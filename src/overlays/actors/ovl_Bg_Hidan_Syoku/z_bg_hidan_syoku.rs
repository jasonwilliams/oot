...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleFlareDancerPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleFlareDancerPlatformCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanSyoku {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanSyokuActionFunc,
    pub unk_168: s16,
    pub timer: s16,
}
pub type BgHidanSyokuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanSyoku, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Syoku_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_SYOKU as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanSyoku>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSyoku_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSyoku_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSyoku_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSyoku_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanSyoku_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanSyoku = thisx as *mut BgHidanSyoku;
    ...
    CollisionHeader_GetVirtual(&mut gFireTempleFlareDancerPlatformCol as
    ...
    (*this).actionFunc =
        Some(func_8088F4B8 as
                 unsafe extern "C" fn(_: *mut BgHidanSyoku,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.home.pos.y += 540.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSyoku_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanSyoku = thisx as *mut BgHidanSyoku;
...
#[no_mangle]
pub unsafe extern "C" fn func_8088F47C(mut this: *mut BgHidanSyoku) {
    (*this).timer = 60 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).dyna.actor,
                          0x2835 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_8088F62C as
                 unsafe extern "C" fn(_: *mut BgHidanSyoku,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8088F4B8(mut this: *mut BgHidanSyoku,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetClear(globalCtx, (*this).dyna.actor.room as s32) != 0 &&
           func_8004356C(&mut (*this).dyna) != 0 {
        (*this).timer = 140 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8088F514 as
                     unsafe extern "C" fn(_: *mut BgHidanSyoku,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8088F514(mut this: *mut BgHidanSyoku,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).dyna.actor.world.pos.y =
        cosf((*this).timer as libc::c_int as libc::c_float *
                 (3.14159265358979323846f32 /
                      140 as libc::c_int as libc::c_float)) * 540.0f32 +
...
#[no_mangle]
pub unsafe extern "C" fn func_8088F5A0(mut this: *mut BgHidanSyoku,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).dyna.actor.world.pos.y =
        (*this).dyna.actor.home.pos.y -
...
#[no_mangle]
pub unsafe extern "C" fn func_8088F62C(mut this: *mut BgHidanSyoku,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).timer = 140 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanSyoku_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanSyoku = thisx as *mut BgHidanSyoku;
    ...
    if func_8004356C(&mut (*this).dyna) != 0 {
        if (*this).unk_168 as libc::c_int == 0 as libc::c_int {
            (*this).unk_168 = 3 as libc::c_int as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanSyoku_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx,
                     gFireTempleFlareDancerPlatformDL.as_mut_ptr());
}
