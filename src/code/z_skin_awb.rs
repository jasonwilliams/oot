...
extern "C" {
    ...
    fn ZeldaArena_FreeDebug(ptr: *mut libc::c_void, file: *const libc::c_char,
                            line: s32);
    #[no_mangle]
    fn SkelAnime_InitSkin(globalCtx: *mut GlobalContext,
                          skelAnime: *mut SkelAnime,
                          skeletonHeaderSeg: *mut SkeletonHeader,
                          animation: *mut AnimationHeader) -> s32;
    #[no_mangle]
    ...
    fn SkinMatrix_MtxFMtxFMult(mfA: *mut MtxF, mfB: *mut MtxF,
                               dest: *mut MtxF);
    #[no_mangle]
    fn SkinMatrix_GetClear(mf: *mut *mut MtxF);
    #[no_mangle]
    fn SkinMatrix_MtxFCopy(src: *mut MtxF, dest: *mut MtxF);
    #[no_mangle]
    fn SkinMatrix_SetTranslateRotateYXZScale(dest: *mut MtxF, scaleX: f32_0,
                                             ...
                                             translateZ: f32_0);
    #[no_mangle]
    fn SkinMatrix_SetTranslateRotateZYX(dest: *mut MtxF, rotX: s16, rotY: s16,
                                        rotZ: s16, translateX: f32_0,
                                        translateY: f32_0, translateZ: f32_0);
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn func_800A6460(mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut limbIndex: s32) {
    let mut i: s32 = 0;
    let mut skeleton: *mut *mut SkinLimb =
    ...
    let mut temp_v1: *mut Struct_800A5E28 =
    ...
    let mut temp_v0: *mut Struct_800A598C =
        gSegments[(((*temp_v1).unk_4 as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*temp_v1).unk_4 as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut Struct_800A598C;
    let mut phi_s0: *mut Struct_800A598C = 0 as *mut Struct_800A598C;
    let mut temp_s1: *mut Struct_800A57C0 = 0 as *mut Struct_800A57C0;
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        let mut temp2: *mut Vtx =
            (*(*skin).avbTbl.offset(limbIndex as isize)).buf[i as usize];
        phi_s0 = temp_v0;
        while phi_s0 <
                  temp_v0.offset((*temp_v1).unk_2 as libc::c_int as isize) {
            let mut phi_s1: *mut Struct_800A57C0 =
                gSegments[(((*phi_s0).unk_8 as u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add((*phi_s0).unk_8 as u32_0 &
            ...
            temp_s1 = phi_s1;
            while temp_s1 <
                      phi_s1.offset((*phi_s0).unk_0 as libc::c_int as isize) {
                let mut temp_t5_3: *mut Vtx =
                    &mut *temp2.offset((*temp_s1).unk_0 as isize) as *mut Vtx;
                (*temp_t5_3).v.flag = 0 as libc::c_int as libc::c_ushort;
                (*temp_t5_3).v.tc[0 as libc::c_int as usize] =
                    (*temp_s1).unk_2;
                (*temp_t5_3).v.tc[1 as libc::c_int as usize] =
                    (*temp_s1).unk_4;
                (*temp_t5_3).v.cn[3 as libc::c_int as usize] =
                    (*temp_s1).unk_9;
                temp_s1 = temp_s1.offset(1)
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_800A663C(mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut skeletonHeader:
                                           *mut SkeletonHeader,
                                       mut animationHeader:
    ...
    let mut virtSkelHeader: *mut SkeletonHeader =
        gSegments[((skeletonHeader as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(skeletonHeader as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut SkeletonHeader;
    (*skin).avbCount = (*virtSkelHeader).limbCount as s32;
                      ...
                      usize].wrapping_add((*(*skin).skeletonHeader).segment as
                                              ...
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut *mut SkinLimb;
    limbCount = (*(*skin).skeletonHeader).limbCount as s32;
    (*skin).avbTbl =
        ZeldaArena_MallocDebug((limbCount as
                                    libc::c_uint).wrapping_mul(::std::mem::size_of::<SkinAvb>()
                                                                   as
                                                                   libc::c_ulong),
                               b"../z_skin_awb.c\x00" as *const u8 as
                                   *const libc::c_char, 212 as libc::c_int) as
            *mut SkinAvb;
    if !(*skin).avbTbl.is_null() {
    } else {
        __assert(b"pskin_awb->avb_tbl != NULL\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_skin_awb.c\x00" as *const u8 as *const libc::c_char,
                 214 as libc::c_int);
    };
    i = 0 as libc::c_int;
    while i < limbCount {
        let mut avbEntry: *mut SkinAvb =
            &mut *(*skin).avbTbl.offset(i as isize) as *mut SkinAvb;
        let mut limb: *mut SkinLimb =
            gSegments[((*skeleton.offset(i as isize) as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(*skeleton.offset(i as isize) as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
                as *mut libc::c_void as *mut SkinLimb;
        if (*limb).unk_8 != 4 as libc::c_int || (*limb).segment.is_null() {
            (*avbEntry).unk_0 = 0 as libc::c_int as u8_0;
            (*avbEntry).buf[0 as libc::c_int as usize] = 0 as *mut Vtx;
            (*avbEntry).buf[1 as libc::c_int as usize] = 0 as *mut Vtx
        } else {
            let mut temp_s1: *mut Struct_800A5E28 =
                gSegments[(((*limb).segment as u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add((*limb).segment as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
                                                                                         as
                    ...
                    as *mut libc::c_void as *mut Struct_800A5E28;
            (*avbEntry).unk_0 = 0 as libc::c_int as u8_0;
            (*avbEntry).buf[0 as libc::c_int as usize] =
                ZeldaArena_MallocDebug(((*temp_s1).unk_0 as
                                            libc::c_uint).wrapping_mul(::std::mem::size_of::<Vtx>()
                                                                           as
                                                                           libc::c_ulong),
                                       b"../z_skin_awb.c\x00" as *const u8 as
                                           *const libc::c_char,
                                       235 as libc::c_int) as *mut Vtx;
            if !(*avbEntry).buf[0 as libc::c_int as usize].is_null() {
            } else {
                __assert(b"psavb->buf[0] != NULL\x00" as *const u8 as
                             *const libc::c_char,
                         b"../z_skin_awb.c\x00" as *const u8 as
                             *const libc::c_char, 237 as libc::c_int);
            };
            (*avbEntry).buf[1 as libc::c_int as usize] =
                ZeldaArena_MallocDebug(((*temp_s1).unk_0 as
                                            libc::c_uint).wrapping_mul(::std::mem::size_of::<Vtx>()
                                                                           as
                                                                           libc::c_ulong),
                                       b"../z_skin_awb.c\x00" as *const u8 as
                                           *const libc::c_char,
                                       240 as libc::c_int) as *mut Vtx;
            if !(*avbEntry).buf[1 as libc::c_int as usize].is_null() {
            } else {
                __assert(b"psavb->buf[1] != NULL\x00" as *const u8 as
                             *const libc::c_char,
                         b"../z_skin_awb.c\x00" as *const u8 as
                             *const libc::c_char, 242 as libc::c_int);
            };
            func_800A6460(globalCtx, skin, i);
        }
        i += 1
    }
    SkelAnime_InitSkin(globalCtx, &mut (*skin).skelAnime, skeletonHeader,
                       animationHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_800A6888(mut globalCtx: *mut GlobalContext,
                                       mut arg1: *mut PSkinAwb) {
    if !(*arg1).avbTbl.is_null() {
        let mut i: s32 = 0;
        i = 0 as libc::c_int;
        while i < (*arg1).avbCount {
            if !(*(*arg1).avbTbl.offset(i as
                                            isize)).buf[0 as libc::c_int as
                                                            usize].is_null() {
                ZeldaArena_FreeDebug((*(*arg1).avbTbl.offset(i as
                                                                 isize)).buf[0
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                     ...
                                     276 as libc::c_int);
                let ref mut fresh0 =
                    (*(*arg1).avbTbl.offset(i as
                                                isize)).buf[0 as libc::c_int
                                                                as usize];
                *fresh0 = 0 as *mut Vtx
            }
            if !(*(*arg1).avbTbl.offset(i as
                                            isize)).buf[1 as libc::c_int as
                                                            usize].is_null() {
                ZeldaArena_FreeDebug((*(*arg1).avbTbl.offset(i as
                                                                 isize)).buf[1
                                                                                 as
        ...
        if !(*arg1).avbTbl.is_null() {
            ZeldaArena_FreeDebug((*arg1).avbTbl as *mut libc::c_void,
                                 b"../z_skin_awb.c\x00" as *const u8 as
                                     *const libc::c_char, 286 as libc::c_int);
        }
        SkelAnime_Free(&mut (*arg1).skelAnime, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_800A698C(mut skin: *mut PSkinAwb,
                                       mut skeleton: *mut *mut SkinLimb,
                                       mut mf: *mut MtxF,
                                       mut parentIndex: u8_0,
                                       mut limbIndex: u8_0) -> s32 {
    let mut pad: s32 = 0;
    let mut limb: *mut SkinLimb =
    ...
    let mut sp28: MtxF = MtxF{mf: [[0.; 4]; 4],};
    if parentIndex as libc::c_int == 0xff as libc::c_int {
        SkinMatrix_GetClear(&mut mtx);
    } else { mtx = &mut *mf.offset(parentIndex as s32 as isize) as *mut MtxF }
    SkinMatrix_MtxFMtxFMult(mtx, &mut *mf.offset(limbIndex as isize),
                            &mut sp28);
    SkinMatrix_MtxFCopy(&mut sp28, &mut *mf.offset(limbIndex as isize));
    if (*limb).child as libc::c_int != 0xff as libc::c_int {
        temp_ret =
            func_800A698C(skin, skeleton, mf, limbIndex, (*limb).child);
        if temp_ret != 0 {
            // func_800A698C only returns false
            return temp_ret
        }
    }
    if (*limb).sibling as libc::c_int != 0xff as libc::c_int {
        temp_ret =
            func_800A698C(skin, skeleton, mf, parentIndex, (*limb).sibling);
        if temp_ret != 0 {
            // func_800A698C only returns false
            return temp_ret
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_800A6AC4(mut skin: *mut PSkinAwb,
                                       mut arg1: *mut MtxF,
                                       mut actor: *mut Actor, mut arg3: s32)
 -> s32 {
    let mut i: s32 = 0;
    let mut pad: s32 = 0;
    let mut yRot: f32_0 = 0.;
    let mut xRot: f32_0 = 0.;
    let mut zRot: f32_0 = 0.;
    let mut temp_ret: s32 = 0;
    let mut yTransl: f32_0 = 0.;
    let mut xTransl: f32_0 = 0.;
    let mut zTransl: f32_0 = 0.;
    let mut skeleton: *mut *mut SkinLimb =
        gSegments[(((*(*skin).skeletonHeader).segment as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add((*(*skin).skeletonHeader).segment as
                                              ...
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut *mut SkinLimb;
    let mut jointRot: *mut Vec3s =
        &mut *(*skin).skelAnime.jointTable.offset(0 as libc::c_int as isize)
            as *mut Vec3s;
    jointRot = jointRot.offset(1);
    xRot = (*jointRot.offset(0 as libc::c_int as isize)).x as f32_0;
    yRot = (*jointRot.offset(0 as libc::c_int as isize)).y as f32_0;
    zRot = (*jointRot.offset(0 as libc::c_int as isize)).z as f32_0;
    if arg3 != 0 as libc::c_int {
        jointRot = jointRot.offset(-1);
        xTransl = (*jointRot.offset(0 as libc::c_int as isize)).x as f32_0;
        yTransl = (*jointRot.offset(0 as libc::c_int as isize)).y as f32_0;
        zTransl = (*jointRot.offset(0 as libc::c_int as isize)).z as f32_0;
        jointRot = jointRot.offset(1);
        if arg3 == 0x23 as libc::c_int {
            let mut horse: *mut EnfHG = actor as *mut EnfHG;
            yRot += (*horse).turnRot as libc::c_int as libc::c_float
        }
        SkinMatrix_SetTranslateRotateZYX(arg1, xRot as s16, yRot as s16,
                                         zRot as s16, xTransl, yTransl,
                                         zTransl);
    } else {
        SkinMatrix_SetTranslateRotateZYX(arg1, xRot as s16, yRot as s16,
                                         zRot as s16, 0.0f32, 0.0f32, 0.0f32);
    }
    jointRot = jointRot.offset(1);
    i = 1 as libc::c_int;
                          ...
                          usize].wrapping_add(*skeleton.offset(i as isize) as
                                                  ...
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     ...
                                                                                     libc::c_uint)
                as *mut libc::c_void as *mut SkinLimb;
        xTransl = (*limb).jointPos.x as f32_0;
        yTransl = (*limb).jointPos.y as f32_0;
        zTransl = (*limb).jointPos.z as f32_0;
        xRot = (*jointRot).x as f32_0;
        yRot = (*jointRot).y as f32_0;
        zRot = (*jointRot).z as f32_0;
        jointRot = jointRot.offset(1);
        SkinMatrix_SetTranslateRotateZYX(&mut *arg1.offset(i as isize),
                                         xRot as s16, yRot as s16,
                                         zRot as s16, xTransl, yTransl,
                                         zTransl);
        i += 1
    }
    SkinMatrix_SetTranslateRotateYXZScale(&mut (*skin).mtx, (*actor).scale.x,
    ...
    temp_ret =
        func_800A698C(skin,
                      gSegments[(((*(*skin).skeletonHeader).segment as u32_0)
                                    ...
                                    as
                                    usize].wrapping_add((*(*skin).skeletonHeader).segment
                                                            as u32_0 &
                                                            0xffffff as
                                                                libc::c_int as
                                                                libc::c_uint).wrapping_add(0x80000000
                                                                                               as
                                                                                               libc::c_uint)
                          as *mut libc::c_void as *mut *mut SkinLimb, arg1,
