...
extern "C" {
    ...
    #[no_mangle]
    fn func_8008EF44(globalCtx: *mut GlobalContext, ammo: s32) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gObjectOssanEnSyatekiManDL_007E28: [Gfx; 0];
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSyatekiMan {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 9],
    pub morphTable: [Vec3s; 9],
    pub actionFunc: EnSyatekiManActionFunc,
    pub headRot: Vec3s,
    pub bodyRot: Vec3s,
    pub eyeState: s16,
    pub blinkTimer: s16,
    ...
    pub getItemId: s32,
    pub cameraHold: u8_0,
    pub tempGallery: *mut Actor,
    pub blinkFunc: EnSyatekiManOtherFunc,
    pub csCam: s16,
}
pub type EnSyatekiManOtherFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSyatekiMan) -> ()>;
pub type EnSyatekiManActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSyatekiMan, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const ENSYATEKI_RESULTS: C2RustUnnamed_21 = 3;
pub const ENSYATEKI_END: C2RustUnnamed_21 = 2;
pub const ENSYATEKI_START: C2RustUnnamed_21 = 1;
pub const ENSYATEKI_NONE: C2RustUnnamed_21 = 0;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const SYATEKI_RESULT_REFUSE: C2RustUnnamed_22 = 4;
pub const SYATEKI_RESULT_FAILURE: C2RustUnnamed_22 = 3;
pub const SYATEKI_RESULT_ALMOST: C2RustUnnamed_22 = 2;
pub const SYATEKI_RESULT_WINNER: C2RustUnnamed_22 = 1;
pub const SYATEKI_RESULT_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const SYATEKI_TEXT_REFUSE: C2RustUnnamed_23 = 3;
pub const SYATEKI_TEXT_NO_RUPEES: C2RustUnnamed_23 = 2;
pub const SYATEKI_TEXT_START_GAME: C2RustUnnamed_23 = 1;
pub const SYATEKI_TEXT_CHOICE: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut En_Syateki_Man_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SYATEKI_MAN as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_OSSAN as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSyatekiMan>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiMan_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiMan_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiMan_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiMan_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBgmList: [u16_0; 88] =
    [0 as libc::c_int as u16_0, 0x1 as libc::c_int as u16_0,
     0x2 as libc::c_int as u16_0, 0x18 as libc::c_int as u16_0,
     0x19 as libc::c_int as u16_0, 0x2 as libc::c_int as u16_0,
     0x19 as libc::c_int as u16_0, 0x1a as libc::c_int as u16_0,
     0x1a as libc::c_int as u16_0,
     (0x1a as libc::c_int | 0x800 as libc::c_int) as u16_0,
     0x1b as libc::c_int as u16_0, 0x1c as libc::c_int as u16_0,
     0x1d as libc::c_int as u16_0, 0x1e as libc::c_int as u16_0,
     0x1f as libc::c_int as u16_0, 0x20 as libc::c_int as u16_0,
     0x21 as libc::c_int as u16_0,
     (0x22 as libc::c_int | 0x900 as libc::c_int) as u16_0,
     0x23 as libc::c_int as u16_0,
     (0x24 as libc::c_int | 0x900 as libc::c_int) as u16_0,
     0x25 as libc::c_int as u16_0, 0x26 as libc::c_int as u16_0,
     0x27 as libc::c_int as u16_0, 0x28 as libc::c_int as u16_0,
     0x29 as libc::c_int as u16_0, 0x2a as libc::c_int as u16_0,
     (0x2b as libc::c_int | 0x900 as libc::c_int) as u16_0,
     0x2c as libc::c_int as u16_0, 0x2d as libc::c_int as u16_0,
     0x2e as libc::c_int as u16_0, 0x2f as libc::c_int as u16_0,
     0x30 as libc::c_int as u16_0, 0x32 as libc::c_int as u16_0,
     0x33 as libc::c_int as u16_0, 0x34 as libc::c_int as u16_0,
     0x35 as libc::c_int as u16_0, 0x36 as libc::c_int as u16_0,
     0x37 as libc::c_int as u16_0, 0x38 as libc::c_int as u16_0,
     0x39 as libc::c_int as u16_0, 0x3a as libc::c_int as u16_0,
     0x3b as libc::c_int as u16_0, 0x3c as libc::c_int as u16_0,
     0x3d as libc::c_int as u16_0, 0x3e as libc::c_int as u16_0,
     0x3f as libc::c_int as u16_0, 0x40 as libc::c_int as u16_0,
     0x41 as libc::c_int as u16_0, 0x42 as libc::c_int as u16_0,
     0x43 as libc::c_int as u16_0, 0x44 as libc::c_int as u16_0,
     0x45 as libc::c_int as u16_0, 0x46 as libc::c_int as u16_0,
     0x47 as libc::c_int as u16_0, 0x48 as libc::c_int as u16_0,
     0x49 as libc::c_int as u16_0, 0x4a as libc::c_int as u16_0,
     0x4b as libc::c_int as u16_0, 0x4c as libc::c_int as u16_0,
     0x4d as libc::c_int as u16_0, 0x4e as libc::c_int as u16_0,
     0x4f as libc::c_int as u16_0, 0x50 as libc::c_int as u16_0,
     0x51 as libc::c_int as u16_0, 0x52 as libc::c_int as u16_0,
     0x53 as libc::c_int as u16_0, 0x54 as libc::c_int as u16_0,
     0x55 as libc::c_int as u16_0, 0x56 as libc::c_int as u16_0,
     0x57 as libc::c_int as u16_0, 0x58 as libc::c_int as u16_0,
     0x59 as libc::c_int as u16_0, 0x5a as libc::c_int as u16_0,
     0x5b as libc::c_int as u16_0, 0x5c as libc::c_int as u16_0,
     0x5d as libc::c_int as u16_0, 0x6d as libc::c_int as u16_0,
     0x5e as libc::c_int as u16_0, 0x5e as libc::c_int as u16_0,
     0x5f as libc::c_int as u16_0, 0x60 as libc::c_int as u16_0,
     0x61 as libc::c_int as u16_0, 0x6d as libc::c_int as u16_0,
     0x62 as libc::c_int as u16_0, 0x63 as libc::c_int as u16_0,
     0x64 as libc::c_int as u16_0, 0x65 as libc::c_int as u16_0,
     0x66 as libc::c_int as u16_0];
static mut sTextIds: [s16; 4] =
    [0x2b as libc::c_int as s16, 0x2e as libc::c_int as s16,
     0xc8 as libc::c_int as s16, 0x2d as libc::c_int as s16];
static mut sTextBoxCount: [s16; 4] =
    [TEXT_STATE_CHOICE as libc::c_int as s16,
     TEXT_STATE_EVENT as libc::c_int as s16,
     TEXT_STATE_EVENT as libc::c_int as s16,
     TEXT_STATE_EVENT as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSyatekiMan = thisx as *mut EnSyatekiMan;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Old man appeared!! Muhohohohohohohon"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa6\xaa\xe7\x88\xb6\xe7\x99\xbb\xe5\xa0\xb4\xef\xbc\x81\xef\xbc\x81\xe3\x82\x80\xe3\x81\xbb\xe3\x81\xbb\xe3\x81\xbb\xe3\x81\xbb\xe3\x81\xbb\xe3\x81\xbb\xe3\x81\xbb\xe3\x83\xbc\xe3\x82\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        (*this).headRot.z = 20 as libc::c_int as s16
    }
    (*this).blinkTimer = 20 as libc::c_int as s16;
    (*this).eyeState = 0 as libc::c_int as s16;
    (*this).blinkFunc =
        Some(EnSyatekiMan_BlinkWait as
                 unsafe extern "C" fn(_: *mut EnSyatekiMan) -> ());
    (*this).actor.colChkInfo.cylRadius = 100 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSyatekiMan_Start as
                 unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Start(mut this: *mut EnSyatekiMan,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gObjectOssanAnim_000338 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gObjectOssanAnim_000338,
                     1.0f32, 0.0f32, lastFrame as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnSyatekiMan_SetupIdle as
                 unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_SetupIdle(mut this: *mut EnSyatekiMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).gameResult as libc::c_int ==
           SYATEKI_RESULT_REFUSE as libc::c_int {
        (*this).textIdx = SYATEKI_TEXT_REFUSE as libc::c_int as s16
    }
    (*this).actor.textId = sTextIds[(*this).textIdx as usize] as u16_0;
    (*this).numTextBox = sTextBoxCount[(*this).textIdx as usize];
    (*this).actionFunc =
        Some(EnSyatekiMan_Idle as
                 unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Idle(mut this: *mut EnSyatekiMan,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnSyatekiMan_Talk as
                     unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                          _: *mut GlobalContext) -> ())
    } else { func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32); };
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Talk(mut this: *mut EnSyatekiMan,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut nextState: s16 = 0 as libc::c_int as s16;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).cameraHold != 0 {
        (*globalCtx).shootingGalleryStatus = -(2 as libc::c_int) as s8
    }
    if (*this).numTextBox as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if (*this).textIdx as libc::c_int ==
               SYATEKI_TEXT_CHOICE as libc::c_int {
                    ...
                    if gSaveContext.rupees as libc::c_int >= 20 as libc::c_int
                       {
                        ...
                        (*this).textIdx =
                            SYATEKI_TEXT_START_GAME as libc::c_int as s16;
                        nextState = 1 as libc::c_int as s16
                    } else {
                        (*this).textIdx =
                            SYATEKI_TEXT_NO_RUPEES as libc::c_int as s16;
                        nextState = 2 as libc::c_int as s16
                    }
                    (*this).actor.textId =
                        sTextIds[(*this).textIdx as usize] as u16_0;
                    (*this).numTextBox =
                        sTextBoxCount[(*this).textIdx as usize]
                }
                1 => {
                    (*this).actor.textId =
                        sTextIds[SYATEKI_TEXT_REFUSE as libc::c_int as usize]
                            as u16_0;
                    (*this).numTextBox =
                        sTextBoxCount[SYATEKI_TEXT_REFUSE as libc::c_int as
                                          usize];
                    nextState = 2 as libc::c_int as s16
                }
                _ => { }
        ...
        match nextState as libc::c_int {
            ...
            1 => {
                (*this).actionFunc =
                    Some(EnSyatekiMan_StartGame as
                             unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_StopTalk(mut this: *mut EnSyatekiMan,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).cameraHold != 0 {
    ...
    if (*this).numTextBox as libc::c_int ==
        ...
        if (*this).cameraHold != 0 {
            ...
            (*this).csCam = -(1 as libc::c_int) as s16;
            (*this).cameraHold = 0 as libc::c_int as u8_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_StartGame(mut this: *mut EnSyatekiMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    if (*this).numTextBox as libc::c_int ==
        ...
        if (*gallery).actor.update.is_some() {
            (*gallery).signal = ENSYATEKI_START as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnSyatekiMan_WaitForGame as
                         unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_WaitForGame(mut this: *mut EnSyatekiMan,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut gallery: *mut EnSyatekiItm = 0 as *mut EnSyatekiItm;
    SkelAnime_Update(&mut (*this).skelAnime);
    gallery = (*this).actor.parent as *mut EnSyatekiItm;
    if (*gallery).actor.update.is_some() &&
           (*gallery).signal as libc::c_int == ENSYATEKI_END as libc::c_int {
        (*this).csCam =
            OnePointCutscene_Init(globalCtx, 8002 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).actor,
                                  0 as libc::c_int as s16);
        match (*gallery).hitCount as libc::c_int {
            10 => {
                (*this).gameResult =
                    SYATEKI_RESULT_WINNER as libc::c_int as s16;
                (*this).actor.textId = 0x71af as libc::c_int as u16_0
            }
            8 | 9 => {
                (*this).gameResult =
                    SYATEKI_RESULT_ALMOST as libc::c_int as s16;
                (*this).actor.textId = 0x71ae as libc::c_int as u16_0
            }
            _ => {
                (*this).gameResult =
                    SYATEKI_RESULT_FAILURE as libc::c_int as s16;
                (*this).actor.textId = 0x71ad as libc::c_int as u16_0;
                if (*globalCtx).shootingGalleryStatus as libc::c_int ==
                       15 as libc::c_int + 1 as libc::c_int {
                    (*this).gameResult =
                        SYATEKI_RESULT_REFUSE as libc::c_int as s16;
        ...
        Message_StartTextbox(globalCtx, (*this).actor.textId,
                             0 as *mut Actor);
        (*this).actionFunc =
            Some(EnSyatekiMan_EndGame as
                     unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_EndGame(mut this: *mut EnSyatekiMan,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut gallery: *mut EnSyatekiItm = 0 as *mut EnSyatekiItm;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).numTextBox as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if (*this).gameResult as libc::c_int !=
               SYATEKI_RESULT_FAILURE as libc::c_int {
            OnePointCutscene_EndCutscene(globalCtx, (*this).csCam);
            (*this).csCam = -(1 as libc::c_int) as s16
        }
        Message_CloseTextbox(globalCtx);
        gallery = (*this).actor.parent as *mut EnSyatekiItm;
        if (*gallery).actor.update.is_some() {
            (*gallery).signal = ENSYATEKI_RESULTS as libc::c_int as s16;
            (*this).textIdx = 0 as libc::c_int as s16;
            match (*this).gameResult as libc::c_int {
                1 => {
                    (*this).tempGallery = (*this).actor.parent;
                    (*this).actor.parent = 0 as *mut Actor;
                    if !(gSaveContext.linkAge == 0 as libc::c_int) {
                        if gSaveContext.itemGetInf[0 as libc::c_int as usize]
                               as libc::c_int & 0x2000 as libc::c_int == 0 {
                            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 Equip_Pachinko \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char,
                            ...
                            if (gSaveContext.inventory.upgrades &
                                ...
                                (*this).getItemId =
                                    GI_BULLET_BAG_40 as libc::c_int
                            } else {
                                (*this).getItemId =
                    ...
                    } else if gSaveContext.itemGetInf[0 as libc::c_int as
                                                          usize] as
                                  libc::c_int & 0x4000 as libc::c_int == 0 {
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 Equip_Bow \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     (gSaveContext.inventory.upgrades &
                        ...
                        match (gSaveContext.inventory.upgrades &
                                   gUpgradeMasks[UPG_QUIVER as libc::c_int as
                                                     usize]) as s32 >>
                                  gUpgradeShifts[UPG_QUIVER as libc::c_int as
                                                     usize] as libc::c_int {
                            0 => {
                                (*this).getItemId =
                            ...
                            1 => {
                                (*this).getItemId =
                                    GI_QUIVER_40 as libc::c_int
                            }
                            2 => {
                                (*this).getItemId =
                                    GI_QUIVER_50 as libc::c_int
                            }
                            _ => { }
                        }
                    } else {
                    ...
                    func_8002F434(&mut (*this).actor, globalCtx,
                                  (*this).getItemId, 2000.0f32, 1000.0f32);
                    (*this).actionFunc =
                        Some(EnSyatekiMan_GivePrize as
                                 unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
                2 => {
                    ...
                    func_8008EF44(globalCtx, 15 as libc::c_int);
                    (*this).actionFunc =
                        Some(EnSyatekiMan_RestartGame as
                                 unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
                _ => {
                    if (*this).gameResult as libc::c_int ==
                        ...
                        (*this).cameraHold = 1 as libc::c_int as u8_0;
                        (*this).actor.textId =
                            sTextIds[(*this).textIdx as usize] as u16_0;
                        (*this).numTextBox =
                            sTextBoxCount[(*this).textIdx as usize];
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_GivePrize(mut this: *mut EnSyatekiMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnSyatekiMan_FinishPrize as
                     unsafe extern "C" fn(_: *mut EnSyatekiMan,
                                          _: *mut GlobalContext) -> ())
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_FinishPrize(mut this: *mut EnSyatekiMan,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        } else if (*this).getItemId == GI_QUIVER_40 as libc::c_int ||
                      (*this).getItemId == GI_QUIVER_50 as libc::c_int {
            gSaveContext.itemGetInf[0 as libc::c_int as usize] =
                (gSaveContext.itemGetInf[0 as libc::c_int as usize] as
                     libc::c_int | 0x4000 as libc::c_int) as u16_0
        }
        (*this).gameResult = SYATEKI_RESULT_NONE as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_RestartGame(mut this: *mut EnSyatekiMan,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        let mut gallery: *mut EnSyatekiItm =
        ...
        if (*gallery).actor.update.is_some() {
            ...
            osSyncPrintf(b"\x1b[34m\xe5\x86\x8d\xe6\x8c\x91\xe6\x88\xa6\xe3\x81\xa0\xe3\x81\x9c\xef\xbc\x81\xe3\x83\x99\xe3\x82\xa4\xe3\x83\x93\xe3\x83\xbc\xef\xbc\x81\x1b[m\n\x00"
                             as *const u8 as *const libc::c_char, this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_BlinkWait(mut this: *mut EnSyatekiMan) {
    let mut decrBlinkTimer: s16 =
        ((*this).blinkTimer as libc::c_int - 1 as libc::c_int) as s16;
    if decrBlinkTimer as libc::c_int != 0 as libc::c_int {
        (*this).blinkTimer = decrBlinkTimer
    } else {
        (*this).blinkFunc =
            Some(EnSyatekiMan_Blink as
                     unsafe extern "C" fn(_: *mut EnSyatekiMan) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Blink(mut this: *mut EnSyatekiMan) {
    let mut decrBlinkTimer: s16 =
        ((*this).blinkTimer as libc::c_int - 1 as libc::c_int) as s16;
    if decrBlinkTimer as libc::c_int != 0 as libc::c_int {
        (*this).blinkTimer = decrBlinkTimer
    } else {
        let mut nextEyeState: s16 =
            ((*this).eyeState as libc::c_int + 1 as libc::c_int) as s16;
        if nextEyeState as libc::c_int >= 3 as libc::c_int {
            (*this).eyeState = 0 as libc::c_int as s16;
            (*this).blinkTimer =
                (20 as libc::c_int + (Rand_ZeroOne() * 60.0f32) as s32) as
                    s16;
            (*this).blinkFunc =
                Some(EnSyatekiMan_BlinkWait as
                         unsafe extern "C" fn(_: *mut EnSyatekiMan) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSyatekiMan = thisx as *mut EnSyatekiMan;
    ...
    func_80038290(globalCtx, &mut (*this).actor, &mut (*this).headRot,
                  &mut (*this).bodyRot, (*this).actor.focus.pos);
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_OverrideLimbDraw(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut limbIndex: s32,
                                                       mut dList:
                                                           *mut *mut Gfx,
 ...
 -> s32 {
    let mut this: *mut EnSyatekiMan = thisx as *mut EnSyatekiMan;
    let mut turnDirection: s32 = 0;
    if limbIndex == 1 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).bodyRot.y as libc::c_int) as
                s16
    }
    if limbIndex == 8 as libc::c_int {
        *dList = gObjectOssanEnSyatekiManDL_007E28.as_mut_ptr();
        turnDirection = 1 as libc::c_int;
        if (*this).gameResult as libc::c_int ==
               SYATEKI_RESULT_REFUSE as libc::c_int {
            turnDirection = -(1 as libc::c_int)
        }
        (*rot).x =
            ((*rot).x as libc::c_int +
                 (*this).headRot.y as libc::c_int * turnDirection) as s16;
        (*rot).z =
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSyatekiMan = thisx as *mut EnSyatekiMan;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnSyatekiMan_OverrideLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiMan_SetBgm() {
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        Audio_QueueSeqCmd(sBgmList[(*gGameInfo).data[(25 as libc::c_int *
                                                          6 as libc::c_int *
                                                          16 as libc::c_int +
                                                          81 as libc::c_int)
                                                         as usize] as usize]
