...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002D97C(actor: *mut Actor);
    #[no_mangle]
    ...
    fn Actor_WorldDistXYZToPoint(actor: *mut Actor, refPoint: *mut Vec3f)
     -> f32_0;
    #[no_mangle]
    fn Actor_WorldPitchTowardPoint(actor: *mut Actor, refPoint: *mut Vec3f)
     -> s16;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gKeeseFlyAnim: AnimationHeader;
    #[no_mangle]
    static mut gKeeseEyesDL: [Gfx; 0];
    #[no_mangle]
    static mut gKeeseSkeleton: SkeletonHeader;
}
...
pub struct EnFirefly {
    pub actor: Actor,
    pub bodyPartsPos: [Vec3f; 3],
    pub skelAnime: SkelAnime,
    pub actionFunc: EnFireflyActionFunc,
    pub auraType: u8_0,
    pub onFire: u8_0,
    pub timer: s16,
    pub targetPitch: s16,
    ...
    pub maxAltitude: f32_0,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
}
pub type EnFireflyActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFirefly, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const KEESE_ICE_FLY: C2RustUnnamed_23 = 4;
pub const KEESE_NORMAL_PERCH: C2RustUnnamed_23 = 3;
pub const KEESE_NORMAL_FLY: C2RustUnnamed_23 = 2;
pub const KEESE_FIRE_PERCH: C2RustUnnamed_23 = 1;
pub const KEESE_FIRE_FLY: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjSyokudai {
    pub actor: Actor,
    pub colliderStand: ColliderCylinder,
    pub colliderFlame: ColliderCylinder,
    pub litTimer: s16,
    pub flameTexScroll: u8_0,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
}
pub const KEESE_AURA_NONE: C2RustUnnamed_24 = 0;
pub const KEESE_AURA_ICE: C2RustUnnamed_24 = 2;
pub const KEESE_AURA_FIRE: C2RustUnnamed_24 = 1;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut En_Firefly_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FIREFLY as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_FIREFLY as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnFirefly>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFirefly_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFirefly_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 1 as libc::c_int as u8_0,
                                   cylRadius: 10 as libc::c_int as s16,
                                   cylHeight: 10 as libc::c_int as s16,
                                   mass: 30 as libc::c_int as u8_0,};
        init
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Extinguish(mut this: *mut EnFirefly) {
    (*this).actor.params =
        ((*this).actor.params as libc::c_int + 2 as libc::c_int) as
            s16; // None
    (*(*this).collider.elements.offset(0 as libc::c_int as
                                           isize)).info.toucher.effect =
        0 as libc::c_int as u8_0;
    (*this).auraType = KEESE_AURA_NONE as libc::c_int as u8_0;
    (*this).onFire = 0 as libc::c_int as u8_0;
    (*this).actor.naviEnemyId = 0x12 as libc::c_int as u8_0;
    // Keese
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Ignite(mut this: *mut EnFirefly) {
    if (*this).actor.params as libc::c_int == KEESE_ICE_FLY as libc::c_int {
        (*this).actor.params = KEESE_FIRE_FLY as libc::c_int as s16
    } else {
        (*this).actor.params =
            ((*this).actor.params as libc::c_int - 2 as libc::c_int) as s16
    } // Fire
    (*(*this).collider.elements.offset(0 as libc::c_int as
                                           isize)).info.toucher.effect =
        1 as libc::c_int as u8_0;
    (*this).auraType = KEESE_AURA_FIRE as libc::c_int as u8_0;
    (*this).onFire = 1 as libc::c_int as u8_0;
    (*this).actor.naviEnemyId = 0x11 as libc::c_int as u8_0;
    // Fire Keese
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly; // Fire Keese
    Actor_ProcessInitChain(&mut (*this).actor,
                           sInitChain.as_mut_ptr()); // Ice
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 25.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gKeeseSkeleton,
                   &mut gKeeseFlyAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 28 as libc::c_int);
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    if (*this).actor.params as libc::c_int & 0x8000 as libc::c_int !=
           0 as libc::c_int {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
        (*this).actor.draw =
            Some(EnFirefly_DrawInvisible as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.params =
            ((*this).actor.params as libc::c_int & 0x7fff as libc::c_int) as
                s16
    }
    if (*this).actor.params as libc::c_int <= KEESE_FIRE_PERCH as libc::c_int
       {
        (*this).onFire = 1 as libc::c_int as u8_0
    } else { (*this).onFire = 0 as libc::c_int as u8_0 }
    if (*this).onFire != 0 {
        (*this).actionFunc =
            Some(EnFirefly_FlyIdle as
                     unsafe extern "C" fn(_: *mut EnFirefly,
                                          _: *mut GlobalContext) -> ());
        (*this).timer =
            Rand_S16Offset(20 as libc::c_int as s16,
                           60 as libc::c_int as s16);
        (*this).actor.shape.rot.x = 0x1554 as libc::c_int as s16;
        (*this).auraType = KEESE_AURA_FIRE as libc::c_int as u8_0;
        (*this).actor.naviEnemyId = 0x11 as libc::c_int as u8_0;
        (*this).maxAltitude = (*this).actor.home.pos.y
    } else {
        if (*this).actor.params as libc::c_int ==
               KEESE_NORMAL_PERCH as libc::c_int {
            (*this).actionFunc =
                Some(EnFirefly_Perch as
                         unsafe extern "C" fn(_: *mut EnFirefly,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
        ...
        if (*this).actor.params as libc::c_int == KEESE_ICE_FLY as libc::c_int
           {
            ...
            (*this).actor.naviEnemyId = 0x56 as libc::c_int as u8_0
            // Ice Keese
        } else {
            (*(*this).collider.elements.offset(0 as libc::c_int as
                                                   isize)).info.toucher.effect
                = 0 as libc::c_int as u8_0;
            (*this).actor.naviEnemyId = 0x12 as libc::c_int as u8_0 // Nothing
            // Keese
        }
        (*this).maxAltitude = (*this).actor.home.pos.y + 100.0f32;
        if (*this).actor.params as libc::c_int == KEESE_ICE_FLY as libc::c_int
           {
            (*this).auraType = KEESE_AURA_ICE as libc::c_int as u8_0
        } else { (*this).auraType = KEESE_AURA_NONE as libc::c_int as u8_0 }
    }
    (*(*this).collider.elements.offset(0 as libc::c_int as
                                           isize)).dim.worldSphere.radius =
        (*sJntSphInit.elements.offset(0 as libc::c_int as
                                          isize)).dim.modelSphere.radius;
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupFlyIdle(mut this: *mut EnFirefly) {
    (*this).timer =
        Rand_S16Offset(70 as libc::c_int as s16, 100 as libc::c_int as s16);
    (*this).actor.speedXZ = Rand_ZeroOne() * 1.5f32 + 1.5f32;
    ...
    (*this).targetPitch =
        ((if (*this).maxAltitude < (*this).actor.world.pos.y {
              0xc00 as libc::c_int
          } else { -(0xc00 as libc::c_int) }) + 0x1554 as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupFall(mut this: *mut EnFirefly) {
    (*this).timer = 40 as libc::c_int as s16;
    (*this).actor.velocity.y = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut gKeeseFlyAnim, 0.5f32,
                     0.0f32, 0.0f32,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -3.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3842 as libc::c_int as u16_0);
    (*this).actor.flags |=
    ...
    (*this).actionFunc =
        Some(EnFirefly_Fall as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupDie(mut this: *mut EnFirefly) {
    (*this).timer = 15 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actionFunc =
        Some(EnFirefly_Die as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupRebound(mut this: *mut EnFirefly) {
    (*this).actor.world.rot.x = 0x7000 as libc::c_int as s16;
    (*this).timer = 18 as libc::c_int as s16;
    (*this).skelAnime.playSpeed = 1.0f32;
    (*this).actor.speedXZ = 2.5f32;
    (*this).actionFunc =
        Some(EnFirefly_Rebound as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupDiveAttack(mut this: *mut EnFirefly) {
    (*this).timer =
        Rand_S16Offset(70 as libc::c_int as s16, 100 as libc::c_int as s16);
    (*this).skelAnime.playSpeed = 1.0f32;
    (*this).targetPitch =
    ...
    (*this).actionFunc =
        Some(EnFirefly_DiveAttack as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupFlyAway(mut this: *mut EnFirefly) {
    (*this).timer = 150 as libc::c_int as s16;
    (*this).skelAnime.playSpeed = 1.0f32;
    (*this).targetPitch = 0x954 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnFirefly_FlyAway as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupStunned(mut this: *mut EnFirefly) {
    ...
    (*this).actionFunc =
        Some(EnFirefly_Stunned as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupFrozenFall(mut this: *mut EnFirefly,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut iceParticlePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
    (*this).auraType = KEESE_AURA_NONE as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    ...
    while i <= 7 as libc::c_int {
        iceParticlePos.x =
            (if i & 1 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) +
                (*this).actor.world.pos.x;
        iceParticlePos.y =
            (if i & 2 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) +
                (*this).actor.world.pos.y;
        iceParticlePos.z =
            (if i & 4 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) +
        ...
        EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).actor,
                                       ...
                                       Rand_ZeroOne() * 0.15f32 + 0.85f32);
        i += 1
    }
    (*this).actionFunc =
        Some(EnFirefly_FrozenFall as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupPerch(mut this: *mut EnFirefly) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SetupDisturbDiveAttack(mut this:
                                                              *mut EnFirefly) {
    (*this).skelAnime.playSpeed = 3.0f32;
    (*this).actor.shape.rot.x = 0x1554 as libc::c_int as s16;
    ...
    (*this).actionFunc =
        Some(EnFirefly_DisturbDiveAttack as
                 unsafe extern "C" fn(_: *mut EnFirefly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_ReturnToPerch(mut this: *mut EnFirefly,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> s32 {
    ...
    if Actor_WorldDistXZToPoint(&mut (*player).actor,
        ...
        distFromHome =
            Actor_WorldDistXYZToPoint(&mut (*this).actor,
                                      &mut (*this).actor.home.pos);
        if distFromHome < 5.0f32 {
            EnFirefly_SetupPerch(this);
            return 1 as libc::c_int
        }
        distFromHome *= 0.05f32;
        if distFromHome < 1.0f32 { (*this).actor.speedXZ *= distFromHome }
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                           Actor_WorldYawTowardPoint(&mut (*this).actor,
                                                     &mut (*this).actor.home.pos),
                           0x300 as libc::c_int as s16);
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           (Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                                        &mut (*this).actor.home.pos)
                                as libc::c_int + 0x1554 as libc::c_int) as
                               s16, 0x100 as libc::c_int as s16);
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_SeekTorch(mut this: *mut EnFirefly,
                                             mut globalCtx:
                                                 *mut GlobalContext) -> s32 {
    let mut findTorch: *mut ObjSyokudai = 0 as *mut ObjSyokudai;
    let mut closestTorch: *mut ObjSyokudai = 0 as *mut ObjSyokudai;
    let mut torchDist: f32_0 = 0.;
    let mut currentMinDist: f32_0 = 0.;
    let mut flamePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    findTorch =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PROP as libc::c_int as
                                             usize].head as *mut ObjSyokudai;
    closestTorch = 0 as *mut ObjSyokudai;
    currentMinDist = 35000.0f32;
    while !findTorch.is_null() {
        if (*findTorch).actor.id as libc::c_int ==
               ACTOR_OBJ_SYOKUDAI as libc::c_int &&
               (*findTorch).litTimer as libc::c_int != 0 as libc::c_int {
            torchDist =
                Actor_WorldDistXYZToActor(&mut (*this).actor,
                                          &mut (*findTorch).actor);
        ...
        findTorch = (*findTorch).actor.next as *mut ObjSyokudai
    }
    if !closestTorch.is_null() {
        flamePos.x = (*closestTorch).actor.world.pos.x;
        flamePos.y = (*closestTorch).actor.world.pos.y + 52.0f32 + 15.0f32;
        flamePos.z = (*closestTorch).actor.world.pos.z;
        if Actor_WorldDistXYZToPoint(&mut (*this).actor, &mut flamePos) <
               15.0f32 {
            ...
            Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                               Actor_WorldYawTowardActor(&mut (*this).actor,
                                                         &mut (*closestTorch).actor),
                               0x300 as libc::c_int as s16);
            Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                               (Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                                            &mut flamePos) as
                                    libc::c_int + 0x1554 as libc::c_int) as
                                   s16, 0x100 as libc::c_int as s16);
            return 1 as libc::c_int
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_FlyIdle(mut this: *mut EnFirefly,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut skelanimeUpdated: s32 = 0;
    let mut rand: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    skelanimeUpdated = Animation_OnFrame(&mut (*this).skelAnime, 0.0f32);
    (*this).actor.speedXZ = Rand_ZeroOne() * 1.5f32 + 1.5f32;
    if (*this).onFire as libc::c_int != 0 ||
           (*this).actor.params as libc::c_int == KEESE_ICE_FLY as libc::c_int
           ||
           EnFirefly_ReturnToPerch(this, globalCtx) == 0 as libc::c_int &&
               EnFirefly_SeekTorch(this, globalCtx) == 0 as libc::c_int {
        if skelanimeUpdated != 0 {
            rand = Rand_ZeroOne();
            if rand < 0.5f32 {
                Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                                   Actor_WorldYawTowardPoint(&mut (*this).actor,
                ...
                (*this).actor.shape.rot.y =
                    ((*this).actor.shape.rot.y as libc::c_float +
                         Rand_CenteredFloat(1536.0f32)) as s16
            }
            // Climb if too close to ground
            if (*this).actor.world.pos.y < (*this).actor.floorHeight + 20.0f32
               {
                (*this).targetPitch = 0x954 as libc::c_int as s16
                // Descend if above maxAltitude
            } else if (*this).maxAltitude < (*this).actor.world.pos.y {
                (*this).targetPitch = 0x2154 as libc::c_int as s16
                // Otherwise ascend or descend at random, biased towards ascending
            } else if 0.35f32 < Rand_ZeroOne() {
                (*this).targetPitch = 0x954 as libc::c_int as s16
            } else { (*this).targetPitch = 0x2154 as libc::c_int as s16 }
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Fall(mut this: *mut EnFirefly,
                                        mut globalCtx: *mut GlobalContext) {
    if Animation_OnFrame(&mut (*this).skelAnime, 6.0f32) != 0 {
        (*this).skelAnime.playSpeed = 0.0f32
    }
    (*this).actor.colorFilterTimer = 40 as libc::c_int as u8_0;
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).actor.flags &
        ...
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           0x6800 as libc::c_int as s16,
                           0x200 as libc::c_int as s16);
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int - 0x300 as libc::c_int)
                as s16;
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Die(mut this: *mut EnFirefly,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, 0.00034f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_DiveAttack(mut this: *mut EnFirefly,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut preyPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    Math_StepToF(&mut (*this).actor.speedXZ, 4.0f32, 0.5f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).actor.wallYaw, 2 as libc::c_int as s16,
                           0xc00 as libc::c_int as s16,
        ...
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           (*this).targetPitch, 0x100 as libc::c_int as s16);
                                   ...
                                   0x2800 as libc::c_int as s16) != 0 {
        if Animation_OnFrame(&mut (*this).skelAnime, 4.0f32) != 0 {
            (*this).skelAnime.playSpeed = 0.0f32;
        ...
        preyPos.y = (*player).actor.world.pos.y + 20.0f32;
        preyPos.z = (*player).actor.world.pos.z;
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                           (Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                                        &mut preyPos) as
                                libc::c_int + 0x1554 as libc::c_int) as s16,
                           2 as libc::c_int as s16,
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 0x10 as libc::c_int !=
               0 || (*this).maxAltitude < (*this).actor.world.pos.y {
            (*this).targetPitch = 0x2154 as libc::c_int as s16
        } else { (*this).targetPitch = 0x954 as libc::c_int as s16 }
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           (*this).targetPitch, 0x100 as libc::c_int as s16);
    }
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Rebound(mut this: *mut EnFirefly,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x100 as libc::c_int as s16);
    Math_StepToF(&mut (*this).actor.velocity.y, 0.0f32, 0.4f32);
    if Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.15f32) != 0 {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
        if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_FlyAway(mut this: *mut EnFirefly,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if fabsf((*this).actor.world.pos.y - (*this).maxAltitude) < 10.0f32 &&
           Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
                             &mut (*this).actor.home.pos) < 20.0f32 ||
           (*this).timer as libc::c_int == 0 as libc::c_int {
        EnFirefly_SetupFlyIdle(this);
        return
    }
    Math_StepToF(&mut (*this).actor.speedXZ, 3.0f32, 0.3f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).targetPitch = 0x954 as libc::c_int as s16
    } else if (*this).actor.bgCheckFlags as libc::c_int & 0x10 as libc::c_int
                  != 0 || (*this).maxAltitude < (*this).actor.world.pos.y {
        (*this).targetPitch = 0x2154 as libc::c_int as s16
    } else { (*this).targetPitch = 0x954 as libc::c_int as s16 }
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
    ...
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x, (*this).targetPitch,
                       0x100 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Stunned(mut this: *mut EnFirefly,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.5f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_FrozenFall(mut this: *mut EnFirefly,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 ||
        ...
        EnFirefly_SetupDie(this);
    } else { (*this).actor.colorFilterTimer = 255 as libc::c_int as u8_0 };
}
// When perching, sit on collision and flap at random intervals
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Perch(mut this: *mut EnFirefly,
                                         mut globalCtx: *mut GlobalContext) {
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x100 as libc::c_int as s16);
    if (*this).timer as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_DisturbDiveAttack(mut this: *mut EnFirefly,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Combust(mut this: *mut EnFirefly,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <= 2 as libc::c_int {
        EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                  ...
                                  0 as libc::c_int as s16, i as s16);
        i += 1
    }
    (*this).auraType = KEESE_AURA_NONE as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_UpdateDamage(mut this: *mut EnFirefly,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut damageEffect: u8_0 = 0;
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if damageEffect as libc::c_int == 2 as libc::c_int {
                // Din's Fire
                if (*this).actor.params as libc::c_int ==
                       KEESE_ICE_FLY as libc::c_int {
            ...
            } else if damageEffect as libc::c_int == 3 as libc::c_int {
                // Ice Arrows or Ice Magic
                if (*this).actor.params as libc::c_int ==
                       KEESE_ICE_FLY as libc::c_int {
                    EnFirefly_SetupFall(this); // Fire Arrows
                } else { EnFirefly_SetupFrozenFall(this, globalCtx); }
            } else if damageEffect as libc::c_int == 1 as libc::c_int {
                // Deku Nuts
                if (*this).actionFunc !=
                       Some(EnFirefly_Stunned as
                                unsafe extern "C" fn(_: *mut EnFirefly,
                ...
                if damageEffect as libc::c_int == 0xf as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Update(mut thisx: *mut Actor,
                                          mut globalCtx2:
                                              *mut GlobalContext) {
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly;
    ...
    if (*this).collider.base.atFlags as libc::c_int &
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3840 as libc::c_int as u16_0);
        if (*this).onFire != 0 { EnFirefly_Extinguish(this); }
        if (*this).actionFunc !=
               Some(EnFirefly_DisturbDiveAttack as
                        unsafe extern "C" fn(_: *mut EnFirefly,
                                             _: *mut GlobalContext) -> ()) {
    ...
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int {
        ...
        if Animation_OnFrame(&mut (*this).skelAnime, 5.0f32) != 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3841 as libc::c_int as u16_0);
        }
    }
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider.base);
    (*this).actor.focus.pos.x =
        10.0f32 * Math_SinS((*this).actor.shape.rot.x) *
            Math_SinS((*this).actor.shape.rot.y) + (*this).actor.world.pos.x;
    (*this).actor.focus.pos.y =
        10.0f32 * Math_CosS((*this).actor.shape.rot.x) +
            (*this).actor.world.pos.y;
    (*this).actor.focus.pos.z =
        10.0f32 * Math_SinS((*this).actor.shape.rot.x) *
            Math_CosS((*this).actor.shape.rot.y) + (*this).actor.world.pos.z;
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
    ...
    if (*this).actor.draw ==
           Some(EnFirefly_DrawInvisible as
                    unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                        -> ()) &&
           (*globalCtx).actorCtx.unk_03 as libc::c_int == 0 as libc::c_int {
        *dList = 0 as *mut Gfx
    } else if limbIndex == 1 as libc::c_int { (*pos).y += 2300.0f32 }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_PostLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut rot: *mut Vec3s,
                                                ...
                                                mut gfx: *mut *mut Gfx) {
    static mut fireAuraPrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut fireAuraEnvColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 255 as libc::c_int as u8_0,
    ...
    static mut iceAuraPrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut iceAuraEnvColor: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut effVelocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
    static mut effAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
    static mut limbSrc: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut effPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut limbDest: *mut Vec3f = 0 as *mut Vec3f;
    let mut effPrimColor: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut effEnvColor: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut mtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut effScaleStep: s16 = 0;
    let mut effLife: s16 = 0;
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly;
    if (*this).onFire == 0 && limbIndex == 27 as libc::c_int {
        let fresh0 = *gfx;
        *gfx = (*gfx).offset(1);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g).words.w1 = gKeeseEyesDL.as_mut_ptr() as libc::c_uint
    } else if (*this).auraType as libc::c_int ==
                  KEESE_AURA_FIRE as libc::c_int ||
                  (*this).auraType as libc::c_int ==
                      KEESE_AURA_ICE as libc::c_int {
        if limbIndex == 15 as libc::c_int || limbIndex == 21 as libc::c_int {
            if (*this).actionFunc !=
                   Some(EnFirefly_Die as
                            unsafe extern "C" fn(_: *mut EnFirefly,
                                                 _: *mut GlobalContext) -> ())
               {
                Matrix_Get(&mut mtx);
                effPos.x = Rand_ZeroOne() * 5.0f32 + mtx.c2rust_unnamed.xw;
                effPos.y = Rand_ZeroOne() * 5.0f32 + mtx.c2rust_unnamed.yw;
                effPos.z = Rand_ZeroOne() * 5.0f32 + mtx.c2rust_unnamed.zw;
                effScaleStep = -(40 as libc::c_int) as s16;
                effLife = 3 as libc::c_int as s16
            } else {
                if limbIndex == 15 as libc::c_int {
                    effPos.x =
                        Math_SinS((9100 as libc::c_int *
                                       (*this).timer as libc::c_int) as s16) *
                            (*this).timer as libc::c_int as libc::c_float +
                            (*this).actor.world.pos.x;
                    effPos.z =
                        Math_CosS((9100 as libc::c_int *
                                       (*this).timer as libc::c_int) as s16) *
                            (*this).timer as libc::c_int as libc::c_float +
                            (*this).actor.world.pos.z
                } else {
                ...
                effPos.y =
                    (*this).actor.world.pos.y +
                        (15 as libc::c_int - (*this).timer as libc::c_int) as
                            libc::c_float * 1.5f32;
                effScaleStep = -(5 as libc::c_int) as s16;
                effLife = 10 as libc::c_int as s16
            }
            if (*this).auraType as libc::c_int ==
                   KEESE_AURA_FIRE as libc::c_int {
                effPrimColor = &mut fireAuraPrimColor;
                effEnvColor = &mut fireAuraEnvColor
            } else {
                effPrimColor = &mut iceAuraPrimColor;
                effEnvColor = &mut iceAuraEnvColor
            }
            func_8002843C(globalCtx, &mut effPos, &mut effVelocity,
                          &mut effAccel, effPrimColor, effEnvColor,
                          250 as libc::c_int as s16, effScaleStep, effLife);
        }
    }
    if limbIndex == 15 as libc::c_int || limbIndex == 21 as libc::c_int ||
           limbIndex == 10 as libc::c_int {
        if limbIndex == 15 as libc::c_int {
            limbDest =
                &mut *(*this).bodyPartsPos.as_mut_ptr().offset(0 as
                                                                   ...
                                                                   as isize)
                    as *mut Vec3f
        } else if limbIndex == 21 as libc::c_int {
            limbDest =
                &mut *(*this).bodyPartsPos.as_mut_ptr().offset(1 as
                                                                   libc::c_int
                                                                   as isize)
                    as *mut Vec3f
        } else {
            limbDest =
                &mut *(*this).bodyPartsPos.as_mut_ptr().offset(2 as
                                                                   libc::c_int
                                                                   as isize)
                    as *mut Vec3f
        }
        Matrix_MultVec3f(&mut limbSrc, limbDest);
        (*limbDest).y -= 5.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_firefly.c\x00" as *const u8 as
    ...
    (*__gfxCtx).polyOpa.p =
        SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                       ...
                       Some(EnFirefly_OverrideLimbDraw as
                                unsafe extern "C" fn(_: *mut GlobalContext,
                                                     ...
                                                     _: *mut *mut Gfx)
                                    -> s32),
                       Some(EnFirefly_PostLimbDraw as
                                unsafe extern "C" fn(_: *mut GlobalContext,
                                                     _: s32, _: *mut *mut Gfx,
                                                     _: *mut Vec3s,
                                                     _: *mut libc::c_void,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_firefly.c\x00" as *const u8 as
                         *const libc::c_char, 1763 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnFirefly_DrawInvisible(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnFirefly = thisx as *mut EnFirefly;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_firefly.c\x00" as *const u8 as
                        *const libc::c_char, 1775 as libc::c_int);
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_firefly.c\x00" as *const u8 as
                         *const libc::c_char, 1805 as libc::c_int);
}
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(-(4 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
