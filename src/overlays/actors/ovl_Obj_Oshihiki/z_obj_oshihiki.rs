...
extern "C" {
    ...
    #[no_mangle]
    fn BgCheck_EntityRaycastFloor6(colCtx: *mut CollisionContext,
                                   outPoly: *mut *mut CollisionPoly,
                                   bgId: *mut s32, actor: *mut Actor,
                                   pos: *mut Vec3f, chkDist: f32_0) -> f32_0;
    #[no_mangle]
    fn BgCheck_EntityLineTest3(colCtx: *mut CollisionContext,
    ...
    #[no_mangle]
    static mut gPushBlockSilverTex: [u64_0; 0];
    #[no_mangle]
    static mut gPushBlockBaseTex: [u64_0; 0];
    #[no_mangle]
    static mut gPushBlockGrayTex: [u64_0; 0];
    #[no_mangle]
    static mut gPushBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gPushBlockCol: CollisionHeader;
}
...
pub const PLAYER_STR_MAX: C2RustUnnamed_16 = 4;
pub const PLAYER_STR_GOLD_G: C2RustUnnamed_16 = 3;
pub const PLAYER_STR_SILVER_G: C2RustUnnamed_16 = 2;
pub const PLAYER_STR_BRACELET: C2RustUnnamed_16 = 1;
pub const PLAYER_STR_NONE: C2RustUnnamed_16 = 0;
...
pub struct ObjOshihiki {
    ...
    pub actionFunc: ObjOshihikiActionFunc,
    ...
    pub pushDist: f32_0,
    pub direction: f32_0,
    pub floorBgIds: [s32; 5],
    pub floorPolys: [*mut CollisionPoly; 5],
    pub floorHeights: [f32_0; 5],
    pub highestFloor: s16,
    pub cantMove: u8_0,
    pub blockUnder: *mut ObjOshihiki,
    pub underDistX: f32_0,
    pub underDistZ: f32_0,
    pub texture: *mut libc::c_void,
    pub color: Color_RGB8,
}
pub type ObjOshihikiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjOshihiki, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const PUSHBLOCK_HUGE_START_OFF: C2RustUnnamed_21 = 7;
pub const PUSHBLOCK_LARGE_START_OFF: C2RustUnnamed_21 = 6;
pub const PUSHBLOCK_MEDIUM_START_OFF: C2RustUnnamed_21 = 5;
pub const PUSHBLOCK_SMALL_START_OFF: C2RustUnnamed_21 = 4;
pub const PUSHBLOCK_HUGE_START_ON: C2RustUnnamed_21 = 3;
pub const PUSHBLOCK_LARGE_START_ON: C2RustUnnamed_21 = 2;
pub const PUSHBLOCK_MEDIUM_START_ON: C2RustUnnamed_21 = 1;
pub const PUSHBLOCK_SMALL_START_ON: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut Obj_Oshihiki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_OSHIHIKI as libc::c_int as s16,
                          ...
                          objectId:
                              OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as
                                  s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjOshihiki>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjOshihiki_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjOshihiki_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjOshihiki_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjOshihiki_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sScales: [f32_0; 8] =
    [1 as libc::c_int as libc::c_float / 10.0f32,
     1 as libc::c_int as libc::c_float / 6.0f32,
     1 as libc::c_int as libc::c_float / 5.0f32,
     1 as libc::c_int as libc::c_float / 3.0f32,
     1 as libc::c_int as libc::c_float / 10.0f32,
     1 as libc::c_int as libc::c_float / 6.0f32,
     1 as libc::c_int as libc::c_float / 5.0f32,
     1 as libc::c_int as libc::c_float / 3.0f32];
static mut sColors: [[Color_RGB8; 4]; 9] =
    [[{
          let mut init =
              Color_RGB8{r: 110 as libc::c_int as u8_0,
                         g: 86 as libc::c_int as u8_0,
     ...
     [{
          let mut init =
              Color_RGB8{r: 106 as libc::c_int as u8_0,
      ...
      {
          let mut init =
              Color_RGB8{r: 104 as libc::c_int as u8_0,
     ...
     [{
          let mut init =
              Color_RGB8{r: 142 as libc::c_int as u8_0,
                         g: 99 as libc::c_int as u8_0,
                         b: 86 as libc::c_int as u8_0,};
          init
      },
      {
          let mut init =
              Color_RGB8{r: 72 as libc::c_int as u8_0,
                         g: 118 as libc::c_int as u8_0,
     ...
     [{
          let mut init =
              Color_RGB8{r: 102 as libc::c_int as u8_0,
                         g: 144 as libc::c_int as u8_0,
                         b: 182 as libc::c_int as u8_0,};
          init
      },
      {
          let mut init =
              Color_RGB8{r: 176 as libc::c_int as u8_0,
                         g: 167 as libc::c_int as u8_0,
      ...
      {
          let mut init =
              Color_RGB8{r: 117 as libc::c_int as u8_0,
                         g: 97 as libc::c_int as u8_0,
                         b: 96 as libc::c_int as u8_0,};
          init
      }],
     [{
          let mut init =
              Color_RGB8{r: 232 as libc::c_int as u8_0,
                         g: 210 as libc::c_int as u8_0,
                         b: 176 as libc::c_int as u8_0,};
          init
      },
      {
          let mut init =
     ...
     [{
          let mut init =
              Color_RGB8{r: 135 as libc::c_int as u8_0,
                         g: 125 as libc::c_int as u8_0,
                         b: 95 as libc::c_int as u8_0,};
          init
      },
      {
          let mut init =
...
static mut sScenes: [s16; 9] =
    [SCENE_YDAN as libc::c_int as s16, SCENE_DDAN as libc::c_int as s16,
     SCENE_BMORI1 as libc::c_int as s16, SCENE_HIDAN as libc::c_int as s16,
     SCENE_MIZUSIN as libc::c_int as s16,
     SCENE_JYASINZOU as libc::c_int as s16,
     SCENE_HAKADAN as libc::c_int as s16, SCENE_GANON as libc::c_int as s16,
     SCENE_MEN as libc::c_int as s16];
...
static mut sColCheckPoints: [Vec3f; 5] =
    [{ let mut init = Vec3f{x: 29.99f32, y: 1.01f32, z: -29.99f32,}; init },
     { let mut init = Vec3f{x: -29.99f32, y: 1.01f32, z: -29.99f32,}; init },
     { let mut init = Vec3f{x: -29.99f32, y: 1.01f32, z: 29.99f32,}; init },
     { let mut init = Vec3f{x: 29.99f32, y: 1.01f32, z: 29.99f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 1.01f32, z: 0.0f32,}; init }];
static mut sFaceVtx: [Vec2f; 4] =
    [{ let mut init = Vec2f{x: -30.0f32, y: 0.0f32,}; init },
     { let mut init = Vec2f{x: 30.0f32, y: 0.0f32,}; init },
     { let mut init = Vec2f{x: -30.0f32, y: 60.0f32,}; init },
     { let mut init = Vec2f{x: 30.0f32, y: 60.0f32,}; init }];
static mut sFaceDirection: [Vec2f; 4] =
    [{ let mut init = Vec2f{x: 1.0f32, y: 1.0f32,}; init },
     { let mut init = Vec2f{x: -1.0f32, y: 1.0f32,}; init },
     { let mut init = Vec2f{x: 1.0f32, y: -1.0f32,}; init },
     { let mut init = Vec2f{x: -1.0f32, y: -1.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_InitDynapoly(mut this: *mut ObjOshihiki,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut collision:
                                                      *mut CollisionHeader,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_obj_oshihiki.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_RotateXZ(mut out: *mut Vec3f,
                                              mut in_0: *mut Vec3f,
                                              mut sn: f32_0, mut cs: f32_0) {
    (*out).x = (*in_0).z * sn + (*in_0).x * cs;
    (*out).y = (*in_0).y;
    (*out).z = (*in_0).z * cs - (*in_0).x * sn;
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_StrongEnough(mut this: *mut ObjOshihiki)
 -> s32 {
    let mut strength: s32 = 0;
    if (*this).cantMove != 0 { return 0 as libc::c_int }
    strength = Player_GetStrength();
    match (*this).dyna.actor.params as libc::c_int & 0xf as libc::c_int {
        0 | 1 | 4 | 5 => { return 1 as libc::c_int }
        2 | 6 => {
            return (strength >= PLAYER_STR_BRACELET as libc::c_int) as
                       libc::c_int
        }
        3 | 7 => {
            return (strength >= PLAYER_STR_SILVER_G as libc::c_int) as
                       libc::c_int
        }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_ResetFloors(mut this: *mut ObjOshihiki) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[s32; 5]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s32>() as
                                                   libc::c_ulong) as s32 {
        (*this).floorBgIds[i as usize] = 50 as libc::c_int;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_GetBlockUnder(mut this: *mut ObjOshihiki,
                                                   mut globalCtx:
                                                       *mut GlobalContext)
 -> *mut ObjOshihiki {
    let mut dynaPolyActor: *mut DynaPolyActor = 0 as *mut DynaPolyActor;
    if (*this).floorBgIds[(*this).highestFloor as usize] != 50 as libc::c_int
           &&
           fabsf((*this).dyna.actor.floorHeight -
                     (*this).dyna.actor.world.pos.y) < 0.001f32 {
        dynaPolyActor =
            DynaPoly_GetActor(&mut (*globalCtx).colCtx,
                              (*this).floorBgIds[(*this).highestFloor as
                                                     usize]);
        if !dynaPolyActor.is_null() &&
               (*dynaPolyActor).actor.id as libc::c_int ==
                   ACTOR_OBJ_OSHIHIKI as libc::c_int {
            return dynaPolyActor as *mut ObjOshihiki
        }
    }
    return 0 as *mut ObjOshihiki;
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_UpdateInitPos(mut this:
                                                       *mut ObjOshihiki) {
    if (*this).dyna.actor.home.pos.x < (*this).dyna.actor.world.pos.x {
        while (*this).dyna.actor.world.pos.x - (*this).dyna.actor.home.pos.x
                  >= 20.0f32 {
            (*this).dyna.actor.home.pos.x += 20.0f32
        }
    } else {
        while (*this).dyna.actor.home.pos.x - (*this).dyna.actor.world.pos.x
                  >= 20.0f32 {
            (*this).dyna.actor.home.pos.x -= 20.0f32
        }
    }
    if (*this).dyna.actor.home.pos.z < (*this).dyna.actor.world.pos.z {
        while (*this).dyna.actor.world.pos.z - (*this).dyna.actor.home.pos.z
                  >= 20.0f32 {
            (*this).dyna.actor.home.pos.z += 20.0f32
        }
    } else {
        while (*this).dyna.actor.home.pos.z - (*this).dyna.actor.world.pos.z
                  >= 20.0f32 {
            (*this).dyna.actor.home.pos.z -= 20.0f32
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_NoSwitchPress(mut this: *mut ObjOshihiki,
                                                   mut dyna:
                                                       *mut DynaPolyActor,
                                                   mut globalCtx:
                                                       *mut GlobalContext)
 -> s32 {
    let mut dynaSwitchFlag: s16 = 0;
    if dyna.is_null() {
        return 1 as libc::c_int
    } else {
        if (*dyna).actor.id as libc::c_int == ACTOR_OBJ_SWITCH as libc::c_int
           {
            dynaSwitchFlag =
                ((*dyna).actor.params as libc::c_int >> 8 as libc::c_int &
                     0x3f as libc::c_int) as s16;
            match (*dyna).actor.params as libc::c_int & 0x33 as libc::c_int {
                32 => {
                    // Normal blue switch
                    if dynaSwitchFlag as libc::c_int ==
                           (*this).dyna.actor.params as libc::c_int >>
                               8 as libc::c_int & 0x3f as libc::c_int &&
                           Flags_GetSwitch(globalCtx, dynaSwitchFlag as s32)
                               != 0 {
                        return 0 as libc::c_int
                    }
                }
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_CheckType(mut this: *mut ObjOshihiki,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xf as libc::c_int {
        0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 => {
            ObjOshihiki_InitDynapoly(this, globalCtx, &mut gPushBlockCol,
                                     1 as libc::c_int);
        }
        _ => {
            // "Error : type cannot be determined"
            osSyncPrintf(b"Error : \xe3\x82\xbf\xe3\x82\xa4\xe3\x83\x97\xe3\x81\x8c\xe5\x88\xa4\xe5\x88\xa5\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_oshihiki.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetScale(mut this: *mut ObjOshihiki,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Actor_SetScale(&mut (*this).dyna.actor,
                   sScales[((*this).dyna.actor.params as libc::c_int &
                                0xf as libc::c_int) as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetTexture(mut this: *mut ObjOshihiki,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xf as libc::c_int {
        0 | 1 | 4 | 5 => {
            (*this).texture =
                gPushBlockSilverTex.as_mut_ptr() as *mut libc::c_void
        }
        2 | 6 => {
            (*this).texture =
                gPushBlockBaseTex.as_mut_ptr() as *mut libc::c_void
        }
        3 | 7 => {
            (*this).texture =
                gPushBlockGrayTex.as_mut_ptr() as *mut libc::c_void
        }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetColor(mut this: *mut ObjOshihiki,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut src: *mut Color_RGB8 = 0 as *mut Color_RGB8;
    let mut color: *mut Color_RGB8 = &mut (*this).color;
    let mut paramsColorIdx: s16 = 0;
    let mut i: s32 = 0;
    paramsColorIdx =
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[s16; 9]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        if sScenes[i as usize] as libc::c_int ==
    ...
    if i >=
           (::std::mem::size_of::<[[Color_RGB8; 4]; 9]>() as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<[Color_RGB8; 4]>()
                                                as libc::c_ulong) as s32 {
        // "Error : scene_data_ID cannot be determined"
        osSyncPrintf(b"Error : scene_data_ID \xe3\x81\x8c\xe5\x88\xa4\xe5\x88\xa5\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xaa\xe3\x81\x84\xe3\x80\x82(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_oshihiki.c\x00" as *const u8 as
                         *const libc::c_char, 579 as libc::c_int);
        (*color).b = 255 as libc::c_int as u8_0;
        (*color).g = (*color).b;
        (*color).r = (*color).g
    } else {
        src =
            &mut *(*sColors.as_mut_ptr().offset(i as
                                                    isize)).as_mut_ptr().offset(paramsColorIdx
                                                                                    as
                                                                                    isize)
                as *mut Color_RGB8;
        (*color).r = (*src).r;
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Init(mut thisx: *mut Actor,
                                          mut globalCtx2:
                                              *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut ObjOshihiki = thisx as *mut ObjOshihiki;
    ObjOshihiki_CheckType(this, globalCtx);
    if (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
           0xff as libc::c_int >= 0 as libc::c_int &&
           (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
               0xff as libc::c_int <= 0x3f as libc::c_int {
    ...
    osSyncPrintf(b"(dungeon keep \xe6\x8a\xbc\xe3\x81\x97\xe5\xbc\x95\xe3\x81\x8d\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjOshihiki = thisx as *mut ObjOshihiki;
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetFloors(mut this: *mut ObjOshihiki,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        let mut colCheckPoint: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut colCheckOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut floorPoly: *mut *mut CollisionPoly =
            0 as *mut *mut CollisionPoly;
        let mut floorBgId: *mut s32 = 0 as *mut s32;
        colCheckOffset.x =
            sColCheckPoints[i as usize].x *
                ((*this).dyna.actor.scale.x * 10.0f32);
        colCheckOffset.y =
            sColCheckPoints[i as usize].y *
                ((*this).dyna.actor.scale.y * 10.0f32);
        colCheckOffset.z =
            sColCheckPoints[i as usize].z *
                ((*this).dyna.actor.scale.z * 10.0f32);
        ObjOshihiki_RotateXZ(&mut colCheckPoint, &mut colCheckOffset,
                             (*this).yawSin, (*this).yawCos);
        ...
        floorPoly =
            &mut *(*this).floorPolys.as_mut_ptr().offset(i as isize) as
                *mut *mut CollisionPoly;
        floorBgId =
            &mut *(*this).floorBgIds.as_mut_ptr().offset(i as isize) as
                *mut s32;
        (*this).floorHeights[i as usize] =
            BgCheck_EntityRaycastFloor6(&mut (*globalCtx).colCtx, floorPoly,
                                        floorBgId, &mut (*this).dyna.actor,
                                        &mut colCheckPoint, 0.0f32);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_GetHighestFloor(mut this:
                                                         *mut ObjOshihiki)
 -> s16 {
    let mut highestFloor: s16 = 0 as libc::c_int as s16;
    let mut temp: s16 = 1 as libc::c_int as s16;
    let mut phi_f0: f32_0 = (*this).floorHeights[temp as usize];
    if phi_f0 > (*this).floorHeights[highestFloor as usize] {
        highestFloor = temp
    } else if (*this).floorBgIds[temp as usize] == 50 as libc::c_int &&
                  phi_f0 - (*this).floorHeights[highestFloor as usize] >
                      -0.001f32 {
        highestFloor = temp
    }
    if (*this).floorHeights[(temp as libc::c_int + 1 as libc::c_int) as usize]
           > (*this).floorHeights[highestFloor as usize] {
        highestFloor = (temp as libc::c_int + 1 as libc::c_int) as s16
    } else if (*this).floorBgIds[(temp as libc::c_int + 1 as libc::c_int) as
                                     usize] == 50 as libc::c_int &&
                  (*this).floorHeights[(temp as libc::c_int +
                                            1 as libc::c_int) as usize] -
                      (*this).floorHeights[highestFloor as usize] > -0.001f32
     {
        highestFloor = (temp as libc::c_int + 1 as libc::c_int) as s16
    }
    if (*this).floorHeights[(temp as libc::c_int + 2 as libc::c_int) as usize]
           > (*this).floorHeights[highestFloor as usize] {
        highestFloor = (temp as libc::c_int + 2 as libc::c_int) as s16
    } else if (*this).floorBgIds[(temp as libc::c_int + 2 as libc::c_int) as
                                     usize] == 50 as libc::c_int &&
                  (*this).floorHeights[(temp as libc::c_int +
    ...
    if (*this).floorHeights[(temp as libc::c_int + 3 as libc::c_int) as usize]
           > (*this).floorHeights[highestFloor as usize] {
        highestFloor = (temp as libc::c_int + 3 as libc::c_int) as s16
    } else if (*this).floorBgIds[(temp as libc::c_int + 3 as libc::c_int) as
                                     usize] == 50 as libc::c_int &&
                  (*this).floorHeights[(temp as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetGround(mut this: *mut ObjOshihiki,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ObjOshihiki_ResetFloors(this);
    ...
    (*this).dyna.actor.floorHeight =
        (*this).floorHeights[(*this).highestFloor as usize];
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_CheckFloor(mut this: *mut ObjOshihiki,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_CheckGround(mut this: *mut ObjOshihiki,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> s32 {
    if (*this).dyna.actor.world.pos.y <= -32000.0f32 + 10.0f32 {
        // "Warning : Push-pull block fell too much"
        osSyncPrintf(b"Warning : \xe6\x8a\xbc\xe3\x81\x97\xe5\xbc\x95\xe3\x81\x8d\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf\xe8\x90\xbd\xe3\x81\xa1\xe3\x81\x99\xe3\x81\x8e\xe3\x81\x9f(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_oshihiki.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_CheckWall(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut angle: s16,
                                               mut direction: f32_0,
                                               mut this: *mut ObjOshihiki)
 -> s32 {
    let mut maxDist: f32_0 =
        (if direction >= 0.0f32 { 1.0f32 } else { -1.0f32 }) *
            (300.0f32 * (*this).dyna.actor.scale.x + 20.0f32 - 0.5f32);
    let mut sn: f32_0 = Math_SinS(angle);
    let mut cs: f32_0 = Math_CosS(angle);
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        let mut faceVtx: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut faceVtxNext: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut posResult: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut faceVtxOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut bgId: s32 = 0;
        let mut outPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
        faceVtxOffset.x =
            sFaceVtx[i as usize].x * (*this).dyna.actor.scale.x * 10.0f32 +
                sFaceDirection[i as usize].x;
        faceVtxOffset.y =
            sFaceVtx[i as usize].y * (*this).dyna.actor.scale.y * 10.0f32 +
                sFaceDirection[i as usize].y;
        faceVtxOffset.z = 0.0f32;
        ObjOshihiki_RotateXZ(&mut faceVtx, &mut faceVtxOffset, sn, cs);
        ...
        if BgCheck_EntityLineTest3(&mut (*globalCtx).colCtx, &mut faceVtx,
                                   &mut faceVtxNext, &mut posResult,
                                   &mut outPoly, 1 as libc::c_int,
                                   0 as libc::c_int, 0 as libc::c_int,
                                   1 as libc::c_int, &mut bgId,
                                   &mut (*this).dyna.actor, 0.0f32) != 0 {
            return 1 as libc::c_int
        }
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_MoveWithBlockUnder(mut this:
                                                            *mut ObjOshihiki,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut blockUnder: *mut ObjOshihiki =
        ObjOshihiki_GetBlockUnder(this, globalCtx);
    if !blockUnder.is_null() &&
           (*blockUnder).stateFlags as libc::c_int &
               (1 as libc::c_int) << 5 as libc::c_int != 0 &&
           ObjOshihiki_CheckWall(globalCtx, (*blockUnder).dyna.unk_158,
                                 (*blockUnder).direction, this) == 0 {
        (*this).blockUnder = blockUnder
    }
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 8 as libc::c_int != 0 &&
           !(*this).blockUnder.is_null() {
        if (*(*this).blockUnder).stateFlags as libc::c_int &
               (1 as libc::c_int) << 4 as libc::c_int != 0 {
            (*this).underDistX =
                (*(*this).blockUnder).dyna.actor.world.pos.x -
                    (*(*this).blockUnder).dyna.actor.prevPos.x;
            (*this).underDistZ =
                (*(*this).blockUnder).dyna.actor.world.pos.z -
                    (*(*this).blockUnder).dyna.actor.prevPos.z;
            ...
            if (*(*this).blockUnder).stateFlags as libc::c_int &
                   (1 as libc::c_int) << 5 as libc::c_int == 0 {
                (*this).blockUnder = 0 as *mut ObjOshihiki
            }
        }
    }
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetupOnScene(mut this: *mut ObjOshihiki,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).stateFlags =
    ...
    (*this).actionFunc =
        Some(ObjOshihiki_OnScene as
                 unsafe extern "C" fn(_: *mut ObjOshihiki,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.gravity = 0.0f32;
    (*this).dyna.actor.velocity.z = 0.0f32;
    (*this).dyna.actor.velocity.y = (*this).dyna.actor.velocity.z;
    (*this).dyna.actor.velocity.x = (*this).dyna.actor.velocity.y;
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_OnScene(mut this: *mut ObjOshihiki,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if (*this).timer as libc::c_int <= 0 as libc::c_int &&
           fabsf((*this).dyna.unk_150) > 0.001f32 {
        if ObjOshihiki_StrongEnough(this) != 0 &&
               ObjOshihiki_CheckWall(globalCtx, (*this).dyna.unk_158,
                                     (*this).dyna.unk_150, this) == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetupOnActor(mut this: *mut ObjOshihiki,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_OnActor(mut this: *mut ObjOshihiki,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut bgId: s32 = 0;
    let mut player: *mut Player =
    ...
    if ObjOshihiki_CheckFloor(this, globalCtx) != 0 {
        bgId = (*this).floorBgIds[(*this).highestFloor as usize];
        if bgId == 50 as libc::c_int {
            ObjOshihiki_SetupOnScene(this, globalCtx);
        } else {
            dynaPolyActor = DynaPoly_GetActor(&mut (*globalCtx).colCtx, bgId);
            if !dynaPolyActor.is_null() {
                ...
                if (*this).timer as libc::c_int <= 0 as libc::c_int &&
                       fabsf((*this).dyna.unk_150) > 0.001f32 {
                    if ObjOshihiki_StrongEnough(this) != 0 &&
                           ObjOshihiki_NoSwitchPress(this, dynaPolyActor,
                                                     globalCtx) != 0 &&
                           ObjOshihiki_CheckWall(globalCtx,
                                                 (*this).dyna.unk_158,
                                                 (*this).dyna.unk_150, this)
                               == 0 {
                        (*this).direction = (*this).dyna.unk_150;
                        ObjOshihiki_SetupPush(this, globalCtx);
                    } else {
            ...
            } else { ObjOshihiki_SetupOnScene(this, globalCtx); }
        }
    } else {
        bgId = (*this).floorBgIds[(*this).highestFloor as usize];
        if bgId == 50 as libc::c_int {
            ...
            dynaPolyActor = DynaPoly_GetActor(&mut (*globalCtx).colCtx, bgId);
            if !dynaPolyActor.is_null() &&
                   (*dynaPolyActor).unk_15C & 1 as libc::c_int as libc::c_uint
                       != 0 {
                func_800434A8(dynaPolyActor);
                func_80043538(dynaPolyActor);
                (*this).dyna.actor.world.pos.y =
                    (*this).dyna.actor.floorHeight
            } else { ObjOshihiki_SetupFall(this, globalCtx); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetupPush(mut this: *mut ObjOshihiki,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
    ...
    (*this).actionFunc =
        Some(ObjOshihiki_Push as
                 unsafe extern "C" fn(_: *mut ObjOshihiki,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.gravity = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Push(mut this: *mut ObjOshihiki,
                                          mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut pushDistSigned: f32_0 = 0.;
    let mut stopFlag: s32 = 0;
    (*this).pushSpeed += 0.5f32;
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
             (1 as libc::c_int) << 4 as libc::c_int) as u16_0;
    (*this).pushSpeed =
        if (*this).pushSpeed > 2.0f32 { 2.0f32 } else { (*this).pushSpeed };
    stopFlag =
        Math_StepToF(&mut (*this).pushDist, 20.0f32, (*this).pushSpeed);
    pushDistSigned =
        (if (*this).direction >= 0.0f32 { 1.0f32 } else { -1.0f32 }) *
            (*this).pushDist;
    (*thisx).world.pos.x =
        (*thisx).home.pos.x + pushDistSigned * (*this).yawSin;
    (*thisx).world.pos.z =
        (*thisx).home.pos.z + pushDistSigned * (*this).yawCos;
    if ObjOshihiki_CheckFloor(this, globalCtx) == 0 {
        (*thisx).home.pos.x = (*thisx).world.pos.x;
        (*thisx).home.pos.z = (*thisx).world.pos.z;
        (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint;
        (*this).dyna.unk_150 = 0.0f32;
        (*this).pushDist = 0.0f32;
        (*this).pushSpeed = 0.0f32;
        ObjOshihiki_SetupFall(this, globalCtx);
    } else if stopFlag != 0 {
        player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        if ObjOshihiki_CheckWall(globalCtx, (*this).dyna.unk_158,
                                 (*this).dyna.unk_150, this) != 0 {
            Audio_PlayActorSound2(thisx, 0x2835 as libc::c_int as u16_0);
        }
        (*thisx).home.pos.x = (*thisx).world.pos.x;
        (*thisx).home.pos.z = (*thisx).world.pos.z;
        (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint;
        ...
        (*this).pushDist = 0.0f32;
        (*this).pushSpeed = 0.0f32;
        (*this).timer = 10 as libc::c_int as s16;
        if (*this).floorBgIds[(*this).highestFloor as usize] ==
               50 as libc::c_int {
            ObjOshihiki_SetupOnScene(this, globalCtx);
        } else { ObjOshihiki_SetupOnActor(this, globalCtx); }
    }
    Audio_PlayActorSound2(thisx,
                          (0x280a as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_SetupFall(mut this: *mut ObjOshihiki,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
    ...
    ObjOshihiki_SetGround(this, globalCtx);
    (*this).actionFunc =
        Some(ObjOshihiki_Fall as
                 unsafe extern "C" fn(_: *mut ObjOshihiki,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Fall(mut this: *mut ObjOshihiki,
                                          mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if fabsf((*this).dyna.unk_150) > 0.001f32 {
        (*this).dyna.unk_150 = 0.0f32;
        (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint
    }
    Actor_MoveForward(&mut (*this).dyna.actor);
    if ObjOshihiki_CheckGround(this, globalCtx) != 0 {
        if (*this).floorBgIds[(*this).highestFloor as usize] ==
               50 as libc::c_int {
            ObjOshihiki_SetupOnScene(this, globalCtx);
        } else { ObjOshihiki_SetupOnActor(this, globalCtx); }
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjOshihiki = thisx as *mut ObjOshihiki;
...
#[no_mangle]
pub unsafe extern "C" fn ObjOshihiki_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjOshihiki = thisx as *mut ObjOshihiki;
    ...
    if ObjOshihiki_MoveWithBlockUnder(this, globalCtx) != 0 {
        Matrix_Translate((*this).underDistX * 10.0f32, 0.0f32,
                         (*this).underDistZ * 10.0f32,
    ...
    (*_g).words.w1 =
        gSegments[(((*this).texture as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*this).texture as u32_0 &
        ...
        0 | 1 | 3 | 4 | 5 | 6 | 7 | 11 => {
            ...
            (*_g_1).words.w0 =
                (0xfb as libc::c_int as u32_0 &
                    ...
                    24 as libc::c_int;
            (*_g_1).words.w1 =
                ((*this).color.r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    ((*this).color.g as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*this).color.b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gPushBlockDL.as_mut_ptr() as libc::c_uint;
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(1800 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
