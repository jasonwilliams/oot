...
#[no_mangle]
pub static mut Effect_Ss_Bomb_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_BOMB as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsBomb_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb_Init(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs,
                                           mut initParamsx: *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsBombInitParams =
        initParamsx as *mut EffectSsBombInitParams;
    ...
    (*this).draw =
        Some(EffectSsBomb_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsBomb_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[0 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[1 as libc::c_int as usize] = 0 as libc::c_int as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb_Draw(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs) {
    static mut explosionTextures: [*mut libc::c_void; 4] =
        unsafe {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_bomb.c\x00" as *const u8 as
    ...
    if !mtx.is_null() {
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((explosionTextures[(*this).regs[1 as libc::c_int as
                                                           usize] as usize] as
                            u32_0) << 4 as libc::c_int >> 28 as libc::c_int)
                          as
                          usize].wrapping_add(explosionTextures[(*this).regs[1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 usize]
        ...
        color =
            ((*this).life as libc::c_int as libc::c_float * 12.75f32) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb_Update(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    if ((*this).life as libc::c_int) < 21 as libc::c_int &&
           (*this).life as libc::c_int > 16 as libc::c_int {
        (*this).regs[1 as libc::c_int as usize] =
            (20 as libc::c_int - (*this).life as libc::c_int) as s16
    } else {
        (*this).regs[0 as libc::c_int as usize] =
            ((*this).regs[0 as libc::c_int as usize] as libc::c_int +
                 0 as libc::c_int) as s16;
        (*this).regs[1 as libc::c_int as usize] = 3 as libc::c_int as s16
    }
