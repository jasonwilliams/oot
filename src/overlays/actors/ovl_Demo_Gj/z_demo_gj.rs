...
extern "C" {
    ...
    fn Item_DropCollectible(globalCtx: *mut GlobalContext,
     ...
     -> *mut EnItem00;
    #[no_mangle]
    fn func_800283D4(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
    ...
    #[no_mangle]
    fn Actor_GetCollidedExplosive(globalCtx: *mut GlobalContext,
                                  collider: *mut Collider) -> *mut Actor;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gGanonsCastleRubbleAroundArenaDL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubbleAroundArenaCol: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble2DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble2Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble3DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble3Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble4DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble4Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble5DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble5Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble6DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble6Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubble7DL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubble7Col: CollisionHeader;
    #[no_mangle]
    static mut gGanonsCastleRubbleTallDL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleRubbleTallCol: CollisionHeader;
}
...
pub const DEMOGJ_TYPE_DESTRUCTABLE_RUBBLE_TALL: C2RustUnnamed_23 = 22;
pub const DEMOGJ_TYPE_DESTRUCTABLE_RUBBLE_2: C2RustUnnamed_23 = 17;
pub const DEMOGJ_TYPE_DESTRUCTABLE_RUBBLE_1: C2RustUnnamed_23 = 16;
pub const DEMOGJ_TYPE_RUBBLE_PILE_7: C2RustUnnamed_23 = 14;
pub const DEMOGJ_TYPE_RUBBLE_PILE_6: C2RustUnnamed_23 = 13;
pub const DEMOGJ_TYPE_RUBBLE_PILE_5: C2RustUnnamed_23 = 12;
pub const DEMOGJ_TYPE_RUBBLE_PILE_4: C2RustUnnamed_23 = 11;
pub const DEMOGJ_TYPE_RUBBLE_PILE_3: C2RustUnnamed_23 = 10;
pub const DEMOGJ_TYPE_RUBBLE_PILE_2: C2RustUnnamed_23 = 9;
pub const DEMOGJ_TYPE_RUBBLE_PILE_1: C2RustUnnamed_23 = 8;
pub const DEMOGJ_TYPE_AROUNDARENA: C2RustUnnamed_23 = 4;
pub type DemoGjUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext) -> ()>;
pub type DemoGjDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext) -> ()>;
...
static mut sCylinderInit3: ColliderCylinderInitType1 =
    {
        let mut init =
            ColliderCylinderInitType1{base:
                                          {
...
// bits 11-15
#[no_mangle]
pub unsafe extern "C" fn DemoGj_GetCollectibleType(mut this: *mut DemoGj)
 -> s32 {
    let mut params: s32 =
        (*this).dyna.actor.params as libc::c_int >> 0xb as libc::c_int;
    return params & 0x1f as libc::c_int;
}
// bits 8-10
#[no_mangle]
pub unsafe extern "C" fn DemoGj_GetCollectibleAmount(mut this: *mut DemoGj)
 -> s32 {
    let mut params: s32 =
        (*this).dyna.actor.params as libc::c_int >> 0x8 as libc::c_int;
    return params & 7 as libc::c_int;
}
// bits 0-7
#[no_mangle]
pub unsafe extern "C" fn DemoGj_GetType(mut this: *mut DemoGj) -> s32 {
    let mut params: s32 = (*this).dyna.actor.params as s32;
    return params & 0xff as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitCylinder(mut this: *mut DemoGj,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut cylinder:
    ...
    Collider_SetCylinderType1(globalCtx, cylinder, &mut (*this).dyna.actor,
                              cylinderInit);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_HitByExplosion(mut this: *mut DemoGj,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut cylinder:
                                                   *mut ColliderCylinder)
 -> s32 {
    if !Actor_GetCollidedExplosive(globalCtx, &mut (*cylinder).base).is_null()
       {
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DestroyCylinder(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    match DemoGj_GetType(this) {
        16 => {
            Collider_DestroyCylinder(globalCtx,
                                     &mut *(*this).cylinders.as_mut_ptr().offset(0
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize));
            Collider_DestroyCylinder(globalCtx,
                                     &mut *(*this).cylinders.as_mut_ptr().offset(1
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize));
            Collider_DestroyCylinder(globalCtx,
                                     &mut *(*this).cylinders.as_mut_ptr().offset(2
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize));
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGj = thisx as *mut DemoGj;
    DemoGj_DestroyCylinder(this, globalCtx);
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_PlayExplosionSfx(mut this: *mut DemoGj,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    Audio_PlaySoundAtPosition(globalCtx, &mut (*this).dyna.actor.world.pos,
                              50 as libc::c_int,
                              0x28c2 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SpawnSmoke(mut globalCtx: *mut GlobalContext,
                                           mut pos: *mut Vec3f,
                                           mut arg2: f32_0) {
    static mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 6.0f32, z: 0.0f32,}; init };
    ...
    let mut temp: f32_0 = arg2 * 0.2f32;
    func_800283D4(globalCtx, pos, &mut velocity, &mut accel, &mut primColor,
                  &mut envColor, (temp * Rand_ZeroOne() + arg2) as s16,
                  15 as libc::c_int as s16, 90 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DropCollectible(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut collectible: s16 = DemoGj_GetCollectibleType(this) as s16;
    let mut amount: s32 = DemoGj_GetCollectibleAmount(this);
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < amount {
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Explode(mut this: *mut DemoGj,
                                        mut globalCtx: *mut GlobalContext,
                                        mut initialPos: *mut Vec3f,
                                        mut direction: *mut Vec3f) {
    let mut explosionPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut phi_s0: s32 = 0;
    let mut aux: f32_0 = 0.;
    let mut theta: s16 = 0 as libc::c_int as s16;
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        explosionPos.x = Math_SinS(theta) * 16.0f32;
        explosionPos.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        explosionPos.z = Math_CosS(theta) * 16.0f32;
        velocity.x = explosionPos.x * 0.6f32 + 12.0f32 * (*direction).x;
        velocity.y = Rand_ZeroOne() * 36.0f32 + 6.0f32;
        velocity.z = explosionPos.z * 0.6f32 + 12.0f32 * (*direction).z;
        explosionPos.x += (*initialPos).x;
        explosionPos.y += (*initialPos).y;
        explosionPos.z += (*initialPos).z;
        aux = Rand_ZeroOne();
        if aux < 0.1f32 {
            phi_s0 = 0x61 as libc::c_int
        } else if aux < 0.7f32 {
            phi_s0 = 0x41 as libc::c_int
        } else { phi_s0 = 0x21 as libc::c_int }
        EffectSsKakera_Spawn(globalCtx, &mut explosionPos, &mut velocity,
                             initialPos, -(200 as libc::c_int) as s16,
                             phi_s0 as s16, 10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 20.0f32 + 20.0f32) as s16,
                             ...
                             &mut *gGanonsCastleRubbleAroundArenaDL.as_mut_ptr().offset(28
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                                                                                            isize));
        theta = (theta as libc::c_int + 0x2aaa as libc::c_int) as s16;
        i += 1
    }
    DemoGj_PlayExplosionSfx(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_IsSceneInvalid() -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_FindGanon(mut this: *mut DemoGj,
                                          mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    if (*this).ganon.is_null() {
        actor =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_BOSS as libc::c_int as
                                                 usize].head;
        while !actor.is_null() {
            if (*actor).id as libc::c_int == ACTOR_BOSS_GANON2 as libc::c_int
               {
                (*this).ganon = actor as *mut BossGanon2;
                // "Demo_Gj_Search_Boss_Ganon %d: Discover Ganon !!!!"
                osSyncPrintf(b"Demo_Gj_Search_Boss_Ganon %d:\xe3\x82\xac\xe3\x83\x8e\xe3\x83\xb3\xe7\x99\xba\xe8\xa6\x8b!!!!\n\x00"
        ...
        osSyncPrintf(b"Demo_Gj_Search_Boss_Ganon %d:\xe3\x82\xac\xe3\x83\x8e\xe3\x83\xb3\xe7\x99\xba\xe8\xa6\x8b\xe5\x87\xba\xe6\x9d\xa5\xe3\x81\x9a\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).dyna.actor.params as libc::c_int);
        return 0 as libc::c_int
    }
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitCommon(mut this: *mut DemoGj,
                                           mut globalCtx: *mut GlobalContext,
                                           mut header: *mut CollisionHeader) {
    let mut pad: [s32; 3] = [0; 3];
    let mut newHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    if !header.is_null() {
        Actor_ProcessInitChain(&mut (*this).dyna.actor,
                               sInitChain.as_mut_ptr());
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        newHeader = 0 as *mut CollisionHeader;
        CollisionHeader_GetVirtual(header as *mut libc::c_void,
                                   &mut newHeader);
        (*this).dyna.bgId =
            DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                                &mut (*this).dyna.actor, newHeader)
    };
}
// TODO: find a better name
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitSetIndexes(mut this: *mut DemoGj,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut updateMode: s32,
                                               mut drawConfig: s32,
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawCommon(mut this: *mut DemoGj,
                                           mut globalCtx: *mut GlobalContext,
                                           mut displayList: *mut Gfx) {
    if (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                        b"../z_demo_gj.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = displayList as libc::c_uint;
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                         b"../z_demo_gj.c\x00" as *const u8 as
                             *const libc::c_char, 1169 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotated(mut this: *mut DemoGj,
                                            mut globalCtx: *mut GlobalContext,
                                            mut displayList: *mut Gfx) {
    let mut pad: s32 = 0;
    let mut gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut x: s16 = (*this).rotationVec.x;
    let mut y: s16 = (*this).rotationVec.y;
    let mut z: s16 = (*this).rotationVec.z;
    let mut pad2: s32 = 0;
    let mut matrix: *mut Mtx = 0 as *mut Mtx;
    ...
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gj.c\x00" as *const u8 as *const libc::c_char,
                    1187 as libc::c_int);
    Matrix_Push();
    Matrix_RotateZYX(x, y, z, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(matrix,
                 b"../z_demo_gj.c\x00" as *const u8 as *const libc::c_char as
                     *mut libc::c_char, 1193 as libc::c_int);
    Matrix_Pop();
    func_80093D18(gfxCtx);
    ...
    (*_g).words.w1 = matrix as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SetupRotation(mut this: *mut DemoGj,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut yPosition: f32_0 = (*this).dyna.actor.world.pos.y;
    let mut yVelocity: *mut f32_0 = &mut (*this).dyna.actor.velocity.y;
    let mut speedXZ: *mut f32_0 = &mut (*this).dyna.actor.speedXZ;
    let mut unk_172: *mut Vec3s = &mut (*this).unk_172;
    let mut verticalTranslation: f32_0 = 0.;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut verticalFactor: f32_0 = 0.;
    let mut xzPlaneFactor: f32_0 = 0.;
    match DemoGj_GetType(this) {
        8 => {
            verticalTranslation =
        ...
        9 => {
            ...
            xzPlaneFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 41 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 1.0f32
        }
        10 => {
            ...
            vec.z =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 52 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 1.0f32;
            verticalFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 53 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + -1.0f32;
            xzPlaneFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        11 => {
            verticalTranslation =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 62 as libc::c_int)
                                      as usize] as f32_0;
            vec.x =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
            ...
            vec.z =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 65 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 1.0f32;
            verticalFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        12 => {
            verticalTranslation =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 75 as libc::c_int)
                                      as usize] as f32_0;
            vec.x =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
            ...
            verticalFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 79 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + -1.0f32;
            xzPlaneFactor =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        _ => {
            ...
            osSyncPrintf(b"\x1b[31mDemo_Gj_common_Reflect : \xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaaarg_data\xe3\x81\xab\xe3\x81\xaf\xe5\xaf\xbe\xe5\xbf\x9c\xe3\x81\x97\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84 = %d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).dyna.actor.params as libc::c_int);
            return
        }
    ...
    if yPosition <= 1086.0f32 && *yVelocity < 0.0f32 {
        if (*this).isRotated == 0 {
            *yVelocity *= verticalFactor;
            *speedXZ *= xzPlaneFactor;
            (*unk_172).x = ((*unk_172).x as libc::c_float * vec.x) as s16;
            (*unk_172).y = ((*unk_172).y as libc::c_float * vec.y) as s16;
            (*unk_172).z = ((*unk_172).z as libc::c_float * vec.z) as s16;
            if *yVelocity <= -(*this).dyna.actor.gravity {
                *yVelocity = 0.0f32;
                *speedXZ = 0.0f32;
                (*unk_172).x = 0 as libc::c_int as s16;
                (*unk_172).y = 0 as libc::c_int as s16;
                (*unk_172).z = 0 as libc::c_int as s16
            }
            (*this).isRotated = 1 as libc::c_int
        }
    };
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_809797E4(mut this: *mut DemoGj, mut arg1: u8_0)
 -> s32 {
    let mut ganon: *mut BossGanon2 = (*this).ganon;
    if !ganon.is_null() &&
           (*ganon).unk_314 as libc::c_int == arg1 as libc::c_int {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_IsGanondorfRisingFromRubble(mut this:
                                                                *mut DemoGj,
                                                            mut globalCtx:
                                                                *mut GlobalContext)
 -> s32 {
    return func_809797E4(this, 1 as libc::c_int as u8_0);
}
// Ganondorf has stopped rising into the air and is just floating. Just before he transforms.
#[no_mangle]
pub unsafe extern "C" fn DemoGj_IsGanondorfFloatingInAir(mut this:
                                                             *mut DemoGj,
                                                         mut globalCtx:
                                                             *mut GlobalContext)
 -> s32 {
    return func_809797E4(this, 2 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SetupMovement(mut this: *mut DemoGj,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut actor: *mut Actor = &mut (*this).dyna.actor;
    let mut player: *mut Player = 0 as *mut Player;
    let mut pos: *mut Vec3f = &mut (*actor).world.pos;
    let mut unk_172: *mut Vec3s = 0 as *mut Vec3s;
    let mut xDistance: f32_0 = 0.;
    let mut zDistance: f32_0 = 0.;
    if !(*this).ganon.is_null() {
        xDistance = (*actor).world.pos.x - (*(*this).ganon).actor.world.pos.x;
        zDistance = (*actor).world.pos.z - (*(*this).ganon).actor.world.pos.z;
        unk_172 = &mut (*this).unk_172;
        match DemoGj_GetType(this) {
            8 => {
                (*actor).speedXZ =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                ...
                (*unk_172).y =
                    ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                         ...
                         libc::c_int + 0x3e8 as libc::c_int) as s16;
                (*unk_172).z =
                    ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            20 as libc::c_int) as usize] as
                         libc::c_int + 0xbb8 as libc::c_int) as s16;
                (*actor).minVelocityY =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           21 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -29.0f32;
                (*actor).gravity =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           22 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -5.0f32
            }
            9 => {
                (*actor).speedXZ =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
            ...
            10 => {
                ...
                (*unk_172).z =
                    ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            46 as libc::c_int) as usize] as
                         libc::c_int + 0xbb8 as libc::c_int) as s16;
                (*actor).minVelocityY =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           47 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -29.0f32;
                (*actor).gravity =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
            ...
            11 => {
                ...
                (*unk_172).y =
                    ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            58 as libc::c_int) as usize] as
                         libc::c_int + 0x3e8 as libc::c_int) as s16;
                (*unk_172).z =
                    ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            59 as libc::c_int) as usize] as
                         libc::c_int + 0xbb8 as libc::c_int) as s16;
                (*actor).minVelocityY =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           60 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -29.0f32;
                (*actor).gravity =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
            ...
            12 => {
                ...
                (*actor).minVelocityY =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           73 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -29.0f32;
                (*actor).gravity =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           74 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float * 0.01f32 + -5.0f32
            }
            13 => {
                (*actor).speedXZ =
            ...
            14 => {
                ...
                (*actor).velocity.y =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           95 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float + 70.0f32;
                (*unk_172).x =
                    (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
            ...
            _ => {
                ...
                osSyncPrintf(b"\x1b[31mDemo_Gj_Setup_Move_common : \xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaaarg_data\xe3\x81\xab\xe3\x81\xaf\xe5\xaf\xbe\xe5\xbf\x9c\xe3\x81\x97\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84 = %d\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*actor).params as libc::c_int);
            }
        }
        if xDistance == 0.0f32 && zDistance == 0.0f32 {
            player =
            ...
            if xDistance != 0.0f32 || zDistance != 0.0f32 {
                (*actor).world.rot.y =
                    (Math_FAtan2F(xDistance, zDistance) *
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_CheckIfTransformedIntoGanon(mut this:
                                                                *mut DemoGj) {
    if func_809797E4(this, 3 as libc::c_int as u8_0) != 0 {
        (*this).isTransformedIntoGanon = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile1(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 1 as libc::c_int, 2 as libc::c_int,
                          &mut gGanonsCastleRubble2Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A000(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
             (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 18 as libc::c_int) as
                                   usize] as libc::c_int) as s16;
    (*this).rotationVec.y =
        ((*this).rotationVec.y as libc::c_int +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 19 as libc::c_int) as
                                    usize] as libc::c_int +
                  1000 as libc::c_int) as s16 as libc::c_int) as s16;
    (*this).rotationVec.z =
        ((*this).rotationVec.z as libc::c_int +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 20 as libc::c_int) as
                                    usize] as libc::c_int +
                  3000 as libc::c_int) as s16 as libc::c_int) as s16;
    DemoGj_SetupRotation(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SpawnSmokePreBattle1(mut this: *mut DemoGj,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut pos: Vec3f =
        {
            let mut init = Vec3f{x: -371.0f32, y: 1188.0f32, z: -303.0f32,};
            init
        };
    let mut gameplayFrames: u32_0 = 0;
    if (*this).isTransformedIntoGanon == 0 {
        gameplayFrames =
            (*globalCtx).gameplayFrames.wrapping_rem(3 as libc::c_int as
                                                         libc::c_uint);
        if gameplayFrames == 0 as libc::c_int as libc::c_uint {
            ((*globalCtx).gameplayFrames) == 0;
            DemoGj_SpawnSmoke(globalCtx, &mut pos, 300.0f32);
        }
        DemoGj_CheckIfTransformedIntoGanon(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A0E4(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097A130(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
// func_8097A160
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update01(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
...
// func_8097A190
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update08(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A000(this, globalCtx);
    func_8097A130(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble2(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble2DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble2(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble2DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile2(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 2 as libc::c_int, 3 as libc::c_int,
                          &mut gGanonsCastleRubble3Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A238(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SpawnSmokePreBattle2(mut this: *mut DemoGj,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut pos: Vec3f =
        {
            let mut init = Vec3f{x: -119.0f32, y: 1056.0f32, z: -147.0f32,};
            init
        };
    let mut gameplayFrames: u32_0 = 0;
    if (*this).isTransformedIntoGanon == 0 {
        gameplayFrames =
            (*globalCtx).gameplayFrames.wrapping_rem(3 as libc::c_int as
                                                         libc::c_uint);
        if gameplayFrames == 1 as libc::c_int as libc::c_uint {
            ((*globalCtx).gameplayFrames) == 0;
            DemoGj_SpawnSmoke(globalCtx, &mut pos, 300.0f32);
        }
        DemoGj_CheckIfTransformedIntoGanon(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_8097A320(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 9 as libc::c_int;
        (*this).drawConfig = 10 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A36C(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097A39C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update02(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097A3CC
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update09(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A238(this, globalCtx);
    func_8097A36C(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble3(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble3DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble3(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble3DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile3(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 3 as libc::c_int, 4 as libc::c_int,
                          &mut gGanonsCastleRubble4Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A474(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_8097A4F0(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 10 as libc::c_int;
        (*this).drawConfig = 11 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A53C(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097A56C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update03(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097A59C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update10(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A474(this, globalCtx);
    func_8097A53C(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble4(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble4DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble4(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble4DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile4(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 4 as libc::c_int, 5 as libc::c_int,
                          &mut gGanonsCastleRubble5Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A644(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_8097A6C0(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 11 as libc::c_int;
        (*this).drawConfig = 12 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A70C(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097A73C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update04(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097A76C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update11(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A644(this, globalCtx);
    func_8097A70C(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble5(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble5DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble5(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble5DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile5(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 5 as libc::c_int, 6 as libc::c_int,
                          &mut gGanonsCastleRubble6Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A814(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_8097A890(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 12 as libc::c_int;
        (*this).drawConfig = 13 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A8DC(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097A90C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update05(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097A93C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update12(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A814(this, globalCtx);
    func_8097A8DC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble6(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble6DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble6(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble6DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile6(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 6 as libc::c_int, 7 as libc::c_int,
                          &mut gGanonsCastleRubble7Col);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097A9E4(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_8097AA60(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 13 as libc::c_int;
        (*this).drawConfig = 14 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097AAAC(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097AADC
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update06(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097AB0C
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update13(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097A9E4(this, globalCtx);
    func_8097AAAC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubble7(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble7DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubble7(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx, gGanonsCastleRubble7DL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubblePile7(mut this: *mut DemoGj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 7 as libc::c_int, 8 as libc::c_int,
                          &mut gGanonsCastleRubbleTallCol);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097ABB4(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).dyna.actor);
    (*this).rotationVec.x =
        ((*this).rotationVec.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SpawnSmokePreBattle3(mut this: *mut DemoGj,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut pos: Vec3f =
        {
            let mut init = Vec3f{x: -6.0f32, y: 1053.0f32, z: -473.0f32,};
            init
        };
    let mut gameplayFrames: u32_0 = 0;
    if (*this).isTransformedIntoGanon == 0 {
        gameplayFrames =
            (*globalCtx).gameplayFrames.wrapping_rem(3 as libc::c_int as
                                                         libc::c_uint);
        if gameplayFrames == 2 as libc::c_int as libc::c_uint {
            ((*globalCtx).gameplayFrames) == 0;
            DemoGj_SpawnSmoke(globalCtx, &mut pos, 300.0f32);
        }
        DemoGj_CheckIfTransformedIntoGanon(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_8097AC9C(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfRisingFromRubble(this, globalCtx) != 0 {
        DemoGj_SetupMovement(this, globalCtx);
        (*this).updateMode = 14 as libc::c_int;
        (*this).drawConfig = 15 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097ACE8(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
...
// func_8097AD18
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update07(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097AD48
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update14(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097ABB4(this, globalCtx);
    func_8097ACE8(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubbleTall(mut this: *mut DemoGj,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx,
                      gGanonsCastleRubbleTallDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRotatedRubbleTall(mut this: *mut DemoGj,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    DemoGj_DrawRotated(this, globalCtx,
                       gGanonsCastleRubbleTallDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitRubbleAroundArena(mut this: *mut DemoGj,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 0 as libc::c_int, 1 as libc::c_int,
                          &mut gGanonsCastleRubbleAroundArenaCol);
}
// func_8097ADF0
#[no_mangle]
pub unsafe extern "C" fn DemoGj_UpdateRubbleAroundArena(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawRubbleAroundArena(mut this: *mut DemoGj,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx,
                      gGanonsCastleRubbleAroundArenaDL.as_mut_ptr());
}
// Inits the three cylinders with `sCylinderInit1`
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitDestructableRubble1(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 15 as libc::c_int,
                          0 as libc::c_int, 0 as *mut CollisionHeader);
    DemoGj_InitCylinder(this, globalCtx,
                        &mut *(*this).cylinders.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                        &mut sCylinderInit1);
    DemoGj_InitCylinder(this, globalCtx,
                        &mut *(*this).cylinders.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                        &mut sCylinderInit1);
    DemoGj_InitCylinder(this, globalCtx,
                        &mut *(*this).cylinders.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                        &mut sCylinderInit1);
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DoNothing1(mut this: *mut DemoGj,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_8097AEE8(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut cylinder0: *mut ColliderCylinder =
        &mut *(*this).cylinders.as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut ColliderCylinder;
    let mut cylinder1: *mut ColliderCylinder =
        &mut *(*this).cylinders.as_mut_ptr().offset(1 as libc::c_int as isize)
            as *mut ColliderCylinder;
    let mut cylinder2: *mut ColliderCylinder =
        &mut *(*this).cylinders.as_mut_ptr().offset(2 as libc::c_int as isize)
            as *mut ColliderCylinder;
    let mut actorPos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut pad: s32 = 0;
    let mut theta: s16 = (*this).dyna.actor.world.rot.y;
    let mut cos_theta: f32_0 = Math_CosS(theta);
    let mut sin_theta: f32_0 = Math_SinS(theta);
    (*cylinder0).dim.pos.z =
        ((*actorPos).z + 20.0f32 * cos_theta - -20.0f32 * sin_theta) as s16;
    (*cylinder0).dim.pos.x =
        ((*actorPos).x + 20.0f32 * sin_theta + -20.0f32 * cos_theta) as s16;
    (*cylinder0).dim.pos.y = (*actorPos).y as s16;
    (*cylinder1).dim.pos.z =
        ((*actorPos).z + -20.0f32 * cos_theta - 20.0f32 * sin_theta) as s16;
    (*cylinder1).dim.pos.x =
        ((*actorPos).x + -20.0f32 * sin_theta + 20.0f32 * cos_theta) as s16;
    (*cylinder1).dim.pos.y = (*actorPos).y as s16;
    (*cylinder2).dim.pos.z =
        ((*actorPos).z + -60.0f32 * cos_theta - 60.0f32 * sin_theta) as s16;
    (*cylinder2).dim.pos.x =
        ((*actorPos).x + -60.0f32 * sin_theta + 60.0f32 * cos_theta) as s16;
    (*cylinder2).dim.pos.y = (*actorPos).y as s16;
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SetCylindersAsAC(mut this: *mut DemoGj,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut cylinder0: *mut Collider =
        &mut (*(*this).cylinders.as_mut_ptr().offset(0 as libc::c_int as
                                                         isize)).base;
    let mut cylinder1: *mut Collider =
        &mut (*(*this).cylinders.as_mut_ptr().offset(1 as libc::c_int as
                                                         isize)).base;
    let mut cylinder2: *mut Collider =
        &mut (*(*this).cylinders.as_mut_ptr().offset(2 as libc::c_int as
                                                         isize)).base;
    let mut pad2: [s32; 3] = [0; 3];
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx, cylinder0);
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx, cylinder1);
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx, cylinder2);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DirectedExplosion(mut this: *mut DemoGj,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut direction: *mut Vec3f) {
    ...
    DemoGj_Explode(this, globalCtx, &mut pos, direction);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097B128(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        let mut scale: *mut Vec3f = &mut (*this).dyna.actor.scale;
        DemoGj_InitCommon(this, globalCtx, &mut gGanonsCastleRubble2Col);
        (*this).updateMode = 18 as libc::c_int;
        (*this).drawConfig = 16 as libc::c_int;
        (*scale).x *= 0.8f32;
        (*scale).y *= 0.8f32;
        (*scale).z *= 0.8f32
    };
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_HasCylinderAnyExploded(mut this: *mut DemoGj,
                                                       mut globalCtx:
                                                           *mut GlobalContext)
 -> s32 {
    if DemoGj_HitByExplosion(this, globalCtx,
                             &mut *(*this).cylinders.as_mut_ptr().offset(0 as
                                                                             libc::c_int
                                                                             as
                                                                             isize))
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_8097B22C(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if func_809797E4(this, 4 as libc::c_int as u8_0) != 0 {
        Actor_Kill(thisx);
    } else if DemoGj_HasCylinderAnyExploded(this, globalCtx) != 0 {
        let mut vec1: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedExplosion(this, globalCtx, &mut vec1);
        Actor_Kill(thisx);
    } else if (*this).killFlag != 0 {
        let mut vec2: Vec3f = (*this).unk_26C;
        vec2.y = 0.0f32;
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedExplosion(this, globalCtx, &mut vec2);
        Actor_Kill(thisx);
    }
...
// func_8097B340
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update15(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097B370
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update18(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097B22C(this, globalCtx);
    DemoGj_DoNothing1(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawDestructableRubble1(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble2DL.as_mut_ptr());
}
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitDestructableRubble2(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 16 as libc::c_int,
                          0 as libc::c_int, 0 as *mut CollisionHeader);
    DemoGj_InitCylinder(this, globalCtx,
                        &mut *(*this).cylinders.as_mut_ptr().offset(0 as
                                                                        libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DoNothing2(mut this: *mut DemoGj,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
// Moves the ColliderCylinder's relative to the actor's position.
#[no_mangle]
pub unsafe extern "C" fn func_8097B450(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut cylinder0: *mut ColliderCylinder =
        &mut *(*this).cylinders.as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut ColliderCylinder;
    ...
    let mut cos_theta: f32_0 = Math_CosS(theta);
    let mut sin_theta: f32_0 = Math_SinS(theta);
    (*cylinder0).dim.pos.z = ((*actorPos).z - 35.0f32 * sin_theta) as s16;
    (*cylinder0).dim.pos.x = ((*actorPos).x + 35.0f32 * cos_theta) as s16;
    (*cylinder0).dim.pos.y = (*actorPos).y as s16;
    (*cylinder1).dim.pos.z = ((*actorPos).z - -10.0f32 * sin_theta) as s16;
    (*cylinder1).dim.pos.x = ((*actorPos).x + -10.0f32 * cos_theta) as s16;
    (*cylinder1).dim.pos.y = (*actorPos).y as s16;
    (*cylinder2).dim.pos.z = ((*actorPos).z - -55.0f32 * sin_theta) as s16;
    (*cylinder2).dim.pos.x = ((*actorPos).x + -55.0f32 * cos_theta) as s16;
    (*cylinder2).dim.pos.y = (*actorPos).y as s16;
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_SetCylindersAsAC2(mut this: *mut DemoGj,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut cylinder0: *mut Collider =
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_HasCylinderAnyExploded2(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    if DemoGj_HitByExplosion(this, globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DirectedExplosion2(mut this: *mut DemoGj,
                                                   mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut direction:
                                                       *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097B6C4(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        let mut scale: *mut Vec3f = &mut (*this).dyna.actor.scale;
        DemoGj_InitCommon(this, globalCtx, &mut gGanonsCastleRubble3Col);
        (*this).updateMode = 19 as libc::c_int;
        (*this).drawConfig = 17 as libc::c_int;
        (*scale).x *= 0.8f32;
        (*scale).y *= 0.8f32;
        (*scale).z *= 0.8f32
    };
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_8097B750(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if func_809797E4(this, 4 as libc::c_int as u8_0) != 0 {
        Actor_Kill(thisx);
    } else if DemoGj_HasCylinderAnyExploded2(this, globalCtx) != 0 {
        let mut vec1: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedExplosion2(this, globalCtx, &mut vec1);
        Actor_Kill(thisx);
    } else if (*this).killFlag != 0 {
        let mut vec2: Vec3f = (*this).unk_26C;
        vec2.y = 0.0f32;
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedExplosion2(this, globalCtx, &mut vec2);
        Actor_Kill(thisx);
    }
...
// func_8097B864
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update16(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097B894
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update19(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097B750(this, globalCtx);
    DemoGj_DoNothing2(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DemoGj_InitDestructableRubble2(mut this:
                                                                   *mut DemoGj,
                                                               mut globalCtx:
                                                                   *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx, gGanonsCastleRubble3DL.as_mut_ptr());
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_InitDestructableRubbleTall(mut this:
                                                               *mut DemoGj,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    DemoGj_InitSetIndexes(this, globalCtx, 17 as libc::c_int,
                          0 as libc::c_int, 0 as *mut CollisionHeader);
    DemoGj_InitCylinder(this, globalCtx,
                        &mut *(*this).cylinders.as_mut_ptr().offset(0 as
                                                                        libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DoNothing3(mut this: *mut DemoGj,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DirectedDoubleExplosion(mut this: *mut DemoGj,
                                                        mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut direction:
                                                            *mut Vec3f) {
    ...
    DemoGj_Explode(this, globalCtx, &mut pos, direction);
    pos.x = (*this).dyna.actor.world.pos.x;
    pos.y = (*this).dyna.actor.world.pos.y + 100.0f32;
    pos.z = (*this).dyna.actor.world.pos.z;
    DemoGj_Explode(this, globalCtx, &mut pos, direction);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097B9BC(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    if DemoGj_IsGanondorfFloatingInAir(this, globalCtx) != 0 {
        let mut scale: *mut Vec3f = &mut (*this).dyna.actor.scale;
        DemoGj_InitCommon(this, globalCtx, &mut gGanonsCastleRubbleTallCol);
        (*this).updateMode = 20 as libc::c_int;
        (*this).drawConfig = 18 as libc::c_int;
        (*scale).x *= 0.8f32;
        (*scale).y *= 0.8f32;
        (*scale).z *= 0.8f32
    };
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_8097BA48(mut this: *mut DemoGj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    ...
    if func_809797E4(this, 4 as libc::c_int as u8_0) != 0 {
        Actor_Kill(thisx);
    } else if DemoGj_HitByExplosion(this, globalCtx, cylinder) != 0 {
        let mut vec1: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedDoubleExplosion(this, globalCtx, &mut vec1);
        Actor_Kill(thisx);
    } else if (*this).killFlag != 0 {
        let mut vec2: Vec3f = (*this).unk_26C;
        vec2.y = 0.0f32;
        DemoGj_DropCollectible(this, globalCtx);
        DemoGj_DirectedDoubleExplosion(this, globalCtx, &mut vec2);
        Actor_Kill(thisx);
    }
...
// func_8097BB78
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update17(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    DemoGj_FindGanon(this, globalCtx);
...
// func_8097BBA8
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update20(mut this: *mut DemoGj,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097BA48(this, globalCtx);
    DemoGj_DoNothing3(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DemoGj_InitDestructableRubbleTall(mut this:
                                                                      *mut DemoGj,
                                                                  mut globalCtx:
                                                                      *mut GlobalContext) {
    DemoGj_DrawCommon(this, globalCtx,
...
static mut sUpdateFuncs: [DemoGjUpdateFunc; 21] =
    unsafe {
        [Some(DemoGj_UpdateRubbleAroundArena as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update01 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update02 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update03 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update04 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update05 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update06 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update07 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update08 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update09 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update10 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update11 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update12 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update13 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update14 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update15 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update16 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update17 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update18 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update19 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_Update20 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGj = thisx as *mut DemoGj;
    if (*this).updateMode < 0 as libc::c_int ||
           (*this).updateMode >=
               (::std::mem::size_of::<[DemoGjUpdateFunc; 21]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoGjUpdateFunc>()
                                                    as libc::c_ulong) as s32
           || sUpdateFuncs[(*this).updateMode as usize].is_none() {
    ...
    sUpdateFuncs[(*this).updateMode as
                     usize].expect("non-null function pointer")(this,
                                                                globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGj = thisx as *mut DemoGj;
    match DemoGj_GetType(this) {
        4 => { DemoGj_InitRubbleAroundArena(this, globalCtx); }
        8 => { DemoGj_InitRubblePile1(this, globalCtx); }
        9 => { DemoGj_InitRubblePile2(this, globalCtx); }
        10 => { DemoGj_InitRubblePile3(this, globalCtx); }
        11 => { DemoGj_InitRubblePile4(this, globalCtx); }
        12 => { DemoGj_InitRubblePile5(this, globalCtx); }
        13 => { DemoGj_InitRubblePile6(this, globalCtx); }
        14 => { DemoGj_InitRubblePile7(this, globalCtx); }
        16 => { DemoGj_InitDestructableRubble1(this, globalCtx); }
        17 => { DemoGj_InitDestructableRubble2(this, globalCtx); }
        22 => { DemoGj_InitDestructableRubbleTall(this, globalCtx); }
        _ => {
            // "Demo_Gj_Actor_ct There is no such argument!!!!!!!!!!!!!!!!!!!!!!"
            osSyncPrintf(b"\x1b[31mDemo_Gj_Actor_ct \xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\xbc\x95\xe6\x95\xb0\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!!!!!!!!!!!!!!!\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char, globalCtx,
                         this);
            Actor_Kill(&mut (*this).dyna.actor);
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn DemoGj_DrawNothing(mut this: *mut DemoGj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
static mut sDrawFuncs: [DemoGjDrawFunc; 19] =
    unsafe {
        [Some(DemoGj_DrawNothing as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubbleAroundArena as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble2 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble3 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble4 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble5 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble6 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubble7 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRubbleTall as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble2 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble3 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble4 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble5 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble6 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubble7 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawRotatedRubbleTall as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DrawDestructableRubble1 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DemoGj_InitDestructableRubble2 as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGj_DemoGj_InitDestructableRubbleTall as
                  unsafe extern "C" fn(_: *mut DemoGj, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoGj_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGj = thisx as *mut DemoGj;
    if (*this).drawConfig < 0 as libc::c_int ||
           (*this).drawConfig >=
               (::std::mem::size_of::<[DemoGjDrawFunc; 19]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoGjDrawFunc>()
                                                    as libc::c_ulong) as s32
...
#[no_mangle]
pub static mut Demo_Gj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_GJ as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_GJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DemoGj>() as
                                  libc::c_ulong,
                          init:
