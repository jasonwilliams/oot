...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffSparkDL: [Gfx; 0];
    #[no_mangle]
    static mut gEffSpark1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffSpark2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffSpark3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffSpark4Tex: [u64_0; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_G_Spk_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_G_SPK as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGSpk_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSpk_Init(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs,
                                           mut initParamsx: *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsGSpkInitParams =
        initParamsx as *mut EffectSsGSpkInitParams;
    ...
    (*this).gfx =
        gSegments[((gEffSparkDL.as_mut_ptr() as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(gEffSparkDL.as_mut_ptr() as u32_0 &
    ...
    if (*initParams).updateMode as libc::c_int == 0 as libc::c_int {
        ...
        (*this).vec.x =
            (*initParams).pos.x - (*(*initParams).actor).world.pos.x;
        (*this).vec.y =
            (*initParams).pos.y - (*(*initParams).actor).world.pos.y;
        (*this).vec.z =
            (*initParams).pos.z - (*(*initParams).actor).world.pos.z;
        (*this).update =
            Some(EffectSsGSpk_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ())
    } else {
        (*this).life = 5 as libc::c_int as s16;
        (*this).update =
            Some(EffectSsGSpk_UpdateNoAccel as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ())
    }
    (*this).draw =
        Some(EffectSsGSpk_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSpk_Draw(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs) {
    static mut sparkTextures: [*mut libc::c_void; 4] =
        unsafe {
            [gEffSpark1Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffSpark2Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffSpark3Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffSpark4Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_g_spk.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((sparkTextures[(*this).regs[8 as libc::c_int as usize]
                                          as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(sparkTextures[(*this).regs[8 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                                                as usize] as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSpk_Update(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    (*this).accel.x = (Rand_ZeroOne() - 0.5f32) * 3.0f32;
    (*this).accel.z = (Rand_ZeroOne() - 0.5f32) * 3.0f32;
    if !(*this).actor.is_null() {
        if (*(*this).actor).category as libc::c_int ==
               ACTORCAT_EXPLOSIVE as libc::c_int &&
               (*(*this).actor).update.is_some() {
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSpk_UpdateNoAccel(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut index: u32_0,
                                                    mut this: *mut EffectSs) {
    if !(*this).actor.is_null() {
