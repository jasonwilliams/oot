...
extern "C" {
    ...
    #[no_mangle]
    static mut gUnknownCircle6Tex: [u64_0; 0];
}
...
// original name: "spark"
#[no_mangle]
pub unsafe extern "C" fn EffectSpark_Init(mut thisx: *mut libc::c_void,
                                          mut initParamsx:
                                              *mut libc::c_void) {
    let mut this: *mut EffectSpark =
        thisx as *mut EffectSpark; // "u_div,v_div 0 is not good."
    let mut initParams: *mut EffectSparkInit =
        initParamsx as *mut EffectSparkInit; // "over table_size"
    let mut elem: *mut EffectSparkElement = 0 as *mut EffectSparkElement;
    let mut velocityNorm: f32_0 = 0.;
    let mut i: s32 = 0;
    if !this.is_null() && !initParams.is_null() {
        if (*initParams).uDiv == 0 as libc::c_int as libc::c_uint ||
               (*initParams).vDiv == 0 as libc::c_int as libc::c_uint {
            osSyncPrintf(b"spark():u_div,v_div 0\xe3\x81\xa7\xe3\x81\xaf\xe5\x9b\xb0\xe3\x82\x8b\xe3\x80\x82\n\x00"
        ...
        (*this).colorStart[0 as libc::c_int as usize].r =
            (*initParams).colorStart[0 as libc::c_int as usize].r;
        (*this).colorStart[0 as libc::c_int as usize].g =
            (*initParams).colorStart[0 as libc::c_int as usize].g;
        (*this).colorStart[0 as libc::c_int as usize].b =
            (*initParams).colorStart[0 as libc::c_int as usize].b;
        (*this).colorStart[0 as libc::c_int as usize].a =
            (*initParams).colorStart[0 as libc::c_int as usize].a;
        (*this).colorStart[1 as libc::c_int as usize].r =
            (*initParams).colorStart[1 as libc::c_int as usize].r;
        (*this).colorStart[1 as libc::c_int as usize].g =
            (*initParams).colorStart[1 as libc::c_int as usize].g;
        (*this).colorStart[1 as libc::c_int as usize].b =
            (*initParams).colorStart[1 as libc::c_int as usize].b;
        (*this).colorStart[1 as libc::c_int as usize].a =
            (*initParams).colorStart[1 as libc::c_int as usize].a;
        (*this).colorStart[2 as libc::c_int as usize].r =
            (*initParams).colorStart[2 as libc::c_int as usize].r;
        (*this).colorStart[2 as libc::c_int as usize].g =
            (*initParams).colorStart[2 as libc::c_int as usize].g;
        (*this).colorStart[2 as libc::c_int as usize].b =
            (*initParams).colorStart[2 as libc::c_int as usize].b;
        (*this).colorStart[2 as libc::c_int as usize].a =
            (*initParams).colorStart[2 as libc::c_int as usize].a;
        (*this).colorStart[3 as libc::c_int as usize].r =
            (*initParams).colorStart[3 as libc::c_int as usize].r;
        (*this).colorStart[3 as libc::c_int as usize].g =
            (*initParams).colorStart[3 as libc::c_int as usize].g;
        (*this).colorStart[3 as libc::c_int as usize].b =
            (*initParams).colorStart[3 as libc::c_int as usize].b;
        (*this).colorStart[3 as libc::c_int as usize].a =
            (*initParams).colorStart[3 as libc::c_int as usize].a;
        (*this).colorEnd[0 as libc::c_int as usize].r =
            (*initParams).colorEnd[0 as libc::c_int as usize].r;
        (*this).colorEnd[0 as libc::c_int as usize].g =
            (*initParams).colorEnd[0 as libc::c_int as usize].g;
        (*this).colorEnd[0 as libc::c_int as usize].b =
            (*initParams).colorEnd[0 as libc::c_int as usize].b;
        (*this).colorEnd[0 as libc::c_int as usize].a =
            (*initParams).colorEnd[0 as libc::c_int as usize].a;
        (*this).colorEnd[1 as libc::c_int as usize].r =
            (*initParams).colorEnd[1 as libc::c_int as usize].r;
        (*this).colorEnd[1 as libc::c_int as usize].g =
            (*initParams).colorEnd[1 as libc::c_int as usize].g;
        (*this).colorEnd[1 as libc::c_int as usize].b =
            (*initParams).colorEnd[1 as libc::c_int as usize].b;
        (*this).colorEnd[1 as libc::c_int as usize].a =
            (*initParams).colorEnd[1 as libc::c_int as usize].a;
        (*this).colorEnd[2 as libc::c_int as usize].r =
            (*initParams).colorEnd[2 as libc::c_int as usize].r;
        (*this).colorEnd[2 as libc::c_int as usize].g =
            (*initParams).colorEnd[2 as libc::c_int as usize].g;
        (*this).colorEnd[2 as libc::c_int as usize].b =
            (*initParams).colorEnd[2 as libc::c_int as usize].b;
        (*this).colorEnd[2 as libc::c_int as usize].a =
            (*initParams).colorEnd[2 as libc::c_int as usize].a;
        (*this).colorEnd[3 as libc::c_int as usize].r =
            (*initParams).colorEnd[3 as libc::c_int as usize].r;
        (*this).colorEnd[3 as libc::c_int as usize].g =
            (*initParams).colorEnd[3 as libc::c_int as usize].g;
        (*this).colorEnd[3 as libc::c_int as usize].b =
            (*initParams).colorEnd[3 as libc::c_int as usize].b;
        (*this).colorEnd[3 as libc::c_int as usize].a =
            (*initParams).colorEnd[3 as libc::c_int as usize].a;
        (*this).duration = (*initParams).duration;
        (*this).numElements =
            (*this).uDiv.wrapping_mul((*this).vDiv).wrapping_add(2 as
                                                                     libc::c_int
                                                                     as
                                                                     libc::c_uint)
                as s32;
        if (*this).numElements >
               (::std::mem::size_of::<[EffectSparkElement; 32]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<EffectSparkElement>()
                                                    as libc::c_ulong) as s32 {
            osSyncPrintf(b"table_size\xe3\x82\xaa\xe3\x83\xbc\xe3\x83\x90\xe3\x83\xbc\n\x00"
                             as *const u8 as *const libc::c_char);
            return
        }
        i = 0 as libc::c_int;
        while i < (*this).numElements {
            elem =
                &mut *(*this).elements.as_mut_ptr().offset(i as isize) as
                    *mut EffectSparkElement;
            (*elem).position.x = (*this).position.x as f32_0;
            (*elem).position.y = (*this).position.y as f32_0;
            (*elem).position.z = (*this).position.z as f32_0;
            (*elem).velocity.x = Rand_ZeroOne() - 0.5f32;
            (*elem).velocity.y = Rand_ZeroOne() - 0.5f32;
            (*elem).velocity.z = Rand_ZeroOne() - 0.5f32;
            velocityNorm =
                sqrtf((*elem).velocity.x * (*elem).velocity.x +
                          (*elem).velocity.y * (*elem).velocity.y +
                          (*elem).velocity.z * (*elem).velocity.z);
            if !(fabsf(velocityNorm) < 0.008f32) {
                (*elem).velocity.x *= (*this).speed * (1.0f32 / velocityNorm);
                (*elem).velocity.y *= (*this).speed * (1.0f32 / velocityNorm);
                (*elem).velocity.z *= (*this).speed * (1.0f32 / velocityNorm)
            } else {
                (*elem).velocity.z = 0.0f32;
                (*elem).velocity.x = (*elem).velocity.z;
                (*elem).velocity.y = (*this).speed
            }
            (*elem).unkVelocity.x =
                (30000.0f32 - Rand_ZeroOne() * 15000.0f32) as s16;
            (*elem).unkVelocity.y =
                (30000.0f32 - Rand_ZeroOne() * 15000.0f32) as s16;
            (*elem).unkVelocity.z =
                (30000.0f32 - Rand_ZeroOne() * 15000.0f32) as s16;
            (*elem).unkPosition.x = (Rand_ZeroOne() * 65534.0f32) as s16;
            (*elem).unkPosition.y = (Rand_ZeroOne() * 65534.0f32) as s16;
            (*elem).unkPosition.z = (Rand_ZeroOne() * 65534.0f32) as s16;
            i += 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn EffectSpark_Destroy(mut thisx: *mut libc::c_void) { }
// original name: "EffectSparkInfo_proc"
#[no_mangle]
pub unsafe extern "C" fn EffectSpark_Update(mut thisx: *mut libc::c_void)
 -> s32 {
    let mut this: *mut EffectSpark = thisx as *mut EffectSpark;
    let mut elem: *mut EffectSparkElement = 0 as *mut EffectSparkElement;
    let mut i: s32 = 0;
    if this.is_null() {
        osSyncPrintf(b"EffectSparkInfo_proc():Spark Pointer is NULL\n\x00" as
    ...
    while i < (*this).numElements {
        ...
        (*elem).unkPosition.x =
            ((*elem).unkPosition.x as libc::c_int +
                 (*elem).unkVelocity.x as libc::c_int) as s16;
        (*elem).unkPosition.y =
            ((*elem).unkPosition.y as libc::c_int +
                 (*elem).unkVelocity.y as libc::c_int) as s16;
        (*elem).unkPosition.z =
            ((*elem).unkPosition.z as libc::c_int +
                 (*elem).unkVelocity.z as libc::c_int) as s16;
        i += 1
    }
    (*this).timer += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSpark_Draw(mut thisx: *mut libc::c_void,
    ...
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut sp1D3: u8_0 = 0;
    let mut sp1D2: u8_0 = 0;
    let mut sp1D1: u8_0 = 0;
    let mut sp1D0: u8_0 = 0;
    let mut sp1CF: u8_0 = 0;
    let mut sp1CE: u8_0 = 0;
    let mut sp1CD: u8_0 = 0;
    let mut sp1CC: u8_0 = 0;
    let mut sp1CB: u8_0 = 0;
    let mut sp1CA: u8_0 = 0;
    let mut sp1C9: u8_0 = 0;
    let mut sp1C8: u8_0 = 0;
    let mut sp1C7: u8_0 = 0;
    let mut sp1C6: u8_0 = 0;
    let mut sp1C5: u8_0 = 0;
    let mut sp1C4: u8_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_spark.c\x00" as *const u8 as
    ...
    if !this.is_null() {
            ...
            (0xfd as libc::c_int as u32_0 &
                ...
                ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gUnknownCircle6Tex.as_mut_ptr() as libc::c_uint;
        ...
        (*_g_12).words.w0 =
            (0xd9 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (!((0x600 as libc::c_int | 0x10000 as libc::c_int |
                        0x20000 as libc::c_int | 0x40000 as libc::c_int |
        ...
        vertices =
            Graph_Alloc(gfxCtx,
                        ((*this).numElements as
                             libc::c_uint).wrapping_mul(::std::mem::size_of::<[Vtx; 4]>()
                                                            as libc::c_ulong)
                            as size_t) as *mut Vtx;
        if vertices.is_null() {
            // "Memory Allocation Failure graph_malloc"
            osSyncPrintf(b"EffectSparkInfo_disp():\xe3\x83\xa1\xe3\x83\xa2\xe3\x83\xaa\xe3\x83\xbc\xe7\xa2\xba\xe4\xbf\x9d\xe5\xa4\xb1\xe6\x95\x97 graph_malloc\n\x00"
                             as *const u8 as *const libc::c_char);
        } else {
            j = 0 as libc::c_int;
            ratio = (*this).timer as f32_0 / (*this).duration as f32_0;
            sp1D3 =
                ((*this).colorStart[0 as libc::c_int as usize].r as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[0 as libc::c_int as usize].r as f32_0 -
                          (*this).colorStart[0 as libc::c_int as usize].r as
                              f32_0) * ratio) as u8_0;
            sp1D2 =
                ((*this).colorStart[0 as libc::c_int as usize].g as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[0 as libc::c_int as usize].g as f32_0 -
                          (*this).colorStart[0 as libc::c_int as usize].g as
                              f32_0) * ratio) as u8_0;
            sp1D1 =
                ((*this).colorStart[0 as libc::c_int as usize].b as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[0 as libc::c_int as usize].b as f32_0 -
                          (*this).colorStart[0 as libc::c_int as usize].b as
                              f32_0) * ratio) as u8_0;
            sp1D0 =
                ((*this).colorStart[0 as libc::c_int as usize].a as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[0 as libc::c_int as usize].a as f32_0 -
                          (*this).colorStart[0 as libc::c_int as usize].a as
                              f32_0) * ratio) as u8_0;
            sp1CF =
                ((*this).colorStart[1 as libc::c_int as usize].r as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[1 as libc::c_int as usize].r as f32_0 -
                          (*this).colorStart[1 as libc::c_int as usize].r as
                              f32_0) * ratio) as u8_0;
            sp1CE =
                ((*this).colorStart[1 as libc::c_int as usize].g as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[1 as libc::c_int as usize].g as f32_0 -
                          (*this).colorStart[1 as libc::c_int as usize].g as
                              f32_0) * ratio) as u8_0;
            sp1CD =
                ((*this).colorStart[1 as libc::c_int as usize].b as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[1 as libc::c_int as usize].b as f32_0 -
                          (*this).colorStart[1 as libc::c_int as usize].b as
                              f32_0) * ratio) as u8_0;
            sp1CC =
                ((*this).colorStart[1 as libc::c_int as usize].a as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[1 as libc::c_int as usize].a as f32_0 -
                          (*this).colorStart[1 as libc::c_int as usize].a as
                              f32_0) * ratio) as u8_0;
            sp1CB =
                ((*this).colorStart[2 as libc::c_int as usize].r as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[2 as libc::c_int as usize].r as f32_0 -
                          (*this).colorStart[2 as libc::c_int as usize].r as
                              f32_0) * ratio) as u8_0;
            sp1CA =
                ((*this).colorStart[2 as libc::c_int as usize].g as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[2 as libc::c_int as usize].g as f32_0 -
                          (*this).colorStart[2 as libc::c_int as usize].g as
                              f32_0) * ratio) as u8_0;
            sp1C9 =
                ((*this).colorStart[2 as libc::c_int as usize].b as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[2 as libc::c_int as usize].b as f32_0 -
                          (*this).colorStart[2 as libc::c_int as usize].b as
                              f32_0) * ratio) as u8_0;
            sp1C8 =
                ((*this).colorStart[2 as libc::c_int as usize].a as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[2 as libc::c_int as usize].a as f32_0 -
                          (*this).colorStart[2 as libc::c_int as usize].a as
                              f32_0) * ratio) as u8_0;
            sp1C7 =
                ((*this).colorStart[3 as libc::c_int as usize].r as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[3 as libc::c_int as usize].r as f32_0 -
                          (*this).colorStart[3 as libc::c_int as usize].r as
                              f32_0) * ratio) as u8_0;
            sp1C6 =
                ((*this).colorStart[3 as libc::c_int as usize].g as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[3 as libc::c_int as usize].g as f32_0 -
                          (*this).colorStart[3 as libc::c_int as usize].g as
                              f32_0) * ratio) as u8_0;
            sp1C5 =
                ((*this).colorStart[3 as libc::c_int as usize].b as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[3 as libc::c_int as usize].b as f32_0 -
                          (*this).colorStart[3 as libc::c_int as usize].b as
                              f32_0) * ratio) as u8_0;
            sp1C4 =
                ((*this).colorStart[3 as libc::c_int as usize].a as
                     libc::c_int as libc::c_float +
                     ((*this).colorEnd[3 as libc::c_int as usize].a as f32_0 -
                          (*this).colorStart[3 as libc::c_int as usize].a as
                              f32_0) * ratio) as u8_0;
            i = 0 as libc::c_int;
            loop  {
                ...
                let mut sp12C: MtxF = MtxF{mf: [[0.; 4]; 4],};
                let mut spEC: MtxF = MtxF{mf: [[0.; 4]; 4],};
                let mut spAC: MtxF = MtxF{mf: [[0.; 4]; 4],};
                let mut sp6C: MtxF = MtxF{mf: [[0.; 4]; 4],};
                let mut elem: *mut EffectSparkElement =
                    &mut *(*this).elements.as_mut_ptr().offset(i as isize) as
                        *mut EffectSparkElement;
                let mut mtx: *mut Mtx = 0 as *mut Mtx;
                let mut temp: f32_0 = 0.;
                SkinMatrix_SetTranslate(&mut spEC, (*elem).position.x,
                                        (*elem).position.y,
                                        (*elem).position.z);
                temp = (Rand_ZeroOne() * 2.5f32 + 1.5f32) / 64.0f32;
                SkinMatrix_SetScale(&mut spAC, temp, temp, 1.0f32);
                SkinMatrix_MtxFMtxFMult(&mut spEC,
                                        &mut (*globalCtx).billboardMtxF,
                                        &mut sp6C);
                SkinMatrix_MtxFMtxFMult(&mut sp6C, &mut spAC, &mut sp12C);
                (*vertices.offset(j as isize)).v.ob[0 as libc::c_int as usize]
                    = -(32 as libc::c_int) as libc::c_short;
                (*vertices.offset(j as isize)).v.ob[1 as libc::c_int as usize]
                    = -(32 as libc::c_int) as libc::c_short;
                (*vertices.offset(j as isize)).v.ob[2 as libc::c_int as usize]
                    = 0 as libc::c_int as libc::c_short;
                (*vertices.offset(j as isize)).v.cn[0 as libc::c_int as usize]
                    = sp1D3;
                (*vertices.offset(j as isize)).v.cn[1 as libc::c_int as usize]
                    = sp1D2;
                (*vertices.offset(j as isize)).v.cn[2 as libc::c_int as usize]
                    = sp1D1;
                (*vertices.offset(j as isize)).v.cn[3 as libc::c_int as usize]
                    = sp1D0;
                (*vertices.offset(j as isize)).v.tc[0 as libc::c_int as usize]
                    = 0 as libc::c_int as libc::c_short;
                (*vertices.offset(j as isize)).v.tc[1 as libc::c_int as usize]
                    = 1024 as libc::c_int as libc::c_short;
                (*vertices.offset(j as isize)).v.flag =
                    0 as libc::c_int as libc::c_ushort;
                (*vertices.offset((j + 1 as libc::c_int) as
                ...
                (*vertices.offset((j + 1 as libc::c_int) as
                    ...
                    = 0 as libc::c_int as libc::c_short;
                (*vertices.offset((j + 1 as libc::c_int) as isize)).v.flag =
                    0 as libc::c_int as libc::c_ushort;
                (*vertices.offset((j + 2 as libc::c_int) as
                                      isize)).v.ob[0 as libc::c_int as usize]
                    = -(32 as libc::c_int) as libc::c_short;
                (*vertices.offset((j + 2 as libc::c_int) as
                                      isize)).v.ob[1 as libc::c_int as usize]
                ...
                (*vertices.offset((j + 2 as libc::c_int) as
                                      isize)).v.tc[1 as libc::c_int as usize]
                    = 0 as libc::c_int as libc::c_short;
                (*vertices.offset((j + 2 as libc::c_int) as isize)).v.flag =
                    0 as libc::c_int as libc::c_ushort;
                (*vertices.offset((j + 3 as libc::c_int) as
                                      isize)).v.ob[0 as libc::c_int as usize]
                    = 32 as libc::c_int as libc::c_short;
                (*vertices.offset((j + 3 as libc::c_int) as
                                      isize)).v.ob[1 as libc::c_int as usize]
                ...
                (*vertices.offset((j + 3 as libc::c_int) as
                                      isize)).v.tc[1 as libc::c_int as usize]
                    = 1024 as libc::c_int as libc::c_short;
                (*vertices.offset((j + 3 as libc::c_int) as isize)).v.flag =
                    0 as libc::c_int as libc::c_ushort;
                j += 4 as libc::c_int;
                mtx = SkinMatrix_MtxFToNewMtx(gfxCtx, &mut sp12C);
                if mtx.is_null() {
                    current_block = 17434351828161064849;
                    break ;
                }
                    ...
                    (0xda as libc::c_int as u32_0 &
                        ...
                        (((0 as libc::c_int | 0x2 as libc::c_int |
                             ...
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_15).words.w1 = mtx as libc::c_uint;
                ...
                (*_g_16).words.w0 =
                    (0x1 as libc::c_int as u32_0 &
                        ...
                        ((0 as libc::c_int + 4 as libc::c_int) as u32_0 &
                            ...
                            1 as libc::c_int;
                (*_g_16).words.w1 =
                    &mut *vertices.offset((4 as libc::c_int * i) as isize) as
