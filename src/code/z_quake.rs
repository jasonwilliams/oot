...
pub struct QuakeRequest {
    pub randIdx: s16,
    pub countdownMax: s16,
    pub cam: *mut Camera,
    pub callbackIdx: u32_0,
    pub y: s16,
    pub x: s16,
    pub zoom: s16,
    pub rotZ: s16,
    pub unk_14: SubQuakeRequest14,
    pub speed: s16,
    pub unk_1C: s16,
    pub countdown: s16,
    pub camPtrIdx: s16,
...
#[no_mangle]
pub static mut sQuakeRequest: [QuakeRequest; 4] =
    [QuakeRequest{randIdx: 0,
                  countdownMax: 0,
                  cam: 0 as *const Camera as *mut Camera,
                  callbackIdx: 0,
                  y: 0,
                  x: 0,
                  zoom: 0,
                  rotZ: 0,
                  unk_14: SubQuakeRequest14{unk_00: 0, unk_02: 0, unk_04: 0,},
                  speed: 0,
                  unk_1C: 0,
                  countdown: 0,
                  camPtrIdx: 0,}; 4];
#[no_mangle]
pub static mut D_80126250: s16 = 1 as libc::c_int as s16;
#[no_mangle]
pub static mut sQuakeRequestCount: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut sQuakeCallbacks:
           [Option<unsafe extern "C" fn(_: *mut QuakeRequest,
                                        _: *mut ShakeInfo) -> s16>; 7] =
    unsafe {
        [None,
         Some(Quake_Callback1 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16),
         Some(Quake_Callback2 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16),
         Some(Quake_Callback3 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16),
         Some(Quake_Callback4 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16),
         Some(Quake_Callback5 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16),
         Some(Quake_Callback6 as
                  unsafe extern "C" fn(_: *mut QuakeRequest,
                                       _: *mut ShakeInfo) -> s16)]
    };
#[no_mangle]
pub unsafe extern "C" fn Quake_AddVec(mut dst: *mut Vec3f,
                                      mut arg1: *mut Vec3f,
                                      mut arg2: *mut VecSph) -> *mut Vec3f {
    let mut vec1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,}; // memset
    let mut vec2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    OLib_VecSphGeoToVec3f(&mut vec2, arg2);
...
#[no_mangle]
pub unsafe extern "C" fn Quake_UpdateShakeInfo(mut req: *mut QuakeRequest,
                                               mut shake: *mut ShakeInfo,
                                               mut y: f32_0, mut x: f32_0) {
    let mut unk50: *mut Vec3f = &mut (*(*req).cam).at;
    let mut unk5C: *mut Vec3f = &mut (*(*req).cam).eye;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut struc2: VecSph = VecSph{r: 0., pitch: 0, yaw: 0,};
    let mut struc1: VecSph = VecSph{r: 0., pitch: 0, yaw: 0,};
    let mut vec2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*req).unk_1C != 0 {
        vec.x = 0 as libc::c_int as f32_0;
        vec.y = 0 as libc::c_int as f32_0;
        vec.z = 0 as libc::c_int as f32_0;
        OLib_Vec3fDiffToVecSphGeo(&mut struc1, unk5C, unk50);
        struc2.r = (*req).y as libc::c_int as libc::c_float * y;
        struc2.pitch =
            (struc1.pitch as libc::c_int + (*req).unk_14.unk_00 as libc::c_int
                 + 0x4000 as libc::c_int) as s16;
        struc2.yaw =
            (struc1.yaw as libc::c_int + (*req).unk_14.unk_02 as libc::c_int)
                as s16;
        Quake_AddVec(&mut vec, &mut vec, &mut struc2);
        struc2.r = (*req).x as libc::c_int as libc::c_float * x;
        struc2.pitch =
            (struc1.pitch as libc::c_int +
                 (*req).unk_14.unk_00 as libc::c_int) as s16;
        struc2.yaw =
            (struc1.yaw as libc::c_int + (*req).unk_14.unk_02 as libc::c_int +
                 0x4000 as libc::c_int) as s16;
        Quake_AddVec(&mut vec, &mut vec, &mut struc2);
        ...
        vec.x = 0 as libc::c_int as f32_0;
        vec.y = (*req).y as libc::c_int as libc::c_float * y;
        vec.z = 0 as libc::c_int as f32_0;
        struc2.r = (*req).x as libc::c_int as libc::c_float * x;
    ...
    (*shake).vec2 = vec2;
    (*shake).vec1 = vec2;
    (*shake).unk_1A = (0x8000 as libc::c_int as f32_0 * y) as s16;
    (*shake).rotZ = ((*req).rotZ as libc::c_int as libc::c_float * y) as s16;
    (*shake).zoom = ((*req).zoom as libc::c_int as libc::c_float * y) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback1(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    let mut pad: s32 = 0;
    if (*req).countdown as libc::c_int > 0 as libc::c_int {
        let mut a: f32_0 =
            Math_SinS(((*req).speed as libc::c_int *
                           (*req).countdown as libc::c_int) as s16);
...
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback5(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    if (*req).countdown as libc::c_int > 0 as libc::c_int {
        let mut a: f32_0 =
            Math_SinS(((*req).speed as libc::c_int *
...
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback6(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    let mut pad: s32 = 0;
    let mut a: f32_0 = 0.;
    (*req).countdown -= 1;
    a =
        Math_SinS(((*req).speed as libc::c_int *
                       (((*req).countdown as libc::c_int & 0xf as libc::c_int)
                            + 500 as libc::c_int)) as s16);
    Quake_UpdateShakeInfo(req, shake, a, Rand_ZeroOne() * a);
    return 1 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback3(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    if (*req).countdown as libc::c_int > 0 as libc::c_int {
        let mut a: f32_0 =
            Math_SinS(((*req).speed as libc::c_int *
                           (*req).countdown as libc::c_int) as s16) *
                ((*req).countdown as f32_0 / (*req).countdownMax as f32_0);
        Quake_UpdateShakeInfo(req, shake, a, a);
        (*req).countdown -= 1
    }
    return (*req).countdown;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback2(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    if (*req).countdown as libc::c_int > 0 as libc::c_int {
        let mut a: f32_0 = Rand_ZeroOne();
        Quake_UpdateShakeInfo(req, shake, a, Rand_ZeroOne() * a);
        (*req).countdown -= 1
    }
    return (*req).countdown;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_Callback4(mut req: *mut QuakeRequest,
                                         mut shake: *mut ShakeInfo) -> s16 {
    if (*req).countdown as libc::c_int > 0 as libc::c_int {
        let mut a: f32_0 =
            Rand_ZeroOne() *
...
#[no_mangle]
pub unsafe extern "C" fn Quake_GetFreeIndex() -> s16 {
    let mut i: s32 = 0;
    let mut ret: s32 = 0;
    let mut min: s32 = 0x10000 as libc::c_int;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[QuakeRequest; 4]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<QuakeRequest>()
                                                   as libc::c_ulong) as s32 {
        if sQuakeRequest[i as usize].callbackIdx ==
               0 as libc::c_int as libc::c_uint {
            ret = i;
            min = 0x20000 as libc::c_int;
            break ;
        } else {
            if (sQuakeRequest[i as usize].countdown as libc::c_int) < min {
                min = sQuakeRequest[i as usize].countdown as s32;
                ret = i
            }
            i += 1
        }
    }
    if min != 0x20000 as libc::c_int {
        osSyncPrintf(b"\x1b[43;30mquake: too many request %d is changed new one !!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, ret);
    }
    return ret as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_AddImpl(mut cam: *mut Camera,
                                       mut callbackIdx: u32_0)
 -> *mut QuakeRequest {
    let mut idx: s16 = Quake_GetFreeIndex();
    let mut req: *mut QuakeRequest =
        &mut *sQuakeRequest.as_mut_ptr().offset(idx as isize) as
            *mut QuakeRequest;
    func_80106860(req as *mut libc::c_void, 0 as libc::c_int,
                  ::std::mem::size_of::<QuakeRequest>() as libc::c_ulong as
                      size_t);
    (*req).cam = cam;
    (*req).camPtrIdx = (*cam).thisIdx;
    (*req).callbackIdx = callbackIdx;
    (*req).unk_1C = 1 as libc::c_int as s16;
    (*req).randIdx =
        (((Rand_ZeroOne() * 0x10000 as libc::c_int as f32_0) as s16 as
              libc::c_int & !(3 as libc::c_int)) + idx as libc::c_int) as s16;
    sQuakeRequestCount += 1;
    return req;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_Remove(mut req: *mut QuakeRequest) {
    (*req).callbackIdx = 0 as libc::c_int as u32_0;
    (*req).countdown = -(1 as libc::c_int) as s16;
    sQuakeRequestCount -= 1;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_GetRequest(mut idx: s16) -> *mut QuakeRequest {
    let mut req: *mut QuakeRequest =
        &mut *sQuakeRequest.as_mut_ptr().offset((idx as libc::c_int &
                                                     3 as libc::c_int) as
                                                    isize) as
            *mut QuakeRequest;
    if (*req).callbackIdx == 0 as libc::c_int as libc::c_uint {
        return 0 as *mut QuakeRequest
    }
    if idx as libc::c_int != (*req).randIdx as libc::c_int {
        return 0 as *mut QuakeRequest
    }
    return req;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_SetValue(mut idx: s16, mut valueType: s16,
                                        mut value: s16) -> *mut QuakeRequest {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if req.is_null() {
        return 0 as *mut QuakeRequest
    } else {
        match valueType as libc::c_int {
            1 => { (*req).speed = value }
            2 => { (*req).y = value }
            4 => { (*req).x = value }
            8 => { (*req).zoom = value }
            16 => { (*req).rotZ = value }
            32 => { (*req).unk_14.unk_00 = value }
            64 => { (*req).unk_14.unk_02 = value }
            128 => { (*req).unk_14.unk_04 = value }
            256 => {
                (*req).countdown = value;
                (*req).countdownMax = (*req).countdown
            }
            512 => { (*req).unk_1C = value }
            _ => { }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn Quake_SetSpeed(mut idx: s16, mut value: s16)
 -> u32_0 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() {
        (*req).speed = value;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_SetCountdown(mut idx: s16, mut value: s16)
 -> u32_0 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() {
        (*req).countdown = value;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_GetCountdown(mut idx: s16) -> s16 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() { return (*req).countdown }
    return 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_SetQuakeValues(mut idx: s16, mut y: s16,
                                              mut x: s16, mut zoom: s16,
                                              mut rotZ: s16) -> u32_0 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() {
        (*req).y = y;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_SetUnkValues(mut idx: s16, mut arg1: s16,
                                            mut arg2: SubQuakeRequest14)
 -> u32_0 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() {
        (*req).unk_1C = arg1;
...
#[no_mangle]
pub unsafe extern "C" fn Quake_Init() {
    let mut i: s16 = 0;
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[QuakeRequest; 4]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<QuakeRequest>()
                                                   as libc::c_ulong) as s32 {
        sQuakeRequest[i as usize].callbackIdx = 0 as libc::c_int as u32_0;
        sQuakeRequest[i as usize].countdown = 0 as libc::c_int as s16;
        i += 1
    }
    D_80126250 = 1 as libc::c_int as s16;
    sQuakeRequestCount = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_Add(mut cam: *mut Camera,
                                   mut callbackIdx: u32_0) -> s16 {
    return (*Quake_AddImpl(cam, callbackIdx)).randIdx;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_RemoveFromIdx(mut idx: s16) -> u32_0 {
    let mut req: *mut QuakeRequest = Quake_GetRequest(idx);
    if !req.is_null() { Quake_Remove(req); return 1 as libc::c_int as u32_0 }
    return 0 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn Quake_Calc(mut camera: *mut Camera,
                                    mut camData: *mut QuakeCamCalc) -> s16 {
    let mut max: f32_0 = 0.;
    let mut max2: f32_0 = 0.;
    let mut req: *mut QuakeRequest = 0 as *mut QuakeRequest;
    let mut shake: ShakeInfo =
        ShakeInfo{vec1: Vec3f{x: 0., y: 0., z: 0.,},
                  vec2: Vec3f{x: 0., y: 0., z: 0.,},
                  rotZ: 0,
                  unk_1A: 0,
                  zoom: 0,};
    let mut absSpeedDiv: f32_0 = 0.;
    let mut temp: *mut s16 = 0 as *mut s16;
    let mut pad2: u32_0 = 0;
    let mut idx: s32 = 0;
    let mut ret: s32 = 0;
    let mut eq: u32_0 = 0;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut globalCtx: *mut GlobalContext = 0 as *mut GlobalContext;
    globalCtx = (*camera).globalCtx;
    vec.x = 0.0f32;
    vec.y = 0.0f32;
    vec.z = 0.0f32;
    (*camData).rotZ = 0 as libc::c_int as s16;
    (*camData).unk_1A = 0 as libc::c_int as s16;
    (*camData).zoom = 0 as libc::c_int as s16;
    (*camData).atOffset.x = 0.0f32;
    (*camData).atOffset.y = 0.0f32;
    (*camData).atOffset.z = 0.0f32;
    (*camData).eyeOffset.x = 0.0f32;
    (*camData).eyeOffset.y = 0.0f32;
    (*camData).eyeOffset.z = 0.0f32;
    (*camData).unk_20 = 0.0f32;
    if sQuakeRequestCount as libc::c_int == 0 as libc::c_int {
        return 0 as libc::c_int as s16
    }
    ret = 0 as libc::c_int;
    idx = 0 as libc::c_int;
    while idx <
        ...
        req =
            &mut *sQuakeRequest.as_mut_ptr().offset(idx as isize) as
                *mut QuakeRequest;
        if (*req).callbackIdx != 0 as libc::c_int as libc::c_uint {
            if (*globalCtx).cameraPtrs[(*req).camPtrIdx as usize].is_null() {
                osSyncPrintf(b"\x1b[43;30mquake: stopped! \'coz camera [%d] killed!!\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*req).camPtrIdx as libc::c_int);
                Quake_Remove(req);
            } else {
                temp = &mut (*camera).thisIdx;
                eq =
                    ((*(*req).cam).thisIdx as libc::c_int !=
                         *temp as libc::c_int) as libc::c_int as u32_0;
                absSpeedDiv =
                    (if (*req).speed as libc::c_int >= 0 as libc::c_int {
                         (*req).speed as libc::c_int
                     } else { -((*req).speed as libc::c_int) }) as
                        libc::c_float / 0x8000 as libc::c_int as f32_0;
                if sQuakeCallbacks[(*req).callbackIdx as
                                       usize].expect("non-null function pointer")(req,
                                                                                  &mut shake)
                       as libc::c_int == 0 as libc::c_int {
                    Quake_Remove(req);
                } else if eq == 0 as libc::c_int as libc::c_uint {
                    ...
                    if ((*camData).rotZ as libc::c_int) <
                           shake.rotZ as libc::c_int {
                        (*camData).rotZ = shake.rotZ;
                        (*camData).unk_1A = shake.unk_1A
                    }
                    if ((*camData).zoom as libc::c_int) <
                           shake.zoom as libc::c_int {
                        (*camData).zoom = shake.zoom
                    }
                    max =
                        OLib_Vec3fDist(&mut shake.vec1, &mut vec) *
                            absSpeedDiv;
                    max2 =
                        OLib_Vec3fDist(&mut shake.vec2, &mut vec) *
                            absSpeedDiv;
                    if max < max2 { max = max2 }
                    max2 =
                        (*camData).rotZ as libc::c_int as libc::c_float *
                            0.005f32 * absSpeedDiv;
                    if max < max2 { max = max2 }
                    max2 =
                        (*camData).zoom as libc::c_int as libc::c_float *
                            0.005f32 * absSpeedDiv;
                    if max < max2 { max = max2 }
                    if (*camData).unk_20 < max { (*camData).unk_20 = max }
                    ret += 1
                }
            }
        }
