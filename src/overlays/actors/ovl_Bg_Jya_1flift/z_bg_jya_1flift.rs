...
extern "C" {
    ...
    #[no_mangle]
    static mut g1fliftDL: [Gfx; 0];
    #[no_mangle]
    static mut g1fliftCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJya1flift {
    pub dyna: DynaPolyActor,
    pub collider: ColliderCylinder,
    pub actionFunc: BgJya1fliftActionFunc,
    pub moveDelay: s16,
    pub isMovingDown: u8_0,
    pub hasInitialized: u8_0,
    pub isLinkRiding: u8_0,
}
pub type BgJya1fliftActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJya1flift, _: *mut GlobalContext)
               -> ()>;
static mut sIsSpawned: u8_0 = 0 as libc::c_int as u8_0;
#[no_mangle]
pub static mut Bg_Jya_1flift_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_1FLIFT as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJya1flift>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJya1flift_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJya1flift_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJya1flift_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJya1flift_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sFinalPositions: [f32_0; 2] = [443.0f32, -50.0f32];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_InitDynapoly(mut this: *mut BgJya1flift,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut collision:
                                                      *mut CollisionHeader,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_1flift.c\x00" as *const u8 as
                         *const libc::c_char, 179 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_InitCollision(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut this: *mut BgJya1flift = thisx as *mut BgJya1flift;
...
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJya1flift = thisx as *mut BgJya1flift;
    // "1 F lift"
    osSyncPrintf(b"(\xef\xbc\x91\xef\xbc\xa6\xe3\x83\xaa\xe3\x83\x95\xe3\x83\x88)(flag %d)(room %d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 sIsSpawned as libc::c_int,
                 (*globalCtx).roomCtx.curRoom.num as libc::c_int);
    (*this).hasInitialized = 0 as libc::c_int as u8_0;
    if sIsSpawned != 0 { Actor_Kill(thisx); return }
    BgJya1flift_InitDynapoly(this, globalCtx, &mut g1fliftCol,
                             0 as libc::c_int);
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        } else { BgJya1flift_SetupDoNothing(this); };
    } else { BgJya1flift_SetupWaitForSwitch(this); }
    (*thisx).room = -(1 as libc::c_int) as s8;
    sIsSpawned = 1 as libc::c_int as u8_0;
    (*this).hasInitialized = 1 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJya1flift = thisx as *mut BgJya1flift;
    if (*this).hasInitialized != 0 {
        sIsSpawned = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_SetupWaitForSwitch(mut this:
                                                            *mut BgJya1flift) {
    (*this).actionFunc =
        Some(BgJya1flift_WaitForSwitch as
                 unsafe extern "C" fn(_: *mut BgJya1flift,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y =
        sFinalPositions[0 as libc::c_int as usize];
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_WaitForSwitch(mut this: *mut BgJya1flift,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_SetupDoNothing(mut this:
                                                        *mut BgJya1flift) {
    (*this).actionFunc =
        Some(BgJya1flift_DoNothing as
                 unsafe extern "C" fn(_: *mut BgJya1flift,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y =
        sFinalPositions[0 as libc::c_int as usize];
...
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_DoNothing(mut this: *mut BgJya1flift,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_ChangeDirection(mut this:
                                                         *mut BgJya1flift) {
    (*this).actionFunc =
        Some(BgJya1flift_Move as
                 unsafe extern "C" fn(_: *mut BgJya1flift,
                                      _: *mut GlobalContext) -> ());
    (*this).isMovingDown =
        ((*this).isMovingDown as libc::c_int ^ 1 as libc::c_int) as u8_0;
    (*this).dyna.actor.velocity.y = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_Move(mut this: *mut BgJya1flift,
                                          mut globalCtx: *mut GlobalContext) {
    let mut tempVelocity: f32_0 = 0.;
    Math_StepToF(&mut (*this).dyna.actor.velocity.y, 6.0f32, 0.4f32);
    if (*this).dyna.actor.velocity.y < 1.0f32 {
        tempVelocity = 1.0f32
    } else { tempVelocity = (*this).dyna.actor.velocity.y }
    if fabsf(Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                                sFinalPositions[(*this).isMovingDown as
                                                    usize], 0.5f32,
                                tempVelocity, 1.0f32)) < 0.001f32 {
        (*this).dyna.actor.world.pos.y =
            sFinalPositions[(*this).isMovingDown as usize];
        ...
        func_8002F974(&mut (*this).dyna.actor,
                      (0x28b9 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_ResetMoveDelay(mut this:
                                                        *mut BgJya1flift) {
    (*this).actionFunc =
        Some(BgJya1flift_DelayMove as
                 unsafe extern "C" fn(_: *mut BgJya1flift,
                                      _: *mut GlobalContext) -> ());
    (*this).moveDelay = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_DelayMove(mut this: *mut BgJya1flift,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).moveDelay += 1;
    if (*this).moveDelay as libc::c_int >= 21 as libc::c_int {
        BgJya1flift_ChangeDirection(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_Update(mut thisx: *mut Actor,
                                            mut globalCtx2:
                                                *mut GlobalContext) {
    let mut this: *mut BgJya1flift = thisx as *mut BgJya1flift;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut tempIsRiding: s32 = 0;
    ...
    if (*globalCtx).roomCtx.curRoom.num as libc::c_int == 6 as libc::c_int ||
           (*globalCtx).roomCtx.curRoom.num as libc::c_int == 0 as libc::c_int
       {
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            if tempIsRiding != 0 {
                Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int
                                                                 as usize],
                                     CAM_SET_FIRE_PLATFORM as libc::c_int as
                                         s16);
            } else if tempIsRiding == 0 &&
                          (*this).isLinkRiding as libc::c_int != 0 {
                Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int
                                                                 as usize],
                                     CAM_SET_DUNGEON0 as libc::c_int as s16);
            }
        }
        (*this).isLinkRiding = tempIsRiding as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn BgJya1flift_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, g1fliftDL.as_mut_ptr());
}
