...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ItemEtcetera {
    pub actor: Actor,
    pub futureActionFunc: ItemEtceteraActionFunc,
    pub giDrawId: s16,
    pub getItemId: s16,
    pub objBankIndex: u8_0,
    pub drawFunc: ActorFunc,
    pub actionFunc: ItemEtceteraActionFunc,
}
pub type ItemEtceteraActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ItemEtcetera, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const ITEM_ETC_KEY_SMALL_CHEST_GAME: C2RustUnnamed_20 = 13;
pub const ITEM_ETC_HEART_PIECE_CHEST_GAME: C2RustUnnamed_20 = 12;
pub const ITEM_ETC_RUPEE_PURPLE_CHEST_GAME: C2RustUnnamed_20 = 11;
pub const ITEM_ETC_RUPEE_RED_CHEST_GAME: C2RustUnnamed_20 = 10;
pub const ITEM_ETC_RUPEE_BLUE_CHEST_GAME: C2RustUnnamed_20 = 9;
pub const ITEM_ETC_RUPEE_GREEN_CHEST_GAME: C2RustUnnamed_20 = 8;
pub const ITEM_ETC_ARROW_FIRE: C2RustUnnamed_20 = 7;
pub const ITEM_ETC_KEY_SMALL: C2RustUnnamed_20 = 6;
pub const ITEM_ETC_SCALE_GOLD: C2RustUnnamed_20 = 5;
pub const ITEM_ETC_SCALE_SILVER: C2RustUnnamed_20 = 4;
pub const ITEM_ETC_QUIVER: C2RustUnnamed_20 = 3;
pub const ITEM_ETC_SHIELD_HYLIAN: C2RustUnnamed_20 = 2;
pub const ITEM_ETC_LETTER: C2RustUnnamed_20 = 1;
pub const ITEM_ETC_BOTTLE: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut Item_Etcetera_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ITEM_ETCETERA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<ItemEtcetera>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemEtcetera_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemEtcetera_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemEtcetera_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sObjectIds: [s16; 14] =
    [OBJECT_GI_BOTTLE as libc::c_int as s16,
     OBJECT_GI_BOTTLE_LETTER as libc::c_int as s16,
     OBJECT_GI_SHIELD_2 as libc::c_int as s16,
     OBJECT_GI_ARROWCASE as libc::c_int as s16,
     OBJECT_GI_SCALE as libc::c_int as s16,
     OBJECT_GI_SCALE as libc::c_int as s16,
     OBJECT_GI_KEY as libc::c_int as s16,
     OBJECT_GI_M_ARROW as libc::c_int as s16,
     OBJECT_GI_RUPY as libc::c_int as s16,
     OBJECT_GI_RUPY as libc::c_int as s16,
     OBJECT_GI_RUPY as libc::c_int as s16,
     OBJECT_GI_RUPY as libc::c_int as s16,
     OBJECT_GI_HEARTS as libc::c_int as s16,
     OBJECT_GI_KEY as libc::c_int as s16];
// Indexes passed to the item table in z_draw.c
static mut sDrawItemIndexes: [s16; 14] =
    [GID_BOTTLE as libc::c_int as s16, GID_LETTER_RUTO as libc::c_int as s16,
     GID_SHIELD_HYLIAN as libc::c_int as s16,
     GID_QUIVER_40 as libc::c_int as s16,
     GID_SCALE_SILVER as libc::c_int as s16,
     GID_SCALE_GOLDEN as libc::c_int as s16,
     GID_KEY_SMALL as libc::c_int as s16,
     GID_ARROW_FIRE as libc::c_int as s16,
     GID_RUPEE_GREEN as libc::c_int as s16,
     GID_RUPEE_BLUE as libc::c_int as s16,
     GID_RUPEE_RED as libc::c_int as s16,
     GID_RUPEE_PURPLE as libc::c_int as s16,
     GID_HEART_PIECE as libc::c_int as s16,
     GID_KEY_SMALL as libc::c_int as s16];
static mut sGetItemIds: [s16; 14] =
    [GI_BOTTLE as libc::c_int as s16, GI_LETTER_RUTO as libc::c_int as s16,
     GI_SHIELD_HYLIAN as libc::c_int as s16,
     GI_QUIVER_40 as libc::c_int as s16,
     GI_SCALE_SILVER as libc::c_int as s16,
     GI_SCALE_GOLD as libc::c_int as s16, GI_KEY_SMALL as libc::c_int as s16,
     GI_ARROW_FIRE as libc::c_int as s16, GI_NONE as libc::c_int as s16,
     GI_NONE as libc::c_int as s16, GI_NONE as libc::c_int as s16,
     GI_NONE as libc::c_int as s16, GI_NONE as libc::c_int as s16,
     GI_NONE as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_SetupAction(mut this: *mut ItemEtcetera,
                                                  mut actionFunc:
                                                      ItemEtceteraActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ItemEtcetera = thisx as *mut ItemEtcetera;
    let mut pad: s32 = 0;
    let mut type_0: s32 = 0;
    let mut objBankIndex: s32 = 0;
    type_0 = (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    osSyncPrintf(b"no = %d\n\x00" as *const u8 as *const libc::c_char,
                 type_0);
    objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        sObjectIds[type_0 as usize]);
    ...
    if objBankIndex < 0 as libc::c_int {
        if 0 as libc::c_int != 0 {
            ...
            __assert(b"0\x00" as *const u8 as *const libc::c_char,
                     b"../z_item_etcetera.c\x00" as *const u8 as
                         *const libc::c_char, 241 as libc::c_int);
        };
    } else { (*this).objBankIndex = objBankIndex as u8_0 }
    (*this).giDrawId = sDrawItemIndexes[type_0 as usize];
    (*this).getItemId = sGetItemIds[type_0 as usize];
    (*this).futureActionFunc =
        Some(func_80B85824 as
                 unsafe extern "C" fn(_: *mut ItemEtcetera,
                                      _: *mut GlobalContext) -> ());
    (*this).drawFunc =
        Some(ItemEtcetera_Draw as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    Actor_SetScale(&mut (*this).actor, 0.25f32);
    ItemEtcetera_SetupAction(this,
                             Some(func_80B857D0 as
                                      unsafe extern "C" fn(_:
                                                               *mut ItemEtcetera,
                                                           _:
                                                               *mut GlobalContext)
    ...
    match type_0 {
        ...
        7 => {
            (*this).futureActionFunc =
                Some(ItemEtcetera_UpdateFireArrow as
                         unsafe extern "C" fn(_: *mut ItemEtcetera,
                                              _: *mut GlobalContext) -> ());
            Actor_SetScale(&mut (*this).actor, 0.5f32);
            (*this).actor.draw = None;
            (*this).actor.shape.yOffset = 50.0f32
        }
        8 | 9 | 10 | 11 | 12 | 13 => {
            Actor_SetScale(&mut (*this).actor, 0.5f32);
            (*this).futureActionFunc =
                Some(func_80B85B28 as
                         unsafe extern "C" fn(_: *mut ItemEtcetera,
                                              _: *mut GlobalContext) -> ());
            (*this).drawFunc =
                Some(ItemEtcetera_DrawThroughLens as
...
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80B857D0(mut this: *mut ItemEtcetera,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B85824(mut this: *mut ItemEtcetera,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        func_8002F434(&mut (*this).actor, globalCtx, (*this).getItemId as s32,
                      30.0f32, 50.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B858B4(mut this: *mut ItemEtcetera,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.params as libc::c_int & 0xff as libc::c_int ==
               1 as libc::c_int {
        ...
        func_8002F434(&mut (*this).actor, globalCtx, (*this).getItemId as s32,
                      30.0f32, 50.0f32);
        if (*globalCtx).gameplayFrames & 0xd as libc::c_int as libc::c_uint ==
...
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_SpawnSparkles(mut this:
                                                        *mut ItemEtcetera,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    velocity.y = -0.05f32;
    accel.y = -0.025f32;
    pos.x = Rand_CenteredFloat(12.0f32) + (*this).actor.world.pos.x;
    pos.y = Rand_ZeroOne() * 6.0f32 + (*this).actor.world.pos.y;
    pos.z = Rand_CenteredFloat(12.0f32) + (*this).actor.world.pos.z;
    EffectSsKiraKira_SpawnDispersed(globalCtx, &mut pos, &mut velocity,
                                    &mut accel, &mut primColor, &mut envColor,
                                    5000 as libc::c_int as s16,
                                    16 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_MoveFireArrowDown(mut this:
                                                            *mut ItemEtcetera,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B85B28(mut this: *mut ItemEtcetera,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetTreasure(globalCtx,
                         (*this).actor.params as libc::c_int >>
                             8 as libc::c_int & 0x1f as libc::c_int) != 0 {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_UpdateFireArrow(mut this:
                                                          *mut ItemEtcetera,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       ...
       {
        LogUtils_LogThreadId(b"../z_item_etcetera.c\x00" as *const u8 as
                                 *const libc::c_char, 441 as libc::c_int);
        osSyncPrintf(b"(game_play->demo_play.npcdemopnt[0]->dousa) = %d\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                         usize]).action as
                         libc::c_int);
        if (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as usize]).action
            ...
            (*this).actionFunc =
                Some(ItemEtcetera_MoveFireArrowDown as
                         unsafe extern "C" fn(_: *mut ItemEtcetera,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ItemEtcetera = thisx as *mut ItemEtcetera;
...
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_DrawThroughLens(mut thisx: *mut Actor,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut this: *mut ItemEtcetera = thisx as *mut ItemEtcetera;
...
#[no_mangle]
pub unsafe extern "C" fn ItemEtcetera_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ItemEtcetera = thisx as *mut ItemEtcetera;
    func_8002EBCC(&mut (*this).actor, globalCtx, 0 as libc::c_int);
