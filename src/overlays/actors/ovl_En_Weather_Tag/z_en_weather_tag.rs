...
extern "C" {
    ...
    fn DebugDisplay_AddObject(posX: f32_0, posY: f32_0, posZ: f32_0,
     ...
     -> *mut DebugDispObject;
    #[no_mangle]
    fn func_80077624(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn func_80077684(globalCtx: *mut GlobalContext);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut D_8011FB34: u8_0;
    #[no_mangle]
    static mut D_8011FB38: u8_0;
    #[no_mangle]
    static mut gSkyboxBlendingEnabled: u8_0;
    #[no_mangle]
...
pub const LIGHTNING_MODE_LAST: C2RustUnnamed_17 = 2;
pub const LIGHTNING_MODE_ON: C2RustUnnamed_17 = 1;
pub const LIGHTNING_MODE_OFF: C2RustUnnamed_17 = 0;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnWeatherTag {
    pub actor: Actor,
    pub actionFunc: EnWeatherTagActionFunc,
    pub unk_150: [libc::c_char; 4],
}
pub type EnWeatherTagActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWeatherTag, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const EN_WEATHER_TAG_TYPE_THUNDERSTORM_GRAVEYARD: C2RustUnnamed_20 = 7;
pub const EN_WEATHER_TAG_TYPE_SANDSTORM_INTENSITY: C2RustUnnamed_20 = 6;
pub const EN_WEATHER_TAG_TYPE_THUNDERSTORM_KAKARIKO: C2RustUnnamed_20 = 5;
pub const EN_WEATHER_TAG_TYPE_CLOUDY_DEATH_MOUNTAIN: C2RustUnnamed_20 = 4;
pub const EN_WEATHER_TAG_TYPE_RAIN_LAKE_HYLIA: C2RustUnnamed_20 = 3;
pub const EN_WEATHER_TAG_TYPE_SNOW_ZORAS_DOMAIN: C2RustUnnamed_20 = 2;
pub const EN_WEATHER_TAG_TYPE_CLOUDY_LON_LON_RANCH: C2RustUnnamed_20 = 1;
pub const EN_WEATHER_TAG_TYPE_CLOUDY_MARKET: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut En_Weather_Tag_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WEATHER_TAG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnWeatherTag>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWeatherTag_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWeatherTag_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWeatherTag_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_SetupAction(mut this: *mut EnWeatherTag,
                                                  mut actionFunc:
                                                      EnWeatherTagActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnWeatherTag = thisx as *mut EnWeatherTag;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    match (*this).actor.params as libc::c_int & 0xf as libc::c_int {
        0 => {
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            // "☆☆☆☆☆ (;o;) About ☆☆☆☆☆☆"
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xef\xbc\x88;o;) \xe3\x81\x8f\xe3\x82\x89\xe3\x81\x84\xe3\x82\x88\xe3\x83\xbc \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledCloudyHyruleMarket
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        1 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8f\xe3\x82\x82\xe3\x82\x8a (._.) \xe3\x81\x82\xe3\x83\xbc\xe3\x81\x82 \xe6\x86\x82\xe9\xac\xb1 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            if Flags_GetEventChkInf(0x18 as libc::c_int) != 0 {
                Actor_Kill(&mut (*this).actor);
            }
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledCloudyLonLonRanch
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        2 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x86\xe3\x81\x8d\xe3\x81\x8c\xe3\x81\xb5\xe3\x82\x8b\xe3\x83\xbc \xe3\x81\x82\xe3\x81\xaa\xe3\x81\x9f\xe3\x81\xaf\xe3\x81\x93\xe3\x81\xaa\xe3\x81\x84\xe3\x83\xbc (._.) \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            ...
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledCloudySnow as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
                                                                       *mut GlobalContext)
        ...
        3 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x8f\xe3\x82\x8f\xe3\x82\x8f\xe3\x82\x8f\xe3\x83\xbc \xe3\x81\xaa\xe3\x83\xbc\xe3\x81\x8c\xe3\x83\xbc\xe3\x81\x95\xe3\x83\xbc\xe3\x81\x8d\xe3\x83\xbc\xe3\x81\xaf\xe3\x83\xbc (^o^) \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            if gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                   libc::c_int & 0x400 as libc::c_int != 0 {
                Actor_Kill(&mut (*this).actor);
            ...
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledRainLakeHylia
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        4 => {
            ...
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledCloudyDeathMountain
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        5 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8f\xe3\x82\x82\xe3\x82\x8a\xe9\x9b\xa8\xe9\x9b\xb7 (;O;) \xe3\x81\x86\xe3\x81\x8a\xe3\x81\x8a \xe6\x86\x82\xe9\xac\xb1 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            if gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                   ...
                   gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                       libc::c_int & 0x400 as libc::c_int == 0 ||
                   gBitFlags[QUEST_MEDALLION_SHADOW as libc::c_int as usize] &
                       gSaveContext.inventory.questItems != 0 {
                Actor_Kill(&mut (*this).actor);
            }
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledCloudyRainThunderKakariko
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        6 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xa0\x82\xe6\xbc\xa0\xe3\x81\x8c\xe6\xbf\x83\xe3\x81\x8f\xe3\x81\xaa\xe3\x82\x8a\xe3\x81\xbe\xe3\x81\x99 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_SetSandstormIntensity
                                              as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
        ...
        7 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x8f\xe3\x82\x8f\xe3\x82\x8f\xe3\x82\x8f\xe3\x83\xbc \xe3\x81\xaa\xe3\x83\xbc\xe3\x81\x8c\xe3\x83\xbc\xe3\x81\x95\xe3\x83\xbc\xe3\x81\x8d\xe3\x83\xbc\xe3\x81\xaf\xe3\x83\xbc (^o^) \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            EnWeatherTag_SetupAction(this,
                                     Some(EnWeatherTag_DisabledRainThunder as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnWeatherTag,
                                                                   _:
                                                                       *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn WeatherTag_CheckEnableWeatherEffect(mut this:
                                                                 *mut EnWeatherTag,
                                                             mut globalCtx:
                                                                 *mut GlobalContext,
                                                             mut arg2: u8_0,
 ...
 -> u8_0 {
    ...
    if Actor_WorldDistXZToActor(&mut (*player).actor, &mut (*this).actor) <
           ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as
               libc::c_float * 100.0f32 {
        if (*globalCtx).envCtx.indoors as libc::c_int != 0 as libc::c_int ||
               gSkyboxBlendingEnabled == 0 ||
               (*globalCtx).skyboxId as libc::c_int !=
                   SKYBOX_NORMAL_SKY as libc::c_int &&
                   (*globalCtx).envCtx.unk_1F as libc::c_int ==
                       (*globalCtx).envCtx.unk_20 as libc::c_int {
            D_8011FB38 = 1 as libc::c_int as u8_0;
            if (*globalCtx).envCtx.gloomySkyMode as libc::c_int ==
                   0 as libc::c_int &&
                   ((*globalCtx).envCtx.indoors as libc::c_int !=
                        0 as libc::c_int ||
                        (*globalCtx).envCtx.unk_1F as libc::c_int !=
                            1 as libc::c_int &&
                            (*globalCtx).envCtx.unk_21 as libc::c_int ==
                                0 as libc::c_int) {
                D_8011FB38 = 0 as libc::c_int as u8_0;
                if gWeatherMode as libc::c_int != weatherMode as libc::c_int {
                    ...
                    if (*globalCtx).envCtx.gloomySkyMode as libc::c_int ==
                        ...
                        (*globalCtx).envCtx.unk_22 =
                            (*globalCtx).envCtx.unk_24
                    }
                }
                ret = 1 as libc::c_int as u8_0
            }
        } else if gTimeIncrement as libc::c_int != 0 as libc::c_int {
            gSaveContext.dayTime =
                (gSaveContext.dayTime as libc::c_int + 0x14 as libc::c_int) as
                    u16_0
        }
    }
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn WeatherTag_CheckRestoreWeather(mut this:
                                                            *mut EnWeatherTag,
                                                        mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut arg2: u8_0,
 ...
 -> u8_0 {
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as
           libc::c_float * 100.0f32 + 100.0f32 <
           Actor_WorldDistXZToActor(&mut (*player).actor, &mut (*this).actor)
       {
        if (*globalCtx).envCtx.indoors as libc::c_int != 0 as libc::c_int ||
               gSkyboxBlendingEnabled == 0 ||
               (*globalCtx).skyboxId as libc::c_int !=
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledCloudyHyruleMarket(mut this:
                                                                     *mut EnWeatherTag,
                                                                 mut globalCtx:
                                                                     *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
        ...
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledCloudyHyruleMarket
                                          as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledCloudyHyruleMarket(mut this:
                                                                    *mut EnWeatherTag,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
                                      1 as libc::c_int as u8_0,
                                      0 as libc::c_int as u8_0,
                                      3 as libc::c_int as u8_0,
                                      0 as libc::c_int as u8_0,
                                      60 as libc::c_int as u16_0) != 0 {
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_DisabledCloudyHyruleMarket
                                          as
                                          unsafe extern "C" fn(_:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledCloudyLonLonRanch(mut this:
                                                                    *mut EnWeatherTag,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
                                           ...
                                           2 as libc::c_int as u8_0) != 0 {
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledCloudyLonLonRanch as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledCloudyLonLonRanch(mut this:
                                                                   *mut EnWeatherTag,
                                                               mut globalCtx:
                                                                   *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledCloudyDeathMountain(mut this:
                                                                      *mut EnWeatherTag,
                                                                  mut globalCtx:
                                                                      *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
                                           ...
                                           2 as libc::c_int as u8_0) != 0 {
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledCloudyDeathMountain
                                          as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledCloudyDeathMountain(mut this:
                                                                     *mut EnWeatherTag,
                                                                 mut globalCtx:
                                                                     *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledCloudySnow(mut this:
                                                             *mut EnWeatherTag,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledCloudySnow(mut this:
                                                            *mut EnWeatherTag,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledRainLakeHylia(mut this:
                                                                *mut EnWeatherTag,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
        ...
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledRainLakeHylia as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledRainLakeHylia(mut this:
                                                               *mut EnWeatherTag,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
        ...
        (*globalCtx).envCtx.unk_EE[0 as libc::c_int as usize] =
            0 as libc::c_int as u8_0;
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_DisabledRainLakeHylia as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledCloudyRainThunderKakariko(mut this:
                                                                            *mut EnWeatherTag,
                                                                        mut globalCtx:
                                                                            *mut GlobalContext) {
    if WeatherTag_CheckEnableWeatherEffect(this, globalCtx,
                                           ...
                                           100 as libc::c_int as u16_0,
                                           5 as libc::c_int as u8_0) != 0 {
        func_80077624(globalCtx);
        (*globalCtx).envCtx.lightningMode =
            LIGHTNING_MODE_ON as libc::c_int as u8_0;
        (*globalCtx).envCtx.unk_EE[0 as libc::c_int as usize] =
            30 as libc::c_int as u8_0;
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledCloudyRainThunderKakariko
                                          as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledCloudyRainThunderKakariko(mut this:
                                                                           *mut EnWeatherTag,
                                                                       mut globalCtx:
                                                                           *mut GlobalContext) {
    if WeatherTag_CheckRestoreWeather(this, globalCtx,
        ...
        func_80077684(globalCtx);
        (*globalCtx).envCtx.lightningMode =
            LIGHTNING_MODE_LAST as libc::c_int as u8_0;
        (*globalCtx).envCtx.unk_EE[0 as libc::c_int as usize] =
            0 as libc::c_int as u8_0;
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_DisabledCloudyRainThunderKakariko
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_SetSandstormIntensity(mut this:
                                                                *mut EnWeatherTag,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    let mut player: *mut Player =
    ...
    if Actor_WorldDistXZToActor(&mut (*player).actor, &mut (*this).actor) <
           ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as
               libc::c_float * 100.0f32 {
        Math_SmoothStepToS(&mut (*globalCtx).envCtx.adjFogNear,
                           -(0x50 as libc::c_int) as s16,
                           1 as libc::c_int as s16, 2 as libc::c_int as s16,
                           1 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*globalCtx).envCtx.adjFogFar,
        ...
        Math_SmoothStepToS(&mut (*globalCtx).envCtx.adjFogFar,
                           0 as libc::c_int as s16, 1 as libc::c_int as s16,
                           25 as libc::c_int as s16, 1 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_DisabledRainThunder(mut this:
                                                              *mut EnWeatherTag,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut player: *mut Player =
    ...
    if Actor_WorldDistXZToActor(&mut (*player).actor, &mut (*this).actor) <
        ...
        (*globalCtx).envCtx.unk_EE[0 as libc::c_int as usize] =
            25 as libc::c_int as u8_0;
        EnWeatherTag_SetupAction(this,
                                 Some(EnWeatherTag_EnabledRainThunder as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnWeatherTag,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_EnabledRainThunder(mut this:
                                                             *mut EnWeatherTag,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut player: *mut Player =
...
#[no_mangle]
pub unsafe extern "C" fn EnWeatherTag_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnWeatherTag = thisx as *mut EnWeatherTag;
