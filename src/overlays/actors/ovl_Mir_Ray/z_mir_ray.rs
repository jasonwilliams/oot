...
extern "C" {
    ...
    fn LightContext_RemoveLight(globalCtx: *mut GlobalContext,
                                ...
                                node: *mut LightNode);
    #[no_mangle]
    fn Player_HasMirrorShieldSetToDraw(globalCtx: *mut GlobalContext) -> s32;
    #[no_mangle]
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gShieldBeamImageDL: [Gfx; 0];
    #[no_mangle]
    static mut gShieldBeamGlowDL: [Gfx; 0];
}
...
pub struct MirRay {
    ...
    pub shieldRay: ColliderQuad,
    pub reflectIntensity: f32_0,
    pub shieldCorners: [Vec3f; 6],
    pub reflectRange: f32_0,
    pub sourcePt: Vec3f,
    pub poolPt: Vec3f,
    pub sourceEndRad: s16,
    pub poolEndRad: s16,
    pub lightPointRad: s16,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct MirRayDataEntry {
    pub sourcePoint: Vec3s,
    pub poolPoint: Vec3s,
    pub sourceEndRadius: s16,
    pub poolEndRadius: s16,
    pub unk_10: f32_0,
    pub unk_14: s16,
    pub lgtPtMaxRad: s16,
    pub unk_18: f32_0,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct MirRayShieldReflection {
    pub pos: Vec3f,
    pub mtx: MtxF,
    pub reflectionPoly: *mut CollisionPoly,
    pub opacity: u8_0,
}
#[no_mangle]
pub static mut Mir_Ray_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_MIR_RAY as libc::c_int as s16,
                          category:
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_MIR_RAY as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<MirRay>() as
                                  libc::c_ulong,
                          init:
...
static mut D_80B8E670: u8_0 = 0 as libc::c_int as u8_0;
...
static mut sMirRayData: [MirRayDataEntry; 10] =
    [{
         let mut init =
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(1160 as libc::c_int) as
                                                       s16,
                                               y: 686 as libc::c_int as s16,
                                               z:
                             ...
                             poolPoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(920 as libc::c_int) as
                                                       s16,
                                               y: 480 as libc::c_int as s16,
                                               z:
                                                   -(889 as libc::c_int) as
                                                       s16,};
                                     init
                                 },
                             sourceEndRadius: 30 as libc::c_int as s16,
                             poolEndRadius: 50 as libc::c_int as s16,
                             unk_10: 1.0f32,
                             unk_14: 50 as libc::c_int as s16,
                             lgtPtMaxRad: 150 as libc::c_int as s16,
                             unk_18: 0.8f32,
                             color:
                                 {
                                     let mut init =
                             ...
                             params: 0x2 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(1856 as libc::c_int) as
                                                       s16,
                                               y: 1092 as libc::c_int as s16,
                                               z:
                             ...
                             poolPoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(1703 as libc::c_int) as
                                                       s16,
                                               y: 841 as libc::c_int as s16,
                                               z:
                             ...
                             sourceEndRadius: 30 as libc::c_int as s16,
                             poolEndRadius: 70 as libc::c_int as s16,
                             unk_10: 0.88f32,
                             unk_14: 54 as libc::c_int as s16,
                             lgtPtMaxRad: 150 as libc::c_int as s16,
                             unk_18: 0.8f32,
                             color:
                                 {
     ...
     },
     {
         let mut init =
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 1367 as libc::c_int as s16,
                                               y: 738 as libc::c_int as s16,
                                               z:
                                                   -(860 as libc::c_int) as
                                                       s16,};
                                     init
                                 },
                             poolPoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 1091 as libc::c_int as s16,
                                               y: 476 as libc::c_int as s16,
                                               z:
                                                   -(860 as libc::c_int) as
                                                       s16,};
                                     init
                             ...
                             sourceEndRadius: 30 as libc::c_int as s16,
                             poolEndRadius: 85 as libc::c_int as s16,
                             unk_10: 0.0f32,
                             ...
                             params: 0 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 2200 as libc::c_int as s16,
                                               y: 1103 as libc::c_int as s16,
                                               z:
                             ...
                             poolPoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 2040 as libc::c_int as s16,
                                               y: 843 as libc::c_int as s16,
                                               z:
                                                   -(220 as libc::c_int) as
                                                       s16,};
                                     init
                             ...
                             sourceEndRadius: 30 as libc::c_int as s16,
                             poolEndRadius: 60 as libc::c_int as s16,
                             unk_10: 0.0f32,
                             unk_14: 0 as libc::c_int as s16,
                             lgtPtMaxRad: 150 as libc::c_int as s16,
                             unk_18: 0.8f32,
                             ...
                             params: 0x1 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
                                     ...
                                     let mut init =
                                         Vec3s{x:
                                                   -(560 as libc::c_int) as
                                                       s16,
                                               y: 2169 as libc::c_int as s16,
                                               z:
                                                   -(310 as libc::c_int) as
                                                       s16,};
                                     init
                                 },
                             poolPoint:
             ...
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 60 as libc::c_int as s16,
                                               y: 1802 as libc::c_int as s16,
                                               z:
                                                   -(1090 as libc::c_int) as
                                                       s16,};
                                     init
                                 },
                             poolPoint:
                             ...
                             params: 0xd as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x: 1140 as libc::c_int as s16,
                                               y: 480 as libc::c_int as s16,
                                               z:
                                                   -(860 as libc::c_int) as
                                                       s16,};
                             ...
                             sourceEndRadius: 30 as libc::c_int as s16,
                             poolEndRadius: 30 as libc::c_int as s16,
                             unk_10: 1.0f32,
                             unk_14: 10 as libc::c_int as s16,
                             lgtPtMaxRad: 100 as libc::c_int as s16,
                             unk_18: 0.9f32,
                             color:
                                 {
                                     let mut init =
                             ...
                             params: 0xe as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             MirRayDataEntry{sourcePoint:
                             ...
                             params: 0xc as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             ...
             MirRayDataEntry{sourcePoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(1174 as libc::c_int) as
                                                       s16,
                                               y: 448 as libc::c_int as s16,
                                               z:
                                                   1194 as libc::c_int as
                                                       s16,};
                                     init
                                 },
                             poolPoint:
                                 {
                                     let mut init =
                                         Vec3s{x:
                                                   -(1174 as libc::c_int) as
                                                       s16,
                                               y: 148 as libc::c_int as s16,
                                               z:
                                                   1194 as libc::c_int as
                                                       s16,};
                                     init
                                 },
                             sourceEndRadius: 50 as libc::c_int as s16,
                             poolEndRadius: 100 as libc::c_int as s16,
                             unk_10: 1.0f32,
                             unk_14: 50 as libc::c_int as s16,
                             lgtPtMaxRad: 150 as libc::c_int as s16,
                             unk_18: 0.8f32,
                             ...
                             params: 0x3 as libc::c_int as u8_0,};
         init
     }];
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_SetupCollider(mut this: *mut MirRay) {
    let mut colliderOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dataEntry: *mut MirRayDataEntry =
        &mut *sMirRayData.as_mut_ptr().offset((*this).actor.params as isize)
            as *mut MirRayDataEntry;
    colliderOffset.x =
        ((*this).poolPt.x - (*this).sourcePt.x) * (*dataEntry).unk_10;
    colliderOffset.y =
        ((*this).poolPt.y - (*this).sourcePt.y) * (*dataEntry).unk_10;
    colliderOffset.z =
        ((*this).poolPt.z - (*this).sourcePt.z) * (*dataEntry).unk_10;
    (*(*this).colliderSph.elements.offset(0 as libc::c_int as
                                              isize)).dim.worldSphere.center.x
        = (colliderOffset.x + (*this).sourcePt.x) as s16;
    (*(*this).colliderSph.elements.offset(0 as libc::c_int as
                                              isize)).dim.worldSphere.center.y
        = (colliderOffset.y + (*this).sourcePt.y) as s16;
    (*(*this).colliderSph.elements.offset(0 as libc::c_int as
                                              isize)).dim.worldSphere.center.z
        = (colliderOffset.z + (*this).sourcePt.z) as s16;
    (*(*this).colliderSph.elements.offset(0 as libc::c_int as
                                              isize)).dim.worldSphere.radius =
        ((*dataEntry).unk_14 as libc::c_int as libc::c_float *
             (*(*this).colliderSph.elements).dim.scale) as s16;
}
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_MakeShieldLight(mut this: *mut MirRay,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as
            *mut Player; // Light beams from windows
    let mut dataEntry: *mut MirRayDataEntry =
        &mut *sMirRayData.as_mut_ptr().offset((*this).actor.params as isize)
            as *mut MirRayDataEntry;
    let mut reflectionPt: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut lightPt: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    if MirRay_CheckInFrustum(&mut (*this).sourcePt, &mut (*this).poolPt,
                             (*player).actor.world.pos.x,
                             (*player).actor.world.pos.y + 30.0f32,
                             (*player).actor.world.pos.z,
                             (*this).sourceEndRad, (*this).poolEndRad) != 0 {
        if (*dataEntry).params as libc::c_int & 8 as libc::c_int != 0 {
            // Light beams from mirrors
            Math_Vec3f_Diff(&mut (*player).actor.world.pos,
                            &mut (*this).sourcePt, &mut reflectionPt);
        } else {
            Math_Vec3f_Diff(&mut (*this).poolPt, &mut (*this).sourcePt,
                            &mut reflectionPt);
        }
        lightPt.x =
            ((*dataEntry).unk_18 * reflectionPt.x + (*this).sourcePt.x) as
                s16;
        lightPt.y =
            ((*dataEntry).unk_18 * reflectionPt.y + (*this).sourcePt.y) as
                s16;
        lightPt.z =
            ((*dataEntry).unk_18 * reflectionPt.z + (*this).sourcePt.z) as
                s16;
        // Fade up
        Math_StepToS(&mut (*this).lightPointRad, (*dataEntry).lgtPtMaxRad,
                     6 as libc::c_int as s16);
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo, lightPt.x,
                                  lightPt.y, lightPt.z, (*dataEntry).color.r,
                                  (*dataEntry).color.g, (*dataEntry).color.b,
                                  (*this).lightPointRad);
    } else {
        // Fade down
        Math_StepToS(&mut (*this).lightPointRad, 0 as libc::c_int as s16,
                     6 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut MirRay = thisx as *mut MirRay;
    let mut dataEntry: *mut MirRayDataEntry =
        &mut *sMirRayData.as_mut_ptr().offset((*this).actor.params as isize)
            as *mut MirRayDataEntry;
    ...
    osSyncPrintf(b"\xe5\x8f\x8d\xe5\xb0\x84\xe7\x94\xa8 \xe5\x85\x89\xe3\x81\xae\xe7\x99\xba\xe7\x94\x9f!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\x00"
                     as *const u8 as *const libc::c_char);
    LogUtils_LogThreadId(b"../z_mir_ray.c\x00" as *const u8 as
                             *const libc::c_char, 518 as libc::c_int);
    osSyncPrintf(b"this->actor.arg_data = %d\n\x00" as *const u8 as
                     *const libc::c_char,
    ...
    if (*this).actor.params as libc::c_int >= 0xa as libc::c_int {
        ...
        osSyncPrintf(b"\"\xe5\x8f\x8d\xe5\xb0\x84\xe5\x85\x89 \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97\" = %s\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"\xe5\x8f\x8d\xe5\xb0\x84\xe5\x85\x89 \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97\x00"
                         as *const u8 as *const libc::c_char);
        Actor_Kill(&mut (*this).actor);
    }
    (*this).sourcePt.x = (*dataEntry).sourcePoint.x as f32_0;
    (*this).sourcePt.y = (*dataEntry).sourcePoint.y as f32_0;
    (*this).sourcePt.z = (*dataEntry).sourcePoint.z as f32_0;
    (*this).sourceEndRad = (*dataEntry).sourceEndRadius;
    (*this).poolPt.x = (*dataEntry).poolPoint.x as f32_0;
    (*this).poolPt.y = (*dataEntry).poolPoint.y as f32_0;
    (*this).poolPt.z = (*dataEntry).poolPoint.z as f32_0;
    (*this).poolEndRad = (*dataEntry).poolEndRadius;
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).sourcePt.x as s16,
                              (*this).sourcePt.y as s16,
                              (*this).sourcePt.z as s16,
    ...
    (*this).lightNode =
        LightContext_InsertLight(globalCtx, &mut (*globalCtx).lightCtx,
                                 &mut (*this).lightInfo);
    (*this).shieldCorners[0 as libc::c_int as usize].x = -536.0f32;
    (*this).shieldCorners[0 as libc::c_int as usize].y = -939.0f32;
    (*this).shieldCorners[1 as libc::c_int as usize].x = -1690.0f32;
    (*this).shieldCorners[1 as libc::c_int as usize].y = 0.0f32;
    (*this).shieldCorners[2 as libc::c_int as usize].x = -536.0f32;
    (*this).shieldCorners[2 as libc::c_int as usize].y = 938.0f32;
    (*this).shieldCorners[3 as libc::c_int as usize].x = 921.0f32;
    (*this).shieldCorners[3 as libc::c_int as usize].y = 0.0f32;
    (*this).shieldCorners[4 as libc::c_int as usize].x = 758.0f32;
    (*this).shieldCorners[4 as libc::c_int as usize].y = 800.0f32;
    (*this).shieldCorners[5 as libc::c_int as usize].x = 758.0f32;
    (*this).shieldCorners[5 as libc::c_int as usize].y = -800.0f32;
    if (*dataEntry).params as libc::c_int & 2 as libc::c_int != 0 {
        ...
        if (*dataEntry).params as libc::c_int & 4 as libc::c_int == 0 {
            // Beams not from mirrors
            MirRay_SetupCollider(this);
        }
    }
    Collider_InitQuad(globalCtx, &mut (*this).shieldRay);
    Collider_SetQuad(globalCtx, &mut (*this).shieldRay, &mut (*this).actor,
                     &mut sQuadInit);
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut MirRay = thisx as *mut MirRay;
    LightContext_RemoveLight(globalCtx, &mut (*globalCtx).lightCtx,
                             (*this).lightNode);
    if sMirRayData[(*this).actor.params as usize].params as libc::c_int &
           2 as libc::c_int != 0 {
        Collider_DestroyJntSph(globalCtx, &mut (*this).colliderSph);
    }
    Collider_DestroyQuad(globalCtx, &mut (*this).shieldRay);
}
#[no_mangle]
pub unsafe extern "C" fn MirRay_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut MirRay = thisx as *mut MirRay;
    let mut player: *mut Player =
    ...
    D_80B8E670 = 0 as libc::c_int as u8_0;
    if (*this).unLit == 0 {
        if sMirRayData[(*this).actor.params as usize].params as libc::c_int &
               2 as libc::c_int != 0 {
            if sMirRayData[(*this).actor.params as usize].params as
        ...
        if (*this).reflectIntensity > 0.0f32 {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).shieldRay.base);
        }
        MirRay_MakeShieldLight(this, globalCtx);
        if (*this).reflectIntensity > 0.0f32 {
            func_8002F8F0(&mut (*player).actor,
                          (0x1849 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn MirRay_SetIntensity(mut this: *mut MirRay,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut sp4C: [f32_0; 3] = [0.; 3];
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut shieldMtx: *mut MtxF = &mut (*player).shieldMf;
    (*this).reflectIntensity = 0.0f32;
    if MirRay_CheckInFrustum(&mut (*this).sourcePt, &mut (*this).poolPt,
                             (*shieldMtx).c2rust_unnamed.xw,
                             (*shieldMtx).c2rust_unnamed.yw,
                             (*shieldMtx).c2rust_unnamed.zw,
                             (*this).sourceEndRad, (*this).poolEndRad) != 0 {
        temp_f0 =
            sqrtf((*shieldMtx).c2rust_unnamed.zz *
                      (*shieldMtx).c2rust_unnamed.zz +
                      ((*shieldMtx).c2rust_unnamed.xz *
                           (*shieldMtx).c2rust_unnamed.xz +
                           (*shieldMtx).c2rust_unnamed.yz *
                               (*shieldMtx).c2rust_unnamed.yz));
        if temp_f0 == 0.0f32 {
            (*this).reflectRange = 1.0f32
        } else { (*this).reflectRange = 1.0f32 / temp_f0 }
        // If light beam is adirectional, always reflect, else only reflect if shield is pointing in correct direction
        if sMirRayData[(*this).actor.params as usize].params as libc::c_int &
               1 as libc::c_int != 0 {
            (*this).reflectIntensity = 1.0f32
        } else {
            sp4C[0 as libc::c_int as usize] =
                (*this).poolPt.x - (*this).sourcePt.x;
            sp4C[1 as libc::c_int as usize] =
                (*this).poolPt.y - (*this).sourcePt.y;
            sp4C[2 as libc::c_int as usize] =
                (*this).poolPt.z - (*this).sourcePt.z;
            temp_f2_2 =
                -(*shieldMtx).c2rust_unnamed.xz *
                    sp4C[0 as libc::c_int as usize] -
                    (*shieldMtx).c2rust_unnamed.yz *
            ...
            if temp_f2_2 < 0.0f32 {
                temp_f0_2 =
                    sqrtf(sp4C[0 as libc::c_int as usize] *
                              sp4C[0 as libc::c_int as usize] +
                              sp4C[1 as libc::c_int as usize] *
                                  sp4C[1 as libc::c_int as usize] +
                              sp4C[2 as libc::c_int as usize] *
                                  sp4C[2 as libc::c_int as usize]);
                if temp_f0 != 0.0f32 && temp_f0_2 != 0.0f32 {
                    (*this).reflectIntensity =
                        -temp_f2_2 / (temp_f0 * temp_f0_2)
                }
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_SetupReflectionPolys(mut this: *mut MirRay,
                                                     mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut reflection:
                                                         *mut MirRayShieldReflection) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as
            *mut Player; // Need something involving sp60 or the whole function changes
    let mut shieldMtx: *mut MtxF = 0 as *mut MtxF;
    let mut i: s32 = 0;
    let mut posA: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    shieldMtx = &mut (*player).shieldMf;
    sp60.x =
        -((*shieldMtx).c2rust_unnamed.xz * (*this).reflectRange) *
            (*this).reflectIntensity * 400.0f32;
    sp60.y =
        -((*shieldMtx).c2rust_unnamed.yz * (*this).reflectRange) *
            (*this).reflectIntensity * 400.0f32;
    sp60.z =
        -((*shieldMtx).c2rust_unnamed.zz * (*this).reflectRange) *
            (*this).reflectIntensity * 400.0f32;
    sp60 = sp60;
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        posA.x =
            (*shieldMtx).c2rust_unnamed.xw +
                (*this).shieldCorners[i as usize].x *
                    (*shieldMtx).c2rust_unnamed.xx +
                (*this).shieldCorners[i as usize].y *
                    (*shieldMtx).c2rust_unnamed.xy;
        posA.y =
            (*shieldMtx).c2rust_unnamed.yw +
                (*this).shieldCorners[i as usize].x *
                    (*shieldMtx).c2rust_unnamed.yx +
                (*this).shieldCorners[i as usize].y *
                    (*shieldMtx).c2rust_unnamed.yy;
        posA.z =
            (*shieldMtx).c2rust_unnamed.zw +
                (*this).shieldCorners[i as usize].x *
                    (*shieldMtx).c2rust_unnamed.zx +
                (*this).shieldCorners[i as usize].y *
                    (*shieldMtx).c2rust_unnamed.zy;
        posB.x = sp60.x + posA.x;
        posB.y = sp60.y + posA.y;
        posB.z = sp60.z + posA.z;
        if BgCheck_AnyLineTest1(&mut (*globalCtx).colCtx, &mut posA,
                                &mut posB, &mut posResult, &mut outPoly,
                                1 as libc::c_int) != 0 {
            let ref mut fresh0 =
                (*reflection.offset(i as isize)).reflectionPoly;
            *fresh0 = outPoly
        } else {
            let ref mut fresh1 =
                (*reflection.offset(i as isize)).reflectionPoly;
            *fresh1 = 0 as *mut CollisionPoly
        }
        i += 1
    };
}
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_RemoveSimilarReflections(mut reflection:
                                                             *mut MirRayShieldReflection) {
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        ...
        while j < 6 as libc::c_int {
            if !(*reflection.offset(i as isize)).reflectionPoly.is_null() {
                if !(*reflection.offset(j as isize)).reflectionPoly.is_null()
                       &&
                       (if (*(*reflection.offset(i as
                                                     isize)).reflectionPoly).normal.x
                               as libc::c_int -
                               (*(*reflection.offset(j as
                                                         isize)).reflectionPoly).normal.x
                                   as libc::c_int >= 0 as libc::c_int {
                            ((*(*reflection.offset(i as
                                                       isize)).reflectionPoly).normal.x
                                 as libc::c_int) -
                                (*(*reflection.offset(j as
                                                          isize)).reflectionPoly).normal.x
                       ...
                       (*(*reflection.offset(i as isize)).reflectionPoly).dist
                           as libc::c_int ==
                           (*(*reflection.offset(j as
                                                     isize)).reflectionPoly).dist
                               as libc::c_int {
                    let ref mut fresh2 =
                        (*reflection.offset(j as isize)).reflectionPoly;
                    *fresh2 = 0 as *mut CollisionPoly
                }
            }
            j += 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_ReflectedBeam(mut this: *mut MirRay,
                                              mut globalCtx:
                                                  *mut GlobalContext,
                                              mut reflection:
                                                  *mut MirRayShieldReflection) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as
            *mut Player; // Required to match
    let mut i: s32 = 0; // Required to match
    let mut temp_f0: f32_0 = 0.;
    let mut vecB: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vecD: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp118: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp10C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp100: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut intersection: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spE8: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut normalVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut shieldMtx: *mut MtxF = 0 as *mut MtxF;
    let mut vecA: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vecC: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut currentReflection: *mut MirRayShieldReflection =
        0 as *mut MirRayShieldReflection;
    shieldMtx = &mut (*player).shieldMf;
    spE8.x =
        -((*shieldMtx).c2rust_unnamed.xz * (*this).reflectRange) *
            (*this).reflectIntensity * 400.0f32;
    ...
    spE8.z =
        -((*shieldMtx).c2rust_unnamed.zz * (*this).reflectRange) *
            (*this).reflectIntensity * 400.0f32;
    vecB.x = (*shieldMtx).c2rust_unnamed.xw;
    vecB.y = (*shieldMtx).c2rust_unnamed.yw;
    vecB.z = (*shieldMtx).c2rust_unnamed.zw;
    vecD.x = spE8.x + vecB.x;
    vecD.y = spE8.y + vecB.y;
    vecD.z = spE8.z + vecB.z;
    vecA.x = vecB.x + (*shieldMtx).c2rust_unnamed.xx * 300.0f32;
    vecA.y = vecB.y + (*shieldMtx).c2rust_unnamed.yx * 300.0f32;
    vecA.z = vecB.z + (*shieldMtx).c2rust_unnamed.zx * 300.0f32;
    vecC.x = vecD.x + (*shieldMtx).c2rust_unnamed.xx * 300.0f32;
    vecC.y = vecD.y + (*shieldMtx).c2rust_unnamed.yx * 300.0f32;
    vecC.z = vecD.z + (*shieldMtx).c2rust_unnamed.zx * 300.0f32;
    Collider_SetQuadVertices(&mut (*this).shieldRay, &mut vecA, &mut vecB,
                             &mut vecC, &mut vecD);
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        currentReflection =
            &mut *reflection.offset(i as isize) as
                *mut MirRayShieldReflection;
        if !(*currentReflection).reflectionPoly.is_null() {
            normalVec.x =
                (*(*currentReflection).reflectionPoly).normal.x as libc::c_int
                    as libc::c_float * (1.0f32 / 32767.0f32);
            normalVec.y =
                (*(*currentReflection).reflectionPoly).normal.y as libc::c_int
                    as libc::c_float * (1.0f32 / 32767.0f32);
            normalVec.z =
                (*(*currentReflection).reflectionPoly).normal.z as libc::c_int
                    as libc::c_float * (1.0f32 / 32767.0f32);
            if Math3D_LineSegVsPlane(normalVec.x, normalVec.y, normalVec.z,
                                     (*(*currentReflection).reflectionPoly).dist
                                         as f32_0, &mut vecB, &mut vecD,
                                     &mut sp118, 1 as libc::c_int) != 0 {
                (*currentReflection).pos.x = sp118.x;
                (*currentReflection).pos.y = sp118.y;
                (*currentReflection).pos.z = sp118.z;
                temp_f0 =
                    sqrtf((sp118.x - vecB.x) * (sp118.x - vecB.x) +
                              (sp118.y - vecB.y) * (sp118.y - vecB.y) +
                              (sp118.z - vecB.z) * (sp118.z - vecB.z));
                if temp_f0 < (*this).reflectIntensity * 600.0f32 {
                    (*currentReflection).opacity = 200 as libc::c_int as u8_0
                } else {
                    (*currentReflection).opacity =
                        (800.0f32 - temp_f0) as s32 as u8_0
                }
                spE8 = spE8;
                sp10C.x = (*shieldMtx).c2rust_unnamed.xx * 100.0f32 + vecB.x;
                sp10C.y = (*shieldMtx).c2rust_unnamed.yx * 100.0f32 + vecB.y;
                sp10C.z = (*shieldMtx).c2rust_unnamed.zx * 100.0f32 + vecB.z;
                sp100.x = spE8.x * 4.0f32 + sp10C.x;
                sp100.y = spE8.y * 4.0f32 + sp10C.y;
                sp100.z = spE8.z * 4.0f32 + sp10C.z;
                normalVec = normalVec;
                (*currentReflection).mtx.c2rust_unnamed.zw = 0.0f32;
                // All four required to match
                (*currentReflection).mtx.c2rust_unnamed.ww = 1.0f32;
                (*currentReflection).mtx.c2rust_unnamed.zz =
                    (*currentReflection).mtx.c2rust_unnamed.ww;
                (*currentReflection).mtx.c2rust_unnamed.yy =
                    (*currentReflection).mtx.c2rust_unnamed.zz;
                (*currentReflection).mtx.c2rust_unnamed.xx =
                    (*currentReflection).mtx.c2rust_unnamed.yy;
                (*currentReflection).mtx.c2rust_unnamed.yw =
                    (*currentReflection).mtx.c2rust_unnamed.zw;
                (*currentReflection).mtx.c2rust_unnamed.xw =
                    (*currentReflection).mtx.c2rust_unnamed.yw;
                (*currentReflection).mtx.c2rust_unnamed.wz =
                    (*currentReflection).mtx.c2rust_unnamed.xw;
                (*currentReflection).mtx.c2rust_unnamed.yz =
                    (*currentReflection).mtx.c2rust_unnamed.wz;
                (*currentReflection).mtx.c2rust_unnamed.xz =
                    (*currentReflection).mtx.c2rust_unnamed.yz;
                (*currentReflection).mtx.c2rust_unnamed.wy =
                    (*currentReflection).mtx.c2rust_unnamed.xz;
                (*currentReflection).mtx.c2rust_unnamed.zy =
                    (*currentReflection).mtx.c2rust_unnamed.wy;
                (*currentReflection).mtx.c2rust_unnamed.xy =
                    (*currentReflection).mtx.c2rust_unnamed.zy;
                (*currentReflection).mtx.c2rust_unnamed.wx =
                    (*currentReflection).mtx.c2rust_unnamed.xy;
                (*currentReflection).mtx.c2rust_unnamed.zx =
                    (*currentReflection).mtx.c2rust_unnamed.wx;
                (*currentReflection).mtx.c2rust_unnamed.yx =
                    (*currentReflection).mtx.c2rust_unnamed.zx;
                if Math3D_LineSegVsPlane(normalVec.x, normalVec.y,
                                         normalVec.z,
                                         (*(*currentReflection).reflectionPoly).dist
                                             as f32_0, &mut sp10C, &mut sp100,
                                         &mut intersection, 1 as libc::c_int)
                       != 0 {
                    (*currentReflection).mtx.c2rust_unnamed.xx =
                        intersection.x - sp118.x;
                    (*currentReflection).mtx.c2rust_unnamed.yx =
                        intersection.y - sp118.y;
                    (*currentReflection).mtx.c2rust_unnamed.zx =
                        intersection.z - sp118.z
                }
                sp10C.x = (*shieldMtx).c2rust_unnamed.xy * 100.0f32 + vecB.x;
                sp10C.y = (*shieldMtx).c2rust_unnamed.yy * 100.0f32 + vecB.y;
                sp10C.z = (*shieldMtx).c2rust_unnamed.zy * 100.0f32 + vecB.z;
                sp100.x = spE8.x * 4.0f32 + sp10C.x;
                sp100.y = spE8.y * 4.0f32 + sp10C.y;
                sp100.z = spE8.z * 4.0f32 + sp10C.z;
                if Math3D_LineSegVsPlane(normalVec.x, normalVec.y,
                ...
                (*currentReflection).reflectionPoly = 0 as *mut CollisionPoly
            }
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut MirRay = thisx as *mut MirRay;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut i: s32 = 0;
    let mut reflection: [MirRayShieldReflection; 6] =
        [MirRayShieldReflection{pos: Vec3f{x: 0., y: 0., z: 0.,},
                                mtx: MtxF{mf: [[0.; 4]; 4],},
                                reflectionPoly: 0 as *mut CollisionPoly,
                                opacity: 0,}; 6];
    let mut temp: s32 = 0;
    (*this).reflectIntensity = 0.0f32;
    if D_80B8E670 as libc::c_int == 0 as libc::c_int && (*this).unLit == 0 &&
           Player_HasMirrorShieldSetToDraw(globalCtx) != 0 {
        ...
        if !((*this).reflectIntensity <= 0.0f32) {
            ...
            Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                            b"../z_mir_ray.c\x00" as *const u8 as
                                *const libc::c_char, 966 as libc::c_int);
            func_80093D84((*globalCtx).state.gfxCtx);
            Matrix_Scale(1.0f32, 1.0f32, (*this).reflectIntensity * 5.0f32,
                ...
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            temp = ((*this).reflectIntensity * 100.0f32) as s32;
            (*_g_0).words.w1 =
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_1).words.w1 = gShieldBeamGlowDL.as_mut_ptr() as libc::c_uint;
            MirRay_SetupReflectionPolys(this, globalCtx,
                                        reflection.as_mut_ptr());
            MirRay_RemoveSimilarReflections(reflection.as_mut_ptr());
            MirRay_ReflectedBeam(this, globalCtx, reflection.as_mut_ptr());
            if reflection[0 as libc::c_int as usize].reflectionPoly.is_null()
               {
                reflection[0 as libc::c_int as usize].opacity =
                    0 as libc::c_int as u8_0
            }
            i = 1 as libc::c_int;
            while i < 6 as libc::c_int {
                if !reflection[i as usize].reflectionPoly.is_null() {
                    if (reflection[0 as libc::c_int as usize].opacity as
                            libc::c_int) <
                           reflection[i as usize].opacity as libc::c_int {
                        reflection[0 as libc::c_int as usize].opacity =
                            reflection[i as usize].opacity
                    }
                }
                i += 1
            }
            ...
            while i < 6 as libc::c_int {
                if !reflection[i as usize].reflectionPoly.is_null() {
                    Matrix_Translate(reflection[i as usize].pos.x,
                                     reflection[i as usize].pos.y,
                                     reflection[i as usize].pos.z,
                                     MTXMODE_NEW as libc::c_int as u8_0);
                    Matrix_Scale(0.01f32, 0.01f32, 0.01f32,
                                 MTXMODE_APPLY as libc::c_int as u8_0);
                    Matrix_Mult(&mut (*reflection.as_mut_ptr().offset(i as
                                                                          isize)).mtx,
                                MTXMODE_APPLY as libc::c_int as u8_0);
                        ...
                        (255 as libc::c_int as u32_0 &
                            ...
                            (150 as libc::c_int as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                8 as libc::c_int |
                            (reflection[0 as libc::c_int as usize].opacity as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                0 as libc::c_int;
                    ...
                    (*_g_5).words.w0 =
                        (0xde as libc::c_int as u32_0 &
                            ...
                            (0 as libc::c_int as u32_0 &
                                ...
                                0 as libc::c_int;
                    (*_g_5).words.w1 =
                        gShieldBeamImageDL.as_mut_ptr() as libc::c_uint
                }
                i += 1
            }
            D_80B8E670 = 1 as libc::c_int as u8_0;
            Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                             b"../z_mir_ray.c\x00" as *const u8 as
                                 *const libc::c_char, 1027 as libc::c_int);
        }
    };
}
...
#[no_mangle]
pub unsafe extern "C" fn MirRay_CheckInFrustum(mut vecA: *mut Vec3f,
                                               mut vecB: *mut Vec3f,
                                               mut pointx: f32_0,
                                               mut pointy: f32_0,
                                               mut pointz: f32_0,
                                               mut radiusA: s16,
                                               mut radiusB: s16) -> s32 {
    let mut coneRadius: f32_0 = 0.;
    let mut closestPtx: f32_0 = 0.;
    let mut closestPty: f32_0 = 0.;
    let mut closestPtz: f32_0 = 0.;
    let mut vecdiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    dist =
        vecdiff.x * vecdiff.x + vecdiff.y * vecdiff.y + vecdiff.z * vecdiff.z;
    if dist == 0.0f32 { return 0 as libc::c_int }
    dist =
        ((pointx - (*vecA).x) * vecdiff.x + (pointy - (*vecA).y) * vecdiff.y +
             (pointz - (*vecA).z) * vecdiff.z) / dist;
    ...
    coneRadius =
        (radiusB as libc::c_int - radiusA as libc::c_int) as libc::c_float *
            dist + radiusA as libc::c_int as libc::c_float;
    // If the Point is within the bounding double cone, check if it is in the frustum by checking whether it is between
    // the bounding planes
    if (closestPtx - pointx) * (closestPtx - pointx) +
           (closestPty - pointy) * (closestPty - pointy) +
           (closestPtz - pointz) * (closestPtz - pointz) <=
           coneRadius * coneRadius {
        // Stores the vector difference again
        Math_Vec3f_Diff(vecB, vecA, &mut sp5C);
        sp50.x = pointx - (*vecA).x;
        sp50.y = pointy - (*vecA).y;
        sp50.z = pointz - (*vecA).z;
        if Math3D_Cos(&mut sp5C, &mut sp50) < 0.0f32 {
            return 0 as libc::c_int
        }
        sp44.x = pointx - (*vecB).x;
        sp44.y = pointy - (*vecB).y;
        sp44.z = pointz - (*vecB).z;
        if Math3D_Cos(&mut sp5C, &mut sp44) > 0.0f32 {
            return 0 as libc::c_int
        }
