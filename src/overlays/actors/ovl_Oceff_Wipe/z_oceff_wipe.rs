...
pub const OCEFF_WIPE_SOT: C2RustUnnamed_18 = 1;
pub const OCEFF_WIPE_ZL: C2RustUnnamed_18 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct OceffWipe {
    pub actor: Actor,
    pub timer: s16,
}
#[no_mangle]
pub static mut Oceff_Wipe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OCEFF_WIPE as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn OceffWipe_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut OceffWipe = thisx as *mut OceffWipe;
    ...
    osSyncPrintf(b"\x1b[36m WIPE arg_data = %d\n\x1b[m\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn OceffWipe_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut OceffWipe = thisx as *mut OceffWipe;
...
#[no_mangle]
pub unsafe extern "C" fn OceffWipe_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut OceffWipe = thisx as *mut OceffWipe;
    (*this).actor.world.pos =
        (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize]).eye;
...
// Initialized in run_static_initializers
static mut sFrustumDL: [Gfx; 23] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 23];
static mut sAlphaIndices: [u8_0; 20] =
    [0x1 as libc::c_int as u8_0, 0x10 as libc::c_int as u8_0,
     0x22 as libc::c_int as u8_0, 0x1 as libc::c_int as u8_0,
     0x20 as libc::c_int as u8_0, 0x12 as libc::c_int as u8_0,
     0x1 as libc::c_int as u8_0, 0x20 as libc::c_int as u8_0,
     0x12 as libc::c_int as u8_0, 0x1 as libc::c_int as u8_0,
     0x10 as libc::c_int as u8_0, 0x22 as libc::c_int as u8_0,
     0x1 as libc::c_int as u8_0, 0x20 as libc::c_int as u8_0,
     0x12 as libc::c_int as u8_0, 0x1 as libc::c_int as u8_0,
     0x12 as libc::c_int as u8_0, 0x21 as libc::c_int as u8_0,
     0x1 as libc::c_int as u8_0, 0x2 as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn OceffWipe_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_oceff_wipe.c\x00" as *const u8 as
    ...
    if ((*this).timer as libc::c_int) < 32 as libc::c_int {
        z =
            Math_SinS((((*this).timer as libc::c_int) << 9 as libc::c_int) as
                          s16) * 1400 as libc::c_int as libc::c_float
    } else { z = 1400 as libc::c_int as f32_0 }
    if (*this).timer as libc::c_int >= 80 as libc::c_int {
        alphaTable[0 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        alphaTable[1 as libc::c_int as usize] =
            ((0x64 as libc::c_int - (*this).timer as libc::c_int) *
                 8 as libc::c_int) as u8_0;
        alphaTable[2 as libc::c_int as usize] =
            ((0x64 as libc::c_int - (*this).timer as libc::c_int) *
                 12 as libc::c_int) as u8_0
    } else {
        alphaTable[0 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        alphaTable[1 as libc::c_int as usize] = 0xa0 as libc::c_int as u8_0;
        alphaTable[2 as libc::c_int as usize] = 0xff as libc::c_int as u8_0
    }
    i = 0 as libc::c_int;
    while i < 20 as libc::c_int {
        vtxPtr = sFrustumVtx.as_mut_ptr();
        (*vtxPtr.offset((i * 2 as libc::c_int + 0 as libc::c_int) as
                            isize)).v.cn[3 as libc::c_int as usize] =
            alphaTable[((sAlphaIndices[i as usize] as libc::c_int &
                             0xf0 as libc::c_int) >> 4 as libc::c_int) as
                           usize];
        (*vtxPtr.offset((i * 2 as libc::c_int + 1 as libc::c_int) as
                            isize)).v.cn[3 as libc::c_int as usize] =
            alphaTable[(sAlphaIndices[i as usize] as libc::c_int &
    ...
    if (*this).actor.params as libc::c_int != OCEFF_WIPE_ZL as libc::c_int {
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = sMaterialDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_5).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (0 as libc::c_int as
                              libc::c_uint).wrapping_sub(scroll),
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = sFrustumDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_oceff_wipe.c\x00" as *const u8 as
                         *const libc::c_char, 398 as libc::c_int);
}
                         ...
                         Gwords{w0:
                                    (0x1 as libc::c_int as u32_0 &
                                        ...
                                        ((0 as libc::c_int + 8 as libc::c_int)
                                            ...
                                            1 as libc::c_int,
                                w1:
                                    &mut *sFrustumVtx.as_mut_ptr().offset(32
                                                                              as
                                                                              libc::c_int
                                                                              as
                                                                              isize)
