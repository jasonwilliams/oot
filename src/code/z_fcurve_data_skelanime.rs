...
extern "C" {
    ...
    #[no_mangle]
    fn func_8006C5A8(target: f32_0, transData: *mut TransformData,
                     refIdx: s32) -> f32_0;
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_Clear(mut skelCurve: *mut SkelAnimeCurve) {
    (*skelCurve).limbCount = 0 as libc::c_int as u8_0;
    (*skelCurve).limbList = 0 as *mut *mut SkelCurveLimb;
    (*skelCurve).transUpdIdx = 0 as *mut TransformUpdateIndex;
    (*skelCurve).animCurFrame = 0.0f32;
    (*skelCurve).animSpeed = 0.0f32;
    (*skelCurve).animFinalFrame = 0.0f32;
    (*skelCurve).transforms = 0 as *mut LimbTransform;
    (*skelCurve).unk_0C = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_Init(mut globalCtx: *mut GlobalContext,
                                        mut skelCurve: *mut SkelAnimeCurve,
                                        mut limbListSeg:
                                            *mut SkelCurveLimbList,
                                        mut transUpdIdx:
                                            *mut TransformUpdateIndex)
 -> s32 {
    let mut limbs: *mut *mut SkelCurveLimb = 0 as *mut *mut SkelCurveLimb;
    let mut limbList: *mut SkelCurveLimbList =
        gSegments[((limbListSeg as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(limbListSeg as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut SkelCurveLimbList;
    (*skelCurve).limbCount = (*limbList).limbCount;
    (*skelCurve).limbList =
        gSegments[(((*limbList).limbs as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*limbList).limbs as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut *mut SkelCurveLimb;
    (*skelCurve).transforms =
        ZeldaArena_MallocDebug((::std::mem::size_of::<LimbTransform>() as
                                    libc::c_ulong).wrapping_mul((*skelCurve).limbCount
                                                                    as
                                                                    libc::c_uint),
                               b"../z_fcurve_data_skelanime.c\x00" as
                                   *const u8 as *const libc::c_char,
                               125 as libc::c_int) as *mut LimbTransform;
    if !(*skelCurve).transforms.is_null() {
    } else {
        __assert(b"this->now_joint != NULL\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_fcurve_data_skelanime.c\x00" as *const u8 as
                     *const libc::c_char, 127 as libc::c_int);
    };
    (*skelCurve).animCurFrame = 0.0f32;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_Destroy(mut globalCtx: *mut GlobalContext,
                                           mut skelCurve:
                                               *mut SkelAnimeCurve) {
    if !(*skelCurve).transforms.is_null() {
        ZeldaArena_FreeDebug((*skelCurve).transforms as *mut libc::c_void,
                             b"../z_fcurve_data_skelanime.c\x00" as *const u8
                                 as *const libc::c_char, 146 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_SetAnim(mut skelCurve: *mut SkelAnimeCurve,
                                           mut transUpdIdx:
                                               *mut TransformUpdateIndex,
                                           mut arg2: f32_0,
                                           mut animFinalFrame: f32_0,
                                           mut animCurFrame: f32_0,
                                           mut animSpeed: f32_0) {
...
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_Update(mut globalCtx: *mut GlobalContext,
                                          mut skelCurve: *mut SkelAnimeCurve)
 -> s32 {
    let mut transforms: *mut s16 = 0 as *mut s16;
    let mut transformRefIdx: *mut u8_0 = 0 as *mut u8_0;
    let mut transformIndex: *mut TransformUpdateIndex =
        0 as *mut TransformUpdateIndex;
    let mut transformCopyValues: *mut u16_0 = 0 as *mut u16_0;
    let mut i: s32 = 0;
    let mut ret: s32 = 0 as libc::c_int;
    let mut k: s32 = 0;
    let mut transData: *mut TransformData = 0 as *mut TransformData;
    let mut transformValue: f32_0 = 0.;
    let mut j: s32 = 0;
    transformIndex =
        gSegments[(((*skelCurve).transUpdIdx as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*skelCurve).transUpdIdx as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut TransformUpdateIndex;
    transformRefIdx =
        gSegments[(((*transformIndex).refIndex as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add((*transformIndex).refIndex as u32_0
                                              &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
    ...
    transData =
        gSegments[(((*transformIndex).transformData as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add((*transformIndex).transformData as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut TransformData;
    transformCopyValues =
        gSegments[(((*transformIndex).copyValues as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add((*transformIndex).copyValues as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
    ...
    i = 0 as libc::c_int;
    while i < (*skelCurve).limbCount as libc::c_int {
        j = 0 as libc::c_int;
        while j < 3 as libc::c_int {
            k = 0 as libc::c_int;
            while k < 3 as libc::c_int {
                if *transformRefIdx as libc::c_int == 0 as libc::c_int {
                    transformValue = *transformCopyValues as f32_0;
                    *transforms = transformValue as s16;
                    transformCopyValues = transformCopyValues.offset(1)
                } else {
                    transformValue =
                        func_8006C5A8((*skelCurve).animCurFrame, transData,
                                      *transformRefIdx as s32);
                    transData =
                        transData.offset(*transformRefIdx as libc::c_int as
                                             isize);
                    if j == 0 as libc::c_int {
                        *transforms = (transformValue * 1024.0f32) as s16
                    } else if j == 1 as libc::c_int {
                        *transforms =
                            (transformValue * (32768.0f32 / 180.0f32)) as s16
                    } else {
                        *transforms = (transformValue * 100.0f32) as s16
                    }
                }
                k += 1;
                transformRefIdx = transformRefIdx.offset(1);
                transforms = transforms.offset(1)
            }
            j += 1
        }
        i += 1
...
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_DrawLimb(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut skelCurve:
                                                *mut SkelAnimeCurve,
                                            mut overrideLimbDraw:
                                                OverrideCurveLimbDraw,
                                            mut postLimbDraw:
                                                PostCurveLimbDraw,
                                            mut lod: s32,
                                            mut data: *mut libc::c_void) {
    let mut limb: *mut SkelCurveLimb =
        gSegments[((*(*skelCurve).limbList.offset(limbIndex as isize) as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(*(*skelCurve).limbList.offset(limbIndex
                                                                            as
                                                                            isize)
                                              as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut SkelCurveLimb;
    ...
    if overrideLimbDraw.is_none() ||
                                                                    ...
                                                                    data) != 0
       {
        ...
        let mut transform: *mut Vec3s =
            &mut *(*skelCurve).transforms.offset(limbIndex as isize) as
                *mut LimbTransform as *mut Vec3s;
        scale.x = (*transform).x as libc::c_int as libc::c_float / 1024.0f32;
        scale.y = (*transform).y as libc::c_int as libc::c_float / 1024.0f32;
        scale.z = (*transform).z as libc::c_int as libc::c_float / 1024.0f32;
        transform = transform.offset(1);
        rot.x = (*transform).x;
        rot.y = (*transform).y;
        rot.z = (*transform).z;
        transform = transform.offset(1);
        pos.x = (*transform).x as f32_0;
        pos.y = (*transform).y as f32_0;
        pos.z = (*transform).z as f32_0;
        ...
        if lod == 0 as libc::c_int {
            let mut pad1: s32 = 0;
            dList = (*limb).dList[0 as libc::c_int as usize];
            if !dList.is_null() {
                ...
                (*_g).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_fcurve_data_skelanime.c\x00" as
                                      ...
                                      *mut libc::c_char, 321 as libc::c_int)
                        as libc::c_uint;
            ...
            if !dList.is_null() {
                ...
                (*_g_1).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_fcurve_data_skelanime.c\x00" as
                                      *const u8 as *const libc::c_char as
                                      *mut libc::c_char, 332 as libc::c_int)
                        as libc::c_uint;
            ...
            dList = (*limb).dList[1 as libc::c_int as usize];
            if !dList.is_null() {
                ...
                (*_g_3).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_fcurve_data_skelanime.c\x00" as
                                      *const u8 as *const libc::c_char as
                                      *mut libc::c_char, 338 as libc::c_int)
                        as libc::c_uint;
                    ...
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 16 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_4).words.w1 = dList as libc::c_uint
            }
        } else {
            // "FcSkeletonInfo_draw_child (): Not supported"
            osSyncPrintf(b"FcSkeletonInfo_draw_child():\xe6\x9c\xaa\xe5\xaf\xbe\xe5\xbf\x9c\n\x00"
                             as *const u8 as *const libc::c_char);
        }
    }
    if postLimbDraw.is_some() {
        postLimbDraw.expect("non-null function pointer")(globalCtx, skelCurve,
                                                         limbIndex, data);
    }
    if (*limb).firstChildIdx as libc::c_int != 0xff as libc::c_int {
        SkelCurve_DrawLimb(globalCtx, (*limb).firstChildIdx as s32, skelCurve,
                           overrideLimbDraw, postLimbDraw, lod, data);
    }
    Matrix_Pop();
    if (*limb).nextLimbIdx as libc::c_int != 0xff as libc::c_int {
        SkelCurve_DrawLimb(globalCtx, (*limb).nextLimbIdx as s32, skelCurve,
                           overrideLimbDraw, postLimbDraw, lod, data);
    }
...
#[no_mangle]
pub unsafe extern "C" fn SkelCurve_Draw(mut actor: *mut Actor,
                                        mut globalCtx: *mut GlobalContext,
                                        mut skelCurve: *mut SkelAnimeCurve,
                                        mut overrideLimbDraw:
                                            OverrideCurveLimbDraw,
                                        mut postLimbDraw: PostCurveLimbDraw,
                                        mut lod: s32,
                                        mut data: *mut libc::c_void) {
    if !(*skelCurve).transforms.is_null() {
        SkelCurve_DrawLimb(globalCtx, 0 as libc::c_int, skelCurve,
                           overrideLimbDraw, postLimbDraw, lod, data);
    };
}
