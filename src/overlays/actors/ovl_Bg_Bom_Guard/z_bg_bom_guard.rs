...
extern "C" {
    ...
    #[no_mangle]
    static mut gBowlingDefaultCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgBomGuard {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgBomGuardActionFunc,
    pub unk_168: u8_0,
    pub unk_16C: Vec3f,
}
pub type BgBomGuardActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgBomGuard, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnExItem {
...
pub type EnBomBowlManActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnBomBowlMan, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Bom_Guard_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BOM_GUARD as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBomGuard_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBomGuard_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBomGuard_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgBomGuard_SetupAction(mut this: *mut BgBomGuard,
                                                mut actionFunc:
                                                    BgBomGuardActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgBomGuard_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgBomGuard = thisx as *mut BgBomGuard;
    ...
    CollisionHeader_GetVirtual(&mut gBowlingDefaultCol as *mut CollisionHeader
                                   as *mut libc::c_void, &mut colHeader);
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna, thisx,
                            colHeader);
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe9\x80\x8f\xe6\x98\x8e\xe3\x82\xac\xe3\x83\xbc\xe3\x83\x89\xe5\x87\xba\xe7\x8f\xbe \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*thisx).scale.x = 1.0f32;
    (*thisx).scale.y = 1.0f32;
    (*thisx).scale.z = 1.0f32;
    (*this).unk_16C = (*thisx).world.pos;
    BgBomGuard_SetupAction(this,
                           Some(func_8086E638 as
                                    unsafe extern "C" fn(_: *mut BgBomGuard,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn BgBomGuard_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgBomGuard = thisx as *mut BgBomGuard;
...
#[no_mangle]
pub unsafe extern "C" fn func_8086E638(mut this: *mut BgBomGuard,
                                       mut globalCtx: *mut GlobalContext) {
    let mut it: *mut Actor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_NPC as libc::c_int as
                                             usize].head;
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    (*this).unk_168 = 0 as libc::c_int as u8_0;
    while !it.is_null() {
        if (*it).id as libc::c_int == ACTOR_EN_BOM_BOWL_MAN as libc::c_int {
            if (*(it as *mut EnBomBowlMan)).minigamePlayStatus as libc::c_int
                   != 0 as libc::c_int &&
                   fabsf((*globalCtx).view.eye.x) > -20.0f32 &&
                   fabsf((*globalCtx).view.eye.y) > 110.0f32 {
                (*this).unk_168 = 1 as libc::c_int as u8_0
            }
            break ;
        } else { it = (*it).next }
    }
    if (*this).unk_168 as libc::c_int == 0 as libc::c_int {
        (*thisx).world.pos.y =
            (*gGameInfo).data[(16 as libc::c_int * 6 as libc::c_int *
                ...
                -200.0f32
    } else { (*thisx).world.pos.y = 0.0f32 };
}
#[no_mangle]
pub unsafe extern "C" fn BgBomGuard_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgBomGuard = thisx as *mut BgBomGuard;
