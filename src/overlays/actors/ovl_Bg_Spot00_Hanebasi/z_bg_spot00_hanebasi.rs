...
extern "C" {
    ...
    #[no_mangle]
    static mut gHyruleFieldCastleDrawbridgeChainsDL: [Gfx; 0];
    #[no_mangle]
    static mut gHyruleFieldCastleDrawbridgeChainsCol: CollisionHeader;
    #[no_mangle]
    static mut gHyruleFieldCastleDrawbridgeDL: [Gfx; 0];
    #[no_mangle]
    static mut gHyruleFieldCastleDrawbridgeCol: CollisionHeader;
    #[no_mangle]
...
pub struct BgSpot00Hanebasi {
    ...
    pub actionFunc: BgSpot00HanebasiActionFunc,
    pub destAngle: s16,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
}
pub type BgSpot00HanebasiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_21 = libc::c_int;
pub const DT_CHAIN_2: C2RustUnnamed_21 = 1;
pub const DT_CHAIN_1: C2RustUnnamed_21 = 0;
pub const DT_DRAWBRIDGE: C2RustUnnamed_21 = -1;
#[no_mangle]
pub static mut Bg_Spot00_Hanebasi_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT00_HANEBASI as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_SPOT00_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot00Hanebasi>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Hanebasi_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Hanebasi_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Hanebasi_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Hanebasi_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTorchFlameScale: f32_0 = 0.0f32;
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot00Hanebasi = thisx as *mut BgSpot00Hanebasi;
    let mut pad: s32 = 0;
    let mut chainPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    DynaPolyActor_Init(&mut (*this).dyna, 1 as libc::c_int);
    if (*this).dyna.actor.params as libc::c_int ==
           DT_DRAWBRIDGE as libc::c_int {
        CollisionHeader_GetVirtual(&mut gHyruleFieldCastleDrawbridgeCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gHyruleFieldCastleDrawbridgeChainsCol
    ...
    if (*this).dyna.actor.params as libc::c_int ==
        ...
        if gSaveContext.sceneSetupIndex != 6 as libc::c_int &&
            ...
            (*this).dyna.actor.shape.rot.x = -(0x4000 as libc::c_int) as s16
        } else { (*this).dyna.actor.shape.rot.x = 0 as libc::c_int as s16 }
        if gSaveContext.sceneSetupIndex != 6 as libc::c_int {
        ...
        chainPos.y =
            10.0f32 * Math_CosS((*this).dyna.actor.shape.rot.x) -
                Math_SinS((*this).dyna.actor.shape.rot.x) * 400.0f32;
        chainPos.z =
            10.0f32 * Math_SinS((*this).dyna.actor.shape.rot.x) -
                Math_CosS((*this).dyna.actor.shape.rot.x) * 400.0f32;
        chainPos.x =
            158.0f32 * Math_CosS((*this).dyna.actor.shape.rot.y) +
                Math_SinS((*this).dyna.actor.shape.rot.y) * chainPos.z;
        chainPos.z =
            -158.0f32 * Math_SinS((*this).dyna.actor.shape.rot.y) +
                Math_CosS((*this).dyna.actor.shape.rot.y) * chainPos.z;
        if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                              &mut (*this).dyna.actor, globalCtx,
                              ACTOR_BG_SPOT00_HANEBASI as libc::c_int as s16,
                              (*this).dyna.actor.world.pos.x + chainPos.x,
                              (*this).dyna.actor.world.pos.y + chainPos.y,
                              (*this).dyna.actor.world.pos.z + chainPos.z,
                              if (*this).dyna.actor.shape.rot.x as libc::c_int
                                     == 0 as libc::c_int {
                                  0 as libc::c_int
                              } else { 0xf020 as libc::c_int } as s16,
                              (*this).dyna.actor.shape.rot.y,
                              0 as libc::c_int as s16,
                              DT_CHAIN_1 as libc::c_int as s16).is_null() {
            Actor_Kill(&mut (*this).dyna.actor);
        }
        (*this).actionFunc =
            Some(BgSpot00Hanebasi_DrawbridgeWait as
                     unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                          _: *mut GlobalContext) -> ());
        (*this).destAngle = 40 as libc::c_int as s16
    } else if (*this).dyna.actor.params as libc::c_int ==
                  DT_CHAIN_1 as libc::c_int {
        if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                              &mut (*this).dyna.actor, globalCtx,
                              ACTOR_BG_SPOT00_HANEBASI as libc::c_int as s16,
                              ...
                              (*this).dyna.actor.shape.rot.y,
                              0 as libc::c_int as s16,
                              DT_CHAIN_2 as libc::c_int as s16).is_null() {
            Actor_Kill(&mut (*this).dyna.actor);
            Actor_Kill((*this).dyna.actor.parent);
        }
        (*this).actionFunc =
            Some(BgSpot00Hanebasi_SetTorchLightInfo as
                     unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
    ...
    if (*this).dyna.actor.params as libc::c_int >= DT_CHAIN_1 as libc::c_int {
        (*this).lightNode =
        ...
        Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                                if (*this).dyna.actor.params as libc::c_int ==
                                       DT_CHAIN_1 as libc::c_int {
                                    260.0f32
                                } else { -260.0f32 } as s16,
                                168 as libc::c_int as s16,
                                690 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgSpot00Hanebasi = thisx as *mut BgSpot00Hanebasi;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_DrawbridgeWait(mut this:
                                                             *mut BgSpot00Hanebasi,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut child: *mut BgSpot00Hanebasi =
        (*this).dyna.actor.child as *mut BgSpot00Hanebasi;
    if gSaveContext.sceneSetupIndex >= 4 as libc::c_int ||
           ...
           gSaveContext.eventChkInf[8 as libc::c_int as usize] as libc::c_int
               & 1 as libc::c_int != 0 {
        if (*this).dyna.actor.shape.rot.x as libc::c_int != 0 as libc::c_int {
            if Flags_GetEnv(globalCtx, 0 as libc::c_int as s16) != 0 ||
                   gSaveContext.sceneSetupIndex < 4 as libc::c_int &&
                       gSaveContext.nightFlag == 0 as libc::c_int {
                (*this).actionFunc =
                    Some(BgSpot00Hanebasi_DrawbridgeRiseAndFall as
                             unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).destAngle = 0 as libc::c_int as s16;
                (*child).destAngle = 0 as libc::c_int as s16;
                return
            }
            !this.is_null();
            // required to match
        } // intensity of the red and green channels
        if (*this).dyna.actor.shape.rot.x as libc::c_int == 0 as libc::c_int
               && gSaveContext.sceneSetupIndex < 4 as libc::c_int &&
               !(gSaveContext.linkAge == 0 as libc::c_int) &&
               gSaveContext.nightFlag != 0 as libc::c_int {
            (*this).actionFunc =
                Some(BgSpot00Hanebasi_DrawbridgeRiseAndFall as
                         unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                              _: *mut GlobalContext) -> ());
            (*this).destAngle = -(0x4000 as libc::c_int) as s16;
            (*child).destAngle = -(0xfe0 as libc::c_int) as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_DoNothing(mut this:
                                                        *mut BgSpot00Hanebasi,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_DrawbridgeRiseAndFall(mut this:
                                                                    *mut BgSpot00Hanebasi,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    let mut child: *mut BgSpot00Hanebasi = 0 as *mut BgSpot00Hanebasi;
    let mut childsChild: *mut Actor = 0 as *mut Actor;
    let mut angle: s16 = 80 as libc::c_int as s16;
    if Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.x,
                          (*this).destAngle, 80 as libc::c_int as s16) != 0 {
        (*this).actionFunc =
            Some(BgSpot00Hanebasi_DrawbridgeWait as
                     unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                          _: *mut GlobalContext) -> ())
    ...
    if (*this).dyna.actor.shape.rot.x as libc::c_int >=
           -(0x27d8 as libc::c_int) {
        child = (*this).dyna.actor.child as *mut BgSpot00Hanebasi;
        angle = (angle as libc::c_float * 0.4f32) as s16;
        Math_ScaledStepToS(&mut (*child).dyna.actor.shape.rot.x,
                           (*child).destAngle, angle);
        childsChild = (*child).dyna.actor.child;
        Math_ScaledStepToS(&mut (*childsChild).shape.rot.x,
                           (*child).destAngle, angle);
    }
    if ((*this).destAngle as libc::c_int) < 0 as libc::c_int {
        if (*this).actionFunc ==
               Some(BgSpot00Hanebasi_DrawbridgeWait as
                        unsafe extern "C" fn(_: *mut BgSpot00Hanebasi,
                                             _: *mut GlobalContext) -> ()) {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x280f as libc::c_int as u16_0);
        } else {
            func_8002F974(&mut (*this).dyna.actor,
                          (0x280d as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
     ...
     {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x280e as libc::c_int as u16_0);
    } else {
        func_8002F974(&mut (*this).dyna.actor,
                      (0x280c as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_SetTorchLightInfo(mut this:
                                                                *mut BgSpot00Hanebasi,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    let mut lightColor: u8_0 =
        ((Rand_ZeroOne() * 127.0f32) as u8_0 as libc::c_int +
    ...
    Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                            ...
                            (5000.0f32 * sTorchFlameScale + 128.0f32) as s16,
                            690 as libc::c_int as s16, lightColor, lightColor,
                            0 as libc::c_int as u8_0,
                            (sTorchFlameScale * 37500.0f32) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot00Hanebasi = thisx as *mut BgSpot00Hanebasi;
    let mut pad: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int ==
            ...
            if gBitFlags[QUEST_KOKIRI_EMERALD as libc::c_int as usize] &
                ...
                let mut player: *mut Player =
                    (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                         ...
                                                         usize].head as
                        *mut Player;
                if (*player).actor.world.pos.x > -450.0f32 &&
                       (*player).actor.world.pos.x < 450.0f32 &&
                       (*player).actor.world.pos.z > 1080.0f32 &&
                       (*player).actor.world.pos.z < 1700.0f32 &&
                       Gameplay_InCsMode(globalCtx) == 0 {
                    gSaveContext.eventChkInf[8 as libc::c_int as usize] =
                        (gSaveContext.eventChkInf[8 as libc::c_int as usize]
                             as libc::c_int | 1 as libc::c_int) as u16_0;
                    Flags_SetEventChkInf(0x82 as libc::c_int);
                    (*this).actionFunc =
                        Some(BgSpot00Hanebasi_DoNothing as
                                 unsafe extern "C" fn(_:
                                                          *mut BgSpot00Hanebasi,
                                                      _: *mut GlobalContext)
                                     -> ());
                ...
                } else if Actor_IsFacingAndNearPlayer(&mut (*this).dyna.actor,
                                                      3000.0f32,
                                                      0x7530 as libc::c_int as
                                                          s16) != 0 {
        ...
        if gSaveContext.sceneSetupIndex == 5 as libc::c_int {
            ...
            let mut tmp: s32 = 0;
            if gTimeIncrement as libc::c_int == 50 as libc::c_int {
                tmp = 0xd556 as libc::c_int;
                if gSaveContext.dayTime as libc::c_int >=
                       0xd557 as libc::c_int {
                    tmp = 0x1d556 as libc::c_int
                }
                gTimeIncrement =
                    ((tmp - gSaveContext.dayTime as libc::c_int) as
                         libc::c_float * (1.0f32 / 350.0f32)) as u16_0
            }
            dayTime = gSaveContext.dayTime;
            if dayTime as libc::c_int >= 0x2aac as libc::c_int &&
                   (dayTime as libc::c_int) < 0x3000 as libc::c_int &&
                   gSaveContext.sceneSetupIndex == 5 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_DrawTorches(mut thisx: *mut Actor,
                                                      mut globalCtx2:
                                                          *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot00_hanebasi.c\x00" as *const u8 as
                        *const libc::c_char, 633 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    if gSaveContext.sceneSetupIndex >= 4 as libc::c_int {
        sTorchFlameScale = 0.008f32
    } else {
        sTorchFlameScale =
            ((*thisx).shape.rot.x as libc::c_int * -(1 as libc::c_int) -
    ...
    angle =
        (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                         as usize]) as
             libc::c_int + 0x8000 as libc::c_int) as s16 as libc::c_int as
            libc::c_float * (3.14159265358979323846f32 / 32768.0f32);
    ...
    while i < 2 as libc::c_int {
        ...
        (*_g_1).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             (*globalCtx).gameplayFrames.wrapping_add(i as
                ...
                libc::c_uint;
        Matrix_Translate(if i == 0 as libc::c_int {
                             260.0f32
                         } else { -260.0f32 }, 128.0f32, 690.0f32,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY(angle, MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(sTorchFlameScale, sTorchFlameScale, sTorchFlameScale,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Hanebasi_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut basePos: Vec3f =
        { let mut init = Vec3f{x: 158.0f32, y: 10.0f32, z: 400.0f32,}; init };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot00_hanebasi.c\x00" as *const u8 as
                        *const libc::c_char, 698 as libc::c_int);
    ...
    if (*thisx).params as libc::c_int == DT_DRAWBRIDGE as libc::c_int {
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gHyruleFieldCastleDrawbridgeDL.as_mut_ptr() as libc::c_uint;
        Matrix_MultVec3f(&mut basePos, &mut newPos);
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gHyruleFieldCastleDrawbridgeChainsDL.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_spot00_hanebasi.c\x00" as *const u8 as
                         *const libc::c_char, 733 as libc::c_int);
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(550 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
