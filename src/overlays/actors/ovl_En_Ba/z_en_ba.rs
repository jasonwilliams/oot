...
extern "C" {
    ...
    fn Actor_Spawn(actorCtx: *mut ActorContext, globalCtx: *mut GlobalContext,
     ...
     -> *mut Actor;
    #[no_mangle]
    fn func_80033AEC(arg0: *mut Vec3f, arg1: *mut Vec3f, arg2: f32_0,
                     arg3: f32_0, arg4: f32_0, arg5: f32_0) -> f32_0;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_bxa_DL_000890: [Gfx; 0];
    #[no_mangle]
    static mut object_bxa_DL_001D80: [Gfx; 0];
    #[no_mangle]
    static mut object_bxa_Tex_0024F0: [u64_0; 0];
    #[no_mangle]
    static mut object_bxa_Tex_0027F0: [u64_0; 0];
    #[no_mangle]
    static mut object_bxa_Tex_0029F0: [u64_0; 0];
}
...
pub struct EnBa {
    ...
    pub colliderItems: [ColliderJntSphElement; 2],
}
pub type EnBaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBa, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const EN_BA_DEAD_BLOB: C2RustUnnamed_22 = 3;
pub const EN_BA_TENTACLE_GRAY: C2RustUnnamed_22 = 2;
pub const EN_BA_TENTACLE_GREEN: C2RustUnnamed_22 = 1;
pub const EN_BA_TENTACLE_RED: C2RustUnnamed_22 = 0;
#[no_mangle]
pub static mut En_Ba_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BA as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BXA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBa>() as libc::c_ulong,
                          init:
...
static mut D_809B8080: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 32.0f32,}; init };
static mut sJntSphElementInit: [ColliderJntSphElementInit; 2] =
    [{
         let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnBa_SetupAction(mut this: *mut EnBa,
                                          mut actionFunc: EnBaActionFunc) {
    (*this).actionFunc = actionFunc;
}
static mut D_809B80E4: Vec3f =
    { let mut init = Vec3f{x: 0.01f32, y: 0.01f32, z: 0.01f32,}; init };
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn EnBa_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBa = thisx as *mut EnBa;
    let mut sp38: Vec3f = D_809B80E4;
    let mut pad: s32 = 0;
    let mut i: s16 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 100.0f32;
    i = 13 as libc::c_int as s16;
    while i as libc::c_int >= 0 as libc::c_int {
        (*this).unk200[i as usize] = sp38;
        (*this).unk2A8[i as usize].x = -(0x4000 as libc::c_int) as s16;
        (*this).unk158[i as usize] = (*this).actor.world.pos;
        (*this).unk158[i as usize].y =
            (*this).actor.world.pos.y -
                (i as libc::c_int + 1 as libc::c_int) as libc::c_float *
                    32.0f32;
        i -= 1
    }
    (*this).actor.targetMode = 4 as libc::c_int as s8;
    (*this).upperParams =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int &
             0xff as libc::c_int) as s16;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    if ((*this).actor.params as libc::c_int) < EN_BA_DEAD_BLOB as libc::c_int
       {
        if Flags_GetSwitch(globalCtx, (*this).upperParams as s32) != 0 {
        ...
        Actor_SetScale(&mut (*this).actor, 0.021f32);
        EnBa_SetupFallAsBlob(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBa = thisx as *mut EnBa;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_SetupIdle(mut this: *mut EnBa) {
    (*this).unk14C = 2 as libc::c_int;
    (*this).unk31C = 1500 as libc::c_int as s16;
    (*this).actor.speedXZ = 10.0f32;
    EnBa_SetupAction(this,
                     Some(EnBa_Idle as
                              unsafe extern "C" fn(_: *mut EnBa,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_Idle(mut this: *mut EnBa,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    let mut i: s32 = 0;
    let mut pad: s32 = 0;
    let mut sp5C: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    if (*this).actor.colChkInfo.mass as libc::c_int == 0xff as libc::c_int &&
           (*this).actor.xzDistToPlayer > 175.0f32 {
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.home.pos.y + 330.0f32, 1.0f32,
                           7.0f32, 0.0f32);
    } else {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.home.pos.y + 100.0f32, 1.0f32,
                           10.0f32, 0.0f32);
    }
    ...
    if (*globalCtx).gameplayFrames.wrapping_rem(16 as libc::c_int as
        ...
        (*this).unk308.z += Rand_CenteredFloat(180.0f32);
        (*this).unk314 += Rand_CenteredFloat(180.0f32);
        (*this).unk308.x = Math_SinF((*this).unk308.z) * 80.0f32;
        (*this).unk308.y = Math_CosF((*this).unk314) * 80.0f32
    }
    (*this).unk2FC.y -= 448.0f32;
    (*this).unk2FC.x += (*this).unk308.x;
    (*this).unk2FC.z += (*this).unk308.y;
    func_80033AEC(&mut (*this).unk2FC,
                  &mut *(*this).unk158.as_mut_ptr().offset(13 as libc::c_int
                                                               as isize),
                  1.0f32, (*this).actor.speedXZ, 0.0f32, 0.0f32);
    i = 12 as libc::c_int;
    while i >= 0 as libc::c_int {
        func_80035844(&mut *(*this).unk158.as_mut_ptr().offset((i +
                                                                    1 as
                                                                        libc::c_int)
                                                                   as isize),
                      &mut *(*this).unk158.as_mut_ptr().offset(i as isize),
                      &mut sp5C, 0 as libc::c_int);
        Matrix_Translate((*this).unk158[(i + 1 as libc::c_int) as usize].x,
                         (*this).unk158[(i + 1 as libc::c_int) as usize].y,
                         (*this).unk158[(i + 1 as libc::c_int) as usize].z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateZYX(sp5C.x, sp5C.y, 0 as libc::c_int as s16,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut D_809B8080,
                         &mut *(*this).unk158.as_mut_ptr().offset(i as
                                                                      isize));
        i -= 1
    }
    func_80035844(&mut *(*this).unk158.as_mut_ptr().offset(0 as libc::c_int as
                                                               isize),
                  &mut (*this).unk2FC, &mut sp5C, 0 as libc::c_int);
    Matrix_Translate((*this).actor.world.pos.x, (*this).actor.world.pos.y,
                     (*this).actor.world.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).unk2A8[0 as libc::c_int as usize].y,
                       3 as libc::c_int as s16, (*this).unk31C,
                       182 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       (*this).unk2A8[0 as libc::c_int as usize].x,
                       3 as libc::c_int as s16, (*this).unk31C,
                       182 as libc::c_int as s16);
    Matrix_RotateZYX(((*this).actor.shape.rot.x as libc::c_int -
                          0x8000 as libc::c_int) as s16,
                     (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut D_809B8080,
                     &mut *(*this).unk158.as_mut_ptr().offset(0 as libc::c_int
                                                                  as isize));
    (*this).unk2A8[13 as libc::c_int as usize].y = sp5C.y;
    (*this).unk2A8[13 as libc::c_int as usize].x =
        (sp5C.x as libc::c_int + 0x8000 as libc::c_int) as s16;
    i = 0 as libc::c_int;
    while i < 13 as libc::c_int {
        Matrix_Translate((*this).unk158[i as usize].x,
                         (*this).unk158[i as usize].y,
                         (*this).unk158[i as usize].z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).y,
                           (*this).unk2A8[(i + 1 as libc::c_int) as usize].y,
                           3 as libc::c_int as s16, (*this).unk31C,
                           182 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).x,
                           (*this).unk2A8[(i + 1 as libc::c_int) as usize].x,
                           3 as libc::c_int as s16, (*this).unk31C,
                           182 as libc::c_int as s16);
        Matrix_RotateZYX(((*this).unk2A8[i as usize].x as libc::c_int -
                              0x8000 as libc::c_int) as s16,
                         (*this).unk2A8[i as usize].y,
                         0 as libc::c_int as s16,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut D_809B8080,
                         &mut *(*this).unk158.as_mut_ptr().offset((i +
                                                                       1 as
                                                                           libc::c_int)
                                                                      as
                                                                      isize));
    ...
    (*this).unk2A8[13 as libc::c_int as usize].x =
        (*this).unk2A8[12 as libc::c_int as usize].x;
    (*this).unk2A8[13 as libc::c_int as usize].y =
        (*this).unk2A8[12 as libc::c_int as usize].y;
...
#[no_mangle]
pub unsafe extern "C" fn EnBa_SetupFallAsBlob(mut this: *mut EnBa) {
    (*this).unk14C = 0 as libc::c_int;
    (*this).actor.speedXZ = Rand_CenteredFloat(8.0f32);
    (*this).actor.world.rot.y = Rand_CenteredFloat(65535.0f32) as s16;
    (*this).unk318 = 20 as libc::c_int as s16;
    (*this).actor.gravity = -2.0f32;
    EnBa_SetupAction(this,
                     Some(EnBa_FallAsBlob as
                              unsafe extern "C" fn(_: *mut EnBa,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBa_FallAsBlob(mut this: *mut EnBa,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.scale.y -= 0.001f32;
        (*this).actor.scale.x += 0.0005f32;
        (*this).actor.scale.z += 0.0005f32;
        (*this).unk318 -= 1;
        if (*this).unk318 as libc::c_int == 0 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        }
    } else {
        Actor_MoveForward(&mut (*this).actor);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 30.0f32,
                                28.0f32, 80.0f32, 5 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_SetupSwingAtPlayer(mut this: *mut EnBa) {
    (*this).unk14C = 3 as libc::c_int;
    (*this).unk318 = 20 as libc::c_int as s16;
    (*this).unk31A = 0 as libc::c_int as s16;
    (*this).unk31C = 1500 as libc::c_int as s16;
    (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).actor.speedXZ = 20.0f32;
    EnBa_SetupAction(this,
                     Some(EnBa_SwingAtPlayer as
                              unsafe extern "C" fn(_: *mut EnBa,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_SwingAtPlayer(mut this: *mut EnBa,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    let mut temp: s16 = 0;
    let mut i: s16 = 0;
    let mut sp58: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut phi_fp: s16 = 0;
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*this).actor.home.pos.y + 60.0f32, 1.0f32, 10.0f32,
                       0.0f32);
    if (*this).actor.xzDistToPlayer <= 175.0f32 ||
           (*this).unk31A as libc::c_int != 0 as libc::c_int {
        if (*this).unk318 as libc::c_int == 20 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3959 as libc::c_int as u16_0);
            (*this).unk31C = 1500 as libc::c_int as s16
        }
        if (*this).unk318 as libc::c_int != 0 as libc::c_int {
            (*this).unk31A = 10 as libc::c_int as s16;
            (*this).unk318 -= 1;
            if (*this).unk318 as libc::c_int >= 11 as libc::c_int {
                (*this).unk2FC = (*player).actor.world.pos;
                (*this).unk2FC.y += 30.0f32;
            ...
            Math_SmoothStepToS(&mut (*this).unk31C,
                               1500 as libc::c_int as s16,
                               1 as libc::c_int as s16,
                               30 as libc::c_int as s16,
                               0 as libc::c_int as s16);
            func_80035844(&mut (*this).actor.world.pos,
                          &mut *(*this).unk158.as_mut_ptr().offset(0 as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
                          &mut sp58, 0 as libc::c_int);
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, sp58.y,
                               1 as libc::c_int as s16, (*this).unk31C,
                               0 as libc::c_int as s16);
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                               (sp58.x as libc::c_int + 0x8000 as libc::c_int)
                                   as s16, 1 as libc::c_int as s16,
                               (*this).unk31C, 0 as libc::c_int as s16);
            ...
            while (i as libc::c_int) < 13 as libc::c_int {
                Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize)).x,
                                   (i as libc::c_int * 1200 as libc::c_int -
            ...
            if (*this).unk31A as libc::c_int == 10 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3958 as libc::c_int as u16_0);
            }
            if (*this).unk31A as libc::c_int != 0 as libc::c_int {
                (*this).unk31C = 8000 as libc::c_int as s16;
                ...
                temp =
                    (Math_Vec3f_Pitch(&mut (*this).actor.world.pos,
                                      &mut *(*this).unk158.as_mut_ptr().offset(0
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize))
                         as libc::c_int + 0x8000 as libc::c_int) as s16;
                Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, phi_fp,
                                   1 as libc::c_int as s16, (*this).unk31C,
                                   0 as libc::c_int as s16);
                Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, temp,
                                   1 as libc::c_int as s16, (*this).unk31C,
                                   0 as libc::c_int as s16);
                Matrix_Translate((*this).actor.world.pos.x,
                                 (*this).actor.world.pos.y,
                ...
                Matrix_RotateZYX(((*this).actor.shape.rot.x as libc::c_int -
                                 ...
                                 MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_MultVec3f(&mut D_809B8080,
                                 (*this).unk158.as_mut_ptr());
                i = 0 as libc::c_int as s16;
                while (i as libc::c_int) < 13 as libc::c_int {
                    temp =
                        (-Math_CosS(((*this).unk31A as libc::c_int *
                                         0xccc as libc::c_int) as s16) *
                             (i as libc::c_int * 1200 as libc::c_int) as
                                 libc::c_float) as s16;
                    Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i
                                                                                     as
                                                                                     isize)).x,
                    ...
                    Matrix_Translate((*this).unk158[i as usize].x,
                                     ...
                                     (*this).unk158[i as usize].z,
                                     MTXMODE_NEW as libc::c_int as u8_0);
                    Matrix_RotateZYX(((*this).unk2A8[i as usize].x as
                                          libc::c_int - 0x8000 as libc::c_int)
                                         as s16, (*this).unk2A8[i as usize].y,
                                     0 as libc::c_int as s16,
                                     MTXMODE_APPLY as libc::c_int as u8_0);
                    Matrix_MultVec3f(&mut D_809B8080,
                                     &mut *(*this).unk158.as_mut_ptr().offset((i
                ...
                (*this).unk31A -= 1
            } else if (*this).actor.xzDistToPlayer > 175.0f32 ||
                          (*player).stateFlags1 &
                              0x4000000 as libc::c_int as libc::c_uint != 0 {
                EnBa_SetupIdle(this);
            } else {
                EnBa_SetupSwingAtPlayer(this);
                (*this).unk318 = 27 as libc::c_int as s16;
                (*this).unk31C = 750 as libc::c_int as s16
            }
        }
        (*this).unk2A8[13 as libc::c_int as usize].x =
            (*this).unk2A8[12 as libc::c_int as usize].x;
        (*this).unk2A8[13 as libc::c_int as usize].y =
            (*this).unk2A8[12 as libc::c_int as usize].y;
        if (*this).collider.base.atFlags as libc::c_int & 2 as libc::c_int !=
               0 {
            (*this).collider.base.atFlags =
                ((*this).collider.base.atFlags as libc::c_int &
                     !(2 as libc::c_int)) as u8_0;
            if (*this).collider.base.at == &mut (*player).actor as *mut Actor
               {
...
#[no_mangle]
pub unsafe extern "C" fn func_809B7174(mut this: *mut EnBa) {
    (*this).unk14C = 1 as libc::c_int;
    (*this).unk31C = 1500 as libc::c_int as s16;
    (*this).unk318 = 20 as libc::c_int as s16;
    (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).actor.speedXZ = 10.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x395a as libc::c_int as u16_0);
    ...
    EnBa_SetupAction(this,
                     Some(EnBa_RecoilFromDamage as
                              unsafe extern "C" fn(_: *mut EnBa,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_RecoilFromDamage(mut this: *mut EnBa,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut sp6C: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*this).actor.home.pos.y + 330.0f32, 1.0f32, 30.0f32,
                       0.0f32);
    (*this).unk2FC = (*this).actor.world.pos;
    if (*globalCtx).gameplayFrames.wrapping_rem(16 as libc::c_int as
                                                    libc::c_uint) ==
    ...
    while i >= 0 as libc::c_int {
        func_80035844(&mut *(*this).unk158.as_mut_ptr().offset((i +
                                                                   ...
                                                                   as isize),
                      &mut *(*this).unk158.as_mut_ptr().offset(i as isize),
                      &mut sp6C, 0 as libc::c_int);
        Matrix_Translate((*this).unk158[(i + 1 as libc::c_int) as usize].x,
                         (*this).unk158[(i + 1 as libc::c_int) as usize].y,
                         (*this).unk158[(i + 1 as libc::c_int) as usize].z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateZYX(sp6C.x, sp6C.y, 0 as libc::c_int as s16,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut D_809B8080,
                         &mut *(*this).unk158.as_mut_ptr().offset(i as
                                                                      isize));
    ...
    func_80035844(&mut (*this).actor.world.pos,
                  &mut *(*this).unk158.as_mut_ptr().offset(0 as libc::c_int as
                                                               isize),
                  &mut sp6C, 0 as libc::c_int);
    Matrix_Translate((*this).actor.world.pos.x, (*this).actor.world.pos.y,
                     (*this).actor.world.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, sp6C.y,
                       3 as libc::c_int as s16, (*this).unk31C,
                       182 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       (sp6C.x as libc::c_int + 0x8000 as libc::c_int) as s16,
                       3 as libc::c_int as s16, (*this).unk31C,
                       182 as libc::c_int as s16);
    Matrix_RotateZYX(((*this).actor.shape.rot.x as libc::c_int -
                          0x8000 as libc::c_int) as s16,
    ...
    i = 0 as libc::c_int;
    while i < 13 as libc::c_int {
        func_80035844(&mut *(*this).unk158.as_mut_ptr().offset(i as isize),
                      &mut *(*this).unk158.as_mut_ptr().offset((i +
                                                                    1 as
                                                                        libc::c_int)
                                                                   as isize),
        ...
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).y,
                           sp6C.y, 3 as libc::c_int as s16, (*this).unk31C,
                           182 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).x,
                           (sp6C.x as libc::c_int + 0x8000 as libc::c_int) as
                               s16, 3 as libc::c_int as s16, (*this).unk31C,
                           182 as libc::c_int as s16);
        Matrix_RotateZYX(((*this).unk2A8[i as usize].x as libc::c_int -
                              0x8000 as libc::c_int) as s16,
                         (*this).unk2A8[i as usize].y,
...
pub unsafe extern "C" fn func_809B75A0(mut this: *mut EnBa,
    ...
    while i < 14 as libc::c_int {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_BA as libc::c_int as s16,
                    (*this).unk158[i as usize].x,
                    (*this).unk158[i as usize].y,
                    (*this).unk158[i as usize].z, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    EN_BA_DEAD_BLOB as libc::c_int as s16);
        i += 1
    }
    unk_temp =
        (Math_Vec3f_Pitch(&mut (*this).actor.world.pos,
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ...
                       1 as libc::c_int as s16, (*this).unk31C,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, unk_temp,
                       1 as libc::c_int as s16, (*this).unk31C,
                       0 as libc::c_int as s16);
    Matrix_Translate((*this).actor.world.pos.x, (*this).actor.world.pos.y,
                     (*this).actor.world.pos.z,
    ...
    while i < 13 as libc::c_int {
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).x,
                           (*this).unk2A8[5 as libc::c_int as usize].x,
                           1 as libc::c_int as s16, (*this).unk31C,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                         isize)).y,
                           (*this).unk2A8[5 as libc::c_int as usize].y,
                           1 as libc::c_int as s16, (*this).unk31C,
                           0 as libc::c_int as s16);
        Matrix_Translate((*this).unk158[i as usize].x,
                         (*this).unk158[i as usize].y,
    ...
    (*this).unk31A = 15 as libc::c_int as s16;
    EnBa_SetupAction(this,
                     Some(EnBa_Die as
                              unsafe extern "C" fn(_: *mut EnBa,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBa_Die(mut this: *mut EnBa,
                                  mut globalCtx: *mut GlobalContext) {
    let mut sp6C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut temp: s16 = 0;
    ...
    if (*this).unk31A as libc::c_int != 0 as libc::c_int {
        ...
        while i < 5 as libc::c_int {
            temp =
                (-Math_CosS(((*this).unk31A as libc::c_int *
                     ...
                     (i * 400 as libc::c_int) as libc::c_float) as s16;
            Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                             isize)).x,
                               (temp as libc::c_int - 0x4000 as libc::c_int)
                                   as s16, 1 as libc::c_int as s16,
                               (*this).unk31C, 0 as libc::c_int as s16);
            Math_SmoothStepToS(&mut (*(*this).unk2A8.as_mut_ptr().offset(i as
                                                                             isize)).y,
        ...
        Flags_SetSwitch(globalCtx, (*this).upperParams as s32);
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBa_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBa = thisx as *mut EnBa;
    if ((*this).actor.params as libc::c_int) < EN_BA_DEAD_BLOB as libc::c_int
           &&
           (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int !=
               0 {
        ...
        } else { func_809B7174(this); }
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if ((*this).actor.params as libc::c_int) < EN_BA_DEAD_BLOB as libc::c_int
       {
        (*this).actor.focus.pos = (*this).unk158[6 as libc::c_int as usize]
    }
    if (*this).unk14C >= 2 as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    };
}
static mut D_809B8118: [*mut libc::c_void; 3] =
    unsafe {
        [object_bxa_Tex_0024F0.as_ptr() as *mut _ as *mut libc::c_void,
         object_bxa_Tex_0027F0.as_ptr() as *mut _ as *mut libc::c_void,
         object_bxa_Tex_0029F0.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnBa_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBa = thisx as *mut EnBa;
    let mut pad: s32 = 0;
    let mut i: s16 = 0;
    let mut mtx: *mut Mtx =
        Graph_Alloc((*globalCtx).state.gfxCtx,
                    (::std::mem::size_of::<Mtx>() as
                         libc::c_ulong).wrapping_mul(14 as libc::c_int as
                                                         libc::c_uint) as
                        size_t) as *mut Mtx;
    let mut unused: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 448.0f32,}; init };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ba.c\x00" as *const u8 as *const libc::c_char,
                    933 as libc::c_int);
    ...
    if ((*this).actor.params as libc::c_int) < EN_BA_DEAD_BLOB as libc::c_int
       {
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((D_809B8118[(*this).actor.params as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(D_809B8118[(*this).actor.params
                                                             as usize] as
                                                  u32_0 &
        ...
        while (i as libc::c_int) < 14 as libc::c_int {
            Matrix_Translate((*this).unk158[i as usize].x,
                             ...
                             (*this).unk158[i as usize].z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_RotateZYX((*this).unk2A8[i as usize].x,
                             (*this).unk2A8[i as usize].y,
                             (*this).unk2A8[i as usize].z,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale((*this).unk200[i as usize].x,
                         (*this).unk200[i as usize].y,
                         (*this).unk200[i as usize].z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            if i as libc::c_int == 6 as libc::c_int ||
                   i as libc::c_int == 13 as libc::c_int {
                match i as libc::c_int {
                    13 => {
                        Collider_UpdateSpheres(i as s32,
                                               &mut (*this).collider);
                    }
                    _ => {
                        Matrix_Scale(0.5f32, 0.5f32, 1.0f32,
                                     MTXMODE_APPLY as libc::c_int as u8_0);
                        Collider_UpdateSpheres(8 as libc::c_int,
                                               &mut (*this).collider);
                    }
                }
            }
            Matrix_ToMtx(mtx,
                         b"../z_en_ba.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = object_bxa_DL_000890.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_7).words.w1 = object_bxa_DL_001D80.as_mut_ptr() as libc::c_uint
    }
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x15 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
