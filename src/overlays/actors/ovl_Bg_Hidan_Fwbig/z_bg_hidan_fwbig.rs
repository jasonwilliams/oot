...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffUnknown4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnknown5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigFireWallDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanFwbig {
    pub actor: Actor,
    pub actionFunc: BgHidanFwbigActionFunc,
    pub direction: s8,
    pub moveState: u8_0,
    pub timer: s16,
    pub collider: ColliderCylinder,
}
pub type BgHidanFwbigActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanFwbig, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const FWBIG_KILL: C2RustUnnamed_21 = 2;
pub const FWBIG_RESET: C2RustUnnamed_21 = 1;
pub const FWBIG_MOVE: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut Bg_Hidan_Fwbig_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_FWBIG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanFwbig>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFwbig_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFwbig_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFwbig_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFwbig_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Init(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut BgHidanFwbig = thisx as *mut BgHidanFwbig;
    ...
    (*this).direction =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int) as u16_0 as s8;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    if (*this).direction as libc::c_int != 0 as libc::c_int {
        (*this).actor.home.pos.x = 1560.0f32;
        (*this).actor.home.pos.z = 0.0f32;
        if (*player).actor.world.pos.z > 300.0f32 {
            (*this).direction = -(1 as libc::c_int) as s8;
            (*this).actor.shape.rot.y = -(0x4e38 as libc::c_int) as s16;
            (*this).actor.home.rot.y = (*this).actor.shape.rot.y
        } else if (*player).actor.world.pos.z < -300.0f32 {
            (*this).direction = 1 as libc::c_int as s8;
            (*this).actor.shape.rot.y = -(0x31c8 as libc::c_int) as s16;
            (*this).actor.home.rot.y = (*this).actor.shape.rot.y
        } else { Actor_Kill(&mut (*this).actor); return }
        BgHidanFwbig_UpdatePosition(this);
        Actor_SetScale(&mut (*this).actor, 0.15f32);
        (*this).collider.dim.height = 230 as libc::c_int as s16;
        (*this).actor.flags |=
            ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
        (*this).moveState = FWBIG_MOVE as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgHidanFwbig_WaitForPlayer as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.world.pos.y =
            (*this).actor.home.pos.y - 2400.0f32 * (*this).actor.scale.y
    } else {
        Actor_SetScale(&mut (*this).actor, 0.1f32);
        (*this).actionFunc =
            Some(BgHidanFwbig_WaitForSwitch as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanFwbig = thisx as *mut BgHidanFwbig;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_UpdatePosition(mut this:
                                                         *mut BgHidanFwbig) {
    let mut startAngle: s16 =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).direction as libc::c_int * -(0x4000 as libc::c_int)) as
            s16;
    (*this).actor.world.pos.x =
        Math_SinS(startAngle) * 885.4f32 + (*this).actor.home.pos.x;
    (*this).actor.world.pos.z =
        Math_CosS(startAngle) * 885.4f32 + (*this).actor.home.pos.z;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_WaitForSwitch(mut this:
                                                        *mut BgHidanFwbig,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        (*this).actionFunc =
            Some(BgHidanFwbig_WaitForCs as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 3340 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_WaitForCs(mut this: *mut BgHidanFwbig,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    if fresh0 as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgHidanFwbig_Lower as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Rise(mut this: *mut BgHidanFwbig,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Lower(mut this: *mut BgHidanFwbig,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if Math_StepToF(&mut (*this).actor.world.pos.y,
                    (*this).actor.home.pos.y -
                        2400.0f32 * (*this).actor.scale.y, 10.0f32) != 0 {
        if (*this).direction as libc::c_int == 0 as libc::c_int {
            (*this).actionFunc =
                Some(BgHidanFwbig_WaitForTimer as
                         unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                              _: *mut GlobalContext) -> ());
            (*this).timer = 150 as libc::c_int as s16
        } else if (*this).moveState as libc::c_int ==
                      FWBIG_KILL as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        } else {
            if (*this).moveState as libc::c_int == FWBIG_MOVE as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_WaitForTimer(mut this:
                                                       *mut BgHidanFwbig,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_WaitForPlayer(mut this:
                                                        *mut BgHidanFwbig,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*player).actor.world.pos.x < 1150.0f32 {
        (*this).actionFunc =
            Some(BgHidanFwbig_Rise as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 3290 as libc::c_int as s16,
                              -(99 as libc::c_int) as s16, &mut (*this).actor,
                              0 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Move(mut this: *mut BgHidanFwbig,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if Player_InCsMode(globalCtx) == 0 {
        if Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                              ((*this).actor.home.rot.y as libc::c_int +
                                   (*this).direction as libc::c_int *
                                       0x6390 as libc::c_int) as s16,
                              0x20 as libc::c_int as s16) != 0 {
            (*this).moveState = FWBIG_RESET as libc::c_int as u8_0;
            (*this).actionFunc =
                Some(BgHidanFwbig_Lower as
                         unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                              _: *mut GlobalContext) -> ())
        } else { BgHidanFwbig_UpdatePosition(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_MoveCollider(mut this:
                                                       *mut BgHidanFwbig,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut projPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut cs: f32_0 = 0.;
    let mut sn: f32_0 = 0.;
    func_8002DBD0(&mut (*this).actor, &mut projPos,
                  &mut (*player).actor.world.pos);
    projPos.z =
        (if projPos.z >= 0.0f32 { 1.0f32 } else { -1.0f32 }) * 25.0f32 *
            -1.0f32;
    if (*this).direction as libc::c_int == 0 as libc::c_int {
        projPos.x =
            if projPos.x < -360.0f32 {
                -360.0f32
            } else if projPos.x > 360.0f32 { 360.0f32 } else { projPos.x }
    } else {
        projPos.x =
            if projPos.x < -500.0f32 {
                -500.0f32
            } else if projPos.x > 500.0f32 { 500.0f32 } else { projPos.x }
    }
    sn = Math_SinS((*this).actor.shape.rot.y);
    cs = Math_CosS((*this).actor.shape.rot.y);
    (*this).collider.dim.pos.x =
        ((*this).actor.world.pos.x + projPos.x * cs + projPos.z * sn) as s16;
    (*this).collider.dim.pos.z =
        ((*this).actor.world.pos.z - projPos.x * sn + projPos.z * cs) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanFwbig = thisx as *mut BgHidanFwbig;
    ...
    if (*this).direction as libc::c_int != 0 as libc::c_int &&
        ...
        (*this).moveState = FWBIG_KILL as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgHidanFwbig_Lower as
                     unsafe extern "C" fn(_: *mut BgHidanFwbig,
                                          _: *mut GlobalContext) -> ())
    ...
    if (*this).actor.home.pos.y - 200.0f32 < (*this).actor.world.pos.y {
        if gSaveContext.sceneSetupIndex < 4 as libc::c_int {
            func_8002F974(&mut (*this).actor,
                          (0x28b3 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        } else if (*this).actor.world.pos.x as s16 as libc::c_int ==
                      -(513 as libc::c_int) {
            func_8002F974(&mut (*this).actor,
                          (0x28bb as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFwbig_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_fwbig.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        gSegments[((gEffUnknown4Tex.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffUnknown4Tex.as_mut_ptr() as
                                              u32_0 &
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((gEffUnknown5Tex.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffUnknown5Tex.as_mut_ptr() as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as libc::c_uint;
    height = (*thisx).scale.y * 2400.0f32;
    ...
    (*_g_1).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((height - ((*thisx).home.pos.y - (*thisx).world.pos.y)) *
                  255.0f32 / height) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_3).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         0 as libc::c_int as u32_0,
                         (*globalCtx).gameplayFrames.wrapping_mul(-(15 as
                                                                        libc::c_int)
                                                                      as
                                                                      libc::c_uint)
                             as u8_0 as u32_0, 0x20 as libc::c_int,
    ...
    (*_g_5).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 = gFireTempleBigFireWallDL.as_mut_ptr() as libc::c_uint;
