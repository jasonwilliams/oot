...
extern "C" {
    #[no_mangle]
    fn EffectSs_DrawGEffect(globalCtx: *mut GlobalContext,
                            this: *mut EffectSs, texture: *mut libc::c_void);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gEffWaterSplash1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplash8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffWaterSplashDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_G_Splash_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_G_SPLASH as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGSplash_Init as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSplash_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              ...
                                              mut initParamsx:
                                                  *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsGSplashInitParams =
        initParamsx as *mut EffectSsGSplashInitParams;
    ...
    (*this).draw =
        Some(EffectSsGSplash_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsGSplash_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    if (*initParams).scale as libc::c_int == 0 as libc::c_int {
        (*initParams).scale = 600 as libc::c_int as s16
    }
    (*this).gfx =
        gSegments[((gEffWaterSplashDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffWaterSplashDL.as_mut_ptr() as
                                              u32_0 &
    ...
    (*this).regs[1 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[0 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[2 as libc::c_int as usize] = 100 as libc::c_int as s16;
    if (*initParams).customColor != 0 {
        ...
        (*this).regs[11 as libc::c_int as usize] = (*initParams).type_0 as s16
    } else {
        match (*initParams).type_0 as libc::c_int {
            0 => {
                (*this).regs[3 as libc::c_int as usize] =
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSplash_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    static mut waterSplashTextures: [*mut libc::c_void; 8] =
        unsafe {
            [gEffWaterSplash1Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash2Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash3Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash4Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash5Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash6Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash7Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffWaterSplash8Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut texIdx: s16 = 0;
    match (*this).regs[11 as libc::c_int as usize] as libc::c_int {
        0 => {
            texIdx =
            ...
            EffectSs_DrawGEffect(globalCtx, this,
                                 waterSplashTextures[texIdx as usize]);
        }
        1 => {
            texIdx =
                ((*this).regs[0 as libc::c_int as usize] as libc::c_int /
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGSplash_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    let mut newSplashPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).regs[11 as libc::c_int as usize] as libc::c_int ==
           1 as libc::c_int && (*this).life as libc::c_int == 5 as libc::c_int
       {
        newSplashPos = (*this).pos;
        newSplashPos.y +=
            ((*this).regs[1 as libc::c_int as usize] as libc::c_int *
                 20 as libc::c_int) as libc::c_float * 0.002f32;
        EffectSsGSplash_Spawn(globalCtx, &mut newSplashPos,
                              0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                              2 as libc::c_int as s16,
                              ((*this).regs[1 as libc::c_int as usize] as
                                   libc::c_int / 2 as libc::c_int) as s16);
    }
    (*this).regs[0 as libc::c_int as usize] =
        ((*this).regs[0 as libc::c_int as usize] as libc::c_int +
             (*this).regs[2 as libc::c_int as usize] as libc::c_int) as s16;
}
