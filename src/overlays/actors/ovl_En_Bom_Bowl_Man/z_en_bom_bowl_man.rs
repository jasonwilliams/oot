...
extern "C" {
    ...
    #[no_mangle]
    static mut gChuGirlWakeUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gChuGirlNoddingOffAnim: AnimationHeader;
    #[no_mangle]
    static mut gChuGirlEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gChuGirlEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gChuGirlEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gChuGirlSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gChuGirlLeanOverCounterAnim: AnimationHeader;
}
...
pub const TEXT_STATE_AWAITING_NEXT: C2RustUnnamed_19 = 10;
pub const TEXT_STATE_9: C2RustUnnamed_19 = 9;
pub const TEXT_STATE_8: C2RustUnnamed_19 = 8;
pub const TEXT_STATE_SONG_DEMO_DONE: C2RustUnnamed_19 = 7;
pub const TEXT_STATE_DONE: C2RustUnnamed_19 = 6;
pub const TEXT_STATE_EVENT: C2RustUnnamed_19 = 5;
pub const TEXT_STATE_CHOICE: C2RustUnnamed_19 = 4;
pub const TEXT_STATE_DONE_FADING: C2RustUnnamed_19 = 3;
pub const TEXT_STATE_CLOSING: C2RustUnnamed_19 = 2;
pub const TEXT_STATE_DONE_HAS_NEXT: C2RustUnnamed_19 = 1;
pub const TEXT_STATE_NONE: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnExItem {
    pub actor: Actor,
...
pub const EXITEM_BULLET_BAG: C2RustUnnamed_20 = 19;
pub const EXITEM_MAGIC_DARK: C2RustUnnamed_20 = 18;
pub const EXITEM_MAGIC_WIND: C2RustUnnamed_20 = 17;
pub const EXITEM_MAGIC_FIRE: C2RustUnnamed_20 = 16;
pub const EXITEM_SMALL_KEY_CHEST: C2RustUnnamed_20 = 15;
pub const EXITEM_14: C2RustUnnamed_20 = 14;
pub const EXITEM_13: C2RustUnnamed_20 = 13;
pub const EXITEM_RED_RUPEE_CHEST: C2RustUnnamed_20 = 12;
pub const EXITEM_BLUE_RUPEE_CHEST: C2RustUnnamed_20 = 11;
pub const EXITEM_GREEN_RUPEE_CHEST: C2RustUnnamed_20 = 10;
pub const EXITEM_PURPLE_RUPEE_COUNTER: C2RustUnnamed_20 = 9;
pub const EXITEM_BOMBS_COUNTER: C2RustUnnamed_20 = 8;
pub const EXITEM_BOMBCHUS_COUNTER: C2RustUnnamed_20 = 7;
pub const EXITEM_HEART_PIECE_COUNTER: C2RustUnnamed_20 = 6;
pub const EXITEM_BOMB_BAG_COUNTER: C2RustUnnamed_20 = 5;
pub const EXITEM_PURPLE_RUPEE_BOWLING: C2RustUnnamed_20 = 4;
pub const EXITEM_BOMBS_BOWLING: C2RustUnnamed_20 = 3;
pub const EXITEM_BOMBCHUS_BOWLING: C2RustUnnamed_20 = 2;
pub const EXITEM_HEART_PIECE_BOWLING: C2RustUnnamed_20 = 1;
pub const EXITEM_BOMB_BAG_BOWLING: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBomBowlPit {
    pub actor: Actor,
    pub actionFunc: EnBomBowlPitActionFunc,
    pub unk_150: u16_0,
    pub camId: s16,
    pub unk_154: s16,
    pub exItemDone: s16,
    ...
    pub unk_1C8: Vec3f,
    pub unk_1D4: Vec3f,
    pub exItem: *mut EnExItem,
    pub unk_1E4: [libc::c_char; 13600],
}
pub type EnBomBowlPitActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBomBowlPit, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBomBowlMan {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 11],
    pub morphTable: [Vec3s; 11],
    pub actionFunc: EnBomBowlManActionFunc,
    pub unk_218: Vec3s,
    pub unk_21E: [libc::c_char; 6],
    pub unk_224: Vec3s,
    pub prizeRevealTimer: s16,
    pub timer: s16,
    pub dialogState: s16,
    pub prizeIndex: s16,
    pub startedPlaying: s16,
    pub eyeTextureIndex: s16,
    pub blinkTimer: s16,
    pub eyeMode: s16,
    pub blinkCount: s16,
    pub playingAgain: s16,
    pub wallStatus: [s16; 2],
    pub prizeSelect: s16,
    pub gameResult: s16,
    pub posCopy: Vec3f,
    pub frameCount: f32_0,
    pub minigamePlayStatus: u8_0,
    pub bowlPit: *mut EnBomBowlPit,
    pub exItem: *mut EnExItem,
}
pub type EnBomBowlManActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBomBowlMan, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSyatekiNiw {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
    pub actionFunc: EnSyatekiNiwActionFunc,
    pub unk_254: s16,
    pub unk_256: s16,
    pub unk_258: s16,
    pub unk_25A: s16,
    ...
    pub unk_348: [EnSyatekiNiw_1; 5],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSyatekiNiw_1 {
    pub unk_00: u8_0,
    pub unk_04: Vec3f,
    pub unk_10: Vec3f,
    pub unk_1C: Vec3f,
...
pub type EnSyatekiNiwActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSyatekiNiw, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const CHU_GIRL_EYES_AWAKE: C2RustUnnamed_21 = 3;
pub const CHU_GIRL_EYES_BLINK_RAPIDLY: C2RustUnnamed_21 = 2;
pub const CHU_GIRL_EYES_OPEN_SLOWLY: C2RustUnnamed_21 = 1;
pub const CHU_GIRL_EYES_ASLEEP: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut En_Bom_Bowl_Man_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOM_BOWL_MAN as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BG as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBomBowlMan>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlMan_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlMan_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlMan_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlMan_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_Init(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    static mut cuccoColliderDims: [[f32_0; 3]; 2] =
        [[16.0f32, 46.0f32, 0.0f32], [36.0f32, 56.0f32, 0.0f32]];
    static mut cuccoSpawnPos: [Vec3f; 2] =
        [{
             let mut init =
                 Vec3f{x: 60 as libc::c_int as f32_0,
                       y: -(60 as libc::c_int) as f32_0,
                       z: -(430 as libc::c_int) as f32_0,};
             init
         },
         {
             let mut init =
                 Vec3f{x: 0 as libc::c_int as f32_0,
                       y: -(120 as libc::c_int) as f32_0,
                       z: -(620 as libc::c_int) as f32_0,};
             init
         }];
    static mut cuccoScales: [f32_0; 2] = [0.01f32, 0.03f32];
    let mut this: *mut EnBomBowlMan = thisx as *mut EnBomBowlMan;
    let mut cucco: *mut EnSyatekiNiw = 0 as *mut EnSyatekiNiw;
    let mut i: s32 = 0;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gChuGirlSkel,
                       &mut gChuGirlNoddingOffAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 11 as libc::c_int);
    // "☆ Man, my shoulders hurt~ ☆"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86 \xe3\x82\x82\xe3\x83\xbc \xe8\x82\xa9\xe3\x81\x93\xe3\x81\xa3\xe3\x81\xa1\xe3\x82\x83\xe3\x81\x86\xe3\x82\x88\xe3\x81\xad\xe3\x81\x87\xe3\x80\x9c \t\t \xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    // "☆ Isn't there some sort of job that will pay better and be more relaxing? ☆ %d"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86 \xe3\x82\x82\xe3\x81\xa3\xe3\x81\xa8\xe3\x83\xa9\xe3\x82\xaf\xe3\x81\x97\xe3\x81\xa6\xe3\x82\x82\xe3\x81\x86\xe3\x81\x8b\xe3\x82\x8b\xe3\x83\x90\xe3\x82\xa4\xe3\x83\x88\xe3\x81\xaa\xe3\x81\x84\xe3\x81\x8b\xe3\x81\x97\xe3\x82\x89\xef\xbc\x9f \xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*globalCtx).bombchuBowlingStatus as libc::c_int);
    (*this).posCopy = (*this).actor.world.pos;
    (*this).actor.shape.yOffset = -60.0f32;
    Actor_SetScale(&mut (*this).actor, 0.013f32);
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        cucco =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_SYATEKI_NIW as libc::c_int as s16,
                        cuccoSpawnPos[i as usize].x,
                        cuccoSpawnPos[i as usize].y,
                        cuccoSpawnPos[i as usize].z, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16,
                        1 as libc::c_int as s16) as *mut EnSyatekiNiw;
        if !cucco.is_null() {
            (*cucco).unk_2F4 = cuccoScales[i as usize];
            (*cucco).collider.dim.radius =
                cuccoColliderDims[i as usize][0 as libc::c_int as usize] as
                    s16;
            (*cucco).collider.dim.height =
                cuccoColliderDims[i as usize][1 as libc::c_int as usize] as
                    s16
        }
        i += 1
    }
    (*this).prizeSelect = Rand_ZeroFloat(4.99f32) as s16;
    (*this).actor.targetMode = 1 as libc::c_int as s8;
    (*this).actionFunc =
        Some(EnBomBowMan_SetupWaitAsleep as
                 unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_SetupWaitAsleep(mut this:
                                                         *mut EnBomBowlMan,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    (*this).frameCount =
        Animation_GetLastFrame(&mut gChuGirlNoddingOffAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gChuGirlNoddingOffAnim,
                     1.0f32, 0.0f32, (*this).frameCount,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.textId = 0xc0 as libc::c_int as u16_0;
    (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnBomBowMan_WaitAsleep as
                 unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_WaitAsleep(mut this: *mut EnBomBowlMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnBomBowMan_TalkAsleep as
                     unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                          _: *mut GlobalContext) -> ())
    } else {
        yawDiff =
        ...
        if !((*this).actor.xzDistToPlayer > 120.0f32) &&
               (yawDiff as libc::c_int) < 0x4300 as libc::c_int {
            func_8002F2CC(&mut (*this).actor, globalCtx, 120.0f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_TalkAsleep(mut this: *mut EnBomBowlMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).actionFunc =
            Some(EnBomBowMan_WakeUp as
                     unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_WakeUp(mut this: *mut EnBomBowlMan,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    (*this).frameCount =
        Animation_GetLastFrame(&mut gChuGirlWakeUpAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gChuGirlWakeUpAnim, 1.0f32,
                     0.0f32, (*this).frameCount,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).eyeMode = CHU_GIRL_EYES_OPEN_SLOWLY as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnBomBowMan_BlinkAwake as
                 unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_BlinkAwake(mut this: *mut EnBomBowlMan,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut frameCount: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frameCount == 30.0f32 {
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
        ...
        if gSaveContext.eventChkInf[2 as libc::c_int as usize] as libc::c_int
            ...
            (*this).actor.textId = 0xbf as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x7058 as libc::c_int as u16_0 }
    }
    Message_ContinueTextbox(globalCtx, (*this).actor.textId);
    if (*this).eyeTextureIndex as libc::c_int == 0 as libc::c_int &&
           (*this).eyeMode as libc::c_int ==
               CHU_GIRL_EYES_BLINK_RAPIDLY as libc::c_int &&
           (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
        // Blink twice, then move on
        (*this).eyeTextureIndex = 2 as libc::c_int as s16;
        (*this).blinkCount += 1;
        if (*this).blinkCount as libc::c_int >= 3 as libc::c_int {
            (*this).actionFunc =
                Some(EnBomBowMan_CheckBeatenDC as
                         unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_CheckBeatenDC(mut this:
                                                       *mut EnBomBowlMan,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).frameCount =
            Animation_GetLastFrame(&mut gChuGirlLeanOverCounterAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0;
        Animation_Change(&mut (*this).skelAnime,
                         &mut gChuGirlLeanOverCounterAnim, 1.0f32, 0.0f32,
                         (*this).frameCount,
                         ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
        (*this).eyeMode = CHU_GIRL_EYES_AWAKE as libc::c_int as s16;
        (*this).blinkTimer =
        ...
        if !(gSaveContext.eventChkInf[2 as libc::c_int as usize] as
            ...
            (*this).actionFunc =
                Some(EnBomBowMan_WaitNotBeatenDC as
                         unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actor.textId = 0x18 as libc::c_int as u16_0;
            (*this).dialogState = TEXT_STATE_CHOICE as libc::c_int as s16;
            Message_ContinueTextbox(globalCtx, (*this).actor.textId);
            (*this).actionFunc =
                Some(EnBomBowlMan_HandlePlayChoice as
                         unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_WaitNotBeatenDC(mut this:
                                                         *mut EnBomBowlMan,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnBomBowMan_TalkNotBeatenDC as
                     unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                          _: *mut GlobalContext) -> ())
    } else { func_8002F2CC(&mut (*this).actor, globalCtx, 120.0f32); };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_TalkNotBeatenDC(mut this:
                                                         *mut EnBomBowlMan,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_SetupRunGame(mut this: *mut EnBomBowlMan,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).minigamePlayStatus as libc::c_int == 0 as libc::c_int {
        if (*this).startedPlaying == 0 {
            (*this).actor.textId = 0x18 as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x1a as libc::c_int as u16_0 }
        (*this).dialogState = TEXT_STATE_CHOICE as libc::c_int as s16
    } else {
        (*this).actor.textId = 0x19 as libc::c_int as u16_0;
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16
    }
    (*this).actionFunc =
        Some(EnBomBowMan_RunGame as
                 unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_RunGame(mut this: *mut EnBomBowlMan,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut yawDiff: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
           ...
           != 0 {
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86 game_play->bomchu_game_flag \xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*globalCtx).bombchuBowlingStatus as libc::c_int);
        // "HOW'S THE FIRST WALL DOING?"
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86 \xe5\xa3\x81\xef\xbc\x91\xe3\x81\xae\xe7\x8a\xb6\xe6\x85\x8b\xe3\x81\xa9\xe3\x81\x86\xef\xbc\x9f \xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).wallStatus[0 as libc::c_int as usize] as
                         libc::c_int);
        // "HOW'S THE SECOND WALL DOING?"
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86 \xe5\xa3\x81\xef\xbc\x92\xe3\x81\xae\xe7\x8a\xb6\xe6\x85\x8b\xe3\x81\xa9\xe3\x81\x86\xef\xbc\x9f \xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).wallStatus[1 as libc::c_int as usize] as
                         libc::c_int);
        // "HOLE INFORMATION"
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86 \xe7\xa9\xb4\xe6\x83\x85\xe5\xa0\xb1\t     \xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*(*this).bowlPit).status as libc::c_int); // Won
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    }
    (*this).gameResult = 0 as libc::c_int as s16;
    if !(*this).bowlPit.is_null() {
        if (*this).wallStatus[0 as libc::c_int as usize] as libc::c_int !=
               1 as libc::c_int &&
               (*this).wallStatus[1 as libc::c_int as usize] as libc::c_int !=
                   1 as libc::c_int &&
               (*(*this).bowlPit).status as libc::c_int == 2 as libc::c_int {
            (*this).gameResult = 1 as libc::c_int as s16;
            (*(*this).bowlPit).status = 0 as libc::c_int as u8_0;
            // "Center HIT!"
            osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xb8\xad\xe5\xa4\xae\xef\xbc\xa8\xef\xbc\xa9\xef\xbc\xb4\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char); // Lost
        }
        if (*globalCtx).bombchuBowlingStatus as libc::c_int ==
               ...
               (*globalCtx).actorCtx.actorLists[ACTORCAT_EXPLOSIVE as
                                                    ...
                                                    usize].length ==
                   0 as libc::c_int &&
               (*(*this).bowlPit).status as libc::c_int == 0 as libc::c_int &&
               (*this).wallStatus[0 as libc::c_int as usize] as libc::c_int !=
                   1 as libc::c_int &&
               (*this).wallStatus[1 as libc::c_int as usize] as libc::c_int !=
                   1 as libc::c_int {
            (*this).gameResult = 2 as libc::c_int as s16;
            // "Bombchu lost"
            osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x9c\xe3\x83\xa0\xe3\x83\x81\xe3\x83\xa5\xe3\x82\xa6\xe6\xb6\x88\xe5\x8c\x96 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        }
    }
    if (*this).gameResult as libc::c_int != 0 as libc::c_int {
        // won or lost
        (*this).actor.textId = 0x1a as libc::c_int as u16_0;
        (*this).dialogState = TEXT_STATE_CHOICE as libc::c_int as s16;
        (*this).minigamePlayStatus = 0 as libc::c_int as u8_0;
        if !(*this).exItem.is_null() &&
               (*(*this).exItem).actor.update.is_some() {
            (*(*this).exItem).killItem = 1 as libc::c_int as s16;
            (*this).exItem = 0 as *mut EnExItem
        }
        (*globalCtx).bombchuBowlingStatus = 0 as libc::c_int as s8;
        (*this).playingAgain = 1 as libc::c_int as s16;
        Message_StartTextbox(globalCtx, (*this).actor.textId,
                             0 as *mut Actor);
        if (*this).gameResult as libc::c_int == 2 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_HandlePlayChoice(mut this:
                                                           *mut EnBomBowlMan,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if gSaveContext.rupees as libc::c_int >= 30 as libc::c_int {
                    ...
                    (*this).minigamePlayStatus = 1 as libc::c_int as u8_0;
                    (*this).wallStatus[1 as libc::c_int as usize] =
                        0 as libc::c_int as s16;
                    (*this).wallStatus[0 as libc::c_int as usize] =
                        (*this).wallStatus[1 as libc::c_int as usize];
                    (*globalCtx).bombchuBowlingStatus =
                        10 as libc::c_int as s8;
                    Flags_SetSwitch(globalCtx, 0x38 as libc::c_int);
                    if (*this).startedPlaying == 0 &&
                           (*this).playingAgain == 0 {
                        (*this).actor.textId = 0x19 as libc::c_int as u16_0;
                        Message_ContinueTextbox(globalCtx,
                                                (*this).actor.textId);
                        (*this).dialogState =
                            TEXT_STATE_EVENT as libc::c_int as s16;
                        (*this).actionFunc =
                            Some(func_809C41FC as
                                     unsafe extern "C" fn(_:
                                                              *mut EnBomBowlMan,
                        ...
                        (*this).actor.textId = 0x1b as libc::c_int as u16_0;
                        Message_ContinueTextbox(globalCtx,
                                                (*this).actor.textId);
                        (*this).dialogState =
                            TEXT_STATE_EVENT as libc::c_int as s16;
                        OnePointCutscene_Init(globalCtx,
                                              8010 as libc::c_int as s16,
                        ...
                        func_8002DF54(globalCtx, 0 as *mut Actor,
                                      8 as libc::c_int as u8_0);
                        (*this).actionFunc =
                            Some(EnBomBowMan_SetupChooseShowPrize as
                                     unsafe extern "C" fn(_:
                                                              *mut EnBomBowlMan,
                                                          _:
                                                              *mut GlobalContext)
                    ...
                    (*this).playingAgain = 0 as libc::c_int as s16;
                    (*this).actor.textId = 0x85 as libc::c_int as u16_0;
                    Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                    (*this).dialogState =
                        TEXT_STATE_EVENT as libc::c_int as s16;
                    (*this).actionFunc =
            ...
            1 => {
                // No
                (*this).playingAgain = 0 as libc::c_int as s16;
                (*this).actor.textId = 0x2d as libc::c_int as u16_0;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_809C41FC as
...
#[no_mangle]
pub unsafe extern "C" fn func_809C41FC(mut this: *mut EnBomBowlMan,
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_CloseTextbox(globalCtx);
        if ((*this).actor.textId as libc::c_int == 0x2d as libc::c_int ||
                (*this).actor.textId as libc::c_int == 0x85 as libc::c_int) &&
               Flags_GetSwitch(globalCtx, 0x38 as libc::c_int) != 0 {
            Flags_UnsetSwitch(globalCtx, 0x38 as libc::c_int);
        }
        if (*this).minigamePlayStatus as libc::c_int == 1 as libc::c_int {
            (*this).actor.textId = 0x1b as libc::c_int as u16_0;
            Message_ContinueTextbox(globalCtx, (*this).actor.textId);
            (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
            OnePointCutscene_Init(globalCtx, 8010 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
            ...
            (*this).actionFunc =
                Some(EnBomBowMan_SetupRunGame as
                         unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_SetupChooseShowPrize(mut this:
                                                              *mut EnBomBowlMan,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut accel: Vec3f =
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        pos.y = 40.0f32;
        pos.z = 300.0f32;
        EffectSsBomb2_SpawnLayered(globalCtx, &mut pos, &mut velocity,
                                   &mut accel, 50 as libc::c_int as s16,
                                   15 as libc::c_int as s16);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x184b as libc::c_int as u16_0);
        (*this).prizeRevealTimer = 10 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnBomBowMan_ChooseShowPrize as
                     unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                          _: *mut GlobalContext) -> ())
    };
}
static mut sPrizePosOffset: [Vec3f; 5] =
    [{ let mut init = Vec3f{x: 0.0f32, y: 22.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 22.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 8.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 9.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: -2.0f32, z: 0.0f32,}; init }];
static mut sPrizeRot: [s16; 6] =
    [0x4268 as libc::c_int as s16, 0x4268 as libc::c_int as s16,
     -(0x3e8 as libc::c_int) as s16, 0 as libc::c_int as s16,
     0x4268 as libc::c_int as s16, 0 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn EnBomBowMan_ChooseShowPrize(mut this:
                                                         *mut EnBomBowlMan,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut prizeTemp: s16 = 0;
    let mut pad: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).prizeRevealTimer as libc::c_int == 0 as libc::c_int {
        match (*this).prizeSelect as libc::c_int {
            0 => {
                prizeTemp = EXITEM_BOMB_BAG_BOWLING as libc::c_int as s16;
                if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
                       libc::c_int & 2 as libc::c_int != 0 {
                    prizeTemp =
                        EXITEM_PURPLE_RUPEE_BOWLING as libc::c_int as s16
                }
            }
            1 => {
                prizeTemp = EXITEM_PURPLE_RUPEE_BOWLING as libc::c_int as s16
            }
            2 => { prizeTemp = EXITEM_BOMBCHUS_BOWLING as libc::c_int as s16 }
            3 => {
                prizeTemp = EXITEM_HEART_PIECE_BOWLING as libc::c_int as s16;
                if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
            ...
            4 => { prizeTemp = EXITEM_BOMBS_BOWLING as libc::c_int as s16 }
            _ => { }
        }
        ...
        (*this).exItem =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               ...
                               sPrizePosOffset[(*this).prizeIndex as usize].x
                                   + 148.0f32,
                               sPrizePosOffset[(*this).prizeIndex as usize].y
                                   + 40.0f32,
                               sPrizePosOffset[(*this).prizeIndex as usize].z
                                   + 300.0f32, 0 as libc::c_int as s16,
                               sPrizeRot[(*this).prizeIndex as usize],
                               0 as libc::c_int as s16,
                               ((*this).prizeIndex as libc::c_int +
                                    5 as libc::c_int) as s16) as
                *mut EnExItem;
        if (*this).startedPlaying == 0 {
            (*this).bowlPit =
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx,
                                   ACTOR_EN_BOM_BOWL_PIT as libc::c_int as
                                       s16, 0.0f32, 90.0f32, -860.0f32,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
        ...
        } else { (*(*this).bowlPit).prizeIndex = (*this).prizeIndex }
        (*(*this).bowlPit).start = 1 as libc::c_int as s16;
        (*this).minigamePlayStatus = 2 as libc::c_int as u8_0;
        (*this).actor.textId = 0x405a as libc::c_int as u16_0;
        Message_ContinueTextbox(globalCtx, (*this).actor.textId);
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
        // Cycle through prizes in order
        (*this).prizeSelect += 1;
        if (*this).prizeSelect as libc::c_int >= 5 as libc::c_int {
            (*this).prizeSelect = 0 as libc::c_int as s16
        }
        (*this).actionFunc =
            Some(EnBomBowlMan_BeginPlayGame as
                     unsafe extern "C" fn(_: *mut EnBomBowlMan,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_BeginPlayGame(mut this:
                                                        *mut EnBomBowlMan,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8005B1A4((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                  usize]);
        (*this).startedPlaying = 1 as libc::c_int as s16;
        if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 2 as libc::c_int) as
                                 usize] != 0 {
            (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        // "Wow"
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86 \xe3\x82\x8f\xe3\x83\xbc \xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*globalCtx).bombchuBowlingStatus as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnBomBowlMan = thisx as *mut EnBomBowlMan;
    (*this).timer += 1;
    ...
    match (*this).eyeMode as libc::c_int {
        0 => { (*this).eyeTextureIndex = 2 as libc::c_int as s16 }
        1 => {
            if (*this).eyeTextureIndex as libc::c_int > 0 as libc::c_int {
                (*this).eyeTextureIndex -= 1
            } else {
                (*this).blinkTimer = 30 as libc::c_int as s16;
                (*this).eyeMode =
                    CHU_GIRL_EYES_BLINK_RAPIDLY as libc::c_int as s16
            }
        }
        2 => {
            if (*this).blinkTimer as libc::c_int == 0 as libc::c_int &&
                   (*this).eyeTextureIndex as libc::c_int > 0 as libc::c_int {
                (*this).eyeTextureIndex -= 1
            }
        }
        _ => {
            if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
                (*this).eyeTextureIndex += 1;
                if (*this).eyeTextureIndex as libc::c_int >= 3 as libc::c_int
                   {
            ...
            func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_218,
                          &mut (*this).unk_224, (*this).actor.focus.pos);
        }
    }
    if (*this).prizeRevealTimer as libc::c_int == 0 as libc::c_int {
    } else { (*this).prizeRevealTimer -= 1 };
    if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
    } else { (*this).blinkTimer -= 1 };
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_OverrideLimbDraw(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut limbIndex: s32,
                                                       mut dList:
                                                           *mut *mut Gfx,
 ...
 -> s32 {
    ...
    if limbIndex == 4 as libc::c_int {
        // head
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_218.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_218.z as libc::c_int) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlMan_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gChuGirlEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gChuGirlEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gChuGirlEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnBomBowlMan = thisx as *mut EnBomBowlMan;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bom_bowl_man.c\x00" as *const u8 as
                        *const libc::c_char, 907 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((eyeTextures[(*this).eyeTextureIndex as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(eyeTextures[(*this).eyeTextureIndex
                                                          as usize] as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnBomBowlMan_OverrideLimbDraw as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bom_bowl_man.c\x00" as *const u8 as
                         *const libc::c_char, 923 as libc::c_int);
}
