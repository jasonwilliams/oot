...
extern "C" {
    ...
    #[no_mangle]
    static mut gJabuBlueFloorSwitchDL: [Gfx; 0];
    #[no_mangle]
    static mut gJabuFloorSwitchCol: CollisionHeader;
    #[no_mangle]
    static mut gJabuYellowFloorSwitchDL: [Gfx; 0];
}
...
pub const YELLOW_TALL_2: C2RustUnnamed_23 = 4;
pub const YELLOW_TALL_1: C2RustUnnamed_23 = 3;
pub const YELLOW: C2RustUnnamed_23 = 2;
pub const YELLOW_HEAVY: C2RustUnnamed_23 = 1;
pub const BLUE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgBdanSwitch {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgBdanSwitchActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub unk_1C8: f32_0,
    pub unk_1CC: s16,
    pub unk_1CE: [libc::c_char; 2],
    pub unk_1D0: f32_0,
    pub unk_1D4: f32_0,
    pub unk_1D8: s16,
    pub unk_1DA: s16,
    pub unk_1DC: u8_0,
    pub unk_1DD: [libc::c_char; 3],
}
pub type BgBdanSwitchActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgBdanSwitch, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Bdan_Switch_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BDAN_SWITCH as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgBdanSwitch>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanSwitch_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanSwitch_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanSwitch_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanSwitch_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_8086E0E0: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 140.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_InitDynaPoly(mut this:
                                                       *mut BgBdanSwitch,
                                                   mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_bdan_switch.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_InitCollision(mut this:
                                                        *mut BgBdanSwitch,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut actor: *mut Actor = &mut (*this).dyna.actor;
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider, actor,
                       &mut sJntSphInit, (*this).colliderItems.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D0EC(mut this: *mut BgBdanSwitch) {
    if (*this).unk_1CC as libc::c_int > 0 as libc::c_int {
        (*this).unk_1CC =
            ((*this).unk_1CC as libc::c_int + 0x5dc as libc::c_int) as s16
    } else {
        (*this).unk_1CC =
            ((*this).unk_1CC as libc::c_int + 0xfa0 as libc::c_int) as s16
    }
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        0 | 1 | 2 => {
            (*this).unk_1D4 =
                (Math_CosS((*this).unk_1CC) * 0.5f32 + 53.000004f32 / 6.0f32)
                    * 0.012f32;
            (*this).unk_1D0 =
                (Math_CosS((*this).unk_1CC) * 0.5f32 + 20.5f32) *
                    ((*this).unk_1C8 * 0.0050000004f32);
            (*this).dyna.actor.scale.y = (*this).unk_1C8 * 0.1f32
        }
        3 | 4 => {
            (*this).unk_1D4 =
                (Math_CosS((*this).unk_1CC) * 0.5f32 + 43.0f32 / 6.0f32) *
                    0.0075000003f32;
            (*this).unk_1D0 =
                (Math_CosS((*this).unk_1CC) * 0.5f32 + 20.5f32) *
                    ((*this).unk_1C8 * 0.0050000004f32);
    ...
    (*this).dyna.actor.shape.yOffset = 1.2f32 / (*this).unk_1D0;
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgBdanSwitch = thisx as *mut BgBdanSwitch;
    let mut pad: s32 = 0;
    let mut type_0: s16 = 0;
    let mut flag: s32 = 0;
    type_0 =
        ((*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int) as
            s16;
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
    if type_0 as libc::c_int == YELLOW_TALL_1 as libc::c_int ||
           type_0 as libc::c_int == YELLOW_TALL_2 as libc::c_int {
        (*this).dyna.actor.scale.z = 0.05f32;
        (*this).dyna.actor.scale.x = 0.05f32
    } else {
        (*this).dyna.actor.scale.z = 0.1f32;
        (*this).dyna.actor.scale.x = 0.1f32
    }
    (*this).dyna.actor.scale.y = 0.0f32;
    Actor_SetFocus(&mut (*this).dyna.actor, 10.0f32);
    match type_0 as libc::c_int {
        0 | 1 | 2 => {
            BgBdanSwitch_InitDynaPoly(this, globalCtx,
                                      &mut gJabuFloorSwitchCol,
    ...
    match type_0 as libc::c_int {
        0 | 2 => {
            if flag != 0 {
                func_8086D730(this);
            } else { func_8086D5C4(this); }
        }
        1 => {
            if flag != 0 {
                func_8086DB24(this);
            } else { func_8086D86C(this); }
        }
        3 | 4 => {
            if flag != 0 {
                func_8086DCCC(this);
            } else { func_8086DB4C(this); }
        }
        _ => {
            osSyncPrintf(b"\xe4\xb8\x8d\xe6\xad\xa3\xe3\x81\xaa ARG_DATA(arg_data 0x%04x)(%s %d)\n\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).dyna.actor.params as libc::c_int,
                         b"../z_bg_bdan_switch.c\x00" as *const u8 as
                             *const libc::c_char, 454 as libc::c_int);
            Actor_Kill(&mut (*this).dyna.actor);
            return
        }
    }
    osSyncPrintf(b"(\xe5\xb7\xa8\xe5\xa4\xa7\xe9\xad\x9a\xe3\x83\x80\xe3\x83\xb3\xe3\x82\xb8\xe3\x83\xa7\xe3\x83\xb3 \xe5\xb0\x82\xe7\x94\xa8\xe3\x82\xb9\xe3\x82\xa4\xe3\x83\x83\xe3\x83\x81)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgBdanSwitch = thisx as *mut BgBdanSwitch;
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        ...
        3 | 4 => { Collider_DestroyJntSph(globalCtx, &mut (*this).collider); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D4B4(mut this: *mut BgBdanSwitch,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        type_0 =
            (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int;
        Flags_SetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int);
        if type_0 == BLUE as libc::c_int ||
               type_0 == YELLOW_TALL_2 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D548(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0x3f as libc::c_int) != 0 {
        Flags_UnsetSwitch(globalCtx,
                          (*this).dyna.actor.params as libc::c_int >>
                              8 as libc::c_int & 0x3f as libc::c_int);
        if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
               YELLOW_TALL_2 as libc::c_int {
            OnePointCutscene_AttentionSetSfx(globalCtx,
                                             &mut (*this).dyna.actor,
                                             0x4807 as libc::c_int);
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D5C4(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D5E0 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1C8 = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D5E0(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        0 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D67C(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D694 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1DA = 0x64 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D694(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).unk_1DA as libc::c_int <= 0 as libc::c_int {
        (*this).unk_1C8 -= 0.2f32;
        if (*this).unk_1C8 <= 0.1f32 {
            func_8086D730(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D730(mut this: *mut BgBdanSwitch) {
    (*this).unk_1C8 = 0.1f32;
    (*this).actionFunc =
        Some(func_8086D754 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1D8 = 6 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D754(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        0 => {
            if func_800435B4(&mut (*this).dyna) == 0 {
                if (*this).unk_1D8 as libc::c_int <= 0 as libc::c_int {
                    func_8086D7FC(this);
                    func_8086D548(this, globalCtx);
                }
            } else { (*this).unk_1D8 = 6 as libc::c_int as s16 }
        }
        2 => {
            if Flags_GetSwitch(globalCtx,
                               (*this).dyna.actor.params as libc::c_int >>
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D7FC(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D80C as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D80C(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_1C8 += 0.2f32;
    if (*this).unk_1C8 >= 1.0f32 {
        func_8086D5C4(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x2815 as libc::c_int as u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D86C(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D888 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1C8 = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D888(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 { func_8086D8BC(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D8BC(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D8CC as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D8CC(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_1C8 -= 0.2f32;
    if (*this).unk_1C8 <= 0.6f32 {
        func_8086D9F8(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x2815 as libc::c_int as u16_0);
        func_800AA000((*this).dyna.actor.xyzDistToPlayerSq,
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D944(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086D95C as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1DA = 0x64 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086D95C(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).unk_1DA as libc::c_int <= 0 as libc::c_int {
        (*this).unk_1C8 -= 0.2f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_8086D9F8(mut this: *mut BgBdanSwitch) {
    (*this).unk_1C8 = 0.6f32;
    (*this).actionFunc =
        Some(func_8086DA1C as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1D8 = 6 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DA1C(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    let mut heldActor: *mut Actor =
        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                usize].head as
               *mut Player)).heldActor;
    if func_8004356C(&mut (*this).dyna) != 0 {
        if !heldActor.is_null() &&
               (*heldActor).id as libc::c_int == ACTOR_EN_RU1 as libc::c_int {
            if (*this).unk_1D8 as libc::c_int <= 0 as libc::c_int {
                func_8086D944(this);
                func_8086D4B4(this, globalCtx);
            }
        } else { (*this).unk_1D8 = 6 as libc::c_int as s16 }
    } else if (*this).unk_1D8 as libc::c_int <= 0 as libc::c_int {
        func_8086DAB4(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DAB4(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086DAC4 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DAC4(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_1C8 += 0.2f32;
    if (*this).unk_1C8 >= 1.0f32 {
        func_8086D86C(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_8086DB24(mut this: *mut BgBdanSwitch) {
    (*this).unk_1C8 = 0.1f32;
    (*this).actionFunc =
        Some(func_8086DB40 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DB40(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DB4C(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086DB68 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1C8 = 2.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DB68(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        3 => {
            if (*this).collider.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 as libc::c_int
                   && (*this).unk_1D8 as libc::c_int <= 0 as libc::c_int {
                (*this).unk_1D8 = 0xa as libc::c_int as s16;
                func_8086DC30(this);
                func_8086D4B4(this, globalCtx);
            }
        }
        4 => {
            if (*this).collider.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 as libc::c_int
                   &&
                   (*this).unk_1DC as libc::c_int & 2 as libc::c_int ==
                       0 as libc::c_int &&
                   (*this).unk_1D8 as libc::c_int <= 0 as libc::c_int {
                (*this).unk_1D8 = 0xa as libc::c_int as s16;
                func_8086DC30(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_8086DC30(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086DC48 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1DA = 0x64 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DC48(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).unk_1DA as libc::c_int <= 0 as libc::c_int {
        (*this).unk_1C8 -= 0.3f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_8086DCCC(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086DCE8 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1C8 = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DCE8(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        3 => {
            if Flags_GetSwitch(globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn func_8086DDA8(mut this: *mut BgBdanSwitch) {
    (*this).actionFunc =
        Some(func_8086DDC0 as
                 unsafe extern "C" fn(_: *mut BgBdanSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_1DA = 0x64 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086DDC0(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int !=
           YELLOW_TALL_2 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgBdanSwitch = thisx as *mut BgBdanSwitch;
    ...
    func_8086D0EC(this);
    type_0 = (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_8086DF58(mut this: *mut BgBdanSwitch,
                                       mut globalCtx: *mut GlobalContext,
                                       mut dlist: *mut Gfx) {
    func_800D1694((*this).dyna.actor.world.pos.x,
                  (*this).dyna.actor.world.pos.y +
                      (*this).dyna.actor.shape.yOffset * (*this).unk_1D0,
                  (*this).dyna.actor.world.pos.z,
                  &mut (*this).dyna.actor.shape.rot);
    Matrix_Scale((*this).unk_1D4, (*this).unk_1D0, (*this).unk_1D4,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Gfx_DrawDListOpa(globalCtx, dlist);
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanSwitch_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgBdanSwitch = thisx as *mut BgBdanSwitch;
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        1 | 2 => {
            func_8086DF58(this, globalCtx,
                          gJabuYellowFloorSwitchDL.as_mut_ptr());
        }
        3 | 4 => {
            func_8086DF58(this, globalCtx,
                          gJabuYellowFloorSwitchDL.as_mut_ptr());
            Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).collider);
            Matrix_MultVec3f(&mut D_8086E0E0,
                             &mut (*this).dyna.actor.focus.pos);
        }
        0 => {
            func_8086DF58(this, globalCtx,
                          gJabuBlueFloorSwitchDL.as_mut_ptr());
        }
        _ => { }
    };
}
