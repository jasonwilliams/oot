...
extern "C" {
    ...
    #[no_mangle]
    static mut gGoronCityStatueSpearDL: [Gfx; 0];
    #[no_mangle]
    static mut gGoronCityStatueSpearCol: CollisionHeader;
    #[no_mangle]
    static mut gGoronCityStatueDL: [Gfx; 0];
    #[no_mangle]
    static mut gGoronCityStatueCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot18Obj {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot18ObjActionFunc,
    pub unk_168: s16,
}
pub type BgSpot18ObjActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot18Obj, _: *mut GlobalContext)
               -> ()>;
pub type BgSpot18ObjInitFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot18Obj, _: *mut GlobalContext)
               -> s32>;
#[no_mangle]
pub static mut Bg_Spot18_Obj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT18_OBJ as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT18_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot18Obj>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Obj_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Obj_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Obj_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Obj_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B90F0: [[u8_0; 2]; 2] =
    [[0x1 as libc::c_int as u8_0, 0x1 as libc::c_int as u8_0],
     [0x1 as libc::c_int as u8_0, 0 as libc::c_int as u8_0]];
static mut D_808B90F4: [f32_0; 2] = [0.1f32, 0.1f32];
static mut D_808B90FC: [*mut CollisionHeader; 2] =
    unsafe {
        [&gGoronCityStatueCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gGoronCityStatueSpearCol as *const CollisionHeader as
             *mut CollisionHeader]
    };
static mut D_808B9104: [u32_0; 2] =
    [0 as libc::c_int as u32_0, 0 as libc::c_int as u32_0];
static mut D_808B910C: [BgSpot18ObjInitFunc; 4] =
    unsafe {
        [Some(func_808B8A98 as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B8910 as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B8A5C as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B8B08 as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32)]
    };
// Initialized in run_static_initializers
static mut sInitChain1: [InitChainEntry; 5] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 5];
// Initialized in run_static_initializers
static mut sInitChain2: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
static mut D_808B913C: [BgSpot18ObjInitFunc; 2] =
    unsafe {
        [Some(func_808B8BB4 as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B8C90 as
                  unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                       _: *mut GlobalContext) -> s32)]
    };
static mut sDlists: [*mut Gfx; 2] =
    unsafe {
        [gGoronCityStatueDL.as_ptr() as *mut _,
         gGoronCityStatueSpearDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn func_808B8910(mut this: *mut BgSpot18Obj,
 ...
 -> s32 {
    ...
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        age = 1 as libc::c_int
    } else if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
                   5 as libc::c_int
               } else { 17 as libc::c_int }) == 5 as libc::c_int {
        age = 0 as libc::c_int
    } else {
        osSyncPrintf(b"Error : \xe3\x83\xaa\xe3\x83\xb3\xe3\x82\xaf\xe5\xb9\xb4\xe9\xbd\xa2\xe4\xb8\x8d\xe8\xa9\xb3 (%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_spot18_obj.c\x00" as *const u8 as
                         *const libc::c_char, 182 as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
        return 0 as libc::c_int
    }
    match D_808B90F0[((*this).dyna.actor.params as libc::c_int &
                          0xf as libc::c_int) as usize][age as usize] as
              libc::c_int {
        0 | 1 => {
            if D_808B90F0[((*this).dyna.actor.params as libc::c_int &
                               0xf as libc::c_int) as usize][age as usize] as
                   libc::c_int == 0 as libc::c_int {
                osSyncPrintf(b"\xe5\x87\xba\xe7\x8f\xbe\xe3\x81\x97\xe3\x81\xaa\xe3\x81\x84 Object (0x%04x)\n\x00"
                                 as *const u8 as *const libc::c_char,
                             (*this).dyna.actor.params as libc::c_int);
            }
            return D_808B90F0[((*this).dyna.actor.params as libc::c_int &
                                   0xf as libc::c_int) as usize][age as usize]
                       as s32
        }
        2 => {
            osSyncPrintf(b"Error : Obj\xe5\x87\xba\xe7\x8f\xbe\xe5\x88\xa4\xe5\xae\x9a\xe3\x81\x8c\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_bg_spot18_obj.c\x00" as *const u8 as
        ...
        _ => {
            osSyncPrintf(b"Error : Obj\xe5\x87\xba\xe7\x8f\xbe\xe5\x88\xa4\xe5\xae\x9a\xe5\xa4\xb1\xe6\x95\x97(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_bg_spot18_obj.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8A5C(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    Actor_SetScale(&mut (*this).dyna.actor,
                   D_808B90F4[((*this).dyna.actor.params as libc::c_int &
                                   0xf as libc::c_int) as usize]);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8A98(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    CollisionHeader_GetVirtual(D_808B90FC[((*this).dyna.actor.params as
                                               libc::c_int &
                                               0xf as libc::c_int) as usize]
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8B08(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    (*this).dyna.actor.flags |=
        D_808B9104[((*this).dyna.actor.params as libc::c_int &
                        0xf as libc::c_int) as usize];
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8B38(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[BgSpot18ObjInitFunc; 4]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<BgSpot18ObjInitFunc>()
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8BB4(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain1.as_mut_ptr());
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
            5 as libc::c_int
        } else { 17 as libc::c_int }) == 5 as libc::c_int {
        func_808B9030(this);
                                  ...
                                  8 as libc::c_int & 0x3f as libc::c_int) != 0
     {
        ...
        (*this).dyna.actor.world.pos.x =
            Math_SinS((*this).dyna.actor.world.rot.y) * 80.0f32 +
                (*this).dyna.actor.home.pos.x;
        (*this).dyna.actor.world.pos.z =
            Math_CosS((*this).dyna.actor.world.rot.y) * 80.0f32 +
                (*this).dyna.actor.home.pos.z
    } else { func_808B8E64(this); }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8C90(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain2.as_mut_ptr());
    func_808B8DC0(this);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8CC8(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if D_808B913C[((*this).dyna.actor.params as libc::c_int &
                       0xf as libc::c_int) as usize].is_some() &&
           D_808B913C[((*this).dyna.actor.params as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Obj_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgSpot18Obj = thisx as *mut BgSpot18Obj;
    osSyncPrintf(b"Spot18 Object [arg_data : 0x%04x]\n\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
    if func_808B8B38(this, globalCtx) == 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    } else if func_808B8CC8(this, globalCtx) == 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Obj_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot18Obj = thisx as *mut BgSpot18Obj;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8DC0(mut this: *mut BgSpot18Obj) {
    (*this).actionFunc =
        Some(func_808B8DD0 as
                 unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8DD0(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8DDC(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor, 20.0f32,
                            46.0f32, 0.0f32, 28 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8E20(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8E64(mut this: *mut BgSpot18Obj) {
    (*this).unk_168 = 20 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_808B8E7C as
                 unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8E7C(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).dyna.unk_150 < -0.001f32 {
        if (*this).unk_168 as libc::c_int <= 0 as libc::c_int {
            func_808B8EE0(this);
        }
    } else { (*this).unk_168 = 20 as libc::c_int as s16 }
    func_808B8E20(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B8EE0(mut this: *mut BgSpot18Obj) {
    (*this).actionFunc =
        Some(func_808B8F08 as
                 unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_808B8F08(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Math_StepToF(&mut (*this).dyna.actor.speedXZ, 1.2f32, 0.1f32);
    Actor_MoveForward(&mut (*this).dyna.actor);
    func_808B8DDC(this, globalCtx);
    if Math3D_Dist2DSq((*this).dyna.actor.world.pos.x,
                       (*this).dyna.actor.world.pos.z,
                       (*this).dyna.actor.home.pos.x,
                       (*this).dyna.actor.home.pos.z) >= 6400.0f32 {
        func_808B9030(this);
        (*this).dyna.actor.world.pos.x =
            Math_SinS((*this).dyna.actor.world.rot.y) * 80.0f32 +
                (*this).dyna.actor.home.pos.x;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B9030(mut this: *mut BgSpot18Obj) {
    (*this).actionFunc =
        Some(func_808B9040 as
                 unsafe extern "C" fn(_: *mut BgSpot18Obj,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B9040(mut this: *mut BgSpot18Obj,
                                       mut globalCtx: *mut GlobalContext) {
    func_808B8E20(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Obj_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot18Obj = thisx as *mut BgSpot18Obj;
    if (*this).unk_168 as libc::c_int > 0 as libc::c_int {
        (*this).unk_168 =
            ((*this).unk_168 as libc::c_int - 1 as libc::c_int) as s16
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Obj_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx,
                     sDlists[((*thisx).params as libc::c_int &
                                  0xf as libc::c_int) as usize]);
}
