...
extern "C" {
    ...
    #[no_mangle]
    static mut object_bigokuta_Anim_000444: AnimationHeader;
    #[no_mangle]
    static mut object_bigokuta_Anim_000A74: AnimationHeader;
    #[no_mangle]
    static mut object_bigokuta_Anim_000D1C: AnimationHeader;
    #[no_mangle]
    static mut object_bigokuta_Anim_0014B8: AnimationHeader;
    #[no_mangle]
    static mut object_bigokuta_Anim_001CA4: AnimationHeader;
    #[no_mangle]
    static mut object_bigokuta_Skel_006BC0: FlexSkeletonHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBigokuta {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnBigokutaActionFunc,
    pub unk_194: s8,
    pub unk_195: u8_0,
    pub unk_196: s16,
    pub unk_198: s16,
    ...
    pub element: ColliderJntSphElement,
    pub cylinder: [ColliderCylinder; 2],
}
pub type EnBigokutaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBigokuta, _: *mut GlobalContext)
               -> ()>;
...
static mut sEffectPosAccel: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub static mut En_Bigokuta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BIGOKUTA as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BIGOKUTA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBigokuta>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBigokuta_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBigokuta_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBigokuta_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBigokuta_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCylinderInit: [ColliderCylinderInit; 2] =
    [{
         let mut init =
...
static mut sColChkInfoInit: [CollisionCheckInfoInit; 1] =
    [{
         let mut init =
             CollisionCheckInfoInit{health: 4 as libc::c_int as u8_0,
                                    cylRadius: 130 as libc::c_int as s16,
                                    cylHeight: 120 as libc::c_int as s16,
...
pub unsafe extern "C" fn EnBigokuta_Init(mut thisx: *mut Actor,
    ...
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        ...
        (*this).unk_196 = 1 as libc::c_int as s16;
        (*this).actor.home.pos.y = -1025.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBigokuta_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnBigokuta = thisx as *mut EnBigokuta;
    let mut i: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn func_809BCE3C(mut this: *mut EnBigokuta) {
    (*this).actor.world.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).unk_194 as libc::c_int * -(0x4000 as libc::c_int)) as
            s16;
    (*this).actor.world.pos.x =
        Math_SinS((*this).actor.world.rot.y) * 263.0f32 +
            (*this).actor.home.pos.x;
    (*this).actor.world.pos.z =
        Math_CosS((*this).actor.world.rot.y) * 263.0f32 +
            (*this).actor.home.pos.z;
}
#[no_mangle]
pub unsafe extern "C" fn func_809BCEBC(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut yDistFromHome: f32_0 =
        (*this).actor.world.pos.y - (*this).actor.home.pos.y;
    pos.x = (*this).actor.world.pos.x;
    pos.y = (*this).actor.home.pos.y + 3.0f32;
    pos.z = (*this).actor.world.pos.z;
    if (*globalCtx).gameplayFrames.wrapping_rem(7 as libc::c_int as
                                                    libc::c_uint) ==
           0 as libc::c_int as libc::c_uint && yDistFromHome <= 0.0f32 &&
           yDistFromHome > -100.0f32 {
        EffectSsGRipple_Spawn(globalCtx, &mut pos, 800 as libc::c_int as s16,
                              1300 as libc::c_int as s16,
                              0 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BCF68(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut rot: s16 = 0;
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0 {
        rot =
            (Rand_S16Offset(0x1200 as libc::c_int as s16,
                            0xc00 as libc::c_int as s16) as libc::c_int +
                 (*this).actor.shape.rot.y as libc::c_int -
                 (*this).unk_194 as libc::c_int * 0xa00 as libc::c_int) as s16
    } else {
        rot =
            ((*this).actor.shape.rot.y as libc::c_int -
                 (*this).unk_194 as libc::c_int * 0xa00 as libc::c_int -
                 Rand_S16Offset(0x1200 as libc::c_int as s16,
                                0xc00 as libc::c_int as s16) as libc::c_int)
                as s16
    }
    if (*this).actionFunc !=
           Some(func_809BE4A4 as
                    unsafe extern "C" fn(_: *mut EnBigokuta,
                                         _: *mut GlobalContext) -> ()) {
        if (*this).actionFunc ==
               Some(func_809BE3E4 as
                        unsafe extern "C" fn(_: *mut EnBigokuta,
                                             _: *mut GlobalContext) -> ()) ||
               (*globalCtx).gameplayFrames & 2 as libc::c_int as libc::c_uint
                   != 0 {
            effectPos.x =
                (*this).actor.world.pos.x - Math_SinS(rot) * 80.0f32;
            effectPos.z =
                (*this).actor.world.pos.z - Math_CosS(rot) * 80.0f32;
            effectPos.y = (*this).actor.home.pos.y + 1.0f32;
            EffectSsGRipple_Spawn(globalCtx, &mut effectPos,
                                  100 as libc::c_int as s16,
                                  500 as libc::c_int as s16,
                                  0 as libc::c_int as s16);
        } else {
            effectPos.x =
                (*this).actor.world.pos.x - Math_SinS(rot) * 120.0f32;
            effectPos.z =
                (*this).actor.world.pos.z - Math_CosS(rot) * 120.0f32;
            effectPos.y = (*this).actor.home.pos.y + 5.0f32
        }
    } else {
        effectPos.x = (*this).actor.world.pos.x - Math_SinS(rot) * 50.0f32;
        effectPos.z = (*this).actor.world.pos.z - Math_CosS(rot) * 50.0f32;
        effectPos.y = (*this).actor.home.pos.y + 1.0f32;
        EffectSsGRipple_Spawn(globalCtx, &mut effectPos,
                              100 as libc::c_int as s16,
                              500 as libc::c_int as s16,
    ...
    EffectSsGSplash_Spawn(globalCtx, &mut effectPos, 0 as *mut Color_RGBA8,
    ...
    if (*this).actionFunc !=
        ...
        func_8002F974(&mut (*this).actor,
                      (0x3905 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD1C8(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    while i < 4 as libc::c_int {
        effectPos.x =
            (if i >= 2 as libc::c_int {
                 1 as libc::c_int
             } else { -(1 as libc::c_int) }) as libc::c_float * 60.0f32 +
                (*this).actor.world.pos.x;
        effectPos.z =
            (if i & 1 as libc::c_int != 0 {
                ...
                (*this).actor.world.pos.z;
        EffectSsGSplash_Spawn(globalCtx, &mut effectPos,
                              0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                              1 as libc::c_int as s16,
                              2000 as libc::c_int as s16);
        i += 1
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x39ed as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3879 as libc::c_int as u16_0);
    func_80033E88(&mut (*this).actor, globalCtx, 0xa as libc::c_int as s16,
                  8 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD2E4(mut this: *mut EnBigokuta) {
    let mut parent: *mut Actor = (*this).actor.parent;
    if !parent.is_null() {
        Math_ScaledStepToS(&mut (*parent).world.rot.y, (*this).unk_19A,
                           0x10 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD318(mut this: *mut EnBigokuta) {
    Animation_PlayLoop(&mut (*this).skelAnime,
                       &mut object_bigokuta_Anim_0014B8);
    (*this).unk_19A = 0 as libc::c_int as s16;
    (*this).actor.home.pos.y = -1025.0f32;
    (*this).unk_196 = 121 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809BD84C as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD370(mut this: *mut EnBigokuta) {
    (*this).unk_196 = 21 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_809BD8DC as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD3AC(mut this: *mut EnBigokuta) {
    (*this).actor.world.pos.x = (*this).actor.home.pos.x + 263.0f32;
    (*this).unk_196 = 10 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809BDAE8 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.world.pos.y = (*this).actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD3E0(mut this: *mut EnBigokuta) {
    (*this).unk_196 = 40 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809BDB90 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD3F8(mut this: *mut EnBigokuta) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_bigokuta_Anim_001CA4, -5.0f32);
    (*this).unk_196 = 350 as libc::c_int as s16;
    (*this).unk_198 = 80 as libc::c_int as s16;
    (*this).unk_19A =
        ((*this).unk_194 as libc::c_int * -(0x200 as libc::c_int)) as s16;
    func_809BCE3C(this);
    (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
        ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
    ...
    (*this).actionFunc =
        Some(func_809BDC08 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD47C(mut this: *mut EnBigokuta) {
    (*this).unk_196 = 16 as libc::c_int as s16;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actor.colorFilterTimer = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(func_809BDF34 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD4A4(mut this: *mut EnBigokuta) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_bigokuta_Anim_0014B8, -5.0f32);
    (*this).unk_195 = 1 as libc::c_int as u8_0;
    ...
    (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
        ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
             libc::c_int | (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(func_809BDFC8 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD524(mut this: *mut EnBigokuta) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_bigokuta_Anim_000D1C, -5.0f32);
    (*this).unk_196 = 80 as libc::c_int as s16;
    (*this).unk_19A = 0 as libc::c_int as s16;
    (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
        ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
             libc::c_int | (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3904 as libc::c_int as u16_0);
    if (*(*(*this).collider.elements).info.acHitInfo).toucher.dmgFlags &
           1 as libc::c_int as libc::c_uint != 0 {
        (*this).unk_195 = 1 as libc::c_int as u8_0;
        (*this).unk_196 = 20 as libc::c_int as s16
    } else {
        (*this).unk_195 = 0 as libc::c_int as u8_0;
        (*this).unk_196 = 80 as libc::c_int as s16
    }
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         ...
                         (*this).unk_196);
    (*this).actionFunc =
        Some(func_809BE058 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD5E0(mut this: *mut EnBigokuta) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_bigokuta_Anim_000444, -5.0f32);
    (*this).unk_196 = 24 as libc::c_int as s16;
    (*this).unk_19A = 0 as libc::c_int as s16;
    (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
        ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
             libc::c_int & !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    ...
    (*this).actionFunc =
        Some(func_809BE180 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD658(mut this: *mut EnBigokuta) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_bigokuta_Anim_000A74, -5.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x390a as libc::c_int as u16_0);
    (*this).unk_196 = 38 as libc::c_int as s16;
    (*this).unk_198 = 10 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809BE26C as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD6B8(mut this: *mut EnBigokuta) {
    if (*this).unk_195 == 0 {
        if Rand_ZeroOne() < 0.5f32 {
            (*this).unk_196 = 24 as libc::c_int as s16
        } else { (*this).unk_196 = 28 as libc::c_int as s16 }
    } else if (if (*this).actor.shape.rot.y as libc::c_int -
        ...
        (*this).unk_196 = 4 as libc::c_int as s16
    } else { (*this).unk_196 = 0 as libc::c_int as s16 }
    (*this).unk_19A = 0 as libc::c_int as s16;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_809BD768(mut this: *mut EnBigokuta) {
    (*this).unk_194 =
        if Rand_ZeroOne() < 0.5f32 {
            -(1 as libc::c_int)
        } else { 1 as libc::c_int } as s8;
    (*this).unk_19A = 0 as libc::c_int as s16;
    (*this).actor.flags &=
    ...
    (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
        ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
             libc::c_int & !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3908 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_809BE4A4 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_809BD7F0(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.rot.y =
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             (*this).unk_194 as libc::c_int * 0x4000 as libc::c_int) as s16;
    func_809BCE3C(this);
    (*this).actionFunc =
        Some(func_809BE518 as
                 unsafe extern "C" fn(_: *mut EnBigokuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809BD84C(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).unk_196 -= 1;
    if (*this).unk_196 as libc::c_int == 13 as libc::c_int ||
           (*this).unk_196 as libc::c_int == -(20 as libc::c_int) {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3906 as libc::c_int as u16_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_809BD8DC(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).unk_196 -= 1;
    if (*this).unk_196 as libc::c_int >= 0 as libc::c_int {
        Math_StepToF(&mut (*this).actor.world.pos.x,
                     (*this).actor.home.pos.x + 263.0f32,
                     263.0f32 / 21 as libc::c_int as libc::c_float);
        if ((*this).unk_196 as libc::c_int) < 14 as libc::c_int {
            (*this).actor.world.pos.y =
                sinf((*this).unk_196 as libc::c_int as libc::c_float *
                         (3.14159265358979323846f32 /
                              28 as libc::c_int as libc::c_float)) * 200.0f32
                    + (*this).actor.home.pos.y
        } else {
            (*this).actor.world.pos.y =
                sinf(((*this).unk_196 as libc::c_int - 7 as libc::c_int) as
                         libc::c_float *
                         (3.14159265358979323846f32 /
                              14 as libc::c_int as libc::c_float)) * 130.0f32
                    + ((*this).actor.home.pos.y + 70.0f32)
        }
        if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
            effectPos.x = (*this).actor.world.pos.x + 40.0f32;
            effectPos.y = (*this).actor.world.pos.y;
            effectPos.z = (*this).actor.world.pos.z - 70.0f32;
            EffectSsGSplash_Spawn(globalCtx, &mut effectPos,
    ...
    } else if ((*this).unk_196 as libc::c_int) < -(1 as libc::c_int) {
        (*this).actor.world.pos.y =
            (*this).actor.home.pos.y -
                sinf(((*this).unk_196 as libc::c_int + 1 as libc::c_int) as
                         libc::c_float *
                         (3.14159265358979323846f32 /
                              10 as libc::c_int as libc::c_float)) * 20.0f32;
        if (*this).unk_196 as libc::c_int == -(10 as libc::c_int) {
            func_809BD3AC(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BDAE8(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
        ...
        if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
            ...
            (*this).actor.params = 2 as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3906 as libc::c_int as u16_0);
            func_809BD3E0(this);
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_809BDB90(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        (*this).unk_196 -= 1
...
#[no_mangle]
pub unsafe extern "C" fn func_809BDC08(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c5 as libc::c_int as u16_0);
    }
    if ((*this).unk_196 as libc::c_int) < 0 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).unk_194 as libc::c_int * 0x200 as libc::c_int) as
                s16;
        func_809BCE3C(this);
        (*this).unk_196 += 1;
        if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
    ...
    phi_v1 =
        ((Actor_WorldDistXZToPoint(&mut (*player).actor,
                                   &mut (*this).actor.home.pos) - 180.0f32) *
             (8.0f32 / 15 as libc::c_int as libc::c_float)) as s16;
    func_8002DBD0(&mut (*this).actor, &mut sp28,
                  &mut (*player).actor.world.pos);
    if fabsf(sp28.x) > 263.0f32 ||
           sp28.z > 0.0f32 &&
               Actor_IsFacingPlayer(&mut (*this).actor,
                                    0x1b00 as libc::c_int as s16) == 0 &&
               Player_IsFacingActor(&mut (*this).actor,
                                    0x2000 as libc::c_int as s16, globalCtx)
                   == 0 {
        phi_v1 = (phi_v1 as libc::c_int - 0x80 as libc::c_int) as s16;
        if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
            (*this).unk_196 -= 1
        }
    }
    if (*this).actor.xzDistToPlayer < 250.0f32 &&
           Actor_IsFacingPlayer(&mut (*this).actor,
                                0x6000 as libc::c_int as s16) == 0 {
        if (*this).unk_198 as libc::c_int != 0 as libc::c_int {
            (*this).unk_198 -= 1
        }
        if (*this).actor.xzDistToPlayer < 180.0f32 {
            phi_v1 = (phi_v1 as libc::c_int + 0x20 as libc::c_int) as s16
        }
    } else { (*this).unk_198 = 80 as libc::c_int as s16 }
    if (*this).actor.colChkInfo.health as libc::c_int == 1 as libc::c_int {
        phi_v1 =
            ((phi_v1 as libc::c_int + 0x130 as libc::c_int) as libc::c_float *
                 1.1f32) as s16
    } else { phi_v1 = (phi_v1 as libc::c_int + 0x130 as libc::c_int) as s16 }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             phi_v1 as libc::c_int * (*this).unk_194 as libc::c_int) as s16;
    func_809BCE3C(this);
    func_809BCF68(this, globalCtx);
    if (*this).unk_198 as libc::c_int == 0 as libc::c_int {
        func_809BD768(this);
    } else if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
        func_809BD4A4(this);
    } else if (*this).unk_195 != 0 {
        phi_v0 =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        if (phi_v0 as libc::c_int) < 0 as libc::c_int {
            phi_v0 = -(phi_v0 as libc::c_int) as s16
        }
        if (phi_v0 as libc::c_int) < 0x4100 as libc::c_int &&
               phi_v0 as libc::c_int > 0x3f00 as libc::c_int {
            if Rand_ZeroOne() < 0.6f32 {
                (*this).unk_196 = 0 as libc::c_int as s16;
                func_809BD4A4(this);
            }
            (*this).unk_195 = 0 as libc::c_int as u8_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_809BDF34(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        (*this).unk_196 -= 1
    ...
    (*this).actor.world.pos.y =
        sinf((*this).unk_196 as libc::c_int as libc::c_float *
                 (3.14159265358979323846f32 /
                      16 as libc::c_int as libc::c_float)) * 100.0f32 +
            (*this).actor.home.pos.y;
    if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809BDFC8(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        (*this).unk_196 -= 1
    }
    if (*this).unk_196 as libc::c_int == 20 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3906 as libc::c_int as u16_0);
    }
    if (*this).unk_196 as libc::c_int == 0 as libc::c_int &&
        ...
        (*this).unk_194 = -((*this).unk_194 as libc::c_int) as s8;
        func_809BD3F8(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BE058(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).collider.base.ocFlags1 as libc::c_int &
           ...
           (*this).cylinder[0 as libc::c_int as usize].base.ocFlags1 as
               libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).cylinder[1 as libc::c_int as usize].base.ocFlags1 as
               libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        speedXZ =
            if (*player).actor.speedXZ < 1.0f32 {
                1.0f32
            } else { (*player).actor.speedXZ };
        if (*this).collider.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int == 0 {
            (*this).cylinder[0 as libc::c_int as usize].base.ocFlags1 =
                ((*this).cylinder[0 as libc::c_int as usize].base.ocFlags1 as
                     libc::c_int & !((1 as libc::c_int) << 1 as libc::c_int))
                    as u8_0;
            (*this).cylinder[1 as libc::c_int as usize].base.ocFlags1 =
                ((*this).cylinder[1 as libc::c_int as usize].base.ocFlags1 as
                     libc::c_int & !((1 as libc::c_int) << 1 as libc::c_int))
                    as u8_0;
            speedXZ *= -1.0f32
        ...
        (*player).actor.world.pos.x -=
            speedXZ * Math_SinS((*this).actor.shape.rot.y);
        (*player).actor.world.pos.z -=
            speedXZ * Math_CosS((*this).actor.shape.rot.y)
    }
    if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
        func_809BD6B8(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_809BE180(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        (*this).unk_196 -= 1
    ...
    if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
        if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int
           {
            func_809BD4A4(this);
        } else { func_809BD658(this); }
    } else if (*this).unk_196 as libc::c_int >= 8 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).unk_194 as libc::c_int * 0x200 as libc::c_int) as
                s16;
        (*this).actor.world.pos.y =
            sinf(((*this).unk_196 as libc::c_int - 8 as libc::c_int) as
                     libc::c_float *
                     (3.14159265358979323846f32 /
                          16 as libc::c_int as libc::c_float)) * 100.0f32 +
                (*this).actor.home.pos.y;
        func_809BCE3C(this);
        if (*this).unk_196 as libc::c_int == 8 as libc::c_int {
            func_809BD1C8(this, globalCtx);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BE26C(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).unk_198 as libc::c_int == 6 as libc::c_int {
            ...
            effectPos.y = (*this).actor.world.pos.y + 150.0f32;
            effectPos.z = (*this).actor.world.pos.z;
            func_8002829C(globalCtx, &mut effectPos, &mut sEffectPosAccel,
                          &mut sEffectPosAccel, &mut sEffectPrimColor,
                          &mut sEffectEnvColor, 1200 as libc::c_int as s16,
                          20 as libc::c_int as s16);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38c7 as libc::c_int as u16_0);
        }
        if (*this).unk_198 as libc::c_int == 0 as libc::c_int &&
               Math_StepToF(&mut (*this).actor.scale.y, 0.0f32, 0.001f32) != 0
           {
            Flags_SetClear(globalCtx, (*this).actor.room as s32);
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 CAM_SET_DUNGEON0 as libc::c_int as s16);
            func_8005ACFC((*globalCtx).cameraPtrs[0 as libc::c_int as usize],
...
#[no_mangle]
pub unsafe extern "C" fn func_809BE3E4(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        if (*this).unk_196 as libc::c_int != 0 as libc::c_int {
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x2000 as libc::c_int)
                as s16
    }
    if (*this).unk_196 as libc::c_int == 0 as libc::c_int {
        if ((*this).actor.shape.rot.y as libc::c_int -
            ...
            (*this).unk_194 = 1 as libc::c_int as s8
        } else { (*this).unk_194 = -(1 as libc::c_int) as s8 }
        func_809BD3F8(this);
        if (*this).unk_195 == 0 {
            (*this).unk_196 = -(40 as libc::c_int) as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_809BE4A4(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.pos.y -= 10.0f32;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x2000 as libc::c_int) as
            s16;
    if (*this).actor.world.pos.y < (*this).actor.home.pos.y + -200.0f32 {
        func_809BD7F0(this, globalCtx);
    }
    func_809BCF68(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_809BE518(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                    10.0f32) != 0 {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        func_809BD3F8(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_809BE568(mut this: *mut EnBigokuta) {
    let mut i: s32 = 0;
    ...
    (*(*this).collider.elements).dim.worldSphere.center.x =
        ((*(*this).collider.elements).dim.modelSphere.center.z as libc::c_int
             as libc::c_float * sin +
             ((*this).actor.world.pos.x +
                  (*(*this).collider.elements).dim.modelSphere.center.x as
                      libc::c_int as libc::c_float * cos)) as s16;
    (*(*this).collider.elements).dim.worldSphere.center.z =
        ((*this).actor.world.pos.z +
             (*(*this).collider.elements).dim.modelSphere.center.z as
                 libc::c_int as libc::c_float * cos -
             (*(*this).collider.elements).dim.modelSphere.center.x as
                 libc::c_int as libc::c_float * sin) as s16;
    (*(*this).collider.elements).dim.worldSphere.center.y =
        ((*(*this).collider.elements).dim.modelSphere.center.y as libc::c_int
             as libc::c_float + (*this).actor.world.pos.y) as s16;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderCylinder; 2]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderCylinder>()
                                                   as libc::c_ulong) as s32 {
        (*this).cylinder[i as usize].dim.pos.x =
            ((*this).actor.world.pos.x +
                 sCylinderInit[i as usize].dim.pos.z as libc::c_int as
                     libc::c_float * sin +
                 sCylinderInit[i as usize].dim.pos.x as libc::c_int as
                     libc::c_float * cos) as s16;
        (*this).cylinder[i as usize].dim.pos.z =
            ((*this).actor.world.pos.z +
                 sCylinderInit[i as usize].dim.pos.z as libc::c_int as
                     libc::c_float * cos -
                 sCylinderInit[i as usize].dim.pos.x as libc::c_int as
                     libc::c_float * sin) as s16;
        (*this).cylinder[i as usize].dim.pos.y =
            (*this).actor.world.pos.y as s16;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BE798(mut this: *mut EnBigokuta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectRot: s16 = 0;
    let mut yawDiff: s16 = 0;
    if (*this).cylinder[0 as libc::c_int as usize].base.atFlags as libc::c_int
           & (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).cylinder[1 as libc::c_int as usize].base.atFlags as
               libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0 ||
        ...
        (*this).cylinder[0 as libc::c_int as usize].base.atFlags =
            ((*this).cylinder[0 as libc::c_int as usize].base.atFlags as
                ...
                u8_0;
        (*this).cylinder[1 as libc::c_int as usize].base.atFlags =
            ((*this).cylinder[1 as libc::c_int as usize].base.atFlags as
                 libc::c_int & !((1 as libc::c_int) << 1 as libc::c_int)) as
                u8_0;
        ...
        if yawDiff as libc::c_int > 0x4000 as libc::c_int {
            effectRot = 0x4000 as libc::c_int as s16
        } else if yawDiff as libc::c_int > 0 as libc::c_int {
            effectRot = 0x6000 as libc::c_int as s16
        } else if (yawDiff as libc::c_int) < -(0x4000 as libc::c_int) {
            effectRot = -(0x4000 as libc::c_int) as s16
        } else { effectRot = -(0x6000 as libc::c_int) as s16 }
        func_8002F71C(globalCtx, &mut (*this).actor, 10.0f32,
                      ((*this).actor.world.rot.y as libc::c_int +
                           effectRot as libc::c_int) as s16, 5.0f32);
        if (*this).actionFunc ==
               Some(func_809BDC08 as
                        unsafe extern "C" fn(_: *mut EnBigokuta,
                                             _: *mut GlobalContext) -> ()) {
            ...
            (*this).unk_196 = 40 as libc::c_int as s16
                      ...
                      Some(func_809BE3E4 as
                               unsafe extern "C" fn(_: *mut EnBigokuta,
                                                    _: *mut GlobalContext)
                                   -> ()) {
            if effectRot as libc::c_int * (*this).unk_194 as libc::c_int >
                   0 as libc::c_int {
                (*this).unk_194 =
                    (0 as libc::c_int - (*this).unk_194 as libc::c_int) as s8;
                (*this).unk_196 =
                    ((*this).unk_196 as libc::c_int + 4 as libc::c_int) as s16
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBigokuta_UpdateDamage(mut this: *mut EnBigokuta,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                                           ...
                                           0x4000 as libc::c_int as s16) == 0
             {
                if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                    ...
                    // Dead
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3909 as libc::c_int as u16_0);
                    Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
                } else {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3907 as libc::c_int as u16_0);
                }
                func_809BD5E0(this);
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnBigokuta_Update(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut this: *mut EnBigokuta = thisx as *mut EnBigokuta;
    let mut i: s32 = 0;
    ...
    func_809BD2E4(this);
    func_809BE568(this);
    Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as usize],
                         CAM_SET_BIG_OCTO as libc::c_int as s16);
    func_8005AD1C((*globalCtx).cameraPtrs[0 as libc::c_int as usize],
                  4 as libc::c_int as s16);
    if (*this).cylinder[0 as libc::c_int as usize].base.atFlags as libc::c_int
    ...
    Actor_SetFocus(&mut (*this).actor,
                   (*this).actor.scale.y * 25.0f32 * 100.0f32);
    func_809BCEBC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnBigokuta_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 15 as libc::c_int {
        if (*this).actionFunc ==
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            ...
            Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                            b"../z_en_bigokuta.c\x00" as *const u8 as
                                *const libc::c_char, 1914 as libc::c_int);
            if (*this).actionFunc ==
                   Some(func_809BE058 as
                            unsafe extern "C" fn(_: *mut EnBigokuta,
                                                 _: *mut GlobalContext) -> ())
               {
                temp_hi = (*this).unk_196 as libc::c_int % 12 as libc::c_int;
                if temp_hi >= 8 as libc::c_int {
                    temp_f0 =
                        (12 as libc::c_int - temp_hi) as libc::c_float *
                            (3.14159265358979323846f32 /
                                 8 as libc::c_int as libc::c_float)
                } else {
                    temp_f0 =
                        temp_hi as libc::c_float *
                            (3.14159265358979323846f32 /
                                 16 as libc::c_int as libc::c_float)
                }
            } else {
                temp_hi = (*this).unk_196 as libc::c_int % 6 as libc::c_int;
                if temp_hi >= 4 as libc::c_int {
                    temp_f0 =
                        (6 as libc::c_int - temp_hi) as libc::c_float *
                            (3.14159265358979323846f32 /
            ...
            temp_f0 = sinf(temp_f0) * 125.0f32 + 130.0f32;
            ...
            Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                             b"../z_en_bigokuta.c\x00" as *const u8 as
                                 *const libc::c_char, 1945 as libc::c_int);
        }
        ...
        Graph_OpenDisps(dispRefs_0.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_bigokuta.c\x00" as *const u8 as
                            *const libc::c_char, 1950 as libc::c_int);
        if (*this).actionFunc ==
               Some(func_809BE26C as
                        unsafe extern "C" fn(_: *mut EnBigokuta,
                                             _: *mut GlobalContext) -> ()) {
            intensity =
                ((*this).unk_196 as libc::c_int as libc::c_float *
                     (255.0f32 / 38 as libc::c_int as libc::c_float)) as u8_0
        } else { intensity = 255 as libc::c_int as u8_0 }
        let fresh2 = (*__gfxCtx_0).polyOpa.p;
        ...
        let fresh3 = (*__gfxCtx_0).polyOpa.p;
        (*__gfxCtx_0).polyOpa.p = (*__gfxCtx_0).polyOpa.p.offset(1);
        ...
        Graph_CloseDisps(dispRefs_0.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_bigokuta.c\x00" as *const u8 as
                             *const libc::c_char, 1972 as libc::c_int);
        ...
        if ((*this).unk_198 as libc::c_int) < 5 as libc::c_int {
            Matrix_Scale((*this).unk_198 as libc::c_int as libc::c_float *
                             0.2f32 * 0.25f32 + 1.0f32, 1.0f32, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        } else if ((*this).unk_198 as libc::c_int) < 8 as libc::c_int {
            temp_f0 =
                ((*this).unk_198 as libc::c_int - 5 as libc::c_int) as
                    libc::c_float *
                    (1.0f32 / 12 as libc::c_int as libc::c_float);
            Matrix_Scale(1.25f32 - temp_f0, 1.0f32 + temp_f0,
                         1.0f32 + temp_f0,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        } else {
            temp_f0 =
                ((*this).unk_198 as libc::c_int - 8 as libc::c_int) as
                    libc::c_float * 0.125f32;
            Matrix_Scale(1.0f32, 1.25f32 - temp_f0, 1.25f32 - temp_f0,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnBigokuta_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBigokuta = thisx as *mut EnBigokuta;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bigokuta.c\x00" as *const u8 as
                        *const libc::c_char, 2017 as libc::c_int);
    if (*this).actionFunc !=
           Some(func_809BE26C as
                    unsafe extern "C" fn(_: *mut EnBigokuta,
                                         _: *mut GlobalContext) -> ()) ||
           (*this).unk_196 as libc::c_int != 0 as libc::c_int ||
            ...
            (255 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        if (*this).unk_196 as libc::c_int & 1 as libc::c_int != 0 {
            if (*this).actionFunc ==
                   Some(func_809BE180 as
                            unsafe extern "C" fn(_: *mut EnBigokuta,
                                                 _: *mut GlobalContext) -> ())
                   && (*this).unk_196 as libc::c_int >= 8 as libc::c_int ||
                   (*this).actionFunc ==
                       Some(func_809BE26C as
                                unsafe extern "C" fn(_: *mut EnBigokuta,
                                                     _: *mut GlobalContext)
                                    -> ()) &&
                       (*this).unk_196 as libc::c_int >= 10 as libc::c_int {
                let mut rotX: f32_0 =
                    Rand_ZeroOne() * (3.14159265358979323846f32 * 2.0f32);
                let mut rotY: f32_0 =
                    Rand_ZeroOne() * (3.14159265358979323846f32 * 2.0f32);
                Matrix_RotateY(rotY, MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateX(rotX, MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_Scale(0.78999996f32, 1.3f32, 0.78999996f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateX(-rotX, MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateY(-rotY, MTXMODE_APPLY as libc::c_int as u8_0);
            }
        ...
        SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                              ...
                              Some(EnBigokuta_OverrideLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xc as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = D_80116280.as_mut_ptr() as libc::c_uint;
        ...
        (*_g_2).words.w1 =
            (0 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    8 as libc::c_int |
                (((*this).actor.scale.y *
                      (255 as libc::c_int as libc::c_float / 0.033f32)) as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bigokuta.c\x00" as *const u8 as
                         *const libc::c_char, 2076 as libc::c_int);
}
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(0x59 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).scale as *mut Vec3f as
                                 size_t as u32_0);
             init.set_value(33 as libc::c_int);
             init
         }]
}
#[used]
