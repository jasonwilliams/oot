...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002F7A0(globalCtx: *mut GlobalContext, actor: *mut Actor,
...
pub struct EnBubble {
    pub actor: Actor,
    pub actionFunc: EnBubbleActionFunc,
    pub colliderSphere: ColliderJntSph,
    pub colliderSphereItems: [ColliderJntSphElement; 2],
    pub unk_1F0: Vec3f,
    pub unk_1FC: Vec3f,
    pub unk_208: s16,
    pub explosionCountdown: s16,
    pub unk_20C: [libc::c_char; 4],
    pub graphicRotSpeed: f32_0,
    pub graphicEccentricity: f32_0,
    pub unk_218: f32_0,
    pub unk_21C: f32_0,
    pub expansionWidth: f32_0,
    pub expansionHeight: f32_0,
    pub bounceCount: u8_0,
    pub bounceDirection: Vec3f,
    pub velocityFromBounce: Vec3f,
    pub normalizedBumpVelocity: Vec3f,
    pub velocityFromBump: Vec3f,
    pub sinkSpeed: f32_0,
}
pub type EnBubbleActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBubble, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Bubble_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BUBBLE as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BUBBLE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBubble>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBubble_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBubble_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBubble_SetDimensions(mut this: *mut EnBubble,
                                                mut dim: f32_0) {
    let mut a: f32_0 = 0.;
    let mut b: f32_0 = 0.;
    let mut c: f32_0 = 0.;
    ...
    (*this).actor.shape.yOffset = 16.0f32;
    (*this).graphicRotSpeed = 16.0f32;
    (*this).graphicEccentricity = 0.08f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_809CBCBC(mut this: *mut EnBubble) -> u32_0 {
    let mut info: *mut ColliderInfo =
        &mut (*(*this).colliderSphere.elements.offset(0 as libc::c_int as
                                                          isize)).info;
    (*info).toucher.dmgFlags = 0x8 as libc::c_int as u32_0;
    (*info).toucher.effect = 0 as libc::c_int as u8_0;
    (*info).toucher.damage = 4 as libc::c_int as u8_0;
    (*info).toucherFlags = ((1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actor.velocity.y = 0.0f32;
    return 6 as libc::c_int as u32_0;
}
// only called in an unused actionFunc
#[no_mangle]
pub unsafe extern "C" fn func_809CBCEC(mut this: *mut EnBubble) -> u32_0 {
    EnBubble_SetDimensions(this, -1.0f32);
    return 12 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_DamagePlayer(mut this: *mut EnBubble,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut damage: s32 =
        -((*(*this).colliderSphere.elements.offset(0 as libc::c_int as
                                                       isize)).info.toucher.damage
              as libc::c_int);
    (*globalCtx).damagePlayer.expect("non-null function pointer")(globalCtx,
                                                                  damage);
    func_8002F7A0(globalCtx, &mut (*this).actor, 6.0f32,
                  (*this).actor.yawTowardsPlayer, 6.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Explosion(mut this: *mut EnBubble,
 ...
 -> s32 {
    ...
    Math_SmoothStepToF(&mut (*this).expansionWidth, 4.0f32, 0.1f32, 1000.0f32,
                       0.0f32);
    Math_SmoothStepToF(&mut (*this).expansionHeight, 4.0f32, 0.1f32,
                       1000.0f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).graphicRotSpeed, 54.0f32, 0.1f32,
                       1000.0f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).graphicEccentricity, 0.2f32, 0.1f32,
                       1000.0f32, 0.0f32);
    (*this).actor.shape.yOffset =
        ((*this).expansionHeight + 1.0f32) * 16.0f32;
    if (if (*this).explosionCountdown as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).explosionCountdown -= 1;
            (*this).explosionCountdown as libc::c_int
        }) != 0 as libc::c_int {
    ...
    while i < 20 as libc::c_int as libc::c_uint {
        effectVel.x = (Rand_ZeroOne() - 0.5f32) * 7.0f32;
        effectVel.y = Rand_ZeroOne() * 7.0f32;
        effectVel.z = (Rand_ZeroOne() - 0.5f32) * 7.0f32;
        EffectSsDtBubble_SpawnCustomColor(globalCtx, &mut effectPos,
                                          &mut effectVel, &mut effectAccel,
                                          &mut sEffectPrimColor,
                                          &mut sEffectEnvColor,
                                          Rand_S16Offset(100 as libc::c_int as
                                                             s16,
                                                         50 as libc::c_int as
                                                             s16),
    ...
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    return Rand_S16Offset(90 as libc::c_int as s16, 60 as libc::c_int as s16)
               as s32;
}
// only called in an unused actionFunc
#[no_mangle]
pub unsafe extern "C" fn func_809CBFD4(mut this: *mut EnBubble) -> u32_0 {
    if (if (*this).explosionCountdown as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).explosionCountdown -= 1;
...
// only called in an unused actionFunc
#[no_mangle]
pub unsafe extern "C" fn func_809CC020(mut this: *mut EnBubble) -> s32 {
    (*this).expansionWidth += 1.0f32 / 12.0f32;
    (*this).expansionHeight += 1.0f32 / 12.0f32;
    if (if (*this).explosionCountdown as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).explosionCountdown -= 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Vec3fNormalizedRelfect(mut vec1: *mut Vec3f,
                                                         mut vec2: *mut Vec3f,
                                                         mut ret:
                                                             *mut Vec3f) {
    ...
    norm =
        sqrtf((*ret).x * (*ret).x + (*ret).y * (*ret).y +
                  (*ret).z * (*ret).z);
    if norm != 0.0f32 {
        (*ret).x /= norm;
        (*ret).y /= norm;
        (*ret).z /= norm
    } else { (*ret).z = 0.0f32; (*ret).y = (*ret).z; (*ret).x = (*ret).y };
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Vec3fNormalize(mut vec: *mut Vec3f) {
    let mut norm: f32_0 =
    ...
    if norm != 0.0f32 {
        ...
        (*vec).y /= norm;
        (*vec).z /= norm
    } else { (*vec).z = 0.0f32; (*vec).y = (*vec).z; (*vec).x = (*vec).y };
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Fly(mut this: *mut EnBubble,
                                      mut globalCtx: *mut GlobalContext) {
    let mut sp94: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bumpActor: *mut Actor = 0 as *mut Actor;
    ...
    let mut bounceSpeed: f32_0 = 0.;
    let mut bgId: s32 = 0;
    let mut bounceCount: u8_0 = 0;
    if (*(*this).colliderSphere.elements.offset(1 as libc::c_int as
        ...
        EnBubble_Vec3fNormalize(&mut (*this).normalizedBumpVelocity);
        (*this).velocityFromBump.x +=
            (*this).normalizedBumpVelocity.x * 3.0f32;
        (*this).velocityFromBump.y +=
            (*this).normalizedBumpVelocity.y * 3.0f32;
        (*this).velocityFromBump.z +=
            (*this).normalizedBumpVelocity.z * 3.0f32
    }
    (*this).sinkSpeed -= 0.1f32;
    ...
    sp54.y =
        (*this).velocityFromBounce.y + (*this).velocityFromBump.y +
            (*this).sinkSpeed;
    sp54.z = (*this).velocityFromBounce.z + (*this).velocityFromBump.z;
    EnBubble_Vec3fNormalize(&mut sp54);
    sp78.x = (*this).actor.world.pos.x;
    sp78.y = (*this).actor.world.pos.y + (*this).actor.shape.yOffset;
    sp78.z = (*this).actor.world.pos.z;
    sp6C = sp78;
    sp6C.x += sp54.x * 24.0f32;
    sp6C.y += sp54.y * 24.0f32;
    sp6C.z += sp54.z * 24.0f32;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut sp78, &mut sp6C,
                               &mut sp84, &mut sp94, 1 as libc::c_int,
                               1 as libc::c_int, 1 as libc::c_int,
                               0 as libc::c_int, &mut bgId) != 0 {
        sp60.x =
            (*sp94).normal.x as libc::c_int as libc::c_float *
                (1.0f32 / 32767.0f32);
        sp60.y =
            (*sp94).normal.y as libc::c_int as libc::c_float *
                (1.0f32 / 32767.0f32);
        sp60.z =
            (*sp94).normal.z as libc::c_int as libc::c_float *
                (1.0f32 / 32767.0f32);
        EnBubble_Vec3fNormalizedRelfect(&mut sp54, &mut sp60, &mut sp54);
        (*this).bounceDirection = sp54;
        bounceCount = (*this).bounceCount;
        bounceCount = bounceCount.wrapping_add(1);
        (*this).bounceCount = bounceCount;
        if bounceCount as libc::c_int >
               (Rand_ZeroOne() * 10.0f32) as s16 as libc::c_int {
            (*this).bounceCount = 0 as libc::c_int as u8_0
        }
        bounceSpeed =
            if (*this).bounceCount as libc::c_int == 0 as libc::c_int {
                3.6000001f32
            } else { 3.0f32 };
        (*this).velocityFromBump.z = 0.0f32;
        (*this).velocityFromBump.y = (*this).velocityFromBump.z;
        (*this).velocityFromBump.x = (*this).velocityFromBump.y;
        (*this).velocityFromBounce.x =
            (*this).bounceDirection.x * bounceSpeed;
        (*this).velocityFromBounce.y =
            (*this).bounceDirection.y * bounceSpeed;
        (*this).velocityFromBounce.z =
            (*this).bounceDirection.z * bounceSpeed;
        (*this).sinkSpeed = 0.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3948 as libc::c_int as u16_0);
        (*this).graphicRotSpeed = 128.0f32;
        (*this).graphicEccentricity = 0.48f32
    ...
    (*this).actor.velocity.x =
        (*this).velocityFromBounce.x + (*this).velocityFromBump.x;
    (*this).actor.velocity.y =
        (*this).velocityFromBounce.y + (*this).velocityFromBump.y +
            (*this).sinkSpeed;
    (*this).actor.velocity.z =
        (*this).velocityFromBounce.z + (*this).velocityFromBump.z;
    Math_ApproachF(&mut (*this).velocityFromBump.x, 0.0f32, 0.3f32, 0.1f32);
    Math_ApproachF(&mut (*this).velocityFromBump.y, 0.0f32, 0.3f32, 0.1f32);
    Math_ApproachF(&mut (*this).velocityFromBump.z, 0.0f32, 0.3f32, 0.1f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_809CC648(mut this: *mut EnBubble) -> u32_0 {
    if ((*this).colliderSphere.base.acFlags as libc::c_int &
            (1 as libc::c_int) << 1 as libc::c_int != 0 as libc::c_int) as
           libc::c_int == 0 as libc::c_int {
        return 0 as libc::c_int as u32_0
    }
    (*this).colliderSphere.base.acFlags =
        ((*this).colliderSphere.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
    if (*(*this).colliderSphere.elements.offset(1 as libc::c_int as
                                                    isize)).info.bumperFlags
           as libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).unk_1F0.x =
            (*(*this).colliderSphere.base.ac).velocity.x / 10.0f32;
        (*this).unk_1F0.y =
            (*(*this).colliderSphere.base.ac).velocity.y / 10.0f32;
        (*this).unk_1F0.z =
            (*(*this).colliderSphere.base.ac).velocity.z / 10.0f32;
        (*this).graphicRotSpeed = 128.0f32;
        (*this).graphicEccentricity = 0.48f32;
        return 0 as libc::c_int as u32_0
    }
    (*this).unk_208 = 8 as libc::c_int as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_DetectPop(mut this: *mut EnBubble,
                                            mut globalCtx: *mut GlobalContext)
 -> u32_0 {
    if (if (*this).unk_208 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).unk_208 -= 1; (*this).unk_208 as libc::c_int }) !=
           0 as libc::c_int ||
           (*this).actionFunc ==
               Some(EnBubble_Pop as
                        unsafe extern "C" fn(_: *mut EnBubble,
                                             _: *mut GlobalContext) -> ()) {
        return 0 as libc::c_int as u32_0
    }
    if (*this).colliderSphere.base.ocFlags2 as libc::c_int &
           (1 as libc::c_int) << 0 as libc::c_int != 0 {
        (*this).colliderSphere.base.ocFlags2 =
            ((*this).colliderSphere.base.ocFlags2 as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn func_809CC774(mut this: *mut EnBubble) {
    let mut dim: *mut ColliderJntSphElementDim =
        0 as *mut ColliderJntSphElementDim;
    let mut src: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dest: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    dim =
        &mut (*(*this).colliderSphere.elements.offset(0 as libc::c_int as
                                                          isize)).dim;
    src.x = (*dim).modelSphere.center.x as f32_0;
    src.y = (*dim).modelSphere.center.y as f32_0;
    src.z = (*dim).modelSphere.center.z as f32_0;
    Matrix_MultVec3f(&mut src, &mut dest);
    (*dim).worldSphere.center.x = dest.x as s16;
    (*dim).worldSphere.center.y = dest.y as s16;
    (*dim).worldSphere.center.z = dest.z as s16;
    (*dim).worldSphere.radius =
        ((*dim).modelSphere.radius as libc::c_int as libc::c_float *
             (1.0f32 + (*this).expansionWidth)) as s16;
    (*(*this).colliderSphere.elements.offset(1 as libc::c_int as isize)).dim =
        *dim;
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBubble = thisx as *mut EnBubble;
    let mut pad: u32_0 = 0;
    ActorShape_Init(&mut (*this).actor.shape, 16.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 0.2f32);
    Collider_InitJntSph(globalCtx, &mut (*this).colliderSphere);
    Collider_SetJntSph(globalCtx, &mut (*this).colliderSphere,
                       &mut (*this).actor, &mut sJntSphInit,
                       (*this).colliderSphereItems.as_mut_ptr());
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(9 as libc::c_int),
                            &mut sColChkInfoInit2);
    (*this).actor.naviEnemyId = 0x16 as libc::c_int as u8_0;
    (*this).bounceDirection.x = Rand_ZeroOne();
    (*this).bounceDirection.y = Rand_ZeroOne();
    (*this).bounceDirection.z = Rand_ZeroOne();
    EnBubble_Vec3fNormalize(&mut (*this).bounceDirection);
    (*this).velocityFromBounce.x = (*this).bounceDirection.x * 3.0f32;
    (*this).velocityFromBounce.y = (*this).bounceDirection.y * 3.0f32;
    (*this).velocityFromBounce.z = (*this).bounceDirection.z * 3.0f32;
    EnBubble_SetDimensions(this, 0.0f32);
    (*this).actionFunc =
        Some(EnBubble_Wait as
                 unsafe extern "C" fn(_: *mut EnBubble, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBubble = thisx as *mut EnBubble;
    Collider_DestroyJntSph(globalCtx, &mut (*this).colliderSphere);
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Wait(mut this: *mut EnBubble,
                                       mut globalCtx: *mut GlobalContext) {
    if EnBubble_DetectPop(this, globalCtx) != 0 {
        (*this).explosionCountdown = func_809CBCBC(this) as s16;
        (*this).actionFunc =
            Some(EnBubble_Pop as
                     unsafe extern "C" fn(_: *mut EnBubble,
                                          _: *mut GlobalContext) -> ())
        ...
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderSphere.base);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderSphere.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Pop(mut this: *mut EnBubble,
                                      mut globalCtx: *mut GlobalContext) {
    if EnBubble_Explosion(this, globalCtx) >= 0 as libc::c_int {
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                  60 as libc::c_int,
                                  0x3949 as libc::c_int as u16_0);
        Actor_Kill(&mut (*this).actor);
    };
}
// unused
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Disappear(mut this: *mut EnBubble,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut temp_v0: s32 = 0;
    temp_v0 = func_809CBFD4(this) as s32;
    if temp_v0 >= 0 as libc::c_int {
        (*this).actor.shape.shadowDraw =
            Some(ActorShadow_DrawCircle as
                     unsafe extern "C" fn(_: *mut Actor, _: *mut Lights,
                                          _: *mut GlobalContext) -> ());
        (*this).explosionCountdown = temp_v0 as s16;
        (*this).actionFunc =
            Some(EnBubble_Regrow as
                     unsafe extern "C" fn(_: *mut EnBubble,
                                          _: *mut GlobalContext) -> ())
    };
}
// unused
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Regrow(mut this: *mut EnBubble,
                                         mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBubble = thisx as *mut EnBubble;
    func_8002D7EC(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 16.0f32, 16.0f32,
                            0.0f32, 7 as libc::c_int);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_SetFocus(&mut (*this).actor, (*this).actor.shape.yOffset);
}
#[no_mangle]
pub unsafe extern "C" fn EnBubble_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBubble = thisx as *mut EnBubble;
    let mut pad: u32_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bubble.c\x00" as *const u8 as
                        *const libc::c_char, 1175 as libc::c_int);
    if (*this).actionFunc !=
           Some(EnBubble_Disappear as
                    unsafe extern "C" fn(_: *mut EnBubble,
                                         _: *mut GlobalContext) -> ()) {
        func_80093D84((*globalCtx).state.gfxCtx);
        Math_SmoothStepToF(&mut (*this).graphicRotSpeed, 16.0f32, 0.2f32,
                           1000.0f32, 0.0f32);
        Math_SmoothStepToF(&mut (*this).graphicEccentricity, 0.08f32, 0.2f32,
                           1000.0f32, 0.0f32);
        func_800D1FD4(&mut (*globalCtx).billboardMtxF);
        Matrix_Scale((*this).expansionWidth + 1.0f32,
                     (*this).expansionHeight + 1.0f32, 1.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ((*globalCtx).state.frames as f32_0 *
                           (3.14159265358979323846f32 / 180.0f32) *
                           (*this).graphicRotSpeed,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale((*this).graphicEccentricity + 1.0f32, 1.0f32, 1.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(-((*globalCtx).state.frames as f32_0) *
                           (3.14159265358979323846f32 / 180.0f32) *
                           (*this).graphicRotSpeed,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gBubbleDL.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bubble.c\x00" as *const u8 as
                         *const libc::c_char, 1226 as libc::c_int);
    if (*this).actionFunc !=
           Some(EnBubble_Disappear as
                    unsafe extern "C" fn(_: *mut EnBubble,
                                         _: *mut GlobalContext) -> ()) {
        (*this).actor.shape.shadowScale =
            ((*this).expansionWidth + 1.0f32) * 0.2f32;
        func_809CC774(this);
    };
}
