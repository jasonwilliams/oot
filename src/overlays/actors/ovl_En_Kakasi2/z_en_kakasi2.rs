...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnKakasi2 {
    pub actor: Actor,
    pub actionFunc: EnKakasi2ActionFunc,
    pub skelAnime: SkelAnime,
    pub unk_194: s16,
    pub switchFlag: s16,
    pub unk_198: s16,
    pub maxSpawnDistance: Vec3f,
    pub height: f32_0,
    pub collider: ColliderCylinder,
}
pub type EnKakasi2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKakasi2, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut En_Kakasi2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KAKASI2 as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi2_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi2_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi2 = thisx as *mut EnKakasi2;
    let mut pad: s32 = 0;
    let mut spawnRangeY: f32_0 = 0.;
    let mut spawnRangeXZ: f32_0 = 0.;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Visit Umeda"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\xa2\x85\xe7\x94\xb0\xe5\x8f\x82\xe5\x8f\xb7\xe8\xa6\x8b\xe5\x8f\x82\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).switchFlag =
        ((*this).actor.params as libc::c_int & 0x3f as libc::c_int) as s16;
    spawnRangeY =
        ((*this).actor.params as libc::c_int >> 6 as libc::c_int &
             0xff as libc::c_int) as f32_0;
    spawnRangeXZ = (*this).actor.world.rot.z as f32_0;
    ...
    (*this).maxSpawnDistance.x = spawnRangeY * 40.0f32 + 40.0f32;
    (*this).maxSpawnDistance.y = spawnRangeXZ * 40.0f32 + 40.0f32;
    // "Former? (Argument 0)"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x85\x83\xef\xbc\x9f(\xe5\xbc\x95\xe6\x95\xb0\xef\xbc\x90) \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 spawnRangeY as libc::c_double);
    // "Former? (Z angle)"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x85\x83\xef\xbc\x9f(\xef\xbc\xba\xe3\x82\xa2\xe3\x83\xb3\xe3\x82\xb0\xe3\x83\xab) \xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 spawnRangeXZ as libc::c_double);
    // "Correction coordinates X"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa3\x9c\xe6\xad\xa3\xe5\xba\xa7\xe6\xa8\x99\xef\xbc\xb8 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).maxSpawnDistance.x as libc::c_double);
    // "Correction coordinates Y"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa3\x9c\xe6\xad\xa3\xe5\xba\xa7\xe6\xa8\x99\xef\xbc\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).maxSpawnDistance.y as libc::c_double);
    // "Correction coordinates Z"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa3\x9c\xe6\xad\xa3\xe5\xba\xa7\xe6\xa8\x99\xef\xbc\xba \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).maxSpawnDistance.z as libc::c_double);
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 SAVE       \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
    ...
    if (*this).switchFlag as libc::c_int >= 0 as libc::c_int &&
        ...
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut object_ka_Skel_0065B0,
                           &mut object_ka_Anim_000214, 0 as *mut Vec3s,
                           0 as *mut Vec3s, 0 as libc::c_int);
        (*this).actionFunc =
            Some(func_80A9062C as
                     unsafe extern "C" fn(_: *mut EnKakasi2,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(func_80A90264 as
                     unsafe extern "C" fn(_: *mut EnKakasi2,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi2_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnKakasi2 = thisx as *mut EnKakasi2;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A90264(mut this: *mut EnKakasi2,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 SAVE \xe7\xb5\x82\xe4\xba\x86 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).switchFlag as libc::c_int);
        (*this).actionFunc =
            Some(func_80A904D8 as
                     unsafe extern "C" fn(_: *mut EnKakasi2,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80A904D8(mut this: *mut EnKakasi2,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x28bf as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_80A90578 as
                 unsafe extern "C" fn(_: *mut EnKakasi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A90578(mut this: *mut EnKakasi2,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x800 as libc::c_int) as
            s16;
    Math_ApproachZeroF(&mut (*this).actor.shape.yOffset, 0.5f32, 500.0f32);
    if (*this).actor.shape.yOffset > -100.0f32 {
        (*this).actionFunc =
            Some(func_80A9062C as
                     unsafe extern "C" fn(_: *mut EnKakasi2,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80A9062C(mut this: *mut EnKakasi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut object_ka_Anim_000214 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_ka_Anim_000214,
                     0.0f32, 0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A906C4 as
                 unsafe extern "C" fn(_: *mut EnKakasi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A906C4(mut this: *mut EnKakasi2,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).skelAnime.curFrame != 0 as libc::c_int as libc::c_float {
        Math_ApproachZeroF(&mut (*this).skelAnime.curFrame, 0.5f32, 1.0f32);
    }
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, (*this).unk_198,
                       5 as libc::c_int as s16, 0xbb8 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnKakasi2_Update(mut thisx: *mut Actor,
                                          mut globalCtx2:
                                              *mut GlobalContext) {
    let mut this: *mut EnKakasi2 = thisx as *mut EnKakasi2;
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->actor.player_distance \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).actor.xzDistToPlayer as libc::c_double);
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->hosei.x \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).maxSpawnDistance.x as libc::c_double);
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        }
        if (*this).actor.draw.is_none() {
            if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
                if (*this).unk_194 as libc::c_int % 2 as libc::c_int ==
                       0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A90948(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi2 = thisx as *mut EnKakasi2;
