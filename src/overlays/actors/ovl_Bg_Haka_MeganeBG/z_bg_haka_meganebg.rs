...
extern "C" {
    ...
    #[no_mangle]
    static mut object_haka_objects_DL_000040: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_000118: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_005000: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_005334: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_008EB0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_009168: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_00A1A0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_00A7F4: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaMeganeBG {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaMeganeBGActionFunc,
    pub unk_168: u8_0,
    pub unk_16A: s16,
}
pub type BgHakaMeganeBGActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaMeganeBG, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_MeganeBG_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_MEGANEBG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHakaMeganeBG>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMeganeBG_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMeganeBG_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMeganeBG_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMeganeBG_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_8087E410: [*mut Gfx; 4] =
    unsafe {
        [object_haka_objects_DL_008EB0.as_ptr() as *mut _,
         object_haka_objects_DL_00A1A0.as_ptr() as *mut _,
         object_haka_objects_DL_005000.as_ptr() as *mut _,
         object_haka_objects_DL_000040.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgHakaMeganeBG_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHakaMeganeBG = thisx as *mut BgHakaMeganeBG;
    ...
    if (*thisx).params as libc::c_int == 2 as libc::c_int {
        ...
        CollisionHeader_GetVirtual(&mut object_haka_objects_Col_005334 as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).actionFunc =
            Some(func_8087E258 as
                     unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                          _: *mut GlobalContext) -> ())
    } else {
        DynaPolyActor_Init(&mut (*this).dyna, DPM_PLAYER as libc::c_int);
        if (*thisx).params as libc::c_int == 0 as libc::c_int {
            CollisionHeader_GetVirtual(&mut object_haka_objects_Col_009168 as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
            (*thisx).flags |=
                ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
            (*this).unk_16A = 20 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_8087DFF8 as
                         unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                              _: *mut GlobalContext) -> ())
        } else if (*thisx).params as libc::c_int == 3 as libc::c_int {
            CollisionHeader_GetVirtual(&mut object_haka_objects_Col_000118 as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
            (*thisx).home.pos.y += 100.0f32;
            if Flags_GetSwitch(globalCtx, (*this).unk_168 as s32) != 0 {
                (*this).actionFunc =
                    Some(func_8087E34C as
                             unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                                  _: *mut GlobalContext)
                                 -> ());
                ...
                (*thisx).flags |=
                    ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
                (*this).actionFunc =
                    Some(func_8087E288 as
                             unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        } else {
            CollisionHeader_GetVirtual(&mut object_haka_objects_Col_00A7F4 as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
            (*this).unk_16A = 80 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_8087E10C as
                         unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                              _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaMeganeBG_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgHakaMeganeBG = thisx as *mut BgHakaMeganeBG;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087DFF8(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_16A as libc::c_int != 0 as libc::c_int {
        (*this).unk_16A -= 1
    }
    if (*this).unk_16A as libc::c_int == 0 as libc::c_int {
        (*this).unk_16A = 40 as libc::c_int as s16;
        (*this).dyna.actor.world.rot.y =
            ((*this).dyna.actor.world.rot.y as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        (*this).actionFunc =
            Some(func_8087E040 as
                     unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8087E040(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    let mut xSub: f32_0 = 0.;
    if (*this).unk_16A as libc::c_int != 0 as libc::c_int {
        (*this).unk_16A -= 1
    }
    xSub =
        (sinf(((*this).unk_16A as libc::c_int as libc::c_float * 0.025f32 +
                   0.5f32) * 3.14159265358979323846f32) + 1.0f32) * 160.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087E10C(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dyna.actor.velocity.y += 1.0f32;
    if (*this).dyna.actor.velocity.y > 20.0f32 {
        (*this).dyna.actor.velocity.y = 20.0f32
    } else { (*this).dyna.actor.velocity.y = (*this).dyna.actor.velocity.y }
    if (*this).unk_16A as libc::c_int != 0 as libc::c_int {
        (*this).unk_16A -= 1
    }
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y - 640.0f32,
    ...
    if (*this).unk_16A as libc::c_int == 0 as libc::c_int {
        (*this).unk_16A = 120 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8087E1E0 as
                     unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_8087E1E0(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                 (*this).dyna.actor.home.pos.y, 16.0f32 / 3.0f32);
    func_8002F974(&mut (*this).dyna.actor,
...
#[no_mangle]
pub unsafe extern "C" fn func_8087E258(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8087E288(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).unk_168 as s32) != 0 {
        OnePointCutscene_Attention(globalCtx, &mut (*this).dyna.actor);
        (*this).actionFunc =
            Some(func_8087E2D8 as
                     unsafe extern "C" fn(_: *mut BgHakaMeganeBG,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8087E2D8(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).dyna.actor.speedXZ, 30.0f32, 2.0f32);
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y, (*this).dyna.actor.speedXZ)
           != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_8087E34C(mut this: *mut BgHakaMeganeBG,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaMeganeBG_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgHakaMeganeBG = thisx as *mut BgHakaMeganeBG;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaMeganeBG_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHakaMeganeBG = thisx as *mut BgHakaMeganeBG;
    ...
    if params as libc::c_int == 0 as libc::c_int {
        Gfx_DrawDListXlu(globalCtx,
                         object_haka_objects_DL_008EB0.as_mut_ptr());
    } else { Gfx_DrawDListOpa(globalCtx, D_8087E410[params as usize]); };
}
