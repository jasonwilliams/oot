...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoWindmillSailsDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot01Fusya {
    pub actor: Actor,
    pub actionFunc: BgSpot01FusyaActionFunc,
    pub unk_150: [libc::c_char; 4],
    pub unk_154: f32_0,
    pub unk_158: f32_0,
    pub unk_15C: f32_0,
}
pub type BgSpot01FusyaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Fusya, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot01_Fusya_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT01_FUSYA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot01Fusya>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Fusya_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Fusya_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Fusya_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Fusya_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Fusya_SetupAction(mut this:
                                                       *mut BgSpot01Fusya,
                                                   mut actionFunc:
                                                       BgSpot01FusyaActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Fusya_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot01Fusya = thisx as *mut BgSpot01Fusya;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).unk_154 = 100.0f32;
    (*this).unk_158 = 100.0f32;
    (*this).unk_15C = 0.5f32;
    if gSaveContext.sceneSetupIndex < 4 as libc::c_int {
        gSaveContext.eventChkInf[6 as libc::c_int as usize] =
            (gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                 libc::c_int & 0xffdf as libc::c_int) as u16_0
    }
    BgSpot01Fusya_SetupAction(this,
                              Some(func_808AAA50 as
                                       unsafe extern "C" fn(_:
                                                                *mut BgSpot01Fusya,
                                                            _:
                                                                *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Fusya_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808AAA50(mut this: *mut BgSpot01Fusya,
    ...
    if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int &
        ...
        (*this).unk_158 = 1800.0f32
    }
    (*thisx).shape.rot.z =
        ((*thisx).shape.rot.z as libc::c_float + (*this).unk_154) as s16;
    temp = ((*this).unk_154 - 100.0f32) / 1700.0f32 + 1.0f32;
    func_800F436C(&mut (*thisx).projectedPos, 0x2085 as libc::c_int as u16_0,
                  temp);
    Math_ApproachF(&mut (*this).unk_154, (*this).unk_158, (*this).unk_15C,
                   100.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Fusya_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot01Fusya = thisx as *mut BgSpot01Fusya;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Fusya_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot01_fusya.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gKakarikoWindmillSailsDL.as_mut_ptr() as libc::c_uint;
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneScale as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(1300 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
