...
pub const GAMEOVER_REVIVE_FADE_OUT: C2RustUnnamed_20 = 24;
pub const GAMEOVER_REVIVE_WAIT_FAIRY: C2RustUnnamed_20 = 23;
pub const GAMEOVER_REVIVE_WAIT_GROUND: C2RustUnnamed_20 = 22;
pub const GAMEOVER_REVIVE_RUMBLE: C2RustUnnamed_20 = 21;
pub const GAMEOVER_REVIVE_START: C2RustUnnamed_20 = 20;
pub const GAMEOVER_DEATH_MENU: C2RustUnnamed_20 = 4;
pub const GAMEOVER_DEATH_DELAY_MENU: C2RustUnnamed_20 = 3;
pub const GAMEOVER_DEATH_WAIT_GROUND: C2RustUnnamed_20 = 2;
pub const GAMEOVER_DEATH_START: C2RustUnnamed_20 = 1;
pub const GAMEOVER_INACTIVE: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnOkarinaEffect {
    pub actor: Actor,
    pub timer: u16_0,
    pub actionFunc: EnOkarinaEffectActionFunc,
}
pub type EnOkarinaEffectActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnOkarinaEffect,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Okarina_Effect_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_OKARINA_EFFECT as libc::c_int as s16,
                          category:
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnOkarinaEffect>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnOkarinaEffect_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnOkarinaEffect_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnOkarinaEffect_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                                                                              ...
                                                                              ->
                                                                                  ())),
                          draw: None,}; // end gloomy sky
            init
        }
    };
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_SetupAction(mut this:
                                                         *mut EnOkarinaEffect,
                                                     mut actionFunc:
                                                         EnOkarinaEffectActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnOkarinaEffect = thisx as *mut EnOkarinaEffect;
    (*globalCtx).envCtx.unk_F2[0 as libc::c_int as usize] =
        0 as libc::c_int as u8_0;
    if gWeatherMode as libc::c_int != 4 as libc::c_int &&
           gWeatherMode as libc::c_int != 5 as libc::c_int &&
           (*globalCtx).envCtx.gloomySkyMode as libc::c_int ==
               1 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnOkarinaEffect = thisx as *mut EnOkarinaEffect;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Ocarina Storm Effect"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xaa\xe3\x82\xab\xe3\x83\xaa\xe3\x83\x8a\xe3\x81\x82\xe3\x82\x89\xe3\x81\x97\xe5\x8a\xb9\xe6\x9e\x9c\xe3\x83\x93\xe3\x82\xab\xe3\x83\x93\xe3\x82\xab\xe3\x83\x93\xe3\x82\xab\xe3\x80\x9c \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char); // 20 seconds
    osSyncPrintf(b"\n\n\x00" as *const u8 as
                     *const libc::c_char); // rain intensity target
    if (*globalCtx).envCtx.unk_EE[1 as libc::c_int as usize] as libc::c_int !=
           0 as libc::c_int {
        Actor_Kill(&mut (*this).actor); // start gloomy sky
    } // clear storms env flag
    EnOkarinaEffect_SetupAction(this,
                                Some(EnOkarinaEffect_TriggerStorm as
                                         unsafe extern "C" fn(_:
                                                                  *mut EnOkarinaEffect,
                                                              _:
                                                                  *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_TriggerStorm(mut this:
                                                          *mut EnOkarinaEffect,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    (*this).timer = 400 as libc::c_int as u16_0;
    (*globalCtx).envCtx.unk_F2[0 as libc::c_int as usize] =
        20 as libc::c_int as u8_0;
    (*globalCtx).envCtx.gloomySkyMode = 1 as libc::c_int as u8_0;
    if gWeatherMode as libc::c_int != 0 as libc::c_int ||
           (*globalCtx).envCtx.unk_17 as libc::c_int != 0 as libc::c_int {
        (*globalCtx).envCtx.unk_DE = 1 as libc::c_int as u8_0
    }
    (*globalCtx).envCtx.lightningMode =
        LIGHTNING_MODE_ON as libc::c_int as u8_0;
    func_80077624(globalCtx);
    EnOkarinaEffect_SetupAction(this,
                                Some(EnOkarinaEffect_ManageStorm as
                                         unsafe extern "C" fn(_:
                                                                  *mut EnOkarinaEffect,
                                                              _:
                                                                  *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_ManageStorm(mut this:
                                                         *mut EnOkarinaEffect,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    Flags_UnsetEnv(globalCtx, 5 as libc::c_int as s16);
    if (*globalCtx).pauseCtx.state as libc::c_int == 0 as libc::c_int &&
           ...
           (*this).timer as libc::c_int >= 250 as libc::c_int {
        if (*globalCtx).envCtx.indoors as libc::c_int != 0 ||
               (*globalCtx).envCtx.unk_1F as libc::c_int != 1 as libc::c_int {
            (*this).timer = (*this).timer.wrapping_sub(1)
        }
        osSyncPrintf(b"\nthis->timer=[%d]\x00" as *const u8 as
                         *const libc::c_char, (*this).timer as libc::c_int);
        if (*this).timer as libc::c_int == 308 as libc::c_int {
            osSyncPrintf(b"\n\n\n\xe8\xb1\x86\xe3\x82\x88 \xe3\x81\xae\xe3\x81\xb3\xe3\x82\x8d \xe6\x8c\x87\xe5\xae\x9a\n\n\n\x00"
                             as *const u8 as *const libc::c_char);
            Flags_SetEnv(globalCtx, 5 as libc::c_int as s16);
            // set storms env flag
        }
    }
    if D_8011FB38 as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        if (*globalCtx).csCtx.state as libc::c_int ==
            ...
            func_80077684(globalCtx);
        } else if func_800FA0B4(SEQ_PLAYER_BGM_MAIN as libc::c_int as u8_0) as
        ...
        osSyncPrintf(b"\n\n\nE_wether_flg=[%d]\x00" as *const u8 as
                         *const libc::c_char, gWeatherMode as libc::c_int);
        osSyncPrintf(b"\nrain_evt_trg=[%d]\n\n\x00" as *const u8 as
                         *const libc::c_char,
                     (*globalCtx).envCtx.gloomySkyMode as libc::c_int);
        if gWeatherMode as libc::c_int == 0 as libc::c_int &&
            ...
            (*globalCtx).envCtx.gloomySkyMode = 0 as libc::c_int as u8_0;
            (*globalCtx).envCtx.unk_DE = 0 as libc::c_int as u8_0
        }
        (*globalCtx).envCtx.lightningMode =
            LIGHTNING_MODE_LAST as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnOkarinaEffect_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut EnOkarinaEffect = thisx as *mut EnOkarinaEffect;
