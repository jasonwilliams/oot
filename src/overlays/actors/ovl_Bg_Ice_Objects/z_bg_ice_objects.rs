...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ice_objects_DL_000190: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_Col_0003F0: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgIceObjects {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgIceObjectsActionFunc,
    pub targetPos: Vec3f,
}
pub type BgIceObjectsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgIceObjects, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Bg_Ice_Objects_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_ICE_OBJECTS as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgIceObjects>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceObjects_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceObjects_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceObjects_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceObjects_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgIceObjects = thisx as *mut BgIceObjects;
    ...
    CollisionHeader_GetVirtual(&mut object_ice_objects_Col_0003F0 as
                                   *mut CollisionHeader as *mut libc::c_void,
                               &mut colHeader);
    Math_Vec3f_Copy(&mut (*this).targetPos, &mut (*this).dyna.actor.home.pos);
    (*this).actionFunc =
        Some(BgIceObjects_Idle as
                 unsafe extern "C" fn(_: *mut BgIceObjects,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgIceObjects = thisx as *mut BgIceObjects;
...
static mut sXStarts: [s16; 7] =
    [-(1060 as libc::c_int) as s16, -(1200 as libc::c_int) as s16,
     -(1240 as libc::c_int) as s16, -(1387 as libc::c_int) as s16,
     -(1580 as libc::c_int) as s16, -(1680 as libc::c_int) as s16,
     -(1780 as libc::c_int) as s16];
static mut sZStarts: [s16; 7] =
    [-(580 as libc::c_int) as s16, -(660 as libc::c_int) as s16,
     -(780 as libc::c_int) as s16, -(820 as libc::c_int) as s16,
     -(860 as libc::c_int) as s16, -(900 as libc::c_int) as s16,
     -(1087 as libc::c_int) as s16];
static mut sZStops: [[s16; 2]; 7] =
    [[-(580 as libc::c_int) as s16, -(1087 as libc::c_int) as s16],
     [-(780 as libc::c_int) as s16, -(1260 as libc::c_int) as s16],
     [-(340 as libc::c_int) as s16, -(820 as libc::c_int) as s16],
     [-(260 as libc::c_int) as s16, -(1260 as libc::c_int) as s16],
     [-(340 as libc::c_int) as s16, -(860 as libc::c_int) as s16],
     [-(660 as libc::c_int) as s16, -(1260 as libc::c_int) as s16],
     [-(340 as libc::c_int) as s16, -(740 as libc::c_int) as s16]];
static mut sXStops: [[s16; 2]; 7] =
    [[-(860 as libc::c_int) as s16, -(1580 as libc::c_int) as s16],
     [-(1240 as libc::c_int) as s16, -(1780 as libc::c_int) as s16],
     [-(860 as libc::c_int) as s16, -(1680 as libc::c_int) as s16],
     [-(860 as libc::c_int) as s16, -(1680 as libc::c_int) as s16],
     [-(1387 as libc::c_int) as s16, -(1680 as libc::c_int) as s16],
     [-(860 as libc::c_int) as s16, -(1200 as libc::c_int) as s16],
     [-(860 as libc::c_int) as s16, -(1800 as libc::c_int) as s16]];
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_SetNextTarget(mut this:
                                                        *mut BgIceObjects,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut x16: s16 = 0; // needed to match
    let mut z16: s16 = 0 as libc::c_int as s16;
    let mut i: s32 = 0;
    if (*this).dyna.unk_158 as libc::c_int == 0 as libc::c_int ||
           (*this).dyna.unk_158 as libc::c_int == -(0x8000 as libc::c_int) {
        x16 = (*this).dyna.actor.world.pos.x as s16;
        i = 0 as libc::c_int;
        while i < 7 as libc::c_int {
            if x16 as libc::c_int == sXStarts[i as usize] as libc::c_int {
                z16 =
                    if (*this).dyna.unk_158 as libc::c_int == 0 as libc::c_int
                       {
                        sZStops[i as usize][0 as libc::c_int as usize] as
                            libc::c_int
                    } else {
                        sZStops[i as usize][1 as libc::c_int as usize] as
                            libc::c_int
                    } as s16;
                (*this).targetPos.z = z16 as f32_0;
                return
            }
            i += 1
        }
        (*this).targetPos.z =
            if (*this).dyna.unk_158 as libc::c_int == 0 as libc::c_int {
                -(340 as libc::c_int)
            } else { -(1260 as libc::c_int) } as f32_0
    } else {
        z16 = (*this).dyna.actor.world.pos.z as s16;
        i = 0 as libc::c_int;
        while i < 7 as libc::c_int {
            if z16 as libc::c_int == sZStarts[i as usize] as libc::c_int {
                x16 =
                    if (*this).dyna.unk_158 as libc::c_int ==
                           0x4000 as libc::c_int {
                        sXStops[i as usize][0 as libc::c_int as usize] as
                            libc::c_int
                    } else {
                        sXStops[i as usize][1 as libc::c_int as usize] as
                            libc::c_int
                    } as s16;
                (*this).targetPos.x = x16 as f32_0;
                return
            }
            i += 1
        }
        (*this).targetPos.x =
            if (*this).dyna.unk_158 as libc::c_int == 0x4000 as libc::c_int {
                -(860 as libc::c_int)
            } else { -(1780 as libc::c_int) } as f32_0
    };
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_CheckPits(mut this: *mut BgIceObjects,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if (*thisx).velocity.y > 0.0f32 ||
           (*thisx).world.pos.x <= -1660.0f32 &&
               (*thisx).world.pos.z <= -1060.0f32 ||
           (*thisx).world.pos.x <= -1580.0f32 &&
               (*thisx).world.pos.z >= -420.0f32 ||
           (*thisx).world.pos.x >= -980.0f32 &&
               (*thisx).world.pos.z <= -1180.0f32 ||
           (*thisx).world.pos.x >= -860.0f32 &&
               (*thisx).world.pos.z >= -700.0f32 {
        (*thisx).velocity.y += 1.0f32;
        if Math_StepToF(&mut (*thisx).world.pos.y, -300.0f32,
                        (*thisx).velocity.y) != 0 {
            (*thisx).velocity.y = 0.0f32;
            (*thisx).world.pos.x = (*thisx).home.pos.x;
            (*thisx).world.pos.y = (*thisx).home.pos.y - 60.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Idle(mut this: *mut BgIceObjects,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    if (*this).dyna.unk_150 != 0.0f32 {
        ...
        if (*this).dyna.unk_150 > 0.0f32 && Player_InCsMode(globalCtx) == 0 {
            BgIceObjects_SetNextTarget(this, globalCtx);
            if Actor_WorldDistXZToPoint(thisx, &mut (*this).targetPos) >
                   1.0f32 {
                (*thisx).flags |=
                    ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
                func_8002DF54(globalCtx, thisx, 8 as libc::c_int as u8_0);
                (*thisx).params = 1 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(BgIceObjects_Slide as
                             unsafe extern "C" fn(_: *mut BgIceObjects,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Slide(mut this: *mut BgIceObjects,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    if atTarget != 0 {
        ...
        (*thisx).params = 0 as libc::c_int as s16;
        func_8002DF54(globalCtx, thisx, 7 as libc::c_int as u8_0);
        Audio_PlayActorSound2(thisx, 0x2835 as libc::c_int as u16_0);
        if fabsf((*thisx).world.pos.x + 1387.0f32) < 1.0f32 &&
               fabsf((*thisx).world.pos.z + 260.0f32) < 1.0f32 {
            (*this).actionFunc =
                Some(BgIceObjects_Stuck as
                         unsafe extern "C" fn(_: *mut BgIceObjects,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
    ...
    } else if (*thisx).speedXZ > 6.0f32 && (*thisx).world.pos.y >= 0.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Reset(mut this: *mut BgIceObjects,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Math_StepToF(&mut (*thisx).world.pos.y, (*thisx).home.pos.y, 1.0f32) !=
        ...
        (*thisx).flags &=
            !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
        Math_Vec3f_Copy(&mut (*this).targetPos, &mut (*thisx).home.pos);
        (*this).actionFunc =
            Some(BgIceObjects_Idle as
                     unsafe extern "C" fn(_: *mut BgIceObjects,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Stuck(mut this: *mut BgIceObjects,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgIceObjects = thisx as *mut BgIceObjects;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceObjects_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgIceObjects = thisx as *mut BgIceObjects;
    Gfx_DrawDListOpa(globalCtx, object_ice_objects_DL_000190.as_mut_ptr());
}
