...
extern "C" {
    ...
    #[no_mangle]
    static mut object_dog_Anim_000278: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Anim_000928: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Anim_000C28: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Anim_000D78: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Anim_001150: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Anim_001368: AnimationHeader;
    #[no_mangle]
    static mut object_dog_Skel_007290: FlexSkeletonHeader;
}
...
pub struct EnDog {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDogActionFunc,
    ...
    pub unusedAngle: s16,
    pub pad1: s16,
    pub behaviorTimer: s16,
    pub pad2: s16,
    pub nextBehavior: s16,
    pub behavior: s16,
    pub jointTable: [Vec3s; 13],
    pub morphTable: [Vec3s; 13],
}
pub type EnDogActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDog, _: *mut GlobalContext) -> ()>;
pub const DOG_BARK: C2RustUnnamed_22 = 2;
pub const DOG_BOW: C2RustUnnamed_22 = 5;
pub const DOG_SIT: C2RustUnnamed_22 = 3;
pub const DOG_WALK: C2RustUnnamed_22 = 0;
pub const DOG_BOW_2: C2RustUnnamed_22 = 6;
pub const DOG_RUN: C2RustUnnamed_22 = 1;
pub const DOG_SIT_2: C2RustUnnamed_22 = 4;
pub type C2RustUnnamed_22 = libc::c_uint;
#[no_mangle]
pub static mut En_Dog_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DOG as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_DOG as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDog>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_PlayWalkSFX(mut this: *mut EnDog) {
    let mut walk: *mut AnimationHeader = &mut object_dog_Anim_001368;
    if (*this).skelAnime.animation == walk as *mut libc::c_void {
        if (*this).skelAnime.curFrame == 1.0f32 ||
               (*this).skelAnime.curFrame == 7.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_PlayRunSFX(mut this: *mut EnDog) {
    let mut run: *mut AnimationHeader = &mut object_dog_Anim_000D78;
    if (*this).skelAnime.animation == run as *mut libc::c_void {
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_PlayBarkSFX(mut this: *mut EnDog) {
    let mut bark: *mut AnimationHeader = &mut object_dog_Anim_000278;
    if (*this).skelAnime.animation == bark as *mut libc::c_void {
        if (*this).skelAnime.curFrame == 13.0f32 ||
               (*this).skelAnime.curFrame == 19.0f32 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28d8 as libc::c_int as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_PlayAnimAndSFX(mut this: *mut EnDog) -> s32 {
    let mut animation: s32 = 0;
    if (*this).behavior as libc::c_int != (*this).nextBehavior as libc::c_int
       {
        if (*this).nextBehavior as libc::c_int == DOG_SIT_2 as libc::c_int {
            (*this).nextBehavior = DOG_SIT as libc::c_int as s16
        }
        if (*this).nextBehavior as libc::c_int == DOG_BOW_2 as libc::c_int {
            (*this).nextBehavior = DOG_BOW as libc::c_int as s16
        }
        (*this).behavior = (*this).nextBehavior;
        match (*this).behavior as libc::c_int {
            0 => { animation = 1 as libc::c_int }
            1 => { animation = 2 as libc::c_int }
            2 => { animation = 3 as libc::c_int }
            3 => { animation = 4 as libc::c_int }
            5 => { animation = 6 as libc::c_int }
            _ => { }
        }
    ...
    match (*this).behavior as libc::c_int {
        3 => {
            if Animation_OnFrame(&mut (*this).skelAnime,
                ...
                (*this).nextBehavior = DOG_SIT_2 as libc::c_int as s16;
                (*this).behavior = (*this).nextBehavior
            }
        }
        5 => {
            if Animation_OnFrame(&mut (*this).skelAnime,
                ...
                (*this).nextBehavior = DOG_BOW_2 as libc::c_int as s16;
                (*this).behavior = (*this).nextBehavior
            }
        }
        0 => { EnDog_PlayWalkSFX(this); }
        1 => { EnDog_PlayRunSFX(this); }
        2 => { EnDog_PlayBarkSFX(this); !this.is_null(); }
        _ => { }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_CanFollow(mut this: *mut EnDog,
 ...
 -> s8 {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        return 2 as libc::c_int as s8
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_MARKET_DAY as libc::c_int
       {
        return 0 as libc::c_int as s8
    }
    if (*this).collider.base.ocFlags2 as libc::c_int &
        ...
        gSaveContext.dogParams =
            ((*this).actor.params as libc::c_int & 0x7fff as libc::c_int) as
                s16;
        return 1 as libc::c_int as s8
    }
    return 0 as libc::c_int as s8;
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_UpdateWaypoint(mut this: *mut EnDog,
                                              mut globalCtx:
    ...
    } else { change = 1 as libc::c_int }
    (*this).waypoint = ((*this).waypoint as libc::c_int + change) as s16;
    if (*this).reverse != 0 {
        if ((*this).waypoint as libc::c_int) < 0 as libc::c_int {
            (*this).waypoint =
                ((*(*this).path).count as libc::c_int - 1 as libc::c_int) as
                    s16
        }
    } else if ((*(*this).path).count as libc::c_int - 1 as libc::c_int) <
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_Orient(mut this: *mut EnDog,
                                      mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut targetYaw: s16 = 0;
    let mut waypointDistSq: f32_0 = 0.;
    waypointDistSq =
        Path_OrientAndGetDistSq(&mut (*this).actor, (*this).path,
                                (*this).waypoint, &mut targetYaw);
    ...
    if waypointDistSq > 0.0f32 && waypointDistSq < 1000.0f32 {
        return EnDog_UpdateWaypoint(this, globalCtx)
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDog = thisx as *mut EnDog;
    let mut followingDog: s16 = 0;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_dog_Skel_007290, 0 as *mut AnimationHeader,
    ...
    if (*this).actor.params as libc::c_int & 0x8000 as libc::c_int ==
           0 as libc::c_int {
        (*this).actor.params =
            ((*this).actor.params as libc::c_int & 0xf0ff as libc::c_int |
                 ((((*this).actor.params as libc::c_int &
                        0xf00 as libc::c_int) >> 8 as libc::c_int) +
                      1 as libc::c_int) << 8 as libc::c_int) as s16
    }
    followingDog =
        ((gSaveContext.dogParams as libc::c_int & 0xf00 as libc::c_int) >>
             8 as libc::c_int) as s16;
    if followingDog as libc::c_int ==
    ...
    Actor_SetScale(&mut (*this).actor, 0.0075f32);
    (*this).waypoint = 0 as libc::c_int as s16;
    ...
    match (*globalCtx).sceneNum as libc::c_int {
        ...
        53 => {
            // Richard's Home
            if ((*this).actor.params as libc::c_int & 0x8000 as libc::c_int)
                   as u32_0 == 0 as libc::c_int as libc::c_uint {
                if gSaveContext.dogIsLost == 0 {
                    (*this).nextBehavior = DOG_SIT as libc::c_int as s16;
                    (*this).actionFunc =
                        Some(EnDog_Wait as
                                 unsafe extern "C" fn(_: *mut EnDog,
                                                      _: *mut GlobalContext)
                                     -> ());
    ...
    if ((*this).actor.params as libc::c_int & 0x8000 as libc::c_int) as u32_0
           != 0 as libc::c_int as libc::c_uint {
        (*this).nextBehavior = DOG_WALK as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDog_FollowLink as
                     unsafe extern "C" fn(_: *mut EnDog,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).nextBehavior = DOG_SIT as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDog_ChooseMovement as
                     unsafe extern "C" fn(_: *mut EnDog,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDog = thisx as *mut EnDog;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_FollowPath(mut this: *mut EnDog,
                                          mut globalCtx: *mut GlobalContext) {
    let mut behaviors: [s32; 3] =
        [DOG_SIT as libc::c_int, DOG_BOW as libc::c_int,
         DOG_BARK as libc::c_int];
    let mut unused: [s32; 3] =
        [40 as libc::c_int, 80 as libc::c_int, 20 as libc::c_int];
    let mut speed: f32_0 = 0.;
    let mut frame: s32 = 0;
    if EnDog_CanFollow(this, globalCtx) as libc::c_int == 1 as libc::c_int {
        (*this).actionFunc =
            Some(EnDog_FollowLink as
                     unsafe extern "C" fn(_: *mut EnDog,
                                          _: *mut GlobalContext) -> ())
    }
    if (if (*this).behaviorTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).behaviorTimer -= 1;
            (*this).behaviorTimer as libc::c_int
        }) != 0 as libc::c_int {
        if (*this).nextBehavior as libc::c_int == DOG_WALK as libc::c_int {
            speed = 1.0f32
        } else { speed = 4.0f32 }
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, speed, 0.4f32, 1.0f32,
                           0.0f32);
        ...
        frame =
            (*globalCtx).state.frames.wrapping_rem(3 as libc::c_int as
                                                       libc::c_uint) as s32;
        (*this).nextBehavior = behaviors[frame as usize] as s16;
        ...
        (*this).behaviorTimer =
            Rand_S16Offset(60 as libc::c_int as s16,
                           behaviors[frame as usize] as s16);
        (*this).actionFunc =
            Some(EnDog_ChooseMovement as
                     unsafe extern "C" fn(_: *mut EnDog,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_ChooseMovement(mut this: *mut EnDog,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if EnDog_CanFollow(this, globalCtx) as libc::c_int == 1 as libc::c_int {
        (*this).actionFunc =
    ...
    if (if (*this).behaviorTimer as libc::c_int == 0 as libc::c_int {
        ...
        if (*globalCtx).state.frames.wrapping_rem(2 as libc::c_int as
                                                      libc::c_uint) != 0 {
            (*this).nextBehavior = DOG_WALK as libc::c_int as s16
        } else { (*this).nextBehavior = DOG_RUN as libc::c_int as s16 }
        if (*this).nextBehavior as libc::c_int == DOG_RUN as libc::c_int {
            (*this).behaviorTimer =
                ((*this).behaviorTimer as libc::c_int / 2 as libc::c_int) as
                    s16
        }
        (*this).actionFunc =
            Some(EnDog_FollowPath as
                     unsafe extern "C" fn(_: *mut EnDog,
                                          _: *mut GlobalContext) -> ())
    }
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.4f32, 1.0f32,
                       0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnDog_FollowLink(mut this: *mut EnDog,
                                          mut globalCtx: *mut GlobalContext) {
    let mut speed: f32_0 = 0.;
    if gSaveContext.dogParams as libc::c_int == 0 as libc::c_int {
        (*this).nextBehavior = DOG_SIT as libc::c_int as s16;
    ...
    if (*this).actor.xzDistToPlayer > 400.0f32 {
        if (*this).nextBehavior as libc::c_int != DOG_SIT as libc::c_int &&
               (*this).nextBehavior as libc::c_int != DOG_SIT_2 as libc::c_int
           {
            (*this).nextBehavior = DOG_BOW as libc::c_int as s16
        }
        ...
        (*this).nextBehavior = DOG_RUN as libc::c_int as s16;
        speed = 4.0f32
    } else if (*this).actor.xzDistToPlayer < 40.0f32 {
        if (*this).nextBehavior as libc::c_int != DOG_BOW as libc::c_int &&
               (*this).nextBehavior as libc::c_int != DOG_BOW_2 as libc::c_int
           {
            (*this).nextBehavior = DOG_BOW as libc::c_int as s16
        }
        speed = 0.0f32
    ...
    Math_ApproachF(&mut (*this).actor.speedXZ, speed, 0.6f32, 1.0f32);
    if !((*this).actor.xzDistToPlayer > 400.0f32) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_RunAway(mut this: *mut EnDog,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.xzDistToPlayer < 200.0f32 {
        Math_ApproachF(&mut (*this).actor.speedXZ, 4.0f32, 0.6f32, 1.0f32);
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_FaceLink(mut this: *mut EnDog,
                                        mut globalCtx: *mut GlobalContext) {
    let mut rotTowardLink: s16 = 0;
    let mut prevRotY: s16 = 0;
    let mut absAngleDiff: f32_0 = 0.;
    // if the dog is more than 200 units away from Link, turn to face him then wait
    if 200.0f32 <= (*this).actor.xzDistToPlayer {
        (*this).nextBehavior = DOG_WALK as libc::c_int as s16;
        Math_ApproachF(&mut (*this).actor.speedXZ, 1.0f32, 0.6f32, 1.0f32);
        rotTowardLink = (*this).actor.yawTowardsPlayer;
        prevRotY = (*this).actor.world.rot.y;
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y, rotTowardLink,
                           10 as libc::c_int as s16,
                           1000 as libc::c_int as s16,
                           1 as libc::c_int as s16);
        absAngleDiff = (*this).actor.world.rot.y as f32_0;
        absAngleDiff -= prevRotY as libc::c_int as libc::c_float;
        absAngleDiff = fabsf(absAngleDiff);
        if absAngleDiff < 200.0f32 {
            (*this).nextBehavior = DOG_SIT as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDog_Wait as
                         unsafe extern "C" fn(_: *mut EnDog,
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_Wait(mut this: *mut EnDog,
                                    mut globalCtx: *mut GlobalContext) {
    (*this).unusedAngle =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDog = thisx as *mut EnDog;
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDog_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDog = thisx as *mut EnDog;
    let mut colors: [Color_RGBA8; 2] =
        [{
             let mut init =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dog.c\x00" as *const u8 as *const libc::c_char,
                    972 as libc::c_int);
    ...
    (*_g_0).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_0).words.w1 =
        (colors[((*this).actor.params as libc::c_int & 0xf as libc::c_int) as
                    usize].r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (colors[((*this).actor.params as libc::c_int & 0xf as libc::c_int)
                        as usize].g as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnDog_OverrideLimbDraw as
