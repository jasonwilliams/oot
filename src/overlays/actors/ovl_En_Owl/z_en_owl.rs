...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002F1C4(actor: *mut Actor, globalCtx: *mut GlobalContext,
                     arg2: f32_0, arg3: f32_0, arg4: u32_0) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_800F4414(pos: *mut Vec3f, sfxId: u16_0, _: f32_0);
    #[no_mangle]
    fn func_800F44EC(arg0: s8, arg1: s8);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gOwlTakeoffAnim: AnimationHeader;
    #[no_mangle]
    static mut gOwlFlyAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjOwlEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gObjOwlEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gObjOwlEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gOwlFlyingSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gOwlGlideAnim: AnimationHeader;
    #[no_mangle]
    static mut gOwlUnfoldWingsAnim: AnimationHeader;
    #[no_mangle]
    static mut gOwlPerchAnim: AnimationHeader;
    #[no_mangle]
    static mut gOwlPerchingSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gLakeHyliaOwlCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gDMTOwlCs: [CutsceneData; 0];
}
...
pub const ICHAINTYPE_VEC3S: C2RustUnnamed_25 = 10;
pub const ICHAINTYPE_VEC3F_DIV1000: C2RustUnnamed_25 = 9;
pub const ICHAINTYPE_VEC3F: C2RustUnnamed_25 = 8;
pub const ICHAINTYPE_F32_DIV1000: C2RustUnnamed_25 = 7;
pub const ICHAINTYPE_F32: C2RustUnnamed_25 = 6;
pub const ICHAINTYPE_S32: C2RustUnnamed_25 = 5;
pub const ICHAINTYPE_U32: C2RustUnnamed_25 = 4;
pub const ICHAINTYPE_S16: C2RustUnnamed_25 = 3;
pub const ICHAINTYPE_U16: C2RustUnnamed_25 = 2;
pub const ICHAINTYPE_S8: C2RustUnnamed_25 = 1;
pub const ICHAINTYPE_U8: C2RustUnnamed_25 = 0;
...
pub struct EnOwl {
    ...
    pub skelAnime2: SkelAnime,
    pub jointTable2: [Vec3s; 16],
    pub morphTable2: [Vec3s; 16],
    pub curSkelAnime: *mut SkelAnime,
    pub eye: Vec3f,
    pub unk_3EC: s16,
    pub unk_3EE: s16,
    pub unk_3F0: s16,
    ...
    pub unk_40A: u8_0,
    pub unk_40B: u8_0,
    pub actionFunc: EnOwlActionFunc,
    pub unk_410: OwlFunc,
}
pub type OwlFunc = Option<unsafe extern "C" fn(_: *mut EnOwl) -> ()>;
pub type EnOwlActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnOwl, _: *mut GlobalContext) -> ()>;
pub const OWL_OK: C2RustUnnamed_28 = 1;
pub const OWL_REPEAT: C2RustUnnamed_28 = 0;
pub const OWL_LOST_WOODS_POSTSARIA: C2RustUnnamed_27 = 12;
pub const OWL_LOST_WOODS_PRESARIA: C2RustUnnamed_27 = 11;
pub const OWL_DESSERT_COLOSSUS: C2RustUnnamed_27 = 10;
pub const OWL_DEATH_MOUNTAIN2: C2RustUnnamed_27 = 9;
pub const OWL_DEATH_MOUNTAIN: C2RustUnnamed_27 = 8;
pub const OWL_HYLIA_SHORTCUT: C2RustUnnamed_27 = 7;
pub const OWL_ZORA_RIVER: C2RustUnnamed_27 = 6;
pub const OWL_LAKE_HYLIA: C2RustUnnamed_27 = 5;
pub const OWL_HYLIA_GERUDO: C2RustUnnamed_27 = 4;
pub const OWL_KAKARIKO: C2RustUnnamed_27 = 3;
pub const OWL_HYRULE_CASTLE: C2RustUnnamed_27 = 2;
pub const OWL_OUTSIDE_KOKIRI: C2RustUnnamed_27 = 1;
pub const OWL_DEFAULT: C2RustUnnamed_27 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub type C2RustUnnamed_28 = libc::c_uint;
#[no_mangle]
pub static mut En_Owl_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_OWL as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_OWL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnOwl>() as libc::c_ulong,
                          init:
...
static mut sOwlCylinderInit: ColliderCylinderInit =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOwl = thisx as *mut EnOwl;
    let mut collider: *mut ColliderCylinder = 0 as *mut ColliderCylinder;
    let mut owlType: s32 = 0;
    let mut switchFlag: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*this).actor.shape, 0 as libc::c_int as f32_0,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 36.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gOwlFlyingSkel,
                       &mut gOwlFlyAnim, (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 21 as libc::c_int);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime2,
                       &mut gOwlPerchingSkel, &mut gOwlPerchAnim,
                       (*this).jointTable2.as_mut_ptr(),
                       (*this).morphTable2.as_mut_ptr(), 16 as libc::c_int);
    Collider_InitCylinder(globalCtx, &mut (*this).collider);
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sOwlCylinderInit);
    (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).actor.minVelocityY = -10.0f32;
    (*this).actor.targetArrowOffset = 500.0f32;
    EnOwl_ChangeMode(this,
                     Some(EnOwl_WaitDefault as
                              unsafe extern "C" fn(_: *mut EnOwl,
                                                   _: *mut GlobalContext)
                                  -> ()),
                     Some(func_80ACC540 as
                              unsafe extern "C" fn(_: *mut EnOwl) -> ()),
                     &mut (*this).skelAnime2, &mut gOwlPerchAnim, 0.0f32);
    (*this).unk_409 = 0 as libc::c_int as u8_0;
    (*this).unk_406 = (*this).unk_409;
    (*this).actionFlags = (*this).unk_406 as u16_0;
    (*this).unk_405 = 4 as libc::c_int as u8_0;
    (*this).unk_407 = 0 as libc::c_int as u8_0;
    (*this).unk_404 = (*this).unk_407;
    (*this).unk_408 = 4 as libc::c_int as u8_0;
    owlType =
        ((*this).actor.params as libc::c_int & 0xfc0 as libc::c_int) >>
            6 as libc::c_int;
    switchFlag = (*this).actor.params as libc::c_int & 0x3f as libc::c_int;
    if (*this).actor.params as libc::c_int == 0xfff as libc::c_int {
        owlType = OWL_OUTSIDE_KOKIRI as libc::c_int;
        switchFlag = 0x20 as libc::c_int
    }
    // "conversation owl %4x no = %d, sv = %d"
    osSyncPrintf(b"\x1b[36m \xe4\xbc\x9a\xe8\xa9\xb1\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6 %4x no = %d, sv = %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int, owlType,
                 switchFlag); // "Save owl with savebit"
    if owlType != OWL_DEFAULT as libc::c_int &&
           switchFlag < 0x20 as libc::c_int &&
           Flags_GetSwitch(globalCtx, switchFlag) != 0 {
        osSyncPrintf(b"savebit\xe3\x81\xa7\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6\xe9\x80\x80\xe9\x81\xbf\n\x00"
                         as *const u8 as *const libc::c_char);
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).unk_3EE = 0 as libc::c_int as s16;
    ...
    match owlType {
        0 => {
            ...
            (*this).unk_40A = 0 as libc::c_int as u8_0
        }
        1 => {
            (*this).actionFunc =
                Some(EnOwl_WaitOutsideKokiri as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        2 => {
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 2 as libc::c_int) as
                    u16_0;
            (*this).unk_3EE = 0x20 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnOwl_WaitHyruleCastle as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        3 => {
            if gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                ...
                // has zelda's letter
                osSyncPrintf(b"\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6\xe9\x80\x80\xe9\x81\xbf\n\x00"
                                 as *const u8 as
                                 *const libc::c_char); // "Owl evacuation"
                Actor_Kill(&mut (*this).actor);
                return
            }
            (*this).actionFunc =
                Some(EnOwl_WaitKakariko as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        4 => {
            ...
            (*this).actionFunc =
                Some(EnOwl_WaitGerudo as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        5 => {
            (*this).actionFunc =
                Some(EnOwl_WaitLakeHylia as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        6 => {
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                ...
                osSyncPrintf(b"\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6\xe9\x80\x80\xe9\x81\xbf\n\x00"
                                 as *const u8 as
                                 *const libc::c_char); // "Owl evacuation"
                Actor_Kill(&mut (*this).actor); // "Owl evacuation"
                return
            } // "Owl evacuation"
            (*this).actionFunc =
                Some(EnOwl_WaitZoraRiver as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        7 => {
            (*this).actionFunc =
                Some(EnOwl_WaitHyliaShortcut as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ());
        ...
        8 => {
            (*this).actionFunc =
                Some(EnOwl_WaitDeathMountainShortcut as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
        9 => {
        ...
        _ => {
            ...
            osSyncPrintf(b"no = %d  \n\x00" as *const u8 as
                             *const libc::c_char, owlType);
            // "Unfinished owl unfinished owl unfinished owl"
            osSyncPrintf(b"\n\x00"
                             as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOwl = thisx as *mut EnOwl;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnOwl_LookAtLink(mut this: *mut EnOwl,
                                          mut globalCtx: *mut GlobalContext) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnOwl_CheckInitTalk(mut this: *mut EnOwl,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut textId: u16_0,
                                             mut targetDist: f32_0,
                                             mut flags: u16_0) -> s32 {
    let mut timer: s32 = 0;
    let mut distCheck: f32_0 = 0.;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.params as libc::c_int == 0xfff as libc::c_int {
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 0x40 as libc::c_int) as
                    u16_0;
            timer = -(100 as libc::c_int)
        } else if Rand_ZeroOne() < 0.5f32 {
            timer =
                if flags as libc::c_int & 1 as libc::c_int != 0 {
                    -(97 as libc::c_int)
                } else { -(99 as libc::c_int) };
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 0x40 as libc::c_int) as
                    u16_0
        } else {
            timer =
                if flags as libc::c_int & 1 as libc::c_int != 0 {
                    -(96 as libc::c_int)
                } else { -(98 as libc::c_int) };
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int & !(0x40 as libc::c_int))
                    as u16_0
        }
        (*this).cameraIdx =
            OnePointCutscene_Init(globalCtx, 8700 as libc::c_int as s16,
                                  timer as s16, &mut (*this).actor,
        ...
        if (*this).actor.xzDistToPlayer < targetDist {
            ...
            func_8002F1C4(&mut (*this).actor, globalCtx, targetDist,
                          distCheck, 0 as libc::c_int as u32_0);
        }
        return 0 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACA558(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext,
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        if (*this).actor.xzDistToPlayer < 120.0f32 {
            func_8002F1C4(&mut (*this).actor, globalCtx, 350.0f32, 1000.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACA5C8(mut this: *mut EnOwl) {
    EnOwl_ChangeMode(this,
                     Some(func_80ACBEA0 as
                              unsafe extern "C" fn(_: *mut EnOwl,
                                                   _: *mut GlobalContext)
                                  -> ()),
                     Some(func_80ACC540 as
                              unsafe extern "C" fn(_: *mut EnOwl) -> ()),
                     &mut (*this).skelAnime, &mut gOwlUnfoldWingsAnim,
                     0.0f32);
    (*this).eyeTexIndex = 0 as libc::c_int as s16;
    (*this).blinkTimer =
        Rand_S16Offset(60 as libc::c_int as s16, 60 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACA62C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut switchFlag: s32 =
        (*this).actor.params as libc::c_int & 0x3f as libc::c_int;
    if switchFlag < 0x20 as libc::c_int {
        Flags_SetSwitch(globalCtx, switchFlag);
        osSyncPrintf(b"\x1b[36m Actor_Environment_sw = %d\n\x1b[m\x00" as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACA690(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_3EE as libc::c_int & 0x3f as libc::c_int ==
           0 as libc::c_int {
        func_80ACA62C(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACA6C0(mut this: *mut EnOwl) {
    if Rand_CenteredFloat(1.0f32) < 0.0f32 {
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int | 0x20 as libc::c_int) as
                u16_0
    } else {
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int & !(0x20 as libc::c_int)) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACA71C(mut this: *mut EnOwl) {
    func_80ACA6C0(this);
    (*this).unk_3F2 = 0 as libc::c_int as s16;
    (*this).actionFlags =
        ((*this).actionFlags as libc::c_int | 0x10 as libc::c_int) as u16_0;
    (*this).unk_408 = 4 as libc::c_int as u8_0;
    (*this).unk_404 = 0 as libc::c_int as u8_0;
    (*this).unk_406 = 0 as libc::c_int as u8_0;
    (*this).unk_405 = 4 as libc::c_int as u8_0;
    (*this).unk_407 = (*this).unk_3F2 as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACA76C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
                               (SEQ_PLAYER_FANFARE as libc::c_int) <<
                                   24 as libc::c_int | 0xff as libc::c_int) as
                              u32_0);
        func_80ACA62C(this, globalCtx);
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACA7E0(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002DF54(globalCtx, &mut (*this).actor, 8 as libc::c_int as u8_0);
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_ConfirmKokiriMessage(mut this: *mut EnOwl,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x2065 as libc::c_int as u16_0);
            }
            1 => {
                Message_ContinueTextbox(globalCtx,
                                        0x2067 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACA76C as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitOutsideKokiri(mut this: *mut EnOwl,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x2064 as libc::c_int as u16_0,
                           360.0f32, 0 as libc::c_int as u16_0) != 0 {
        // Sets BGM
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnOwl_ConfirmKokiriMessage as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACA998(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x2069 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACAA54 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
            1 => {
                Message_ContinueTextbox(globalCtx,
                                        0x206b as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACA7E0 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACAA54(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x206a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACA998 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int | 2 as libc::c_int) as u16_0;
        func_80ACA71C(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACAAC0(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x2069 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACAA54 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitHyruleCastle(mut this: *mut EnOwl,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x2068 as libc::c_int as u16_0,
                           540.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACAAC0 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACAB88(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                       libc::c_int & 1 as libc::c_int != 0 {
                    Message_ContinueTextbox(globalCtx,
                                            0x206d as libc::c_int as u16_0);
                } else {
                    Message_ContinueTextbox(globalCtx,
                                            0x206c as libc::c_int as u16_0);
                }
                (*this).actionFunc =
                    Some(func_80ACAC6C as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACAC6C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitKakariko(mut this: *mut EnOwl,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x206c as libc::c_int as u16_0,
                           480.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACAC6C as
                     unsafe extern "C" fn(_: *mut EnOwl,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACAD34(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x206f as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACADF0 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACADF0(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitGerudo(mut this: *mut EnOwl,
                                          mut globalCtx: *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x206f as libc::c_int as u16_0,
                           360.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACADF0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACAEB8(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x2071 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACAF74 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACAF74(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitLakeHylia(mut this: *mut EnOwl,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x2071 as libc::c_int as u16_0,
                           360.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACAF74 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB03C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002DF54(globalCtx, &mut (*this).actor, 8 as libc::c_int as u8_0);
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitZoraRiver(mut this: *mut EnOwl,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if gBitFlags[QUEST_SONG_SARIA as libc::c_int as usize] &
        ...
        if gBitFlags[QUEST_SONG_LULLABY as libc::c_int as usize] &
               gSaveContext.inventory.questItems != 0 {
            textId = 0x4031 as libc::c_int as u16_0
        } else { textId = 0x4017 as libc::c_int as u16_0 }
    } else { textId = 0x4002 as libc::c_int as u16_0 }
    if EnOwl_CheckInitTalk(this, globalCtx, textId, 360.0f32,
                           0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB03C as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACB148(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
                               (SEQ_PLAYER_FANFARE as libc::c_int) <<
        ...
        func_80ACA5C8(this);
        (*this).actionFunc =
            Some(func_80ACC30C as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
        Flags_SetSwitch(globalCtx, 0x23 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitHyliaShortcut(mut this: *mut EnOwl,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut textId: u16_0 =
        if gSaveContext.infTable[25 as libc::c_int as usize] as libc::c_int &
               0x20 as libc::c_int != 0 {
            0x4004 as libc::c_int
        } else { 0x4003 as libc::c_int } as u16_0;
    // Spoke to Owl in Lake Hylia
    EnOwl_LookAtLink(this, globalCtx); // "%d owl"
    if func_80ACA558(this, globalCtx, textId) != 0 {
        gSaveContext.infTable[25 as libc::c_int as usize] =
            (gSaveContext.infTable[25 as libc::c_int as usize] as libc::c_int
                ...
                u16_0; // "Demo of SPOT 06 has been completed"
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB148 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACB22C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
                               (SEQ_PLAYER_FANFARE as libc::c_int) <<
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB274(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        Audio_QueueSeqCmd(((0x1 as libc::c_int) << 28 as libc::c_int |
                               (SEQ_PLAYER_FANFARE as libc::c_int) <<
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitDeathMountainShortcut(mut this: *mut EnOwl,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if gSaveContext.magicAcquired == 0 {
        if func_80ACA558(this, globalCtx, 0x3062 as libc::c_int as u16_0) != 0
           {
            Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
            (*this).actionFunc =
                Some(func_80ACB274 as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ());
            return
        }
    } else if func_80ACA558(this, globalCtx, 0x3063 as libc::c_int as u16_0)
                  != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB22C as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACB344(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x607a as libc::c_int as u16_0);
            }
            1 => {
                Message_ContinueTextbox(globalCtx,
                                        0x607c as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACA7E0 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB3E0(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x6079 as libc::c_int as u16_0,
                           360.0f32, 2 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB344 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACB440(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x10c1 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACB4FC as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB4FC(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x10c2 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB440 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int | 2 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitLWPreSaria(mut this: *mut EnOwl,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x10c0 as libc::c_int as u16_0,
                           190.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB4FC as
                     unsafe extern "C" fn(_: *mut EnOwl,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB5C4(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                Message_ContinueTextbox(globalCtx,
                                        0x10c5 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80ACB680 as
                             unsafe extern "C" fn(_: *mut EnOwl,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB680(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x10c6 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB5C4 as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int | 2 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitLWPostSaria(mut this: *mut EnOwl,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    EnOwl_LookAtLink(this, globalCtx);
    if EnOwl_CheckInitTalk(this, globalCtx, 0x10c4 as libc::c_int as u16_0,
                           360.0f32, 0 as libc::c_int as u16_0) != 0 {
        Audio_PlayFanfare(0x5a as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80ACB680 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB748(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_80ACD62C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut dist: f32_0 = 0.;
    let mut weight: f32_0 = 0.;
    let mut owlType: s32 =
        ((*this).actor.params as libc::c_int & 0xfc0 as libc::c_int) >>
            6 as libc::c_int;
    dist =
        Math3D_Vec3f_DistXYZ(&mut (*this).eye, &mut (*globalCtx).view.eye) /
            45.0f32;
    (*this).eye.x = (*globalCtx).view.eye.x;
    (*this).eye.y = (*globalCtx).view.eye.y;
    (*this).eye.z = (*globalCtx).view.eye.z;
    weight = dist;
    if weight > 1.0f32 { weight = 1.0f32 }
    match owlType {
        7 => {
            func_800F436C(&mut D_80ACD62C,
                          (0x28bd as libc::c_int - 0x800 as libc::c_int) as
                              u16_0, weight * 2.0f32);
            if (*globalCtx).csCtx.frames as libc::c_int > 324 as libc::c_int
                   ||
                   (*globalCtx).csCtx.frames as libc::c_int >=
                       142 as libc::c_int &&
                       (*globalCtx).csCtx.frames as libc::c_int <=
                           266 as libc::c_int {
                func_800F4414(&mut D_80ACD62C, 0x3926 as libc::c_int as u16_0,
                              weight * 2.0f32);
            }
            if (*globalCtx).csCtx.frames as libc::c_int == 85 as libc::c_int {
                func_800F436C(&mut D_80ACD62C, 0x28be as libc::c_int as u16_0,
                              weight * 2.0f32);
            }
        }
        8 | 9 => {
            ...
            if (*globalCtx).csCtx.frames as libc::c_int == 217 as libc::c_int
               {
                func_800F436C(&mut D_80ACD62C, 0x28be as libc::c_int as u16_0,
                              weight * 2.0f32);
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACB904(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize].is_null()
       {
        if (*this).unk_40A as libc::c_int !=
               (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as
                                                   usize]).action as
                   libc::c_int {
            func_80ACD130(this, globalCtx, 7 as libc::c_int);
            func_80ACBAB8(this, globalCtx);
        }
        func_80ACD2CC(this, globalCtx);
    }
    if (*this).actionFlags as libc::c_int & 0x80 as libc::c_int != 0 {
        func_80ACB748(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACB994(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize].is_null()
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_WaitDefault(mut this: *mut EnOwl,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize].is_null()
       {
        if (*this).unk_40A as libc::c_int !=
               (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as
                   ...
                   libc::c_int {
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 4 as libc::c_int) as
                    u16_0;
            func_80ACD130(this, globalCtx, 7 as libc::c_int);
            func_80ACBAB8(this, globalCtx);
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACBAB8(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    match (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).action
              as libc::c_int - 1 as libc::c_int {
        0 => {
            EnOwl_ChangeMode(this,
                             Some(func_80ACB904 as
                                      unsafe extern "C" fn(_: *mut EnOwl,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()),
        ...
        4 => { Actor_Kill(&mut (*this).actor); }
        _ => { }
    }
    (*this).unk_40A =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).action as
            u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACBC0C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.flags |=
        ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    if (*this).actor.xzDistToPlayer > 6000.0f32 &&
           (*this).actionFlags as libc::c_int & 0x80 as libc::c_int == 0 {
        Actor_Kill(&mut (*this).actor);
    }
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_400,
                       2 as libc::c_int as s16, 0x80 as libc::c_int as s16,
                       0x40 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).actor.speedXZ < 16.0f32 { (*this).actor.speedXZ += 0.5f32 }
    if (*this).unk_3F8 + 1000.0f32 < (*this).actor.world.pos.y {
        if (*this).actor.velocity.y > 0.0f32 {
            (*this).actor.velocity.y -= 0.4f32
        }
    } else if (*this).actor.velocity.y < 4.0f32 {
        (*this).actor.velocity.y += 0.2f32
    }
    (*this).actionFlags =
        ((*this).actionFlags as libc::c_int | 8 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACBD4C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).skelAnime.curFrame > 45.0f32 {
        (*this).actor.velocity.y = 2.0f32;
        (*this).actor.gravity = 0.0f32;
        (*this).actor.speedXZ = 8.0f32
    } else if (*this).skelAnime.curFrame > 17.0f32 {
        (*this).actor.velocity.y = 6.0f32;
        (*this).actor.gravity = 0.0f32;
        (*this).actor.speedXZ = 4.0f32
    }
    if (*this).actionFlags as libc::c_int & 1 as libc::c_int != 0 {
        EnOwl_ChangeMode(this,
                         Some(func_80ACBC0C as
                                  unsafe extern "C" fn(_: *mut EnOwl,
                                                       _: *mut GlobalContext)
                                      -> ()),
                         Some(func_80ACC460 as
                                  unsafe extern "C" fn(_: *mut EnOwl) -> ()),
                         &mut (*this).skelAnime, &mut gOwlFlyAnim, 0.0f32);
        (*this).unk_3FE = 6 as libc::c_int as u16_0;
        if (*this).actionFlags as libc::c_int & 0x40 as libc::c_int != 0 {
            (*this).unk_400 =
                ((*this).unk_400 as libc::c_int + 0x2000 as libc::c_int) as
                    s16
        } else {
            (*this).unk_400 =
                ((*this).unk_400 as libc::c_int - 0x2000 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACBEA0(mut this: *mut EnOwl,
                                       mut GlobalContext:
                                           *mut GlobalContext) {
    if (*this).actionFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_3FE = 3 as libc::c_int as u16_0;
        EnOwl_ChangeMode(this,
                         Some(func_80ACBD4C as
                                  unsafe extern "C" fn(_: *mut EnOwl,
                                                       _: *mut GlobalContext)
                                      -> ()),
                         Some(func_80ACC540 as
                                  unsafe extern "C" fn(_: *mut EnOwl) -> ()),
                         &mut (*this).skelAnime, &mut gOwlTakeoffAnim,
                         0.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACBF50(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_400,
                       2 as libc::c_int as s16, 0x384 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACC00C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut owlType: s32 = 0;
    let mut temp_v0: s32 = 0;
    let mut temp_v0_2: s32 = 0;
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_400,
                       2 as libc::c_int as s16, 0x384 as libc::c_int as s16,
                       0x258 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
        ...
        if Gameplay_InCsMode(globalCtx) == 0 {
            owlType =
                ((*this).actor.params as libc::c_int & 0xfc0 as libc::c_int)
                    >> 6 as libc::c_int;
            osSyncPrintf(b"\x1b[36m\x00" as *const u8 as *const libc::c_char);
            osSyncPrintf(b"%d\xe3\x81\xae\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6\n\x00"
                             as *const u8 as *const libc::c_char, owlType);
            osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
            match owlType {
                7 => {
                    osSyncPrintf(b"\x1b[36m\x00" as *const u8 as
                                     *const libc::c_char);
                    osSyncPrintf(b"SPOT 06 \xe3\x81\xae \xe3\x83\x87\xe3\x83\xa2\xe3\x81\x8c\xe3\x81\xaf\xe3\x81\x97\xe3\x81\xa3\xe3\x81\x9f\n\x00"
                                     as *const u8 as *const libc::c_char);
                    osSyncPrintf(b"\x1b[m\x00" as *const u8 as
                                     *const libc::c_char);
                    (*globalCtx).csCtx.segment =
                        gSegments[((gLakeHyliaOwlCs.as_mut_ptr() as u32_0) <<
                                       4 as libc::c_int >> 28 as libc::c_int)
                                      as
                                      usize].wrapping_add(gLakeHyliaOwlCs.as_mut_ptr()
                                                              as u32_0 &
                                                              0xffffff as
                                                                  libc::c_int
                                                                  as
                ...
                8 | 9 => {
                    (*globalCtx).csCtx.segment =
                        gSegments[((gDMTOwlCs.as_mut_ptr() as u32_0) <<
                                       4 as libc::c_int >> 28 as libc::c_int)
                                      as
                                      usize].wrapping_add(gDMTOwlCs.as_mut_ptr()
                                                              as u32_0 &
                                                              0xffffff as
                                                                  libc::c_int
                                                                  as
                ...
                _ => {
                    if 0 as libc::c_int != 0 {
                        ...
                        __assert(b"0\x00" as *const u8 as *const libc::c_char,
                                 b"../z_en_owl.c\x00" as *const u8 as
                                     *const libc::c_char,
                                 1693 as libc::c_int);
                    };
                }
            ...
            func_800F44EC(0x14 as libc::c_int as s8,
                          0xa as libc::c_int as s8);
            (*this).actionFunc =
                Some(EnOwl_WaitDefault as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ());
            (*this).unk_40A = 0 as libc::c_int as u8_0;
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 0x80 as libc::c_int) as
                    u16_0;
            gTimeIncrement = 0 as libc::c_int as u16_0
        }
    }
    if (*this).skelAnime.curFrame >= 37.0f32 {
        if (*this).unk_3FE as libc::c_int > 0 as libc::c_int {
            (*this).skelAnime.curFrame = 21.0f32;
            (*this).unk_3FE = (*this).unk_3FE.wrapping_sub(1)
        } else {
            (*this).actionFunc =
                Some(func_80ACBF50 as
                         unsafe extern "C" fn(_: *mut EnOwl,
                                              _: *mut GlobalContext) -> ())
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACC23C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).skelAnime.curFrame >= 37.0f32 {
        (*this).skelAnime.curFrame = 21.0f32;
        (*this).actionFunc =
            Some(func_80ACC00C as
                     unsafe extern "C" fn(_: *mut EnOwl,
                                          _: *mut GlobalContext) -> ());
        (*this).unk_3FE = 5 as libc::c_int as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACC30C(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actionFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_3FE = 3 as libc::c_int as u16_0;
        EnOwl_ChangeMode(this,
                         Some(func_80ACC23C as
                                  unsafe extern "C" fn(_: *mut EnOwl,
                                                       _: *mut GlobalContext)
                                      -> ()),
                         Some(func_80ACC540 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACC390(mut this: *mut EnOwl) {
    SkelAnime_Update((*this).curSkelAnime);
    if (*this).unk_3FE as libc::c_int > 0 as libc::c_int {
        (*this).unk_3FE = (*this).unk_3FE.wrapping_sub(1);
        (*this).actor.shape.rot.z =
            (Math_SinS(((*this).unk_3FE as libc::c_int * 0x333 as libc::c_int)
                           as s16) * 1000.0f32) as s16
    } else {
        (*this).unk_410 =
            Some(func_80ACC460 as unsafe extern "C" fn(_: *mut EnOwl) -> ());
        (*this).unk_3FE = 6 as libc::c_int as u16_0;
        Animation_Change((*this).curSkelAnime, &mut gOwlFlyAnim, 1.0f32,
                         0.0f32,
                         Animation_GetLastFrame(&mut gOwlFlyAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, 2 as libc::c_int as u8_0, 5.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACC460(mut this: *mut EnOwl) {
    if SkelAnime_Update((*this).curSkelAnime) != 0 {
        if (*this).unk_3FE as libc::c_int > 0 as libc::c_int {
            (*this).unk_3FE = (*this).unk_3FE.wrapping_sub(1);
            Animation_Change((*this).curSkelAnime,
                             (*(*this).curSkelAnime).animation as
                                 *mut AnimationHeader, 1.0f32, 0.0f32,
                             Animation_GetLastFrame((*(*this).curSkelAnime).animation)
                                 as f32_0,
                             ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
        } else {
            (*this).unk_3FE = 0xa0 as libc::c_int as u16_0;
            (*this).unk_410 =
                Some(func_80ACC390 as
                         unsafe extern "C" fn(_: *mut EnOwl) -> ());
            Animation_Change((*this).curSkelAnime, &mut gOwlGlideAnim, 1.0f32,
                             0.0f32,
                             Animation_GetLastFrame(&mut gOwlGlideAnim as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0, 0 as libc::c_int as u8_0, 5.0f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACC540(mut this: *mut EnOwl) {
    if SkelAnime_Update((*this).curSkelAnime) != 0 {
        Animation_Change((*this).curSkelAnime,
                         (*(*this).curSkelAnime).animation as
                             *mut AnimationHeader, 1.0f32, 0.0f32,
                         Animation_GetLastFrame((*(*this).curSkelAnime).animation)
                             as f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         0.0f32);
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int | 1 as libc::c_int) as u16_0
    } else {
        (*this).actionFlags =
            ((*this).actionFlags as libc::c_int & !(1 as libc::c_int)) as
                u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACC5CC(mut this: *mut EnOwl) -> s32 {
    let mut phi_v1: s32 =
        if (*this).actionFlags as libc::c_int & 2 as libc::c_int != 0 {
            0x20 as libc::c_int
        } else { 0 as libc::c_int };
    if phi_v1 == (*this).unk_3EE as libc::c_int & 0x3f as libc::c_int {
        return 1 as libc::c_int
    } else {
        if (*this).actionFlags as libc::c_int & 0x20 as libc::c_int != 0 {
            (*this).unk_3EE =
                ((*this).unk_3EE as libc::c_int + 4 as libc::c_int) as s16
        } else {
            (*this).unk_3EE =
                ((*this).unk_3EE as libc::c_int - 4 as libc::c_int) as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACC624(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut switchFlag: s32 =
        ((*this).actor.params as libc::c_int & 0xfc0 as libc::c_int) >>
            6 as libc::c_int;
    if (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT11 as libc::c_int {
        return 1 as libc::c_int
    } else if switchFlag == 0xa as libc::c_int {
        return 1 as libc::c_int
    } else if (*globalCtx).csCtx.frames as libc::c_int >= 300 as libc::c_int
                  &&
                  (*globalCtx).csCtx.frames as libc::c_int <=
                      430 as libc::c_int {
        return 1 as libc::c_int
    } else if (*globalCtx).csCtx.frames as libc::c_int >= 1080 as libc::c_int
                  &&
                  (*globalCtx).csCtx.frames as libc::c_int <=
                      1170 as libc::c_int {
        return 1 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnOwl = thisx as *mut EnOwl;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32, 10.0f32,
                            10.0f32, 5 as libc::c_int);
    (*this).unk_410.expect("non-null function pointer")(this);
    (*this).actionFlags =
        ((*this).actionFlags as libc::c_int & !(8 as libc::c_int)) as u16_0;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).actor.update.is_none() {
        // "Owl disappears"
        osSyncPrintf(b"\xe3\x83\x95\xe3\x82\xaf\xe3\x83\xad\xe3\x82\xa6\xe6\xb6\x88\xe6\xbb\x85!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\x00"
                         as *const u8 as *const libc::c_char);
        return
    }
    if (*this).actionFlags as libc::c_int & 0x80 as libc::c_int == 0 &&
           func_80ACC624(this, globalCtx) != 0 {
        if (*this).skelAnime.animation ==
               &mut gOwlTakeoffAnim as *mut AnimationHeader as
                   *mut libc::c_void &&
               ((*this).skelAnime.curFrame == 2.0f32 ||
                    (*this).skelAnime.curFrame == 9.0f32 ||
                    (*this).skelAnime.curFrame == 23.0f32 ||
                    (*this).skelAnime.curFrame == 40.0f32 ||
                    (*this).skelAnime.curFrame == 58.0f32) ||
               (*this).skelAnime.animation ==
                   &mut gOwlFlyAnim as *mut AnimationHeader as
                       *mut libc::c_void &&
                   (*this).skelAnime.curFrame == 4.0f32 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3926 as libc::c_int as u16_0);
        }
    }
    if (*this).actor.draw.is_some() { Actor_MoveForward(&mut (*this).actor); }
    if (*this).actionFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).eyeTexIndex = 2 as libc::c_int as s16
    } else {
        ...
        if (*this).eyeTexIndex as libc::c_int >= 3 as libc::c_int {
            (*this).eyeTexIndex = 0 as libc::c_int as s16
        }
    }
    if (*this).actionFlags as libc::c_int & 8 as libc::c_int == 0 {
        phi_a1 = 0 as libc::c_int as s16;
        if (*this).actionFlags as libc::c_int & 0x10 as libc::c_int != 0 {
            match (*this).unk_404 as libc::c_int {
                0 => {
                    (*this).unk_404 = 1 as libc::c_int as u8_0;
                    (*this).unk_405 = 6 as libc::c_int as u8_0
                }
                1 => {
                    (*this).unk_405 = (*this).unk_405.wrapping_sub(1);
                    if (*this).unk_405 as libc::c_int != 0 as libc::c_int {
                        phi_a1 =
                            (Math_CosS(((*this).unk_405 as libc::c_int *
                                            8192 as libc::c_int) as s16) *
                                 4096.0f32) as s16
                    } else {
                        if (*this).actionFlags as libc::c_int &
                               2 as libc::c_int != 0 {
                            (*this).unk_3EE = 0 as libc::c_int as s16
                        } else {
                            (*this).unk_3EE = 0x20 as libc::c_int as s16
                        ...
                        (*this).unk_404 = (*this).unk_404.wrapping_add(1)
                    }
                    if (*this).actionFlags as libc::c_int &
                           0x20 as libc::c_int != 0 {
                        phi_a1 = -(phi_a1 as libc::c_int) as s16
                    }
                }
                2 => {
                    if func_80ACC5CC(this) != 0 {
                        (*this).actionFlags =
                            ((*this).actionFlags as libc::c_int &
                                 !(0x10 as libc::c_int)) as u16_0;
                        (*this).unk_406 =
                            (Rand_ZeroFloat(20.0f32) as s32 +
            ...
            if (*this).unk_406 as libc::c_int > 0 as libc::c_int {
                (*this).unk_406 = (*this).unk_406.wrapping_sub(1)
            } else {
                if (*this).unk_404 as libc::c_int == 0 as libc::c_int {
                    if Rand_ZeroOne() < 0.3f32 {
                        (*this).unk_404 = 4 as libc::c_int as u8_0;
                        (*this).unk_405 = 0xc as libc::c_int as u8_0
                    } else {
                        (*this).unk_404 = 1 as libc::c_int as u8_0;
                        (*this).unk_405 = 4 as libc::c_int as u8_0
                    }
                ...
                match (*this).unk_404 as libc::c_int {
                    1 => {
                        phi_a1 =
                            (Math_SinS((-((*this).unk_405 as libc::c_int) *
                                            4096 as libc::c_int +
                                            0x4000 as libc::c_int) as s16) *
                                 5000.0f32) as s16;
                        if (*this).unk_405 as libc::c_int <= 0 as libc::c_int
                           {
                            (*this).unk_405 =
                                (Rand_ZeroFloat(15.0f32) + 5.0f32) as s32 as
                                    u8_0;
                            (*this).unk_404 = 2 as libc::c_int as u8_0
                        }
                    }
                    2 => {
                        phi_a1 = 0x1388 as libc::c_int as s16;
                        if (*this).unk_405 as libc::c_int <= 0 as libc::c_int
                           {
                            (*this).unk_404 = 3 as libc::c_int as u8_0;
                            (*this).unk_405 = 4 as libc::c_int as u8_0
                        }
                    }
                    3 => {
                ...
                if (*this).actionFlags as libc::c_int & 0x20 as libc::c_int !=
                       0 {
                    phi_a1 = -(phi_a1 as libc::c_int) as s16
                }
            }
            if (*this).unk_409 as libc::c_int > 0 as libc::c_int {
                (*this).unk_409 = (*this).unk_409.wrapping_sub(1)
            } else {
                (*this).unk_408 = (*this).unk_408.wrapping_sub(1);
                match (*this).unk_407 as libc::c_int {
                    0 => {
                        (*this).unk_3F2 =
                            (-((*this).unk_408 as libc::c_int) *
                                 0x5dc as libc::c_int + 0x1770 as libc::c_int)
                                as s16;
                        if (*this).unk_408 as libc::c_int <= 0 as libc::c_int
                           {
                            (*this).unk_407 = 1 as libc::c_int as u8_0;
                            (*this).unk_408 =
                                (Rand_ZeroFloat(15.0f32) + 5.0f32) as s32 as
                                    u8_0
                        }
                    ...
                    1 => {
                        (*this).unk_3F2 = 0x1770 as libc::c_int as s16;
                        if (*this).unk_408 as libc::c_int <= 0 as libc::c_int
                           {
                            (*this).unk_407 = 2 as libc::c_int as u8_0;
                            (*this).unk_408 = 4 as libc::c_int as u8_0
                        }
                    }
                    2 => {
        ...
        (phi_a1) != 0;
        (*this).unk_3F0 =
            (((((*this).unk_3EE as libc::c_int) << 2 as libc::c_int) <<
                  8 as libc::c_int) as u16_0 as libc::c_int +
                 phi_a1 as libc::c_int) as s16;
        (*this).unk_3EC =
            ((if (*this).unk_3F0 as libc::c_int >= 0 as libc::c_int {
                  (*this).unk_3F0 as libc::c_int
              } else { -((*this).unk_3F0 as libc::c_int) }) >>
                 3 as libc::c_int) as s16
    } else {
        (*this).unk_3F2 = 0 as libc::c_int as s16;
        if (*this).actionFlags as libc::c_int & 2 as libc::c_int != 0 {
            (*this).unk_3F0 = -(0x8000 as libc::c_int) as s16
        } else { (*this).unk_3F0 = 0 as libc::c_int as s16 }
        (*this).unk_3EC =
            ((if (*this).unk_3F0 as libc::c_int >= 0 as libc::c_int {
                  (*this).unk_3F0 as libc::c_int
              } else { -((*this).unk_3F0 as libc::c_int) }) >>
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut gfx: *mut *mut Gfx,
                                                mut pos: *mut Vec3f,
 ...
 -> s32 {
    ...
    match limbIndex {
        3 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_3F0 as libc::c_int) as
                    s16;
            (*rot).z =
                ((*rot).z as libc::c_int + (*this).unk_3EC as libc::c_int) as
                    s16;
            (*rot).z =
                ((*rot).z as libc::c_int - (*this).unk_3F2 as libc::c_int) as
                    s16
        }
        2 => {
            (*rot).z =
        ...
        4 => {
            if (*this).actionFlags as libc::c_int & 8 as libc::c_int == 0 {
                (*rot).y =
                    ((*rot).y as libc::c_int -
                         ((*this).unk_3EC as libc::c_int as libc::c_float *
                              1.5f32) as s16 as libc::c_int) as s16
            }
        }
        5 => {
            if (*this).actionFlags as libc::c_int & 8 as libc::c_int == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_PostLimbUpdate(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut limbIndex: s32,
                                              mut gfx: *mut *mut Gfx,
                                              mut rot: *mut Vec3s,
    ...
    if (*this).actionFlags as libc::c_int & 2 as libc::c_int != 0 {
        vec.x = 700.0f32;
        vec.y = 400.0f32
    } else { vec.y = 0.0f32; vec.x = 1400.0f32 }
    if limbIndex == 3 as libc::c_int {
        Matrix_MultVec3f(&mut vec, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOwl_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gObjOwlEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gObjOwlEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gObjOwlEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnOwl = thisx as *mut EnOwl;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_owl.c\x00" as *const u8 as *const libc::c_char,
                    2247 as libc::c_int);
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*(*this).curSkelAnime).skeleton,
                          (*(*this).curSkelAnime).jointTable,
                          (*(*this).curSkelAnime).dListCount as s32,
                          Some(EnOwl_OverrideLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn EnOwl_ChangeMode(mut this: *mut EnOwl,
                                          mut actionFunc: EnOwlActionFunc,
                                          mut arg2: OwlFunc,
                                          mut skelAnime: *mut SkelAnime,
                                          mut animation: *mut AnimationHeader,
                                          mut morphFrames: f32_0) {
    (*this).curSkelAnime = skelAnime;
    Animation_Change((*this).curSkelAnime, animation, 1.0f32, 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACD130(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext,
                                       mut idx: s32) {
    let mut startPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    startPos.x =
        (*(*globalCtx).csCtx.npcActions[idx as usize]).startPos.x as f32_0;
    startPos.y =
        (*(*globalCtx).csCtx.npcActions[idx as usize]).startPos.y as f32_0;
    startPos.z =
        (*(*globalCtx).csCtx.npcActions[idx as usize]).startPos.z as f32_0;
    (*this).actor.world.pos = startPos;
    (*this).actor.shape.rot.y =
        (*(*globalCtx).csCtx.npcActions[idx as usize]).c2rust_unnamed.rot.y;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actor.shape.rot.z =
        (*(*globalCtx).csCtx.npcActions[idx as usize]).c2rust_unnamed.urot.z
            as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACD1C4(mut globalCtx: *mut GlobalContext,
                                       mut idx: s32) -> f32_0 {
    let mut ret: f32_0 =
        Environment_LerpWeight((*(*globalCtx).csCtx.npcActions[idx as
                                                                   usize]).endFrame,
                               (*(*globalCtx).csCtx.npcActions[idx as
                                                                   usize]).startFrame,
                               (*globalCtx).csCtx.frames);
    ret = if ret > 1.0f32 { 1.0f32 } else { ret };
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACD220(mut this: *mut EnOwl,
                                       mut arg1: *mut Vec3f,
                                       mut arg2: f32_0) {
    let mut rpy: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    rpy.x = ((*arg1).x - (*this).actor.world.pos.x) * arg2;
    rpy.y = ((*arg1).y - (*this).actor.world.pos.y) * arg2;
    rpy.z = ((*arg1).z - (*this).actor.world.pos.z) * arg2;
    Math_StepToF(&mut (*this).actor.velocity.y, rpy.y, 1.0f32);
    (*this).actor.speedXZ = sqrtf(rpy.x * rpy.x + rpy.z * rpy.z);
    (*this).actor.world.rot.y =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos, arg1);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACD2CC(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut angle: s32 = 0;
    let mut t: f32_0 = func_80ACD1C4(globalCtx, 7 as libc::c_int);
    pos.x =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).startPos.x
            as f32_0;
    pos.y =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).startPos.y
            as f32_0;
    pos.z =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).startPos.z
            as f32_0;
    angle =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as
                                            usize]).c2rust_unnamed.rot.y as
            libc::c_int - (*this).actor.world.rot.z as libc::c_int;
    if angle < 0 as libc::c_int { angle += 0x10000 as libc::c_int }
    angle =
        (t * angle as libc::c_float +
             (*this).actor.world.rot.z as libc::c_int as libc::c_float) as s16
            as s32;
    angle = angle as u16_0 as s32;
    if (*this).actionFlags as libc::c_int & 4 as libc::c_int != 0 {
        let mut phi_f2: f32_0 =
            (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as
                                                usize]).c2rust_unnamed.urot.x
                as f32_0;
        phi_f2 *=
            10.0f32 * (360.0f32 / 0x10000 as libc::c_int as libc::c_float);
        if phi_f2 < 0.0f32 { phi_f2 += 360.0f32 }
        pos.x -= Math_SinS(angle as s16) * phi_f2;
        pos.z += Math_CosS(angle as s16) * phi_f2;
        (*this).unk_3F8 = phi_f2;
        ...
        pos.x -= Math_SinS(angle as s16) * (*this).unk_3F8;
        pos.z += Math_CosS(angle as s16) * (*this).unk_3F8;
        func_80ACD220(this, &mut pos, 1.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACD4D4(mut this: *mut EnOwl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut endPosf: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_ret: f32_0 = func_80ACD1C4(globalCtx, 7 as libc::c_int);
    pos.x =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).startPos.x
            as f32_0;
    pos.y =
    ...
    pos.z =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).startPos.z
            as f32_0;
    endPosf.x =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).endPos.x
            as f32_0;
    endPosf.y =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).endPos.y
            as f32_0;
    endPosf.z =
        (*(*globalCtx).csCtx.npcActions[7 as libc::c_int as usize]).endPos.z
            as f32_0;
    ...
    sInitChain =
        [{
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).scale as *mut Vec3f as
                                 size_t as u32_0);
             init.set_value(25 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_value(1400 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneDownward as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(2400 as libc::c_int);
             init
         }]
}
#[used]
