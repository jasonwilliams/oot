...
extern "C" {
    ...
    #[no_mangle]
    static mut gHeishiKingGuardDL: [Gfx; 0];
    #[no_mangle]
    static mut gEnHeishiSlamSpearAnim: AnimationHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHeishi2 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
    pub actionFunc: EnHeishi2ActionFunc,
    pub unk_260: Vec3s,
    pub unk_266: [libc::c_char; 6],
    pub unk_26C: Vec3s,
    pub unk_274: Vec3f,
    pub unk_280: Vec3f,
    pub unk_28C: Vec3f,
    pub unk_298: Vec3f,
    pub unk_2A4: [libc::c_char; 24],
    pub unk_2BC: Vec3f,
    pub unk_2C8: [libc::c_char; 24],
    pub unk_2E0: f32_0,
    pub unk_2E4: f32_0,
    pub unk_2E8: [libc::c_char; 4],
    pub unk_2EC: f32_0,
    pub unk_2F0: u16_0,
    pub unk_2F2: [s16; 5],
    pub unk_2FC: s16,
    pub type_0: s16,
    pub unk_300: s16,
    pub unk_302: [libc::c_char; 6],
    pub audioFlag: u8_0,
    pub unk_309: u8_0,
    pub unk_30A: u8_0,
    pub unk_30B: u8_0,
    pub unk_30C: u8_0,
    pub unk_30D: libc::c_char,
    pub unk_30E: s16,
    pub cameraId: s16,
    pub gate: *mut Actor,
    pub unk_318: [libc::c_char; 24],
    pub mtxf_330: MtxF,
    pub unk_370: [libc::c_char; 40],
    pub collider: ColliderCylinder,
}
pub type EnHeishi2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHeishi2, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGateShutter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgGateShutterActionFunc,
    pub openingState: s16,
    pub somePos: Vec3f,
    pub unk_178: s16,
}
pub type BgGateShutterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGateShutter, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot15Saku {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot15SakuActionFunc,
    pub unk_168: u64_0,
    pub unk_170: Vec3f,
    pub timer: s16,
}
pub type BgSpot15SakuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot15Saku, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Heishi2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HEISHI2 as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi2_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut collider: *mut ColliderCylinder = 0 as *mut ColliderCylinder;
    let mut this: *mut EnHeishi2 = thisx as *mut EnHeishi2;
    ...
    if (*this).type_0 as libc::c_int == 6 as libc::c_int ||
           (*this).type_0 as libc::c_int == 9 as libc::c_int {
        (*this).actor.draw =
            Some(EnHeishi2_DrawKingGuard as
        ...
        Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                             &mut (*this).actor, 6 as libc::c_int as u8_0);
        if (*this).type_0 as libc::c_int == 6 as libc::c_int {
            (*this).actionFunc =
                Some(EnHeishi2_DoNothing1 as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
                                              _: *mut GlobalContext) -> ())
        } else {
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            // "No, I'm completely disappointed" (message for when shooting guard window in courtyard)
            osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x84\xe3\x82\x84\xe3\x83\xbc \xe3\x81\xa4\xe3\x81\x84\xe3\x81\x86\xe3\x81\xa3\xe3\x81\x8b\xe3\x82\x8a \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            Actor_SetScale(&mut (*this).actor, 0.02f32);
            (*this).unk_274 = (*this).actor.world.pos;
            (*this).actor.world.rot.y = 0x7918 as libc::c_int as s16;
            (*this).actor.world.pos.x += 90.0f32;
            (*this).actor.world.pos.y -= 60.0f32;
            (*this).actor.world.pos.z += 90.0f32;
            ...
            (*this).actionFunc =
                Some(func_80A544AC as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
        (*this).unk_2E0 = 60.0f32;
        ...
        match (*this).type_0 as libc::c_int {
            ...
            6 => {
                osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
                // "Peep hole soldier!"
                osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa6\x97\xe3\x81\x8d\xe7\xa9\xb4\xe5\xa5\xa5\xe5\x85\xb5\xe5\xa3\xab\xe3\x81\xb5\xe3\x81\x83\xe3\x80\x9c \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
        ...
        (*this).unk_2F0 =
            ((*this).actor.params as libc::c_int >> 8 as libc::c_int &
                 0xff as libc::c_int) as u16_0;
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "Soldier Set 2 Completed!"
        osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x85\xb5\xe5\xa3\xab\xef\xbc\x92\xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xe5\xae\x8c\xe4\xba\x86\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
        // "Identification Completed!"
        osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xad\x98\xe5\x88\xa5\xe5\xae\x8c\xe4\xba\x86\xef\xbc\x81         \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).type_0 as libc::c_int);
        // "Message completed!"
        osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xa1\xe3\x83\x83\xe3\x82\xbb\xe3\x83\xbc\xe3\x82\xb8\xe5\xae\x8c\xe4\xba\x86\xef\xbc\x81   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int >> 8 as libc::c_int &
                         0xf as libc::c_int);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHeishi2 = thisx as *mut EnHeishi2;
    if (*this).collider.dim.radius as libc::c_int != 0 as libc::c_int ||
           (*this).collider.dim.height as libc::c_int != 0 as libc::c_int {
        Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_DoNothing1(mut this: *mut EnHeishi2,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi_DoNothing2(mut this: *mut EnHeishi2,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80A531E4(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actionFunc =
        Some(func_80A53278 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53278(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_30B = 0 as libc::c_int as u8_0;
    (*this).unk_30E = 0 as libc::c_int as s16;
    if Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0) as
           libc::c_int != 0 as libc::c_int {
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0);
        (*this).unk_30B = 1 as libc::c_int as u8_0;
        (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    } else if gSaveContext.eventChkInf[0 as libc::c_int as usize] as
        ...
        osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x85\xa8\xe9\x83\xa8\xe3\x81\xae\xe7\xb2\xbe\xe9\x9c\x8a\xe7\x9f\xb3GET\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
        (*this).actor.textId = 0x7006 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
        ...
        osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xad\x90\xe4\xbe\x9b\xe3\x81\xaf\xe3\x81\xaf\xe3\x82\x84\xe3\x81\x8f\xe3\x83\x8d\xe3\x83\xad\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
        (*this).actor.textId = 0x7002 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).unk_30C as libc::c_int != 0 as libc::c_int {
        // "Anything passes"
        osSyncPrintf(b"\x1b[34m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xaa\xe3\x82\x93\xe3\x81\xa7\xe3\x82\x82\xe9\x80\x9a\xe3\x82\x8b\xe3\x82\x88 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
        (*this).actor.textId = 0x7099 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
        ...
        if (*this).unk_30E as libc::c_int == 0 as libc::c_int {
            // "Start under the first sleeve!"
            osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xef\xbc\x91\xe5\x9b\x9e\xe7\x9b\xae\xe8\xa2\x96\xe3\x81\xae\xe4\xb8\x8b\xe9\x96\x8b\xe5\xa7\x8b\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actor.textId = 0x7071 as libc::c_int as u16_0;
            (*this).unk_30E = 1 as libc::c_int as s16
        } else {
            // "Start under the second sleeve!"
            osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xef\xbc\x92\xe5\x9b\x9e\xe7\x9b\xae\xe8\xa2\x96\xe3\x81\xae\xe4\xb8\x8b\xe9\x96\x8b\xe5\xa7\x8b\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actor.textId = 0x7072 as libc::c_int as u16_0
        }
        (*this).unk_300 = TEXT_STATE_CHOICE as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
        ...
        // "That's okay"
        osSyncPrintf(b"\x1b[36m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x9d\xe3\x82\x8c\xe3\x81\xaf\xe3\x81\xa8\xe3\x81\x8a\xe3\x82\x89\xe3\x82\x93\xe3\x82\x88\xe3\x81\x89 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
        (*this).actor.textId = 0x7029 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80A5475C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80A5344C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).unk_300 = TEXT_STATE_EVENT as libc::c_int as s16;
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                if gSaveContext.rupees as libc::c_int >= 10 as libc::c_int {
                    ...
                    (*this).actor.textId = 0x7098 as libc::c_int as u16_0;
                    (*this).actionFunc =
                        Some(func_80A53538 as
                                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                                      _: *mut GlobalContext)
                                     -> ())
                } else {
                    (*this).actor.textId = 0x7097 as libc::c_int as u16_0;
                    (*this).actionFunc =
                        Some(func_80A54954 as
                                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
            ...
            1 => {
                (*this).actor.textId = 0x7096 as libc::c_int as u16_0;
                (*this).actionFunc =
                    Some(func_80A54954 as
                             unsafe extern "C" fn(_: *mut EnHeishi2,
                                                  _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80A53538(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_300 as libc::c_int ==
        ...
        (*this).actionFunc =
            Some(func_80A535BC as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A535BC(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiSlamSpearAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2EC = frameCount;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiSlamSpearAnim,
                     1.0f32, 0.0f32, frameCount,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A53638 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53638(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut frameCount: f32_0 = (*this).skelAnime.curFrame;
    let mut actor: *mut BgSpot15Saku =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ITEMACTION as libc::c_int as
                                             usize].head as *mut BgSpot15Saku;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frameCount >= 12.0f32 && (*this).audioFlag == 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2823 as libc::c_int as u16_0);
        (*this).audioFlag = 1 as libc::c_int as u8_0
    }
    if (*this).unk_2EC <= frameCount {
        while !actor.is_null() {
            if (*actor).dyna.actor.id as libc::c_int !=
                   ACTOR_BG_SPOT15_SAKU as libc::c_int {
                actor = (*actor).dyna.actor.next as *mut BgSpot15Saku
            } else {
                (*this).gate = &mut (*actor).dyna.actor;
                (*actor).unk_168 = 1 as libc::c_int as u64_0;
                break ;
            }
        }
        // "I've come!"
        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8d\xe3\x81\x9f\xe3\x81\x8d\xe3\x81\x9f\xe3\x81\x8d\xe3\x81\x9f\xe3\x81\x81\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*actor).dyna.actor.next);
        (*this).actionFunc =
            Some(func_80A5372C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A5372C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiIdleAnim, 1.0f32,
                     0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).unk_2F2[0 as libc::c_int as usize] = 200 as libc::c_int as s16;
    ...
    Gameplay_ChangeCameraStatus(globalCtx, (*this).cameraId,
                                7 as libc::c_int as s16);
    (*this).unk_280.x = 947.0f32;
    (*this).unk_280.y = 1195.0f32;
    (*this).unk_280.z = 2682.0f32;
    (*this).unk_28C.x = 1164.0f32;
    (*this).unk_28C.y = 1145.0f32;
    (*this).unk_28C.z = 3014.0f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).cameraId, &mut (*this).unk_280,
                            &mut (*this).unk_28C);
    (*this).actionFunc =
        Some(func_80A53850 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53850(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut gate: *mut BgSpot15Saku = 0 as *mut BgSpot15Saku;
    SkelAnime_Update(&mut (*this).skelAnime);
    Gameplay_CameraSetAtEye(globalCtx, (*this).cameraId, &mut (*this).unk_280,
                            &mut (*this).unk_28C);
    gate = (*this).gate as *mut BgSpot15Saku;
    if (*this).unk_2F2[0 as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int ||
           (*gate).unk_168 == 0 as libc::c_int as libc::c_ulonglong {
        Gameplay_ClearCamera(globalCtx, (*this).cameraId);
        Gameplay_ChangeCameraStatus(globalCtx, 0 as libc::c_int as s16,
                                    7 as libc::c_int as s16);
        Message_CloseTextbox(globalCtx);
        (*this).unk_30C = 1 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A53908(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiIdleAnim, 1.0f32,
                     ...
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A5399C as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A5399C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut var: s16 = 0;
    (*this).unk_30B = 0 as libc::c_int as u8_0;
    var = 0 as libc::c_int as s16;
    if gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
        ...
        if gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
            ...
            if Player_GetMask(globalCtx) as libc::c_int ==
                   PLAYER_MASK_KEATON as libc::c_int {
                if (*this).unk_309 as libc::c_int == 0 as libc::c_int {
                    (*this).actor.textId = 0x200a as libc::c_int as u16_0
                } else {
                    (*this).actor.textId = 0x200b as libc::c_int as u16_0
                }
                (*this).unk_300 = TEXT_STATE_CHOICE as libc::c_int as s16;
                (*this).unk_30B = 1 as libc::c_int as u8_0;
                var = 1 as libc::c_int as s16
            } else {
                (*this).actor.textId = 0x2016 as libc::c_int as u16_0;
                (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
                var = 1 as libc::c_int as s16
            }
        } else {
            (*this).actor.textId = 0x2020 as libc::c_int as u16_0;
            (*this).unk_300 = TEXT_STATE_EVENT as libc::c_int as s16;
            (*this).unk_30E = 0 as libc::c_int as s16
        }
        if Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0) as
        ...
        // "I don't know"
        osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xa8\xe3\x81\x8a\xe3\x81\x97\xe3\x82\x83\xe3\x81\x97\xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x85\xe3\x83\xbc\xe3\x81\xae \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).actionFunc =
            Some(func_80A53AD4 as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53AD4(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut exchangeItemId: s32 = 0;
    let mut yawDiffTemp: s16 = 0;
    ...
    if Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0) as
        ...
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0)
    } else { (*this).actor.textId = 0x200e as libc::c_int as u16_0 }
    (*this).unk_300 = TEXT_STATE_DONE as libc::c_int as s16;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        exchangeItemId = func_8002F368(globalCtx) as s32;
        if exchangeItemId == EXCH_ITEM_LETTER_ZELDA as libc::c_int {
            func_80078884(0x4802 as libc::c_int as u16_0);
            (*player).actor.textId = 0x2010 as libc::c_int as u16_0;
            (*this).unk_300 = TEXT_STATE_EVENT as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80A53C0C as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
                                              _: *mut GlobalContext) -> ())
        } else if exchangeItemId != EXCH_ITEM_NONE as libc::c_int {
            (*player).actor.textId = 0x200f as libc::c_int as u16_0
        }
    } else {
        yawDiffTemp =
        ...
        yawDiff =
            if yawDiffTemp as libc::c_int >= 0 as libc::c_int {
                yawDiffTemp as libc::c_int
            } else { -(yawDiffTemp as libc::c_int) } as s16;
        if !(120.0f32 < (*this).actor.xzDistToPlayer) &&
               (yawDiff as libc::c_int) < 0x4300 as libc::c_int {
            func_8002F298(&mut (*this).actor, globalCtx, 100.0f32,
                          EXCH_ITEM_LETTER_ZELDA as libc::c_int as u32_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53C0C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_300 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
        ...
        (*globalCtx).msgCtx.msgMode = MSGMODE_PAUSED as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(func_80A53C90 as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53C90(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiSlamSpearAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiSlamSpearAnim,
                     ...
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A53D0C as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53D0C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut frameCount: f32_0 = 0.;
    let mut gate: *mut BgGateShutter = 0 as *mut BgGateShutter;
    ...
    gate =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ITEMACTION as libc::c_int as
            ...
            *mut BgGateShutter;
    SkelAnime_Update(&mut (*this).skelAnime);
    if 12.0f32 <= frameCount {
        if (*this).audioFlag as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2823 as libc::c_int as u16_0);
            (*this).audioFlag = 1 as libc::c_int as u8_0
        }
    ...
    if (*this).unk_2EC <= frameCount {
        while !gate.is_null() {
            if (*gate).dyna.actor.id as libc::c_int !=
                   ACTOR_BG_GATE_SHUTTER as libc::c_int {
                gate = (*gate).dyna.actor.next as *mut BgGateShutter
            } else {
                (*this).gate = &mut (*gate).dyna.actor;
                (*gate).openingState = 1 as libc::c_int as s16;
                break ;
            }
        }
        // "I've come!"
        ...
        (*this).actionFunc =
            Some(func_80A53DF8 as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53DF8(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    ...
    Gameplay_ChangeCameraStatus(globalCtx, (*this).cameraId,
                                7 as libc::c_int as s16);
    (*this).unk_2BC.x = -71.0f32;
    (*this).unk_280.x = -71.0f32;
    (*this).unk_2BC.y = 571.0f32;
    (*this).unk_280.y = 571.0f32;
    (*this).unk_2BC.z = -1487.0f32;
    (*this).unk_280.z = -1487.0f32;
    (*this).unk_298.x = 181.0f32;
    (*this).unk_28C.x = 181.0f32;
    (*this).unk_298.y = 417.0f32;
    (*this).unk_28C.y = 417.0f32;
    (*this).unk_298.z = -1079.0f32;
    (*this).unk_28C.z = -1079.0f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).cameraId, &mut (*this).unk_280,
                            &mut (*this).unk_28C);
    (*this).actionFunc =
        Some(func_80A53F30 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A53F30(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut gate: *mut BgGateShutter = 0 as *mut BgGateShutter;
    SkelAnime_Update(&mut (*this).skelAnime);
    Gameplay_CameraSetAtEye(globalCtx, (*this).cameraId, &mut (*this).unk_280,
                            &mut (*this).unk_28C);
    gate = (*this).gate as *mut BgGateShutter;
    if (*this).unk_2F2[0 as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int ||
           (*gate).openingState as libc::c_int == 0 as libc::c_int {
        Gameplay_ClearCamera(globalCtx, (*this).cameraId);
        Gameplay_ChangeCameraStatus(globalCtx, 0 as libc::c_int as s16,
                                    7 as libc::c_int as s16);
        if (*this).unk_30A as libc::c_int != 2 as libc::c_int {
            if (*this).unk_30A as libc::c_int == 0 as libc::c_int {
                (*this).actor.textId = 0x2015 as libc::c_int as u16_0;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                (*this).actionFunc =
                    Some(func_80A54038 as
                             unsafe extern "C" fn(_: *mut EnHeishi2,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
            ...
            (*this).unk_30E = 0 as libc::c_int as s16;
            (*this).actor.textId = 0x2021 as libc::c_int as u16_0;
            Rupees_ChangeBy(15 as libc::c_int as s16);
            Message_ContinueTextbox(globalCtx, (*this).actor.textId);
            (*this).actionFunc =
                Some(func_80A5427C as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A54038(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
...
#[no_mangle]
pub unsafe extern "C" fn func_80A540C0(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if (*this).unk_30A as libc::c_int != 0 as libc::c_int {
                    (*this).unk_30A = 2 as libc::c_int as u8_0;
                    (*this).unk_30E = 1 as libc::c_int as s16;
                    (*this).actionFunc =
                        Some(func_80A5427C as
                                 unsafe extern "C" fn(_: *mut EnHeishi2,
            ...
            1 => {
                (*this).unk_30E = 1 as libc::c_int as s16;
                (*this).actor.textId = 0x200c as libc::c_int as u16_0;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                (*this).unk_300 = TEXT_STATE_EVENT as libc::c_int as s16;
                if (*this).unk_30A as libc::c_int == 0 as libc::c_int {
                    (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn func_80A541FC(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80A5427C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
        ...
        if (*this).unk_30E as libc::c_int == 0 as libc::c_int {
            (*this).unk_30E = 0 as libc::c_int as s16;
            (*this).unk_30A = (*this).unk_30E as u8_0;
            Message_CloseTextbox(globalCtx);
            (*this).actionFunc =
                Some(func_80A53908 as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A54320(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiSlamSpearAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiSlamSpearAnim,
                     1.0f32, 0.0f32, frameCount,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).audioFlag = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(func_80A543A0 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A543A0(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut frameCount: f32_0 = (*this).skelAnime.curFrame;
    let mut gate: *mut BgGateShutter =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ITEMACTION as libc::c_int as
                                             usize].head as
            *mut BgGateShutter;
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).unk_2EC <= frameCount {
        while !gate.is_null() {
            if ACTOR_BG_GATE_SHUTTER as libc::c_int !=
                   (*gate).dyna.actor.id as libc::c_int {
                gate = (*gate).dyna.actor.next as *mut BgGateShutter
            } else {
                (*this).gate = &mut (*gate).dyna.actor;
                if (*this).unk_30A as libc::c_int != 2 as libc::c_int {
                    ...
                    (*gate).openingState = 2 as libc::c_int as s16;
                    break ;
                }
            }
        }
        if (*this).unk_30A as libc::c_int == 0 as libc::c_int {
            (*this).unk_30A = 1 as libc::c_int as u8_0
        }
        (*this).actionFunc =
            Some(func_80A53DF8 as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A544AC(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       -(6100 as libc::c_int) as s16, 5 as libc::c_int as s16,
                       (*this).unk_2E4 as s16, 0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2E4, 3000.0f32, 1.0f32, 500.0f32);
    (*this).actor.world.rot.z = (*this).actor.shape.rot.z;
    if ((*this).actor.shape.rot.z as libc::c_int) < -(6000 as libc::c_int) {
        Message_StartTextbox(globalCtx, 0x708f as libc::c_int as u16_0,
                             0 as *mut Actor);
        (*this).actor.flags |=
            ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(func_80A5455C as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ());
        (*this).unk_2E4 = 0.0f32
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A5455C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8002DF54(globalCtx, 0 as *mut Actor, 7 as libc::c_int as u8_0);
        Message_CloseTextbox(globalCtx);
        pos.x = Rand_CenteredFloat(20.0f32) + (*this).unk_274.x;
        pos.y = Rand_CenteredFloat(20.0f32) + ((*this).unk_274.y - 40.0f32);
        pos.z = Rand_CenteredFloat(20.0f32) + ((*this).unk_274.z - 20.0f32);
        rotY =
            Rand_CenteredFloat(7000.0f32) +
                (*this).actor.yawTowardsPlayer as libc::c_int as
                    libc::c_float;
        bomb =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_BOM as libc::c_int as s16, pos.x, pos.y,
                        pos.z, 0 as libc::c_int as s16, rotY as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16) as
                *mut EnBom;
        if !bomb.is_null() {
            (*bomb).actor.speedXZ = Rand_CenteredFloat(5.0f32) + 10.0f32;
            (*bomb).actor.velocity.y = Rand_CenteredFloat(5.0f32) + 10.0f32
        }
        // "This is down!"
        osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x93\xe3\x82\x8c\xe3\x81\xa7\xe3\x83\x80\xe3\x82\xa6\xe3\x83\xb3\xe3\x81\xa0\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).actionFunc =
            Some(func_80A546DC as
                     unsafe extern "C" fn(_: *mut EnHeishi2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A546DC(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       200 as libc::c_int as s16, 5 as libc::c_int as s16,
                       (*this).unk_2E4 as s16, 0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2E4, 3000.0f32, 1.0f32, 500.0f32);
    (*this).actor.world.rot.z = (*this).actor.shape.rot.z;
    if (*this).actor.shape.rot.z as libc::c_int > 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A5475C(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if Text_GetFaceReaction(globalCtx, 5 as libc::c_int as u32_0) as
           libc::c_int != 0 as libc::c_int {
        if (*this).unk_30B as libc::c_int == 0 as libc::c_int {
    ...
    } else if (*this).unk_30B as libc::c_int != 0 as libc::c_int {
        if (*this).type_0 as libc::c_int == 2 as libc::c_int {
            (*this).actionFunc =
                Some(func_80A53278 as
                         unsafe extern "C" fn(_: *mut EnHeishi2,
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).type_0 as libc::c_int == 2 as libc::c_int {
            if (*this).unk_30E as libc::c_int == 1 as libc::c_int {
                (*this).actionFunc =
                    Some(func_80A5344C as
                             unsafe extern "C" fn(_: *mut EnHeishi2,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
            ...
            if (*this).type_0 as libc::c_int == 5 as libc::c_int {
                ...
                if (*this).unk_300 as libc::c_int ==
                       TEXT_STATE_CHOICE as libc::c_int {
                    (*this).unk_309 = 1 as libc::c_int as u8_0;
                    func_80078884(0x4807 as libc::c_int as u16_0);
                    (*this).actionFunc =
                        Some(func_80A540C0 as
                                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
    ...
    if (*this).type_0 as libc::c_int != 2 as libc::c_int &&
           (*this).type_0 as libc::c_int != 5 as libc::c_int ||
           {
               yawDiff =
               ...
               (!((*this).actor.xzDistToPlayer > 120.0f32) as libc::c_int !=
                    0) && (yawDiff as libc::c_int) < 0x4300 as libc::c_int
           } {
        func_8002F2F4(&mut (*this).actor, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A54954(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiIdleAnim, 1.0f32,
                     ...
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A549E8 as
                 unsafe extern "C" fn(_: *mut EnHeishi2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A549E8(mut this: *mut EnHeishi2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_300 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHeishi2 = thisx as *mut EnHeishi2;
    let mut i: s32 = 0;
    Actor_SetFocus(&mut (*this).actor, (*this).unk_2E0);
    if (*this).type_0 as libc::c_int == 2 as libc::c_int ||
           (*this).type_0 as libc::c_int == 5 as libc::c_int {
        (*this).actor.focus.pos.y = 70.0f32;
        Actor_SetFocus(&mut (*this).actor, 70.0f32);
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_260,
                      &mut (*this).unk_26C, (*this).actor.focus.pos);
    }
    (*this).unk_2FC += 1;
    i = 0 as libc::c_int;
    while i != 5 as libc::c_int {
        if (*this).unk_2F2[i as usize] as libc::c_int != 0 as libc::c_int {
            (*this).unk_2F2[i as usize] -= 1
        }
        i += 1
    }
    ...
    match (*this).type_0 as libc::c_int {
        ...
        _ => {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32,
                                    10.0f32, 30.0f32, 0x1d as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
    ...
    match (*this).type_0 as libc::c_int {
        ...
        _ => {
            if limbIndex == 9 as libc::c_int {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_26C.y as libc::c_int) as s16
            }
            if limbIndex == 16 as libc::c_int {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_260.y as libc::c_int) as s16;
                (*rot).z =
                    ((*rot).z as libc::c_int +
                         (*this).unk_260.z as libc::c_int) as s16
            }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_PostLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut rot: *mut Vec3s,
                                                mut thisx:
                                                    *mut libc::c_void) {
    let mut this: *mut EnHeishi2 = thisx as *mut EnHeishi2;
    if limbIndex == 16 as libc::c_int { Matrix_Get(&mut (*this).mtxf_330); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_DrawKingGuard(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_heishi2.c\x00" as *const u8 as
                        *const libc::c_char, 1772 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gHeishiKingGuardDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_heishi2.c\x00" as *const u8 as
                         *const libc::c_char, 1777 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi2_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi2 = thisx as *mut EnHeishi2;
    let mut mtx: *mut Mtx = 0 as *mut Mtx;
    let mut linkObjBankIndex: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_heishi2.c\x00" as *const u8 as
                        *const libc::c_char, 1792 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnHeishi2_OverrideLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    ...
                                                    _: *mut libc::c_void)
                                   -> s32),
                      Some(EnHeishi2_PostLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: s32, _: *mut *mut Gfx,
                                                    _: *mut Vec3s,
                                                    _: *mut libc::c_void)
    ...
    if (*this).type_0 as libc::c_int == 5 as libc::c_int &&
        ...
        if linkObjBankIndex >= 0 as libc::c_int {
            Matrix_Put(&mut (*this).mtxf_330);
            Matrix_Translate(-570.0f32, 0.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((70.0f64 *
                                3.14159265358979323846f32 as libc::c_double /
                                180.0f32 as libc::c_double) as f32_0,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            mtx =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_heishi2.c\x00" as *const u8 as
                                  *const libc::c_char as *mut libc::c_char,
                              1820 as
                                  libc::c_int).offset(-(7 as libc::c_int as
                                                            isize));
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                (*globalCtx).objectCtx.status[linkObjBankIndex as
                                                  usize].segment as
                    libc::c_uint;
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gLinkChildKeatonMaskDL.as_mut_ptr() as libc::c_uint;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_heishi2.c\x00" as *const u8 as
                         *const libc::c_char, 1834 as libc::c_int);
}
