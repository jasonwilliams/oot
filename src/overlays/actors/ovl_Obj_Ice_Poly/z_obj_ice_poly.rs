...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjIcePoly {
    pub actor: Actor,
    pub actionFunc: ObjIcePolyActionFunc,
    pub alpha: u8_0,
    pub unk_151: u8_0,
    pub meltTimer: s16,
    pub colliderIce: ColliderCylinder,
    pub colliderHard: ColliderCylinder,
}
pub type ObjIcePolyActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjIcePoly, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Ice_Poly_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_ICE_POLY as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjIcePoly_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjIcePoly_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjIcePoly_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjIcePoly_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCylinderInitIce: ColliderCylinderInit =
    {
        let mut init =
...
static mut sCylinderInitHard: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sScale: [f32_0; 3] = [0.5f32, 1.0f32, 1.5f32];
static mut sOffsetY: [s16; 3] =
    [-(25 as libc::c_int) as s16, 0 as libc::c_int as s16,
     -(20 as libc::c_int) as s16];
static mut sColorWhite: Color_RGBA8 =
    {
        let mut init =
...
static mut sColorGray: Color_RGBA8 =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjIcePoly = thisx as *mut ObjIcePoly;
    (*this).unk_151 =
    ...
    if ((*thisx).params as libc::c_int) < 0 as libc::c_int ||
           (*thisx).params as libc::c_int >= 3 as libc::c_int {
        Actor_Kill(thisx);
        return
    }
    Actor_SetScale(thisx, sScale[(*thisx).params as usize]);
    (*thisx).world.pos.y =
        sOffsetY[(*thisx).params as usize] as libc::c_int as libc::c_float +
            (*thisx).home.pos.y;
    Collider_InitCylinder(globalCtx, &mut (*this).colliderIce);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderIce, thisx,
                         &mut sCylinderInitIce);
    Collider_InitCylinder(globalCtx, &mut (*this).colliderHard);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderHard, thisx,
                         &mut sCylinderInitHard);
    Collider_UpdateCylinder(thisx, &mut (*this).colliderIce);
    Collider_UpdateCylinder(thisx, &mut (*this).colliderHard);
    (*thisx).colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).alpha = 255 as libc::c_int as u8_0;
    (*this).colliderIce.dim.radius =
        ((*this).colliderIce.dim.radius as libc::c_float * (*thisx).scale.x)
            as s16;
    (*this).colliderIce.dim.height =
        ((*this).colliderIce.dim.height as libc::c_float * (*thisx).scale.y)
            as s16;
    (*this).colliderHard.dim.radius =
        ((*this).colliderHard.dim.radius as libc::c_float * (*thisx).scale.x)
            as s16;
    (*this).colliderHard.dim.height =
        ((*this).colliderHard.dim.height as libc::c_float * (*thisx).scale.y)
            as s16;
    Actor_SetFocus(thisx, (*thisx).scale.y * 30.0f32);
    (*this).actionFunc =
        Some(ObjIcePoly_Idle as
                 unsafe extern "C" fn(_: *mut ObjIcePoly,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjIcePoly = thisx as *mut ObjIcePoly;
    if (*this).actor.params as libc::c_int >= 0 as libc::c_int &&
        ...
        Collider_DestroyCylinder(globalCtx, &mut (*this).colliderIce);
        Collider_DestroyCylinder(globalCtx, &mut (*this).colliderHard);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Idle(mut this: *mut ObjIcePoly,
                                         mut globalCtx: *mut GlobalContext) {
    static mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pad: s32 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).colliderIce.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).meltTimer =
            -((*(*this).colliderIce.info.acHitInfo).toucher.damage as
                  libc::c_int) as s16;
        (*this).actor.focus.rot.y = (*this).actor.yawTowardsPlayer;
        OnePointCutscene_Init(globalCtx, 5120 as libc::c_int as s16,
                              40 as libc::c_int as s16, &mut (*this).actor,
                              0 as libc::c_int as s16);
        (*this).actionFunc =
            Some(ObjIcePoly_Melt as
                     unsafe extern "C" fn(_: *mut ObjIcePoly,
                                          _: *mut GlobalContext) -> ())
    } else if !(*this).actor.parent.is_null() {
        (*(*this).actor.parent).freezeTimer = 40 as libc::c_int as u16_0;
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderIce.base);
        ...
        (*this).actor.world.pos.x +
            (*this).actor.scale.x *
                (Rand_S16Offset(15 as libc::c_int as s16,
                                15 as libc::c_int as s16) as libc::c_int *
        ...
        (*this).actor.world.pos.y +
            (*this).actor.scale.y *
                Rand_S16Offset(10 as libc::c_int as s16,
                               90 as libc::c_int as s16) as libc::c_int as
                    libc::c_float;
    pos.z =
    ...
    if (*globalCtx).gameplayFrames.wrapping_rem(7 as libc::c_int as
        ...
        EffectSsKiraKira_SpawnDispersed(globalCtx, &mut pos, &mut zeroVec,
                                        &mut zeroVec, &mut sColorWhite,
                                        &mut sColorGray,
...
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Melt(mut this: *mut ObjIcePoly,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    while i < 2 as libc::c_int {
            ...
            (*this).actor.world.pos.x +
                (*this).actor.scale.x *
                    (Rand_S16Offset(20 as libc::c_int as s16,
                                    20 as libc::c_int as s16) as libc::c_int *
                         (if Rand_ZeroOne() < 0.5f32 {
                              -(1 as libc::c_int)
                          } else { 1 as libc::c_int })) as libc::c_float;
        pos.y =
            (*this).actor.world.pos.y +
                (*this).actor.scale.y * Rand_ZeroOne() * 50.0f32;
        pos.z =
            (*this).actor.world.pos.z +
                (*this).actor.scale.x *
                    (Rand_S16Offset(20 as libc::c_int as s16,
        ...
        func_8002829C(globalCtx, &mut pos, &mut vel, &mut accel,
                      &mut sColorWhite, &mut sColorGray,
                      (Rand_S16Offset(0x15e as libc::c_int as s16,
                                      0x64 as libc::c_int as s16) as
                           libc::c_int as libc::c_float *
                           (*this).actor.scale.x) as s16,
                      ((*this).actor.scale.x * 20.0f32) as s16);
        i += 1
    }
    if ((*this).meltTimer as libc::c_int) < 0 as libc::c_int {
        if !(*this).actor.parent.is_null() {
            (*(*this).actor.parent).freezeTimer = 40 as libc::c_int as u16_0
        }
        (*this).meltTimer += 1;
        if (*this).meltTimer as libc::c_int == 0 as libc::c_int {
            (*this).meltTimer = 40 as libc::c_int as s16;
        ...
        (*this).actor.scale.y =
            sScale[(*this).actor.params as usize] *
                (0.5f32 +
                     (*this).meltTimer as libc::c_int as libc::c_float *
                         0.0125f32);
        (*this).alpha =
            ((*this).alpha as libc::c_int - 6 as libc::c_int) as u8_0;
        if (*this).meltTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjIcePoly = thisx as *mut ObjIcePoly;
...
#[no_mangle]
pub unsafe extern "C" fn ObjIcePoly_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjIcePoly = thisx as *mut ObjIcePoly;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_ice_poly.c\x00" as *const u8 as
                        *const libc::c_char, 421 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    func_8002ED80(&mut (*this).actor, globalCtx, 0 as libc::c_int);
    Matrix_RotateZYX(0x500 as libc::c_int as s16, 0 as libc::c_int as s16,
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).gameplayFrames.wrapping_rem(0x100 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_uint),
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gEffIceFragment3DL.as_mut_ptr() as libc::c_uint;
