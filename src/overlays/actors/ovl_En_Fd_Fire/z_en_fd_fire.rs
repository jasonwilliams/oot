...
pub struct EnFdFire {
    pub actor: Actor,
    pub actionFunc: EnFdFireActionFunc,
    pub collider: ColliderCylinder,
    pub spawnRadius: f32_0,
    pub scale: f32_0,
    pub unk_1A4: [libc::c_char; 2],
    pub deathTimer: s16,
    pub tile2Y: s16,
}
pub type EnFdFireActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFdFire, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Fd_Fire_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FD_FIRE as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFdFire_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFdFire_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_UpdatePos(mut this: *mut EnFdFire,
                                            mut targetPos: *mut Vec3f) {
    let mut dist: f32_0 = 0.;
    let mut xDiff: f32_0 = (*targetPos).x - (*this).actor.world.pos.x;
    let mut yDiff: f32_0 = (*targetPos).y - (*this).actor.world.pos.y;
    let mut zDiff: f32_0 = (*targetPos).z - (*this).actor.world.pos.z;
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_CheckCollider(mut this: *mut EnFdFire,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
    if (*this).actionFunc ==
           Some(EnFdFire_Disappear as
                    unsafe extern "C" fn(_: *mut EnFdFire,
                                         _: *mut GlobalContext) -> ()) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFdFire = thisx as *mut EnFdFire;
    let mut pad: s32 = 0;
    ...
    (*this).scale = 3.0f32;
    (*this).tile2Y =
        (Rand_ZeroFloat(5.0f32) as s16 as libc::c_int - 25 as libc::c_int) as
            s16;
    (*this).actionFunc =
        Some(func_80A0E70C as
                 unsafe extern "C" fn(_: *mut EnFdFire, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFdFire = thisx as *mut EnFdFire;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A0E70C(mut this: *mut EnFdFire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut targetPos: Vec3f = (*(*this).actor.parent).world.pos;
    ...
    EnFdFire_UpdatePos(this, &mut targetPos);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
        ...
        if (*this).actor.params as libc::c_int & 0x8000 as libc::c_int != 0 {
            (*this).deathTimer = 200 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnFdFire_DanceTowardsPlayer as
                         unsafe extern "C" fn(_: *mut EnFdFire,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).deathTimer = 300 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnFdFire_WaitToDie as
                         unsafe extern "C" fn(_: *mut EnFdFire,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_WaitToDie(mut this: *mut EnFdFire,
                                            mut globalCtx:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_DanceTowardsPlayer(mut this: *mut EnFdFire,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    let mut idx: s16 = 0;
    idx =
        (*globalCtx).state.frames.wrapping_div(10 as libc::c_int as
                                                   libc::c_uint).wrapping_add(((*this).actor.params
                                                                                   as
                                                                                   libc::c_int
                                                                                   &
                                                                                   0x7fff
                                                                                       ...
                                                                                       libc::c_int)
                                                                                  as
                                                                                  libc::c_uint).wrapping_rem((::std::mem::size_of::<[f32_0; 12]>()
                                                                                                                  as
    ...
    pos.x += 120.0f32 * sinf(angles[idx as usize]);
    pos.z += 120.0f32 * cosf(angles[idx as usize]);
    if (if (*this).deathTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).deathTimer -= 1; (*this).deathTimer as libc::c_int })
           == 0 as libc::c_int {
        ...
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                                          &mut pos), 8 as libc::c_int as s16,
                           0xfa0 as libc::c_int as s16,
                           1 as libc::c_int as s16);
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.4f32, 1.0f32,
                           0.0f32);
        if (*this).actor.speedXZ < 0.1f32 { (*this).actor.speedXZ = 5.0f32 }
        func_8002D868(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_Disappear(mut this: *mut EnFdFire,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.6f32, 9.0f32,
                       0.0f32);
    func_8002D868(&mut (*this).actor);
    Math_SmoothStepToF(&mut (*this).scale, 0.0f32, 0.3f32, 0.1f32, 0.0f32);
    (*this).actor.shape.shadowScale = 20.0f32;
    (*this).actor.shape.shadowScale *= (*this).scale / 3.0f32;
    if !((*this).scale > 0.01f32) { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFdFire = thisx as *mut EnFdFire;
    let mut pad: s32 = 0;
    if (*this).actionFunc !=
           Some(EnFdFire_Disappear as
                    unsafe extern "C" fn(_: *mut EnFdFire,
                                         _: *mut GlobalContext) -> ()) {
        if (*(*this).actor.parent).update.is_none() ||
               EnFdFire_CheckCollider(this, globalCtx) != 0 {
            (*this).actionFunc =
                Some(EnFdFire_Disappear as
                         unsafe extern "C" fn(_: *mut EnFdFire,
                                              _: *mut GlobalContext) -> ())
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 12.0f32, 10.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnFdFire_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut primColors: [Color_RGBA8; 2] =
        [{
             let mut init =
    ...
    let mut envColors: [Color_RGBA8; 2] =
        [{
             let mut init =
                 Color_RGBA8{r: 255 as libc::c_int as u8_0,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fd_fire.c\x00" as *const u8 as
    ...
    sp8E =
        (Math_Vec3f_Yaw(&mut scale, &mut (*this).actor.velocity) as
             libc::c_int -
    ...
    sp88 = Math_SinS(sp8E);
    sp80 =
        Math_Vec3f_DistXZ(&mut scale, &mut (*this).actor.velocity) / 1.5f32;
    ...
    Matrix_RotateZ(sp88 * -10.0f32 * sp80 *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    scale.z = (*this).scale * 0.001f32;
    scale.y = scale.z;
    scale.x = scale.y;
    Matrix_Scale(scale.x, scale.y, scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    sp84 = sp80 * (0.01f32 * -15.0f32 * sp84) + 1.0f32;
    if sp84 < 0.1f32 { sp84 = 0.1f32 }
    Matrix_Scale(1.0f32, sp84, 1.0f32 / sp84,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).state.frames.wrapping_mul((*this).tile2Y
                                                                    as
                                                                    libc::c_uint),
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (128 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        (primColors[(((*this).actor.params as libc::c_int &
                          0x8000 as libc::c_int) >> 0xf as libc::c_int) as
                        usize].r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (primColors[(((*this).actor.params as libc::c_int &
    ...
    (*_g_2).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_2).words.w1 =
        (envColors[(((*this).actor.params as libc::c_int &
                         0x8000 as libc::c_int) >> 0xf as libc::c_int) as
                       usize].r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
