...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoShootingGalleryDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoShootingGalleryCol: CollisionHeader;
    #[no_mangle]
    static mut gKakarikoPotionShopSignDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoShootingGallerySignDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoBazaarSignDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoConstructionSiteDL: [Gfx; 0];
    #[no_mangle]
    static mut object_spot01_matoyab_col: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot01Objects2 {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot01Objects2ActionFunc,
    pub unk_168: [libc::c_char; 16],
    pub objectId: s32,
    pub objBankIndex: s8,
}
pub type BgSpot01Objects2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Objects2,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Spot01_Objects2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT01_OBJECTS2 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot01Objects2>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Objects2_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Objects2_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Objects2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808AC510: [*mut Gfx; 5] =
    unsafe {
        [gKakarikoPotionShopSignDL.as_ptr() as *mut _,
         gKakarikoShootingGallerySignDL.as_ptr() as *mut _,
         gKakarikoBazaarSignDL.as_ptr() as *mut _,
         gKakarikoConstructionSiteDL.as_ptr() as *mut _,
         gKakarikoShootingGalleryDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Objects2_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot01Objects2 = thisx as *mut BgSpot01Objects2;
    match (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int {
        0 | 1 | 2 => {
            (*this).objectId = OBJECT_SPOT01_MATOYA as libc::c_int
        }
        3 => { (*this).objectId = OBJECT_SPOT01_MATOYAB as libc::c_int }
        4 => { (*this).objectId = OBJECT_SPOT01_MATOYA as libc::c_int }
        _ => { }
    }
    if (*this).objectId >= 0 as libc::c_int {
        (*this).objBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            (*this).objectId as s16) as s8;
        if ((*this).objBankIndex as libc::c_int) < 0 as libc::c_int {
            // "There was no bank setting."
            osSyncPrintf(b"-----------------------------\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x82\xe3\x82\x8a\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x81\xa7\xe3\x81\x97\xe3\x81\x9f.\x00"
    ...
    (*this).actionFunc =
        Some(func_808AC2BC as
                 unsafe extern "C" fn(_: *mut BgSpot01Objects2,
                                      _: *mut GlobalContext) -> ());
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Objects2_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808AC22C(mut pathList: *mut Path,
                                       mut pos: *mut Vec3f, mut path: s32,
                                       mut waypoint: s32) -> s32 {
    let mut pointPos: *mut Vec3s =
        &mut *((*gSegments.as_mut_ptr().offset((((*pathList.offset(path as
                                                                       isize)).points
                                                     as u32_0) <<
                                                    4 as libc::c_int >>
                                                    28 as libc::c_int) as
                                                   isize)).wrapping_add((*pathList.offset(path
                                                                                              as
                                                                                              isize)).points
                                                                            as
                                                                            u32_0
...
#[no_mangle]
pub unsafe extern "C" fn func_808AC2BC(mut this: *mut BgSpot01Objects2,
    ...
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        osSyncPrintf(b"-----\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x88\x87\xe3\x82\x8a\xe6\x8f\x9b\xe3\x81\x88\xe6\x88\x90\xe5\x8a\x9f\xef\xbc\x81\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char);
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objBankIndex as
                                               usize].segment as
        ...
        match (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int {
            4 => {
                // Shooting gallery
                CollisionHeader_GetVirtual(&mut gKakarikoShootingGalleryCol as
            ...
            3 => {
                // Shooting Gallery, spawns Carpenter Sabooro during the day
                CollisionHeader_GetVirtual(&mut object_spot01_matoyab_col as
                                               *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
                (*this).dyna.bgId =
                ...
                if gSaveContext.nightFlag == 0 as libc::c_int {
                    func_808AC22C((*globalCtx).setupPathList, &mut position,
                                  (*thisx).params as s32 >> 8 as libc::c_int &
                                      0xff as libc::c_int, 0 as libc::c_int);
                    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, thisx,
                                       globalCtx,
                                       ACTOR_EN_DAIKU_KAKARIKO as libc::c_int
                                           as s16, position.x, position.y,
                                       position.z, (*thisx).world.rot.x,
                                       (*thisx).world.rot.y,
                                       (*thisx).world.rot.z,
                                       ((((*thisx).params as s32 >>
                                              8 as libc::c_int &
        ...
        (*this).dyna.actor.draw =
            Some(func_808AC4A4 as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFunc =
            Some(func_808AC474 as
                     unsafe extern "C" fn(_: *mut BgSpot01Objects2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808AC474(mut this: *mut BgSpot01Objects2,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Objects2_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot01Objects2 = thisx as *mut BgSpot01Objects2;
...
#[no_mangle]
pub unsafe extern "C" fn func_808AC4A4(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx,
                     D_808AC510[((*thisx).params as libc::c_int &
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(12800 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
