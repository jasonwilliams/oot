...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gLoadedPauseMarkDataTable: *mut PauseMapMarksData;
    #[no_mangle]
    static mut gBossMarkScale: f32_0;
    #[no_mangle]
    static mut gGameInfo: *mut GameInfo;
    #[no_mangle]
    static mut gBossMarkState: u8_0;
    #[no_mangle]
    static mut gMapChestIconTex: [u64_0; 0];
    #[no_mangle]
    static mut gMapBossIconTex: [u64_0; 0];
    #[no_mangle]
    static mut gPauseMapMarkDataTable: [PauseMapMarksData; 0];
}
...
// size = 0x24
static mut sMapMarkInfoTable: [PauseMapMarkInfo; 2] =
    unsafe {
        [{
             let mut init =
                 PauseMapMarkInfo{texture:
...
static mut sLineBytesImageSizes: [u32_0; 4] =
    [0 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     2 as libc::c_int as u32_0, 2 as libc::c_int as u32_0];
#[no_mangle]
pub unsafe extern "C" fn PauseMapMark_Init(mut globalCtx:
                                               *mut GlobalContext) {
    gBossMarkState = 0 as libc::c_int as u8_0;
    gBossMarkScale = 1.0f32;
    gLoadedPauseMarkDataTable = gPauseMapMarkDataTable.as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn PauseMapMark_Clear(mut globalCtx:
                                                *mut GlobalContext) {
    gLoadedPauseMarkDataTable = 0 as *mut PauseMapMarksData;
}
#[no_mangle]
pub unsafe extern "C" fn PauseMapMark_DrawForDungeon(mut globalCtx:
                                                         *mut GlobalContext) {
    let mut mapMarkData: *mut PauseMapMarkData = 0 as *mut PauseMapMarkData;
    let mut markPoint: *mut PauseMapMarkPoint = 0 as *mut PauseMapMarkPoint;
    let mut markInfo: *mut PauseMapMarkInfo = 0 as *mut PauseMapMarkInfo;
    let mut scale: f32_0 = 0.;
    let mut i: s32 = 0 as libc::c_int;
    mapMarkData =
        &mut *(*gLoadedPauseMarkDataTable.offset((*(*gGameInfo).data.as_mut_ptr().offset((20
                                                                                              as
                                                                                              libc::c_int
                                                                                              *
                                                                                              6
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_lmap_mark.c\x00" as *const u8 as
                        *const libc::c_char, 182 as libc::c_int);
    while !((*mapMarkData).markType as libc::c_int == -(1 as libc::c_int)) {
        if (*mapMarkData).markType as libc::c_int == 1 as libc::c_int &&
               (*globalCtx).sceneNum as libc::c_int >=
                   SCENE_YDAN_BOSS as libc::c_int &&
               (*globalCtx).sceneNum as libc::c_int <=
                   SCENE_GANON_FINAL as libc::c_int {
            if gBossMarkState as libc::c_int == 0 as libc::c_int {
                Math_ApproachF(&mut gBossMarkScale, 1.5f32, 1.0f32, 0.041f32);
                if gBossMarkScale == 1.5f32 {
                    gBossMarkState = 1 as libc::c_int as u8_0
                }
            } else {
                Math_ApproachF(&mut gBossMarkScale, 1.0f32, 1.0f32, 0.041f32);
                if gBossMarkScale == 1.0f32 {
                    gBossMarkState = 0 as libc::c_int as u8_0
                }
            }
        ...
        if (*globalCtx).pauseCtx.state as libc::c_int == 4 as libc::c_int ||
               (*globalCtx).pauseCtx.state as libc::c_int >=
                   0x12 as libc::c_int {
            Matrix_Translate(-36.0f32, 101.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
        } else {
            Matrix_Translate(-36.0f32, 21.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
        }
        ...
        (*_g_1).words.w1 =
            (0 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        markPoint =
            &mut *(*mapMarkData).points.as_mut_ptr().offset(0 as libc::c_int
                                                                as isize) as
                *mut PauseMapMarkPoint;
        i = 0 as libc::c_int;
        while i < (*mapMarkData).count {
            let mut display: s32 = 0;
            if (*mapMarkData).markType as libc::c_int == 0 as libc::c_int {
                if Flags_GetTreasure(globalCtx, (*markPoint).chestFlag as s32)
                       != 0 {
                    ...
                    match (*globalCtx).sceneNum as libc::c_int {
                        ...
                        _ => { display = 1 as libc::c_int }
                    }
                }
            } else { display = 1 as libc::c_int }
            if display != 0 {
                markInfo =
                    &mut *sMapMarkInfoTable.as_mut_ptr().offset((*mapMarkData).markType
                                                                    as isize)
                        as *mut PauseMapMarkInfo;
                    ...
                    (0xfd as libc::c_int as u32_0 &
                        ...
                        ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_3).words.w1 = (*markInfo).texture as libc::c_uint;
                ...
                (*_g_9).words.w1 =
                    (0 as libc::c_int as u32_0 &
                        ...
                        ((*markInfo).textureHeight.wrapping_sub(1 as
                            ...
                            0 as libc::c_int;
                Matrix_Push();
                Matrix_Translate((*gGameInfo).data[(22 as libc::c_int *
                                                        6 as libc::c_int *
                                                        16 as libc::c_int +
                                                        92 as libc::c_int) as
                                                       usize] as libc::c_int
                                     as libc::c_float + (*markPoint).x,
                                 (*gGameInfo).data[(22 as libc::c_int *
                                                        6 as libc::c_int *
                                                        16 as libc::c_int +
                                                        93 as libc::c_int) as
                                                       usize] as libc::c_int
                                     as libc::c_float + (*markPoint).y,
                                 0.0f32,
                                 MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (*_g_10).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_lmap_mark.c\x00" as *const u8 as
                                      ...
                                      *mut libc::c_char, 272 as libc::c_int)
                        as libc::c_uint;
                Matrix_Pop();
                ...
                (*_g_11).words.w0 =
                    (0x1 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        ((*mapMarkData).vtxCount as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            12 as libc::c_int |
                        ((0 as libc::c_int + (*mapMarkData).vtxCount) as u32_0
                             &
                             (((0x1 as libc::c_int) << 7 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            1 as libc::c_int;
                (*_g_11).words.w1 = (*mapMarkData).vtx as libc::c_uint;
        ...
        mapMarkData = mapMarkData.offset(1);
        Matrix_Pop();
    }
...
#[no_mangle]
pub unsafe extern "C" fn PauseMapMark_Draw(mut globalCtx:
                                               *mut GlobalContext) {
