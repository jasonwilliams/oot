...
extern "C" {
    ...
    #[no_mangle]
    static mut gWarpPadBaseDL: [Gfx; 0];
    #[no_mangle]
    static mut gWarpPadCol: CollisionHeader;
    #[no_mangle]
    static mut gOcarinaWarpPadDL: [Gfx; 0];
    #[no_mangle]
    static mut gOcarinaWarpPadCol: CollisionHeader;
    #[no_mangle]
    static mut D_06000000: s32;
}
...
pub struct BgMjin {
    ...
    pub objBankIndex: s8,
    pub actionFunc: BgMjinActionFunc,
}
pub type BgMjinActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMjin, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Mjin_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MJIN as libc::c_int as s16,
...
static mut sObjectIDs: [s16; 6] =
    [OBJECT_MJIN_FLASH as libc::c_int as s16,
     OBJECT_MJIN_DARK as libc::c_int as s16,
     OBJECT_MJIN_FLAME as libc::c_int as s16,
     OBJECT_MJIN_ICE as libc::c_int as s16,
     OBJECT_MJIN_SOUL as libc::c_int as s16,
     OBJECT_MJIN_WIND as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn BgMjin_SetupAction(mut this: *mut BgMjin,
                                            mut actionFunc:
                                                BgMjinActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgMjin_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMjin = thisx as *mut BgMjin;
    ...
    objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        if (*thisx).params as libc::c_int != 0 as libc::c_int
                           {
                            OBJECT_MJIN as libc::c_int
                        } else { OBJECT_MJIN_OKA as libc::c_int } as s16) as
            s8;
    (*this).objBankIndex = objBankIndex;
    if (objBankIndex as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(thisx);
    } else {
        BgMjin_SetupAction(this,
                           Some(func_808A0850 as
                                    unsafe extern "C" fn(_: *mut BgMjin,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgMjin_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMjin = thisx as *mut BgMjin;
...
#[no_mangle]
pub unsafe extern "C" fn func_808A0850(mut this: *mut BgMjin,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgMjin_DoNothing(mut this: *mut BgMjin,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgMjin_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMjin = thisx as *mut BgMjin;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgMjin_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMjin = thisx as *mut BgMjin;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mjin.c\x00" as *const u8 as *const libc::c_char,
                    250 as libc::c_int);
    if (*thisx).params as libc::c_int != 0 as libc::c_int {
        ...
        if objBankIndex >= 0 as libc::c_int {
            gSegments[6 as libc::c_int as usize] =
                ((*globalCtx).objectCtx.status[objBankIndex as usize].segment
                     as
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((&mut D_06000000 as *mut s32 as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(&mut D_06000000 as *mut s32 as
                                                  u32_0 &
        ...
        dlist = gWarpPadBaseDL.as_mut_ptr()
    } else { dlist = gOcarinaWarpPadDL.as_mut_ptr() }
