...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoWellArchDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoWellArchCol: CollisionHeader;
}
...
pub const DPM_UNK3: C2RustUnnamed_20 = 3;
pub const DPM_ENEMY: C2RustUnnamed_20 = 2;
pub const DPM_PLAYER: C2RustUnnamed_20 = 1;
pub const DPM_UNK: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot01Idohashira {
...
pub type BgSpot01IdohashiraActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                _: *mut GlobalContext) -> ()>;
pub type BgSpot01IdohashiraDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                _: *mut GlobalContext) -> ()>;
static mut sActionFuncs: [BgSpot01IdohashiraActionFunc; 4] =
    unsafe {
        [Some(func_808AB504 as
                  unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                       _: *mut GlobalContext) -> ()),
         Some(func_808AB510 as
                  unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                       _: *mut GlobalContext) -> ()),
         Some(func_808AB530 as
                  unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                       _: *mut GlobalContext) -> ()),
         Some(func_808AB570 as
                  unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                       _: *mut GlobalContext) -> ())]
    };
...
static mut sDrawFuncs: [BgSpot01IdohashiraDrawFunc; 1] =
    unsafe {
        [Some(func_808AB700 as
                  unsafe extern "C" fn(_: *mut BgSpot01Idohashira,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub static mut Bg_Spot01_Idohashira_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id:
                              ACTOR_BG_SPOT01_IDOHASHIRA as libc::c_int as
                                  s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_SPOT01_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot01Idohashira>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idohashira_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idohashira_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idohashira_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idohashira_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_PlayBreakSfx1(mut this:
                                                              *mut BgSpot01Idohashira) {
    func_80078914(&mut (*this).dyna.actor.projectedPos,
                  0x2839 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_PlayBreakSfx2(mut this:
                                                              *mut BgSpot01Idohashira,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    Audio_PlaySoundAtPosition(globalCtx, &mut (*this).dyna.actor.world.pos,
                              60 as libc::c_int,
                              0x28aa as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_808AAD3C(mut globalCtx: *mut GlobalContext,
                                       mut vec: *mut Vec3f, mut arg2: u32_0) {
    let mut effect: EffectSparkInit =
        EffectSparkInit{position: Vec3s{x: 0, y: 0, z: 0,},
                        ...
                        duration: 0,};
    let mut sp24: s32 = 0;
    effect.position.x = (*vec).x as s16;
    effect.position.y = (*vec).y as s16;
    effect.position.z = (*vec).z as s16;
    effect.speed = 8.0f32;
    ...
    effect.colorStart[0 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorStart[1 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorStart[2 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorStart[3 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorEnd[0 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorEnd[1 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
    ...
    effect.colorEnd[2 as libc::c_int as usize].b = 0 as libc::c_int as u8_0;
...
pub unsafe extern "C" fn func_808AAE6C(mut this: *mut BgSpot01Idohashira,
    ...
    func_80033480(globalCtx, &mut sp30,
                  ...
                  ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                       ...
                       libc::c_int + 0x320 as libc::c_int) as s16,
                  0 as libc::c_int as u8_0);
    func_808AAD3C(globalCtx, &mut sp30, 5 as libc::c_int as u32_0);
    BgSpot01Idohashira_PlayBreakSfx2(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_808AAF34(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut dest: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut src: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_170 != 0 as libc::c_int {
        src.x =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        func_80033480(globalCtx, &mut dest,
                      (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int
                                             * 16 as libc::c_int +
                      ...
                      0 as libc::c_int as u8_0);
        func_808AAD3C(globalCtx, &mut dest, 3 as libc::c_int as u32_0);
        src.x =
            -((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 20 as libc::c_int) as
                                    usize] as libc::c_int as libc::c_float +
        ...
        func_80033480(globalCtx, &mut dest,
                      ...
                      0 as libc::c_int as u8_0);
        func_808AAD3C(globalCtx, &mut dest, 3 as libc::c_int as u32_0);
        (*this).unk_170 = 0 as libc::c_int;
        BgSpot01Idohashira_PlayBreakSfx1(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_Destroy(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut BgSpot01Idohashira = thisx as *mut BgSpot01Idohashira;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_NotInCsMode(mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_GetNpcAction(mut globalCtx:
                                                             *mut GlobalContext,
                                                         mut actionIdx: s32)
 -> *mut CsCmdActorAction {
    let mut pad: [s32; 2] = [0; 2];
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    if BgSpot01Idohashira_NotInCsMode(globalCtx) == 0 {
        npcAction = (*globalCtx).csCtx.npcActions[actionIdx as usize]
    }
    return npcAction;
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB18C(mut this: *mut BgSpot01Idohashira) {
    ...
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.shape.rot.y as libc::c_int +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    ...
                                    usize] as libc::c_int +
                  0x3e8 as libc::c_int) as s16 as libc::c_int) as s16;
    (*this).dyna.actor.shape.rot.z =
        ((*this).dyna.actor.shape.rot.z as libc::c_int +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 8 as libc::c_int) as
                                    usize] as libc::c_int +
                  0x7d0 as libc::c_int) as s16 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB1DC(mut arg0: f32_0, mut arg1: f32_0,
                                       mut arg2: u16_0, mut arg3: u16_0,
                                       mut arg4: u16_0) -> f32_0 {
    let mut temp_f12: f32_0 = 0.;
    let mut regFloat: f32_0 = 0.;
    let mut diff23: f32_0 = 0.;
    let mut diff43: f32_0 = 0.;
    diff23 = (arg2 as libc::c_int - arg3 as libc::c_int) as f32_0;
    if diff23 != 0.0f32 {
        regFloat =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  ...
                                  usize] as libc::c_int as libc::c_float +
                30.0f32;
        diff43 = (arg4 as libc::c_int - arg3 as libc::c_int) as f32_0;
        temp_f12 = regFloat * diff43;
        return (arg1 - arg0 - temp_f12) / (diff23 * diff23) * diff43 * diff43
                   + temp_f12
    }
    osSyncPrintf(b"\x1b[31mBg_Spot01_Idohashira_Get_FreeFall\xe3\x81\xa7\xe5\x89\xb2\xe3\x82\x8a\xe7\xae\x97\xe5\x87\xba\xe6\x9d\xa5\xe3\x81\xaa\xe3\x81\x84!!!!!!!!!!!!!!\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    return 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB29C(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    ...
    npcAction = BgSpot01Idohashira_GetNpcAction(globalCtx, 2 as libc::c_int);
    if !npcAction.is_null() {
        ...
        tempY =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                   ...
                                   usize] as libc::c_int as libc::c_float +
                 1100.0f32) / 10.0f32 +
                (*npcAction).endPos.y as libc::c_float;
        endZ = (*npcAction).endPos.z as f32_0;
        thisPos = &mut (*this).dyna.actor.world.pos;
        (*thisPos).x = (endX - initPos.x) * temp_f0 + initPos.x;
        (*thisPos).y =
            func_808AB1DC(initPos.y, tempY, (*npcAction).endFrame,
                          (*npcAction).startFrame, (*globalCtx).csCtx.frames)
                + initPos.y;
...
#[no_mangle]
pub unsafe extern "C" fn func_808AB3E8(mut this: *mut BgSpot01Idohashira) {
    (*this).action = 1 as libc::c_int;
    (*this).drawConfig = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB3F8(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).action = 2 as libc::c_int;
    (*this).drawConfig = 0 as libc::c_int;
    (*this).unk_170 = 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB414(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_808AB444(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        BgSpot01Idohashira_GetNpcAction(globalCtx, 2 as libc::c_int);
    ...
    if !npcAction.is_null() {
        ...
        if action != currentNpcAction {
            match action {
                1 => { func_808AB3E8(this); }
                2 => { func_808AB3F8(this, globalCtx); }
                3 => { Actor_Kill(&mut (*this).dyna.actor); }
                _ => {
                    osSyncPrintf(b"Bg_Spot01_Idohashira_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
                                     as *const u8 as *const libc::c_char);
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_808AB504(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB510(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    func_808AB444(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB530(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    func_808AB18C(this);
    if func_808AB29C(this, globalCtx) != 0 {
        func_808AB414(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808AB570(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    func_808AB444(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_Update(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut this: *mut BgSpot01Idohashira = thisx as *mut BgSpot01Idohashira;
    if (*this).action < 0 as libc::c_int || (*this).action >= 4 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_Init(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut this: *mut BgSpot01Idohashira = thisx as *mut BgSpot01Idohashira;
    ...
    CollisionHeader_GetVirtual(&mut gKakarikoWellArchCol as
    ...
    if gSaveContext.sceneSetupIndex < 4 as libc::c_int {
        ...
        } else { (*this).action = 0 as libc::c_int }
...
#[no_mangle]
pub unsafe extern "C" fn func_808AB700(mut this: *mut BgSpot01Idohashira,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    __gfxCtx = localGfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), localGfxCtx,
                    b"../z_bg_spot01_idohashira.c\x00" as *const u8 as
                        *const libc::c_char, 689 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gKakarikoWellArchDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), localGfxCtx,
                     b"../z_bg_spot01_idohashira.c\x00" as *const u8 as
                         *const libc::c_char, 708 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idohashira_Draw(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot01Idohashira = thisx as *mut BgSpot01Idohashira;
