...
extern "C" {
    ...
    #[no_mangle]
    fn func_8003555C(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
    ...
    #[no_mangle]
    static mut gDodongoFallingStairsDL: [Gfx; 0];
    #[no_mangle]
    static mut gDodongoFallingStairsCol: CollisionHeader;
}
...
pub struct BgDdanKd {
    ...
    pub prevExplosive: *mut Actor,
    pub timer: s16,
    pub prevExplosivePos: Vec3f,
    pub collider: ColliderCylinder,
    pub actionFunc: BgDdanKdActionFunc,
}
pub type BgDdanKdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgDdanKd, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Ddan_Kd_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_DDAN_KD as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDdanKd_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDdanKd_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_SetupAction(mut this: *mut BgDdanKd,
                                              mut actionFunc:
                                                  BgDdanKdActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDdanKd = thisx as *mut BgDdanKd;
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    (*this).prevExplosive = 0 as *mut Actor;
    ...
    CollisionHeader_GetVirtual(&mut gDodongoFallingStairsCol as
    ...
    if Flags_GetSwitch(globalCtx, (*this).dyna.actor.params as s32) == 0 {
        BgDdanKd_SetupAction(this,
                             Some(BgDdanKd_CheckForExplosions as
                                      unsafe extern "C" fn(_: *mut BgDdanKd,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
    } else {
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y - 200.0f32 - 20.0f32;
        BgDdanKd_SetupAction(this,
                             Some(BgDdanKd_DoNothing as
                                      unsafe extern "C" fn(_: *mut BgDdanKd,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDdanKd = thisx as *mut BgDdanKd;
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_CheckForExplosions(mut this: *mut BgDdanKd,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut explosive: *mut Actor = 0 as *mut Actor;
    explosive =
        Actor_GetCollidedExplosive(globalCtx, &mut (*this).collider.base);
    if !explosive.is_null() {
        osSyncPrintf(b"dam    %d\n\x00" as *const u8 as *const libc::c_char,
                     (*this).dyna.actor.colChkInfo.damage as libc::c_int);
        (*explosive).params = 2 as libc::c_int as s16
    }
    if !explosive.is_null() && !(*this).prevExplosive.is_null() &&
           explosive != (*this).prevExplosive &&
           Math_Vec3f_DistXZ(&mut (*this).prevExplosivePos,
                             &mut (*explosive).world.pos) > 80.0f32 {
        BgDdanKd_SetupAction(this,
                             Some(BgDdanKd_LowerStairs as
                                      unsafe extern "C" fn(_: *mut BgDdanKd,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
        OnePointCutscene_Init(globalCtx, 3050 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_LowerStairs(mut this: *mut BgDdanKd,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 5.0f32, z: 0.0f32,}; init };
    static mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -0.45f32, z: 0.0f32,}; init };
    let mut pos1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut effectStrength: f32_0 = 0.;
    Math_SmoothStepToF(&mut (*this).dyna.actor.speedXZ, 4.0f32, 0.5f32,
                       0.025f32, 0.0f32);
    ...
    if Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                          (*this).dyna.actor.home.pos.y - 200.0f32 - 20.0f32,
                          0.075f32, (*this).dyna.actor.speedXZ, 0.0075f32) ==
           0.0f32 {
        ...
        effectStrength =
            (*this).dyna.actor.prevPos.y - (*this).dyna.actor.world.pos.y +
                (*this).dyna.actor.speedXZ * 0.25f32;
        if (*globalCtx).state.frames & 1 as libc::c_int as libc::c_uint != 0 {
            pos2 = (*this).dyna.actor.world.pos;
            pos1 = pos2;
            if (*globalCtx).state.frames & 2 as libc::c_int as libc::c_uint !=
                   0 {
                pos1.z += 210.0f32 + Rand_ZeroOne() * 230.0f32;
                pos2.z += 210.0f32 + Rand_ZeroOne() * 230.0f32
            } else {
                pos1.z += 330.0f32 + Rand_ZeroOne() * 240.0f32;
                pos2.z += 330.0f32 + Rand_ZeroOne() * 240.0f32
            }
            pos1.x += 80.0f32 + Rand_ZeroOne() * 10.0f32;
            pos2.x -= 80.0f32 + Rand_ZeroOne() * 10.0f32;
            pos1.y =
                (*this).dyna.actor.floorHeight + 20.0f32 + Rand_ZeroOne();
            pos2.y =
                (*this).dyna.actor.floorHeight + 20.0f32 + Rand_ZeroOne();
            func_80033480(globalCtx, &mut pos1, 20.0f32, 1 as libc::c_int,
                          (effectStrength * 135.0f32) as s16,
                          60 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            func_80033480(globalCtx, &mut pos2, 20.0f32, 1 as libc::c_int,
                          (effectStrength * 135.0f32) as s16,
                          60 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            velocity.x = Rand_CenteredFloat(3.0f32);
            velocity.z = Rand_CenteredFloat(3.0f32);
            func_8003555C(globalCtx, &mut pos1, &mut velocity, &mut accel);
            func_8003555C(globalCtx, &mut pos2, &mut velocity, &mut accel);
            pos1 = (*this).dyna.actor.world.pos;
            pos1.z += 560.0f32 + Rand_ZeroOne() * 5.0f32;
            pos1.x += (Rand_ZeroOne() - 0.5f32) * 160.0f32;
            pos1.y =
                Rand_ZeroOne() * 3.0f32 +
                    ((*this).dyna.actor.floorHeight + 20.0f32);
            func_80033480(globalCtx, &mut pos1, 20.0f32, 1 as libc::c_int,
                          (effectStrength * 135.0f32) as s16,
                          60 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            func_8003555C(globalCtx, &mut pos1, &mut velocity, &mut accel);
        }
        Camera_AddQuake(&mut (*globalCtx).mainCamera, 0 as libc::c_int,
                        (effectStrength * 0.6f32) as s16, 3 as libc::c_int);
        Audio_PlaySoundGeneral((0x2827 as libc::c_int - 0x800 as libc::c_int)
                                   as u16_0,
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_DoNothing(mut this: *mut BgDdanKd,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDdanKd = thisx as *mut BgDdanKd;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgDdanKd_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gDodongoFallingStairsDL.as_mut_ptr());
}
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(32767 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
