...
pub struct EnKarebaba {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnKarebabaActionFunc,
    pub jointTable: [Vec3s; 8],
    pub morphTable: [Vec3s; 8],
    pub boundFloor: *mut CollisionPoly,
    pub headCollider: ColliderCylinder,
    pub bodyCollider: ColliderCylinder,
}
pub type EnKarebabaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKarebaba, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Karebaba_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KAREBABA as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKarebaba_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKarebaba_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKarebaba_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKarebaba_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sHeadColliderInit: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKarebaba = thisx as *mut EnKarebaba;
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).headCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).headCollider,
                         &mut (*this).actor, &mut sHeadColliderInit);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).headCollider);
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo,
                           DamageTable_Get(1 as libc::c_int),
                           &mut sColCheckInfoInit);
    (*this).boundFloor = 0 as *mut CollisionPoly;
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        EnKarebaba_SetupGrow(this);
    } else { EnKarebaba_SetupIdle(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnKarebaba = thisx as *mut EnKarebaba;
    Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).headCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_ResetCollider(mut this: *mut EnKarebaba) {
    (*this).bodyCollider.dim.radius = 7 as libc::c_int as s16;
    (*this).bodyCollider.dim.height = 25 as libc::c_int as s16;
    (*this).bodyCollider.base.colType = COLTYPE_HARD as libc::c_int as u8_0;
    ...
    (*this).headCollider.dim.height = 25 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupGrow(mut this: *mut EnKarebaba) {
    Actor_SetScale(&mut (*this).actor, 0.0f32);
    (*this).actor.shape.rot.x = -(0x4000 as libc::c_int) as s16;
    (*this).actionFunc =
        Some(EnKarebaba_Grow as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 14.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupIdle(mut this: *mut EnKarebaba) {
    Actor_SetScale(&mut (*this).actor, 0.005f32);
    (*this).actor.shape.rot.x = -(0x4000 as libc::c_int) as s16;
    (*this).actionFunc =
        Some(EnKarebaba_Idle as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 14.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupAwaken(mut this: *mut EnKarebaba) {
    ...
    (*this).actionFunc =
        Some(EnKarebaba_Awaken as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupUpright(mut this: *mut EnKarebaba) {
    if (*this).actionFunc !=
           Some(EnKarebaba_Spin as
                    unsafe extern "C" fn(_: *mut EnKarebaba,
                                         _: *mut GlobalContext) -> ()) {
        Actor_SetScale(&mut (*this).actor, 0.01f32);
        (*this).bodyCollider.base.colType =
            COLTYPE_HIT6 as libc::c_int as u8_0;
        (*this).bodyCollider.base.acFlags =
            ((*this).bodyCollider.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
        (*this).bodyCollider.info.bumper.dmgFlags =
            if !(gSaveContext.linkAge == 0 as libc::c_int) {
                0x7c00710 as libc::c_int
            } else { 0xfc00710 as libc::c_int } as u32_0;
        (*this).bodyCollider.dim.radius = 15 as libc::c_int as s16;
        (*this).bodyCollider.dim.height = 80 as libc::c_int as s16;
        (*this).headCollider.dim.height = 80 as libc::c_int as s16
    }
    (*this).actor.params = 40 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnKarebaba_Upright as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupSpin(mut this: *mut EnKarebaba) {
    (*this).actor.params = 40 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnKarebaba_Spin as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupDying(mut this: *mut EnKarebaba) {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x3862 as libc::c_int as u16_0);
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int |
             (1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnKarebaba_Dying as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupDeadItemDrop(mut this:
                                                          *mut EnKarebaba,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    ...
    (*this).actor.params = 200 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnKarebaba_DeadItemDrop as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupRetract(mut this: *mut EnKarebaba) {
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
                     -3.0f32,
                     Animation_GetLastFrame(&mut gDekuBabaFastChompAnim as
                                                *mut AnimationHeader as
    ...
    (*this).actionFunc =
        Some(EnKarebaba_Retract as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupDead(mut this: *mut EnKarebaba) {
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
    ...
    (*this).actionFunc =
        Some(EnKarebaba_Dead as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_SetupRegrow(mut this: *mut EnKarebaba) {
    (*this).actor.shape.yOffset = 0.0f32;
    (*this).actor.shape.shadowScale = 22.0f32;
    (*this).headCollider.dim.radius = sHeadColliderInit.dim.radius;
    Actor_SetScale(&mut (*this).actor, 0.0f32);
    (*this).actionFunc =
        Some(EnKarebaba_Regrow as
                 unsafe extern "C" fn(_: *mut EnKarebaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Grow(mut this: *mut EnKarebaba,
                                         mut globalCtx: *mut GlobalContext) {
    let mut scale: f32_0 = 0.;
    (*this).actor.params += 1;
    scale = (*this).actor.params as libc::c_int as libc::c_float * 0.05f32;
    Actor_SetScale(&mut (*this).actor, 0.005f32 * scale);
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 14.0f32 * scale;
    if (*this).actor.params as libc::c_int == 20 as libc::c_int {
        EnKarebaba_SetupIdle(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Idle(mut this: *mut EnKarebaba,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.xzDistToPlayer < 200.0f32 &&
           fabsf((*this).actor.yDistToPlayer) < 30.0f32 {
        EnKarebaba_SetupAwaken(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Awaken(mut this: *mut EnKarebaba,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    if Math_StepToF(&mut (*this).actor.world.pos.y,
                    (*this).actor.home.pos.y + 60.0f32, 5.0f32) != 0 {
        EnKarebaba_SetupUpright(this);
    }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x1999 as libc::c_int) as
            s16;
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.home.pos, 3.0f32,
                             0 as libc::c_int as s16,
                             12 as libc::c_int as s16,
                             5 as libc::c_int as s16, 1 as libc::c_int as s16,
                             -(1 as libc::c_int) as s16,
                             10 as libc::c_int as s16, 0 as *mut Gfx);
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Upright(mut this: *mut EnKarebaba,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    } else if Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                                &mut (*player).actor.world.pos) > 240.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Spin(mut this: *mut EnKarebaba,
                                         mut globalCtx: *mut GlobalContext) {
    let mut value: s32 = 0;
    let mut cos60: f32_0 = 0.;
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        (*this).actor.params -= 1
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    value = 20 as libc::c_int - (*this).actor.params as libc::c_int;
    value =
        20 as libc::c_int -
            (if value >= 0 as libc::c_int { value } else { -value });
    if value > 10 as libc::c_int { value = 10 as libc::c_int }
    (*this).headCollider.dim.radius =
        (sHeadColliderInit.dim.radius as libc::c_int +
             value * 2 as libc::c_int) as s16;
    (*this).actor.shape.rot.x =
        (0xc000 as libc::c_int - value * 0x100 as libc::c_int) as s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             value * 0x2c0 as libc::c_int) as s16;
    (*this).actor.world.pos.y =
        Math_SinS((*this).actor.shape.rot.x) * -60.0f32 +
            (*this).actor.home.pos.y;
    cos60 = Math_CosS((*this).actor.shape.rot.x) * 60.0f32;
    (*this).actor.world.pos.x =
        Math_SinS((*this).actor.shape.rot.y) * cos60 +
            (*this).actor.home.pos.x;
    (*this).actor.world.pos.z =
        Math_CosS((*this).actor.shape.rot.y) * cos60 +
...
pub unsafe extern "C" fn EnKarebaba_Dying(mut this: *mut EnKarebaba,
    ...
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        ...
        Math_Vec3f_Copy(&mut position, &mut (*this).actor.world.pos);
        rotation.z = Math_SinS((*this).actor.shape.rot.x) * 20.0f32;
        rotation.x =
        ...
        while i < 4 as libc::c_int {
            func_800286CC(globalCtx, &mut position, &mut zeroVec,
                          &mut zeroVec, 500 as libc::c_int as s16,
        ...
        func_800286CC(globalCtx, &mut (*this).actor.home.pos, &mut zeroVec,
                      &mut zeroVec, 500 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_DeadItemDrop(mut this: *mut EnKarebaba,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        (*this).actor.params -= 1
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 ||
        ...
        func_8002F554(&mut (*this).actor, globalCtx,
                      GI_STICKS_1 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Retract(mut this: *mut EnKarebaba,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_StepToF(&mut (*this).actor.scale.x, 0.005f32, 0.0005f32);
    (*this).actor.scale.z = (*this).actor.scale.x;
    (*this).actor.scale.y = (*this).actor.scale.z;
    if Math_StepToF(&mut (*this).actor.world.pos.y,
                    (*this).actor.home.pos.y + 14.0f32, 5.0f32) != 0 {
        EnKarebaba_SetupIdle(this);
    }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x1999 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Dead(mut this: *mut EnKarebaba,
                                         mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        (*this).actor.params -= 1
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Regrow(mut this: *mut EnKarebaba,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut scaleFactor: f32_0 = 0.;
    (*this).actor.params += 1;
    scaleFactor =
        (*this).actor.params as libc::c_int as libc::c_float * 0.05f32;
    Actor_SetScale(&mut (*this).actor, 0.005f32 * scaleFactor);
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y + 14.0f32 * scaleFactor;
    if (*this).actor.params as libc::c_int == 20 as libc::c_int {
        (*this).actor.flags &=
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnKarebaba = thisx as *mut EnKarebaba;
        ...
        if (*this).actionFunc !=
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            ...
            Actor_SetFocus(&mut (*this).actor,
                           (*this).actor.scale.x * 10.0f32 / 0.01f32);
            height = (*this).actor.home.pos.y + 40.0f32;
            (*this).actor.focus.pos.x = (*this).actor.home.pos.x;
            (*this).actor.focus.pos.y =
                if (*this).actor.focus.pos.y > height {
                    height
                } else { (*this).actor.focus.pos.y };
            (*this).actor.focus.pos.z = (*this).actor.home.pos.z
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_DrawBaseShadow(mut this: *mut EnKarebaba,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_karebaba.c\x00" as *const u8 as
    ...
    Matrix_Scale(0.15f32, 1.0f32, 0.15f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnKarebaba_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    static mut black: Color_RGBA8 =
        {
            let mut init =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_karebaba.c\x00" as *const u8 as
                        *const libc::c_char, 1056 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if (*this).actionFunc ==
           Some(EnKarebaba_DeadItemDrop as
                    unsafe extern "C" fn(_: *mut EnKarebaba,
                                         _: *mut GlobalContext) -> ()) {
        if (*this).actor.params as libc::c_int > 40 as libc::c_int ||
               (*this).actor.params as libc::c_int & 1 as libc::c_int != 0 {
            ...
            (*_g_0).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gDekuBabaStickDropDL.as_mut_ptr() as libc::c_uint
        }
                  ...
                  Some(EnKarebaba_Dead as
                           unsafe extern "C" fn(_: *mut EnKarebaba,
                                                _: *mut GlobalContext) -> ())
     {
        func_80026230(globalCtx, &mut black, 1 as libc::c_int as s16,
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_2).words.w1 = stemDLists[i as usize] as libc::c_uint;
    ...
    Matrix_RotateY((*this).actor.home.rot.y as libc::c_int as libc::c_float *
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = gDekuBabaBaseLeavesDL.as_mut_ptr() as libc::c_uint;
    if (*this).actionFunc ==
           Some(EnKarebaba_Dying as
                    unsafe extern "C" fn(_: *mut EnKarebaba,
                                         _: *mut GlobalContext) -> ()) {
        Matrix_RotateZYX(-(0x4000 as libc::c_int) as s16,
                         ((*this).actor.shape.rot.y as libc::c_int -
                              (*this).actor.home.rot.y as libc::c_int) as s16,
                         0 as libc::c_int as s16,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = gDekuBabaStemBaseDL.as_mut_ptr() as libc::c_uint
    }
    func_80026608(globalCtx);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_karebaba.c\x00" as *const u8 as
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(0x9 as libc::c_int);
             init
         }]
}
#[used]
