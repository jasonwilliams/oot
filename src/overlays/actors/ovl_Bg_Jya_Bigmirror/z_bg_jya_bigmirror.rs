...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gBigMirror1DL: [Gfx; 0];
    #[no_mangle]
    static mut gBigMirror2DL: [Gfx; 0];
    #[no_mangle]
    static mut gBigMirror3DL: [Gfx; 0];
    #[no_mangle]
    static mut gBigMirror4DL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Bg_Jya_Bigmirror_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_BIGMIRROR as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJyaBigmirror>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBigmirror_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBigmirror_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBigmirror_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBigmirror_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x14
static mut sCobraSpawnData: [BigMirrorDataEntry; 2] =
    [{
         let mut init =
             BigMirrorDataEntry{pos:
                                    {
                                        let mut init =
                                            Vec3f{x: -560.0f32,
                                                  y: 1743.0f32,
                                ...
                                params: 0xff01 as libc::c_int as s16,
                                solvedRotY: 0x4000 as libc::c_int as s16,
                                initRotY: 0x8000 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BigMirrorDataEntry{pos:
                                ...
                                params: 0xff02 as libc::c_int as s16,
                                solvedRotY: 0x8000 as libc::c_int as s16,
                                initRotY: 0xa000 as libc::c_int as s16,};
         init
     }];
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_SetRoomFlag(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    (*this).puzzleFlags =
        ((*this).puzzleFlags as libc::c_int &
             !((1 as libc::c_int) << 3 as libc::c_int |
                   (1 as libc::c_int) << 4 as libc::c_int |
                   (1 as libc::c_int) << 5 as libc::c_int)) as u8_0;
    if (*globalCtx).roomCtx.curRoom.num as libc::c_int == 5 as libc::c_int {
        (*this).puzzleFlags =
            ((*this).puzzleFlags as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_HandleCobra(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    static mut cobraPuzzleFlags: [u8_0; 2] =
        [((1 as libc::c_int) << 0 as libc::c_int) as u8_0,
         ((1 as libc::c_int) << 1 as libc::c_int) as u8_0];
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    let mut curSpawnData: *mut BigMirrorDataEntry =
        0 as *mut BigMirrorDataEntry;
    let mut curCobraInfo: *mut BigmirrorCobra = 0 as *mut BigmirrorCobra;
    let mut i: s32 = 0;
    if (*this).puzzleFlags as libc::c_int &
           ((1 as libc::c_int) << 4 as libc::c_int |
                (1 as libc::c_int) << 5 as libc::c_int) != 0 {
        i = 0 as libc::c_int;
        while i < 2 as libc::c_int {
            curSpawnData =
                &mut *sCobraSpawnData.as_mut_ptr().offset(i as isize) as
                    *mut BigMirrorDataEntry;
            curCobraInfo =
                &mut *(*this).cobraInfo.as_mut_ptr().offset(i as isize) as
                    *mut BigmirrorCobra;
            if !(*curCobraInfo).cobra.is_null() {
                (*curCobraInfo).rotY =
                    (*(*curCobraInfo).cobra).dyna.actor.shape.rot.y;
                if (*curCobraInfo).rotY as libc::c_int ==
                       (*curSpawnData).solvedRotY as libc::c_int {
                    (*this).puzzleFlags =
                        ((*this).puzzleFlags as libc::c_int |
                             cobraPuzzleFlags[i as usize] as libc::c_int) as
                            u8_0
                } else {
                    (*this).puzzleFlags =
                        ((*this).puzzleFlags as libc::c_int &
                             !(cobraPuzzleFlags[i as usize] as libc::c_int))
                            as u8_0
                }
                if (*(*curCobraInfo).cobra).dyna.actor.update.is_none() {
                    // "Cobra deleted"
                    osSyncPrintf(b"Error : \xe3\x82\xb3\xe3\x83\x96\xe3\x83\xa9\xe5\x89\x8a\xe9\x99\xa4\xe3\x81\x95\xe3\x82\x8c\xe3\x81\x9f (%s %d)\n\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"../z_bg_jya_bigmirror.c\x00" as *const u8
                ...
                (*curCobraInfo).cobra =
                    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                       ...
                                       ACTOR_BG_JYA_COBRA as libc::c_int as
                                           s16, (*curSpawnData).pos.x,
                                       (*curSpawnData).pos.y,
                                       (*curSpawnData).pos.z,
                                       0 as libc::c_int as s16,
                                       (*curCobraInfo).rotY,
                                       0 as libc::c_int as s16,
                                       (*curSpawnData).params) as
                        *mut BgJyaCobra;
                (*this).actor.child = 0 as *mut Actor;
                if (&mut (*(*curCobraInfo).cobra).dyna.actor as
                        *mut Actor).is_null() {
                    // "Cobra generation failed"
                    osSyncPrintf(b"Error : \xe3\x82\xb3\xe3\x83\x96\xe3\x83\xa9\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"../z_bg_jya_bigmirror.c\x00" as *const u8
                                     as *const libc::c_char,
                                 221 as
                                     libc::c_int); // Only spawn if puzzle solved
                }
            }
            i += 1
        }
        ...
        while i < 2 as libc::c_int {
            curCobraInfo =
                &mut *(*this).cobraInfo.as_mut_ptr().offset(i as isize) as
                    *mut BigmirrorCobra;
            if !(*curCobraInfo).cobra.is_null() {
                if !(*(*curCobraInfo).cobra).dyna.actor.child.is_null() {
                    Actor_Kill((*(*curCobraInfo).cobra).dyna.actor.child);
                    (*(*curCobraInfo).cobra).dyna.actor.child =
                        0 as *mut Actor
                }
                Actor_Kill(&mut (*(*curCobraInfo).cobra).dyna.actor);
                (*curCobraInfo).cobra = 0 as *mut BgJyaCobra
            }
            i += 1
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_SetBombiwaFlag(mut thisx: *mut Actor,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_HandleMirRay(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut sMirRayParamss: [s16; 3] =
        [0x5 as libc::c_int as s16, 0x7 as libc::c_int as s16,
         0x8 as libc::c_int as s16];
    static mut sMirRayPoss: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: 60.0f32, y: 1802.0f32, z: -1102.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -560.0f32, y: 1800.0f32, z: -310.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 60.0f32, y: 1800.0f32, z: -310.0f32,};
             init
         }];
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    let mut puzzleSolved: s32 = 0;
    let mut lightBeamToggles: [s32; 3] = [0; 3];
    let mut i: s32 = 0;
    let mut objBankIndex: s32 = 0;
    objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_MIR_RAY as libc::c_int as s16);
    if objBankIndex < 0 as libc::c_int ||
           objBankIndex != (*this).mirRayObjIndex {
        (*this).lightBeams[2 as libc::c_int as usize] = 0 as *mut Actor;
        (*this).lightBeams[1 as libc::c_int as usize] = 0 as *mut Actor;
        (*this).lightBeams[0 as libc::c_int as usize] = 0 as *mut Actor
    } else {
        puzzleSolved =
            ((*this).puzzleFlags as libc::c_int &
                 ((1 as libc::c_int) << 3 as libc::c_int |
                      (1 as libc::c_int) << 4 as libc::c_int) != 0) as
                libc::c_int;
        if puzzleSolved != 0 {
            puzzleSolved =
                ((*this).puzzleFlags as libc::c_int &
                     (1 as libc::c_int) << 1 as libc::c_int != 0) as
                    libc::c_int;
            if puzzleSolved != 0 {
                puzzleSolved =
                    ((*this).puzzleFlags as libc::c_int &
                         (1 as libc::c_int) << 0 as libc::c_int != 0) as
                        libc::c_int
            }
        }
        lightBeamToggles[0 as libc::c_int as usize] = puzzleSolved;
        lightBeamToggles[2 as libc::c_int as usize] =
            (*this).puzzleFlags as libc::c_int &
                ((1 as libc::c_int) << 4 as libc::c_int |
                     (1 as libc::c_int) << 5 as libc::c_int);
        lightBeamToggles[1 as libc::c_int as usize] =
            lightBeamToggles[2 as libc::c_int as usize];
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            if lightBeamToggles[i as usize] != 0 {
                if (*this).lightBeams[i as usize].is_null() &&
                       Object_IsLoaded(&mut (*globalCtx).objectCtx,
                                       objBankIndex) != 0 {
                    (*this).lightBeams[i as usize] =
                        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                    ACTOR_MIR_RAY as libc::c_int as s16,
                                    sMirRayPoss[i as usize].x,
                                    sMirRayPoss[i as usize].y,
                                    sMirRayPoss[i as usize].z,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    sMirRayParamss[i as usize]);
                    if (*this).lightBeams[i as usize].is_null() {
                        // "Mir Ray generation failed"
                        osSyncPrintf(b"Error : Mir Ray \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                                         as *const u8 as *const libc::c_char,
                                     b"../z_bg_jya_bigmirror.c\x00" as
                                         *const u8 as *const libc::c_char,
                                     310 as libc::c_int);
                    }
                }
            } else if !(*this).lightBeams[i as usize].is_null() {
                Actor_Kill((*this).lightBeams[i as usize]);
                (*this).lightBeams[i as usize] = 0 as *mut Actor
            }
            i += 1
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    if sIsSpawned != 0 { Actor_Kill(&mut (*this).actor); return }
    Actor_SetScale(&mut (*this).actor, 0.1f32);
    (*this).cobraInfo[0 as libc::c_int as usize].rotY =
        sCobraSpawnData[0 as libc::c_int as usize].initRotY;
    (*this).cobraInfo[1 as libc::c_int as usize].rotY =
        sCobraSpawnData[1 as libc::c_int as usize].initRotY;
    (*this).actor.room = -(1 as libc::c_int) as s8;
    sIsSpawned = 1 as libc::c_int as u8_0;
    (*this).spawned = 1 as libc::c_int as u8_0;
    (*this).mirRayObjIndex = -(1 as libc::c_int);
    // "jya Bigmirror"
    osSyncPrintf(b"(jya \xe5\xa4\xa7\xe9\x8f\xa1)(arg_data 0x%04x)\n\x00" as
                     *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    if (*this).spawned != 0 { sIsSpawned = 0 as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_DrawLightBeam(mut thisx: *mut Actor,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    static mut D_80893F4C: Vec3s =
        {
            let mut init =
    ...
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    let mut lift: *mut Actor = 0 as *mut Actor;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_bigmirror.c\x00" as *const u8 as
                        *const libc::c_char, 435 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    lift =
        Actor_Find(&mut (*globalCtx).actorCtx,
                   ACTOR_BG_JYA_LIFT as libc::c_int,
                   ACTORCAT_BG as libc::c_int);
    if !lift.is_null() { (*this).liftHeight = (*lift).world.pos.y }
    func_800D1694((*this).actor.world.pos.x,
                  (*this).actor.world.pos.y + 40.0f32,
                  (*this).actor.world.pos.z, &mut (*this).actor.shape.rot);
    Matrix_Scale(0.1f32,
                 (*this).liftHeight * -(1.0f32 / 1280.0f32) +
                     1779.4f32 / 1280.0f32, 0.1f32,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBigMirror1DL.as_mut_ptr() as libc::c_uint;
    if !lift.is_null() {
        func_800D1694((*lift).world.pos.x, (*lift).world.pos.y,
                      (*lift).world.pos.z, &mut D_80893F4C);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = gBigMirror2DL.as_mut_ptr() as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBigmirror_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaBigmirror = thisx as *mut BgJyaBigmirror;
    if (*this).puzzleFlags as libc::c_int &
           (1 as libc::c_int) << 4 as libc::c_int != 0 {
        Gfx_DrawDListOpa(globalCtx, gBigMirror3DL.as_mut_ptr());
        Gfx_DrawDListXlu(globalCtx, gBigMirror4DL.as_mut_ptr());
    }
    if (*this).puzzleFlags as libc::c_int &
           ((1 as libc::c_int) << 3 as libc::c_int |
                (1 as libc::c_int) << 4 as libc::c_int |
        ...
        BgJyaBigmirror_DrawLightBeam(&mut (*this).actor, globalCtx);
    };
}
