...
extern "C" {
    ...
    #[no_mangle]
    static mut object_kingdodongo_DL_025A90: [Gfx; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02E4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02E8E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02ECE0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02F0E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02F4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02F8E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02FCE0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0300E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0304E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0308E0: [u64_0; 0];
}
...
static mut sTextures: [*mut libc::c_void; 13] =
    unsafe {
        [object_kingdodongo_Tex_02E4E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02E8E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02ECE0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02F0E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02F4E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02F8E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_02FCE0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_0300E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_0304E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_0308E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_0308E0.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_kingdodongo_Tex_0308E0.as_ptr() as *mut _ as
...
#[no_mangle]
pub static mut Effect_Ss_G_Magma2_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_G_MAGMA2 as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGMagma2_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma2_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
 ...
 -> u32_0 {
    ...
    if objBankIndex >= 0 as libc::c_int &&
           Object_IsLoaded(&mut (*globalCtx).objectCtx, objBankIndex) != 0 {
        let mut zeroVec: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut initParams: *mut EffectSsGMagma2InitParams =
            initParamsx as *mut EffectSsGMagma2InitParams;
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[objBankIndex as usize].segment as
                ...
                u32_0;
        (*this).regs[10 as libc::c_int as usize] = objBankIndex as s16;
        (*this).pos = (*initParams).pos;
        (*this).velocity = zeroVec;
        (*this).accel = zeroVec;
        (*this).life = 100 as libc::c_int as s16;
        (*this).draw =
            Some(EffectSsGMagma2_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsGMagma2_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).gfx =
            gSegments[((object_kingdodongo_DL_025A90.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_kingdodongo_DL_025A90.as_mut_ptr()
                                                  as u32_0 &
        ...
        (*this).regs[9 as libc::c_int as usize] = (*initParams).drawMode;
        (*this).regs[8 as libc::c_int as usize] = (*initParams).updateRate;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma2_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    ...
    object =
        (*globalCtx).objectCtx.status[(*this).regs[10 as libc::c_int as usize]
                                          as usize].segment;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_g_magma2.c\x00" as *const u8 as
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gSegments[((sTextures[(*this).regs[6 as libc::c_int as usize] as
                                  usize] as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(sTextures[(*this).regs[6 as
                                                                     libc::c_int
                                                                     as usize]
                                                        as usize] as u32_0 &
                                              0xffffff as libc::c_int as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_ss_g_magma2.c\x00" as *const u8 as
                         *const libc::c_char, 311 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma2_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    (*this).regs[7 as libc::c_int as usize] =
        ((*this).regs[7 as libc::c_int as usize] as libc::c_int +
             (*this).regs[8 as libc::c_int as usize] as libc::c_int) as s16;
    if (*this).regs[7 as libc::c_int as usize] as libc::c_int >=
           10 as libc::c_int {
        (*this).regs[7 as libc::c_int as usize] =
            ((*this).regs[7 as libc::c_int as usize] as libc::c_int -
                 10 as libc::c_int) as s16;
        (*this).regs[6 as libc::c_int as usize] += 1;
