...
extern "C" {
    ...
    #[no_mangle]
    static mut _ovl_map_mark_dataSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_map_mark_dataSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_map_mark_dataSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_map_mark_dataSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gMapMarkDataTable: [*mut MapMarkData; 0];
    #[no_mangle]
    static mut gMapChestIconTex: [u64_0; 0];
    #[no_mangle]
    static mut gMapBossIconTex: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct MapMarkDataOverlay {
    pub loadedRamAddr: *mut libc::c_void,
    pub vromStart: u32_0,
    pub vromEnd: u32_0,
    pub vramStart: *mut libc::c_void,
    pub vramEnd: *mut libc::c_void,
    pub vramTable: *mut libc::c_void,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct MapMarkInfo {
    pub texture: *mut libc::c_void,
    pub imageFormat: u32_0,
    pub imageSize: u32_0,
    pub textureWidth: u32_0,
    pub textureHeight: u32_0,
    pub rectWidth: u32_0,
    pub rectHeight: u32_0,
    pub dsdx: u32_0,
    pub dtdy: u32_0,
}
// size = 0x18
static mut sBaseImageSizes: [u32_0; 4] =
    [0 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     2 as libc::c_int as u32_0, 3 as libc::c_int as u32_0];
static mut sLoadBlockImageSizes: [u32_0; 4] =
    [2 as libc::c_int as u32_0, 2 as libc::c_int as u32_0,
     2 as libc::c_int as u32_0, 3 as libc::c_int as u32_0];
static mut sIncrImageSizes: [u32_0; 4] =
    [3 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     0 as libc::c_int as u32_0, 0 as libc::c_int as u32_0];
static mut sShiftImageSizes: [u32_0; 4] =
    [2 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     0 as libc::c_int as u32_0, 0 as libc::c_int as u32_0];
static mut sBytesImageSizes: [u32_0; 4] =
    [0 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     2 as libc::c_int as u32_0, 4 as libc::c_int as u32_0];
static mut sLineBytesImageSizes: [u32_0; 4] =
    [0 as libc::c_int as u32_0, 1 as libc::c_int as u32_0,
     2 as libc::c_int as u32_0, 2 as libc::c_int as u32_0];
static mut sMapMarkInfoTable: [MapMarkInfo; 2] =
    unsafe {
        [{
             let mut init =
                 MapMarkInfo{texture:
                                 gMapChestIconTex.as_ptr() as *mut _ as
                                     *mut libc::c_void,
                             imageFormat: 0 as libc::c_int as u32_0,
                             imageSize: 2 as libc::c_int as u32_0,
                             textureWidth: 8 as libc::c_int as u32_0,
                             textureHeight: 8 as libc::c_int as u32_0,
                             rectWidth: 32 as libc::c_int as u32_0,
                             rectHeight: 32 as libc::c_int as u32_0,
                             dsdx:
         ...
         },
         {
             let mut init =
                 MapMarkInfo{texture:
                                 gMapBossIconTex.as_ptr() as *mut _ as
                                     *mut libc::c_void,
                             imageFormat: 3 as libc::c_int as u32_0,
                             imageSize: 1 as libc::c_int as u32_0,
                             textureWidth: 8 as libc::c_int as u32_0,
                             textureHeight: 8 as libc::c_int as u32_0,
                             rectWidth: 32 as libc::c_int as u32_0,
                             rectHeight: 32 as libc::c_int as u32_0,
...
static mut sMapMarkDataOvl: MapMarkDataOverlay =
    MapMarkDataOverlay{loadedRamAddr:
                           0 as *const libc::c_void as *mut libc::c_void,
                       vromStart: 0,
                       vromEnd: 0,
                       vramStart:
                           0 as *const libc::c_void as *mut libc::c_void,
                       vramEnd: 0 as *const libc::c_void as *mut libc::c_void,
                       vramTable:
                           0 as *const libc::c_void as *mut libc::c_void,};
static mut sLoadedMarkDataTable: *mut *mut MapMarkData =
    0 as *const *mut MapMarkData as *mut *mut MapMarkData;
#[no_mangle]
pub unsafe extern "C" fn MapMark_Init(mut globalCtx: *mut GlobalContext) {
    let mut overlay: *mut MapMarkDataOverlay = &mut sMapMarkDataOvl;
    let mut overlaySize: u32_0 =
        ((*overlay).vramEnd as
             u32_0).wrapping_sub((*overlay).vramStart as u32_0);
    (*overlay).loadedRamAddr =
        GameState_Alloc(&mut (*globalCtx).state, overlaySize as size_t,
                        b"../z_map_mark.c\x00" as *const u8 as
                            *const libc::c_char as *mut libc::c_char,
                        235 as libc::c_int);
    LogUtils_CheckNullPointer(b"dlftbl->allocp\x00" as *const u8 as
                                  *const libc::c_char,
                              (*overlay).loadedRamAddr,
                              b"../z_map_mark.c\x00" as *const u8 as
    ...
    Overlay_Load((*overlay).vromStart, (*overlay).vromEnd,
                 ...
                 (*overlay).loadedRamAddr);
    sLoadedMarkDataTable = gMapMarkDataTable.as_mut_ptr();
    sLoadedMarkDataTable =
        if !(*overlay).vramTable.is_null() {
            ((*overlay).vramTable as
                 u32_0).wrapping_sub(((*overlay).vramStart as
                                          u32_0).wrapping_sub((*overlay).loadedRamAddr
                                                                  as u32_0) as
                                         s32 as libc::c_uint) as
                *mut libc::c_void
        } else { 0 as *mut libc::c_void } as u32_0 as *mut libc::c_void as
            *mut *mut MapMarkData;
}
#[no_mangle]
pub unsafe extern "C" fn MapMark_ClearPointers(mut globalCtx:
                                                   *mut GlobalContext) {
    sMapMarkDataOvl.loadedRamAddr = 0 as *mut libc::c_void;
    sLoadedMarkDataTable = 0 as *mut *mut MapMarkData;
}
#[no_mangle]
pub unsafe extern "C" fn MapMark_DrawForDungeon(mut globalCtx:
                                                    *mut GlobalContext) {
    let mut interfaceCtx: *mut InterfaceContext = 0 as *mut InterfaceContext;
    let mut mapMarkIconData: *mut MapMarkIconData = 0 as *mut MapMarkIconData;
    let mut markPoint: *mut MapMarkPoint = 0 as *mut MapMarkPoint;
    let mut markInfo: *mut MapMarkInfo = 0 as *mut MapMarkInfo;
    let mut dungeon: u16_0 = gSaveContext.mapIndex;
    let mut i: s32 = 0;
    let mut rectLeft: s32 = 0;
    let mut rectTop: s32 = 0;
    interfaceCtx = &mut (*globalCtx).interfaceCtx;
    if !gMapData.is_null() &&
           (*globalCtx).interfaceCtx.mapRoomNum as libc::c_int >=
               *(*gMapData).dgnMinimapCount.offset(dungeon as isize) as
                   libc::c_int {
        // "Room number exceeded, yikes %d/%d  MapMarkDraw processing interrupted"
        osSyncPrintf(b"\x1b[41;37m\xe9\x83\xa8\xe5\xb1\x8b\xe7\x95\xaa\xe5\x8f\xb7\xe3\x81\x8c\xe3\x82\xaa\xe3\x83\xbc\xe3\x83\x90\xe3\x83\xbc\xe3\x81\x97\xe3\x81\xa6\xe3\x82\x8b\xe3\x81\xa7,\xe3\x83\xa4\xe3\x83\x90\xe3\x82\xa4\xe3\x81\xa7 %d/%d  \nMapMarkDraw \xe3\x81\xae\xe5\x87\xa6\xe7\x90\x86\xe3\x82\x92\xe4\xb8\xad\xe6\x96\xad\xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99\n\x00"
    ...
    mapMarkIconData =
        &mut *(*(*sLoadedMarkDataTable.offset(dungeon as
                                                  isize)).offset((*interfaceCtx).mapRoomNum
                                                                     as
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_map_mark.c\x00" as *const u8 as
                        *const libc::c_char, 303 as libc::c_int);
    while !((*mapMarkIconData).markType as libc::c_int == -(1 as libc::c_int))
          {
        ...
        (*_g_2).words.w1 =
            (0 as libc::c_int as u32_0 &
                ...
                ((*interfaceCtx).minimapAlpha as u32_0 &
                    ...
                    0 as libc::c_int;
        markPoint =
            &mut *(*mapMarkIconData).points.as_mut_ptr().offset(0 as
                                                                    libc::c_int
                                                                    as isize)
                as *mut MapMarkPoint;
        i = 0 as libc::c_int;
        while i < (*mapMarkIconData).count as libc::c_int {
            if (*mapMarkIconData).markType as libc::c_int != 0 as libc::c_int
                   ||
                   Flags_GetTreasure(globalCtx, (*markPoint).chestFlag as s32)
                       == 0 {
                markInfo =
                    &mut *sMapMarkInfoTable.as_mut_ptr().offset((*mapMarkIconData).markType
                                                                    as isize)
                        as *mut MapMarkInfo;
                    ...
                    (0xfd as libc::c_int as u32_0 &
                        ...
                        ((*markInfo).imageFormat &
                             (((0x1 as libc::c_int) << 3 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            21 as libc::c_int |
                        (sLoadBlockImageSizes[(*markInfo).imageSize as usize]
                             &
                        ...
                        ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_4).words.w1 = (*markInfo).texture as libc::c_uint;
                ...
                (*_g_7).words.w1 =
                    (7 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 3 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        ((if ((*markInfo).textureWidth.wrapping_mul((*markInfo).textureHeight).wrapping_add(sIncrImageSizes[(*markInfo).imageSize
                                                                                                                                as
                                                                                                                                usize])
                                  >>
                                  sShiftImageSizes[(*markInfo).imageSize as
                              ...
                              ((*markInfo).textureWidth.wrapping_mul((*markInfo).textureHeight).wrapping_add(sIncrImageSizes[(*markInfo).imageSize
                                                                                                                                 as
                                                                                                                                 usize])
                                   >>
                                   sShiftImageSizes[(*markInfo).imageSize as
                                                        usize]).wrapping_sub(1
                                                                                 ...
                                                                                 as
                                                                                 libc::c_uint)
                          } else { 2047 as libc::c_int as libc::c_uint }) &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            12 as libc::c_int |
                        ((((1 as libc::c_int) << 11 as libc::c_int) as
                              libc::c_uint).wrapping_add((if 1 as libc::c_int
                                                                 as
                                                                 libc::c_uint
                                                                 >
                                                                 (*markInfo).textureWidth.wrapping_mul(sBytesImageSizes[(*markInfo).imageSize
                                                                                                                            as
                                                                                                                            usize]).wrapping_div(8
                                                                                                                                                     as
                                                                                                                                                     libc::c_int
                                                                                                                                                     as
                                                                                                                                                     libc::c_uint)
                    ...
                    (0xf5 as libc::c_int as u32_0 &
                        ...
                        ((*markInfo).imageFormat &
                             (((0x1 as libc::c_int) << 3 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            21 as libc::c_int |
                        (sBaseImageSizes[(*markInfo).imageSize as usize] &
                             (((0x1 as libc::c_int) << 2 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            19 as libc::c_int |
                        ((*markInfo).textureWidth.wrapping_mul(sLineBytesImageSizes[(*markInfo).imageSize
                                                                                        as
                                                                                        usize]).wrapping_add(7
                                                                                                                 as
                                                                                                                 libc::c_int
                                                                                                                 as
                                                                                                                 libc::c_uint)
                ...
                (*_g_10).words.w1 =
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 3 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        ((*markInfo).textureWidth.wrapping_sub(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_uint)
                             << 2 as libc::c_int &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            12 as libc::c_int |
                        ((*markInfo).textureHeight.wrapping_sub(1 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
                             << 2 as libc::c_int &
                            ...
                            0 as libc::c_int;
                rectLeft =
                    ((*gGameInfo).data[(22 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            94 as libc::c_int) as usize] as
                         libc::c_int + (*markPoint).x as libc::c_int +
                         204 as libc::c_int) << 2 as libc::c_int;
                rectTop =
                    ((*gGameInfo).data[(22 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            95 as libc::c_int) as usize] as
                         libc::c_int + (*markPoint).y as libc::c_int +
                         140 as libc::c_int) << 2 as libc::c_int;
                ...
                (*_g_11).words.w0 =
                    (0xe4 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        ((*markInfo).rectWidth.wrapping_add(rectLeft as
                                                                libc::c_uint)
                             &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            12 as libc::c_int |
                        ((rectTop as
                              libc::c_uint).wrapping_add((*markInfo).rectHeight)
                             &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
            ...
            markPoint = markPoint.offset(1);
            i += 1
        }
        mapMarkIconData = mapMarkIconData.offset(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn MapMark_Draw(mut globalCtx: *mut GlobalContext) {
...
unsafe extern "C" fn run_static_initializers() {
    sMapMarkDataOvl =
        {
            let mut init =
                MapMarkDataOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                   vromStart:
                                       _ovl_map_mark_dataSegmentRomStart.as_mut_ptr()
                                           as u32_0,
                                   vromEnd:
                                       _ovl_map_mark_dataSegmentRomEnd.as_mut_ptr()
                                           as u32_0,
                                   vramStart:
                                       _ovl_map_mark_dataSegmentStart.as_mut_ptr()
                                           as *mut libc::c_void,
                                   vramEnd:
                                       _ovl_map_mark_dataSegmentEnd.as_mut_ptr()
                                           as *mut libc::c_void,
                                   vramTable:
                                       gMapMarkDataTable.as_mut_ptr() as
                                           *mut libc::c_void,};
            init
        }
}
