...
#[no_mangle]
pub unsafe extern "C" fn Flags_UnsetAllEnv(mut globalCtx:
                                               *mut GlobalContext) {
    let mut i: u8_0 = 0;
    i = 0 as libc::c_int as u8_0;
    while (i as libc::c_int) < 20 as libc::c_int {
        (*globalCtx).envFlags[i as usize] = 0 as libc::c_int as u16_0;
        i = i.wrapping_add(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn Flags_SetEnv(mut globalCtx: *mut GlobalContext,
                                      mut flag: s16) {
    let mut index: s16 = (flag as libc::c_int / 16 as libc::c_int) as s16;
    let mut bit: s16 = (flag as libc::c_int % 16 as libc::c_int) as s16;
    let mut mask: s16 = ((1 as libc::c_int) << bit as libc::c_int) as s16;
    (*globalCtx).envFlags[index as usize] =
        ((*globalCtx).envFlags[index as usize] as libc::c_int |
             mask as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn Flags_UnsetEnv(mut globalCtx: *mut GlobalContext,
                                        mut flag: s16) {
    let mut index: s16 = (flag as libc::c_int / 16 as libc::c_int) as s16;
    let mut bit: s16 = (flag as libc::c_int % 16 as libc::c_int) as s16;
    let mut mask: s16 =
        ((1 as libc::c_int) << bit as libc::c_int ^ 0xffff as libc::c_int) as
            s16;
    (*globalCtx).envFlags[index as usize] =
        ((*globalCtx).envFlags[index as usize] as libc::c_int &
             mask as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn Flags_GetEnv(mut globalCtx: *mut GlobalContext,
                                      mut flag: s16) -> s32 {
    let mut index: s16 = (flag as libc::c_int / 16 as libc::c_int) as s16;
    let mut bit: s16 = (flag as libc::c_int % 16 as libc::c_int) as s16;
    let mut mask: s16 = ((1 as libc::c_int) << bit as libc::c_int) as s16;
    return (*globalCtx).envFlags[index as usize] as libc::c_int &
               mask as libc::c_int;
}
