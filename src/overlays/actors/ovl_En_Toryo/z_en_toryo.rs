...
extern "C" {
    ...
    #[no_mangle]
    static mut object_toryo_Anim_000E50: AnimationHeader;
    #[no_mangle]
...
pub const EXCH_ITEM_MAX: C2RustUnnamed_22 = 30;
pub const EXCH_ITEM_LETTER_RUTO: C2RustUnnamed_22 = 29;
pub const EXCH_ITEM_BIG_POE: C2RustUnnamed_22 = 28;
pub const EXCH_ITEM_POE: C2RustUnnamed_22 = 27;
pub const EXCH_ITEM_BUG: C2RustUnnamed_22 = 26;
pub const EXCH_ITEM_BLUE_FIRE: C2RustUnnamed_22 = 25;
pub const EXCH_ITEM_FISH: C2RustUnnamed_22 = 24;
pub const EXCH_ITEM_MASK_GERUDO: C2RustUnnamed_22 = 23;
pub const EXCH_ITEM_MASK_ZORA: C2RustUnnamed_22 = 22;
pub const EXCH_ITEM_MASK_GORON: C2RustUnnamed_22 = 21;
pub const EXCH_ITEM_MASK_TRUTH: C2RustUnnamed_22 = 20;
pub const EXCH_ITEM_MASK_BUNNY: C2RustUnnamed_22 = 19;
pub const EXCH_ITEM_MASK_KEATON: C2RustUnnamed_22 = 18;
pub const EXCH_ITEM_MASK_SPOOKY: C2RustUnnamed_22 = 17;
pub const EXCH_ITEM_MASK_SKULL: C2RustUnnamed_22 = 16;
pub const EXCH_ITEM_CLAIM_CHECK: C2RustUnnamed_22 = 15;
pub const EXCH_ITEM_EYEDROPS: C2RustUnnamed_22 = 14;
pub const EXCH_ITEM_FROG: C2RustUnnamed_22 = 13;
pub const EXCH_ITEM_PRESCRIPTION: C2RustUnnamed_22 = 12;
pub const EXCH_ITEM_SWORD_BROKEN: C2RustUnnamed_22 = 11;
pub const EXCH_ITEM_SAW: C2RustUnnamed_22 = 10;
pub const EXCH_ITEM_ODD_POTION: C2RustUnnamed_22 = 9;
pub const EXCH_ITEM_ODD_MUSHROOM: C2RustUnnamed_22 = 8;
pub const EXCH_ITEM_COJIRO: C2RustUnnamed_22 = 7;
pub const EXCH_ITEM_POCKET_CUCCO: C2RustUnnamed_22 = 6;
pub const EXCH_ITEM_POCKET_EGG: C2RustUnnamed_22 = 5;
pub const EXCH_ITEM_BEAN: C2RustUnnamed_22 = 4;
pub const EXCH_ITEM_CHICKEN: C2RustUnnamed_22 = 3;
pub const EXCH_ITEM_WEIRD_EGG: C2RustUnnamed_22 = 2;
pub const EXCH_ITEM_LETTER_ZELDA: C2RustUnnamed_22 = 1;
pub const EXCH_ITEM_NONE: C2RustUnnamed_22 = 0;
...
pub struct EnToryo {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnToryoActionFunc,
    pub collider: ColliderCylinder,
    pub unk_1E0: s32,
    pub unk_1E4: s32,
    pub stateFlags: u16_0,
    pub unk_1EA: s16,
    pub unk_1EC: struct_80034A14_arg1,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
}
pub type EnToryoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnToryo, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnToryoAnimation {
...
#[no_mangle]
pub static mut En_Toryo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TORYO as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_TORYO as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnToryo>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnToryo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sEnToryoAnimation: EnToryoAnimation =
    unsafe {
        {
            let mut init =
                EnToryoAnimation{anim:
                                     &object_toryo_Anim_000E50 as
...
static mut sMultVec: Vec3f =
    { let mut init = Vec3f{x: 800.0f32, y: 1000.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnToryo_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnToryo = thisx as *mut EnToryo;
    let mut pad: s32 = 0;
    match (*globalCtx).sceneNum as libc::c_int {
        90 => {
            if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
                ...
                (*this).stateFlags =
                    ((*this).stateFlags as libc::c_int | 1 as libc::c_int) as
                        u16_0
            }
        }
        82 => {
            if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
                ...
                (*this).stateFlags =
                    ((*this).stateFlags as libc::c_int | 2 as libc::c_int) as
                        u16_0
            }
        }
        42 => {
            if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
                ...
                (*this).stateFlags =
                    ((*this).stateFlags as libc::c_int | 4 as libc::c_int) as
                        u16_0
            }
        }
        _ => { }
    }
    if (*this).stateFlags as libc::c_int & 7 as libc::c_int ==
           0 as libc::c_int {
    ...
    Animation_Change(&mut (*this).skelAnime, sEnToryoAnimation.anim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sEnToryoAnimation.anim as
                                                *mut libc::c_void) as f32_0,
                     sEnToryoAnimation.mode,
                     sEnToryoAnimation.transitionRate);
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int | 8 as libc::c_int) as u16_0;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    (*this).actionFunc =
        Some(func_80B20914 as
                 unsafe extern "C" fn(_: *mut EnToryo, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnToryo_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnToryo = thisx as *mut EnToryo;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B203D8(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
        ...
        4 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                    ...
                    (*this).actor.textId = 0x601b as libc::c_int as u16_0;
                    ret = 3 as libc::c_int
                } else {
                    (*this).actor.textId = 0x606f as libc::c_int as u16_0;
                    ret = 2 as libc::c_int
                }
            }
        }
            ...
            match (*this).actor.textId as libc::c_int {
                ...
                24687 => {
                    ...
                    if Message_ShouldAdvance(globalCtx) != 0 {
                        gSaveContext.infTable[23 as libc::c_int as usize] =
                            (gSaveContext.infTable[23 as libc::c_int as usize]
                                 as libc::c_int | 2 as libc::c_int) as u16_0;
                        ret = 0 as libc::c_int
                    }
                }
                24682 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B205CC(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut ret: s32 = 5 as libc::c_int;
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        0 | 1 | 2 | 3 | 4 | 5 => { ret = 5 as libc::c_int }
        6 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                ret = 0 as libc::c_int
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B20634(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext)
 -> u32_0 {
    let mut ret: u32_0 = 0;
    if (*this).unk_1E0 != 0 as libc::c_int {
        if (*this).unk_1E0 == 10 as libc::c_int {
            ...
            if gSaveContext.infTable[23 as libc::c_int as usize] as
                ...
                ret = 0x606e as libc::c_int as u32_0
            } else { ret = 0x606d as libc::c_int as u32_0 }
        } else { ret = 0x200f as libc::c_int as u32_0 }
    }
    // ! @bug return value may be unitialized
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B206A0(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut textId: s32 =
        Text_GetFaceReaction(globalCtx, 0 as libc::c_int as u32_0) as s32;
    let mut ret: s32 = textId;
    if textId == 0 as libc::c_int {
        if (*this).stateFlags as libc::c_int & 1 as libc::c_int != 0 {
            if gSaveContext.eventChkInf[9 as libc::c_int as usize] as
                   libc::c_int & 0xf as libc::c_int == 0xf as libc::c_int {
                ret = 0x606c as libc::c_int
            } else if gSaveContext.infTable[23 as libc::c_int as usize] as
                          libc::c_int & 1 as libc::c_int != 0 {
                ret = 0x606b as libc::c_int
            } else { ret = 0x606a as libc::c_int }
        } else if (*this).stateFlags as libc::c_int & 2 as libc::c_int != 0 {
            if gSaveContext.infTable[23 as libc::c_int as usize] as
                   libc::c_int & 4 as libc::c_int != 0 {
                ret = 0x5029 as libc::c_int
            } else { ret = 0x5028 as libc::c_int }
        } else {
            ret = textId;
            if (*this).stateFlags as libc::c_int & 4 as libc::c_int != 0 {
                ret = 0x506c as libc::c_int
            }
        }
    }
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B20768(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut sp32: s16 = 0;
    let mut sp30: s16 = 0;
    if (*this).unk_1E4 == 3 as libc::c_int {
        Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx);
        Message_ContinueTextbox(globalCtx, (*this).actor.textId);
        (*this).unk_1E4 = 1 as libc::c_int
    }
    if (*this).unk_1E4 == 1 as libc::c_int {
        (*this).unk_1E4 = func_80B203D8(this, globalCtx)
    }
    if (*this).unk_1E4 == 5 as libc::c_int {
        (*this).unk_1E4 = func_80B205CC(this, globalCtx);
        return
    }
    if (*this).unk_1E4 == 2 as libc::c_int {
        Message_ContinueTextbox(globalCtx, (*this).actor.textId);
        (*this).unk_1E4 = 1 as libc::c_int
    }
    if (*this).unk_1E4 == 4 as libc::c_int {
        if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
            (*this).actor.parent = 0 as *mut Actor;
            (*this).unk_1E4 = 5 as libc::c_int
        } else {
            func_8002F434(&mut (*this).actor, globalCtx,
                          GI_SWORD_BROKEN as libc::c_int, 100.0f32, 10.0f32);
        }
        return
    }
    if (*this).unk_1E4 == 0 as libc::c_int {
        if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
            (*this).unk_1E0 = func_8002F368(globalCtx) as s32;
            if (*this).unk_1E0 != 0 as libc::c_int {
                (*player).actor.textId =
                    func_80B20634(this, globalCtx) as u16_0;
                (*this).actor.textId = (*player).actor.textId
            }
            (*this).unk_1E4 = 1 as libc::c_int;
            return
        }
        Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp32,
                           &mut sp30);
        if sp32 as libc::c_int >= 0 as libc::c_int &&
               (sp32 as libc::c_int) < 0x141 as libc::c_int &&
               sp30 as libc::c_int >= 0 as libc::c_int &&
               (sp30 as libc::c_int) < 0xf1 as libc::c_int {
            (*this).actor.textId = func_80B206A0(this, globalCtx) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B20914(mut this: *mut EnToryo,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    func_80B20768(this, globalCtx);
    if (*this).unk_1E4 != 0 as libc::c_int {
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int | 0x10 as libc::c_int) as u16_0
    } else {
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int & !(0x10 as libc::c_int)) as
                u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnToryo_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnToryo = thisx as *mut EnToryo;
    ...
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         collider as *mut Collider);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).stateFlags as libc::c_int & 8 as libc::c_int != 0 {
        ...
        if (*this).stateFlags as libc::c_int & 0x10 as libc::c_int != 0 {
            func_80034A14(thisx, &mut (*this).unk_1EC,
                          0 as libc::c_int as s16, 4 as libc::c_int as s16);
            return
        }
        rot =
            ((*thisx).yawTowardsPlayer as libc::c_int -
                 (*thisx).shape.rot.y as libc::c_int) as f32_0;
        if rot < 14563.0f32 && rot > -14563.0f32 {
            func_80034A14(thisx, &mut (*this).unk_1EC,
...
#[no_mangle]
pub unsafe extern "C" fn EnToryo_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnToryo = thisx as *mut EnToryo;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnToryo_OverrideLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn EnToryo_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
    ...
    if (*this).stateFlags as libc::c_int & 8 as libc::c_int != 0 {
        match limbIndex {
            8 => {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_1EC.unk_0E.y as libc::c_int) as s16;
                (*rot).y =
                    ((*rot).y as libc::c_int -
                         (*this).unk_1EC.unk_0E.x as libc::c_int) as s16
            }
            15 => {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_1EC.unk_08.y as libc::c_int) as s16;
                (*rot).z =
                    ((*rot).z as libc::c_int +
                         (*this).unk_1EC.unk_08.x as libc::c_int) as s16
            }
            _ => { }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnToryo_PostLimbDraw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut limbIndex: s32,
                                              mut dList: *mut *mut Gfx,
                                              mut rot: *mut Vec3s,
