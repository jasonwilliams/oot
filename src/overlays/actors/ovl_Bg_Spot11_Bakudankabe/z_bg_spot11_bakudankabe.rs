...
extern "C" {
    ...
    #[no_mangle]
    static mut gDesertColossusBombableWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gDesertColossusBombableWallCol: CollisionHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot11Bakudankabe {
...
#[no_mangle]
pub static mut Bg_Spot11_Bakudankabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id:
                              ACTOR_BG_SPOT11_BAKUDANKABE as libc::c_int as
                                  s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot11Bakudankabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Bakudankabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Bakudankabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Bakudankabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Bakudankabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B272C: Vec3f =
    { let mut init = Vec3f{x: 2259.0f32, y: 108.0f32, z: -1550.0f32,}; init };
static mut D_808B2738: Vec3f =
    { let mut init = Vec3f{x: 2259.0f32, y: 108.0f32, z: -1550.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn func_808B2180(mut this: *mut BgSpot11Bakudankabe,
    ...
    (*this).collider.dim.pos.x =
        ((*this).collider.dim.pos.x as libc::c_int +
             (*this).dyna.actor.world.pos.x as s16 as libc::c_int) as s16;
    (*this).collider.dim.pos.y =
        ((*this).collider.dim.pos.y as libc::c_int +
             (*this).dyna.actor.world.pos.y as s16 as libc::c_int) as s16;
    (*this).collider.dim.pos.z =
        ((*this).collider.dim.pos.z as libc::c_int +
             (*this).dyna.actor.world.pos.z as s16 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B2218(mut this: *mut BgSpot11Bakudankabe,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut i: s32 = 0;
    burstDepthX.z = 0 as libc::c_int as f32_0;
    burstDepthX.x = 0 as libc::c_int as f32_0;
    i = 0 as libc::c_int;
    while i < 20 as libc::c_int {
        let mut scale: s16 = 0;
        let mut gravityInfluence: s32 = 0;
        let mut rotationSpeed: s32 = 0;
        Math_Vec3f_Sum(&mut (*thisx).world.pos, &mut D_808B272C,
                       &mut burstDepthY);
        burstDepthY.x += (Rand_ZeroOne() - 0.5f32) * 120.0f32;
        burstDepthY.y += 30.0f32 + i as libc::c_float * 6.5f32;
        burstDepthY.z += (Rand_ZeroOne() - 0.5f32) * 20.0f32;
        burstDepthX.y = (Rand_ZeroOne() - 0.2f32) * 12.0f32;
        scale = (Rand_ZeroOne() * 55.0f32 + 8.0f32) as s16;
        if (scale as libc::c_int) < 20 as libc::c_int {
            gravityInfluence = -(300 as libc::c_int)
        } else if (scale as libc::c_int) < 35 as libc::c_int {
            gravityInfluence = -(360 as libc::c_int)
        } else { gravityInfluence = -(420 as libc::c_int) }
        ...
        EffectSsKakera_Spawn(globalCtx, &mut burstDepthY, &mut burstDepthX,
                             &mut burstDepthY, gravityInfluence as s16,
    ...
    Math_Vec3f_Sum(&mut (*thisx).world.pos, &mut D_808B272C,
                   &mut burstDepthY);
    func_80033480(globalCtx, &mut burstDepthY, 70 as libc::c_int as f32_0,
                  4 as libc::c_int, 110 as libc::c_int as s16,
                  160 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    burstDepthY.y += 40 as libc::c_int as libc::c_float;
    func_80033480(globalCtx, &mut burstDepthY, 70 as libc::c_int as f32_0,
                  5 as libc::c_int, 110 as libc::c_int as s16,
                  160 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    burstDepthY.y += 40 as libc::c_int as libc::c_float;
    func_80033480(globalCtx, &mut burstDepthY, 70 as libc::c_int as f32_0,
                  4 as libc::c_int, 110 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Bakudankabe_Init(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgSpot11Bakudankabe =
        thisx as *mut BgSpot11Bakudankabe;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gDesertColossusBombableWallCol as
    ...
    Actor_SetScale(&mut (*this).dyna.actor, 1.0f32);
    osSyncPrintf(b"(spot11 \xe7\x88\x86\xe5\xbc\xbe\xe5\xa3\x81)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Bakudankabe_Destroy(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut this: *mut BgSpot11Bakudankabe =
        thisx as *mut BgSpot11Bakudankabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Bakudankabe_Update(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut BgSpot11Bakudankabe =
        thisx as *mut BgSpot11Bakudankabe;
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        Flags_SetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int &
                            0x3f as libc::c_int);
        Audio_PlaySoundAtPosition(globalCtx, &mut D_808B2738,
                                  40 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Bakudankabe_Draw(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgSpot11Bakudankabe =
        thisx as *mut BgSpot11Bakudankabe;
    Gfx_DrawDListOpa(globalCtx, gDesertColossusBombableWallDL.as_mut_ptr());
}
