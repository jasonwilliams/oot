...
extern "C" {
    ...
    fn EffectSsBlast_SpawnWhiteShockwave(globalCtx: *mut GlobalContext,
                                         ...
                                         accel: *mut Vec3f);
    #[no_mangle]
    fn EffectSsGSpk_SpawnFuse(globalCtx: *mut GlobalContext,
    ...
    fn Actor_HasNoParent(actor: *mut Actor, globalCtx: *mut GlobalContext)
     -> u32_0;
    #[no_mangle]
    fn func_8002F5C4(actorA: *mut Actor, actorB: *mut Actor,
                     globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn Audio_PlayActorSound2(actor: *mut Actor, sfxId: u16_0);
    #[no_mangle]
    fn func_8002F850(globalCtx: *mut GlobalContext, actor: *mut Actor);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBombFlowerLeavesDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombFlowerBombAndSparkDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombFlowerBaseLeavesDL: [Gfx; 0];
}
...
pub const BOMBFLOWER_EXPLOSION: C2RustUnnamed_21 = 1;
pub const BOMBFLOWER_BODY: C2RustUnnamed_21 = 0;
pub const BOMBFLOWER_FLOWER: C2RustUnnamed_21 = -1;
#[no_mangle]
pub static mut En_Bombf_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOMBF as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BOMBF as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBombf>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBombf_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBombf_SetupAction(mut this: *mut EnBombf,
                                             mut actionFunc:
                                                 EnBombfActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBombf_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut shapeUnk10: f32_0 = 0.0f32;
    let mut pad: s32 = 0;
    let mut this: *mut EnBombf = thisx as *mut EnBombf;
    Actor_SetScale(thisx, 0.01f32);
    (*this).unk_200 = 1 as libc::c_int;
    Collider_InitCylinder(globalCtx, &mut (*this).bombCollider);
    Collider_InitJntSph(globalCtx, &mut (*this).explosionCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).bombCollider, thisx,
                         &mut sCylinderInit);
    Collider_SetJntSph(globalCtx, &mut (*this).explosionCollider, thisx,
                       &mut sJntSphInit,
                       &mut *(*this).explosionColliderItems.as_mut_ptr().offset(0
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    isize));
    if (*thisx).params as libc::c_int == BOMBFLOWER_BODY as libc::c_int {
        shapeUnk10 = 1000.0f32
    }
    ActorShape_Init(&mut (*thisx).shape, shapeUnk10,
    ...
    if !Actor_FindNearby(globalCtx, thisx,
                         ACTOR_BG_DDAN_KD as libc::c_int as s16,
                         ACTORCAT_BG as libc::c_int as u8_0,
                         10000.0f32).is_null() {
        (*thisx).flags |=
            ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint
    }
    (*thisx).colChkInfo.cylRadius = 10.0f32 as s16;
    (*thisx).colChkInfo.cylHeight = 10 as libc::c_int as s16;
    (*thisx).targetMode = 0 as libc::c_int as s8;
    if (*thisx).params as libc::c_int == BOMBFLOWER_BODY as libc::c_int {
        (*this).timer = 140 as libc::c_int as s16;
        (*this).flashSpeedScale = 15 as libc::c_int as s16;
        (*thisx).gravity = -1.5f32;
        Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx, thisx,
                             ACTORCAT_EXPLOSIVE as libc::c_int as u8_0);
        (*thisx).colChkInfo.mass = 200 as libc::c_int as u8_0;
        (*thisx).flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        EnBombf_SetupAction(this,
                            Some(EnBombf_Move as
                                     unsafe extern "C" fn(_: *mut EnBombf,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    } else {
        (*thisx).colChkInfo.mass = 0xff as libc::c_int as u8_0;
        (*this).bumpOn = 1 as libc::c_int as u8_0;
        (*this).flowerBombScale = 1.0f32;
        EnBombf_SetupGrowBomb(this, (*thisx).params);
    }
    (*thisx).uncullZoneScale += 31000.0f32;
    (*thisx).uncullZoneForward += 31000.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnBombf_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBombf = thisx as *mut EnBombf;
    Collider_DestroyCylinder(globalCtx, &mut (*this).bombCollider);
    Collider_DestroyJntSph(globalCtx, &mut (*this).explosionCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnBombf_SetupGrowBomb(mut this: *mut EnBombf,
                                               mut params: s16) {
    EnBombf_SetupAction(this,
                        Some(EnBombf_GrowBomb as
                                 unsafe extern "C" fn(_: *mut EnBombf,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBombf_GrowBomb(mut this: *mut EnBombf,
                                          mut globalCtx: *mut GlobalContext) {
    let mut bombFlower: *mut EnBombf = 0 as *mut EnBombf;
    let mut pad: s32 = 0;
    let mut pad1: s32 = 0;
    ...
    if (*this).flowerBombScale >= 1.0f32 {
        if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
            bombFlower =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ...
                            0 as libc::c_int as s16, 0 as libc::c_int as s16)
                    as *mut EnBombf;
            if !bombFlower.is_null() {
                func_8002F5C4(&mut (*this).actor, &mut (*bombFlower).actor,
                              globalCtx);
                (*this).timer = 180 as libc::c_int as s16;
                (*this).flowerBombScale = 0.0f32;
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x86a as libc::c_int as u16_0);
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
            } else {
                (*player).actor.child = 0 as *mut Actor;
        ...
        } else if (*this).bombCollider.base.acFlags as libc::c_int &
                      (1 as libc::c_int) << 1 as libc::c_int != 0 {
            (*this).bombCollider.base.acFlags =
                ((*this).bombCollider.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*(*this).bombCollider.base.ac).category as libc::c_int !=
                   ACTORCAT_BOSS as libc::c_int {
                bombFlower =
                    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                ACTOR_EN_BOMBF as libc::c_int as s16,
                                (*this).actor.world.pos.x,
                                ...
                                0 as libc::c_int as s16,
                                0 as libc::c_int as s16,
                                0 as libc::c_int as s16) as *mut EnBombf;
                if !bombFlower.is_null() {
                    (*bombFlower).unk_200 = 1 as libc::c_int;
                    (*bombFlower).timer = 0 as libc::c_int as s16;
                    (*this).timer = 180 as libc::c_int as s16;
                    (*this).actor.flags &=
        ...
        } else if Player_IsBurningStickInRange(globalCtx,
            ...
            bombFlower =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    as *mut EnBombf;
            if !bombFlower.is_null() {
                (*bombFlower).timer = 100 as libc::c_int as s16;
                (*this).timer = 180 as libc::c_int as s16;
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
                (*this).flowerBombScale = 0.0f32
...
#[no_mangle]
pub unsafe extern "C" fn EnBombf_Move(mut this: *mut EnBombf,
                                      mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        (*this).flowerBombScale = 0.0f32;
        EnBombf_SetupAction(this,
                            Some(EnBombf_WaitForRelease as
                                     unsafe extern "C" fn(_: *mut EnBombf,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int == 0 {
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0
            ...
            func_8002F850(globalCtx, &mut (*this).actor);
            (*this).actor.velocity.y *= -0.5f32
...
#[no_mangle]
pub unsafe extern "C" fn EnBombf_WaitForRelease(mut this: *mut EnBombf,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBombf_Explode(mut this: *mut EnBombf,
                                         mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    if (*(*this).explosionCollider.elements.offset(0 as libc::c_int as
    ...
    let ref mut fresh0 =
        (*(*this).explosionCollider.elements.offset(0 as libc::c_int as
                                                        isize)).dim.modelSphere.radius;
    *fresh0 = (*fresh0 as libc::c_int + 8 as libc::c_int) as s16;
    (*(*this).explosionCollider.elements.offset(0 as libc::c_int as
    ...
    if (*this).actor.params as libc::c_int ==
           BOMBFLOWER_EXPLOSION as libc::c_int {
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).explosionCollider.base);
    }
    if (*globalCtx).envCtx.adjLight1Color[0 as libc::c_int as usize] as
           libc::c_int != 0 as libc::c_int {
        (*globalCtx).envCtx.adjLight1Color[0 as libc::c_int as usize] =
            ((*globalCtx).envCtx.adjLight1Color[0 as libc::c_int as usize] as
                 libc::c_int - 25 as libc::c_int) as s16
    }
    if (*globalCtx).envCtx.adjLight1Color[1 as libc::c_int as usize] as
           libc::c_int != 0 as libc::c_int {
        (*globalCtx).envCtx.adjLight1Color[1 as libc::c_int as usize] =
            ((*globalCtx).envCtx.adjLight1Color[1 as libc::c_int as usize] as
                 libc::c_int - 25 as libc::c_int) as s16
    }
    if (*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize] as
           libc::c_int != 0 as libc::c_int {
        (*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize] =
            ((*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize] as
                 libc::c_int - 25 as libc::c_int) as s16
    }
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        if (*player).stateFlags1 & 0x800 as libc::c_int as libc::c_uint != 0
               && (*player).heldActor == &mut (*this).actor as *mut Actor {
            (*player).actor.child = 0 as *mut Actor;
            (*player).heldActor = 0 as *mut Actor;
            (*player).interactRangeActor = 0 as *mut Actor;
            (*player).stateFlags1 &= !(0x800 as libc::c_int) as libc::c_uint
...
pub unsafe extern "C" fn EnBombf_Update(mut thisx: *mut Actor,
    ...
    let mut this: *mut EnBombf = thisx as *mut EnBombf;
    if (*this).unk_200 != 0 as libc::c_int &&
           (*this).timer as libc::c_int != 0 as libc::c_int {
        (*this).timer -= 1
    }
    if (*this).bumpOn == 0 && Actor_HasParent(thisx, globalCtx) == 0 &&
           ((*thisx).xzDistToPlayer >= 20.0f32 ||
                (if (*thisx).yDistToPlayer >=
                        0 as libc::c_int as libc::c_float {
                     (*thisx).yDistToPlayer
                 } else { -(*thisx).yDistToPlayer }) >= 80.0f32) {
        (*this).bumpOn = 1 as libc::c_int as u8_0
    }
    ...
    if (*thisx).params as libc::c_int == BOMBFLOWER_BODY as libc::c_int {
        if (*thisx).velocity.y > 0.0f32 &&
               (*thisx).bgCheckFlags as libc::c_int & 0x10 as libc::c_int != 0
           {
            (*thisx).velocity.y = -(*thisx).velocity.y
        }
        // rebound bomb off the wall it hits
        if (*thisx).speedXZ != 0.0f32 &&
               (*thisx).bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
            if (if ((*thisx).wallYaw as libc::c_int -
                        (*thisx).world.rot.y as libc::c_int) as s16 as
                       libc::c_int >= 0 as libc::c_int {
            ...
            Audio_PlayActorSound2(thisx, 0x282f as libc::c_int as u16_0);
            Actor_MoveForward(thisx);
            (*gGameInfo).data[(7 as libc::c_int * 6 as libc::c_int *
            ...
            (*thisx).speedXZ *= 0.7f32;
            (*thisx).bgCheckFlags =
                ((*thisx).bgCheckFlags as libc::c_int & !(8 as libc::c_int))
                    as u16_0
        }
        if (*this).bombCollider.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 ||
               (*this).bombCollider.base.ocFlags1 as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                   (*(*this).bombCollider.base.oc).category as libc::c_int ==
                       ACTORCAT_ENEMY as libc::c_int {
            (*this).unk_200 = 1 as libc::c_int;
            (*this).timer = 0 as libc::c_int as s16
        } else if (*this).timer as libc::c_int > 100 as libc::c_int &&
                      Player_IsBurningStickInRange(globalCtx,
                                                   &mut (*thisx).world.pos,
                                                   30.0f32, 50.0f32) != 0 {
        ...
        if (*this).unk_200 != 0 as libc::c_int {
            ...
            effPos.y += 25.0f32;
            if ((*this).timer as libc::c_int) < 127 as libc::c_int {
                ...
                if (*globalCtx).gameplayFrames.wrapping_rem(2 as libc::c_int
                    ...
                    EffectSsGSpk_SpawnFuse(globalCtx, thisx, &mut effPos,
                                           &mut effVelocity, &mut effAccel);
                }
                Audio_PlayActorSound2(thisx,
                                      (0x180d as libc::c_int -
                                           0x800 as libc::c_int) as u16_0);
                effPos.y += 3.0f32;
                func_8002829C(globalCtx, &mut effPos, &mut effVelocity,
                              &mut dustAccel, &mut dustColor, &mut dustColor,
            ...
            if (*this).timer as libc::c_int == 3 as libc::c_int ||
                   (*this).timer as libc::c_int == 30 as libc::c_int ||
                   (*this).timer as libc::c_int == 50 as libc::c_int ||
                   (*this).timer as libc::c_int == 70 as libc::c_int {
                (*this).flashSpeedScale =
                    ((*this).flashSpeedScale as libc::c_int >>
                         1 as libc::c_int) as s16
            }
            if ((*this).timer as libc::c_int) < 100 as libc::c_int &&
                   (*this).timer as libc::c_int &
                       (*this).flashSpeedScale as libc::c_int +
                           1 as libc::c_int != 0 as libc::c_int {
                Math_SmoothStepToF(&mut (*this).flashIntensity, 150.0f32,
                                   1.0f32,
                                   150.0f32 /
                                       (*this).flashSpeedScale as libc::c_int
                                           as libc::c_float, 0.0f32);
            } else {
                Math_SmoothStepToF(&mut (*this).flashIntensity, 0.0f32,
                                   1.0f32,
                                   150.0f32 /
                                       (*this).flashSpeedScale as libc::c_int
                                           as libc::c_float, 0.0f32);
            ...
            if ((*this).timer as libc::c_int) < 3 as libc::c_int {
                Actor_SetScale(thisx, (*thisx).scale.x + 0.002f32);
            }
            if (*this).timer as libc::c_int == 0 as libc::c_int {
                effPos = (*thisx).world.pos;
                effPos.y += 10.0f32;
                ...
                EffectSsBomb2_SpawnLayered(globalCtx, &mut effPos,
                                           &mut effVelocity, &mut bomb2Accel,
                                           100 as libc::c_int as s16,
                                           19 as libc::c_int as s16);
                effPos.y = (*thisx).floorHeight;
                if (*thisx).floorHeight > -32000.0f32 {
                    EffectSsBlast_SpawnWhiteShockwave(globalCtx, &mut effPos,
                                                      &mut effVelocity,
                                                      &mut effAccel);
                }
                Audio_PlayActorSound2(thisx, 0x180e as libc::c_int as u16_0);
                (*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize]
                ...
                Camera_AddQuake(&mut (*globalCtx).mainCamera,
                                2 as libc::c_int, 0xb as libc::c_int as s16,
                                8 as libc::c_int);
                (*thisx).params = BOMBFLOWER_EXPLOSION as libc::c_int as s16;
                (*this).timer = 10 as libc::c_int as s16;
                (*thisx).flags |=
                    ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
                EnBombf_SetupAction(this,
                                    Some(EnBombf_Explode as
                                             unsafe extern "C" fn(_:
                                                                      *mut EnBombf,
                                                                  _:
                                                                      *mut GlobalContext)
    ...
    (*thisx).focus.pos = (*thisx).world.pos;
    (*thisx).focus.pos.y += 10.0f32;
    if (*thisx).params as libc::c_int <= BOMBFLOWER_BODY as libc::c_int {
        Collider_UpdateCylinder(thisx, &mut (*this).bombCollider);
        if (*this).flowerBombScale >= 1.0f32 &&
               (*this).bumpOn as libc::c_int != 0 {
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).bombCollider.base);
        }
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).bombCollider.base);
    }
    if (*thisx).scale.x >= 0.01f32 &&
           (*thisx).params as libc::c_int !=
               BOMBFLOWER_EXPLOSION as libc::c_int {
        if (*thisx).yDistToWater >= 20.0f32 {
            EffectSsDeadSound_SpawnStationary(globalCtx,
                                              &mut (*thisx).projectedPos,
                                              0x180f as libc::c_int as u16_0,
                                              1 as libc::c_int as s16,
                                              1 as libc::c_int as s16,
                                              10 as libc::c_int);
            Actor_Kill(thisx);
        ...
        if (*thisx).bgCheckFlags as libc::c_int & 0x40 as libc::c_int != 0 {
            (*thisx).bgCheckFlags =
                ((*thisx).bgCheckFlags as libc::c_int &
                     !(0x40 as libc::c_int)) as u16_0;
            Audio_PlayActorSound2(thisx, 0x2817 as libc::c_int as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBombf_NewMtxDList(mut gfxCtx: *mut GraphicsContext,
                                             mut globalCtx:
                                                 *mut GlobalContext)
 -> *mut Gfx {
    ...
    (*_g).words.w1 =
        Matrix_NewMtx(gfxCtx,
                      b"../z_en_bombf.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnBombf_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBombf = thisx as *mut EnBombf;
            ...
            (*_g_0).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gBombFlowerLeavesDL.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gBombFlowerBaseLeavesDL.as_mut_ptr() as libc::c_uint;
            Matrix_Translate(0.0f32, 1000.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale((*this).flowerBombScale, (*this).flowerBombScale,
                         (*this).flowerBombScale,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        }
        ...
        (*_g_4).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_4).words.w1 =
            ((*this).flashIntensity as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
        ...
        (*_g_6).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_6).words.w1 =
            gSegments[((EnBombf_NewMtxDList((*globalCtx).state.gfxCtx,
                                            globalCtx) as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(EnBombf_NewMtxDList((*globalCtx).state.gfxCtx,
                                                                  globalCtx)
                                                  as u32_0 &
        ...
        (*_g_7).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_7).words.w1 =
            gBombFlowerBombAndSparkDL.as_mut_ptr() as libc::c_uint
    } else {
        Collider_UpdateSpheres(0 as libc::c_int,
                               &mut (*this).explosionCollider);
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bombf.c\x00" as *const u8 as
                         *const libc::c_char, 1063 as libc::c_int);
}
