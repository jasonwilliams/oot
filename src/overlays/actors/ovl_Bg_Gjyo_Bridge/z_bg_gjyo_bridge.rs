...
extern "C" {
    ...
    #[no_mangle]
    static mut gRainbowBridgeDL: [Gfx; 0];
    #[no_mangle]
    static mut gRainbowBridgeCol: CollisionHeader;
    #[no_mangle]
    static mut gRainbowBridgeCs: [CutsceneData; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGjyoBridge {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgGjyoBridgeActionFunc,
}
pub type BgGjyoBridgeActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGjyoBridge, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Gjyo_Bridge_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GJYO_BRIDGE as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_GJYO_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgGjyoBridge>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGjyoBridge_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGjyoBridge_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGjyoBridge_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGjyoBridge_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgGjyoBridge = thisx as *mut BgGjyoBridge;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gRainbowBridgeCol as *mut CollisionHeader
    ...
    if gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int &
        ...
        (*this).actionFunc =
            Some(func_808787A4 as
                     unsafe extern "C" fn(_: *mut BgGjyoBridge,
                                          _: *mut GlobalContext) -> ())
    } else {
        ...
        func_8003EBF8(globalCtx, &mut (*globalCtx).colCtx.dyna,
                      (*this).dyna.bgId);
        (*this).actionFunc =
            Some(BgGjyoBridge_TriggerCutscene as
                     unsafe extern "C" fn(_: *mut BgGjyoBridge,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgGjyoBridge = thisx as *mut BgGjyoBridge;
...
#[no_mangle]
pub unsafe extern "C" fn func_808787A4(mut this: *mut BgGjyoBridge,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_TriggerCutscene(mut this:
                                                          *mut BgGjyoBridge,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    ...
    if gBitFlags[QUEST_MEDALLION_SPIRIT as libc::c_int as usize] &
           ...
           gBitFlags[QUEST_MEDALLION_SHADOW as libc::c_int as usize] &
               gSaveContext.inventory.questItems != 0 &&
           gSaveContext.inventory.items[gItemSlots[ITEM_ARROW_LIGHT as
                                                       libc::c_int as usize]
                                            as usize] as libc::c_int ==
               ITEM_ARROW_LIGHT as libc::c_int &&
           (*player).actor.world.pos.x > -70.0f32 &&
           (*player).actor.world.pos.x < 300.0f32 &&
           (*player).actor.world.pos.y > 1340.0f32 &&
           (*player).actor.world.pos.z > 1340.0f32 &&
           (*player).actor.world.pos.z < 1662.0f32 &&
           Gameplay_InCsMode(globalCtx) == 0 {
        (*globalCtx).csCtx.segment =
            gSegments[((gRainbowBridgeCs.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gRainbowBridgeCs.as_mut_ptr() as
                                                  u32_0 &
        ...
        (*this).actionFunc =
            Some(BgGjyoBridge_SpawnBridge as
                     unsafe extern "C" fn(_: *mut BgGjyoBridge,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_SpawnBridge(mut this: *mut BgGjyoBridge,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgGjyoBridge = thisx as *mut BgGjyoBridge;
...
#[no_mangle]
pub unsafe extern "C" fn BgGjyoBridge_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgGjyoBridge = thisx as *mut BgGjyoBridge;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_gjyo_bridge.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        Gfx_TexScroll((*globalCtx).state.gfxCtx,
                      ...
                      (*globalCtx).gameplayFrames.wrapping_mul(-(3 as
                                                                     libc::c_int)
                                                                   as
                                                                   libc::c_uint)
                          & 127 as libc::c_int as libc::c_uint,
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gRainbowBridgeDL.as_mut_ptr() as libc::c_uint;
