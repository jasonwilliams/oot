...
extern "C" {
    ...
    #[no_mangle]
    fn EffectBlure_Init1(thisx: *mut libc::c_void,
                         initParamsx: *mut libc::c_void);
    #[no_mangle]
    fn EffectBlure_Init2(thisx: *mut libc::c_void,
                         initParamsx: *mut libc::c_void);
    #[no_mangle]
    fn EffectBlure_Destroy(thisx: *mut libc::c_void);
    #[no_mangle]
    fn EffectBlure_Update(thisx: *mut libc::c_void) -> s32;
    #[no_mangle]
    fn EffectBlure_Draw(thisx: *mut libc::c_void,
                        gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    fn EffectShieldParticle_Init(thisx: *mut libc::c_void,
                                 initParamsx: *mut libc::c_void);
    #[no_mangle]
    fn EffectShieldParticle_Destroy(thisx: *mut libc::c_void);
    #[no_mangle]
    fn EffectShieldParticle_Update(thisx: *mut libc::c_void) -> s32;
    #[no_mangle]
    fn EffectShieldParticle_Draw(thisx: *mut libc::c_void,
                                 gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    fn EffectSpark_Init(thisx: *mut libc::c_void,
                        initParamsx: *mut libc::c_void);
    #[no_mangle]
    fn EffectSpark_Destroy(thisx: *mut libc::c_void);
    #[no_mangle]
    fn EffectSpark_Update(thisx: *mut libc::c_void) -> s32;
    #[no_mangle]
    fn EffectSpark_Draw(thisx: *mut libc::c_void,
                        gfxCtx: *mut GraphicsContext);
    #[no_mangle]
...
pub struct EffectShieldParticleElement {
    pub initialSpeed: f32_0,
    pub endXChange: f32_0,
    pub endX: f32_0,
    pub startXChange: f32_0,
    pub startX: f32_0,
    pub yaw: s16,
    pub pitch: s16,
}
...
pub struct EffectShieldParticle {
    pub elements: [EffectShieldParticleElement; 16],
    pub numElements: u8_0,
    pub position: Vec3s,
...
pub struct EffectContext {
    pub globalCtx: *mut GlobalContext,
    pub sparks: [C2RustUnnamed_16; 3],
    pub blures: [C2RustUnnamed_15; 25],
    pub shieldParticles: [C2RustUnnamed_14; 3],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_14 {
    pub status: EffectStatus,
    pub effect: EffectShieldParticle,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_15 {
    pub status: EffectStatus,
    pub effect: EffectBlure,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_16 {
    pub status: EffectStatus,
    pub effect: EffectSpark,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EffectInfo {
    ...
    pub init: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                          _: *mut libc::c_void) -> ()>,
    pub destroy: Option<unsafe extern "C" fn(_: *mut libc::c_void) -> ()>,
    pub update: Option<unsafe extern "C" fn(_: *mut libc::c_void) -> s32>,
    pub draw: Option<unsafe extern "C" fn(_: *mut libc::c_void,
                                          _: *mut GraphicsContext) -> ()>,
}
pub type C2RustUnnamed_17 = libc::c_uint;
pub const EFFECT_SHIELD_PARTICLE: C2RustUnnamed_17 = 3;
pub const EFFECT_BLURE2: C2RustUnnamed_17 = 2;
pub const EFFECT_BLURE1: C2RustUnnamed_17 = 1;
pub const EFFECT_SPARK: C2RustUnnamed_17 = 0;
#[no_mangle]
pub static mut sEffectContext: EffectContext =
    EffectContext{globalCtx: 0 as *const GlobalContext as *mut GlobalContext,
                  sparks:
                      [C2RustUnnamed_16{status:
                                            EffectStatus{active: 0,
                                                         unk_01: 0,
                                                         unk_02: 0,},
                                        effect:
                                            EffectSpark{position:
                                                            Vec3s{x: 0,
                                                                  y: 0,
                                                                  z: 0,},
                                                        numElements: 0,
                                                        ...
                                                        duration: 0,},}; 3],
                  blures:
                      [C2RustUnnamed_15{status:
                                            EffectStatus{active: 0,
                                                         unk_01: 0,
                                                         unk_02: 0,},
                                        effect:
                                            EffectBlure{elements:
                                                            [EffectBlureElement{state:
                                                                                    0,
                                                                                timer:
                                                                                    0,
                                                                                p1:
                          ...
                          25],
                  shieldParticles:
                      [C2RustUnnamed_14{status:
                                            EffectStatus{active: 0,
                                                         unk_01: 0,
                                                         unk_02: 0,},
                                        effect:
                                            EffectShieldParticle{elements:
                                                                     [EffectShieldParticleElement{initialSpeed:
                                                                                                      0.,
                                                                                                  endXChange:
                                                                                                      0.,
                                                                                                  endX:
                          ...
                          3],};
#[no_mangle]
pub static mut sEffectInfoTable: [EffectInfo; 4] =
    unsafe {
        [{
             let mut init =
                 EffectInfo{size:
                                ::std::mem::size_of::<EffectSpark>() as
                                    libc::c_ulong,
                            init:
                                Some(EffectSpark_Init as
                                         unsafe extern "C" fn(_:
                                             ...
                                             -> ()),
                            destroy:
                                Some(EffectSpark_Destroy as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> ()),
                            update:
                                Some(EffectSpark_Update as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> s32),
                            draw:
                                Some(EffectSpark_Draw as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void,
                                                              _:
                                                                  *mut GraphicsContext)
         ...
         },
         {
             let mut init =
                 EffectInfo{size:
                                ::std::mem::size_of::<EffectBlure>() as
                                    libc::c_ulong,
                            init:
                                Some(EffectBlure_Init1 as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void,
                                                              _:
                                                                  *mut libc::c_void)
                                             -> ()),
                            destroy:
                                Some(EffectBlure_Destroy as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> ()),
                            update:
                                Some(EffectBlure_Update as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> s32),
                            draw:
                                Some(EffectBlure_Draw as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void,
                                                              _:
                                                                  *mut GraphicsContext)
         ...
         },
         {
             let mut init =
                 EffectInfo{size:
                                ::std::mem::size_of::<EffectShieldParticle>()
                                    as libc::c_ulong,
                            init:
                                Some(EffectShieldParticle_Init as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void,
                                                              _:
                                                                  *mut libc::c_void)
                                             -> ()),
                            destroy:
                                Some(EffectShieldParticle_Destroy as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> ()),
                            update:
                                Some(EffectShieldParticle_Update as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void)
                                             -> s32),
                            draw:
                                Some(EffectShieldParticle_Draw as
                                         unsafe extern "C" fn(_:
                                                                  *mut libc::c_void,
                                                              _:
                                                                  *mut GraphicsContext)
...
#[no_mangle]
pub unsafe extern "C" fn Effect_GetGlobalCtx() -> *mut GlobalContext {
    return sEffectContext.globalCtx;
}
#[no_mangle]
pub unsafe extern "C" fn Effect_GetByIndex(mut index: s32)
 -> *mut libc::c_void {
    if index == 3 as libc::c_int + 25 as libc::c_int + 3 as libc::c_int {
        return 0 as *mut libc::c_void
    }
    if index < 3 as libc::c_int {
        if sEffectContext.sparks[index as usize].status.active as libc::c_int
               == 1 as libc::c_int {
            return &mut (*sEffectContext.sparks.as_mut_ptr().offset(index as
                                                                        isize)).effect
                       as *mut EffectSpark as *mut libc::c_void
        } else { return 0 as *mut libc::c_void }
    }
    index -= 3 as libc::c_int;
    if index < 25 as libc::c_int {
        if sEffectContext.blures[index as usize].status.active as libc::c_int
               == 1 as libc::c_int {
            return &mut (*sEffectContext.blures.as_mut_ptr().offset(index as
                                                                        isize)).effect
                       as *mut EffectBlure as *mut libc::c_void
        } else { return 0 as *mut libc::c_void }
    }
    index -= 25 as libc::c_int;
    if index < 3 as libc::c_int {
        if sEffectContext.shieldParticles[index as usize].status.active as
               libc::c_int == 1 as libc::c_int {
            return &mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(index
                                                                                 as
                                                                                 isize)).effect
                       as *mut EffectShieldParticle as *mut libc::c_void
        } else { return 0 as *mut libc::c_void }
    }
    return 0 as *mut libc::c_void;
}
#[no_mangle]
pub unsafe extern "C" fn Effect_InitStatus(mut status: *mut EffectStatus) {
    (*status).active = 0 as libc::c_int as u8_0;
    (*status).unk_01 = 0 as libc::c_int as u8_0;
    (*status).unk_02 = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn Effect_InitContext(mut globalCtx:
                                                *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        Effect_InitStatus(&mut (*sEffectContext.sparks.as_mut_ptr().offset(i
                                                                               as
                                                                               isize)).status);
        i += 1
    }
    ...
    while i < 25 as libc::c_int {
        Effect_InitStatus(&mut (*sEffectContext.blures.as_mut_ptr().offset(i
                                                                               as
                                                                               isize)).status);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn Effect_Add(mut globalCtx: *mut GlobalContext,
                                    mut pIndex: *mut s32, mut type_0: s32,
                                    mut arg3: u8_0, mut arg4: u8_0,
                                    mut initParams: *mut libc::c_void) {
    let mut i: s32 = 0;
    let mut slotFound: u32_0 = 0;
    let mut effect: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut status: *mut EffectStatus = 0 as *mut EffectStatus;
    *pIndex = 3 as libc::c_int + 25 as libc::c_int + 3 as libc::c_int;
    if FrameAdvance_IsEnabled(globalCtx) != 1 as libc::c_int {
        slotFound = 0 as libc::c_int as u32_0;
        match type_0 {
            0 => {
                i = 0 as libc::c_int;
                while i < 3 as libc::c_int {
                    if sEffectContext.sparks[i as usize].status.active as
                           libc::c_int == 0 as libc::c_int {
                        slotFound = 1 as libc::c_int as u32_0;
                        *pIndex = i;
                        effect =
                            &mut (*sEffectContext.sparks.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize)).effect
                                as *mut EffectSpark as *mut libc::c_void;
                        status =
            ...
            1 | 2 => {
                i = 0 as libc::c_int;
                while i < 25 as libc::c_int {
                    if sEffectContext.blures[i as usize].status.active as
                           libc::c_int == 0 as libc::c_int {
                        slotFound = 1 as libc::c_int as u32_0;
                        *pIndex = i + 3 as libc::c_int;
                        effect =
                            &mut (*sEffectContext.blures.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize)).effect
                                as *mut EffectBlure as *mut libc::c_void;
                        status =
            ...
            3 => {
                i = 0 as libc::c_int;
                while i < 3 as libc::c_int {
                    if sEffectContext.shieldParticles[i as
                                                          usize].status.active
                           as libc::c_int == 0 as libc::c_int {
                        slotFound = 1 as libc::c_int as u32_0;
                        *pIndex = i + 3 as libc::c_int + 25 as libc::c_int;
                        effect =
                            &mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(i
                                                                                          as
                                                                                          isize)).effect
                                as *mut EffectShieldParticle as
                                *mut libc::c_void;
                        status =
                            &mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(i
                                                                                          as
        ...
        if slotFound == 0 {
            ...
            osSyncPrintf(b"EffectAdd():\xe7\xa2\xba\xe4\xbf\x9d\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\xe6\xb3\xa8\xe6\x84\x8f\xe3\x81\x97\xe3\x81\xa6\xe3\x81\x8f\xe3\x81\xa0\xe3\x81\x95\xe3\x81\x84\xe3\x80\x82Type%d\n\x00"
                             as *const u8 as *const libc::c_char, type_0);
            osSyncPrintf(b"\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe8\xbf\xbd\xe5\x8a\xa0\xe3\x81\x9b\xe3\x81\x9a\xe3\x81\xab\xe7\xb5\x82\xe4\xba\x86\xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82\n\x00"
                             as *const u8 as *const libc::c_char);
            // "Exit without adding the effect."
        } else {
            sEffectInfoTable[type_0 as
                                 usize].init.expect("non-null function pointer")(effect,
                                                                                 initParams); // Necessary to match
            (*status).unk_02 = arg3; // "All effect release"
            (*status).unk_01 = arg4;
            (*status).active = 1 as libc::c_int as u8_0
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn Effect_DrawAll(mut gfxCtx: *mut GraphicsContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if sEffectContext.sparks[i as usize].status.active != 0 {
            sEffectInfoTable[EFFECT_SPARK as libc::c_int as
                                 usize].draw.expect("non-null function pointer")(&mut (*sEffectContext.sparks.as_mut_ptr().offset(i
                                                                                                                                      as
                                                                                                                                      isize)).effect
                                                                                     as
                                                                                     *mut EffectSpark
    ...
    i = 0 as libc::c_int;
    while i < 25 as libc::c_int {
        if sEffectContext.blures[i as usize].status.active != 0 {
            sEffectInfoTable[EFFECT_BLURE1 as libc::c_int as
                                 usize].draw.expect("non-null function pointer")(&mut (*sEffectContext.blures.as_mut_ptr().offset(i
                                                                                                                                      as
                                                                                                                                      isize)).effect
                                                                                     as
                                                                                     *mut EffectBlure
    ...
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if sEffectContext.shieldParticles[i as usize].status.active != 0 {
            !gfxCtx.is_null();
            sEffectInfoTable[EFFECT_SHIELD_PARTICLE as libc::c_int as
                                 usize].draw.expect("non-null function pointer")(&mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(i
                                                                                                                                               as
                                                                                                                                               isize)).effect
                                                                                     as
                                                                                     *mut EffectShieldParticle
                                                                                     as
                                                                                     *mut libc::c_void,
                                                                                 gfxCtx);
        }
...
#[no_mangle]
pub unsafe extern "C" fn Effect_UpdateAll(mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if sEffectContext.sparks[i as usize].status.active != 0 {
            if sEffectInfoTable[EFFECT_SPARK as libc::c_int as
                                    usize].update.expect("non-null function pointer")(&mut (*sEffectContext.sparks.as_mut_ptr().offset(i
                                                                                                                                           as
                                                                                                                                           isize)).effect
                                                                                          as
                                                                                          *mut EffectSpark
    ...
    while i < 25 as libc::c_int {
        if sEffectContext.blures[i as usize].status.active != 0 {
            if sEffectInfoTable[EFFECT_BLURE1 as libc::c_int as
                                    usize].update.expect("non-null function pointer")(&mut (*sEffectContext.blures.as_mut_ptr().offset(i
                                                                                                                                           as
                                                                                                                                           isize)).effect
                                                                                          as
                                                                                          *mut EffectBlure
                                                                                          ...
                                                                                          *mut libc::c_void)
                   == 1 as libc::c_int {
                Effect_Delete(globalCtx, i + 3 as libc::c_int);
            }
        }
        i += 1
    }
    ...
    while i < 3 as libc::c_int {
        if sEffectContext.shieldParticles[i as usize].status.active != 0 {
            if sEffectInfoTable[EFFECT_SHIELD_PARTICLE as libc::c_int as
                                    usize].update.expect("non-null function pointer")(&mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(i
                                                                                                                                                    as
                                                                                                                                                    isize)).effect
                                                                                          as
                                                                                          *mut EffectShieldParticle
                                                                                          ...
                                                                                          *mut libc::c_void)
                   == 1 as libc::c_int {
                Effect_Delete(globalCtx,
                              i + 3 as libc::c_int + 25 as libc::c_int);
            }
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn Effect_Delete(mut globalCtx: *mut GlobalContext,
                                       mut index: s32) {
    if index == 3 as libc::c_int + 25 as libc::c_int + 3 as libc::c_int {
        return
    }
    if index < 3 as libc::c_int {
        sEffectContext.sparks[index as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_SPARK as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.sparks.as_mut_ptr().offset(index
                                                                                                                                     as
                                                                                                                                     isize)).effect
                                                                                    as
                                                                                    *mut EffectSpark
    ...
    index -= 3 as libc::c_int;
    if index < 25 as libc::c_int {
        sEffectContext.blures[index as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_BLURE1 as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.blures.as_mut_ptr().offset(index
                                                                                                                                     as
                                                                                                                                     isize)).effect
                                                                                    as
                                                                                    *mut EffectBlure
    ...
    index -= 25 as libc::c_int;
    if index < 3 as libc::c_int {
        sEffectContext.shieldParticles[index as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_SHIELD_PARTICLE as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(index
                                                                                                                                              as
                                                                                                                                              isize)).effect
                                                                                    as
                                                                                    *mut EffectShieldParticle
...
#[no_mangle]
pub unsafe extern "C" fn Effect_DeleteAll(mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    osSyncPrintf(b"\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe7\xb7\x8f\xe3\x81\xa6\xe8\xa7\xa3\xe6\x94\xbe\n\x00"
                     as *const u8 as *const libc::c_char);
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        sEffectContext.sparks[i as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_SPARK as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.sparks.as_mut_ptr().offset(i
                                                                                                                                     as
                                                                                                                                     isize)).effect
                                                                                    as
                                                                                    *mut EffectSpark
    ...
    i = 0 as libc::c_int;
    while i < 25 as libc::c_int {
        sEffectContext.blures[i as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_BLURE1 as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.blures.as_mut_ptr().offset(i
                                                                                                                                     as
                                                                                                                                     isize)).effect
                                                                                    as
                                                                                    *mut EffectBlure
    ...
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        sEffectContext.shieldParticles[i as usize].status.active =
            0 as libc::c_int as u8_0;
        sEffectInfoTable[EFFECT_SHIELD_PARTICLE as libc::c_int as
                             usize].destroy.expect("non-null function pointer")(&mut (*sEffectContext.shieldParticles.as_mut_ptr().offset(i
                                                                                                                                              as
                                                                                                                                              isize)).effect
                                                                                    as
                                                                                    *mut EffectShieldParticle
    ...
    osSyncPrintf(b"\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe7\xb7\x8f\xe3\x81\xa6\xe8\xa7\xa3\xe6\x94\xbe \xe7\xb5\x82\xe4\xba\x86\n\x00"
                     as *const u8 as *const libc::c_char);
