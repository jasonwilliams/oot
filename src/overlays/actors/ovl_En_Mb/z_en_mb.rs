...
extern "C" {
    ...
    fn Actor_SetDropFlag(actor: *mut Actor, colBody: *mut ColliderInfo,
                         freezeFlag: s32);
    #[no_mangle]
    fn func_800358DC(actor: *mut Actor, spawnPos: *mut Vec3f,
                     spawnRot: *mut Vec3s, arg3: *mut f32_0, timer: s32,
                     unused: *mut s16, globalCtx: *mut GlobalContext,
                     params: s16, arg8: s32) -> *mut Actor;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gEnMbSpearDamagedFromBehindAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearFallOnItsBackAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearDamagedFromFrontAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearStandStillAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearPrepareChargeAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearChargeAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearLookLeftAndRightAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gEnMbSpearSlowDownAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbSpearWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubStrikeDownAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubLiftClubAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubFallOnItsBackAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubDamagedKneelAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubBeatenKneelingAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubStandUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubStandStillClubDownAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnMbClubSkel: FlexSkeletonHeader;
}
...
pub struct EnMb {
    ...
    pub state: EnMbState,
    pub actionFunc: EnMbActionFunc,
    pub iceEffectTimer: s16,
    pub timer1: s16,
    pub timer2: s16,
    pub timer3: s16,
    pub yawToWaypoint: s16,
    pub unk_332: s16,
    pub attack: s16,
    pub effSpawnPos: Vec3f,
    pub waypointPos: Vec3f,
    pub unk_34A: [libc::c_char; 12],
    pub waypoint: s8,
    pub path: s8,
    pub direction: s8,
    pub maxHomeDist: f32_0,
    pub playerDetectionRange: f32_0,
    pub hitbox: ColliderCylinder,
    pub attackCollider: ColliderQuad,
    pub frontShielding: ColliderTris,
    pub frontShieldingTris: [ColliderTrisElement; 2],
}
pub type EnMbActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMb, _: *mut GlobalContext) -> ()>;
pub type EnMbState = libc::c_uint;
pub const ENMB_STATE_ATTACK_END: EnMbState = 11;
pub const ENMB_STATE_ATTACK: EnMbState = 10;
pub const ENMB_STATE_WALK: EnMbState = 9;
pub const ENMB_STATE_IDLE: EnMbState = 6;
pub const ENMB_STATE_STUNNED: EnMbState = 5;
pub const ENMB_STATE_CLUB_KNEELING: EnMbState = 3;
pub const ENMB_STATE_CLUB_KNEELING_DAMAGED: EnMbState = 2;
pub const ENMB_STATE_CLUB_DEAD: EnMbState = 1;
pub const ENMB_STATE_SPEAR_SPEARPATH_DAMAGED: EnMbState = 0;
pub type C2RustUnnamed_22 = libc::c_int;
pub const ENMB_TYPE_SPEAR_PATROL: C2RustUnnamed_22 = 1;
pub const ENMB_TYPE_CLUB: C2RustUnnamed_22 = 0;
pub const ENMB_TYPE_SPEAR_GUARD: C2RustUnnamed_22 = -1;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const ENMB_LIMB_RFOOT: C2RustUnnamed_23 = 27;
pub const ENMB_LIMB_RSHIN: C2RustUnnamed_23 = 26;
pub const ENMB_LIMB_RTHIGH: C2RustUnnamed_23 = 25;
pub const ENMB_LIMB_LFOOT: C2RustUnnamed_23 = 22;
pub const ENMB_LIMB_LSHIN: C2RustUnnamed_23 = 21;
pub const ENMB_LIMB_LTHIGH: C2RustUnnamed_23 = 20;
pub const ENMB_LIMB_RHAND: C2RustUnnamed_23 = 17;
pub const ENMB_LIMB_RFOREARM: C2RustUnnamed_23 = 16;
pub const ENMB_LIMB_RSHOULDER: C2RustUnnamed_23 = 14;
pub const ENMB_LIMB_LHAND: C2RustUnnamed_23 = 12;
pub const ENMB_LIMB_LFOREARM: C2RustUnnamed_23 = 11;
pub const ENMB_LIMB_LSHOULDER: C2RustUnnamed_23 = 9;
pub const ENMB_LIMB_HEAD: C2RustUnnamed_23 = 7;
pub const ENMB_LIMB_CHEST: C2RustUnnamed_23 = 6;
pub const ENMB_LIMB_WAIST: C2RustUnnamed_23 = 3;
pub const ENMB_LIMB_ROOT: C2RustUnnamed_23 = 1;
pub const ENMB_DMGEFF_IGNORE: C2RustUnnamed_24 = 0;
pub const ENMB_DMGEFF_DEFAULT: C2RustUnnamed_24 = 15;
pub const ENMB_DMGEFF_FREEZE: C2RustUnnamed_24 = 5;
pub const ENMB_DMGEFF_STUN_ICE: C2RustUnnamed_24 = 6;
pub const ENMB_DMGEFF_STUN: C2RustUnnamed_24 = 1;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut En_Mb_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MB as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_MB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMb>() as libc::c_ulong,
                          init:
...
static mut sHitboxInit: ColliderCylinderInit =
    {
        let mut init =
...
static mut sFrontShieldingTrisInit: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
...
static mut sFrontShieldingInit: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sFrontShieldingTrisInit.as_ptr() as
                                         *mut _,};
            init
        }
    };
static mut sAttackColliderInit: ColliderQuadInit =
    {
        let mut init =
...
static mut sSpearMoblinDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (ENMB_DMGEFF_FREEZE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (ENMB_DMGEFF_STUN as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (ENMB_DMGEFF_STUN_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENMB_DMGEFF_DEFAULT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (0 as libc::c_int |
                                  (ENMB_DMGEFF_FREEZE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (ENMB_DMGEFF_IGNORE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (ENMB_DMGEFF_IGNORE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
static mut sClubMoblinDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupAction(mut this: *mut EnMb,
                                          mut actionFunc: EnMbActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMb = thisx as *mut EnMb;
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut relYawFromPlayer: s16 = 0;
    ...
    (*this).actor.colChkInfo.damageTable = &mut sSpearMoblinDamageTable;
    Collider_InitCylinder(globalCtx, &mut (*this).hitbox);
    Collider_SetCylinder(globalCtx, &mut (*this).hitbox, &mut (*this).actor,
                         &mut sHitboxInit);
    Collider_InitTris(globalCtx, &mut (*this).frontShielding);
    Collider_SetTris(globalCtx, &mut (*this).frontShielding,
                     &mut (*this).actor, &mut sFrontShieldingInit,
                     (*this).frontShieldingTris.as_mut_ptr());
    Collider_InitQuad(globalCtx, &mut (*this).attackCollider);
    Collider_SetQuad(globalCtx, &mut (*this).attackCollider,
                     &mut (*this).actor, &mut sAttackColliderInit);
    match (*this).actor.params as libc::c_int {
        -1 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut gEnMbSpearSkel,
                               &mut gEnMbSpearStandStillAnim,
            ...
            (*this).maxHomeDist = 1000.0f32;
            (*this).playerDetectionRange = 1750.0f32;
            EnMb_SetupSpearGuardLookAround(this);
        }
        0 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut gEnMbClubSkel,
                               &mut gEnMbClubStandStillClubDownAnim,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               28 as libc::c_int);
            (*this).actor.colChkInfo.health = 6 as libc::c_int as u8_0;
            (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
            (*this).actor.colChkInfo.damageTable =
                &mut sClubMoblinDamageTable;
            Actor_SetScale(&mut (*this).actor, 0.02f32);
            (*this).hitbox.dim.height = 170 as libc::c_int as s16;
            (*this).hitbox.dim.radius = 45 as libc::c_int as s16;
            (*this).actor.uncullZoneForward = 4000.0f32;
            (*this).actor.uncullZoneScale = 800.0f32;
            (*this).actor.uncullZoneDownward = 1800.0f32;
            (*this).playerDetectionRange = 710.0f32;
            (*this).attackCollider.info.toucher.dmgFlags =
                0x20000000 as libc::c_int as u32_0;
            relYawFromPlayer =
                ((*this).actor.world.rot.y as libc::c_int -
                     Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                                    &mut (*player).actor.world.pos) as
                         libc::c_int) as s16;
            if (if relYawFromPlayer as libc::c_int >= 0 as libc::c_int {
                    relYawFromPlayer as libc::c_int
                } else { -(relYawFromPlayer as libc::c_int) }) >
                ...
                (*this).actor.world.pos.z = (*thisx).world.pos.z + 600.0f32
            }
            ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
            ...
            (*this).actor.naviEnemyId =
                ((*this).actor.naviEnemyId as libc::c_int + 1 as libc::c_int)
                    as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMb = thisx as *mut EnMb;
    Collider_DestroyTris(globalCtx, &mut (*this).frontShielding);
    Collider_DestroyCylinder(globalCtx, &mut (*this).hitbox);
    Collider_DestroyQuad(globalCtx, &mut (*this).attackCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_FaceWaypoint(mut this: *mut EnMb,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut yawToWaypoint: s16 =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                       &mut (*this).waypointPos);
    (*this).actor.shape.rot.y = yawToWaypoint;
    (*this).actor.world.rot.y = yawToWaypoint;
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_NextWaypoint(mut this: *mut EnMb,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut path: *mut Path = 0 as *mut Path;
    let mut waypointPos: *mut Vec3s = 0 as *mut Vec3s;
    path =
        &mut *(*globalCtx).setupPathList.offset((*this).path as isize) as
            *mut Path;
    if (*this).waypoint as libc::c_int == 0 as libc::c_int {
        (*this).direction = 1 as libc::c_int as s8
    } else if (*this).waypoint as libc::c_int ==
                  ((*path).count as libc::c_int - 1 as libc::c_int) as s8 as
                      libc::c_int {
        (*this).direction = -(1 as libc::c_int) as s8
    }
    (*this).waypoint =
        ((*this).waypoint as libc::c_int + (*this).direction as libc::c_int)
            as s8;
    waypointPos =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
             ...
             *mut Vec3s).offset((*this).waypoint as libc::c_int as isize);
    (*this).waypointPos.x = (*waypointPos).x as f32_0;
    (*this).waypointPos.y = (*waypointPos).y as f32_0;
    (*this).waypointPos.z = (*waypointPos).z as f32_0;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_IsPlayerInCorridor(mut this: *mut EnMb,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut xFromPlayer: f32_0 = 0.;
    let mut zFromPlayer: f32_0 = 0.;
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    let mut xFromPlayerAbs: f32_0 = 0.;
    let mut zFromPlayerAbs: f32_0 = 0.;
    let mut alignedYaw: s16 = 0 as libc::c_int as s16;
    if ((*this).actor.world.rot.y as libc::c_int) < -(0x62a2 as libc::c_int)
           || (*this).actor.world.rot.y as libc::c_int > 0x62a2 as libc::c_int
       {
        alignedYaw = -(0x8000 as libc::c_int) as s16
    } else if ((*this).actor.world.rot.y as libc::c_int) <
                  -(0x20e0 as libc::c_int) {
        alignedYaw = -(0x4000 as libc::c_int) as s16
    } else if (*this).actor.world.rot.y as libc::c_int > 0x20e0 as libc::c_int
     {
        alignedYaw = 0x4000 as libc::c_int as s16
    }
    cos = Math_CosS(alignedYaw);
    sin = Math_SinS(alignedYaw);
    cos = if cos >= 0 as libc::c_int as libc::c_float { cos } else { -cos };
    sin = if sin >= 0 as libc::c_int as libc::c_float { sin } else { -sin };
    xFromPlayer = (*this).actor.world.pos.x - (*player).actor.world.pos.x;
    zFromPlayer = (*this).actor.world.pos.z - (*player).actor.world.pos.z;
    xFromPlayerAbs =
        if xFromPlayer >= 0 as libc::c_int as libc::c_float {
            xFromPlayer
        } else { -xFromPlayer };
    if xFromPlayerAbs < cos * 37.0f32 + sin * 400.0f32 {
        zFromPlayerAbs =
            if zFromPlayer >= 0 as libc::c_int as libc::c_float {
                zFromPlayer
            } else { -zFromPlayer };
        if zFromPlayerAbs < sin * 37.0f32 + cos * 400.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_FindWaypointTowardsPlayer(mut this: *mut EnMb,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset((*this).path as isize) as
            *mut Path;
    let mut yawToWaypoint: s16 = 0;
    let mut waypointPosF: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut waypointPosS: *mut Vec3s = 0 as *mut Vec3s;
    let mut yawPlayerToWaypoint: s16 = 0;
    let mut i: s32 = 0;
    let mut waypoint: s32 = 0;
    waypoint = 0 as libc::c_int;
    i = (*path).count as libc::c_int - 1 as libc::c_int;
                           ...
                           usize].wrapping_add((*path).points as u32_0 &
                                                   0xffffff as libc::c_int as
                                                       libc::c_uint).wrapping_add(0x80000000
                                                                                      ...
                                                                                      libc::c_uint)
                 as *mut libc::c_void as
                 *mut Vec3s).offset(waypoint as isize);
        waypointPosF.x = (*waypointPosS).x as f32_0;
        waypointPosF.y = (*waypointPosS).y as f32_0;
        waypointPosF.z = (*waypointPosS).z as f32_0;
        yawToWaypoint =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut waypointPosF);
        yawPlayerToWaypoint =
            (yawToWaypoint as libc::c_int -
                 (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
        if (if yawPlayerToWaypoint as libc::c_int >= 0 as libc::c_int {
                yawPlayerToWaypoint as libc::c_int
            } else { -(yawPlayerToWaypoint as libc::c_int) }) <=
               0x1770 as libc::c_int {
            (*this).actor.world.rot.y = yawToWaypoint;
            if waypoint == (*this).waypoint as libc::c_int {
                (*this).direction = -((*this).direction as libc::c_int) as s8
            }
            (*this).waypointPos = waypointPosF;
            (*this).waypoint = waypoint as s8;
            break ;
        } else { i -= 1; waypoint += 1 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearGuardLookAround(mut this: *mut EnMb) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut gEnMbSpearLookLeftAndRightAnim, -4.0f32);
    (*this).actor.speedXZ = 0.0f32;
    (*this).timer1 =
        Rand_S16Offset(30 as libc::c_int as s16, 50 as libc::c_int as s16);
    (*this).state = ENMB_STATE_IDLE;
    EnMb_SetupAction(this,
                     Some(EnMb_SpearGuardLookAround as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubWaitPlayerNear(mut this: *mut EnMb) {
    ...
    (*this).state = ENMB_STATE_IDLE;
    EnMb_SetupAction(this,
                     Some(EnMb_ClubWaitPlayerNear as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearPatrolTurnTowardsWaypoint(mut this:
                                                                      *mut EnMb,
                                                                  mut globalCtx:
                                                                      *mut GlobalContext) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
    ...
    (*this).actor.speedXZ = 0.0f32;
    (*this).timer1 =
        Rand_S16Offset(40 as libc::c_int as s16, 80 as libc::c_int as s16);
    (*this).state = ENMB_STATE_IDLE;
    EnMb_NextWaypoint(this, globalCtx);
    EnMb_SetupAction(this,
                     Some(EnMb_SpearPatrolTurnTowardsWaypoint as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearGuardWalk(mut this: *mut EnMb) {
    Animation_Change(&mut (*this).skelAnime, &mut gEnMbSpearWalkAnim, 0.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gEnMbSpearWalkAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -4.0f32);
    (*this).actor.speedXZ = 0.59999996f32;
    (*this).timer1 =
        Rand_S16Offset(50 as libc::c_int as s16, 70 as libc::c_int as s16);
    (*this).unk_332 = 1 as libc::c_int as s16;
    (*this).state = ENMB_STATE_WALK;
    EnMb_SetupAction(this,
                     Some(EnMb_SpearGuardWalk as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearPatrolWalkTowardsWaypoint(mut this:
                                                                      *mut EnMb) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnMbSpearWalkAnim as *mut AnimationHeader
    ...
    EnMb_SetupAction(this,
                     Some(EnMb_SpearPatrolWalkTowardsWaypoint as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearPrepareAndCharge(mut this:
                                                             *mut EnMb) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnMbSpearPrepareChargeAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gEnMbSpearPrepareChargeAnim, -4.0f32);
    (*this).state = ENMB_STATE_ATTACK;
    (*this).actor.speedXZ = 0.0f32;
    (*this).timer3 =
        (frameCount as s16 as libc::c_int + 6 as libc::c_int) as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38bc as libc::c_int as u16_0);
    if (*this).actor.params as libc::c_int ==
           ENMB_TYPE_SPEAR_GUARD as libc::c_int {
        EnMb_SetupAction(this,
                         Some(EnMb_SpearGuardPrepareAndCharge as
                                  unsafe extern "C" fn(_: *mut EnMb,
                                                       _: *mut GlobalContext)
                                      -> ()));
    } else {
        EnMb_SetupAction(this,
                         Some(EnMb_SpearPatrolPrepareAndCharge as
                                  unsafe extern "C" fn(_: *mut EnMb,
                                                       _: *mut GlobalContext)
                                      -> ()));
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearPatrolImmediateCharge(mut this:
                                                                  *mut EnMb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gEnMbSpearChargeAnim);
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ba as libc::c_int as u16_0);
    (*this).attack = 1 as libc::c_int as s16;
    (*this).state = ENMB_STATE_ATTACK;
    (*this).timer3 = 3 as libc::c_int as s16;
    (*this).actor.speedXZ = 10.0f32;
    EnMb_SetupAction(this,
                     Some(EnMb_SpearPatrolImmediateCharge as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubAttack(mut this: *mut EnMb) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gEnMbClubLiftClubAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    let mut relYawFromPlayer: s16 = 0;
    (*this).state = ENMB_STATE_ATTACK;
    Animation_Change(&mut (*this).skelAnime, &mut gEnMbClubLiftClubAnim,
                     3.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, 0.0f32);
    (*this).timer3 = 1 as libc::c_int as s16;
    relYawFromPlayer =
        ((*this).actor.world.rot.y as libc::c_int -
             (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
    if (if relYawFromPlayer as libc::c_int >= 0 as libc::c_int {
            relYawFromPlayer as libc::c_int
        } else { -(relYawFromPlayer as libc::c_int) }) <= 0x258 as libc::c_int
       {
        (*this).attack = 2 as libc::c_int as s16
    } else if relYawFromPlayer as libc::c_int >= 0 as libc::c_int {
        (*this).attack = 1 as libc::c_int as s16
    } else { (*this).attack = 3 as libc::c_int as s16 }
    EnMb_SetupAction(this,
                     Some(EnMb_ClubAttack as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearEndChargeQuick(mut this: *mut EnMb) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gEnMbSpearSlowDownAnim);
    (*this).state = ENMB_STATE_ATTACK_END;
    (*this).timer1 = 0 as libc::c_int as s16;
    (*this).timer3 = 5 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38b9 as libc::c_int as u16_0);
    EnMb_SetupAction(this,
                     Some(EnMb_SpearEndChargeQuick as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearPatrolEndCharge(mut this: *mut EnMb) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gEnMbSpearSlowDownAnim);
    (*this).state = ENMB_STATE_ATTACK_END;
    (*this).actor.bgCheckFlags =
        ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int)) as
            u16_0;
    (*this).timer1 = 0 as libc::c_int as s16;
    (*this).timer3 = 50 as libc::c_int as s16;
    (*this).actor.speedXZ = -8.0f32;
    (*this).actor.velocity.y = 6.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38b9 as libc::c_int as u16_0);
    EnMb_SetupAction(this,
                     Some(EnMb_SpearPatrolEndCharge as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubWaitAfterAttack(mut this: *mut EnMb) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnMbClubStandStillClubDownAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).state = ENMB_STATE_ATTACK_END;
    Animation_Change(&mut (*this).skelAnime,
                     &mut gEnMbClubStandStillClubDownAnim, 5.0f32, 0.0f32,
                     frameCount, ANIMMODE_ONCE_INTERP as libc::c_int as u8_0,
                     0.0f32);
    EnMb_SetupAction(this,
                     Some(EnMb_ClubWaitAfterAttack as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubDamaged(mut this: *mut EnMb) {
    Animation_PlayOnce(&mut (*this).skelAnime,
                       &mut gEnMbClubDamagedKneelAnim);
    (*this).state = ENMB_STATE_CLUB_KNEELING;
    (*this).timer1 = 0 as libc::c_int as s16;
    (*this).timer3 = 20 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38be as libc::c_int as u16_0);
    EnMb_SetupAction(this,
                     Some(EnMb_ClubDamaged as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubDamagedWhileKneeling(mut this:
                                                                *mut EnMb) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gEnMbClubBeatenKneelingAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).state = ENMB_STATE_CLUB_KNEELING_DAMAGED;
    (*this).timer1 = 0 as libc::c_int as s16;
    (*this).timer3 = 6 as libc::c_int as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gEnMbClubBeatenKneelingAnim,
                     1.0f32, 4.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, 0.0f32);
    EnMb_SetupAction(this,
                     Some(EnMb_ClubDamagedWhileKneeling as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupClubDead(mut this: *mut EnMb) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gEnMbClubFallOnItsBackAnim, -4.0f32);
    (*this).state = ENMB_STATE_CLUB_DEAD;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).hitbox.dim.height = 80 as libc::c_int as s16;
    (*this).hitbox.dim.radius = 95 as libc::c_int as s16;
    (*this).timer1 = 30 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38be as libc::c_int as u16_0);
    EnMb_SetupAction(this,
                     Some(EnMb_ClubDead as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupStunned(mut this: *mut EnMb) {
    (*this).state = ENMB_STATE_STUNNED;
    (*this).actor.speedXZ = 0.0f32;
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         0x78 as libc::c_int as s16, 0 as libc::c_int as s16,
                         0x50 as libc::c_int as s16);
    if (*this).damageEffect as libc::c_int ==
           ENMB_DMGEFF_STUN_ICE as libc::c_int {
        (*this).iceEffectTimer = 40 as libc::c_int as s16
    } else {
        if (*this).actor.params as libc::c_int !=
               ENMB_TYPE_CLUB as libc::c_int {
            Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                                       &mut gEnMbSpearDamagedFromFrontAnim,
                                       0.0f32);
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x389e as libc::c_int as u16_0);
    }
    EnMb_SetupAction(this,
                     Some(EnMb_Stunned as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_Stunned(mut this: *mut EnMb,
                                      mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint != 0 &&
           (*player).actor.parent == &mut (*this).actor as *mut Actor {
        (*player).stateFlags2 &= !(0x80 as libc::c_int) as libc::c_uint;
        (*player).actor.parent = 0 as *mut Actor;
        (*player).unk_850 = 200 as libc::c_int as s16;
        func_8002F71C(globalCtx, &mut (*this).actor, 4.0f32,
                      (*this).actor.world.rot.y, 4.0f32);
        (*this).attack = 0 as libc::c_int as s16
    }
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        if (*this).actor.params as libc::c_int ==
            ...
            } else if (*this).state as libc::c_uint ==
                          ENMB_STATE_CLUB_KNEELING as libc::c_int as
                              libc::c_uint {
                /* dead code: the setup for this action sets state to something else */
                EnMb_SetupClubDamagedWhileKneeling(this);
            } else { EnMb_SetupClubWaitPlayerNear(this); }
        } else if (*this).actor.colChkInfo.health as libc::c_int ==
                      0 as libc::c_int {
            EnMb_SetupSpearDead(this);
        } else { EnMb_SetupSpearDamaged(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearGuardLookAround(mut this: *mut EnMb,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut timer1: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer1 as libc::c_int == 0 as libc::c_int {
        timer1 = 0 as libc::c_int as s16
    } else { (*this).timer1 -= 1; timer1 = (*this).timer1 }
    if timer1 as libc::c_int == 0 as libc::c_int &&
           Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 {
        EnMb_SetupSpearGuardWalk(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearPatrolTurnTowardsWaypoint(mut this:
                                                                 *mut EnMb,
                                                             mut globalCtx:
                                                                 *mut GlobalContext) {
    let mut relYawFromPlayer: s16 = 0;
    ...
    if (*this).timer1 as libc::c_int == 0 as libc::c_int {
        (*this).yawToWaypoint =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).waypointPos);
        if Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                              (*this).yawToWaypoint, 1 as libc::c_int as s16,
        ...
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).actor.home.rot.y, 1 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    }
    if (if (*this).actor.yDistToPlayer >= 0 as libc::c_int as libc::c_float {
            (*this).actor.yDistToPlayer
        } else { -(*this).actor.yDistToPlayer }) <= 20.0f32 &&
           EnMb_IsPlayerInCorridor(this, globalCtx) != 0 {
        relYawFromPlayer =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearEndChargeQuick(mut this: *mut EnMb,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.5f32, 1.0f32,
                       0.0f32);
    if (*this).actor.speedXZ > 1.0f32 {
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).actor.world.pos, 5.0f32,
                                 3 as libc::c_int, 4.0f32,
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer1 as libc::c_int == 0 as libc::c_int {
            (*this).timer3 -= 1;
            if (*this).timer3 as libc::c_int == 0 as libc::c_int {
                /* Play the charge animation in reverse: let go of the spear and stand normally */
                Animation_Change(&mut (*this).skelAnime,
                                 &mut gEnMbSpearPrepareChargeAnim, -1.0f32,
                                 Animation_GetLastFrame(&mut gEnMbSpearPrepareChargeAnim
                                                            as
                                                            *mut AnimationHeader
                                                            as
                                                            *mut libc::c_void)
                                 ...
                                 0.0f32);
                (*this).timer1 = 1 as libc::c_int as s16;
                (*this).actor.speedXZ = 0.0f32;
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38bd as libc::c_int as u16_0);
            }
        } else if (*this).actor.params as libc::c_int <=
                      ENMB_TYPE_SPEAR_GUARD as libc::c_int {
            EnMb_SetupSpearGuardWalk(this);
            (*this).timer3 = 80 as libc::c_int as s16;
            (*this).timer2 = (*this).timer3;
            (*this).timer1 = (*this).timer2
        } else { EnMb_SetupSpearPatrolTurnTowardsWaypoint(this, globalCtx); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubWaitAfterAttack(mut this: *mut EnMb,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).attack = 0 as libc::c_int as s16;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearPatrolEndCharge(mut this: *mut EnMb,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        if (*this).timer1 as libc::c_int != 0 as libc::c_int {
            ...
            if (*this).timer3 as libc::c_int == 0 as libc::c_int {
                relYawFromPlayer =
                    ((*this).actor.shape.rot.y as libc::c_int -
                        ...
                        s16;
                if (if (*this).actor.yDistToPlayer >=
                           0 as libc::c_int as libc::c_float {
                        (*this).actor.yDistToPlayer
                    } else { -(*this).actor.yDistToPlayer }) <= 20.0f32 &&
                       EnMb_IsPlayerInCorridor(this, globalCtx) != 0 &&
                       (if relYawFromPlayer as libc::c_int >= 0 as libc::c_int
                           {
                            relYawFromPlayer as libc::c_int
                        } else { -(relYawFromPlayer as libc::c_int) }) <=
                           0x4000 as libc::c_int &&
                    ...
                    /* Play the charge animation in reverse: let go of the spear and stand normally */
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut gEnMbSpearPrepareChargeAnim,
                                     -1.0f32, lastFrame, 0.0f32,
                                     ANIMMODE_ONCE as libc::c_int as u8_0,
                                     0.0f32);
                    (*this).actor.speedXZ = 0.0f32;
                    Audio_PlayActorSound2(&mut (*this).actor,
            ...
            } else { (*this).actor.speedXZ = 0.0f32 }
        }
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
            if (*this).timer1 as libc::c_int == 0 as libc::c_int {
                lastFrame =
                    Animation_GetLastFrame(&mut gEnMbSpearChargeAnim as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime,
                                 &mut gEnMbSpearChargeAnim, 0.5f32, 0.0f32,
                                 lastFrame,
                                 ANIMMODE_LOOP_INTERP as libc::c_int as u8_0,
                                 0.0f32);
                (*this).timer1 = 1 as libc::c_int as s16
            } else {
                yawPlayerToWaypoint =
                    (Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                                    &mut (*this).waypointPos) as libc::c_int -
                         (*this).actor.yawTowardsPlayer as libc::c_int) as
                        s16;
                if (if yawPlayerToWaypoint as libc::c_int >= 0 as libc::c_int
                       {
                       ...
                       0x4000 as libc::c_int {
                    EnMb_SetupSpearPatrolTurnTowardsWaypoint(this, globalCtx);
                } else { EnMb_SetupSpearPatrolWalkTowardsWaypoint(this); }
            }
        }
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearGuardPrepareAndCharge(mut this: *mut EnMb,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut prevFrame: s32 = 0;
    let mut relYawTowardsPlayerAbs: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if (relYawTowardsPlayerAbs as libc::c_int) < 0 as libc::c_int {
        relYawTowardsPlayerAbs =
            -(relYawTowardsPlayerAbs as libc::c_int) as s16
    }
    prevFrame = (*this).skelAnime.curFrame as s32;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Animation_PlayLoop(&mut (*this).skelAnime, &mut gEnMbSpearChargeAnim);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ba as libc::c_int as u16_0);
    }
    if (*this).timer3 as libc::c_int != 0 as libc::c_int {
        (*this).timer3 -= 1;
        ...
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 ...
                                 15 as libc::c_int as s16,
                                 0 as libc::c_int as u8_0);
        if prevFrame != (*this).skelAnime.curFrame as s32 &&
               ((*this).skelAnime.curFrame as s32 == 2 as libc::c_int ||
                    (*this).skelAnime.curFrame as s32 == 6 as libc::c_int) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38bf as libc::c_int as u16_0);
        }
    }
    if relYawTowardsPlayerAbs as libc::c_int > 0x1388 as libc::c_int {
        (*this).attack = 0 as libc::c_int as s16;
        EnMb_SetupSpearEndChargeQuick(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubAttack(mut this: *mut EnMb,
                                         mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut pad: s32 = 0;
    let mut effSpawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut effWhiteShockwaveDynamics: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut flamesParams: [f32_0; 3] = [18.0f32, 18.0f32, 0.0f32];
    let mut flamesUnused: [s16; 3] =
        [20 as libc::c_int as s16, 40 as libc::c_int as s16,
         0 as libc::c_int as s16];
    let mut relYawTarget: [s16; 3] =
        [-(0x9c4 as libc::c_int) as s16, 0 as libc::c_int as s16,
         0xdac as libc::c_int as s16];
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (relYawTarget[((*this).attack as libc::c_int -
                                          1 as libc::c_int) as usize] as
                            libc::c_int +
                            (*this).actor.world.rot.y as libc::c_int) as s16,
                       1 as libc::c_int as s16, 0x2ee as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if (*this).attackCollider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).attackCollider.base.atFlags =
            ((*this).attackCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if (*this).attackCollider.base.at ==
               &mut (*player).actor as *mut Actor {
            let mut prevPlayerInvincibilityTimer: u8_0 =
                (*player).invincibilityTimer as u8_0;
            if ((*player).invincibilityTimer as libc::c_int) <
                   0 as libc::c_int {
                if (*player).invincibilityTimer as libc::c_int <=
                       -(40 as libc::c_int) {
                    (*player).invincibilityTimer = 0 as libc::c_int as s8
                } else {
                    (*player).invincibilityTimer = 0 as libc::c_int as s8;
            ...
            func_8002F71C(globalCtx, &mut (*this).actor,
                          (650.0f32 - (*this).actor.xzDistToPlayer) * 0.04f32
                              + 4.0f32, (*this).actor.world.rot.y, 8.0f32);
            (*player).invincibilityTimer = prevPlayerInvincibilityTimer as s8
        }
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer3 as libc::c_int != 0 as libc::c_int {
            (*this).timer3 -= 1;
            if (*this).timer3 as libc::c_int == 0 as libc::c_int {
                let mut lastAnimFrame: f32_0 =
                    Animation_GetLastFrame(&mut gEnMbClubStrikeDownAnim as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime,
                                 &mut gEnMbClubStrikeDownAnim, 1.5f32, 0.0f32,
                                 lastAnimFrame,
                                 ANIMMODE_ONCE_INTERP as libc::c_int as u8_0,
                                 0.0f32);
            }
        } else {
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39ef as libc::c_int as u16_0);
            func_800AA000((*this).actor.xzDistToPlayer,
                          0xff as libc::c_int as u8_0,
                          0x14 as libc::c_int as u8_0,
                          0x96 as libc::c_int as u8_0);
            EffectSsBlast_SpawnWhiteShockwave(globalCtx, &mut effSpawnPos,
                                              &mut effWhiteShockwaveDynamics,
                                              &mut effWhiteShockwaveDynamics);
            func_80033480(globalCtx, &mut effSpawnPos, 2.0f32,
                          3 as libc::c_int, 0x12c as libc::c_int as s16,
                          0xb4 as libc::c_int as s16,
                          1 as libc::c_int as u8_0);
            Camera_AddQuake(&mut (*globalCtx).mainCamera, 2 as libc::c_int,
                            0x19 as libc::c_int as s16, 5 as libc::c_int);
            func_800358DC(&mut (*this).actor, &mut effSpawnPos,
                          &mut (*this).actor.world.rot,
                          flamesParams.as_mut_ptr(), 20 as libc::c_int,
                          flamesUnused.as_mut_ptr(), globalCtx,
                          -(1 as libc::c_int) as s16, 0 as libc::c_int);
            EnMb_SetupClubWaitAfterAttack(this);
        }
    } else if (*this).timer3 as libc::c_int != 0 as libc::c_int &&
                  (*this).skelAnime.curFrame == 6.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38e2 as libc::c_int as u16_0);
    } else if (*this).timer3 as libc::c_int == 0 as libc::c_int &&
                  (*this).skelAnime.curFrame == 3.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38e1 as libc::c_int as u16_0);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearPatrolPrepareAndCharge(mut this: *mut EnMb,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut prevFrame: s32 = 0;
    let mut hasHitPlayer: s32 = 0 as libc::c_int;
    let mut endCharge: s32 =
        (Actor_TestFloorInDirection(&mut (*this).actor, globalCtx, 110.0f32,
                                    (*this).actor.world.rot.y) == 0) as
            libc::c_int;
    prevFrame = (*this).skelAnime.curFrame as s32;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Animation_PlayLoop(&mut (*this).skelAnime, &mut gEnMbSpearChargeAnim);
    ...
    if (*this).timer3 as libc::c_int != 0 as libc::c_int {
        ...
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           ...
                           0x1f40 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        endCharge = 0 as libc::c_int
    } else {
        (*this).actor.speedXZ = 10.0f32;
        (*this).attack = 1 as libc::c_int as s16;
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
    ...
    if (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint != 0 &&
        ...
        (*player).actor.world.pos.x =
            (*this).actor.world.pos.x +
                ...
                Math_SinS((*this).actor.shape.rot.y) * 89.0f32;
        hasHitPlayer = 1 as libc::c_int;
        (*player).actor.world.pos.z =
            (*this).actor.world.pos.z +
                Math_SinS((*this).actor.shape.rot.y) * 10.0f32 +
                Math_CosS((*this).actor.shape.rot.y) * 89.0f32;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearPatrolImmediateCharge(mut this: *mut EnMb,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if endCharge != 0 {
        if hasHitPlayer != 0 ||
            ...
            EnMb_SetupSpearPatrolEndCharge(this);
            (*this).timer3 = 1 as libc::c_int as s16
        } else { (*this).timer3 -= 1; EnMb_NextWaypoint(this, globalCtx); }
    }
    EnMb_FaceWaypoint(this, globalCtx);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).timer3 as libc::c_int == 0 as libc::c_int &&
           Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                             &mut (*this).actor.world.pos) < 80.0f32 {
        (*this).attack = 0 as libc::c_int as s16;
        EnMb_SetupSpearEndChargeQuick(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubDamaged(mut this: *mut EnMb,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer3 as libc::c_int != 0 as libc::c_int {
            Animation_PlayOnce(&mut (*this).skelAnime,
                               &mut gEnMbClubStandUpAnim);
            (*this).timer3 = 0 as libc::c_int as s16;
            func_800AA000((*this).actor.xzDistToPlayer,
                          0xff as libc::c_int as u8_0,
                          0x14 as libc::c_int as u8_0,
                          0x96 as libc::c_int as u8_0);
            Camera_AddQuake(&mut (*globalCtx).mainCamera, 2 as libc::c_int,
                            25 as libc::c_int as s16, 5 as libc::c_int);
        } else { EnMb_SetupClubWaitPlayerNear(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubDamagedWhileKneeling(mut this: *mut EnMb,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut pad: s32 = 0;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer3 as libc::c_int != 0 as libc::c_int {
            ...
            if (*this).timer3 as libc::c_int == 0 as libc::c_int {
                if (*this).timer1 as libc::c_int == 0 as libc::c_int {
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut gEnMbClubStandUpAnim, 3.0f32,
                                     0.0f32,
                                     Animation_GetLastFrame(&mut gEnMbClubStandUpAnim
                                                                as
                                                                *mut AnimationHeader
                                                                as
                                                                *mut libc::c_void)
                                         as f32_0,
                                     ANIMMODE_ONCE_INTERP as libc::c_int as
                                         u8_0, 0.0f32);
                    (*this).timer1 = 1 as libc::c_int as s16;
                    (*this).timer3 = 6 as libc::c_int as s16
                } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubDead(mut this: *mut EnMb,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut effPosBase: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    effPos = (*this).actor.world.pos;
    effPos.x += Math_SinS((*this).actor.shape.rot.y) * -70.0f32;
    effPos.z += Math_CosS((*this).actor.shape.rot.y) * -70.0f32;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    effPosBase = effPos;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer1 as libc::c_int > 0 as libc::c_int {
            let mut effZeroVec: Vec3f =
                {
            ...
            i = 4 as libc::c_int;
            while i >= 0 as libc::c_int {
                effPos.x = Rand_CenteredFloat(240.0f32) + effPosBase.x;
                effPos.y =
                    Rand_CenteredFloat(15.0f32) + (effPosBase.y + 20.0f32);
                effPos.z = Rand_CenteredFloat(240.0f32) + effPosBase.z;
                EffectSsDeadDb_Spawn(globalCtx, &mut effPos, &mut effZeroVec,
                                     &mut effZeroVec,
    ...
    } else if (*this).skelAnime.curFrame as s32 == 15 as libc::c_int ||
                  (*this).skelAnime.curFrame as s32 == 22 as libc::c_int {
        func_800AA000((*this).actor.xzDistToPlayer,
                      0xff as libc::c_int as u8_0,
                      0x14 as libc::c_int as u8_0,
                      0x96 as libc::c_int as u8_0);
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor, &mut effPos,
                                 50.0f32, 10 as libc::c_int, 3.0f32,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearGuardWalk(mut this: *mut EnMb,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut prevFrame: s32 = 0;
    let mut beforeCurFrame: s32 = 0;
    let mut pad1: s32 = 0;
    let mut pad2: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut relYawTowardsPlayer: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    let mut yawTowardsHome: s16 = 0;
    let mut playSpeedAbs: f32_0 = 0.;
    relYawTowardsPlayer =
        if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
            relYawTowardsPlayer as libc::c_int
        } else { -(relYawTowardsPlayer as libc::c_int) } as s16;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.59999996f32, 0.1f32,
                       1.0f32, 0.0f32);
    ...
    beforeCurFrame = ((*this).skelAnime.curFrame - playSpeedAbs) as s32;
    playSpeedAbs =
        if (*this).skelAnime.playSpeed >= 0 as libc::c_int as libc::c_float {
            (*this).skelAnime.playSpeed
        } else { -(*this).skelAnime.playSpeed };
    if (*this).timer3 as libc::c_int == 0 as libc::c_int &&
        ...
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           1 as libc::c_int as s16,
                           0x2ee as libc::c_int as s16,
                           0 as libc::c_int as s16);
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        if (*this).actor.xzDistToPlayer < 500.0f32 &&
               (relYawTowardsPlayer as libc::c_int) < 0x1388 as libc::c_int {
            EnMb_SetupSpearPrepareAndCharge(this);
        }
    } else {
        (*this).actor.flags &=
        ...
        if Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
            ...
            yawTowardsHome =
                Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                               &mut (*this).actor.home.pos);
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y, yawTowardsHome,
                               1 as libc::c_int as s16,
                               0x2ee as libc::c_int as s16,
                               0 as libc::c_int as s16);
        }
        ...
        if (*this).timer1 as libc::c_int == 0 as libc::c_int {
            if Rand_ZeroOne() > 0.7f32 {
                (*this).timer1 =
                    Rand_S16Offset(50 as libc::c_int as s16,
                                   70 as libc::c_int as s16);
                (*this).timer2 =
                    Rand_S16Offset(15 as libc::c_int as s16,
                                   40 as libc::c_int as s16)
            } else { EnMb_SetupSpearGuardLookAround(this); }
        }
    }
    if prevFrame != (*this).skelAnime.curFrame as s32 {
        if beforeCurFrame <= 1 as libc::c_int &&
               prevFrame + playSpeedAbs as s32 >= 1 as libc::c_int ||
               beforeCurFrame <= 20 as libc::c_int &&
                   prevFrame + playSpeedAbs as s32 >= 20 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearPatrolWalkTowardsWaypoint(mut this:
                                                                 *mut EnMb,
                                                             mut globalCtx:
                                                                 *mut GlobalContext) {
    let mut prevFrame: s32 = 0;
    let mut beforeCurFrame: s32 = 0;
    let mut relYawTowardsPlayer: s16 = 0;
    let mut yDistToPlayerAbs: f32_0 = 0.;
    let mut playSpeedABS: f32_0 = 0.;
    if Math_Vec3f_DistXZ(&mut (*this).waypointPos,
                         &mut (*this).actor.world.pos) <= 8.0f32 ||
           Rand_ZeroOne() < 0.1f32 &&
               Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                                 &mut (*this).actor.world.pos) <= 4.0f32 {
        EnMb_SetupSpearPatrolTurnTowardsWaypoint(this, globalCtx);
    } else {
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.59999996f32, 0.1f32,
                           1.0f32, 0.0f32);
        (*this).skelAnime.playSpeed = 2.0f32 * (*this).actor.speedXZ
    }
    (*this).yawToWaypoint =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                       &mut (*this).waypointPos);
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).yawToWaypoint,
                       1 as libc::c_int as s16, 0x5dc as libc::c_int as s16,
                       0 as libc::c_int as s16);
    yDistToPlayerAbs =
        if (*this).actor.yDistToPlayer >= 0.0f32 {
            (*this).actor.yDistToPlayer
        } else { -(*this).actor.yDistToPlayer };
    if yDistToPlayerAbs <= 20.0f32 &&
           EnMb_IsPlayerInCorridor(this, globalCtx) != 0 {
        relYawTowardsPlayer =
            ((*this).actor.shape.rot.y as libc::c_int -
                 (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
        if (if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
                relYawTowardsPlayer as libc::c_int
            } else { -(relYawTowardsPlayer as libc::c_int) }) <=
               0x4000 as libc::c_int ||
               func_8002DDE4(globalCtx) != 0 &&
                   (*this).actor.xzDistToPlayer < 160.0f32 {
            EnMb_FindWaypointTowardsPlayer(this, globalCtx);
    ...
    if (*this).timer2 as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38bb as libc::c_int as u16_0);
        (*this).timer2 =
            Rand_S16Offset(30 as libc::c_int as s16, 70 as libc::c_int as s16)
    }
    prevFrame = (*this).skelAnime.curFrame as s32;
    SkelAnime_Update(&mut (*this).skelAnime);
    playSpeedABS =
    ...
    if prevFrame != (*this).skelAnime.curFrame as s32 {
        if beforeCurFrame <= 1 as libc::c_int &&
               playSpeedABS as s32 + prevFrame >= 1 as libc::c_int ||
               beforeCurFrame <= 20 as libc::c_int &&
                   playSpeedABS as s32 + prevFrame >= 20 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38b8 as libc::c_int as u16_0);
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubWaitPlayerNear(mut this: *mut EnMb,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut pad: s32 = 0;
    let mut relYawFromPlayer: s16 =
        ((*this).actor.world.rot.y as libc::c_int -
             (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                         &mut (*player).actor.world.pos) <
           (*this).playerDetectionRange &&
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearDamaged(mut this: *mut EnMb) {
    let mut relYawTowardsPlayer: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if (if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
        ...
        Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                  &mut gEnMbSpearDamagedFromBehindAnim,
                                  -4.0f32);
        (*this).actor.speedXZ = 8.0f32
    }
    (*this).timer1 = 30 as libc::c_int as s16;
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x38be as libc::c_int as u16_0);
    EnMb_SetupAction(this,
                     Some(EnMb_SpearDamaged as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearDamaged(mut this: *mut EnMb,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.params as libc::c_int <=
               ENMB_TYPE_SPEAR_GUARD as libc::c_int {
            EnMb_SetupSpearGuardLookAround(this);
        } else { EnMb_SetupSpearPatrolImmediateCharge(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SetupSpearDead(mut this: *mut EnMb) {
    let mut relYawTowardsPlayer: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if (if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
           ...
           0x4000 as libc::c_int {
        Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                  &mut gEnMbSpearFallOnItsBackAnim, -4.0f32);
        (*this).actor.speedXZ = -8.0f32
    } else {
    ...
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    EnMb_SetupAction(this,
                     Some(EnMb_SpearDead as
                              unsafe extern "C" fn(_: *mut EnMb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearDead(mut this: *mut EnMb,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer1 as libc::c_int > 0 as libc::c_int {
            ...
            while i >= 0 as libc::c_int {
                effPos.x =
                    Rand_CenteredFloat(110.0f32) + (*this).actor.world.pos.x;
                effPos.y =
                    Rand_CenteredFloat(15.0f32) +
                        ((*this).actor.world.pos.y + 20.0f32);
                effPos.z =
                    Rand_CenteredFloat(110.0f32) + (*this).actor.world.pos.z;
                EffectSsDeadDb_Spawn(globalCtx, &mut effPos, &mut zeroVec,
                                     &mut zeroVec, 100 as libc::c_int as s16,
                                     7 as libc::c_int as s16,
                                     255 as libc::c_int as s16,
                                     255 as libc::c_int as s16,
                                     255 as libc::c_int as s16,
            ...
            Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                       ...
                                       0xe0 as libc::c_int as s16);
            Actor_Kill(&mut (*this).actor);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_SpearUpdateAttackCollider(mut thisx: *mut Actor,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut quadModel0: Vec3f =
        {
            let mut init = Vec3f{x: 1000.0f32, y: 1500.0f32, z: 0.0f32,};
            init
        };
    let mut quadModel1: Vec3f =
        {
            let mut init = Vec3f{x: -1000.0f32, y: 1500.0f32, z: 0.0f32,};
            init
        };
    let mut quadModel2: Vec3f =
        {
            let mut init = Vec3f{x: 1000.0f32, y: 1500.0f32, z: 4500.0f32,};
            init
        };
    let mut quadModel3: Vec3f =
        {
            let mut init = Vec3f{x: -1000.0f32, y: 1500.0f32, z: 4500.0f32,};
            init
        };
    let mut this: *mut EnMb = thisx as *mut EnMb;
    if (*this).actor.params as libc::c_int >=
           ENMB_TYPE_SPEAR_PATROL as libc::c_int {
        quadModel0.x += 2000.0f32;
        quadModel0.z = -4000.0f32;
        quadModel1.z = -4000.0f32;
        quadModel2.x += 2000.0f32;
        quadModel1.x -= 2000.0f32;
        quadModel3.x -= 2000.0f32;
        quadModel2.z += 4000.0f32;
        quadModel3.z += 4000.0f32
    }
    Matrix_MultVec3f(&mut quadModel0,
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(1
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut quadModel1,
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(0
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut quadModel2,
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(3
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut quadModel3,
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(2
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Collider_SetQuadVertices(&mut (*this).attackCollider,
                             &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(0
                                                                                           as
                                                                                           libc::c_int
                                                                                           as
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_ClubUpdateAttackCollider(mut thisx: *mut Actor,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    static mut quadModel: [Vec3f; 4] =
        [{ let mut init = Vec3f{x: 1000.0f32, y: 0.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: 1000.0f32, y: 0.0f32, z: 0.0f32,}; init },
         {
             let mut init =
                 Vec3f{x: 1000.0f32, y: -8000.0f32, z: -1500.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 1000.0f32, y: -9000.0f32, z: 2000.0f32,};
             init
         }];
    let mut this: *mut EnMb = thisx as *mut EnMb;
    Matrix_MultVec3f(&mut *quadModel.as_mut_ptr().offset(0 as libc::c_int as
                                                             isize),
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(1
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut *quadModel.as_mut_ptr().offset(1 as libc::c_int as
                                                             isize),
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(0
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut *quadModel.as_mut_ptr().offset(2 as libc::c_int as
                                                             isize),
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(3
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   isize));
    Matrix_MultVec3f(&mut *quadModel.as_mut_ptr().offset(3 as libc::c_int as
                                                             isize),
                     &mut *(*this).attackCollider.dim.quad.as_mut_ptr().offset(2
                                                                                   as
                                                                                   libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_CheckColliding(mut this: *mut EnMb,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).frontShielding.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).frontShielding.base.acFlags =
            ((*this).frontShielding.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int |
                       (1 as libc::c_int) << 7 as libc::c_int)) as u8_0;
        (*this).hitbox.base.acFlags =
            ((*this).hitbox.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
    } else if (*this).hitbox.base.acFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                  (*this).state as libc::c_uint >=
                      ENMB_STATE_STUNNED as libc::c_int as libc::c_uint {
        (*this).hitbox.base.acFlags =
            ((*this).hitbox.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint !=
                   ...
                   (*player).actor.parent == &mut (*this).actor as *mut Actor
               {
                ...
                (*player).actor.parent = 0 as *mut Actor;
                (*player).unk_850 = 200 as libc::c_int as s16;
                func_8002F71C(globalCtx, &mut (*this).actor, 6.0f32,
                              (*this).actor.world.rot.y, 6.0f32);
            }
            (*this).damageEffect = (*this).actor.colChkInfo.damageEffect;
            (*this).attack = 0 as libc::c_int as s16;
            Actor_SetDropFlag(&mut (*this).actor, &mut (*this).hitbox.info,
                              0 as libc::c_int);
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   ENMB_DMGEFF_STUN as libc::c_int ||
                   (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       ENMB_DMGEFF_STUN_ICE as libc::c_int {
                if (*this).state as libc::c_uint !=
                       ENMB_STATE_STUNNED as libc::c_int as libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn EnMb_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMb = thisx as *mut EnMb;
    let mut pad: s32 = 0;
    EnMb_CheckColliding(this, globalCtx);
    if (*thisx).colChkInfo.damageEffect as libc::c_int !=
           ENMB_DMGEFF_FREEZE as libc::c_int {
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        Actor_MoveForward(thisx);
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 40.0f32, 40.0f32, 70.0f32,
                                0x1d as libc::c_int);
        Actor_SetFocus(thisx, (*thisx).scale.x * 4500.0f32);
        Collider_UpdateCylinder(thisx, &mut (*this).hitbox);
        if (*thisx).colChkInfo.health as libc::c_int <= 0 as libc::c_int {
            (*this).hitbox.dim.pos.x =
                ((*this).hitbox.dim.pos.x as libc::c_float +
                     Math_SinS((*thisx).shape.rot.y) *
                         (-4400.0f32 * (*thisx).scale.y)) as s16;
            (*this).hitbox.dim.pos.z =
                ((*this).hitbox.dim.pos.z as libc::c_float +
                     Math_CosS((*thisx).shape.rot.y) *
                         (-4400.0f32 * (*thisx).scale.y)) as s16
        }
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).hitbox.base);
        if (*this).state as libc::c_uint >=
               ENMB_STATE_STUNNED as libc::c_int as libc::c_uint &&
               ((*thisx).params as libc::c_int ==
                    ENMB_TYPE_CLUB as libc::c_int ||
                    (*this).state as libc::c_uint !=
                        ENMB_STATE_ATTACK as libc::c_int as libc::c_uint) {
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).hitbox.base);
        }
        if (*this).state as libc::c_uint >=
               ENMB_STATE_IDLE as libc::c_int as libc::c_uint {
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).frontShielding.base);
        }
        if (*this).attack as libc::c_int > 0 as libc::c_int {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).attackCollider.base);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut unused: Vec3f =
        {
            let mut init = Vec3f{x: 1100.0f32, y: -700.0f32, z: 0.0f32,};
            init
        };
    static mut feetPos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut effSpawnPosModel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -8000.0f32, z: 0.0f32,}; init };
    static mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut bodyPart: s32 = -(1 as libc::c_int);
    let mut this: *mut EnMb = thisx as *mut EnMb;
    let mut bodyPartPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).actor.params as libc::c_int == ENMB_TYPE_CLUB as libc::c_int {
        if limbIndex == ENMB_LIMB_LHAND as libc::c_int {
            Matrix_MultVec3f(&mut effSpawnPosModel, &mut (*this).effSpawnPos);
            if (*this).attack as libc::c_int > 0 as libc::c_int {
                EnMb_ClubUpdateAttackCollider(&mut (*this).actor, globalCtx);
            }
        }
        Actor_SetFeetPos(&mut (*this).actor, limbIndex,
                         ENMB_LIMB_LFOOT as libc::c_int, &mut feetPos,
                         ENMB_LIMB_RFOOT as libc::c_int, &mut feetPos);
    }
    if (*this).iceEffectTimer as libc::c_int != 0 as libc::c_int {
        match limbIndex {
            7 => { bodyPart = 0 as libc::c_int }
            12 => { bodyPart = 1 as libc::c_int }
            17 => { bodyPart = 2 as libc::c_int }
            9 => { bodyPart = 3 as libc::c_int }
            14 => { bodyPart = 4 as libc::c_int }
            6 => { bodyPart = 5 as libc::c_int }
            20 => { bodyPart = 6 as libc::c_int }
            25 => { bodyPart = 7 as libc::c_int }
            22 => { bodyPart = 8 as libc::c_int }
            27 => { bodyPart = 9 as libc::c_int }
            _ => { }
        }
        if bodyPart >= 0 as libc::c_int {
            Matrix_MultVec3f(&mut zeroVec, &mut bodyPartPos);
            (*this).bodyPartsPos[bodyPart as usize].x = bodyPartPos.x as s16;
            (*this).bodyPartsPos[bodyPart as usize].y = bodyPartPos.y as s16;
            (*this).bodyPartsPos[bodyPart as usize].z = bodyPartPos.z as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMb_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut frontShieldingTriModel0: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: 4000.0f32, y: 7000.0f32, z: 3500.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 4000.0f32, y: 0.0f32, z: 3500.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -4000.0f32, y: 7000.0f32, z: 3500.0f32,};
    ...
    static mut frontShieldingTriModel1: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -4000.0f32, y: 7000.0f32, z: 3500.0f32,};
             init
         },
    ...
    let mut frontShieldingTri0: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut frontShieldingTri1: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut bodyPartIdx: s32 = 0;
    let mut this: *mut EnMb = thisx as *mut EnMb;
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          (*this).skelAnime.jointTable,
                          (*this).skelAnime.dListCount as s32, None,
                          Some(EnMb_PostLimbDraw as
    ...
    if (*thisx).params as libc::c_int != ENMB_TYPE_CLUB as libc::c_int {
        if (*this).attack as libc::c_int > 0 as libc::c_int {
            EnMb_SpearUpdateAttackCollider(thisx, globalCtx);
        }
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            Matrix_MultVec3f(&mut *frontShieldingTriModel0.as_mut_ptr().offset(i
                                                                                   as
                                                                                   isize),
                             &mut *frontShieldingTri0.as_mut_ptr().offset(i as
                                                                              isize));
            Matrix_MultVec3f(&mut *frontShieldingTriModel1.as_mut_ptr().offset(i
                                                                                   as
                                                                                   isize),
                             &mut *frontShieldingTri1.as_mut_ptr().offset(i as
                                                                              isize));
            i += 1
        }
        Collider_SetTrisVertices(&mut (*this).frontShielding,
                                 0 as libc::c_int,
                                 &mut *frontShieldingTri0.as_mut_ptr().offset(0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                                 &mut *frontShieldingTri0.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                                 &mut *frontShieldingTri0.as_mut_ptr().offset(2
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
        Collider_SetTrisVertices(&mut (*this).frontShielding,
                                 1 as libc::c_int,
                                 &mut *frontShieldingTri1.as_mut_ptr().offset(0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                                 &mut *frontShieldingTri1.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                                 &mut *frontShieldingTri1.as_mut_ptr().offset(2
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
    ...
    if (*this).iceEffectTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).iceEffectTimer as libc::c_int >= 0 as libc::c_int {
            (*this).iceEffectTimer -= 1
        }
        if (*this).iceEffectTimer as libc::c_int % 4 as libc::c_int ==
               0 as libc::c_int {
            scale = 2.5f32;
            if (*thisx).params as libc::c_int == ENMB_TYPE_CLUB as libc::c_int
               {
            ...
            bodyPartIdx =
                (*this).iceEffectTimer as libc::c_int >> 2 as libc::c_int;
            EffectSsEnIce_SpawnFlyingVec3s(globalCtx, thisx,
                                           &mut *(*this).bodyPartsPos.as_mut_ptr().offset(bodyPartIdx
                                                                                              as
                                                                                              isize),
                                           ...
                                           255 as libc::c_int as s16, scale);
        }
    };
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x4a as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_value(5300 as libc::c_int);
             init
         }]
}
#[used]
