...
extern "C" {
    ...
    fn __osSiRelAccess();
    #[no_mangle]
    fn __osContGetInitData(ctl_present_bitfield: *mut u8_0,
                           status: *mut OSContStatus);
    #[no_mangle]
    fn __osPackRequestData(poll: u8_0);
    #[no_mangle]
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn osContStartQuery(mut mq: *mut OSMesgQueue) -> s32 {
    let mut ret: s32 = 0 as libc::c_int;
    __osSiGetAccess();
    if __osContLastPoll as libc::c_int != 0 as libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn osContGetQuery(mut data: *mut OSContStatus) {
    let mut pattern: u8_0 = 0;
    __osContGetInitData(&mut pattern, data);
}
