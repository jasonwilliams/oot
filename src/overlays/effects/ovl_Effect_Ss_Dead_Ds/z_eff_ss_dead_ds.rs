...
#[no_mangle]
pub static mut Effect_Ss_Dead_Ds_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_DEAD_DS as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDeadDs_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDs_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsDeadDsInitParams =
        initParamsx as *mut EffectSsDeadDsInitParams;
    ...
    (*this).regs[11 as libc::c_int as usize] =
        ((*initParams).life / 2 as libc::c_int) as s16;
    (*this).regs[10 as libc::c_int as usize] =
        ((*initParams).alpha as libc::c_int /
             (*this).regs[11 as libc::c_int as usize] as libc::c_int) as s16;
    (*this).draw =
        Some(EffectSsDeadDs_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsDeadDs_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[0 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[5 as libc::c_int as usize] = (*initParams).alpha;
    (*this).regs[1 as libc::c_int as usize] = 0 as libc::c_int as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDs_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_eff_ss_dead_ds.c\x00" as *const u8 as
    ...
    if (*this).regs[1 as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int {
        let mut rpy: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
        let mut sp44: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        sp44.x = pos.x - (*this).velocity.x;
        sp44.y = pos.y - (*this).velocity.y;
        sp44.z = pos.z - (*this).velocity.z;
        if BgCheck_EntitySphVsWall1(&mut (*globalCtx).colCtx,
                                    &mut (*this).pos, &mut pos, &mut sp44,
                                    1.5f32, &mut floorPoly, 1.0f32) != 0 {
            func_80038A28(floorPoly, (*this).pos.x, (*this).pos.y,
                          (*this).pos.z, &mut mf);
            Matrix_Put(&mut mf);
        } else {
            pos.y += 1.;
            temp =
                BgCheck_EntityRaycastFloor1(&mut (*globalCtx).colCtx,
                                            &mut floorPoly, &mut pos);
            if !floorPoly.is_null() {
                func_80038A28(floorPoly, (*this).pos.x, temp + 1.5f32,
                              (*this).pos.z, &mut mf);
                Matrix_Put(&mut mf);
            } else {
        ...
        Matrix_MtxFToZYXRotS(&mut mf, &mut rpy, 0 as libc::c_int);
        (*this).regs[2 as libc::c_int as usize] = rpy.x;
        (*this).regs[3 as libc::c_int as usize] = rpy.y;
        (*this).regs[4 as libc::c_int as usize] = rpy.z;
        (*this).pos.y = mf.c2rust_unnamed.yw;
        (*this).regs[1 as libc::c_int as usize] += 1
    }
    Matrix_Translate((*this).pos.x, (*this).pos.y, (*this).pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateZYX((*this).regs[2 as libc::c_int as usize],
                     (*this).regs[3 as libc::c_int as usize],
                     (*this).regs[4 as libc::c_int as usize],
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateX(1.57f32, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gLensFlareCircleDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_eff_ss_dead_ds.c\x00" as *const u8 as
                         *const libc::c_char, 255 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDs_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
