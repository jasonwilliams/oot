...
extern "C" {
    ...
    #[no_mangle]
    static mut gTalonSitSleepingAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonStandAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonHeadSkinTex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gTalonSitHandsUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonSitWakeUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonRunAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonSleepAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonRunTransitionAnim: AnimationHeader;
    #[no_mangle]
    static mut gTalonWakeUpAnim: AnimationHeader;
}
...
pub struct EnTa {
    ...
    pub actionFunc: EnTaActionFunc,
    pub unk_260: EnTaUnkFunc,
    pub collider: ColliderCylinder,
    pub unk_2B0: EnTaUnkFunc,
    pub eyeIndex: s16,
    pub blinkTimer: s16,
    pub superCuccos: [*mut EnNiw; 3],
    pub unk_2C4: [s16; 3],
    pub unk_2CA: u8_0,
    pub unk_2CC: s16,
    pub unk_2CE: s16,
    ...
    pub unk_2E0: u16_0,
    pub unk_2E2: s16,
    pub currentAnimation: *mut AnimationHeader,
}
pub type EnTaUnkFunc = Option<unsafe extern "C" fn(_: *mut EnTa) -> ()>;
pub type EnTaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TA as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_TA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTa>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn func_80B13AA0(mut this: *mut EnTa,
                                       mut arg1: EnTaActionFunc,
                                       mut arg2: EnTaUnkFunc) {
    (*this).actionFunc = arg1;
    (*this).unk_260 = arg2;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B13AAC(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut faceReaction: u16_0 =
        Text_GetFaceReaction(globalCtx, 24 as libc::c_int as u32_0);
    if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
        ...
        if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
            ...
            if gSaveContext.itemGetInf[0 as libc::c_int as usize] as
                ...
                (*this).actor.textId = 0x2088 as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x2086 as libc::c_int as u16_0 }
        } else { (*this).actor.textId = 0x2085 as libc::c_int as u16_0 }
    ...
    } else if faceReaction as libc::c_int == 0 as libc::c_int {
        if gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
               0x4000 as libc::c_int != 0 {
            if gSaveContext.itemGetInf[0 as libc::c_int as usize] as
                   libc::c_int & 4 as libc::c_int != 0 {
                (*this).actor.textId = 0x208b as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x207f as libc::c_int as u16_0 }
        } else { (*this).actor.textId = 0x207e as libc::c_int as u16_0 }
    } else { (*this).actor.textId = faceReaction };
}
#[no_mangle]
pub unsafe extern "C" fn EnTa_Init(mut thisx: *mut Actor,
                                   mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnTa = thisx as *mut EnTa;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 36.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gTalonSkel,
                       &mut gTalonStandAnim, (*this).jointTable.as_mut_ptr(),
    ...
    match (*this).actor.params as libc::c_int {
        1 => {
            ...
            if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                ...
                Actor_Kill(&mut (*this).actor);
            } else if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                          libc::c_int & 0x400 as libc::c_int != 0 {
                func_80B13AA0(this,
                              Some(func_80B14CAC as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
                              Some(func_80B167C0 as
                                       unsafe extern "C" fn(_: *mut EnTa)
                                           -> ()));
                (*this).eyeIndex = 0 as libc::c_int as s16;
                Animation_PlayOnce(&mut (*this).skelAnime,
                                   &mut gTalonStandAnim);
                (*this).currentAnimation = &mut gTalonStandAnim
            } else {
                func_80B13AA0(this,
                              Some(func_80B14754 as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
                              Some(func_80B167FC as
                                       unsafe extern "C" fn(_: *mut EnTa)
                                           -> ()));
                (*this).eyeIndex = 2 as libc::c_int as s16;
                Animation_PlayOnce(&mut (*this).skelAnime,
                                   &mut gTalonSleepAnim);
                (*this).currentAnimation = &mut gTalonSleepAnim;
                (*this).actor.shape.shadowScale = 54.0f32
            }
        }
        2 => {
            osSyncPrintf(b"\x1b[36m \xe5\x87\xba\xe6\x88\xbb\xe3\x82\x8a\xe3\x82\xbf\xe3\x83\xad\xe3\x83\xb3 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                   libc::c_int & 0x800 as libc::c_int == 0 {
                Actor_Kill(&mut (*this).actor);
                ...
                Actor_Kill(&mut (*this).actor);
                osSyncPrintf(b"\x1b[36m \xe5\xa4\x9c\xe3\x81\xaf\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
            } else {
                func_80B13AA0(this,
                              Some(func_80B14D98 as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
        ...
        _ => {
            osSyncPrintf(b"\x1b[36m \xe3\x81\x9d\xe3\x81\xae\xe4\xbb\x96\xe3\x81\xae\xe3\x82\xbf\xe3\x83\xad\xe3\x83\xb3 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            if (*globalCtx).sceneNum as libc::c_int ==
                ...
                if gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                    ...
                    Actor_Kill(&mut (*this).actor);
                } else if gSaveContext.eventChkInf[1 as libc::c_int as usize]
                              as libc::c_int & 0x8 as libc::c_int != 0 {
                    func_80B13AA0(this,
                                  Some(func_80B14C18 as
                                           unsafe extern "C" fn(_: *mut EnTa,
                                                                _:
                                                                    *mut GlobalContext)
                                               -> ()),
                ...
                osSyncPrintf(b"\x1b[36m \xe3\x83\xad\xe3\x83\xb3\xe3\x83\xad\xe3\x83\xb3\xe7\x89\xa7\xe5\xa0\xb4\xe3\x81\xae\xe5\x80\x89\xe5\xba\xab \xe3\x81\xae \xe3\x82\xbf\xe3\x83\xad\xe3\x83\xb3\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
                if gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                       libc::c_int & 0x10 as libc::c_int == 0 {
                    Actor_Kill(&mut (*this).actor);
                    ...
                    (*this).actor.flags |=
                        ((1 as libc::c_int) << 4 as libc::c_int) as
                            libc::c_uint;
                    (*this).unk_2C4[2 as libc::c_int as usize] =
                        7 as libc::c_int as s16;
                    (*this).unk_2C4[1 as libc::c_int as usize] =
                        (*this).unk_2C4[2 as libc::c_int as usize];
                    (*this).unk_2C4[0 as libc::c_int as usize] =
                        (*this).unk_2C4[1 as libc::c_int as usize];
                    (*this).superCuccos[0 as libc::c_int as usize] =
                        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                    ACTOR_EN_NIW as libc::c_int as s16,
                                    (*this).actor.world.pos.x + 5.0f32,
                                    (*this).actor.world.pos.y + 3.0f32,
                                    (*this).actor.world.pos.z + 26.0f32,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0xd as libc::c_int as s16) as *mut EnNiw;
                    (*this).superCuccos[1 as libc::c_int as usize] =
                        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                    ACTOR_EN_NIW as libc::c_int as s16,
                                    (*this).actor.world.pos.x - 20.0f32,
                                    (*this).actor.world.pos.y + 40.0f32,
                                    (*this).actor.world.pos.z - 30.0f32,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0xd as libc::c_int as s16) as *mut EnNiw;
                    (*this).superCuccos[2 as libc::c_int as usize] =
                        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                    ACTOR_EN_NIW as libc::c_int as s16,
                                    (*this).actor.world.pos.x + 20.0f32,
                                    (*this).actor.world.pos.y + 40.0f32,
                    ...
                    if gSaveContext.eventInf[0 as libc::c_int as usize] as
                           libc::c_int & 0x400 as libc::c_int != 0 {
                        func_80B13AA0(this,
                                      Some(func_80B16608 as
                                               unsafe extern "C" fn(_:
                                                                        *mut EnTa,
                                                                    _:
                                                                        *mut GlobalContext)
                                                   -> ()),
                                      Some(func_80B16938 as
                                               unsafe extern "C" fn(_:
                                                                        *mut EnTa)
                                                   -> ()));
                        Animation_Change(&mut (*this).skelAnime,
                                         &mut gTalonSitWakeUpAnim, 1.0f32,
                                         Animation_GetLastFrame(&mut gTalonSitWakeUpAnim
                                                                    as
                                                                    *mut AnimationHeader
                                                                    as
                                                                    *mut libc::c_void)
                        ...
                        gSaveContext.eventInf[0 as libc::c_int as usize] =
                            (gSaveContext.eventInf[0 as libc::c_int as usize]
                                 as libc::c_int & !(0x400 as libc::c_int)) as
                                u16_0
                    } else {
                        func_80B13AA0(this,
                                      Some(func_80B16504 as
                                               unsafe extern "C" fn(_:
                                                                        *mut EnTa,
                                                                    _:
                                                                        *mut GlobalContext)
                                                   -> ()),
                                      Some(func_80B16854 as
                                               unsafe extern "C" fn(_:
                                                                        *mut EnTa)
                                                   -> ()));
                        (*this).eyeIndex = 0 as libc::c_int as s16;
                        Animation_PlayOnce(&mut (*this).skelAnime,
                                           &mut gTalonSitSleepingAnim);
                        (*this).currentAnimation = &mut gTalonSitSleepingAnim
                    }
                } else {
                    func_80B13AA0(this,
                                  Some(func_80B146F8 as
                                           unsafe extern "C" fn(_: *mut EnTa,
                                                                _:
                                                                    *mut GlobalContext)
                                               -> ()),
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14248(mut this: *mut EnTa) {
    if (*this).actor.shape.shadowScale > 36.0f32 {
        (*this).actor.shape.shadowScale -= 0.8f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTa_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTa = thisx as *mut EnTa;
    ...
    if (*this).actor.params as libc::c_int != 1 as libc::c_int &&
           ...
           (*globalCtx).sceneNum as libc::c_int == SCENE_SOUKO as libc::c_int
       {
        gSaveContext.timer1State = 0 as libc::c_int as s16
    }
    if (*this).unk_2E0 as libc::c_int & 0x200 as libc::c_int != 0 {
        func_800F5B58();
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B142F4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext,
    ...
    if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
            ...
            -(((*this).actor.yawTowardsPlayer as libc::c_int -
                   (*this).actor.shape.rot.y as libc::c_int) as s16 as
                  libc::c_int)
        }) <= 0x4300 as libc::c_int && (*this).actor.xzDistToPlayer < 100.0f32
       {
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int | 1 as libc::c_int) as u16_0;
        func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14398(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B143D4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B13AA0(this,
                      Some(func_80B146F8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14410(mut this: *mut EnTa) {
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        func_80B13AA0(this,
                      ...
                      Some(func_80B167C0 as
                               unsafe extern "C" fn(_: *mut EnTa) -> ()));
        gSaveContext.eventChkInf[1 as libc::c_int as usize] =
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1448C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B14410(this);
    }
    func_80B14248(this);
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 0x4 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B144D8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B14410(this);
        (*this).blinkTimer = 1 as libc::c_int as s16;
        (*this).unk_2B0 =
            Some(func_80B16700 as unsafe extern "C" fn(_: *mut EnTa) -> ())
    }
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_DONE as libc::c_int {
        (*this).eyeIndex = 1 as libc::c_int as s16;
        func_80B13AA0(this,
                      Some(func_80B1448C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
    ...
    func_80B14248(this);
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 4 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14570(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 4 as libc::c_int) as u16_0;
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        func_80B13AA0(this,
                      Some(func_80B144D8 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
                               unsafe extern "C" fn(_: *mut EnTa) -> ()));
        (*this).unk_2CE = 3 as libc::c_int as s16;
        (*this).unk_2CC = 60 as libc::c_int as s16;
        Animation_PlayOnce(&mut (*this).skelAnime, &mut gTalonWakeUpAnim);
        (*this).currentAnimation = &mut gTalonStandAnim;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x6851 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B145F8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B13AA0(this,
                      Some(func_80B14634 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14634(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        let mut exchangeItemId: s32 = func_8002F368(globalCtx) as s32;
        match exchangeItemId {
            3 => {
                (*player).actor.textId = 0x702b as libc::c_int as u16_0;
                func_80B13AA0(this,
                              Some(func_80B14570 as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
                              Some(func_80B167C0 as
                                       unsafe extern "C" fn(_: *mut EnTa)
                                           -> ()));
                (*this).unk_2CC = 40 as libc::c_int as s16
            }
            _ => {
                if exchangeItemId != EXCH_ITEM_NONE as libc::c_int {
                    (*player).actor.textId = 0x702a as libc::c_int as u16_0
                }
                func_80B13AA0(this,
                              Some(func_80B145F8 as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
        ...
        (*this).actor.textId = 0x702a as libc::c_int as u16_0;
        func_8002F298(&mut (*this).actor, globalCtx, 100.0f32,
                      3 as libc::c_int as u32_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B146F8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        func_80B13AA0(this,
                      Some(func_80B143D4 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167FC as
    ...
    (*this).actor.textId = 0x204b as libc::c_int as u16_0;
    func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14754(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        match exchangeItemId {
            ...
            _ => {
                if exchangeItemId != EXCH_ITEM_NONE as libc::c_int {
                    (*player).actor.textId = 0x5015 as libc::c_int as u16_0
                }
                func_80B13AA0(this,
                              Some(func_80B14398 as
                                       unsafe extern "C" fn(_: *mut EnTa,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()),
        ...
        (*this).actor.textId = 0x5015 as libc::c_int as u16_0;
        func_8002F298(&mut (*this).actor, globalCtx, 100.0f32,
                      6 as libc::c_int as u32_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14818(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut framesMod12: s32 =
        (*globalCtx).state.frames as s32 % 12 as libc::c_int;
    if framesMod12 == 0 as libc::c_int || framesMod12 == 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x800 as libc::c_int as u16_0);
    }
    if (*this).actor.speedXZ < 6.0f32 { (*this).actor.speedXZ += 0.4f32 }
    Actor_MoveForward(&mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14898(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 50.0f32,
                  2 as libc::c_int, 250 as libc::c_int as s16,
                  20 as libc::c_int as s16, 1 as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1490C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int + 0xc00 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0xc00 as libc::c_int) as
            s16;
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        func_80B13AA0(this,
                      Some(func_80B14898 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1496C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 50.0f32,
                  2 as libc::c_int, 250 as libc::c_int as s16,
                  20 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    ...
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        func_80B13AA0(this,
                      Some(func_80B1490C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
                               unsafe extern "C" fn(_: *mut EnTa) -> ()));
        (*this).unk_2CC = 5 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B149F4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int - 0xd00 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int - 0xd00 as libc::c_int) as
            s16;
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        func_80B13AA0(this,
                      Some(func_80B1496C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
                               unsafe extern "C" fn(_: *mut EnTa) -> ()));
        (*this).unk_2CC = 65 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14A54(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 50.0f32,
                  2 as libc::c_int, 250 as libc::c_int as s16,
                  20 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    func_80B14818(this, globalCtx);
    if (*this).unk_2CC as libc::c_int == 20 as libc::c_int {
        Message_CloseTextbox(globalCtx);
    }
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        (*this).unk_2CC = 5 as libc::c_int as s16;
        func_80B13AA0(this,
                      Some(func_80B149F4 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14AF4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int - 0xc00 as libc::c_int) as
            s16;
    ...
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x6853 as libc::c_int as u16_0);
        func_80B13AA0(this,
                      Some(func_80B14A54 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14B6C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int {
        OnePointCutscene_Init(globalCtx, 4175 as libc::c_int as s16,
                              -(99 as libc::c_int) as s16, &mut (*this).actor,
                              0 as libc::c_int as s16);
        func_80B13AA0(this,
                      Some(func_80B14AF4 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
        ...
        Animation_PlayOnce(&mut (*this).skelAnime,
                           &mut gTalonRunTransitionAnim);
        (*this).currentAnimation = &mut gTalonRunAnim
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14C18(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80B142F4(this, globalCtx, 0x702c as libc::c_int as u16_0) != 0 {
        func_80B13AA0(this,
                      Some(func_80B14B6C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14C60(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B13AA0(this,
                      Some(func_80B14CAC as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14CAC(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x100 as libc::c_int != 0 {
        if func_80B142F4(this, globalCtx, 0x5017 as libc::c_int as u16_0) != 0
           {
            func_80B13AA0(this,
                          Some(func_80B14C60 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
                                       -> ()),
                          Some(func_80B167C0 as
    ...
    } else if func_80B142F4(this, globalCtx, 0x5016 as libc::c_int as u16_0)
                  != 0 {
        func_80B13AA0(this,
                      Some(func_80B14C60 as
                               unsafe extern "C" fn(_: *mut EnTa,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14D4C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B13AA0(this,
                      Some(func_80B14D98 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14D98(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80B142F4(this, globalCtx, 0x2055 as libc::c_int as u16_0) != 0 {
        func_80B13AA0(this,
                      Some(func_80B14D4C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B167C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14DD8() -> s32 {
    if (gSaveContext.rupees as libc::c_int) < 30 as libc::c_int {
        return 0 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14E28(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut b: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut a: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).unk_2D0 = Gameplay_CreateSubCamera(globalCtx);
    (*this).unk_2D2 = (*globalCtx).activeCamera;
    Gameplay_ChangeCameraStatus(globalCtx, (*this).unk_2D2,
                                1 as libc::c_int as s16);
    Gameplay_ChangeCameraStatus(globalCtx, (*this).unk_2D0,
                                7 as libc::c_int as s16);
    b.x = 1053.0f32;
    b.y = 11.0f32;
    b.z = 22.0f32;
    ...
    a.y = 45.0f32;
    a.z = -40.0f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).unk_2D0, &mut a, &mut b);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B14EDC(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    Gameplay_ChangeCameraStatus(globalCtx, (*this).unk_2D2,
                                7 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14F20(mut this: *mut EnTa,
                                       mut arg1: EnTaActionFunc) {
    func_80B13AA0(this, arg1,
                  Some(func_80B16854 as
                           unsafe extern "C" fn(_: *mut EnTa) -> ()));
    (*this).eyeIndex = 2 as libc::c_int as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gTalonSitSleepingAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gTalonSitSleepingAnim as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B14FAC(mut this: *mut EnTa,
                                       mut arg1: EnTaActionFunc) {
    (*this).eyeIndex = 1 as libc::c_int as s16;
    func_80B13AA0(this, arg1,
                  Some(func_80B16938 as
                           unsafe extern "C" fn(_: *mut EnTa) -> ()));
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int & !(0x10 as libc::c_int)) as u16_0;
    Animation_Change(&mut (*this).skelAnime, &mut gTalonSitWakeUpAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gTalonSitWakeUpAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -5.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15034(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80B150AC(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext,
                                       mut idx: s32) -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut interactRangeActor: *mut Actor = 0 as *mut Actor;
    if (*player).stateFlags1 & 0x800 as libc::c_int as libc::c_uint != 0 {
        interactRangeActor = (*player).interactRangeActor;
        if !interactRangeActor.is_null() &&
               (*interactRangeActor).id as libc::c_int ==
                   ACTOR_EN_NIW as libc::c_int &&
               interactRangeActor ==
                   &mut (**(*this).superCuccos.as_mut_ptr().offset(idx as
                                                                       isize)).actor
                       as *mut Actor {
            return 1 as libc::c_int
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15100(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        let mut unk_2CA: s32 = 0;
        Animation_Change(&mut (*this).skelAnime, &mut gTalonSitWakeUpAnim,
                         1.0f32,
                         Animation_GetLastFrame(&mut gTalonSitWakeUpAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                         ...
                         10.0f32);
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int & !(0x10 as libc::c_int)) as
                u16_0;
        Message_CloseTextbox(globalCtx);
        unk_2CA = (*this).unk_2CA as s32;
        (*this).actionFunc =
            Some(func_80B154FC as
                     unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext)
                         -> ());
        (*(*this).superCuccos[unk_2CA as usize]).actor.gravity = 0.1f32;
        (*(*this).superCuccos[unk_2CA as usize]).actor.velocity.y = 0.0f32;
        (*(*this).superCuccos[unk_2CA as usize]).actor.speedXZ = 0.0f32;
        (*(*this).superCuccos[unk_2CA as usize]).actor.parent =
            0 as *mut Actor;
        if (*player).interactRangeActor ==
               &mut (**(*this).superCuccos.as_mut_ptr().offset(unk_2CA as
                                                                   isize)).actor
                   as *mut Actor {
            (*player).interactRangeActor = 0 as *mut Actor
        }
        if (*player).heldActor ==
               &mut (**(*this).superCuccos.as_mut_ptr().offset(unk_2CA as
                                                                   isize)).actor
                   as *mut Actor {
            (*player).heldActor = 0 as *mut Actor
        }
        (*player).stateFlags1 &= !(0x800 as libc::c_int) as libc::c_uint;
        (*this).superCuccos[unk_2CA as usize] = 0 as *mut EnNiw
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15260(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80B15100 as
                     unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext)
                         -> ());
        (*this).actor.flags &=
...
#[no_mangle]
pub unsafe extern "C" fn EnTa_GetSuperCuccosCount(mut this: *mut EnTa,
                                                  mut globalCtx:
                                                      *mut GlobalContext)
 -> s32 {
    let mut count: s32 = 0;
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[*mut EnNiw; 3]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut EnNiw>()
                                                   as libc::c_ulong) as s32 {
        if !(*this).superCuccos[i as usize].is_null() { count += 1 }
        i += 1
    }
    return count;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15308(mut this: *mut EnTa) {
    if (*this).unk_2E0 as libc::c_int & 0x10 as libc::c_int != 0 {
        if (*this).unk_2E0 as libc::c_int & 0x100 as libc::c_int != 0 {
            Animation_Change(&mut (*this).skelAnime,
                             &mut gTalonSitHandsUpAnim, 1.0f32, 17.0f32,
                             22.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                             0.0f32);
            (*this).unk_2E0 =
                ((*this).unk_2E0 as libc::c_int & !(0x100 as libc::c_int)) as
                    u16_0
        } else {
            Animation_Change(&mut (*this).skelAnime,
                             &mut gTalonSitHandsUpAnim, -1.0f32, 21.0f32,
                             16.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                             3.0f32);
            (*this).unk_2E0 =
                ((*this).unk_2E0 as libc::c_int | 0x100 as libc::c_int) as
                    u16_0
...
#[no_mangle]
pub unsafe extern "C" fn func_80B153D4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B15308(this);
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int {
        if (*this).unk_2E0 as libc::c_int & 0x80 as libc::c_int != 0 {
            (*this).unk_2E0 =
                ((*this).unk_2E0 as libc::c_int & !(0x80 as libc::c_int)) as
                    u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15424(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B15308(this);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        (*globalCtx).nextEntranceIndex = 0x5e4 as libc::c_int as s16;
        if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
               0x100 as libc::c_int != 0 {
            (*globalCtx).fadeTransition = 46 as libc::c_int as u8_0;
        ...
        (*this).actionFunc =
            Some(func_80B153D4 as
                     unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext)
                         -> ());
        (*this).unk_2CC = 22 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B154FC(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[*mut EnNiw; 3]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut EnNiw>()
                                                   as libc::c_ulong) as s32 {
        if !(*this).superCuccos[i as usize].is_null() {
            if (*(*this).superCuccos[i as usize]).actor.gravity > -2.0f32 {
                (*(*this).superCuccos[i as usize]).actor.gravity -= 0.03f32
            }
            if func_80B150AC(this, globalCtx, i) != 0 {
                if (*this).unk_2C4[i as usize] as libc::c_int >
                       0 as libc::c_int {
                    (*this).unk_2C4[i as usize] -= 1
                } else {
                    (*this).unk_2CA = i as u8_0;
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut gTalonSitHandsUpAnim, 1.0f32,
                                     8.0f32, 29.0f32,
                                     ANIMMODE_ONCE as libc::c_int as u8_0,
                                     -10.0f32);
                    (*this).unk_2E0 =
                        ((*this).unk_2E0 as libc::c_int &
                             !(0x10 as libc::c_int)) as u16_0;
                    match EnTa_GetSuperCuccosCount(this, globalCtx) {
                        1 => {
                            ...
                            Message_StartTextbox(globalCtx,
                                                 0x2084 as libc::c_int as
                                                     u16_0,
                                                 &mut (*this).actor);
                            (*this).actionFunc =
                                Some(func_80B15424 as
                                         unsafe extern "C" fn(_: *mut EnTa,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ());
                            Animation_Change(&mut (*this).skelAnime,
                                             &mut gTalonSitHandsUpAnim,
                                             1.0f32, 8.0f32, 29.0f32,
                            ...
                            gSaveContext.eventInf[0 as libc::c_int as usize] =
                                (gSaveContext.eventInf[0 as libc::c_int as
                                                           usize] as
                                     libc::c_int | 0x100 as libc::c_int) as
                                    u16_0;
                            Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as
                                                    libc::c_int) <<
                                                   24 as libc::c_int |
                                                   0x100000ff as libc::c_int)
                                                  as u32_0);
                            (*this).unk_2E0 =
                                ((*this).unk_2E0 as libc::c_int &
                                     !(0x200 as libc::c_int)) as u16_0;
                            Audio_PlayFanfare(0x39 as libc::c_int as u16_0);
                            return
                        }
                        2 => {
                            (*this).actor.textId =
                                0x2083 as libc::c_int as u16_0;
                            Audio_PlayActorSound2(&mut (*this).actor,
                                                  0x6853 as libc::c_int as
                                                      u16_0);
                        }
                        3 => {
                            (*this).actor.textId =
                                0x2082 as libc::c_int as u16_0;
                            Audio_PlayActorSound2(&mut (*this).actor,
                                                  0x6851 as libc::c_int as
                                                      u16_0);
                        }
                        _ => { }
                    }
                    (*this).actionFunc =
                        Some(func_80B15260 as
                                 unsafe extern "C" fn(_: *mut EnTa,
                                                      _: *mut GlobalContext)
                                     -> ());
                    (*this).actor.flags |=
                        ((1 as libc::c_int) << 16 as libc::c_int) as
                            libc::c_uint;
                    func_8002F2CC(&mut (*this).actor, globalCtx, 1000.0f32);
                    return
                }
            } else { (*this).unk_2C4[i as usize] = 7 as libc::c_int as s16 }
        }
        i += 1
    }
    if gSaveContext.timer1Value as libc::c_int == 10 as libc::c_int {
        func_800F5918();
    }
    if gSaveContext.timer1Value as libc::c_int == 0 as libc::c_int &&
           Gameplay_InCsMode(globalCtx) == 0 {
        Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                               24 as libc::c_int | 0x100000ff as libc::c_int)
                              as u32_0);
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int & !(0x200 as libc::c_int)) as
                u16_0;
        func_80078884(0x482c as libc::c_int as u16_0);
        gSaveContext.timer1State = 0 as libc::c_int as s16;
        func_8002DF54(globalCtx, &mut (*this).actor,
                      1 as libc::c_int as u8_0);
        Message_StartTextbox(globalCtx, 0x2081 as libc::c_int as u16_0,
                             &mut (*this).actor);
        (*this).actionFunc =
            Some(func_80B15424 as
                     unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext)
        ...
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0x100 as libc::c_int)) as u16_0;
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int | 0x80 as libc::c_int) as u16_0;
        Animation_Change(&mut (*this).skelAnime, &mut gTalonSitHandsUpAnim,
                         1.0f32, 8.0f32, 29.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1585C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*this).unk_2CC as libc::c_int > 35 as libc::c_int {
        i = 1 as libc::c_int;
        while i <
                  (::std::mem::size_of::<[*mut EnNiw; 3]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut EnNiw>()
                      ...
                      s32 {
            if !(*this).superCuccos[i as usize].is_null() {
                Math_SmoothStepToS(&mut (**(*this).superCuccos.as_mut_ptr().offset(i
                                                                                       as
                                                                                       isize)).actor.world.rot.y,
                                   (i * -(10000 as libc::c_int) -
                                        3000 as libc::c_int) as s16,
                                   2 as libc::c_int as s16,
                                   0x800 as libc::c_int as s16,
                                   0x100 as libc::c_int as s16);
                (*(*this).superCuccos[i as usize]).actor.shape.rot.y =
                    (*(*this).superCuccos[i as usize]).actor.world.rot.y
            }
            i += 1
        }
    } else if (*this).unk_2CC as libc::c_int == 35 as libc::c_int {
        i = 0 as libc::c_int;
        while i <
                  (::std::mem::size_of::<[*mut EnNiw; 3]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut EnNiw>()
                                                       as libc::c_ulong) as
                      s32 {
            (*this).unk_2C4[i as usize] =
                (Rand_CenteredFloat(6.0f32) + 10.0f32) as s32 as s16;
            if !(*this).superCuccos[i as usize].is_null() {
                let mut niw: *mut EnNiw = (*this).superCuccos[i as usize];
                (*niw).unk_308 = 1 as libc::c_int as u8_0;
                (*niw).actor.gravity = 0.0f32
            }
            i += 1
        }
    } else {
        ...
        while i <
                  (::std::mem::size_of::<[*mut EnNiw; 3]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut EnNiw>()
                                                       as libc::c_ulong) as
                      s32 {
            if ((*this).unk_2CC as libc::c_int) <
                   35 as libc::c_int -
                       (*this).unk_2C4[i as usize] as libc::c_int {
                if !(*this).superCuccos[i as usize].is_null() {
                    if (*(*this).superCuccos[i as usize]).actor.gravity >
                           -2.0f32 {
                        (*(*this).superCuccos[i as usize]).actor.gravity -=
                            0.03f32
                    }
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15AD4(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_2CC as libc::c_int == 0 as libc::c_int &&
           (*this).unk_2E0 as libc::c_int & 0x20 as libc::c_int != 0 {
        func_80B13AA0(this,
                      Some(func_80B1585C as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B16938 as
        ...
        Animation_Change(&mut (*this).skelAnime, &mut gTalonSitHandsUpAnim,
                         1.0f32, 1.0f32,
                         Animation_GetLastFrame(&mut gTalonSitHandsUpAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         0.0f32);
        (*this).unk_2CC = 50 as libc::c_int as s16;
        func_80088B34(0x1e as libc::c_int as s16);
        func_800F5ACC(0x6c as libc::c_int as u16_0);
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int | 0x200 as libc::c_int) as u16_0;
        Message_CloseTextbox(globalCtx);
        func_8002DF54(globalCtx, &mut (*this).actor,
                      1 as libc::c_int as u8_0);
    }
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int | 0x20 as libc::c_int) as u16_0
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15BF8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_2E0 as libc::c_int & 0x10 as libc::c_int != 0 {
        func_80B13AA0(this,
                      Some(func_80B15AD4 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B16938 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15CC8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_2E0 as libc::c_int & 0x10 as libc::c_int != 0 {
        func_80B13AA0(this,
                      Some(func_80B15BF8 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B16938 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15D90(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B13AA0(this,
                  Some(func_80B15CC8 as
                           unsafe extern "C" fn(_: *mut EnTa,
                                                _: *mut GlobalContext) -> ()),
                  Some(func_80B16938 as
                           unsafe extern "C" fn(_: *mut EnTa) -> ()));
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gTalonSitHandsUpAnim,
                     1.0f32, 8.0f32, 29.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    Message_ContinueTextbox(globalCtx, 0x2080 as libc::c_int as u16_0);
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int & !(0x20 as libc::c_int)) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15E28(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80B14F20(this,
                      Some(func_80B16504 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15E80(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).actionFunc =
            Some(func_80B15E28 as
                     unsafe extern "C" fn(_: *mut EnTa, _: *mut GlobalContext)
                         -> ());
        if (*this).unk_2E0 as libc::c_int & 0x2 as libc::c_int == 0 {
        ...
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int & !(0x2 as libc::c_int)) as u16_0
    } else if (*this).unk_2E0 as libc::c_int & 2 as libc::c_int != 0 {
        func_8002F434(&mut (*this).actor, globalCtx, GI_MILK as libc::c_int,
                      10000.0f32, 50.0f32);
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_MILK_BOTTLE as libc::c_int, 10000.0f32, 50.0f32);
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B15F54(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B15FE8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
                        ...
                        func_80B13AA0(this,
                                      ...
                                      Some(func_80B16938 as
                                               unsafe extern "C" fn(_:
                                                                        *mut EnTa)
                                                   -> ()));
                        Rupees_ChangeBy(-(30 as libc::c_int) as s16);
                        func_8002F434(&mut (*this).actor, globalCtx,
                                      GI_MILK as libc::c_int, 10000.0f32,
                                      50.0f32);
                    }
                    _ => { }
                }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B161C0(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut price: s32 = 0;
    if (*this).actor.textId as libc::c_int == 0x2085 as libc::c_int {
        price = 5 as libc::c_int
    } else { price = 10 as libc::c_int }
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                if (gSaveContext.rupees as libc::c_int) < price {
                    Message_ContinueTextbox(globalCtx,
                                            0x85 as libc::c_int as u16_0);
                    func_80B13AA0(this,
                                  Some(func_80B15034 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B162E8(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x2087 as libc::c_int as u16_0);
        func_80B13AA0(this,
                      Some(func_80B15F54 as
                               unsafe extern "C" fn(_: *mut EnTa,
                                                    _: *mut GlobalContext)
                                   -> ()),
                      Some(func_80B16938 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B16364(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        gSaveContext.infTable[7 as libc::c_int as usize] =
            (gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int |
                 0x4000 as libc::c_int) as u16_0;
        if gSaveContext.itemGetInf[0 as libc::c_int as usize] as libc::c_int &
               4 as libc::c_int != 0 {
            Message_ContinueTextbox(globalCtx,
                                    0x208b as libc::c_int as u16_0);
            func_80B13AA0(this,
                          Some(func_80B15FE8 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
                                       -> ()),
                          Some(func_80B16938 as
            ...
            Message_ContinueTextbox(globalCtx,
                                    0x207f as libc::c_int as u16_0);
            func_80B13AA0(this,
                          Some(func_80B161C0 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
                                       -> ()),
                          Some(func_80B16938 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1642C(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if Inventory_HasEmptyBottle() != 0 {
            Message_CloseTextbox(globalCtx);
            (*this).unk_2E0 =
                ((*this).unk_2E0 as libc::c_int | 2 as libc::c_int) as u16_0;
            func_80B13AA0(this,
                          Some(func_80B15E80 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
                          ...
                          Some(func_80B16938 as
                                   unsafe extern "C" fn(_: *mut EnTa) -> ()));
            func_8002F434(&mut (*this).actor, globalCtx,
                          GI_MILK as libc::c_int, 10000.0f32, 50.0f32);
        } else {
            Message_ContinueTextbox(globalCtx,
                                    0x208a as libc::c_int as u16_0);
            func_80B13AA0(this,
                          Some(func_80B15E28 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80B16504(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut faceReaction: u16_0 =
        Text_GetFaceReaction(globalCtx, 0x18 as libc::c_int as u32_0);
    func_80B13AAC(this, globalCtx);
    if func_80B142F4(this, globalCtx, (*this).actor.textId) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x6851 as libc::c_int as u16_0);
        if faceReaction as libc::c_int != 0 as libc::c_int {
            func_80B14FAC(this,
                          Some(func_80B15E28 as
                                   unsafe extern "C" fn(_: *mut EnTa,
                                                        _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80B16608(mut this: *mut EnTa,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        match (*this).actor.textId as libc::c_int {
            8325 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B166CC(mut this: *mut EnTa) {
    let mut temp_v0: s16 =
...
#[no_mangle]
pub unsafe extern "C" fn func_80B16700(mut this: *mut EnTa) {
    let mut blinkTimer: s16 =
        ((*this).blinkTimer as libc::c_int - 1 as libc::c_int) as s16;
    if blinkTimer as libc::c_int != 0 as libc::c_int {
        (*this).blinkTimer = blinkTimer
    } else {
        let mut nextEyeIndex: s16 =
            ((*this).eyeIndex as libc::c_int + 1 as libc::c_int) as s16;
        let mut blinkTimer_0: s16 = 3 as libc::c_int as s16;
        if nextEyeIndex as libc::c_int >= blinkTimer_0 as libc::c_int {
            (*this).eyeIndex = 0 as libc::c_int as s16;
            if (*this).unk_2CE as libc::c_int > 0 as libc::c_int {
                (*this).unk_2CE -= 1;
                blinkTimer_0 = 1 as libc::c_int as s16
            } else {
                blinkTimer_0 =
                    ((Rand_ZeroOne() * 60.0f32) as s32 + 20 as libc::c_int) as
                        s16
            }
            (*this).blinkTimer = blinkTimer_0;
            (*this).unk_2B0 =
                Some(func_80B166CC as
                         unsafe extern "C" fn(_: *mut EnTa) -> ())
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B167C0(mut this: *mut EnTa) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Animation_PlayOnce(&mut (*this).skelAnime, (*this).currentAnimation);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B167FC(mut this: *mut EnTa) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Animation_PlayOnce(&mut (*this).skelAnime, (*this).currentAnimation);
        Audio_PlayActorSound2(&mut (*this).actor,
    ...
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 0xc as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B16854(mut this: *mut EnTa) {
    if (*this).unk_2E2 as libc::c_int > 0 as libc::c_int {
        ...
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
            ...
            (*this).unk_2E2 = (Rand_ZeroFloat(100.0f32) + 100.0f32) as s16
        }
        if (*this).skelAnime.curFrame < 96.0f32 &&
               (*this).skelAnime.curFrame >= 53.0f32 {
            (*this).eyeIndex = 1 as libc::c_int as s16
        } else { (*this).eyeIndex = 2 as libc::c_int as s16 }
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int | 8 as libc::c_int) as u16_0
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int | 4 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B16938(mut this: *mut EnTa) {
    if (*this).unk_2E0 as libc::c_int & 0x10 as libc::c_int == 0 {
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
            (*this).unk_2E0 =
                ((*this).unk_2E0 as libc::c_int | 0x10 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn EnTa_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTa = thisx as *mut EnTa;
    let mut pad: s32 = 0;
    ...
    (*this).unk_260.expect("non-null function pointer")(this);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).unk_2E0 as libc::c_int & 4 as libc::c_int == 0 {
        (*this).unk_2B0.expect("non-null function pointer")(this);
    }
    if (*this).unk_2E0 as libc::c_int & 1 as libc::c_int != 0 {
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_2D4,
                      &mut (*this).unk_2DA, (*this).actor.focus.pos);
    } else {
        Math_SmoothStepToS(&mut (*this).unk_2D4.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2D4.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2DA.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2DA.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
    }
    (*this).unk_2E0 =
        ((*this).unk_2E0 as libc::c_int & !(0x5 as libc::c_int)) as u16_0;
    if (*this).unk_2CC as libc::c_int > 0 as libc::c_int {
        (*this).unk_2CC -= 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTa_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    match limbIndex {
        8 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_2DA.y as libc::c_int)
                    as s16;
            (*rot).y =
                ((*rot).y as libc::c_int - (*this).unk_2DA.x as libc::c_int)
                    as s16
        }
        15 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_2D4.y as libc::c_int)
                    as s16;
            (*rot).z =
                ((*rot).z as libc::c_int + (*this).unk_2D4.x as libc::c_int)
                    as s16
        }
        _ => { }
    }
    if (*this).unk_2E0 as libc::c_int & 0x8 as libc::c_int != 0 {
        (*this).unk_2E0 =
            ((*this).unk_2E0 as libc::c_int & !(0x8 as libc::c_int)) as u16_0
    } else if limbIndex == 8 as libc::c_int || limbIndex == 10 as libc::c_int
                  || limbIndex == 13 as libc::c_int {
        let mut limbIdx50: s32 = limbIndex * 50 as libc::c_int;
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*globalCtx).state.frames.wrapping_mul((limbIdx50 +
                                                                       0x814
                                                                           as
                                                                           libc::c_int)
                                                                      as
        ...
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*globalCtx).state.frames.wrapping_mul((limbIdx50 +
                                                                       0x940
                                                                           as
                                                                           libc::c_int)
                                                                      as
...
#[no_mangle]
pub unsafe extern "C" fn EnTa_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut D_80B16E7C: Vec3f =
        {
            let mut init = Vec3f{x: 1100.0f32, y: 1000.0f32, z: 0.0f32,};
            init
        };
    let mut this: *mut EnTa = thisx as *mut EnTa;
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut D_80B16E7C, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTa_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gTalonEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gTalonEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gTalonEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnTa = thisx as *mut EnTa;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ta.c\x00" as *const u8 as *const libc::c_char,
                    2381 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((eyeTextures[(*this).eyeIndex as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(eyeTextures[(*this).eyeIndex as
                                                          usize] as u32_0 &
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((gTalonHeadSkinTex.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gTalonHeadSkinTex.as_mut_ptr() as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
