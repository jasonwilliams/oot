...
pub struct ItemInbox {
    pub actor: Actor,
    pub actionFunc: ItemInboxActionFunc,
}
pub type ItemInboxActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ItemInbox, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Item_Inbox_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ITEM_INBOX as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemInbox_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemInbox_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ItemInbox_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemInbox = thisx as *mut ItemInbox;
    (*this).actionFunc =
        Some(ItemInbox_Wait as
                 unsafe extern "C" fn(_: *mut ItemInbox,
                                      _: *mut GlobalContext) -> ());
    Actor_SetScale(&mut (*this).actor, 0.2f64 as f32_0);
}
#[no_mangle]
pub unsafe extern "C" fn ItemInbox_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ItemInbox_Wait(mut this: *mut ItemInbox,
                                        mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ItemInbox_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemInbox = thisx as *mut ItemInbox;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn ItemInbox_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemInbox = thisx as *mut ItemInbox;
