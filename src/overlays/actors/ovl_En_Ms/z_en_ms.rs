...
extern "C" {
    ...
    #[no_mangle]
    static mut gBeanSalesmanEatingAnim: AnimationHeader;
    #[no_mangle]
    static mut gBeanSalesmanSkel: FlexSkeletonHeader;
}
...
pub struct EnMs {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 9],
    pub morphTable: [Vec3s; 9],
    pub actionFunc: EnMsActionFunc,
    pub collider: ColliderCylinder,
    pub activeTimer: s16,
}
pub type EnMsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMs, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ms_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MS as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_MS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMs>() as libc::c_ulong,
                          init:
...
static mut sPrices: [s16; 10] =
    [10 as libc::c_int as s16, 20 as libc::c_int as s16,
     30 as libc::c_int as s16, 40 as libc::c_int as s16,
     50 as libc::c_int as s16, 60 as libc::c_int as s16,
     70 as libc::c_int as s16, 80 as libc::c_int as s16,
     90 as libc::c_int as s16, 100 as libc::c_int as s16];
static mut sOfferTextIDs: [u16_0; 10] =
    [0x405e as libc::c_int as u16_0, 0x405f as libc::c_int as u16_0,
     0x4060 as libc::c_int as u16_0, 0x4061 as libc::c_int as u16_0,
     0x4062 as libc::c_int as u16_0, 0x4063 as libc::c_int as u16_0,
     0x4064 as libc::c_int as u16_0, 0x4065 as libc::c_int as u16_0,
     0x4066 as libc::c_int as u16_0, 0x4067 as libc::c_int as u16_0];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 2] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 2];
#[no_mangle]
pub unsafe extern "C" fn EnMs_SetOfferText(mut this: *mut EnMs,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).actor.textId =
        Text_GetFaceReaction(globalCtx, 0x1b as libc::c_int as u32_0);
    if (*this).actor.textId as libc::c_int == 0 as libc::c_int {
        if gSaveContext.inventory.ammo[gItemSlots[(ITEM_BEAN as libc::c_int +
                                                       1 as libc::c_int) as
                                                      usize] as usize] as
               libc::c_int >= 10 as libc::c_int {
            (*this).actor.textId = 0x406b as libc::c_int as u16_0
        } else {
            (*this).actor.textId =
                sOfferTextIDs[gSaveContext.inventory.ammo[gItemSlots[(ITEM_BEAN
                                                                          as
                                                                          libc::c_int
                                                                          +
                                                                          1 as
...
#[no_mangle]
pub unsafe extern "C" fn EnMs_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMs = thisx as *mut EnMs;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gBeanSalesmanSkel, &mut gBeanSalesmanEatingAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 9 as libc::c_int);
    ...
    (*this).actionFunc =
        Some(EnMs_Wait as
                 unsafe extern "C" fn(_: *mut EnMs, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnMs_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMs = thisx as *mut EnMs;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnMs_Wait(mut this: *mut EnMs,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        // talk range
        func_8002F2CC(&mut (*this).actor, globalCtx, 90.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMs_Talk(mut this: *mut EnMs,
                                   mut globalCtx: *mut GlobalContext) {
    let mut dialogState: u8_0 = 0;
    dialogState = Message_GetState(&mut (*globalCtx).msgCtx);
    if dialogState as libc::c_int != TEXT_STATE_CHOICE as libc::c_int {
        if dialogState as libc::c_int == TEXT_STATE_DONE as libc::c_int &&
               Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
            // advanced final textbox
            (*this).actionFunc =
                Some(EnMs_Wait as
                         unsafe extern "C" fn(_: *mut EnMs,
                                              _: *mut GlobalContext) -> ())
        }
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if (gSaveContext.rupees as libc::c_int) <
                       sPrices[gSaveContext.inventory.ammo[gItemSlots[(ITEM_BEAN
                                                                           as
                                                                           libc::c_int
                                                                           +
                                                                           1
                    ...
                    Message_ContinueTextbox(globalCtx,
                                            0x4069 as libc::c_int as
                                                u16_0); // not enough rupees text
                    return
                }
                func_8002F434(&mut (*this).actor, globalCtx,
                              GI_BEAN as libc::c_int, 90.0f32, 10.0f32);
                (*this).actionFunc =
                    Some(EnMs_Sell as
                             unsafe extern "C" fn(_: *mut EnMs,
                                                  _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnMs_Sell(mut this: *mut EnMs,
                                   mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        Rupees_ChangeBy(-(sPrices[gSaveContext.inventory.ammo[gItemSlots[(ITEM_BEAN
                                                                              as
                                                                              libc::c_int
                                                                              +
                                                                              1
        ...
        (*this).actionFunc =
            Some(EnMs_TalkAfterPurchase as
                     unsafe extern "C" fn(_: *mut EnMs, _: *mut GlobalContext)
                         -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx, GI_BEAN as libc::c_int,
                      90.0f32, 10.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMs_TalkAfterPurchase(mut this: *mut EnMs,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x406c as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnMs_Talk as
                     unsafe extern "C" fn(_: *mut EnMs, _: *mut GlobalContext)
                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnMs_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMs = thisx as *mut EnMs;
    let mut pad: s32 = 0;
    (*this).activeTimer =
        ((*this).activeTimer as libc::c_int + 1 as libc::c_int) as s16;
    Actor_SetFocus(&mut (*this).actor, 20.0f32);
    (*this).actor.targetArrowOffset = 500.0f32;
    Actor_SetScale(&mut (*this).actor, 0.015f32);
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if gSaveContext.entranceIndex == 0x157 as libc::c_int &&
           gSaveContext.sceneSetupIndex == 8 as libc::c_int {
        // ride carpet if in credits
        Actor_MoveForward(&mut (*this).actor);
        osSyncPrintf(b"OOOHHHHHH %f\n\x00" as *const u8 as
                         *const libc::c_char,
                     (*this).actor.velocity.y as libc::c_double);
...
#[no_mangle]
pub unsafe extern "C" fn EnMs_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMs = thisx as *mut EnMs;
