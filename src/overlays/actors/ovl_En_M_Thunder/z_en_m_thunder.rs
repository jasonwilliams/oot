...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    fn func_800F4254(pos: *mut Vec3f, arg1: u8_0);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gSpinAttack1DL: [Gfx; 0];
    #[no_mangle]
    static mut gSpinAttack2DL: [Gfx; 0];
    #[no_mangle]
    static mut gSpinAttack3DL: [Gfx; 0];
    #[no_mangle]
    static mut gSpinAttack4DL: [Gfx; 0];
    #[no_mangle]
    static mut gSpinAttackChargingDL: [Gfx; 0];
}
...
pub struct EnMThunder {
    ...
    pub unk_1B8: f32_0,
    pub unk_1BC: f32_0,
    pub actionFunc: EnMThunderActionFunc,
    pub unk_1C4: u16_0,
    pub unk_1C6: u8_0,
    pub unk_1C7: u8_0,
    pub unk_1C8: u8_0,
...
pub type EnMThunderActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMThunder, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_M_Thunder_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_M_THUNDER as libc::c_int as s16,
                          category:
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnMThunder_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnMThunder_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnMThunder_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnMThunder_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80AA0420: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80AA044C: [u32_0; 3] =
    [0x1000000 as libc::c_int as u32_0, 0x400000 as libc::c_int as u32_0,
     0x800000 as libc::c_int as u32_0];
static mut D_80AA0458: [u32_0; 3] =
    [0x8000000 as libc::c_int as u32_0, 0x2000000 as libc::c_int as u32_0,
     0x4000000 as libc::c_int as u32_0];
static mut sSfxIds: [u16_0; 4] =
    [0x182f as libc::c_int as u16_0, 0x182e as libc::c_int as u16_0,
     0x182f as libc::c_int as u16_0, 0x182e as libc::c_int as u16_0];
// Setup action
#[no_mangle]
pub unsafe extern "C" fn func_80A9EFE0(mut this: *mut EnMThunder,
                                       mut actionFunc: EnMThunderActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnMThunder_Init(mut thisx: *mut Actor,
                                         mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnMThunder = thisx as *mut EnMThunder;
    ...
    (*this).lightNode =
        LightContext_InsertLight(globalCtx, &mut (*globalCtx).lightCtx,
                                 &mut (*this).lightInfo);
    (*this).collider.dim.radius = 0 as libc::c_int as s16;
    (*this).collider.dim.height = 40 as libc::c_int as s16;
    (*this).collider.dim.yShift = -(20 as libc::c_int) as s16;
    (*this).unk_1C4 = 8 as libc::c_int as u16_0;
    (*this).unk_1B4 = 0.0f32;
    (*this).actor.world.pos =
        (*player).bodyPartsPos[0 as libc::c_int as usize];
    (*this).unk_1AC = 0.0f32;
    (*this).unk_1BC = 0.0f32;
    ...
    (*this).unk_1CA = 0 as libc::c_int as u8_0;
    if (*player).stateFlags2 & 0x20000 as libc::c_int as libc::c_uint != 0 {
        if gSaveContext.magicAcquired == 0 ||
               gSaveContext.unk_13F0 as libc::c_int != 0 ||
            ...
            Audio_PlaySoundGeneral(0x1823 as libc::c_int as u16_0,
                                   &mut (*player).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
            Audio_PlaySoundGeneral(0x1818 as libc::c_int as u16_0,
                                   &mut (*player).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
        ...
        (*player).stateFlags2 &= !(0x20000 as libc::c_int) as libc::c_uint;
        (*this).unk_1CA = 1 as libc::c_int as u8_0;
        (*this).collider.info.toucher.dmgFlags =
            D_80AA044C[(*this).unk_1C7 as usize];
        (*this).unk_1C6 = 1 as libc::c_int as u8_0;
        (*this).unk_1C9 =
            if (*this).unk_1C7 as libc::c_int == 1 as libc::c_int {
                2 as libc::c_int
            } else { 4 as libc::c_int } as u8_0;
        func_80A9EFE0(this,
                      Some(func_80A9F9B4 as
                               unsafe extern "C" fn(_: *mut EnMThunder,
                                                    _: *mut GlobalContext)
                                   -> ()));
        (*this).unk_1C4 = 8 as libc::c_int as u16_0;
        Audio_PlaySoundGeneral(0x182e as libc::c_int as u16_0,
                               &mut (*player).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
        (*this).unk_1AC = 1.0f32
...
#[no_mangle]
pub unsafe extern "C" fn EnMThunder_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnMThunder = thisx as *mut EnMThunder;
    ...
    func_80A9F314(globalCtx, 0.0f32);
    LightContext_RemoveLight(globalCtx, &mut (*globalCtx).lightCtx,
                             (*this).lightNode);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9F314(mut globalCtx: *mut GlobalContext,
                                       mut arg1: f32_0) {
    Environment_AdjustLights(globalCtx, arg1, 850.0f32, 0.2f32, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9F350(mut this: *mut EnMThunder,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*player).stateFlags2 & 0x20000 as libc::c_int as libc::c_uint != 0 {
        if (*player).swordAnimation as libc::c_int >= 0x18 as libc::c_int {
            Audio_PlaySoundGeneral(0x1823 as libc::c_int as u16_0,
                                   &mut (*player).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
    ...
    if (*player).stateFlags1 & 0x1000 as libc::c_int as libc::c_uint == 0 {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9F408(mut this: *mut EnMThunder,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    (*this).actor.shape.rot.y =
        ((*player).actor.shape.rot.y as libc::c_int + 0x8000 as libc::c_int)
            as s16;
    if (*this).unk_1CA as libc::c_int == 0 as libc::c_int {
        if (*player).unk_858 >= 0.1f32 {
            if gSaveContext.unk_13F0 as libc::c_int != 0 ||
                   ((*this).actor.params as libc::c_int &
                        0xff00 as libc::c_int) >> 8 as libc::c_int != 0 &&
                       func_80087708(globalCtx,
                                     (((*this).actor.params as libc::c_int &
                                           0xff00 as libc::c_int) >>
                                          8 as libc::c_int) as s16,
                ...
                func_80A9EFE0(this,
                              Some(func_80A9F350 as
                                       unsafe extern "C" fn(_:
                                                                *mut EnMThunder,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
                (*this).unk_1C8 = 0 as libc::c_int as u8_0;
                (*this).unk_1BC = 0.0f64 as f32_0;
                (*this).unk_1AC = 0.0f32;
                return
            }
            (*this).unk_1CA = 1 as libc::c_int as u8_0
    ...
    if (*player).unk_858 >= 0.1f32 {
        func_800AA000(0.0f32,
                      (((*player).unk_858 * 150.0f32) as s32 &
    ...
    if (*player).stateFlags2 & 0x20000 as libc::c_int as libc::c_uint != 0 {
        if !child.is_null() && (*child).update.is_some() {
            (*child).parent = 0 as *mut Actor
        }
        if (*player).unk_858 <= 0.15f32 {
            if (*player).unk_858 >= 0.1f32 &&
            ...
            if (*player).unk_858 < 0.85f32 {
                ...
                (*this).collider.info.toucher.dmgFlags =
                    D_80AA0458[(*this).unk_1C7 as usize];
                (*this).unk_1C6 = 0 as libc::c_int as u8_0;
                (*this).unk_1C9 =
                    if (*this).unk_1C7 as libc::c_int == 1 as libc::c_int {
                        4 as libc::c_int
                    } else { 8 as libc::c_int } as u8_0
            }
            func_80A9EFE0(this,
                          Some(func_80A9F9B4 as
                                   unsafe extern "C" fn(_: *mut EnMThunder,
                                       ...
                                       -> ()));
            (*this).unk_1C4 = 8 as libc::c_int as u16_0;
            Audio_PlaySoundGeneral(sSfxIds[(*this).unk_1C6 as usize],
                                   &mut (*player).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
            (*this).unk_1AC = 1.0f32;
    ...
    if (*player).unk_858 > 0.15f32 {
        (*this).unk_1C8 = 255 as libc::c_int as u8_0;
        if (*this).actor.child.is_null() {
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               ...
                               (*this).actor.shape.rot.y,
                               0 as libc::c_int as s16,
                               ((*this).unk_1C7 as libc::c_int +
                                    2 as libc::c_int) as s16);
        }
        (*this).unk_1BC +=
            (((*player).unk_858 - 0.15f32) * 1.5f32 - (*this).unk_1BC) *
                0.5f32
    } else if (*player).unk_858 > 0.1f32 {
        (*this).unk_1C8 =
            (((*player).unk_858 - 0.1f32) * 255.0f32 * 20.0f32) as s32 as
                u8_0;
        (*this).unk_1AC = ((*player).unk_858 - 0.1f32) * 10.0f32
    } else { (*this).unk_1C8 = 0 as libc::c_int as u8_0 }
    if (*player).unk_858 > 0.85f32 {
        func_800F4254(&mut (*player).actor.projectedPos,
                      2 as libc::c_int as u8_0);
    } else if (*player).unk_858 > 0.15f32 {
        func_800F4254(&mut (*player).actor.projectedPos,
                      1 as libc::c_int as u8_0);
    } else if (*player).unk_858 > 0.1f32 {
        func_800F4254(&mut (*player).actor.projectedPos,
    ...
    if Gameplay_InCsMode(globalCtx) != 0 { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9F938(mut this: *mut EnMThunder,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).unk_1C4 as libc::c_int) < 2 as libc::c_int {
        if ((*this).unk_1C8 as libc::c_int) < 40 as libc::c_int {
            (*this).unk_1C8 = 0 as libc::c_int as u8_0
        } else {
            (*this).unk_1C8 =
                ((*this).unk_1C8 as libc::c_int - 40 as libc::c_int) as u8_0
        }
    }
    (*this).unk_1B4 += 2.0f32 * (*this).unk_1B0;
    if (*this).unk_1BC < (*this).unk_1AC {
        (*this).unk_1BC += ((*this).unk_1AC - (*this).unk_1BC) * 0.1f32
    } else { (*this).unk_1BC = (*this).unk_1AC };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9F9B4(mut this: *mut EnMThunder,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Math_StepToF(&mut (*this).unk_1AC, 0.0f32,
                    1 as libc::c_int as libc::c_float / 16.0f32) != 0 {
        Actor_Kill(&mut (*this).actor);
    } else {
        Math_SmoothStepToF(&mut (*this).actor.scale.x,
                           (*this).unk_1C9 as s32 as f32_0, 0.6f32, 0.8f32,
                           0.0f32);
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
        (*this).collider.dim.radius =
            ((*this).actor.scale.x * 25.0f32) as s16;
    ...
    if (*this).unk_1C4 as libc::c_int > 0 as libc::c_int {
        (*this).actor.world.pos.x =
            (*player).bodyPartsPos[0 as libc::c_int as usize].x;
        (*this).actor.world.pos.z =
            (*player).bodyPartsPos[0 as libc::c_int as usize].z;
        (*this).unk_1C4 = (*this).unk_1C4.wrapping_sub(1)
    }
    if (*this).unk_1AC > 0.6f32 {
        (*this).unk_1B0 = 1.0f32
    } else { (*this).unk_1B0 = (*this).unk_1AC * (5.0f32 / 3.0f32) }
    func_80A9F938(this, globalCtx);
    if Gameplay_InCsMode(globalCtx) != 0 { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn EnMThunder_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnMThunder = thisx as *mut EnMThunder;
    let mut blueRadius: f32_0 = 0.;
    let mut redGreen: s32 = 0;
    ...
    redGreen =
        ((blueRadius * 255.0f32) as u32_0 &
             0xff as libc::c_int as libc::c_uint) as s32;
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).actor.world.pos.x as s16,
                              (*this).actor.world.pos.y as s16,
                              (*this).actor.world.pos.z as s16,
                              redGreen as u8_0, redGreen as u8_0,
                              (blueRadius * 100.0f32) as u32_0 as u8_0,
                              (blueRadius * 800.0f32) as s32 as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnMThunder_Draw(mut thisx: *mut Actor,
                                         mut globalCtx2: *mut GlobalContext) {
    static mut D_80AA046C: [f32_0; 8] =
        [0.1f32, 0.15f32, 0.2f32, 0.25f32, 0.3f32, 0.25f32, 0.2f32, 0.15f32];
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnMThunder = thisx as *mut EnMThunder;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_m_thunder.c\x00" as *const u8 as
    ...
    match (*this).unk_1C6 as libc::c_int {
        0 | 1 => {
                ...
                (255 as libc::c_int as u32_0 &
                    ...
                    (170 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (((*this).unk_1B0 * 255 as libc::c_int as libc::c_float)
                         as u8_0 as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_2).words.w1 = gSpinAttack3DL.as_mut_ptr() as libc::c_uint;
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = gSpinAttack4DL.as_mut_ptr() as libc::c_uint
        }
        1 => {
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_5).words.w1 = gSpinAttack1DL.as_mut_ptr() as libc::c_uint;
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_6).words.w1 = gSpinAttack2DL.as_mut_ptr() as libc::c_uint
        }
        _ => { }
    }
    Matrix_Mult(&mut (*player).mf_9E0, MTXMODE_NEW as libc::c_int as u8_0);
    match (*this).unk_1C7 as libc::c_int {
        1 => {
            Matrix_Translate(0.0f32, 220.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(-0.7f32, -0.6f32, -0.4f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateX(16384.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        }
        0 => {
            Matrix_Translate(0.0f32, 300.0f32, -100.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(-1.2f32, -1.0f32, -0.7f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateX(16384.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        }
        2 => {
            Matrix_Translate(200.0f32, 350.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(-1.8f32, -1.4f32, -0.7f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateX(16384.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        }
        _ => { }
    }
    if (*this).unk_1B8 >= 0.85f32 {
        phi_f14 =
            D_80AA046C[((*globalCtx).gameplayFrames &
                            7 as libc::c_int as libc::c_uint) as usize] *
                6.0f32 + 1.0f32;
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (128 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        phi_t1 = 0x14 as libc::c_int
    }
    Matrix_Scale(1.0f32, phi_f14, phi_f14,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_12).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).gameplayFrames.wrapping_mul(20 as
                                                                      ...
                                                                      libc::c_uint)
                             & 0xff as libc::c_int as libc::c_uint,
                         (*globalCtx).gameplayFrames.wrapping_mul(phi_t1 as
                                                                      libc::c_uint)
                             & 0xff as libc::c_int as libc::c_uint,
    ...
    (*_g_13).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_13).words.w1 = gSpinAttackChargingDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_m_thunder.c\x00" as *const u8 as
                         *const libc::c_char, 1031 as libc::c_int);
}
