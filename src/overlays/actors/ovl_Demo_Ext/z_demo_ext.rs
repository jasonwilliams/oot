...
pub struct DemoExt {
    ...
    pub scrollIncr: [s16; 4],
    pub curScroll: [s16; 4],
    pub rotationPitch: s16,
    pub alphaTimer: f32_0,
    pub primAlpha: s32,
    pub envAlpha: s32,
    pub scale: Vec3f,
}
pub type DemoExtActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoExt, _: *mut GlobalContext)
               -> ()>;
pub type DemoExtDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const EXT_DISPELL: C2RustUnnamed_19 = 2;
pub const EXT_MAINTAIN: C2RustUnnamed_19 = 1;
pub const EXT_WAIT: C2RustUnnamed_19 = 0;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const EXT_DRAW_VORTEX: C2RustUnnamed_20 = 1;
pub const EXT_DRAW_NOTHING: C2RustUnnamed_20 = 0;
#[no_mangle]
pub unsafe extern "C" fn DemoExt_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoExt = thisx as *mut DemoExt;
    (*this).scrollIncr[0 as libc::c_int as usize] = 25 as libc::c_int as s16;
    (*this).scrollIncr[1 as libc::c_int as usize] = 40 as libc::c_int as s16;
    (*this).scrollIncr[2 as libc::c_int as usize] = 5 as libc::c_int as s16;
    (*this).scrollIncr[3 as libc::c_int as usize] = 30 as libc::c_int as s16;
    (*this).primAlpha =
        (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 28 as libc::c_int) as
                              usize] as libc::c_int + 255 as libc::c_int;
    (*this).envAlpha =
        (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_PlayVortexSFX(mut this: *mut DemoExt) {
    if (*this).alphaTimer <=
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 35 as libc::c_int) as
                                 usize] as libc::c_int as libc::c_float +
               40.0f32 - 15.0f32 {
        Audio_PlaySoundGeneral((0x2840 as libc::c_int - 0x800 as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_GetNpcAction(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut npcActionIndex: s32)
 -> *mut CsCmdActorAction {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        return (*globalCtx).csCtx.npcActions[npcActionIndex as usize]
    }
    return 0 as *mut CsCmdActorAction;
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_SetupWait(mut this: *mut DemoExt) {
    (*this).action = EXT_WAIT as libc::c_int;
    (*this).drawMode = EXT_DRAW_NOTHING as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_SetupMaintainVortex(mut this: *mut DemoExt,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        DemoExt_GetNpcAction(globalCtx, 5 as libc::c_int);
    ...
    (*this).action = EXT_MAINTAIN as libc::c_int;
    (*this).drawMode = EXT_DRAW_VORTEX as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_SetupDispellVortex(mut this: *mut DemoExt) {
    (*this).action = EXT_DISPELL as libc::c_int;
    (*this).drawMode = EXT_DRAW_VORTEX as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_FinishClosing(mut this: *mut DemoExt) {
    (*this).alphaTimer += 1.0f32;
    if (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                              16 as libc::c_int + 35 as libc::c_int) as usize]
           as libc::c_int as libc::c_float + 40.0f32 <= (*this).alphaTimer {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_CheckCsMode(mut this: *mut DemoExt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if !csCmdNPCAction.is_null() {
        ...
        if csAction != previousCsAction {
            match csAction {
                1 => { DemoExt_SetupWait(this); }
                2 => { DemoExt_SetupMaintainVortex(this, globalCtx); }
                3 => { DemoExt_SetupDispellVortex(this); }
                _ => {
                    // "Demo_Ext_Check_DemoMode: there is no such action!"
                    osSyncPrintf(b"Demo_Ext_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_SetScrollAndRotation(mut this:
                                                          *mut DemoExt) {
    let mut scrollIncr: *mut s16 = (*this).scrollIncr.as_mut_ptr();
    let mut curScroll: *mut s16 = (*this).curScroll.as_mut_ptr();
    let mut i: s32 = 0;
    i = 3 as libc::c_int;
    while i != 0 as libc::c_int {
        let ref mut fresh0 = *curScroll.offset(i as isize);
        *fresh0 =
            (*fresh0 as libc::c_int +
                 *scrollIncr.offset(i as isize) as libc::c_int) as s16;
        i -= 1
    }
    (*this).rotationPitch =
        ((*this).rotationPitch as libc::c_int +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_SetColorsAndScales(mut this: *mut DemoExt) {
    let mut scale: *mut Vec3f = &mut (*this).scale;
    let mut shrinkFactor: f32_0 = 0.;
    shrinkFactor =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 35 as libc::c_int) as
                               usize] as libc::c_int as libc::c_float +
             40.0f32 - (*this).alphaTimer) /
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 35 as libc::c_int) as
                                   usize] as libc::c_int as libc::c_float +
                 40.0f32);
    if shrinkFactor < 0.0f32 { shrinkFactor = 0.0f32 }
    (*this).primAlpha =
        (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                 16 as libc::c_int + 28 as libc::c_int) as
                                usize] as libc::c_int + 255 as libc::c_int) as
             u32_0 as libc::c_float * shrinkFactor) as s32;
    (*this).envAlpha =
        (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                 16 as libc::c_int + 32 as libc::c_int) as
                                usize] as libc::c_int + 255 as libc::c_int) as
    ...
    (*scale).x =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 19 as libc::c_int) as
                               usize] as libc::c_int as libc::c_float +
             400.0f32) * shrinkFactor;
    (*scale).y =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 20 as libc::c_int) as
                               usize] as libc::c_int as libc::c_float +
             100.0f32) * shrinkFactor;
    (*scale).z =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 21 as libc::c_int) as
                               usize] as libc::c_int as libc::c_float +
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_Wait(mut this: *mut DemoExt,
                                      mut globalCtx: *mut GlobalContext) {
    DemoExt_CheckCsMode(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_MaintainVortex(mut this: *mut DemoExt,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_DispellVortex(mut this: *mut DemoExt,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoExt_PlayVortexSFX(this);
    DemoExt_SetScrollAndRotation(this);
...
static mut sActionFuncs: [DemoExtActionFunc; 3] =
    unsafe {
        [Some(DemoExt_Wait as
                  unsafe extern "C" fn(_: *mut DemoExt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoExt_MaintainVortex as
                  unsafe extern "C" fn(_: *mut DemoExt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoExt_DispellVortex as
                  unsafe extern "C" fn(_: *mut DemoExt, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoExt_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoExt = thisx as *mut DemoExt;
    if (*this).action < EXT_WAIT as libc::c_int ||
           (*this).action > EXT_DISPELL as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn DemoExt_DrawNothing(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoExt_DrawVortex(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut DemoExt = thisx as *mut DemoExt;
    let mut mtx: *mut Mtx = 0 as *mut Mtx;
    let mut gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut curScroll: *mut s16 = 0 as *mut s16;
    let mut scale: *mut Vec3f = 0 as *mut Vec3f;
    scale = &mut (*this).scale;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_ext.c\x00" as *const u8 as
                        *const libc::c_char, 460 as libc::c_int);
    Matrix_Push();
    Matrix_Scale((*scale).x, (*scale).y, (*scale).z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZYX(((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int
                                             * 16 as libc::c_int +
                     ...
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                     ...
                     (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                         ...
                         f32_0, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(mtx,
                 b"../z_demo_ext.c\x00" as *const u8 as *const libc::c_char as
                     *mut libc::c_char, 476 as libc::c_int);
    Matrix_Pop();
    ...
    (*_g).words.w1 =
        (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                ...
                                usize] as libc::c_int + 140 as libc::c_int) as
             u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 26 as libc::c_int) as
                                    usize] as libc::c_int + 80 as libc::c_int)
                 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
    ...
    (*_g_0).words.w1 =
        (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                ...
                                usize] as libc::c_int + 90 as libc::c_int) as
             u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
            ...
            (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    ...
                                    usize] as libc::c_int + 95 as libc::c_int)
                 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*this).envAlpha as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    curScroll = (*this).curScroll.as_mut_ptr();
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll(gfxCtx, 0 as libc::c_int,
                         *curScroll.offset(0 as libc::c_int as isize) as
                             u32_0,
                         *curScroll.offset(1 as libc::c_int as isize) as
                             u32_0, 0x40 as libc::c_int, 0x40 as libc::c_int,
                         1 as libc::c_int,
                         *curScroll.offset(2 as libc::c_int as isize) as
                             u32_0,
                         *curScroll.offset(3 as libc::c_int as isize) as
                             u32_0, 0x40 as libc::c_int, 0x40 as libc::c_int)
            as libc::c_uint;
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gPhantomWarpDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_4).words.w0 =
        (0xd8 as libc::c_int as u32_0 &
            ...
            (2 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = (1 as libc::c_int * 64 as libc::c_int) as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_ext.c\x00" as *const u8 as
                         *const libc::c_char, 512 as libc::c_int);
}
static mut sDrawFuncs: [DemoExtDrawFunc; 2] =
    unsafe {
        [Some(DemoExt_DrawNothing as
                  unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                      -> ()),
         Some(DemoExt_DrawVortex as
                  unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoExt_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoExt = thisx as *mut DemoExt;
    if (*this).drawMode < EXT_DRAW_NOTHING as libc::c_int ||
           (*this).drawMode > EXT_DRAW_VORTEX as libc::c_int ||
...
#[no_mangle]
pub static mut Demo_Ext_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_EXT as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoExt_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
