...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ka_Anim_000214: AnimationHeader;
    #[no_mangle]
    static mut object_ka_Skel_0065B0: FlexSkeletonHeader;
}
...
pub const OCARINA_NOTE_INVALID: C2RustUnnamed_20 = 255;
pub const OCARINA_NOTE_C_UP: C2RustUnnamed_20 = 4;
pub const OCARINA_NOTE_C_LEFT: C2RustUnnamed_20 = 3;
pub const OCARINA_NOTE_C_RIGHT: C2RustUnnamed_20 = 2;
pub const OCARINA_NOTE_C_DOWN: C2RustUnnamed_20 = 1;
pub const OCARINA_NOTE_A: C2RustUnnamed_20 = 0;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnKakasi3 {
    pub actor: Actor,
    pub actionFunc: EnKakasi3ActionFunc,
    pub skelAnime: SkelAnime,
    pub unk_194: u8_0,
    pub unk_195: u8_0,
    pub dialogState: s16,
...
pub type EnKakasi3ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKakasi3, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut En_Kakasi3_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KAKASI3 as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_KA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnKakasi3>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi3_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi3_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi3_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnKakasi3 = thisx as *mut EnKakasi3;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
    // ! @bug SkelAnime_Free is not called
}
#[no_mangle]
pub unsafe extern "C" fn EnKakasi3_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi3 = thisx as *mut EnKakasi3;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Obonur" -- Related to the name of the scarecrow (Bonooru)
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8a\xe3\x83\xbc\xe3\x83\x9c\xe3\x83\x8c\xe3\x83\xbc\xe3\x83\xab \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_ka_Skel_0065B0, &mut object_ka_Anim_000214,
    ...
    (*this).actionFunc =
        Some(func_80A911F0 as
                 unsafe extern "C" fn(_: *mut EnKakasi3,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A90E28(mut this: *mut EnKakasi3) {
    ...
    Math_ApproachZeroF(&mut (*this).skelAnime.curFrame, 0.5f32, 1.0f32);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, (*this).rot.x,
                       5 as libc::c_int as s16, 0x2710 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, (*this).rot.y,
                       5 as libc::c_int as s16, 0x2710 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z, (*this).rot.z,
                       5 as libc::c_int as s16, 0x2710 as libc::c_int as s16,
                       0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A90EBC(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg: s32) {
    let mut currentFrame: s16 = 0;
    let mut ocarinaNote: s16 = (*globalCtx).msgCtx.lastOcaNoteIdx as s16;
    if arg != 0 as libc::c_int {
        if (*this).unk_19C[3 as libc::c_int as usize] as libc::c_int ==
               0 as libc::c_int {
            (*this).unk_19C[3 as libc::c_int as usize] =
                (Rand_ZeroFloat(10.99f32) as s16 as libc::c_int +
                     30 as libc::c_int) as s16;
            (*this).unk_1A6 = Rand_ZeroFloat(4.99f32) as s16
        }
        (*this).unk_19A =
            (Rand_ZeroFloat(2.99f32) as s16 as libc::c_int + 5 as libc::c_int)
                as s16;
    ...
    match ocarinaNote as libc::c_int {
        0 => {
            ...
            if (*this).unk_1A4 as libc::c_int == 0 as libc::c_int {
                (*this).unk_1A4 = 1 as libc::c_int as s16;
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x286b as libc::c_int as u16_0);
            }
        }
        1 => { (*this).unk_19A += 1; (*this).unk_1B8 = 1.0f32 }
        2 => {
            (*this).unk_19A += 1;
            if (*this).unk_1AE as libc::c_int == 0 as libc::c_int {
                (*this).unk_1AE = 0x1388 as libc::c_int as s16
            }
        }
        3 => {
            (*this).unk_19A += 1;
            if (*this).unk_1AA as libc::c_int == 0 as libc::c_int {
                (*this).unk_1AA = 0x1388 as libc::c_int as s16
            }
        }
        4 => { (*this).unk_19A += 1; (*this).unk_1B8 = 2.0f32 }
        _ => { }
    }
    if (*this).unk_19A as libc::c_int > 8 as libc::c_int {
        (*this).unk_19A = 8 as libc::c_int as s16
    }
    if (*this).unk_19A as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).unk_19A as libc::c_int == 8 as libc::c_int &&
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x1847 as libc::c_int as u16_0);
        }
        Math_ApproachF(&mut (*this).skelAnime.playSpeed, (*this).unk_1B8,
                       0.1f32, 0.2f32);
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, (*this).unk_1AA,
                           0x5 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.z, (*this).unk_1AE,
                           0x5 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if (*this).unk_1AA as libc::c_int != 0 as libc::c_int &&
               fabsf(((*this).actor.shape.rot.x as libc::c_int -
                          (*this).unk_1AA as libc::c_int) as f32_0) < 50.0f32
           {
            (*this).unk_1AA =
                ((*this).unk_1AA as libc::c_float * -1.0f32) as s16
        }
        if (*this).unk_1AE as libc::c_int != 0 as libc::c_int &&
               fabsf(((*this).actor.shape.rot.z as libc::c_int -
                          (*this).unk_1AE as libc::c_int) as f32_0) < 50.0f32
           {
            (*this).unk_1AE =
                ((*this).unk_1AE as libc::c_float * -1.0f32) as s16
        }
        if (*this).unk_1A4 as libc::c_int != 0 as libc::c_int {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
                     0x1000 as libc::c_int) as s16;
            if (*this).actor.shape.rot.y as libc::c_int == 0 as libc::c_int {
                (*this).unk_1A4 = 0 as libc::c_int as s16
            }
        }
        currentFrame = (*this).skelAnime.curFrame as s16;
        if currentFrame as libc::c_int == 11 as libc::c_int ||
               currentFrame as libc::c_int == 17 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x286a as libc::c_int as u16_0);
        }
        SkelAnime_Update(&mut (*this).skelAnime);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A911F0(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut object_ka_Anim_000214 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_ka_Anim_000214,
                     1.0f32, 0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A91284 as
                 unsafe extern "C" fn(_: *mut EnKakasi3,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A91284(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).actor.textId = 0x40a1 as libc::c_int as u16_0;
    (*this).dialogState = TEXT_STATE_DONE as libc::c_int as s16;
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        if gSaveContext.scarecrowSpawnSongSet != 0 {
            (*this).actor.textId = 0x40a0 as libc::c_int as u16_0;
            (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
            (*this).unk_1A8 = 1 as libc::c_int as s16
        }
    } else {
        (*this).unk_194 = 1 as libc::c_int as u8_0;
        if gSaveContext.scarecrowSpawnSongSet != 0 {
            if (*this).unk_195 != 0 {
                (*this).actor.textId = 0x40a2 as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x40a3 as libc::c_int as u16_0 }
        }
    }
    (*this).actionFunc =
        Some(func_80A91348 as
                 unsafe extern "C" fn(_: *mut EnKakasi3,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A91348(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    func_80A90E28(this);
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).camId = -(1 as libc::c_int) as s16;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        if !((*this).actor.xzDistToPlayer > 120.0f32) {
            let mut absAngleTowardsLink: s16 =
                if angleTowardsLink as libc::c_int >= 0 as libc::c_int {
                    angleTowardsLink as libc::c_int
                } else { -(angleTowardsLink as libc::c_int) } as s16;
            if (absAngleTowardsLink as libc::c_int) < 0x4300 as libc::c_int {
                if (*this).unk_194 == 0 {
                    if (*player).stateFlags2 &
                           0x1000000 as libc::c_int as libc::c_uint != 0 {
                        (*this).camId =
                            OnePointCutscene_Init(globalCtx,
                                                  2260 as libc::c_int as s16,
                        ...
                        Message_StartTextbox(globalCtx,
                                             0x40a4 as libc::c_int as u16_0,
                                             0 as *mut Actor);
                        (*player).stateFlags2 |=
                            0x800000 as libc::c_int as libc::c_uint;
                        (*this).actionFunc =
                            Some(func_80A915B8 as
                                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ());
                ...
                } else if gSaveContext.scarecrowSpawnSongSet as libc::c_int !=
                              0 && (*this).unk_195 == 0 {
                    if (*player).stateFlags2 &
                           0x1000000 as libc::c_int as libc::c_uint != 0 {
                        (*this).camId =
                        ...
                        (*this).unk_1B8 = 0.0f32;
                        Message_StartTextbox(globalCtx,
                                             0x40a8 as libc::c_int as u16_0,
                                             0 as *mut Actor);
                        (*player).stateFlags2 |=
                            0x800000 as libc::c_int as libc::c_uint;
                        (*this).actionFunc =
                            Some(func_80A9187C as
                                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80A915B8(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_SCARECROW_RECORDING as libc::c_int as
                          u16_0);
        (*this).actionFunc =
            Some(func_80A91620 as
                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A91620(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if ((*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
            ...
            (*globalCtx).msgCtx.ocarinaMode as libc::c_int >=
                ...
                ((*globalCtx).msgCtx.ocarinaMode as libc::c_int) <
                    OCARINA_MODE_0B as libc::c_int) &&
           (*globalCtx).msgCtx.msgMode as libc::c_int ==
               MSGMODE_NONE as libc::c_int {
        OnePointCutscene_EndCutscene(globalCtx, (*this).camId);
        if (*globalCtx).cameraPtrs[(*this).camId as usize].is_null() {
            (*this).camId = -(1 as libc::c_int) as s16
        }
        if (*this).camId as libc::c_int != -(1 as libc::c_int) {
            func_8005B1A4((*globalCtx).cameraPtrs[(*this).camId as usize]);
        }
        (*this).actionFunc =
            Some(func_80A911F0 as
                     unsafe extern "C" fn(_: *mut EnKakasi3,
    ...
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
           ...
           (*globalCtx).msgCtx.msgMode as libc::c_int ==
               MSGMODE_NONE as libc::c_int {
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
        Message_StartTextbox(globalCtx, 0x40a5 as libc::c_int as u16_0,
                             0 as *mut Actor);
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        (*this).actionFunc =
            Some(func_80A91A90 as
                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                          _: *mut GlobalContext) -> ());
        return
    }
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
        ...
        func_80A90EBC(this, globalCtx, 0 as libc::c_int);
        (*player).stateFlags2 |= 0x800000 as libc::c_int as libc::c_uint
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A91760(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A90E28(this);
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).dialogState as libc::c_int ==
        ...
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_SCARECROW_PLAYBACK as libc::c_int as
                          u16_0);
        (*this).actionFunc =
            Some(func_80A917FC as
                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                          _: *mut GlobalContext) -> ());
        (*this).camId =
            OnePointCutscene_Init(globalCtx, 2280 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).actor, 0 as libc::c_int as s16)
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A917FC(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int !=
           OCARINA_MODE_0F as libc::c_int {
        func_80A90EBC(this, globalCtx, 1 as libc::c_int);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A9187C(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_CloseTextbox(globalCtx);
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_CHECK_SCARECROW as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80A918E4 as
                     unsafe extern "C" fn(_: *mut EnKakasi3,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A918E4(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        // "No way!"
        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xbe\xe3\x81\x95\xe3\x81\x8b\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*globalCtx).msgCtx.ocarinaMode as libc::c_int);
    }
    if ((*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
           ...
           (*globalCtx).msgCtx.msgMode as libc::c_int ==
               MSGMODE_NONE as libc::c_int {
        Message_StartTextbox(globalCtx, 0x40a6 as libc::c_int as u16_0,
                             0 as *mut Actor);
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
        OnePointCutscene_EndCutscene(globalCtx, (*this).camId);
        (*this).camId = -(1 as libc::c_int) as s16;
    ...
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
        ...
        if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
            ...
            osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x93\xe3\x82\x8c\xe3\x81\xa7\xe3\x80\x81\xe4\xbb\x96\xe3\x81\xae\xe5\xa5\xb4\xe3\x82\x82\xef\xbc\xaf\xef\xbc\xab\xef\xbc\x81\xe3\x81\xa0\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*globalCtx).msgCtx.ocarinaMode as libc::c_int);
        }
        (*this).unk_195 = 1 as libc::c_int as u8_0;
        Message_StartTextbox(globalCtx, 0x40a7 as libc::c_int as u16_0,
                             0 as *mut Actor);
        (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16;
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn func_80A91A90(mut this: *mut EnKakasi3,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A90E28(this);
    SkelAnime_Update(&mut (*this).skelAnime);
    func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi3_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi3 = thisx as *mut EnKakasi3;
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "flag!"
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x95\xe3\x83\xa9\xe3\x82\xb0\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     gSaveContext.scarecrowSpawnSongSet as libc::c_int);
    }
    (*this).unk_198 += 1;
    ...
    while i <
              (::std::mem::size_of::<[s16; 4]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        if (*this).unk_19C[i as usize] as libc::c_int != 0 as libc::c_int {
            (*this).unk_19C[i as usize] -= 1
        }
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi3_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi3 = thisx as *mut EnKakasi3;
