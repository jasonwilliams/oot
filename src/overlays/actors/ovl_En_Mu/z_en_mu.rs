...
extern "C" {
    ...
    #[no_mangle]
    static mut object_mu_Anim_0003F4: AnimationHeader;
    #[no_mangle]
    static mut object_mu_Skel_004F70: FlexSkeletonHeader;
}
...
pub struct EnMu {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnMuActionFunc,
    pub collider: ColliderCylinder,
    pub npcInfo: struct_80034A14_arg1,
    pub defFaceReaction: u16_0,
    pub unk_20A: [s16; 16],
    pub unk_22A: [s16; 17],
}
pub type EnMuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMu, _: *mut GlobalContext) -> ()>;
static mut D_80AB0BD0: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80AB0BFC: CollisionCheckInfoInit2 =
    {
        let mut init =
...
#[no_mangle]
pub static mut En_Mu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MU as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_MU as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMu>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnMu_SetupAction(mut this: *mut EnMu,
                                          mut actionFunc: EnMuActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_Interact(mut this: *mut EnMu,
                                       mut globalCtx: *mut GlobalContext) {
    let mut textIdOffset: [u8_0; 5] =
        [0x42 as libc::c_int as u8_0, 0x43 as libc::c_int as u8_0,
         0x3f as libc::c_int as u8_0, 0x41 as libc::c_int as u8_0,
         0x3e as libc::c_int as u8_0];
    let mut bitmask: [u8_0; 5] =
        [0x1 as libc::c_int as u8_0, 0x2 as libc::c_int as u8_0,
         0x4 as libc::c_int as u8_0, 0x8 as libc::c_int as u8_0,
         0x10 as libc::c_int as u8_0];
    let mut textFlags: u8_0 = 0;
    let mut randomIndex: s32 = 0;
    let mut i: s32 = 0;
    textFlags =
        (gSaveContext.eventInf[2 as libc::c_int as usize] as libc::c_int &
             0x1f as libc::c_int) as u8_0;
    gSaveContext.eventInf[2 as libc::c_int as usize] =
        (gSaveContext.eventInf[2 as libc::c_int as usize] as libc::c_int &
             !(0x1f as libc::c_int)) as u16_0;
    randomIndex =
        (*globalCtx).state.frames.wrapping_add((Rand_ZeroOne() * 5.0f32) as
                                                   s32 as
    ...
    while i < 5 as libc::c_int {
        if textFlags as libc::c_int &
               bitmask[randomIndex as usize] as libc::c_int == 0 {
            break ;
        }
        randomIndex += 1;
        if randomIndex >= 5 as libc::c_int { randomIndex = 0 as libc::c_int }
        i += 1
    }
    if i == 5 as libc::c_int {
        if (*this).defFaceReaction as libc::c_int ==
               textIdOffset[randomIndex as usize] as libc::c_int |
                   0x7000 as libc::c_int {
            randomIndex += 1;
            if randomIndex >= 5 as libc::c_int {
                randomIndex = 0 as libc::c_int
            }
        }
        textFlags = 0 as libc::c_int as u8_0
    }
    textFlags =
        (textFlags as libc::c_int |
             bitmask[randomIndex as usize] as libc::c_int) as u8_0;
    (*this).defFaceReaction =
        (textIdOffset[randomIndex as usize] as libc::c_int |
             0x7000 as libc::c_int) as u16_0;
    textFlags = (textFlags as libc::c_int & 0xff as libc::c_int) as u8_0;
    gSaveContext.eventInf[2 as libc::c_int as usize] =
        (gSaveContext.eventInf[2 as libc::c_int as usize] as libc::c_int |
             textFlags as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_GetFaceReaction(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut thisx: *mut Actor)
 -> u16_0 {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    let mut faceReaction: u16_0 =
        Text_GetFaceReaction(globalCtx,
                             ((*this).actor.params as libc::c_int +
                                  0x3a as libc::c_int) as u32_0);
    if faceReaction as libc::c_int != 0 as libc::c_int { return faceReaction }
    return (*this).defFaceReaction;
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_CheckDialogState(mut globalCtx:
                                                   *mut GlobalContext,
    ...
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        ...
        _ => { return 1 as libc::c_int as s16 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_mu_Skel_004F70, &mut object_mu_Anim_0003F4,
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            0 as *mut DamageTable, &mut D_80AB0BFC);
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    EnMu_Interact(this, globalCtx);
    EnMu_SetupAction(this,
                     Some(EnMu_Pose as
                              unsafe extern "C" fn(_: *mut EnMu,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_Pose(mut this: *mut EnMu,
                                   mut globalCtx: *mut GlobalContext) {
    func_80034F54(globalCtx, (*this).unk_20A.as_mut_ptr(),
                  (*this).unk_22A.as_mut_ptr(), 16 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    let mut pad: s32 = 0;
    let mut talkDist: f32_0 = 0.;
    ...
    func_800343CC(globalCtx, &mut (*this).actor, &mut (*this).npcInfo.unk_00,
                  talkDist,
                  Some(EnMu_GetFaceReaction as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> u16_0),
                  Some(EnMu_CheckDialogState as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> s16));
...
#[no_mangle]
pub unsafe extern "C" fn EnMu_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    if limbIndex == 5 as libc::c_int || limbIndex == 6 as libc::c_int ||
           limbIndex == 7 as libc::c_int || limbIndex == 11 as libc::c_int ||
           limbIndex == 12 as libc::c_int || limbIndex == 13 as libc::c_int ||
           limbIndex == 14 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*this).unk_20A[limbIndex as usize]) * 200.0f32) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*this).unk_22A[limbIndex as usize]) * 200.0f32) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnMu_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn EnMu_DisplayListSetColor(mut gfxCtx:
                                                      *mut GraphicsContext,
...
#[no_mangle]
pub unsafe extern "C" fn EnMu_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMu = thisx as *mut EnMu;
    let mut colors: [[Color_RGBA8; 5]; 2] =
        [[{
              let mut init =
          ...
          {
              let mut init =
                  Color_RGBA8{r: 160 as libc::c_int as u8_0,
                              g: 250 as libc::c_int as u8_0,
                              b: 60 as libc::c_int as u8_0,
                              a: 0 as libc::c_int as u8_0,};
              init
          },
          {
          ...
          {
              let mut init =
                  Color_RGBA8{r: 30 as libc::c_int as u8_0,
                              g: 240 as libc::c_int as u8_0,
          ...
          {
              let mut init =
                  Color_RGBA8{r: 140 as libc::c_int as u8_0,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_mu.c\x00" as *const u8 as *const libc::c_char,
                    514 as libc::c_int);
    Matrix_Translate(-1200.0f32, 0.0f32, -1400.0f32,
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                (0x6 as libc::c_int as u32_0 &
                    ...
                    16 as libc::c_int |
                ((segmentId[i as usize] as libc::c_int * 4 as libc::c_int) as
                     u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g).words.w1 =
            EnMu_DisplayListSetColor((*globalCtx).state.gfxCtx,
                                     colors[(*this).actor.params as
                                                usize][i as usize].r,
                                     colors[(*this).actor.params as
                                                usize][i as usize].g,
                                     colors[(*this).actor.params as
