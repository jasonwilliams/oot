...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002F758(globalCtx: *mut GlobalContext, actor: *mut Actor,
...
pub const FIRE_ROCK_ON_FLOOR: C2RustUnnamed_21 = 6;
pub const FIRE_ROCK_CEILING_SPOT_SPAWNER: C2RustUnnamed_21 = 5;
pub const FIRE_ROCK_SPAWNED_FALLING2: C2RustUnnamed_21 = 3;
pub const FIRE_ROCK_BROKEN_PIECE2: C2RustUnnamed_21 = 2;
pub const FIRE_ROCK_BROKEN_PIECE1: C2RustUnnamed_21 = 1;
pub const FIRE_ROCK_SPAWNED_FALLING1: C2RustUnnamed_21 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type EnFireRockActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnFireRock, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Fire_Rock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FIRE_ROCK as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFireRock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFireRock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFireRock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFireRock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80A12CA0: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80A12CCC: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_Init(mut thisx: *mut Actor,
    ...
    let mut this: *mut EnFireRock = thisx as *mut EnFireRock;
    let mut temp: s16 = 0;
    (*this).type_0 = (*this).actor.params;
    if (*this).type_0 as libc::c_int !=
           FIRE_ROCK_CEILING_SPOT_SPAWNER as libc::c_int {
        ActorShape_Init(&mut (*thisx).shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      ...
                                                      _: *mut GlobalContext)
                                     -> ()), 15.0f32);
        if (*this).type_0 as libc::c_int != FIRE_ROCK_ON_FLOOR as libc::c_int
           {
            (*this).angularVelocity.x = Rand_ZeroFloat(10.0f32) + 15.0f32;
            (*this).angularVelocity.y = Rand_ZeroFloat(10.0f32) + 15.0f32;
            (*this).angularVelocity.z = Rand_ZeroFloat(10.0f32) + 15.0f32
        }
    }
    ...
    match (*this).type_0 as libc::c_int {
        5 => {
            ...
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa4\xa9\xe4\xba\x95\xe5\xbe\x85\xe3\x81\xa1\xe5\xb2\xa9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actionFunc =
                Some(FireRock_WaitSpawnRocksFromCeiling as
                         unsafe extern "C" fn(_: *mut EnFireRock,
                                              _: *mut GlobalContext) -> ());
            current_block_50 = 1423531122933789233;
        }
        6 => {
            ...
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut D_80A12CCC);
            // "☆☆☆☆☆ floor rock ☆☆☆☆☆"
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xba\x8a\xe5\xb2\xa9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        ...
        0 => {
            ...
            // sets unused vars?
            (*this).unk17C.x =
                Rand_CenteredFloat(50.0f32) + (*player).actor.world.pos.x;
            (*this).unk17C.z =
                Rand_CenteredFloat(50.0f32) + (*player).actor.world.pos.z;
            current_block_50 = 10481819802703796409;
        }
        3 => { current_block_50 = 10481819802703796409; }
        1 => {
            (*this).actor.velocity.y = Rand_ZeroFloat(3.0f32) + 4.0f32;
            (*this).actor.speedXZ = Rand_ZeroFloat(3.0f32) + 3.0f32;
            (*this).scale = Rand_ZeroFloat(1.0f32) / 100.0f32 + 0.02f32;
            Actor_SetScale(&mut (*this).actor, (*this).scale);
            (*this).actor.gravity = -1.5f32;
            Collider_InitCylinder(globalCtx, &mut (*this).collider);
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut D_80A12CA0);
            (*this).actor.shape.shadowScale = 10.0f32;
            (*this).actor.shape.rot.y = Rand_CenteredFloat(65535.0f32) as s16;
            (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
            (*this).actionFunc =
                Some(EnFireRock_Fall as
                         unsafe extern "C" fn(_: *mut EnFireRock,
                                              _: *mut GlobalContext) -> ());
            current_block_50 = 1423531122933789233;
        }
        2 => {
            (*this).actor.velocity.y = Rand_ZeroFloat(3.0f32) + 4.0f32;
            (*this).actor.speedXZ = Rand_ZeroFloat(3.0f32) + 2.0f32;
            (*this).scale = Rand_ZeroFloat(1.0f32) / 500.0f32 + 0.01f32;
            Actor_SetScale(&mut (*this).actor, (*this).scale);
            (*this).actor.gravity = -1.2f32;
            (*this).actor.shape.shadowScale = 5.0f32;
            (*this).actor.shape.rot.y = Rand_CenteredFloat(65535.0f32) as s16;
            (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
            (*this).actionFunc =
                Some(EnFireRock_Fall as
        ...
        _ => {
            // "☆☆☆☆☆ No such rock! ERR !!!!!! ☆☆☆☆☆"
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\xb2\xa9\xe3\x81\xaf\xe3\x81\xad\xe3\x81\x87\xef\xbc\x81ERR!!!!!! \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
    ...
    match current_block_50 {
        10481819802703796409 => {
            // spawned by encount2 and by the ceilling spawner
            (*this).scale = Rand_ZeroFloat(2.0f32) / 100.0f32 + 0.02f32;
            Actor_SetScale(&mut (*this).actor, (*this).scale);
            Collider_InitCylinder(globalCtx, &mut (*this).collider);
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut D_80A12CA0);
...
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnFireRock = thisx as *mut EnFireRock;
    if !(*this).actor.parent.is_null() &&
           (*this).actor.parent == &mut (*(*this).spawner).actor as *mut Actor
       {
        let mut spawner: *mut EnEncount2 =
            (*this).actor.parent as *mut EnEncount2;
        if (*spawner).actor.update.is_some() &&
               (*spawner).numSpawnedRocks as libc::c_int > 0 as libc::c_int {
            (*spawner).numSpawnedRocks -= 1;
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            // "☆☆☆☆☆ Number of spawned instances recovery ☆☆☆☆☆%d"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb0\xe5\x9b\x9e\xe5\xbe\xa9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86%d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*spawner).numSpawnedRocks as libc::c_int);
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_Fall(mut this: *mut EnFireRock,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.floorHeight == -10000.0f32 ||
           (*this).actor.world.pos.y < (*player).actor.world.pos.y - 200.0f32
       {
        Actor_Kill(&mut (*this).actor);
        return
    }
    ...
    match (*this).type_0 as libc::c_int {
        0 => {
            if (*player).actor.world.pos.y < (*this).actor.world.pos.y {
                if (*player).actor.world.pos.x > -700.0f32 ||
                       (*player).actor.world.pos.x < 100.0f32 ||
                       (*player).actor.world.pos.z > -1290.0f32 ||
                       (*player).actor.world.pos.z < -3880.0f32 {
                    Math_ApproachF(&mut (*this).actor.world.pos.x,
                                   (*player).actor.world.pos.x, 1.0f32,
                                   10.0f32);
                    Math_ApproachF(&mut (*this).actor.world.pos.z,
                                   (*player).actor.world.pos.z, 1.0f32,
                                   10.0f32);
                }
            }
            current_block_17 = 11819595388259979699;
        }
        3 => { current_block_17 = 11819595388259979699; }
        1 => {
            if (*globalCtx).gameplayFrames & 3 as libc::c_int as libc::c_uint
                   == 0 as libc::c_int as libc::c_uint {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38d7 as libc::c_int as u16_0);
            }
            current_block_17 = 26972500619410423;
        }
        _ => { current_block_17 = 26972500619410423; }
    }
    match current_block_17 {
        11819595388259979699 => {
            flamePos.x =
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
        ...
        match (*this).type_0 as libc::c_int {
            0 | 3 => {
                ...
                current_block_31 = 397555038283125354;
            }
            1 => { current_block_31 = 397555038283125354; }
            _ => {
                ...
                Audio_PlaySoundAtPosition(globalCtx,
                                          &mut (*this).actor.world.pos,
                                          40 as libc::c_int,
                                          0x2802 as libc::c_int as u16_0);
                Actor_Kill(&mut (*this).actor);
                current_block_31 = 1836292691772056875;
            }
        }
        match current_block_31 {
            397555038283125354 => {
                ...
                (*this).actionFunc =
                    Some(EnFireRock_SpawnMoreBrokenPieces as
                             unsafe extern "C" fn(_: *mut EnFireRock,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_SpawnMoreBrokenPieces(mut this:
                                                              *mut EnFireRock,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut spawnedFireRock: *mut EnFireRock = 0 as *mut EnFireRock;
    let mut nextRockType: s32 = 0;
    let mut i: s32 = 0;
    let mut temp: s32 = 0;
    nextRockType = FIRE_ROCK_SPAWNED_FALLING1 as libc::c_int;
    match (*this).type_0 as libc::c_int {
        0 | 3 => { nextRockType = FIRE_ROCK_BROKEN_PIECE1 as libc::c_int }
        1 => { nextRockType = FIRE_ROCK_BROKEN_PIECE2 as libc::c_int }
        _ => { }
    }
    if nextRockType != FIRE_ROCK_SPAWNED_FALLING1 as libc::c_int {
        i = 0 as libc::c_int;
        while i < 2 as libc::c_int {
            spawnedFireRock =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_FIRE_ROCK as libc::c_int as s16,
                            Rand_CenteredFloat(3.0f32) +
                                (*this).actor.world.pos.x,
                            Rand_CenteredFloat(3.0f32) +
                            ...
                            0 as libc::c_int as s16, nextRockType as s16) as
                    *mut EnFireRock;
            if !spawnedFireRock.is_null() {
                (*spawnedFireRock).actor.world.rot.y =
                    (*this).actor.world.rot.y;
                if i == 0 as libc::c_int {
                    (*spawnedFireRock).actor.shape.rot.y =
                        (*this).actor.shape.rot.y
                }
                (*spawnedFireRock).scale = (*this).scale - 0.01f32
            } else {
                osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa4\xe3\x83\x83\xe3\x83\x91\xe3\x82\xa4\xe3\x83\x87\xe3\x83\x83\xe3\x82\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
            }
            i += 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn FireRock_WaitSpawnRocksFromCeiling(mut this:
                                                                *mut EnFireRock,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    let mut spawnedFireRock: *mut EnFireRock = 0 as *mut EnFireRock;
    if (*this).actor.xzDistToPlayer < 200.0f32 {
        if (*this).playerNearby as libc::c_int == 0 as libc::c_int &&
               (*this).timer2 as libc::c_int == 0 as libc::c_int {
            (*this).timer2 = 30 as libc::c_int as s16;
            spawnedFireRock =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_FIRE_ROCK as libc::c_int as s16,
                            Rand_CenteredFloat(3.0f32) +
                    ...
                    as *mut EnFireRock;
            if !spawnedFireRock.is_null() {
                (*spawnedFireRock).timer = 10 as libc::c_int as s16
            } else {
                osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa4\xe3\x83\x83\xe3\x83\x91\xe3\x82\xa4\xe3\x83\x87\xe3\x83\x83\xe3\x82\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
            }
        }
        (*this).playerNearby = 1 as libc::c_int as u8_0
    } else { (*this).playerNearby = 0 as libc::c_int as u8_0 }
...
#[no_mangle]
pub unsafe extern "C" fn FireRock_WaitOnFloor(mut this: *mut EnFireRock,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut flamePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut scale: s16 = 0;
    if (*this).timer2 as libc::c_int == 0 as libc::c_int {
        flamePos.x = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
        flamePos.y = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.y;
        flamePos.z = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
        scale =
            (130 as libc::c_int +
                 Rand_CenteredFloat(60.0f32) as s16 as libc::c_int) as s16;
        (*this).timer2 =
            (3 as libc::c_int + Rand_ZeroFloat(3.0f32) as s16 as libc::c_int)
                as s16;
        EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                  &mut flamePos, scale,
                                  0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnFireRock = thisx as *mut EnFireRock;
    let mut setCollision: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut playerActor: *mut Actor =
    ...
    if (*this).type_0 as libc::c_int !=
        ...
        (*this).relativePos.y = 3.0f32;
        temp = 10.0f32 + (*this).scale * 300.0f32;
        (*thisx).shape.shadowScale = temp;
        if (*thisx).shape.shadowScale < 10.0f32 {
            (*thisx).shape.shadowScale = 10.0f32
        }
        if (*thisx).shape.shadowScale > 20.0f32 {
            (*thisx).shape.shadowScale = 20.0f32
        }
        if (*this).type_0 as libc::c_int ==
               FIRE_ROCK_SPAWNED_FALLING1 as libc::c_int ||
               (*this).type_0 as libc::c_int ==
                   FIRE_ROCK_SPAWNED_FALLING2 as libc::c_int {
            (*thisx).gravity = -0.3f32 - (*this).scale * 7.0f32
        }
        if (*this).type_0 as libc::c_int != FIRE_ROCK_ON_FLOOR as libc::c_int
           {
            Actor_MoveForward(thisx);
            Actor_UpdateBgCheckInfo(globalCtx, thisx, 50.0f32, 50.0f32,
                                    100.0f32, 0x1c as libc::c_int);
        }
        setCollision = 0 as libc::c_int as s16;
        if (*this).actionFunc !=
               Some(EnFireRock_SpawnMoreBrokenPieces as
                        unsafe extern "C" fn(_: *mut EnFireRock,
                                             _: *mut GlobalContext) -> ()) {
            if (*this).type_0 as libc::c_int ==
                   ...
                   (*this).type_0 as libc::c_int ==
                       FIRE_ROCK_SPAWNED_FALLING2 as libc::c_int ||
                   (*this).type_0 as libc::c_int ==
                       FIRE_ROCK_BROKEN_PIECE1 as libc::c_int {
                    ...
                    (*this).actionFunc =
                        Some(EnFireRock_SpawnMoreBrokenPieces as
                                 unsafe extern "C" fn(_: *mut EnFireRock,
                                     ...
                                     -> ());
                    // "☆☆☆☆☆ Shield Defense Lv1 ☆☆☆☆☆"
                    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xb7\xe3\x83\xbc\xe3\x83\xab\xe3\x83\x89\xe9\x98\xb2\xe5\xbe\xa1 Lv\xef\xbc\x91 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char);
                    return
                }
                setCollision = 1 as libc::c_int as s16
            }
        }
        if (*this).type_0 as libc::c_int == FIRE_ROCK_ON_FLOOR as libc::c_int
           {
            if (*this).collider.base.atFlags as libc::c_int & 2 as libc::c_int
                ...
                if (*this).collider.base.at == playerActor {
                    if (*player).stateFlags1 &
                        ...
                        func_8002F758(globalCtx, thisx, 2.0f32,
                                      -((*player).actor.world.rot.y as
                                            libc::c_int) as s16, 3.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnFireRock_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFireRock = thisx as *mut EnFireRock;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fire_rock.c\x00" as *const u8 as
                        *const libc::c_char, 747 as libc::c_int);
    Matrix_Translate((*thisx).world.pos.x + (*this).relativePos.x,
                     (*thisx).world.pos.y + (*this).relativePos.y,
                     (*thisx).world.pos.z + (*this).relativePos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateX((*this).rockRotation.x *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateY((*this).rockRotation.y *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZ((*this).rockRotation.z *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale((*thisx).scale.x, (*thisx).scale.y, (*thisx).scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
