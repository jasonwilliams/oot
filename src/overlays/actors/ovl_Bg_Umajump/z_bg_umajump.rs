...
extern "C" {
    ...
    #[no_mangle]
    static mut gJumpableHorseFenceDL: [Gfx; 0];
    #[no_mangle]
    static mut gJumpableHorseFenceCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgUmaJump {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut Bg_Umajump_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_UMAJUMP as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_UMAJUMP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgUmaJump>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgUmaJump_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgUmaJump_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgUmaJump_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgUmaJump = thisx as *mut BgUmaJump;
    ...
    CollisionHeader_GetVirtual(&mut gJumpableHorseFenceCol as
...
#[no_mangle]
pub unsafe extern "C" fn BgUmaJump_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgUmaJump = thisx as *mut BgUmaJump;
...
#[no_mangle]
pub unsafe extern "C" fn BgUmaJump_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgUmaJump_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gJumpableHorseFenceDL.as_mut_ptr());
}
