...
pub type DemoGoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext) -> ()>;
pub type DemoGoDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext) -> ()>;
...
static mut D_8097D44C: [DemoGoActionFunc; 7] =
    unsafe {
        [Some(func_8097CFDC as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097CFFC as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D01C as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D058 as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D088 as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D0D0 as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D130 as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ())]
    };
static mut D_8097D468: [DemoGoDrawFunc; 2] =
    unsafe {
        [Some(func_8097D290 as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ()),
         Some(func_8097D29C as
                  unsafe extern "C" fn(_: *mut DemoGo, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub static mut Demo_Go_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_GO as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_8097C870(mut this: *mut DemoGo) -> s32 {
    let mut ret: s32 = 0;
    match (*this).actor.params as libc::c_int {
        0 => { ret = 3 as libc::c_int }
        1 => { ret = 4 as libc::c_int }
        _ => { ret = 5 as libc::c_int }
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_8097C8A8(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).actor;
    let mut sp20: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp1C: f32_0 = 0.;
    if (*thisx).params as libc::c_int == 0 as libc::c_int ||
        ...
        SkinMatrix_Vec3fMtxFMultXYZW(&mut (*globalCtx).viewProjectionMtxF,
                                     &mut (*thisx).world.pos, &mut sp20,
                                     &mut sp1C);
        Audio_PlaySoundAtPosition(globalCtx, &mut sp20, 20 as libc::c_int,
                                  0x28a0 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGo_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGo = thisx as *mut DemoGo;
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097C930(mut this: *mut DemoGo) {
    let mut something: *mut s16 = &mut (*this).unk_192;
    let mut other: *mut s16 = &mut (*this).unk_190;
    let mut pad: [s32; 3] = [0; 3];
    if (if *something as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { *something -= 1; *something as libc::c_int }) ==
           0 as libc::c_int {
        *something =
            Rand_S16Offset(60 as libc::c_int as s16, 60 as libc::c_int as s16)
    }
    *other = *something;
    if *other as libc::c_int >= 3 as libc::c_int {
        *other = 0 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097C9B8(mut this: *mut DemoGo) {
    func_80078914(&mut (*this).actor.projectedPos,
                  0x387b as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097C9DC(mut this: *mut DemoGo) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CA30(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 30.0f32,
                            30.0f32, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CA78(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s16 = 0;
    let mut vec: Vec3f = (*this).actor.world.pos;
    func_80033480(globalCtx, &mut vec,
                  ...
                  ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                       ...
                       libc::c_int + 0x12c as libc::c_int) as s16,
                  (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                         16 as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CB0C(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).actor;
    let mut world: *mut PosRot = &mut (*thisx).world;
    ...
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        npcAction = (*csCtx).npcActions[func_8097C870(this) as usize];
        if !npcAction.is_null() {
            ...
            (*thisx).shape.rot.y = (*npcAction).c2rust_unnamed.rot.y;
            (*world).rot.y = (*thisx).shape.rot.y
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CC08(mut this: *mut DemoGo) {
    let mut something: f32_0 = (*this).unk_19C;
    if something < 8.0f32 {
        (*this).actor.speedXZ =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 15 as libc::c_int) as
                                   usize] as libc::c_int as libc::c_float *
                 0.01f32 + 1.2f32) / 8.0f32 * something
    } else {
        (*this).actor.speedXZ =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 15 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CCC0(mut this: *mut DemoGo) {
    Actor_MoveForward(&mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CCE0(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    let mut thisx: *mut Actor = &mut (*this).actor;
    let mut rotYDelta: s32 = 0;
    let mut newRotY: s32 = 0;
    let mut thisRotY: s32 = 0;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        npcAction =
            (*globalCtx).csCtx.npcActions[func_8097C870(this) as usize];
        if !npcAction.is_null() {
            thisRotY = (*thisx).world.rot.y as s32;
            rotYDelta =
                (*npcAction).c2rust_unnamed.rot.y as libc::c_int - thisRotY;
            if rotYDelta >
                   -((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            16 as libc::c_int) as usize] as
                         libc::c_int + 0x96 as libc::c_int) &&
                   rotYDelta <
                       (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int
                                              * 16 as libc::c_int +
                                              16 as libc::c_int) as usize] as
                           libc::c_int + 0x96 as libc::c_int {
                newRotY = (*npcAction).c2rust_unnamed.rot.y as s32
            } else if rotYDelta > 0 as libc::c_int {
                newRotY =
                    thisRotY +
            ...
            (*thisx).shape.rot.y = newRotY as s16;
            (*thisx).world.rot.y = newRotY as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGo_UpdateSkelAnime(mut this: *mut DemoGo)
 -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CDB0(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext,
                                       mut npcAction: u16_0) -> s32 {
    let mut csCtx: *mut CutsceneContext = &mut (*globalCtx).csCtx;
    let mut actionIdx: s32 = func_8097C870(this);
    if (*csCtx).state as libc::c_int != CS_STATE_IDLE as libc::c_int &&
           !(*csCtx).npcActions[actionIdx as usize].is_null() &&
           (*(*csCtx).npcActions[actionIdx as usize]).action as libc::c_int ==
               npcAction as libc::c_int {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CE10(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).action = 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CE20(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097CDB0(this, globalCtx, 2 as libc::c_int as u16_0) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CE78(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut csCtx: *mut CutsceneContext = &mut (*globalCtx).csCtx;
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CEEC(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097CDB0(this, globalCtx, 3 as libc::c_int as u16_0) != 0 {
        (*this).action = 4 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CF20(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    let mut animation: *mut AnimationHeader = &mut gGoronAnim_0029A8;
...
#[no_mangle]
pub unsafe extern "C" fn func_8097CF9C(mut this: *mut DemoGo) {
    (*this).unk_19C += 1.0f32;
    if (*this).unk_19C >= 8.0f32 { (*this).action = 6 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CFDC(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    func_8097CE10(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097CFFC(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    func_8097CE20(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097D01C(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    func_8097CB0C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_8097D058(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    func_8097CA30(this, globalCtx);
    func_8097CEEC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097D088(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097D0D0(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097D130(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    func_8097CCE0(this, globalCtx);
    func_8097CC08(this);
    func_8097CA30(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoGo_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGo = thisx as *mut DemoGo;
    if (*this).action < 0 as libc::c_int || (*this).action >= 7 as libc::c_int
           || D_8097D44C[(*this).action as usize].is_none() {
    ...
    D_8097D44C[(*this).action as
                   usize].expect("non-null function pointer")(this,
                                                              globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGo_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGo = thisx as *mut DemoGo;
    let mut animation: *mut AnimationHeader = &mut gGoronAnim_004930;
...
#[no_mangle]
pub unsafe extern "C" fn func_8097D290(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_8097D29C(mut this: *mut DemoGo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut eyeTexIdx: s16 = (*this).unk_190;
    let mut skelAnime: *mut SkelAnime = &mut (*this).skelAnime;
    let mut eyeTexture: *mut libc::c_void = sEyeTextures[eyeTexIdx as usize];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_go.c\x00" as *const u8 as *const libc::c_char,
                    732 as libc::c_int);
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_go.c\x00" as *const u8 as
                         *const libc::c_char, 746 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGo_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGo = thisx as *mut DemoGo;
    if (*this).drawConfig < 0 as libc::c_int ||
           (*this).drawConfig >= 2 as libc::c_int ||
           D_8097D468[(*this).drawConfig as usize].is_none() {
