...
extern "C" {
    ...
    #[no_mangle]
    static mut gWoodenDoorTex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleDoorKillerTex: [u64_0; 0];
    #[no_mangle]
    static mut object_mizu_objects_Tex_0035C0: [u64_0; 0];
    #[no_mangle]
    static mut object_haka_door_Tex_000000: [u64_0; 0];
    #[no_mangle]
    static mut object_door_killer_DL_001250: [Gfx; 0];
    #[no_mangle]
    static mut object_door_killer_DL_001550: [Gfx; 0];
    #[no_mangle]
    static mut object_door_killer_DL_0017B8: [Gfx; 0];
    #[no_mangle]
    static mut object_door_killer_DL_001A58: [Gfx; 0];
    #[no_mangle]
    static mut object_door_killer_Skel_001BC8: FlexSkeletonHeader;
}
...
pub type C2RustUnnamed_19 = libc::c_int;
pub const PLAYER_DOORTYPE_FAKE: C2RustUnnamed_19 = 3;
pub const PLAYER_DOORTYPE_SLIDING: C2RustUnnamed_19 = 2;
pub const PLAYER_DOORTYPE_HANDLE: C2RustUnnamed_19 = 1;
pub const PLAYER_DOORTYPE_NONE: C2RustUnnamed_19 = 0;
pub const PLAYER_DOORTYPE_AJAR: C2RustUnnamed_19 = -1;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DoorKillerTextureEntry {
    pub objectId: s16,
    pub texture: *mut libc::c_void,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DoorKiller {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub animStyle: u8_0,
    ...
    pub texture: *mut libc::c_void,
    pub hasHitPlayerOrGround: u16_0,
    pub timer: u16_0,
    pub doorObjBankIndex: u8_0,
    pub textureEntryIndex: u8_0,
    pub colliderJntSph: ColliderJntSph,
    pub colliderJntSphItems: [ColliderJntSphElement; 1],
    pub actionFunc: DoorKillerActionFunc,
}
pub type DoorKillerActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DoorKiller, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const DOOR_KILLER_RUBBLE_PIECE_4: C2RustUnnamed_21 = 4;
pub const DOOR_KILLER_RUBBLE_PIECE_3: C2RustUnnamed_21 = 3;
pub const DOOR_KILLER_RUBBLE_PIECE_2: C2RustUnnamed_21 = 2;
pub const DOOR_KILLER_RUBBLE_PIECE_1: C2RustUnnamed_21 = 1;
pub const DOOR_KILLER_DOOR: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut Door_Killer_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DOOR_KILLER as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_DOOR_KILLER as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DoorKiller>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorKiller_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorKiller_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorKiller_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDoorTextures: [DoorKillerTextureEntry; 4] =
    unsafe {
        [{
             let mut init =
                 DoorKillerTextureEntry{objectId:
                                            OBJECT_HIDAN_OBJECTS as
                                                libc::c_int as s16,
                                        texture:
                                            gFireTempleDoorKillerTex.as_ptr()
                                                as *mut _ as
                                                *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DoorKillerTextureEntry{objectId:
                                            OBJECT_MIZU_OBJECTS as libc::c_int
                                                as s16,
                                        texture:
                                            object_mizu_objects_Tex_0035C0.as_ptr()
                                                as *mut _ as
                                                *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DoorKillerTextureEntry{objectId:
                                            OBJECT_HAKA_DOOR as libc::c_int as
                                                s16,
                                        texture:
                                            object_haka_door_Tex_000000.as_ptr()
                                                as *mut _ as
                                                *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DoorKillerTextureEntry{objectId:
                                            OBJECT_GAMEPLAY_KEEP as
                                                libc::c_int as s16,
                                        texture:
                                            gWoodenDoorTex.as_ptr() as *mut _
                                                as *mut libc::c_void,};
             init
         }]
    };
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_Init(mut thisx: *mut Actor,
                                         mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut randF: f32_0 = 0.;
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    let mut bankIndex: s32 = 0;
    let mut i: s32 = 0;
    // Look in the object bank for one of the four objects containing door textures
    bankIndex = -(1 as libc::c_int);
    i = 0 as libc::c_int;
    while bankIndex < 0 as libc::c_int {
        bankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            sDoorTextures[i as usize].objectId);
        (*this).textureEntryIndex = i as u8_0;
        i += 1
    }
    osSyncPrintf(b"bank_ID = %d\n\x00" as *const u8 as *const libc::c_char,
                 bankIndex);
    osSyncPrintf(b"status = %d\n\x00" as *const u8 as *const libc::c_char,
                 (*this).textureEntryIndex as libc::c_int);
    (*this).doorObjBankIndex = bankIndex as u8_0;
    (*this).texture =
        sDoorTextures[(*this).textureEntryIndex as usize].texture;
    ...
    (*this).hasHitPlayerOrGround = 0 as libc::c_int as u16_0;
    (*this).animStyle = 0 as libc::c_int as u8_0;
    (*this).playerIsOpening = 0 as libc::c_int as u8_0;
    match ((*this).actor.params as libc::c_int & 0xff as libc::c_int) as u8_0
              as libc::c_int {
        0 => {
            ...
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut object_door_killer_Skel_001BC8,
                               0 as *mut AnimationHeader,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).jointTable.as_mut_ptr(),
                               9 as libc::c_int);
            (*this).actionFunc =
                Some(DoorKiller_SetProperties as
                         unsafe extern "C" fn(_: *mut DoorKiller,
                                              _: *mut GlobalContext) -> ());
            DoorKiller_SetProperties(this, globalCtx);
            // manually set the overall rotation of the door
            (*this).jointTable[1 as libc::c_int as usize].z =
                0x4000 as libc::c_int as s16;
            (*this).jointTable[1 as libc::c_int as usize].x =
                (*this).jointTable[1 as libc::c_int as usize].z;
            ...
            Collider_SetJntSph(globalCtx, &mut (*this).colliderJntSph,
                               ...
                               (*this).colliderJntSphItems.as_mut_ptr());
            ...
            if (*this).actor.params as libc::c_int >> 8 as libc::c_int &
                   0x3f as libc::c_int != 0x3f as libc::c_int &&
            ...
            (*this).actionFunc =
                Some(DoorKiller_SetProperties as
                         unsafe extern "C" fn(_: *mut DoorKiller,
                                              _: *mut GlobalContext) -> ());
            DoorKiller_SetProperties(this, globalCtx);
            (*this).actor.gravity = -0.6f32;
            (*this).actor.minVelocityY = -6.0f32;
            // Random trajectories for rubble pieces
            randF = Rand_CenteredFloat(8.0f32);
            (*this).actor.velocity.z = Rand_ZeroFloat(8.0f32);
            (*this).actor.velocity.x =
                Math_CosS((*this).actor.world.rot.y) * randF +
                    Math_SinS((*this).actor.world.rot.y) *
                        (*this).actor.velocity.z;
            (*this).actor.velocity.z =
                -Math_SinS((*this).actor.world.rot.y) * randF +
                    Math_CosS((*this).actor.world.rot.y) *
                        (*this).actor.velocity.z;
            (*this).actor.velocity.y = Rand_ZeroFloat(4.0f32) + 4.0f32;
            // These are used as the x,y,z rotational velocities in DoorKiller_FallAsRubble
            (*this).actor.world.rot.x =
                Rand_CenteredFloat(0x1000 as libc::c_int as f32_0) as s16;
            (*this).actor.world.rot.y =
                Rand_CenteredFloat(0x1000 as libc::c_int as f32_0) as s16;
            (*this).actor.world.rot.z =
                Rand_CenteredFloat(0x1000 as libc::c_int as f32_0) as s16;
            (*this).timer = 80 as libc::c_int as u16_0
        }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    if (*thisx).params as libc::c_int & 0xff as libc::c_int ==
           DOOR_KILLER_DOOR as libc::c_int {
        Collider_DestroyCylinder(globalCtx, &mut (*this).colliderCylinder);
        Collider_DestroyJntSph(globalCtx, &mut (*this).colliderJntSph);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_SpawnRubble(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_DOOR_KILLER as libc::c_int as s16, (*thisx).world.pos.x,
                (*thisx).world.pos.y + 9.0f32, (*thisx).world.pos.z,
                (*thisx).shape.rot.x, (*thisx).shape.rot.y,
                (*thisx).shape.rot.z,
                DOOR_KILLER_RUBBLE_PIECE_1 as libc::c_int as s16);
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_DOOR_KILLER as libc::c_int as s16,
                (*thisx).world.pos.x + 7.88f32,
                (*thisx).world.pos.y + 39.8f32, (*thisx).world.pos.z,
                (*thisx).shape.rot.x, (*thisx).shape.rot.y,
                (*thisx).shape.rot.z,
                DOOR_KILLER_RUBBLE_PIECE_2 as libc::c_int as s16);
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_DOOR_KILLER as libc::c_int as s16,
                (*thisx).world.pos.x - 15.86f32,
                (*thisx).world.pos.y + 61.98f32, (*thisx).world.pos.z,
                (*thisx).shape.rot.x, (*thisx).shape.rot.y,
                (*thisx).shape.rot.z,
                DOOR_KILLER_RUBBLE_PIECE_3 as libc::c_int as s16);
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_DOOR_KILLER as libc::c_int as s16,
                (*thisx).world.pos.x + 3.72f32,
                (*thisx).world.pos.y + 85.1f32, (*thisx).world.pos.z,
                (*thisx).shape.rot.x, (*thisx).shape.rot.y,
                (*thisx).shape.rot.z,
                DOOR_KILLER_RUBBLE_PIECE_4 as libc::c_int as s16);
}
/* *
 * action function for the individual door pieces that spawn and fall down when the door is destroyed
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_FallAsRubble(mut this: *mut DoorKiller,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    (*this).actor.velocity.x *= 0.98f32;
    (*this).actor.velocity.z *= 0.98f32;
    ...
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_int +
             (*this).actor.world.rot.z as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_IsHit(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    if (*this).colliderCylinder.base.acFlags as libc::c_int & 2 as libc::c_int
           != 0 && !(*this).colliderCylinder.info.acHitInfo.is_null() {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_SetAC(mut this: *mut DoorKiller,
                                          mut globalCtx: *mut GlobalContext) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_RiseBackUp(mut this: *mut DoorKiller,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut rotation: s16 = 0;
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer = (*this).timer.wrapping_sub(1)
    } else {
        (*this).actionFunc =
            Some(DoorKiller_Wait as
                     unsafe extern "C" fn(_: *mut DoorKiller,
                                          _: *mut GlobalContext) -> ());
    ...
    (*this).actor.shape.rot.x =
        if (*this).timer as libc::c_int >= 8 as libc::c_int {
            ((*this).timer as libc::c_int * 0x800 as libc::c_int) -
                0x4000 as libc::c_int
        } else { 0 as libc::c_int } as s16;
    if (*this).timer as libc::c_int >= 12 as libc::c_int {
        rotation =
            (-((*this).timer as libc::c_int) * -(500 as libc::c_int) -
                 8000 as libc::c_int) as s16
    } else if (*this).timer as libc::c_int >= 8 as libc::c_int {
        rotation = -(2000 as libc::c_int) as s16
    } else if (*this).timer as libc::c_int >= 5 as libc::c_int {
        rotation =
            ((*this).timer as libc::c_int * -(500 as libc::c_int) +
                 2000 as libc::c_int) as s16
    } else { rotation = 0 as libc::c_int as s16 }
    i = 2 as libc::c_int;
    while i < 9 as libc::c_int {
        (*this).jointTable[i as usize].z = -(rotation as libc::c_int) as s16;
        i += 1
    }
    if ((*this).timer as libc::c_int) < 8 as libc::c_int {
        rotation =
            (Math_SinS(((*this).timer as libc::c_int * 0x2000 as libc::c_int)
                           as s16) *
                 (*this).timer as libc::c_int as libc::c_float * 100.0f32) as
                s16;
        i = 2 as libc::c_int;
        while i < 9 as libc::c_int {
            (*this).jointTable[i as usize].y = rotation;
            i += 1
        }
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_FallOver(mut this: *mut DoorKiller,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut rotation: s16 = 0;
    ...
    (*this).actor.shape.rot.x =
        if (*this).timer as libc::c_int >= 4 as libc::c_int {
            (0x8000 as libc::c_int) +
                -((*this).timer as libc::c_int) * 0x1000 as libc::c_int
    ...
    if (*this).timer as libc::c_int >= 6 as libc::c_int {
        ...
        rotation = -(1000 as libc::c_int) as s16
    } else if (*this).timer as libc::c_int >= 3 as libc::c_int {
        rotation =
            ((*this).timer as libc::c_int * -(500 as libc::c_int) +
    ...
    i = 2 as libc::c_int;
    while i < 9 as libc::c_int {
        (*this).jointTable[i as usize].z = rotation;
        i += 1
    }
    if (*this).timer as libc::c_int == 4 as libc::c_int {
        ...
        while j != 20 as libc::c_int {
            pos.y = 0.0f32;
            randF = Rand_CenteredFloat(40.0f32);
            pos.z = Rand_ZeroFloat(100.0f32);
            pos.x =
                Math_CosS((*this).actor.world.rot.y) * randF +
                    Math_SinS((*this).actor.world.rot.y) * pos.z;
            pos.z =
                -Math_SinS((*this).actor.world.rot.y) * randF +
                    Math_CosS((*this).actor.world.rot.y) * pos.z;
            velocity.x = pos.x * 0.2f32;
            velocity.z = pos.z * 0.2f32;
    ...
    if (*this).hasHitPlayerOrGround as libc::c_int & 1 as libc::c_int == 0 {
        let mut playerPosRelToDoor: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut player: *mut Player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        func_8002DBD0(&mut (*this).actor, &mut playerPosRelToDoor,
                      &mut (*player).actor.world.pos);
        if fabsf(playerPosRelToDoor.y) < 20.0f32 &&
               fabsf(playerPosRelToDoor.x) < 20.0f32 &&
               playerPosRelToDoor.z < 100.0f32 &&
               playerPosRelToDoor.z > 0.0f32 {
            (*this).hasHitPlayerOrGround =
                ((*this).hasHitPlayerOrGround as libc::c_int |
                     1 as libc::c_int) as u16_0;
            func_8002F6D4(globalCtx, &mut (*this).actor, 6.0f32,
                          (*this).actor.yawTowardsPlayer, 6.0f32,
                          16 as libc::c_int as u32_0);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39dc as libc::c_int as u16_0);
    ...
    if (*this).hasHitPlayerOrGround as libc::c_int & 1 as libc::c_int == 0 &&
        ...
        (*this).hasHitPlayerOrGround =
            ((*this).hasHitPlayerOrGround as libc::c_int | 1 as libc::c_int)
                as u16_0;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39de as libc::c_int as u16_0);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_Wobble(mut this: *mut DoorKiller,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut rotation: s16 = 0;
    let mut i: s32 = 0;
    if (*this).timer as libc::c_int == 16 as libc::c_int ||
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39db as libc::c_int as u16_0);
    }
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer = (*this).timer.wrapping_sub(1)
    } else {
        (*this).actionFunc =
            Some(DoorKiller_FallOver as
                     unsafe extern "C" fn(_: *mut DoorKiller,
                                          _: *mut GlobalContext) -> ());
        (*this).timer = 8 as libc::c_int as u16_0;
        (*this).hasHitPlayerOrGround =
            ((*this).hasHitPlayerOrGround as libc::c_int &
                 !(1 as libc::c_int)) as u16_0;
        return
    ...
    rotation =
        (Math_SinS(((*this).timer as libc::c_int * 0x2000 as libc::c_int) as
                       s16) * (*this).timer as libc::c_int as libc::c_float *
             100.0f32) as s16;
    i = 2 as libc::c_int;
    while i < 9 as libc::c_int {
        (*this).jointTable[i as usize].y = rotation;
    ...
    rotation =
        ((-Math_CosS(((*this).timer as libc::c_int * 0x1000 as libc::c_int) as
                         s16) * 1000.0f32) as s32 as u16_0 as libc::c_int +
             1000 as libc::c_int) as s16;
    i = 2 as libc::c_int;
    while i < 9 as libc::c_int {
        (*this).jointTable[i as usize].z = rotation;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_WaitBeforeWobble(mut this:
                                                         *mut DoorKiller,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        ...
        (*this).timer = 16 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(DoorKiller_Wobble as
                     unsafe extern "C" fn(_: *mut DoorKiller,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_Wait(mut this: *mut DoorKiller,
                                         mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut playerPosRelToDoor: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut angleToFacingPlayer: s16 = 0;
    func_8002DBD0(&mut (*this).actor, &mut playerPosRelToDoor,
                  &mut (*player).actor.world.pos);
    // playerIsOpening is set by player
    if (*this).playerIsOpening != 0 {
        (*this).actionFunc =
            Some(DoorKiller_WaitBeforeWobble as
                     unsafe extern "C" fn(_: *mut DoorKiller,
                                          _: *mut GlobalContext) -> ());
        (*this).timer = 10 as libc::c_int as u16_0;
        (*this).playerIsOpening = 0 as libc::c_int as u8_0;
        return
    }
    if DoorKiller_IsHit(&mut (*this).actor, globalCtx) != 0 {
        // AC cylinder: wobble if hit by most weapons, die if hit by explosives or hammer
        if (*(*this).colliderCylinder.info.acHitInfo).toucher.dmgFlags &
               0x1ffa6 as libc::c_int as libc::c_uint !=
            ...
            (*this).actionFunc =
                Some(DoorKiller_Wobble as
                         unsafe extern "C" fn(_: *mut DoorKiller,
                                              _: *mut GlobalContext) -> ())
        } else if (*(*this).colliderCylinder.info.acHitInfo).toucher.dmgFlags
                      & 0x48 as libc::c_int as libc::c_uint !=
                      0 as libc::c_int as libc::c_uint {
            DoorKiller_SpawnRubble(&mut (*this).actor, globalCtx);
            (*this).actionFunc =
                Some(DoorKiller_Die as
                         unsafe extern "C" fn(_: *mut DoorKiller,
                                              _: *mut GlobalContext) -> ());
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      20 as libc::c_int,
                                      0x39dd as libc::c_int as u16_0);
        }
    } else if !Actor_GetCollidedExplosive(globalCtx,
                                          &mut (*this).colliderJntSph.base).is_null()
     {
        ...
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                  ...
                  fabsf(playerPosRelToDoor.y) < 20.0f32 &&
                  fabsf(playerPosRelToDoor.x) < 20.0f32 &&
                  playerPosRelToDoor.z < 50.0f32 &&
                  playerPosRelToDoor.z > 0.0f32 {
        ...
        if playerPosRelToDoor.z > 0.0f32 {
            angleToFacingPlayer =
                (0x8000 as libc::c_int - angleToFacingPlayer as libc::c_int)
                    as s16
        }
        if (if angleToFacingPlayer as libc::c_int >= 0 as libc::c_int {
                angleToFacingPlayer as libc::c_int
            } else { -(angleToFacingPlayer as libc::c_int) }) <
               0x3000 as libc::c_int {
            (*player).doorType = PLAYER_DOORTYPE_FAKE as libc::c_int as s8;
            (*player).doorDirection =
                if playerPosRelToDoor.z >= 0.0f32 { 1.0f32 } else { -1.0f32 }
                    as s8;
            (*player).doorActor = &mut (*this).actor
        }
    }
    DoorKiller_SetAC(this, globalCtx);
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_UpdateTexture(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).doorObjBankIndex as
                                           usize].segment as
    ...
    (*this).texture =
        gSegments[(((*this).texture as u32_0) << 4 as libc::c_int >>
            ...
            as *mut libc::c_void;
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*thisx).objBankIndex as usize].segment
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_SetProperties(mut this: *mut DoorKiller,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).doorObjBankIndex as s32) != 0 {
        DoorKiller_UpdateTexture(&mut (*this).actor, globalCtx);
        match (*this).actor.params as libc::c_int & 0xff as libc::c_int {
            ...
            1 | 2 | 3 | 4 => {
                (*this).actionFunc =
                    Some(DoorKiller_FallAsRubble as
                             unsafe extern "C" fn(_: *mut DoorKiller,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).actor.draw =
                    Some(DoorKiller_DrawRubble as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
...
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_SetTexture(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    let mut doorTexture: *mut libc::c_void = (*this).texture;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_door_killer.c\x00" as *const u8 as
    ...
    (*_g).words.w1 = doorTexture as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_door_killer.c\x00" as *const u8 as
                         *const libc::c_char, 885 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_DrawDoor(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut DoorKiller = thisx as *mut DoorKiller;
    func_800943C8((*globalCtx).state.gfxCtx);
    DoorKiller_SetTexture(&mut (*this).actor, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DoorKiller_DrawRubble(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 4] =
        unsafe {
            [object_door_killer_DL_001250.as_ptr() as *mut _,
             object_door_killer_DL_001550.as_ptr() as *mut _,
             object_door_killer_DL_0017B8.as_ptr() as *mut _,
             object_door_killer_DL_001A58.as_ptr() as *mut _]
        };
    let mut rubblePieceIndex: s32 =
    ...
    if (*this).timer as libc::c_int >= 20 as libc::c_int ||
           (*this).timer as libc::c_int & 1 as libc::c_int == 0 as libc::c_int
       {
        ...
        Gfx_DrawDListOpa(globalCtx, dLists[rubblePieceIndex as usize]);
    };
}
