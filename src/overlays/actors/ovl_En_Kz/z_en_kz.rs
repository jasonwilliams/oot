...
extern "C" {
    ...
    #[no_mangle]
    static mut object_kz_Anim_00046C: AnimationHeader;
    #[no_mangle]
    static mut object_kz_Anim_00075C: AnimationHeader;
    #[no_mangle]
    static mut object_kz_Tex_001470: [u64_0; 0];
    #[no_mangle]
    static mut object_kz_Tex_001870: [u64_0; 0];
    #[no_mangle]
    static mut object_kz_Tex_001C70: [u64_0; 0];
    #[no_mangle]
...
pub struct EnKz {
    ...
    pub waypoint: s16,
    pub blinkTimer: s16,
    pub unk_20E: [libc::c_char; 2],
    pub eyeIdx: s16,
    pub cutsceneCamera: s16,
    pub gameplayCamera: s16,
    pub jointTable: [Vec3s; 12],
    pub morphTable: [Vec3s; 12],
    pub unk_2A6: [s16; 12],
    pub unk_2BE: [s16; 12],
}
pub type EnKzActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Kz_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KZ as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_KZ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnKz>() as libc::c_ulong,
                          init:
...
static mut sAnimations: [struct_80034EC0_Entry; 3] =
    unsafe {
        [{
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &object_kz_Anim_00075C as
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_GetTextNoMaskChild(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut this: *mut EnKz)
 -> u16_0 {
    ...
    if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
        ...
        return 0x402b as libc::c_int as u16_0
    } else if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                  libc::c_int & 8 as libc::c_int != 0 {
        return 0x401c as libc::c_int as u16_0
    } else {
        (*player).exchangeItemId = EXCH_ITEM_LETTER_RUTO as libc::c_int as s8;
        return 0x401a as libc::c_int as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_GetTextNoMaskAdult(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut this: *mut EnKz)
 -> u16_0 {
    let mut player: *mut Player =
    ...
    if gSaveContext.inventory.items[gItemSlots[ITEM_POCKET_EGG as libc::c_int
           ...
           libc::c_int >= ITEM_FROG as libc::c_int {
        if gSaveContext.infTable[19 as libc::c_int as usize] as libc::c_int &
            ...
            if gBitFlags[2 as libc::c_int as usize] <<
                ...
                return 0x401f as libc::c_int as u16_0
            } else { return 0x4012 as libc::c_int as u16_0 }
        } else {
            return if gBitFlags[QUEST_SONG_SERENADE as libc::c_int as usize] &
                          gSaveContext.inventory.questItems != 0 {
                       0x4045 as libc::c_int
                   } else { 0x401a as libc::c_int } as u16_0
        }
    } else {
        (*player).exchangeItemId =
            EXCH_ITEM_PRESCRIPTION as libc::c_int as s8;
        return 0x4012 as libc::c_int as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_GetText(mut globalCtx: *mut GlobalContext,
                                      mut thisx: *mut Actor) -> u16_0 {
    let mut this: *mut EnKz = thisx as *mut EnKz;
    let mut reactionText: u16_0 =
        Text_GetFaceReaction(globalCtx, 0x1e as libc::c_int as u32_0);
    ...
    } else { return EnKz_GetTextNoMaskChild(globalCtx, this) };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9C6C0(mut globalCtx: *mut GlobalContext,
    ...
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        6 => {
            ...
            match (*this).actor.textId as libc::c_int {
                16402 => {
                    gSaveContext.infTable[19 as libc::c_int as usize] =
                        (gSaveContext.infTable[19 as libc::c_int as usize] as
        ...
        3 => {
            if (*this).actor.textId as libc::c_int != 0x4014 as libc::c_int {
                if (*this).actor.textId as libc::c_int ==
                       0x401b as libc::c_int && (*this).sfxPlayed == 0 {
                    Audio_PlaySoundGeneral(0x4802 as libc::c_int as u16_0,
                                           &mut D_801333D4,
                                           4 as libc::c_int as u8_0,
                                           &mut D_801333E0, &mut D_801333E0,
                                           &mut D_801333E8);
                    (*this).sfxPlayed = 1 as libc::c_int as u8_0
                }
            } else if (*this).sfxPlayed == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_UpdateEyes(mut this: *mut EnKz) {
    if (if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).blinkTimer -= 1; (*this).blinkTimer as libc::c_int })
           == 0 as libc::c_int {
        (*this).eyeIdx =
            ((*this).eyeIdx as libc::c_int + 1 as libc::c_int) as s16;
        if (*this).eyeIdx as libc::c_int >= 3 as libc::c_int {
            (*this).blinkTimer =
...
#[no_mangle]
pub unsafe extern "C" fn func_80A9C95C(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut EnKz,
                                       mut arg2: *mut s16, mut unkf: f32_0,
                                       mut callback1: callback1_800343CC,
                                       mut callback2: callback2_800343CC)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if *arg2 as libc::c_int != 0 as libc::c_int {
        *arg2 =
            callback2.expect("non-null function pointer")(globalCtx,
                                                          &mut (*this).actor);
        return 0 as libc::c_int
    }
    yaw =
        Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                       &mut (*player).actor.world.pos) as f32_0;
    yaw -= (*this).actor.shape.rot.y as libc::c_int as libc::c_float;
    if fabsf(yaw) > 1638.0f32 || (*this).actor.xzDistToPlayer < 265.0f32 {
        (*this).actor.flags &=
    ...
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp32, &mut sp30);
    if !(sp32 as libc::c_int >= -(30 as libc::c_int) &&
             (sp32 as libc::c_int) < 361 as libc::c_int &&
             sp30 as libc::c_int >= -(10 as libc::c_int) &&
             (sp30 as libc::c_int) < 241 as libc::c_int) {
        return 0 as libc::c_int
    }
    ...
    if func_8002F2CC(&mut (*this).actor, globalCtx, unkf) == 0 as libc::c_int
       {
    ...
    (*this).actor.xzDistToPlayer = xzDistToPlayer;
    (*this).actor.textId =
        callback1.expect("non-null function pointer")(globalCtx,
                                                      &mut (*this).actor);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A9CB18(mut this: *mut EnKz,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if func_80A9C95C(globalCtx, this, &mut (*this).unk_1E0.unk_00, 340.0f32,
                     Some(EnKz_GetText as
                              unsafe extern "C" fn(_: *mut GlobalContext,
                                                   _: *mut Actor) -> u16_0),
                     Some(func_80A9C6C0 as
                              unsafe extern "C" fn(_: *mut GlobalContext,
                                                   _: *mut Actor) -> s16)) !=
           0 {
        if (*this).actor.textId as libc::c_int == 0x401a as libc::c_int &&
               gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 8 as libc::c_int == 0 {
            if func_8002F368(globalCtx) as libc::c_int ==
                   EXCH_ITEM_LETTER_RUTO as libc::c_int {
                (*this).actor.textId = 0x401b as libc::c_int as u16_0;
                (*this).sfxPlayed = 0 as libc::c_int as u8_0
            } else { (*this).actor.textId = 0x401a as libc::c_int as u16_0 }
        ...
        if gSaveContext.linkAge == 0 as libc::c_int {
            if gSaveContext.inventory.items[gItemSlots[ITEM_POCKET_EGG as
                   ...
                   func_8002F368(globalCtx) as libc::c_int ==
                       EXCH_ITEM_PRESCRIPTION as libc::c_int {
                (*this).actor.textId = 0x4014 as libc::c_int as u16_0;
                (*this).sfxPlayed = 0 as libc::c_int as u8_0;
                (*player).actor.textId = (*this).actor.textId;
                (*this).isTrading = 1 as libc::c_int as u8_0;
                return
            }
            (*this).isTrading = 0 as libc::c_int as u8_0;
            if gSaveContext.infTable[19 as libc::c_int as usize] as
                   libc::c_int & 0x200 as libc::c_int != 0 {
                (*this).actor.textId =
                    if gBitFlags[QUEST_SONG_SERENADE as libc::c_int as usize]
                           & gSaveContext.inventory.questItems != 0 {
                        0x4045 as libc::c_int
                    } else { 0x401a as libc::c_int } as u16_0;
                (*player).actor.textId = (*this).actor.textId
                ...
                (*this).actor.textId =
                    if gBitFlags[2 as libc::c_int as usize] <<
                           ...
                           0 {
                        0x401f as libc::c_int
                    } else { 0x4012 as libc::c_int } as u16_0;
                (*player).actor.textId = (*this).actor.textId
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_FollowPath(mut this: *mut EnKz,
                                         mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       ...
                       0xa as libc::c_int as s16, 0x3e8 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    if pathDiffX * pathDiffX + pathDiffZ * pathDiffZ < 10.0f32 {
        (*this).waypoint += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_SetMovedPos(mut this: *mut EnKz,
                                          mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut path: *mut Path = 0 as *mut Path;
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKz = thisx as *mut EnKz;
    let mut pad: s32 = 0;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelanime,
                       &mut object_kz_Skel_0086D0, 0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 12 as libc::c_int);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f64 as f32_0, None,
                    0.0f64 as f32_0);
    ...
    Actor_SetScale(&mut (*this).actor, 0.01f64 as f32_0);
    ...
    if gSaveContext.linkAge == 0 as libc::c_int {
        if gSaveContext.infTable[19 as libc::c_int as usize] as libc::c_int &
            ...
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               ACTOR_BG_ICE_SHELTER as libc::c_int as s16,
                               (*this).actor.world.pos.x,
                               ...
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0x4ff as libc::c_int as s16);
        }
        (*this).actionFunc =
            Some(EnKz_Wait as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ())
    } else {
        (*this).actionFunc =
            Some(EnKz_PreMweepWait as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKz = thisx as *mut EnKz;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_PreMweepWait(mut this: *mut EnKz,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).unk_1E0.unk_00 as libc::c_int == 2 as libc::c_int {
        ...
        (*this).unk_1E0.unk_00 = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnKz_SetupMweep as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ())
    } else {
        func_80034F54(globalCtx, (*this).unk_2A6.as_mut_ptr(),
                      (*this).unk_2BE.as_mut_ptr(), 12 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_SetupMweep(mut this: *mut EnKz,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    Gameplay_ChangeCameraStatus(globalCtx, (*this).gameplayCamera,
                                1 as libc::c_int as s16);
    ...
    initPos.y += -100.0f32;
    initPos.z += 260.0f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).cutsceneCamera, &mut pos,
                            &mut initPos);
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_Mweep(mut this: *mut EnKz,
                                    mut globalCtx: *mut GlobalContext) {
    let mut unused: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    Gameplay_CameraSetAtEye(globalCtx, (*this).cutsceneCamera, &mut pos,
                            &mut initPos);
    if EnKz_FollowPath(this, globalCtx) == 1 as libc::c_int &&
           (*this).waypoint as libc::c_int == 0 as libc::c_int {
        func_80034EC0(&mut (*this).skelanime, sAnimations.as_mut_ptr(),
                      1 as libc::c_int);
        Inventory_ReplaceItem(globalCtx,
                              ITEM_LETTER_RUTO as libc::c_int as u16_0,
                              ITEM_BOTTLE as libc::c_int as u16_0);
        EnKz_SetMovedPos(this, globalCtx);
        ...
        (*this).actionFunc =
            Some(EnKz_StopMweep as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ())
    }
    if (*this).skelanime.curFrame == 13.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x687a as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_StopMweep(mut this: *mut EnKz,
                                        mut globalCtx: *mut GlobalContext) {
    Gameplay_ChangeCameraStatus(globalCtx, (*this).gameplayCamera,
                                7 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_Wait(mut this: *mut EnKz,
                                   mut globalCtx: *mut GlobalContext) {
    if (*this).unk_1E0.unk_00 as libc::c_int == 2 as libc::c_int {
        (*this).actionFunc =
            Some(EnKz_SetupGetItem as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ());
        EnKz_SetupGetItem(this, globalCtx);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_SetupGetItem(mut this: *mut EnKz,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut getItemId: s32 = 0;
    let mut xzRange: f32_0 = 0.;
    let mut yRange: f32_0 = 0.;
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).unk_1E0.unk_00 = 1 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnKz_StartTimer as
                     unsafe extern "C" fn(_: *mut EnKz, _: *mut GlobalContext)
                         -> ())
    } else {
        getItemId =
            if (*this).isTrading as libc::c_int == 1 as libc::c_int {
                GI_FROG as libc::c_int
            } else { GI_TUNIC_ZORA as libc::c_int };
        yRange = fabsf((*this).actor.yDistToPlayer) + 1.0f32;
        xzRange = (*this).actor.xzDistToPlayer + 1.0f32;
        func_8002F434(&mut (*this).actor, globalCtx, getItemId, xzRange,
                      yRange);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_StartTimer(mut this: *mut EnKz,
                                         mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKz = thisx as *mut EnKz;
    let mut pad: s32 = 0;
    if gSaveContext.linkAge == 0 as libc::c_int &&
           gSaveContext.infTable[19 as libc::c_int as usize] as libc::c_int &
               0x100 as libc::c_int == 0 {
        gSaveContext.infTable[19 as libc::c_int as usize] =
            (gSaveContext.infTable[19 as libc::c_int as usize] as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
    ...
    if limbIndex == 8 as libc::c_int || limbIndex == 9 as libc::c_int ||
        ...
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*this).unk_2A6[limbIndex as usize]) * 200.0f32) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*this).unk_2BE[limbIndex as usize]) * 200.0f32) as
                s16
    }
    (limbIndex) != 0;
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnKz_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnKz = thisx as *mut EnKz;
    let mut mult: Vec3f =
        { let mut init = Vec3f{x: 2600.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if limbIndex == 11 as libc::c_int {
        Matrix_MultVec3f(&mut mult, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKz_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut sEyeSegments: [*mut libc::c_void; 3] =
        unsafe {
            [object_kz_Tex_001470.as_ptr() as *mut _ as *mut libc::c_void,
             object_kz_Tex_001870.as_ptr() as *mut _ as *mut libc::c_void,
             object_kz_Tex_001C70.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnKz = thisx as *mut EnKz;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_kz.c\x00" as *const u8 as *const libc::c_char,
                    1259 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((sEyeSegments[(*this).eyeIdx as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sEyeSegments[(*this).eyeIdx as
                                                           usize] as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
