...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffFragments2DL: [Gfx; 0];
    #[no_mangle]
    static mut gEffFireCircleDL: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_00FE40: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_0108B8: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaTubo {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaTuboActionFunc,
    pub dropTimer: s16,
    pub fireScroll: s16,
    pub potCollider: ColliderCylinder,
    pub flamesCollider: ColliderCylinder,
}
pub type BgHakaTuboActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaTubo, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_Tubo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_TUBO as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaTubo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaTubo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaTubo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaTubo_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sPotColliderInit: ColliderCylinderInit =
    {
        let mut init =
...
static mut sFlamesColliderInit: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sPotsDestroyed: s32 = 0 as libc::c_int;
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaTubo = thisx as *mut BgHakaTubo;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut object_haka_objects_Col_0108B8 as
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).potCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).potCollider,
                         &mut (*this).dyna.actor, &mut sPotColliderInit);
    Collider_InitCylinder(globalCtx, &mut (*this).flamesCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).flamesCollider,
                         &mut (*this).dyna.actor, &mut sFlamesColliderInit);
    (*this).fireScroll = (Rand_ZeroOne() * 15.0f32) as s16;
    sPotsDestroyed = 0 as libc::c_int;
    (*this).actionFunc =
        Some(BgHakaTubo_Idle as
                 unsafe extern "C" fn(_: *mut BgHakaTubo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHakaTubo = thisx as *mut BgHakaTubo;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Collider_DestroyCylinder(globalCtx, &mut (*this).potCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).flamesCollider);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_Idle(mut this: *mut BgHakaTubo,
                                         mut globalCtx: *mut GlobalContext) {
    static mut sZeroVector: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).dyna.actor.room as libc::c_int == 12 as libc::c_int {
        // 3 spinning pots room in Shadow Temple
        ...
        (*this).dyna.actor.world.pos.x =
            Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int -
                           0x4000 as libc::c_int) as s16) * 145.0f32 +
                -5559.0f32;
    ...
    if (*this).flamesCollider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).flamesCollider.base.atFlags =
            ((*this).flamesCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        func_8002F71C(globalCtx, &mut (*this).dyna.actor, 5.0f32,
                      (*this).dyna.actor.yawTowardsPlayer, 5.0f32);
    }
    // Colliding with hitbox inside the pot
    if (*this).potCollider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).potCollider.base.acFlags =
            ((*this).potCollider.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        ...
        if Actor_WorldDistXZToPoint(&mut (*this).dyna.actor,
                                    &mut (*(*this).potCollider.base.ac).world.pos)
               < 50.0f32 &&
               (*(*this).potCollider.base.ac).world.pos.y -
                   (*this).dyna.actor.world.pos.y < 50.0f32 {
            pos.x = (*this).dyna.actor.world.pos.x;
            pos.z = (*this).dyna.actor.world.pos.z;
            pos.y = (*this).dyna.actor.world.pos.y + 80.0f32;
            EffectSsBomb2_SpawnLayered(globalCtx, &mut pos, &mut sZeroVector,
                                       &mut sZeroVector,
            ...
            EffectSsHahen_SpawnBurst(globalCtx, &mut pos, 20.0f32,
                                     0 as libc::c_int as s16,
                                     350 as libc::c_int as s16,
                                     100 as libc::c_int as s16,
                                     50 as libc::c_int as s16,
                                     OBJECT_HAKA_OBJECTS as libc::c_int as
                                         s16, 40 as libc::c_int as s16,
                                     gEffFragments2DL.as_mut_ptr());
            (*this).dropTimer = 5 as libc::c_int as s16;
            (*this).dyna.actor.draw = None;
            Actor_SetScale(&mut (*this).dyna.actor, 0.0f32);
            (*this).actionFunc =
                Some(BgHakaTubo_DropCollectible as
                         unsafe extern "C" fn(_: *mut BgHakaTubo,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).flamesCollider);
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).potCollider);
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).potCollider.base);
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).flamesCollider.base);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).flamesCollider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_DropCollectible(mut this: *mut BgHakaTubo,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    let mut i: s32 = 0;
    let mut collectibleParams: s32 = 0;
    (*this).dropTimer -= 1;
    if (*this).dropTimer as libc::c_int == 0 as libc::c_int {
        // Creates a delay between destroying the pot and dropping the collectible
        spawnPos.x = (*this).dyna.actor.world.pos.x;
        spawnPos.y = (*this).dyna.actor.world.pos.y + 200.0f32;
        spawnPos.z = (*this).dyna.actor.world.pos.z;
        if (*this).dyna.actor.room as libc::c_int == 12 as libc::c_int {
            // 3 spinning pots room in Shadow Temple
            rnd = Rand_ZeroOne();
            sPotsDestroyed += 1;
            if sPotsDestroyed == 3 as libc::c_int {
                // All 3 pots destroyed
                collectibleParams = -(1 as libc::c_int);
                ...
                while i < 9 as libc::c_int {
                    collectible =
                        Item_DropCollectible(globalCtx, &mut spawnPos,
                                             (i % 3 as libc::c_int) as s16);
                    if !collectible.is_null() {
                        (*collectible).actor.velocity.y = 15.0f32;
                        (*collectible).actor.world.rot.y =
                            ((*this).dyna.actor.shape.rot.y as libc::c_int +
                                 i * 0x1c71 as libc::c_int) as s16
                    }
                    i += 1
                }
            } else if rnd < 0.2f32 {
                ...
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_FIREFLY as libc::c_int as s16,
                            (*this).dyna.actor.world.pos.x,
                ...
                // Random rewards
                if rnd < 0.4f32 {
                    collectibleParams = ITEM00_BOMBS_A as libc::c_int
                } else if rnd < 0.6f32 {
                    collectibleParams = ITEM00_MAGIC_LARGE as libc::c_int
                } else if rnd < 0.8f32 {
                    collectibleParams = ITEM00_MAGIC_SMALL as libc::c_int
                } else {
                    collectibleParams = ITEM00_ARROWS_SMALL as libc::c_int
                }
                func_80078884(0x4807 as libc::c_int as u16_0);
            }
        } else if Flags_GetCollectible(globalCtx,
                                       (*this).dyna.actor.params as s32) !=
                      0 as libc::c_int {
            // If small key already collected, drop recovery heart instead
            collectibleParams = ITEM00_HEART as libc::c_int;
            func_80078884(0x4807 as libc::c_int as u16_0);
        } else {
        ...
        if collectibleParams != -(1 as libc::c_int) {
            collectible =
                Item_DropCollectible(globalCtx, &mut spawnPos,
                                     collectibleParams as s16);
            if !collectible.is_null() {
                (*collectible).actor.velocity.y = 15.0f32;
                (*collectible).actor.world.rot.y =
                    (*this).dyna.actor.shape.rot.y
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaTubo = thisx as *mut BgHakaTubo;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_DrawFlameCircle(mut this: *mut BgHakaTubo,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_haka_tubo.c\x00" as *const u8 as
                        *const libc::c_char, 476 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    Matrix_Translate((*this).dyna.actor.world.pos.x,
                     (*this).dyna.actor.world.pos.y + 235.0f32,
                     (*this).dyna.actor.world.pos.z,
    ...
    Matrix_Scale(0.07f32, 0.04f32, 0.07f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ((*this).fireScroll as libc::c_int &
                              127 as libc::c_int) as u32_0,
                         0 as libc::c_int as u32_0, 32 as libc::c_int,
                         64 as libc::c_int, 1 as libc::c_int,
                         0 as libc::c_int as u32_0,
                         ((*this).fireScroll as libc::c_int *
                              -(15 as libc::c_int) & 0xff as libc::c_int) as
                             u32_0, 32 as libc::c_int, 64 as libc::c_int) as
            libc::c_uint;
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gEffFireCircleDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_haka_tubo.c\x00" as *const u8 as
                         *const libc::c_char, 501 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaTubo_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaTubo = thisx as *mut BgHakaTubo;
    Gfx_DrawDListOpa(globalCtx, object_haka_objects_DL_00FE40.as_mut_ptr());
