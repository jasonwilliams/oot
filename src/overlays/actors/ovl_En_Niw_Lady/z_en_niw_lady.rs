...
extern "C" {
    ...
    #[no_mangle]
    static mut gCuccoLadyEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gCuccoLadyEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gCuccoLadyEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gObjOsAnim_0718: AnimationHeader;
    #[no_mangle]
    static mut gObjOsAnim_07D0: AnimationHeader;
    #[no_mangle]
    static mut gObjOsAnim_9F94: AnimationHeader;
    #[no_mangle]
    static mut gObjOsAnim_A630: AnimationHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNiwLady {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
    pub actionFunc: EnNiwLadyActionFunc,
    pub unk_254: Vec3s,
    pub unk_25A: Vec3s,
    pub unusedTimer: s16,
    pub unk_262: s16,
    pub unusedTimer2: s16,
    pub unusedRandomTimer: s16,
    pub cuccosInPen: s16,
    pub unk_26A: s16,
    pub unk_26C: s16,
    pub unk_26E: s16,
    ...
    pub faceState: s16,
    pub unk_27E: s16,
    pub objectAneIndex: s8,
    pub objectOsAnimeIndex: s8,
    pub getItemId: s32,
    pub unk_288: struct_80034A14_arg1,
    pub collider: ColliderCylinder,
}
pub type EnNiwLadyActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNiwLady, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNiw {
...
#[no_mangle]
pub static mut En_Niw_Lady_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NIW_LADY as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_ANE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnNiwLady>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNiwLady_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNiwLady_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sMissingCuccoTextIds: [s16; 10] =
    [0x5036 as libc::c_int as s16, 0x5070 as libc::c_int as s16,
     0x5072 as libc::c_int as s16, 0x5037 as libc::c_int as s16,
     0x5038 as libc::c_int as s16, 0x5039 as libc::c_int as s16,
     0x503a as libc::c_int as s16, 0x503b as libc::c_int as s16,
     0x503d as libc::c_int as s16, 0x503c as libc::c_int as s16];
static mut D_80ABB3B4: [s16; 7] =
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNiwLady = thisx as *mut EnNiwLady;
    (*this).objectAneIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_ANE as libc::c_int as s16) as s8;
    (*this).objectOsAnimeIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_OS_ANIME as libc::c_int as s16) as s8;
    if ((*this).objectOsAnimeIndex as libc::c_int) < 0 as libc::c_int ||
           ((*this).objectAneIndex as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(thisx);
        return
    }
    (*this).unk_278 = 0 as libc::c_int as s16;
    if (*globalCtx).sceneNum as libc::c_int == SCENE_LABO as libc::c_int {
        (*this).unk_278 = 1 as libc::c_int as s16
    }
    if (*this).unk_278 as libc::c_int != 0 as libc::c_int &&
           gSaveContext.nightFlag == 0 as libc::c_int {
        Actor_Kill(thisx);
        return
    }
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x83\xe3\x82\x93\xe3\x81\x86\xe3\x81\xa3\xe3\x81\xb5\xe3\x82\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).unk_278 as libc::c_int);
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    (*this).actionFunc =
        Some(func_80AB9F24 as
                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                      _: *mut GlobalContext) -> ());
    (*thisx).uncullZoneForward = 600.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnNiwLady = thisx as *mut EnNiwLady;
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_ChoseAnimation(mut this: *mut EnNiwLady,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut arg2: s32) {
    let mut frames: f32_0 = 0.;
    if Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0) as
           libc::c_int != 0 as libc::c_int {
        arg2 = 8 as libc::c_int
    }
    if arg2 != (*this).unk_270 as libc::c_int {
        (*this).unk_275 = 0 as libc::c_int as u8_0;
        (*this).unk_276 = 1 as libc::c_int as u8_0;
        (*this).unk_270 = arg2 as s16;
        let mut current_block_15: u64;
        match arg2 {
            10 => {
                (*this).unk_275 = 1 as libc::c_int as u8_0;
                current_block_15 = 14211870259702523226;
            }
            9 => { current_block_15 = 14211870259702523226; }
            0 | 1 | 2 | 3 | 4 | 5 | 6 | 8 | 21 | 22 | 24 | 29 => {
                frames =
                    Animation_GetLastFrame(&mut gObjOsAnim_9F94 as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_9F94,
            ...
            7 | 20 | 23 | 25 | 26 | 27 | 28 => {
                frames =
                    Animation_GetLastFrame(&mut gObjOsAnim_0718 as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_0718,
                                 1.0f32, 0.0f32, frames,
                                 ANIMMODE_LOOP as libc::c_int as u8_0,
                                 -10.0f32);
                current_block_15 = 6669252993407410313;
            ...
            100 => {
                frames =
                    Animation_GetLastFrame(&mut gObjOsAnim_A630 as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_A630,
                                 1.0f32, 0.0f32, frames,
                                 ANIMMODE_LOOP as libc::c_int as u8_0,
                                 -10.0f32);
                (*this).unk_276 = 0 as libc::c_int as u8_0;
                current_block_15 = 6669252993407410313;
            }
            _ => { current_block_15 = 6669252993407410313; }
        }
        match current_block_15 {
            14211870259702523226 => {
                frames =
                    Animation_GetLastFrame(&mut gObjOsAnim_07D0 as
                                               *mut AnimationHeader as
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_07D0,
                                 1.0f32, 0.0f32, frames,
                                 ANIMMODE_LOOP as libc::c_int as u8_0,
                                 -10.0f32);
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB9F24(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 = 0.;
    let mut pad: s32 = 0;
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).objectAneIndex as s32) != 0 &&
           Object_IsLoaded(&mut (*globalCtx).objectCtx,
                           (*this).objectOsAnimeIndex as s32) != 0 {
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objectAneIndex as
                                               usize].segment as
                 *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize)) as
                u32_0;
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut gCuccoLadySkel, 0 as *mut AnimationHeader,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           16 as libc::c_int);
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objectOsAnimeIndex as
                                               usize].segment as
                 *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize)) as
                u32_0;
        (*this).unk_27E = 1 as libc::c_int as s16;
        ...
        (*this).unk_272 = 0 as libc::c_int as u8_0;
        (*this).actor.targetMode = 6 as libc::c_int as s8;
        (*this).actor.draw =
            Some(EnNiwLady_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        match (*this).unk_278 as libc::c_int {
            0 => {
                if gSaveContext.itemGetInf[0 as libc::c_int as usize] as
                    ...
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut gObjOsAnim_A630, 1.0f32, 0.0f32,
                                     frames as s16 as f32_0,
                                     ANIMMODE_LOOP as libc::c_int as u8_0,
                                     0.0f32);
                } else {
                    frames =
                        Animation_GetLastFrame(&mut gObjOsAnim_07D0 as
                            ...
                            f32_0;
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut gObjOsAnim_07D0, 1.0f32, 0.0f32,
                                     frames as s16 as f32_0,
                                     ANIMMODE_LOOP as libc::c_int as u8_0,
                                     0.0f32);
                }
                if gSaveContext.linkAge == 0 as libc::c_int {
                    (*this).actionFunc =
                        Some(func_80ABA778 as
                                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                                      _: *mut GlobalContext)
                                     -> ())
                } else {
                    (*this).actionFunc =
                        Some(func_80ABA21C as
                                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
            ...
            1 => {
                frames =
                    Animation_GetLastFrame(&mut gObjOsAnim_07D0 as
                                               ...
                                               *mut libc::c_void) as f32_0;
                Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_07D0,
                                 1.0f32, 0.0f32, frames as s16 as f32_0,
                                 ANIMMODE_LOOP as libc::c_int as u8_0,
                                 0.0f32);
                (*this).actionFunc =
                    Some(func_80ABAD38 as
                             unsafe extern "C" fn(_: *mut EnNiwLady,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABA21C(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.textId =
        sMissingCuccoTextIds[0 as libc::c_int as usize] as u16_0;
    (*this).unk_262 = TEXT_STATE_DONE as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80ABA244 as
                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABA244(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    let mut currentCucco: *mut EnNiw = 0 as *mut EnNiw;
    let mut phi_s1: s32 = 0;
    (*this).cuccosInPen = 0 as libc::c_int as s16;
    currentCucco =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PROP as libc::c_int as
                                             usize].head as *mut EnNiw;
    while !currentCucco.is_null() {
        if (*currentCucco).actor.id as libc::c_int ==
               ACTOR_EN_NIW as libc::c_int {
            if fabsf((*currentCucco).actor.world.pos.x - 330.0f32) < 90.0f32
                   &&
                   fabsf((*currentCucco).actor.world.pos.z - 1610.0f32) <
                       190.0f32 {
                if (*this).unk_26C as libc::c_int == 0 as libc::c_int {
                    gSaveContext.infTable[25 as libc::c_int as usize] =
                        (gSaveContext.infTable[25 as libc::c_int as usize] as
                             libc::c_int |
                             D_80ABB3B4[(*currentCucco).unk_2AA as usize] as
                                 libc::c_int) as u16_0;
                    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int
                        ...
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86 \xe9\xb6\x8f\xe6\x9f\xb5\xe5\x86\x85\xef\xbc\xa7\xef\xbc\xa5\xef\xbc\xb4\xef\xbc\x81\xe2\x98\x86 %x\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     D_80ABB3B4[(*currentCucco).unk_2AA as
                                                    usize] as libc::c_int);
                    }
                }
                (*this).cuccosInPen += 1
            } else if (*this).unk_26C as libc::c_int == 0 as libc::c_int {
                gSaveContext.infTable[25 as libc::c_int as usize] =
                    (gSaveContext.infTable[25 as libc::c_int as usize] as
                         libc::c_int &
                         !(D_80ABB3B4[(*currentCucco).unk_2AA as usize] as
        ...
        currentCucco = (*currentCucco).actor.next as *mut EnNiw
    }
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
    ...
    phi_s1 = (*this).cuccosInPen as s32;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).unk_26E = 101 as libc::c_int as s16
    }
    if (*this).cuccosInPen as libc::c_int >= 7 as libc::c_int {
        phi_s1 = 8 as libc::c_int;
        if ((*this).unk_26C as libc::c_int) < 2 as libc::c_int &&
               (*this).unk_26C as libc::c_int == 0 as libc::c_int {
            phi_s1 = 7 as libc::c_int
        }
    }
    if (*this).unk_26C as libc::c_int != 0 as libc::c_int &&
           phi_s1 < 7 as libc::c_int {
        phi_s1 = 9 as libc::c_int
    }
    (*this).actor.textId = sMissingCuccoTextIds[phi_s1 as usize] as u16_0;
    if Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0) as
           libc::c_int != 0 as libc::c_int {
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0);
        (*this).unk_262 = TEXT_STATE_DONE as libc::c_int as s16
    }
    if (*this).unk_26C as libc::c_int != 0 as libc::c_int &&
           phi_s1 != 9 as libc::c_int {
        phi_s1 = 10 as libc::c_int;
        (*this).unk_26E = 11 as libc::c_int as s16
    }
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x83\xe3\x82\x93\xe9\x81\xb8\xe6\x8a\x9e\t \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, phi_s1);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x83\xe3\x82\x93\xe3\x83\x8f\xe3\x83\xbc\xe3\x83\x88     \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).unk_26C as libc::c_int);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x83\xe3\x82\x93\xe4\xbf\x9d\xe5\xad\x98       \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).unk_26A as libc::c_int);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xad\xe3\x81\x87\xe3\x81\xa1\xe3\x82\x83\xe3\x82\x93\xe4\xbb\x8a\t \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).cuccosInPen as libc::c_int);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->actor.talk_message \xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.textId as libc::c_int);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->message_end_code   \xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).unk_262 as libc::c_int);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        if Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0) as
               libc::c_int == 0 as libc::c_int {
            if (*this).actor.textId as libc::c_int == 0x503c as libc::c_int {
                func_80078884(0x4806 as libc::c_int as u16_0);
                (*this).unk_26C = 2 as libc::c_int as s16;
                (*this).unk_262 = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_80ABA654 as
                             unsafe extern "C" fn(_: *mut EnNiwLady,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
            }
            (*this).unk_26E = (phi_s1 + 1 as libc::c_int) as s16;
            if phi_s1 == 7 as libc::c_int {
                func_80078884(0x4807 as libc::c_int as u16_0);
                (*this).unk_26C = 1 as libc::c_int as s16;
                (*this).unk_262 = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).unk_26A = (*this).cuccosInPen;
                osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9f\xb5\xe5\x86\x85BIT\xe5\xa4\x89\xe6\x9b\xb4\xe5\x89\x8d \xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             gSaveContext.infTable[25 as libc::c_int as usize]
                                 as libc::c_int);
                gSaveContext.infTable[25 as libc::c_int as usize] =
                ...
                osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9f\xb5\xe5\x86\x85BIT\xe5\xa4\x89\xe6\x9b\xb4\xe5\xbe\x8c \xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             gSaveContext.infTable[25 as libc::c_int as usize]
                                 as libc::c_int);
                osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            ...
            if (*this).unk_26A as libc::c_int !=
                   (*this).cuccosInPen as libc::c_int {
                if ((*this).cuccosInPen as libc::c_int) <
                       (*this).unk_26A as libc::c_int {
                    func_80078884(0x4806 as libc::c_int as u16_0);
                } else if (phi_s1 + 1 as libc::c_int) < 9 as libc::c_int {
                    func_80078884(0x4807 as libc::c_int as u16_0);
                }
            }
            if ((*this).unk_26A as libc::c_int) <
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABA654(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_262 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_CloseTextbox(globalCtx);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x8f\xe3\x83\xbc\xe3\x83\x88 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).unk_26C as libc::c_int);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x88\x86\xe5\xbc\xbe   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).unk_272 as libc::c_int);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        (*this).unk_26E = 0xb as libc::c_int as s16;
        if gSaveContext.itemGetInf[0 as libc::c_int as usize] as libc::c_int &
               0x1000 as libc::c_int == 0 {
            (*this).actor.parent = 0 as *mut Actor;
            (*this).getItemId = GI_BOTTLE as libc::c_int;
            func_8002F434(&mut (*this).actor, globalCtx,
                          GI_BOTTLE as libc::c_int, 100.0f32, 50.0f32);
            (*this).actionFunc =
                Some(func_80ABAC00 as
                         unsafe extern "C" fn(_: *mut EnNiwLady,
                                              _: *mut GlobalContext) -> ());
            return
        }
        if (*this).unk_26C as libc::c_int == 1 as libc::c_int {
            (*this).getItemId = GI_RUPEE_PURPLE as libc::c_int;
            func_8002F434(&mut (*this).actor, globalCtx,
                          GI_RUPEE_PURPLE as libc::c_int, 100.0f32, 50.0f32);
            (*this).actionFunc =
                Some(func_80ABAC00 as
                         unsafe extern "C" fn(_: *mut EnNiwLady,
                                              _: *mut GlobalContext) -> ())
...
static mut sTradeItemTextIds: [s16; 11] =
    [0x503e as libc::c_int as s16, 0x503f as libc::c_int as s16,
     0x5047 as libc::c_int as s16, 0x5040 as libc::c_int as s16,
     0x5042 as libc::c_int as s16, 0x5043 as libc::c_int as s16,
     0x5044 as libc::c_int as s16, 0xcf as libc::c_int as s16,
     0x5045 as libc::c_int as s16, 0x5042 as libc::c_int as s16,
     0x5027 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn func_80ABA778(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    // "☆☆☆☆☆ Adult message check ☆☆☆☆☆"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa2\xe3\x83\x80\xe3\x83\xab\xe3\x83\x88\xe3\x83\xa1\xe3\x83\x83\xe3\x82\xbb\xe3\x83\xbc\xe3\x82\xb8\xe3\x83\x81\xe3\x82\xa7\xe3\x83\x83\xe3\x82\xaf \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).unk_262 = TEXT_STATE_DONE as libc::c_int as s16;
    (*this).unk_273 = 0 as libc::c_int as u8_0;
    if gSaveContext.itemGetInf[2 as libc::c_int as usize] as libc::c_int &
           0x1000 as libc::c_int == 0 {
        if (*this).unk_274 as libc::c_int != 0 as libc::c_int {
            (*this).unk_27A = 1 as libc::c_int as s16
        } else { (*this).unk_27A = 0 as libc::c_int as s16 }
        (*this).unk_273 = 1 as libc::c_int as u8_0;
        (*this).unk_262 = TEXT_STATE_CHOICE as libc::c_int as s16
    } else {
        (*this).unk_27A = 2 as libc::c_int as s16;
        if gSaveContext.itemGetInf[2 as libc::c_int as usize] as libc::c_int &
               0x4000 as libc::c_int == 0 {
            (*this).unk_27A = 3 as libc::c_int as s16;
            if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                   libc::c_int & 0x400 as libc::c_int != 0 {
                (*this).unk_27A = 9 as libc::c_int as s16;
                if (*this).unk_277 as libc::c_int != 0 as libc::c_int {
                    (*this).unk_27A = 10 as libc::c_int as s16
                }
            } else { (*this).unk_27A = 4 as libc::c_int as s16 }
        }
    }
    (*this).actor.textId =
        sTradeItemTextIds[(*this).unk_27A as usize] as u16_0;
    (*this).actionFunc =
        Some(func_80ABA878 as
                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABA878(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut playerExchangeItemId: s8 = 0;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_NONE as libc::c_int ||
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
               TEXT_STATE_DONE as libc::c_int {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        if playerExchangeItemId as libc::c_int == 6 as libc::c_int &&
               gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                   libc::c_int & 0x400 as libc::c_int != 0 {
            func_80078884(0x4807 as libc::c_int as u16_0);
            (*player).actor.textId =
                sTradeItemTextIds[5 as libc::c_int as usize] as u16_0;
            (*this).unk_26E =
                ((*this).unk_27A as libc::c_int + 21 as libc::c_int) as s16;
            (*this).unk_262 = TEXT_STATE_CHOICE as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80ABAB08 as
                         unsafe extern "C" fn(_: *mut EnNiwLady,
                                              _: *mut GlobalContext) -> ())
        } else if playerExchangeItemId as libc::c_int != 0 as libc::c_int {
            (*player).actor.textId =
                sTradeItemTextIds[7 as libc::c_int as usize] as u16_0;
            (*this).unk_26E =
                ((*this).unk_27A as libc::c_int + 21 as libc::c_int) as s16
        } else {
        ...
        func_8002F298(&mut (*this).actor, globalCtx, 50.0f32,
                      6 as libc::c_int as u32_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABA9B8(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_262 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                (*this).actor.parent = 0 as *mut Actor;
                func_8002F434(&mut (*this).actor, globalCtx,
                              GI_POCKET_EGG as libc::c_int, 200.0f32,
                              100.0f32);
                (*this).actionFunc =
                    Some(func_80ABAC00 as
                             unsafe extern "C" fn(_: *mut EnNiwLady,
            ...
            1 => {
                (*this).actor.textId =
                    sTradeItemTextIds[3 as libc::c_int as usize] as u16_0;
                (*this).unk_26E =
                    ((*this).unk_27A as libc::c_int + 21 as libc::c_int) as
                        s16;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                (*this).unk_262 = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_80ABAA9C as
                             unsafe extern "C" fn(_: *mut EnNiwLady,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABAA9C(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_26E = 11 as libc::c_int as s16;
    if (*this).unk_262 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABAB08(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_262 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                (*this).actor.parent = 0 as *mut Actor;
                func_8002F434(&mut (*this).actor, globalCtx,
                              GI_COJIRO as libc::c_int, 200.0f32, 100.0f32);
                (*this).actionFunc =
                    Some(func_80ABAC00 as
                             unsafe extern "C" fn(_: *mut EnNiwLady,
                                                  _: *mut GlobalContext)
            ...
            1 => {
                Message_CloseTextbox(globalCtx);
                (*this).unk_277 = 1 as libc::c_int as u8_0;
                (*this).actor.textId =
                    sTradeItemTextIds[8 as libc::c_int as usize] as u16_0;
                (*this).unk_26E =
                    ((*this).unk_27A as libc::c_int + 21 as libc::c_int) as
                        s16;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABAC00(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    let mut getItemId: s32 = 0;
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80ABAC84 as
                     unsafe extern "C" fn(_: *mut EnNiwLady,
                                          _: *mut GlobalContext) -> ())
    } else {
        ...
        if gSaveContext.linkAge == 0 as libc::c_int {
            getItemId =
                if gSaveContext.itemGetInf[2 as libc::c_int as usize] as
                       libc::c_int & 0x1000 as libc::c_int == 0 {
                    GI_POCKET_EGG as libc::c_int
                } else { GI_COJIRO as libc::c_int }
        }
        func_8002F434(&mut (*this).actor, globalCtx, getItemId, 200.0f32,
                      100.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABAC84(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int !=
           TEXT_STATE_DONE as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABAD38(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe9\x80\x9a\xe5\xb8\xb8\xe3\x83\xa1\xe3\x83\x83\xe3\x82\xbb\xe3\x83\xbc\xe3\x82\xb8\xe3\x83\x81\xe3\x82\xa7\xe3\x83\x83\xe3\x82\xaf \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).unk_262 = TEXT_STATE_DONE as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80ABAD7C as
                 unsafe extern "C" fn(_: *mut EnNiwLady,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABAD7C(mut this: *mut EnNiwLady,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.textId = 0x503d as libc::c_int as u16_0;
    if Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0) as
           libc::c_int != 0 as libc::c_int {
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx, 8 as libc::c_int as u32_0)
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
               TEXT_STATE_DONE as libc::c_int {
        (*this).unk_26E = 8 as libc::c_int as s16
    }
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).unk_274 = 1 as libc::c_int as u8_0;
        (*this).unk_26E =
            ((*this).unk_27A as libc::c_int + 9 as libc::c_int) as s16;
        (*this).actionFunc =
            Some(func_80ABAD38 as
                     unsafe extern "C" fn(_: *mut EnNiwLady,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNiwLady = thisx as *mut EnNiwLady;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Actor_SetFocus(thisx, 60.0f32);
    (*this).unk_288.unk_18 = (*player).actor.world.pos;
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        (*this).unk_288.unk_18.y = (*player).actor.world.pos.y - 10.0f32
    }
    func_80034A14(thisx, &mut (*this).unk_288, 2 as libc::c_int as s16,
                  4 as libc::c_int as s16);
    (*this).unk_254 = (*this).unk_288.unk_08;
    (*this).unk_25A = (*this).unk_288.unk_0E;
    if (*this).unk_276 as libc::c_int == 0 as libc::c_int {
        Math_SmoothStepToS(&mut (*this).unk_254.y, 0 as libc::c_int as s16,
    ...
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).objectOsAnimeIndex as
            ...
            u32_0;
    if (*this).objectOsAnimeIndex as libc::c_int >= 0 as libc::c_int {
        if (*this).unk_27E as libc::c_int != 0 as libc::c_int {
            if (*this).unk_26E as libc::c_int != 0 as libc::c_int {
                (*this).unk_26E -= 1;
                EnNiwLady_ChoseAnimation(this, globalCtx,
                                         (*this).unk_26E as s32);
                (*this).unk_26E = 0 as libc::c_int as s16
            }
        ...
        (*this).objectAneIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_ANE as libc::c_int as s16) as s8;
        if (*this).objectAneIndex as libc::c_int >= 0 as libc::c_int {
            (*this).actionFunc.expect("non-null function pointer")(this,
                                                                   globalCtx);
            if (*this).unusedTimer2 as libc::c_int != 0 as libc::c_int {
                (*this).unusedTimer2 -= 1
            }
            if (*this).unusedRandomTimer as libc::c_int != 0 as libc::c_int {
                (*this).unusedRandomTimer -= 1
            }
            (*this).unusedTimer += 1;
            if (*this).unusedRandomTimer as libc::c_int == 0 as libc::c_int {
                (*this).faceState += 1;
                if (*this).faceState as libc::c_int >= 3 as libc::c_int {
                    (*this).faceState = 0 as libc::c_int as s16;
                    (*this).unusedRandomTimer =
                        (Rand_ZeroFloat(60.0f32) as s16 as libc::c_int +
                             0x14 as libc::c_int) as s16
                }
            }
            Actor_UpdateBgCheckInfo(globalCtx, thisx, 20.0f32, 20.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABB0A0(mut gfxCtx: *mut GraphicsContext)
 -> *mut Gfx {
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 15 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_254.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_254.x as libc::c_int) as
                s16
    }
    if limbIndex == 8 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_25A.y as libc::c_int) as
                s16
    }
    if (*this).unk_275 as libc::c_int != 0 as libc::c_int {
        if limbIndex == 8 as libc::c_int || limbIndex == 10 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwLady_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut sEyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gCuccoLadyEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gCuccoLadyEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gCuccoLadyEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnNiwLady = thisx as *mut EnNiwLady;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_niw_lady.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((sEyeTextures[(*this).faceState as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(sEyeTextures[(*this).faceState
                                                               as usize] as
                                                  u32_0 &
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_niw_lady.c\x00" as *const u8 as
                         *const libc::c_char, 1370 as libc::c_int);
}
