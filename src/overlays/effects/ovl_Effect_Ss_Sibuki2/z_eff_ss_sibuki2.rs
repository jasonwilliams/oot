...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffUnusedBubbles1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubbles8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffUnusedBubblesDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_Sibuki2_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_SIBUKI2 as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsSibuki2_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki2_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              ...
                                              mut initParamsx:
                                                  *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsSibuki2InitParams =
        initParamsx as *mut EffectSsSibuki2InitParams;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).life = 10 as libc::c_int as s16;
    (*this).draw =
        Some(EffectSsSibuki2_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsSibuki2_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[0 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[1 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[2 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[4 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[5 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[6 as libc::c_int as usize] = 100 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki2_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    static mut bubbleTextures: [*mut libc::c_void; 9] =
        unsafe {
            [gEffUnusedBubbles1Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles1Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles2Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles3Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles4Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles5Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles6Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles7Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffUnusedBubbles8Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_sibuki2.c\x00" as *const u8 as
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gSegments[((bubbleTextures[(*this).regs[8 as libc::c_int as usize] as
                                       usize] as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(bubbleTextures[(*this).regs[8 as
                                                                          libc::c_int
                                                                          as
                                                                          usize]
                                                             as usize] as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gSegments[((gEffUnusedBubblesDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffUnusedBubblesDL.as_mut_ptr() as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki2_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
