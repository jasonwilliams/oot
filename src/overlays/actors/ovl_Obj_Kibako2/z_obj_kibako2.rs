...
extern "C" {
    ...
    #[no_mangle]
    static mut gLargeCrateDL: [Gfx; 0];
    #[no_mangle]
    static mut gLargeCrateCol: CollisionHeader;
    #[no_mangle]
    static mut gLargeCrateFragmentDL: [Gfx; 0];
}
...
pub struct ObjKibako2 {
    ...
    pub collider: ColliderCylinder,
    pub actionFunc: ObjKibako2ActionFunc,
    pub collectibleFlag: s16,
}
pub type ObjKibako2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjKibako2, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Obj_Kibako2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_KIBAKO2 as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_KIBAKO2 as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjKibako2>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako2_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako2_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako2_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_InitCollider(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut ObjKibako2 = thisx as *mut ObjKibako2;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Break(mut this: *mut ObjKibako2,
    ...
    while i < 0x10 as libc::c_int {
        ...
        temp_rand = Rand_ZeroOne() * 30.0f32;
        pos.x = sn * temp_rand;
        pos.y = Rand_ZeroOne() * 10.0f32 + 2.0f32;
        pos.z = cs * temp_rand;
        velocity.x = pos.x * 0.2f32;
        velocity.y = Rand_ZeroOne() * 10.0f32 + 2.0f32;
        velocity.z = pos.z * 0.2f32;
        pos.x += (*thisPos).x;
        pos.y += (*thisPos).y;
        pos.z += (*thisPos).z;
        temp_rand = Rand_ZeroOne();
        if temp_rand < 0.05f32 {
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             -(200 as libc::c_int) as s16, phi_s0 as s16,
                             28 as libc::c_int as s16,
                             2 as libc::c_int as s16, 0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 30.0f32 + 5.0f32) as s16,
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             70 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_KIBAKO2 as libc::c_int as s16,
                             gLargeCrateFragmentDL.as_mut_ptr());
        i += 1;
        angle = (angle as libc::c_int + 0x4e20 as libc::c_int) as s16
    }
    func_80033480(globalCtx, thisPos, 90.0f32, 6 as libc::c_int,
                  100 as libc::c_int as s16, 160 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_SpawnCollectible(mut this:
                                                         *mut ObjKibako2,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut itemDropped: s16 = 0;
    let mut collectibleFlagTemp: s16 = 0;
    collectibleFlagTemp = (*this).collectibleFlag;
    itemDropped = (*this).dyna.actor.home.rot.x;
    if itemDropped as libc::c_int >= 0 as libc::c_int &&
           (itemDropped as libc::c_int) < 0x1a as libc::c_int {
        Item_DropCollectible(globalCtx, &mut (*this).dyna.actor.world.pos,
                             (itemDropped as libc::c_int |
                                  (collectibleFlagTemp as libc::c_int) <<
                                      8 as libc::c_int) as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjKibako2 = thisx as *mut ObjKibako2;
    let mut pad: s16 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut bgId: u32_0 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gLargeCrateCol as *mut CollisionHeader as
                                   *mut libc::c_void, &mut colHeader);
    bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, colHeader) as u32_0;
    (*this).collectibleFlag =
        ((*this).dyna.actor.home.rot.z as libc::c_int & 0x3f as libc::c_int)
            as s16;
    (*this).dyna.bgId = bgId as s32;
    (*this).actionFunc =
        Some(ObjKibako2_Idle as
                 unsafe extern "C" fn(_: *mut ObjKibako2,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.shape.rot.x = 0 as libc::c_int as s16;
    (*this).dyna.actor.world.rot.x = (*this).dyna.actor.shape.rot.x;
    (*this).dyna.actor.shape.rot.z = (*this).dyna.actor.world.rot.x;
    ...
    osSyncPrintf(b"\xe6\x9c\xa8\xe7\xae\xb1(\xe6\x8d\xae\xe7\xbd\xae)(arg %04xH)(item %04xH %d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int,
                 (*this).collectibleFlag as libc::c_int,
                 (*this).dyna.actor.home.rot.x as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut ObjKibako2 = thisx as *mut ObjKibako2;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Idle(mut this: *mut ObjKibako2,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).dyna.actor.home.rot.z as libc::c_int != 0 as libc::c_int ||
           !func_80033684(globalCtx, &mut (*this).dyna.actor).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Kill(mut this: *mut ObjKibako2,
                                         mut globalCtx: *mut GlobalContext) {
    let mut params: s16 = (*this).dyna.actor.params;
    if params as libc::c_int & 0x8000 as libc::c_int == 0 as libc::c_int {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_SW as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjKibako2 = thisx as *mut ObjKibako2;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako2_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gLargeCrateDL.as_mut_ptr());
}
