...
extern "C" {
    ...
    #[no_mangle]
    fn Flags_UnsetClear(globalCtx: *mut GlobalContext, flag: s32);
    #[no_mangle]
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriBigstDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriBigstCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriBigst {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriBigstActionFunc,
    pub waitTimer: s16,
    pub moriTexObjIndex: s8,
}
pub type BgMoriBigstActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriBigst, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Mori_Bigst_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_BIGST as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriBigst>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriBigst_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriBigst_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriBigst_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupAction(mut this: *mut BgMoriBigst,
                                                 mut actionFunc:
                                                     BgMoriBigstActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_InitDynapoly(mut this: *mut BgMoriBigst,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut collision:
                                                      *mut CollisionHeader,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_mori_bigst.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriBigst = thisx as *mut BgMoriBigst;
    // "mori (bigST.keyceiling)"
    osSyncPrintf(b"mori (bigST.\xe9\x8d\xb5\xe5\x9e\x8b\xe5\xa4\xa9\xe4\xba\x95)(arg : %04x)(sw %d)(noE %d)(roomC %d)(playerPosY %f)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int,
                 Flags_GetSwitch(globalCtx,
                                 (*this).dyna.actor.params as libc::c_int >>
                                     8 as libc::c_int & 0x3f as libc::c_int),
                 Flags_GetTempClear(globalCtx,
                                    (*this).dyna.actor.room as s32),
                 Flags_GetClear(globalCtx, (*this).dyna.actor.room as s32),
                 (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                         libc::c_int as
                                                         usize].head as
                        *mut Player)).actor.world.pos.y as libc::c_double);
    BgMoriBigst_InitDynapoly(this, globalCtx, &mut gMoriBigstCol,
    ...
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        ...
        osSyncPrintf(b"\xe3\x80\x90\xe3\x83\x93\xe3\x83\x83\xe3\x82\xb0\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xab\xe3\x83\x95\xe3\x82\xa9\xe3\x82\xb9\xe9\x8d\xb5\xe5\x9e\x8b\xe5\xa4\xa9\xe4\xba\x95\xe3\x80\x91 \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x8d\xb1\xe9\x99\xba\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char);
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y + 270.0f32
    }
    Actor_SetFocus(&mut (*this).dyna.actor, 50.0f32);
    BgMoriBigst_SetupWaitForMoriTex(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriBigst = thisx as *mut BgMoriBigst;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupWaitForMoriTex(mut this:
                                                             *mut BgMoriBigst,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    BgMoriBigst_SetupAction(this,
                            Some(BgMoriBigst_WaitForMoriTex as
                                     unsafe extern "C" fn(_: *mut BgMoriBigst,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_WaitForMoriTex(mut this:
                                                        *mut BgMoriBigst,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        if Flags_GetClear(globalCtx, (*thisx).room as s32) != 0 &&
               (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                       libc::c_int as
                                                       usize].head as
                      *mut Player)).actor.world.pos.y > 700.0f32 {
            if Flags_GetSwitch(globalCtx,
                               (*thisx).params as libc::c_int >>
                                   8 as libc::c_int & 0x3f as libc::c_int) !=
                   0 {
                BgMoriBigst_SetupDone(this, globalCtx);
            } else { BgMoriBigst_SetupStalfosFight(this, globalCtx); }
        } else { BgMoriBigst_SetupNoop(this, globalCtx); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupNoop(mut this: *mut BgMoriBigst,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    BgMoriBigst_SetupAction(this, None);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupStalfosFight(mut this:
                                                           *mut BgMoriBigst,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut stalfos: *mut Actor = 0 as *mut Actor;
    BgMoriBigst_SetupAction(this,
                            Some(BgMoriBigst_StalfosFight as
                                     unsafe extern "C" fn(_: *mut BgMoriBigst,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    Flags_UnsetClear(globalCtx, (*this).dyna.actor.room as s32);
    stalfos =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_EN_TEST as libc::c_int as s16, 209.0f32,
                           827.0f32, -3320.0f32, 0 as libc::c_int as s16,
    ...
    if !stalfos.is_null() {
        ...
        osSyncPrintf(b"Warning : \xe7\xac\xac\xef\xbc\x92\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xab\xe3\x83\x95\xe3\x82\xa9\xe3\x82\xb9\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    Flags_SetClear(globalCtx, (*this).dyna.actor.room as s32);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_StalfosFight(mut this: *mut BgMoriBigst,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).dyna.actor.home.rot.z as libc::c_int == 0 as libc::c_int &&
           (*this).dyna.actor.home.pos.y - 5.0f32 <=
               (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                       libc::c_int as
                                                       usize].head as
                      *mut Player)).actor.world.pos.y {
        BgMoriBigst_SetupFall(this, globalCtx);
        OnePointCutscene_Init(globalCtx, 3220 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupFall(mut this: *mut BgMoriBigst,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    BgMoriBigst_SetupAction(this,
                            Some(BgMoriBigst_Fall as
                                     unsafe extern "C" fn(_: *mut BgMoriBigst,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Fall(mut this: *mut BgMoriBigst,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).dyna.actor.world.pos.y <= (*this).dyna.actor.home.pos.y {
        ...
        OnePointCutscene_Init(globalCtx, 1020 as libc::c_int as s16,
                              8 as libc::c_int as s16,
                              &mut (*this).dyna.actor,
                              0 as libc::c_int as s16);
        func_8002DF38(globalCtx, 0 as *mut Actor,
                      0x3c as libc::c_int as u8_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupLanding(mut this: *mut BgMoriBigst,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut quake: s32 = 0;
    BgMoriBigst_SetupAction(this,
                            Some(BgMoriBigst_Landing as
                                     unsafe extern "C" fn(_: *mut BgMoriBigst,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    (*this).waitTimer = 18 as libc::c_int as s16;
    quake =
        Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize],
                  3 as libc::c_int as u32_0) as s32;
    Quake_SetSpeed(quake as s16, 25000 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Landing(mut this: *mut BgMoriBigst,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupStalfosPairFight(mut this:
                                                               *mut BgMoriBigst,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    let mut stalfos1: *mut Actor = 0 as *mut Actor;
    let mut stalfos2: *mut Actor = 0 as *mut Actor;
    BgMoriBigst_SetupAction(this,
                            Some(BgMoriBigst_StalfosPairFight as
                                     unsafe extern "C" fn(_: *mut BgMoriBigst,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    ...
    stalfos1 =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_EN_TEST as libc::c_int as s16, 70.0f32,
                           827.0f32, -3383.0f32, 0 as libc::c_int as s16,
                           0 as libc::c_int as s16, 0 as libc::c_int as s16,
    ...
    if !stalfos1.is_null() {
        ...
        osSyncPrintf(b"Warning : \xe7\xac\xac\xef\xbc\x93-1\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xab\xe3\x83\x95\xe3\x82\xa9\xe3\x82\xb9\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    stalfos2 =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_EN_TEST as libc::c_int as s16, 170.0f32,
                           827.0f32, -3260.0f32, 0 as libc::c_int as s16,
                           0 as libc::c_int as s16, 0 as libc::c_int as s16,
                           5 as libc::c_int as s16);
    if !stalfos2.is_null() {
        (*this).dyna.actor.child = 0 as *mut Actor;
        ...
        osSyncPrintf(b"Warning : \xe7\xac\xac\xef\xbc\x93-2\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xab\xe3\x83\x95\xe3\x82\xa9\xe3\x82\xb9\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    Flags_SetClear(globalCtx, (*this).dyna.actor.room as s32);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_StalfosPairFight(mut this:
                                                          *mut BgMoriBigst,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*this).dyna.actor.home.rot.z as libc::c_int == 0 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_SetupDone(mut this: *mut BgMoriBigst,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    BgMoriBigst_SetupAction(this, None);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriBigst = thisx as *mut BgMoriBigst;
    ...
    if func_80043590(&mut (*this).dyna) != 0 {
        func_80074CE8(globalCtx, 6 as libc::c_int as u32_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriBigst_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriBigst = thisx as *mut BgMoriBigst;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gMoriBigstDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_mori_bigst.c\x00" as *const u8 as
                         *const libc::c_char, 553 as libc::c_int);
}
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).minVelocityY as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(-(12000 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
