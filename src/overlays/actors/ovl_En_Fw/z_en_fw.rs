...
extern "C" {
    ...
    #[no_mangle]
    static mut gFlareDancerCoreInitRunCycleAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerDL_7928: [Gfx; 0];
    #[no_mangle]
    static mut gFlareDancerSquareParticleDL: [Gfx; 0];
    #[no_mangle]
    static mut gFlareDancerCoreSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gFlareDancerCoreRunCycleAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerCoreEndRunCycleAnim: AnimationHeader;
    #[no_mangle]
...
pub struct EnFw {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnFwActionFunc,
    pub collider: ColliderJntSph,
    pub sphs: [ColliderJntSphElement; 1],
    pub bompPos: Vec3f,
    pub lastDmgHook: u8_0,
    pub runDirection: s16,
    pub bounceCnt: s16,
    pub unk_206: [libc::c_char; 2],
    pub damageTimer: s16,
    pub explosionTimer: s16,
    pub unk_20C: [libc::c_char; 2],
    pub slideTimer: s16,
    pub slideSfxTimer: s16,
    pub returnToParentTimer: s16,
    pub turnAround: s16,
    pub runRadius: f32_0,
    pub jointTable: [Vec3s; 11],
    pub morphTable: [Vec3s; 11],
    pub effects: [EnFwEffect; 20],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFwEffect {
    pub type_0: u8_0,
    pub timer: u8_0,
...
pub type EnFwActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFw, _: *mut GlobalContext) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
    pub actor: Actor,
...
#[no_mangle]
pub static mut En_Fw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FW as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnFw>() as libc::c_ulong,
                          init:
...
static mut D_80A1FB94: CollisionCheckInfoInit2 =
    {
        let mut init =
            CollisionCheckInfoInit2{health: 8 as libc::c_int as u8_0,
...
static mut D_80A1FBA0: [struct_80034EC0_Entry; 3] =
    unsafe {
        [{
             let mut init =
         ...
         },
         {
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gFlareDancerCoreRunCycleAnim as
         ...
         },
         {
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gFlareDancerCoreEndRunCycleAnim as
                                               *const AnimationHeader as
                                               *mut AnimationHeader,
                                       playbackSpeed: 1.0f32,
                                       startFrame: 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_DoBounce(mut this: *mut EnFw,
                                       mut totalBounces: s32,
                                       mut yVelocity: f32_0) -> s32 {
    ...
    (*this).bounceCnt -= 1;
    if (*this).bounceCnt as libc::c_int <= 0 as libc::c_int {
        if (*this).bounceCnt as libc::c_int == 0 as libc::c_int {
            (*this).bounceCnt = 0 as libc::c_int as s16;
            (*this).actor.velocity.y = 0.0f32;
            return 1 as libc::c_int
        }
        (*this).bounceCnt = totalBounces as s16
    }
    (*this).actor.velocity.y = yVelocity;
    (*this).actor.velocity.y *=
        (*this).bounceCnt as f32_0 / totalBounces as libc::c_float;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_PlayerInRange(mut this: *mut EnFw,
 ...
 -> s32 {
    ...
    let mut bgId: s32 = 0;
    let mut collisionPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).actor.xzDistToPlayer > 300.0f32 { return 0 as libc::c_int }
    if (if ((*this).actor.yawTowardsPlayer as f32_0 -
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_GetPosAdjAroundCircle(mut dst: *mut Vec3f,
                                                    mut this: *mut EnFw,
                                                    mut radius: f32_0,
                                                    mut dir: s16)
 -> *mut Vec3f {
    let mut angle: s16 = 0;
    let mut posAdj: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    // increase rotation around circle ~30 degrees.
    angle =
        (Math_Vec3f_Yaw(&mut (*(*this).actor.parent).home.pos,
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_CheckCollider(mut this: *mut EnFw,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut info: *mut ColliderInfo = 0 as *mut ColliderInfo;
    let mut phi_return: s32 = 0;
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        info =
            &mut (*(*this).collider.elements.offset(0 as libc::c_int as
                                                        isize)).info;
        if (*(*info).acHitInfo).toucher.dmgFlags &
               0x80 as libc::c_int as libc::c_uint != 0 {
            (*this).lastDmgHook = 1 as libc::c_int as u8_0
        } else { (*this).lastDmgHook = 0 as libc::c_int as u8_0 }
        ...
        if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int <=
               0 as libc::c_int {
            if (*(*this).actor.parent).colChkInfo.health as libc::c_int <=
                   8 as libc::c_int {
                ...
                (*(*this).actor.parent).colChkInfo.health =
                    ((*(*this).actor.parent).colChkInfo.health as libc::c_int
                         - 8 as libc::c_int) as u8_0
            }
            (*this).returnToParentTimer = 0 as libc::c_int as s16
        }
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_SpawnDust(mut this: *mut EnFw, mut timer: u8_0,
                                        mut scale: f32_0,
                                        mut scaleStep: f32_0,
                                        mut dustCnt: s32, mut radius: f32_0,
                                        mut xzAccel: f32_0, mut yAccel: f32_0)
 -> s32 {
    let mut pos: Vec3f =
    ...
    pos.y = (*this).actor.floorHeight + 2.0f32;
    angle =
    ...
    while i >= 0 as libc::c_int {
        ...
        EnFw_AddDust(this, &mut pos, &mut velocity, &mut accel, timer, scale,
                     scaleStep);
        angle =
            (angle as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFw = thisx as *mut EnFw;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gFlareDancerCoreSkel, 0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 11 as libc::c_int);
    func_80034EC0(&mut (*this).skelAnime, D_80A1FBA0.as_mut_ptr(),
                  0 as libc::c_int);
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(0x10 as libc::c_int),
                            &mut D_80A1FB94);
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).runDirection = -((*this).actor.params as libc::c_int) as s16;
    (*this).actionFunc =
        Some(EnFw_Bounce as
                 unsafe extern "C" fn(_: *mut EnFw, _: *mut GlobalContext)
                     -> ());
    (*this).actor.gravity = -1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFw = thisx as *mut EnFw;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_Bounce(mut this: *mut EnFw,
                                     mut globalCtx: *mut GlobalContext) {
    if EnFw_DoBounce(this, 3 as libc::c_int, 8.0f32) != 0 &&
           (*this).bounceCnt as libc::c_int == 0 as libc::c_int {
        (*this).returnToParentTimer =
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_Run(mut this: *mut EnFw,
                                  mut globalCtx: *mut GlobalContext) {
    let mut tmpAngle: f32_0 = 0.;
    let mut phi_v0: s16 = 0;
    let mut facingDir: f32_0 = 0.;
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    let mut flareDancer: *mut Actor = 0 as *mut Actor;
    Math_SmoothStepToF(&mut (*this).skelAnime.playSpeed, 1.0f32, 0.1f32,
                       1.0f32, 0.0f32);
    if (*this).skelAnime.animation ==
           &mut gFlareDancerCoreInitRunCycleAnim as *mut AnimationHeader as
               *mut libc::c_void {
        if Animation_OnFrame(&mut (*this).skelAnime,
                             (*this).skelAnime.endFrame) == 0 as libc::c_int {
            (*this).runRadius =
                Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                   &mut (*(*this).actor.parent).world.pos);
            func_80034EC0(&mut (*this).skelAnime, D_80A1FBA0.as_mut_ptr(),
                          2 as libc::c_int);
        }
        return
    }
    if (*this).damageTimer as libc::c_int == 0 as libc::c_int &&
           (*this).explosionTimer as libc::c_int == 0 as libc::c_int &&
           EnFw_CheckCollider(this, globalCtx) != 0 {
        if (*(*this).actor.parent).colChkInfo.health as libc::c_int >
               0 as libc::c_int {
            if (*this).lastDmgHook == 0 { (*this).actor.velocity.y = 6.0f32 }
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3980 as libc::c_int as u16_0);
            (*this).damageTimer = 20 as libc::c_int as s16
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3980 as libc::c_int as u16_0);
            (*this).explosionTimer = 6 as libc::c_int as s16
        }
        (*this).actor.speedXZ = 0.0f32
    }
    if (*this).explosionTimer as libc::c_int != 0 as libc::c_int {
        (*this).skelAnime.playSpeed = 0.0f32;
        Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.024999999f32,
                           0.08f32, 0.6f32, 0.0f32);
        ...
        if (*this).explosionTimer as libc::c_int == 0 as libc::c_int {
            bomb =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ...
                            (*this).bompPos.x, (*this).bompPos.y,
                            (*this).bompPos.z, 0 as libc::c_int as s16,
                            0 as libc::c_int as s16,
            ...
            (*flareDancer).params =
                ((*flareDancer).params as libc::c_int | 0x4000 as libc::c_int)
                    as s16;
        ...
        if (*this).damageTimer as libc::c_int == 0 as libc::c_int {
        } else { (*this).damageTimer -= 1 };
        if 200.0f32 - (*this).runRadius < 0.9f32 {
            if (if (*this).returnToParentTimer as libc::c_int ==
                       0 as libc::c_int {
                    0 as libc::c_int
                } else {
                    (*this).returnToParentTimer -= 1;
                    (*this).returnToParentTimer as libc::c_int
                }) == 0 as libc::c_int {
                (*this).actor.speedXZ = 0.0f32;
                (*this).actionFunc =
                    Some(EnFw_TurnToParentInitPos as
                             unsafe extern "C" fn(_: *mut EnFw,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
            }
        ...
        Math_SmoothStepToF(&mut (*this).runRadius, 200.0f32, 0.3f32, 100.0f32,
                           0.0f32);
        if (*this).turnAround != 0 {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32,
                               1.0f32, 0.0f32);
            tmpAngle =
                ((*this).actor.world.rot.y as libc::c_int ^
                     0x8000 as libc::c_int) as s16 as f32_0;
            facingDir = (*this).actor.shape.rot.y as f32_0;
            tmpAngle =
                Math_SmoothStepToF(&mut facingDir, tmpAngle, 0.1f32,
                                   10000.0f32, 0.0f32);
            (*this).actor.shape.rot.y = facingDir as s16;
            if tmpAngle > 0x1554 as libc::c_int as libc::c_float { return }
            (*this).turnAround = 0 as libc::c_int as s16
        } else {
            let mut sp48: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            EnFw_GetPosAdjAroundCircle(&mut sp48, this, (*this).runRadius,
                                       (*this).runDirection);
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                               (Math_FAtan2F(sp48.x, sp48.z) *
        ...
        if (*this).slideTimer as libc::c_int == 0 as libc::c_int &&
               EnFw_PlayerInRange(this, globalCtx) != 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x398b as libc::c_int as u16_0);
            (*this).slideSfxTimer = 8 as libc::c_int as s16;
            (*this).slideTimer = 8 as libc::c_int as s16
        }
        if (*this).slideTimer as libc::c_int != 0 as libc::c_int {
            if (if (*this).slideSfxTimer as libc::c_int == 0 as libc::c_int {
                    0 as libc::c_int
                } else {
                    (*this).slideSfxTimer -= 1;
                    (*this).slideSfxTimer as libc::c_int
                }) == 0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3982 as libc::c_int as u16_0);
                (*this).slideSfxTimer = 4 as libc::c_int as s16
            }
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32,
                               1.0f32, 0.0f32);
            (*this).skelAnime.playSpeed = 0.0f32;
            EnFw_SpawnDust(this, 8 as libc::c_int as u8_0, 0.16f32, 0.2f32,
                           3 as libc::c_int, 8.0f32, 20.0f32,
                           (Rand_ZeroOne() - 0.5f32) * 0.2f32 + 0.3f32);
            (*this).slideTimer -= 1;
            if (*this).slideTimer as libc::c_int == 0 as libc::c_int {
                (*this).turnAround = 1 as libc::c_int as s16;
                (*this).runDirection =
                    -((*this).runDirection as libc::c_int) as s16
            }
        } else {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, 6.0f32, 0.1f32,
                               1.0f32, 0.0f32);
            phi_v0 = (*this).skelAnime.curFrame as s16;
            if phi_v0 as libc::c_int == 1 as libc::c_int ||
                   phi_v0 as libc::c_int == 4 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x397f as libc::c_int as u16_0);
                EnFw_SpawnDust(this, 8 as libc::c_int as u8_0, 0.16f32,
                               0.1f32, 1 as libc::c_int, 0.0f32, 20.0f32,
                               0.0f32);
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_TurnToParentInitPos(mut this: *mut EnFw,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut angleToParentInit: s16 = 0;
    angleToParentInit =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                       &mut (*(*this).actor.parent).home.pos);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, angleToParentInit,
                       4 as libc::c_int as s16, 0xfa0 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    if (if angleToParentInit as libc::c_int -
               (*this).actor.shape.rot.y as libc::c_int >= 0 as libc::c_int {
            (angleToParentInit as libc::c_int) -
        ...
        func_80034EC0(&mut (*this).skelAnime, D_80A1FBA0.as_mut_ptr(),
                      1 as libc::c_int);
        (*this).actionFunc =
            Some(EnFw_JumpToParentInitPos as
                     unsafe extern "C" fn(_: *mut EnFw, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_JumpToParentInitPos(mut this: *mut EnFw,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
           (*this).actor.velocity.y <= 0.0f32 {
        (*(*this).actor.parent).params =
            ((*(*this).actor.parent).params as libc::c_int |
                 0x8000 as libc::c_int) as s16;
        Actor_Kill(&mut (*this).actor);
    } else {
        Math_SmoothStepToF(&mut (*this).actor.world.pos.x,
                           (*(*this).actor.parent).home.pos.x, 0.6f32, 8.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).actor.world.pos.z,
                           (*(*this).actor.parent).home.pos.z, 0.6f32, 8.0f32,
                           0.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFw_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFw = thisx as *mut EnFw;
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_OverrideLimbDraw(mut globalContext:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    ...
    if limbIndex == 2 as libc::c_int {
        // body
        Matrix_MultVec3f(&mut zeroVec, &mut (*this).bompPos);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFw = thisx as *mut EnFw;
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_AddDust(mut this: *mut EnFw,
                                      mut initialPos: *mut Vec3f,
                                      mut initialSpeed: *mut Vec3f,
                                      mut accel: *mut Vec3f,
                                      mut initialTimer: u8_0,
                                      mut scale: f32_0,
                                      mut scaleStep: f32_0) {
    let mut eff: *mut EnFwEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFwEffect; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFwEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).type_0 as libc::c_int != 1 as libc::c_int {
            (*eff).scale = scale;
            (*eff).scaleStep = scaleStep;
            (*eff).timer = initialTimer;
            (*eff).initialTimer = (*eff).timer;
            (*eff).type_0 = 1 as libc::c_int as u8_0;
            (*eff).pos = *initialPos;
            (*eff).accel = *accel;
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_UpdateDust(mut this: *mut EnFw) {
    let mut eff: *mut EnFwEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
        ...
        if (*eff).type_0 as libc::c_int != 0 as libc::c_int {
            ...
            if (*eff).timer as libc::c_int == 0 as libc::c_int {
                (*eff).type_0 = 0 as libc::c_int as u8_0
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnFw_DrawDust(mut this: *mut EnFw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fw.c\x00" as *const u8 as *const libc::c_char,
                    1191 as libc::c_int);
    ...
    while (i as libc::c_int) <
        ...
        if (*eff).type_0 as libc::c_int != 0 as libc::c_int {
            if firstDone == 0 {
                (*__gfxCtx).polyXlu.p =
                    Gfx_CallSetupDL((*__gfxCtx).polyXlu.p, 0 as libc::c_uint);
            ...
            (*_g_3).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_fw.c\x00" as *const u8 as
