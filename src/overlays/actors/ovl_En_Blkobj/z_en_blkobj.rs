...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gIllusionRoomNormalDL: [Gfx; 0];
    #[no_mangle]
    static mut gIllusionRoomIllusionDL: [Gfx; 0];
    #[no_mangle]
    static mut gIllusionRoomCol: CollisionHeader;
}
...
pub struct EnBlkobj {
    ...
    pub alpha: s16,
    pub timer: s16,
    pub actionFunc: EnBlkobjActionFunc,
}
pub type EnBlkobjActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBlkobj, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Blkobj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BLKOBJ as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BLKOBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBlkobj>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBlkobj_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBlkobj_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_SetupAction(mut this: *mut EnBlkobj,
                                              mut actionFunc:
                                                  EnBlkobjActionFunc) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBlkobj = thisx as *mut EnBlkobj;
    ...
    if Flags_GetClear(globalCtx, (*this).dyna.actor.room as s32) != 0 {
        ...
        EnBlkobj_SetupAction(this,
                             Some(EnBlkobj_DoNothing as
                                      unsafe extern "C" fn(_: *mut EnBlkobj,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
    } else {
        CollisionHeader_GetVirtual(&mut gIllusionRoomCol as
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBlkobj = thisx as *mut EnBlkobj;
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_Wait(mut this: *mut EnBlkobj,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).dyna.actor.xzDistToPlayer < 120.0f32 {
        EnBlkobj_SetupAction(this,
                             Some(EnBlkobj_SpawnDarkLink as
                                      unsafe extern "C" fn(_: *mut EnBlkobj,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
    }
    (*player).stateFlags2 |= 0x4000000 as libc::c_int as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_SpawnDarkLink(mut this: *mut EnBlkobj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).dyna.actor.flags &
           ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_uint == 0 {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_TORCH2 as libc::c_int as s16,
        ...
        EnBlkobj_SetupAction(this,
                             Some(EnBlkobj_DarkLinkFight as
                                      unsafe extern "C" fn(_: *mut EnBlkobj,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_DarkLinkFight(mut this: *mut EnBlkobj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut alphaMod: s32 = 0;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if Actor_Find(&mut (*globalCtx).actorCtx,
                      ACTOR_EN_TORCH2 as libc::c_int,
                      ACTORCAT_BOSS as libc::c_int).is_null() {
        ...
        if fresh0 as libc::c_int > 100 as libc::c_int {
            alphaMod =
                (*this).timer as libc::c_int - 100 as libc::c_int >>
                    2 as libc::c_int;
            if alphaMod > 5 as libc::c_int { alphaMod = 5 as libc::c_int }
            (*this).alpha = ((*this).alpha as libc::c_int + alphaMod) as s16;
                                     ...
                                     Some(EnBlkobj_DoNothing as
                                              unsafe extern "C" fn(_:
                                                                   ...
                                                                   _:
                                                                       *mut GlobalContext)
                                                  -> ()));
                DynaPoly_DeleteBgActor(globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_DoNothing(mut this: *mut EnBlkobj,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBlkobj = thisx as *mut EnBlkobj;
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_DrawAlpha(mut globalCtx: *mut GlobalContext,
                                            mut dList: *mut Gfx,
                                            mut alpha: s32) {
    let mut segment: *mut Gfx = 0 as *mut Gfx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_blkobj.c\x00" as *const u8 as
                        *const libc::c_char, 322 as libc::c_int);
    if alpha == 255 as libc::c_int {
        segment = sSetupOpaDL.as_mut_ptr()
    } else { segment = sSetupXluDL.as_mut_ptr() }
    ...
    (*_g).words.w1 = segment as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnBlkobj_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBlkobj = thisx as *mut EnBlkobj;
    let mut illusionAlpha: s32 = 0;
    ...
    gameplayFrames =
        (*globalCtx).gameplayFrames.wrapping_rem(128 as libc::c_int as
                                                     libc::c_uint);
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         gameplayFrames, 0 as libc::c_int as u32_0,
                         32 as libc::c_int, 32 as libc::c_int,
                         1 as libc::c_int, gameplayFrames,
    ...
    if (*this).alpha as libc::c_int != 0 as libc::c_int {
        EnBlkobj_DrawAlpha(globalCtx, gIllusionRoomNormalDL.as_mut_ptr(),
                           (*this).alpha as s32);
    }
    illusionAlpha = 255 as libc::c_int - (*this).alpha as libc::c_int;
    if illusionAlpha != 0 as libc::c_int {
        EnBlkobj_DrawAlpha(globalCtx, gIllusionRoomIllusionDL.as_mut_ptr(),
                           illusionAlpha);
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_blkobj.c\x00" as *const u8 as
