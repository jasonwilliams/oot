...
extern "C" {
    ...
    fn Message_StartTextbox(globalCtx: *mut GlobalContext, textId: u16_0,
                            actor: *mut Actor);
    #[no_mangle]
    static mut object_haka_objects_DL_005A70: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_00D330: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_00E408: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_00E910: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_00ED7C: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaShip {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaShipActionFunc,
    pub counter: u8_0,
    pub switchFlag: u8_0,
    pub yOffset: s16,
    pub bellSoundPos: Vec3f,
}
pub type BgHakaShipActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaShip, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_Ship_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_SHIP as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaShip_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaShip_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaShip_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaShip_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaShip = thisx as *mut BgHakaShip;
    let mut pad: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut object_haka_objects_Col_00E408 as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).counter = 8 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgHakaShip_WaitForSong as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    } else {
        CollisionHeader_GetVirtual(&mut object_haka_objects_Col_00ED7C as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).actionFunc =
            Some(BgHakaShip_ChildUpdatePosition as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).dyna.bgId =
    ...
    (*this).yOffset = 0 as libc::c_int as s16;
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int &&
           Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                              &mut (*this).dyna.actor, globalCtx,
                              ACTOR_BG_HAKA_SHIP as libc::c_int as s16,
                              (*this).dyna.actor.world.pos.x + -10.0f32,
                              (*this).dyna.actor.world.pos.y + 82.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHakaShip = thisx as *mut BgHakaShip;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Audio_StopSfxByPos(&mut (*this).bellSoundPos);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_ChildUpdatePosition(mut this:
                                                            *mut BgHakaShip,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut parent: *mut Actor = (*this).dyna.actor.parent;
    if !parent.is_null() && (*parent).update.is_some() {
        (*this).dyna.actor.world.pos.x = (*parent).world.pos.x + -10.0f32;
        (*this).dyna.actor.world.pos.y = (*parent).world.pos.y + 82.0f32;
        (*this).dyna.actor.world.pos.z = (*parent).world.pos.z
    } else { (*this).dyna.actor.parent = 0 as *mut Actor };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_WaitForSong(mut this: *mut BgHakaShip,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        if (*this).counter != 0 {
            (*this).counter = (*this).counter.wrapping_sub(1)
        }
        if (*this).counter as libc::c_int == 0 as libc::c_int {
            (*this).counter = 130 as libc::c_int as u8_0;
            (*this).actionFunc =
                Some(BgHakaShip_CutsceneStationary as
                         unsafe extern "C" fn(_: *mut BgHakaShip,
                                              _: *mut GlobalContext) -> ());
            osSyncPrintf(b"\xe3\x82\xb7\xe3\x83\xbc\xe3\x83\xb3 \xe5\xa4\x96\xe8\xbc\xaa\xe8\x88\xb9 ...  \xe3\x82\xa2\xe3\x82\xa1\xe3\x82\xaf\xe3\x82\xb7\xe3\x83\xa7\xe3\x83\xb3\xef\xbc\x81\xef\xbc\x81\n\x00"
                             as *const u8 as *const libc::c_char);
            OnePointCutscene_Init(globalCtx, 3390 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_CutsceneStationary(mut this:
                                                           *mut BgHakaShip,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if (*this).counter != 0 {
    ...
    (*this).yOffset =
        (sinf((*this).counter as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       25 as libc::c_int as libc::c_float)) * 6144.0f32) as
            s16;
    if (*this).counter as libc::c_int == 0 as libc::c_int {
        (*this).counter = 50 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgHakaShip_Move as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_Move(mut this: *mut BgHakaShip,
                                         mut globalCtx: *mut GlobalContext) {
    let mut distanceFromHome: f32_0 = 0.;
    ...
    (*this).dyna.actor.world.pos.y =
        sinf((*this).counter as libc::c_int as libc::c_float *
                 (3.14159265358979323846f32 /
                      25 as libc::c_int as libc::c_float)) * 50.0f32 +
            (*this).dyna.actor.home.pos.y;
    distanceFromHome =
        (*this).dyna.actor.home.pos.x - (*this).dyna.actor.world.pos.x;
    if distanceFromHome > 7650.0f32 {
        (*this).dyna.actor.world.pos.x =
            (*this).dyna.actor.home.pos.x - 7650.0f32;
        (*this).dyna.actor.speedXZ = 0.0f32
    }
    if distanceFromHome > 7600.0f32 && Gameplay_InCsMode(globalCtx) == 0 {
        (*this).counter = 40 as libc::c_int as u8_0;
        (*this).dyna.actor.speedXZ = 0.0f32;
        Message_StartTextbox(globalCtx, 0x5071 as libc::c_int as u16_0,
                             0 as *mut Actor);
        (*this).actionFunc =
            Some(BgHakaShip_SetupCrash as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    } else { Math_StepToF(&mut (*this).dyna.actor.speedXZ, 4.0f32, 0.2f32); }
    child = (*this).dyna.actor.child;
    if !child.is_null() && (*child).update.is_some() {
        (*child).shape.rot.z =
            ((*child).shape.rot.z as libc::c_float +
                 655.0f32 / 13.0f32 * (*this).dyna.actor.speedXZ) as s16
    } else { (*this).dyna.actor.child = 0 as *mut Actor }
    (*this).yOffset =
        (sinf((*this).counter as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       25 as libc::c_int as libc::c_float)) * 6144.0f32) as
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_SetupCrash(mut this: *mut BgHakaShip,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).counter != 0 {
        (*this).counter = (*this).counter.wrapping_sub(1)
    ...
    if (*this).counter as libc::c_int == 0 as libc::c_int {
        (*this).counter = 40 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgHakaShip_CrashShake as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    }
    Math_ScaledStepToS(&mut (*this).yOffset, 0 as libc::c_int as s16,
                       128 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_CrashShake(mut this: *mut BgHakaShip,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).counter as libc::c_int != 0 as libc::c_int {
        (*this).counter = (*this).counter.wrapping_sub(1)
    ...
    (*this).dyna.actor.world.pos.y =
        ((*this).counter as libc::c_int % 4 as libc::c_int * 3 as libc::c_int
             - 6 as libc::c_int) as libc::c_float +
            (*this).dyna.actor.home.pos.y;
    if (*this).counter == 0 {
        (*this).dyna.actor.gravity = -1.0f32;
        (*this).actionFunc =
            Some(BgHakaShip_CrashFall as
                     unsafe extern "C" fn(_: *mut BgHakaShip,
                                          _: *mut GlobalContext) -> ())
    }
    func_8002F974(&mut (*this).dyna.actor,
                  (0x285c as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_CrashFall(mut this: *mut BgHakaShip,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut child: *mut Actor = 0 as *mut Actor;
    if (*this).dyna.actor.home.pos.y - (*this).dyna.actor.world.pos.y >
        ...
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              (0x285c as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        if (*this).dyna.actor.home.pos.y - (*this).dyna.actor.world.pos.y >
               500.0f32 && func_8004356C(&mut (*this).dyna) != 0 {
            Gameplay_TriggerVoidOut(globalCtx);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaShip = thisx as *mut BgHakaShip;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaShip_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaShip = thisx as *mut BgHakaShip;
    let mut angleTemp: f32_0 = 0.;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_haka_ship.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            object_haka_objects_DL_00D330.as_mut_ptr() as libc::c_uint;
        angleTemp =
            (*this).yOffset as libc::c_int as libc::c_float *
                (3.14159265358979323846f32 /
                     0x8000 as libc::c_int as libc::c_float);
        Matrix_Translate(-3670.0f32, 620.0f32, 1150.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(angleTemp, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_2).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            object_haka_objects_DL_005A70.as_mut_ptr() as libc::c_uint;
        Matrix_Translate(0.0f32, 0.0f32, -2300.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(-(2.0f32 * angleTemp),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_6).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_6).words.w1 =
            object_haka_objects_DL_00E910.as_mut_ptr() as libc::c_uint
    }
    ...
    if (*this).actionFunc ==
        ...
        sp2C.x = (*this).dyna.actor.world.pos.x + -367.0f32;
        sp2C.y = (*this).dyna.actor.world.pos.y + 62.0f32;
        sp2C.z = (*this).dyna.actor.world.pos.z;
        SkinMatrix_Vec3fMtxFMultXYZ(&mut (*globalCtx).viewProjectionMtxF,
                                    &mut sp2C, &mut (*this).bellSoundPos);
        func_80078914(&mut (*this).bellSoundPos,
                      (0x284f as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
