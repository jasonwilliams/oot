...
pub struct ArrowFire {
    ...
    pub unk_158: f32_0,
    pub unk_15C: f32_0,
    pub actionFunc: ArrowFireActionFunc,
    pub radius: s16,
    pub timer: u16_0,
    pub alpha: u8_0,
}
pub type ArrowFireActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ArrowFire, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnArrow {
...
#[no_mangle]
pub static mut Arrow_Fire_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ARROW_FIRE as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowFire_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowFire_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_SetupAction(mut this: *mut ArrowFire,
                                               mut actionFunc:
                                                   ArrowFireActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArrowFire = thisx as *mut ArrowFire;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).radius = 0 as libc::c_int as s16;
    (*this).unk_158 = 1.0f32;
    ArrowFire_SetupAction(this,
                          Some(ArrowFire_Charge as
                                   unsafe extern "C" fn(_: *mut ArrowFire,
                                                        _: *mut GlobalContext)
                                       -> ()));
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).alpha = 160 as libc::c_int as u8_0;
    (*this).timer = 0 as libc::c_int as u16_0;
    (*this).unk_15C = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    func_800876C8(globalCtx);
    LogUtils_LogThreadId(b"../z_arrow_fire.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Charge(mut this: *mut ArrowFire,
                                          mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80865ECC(mut unkPos: *mut Vec3f,
                                       mut firePos: *mut Vec3f,
                                       mut scale: f32_0) {
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Hit(mut this: *mut ArrowFire,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if timer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).timer as libc::c_int >= 8 as libc::c_int {
            ...
            (*this).unk_158 += (2.0f32 - (*this).unk_158) * 0.1f32;
    ...
    if (*this).timer as libc::c_int >= 9 as libc::c_int {
        if (*this).unk_15C < 1.0f32 { (*this).unk_15C += 0.25f32 }
    } else if (*this).unk_15C > 0.0f32 { (*this).unk_15C -= 0.125f32 }
    if ((*this).timer as libc::c_int) < 8 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Fly(mut this: *mut ArrowFire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut arrow: *mut EnArrow = 0 as *mut EnArrow;
    ...
    if distanceScaled < 1.0f32 { (*this).unk_158 = 1.0f32 }
    func_80865ECC(&mut (*this).unkPos, &mut (*this).actor.world.pos, 0.05f32);
    if (*arrow).hitFlags as libc::c_int & 1 as libc::c_int != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x183a as libc::c_int as u16_0);
        ArrowFire_SetupAction(this,
                              Some(ArrowFire_Hit as
                                       unsafe extern "C" fn(_: *mut ArrowFire,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArrowFire = thisx as *mut ArrowFire;
...
#[no_mangle]
pub unsafe extern "C" fn ArrowFire_Draw(mut thisx: *mut Actor,
                                        mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut ArrowFire = thisx as *mut ArrowFire;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut stateFrames: u32_0 = 0;
    let mut arrow: *mut EnArrow = 0 as *mut EnArrow;
    ...
    if !arrow.is_null() && (*arrow).actor.update.is_some() &&
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_arrow_fire.c\x00" as *const u8 as
        ...
        if (*this).unk_15C > 0 as libc::c_int as libc::c_float {
            ...
            (*_g).words.w0 =
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                (((40.0f32 * (*this).unk_15C) as s32 & 0xff as libc::c_int) as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
        ...
        (*_g_7).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             (255 as libc::c_int as
                                  libc::c_uint).wrapping_sub(stateFrames.wrapping_mul(2
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                             ...
                             (255 as libc::c_int as
                                  libc::c_uint).wrapping_sub(stateFrames.wrapping_rem(256
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_uint)),
