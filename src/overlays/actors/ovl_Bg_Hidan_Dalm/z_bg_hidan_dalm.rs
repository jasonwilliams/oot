...
extern "C" {
    #[no_mangle]
    fn EffectSsKiraKira_SpawnSmallYellow(globalCtx: *mut GlobalContext,
                                         pos: *mut Vec3f,
                                         velocity: *mut Vec3f,
                                         accel: *mut Vec3f);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gFireTempleHammerableTotemBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleHammerableTotemHeadDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleHammerableTotemCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanDalm {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanDalmActionFunc,
    pub switchFlag: u8_0,
    pub collider: ColliderTris,
    pub colliderItems: [ColliderTrisElement; 4],
}
pub type BgHidanDalmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanDalm, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Dalm_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_DALM as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanDalm>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanDalm_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanDalm_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanDalm_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanDalm_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTrisElementInit: [ColliderTrisElementInit; 4] =
    [{
         let mut init =
    ...
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sTrisElementInit.as_ptr() as *mut _,};
            init
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanDalm = thisx as *mut BgHidanDalm;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gFireTempleHammerableTotemCol as
    ...
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        ...
        (*this).actionFunc =
            Some(BgHidanDalm_Wait as
                     unsafe extern "C" fn(_: *mut BgHidanDalm,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanDalm = thisx as *mut BgHidanDalm;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Wait(mut this: *mut BgHidanDalm,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).collider.base.acFlags as libc::c_int &
           ...
           ((*player).swordAnimation as libc::c_int == 22 as libc::c_int ||
                (*player).swordAnimation as libc::c_int == 23 as libc::c_int)
       {
        ...
        (*this).dyna.actor.world.pos.x +=
            32.5f32 * Math_SinS((*this).dyna.actor.world.rot.y);
        (*this).dyna.actor.world.pos.z +=
            32.5f32 * Math_CosS((*this).dyna.actor.world.rot.y);
        ...
        (*this).dyna.actor.speedXZ = 10.0f32;
        ...
        func_8002F7DC(&mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                         ...
                                                                                         isize)).head
                                  as *mut Player)).actor,
                      0x180a as libc::c_int as u16_0);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28b7 as libc::c_int as u16_0);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Shrink(mut this: *mut BgHidanDalm,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    if Math_StepToF(&mut (*this).dyna.actor.scale.x, 0.0f32, 0.004f32) != 0 {
        func_8002DF54(globalCtx, &mut (*this).dyna.actor,
    ...
    pos.y =
        (*this).dyna.actor.world.pos.y +
            (*this).dyna.actor.scale.x * 160.0f32;
        ...
        velocity.z =
            5.0f32 *
                Math_CosS(((*this).dyna.actor.world.rot.y as libc::c_int +
                               0x8000 as libc::c_int) as s16) +
                (Rand_ZeroOne() - 0.5f32) * 5.0f32;
        velocity.y = (Rand_ZeroOne() - 0.5f32) * 1.5f32;
        EffectSsKiraKira_SpawnSmallYellow(globalCtx, &mut pos, &mut velocity,
                                          &mut accel);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHidanDalm = thisx as *mut BgHidanDalm;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_MoveForward(&mut (*this).dyna.actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor, 10.0f32,
                            15.0f32, 32.0f32, 5 as libc::c_int);
}
/* *
 * Update vertices of collider tris based on the current matrix
 */
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_UpdateCollider(mut this:
                                                        *mut BgHidanDalm) {
    let mut pos2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos0: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(0 as
                                                                      libc::c_int
                                                                      as
    ...
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(0 as
                                                                      ...
                                                                      isize)).dim.vtx.as_mut_ptr().offset(2
                                                                                                              ...
                                                                                                              isize),
                     &mut pos2);
    Collider_SetTrisVertices(&mut (*this).collider, 0 as libc::c_int,
                             &mut pos0, &mut pos1, &mut pos2);
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(1 as
                                                                      libc::c_int
                                                                      as
                                                                      isize)).dim.vtx.as_mut_ptr().offset(2
                                                                                                              as
                                                                                                              ...
                                                                                                              isize),
                     &mut pos1);
    Collider_SetTrisVertices(&mut (*this).collider, 1 as libc::c_int,
                             &mut pos0, &mut pos2, &mut pos1);
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(2 as
                                                                      libc::c_int
                                                                      as
                                                                      isize)).dim.vtx.as_mut_ptr().offset(0
                                                                                                              as
    ...
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(2 as
                                                                      ...
                                                                      isize)).dim.vtx.as_mut_ptr().offset(2
                                                                                                              ...
                                                                                                              isize),
                     &mut pos2);
    Collider_SetTrisVertices(&mut (*this).collider, 2 as libc::c_int,
                             &mut pos0, &mut pos1, &mut pos2);
    Matrix_MultVec3f(&mut *(*sTrisElementInit.as_mut_ptr().offset(3 as
                                                                      libc::c_int
                                                                      as
                                                                      isize)).dim.vtx.as_mut_ptr().offset(1
                                                                                                              as
                                                                                                              ...
                                                                                                              isize),
                     &mut pos2);
    Collider_SetTrisVertices(&mut (*this).collider, 3 as libc::c_int,
                             &mut pos0, &mut pos2, &mut pos1);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanDalm_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanDalm = thisx as *mut BgHidanDalm;
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        Gfx_DrawDListOpa(globalCtx,
                         gFireTempleHammerableTotemBodyDL.as_mut_ptr());
    } else {
        Gfx_DrawDListOpa(globalCtx,
                         gFireTempleHammerableTotemHeadDL.as_mut_ptr());
    }
    if (*this).actionFunc ==
           Some(BgHidanDalm_Wait as
                    unsafe extern "C" fn(_: *mut BgHidanDalm,
