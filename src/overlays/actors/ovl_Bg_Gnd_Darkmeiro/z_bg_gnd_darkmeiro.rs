...
extern "C" {
    ...
    #[no_mangle]
    static mut gShadowTrialPathDL: [Gfx; 0];
    #[no_mangle]
    static mut gClearBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gClearBlockCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGndDarkmeiro {
    pub dyna: DynaPolyActor,
    pub actionFlags: u16_0,
    pub timer1: s16,
    pub timer2: s16,
    pub updateFunc: BgGndDarkmeiroUpdateFunc,
}
pub type BgGndDarkmeiroUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGndDarkmeiro, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_17 = libc::c_uint;
pub const DARKMEIRO_BLOCK_TIMER: C2RustUnnamed_17 = 2;
pub const DARKMEIRO_CLEAR_BLOCK: C2RustUnnamed_17 = 1;
pub const DARKMEIRO_INVISIBLE_PATH: C2RustUnnamed_17 = 0;
#[no_mangle]
pub static mut Bg_Gnd_Darkmeiro_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GND_DARKMEIRO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgGndDarkmeiro>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndDarkmeiro_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndDarkmeiro_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndDarkmeiro_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_ToggleBlock(mut this:
                                                        *mut BgGndDarkmeiro,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    } else if (*this).timer1 as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_Init(mut thisx: *mut Actor,
                                             mut globalCtx2:
                                                 *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut this: *mut BgGndDarkmeiro = thisx as *mut BgGndDarkmeiro;
    (*this).updateFunc =
        Some(BgGndDarkmeiro_Noop as
                 unsafe extern "C" fn(_: *mut BgGndDarkmeiro,
                                      _: *mut GlobalContext) -> ());
    ...
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        0 => {
            (*this).dyna.actor.draw =
                Some(BgGndDarkmeiro_DrawInvisiblePath as
        ...
        1 => {
            CollisionHeader_GetVirtual(&mut gClearBlockCol as
            ...
            if (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
                ...
                (*this).updateFunc =
                    Some(BgGndDarkmeiro_UpdateStaticBlock as
                             unsafe extern "C" fn(_: *mut BgGndDarkmeiro,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).dyna.actor.draw =
                    Some(BgGndDarkmeiro_DrawStaticBlock as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
                ...
                (*this).actionFlags = (*this).timer1 as u16_0;
                (*thisx).draw =
                    Some(BgGndDarkmeiro_DrawSwitchBlock as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).updateFunc =
                    Some(BgGndDarkmeiro_UpdateSwitchBlock as
                             unsafe extern "C" fn(_: *mut BgGndDarkmeiro,
                                                  _: *mut GlobalContext)
                                 -> ());
                if Flags_GetSwitch(globalCtx,
                    ...
                    (*this).timer1 = 64 as libc::c_int as s16;
                    (*this).actionFlags =
        ...
        2 => {
            ...
            (*this).actionFlags = (*this).timer1 as u16_0;
            (*this).updateFunc =
                Some(BgGndDarkmeiro_UpdateBlockTimer as
                         unsafe extern "C" fn(_: *mut BgGndDarkmeiro,
                                              _: *mut GlobalContext) -> ());
            (*thisx).draw = None;
            if Flags_GetSwitch(globalCtx,
            ...
            if Flags_GetSwitch(globalCtx,
                ...
                (*this).actionFlags =
                    ((*this).actionFlags as libc::c_int | 8 as libc::c_int) as
                        u16_0
            }
            if (*this).timer1 as libc::c_int != 0 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx2:
                                                    *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut BgGndDarkmeiro = thisx as *mut BgGndDarkmeiro;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_Noop(mut this: *mut BgGndDarkmeiro,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_UpdateBlockTimer(mut this:
                                                             *mut BgGndDarkmeiro,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut timeLeft: s16 = 0;
    if Flags_GetSwitch(globalCtx,
                       ((*this).dyna.actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int) +
                           1 as libc::c_int) != 0 {
            ...
            if (*this).timer1 as libc::c_int > 0 as libc::c_int {
                ...
                Flags_UnsetSwitch(globalCtx,
                                  ((*this).dyna.actor.params as libc::c_int >>
                                      ...
                                      + 1 as libc::c_int);
                (*this).actionFlags =
                    ((*this).actionFlags as libc::c_int & !(4 as libc::c_int))
                        as u16_0
            }
        } else {
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 4 as libc::c_int) as
                    u16_0;
            (*this).timer1 = 304 as libc::c_int as s16;
            Audio_PlaySoundGeneral(0x2881 as libc::c_int as u16_0,
            ...
            if (*this).timer2 as libc::c_int > 0 as libc::c_int {
                ...
                Flags_UnsetSwitch(globalCtx,
                                  ((*this).dyna.actor.params as libc::c_int >>
                                      ...
                                      + 2 as libc::c_int);
                (*this).actionFlags =
                    ((*this).actionFlags as libc::c_int & !(8 as libc::c_int))
                        as u16_0
            }
        } else {
            (*this).actionFlags =
                ((*this).actionFlags as libc::c_int | 8 as libc::c_int) as
                    u16_0;
            (*this).timer2 = 304 as libc::c_int as s16;
            Audio_PlaySoundGeneral(0x2881 as libc::c_int as u16_0,
                                   &mut D_801333D4, 4 as libc::c_int as u8_0,
                                   &mut D_801333E0, &mut D_801333E0,
                                   &mut D_801333E8);
    ...
    timeLeft =
        if ((*this).timer1 as libc::c_int) < (*this).timer2 as libc::c_int {
            (*this).timer2 as libc::c_int
        } else { (*this).timer1 as libc::c_int } as s16;
    if timeLeft as libc::c_int > 0 as libc::c_int {
        func_8002F994(&mut (*this).dyna.actor, timeLeft as s32);
    }
    if (*this).timer1 as libc::c_int >= 64 as libc::c_int ||
           (*this).timer2 as libc::c_int >= 64 as libc::c_int {
        Flags_SetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_UpdateStaticBlock(mut this:
                                                              *mut BgGndDarkmeiro,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_UpdateSwitchBlock(mut this:
                                                              *mut BgGndDarkmeiro,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    if (*this).timer1 as libc::c_int > 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_Update(mut thisx: *mut Actor,
                                               mut globalCtx2:
                                                   *mut GlobalContext) {
    let mut this: *mut BgGndDarkmeiro = thisx as *mut BgGndDarkmeiro;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    (*this).updateFunc.expect("non-null function pointer")(this, globalCtx2);
}
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_DrawInvisiblePath(mut thisx:
                                                              *mut Actor,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    Gfx_DrawDListXlu(globalCtx, gShadowTrialPathDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_DrawSwitchBlock(mut thisx: *mut Actor,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut this: *mut BgGndDarkmeiro = thisx as *mut BgGndDarkmeiro;
    let mut vanishTimer: s16 = 0;
    vanishTimer = (*this).timer1;
    if vanishTimer as libc::c_int != 0 as libc::c_int {
        if vanishTimer as libc::c_int > 64 as libc::c_int {
            (*this).timer2 =
                if ((*this).timer2 as libc::c_int) < 120 as libc::c_int {
                    ((*this).timer2 as libc::c_int) + 8 as libc::c_int
                } else { 127 as libc::c_int } as s16
        } else if vanishTimer as libc::c_int > 16 as libc::c_int {
            (*this).timer2 =
                (Math_CosS(((*this).timer1 as u16_0 as libc::c_int *
                                0x1000 as libc::c_int) as s16) * 64.0f32 +
                     127.0f32) as s16;
            if (*this).timer2 as libc::c_int > 127 as libc::c_int {
                (*this).timer2 = 127 as libc::c_int as s16
            }
        } else {
            (*this).timer2 =
                (vanishTimer as libc::c_int * 8 as libc::c_int) as s16
        }
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_bg_gnd_darkmeiro.c\x00" as *const u8 as
        ...
        Gfx_DrawDListXlu(globalCtx, gClearBlockDL.as_mut_ptr());
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndDarkmeiro_DrawStaticBlock(mut thisx: *mut Actor,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_gnd_darkmeiro.c\x00" as *const u8 as
                         *const libc::c_char, 393 as libc::c_int);
    Gfx_DrawDListXlu(globalCtx, gClearBlockDL.as_mut_ptr());
}
