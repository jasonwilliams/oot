...
extern "C" {
    ...
    #[no_mangle]
    static mut gPeehatLandingAnim: AnimationHeader;
    #[no_mangle]
    static mut gPeehatFlyingAnim: AnimationHeader;
    #[no_mangle]
    static mut gPeehatRecoilAnim: AnimationHeader;
    #[no_mangle]
    static mut gPeehatRisingAnim: AnimationHeader;
    #[no_mangle]
    static mut gPeehatSkel: SkeletonHeader;
}
...
pub const PEAHAT_TYPE_LARVA: C2RustUnnamed_23 = 1;
pub const PEAHAT_TYPE_FLYING: C2RustUnnamed_23 = 0;
pub const PEAHAT_TYPE_GROUNDED: C2RustUnnamed_23 = -1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPeehat {
    pub actor: Actor,
    ...
    pub morphTable: [Vec3s; 24],
    pub state: s32,
    pub isStateDieFirstUpdate: s32,
    pub actionFunc: EnPeehatActionFunc,
    pub bladeTip: [Vec3f; 2],
    pub unk2D4: s32,
    pub xzDistMax: f32_0,
    pub xzDistToRise: f32_0,
    pub unk2E0: f32_0,
    pub jiggleRot: f32_0,
    pub jiggleRotInc: f32_0,
    pub scaleShift: f32_0,
    pub bladeRotVel: s16,
    pub bladeRot: s16,
    pub unk2F4: s16,
    pub riseDelayTimer: s16,
    pub seekPlayerTimer: s16,
    pub unk2FA: s16,
    pub animTimer: s16,
    pub colCylinder: ColliderCylinder,
    pub colJntSph: ColliderJntSph,
    pub colJntSphItemList: [ColliderJntSphElement; 1],
    pub colQuad: ColliderQuad,
}
pub type EnPeehatActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPeehat, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
...
pub const PEAHAT_STATE_15: C2RustUnnamed_25 = 15;
pub const PEAHAT_STATE_8: C2RustUnnamed_25 = 8;
pub const PEAHAT_STATE_STUNNED: C2RustUnnamed_25 = 13;
pub const PEAHAT_STATE_3: C2RustUnnamed_25 = 3;
pub const PEAHAT_STATE_LANDING: C2RustUnnamed_25 = 10;
pub const PEAHAT_STATE_RETURN_HOME: C2RustUnnamed_25 = 12;
pub const PEAHAT_STATE_SEEK_PLAYER: C2RustUnnamed_25 = 14;
pub const PEAHAT_STATE_ATTACK_RECOIL: C2RustUnnamed_25 = 7;
pub const PEAHAT_STATE_FLY: C2RustUnnamed_25 = 5;
pub const PEAHAT_STATE_9: C2RustUnnamed_25 = 9;
pub const PEAHAT_STATE_4: C2RustUnnamed_25 = 4;
pub const PEAHAT_DMG_EFF_ATTACK: C2RustUnnamed_24 = 0;
pub const PEAHAT_DMG_EFF_LIGHT_ICE_ARROW: C2RustUnnamed_24 = 6;
pub const PEAHAT_DMG_EFF_FIRE: C2RustUnnamed_24 = 12;
pub const PEAHAT_DMG_EFF_HOOKSHOT: C2RustUnnamed_24 = 13;
pub const PEAHAT_DMG_EFF_BOOMERANG: C2RustUnnamed_24 = 14;
pub const PEAHAT_DMG_EFF_NUT: C2RustUnnamed_24 = 15;
pub const PEAHAT_STATE_EXPLODE: C2RustUnnamed_25 = 1;
pub const PEAHAT_STATE_DYING: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub type C2RustUnnamed_25 = libc::c_uint;
#[no_mangle]
pub static mut En_Peehat_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PEEHAT as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_PEEHAT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnPeehat>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPeehat_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPeehat_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sJntSphElemInit: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
    ...
    unsafe {
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   elements:
                                       sJntSphElemInit.as_ptr() as *mut _,};
            init
        }
    };
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (PEAHAT_DMG_EFF_NUT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (PEAHAT_DMG_EFF_BOOMERANG as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_HOOKSHOT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (4 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (PEAHAT_DMG_EFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (PEAHAT_DMG_EFF_ATTACK as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (3 as libc::c_int |
                                  (PEAHAT_DMG_EFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (PEAHAT_DMG_EFF_LIGHT_ICE_ARROW as
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_SetupAction(mut this: *mut EnPeehat,
                                              mut actionFunc:
                                                  EnPeehatActionFunc) {
    (*this).actionFunc = actionFunc; // Larva
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPeehat = thisx as *mut EnPeehat;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 36.0f32 * 0.001f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gPeehatSkel,
                   &mut gPeehatRisingAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 24 as libc::c_int);
    ActorShape_Init(&mut (*this).actor.shape, 100.0f32,
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).colCylinder);
    Collider_SetCylinder(globalCtx, &mut (*this).colCylinder,
                         &mut (*this).actor, &mut sCylinderInit);
    Collider_InitQuad(globalCtx, &mut (*this).colQuad);
    Collider_SetQuad(globalCtx, &mut (*this).colQuad, &mut (*this).actor,
                     &mut sQuadInit);
    Collider_InitJntSph(globalCtx, &mut (*this).colJntSph);
    Collider_SetJntSph(globalCtx, &mut (*this).colJntSph, &mut (*this).actor,
                       &mut sJntSphInit,
                       (*this).colJntSphItemList.as_mut_ptr());
    (*this).actor.naviEnemyId = 0x48 as libc::c_int as u8_0;
    (*this).xzDistToRise = 740.0f32;
    (*this).xzDistMax = 1200.0f32;
    ...
    match (*this).actor.params as libc::c_int {
        -1 => { EnPeehat_Ground_SetStateGround(this); }
        0 => {
            (*this).actor.uncullZoneForward = 4200.0f32;
            (*this).xzDistToRise = 2800.0f32;
            (*this).xzDistMax = 1400.0f32;
            EnPeehat_Flying_SetStateGround(this);
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
        }
        1 => {
            (*this).actor.scale.z = 0.006f32;
            (*this).actor.scale.x = (*this).actor.scale.z;
            (*this).actor.scale.y = 0.003f32;
            (*this).colCylinder.dim.radius = 25 as libc::c_int as s16;
            (*this).colCylinder.dim.height = 15 as libc::c_int as s16;
            (*this).colCylinder.dim.yShift = -(5 as libc::c_int) as s16;
            (*this).colCylinder.info.bumper.dmgFlags =
                0x1f824 as libc::c_int as u32_0;
            (*this).colQuad.base.atFlags =
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int) as u8_0;
            (*this).colQuad.base.acFlags =
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
            (*this).actor.naviEnemyId = 0x49 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPeehat = thisx as *mut EnPeehat;
    let mut parent: *mut EnPeehat = 0 as *mut EnPeehat;
    Collider_DestroyCylinder(globalCtx, &mut (*this).colCylinder);
    Collider_DestroyJntSph(globalCtx, &mut (*this).colJntSph);
    // If PEAHAT_TYPE_LARVA, decrement total larva spawned
    if (*this).actor.params as libc::c_int > 0 as libc::c_int {
        parent = (*this).actor.parent as *mut EnPeehat; // radians
        if !parent.is_null() && (*parent).actor.update.is_some() {
            (*parent).unk2FA -= 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_SpawnDust(mut globalCtx: *mut GlobalContext,
                                            mut this: *mut EnPeehat,
                                            mut pos: *mut Vec3f,
                                            mut arg3: f32_0, mut arg4: s32,
                                            mut arg5: f32_0,
                                            mut arg6: f32_0) {
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustVel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 8.0f32, z: 0.0f32,}; init };
    let mut dustAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -1.5f32, z: 0.0f32,}; init };
    let mut rot: f32_0 = 0.;
    let mut pScale: s32 = 0;
    rot = (Rand_ZeroOne() - 0.5f32) * 6.28f32;
    dustPos.y = (*this).actor.floorHeight;
    dustPos.x = Math_SinF(rot) * arg3 + (*pos).x;
    dustPos.z = Math_CosF(rot) * arg3 + (*pos).z;
    dustAccel.x = (Rand_ZeroOne() - 0.5f32) * arg5;
    dustAccel.z = (Rand_ZeroOne() - 0.5f32) * arg5;
    dustVel.y += (Rand_ZeroOne() - 0.5f32) * 4.0f32;
    pScale =
        ((Rand_ZeroOne() * 5 as libc::c_int as libc::c_float +
              12 as libc::c_int as libc::c_float) * arg6) as s32;
    EffectSsHahen_Spawn(globalCtx, &mut dustPos, &mut dustVel, &mut dustAccel,
                        arg4 as s16, pScale as s16,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_HitWhenGrounded(mut this: *mut EnPeehat,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).colCylinder.base.acFlags =
        ((*this).colCylinder.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int)) as
            u8_0; // ! @bug: overwrites number of child larva spawned, allowing for more than MAX_LARVA spawns
    if (*globalCtx).gameplayFrames & 0xf as libc::c_int as libc::c_uint ==
           0 as libc::c_int as libc::c_uint {
        let mut itemDropPos: Vec3f = (*this).actor.world.pos;
        itemDropPos.y += 70.0f32;
        ...
        Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                   &mut itemDropPos,
                                   0x40 as libc::c_int as s16);
        (*this).unk2D4 = 240 as libc::c_int
    } else {
        let mut i: s32 = 0;
        (*this).colCylinder.base.acFlags =
            ((*this).colCylinder.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        i = 3 as libc::c_int - (*this).unk2FA as libc::c_int;
        while i > 0 as libc::c_int {
            let mut larva: *mut Actor =
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx,
                                   ACTOR_EN_PEEHAT as libc::c_int as s16,
                                   Rand_CenteredFloat(25.0f32) +
                                   ...
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   PEAHAT_TYPE_LARVA as libc::c_int as s16);
            if !larva.is_null() {
                (*larva).velocity.y = 6.0f32;
                (*larva).world.rot.y =
                    Rand_CenteredFloat(0xffff as libc::c_int as f32_0) as s16;
                (*larva).shape.rot.y = (*larva).world.rot.y;
                (*this).unk2FA += 1
            }
            i -= 1
        }
        (*this).unk2D4 = 8 as libc::c_int
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x3956 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateGround(mut this:
                                                            *mut EnPeehat) {
    Animation_Change(&mut (*this).skelAnime, &mut gPeehatRisingAnim, 0.0f32,
                     3.0f32,
                     Animation_GetLastFrame(&mut gPeehatRisingAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).seekPlayerTimer = 600 as libc::c_int as s16;
    (*this).unk2D4 = 0 as libc::c_int;
    (*this).unk2FA = 0 as libc::c_int as s16;
    (*this).state = PEAHAT_STATE_3 as libc::c_int;
    (*this).colCylinder.base.acFlags =
        ((*this).colCylinder.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateGround as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateGround(mut this: *mut EnPeehat,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if gSaveContext.nightFlag == 0 as libc::c_int {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        if (*this).riseDelayTimer as libc::c_int == 0 as libc::c_int {
            if (*this).actor.xzDistToPlayer < (*this).xzDistToRise {
                EnPeehat_Ground_SetStateRise(this);
            }
        } else {
            Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, -1000.0f32,
                               1.0f32, 10.0f32, 0.0f32);
            (*this).riseDelayTimer -= 1
        }
    } else {
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, -1000.0f32,
                           1.0f32, 50.0f32, 0.0f32);
        if (*this).unk2D4 != 0 as libc::c_int {
            (*this).unk2D4 -= 1;
            if (*this).unk2D4 & 4 as libc::c_int != 0 {
                Math_SmoothStepToF(&mut (*this).scaleShift, 0.205f32, 1.0f32,
                                   0.235f32, 0.0f32);
            } else {
                Math_SmoothStepToF(&mut (*this).scaleShift, 0.0f32, 1.0f32,
                                   0.005f32, 0.0f32);
            }
        } else if (*this).colCylinder.base.acFlags as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_SetStateGround(mut this:
                                                            *mut EnPeehat) {
    Animation_Change(&mut (*this).skelAnime, &mut gPeehatRisingAnim, 0.0f32,
                     3.0f32,
                     Animation_GetLastFrame(&mut gPeehatRisingAnim as
                                                ...
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).seekPlayerTimer = 400 as libc::c_int as s16;
    (*this).unk2D4 = 0 as libc::c_int;
    (*this).unk2FA = 0 as libc::c_int as s16;
    (*this).state = PEAHAT_STATE_4 as libc::c_int;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Flying_StateGrounded as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_StateGrounded(mut this:
                                                           *mut EnPeehat,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if gSaveContext.nightFlag == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_SetStateFly(mut this:
                                                         *mut EnPeehat) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPeehatFlyingAnim);
    (*this).state = PEAHAT_STATE_FLY as libc::c_int;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Flying_StateFly as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_StateFly(mut this: *mut EnPeehat,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x3955 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    SkelAnime_Update(&mut (*this).skelAnime);
    if !(gSaveContext.nightFlag == 0 as libc::c_int) ||
           (*this).xzDistToRise < (*this).actor.xzDistToPlayer {
        EnPeehat_Flying_SetStateLanding(this);
    } else if (*this).actor.xzDistToPlayer < (*this).xzDistMax {
        if ((*this).unk2FA as libc::c_int) < 3 as libc::c_int &&
               (*globalCtx).gameplayFrames & 7 as libc::c_int as libc::c_uint
                   == 0 as libc::c_int as libc::c_uint {
            let mut larva: *mut Actor =
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx,
    ...
    (*this).bladeRot =
        ((*this).bladeRot as libc::c_int + (*this).bladeRotVel as libc::c_int)
            as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateRise(mut this:
                                                          *mut EnPeehat) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gPeehatRisingAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    if (*this).state != PEAHAT_STATE_STUNNED as libc::c_int {
        Animation_Change(&mut (*this).skelAnime, &mut gPeehatRisingAnim,
                         0.0f32, 3.0f32, lastFrame,
                         ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    }
    (*this).state = PEAHAT_STATE_8 as libc::c_int;
    (*this).animTimer = lastFrame as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3954 as libc::c_int as u16_0);
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateRise as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateRise(mut this: *mut EnPeehat,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, 0.0f32, 1.0f32,
                       50.0f32, 0.0f32);
    if Math_SmoothStepToS(&mut (*this).bladeRotVel,
                          4000 as libc::c_int as s16, 1 as libc::c_int as s16,
                          800 as libc::c_int as s16, 0 as libc::c_int as s16)
           as libc::c_int == 0 as libc::c_int {
        if (*this).animTimer as libc::c_int != 0 as libc::c_int {
            (*this).animTimer -= 1;
            if (*this).skelAnime.playSpeed == 0.0f32 {
                if (*this).animTimer as libc::c_int == 0 as libc::c_int {
                    (*this).animTimer = 40 as libc::c_int as s16;
                    (*this).skelAnime.playSpeed = 1.0f32
                }
            }
        }
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 ||
               (*this).animTimer as libc::c_int == 0 as libc::c_int {
            EnPeehat_Ground_SetStateHover(this);
        } else { (*this).actor.world.pos.y += 6.5f32 }
        if (*this).actor.world.pos.y - (*this).actor.floorHeight < 80.0f32 {
            let mut pos: Vec3f = (*this).actor.world.pos;
            pos.y = (*this).actor.floorHeight;
            func_80033480(globalCtx, &mut pos, 90.0f32, 1 as libc::c_int,
                          0x96 as libc::c_int as s16,
                          100 as libc::c_int as s16,
                          1 as libc::c_int as u8_0);
        }
    }
    EnPeehat_SpawnDust(globalCtx, this, &mut (*this).actor.world.pos, 75.0f32,
                       2 as libc::c_int, 1.05f32, 2.0f32);
    Math_SmoothStepToF(&mut (*this).scaleShift, 0.075f32, 1.0f32, 0.005f32,
                       0.0f32);
    (*this).bladeRot =
        ((*this).bladeRot as libc::c_int + (*this).bladeRotVel as libc::c_int)
            as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_SetStateRise(mut this:
                                                          *mut EnPeehat) {
    ...
    (*this).state = PEAHAT_STATE_9 as libc::c_int;
    (*this).animTimer = lastFrame as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3954 as libc::c_int as u16_0);
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Flying_StateRise as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_StateRise(mut this: *mut EnPeehat,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, 0.0f32, 1.0f32,
                       50.0f32, 0.0f32);
    if Math_SmoothStepToS(&mut (*this).bladeRotVel,
        ...
        } else { (*this).actor.world.pos.y += 18.0f32 }
        if (*this).actor.world.pos.y - (*this).actor.floorHeight < 80.0f32 {
            let mut pos: Vec3f = (*this).actor.world.pos;
            pos.y = (*this).actor.floorHeight;
            func_80033480(globalCtx, &mut pos, 90.0f32, 1 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateSeekPlayer(mut this:
                                                                *mut EnPeehat) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPeehatFlyingAnim);
    (*this).state = PEAHAT_STATE_SEEK_PLAYER as libc::c_int;
    (*this).unk2E0 = 0.0f32;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateSeekPlayer as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateSeekPlayer(mut this:
                                                             *mut EnPeehat,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    ...
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 3.0f32, 1.0f32, 0.25f32,
                       0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*this).actor.floorHeight + 80.0f32, 1.0f32, 3.0f32,
                       0.0f32);
    if (*this).seekPlayerTimer as libc::c_int <= 0 as libc::c_int {
        EnPeehat_Ground_SetStateLanding(this);
        (*this).riseDelayTimer = 40 as libc::c_int as s16
    } else { (*this).seekPlayerTimer -= 1 }
    if gSaveContext.nightFlag == 0 as libc::c_int &&
        ...
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           ...
                           0 as libc::c_int as s16);
        if (*this).unk2FA as libc::c_int != 0 as libc::c_int {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
                     0x1c2 as libc::c_int) as s16
        } else {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int -
                     0x1c2 as libc::c_int) as s16
        }
    } else { EnPeehat_Ground_SetStateReturnHome(this); }
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).bladeRotVel, 4000 as libc::c_int as s16,
                       1 as libc::c_int as s16, 500 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    (*this).bladeRot =
        ((*this).bladeRot as libc::c_int + (*this).bladeRotVel as libc::c_int)
            as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Larva_SetStateSeekPlayer(mut this:
                                                               *mut EnPeehat) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPeehatFlyingAnim);
    (*this).state = PEAHAT_STATE_SEEK_PLAYER as libc::c_int;
    (*this).unk2D4 = 0 as libc::c_int;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Larva_StateSeekPlayer as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Larva_StateSeekPlayer(mut this:
                                                            *mut EnPeehat,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut speedXZ: f32_0 = 5.3f32;
    if (*this).actor.xzDistToPlayer <= 5.3f32 {
        speedXZ = (*this).actor.xzDistToPlayer + 0.0005f32
    }
    if !(*this).actor.parent.is_null() &&
           (*(*this).actor.parent).update.is_none() {
        (*this).actor.parent = 0 as *mut Actor
    }
    (*this).actor.speedXZ = speedXZ;
    if (*this).actor.world.pos.y - (*this).actor.floorHeight >= 70.0f32 {
        Math_SmoothStepToF(&mut (*this).actor.velocity.y, -1.3f32, 1.0f32,
                           0.5f32, 0.0f32);
    } else {
        Math_SmoothStepToF(&mut (*this).actor.velocity.y, -0.135f32, 1.0f32,
                           0.05f32, 0.0f32);
    }
    if (*this).unk2D4 == 0 as libc::c_int {
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           1 as libc::c_int as s16, 830 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    } else { (*this).unk2D4 -= 1 }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x15e as libc::c_int) as
            s16;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).bladeRotVel, 4000 as libc::c_int as s16,
                       1 as libc::c_int as s16, 500 as libc::c_int as s16,
    ...
    Math_SmoothStepToF(&mut (*this).scaleShift, 0.075f32, 1.0f32, 0.005f32,
                       0.0f32);
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x3984 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    if (*this).colQuad.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 2 as libc::c_int != 0 {
        (*this).actor.colChkInfo.health = 0 as libc::c_int as u8_0;
        (*this).colQuad.base.acFlags =
            ((*this).colQuad.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 7 as libc::c_int)) as u8_0;
        EnPeehat_SetStateAttackRecoil(this);
    } else if (*this).colQuad.base.atFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 ||
                  (*this).colCylinder.base.acFlags as libc::c_int &
                      (1 as libc::c_int) << 1 as libc::c_int != 0 ||
        ...
        let mut player: *mut Player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        (*this).colQuad.base.atFlags =
            ((*this).colQuad.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if (*this).colCylinder.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int == 0 &&
               &mut (*player).actor as *mut Actor == (*this).colQuad.base.at {
            ...
            let mut zeroVec: Vec3f =
                {
                    let mut init =
                        Vec3f{x: 0 as libc::c_int as f32_0,
                              y: 0 as libc::c_int as f32_0,
                              z: 0 as libc::c_int as f32_0,};
                    init
                };
            let mut i: s32 = 0;
            i = 4 as libc::c_int;
            while i >= 0 as libc::c_int {
                ...
                EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut zeroVec,
                                     &mut zeroVec, 40 as libc::c_int as s16,
        ...
        if &mut (*player).actor as *mut Actor != (*this).colQuad.base.at ||
               (*this).colCylinder.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateLanding(mut this:
                                                             *mut EnPeehat) {
    (*this).state = PEAHAT_STATE_LANDING as libc::c_int;
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gPeehatLandingAnim);
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateLanding as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateLanding(mut this: *mut EnPeehat,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3957 as libc::c_int as u16_0);
    } else if (*this).actor.floorHeight < (*this).actor.world.pos.y {
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.floorHeight, 0.3f32, 3.5f32,
                           0.25f32);
        if (*this).actor.world.pos.y - (*this).actor.floorHeight < 60.0f32 {
            let mut pos: Vec3f = (*this).actor.world.pos;
            pos.y = (*this).actor.floorHeight;
            func_80033480(globalCtx, &mut pos, 80.0f32, 1 as libc::c_int,
                          150 as libc::c_int as s16,
                          100 as libc::c_int as s16,
                          1 as libc::c_int as u8_0);
            EnPeehat_SpawnDust(globalCtx, this, &mut pos, 75.0f32,
                               2 as libc::c_int, 1.05f32, 2.0f32);
        }
    }
    Math_SmoothStepToS(&mut (*this).bladeRotVel, 0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_SetStateLanding(mut this:
                                                             *mut EnPeehat) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gPeehatLandingAnim);
    (*this).state = PEAHAT_STATE_LANDING as libc::c_int;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Flying_StateLanding as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Flying_StateLanding(mut this: *mut EnPeehat,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, -1000.0f32, 1.0f32,
                       50.0f32, 0.0f32);
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.floorHeight, 0.3f32, 13.5f32,
                           0.25f32);
        if (*this).actor.world.pos.y - (*this).actor.floorHeight < 60.0f32 {
            let mut pos: Vec3f = (*this).actor.world.pos;
            pos.y = (*this).actor.floorHeight;
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateHover(mut this:
                                                           *mut EnPeehat) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPeehatFlyingAnim);
    (*this).actor.speedXZ = Rand_ZeroOne() * 0.5f32 + 2.5f32;
    (*this).unk2D4 =
        (Rand_ZeroOne() * 10 as libc::c_int as libc::c_float +
             10 as libc::c_int as libc::c_float) as s32;
    (*this).state = PEAHAT_STATE_15 as libc::c_int;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateHover as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateHover(mut this: *mut EnPeehat,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    let mut player: *mut Player =
    ...
    if (*this).actor.world.pos.y - (*this).actor.floorHeight > 75.0f32 {
        (*this).actor.world.pos.y -= 1.0f32
    }
    (*this).actor.world.pos.y += Math_CosF((*this).unk2E0) * 1.4f32;
    cos = Math_CosF((*this).unk2E0) * 0.18f32;
    (*this).unk2E0 += (if 0.0f32 <= cos { cos } else { -cos }) + 0.07f32;
    (*this).unk2D4 -= 1;
    if (*this).unk2D4 <= 0 as libc::c_int {
        (*this).actor.speedXZ = Rand_ZeroOne() * 0.5f32 + 2.5f32;
        (*this).unk2D4 = (Rand_ZeroOne() * 10.0f32 + 10.0f32) as s32;
        (*this).unk2F4 = ((Rand_ZeroOne() - 0.5f32) * 1000.0f32) as s16
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             (*this).unk2F4 as libc::c_int) as s16;
    if (*this).seekPlayerTimer as libc::c_int <= 0 as libc::c_int {
        EnPeehat_Ground_SetStateLanding(this);
        (*this).riseDelayTimer = 40 as libc::c_int as s16
    } else { (*this).seekPlayerTimer -= 1 }
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_SetStateReturnHome(mut this:
                                                                *mut EnPeehat) {
    (*this).state = PEAHAT_STATE_RETURN_HOME as libc::c_int;
    (*this).actor.speedXZ = 2.5f32;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Ground_StateReturnHome as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Ground_StateReturnHome(mut this:
                                                             *mut EnPeehat,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    ...
    if (*this).actor.world.pos.y - (*this).actor.floorHeight > 75.0f32 {
        (*this).actor.world.pos.y -= 1.0f32
    } else { (*this).actor.world.pos.y += 1.0f32 }
    (*this).actor.world.pos.y += Math_CosF((*this).unk2E0) * 1.4f32;
    cos = Math_CosF((*this).unk2E0) * 0.18f32;
    (*this).unk2E0 += (if 0.0f32 <= cos { cos } else { -cos }) + 0.07f32;
    yRot =
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, yRot,
                       1 as libc::c_int as s16, 600 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       4500 as libc::c_int as s16, 1 as libc::c_int as s16,
                       600 as libc::c_int as s16, 0 as libc::c_int as s16);
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x15e as libc::c_int) as
            s16;
    (*this).bladeRot =
    ...
    if Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
                         &mut (*this).actor.home.pos) < 2.0f32 {
        EnPeehat_Ground_SetStateLanding(this);
        (*this).riseDelayTimer = 60 as libc::c_int as s16
    }
    if gSaveContext.nightFlag == 0 as libc::c_int &&
           Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                             &mut (*player).actor.world.pos) <
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_SetStateAttackRecoil(mut this:
                                                           *mut EnPeehat) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gPeehatRecoilAnim,
                              -4.0f32);
    (*this).state = PEAHAT_STATE_ATTACK_RECOIL as libc::c_int;
    (*this).actor.speedXZ = -9.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_StateAttackRecoil as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_StateAttackRecoil(mut this: *mut EnPeehat,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    (*this).bladeRot =
        ((*this).bladeRot as libc::c_int + (*this).bladeRotVel as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_SetStateBoomerangStunned(mut this:
                                                               *mut EnPeehat) {
    (*this).state = PEAHAT_STATE_STUNNED as libc::c_int;
    if (*this).actor.floorHeight < (*this).actor.world.pos.y {
        (*this).actor.speedXZ = -9.0f32
    }
    (*this).bladeRotVel = 0 as libc::c_int as s16;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    ...
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_StateBoomerangStunned as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_StateBoomerangStunned(mut this:
                                                            *mut EnPeehat,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 1.0f32,
                       0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*this).actor.floorHeight, 1.0f32, 8.0f32, 0.0f32);
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        EnPeehat_Ground_SetStateRise(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Adult_SetStateDie(mut this: *mut EnPeehat) {
    (*this).bladeRotVel = 0 as libc::c_int as s16;
    (*this).isStateDieFirstUpdate = 1 as libc::c_int;
    ...
    (*this).state = PEAHAT_STATE_DYING as libc::c_int;
    (*this).scaleShift = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_Adult_StateDie as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Adult_StateDie(mut this: *mut EnPeehat,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).isStateDieFirstUpdate != 0 {
        (*this).unk2D4 -= 1;
        if (*this).unk2D4 <= 0 as libc::c_int ||
               (*this).actor.colChkInfo.health as libc::c_int ==
                   0 as libc::c_int {
            Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                      &mut gPeehatRecoilAnim, -4.0f32);
            (*this).bladeRotVel = 4000 as libc::c_int as s16;
            (*this).unk2D4 = 14 as libc::c_int;
            (*this).actor.speedXZ = 0 as libc::c_int as f32_0;
            (*this).actor.velocity.y = 6 as libc::c_int as f32_0;
            (*this).isStateDieFirstUpdate = 0 as libc::c_int;
            (*this).actor.shape.rot.x = 0 as libc::c_int as s16;
            (*this).actor.shape.rot.z = (*this).actor.shape.rot.x
        } else if (*this).actor.colorFilterTimer as libc::c_int &
                      4 as libc::c_int != 0 {
            Math_SmoothStepToF(&mut (*this).scaleShift, 0.205f32, 1.0f32,
                               0.235f32, 0 as libc::c_int as f32_0);
        } else {
            Math_SmoothStepToF(&mut (*this).scaleShift,
                               0 as libc::c_int as f32_0, 1.0f32, 0.005f32,
                               0 as libc::c_int as f32_0);
        }
    } else {
        SkelAnime_Update(&mut (*this).skelAnime);
        (*this).bladeRot =
            ((*this).bladeRot as libc::c_int +
                 (*this).bladeRotVel as libc::c_int) as s16;
        Math_SmoothStepToS(&mut (*this).bladeRotVel,
                           4000 as libc::c_int as s16,
                           1 as libc::c_int as s16, 250 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            (*this).actor.scale.x -= 0.0015f32;
            Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
        }
        if Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                              (*this).actor.floorHeight + 88.5f32, 1.0f32,
                              3.0f32, 0.0f32) == 0.0f32 &&
               (*this).actor.world.pos.y - (*this).actor.floorHeight < 59.0f32
           {
            let mut pos: Vec3f = (*this).actor.world.pos;
            pos.y = (*this).actor.floorHeight;
            func_80033480(globalCtx, &mut pos, 80.0f32, 1 as libc::c_int,
        ...
        if (*this).unk2D4 <= 0 as libc::c_int {
            ...
            } else if ((*this).actor.params as libc::c_int) < 0 as libc::c_int
             {
                EnPeehat_Ground_SetStateHover(this);
                (*this).riseDelayTimer = 60 as libc::c_int as s16
            } else { EnPeehat_Flying_SetStateFly(this); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_SetStateExplode(mut this: *mut EnPeehat) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPeehatFlyingAnim);
    (*this).state = PEAHAT_STATE_EXPLODE as libc::c_int;
    (*this).animTimer = 5 as libc::c_int as s16;
    (*this).unk2E0 = 0.0f32;
    EnPeehat_SetupAction(this,
                         Some(EnPeehat_StateExplode as
                                  unsafe extern "C" fn(_: *mut EnPeehat,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_StateExplode(mut this: *mut EnPeehat,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    let mut pad: [s32; 2] = [0; 2];
    if (*this).animTimer as libc::c_int == 5 as libc::c_int {
        bomb =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        0 as libc::c_int as s16, 0x602 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Adult_CollisionCheck(mut this:
                                                           *mut EnPeehat,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if (*this).colCylinder.base.acFlags as libc::c_int &
        ...
        (*this).colCylinder.base.acFlags =
            ((*this).colCylinder.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 7 as libc::c_int)) as u8_0;
        (*this).colJntSph.base.acFlags =
            ((*this).colJntSph.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
    } else if (*this).colJntSph.base.acFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).colJntSph.base.acFlags =
            ((*this).colJntSph.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        Actor_SetDropFlagJntSph(&mut (*this).actor, &mut (*this).colJntSph,
                                1 as libc::c_int);
        if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
               PEAHAT_DMG_EFF_NUT as libc::c_int ||
               (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   PEAHAT_DMG_EFF_LIGHT_ICE_ARROW as libc::c_int {
            return
        }
        if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
               PEAHAT_DMG_EFF_HOOKSHOT as libc::c_int {
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
            ...
            while i >= 0 as libc::c_int {
                pos.x =
                    Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
                pos.y = Rand_ZeroOne() * 25.0f32 + (*this).actor.world.pos.y;
                pos.z =
                    Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
                EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                          &mut pos, 70 as libc::c_int as s16,
                                          0 as libc::c_int as s16,
                                          0 as libc::c_int as s16,
                                          -(1 as libc::c_int) as s16);
                i -= 1
...
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPeehat = thisx as *mut EnPeehat;
    let mut i: s32 = 0;
    let mut player: *mut Player =
    ...
    if (*thisx).colChkInfo.damageEffect as libc::c_int !=
           PEAHAT_DMG_EFF_LIGHT_ICE_ARROW as libc::c_int {
        if (*thisx).speedXZ != 0.0f32 || (*thisx).velocity.y != 0.0f32 {
            Actor_MoveForward(thisx);
            Actor_UpdateBgCheckInfo(globalCtx, thisx, 25.0f32, 30.0f32,
                                    30.0f32, 5 as libc::c_int);
        }
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        if (*globalCtx).gameplayFrames & 0x7f as libc::c_int as libc::c_uint
               == 0 as libc::c_int as libc::c_uint {
            (*this).jiggleRotInc = Rand_ZeroOne() * 0.25f32 + 0.5f32
        }
    ...
    if ((*thisx).params as libc::c_int) < 0 as libc::c_int {
        ...
        (*thisx).focus.pos.x =
            (*(*this).colJntSph.elements.offset(0 as libc::c_int as
        ...
        (*thisx).focus.pos.z =
            (*(*this).colJntSph.elements.offset(0 as libc::c_int as
                ...
                as f32_0;
        if (*this).state == PEAHAT_STATE_SEEK_PLAYER as libc::c_int {
            Math_SmoothStepToS(&mut (*thisx).shape.rot.x,
    ...
    } else { (*thisx).focus.pos = (*thisx).world.pos }
    Collider_UpdateCylinder(thisx, &mut (*this).colCylinder);
    if (*thisx).colChkInfo.health as libc::c_int > 0 as libc::c_int {
        // If Adult Peahat
        if (*thisx).params as libc::c_int <= 0 as libc::c_int {
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colCylinder.base);
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colJntSph.base);
            if (*thisx).colorFilterTimer as libc::c_int == 0 as libc::c_int ||
                   (*thisx).colorFilterParams as libc::c_int &
                       0x4000 as libc::c_int == 0 {
                if (*this).state != PEAHAT_STATE_EXPLODE as libc::c_int {
        ...
        if (*thisx).params as libc::c_int != PEAHAT_TYPE_FLYING as libc::c_int
               &&
               (*this).colQuad.base.atFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 {
            (*this).colQuad.base.atFlags =
    ...
    if (*this).state == PEAHAT_STATE_15 as libc::c_int ||
           (*this).state == PEAHAT_STATE_SEEK_PLAYER as libc::c_int ||
           (*this).state == PEAHAT_STATE_FLY as libc::c_int ||
           (*this).state == PEAHAT_STATE_RETURN_HOME as libc::c_int ||
           (*this).state == PEAHAT_STATE_EXPLODE as libc::c_int {
        ...
        if ((*thisx).params as libc::c_int) < 0 as libc::c_int &&
            ...
            while i >= 0 as libc::c_int {
                ...
                let mut bgId: s32 = 0;
                let mut posB: *mut Vec3f =
                    &mut *(*this).bladeTip.as_mut_ptr().offset(i as isize) as
                        *mut Vec3f;
                if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                                           &mut (*thisx).world.pos, posB,
                                           &mut posResult, &mut poly,
                                           1 as libc::c_int, 1 as libc::c_int,
                                           0 as libc::c_int, 1 as libc::c_int,
                                           &mut bgId) == 1 as libc::c_int {
                    func_80033480(globalCtx, &mut posResult, 0.0f32,
                                  1 as libc::c_int, 300 as libc::c_int as s16,
                                  150 as libc::c_int as s16,
                                  1 as libc::c_int as u8_0);
                    EnPeehat_SpawnDust(globalCtx, this, &mut posResult,
                                       0.0f32, 3 as libc::c_int, 1.05f32,
                                       1.5f32);
                }
                i -= 1
            }
        } else if (*thisx).params as libc::c_int !=
                      PEAHAT_TYPE_FLYING as libc::c_int {
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colCylinder.base);
        }
    } else {
    ...
    Math_SmoothStepToF(&mut (*this).scaleShift, 0.0f32, 1.0f32, 0.001f32,
                       0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_OverrideLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnPeehat = thisx as *mut EnPeehat;
    if limbIndex == 4 as libc::c_int {
        (*rot).x = -((*this).bladeRot as libc::c_int) as s16
    }
    if limbIndex == 3 as libc::c_int ||
           limbIndex == 23 as libc::c_int &&
               ((*this).state == PEAHAT_STATE_DYING as libc::c_int ||
                    (*this).state == PEAHAT_STATE_3 as libc::c_int ||
                    (*this).state == PEAHAT_STATE_4 as libc::c_int) {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_peehat.c\x00" as *const u8 as
                            *const libc::c_char, 1946 as libc::c_int);
        Matrix_Push();
        Matrix_Scale(1.0f32, 1.0f32, 1.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX((*this).jiggleRot * 0.115f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY((*this).jiggleRot * 0.13f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ((*this).jiggleRot * 0.1f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(1.0f32 - (*this).scaleShift, (*this).scaleShift + 1.0f32,
                     1.0f32 - (*this).scaleShift,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(-((*this).jiggleRot * 0.1f32),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY(-((*this).jiggleRot * 0.13f32),
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_peehat.c\x00" as *const u8 as
                             *const libc::c_char, 1963 as libc::c_int);
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_PostLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
                                               mut dList: *mut *mut Gfx,
                                               mut rot: *mut Vec3s,
                                               mut thisx: *mut libc::c_void) {
    static mut peahatBladeTip: [Vec3f; 2] =
        [{ let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 5500.0f32,}; init },
         {
             let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -5500.0f32,};
             init
         }];
    let mut this: *mut EnPeehat = thisx as *mut EnPeehat;
    let mut damageYRot: f32_0 = 0.;
    if limbIndex == 4 as libc::c_int {
        Matrix_MultVec3f(&mut *peahatBladeTip.as_mut_ptr().offset(0 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
                         &mut *(*this).bladeTip.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
        Matrix_MultVec3f(&mut *peahatBladeTip.as_mut_ptr().offset(1 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
                         &mut *(*this).bladeTip.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
        return
    ...
    if limbIndex == 3 as libc::c_int &&
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_peehat.c\x00" as *const u8 as
                            *const libc::c_char, 1981 as libc::c_int);
        Matrix_Push();
        Matrix_Translate(-1000.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).colJntSph);
        Matrix_Translate(500.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        if (*this).actor.colorFilterTimer as libc::c_int != 0 as libc::c_int
               &&
               (*this).actor.colorFilterParams as libc::c_int &
                   0x4000 as libc::c_int != 0 {
            damageYRot =
                Math_SinS(((*this).actor.colorFilterTimer as libc::c_int *
                               0x4e20 as libc::c_int) as s16) * 0.35f32
        }
        Matrix_RotateY(3.2f32 + damageYRot,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(0.3f32, 0.2f32, 0.2f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_peehat.c\x00" as *const u8 as
                             *const libc::c_char, 1994 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPeehat_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_80AD285C: [Vec3f; 4] =
        [{ let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -4500.0f32,}; init },
    ...
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      ...
                      Some(EnPeehat_OverrideLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    ...
                                                    _: *mut libc::c_void)
                                   -> s32),
                      Some(EnPeehat_PostLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: s32, _: *mut *mut Gfx,
                                                    _: *mut Vec3s,
                                                    _: *mut libc::c_void)
                                   -> ()), this as *mut libc::c_void);
    if (*this).actor.speedXZ != 0.0f32 || (*this).actor.velocity.y != 0.0f32 {
        Matrix_MultVec3f(&mut *D_80AD285C.as_mut_ptr().offset(0 as libc::c_int
                                                                  as isize),
                         &mut *(*this).colQuad.dim.quad.as_mut_ptr().offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
        Matrix_MultVec3f(&mut *D_80AD285C.as_mut_ptr().offset(1 as libc::c_int
                                                                  as isize),
                         &mut *(*this).colQuad.dim.quad.as_mut_ptr().offset(0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
        Matrix_MultVec3f(&mut *D_80AD285C.as_mut_ptr().offset(2 as libc::c_int
                                                                  as isize),
                         &mut *(*this).colQuad.dim.quad.as_mut_ptr().offset(3
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
        Matrix_MultVec3f(&mut *D_80AD285C.as_mut_ptr().offset(3 as libc::c_int
                                                                  as isize),
                         &mut *(*this).colQuad.dim.quad.as_mut_ptr().offset(2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
        Collider_SetQuadVertices(&mut (*this).colQuad,
                                 &mut *(*this).colQuad.dim.quad.as_mut_ptr().offset(0
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(700 as libc::c_int);
             init
         }]
}
#[used]
