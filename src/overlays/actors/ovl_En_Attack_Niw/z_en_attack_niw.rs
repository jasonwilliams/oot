...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnAttackNiw {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
    pub actionFunc: EnAttackNiwActionFunc,
    pub unk_254: s16,
    pub unk_256: s16,
    pub unk_258: s16,
    pub unk_25A: s16,
    ...
    pub unk_28C: s16,
    pub unk_28E: s16,
    pub unk_290: [libc::c_char; 2],
    pub unk_292: s16,
    pub unk_294: [libc::c_char; 2],
    pub unk_296: s16,
    pub unk_298: Vec3f,
    pub unk_2A4: Vec3f,
    pub unk_2B0: Vec3f,
...
pub type EnAttackNiwActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAttackNiw, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNiw {
...
#[no_mangle]
pub static mut En_Attack_Niw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ATTACK_NIW as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnAttackNiw>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAttackNiw_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAttackNiw_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAttackNiw_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAttackNiw_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnAttackNiw_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAttackNiw = thisx as *mut EnAttackNiw;
    let mut pad: s32 = 0;
    ...
    (*this).unk_298.x = Rand_CenteredFloat(100.0f32);
    (*this).unk_298.y = Rand_CenteredFloat(10.0f32);
    (*this).unk_298.z = Rand_CenteredFloat(100.0f32);
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.world.rot.y =
        ((Rand_ZeroOne() - 0.5f32) * 60000.0f32) as s16;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    (*this).actionFunc =
        Some(func_809B5670 as
                 unsafe extern "C" fn(_: *mut EnAttackNiw,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnAttackNiw_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnAttackNiw = thisx as *mut EnAttackNiw;
    let mut cucco: *mut EnNiw = (*this).actor.parent as *mut EnNiw;
    if !(*this).actor.parent.is_null() {
        if (*cucco).actor.update.is_some() &&
               (*cucco).unk_296 as libc::c_int > 0 as libc::c_int {
            (*cucco).unk_296 -= 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B5268(mut this: *mut EnAttackNiw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s16) {
    if (*this).unk_254 as libc::c_int == 0 as libc::c_int {
        ...
        if (*this).unk_28E as libc::c_int & 1 as libc::c_int ==
               0 as libc::c_int {
            (*this).unk_264 = 0.0f32;
            if arg2 as libc::c_int == 0 as libc::c_int {
    ...
    if (*this).unk_288 != (*this).unk_2C0 {
        Math_ApproachF(&mut (*this).unk_2C0, (*this).unk_288, 0.5f32,
                       4000.0f32);
    }
    if (*this).unk_264 != (*this).unk_2BC {
        Math_ApproachF(&mut (*this).unk_2BC, (*this).unk_264, 0.5f32,
                       4000.0f32);
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_809B55EC(mut this: *mut EnAttackNiw,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut sp1E: s16 = 0;
    let mut sp1C: s16 = 0;
    Actor_SetFocus(&mut (*this).actor, (*this).unk_2E4);
    Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp1E, &mut sp1C);
    if (*this).actor.projectedPos.z < -20.0f32 ||
           (sp1E as libc::c_int) < 0 as libc::c_int ||
           sp1E as libc::c_int > 320 as libc::c_int ||
           (sp1C as libc::c_int) < 0 as libc::c_int ||
           sp1C as libc::c_int > 240 as libc::c_int {
        return 0 as libc::c_int
    } else { return 1 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B5670(mut this: *mut EnAttackNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp4E: s16 = 0;
    let mut sp4C: s16 = 0;
    ...
    tmpf1 =
        (*this).unk_298.x + (*globalCtx).view.lookAt.x -
            (*globalCtx).view.eye.x;
    tmpf2 =
        (*this).unk_298.y + (*globalCtx).view.lookAt.y -
            (*globalCtx).view.eye.y;
    tmpf3 =
        (*this).unk_298.z + (*globalCtx).view.lookAt.z -
    ...
    (*this).unk_2D4 =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut sp34) as f32_0;
    (*this).unk_2D0 =
        Math_Vec3f_Pitch(&mut (*this).actor.world.pos, &mut sp34) as
            libc::c_int as libc::c_float * -1.0f32;
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_2D4 as s16,
                       5 as libc::c_int as s16, (*this).unk_2DC as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.world.rot.x, (*this).unk_2D0 as s16,
                       5 as libc::c_int as s16, (*this).unk_2DC as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2DC, 5000.0f32, 1.0f32, 100.0f32);
    Actor_SetFocus(&mut (*this).actor, (*this).unk_2E4);
    Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp4E, &mut sp4C);
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        (*this).unk_2D4 = (*this).actor.yawTowardsPlayer as f32_0;
        (*this).unk_2D0 =
        ...
        (*this).unk_284 = 0.0f32;
        (*this).unk_27C = 0.0f32;
        (*this).unk_25A = 0 as libc::c_int as s16;
        (*this).unk_258 = (*this).unk_25A;
        (*this).unk_256 = (*this).unk_258;
        (*this).unk_254 = (*this).unk_256;
        (*this).unk_25C = 0x64 as libc::c_int as s16;
        (*this).actor.gravity = -0.2f32;
        (*this).unk_2E0 = 5.0f32;
        (*this).unk_288 = 0.0f32;
        (*this).actionFunc =
            Some(func_809B59B0 as
                     unsafe extern "C" fn(_: *mut EnAttackNiw,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).actor.projectedPos.z > 0.0f32 &&
                  fabsf(sp34.x - (*this).actor.world.pos.x) < 50.0f32 &&
                  fabsf(sp34.y - (*this).actor.world.pos.y) < 50.0f32 &&
                  fabsf(sp34.z - (*this).actor.world.pos.z) < 50.0f32 ||
        ...
        (*this).unk_254 = 10 as libc::c_int as s16;
        (*this).unk_264 = -10000.0f32;
        (*this).unk_288 = -3000.0f32;
        func_809B5268(this, globalCtx, 2 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B59B0(mut this: *mut EnAttackNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if func_809B55EC(this, globalCtx) == 0 {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        if (*this).unk_25A as libc::c_int == 0 as libc::c_int {
            (*this).unk_25A = 3 as libc::c_int as s16;
            (*this).actor.velocity.y = 3.5f32
        }
        if (*this).actor.gravity != -2.0f32 {
            (*this).unk_278 = 14000.0f32;
            (*this).unk_280 = (*this).unk_278;
            (*this).unk_27C = 0.0f32;
            (*this).unk_284 = (*this).unk_27C;
            (*this).unk_268 = (*this).unk_284;
            (*this).unk_26C = (*this).unk_268;
            (*this).unk_2D0 = (*this).unk_26C;
            (*this).unk_2D4 = (*this).actor.yawTowardsPlayer as f32_0;
            (*this).unk_262 = 0x32 as libc::c_int as s16;
            (*this).unk_25C = 0x64 as libc::c_int as s16;
            (*this).actor.gravity = -2.0f32
        }
    }
    if (*this).unk_25C as libc::c_int == 0x32 as libc::c_int {
        (*this).unk_2D4 =
            Rand_CenteredFloat(200.0f32) +
                (*this).actor.yawTowardsPlayer as libc::c_int as libc::c_float
    }
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_2D4 as s16,
                       2 as libc::c_int as s16, (*this).unk_2DC as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.world.rot.x, (*this).unk_2D0 as s16,
                       2 as libc::c_int as s16, (*this).unk_2DC as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2DC, 10000.0f32, 1.0f32, 1000.0f32);
    Math_ApproachF(&mut (*this).actor.speedXZ, (*this).unk_2E0, 0.9f32,
                   1.0f32);
    if (*this).actor.gravity == -2.0f32 &&
           (*this).unk_262 as libc::c_int == 0 as libc::c_int &&
        ...
        (*this).unk_2D0 =
            (*this).actor.world.rot.x as libc::c_int as libc::c_float -
                5000.0f32;
        (*this).actionFunc =
            Some(func_809B5C18 as
                     unsafe extern "C" fn(_: *mut EnAttackNiw,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                  0 {
        func_809B5268(this, globalCtx, 5 as libc::c_int as s16);
    } else { func_809B5268(this, globalCtx, 2 as libc::c_int as s16); };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B5C18(mut this: *mut EnAttackNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if func_809B55EC(this, globalCtx) == 0 {
        Actor_Kill(&mut (*this).actor);
        return
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.x, (*this).unk_2D0 as s16,
                       ...
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2DC, 5000.0f32, 1.0f32, 100.0f32);
    Math_ApproachF(&mut (*this).actor.velocity.y, 5.0f32, 0.3f32, 1.0f32);
    func_809B5268(this, globalCtx, 2 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnAttackNiw_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut tmpf1: f32_0 = 0.;
    let mut this: *mut EnAttackNiw = thisx as *mut EnAttackNiw;
    let mut cucco: *mut EnNiw = 0 as *mut EnNiw;
    ...
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx2);
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0 &&
           (*this).actionFunc !=
               Some(func_809B5C18 as
                        unsafe extern "C" fn(_: *mut EnAttackNiw,
                                             _: *mut GlobalContext) -> ()) {
        Math_Vec3f_Copy(&mut sp30, &mut (*this).actor.world.pos);
        sp30.y += (*this).actor.yDistToWater;
        EffectSsGSplash_Spawn(globalCtx, &mut sp30, 0 as *mut Color_RGBA8,
    ...
    tmpf1 = 20.0f32;
    if (*this).actor.xyzDistToPlayerSq < tmpf1 * tmpf1 {
        cucco = (*this).actor.parent as *mut EnNiw;
        if (*(*this).actor.parent).update.is_some() &&
               !(*this).actor.parent.is_null() && !cucco.is_null() &&
               (*cucco).timer9 as libc::c_int == 0 as libc::c_int &&
               (*player).invincibilityTimer as libc::c_int == 0 as libc::c_int
           {
            ...
            (*cucco).timer9 = 0x46 as libc::c_int as s16
        }
    }
    if (*this).unk_25E as libc::c_int == 0 as libc::c_int {
        (*this).unk_25E = 30 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2812 as libc::c_int as u16_0);
    }
    if (*this).unk_260 as libc::c_int == 0 as libc::c_int {
        (*this).unk_260 = 7 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ff as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B5F98(mut globalCtx: *mut GlobalContext,
                                       mut limbIndex: s32,
    ...
    if limbIndex == 13 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_2BC as s16 as libc::c_int)
                as s16
    }
    if limbIndex == 15 as libc::c_int {
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_2C0 as s16 as libc::c_int)
                as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnAttackNiw_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAttackNiw = thisx as *mut EnAttackNiw;
