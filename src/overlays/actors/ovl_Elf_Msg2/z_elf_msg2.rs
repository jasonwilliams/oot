...
pub struct ElfMsg2 {
    pub actor: Actor,
    pub actionFunc: ElfMsg2ActionFunc,
}
pub type ElfMsg2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ElfMsg2, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Elf_Msg2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ELF_MSG2 as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ElfMsg2_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_SetupAction(mut this: *mut ElfMsg2,
                                             mut actionFunc:
                                                 ElfMsg2ActionFunc) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_KillCheck(mut this: *mut ElfMsg2,
    ...
    if (*this).actor.world.rot.y as libc::c_int > 0 as libc::c_int &&
           ...
           Flags_GetSwitch(globalCtx,
                           (*this).actor.world.rot.y as libc::c_int -
                               1 as libc::c_int) != 0 {
        LogUtils_LogThreadId(b"../z_elf_msg2.c\x00" as *const u8 as
                                 *const libc::c_char,
                             171 as libc::c_int); // "Mutual destruction"
        osSyncPrintf(b"\"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\" = %s\n\x00" as
                         *const u8 as *const libc::c_char,
                     b"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\x00" as *const u8
                         as *const libc::c_char); // "Mutual destruction 2"
        if (*this).actor.params as libc::c_int >> 8 as libc::c_int &
            ...
            Flags_SetSwitch(globalCtx,
                            (*this).actor.params as libc::c_int >>
                                8 as libc::c_int &
                                0x3f as libc::c_int); // "Mutual destruction"
        } // Make actor targetable and Navi-checkable
        ...
        if (*this).actor.world.rot.y as libc::c_int == -(1 as libc::c_int) &&
            ...
            osSyncPrintf(b"\"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\xef\xbc\x92\" = %s\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\xef\xbc\x92\x00"
                             as *const u8 as *const libc::c_char);
            if (*this).actor.params as libc::c_int >> 8 as libc::c_int &
                   0x3f as libc::c_int != 0x3f as libc::c_int {
                Flags_SetSwitch(globalCtx,
            ...
            if (*this).actor.params as libc::c_int >> 8 as libc::c_int &
                ...
                if Flags_GetSwitch(globalCtx,
                                   (*this).actor.params as libc::c_int >>
                                       8 as libc::c_int & 0x3f as libc::c_int)
                       != 0 {
                    LogUtils_LogThreadId(b"../z_elf_msg2.c\x00" as *const u8
                                             as *const libc::c_char,
                                         192 as libc::c_int);
                    osSyncPrintf(b"\"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\" = %s\n\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\x00"
                                     as *const u8 as *const libc::c_char);
                    Actor_Kill(&mut (*this).actor);
                    return 1 as libc::c_int
                }
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ElfMsg2 = thisx as *mut ElfMsg2;
    osSyncPrintf(b"\x1b[36m Elf_Msg2_Actor_ct %04x\n\n\x1b[m\x00" as *const u8
                     as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    if ElfMsg2_KillCheck(this, globalCtx) == 0 {
        if (*this).actor.world.rot.x as libc::c_int > 0 as libc::c_int &&
               ((*this).actor.world.rot.x as libc::c_int) < 8 as libc::c_int {
            (*this).actor.targetMode =
                ((*this).actor.world.rot.x as libc::c_int - 1 as libc::c_int)
                    as s8
        }
        Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
        if (*this).actor.world.rot.y as libc::c_int >= 0x41 as libc::c_int {
            ElfMsg2_SetupAction(this,
                                Some(ElfMsg2_WaitUntilActivated as
                                         unsafe extern "C" fn(_: *mut ElfMsg2,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
        } else {
            ElfMsg2_SetupAction(this,
                                Some(ElfMsg2_WaitForTextRead as
                                         unsafe extern "C" fn(_: *mut ElfMsg2,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
            ...
            (*this).actor.textId = ElfMsg2_GetMessageId(this) as u16_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_GetMessageId(mut this: *mut ElfMsg2) -> s32 {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_WaitForTextClose(mut this: *mut ElfMsg2,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut switchFlag: s32 = 0;
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.world.rot.z as libc::c_int != 1 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            switchFlag =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_WaitForTextRead(mut this: *mut ElfMsg2,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ElfMsg2_SetupAction(this,
                            Some(ElfMsg2_WaitForTextClose as
                                     unsafe extern "C" fn(_: *mut ElfMsg2,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_WaitUntilActivated(mut this: *mut ElfMsg2,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ElfMsg2 = thisx as *mut ElfMsg2;
    if ElfMsg2_KillCheck(this, globalCtx) == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg2_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_elf_msg2.c\x00" as *const u8 as
                        *const libc::c_char, 355 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = D_809ADC38.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = sCubeDL.as_mut_ptr() as libc::c_uint;
