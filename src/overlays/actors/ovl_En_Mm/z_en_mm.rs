...
extern "C" {
    ...
    #[no_mangle]
    static mut gRunningManSprintAnim: AnimationHeader;
    #[no_mangle]
    static mut gRunningManRunAnim: AnimationHeader;
    #[no_mangle]
    static mut gRunningManMouthClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gRunningManMouthOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gRunningManSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gRunningManSitStandAnim: AnimationHeader;
    #[no_mangle]
    static mut gRunningManSitWaitAnim: AnimationHeader;
    #[no_mangle]
    static mut gRunningManExcitedAnim: AnimationHeader;
    #[no_mangle]
    static mut gRunningManHappyAnim: AnimationHeader;
    #[no_mangle]
...
pub struct EnMm {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnMmActionFunc,
    pub collider: ColliderCylinder,
    pub unk_1E0: s32,
    pub mouthTexIndex: s32,
    pub unk_1E8: s32,
    pub path: s32,
    pub unk_1F0: s32,
    pub waypoint: s32,
    pub yawToWaypoint: f32_0,
    pub distToWaypoint: f32_0,
    pub speedXZ: f32_0,
    pub unk_204: s32,
    pub unk_208: MtxF,
    pub unk_248: Vec3s,
    pub unk_24E: Vec3s,
    pub unk_254: s32,
    pub curAnimIndex: s32,
    pub sitTimer: s32,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
}
pub type EnMmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMm, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const RM_ANIM_HAPPY: C2RustUnnamed_26 = 6;
pub const RM_ANIM_EXCITED: C2RustUnnamed_26 = 5;
pub const RM_ANIM_SPRINT: C2RustUnnamed_26 = 4;
pub const RM_ANIM_STAND: C2RustUnnamed_26 = 3;
pub const RM_ANIM_SIT_WAIT: C2RustUnnamed_26 = 2;
pub const RM_ANIM_SIT: C2RustUnnamed_26 = 1;
pub const RM_ANIM_RUN: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const RM_MOUTH_OPEN: C2RustUnnamed_27 = 1;
pub const RM_MOUTH_CLOSED: C2RustUnnamed_27 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnMmAnimEntry {
...
#[no_mangle]
pub static mut En_Mm_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MM as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_MM as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMm>() as libc::c_ulong,
                          init:
...
static mut sColChkInfoInit: [CollisionCheckInfoInit2; 1] =
    [{
         let mut init =
...
// size = 0x10
static mut sAnimationEntries: [EnMmAnimEntry; 7] =
    unsafe {
        [{
             let mut init =
                 EnMmAnimEntry{animation:
                                   &gRunningManRunAnim as
...
static mut sPathInfo: [EnMmPathInfo; 4] =
    [{
         let mut init =
             EnMmPathInfo{unk_00: 0 as libc::c_int,
                          unk_04: 1 as libc::c_int,
                          unk_08: 0 as libc::c_int,
                          unk_0C: 0 as libc::c_int,};
         init
     },
     {
         let mut init =
             EnMmPathInfo{unk_00: 1 as libc::c_int,
                          unk_04: 1 as libc::c_int,
                          unk_08: 0 as libc::c_int,
                          unk_0C: 1 as libc::c_int,};
         init
     },
     {
         let mut init =
             EnMmPathInfo{unk_00: 1 as libc::c_int,
                          unk_04: 3 as libc::c_int,
                          unk_08: 2 as libc::c_int,
                          unk_0C: 1 as libc::c_int,};
         init
     },
     {
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_ChangeAnimation(mut this: *mut EnMm,
                                              mut newAnimIndex: s32,
                                              mut curAnimIndex: *mut s32) {
    let mut morphFrames: f32_0 = 0.;
    if *curAnimIndex < 0 as libc::c_int || newAnimIndex == *curAnimIndex {
        morphFrames = 0.0f32
    } else {
        morphFrames = sAnimationEntries[newAnimIndex as usize].morphFrames
    }
    if sAnimationEntries[newAnimIndex as usize].playSpeed >= 0.0f32 {
        Animation_Change(&mut (*this).skelAnime,
                         sAnimationEntries[newAnimIndex as usize].animation,
                         sAnimationEntries[newAnimIndex as usize].playSpeed,
                         0.0f32,
                         Animation_GetLastFrame(sAnimationEntries[newAnimIndex
                                                                      as
                                                                      usize].animation
                                                    as *mut libc::c_void) as
                             f32_0,
                         sAnimationEntries[newAnimIndex as usize].mode,
                         morphFrames);
    } else {
        Animation_Change(&mut (*this).skelAnime,
                         sAnimationEntries[newAnimIndex as usize].animation,
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnMm = thisx as *mut EnMm;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gRunningManSkel, 0 as *mut AnimationHeader,
    ...
    Animation_Change(&mut (*this).skelAnime,
                     sAnimationEntries[RM_ANIM_RUN as libc::c_int as
                                           usize].animation, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(sAnimationEntries[RM_ANIM_RUN as
                                                                  libc::c_int
                                                                  as
                                                                  usize].animation
                                                as *mut libc::c_void) as
                     ...
                     sAnimationEntries[RM_ANIM_RUN as libc::c_int as
                                           usize].morphFrames);
    (*this).path = (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    (*this).unk_1F0 = 2 as libc::c_int;
    (*this).unk_1E8 = 0 as libc::c_int;
    (*this).actor.targetMode = 2 as libc::c_int as s8;
    (*this).actor.gravity = -1.0f32;
    (*this).speedXZ = 3.0f32;
    (*this).unk_204 = (*this).actor.objBankIndex as s32;
    if func_80AADA70() == 1 as libc::c_int {
        (*this).mouthTexIndex = RM_MOUTH_OPEN as libc::c_int;
        EnMm_ChangeAnimation(this, RM_ANIM_RUN as libc::c_int,
                             &mut (*this).curAnimIndex);
        (*this).actionFunc =
            Some(func_80AAE598 as
                     unsafe extern "C" fn(_: *mut EnMm, _: *mut GlobalContext)
                         -> ())
    } else {
        (*this).mouthTexIndex = RM_MOUTH_CLOSED as libc::c_int;
        EnMm_ChangeAnimation(this, RM_ANIM_SIT_WAIT as libc::c_int,
                             &mut (*this).curAnimIndex);
        (*this).actionFunc =
            Some(func_80AAE294 as
                     unsafe extern "C" fn(_: *mut EnMm, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMm_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnMm = thisx as *mut EnMm;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AADA70() -> s32 {
    let mut isDay: s32 = 0 as libc::c_int;
    if gSaveContext.dayTime as libc::c_int > 0x3555 as libc::c_int &&
           gSaveContext.dayTime as libc::c_int <= 0xd556 as libc::c_int {
        isDay = 1 as libc::c_int
    }
    return isDay;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AADAA0(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    ...
    let mut sp1C: s32 = 1 as libc::c_int;
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        4 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                       0 as libc::c_int {
                    (*player).actor.textId = 0x202d as libc::c_int as u16_0;
                    (*this).unk_254 &= !(1 as libc::c_int);
                    EnMm_ChangeAnimation(this, RM_ANIM_HAPPY as libc::c_int,
                                         &mut (*this).curAnimIndex);
                } else {
                    (*player).actor.textId = 0x202c as libc::c_int as u16_0;
                    gSaveContext.infTable[23 as libc::c_int as usize] =
                        (gSaveContext.infTable[23 as libc::c_int as usize] as
                             libc::c_int | 0x1000 as libc::c_int) as u16_0
                }
                sp1C = 2 as libc::c_int
            }
        }
        5 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                ...
                Rupees_ChangeBy(500 as libc::c_int as s16);
                (*player).actor.textId = 0x202e as libc::c_int as u16_0;
                sp1C = 2 as libc::c_int
            }
        }
        6 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*player).actor.textId as libc::c_int ==
                       0x202e as libc::c_int ||
                       (*player).actor.textId as libc::c_int ==
                           0x202c as libc::c_int {
                    (*this).unk_254 |= 1 as libc::c_int;
                    EnMm_ChangeAnimation(this,
                                         RM_ANIM_SIT_WAIT as libc::c_int,
                                         &mut (*this).curAnimIndex);
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_GetTextId(mut this: *mut EnMm,
                                        mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut textId: s32 = 0;
    textId =
        Text_GetFaceReaction(globalCtx, 0x1c as libc::c_int as u32_0) as s32;
    if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
           0x800 as libc::c_int != 0 {
        if textId == 0 as libc::c_int { textId = 0x204d as libc::c_int }
    } else if (*player).currentMask as libc::c_int ==
                  PLAYER_MASK_BUNNY as libc::c_int {
        textId =
            if gSaveContext.infTable[23 as libc::c_int as usize] as
                   libc::c_int & 0x1000 as libc::c_int != 0 {
                0x202b as libc::c_int
            } else { 0x202a as libc::c_int }
    } else if textId == 0 as libc::c_int { textId = 0x2029 as libc::c_int }
    return textId;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AADCD0(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut yawDiff: f32_0 = 0.;
    let mut sp26: s16 = 0;
    let mut sp24: s16 = 0;
    if (*this).unk_1E0 == 2 as libc::c_int {
        Message_ContinueTextbox(globalCtx, (*player).actor.textId);
        (*this).unk_1E0 = 1 as libc::c_int
    } else if (*this).unk_1E0 == 1 as libc::c_int {
        (*this).unk_1E0 = func_80AADAA0(this, globalCtx)
    } else if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).unk_1E0 = 1 as libc::c_int;
        if (*this).curAnimIndex != 5 as libc::c_int {
            if (*this).actor.textId as libc::c_int == 0x202a as libc::c_int ||
                   (*this).actor.textId as libc::c_int ==
                       0x202b as libc::c_int {
                EnMm_ChangeAnimation(this, RM_ANIM_EXCITED as libc::c_int,
                                     &mut (*this).curAnimIndex);
        ...
        if sp26 as libc::c_int >= 0 as libc::c_int &&
               sp26 as libc::c_int <= 0x140 as libc::c_int &&
               sp24 as libc::c_int >= 0 as libc::c_int &&
               sp24 as libc::c_int <= 0xf0 as libc::c_int &&
               yawDiff <= 17152.0f32 && (*this).unk_1E0 != 3 as libc::c_int &&
               func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32) != 0 {
            (*this).actor.textId = EnMm_GetTextId(this, globalCtx) as u16_0
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMm_GetPointCount(mut pathList: *mut Path,
                                            mut pathNum: s32) -> s32 {
    return (*pathList.offset(pathNum as isize)).count as s32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AADE60(mut pathList: *mut Path,
                                       mut pos: *mut Vec3f, mut pathNum: s32,
                                       mut waypoint: s32) -> s32 {
    let mut pointPos: *mut Vec3s = 0 as *mut Vec3s;
    pointPos =
        &mut *((*gSegments.as_mut_ptr().offset((((*pathList.offset(pathNum as
                                                                       isize)).points
                                                     as u32_0) <<
                                                    4 as libc::c_int >>
                                                    28 as libc::c_int) as
                                                   isize)).wrapping_add((*pathList.offset(pathNum
                                                                                              as
                                                                                              isize)).points
                                                                            as
                                                                            u32_0
                                                                            ...
                                                                            0xffffff
                                                                                ...
                                                                                libc::c_uint).wrapping_add(0x80000000
                                                                                                               ...
                                                                                                               libc::c_uint)
                   as *mut libc::c_void as
                   *mut Vec3s).offset(waypoint as isize) as *mut Vec3s;
    (*pos).x = (*pointPos).x as f32_0;
    (*pos).y = (*pointPos).y as f32_0;
    (*pos).z = (*pointPos).z as f32_0;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AADEF0(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut xDiff: f32_0 = 0.;
    let mut zDiff: f32_0 = 0.;
    let mut waypointPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut phi_a2: s32 = 0;
    let mut phi_v1: s32 = 0;
    func_80AADE60((*globalCtx).setupPathList, &mut waypointPos, (*this).path,
                  (*this).waypoint);
    ...
    (*this).yawToWaypoint =
        (Math_FAtan2F(xDiff, zDiff) *
             (0x8000 as libc::c_int as libc::c_float /
                  3.14159265358979323846f32)) as s32 as f32_0;
    (*this).distToWaypoint = sqrtf(xDiff * xDiff + zDiff * zDiff);
    while (*this).distToWaypoint <= 10.44f32 &&
              (*this).unk_1E8 != 0 as libc::c_int {
        (*this).waypoint += sPathInfo[(*this).unk_1E8 as usize].unk_00;
        phi_a2 = sPathInfo[(*this).unk_1E8 as usize].unk_08;
        match phi_a2 {
            0 => { phi_a2 = 0 as libc::c_int }
            1 => {
                phi_a2 =
                    EnMm_GetPointCount((*globalCtx).setupPathList,
                                       (*this).path) - 1 as libc::c_int
            }
            2 => { phi_a2 = (*this).unk_1F0 }
            _ => { }
        }
        phi_v1 = sPathInfo[(*this).unk_1E8 as usize].unk_0C;
        match phi_v1 {
            0 => { phi_v1 = 0 as libc::c_int }
            1 => {
                phi_v1 =
                    EnMm_GetPointCount((*globalCtx).setupPathList,
                                       (*this).path) - 1 as libc::c_int
            }
            2 => { phi_v1 = (*this).unk_1F0 }
            _ => { }
        }
        if sPathInfo[(*this).unk_1E8 as usize].unk_00 >= 0 as libc::c_int &&
               ((*this).waypoint < phi_a2 || phi_v1 < (*this).waypoint) ||
               sPathInfo[(*this).unk_1E8 as usize].unk_00 < 0 as libc::c_int
                   && (phi_a2 < (*this).waypoint || (*this).waypoint < phi_v1)
           {
            (*this).unk_1E8 = sPathInfo[(*this).unk_1E8 as usize].unk_04;
            (*this).waypoint = sPathInfo[(*this).unk_1E8 as usize].unk_08
        }
        func_80AADE60((*globalCtx).setupPathList, &mut waypointPos,
                      (*this).path, (*this).waypoint);
        xDiff = waypointPos.x - (*this).actor.world.pos.x;
        zDiff = waypointPos.z - (*this).actor.world.pos.z;
        (*this).yawToWaypoint =
            (Math_FAtan2F(xDiff, zDiff) *
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).yawToWaypoint as s16, 1 as libc::c_int as s16,
                       2500 as libc::c_int as s16, 0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).speedXZ, 0.6f32,
                       (*this).distToWaypoint, 0.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAE224(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAE294(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut floorYNorm: f32_0 = 0.;
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if Player_InCsMode(globalCtx) == 0 {
        SkelAnime_Update(&mut (*this).skelAnime);
        if (*this).curAnimIndex == 0 as libc::c_int {
        ...
        if (*this).curAnimIndex == 4 as libc::c_int {
            if (*this).skelAnime.curFrame - (*this).skelAnime.playSpeed <
                   9.0f32 && (*this).skelAnime.curFrame >= 9.0f32 ||
                   (*this).skelAnime.curFrame - (*this).skelAnime.playSpeed <
                       19.0f32 && (*this).skelAnime.curFrame >= 19.0f32 {
                Audio_PlayActorSound2(&mut (*this).actor,
        ...
        if func_80AADA70() == 0 as libc::c_int {
            if !(*this).actor.floorPoly.is_null() {
                floorYNorm =
                    (*(*this).actor.floorPoly).normal.y as libc::c_int as
                        libc::c_float * (1.0f32 / 32767.0f32);
                if floorYNorm > 0.9848f32 || floorYNorm < -0.9848f32 {
                    if (*this).sitTimer > 30 as libc::c_int {
                        EnMm_ChangeAnimation(this, RM_ANIM_SIT as libc::c_int,
                                             &mut (*this).curAnimIndex);
                        (*this).actionFunc =
                            Some(func_80AAE224 as
                                     unsafe extern "C" fn(_: *mut EnMm,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ())
                    } else { (*this).sitTimer += 1 }
                } else { (*this).sitTimer = 0 as libc::c_int }
            }
        }
        if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int != 0 {
            ...
            if gSaveContext.gameMode != 3 as libc::c_int {
                func_80033480(globalCtx, &mut dustPos, 50.0f32,
                              2 as libc::c_int, 350 as libc::c_int as s16,
            ...
            if (*this).collider.base.ocFlags2 as libc::c_int &
                ...
                func_8002F71C(globalCtx, &mut (*this).actor, 3.0f32,
                              (*this).actor.yawTowardsPlayer, 4.0f32);
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAE50C(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).sitTimer = 0 as libc::c_int;
        (*this).actionFunc =
            Some(func_80AAE294 as
                     unsafe extern "C" fn(_: *mut EnMm, _: *mut GlobalContext)
                         -> ());
        if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int != 0 {
            EnMm_ChangeAnimation(this, RM_ANIM_SPRINT as libc::c_int,
                                 &mut (*this).curAnimIndex);
            (*this).mouthTexIndex = RM_MOUTH_CLOSED as libc::c_int
        } else {
            EnMm_ChangeAnimation(this, RM_ANIM_RUN as libc::c_int,
        ...
        (*this).unk_1E8 = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAE598(mut this: *mut EnMm,
                                       mut globalCtx: *mut GlobalContext) {
    func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_248,
                  &mut (*this).unk_24E, (*this).actor.focus.pos);
    SkelAnime_Update(&mut (*this).skelAnime);
    if func_80AADA70() != 0 as libc::c_int &&
           (*this).unk_1E0 == 0 as libc::c_int {
        (*this).unk_1E0 = 3 as libc::c_int;
        (*this).actionFunc =
            Some(func_80AAE50C as
                     unsafe extern "C" fn(_: *mut EnMm, _: *mut GlobalContext)
                         -> ());
        (*this).unk_254 &= !(1 as libc::c_int);
        EnMm_ChangeAnimation(this, RM_ANIM_STAND as libc::c_int,
                             &mut (*this).curAnimIndex);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMm_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnMm = thisx as *mut EnMm;
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut mouthTextures: [*mut libc::c_void; 2] =
        unsafe {
            [gRunningManMouthOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gRunningManMouthClosedTex.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut pad: s32 = 0;
    let mut this: *mut EnMm = thisx as *mut EnMm;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_mm.c\x00" as *const u8 as *const libc::c_char,
                    1065 as libc::c_int);
    ...
    if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
           0x800 as libc::c_int != 0 {
        let mut linkChildObjBankIndex: s32 =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_LINK_CHILD as libc::c_int as s16);
        if linkChildObjBankIndex >= 0 as libc::c_int {
            let mut mtx: *mut Mtx = 0 as *mut Mtx;
            let mut sp50: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
            ...
            Matrix_Put(&mut (*this).unk_208);
            mtx2 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_mm.c\x00" as *const u8 as
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                (*globalCtx).objectCtx.status[linkChildObjBankIndex as
                                                  usize].segment as
                    libc::c_uint;
            ...
            (*_g_2).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0xd as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                mtx2.offset(-(7 as libc::c_int as isize)) as libc::c_uint;
            sp50.x = 994 as libc::c_int as s16;
            sp50.y = 3518 as libc::c_int as s16;
            sp50.z = -(13450 as libc::c_int) as s16;
            func_800D1694(97.0f32, -1203.0f32, -240.0f32, &mut sp50);
            let fresh4 = mtx;
            mtx = mtx.offset(1);
            Matrix_ToMtx(fresh4,
                         b"../z_en_mm.c\x00" as *const u8 as
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gLinkChildBunnyHoodDL.as_mut_ptr() as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnMm = thisx as *mut EnMm;
    if (*this).unk_254 & 1 as libc::c_int != 0 {
        match limbIndex {
            8 => {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_24E.y as libc::c_int) as s16;
                (*rot).y =
                    ((*rot).y as libc::c_int -
                         (*this).unk_24E.x as libc::c_int) as s16
            }
            15 => {
                (*rot).x =
                    ((*rot).x as libc::c_int +
                         (*this).unk_248.y as libc::c_int) as s16;
                (*rot).z =
                    ((*rot).z as libc::c_int +
                         ((*this).unk_248.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn EnMm_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut headOffset: Vec3f =
        { let mut init = Vec3f{x: 200.0f32, y: 800.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnMm = thisx as *mut EnMm;
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut headOffset, &mut (*this).actor.focus.pos);
        Matrix_Translate(260.0f32, 20.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY(0.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX(0.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(4.0f32 * 3.14159265358979323846f32 / 5.0f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(-260.0f32, 58.0f32, 10.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Get(&mut (*this).unk_208);
    };
}
