...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnYabusameMark {
    pub actor: Actor,
    pub actionFunc: EnYabusameMarkActionFunc,
    pub typeIndex: s16,
    pub subTypeIndex: s16,
    pub worldPos: Vec3f,
    pub vertexA: Vec3f,
    pub vertexB: Vec3f,
    pub vertexC: Vec3f,
...
pub type EnYabusameMarkActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnYabusameMark, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut En_Yabusame_Mark_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_YABUSAME_MARK as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnYabusameMark>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYabusameMark_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYabusameMark_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYabusameMark_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCollisionVertices: [Vec3f; 12] =
    [{ let mut init = Vec3f{x: 70.0f32, y: 70.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 70.0f32, y: -70.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: -70.0f32, y: 70.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: -70.0f32, y: -70.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 90.0f32, y: 130.0f32, z: -120.0f32,}; init },
     { let mut init = Vec3f{x: -25.0f32, y: -80.0f32, z: -130.0f32,}; init },
     { let mut init = Vec3f{x: 90.0f32, y: 130.0f32, z: 120.0f32,}; init },
     {
         let mut init =
             Vec3f{x: -25.0f32, y: -80.0f64 as f32_0, z: 130.0f32,};
         init
     },
     { let mut init = Vec3f{x: 115.0f32, y: 160.0f32, z: -150.0f32,}; init },
     { let mut init = Vec3f{x: -50.0f32, y: -140.0f32, z: -160.0f32,}; init },
     { let mut init = Vec3f{x: 115.0f32, y: 160.0f32, z: 150.0f32,}; init },
     { let mut init = Vec3f{x: -50.0f32, y: -140.0f32, z: 160.0f32,}; init }];
static mut sTargetPos: [Vec3f; 5] =
    [{
         let mut init = Vec3f{x: 3382.0f32, y: 1734.0f32, z: -4946.0f32,};
         init
     },
     { let mut init = Vec3f{x: 3360.0f32, y: 1734.0f32, z: 495.0f32,}; init },
     {
         let mut init = Vec3f{x: 4517.0f32, y: 1682.0f32, z: -1779.0f32,};
         init
     },
     {
         let mut init = Vec3f{x: 4517.0f32, y: 1682.0f32, z: -2813.0f32,};
         init
     },
     {
         let mut init = Vec3f{x: 4522.0f32, y: 1727.0f32, z: -2296.0f32,};
         init
     }];
// 0: first ring
// 1: second ring
// 2: outside edge
static mut sRingDistance: [f32_0; 12] =
    [20.0f32, 40.0f32, 60.0f32, 777.0f32, 40.0f32, 80.0f32, 120.0f32,
     777.0f32, 40.0f32, 120.0f32, 160.0f32, 777.0f32];
#[no_mangle]
pub unsafe extern "C" fn EnYabusameMark_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut EnYabusameMark = thisx as *mut EnYabusameMark;
    Collider_DestroyQuad(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnYabusameMark_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnYabusameMark = thisx as *mut EnYabusameMark;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xb6\xe3\x81\x95\xe3\x82\x81\xe3\x81\xbe\xe3\x81\xa8 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
    ...
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xa8\xae\xe9\xa1\x9e\xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9 \t   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).typeIndex as libc::c_int);
    match (*this).typeIndex as libc::c_int {
        0 => {
            (*this).subTypeIndex = 0 as libc::c_int as s16;
            if (*this).actor.world.pos.z > 0.0f32 {
                (*this).subTypeIndex = 1 as libc::c_int as s16
            }
        }
        1 => {
            (*this).subTypeIndex = 2 as libc::c_int as s16;
            if (*this).actor.world.pos.z < -2000.0f32 {
                (*this).subTypeIndex = 3 as libc::c_int as s16
            }
        }
        2 => { (*this).subTypeIndex = 4 as libc::c_int as s16 }
        _ => { }
    }
    ...
    osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xa8\xae\xe9\xa1\x9e       \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).typeIndex as libc::c_int);
    osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x95\xe3\x82\x89\xe3\x81\xab\xe5\x88\x86\xe9\xa1\x9e \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).subTypeIndex as libc::c_int);
    (*this).actionFunc =
        Some(func_80B42F74 as
                 unsafe extern "C" fn(_: *mut EnYabusameMark,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B42F74(mut this: *mut EnYabusameMark,
    ...
    let mut effectVelocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut arrowHitPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut distanceFromCenter: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: s32 = 0;
    let mut scoreIndex: s32 = 0;
    let mut scoreDistance100: f32_0 = 0.;
    let mut scoreDistance60: f32_0 = 0.;
    let mut scoreDistance30: f32_0 = 0.;
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        arrowHitPos.x = (*this).collider.info.bumper.hitPos.x as f32_0;
        arrowHitPos.y = (*this).collider.info.bumper.hitPos.y as f32_0;
        arrowHitPos.z = (*this).collider.info.bumper.hitPos.z as f32_0;
        effectVelocity.y = 15.0f32;
        EffectSsHitMark_SpawnCustomScale(globalCtx, 0 as libc::c_int,
                                         700 as libc::c_int as s16,
                                         &mut arrowHitPos);
        scoreIndex = 2 as libc::c_int;
        scoreDistance100 =
            sRingDistance[((*this).typeIndex as libc::c_int * 4 as libc::c_int
        ...
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 pos\xef\xbc\xb8 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     arrowHitPos.x as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 pos\xef\xbc\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     arrowHitPos.y as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 pos\xef\xbc\xba \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     arrowHitPos.z as libc::c_double);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 hit\xef\xbc\xb8 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     sTargetPos[(*this).subTypeIndex as usize].x as
                         libc::c_double);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 hit\xef\xbc\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     sTargetPos[(*this).subTypeIndex as usize].y as
                         libc::c_double);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 hit\xef\xbc\xba \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     sTargetPos[(*this).subTypeIndex as usize].z as
                         libc::c_double);
        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xb0\x8f    \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     scoreDistance100 as libc::c_double);
        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa4\xa7    \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     scoreDistance60 as libc::c_double);
        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 point \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, scoreIndex);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        if scoreIndex == 2 as libc::c_int {
            Audio_PlayFanfare((0x22 as libc::c_int | 0x900 as libc::c_int) as
                                  u16_0);
        }
        if scoreIndex == 1 as libc::c_int {
            Audio_StopSfxById(0x4807 as libc::c_int as u32_0);
            func_80078884(0x4807 as libc::c_int as u16_0);
        }
        if scoreIndex == 0 as libc::c_int {
            func_80078884(0x4808 as libc::c_int as u16_0);
        }
        EffectSsExtra_Spawn(globalCtx, &mut arrowHitPos, &mut effectVelocity,
                            &mut effectAccel, 5 as libc::c_int as s16,
                            scoreIndex as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnYabusameMark_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnYabusameMark = thisx as *mut EnYabusameMark;
    let mut vertexArray: *mut Vec3f = 0 as *mut Vec3f;
    let mut arrayIndex: u32_0 = 0;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    arrayIndex =
        ((*this).typeIndex as libc::c_int * 4 as libc::c_int) as u32_0;
    vertexArray =
        &mut *sCollisionVertices.as_mut_ptr().offset(arrayIndex as isize) as
            *mut Vec3f;
    (*this).vertexA.x =
        (*vertexArray.offset(0 as libc::c_int as isize)).x +
            (*this).actor.world.pos.x;
    (*this).vertexA.y =
        (*vertexArray.offset(0 as libc::c_int as isize)).y +
            (*this).actor.world.pos.y;
    (*this).vertexA.z =
        (*vertexArray.offset(0 as libc::c_int as isize)).z +
            (*this).actor.world.pos.z;
    (*this).vertexB.x =
        (*vertexArray.offset(1 as libc::c_int as isize)).x +
            (*this).actor.world.pos.x;
    (*this).vertexB.y =
        (*vertexArray.offset(1 as libc::c_int as isize)).y +
            (*this).actor.world.pos.y;
    (*this).vertexB.z =
        (*vertexArray.offset(1 as libc::c_int as isize)).z +
            (*this).actor.world.pos.z;
    (*this).vertexC.x =
        (*vertexArray.offset(2 as libc::c_int as isize)).x +
            (*this).actor.world.pos.x;
    (*this).vertexC.y =
        (*vertexArray.offset(2 as libc::c_int as isize)).y +
            (*this).actor.world.pos.y;
    (*this).vertexC.z =
        (*vertexArray.offset(2 as libc::c_int as isize)).z +
            (*this).actor.world.pos.z;
    (*this).vertexD.x =
        (*vertexArray.offset(3 as libc::c_int as isize)).x +
            (*this).actor.world.pos.x;
    (*this).vertexD.y =
        (*vertexArray.offset(3 as libc::c_int as isize)).y +
            (*this).actor.world.pos.y;
    (*this).vertexD.z =
        (*vertexArray.offset(3 as libc::c_int as isize)).z +
            (*this).actor.world.pos.z;
    Collider_SetQuadVertices(&mut (*this).collider, &mut (*this).vertexA,
                             &mut (*this).vertexB, &mut (*this).vertexC,
                             &mut (*this).vertexD);
