...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002DDF4(globalCtx: *mut GlobalContext) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_st_Anim_000304: AnimationHeader;
    #[no_mangle]
    static mut object_st_DL_003FB0: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_0043D8: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_0045C0: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_004658: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_0046F0: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_004788: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_004820: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_0048B8: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_004950: [Gfx; 0];
    #[no_mangle]
    static mut object_st_DL_0049E8: [Gfx; 0];
    #[no_mangle]
    static mut object_st_Skel_005298: SkeletonHeader;
    #[no_mangle]
    static mut object_st_Anim_0055A8: AnimationHeader;
    #[no_mangle]
    static mut object_st_Anim_005B98: AnimationHeader;
}
...
#[no_mangle]
pub static mut En_Sw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SW as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_ST as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSw>() as libc::c_ulong,
                          init:
...
static mut D_80B0F074: CollisionCheckInfoInit2 =
    {
        let mut init =
            CollisionCheckInfoInit2{health: 1 as libc::c_int as u8_0,
                                    cylRadius: 2 as libc::c_int as s16,
                                    cylHeight: 25 as libc::c_int as s16,
                                    cylYShift: 25 as libc::c_int as s16,
                                    mass: 0xff as libc::c_int as u8_0,};
        init
    };
static mut D_80B0F080: [struct_80034EC0_Entry; 4] =
    unsafe {
        [{
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &object_st_Anim_000304 as
...
#[no_mangle]
pub static mut D_80B0F630: [libc::c_char; 128] = [0; 128];
// unused
#[no_mangle]
pub unsafe extern "C" fn EnSw_CrossProduct(mut a: *mut Vec3f,
                                           mut b: *mut Vec3f,
                                           mut dst: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0BE20(mut this: *mut EnSw,
                                       mut poly: *mut CollisionPoly) -> s32 {
    ...
    sp44.z =
        (*poly).normal.z as libc::c_int as libc::c_float *
            (1.0f32 / 32767.0f32);
    sp34 =
        Math_FAcosF(sp44.x * (*this).unk_364.x + sp44.y * (*this).unk_364.y +
                        sp44.z * (*this).unk_364.z);
    EnSw_CrossProduct(&mut (*this).unk_364, &mut sp44, &mut sp38);
    Matrix_RotateAxis(sp34, &mut sp38, MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut (*this).unk_370, &mut sp38);
    (*this).unk_370 = sp38;
    EnSw_CrossProduct(&mut (*this).unk_370, &mut sp44, &mut (*this).unk_37C);
    temp_f0 = Math3D_Vec3fMagnitude(&mut (*this).unk_37C);
    if temp_f0 < 0.001f32 { return 0 as libc::c_int }
    (*this).unk_37C.x = (*this).unk_37C.x * (1.0f32 / temp_f0);
    (*this).unk_37C.y = (*this).unk_37C.y * (1.0f32 / temp_f0);
    (*this).unk_37C.z = (*this).unk_37C.z * (1.0f32 / temp_f0);
    (*this).unk_364 = sp44;
    (*this).unk_3D8.c2rust_unnamed.xx = (*this).unk_370.x;
    (*this).unk_3D8.c2rust_unnamed.yx = (*this).unk_370.y;
    (*this).unk_3D8.c2rust_unnamed.zx = (*this).unk_370.z;
    (*this).unk_3D8.c2rust_unnamed.wx = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.xy = (*this).unk_364.x;
    (*this).unk_3D8.c2rust_unnamed.yy = (*this).unk_364.y;
    (*this).unk_3D8.c2rust_unnamed.zy = (*this).unk_364.z;
    (*this).unk_3D8.c2rust_unnamed.wy = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.xz = (*this).unk_37C.x;
    (*this).unk_3D8.c2rust_unnamed.yz = (*this).unk_37C.y;
    (*this).unk_3D8.c2rust_unnamed.zz = (*this).unk_37C.z;
    (*this).unk_3D8.c2rust_unnamed.wz = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.xw = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.yw = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.zw = 0.0f32;
    (*this).unk_3D8.c2rust_unnamed.ww = 1.0f32;
    Matrix_MtxFToYXZRotS(&mut (*this).unk_3D8, &mut (*this).actor.world.rot,
                         0 as libc::c_int);
    panic!("Reached end of non-void function without returning");
    // ! @bug: Does not return.
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0C020(mut globalCtx: *mut GlobalContext,
                                       mut arg1: *mut Vec3f,
                                       mut arg2: *mut Vec3f,
                                       mut arg3: *mut Vec3f,
                                       mut arg4: *mut s32)
 -> *mut CollisionPoly {
    let mut sp3C: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut pad: s32 = 0;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, arg1, arg2, arg3,
                               &mut sp3C, 1 as libc::c_int, 1 as libc::c_int,
                               1 as libc::c_int, 0 as libc::c_int, arg4) == 0
       {
        return 0 as *mut CollisionPoly
    }
    if func_80041DB8(&mut (*globalCtx).colCtx, sp3C, *arg4) &
           0x30 as libc::c_int != 0 {
        return 0 as *mut CollisionPoly
    }
    if SurfaceType_IsIgnoredByProjectiles(&mut (*globalCtx).colCtx, sp3C,
                                          *arg4) != 0 {
        return 0 as *mut CollisionPoly
    }
    return sp3C;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0C0CC(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) -> s32 {
    let mut temp_v0_2: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut temp_s1: *mut CollisionPoly = 0 as *mut CollisionPoly;
    ...
    let mut sp70: s32 = 0;
    let mut sp6C: s32 = 0;
    let mut phi_s1: s32 = 0;
    let mut sp64: s32 = 0;
    sp64 = 0 as libc::c_int;
    (*this).unk_42C = 1 as libc::c_int as u8_0;
    sp78 = (*this).actor.world.pos;
    sp84 = sp78;
    sp84.x += (*this).unk_364.x * 18.0f32;
    sp84.y += (*this).unk_364.y * 18.0f32;
    sp84.z += (*this).unk_364.z * 18.0f32;
    sp78.x -= (*this).unk_364.x * 18.0f32;
    sp78.y -= (*this).unk_364.y * 18.0f32;
    sp78.z -= (*this).unk_364.z * 18.0f32;
    temp_s1 =
        func_80B0C020(globalCtx, &mut sp84, &mut sp78, &mut sp90, &mut sp70);
    if !temp_s1.is_null() &&
           (*this).unk_360 as libc::c_int == 0 as libc::c_int {
        sp78.x =
            sp84.x + (*this).unk_37C.x * 24 as libc::c_int as libc::c_float;
        sp78.y =
            sp84.y + (*this).unk_37C.y * 24 as libc::c_int as libc::c_float;
        sp78.z =
            sp84.z + (*this).unk_37C.z * 24 as libc::c_int as libc::c_float;
        temp_v0_2 =
            func_80B0C020(globalCtx, &mut sp84, &mut sp78, &mut sp9C,
                          &mut sp6C);
        if !temp_v0_2.is_null() {
            if arg2 == 1 as libc::c_int {
                func_80B0BE20(this, temp_v0_2);
                (*this).actor.world.pos = sp9C;
                (*this).actor.floorBgId = sp6C as u8_0
            }
        } else {
            ...
            (*this).actor.floorBgId = sp70 as u8_0
        }
        sp64 = 1 as libc::c_int
    } else {
        sp84 = sp78;
        phi_s1 = 0 as libc::c_int;
        while phi_s1 < 3 as libc::c_int {
            if phi_s1 == 0 as libc::c_int {
                sp78.x = sp84.x - (*this).unk_37C.x * 24.0f32;
                sp78.y = sp84.y - (*this).unk_37C.y * 24.0f32;
                sp78.z = sp84.z - (*this).unk_37C.z * 24.0f32
            } else if phi_s1 == 1 as libc::c_int {
                sp78.x = sp84.x + (*this).unk_370.x * 24.0f32;
                sp78.y = sp84.y + (*this).unk_370.y * 24.0f32;
                sp78.z = sp84.z + (*this).unk_370.z * 24.0f32
            } else {
                sp78.x = sp84.x - (*this).unk_370.x * 24.0f32;
                sp78.y = sp84.y - (*this).unk_370.y * 24.0f32;
                sp78.z = sp84.z - (*this).unk_370.z * 24.0f32
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       (*this).actor.world.rot.x, 8 as libc::c_int as s16,
                       0xfa0 as libc::c_int as s16, 1 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.world.rot.y, 8 as libc::c_int as s16,
                       0xfa0 as libc::c_int as s16, 1 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       (*this).actor.world.rot.z, 8 as libc::c_int as s16,
                       0xfa0 as libc::c_int as s16, 1 as libc::c_int as s16);
    return sp64;
}
#[no_mangle]
pub unsafe extern "C" fn EnSw_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSw = thisx as *mut EnSw;
    let mut phi_v0: s32 = 0;
    let mut sp4C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pad: s32 = 0;
    if (*thisx).params as libc::c_int & 0x8000 as libc::c_int != 0 {
        phi_v0 =
            (((*thisx).params as libc::c_int - 0x8000 as libc::c_int &
                  0xe000 as libc::c_int) >> 0xd as libc::c_int) +
                1 as libc::c_int;
        (*thisx).params =
            ((*thisx).params as libc::c_int & 0x1fff as libc::c_int |
                 phi_v0 << 0xd as libc::c_int) as s16
    }
    if ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int > 0 as libc::c_int {
        phi_v0 =
            (((*thisx).params as libc::c_int & 0x1f00 as libc::c_int) >>
                 8 as libc::c_int) - 1 as libc::c_int;
        (*thisx).params =
            ((*thisx).params as libc::c_int & 0xe0ff as libc::c_int |
                 phi_v0 << 8 as libc::c_int) as s16
    }
    // Check to see if this gold skull token has already been retrieved.
    if (gSaveContext.gsFlags[(((*thisx).params as libc::c_int &
                                   0x1f00 as libc::c_int) >> 8 as libc::c_int
                                  >> 2 as libc::c_int) as usize] as
            libc::c_uint &
            gGsFlagsMasks[(((*thisx).params as libc::c_int &
                                0x1f00 as libc::c_int) >> 8 as libc::c_int &
                               3 as libc::c_int) as usize]) >>
           gGsFlagsShifts[(((*thisx).params as libc::c_int &
                                0x1f00 as libc::c_int) >> 8 as libc::c_int &
                               3 as libc::c_int) as usize] &
           ((*thisx).params as libc::c_int & 0xff as libc::c_int) as
               libc::c_uint != 0 {
        Actor_Kill(&mut (*this).actor);
        return
    }
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_st_Skel_005298, 0 as *mut AnimationHeader,
                   (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 30 as libc::c_int);
    func_80034EC0(&mut (*this).skelAnime, D_80B0F080.as_mut_ptr(),
                  0 as libc::c_int);
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit, (*this).sphs.as_mut_ptr());
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(0xe as libc::c_int),
                            &mut D_80B0F074);
    (*this).actor.scale.x = 0.02f32;
    if ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int == 0 as libc::c_int {
        (*this).actor.world.rot.x = 0 as libc::c_int as s16;
        ...
        (*this).unk_484.x =
            (*this).actor.world.pos.x +
                Math_SinS((*this).actor.world.rot.y) * -60.0f32;
        (*this).unk_484.z =
            (*this).actor.world.pos.z +
                Math_CosS((*this).actor.world.rot.y) * -60.0f32;
        func_80B0DFFC(this, globalCtx);
        (*this).actor.home.pos = (*this).actor.world.pos
    } else {
        (*this).unk_370.x =
            Math_SinS(((*thisx).shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16);
        (*this).unk_370.y = 0.0f32;
        (*this).unk_370.z =
            Math_CosS(((*thisx).shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16);
        (*this).unk_364.x = 0.0f32;
        (*this).unk_364.y = 1.0f32;
        (*this).unk_364.z = 0.0f32;
        (*this).unk_37C.x = Math_SinS((*thisx).shape.rot.y);
        (*this).unk_37C.y = 0.0f32;
        (*this).unk_37C.z = Math_CosS((*thisx).shape.rot.y);
        func_80B0C0CC(this, globalCtx, 1 as libc::c_int);
    }
    if ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int >= 3 as libc::c_int {
    ...
    match ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
              0xd as libc::c_int {
        3 | 4 => {
            (*this).unk_360 = 1 as libc::c_int as u8_0;
            (*this).actor.velocity.y = 8.0f32;
            (*this).actor.speedXZ = 4.0f32;
            (*this).actor.gravity = -1.0f32;
            current_block_53 = 3482126830078640574;
        }
        2 => { current_block_53 = 3482126830078640574; }
        1 => { current_block_53 = 115992587554158073; }
        _ => {
            Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                                 &mut (*this).actor,
                                 ACTORCAT_ENEMY as libc::c_int as u8_0);
            (*this).actor.naviEnemyId = 0x1f as libc::c_int as u8_0;
    ...
    match current_block_53 {
        3482126830078640574 => {
            ...
            current_block_53 = 115992587554158073;
        }
        _ => { }
    }
    match current_block_53 {
        115992587554158073 => {
            ...
            *fresh0 = (*fresh0 as libc::c_int * 2 as libc::c_int) as u8_0;
            (*this).actor.naviEnemyId = 0x20 as libc::c_int as u8_0;
    ...
    (*this).unk_38E =
        Rand_S16Offset(0xf as libc::c_int as s16, 0x1e as libc::c_int as s16);
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    (*this).actor.home.pos = (*this).actor.world.pos;
    (*thisx).shape.rot = (*this).actor.world.rot;
    if ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int >= 3 as libc::c_int {
        (*this).unk_38C = 0x28 as libc::c_int as s16;
        (*this).unk_394 = 1 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B0D364 as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    } else if ((*thisx).params as libc::c_int & 0xe000 as libc::c_int) >>
                  0xd as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_80B0E5E0 as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    } else {
        (*this).actionFunc =
            Some(func_80B0D590 as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSw_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSw = thisx as *mut EnSw;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0C9F0(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut phi_v1: s32 = 0 as libc::c_int;
    if (*this).actor.xyzDistToPlayerSq < 400.0f32 * 400.0f32 &&
           ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
               0xd as libc::c_int == 0 as libc::c_int &&
        ...
        if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int !=
            ...
            (*this).collider.base.acFlags =
                ((*this).collider.base.acFlags as libc::c_int &
                     !(2 as libc::c_int)) as u8_0;
            (*this).unk_392 = 0x10 as libc::c_int as s16;
            Actor_SetColorFilter(&mut (*this).actor,
                                 0x4000 as libc::c_int as s16,
                                 0xc8 as libc::c_int as s16,
                                 0 as libc::c_int as s16, (*this).unk_392);
            if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int !=
                   0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x386b as libc::c_int as u16_0);
                return 1 as libc::c_int
            }
            Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
            if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int)
                   >> 0xd as libc::c_int != 0 as libc::c_int {
                (*this).skelAnime.playSpeed = 8.0f32;
                if (*globalCtx).state.frames &
                       1 as libc::c_int as libc::c_uint ==
                       0 as libc::c_int as libc::c_uint {
                    (*this).unk_420 = 0.1f32
                } else { (*this).unk_420 = -0.1f32 }
                (*this).unk_394 = 0xa as libc::c_int as s16;
                (*this).unk_38A = 1 as libc::c_int as s16;
                (*this).unk_420 *= 4.0f32;
                (*this).actionFunc =
                    Some(func_80B0D878 as
                             unsafe extern "C" fn(_: *mut EnSw,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
                ...
                (*this).unk_38A = 2 as libc::c_int as s16;
                (*this).actor.shape.shadowScale = 16.0f32;
                (*this).actor.gravity = -1.0f32;
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
                (*this).actionFunc =
                    Some(func_80B0DB00 as
                             unsafe extern "C" fn(_: *mut EnSw,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3885 as libc::c_int as u16_0);
            return 1 as libc::c_int
        }
    }
    if (*this).unk_390 as libc::c_int == 0 as libc::c_int &&
           (*this).collider.base.atFlags as libc::c_int & 2 as libc::c_int !=
               0 {
        (*this).unk_390 = 30 as libc::c_int as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0CBE8(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int > 0 as libc::c_int &&
           (*this).actionFunc !=
        ...
        if (if (*this).unk_390 as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unk_390 -= 1; (*this).unk_390 as libc::c_int })
               == 0 as libc::c_int &&
               (*this).actor.colChkInfo.health as libc::c_int !=
                   0 as libc::c_int {
        ...
        if (if (*this).unk_392 as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unk_392 -= 1; (*this).unk_392 as libc::c_int })
               == 0 as libc::c_int &&
               (*this).actor.colChkInfo.health as libc::c_int !=
                   0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0CCF4(mut this: *mut EnSw,
                                       mut arg1: *mut f32_0) -> s32 {
    let mut temp_v1: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut temp_f0: f32_0 = 0.;
    let mut sp6C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp2C: MtxF = MtxF{mf: [[0.; 4]; 4],};
    if (*this).actor.floorPoly.is_null() { return 0 as libc::c_int }
    temp_v1 = (*this).actor.floorPoly;
    sp6C.x =
        (*temp_v1).normal.x as libc::c_int as libc::c_float *
            (1.0f32 / 32767.0f32);
    sp6C.y =
        (*temp_v1).normal.y as libc::c_int as libc::c_float *
            (1.0f32 / 32767.0f32);
    sp6C.z =
        (*temp_v1).normal.z as libc::c_int as libc::c_float *
            (1.0f32 / 32767.0f32);
    Matrix_RotateAxis(*arg1, &mut sp6C, MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut (*this).unk_370, &mut sp6C);
    (*this).unk_370 = sp6C;
    EnSw_CrossProduct(&mut (*this).unk_370, &mut (*this).unk_364,
                      &mut (*this).unk_37C);
    temp_f0 = Math3D_Vec3fMagnitude(&mut (*this).unk_37C);
    if temp_f0 < 0.001f32 { return 0 as libc::c_int }
    temp_f0 = 1.0f32 / temp_f0;
    (*this).unk_37C.x *= temp_f0;
    (*this).unk_37C.y *= temp_f0;
    (*this).unk_37C.z *= temp_f0;
    sp2C.c2rust_unnamed.xx = (*this).unk_370.x;
    sp2C.c2rust_unnamed.yx = (*this).unk_370.y;
    sp2C.c2rust_unnamed.zx = (*this).unk_370.z;
    sp2C.c2rust_unnamed.wx = 0.0f32;
    sp2C.c2rust_unnamed.xy = (*this).unk_364.x;
    sp2C.c2rust_unnamed.yy = (*this).unk_364.y;
    sp2C.c2rust_unnamed.zy = (*this).unk_364.z;
    sp2C.c2rust_unnamed.wy = 0.0f32;
    sp2C.c2rust_unnamed.xz = (*this).unk_37C.x;
    sp2C.c2rust_unnamed.yz = (*this).unk_37C.y;
    sp2C.c2rust_unnamed.zz = (*this).unk_37C.z;
    sp2C.c2rust_unnamed.wz = 0.0f32;
    sp2C.c2rust_unnamed.xw = 0.0f32;
    sp2C.c2rust_unnamed.yw = 0.0f32;
    sp2C.c2rust_unnamed.zw = 0.0f32;
    sp2C.c2rust_unnamed.ww = 1.0f32;
    Matrix_MtxFToYXZRotS(&mut sp2C, &mut (*this).actor.world.rot,
                         0 as libc::c_int);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0CEA8(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    if !((*this).actor.scale.x < 0.0139999995f32) {
        ...
        if !(Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                &mut (*activeCam).eye) >= 380.0f32) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  if ((*this).actor.params as libc::c_int &
                                          0xe000 as libc::c_int) >>
                                         0xd as libc::c_int > 0 as libc::c_int
                                     {
                                      0x39da as libc::c_int
                                  } else { 0x388c as libc::c_int } as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0CF44(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut cnt: s32) {
    ...
    let mut angle: s16 = ((Rand_ZeroOne() - 0.5f32) * 65536.0f32) as s16;
    let mut i: s32 = 0;
    i = cnt;
    while i >= 0 as libc::c_int {
        accel.x = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        accel.z = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        pos.x = (*this).actor.world.pos.x + Math_SinS(angle) * 2.0f32;
        pos.y = (*this).actor.world.pos.y;
        pos.z = (*this).actor.world.pos.z + Math_CosS(angle) * 2.0f32;
        func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel,
                      &mut primColor, &mut envColor, 20 as libc::c_int as s16,
                      30 as libc::c_int as s16, 12 as libc::c_int as s16);
        i -= 1;
        angle =
            (angle as libc::c_int +
                 (0x10000 as libc::c_int / cnt) as s16 as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0D14C(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut cnt: s32) {
    let mut primColor: Color_RGBA8 =
        {
    ...
    while i >= 0 as libc::c_int {
        accel.x = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        accel.z = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        pos.x = (*this).actor.world.pos.x + Math_SinS(angle) * 14.0f32;
        pos.y = (*this).actor.world.pos.y;
        pos.z = (*this).actor.world.pos.z + Math_CosS(angle) * 14.0f32;
        func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel,
                      &mut primColor, &mut envColor, 20 as libc::c_int as s16,
                      40 as libc::c_int as s16, 10 as libc::c_int as s16);
        i -= 1;
        angle =
            (angle as libc::c_int +
                 (0x10000 as libc::c_int / cnt) as s16 as libc::c_int) as s16
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0D364(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int == 4 as libc::c_int {
        (*this).unk_38C = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B0D3AC as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    } else {
        (*this).unk_38C = 10 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B0D3AC as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0D3AC(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_38C as libc::c_int != 0 as libc::c_int {
        if (*this).unk_38C as libc::c_int & 4 as libc::c_int !=
               0 as libc::c_int {
            func_80B0CF44(this, globalCtx, 5 as libc::c_int);
        }
        (*this).unk_38C -= 1;
        if (*this).unk_38C as libc::c_int == 0 as libc::c_int {
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      0x28 as libc::c_int,
                                      0x39ea as libc::c_int as u16_0);
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      0x28 as libc::c_int,
                                      0x3824 as libc::c_int as u16_0);
        } else { return }
    }
    Math_ApproachF(&mut (*this).actor.scale.x, 0.02f32, 0.2f32, 0.01f32);
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    ...
    (*this).actor.velocity.y =
        ...
        } else { (*this).actor.velocity.y };
    if (*this).actor.velocity.y < 0.0f32 {
        (*this).unk_360 = 0 as libc::c_int as u8_0
    }
    if func_80B0C0CC(this, globalCtx, 1 as libc::c_int) == 1 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387b as libc::c_int as u16_0);
        func_80B0D14C(this, globalCtx, 8 as libc::c_int);
        (*this).actor.scale.x = 0.02f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0D590(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp2C: f32_0 = 0.;
    if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int == 2 as libc::c_int {
        if (*this).actor.scale.x < 0.0139999995f32 {
            (*(*this).collider.elements.offset(0 as libc::c_int as
        ...
        Math_ApproachF(&mut (*this).actor.scale.x,
                       if !(gSaveContext.nightFlag == 0 as libc::c_int) {
                           0.02f32
                       } else { 0.0f32 }, 0.2f32, 0.01f32);
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    }
    if (*this).unk_38E as libc::c_int != 0 as libc::c_int {
        (*this).unk_38E -= 1;
        if (*this).unk_38E as libc::c_int == 0 as libc::c_int {
            ...
            if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int)
                   >> 0xd as libc::c_int != 0 as libc::c_int {
                (*this).unk_38C =
                    ((*this).unk_38C as libc::c_int * 2 as libc::c_int) as
                        s16;
                (*this).unk_420 *= 2.0f32
            }
        }
        ...
        if (*this).unk_38C as libc::c_int == 0 as libc::c_int {
            ...
            (*this).unk_38A = 0 as libc::c_int as s16;
            (*this).skelAnime.playSpeed = 0.0f32;
            if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int)
                   >> 0xd as libc::c_int != 0 as libc::c_int {
                (*this).unk_38E =
                    ((*this).unk_38E as libc::c_int / 2 as libc::c_int) as s16
            }
        } else if (*this).unk_38A as libc::c_int != 0 as libc::c_int {
            (*this).unk_38A -= 1;
            (*this).skelAnime.playSpeed =
                if (*this).unk_38A as libc::c_int == 0 as libc::c_int {
                    4.0f32
                } else { 0.0f32 };
            ...
            sp2C = 32768.0f32 / (*this).skelAnime.endFrame;
            sp2C *= (*this).skelAnime.curFrame;
            sp2C = Math_SinS(sp2C as s16) * (*this).unk_420;
            func_80B0CCF4(this, &mut sp2C);
            (*this).actor.shape.rot = (*this).actor.world.rot
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0D878(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_v0: *mut Actor = 0 as *mut Actor;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    func_80B0CCF4(this, &mut (*this).unk_420);
    (*this).actor.shape.rot = (*this).actor.world.rot;
    if (*this).unk_394 as libc::c_int == 0 as libc::c_int &&
           (*this).unk_392 as libc::c_int == 0 as libc::c_int {
        Audio_PlaySoundGeneral(0x4843 as libc::c_int as u16_0,
                               &mut D_801333D4, 4 as libc::c_int as u8_0,
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
        x = (*this).unk_364.x * 10.0f32;
        y = (*this).unk_364.y * 10.0f32;
        z = (*this).unk_364.z * 10.0f32;
        temp_v0 =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx, ACTOR_EN_SI as libc::c_int as s16,
                               (*this).actor.world.pos.x + x,
                               (*this).actor.world.pos.y + y,
                               (*this).actor.world.pos.z + z,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16, (*this).actor.params);
        if !temp_v0.is_null() { (*temp_v0).parent = 0 as *mut Actor }
        Actor_Kill(&mut (*this).actor);
        return
    }
    if (*this).unk_392 as libc::c_int == 0 as libc::c_int &&
           (if (*this).unk_394 as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unk_394 -= 1; (*this).unk_394 as libc::c_int })
               != 0 as libc::c_int {
        pos = (*this).actor.world.pos;
        pos.y += 10.0f32 + (Rand_ZeroOne() - 0.5f32) * 6.0f32;
        pos.x += (Rand_ZeroOne() - 0.5f32) * 32.0f32;
        pos.z += (Rand_ZeroOne() - 0.5f32) * 32.0f32;
        EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut velAndAccel,
                             &mut velAndAccel, 42 as libc::c_int as s16,
                             0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0DB00(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_MoveForward(&mut (*this).actor);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + 0x1000 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_int + 0x1000 as libc::c_int) as
            s16;
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
           !(0.0f32 <= (*this).actor.velocity.y) {
        if (*this).actor.floorHeight <= -32000.0f32 ||
               (*this).actor.floorHeight >= 32000.0f32 {
            Actor_Kill(&mut (*this).actor);
            return
        }
        ...
        if (*this).unk_38A as libc::c_int == 0 as libc::c_int {
            (*this).actionFunc =
                Some(func_80B0DC7C as
                         unsafe extern "C" fn(_: *mut EnSw,
                                              _: *mut GlobalContext) -> ());
            (*this).unk_394 = 10 as libc::c_int as s16
        } else {
            let fresh1 = (*this).unk_38A;
            (*this).unk_38A = (*this).unk_38A - 1;
            (*this).actor.velocity.y =
                fresh1 as libc::c_int as libc::c_float * 8.0f32 * 0.5f32
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387b as libc::c_int as u16_0);
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).actor.world.pos, 16.0f32,
                                 0xc as libc::c_int, 2.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0DC7C(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut velAndAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
    let mut pos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if (if (*this).unk_394 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).unk_394 -= 1; (*this).unk_394 as libc::c_int }) !=
           0 as libc::c_int {
        pos.y =
            (Rand_ZeroOne() - 0.5f32) * 6.0f32 +
                ((*this).actor.world.pos.y + 10.0f32);
        pos.x =
            (Rand_ZeroOne() - 0.5f32) * 32.0f32 + (*this).actor.world.pos.x;
        pos.z =
            (Rand_ZeroOne() - 0.5f32) * 32.0f32 + (*this).actor.world.pos.z;
        EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut velAndAccel,
                             &mut velAndAccel, 42 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             255 as libc::c_int as s16,
                             ...
                             1 as libc::c_int as s16);
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int + 0x1000 as libc::c_int)
                as s16;
        (*this).actor.shape.rot.z =
            ((*this).actor.shape.rot.z as libc::c_int + 0x1000 as libc::c_int)
                as s16
    } else {
        Item_DropCollectibleRandom(globalCtx, 0 as *mut Actor,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0DE34(mut this: *mut EnSw,
                                       mut arg1: *mut Vec3f) -> s16 {
    let mut pitch: s16 = 0;
    let mut yaw: s16 = 0;
    yaw =
        (Math_Vec3f_Yaw(&mut (*this).actor.world.pos, arg1) as libc::c_int -
             (*this).actor.wallYaw as libc::c_int) as s16;
    pitch =
        (Math_Vec3f_Pitch(&mut (*this).actor.world.pos, arg1) as libc::c_int -
             0x4000 as libc::c_int) as s16;
    return (pitch as libc::c_int *
                (if yaw as libc::c_int >= 0 as libc::c_int {
                     -(1 as libc::c_int)
                 } else { 1 as libc::c_int })) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0DEA8(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) -> s32 {
    ...
    if (*player).stateFlags1 & 0x200000 as libc::c_int as libc::c_uint == 0 &&
           arg2 != 0 {
        return 0 as libc::c_int
    } else if func_8002DDF4(globalCtx) != 0 && arg2 != 0 {
        return 0 as libc::c_int
    } else if (if func_80B0DE34(this, &mut (*player).actor.world.pos) as
                      libc::c_int - (*this).actor.shape.rot.z as libc::c_int
                      >= 0 as libc::c_int {
                   (func_80B0DE34(this, &mut (*player).actor.world.pos) as
                        libc::c_int) -
        ...
        return 0 as libc::c_int
    } else if Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                 &mut (*player).actor.world.pos) >= 130.0f32 {
        return 0 as libc::c_int
    } else if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                                      &mut (*this).actor.world.pos,
                                      &mut (*player).actor.world.pos,
                                      &mut sp48, &mut sp58, 1 as libc::c_int,
                                      0 as libc::c_int, 0 as libc::c_int,
                                      1 as libc::c_int, &mut sp54) == 0 {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0DFFC(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut sp60: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut sp5C: s32 = 0;
    let mut sp50: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp4C: s32 = 1 as libc::c_int;
    ...
    } else if (*globalCtx).state.frames.wrapping_rem(4 as libc::c_int as
                                                         libc::c_uint) ==
                  0 as libc::c_int as libc::c_uint &&
                  BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                                          &mut (*this).actor.world.pos,
                                          &mut (*this).unk_454, &mut sp50,
                                          &mut sp60, 1 as libc::c_int,
                                          0 as libc::c_int, 0 as libc::c_int,
                                          1 as libc::c_int, &mut sp5C) == 0 {
        sp4C = 0 as libc::c_int
    } else if (*globalCtx).state.frames.wrapping_rem(4 as libc::c_int as
                                                         libc::c_uint) ==
                  1 as libc::c_int as libc::c_uint &&
    ...
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                               &mut (*this).actor.world.pos,
                               &mut (*this).unk_484, &mut sp50,
                               &mut (*this).unk_430, 1 as libc::c_int,
                               0 as libc::c_int, 0 as libc::c_int,
                               1 as libc::c_int, &mut sp5C) != 0 {
        (*this).actor.wallYaw =
            (Math_FAtan2F((*(*this).unk_430).normal.x as f32_0,
                          (*(*this).unk_430).normal.z as f32_0) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        (*this).actor.world.pos = sp50;
        (*this).actor.world.pos.x +=
            6.0f32 * Math_SinS((*this).actor.world.rot.y);
        (*this).actor.world.pos.z +=
            6.0f32 * Math_CosS((*this).actor.world.rot.y);
        (*this).unk_434 = sp50;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0E314(mut this: *mut EnSw, mut arg1: Vec3f,
                                       mut arg4: f32_0) {
    ...
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, arg4, 0.3f32, 100.0f32,
                       0.1f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0E430(mut this: *mut EnSw, mut arg1: f32_0,
                                       mut arg2: s16, mut arg3: s32,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut activeCam: *mut Camera = 0 as *mut Camera;
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_st_Anim_000304 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    if (if (*this).unk_388 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).unk_388 -= 1; (*this).unk_388 as libc::c_int }) !=
           0 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).skelAnime.playSpeed, 0.0f32, 0.6f32,
                           1000.0f32, 0.01f32);
        return 0 as libc::c_int
    }
    Math_SmoothStepToF(&mut (*this).skelAnime.playSpeed, arg1, 0.6f32,
                       1000.0f32, 0.01f32);
    if arg3 == 1 as libc::c_int &&
           lastFrame <
               (*this).skelAnime.curFrame + (*this).skelAnime.playSpeed {
        return 0 as libc::c_int
    }
    activeCam = (*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize];
    if Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos, &mut (*activeCam).eye)
           < 380.0f32 {
        if (if (*this).unk_440 as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unk_440 -= 1; (*this).unk_440 as libc::c_int })
               == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x388c as libc::c_int as u16_0);
            (*this).unk_440 = 4 as libc::c_int as s16
        }
    } else { (*this).unk_440 = 0 as libc::c_int as s16 }
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z, (*this).unk_444,
                       4 as libc::c_int as s16, arg2, arg2);
    (*this).actor.world.rot = (*this).actor.shape.rot;
    if (*this).actor.shape.rot.z as libc::c_int ==
           (*this).unk_444 as libc::c_int {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0E5E0(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut rand: f32_0 = 0.;
    if func_80B0E430(this, 6.0f32, 0x3e8 as libc::c_int as s16,
                     1 as libc::c_int, globalCtx) != 0 {
        rand = Rand_ZeroOne();
        (*this).unk_444 =
            (((20000.0f32 * rand) as s16 as libc::c_int +
                  0x2ee0 as libc::c_int) as libc::c_float *
                 (if Rand_ZeroOne() >= 0.5f32 { 1.0f32 } else { -1.0f32 }) +
                 (*this).actor.world.rot.z as libc::c_int as libc::c_float) as
                s16;
        (*this).unk_388 =
            Rand_S16Offset(10 as libc::c_int as s16, 30 as libc::c_int as s16)
    }
    if (if (*this).unk_442 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).unk_442 -= 1; (*this).unk_442 as libc::c_int }) ==
           0 as libc::c_int &&
           func_80B0DEA8(this, globalCtx, 1 as libc::c_int) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39f2 as libc::c_int as u16_0);
        (*this).unk_442 = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B0E728 as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0E728(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (if (*this).unk_442 as libc::c_int == 0 as libc::c_int {
           ...
           0 as libc::c_int {
        if func_80B0DEA8(this, globalCtx, 1 as libc::c_int) != 0 {
            (*this).unk_448 = (*player).actor.world.pos;
            (*this).unk_448.y += 30.0f32;
            (*this).unk_444 = func_80B0DE34(this, &mut (*this).unk_448);
            func_80B0E430(this, 6.0f32, 0xfa0 as libc::c_int as u16_0 as s16,
                          0 as libc::c_int, globalCtx);
        } else {
            (*this).actionFunc =
                Some(func_80B0E5E0 as
                         unsafe extern "C" fn(_: *mut EnSw,
    ...
    } else if func_80B0DFFC(this, globalCtx) == 0 {
        (*this).unk_442 =
            Rand_S16Offset(20 as libc::c_int as s16,
                           10 as libc::c_int as s16);
        (*this).unk_444 = func_80B0DE34(this, &mut (*this).actor.home.pos);
        (*this).unk_448 = (*this).actor.home.pos;
        (*this).actionFunc =
            Some(func_80B0E9BC as
                     unsafe extern "C" fn(_: *mut EnSw, _: *mut GlobalContext)
                         -> ())
    } else {
        func_80B0E314(this, (*this).unk_448, 8.0f32);
        if (if (*this).unk_440 as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unk_440 -= 1; (*this).unk_440 as libc::c_int })
               == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x388d as libc::c_int as u16_0);
            (*this).unk_440 = 4 as libc::c_int as s16
        }
        if !(Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                &mut (*this).unk_448) > 13.0f32) ||
               func_8002DDF4(globalCtx) != 0 {
            (*this).actionFunc =
                Some(func_80B0E90C as
                         unsafe extern "C" fn(_: *mut EnSw,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0E90C(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    func_80B0E314(this, (*this).unk_448, 0.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0E9BC(mut this: *mut EnSw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    if func_80B0E430(this, 6.0f32, 0x3e8 as libc::c_int as s16,
                     0 as libc::c_int, globalCtx) != 0 {
        func_80B0E314(this, (*this).unk_448, 2.0f32);
        if !(Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                &mut (*this).unk_448) > 4.0f32) {
            (*this).actionFunc =
                Some(func_80B0E5E0 as
                         unsafe extern "C" fn(_: *mut EnSw,
                                              _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnSw_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSw = thisx as *mut EnSw;
...
#[no_mangle]
pub unsafe extern "C" fn EnSw_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut sp7C: Vec3f =
        {
            let mut init = Vec3f{x: 1400.0f32, y: -2600.0f32, z: -800.0f32,};
            init
        };
    let mut sp70: Vec3f =
        {
            let mut init = Vec3f{x: 1400.0f32, y: -1600.0f32, z: 0.0f32,};
            init
        };
    let mut sp64: Vec3f =
        {
    ...
    let mut sp4C: Vec3f =
        {
            let mut init =
                Vec3f{x: 0.0f64 as f32_0, y: 0.0f32, z: -600.0f32,};
            init
        };
    let mut this: *mut EnSw = thisx as *mut EnSw;
    let mut sp3C: Vec3f =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_sw.c\x00" as *const u8 as *const libc::c_char,
                    2084 as libc::c_int);
    if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int != 0 as libc::c_int {
        match limbIndex {
            23 => { *dList = object_st_DL_004788.as_mut_ptr() }
            8 => { *dList = object_st_DL_0046F0.as_mut_ptr() }
            14 => { *dList = object_st_DL_004658.as_mut_ptr() }
            11 => { *dList = object_st_DL_0045C0.as_mut_ptr() }
            26 => { *dList = object_st_DL_004820.as_mut_ptr() }
            20 => { *dList = object_st_DL_0048B8.as_mut_ptr() }
            17 => { *dList = object_st_DL_004950.as_mut_ptr() }
            29 => { *dList = object_st_DL_0049E8.as_mut_ptr() }
            5 => { *dList = object_st_DL_003FB0.as_mut_ptr() }
            4 => { *dList = object_st_DL_0043D8.as_mut_ptr() }
            _ => { }
        }
    }
    if limbIndex == 1 as libc::c_int {
        Matrix_MultVec3f(&mut sp7C, &mut (*this).unk_454);
        Matrix_MultVec3f(&mut sp70, &mut (*this).unk_460);
        Matrix_MultVec3f(&mut sp64, &mut (*this).unk_46C);
        Matrix_MultVec3f(&mut sp58, &mut (*this).unk_478);
        Matrix_MultVec3f(&mut sp4C, &mut (*this).unk_484);
    }
    ...
    if limbIndex == 4 as libc::c_int {
        ...
        (*_g).words.w1 =
            ((*this).unk_1F4.r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*this).unk_1F4.g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                ((*this).unk_1F4.b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnSw_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B0EDB8(mut globalCtx: *mut GlobalContext,
                                       mut arg1: *mut Color_RGBA8,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    ...
                    2181 as libc::c_int);
    temp_f2 =
        11500.0f32 / arg3 as libc::c_int as libc::c_float *
            (arg3 as libc::c_int - arg2 as libc::c_int) as libc::c_float;
    if 0.0f32 == temp_f2 { temp_f2 = 11500 as libc::c_int as f32_0 }
    (*__gfxCtx).polyOpa.p =
        Gfx_SetFog2((*__gfxCtx).polyOpa.p, (*arg1).r as s32, (*arg1).g as s32,
                    (*arg1).b as s32, (*arg1).a as s32, 0 as libc::c_int,
                    temp_f2 as s16 as s32);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_sw.c\x00" as *const u8 as *const libc::c_char,
                     2197 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B0EEA4(mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
...
#[no_mangle]
pub unsafe extern "C" fn EnSw_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSw = thisx as *mut EnSw;
    let mut sp30: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 184 as libc::c_int as u8_0,
                            g: 0 as libc::c_int as u8_0,
                            b: 228 as libc::c_int as u8_0,
                            a: 255 as libc::c_int as u8_0,};
            init
        };
    if ((*this).actor.params as libc::c_int & 0xe000 as libc::c_int) >>
           0xd as libc::c_int != 0 as libc::c_int {
        Matrix_RotateX(-(80 as libc::c_int) as libc::c_float *
