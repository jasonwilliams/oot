...
#[no_mangle]
pub static mut En_Sda_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SDA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnSda>() as libc::c_ulong,
                          init:
...
static mut D_80AFA0D0: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80AFA0DC: [s16; 6] =
...
static mut D_80AFA0F8: [s16; 8] =
    [2 as libc::c_int as s16, 3 as libc::c_int as s16,
     4 as libc::c_int as s16, 4 as libc::c_int as s16,
     4 as libc::c_int as s16, 4 as libc::c_int as s16,
     3 as libc::c_int as s16, 2 as libc::c_int as s16];
static mut D_80AFA108: [s16; 12] =
...
static mut D_80AFA120: [s16; 14] =
    [2 as libc::c_int as s16, 4 as libc::c_int as s16,
     ...
     8 as libc::c_int as s16, 7 as libc::c_int as s16,
     6 as libc::c_int as s16, 5 as libc::c_int as s16,
     4 as libc::c_int as s16, 2 as libc::c_int as s16];
static mut D_80AFA13C: [s16; 16] =
...
static mut D_80AFA16C: [s8; 20] =
    [2 as libc::c_int as s8, 9 as libc::c_int as s8, 10 as libc::c_int as s8,
     11 as libc::c_int as s8, 12 as libc::c_int as s8,
     13 as libc::c_int as s8, 14 as libc::c_int as s8, 0 as libc::c_int as s8,
     15 as libc::c_int as s8, -(1 as libc::c_int) as s8,
     3 as libc::c_int as s8, 4 as libc::c_int as s8, 5 as libc::c_int as s8,
     6 as libc::c_int as s8, 7 as libc::c_int as s8, 8 as libc::c_int as s8,
     -(1 as libc::c_int) as s8, 1 as libc::c_int as s8,
     0 as libc::c_int as s8, 0 as libc::c_int as s8];
static mut D_80AFA180: [Vec3f; 22] =
    [{ let mut init = Vec3f{x: -1.0f32, y: 2.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 2.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: 1.0f32, y: 2.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: -2.0f32, y: 1.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -1.0f32, y: 1.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 1.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 1.0f32, y: 1.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 2.0f32, y: 1.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -2.0f32, y: 0.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -1.0f32, y: 0.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 1.0f32, y: 0.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 2.0f32, y: 0.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -2.0f32, y: -1.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -1.0f32, y: -1.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: -1.0f32, z: -0.1f32,}; init },
     { let mut init = Vec3f{x: 1.0f32, y: -1.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 2.0f32, y: -1.0f32, z: -0.5f32,}; init },
     { let mut init = Vec3f{x: -1.0f32, y: -2.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: -2.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 1.0f32, y: -2.0f32, z: -0.2f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: -3.0f32, z: -0.5f32,}; init }];
// Initialized in run_static_initializers
static mut D_80AFA3F8: [Gfx; 6] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 6];
static mut D_80AFA398: [Vtx; 4] =
    [Vtx{v:
             {
                 let mut init =
                     Vtx_t{ob:
...
static mut D_80AFA660: [Vec3f; 16] = [Vec3f{x: 0., y: 0., z: 0.,}; 16];
#[no_mangle]
pub unsafe extern "C" fn EnSda_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnSda_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnSda_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSda = thisx as *mut EnSda;
    let mut player: *mut Player = 0 as *mut Player;
    osSyncPrintf(b"SDA MOVE\n\x00" as *const u8 as *const libc::c_char);
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        player = (*this).actor.parent as *mut Player
    } else {
        player =
    ...
    osSyncPrintf(b"SDA MOVE END\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn EnSda_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSda = thisx as *mut EnSda;
    let mut player: *mut Player = 0 as *mut Player;
    let mut shadowTexture: *mut u8_0 =
        Graph_Alloc((*globalCtx).state.gfxCtx,
                    0x1000 as libc::c_int as size_t) as *mut u8_0;
    osSyncPrintf(b"SDA DRAW \n\x00" as *const u8 as *const libc::c_char);
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        player = (*this).actor.parent as *mut Player
    } else {
        player =
    ...
    (*player).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
    ...
    osSyncPrintf(b"SDA DRAW END\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF8F60(mut player: *mut Player,
    ...
    let mut i: s16 = 0;
    let mut j: s16 = 0;
    let mut lerp: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    while (i as libc::c_int) < 16 as libc::c_int {
        if arg2 == 0.0f32 ||
               {
                   j = D_80AFA13C[i as usize];
                   (j as libc::c_int) >= 0 as libc::c_int
               } {
            if arg2 > 0.0f32 {
                lerp.x =
                    D_80AFA660[i as usize].x +
                        (D_80AFA660[j as usize].x - D_80AFA660[i as usize].x)
                            * arg2;
                lerp.y =
                    D_80AFA660[i as usize].y +
                        (D_80AFA660[j as usize].y - D_80AFA660[i as usize].y)
                            * arg2;
                lerp.z =
                    D_80AFA660[i as usize].z +
                        (D_80AFA660[j as usize].z - D_80AFA660[i as usize].z)
                            * arg2;
                sp88.x = lerp.x - (*player).actor.world.pos.x;
                sp88.y =
                    lerp.y - (*player).actor.world.pos.y +
                        (*gGameInfo).data[(25 as libc::c_int *
                                               6 as libc::c_int *
                                               16 as libc::c_int +
                                               48 as libc::c_int) as usize] as
                            libc::c_int as libc::c_float + 76.0f32 + 30.0f32 -
                        105.0f32 + 15.0f32;
                sp88.z = lerp.z - (*player).actor.world.pos.z
            } else {
                sp88.x =
                    D_80AFA660[i as usize].x - (*player).actor.world.pos.x;
                sp88.y =
                    D_80AFA660[i as usize].y - (*player).actor.world.pos.y +
                        (*gGameInfo).data[(25 as libc::c_int *
                                               6 as libc::c_int *
                                               16 as libc::c_int +
                                               48 as libc::c_int) as usize] as
                        ...
                        105.0f32 + 15.0f32;
                sp88.z =
                    D_80AFA660[i as usize].z - (*player).actor.world.pos.z
            }
            ...
            sp7C.y *=
                1.0f32 +
                    (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                           ...
                                           49 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float / 100.0f32;
            temp_t0 = (sp7C.x + 32.0f32) as s16;
            temp_t1 =
                ((sp7C.y as s16 as libc::c_int) << 6 as libc::c_int) as s16;
            if D_80AFA15C[i as usize] as libc::c_int == 2 as libc::c_int {
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0x180 as libc::c_int) as s16;
                while (j as libc::c_int) < 12 as libc::c_int {
                    phi_a0 = -(D_80AFA108[j as usize] as libc::c_int) as s16;
                    while (phi_a0 as libc::c_int) <
                              D_80AFA108[j as usize] as libc::c_int {
                        temp_v1 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
                        if temp_v1 as libc::c_int >= 0 as libc::c_int &&
                               (temp_v1 as libc::c_int) < 0x40 as libc::c_int
                           {
                            temp_v0 =
                                (temp_t1 as libc::c_int +
                                     phi_a3 as libc::c_int) as s16;
                            if temp_v0 as libc::c_int >= 0 as libc::c_int &&
                                   (temp_v0 as libc::c_int) <
                                       0x1000 as libc::c_int {
                                *shadowTexture.offset((temp_v1 as libc::c_int
                                                           +
                                                           temp_v0 as
                                                               libc::c_int) as
                                                          isize) =
                    ...
                    j += 1;
                    phi_a3 =
                        (phi_a3 as libc::c_int + 0x40 as libc::c_int) as s16
                }
            } else if D_80AFA15C[i as usize] as libc::c_int ==
                          1 as libc::c_int {
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0x100 as libc::c_int) as s16;
                while (j as libc::c_int) < 8 as libc::c_int {
                    phi_a0 = -(D_80AFA0F8[j as usize] as libc::c_int) as s16;
                    while (phi_a0 as libc::c_int) <
                              D_80AFA0F8[j as usize] as libc::c_int {
                        temp_v1 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
                        if temp_v1 as libc::c_int >= 0 as libc::c_int &&
                    ...
                    phi_a3 =
                        (phi_a3 as libc::c_int + 0x40 as libc::c_int) as s16
                          ...
                          0 as libc::c_int {
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0xc0 as libc::c_int) as s16;
                while (j as libc::c_int) < 7 as libc::c_int {
                    phi_a0 = -(D_80AFA0E8[j as usize] as libc::c_int) as s16;
                    while (phi_a0 as libc::c_int) <
                              D_80AFA0E8[j as usize] as libc::c_int -
                                  1 as libc::c_int {
                        temp_v1 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
                    ...
                    phi_a3 =
                        (phi_a3 as libc::c_int + 0x40 as libc::c_int) as s16
                          ...
                          4 as libc::c_int {
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0x1c0 as libc::c_int) as s16;
                while (j as libc::c_int) < 14 as libc::c_int {
                    phi_a0 = -(D_80AFA120[j as usize] as libc::c_int) as s16;
                    while (phi_a0 as libc::c_int) <
                              D_80AFA120[j as usize] as libc::c_int {
                        temp_v1 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
                        if temp_v1 as libc::c_int >= 0 as libc::c_int &&
                ...
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0x80 as libc::c_int) as s16;
                while (j as libc::c_int) < 6 as libc::c_int {
                    phi_a0 = -(D_80AFA0DC[j as usize] as libc::c_int) as s16;
                    while (phi_a0 as libc::c_int) <
                              D_80AFA0DC[j as usize] as libc::c_int -
                                  1 as libc::c_int {
                        temp_v1 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF95C4(mut this: *mut EnSda,
                                       mut shadowTexture: *mut u8_0,
    ...
    let mut i: s16 = 0;
    let mut j: s16 = 0;
    let mut sp194: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp188: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut shadowTextureTemp32: *mut s32 = 0 as *mut s32;
    let mut shadowTextureTemp: *mut u8_0 = 0 as *mut u8_0;
    let mut sp178: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut sp16C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp64: [Vec3f; 22] = [Vec3f{x: 0., y: 0., z: 0.,}; 22];
    osSyncPrintf(b"SDA CONT \n\x00" as *const u8 as *const libc::c_char);
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                              16 as libc::c_int + 57 as libc::c_int) as usize]
           as libc::c_int != 0 as libc::c_int {
        shadowTextureTemp = shadowTexture;
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 0x1000 as libc::c_int {
            if i as libc::c_int >= 0 as libc::c_int &&
                   (i as libc::c_int) < 0x40 as libc::c_int ||
                   i as libc::c_int >= 0xfc0 as libc::c_int &&
                       (i as libc::c_int) < 0x1000 as libc::c_int ||
                   i as libc::c_int & 0x3f as libc::c_int == 0 as libc::c_int
                   ||
                   i as libc::c_int & 0x3f as libc::c_int ==
                       0x3f as libc::c_int {
                *shadowTextureTemp = 255 as libc::c_int as u8_0
            } else { *shadowTextureTemp = 0 as libc::c_int as u8_0 }
            i += 1;
            shadowTextureTemp = shadowTextureTemp.offset(1)
        }
    } else {
        shadowTextureTemp32 = shadowTexture as *mut s32;
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 0x400 as libc::c_int {
            *shadowTextureTemp32 = 0 as libc::c_int;
            i += 1;
            shadowTextureTemp32 = shadowTextureTemp32.offset(1)
        }
    }
    Matrix_RotateX(((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           50 as libc::c_int) as usize] as
                        libc::c_int + 70 as libc::c_int) as libc::c_float /
                       100.0f32, MTXMODE_NEW as libc::c_int as u8_0);
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 18 as libc::c_int {
        if D_80AFA16C[i as usize] as libc::c_int >= 0 as libc::c_int {
            D_80AFA660[D_80AFA16C[i as usize] as usize] =
                (*player).bodyPartsPos[i as usize]
        }
        i += 1
    }
    osSyncPrintf(b"SDA CONT 2\n\x00" as *const u8 as *const libc::c_char);
    D_80AFA660[0 as libc::c_int as usize].y += 3.0f32;
    D_80AFA660[15 as libc::c_int as usize].x =
        D_80AFA660[0 as libc::c_int as usize].x +
            (D_80AFA660[15 as libc::c_int as usize].x -
                 D_80AFA660[0 as libc::c_int as usize].x) * 1.2f32;
    D_80AFA660[15 as libc::c_int as usize].y =
        D_80AFA660[0 as libc::c_int as usize].y +
            (D_80AFA660[15 as libc::c_int as usize].y -
                 D_80AFA660[0 as libc::c_int as usize].y) * -1.2f32;
    D_80AFA660[15 as libc::c_int as usize].z =
        D_80AFA660[0 as libc::c_int as usize].z +
            (D_80AFA660[15 as libc::c_int as usize].z -
                 D_80AFA660[0 as libc::c_int as usize].z) * 1.2f32;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 6 as libc::c_int {
        func_80AF8F60(player, shadowTexture,
                      i as libc::c_int as libc::c_float / 5.0f32);
        i += 1
    }
    osSyncPrintf(b"SDA CONT 3\n\x00" as *const u8 as *const libc::c_char);
    if (*this).actor.params as libc::c_int != 1 as libc::c_int {
        Matrix_MtxFToYXZRotS(&mut (*player).shieldMf, &mut sp178,
                             0 as libc::c_int);
        sp178.y =
            (sp178.y as libc::c_int +
        ...
        Matrix_MultVec3f(&mut D_80AFA0D0, &mut sp16C);
        Matrix_RotateY(sp178.y as libc::c_int as libc::c_float / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateX(sp178.x as libc::c_int as libc::c_float / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 22 as libc::c_int {
            Matrix_MultVec3f(&mut *D_80AFA180.as_mut_ptr().offset(i as isize),
                             &mut sp188);
            sp64[i as usize].x =
                ((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 82 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float / 100.0f32 + 4.0f32) * sp188.x + sp16C.x;
            sp64[i as usize].y =
                ((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 82 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float / 100.0f32 + 4.0f32) * sp188.y + sp16C.y;
            sp64[i as usize].z =
                ((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 82 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float / 100.0f32 + 4.0f32) * sp188.z + sp16C.z;
            i += 1
        }
        Matrix_RotateX(((*gGameInfo).data[(25 as libc::c_int *
                                               6 as libc::c_int *
                                               16 as libc::c_int +
                                               50 as libc::c_int) as usize] as
                            libc::c_int + 70 as libc::c_int) as libc::c_float
        ...
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 22 as libc::c_int {
            sp194.x = sp64[i as usize].x - (*player).actor.world.pos.x;
            sp194.y =
                sp64[i as usize].y - (*player).actor.world.pos.y +
                    (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           80 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float + 16.0f32;
            sp194.z = sp64[i as usize].z - (*player).actor.world.pos.z;
            Matrix_MultVec3f(&mut sp194, &mut sp188);
            sp188.x *=
                1.0f32 +
                    (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
            ...
            sp188.y *=
                1.0f32 +
                    (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                           ...
                                           90 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float / 100.0f32;
            temp_t0 = (sp188.x + 32.0f32) as s16;
            temp_t1 =
                ((sp188.y as s16 as libc::c_int) << 6 as libc::c_int) as s16;
            loop  {
                j = 0 as libc::c_int as s16;
                phi_a3 = -(0xc0 as libc::c_int) as s16;
                while (j as libc::c_int) < 7 as libc::c_int {
                    ...
                    while (phi_a0 as libc::c_int) <
                        ...
                        temp_v0 =
                            (temp_t0 as libc::c_int + phi_a0 as libc::c_int)
                                as s16;
                        if temp_v0 as libc::c_int >= 0 as libc::c_int &&
                               (temp_v0 as libc::c_int) < 0x40 as libc::c_int
                           {
                            temp_v1 =
                                (temp_t1 as libc::c_int +
                                     phi_a3 as libc::c_int) as s16;
                            if temp_v1 as libc::c_int >= 0 as libc::c_int &&
                                   (temp_v1 as libc::c_int) <
                                       0x1000 as libc::c_int {
                                *shadowTexture.offset((temp_v0 as libc::c_int
                                                           +
                                                           temp_v1 as
                                                               libc::c_int) as
                                                          isize) =
                ...
                j += 1;
                if !((j as libc::c_int) < 6 as libc::c_int) { break ; }
            }
            i += 1
        }
    }
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 0x1000 as libc::c_int {
            if *shadowTextureTemp as libc::c_int != 0 as libc::c_int {
                *shadowTextureTemp =
    ...
    osSyncPrintf(b"SDA CONT 4\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF9C70(mut shadowTexture: *mut u8_0,
                                       mut player: *mut Player,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_sda.c\x00" as *const u8 as *const libc::c_char,
                    826 as libc::c_int);
    osSyncPrintf(b"SDA D 1\n\x00" as *const u8 as *const libc::c_char);
    ...
    (*_g).words.w1 =
        (0 as libc::c_int as u32_0 &
            ...
            (((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                    ...
                                    usize] as libc::c_int + 50 as libc::c_int)
                 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_0).words.w1 =
        (0 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    Matrix_Translate((*player).actor.world.pos.x, (*player).actor.floorHeight,
                     (*player).actor.world.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateY((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                          16 as libc::c_int +
                                          51 as libc::c_int) as usize] as
                       libc::c_int as libc::c_float / 100.0f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(1.0f32, 1.0f32,
                 (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 63 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float / 10.0f32 + 1.0f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    tempx =
        (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 62 as libc::c_int) as
                              usize] as libc::c_int as libc::c_float / 10.0f32
            + 2.0f32;
    tempz =
        ((*player).actor.world.pos.y - (*player).actor.floorHeight +
            ...
            (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                  ...
                                  usize] as libc::c_int as libc::c_float -
            20.0f32;
    Matrix_Translate(tempx, 0.0f32, tempz,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                         16 as libc::c_int +
                                         56 as libc::c_int) as usize] as
                      libc::c_int - 250 as libc::c_int) as libc::c_float /
                     1000.0f32 + 0.6f32, 1.0f32,
                 ((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                         16 as libc::c_int +
    ...
    (*_g_1).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_sda.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 860 as libc::c_int) as
            libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = D_80AFA3D8.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_10).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_10).words.w1 = D_80AFA3F8.as_mut_ptr() as libc::c_uint;
    phi_s1 = 0 as libc::c_int as s16;
    while (phi_s1 as libc::c_int) <
              (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 78 as libc::c_int) as
                                    usize] as libc::c_int {
        Matrix_Scale((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            79 as libc::c_int) as usize] as
                         libc::c_int as libc::c_float / 100.0f32 + 1.0f32,
                     1.0f32,
                     (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
                                            79 as libc::c_int) as usize] as
        ...
        (*_g_11).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_sda.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_12).words.w1 = D_80AFA3F8.as_mut_ptr() as libc::c_uint;
        phi_s1 += 1
    }
    osSyncPrintf(b"SDA D 2\n\x00" as *const u8 as *const libc::c_char);
                                    ...
                                    (0x1 as libc::c_int as u32_0 &
                                        ...
                                        ((0 as libc::c_int + 4 as libc::c_int)
                                             ...
                                             (((0x1 as libc::c_int) <<
                                                 ...
                                                 libc::c_uint) <<
                                            1 as libc::c_int,
                                w1: D_80AFA398.as_mut_ptr() as libc::c_uint,};
                     init
                 },},
         Gfx{words:
                 {
