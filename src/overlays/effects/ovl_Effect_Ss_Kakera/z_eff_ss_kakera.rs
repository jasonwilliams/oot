...
#[no_mangle]
pub static mut Effect_Ss_Kakera_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_KAKERA as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsKakera_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsKakera_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsKakeraInitParams =
        initParamsx as *mut EffectSsKakeraInitParams;
    let mut objId: s32 = 0;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).life = (*initParams).life as s16;
    (*this).priority = 101 as libc::c_int as u8_0;
    if !(*initParams).dList.is_null() {
        (*this).gfx = (*initParams).dList as *mut libc::c_void;
        objId = (*initParams).objId as s32;
        if objId == OBJECT_GAMEPLAY_KEEP as libc::c_int ||
               objId == OBJECT_GAMEPLAY_FIELD_KEEP as libc::c_int ||
               objId == OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int {
            (*this).regs[10 as libc::c_int as usize] =
                -(1 as libc::c_int) as s16
        } else {
            (*this).regs[10 as libc::c_int as usize] = (*initParams).objId;
            func_809A9BA8(this, globalCtx);
        }
    } else {
        osSyncPrintf(b"shape_model\xe3\x81\x8cNULL\n\x00" as *const u8 as
                         *const libc::c_char);
        LogUtils_HungupThread(b"../z_eff_kakera.c\x00" as *const u8 as
                                  *const libc::c_char, 178 as libc::c_int);
    }
    (*this).draw =
        Some(EffectSsKakera_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsKakera_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).vec = (*initParams).unk_18;
    (*this).regs[0 as libc::c_int as usize] = (*initParams).unk_2C;
    (*this).regs[1 as libc::c_int as usize] = (*initParams).gravity;
    (*this).regs[2 as libc::c_int as usize] =
        (Rand_ZeroOne() * 32767.0f32) as s16;
    (*this).regs[3 as libc::c_int as usize] =
        (Rand_ZeroOne() * 32767.0f32) as s16;
    (*this).regs[4 as libc::c_int as usize] = (*initParams).unk_26;
    (*this).regs[5 as libc::c_int as usize] = (*initParams).unk_28;
    (*this).regs[6 as libc::c_int as usize] = (*initParams).unk_2A;
    (*this).regs[7 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).unk_30;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).unk_32;
    (*this).regs[12 as libc::c_int as usize] = (*initParams).colorIdx;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9818(mut arg0: f32_0, mut arg1: f32_0)
 -> f32_0 {
    let mut temp_f2: f32_0 = 0.;
    if arg1 < 0.0f32 {
        osSyncPrintf(b"\xe7\xaf\x84\xe5\x9b\xb2\xe3\x81\x8c\xe3\x83\x9e\xe3\x82\xa4\xe3\x83\x8a\xe3\x82\xb9\xef\xbc\x81\xef\xbc\x81(randomD_sectionUniformity)\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    temp_f2 = Rand_ZeroOne() * arg1;
    return temp_f2 * 2.0f32 - arg1 + arg0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsKakera_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    static mut colors: [Color_RGB8; 2] =
        [{
             let mut init =
         ...
         {
             let mut init =
                 Color_RGB8{r: 235 as libc::c_int as u8_0,
    ...
    let mut colorIdx: s32 = 0;
    scale =
        (*this).regs[7 as libc::c_int as usize] as libc::c_int as
            libc::c_float / 256.0f32;
    colorIdx = (*this).regs[12 as libc::c_int as usize] as s32;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_kakera.c\x00" as *const u8 as
                        *const libc::c_char, 241 as libc::c_int);
    if (*this).regs[10 as libc::c_int as usize] as libc::c_int !=
           -(1 as libc::c_int) {
        if ((*this).regs[4 as libc::c_int as usize] as libc::c_int >>
                7 as libc::c_int & 1 as libc::c_int) << 7 as libc::c_int ==
               0x80 as libc::c_int {
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                (*globalCtx).objectCtx.status[(*this).regs[11 as libc::c_int
                                                               as usize] as
                                                  usize].segment as
                    libc::c_uint
        } else {
    ...
    Matrix_RotateY((*this).regs[3 as libc::c_int as usize] as libc::c_int as
                       libc::c_float * 0.01f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateX((*this).regs[2 as libc::c_int as usize] as libc::c_int as
                       libc::c_float * 0.01f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_2).words.w0 =
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                (colors[colorIdx as usize].r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (colors[colorIdx as usize].g as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    (colors[colorIdx as usize].b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = (*this).gfx as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = (*this).gfx as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_kakera.c\x00" as *const u8 as
                         *const libc::c_char, 302 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9BA8(mut this: *mut EffectSs,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).regs[11 as libc::c_int as usize] =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        (*this).regs[10 as libc::c_int as usize]) as s16;
    if ((*this).regs[11 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int ||
           Object_IsLoaded(&mut (*globalCtx).objectCtx,
                           (*this).regs[11 as libc::c_int as usize] as s32) ==
               0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_809A9C10(mut this: *mut EffectSs) {
    ...
    temp_f18 =
        (*this).regs[5 as libc::c_int as usize] as libc::c_int as
            libc::c_float / 1024.0f32;
    temp_f20 =
        (*this).regs[6 as libc::c_int as usize] as libc::c_int as
            libc::c_float / 1024.0f32;
    temp_f14 =
        (*this).regs[9 as libc::c_int as usize] as libc::c_int as
            libc::c_float / 1024.0f32 * 4.0f32;
    temp_f2 = (*this).velocity.x - func_809A9818(0.0f32, temp_f14);
    temp_f16 = (*this).velocity.y - func_809A9818(0.0f32, temp_f14);
    temp_f12 = (*this).velocity.z - func_809A9818(0.0f32, temp_f14);
    if temp_f2 > 0.0f32 {
        (*this).velocity.x -=
            temp_f2 * temp_f18 + temp_f2 * temp_f2 * temp_f20
    } else {
        (*this).velocity.x -=
            temp_f2 * temp_f18 - temp_f2 * temp_f2 * temp_f20
    }
    ...
    } else { (*this).velocity.z -= temp_f0 - temp_f2 };
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9DC0(mut this: *mut EffectSs) {
    (*this).accel.z = 0.0f32;
    (*this).accel.y = (*this).accel.z;
    (*this).accel.x = (*this).accel.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9DD8(mut arg0: f32_0, mut arg1: s32)
 -> f32_0 {
    return 1.0f32;
}
static mut D_809AA530: [f32_0; 10] =
    [1.0f32, 100.0f32, 40.0f32, 5.0f32, 100.0f32, 40.0f32, 5.0f32, 100.0f32,
     40.0f32, 5.0f32];
#[no_mangle]
pub unsafe extern "C" fn func_809A9DEC(mut arg0: f32_0, mut arg1: s32)
 -> f32_0 {
    if D_809AA530[arg1 as usize] < arg0 {
        return D_809AA530[arg1 as usize] / arg0
    } else { return 1.0f32 };
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9E28(mut arg0: f32_0, mut arg1: s32)
 -> f32_0 {
    let mut temp: f32_0 = arg0 * arg0;
    if D_809AA530[arg1 as usize] < temp {
        return D_809AA530[arg1 as usize] / temp
    } else { return 1.0f32 };
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9E68(mut arg0: f32_0, mut arg1: s32)
 -> f32_0 {
    return func_809A9E28(arg0, arg1);
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9E88(mut this: *mut EffectSs,
                                       mut diff: *mut Vec3f, mut dist: f32_0)
 -> s32 {
    static mut D_809AA558: [f32_0; 2] = [0.05f32, 1.0f32];
    ...
    if temp_v0 != 0 as libc::c_int {
        if dist > 1.0f32 { phi_f0 = 1.0f32 / dist } else { phi_f0 = 1.0f32 }
        (*this).accel.x +=
            D_809AA558[(temp_v0 - 1 as libc::c_int) as usize] * (*diff).z *
                phi_f0;
        (*this).accel.z -=
            D_809AA558[(temp_v0 - 1 as libc::c_int) as usize] * (*diff).x *
                phi_f0
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9F10(mut this: *mut EffectSs,
                                       mut diff: *mut Vec3f, mut dist: f32_0)
 -> s32 {
    static mut D_809AA560: [f32_0; 7] =
        [4.0f32, 0.1f32, 0.3f32, 0.9f32, -0.1f32, -0.3f32, -0.9f32];
    let mut temp_v0: s32 = 0;
    temp_v0 =
        (*this).regs[0 as libc::c_int as usize] as libc::c_int >>
            2 as libc::c_int & 7 as libc::c_int;
    if temp_v0 != 0 as libc::c_int {
        (*this).accel.y += D_809AA560[temp_v0 as usize]
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9F4C(mut this: *mut EffectSs,
                                       mut diff: *mut Vec3f, mut dist: f32_0)
 -> s32 {
    static mut D_809AA57C: [f32_0; 3] = [0.1f32, 1.0f32, 6.0f32];
    let mut temp_v0: s32 = 0;
    let mut phi_f0: f32_0 = 0.;
    temp_v0 =
        (*this).regs[0 as libc::c_int as usize] as libc::c_int >>
    ...
    if temp_v0 != 0 as libc::c_int {
        if dist > 1.0f32 { phi_f0 = 1.0f32 / dist } else { phi_f0 = 1.0f32 }
        (*this).accel.x -=
            (*diff).x * D_809AA57C[(temp_v0 - 1 as libc::c_int) as usize] *
                phi_f0;
        (*this).accel.z -=
            (*diff).z * D_809AA57C[(temp_v0 - 1 as libc::c_int) as usize] *
                phi_f0
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809A9FD8(mut this: *mut EffectSs,
                                       mut diff: *mut Vec3f, mut dist: f32_0)
 -> s32 {
    static mut D_809AA588:
           [Option<unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0>; 10] =
        unsafe {
            [Some(func_809A9DD8 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9DEC as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9DEC as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9DEC as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E28 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E28 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E28 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E68 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E68 as
                      unsafe extern "C" fn(_: f32_0, _: s32) -> f32_0),
             Some(func_809A9E68 as
    ...
    temp_a1 =
        (*this).regs[0 as libc::c_int as usize] as libc::c_int >>
            7 as libc::c_int & 0xf as libc::c_int;
    temp_f0 =
        D_809AA588[temp_a1 as
                       usize].expect("non-null function pointer")(dist,
                                                                  temp_a1);
    temp_f0 =
        func_809A9818(temp_f0,
                      (*this).regs[9 as libc::c_int as usize] as libc::c_int
                          as libc::c_float * temp_f0 / 1024.0f32);
    (*this).accel.x *= temp_f0;
    (*this).accel.y *= temp_f0;
    (*this).accel.z *= temp_f0;
    (*this).accel.x += temp_f0 * 0.01f32;
    (*this).accel.y += temp_f0 * 0.01f32;
    (*this).accel.z += temp_f0 * 0.01f32;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809AA0B8(mut this: *mut EffectSs,
                                       mut diff: *mut Vec3f, mut dist: f32_0)
 -> s32 {
    (*this).accel.y +=
...
#[no_mangle]
pub unsafe extern "C" fn func_809AA0EC(mut this: *mut EffectSs) -> s32 {
    ...
    if dist > 1000.0f32 { return 0 as libc::c_int }
    if (*this).regs[0 as libc::c_int as usize] as libc::c_int !=
           0 as libc::c_int {
        if func_809A9E88(this, &mut diff, dist) == 0 {
            return 0 as libc::c_int
        }
        if func_809A9F10(this, &mut diff, dist) == 0 {
            return 0 as libc::c_int
        }
        if func_809A9F4C(this, &mut diff, dist) == 0 {
            return 0 as libc::c_int
        }
        if func_809A9FD8(this, &mut diff, dist) == 0 {
            return 0 as libc::c_int
        }
    }
    if func_809AA0B8(this, &mut diff, dist) == 0 { return 0 as libc::c_int }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809AA230(mut this: *mut EffectSs,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_809AA5B0: [f32_0; 3] = [10.0f32, 20.0f32, 40.0f32];
    ...
    if (*this).regs[8 as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int {
        if ((*this).regs[4 as libc::c_int as usize] as libc::c_int >>
                4 as libc::c_int & 1 as libc::c_int) * 0x10 as libc::c_int ==
               0x10 as libc::c_int {
            if (*this).pos.y <=
                   (*player).actor.floorHeight -
                       ((*this).regs[4 as libc::c_int as usize] as libc::c_int
                            >> 2 as libc::c_int & 3 as libc::c_int) as
                           libc::c_float {
                (*this).regs[9 as libc::c_int as usize] =
                ...
                (*this).regs[5 as libc::c_int as usize] =
                    (*this).regs[9 as libc::c_int as usize];
                (*this).regs[1 as libc::c_int as usize] =
                    (*this).regs[9 as libc::c_int as usize]
                      ...
                      (*player).actor.floorHeight -
                          ((*this).regs[4 as libc::c_int as usize] as
                               libc::c_int >> 2 as libc::c_int &
                               3 as libc::c_int) as libc::c_float - 600.0f32 {
            (*this).life = 0 as libc::c_int as s16
        }
    } else {
        match (*this).regs[4 as libc::c_int as usize] as libc::c_int &
                  3 as libc::c_int {
            0 => {
            ...
            1 => {
                if (*this).velocity.y < 0.0f32 {
                    if BgCheck_SphVsFirstPoly(&mut (*globalCtx).colCtx,
                                              &mut (*this).pos,
                                              D_809AA5B0[((*this).regs[4 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]
                                                              as libc::c_int
                                                              ...
                                                              3 as
                                                                  libc::c_int)
                                                             as usize]) != 0 {
                        (*this).velocity.x *= func_809A9818(0.9f32, 0.2f32);
                        (*this).velocity.y *= -0.8f32;
                        (*this).velocity.z *= func_809A9818(0.9f32, 0.2f32);
                        if (*this).regs[8 as libc::c_int as usize] as
                               libc::c_int > 0 as libc::c_int {
                            (*this).regs[8 as libc::c_int as usize] =
                                ((*this).regs[8 as libc::c_int as usize] as
            ...
            2 => {
                (BgCheck_SphVsFirstPoly(&mut (*globalCtx).colCtx,
                                        &mut (*this).pos,
                                        D_809AA5B0[((*this).regs[4 as
                                                                     libc::c_int
                                                                     as usize]
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsKakera_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    match ((*this).regs[4 as libc::c_int as usize] as libc::c_int >>
               5 as libc::c_int & 3 as libc::c_int) << 5 as libc::c_int {
        32 => {
            (*this).regs[2 as libc::c_int as usize] =
                ((*this).regs[2 as libc::c_int as usize] as libc::c_int +
    ...
    func_809A9C10(this);
    if func_809AA0EC(this) == 0 { (*this).life = 0 as libc::c_int as s16 }
