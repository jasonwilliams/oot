...
extern "C" {
    ...
    #[no_mangle]
    static mut gBiriDischargeLightningAnim: AnimationHeader;
    #[no_mangle]
    static mut gBiriClimbAnim: AnimationHeader;
    #[no_mangle]
    static mut gBiriDefaultAnim: AnimationHeader;
    #[no_mangle]
    static mut gBiriTentacles0Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriTentacles7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gBiriSkel: SkeletonHeader;
}
...
pub struct EnBili {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnBiliActionFunc,
    pub tentaclesTexIndex: u8_0,
    pub playFlySound: u8_0,
    pub timer: s16,
    pub jointTable: [Vec3s; 5],
    pub morphTable: [Vec3s; 5],
    pub collider: ColliderCylinder,
}
pub type EnBiliActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const EN_BILI_LIMB_MAX: C2RustUnnamed_22 = 5;
pub const EN_BILI_LIMB_TENTACLES: C2RustUnnamed_22 = 4;
pub const EN_BILI_LIMB_OUTER_HOOD: C2RustUnnamed_22 = 3;
pub const EN_BILI_LIMB_INNER_HOOD: C2RustUnnamed_22 = 2;
pub const EN_BILI_LIMB_ROOT: C2RustUnnamed_22 = 1;
pub const EN_BILI_LIMB_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_int;
pub const EN_BILI_TYPE_DYING: C2RustUnnamed_23 = 1;
pub const EN_BILI_TYPE_VALI_SPAWNED: C2RustUnnamed_23 = 0;
pub const EN_BILI_TYPE_NORMAL: C2RustUnnamed_23 = -1;
pub const BIRI_DMGEFF_NONE: C2RustUnnamed_24 = 0;
pub const BIRI_DMGEFF_ICE: C2RustUnnamed_24 = 3;
pub const BIRI_DMGEFF_FIRE: C2RustUnnamed_24 = 2;
pub const BIRI_DMGEFF_SWORD: C2RustUnnamed_24 = 15;
pub const BIRI_DMGEFF_SLINGSHOT: C2RustUnnamed_24 = 14;
pub const BIRI_DMGEFF_DEKUNUT: C2RustUnnamed_24 = 1;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut En_Bili_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BILI as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBili>() as
                                  libc::c_ulong,
                          init:
...
static mut sColChkInfoInit: CollisionCheckInfoInit2 =
    {
        let mut init =
            CollisionCheckInfoInit2{health: 1 as libc::c_int as u8_0,
                                    cylRadius: 9 as libc::c_int as s16,
                                    cylHeight: 28 as libc::c_int as s16,
                                    cylYShift: -(20 as libc::c_int) as s16,
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (BIRI_DMGEFF_DEKUNUT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BIRI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (BIRI_DMGEFF_SLINGSHOT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BIRI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (BIRI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (BIRI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BIRI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BIRI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BIRI_DMGEFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BIRI_DMGEFF_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BIRI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBili = thisx as *mut EnBili;
    ...
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gBiriSkel,
                   &mut gBiriDefaultAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(),
                   EN_BILI_LIMB_MAX as libc::c_int);
    Collider_InitCylinder(globalCtx, &mut (*this).collider);
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInit);
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                            &mut sColChkInfoInit);
    (*this).playFlySound = 0 as libc::c_int as u8_0;
    if (*this).actor.params as libc::c_int ==
           EN_BILI_TYPE_NORMAL as libc::c_int {
        EnBili_SetupFloatIdle(this);
    } else { EnBili_SetupSpawnedFlyApart(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBili = thisx as *mut EnBili;
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupFloatIdle(mut this: *mut EnBili) {
    (*this).actor.speedXZ = 0.7f32; // Shock?
    (*this).collider.info.bumper.effect = 1 as libc::c_int as u8_0;
    (*this).timer = 32 as libc::c_int as s16;
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(EnBili_FloatIdle as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupSpawnedFlyApart(mut this: *mut EnBili) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gBiriDefaultAnim);
    ...
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnBili_SpawnedFlyApart as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupDischargeLightning(mut this:
                                                            *mut EnBili) {
    Animation_PlayLoop(&mut (*this).skelAnime,
                       &mut gBiriDischargeLightningAnim);
    (*this).timer = 10 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnBili_DischargeLightning as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupClimb(mut this: *mut EnBili) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gBiriClimbAnim);
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnBili_Climb as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupApproachPlayer(mut this: *mut EnBili) {
    (*this).actor.speedXZ = 1.2f32;
    (*this).actionFunc =
        Some(EnBili_ApproachPlayer as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupSetNewHomeHeight(mut this: *mut EnBili) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gBiriDefaultAnim);
    (*this).timer = 96 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.9f32;
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(EnBili_SetNewHomeHeight as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
    (*this).actor.home.pos.y = (*this).actor.world.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupRecoil(mut this: *mut EnBili) {
    if (*this).skelAnime.animation !=
           &mut gBiriDefaultAnim as *mut AnimationHeader as *mut libc::c_void
       {
        Animation_PlayLoop(&mut (*this).skelAnime, &mut gBiriDefaultAnim);
    }
    (*this).actor.world.rot.y =
        (Actor_WorldYawTowardPoint(&mut (*this).actor,
                                   &mut (*(*this).collider.base.ac).prevPos)
             as libc::c_int + 0x8000 as libc::c_int) as s16;
    (*this).actor.world.rot.x =
        Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                    &mut (*(*this).collider.base.ac).prevPos);
    (*this).actionFunc =
        Some(EnBili_Recoil as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupBurnt(mut this: *mut EnBili) {
    if (*this).actionFunc ==
           Some(EnBili_Climb as
                    unsafe extern "C" fn(_: *mut EnBili,
                                         _: *mut GlobalContext) -> ()) {
        Animation_PlayLoop(&mut (*this).skelAnime, &mut gBiriDefaultAnim);
    }
    ...
    (*this).actionFunc =
        Some(EnBili_Burnt as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupDie(mut this: *mut EnBili) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupStunned(mut this: *mut EnBili) {
    (*this).timer = 80 as libc::c_int as s16;
    (*this).collider.info.bumper.effect = 0 as libc::c_int as u8_0;
    ...
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnBili_Stunned as
                 unsafe extern "C" fn(_: *mut EnBili, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetupFrozen(mut this: *mut EnBili,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    (*this).actor.velocity.y = 0.0f32;
    effectPos.y = (*this).actor.world.pos.y - 15.0f32;
    i = 0 as libc::c_int;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_UpdateTentaclesIndex(mut this: *mut EnBili) {
    let mut curFrame: s16 =
        (*this).skelAnime.curFrame as
            s16; // Not strictly necessary, but avoids a few s16 casts
    let mut temp: s16 = 0;
    if (*this).actionFunc ==
           Some(EnBili_DischargeLightning as
                    unsafe extern "C" fn(_: *mut EnBili,
                                         _: *mut GlobalContext) -> ()) {
        temp = (3 as libc::c_int - curFrame as libc::c_int) as s16;
        (*this).tentaclesTexIndex =
            (((if temp as libc::c_int >= 0 as libc::c_int {
                   temp as libc::c_int
               } else { -(temp as libc::c_int) }) + 5 as libc::c_int) %
                 8 as libc::c_int) as u8_0
                  ...
                  Some(EnBili_Climb as
                           unsafe extern "C" fn(_: *mut EnBili,
                                                _: *mut GlobalContext) -> ())
     {
        if curFrame as libc::c_int <= 9 as libc::c_int {
            temp = (curFrame as libc::c_int >> 1 as libc::c_int) as s16;
            (*this).tentaclesTexIndex =
                if temp as libc::c_int > 3 as libc::c_int {
                    3 as libc::c_int
                } else { temp as libc::c_int } as u8_0
        } else if curFrame as libc::c_int <= 18 as libc::c_int {
            temp = (17 as libc::c_int - curFrame as libc::c_int) as s16;
            (*this).tentaclesTexIndex =
                ((if (temp as libc::c_int) < 0 as libc::c_int {
                      0 as libc::c_int
                  } else { temp as libc::c_int }) >> 1 as libc::c_int) as u8_0
        } else if curFrame as libc::c_int <= 36 as libc::c_int {
            (*this).tentaclesTexIndex =
                ((36 as libc::c_int - curFrame as libc::c_int) /
                     3 as libc::c_int + 2 as libc::c_int) as u8_0
        } else {
            (*this).tentaclesTexIndex =
                (40 as libc::c_int - curFrame as libc::c_int >>
                     1 as libc::c_int) as u8_0
        }
    } else {
        (*this).tentaclesTexIndex =
            (curFrame as libc::c_int >> 1 as libc::c_int) as u8_0
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBili_UpdateFloating(mut this: *mut EnBili) {
    let mut playerHeight: f32_0 =
        (*this).actor.world.pos.y + (*this).actor.yDistToPlayer;
    let mut heightOffset: f32_0 =
        if (*this).actionFunc ==
               Some(EnBili_SetNewHomeHeight as
                        unsafe extern "C" fn(_: *mut EnBili,
                                             _: *mut GlobalContext) -> ()) {
    ...
    let mut baseHeight: f32_0 =
        if (*this).actor.floorHeight < playerHeight {
            playerHeight
        } else { (*this).actor.floorHeight };
    Math_StepToF(&mut (*this).actor.home.pos.y, baseHeight + heightOffset,
                 1.0f32);
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y +
            sinf((*this).timer as libc::c_int as libc::c_float *
                     (3.14159265358979323846f32 /
                          16 as libc::c_int as libc::c_float)) * 3.0f32;
...
// Action functions
#[no_mangle]
pub unsafe extern "C" fn EnBili_FloatIdle(mut this: *mut EnBili,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int % 4 as libc::c_int == 0 {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_float +
                 Rand_CenteredFloat(1820.0f32)) as s16
    }
    ...
    if (*this).actor.xzDistToPlayer < 160.0f32 &&
           fabsf((*this).actor.yDistToPlayer) < 45.0f32 {
        EnBili_SetupApproachPlayer(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_SpawnedFlyApart(mut this: *mut EnBili,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_DischargeLightning(mut this: *mut EnBili,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    let mut i: s32 = 0;
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut effectYaw: s16 = 0;
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        if ((*this).timer as libc::c_int + (i << 1 as libc::c_int)) %
               4 as libc::c_int == 0 {
            effectYaw =
                (Rand_CenteredFloat(12288.0f32) as s16 as libc::c_int +
                    ...
                    s16;
            effectPos.x =
                Rand_CenteredFloat(5.0f32) + (*this).actor.world.pos.x;
            effectPos.y =
                Rand_ZeroOne() * 5.0f32 + (*this).actor.world.pos.y + 2.5f32;
            effectPos.z =
                Rand_CenteredFloat(5.0f32) + (*this).actor.world.pos.z;
            EffectSsLightning_Spawn(globalCtx, &mut effectPos, &mut primColor,
                                    &mut envColor, 15 as libc::c_int as s16,
                                    effectYaw, 6 as libc::c_int as s16,
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
        ...
        if (*this).actor.params as libc::c_int ==
               EN_BILI_TYPE_DYING as libc::c_int {
            EnBili_SetupDie(this);
        } else { EnBili_SetupClimb(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_Climb(mut this: *mut EnBili,
                                      mut globalCtx: *mut GlobalContext) {
    let mut skelAnimeUpdate: s32 = SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if curFrame > 9.0f32 {
        Math_ApproachF(&mut (*this).actor.world.pos.y,
                       (*this).actor.world.pos.y + (*this).actor.yDistToPlayer
                           + 100.0f32, 0.5f32, 5.0f32);
    }
    if skelAnimeUpdate != 0 { EnBili_SetupSetNewHomeHeight(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_ApproachPlayer(mut this: *mut EnBili,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ApproachS(&mut (*this).actor.world.rot.y,
                   (*this).actor.yawTowardsPlayer, 2 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_SetNewHomeHeight(mut this: *mut EnBili,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Recoil(mut this: *mut EnBili,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.3f32) != 0 {
        (*this).actor.world.rot.y =
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Burnt(mut this: *mut EnBili,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.flags &
           ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_uint != 0 {
        (*this).actor.colorFilterTimer = 20 as libc::c_int as u8_0
    } else {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
...
pub unsafe extern "C" fn EnBili_Die(mut this: *mut EnBili,
    ...
    if (*this).timer as libc::c_int != 0 as libc::c_int {
        ...
        while i < 2 as libc::c_int {
            effectPos.x =
                Rand_ZeroOne() * 10.0f32 + (*this).actor.world.pos.x - 5.0f32;
            effectPos.y =
                Rand_ZeroOne() * 5.0f32 + (*this).actor.world.pos.y - 2.5f32;
            effectPos.z =
                Rand_ZeroOne() * 10.0f32 + (*this).actor.world.pos.z - 5.0f32;
            effectVelocity.y = Rand_ZeroOne() + 1.0f32;
            effectScale =
                Rand_S16Offset(40 as libc::c_int as s16,
                               40 as libc::c_int as s16);
            if Rand_ZeroOne() < 0.7f32 {
                EffectSsDtBubble_SpawnColorProfile(globalCtx, &mut effectPos,
                                                   &mut effectVelocity,
                                                   &mut effectAccel,
                                                   effectScale,
    ...
    if (*this).timer as libc::c_int == 14 as libc::c_int {
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                  40 as libc::c_int,
                                  0x389c as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_Stunned(mut this: *mut EnBili,
                                        mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Frozen(mut this: *mut EnBili,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).actor.flags &
           ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_uint == 0 {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 ||
        ...
        EnBili_SetupDie(this);
    } else { (*this).actor.colorFilterTimer = 10 as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_UpdateDamage(mut this: *mut EnBili,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int &&
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                   0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x389b as libc::c_int as u16_0);
                Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
            }
            damageEffect = (*this).actor.colChkInfo.damageEffect;
            if damageEffect as libc::c_int ==
                   BIRI_DMGEFF_DEKUNUT as libc::c_int {
                if (*this).actionFunc !=
                       Some(EnBili_Stunned as
                                unsafe extern "C" fn(_: *mut EnBili,
            ...
            } else if damageEffect as libc::c_int ==
                          BIRI_DMGEFF_SWORD as libc::c_int {
                if (*this).actionFunc !=
                       Some(EnBili_Stunned as
                                unsafe extern "C" fn(_: *mut EnBili,
                    ...
                    if (*this).actor.colChkInfo.health as libc::c_int ==
                           0 as libc::c_int {
                        (*this).actor.params =
                            EN_BILI_TYPE_DYING as libc::c_int as s16
                    }
                    EnBili_SetupDischargeLightning(this);
                } else { EnBili_SetupBurnt(this); }
            } else if damageEffect as libc::c_int ==
                          BIRI_DMGEFF_FIRE as libc::c_int {
            ...
            if (*(*this).collider.info.acHitInfo).toucher.dmgFlags &
                   0x1f820 as libc::c_int as libc::c_uint != 0 {
                // DMG_ARROW
                (*this).actor.flags |=
                    ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Update(mut thisx: *mut Actor,
    ...
    if (*this).actionFunc !=
                   ...
                   (*this).actionFunc ==
                       Some(EnBili_Recoil as
                                unsafe extern "C" fn(_: *mut EnBili,
                                                     _: *mut GlobalContext)
                                    -> ()) {
                if (*this).playFlySound != 0 {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3898 as libc::c_int as u16_0);
                    (*this).playFlySound = 0 as libc::c_int as u8_0
                } else { (*this).playFlySound = 1 as libc::c_int as u8_0 }
            }
        }
        if (*this).actionFunc ==
               Some(EnBili_Recoil as
        ...
        } else { Actor_MoveForward(&mut (*this).actor); }
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                (*this).collider.dim.radius as f32_0,
                                (*this).collider.dim.height as f32_0,
                                7 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_PulseLimb3(mut this: *mut EnBili,
                                           mut frame: f32_0,
                                           mut arg2: *mut Vec3f) {
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    if (*this).actionFunc ==
        ...
        (*arg2).y =
            1.0f32 -
                sinf(3.14159265358979323846f32 * 0.16667f32 * frame) * 0.26f32
    } else if (*this).actionFunc ==
                  Some(EnBili_Climb as
                           unsafe extern "C" fn(_: *mut EnBili,
                                                _: *mut GlobalContext) -> ())
     {
        if frame <= 8.0f32 {
            (*arg2).y =
                cosf(3.14159265358979323846f32 * 0.125f32 * frame) * 0.15f32 +
                    0.85f32
        } else if frame <= 18.0f32 {
            cos =
                cosf((frame - 8.0f32) * (3.14159265358979323846f32 * 0.1f32));
            (*arg2).y = 1.0f32 - 0.3f32 * cos;
            (*arg2).x = 0.2f32 * cos + 0.8f32
        } else {
            cos =
                cosf((frame - 18.0f32) *
                         (3.14159265358979323846f32 * 0.0227f32));
            (*arg2).y = 0.31f32 * cos + 1.0f32;
            (*arg2).x = 1.0f32 - 0.4f32 * cos
        }
        (*arg2).z = (*arg2).x
    } else if (*this).actionFunc ==
                  Some(EnBili_Stunned as
     ...
     {
        sin =
            sinf(3.14159265358979323846f32 * 0.1f32 *
        ...
        (*arg2).y =
            cosf(3.14159265358979323846f32 * 0.125f32 * frame) * 0.13f32 +
                0.87f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_PulseLimb2(mut this: *mut EnBili,
                                           mut frame: f32_0,
                                           mut arg2: *mut Vec3f) {
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    if (*this).actionFunc ==
           Some(EnBili_DischargeLightning as
                    unsafe extern "C" fn(_: *mut EnBili,
                                         _: *mut GlobalContext) -> ()) {
        (*arg2).y =
            sinf(3.14159265358979323846f32 * 0.16667f32 * frame) * 0.2f32 +
                1.0f32
    } else if (*this).actionFunc ==
                  Some(EnBili_Climb as
                           unsafe extern "C" fn(_: *mut EnBili,
                                                _: *mut GlobalContext) -> ())
     {
        if frame <= 8.0f32 {
            (*arg2).x =
                1.125f32 -
                    cosf(3.14159265358979323846f32 * 0.125f32 * frame) *
                        0.125f32
        } else if frame <= 18.0f32 {
            cos =
                cosf((frame - 8.0f32) * (3.14159265358979323846f32 * 0.1f32));
            (*arg2).x = 0.275f32 * cos + 0.975f32;
            (*arg2).y = 1.25f32 - 0.25f32 * cos
        } else {
            cos =
                cosf((frame - 18.0f32) *
                         (3.14159265358979323846f32 * 0.0227f32));
            (*arg2).x = 1.0f32 - 0.3f32 * cos;
            (*arg2).y = 0.48f32 * cos + 1.0f32
        }
        (*arg2).z = (*arg2).x
    } else if (*this).actionFunc ==
                  Some(EnBili_Stunned as
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        ...
        (*arg2).y =
            1.1f32 -
                cosf(3.14159265358979323846f32 * 0.125f32 * frame) * 0.1f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_PulseLimb4(mut this: *mut EnBili,
                                           mut frame: f32_0,
                                           mut arg2: *mut Vec3f) {
    let mut cos: f32_0 = 0.;
    if (*this).actionFunc ==
           Some(EnBili_Climb as
                    unsafe extern "C" fn(_: *mut EnBili,
                                         _: *mut GlobalContext) -> ()) {
        if frame <= 8.0f32 {
            cos = cosf(3.14159265358979323846f32 * 0.125f32 * frame);
            (*arg2).x = 1.125f32 - 0.125f32 * cos;
            (*arg2).y = 0.3f32 * cos + 0.7f32
        } else if frame <= 18.0f32 {
            cos =
                cosf((frame - 8.0f32) * (3.14159265358979323846f32 * 0.1f32));
            (*arg2).x = 0.325f32 * cos + 0.925f32;
            (*arg2).y = 0.95f32 - 0.55f32 * cos
        } else {
            cos =
                cosf((frame - 18.0f32) *
                         (3.14159265358979323846f32 * 0.0227f32));
            (*arg2).x = 1.0f32 - 0.4f32 * cos;
            (*arg2).y = 0.52f32 * cos + 1.0f32
        }
        (*arg2).z = (*arg2).x
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBili_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnBili = thisx as *mut EnBili;
    let mut limbScale: Vec3f =
        { let mut init = Vec3f{x: 1.0f32, y: 1.0f32, z: 1.0f32,}; init };
    let mut curFrame: f32_0 = (*this).skelAnime.curFrame;
    if limbIndex == EN_BILI_LIMB_OUTER_HOOD as libc::c_int {
        EnBili_PulseLimb3(this, curFrame, &mut limbScale);
    } else if limbIndex == EN_BILI_LIMB_INNER_HOOD as libc::c_int {
        EnBili_PulseLimb2(this, curFrame, &mut limbScale);
    } else if limbIndex == EN_BILI_LIMB_TENTACLES as libc::c_int {
        EnBili_PulseLimb4(this, curFrame, &mut limbScale);
        (*rot).y =
    ...
    Matrix_Scale(limbScale.x, limbScale.y, limbScale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    return 0 as libc::c_int;
}
static mut sTentaclesTextures: [*mut libc::c_void; 8] =
    unsafe {
        [gBiriTentacles0Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles5Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles6Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gBiriTentacles7Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut D_809C1700: [Gfx; 2] =
    [Gfx{words:
             {
                 let mut init =
                     Gwords{w0:
...
#[no_mangle]
pub unsafe extern "C" fn EnBili_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBili = thisx as *mut EnBili;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bili.c\x00" as *const u8 as *const libc::c_char,
                    1521 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    (*this).tentaclesTexIndex =
        if (*this).tentaclesTexIndex as libc::c_int > 7 as libc::c_int {
            7 as libc::c_int
        } else { (*this).tentaclesTexIndex as libc::c_int } as u8_0;
    ...
    (*_g).words.w1 =
        gSegments[((sTentaclesTextures[(*this).tentaclesTexIndex as usize] as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sTentaclesTextures[(*this).tentaclesTexIndex
                                                                 as usize] as
                                              u32_0 &
    ...
    if (*this).actionFunc ==
           Some(EnBili_DischargeLightning as
                    unsafe extern "C" fn(_: *mut EnBili,
                                         _: *mut GlobalContext) -> ()) &&
           (*this).timer as libc::c_int & 1 as libc::c_int != 0 as libc::c_int
       {
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = D_809C16F0.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = D_809C1700.as_mut_ptr() as libc::c_uint
    }
    (*__gfxCtx).polyXlu.p =
        SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                       (*this).skelAnime.jointTable,
                       Some(EnBili_OverrideLimbDraw as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bili.c\x00" as *const u8 as
                         *const libc::c_char, 1552 as libc::c_int);
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x17 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
