...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjRoomtimer {
    pub actor: Actor,
    pub actionFunc: ObjRoomtimerActionFunc,
    pub switchFlag: u32_0,
}
pub type ObjRoomtimerActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjRoomtimer, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Roomtimer_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_ROOMTIMER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<ObjRoomtimer>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjRoomtimer_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjRoomtimer_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjRoomtimer_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjRoomtimer_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjRoomtimer = thisx as *mut ObjRoomtimer;
    let mut params: s16 = (*this).actor.params;
    (*this).switchFlag =
        (params as libc::c_int >> 10 as libc::c_int & 0x3f as libc::c_int) as
            u32_0;
    (*this).actor.params =
        (params as libc::c_int & 0x3ff as libc::c_int) as s16;
    params = (*this).actor.params;
    if params as libc::c_int != 0x3ff as libc::c_int {
        if params as libc::c_int > 600 as libc::c_int {
            (*this).actor.params = 600 as libc::c_int as s16
        } else { (*this).actor.params = params }
    }
    (*this).actionFunc =
        Some(func_80B9D054 as
                 unsafe extern "C" fn(_: *mut ObjRoomtimer,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjRoomtimer_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut ObjRoomtimer = thisx as *mut ObjRoomtimer;
    if (*this).actor.params as libc::c_int != 0x3ff as libc::c_int &&
           gSaveContext.timer1Value as libc::c_int > 0 as libc::c_int {
        gSaveContext.timer1State = 10 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9D054(mut this: *mut ObjRoomtimer,
    ...
    (*this).actionFunc =
        Some(func_80B9D0B0 as
                 unsafe extern "C" fn(_: *mut ObjRoomtimer,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9D0B0(mut this: *mut ObjRoomtimer,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    } else if (*this).actor.params as libc::c_int != 0x3ff as libc::c_int &&
                  gSaveContext.timer1Value as libc::c_int == 0 as libc::c_int
     {
...
#[no_mangle]
pub unsafe extern "C" fn ObjRoomtimer_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjRoomtimer = thisx as *mut ObjRoomtimer;
