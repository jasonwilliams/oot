...
extern "C" {
    ...
    #[no_mangle]
    static mut object_hs_Anim_000304: AnimationHeader;
    #[no_mangle]
    static mut object_hs_Anim_000528: AnimationHeader;
    #[no_mangle]
    static mut object_hs_Anim_0005C0: AnimationHeader;
    #[no_mangle]
    static mut object_hs_Skel_006260: FlexSkeletonHeader;
}
...
pub struct EnHs {
    ...
    pub unk_2A8: u16_0,
    pub unk_2AA: s16,
    pub actionFunc: EnHsActionFunc,
}
pub type EnHsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHs, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Hs_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HS as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_HS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHs>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E3A0(mut this: *mut EnHs,
                                       mut actionFunc: EnHsActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnHs_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs = thisx as *mut EnHs;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_hs_Skel_006260, &mut object_hs_Anim_0005C0,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 16 as libc::c_int);
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_hs_Anim_0005C0);
    ...
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        ...
        osSyncPrintf(b"\x1b[36m \xe3\x83\x92\xe3\x83\xa8\xe3\x82\xb3\xe3\x81\xae\xe5\xba\x97(\xe5\xa4\xa7\xe4\xba\xba\xe3\x81\xae\xe6\x99\x82) \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        func_80A6E3A0(this,
                      Some(func_80A6E9AC as
                               unsafe extern "C" fn(_: *mut EnHs,
                                                    _: *mut GlobalContext)
                                   -> ()));
        if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
               1 as libc::c_int != 0 {
            // "chicken shop closed"
            osSyncPrintf(b"\x1b[36m \xe3\x83\x92\xe3\x83\xa8\xe3\x82\xb3\xe5\xb1\x8b\xe9\x96\x89\xe5\xba\x97 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            Actor_Kill(&mut (*this).actor);
        }
    } else {
        // "chicken shop (child era)"
        osSyncPrintf(b"\x1b[36m \xe3\x83\x92\xe3\x83\xa8\xe3\x82\xb3\xe3\x81\xae\xe5\xba\x97(\xe5\xad\x90\xe4\xba\xba\xe3\x81\xae\xe6\x99\x82) \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        func_80A6E3A0(this,
                      Some(func_80A6E9AC as
                               unsafe extern "C" fn(_: *mut EnHs,
...
#[no_mangle]
pub unsafe extern "C" fn EnHs_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs = thisx as *mut EnHs;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6E53C(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext,
                                       mut textId: u16_0,
                                       mut actionFunc: EnHsActionFunc)
 -> s32 {
    ...
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
        ...
        } else { -(yawDiff as libc::c_int) }) <= 0x2150 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E5EC(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80A6E3A0(this,
                      Some(func_80A6E6B0 as
                               unsafe extern "C" fn(_: *mut EnHs,
                                                    _: *mut GlobalContext)
                                   -> ()));
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E630(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E6B0(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A6E53C(this, globalCtx, 0x10b6 as libc::c_int as u16_0,
                  Some(func_80A6E5EC as
                           unsafe extern "C" fn(_: *mut EnHs,
                                                _: *mut GlobalContext)
                               -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6E6D8(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80A6E3A0(this,
                      Some(func_80A6E9AC as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E70C(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        func_80A6E3A0(this,
                      Some(func_80A6E9AC as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E740(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        func_80A6E3A0(this,
                      Some(func_80A6E630 as
                               unsafe extern "C" fn(_: *mut EnHs,
                                                    _: *mut GlobalContext)
                                   -> ()));
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_ODD_MUSHROOM as libc::c_int, 10000.0f32, 50.0f32);
    }
    (*this).unk_2A8 =
        ((*this).unk_2A8 as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6E7BC(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                func_80A6E3A0(this,
                              Some(func_80A6E740 as
                                       unsafe extern "C" fn(_: *mut EnHs,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
                func_8002F434(&mut (*this).actor, globalCtx,
                              GI_ODD_MUSHROOM as libc::c_int, 10000.0f32,
                              50.0f32);
            }
            1 => {
                Message_ContinueTextbox(globalCtx,
                                        0x10b4 as libc::c_int as u16_0);
                func_80A6E3A0(this,
                              Some(func_80A6E70C as
                                       unsafe extern "C" fn(_: *mut EnHs,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
        ...
        Animation_Change(&mut (*this).skelAnime, &mut object_hs_Anim_0005C0,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_hs_Anim_0005C0 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E8CC(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x10b3 as libc::c_int as u16_0);
        func_80A6E3A0(this,
                      Some(func_80A6E7BC as
                               unsafe extern "C" fn(_: *mut EnHs,
                                                    _: *mut GlobalContext)
                                   -> ()));
        Animation_Change(&mut (*this).skelAnime, &mut object_hs_Anim_000528,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_hs_Anim_000528 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         8.0f32);
    }
    if (*this).unk_2AA as libc::c_int > 0 as libc::c_int {
        (*this).unk_2AA -= 1;
        if (*this).unk_2AA as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6E9AC(mut this: *mut EnHs,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut yawDiff: s16 = 0;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if func_8002F368(globalCtx) as libc::c_int == 7 as libc::c_int {
            (*player).actor.textId = 0x10b2 as libc::c_int as u16_0;
            func_80A6E3A0(this,
                          Some(func_80A6E8CC as
                                   unsafe extern "C" fn(_: *mut EnHs,
                                                        _: *mut GlobalContext)
                                       -> ()));
            Animation_Change(&mut (*this).skelAnime,
                             &mut object_hs_Anim_000304, 1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut object_hs_Anim_000304
                                                        as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
                             ANIMMODE_LOOP as libc::c_int as u8_0, 8.0f32);
            (*this).unk_2AA = 40 as libc::c_int as s16;
            func_80078884(0x4807 as libc::c_int as u16_0);
        } else {
            (*player).actor.textId = 0x10b1 as libc::c_int as u16_0;
            func_80A6E3A0(this,
                          Some(func_80A6E6D8 as
                                   unsafe extern "C" fn(_: *mut EnHs,
                                                        _: *mut GlobalContext)
                                       -> ()));
        }
        ...
        yawDiff =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        (*this).actor.textId = 0x10b1 as libc::c_int as u16_0;
        if (if yawDiff as libc::c_int >= 0 as libc::c_int {
                yawDiff as libc::c_int
            } else { -(yawDiff as libc::c_int) }) <= 0x2150 as libc::c_int &&
               (*this).actor.xzDistToPlayer < 100.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHs_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs = thisx as *mut EnHs;
    let mut pad: s32 = 0;
    ...
    if (*this).unk_2A8 as libc::c_int & 1 as libc::c_int != 0 {
        ...
        Math_SmoothStepToS(&mut (*this).unk_29C.x,
...
#[no_mangle]
pub unsafe extern "C" fn EnHs_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    match limbIndex {
        9 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_29C.y as libc::c_int)
                    as s16;
            (*rot).z =
                ((*rot).z as libc::c_int + (*this).unk_29C.x as libc::c_int)
                    as s16
        }
        10 => { *dList = 0 as *mut Gfx; return 0 as libc::c_int }
        11 => { *dList = 0 as *mut Gfx; return 0 as libc::c_int }
        12 => {
            if (*this).actor.params as libc::c_int == 1 as libc::c_int {
                *dList = 0 as *mut Gfx;
                return 0 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnHs_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut D_80A6EDFC: Vec3f =
        { let mut init = Vec3f{x: 300.0f32, y: 1000.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnHs = thisx as *mut EnHs;
    if limbIndex == 9 as libc::c_int {
        Matrix_MultVec3f(&mut D_80A6EDFC, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHs_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs = thisx as *mut EnHs;
