...
extern "C" {
    ...
    #[no_mangle]
    static mut gFieldBushDL: [Gfx; 0];
    #[no_mangle]
    static mut object_kusa_DL_000140: [Gfx; 0];
    #[no_mangle]
    static mut object_kusa_DL_0002E0: [Gfx; 0];
}
...
pub struct EnKusa {
    pub actor: Actor,
    pub actionFunc: EnKusaActionFunc,
    pub collider: ColliderCylinder,
    pub timer: s16,
    pub objBankIndex: s8,
}
pub type EnKusaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKusa, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const ENKUSA_TYPE_2: C2RustUnnamed_23 = 2;
pub const ENKUSA_TYPE_1: C2RustUnnamed_23 = 1;
pub const ENKUSA_TYPE_0: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_24 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_24 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_24 = -1;
static mut rotSpeedXtarget: s16 = 0 as libc::c_int as s16;
static mut rotSpeedX: s16 = 0 as libc::c_int as s16;
static mut rotSpeedYtarget: s16 = 0 as libc::c_int as s16;
static mut rotSpeedY: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut En_Kusa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KUSA as libc::c_int as s16,
...
static mut sObjectIds: [s16; 3] =
    [OBJECT_GAMEPLAY_FIELD_KEEP as libc::c_int as s16,
     OBJECT_KUSA as libc::c_int as s16, OBJECT_KUSA as libc::c_int as s16];
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 0 as libc::c_int as u8_0,
                                   ...
                                   cylHeight: 30 as libc::c_int as s16,
                                   mass: 0xff as libc::c_int as u8_0,};
        init
    };
static mut sUnitDirections: [Vec3f; 4] =
    [{ let mut init = Vec3f{x: 0.0f32, y: 0.7071f32, z: 0.7071f32,}; init },
     { let mut init = Vec3f{x: 0.7071f32, y: 0.7071f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.7071f32, z: -0.7071f32,}; init },
     { let mut init = Vec3f{x: -0.7071f32, y: 0.7071f32, z: 0.0f32,}; init }];
static mut sFragmentScales: [s16; 8] =
    [108 as libc::c_int as s16, 102 as libc::c_int as s16,
     96 as libc::c_int as s16, 84 as libc::c_int as s16,
     66 as libc::c_int as s16, 55 as libc::c_int as s16,
     42 as libc::c_int as s16, 38 as libc::c_int as s16];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 6] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 6];
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupAction(mut this: *mut EnKusa,
                                            mut actionFunc:
                                                EnKusaActionFunc) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SnapToFloor(mut this: *mut EnKusa,
                                            mut globalCtx: *mut GlobalContext,
                                            mut yOffset: f32_0) -> s32 {
    let mut pad: s32 = 0;
    ...
    pos.y = (*this).actor.world.pos.y + 30.0f32;
    pos.z = (*this).actor.world.pos.z;
    floorY =
        BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx, &mut poly,
                                    &mut bgId, &mut (*this).actor, &mut pos);
    if floorY > -32000.0f32 {
        ...
        osSyncPrintf(b"\xe5\x9c\xb0\xe9\x9d\xa2\xe3\x81\xab\xe4\xbb\x98\xe7\x9d\x80\xe5\xa4\xb1\xe6\x95\x97(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_en_kusa.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_DropCollectible(mut this: *mut EnKusa,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_UpdateVelY(mut this: *mut EnKusa) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_RandScaleVecToZero(mut vec: *mut Vec3f,
                                                   mut scale: f32_0) {
    scale += (Rand_ZeroOne() * 0.2f32 - 0.1f32) * scale;
    (*vec).x -= (*vec).x * scale;
    (*vec).y -= (*vec).y * scale;
    (*vec).z -= (*vec).z * scale;
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetScaleSmall(mut this: *mut EnKusa) {
    (*this).actor.scale.y = 0.16000001f32;
    (*this).actor.scale.x = 0.120000005f32;
    (*this).actor.scale.z = 0.120000005f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SpawnFragments(mut this: *mut EnKusa,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    let mut scaleIndex: s32 = 0;
    let mut dir: *mut Vec3f = 0 as *mut Vec3f;
    let mut pad: s32 = 0;
    i = 0 as libc::c_int;
    while i <
        ...
        dir =
            &mut *sUnitDirections.as_mut_ptr().offset(i as isize) as
                *mut Vec3f;
        pos.x =
            (*this).actor.world.pos.x +
                (*dir).x * (*this).actor.scale.x * 20.0f32;
        pos.y =
            (*this).actor.world.pos.y +
                (*dir).y * (*this).actor.scale.y * 20.0f32 + 10.0f32;
        pos.z =
            (*this).actor.world.pos.z +
                (*dir).z * (*this).actor.scale.z * 20.0f32;
        velocity.x = (Rand_ZeroOne() - 0.5f32) * 8.0f32;
        velocity.y = Rand_ZeroOne() * 10.0f32;
        velocity.z = (Rand_ZeroOne() - 0.5f32) * 8.0f32;
        scaleIndex = (Rand_ZeroOne() * 111.1f32) as s32 & 7 as libc::c_int;
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             ...
                             sFragmentScales[scaleIndex as usize],
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             80 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                             gCuttableShrubStalkDL.as_mut_ptr());
        pos.x =
            (*this).actor.world.pos.x +
                (*dir).x * (*this).actor.scale.x * 40.0f32;
        pos.y =
            (*this).actor.world.pos.y +
                (*dir).y * (*this).actor.scale.y * 40.0f32 + 10.0f32;
        pos.z =
            (*this).actor.world.pos.z +
                (*dir).z * (*this).actor.scale.z * 40.0f32;
        velocity.x = (Rand_ZeroOne() - 0.5f32) * 6.0f32;
        velocity.y = Rand_ZeroOne() * 10.0f32;
        velocity.z = (Rand_ZeroOne() - 0.5f32) * 6.0f32;
        scaleIndex = (Rand_ZeroOne() * 111.1f32) as s32 % 7 as libc::c_int;
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             -(100 as libc::c_int) as s16,
                             64 as libc::c_int as s16,
                             ...
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                             gCuttableShrubTipDL.as_mut_ptr());
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SpawnBugs(mut this: *mut EnKusa,
                                          mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        let mut bug: *mut Actor =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        (Rand_ZeroOne() *
                             0xffff as libc::c_int as libc::c_float) as s16,
                        0 as libc::c_int as s16, 1 as libc::c_int as s16);
        if bug.is_null() { break ; }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_InitCollider(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnKusa = thisx as *mut EnKusa;
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKusa = thisx as *mut EnKusa;
    ...
    if (*this).actor.shape.rot.y as libc::c_int == 0 as libc::c_int {
        let mut rand: s16 =
            Rand_ZeroFloat(0x10000 as libc::c_int as f32_0) as s16;
        (*this).actor.world.rot.y = rand;
        (*this).actor.home.rot.y = rand;
        (*this).actor.shape.rot.y = rand
    }
    if EnKusa_SnapToFloor(this, globalCtx, 0.0f32) == 0 {
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        sObjectIds[((*thisx).params as libc::c_int &
                                        3 as libc::c_int) as usize]) as s8;
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Destroy(mut thisx: *mut Actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupWaitObject(mut this: *mut EnKusa) {
    EnKusa_SetupAction(this,
                       Some(EnKusa_WaitObject as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_WaitObject(mut this: *mut EnKusa,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupMain(mut this: *mut EnKusa) {
    EnKusa_SetupAction(this,
                       Some(EnKusa_Main as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Main(mut this: *mut EnKusa,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        if (*this).collider.base.ocFlags1 as libc::c_int &
               ...
               (*this).actor.xzDistToPlayer > 12.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupLiftedUp(mut this: *mut EnKusa) {
    EnKusa_SetupAction(this,
                       Some(EnKusa_LiftedUp as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
                                    -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_LiftedUp(mut this: *mut EnKusa,
                                         mut globalCtx: *mut GlobalContext) {
    if Actor_HasNoParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        (*this).actor.colChkInfo.mass = 240 as libc::c_int as u8_0;
        (*this).actor.gravity = -0.1f32;
        EnKusa_UpdateVelY(this);
        EnKusa_RandScaleVecToZero(&mut (*this).actor.velocity, 0.005f32);
        func_8002D7EC(&mut (*this).actor);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 7.5f32,
                                35.0f32, 0.0f32, 0xc5 as libc::c_int);
        (*this).actor.gravity = -3.2f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupFall(mut this: *mut EnKusa) {
    EnKusa_SetupAction(this,
                       Some(EnKusa_Fall as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
                                    -> ()));
    rotSpeedXtarget = -(0xbb8 as libc::c_int) as s16;
    rotSpeedYtarget = ((Rand_ZeroOne() - 0.5f32) * 1600.0f32) as s16;
    rotSpeedX = 0 as libc::c_int as s16;
    rotSpeedY = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Fall(mut this: *mut EnKusa,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut contactPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).actor.bgCheckFlags as libc::c_int & 0xb as libc::c_int != 0 {
        ...
        EnKusa_DropCollectible(this, globalCtx);
        match (*this).actor.params as libc::c_int & 3 as libc::c_int {
            0 | 2 => { Actor_Kill(&mut (*this).actor); }
            1 => { EnKusa_SetupUprootedWaitRegrow(this); }
            _ => { }
        }
        return
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int != 0 {
        ...
        EffectSsGSplash_Spawn(globalCtx, &mut contactPos,
                              0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                              0 as libc::c_int as s16,
                              400 as libc::c_int as s16);
        EffectSsGRipple_Spawn(globalCtx, &mut contactPos,
        ...
        (*this).actor.minVelocityY = -3.0f32;
        rotSpeedX = (rotSpeedX as libc::c_int >> 1 as libc::c_int) as s16;
        rotSpeedXtarget =
            (rotSpeedXtarget as libc::c_int >> 1 as libc::c_int) as s16;
        rotSpeedY = (rotSpeedY as libc::c_int >> 1 as libc::c_int) as s16;
        rotSpeedYtarget =
            (rotSpeedYtarget as libc::c_int >> 1 as libc::c_int) as s16;
    ...
    EnKusa_UpdateVelY(this);
    Math_StepToS(&mut rotSpeedX, rotSpeedXtarget,
                 0x1f4 as libc::c_int as s16);
    Math_StepToS(&mut rotSpeedY, rotSpeedYtarget, 0xaa as libc::c_int as s16);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + rotSpeedX as libc::c_int)
            as s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + rotSpeedY as libc::c_int)
            as s16;
    EnKusa_RandScaleVecToZero(&mut (*this).actor.velocity, 0.05f32);
    func_8002D7EC(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 7.5f32, 35.0f32,
                            0.0f32, 0xc5 as libc::c_int);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider.base);
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupCut(mut this: *mut EnKusa) {
    match (*this).actor.params as libc::c_int & 3 as libc::c_int {
        2 => {
            EnKusa_SetupAction(this,
                               Some(EnKusa_DoNothing as
                                        unsafe extern "C" fn(_: *mut EnKusa,
                                                             _:
                                                                 *mut GlobalContext)
                                            -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_CutWaitRegrow(mut this: *mut EnKusa,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_DoNothing(mut this: *mut EnKusa,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupUprootedWaitRegrow(mut this:
                                                            *mut EnKusa) {
    (*this).actor.world.pos.x = (*this).actor.home.pos.x;
    (*this).actor.world.pos.y = (*this).actor.home.pos.y - 9.0f32;
    (*this).actor.world.pos.z = (*this).actor.home.pos.z;
    EnKusa_SetScaleSmall(this);
    (*this).actor.shape.rot = (*this).actor.home.rot;
    EnKusa_SetupAction(this,
                       Some(EnKusa_UprootedWaitRegrow as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_UprootedWaitRegrow(mut this: *mut EnKusa,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if (*this).timer as libc::c_int > 120 as libc::c_int {
        if Math_StepToF(&mut (*this).actor.world.pos.y,
                        (*this).actor.home.pos.y, 0.6f32) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_SetupRegrow(mut this: *mut EnKusa) {
    EnKusa_SetupAction(this,
                       Some(EnKusa_Regrow as
                                unsafe extern "C" fn(_: *mut EnKusa,
                                                     _: *mut GlobalContext)
                                    -> ()));
    EnKusa_SetScaleSmall(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Regrow(mut this: *mut EnKusa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut isFullyGrown: s32 = 1 as libc::c_int;
    isFullyGrown &=
        Math_StepToF(&mut (*this).actor.scale.y, 0.4f32, 0.014f32);
    isFullyGrown &=
        Math_StepToF(&mut (*this).actor.scale.x, 0.4f32, 0.011f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKusa = thisx as *mut EnKusa;
    (*this).timer += 1;
    ...
    if (*this).actor.flags &
           ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint != 0 {
        (*this).actor.shape.yOffset = -6.25f32
    } else { (*this).actor.shape.yOffset = 0.0f32 };
}
#[no_mangle]
pub unsafe extern "C" fn EnKusa_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 3] =
        unsafe {
            [gFieldBushDL.as_ptr() as *mut _,
             object_kusa_DL_000140.as_ptr() as *mut _,
             object_kusa_DL_000140.as_ptr() as *mut _]
        };
    let mut this: *mut EnKusa = thisx as *mut EnKusa;
    if (*this).actor.flags &
           ((1 as libc::c_int) << 11 as libc::c_int) as libc::c_uint != 0 {
        Gfx_DrawDListOpa(globalCtx, object_kusa_DL_0002E0.as_mut_ptr());
    } else {
        Gfx_DrawDListOpa(globalCtx,
                         dLists[((*thisx).params as libc::c_int &
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(-(17000 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneDownward as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(120 as libc::c_int);
             init
         }]
}
#[used]
