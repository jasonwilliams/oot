...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriHashigoLadderDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriHashigoCol: CollisionHeader;
    #[no_mangle]
    static mut gMoriHashigoClaspDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriHashigo {
    pub dyna: DynaPolyActor,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub actionFunc: BgMoriHashigoActionFunc,
    pub hitTimer: s16,
    pub bounceCounter: s16,
    pub moriTexObjIndex: s8,
}
pub type BgMoriHashigoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriHashigo, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_int;
pub const HASHIGO_LADDER: C2RustUnnamed_22 = 0;
pub const HASHIGO_CLASP: C2RustUnnamed_22 = -1;
#[no_mangle]
pub static mut Bg_Mori_Hashigo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_HASHIGO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriHashigo>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashigo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashigo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashigo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sInitChainClasp: [InitChainEntry; 6] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 6];
// Initialized in run_static_initializers
static mut sInitChainLadder: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_InitDynapoly(mut this:
                                                        *mut BgMoriHashigo,
                                                    mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_mori_hashigo.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_InitCollider(mut this:
                                                        *mut BgMoriHashigo,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SpawnLadder(mut this:
                                                       *mut BgMoriHashigo,
                                                   mut globalCtx:
                                                       *mut GlobalContext)
 -> s32 {
    ...
    let mut ladder: *mut Actor = 0 as *mut Actor;
    cs = Math_CosS((*this).dyna.actor.shape.rot.y);
    sn = Math_SinS((*this).dyna.actor.shape.rot.y);
    pos.x = 6.0f32 * sn + (*this).dyna.actor.world.pos.x;
    pos.y = -210.0f32 + (*this).dyna.actor.world.pos.y;
    pos.z = 6.0f32 * cs + (*this).dyna.actor.world.pos.z;
    ladder =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_BG_MORI_HASHIGO as libc::c_int as s16, pos.x,
                           pos.y, pos.z, (*this).dyna.actor.world.rot.x,
    ...
    if !ladder.is_null() {
        ...
        // "Ladder failure"
        osSyncPrintf(b"Error : \xe6\xa2\xaf\xe5\xad\x90\xe3\x81\xae\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_mori_hashigo.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_InitClasp(mut this: *mut BgMoriHashigo,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> s32 {
    Actor_ProcessInitChain(&mut (*this).dyna.actor,
                           sInitChainClasp.as_mut_ptr());
    (*this).dyna.actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Actor_SetFocus(&mut (*this).dyna.actor, 55.0f32);
    BgMoriHashigo_InitCollider(this, globalCtx);
    if (*this).dyna.actor.params as libc::c_int ==
           HASHIGO_CLASP as libc::c_int &&
           BgMoriHashigo_SpawnLadder(this, globalCtx) == 0 {
        return 0 as libc::c_int
    } else { return 1 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_InitLadder(mut this:
                                                      *mut BgMoriHashigo,
                                                  mut globalCtx:
                                                      *mut GlobalContext)
 -> s32 {
    BgMoriHashigo_InitDynapoly(this, globalCtx, &mut gMoriHashigoCol,
                               DPM_UNK as libc::c_int);
    Actor_ProcessInitChain(&mut (*this).dyna.actor,
                           sInitChainLadder.as_mut_ptr());
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashigo = thisx as *mut BgMoriHashigo;
    if (*this).dyna.actor.params as libc::c_int ==
           HASHIGO_CLASP as libc::c_int {
        if BgMoriHashigo_InitClasp(this, globalCtx) == 0 {
            Actor_Kill(&mut (*this).dyna.actor);
            return
        }
    } else if (*this).dyna.actor.params as libc::c_int ==
                  HASHIGO_LADDER as libc::c_int {
        if BgMoriHashigo_InitLadder(this, globalCtx) == 0 {
            Actor_Kill(&mut (*this).dyna.actor);
            return
        }
    }
    ...
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        ...
        osSyncPrintf(b"(\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf \xe6\xa2\xaf\xe5\xad\x90\xe3\x81\xa8\xe3\x81\x9d\xe3\x81\xae\xe7\x95\x99\xe3\x82\x81\xe9\x87\x91)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashigo = thisx as *mut BgMoriHashigo;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SetupWaitForMoriTex(mut this:
                                                               *mut BgMoriHashigo) {
    (*this).actionFunc =
        Some(BgMoriHashigo_WaitForMoriTex as
                 unsafe extern "C" fn(_: *mut BgMoriHashigo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_WaitForMoriTex(mut this:
                                                          *mut BgMoriHashigo,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        (*this).dyna.actor.draw =
            Some(BgMoriHashigo_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SetupClasp(mut this:
                                                      *mut BgMoriHashigo) {
    (*this).actionFunc =
        Some(BgMoriHashigo_Clasp as
                 unsafe extern "C" fn(_: *mut BgMoriHashigo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_Clasp(mut this: *mut BgMoriHashigo,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if (*this).hitTimer as libc::c_int <= 0 as libc::c_int {
        if (*this).collider.base.acFlags as libc::c_int &
            ...
            (*this).hitTimer = 10 as libc::c_int as s16
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SetupLadderWait(mut this:
                                                           *mut BgMoriHashigo) {
    (*this).actionFunc =
        Some(BgMoriHashigo_LadderWait as
                 unsafe extern "C" fn(_: *mut BgMoriHashigo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_LadderWait(mut this:
                                                      *mut BgMoriHashigo,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut clasp: *mut BgMoriHashigo =
        (*this).dyna.actor.parent as *mut BgMoriHashigo;
    if (*clasp).hitTimer as libc::c_int > 0 as libc::c_int {
        BgMoriHashigo_SetupLadderFall(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SetupLadderFall(mut this:
                                                           *mut BgMoriHashigo) {
    (*this).bounceCounter = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(BgMoriHashigo_LadderFall as
                 unsafe extern "C" fn(_: *mut BgMoriHashigo,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.gravity = -1.0f32;
    (*this).dyna.actor.minVelocityY = -10.0f32;
    (*this).dyna.actor.velocity.y = 2.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_LadderFall(mut this:
                                                      *mut BgMoriHashigo,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    static mut bounceSpeed: [f32_0; 3] = [4.0f32, 2.7f32, 1.7f32];
    ...
    if (*thisx).bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
        ...
        if (*this).bounceCounter as libc::c_int >=
               (::std::mem::size_of::<[f32_0; 3]>() as
            ...
            Actor_UpdateBgCheckInfo(globalCtx, thisx, 0.0f32, 0.0f32, 0.0f32,
                                    0x1c as libc::c_int);
            (*thisx).velocity.y = bounceSpeed[(*this).bounceCounter as usize];
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_SetupLadderRest(mut this:
                                                           *mut BgMoriHashigo) {
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashigo = thisx as *mut BgMoriHashigo;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashigo_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashigo = thisx as *mut BgMoriHashigo;
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gMoriHashigoClaspDL.as_mut_ptr() as libc::c_uint
        }
        0 => {
            ...
            (*_g_2).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                gMoriHashigoLadderDL.as_mut_ptr() as libc::c_uint
        }
        _ => { }
    }
