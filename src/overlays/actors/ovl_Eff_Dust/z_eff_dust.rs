...
pub struct EffDust {
    pub actor: Actor,
    pub distanceTraveled: [f32_0; 64],
    pub initialPositions: [Vec3f; 64],
    pub index: u8_0,
    pub life: u8_0,
    pub dx: f32_0,
    pub dy: f32_0,
    pub dz: f32_0,
    pub scalingFactor: f32_0,
    pub actionFunc: EffDustActionFunc,
    pub drawFunc: EffDustDrawFunc,
}
pub type EffDustDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext) -> ()>;
pub type EffDustActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EffDust, _: *mut GlobalContext)
               -> ()>;
pub type EffDustType = libc::c_uint;
pub const EFF_DUST_TYPE_4: EffDustType = 4;
pub const EFF_DUST_TYPE_3: EffDustType = 3;
pub const EFF_DUST_TYPE_2: EffDustType = 2;
pub const EFF_DUST_TYPE_1: EffDustType = 1;
pub const EFF_DUST_TYPE_0: EffDustType = 0;
#[no_mangle]
pub static mut Eff_Dust_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EFF_DUST as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EffDust_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EffDust_SetupAction(mut this: *mut EffDust,
                                             mut actionFunc:
                                                 EffDustActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_SetupDraw(mut this: *mut EffDust,
                                           mut drawFunc: EffDustDrawFunc) {
    (*this).drawFunc = drawFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_InitPosAndDistance(mut this: *mut EffDust) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        (*this).initialPositions[i as usize].z = 0.0f32;
        (*this).initialPositions[i as usize].y = 0.0f32;
        (*this).initialPositions[i as usize].x = 0.0f32;
        (*this).distanceTraveled[i as usize] = 1.0f32;
        i += 1
    }
    (*this).index = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EffDust = thisx as *mut EffDust;
    let mut dustEffect: EffDustType = (*this).actor.params as EffDustType;
    EffDust_InitPosAndDistance(this);
    match dustEffect as libc::c_uint {
        0 => {
            EffDust_SetupAction(this,
                                Some(EffDust_UpdateFunc_8099DB28 as
                                         unsafe extern "C" fn(_: *mut EffDust,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
            EffDust_SetupDraw(this,
                              Some(EffDust_DrawFunc_8099E4F4 as
            ...
            (*this).dz = 0.8f32;
            (*this).dx = 1.0f32;
            (*this).scalingFactor = 0.1f32
        }
        1 => {
            EffDust_SetupAction(this,
                                Some(EffDust_UpdateFunc_8099DD74 as
                                         unsafe extern "C" fn(_: *mut EffDust,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
            ...
            (*this).dz = 0.8f32;
            (*this).dy = 1.0f32;
            (*this).scalingFactor = 0.5f32
        }
        2 => {
            EffDust_SetupAction(this,
                                Some(EffDust_UpdateFunc_8099DFC0 as
                                         unsafe extern "C" fn(_: *mut EffDust,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
            EffDust_SetupDraw(this,
                              Some(EffDust_DrawFunc_8099E784 as
                                       unsafe extern "C" fn(_: *mut Actor,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
            (*this).dx = 0.5f32;
            (*this).scalingFactor = 15.0f32
        }
        3 => {
            EffDust_SetupAction(this,
                                Some(EffDust_UpdateFunc_8099DFC0 as
        ...
        4 => {
            ...
            (*this).dx = 0.5f32;
            (*this).scalingFactor = 20.0f32
        }
        _ => {
            SystemArena_FreeDebug(this as *mut libc::c_void,
                                  b"../z_eff_dust.c\x00" as *const u8 as
                                      *const libc::c_char,
                                  202 as libc::c_int);
        }
    }
    (*this).life = 10 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_UpdateFunc_8099DB28(mut this: *mut EffDust,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut theta: s16 = 0;
    let mut fi: s16 = 0;
    let mut distanceTraveled: *mut f32_0 =
        (*this).distanceTraveled.as_mut_ptr();
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        if *distanceTraveled < 1.0f32 { *distanceTraveled += 0.05f32 }
        distanceTraveled = distanceTraveled.offset(1);
        i += 1
    }
    j = 0 as libc::c_int;
    while j < 3 as libc::c_int {
        i = (*this).index as libc::c_int & 0x3f as libc::c_int;
        if (*this).distanceTraveled[i as usize] >= 1.0f32 {
            // Spherical coordinate system.
            fi = Rand_CenteredFloat(8192.0f32) as s16;
            theta = Rand_CenteredFloat(4096.0f32) as s16;
            (*this).initialPositions[i as usize].x =
                -800.0f32 * Math_CosS(fi) * Math_CosS(theta);
            (*this).initialPositions[i as usize].y =
                -800.0f32 * Math_SinS(theta);
            (*this).initialPositions[i as usize].z =
                -800.0f32 * Math_SinS(fi) * Math_CosS(theta);
            (*this).distanceTraveled[i as usize] = 0.0f32;
            (*this).index =
                ((*this).index as libc::c_int + 1 as libc::c_int) as u8_0
        }
        j += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_UpdateFunc_8099DD74(mut this: *mut EffDust,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut theta: s16 = 0;
    let mut fi: s16 = 0;
    ...
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        if *distanceTraveled < 1.0f32 { *distanceTraveled += 0.03f32 }
        distanceTraveled = distanceTraveled.offset(1);
        i += 1
    }
    j = 0 as libc::c_int;
    while j < 2 as libc::c_int {
        ...
        if (*this).distanceTraveled[i as usize] >= 1.0f32 {
            // Spherical coordinate system.
            fi = Rand_CenteredFloat(65536.0f32) as s16;
            theta = Rand_ZeroFloat(8192.0f32) as s16;
            (*this).initialPositions[i as usize].x =
                400.0f32 * Math_CosS(fi) * Math_CosS(theta);
            (*this).initialPositions[i as usize].y =
                400.0f32 * Math_SinS(theta);
            (*this).initialPositions[i as usize].z =
                400.0f32 * Math_SinS(fi) * Math_CosS(theta);
            (*this).distanceTraveled[i as usize] = 0.0f32;
            (*this).index =
                ((*this).index as libc::c_int + 1 as libc::c_int) as u8_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn EffDust_UpdateFunc_8099DFC0(mut this: *mut EffDust,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut theta: s16 = 0;
    ...
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    if parent.is_null() || (*parent).update.is_none() ||
           (*player).stateFlags1 & 0x1000 as libc::c_int as libc::c_uint == 0
       {
        if (*this).life as libc::c_int != 0 as libc::c_int {
            (*this).life =
                ((*this).life as libc::c_int - 1 as libc::c_int) as u8_0
        } else { Actor_Kill(&mut (*this).actor); }
        i = 0 as libc::c_int;
        while i < 64 as libc::c_int {
            if *distanceTraveled < 1.0f32 { *distanceTraveled += 0.2f32 }
            distanceTraveled = distanceTraveled.offset(1);
            i += 1
        }
        return
    ...
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        if *distanceTraveled < 1.0f32 { *distanceTraveled += 0.1f32 }
        distanceTraveled = distanceTraveled.offset(1);
        i += 1
    }
    ...
    while j < 3 as libc::c_int {
        i = (*this).index as libc::c_int & 0x3f as libc::c_int;
        if (*this).distanceTraveled[i as usize] >= 1.0f32 {
            theta = Rand_CenteredFloat(65536.0f32) as s16;
            match (*this).actor.params as libc::c_int {
                2 => {
                    (*this).initialPositions[i as usize].x =
                        Rand_ZeroOne() * 4500.0f32 + 700.0f32;
                    if (*this).initialPositions[i as usize].x > 3000.0f32 {
                        (*this).initialPositions[i as usize].y =
                            3000.0f32 * Rand_ZeroOne() * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            3000.0f32 * Rand_ZeroOne() * Math_CosS(theta)
                    } else {
                        (*this).initialPositions[i as usize].y =
                            3000.0f32 * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            3000.0f32 * Math_CosS(theta)
                    }
                }
                3 => {
                    (*this).initialPositions[i as usize].x =
                        Rand_ZeroOne() * 2500.0f32 + 700.0f32;
                    if (*this).initialPositions[i as usize].x > 2000.0f32 {
                        (*this).initialPositions[i as usize].y =
                            2000.0f32 * Rand_ZeroOne() * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            2000.0f32 * Rand_ZeroOne() * Math_CosS(theta)
                    } else {
                        (*this).initialPositions[i as usize].y =
                            2000.0f32 * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            2000.0f32 * Math_CosS(theta)
                    }
                }
                4 => {
                    (*this).initialPositions[i as usize].x =
                        Rand_ZeroOne() * 8500.0f32 + 1700.0f32;
                    if (*this).initialPositions[i as usize].x > 5000.0f32 {
                        (*this).initialPositions[i as usize].y =
                            4000.0f32 * Rand_ZeroOne() * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            4000.0f32 * Rand_ZeroOne() * Math_CosS(theta)
                    } else {
                        (*this).initialPositions[i as usize].y =
                            4000.0f32 * Math_SinS(theta);
                        (*this).initialPositions[i as usize].z =
                            4000.0f32 * Math_CosS(theta)
                    }
                }
                _ => { }
            }
...
#[no_mangle]
pub unsafe extern "C" fn EffDust_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EffDust = thisx as *mut EffDust;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EffDust_DrawFunc_8099E4F4(mut thisx: *mut Actor,
                                                   mut globalCtx2:
                                                       *mut GlobalContext) {
    let mut this: *mut EffDust = thisx as *mut EffDust;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut initialPositions: *mut Vec3f = 0 as *mut Vec3f;
    let mut distanceTraveled: *mut f32_0 = 0 as *mut f32_0;
    let mut i: s32 = 0;
    let mut aux: f32_0 = 0.;
    ...
    (*_g_1).words.w1 =
        (128 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    initialPositions = (*this).initialPositions.as_mut_ptr();
    distanceTraveled = (*this).distanceTraveled.as_mut_ptr();
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = sEmptyDL.as_mut_ptr() as libc::c_uint;
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        if *distanceTraveled < 1.0f32 {
            aux = 1.0f32 - *distanceTraveled * *distanceTraveled;
            ...
            Matrix_Scale((*this).scalingFactor, (*this).scalingFactor,
                         (*this).scalingFactor,
            ...
            (*_g_4).words.w1 =
                gSegments[((gEffSparklesDL.as_mut_ptr() as u32_0) <<
                              ...
                              usize].wrapping_add(gEffSparklesDL.as_mut_ptr()
                                                      as u32_0 &
        ...
        initialPositions = initialPositions.offset(1);
        distanceTraveled = distanceTraveled.offset(1);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EffDust_DrawFunc_8099E784(mut thisx: *mut Actor,
                                                   mut globalCtx2:
                                                       *mut GlobalContext) {
    let mut this: *mut EffDust = thisx as *mut EffDust;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    ...
    (*_g_3).words.w0 =
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = sEmptyDL.as_mut_ptr() as libc::c_uint;
    i = 0 as libc::c_int;
    while i < 64 as libc::c_int {
        if *distanceTraveled < 1.0f32 {
                ...
                (255 as libc::c_int as u32_0 &
                    ...
                    (255 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    ((*distanceTraveled * 255 as libc::c_int as libc::c_float)
                         as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            ...
            Matrix_Mult(&mut (*player).mf_9E0,
                        MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_Translate((*initialPositions).x *
                                 ((*this).dx * aux + (1.0f32 - (*this).dx)),
                             (*initialPositions).y *
                                 (1.0f32 - *distanceTraveled) + 320.0f32,
                             (*initialPositions).z *
                                 (1.0f32 - *distanceTraveled) + -20.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn EffDust_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EffDust = thisx as *mut EffDust;
    (*this).drawFunc.expect("non-null function pointer")(thisx, globalCtx);
}
