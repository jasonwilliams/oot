...
extern "C" {
    ...
    #[no_mangle]
    static mut object_stream_DL_000950: [Gfx; 0];
}
...
pub struct EnStream {
    pub actor: Actor,
    pub actionFunc: EnStreamActionFunc,
    pub unk_150: s32,
    pub unk_154: [libc::c_char; 4],
}
pub type EnStreamActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnStream, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Stream_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_STREAM as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_STREAM as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnStream>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnStream_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnStream_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnStream_SetupAction(mut this: *mut EnStream,
                                              mut actionFunc:
                                                  EnStreamActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnStream_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnStream = thisx as *mut EnStream;
    (*this).unk_150 = (*thisx).params as libc::c_int & 0xff as libc::c_int;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    if (*this).unk_150 != 0 as libc::c_int &&
           (*this).unk_150 == 1 as libc::c_int {
        (*thisx).scale.y = 0.01f32
    }
    EnStream_SetupAction(this,
                         Some(EnStream_WaitForPlayer as
                                  unsafe extern "C" fn(_: *mut EnStream,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnStream_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
}
// Checks if the player is in range of the vortex
#[no_mangle]
pub unsafe extern "C" fn func_80B0B81C(mut vortexPosRot: *mut Vec3f,
                                       mut playerPosRot: *mut Vec3f,
                                       mut posDifference: *mut Vec3f,
                                       mut vortexYScale: f32_0) -> s32 {
    let mut ret: s32 = 0 as libc::c_int;
    let mut smallConstant: f32_0 = 28.0f32;
    let mut upperBounds: f32_0 =
        160 as libc::c_int as libc::c_float * vortexYScale * 50.0f32;
    let mut lowerBounds: f32_0 =
        0 as libc::c_int as libc::c_float * vortexYScale * 50.0f32;
    let mut xzDist: f32_0 = 0.;
    let mut range: f32_0 = 0.;
    ...
    xzDist =
        sqrtf((*posDifference).x * (*posDifference).x +
                  (*posDifference).z * (*posDifference).z);
    if lowerBounds <= (*posDifference).y && (*posDifference).y <= upperBounds
       {
        (*posDifference).y -= lowerBounds;
        range =
            (75.0f32 - smallConstant) *
                ((*posDifference).y / (upperBounds - lowerBounds)) + 28.0f32;
        if xzDist <= range { ret = 1 as libc::c_int }
    }
    if (*posDifference).y <= lowerBounds && xzDist <= 28.0f32 {
        ret = 2 as libc::c_int
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn EnStream_SuckPlayer(mut this: *mut EnStream,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    let mut pad48: s32 = 0;
    let mut posDifference: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut xzDist: f32_0 = 0.;
    let mut yDistWithOffset: f32_0 = 0.;
    let mut pad30: s32 = 0;
    let mut pad2C: s32 = 0;
    if func_80B0B81C(&mut (*this).actor.world.pos,
                     &mut (*player).actor.world.pos, &mut posDifference,
                     (*this).actor.scale.y) != 0 as libc::c_int {
        xzDist =
            sqrtf(posDifference.x * posDifference.x +
                      posDifference.z * posDifference.z);
        yDistWithOffset =
            (*player).actor.world.pos.y -
                ((*this).actor.world.pos.y - 90.0f32);
        (*player).windDirection =
            (Math_FAtan2F(-posDifference.x, -posDifference.z) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        if xzDist > 3.0f32 {
            Math_SmoothStepToF(&mut (*player).windSpeed, 3.0f32, 0.5f32,
                               xzDist, 0.0f32);
        } else {
            (*player).windSpeed = 0.0f32;
            Math_SmoothStepToF(&mut (*player).actor.world.pos.x,
                               (*this).actor.world.pos.x, 0.5f32, 3.0f32,
                               0.0f32);
            Math_SmoothStepToF(&mut (*player).actor.world.pos.z,
                               (*this).actor.world.pos.z, 0.5f32, 3.0f32,
                               0.0f32);
        }
        if yDistWithOffset > 0.0f32 {
            Math_SmoothStepToF(&mut (*player).actor.velocity.y, -3.0f32,
                               0.7f32, yDistWithOffset, 0.0f32);
            if posDifference.y < -70.0f32 {
                (*player).stateFlags2 |= 0x80000000 as libc::c_uint
            }
        }
    } else {
        EnStream_SetupAction(this,
...
#[no_mangle]
pub unsafe extern "C" fn EnStream_WaitForPlayer(mut this: *mut EnStream,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if func_80B0B81C(&mut (*this).actor.world.pos,
                     &mut (*player).actor.world.pos, &mut temp,
                     (*this).actor.scale.y) != 0 as libc::c_int {
        EnStream_SetupAction(this,
                             Some(EnStream_SuckPlayer as
                                      unsafe extern "C" fn(_: *mut EnStream,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnStream_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnStream = thisx as *mut EnStream;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    func_8002F948(thisx,
                  (0x28dd as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnStream_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut multipliedFrames: u32_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_stream.c\x00" as *const u8 as
    ...
    multipliedFrames = frames.wrapping_mul(20 as libc::c_int as libc::c_uint);
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         frames.wrapping_mul(30 as libc::c_int as
                                                 libc::c_uint),
                         multipliedFrames.wrapping_neg(), 0x40 as libc::c_int,
                         0x40 as libc::c_int, 1 as libc::c_int,
                         multipliedFrames, multipliedFrames.wrapping_neg(),
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = object_stream_DL_000950.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_stream.c\x00" as *const u8 as
                         *const libc::c_char, 310 as libc::c_int);
}
