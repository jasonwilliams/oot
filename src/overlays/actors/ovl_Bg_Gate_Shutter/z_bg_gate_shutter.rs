...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoGuardGateDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoGuardGateCol: CollisionHeader;
}
...
pub type BgGateShutterActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut BgGateShutter, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Gate_Shutter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GATE_SHUTTER as libc::c_int as s16,
                          category:
                              ACTORCAT_ITEMACTION as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_SPOT01_MATOYAB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgGateShutter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGateShutter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGateShutter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGateShutter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGateShutter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGateShutter_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgGateShutter = thisx as *mut BgGateShutter;
    ...
    CollisionHeader_GetVirtual(&mut gKakarikoGuardGateCol as
    ...
    if (gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
           ...
           (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT01 as libc::c_int
       {
        (*thisx).world.pos.x = -89.0f32;
        (*thisx).world.pos.z = -1375.0f32
    }
    (*thisx).scale.x = 1.0f32;
    (*thisx).scale.y = 1.0f32;
    (*thisx).scale.z = 1.0f32;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9f\xb5\xe3\x81\xa7\xe3\x81\x9f\xe3\x81\xaa\xe3\x81\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).actionFunc =
        Some(func_8087828C as
                 unsafe extern "C" fn(_: *mut BgGateShutter,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgGateShutter_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgGateShutter = thisx as *mut BgGateShutter;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087828C(mut this: *mut BgGateShutter,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).openingState as libc::c_int == 1 as libc::c_int &&
           gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
               0x40 as libc::c_int == 0 {
        (*this).unk_178 = 2 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80878300 as
                     unsafe extern "C" fn(_: *mut BgGateShutter,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).openingState as libc::c_int == 2 as libc::c_int {
        (*this).unk_178 = 2 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80878300 as
                     unsafe extern "C" fn(_: *mut BgGateShutter,
                                          _: *mut GlobalContext) -> ())
    } else if ((*this).openingState as libc::c_int) < 0 as libc::c_int {
        (*this).unk_178 = 2 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_808783D4 as
                     unsafe extern "C" fn(_: *mut BgGateShutter,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80878300(mut this: *mut BgGateShutter,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if (*this).unk_178 as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(thisx,
                              (0x2867 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        (*thisx).world.pos.x -= 2.0f32;
        Math_ApproachF(&mut (*thisx).world.pos.z, -1375.0f32, 0.8f32, 0.3f32);
        if (*thisx).world.pos.x < -89.0f32 {
            Audio_PlayActorSound2(thisx, 0x280e as libc::c_int as u16_0);
            (*this).unk_178 = 0x1e as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_808783AC as
                         unsafe extern "C" fn(_: *mut BgGateShutter,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_808783AC(mut this: *mut BgGateShutter,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_178 as libc::c_int == 0 as libc::c_int {
        (*this).openingState = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8087828C as
                     unsafe extern "C" fn(_: *mut BgGateShutter,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_808783D4(mut this: *mut BgGateShutter,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if (*this).unk_178 as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(thisx,
                              (0x2867 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        (*thisx).world.pos.x += 2.0f32;
        Math_ApproachF(&mut (*thisx).world.pos.z, -1350.0f32, 0.8f32, 0.3f32);
        if (*thisx).world.pos.x > 90.0f32 {
            (*thisx).world.pos.x = 91.0f32;
            Audio_PlayActorSound2(thisx, 0x280e as libc::c_int as u16_0);
            (*this).unk_178 = 30 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_808783AC as
                         unsafe extern "C" fn(_: *mut BgGateShutter,
                                              _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgGateShutter_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgGateShutter = thisx as *mut BgGateShutter;
    if (*this).unk_178 as libc::c_int != 0 as libc::c_int {
        (*this).unk_178 =
            ((*this).unk_178 as libc::c_int - 1 as libc::c_int) as s16
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgGateShutter_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_gate_shutter.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gKakarikoGuardGateDL.as_mut_ptr() as libc::c_uint;
