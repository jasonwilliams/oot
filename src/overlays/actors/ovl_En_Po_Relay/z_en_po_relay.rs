...
extern "C" {
    #[no_mangle]
    fn Item_DropCollectible2(globalCtx: *mut GlobalContext,
    ...
    fn Actor_Spawn(actorCtx: *mut ActorContext, globalCtx: *mut GlobalContext,
     ...
     -> *mut Actor;
    #[no_mangle]
    fn Actor_SetTextWithPrefix(globalCtx: *mut GlobalContext,
                               actor: *mut Actor, textIdLower: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDampeFloatAnim: AnimationHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDampeLanternDL: [Gfx; 0];
    #[no_mangle]
    static mut gDampeHaloDL: [Gfx; 0];
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPoRelay {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnPoRelayActionFunc,
    pub hookshotSlotFull: u8_0,
    pub unk_195: u8_0,
    pub actionTimer: s16,
    pub pathIndex: s16,
    pub unk_19A: s16,
    pub textId: u16_0,
    pub eyeTextureIdx: u16_0,
...
pub type EnPoRelayActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPoRelay, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const HONOTRAP_FLAME_DROP: C2RustUnnamed_25 = 2;
pub const HONOTRAP_FLAME_MOVE: C2RustUnnamed_25 = 1;
pub const HONOTRAP_EYE: C2RustUnnamed_25 = 0;
static mut D_80AD8C30: [Vec3s; 28] =
    [{
         let mut init =
             Vec3s{x: 0xffc4 as libc::c_int as s16,
                   y: 0xfdee as libc::c_int as s16,
                   z: 0xf47a as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x186 as libc::c_int as s16,
                   y: 0xfe0c as libc::c_int as s16,
                   z: 0xf47a as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x186 as libc::c_int as s16,
                   y: 0xfe0c as libc::c_int as s16,
                   z: 0xf0f6 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xd2 as libc::c_int as s16,
                   y: 0xfdee as libc::c_int as s16,
                   z: 0xf0f6 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xd2 as libc::c_int as s16,
                   y: 0xfd9e as libc::c_int as s16,
                   z: 0xeeda as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x23a as libc::c_int as s16,
                   y: 0xfdc6 as libc::c_int as s16,
                   z: 0xeeda as libc::c_int as s16,};
         init
     },
     {
     ...
     },
     {
         let mut init =
             Vec3s{x: 0x23a as libc::c_int as s16,
                   y: 0xfdc6 as libc::c_int as s16,
                   z: 0xebb0 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x4ec as libc::c_int as s16,
                   y: 0xfd9e as libc::c_int as s16,
                   z: 0xebb0 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x672 as libc::c_int as s16,
                   y: 0xfd62 as libc::c_int as s16,
                   z: 0xed18 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x672 as libc::c_int as s16,
                   y: 0xfd30 as libc::c_int as s16,
                   z: 0xee80 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x7da as libc::c_int as s16,
                   y: 0xfd26 as libc::c_int as s16,
                   z: 0xee80 as libc::c_int as s16,};
         init
     },
     {
     ...
     },
     {
         let mut init =
             Vec3s{x: 0x7da as libc::c_int as s16,
                   y: 0xfd26 as libc::c_int as s16,
                   z: 0xf204 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x672 as libc::c_int as s16,
                   y: 0xfd44 as libc::c_int as s16,
                   z: 0xf204 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x672 as libc::c_int as s16,
                   y: 0xfd6c as libc::c_int as s16,
                   z: 0xf3c6 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x88e as libc::c_int as s16,
                   y: 0xfd6c as libc::c_int as s16,
                   z: 0xf3c6 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x88e as libc::c_int as s16,
                   y: 0xfdb2 as libc::c_int as s16,
                   z: 0xf5e2 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0x99c as libc::c_int as s16,
                   y: 0xfdd0 as libc::c_int as s16,
                   z: 0xf5e2 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xb54 as libc::c_int as s16,
                   y: 0xfe66 as libc::c_int as s16,
                   z: 0xf772 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xb4e as libc::c_int as s16,
                   y: 0xfe66 as libc::c_int as s16,
                   z: 0xf87e as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xb4a as libc::c_int as s16,
                   y: 0xfe66 as libc::c_int as s16,
                   z: 0xf97a as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xb4a as libc::c_int as s16,
                   y: 0xfe98 as libc::c_int as s16,
                   z: 0xf9fc as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 0xbae as libc::c_int as s16,
                   y: 0xfe98 as libc::c_int as s16,
                   z: 0xf9fc as libc::c_int as s16,};
         init
     }];
#[no_mangle]
pub static mut En_Po_Relay_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PO_RELAY as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoRelay_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoRelay_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80AD8D24: s32 = 0 as libc::c_int;
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 2] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 2];
static mut D_80AD8D30: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 1.5f32, z: 0.0f32,}; init };
static mut D_80AD8D3C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80AD8D48: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 1200.0f32, z: 0.0f32,}; init };
static mut sEyesTextures: [*mut libc::c_void; 3] =
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoRelay = thisx as *mut EnPoRelay;
    let mut temp: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gDampeSkel,
                       &mut gDampeFloatAnim, (*this).jointTable.as_mut_ptr(),
    ...
    if D_80AD8D24 != 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    } else {
        D_80AD8D24 = temp;
        Actor_SetTextWithPrefix(globalCtx, &mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnPoRelay = thisx as *mut EnPoRelay;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_SetupIdle(mut this: *mut EnPoRelay) {
    (*this).unk_195 = 32 as libc::c_int as u8_0;
    (*this).pathIndex = 0 as libc::c_int as s16;
    (*this).actor.room = -(1 as libc::c_int) as s8;
    (*this).actor.shape.rot.y = 0 as libc::c_int as s16;
    (*this).actor.world.rot.y = -(0x8000 as libc::c_int) as s16;
    (*this).actor.colChkInfo.mass = 0xfe as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnPoRelay_Idle as
                 unsafe extern "C" fn(_: *mut EnPoRelay,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Vec3sToVec3f(mut dest: *mut Vec3f,
                                                mut src: *mut Vec3s) {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_SetupRace(mut this: *mut EnPoRelay) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    EnPoRelay_Vec3sToVec3f(&mut vec,
                           &mut *D_80AD8C30.as_mut_ptr().offset((*this).pathIndex
                                                                    as
                                                                    isize));
    (*this).actionTimer =
        ((((*this).actor.shape.rot.y as libc::c_int -
             ...
             libc::c_uint).wrapping_rem(32 as libc::c_uint) as s16;
    func_80088B34(0 as libc::c_int as s16);
    (*this).hookshotSlotFull =
        (gSaveContext.inventory.items[gItemSlots[ITEM_HOOKSHOT as libc::c_int
                                                     as usize] as usize] as
             libc::c_int != ITEM_NONE as libc::c_int) as libc::c_int as u8_0;
    (*this).unk_19A = Actor_WorldYawTowardPoint(&mut (*this).actor, &mut vec);
    (*this).actor.flags |=
        ((1 as libc::c_int) << 27 as libc::c_int) as libc::c_uint;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ec as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoRelay_Race as
                 unsafe extern "C" fn(_: *mut EnPoRelay,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_SetupEndRace(mut this: *mut EnPoRelay) {
    (*this).actor.world.rot.y =
        ((*this).actor.home.rot.y as libc::c_int + 0xc000 as libc::c_int) as
            s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 27 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actionFunc =
        Some(EnPoRelay_EndRace as
                 unsafe extern "C" fn(_: *mut EnPoRelay,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_CorrectY(mut this: *mut EnPoRelay) {
    Math_StepToF(&mut (*this).actor.home.pos.y,
                 D_80AD8C30[(if (*this).pathIndex as libc::c_int >=
                                    28 as libc::c_int {
                                 27 as libc::c_int
                             } else { (*this).pathIndex as libc::c_int }) as
                                usize].y as libc::c_int as libc::c_float +
                     45.0f32, 2.0f32);
    (*this).actor.world.pos.y =
        Math_SinS(((*this).unk_195 as libc::c_int * 0x800 as libc::c_int) as
                      s16) * 8.0f32 + (*this).actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Idle(mut this: *mut EnPoRelay,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        (*this).actionFunc =
            Some(EnPoRelay_Talk as
                     unsafe extern "C" fn(_: *mut EnPoRelay,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).actor.xzDistToPlayer < 250.0f32 {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*this).actor.textId = (*this).textId;
        func_8002F2CC(&mut (*this).actor, globalCtx, 250.0f32);
    }
    func_8002F974(&mut (*this).actor,
                  (0x3871 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Talk(mut this: *mut EnPoRelay,
                                        mut globalCtx: *mut GlobalContext) {
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0x100 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Race(mut this: *mut EnPoRelay,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int &&
        ...
        (*this).actionTimer = 32 as libc::c_int as s16;
        if ((*this).pathIndex as libc::c_int) < 23 as libc::c_int {
            speed = Rand_ZeroOne() * 3.0f32;
            if speed < 1.0f32 {
                multiplier = 1.0f32
            } else if speed < 2.0f32 {
                multiplier = -1.0f32
            } else { multiplier = 0.0f32 }
            speed = 30.0f32 * multiplier;
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_HONOTRAP as libc::c_int as s16,
                        Math_CosS((*this).unk_19A) * speed +
                            (*this).actor.world.pos.x,
                        (*this).actor.world.pos.y,
                        Math_SinS((*this).unk_19A) * speed +
                        ...
                        (((*this).unk_19A as libc::c_int +
                             ...
                             0x2000 as libc::c_int as libc::c_float *
                                 multiplier) as s16, 0 as libc::c_int as s16,
                        HONOTRAP_FLAME_DROP as libc::c_int as s16);
        }
    }
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_19A,
                       2 as libc::c_int as s16, 0x1000 as libc::c_int as s16,
                       0x100 as libc::c_int as s16);
    (*this).actor.shape.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             (*this).actionTimer as libc::c_int * 0x800 as libc::c_int +
             0x8000 as libc::c_int) as s16;
    if ((*this).pathIndex as libc::c_int) < 23 as libc::c_int {
        // If the player travels along a different path to Dampé that converges later
        if Math3D_PointInSquare2D(660.0f32, 840.0f32, -4480.0f32, -3760.0f32,
                                  (*player).actor.world.pos.x,
                                  (*player).actor.world.pos.z) !=
               0 as libc::c_int ||
               Math3D_PointInSquare2D(1560.0f32, 1740.0f32, -4030.0f32,
                                      -3670.0f32, (*player).actor.world.pos.x,
                                      (*player).actor.world.pos.z) !=
                   0 as libc::c_int ||
               Math3D_PointInSquare2D(1580.0f32, 2090.0f32, -3030.0f32,
                                      -2500.0f32, (*player).actor.world.pos.x,
                                      (*player).actor.world.pos.z) !=
                   0 as libc::c_int {
            speed =
                if (*this).hookshotSlotFull as libc::c_int != 0 {
                    ((*player).actor.speedXZ) * 1.4f32
                } else { ((*player).actor.speedXZ) * 1.2f32 }
        } else if (*this).actor.xzDistToPlayer < 150.0f32 {
            speed =
                if (*this).hookshotSlotFull as libc::c_int != 0 {
                    ((*player).actor.speedXZ) * 1.2f32
                } else { (*player).actor.speedXZ }
        } else if (*this).actor.xzDistToPlayer < 300.0f32 {
            speed =
                if (*this).hookshotSlotFull as libc::c_int != 0 {
                    (*player).actor.speedXZ
                } else { ((*player).actor.speedXZ) * 0.8f32 }
        } else if (*this).hookshotSlotFull != 0 {
            speed = 4.5f32
        } else { speed = 3.5f32 }
        multiplier = 250.0f32 - (*this).actor.xzDistToPlayer;
        multiplier = if multiplier < 0.0f32 { 0.0f32 } else { multiplier };
        speed += multiplier * 0.02f32 + 1.0f32;
        Math_ApproachF(&mut (*this).actor.speedXZ, speed, 0.5f32, 1.5f32);
    } else {
        Math_ApproachF(&mut (*this).actor.speedXZ, 3.5f32, 0.5f32, 1.5f32);
    }
    EnPoRelay_Vec3sToVec3f(&mut vec,
                           &mut *D_80AD8C30.as_mut_ptr().offset((*this).pathIndex
                                                                    as
                                                                    isize));
    if Actor_WorldDistXZToPoint(&mut (*this).actor, &mut vec) < 40.0f32 {
        (*this).pathIndex += 1;
        EnPoRelay_Vec3sToVec3f(&mut vec,
                               &mut *D_80AD8C30.as_mut_ptr().offset((*this).pathIndex
                                                                        as
                                                                        isize));
        if (*this).pathIndex as libc::c_int == 28 as libc::c_int {
            EnPoRelay_SetupEndRace(this);
        } else if (*this).pathIndex as libc::c_int == 9 as libc::c_int {
            Flags_SetSwitch(globalCtx, 0x35 as libc::c_int);
        } else if (*this).pathIndex as libc::c_int == 17 as libc::c_int {
            Flags_SetSwitch(globalCtx, 0x36 as libc::c_int);
        } else if (*this).pathIndex as libc::c_int == 25 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_EndRace(mut this: *mut EnPoRelay,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnPoRelay_Talk2 as
                     unsafe extern "C" fn(_: *mut EnPoRelay,
                                          _: *mut GlobalContext) -> ())
    } else if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                  5 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        gSaveContext.timer1State = 0 as libc::c_int as s16
    } else if Actor_IsFacingAndNearPlayer(&mut (*this).actor, 150.0f32,
                                          0x3000 as libc::c_int as s16) != 0 {
        (*this).actor.textId = (*this).textId;
        func_8002F2CC(&mut (*this).actor, globalCtx, 250.0f32);
    }
    func_8002F974(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Talk2(mut this: *mut EnPoRelay,
                                         mut globalCtx: *mut GlobalContext) {
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0x100 as libc::c_int as s16);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        if Message_ShouldAdvance(globalCtx) != 0 {
            if (*this).hookshotSlotFull as libc::c_int != 0 as libc::c_int {
                Actor_SetTextWithPrefix(globalCtx, &mut (*this).actor,
                                        0x2e as libc::c_int as s16);
            } else {
                Actor_SetTextWithPrefix(globalCtx, &mut (*this).actor,
                                        0x2d as libc::c_int as s16);
            }
            (*this).textId = (*this).actor.textId;
        ...
        (*this).actionFunc =
            Some(EnPoRelay_DisappearAndReward as
                     unsafe extern "C" fn(_: *mut EnPoRelay,
                                          _: *mut GlobalContext) -> ())
    }
    func_8002F974(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_DisappearAndReward(mut this:
                                                          *mut EnPoRelay,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if ((*this).actionTimer as libc::c_int) < 8 as libc::c_int {
        ...
        EffectSsDeadDb_Spawn(globalCtx, &mut vec, &mut D_80AD8D30,
                             &mut D_80AD8D3C,
                             ((*this).actionTimer as libc::c_int *
    ...
    if Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, 0.001f32) !=
        ...
        if (*this).hookshotSlotFull as libc::c_int != 0 as libc::c_int {
            ...
            if (gSaveContext.timer1Value as libc::c_int) <
                   gSaveContext.highScores[HS_DAMPE_RACE as libc::c_int as
                                               usize] {
                gSaveContext.highScores[HS_DAMPE_RACE as libc::c_int as usize]
                    = gSaveContext.timer1Value as s32
            }
            if Flags_GetCollectible(globalCtx, (*this).actor.params as s32) ==
                   0 as libc::c_int &&
                   gSaveContext.timer1Value as libc::c_int <=
                       60 as libc::c_int {
                Item_DropCollectible2(globalCtx, &mut sp60,
                                      ((((*this).actor.params as libc::c_int)
                                            << 8 as libc::c_int) +
                                           (0x4000 as libc::c_int |
                                                ITEM00_HEART_PIECE as
                                                    libc::c_int)) as s16);
            } else {
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_ITEM00 as libc::c_int as s16, sp60.x,
                            sp60.y, sp60.z, 0 as libc::c_int as s16,
                            0 as libc::c_int as s16, 0 as libc::c_int as s16,
                            2 as libc::c_int as s16);
            }
        } else {
            Flags_SetTempClear(globalCtx, 4 as libc::c_int);
            gSaveContext.highScores[HS_DAMPE_RACE as libc::c_int as usize] =
                gSaveContext.timer1Value as s32
        }
        Actor_Kill(&mut (*this).actor);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoRelay = thisx as *mut EnPoRelay;
    let mut pad: s32 = 0;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32, 27.0f32,
                            60.0f32, 4 as libc::c_int);
    ...
    (*this).eyeTextureIdx = (*this).eyeTextureIdx.wrapping_add(1);
    if (*this).eyeTextureIdx as libc::c_int == 3 as libc::c_int {
        (*this).eyeTextureIdx = 0 as libc::c_int as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_PostLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
    ...
    if limbIndex == 14 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_po_relay.c\x00" as *const u8 as
                            *const libc::c_char, 885 as libc::c_int);
        rand = Rand_ZeroOne();
        (*this).lightColor.r =
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = gDampeLanternDL.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_po_relay.c\x00" as *const u8 as
                             *const libc::c_char, 901 as libc::c_int);
        Matrix_MultVec3f(&mut D_80AD8D48, &mut vec);
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo, vec.x as s16,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gDampeHaloDL.as_mut_ptr() as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoRelay_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoRelay = thisx as *mut EnPoRelay;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    (*_g).words.w1 =
        gSegments[((sEyesTextures[(*this).eyeTextureIdx as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sEyesTextures[(*this).eyeTextureIdx
                                                            as usize] as u32_0
                                              &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnPoRelay_PostLimbDraw as
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x4f as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
