...
extern "C" {
    ...
    #[no_mangle]
    static mut gUnknownEffStone1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStone8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gUnknownEffStoneDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EffStoneDrawInfo {
    pub texture: *mut libc::c_void,
    pub primColor: Color_RGBA8,
    pub envColor: Color_RGBA8,
}
#[no_mangle]
pub static mut Effect_Ss_Stone1_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_STONE1 as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsStone1_Init as
...
static mut sDrawInfo: [EffStoneDrawInfo; 8] =
    unsafe {
        [{
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone8Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone7Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone6Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone5Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone4Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone3Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone2Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
         ...
         },
         {
             let mut init =
                 EffStoneDrawInfo{texture:
                                      gUnknownEffStone1Tex.as_ptr() as *mut _
                                          as *mut libc::c_void,
                                  primColor:
                                      {
                                          let mut init =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsStone1_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsStone1InitParams =
        initParamsx as *mut EffectSsStone1InitParams;
    let mut pos: Vec3f = (*initParams).pos;
    (*this).pos = pos;
    (*this).vec = pos;
    (*this).life = 8 as libc::c_int as s16;
    (*this).regs[0 as libc::c_int as usize] = (*initParams).unk_C as s16;
    (*this).draw =
        Some(EffectSsStone1_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsStone1_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsStone1_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut drawParams: *mut EffStoneDrawInfo =
        &mut *sDrawInfo.as_mut_ptr().offset((*this).life as isize) as
            *mut EffStoneDrawInfo;
    let mut mfVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut mfW: f32_0 = 0.;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_stone1.c\x00" as *const u8 as
                        *const libc::c_char, 154 as libc::c_int);
    SkinMatrix_Vec3fMtxFMultXYZW(&mut (*globalCtx).viewProjectionMtxF,
                                 &mut (*this).pos, &mut mfVec, &mut mfW);
    scale = if mfW < 1500.0f32 { 3.0f32 } else { (mfW / 1500.0f32) * 3.0f32 };
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[(((*drawParams).texture as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*drawParams).texture as u32_0 &
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        ((*drawParams).primColor.r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*drawParams).primColor.g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*drawParams).primColor.b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
    ...
    (*_g_2).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_2).words.w1 =
        ((*drawParams).envColor.r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*drawParams).envColor.g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*drawParams).envColor.b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gUnknownEffStoneDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_ss_stone1.c\x00" as *const u8 as
                         *const libc::c_char, 183 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsStone1_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    if (*this).life as libc::c_int == 6 as libc::c_int &&
