...
extern "C" {
    ...
    #[no_mangle]
    static mut gCuccoAnim: AnimationHeader;
    #[no_mangle]
    static mut gCuccoParticleAppearDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoParticleAliveDL: [Gfx; 0];
    #[no_mangle]
...
pub struct EnNiw {
    ...
    pub actionFunc: EnNiwActionFunc,
    pub timer1: s16,
    pub timer2: s16,
    pub timer3: s16,
    pub timer4: s16,
    ...
    pub feathers: [EnNiwFeather; 20],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNiwFeather {
    pub type_0: u8_0,
    pub pos: Vec3f,
    pub vel: Vec3f,
    pub accel: Vec3f,
...
pub type EnNiwActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext) -> ()>;
static mut D_80AB85E0: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut En_Niw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NIW as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 23 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_NIW as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnNiw>() as libc::c_ulong,
                          init:
...
static mut D_80AB8604: [f32_0; 2] = [5000.0f32, -5000.0f32];
static mut D_80AB860C: [f32_0; 3] = [5000.0f32, 3000.0f32, 4000.0f32];
static mut sKakarikoPosList: [Vec3f; 7] =
    [{ let mut init = Vec3f{x: -1697.0f32, y: 80.0f32, z: 870.0f32,}; init },
     { let mut init = Vec3f{x: 57.0f32, y: 320.0f32, z: -673.0f32,}; init },
     { let mut init = Vec3f{x: 796.0f32, y: 80.0f32, z: 1639.0f32,}; init },
     { let mut init = Vec3f{x: 1417.0f32, y: 465.0f32, z: 169.0f32,}; init },
     { let mut init = Vec3f{x: -60.0f32, y: 0.0f32, z: -46.0f32,}; init },
     { let mut init = Vec3f{x: -247.0f32, y: 80.0f32, z: 854.0f32,}; init },
     { let mut init = Vec3f{x: 1079.0f32, y: 80.0f32, z: -47.0f32,}; init }];
static mut sKakarikoFlagList: [s16; 7] =
    [0x200 as libc::c_int as s16, 0x400 as libc::c_int as s16,
     0x800 as libc::c_int as s16, 0x1000 as libc::c_int as s16,
     0x2000 as libc::c_int as s16, 0x4000 as libc::c_int as s16,
     0x8000 as libc::c_int as s16];
static mut sLowerRiverSpawned: u8_0 = 0 as libc::c_int as u8_0;
static mut sUpperRiverSpawned: u8_0 = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnNiw_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNiw = thisx as *mut EnNiw;
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
    ...
    if (*this).actor.params as libc::c_int == 0xb as libc::c_int {
        if sLowerRiverSpawned != 0 {
            Actor_Kill(&mut (*this).actor);
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x82\xe3\x81\x86\xe3\x81\x84\xe3\x81\xa6\xe3\x82\x8b\xe5\x8e\x9f Ver.1 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            return
        }
        sLowerRiverSpawned = 1 as libc::c_int as u8_0;
        (*this).actor.room = -(1 as libc::c_int) as s8
    }
    // Cucco at tall platform in the first room of Zora's River
    if (*this).actor.params as libc::c_int == 0xc as libc::c_int {
        if sUpperRiverSpawned != 0 {
            Actor_Kill(&mut (*this).actor);
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x82\xe3\x81\x86\xe3\x81\x84\xe3\x81\xa6\xe3\x82\x8b\xe5\x8e\x9f Ver.2 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            return
        }
        sUpperRiverSpawned = 1 as libc::c_int as u8_0;
        (*this).actor.room = -(1 as libc::c_int) as s8
    }
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 25.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gCuccoSkel,
                       &mut gCuccoAnim, (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 16 as libc::c_int);
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT01 as libc::c_int {
        i = 0 as libc::c_int;
        while i <
                  (::std::mem::size_of::<[Vec3f; 7]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<Vec3f>()
                                                       as libc::c_ulong) as
                      s32 {
            if fabsf((*this).actor.world.pos.x -
                         sKakarikoPosList[i as usize].x) < 40.0f32 &&
                   fabsf((*this).actor.world.pos.z -
                             sKakarikoPosList[i as usize].z) < 40.0f32 {
                (*this).unk_2AA = i as s16;
                osSyncPrintf(b"\x1b[33m \xe9\x80\x9a\xe5\xb8\xb8\xe9\xb6\x8findex %d\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*this).unk_2AA as libc::c_int);
                if gSaveContext.infTable[25 as libc::c_int as usize] as
                       libc::c_int &
                       sKakarikoFlagList[i as usize] as libc::c_int != 0 {
                    (*this).actor.world.pos.x = 300.0f32;
                    (*this).actor.world.pos.y = 100.0f32;
                    (*this).actor.world.pos.z = 1530.0f32;
                    (*this).actor.params = 0 as libc::c_int as s16
                }
            }
            i += 1
    ...
    Math_Vec3f_Copy(&mut (*this).unk_2AC, &mut (*this).actor.world.pos);
    Math_Vec3f_Copy(&mut (*this).unk_2B8, &mut (*this).actor.world.pos);
    (*this).unk_304 = 10.0f32;
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).unk_2A4 =
        (Rand_ZeroFloat(3.99f32) as s16 as libc::c_int + 5 as libc::c_int) as
            s16;
    if ((*this).unk_2A4 as libc::c_int) < 0 as libc::c_int {
        (*this).unk_2A4 = 1 as libc::c_int as s16
    }
    ...
    match (*this).actor.params as libc::c_int {
        ...
        13 => {
            ...
            current_block_66 = 2875714898739686747;
        }
        14 => { current_block_66 = 2875714898739686747; }
        4 => {
            (*this).actor.gravity = 0.0f32;
            current_block_66 = 16779030619667747692;
        }
        _ => { current_block_66 = 16779030619667747692; }
    }
    ...
    match (*this).actor.params as libc::c_int {
        10 => {
            ...
            current_block_74 = 18189863660378055185;
        }
        13 | 14 => { current_block_74 = 18189863660378055185; }
        _ => {
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut sCylinderInit1);
            current_block_74 = 15514718523126015390;
        }
    }
    match current_block_74 {
        18189863660378055185 => {
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
    ...
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xa9\xe3\x82\x93\xe3\x81\xaa\xe5\xa5\xb4\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    (*this).actionFunc =
        Some(EnNiw_ResetAction as
                 unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNiw = thisx as *mut EnNiw;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB5BF8(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s16) {
    let mut factor: f32_0 = 1.0f32;
    if (*this).actor.params as libc::c_int == 0xd as libc::c_int {
        factor = 2.0f32
    }
    if (*this).timer1 as libc::c_int == 0 as libc::c_int {
        if arg2 as libc::c_int == 0 as libc::c_int {
            (*this).unk_26C[0 as libc::c_int as usize] = 0.0f32
        } else {
            (*this).unk_26C[0 as libc::c_int as usize] = -10000.0f32 * factor
        }
        (*this).unk_298 += 1;
        (*this).timer1 = 3 as libc::c_int as s16;
        if (*this).unk_298 as libc::c_int & 1 as libc::c_int == 0 {
            (*this).unk_26C[0 as libc::c_int as usize] = 0.0f32;
            if arg2 as libc::c_int == 0 as libc::c_int {
                (*this).timer1 = Rand_ZeroFloat(30.0f32) as s16
            }
        }
    }
    if (*this).timer2 as libc::c_int == 0 as libc::c_int {
        (*this).unk_29C += 1;
        (*this).unk_29C =
            ((*this).unk_29C as libc::c_int & 1 as libc::c_int) as s16;
        match arg2 as libc::c_int {
            0 => {
                (*this).unk_26C[2 as libc::c_int as usize] = 0.0f32;
                (*this).unk_26C[1 as libc::c_int as usize] =
                    (*this).unk_26C[2 as libc::c_int as usize]
            }
            1 => {
                (*this).timer2 = 3 as libc::c_int as s16;
                (*this).unk_26C[2 as libc::c_int as usize] =
                    7000.0f32 * factor;
                (*this).unk_26C[1 as libc::c_int as usize] =
                    (*this).unk_26C[2 as libc::c_int as usize];
                if (*this).unk_29C as libc::c_int == 0 as libc::c_int {
                    (*this).unk_26C[2 as libc::c_int as usize] = 0.0f32;
                    (*this).unk_26C[1 as libc::c_int as usize] =
                        (*this).unk_26C[2 as libc::c_int as usize]
                }
            ...
            2 => {
                (*this).timer2 = 2 as libc::c_int as s16;
                (*this).unk_26C[2 as libc::c_int as usize] = -10000.0f32;
                (*this).unk_26C[1 as libc::c_int as usize] =
                    (*this).unk_26C[2 as libc::c_int as usize];
                (*this).unk_26C[5 as libc::c_int as usize] = 25000.0f32;
                (*this).unk_26C[7 as libc::c_int as usize] =
                    (*this).unk_26C[5 as libc::c_int as usize];
                (*this).unk_26C[6 as libc::c_int as usize] = 6000.0f32;
                (*this).unk_26C[8 as libc::c_int as usize] =
                    (*this).unk_26C[6 as libc::c_int as usize];
                if (*this).unk_29C as libc::c_int == 0 as libc::c_int {
                    (*this).unk_26C[7 as libc::c_int as usize] = 8000.0f32;
                    (*this).unk_26C[5 as libc::c_int as usize] =
                        (*this).unk_26C[7 as libc::c_int as usize]
                }
            }
            3 => {
                (*this).timer2 = 2 as libc::c_int as s16;
                (*this).unk_26C[5 as libc::c_int as usize] = 10000.0f32;
                (*this).unk_26C[7 as libc::c_int as usize] =
                    (*this).unk_26C[5 as libc::c_int as usize];
                if (*this).unk_29C as libc::c_int == 0 as libc::c_int {
                    (*this).unk_26C[5 as libc::c_int as usize] = 3000.0f32;
                    (*this).unk_26C[7 as libc::c_int as usize] =
                        (*this).unk_26C[5 as libc::c_int as usize]
                }
            }
            4 => { (*this).timer1 = 5 as libc::c_int as s16 }
            5 => {
                (*this).timer2 = 5 as libc::c_int as s16;
                (*this).unk_26C[5 as libc::c_int as usize] = 14000.0f32;
                (*this).unk_26C[7 as libc::c_int as usize] =
                    (*this).unk_26C[5 as libc::c_int as usize];
                if (*this).unk_29C as libc::c_int == 0 as libc::c_int {
                    (*this).unk_26C[5 as libc::c_int as usize] = 10000.0f32;
    ...
    if (*this).unk_2E0 != (*this).unk_26C[9 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2E0,
                       (*this).unk_26C[9 as libc::c_int as usize], 0.5f32,
                       4000.0f32);
    }
    if (*this).unk_2DC != (*this).unk_26C[0 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2DC,
                       (*this).unk_26C[0 as libc::c_int as usize], 0.5f32,
                       4000.0f32);
    }
    if (*this).unk_2C4 != (*this).unk_26C[2 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2C4,
                       (*this).unk_26C[2 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_2C8 != (*this).unk_26C[7 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2C8,
                       (*this).unk_26C[7 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_2CC != (*this).unk_26C[8 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2CC,
                       (*this).unk_26C[8 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_2D0 != (*this).unk_26C[1 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2D0,
                       (*this).unk_26C[1 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_2D4 != (*this).unk_26C[5 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2D4,
                       (*this).unk_26C[5 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_2D8 != (*this).unk_26C[6 as libc::c_int as usize] {
        Math_ApproachF(&mut (*this).unk_2D8,
                       (*this).unk_26C[6 as libc::c_int as usize], 0.8f32,
                       7000.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_SpawnAttackCucco(mut this: *mut EnNiw,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut viewX: f32_0 = 0.;
    let mut viewY: f32_0 = 0.;
    let mut viewZ: f32_0 = 0.;
    let mut attackCuccoPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut attackCucco: *mut Actor = 0 as *mut Actor;
    if (*this).timer5 as libc::c_int == 0 as libc::c_int &&
           ((*this).unk_296 as libc::c_int) < 7 as libc::c_int {
        ...
        attackCuccoPos.x =
            (Rand_ZeroOne() - 0.5f32) * viewX + (*globalCtx).view.eye.x;
        attackCuccoPos.y =
            Rand_CenteredFloat(0.3f32) +
                ((*globalCtx).view.eye.y + 50.0f32 + viewY * 0.5f32);
        attackCuccoPos.z =
            (Rand_ZeroOne() - 0.5f32) * viewZ + (*globalCtx).view.eye.z;
        attackCucco =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               ACTOR_EN_ATTACK_NIW as libc::c_int as s16,
                               attackCuccoPos.x, attackCuccoPos.y,
                               attackCuccoPos.z, 0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16);
        if !attackCucco.is_null() {
            (*this).unk_296 += 1;
            (*this).timer5 = 10 as libc::c_int as s16
        } else {
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\x9a  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB6100(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    let mut factor: f32_0 = 0.;
    let mut targetRotY: f32_0 = 0.;
    if (*this).timer4 as libc::c_int == 0 as libc::c_int {
        (*this).timer4 = 3 as libc::c_int as s16;
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            (*this).actor.velocity.y = 3.5f32
        }
    }
    if (*this).timer3 as libc::c_int == 0 as libc::c_int {
        (*this).unk_2A0 += 1;
        (*this).unk_2A0 =
            ((*this).unk_2A0 as libc::c_int & 1 as libc::c_int) as s16;
        (*this).timer3 = 5 as libc::c_int as s16
    }
    if (*this).unk_2A0 as libc::c_int == 0 as libc::c_int {
        factor = D_80AB860C[arg2 as usize]
    } else { factor = -D_80AB860C[arg2 as usize] }
    if arg2 == 1 as libc::c_int {
        if (*this).timer6 as libc::c_int == 0 as libc::c_int ||
               (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int !=
                   0 {
            (*this).timer6 = 150 as libc::c_int as s16;
            if (*this).timer8 as libc::c_int == 0 as libc::c_int {
                (*this).timer8 = 70 as libc::c_int as s16;
                (*this).unk_2E4 = (*this).actor.yawTowardsPlayer
            }
        }
    }
    targetRotY = (*this).unk_2E4 as libc::c_int as libc::c_float + factor;
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, targetRotY as s16,
                       3 as libc::c_int as s16, (*this).unk_2FC as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2FC, 3000.0f32, 1.0f32, 500.0f32);
    func_80AB5BF8(this, globalCtx, 5 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_ResetAction(mut this: *mut EnNiw,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gCuccoAnim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gCuccoAnim as
    ...
    match (*this).actor.params as libc::c_int {
        4 => {
            (*this).actionFunc =
                Some(func_80AB6450 as
                         unsafe extern "C" fn(_: *mut EnNiw,
                                              _: *mut GlobalContext) -> ())
        }
        13 => {
            (*this).actionFunc =
                Some(func_80AB6324 as
                         unsafe extern "C" fn(_: *mut EnNiw,
                                              _: *mut GlobalContext) -> ())
        }
        _ => {
            (*this).actionFunc =
                Some(func_80AB6570 as
                         unsafe extern "C" fn(_: *mut EnNiw,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB6324(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_308 as libc::c_int != 0 as libc::c_int {
        (*this).actor.velocity.y = Rand_ZeroFloat(2.0f32) + 4.0f32;
        (*this).actor.speedXZ = Rand_ZeroFloat(2.0f32) + 3.0f32;
        (*this).actionFunc =
            Some(func_80AB63A8 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ())
    }
    func_80AB5BF8(this, globalCtx, 1 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB63A8(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
           (*this).actor.velocity.y < 0.0f32 {
        (*this).unk_2B8.x = (*this).actor.world.pos.x;
        (*this).unk_2AC.x = (*this).unk_2B8.x;
        (*this).unk_2B8.y = (*this).actor.world.pos.y;
        (*this).unk_2AC.y = (*this).unk_2B8.y;
        (*this).unk_2B8.z = (*this).actor.world.pos.z;
        (*this).unk_2AC.z = (*this).unk_2B8.z;
        (*this).unk_29E = 0 as libc::c_int as s16;
        (*this).timer4 = (*this).unk_29E;
        (*this).timer5 = (*this).timer4;
        (*this).unk_300 = 0.0f32;
        (*this).unk_2FC = (*this).unk_300;
        (*this).actor.speedXZ = (*this).unk_2FC;
        (*this).unk_26C[8 as libc::c_int as usize] = (*this).actor.speedXZ;
        (*this).unk_26C[6 as libc::c_int as usize] =
            (*this).unk_26C[8 as libc::c_int as usize];
        (*this).unk_26C[5 as libc::c_int as usize] =
            (*this).unk_26C[6 as libc::c_int as usize];
        ...
        (*this).actionFunc =
            Some(func_80AB6570 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ())
    } else { func_80AB5BF8(this, globalCtx, 2 as libc::c_int as s16); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB6450(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.xzDistToPlayer < 30.0f32 &&
           fabsf((*this).actor.world.pos.y - (*player).actor.world.pos.y) <
               5.0f32 {
        (*this).timer6 = 100 as libc::c_int as s16;
        (*this).actor.gravity = -2.0f32;
        (*this).actionFunc =
            Some(func_80AB7290 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ())
    } else if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.gravity = -2.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2813 as libc::c_int as u16_0);
        (*this).sfxTimer1 = 30 as libc::c_int as s16;
        (*this).path = 0 as libc::c_int as s16;
        (*this).timer4 = 30 as libc::c_int as s16;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actor.speedXZ = 0.0f32;
        (*this).actionFunc =
            Some(func_80AB6BF8 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ())
    } else {
        // GI_NONE in this case allows the player to lift the actor
        func_8002F434(&mut (*this).actor, globalCtx, GI_NONE as libc::c_int,
                      25.0f32, 10.0f32);
        func_80AB5BF8(this, globalCtx, 1 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB6570(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut posY: f32_0 = Rand_CenteredFloat(100.0f32);
    let mut posZ: f32_0 = Rand_CenteredFloat(100.0f32);
    let mut tmp: s16 = 0;
    if (*this).actor.params as libc::c_int != 0xa as libc::c_int {
    ...
    } else if (*this).path as libc::c_int != 0 as libc::c_int {
        (*this).unk_2A6 = 1 as libc::c_int as s16;
        if (*this).sfxTimer3 as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2813 as libc::c_int as u16_0);
            (*this).sfxTimer3 = 100 as libc::c_int as s16
        }
        (*this).unk_2A0 = Rand_ZeroFloat(1.99f32) as s16;
        (*this).actor.speedXZ = 4.0f32;
        (*this).unk_300 = 0.0f32;
        (*this).unk_2FC = 0.0f32;
        (*this).actionFunc =
            Some(func_80AB6A38 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ());
        return
    }
    ...
    if (*this).timer5 as libc::c_int != 0 as libc::c_int {
        if Rand_ZeroFloat(3.99f32) < 1.0f32 {
            (*this).unk_2E6 += 1;
            (*this).unk_2E6 =
                ((*this).unk_2E6 as libc::c_int & 1 as libc::c_int) as s16
        }
        Math_ApproachF(&mut *(*this).unk_26C.as_mut_ptr().offset(9 as
                                                                     libc::c_int
                                                                     as
                                                                     isize),
                       D_80AB8604[(*this).unk_2E6 as usize], 0.5f32,
                       4000.0f32);
    }
    if (*this).timer5 as libc::c_int == 0 as libc::c_int &&
           (*this).timer4 as libc::c_int == 0 as libc::c_int {
        (*this).unk_29E += 1;
        if (*this).unk_29E as libc::c_int >= 8 as libc::c_int {
            (*this).timer5 = Rand_ZeroFloat(30.0f32) as s16;
            (*this).unk_29E = Rand_ZeroFloat(3.99f32) as s16;
            if (*this).actor.params as libc::c_int != 0xa as libc::c_int &&
                ...
                posY = Rand_CenteredFloat(30.0f32);
                posZ = Rand_CenteredFloat(30.0f32);
                if posY < 0.0f32 { posY -= 20.0f32 } else { posY += 20.0f32 }
                if posZ < 0.0f32 {
                    // Required to match
                    posZ -= 20.0f32
                } else { posZ += 20.0f32 }
            ...
            (*this).timer4 = 4 as libc::c_int as s16;
    ...
    if (*this).timer4 as libc::c_int != 0 as libc::c_int {
        Math_ApproachZeroF(&mut *(*this).unk_26C.as_mut_ptr().offset(9 as
                                                                         libc::c_int
                                                                         as
                                                                         isize),
                           0.5f32, 4000.0f32);
        tmp = 1 as libc::c_int as s16;
        Math_ApproachF(&mut (*this).actor.world.pos.x, (*this).unk_2B8.x,
                       1.0f32, (*this).unk_2FC);
        Math_ApproachF(&mut (*this).actor.world.pos.z, (*this).unk_2B8.z,
                       1.0f32, (*this).unk_2FC);
        Math_ApproachF(&mut (*this).unk_2FC, 3.0f32, 1.0f32, 0.3f32);
        posY = (*this).unk_2B8.x - (*this).actor.world.pos.x;
        posZ = (*this).unk_2B8.z - (*this).actor.world.pos.z;
        if fabsf(posY) < 10.0f32 { posY = 0.0f64 as f32_0 }
        if fabsf(posZ) < 10.0f32 { posZ = 0.0f64 as f32_0 }
        if posY == 0.0f32 && posZ == 0.0f32 {
            (*this).timer4 = 0 as libc::c_int as s16;
            (*this).unk_29E = 7 as libc::c_int as s16
        }
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (Math_FAtan2F(posY, posZ) *
                                (0x8000 as libc::c_int as libc::c_float /
                                     3.14159265358979323846f32)) as s16,
                           3 as libc::c_int as s16, (*this).unk_300 as s16,
                           0 as libc::c_int as s16);
        Math_ApproachF(&mut (*this).unk_300, 10000.0f32, 1.0f32, 1000.0f32);
    }
    func_80AB5BF8(this, globalCtx, tmp);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB6A38(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut pathIndex: s16 =
        ((*this).path as libc::c_int - 1 as libc::c_int) as s16;
    if (*this).path as libc::c_int == 0 as libc::c_int {
        (*this).unk_2B8.x = (*this).actor.world.pos.x;
        (*this).unk_2AC.x = (*this).unk_2B8.x;
        (*this).unk_2B8.y = (*this).actor.world.pos.y;
        (*this).unk_2AC.y = (*this).unk_2B8.y;
        ...
        path =
            &mut *(*globalCtx).setupPathList.offset(pathIndex as isize) as
                *mut Path;
        pointPos =
        ...
        (*this).unk_2E4 =
            (Math_FAtan2F(pathDiffX, pathDiffZ) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        func_80AB6100(this, globalCtx, 2 as libc::c_int);
        if fabsf(pathDiffX) < 30.0f32 && fabsf(pathDiffZ) < 30.0f32 {
            (*this).waypoint += 1;
            if (*this).waypoint as libc::c_int >=
                   (*this).unk_2EC as libc::c_int {
                (*this).waypoint = 0 as libc::c_int as s16
            }
        }
        func_80AB5BF8(this, globalCtx, 2 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB6BF8(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer4 as libc::c_int == 0 as libc::c_int {
        (*this).unk_2A6 = 2 as libc::c_int as s16;
        (*this).timer4 = 10 as libc::c_int as s16
    }
    (*this).actor.shape.rot.x = Rand_CenteredFloat(5000.0f32) as s16;
    (*this).actor.shape.rot.y = Rand_CenteredFloat(5000.0f32) as s16;
    (*this).actor.shape.rot.z = Rand_CenteredFloat(5000.0f32) as s16;
    if Actor_HasNoParent(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.params as libc::c_int == 0xd as libc::c_int {
            (*this).sfxTimer1 = 0 as libc::c_int as s16;
            (*this).unk_2A6 = 1 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80AB6EB4 as
                         unsafe extern "C" fn(_: *mut EnNiw,
                                              _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB6D08(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).path as libc::c_int == 0 as libc::c_int {
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int == 0 {
            return
        }
        if (*this).actor.params as libc::c_int == 0xe as libc::c_int {
            (*this).unk_2B8.x = (*this).actor.world.pos.x;
            (*this).unk_2AC.x = (*this).unk_2B8.x;
            (*this).unk_2B8.y = (*this).actor.world.pos.y;
            (*this).unk_2AC.y = (*this).unk_2B8.y;
        ...
        (*this).path = 1 as libc::c_int as s16;
        (*this).timer5 = 80 as libc::c_int as s16;
        (*this).actor.speedXZ = 0.0f32;
        (*this).actor.velocity.y = 4.0f32
    } else {
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        if (*this).timer5 as libc::c_int >= 6 as libc::c_int {
            func_8002F580(&mut (*this).actor, globalCtx);
        }
        func_80AB5BF8(this, globalCtx, 2 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB6EB4(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB6F04(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_2A8 as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0 {
        (*this).actor.gravity = 0.0f32;
        if (*this).actor.yDistToWater > 15.0f32 {
            (*this).actor.world.pos.y += 2.0f32
        }
        if (*this).timer4 as libc::c_int == 0 as libc::c_int {
            (*this).timer4 = 30 as libc::c_int as s16;
            Math_Vec3f_Copy(&mut pos, &mut (*this).actor.world.pos);
            pos.y += (*this).actor.yDistToWater;
            EffectSsGRipple_Spawn(globalCtx, &mut pos,
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
            ...
            (*this).actor.speedXZ = 1.0f32;
            (*this).actor.gravity = 0.0f32
        } else { (*this).actor.speedXZ = 4.0f32 }
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            (*this).actor.gravity = -2.0f32;
            (*this).timer6 = 100 as libc::c_int as s16;
            (*this).timer4 = 0 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB70A0(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    OnePointCutscene_Init(globalCtx, 2290 as libc::c_int as s16,
                          -(99 as libc::c_int) as s16, &mut (*this).actor,
                          0 as libc::c_int as s16);
    (*this).timer5 = 100 as libc::c_int as s16;
    (*this).unk_2A2 = 1 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80AB70F8 as
                 unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB70F8(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).sfxTimer1 = 100 as libc::c_int as s16;
    if (*this).timer5 as libc::c_int == 0 as libc::c_int {
        (*this).timer5 = 60 as libc::c_int as s16;
        (*this).timer1 = 10 as libc::c_int as s16;
        (*this).unk_2A2 = 4 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80AB714C as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ())
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB714C(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).sfxTimer1 = 100 as libc::c_int as s16;
    if (*this).timer5 as libc::c_int == 40 as libc::c_int {
        (*this).unk_26C[0 as libc::c_int as usize] = 10000.0f32;
        (*this).unk_26C[7 as libc::c_int as usize] = 14000.0f32;
        (*this).unk_26C[5 as libc::c_int as usize] = 14000.0f32;
        (*this).unk_26C[6 as libc::c_int as usize] = 0.0f32;
        (*this).unk_26C[8 as libc::c_int as usize] = 0.0f32;
        (*this).unk_26C[1 as libc::c_int as usize] = 0.0f32;
        (*this).unk_26C[2 as libc::c_int as usize] = 0.0f32;
        (*this).timer1 = 10 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2813 as libc::c_int as u16_0);
    ...
    if (*this).timer5 as libc::c_int == 0 as libc::c_int {
        (*this).timer7 = 10 as libc::c_int as s16;
        (*this).unk_2E4 = (*this).actor.yawTowardsPlayer;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB7204(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    EnNiw_SpawnAttackCucco(this, globalCtx);
    if ((*this).timer7 as libc::c_int) < 2 as libc::c_int {
        if (*this).timer7 as libc::c_int == 1 as libc::c_int {
            (*this).actor.speedXZ = 3.0f32;
            (*this).unk_2A0 = Rand_ZeroFloat(1.99f32) as s16;
            (*this).timer4 = 0 as libc::c_int as s16;
            (*this).timer3 = (*this).timer4;
            (*this).timer2 = (*this).timer3;
            (*this).timer1 = (*this).timer2
        } else { func_80AB6100(this, globalCtx, 1 as libc::c_int); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB7290(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gCuccoAnim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gCuccoAnim as
                                                *mut AnimationHeader as
    ...
    (*this).actor.speedXZ = 4.0f32;
    (*this).actionFunc =
        Some(func_80AB7328 as
                 unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB7328(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).timer6 as libc::c_int == 0 as libc::c_int {
        ...
        (*this).unk_2E4 =
            (Math_FAtan2F((*this).actor.world.pos.x -
                              (*player).actor.world.pos.x,
                          (*this).actor.world.pos.z -
                              (*player).actor.world.pos.z) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        func_80AB6100(this, globalCtx, 0 as libc::c_int);
        func_80AB5BF8(this, globalCtx, 2 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB7420(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_2A4 =
            (Rand_ZeroFloat(3.99f32) as s16 as libc::c_int + 5 as libc::c_int)
                as s16;
        (*this).actionFunc =
            Some(EnNiw_ResetAction as
                     unsafe extern "C" fn(_: *mut EnNiw,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AB747C(mut this: *mut EnNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_2A8 as libc::c_int == 0 as libc::c_int &&
        ...
        (*this).sfxTimer1 = 30 as libc::c_int as s16;
        if (*this).unk_2A4 as libc::c_int > 0 as libc::c_int &&
               D_80AB85E0 as libc::c_int == 0 as libc::c_int {
            (*this).unk_2A4 -= 1
        }
        (*this).unk_2A6 = 1 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnNiw_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut this: *mut EnNiw = thisx as *mut EnNiw;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut i: s16 = 0;
    let mut featherCount: s16 = 0;
    let mut zeroVec1: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut zeroVec2: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    let mut cam: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dist: f32_0 = 0.;
    let mut camResult: f32_0 = 0.;
    let mut pad3: [s32; 10] = [0; 10];
    // Required to match
    (*this).unk_294 += 1;
    if (*this).actionFunc !=
           Some(func_80AB6570 as
                    unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext)
                        -> ()) {
        (*this).unk_26C[9 as libc::c_int as usize] = 0.0f32
    }
    if (*this).unk_2A6 != 0 {
        featherCount = 20 as libc::c_int as s16;
        if (*this).unk_2A6 as libc::c_int == 2 as libc::c_int {
            featherCount = 4 as libc::c_int as s16
        }
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < featherCount as libc::c_int {
            pos.x = Rand_CenteredFloat(10.0f32) + (*thisx).world.pos.x;
            pos.y =
                Rand_CenteredFloat(10.0f32) +
                    ((*thisx).world.pos.y + (*this).unk_304);
            pos.z = Rand_CenteredFloat(10.0f32) + (*thisx).world.pos.z;
            scale = Rand_ZeroFloat(6.0f32) + 6.0f32;
            if (*this).unk_2A6 as libc::c_int == 2 as libc::c_int &&
                   (*this).unk_304 != 0 as libc::c_int as libc::c_float {
                pos.y += 10 as libc::c_int as libc::c_float
            }
            if (*this).unk_304 == 0 as libc::c_int as libc::c_float {
                scale =
                    Rand_ZeroFloat(2.0f32) + 2 as libc::c_int as libc::c_float
            }
            vel.x = Rand_CenteredFloat(3.0f32);
            vel.y = Rand_ZeroFloat(2.0f32) * 0.5f32 + 2.0f32;
            vel.z = Rand_CenteredFloat(3.0f32);
            accel.x = 0.0f32;
            accel.y = -0.15f32;
            accel.z = 0.0f32;
            EnNiw_FeatherSpawn(this, &mut pos, &mut vel, &mut accel, scale);
            i += 1
        }
        (*this).unk_2A6 = 0 as libc::c_int as s16
    }
    ...
    if (*this).timer7 as libc::c_int != 0 as libc::c_int {
        (*this).timer7 -= 1
    }
    if (*this).timer6 as libc::c_int != 0 as libc::c_int {
        (*this).timer6 -= 1
    }
    if (*this).sfxTimer1 as libc::c_int != 0 as libc::c_int {
        (*this).sfxTimer1 -= 1
    }
    if (*this).sfxTimer2 as libc::c_int != 0 as libc::c_int {
        (*this).sfxTimer2 -= 1
    }
    if (*this).sfxTimer3 as libc::c_int != 0 as libc::c_int {
        (*this).sfxTimer3 -= 1
    ...
    if (*this).timer9 as libc::c_int != 0 as libc::c_int {
        (*this).timer9 -= 1
    }
    (*thisx).shape.rot = (*thisx).world.rot;
    (*thisx).shape.shadowScale = 15.0f32;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_SetFocus(&mut (*this).actor, (*this).unk_304);
    ...
    if (*this).actionFunc !=
           ...
           (*this).actionFunc !=
               Some(func_80AB6450 as
                        unsafe extern "C" fn(_: *mut EnNiw,
                                             _: *mut GlobalContext) -> ()) &&
           (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT03 as libc::c_int
       {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32,
                                20.0f32, 60.0f32, 31 as libc::c_int);
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT03 as libc::c_int {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32,
                                20.0f32, 60.0f32, 29 as libc::c_int);
    }
    if (*thisx).floorHeight <= -32000.0f32 ||
           (*thisx).floorHeight >= 32000.0f32 {
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xb8\x8a\xe4\xb8\x8b\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).floorHeight as libc::c_double);
        ...
        camResult =
            cam.y / sqrtf(cam.x * cam.x + cam.y * cam.y + cam.z * cam.z);
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xaf\x84\xe5\x9b\xb2\xe5\xa4\x96\xef\xbc\xb8\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.x as libc::c_double);
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xaf\x84\xe5\x9b\xb2\xe5\xa4\x96\xef\xbc\xb9\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.y as libc::c_double);
        osSyncPrintf(b"\x1b[31m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xaf\x84\xe5\x9b\xb2\xe5\xa4\x96\xef\xbc\xba\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.z as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xef\xbc\xb8\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).home.pos.x as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xef\xbc\xb9\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).home.pos.y as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xef\xbc\xba\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).home.pos.z as libc::c_double);
        (*thisx).world.pos.x = (*thisx).home.pos.x;
        (*thisx).world.pos.z = (*thisx).home.pos.z;
        (*thisx).world.pos.y =
            (*thisx).home.pos.y + (*globalCtx).view.eye.y +
                camResult * 160.0f32;
        if (*thisx).world.pos.y < (*thisx).home.pos.y {
            (*thisx).world.pos.y = (*thisx).home.pos.y + 300.0f32
        }
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xbf\xae\xe6\x95\xb4\xe5\xbe\x8c\xef\xbc\xb8\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.x as libc::c_double);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xbf\xae\xe6\x95\xb4\xe5\xbe\x8c\xef\xbc\xb9\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.y as libc::c_double);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xbf\xae\xe6\x95\xb4\xe5\xbe\x8c\xef\xbc\xba\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).world.pos.z as libc::c_double);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        (*thisx).speedXZ = 0.0f32;
        (*thisx).gravity = -2.0f32;
        Math_Vec3f_Copy(&mut (*this).unk_2AC, &mut (*thisx).home.pos);
        Math_Vec3f_Copy(&mut (*this).unk_2B8, &mut (*thisx).home.pos);
        (*this).unk_300 = 0.0f32;
        (*this).unk_2FC = 0.0f32;
        (*this).unk_2F0.z = 0.0f32;
        (*this).unk_2F0.y = 0.0f32;
        (*this).unk_2F0.x = 0.0f32;
        (*this).unk_2D8 = 0.0f32;
        (*this).unk_2D4 = 0.0f32;
        (*this).unk_2D0 = 0.0f32;
        (*this).unk_2CC = 0.0f32;
        ...
        (*this).unk_2DC = 0.0f32;
        (*this).unk_2E0 = 0.0f32;
        (*this).unk_2A2 = 0 as libc::c_int as s16;
        (*this).unk_2A0 = (*this).unk_2A2;
        (*this).unk_29E = (*this).unk_2A0;
        (*this).unk_2A6 = (*this).unk_29E;
        (*this).unk_298 = (*this).unk_2A6;
        (*this).unk_294 = (*this).unk_298;
        (*this).unk_2A8 = (*this).unk_294;
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) <
                  (::std::mem::size_of::<[f32_0; 10]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<f32_0>()
                                                       as libc::c_ulong) as
                      s32 {
            (*this).unk_26C[i as usize] = 0 as libc::c_int as f32_0;
            i += 1
        }
        (*this).unk_2A8 = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80AB7420 as
                     unsafe extern "C" fn(_: *mut EnNiw,
                                          _: *mut GlobalContext) -> ());
        return
    }
    if (*thisx).bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0 &&
           (*thisx).yDistToWater > 15.0f32 &&
           (*this).actionFunc !=
               Some(func_80AB6F04 as
                        unsafe extern "C" fn(_: *mut EnNiw,
                                             _: *mut GlobalContext) -> ()) &&
           (*thisx).params as libc::c_int != 0xd as libc::c_int &&
           (*thisx).params as libc::c_int != 0xe as libc::c_int &&
           (*thisx).params as libc::c_int != 0xa as libc::c_int {
        (*thisx).velocity.y = 0.0f32;
        (*thisx).gravity = 0.0f32;
        Math_Vec3f_Copy(&mut pos, &mut (*thisx).world.pos);
        pos.y += (*thisx).yDistToWater;
        (*this).timer4 = 30 as libc::c_int as s16;
        EffectSsGSplash_Spawn(globalCtx, &mut pos, 0 as *mut Color_RGBA8,
                              0 as *mut Color_RGBA8, 0 as libc::c_int as s16,
                              400 as libc::c_int as s16);
        (*this).timer5 = 0 as libc::c_int as s16;
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xb6\xe3\x81\x8f\xe3\x81\xb6\xe3\x81\x8f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        (*this).actionFunc =
            Some(func_80AB6F04 as
    ...
    if D_80AB85E0 as libc::c_int == 0 as libc::c_int &&
           (*this).unk_2A4 as libc::c_int <= 0 as libc::c_int &&
           (*thisx).params as libc::c_int != 0xd as libc::c_int &&
           (*thisx).params as libc::c_int != 0xe as libc::c_int &&
           (*thisx).params as libc::c_int != 0xa as libc::c_int {
        (*this).timer6 = 100 as libc::c_int as s16;
        if (*thisx).xzDistToPlayer > 10.0f32 {
            D_80AB85E0 = 1 as libc::c_int as s16;
            (*this).unk_29E = 0 as libc::c_int as s16;
            (*this).timer4 = (*this).unk_29E;
            (*this).timer5 = (*this).timer4;
            (*thisx).speedXZ = 0.0f32;
            (*this).unk_2FC = 0.0f32;
            (*this).unk_300 = 0.0f32;
            (*this).unk_26C[7 as libc::c_int as usize] = 0.0f32;
            (*this).unk_26C[5 as libc::c_int as usize] = 0.0f32;
            (*this).unk_26C[6 as libc::c_int as usize] = 0.0f32;
            (*this).unk_26C[8 as libc::c_int as usize] = 0.0f32;
            (*this).sfxTimer1 = 10000 as libc::c_int as s16;
            (*this).unk_2A8 = 1 as libc::c_int as s16;
            (*this).unk_2B8.x = (*thisx).world.pos.x;
            (*this).unk_2AC.x = (*this).unk_2B8.x;
            (*this).unk_2B8.y = (*thisx).world.pos.y;
            (*this).unk_2AC.y = (*this).unk_2B8.y;
            (*this).unk_2B8.z = (*thisx).world.pos.z;
            (*this).unk_2AC.z = (*this).unk_2B8.z;
            (*this).actionFunc =
                Some(func_80AB70A0 as
                         unsafe extern "C" fn(_: *mut EnNiw,
                                              _: *mut GlobalContext) -> ());
            return
        }
    ...
    dist = 20.0f32;
    if (*this).unk_2A8 as libc::c_int != 0 as libc::c_int &&
           (*thisx).xyzDistToPlayerSq < dist * dist &&
           (*player).invincibilityTimer as libc::c_int == 0 as libc::c_int {
        func_8002F6D4(globalCtx, &mut (*this).actor, 2.0f32,
                      (*thisx).world.rot.y, 0.0f32,
    ...
    if (*this).sfxTimer2 as libc::c_int == 0 as libc::c_int &&
           (*this).actionFunc ==
               Some(func_80AB6BF8 as
                        unsafe extern "C" fn(_: *mut EnNiw,
                                             _: *mut GlobalContext) -> ()) {
        (*this).sfxTimer2 = 7 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ff as libc::c_int as u16_0);
    }
    if (*this).sfxTimer1 as libc::c_int == 0 as libc::c_int {
        if (*this).actionFunc !=
               Some(func_80AB6570 as
            ...
            (*this).sfxTimer1 = 30 as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2812 as libc::c_int as u16_0);
        } else {
            (*this).sfxTimer1 = 300 as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2811 as libc::c_int as u16_0);
        }
    }
    if (*this).unk_2A8 as libc::c_int == 0 as libc::c_int {
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
        if (*thisx).params as libc::c_int != 0xa as libc::c_int &&
               (*thisx).params as libc::c_int != 0xd as libc::c_int &&
               (*thisx).params as libc::c_int != 0xe as libc::c_int &&
               (*thisx).params as libc::c_int != 4 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnNiw_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 13 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_2DC as s16 as libc::c_int)
                as s16
    }
    if limbIndex == 15 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_2E0 as s16 as libc::c_int)
                as s16
    }
    if limbIndex == 11 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_2D8 as s16 as libc::c_int)
                as s16;
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_2D4 as s16 as libc::c_int)
                as s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_2D0 as s16 as libc::c_int)
                as s16
    }
    if limbIndex == 7 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_2CC as s16 as libc::c_int)
                as s16;
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_2C8 as s16 as libc::c_int)
                as s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_2C4 as s16 as libc::c_int)
                as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNiw = thisx as *mut EnNiw;
    let mut scale: Vec3f =
        { let mut init = Vec3f{x: 0.15f32, y: 0.15f32, z: 0.15f32,}; init };
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnNiw_OverrideLimbDraw as
    ...
    if (*this).actionFunc ==
           Some(func_80AB6450 as
                    unsafe extern "C" fn(_: *mut EnNiw, _: *mut GlobalContext)
                        -> ()) {
        func_80033C30(&mut (*this).actor.world.pos, &mut scale,
                      255 as libc::c_int as u8_0, globalCtx);
    }
    EnNiw_FeatherDraw(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_FeatherSpawn(mut this: *mut EnNiw,
                                            mut pos: *mut Vec3f,
                                            mut vel: *mut Vec3f,
                                            mut accel: *mut Vec3f,
                                            mut scale: f32_0) {
    let mut i: s16 = 0;
    let mut feather: *mut EnNiwFeather = (*this).feathers.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnNiwFeather; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnNiwFeather>()
                                                   as libc::c_ulong) as s32 {
        if (*feather).type_0 as libc::c_int == 0 as libc::c_int {
            (*feather).type_0 = 1 as libc::c_int as u8_0;
            (*feather).pos = *pos;
            (*feather).vel = *vel;
            (*feather).accel = *accel;
            (*feather).timer = 0 as libc::c_int as u8_0;
            (*feather).scale = scale / 1000.0f32;
            (*feather).life =
                (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int +
                     40 as libc::c_int) as s16;
            (*feather).unk_2A = Rand_ZeroFloat(1000.0f32) as s16;
            break ;
        } else { i += 1; feather = feather.offset(1) }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_FeatherUpdate(mut this: *mut EnNiw,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut i: s16 = 0;
    let mut feather: *mut EnNiwFeather = (*this).feathers.as_mut_ptr();
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnNiwFeather; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnNiwFeather>()
                                                   as libc::c_ulong) as s32 {
        if (*feather).type_0 as libc::c_int != 0 as libc::c_int {
            (*feather).timer = (*feather).timer.wrapping_add(1);
            ...
            if (*feather).type_0 as libc::c_int == 1 as libc::c_int {
                (*feather).unk_2A += 1;
                Math_ApproachF(&mut (*feather).vel.x, 0.0f32, 1.0f32,
                               0.05f32);
                Math_ApproachF(&mut (*feather).vel.z, 0.0f32, 1.0f32,
                               0.05f32);
                if (*feather).vel.y < -0.5f32 { (*feather).vel.y = -0.5f32 }
                (*feather).unk_30 =
                    Math_SinS(((*feather).unk_2A as libc::c_int *
                                   0xbb8 as libc::c_int) as s16) *
                        3.14159265358979323846f32 * 0.2f32;
                if ((*feather).life as libc::c_int) <
                       (*feather).timer as libc::c_int {
                    (*feather).type_0 = 0 as libc::c_int as u8_0
                }
            }
        }
        i += 1;
        feather = feather.offset(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnNiw_FeatherDraw(mut this: *mut EnNiw,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    let mut pad: s32 = 0;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut feather: *mut EnNiwFeather =
        &mut *(*this).feathers.as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut EnNiwFeather;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_niw.c\x00" as *const u8 as *const libc::c_char,
                    1897 as libc::c_int);
        ...
        if (*feather).type_0 as libc::c_int == 1 as libc::c_int {
                ...
                (*_g).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g).words.w1 =
                    gCuccoParticleAppearDL.as_mut_ptr() as libc::c_uint;
                flag = flag.wrapping_add(1)
            }
            Matrix_Translate((*feather).pos.x, (*feather).pos.y,
                             (*feather).pos.z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            func_800D1FD4(&mut (*globalCtx).billboardMtxF);
            Matrix_Scale((*feather).scale, (*feather).scale, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*feather).unk_30,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Translate(0.0f32, -1000.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_0).words.w1 =
                Matrix_NewMtx(gfxCtx,
                              b"../z_en_niw.c\x00" as *const u8 as
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gCuccoParticleAliveDL.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        feather = feather.offset(1)
    }
