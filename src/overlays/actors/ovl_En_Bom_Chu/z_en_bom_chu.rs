...
pub struct EnBomChu {
    pub actor: Actor,
    pub actionFunc: EnBomChuActionFunc,
    pub timer: s16,
    pub axisForwards: Vec3f,
    pub axisUp: Vec3f,
    pub axisLeft: Vec3f,
    pub visualJitter: f32_0,
    pub blure1Index: s32,
    pub blure2Index: s32,
    pub collider: ColliderJntSph,
    pub colliderElements: [ColliderJntSphElement; 1],
}
pub type EnBomChuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBomChu, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
...
#[no_mangle]
pub static mut En_Bom_Chu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOM_CHU as libc::c_int as s16,
                          category: ACTORCAT_EXPLOSIVE as libc::c_int as u8_0,
                          flags:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomChu_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomChu_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    static mut p1StartColor: [u8_0; 4] =
        [250 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 250 as libc::c_int as u8_0];
    static mut p2StartColor: [u8_0; 4] =
        [200 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 130 as libc::c_int as u8_0];
    static mut p1EndColor: [u8_0; 4] =
        [150 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 100 as libc::c_int as u8_0];
    static mut p2EndColor: [u8_0; 4] =
        [100 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 50 as libc::c_int as u8_0];
    let mut this: *mut EnBomChu = thisx as *mut EnBomChu;
    ...
    blureInit.calcMode = 0 as libc::c_int;
    Effect_Add(globalCtx, &mut (*this).blure1Index,
    ...
    Effect_Add(globalCtx, &mut (*this).blure2Index,
               EFFECT_BLURE1 as libc::c_int, 0 as libc::c_int as u8_0,
               0 as libc::c_int as u8_0,
               &mut blureInit as *mut EffectBlureInit1 as *mut libc::c_void);
    ...
    (*this).actionFunc =
        Some(EnBomChu_WaitForRelease as
                 unsafe extern "C" fn(_: *mut EnBomChu, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBomChu = thisx as *mut EnBomChu;
...
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Explode(mut this: *mut EnBomChu,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.yDistToWater > 0.0f32 {
        ...
        while i < 40 as libc::c_int {
            EffectSsBubble_Spawn(globalCtx, &mut (*this).actor.world.pos,
                                 1.0f32, 5.0f32, 30.0f32, 0.25f32);
            i += 1
        }
    }
    (*this).actionFunc =
        Some(EnBomChu_WaitForKill as
                 unsafe extern "C" fn(_: *mut EnBomChu, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_CrossProduct(mut a: *mut Vec3f,
                                               mut b: *mut Vec3f,
                                               mut dest: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_UpdateFloorPoly(mut this: *mut EnBomChu,
                                                  mut floorPoly:
                                                      *mut CollisionPoly,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut normal: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut angle: f32_0 = 0.;
    let mut magnitude: f32_0 = 0.;
    let mut normDotUp: f32_0 = 0.;
    ...
    normal.z =
        (*floorPoly).normal.z as libc::c_int as libc::c_float *
            (1.0f32 / 32767.0f32);
    normDotUp =
        normal.x * (*this).axisUp.x + normal.y * (*this).axisUp.y +
            normal.z * (*this).axisUp.z;
    if !(fabsf(normDotUp) >= 1.0f32) {
        angle = Math_FAcosF(normDotUp);
        if !(angle < 0.001f32) {
            EnBomChu_CrossProduct(&mut (*this).axisUp, &mut normal, &mut vec);
            // ! @bug this function expects a unit vector but `vec` is not normalized
            Matrix_RotateAxis(angle, &mut vec,
                              MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_MultVec3f(&mut (*this).axisLeft, &mut vec);
            (*this).axisLeft = vec;
            EnBomChu_CrossProduct(&mut (*this).axisLeft, &mut normal,
                                  &mut (*this).axisForwards);
            magnitude = Math3D_Vec3fMagnitude(&mut (*this).axisForwards);
            if magnitude < 0.001f32 {
                EnBomChu_Explode(this, globalCtx);
                return
            }
            (*this).axisForwards.x *= 1.0f32 / magnitude;
            (*this).axisForwards.y *= 1.0f32 / magnitude;
            (*this).axisForwards.z *= 1.0f32 / magnitude;
            (*this).axisUp = normal;
            // mf = (axisLeft | axisUp | axisForwards)
            mf.c2rust_unnamed.xx = (*this).axisLeft.x;
            mf.c2rust_unnamed.yx = (*this).axisLeft.y;
            mf.c2rust_unnamed.zx = (*this).axisLeft.z;
            mf.c2rust_unnamed.xy = normal.x;
            mf.c2rust_unnamed.yy = normal.y;
            mf.c2rust_unnamed.zy = normal.z;
            mf.c2rust_unnamed.xz = (*this).axisForwards.x;
            mf.c2rust_unnamed.yz = (*this).axisForwards.y;
            mf.c2rust_unnamed.zz = (*this).axisForwards.z;
            Matrix_MtxFToYXZRotS(&mut mf, &mut (*this).actor.world.rot,
                                 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_WaitForRelease(mut this: *mut EnBomChu,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    if Actor_HasNoParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        EnBomChu_UpdateFloorPoly(this, (*this).actor.floorPoly,
                                 globalCtx); // make chu targetable
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        func_8002F850(globalCtx, &mut (*this).actor);
        (*this).actionFunc =
            Some(EnBomChu_Move as
                     unsafe extern "C" fn(_: *mut EnBomChu,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Move(mut this: *mut EnBomChu,
                                       mut globalCtx: *mut GlobalContext) {
    let mut polySide: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut polyUpDown: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgIdSide: s32 = 0;
    let mut bgIdUpDown: s32 = 0;
    let mut i: s32 = 0;
    let mut lineLength: f32_0 = 0.;
    let mut posA: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut posB: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut posSide: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut posUpDown: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).actor.speedXZ = 8.0f32;
    lineLength = (*this).actor.speedXZ * 2.0f32;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           ...
           (*this).collider.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               (*(*this).collider.base.oc).category as libc::c_int !=
                   ACTORCAT_PLAYER as libc::c_int {
        EnBomChu_Explode(this, globalCtx);
        return
    }
    posA.x = (*this).actor.world.pos.x + (*this).axisUp.x * 2.0f32;
    posA.y = (*this).actor.world.pos.y + (*this).axisUp.y * 2.0f32;
    posA.z = (*this).actor.world.pos.z + (*this).axisUp.z * 2.0f32;
    posB.x = (*this).actor.world.pos.x - (*this).axisUp.x * 4.0f32;
    posB.y = (*this).actor.world.pos.y - (*this).axisUp.y * 4.0f32;
    posB.z = (*this).actor.world.pos.z - (*this).axisUp.z * 4.0f32;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut posA, &mut posB,
                               &mut posUpDown, &mut polyUpDown,
                               1 as libc::c_int, 1 as libc::c_int,
                               1 as libc::c_int, 1 as libc::c_int,
                               &mut bgIdUpDown) != 0 &&
           func_80041DB8(&mut (*globalCtx).colCtx, polyUpDown, bgIdUpDown) &
               0x30 as libc::c_int == 0 &&
           SurfaceType_IsIgnoredByProjectiles(&mut (*globalCtx).colCtx,
                                              polyUpDown, bgIdUpDown) == 0 {
        // forwards
        ...
        if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut posA,
                                   &mut posB, &mut posSide, &mut polySide,
                                   1 as libc::c_int, 1 as libc::c_int,
                                   1 as libc::c_int, 1 as libc::c_int,
                                   &mut bgIdSide) != 0 &&
               func_80041DB8(&mut (*globalCtx).colCtx, polySide, bgIdSide) &
                   0x30 as libc::c_int == 0 &&
               SurfaceType_IsIgnoredByProjectiles(&mut (*globalCtx).colCtx,
                                                  polySide, bgIdSide) == 0 {
            EnBomChu_UpdateFloorPoly(this, polySide, globalCtx);
            (*this).actor.world.pos = posSide;
            (*this).actor.floorBgId = bgIdSide as u8_0;
            (*this).actor.speedXZ = 0.0f32
        } else {
            ...
            (*this).actor.floorBgId = bgIdUpDown as u8_0
        }
    } else {
        (*this).actor.speedXZ = 0.0f32;
        lineLength *= 3.0f32;
    ...
    func_8002F8F0(&mut (*this).actor,
                  (0x1831 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_WaitForKill(mut this: *mut EnBomChu,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_ModelToWorld(mut this: *mut EnBomChu,
                                               mut posModel: *mut Vec3f,
                                               mut dest: *mut Vec3f) {
    let mut x: f32_0 = (*posModel).x + (*this).visualJitter;
    (*dest).x =
        (*this).actor.world.pos.x + (*this).axisLeft.x * x +
            (*this).axisUp.x * (*posModel).y +
            (*this).axisForwards.x * (*posModel).z;
    (*dest).y =
        (*this).actor.world.pos.y + (*this).axisLeft.y * x +
            (*this).axisUp.y * (*posModel).y +
            (*this).axisForwards.y * (*posModel).z;
    (*dest).z =
        (*this).actor.world.pos.z + (*this).axisLeft.z * x +
            (*this).axisUp.z * (*posModel).y +
            (*this).axisForwards.z * (*posModel).z;
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_SpawnRipples(mut this: *mut EnBomChu,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut y: f32_0) {
    ...
    EffectSsGRipple_Spawn(globalCtx, &mut pos, 70 as libc::c_int as s16,
                          500 as libc::c_int as s16, 0 as libc::c_int as s16);
    EffectSsGRipple_Spawn(globalCtx, &mut pos, 70 as libc::c_int as s16,
                          500 as libc::c_int as s16, 4 as libc::c_int as s16);
    EffectSsGRipple_Spawn(globalCtx, &mut pos, 70 as libc::c_int as s16,
                          500 as libc::c_int as s16, 8 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Update(mut thisx: *mut Actor,
                                         mut globalCtx2: *mut GlobalContext) {
    static mut blureP1Model: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 7.0f32, z: -6.0f32,}; init };
    static mut blureP2LeftModel: Vec3f =
        { let mut init = Vec3f{x: 12.0f32, y: 0.0f32, z: -5.0f32,}; init };
    static mut blureP2RightModel: Vec3f =
        { let mut init = Vec3f{x: -12.0f32, y: 0.0f32, z: -5.0f32,}; init };
    ...
    let mut blureP1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut blureP2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if (*this).actor.floorBgId as libc::c_int != 50 as libc::c_int {
        ...
        func_800433A4(&mut (*globalCtx).colCtx,
                      (*this).actor.floorBgId as s32, &mut (*this).actor);
        if yaw as libc::c_int != (*this).actor.shape.rot.y as libc::c_int {
            yaw =
            ...
            (*this).axisForwards.x =
                (*this).axisForwards.z * sin + cos * tempX;
            (*this).axisForwards.z =
                (*this).axisForwards.z * cos - sin * tempX;
            tempX = (*this).axisUp.x;
    ...
    if (*this).actionFunc ==
           Some(EnBomChu_Move as
                    unsafe extern "C" fn(_: *mut EnBomChu,
                                         _: *mut GlobalContext) -> ()) {
        (*this).visualJitter =
            (5.0f32 + Rand_ZeroOne() * 3.0f32) *
                Math_SinS(((Rand_ZeroOne() * 0x200 as libc::c_int as f32_0 +
                                0x3000 as libc::c_int as f32_0) *
                               (*this).timer as libc::c_int as libc::c_float)
                              as s16);
        EnBomChu_ModelToWorld(this, &mut blureP1Model, &mut blureP1);
        EnBomChu_ModelToWorld(this, &mut blureP2LeftModel, &mut blureP2);
        EffectBlure_AddVertex(Effect_GetByIndex((*this).blure1Index) as
                                  *mut EffectBlure, &mut blureP1,
                              &mut blureP2);
        EnBomChu_ModelToWorld(this, &mut blureP2RightModel, &mut blureP2);
        EffectBlure_AddVertex(Effect_GetByIndex((*this).blure2Index) as
                                  *mut EffectBlure, &mut blureP1,
                              &mut blureP2);
        waterY = (*this).actor.world.pos.y;
        if WaterBox_GetSurface1(globalCtx, &mut (*globalCtx).colCtx,
                                (*this).actor.world.pos.x,
                                (*this).actor.world.pos.z, &mut waterY,
                                &mut waterBox) != 0 {
            ...
            if (*this).actor.yDistToWater < 0.0f32 {
                ...
                if (*this).actor.bgCheckFlags as libc::c_int &
                       0x20 as libc::c_int == 0 &&
                       (*this).timer as libc::c_int != 120 as libc::c_int {
                    EnBomChu_SpawnRipples(this, globalCtx, waterY);
                } else {
                    EffectSsBubble_Spawn(globalCtx,
                                         &mut (*this).actor.world.pos, 0.0f32,
                                         3.0f32, 15.0f32, 0.25f32);
                }
                (*this).actor.bgCheckFlags =
                    ((*this).actor.bgCheckFlags as libc::c_int |
                         0x20 as libc::c_int) as u16_0
            ...
            (*this).actor.bgCheckFlags =
                ((*this).actor.bgCheckFlags as libc::c_int &
                     !(0x20 as libc::c_int)) as u16_0;
            (*this).actor.yDistToWater = -32000.0f32
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomChu_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBomChu = thisx as *mut EnBomChu;
    let mut colorIntensity: f32_0 = 0.;
    let mut blinkHalfPeriod: s32 = 0;
    let mut blinkTime: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bom_chu.c\x00" as *const u8 as
    ...
    if (*this).timer as libc::c_int >= 40 as libc::c_int {
        blinkTime = (*this).timer as libc::c_int % 20 as libc::c_int;
        blinkHalfPeriod = 10 as libc::c_int
    } else if (*this).timer as libc::c_int >= 10 as libc::c_int {
        blinkTime = (*this).timer as libc::c_int % 10 as libc::c_int;
        blinkHalfPeriod = 5 as libc::c_int
    } else {
        blinkTime = (*this).timer as libc::c_int & 1 as libc::c_int;
        blinkHalfPeriod = 1 as libc::c_int
    }
    if blinkTime > blinkHalfPeriod {
        blinkTime = 2 as libc::c_int * blinkHalfPeriod - blinkTime
    }
    colorIntensity = blinkTime as libc::c_float / blinkHalfPeriod as f32_0;
    ...
    (*_g).words.w1 =
        ((9.0f32 + colorIntensity * 209.0f32) as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((9.0f32 + colorIntensity * 34.0f32) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((35.0f32 + colorIntensity * -35.0f32) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    Matrix_Translate((*this).visualJitter * (1.0f32 / 0.01f32), 0.0f32,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gBombchuDL.as_mut_ptr() as libc::c_uint;
                                   ...
                                   count:
                                       (::std::mem::size_of::<[ColliderJntSphElementInit; 1]>()
                                            ...
                                            libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElementInit>()
                                                                            ...
                                                                            libc::c_ulong)
                                           as s32,
                                   elements: sJntSphElemInit.as_mut_ptr(),};
            init
        };
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).scale as *mut Vec3f as
                                 size_t as u32_0);
             init.set_value((1000 as libc::c_int as libc::c_float * 0.01f32)
                                as s32);
             init
         }]
}
