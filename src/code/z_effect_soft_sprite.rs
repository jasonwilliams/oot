...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffectSsOverlayTable: [EffectSsOverlay; 37];
}
...
pub struct EffectSsInfo {
    pub table: *mut EffectSs,
    pub searchStartIndex: s32,
    pub tableSize: s32,
}
pub type C2RustUnnamed_14 = libc::c_uint;
pub const EFFECT_SS_TYPE_MAX: C2RustUnnamed_14 = 37;
pub const EFFECT_SS_ICE_SMOKE: C2RustUnnamed_14 = 36;
pub const EFFECT_SS_DEAD_SOUND: C2RustUnnamed_14 = 35;
pub const EFFECT_SS_DEAD_DS: C2RustUnnamed_14 = 34;
pub const EFFECT_SS_DEAD_DD: C2RustUnnamed_14 = 33;
pub const EFFECT_SS_DEAD_DB: C2RustUnnamed_14 = 32;
pub const EFFECT_SS_FCIRCLE: C2RustUnnamed_14 = 31;
pub const EFFECT_SS_EXTRA: C2RustUnnamed_14 = 30;
pub const EFFECT_SS_EN_FIRE: C2RustUnnamed_14 = 29;
pub const EFFECT_SS_FIRE_TAIL: C2RustUnnamed_14 = 28;
pub const EFFECT_SS_EN_ICE: C2RustUnnamed_14 = 27;
pub const EFFECT_SS_ICE_PIECE: C2RustUnnamed_14 = 26;
pub const EFFECT_SS_KAKERA: C2RustUnnamed_14 = 25;
pub const EFFECT_SS_SOLDER_SRCH_BALL: C2RustUnnamed_14 = 24;
pub const EFFECT_SS_K_FIRE: C2RustUnnamed_14 = 23;
pub const EFFECT_SS_FHG_FLASH: C2RustUnnamed_14 = 22;
pub const EFFECT_SS_HITMARK: C2RustUnnamed_14 = 21;
pub const EFFECT_SS_STONE1: C2RustUnnamed_14 = 20;
pub const EFFECT_SS_G_MAGMA2: C2RustUnnamed_14 = 19;
pub const EFFECT_SS_SIBUKI2: C2RustUnnamed_14 = 18;
pub const EFFECT_SS_SIBUKI: C2RustUnnamed_14 = 17;
pub const EFFECT_SS_STICK: C2RustUnnamed_14 = 16;
pub const EFFECT_SS_HAHEN: C2RustUnnamed_14 = 15;
pub const EFFECT_SS_DT_BUBBLE: C2RustUnnamed_14 = 14;
pub const EFFECT_SS_LIGHTNING: C2RustUnnamed_14 = 13;
pub const EFFECT_SS_G_FIRE: C2RustUnnamed_14 = 12;
pub const EFFECT_SS_G_MAGMA: C2RustUnnamed_14 = 11;
pub const EFFECT_SS_G_SPLASH: C2RustUnnamed_14 = 10;
pub const EFFECT_SS_G_RIPPLE: C2RustUnnamed_14 = 9;
pub const EFFECT_SS_UNSET: C2RustUnnamed_14 = 8;
pub const EFFECT_SS_BUBBLE: C2RustUnnamed_14 = 7;
pub const EFFECT_SS_D_FIRE: C2RustUnnamed_14 = 6;
pub const EFFECT_SS_G_SPK: C2RustUnnamed_14 = 5;
pub const EFFECT_SS_BLAST: C2RustUnnamed_14 = 4;
pub const EFFECT_SS_BOMB2: C2RustUnnamed_14 = 3;
pub const EFFECT_SS_BOMB: C2RustUnnamed_14 = 2;
pub const EFFECT_SS_KIRAKIRA: C2RustUnnamed_14 = 1;
pub const EFFECT_SS_DUST: C2RustUnnamed_14 = 0;
#[no_mangle]
pub static mut sEffectSsInfo: EffectSsInfo =
    {
        let mut init =
            EffectSsInfo{table: 0 as *const EffectSs as *mut EffectSs,
                         searchStartIndex: 0,
                         tableSize: 0,};
        init
    };
// "EffectSS2Info"
#[no_mangle]
pub unsafe extern "C" fn EffectSs_InitInfo(mut globalCtx: *mut GlobalContext,
                                           mut tableSize: s32) {
    let mut i: u32_0 = 0;
    let mut effectSs: *mut EffectSs = 0 as *mut EffectSs;
    let mut overlay: *mut EffectSsOverlay = 0 as *mut EffectSsOverlay;
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[EffectSsOverlay; 37]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EffectSsOverlay>()
                                                   as libc::c_ulong) as s32 as
                  libc::c_uint {
        overlay =
            &mut *gEffectSsOverlayTable.as_mut_ptr().offset(i as isize) as
                *mut EffectSsOverlay;
        osSyncPrintf(b"effect index %3d:size=%6dbyte romsize=%6dbyte\n\x00" as
                         *const u8 as *const libc::c_char, i,
                     ((*overlay).vramEnd as
                          u32_0).wrapping_sub((*overlay).vramStart as u32_0),
                     (*overlay).vromEnd.wrapping_sub((*overlay).vromStart));
        i = i.wrapping_add(1)
    }
    sEffectSsInfo.table =
        GameState_Alloc(&mut (*globalCtx).state,
                        (tableSize as
                             libc::c_uint).wrapping_mul(::std::mem::size_of::<EffectSs>()
                                                            as libc::c_ulong)
                            as size_t,
                        b"../z_effect_soft_sprite.c\x00" as *const u8 as
                            *const libc::c_char as *mut libc::c_char,
                        289 as libc::c_int) as *mut EffectSs;
    if !sEffectSsInfo.table.is_null() {
    } else {
        __assert(b"EffectSS2Info.data_table != NULL\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_effect_soft_sprite.c\x00" as *const u8 as
                     *const libc::c_char, 290 as libc::c_int);
    };
    sEffectSsInfo.searchStartIndex = 0 as libc::c_int;
    sEffectSsInfo.tableSize = tableSize;
    effectSs =
        &mut *sEffectSsInfo.table.offset(0 as libc::c_int as isize) as
            *mut EffectSs;
    while effectSs <
              &mut *sEffectSsInfo.table.offset(sEffectSsInfo.tableSize as
                                                   isize) as *mut EffectSs {
        EffectSs_Reset(effectSs);
        effectSs = effectSs.offset(1)
    }
    overlay =
        &mut *gEffectSsOverlayTable.as_mut_ptr().offset(0 as libc::c_int as
                                                            isize) as
            *mut EffectSsOverlay;
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[EffectSsOverlay; 37]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EffectSsOverlay>()
                                                   as libc::c_ulong) as s32 as
                  libc::c_uint {
        (*overlay).loadedRamAddr = 0 as *mut libc::c_void;
        overlay = overlay.offset(1);
        i = i.wrapping_add(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_ClearAll(mut globalCtx:
                                               *mut GlobalContext) {
    let mut i: u32_0 = 0;
    let mut effectSs: *mut EffectSs = 0 as *mut EffectSs;
    let mut overlay: *mut EffectSsOverlay = 0 as *mut EffectSsOverlay;
    let mut addr: *mut libc::c_void = 0 as *mut libc::c_void;
    sEffectSsInfo.table = 0 as *mut EffectSs;
    sEffectSsInfo.searchStartIndex = 0 as libc::c_int;
    sEffectSsInfo.tableSize = 0 as libc::c_int;
    ...
    while i <
        ...
        if !addr.is_null() {
            ZeldaArena_FreeDebug(addr,
                                 b"../z_effect_soft_sprite.c\x00" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Delete(mut effectSs: *mut EffectSs) {
    if (*effectSs).flags as libc::c_int & 2 as libc::c_int != 0 {
        Audio_StopSfxByPos(&mut (*effectSs).pos);
    }
    if (*effectSs).flags as libc::c_int & 4 as libc::c_int != 0 {
        Audio_StopSfxByPos(&mut (*effectSs).vec);
    }
    EffectSs_Reset(effectSs);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Reset(mut effectSs: *mut EffectSs) {
    let mut i: u32_0 = 0;
    (*effectSs).type_0 = EFFECT_SS_TYPE_MAX as libc::c_int as u8_0;
    (*effectSs).accel.z = 0 as libc::c_int as f32_0;
    (*effectSs).accel.y = (*effectSs).accel.z;
    (*effectSs).accel.x = (*effectSs).accel.y;
    (*effectSs).velocity.z = 0 as libc::c_int as f32_0;
    (*effectSs).velocity.y = (*effectSs).velocity.z;
    (*effectSs).velocity.x = (*effectSs).velocity.y;
    (*effectSs).vec.z = 0 as libc::c_int as f32_0;
    (*effectSs).vec.y = (*effectSs).vec.z;
    (*effectSs).vec.x = (*effectSs).vec.y;
    (*effectSs).pos.z = 0 as libc::c_int as f32_0;
    (*effectSs).pos.y = (*effectSs).pos.z;
    (*effectSs).pos.x = (*effectSs).pos.y;
    (*effectSs).life = -(1 as libc::c_int) as s16;
    (*effectSs).flags = 0 as libc::c_int as u16_0;
    (*effectSs).priority = 128 as libc::c_int as u8_0;
    (*effectSs).draw = None;
    (*effectSs).update = None;
    (*effectSs).gfx = 0 as *mut libc::c_void;
    (*effectSs).actor = 0 as *mut Actor;
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[s16; 13]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 as
                  libc::c_uint {
        (*effectSs).regs[i as usize] = 0 as libc::c_int as s16;
        i = i.wrapping_add(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_FindSlot(mut priority: s32,
                                           mut pIndex: *mut s32) -> s32 {
    let mut foundFree: s32 = 0;
    let mut i: s32 = 0;
    ...
    foundFree = 0 as libc::c_int;
    loop  {
        if (*sEffectSsInfo.table.offset(i as isize)).life as libc::c_int ==
               -(1 as libc::c_int) {
            foundFree = 1 as libc::c_int;
            break ;
        } else {
            i += 1;
            if i >= sEffectSsInfo.tableSize {
                i = 0 as libc::c_int
                // Loop around the whole table
            }
            // After a full loop, break out
            if i == sEffectSsInfo.searchStartIndex { break ; }
        }
    }
    if foundFree == 1 as libc::c_int { *pIndex = i; return 0 as libc::c_int }
    ...
    while !(priority <=
                (*sEffectSsInfo.table.offset(i as isize)).priority as
                    libc::c_int &&
                !(priority ==
                      (*sEffectSsInfo.table.offset(i as isize)).priority as
                          libc::c_int &&
                      (*sEffectSsInfo.table.offset(i as isize)).flags as
        ...
        if i == sEffectSsInfo.searchStartIndex { return 1 as libc::c_int }
    }
    *pIndex = i;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Insert(mut globalCtx: *mut GlobalContext,
                                         mut effectSs: *mut EffectSs) {
    let mut index: s32 = 0;
    if FrameAdvance_IsEnabled(globalCtx) != 1 as libc::c_int {
        if EffectSs_FindSlot((*effectSs).priority as s32, &mut index) ==
               0 as libc::c_int {
            sEffectSsInfo.searchStartIndex = index + 1 as libc::c_int;
            *sEffectSsInfo.table.offset(index as isize) = *effectSs
        }
    };
}
// original name: "EffectSoftSprite2_makeEffect"
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Spawn(mut globalCtx: *mut GlobalContext,
                                        mut type_0: s32, mut priority: s32,
                                        mut initParams: *mut libc::c_void) {
    let mut index: s32 = 0;
    let mut overlaySize: u32_0 = 0;
    let mut overlayEntry: *mut EffectSsOverlay = 0 as *mut EffectSsOverlay;
    let mut initInfo: *mut EffectSsInit = 0 as *mut EffectSsInit;
    overlayEntry =
        &mut *gEffectSsOverlayTable.as_mut_ptr().offset(type_0 as isize) as
            *mut EffectSsOverlay;
    if type_0 < EFFECT_SS_TYPE_MAX as libc::c_int {
    } else {
        __assert(b"type < EFFECT_SS2_TYPE_LAST_LABEL\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_effect_soft_sprite.c\x00" as *const u8 as
                     *const libc::c_char, 556 as libc::c_int);
    };
    if EffectSs_FindSlot(priority, &mut index) != 0 as libc::c_int {
    ...
    if (*overlayEntry).vramStart.is_null() {
        // "Not an overlay"
        osSyncPrintf(b"EffectSoftSprite2_makeEffect():\xe3\x82\xaa\xe3\x83\xbc\xe3\x83\x90\xe3\x83\xbc\xe3\x83\xac\xe3\x82\xa4\xe3\x81\xa7\xe3\x81\xaf\xe3\x81\x82\xe3\x82\x8a\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\n\x00"
                         as *const u8 as *const libc::c_char);
        initInfo = (*overlayEntry).initInfo
    } else {
        if (*overlayEntry).loadedRamAddr.is_null() {
            (*overlayEntry).loadedRamAddr =
                ZeldaArena_MallocRDebug(overlaySize,
                                        b"../z_effect_soft_sprite.c\x00" as
            ...
            if (*overlayEntry).loadedRamAddr.is_null() {
                ...
                osSyncPrintf(b"EffectSoftSprite2_makeEffect():zelda_malloc_r()\xe3\x81\xab\xe3\x82\x88\xe3\x82\x8a,%dbyte\xe3\x81\xae\xe3\x83\xa1\xe3\x83\xa2\xe3\x83\xaa\xe7\xa2\xba\xe4\xbf\x9d\xe3\x81\x8c\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\n\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\xe3\x81\x9d\xe3\x81\xae\xe3\x81\x9f\xe3\x82\x81\xe3\x80\x81\xe3\x83\x97\xe3\x83\xad\xe3\x82\xb0\xe3\x83\xa9\xe3\x83\xa0\xe3\x81\xae\xe3\x83\xad\xe3\x83\xbc\xe3\x83\x89\xe3\x82\x82\n\xe5\x87\xba\xe6\x9d\xa5\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\xe3\x81\x9f\xe3\x81\xa0\xe3\x81\x84\xe3\x81\xbe\xe5\x8d\xb1\xe9\x99\xba\xe3\x81\xaa\xe7\x8a\xb6\xe6\x85\x8b\xe3\x81\xa7\xe3\x81\x99\xef\xbc\x81\n\xe3\x82\x82\xe3\x81\xa1\xe3\x82\x8d\xe3\x82\x93,\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe3\x82\x82\xe5\x87\xba\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\n\x00"
                                 as *const u8 as *const libc::c_char,
                             overlaySize);
            ...
            osSyncPrintf(b"EFFECT SS OVL:SegRom %08x %08x, Seg %08x %08x, RamStart %08x, type: %d\n\x00"
                             as *const u8 as *const libc::c_char,
                         (*overlayEntry).vromStart, (*overlayEntry).vromEnd,
                         (*overlayEntry).vramStart, (*overlayEntry).vramEnd,
                         (*overlayEntry).loadedRamAddr, type_0);
    ...
    if (*initInfo).init.is_none() {
        ...
        osSyncPrintf(b"EffectSoftSprite2_makeEffect():\xe3\x81\x99\xe3\x81\xa7\xe3\x81\xab\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe3\x81\xaf\xe3\x83\xad\xe3\x83\xbc\xe3\x83\x89\xe6\xb8\x88\xe3\x81\xbf\xe3\x81\xa7\n\xe3\x81\x99\xe3\x81\x8c,\xe3\x82\xb3\xe3\x83\xb3\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x82\xbf\xe3\x83\xbc\xe3\x81\x8cNULL\xe3\x81\xaa\xe3\x81\xae\xe3\x81\xa7\xe8\xbf\xbd\xe5\x8a\xa0\xe3\x82\x92\xe3\x82\x84\xe3\x82\x81\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82\n\xe7\x9b\xb4\xe3\x81\x97\xe3\x81\xa6\xe3\x81\x8f\xe3\x81\xa0\xe3\x81\x95\xe3\x81\x84\xe3\x80\x82\xef\xbc\x88\xe3\x83\xa1\xe3\x83\xa2\xe3\x83\xaa\xe3\x83\xbc\xe3\x81\xae\xe7\x84\xa1\xe9\xa7\x84) %08x %d\n\x00"
                         as *const u8 as *const libc::c_char, initInfo,
                     type_0);
        return
    }
    // Delete the previous effect in the slot, in case the slot wasn't free
    EffectSs_Delete(&mut *sEffectSsInfo.table.offset(index as isize));
    (*sEffectSsInfo.table.offset(index as isize)).type_0 = type_0 as u8_0;
    (*sEffectSsInfo.table.offset(index as isize)).priority = priority as u8_0;
    if (*initInfo).init.expect("non-null function pointer")(globalCtx,
                                                            index as u32_0,
                                                            &mut *sEffectSsInfo.table.offset(index
                                                                                                 as
                                                                                                 isize),
                                                            initParams) ==
        ...
        osSyncPrintf(b"EffectSoftSprite2_makeEffect():\n\x00"
                         as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
        EffectSs_Reset(&mut *sEffectSsInfo.table.offset(index as isize));
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Update(mut globalCtx: *mut GlobalContext,
                                         mut index: s32) {
    let mut effectSs: *mut EffectSs =
        &mut *sEffectSsInfo.table.offset(index as isize) as *mut EffectSs;
    if (*effectSs).update.is_some() {
        ...
        (*effectSs).update.expect("non-null function pointer")(globalCtx,
                                                               index as u32_0,
                                                               effectSs);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSs_UpdateAll(mut globalCtx:
                                                *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < sEffectSsInfo.tableSize {
        if (*sEffectSsInfo.table.offset(i as isize)).life as libc::c_int >
               -(1 as libc::c_int) {
            let ref mut fresh0 =
                (*sEffectSsInfo.table.offset(i as isize)).life;
            *fresh0 -= 1;
            if ((*sEffectSsInfo.table.offset(i as isize)).life as libc::c_int)
                   < 0 as libc::c_int {
                EffectSs_Delete(&mut *sEffectSsInfo.table.offset(i as isize));
            }
        }
        if (*sEffectSsInfo.table.offset(i as isize)).life as libc::c_int >
               -(1 as libc::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn EffectSs_Draw(mut globalCtx: *mut GlobalContext,
                                       mut index: s32) {
    let mut effectSs: *mut EffectSs =
        &mut *sEffectSsInfo.table.offset(index as isize) as *mut EffectSs;
    if (*effectSs).draw.is_some() {
        (*effectSs).draw.expect("non-null function pointer")(globalCtx,
                                                             index as u32_0,
                                                             effectSs);
    };
}
...
#[no_mangle]
pub unsafe extern "C" fn EffectSs_DrawAll(mut globalCtx: *mut GlobalContext) {
    let mut lights: *mut Lights =
        LightContext_NewLights(&mut (*globalCtx).lightCtx,
                               (*globalCtx).state.gfxCtx);
    let mut i: s32 = 0;
    Lights_BindAll(lights, (*globalCtx).lightCtx.listHead, 0 as *mut Vec3f);
    Lights_Draw(lights, (*globalCtx).state.gfxCtx);
    i = 0 as libc::c_int;
    while i < sEffectSsInfo.tableSize {
        if (*sEffectSsInfo.table.offset(i as isize)).life as libc::c_int >
               -(1 as libc::c_int) {
            if (*sEffectSsInfo.table.offset(i as isize)).pos.x > 32000.0f32 ||
                   (*sEffectSsInfo.table.offset(i as isize)).pos.x <
                       -32000.0f32 ||
                   (*sEffectSsInfo.table.offset(i as isize)).pos.y >
                       32000.0f32 ||
                   (*sEffectSsInfo.table.offset(i as isize)).pos.y <
                       -32000.0f32 ||
                   (*sEffectSsInfo.table.offset(i as isize)).pos.z >
                       32000.0f32 ||
                   (*sEffectSsInfo.table.offset(i as isize)).pos.z <
                       -32000.0f32 {
                osSyncPrintf(b"\x1b[31m\x00" as *const u8 as
                ...
                osSyncPrintf(b"EffectSoftSprite2_disp():\xe4\xbd\x8d\xe7\xbd\xae\xe3\x81\x8c\xe9\xa0\x98\xe5\x9f\x9f\xe5\xa4\x96\xe3\x81\xae\xe3\x81\x9f\xe3\x82\x81 \xe5\x89\x8a\xe9\x99\xa4\xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82\xe3\x82\xa8\xe3\x83\x95\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe3\x83\xa9\xe3\x83\x99\xe3\x83\xabNo.%d: ==> pos(%f, %f, %f)\xe3\x81\xa7\xe3\x80\x81\xe3\x83\xa9\xe3\x83\x99\xe3\x83\xab\xe3\x81\xafz_effect_soft_sprite_dlftbls.decl\xe3\x81\xab\xe3\x81\x82\xe3\x82\x8a\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82\n\x00"
                                 as *const u8 as *const libc::c_char,
                             (*sEffectSsInfo.table.offset(i as isize)).type_0
                                 as libc::c_int,
                             (*sEffectSsInfo.table.offset(i as isize)).pos.x
                                 as libc::c_double,
                             (*sEffectSsInfo.table.offset(i as isize)).pos.y
                ...
                osSyncPrintf(b"\xe3\x82\x82\xe3\x81\x97\xe3\x80\x81pos\xe3\x82\x92\xe5\x88\xa5\xe3\x81\xae\xe3\x81\x93\xe3\x81\xa8\xe3\x81\xab\xe4\xbd\xbf\xe3\x81\xa3\xe3\x81\xa6\xe3\x81\x84\xe3\x82\x8b\xe5\xa0\xb4\xe5\x90\x88\xe7\x9b\xb8\xe8\xab\x87\xe3\x81\xab\xe5\xbf\x9c\xe3\x81\x98\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82\n\x00"
                                 as *const u8 as *const libc::c_char);
                osSyncPrintf(b"\x1b[m\x00" as *const u8 as
                                 *const libc::c_char);
                EffectSs_Delete(&mut *sEffectSsInfo.table.offset(i as isize));
            } else { EffectSs_Draw(globalCtx, i); }
        }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80027DD4(mut arg0: s16, mut arg1: s16,
                                       mut arg2: s32) -> s16 {
    let mut ret: s16 =
        if arg2 == 0 as libc::c_int {
            ...
            (arg0 as libc::c_int) +
                ((arg1 as libc::c_int - arg0 as libc::c_int) as libc::c_float
                     / arg2 as f32_0) as s32
        } as s16;
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_80027E34(mut arg0: s16, mut arg1: s16,
                                       mut arg2: f32_0) -> s16 {
    return ((arg1 as libc::c_int - arg0 as libc::c_int) as libc::c_float *
                arg2 + arg0 as libc::c_int as libc::c_float) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80027E84(mut arg0: u8_0, mut arg1: u8_0,
                                       mut arg2: f32_0) -> u8_0 {
    return (arg2 * (arg1 as f32_0 - arg0 as f32_0) +
                arg0 as libc::c_int as libc::c_float) as u8_0;
}
