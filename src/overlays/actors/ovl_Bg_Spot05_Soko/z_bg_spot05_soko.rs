...
extern "C" {
    ...
    #[no_mangle]
    static mut object_spot05_objects_DL_000840: [Gfx; 0];
    #[no_mangle]
    static mut object_spot05_objects_Col_000918: CollisionHeader;
    #[no_mangle]
    static mut object_spot05_objects_DL_001190: [Gfx; 0];
    #[no_mangle]
    static mut object_spot05_objects_Col_0012C0: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot05Soko {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot05SokoActionFunc,
    pub switchFlag: s32,
}
pub type BgSpot05SokoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot05Soko, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot05_Soko_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT05_SOKO as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_SPOT05_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot05Soko>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot05Soko_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot05Soko_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot05Soko_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot05Soko_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDLists: [*mut Gfx; 2] =
    unsafe {
        [object_spot05_objects_DL_000840.as_ptr() as *mut _,
         object_spot05_objects_DL_001190.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgSpot05Soko_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut this: *mut BgSpot05Soko = thisx as *mut BgSpot05Soko;
    ...
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut object_spot05_objects_Col_000918 as
        ...
        if gSaveContext.linkAge == 0 as libc::c_int {
            ...
            (*this).actionFunc =
                Some(func_808AE5A8 as
                         unsafe extern "C" fn(_: *mut BgSpot05Soko,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
        CollisionHeader_GetVirtual(&mut object_spot05_objects_Col_0012C0 as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 as libc::c_int
           {
            Actor_Kill(thisx);
        } else {
            (*this).actionFunc =
                Some(func_808AE5B4 as
                         unsafe extern "C" fn(_: *mut BgSpot05Soko,
                                              _: *mut GlobalContext) -> ());
            (*thisx).flags |=
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot05Soko_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot05Soko = thisx as *mut BgSpot05Soko;
...
#[no_mangle]
pub unsafe extern "C" fn func_808AE5A8(mut this: *mut BgSpot05Soko,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808AE5B4(mut this: *mut BgSpot05Soko,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_808AE630(mut this: *mut BgSpot05Soko,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dyna.actor.speedXZ *= 1.5f32;
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y - 120.0f32,
                    (*this).dyna.actor.speedXZ) != 0 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot05Soko_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot05Soko = thisx as *mut BgSpot05Soko;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot05Soko_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
