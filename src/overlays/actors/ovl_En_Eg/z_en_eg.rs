...
pub const SEQ_PLAYER_BGM_SUB: C2RustUnnamed_17 = 3;
pub const SEQ_PLAYER_SFX: C2RustUnnamed_17 = 2;
pub const SEQ_PLAYER_FANFARE: C2RustUnnamed_17 = 1;
pub const SEQ_PLAYER_BGM_MAIN: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct GameInfo {
    pub regPage: s32,
...
pub type EnEgActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnEg, _: *mut GlobalContext) -> ()>;
static mut voided: s32 = 0 as libc::c_int;
static mut sActionFuncs: [EnEgActionFunc; 1] =
    unsafe {
        [Some(func_809FFDC8 as
                  unsafe extern "C" fn(_: *mut EnEg, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub static mut En_Eg_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_EG as libc::c_int as s16,
                          category:
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnEg>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnEg_PlayVoidOutSFX() {
    func_800788CC(0x5801 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnEg_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnEg_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEg = thisx as *mut EnEg;
    (*this).action = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809FFDC8(mut this: *mut EnEg,
                                       mut globalCtx: *mut GlobalContext) {
    if voided == 0 &&
           (gSaveContext.timer2Value as libc::c_int) < 1 as libc::c_int &&
           Flags_GetSwitch(globalCtx, 0x36 as libc::c_int) != 0 &&
        ...
        EnEg_PlayVoidOutSFX();
        voided = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnEg_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEg = thisx as *mut EnEg;
    let mut action: s32 = (*this).action;
    if action < 0 as libc::c_int || (0 as libc::c_int) < action ||
...
#[no_mangle]
pub unsafe extern "C" fn EnEg_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
}
