...
extern "C" {
    ...
    #[no_mangle]
    static mut gBrokenDrawbridgeDL: [Gfx; 0];
    #[no_mangle]
    static mut gBrokenDrawbridgeCol: CollisionHeader;
    #[no_mangle]
    static mut gBarbedWireFenceDL: [Gfx; 0];
    #[no_mangle]
    static mut gBarbedWireFenceCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot00Break {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut Bg_Spot00_Break_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT00_BREAK as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT00_BREAK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot00Break>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Break_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Break_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Break_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot00Break_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Break_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot00Break = thisx as *mut BgSpot00Break;
    let mut pad: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gBarbedWireFenceCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gBrokenDrawbridgeCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    }
    (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Break_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot00Break = thisx as *mut BgSpot00Break;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Break_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot00Break_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot00Break = thisx as *mut BgSpot00Break;
    if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gBarbedWireFenceDL.as_mut_ptr());
    } else { Gfx_DrawDListOpa(globalCtx, gBrokenDrawbridgeDL.as_mut_ptr()); };
}
