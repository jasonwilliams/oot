...
extern "C" {
    ...
    fn Item_DropCollectibleRandom(globalCtx: *mut GlobalContext,
                                  ...
                                  params: s16);
    #[no_mangle]
    fn EffectSsDeadDd_Spawn(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                            velocity: *mut Vec3f, accel: *mut Vec3f,
                            scale: s16, scaleStep: s16, primR: s16,
                            primG: s16, primB: s16, alpha: s16, envR: s16,
                            envG: s16, envB: s16, alphaStep: s16, life: s32);
    #[no_mangle]
    fn EffectSsDeadDs_SpawnStationary(globalCtx: *mut GlobalContext,
                                      pos: *mut Vec3f, scale: s16,
                                      scaleStep: s16, alpha: s16, life: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBeamosAnim: AnimationHeader;
    #[no_mangle]
    static mut gBeamosLaserDL: [Gfx; 0];
    #[no_mangle]
    static mut gBeamosSkel: SkeletonHeader;
    #[no_mangle]
    static mut gEffEnemyDeathFlame1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame9Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlame10Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffEnemyDeathFlameDL: [Gfx; 0];
}
...
pub struct EnVm {
    ...
    pub actionFunc: EnVmActionFunc,
    pub beamSightRange: f32_0,
    pub unk_21C: s32,
    pub timer: s32,
    pub beamPos1: Vec3f,
    pub beamPos2: Vec3f,
    ...
    pub beamScale: Vec3f,
    pub beamRot: Vec3s,
    pub beamTexScroll: s16,
    pub headRotY: s16,
    pub unk_25E: s16,
    pub unk_260: s16,
    pub beamSpeed: f32_0,
    pub colliderCylinder: ColliderCylinder,
    pub colliderQuad1: ColliderQuad,
    pub colliderQuad2: ColliderQuad,
}
pub type EnVmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnVm, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const BEAMOS_SMALL: C2RustUnnamed_22 = 1;
pub const BEAMOS_LARGE: C2RustUnnamed_22 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
    pub actor: Actor,
...
pub const BOMB_EXPLOSION: C2RustUnnamed_23 = 1;
pub const BOMB_BODY: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut En_Vm_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_VM as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_VM as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnVm>() as libc::c_ulong,
                          init:
...
static mut sQuadInit1: ColliderQuadInit =
    {
        let mut init =
...
static mut sQuadInit2: ColliderQuadInit =
    {
        let mut init =
            ColliderQuadInit{base:
                                 {
...
static mut D_80B2EAEC: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EAF8: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB04: Vec3f =
    { let mut init = Vec3f{x: 500.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB10: Vec3f =
    { let mut init = Vec3f{x: -500.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB1C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB28: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 1600.0f32,}; init };
static mut D_80B2EB34: Vec3f =
    { let mut init = Vec3f{x: 1000.0f32, y: 700.0f32, z: 2000.0f32,}; init };
static mut D_80B2EB40: Vec3f =
    { let mut init = Vec3f{x: 1000.0f32, y: -700.0f32, z: 2000.0f32,}; init };
static mut D_80B2EB4C: Vec3f =
    { let mut init = Vec3f{x: -1000.0f32, y: 700.0f32, z: 1500.0f32,}; init };
static mut D_80B2EB58: Vec3f =
    {
        let mut init = Vec3f{x: -1000.0f32, y: -700.0f32, z: 1500.0f32,};
        init
    };
static mut D_80B2EB64: Vec3f =
    { let mut init = Vec3f{x: 500.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB70: Vec3f =
    { let mut init = Vec3f{x: -500.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80B2EB7C: Vec3f =
    { let mut init = Vec3f{x: 0.4f32, y: 0.4f32, z: 0.4f32,}; init };
static mut D_80B2EB88: [*mut libc::c_void; 10] =
    unsafe {
        [gEffEnemyDeathFlame1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame5Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame6Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame7Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame8Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame9Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffEnemyDeathFlame10Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnVm_SetupAction(mut this: *mut EnVm,
                                          mut actionFunc: EnVmActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnVm = thisx as *mut EnVm;
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gBeamosSkel,
                   &mut gBeamosAnim, (*this).jointTable.as_mut_ptr(),
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).colliderCylinder, thisx,
                         &mut sCylinderInit);
    Collider_InitQuad(globalCtx, &mut (*this).colliderQuad1);
    Collider_SetQuad(globalCtx, &mut (*this).colliderQuad1, thisx,
                     &mut sQuadInit1);
    Collider_InitQuad(globalCtx, &mut (*this).colliderQuad2);
    Collider_SetQuad(globalCtx, &mut (*this).colliderQuad2, thisx,
                     &mut sQuadInit2);
    (*this).beamSightRange =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int) as libc::c_float
            * 40.0f32;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    (*thisx).naviEnemyId = 0x39 as libc::c_int as u8_0;
    if (*thisx).params as libc::c_int == BEAMOS_LARGE as libc::c_int {
        (*thisx).colChkInfo.health = 2 as libc::c_int as u8_0;
        Actor_SetScale(thisx, 0.014f32);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnVm = thisx as *mut EnVm;
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderCylinder);
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_SetupWait(mut this: *mut EnVm) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gBeamosAnim as *mut AnimationHeader as
                                   *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gBeamosAnim, 1.0f32,
                     frameCount, frameCount,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).unk_260 = 0 as libc::c_int as s16;
    (*this).unk_25E = (*this).unk_260;
    (*this).unk_21C = 0 as libc::c_int;
    (*this).timer = 10 as libc::c_int;
    EnVm_SetupAction(this,
                     Some(EnVm_Wait as
                              unsafe extern "C" fn(_: *mut EnVm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_Wait(mut this: *mut EnVm,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    let mut headRot: s16 = 0;
    let mut pad: s16 = 0;
    let mut pitch: s16 = 0;
    match (*this).unk_25E as libc::c_int {
        0 => {
            Math_SmoothStepToS(&mut (*this).beamRot.x,
            ...
            headRot =
                ((*this).actor.yawTowardsPlayer as libc::c_int -
                     (*this).headRotY as libc::c_int -
                     (*this).actor.shape.rot.y as libc::c_int) as s16;
            pitch =
                Math_Vec3f_Pitch(&mut (*this).beamPos1,
                                 &mut (*player).actor.world.pos);
            if pitch as libc::c_int > 0x1b91 as libc::c_int {
                pitch = 0x1b91 as libc::c_int as s16
            }
            dist = (*this).beamSightRange - (*this).actor.xzDistToPlayer;
            if (*this).actor.xzDistToPlayer <= (*this).beamSightRange &&
                   (if headRot as libc::c_int >= 0 as libc::c_int {
                        headRot as libc::c_int
                    } else { -(headRot as libc::c_int) }) <=
                       0x2710 as libc::c_int &&
                   pitch as libc::c_int >= 0xe38 as libc::c_int &&
                   (*this).actor.yDistToPlayer <= 80.0f32 &&
                   (*this).actor.yDistToPlayer >= -160.0f32 {
                Math_SmoothStepToS(&mut (*this).beamRot.x, pitch,
                                   10 as libc::c_int as s16,
                                   0xfa0 as libc::c_int as s16,
                                   0 as libc::c_int as s16);
                if Math_SmoothStepToS(&mut (*this).headRotY,
                                      ((*this).actor.yawTowardsPlayer as
                                           libc::c_int -
                                           (*this).actor.shape.rot.y as
                                               libc::c_int) as s16,
                                      1 as libc::c_int as s16,
                                      ((if (dist * 180.0f32) as s16 as
                                               libc::c_int >= 0 as libc::c_int
                                           {
                                            (dist * 180.0f32) as s16 as
                                                libc::c_int
                                        } else {
                                            -((dist * 180.0f32) as s16 as
                                                  libc::c_int)
                    ...
                    if (*this).timer == 0 as libc::c_int {
                        ...
                        (*this).skelAnime.startFrame = 0.0f32;
                        (*this).skelAnime.playSpeed = 2.0f32;
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x3973 as libc::c_int as u16_0);
                    }
                }
            } else {
                (*this).headRotY =
                    ((*this).headRotY as libc::c_int - 0x1f4 as libc::c_int)
                        as s16
            }
    ...
    Math_SmoothStepToS(&mut (*this).headRotY,
                       ((*this).actor.yawTowardsPlayer as libc::c_int -
                            (*this).actor.shape.rot.y as libc::c_int) as s16,
                       1 as libc::c_int as s16, 0x1f40 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).unk_260 += 1;
        (*this).skelAnime.curFrame = 0.0f32
    }
    if (*this).unk_260 as libc::c_int == 2 as libc::c_int {
        (*this).beamRot.y = (*this).actor.yawTowardsPlayer;
        (*this).beamRot.x =
            Math_Vec3f_Pitch(&mut (*this).beamPos1,
                             &mut (*player).actor.world.pos);
        if (*this).beamRot.x as libc::c_int > 0x1b91 as libc::c_int {
            (*this).beamRot.x = 0x1b91 as libc::c_int as s16
        }
        if ((*this).beamRot.x as libc::c_int) < 0xaaa as libc::c_int {
            ...
            EffectSsDeadDd_Spawn(globalCtx, &mut (*this).beamPos2,
                                 &mut D_80B2EAEC, &mut D_80B2EAEC,
                                 ...
                                 255 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
                                 16 as libc::c_int as s16, 20 as libc::c_int);
            EnVm_SetupAttack(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_SetupAttack(mut this: *mut EnVm) {
    Animation_Change(&mut (*this).skelAnime, &mut gBeamosAnim, 3.0f32, 3.0f32,
                     7.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).timer = 305 as libc::c_int;
    (*this).beamScale.x = 0.6f32;
    (*this).beamSpeed = 40.0f32;
    (*this).unk_21C = 1 as libc::c_int;
    (*this).colliderQuad1.base.atFlags =
        ((*this).colliderQuad1.base.atFlags as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Attack(mut this: *mut EnVm,
                                     mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).colliderQuad1.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).colliderQuad1.base.atFlags =
            ((*this).colliderQuad1.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        (*this).timer = 0 as libc::c_int;
        if (*this).beamScale.x > 0.1f32 { (*this).beamScale.x = 0.1f32 }
    }
    if ((*this).beamRot.x as libc::c_int) < 0xaaa as libc::c_int ||
           (*this).timer == 0 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).beamScale.x, 0.0f32, 1.0f32, 0.03f32,
                           0.0f32);
        (*this).unk_260 = 0 as libc::c_int as s16;
        if (*this).beamScale.x == 0.0f32 {
            (*this).beamScale.z = 0.0f32;
            (*this).beamScale.y = (*this).beamScale.z;
            EnVm_SetupWait(this);
        }
    } else {
        (*this).timer -= 1;
        if (*this).timer > 300 as libc::c_int { return }
        Math_SmoothStepToS(&mut (*this).headRotY,
                           (-((*this).actor.shape.rot.y as libc::c_int) +
                                (*this).actor.yawTowardsPlayer as libc::c_int)
                               as s16, 10 as libc::c_int as s16,
                           0xdac as libc::c_int as s16,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).beamRot.y,
        ...
        if (*player).actor.floorHeight > -32000.0f32 {
            playerPos.y = (*player).actor.floorHeight
        }
        dist = Math_Vec3f_DistXYZ(&mut (*this).beamPos1, &mut playerPos);
        Math_SmoothStepToF(&mut (*this).beamScale.z, dist, 1.0f32,
                           (*this).beamSpeed, 0.0f32);
        Math_SmoothStepToF(&mut (*this).beamScale.x, 0.1f32, 1.0f32, 0.12f32,
                           0.0f32);
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x3971 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        if (*this).unk_260 as libc::c_int > 2 as libc::c_int {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colliderQuad1.base);
        }
        (*this).unk_260 = 3 as libc::c_int as s16
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_SetupStun(mut this: *mut EnVm) {
    Animation_Change(&mut (*this).skelAnime, &mut gBeamosAnim, -1.0f32,
                     Animation_GetLastFrame(&mut gBeamosAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).unk_260 = 0 as libc::c_int as s16;
    (*this).timer = 180 as libc::c_int;
    (*this).unk_25E = (*this).unk_260;
    (*this).unk_21C = 2 as libc::c_int;
    (*this).beamScale.z = 0.0f32;
    (*this).beamScale.y = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Stun(mut this: *mut EnVm,
                                   mut globalCtx: *mut GlobalContext) {
    if (*this).timer == 0 as libc::c_int {
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
            (*this).unk_25E += 1;
            if (*this).unk_25E as libc::c_int == 3 as libc::c_int {
                EnVm_SetupWait(this);
            } else if (*this).unk_25E as libc::c_int == 1 as libc::c_int {
                Animation_Change(&mut (*this).skelAnime, &mut gBeamosAnim,
                                 1.0f32, 0.0f32,
                                 Animation_GetLastFrame(&mut gBeamosAnim as
                                                            *mut AnimationHeader
                                                            as
        ...
        Math_SmoothStepToS(&mut (*this).beamRot.x, 0 as libc::c_int as s16,
                           10 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_SetupDie(mut this: *mut EnVm) {
    Animation_Change(&mut (*this).skelAnime, &mut gBeamosAnim, -1.0f32,
                     Animation_GetLastFrame(&mut gBeamosAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).timer = 33 as libc::c_int;
    (*this).unk_260 = 0 as libc::c_int as s16;
    (*this).unk_25E = (*this).unk_260;
    (*this).unk_21C = 3 as libc::c_int;
    (*this).beamScale.z = 0.0f32;
    (*this).beamScale.y = 0.0f32;
    (*this).actor.shape.yOffset = -5000.0f32;
    (*this).actor.world.pos.y += 5000.0f32 * (*this).actor.scale.y;
    (*this).actor.velocity.y = 8.0f32;
    (*this).actor.gravity = -0.5f32;
    (*this).actor.speedXZ = Rand_ZeroOne() + 1.0f32;
    (*this).actor.world.rot.y = Rand_CenteredFloat(65535.0f32) as s16;
    EnVm_SetupAction(this,
                     Some(EnVm_Die as
                              unsafe extern "C" fn(_: *mut EnVm,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Die(mut this: *mut EnVm,
                                  mut globalCtx: *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    (*this).beamRot.x =
        ((*this).beamRot.x as libc::c_int + 0x5dc as libc::c_int) as s16;
    (*this).headRotY =
        ((*this).headRotY as libc::c_int + 0x9c4 as libc::c_int) as s16;
    ...
    if (*this).timer == 0 as libc::c_int {
        bomb =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        0 as libc::c_int as s16, 0x6ff as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_CheckHealth(mut this: *mut EnVm,
                                          mut globalCtx: *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    if !Actor_GetCollidedExplosive(globalCtx,
                                   &mut (*this).colliderCylinder.base).is_null()
       {
        (*this).actor.colChkInfo.health =
            (*this).actor.colChkInfo.health.wrapping_sub(1);
        osSyncPrintf(b"hp down %d\n\x00" as *const u8 as *const libc::c_char,
                     (*this).actor.colChkInfo.health as libc::c_int);
    } else {
        if (*this).colliderQuad2.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int == 0 ||
               (*this).unk_21C == 2 as libc::c_int {
            return
        }
        (*this).colliderQuad2.base.acFlags =
            ((*this).colliderQuad2.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
    }
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int {
        ...
        bomb =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16, 0x601 as libc::c_int as s16,
                        BOMB_BODY as libc::c_int as s16) as *mut EnBom;
        if !bomb.is_null() { (*bomb).timer = 0 as libc::c_int as s16 }
        EnVm_SetupDie(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnVm = thisx as *mut EnVm;
    let mut colChkCtx: *mut CollisionCheckContext =
        &mut (*globalCtx).colChkCtx;
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int {
        EnVm_CheckHealth(this, globalCtx);
    }
    if (*this).unk_260 as libc::c_int == 4 as libc::c_int {
        EffectSsDeadDs_SpawnStationary(globalCtx, &mut (*this).beamPos3,
                                       20 as libc::c_int as s16,
                                       -(1 as libc::c_int) as s16,
                                       255 as libc::c_int as s16,
                                       20 as libc::c_int);
        func_80033480(globalCtx, &mut (*this).beamPos3, 6.0f32,
                      1 as libc::c_int, 120 as libc::c_int as s16,
                      20 as libc::c_int as s16, 1 as libc::c_int as u8_0);
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x3972 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    (*this).beamTexScroll =
        ((*this).beamTexScroll as libc::c_int + 0xc as libc::c_int) as s16;
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int &&
           (*this).unk_21C != 2 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x3970 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    }
    Collider_UpdateCylinder(&mut (*this).actor,
                            &mut (*this).colliderCylinder);
    CollisionCheck_SetOC(globalCtx, colChkCtx,
    ...
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int &&
       ...
       {
        CollisionCheck_SetAC(globalCtx, colChkCtx,
                             &mut (*this).colliderCylinder.base);
    }
    CollisionCheck_SetAC(globalCtx, colChkCtx,
                         &mut (*this).colliderQuad2.base);
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actor.focus.pos.y +=
        (6500.0f32 + (*this).actor.shape.yOffset) * (*this).actor.scale.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 2 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).beamRot.x as libc::c_int) as
                s16;
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).headRotY as libc::c_int) as s16
    } else if limbIndex == 10 as libc::c_int {
        if (*this).unk_21C == 3 as libc::c_int { *dList = 0 as *mut Gfx }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnVm_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnVm = thisx as *mut EnVm;
    let mut sp80: Vec3f = D_80B2EAF8;
    let mut sp74: Vec3f = D_80B2EB04;
    let mut sp68: Vec3f = D_80B2EB10;
    let mut pad: s32 = 0;
    ...
    let mut dist: f32_0 = 0.;
    if limbIndex == 2 as libc::c_int {
        Matrix_MultVec3f(&mut D_80B2EB1C, &mut (*this).beamPos1);
        Matrix_MultVec3f(&mut D_80B2EB28, &mut (*this).beamPos2);
        if (*this).unk_260 as libc::c_int >= 3 as libc::c_int {
            poly = 0 as *mut CollisionPoly;
            sp80.z =
                ((*this).beamScale.z + 500.0f32) *
                    ((*this).actor.scale.y * 10000.0f32);
            Matrix_MultVec3f(&mut sp80, &mut (*this).beamPos3);
            if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                                       &mut (*this).beamPos1,
                                       &mut (*this).beamPos3, &mut posResult,
                                       &mut poly, 1 as libc::c_int,
                                       1 as libc::c_int, 0 as libc::c_int,
                                       1 as libc::c_int, &mut bgId) ==
                   1 as libc::c_int {
                (*this).beamScale.z =
                    Math_Vec3f_DistXYZ(&mut (*this).beamPos1, &mut posResult)
                        - 5.0f32;
                (*this).unk_260 = 4 as libc::c_int as s16;
                (*this).beamPos3 = posResult
            }
            if (*this).beamScale.z != 0.0f32 {
                dist = 100.0f32;
                if (*this).actor.scale.y > 0.01f32 { dist = 70.0f32 }
                sp68.z =
                    Math_Vec3f_DistXYZ(&mut (*this).beamPos1,
                                       &mut (*this).beamPos3) * dist;
                sp74.z = sp68.z;
                Matrix_MultVec3f(&mut D_80B2EB64,
                                 &mut *(*this).colliderQuad1.dim.quad.as_mut_ptr().offset(3
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
                                                                                              isize));
                Matrix_MultVec3f(&mut D_80B2EB70,
                                 &mut *(*this).colliderQuad1.dim.quad.as_mut_ptr().offset(2
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
                                                                                              isize));
                Matrix_MultVec3f(&mut sp74,
                                 &mut *(*this).colliderQuad1.dim.quad.as_mut_ptr().offset(1
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
                                                                                              isize));
                Matrix_MultVec3f(&mut sp68,
                                 &mut *(*this).colliderQuad1.dim.quad.as_mut_ptr().offset(0
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
                                                                                              isize));
                Collider_SetQuadVertices(&mut (*this).colliderQuad1,
                                         &mut *(*this).colliderQuad1.dim.quad.as_mut_ptr().offset(0
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
        ...
        Matrix_MultVec3f(&mut D_80B2EB34,
                         &mut *(*this).colliderQuad2.dim.quad.as_mut_ptr().offset(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize));
        Matrix_MultVec3f(&mut D_80B2EB40,
                         &mut *(*this).colliderQuad2.dim.quad.as_mut_ptr().offset(0
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize));
        Matrix_MultVec3f(&mut D_80B2EB4C,
                         &mut *(*this).colliderQuad2.dim.quad.as_mut_ptr().offset(3
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize));
        Matrix_MultVec3f(&mut D_80B2EB58,
                         &mut *(*this).colliderQuad2.dim.quad.as_mut_ptr().offset(2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize));
        Collider_SetQuadVertices(&mut (*this).colliderQuad2,
                                 &mut *(*this).colliderQuad2.dim.quad.as_mut_ptr().offset(0
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
...
#[no_mangle]
pub unsafe extern "C" fn EnVm_Draw(mut thisx: *mut Actor,
                                   mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnVm = thisx as *mut EnVm;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut actorPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_vm.c\x00" as *const u8 as *const libc::c_char,
                    1014 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    func_80093D84((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnVm_OverrideLimbDraw as
    ...
    func_80033C30(&mut actorPos, &mut D_80B2EB7C, 255 as libc::c_int as u8_0,
                  globalCtx);
    if (*this).unk_260 as libc::c_int >= 3 as libc::c_int {
        Matrix_Translate((*this).beamPos3.x, (*this).beamPos3.y + 10.0f32,
                         (*this).beamPos3.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_Scale(0.8f32, 0.8f32, 0.8f32,
        ...
        (*_g).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_vm.c\x00" as *const u8 as
        ...
        (*_g_2).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gSegments[((D_80B2EB88[(*globalCtx).gameplayFrames.wrapping_rem(8
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                libc::c_uint)
                                       as usize] as u32_0) << 4 as libc::c_int
                           >> 28 as libc::c_int) as
                          usize].wrapping_add(D_80B2EB88[(*globalCtx).gameplayFrames.wrapping_rem(8
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint)
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gEffEnemyDeathFlameDL.as_mut_ptr() as libc::c_uint;
        Matrix_RotateY(32767.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_5).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_5).words.w1 =
            gSegments[((D_80B2EB88[(*globalCtx).gameplayFrames.wrapping_add(4
                                                                                as
                                                                                libc::c_int
                                                                                as
                                       ...
                                       as usize] as u32_0) << 4 as libc::c_int
                           >> 28 as libc::c_int) as
                          usize].wrapping_add(D_80B2EB88[(*globalCtx).gameplayFrames.wrapping_add(4
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint).wrapping_rem(8
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = gEffEnemyDeathFlameDL.as_mut_ptr() as libc::c_uint
    }
    ...
    (*_g_7).words.w1 =
        func_80094E78((*globalCtx).state.gfxCtx, 0 as libc::c_int as u32_0,
                      (*this).beamTexScroll as u32_0) as libc::c_uint;
    Matrix_Translate((*this).beamPos1.x, (*this).beamPos1.y,
                     (*this).beamPos1.z, MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateZYX((*this).beamRot.x, (*this).beamRot.y, (*this).beamRot.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale((*this).beamScale.x * 0.1f32, (*this).beamScale.x * 0.1f32,
                 (*this).beamScale.z * 0.0015f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_8).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_vm.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 1063 as libc::c_int) as
            libc::c_uint;
    ...
    (*_g_9).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_9).words.w1 = gBeamosLaserDL.as_mut_ptr() as libc::c_uint;
