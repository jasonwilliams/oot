...
#[no_mangle]
pub unsafe extern "C" fn osViSwapBuffer(mut vaddr: *mut libc::c_void) {
    let mut prevInt: u32_0 =
        __osDisableInt() as u32_0; // TODO: figure out what this flag means
    (*__osViNext).buffer = vaddr;
    (*__osViNext).state =
        ((*__osViNext).state as libc::c_int | 0x10 as libc::c_int) as u16_0;
