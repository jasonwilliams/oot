...
extern "C" {
    ...
    #[no_mangle]
    static mut gHookshotPostDL: [Gfx; 0];
    #[no_mangle]
    static mut gHookshotTargetDL: [Gfx; 0];
    #[no_mangle]
    static mut gHookshotPostCol: CollisionHeader;
    #[no_mangle]
    static mut gHookshotTargetCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjHsblock {
    pub dyna: DynaPolyActor,
    pub actionFunc: ObjHsblockActionFunc,
}
pub type ObjHsblockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjHsblock, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Hsblock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_HSBLOCK as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_D_HSBLOCK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjHsblock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHsblock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHsblock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHsblock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHsblock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80B940C0: [f32_0; 3] = [85.0f32, 85.0f32, 0.0f32];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut sCollisionHeaders: [*mut CollisionHeader; 3] =
    unsafe {
        [&gHookshotTargetCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gHookshotTargetCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gHookshotPostCol as *const CollisionHeader as *mut CollisionHeader]
    };
static mut sFireTempleColor: Color_RGB8 =
    {
        let mut init =
...
static mut sDLists: [*mut Gfx; 3] =
    unsafe {
        [gHookshotPostDL.as_ptr() as *mut _,
         gHookshotPostDL.as_ptr() as *mut _,
         gHookshotTargetDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn ObjHsblock_SetupAction(mut this: *mut ObjHsblock,
                                                mut actionFunc:
                                                    ObjHsblockActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B93B68(mut this: *mut ObjHsblock,
    ...
    DynaPolyActor_Init(&mut (*this).dyna, moveFlags);
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_obj_hsblock.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B93BF0(mut this: *mut ObjHsblock,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHsblock_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjHsblock = thisx as *mut ObjHsblock;
    func_80B93B68(this, globalCtx,
                  sCollisionHeaders[((*thisx).params as libc::c_int &
    ...
    match (*thisx).params as libc::c_int & 3 as libc::c_int {
        0 | 2 => { func_80B93D90(this); }
        1 => {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHsblock_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut ObjHsblock = thisx as *mut ObjHsblock;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B93D90(mut this: *mut ObjHsblock) {
    ObjHsblock_SetupAction(this, None);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B93DB0(mut this: *mut ObjHsblock) {
    (*this).dyna.actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
    (*this).dyna.actor.world.pos.y = (*this).dyna.actor.home.pos.y - 105.0f32;
    ObjHsblock_SetupAction(this,
                           Some(func_80B93DF4 as
                                    unsafe extern "C" fn(_: *mut ObjHsblock,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80B93DF4(mut this: *mut ObjHsblock,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
...
#[no_mangle]
pub unsafe extern "C" fn func_80B93E38(mut this: *mut ObjHsblock) {
    ObjHsblock_SetupAction(this,
                           Some(func_80B93E5C as
                                    unsafe extern "C" fn(_: *mut ObjHsblock,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn func_80B93E5C(mut this: *mut ObjHsblock,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).dyna.actor.velocity.y, 16.0f32, 0.1f32,
                       0.8f32, 0.0f32);
    if fabsf(Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                                (*this).dyna.actor.home.pos.y, 0.3f32,
                                (*this).dyna.actor.velocity.y, 0.3f32)) <
           0.001f32 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHsblock_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjHsblock = thisx as *mut ObjHsblock;
    ...
    Actor_SetFocus(thisx,
                   D_80B940C0[((*thisx).params as libc::c_int &
                                   3 as libc::c_int) as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn ObjHsblock_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut color: *mut Color_RGB8 = 0 as *mut Color_RGB8;
    let mut defaultColor: Color_RGB8 = Color_RGB8{r: 0, g: 0, b: 0,};
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_hsblock.c\x00" as *const u8 as
                        *const libc::c_char, 365 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        sDLists[((*thisx).params as libc::c_int & 3 as libc::c_int) as usize]
            as libc::c_uint;
