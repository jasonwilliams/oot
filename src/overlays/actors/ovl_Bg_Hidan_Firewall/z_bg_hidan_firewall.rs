...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleFireballUpperHalfDL: [Gfx; 0];
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanFirewall {
    pub actor: Actor,
    pub actionFunc: BgHidanFirewallActionFunc,
    pub unk_150: s16,
    pub collider: ColliderCylinder,
}
pub type BgHidanFirewallActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanFirewall,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Firewall_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_FIREWALL as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanFirewall>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFirewall_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFirewall_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFirewall_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanFirewall = thisx as *mut BgHidanFirewall;
    (*this).actor.scale.x = 0.12f32;
    (*this).actor.scale.z = 0.12f32;
    (*this).actor.scale.y = 0.01f32;
    (*this).unk_150 = 0 as libc::c_int as s16;
    ...
    (*this).actionFunc =
        Some(BgHidanFirewall_Wait as
                 unsafe extern "C" fn(_: *mut BgHidanFirewall,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgHidanFirewall = thisx as *mut BgHidanFirewall;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_CheckProximity(mut this:
                                                            *mut BgHidanFirewall,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    ...
    func_8002DBD0(&mut (*this).actor, &mut distance,
                  &mut (*player).actor.world.pos);
    if fabsf(distance.x) < 100.0f32 && fabsf(distance.z) < 120.0f32 {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Wait(mut this: *mut BgHidanFirewall,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if BgHidanFirewall_CheckProximity(this, globalCtx) != 0 as libc::c_int {
        (*this).actor.draw =
            Some(BgHidanFirewall_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.params = 5 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgHidanFirewall_Countdown as
                     unsafe extern "C" fn(_: *mut BgHidanFirewall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Countdown(mut this:
                                                       *mut BgHidanFirewall,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgHidanFirewall_Erupt as
                     unsafe extern "C" fn(_: *mut BgHidanFirewall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Erupt(mut this: *mut BgHidanFirewall,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if BgHidanFirewall_CheckProximity(this, globalCtx) != 0 as libc::c_int {
        Math_StepToF(&mut (*this).actor.scale.y, 0.1f32, 0.01f32 / 0.4f32);
    } else if Math_StepToF(&mut (*this).actor.scale.y, 0.01f32, 0.01f32) !=
                  0 as libc::c_int {
        ...
        (*this).actionFunc =
            Some(BgHidanFirewall_Wait as
                     unsafe extern "C" fn(_: *mut BgHidanFirewall,
                                          _: *mut GlobalContext) -> ())
    } else { (*this).actor.params = 0 as libc::c_int as s16 };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Collide(mut this:
                                                     *mut BgHidanFirewall,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut phi_a3: s16 = 0;
    if Actor_IsFacingPlayer(&mut (*this).actor, 0x4000 as libc::c_int as s16)
           != 0 {
    ...
    func_8002F71C(globalCtx, &mut (*this).actor, 5.0f32, phi_a3, 1.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_ColliderFollowPlayer(mut this:
                                                                  *mut BgHidanFirewall,
                                                              mut globalCtx:
                                                                  *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    ...
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    func_8002DBD0(&mut (*this).actor, &mut sp30,
                  &mut (*player).actor.world.pos);
    if sp30.x < -70.0f32 {
        sp30.x = -70.0f32
    } else {
        if 70.0f32 < sp30.x { phi_f0 = 70.0f32 } else { phi_f0 = sp30.x }
        sp30.x = phi_f0
    }
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        if 0.0f32 < sp30.z {
        ...
        sp30.z =
            (*this).actor.params as libc::c_int as libc::c_float * 25.0f32
    }
    sp28 = Math_SinS((*this).actor.shape.rot.y);
    temp_ret = Math_CosS((*this).actor.shape.rot.y);
    (*this).collider.dim.pos.x =
        ((*this).actor.world.pos.x + sp30.x * temp_ret + sp30.z * sp28) as
            s16;
    (*this).collider.dim.pos.z =
        ((*this).actor.world.pos.z - sp30.x * sp28 + sp30.z * temp_ret) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgHidanFirewall = thisx as *mut BgHidanFirewall;
    let mut pad: s32 = 0;
    ...
    if (*this).actionFunc ==
        ...
        func_8002F974(&mut (*this).actor,
                      (0x2834 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
static mut sFireballTexs: [*mut libc::c_void; 8] =
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFirewall_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanFirewall = thisx as *mut BgHidanFirewall;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_firewall.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        gSegments[((sFireballTexs[(*this).unk_150 as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sFireballTexs[(*this).unk_150 as
                                                            usize] as u32_0 &
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gFireTempleFireballUpperHalfDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_hidan_firewall.c\x00" as *const u8 as
                         *const libc::c_char, 463 as libc::c_int);
}
