...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsStone1_Spawn(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                            arg2: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_8002D9A4(actor: *mut Actor, arg1: f32_0);
    #[no_mangle]
    ...
    fn BgCheck_EntityLineTest1(colCtx: *mut CollisionContext,
                               ...
                               bgId: *mut s32) -> s32;
    #[no_mangle]
    fn BgCheck_ProjectileLineTest(colCtx: *mut CollisionContext,
                                  posA: *mut Vec3f, posB: *mut Vec3f,
                                  posResult: *mut Vec3f,
                                  outPoly: *mut *mut CollisionPoly,
                                  chkWall: s32, chkFloor: s32, chkCeil: s32,
                                  chkOneFace: s32, bgId: *mut s32) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_80090480(globalCtx: *mut GlobalContext,
                     collider: *mut ColliderQuad, weaponDim: *mut WeaponInfo,
                     newTip: *mut Vec3f, newBase: *mut Vec3f) -> u8_0;
    #[no_mangle]
    fn func_80093C14(gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    fn func_80093D18(gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    fn SkelAnime_DrawLod(globalCtx: *mut GlobalContext,
    ...
    fn Graph_CloseDisps(dispRefs: *mut *mut Gfx, gfxCtx: *mut GraphicsContext,
                        file: *const libc::c_char, line: s32);
    #[no_mangle]
    fn Math3D_Vec3fMagnitudeSq(vec: *mut Vec3f) -> f32_0;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gArrow1Anim: AnimationHeader;
    #[no_mangle]
    static mut gArrow2Anim: AnimationHeader;
    #[no_mangle]
    static mut gArrowSkel: SkeletonHeader;
    #[no_mangle]
    static mut gEffSparklesDL: [Gfx; 0];
}
...
pub const ARROW_NUT: C2RustUnnamed_23 = 10;
pub const ARROW_SEED: C2RustUnnamed_23 = 9;
pub const ARROW_0E: C2RustUnnamed_23 = 8;
pub const ARROW_0D: C2RustUnnamed_23 = 7;
pub const ARROW_0C: C2RustUnnamed_23 = 6;
pub const ARROW_LIGHT: C2RustUnnamed_23 = 5;
pub const ARROW_ICE: C2RustUnnamed_23 = 4;
pub const ARROW_FIRE: C2RustUnnamed_23 = 3;
pub const ARROW_NORMAL: C2RustUnnamed_23 = 2;
pub const ARROW_NORMAL_HORSE: C2RustUnnamed_23 = 1;
pub const ARROW_NORMAL_LIT: C2RustUnnamed_23 = 0;
pub const ARROW_NORMAL_SILENT: C2RustUnnamed_23 = -1;
pub const ARROW_CS_NUT: C2RustUnnamed_23 = -10;
#[no_mangle]
pub static mut En_Arrow_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ARROW as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnArrow_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColliderInit: ColliderQuadInit =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnArrow_SetupAction(mut this: *mut EnArrow,
                                             mut actionFunc:
                                                 EnArrowActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    static mut blureNormal: EffectBlureInit2 =
        {
            let mut init =
                EffectBlureInit2{calcMode: 0 as libc::c_int,
                                 flags: 4 as libc::c_int as u16_0,
                                 ...
                                 p2EndColor:
                                     [0 as libc::c_int as u8_0,
                                      ...
                                      255 as libc::c_int as u8_0,
                                      0 as libc::c_int as u8_0],
                                 elemDuration: 16 as libc::c_int as u8_0,
                                 unkFlag: 0 as libc::c_int as u8_0,
                                 drawMode: 1 as libc::c_int as u8_0,
    ...
    static mut blureFire: EffectBlureInit2 =
        {
            let mut init =
                EffectBlureInit2{calcMode: 0 as libc::c_int,
                                 flags: 4 as libc::c_int as u16_0,
    ...
    static mut blureIce: EffectBlureInit2 =
        {
            let mut init =
                EffectBlureInit2{calcMode: 0 as libc::c_int,
                                 flags: 4 as libc::c_int as u16_0,
    ...
    static mut blureLight: EffectBlureInit2 =
        {
            let mut init =
                EffectBlureInit2{calcMode: 0 as libc::c_int,
                                 flags: 4 as libc::c_int as u16_0,
    ...
    static mut dmgFlags: [u32_0; 10] =
        [0x800 as libc::c_int as u32_0, 0x20 as libc::c_int as u32_0,
         0x20 as libc::c_int as u32_0, 0x800 as libc::c_int as u32_0,
         0x1000 as libc::c_int as u32_0, 0x2000 as libc::c_int as u32_0,
         0x10000 as libc::c_int as u32_0, 0x4000 as libc::c_int as u32_0,
         0x8000 as libc::c_int as u32_0, 0x4 as libc::c_int as u32_0];
    let mut this: *mut EnArrow = thisx as *mut EnArrow;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    if (*this).actor.params as libc::c_int == ARROW_CS_NUT as libc::c_int {
        (*this).isCsNut = 1 as libc::c_int as u8_0;
        (*this).actor.params = ARROW_NUT as libc::c_int as s16
    }
    if (*this).actor.params as libc::c_int <= ARROW_SEED as libc::c_int {
        if (*this).actor.params as libc::c_int <= ARROW_0E as libc::c_int {
            SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gArrowSkel,
                           &mut gArrow2Anim, 0 as *mut Vec3s, 0 as *mut Vec3s,
                           0 as libc::c_int);
        }
        if (*this).actor.params as libc::c_int <= ARROW_NORMAL as libc::c_int
           {
            if (*this).actor.params as libc::c_int ==
                   ARROW_NORMAL_HORSE as libc::c_int {
                blureNormal.elemDuration = 4 as libc::c_int as u8_0
            } else { blureNormal.elemDuration = 16 as libc::c_int as u8_0 }
            Effect_Add(globalCtx, &mut (*this).effectIndex,
                       EFFECT_BLURE2 as libc::c_int, 0 as libc::c_int as u8_0,
                       0 as libc::c_int as u8_0,
                       &mut blureNormal as *mut EffectBlureInit2 as
                           *mut libc::c_void);
        } else if (*this).actor.params as libc::c_int ==
                      ARROW_FIRE as libc::c_int {
            Effect_Add(globalCtx, &mut (*this).effectIndex,
                       EFFECT_BLURE2 as libc::c_int, 0 as libc::c_int as u8_0,
                       0 as libc::c_int as u8_0,
                       &mut blureFire as *mut EffectBlureInit2 as
                           *mut libc::c_void);
        } else if (*this).actor.params as libc::c_int ==
                      ARROW_ICE as libc::c_int {
            Effect_Add(globalCtx, &mut (*this).effectIndex,
                       EFFECT_BLURE2 as libc::c_int, 0 as libc::c_int as u8_0,
                       0 as libc::c_int as u8_0,
                       &mut blureIce as *mut EffectBlureInit2 as
                           *mut libc::c_void);
        } else if (*this).actor.params as libc::c_int ==
                      ARROW_LIGHT as libc::c_int {
            Effect_Add(globalCtx, &mut (*this).effectIndex,
                       EFFECT_BLURE2 as libc::c_int, 0 as libc::c_int as u8_0,
                       0 as libc::c_int as u8_0,
                       &mut blureLight as *mut EffectBlureInit2 as
                           *mut libc::c_void);
        }
        Collider_InitQuad(globalCtx, &mut (*this).collider);
        Collider_SetQuad(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sColliderInit);
        if (*this).actor.params as libc::c_int <= ARROW_NORMAL as libc::c_int
           {
            (*this).collider.info.toucherFlags =
                ((*this).collider.info.toucherFlags as libc::c_int &
            ...
            (*this).collider.base.atFlags =
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int) as u8_0
                      ...
                      ARROW_SEED as libc::c_int {
            (*this).collider.info.toucher.dmgFlags =
                dmgFlags[(*this).actor.params as usize];
            LogUtils_LogThreadId(b"../z_en_arrow.c\x00" as *const u8 as
                                     *const libc::c_char, 707 as libc::c_int);
            osSyncPrintf(b"this->at_info.cl_elem.at_btl_info.at_type = %x\n\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).collider.info.toucher.dmgFlags);
        }
    }
    EnArrow_SetupAction(this,
                        Some(EnArrow_Shoot as
                                 unsafe extern "C" fn(_: *mut EnArrow,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnArrow = thisx as *mut EnArrow;
    if (*this).actor.params as libc::c_int <= ARROW_LIGHT as libc::c_int {
        Effect_Delete(globalCtx, (*this).effectIndex);
    }
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
    Collider_DestroyQuad(globalCtx, &mut (*this).collider);
    if !(*this).hitActor.is_null() && (*(*this).hitActor).update.is_some() {
        (*(*this).hitActor).flags &=
            !((1 as libc::c_int) << 15 as libc::c_int) as libc::c_uint
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Shoot(mut this: *mut EnArrow,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.parent.is_null() {
        if (*this).actor.params as libc::c_int != ARROW_NUT as libc::c_int &&
        ...
        match (*this).actor.params as libc::c_int {
            9 => {
                func_8002F7DC(&mut (*player).actor,
                              0x1820 as libc::c_int as u16_0);
            }
            0 | 1 | 2 => {
                func_8002F7DC(&mut (*player).actor,
                              0x1804 as libc::c_int as u16_0);
            }
            3 | 4 | 5 => {
                func_8002F7DC(&mut (*player).actor,
                              0x1839 as libc::c_int as u16_0);
            }
            _ => { }
        }
        EnArrow_SetupAction(this,
                            Some(EnArrow_Fly as
                                     unsafe extern "C" fn(_: *mut EnArrow,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        Math_Vec3f_Copy(&mut (*this).unk_210, &mut (*this).actor.world.pos);
        if (*this).actor.params as libc::c_int >= ARROW_SEED as libc::c_int {
            func_8002D9A4(&mut (*this).actor, 80.0f32);
            (*this).timer = 15 as libc::c_int as u8_0;
            (*this).actor.shape.rot.z = 0 as libc::c_int as s16;
            (*this).actor.shape.rot.y = (*this).actor.shape.rot.z;
            (*this).actor.shape.rot.x = (*this).actor.shape.rot.y
        } else {
            func_8002D9A4(&mut (*this).actor, 150.0f32);
            (*this).timer = 12 as libc::c_int as u8_0
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B3CEC(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut EnArrow) {
    EnArrow_SetupAction(this,
                        Some(func_809B4640 as
                                 unsafe extern "C" fn(_: *mut EnArrow,
                                                      _: *mut GlobalContext)
                                     -> ()));
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gArrow1Anim);
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             ((24576.0f32 * (Rand_ZeroOne() - 0.5f32)) as s32 +
                  0x8000 as libc::c_int)) as s16;
    (*this).actor.velocity.y +=
        (*this).actor.speedXZ * (0.4f32 + 0.4f32 * Rand_ZeroOne());
    (*this).actor.speedXZ *= 0.04f32 + 0.3f32 * Rand_ZeroOne();
    (*this).timer = 50 as libc::c_int as u8_0;
    (*this).actor.gravity = -1.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnArrow_CarryActor(mut this: *mut EnArrow,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut hitPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut posDiffLastFrame: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut actorNextPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut hitPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_f12: f32_0 = 0.;
    let mut scale: f32_0 = 0.;
    let mut bgId: s32 = 0;
    Math_Vec3f_Diff(&mut (*this).actor.world.pos, &mut (*this).unk_210,
                    &mut posDiffLastFrame);
    temp_f12 =
        ((*this).actor.world.pos.x - (*(*this).hitActor).world.pos.x) *
            posDiffLastFrame.x +
            ((*this).actor.world.pos.y - (*(*this).hitActor).world.pos.y) *
                posDiffLastFrame.y +
            ((*this).actor.world.pos.z - (*(*this).hitActor).world.pos.z) *
                posDiffLastFrame.z;
    if !(temp_f12 < 0.0f32) {
        scale = Math3D_Vec3fMagnitudeSq(&mut posDiffLastFrame);
        if !(scale < 1.0f32) {
            scale = temp_f12 / scale;
            Math_Vec3f_Scale(&mut posDiffLastFrame, scale);
            Math_Vec3f_Sum(&mut (*(*this).hitActor).world.pos,
                           &mut posDiffLastFrame, &mut actorNextPos);
            if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                                       &mut (*(*this).hitActor).world.pos,
                                       &mut actorNextPos, &mut hitPos,
                                       &mut hitPoly, 1 as libc::c_int,
                                       1 as libc::c_int, 1 as libc::c_int,
                                       1 as libc::c_int, &mut bgId) != 0 {
                (*(*this).hitActor).world.pos.x =
                    hitPos.x +
                        (if actorNextPos.x <= hitPos.x {
                             1.0f32
                         } else { -1.0f32 });
                (*(*this).hitActor).world.pos.y =
                    hitPos.y +
                        (if actorNextPos.y <= hitPos.y {
                             1.0f32
                         } else { -1.0f32 });
                (*(*this).hitActor).world.pos.z =
                    hitPos.z +
                        (if actorNextPos.z <= hitPos.z {
                             1.0f32
                         } else { -1.0f32 })
            } else {
                Math_Vec3f_Copy(&mut (*(*this).hitActor).world.pos,
                                &mut actorNextPos);
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Fly(mut this: *mut EnArrow,
                                     mut globalCtx: *mut GlobalContext) {
    let mut hitPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgId: s32 = 0;
    let mut hitPoint: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut posCopy: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut atTouched: s32 = 0;
    let mut sfxId: u16_0 = 0;
    let mut hitActor: *mut Actor = 0 as *mut Actor;
    ...
    if ((*this).timer as libc::c_int as libc::c_float) < 7.2000003f32 {
        (*this).actor.gravity = -0.4f32
    }
    atTouched =
        ((*this).actor.params as libc::c_int !=
             ARROW_NORMAL_LIT as libc::c_int &&
             (*this).actor.params as libc::c_int <= ARROW_SEED as libc::c_int
             &&
             (*this).collider.base.atFlags as libc::c_int &
                 (1 as libc::c_int) << 1 as libc::c_int != 0) as libc::c_int;
    if atTouched != 0 || (*this).touchedPoly as libc::c_int != 0 {
        if (*this).actor.params as libc::c_int >= ARROW_SEED as libc::c_int {
            if atTouched != 0 {
            ...
            if (*this).actor.params as libc::c_int == ARROW_NUT as libc::c_int
               {
                (*gGameInfo).data[(17 as libc::c_int * 6 as libc::c_int *
                                      ...
                                      as usize] = -(1 as libc::c_int) as s16;
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_M_FIRE1 as libc::c_int as s16,
                            (*this).actor.world.pos.x,
                            (*this).actor.world.pos.y,
                            (*this).actor.world.pos.z,
                            0 as libc::c_int as s16, 0 as libc::c_int as s16,
                            0 as libc::c_int as s16, 0 as libc::c_int as s16);
                sfxId = 0x182b as libc::c_int as u16_0
            } else { sfxId = 0x1825 as libc::c_int as u16_0 }
            EffectSsStone1_Spawn(globalCtx, &mut (*this).actor.world.pos,
                                 0 as libc::c_int);
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      20 as libc::c_int, sfxId);
            Actor_Kill(&mut (*this).actor);
        } else {
            EffectSsHitMark_SpawnCustomScale(globalCtx, 0 as libc::c_int,
                                             150 as libc::c_int as s16,
                                             &mut (*this).actor.world.pos);
            if atTouched != 0 &&
                   (*(*this).collider.info.atHitInfo).elemType as libc::c_int
                       != ELEMTYPE_UNK4 as libc::c_int {
                hitActor = (*this).collider.base.at;
                if (*hitActor).update.is_some() &&
                       (*this).collider.base.atFlags as libc::c_int &
                    ...
                    Math_Vec3f_Diff(&mut (*hitActor).world.pos,
                                    &mut (*this).actor.world.pos,
                                    &mut (*this).unk_250);
                    (*hitActor).flags |=
                    ...
                    (*this).hitFlags =
                        ((*this).hitFlags as libc::c_int | 1 as libc::c_int)
                            as u8_0;
                    (*this).hitFlags =
                        ((*this).hitFlags as libc::c_int | 2 as libc::c_int)
                            as u8_0;
                    if (*(*this).collider.info.atHitInfo).bumperFlags as
                           libc::c_int & 2 as libc::c_int != 0 {
                        (*this).actor.world.pos.x =
                            (*(*this).collider.info.atHitInfo).bumper.hitPos.x
                                as f32_0;
                        (*this).actor.world.pos.y =
                            (*(*this).collider.info.atHitInfo).bumper.hitPos.y
                                as f32_0;
                        (*this).actor.world.pos.z =
                            (*(*this).collider.info.atHitInfo).bumper.hitPos.z
                                as f32_0
                    }
                    func_809B3CEC(globalCtx, this);
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x1814 as libc::c_int as u16_0);
                }
            } else if (*this).touchedPoly != 0 {
                EnArrow_SetupAction(this,
                                    Some(func_809B45E0 as
                                             unsafe extern "C" fn(_:
                                                                      *mut EnArrow,
                                                                  _:
                                                                      *mut GlobalContext)
                                                 -> ()));
                Animation_PlayOnce(&mut (*this).skelAnime, &mut gArrow2Anim);
                if (*this).actor.params as libc::c_int >=
                       ARROW_NORMAL_LIT as libc::c_int {
                    (*this).timer = 60 as libc::c_int as u8_0
                } else { (*this).timer = 20 as libc::c_int as u8_0 }
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x1815 as libc::c_int as u16_0);
                (*this).hitFlags =
                    ((*this).hitFlags as libc::c_int | 1 as libc::c_int) as
                        u8_0
            }
        }
    } else {
        ...
        (*this).touchedPoly =
            BgCheck_ProjectileLineTest(&mut (*globalCtx).colCtx,
                                       &mut (*this).actor.prevPos,
                                       &mut (*this).actor.world.pos,
                                       &mut hitPoint,
                                       &mut (*this).actor.wallPoly,
                                       1 as libc::c_int, 1 as libc::c_int,
                                       1 as libc::c_int, 1 as libc::c_int,
                                       &mut bgId) as u8_0;
        if (*this).touchedPoly != 0 {
            func_8002F9EC(globalCtx, &mut (*this).actor,
                          (*this).actor.wallPoly, bgId, &mut hitPoint);
            Math_Vec3f_Copy(&mut posCopy, &mut (*this).actor.world.pos);
            Math_Vec3f_Copy(&mut (*this).actor.world.pos, &mut hitPoint);
        }
        if (*this).actor.params as libc::c_int <= ARROW_0E as libc::c_int {
            (*this).actor.shape.rot.x =
                Math_Atan2S((*this).actor.speedXZ, -(*this).actor.velocity.y)
        }
    }
    if !(*this).hitActor.is_null() {
        if (*(*this).hitActor).update.is_some() {
            Math_Vec3f_Sum(&mut (*this).unk_210, &mut (*this).unk_250,
                           &mut sp60);
            Math_Vec3f_Sum(&mut (*this).actor.world.pos, &mut (*this).unk_250,
                           &mut sp54);
            if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut sp60,
                                       &mut sp54, &mut hitPoint, &mut hitPoly,
                                       1 as libc::c_int, 1 as libc::c_int,
                                       1 as libc::c_int, 1 as libc::c_int,
                                       &mut bgId) != 0 {
                (*(*this).hitActor).world.pos.x =
                    hitPoint.x +
                        (if sp54.x <= hitPoint.x { 1.0f32 } else { -1.0f32 });
                (*(*this).hitActor).world.pos.y =
                    hitPoint.y +
                        (if sp54.y <= hitPoint.y { 1.0f32 } else { -1.0f32 });
                (*(*this).hitActor).world.pos.z =
                    hitPoint.z +
                        (if sp54.z <= hitPoint.z { 1.0f32 } else { -1.0f32 });
                Math_Vec3f_Diff(&mut (*(*this).hitActor).world.pos,
                                &mut (*this).actor.world.pos,
                                &mut (*this).unk_250);
                (*(*this).hitActor).flags &=
                    !((1 as libc::c_int) << 15 as libc::c_int) as
                        libc::c_uint;
                (*this).hitActor = 0 as *mut Actor
            } else {
                Math_Vec3f_Sum(&mut (*this).actor.world.pos,
                               &mut (*this).unk_250,
                               &mut (*(*this).hitActor).world.pos);
            }
            if (*this).touchedPoly as libc::c_int != 0 &&
                   !(*this).hitActor.is_null() {
                (*(*this).hitActor).flags &=
                    !((1 as libc::c_int) << 15 as libc::c_int) as
                        libc::c_uint;
                (*this).hitActor = 0 as *mut Actor
            }
        } else { (*this).hitActor = 0 as *mut Actor }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B45E0(mut this: *mut EnArrow,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_809B4640(mut this: *mut EnArrow,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Actor_MoveForward(&mut (*this).actor);
    if (if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnArrow = thisx as *mut EnArrow;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).isCsNut as libc::c_int != 0 ||
           (*this).actor.params as libc::c_int >=
               ARROW_NORMAL_LIT as libc::c_int &&
               (*player).unk_A73 as libc::c_int != 0 as libc::c_int ||
           Player_InBlockingCsMode(globalCtx, player) == 0 {
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
    }
    if (*this).actor.params as libc::c_int >= ARROW_FIRE as libc::c_int &&
           (*this).actor.params as libc::c_int <= ARROW_0E as libc::c_int {
        let mut elementalActorIds: [s16; 6] =
            [ACTOR_ARROW_FIRE as libc::c_int as s16,
             ACTOR_ARROW_ICE as libc::c_int as s16,
             ACTOR_ARROW_LIGHT as libc::c_int as s16,
             ACTOR_ARROW_FIRE as libc::c_int as s16,
             ACTOR_ARROW_FIRE as libc::c_int as s16,
             ACTOR_ARROW_FIRE as libc::c_int as s16];
        if (*this).actor.child.is_null() {
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               elementalActorIds[((*this).actor.params as
                                                      libc::c_int -
                                                      3 as libc::c_int) as
                                                     usize],
                               (*this).actor.world.pos.x,
        ...
        func_8002836C(globalCtx, &mut (*this).unk_21C, &mut velocity,
...
#[no_mangle]
pub unsafe extern "C" fn func_809B4800(mut this: *mut EnArrow,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_809B4E88: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 400.0f32, z: 1500.0f32,}; init };
    static mut D_809B4E94: Vec3f =
        {
            let mut init = Vec3f{x: 0.0f32, y: -400.0f32, z: 1500.0f32,};
            init
        };
    static mut D_809B4EA0: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -300.0f32,}; init };
    let mut sp44: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp38: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut addBlureVertex: s32 = 0;
    Matrix_MultVec3f(&mut D_809B4EA0, &mut (*this).unk_21C);
    if Some(EnArrow_Fly as
                unsafe extern "C" fn(_: *mut EnArrow, _: *mut GlobalContext)
                    -> ()) == (*this).actionFunc {
        Matrix_MultVec3f(&mut D_809B4E88, &mut sp44);
        Matrix_MultVec3f(&mut D_809B4E94, &mut sp38);
        if (*this).actor.params as libc::c_int <= ARROW_SEED as libc::c_int {
            addBlureVertex =
                ((*this).actor.params as libc::c_int <=
                     ARROW_LIGHT as libc::c_int) as libc::c_int;
            if (*this).hitActor.is_null() {
                addBlureVertex &=
                    func_80090480(globalCtx, &mut (*this).collider,
                                  &mut (*this).weaponInfo, &mut sp44,
                                  &mut sp38) as libc::c_int
            } else if addBlureVertex != 0 {
                if sp44.x == (*this).weaponInfo.tip.x &&
                       sp44.y == (*this).weaponInfo.tip.y &&
                       sp44.z == (*this).weaponInfo.tip.z &&
                       sp38.x == (*this).weaponInfo.base.x &&
                       sp38.y == (*this).weaponInfo.base.y &&
                       sp38.z == (*this).weaponInfo.base.z {
                    addBlureVertex = 0 as libc::c_int
                }
            }
            if addBlureVertex != 0 {
                EffectBlure_AddVertex(Effect_GetByIndex((*this).effectIndex)
                                          as *mut EffectBlure, &mut sp44,
                                      &mut sp38);
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnArrow_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnArrow = thisx as *mut EnArrow;
    ...
    if (*this).actor.params as libc::c_int <= ARROW_0E as libc::c_int {
        ...
        SkelAnime_DrawLod(globalCtx, (*this).skelAnime.skeleton,
                          (*this).skelAnime.jointTable, None, None,
                          this as *mut libc::c_void,
                          if (*this).actor.projectedPos.z <
                                 (*gGameInfo).data[(5 as libc::c_int *
                                                        6 as libc::c_int *
                                                        16 as libc::c_int +
                                                        95 as libc::c_int) as
                                                       usize] as libc::c_int
        ...
        alpha =
            (Math_CosS(((*this).timer as libc::c_int * 5000 as libc::c_int) as
                           s16) * 127.5f32 + 127.5f32) as u8_0;
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_arrow.c\x00" as *const u8 as
        ...
        Matrix_RotateZ(if (*this).actor.speedXZ == 0.0f32 {
                           0.0f32
                       } else {
                           (((*globalCtx).gameplayFrames &
                                 0xff as libc::c_int as
                                     libc::c_uint).wrapping_mul(4000 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
                                as libc::c_float) *
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gEffSparklesDL.as_mut_ptr() as libc::c_uint;
        Matrix_Pop();
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_arrow.c\x00" as *const u8 as
                             *const libc::c_char, 1381 as libc::c_int);
    }
