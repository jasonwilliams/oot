...
#[no_mangle]
pub unsafe extern "C" fn Lib_MemSet(mut dest: *mut u8_0, mut size: size_t,
                                    mut val: u8_0) {
    let mut i: u32_0 = 0;
    // clang-format off
...
#[no_mangle]
pub unsafe extern "C" fn Math_CosS(mut angle: s16) -> f32_0 {
    return coss(angle as u16_0) as libc::c_int as libc::c_float *
               (1.0f32 / 32767.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn Math_SinS(mut angle: s16) -> f32_0 {
    return sins(angle as u16_0) as libc::c_int as libc::c_float *
               (1.0f32 / 32767.0f32);
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_ScaledStepToS(mut pValue: *mut s16,
                                            mut target: s16, mut step: s16)
 -> s32 {
    if step as libc::c_int != 0 as libc::c_int {
        let mut updateScale: f32_0 =
            (*gGameInfo).data[(1 as libc::c_int * 6 as libc::c_int *
                ...
                0.5f32;
        if (*pValue as libc::c_int - target as libc::c_int) as s16 as
               libc::c_int > 0 as libc::c_int {
            step = -(step as libc::c_int) as s16
        }
        *pValue =
            (*pValue as libc::c_int +
                 (step as libc::c_int as libc::c_float * updateScale) as s16
                     as libc::c_int) as s16;
        if (*pValue as libc::c_int - target as libc::c_int) as s16 as
               libc::c_int * step as libc::c_int >= 0 as libc::c_int {
            *pValue = target;
            return 1 as libc::c_int
        }
    } else if target as libc::c_int == *pValue as libc::c_int {
        return 1 as libc::c_int
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepToS(mut pValue: *mut s16, mut target: s16,
                                      mut step: s16) -> s32 {
    if step as libc::c_int != 0 as libc::c_int {
        if (target as libc::c_int) < *pValue as libc::c_int {
            step = -(step as libc::c_int) as s16
        }
        *pValue = (*pValue as libc::c_int + step as libc::c_int) as s16;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepToF(mut pValue: *mut f32_0,
                                      mut target: f32_0, mut step: f32_0)
 -> s32 {
    if step != 0.0f32 {
        if target < *pValue { step = -step }
        *pValue += step;
        if (*pValue - target) * step >= 0 as libc::c_int as libc::c_float {
            *pValue = target;
            return 1 as libc::c_int
        }
    } else if target == *pValue { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepUntilAngleS(mut pValue: *mut s16,
                                              mut limit: s16, mut step: s16)
 -> s32 {
    let mut orig: s16 = *pValue;
    *pValue = (*pValue as libc::c_int + step as libc::c_int) as s16;
    if (*pValue as libc::c_int - limit as libc::c_int) as s16 as libc::c_int *
           (orig as libc::c_int - limit as libc::c_int) as s16 as libc::c_int
           <= 0 as libc::c_int {
        *pValue = limit;
        return 1 as libc::c_int
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepUntilS(mut pValue: *mut s16, mut limit: s16,
                                         mut step: s16) -> s32 {
    let mut orig: s16 = *pValue;
    *pValue = (*pValue as libc::c_int + step as libc::c_int) as s16;
    if (*pValue as libc::c_int - limit as libc::c_int) *
           (orig as libc::c_int - limit as libc::c_int) <= 0 as libc::c_int {
        *pValue = limit;
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepToAngleS(mut pValue: *mut s16,
                                           mut target: s16, mut step: s16)
 -> s32 {
    let mut diff: s32 = target as libc::c_int - *pValue as libc::c_int;
    if diff < 0 as libc::c_int { step = -(step as libc::c_int) as s16 }
    if diff >= 0x8000 as libc::c_int {
        step = -(step as libc::c_int) as s16;
        diff = -(0xffff as libc::c_int) - -diff
    } else if diff <= -(0x8000 as libc::c_int) {
        diff += 0xffff as libc::c_int;
        step = -(step as libc::c_int) as s16
    }
    if step as libc::c_int != 0 as libc::c_int {
        *pValue = (*pValue as libc::c_int + step as libc::c_int) as s16;
        if diff * step as libc::c_int <= 0 as libc::c_int {
            *pValue = target;
            return 1 as libc::c_int
        }
    } else if target as libc::c_int == *pValue as libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_StepUntilF(mut pValue: *mut f32_0,
                                         mut limit: f32_0, mut step: f32_0)
 -> s32 {
    let mut orig: f32_0 = *pValue;
    *pValue += step;
    if (*pValue - limit) * (orig - limit) <= 0 as libc::c_int as libc::c_float
       {
        *pValue = limit;
        return 1 as libc::c_int
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_AsymStepToF(mut pValue: *mut f32_0,
                                          mut target: f32_0,
                                          mut incrStep: f32_0,
                                          mut decrStep: f32_0) -> s32 {
    let mut step: f32_0 = if target >= *pValue { incrStep } else { decrStep };
    if step != 0.0f32 {
        if target < *pValue { step = -step }
        *pValue += step;
        if (*pValue - target) * step >= 0 as libc::c_int as libc::c_float {
...
#[no_mangle]
pub unsafe extern "C" fn func_80077D10(mut arg0: *mut f32_0,
                                       mut arg1: *mut s16,
                                       mut input: *mut Input) {
    let mut relX: f32_0 = (*input).rel.stick_x as f32_0;
    let mut relY: f32_0 = (*input).rel.stick_y as f32_0;
    *arg0 = sqrtf(relX * relX + relY * relY);
    *arg0 = if 60.0f32 < *arg0 { 60.0f32 } else { *arg0 };
    *arg1 = Math_Atan2S(relY, -relX);
}
#[no_mangle]
pub unsafe extern "C" fn Rand_S16Offset(mut base: s16, mut range: s16)
 -> s16 {
    return ((Rand_ZeroOne() * range as libc::c_int as libc::c_float) as s16 as
                libc::c_int + base as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn Rand_S16OffsetStride(mut base: s16, mut stride: s16,
                                              mut range: s16) -> s16 {
    return ((Rand_ZeroOne() * range as libc::c_int as libc::c_float) as s16 as
                libc::c_int * stride as libc::c_int + base as libc::c_int) as
               s16;
}
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Copy(mut dest: *mut Vec3f,
                                         mut src: *mut Vec3f) {
    (*dest).x = (*src).x;
    (*dest).y = (*src).y;
    (*dest).z = (*src).z;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3s_ToVec3f(mut dest: *mut Vec3f,
                                            mut src: *mut Vec3s) {
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Sum(mut a: *mut Vec3f, mut b: *mut Vec3f,
                                        mut dest: *mut Vec3f) {
    (*dest).x = (*a).x + (*b).x;
    (*dest).y = (*a).y + (*b).y;
    (*dest).z = (*a).z + (*b).z;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Diff(mut a: *mut Vec3f, mut b: *mut Vec3f,
                                         mut dest: *mut Vec3f) {
    (*dest).x = (*a).x - (*b).x;
    (*dest).y = (*a).y - (*b).y;
    (*dest).z = (*a).z - (*b).z;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3s_DiffToVec3f(mut dest: *mut Vec3f,
                                                mut a: *mut Vec3s,
                                                mut b: *mut Vec3s) {
    (*dest).x = ((*a).x as libc::c_int - (*b).x as libc::c_int) as f32_0;
    (*dest).y = ((*a).y as libc::c_int - (*b).y as libc::c_int) as f32_0;
    (*dest).z = ((*a).z as libc::c_int - (*b).z as libc::c_int) as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Scale(mut vec: *mut Vec3f,
                                          mut scaleF: f32_0) {
    (*vec).x *= scaleF;
    (*vec).y *= scaleF;
    (*vec).z *= scaleF;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_DistXYZ(mut a: *mut Vec3f,
                                            mut b: *mut Vec3f) -> f32_0 {
    let mut dx: f32_0 = (*b).x - (*a).x;
    let mut dy: f32_0 = (*b).y - (*a).y;
    let mut dz: f32_0 = (*b).z - (*a).z;
    return sqrtf(dx * dx + dy * dy + dz * dz);
}
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_DistXYZAndStoreDiff(mut a: *mut Vec3f,
                                                        mut b: *mut Vec3f,
                                                        mut dest: *mut Vec3f)
 -> f32_0 {
    (*dest).x = (*b).x - (*a).x;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_DistXZ(mut a: *mut Vec3f,
                                           mut b: *mut Vec3f) -> f32_0 {
    let mut dx: f32_0 = (*b).x - (*a).x;
    let mut dz: f32_0 = (*b).z - (*a).z;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_DiffY(mut a: *mut Vec3f,
                                          mut b: *mut Vec3f) -> f32_0 {
    return (*b).y - (*a).y;
}
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Yaw(mut a: *mut Vec3f, mut b: *mut Vec3f)
 -> s16 {
    let mut dx: f32_0 = (*b).x - (*a).x;
    let mut dz: f32_0 = (*b).z - (*a).z;
...
#[no_mangle]
pub unsafe extern "C" fn Math_Vec3f_Pitch(mut a: *mut Vec3f,
                                          mut b: *mut Vec3f) -> s16 {
    return Math_Atan2S(Math_Vec3f_DistXZ(a, b), (*a).y - (*b).y);
}
#[no_mangle]
pub static mut sInitChainHandlers:
           [Option<unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                       -> ()>; 11] =
    unsafe {
        [Some(IChain_Apply_u8 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_s8 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_u16 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_s16 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_u32 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_s32 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_f32 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_f32div1000 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_Vec3f as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_Vec3fdiv1000 as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ()),
         Some(IChain_Apply_Vec3s as
                  unsafe extern "C" fn(_: *mut u8_0, _: *mut InitChainEntry)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn Actor_ProcessInitChain(mut actor: *mut Actor,
                                                mut ichain:
                                                    *mut InitChainEntry) {
    loop  {
        sInitChainHandlers[(*ichain).type_0() as
                               usize].expect("non-null function pointer")(actor
                                                                              as
                                                                              *mut u8_0,
                                                                          ichain);
        let fresh1 = ichain;
        ichain = ichain.offset(1);
        if !((*fresh1).cont() != 0) { break ; }
    };
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_u8(mut ptr: *mut u8_0,
                                         mut ichain: *mut InitChainEntry) {
    *ptr.offset((*ichain).offset() as libc::c_int as isize) =
        (*ichain).value() as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_s8(mut ptr: *mut u8_0,
                                         mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut s8) =
        (*ichain).value() as s8;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_u16(mut ptr: *mut u8_0,
                                          mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut u16_0) =
        (*ichain).value() as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_s16(mut ptr: *mut u8_0,
                                          mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut s16) =
        (*ichain).value() as s16;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_u32(mut ptr: *mut u8_0,
                                          mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut u32_0) =
        (*ichain).value() as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_s32(mut ptr: *mut u8_0,
                                          mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut s32) =
        (*ichain).value();
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_f32(mut ptr: *mut u8_0,
                                          mut ichain: *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut f32_0) =
        (*ichain).value() as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_f32div1000(mut ptr: *mut u8_0,
                                                 mut ichain:
                                                     *mut InitChainEntry) {
    *(ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut f32_0) =
        (*ichain).value() as libc::c_float / 1000.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_Vec3f(mut ptr: *mut u8_0,
                                            mut ichain: *mut InitChainEntry) {
    let mut vec: *mut Vec3f =
        ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut Vec3f;
    let mut val: f32_0 = (*ichain).value() as f32_0;
    (*vec).z = val;
    (*vec).y = val;
    (*vec).x = val;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_Vec3fdiv1000(mut ptr: *mut u8_0,
                                                   mut ichain:
                                                       *mut InitChainEntry) {
    let mut vec: *mut Vec3f =
        ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut Vec3f;
    let mut val: f32_0 = 0.;
    osSyncPrintf(b"pp=%x data=%f\n\x00" as *const u8 as *const libc::c_char,
                 vec,
                 ((*ichain).value() as libc::c_float / 1000.0f32) as
                     libc::c_double);
    val = (*ichain).value() as libc::c_float / 1000.0f32;
    (*vec).z = val;
    (*vec).y = val;
    (*vec).x = val;
}
#[no_mangle]
pub unsafe extern "C" fn IChain_Apply_Vec3s(mut ptr: *mut u8_0,
                                            mut ichain: *mut InitChainEntry) {
    let mut vec: *mut Vec3s =
        ptr.offset((*ichain).offset() as libc::c_int as isize) as *mut Vec3s;
    let mut val: s16 = (*ichain).value() as s16;
    (*vec).z = val;
    (*vec).y = val;
    (*vec).x = val;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_SmoothStepToF(mut pValue: *mut f32_0,
                                            mut target: f32_0,
                                            mut fraction: f32_0,
                                            mut step: f32_0,
                                            mut minStep: f32_0) -> f32_0 {
    if *pValue != target {
        let mut stepSize: f32_0 = (target - *pValue) * fraction;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_ApproachF(mut pValue: *mut f32_0,
                                        mut target: f32_0,
                                        mut fraction: f32_0,
                                        mut step: f32_0) {
    if *pValue != target {
        ...
        if stepSize > step {
            stepSize = step
        } else if stepSize < -step { stepSize = -step }
        *pValue += stepSize
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_ApproachZeroF(mut pValue: *mut f32_0,
                                            mut fraction: f32_0,
                                            mut step: f32_0) {
    let mut stepSize: f32_0 = *pValue * fraction;
    if stepSize > step {
        stepSize = step
    } else if stepSize < -step { stepSize = -step }
    *pValue -= stepSize;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_SmoothStepToDegF(mut pValue: *mut f32_0,
                                               mut target: f32_0,
                                               mut fraction: f32_0,
                                               mut step: f32_0,
                                               mut minStep: f32_0) -> f32_0 {
    let mut stepSize: f32_0 = 0.0f32;
    let mut diff: f32_0 = target - *pValue;
    if *pValue != target {
        if diff > 180.0f32 {
            diff = -(360.0f32 - diff)
        } else if diff < -180.0f32 { diff = 360.0f32 + diff }
    ...
    if *pValue >= 360.0f32 { *pValue -= 360.0f32 }
    if *pValue < 0.0f32 { *pValue += 360.0f32 }
    return stepSize;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_SmoothStepToS(mut pValue: *mut s16,
                                            mut target: s16, mut scale: s16,
                                            mut step: s16, mut minStep: s16)
 -> s16 {
    ...
    if *pValue as libc::c_int != target as libc::c_int {
        ...
        if stepSize as libc::c_int > minStep as libc::c_int ||
               (stepSize as libc::c_int) < -(minStep as libc::c_int) {
            ...
            *pValue =
                (*pValue as libc::c_int + stepSize as libc::c_int) as s16
        } else if diff as libc::c_int >= 0 as libc::c_int {
            *pValue =
                (*pValue as libc::c_int + minStep as libc::c_int) as s16;
            if (target as libc::c_int - *pValue as libc::c_int) as s16 as
                   libc::c_int <= 0 as libc::c_int {
                *pValue = target
            }
        } else {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Math_ApproachS(mut pValue: *mut s16, mut target: s16,
                                        mut scale: s16, mut maxStep: s16) {
    let mut diff: s16 =
        (target as libc::c_int - *pValue as libc::c_int) as s16;
    diff = (diff as libc::c_int / scale as libc::c_int) as s16;
    if diff as libc::c_int > maxStep as libc::c_int {
        *pValue = (*pValue as libc::c_int + maxStep as libc::c_int) as s16
    } else if (diff as libc::c_int) < -(maxStep as libc::c_int) {
        *pValue = (*pValue as libc::c_int - maxStep as libc::c_int) as s16
    } else {
        *pValue = (*pValue as libc::c_int + diff as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn Color_RGBA8_Copy(mut dst: *mut Color_RGBA8,
                                          mut src: *mut Color_RGBA8) {
    (*dst).r = (*src).r;
    (*dst).g = (*src).g;
    (*dst).b = (*src).b;
    (*dst).a = (*src).a;
...
#[no_mangle]
pub unsafe extern "C" fn func_80078884(mut sfxId: u16_0) {
    Audio_PlaySoundGeneral(sfxId, &mut D_801333D4, 4 as libc::c_int as u8_0,
                           &mut D_801333E0, &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_800788CC(mut sfxId: u16_0) {
    Audio_PlaySoundGeneral(sfxId, &mut D_801333D4, 4 as libc::c_int as u8_0,
                           &mut D_801333E0, &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_80078914(mut arg0: *mut Vec3f,
                                       mut sfxId: u16_0) {
    Audio_PlaySoundGeneral(sfxId, arg0, 4 as libc::c_int as u8_0,
                           &mut D_801333E0, &mut D_801333E0, &mut D_801333E8);
}
