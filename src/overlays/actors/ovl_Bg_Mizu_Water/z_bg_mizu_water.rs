...
extern "C" {
    ...
    #[no_mangle]
    static mut gObjectMizuObjectsWaterDL_004B20: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMizuWater {
    pub actor: Actor,
    pub actionFunc: BgMizuWaterActionFunc,
    pub type_0: s32,
    pub targetY: f32_0,
    pub baseY: f32_0,
    pub switchFlag: s32,
}
pub type BgMizuWaterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMizuWater, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
static mut sWaterLevels: [WaterLevel; 4] =
    [{
         let mut init =
             WaterLevel{switchFlag: 0 as libc::c_int,
                        yDiff: 0 as libc::c_int,};
         init
     },
     {
         let mut init =
             WaterLevel{switchFlag: 0x1e as libc::c_int,
                        yDiff: 0 as libc::c_int,};
         init
     },
     {
         let mut init =
             WaterLevel{switchFlag: 0x1d as libc::c_int,
                        yDiff: (445.0f32 - 765.0f32) as s32,};
         init
     },
     {
         let mut init =
             WaterLevel{switchFlag: 0x1c as libc::c_int,
                        yDiff: (-15.0f32 - 765.0f32) as s32,};
         init
     }];
#[no_mangle]
pub static mut Bg_Mizu_Water_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MIZU_WATER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMizuWater>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuWater_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuWater_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuWater_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuWater_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sWaterBoxIndexes: [u32_0; 8] =
    [2 as libc::c_int as u32_0, 3 as libc::c_int as u32_0,
     5 as libc::c_int as u32_0, 7 as libc::c_int as u32_0,
     12 as libc::c_int as u32_0, 20 as libc::c_int as u32_0,
     21 as libc::c_int as u32_0, 22 as libc::c_int as u32_0];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_GetWaterLevelActionIndex(mut switchFlag:
                                                                  s16,
                                                              mut globalCtx:
                                                                  *mut GlobalContext)
 -> u32_0 {
    let mut ret: u32_0 = 0;
    if (*gGameInfo).data[(28 as libc::c_int * 6 as libc::c_int *
                              16 as libc::c_int + 0 as libc::c_int) as usize]
           as libc::c_int != 0 as libc::c_int {
        match (*gGameInfo).data[(28 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 1 as libc::c_int) as
                                    usize] as libc::c_int {
            0 => { Flags_SetSwitch(globalCtx, 0x1c as libc::c_int); }
            1 => { Flags_SetSwitch(globalCtx, 0x1d as libc::c_int); }
            2 => { Flags_SetSwitch(globalCtx, 0x1e as libc::c_int); }
            _ => { }
        }
    ...
    if Flags_GetSwitch(globalCtx, 0x1c as libc::c_int) != 0 &&
           switchFlag as libc::c_int != 0x1c as libc::c_int {
        ret = 3 as libc::c_int as u32_0
    } else if Flags_GetSwitch(globalCtx, 0x1d as libc::c_int) != 0 &&
                  switchFlag as libc::c_int != 0x1d as libc::c_int {
        ret = 2 as libc::c_int as u32_0
    } else if Flags_GetSwitch(globalCtx, 0x1e as libc::c_int) != 0 &&
                  switchFlag as libc::c_int != 0x1e as libc::c_int {
        ret = 1 as libc::c_int as u32_0
    } else { ret = 0 as libc::c_int as u32_0 }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_SetWaterBoxesHeight(mut waterBoxes:
                                                             *mut WaterBox,
                                                         mut height: s16) {
    let mut i: u32_0 = 0;
    i = 0 as libc::c_int as u32_0;
    while i < 8 as libc::c_int as libc::c_uint {
        (*waterBoxes.offset(sWaterBoxIndexes[i as usize] as isize)).ySurface =
            height;
        i = i.wrapping_add(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMizuWater = thisx as *mut BgMizuWater;
    let mut initialActorY: f32_0 = 0.;
    let mut waterBoxes: *mut WaterBox = 0 as *mut WaterBox;
    let mut waterLevelActionIndex: s32 = 0;
    ...
    match (*this).type_0 {
        0 => {
            if (*gGameInfo).data[(28 as libc::c_int * 6 as libc::c_int *
                   ...
                   0 as libc::c_int {
                osSyncPrintf(b"<\xe3\x82\xb3\xe3\x83\xb3\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x83\x88>%x %x %x\n\x00"
                                 as *const u8 as *const libc::c_char,
                             Flags_GetSwitch(globalCtx, 0x1c as libc::c_int),
                             Flags_GetSwitch(globalCtx, 0x1d as libc::c_int),
                             Flags_GetSwitch(globalCtx, 0x1e as libc::c_int));
            }
            waterLevelActionIndex =
                BgMizuWater_GetWaterLevelActionIndex(-(1 as libc::c_int) as
                                                         s16, globalCtx) as
                    s32;
            (*this).actor.world.pos.y =
                sWaterLevels[waterLevelActionIndex as usize].yDiff as
                    libc::c_float + (*this).baseY;
            BgMizuWater_SetWaterBoxesHeight(waterBoxes,
                                            (*this).actor.world.pos.y as s16);
            (*this).actor.params =
                sWaterLevels[waterLevelActionIndex as usize].switchFlag as
                    s16;
            Flags_UnsetSwitch(globalCtx, 0x1c as libc::c_int);
            Flags_UnsetSwitch(globalCtx, 0x1d as libc::c_int);
            Flags_UnsetSwitch(globalCtx, 0x1e as libc::c_int);
            match (*this).actor.params as libc::c_int {
                30 => { Flags_SetSwitch(globalCtx, 0x1e as libc::c_int); }
                29 => { Flags_SetSwitch(globalCtx, 0x1d as libc::c_int); }
                28 | _ => { Flags_SetSwitch(globalCtx, 0x1c as libc::c_int); }
            }
            (*this).targetY = (*this).actor.world.pos.y
        }
        2 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).actor.world.pos.y = (*this).baseY + 85.0f32
            }
            (*waterBoxes.offset(6 as libc::c_int as isize)).ySurface =
                (*this).actor.world.pos.y as s16
        }
        3 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).actor.world.pos.y = (*this).baseY + 110.0f32;
                (*this).targetY = (*this).actor.world.pos.y
            }
            (*waterBoxes.offset(8 as libc::c_int as isize)).ySurface =
                (*this).actor.world.pos.y as s16
        }
        4 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).actor.world.pos.y = (*this).baseY + 160.0f32;
                (*this).targetY = (*this).actor.world.pos.y
            }
            (*waterBoxes.offset(16 as libc::c_int as isize)).ySurface =
                (*this).actor.world.pos.y as s16
        }
        1 | _ => { }
    }
    (*this).actionFunc =
        Some(BgMizuWater_WaitForAction as
                 unsafe extern "C" fn(_: *mut BgMizuWater,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_WaitForAction(mut this: *mut BgMizuWater,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut waterLevelActionIndex: s32 = 0;
    let mut prevSwitchFlag: s16 = 0;
    match (*this).type_0 {
        0 => {
            prevSwitchFlag = (*this).actor.params;
            waterLevelActionIndex =
                BgMizuWater_GetWaterLevelActionIndex((*this).actor.params,
                                                     globalCtx) as s32;
            if waterLevelActionIndex != 0 as libc::c_int {
                if prevSwitchFlag as libc::c_int !=
                       sWaterLevels[waterLevelActionIndex as usize].switchFlag
                   {
                    OnePointCutscene_Init(globalCtx,
                                          3120 as libc::c_int as s16,
                                          (-(100 as libc::c_int) -
                                               waterLevelActionIndex) as s16,
                                          0 as *mut Actor,
                                          0 as libc::c_int as s16);
                    (*this).actor.params =
                        sWaterLevels[waterLevelActionIndex as
                                         usize].switchFlag as s16;
                    (*this).targetY =
                        sWaterLevels[waterLevelActionIndex as usize].yDiff as
                            libc::c_float + (*this).baseY
                }
            ...
            if prevSwitchFlag as libc::c_int !=
                   ...
                   prevSwitchFlag as libc::c_int != 0 as libc::c_int {
                Flags_UnsetSwitch(globalCtx, prevSwitchFlag as s32);
            }
        }
        2 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).targetY = (*this).baseY + 85.0f32
            } else { (*this).targetY = (*this).baseY }
        }
        3 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).targetY = (*this).baseY + 110.0f32
            } else { (*this).targetY = (*this).baseY }
        }
        4 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
                (*this).targetY = (*this).baseY + 160.0f32
            } else { (*this).targetY = (*this).baseY }
        }
        1 | _ => { }
    }
    if (*this).targetY != (*this).actor.world.pos.y {
        (*this).actionFunc =
            Some(BgMizuWater_ChangeWaterLevel as
                     unsafe extern "C" fn(_: *mut BgMizuWater,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_ChangeWaterLevel(mut this:
                                                          *mut BgMizuWater,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    match (*this).type_0 {
        0 => {
            ...
            if Math_StepToF(&mut (*this).actor.world.pos.y, (*this).targetY,
                            5.0f32) != 0 {
            ...
            BgMizuWater_SetWaterBoxesHeight((*(*globalCtx).colCtx.colHeader).waterBoxes,
                                            (*this).actor.world.pos.y as s16);
        }
        2 => {
            if Flags_GetSwitch(globalCtx, (*this).switchFlag) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgMizuWater = thisx as *mut BgMizuWater;
    let mut posY: s32 = 0;
    ...
    if (*gGameInfo).data[(28 as libc::c_int * 6 as libc::c_int *
           ...
           as libc::c_int == 0 as libc::c_int {
        osSyncPrintf(b"%x %x %x\n\x00" as *const u8 as *const libc::c_char,
                     Flags_GetSwitch(globalCtx, 0x1c as libc::c_int),
                     Flags_GetSwitch(globalCtx, 0x1d as libc::c_int),
                     Flags_GetSwitch(globalCtx, 0x1e as libc::c_int));
    }
    if (*this).type_0 == 0 as libc::c_int {
        posY = (*this).actor.world.pos.y as s32;
        unk0 = 0 as libc::c_int;
        unk1 = 0 as libc::c_int;
        if (posY as libc::c_float) < -15.0f32 {
            unk0 = 0 as libc::c_int;
            unk1 =
                ((posY as libc::c_float - -835.0f32) / (-15.0f32 - -835.0f32)
                     * 200 as libc::c_int as libc::c_float) as s32
        } else if (posY as libc::c_float) < 445.0f32 {
            unk0 = 1 as libc::c_int;
            unk1 =
                255 as libc::c_int -
                    ((posY as libc::c_float - -15.0f32) /
                         (445.0f32 - -15.0f32) *
                         (255 as libc::c_int - 160 as libc::c_int) as
                             libc::c_float) as s32
        } else if posY as libc::c_float <= 765.0f32 {
            unk0 = 2 as libc::c_int;
            unk1 =
                255 as libc::c_int -
                    ((posY as libc::c_float - 445.0f32) /
                         (765.0f32 - 445.0f32) *
                         (255 as libc::c_int - 160 as libc::c_int) as
                             libc::c_float) as s32
        }
        (*globalCtx).roomCtx.unk_74[1 as libc::c_int as usize] =
            ((unk0 as u8_0 as libc::c_int) << 8 as libc::c_int |
                 unk1 & 0xff as libc::c_int) as s16
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuWater_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMizuWater = thisx as *mut BgMizuWater;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mizu_water.c\x00" as *const u8 as
                        *const libc::c_char, 738 as libc::c_int);
    gameplayFrames = (*globalCtx).gameplayFrames as s32;
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (-gameplayFrames * 1 as libc::c_int) as u32_0,
                         (gameplayFrames * 1 as libc::c_int) as u32_0,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gObjectMizuObjectsWaterDL_004B20.as_mut_ptr() as libc::c_uint;
