...
extern "C" {
    ...
    fn OnePointCutscene_Attention(globalCtx: *mut GlobalContext,
                                  actor: *mut Actor) -> s32;
    #[no_mangle]
    static mut object_ice_objects_DL_002740: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_Col_002854: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgIceShutter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgIceShutterActionFunc,
}
pub type BgIceShutterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgIceShutter, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Ice_Shutter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_ICE_SHUTTER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgIceShutter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShutter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShutter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShutter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShutter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn func_80891AC0(mut this: *mut BgIceShutter) {
    let mut sp24: f32_0 = 0.;
    sp24 =
        Math_SinS((*this).dyna.actor.shape.rot.x) *
            (*this).dyna.actor.velocity.y;
    (*this).dyna.actor.world.pos.y =
        Math_CosS((*this).dyna.actor.shape.rot.x) *
            (*this).dyna.actor.velocity.y + (*this).dyna.actor.home.pos.y;
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).dyna.actor.shape.rot.y) * sp24 +
            (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).dyna.actor.shape.rot.y) * sp24 +
            (*this).dyna.actor.home.pos.z;
}
#[no_mangle]
pub unsafe extern "C" fn BgIceShutter_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgIceShutter = thisx as *mut BgIceShutter;
    let mut sp24: f32_0 = 0.;
    ...
    sp28 = (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int;
    (*this).dyna.actor.params =
        ((*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
             0xff as libc::c_int) as s16;
    CollisionHeader_GetVirtual(&mut object_ice_objects_Col_002854 as
    ...
    if sp28 == 2 as libc::c_int {
        (*this).dyna.actor.shape.rot.x = -(0x4000 as libc::c_int) as s16
    }
    if sp28 != 1 as libc::c_int {
        if Flags_GetClear(globalCtx, (*this).dyna.actor.room as s32) != 0 {
            Actor_Kill(&mut (*this).dyna.actor);
        } else {
            (*this).actionFunc =
                Some(func_80891CF4 as
                         unsafe extern "C" fn(_: *mut BgIceShutter,
                                              _: *mut GlobalContext) -> ())
        }
    } else if Flags_GetSwitch(globalCtx, (*this).dyna.actor.params as s32) !=
                  0 {
        Actor_Kill(&mut (*this).dyna.actor);
    } else {
        (*this).actionFunc =
            Some(func_80891D6C as
                     unsafe extern "C" fn(_: *mut BgIceShutter,
                                          _: *mut GlobalContext) -> ())
    }
    if sp28 == 2 as libc::c_int {
        temp_f6 = Math_SinS((*this).dyna.actor.shape.rot.x) * 50.0f32;
        (*this).dyna.actor.focus.pos.x =
            Math_SinS((*this).dyna.actor.shape.rot.y) * temp_f6 +
                (*this).dyna.actor.home.pos.x;
        (*this).dyna.actor.focus.pos.y = (*this).dyna.actor.home.pos.y;
        (*this).dyna.actor.focus.pos.z =
            (*this).dyna.actor.home.pos.z +
                Math_CosS((*this).dyna.actor.shape.rot.y) * temp_f6
    } else { Actor_SetFocus(&mut (*this).dyna.actor, 50.0f32); };
}
#[no_mangle]
pub unsafe extern "C" fn BgIceShutter_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgIceShutter = thisx as *mut BgIceShutter;
...
#[no_mangle]
pub unsafe extern "C" fn func_80891CF4(mut this: *mut BgIceShutter,
...
#[no_mangle]
pub unsafe extern "C" fn func_80891D6C(mut this: *mut BgIceShutter,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80891DD4(mut this: *mut BgIceShutter,
                                       mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).dyna.actor.speedXZ, 30.0f32, 2.0f32);
    if Math_StepToF(&mut (*this).dyna.actor.velocity.y, 210.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn BgIceShutter_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgIceShutter = thisx as *mut BgIceShutter;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceShutter_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, object_ice_objects_DL_002740.as_mut_ptr());
}
