...
extern "C" {
    ...
    #[no_mangle]
    static mut gPotDL: [Gfx; 0];
    #[no_mangle]
    static mut gPotFragmentDL: [Gfx; 0];
    #[no_mangle]
...
pub struct ObjTsubo {
    pub actor: Actor,
    pub actionFunc: ObjTsuboActionFunc,
    pub collider: ColliderCylinder,
    pub objTsuboBankIndex: s8,
}
pub type ObjTsuboActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjTsubo, _: *mut GlobalContext)
               -> ()>;
...
static mut D_80BA1B50: s16 = 0 as libc::c_int as s16;
static mut D_80BA1B54: s16 = 0 as libc::c_int as s16;
static mut D_80BA1B58: s16 = 0 as libc::c_int as s16;
static mut D_80BA1B5C: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Obj_Tsubo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_TSUBO as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTsubo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTsubo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sObjectIds: [s16; 2] =
    [OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as s16,
     OBJECT_TSUBO as libc::c_int as s16];
static mut D_80BA1B84: [*mut Gfx; 2] =
    unsafe {
        [gPotDL.as_ptr() as *mut _, object_tsubo_DL_0017C0.as_ptr() as *mut _]
    };
static mut D_80BA1B8C: [*mut Gfx; 2] =
    unsafe {
        [gPotFragmentDL.as_ptr() as *mut _,
         object_tsubo_DL_001960.as_ptr() as *mut _]
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SpawnCollectible(mut this: *mut ObjTsubo,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut dropParams: s16 =
        ((*this).actor.params as libc::c_int & 0x1f as libc::c_int) as s16;
    if dropParams as libc::c_int >= ITEM00_RUPEE_GREEN as libc::c_int &&
           dropParams as libc::c_int <= ITEM00_BOMBS_SPECIAL as libc::c_int {
        Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                             (dropParams as libc::c_int |
                                  ((*this).actor.params as libc::c_int >>
                                       9 as libc::c_int & 0x3f as libc::c_int)
                                      << 8 as libc::c_int) as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_ApplyGravity(mut this: *mut ObjTsubo) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SnapToFloor(mut this: *mut ObjTsubo,
                                              mut globalCtx:
    ...
    floorY =
        BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx, &mut floorPoly,
    ...
    if floorY > -32000.0f32 {
        ...
        osSyncPrintf(b"\xe5\x9c\xb0\xe9\x9d\xa2\xe3\x81\xab\xe4\xbb\x98\xe7\x9d\x80\xe5\xa4\xb1\xe6\x95\x97\n\x00"
                         as *const u8 as *const libc::c_char);
        return 0 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_InitCollider(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut ObjTsubo = thisx as *mut ObjTsubo;
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_AirBreak(mut this: *mut ObjTsubo,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    while i < 15 as libc::c_int {
        ...
        pos.z = coss * 8.0f32;
        velocity.x = pos.x * 0.23f32;
        velocity.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        velocity.z = pos.z * 0.23f32;
        Math_Vec3f_Sum(&mut pos, &mut (*this).actor.world.pos, &mut pos);
        rand = Rand_ZeroOne();
        if rand < 0.2f32 {
            arg5 = 96 as libc::c_int
        } else if rand < 0.6f32 {
            arg5 = 64 as libc::c_int
        } else { arg5 = 32 as libc::c_int }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity,
                             &mut (*this).actor.world.pos,
                             -(240 as libc::c_int) as s16, arg5 as s16,
                             10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 95.0f32 + 15.0f32) as s16,
                             0 as libc::c_int as s16,
                             32 as libc::c_int as s16, 60 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             sObjectIds[((*this).actor.params as libc::c_int
                                             >> 8 as libc::c_int &
                                             1 as libc::c_int) as usize],
                             D_80BA1B8C[((*this).actor.params as libc::c_int
                                             >> 8 as libc::c_int &
                                             1 as libc::c_int) as usize]);
        i += 1;
        angle = (angle as libc::c_int + 0x4e20 as libc::c_int) as s16
    }
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 30.0f32,
                  4 as libc::c_int, 20 as libc::c_int as s16,
                  50 as libc::c_int as s16, 1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_WaterBreak(mut this: *mut ObjTsubo,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    angle = 0 as libc::c_int as s16;
    while i < 15 as libc::c_int {
        let mut sins: f32_0 = Math_SinS(angle);
        let mut coss: f32_0 = Math_CosS(angle);
        pos.x = sins * 8.0f32;
        pos.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        pos.z = coss * 8.0f32;
        velocity.x = pos.x * 0.2f32;
        velocity.y = Rand_ZeroOne() * 4.0f32 + 2.0f32;
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity,
                             &mut (*this).actor.world.pos,
                             -(180 as libc::c_int) as s16, phi_s0 as s16,
                             30 as libc::c_int as s16,
                             30 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 95.0f32 + 15.0f32) as s16,
                             0 as libc::c_int as s16,
                             32 as libc::c_int as s16, 70 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             sObjectIds[((*this).actor.params as libc::c_int
                                             >> 8 as libc::c_int &
                                             1 as libc::c_int) as usize],
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SetupWaitForObject(mut this:
                                                         *mut ObjTsubo) {
    (*this).actionFunc =
        Some(ObjTsubo_WaitForObject as
                 unsafe extern "C" fn(_: *mut ObjTsubo, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_WaitForObject(mut this: *mut ObjTsubo,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).objTsuboBankIndex as s32) != 0 {
        (*this).actor.draw =
            Some(ObjTsubo_Draw as
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SetupIdle(mut this: *mut ObjTsubo) {
    (*this).actionFunc =
        Some(ObjTsubo_Idle as
                 unsafe extern "C" fn(_: *mut ObjTsubo, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_Idle(mut this: *mut ObjTsubo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ObjTsubo_SetupLiftedUp(this);
                  ...
                  != 0 && (*this).actor.yDistToWater > 15.0f32 {
        ...
        Actor_Kill(&mut (*this).actor);
                  ...
                  (*(*this).collider.info.acHitInfo).toucher.dmgFlags &
                      0x4fc1fffc as libc::c_int as libc::c_uint != 0 {
            ...
            temp_v0 =
                ((*this).actor.yawTowardsPlayer as libc::c_int -
                     (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                             libc::c_int as
                                                             usize].head as
                            *mut Player)).actor.world.rot.y as libc::c_int) as
                    s16;
            phi_v1 =
                if temp_v0 as libc::c_int >= 0 as libc::c_int {
                    temp_v0 as libc::c_int
                } else { -(temp_v0 as libc::c_int) };
            if phi_v1 >= 0x5556 as libc::c_int {
                // GI_NONE in this case allows the player to lift the actor
                func_8002F434(&mut (*this).actor, globalCtx,
                              GI_NONE as libc::c_int, 30.0f32, 30.0f32);
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SetupLiftedUp(mut this: *mut ObjTsubo) {
    (*this).actionFunc =
        Some(ObjTsubo_LiftedUp as
                 unsafe extern "C" fn(_: *mut ObjTsubo, _: *mut GlobalContext)
                     -> ());
    (*this).actor.room = -(1 as libc::c_int) as s8;
    func_8002F7DC(&mut (*this).actor, 0x86f as libc::c_int as u16_0);
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_LiftedUp(mut this: *mut ObjTsubo,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if Actor_HasNoParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                15.0f32, 0.0f32, 0x85 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_SetupThrown(mut this: *mut ObjTsubo) {
    ...
    D_80BA1B50 = ((Rand_ZeroOne() - 0.7f32) * 2800.0f32) as s16;
    D_80BA1B58 = ((Rand_ZeroOne() - 0.5f32) * 2000.0f32) as s16;
    D_80BA1B54 = 0 as libc::c_int as s16;
    D_80BA1B5C = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(ObjTsubo_Thrown as
                 unsafe extern "C" fn(_: *mut ObjTsubo, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_Thrown(mut this: *mut ObjTsubo,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    if (*this).actor.bgCheckFlags as libc::c_int & 0xb as libc::c_int != 0 ||
        ...
        ObjTsubo_ApplyGravity(this);
        func_8002D7EC(&mut (*this).actor);
        Math_StepToS(&mut D_80BA1B54, D_80BA1B50, 0x64 as libc::c_int as s16);
        Math_StepToS(&mut D_80BA1B5C, D_80BA1B58, 0x64 as libc::c_int as s16);
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int +
                 D_80BA1B54 as libc::c_int) as s16;
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 D_80BA1B5C as libc::c_int) as s16;
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                15.0f32, 0.0f32, 0x85 as libc::c_int);
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
...
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjTsubo = thisx as *mut ObjTsubo;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn ObjTsubo_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx,
                     D_80BA1B84[((*thisx).params as libc::c_int >>
