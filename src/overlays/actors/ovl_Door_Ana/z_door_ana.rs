...
pub struct DoorAna {
    ...
    pub actionFunc: DoorAnaActionFunc,
}
pub type DoorAnaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DoorAna, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Door_Ana_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DOOR_ANA as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorAna_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut entrances: [s16; 15] =
    [0x36d as libc::c_int as s16, 0x3f as libc::c_int as s16,
     0x598 as libc::c_int as s16, 0x59c as libc::c_int as s16,
     0x5a0 as libc::c_int as s16, 0x5a4 as libc::c_int as s16,
     0x5a8 as libc::c_int as s16, 0x5ac as libc::c_int as s16,
     0x5b0 as libc::c_int as s16, 0x5b4 as libc::c_int as s16,
     0x5b8 as libc::c_int as s16, 0x5bc as libc::c_int as s16,
     0x5c0 as libc::c_int as s16, 0x5c4 as libc::c_int as s16,
     0x5fc as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn DoorAna_SetupAction(mut this: *mut DoorAna,
                                             mut actionFunc:
                                                 DoorAnaActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn DoorAna_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorAna = thisx as *mut DoorAna;
    ...
    if (*this).actor.params as libc::c_int & 0x300 as libc::c_int !=
        ...
        if (*this).actor.params as libc::c_int & 0x200 as libc::c_int !=
               0 as libc::c_int {
        ...
        Actor_SetScale(&mut (*this).actor, 0 as libc::c_int as f32_0);
        DoorAna_SetupAction(this,
                            Some(DoorAna_WaitClosed as
                                     unsafe extern "C" fn(_: *mut DoorAna,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    } else {
        DoorAna_SetupAction(this,
                            Some(DoorAna_WaitOpen as
                                     unsafe extern "C" fn(_: *mut DoorAna,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn DoorAna_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorAna = thisx as *mut DoorAna;
...
#[no_mangle]
pub unsafe extern "C" fn DoorAna_WaitClosed(mut this: *mut DoorAna,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut openGrotto: u32_0 = 0 as libc::c_int as u32_0;
    if (*this).actor.params as libc::c_int & 0x200 as libc::c_int == 0 {
        // opening with song of storms
        if (*this).actor.xyzDistToPlayerSq < 40000.0f32 &&
               Flags_GetEnv(globalCtx, 5 as libc::c_int as s16) != 0 {
            openGrotto = 1 as libc::c_int as u32_0;
            (*this).actor.flags &=
                !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint
        }
    ...
    if openGrotto != 0 {
        (*this).actor.params =
            ((*this).actor.params as libc::c_int & !(0x300 as libc::c_int)) as
                s16;
        DoorAna_SetupAction(this,
                            Some(DoorAna_WaitOpen as
                                     unsafe extern "C" fn(_: *mut DoorAna,
    ...
    func_8002F5F0(&mut (*this).actor, globalCtx);
}
// update routine for grottos that are open
#[no_mangle]
pub unsafe extern "C" fn DoorAna_WaitOpen(mut this: *mut DoorAna,
                                          mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut destinationIdx: s32 = 0;
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Math_StepToF(&mut (*this).actor.scale.x, 0.01f32, 0.001f32) != 0 {
        if (*this).actor.targetMode as libc::c_int != 0 as libc::c_int &&
               (*globalCtx).sceneLoadFlag as libc::c_int == 0 as libc::c_int
               && (*player).stateFlags1 & 0x80000000 as libc::c_uint != 0 &&
               (*player).unk_84F as libc::c_int == 0 as libc::c_int {
            destinationIdx =
                ((*this).actor.params as libc::c_int >> 0xc as libc::c_int &
                     7 as libc::c_int) - 1 as libc::c_int;
            Gameplay_SetupRespawnPoint(globalCtx,
                                       RESPAWN_MODE_RETURN as libc::c_int,
                                       0x4ff as libc::c_int);
            gSaveContext.respawn[RESPAWN_MODE_RETURN as libc::c_int as
                                     usize].pos.y = (*this).actor.world.pos.y;
            gSaveContext.respawn[RESPAWN_MODE_RETURN as libc::c_int as
                                     usize].yaw = (*this).actor.home.rot.y;
            gSaveContext.respawn[RESPAWN_MODE_RETURN as libc::c_int as
                                     usize].data =
                ((*this).actor.params as libc::c_int & 0xffff as libc::c_int)
                    as s8;
            if destinationIdx < 0 as libc::c_int {
                destinationIdx =
                    (*this).actor.home.rot.z as libc::c_int + 1 as libc::c_int
            }
            (*globalCtx).nextEntranceIndex =
                entrances[destinationIdx as usize];
            DoorAna_SetupAction(this,
                                Some(DoorAna_GrabPlayer as
                                         unsafe extern "C" fn(_: *mut DoorAna,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ()));
                      ...
                      (*player).stateFlags1 &
                          0x8800000 as libc::c_int as libc::c_uint == 0 &&
                      (*this).actor.xzDistToPlayer <= 15.0f32 &&
                      -50.0f32 <= (*this).actor.yDistToPlayer &&
                      (*this).actor.yDistToPlayer <= 15.0f32 {
            (*player).stateFlags1 |= 0x80000000 as libc::c_uint;
            (*this).actor.targetMode = 1 as libc::c_int as s8
        } else { (*this).actor.targetMode = 0 as libc::c_int as s8 }
    }
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
}
// update function for after the player has triggered the grotto
#[no_mangle]
pub unsafe extern "C" fn DoorAna_GrabPlayer(mut this: *mut DoorAna,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    if (*this).actor.yDistToPlayer <= 0.0f32 &&
           15.0f32 < (*this).actor.xzDistToPlayer {
        player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        (*player).actor.world.pos.x =
            Math_SinS((*this).actor.yawTowardsPlayer) * 15.0f32 +
                (*this).actor.world.pos.x;
        (*player).actor.world.pos.z =
            Math_CosS((*this).actor.yawTowardsPlayer) * 15.0f32 +
                (*this).actor.world.pos.z
    };
}
#[no_mangle]
pub unsafe extern "C" fn DoorAna_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorAna = thisx as *mut DoorAna;
...
#[no_mangle]
pub unsafe extern "C" fn DoorAna_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_door_ana.c\x00" as *const u8 as
                        *const libc::c_char, 440 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gGrottoDL.as_mut_ptr() as libc::c_uint;
