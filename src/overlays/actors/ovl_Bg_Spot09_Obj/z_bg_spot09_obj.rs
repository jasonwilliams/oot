...
extern "C" {
    ...
    #[no_mangle]
    static mut gValleyBridgeSidesDL: [Gfx; 0];
    #[no_mangle]
    static mut gValleyBridgeChildDL: [Gfx; 0];
    #[no_mangle]
    static mut gValleyObjects2Col: CollisionHeader;
    #[no_mangle]
    static mut gValleyBrokenBridgeDL: [Gfx; 0];
    #[no_mangle]
    static mut gValleyObjects1Col: CollisionHeader;
    #[no_mangle]
    static mut gValleyRepairedBridgeDL: [Gfx; 0];
    #[no_mangle]
    static mut gValleyObjects4Col: CollisionHeader;
    #[no_mangle]
    static mut gCarpentersTentDL: [Gfx; 0];
    #[no_mangle]
    static mut gCarpentersTentEntranceDL: [Gfx; 0];
    #[no_mangle]
    static mut gValleyObjects3Col: CollisionHeader;
}
...
#[no_mangle]
pub static mut Bg_Spot09_Obj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT09_OBJ as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT09_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot09Obj>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot09Obj_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot09Obj_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot09Obj_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot09Obj_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B1F90: [*mut CollisionHeader; 5] =
    unsafe {
        [0 as *const CollisionHeader as *mut CollisionHeader,
         &gValleyObjects1Col as *const CollisionHeader as
             *mut CollisionHeader,
         &gValleyObjects2Col as *const CollisionHeader as
             *mut CollisionHeader,
         &gValleyObjects3Col as *const CollisionHeader as
             *mut CollisionHeader,
         &gValleyObjects4Col as *const CollisionHeader as
             *mut CollisionHeader]
    };
static mut D_808B1FA4:
       [Option<unsafe extern "C" fn(_: *mut BgSpot09Obj,
                                    _: *mut GlobalContext) -> s32>; 3] =
    unsafe {
        [Some(func_808B1BEC as
                  unsafe extern "C" fn(_: *mut BgSpot09Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B1AE0 as
                  unsafe extern "C" fn(_: *mut BgSpot09Obj,
                                       _: *mut GlobalContext) -> s32),
         Some(func_808B1BA0 as
                  unsafe extern "C" fn(_: *mut BgSpot09Obj,
                                       _: *mut GlobalContext) -> s32)]
    };
// Initialized in run_static_initializers
static mut sInitChain1: [InitChainEntry; 3] =
...
static mut sDLists: [*mut Gfx; 5] =
    unsafe {
        [gValleyBridgeSidesDL.as_ptr() as *mut _,
         gValleyBrokenBridgeDL.as_ptr() as *mut _,
         gValleyBridgeChildDL.as_ptr() as *mut _,
         gCarpentersTentDL.as_ptr() as *mut _,
         gValleyRepairedBridgeDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn func_808B1AE0(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut carpentersRescued: s32 = 0;
    if gSaveContext.sceneSetupIndex >= 4 as libc::c_int {
        return ((*this).dyna.actor.params as libc::c_int == 0 as libc::c_int)
                   as libc::c_int
    }
    carpentersRescued =
        (gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int &
             0xf as libc::c_int == 0xf as libc::c_int) as libc::c_int;
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        match (*this).dyna.actor.params as libc::c_int {
            ...
            1 => { return (carpentersRescued == 0) as libc::c_int }
            4 => { return carpentersRescued }
            3 => { return 1 as libc::c_int }
            _ => { }
        }
    } else {
        return ((*this).dyna.actor.params as libc::c_int == 2 as libc::c_int)
                   as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B1BA0(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).dyna.actor.params as libc::c_int == 3 as libc::c_int {
        Actor_SetScale(&mut (*this).dyna.actor, 0.1f32);
    } else { Actor_SetScale(&mut (*this).dyna.actor, 1.0f32); }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B1BEC(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad2: [s32; 2] = [0; 2];
    if !D_808B1F90[(*this).dyna.actor.params as usize].is_null() {
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        CollisionHeader_GetVirtual(D_808B1F90[(*this).dyna.actor.params as
                                                  usize] as *mut libc::c_void,
                                   &mut colHeader);
        (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn func_808B1C70(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B1CEC(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B1D18(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B1D44(mut this: *mut BgSpot09Obj,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).dyna.actor.params as libc::c_int == 3 as libc::c_int {
        return func_808B1D18(this, globalCtx)
    } else { return func_808B1CEC(this, globalCtx) };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot09Obj_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgSpot09Obj = thisx as *mut BgSpot09Obj;
    osSyncPrintf(b"Spot09 Object [arg_data : 0x%04x](\xe5\xa4\xa7\xe5\xb7\xa5\xe6\x95\x91\xe5\x87\xba\xe3\x83\x95\xe3\x83\xa9\xe3\x82\xb0 0x%x)\n\x00"
    ...
    if ((*this).dyna.actor.params as libc::c_int) < 0 as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int >= 5 as libc::c_int {
        osSyncPrintf(b"Error : Spot 09 object \xe3\x81\xae arg_data \xe3\x81\x8c\xe5\x88\xa4\xe5\x88\xa5\xe5\x87\xba\xe6\x9d\xa5\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_spot09_obj.c\x00" as *const u8 as
                         *const libc::c_char, 322 as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    }
    if func_808B1C70(this, globalCtx) == 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    } else if func_808B1D44(this, globalCtx) == 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot09Obj_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut dynaColCtx: *mut DynaCollisionContext =
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot09Obj_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot09Obj_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gCarpentersTentEntranceDL.as_mut_ptr() as libc::c_uint;
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain1 =
        [{
             ...
             init.set_value(7200 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
