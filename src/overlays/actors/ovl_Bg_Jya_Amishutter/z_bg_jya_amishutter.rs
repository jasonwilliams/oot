...
extern "C" {
    ...
    #[no_mangle]
    static mut gAmishutterDL: [Gfx; 0];
    #[no_mangle]
    static mut gAmishutterCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaAmishutter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaAmishutterActionFunc,
}
pub type BgJyaAmishutterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaAmishutter) -> ()>;
#[no_mangle]
pub static mut Bg_Jya_Amishutter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_AMISHUTTER as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JYA_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaAmishutter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaAmishutter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaAmishutter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaAmishutter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaAmishutter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_InitDynaPoly(mut this:
                                                          *mut BgJyaAmishutter,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_amishutter.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaAmishutter = thisx as *mut BgJyaAmishutter;
    BgJyaAmishutter_InitDynaPoly(this, globalCtx, &mut gAmishutterCol,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgJyaAmishutter = thisx as *mut BgJyaAmishutter;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_SetupWaitForPlayer(mut this:
                                                                *mut BgJyaAmishutter) {
    (*this).actionFunc =
        Some(BgJyaAmishutter_WaitForPlayer as
                 unsafe extern "C" fn(_: *mut BgJyaAmishutter) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_WaitForPlayer(mut this:
                                                           *mut BgJyaAmishutter) {
    if (*this).dyna.actor.xzDistToPlayer < 60.0f32 &&
           fabsf((*this).dyna.actor.yDistToPlayer) < 30.0f32 {
        func_80893428(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80893428(mut this: *mut BgJyaAmishutter) {
    (*this).actionFunc =
        Some(func_80893438 as
                 unsafe extern "C" fn(_: *mut BgJyaAmishutter) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80893438(mut this: *mut BgJyaAmishutter) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + 100.0f32, 3.0f32) != 0 {
        func_808934B0(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_808934B0(mut this: *mut BgJyaAmishutter) {
    (*this).actionFunc =
        Some(func_808934C0 as
                 unsafe extern "C" fn(_: *mut BgJyaAmishutter) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808934C0(mut this: *mut BgJyaAmishutter) {
    if (*this).dyna.actor.xzDistToPlayer > 300.0f32 { func_808934FC(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_808934FC(mut this: *mut BgJyaAmishutter) {
    (*this).actionFunc =
        Some(func_8089350C as
                 unsafe extern "C" fn(_: *mut BgJyaAmishutter) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8089350C(mut this: *mut BgJyaAmishutter) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y, 3.0f32) != 0 {
        BgJyaAmishutter_SetupWaitForPlayer(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x2837 as libc::c_int as u16_0);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgJyaAmishutter = thisx as *mut BgJyaAmishutter;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaAmishutter_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gAmishutterDL.as_mut_ptr());
}
