...
extern "C" {
    ...
    #[no_mangle]
    fn BgCheck_AnyLineTest1(colCtx: *mut CollisionContext, posA: *mut Vec3f,
                            posB: *mut Vec3f, posResult: *mut Vec3f,
                            outPoly: *mut *mut CollisionPoly, chkOneFace: s32)
     -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gGerudoPurpleFallingToGroundAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoPurpleEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoPurpleEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoPurpleEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoPurpleSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gGerudoPurpleChargingAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoPurpleLookingAboutAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoPurpleWalkingAnim: AnimationHeader;
}
...
pub struct EnGe2 {
    ...
    pub walkDirection: s16,
    pub yawTowardsPlayer: s16,
    pub yDetectRange: f32_0,
    pub walkDuration: u16_0,
    pub walkTimer: u16_0,
    pub unk_304: u8_0,
    pub timer: u8_0,
    pub playerSpottedParam: u8_0,
    pub actionFunc: EnGe2ActionFunc,
}
pub type EnGe2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const GE2_TYPE_GERUDO_CARD_GIVER: C2RustUnnamed_25 = 2;
pub const GE2_TYPE_STATIONARY: C2RustUnnamed_25 = 1;
pub const GE2_TYPE_PATROLLING: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const GE2_ACTION_WAITLOOKATPLAYER: C2RustUnnamed_26 = 8;
pub const GE2_ACTION_STAND: C2RustUnnamed_26 = 7;
pub const GE2_ACTION_CAPTURECLOSE: C2RustUnnamed_26 = 6;
pub const GE2_ACTION_CAPTURECHARGE: C2RustUnnamed_26 = 5;
pub const GE2_ACTION_CAPTURETURN: C2RustUnnamed_26 = 4;
pub const GE2_ACTION_KNOCKEDOUT: C2RustUnnamed_26 = 3;
pub const GE2_ACTION_TURNPLAYERSPOTTED: C2RustUnnamed_26 = 2;
pub const GE2_ACTION_ABOUTTURN: C2RustUnnamed_26 = 1;
pub const GE2_ACTION_WALK: C2RustUnnamed_26 = 0;
#[no_mangle]
pub static mut En_Ge2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GE2 as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_GLA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnGe2>() as libc::c_ulong,
                          init:
...
static mut sActionFuncs: [EnGe2ActionFunc; 9] =
    unsafe {
        [Some(EnGe2_Walk as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_AboutTurn as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_TurnPlayerSpotted as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_KnockedOut as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_CaptureTurn as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_CaptureCharge as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_CaptureClose as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_Stand as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ()),
         Some(EnGe2_WaitLookAtPlayer as
                  unsafe extern "C" fn(_: *mut EnGe2, _: *mut GlobalContext)
                      -> ())]
    };
static mut sAnimations: [*mut AnimationHeader; 9] =
    unsafe {
        [&gGerudoPurpleWalkingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleLookingAboutAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleLookingAboutAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleFallingToGroundAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleLookingAboutAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleChargingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleLookingAboutAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gGerudoPurpleLookingAboutAnim as *const AnimationHeader as
...
static mut sAnimModes: [u8_0; 9] =
    [ANIMMODE_LOOP as libc::c_int as u8_0,
     ...
     ANIMMODE_ONCE as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn EnGe2_ChangeAction(mut this: *mut EnGe2,
                                            mut i: s32) {
    (*this).actionFunc = sActionFuncs[i as usize];
    Animation_Change(&mut (*this).skelAnime, sAnimations[i as usize], 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sAnimations[i as usize] as
                                                *mut libc::c_void) as f32_0,
                     sAnimModes[i as usize], -8.0f32);
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int)) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gGerudoPurpleSkel, 0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 22 as libc::c_int);
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gGerudoPurpleWalkingAnim);
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT09 as libc::c_int {
        (*this).actor.uncullZoneForward = 1000.0f32
    } else { (*this).actor.uncullZoneForward = 1200.0f32 }
    (*this).yDetectRange =
        ((*this).actor.world.rot.z as libc::c_int + 1 as libc::c_int) as
    ...
    match (*this).actor.params as libc::c_int & 0xff as libc::c_int {
        0 => {
            EnGe2_ChangeAction(this, GE2_ACTION_WALK as libc::c_int);
            if EnGe2_CheckCarpentersFreed() != 0 {
                (*this).actor.update =
                    Some(EnGe2_UpdateFriendly as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut GlobalContext)
                                 -> ());
        ...
        1 => {
            EnGe2_ChangeAction(this, GE2_ACTION_STAND as libc::c_int);
            if EnGe2_CheckCarpentersFreed() != 0 {
                (*this).actor.update =
                    Some(EnGe2_UpdateFriendly as
                             unsafe extern "C" fn(_: *mut Actor,
        ...
        2 => {
            EnGe2_ChangeAction(this,
                               GE2_ACTION_WAITLOOKATPLAYER as libc::c_int);
            (*this).actor.update =
                Some(EnGe2_UpdateAfterTalk as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).actionFunc =
                Some(EnGe2_ForceTalk as
                         unsafe extern "C" fn(_: *mut EnGe2,
                                              _: *mut GlobalContext) -> ());
            (*this).actor.targetMode = 6 as libc::c_int as s8
        }
        _ => {
            if 0 as libc::c_int != 0 {
                ...
                __assert(b"0\x00" as *const u8 as *const libc::c_char,
                         b"../z_en_ge2.c\x00" as *const u8 as
                             *const libc::c_char, 418 as libc::c_int);
            };
        }
    }
    (*this).stateFlags = 0 as libc::c_int as u16_0;
    (*this).unk_304 = 0 as libc::c_int as u8_0;
    (*this).walkTimer = 0 as libc::c_int as u16_0;
    (*this).playerSpottedParam = 0 as libc::c_int as u8_0;
    ...
    (*this).walkDuration =
        ((((*this).actor.params as libc::c_int & 0xff00 as libc::c_int) >>
              8 as libc::c_int) * 10 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
...
#[no_mangle]
pub unsafe extern "C" fn Ge2_DetectPlayerInAction(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut this: *mut EnGe2)
 -> s32 {
    let mut visionScale: f32_0 = 0.;
    visionScale =
        if !(gSaveContext.nightFlag == 0 as libc::c_int) {
            0.75f32
        } else { 1.5f32 };
    if 250.0f32 * visionScale < (*this).actor.xzDistToPlayer {
        return 0 as libc::c_int
    }
    if (*this).actor.xzDistToPlayer < 50.0f32 { return 2 as libc::c_int }
    if func_8002DDE4(globalCtx) != 0 { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn Ge2_DetectPlayerInUpdate(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut this: *mut EnGe2,
                                                  mut pos: *mut Vec3f,
                                                  mut yRot: s16,
                                                  mut yDetectRange: f32_0)
 -> s32 {
    ...
    if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
                yRot as libc::c_int) as s16 as libc::c_int >= 0 as libc::c_int
           {
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 yRot as libc::c_int) as s16 as libc::c_int
        } else {
            -(((*this).actor.yawTowardsPlayer as libc::c_int -
                   yRot as libc::c_int) as s16 as libc::c_int)
    ...
    if BgCheck_AnyLineTest1(&mut (*globalCtx).colCtx, pos,
                            &mut *(*player).bodyPartsPos.as_mut_ptr().offset(7
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                            &mut posResult, &mut outPoly, 0 as libc::c_int) !=
           0 {
        return 0 as libc::c_int
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_CheckCarpentersFreed() -> s32 {
    if (gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int &
            0xf as libc::c_int) as u8_0 as libc::c_int == 0xf as libc::c_int {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
// Actions
#[no_mangle]
pub unsafe extern "C" fn EnGe2_CaptureClose(mut this: *mut EnGe2,
                                            mut globalCtx:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_CaptureCharge(mut this: *mut EnGe2,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       2 as libc::c_int as s16, 0x400 as libc::c_int as s16,
                       0x100 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).actor.xzDistToPlayer < 50.0f32 {
        EnGe2_ChangeAction(this, GE2_ACTION_CAPTURECLOSE as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_CaptureTurn(mut this: *mut EnGe2,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       ...
                       0x100 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).actor.world.rot.y as libc::c_int ==
           (*this).actor.yawTowardsPlayer as libc::c_int {
        EnGe2_ChangeAction(this, GE2_ACTION_CAPTURECHARGE as libc::c_int);
        (*this).timer = 50 as libc::c_int as u8_0;
        (*this).actor.speedXZ = 4.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_KnockedOut(mut this: *mut EnGe2,
                                          mut globalCtx: *mut GlobalContext) {
    static mut effectVelocity: Vec3f =
    ...
    static mut effectPrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut effectEnvColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 255 as libc::c_int as u8_0,
    ...
    if (*this).stateFlags as libc::c_int &
        ...
        effectAngle =
            (*globalCtx).state.frames.wrapping_mul(0x2800 as libc::c_int as
                                                       libc::c_uint) as s32;
        effectPos.x =
            (*this).actor.focus.pos.x +
                Math_CosS(effectAngle as s16) * 5.0f32;
        effectPos.y = (*this).actor.focus.pos.y + 10.0f32;
        effectPos.z =
            (*this).actor.focus.pos.z +
                Math_SinS(effectAngle as s16) * 5.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_TurnPlayerSpotted(mut this: *mut EnGe2,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut playerSpotted: s32 = 0;
    (*this).actor.speedXZ = 0.0f32;
    if (*this).stateFlags as libc::c_int &
        ...
        if playerSpotted != 0 as libc::c_int {
            (*this).timer = 100 as libc::c_int as u8_0;
            (*this).yawTowardsPlayer = (*this).actor.yawTowardsPlayer;
            if ((*this).playerSpottedParam as libc::c_int) < playerSpotted {
                (*this).playerSpottedParam = playerSpotted as u8_0
            }
        } else if (*this).actor.world.rot.y as libc::c_int ==
                      (*this).yawTowardsPlayer as libc::c_int {
            (*this).playerSpottedParam = 0 as libc::c_int as u8_0;
            EnGe2_ChangeAction(this, GE2_ACTION_ABOUTTURN as libc::c_int);
            return
        }
    }
    match (*this).playerSpottedParam as libc::c_int {
        1 => {
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_AboutTurn(mut this: *mut EnGe2,
                                         mut globalCtx: *mut GlobalContext) {
    let mut playerSpotted: s32 = 0;
    (*this).actor.speedXZ = 0.0f32;
    playerSpotted = Ge2_DetectPlayerInAction(globalCtx, this);
    if playerSpotted != 0 as libc::c_int {
        EnGe2_ChangeAction(this, GE2_ACTION_TURNPLAYERSPOTTED as libc::c_int);
        (*this).timer = 100 as libc::c_int as u8_0;
        (*this).playerSpottedParam = playerSpotted as u8_0;
        (*this).yawTowardsPlayer = (*this).actor.yawTowardsPlayer
                  ...
                  (1 as libc::c_int) << 1 as libc::c_int != 0 {
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (*this).walkDirection, 2 as libc::c_int as s16,
                           0x400 as libc::c_int as s16,
                           0x200 as libc::c_int as s16);
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y
    }
    if (*this).actor.shape.rot.y as libc::c_int ==
           (*this).walkDirection as libc::c_int {
        EnGe2_ChangeAction(this, GE2_ACTION_WALK as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Walk(mut this: *mut EnGe2,
                                    mut globalCtx: *mut GlobalContext) {
    let mut playerSpotted: u8_0 = 0;
    playerSpotted = Ge2_DetectPlayerInAction(globalCtx, this) as u8_0;
    if playerSpotted as libc::c_int != 0 as libc::c_int {
        (*this).actor.speedXZ = 0.0f32;
        EnGe2_ChangeAction(this, GE2_ACTION_TURNPLAYERSPOTTED as libc::c_int);
        (*this).timer = 100 as libc::c_int as u8_0;
        (*this).playerSpottedParam = playerSpotted;
        (*this).yawTowardsPlayer = (*this).actor.yawTowardsPlayer
    } else if (*this).walkTimer as libc::c_int >=
                  (*this).walkDuration as libc::c_int {
        (*this).walkTimer = 0 as libc::c_int as u16_0;
        (*this).walkDirection =
            ((*this).walkDirection as libc::c_int + 0x8000 as libc::c_int) as
                s16;
        EnGe2_ChangeAction(this, GE2_ACTION_ABOUTTURN as libc::c_int);
        (*this).actor.speedXZ = 0.0f32
    } else {
        (*this).walkTimer = (*this).walkTimer.wrapping_add(1);
        (*this).actor.speedXZ = 2.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Stand(mut this: *mut EnGe2,
                                     mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).walkDirection,
                       2 as libc::c_int as s16, 0x400 as libc::c_int as s16,
                       0x200 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_TurnToFacePlayer(mut this: *mut EnGe2,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if (if angleDiff as libc::c_int >= 0 as libc::c_int {
        ...
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).headRot,
                      &mut (*this).unk_2EE, (*this).actor.focus.pos);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_LookAtPlayer(mut this: *mut EnGe2,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
            ...
            -(((*this).actor.yawTowardsPlayer as libc::c_int -
                   (*this).actor.shape.rot.y as libc::c_int) as s16 as
                  libc::c_int)
        }) <= 0x4300 as libc::c_int && (*this).actor.xzDistToPlayer < 200.0f32
       {
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).headRot,
                      &mut (*this).unk_2EE, (*this).actor.focus.pos);
    } else {
        ...
        Math_SmoothStepToS(&mut (*this).headRot.y, 0 as libc::c_int as s16,
                           ...
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2EE.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2EE.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_SetActionAfterTalk(mut this: *mut EnGe2,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_WaitLookAtPlayer(mut this: *mut EnGe2,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    EnGe2_LookAtPlayer(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_WaitTillCardGiven(mut this: *mut EnGe2,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).actionFunc =
            Some(EnGe2_SetActionAfterTalk as
                     unsafe extern "C" fn(_: *mut EnGe2,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_GERUDO_CARD as libc::c_int, 10000.0f32, 50.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_GiveCard(mut this: *mut EnGe2,
                                        mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(EnGe2_WaitTillCardGiven as
                     unsafe extern "C" fn(_: *mut EnGe2,
                                          _: *mut GlobalContext) -> ());
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_GERUDO_CARD as libc::c_int, 10000.0f32, 50.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_ForceTalk(mut this: *mut EnGe2,
                                         mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnGe2_GiveCard as
                     unsafe extern "C" fn(_: *mut EnGe2,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actor.textId = 0x6004 as libc::c_int as u16_0;
        (*this).actor.flags |=
            ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        func_8002F1C4(&mut (*this).actor, globalCtx, 300.0f32, 300.0f32,
                      0 as libc::c_int as u32_0);
    }
    EnGe2_LookAtPlayer(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_SetupCapturePlayer(mut this: *mut EnGe2,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
    ...
    (*this).actor.speedXZ = 0.0f32;
    EnGe2_ChangeAction(this, GE2_ACTION_CAPTURETURN as libc::c_int);
    func_8002DF54(globalCtx, &mut (*this).actor, 95 as libc::c_int as u8_0);
    func_80078884(0x482c as libc::c_int as u16_0);
    Message_StartTextbox(globalCtx, 0x6000 as libc::c_int as u16_0,
                         &mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_MaintainColliderAndSetAnimState(mut this:
                                                                   *mut EnGe2,
                                                               mut globalCtx:
                                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_MoveAndBlink(mut this: *mut EnGe2,
                                            mut globalCtx:
                                                *mut GlobalContext) {
...
// Update functions
#[no_mangle]
pub unsafe extern "C" fn EnGe2_UpdateFriendly(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.params as libc::c_int & 0xff as libc::c_int ==
               GE2_TYPE_PATROLLING as libc::c_int {
            (*this).actor.speedXZ = 0.0f32;
            EnGe2_ChangeAction(this,
                               GE2_ACTION_WAITLOOKATPLAYER as libc::c_int);
        }
        ...
        (*this).actor.textId = 0x6005 as libc::c_int as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_UpdateAfterTalk(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    (*this).stateFlags =
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    let mut paramsType: s32 = 0;
    EnGe2_MaintainColliderAndSetAnimState(this, globalCtx);
    if (*this).stateFlags as libc::c_int &
        ...
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
    } else if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int
                  != 0 {
        if !(*this).collider.info.acHitInfo.is_null() &&
            ...
            (*this).actor.update =
                Some(EnGe2_UpdateStunned as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            return
        }
        EnGe2_ChangeAction(this, GE2_ACTION_KNOCKEDOUT as libc::c_int);
        (*this).timer = 100 as libc::c_int as u8_0;
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int |
        ...
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        if Ge2_DetectPlayerInUpdate(globalCtx, this,
                                    &mut (*this).actor.focus.pos,
                                    (*this).actor.shape.rot.y,
                                    (*this).yDetectRange) != 0 {
            // "Discovered!"
            osSyncPrintf(b"\x1b[32m\xe7\x99\xba\xe8\xa6\x8b!!!!!!!!!!!!\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            EnGe2_SetupCapturePlayer(this, globalCtx);
        }
        if (*this).actor.params as libc::c_int & 0xff as libc::c_int ==
               GE2_TYPE_STATIONARY as libc::c_int &&
               (*this).actor.xzDistToPlayer < 100.0f32 {
            // "Discovered!"
            osSyncPrintf(b"\x1b[32m\xe7\x99\xba\xe8\xa6\x8b!!!!!!!!!!!!\n\x1b[m\x00"
                             as *const u8 as
                             *const libc::c_char); // Not necessary, but looks a bit nicer
            EnGe2_SetupCapturePlayer(this, globalCtx);
        }
    }
    if (*this).stateFlags as libc::c_int &
        ...
        if paramsType == GE2_TYPE_PATROLLING as libc::c_int ||
               paramsType == GE2_TYPE_STATIONARY as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_UpdateStunned(mut thisx: *mut Actor,
                                             mut globalCtx2:
                                                 *mut GlobalContext) {
    ...
    if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int != 0 &&
           ((*this).collider.info.acHitInfo.is_null() ||
                (*(*this).collider.info.acHitInfo).toucher.dmgFlags &
                    0x80 as libc::c_int as libc::c_uint == 0) {
    ...
    if EnGe2_CheckCarpentersFreed() != 0 {
        ...
        (*this).actor.colorFilterTimer = 0 as libc::c_int as u8_0
                  ...
                  0 as libc::c_int {
        (*this).actor.update =
            Some(EnGe2_Update as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnGe2_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    static mut D_80A343B0: Vec3f =
        { let mut init = Vec3f{x: 600.0f32, y: 700.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    if limbIndex == 6 as libc::c_int {
        Matrix_MultVec3f(&mut D_80A343B0, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe2_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gGerudoPurpleEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGerudoPurpleEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGerudoPurpleEyeClosedTex.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut pad: s32 = 0;
    let mut this: *mut EnGe2 = thisx as *mut EnGe2;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ge2.c\x00" as *const u8 as *const libc::c_char,
                    1274 as libc::c_int);
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnGe2_OverrideLimbDraw as
