...
extern "C" {
    ...
    #[no_mangle]
    fn func_800435B4(dynaActor: *mut DynaPolyActor) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    fn OnePointCutscene_AttentionSetSfx(globalCtx: *mut GlobalContext,
                                        actor: *mut Actor, sfxId: s32) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gFloorSwitch1DL: [Gfx; 0];
    #[no_mangle]
    static mut gRustyFloorSwitchDL: [Gfx; 0];
    #[no_mangle]
    static mut gFloorSwitch2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFloorSwitchCol: CollisionHeader;
    #[no_mangle]
    static mut gFloorSwitch3DL: [Gfx; 0];
    #[no_mangle]
    static mut gEyeSwitch1DL: [Gfx; 0];
    #[no_mangle]
    static mut gEyeSwitch2DL: [Gfx; 0];
    #[no_mangle]
    static mut gCrystalSwitchCoreOpaDL: [Gfx; 0];
    #[no_mangle]
    static mut gCrystalSwitchCoreXluDL: [Gfx; 0];
    #[no_mangle]
    static mut gCrystalSwitchDiamondOpaDL: [Gfx; 0];
    #[no_mangle]
    static mut gCrystalSwitchDiamondXluDL: [Gfx; 0];
    #[no_mangle]
    static mut gEyeSwitchGoldClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchGoldOpeningTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchGoldClosingTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchGoldOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchSilverOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchSilverHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gEyeSwitchSilverClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gCrstalSwitchRedTex: [u64_0; 0];
    #[no_mangle]
    static mut gCrstalSwitchBlueTex: [u64_0; 0];
}
...
pub struct ObjSwitch {
    ...
    pub actionFunc: ObjSwitchActionFunc,
    pub releaseTimer: s16,
    pub disableAcTimer: s16,
    pub cooldownTimer: s16,
    pub cooldownOn: u8_0,
    pub eyeTexIndex: s16,
    pub crystalSubtype1texture: *mut libc::c_void,
    pub x1TexScroll: u8_0,
    pub y1TexScroll: u8_0,
    pub x2TexScroll: u8_0,
    pub y2TexScroll: u8_0,
    pub crystalColor: Color_RGB8,
    pub unk_17F: u8_0,
...
pub union C2RustUnnamed_23 {
    pub jntSph: ObjSwitchJntSph,
    pub tris: ObjSwitchTris,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjSwitchTris {
    pub col: ColliderTris,
    pub items: [ColliderTrisElement; 2],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjSwitchJntSph {
    pub col: ColliderJntSph,
    pub items: [ColliderJntSphElement; 2],
}
pub type ObjSwitchActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjSwitch, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const OBJSWITCH_TYPE_CRYSTAL_TARGETABLE: C2RustUnnamed_24 = 4;
pub const OBJSWITCH_TYPE_CRYSTAL: C2RustUnnamed_24 = 3;
pub const OBJSWITCH_TYPE_EYE: C2RustUnnamed_24 = 2;
pub const OBJSWITCH_TYPE_FLOOR_RUSTY: C2RustUnnamed_24 = 1;
pub const OBJSWITCH_TYPE_FLOOR: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const OBJSWITCH_SUBTYPE_FLOOR_3: C2RustUnnamed_25 = 3;
pub const OBJSWITCH_SUBTYPE_FLOOR_2: C2RustUnnamed_25 = 2;
pub const OBJSWITCH_SUBTYPE_FLOOR_1: C2RustUnnamed_25 = 1;
pub const OBJSWITCH_SUBTYPE_FLOOR_0: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const OBJSWITCH_SUBTYPE_EYE_1: C2RustUnnamed_26 = 1;
pub const OBJSWITCH_SUBTYPE_EYE_0: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const OBJSWITCH_SUBTYPE_CRYSTAL_4: C2RustUnnamed_27 = 4;
pub const OBJSWITCH_SUBTYPE_CRYSTAL_1: C2RustUnnamed_27 = 1;
pub const OBJSWITCH_SUBTYPE_CRYSTAL_0: C2RustUnnamed_27 = 0;
#[no_mangle]
pub static mut Obj_Switch_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_SWITCH as libc::c_int as s16,
                          category: ACTORCAT_SWITCH as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as
                                  s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjSwitch>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSwitch_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSwitch_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sHeights: [f32_0; 5] =
    [10 as libc::c_int as f32_0, 10 as libc::c_int as f32_0,
     0 as libc::c_int as f32_0, 30 as libc::c_int as f32_0,
     30 as libc::c_int as f32_0];
static mut D_80B9EC34: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
...
static mut sRustyFloorTrisInit: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements: D_80B9EC34.as_ptr() as *mut _,};
            init
        }
    };
static mut D_80B9ECBC: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
             ColliderTrisElementInit{info:
                                         {
...
static mut trisColliderEye: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 count: 2 as libc::c_int,
                                 elements: D_80B9ECBC.as_ptr() as *mut _,};
            init
        }
    };
static mut D_80B9ED44: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
...
static mut sCyrstalJntSphereInit: ColliderJntSphInit =
    unsafe {
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   elements: D_80B9ED44.as_ptr() as *mut _,};
            init
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_RotateY(mut dest: *mut Vec3f,
                                           mut src: *mut Vec3f,
                                           mut angle: s16) {
    let mut s: f32_0 = Math_SinS(angle);
    let mut c: f32_0 = Math_CosS(angle);
    (*dest).x = (*src).z * s + (*src).x * c;
    (*dest).y = (*src).y;
    (*dest).z = (*src).z * c - (*src).x * s;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_InitDynapoly(mut this: *mut ObjSwitch,
                                                mut globalCtx:
                                                    *mut GlobalContext,
                                                mut collision:
                                                    *mut CollisionHeader,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_obj_switch.c\x00" as *const u8 as
                         *const libc::c_char, 531 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_InitJntSphCollider(mut this:
                                                          *mut ObjSwitch,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut colliderJntSphInit:
                                                          *mut ColliderJntSphInit) {
    let mut colliderJntSph: *mut ColliderJntSph =
        &mut (*this).c2rust_unnamed.jntSph.col;
    Collider_InitJntSph(globalCtx, colliderJntSph);
    Collider_SetJntSph(globalCtx, colliderJntSph, &mut (*this).dyna.actor,
                       colliderJntSphInit,
                       (*this).c2rust_unnamed.jntSph.items.as_mut_ptr());
    func_800D1694((*this).dyna.actor.world.pos.x,
                  (*this).dyna.actor.world.pos.y +
                      (*this).dyna.actor.shape.yOffset *
                          (*this).dyna.actor.scale.y,
                  (*this).dyna.actor.world.pos.z,
                  &mut (*this).dyna.actor.shape.rot);
    Matrix_Scale((*this).dyna.actor.scale.x, (*this).dyna.actor.scale.y,
                 (*this).dyna.actor.scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Collider_UpdateSpheres(0 as libc::c_int, colliderJntSph);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_InitTrisCollider(mut this: *mut ObjSwitch,
                                                    mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut colliderTrisInit:
                                                        *mut ColliderTrisInit) {
    let mut colliderTris: *mut ColliderTris =
        &mut (*this).c2rust_unnamed.tris.col;
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut pos: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    Collider_InitTris(globalCtx, colliderTris);
    Collider_SetTris(globalCtx, colliderTris, &mut (*this).dyna.actor,
                     colliderTrisInit,
                     (*this).c2rust_unnamed.tris.items.as_mut_ptr());
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        j = 0 as libc::c_int;
        while j < 3 as libc::c_int {
            ObjSwitch_RotateY(&mut *pos.as_mut_ptr().offset(j as isize),
                              &mut *(*(*colliderTrisInit).elements.offset(i as
                                                                              isize)).dim.vtx.as_mut_ptr().offset(j
                                                                                                                      as
                                                                                                                      isize),
                              (*this).dyna.actor.home.rot.y);
            Math_Vec3f_Sum(&mut *pos.as_mut_ptr().offset(j as isize),
                           &mut (*this).dyna.actor.world.pos,
                           &mut *pos.as_mut_ptr().offset(j as isize));
            j += 1
        }
        Collider_SetTrisVertices(colliderTris, i,
                                 &mut *pos.as_mut_ptr().offset(0 as
                                                                   libc::c_int
                                                                   as isize),
                                 &mut *pos.as_mut_ptr().offset(1 as
                                                                   libc::c_int
                                                                   as isize),
                                 &mut *pos.as_mut_ptr().offset(2 as
                                                                   libc::c_int
                                                                   as isize));
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_SpawnIce(mut this: *mut ObjSwitch,
                                            mut globalCtx: *mut GlobalContext)
 -> *mut Actor {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    return Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, thisx, globalCtx,
                              ACTOR_OBJ_ICE_POLY as libc::c_int as s16,
                              (*thisx).world.pos.x, (*thisx).world.pos.y,
                              (*thisx).world.pos.z, (*thisx).world.rot.x,
                              (*thisx).world.rot.y, (*thisx).world.rot.z,
                              (((*this).dyna.actor.params as libc::c_int >>
                                    8 as libc::c_int & 0x3f as libc::c_int) <<
                                   8 as libc::c_int) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_SetOn(mut this: *mut ObjSwitch,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut subType: s32 = 0;
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0x3f as libc::c_int) != 0 {
        (*this).cooldownOn = 0 as libc::c_int as u8_0
    } else {
        subType =
            (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
                7 as libc::c_int;
        Flags_SetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int);
        if subType == 0 as libc::c_int || subType == 4 as libc::c_int {
            OnePointCutscene_AttentionSetSfx(globalCtx,
                                             &mut (*this).dyna.actor,
                                             0x4802 as libc::c_int);
        } else {
            OnePointCutscene_AttentionSetSfx(globalCtx,
                                             &mut (*this).dyna.actor,
                                             0x4807 as libc::c_int);
        }
        (*this).cooldownOn = 1 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_SetOff(mut this: *mut ObjSwitch,
                                          mut globalCtx: *mut GlobalContext) {
    (*this).cooldownOn = 0 as libc::c_int as u8_0;
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0x3f as libc::c_int) != 0 {
        Flags_UnsetSwitch(globalCtx,
                          (*this).dyna.actor.params as libc::c_int >>
                              8 as libc::c_int & 0x3f as libc::c_int);
        if (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_UpdateTwoTexScrollXY(mut this:
                                                            *mut ObjSwitch) {
    (*this).x1TexScroll =
        ((*this).x1TexScroll as libc::c_int - 1 as libc::c_int &
             0x7f as libc::c_int) as u8_0;
    (*this).y1TexScroll =
        ((*this).y1TexScroll as libc::c_int + 1 as libc::c_int &
             0x7f as libc::c_int) as u8_0;
    (*this).x2TexScroll =
        ((*this).x2TexScroll as libc::c_int + 1 as libc::c_int &
             0x7f as libc::c_int) as u8_0;
    (*this).y2TexScroll =
        ((*this).y2TexScroll as libc::c_int - 1 as libc::c_int &
             0x7f as libc::c_int) as u8_0;
}
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjSwitch = thisx as *mut ObjSwitch;
    let mut switchFlagSet: s32 = 0;
    let mut type_0: s32 = 0;
    switchFlagSet =
        Flags_GetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int);
    type_0 = (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int;
    if type_0 == OBJSWITCH_TYPE_FLOOR as libc::c_int ||
           type_0 == OBJSWITCH_TYPE_FLOOR_RUSTY as libc::c_int {
        ObjSwitch_InitDynapoly(this, globalCtx, &mut gFloorSwitchCol,
                               DPM_PLAYER as libc::c_int);
    }
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
    if type_0 == OBJSWITCH_TYPE_FLOOR as libc::c_int ||
           type_0 == OBJSWITCH_TYPE_FLOOR_RUSTY as libc::c_int {
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y + 1.0f32
    }
    Actor_SetFocus(&mut (*this).dyna.actor, sHeights[type_0 as usize]);
    if type_0 == OBJSWITCH_TYPE_FLOOR_RUSTY as libc::c_int {
        ObjSwitch_InitTrisCollider(this, globalCtx, &mut sRustyFloorTrisInit);
    } else if type_0 == OBJSWITCH_TYPE_EYE as libc::c_int {
        ObjSwitch_InitTrisCollider(this, globalCtx, &mut trisColliderEye);
    } else if type_0 == OBJSWITCH_TYPE_CRYSTAL as libc::c_int ||
                  type_0 == OBJSWITCH_TYPE_CRYSTAL_TARGETABLE as libc::c_int {
        ObjSwitch_InitJntSphCollider(this, globalCtx,
                                     &mut sCyrstalJntSphereInit);
    }
    if type_0 == OBJSWITCH_TYPE_CRYSTAL_TARGETABLE as libc::c_int {
        (*this).dyna.actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).dyna.actor.targetMode = 4 as libc::c_int as s8
    }
    (*this).dyna.actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    if (*this).dyna.actor.params as libc::c_int >> 7 as libc::c_int &
           1 as libc::c_int != 0 &&
           ObjSwitch_SpawnIce(this, globalCtx).is_null() {
        osSyncPrintf(b"\x1b[31m\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"Error : \xe6\xb0\xb7\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_switch.c\x00" as *const u8 as
    ...
    } else if type_0 == OBJSWITCH_TYPE_FLOOR as libc::c_int ||
                  type_0 == OBJSWITCH_TYPE_FLOOR_RUSTY as libc::c_int {
        if switchFlagSet != 0 {
            ObjSwitch_FloorDownInit(this);
        } else { ObjSwitch_FloorUpInit(this); }
    } else if type_0 == OBJSWITCH_TYPE_EYE as libc::c_int {
        if switchFlagSet != 0 {
            ObjSwitch_EyeClosedInit(this);
        } else { ObjSwitch_EyeOpenInit(this); }
    } else if type_0 == OBJSWITCH_TYPE_CRYSTAL as libc::c_int ||
                  type_0 == OBJSWITCH_TYPE_CRYSTAL_TARGETABLE as libc::c_int {
        if switchFlagSet != 0 {
            ObjSwitch_CrystalOnInit(this);
        } else { ObjSwitch_CrystalOffInit(this); }
    }
    osSyncPrintf(b"(Dungeon switch)(arg_data 0x%04x)\n\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjSwitch = thisx as *mut ObjSwitch;
    match (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int {
        0 | 1 => {
    ...
    match (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int {
        1 | 2 => {
            Collider_DestroyTris(globalCtx,
                                 &mut (*this).c2rust_unnamed.tris.col);
        }
        3 | 4 => {
            Collider_DestroyJntSph(globalCtx,
                                   &mut (*this).c2rust_unnamed.jntSph.col);
        }
        _ => { }
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorUpInit(mut this: *mut ObjSwitch) {
    (*this).dyna.actor.scale.y = 33.0f32 / 200.0f32;
    (*this).actionFunc =
        Some(ObjSwitch_FloorUp as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorUp(mut this: *mut ObjSwitch,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int ==
           OBJSWITCH_TYPE_FLOOR_RUSTY as libc::c_int {
        if (*this).c2rust_unnamed.tris.col.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            ObjSwitch_FloorPressInit(this);
            ObjSwitch_SetOn(this, globalCtx);
            (*this).c2rust_unnamed.tris.col.base.acFlags =
                ((*this).c2rust_unnamed.tris.col.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
        } else {
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).c2rust_unnamed.tris.col.base);
        }
    } else {
        match (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
                  7 as libc::c_int {
            0 => {
            ...
            1 => {
                if (*this).dyna.unk_160 as libc::c_int & 2 as libc::c_int != 0
                       &&
                       (*this).unk_17F as libc::c_int & 2 as libc::c_int == 0
                   {
                    ObjSwitch_FloorPressInit(this);
                    ObjSwitch_SetOn(this, globalCtx);
                }
            ...
            2 => {
                if func_800435B4(&mut (*this).dyna) != 0 {
                    ObjSwitch_FloorPressInit(this);
                    ObjSwitch_SetOn(this, globalCtx);
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorPressInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_FloorPress as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorPress(mut this: *mut ObjSwitch,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
           7 as libc::c_int == OBJSWITCH_SUBTYPE_FLOOR_3 as libc::c_int ||
           (*this).cooldownOn == 0 ||
           func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).cooldownTimer as libc::c_int <= 0 as libc::c_int {
        (*this).dyna.actor.scale.y -= 99.0f32 / 2000.0f32;
        if (*this).dyna.actor.scale.y <= 33.0f32 / 2000.0f32 {
            ObjSwitch_FloorDownInit(this);
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2815 as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorDownInit(mut this: *mut ObjSwitch) {
    (*this).dyna.actor.scale.y = 33.0f32 / 2000.0f32;
    (*this).releaseTimer = 6 as libc::c_int as s16;
    (*this).actionFunc =
        Some(ObjSwitch_FloorDown as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorDown(mut this: *mut ObjSwitch,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
              7 as libc::c_int {
        ...
        2 | 3 => {
            if func_800435B4(&mut (*this).dyna) == 0 &&
                ...
                if (*this).releaseTimer as libc::c_int <= 0 as libc::c_int {
                    ObjSwitch_FloorReleaseInit(this);
                    if (*this).dyna.actor.params as libc::c_int >>
                           4 as libc::c_int & 7 as libc::c_int ==
                           OBJSWITCH_SUBTYPE_FLOOR_2 as libc::c_int {
                        ObjSwitch_SetOff(this, globalCtx);
                    } else { ObjSwitch_SetOn(this, globalCtx); }
                }
            } else { (*this).releaseTimer = 6 as libc::c_int as s16 }
        }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorReleaseInit(mut this:
                                                        *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_FloorRelease as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_FloorRelease(mut this: *mut ObjSwitch,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut subType: s16 =
        ((*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
             7 as libc::c_int) as s16;
    if subType as libc::c_int != OBJSWITCH_SUBTYPE_FLOOR_1 as libc::c_int &&
           subType as libc::c_int != OBJSWITCH_SUBTYPE_FLOOR_3 as libc::c_int
           || (*this).cooldownOn == 0 ||
           func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).cooldownTimer as libc::c_int <= 0 as libc::c_int {
        (*this).dyna.actor.scale.y += 99.0f32 / 2000.0f32;
        if (*this).dyna.actor.scale.y >= 33.0f32 / 200.0f32 {
            ObjSwitch_FloorUpInit(this);
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2815 as libc::c_int as u16_0);
            if subType as libc::c_int ==
                   OBJSWITCH_SUBTYPE_FLOOR_1 as libc::c_int {
                func_800AA000((*this).dyna.actor.xyzDistToPlayerSq,
                              120 as libc::c_int as u8_0,
                              20 as libc::c_int as u8_0,
                              10 as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeIsHit(mut this: *mut ObjSwitch) -> s32 {
    let mut collidingActor: *mut Actor = 0 as *mut Actor;
    let mut yawDiff: s16 = 0;
    if (*this).c2rust_unnamed.tris.col.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 &&
           (*this).unk_17F as libc::c_int & 2 as libc::c_int == 0 {
        collidingActor = (*this).c2rust_unnamed.tris.col.base.ac;
        if !collidingActor.is_null() {
            yawDiff =
                ((*collidingActor).world.rot.y as libc::c_int -
                     (*this).dyna.actor.shape.rot.y as libc::c_int) as s16;
            if (if yawDiff as libc::c_int >= 0 as libc::c_int {
                    yawDiff as libc::c_int
                } else { -(yawDiff as libc::c_int) }) > 0x5000 as libc::c_int
               {
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeFrozenInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_EyeInit as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeInit(mut this: *mut ObjSwitch,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeOpenInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_EyeOpen as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).eyeTexIndex = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeOpen(mut this: *mut ObjSwitch,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if ObjSwitch_EyeIsHit(this) != 0 ||
           (*this).dyna.actor.params as libc::c_int >> 7 as libc::c_int &
               1 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeClosingInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_EyeClosing as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeClosing(mut this: *mut ObjSwitch,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).cooldownOn == 0 ||
           func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).cooldownTimer as libc::c_int <= 0 as libc::c_int {
        (*this).eyeTexIndex += 1;
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeClosedInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_EyeClosed as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).eyeTexIndex = 3 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeClosed(mut this: *mut ObjSwitch,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
              7 as libc::c_int {
        ...
        1 => {
            if ObjSwitch_EyeIsHit(this) != 0 ||
                   (*this).dyna.actor.params as libc::c_int >>
                       7 as libc::c_int & 1 as libc::c_int != 0 {
                ObjSwitch_EyeOpeningInit(this);
                ObjSwitch_SetOff(this, globalCtx);
                (*this).dyna.actor.params =
                    ((*this).dyna.actor.params as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeOpeningInit(mut this: *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_EyeOpening as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_EyeOpening(mut this: *mut ObjSwitch,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
           7 as libc::c_int != OBJSWITCH_SUBTYPE_EYE_1 as libc::c_int ||
           (*this).cooldownOn == 0 ||
           func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
           (*this).cooldownTimer as libc::c_int <= 0 as libc::c_int {
        (*this).eyeTexIndex -= 1;
        if (*this).eyeTexIndex as libc::c_int <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalOffInit(mut this: *mut ObjSwitch) {
    (*this).crystalColor.r = 0 as libc::c_int as u8_0;
    (*this).crystalColor.g = 0 as libc::c_int as u8_0;
    (*this).crystalColor.b = 0 as libc::c_int as u8_0;
    (*this).crystalSubtype1texture =
        gCrstalSwitchRedTex.as_mut_ptr() as *mut libc::c_void;
    (*this).actionFunc =
        Some(ObjSwitch_CrystalOff as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalOff(mut this: *mut ObjSwitch,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
              7 as libc::c_int {
        0 => {
            if (*this).c2rust_unnamed.jntSph.col.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                   (*this).disableAcTimer as libc::c_int <= 0 as libc::c_int {
                (*this).disableAcTimer = 10 as libc::c_int as s16;
                ObjSwitch_SetOn(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalTurnOnInit(mut this:
                                                         *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_CrystalTurnOn as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalTurnOn(mut this: *mut ObjSwitch,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).cooldownOn == 0 ||
           func_8005B198() == (*this).dyna.actor.category as libc::c_int ||
        ...
        ObjSwitch_CrystalOnInit(this);
        if (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
               7 as libc::c_int == OBJSWITCH_SUBTYPE_CRYSTAL_1 as libc::c_int
           {
            ObjSwitch_UpdateTwoTexScrollXY(this);
        }
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28ba as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalOnInit(mut this: *mut ObjSwitch) {
    (*this).crystalColor.r = 255 as libc::c_int as u8_0;
    (*this).crystalColor.g = 255 as libc::c_int as u8_0;
    (*this).crystalColor.b = 255 as libc::c_int as u8_0;
    (*this).crystalSubtype1texture =
        gCrstalSwitchBlueTex.as_mut_ptr() as *mut libc::c_void;
    (*this).actionFunc =
        Some(ObjSwitch_CrystalOn as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalOn(mut this: *mut ObjSwitch,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
              7 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalTurnOffInit(mut this:
                                                          *mut ObjSwitch) {
    (*this).actionFunc =
        Some(ObjSwitch_CrystalTurnOff as
                 unsafe extern "C" fn(_: *mut ObjSwitch,
                                      _: *mut GlobalContext) -> ());
    (*this).cooldownTimer = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_CrystalTurnOff(mut this: *mut ObjSwitch,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
           7 as libc::c_int != OBJSWITCH_SUBTYPE_CRYSTAL_1 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjSwitch = thisx as *mut ObjSwitch;
    if (*this).releaseTimer as libc::c_int > 0 as libc::c_int {
        (*this).releaseTimer -= 1
    }
    if (*this).cooldownTimer as libc::c_int > 0 as libc::c_int {
        (*this).cooldownTimer -= 1
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    match (*this).dyna.actor.params as libc::c_int & 7 as libc::c_int {
        0 | 1 => { (*this).unk_17F = (*this).dyna.unk_160 }
        2 => {
            (*this).unk_17F = (*this).c2rust_unnamed.tris.col.base.acFlags;
            (*this).c2rust_unnamed.tris.col.base.acFlags =
                ((*this).c2rust_unnamed.tris.col.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
        ...
        3 | 4 => {
            if Player_InCsMode(globalCtx) == 0 &&
                   (*this).disableAcTimer as libc::c_int > 0 as libc::c_int {
                (*this).disableAcTimer -= 1
            }
            (*this).unk_17F = (*this).c2rust_unnamed.jntSph.col.base.acFlags;
            (*this).c2rust_unnamed.jntSph.col.base.acFlags =
                ((*this).c2rust_unnamed.jntSph.col.base.acFlags as libc::c_int
                     & !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*this).disableAcTimer as libc::c_int <= 0 as libc::c_int {
                CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                     &mut (*this).c2rust_unnamed.jntSph.col.base);
            }
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_DrawFloor(mut this: *mut ObjSwitch,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut floorSwitchDLists: [*mut Gfx; 4] =
        unsafe {
            [gFloorSwitch1DL.as_ptr() as *mut _,
             gFloorSwitch3DL.as_ptr() as *mut _,
             gFloorSwitch2DL.as_ptr() as *mut _,
             gFloorSwitch2DL.as_ptr() as *mut _]
        };
    Gfx_DrawDListOpa(globalCtx,
                     floorSwitchDLists[((*this).dyna.actor.params as
                                            libc::c_int >> 4 as libc::c_int &
                                            7 as libc::c_int) as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_DrawFloorRusty(mut this: *mut ObjSwitch,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gRustyFloorSwitchDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_DrawEye(mut this: *mut ObjSwitch,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut eyeTextures: [[*mut libc::c_void; 4]; 2] =
        unsafe {
            [[gEyeSwitchGoldOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
              gEyeSwitchGoldOpeningTex.as_ptr() as *mut _ as
                  *mut libc::c_void,
              gEyeSwitchGoldClosingTex.as_ptr() as *mut _ as
                  *mut libc::c_void,
              gEyeSwitchGoldClosedTex.as_ptr() as *mut _ as
                  *mut libc::c_void],
             [gEyeSwitchSilverOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
              gEyeSwitchSilverHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
              gEyeSwitchSilverClosedTex.as_ptr() as *mut _ as
                  *mut libc::c_void,
              gEyeSwitchSilverClosedTex.as_ptr() as *mut _ as
                  *mut libc::c_void]]
        };
    static mut eyeDlists: [*mut Gfx; 2] =
        unsafe {
            [gEyeSwitch1DL.as_ptr() as *mut _,
             gEyeSwitch2DL.as_ptr() as *mut _]
        };
    let mut pad: s32 = 0;
    let mut subType: s32 =
        (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_switch.c\x00" as *const u8 as
                        *const libc::c_char, 1459 as libc::c_int);
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((eyeTextures[subType as
                                    usize][(*this).eyeTexIndex as usize] as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(eyeTextures[subType as
                                                          usize][(*this).eyeTexIndex
                                                                     as usize]
                                              as u32_0 &
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = eyeDlists[subType as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_switch.c\x00" as *const u8 as
                         *const libc::c_char, 1471 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_DrawCrystal(mut this: *mut ObjSwitch,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut xluDLists: [*mut Gfx; 5] =
        unsafe {
            [gCrystalSwitchCoreXluDL.as_ptr() as *mut _,
             gCrystalSwitchDiamondXluDL.as_ptr() as *mut _,
             0 as *const Gfx as *mut Gfx, 0 as *const Gfx as *mut Gfx,
             gCrystalSwitchCoreXluDL.as_ptr() as *mut _]
        };
    static mut opaDLists: [*mut Gfx; 5] =
        unsafe {
            [gCrystalSwitchCoreOpaDL.as_ptr() as *mut _,
             gCrystalSwitchDiamondOpaDL.as_ptr() as *mut _,
             0 as *const Gfx as *mut Gfx, 0 as *const Gfx as *mut Gfx,
             gCrystalSwitchCoreOpaDL.as_ptr() as *mut _]
        };
    let mut pad1: s32 = 0;
    ...
    subType =
        (*this).dyna.actor.params as libc::c_int >> 4 as libc::c_int &
            7 as libc::c_int;
    func_8002ED80(&mut (*this).dyna.actor, globalCtx, 0 as libc::c_int);
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_switch.c\x00" as *const u8 as
                        *const libc::c_char, 1494 as libc::c_int);
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = xluDLists[subType as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_switch.c\x00" as *const u8 as
                         *const libc::c_char, 1502 as libc::c_int);
    ...
    Graph_OpenDisps(dispRefs_0.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_switch.c\x00" as *const u8 as
                        *const libc::c_char, 1507 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    ...
    if subType == OBJSWITCH_SUBTYPE_CRYSTAL_1 as libc::c_int {
        ...
        (*_g_2).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gSegments[(((*this).crystalSubtype1texture as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add((*this).crystalSubtype1texture
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
    ...
    let fresh7 = (*__gfxCtx_0).polyOpa.p;
    (*__gfxCtx_0).polyOpa.p = (*__gfxCtx_0).polyOpa.p.offset(1);
    ...
    (*_g_3).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_3).words.w1 =
        ((*this).crystalColor.r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*this).crystalColor.g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*this).crystalColor.b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (128 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh8 = (*__gfxCtx_0).polyOpa.p;
    (*__gfxCtx_0).polyOpa.p = (*__gfxCtx_0).polyOpa.p.offset(1);
    ...
    (*_g_4).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (*this).x1TexScroll as u32_0,
                         (*this).y1TexScroll as u32_0, 0x20 as libc::c_int,
                         0x20 as libc::c_int, 1 as libc::c_int,
                         (*this).x2TexScroll as u32_0,
                         (*this).y2TexScroll as u32_0, 0x20 as libc::c_int,
                         0x20 as libc::c_int) as libc::c_uint;
    let fresh9 = (*__gfxCtx_0).polyOpa.p;
    (*__gfxCtx_0).polyOpa.p = (*__gfxCtx_0).polyOpa.p.offset(1);
    ...
    (*_g_5).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 = opaDLists[subType as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs_0.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_switch.c\x00" as *const u8 as
                         *const libc::c_char, 1533 as libc::c_int);
}
static mut sDrawFuncs: [ObjSwitchActionFunc; 5] =
    unsafe {
        [Some(ObjSwitch_DrawFloor as
                  unsafe extern "C" fn(_: *mut ObjSwitch,
                                       _: *mut GlobalContext) -> ()),
         Some(ObjSwitch_DrawFloorRusty as
                  unsafe extern "C" fn(_: *mut ObjSwitch,
                                       _: *mut GlobalContext) -> ()),
         Some(ObjSwitch_DrawEye as
                  unsafe extern "C" fn(_: *mut ObjSwitch,
                                       _: *mut GlobalContext) -> ()),
         Some(ObjSwitch_DrawCrystal as
                  unsafe extern "C" fn(_: *mut ObjSwitch,
                                       _: *mut GlobalContext) -> ()),
         Some(ObjSwitch_DrawCrystal as
                  unsafe extern "C" fn(_: *mut ObjSwitch,
...
#[no_mangle]
pub unsafe extern "C" fn ObjSwitch_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjSwitch = thisx as *mut ObjSwitch;
    sDrawFuncs[((*this).dyna.actor.params as libc::c_int & 7 as libc::c_int)
                   as
