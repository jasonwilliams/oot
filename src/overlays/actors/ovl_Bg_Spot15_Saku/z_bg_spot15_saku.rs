...
extern "C" {
    ...
    #[no_mangle]
    static mut gLonLonCorralFenceDL: [Gfx; 0];
    #[no_mangle]
    static mut gLonLonCorralFenceCol: CollisionHeader;
}
...
pub type BgSpot15SakuActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut BgSpot15Saku, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot15_Saku_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT15_SAKU as libc::c_int as s16,
                          category:
                              ACTORCAT_ITEMACTION as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT15_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot15Saku>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Saku_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Saku_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Saku_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Saku_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Saku_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSpot15Saku = thisx as *mut BgSpot15Saku;
    let mut pad2: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
    CollisionHeader_GetVirtual(&mut gLonLonCorralFenceCol as
    ...
    (*this).dyna.actor.scale.y = 0.1f32;
    ...
    if gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
           2 as libc::c_int != 0 {
        (*this).dyna.actor.world.pos.z = 2659.0f32
    }
    (*this).actionFunc =
        Some(func_808B4930 as
                 unsafe extern "C" fn(_: *mut BgSpot15Saku,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Saku_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot15Saku = thisx as *mut BgSpot15Saku;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B4930(mut this: *mut BgSpot15Saku,
    ...
    if (*this).unk_168 != 0 &&
        ...
        (*this).actionFunc =
            Some(func_808B4978 as
                     unsafe extern "C" fn(_: *mut BgSpot15Saku,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B4978(mut this: *mut BgSpot15Saku,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              (0x2867 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        (*this).dyna.actor.world.pos.z -= 2.0f32;
        if (*this).dyna.actor.world.pos.z < 2660.0f32 {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x280e as libc::c_int as u16_0);
            (*this).timer = 30 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_808B4A04 as
                         unsafe extern "C" fn(_: *mut BgSpot15Saku,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_808B4A04(mut this: *mut BgSpot15Saku,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).unk_168 = 0 as libc::c_int as u64_0;
        (*this).actionFunc =
            Some(func_808B4930 as
                     unsafe extern "C" fn(_: *mut BgSpot15Saku,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Saku_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot15Saku = thisx as *mut BgSpot15Saku;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Saku_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot15_saku.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gLonLonCorralFenceDL.as_mut_ptr() as libc::c_uint;
