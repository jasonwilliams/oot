...
extern "C" {
    ...
    #[no_mangle]
    static mut gDoorTokiCol: CollisionHeader;
}
...
#[no_mangle]
pub static mut Door_Toki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DOOR_TOKI as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorToki_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorToki_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn DoorToki_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DoorToki = thisx as *mut DoorToki;
    ...
    CollisionHeader_GetVirtual(&mut gDoorTokiCol as *mut CollisionHeader as
...
#[no_mangle]
pub unsafe extern "C" fn DoorToki_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorToki = thisx as *mut DoorToki;
...
#[no_mangle]
pub unsafe extern "C" fn DoorToki_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorToki = thisx as *mut DoorToki;
