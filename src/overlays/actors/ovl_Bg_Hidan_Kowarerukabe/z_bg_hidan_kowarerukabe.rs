...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleLargeBombableWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleCrackedStoneFloorDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleBombableWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleCrackedStoneFloorCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleBombableWallCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleLargeBombableWallCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanKowarerukabe {
...
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_22 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_22 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_22 = -1;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const LARGE_BOMBABLE_WALL: C2RustUnnamed_23 = 2;
pub const BOMBABLE_WALL: C2RustUnnamed_23 = 1;
pub const CRACKED_STONE_FLOOR: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut Bg_Hidan_Kowarerukabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id:
                              ACTOR_BG_HIDAN_KOWARERUKABE as libc::c_int as
                                  s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanKowarerukabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKowarerukabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKowarerukabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKowarerukabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKowarerukabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBreakableWallDLists: [*mut Gfx; 3] =
    unsafe {
        [gFireTempleCrackedStoneFloorDL.as_ptr() as *mut _,
         gFireTempleBombableWallDL.as_ptr() as *mut _,
         gFireTempleLargeBombableWallDL.as_ptr() as *mut _]
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_InitDynaPoly(mut this:
                                                              *mut BgHidanKowarerukabe,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    static mut collisionHeaders: [*mut CollisionHeader; 3] =
        unsafe {
            [&gFireTempleCrackedStoneFloorCol as *const CollisionHeader as
                 *mut CollisionHeader,
             &gFireTempleBombableWallCol as *const CollisionHeader as
                 *mut CollisionHeader,
             &gFireTempleLargeBombableWallCol as *const CollisionHeader as
                 *mut CollisionHeader]
        };
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad2: s32 = 0;
    if !collisionHeaders[((*this).dyna.actor.params as libc::c_int &
                              0xff as libc::c_int) as usize].is_null() {
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        CollisionHeader_GetVirtual(collisionHeaders[((*this).dyna.actor.params
                                                         as libc::c_int &
                                                         0xff as libc::c_int)
                                                        as usize] as
    ...
    } else { (*this).dyna.bgId = -(1 as libc::c_int) };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_InitColliderSphere(mut this:
                                                                    *mut BgHidanKowarerukabe,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    static mut sphereRadii: [s16; 3] =
        [80 as libc::c_int as s16, 45 as libc::c_int as s16,
         80 as libc::c_int as s16];
    static mut sphereYPositions: [s16; 3] =
    ...
    (*(*this).collider.elements.offset(0 as libc::c_int as
        ...
        sphereRadii[((*this).dyna.actor.params as libc::c_int &
                         0xff as libc::c_int) as usize];
    (*(*this).collider.elements.offset(0 as libc::c_int as
                                           isize)).dim.modelSphere.center.y =
        sphereYPositions[((*this).dyna.actor.params as libc::c_int &
                              0xff as libc::c_int) as usize];
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_OffsetActorYPos(mut this:
                                                                 *mut BgHidanKowarerukabe) {
    static mut actorYPosOffsets: [f32_0; 3] = [0.7f32, 0.0f32, 0.0f32];
    (*this).dyna.actor.world.pos.y =
        actorYPosOffsets[((*this).dyna.actor.params as libc::c_int &
                              0xff as libc::c_int) as usize] +
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_Init(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgHidanKowarerukabe =
        thisx as *mut BgHidanKowarerukabe;
    BgHidanKowarerukabe_InitDynaPoly(this, globalCtx);
    if ((*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int) <
           CRACKED_STONE_FLOOR as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int >
               LARGE_BOMBABLE_WALL as libc::c_int {
        // "Error: Fire Temple Breakable Walls. arg_data I can't determine the (%s %d)(arg_data 0x%04x)"
        osSyncPrintf(b"Error : \xe7\x82\x8e\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf \xe5\xa3\x8a\xe3\x82\x8c\xe3\x82\x8b\xe5\xa3\x81 \xe3\x81\xae arg_data \xe3\x81\x8c\xe5\x88\xa4\xe5\x88\xa5\xe5\x87\xba\xe6\x9d\xa5\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_hidan_kowarerukabe.c\x00" as *const u8 as
                         *const libc::c_char, 254 as libc::c_int,
    ...
    osSyncPrintf(b"(hidan \xe7\x88\x86\xe5\xbc\xbe\xe3\x81\xa7\xe5\xa3\x8a\xe3\x82\x8c\xe3\x82\x8b \xe5\xa3\x81 \xe5\xba\x8a)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_Destroy(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut this: *mut BgHidanKowarerukabe =
        thisx as *mut BgHidanKowarerukabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_SpawnDust(mut this:
                                                           *mut BgHidanKowarerukabe,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    pos.x =
        (Rand_ZeroOne() - 0.5f32) * 80.0f32 + (*this).dyna.actor.world.pos.x;
    pos.y = Rand_ZeroOne() * 100.0f32 + (*this).dyna.actor.world.pos.y;
    pos.z =
        (Rand_ZeroOne() - 0.5f32) * 80.0f32 + (*this).dyna.actor.world.pos.z;
    func_80033480(globalCtx, &mut pos, 100.0f32, 4 as libc::c_int,
                  200 as libc::c_int as s16, 250 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_FloorBreak(mut this:
                                                            *mut BgHidanKowarerukabe,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    let mut sin: f32_0 = Math_SinS((*thisx).shape.rot.y);
    let mut cos: f32_0 = Math_CosS((*thisx).shape.rot.y);
    let mut tmp1: f32_0 = 0.;
    let mut tmp2: f32_0 = 0.;
    let mut arg9: s16 = 0;
    pos.y = (*thisx).world.pos.y + 10.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        j = 0 as libc::c_int;
        while j < 5 as libc::c_int {
            tmp1 = (24 as libc::c_int * (i - 2 as libc::c_int)) as f32_0;
            tmp2 = (24 as libc::c_int * (j - 2 as libc::c_int)) as f32_0;
            pos.x = tmp2 * sin + tmp1 * cos + (*thisx).world.pos.x;
            pos.z = tmp2 * cos - tmp1 * sin + (*thisx).world.pos.z;
            tmp1 =
                8.0f32 * Rand_ZeroOne() *
                    (i - 2 as libc::c_int) as libc::c_float;
            tmp2 =
                8.0f32 * Rand_ZeroOne() *
                    (j - 2 as libc::c_int) as libc::c_float;
            velocity.x = tmp2 * sin + tmp1 * cos;
            velocity.y = 30.0f32 * Rand_ZeroOne();
            velocity.z = tmp2 * cos - tmp1 * sin;
            arg9 =
                ((Rand_ZeroOne() - 0.5f32) * 11.0f32 * 1.4f32 + 11.0f32) as
                    s16;
            arg5 =
                if (i == 0 as libc::c_int || i == 4 as libc::c_int) &&
                       (j == 0 as libc::c_int || j == 4 as libc::c_int) {
                    65 as libc::c_int
                } else { 64 as libc::c_int } as s16;
            EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity,
                                 &mut (*thisx).world.pos,
                                 -(550 as libc::c_int) as s16, arg5,
                                 15 as libc::c_int as s16,
                                 15 as libc::c_int as s16,
                                 0 as libc::c_int as s16, arg9,
                                 2 as libc::c_int as s16,
                                 16 as libc::c_int as s16, 100 as libc::c_int,
                                 KAKERA_COLOR_NONE as libc::c_int as s16,
                                 OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int
                                     as s16, gBrownFragmentDL.as_mut_ptr());
            j += 1
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8088A67C(mut this: *mut BgHidanKowarerukabe,
    ...
    while i < 5 as libc::c_int {
        pos.y =
            (20 as libc::c_int * i) as libc::c_float + (*thisx).world.pos.y;
        j = 0 as libc::c_int;
        while j < 5 as libc::c_int {
            tmp1 = (16 as libc::c_int * (j - 2 as libc::c_int)) as f32_0;
            pos.x = tmp1 * cos + (*thisx).world.pos.x;
            pos.z = -(tmp1 * sin) + (*thisx).world.pos.z;
            tmp1 =
                3.0f32 * Rand_ZeroOne() *
                    (j - 2 as libc::c_int) as libc::c_float;
            tmp2 = 6.0f32 * Rand_ZeroOne();
            velocity.x = tmp2 * sin + tmp1 * cos;
            velocity.y = 18.0f32 * Rand_ZeroOne();
            velocity.z = tmp2 * cos - tmp1 * sin;
            arg9 =
                ((Rand_ZeroOne() - 0.5f32) * 11.0f32 * 1.4f32 + 11.0f32) as
                    s16;
            arg5 =
                if arg9 as libc::c_int >= 15 as libc::c_int {
                    32 as libc::c_int
                } else { 64 as libc::c_int } as s16;
            if Rand_ZeroOne() < 5.0f32 {
                arg5 = (arg5 as libc::c_int | 1 as libc::c_int) as s16
            }
            EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity,
                                 &mut (*thisx).world.pos,
                                 -(540 as libc::c_int) as s16, arg5,
                                 20 as libc::c_int as s16,
                                 20 as libc::c_int as s16,
                                 0 as libc::c_int as s16, arg9,
                                 2 as libc::c_int as s16,
                                 32 as libc::c_int as s16, 100 as libc::c_int,
                                 KAKERA_COLOR_NONE as libc::c_int as s16,
                                 OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int
                                     as s16, gBrownFragmentDL.as_mut_ptr());
            j += 1
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_LargeWallBreak(mut this:
                                                                *mut BgHidanKowarerukabe,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    while i < 5 as libc::c_int {
        pos.y =
            (24 as libc::c_int * i) as libc::c_float + (*thisx).world.pos.y;
        j = 0 as libc::c_int;
        while j < 5 as libc::c_int {
            tmp1 = (28 as libc::c_int * (j - 2 as libc::c_int)) as f32_0;
            pos.x = tmp1 * cos + (*thisx).world.pos.x;
            pos.z = -(tmp1 * sin) + (*thisx).world.pos.z;
            tmp1 =
                6.0f32 * Rand_ZeroOne() *
            ...
            tmp2 = 6.0f32 * Rand_ZeroOne();
            velocity.x = tmp2 * sin + tmp1 * cos;
            velocity.y = 34.0f32 * Rand_ZeroOne();
            velocity.z = tmp2 * cos - tmp1 * sin;
            arg9 =
                ((Rand_ZeroOne() - 0.5f32) * 14.0f32 * 1.6f32 + 14.0f32) as
                    s16;
            arg5 =
                if arg9 as libc::c_int > 20 as libc::c_int {
                    32 as libc::c_int
                } else { 64 as libc::c_int } as s16;
            if Rand_ZeroOne() < 5.0f32 {
                arg5 = (arg5 as libc::c_int | 1 as libc::c_int) as s16
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_Break(mut this:
                                                       *mut BgHidanKowarerukabe,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        0 => { BgHidanKowarerukabe_FloorBreak(this, globalCtx); }
        1 => { func_8088A67C(this, globalCtx); }
        2 => { BgHidanKowarerukabe_LargeWallBreak(this, globalCtx); }
        _ => { }
    }
    BgHidanKowarerukabe_SpawnDust(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_Update(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut BgHidanKowarerukabe =
        thisx as *mut BgHidanKowarerukabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKowarerukabe_Draw(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgHidanKowarerukabe =
        thisx as *mut BgHidanKowarerukabe;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        sBreakableWallDLists[((*this).dyna.actor.params as libc::c_int &
