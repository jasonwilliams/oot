...
#[no_mangle]
pub static mut sChildSariaMsgs: [ElfMessage; 13] =
    [{
         let mut init =
             ElfMessage{byte0:
                        ...
                        byte1:
                            ((2 as libc::c_int as u32_0 &
                                 ...
                                 (0 as libc::c_int as u32_0 &
                                     ...
                                     << 0 as libc::c_int) as u8_0,
                        byte2:
                            ((0x67 as libc::c_int as u32_0 &
                                  (((0x1 as libc::c_int) << 8 as libc::c_int)
                                       - 1 as libc::c_int) as libc::c_uint) <<
                                 0 as libc::c_int) as u8_0,
                        byte3:
                            ((ITEM_SONG_STORMS as libc::c_int as u32_0 &
                                  (((0x1 as libc::c_int) << 8 as libc::c_int)
                                       - 1 as libc::c_int) as libc::c_uint) <<
                                 0 as libc::c_int) as u8_0,};
         init
...
#[no_mangle]
pub static mut sAdultSariaMsgs: [ElfMessage; 6] =
    [{
         let mut init =
             ElfMessage{byte0:
                            ((0 as libc::c_int as u32_0 &
...
#[no_mangle]
pub unsafe extern "C" fn ElfMessage_CheckCondition(mut msg: *mut ElfMessage)
 -> u32_0 {
    let mut type_0: s32 = (*msg).byte0 as libc::c_int & 0x1e as libc::c_int;
    let mut flag: u16_0 = 0;
    match type_0 {
        0 => {
            flag =
                ((1 as libc::c_int) <<
                     ((*msg).byte1 as libc::c_int & 0xf as libc::c_int)) as
                    u16_0;
            return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                         1 as libc::c_int) as libc::c_int ==
                        (flag as libc::c_int &
                             gSaveContext.eventChkInf[(((*msg).byte1 as
                                                            libc::c_int &
                                                            0xf0 as
                                                                libc::c_int)
                                                           >>
                            ...
                            libc::c_int) as libc::c_int as u32_0
        }
        2 => {
            return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                         1 as libc::c_int) as libc::c_int ==
                        (gSaveContext.inventory.dungeonItems[gSaveContext.mapIndex
                                                                 as usize] as
                             libc::c_uint &
                             gBitFlags[((*msg).byte1 as libc::c_int -
                                            ITEM_KEY_BOSS as libc::c_int) as
                                           usize] !=
        ...
        4 => {
            return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                         1 as libc::c_int) as libc::c_int ==
                        ((*msg).byte3 as libc::c_int ==
                             gSaveContext.inventory.items[gItemSlots[(*msg).byte1
                                                                         as
                                                                         usize]
                                                              as usize] as
                                 libc::c_int) as libc::c_int) as libc::c_int
                       as u32_0
        }
        6 => {
            match (*msg).byte1 as libc::c_int & 0xf0 as libc::c_int {
                0 => {
                    return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                                 1 as libc::c_int) as libc::c_int ==
                                ((*msg).byte1 as libc::c_int &
                                     0xf as libc::c_int ==
                                     (gSaveContext.inventory.upgrades &
                                          gUpgradeMasks[UPG_STRENGTH as
                                                            libc::c_int as
                                                            usize]) as s32 >>
                                         gUpgradeShifts[UPG_STRENGTH as
                                                            libc::c_int as
                                                            usize] as
                                             libc::c_int) as libc::c_int) as
                               libc::c_int as u32_0
                }
                16 => {
                    return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                                 1 as libc::c_int) as libc::c_int ==
                                (gBitFlags[((*msg).byte3 as libc::c_int -
                                                ITEM_BOOTS_KOKIRI as
                                                    libc::c_int) as usize] <<
                                     gEquipShifts[EQUIP_BOOTS as libc::c_int
                ...
                48 => {
                    return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                                 1 as libc::c_int) as libc::c_int ==
                                (gBitFlags[((*msg).byte3 as libc::c_int -
                                                ITEM_MEDALLION_FOREST as
                                                    libc::c_int +
                                                QUEST_MEDALLION_FOREST as
                                                    libc::c_int) as usize] &
                                     gSaveContext.inventory.questItems !=
                                     0 as libc::c_int as libc::c_uint) as
                                    libc::c_int) as libc::c_int as u32_0
                ...
                64 => {
                    return (((*msg).byte0 as libc::c_int & 1 as libc::c_int ==
                                 1 as libc::c_int) as libc::c_int ==
                                (gSaveContext.magicAcquired as libc::c_int !=
    ...
    LogUtils_LogThreadId(b"../z_elf_message.c\x00" as *const u8 as
                             *const libc::c_char, 156 as libc::c_int);
    osSyncPrintf(b"\"\xe4\xbc\x81\xe7\x94\xbb\xe5\xa4\x96 \xe6\x9d\xa1\xe4\xbb\xb6\" = %s\n\x00"
                     as *const u8 as *const libc::c_char,
                 b"\xe4\xbc\x81\xe7\x94\xbb\xe5\xa4\x96 \xe6\x9d\xa1\xe4\xbb\xb6\x00"
                     as *const u8 as *const libc::c_char);
    if 0 as libc::c_int != 0 {
    } else {
        __assert(b"0\x00" as *const u8 as *const libc::c_char,
                 b"../z_elf_message.c\x00" as *const u8 as
                     *const libc::c_char, 157 as libc::c_int);
    };
    return 0 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_8006BE88(mut msgp: *mut *mut ElfMessage)
 -> u32_0 {
    let mut temp: u32_0 = 1 as libc::c_int as u32_0;
    while (**msgp).byte0 as libc::c_int & 0xe0 as libc::c_int ==
              (1 as libc::c_int) << 5 as libc::c_int {
        if ElfMessage_CheckCondition(*msgp) == 0 {
            temp = 0 as libc::c_int as u32_0
        }
        *msgp = (*msgp).offset(1 as libc::c_int as isize)
    }
    if temp != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_8006BF1C(mut msgp: *mut *mut ElfMessage)
 -> u32_0 {
    let mut msg: *mut ElfMessage = *msgp;
    let mut sp44: [u32_0; 10] = [0; 10];
    let mut temp1: s32 = 0 as libc::c_int;
    let mut temp2: s32 = 0 as libc::c_int;
    let mut temp3: s32 = 0;
    loop  {
        sp44[temp2 as usize] = ElfMessage_CheckCondition(msg);
        temp1 =
            (temp1 as libc::c_uint).wrapping_add(sp44[temp2 as usize]) as s32
                as s32;
        temp2 += 1;
        msg = msg.offset(1);
        if !((*msg).byte0 as libc::c_int & 0xe0 as libc::c_int ==
                 (2 as libc::c_int) << 5 as libc::c_int) {
            break ;
        }
    }
    if temp1 == 0 as libc::c_int { return 0 as libc::c_int as u32_0 }
    temp3 = Rand_ZeroFloat(temp1 as f32_0) as s32;
    temp1 = 0 as libc::c_int;
    while temp1 < temp2 {
        if sp44[temp1 as usize] != 0 {
            if temp3 > 0 as libc::c_int {
                temp3 -= 1
            } else { return 1 as libc::c_int as u32_0 }
        }
        *msgp = (*msgp).offset(1 as libc::c_int as isize);
        temp1 += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn ElfMessage_GetTextFromMsgs(mut msg: *mut ElfMessage)
 -> u16_0 {
    loop  {
        match (*msg).byte0 as libc::c_int & 0xe0 as libc::c_int {
            0 => {
                if ElfMessage_CheckCondition(msg) != 0 {
                    return ((*msg).byte2 as libc::c_int |
                                0x100 as libc::c_int) as u16_0
                }
            }
            32 => {
                if func_8006BE88(&mut msg) != 0 {
                    return ((*msg).byte2 as libc::c_int |
                                0x100 as libc::c_int) as u16_0
                }
            }
            64 => {
                if func_8006BF1C(&mut msg) != 0 {
                    return ((*msg).byte2 as libc::c_int |
                                0x100 as libc::c_int) as u16_0
                }
            }
            96 => {
                if ElfMessage_CheckCondition(msg) != 0 {
                    msg = msg.offset((*msg).byte2 as libc::c_int as isize);
                    msg = msg.offset(-1)
                }
            }
            224 => {
                return ((*msg).byte2 as libc::c_int | 0x100 as libc::c_int) as
                           u16_0
            }
            _ => {
                LogUtils_LogThreadId(b"../z_elf_message.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ElfMessage_GetSariaText(mut globalCtx:
                                                     *mut GlobalContext)
 -> u16_0 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut msgs: *mut ElfMessage = 0 as *mut ElfMessage;
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        if Actor_FindNearby(globalCtx, &mut (*player).actor,
                            ACTOR_EN_SA as libc::c_int as s16,
                            4 as libc::c_int as u8_0, 800.0f32).is_null() {
            msgs = sChildSariaMsgs.as_mut_ptr()
        } else {
            return 0x160 as libc::c_int as u16_0
            // Special text about Saria preferring to talk to you face-to-face
        }
    } else { msgs = sAdultSariaMsgs.as_mut_ptr() }
    return ElfMessage_GetTextFromMsgs(msgs);
}
#[no_mangle]
pub unsafe extern "C" fn ElfMessage_GetCUpText(mut globalCtx:
                                                   *mut GlobalContext)
 -> u16_0 {
    if (*globalCtx).cUpElfMsgs.is_null() {
        return 0 as libc::c_int as u16_0
    } else { return ElfMessage_GetTextFromMsgs((*globalCtx).cUpElfMsgs) };
}
