...
pub struct EnWeiyer {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnWeiyerActionFunc,
    pub unk_194: s16,
    pub unk_196: s16,
...
pub type EnWeiyerActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Weiyer_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WEIYER as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWeiyer_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWeiyer_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWeiyer_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWeiyer = thisx as *mut EnWeiyer;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*this).actor.shape, 1000.0f32,
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    (*this).actionFunc =
        Some(func_80B32804 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWeiyer_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWeiyer = thisx as *mut EnWeiyer;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32384(mut this: *mut EnWeiyer) {
    (*this).unk_196 = (*this).actor.shape.rot.y;
    (*this).unk_27C =
        cosf(-3.14159265358979323846f32 / 8 as libc::c_int as libc::c_float) *
            3.0f32 + (*this).actor.world.pos.y;
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gStingerHitAnim,
                          -5.0f32);
    (*this).unk_194 = 30 as libc::c_int as s16;
    (*this).actor.speedXZ =
        if (*this).actor.speedXZ > 2.5f32 {
            2.5f32
    ...
    (*this).actionFunc =
        Some(func_80B328E8 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32434(mut this: *mut EnWeiyer) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gStingerHitAnim,
                          -5.0f32);
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).unk_194 = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 5.0f32;
    (*this).actionFunc =
        Some(func_80B32C2C as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32494(mut this: *mut EnWeiyer) {
    Animation_Change(&mut (*this).skelAnime, &mut gStingerPopOutAnim, 2.0f32,
                     0.0f32, 0.0f32, ANIMMODE_LOOP as libc::c_int as u8_0,
                     -8.0f32);
    (*this).unk_194 = 40 as libc::c_int as s16;
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(func_80B32D30 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32508(mut this: *mut EnWeiyer) {
    (*this).unk_194 = 200 as libc::c_int as s16;
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).skelAnime.playSpeed = 3.0f32;
    (*this).actionFunc =
        Some(func_80B32E34 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32538(mut this: *mut EnWeiyer) {
    (*this).unk_194 = 200 as libc::c_int as s16;
    (*this).unk_196 =
    ...
    (*this).actionFunc =
        Some(func_80B33018 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B325A0(mut this: *mut EnWeiyer) {
    ...
    (*this).actionFunc =
        Some(func_80B331CC as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32660(mut this: *mut EnWeiyer) {
    Animation_Change(&mut (*this).skelAnime, &mut gStingerPopOutAnim, 2.0f32,
                     0.0f32, 0.0f32, ANIMMODE_LOOP as libc::c_int as u8_0,
                     -8.0f32);
    (*this).unk_194 = 80 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.gravity = -1.0f32;
    (*this).collider.dim.height =
        (sCylinderInit.dim.height as libc::c_int + 15 as libc::c_int) as s16;
    ...
    (*this).actionFunc =
        Some(func_80B333B8 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32724(mut this: *mut EnWeiyer) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gStingerHitAnim,
                          -5.0f32);
    (*this).unk_194 = 20 as libc::c_int as s16;
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
                         0xc8 as libc::c_int as s16, 0 as libc::c_int as s16,
                         0x28 as libc::c_int as s16);
    (*this).collider.base.atFlags =
    ...
    (*this).actor.speedXZ = 3.0f32;
    (*this).actionFunc =
        Some(func_80B332B4 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B327B0(mut this: *mut EnWeiyer) {
    ...
    (*this).actor.velocity.y = 0.0f32;
    (*this).actionFunc =
        Some(func_80B33338 as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B327D8(mut this: *mut EnWeiyer) {
    (*this).actor.shape.rot.x = -(0x2000 as libc::c_int) as s16;
    (*this).unk_194 = -(1 as libc::c_int) as s16;
    (*this).actor.speedXZ = 5.0f32;
    (*this).actionFunc =
        Some(func_80B3349C as
                 unsafe extern "C" fn(_: *mut EnWeiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32804(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if WaterBox_GetSurfaceImpl(globalCtx, &mut (*globalCtx).colCtx,
                               ...
                               &mut (*this).actor.home.pos.y, &mut waterBox)
           == 0 ||
           (*this).actor.home.pos.y - 5.0f32 <= (*this).actor.floorHeight {
        Actor_Kill(&mut (*this).actor);
    } else {
        (*this).actor.home.pos.y -= 5.0f32;
        (*this).actor.world.pos.y =
            ((*this).actor.home.pos.y + (*this).actor.floorHeight) / 2.0f32;
        func_80B32384(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B328E8(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp34: s32 = 0;
    let mut curFrame: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x800 as libc::c_int as s16);
    sp34 = Animation_OnFrame(&mut (*this).skelAnime, 0.0f32);
    curFrame = (*this).skelAnime.curFrame;
    Math_StepToF(&mut (*this).unk_27C, (*this).unk_280, 0.5f32);
    (*this).actor.world.pos.y =
        (*this).unk_27C -
            cosf((curFrame - 5.0f32) *
                     (3.14159265358979323846f32 /
                          40 as libc::c_int as libc::c_float)) * 3.0f32;
    if curFrame <= 45.0f32 {
        Math_StepToF(&mut (*this).actor.speedXZ, 1.0f32, 0.03f32);
    } else { Math_StepToF(&mut (*this).actor.speedXZ, 1.3f32, 0.03f32); }
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        (*this).unk_196 = (*this).actor.wallYaw;
        (*this).unk_194 = 30 as libc::c_int as s16
    }
    if Math_ScaledStepToS(&mut (*this).actor.shape.rot.y, (*this).unk_196,
                          182 as libc::c_int as s16) != 0 {
        ...
        if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
            ...
            (*this).unk_194 = 30 as libc::c_int as s16;
            if Rand_ZeroOne() < 0.3333f32 {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x39a3 as libc::c_int as u16_0);
            }
        }
    }
    if (*this).actor.home.pos.y < (*this).actor.world.pos.y {
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            (*this).unk_280 =
                (*this).actor.home.pos.y -
                    Rand_ZeroOne() *
                        (((*this).actor.home.pos.y -
                              (*this).actor.floorHeight) / 2.0f32)
        } else if sp34 != 0 && Rand_ZeroOne() < 0.1f32 {
            (*this).unk_280 =
                Rand_ZeroOne() *
                    ((*this).actor.home.pos.y - (*this).actor.floorHeight) +
                    (*this).actor.floorHeight
        ...
        if (*this).actor.xzDistToPlayer < 400.0f32 &&
               fabsf((*this).actor.yDistToPlayer) < 250.0f32 &&
               (*player).actor.world.pos.y <
                   (*this).actor.home.pos.y + 20.0f32 {
            func_80B32508(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32C2C(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
        if Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
            ...
            (*this).actor.shape.rot.z =
                ((*this).actor.shape.rot.x as libc::c_int * 2 as libc::c_int)
                    as s16
        }
    } else {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B32D30(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B32DEC(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext)
 -> s16 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    vec.y = (*player).actor.world.pos.y + 20.0f32;
    vec.z = (*player).actor.world.pos.z;
    return Actor_WorldPitchTowardPoint(&mut (*this).actor, &mut vec);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B32E34(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).unk_194 as libc::c_int == 0 as libc::c_int ||
           (*this).actor.home.pos.y + 20.0f32 <= (*player).actor.world.pos.y
           ||
           (*this).collider.base.atFlags as libc::c_int &
        ...
        if Actor_IsFacingPlayer(&mut (*this).actor,
            ...
            Math_StepToF(&mut (*this).actor.speedXZ, 4.0f32, 0.2f32);
        } else { Math_StepToF(&mut (*this).actor.speedXZ, 1.3f32, 0.2f32); }
        if (*this).actor.home.pos.y < (*this).actor.world.pos.y {
            if (*this).actor.home.pos.y < (*this).actor.floorHeight {
        ...
        if (*player).actor.yDistToWater < 50.0f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80B33018(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    let mut curFrame: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x800 as libc::c_int as s16);
    curFrame = (*this).skelAnime.curFrame;
    Math_StepToF(&mut (*this).unk_27C,
                 ((*this).actor.home.pos.y - (*this).actor.floorHeight) /
                     4.0f32 + (*this).actor.floorHeight, 1.0f32);
    (*this).actor.world.pos.y =
        (*this).unk_27C -
            cosf((curFrame - 5.0f32) *
                     (3.14159265358979323846f32 /
    ...
    if Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, (*this).unk_196,
                          2 as libc::c_int as s16,
                          0x200 as libc::c_int as s16,
                          0x80 as libc::c_int as s16) as libc::c_int ==
           0 as libc::c_int {
        (*this).unk_196 =
            ((*this).actor.yawTowardsPlayer as libc::c_int +
                 0x8000 as libc::c_int) as s16
    ...
    if (*this).actor.home.pos.y < (*this).actor.world.pos.y {
        if (*this).actor.home.pos.y < (*this).actor.floorHeight {
            func_80B32434(this);
        } else { (*this).actor.world.pos.y = (*this).actor.home.pos.y }
    }
    if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
        func_80B32384(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80B331CC(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
        (*this).unk_194 -= 1
    ...
    Math_ScaledStepToS(&mut (*this).actor.world.rot.y, (*this).unk_196,
                       0x38e as libc::c_int as s16);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x200 as libc::c_int as s16);
    (*this).actor.shape.rot.z =
        (sinf((*this).unk_194 as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
...
#[no_mangle]
pub unsafe extern "C" fn func_80B332B4(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       -(0x4000 as libc::c_int) as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B33338(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B333B8(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
        (*this).unk_194 -= 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B3349C(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    SkelAnime_Update(&mut (*this).skelAnime);
    phi_a0 =
        ((*this).actor.home.pos.y + 20.0f32 <= (*player).actor.world.pos.y) as
            libc::c_int;
    if (*this).unk_194 as libc::c_int == -(1 as libc::c_int) {
        if phi_a0 != 0 ||
            ...
            (*this).unk_194 = 10 as libc::c_int as s16;
            EffectSsGSplash_Spawn(globalCtx, &mut (*this).actor.world.pos,
                                  0 as *mut Color_RGBA8,
                                  0 as *mut Color_RGBA8,
                                  1 as libc::c_int as s16,
        ...
        if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
            phi_a1 = 0x1800 as libc::c_int as s16
        } else {
            phi_a1 = func_80B32DEC(this, globalCtx);
            phi_a1 =
                if (phi_a1 as libc::c_int) < 0 as libc::c_int {
                    0 as libc::c_int
                } else { phi_a1 as libc::c_int } as s16
        }
        if ((*this).actor.shape.rot.x as libc::c_int) < phi_a1 as libc::c_int
           {
            Math_ScaledStepToS(&mut (*this).actor.shape.rot.x, phi_a1,
                               0x400 as libc::c_int as s16);
        }
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            func_80B32434(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B3368C(mut this: *mut EnWeiyer,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                ...
                if (*this).actionFunc !=
                       Some(func_80B333B8 as
                                unsafe extern "C" fn(_: *mut EnWeiyer,
                                                     _: *mut GlobalContext)
                                    -> ()) {
                    func_80B32660(this);
                }
                ...
                func_80B32724(this);
            } else { func_80B325A0(this); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWeiyer_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWeiyer = thisx as *mut EnWeiyer;
    let mut pad: s32 = 0;
    (*this).actor.home.pos.y =
        (*this).actor.yDistToWater + (*this).actor.world.pos.y - 5.0f32;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32, 30.0f32,
                            45.0f32, 7 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnWeiyer_OverrideLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
                                                   ...
                                                   mut gfx: *mut *mut Gfx)
 -> s32 {
    if limbIndex == 1 as libc::c_int { (*pos).z += 2000.0f32 }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnWeiyer_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWeiyer = thisx as *mut EnWeiyer;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_weiyer.c\x00" as *const u8 as
    ...
    if (*this).actionFunc !=
        ...
        (*__gfxCtx).polyOpa.p =
            SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                           ...
                           Some(EnWeiyer_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_weiyer.c\x00" as *const u8 as
                         *const libc::c_char, 1240 as libc::c_int);
}
