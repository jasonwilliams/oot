...
extern "C" {
    ...
    #[no_mangle]
    static mut gLakeHyliaLowWaterDL: [Gfx; 0];
    #[no_mangle]
    static mut gLakeHyliaHighWaterDL: [Gfx; 0];
    #[no_mangle]
    static mut gLakeHyliaWaterTempleGateDL: [Gfx; 0];
    #[no_mangle]
    static mut gLakeHyliaWaterTempleGateCol: CollisionHeader;
    #[no_mangle]
    static mut gLakeHyliaZoraShortcutIceblockDL: [Gfx; 0];
    #[no_mangle]
    static mut gLakeHyliaZoraShortcutIceblockCol: CollisionHeader;
    #[no_mangle]
    static mut gLakeHyliaWaterTempleKeyDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot06Objects {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot06ObjectsActionFunc,
    pub switchFlag: s16,
    pub timer: s16,
    pub lakeHyliaWaterLevel: f32_0,
    pub collider: ColliderJntSph,
    pub colliderItem: [ColliderJntSphElement; 1],
}
pub type BgSpot06ObjectsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const LHO_ICE_BLOCK: C2RustUnnamed_22 = 3;
pub const LHO_WATER_PLANE: C2RustUnnamed_22 = 2;
pub const LHO_WATER_TEMPLE_ENTRANCE_LOCK: C2RustUnnamed_22 = 1;
pub const LHO_WATER_TEMPLE_ENTRACE_GATE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const LHWB_MAIN_2: C2RustUnnamed_23 = 3;
pub const LHWB_MAIN_1: C2RustUnnamed_23 = 2;
pub const LHWB_GERUDO_VALLEY_RIVER_LOWER: C2RustUnnamed_23 = 1;
pub const LHWB_GERUDO_VALLEY_RIVER_UPPER: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut Bg_Spot06_Objects_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT06_OBJECTS as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 9 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_SPOT06_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot06Objects>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot06Objects_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot06Objects_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot06Objects_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot06Objects_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// Initialized in run_static_initializers
static mut sInitChainWaterPlane: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot06Objects = thisx as *mut BgSpot06Objects;
    let mut pad: s32 = 0;
    ...
    osSyncPrintf(b"spot06 obj nthisx->arg_data=[%d]\x00" as *const u8 as
                     *const libc::c_char, (*thisx).params as libc::c_int);
    match (*thisx).params as libc::c_int {
        0 => {
            ...
            CollisionHeader_GetVirtual(&mut gLakeHyliaWaterTempleGateCol as
            ...
            if gSaveContext.linkAge == 0 as libc::c_int &&
               ...
               {
                (*thisx).world.pos.y = (*thisx).home.pos.y + 120.0f32;
                (*this).actionFunc =
                    Some(BgSpot06Objects_DoNothing as
                             unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
                (*this).actionFunc =
                    Some(BgSpot06Objects_GateWaitForSwitch as
                             unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
            ...
            if gSaveContext.linkAge == 0 as libc::c_int &&
                   Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0
               {
                if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                    ...
                    (*thisx).world.pos.y =
                        (-(1313 as libc::c_int) - 680 as libc::c_int) as
                            f32_0;
                    (*thisx).home.pos.y = (*thisx).world.pos.y
                } else {
                    (*thisx).world.pos.y = -(1313 as libc::c_int) as f32_0;
                    (*thisx).home.pos.y = (*thisx).world.pos.y
                }
                (*this).actionFunc =
                    Some(BgSpot06Objects_LockFloat as
                             unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*thisx).world.pos.z -= 100.0f32;
                (*thisx).home.pos.z = (*thisx).world.pos.z + 16.0f32;
                ...
                (*(*this).collider.elements.offset(0 as libc::c_int as
                    ...
                    = ((*thisx).world.pos.z + 16.0f32) as s16
            } else {
                (*this).actionFunc =
                    Some(BgSpot06Objects_LockWait as
                             unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*(*this).collider.elements.offset(0 as libc::c_int as
        ...
        2 => {
            Actor_ProcessInitChain(thisx, sInitChainWaterPlane.as_mut_ptr());
            (*thisx).flags =
            ...
            if gSaveContext.linkAge == 0 as libc::c_int &&
                ...
                if gSaveContext.sceneSetupIndex < 4 as libc::c_int {
                    (*this).lakeHyliaWaterLevel = -681.0f32;
                    (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_GERUDO_VALLEY_RIVER_LOWER
                                                                             as
                                                                             libc::c_int
                                                                             as
                                                                             isize)).ySurface
                        =
                        (-(1313 as libc::c_int) + 200 as libc::c_int -
                    ...
                    let ref mut fresh0 =
                        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_GERUDO_VALLEY_RIVER_LOWER
                                                                                 ...
                                                                                 isize)).zMin;
                    *fresh0 =
                        (*fresh0 as libc::c_int - 50 as libc::c_int) as s16;
                    (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_MAIN_1
                                                                             as
                                                                             libc::c_int
                                                                             as
                                                                             isize)).ySurface
                        =
                        (-(1313 as libc::c_int) - 680 as libc::c_int) as s16;
                    (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_MAIN_2
                                                                             as
                                                                             libc::c_int
                                                                             as
                                                                             isize)).ySurface
                    ...
                    (*this).lakeHyliaWaterLevel = -681.0f32;
                    (*thisx).world.pos.y = (*this).lakeHyliaWaterLevel;
                    (*thisx).world.pos.y +=
                        -(1313 as libc::c_int) as libc::c_float;
                    (*this).actionFunc =
                        Some(BgSpot06Objects_WaterPlaneCutsceneWait as
                                 unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
            } else {
                (*this).lakeHyliaWaterLevel = 0.0f32;
                (*this).actionFunc =
                    Some(BgSpot06Objects_DoNothing as
                             unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                  _: *mut GlobalContext)
        ...
        3 => {
            Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
            DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
            CollisionHeader_GetVirtual(&mut gLakeHyliaZoraShortcutIceblockCol
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot06Objects = thisx as *mut BgSpot06Objects;
    match (*this).dyna.actor.params as libc::c_int {
        ...
        1 => { Collider_DestroyJntSph(globalCtx, &mut (*this).collider); }
        2 | _ => { }
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_GateSpawnBubbles(mut this:
                                                              *mut BgSpot06Objects,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut sp34: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut tmp: f32_0 = 0.;
    if (*globalCtx).gameplayFrames.wrapping_rem(3 as libc::c_int as
                                                    libc::c_uint) ==
           0 as libc::c_int as libc::c_uint {
        tmp = Rand_CenteredFloat(160.0f32);
        sp34.x =
            Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16) * tmp +
        ...
        EffectSsBubble_Spawn(globalCtx, &mut sp34, 50.0f32, 70.0f32, 10.0f32,
                             Rand_ZeroOne() * 0.05f32 + 0.175f32);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_GateWaitForSwitch(mut this:
                                                               *mut BgSpot06Objects,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    let mut i: s32 = 0;
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        ...
        (*this).dyna.actor.world.pos.y += 3.0f32;
        (*this).actionFunc =
            Some(BgSpot06Objects_GateWaitToOpen as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ());
        i = 0 as libc::c_int;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_GateWaitToOpen(mut this:
                                                            *mut BgSpot06Objects,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgSpot06Objects_GateOpen as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ())
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_GateOpen(mut this:
                                                      *mut BgSpot06Objects,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    BgSpot06Objects_GateSpawnBubbles(this, globalCtx);
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + 120.0f32, 0.6f32) != 0 {
        (*this).actionFunc =
            Some(BgSpot06Objects_DoNothing as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_DoNothing(mut this:
                                                       *mut BgSpot06Objects,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockSpawnWaterRipples(mut this:
                                                                   *mut BgSpot06Objects,
                                                               mut globalCtx:
                                                                   *mut GlobalContext,
                                                               mut flag:
                                                                   s32) {
    if flag != 0 ||
           (*globalCtx).gameplayFrames.wrapping_rem(7 as libc::c_int as
                                                        libc::c_uint) == 0 {
        EffectSsGRipple_Spawn(globalCtx, &mut (*this).dyna.actor.home.pos,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockSpawnBubbles(mut this:
                                                              *mut BgSpot06Objects,
                                                          mut globalCtx:
                                                              *mut GlobalContext,
                                                          mut flag: s32) {
    if (*globalCtx).gameplayFrames.wrapping_rem(7 as libc::c_int as
                                                    libc::c_uint) == 0 ||
           flag != 0 {
        EffectSsBubble_Spawn(globalCtx, &mut (*this).dyna.actor.world.pos,
                             0.0f32, 40.0f32, 30.0f32,
                             Rand_ZeroOne() * 0.05f32 + 0.175f32);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockWait(mut this:
                                                      *mut BgSpot06Objects,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).timer = 130 as libc::c_int as s16;
        ...
        (*this).dyna.actor.world.pos.x += 3.0f32 * sin;
        (*this).dyna.actor.world.pos.z += 3.0f32 * cos;
        i = 0 as libc::c_int;
        while i < 20 as libc::c_int {
            BgSpot06Objects_LockSpawnBubbles(this, globalCtx,
                                             1 as libc::c_int);
            i += 1
        }
        effectPos.x = (*this).dyna.actor.world.pos.x + 5.0f32 * sin;
        effectPos.y = (*this).dyna.actor.world.pos.y;
        effectPos.z = (*this).dyna.actor.world.pos.z + 5.0f32 * cos;
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            EffectSsBubble_Spawn(globalCtx, &mut effectPos, 0.0f32, 20.0f32,
                                 20.0f32, Rand_ZeroOne() * 0.1f32 + 0.7f32);
            i += 1
        }
        EffectSsGSplash_Spawn(globalCtx, &mut (*this).dyna.actor.world.pos,
        ...
        (*this).actionFunc =
            Some(BgSpot06Objects_LockPullOutward as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ());
        ...
        OnePointCutscene_Init(globalCtx, 4120 as libc::c_int as s16,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockPullOutward(mut this:
                                                             *mut BgSpot06Objects,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).dyna.actor.world.pos.x +=
        0.3f32 * Math_SinS((*this).dyna.actor.world.rot.y);
    (*this).dyna.actor.world.pos.z +=
        0.3f32 * Math_CosS((*this).dyna.actor.world.rot.y);
    BgSpot06Objects_LockSpawnBubbles(this, globalCtx, 0 as libc::c_int);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).dyna.actor.velocity.y = 0.5f32;
        (*this).dyna.actor.flags &=
            !((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(BgSpot06Objects_LockSwimToSurface as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ())
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockSwimToSurface(mut this:
                                                               *mut BgSpot06Objects,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    ...
    if (*this).dyna.actor.velocity.y <= 0.0f32 {
        cos = Math_CosS((*this).dyna.actor.shape.rot.x) * 4.3f32;
        (*this).dyna.actor.world.pos.x +=
            cos * Math_SinS((*this).dyna.actor.shape.rot.y);
        (*this).dyna.actor.world.pos.z +=
            cos * Math_CosS((*this).dyna.actor.shape.rot.y);
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.world.pos.y - 1.3f32;
        BgSpot06Objects_LockSpawnWaterRipples(this, globalCtx,
                                              0 as libc::c_int);
        if Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.x,
                              0 as libc::c_int as s16,
                              0x260 as libc::c_int as s16) != 0 as libc::c_int
           {
            (*this).dyna.actor.home.pos.x =
                (*this).dyna.actor.world.pos.x -
                    Math_SinS((*this).dyna.actor.shape.rot.y) * 16.0f32;
            (*this).dyna.actor.home.pos.z =
                (*this).dyna.actor.world.pos.z -
                    Math_CosS((*this).dyna.actor.shape.rot.y) * 16.0f32;
            (*this).dyna.actor.world.pos.y = -1993.0f32;
    ...
    } else if (*this).dyna.actor.world.pos.y >= -1973.0f32 {
        (*this).dyna.actor.velocity.y = 0.0f32;
        BgSpot06Objects_LockSpawnWaterRipples(this, globalCtx,
                                              1 as libc::c_int);
        EffectSsGSplash_Spawn(globalCtx, &mut (*this).dyna.actor.home.pos,
                              0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                              1 as libc::c_int as s16,
                              700 as libc::c_int as s16);
    } else if (*this).dyna.actor.shape.rot.x as libc::c_int ==
                  -(0x4000 as libc::c_int) {
        (*this).dyna.actor.velocity.y += 0.02f32;
        (*this).dyna.actor.world.pos.x =
            Rand_CenteredFloat(1.0f32) + (*this).dyna.actor.home.pos.x;
        (*this).dyna.actor.world.pos.z =
            Rand_CenteredFloat(1.0f32) + (*this).dyna.actor.home.pos.z;
        (*this).dyna.actor.velocity.y =
            if (*this).dyna.actor.velocity.y > 10.0f32 {
                10.0f32
            } else { (*this).dyna.actor.velocity.y };
        BgSpot06Objects_LockSpawnBubbles(this, globalCtx, 0 as libc::c_int);
    } else {
        BgSpot06Objects_LockSpawnBubbles(this, globalCtx, 0 as libc::c_int);
        if Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.x,
                              -(0x4000 as libc::c_int) as s16,
                              0x30 as libc::c_int as s16) != 0 {
            (*this).dyna.actor.home.pos.x = (*this).dyna.actor.world.pos.x;
            (*this).dyna.actor.home.pos.y = -1993.0f32;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_LockFloat(mut this:
                                                       *mut BgSpot06Objects,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    BgSpot06Objects_LockSpawnWaterRipples(this, globalCtx, 0 as libc::c_int);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).dyna.actor.world.pos.y =
        2.0f32 *
            sinf((*this).timer as libc::c_int as libc::c_float *
                     (3.14159265358979323846f32 / 16.0f32)) +
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgSpot06Objects = thisx as *mut BgSpot06Objects;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*thisx).params as libc::c_int ==
           LHO_WATER_TEMPLE_ENTRANCE_LOCK as libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_DrawLakeHyliaWater(mut this:
                                                                *mut BgSpot06Objects,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut gameplayFrames: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot06_objects.c\x00" as *const u8 as
                        *const libc::c_char, 844 as libc::c_int);
    ...
    gameplayFrames = (*globalCtx).state.frames as s32;
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         -gameplayFrames as u32_0, gameplayFrames as u32_0,
                         32 as libc::c_int, 32 as libc::c_int,
                         1 as libc::c_int, gameplayFrames as u32_0,
                         gameplayFrames as u32_0, 32 as libc::c_int,
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         -gameplayFrames as u32_0,
                         (gameplayFrames * 6 as libc::c_int) as u32_0,
                         32 as libc::c_int, 32 as libc::c_int,
                         1 as libc::c_int, gameplayFrames as u32_0,
                         (gameplayFrames * 6 as libc::c_int) as u32_0,
    ...
    (*_g_2).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (128 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).lakeHyliaWaterLevel < -680.0f32 &&
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gLakeHyliaLowWaterDL.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gLakeHyliaHighWaterDL.as_mut_ptr() as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot06Objects = thisx as *mut BgSpot06Objects;
    match (*this).dyna.actor.params as libc::c_int {
        0 => {
            Gfx_DrawDListOpa(globalCtx,
                             gLakeHyliaWaterTempleGateDL.as_mut_ptr());
        }
        1 => {
            Gfx_DrawDListOpa(globalCtx,
                             gLakeHyliaWaterTempleKeyDL.as_mut_ptr());
            if (*this).actionFunc ==
                   Some(BgSpot06Objects_LockSwimToSurface as
                            unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                                 _: *mut GlobalContext) -> ())
               {
                Collider_UpdateSpheres(1 as libc::c_int,
                                       &mut (*this).collider);
            }
        }
        2 => { BgSpot06Objects_DrawLakeHyliaWater(this, globalCtx); }
        3 => {
            Gfx_DrawDListOpa(globalCtx,
                             gLakeHyliaZoraShortcutIceblockDL.as_mut_ptr());
        }
        _ => { }
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_WaterPlaneCutsceneWait(mut this:
                                                                    *mut BgSpot06Objects,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int &
        ...
        (*this).actionFunc =
            Some(BgSpot06Objects_WaterPlaneCutsceneRise as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ())
    };
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot06Objects_WaterPlaneCutsceneRise(mut this:
                                                                    *mut BgSpot06Objects,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    (*this).dyna.actor.world.pos.y =
        (*this).lakeHyliaWaterLevel + -(1313 as libc::c_int) as libc::c_float;
    if (*this).lakeHyliaWaterLevel >= 0.0001f32 {
        (*this).dyna.actor.world.pos.y = -(1313 as libc::c_int) as f32_0;
        (*this).actionFunc =
            Some(BgSpot06Objects_DoNothing as
                     unsafe extern "C" fn(_: *mut BgSpot06Objects,
                                          _: *mut GlobalContext) -> ())
    } else {
        Math_SmoothStepToF(&mut (*this).lakeHyliaWaterLevel, 1.0f32, 0.1f32,
                           1.0f32, 0.001f32);
        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_GERUDO_VALLEY_RIVER_LOWER
                                                                 as
                                                                 libc::c_int
                                                                 ...
                                                                 isize)).ySurface
            =
            (-(1313 as libc::c_int) + 200 as libc::c_int - 80 as libc::c_int)
                as s16;
        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_MAIN_1 as
                                                                 libc::c_int
                                                                 as
                                                                 isize)).ySurface
            = (*this).dyna.actor.world.pos.y as s16;
        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(LHWB_MAIN_2 as
                                                                 libc::c_int
                                                                 as
                                                                 isize)).ySurface
            = (*this).dyna.actor.world.pos.y as s16
    ...
    func_8002F948(&mut (*this).dyna.actor,
                  (0x285e as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
