...
extern "C" {
    ...
    #[no_mangle]
    static mut gKanaamiDL: [Gfx; 0];
    #[no_mangle]
    static mut gKanaamiCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaKanaami {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaKanaamiActionFunc,
    pub unk_168: s16,
    pub unk_16A: s16,
}
pub type BgJyaKanaamiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaKanaami, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Jya_Kanaami_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_KANAAMI as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JYA_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaKanaami>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaKanaami_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaKanaami_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaKanaami_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaKanaami_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaKanaami_InitDynaPoly(mut this:
                                                       *mut BgJyaKanaami,
                                                   mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_kanaami.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaKanaami_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaKanaami = thisx as *mut BgJyaKanaami;
    BgJyaKanaami_InitDynaPoly(this, globalCtx, &mut gKanaamiCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        func_80899A08(this);
    } else { func_80899880(this); }
    osSyncPrintf(b"(jya \xe9\x87\x91\xe7\xb6\xb2)(arg_data 0x%04x)\n\x00" as
                     *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaKanaami_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaKanaami = thisx as *mut BgJyaKanaami;
...
#[no_mangle]
pub unsafe extern "C" fn func_80899880(mut this: *mut BgJyaKanaami) {
    (*this).actionFunc =
        Some(func_80899894 as
                 unsafe extern "C" fn(_: *mut BgJyaKanaami,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_16A = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80899894(mut this: *mut BgJyaKanaami,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
                           0x3f as libc::c_int) != 0 ||
           (*this).unk_16A as libc::c_int > 0 as libc::c_int {
        if (*this).dyna.actor.world.pos.x > -1000.0f32 &&
               (*this).unk_16A as libc::c_int == 0 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 3450 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
        }
        (*this).unk_16A =
            ((*this).unk_16A as libc::c_int + 1 as libc::c_int) as s16;
        if (*this).unk_16A as libc::c_int >= 0xa as libc::c_int {
            func_8089993C(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8089993C(mut this: *mut BgJyaKanaami) {
    (*this).actionFunc =
        Some(func_80899950 as
                 unsafe extern "C" fn(_: *mut BgJyaKanaami,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_168 = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80899950(mut this: *mut BgJyaKanaami,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut quakeId: s32 = 0;
    (*this).unk_168 =
        ((*this).unk_168 as libc::c_int + 0x20 as libc::c_int) as s16;
    if Math_ScaledStepToS(&mut (*this).dyna.actor.world.rot.x,
                          0x4000 as libc::c_int as s16, (*this).unk_168) != 0
       {
        func_80899A08(this);
        ...
        Quake_SetSpeed(quakeId as s16, 25000 as libc::c_int as s16);
        Quake_SetQuakeValues(quakeId as s16, 2 as libc::c_int as s16,
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16);
        Quake_SetCountdown(quakeId as s16, 16 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80899A08(mut this: *mut BgJyaKanaami) {
    (*this).actionFunc = None;
    (*this).dyna.actor.world.rot.x = 0x4000 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaKanaami_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaKanaami = thisx as *mut BgJyaKanaami;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaKanaami_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gKanaamiDL.as_mut_ptr());
}
