...
extern "C" {
    ...
    #[no_mangle]
    static mut object_mori_hineri1_DL_0024E0: [Gfx; 0];
    #[no_mangle]
    static mut object_mori_hineri1_Col_0054B8: CollisionHeader;
    #[no_mangle]
    static mut object_mori_hineri1a_DL_001980: [Gfx; 0];
    #[no_mangle]
    static mut object_mori_hineri1a_Col_003490: CollisionHeader;
    #[no_mangle]
    static mut object_mori_hineri2_DL_0020F0: [Gfx; 0];
    #[no_mangle]
    static mut object_mori_hineri2_Col_0043D0: CollisionHeader;
    #[no_mangle]
    static mut object_mori_hineri2a_DL_002B70: [Gfx; 0];
    #[no_mangle]
    static mut object_mori_hineri2a_Col_006078: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriHineri {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriHineriActionFunc,
    pub moriHineriObjIdx: s8,
    pub moriTexObjIdx: s8,
    pub boxObjIdx: s8,
    pub switchFlag: s8,
}
pub type BgMoriHineriActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriHineri, _: *mut GlobalContext)
               -> ()>;
static mut sNextCamIdx: s16 = -(1 as libc::c_int) as s16;
#[no_mangle]
pub static mut Bg_Mori_Hineri_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_HINERI as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriHineri>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHineri_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHineri_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHineri_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDLists: [*mut Gfx; 4] =
    unsafe {
        [object_mori_hineri1_DL_0024E0.as_ptr() as *mut _,
         object_mori_hineri1a_DL_001980.as_ptr() as *mut _,
         object_mori_hineri2_DL_0020F0.as_ptr() as *mut _,
         object_mori_hineri2a_DL_002B70.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgMoriHineri = thisx as *mut BgMoriHineri;
    let mut moriHineriObjIdx: s8 = 0;
    let mut switchFlagParam: u32_0 = 0;
    let mut t6: s32 = 0;
    ...
    switchFlagParam =
        ((*this).dyna.actor.params as libc::c_int & 0x3f as libc::c_int) as
            u32_0;
    t6 = (*this).dyna.actor.params as libc::c_int & 0x4000 as libc::c_int;
    if t6 != 0 as libc::c_int {
        (*this).switchFlag = switchFlagParam as s8
    } else {
        (*this).switchFlag =
    ...
    (*this).dyna.actor.params =
        (((*this).dyna.actor.params as libc::c_int & 0x8000 as libc::c_int) >>
             0xe as libc::c_int) as s16;
    if Flags_GetSwitch(globalCtx, switchFlagParam as s32) != 0 {
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            (*this).dyna.actor.params = 1 as libc::c_int as s16
        } else if (*this).dyna.actor.params as libc::c_int == 2 as libc::c_int
         {
            (*this).dyna.actor.params = 3 as libc::c_int as s16
        }
    }
    (*this).boxObjIdx = -(1 as libc::c_int) as s8;
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        (*this).moriHineriObjIdx =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_MORI_HINERI1 as libc::c_int as s16) as s8;
        if t6 == 0 as libc::c_int {
            (*this).boxObjIdx =
                Object_GetIndex(&mut (*globalCtx).objectCtx,
                                OBJECT_BOX as libc::c_int as s16) as s8
        }
    } else {
        if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int {
            moriHineriObjIdx =
                Object_GetIndex(&mut (*globalCtx).objectCtx,
                                OBJECT_MORI_HINERI1A as libc::c_int as s16) as
                    s8
        } else {
            moriHineriObjIdx =
                if (*this).dyna.actor.params as libc::c_int ==
                       2 as libc::c_int {
                    Object_GetIndex(&mut (*globalCtx).objectCtx,
                                    OBJECT_MORI_HINERI2 as libc::c_int as s16)
                } else {
                    Object_GetIndex(&mut (*globalCtx).objectCtx,
                                    OBJECT_MORI_HINERI2A as libc::c_int as
                                        s16)
                } as s8
        }
    ...
    (*this).moriTexObjIdx =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_MORI_TEX as libc::c_int as s16) as s8;
    if t6 != 0 as libc::c_int {
        (*this).dyna.actor.params =
            ((*this).dyna.actor.params as libc::c_int + 4 as libc::c_int) as
                s16
    }
    if ((*this).moriHineriObjIdx as libc::c_int) < 0 as libc::c_int ||
           ((*this).moriTexObjIdx as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
    } else {
        (*this).actionFunc =
            Some(func_808A39FC as
                     unsafe extern "C" fn(_: *mut BgMoriHineri,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgMoriHineri = thisx as *mut BgMoriHineri;
...
#[no_mangle]
pub unsafe extern "C" fn func_808A39FC(mut this: *mut BgMoriHineri,
    ...
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).moriHineriObjIdx as s32) != 0 &&
           Object_IsLoaded(&mut (*globalCtx).objectCtx,
                           (*this).moriTexObjIdx as s32) != 0 &&
           (((*this).boxObjIdx as libc::c_int) < 0 as libc::c_int ||
                Object_IsLoaded(&mut (*globalCtx).objectCtx,
                                (*this).boxObjIdx as s32) != 0) {
        ...
        if (*this).dyna.actor.params as libc::c_int >= 4 as libc::c_int {
            ...
            if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
                (*this).moriHineriObjIdx =
                    Object_GetIndex(&mut (*globalCtx).objectCtx,
                                    OBJECT_MORI_HINERI1A as libc::c_int as
                                        s16) as s8
            } else if (*this).dyna.actor.params as libc::c_int ==
                          1 as libc::c_int {
                (*this).moriHineriObjIdx =
                    Object_GetIndex(&mut (*globalCtx).objectCtx,
                                    OBJECT_MORI_HINERI1 as libc::c_int as s16)
                        as s8
            } else {
                (*this).moriHineriObjIdx =
                    if (*this).dyna.actor.params as libc::c_int ==
                        ...
                        Object_GetIndex(&mut (*globalCtx).objectCtx,
                                        OBJECT_MORI_HINERI2 as libc::c_int as
                                            s16)
                    } as s8
            }
            if ((*this).moriHineriObjIdx as libc::c_int) < 0 as libc::c_int {
            ...
            (*this).dyna.actor.draw =
                Some(BgMoriHineri_DrawHallAndRoom as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
                (*this).actionFunc =
                    Some(func_808A3C8C as
                             unsafe extern "C" fn(_: *mut BgMoriHineri,
                                                  _: *mut GlobalContext)
                                 -> ());
                CollisionHeader_GetVirtual(&mut object_mori_hineri1_Col_0054B8
                          ...
                          1 as libc::c_int {
                (*this).actionFunc =
                    Some(BgMoriHineri_SpawnBossKeyChest as
                             unsafe extern "C" fn(_: *mut BgMoriHineri,
                                                  _: *mut GlobalContext)
                                 -> ());
                CollisionHeader_GetVirtual(&mut object_mori_hineri1a_Col_003490
                                               as *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
            } else if (*this).dyna.actor.params as libc::c_int ==
                          2 as libc::c_int {
                (*this).actionFunc =
                    Some(BgMoriHineri_DoNothing as
                             unsafe extern "C" fn(_: *mut BgMoriHineri,
                                                  _: *mut GlobalContext)
                                 -> ());
                CollisionHeader_GetVirtual(&mut object_mori_hineri2_Col_0043D0
                                               as *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
            } else {
                (*this).actionFunc =
                    Some(func_808A3C8C as
                             unsafe extern "C" fn(_: *mut BgMoriHineri,
                                                  _: *mut GlobalContext)
                                 -> ());
                CollisionHeader_GetVirtual(&mut object_mori_hineri2a_Col_006078
                                               as *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
            }
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_DoNothing(mut this: *mut BgMoriHineri,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_SpawnBossKeyChest(mut this:
                                                            *mut BgMoriHineri,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_EN_BOX as libc::c_int as s16,
                (*this).dyna.actor.world.pos.x + 147.0f32,
                (*this).dyna.actor.world.pos.y + -245.0f32,
                (*this).dyna.actor.world.pos.z + -453.0f32,
                0 as libc::c_int as s16, 0x4000 as libc::c_int as s16,
                0 as libc::c_int as s16, 0x27ee as libc::c_int as s16);
    (*this).actionFunc =
        Some(BgMoriHineri_DoNothing as
                 unsafe extern "C" fn(_: *mut BgMoriHineri,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_808A3C8C(mut this: *mut BgMoriHineri,
                                       mut globalCtx: *mut GlobalContext) {
    let mut f0: f32_0 = 0.;
    ...
    (*this).dyna.actor.shape.rot.z =
        ((if f0 < 0.0f32 {
              0.0f32
          } else { (if f0 > 1000.0f32 { 1000.0f32 } else { f0 }) }) *
             16.384f32) as s16;
    Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as usize],
                         CAM_SET_DUNGEON1 as libc::c_int as s16);
    if (*this).dyna.actor.params as libc::c_int != 0 as libc::c_int {
        (*this).dyna.actor.shape.rot.z =
            -((*this).dyna.actor.shape.rot.z as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808A3D58(mut this: *mut BgMoriHineri,
                                       mut globalCtx: *mut GlobalContext) {
    let mut mainCamChildIdx: s16 = 0;
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 &&
           ((*this).dyna.actor.params as libc::c_int == 0 as libc::c_int ||
                (*this).dyna.actor.params as libc::c_int == 2 as libc::c_int)
           ||
           Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) == 0 &&
               ((*this).dyna.actor.params as libc::c_int == 1 as libc::c_int
                    ||
        ...
        (*this).dyna.actor.draw =
            Some(BgMoriHineri_DrawHallAndRoom as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFunc =
            Some(func_808A3E54 as
                     unsafe extern "C" fn(_: *mut BgMoriHineri,
                                          _: *mut GlobalContext) -> ());
        mainCamChildIdx =
            (*(*globalCtx).cameraPtrs[0 as libc::c_int as usize]).childCamIdx;
        if mainCamChildIdx as libc::c_int != 0 as libc::c_int &&
               (*(*globalCtx).cameraPtrs[mainCamChildIdx as usize]).setting as
                   libc::c_int == CAM_SET_CS_TWISTED_HALLWAY as libc::c_int {
            OnePointCutscene_EndCutscene(globalCtx, mainCamChildIdx);
        }
        OnePointCutscene_Init(globalCtx, 3260 as libc::c_int as s16,
                              40 as libc::c_int as s16,
                              &mut (*this).dyna.actor,
                              0 as libc::c_int as s16);
        sNextCamIdx =
            OnePointCutscene_Init(globalCtx, 3261 as libc::c_int as s16,
                                  40 as libc::c_int as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16)
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_808A3E54(mut this: *mut BgMoriHineri,
                                       mut globalCtx: *mut GlobalContext) {
    let mut objBankIndex: s8 = 0;
    if (*globalCtx).activeCamera as libc::c_int == sNextCamIdx as libc::c_int
       {
        if sNextCamIdx as libc::c_int != 0 as libc::c_int {
            ...
            (*this).dyna.actor.params =
                ((*this).dyna.actor.params as libc::c_int ^ 1 as libc::c_int)
                    as s16;
            sNextCamIdx = 0 as libc::c_int as s16;
            ...
            (*this).actionFunc =
                Some(func_808A3D58 as
                         unsafe extern "C" fn(_: *mut BgMoriHineri,
                                              _: *mut GlobalContext) -> ());
            sNextCamIdx = -(1 as libc::c_int) as s16
        }
    }
    if sNextCamIdx as libc::c_int >= 1 as libc::c_int &&
           (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                         usize]).eye.z -
               (*this).dyna.actor.world.pos.z < 1100.0f32 {
        func_8002F948(&mut (*this).dyna.actor,
                      (0x28ad as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgMoriHineri = thisx as *mut BgMoriHineri;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHineri_DrawHallAndRoom(mut thisx: *mut Actor,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut this: *mut BgMoriHineri = thisx as *mut BgMoriHineri;
    let mut objIndex: s8 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mori_hineri.c\x00" as *const u8 as
                        *const libc::c_char, 611 as libc::c_int);
    ...
    (*_g).words.w1 =
        (*globalCtx).objectCtx.status[(*this).moriTexObjIdx as usize].segment
            as libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        sDLists[(*this).dyna.actor.params as usize] as libc::c_uint;
    if (*this).boxObjIdx as libc::c_int > 0 as libc::c_int {
        Matrix_Get(&mut mtx);
    }
    if (*this).actionFunc ==
           Some(func_808A3C8C as
                    unsafe extern "C" fn(_: *mut BgMoriHineri,
                                         _: *mut GlobalContext) -> ()) &&
           (*this).dyna.actor.shape.rot.z as libc::c_int != 0 as libc::c_int {
        func_80093D18((*globalCtx).state.gfxCtx);
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            Matrix_Translate(-1761.0f32, 1278.0f32, -1821.0f32,
                             MTXMODE_NEW as libc::c_int as u8_0);
        } else {
            Matrix_Translate(1999.0f32, 1278.0f32, -1821.0f32,
                             MTXMODE_NEW as libc::c_int as u8_0);
        }
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gDungeonDoorDL.as_mut_ptr() as libc::c_uint
    }
    if (*this).boxObjIdx as libc::c_int > 0 as libc::c_int &&
           {
               (*this).boxObjIdx =
        ...
        (*_g_4).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_4).words.w1 =
            (*globalCtx).objectCtx.status[(*this).boxObjIdx as usize].segment
                as libc::c_uint;
        ...
        Matrix_Put(&mut mtx);
        Matrix_Translate(147.0f32, -245.0f32, -453.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        Matrix_Put(&mut mtx);
        Matrix_Translate(167.0f32, -218.0f32, -453.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        if Flags_GetTreasure(globalCtx, 0xe as libc::c_int) != 0 {
            Matrix_RotateZ(0x3500 as libc::c_int as libc::c_float *
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_mori_hineri.c\x00" as *const u8 as
                         *const libc::c_char, 709 as libc::c_int);
}
