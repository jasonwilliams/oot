...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleStoneBlock1DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStoneBlock2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlameDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStoneBlock1Col: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleStoneBlock2Col: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame0Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleBigVerticalFlame7Tex: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanRock {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanRockActionFunc,
    pub type_0: u8_0,
    pub unk_169: u8_0,
    pub timer: s16,
    pub unk_16C: f32_0,
...
pub type BgHidanRockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanRock, _: *mut GlobalContext)
               -> ()>;
static mut D_8088BF60: Vec3f =
    { let mut init = Vec3f{x: 3310.0f32, y: 120.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub static mut Bg_Hidan_Rock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_ROCK as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanRock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRock_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanRock = thisx as *mut BgHidanRock;
    let mut pad: s32 = 0;
    ...
    (*this).type_0 =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as u8_0;
    (*this).unk_169 = 0 as libc::c_int as u8_0;
    (*thisx).params =
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        if Flags_GetSwitch(globalCtx, (*thisx).params as s32) != 0 {
            Math_Vec3f_Copy(&mut (*thisx).home.pos, &mut D_8088BF60);
            Math_Vec3f_Copy(&mut (*thisx).world.pos, &mut D_8088BF60);
            (*this).timer = 60 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_8088B5F4 as
                         unsafe extern "C" fn(_: *mut BgHidanRock,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(func_8088B268 as
                         unsafe extern "C" fn(_: *mut BgHidanRock,
                                              _: *mut GlobalContext) -> ())
        }
        (*thisx).flags |=
        ...
        CollisionHeader_GetVirtual(&mut gFireTempleStoneBlock1Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gFireTempleStoneBlock2Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).collider.dim.pos.x = (*thisx).home.pos.x as s16;
        (*this).collider.dim.pos.y = (*thisx).home.pos.y as s16;
        (*this).collider.dim.pos.z = (*thisx).home.pos.z as s16;
        (*this).actionFunc =
            Some(func_8088B634 as
                     unsafe extern "C" fn(_: *mut BgHidanRock,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRock_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanRock = thisx as *mut BgHidanRock;
    ...
    Audio_StopSfxByPos(&mut (*this).unk_170);
}
#[no_mangle]
pub unsafe extern "C" fn func_8088B24C(mut this: *mut BgHidanRock) {
    (*this).dyna.actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int |
             (1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(func_8088B990 as
                 unsafe extern "C" fn(_: *mut BgHidanRock,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8088B268(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_8088BFC0: f32_0 = 0.0f32;
    ...
    if (*this).dyna.unk_150 != 0.0f32 {
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            if D_8088BFC0 == 0.0f32 {
                if (*this).dyna.unk_150 > 0.0f32 {
                    D_8088BFC0 += 0.01f32
                } else { D_8088BFC0 -= 0.01f32 }
            }
            ...
            if D_8088BFC0 > 0.0f32 {
                temp_v1 =
                    Math_StepToF(&mut D_8088BFC0, 20.0f32,
                                 (*this).dyna.actor.speedXZ)
            } else {
                temp_v1 =
                    Math_StepToF(&mut D_8088BFC0, -20.0f32,
            ...
            (*this).dyna.actor.world.pos.x =
                Math_SinS((*this).dyna.unk_158) * D_8088BFC0 +
                    (*this).dyna.actor.home.pos.x;
            (*this).dyna.actor.world.pos.z =
                Math_CosS((*this).dyna.unk_158) * D_8088BFC0 +
    ...
    if sp2C < 0.5f32 {
        Flags_SetSwitch(globalCtx, (*this).dyna.actor.params as s32);
        Math_Vec3f_Copy(&mut (*this).dyna.actor.home.pos, &mut D_8088BF60);
        ...
        (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(func_8088B79C as
                     unsafe extern "C" fn(_: *mut BgHidanRock,
                                          _: *mut GlobalContext) -> ())
    }
    frame =
        ((*globalCtx).gameplayFrames & 0xff as libc::c_int as libc::c_uint) as
            s32;
    if (*globalCtx).gameplayFrames & 0x100 as libc::c_int as libc::c_uint != 0
       {
        (*this).unk_16C = 0.0f32
    } else if frame < 128 as libc::c_int {
        (*this).unk_16C =
            sinf(frame as libc::c_float *
                     (4 as libc::c_int as libc::c_float * 0.001f32 *
                          3.14159265358979323846f32)) * 19.625f32
    } else if frame < 230 as libc::c_int {
        (*this).unk_16C = 19.625f32
    } else {
        (*this).unk_16C -= 1.0f32;
        (*this).unk_16C =
            if (*this).unk_16C < 0.0f32 { 0.0f32 } else { (*this).unk_16C }
    }
    if sp2C < 100.0f32 {
        (*this).unk_16C =
            if (*this).unk_16C > 6.125f32 {
                6.125f32
            } else { (*this).unk_16C }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8088B5F4(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8088B634(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 {
        ...
        (*this).dyna.actor.world.rot.y =
            (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                             as usize]) as
                 libc::c_int + 0x4000 as libc::c_int) as s16;
        (*this).actionFunc =
            Some(func_8088B69C as
                     unsafe extern "C" fn(_: *mut BgHidanRock,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8088B69C(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int != 0 as libc::c_int {
        (*this).dyna.actor.world.pos.x =
    ...
    if (*this).timer as libc::c_int % 4 as libc::c_int == 0 {
        func_800AA000((*this).dyna.actor.xyzDistToPlayerSq,
                      0xb4 as libc::c_int as u8_0, 0xa as libc::c_int as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_8088B79C(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).timer -= 1;
    if (*this).dyna.actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0
       {
        if (*this).type_0 as libc::c_int == 0 as libc::c_int {
            ...
            (*this).dyna.actor.world.pos.y =
                (*this).dyna.actor.home.pos.y - 15.0f32;
            (*this).actionFunc =
                Some(func_8088B90C as
                         unsafe extern "C" fn(_: *mut BgHidanRock,
                                              _: *mut GlobalContext) -> ());
            (*this).dyna.actor.flags &=
                !((1 as libc::c_int) << 4 as libc::c_int |
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        if func_8004356C(&mut (*this).dyna) != 0 {
            if (*this).unk_169 as libc::c_int == 0 as libc::c_int {
                (*this).unk_169 = 3 as libc::c_int as u8_0
            }
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 CAM_SET_FIRE_PLATFORM as libc::c_int as s16);
        } else if func_8004356C(&mut (*this).dyna) == 0 {
            if (*this).unk_169 as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_8088B90C(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y, 1.0f32) != 0 {
        (*this).actionFunc =
            Some(func_8088B634 as
                     unsafe extern "C" fn(_: *mut BgHidanRock,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_8088B954(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn func_8088B990(mut this: *mut BgHidanRock,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int &&
           Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                              (*this).dyna.actor.home.pos.y + 1820.0f32,
                              0.25f32, 20.0f32, 0.5f32) < 0.1f32 ||
           (*this).type_0 as libc::c_int != 0 as libc::c_int &&
               Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                                  ((*this).dyna.actor.home.pos.y as
                                       libc::c_double + 480.0f64) as f32_0,
                                  0.25f32, 20.0f32, 0.5f32) < 0.1f32 {
        if (*this).type_0 as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2835 as libc::c_int as u16_0);
        ...
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8088B954 as
                     unsafe extern "C" fn(_: *mut BgHidanRock,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).unk_16C =
        ((*this).dyna.actor.world.pos.y + 50.0f32 -
             (*this).dyna.actor.home.pos.y + 40.0f32) / 80.0f32;
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        if func_8004356C(&mut (*this).dyna) != 0 {
            if (*this).unk_169 as libc::c_int == 0 as libc::c_int {
                (*this).unk_169 = 3 as libc::c_int as u8_0
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRock_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHidanRock = thisx as *mut BgHidanRock;
    ...
    if (*this).unk_16C > 0.0f32 {
        (*this).collider.dim.height =
            (sCylinderInit.dim.height as libc::c_int as libc::c_float *
                 (*this).unk_16C) as s16;
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    };
}
static mut sVerticalFlamesTexs: [*mut libc::c_void; 8] =
    unsafe {
        [gFireTempleBigVerticalFlame0Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame1Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame2Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame3Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame4Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame5Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame6Tex.as_ptr() as *mut _ as
             *mut libc::c_void,
         gFireTempleBigVerticalFlame7Tex.as_ptr() as *mut _ as
             *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn func_8088BC40(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut BgHidanRock) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_rock.c\x00" as *const u8 as
                        *const libc::c_char, 808 as libc::c_int);
    (*__gfxCtx).polyXlu.p =
        ...
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        Matrix_Translate(D_8088BF60.x, D_8088BF60.y - 40.0f32, D_8088BF60.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
    } else {
        Matrix_Translate((*this).dyna.actor.home.pos.x,
                         (*this).dyna.actor.home.pos.y - 40.0f32,
                         (*this).dyna.actor.home.pos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
    }
    ...
    Matrix_Translate(-10.5f32, 0.0f32, 0.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(6.0f32, (*this).unk_16C, 6.0f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        gSegments[((sVerticalFlamesTexs[((*globalCtx).gameplayFrames &
                                             7 as libc::c_int as libc::c_uint)
                                            as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sVerticalFlamesTexs[((*globalCtx).gameplayFrames
                                                                   &
                                                                   7 as
                                                                       libc::c_int
                                                                       as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gFireTempleBigVerticalFlameDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_hidan_rock.c\x00" as *const u8 as
                         *const libc::c_char, 857 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanRock_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanRock = thisx as *mut BgHidanRock;
    let mut pad: s32 = 0;
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gFireTempleStoneBlock1DL.as_mut_ptr());
    } else {
        Gfx_DrawDListOpa(globalCtx, gFireTempleStoneBlock2DL.as_mut_ptr());
    }
    if (*this).unk_16C > 0.0f32 {
        if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        ...
        func_80078914(&mut (*this).unk_170,
