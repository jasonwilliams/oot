...
extern "C" {
    ...
    #[no_mangle]
    static mut gDancingCoupleAnim: AnimationHeader;
    #[no_mangle]
    static mut gDancingCoupleSkel: FlexSkeletonHeader;
}
...
pub struct EnTg {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnTgActionFunc,
    pub collider: ColliderCylinder,
    pub isTalking: s16,
    pub unk_1E2: [libc::c_char; 38],
    pub nextDialogue: u8_0,
}
pub type EnTgActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTg, _: *mut GlobalContext) -> ()>;
...
#[no_mangle]
pub static mut En_Tg_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnTg>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_GetTextId(mut globalCtx: *mut GlobalContext,
                                        mut thisx: *mut Actor) -> u16_0 {
    let mut this: *mut EnTg = thisx as *mut EnTg;
    let mut temp: u16_0 = 0;
    let mut phi: u32_0 = 0;
    // If the player is wearing a mask, return a special reaction text
    temp = Text_GetFaceReaction(globalCtx, 0x24 as libc::c_int as u32_0);
    if temp as libc::c_int != 0 as libc::c_int { return temp }
    // Use a different set of dialogue in Kakariko Village (Adult)
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT01 as libc::c_int {
        if (*this).nextDialogue as libc::c_int % 2 as libc::c_int !=
               0 as libc::c_int {
            phi = 0x5089 as libc::c_int as u32_0
        } else { phi = 0x508a as libc::c_int as u32_0 }
        return phi as u16_0
    } else {
        if (*this).nextDialogue as libc::c_int % 2 as libc::c_int !=
               0 as libc::c_int {
            phi = 0x7025 as libc::c_int as u32_0
        } else { phi = 0x7026 as libc::c_int as u32_0 }
        return phi as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTg_OnTextComplete(mut globalCtx:
                                                 *mut GlobalContext,
    ...
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        ...
        2 => {
            match (*this).actor.textId as libc::c_int {
                20617 | 20618 => {
                    (*this).nextDialogue =
                        (*this).nextDialogue.wrapping_add(1)
                }
                28709 | 28710 => {
                    (*this).actor.params =
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_Init(mut thisx: *mut Actor,
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gDancingCoupleSkel, &mut gDancingCoupleAnim,
    ...
    (*this).nextDialogue =
        (*globalCtx).state.frames.wrapping_rem(2 as libc::c_int as
                                                   libc::c_uint) as u8_0;
    (*this).actionFunc =
        Some(EnTg_SpinIfNotTalking as
                 unsafe extern "C" fn(_: *mut EnTg, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnTg_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTg = thisx as *mut EnTg;
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_SpinIfNotTalking(mut this: *mut EnTg,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).isTalking == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTg = thisx as *mut EnTg;
    let mut pad: s32 = 0;
    let mut temp: f32_0 = 0.;
    let mut sp2C: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    sp2C.x = (*this).actor.world.pos.x as s16;
    sp2C.y = (*this).actor.world.pos.y as s16;
    sp2C.z =
        ((*this).actor.world.pos.z as s16 as libc::c_int + 3 as libc::c_int)
            as s16;
    ...
    func_800343CC(globalCtx, &mut (*this).actor, &mut (*this).isTalking, temp,
                  Some(EnTg_GetTextId as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> u16_0),
                  Some(EnTg_OnTextComplete as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> s16));
}
#[no_mangle]
pub unsafe extern "C" fn EnTg_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnTg = thisx as *mut EnTg;
    let mut targetOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 800.0f32, z: 0.0f32,}; init };
    if limbIndex == 9 as libc::c_int {
        // Place the target point at the guy's head instead of the center of the actor
        Matrix_MultVec3f(&mut targetOffset, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTg_SetColor(mut gfxCtx: *mut GraphicsContext,
...
#[no_mangle]
pub unsafe extern "C" fn EnTg_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTg = thisx as *mut EnTg;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tg.c\x00" as *const u8 as *const libc::c_char,
                    462 as libc::c_int);
    Matrix_Translate(0.0f32, 0.0f32, -560.0f32,
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        EnTg_SetColor((*globalCtx).state.gfxCtx, 0 as libc::c_int as u8_0,
                      50 as libc::c_int as u8_0, 160 as libc::c_int as u8_0,
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        EnTg_SetColor((*globalCtx).state.gfxCtx, 255 as libc::c_int as u8_0,
