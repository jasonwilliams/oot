...
extern "C" {
    ...
    #[no_mangle]
    static mut gSongOfTimeBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gSongOfTimeBlockCol: CollisionHeader;
}
...
pub const OCARINA_SONG_SCARECROW_LONG: C2RustUnnamed_18 = 14;
pub const OCARINA_SONG_MAX: C2RustUnnamed_18 = 14;
pub const OCARINA_SONG_MEMORY_GAME: C2RustUnnamed_18 = 13;
pub const OCARINA_SONG_SCARECROW: C2RustUnnamed_18 = 12;
pub const OCARINA_SONG_STORMS: C2RustUnnamed_18 = 11;
pub const OCARINA_SONG_TIME: C2RustUnnamed_18 = 10;
pub const OCARINA_SONG_SUNS: C2RustUnnamed_18 = 9;
pub const OCARINA_SONG_LULLABY: C2RustUnnamed_18 = 8;
pub const OCARINA_SONG_EPONAS: C2RustUnnamed_18 = 7;
pub const OCARINA_SONG_SARIAS: C2RustUnnamed_18 = 6;
pub const OCARINA_SONG_PRELUDE: C2RustUnnamed_18 = 5;
pub const OCARINA_SONG_NOCTURNE: C2RustUnnamed_18 = 4;
pub const OCARINA_SONG_REQUIEM: C2RustUnnamed_18 = 3;
pub const OCARINA_SONG_SERENADE: C2RustUnnamed_18 = 2;
pub const OCARINA_SONG_BOLERO: C2RustUnnamed_18 = 1;
pub const OCARINA_SONG_MINUET: C2RustUnnamed_18 = 0;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjWarp2block {
    pub dyna: DynaPolyActor,
    pub actionFunc: ObjWarp2blockActionFunc,
    pub func_168: ObjWarp2blockFunc168,
    pub unk_16C: s16,
    pub unk_16E: s16,
    pub unk_170: s16,
    pub unk_172: u16_0,
...
pub type ObjWarp2blockFunc168
    =
    Option<unsafe extern "C" fn(_: *mut ObjWarp2block, _: *mut GlobalContext)
               -> s32>;
pub type ObjWarp2blockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjWarp2block, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct Warp2BlockSpawnData {
    pub scale: f32_0,
    pub focus: f32_0,
    pub params: s16,
}
#[no_mangle]
pub static mut Obj_Warp2block_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_WARP2BLOCK as libc::c_int as s16,
                          category:
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_TIMEBLOCK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjWarp2block>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjWarp2block_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjWarp2block_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjWarp2block_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjWarp2block_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x0C
static mut sSpawnData: [Warp2BlockSpawnData; 2] =
    [{
         let mut init =
             Warp2BlockSpawnData{scale: 1.0f32,
                                 focus: 60.0f32,
                                 params: 0x18 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Warp2BlockSpawnData{scale: 0.6f32,
                                 focus: 40.0f32,
                                 params: 0x19 as libc::c_int as s16,};
         init
     }];
static mut sDistances: [f32_0; 8] =
    [60.0f32, 100.0f32, 140.0f32, 180.0f32, 220.0f32, 260.0f32, 300.0f32,
     300.0f32];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
static mut sColors: [Color_RGB8; 8] =
    [{
         let mut init =
             Color_RGB8{r: 100 as libc::c_int as u8_0,
                        g: 120 as libc::c_int as u8_0,
                        b: 140 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             Color_RGB8{r: 80 as libc::c_int as u8_0,
                        g: 140 as libc::c_int as u8_0,
     ...
     {
         let mut init =
             Color_RGB8{r: 70 as libc::c_int as u8_0,
                        g: 160 as libc::c_int as u8_0,
                        b: 225 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_Spawn(mut this: *mut ObjWarp2block,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ...
                (*this).dyna.actor.world.pos.z, 0 as libc::c_int as s16,
                0 as libc::c_int as s16, 0 as libc::c_int as s16,
                sSpawnData[((*this).dyna.actor.params as libc::c_int >>
                                8 as libc::c_int & 1 as libc::c_int) as
                               usize].params);
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_DEMO_EFFECT as libc::c_int as s16,
                (*(*this).dyna.actor.child).world.pos.x,
                (*(*this).dyna.actor.child).world.pos.y,
                (*(*this).dyna.actor.child).world.pos.z,
                0 as libc::c_int as s16, 0 as libc::c_int as s16,
                0 as libc::c_int as s16,
                sSpawnData[((*(*this).dyna.actor.child).params as libc::c_int
                                >> 8 as libc::c_int & 1 as libc::c_int) as
                               usize].params);
}
#[no_mangle]
pub unsafe extern "C" fn func_80BA1ECC(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut temp_a3: *mut Actor = 0 as *mut Actor;
    let mut player: *mut Player = 0 as *mut Player;
    let mut sp20: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_f2: f32_0 = 0.;
    if func_80043590(&mut (*this).dyna) != 0 { return 0 as libc::c_int }
    temp_a3 = (*this).dyna.actor.child;
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).dyna.actor.xzDistToPlayer <=
           sDistances[((*this).dyna.actor.params as libc::c_int >>
                           0xb as libc::c_int & 7 as libc::c_int) as usize] ||
           (*temp_a3).xzDistToPlayer <=
               sDistances[((*temp_a3).params as libc::c_int >>
                               0xb as libc::c_int & 7 as libc::c_int) as
                              usize] {
        func_8002DBD0(&mut (*this).dyna.actor, &mut sp20,
                      &mut (*player).actor.world.pos);
        temp_f2 = (*this).dyna.actor.scale.x * 50.0f32 + 6.0f32;
        if !(temp_f2 < fabsf(sp20.x)) && !(temp_f2 < fabsf(sp20.z)) {
            return 0 as libc::c_int
        }
        func_8002DBD0(temp_a3, &mut sp20, &mut (*player).actor.world.pos);
        temp_f2 = (*temp_a3).scale.x * 50.0f32 + 6.0f32;
        if !(temp_f2 < fabsf(sp20.x)) && !(temp_f2 < fabsf(sp20.z)) {
            return 0 as libc::c_int
        }
...
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_SwapWithChild(mut this:
                                                         *mut ObjWarp2block,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut tempVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut tempRot: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut temp: s32 = 0;
    Math_Vec3f_Copy(&mut tempVec, &mut (*this).dyna.actor.world.pos);
    Math_Vec3f_Copy(&mut (*this).dyna.actor.world.pos,
                    &mut (*(*this).dyna.actor.child).world.pos);
    Math_Vec3f_Copy(&mut (*(*this).dyna.actor.child).world.pos, &mut tempVec);
    temp = (*this).dyna.actor.world.rot.y as s32;
    (*this).dyna.actor.world.rot.y = (*(*this).dyna.actor.child).world.rot.y;
    (*(*this).dyna.actor.child).world.rot.y = temp as s16;
    temp = (*this).dyna.actor.shape.rot.y as s32;
    (*this).dyna.actor.shape.rot.y = (*(*this).dyna.actor.child).shape.rot.y;
    (*(*this).dyna.actor.child).shape.rot.y = temp as s16;
    temp = (*this).dyna.actor.home.rot.z as s32;
    (*this).dyna.actor.home.rot.z = (*(*this).dyna.actor.child).home.rot.z;
    (*(*this).dyna.actor.child).home.rot.z = temp as s16;
    Math_Vec3f_Copy(&mut tempVec, &mut (*this).dyna.actor.scale);
    Math_Vec3f_Copy(&mut (*this).dyna.actor.scale,
                    &mut (*(*this).dyna.actor.child).scale);
    Math_Vec3f_Copy(&mut (*(*this).dyna.actor.child).scale, &mut tempVec);
    Math_Vec3f_Copy(&mut tempVec, &mut (*this).dyna.actor.focus.pos);
    Math_Vec3f_Copy(&mut (*this).dyna.actor.focus.pos,
                    &mut (*(*this).dyna.actor.child).focus.pos);
    Math_Vec3f_Copy(&mut (*(*this).dyna.actor.child).focus.pos, &mut tempVec);
    ...
    temp = (*this).dyna.actor.params as libc::c_int & 0x7fff as libc::c_int;
    (*this).dyna.actor.params =
        ((*this).dyna.actor.params as libc::c_int & 0x8000 as libc::c_int |
             (*(*this).dyna.actor.child).params as libc::c_int &
                 0x7fff as libc::c_int) as s16;
    (*(*this).dyna.actor.child).params =
        ((*(*this).dyna.actor.child).params as libc::c_int &
             0x8000 as libc::c_int | temp & 0x7fff as libc::c_int) as s16;
    if Math3D_Vec3fDistSq(&mut (*this).dyna.actor.world.pos,
                          &mut (*this).dyna.actor.home.pos) < 0.01f32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80BA2218(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if func_80BA1ECC(this, globalCtx) != 0 {
        if (*player).stateFlags2 & 0x1000000 as libc::c_int as libc::c_uint !=
            ...
            (*this).func_168 =
                Some(func_80BA228C as
                         unsafe extern "C" fn(_: *mut ObjWarp2block,
...
#[no_mangle]
pub unsafe extern "C" fn func_80BA228C(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
           OCARINA_MODE_04 as libc::c_int {
        (*this).func_168 =
            Some(func_80BA2218 as
                     unsafe extern "C" fn(_: *mut ObjWarp2block,
                                          _: *mut GlobalContext) -> s32)
    }
    if (*globalCtx).msgCtx.lastPlayedSong as libc::c_int ==
           OCARINA_SONG_TIME as libc::c_int {
        if (*this).unk_172 as libc::c_int == 0xfe as libc::c_int {
            (*this).unk_16E = 0x6e as libc::c_int as s16
        } else {
            (*this).unk_16E -= 1;
...
#[no_mangle]
pub unsafe extern "C" fn func_80BA2304(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut ret: s32 =
        (*this).func_168.expect("non-null function pointer")(this, globalCtx);
    (*this).unk_172 = (*globalCtx).msgCtx.lastPlayedSong;
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_Init(mut thisx: *mut Actor,
                                            mut globalCtx2:
                                                *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut ObjWarp2block = thisx as *mut ObjWarp2block;
    let mut collisionHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    collisionHeader = 0 as *mut CollisionHeader;
    ...
    Actor_SetFocus(&mut (*this).dyna.actor,
                   sSpawnData[((*this).dyna.actor.params as libc::c_int >>
                                   8 as libc::c_int & 1 as libc::c_int) as
                                  usize].focus);
    if (*this).dyna.actor.params as libc::c_int >> 0xf as libc::c_int &
           1 as libc::c_int != 0 {
        func_80BA24E8(this);
        ...
        CollisionHeader_GetVirtual(&mut gSongOfTimeBlockCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void,
                                   &mut collisionHeader);
        (*this).dyna.bgId =
            DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                                &mut (*this).dyna.actor, collisionHeader)
    } else { ObjWarp2block_SetInactive(this); }
    osSyncPrintf(b"\xe6\x99\x82\xe3\x81\xae\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf(\xe3\x83\xaf\xe3\x83\xbc\xe3\x83\x97\xef\xbc\x92) (<arg> %04xH <type> color:%d range:%d)\n\x00"
                 ...
                 (*this).dyna.actor.home.rot.z as libc::c_int &
                     7 as libc::c_int,
                 (*this).dyna.actor.params as libc::c_int >>
                     0xb as libc::c_int & 7 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut ObjWarp2block = thisx as *mut ObjWarp2block;
    if (*this).dyna.actor.params as libc::c_int >> 0xf as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_SetInactive(mut this:
                                                       *mut ObjWarp2block) {
    (*this).actionFunc =
        Some(ObjWarp2block_DoNothing as
                 unsafe extern "C" fn(_: *mut ObjWarp2block,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.draw = None;
}
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_DoNothing(mut this: *mut ObjWarp2block,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80BA24E8(mut this: *mut ObjWarp2block) {
    (*this).actionFunc =
        Some(func_80BA24F8 as
                 unsafe extern "C" fn(_: *mut ObjWarp2block,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80BA24F8(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext) {
    let mut current: *mut Actor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ITEMACTION as libc::c_int as
                                             usize].head;
    while !current.is_null() {
        if (*current).id as libc::c_int == ACTOR_OBJ_WARP2BLOCK as libc::c_int
               &&
               (*current).params as libc::c_int >> 0xf as libc::c_int &
                   1 as libc::c_int == 0 &&
               (*this).dyna.actor.params as libc::c_int & 0x3f as libc::c_int
                   == (*current).params as libc::c_int & 0x3f as libc::c_int {
            (*this).dyna.actor.child = current;
            if Flags_GetSwitch(globalCtx,
                               (*this).dyna.actor.params as libc::c_int &
                                   0x3f as libc::c_int) != 0 {
                ObjWarp2block_SwapWithChild(this, globalCtx);
                (*this).dyna.actor.draw =
                    Some(ObjWarp2block_Draw as
    ...
    (*this).unk_174 += 1;
    if (*this).unk_174 as libc::c_int > 60 as libc::c_int {
        osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"Error : \xe6\x99\x82\xe3\x81\xae\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf(\xe3\x83\xaf\xe3\x83\xbc\xe3\x83\x97\xef\xbc\x92)\xe3\x81\x8c\xe5\xaf\xbe\xe3\x81\xa7\xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_warp2block.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80BA2600(mut this: *mut ObjWarp2block) {
    (*this).actionFunc =
        Some(func_80BA2610 as
                 unsafe extern "C" fn(_: *mut ObjWarp2block,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80BA2610(mut this: *mut ObjWarp2block,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80BA2304(this, globalCtx) != 0 as libc::c_int &&
           (*this).unk_16C as libc::c_int <= 0 as libc::c_int {
        ObjWarp2block_Spawn(this, globalCtx);
        (*this).unk_16C = 0xa0 as libc::c_int as s16;
        OnePointCutscene_Attention(globalCtx, &mut (*this).dyna.actor);
        (*this).unk_170 = 0xc as libc::c_int as s16
    }
    if (*this).unk_170 as libc::c_int > 0 as libc::c_int {
        (*this).unk_170 -= 1;
        if (*this).unk_170 as libc::c_int == 0 as libc::c_int {
            ObjWarp2block_SwapWithChild(this, globalCtx);
        }
    }
    if (*this).unk_16C as libc::c_int == 0x32 as libc::c_int {
        func_80078884(0x4807 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut ObjWarp2block = thisx as *mut ObjWarp2block;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).unk_16C as libc::c_int > 0 as libc::c_int {
        (*this).unk_16C -= 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjWarp2block_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut sp44: *mut Color_RGB8 = 0 as *mut Color_RGB8;
    sp44 =
        &mut *sColors.as_mut_ptr().offset(((*thisx).home.rot.z as libc::c_int
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_warp2block.c\x00" as *const u8 as
                        *const libc::c_char, 584 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gSongOfTimeBlockDL.as_mut_ptr() as libc::c_uint;
