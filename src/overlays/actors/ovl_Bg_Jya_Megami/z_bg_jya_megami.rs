...
extern "C" {
    ...
    #[no_mangle]
    static mut gMegamiLeftCrumble5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiRightCrumble1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiLeftCrumble1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiRightCrumble2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiRightCrumble3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiRightCrumble4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiLeftCrumble2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiLeftCrumble3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiLeftCrumble4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegamiRightCrumble5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gMegami1DL: [Gfx; 0];
    #[no_mangle]
    static mut GMegamiCol: CollisionHeader;
    #[no_mangle]
    static mut gMegamiPiece1DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece2DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece3DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece4DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece5DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece6DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece7DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece8DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece9DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece10DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece11DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece12DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegamiPiece13DL: [Gfx; 0];
    #[no_mangle]
    static mut gMegami2DL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaMegami {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaMegamiActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItem: ColliderJntSphElement,
    pub lightTimer: s16,
    pub explosionTimer: s16,
    pub crumbleIndex: s16,
    pub pieces: [BgJyaMegamiPiece; 13],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaMegamiPiece {
    pub pos: Vec3f,
    pub vel: Vec3f,
    pub rotVelX: s16,
    pub rotVelY: s16,
}
pub type BgJyaMegamiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaMegami, _: *mut GlobalContext)
               -> ()>;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaMegamiPieceInit {
    pub unk_00: Vec3f,
    pub velX: f32_0,
    pub rotVelX: s16,
    pub rotVelY: s16,
...
#[no_mangle]
pub static mut Bg_Jya_Megami_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_MEGAMI as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JYA_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaMegami>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaMegami_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaMegami_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaMegami_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaMegami_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x18
static mut sPiecesInit: [BgJyaMegamiPieceInit; 13] =
    [{
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                      {
                                          let mut init =
                                              Vec3f{x: -50.0f32,
                                                    y: -21.28f32,
                                  ...
                                  velX: -1.6f32,
                                  rotVelX: 0xfed4 as libc::c_int as s16,
                                  rotVelY: 0xfe70 as libc::c_int as s16,
                                  delay: 40 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: 0.0f32,
                                  rotVelX: 0x4b0 as libc::c_int as s16,
                                  rotVelY: 0x190 as libc::c_int as s16,
                                  delay: 42 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: 1.6f32,
                                  rotVelX: 0xfce0 as libc::c_int as s16,
                                  rotVelY: 0x320 as libc::c_int as s16,
                                  delay: 44 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: -1.0f32,
                                  rotVelX: 0xfd44 as libc::c_int as s16,
                                  rotVelY: 0x1f4 as libc::c_int as s16,
                                  delay: 36 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: -3.2f32,
                                  rotVelX: 0x3e8 as libc::c_int as s16,
                                  rotVelY: 0xff38 as libc::c_int as s16,
                                  delay: 30 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: -1.0f32,
                                  rotVelX: 0xfc18 as libc::c_int as s16,
                                  rotVelY: 0x258 as libc::c_int as s16,
                                  delay: 26 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                      {
                                          let mut init =
                                              Vec3f{x: -10.240001f32,
                                                    y: -52.56f32,
                                                    z: -13.400001f32,};
                                          init
                                      },
                                  velX: 1.6f32,
                                  rotVelX: 0x258 as libc::c_int as s16,
                                  rotVelY: 0xfe70 as libc::c_int as s16,
                                  delay: 34 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: 1.8f32,
                                  rotVelX: 0x1f4 as libc::c_int as s16,
                                  rotVelY: 0 as libc::c_int as s16,
                                  delay: 38 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: -1.6f32,
                                  rotVelX: 0x12c as libc::c_int as s16,
                                  rotVelY: 0x320 as libc::c_int as s16,
                                  delay: 22 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                  ...
                                  velX: 2.4f32,
                                  rotVelX: 0x2bc as libc::c_int as s16,
                                  rotVelY: 0x12c as libc::c_int as s16,
                                  delay: 32 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BgJyaMegamiPieceInit{unk_00:
                                      {
                                          let mut init =
                                              Vec3f{x: 14.759999f32,
                                                    y: -125.8f32,
                                                    z: -44.16f32,};
                                          init
                                      },
                                  velX: 0.2f32,
                                  rotVelX: 0x320 as libc::c_int as s16,
                                  rotVelY: 0x258 as libc::c_int as s16,
                                  delay: 20 as libc::c_int as s16,};
         init
     }];
static mut D_8089B14C: [s16; 8] =
    [0x5 as libc::c_int as s16, 0x8 as libc::c_int as s16,
     0xb as libc::c_int as s16, 0xe as libc::c_int as s16,
     0x11 as libc::c_int as s16, 0x14 as libc::c_int as s16,
     0x17 as libc::c_int as s16, 0x1a as libc::c_int as s16];
static mut D_8089B15C: [s16; 8] =
    [0x12 as libc::c_int as s16, 0x1a as libc::c_int as s16,
     0x22 as libc::c_int as s16, 0x2a as libc::c_int as s16,
     0x32 as libc::c_int as s16, 0x3c as libc::c_int as s16,
     0x46 as libc::c_int as s16, 0x50 as libc::c_int as s16];
static mut D_8089B16C: [s16; 8] =
    [0x30 as libc::c_int as s16, 0x2a as libc::c_int as s16,
     0x24 as libc::c_int as s16, 0x20 as libc::c_int as s16,
     0x1c as libc::c_int as s16, 0x18 as libc::c_int as s16,
     0x14 as libc::c_int as s16, 0x10 as libc::c_int as s16];
static mut D_8089B17C: [s16; 3] =
    [0x1 as libc::c_int as s16, 0x3 as libc::c_int as s16,
     0x7 as libc::c_int as s16];
static mut sVelocity: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.8f32,}; init };
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_InitDynaPoly(mut this: *mut BgJyaMegami,
                                                  mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut collision:
                                                      *mut CollisionHeader,
    ...
    DynaPolyActor_Init(&mut (*this).dyna, flag);
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_InitCollider(mut this: *mut BgJyaMegami,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider,
                       &mut (*this).dyna.actor, &mut sJntSphInit,
                       &mut (*this).colliderItem);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_SpawnEffect(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut pos: *mut Vec3f,
    ...
    while i < num {
        let mut idx: s32 =
            (Rand_ZeroOne() * 8.0f32) as s16 as libc::c_int &
                D_8089B17C[arg4 as usize] as libc::c_int;
        let mut arg5: s16 =
            if idx < 5 as libc::c_int && Rand_ZeroOne() < 0.7f32 {
                0x40 as libc::c_int
            } else { 0x20 as libc::c_int } as s16;
        EffectSsKakera_Spawn(globalCtx, pos, velocity, pos,
                             -(90 as libc::c_int) as s16, arg5,
                             D_8089B16C[idx as usize],
                             4 as libc::c_int as s16, 0 as libc::c_int as s16,
                             D_8089B14C[idx as usize],
                             0 as libc::c_int as s16, 5 as libc::c_int as s16,
                             D_8089B15C[idx as usize] as s32,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_JYA_OBJ as libc::c_int as s16,
                             gMegami2DL.as_mut_ptr());
        if Rand_ZeroOne() < 0.45f32 {
            Math_Vec3f_Copy(&mut spB4, pos);
            spB4.z += 25.0f32;
            func_80033480(globalCtx, &mut spB4, 60.0f32, 0 as libc::c_int,
                          (D_8089B14C[idx as usize] as libc::c_int *
                               4 as libc::c_int + 50 as libc::c_int) as s16,
                          (D_8089B14C[idx as usize] as libc::c_int *
                               4 as libc::c_int + 70 as libc::c_int) as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_SetupSpawnEffect(mut this:
                                                          *mut BgJyaMegami,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut arg2: f32_0) {
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[BgJyaMegamiPiece; 13]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<BgJyaMegamiPiece>()
                                                   as libc::c_ulong) as s32 {
        if Rand_ZeroOne() < arg2 {
            Math_Vec3f_Sum(&mut (*this).dyna.actor.world.pos,
                           &mut (*sPiecesInit.as_mut_ptr().offset(i as
                                                                      isize)).unk_00,
                           &mut pos);
            pos.z += 15.0f32;
            BgJyaMegami_SpawnEffect(globalCtx, &mut pos, &mut sVelocity,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJyaMegami = thisx as *mut BgJyaMegami;
    BgJyaMegami_InitDynaPoly(this, globalCtx, &mut GMegamiCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        Actor_SetFocus(&mut (*this).dyna.actor, -50.0f32);
        BgJyaMegami_SetupDetectLight(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaMegami = thisx as *mut BgJyaMegami;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_SetupDetectLight(mut this:
                                                          *mut BgJyaMegami) {
    (*this).actionFunc =
        Some(BgJyaMegami_DetectLight as
                 unsafe extern "C" fn(_: *mut BgJyaMegami,
                                      _: *mut GlobalContext) -> ());
    (*this).lightTimer = 0 as libc::c_int as s16;
    (*this).crumbleIndex = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_DetectLight(mut this: *mut BgJyaMegami,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*globalCtx).gameplayFrames.wrapping_rem(4 as libc::c_int as
            ...
            BgJyaMegami_SetupSpawnEffect(this, globalCtx,
                                         (*this).crumbleIndex as libc::c_int
                                             as libc::c_float * 0.04f32 +
                                             0.05f32);
        }
        func_8002F974(&mut (*this).dyna.actor,
                      (0x28d1 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    } else if (*this).lightTimer as libc::c_int > 0 as libc::c_int {
        (*this).lightTimer -= 1
    }
    if (*this).lightTimer as libc::c_int > 40 as libc::c_int {
        ...
        Audio_PlaySoundAtPosition(globalCtx,
                                  ...
                                  100 as libc::c_int,
                                  0x28d0 as libc::c_int as u16_0);
        OnePointCutscene_Init(globalCtx, 3440 as libc::c_int as s16,
                              -(99 as libc::c_int) as s16,
                              &mut (*this).dyna.actor,
                              0 as libc::c_int as s16);
    } else {
        if ((*this).lightTimer as libc::c_int) < 8 as libc::c_int {
            (*this).crumbleIndex = 0 as libc::c_int as s16
        } else if ((*this).lightTimer as libc::c_int) < 16 as libc::c_int {
            (*this).crumbleIndex = 1 as libc::c_int as s16
        } else if ((*this).lightTimer as libc::c_int) < 24 as libc::c_int {
            (*this).crumbleIndex = 2 as libc::c_int as s16
        } else if ((*this).lightTimer as libc::c_int) < 32 as libc::c_int {
            (*this).crumbleIndex = 3 as libc::c_int as s16
        } else { (*this).crumbleIndex = 4 as libc::c_int as s16 }
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_SetupExplode(mut this:
                                                      *mut BgJyaMegami) {
    let mut i: u32_0 = 0;
    (*this).actionFunc =
        Some(BgJyaMegami_Explode as
                 unsafe extern "C" fn(_: *mut BgJyaMegami,
                                      _: *mut GlobalContext) -> ());
    ...
    while i <
              (::std::mem::size_of::<[BgJyaMegamiPiece; 13]>() as
                  ...
                  libc::c_uint {
        Math_Vec3f_Copy(&mut (*(*this).pieces.as_mut_ptr().offset(i as
                                                                      isize)).pos,
                        &mut (*this).dyna.actor.world.pos);
        (*this).pieces[i as usize].vel.x = sPiecesInit[i as usize].velX;
        i = i.wrapping_add(1)
    }
    (*this).explosionTimer = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_Explode(mut this: *mut BgJyaMegami,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut sVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut temp: *mut BgJyaMegamiPiece = 0 as *mut BgJyaMegamiPiece;
    let mut i: u32_0 = 0;
    let mut sp8C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp2: *mut BgJyaMegamiPieceInit = 0 as *mut BgJyaMegamiPieceInit;
    let mut pad: s32 = 0;
    (*this).explosionTimer += 1;
    if (*this).explosionTimer as libc::c_int == 30 as libc::c_int {
        Audio_PlaySoundAtPosition(globalCtx,
                                  &mut (*this).dyna.actor.world.pos,
                                  100 as libc::c_int,
                                  0x28cf as libc::c_int as u16_0);
    }
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[BgJyaMegamiPiece; 13]>() as
                  ...
                  libc::c_uint {
        temp =
            &mut *(*this).pieces.as_mut_ptr().offset(i as isize) as
                *mut BgJyaMegamiPiece;
        temp2 =
            &mut *sPiecesInit.as_mut_ptr().offset(i as isize) as
                *mut BgJyaMegamiPieceInit;
        if (*this).explosionTimer as libc::c_int >
               (*temp2).delay as libc::c_int {
            (*temp).vel.y -= 0.6f32;
            if (*temp).vel.y < -18.0f32 { (*temp).vel.y = -18.0f32 }
            (*temp).vel.x *= 0.995f32;
            (*temp).pos.x += (*temp).vel.x;
            (*temp).pos.y += (*temp).vel.y;
            (*temp).rotVelX =
                ((*temp).rotVelX as libc::c_int +
                     (*temp2).rotVelX as libc::c_int) as s16;
            (*temp).rotVelY =
                ((*temp).rotVelY as libc::c_int +
                     (*temp2).rotVelY as libc::c_int) as s16;
            if Rand_ZeroOne() < 0.067f32 {
                Math_Vec3f_Sum(&mut (*temp).pos, &mut (*temp2).unk_00,
                               &mut sp8C);
                sp8C.z += 10.0f32;
                BgJyaMegami_SpawnEffect(globalCtx, &mut sp8C,
                                        &mut (*temp).vel, 3 as libc::c_int,
                                        2 as libc::c_int);
            }
        } else if (*this).explosionTimer as libc::c_int ==
                      (*temp2).delay as libc::c_int {
            Math_Vec3f_Sum(&mut (*temp).pos, &mut (*temp2).unk_00, &mut sp8C);
            sp8C.z += 10.0f32;
            BgJyaMegami_SpawnEffect(globalCtx, &mut sp8C, &mut (*temp).vel,
                                    4 as libc::c_int, 2 as libc::c_int);
        }
        i = i.wrapping_add(1)
    }
    if (*this).explosionTimer as libc::c_int % 4 as libc::c_int ==
           0 as libc::c_int &&
           (*this).explosionTimer as libc::c_int > 30 as libc::c_int &&
           ((*this).explosionTimer as libc::c_int) < 80 as libc::c_int &&
           (*this).explosionTimer as libc::c_int > 40 as libc::c_int {
        sp8C.x =
            (Rand_ZeroOne() - 0.5f32) * 90.0f32 +
                (*this).dyna.actor.world.pos.x;
        sp8C.y =
            (*this).dyna.actor.world.pos.y - Rand_ZeroOne() * 80.0f32 -
                20.0f32;
        sp8C.z =
            (*this).dyna.actor.world.pos.z -
                (Rand_ZeroOne() - 0.5f32) * 50.0f32;
        BgJyaMegami_SpawnEffect(globalCtx, &mut sp8C, &mut sVec,
                                1 as libc::c_int, 0 as libc::c_int);
    }
    if ((*this).explosionTimer as libc::c_int) <
           (::std::mem::size_of::<[BgJyaMegamiPiece; 13]>() as
        ...
        sp8C.y = (*this).dyna.actor.world.pos.y - 60.0f32;
        sp8C.z = (*this).dyna.actor.world.pos.z;
        func_80033480(globalCtx, &mut sp8C, 100.0f32, 1 as libc::c_int,
                      150 as libc::c_int as s16, 100 as libc::c_int as s16,
                      1 as libc::c_int as u8_0);
    }
    if (*this).explosionTimer as libc::c_int == 60 as libc::c_int {
        func_80078884(0x4802 as libc::c_int as u16_0);
    }
    if (*this).explosionTimer as libc::c_int >= 100 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgJyaMegami = thisx as *mut BgJyaMegami;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
static mut sRightSideCrumbles: [*mut libc::c_void; 5] =
    unsafe {
        [gMegamiRightCrumble1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiRightCrumble2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiRightCrumble3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiRightCrumble4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiRightCrumble5Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sLeftSideCrumbles: [*mut libc::c_void; 5] =
    unsafe {
        [gMegamiLeftCrumble1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiLeftCrumble2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiLeftCrumble3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiLeftCrumble4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gMegamiLeftCrumble5Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_DrawFace(mut this: *mut BgJyaMegami,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_megami.c\x00" as *const u8 as
                        *const libc::c_char, 706 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((sRightSideCrumbles[(*this).crumbleIndex as usize] as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sRightSideCrumbles[(*this).crumbleIndex
                                                                 as usize] as
                                              u32_0 &
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((sLeftSideCrumbles[(*this).crumbleIndex as usize] as u32_0)
                       << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sLeftSideCrumbles[(*this).crumbleIndex
                                                                as usize] as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gMegami1DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_megami.c\x00" as *const u8 as
                         *const libc::c_char, 720 as libc::c_int);
}
static mut sDLists: [*mut Gfx; 13] =
    unsafe {
        [gMegamiPiece1DL.as_ptr() as *mut _,
         gMegamiPiece2DL.as_ptr() as *mut _,
         gMegamiPiece3DL.as_ptr() as *mut _,
         gMegamiPiece4DL.as_ptr() as *mut _,
         gMegamiPiece5DL.as_ptr() as *mut _,
         gMegamiPiece6DL.as_ptr() as *mut _,
         gMegamiPiece7DL.as_ptr() as *mut _,
         gMegamiPiece8DL.as_ptr() as *mut _,
         gMegamiPiece9DL.as_ptr() as *mut _,
         gMegamiPiece10DL.as_ptr() as *mut _,
         gMegamiPiece11DL.as_ptr() as *mut _,
         gMegamiPiece12DL.as_ptr() as *mut _,
         gMegamiPiece13DL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_DrawExplode(mut this: *mut BgJyaMegami,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut piece: *mut BgJyaMegamiPiece = 0 as *mut BgJyaMegamiPiece;
    let mut i: u32_0 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_megami.c\x00" as *const u8 as
                        *const libc::c_char, 746 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[BgJyaMegamiPiece; 13]>() as
        ...
        piece =
            &mut *(*this).pieces.as_mut_ptr().offset(i as isize) as
                *mut BgJyaMegamiPiece;
        Matrix_Translate((*piece).pos.x + sPiecesInit[i as usize].unk_00.x,
                         (*piece).pos.y + sPiecesInit[i as usize].unk_00.y,
                         (*piece).pos.z + sPiecesInit[i as usize].unk_00.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY((*piece).rotVelY as libc::c_int as libc::c_float *
                           (3.14159265358979323846f32 /
                                0x8000 as libc::c_int as libc::c_float),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX((*piece).rotVelX as libc::c_int as libc::c_float *
                           (3.14159265358979323846f32 /
                                0x8000 as libc::c_int as libc::c_float),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(0.1f32, 0.1f32, 0.1f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(sPiecesInit[i as usize].unk_00.x * -10.0f32,
                         sPiecesInit[i as usize].unk_00.y * -10.0f32,
                         sPiecesInit[i as usize].unk_00.z * -10.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = sDLists[i as usize] as libc::c_uint;
        i = i.wrapping_add(1)
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_megami.c\x00" as *const u8 as
                         *const libc::c_char, 783 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaMegami_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJyaMegami = thisx as *mut BgJyaMegami;
    ...
    } else { BgJyaMegami_DrawFace(this, globalCtx); };
}
