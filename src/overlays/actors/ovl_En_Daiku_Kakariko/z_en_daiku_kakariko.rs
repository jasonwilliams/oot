...
extern "C" {
    ...
    #[no_mangle]
    static mut object_daiku_Anim_000600: AnimationHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDaikuKakariko {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDaikuKakarikoActionFunc,
    ...
    pub timer: s32,
    pub neckAngle: Vec3s,
    pub neckAngleTarget: Vec3s,
}
pub type EnDaikuKakarikoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDaikuKakariko,
                                _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const CARPENTER_SHIRO: C2RustUnnamed_23 = 3;
pub const CARPENTER_JIRO: C2RustUnnamed_23 = 2;
pub const CARPENTER_SABOORO: C2RustUnnamed_23 = 1;
pub const CARPENTER_ICHIRO: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut En_Daiku_Kakariko_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DAIKU_KAKARIKO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnDaikuKakariko>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDaikuKakariko_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDaikuKakariko_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDaikuKakariko_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDaikuKakariko_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                                                                                                   *mut GlobalContext)
                                                                              ->
                                                                                  ())),}; // List of inital values for this->flags
            init
        }
    };
...
static mut sAnimations: [struct_D_80AA1678; 6] =
    unsafe {
        [{
             let mut init =
                 struct_D_80AA1678{animation:
                                       &object_daiku_Anim_001AB0 as
                                           ...
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
                                   mode: 2 as libc::c_int as u8_0,
                                   transitionRate: -7.0f32,};
             init
         },
         {
             let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_SetAnimFromIndex(mut this:
                                                              *mut EnDaikuKakariko,
                                                          mut animIndex: s32,
                                                          mut currentAnimIndex:
                                                              *mut s32) {
    let mut morphFrames: f32_0 = 0.;
    if *currentAnimIndex < 0 as libc::c_int || animIndex == *currentAnimIndex
       {
        morphFrames = 0.0f32
    } else { morphFrames = sAnimations[animIndex as usize].transitionRate }
    Animation_Change(&mut (*this).skelAnime,
                     sAnimations[animIndex as usize].animation, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sAnimations[animIndex as
                                                            usize].animation
                                                as *mut libc::c_void) as
                         f32_0, sAnimations[animIndex as usize].mode,
                     morphFrames);
    *currentAnimIndex = animIndex;
}
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut initFlags: [u16_0; 4] =
        [0x80 as libc::c_int as u16_0, 0xb0 as libc::c_int as u16_0,
         0x70 as libc::c_int as u16_0, 0x470 as libc::c_int as u16_0];
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
    let mut pad: s32 = 0;
        ...
        match (*globalCtx).sceneNum as libc::c_int {
            82 => {
                if gSaveContext.nightFlag == 0 as libc::c_int {
                    (*this).flags =
                        ((*this).flags as libc::c_int | 1 as libc::c_int) as
                            u16_0;
                    (*this).flags =
                        ((*this).flags as libc::c_int |
                             initFlags[((*this).actor.params as libc::c_int &
            ...
            42 => {
                if gSaveContext.nightFlag == 1 as libc::c_int {
                    (*this).flags =
                        ((*this).flags as libc::c_int | 2 as libc::c_int) as
                            u16_0
                }
            }
            48 => {
    ...
    if (*this).flags as libc::c_int & 7 as libc::c_int == 0 {
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                            &mut sColChkInit);
    Animation_Change(&mut (*this).skelAnime,
                     (*sAnimations.as_mut_ptr()).animation, 1.0f32, 0.0f32,
                     Animation_GetLastFrame((*sAnimations.as_mut_ptr()).animation
                                                as *mut libc::c_void) as
                         f32_0, (*sAnimations.as_mut_ptr()).mode,
                     (*sAnimations.as_mut_ptr()).transitionRate);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32, 0.0f32,
                            0.0f32, 4 as libc::c_int);
    (*this).actor.gravity = 0.0f32;
    (*this).runSpeed = 3.0f32;
    (*this).actor.uncullZoneForward = 1200.0f32;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    (*this).currentAnimIndex = -(1 as libc::c_int);
    if (*this).flags as libc::c_int & 0x40 as libc::c_int != 0 {
        (*this).actor.gravity = -1.0f32
    }
    if (*this).flags as libc::c_int & 0x10 as libc::c_int != 0 {
        EnDaikuKakariko_SetAnimFromIndex(this, 3 as libc::c_int,
                                         &mut (*this).currentAnimIndex);
        (*this).actionFunc =
            Some(EnDaikuKakariko_Run as
                     unsafe extern "C" fn(_: *mut EnDaikuKakariko,
                                          _: *mut GlobalContext) -> ())
    } else {
        if (*this).flags as libc::c_int & 8 as libc::c_int != 0 {
            if (*this).actor.params as libc::c_int & 3 as libc::c_int ==
                   CARPENTER_SABOORO as libc::c_int ||
                   (*this).actor.params as libc::c_int & 3 as libc::c_int ==
                       CARPENTER_SHIRO as libc::c_int {
                EnDaikuKakariko_SetAnimFromIndex(this, 5 as libc::c_int,
                                                 &mut (*this).currentAnimIndex);
                (*this).flags =
                    ((*this).flags as libc::c_int | 0x800 as libc::c_int) as
                        u16_0
            } else {
                EnDaikuKakariko_SetAnimFromIndex(this, 1 as libc::c_int,
                                                 &mut (*this).currentAnimIndex);
            }
            (*this).skelAnime.curFrame =
                (Rand_ZeroOne() * (*this).skelAnime.endFrame) as s32 as f32_0
        } else {
            EnDaikuKakariko_SetAnimFromIndex(this, 0 as libc::c_int,
                                             &mut (*this).currentAnimIndex);
            (*this).skelAnime.curFrame =
                (Rand_ZeroOne() * (*this).skelAnime.endFrame) as s32 as f32_0
        }
        (*this).flags =
            ((*this).flags as libc::c_int | 0x100 as libc::c_int) as u16_0;
        (*this).actionFunc =
            Some(EnDaikuKakariko_Wait as
                     unsafe extern "C" fn(_: *mut EnDaikuKakariko,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_GetTalkState(mut this:
                                                          *mut EnDaikuKakariko,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
    let mut talkState: s32 = 2 as libc::c_int;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        talkState = 0 as libc::c_int
    }
    return talkState;
}
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_HandleTalking(mut this:
                                                           *mut EnDaikuKakariko,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    static mut maskReactionSets: [s32; 4] =
        [1 as libc::c_int, 2 as libc::c_int, 3 as libc::c_int,
         4 as libc::c_int];
    let mut sp26: s16 = 0;
    let mut sp24: s16 = 0;
    if (*this).talkState == 2 as libc::c_int {
        (*this).talkState = EnDaikuKakariko_GetTalkState(this, globalCtx)
    } else if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).talkState = 2 as libc::c_int
    } else {
        ...
        if sp26 as libc::c_int >= 0 as libc::c_int &&
            ...
            if (*this).actor.textId as libc::c_int == 0 as libc::c_int {
                match (*this).actor.params as libc::c_int & 3 as libc::c_int {
                    0 => {
                        if (*this).flags as libc::c_int & 8 as libc::c_int !=
                               0 {
                            (*this).actor.textId =
                                0x5076 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x5075 as libc::c_int as u16_0
                        }
                    }
                    1 => {
                        if (*this).flags as libc::c_int & 1 as libc::c_int !=
                               0 {
                            (*this).actor.textId =
                                0x502a as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x5074 as libc::c_int as u16_0
                        }
                    }
                    2 => {
                        if (*this).flags as libc::c_int & 1 as libc::c_int !=
                               0 {
                            (*this).actor.textId =
                                0x506a as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x506b as libc::c_int as u16_0
                        }
                    }
                    3 => {
                        if (*this).flags as libc::c_int & 1 as libc::c_int !=
                               0 {
                            (*this).actor.textId =
                                0x5077 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x5078 as libc::c_int as u16_0
                        }
                    }
                    _ => { }
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Talk(mut this: *mut EnDaikuKakariko,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if (*this).talkState == 0 as libc::c_int {
        if (*this).flags as libc::c_int & 0x10 as libc::c_int != 0 {
            EnDaikuKakariko_SetAnimFromIndex(this, 3 as libc::c_int,
                                             &mut (*this).currentAnimIndex);
            (*this).flags =
                ((*this).flags as libc::c_int & !(0x300 as libc::c_int)) as
                    u16_0;
            (*this).actionFunc =
                Some(EnDaikuKakariko_Run as
                         unsafe extern "C" fn(_: *mut EnDaikuKakariko,
        ...
        if (*this).flags as libc::c_int & 0x800 as libc::c_int ==
               0 as libc::c_int {
            (*this).flags =
                ((*this).flags as libc::c_int & !(0x200 as libc::c_int)) as
                    u16_0;
            (*this).flags =
                ((*this).flags as libc::c_int | 0x100 as libc::c_int) as u16_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Wait(mut this: *mut EnDaikuKakariko,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    EnDaikuKakariko_HandleTalking(this, globalCtx);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
    ...
    if (*this).talkState != 0 as libc::c_int {
        if (*this).flags as libc::c_int & 8 as libc::c_int == 0 {
            EnDaikuKakariko_SetAnimFromIndex(this, 4 as libc::c_int,
                                             &mut (*this).currentAnimIndex);
        }
        if (*this).flags as libc::c_int & 0x800 as libc::c_int == 0 {
            (*this).flags =
                ((*this).flags as libc::c_int | 0x200 as libc::c_int) as
                    u16_0;
            (*this).flags =
                ((*this).flags as libc::c_int & !(0x100 as libc::c_int)) as
                    u16_0
        }
        (*this).actionFunc =
            Some(EnDaikuKakariko_Talk as
                     unsafe extern "C" fn(_: *mut EnDaikuKakariko,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_StopRunning(mut this:
                                                         *mut EnDaikuKakariko,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (*this).timer <= 0 as libc::c_int {
            ...
            (*this).actionFunc =
                Some(EnDaikuKakariko_Run as
                         unsafe extern "C" fn(_: *mut EnDaikuKakariko,
                                              _: *mut GlobalContext) -> ())
        } else { (*this).skelAnime.curFrame = (*this).skelAnime.startFrame }
    }
    EnDaikuKakariko_HandleTalking(this, globalCtx);
    if (*this).talkState != 0 as libc::c_int {
        (*this).flags =
            ((*this).flags as libc::c_int | 0x200 as libc::c_int) as u16_0;
        EnDaikuKakariko_SetAnimFromIndex(this, 4 as libc::c_int,
                                         &mut (*this).currentAnimIndex);
        (*this).actionFunc =
            Some(EnDaikuKakariko_Talk as
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Run(mut this: *mut EnDaikuKakariko,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut path: *mut Path = 0 as *mut Path;
    let mut pathPos: *mut Vec3s = 0 as *mut Vec3s;
    let mut xDist: f32_0 = 0.;
    let mut zDist: f32_0 = 0.;
    let mut runAngle: s16 = 0;
    let mut runDist: f32_0 = 0.;
    let mut angleStepDiff: s16 = 0;
    let mut run: s32 = 0;
    loop  {
        path =
                                                       ...
                                                       isize)).wrapping_add((*path).points
                                                                                ...
                                                                                0xffffff
                                                                                    ...
                                                                                    libc::c_uint).wrapping_add(0x80000000
                                                                                                                   ...
                                                                                                                   libc::c_uint)
                       as *mut libc::c_void as
                       *mut Vec3s).offset((*this).waypoint as isize) as
                *mut Vec3s;
        xDist =
            (*pathPos).x as libc::c_int as libc::c_float -
                (*this).actor.world.pos.x;
        zDist =
            (*pathPos).z as libc::c_int as libc::c_float -
        ...
        run = 0 as libc::c_int;
        if runDist <= 10.0f32 {
            if (*this).pathContinue == 0 as libc::c_int {
                (*this).waypoint += 1;
                if (*this).waypoint >= (*path).count as libc::c_int {
                    if (*this).flags as libc::c_int & 0x20 as libc::c_int != 0
                       {
                        (*this).waypoint =
                            (*path).count as libc::c_int - 2 as libc::c_int;
                        (*this).pathContinue = 1 as libc::c_int;
                        run = 0 as libc::c_int;
                        (*this).run = run;
                        if (*this).flags as libc::c_int & 0x400 as libc::c_int
                               != 0 {
                            (*this).timer = 2 as libc::c_int;
                            EnDaikuKakariko_SetAnimFromIndex(this,
                                                             0 as libc::c_int,
                                                             &mut (*this).currentAnimIndex);
                            (*this).actionFunc =
                                Some(EnDaikuKakariko_StopRunning as
                                         unsafe extern "C" fn(_:
                                                                  *mut EnDaikuKakariko,
                                                              _:
                                                                  *mut GlobalContext)
                ...
                } else { run = 1 as libc::c_int; (*this).run = run }
            } else {
                (*this).waypoint -= 1;
                if (*this).waypoint < 0 as libc::c_int {
                    (*this).waypoint = 1 as libc::c_int;
                    (*this).pathContinue = 0 as libc::c_int;
                    run = 0 as libc::c_int;
                    (*this).run = run;
                    if (*this).flags as libc::c_int & 0x400 as libc::c_int !=
                           0 {
                ...
                } else { run = 1 as libc::c_int }
            }
        }
        if !(run != 0) { break ; }
    }
    angleStepDiff =
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, runAngle,
                           1 as libc::c_int as s16,
                           5000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    if (*this).run == 0 as libc::c_int {
        if angleStepDiff as libc::c_int == 0 as libc::c_int {
            (*this).run = 1 as libc::c_int
        } else { (*this).actor.speedXZ = 0.0f32 }
    }
    if (*this).run == 1 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).runSpeed,
                           0.8f32, runDist, 0.0f32);
    }
    Actor_MoveForward(&mut (*this).actor);
    if (*this).flags as libc::c_int & 0x40 as libc::c_int != 0 {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32, 0.0f32,
                                0.0f32, 4 as libc::c_int);
    } else if (*this).flags as libc::c_int & 0x80 as libc::c_int != 0 {
        (*this).runFlag =
            ((*this).runFlag as libc::c_int | 1 as libc::c_int) as u16_0;
        (*this).flags =
            ((*this).flags as libc::c_int & !(0x80 as libc::c_int)) as u16_0
    } else if (*this).runFlag as libc::c_int & 1 as libc::c_int != 0 {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32, 0.0f32,
                                0.0f32, 4 as libc::c_int);
        (*this).runFlag =
            ((*this).runFlag as libc::c_int & !(1 as libc::c_int)) as u16_0
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
    let mut pad: s32 = 0;
    ...
    let mut pad2: s32 = 0;
    if (*this).currentAnimIndex == 3 as libc::c_int {
        if (*this).skelAnime.curFrame as s32 == 6 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 15 as libc::c_int {
    ...
    if (*this).flags as libc::c_int & 4 as libc::c_int != 0 {
        (*this).collider.dim.pos.x =
            ((*this).collider.dim.pos.x as libc::c_int - 27 as libc::c_int) as
                s16;
        (*this).collider.dim.pos.z =
            ((*this).collider.dim.pos.z as libc::c_int - 27 as libc::c_int) as
                s16;
        (*this).collider.dim.radius = 63 as libc::c_int as s16
    }
    ...
    if (*this).flags as libc::c_int & 0x100 as libc::c_int != 0 {
        (*this).neckAngleTarget.x = 5900 as libc::c_int as s16;
        (*this).flags =
            ((*this).flags as libc::c_int | 0x1000 as libc::c_int) as u16_0;
        func_80034A14(&mut (*this).actor, &mut (*this).npcInfo,
                      0 as libc::c_int as s16, 2 as libc::c_int as s16);
    } else if (*this).flags as libc::c_int & 0x200 as libc::c_int != 0 {
        (*this).neckAngleTarget.x = 5900 as libc::c_int as s16;
        (*this).flags =
            ((*this).flags as libc::c_int | 0x1000 as libc::c_int) as u16_0;
        func_80034A14(&mut (*this).actor, &mut (*this).npcInfo,
    ...
    Math_SmoothStepToS(&mut (*this).neckAngle.x, (*this).neckAngleTarget.x,
                       1 as libc::c_int as s16, 1820 as libc::c_int as s16,
                       0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_OverrideLimbDraw(mut globalCtx:
                                                              *mut GlobalContext,
                                                          mut limbIndex: s32,
                                                          mut dList:
                                                              *mut *mut Gfx,
 ...
 -> s32 {
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
    let mut angle: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    match limbIndex {
        8 => {
            angle = (*this).npcInfo.unk_0E;
            Matrix_RotateX(-(angle.y as libc::c_int as libc::c_float *
                                 (3.14159265358979323846f32 / 32768.0f32)),
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ(-(angle.x as libc::c_int as libc::c_float *
                                 (3.14159265358979323846f32 / 32768.0f32)),
                           MTXMODE_APPLY as libc::c_int as u8_0);
        }
        15 => {
            ...
            if (*this).flags as libc::c_int & 0x1000 as libc::c_int != 0 {
                osSyncPrintf(b"<%d>\n\x00" as *const u8 as
                                 *const libc::c_char,
                             (*this).neckAngle.x as libc::c_int);
                Matrix_RotateX((angle.y as libc::c_int +
                                    (*this).neckAngle.y as libc::c_int) as
                                   libc::c_float *
                                   (3.14159265358979323846f32 / 32768.0f32),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateZ((angle.x as libc::c_int +
                                    (*this).neckAngle.x as libc::c_int) as
                                   libc::c_float *
                                   (3.14159265358979323846f32 / 32768.0f32),
                               MTXMODE_APPLY as libc::c_int as u8_0);
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_PostLimbDraw(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut limbIndex: s32,
                                                      mut dList:
                                                          *mut *mut Gfx,
                                                      ...
                                                      mut thisx:
                                                          *mut libc::c_void) {
    static mut carpenterHeadDLists: [*mut Gfx; 4] =
        unsafe {
    ...
    static mut unkVec: Vec3f =
        { let mut init = Vec3f{x: 700.0f32, y: 1100.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_daiku_kakariko.c\x00" as *const u8 as
                        *const libc::c_char, 1104 as libc::c_int);
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut unkVec, &mut (*this).actor.focus.pos);
        ...
        (*_g).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            carpenterHeadDLists[((*this).actor.params as libc::c_int &
                                     3 as libc::c_int) as usize] as
                libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnDaikuKakariko_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnDaikuKakariko = thisx as *mut EnDaikuKakariko;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_daiku_kakariko.c\x00" as *const u8 as
                        *const libc::c_char, 1124 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if (*thisx).params as libc::c_int & 3 as libc::c_int ==
           CARPENTER_ICHIRO as libc::c_int {
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnDaikuKakariko_OverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        ...
                                                        _: *mut libc::c_void)
                                       -> s32),
                          Some(EnDaikuKakariko_PostLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3s,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_daiku_kakariko.c\x00" as *const u8 as
                         *const libc::c_char, 1151 as libc::c_int);
}
