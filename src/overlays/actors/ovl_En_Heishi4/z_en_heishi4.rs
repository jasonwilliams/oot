...
extern "C" {
    ...
    #[no_mangle]
    static mut gEnHeishiDyingGuardDieAnim: AnimationHeader;
    #[no_mangle]
    static mut gEnHeishiDyingGuardAnim_00C444: AnimationHeader;
    #[no_mangle]
    static mut gEnHeishiDyingGuardTalkAnim: AnimationHeader;
}
...
pub const HEISHI4_AT_MARKET_NIGHT: C2RustUnnamed_23 = 8;
pub const HEISHI4_AT_MARKET_DYING: C2RustUnnamed_23 = 7;
pub const HEISHI4_AT_IMPAS_HOUSE: C2RustUnnamed_23 = 4;
pub const HEISHI4_AT_KAKRIKO_ENTRANCE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHeishi4 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
    pub actionFunc: EnHeishi4ActionFunc,
    pub unk_260: Vec3s,
    pub unk_266: Vec3s,
    pub pos: Vec3f,
    pub height: f32_0,
    ...
    pub unk_284: s16,
    pub unk_288: f32_0,
    pub unk_28C: struct_80034A14_arg1,
    pub unk_2B4: u8_0,
    pub unk_2B6: [libc::c_char; 7],
    pub collider: ColliderCylinder,
}
pub type EnHeishi4ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHeishi4, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Heishi4_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HEISHI4 as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi4_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi4_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sFaceReactionSets: [u32_0; 2] =
    [6 as libc::c_int as u32_0, 7 as libc::c_int as u32_0];
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi4_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi4 = thisx as *mut EnHeishi4;
    ...
    if (*this).type_0 as libc::c_int == HEISHI4_AT_MARKET_DYING as libc::c_int
       {
        (*this).height = 30.0f32;
        ActorShape_Init(&mut (*thisx).shape, 0.0f32, None, 30.0f32);
        SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gEnHeishiSkel,
                       &mut gEnHeishiDyingGuardAnim_00C444,
    ...
    match (*this).type_0 as libc::c_int {
        0 | 4 => {
            (*this).actionFunc =
                Some(func_80A56328 as
                         unsafe extern "C" fn(_: *mut EnHeishi4,
                                              _: *mut GlobalContext) -> ())
        }
        7 => {
            (*this).collider.dim.radius = 28 as libc::c_int as s16;
            (*this).collider.dim.height = 5 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80A5673C as
                         unsafe extern "C" fn(_: *mut EnHeishi4,
                                              _: *mut GlobalContext) -> ())
        }
        8 => {
            (*this).actionFunc =
                Some(func_80A56544 as
                         unsafe extern "C" fn(_: *mut EnHeishi4,
                                              _: *mut GlobalContext) -> ())
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi4_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHeishi4 = thisx as *mut EnHeishi4;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A56328(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiIdleAnim, 1.0f32,
                     0.0f32, frames as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A563BC as
                 unsafe extern "C" fn(_: *mut EnHeishi4,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A563BC(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut reactionOffset: s16 = 0;
    (*this).unk_2B4 = 0 as libc::c_int as u8_0;
    reactionOffset =
        ((*this).type_0 as libc::c_int - 4 as libc::c_int) as s16;
    if (reactionOffset as libc::c_int) < 0 as libc::c_int {
        reactionOffset = 0 as libc::c_int as s16
    }
    if reactionOffset as libc::c_int >= 3 as libc::c_int {
        reactionOffset = 1 as libc::c_int as s16
    }
    if Text_GetFaceReaction(globalCtx,
                            sFaceReactionSets[reactionOffset as usize]) as
           libc::c_int != 0 as libc::c_int {
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx,
                                 sFaceReactionSets[reactionOffset as usize]);
        (*this).unk_2B4 = 1 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(func_80A56B40 as
                     unsafe extern "C" fn(_: *mut EnHeishi4,
                                          _: *mut GlobalContext) -> ())
    } else {
        if gSaveContext.eventChkInf[8 as libc::c_int as usize] as libc::c_int
               & 1 as libc::c_int != 0 {
            (*this).actor.textId = 0x5065 as libc::c_int as u16_0;
            (*this).actionFunc =
                Some(func_80A56B40 as
                         unsafe extern "C" fn(_: *mut EnHeishi4,
                                              _: *mut GlobalContext) -> ());
        ...
        if gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int
            ...
            (*this).actor.textId = 0x5068 as libc::c_int as u16_0;
            (*this).actionFunc =
                Some(func_80A56B40 as
                         unsafe extern "C" fn(_: *mut EnHeishi4,
                                              _: *mut GlobalContext) -> ());
        ...
        if (*this).type_0 as libc::c_int ==
               HEISHI4_AT_IMPAS_HOUSE as libc::c_int {
            if (*this).unk_284 as libc::c_int == 0 as libc::c_int {
                (*this).actor.textId = 0x5079 as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x507a as libc::c_int as u16_0 }
        } else if gSaveContext.nightFlag == 0 as libc::c_int {
            if (*this).unk_284 as libc::c_int == 0 as libc::c_int {
                (*this).actor.textId = 0x5063 as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x5064 as libc::c_int as u16_0 }
        } else if (*this).unk_284 as libc::c_int == 0 as libc::c_int {
            (*this).actor.textId = 0x5066 as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x5067 as libc::c_int as u16_0 }
        (*this).actionFunc =
            Some(func_80A56B40 as
                     unsafe extern "C" fn(_: *mut EnHeishi4,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80A56544(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    ...
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8e\xe3\x82\x83\xe3\x81\x81\xef\xbc\x81\xe3\x82\xaa\xe3\x83\x88\xe3\x83\x8a\xe3\x81\xa0\xe3\x83\xbc \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Actor_Kill(&mut (*this).actor);
    } else {
        (*this).actionFunc =
            Some(func_80A56614 as
                     unsafe extern "C" fn(_: *mut EnHeishi4,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A56614(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut reactionOffset: s16 = 0;
    reactionOffset =
        ((*this).type_0 as libc::c_int - 4 as libc::c_int) as s16;
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_MIHARIGOYA as libc::c_int
       {
        if gSaveContext.nightFlag == 0 as libc::c_int {
            (*this).actor.textId = 0x7004 as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x709a as libc::c_int as u16_0 }
    } else if (*globalCtx).sceneNum as libc::c_int !=
                  SCENE_MARKET_NIGHT as libc::c_int {
        if gSaveContext.nightFlag == 0 as libc::c_int {
            (*this).actor.textId = 0x7002 as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x7003 as libc::c_int as u16_0 }
    } else { (*this).actor.textId = 0x7003 as libc::c_int as u16_0 }
    (*this).actionFunc =
        Some(func_80A56B40 as
                 unsafe extern "C" fn(_: *mut EnHeishi4,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A5673C(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    if gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int &
           0x20 as libc::c_int != 0 {
        osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x9e\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xbc\xe3\x82\xbd\xe3\x83\xbc\xe3\x83\x89\xe7\xa5\x9d\xe5\x85\xa5\xe6\x89\x8b\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).unk_284 = 0 as libc::c_int as s16;
    if gSaveContext.eventChkInf[8 as libc::c_int as usize] as libc::c_int &
           1 as libc::c_int != 0 {
        if gSaveContext.infTable[6 as libc::c_int as usize] as libc::c_int &
               0x1000 as libc::c_int == 0 {
            let mut frames: f32_0 =
                Animation_GetLastFrame(&mut gEnHeishiDyingGuardAnim_00C444 as
                                           *mut AnimationHeader as
                                           *mut libc::c_void) as f32_0;
            Animation_Change(&mut (*this).skelAnime,
                             &mut gEnHeishiDyingGuardAnim_00C444, 1.0f32,
                             0.0f32, frames as s16 as f32_0,
                             ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
            (*this).actor.textId = 0x7007 as libc::c_int as u16_0;
            (*this).unk_282 = TEXT_STATE_EVENT as libc::c_int as s16;
            (*this).unk_284 = 1 as libc::c_int as s16;
            osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x87\xe3\x83\xa2\xe9\x96\x8b\xe5\xa7\x8b\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        } else {
            (*this).actor.textId = 0x7008 as libc::c_int as u16_0;
            (*this).unk_282 = TEXT_STATE_DONE as libc::c_int as s16;
            osSyncPrintf(b"\x1b[34m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xbf\x94\xe4\xba\x8b\xe3\x81\xaa\xe3\x81\x97 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        }
        (*this).actionFunc =
            Some(func_80A56874 as
                     unsafe extern "C" fn(_: *mut EnHeishi4,
                                          _: *mut GlobalContext) -> ())
    } else { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A56874(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_284 as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A56900(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiDyingGuardTalkAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiDyingGuardTalkAnim,
                     1.0f32, 0.0f32, frames as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A56994 as
                 unsafe extern "C" fn(_: *mut EnHeishi4,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A56994(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_260,
                  &mut (*this).unk_266, (*this).actor.focus.pos);
    if (*this).unk_282 as libc::c_int ==
        ...
        gSaveContext.infTable[6 as libc::c_int as usize] =
            (gSaveContext.infTable[6 as libc::c_int as usize] as libc::c_int |
                 0x1000 as libc::c_int) as u16_0;
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        (*this).actionFunc =
            Some(func_80A56A50 as
                     unsafe extern "C" fn(_: *mut EnHeishi4,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A56A50(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiDyingGuardDieAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_288 = frames;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiDyingGuardDieAnim,
                     1.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A56ACC as
                 unsafe extern "C" fn(_: *mut EnHeishi4,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A56ACC(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A56B40(mut this: *mut EnHeishi4,
                                       mut globalCtx: *mut GlobalContext) {
    let mut reactionOffset: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    reactionOffset =
    ...
    if Text_GetFaceReaction(globalCtx,
                            sFaceReactionSets[reactionOffset as usize]) as
           libc::c_int != 0 as libc::c_int {
        if (*this).unk_2B4 as libc::c_int == 0 as libc::c_int {
            if (*this).type_0 as libc::c_int ==
                   HEISHI4_AT_KAKRIKO_ENTRANCE as libc::c_int ||
                   (*this).type_0 as libc::c_int ==
                       HEISHI4_AT_IMPAS_HOUSE as libc::c_int {
                (*this).actionFunc =
                    Some(func_80A563BC as
            ...
            if (*this).type_0 as libc::c_int ==
                   HEISHI4_AT_MARKET_NIGHT as libc::c_int {
                (*this).actionFunc =
                    Some(func_80A56614 as
                             unsafe extern "C" fn(_: *mut EnHeishi4,
                                                  _: *mut GlobalContext)
    ...
    } else if (*this).unk_2B4 as libc::c_int != 0 as libc::c_int {
        if (*this).type_0 as libc::c_int ==
               HEISHI4_AT_KAKRIKO_ENTRANCE as libc::c_int ||
               (*this).type_0 as libc::c_int ==
                   HEISHI4_AT_IMPAS_HOUSE as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi4_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi4 = thisx as *mut EnHeishi4;
    let mut pad: s32 = 0;
    ...
    if (*this).type_0 as libc::c_int != HEISHI4_AT_MARKET_DYING as libc::c_int
       {
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            (*this).unk_28C.unk_18.y = (*player).actor.world.pos.y - 10.0f32
        }
        func_80034A14(thisx, &mut (*this).unk_28C, 2 as libc::c_int as s16,
                      4 as libc::c_int as s16);
        (*this).unk_260 = (*this).unk_28C.unk_08;
        (*this).unk_266 = (*this).unk_28C.unk_0E
    }
    (*this).unk_27E =
        ((*this).unk_27E as libc::c_int + 1 as libc::c_int) as s16;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_MoveForward(thisx);
    Actor_UpdateBgCheckInfo(globalCtx, thisx, 10.0f32, 10.0f32, 30.0f32,
                            0x1d as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi_OverrideLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 9 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_266.y as libc::c_int) as
                s16
    }
    if limbIndex == 16 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_260.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_260.z as libc::c_int) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi4_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi4 = thisx as *mut EnHeishi4;
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnHeishi_OverrideLimbDraw as
