...
extern "C" {
    ...
    #[no_mangle]
    fn Camera_GetCamDirPitch(camera: *mut Camera) -> s16;
    #[no_mangle]
...
#[no_mangle]
pub static mut Magic_Dark_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_MAGIC_DARK as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(MagicDark_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(MagicDark_OrbUpdate
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(MagicDark_OrbDraw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDiamondTex: [u64_0; 256] =
     ...
     Vtx{v:
             {
                 let mut init =
                     Vtx_t{ob:
                           ...
                           flag: 0 as libc::c_int as libc::c_ushort,
                           tc:
                               [4437 as libc::c_int as libc::c_short,
                                512 as libc::c_int as libc::c_short],
                           cn:
...
static mut sDiamondMaterialDL: [Gfx; 22] =
    [Gfx{words: Gwords{w0: 0, w1: 0,},}; 22];
// Initialized in run_static_initializers
static mut sDiamondModelDL: [Gfx; 8] =
    [Gfx{words: Gwords{w0: 0, w1: 0,},}; 8];
#[no_mangle]
pub unsafe extern "C" fn MagicDark_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut MagicDark = thisx as *mut MagicDark;
    ...
    if gSaveContext.nayrusLoveTimer as libc::c_int != 0 as libc::c_int {
        (*thisx).update =
            Some(MagicDark_DiamondUpdate as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*thisx).draw =
            Some(MagicDark_DiamondDraw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*thisx).scale.z = (*this).scale * 1.6f32;
        (*thisx).scale.x = (*thisx).scale.z;
        (*thisx).scale.y = (*this).scale * 0.8f32;
        (*this).timer = 0 as libc::c_int as s16;
        (*this).primAlpha = 0 as libc::c_int as u8_0
    } else {
        (*this).timer = 0 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn MagicDark_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if gSaveContext.nayrusLoveTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn MagicDark_DiamondUpdate(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut MagicDark = thisx as *mut MagicDark;
    let mut phi_a0: u8_0 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut pad: s16 = 0;
    let mut nayrusLoveTimer: s16 = gSaveContext.nayrusLoveTimer;
    let mut msgMode: s32 = (*globalCtx).msgCtx.msgMode as s32;
    if msgMode == MSGMODE_OCARINA_CORRECT_PLAYBACK as libc::c_int ||
           msgMode == MSGMODE_SONG_PLAYED as libc::c_int {
        Actor_Kill(thisx);
        return
    }
    if nayrusLoveTimer as libc::c_int >= 1200 as libc::c_int {
        (*player).invincibilityTimer = 0 as libc::c_int as s8;
        gSaveContext.nayrusLoveTimer = 0 as libc::c_int as s16;
        Actor_Kill(thisx);
        return
    }
    (*player).invincibilityTimer = -(100 as libc::c_int) as s8;
    (*thisx).scale.z = (*this).scale;
    (*thisx).scale.x = (*thisx).scale.z;
    if ((*this).timer as libc::c_int) < 20 as libc::c_int {
        (*thisx).scale.z =
            (1.6f32 - (*this).timer as libc::c_int as libc::c_float * 0.03f32)
                * (*this).scale;
        (*thisx).scale.x = (*thisx).scale.z;
        (*thisx).scale.y =
            ((*this).timer as libc::c_int as libc::c_float * 0.01f32 + 0.8f32)
                * (*this).scale
    } else {
        (*thisx).scale.z = (*this).scale;
        (*thisx).scale.x = (*thisx).scale.z;
    ...
    (*thisx).scale.x *= 1.3f32;
    (*thisx).scale.z *= 1.3f32;
    phi_a0 =
        if ((*this).timer as libc::c_int) < 20 as libc::c_int {
            ((*this).timer as libc::c_int) * 12 as libc::c_int
        } else { 255 as libc::c_int } as u8_0;
    if nayrusLoveTimer as libc::c_int >= 1180 as libc::c_int {
        (*this).primAlpha =
            (15595 as libc::c_int -
                 nayrusLoveTimer as libc::c_int * 13 as libc::c_int) as u8_0;
        if nayrusLoveTimer as libc::c_int & 1 as libc::c_int != 0 {
            (*this).primAlpha =
                ((*this).primAlpha as libc::c_int >> 1 as libc::c_int) as u8_0
        }
    } else if nayrusLoveTimer as libc::c_int >= 1100 as libc::c_int {
        (*this).primAlpha =
            (((nayrusLoveTimer as libc::c_int) << 7 as libc::c_int) as u8_0 as
                 libc::c_int + 127 as libc::c_int) as u8_0
    } else { (*this).primAlpha = 255 as libc::c_int as u8_0 }
    if (*this).primAlpha as libc::c_int > phi_a0 as libc::c_int {
        (*this).primAlpha = phi_a0
    }
    (*thisx).world.rot.y =
        ((*thisx).world.rot.y as libc::c_int + 0x3e8 as libc::c_int) as s16;
    (*thisx).shape.rot.y =
    ...
    gSaveContext.nayrusLoveTimer =
        (nayrusLoveTimer as libc::c_int + 1 as libc::c_int) as s16;
    if (nayrusLoveTimer as libc::c_int) < 1100 as libc::c_int {
        func_8002F974(thisx,
                      (0x87c as libc::c_int - 0x800 as libc::c_int) as u16_0);
    } else {
        func_8002F974(thisx,
                      (0x8c0 as libc::c_int - 0x800 as libc::c_int) as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn MagicDark_DimLighting(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut intensity: f32_0) {
    let mut i: s32 = 0;
    let mut colorScale: f32_0 = 0.;
    let mut fogScale: f32_0 = 0.;
    if (*globalCtx).roomCtx.curRoom.unk_03 as libc::c_int != 5 as libc::c_int
       {
        intensity = if intensity < 0.0f32 { 0.0f32 } else { intensity };
        intensity = if intensity > 1.0f32 { 1.0f32 } else { intensity };
        fogScale = intensity - 0.2f32;
        if intensity < 0.2f32 { fogScale = 0.0f32 }
        (*globalCtx).envCtx.adjFogNear =
            ((850.0f32 -
                  (*globalCtx).envCtx.lightSettings.fogNear as libc::c_int as
                      libc::c_float) * fogScale) as s16;
        if intensity == 0.0f32 {
            i = 0 as libc::c_int;
            while i <
            ...
            colorScale = intensity * 5.0f32;
            if colorScale > 1.0f32 { colorScale = 1.0f32 }
            i = 0 as libc::c_int;
            while i <
                      (::std::mem::size_of::<[s16; 3]>() as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>()
                ...
                (*globalCtx).envCtx.adjFogColor[i as usize] =
                    -(((*globalCtx).envCtx.lightSettings.fogColor[i as usize]
                           as libc::c_int as libc::c_float * colorScale) as
...
#[no_mangle]
pub unsafe extern "C" fn MagicDark_OrbUpdate(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut MagicDark = thisx as *mut MagicDark;
    let mut pad: s32 = 0;
    ...
    func_8002F974(&mut (*this).actor,
                  (0x8c3 as libc::c_int - 0x800 as libc::c_int) as u16_0);
    if ((*this).timer as libc::c_int) < 35 as libc::c_int {
        MagicDark_DimLighting(globalCtx,
                              (*this).timer as libc::c_int as libc::c_float *
                                  (1 as libc::c_int as libc::c_float /
                                       45.0f32));
        Math_SmoothStepToF(&mut (*thisx).scale.x,
                           (*this).scale *
                               (1 as libc::c_int as libc::c_float /
                                    12.000001f32), 0.05f32, 0.01f32,
                           0.0001f32);
        Actor_SetScale(&mut (*this).actor, (*thisx).scale.x);
    } else if ((*this).timer as libc::c_int) < 55 as libc::c_int {
        Actor_SetScale(&mut (*this).actor, (*thisx).scale.x * 0.9f32);
        Math_SmoothStepToF(&mut (*this).orbOffset.y,
                           (*player).bodyPartsPos[0 as libc::c_int as
                                                      usize].y, 0.5f32,
                           3.0f32, 1.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn MagicDark_DiamondDraw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut MagicDark = thisx as *mut MagicDark;
    let mut pad: s32 = 0;
    let mut gameplayFrames: u16_0 = (*globalCtx).gameplayFrames as u16_0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_magic_dark.c\x00" as *const u8 as
                        *const libc::c_char, 525 as libc::c_int);
    ...
    heightDiff =
        (*player).bodyPartsPos[0 as libc::c_int as usize].y -
            (*this).actor.world.pos.y;
    if heightDiff < -2.0f32 {
        (*this).actor.world.pos.y =
            (*player).bodyPartsPos[0 as libc::c_int as usize].y + 2.0f32
    } else if heightDiff > 2.0f32 {
        (*this).actor.world.pos.y =
            (*player).bodyPartsPos[0 as libc::c_int as usize].y - 2.0f32
    }
    ...
    (*_g_0).words.w1 =
        (170 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((((*this).primAlpha as libc::c_int as libc::c_float * 0.6f32) as
                  s32 & 0xff as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = sDiamondMaterialDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_3).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (gameplayFrames as libc::c_int * 2 as libc::c_int) as
                             u32_0,
                         (gameplayFrames as libc::c_int * -(4 as libc::c_int))
                             as u32_0, 32 as libc::c_int, 32 as libc::c_int,
                         1 as libc::c_int, 0 as libc::c_int as u32_0,
                         (gameplayFrames as libc::c_int *
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = sDiamondModelDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_magic_dark.c\x00" as *const u8 as
                         *const libc::c_char, 570 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn MagicDark_OrbDraw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut MagicDark = thisx as *mut MagicDark;
    ...
    let mut pad: s32 = 0;
    let mut sp6C: f32_0 =
        ((*globalCtx).state.frames & 0x1f as libc::c_int as libc::c_uint) as
            f32_0;
    if ((*this).timer as libc::c_int) < 32 as libc::c_int {
        pos.x =
            ((*player).bodyPartsPos[12 as libc::c_int as usize].x +
                 (*player).bodyPartsPos[15 as libc::c_int as usize].x) *
                0.5f32;
        pos.y =
            ((*player).bodyPartsPos[12 as libc::c_int as usize].y +
                 (*player).bodyPartsPos[15 as libc::c_int as usize].y) *
                0.5f32;
        pos.z =
            ((*player).bodyPartsPos[12 as libc::c_int as usize].z +
                 (*player).bodyPartsPos[15 as libc::c_int as usize].z) *
                0.5f32;
        if (*this).timer as libc::c_int > 20 as libc::c_int {
            pos.y +=
        ...
        (*this).orbOffset = pos
    } else if ((*this).timer as libc::c_int) < 130 as libc::c_int {
        pos = (*this).orbOffset
    } else { return }
    pos.x -=
        (*this).actor.scale.x * 300.0f32 *
            Math_SinS(Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                      as
                                                                      usize]))
            *
            Math_CosS(Camera_GetCamDirPitch((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                        as
                                                                        usize]));
    pos.y -=
        (*this).actor.scale.x * 300.0f32 *
            Math_SinS(Camera_GetCamDirPitch((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                        as
                                                                        usize]));
    pos.z -=
        (*this).actor.scale.x * 300.0f32 *
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_magic_dark.c\x00" as *const u8 as
                        *const libc::c_char, 619 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
