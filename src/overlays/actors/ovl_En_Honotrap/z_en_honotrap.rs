...
extern "C" {
    ...
    fn Graph_CloseDisps(dispRefs: *mut *mut Gfx, gfxCtx: *mut GraphicsContext,
                        file: *const libc::c_char, line: s32);
    #[no_mangle]
    fn Math3D_Vec3fReflect(vec: *mut Vec3f, normal: *mut Vec3f,
                           reflVec: *mut Vec3f);
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHonotrap {
    pub actor: Actor,
    pub actionFunc: EnHonotrapActionFunc,
    pub collider: EnHonotrapCollider,
    pub timer: s16,
    pub eyeState: s16,
    pub targetPos: Vec3f,
    pub speedMod: f32_0,
    pub bobPhase: s16,
    pub flameScroll: s16,
    pub colChkFlags: u8_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union EnHonotrapCollider {
    pub c2rust_unnamed: C2RustUnnamed_22,
    pub cyl: ColliderCylinder,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct C2RustUnnamed_22 {
    pub tris: ColliderTris,
    pub elements: [ColliderTrisElement; 2],
}
pub type EnHonotrapActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHonotrap, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const HONOTRAP_FLAME_DROP: C2RustUnnamed_23 = 2;
pub const HONOTRAP_FLAME_MOVE: C2RustUnnamed_23 = 1;
pub const HONOTRAP_EYE: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const HONOTRAP_EYE_SHUT: C2RustUnnamed_24 = 3;
pub const HONOTRAP_EYE_CLOSE: C2RustUnnamed_24 = 2;
pub const HONOTRAP_EYE_HALF: C2RustUnnamed_24 = 1;
pub const HONOTRAP_EYE_OPEN: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut En_Honotrap_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HONOTRAP as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHonotrap_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHonotrap_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHonotrap_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHonotrap_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 0 as libc::c_int as u8_0,
                                   ...
                                   cylHeight: 23 as libc::c_int as s16,
                                   mass: 1 as libc::c_int as u8_0,};
        init
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_GetNormal(mut normal: *mut Vec3f,
                                              mut vec: *mut Vec3f) {
    let mut mag: f32_0 = Math3D_Vec3fMagnitude(vec);
    if mag < 0.001f32 {
        osSyncPrintf(b"Warning : vector size zero (%s %d)\n\x00" as *const u8
                         as *const libc::c_char,
                     b"../z_en_honotrap.c\x00" as *const u8 as
                         *const libc::c_char, 328 as libc::c_int, normal);
        (*normal).y = 0.0f32;
        (*normal).x = (*normal).y;
        (*normal).z = 1.0f32
    } else {
        (*normal).x = (*vec).x * (1.0f32 / mag);
        (*normal).y = (*vec).y * (1.0f32 / mag);
        (*normal).z = (*vec).z * (1.0f32 / mag)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_InitEye(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHonotrap = thisx as *mut EnHonotrap;
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut vtx: *mut Vec3f = 0 as *mut Vec3f;
    let mut triangle: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    Actor_SetScale(thisx, 0.1f32);
    sin = Math_SinS((*thisx).home.rot.y);
    cos = Math_CosS((*thisx).home.rot.y);
    Collider_InitTris(globalCtx, &mut (*this).collider.c2rust_unnamed.tris);
    Collider_SetTris(globalCtx, &mut (*this).collider.c2rust_unnamed.tris,
                     thisx, &mut sTrisInit,
                     (*this).collider.c2rust_unnamed.elements.as_mut_ptr());
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        j = 0 as libc::c_int;
        vtx = triangle.as_mut_ptr();
        while j < 3 as libc::c_int {
            let mut baseVtx: *mut Vec3f =
                &mut *(*sTrisInit.elements.offset(i as
            ...
            Math_Vec3f_Sum(vtx, &mut (*thisx).world.pos, vtx);
            j += 1;
            vtx = vtx.offset(1)
        }
        Collider_SetTrisVertices(&mut (*this).collider.c2rust_unnamed.tris, i,
                                 &mut *triangle.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                 &mut *triangle.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                 &mut *triangle.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
        i += 1
    ...
    Actor_SetFocus(thisx, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_InitFlame(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHonotrap = thisx as *mut EnHonotrap;
    Actor_SetScale(&mut (*this).actor, 0.0001f32);
    Collider_InitCylinder(globalCtx, &mut (*this).collider.cyl);
    Collider_SetCylinder(globalCtx, &mut (*this).collider.cyl,
                         &mut (*this).actor, &mut sCylinderInit);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider.cyl);
    (*this).actor.minVelocityY = -1.0f32;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).actor.shape.shadowAlpha = 128 as libc::c_int as u8_0;
    (*this).targetPos =
        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                usize].head as
               *mut Player)).actor.world.pos;
    (*this).targetPos.y += 10.0f32;
    (*this).flameScroll = (Rand_ZeroOne() * 511.0f32) as s16;
    ...
    if (*this).actor.params as libc::c_int ==
           HONOTRAP_FLAME_DROP as libc::c_int {
        (*this).actor.room = -(1 as libc::c_int) as s8;
        (*this).collider.cyl.dim.radius = 12 as libc::c_int as s16;
        (*this).collider.cyl.dim.height = 30 as libc::c_int as s16;
        (*this).actor.shape.yOffset = -1000.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    if (*thisx).params as libc::c_int == HONOTRAP_EYE as libc::c_int {
        EnHonotrap_InitEye(thisx, globalCtx);
    } else { EnHonotrap_InitFlame(thisx, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHonotrap = thisx as *mut EnHonotrap;
    if (*this).actor.params as libc::c_int == HONOTRAP_EYE as libc::c_int {
        Collider_DestroyTris(globalCtx,
                             &mut (*this).collider.c2rust_unnamed.tris);
    } else {
        Collider_DestroyCylinder(globalCtx, &mut (*this).collider.cyl);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupEyeIdle(mut this: *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_EyeIdle as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
    (*this).eyeState = HONOTRAP_EYE_SHUT as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_EyeIdle(mut this: *mut EnHonotrap,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if !(*this).actor.child.is_null() {
        (*this).timer = 200 as libc::c_int as s16
    } else if (*this).timer as libc::c_int <= 0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 750.0f32 &&
                  0.0f32 > (*this).actor.yDistToPlayer &&
                  (*this).actor.yDistToPlayer > -700.0f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupEyeOpen(mut this: *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_EyeOpen as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x2881 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_EyeOpen(mut this: *mut EnHonotrap,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    (*this).eyeState -= 1;
    if (*this).eyeState as libc::c_int <= HONOTRAP_EYE_OPEN as libc::c_int {
        EnHonotrap_SetupEyeAttack(this);
        sin = Math_SinS((*this).actor.shape.rot.y);
        cos = Math_CosS((*this).actor.shape.rot.y);
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_HONOTRAP as libc::c_int as s16,
                           sin * 12.0f32 + (*this).actor.home.pos.x,
                           (*this).actor.home.pos.y - 10.0f32,
                           cos * 12.0f32 + (*this).actor.home.pos.z,
                           (*this).actor.home.rot.x, (*this).actor.home.rot.y,
                           (*this).actor.home.rot.z,
                           HONOTRAP_FLAME_MOVE as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupEyeAttack(mut this:
                                                       *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_EyeAttack as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
    (*this).eyeState = HONOTRAP_EYE_OPEN as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_EyeAttack(mut this: *mut EnHonotrap,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupEyeClose(mut this: *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_EyeClose as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_EyeClose(mut this: *mut EnHonotrap,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).eyeState += 1;
    if (*this).eyeState as libc::c_int >= HONOTRAP_EYE_SHUT as libc::c_int {
        EnHonotrap_SetupEyeIdle(this);
        (*this).timer = 200 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupFlame(mut this: *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_Flame as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_Flame(mut this: *mut EnHonotrap,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut ready: s32 =
        Math_StepToF(&mut (*this).actor.scale.x,
                     if (*this).actor.params as libc::c_int ==
                            HONOTRAP_FLAME_MOVE as libc::c_int {
                         0.004f32
                     } else { 0.0048f32 }, 0.0006f32);
    ...
    if ready != 0 {
        ...
        } else { EnHonotrap_SetupFlameDrop(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupFlameDrop(mut this:
                                                       *mut EnHonotrap) {
    (*this).timer = 40 as libc::c_int as s16;
    (*this).actor.velocity.y = 1.0f32;
    (*this).actor.velocity.x = 2.0f32 * Math_SinS((*this).actor.world.rot.y);
    (*this).actor.velocity.z = 2.0f32 * Math_CosS((*this).actor.world.rot.y);
    (*this).actionFunc =
        Some(EnHonotrap_FlameDrop as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_FlameDrop(mut this: *mut EnHonotrap,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).collider.cyl.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).timer as libc::c_int <= 0 as libc::c_int {
        if (*this).collider.cyl.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               (*this).collider.cyl.base.atFlags as libc::c_int &
        ...
        if (*this).actor.velocity.y > 0.0f32 {
            ...
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 7.0f32,
                                    12.0f32, 0.0f32, 5 as libc::c_int);
        }
        if Math_StepToF(&mut (*this).actor.world.pos.y,
                        (*this).actor.floorHeight + 1.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupFlameMove(mut this:
                                                       *mut EnHonotrap) {
    let mut distFrac: f32_0 = 0.;
    (*this).actionFunc =
        Some(EnHonotrap_FlameMove as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
    distFrac =
        1.0f32 /
            (Actor_WorldDistXYZToPoint(&mut (*this).actor,
                                       &mut (*this).targetPos) + 1.0f32);
    (*this).actor.velocity.x =
        ((*this).targetPos.x - (*this).actor.world.pos.x) * distFrac;
    (*this).actor.velocity.y =
        ((*this).targetPos.y - (*this).actor.world.pos.y) * distFrac;
    (*this).actor.velocity.z =
        ((*this).targetPos.z - (*this).actor.world.pos.z) * distFrac;
    (*this).speedMod = 0.0f32;
    (*this).timer = 160 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_FlameMove(mut this: *mut EnHonotrap,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut speed: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut ready: s32 = 0;
    Math_StepToF(&mut (*this).speedMod, 13.0f32, 0.5f32);
    ...
    ready &=
        Math_StepToF(&mut (*this).actor.world.pos.x, (*this).targetPos.x,
                     speed.x);
    ready &=
        Math_StepToF(&mut (*this).actor.world.pos.y, (*this).targetPos.y,
                     speed.y);
    ready &=
        Math_StepToF(&mut (*this).actor.world.pos.z, (*this).targetPos.z,
                     speed.z);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 7.0f32, 10.0f32,
                            0.0f32, 0x1d as libc::c_int);
    if (*this).collider.c2rust_unnamed.tris.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 2 as libc::c_int != 0 {
        let mut player: *mut Player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        let mut shieldNorm: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut tempVel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut shieldVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        shieldVec.x = -(*player).shieldMf.c2rust_unnamed.xz;
        shieldVec.y = -(*player).shieldMf.c2rust_unnamed.yz;
        shieldVec.z = -(*player).shieldMf.c2rust_unnamed.zz;
        EnHonotrap_GetNormal(&mut shieldNorm, &mut shieldVec);
        tempVel = (*this).actor.velocity;
        Math3D_Vec3fReflect(&mut tempVel, &mut shieldNorm,
                            &mut (*this).actor.velocity);
        (*this).actor.speedXZ = (*this).speedMod * 0.5f32;
        (*this).actor.world.rot.y =
            Math_Atan2S((*this).actor.velocity.z, (*this).actor.velocity.x);
        EnHonotrap_SetupFlameVanish(this);
    } else if (*this).collider.c2rust_unnamed.tris.base.atFlags as libc::c_int
                  & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        ...
        EnHonotrap_FlameCollisionCheck(this, globalCtx);
        if ready != 0 { EnHonotrap_SetupFlameChase(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupFlameChase(mut this:
                                                        *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_FlameChase as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_FlameChase(mut this: *mut EnHonotrap,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Math_StepToF(&mut (*this).actor.speedXZ, 3.0f32, 0.1f32);
    (*this).actor.gravity =
        if -(*this).actor.yDistToPlayer < 10.0f32 {
            0.08f32
        } else { -0.08f32 };
    func_8002D868(&mut (*this).actor);
    if (*this).actor.velocity.y > 1.0f32 { (*this).actor.velocity.y = 1.0f32 }
    (*this).actor.velocity.y *= 0.95f32;
    ...
    if (*this).collider.cyl.base.atFlags as libc::c_int &
        ...
        let mut player: *mut Player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        let mut shieldRot: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
        Matrix_MtxFToYXZRotS(&mut (*player).shieldMf, &mut shieldRot,
                             0 as libc::c_int);
        (*this).actor.world.rot.y =
            (shieldRot.y as libc::c_int * 2 as libc::c_int -
                 (*this).actor.world.rot.y as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        EnHonotrap_SetupFlameVanish(this);
    } else if (*this).collider.cyl.base.atFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).actor.speedXZ *= 0.1f32;
        (*this).actor.velocity.y *= 0.1f32;
        EnHonotrap_SetupFlameVanish(this);
    } else if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int !=
                  0 || (*this).timer as libc::c_int <= 0 as libc::c_int {
        EnHonotrap_SetupFlameVanish(this);
    } else { EnHonotrap_FlameCollisionCheck(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_SetupFlameVanish(mut this:
                                                         *mut EnHonotrap) {
    (*this).actionFunc =
        Some(EnHonotrap_FlameVanish as
                 unsafe extern "C" fn(_: *mut EnHonotrap,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_FlameVanish(mut this: *mut EnHonotrap,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut ready: s32 =
        Math_StepToF(&mut (*this).actor.scale.x, 0.0001f32, 0.00015f32);
    (*this).actor.scale.y = (*this).actor.scale.x;
    (*this).actor.scale.z = (*this).actor.scale.y;
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 7.0f32, 10.0f32,
                            0.0f32, 0x1d as libc::c_int);
    if ready != 0 { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    if (*this).actor.params as libc::c_int == HONOTRAP_EYE as libc::c_int {
        ...
        (*this).colChkFlags = 0 as libc::c_int as u8_0;
        (*this).bobPhase =
            ((*this).bobPhase as libc::c_int + 0x640 as libc::c_int) as s16;
        (*this).actor.shape.yOffset =
            Math_SinS((*this).bobPhase) * 1000.0f32 + 600.0f32;
        Actor_SetFocus(&mut (*this).actor, 5.0f32);
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x285b as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).actor.params as libc::c_int == HONOTRAP_EYE as libc::c_int {
        if (*this).collider.c2rust_unnamed.tris.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            EffectSsBomb2_SpawnLayered(globalCtx,
                                       &mut (*this).actor.world.pos,
                                       &mut velocity, &mut accel,
                                       15 as libc::c_int as s16,
                                       8 as libc::c_int as s16);
            Actor_Kill(&mut (*this).actor);
        } else if ((*this).eyeState as libc::c_int) <
                      HONOTRAP_EYE_SHUT as libc::c_int {
            (*this).collider.c2rust_unnamed.tris.base.acFlags =
                ((*this).collider.c2rust_unnamed.tris.base.acFlags as
                     libc::c_int & !((1 as libc::c_int) << 1 as libc::c_int))
                    as u8_0;
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).collider.c2rust_unnamed.tris.base);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_DrawEye(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gEyeSwitch2DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_honotrap.c\x00" as *const u8 as
                         *const libc::c_char, 991 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_DrawFlame(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHonotrap = thisx as *mut EnHonotrap;
    ...
    (*this).flameScroll =
        ((*this).flameScroll as libc::c_int - 20 as libc::c_int) as s16;
    (*this).flameScroll =
        ((*this).flameScroll as libc::c_int & 0x1ff as libc::c_int) as s16;
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*this).flameScroll as u32_0, 0x20 as libc::c_int,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_honotrap.c\x00" as *const u8 as
                         *const libc::c_char, 1028 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnHonotrap_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    match (*thisx).params as libc::c_int {
        0 => { EnHonotrap_DrawEye(thisx, globalCtx); }
        1 | 2 => { EnHonotrap_DrawFlame(thisx, globalCtx); }
        _ => { }
    };
}
