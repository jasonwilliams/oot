...
extern "C" {
    ...
    #[no_mangle]
    fn func_8004356C(dynaActor: *mut DynaPolyActor) -> s32;
    #[no_mangle]
    fn func_80043590(dynaActor: *mut DynaPolyActor) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gMagicBeanSeedlingDL: [Gfx; 0];
    #[no_mangle]
    static mut gMagicBeanStemDL: [Gfx; 0];
    #[no_mangle]
    static mut gMagicBeanPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gMagicBeanPlatformCol: CollisionHeader;
    #[no_mangle]
    static mut gMagicBeanSoftSoilDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuttableShrubStalkDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuttableShrubTipDL: [Gfx; 0];
}
...
pub const DPM_UNK3: C2RustUnnamed_25 = 3;
pub const DPM_ENEMY: C2RustUnnamed_25 = 2;
pub const DPM_PLAYER: C2RustUnnamed_25 = 1;
pub const DPM_UNK: C2RustUnnamed_25 = 0;
...
pub struct ObjBean {
    ...
    pub actionFunc: ObjBeanActionFunc,
    pub collider: ColliderCylinder,
    pub timer: s16,
    pub unk_1B6: Vec3s,
    pub transformFunc: ObjBeanTransformFunc,
    pub unk_1C0: s16,
    pub unk_1C2: s16,
    pub unk_1C4: s16,
    pub unk_1C6: s16,
    ...
    pub unk_1CC: s16,
    pub unk_1CE: s16,
    pub leafRotFactor: s16,
    pub unk_1D2: u16_0,
    pub stalkSizeMultiplier: f32_0,
    pub pathPoints: Vec3f,
    pub unk_1E4: f32_0,
    pub posOffsetX: f32_0,
    pub posOffsetZ: f32_0,
    pub pathCount: s16,
    pub currentPointIndex: s16,
    pub nextPointIndex: s16,
    pub unk_1F6: u8_0,
    pub stateFlags: u8_0,
}
pub type ObjBeanTransformFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjBean) -> ()>;
pub type ObjBeanActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BeenSpeedInfo {
    pub velocity: f32_0,
    pub accel: f32_0,
}
static mut D_80B90E30: *mut ObjBean = 0 as *const ObjBean as *mut ObjBean;
#[no_mangle]
pub static mut Obj_Bean_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_BEAN as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 22 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_MAMENOKI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjBean>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBean_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBeanSpeeds: [BeenSpeedInfo; 4] =
    [{ let mut init = BeenSpeedInfo{velocity: 3.0f32, accel: 0.3f32,}; init },
     {
         let mut init = BeenSpeedInfo{velocity: 10.0f32, accel: 0.5f32,};
         init
     },
     {
         let mut init = BeenSpeedInfo{velocity: 30.0f32, accel: 0.5f32,};
         init
     },
     {
         let mut init = BeenSpeedInfo{velocity: 3.0f32, accel: 0.3f32,};
         init
     }];
static mut sBreakDlists: [*mut Gfx; 2] =
    unsafe {
        [gCuttableShrubStalkDL.as_ptr() as *mut _,
         gCuttableShrubTipDL.as_ptr() as *mut _]
    };
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn ObjBean_InitCollider(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut ObjBean = thisx as *mut ObjBean;
    ...
    Collider_UpdateCylinder(&mut (*this).dyna.actor, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_InitDynaPoly(mut this: *mut ObjBean,
                                              mut globalCtx:
                                                  *mut GlobalContext,
                                              mut collision:
                                                  *mut CollisionHeader,
    ...
    DynaPolyActor_Init(&mut (*this).dyna, moveFlag);
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_bean.c\x00" as *const u8 as
                         *const libc::c_char, 374 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_FindFloor(mut this: *mut ObjBean,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp20: s32 = 0;
    vec.x = (*this).dyna.actor.world.pos.x;
    vec.y = (*this).dyna.actor.world.pos.y + 29.999998f32;
    vec.z = (*this).dyna.actor.world.pos.z;
    (*this).dyna.actor.floorHeight =
        BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                    &mut (*this).dyna.actor.floorPoly,
                                    &mut sp20, &mut (*this).dyna.actor,
                                    &mut vec);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8EBC8(mut this: *mut ObjBean) {
    (*this).unk_1B6.z = 0 as libc::c_int as s16;
    (*this).unk_1B6.y = (*this).unk_1B6.z;
    (*this).unk_1B6.x = (*this).unk_1B6.y;
    (*this).unk_1E4 = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_UpdatePosition(mut this: *mut ObjBean) {
    let mut temp_f20: f32_0 = 0.;
    (*this).unk_1B6.x =
        ((*this).unk_1B6.x as libc::c_int + 0xb6 as libc::c_int) as s16;
    (*this).unk_1B6.y =
        ((*this).unk_1B6.y as libc::c_int + 0xfb as libc::c_int) as s16;
    (*this).unk_1B6.z =
        ((*this).unk_1B6.z as libc::c_int + 0x64 as libc::c_int) as s16;
    Math_StepToF(&mut (*this).unk_1E4, 2.0f32, 0.1f32);
    temp_f20 =
        Math_SinS(((*this).unk_1B6.x as libc::c_int * 3 as libc::c_int) as
                      s16);
    (*this).posOffsetX =
        (Math_SinS(((*this).unk_1B6.y as libc::c_int * 3 as libc::c_int) as
                       s16) + temp_f20) * (*this).unk_1E4;
    temp_f20 =
        Math_CosS(((*this).unk_1B6.x as libc::c_int * 4 as libc::c_int) as
                      s16);
    (*this).posOffsetZ =
        (Math_CosS(((*this).unk_1B6.y as libc::c_int * 4 as libc::c_int) as
                       s16) + temp_f20) * (*this).unk_1E4;
    temp_f20 =
        Math_SinS(((*this).unk_1B6.z as libc::c_int * 5 as libc::c_int) as
                      s16);
    (*this).dyna.actor.scale.z =
        (Math_SinS(((*this).unk_1B6.y as libc::c_int * 8 as libc::c_int) as
                       s16) * 0.01f32 + temp_f20 * 0.06f32 + 1.07f32) *
            0.1f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
    (*this).dyna.actor.scale.y =
        (Math_CosS(((*this).unk_1B6.z as libc::c_int * 10 as libc::c_int) as
                       s16) * 0.2f32 + 1.0f32) * 0.1f32;
    temp_f20 =
        Math_SinS(((*this).unk_1B6.x as libc::c_int * 3 as libc::c_int) as
                      s16);
    (*this).dyna.actor.shape.rot.y =
        (Math_SinS(((*this).unk_1B6.z as libc::c_int * 2 as libc::c_int) as
                       s16) * 2100.0f32 +
             ((*this).dyna.actor.home.rot.y as f32_0 + temp_f20 * 1000.0f32))
            as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8EDF4(mut this: *mut ObjBean) {
    (*this).unk_1B6.z = 0 as libc::c_int as s16;
    (*this).unk_1B6.y = (*this).unk_1B6.z;
    (*this).unk_1B6.x = (*this).unk_1B6.y;
    Actor_SetScale(&mut (*this).dyna.actor, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8EE24(mut this: *mut ObjBean) {
    (*this).unk_1B6.x =
        ((*this).unk_1B6.x as libc::c_int + 0x384 as libc::c_int) as s16;
    if (*this).unk_1B6.x as libc::c_int > 0x5fff as libc::c_int {
        (*this).unk_1B6.x = 0x5fff as libc::c_int as s16
    }
    (*this).unk_1B6.y =
        ((*this).unk_1B6.y as libc::c_int + 0x258 as libc::c_int) as s16;
    if (*this).unk_1B6.y as libc::c_int > 0x4000 as libc::c_int {
        (*this).unk_1B6.y = 0x4000 as libc::c_int as s16
    }
    (*this).dyna.actor.scale.y = Math_SinS((*this).unk_1B6.x) * 0.16970563f32;
    (*this).dyna.actor.scale.z = Math_SinS((*this).unk_1B6.y) * 0.10700001f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
    Math_StepToF(&mut (*this).posOffsetX, 0.0f32, 0.1f32);
    Math_StepToF(&mut (*this).posOffsetZ, 0.0f32, 0.1f32);
    Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.y,
                       (*this).dyna.actor.home.rot.y,
                       0x64 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Move(mut this: *mut ObjBean) {
    (*this).dyna.actor.world.pos.x =
        (*this).pathPoints.x + (*this).posOffsetX;
    (*this).dyna.actor.world.pos.y = (*this).pathPoints.y;
    (*this).dyna.actor.world.pos.z =
        (*this).pathPoints.z + (*this).posOffsetZ;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetDrawMode(mut this: *mut ObjBean,
                                             mut drawFlag: u8_0) {
    (*this).stateFlags =
    ...
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int | drawFlag as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupPathCount(mut this: *mut ObjBean,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    (*this).pathCount =
        ((*(*globalCtx).setupPathList.offset(((*this).dyna.actor.params as
                                                  libc::c_int >>
                                                  8 as libc::c_int &
                                                  0x1f as libc::c_int) as
                                                 isize)).count as libc::c_int
             - 1 as libc::c_int) as s16;
    (*this).currentPointIndex = 0 as libc::c_int as s16;
    (*this).nextPointIndex = 1 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupPath(mut this: *mut ObjBean,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset(((*this).dyna.actor.params as
                                                     libc::c_int >>
                                                     8 as libc::c_int &
                                                     0x1f as libc::c_int) as
                                                    isize) as *mut Path;
    Math_Vec3s_ToVec3f(&mut (*this).pathPoints,
                       gSegments[(((*path).points as u32_0) <<
                                      4 as libc::c_int >> 28 as libc::c_int)
                                     as
                                     usize].wrapping_add((*path).points as
                                                             u32_0 &
                                                             0xffffff as
                                                                 libc::c_int
                                                                 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_FollowPath(mut this: *mut ObjBean,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut path: *mut Path = 0 as *mut Path;
    let mut acell: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pathPointsFloat: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut speed: f32_0 = 0.;
    let mut nextPathPoint: *mut Vec3s = 0 as *mut Vec3s;
    let mut currentPoint: *mut Vec3s = 0 as *mut Vec3s;
    let mut sp4C: *mut Vec3s = 0 as *mut Vec3s;
    let mut sp40: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp34: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp30: f32_0 = 0.;
    let mut mag: f32_0 = 0.;
    Math_StepToF(&mut (*this).dyna.actor.speedXZ,
                 sBeanSpeeds[(*this).unk_1F6 as usize].velocity,
                 sBeanSpeeds[(*this).unk_1F6 as usize].accel);
    path =
        &mut *(*globalCtx).setupPathList.offset(((*this).dyna.actor.params as
                                                     libc::c_int >>
                                                     8 as libc::c_int &
                                                    ...
                                                    isize) as *mut Path;
    nextPathPoint =
        &mut *((*gSegments.as_mut_ptr().offset((((*path).points as u32_0) <<
                                                    4 as libc::c_int >>
                                                    28 as libc::c_int) as
                                                   isize)).wrapping_add((*path).points
                                                                            as
                                                                            u32_0
                                                                            &
                                                                            0xffffff
                   ...
                   *mut Vec3s).offset((*this).nextPointIndex as isize) as
            *mut Vec3s;
    Math_Vec3s_ToVec3f(&mut pathPointsFloat, nextPathPoint);
    Math_Vec3f_Diff(&mut pathPointsFloat, &mut (*this).pathPoints,
                    &mut acell);
    mag = Math3D_Vec3fMagnitude(&mut acell);
    speed =
        if (*this).dyna.actor.speedXZ < 0.5f32 {
            0.5f32
        } else { (*this).dyna.actor.speedXZ };
    if speed > mag {
        currentPoint =
            &mut *((*gSegments.as_mut_ptr().offset((((*path).points as u32_0)
                                                        << 4 as libc::c_int >>
                                                       ...
                                                       isize)).wrapping_add((*path).points
                                                                                ...
                                                                                0xffffff
                                                                                    ...
                                                                                    libc::c_uint).wrapping_add(0x80000000
                                                                                                                   ...
                                                                                                                   libc::c_uint)
                       as *mut libc::c_void as
                       *mut Vec3s).offset((*this).currentPointIndex as isize)
                as *mut Vec3s;
        Math_Vec3f_Copy(&mut (*this).pathPoints, &mut pathPointsFloat);
        (*this).currentPointIndex = (*this).nextPointIndex;
        if (*this).pathCount as libc::c_int <=
               (*this).currentPointIndex as libc::c_int {
            (*this).nextPointIndex = 0 as libc::c_int as s16
        } else { (*this).nextPointIndex += 1 }
        sp4C =
            &mut *((*gSegments.as_mut_ptr().offset((((*path).points as u32_0)
                                                        << 4 as libc::c_int >>
                                                        28 as libc::c_int) as
                       ...
                       *mut Vec3s).offset((*this).nextPointIndex as isize) as
                *mut Vec3s;
        Math_Vec3s_DiffToVec3f(&mut sp40, nextPathPoint, currentPoint);
        Math_Vec3s_DiffToVec3f(&mut sp34, sp4C, nextPathPoint);
        if Math3D_CosOut(&mut sp40, &mut sp34, &mut sp30) != 0 {
            (*this).dyna.actor.speedXZ = 0.0f32
        } else { (*this).dyna.actor.speedXZ *= (sp30 + 1.0f32) * 0.5f32 }
    } else {
        Math_Vec3f_Scale(&mut acell, (*this).dyna.actor.speedXZ / mag);
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_CheckForHorseTrample(mut this: *mut ObjBean,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
    let mut currentActor: *mut Actor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_BG as libc::c_int as
                                             usize].head;
    while !currentActor.is_null() {
        if (*currentActor).id as libc::c_int == ACTOR_EN_HORSE as libc::c_int
               &&
               Math3D_Vec3fDistSq(&mut (*currentActor).world.pos,
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Break(mut this: *mut ObjBean,
    ...
    let mut scale: s32 = 0;
    let mut i: s32 = 0;
    let mut gravity: s16 = 0;
    let mut arg5: s16 = 0;
    angle = 0 as libc::c_int as s16;
    i = 0 as libc::c_int;
    while i < 36 as libc::c_int {
        angle = (angle as libc::c_int + 0x4e20 as libc::c_int) as s16;
        temp_f20 = Rand_ZeroOne() * 60.0f32;
        ...
        velocity.x = Math_SinS(angle) * 3.5f32;
        velocity.y = Rand_ZeroOne() * 13.0f32;
        velocity.z = Math_CosS(angle) * 3.5f32;
        velocity.x +=
            (*this).dyna.actor.world.pos.x - (*this).dyna.actor.prevPos.x;
        velocity.y +=
            (*this).dyna.actor.world.pos.y - (*this).dyna.actor.prevPos.y;
        velocity.z +=
            (*this).dyna.actor.world.pos.z - (*this).dyna.actor.prevPos.z;
        scale = (Rand_ZeroOne() * 180.0f32) as s32 + 30 as libc::c_int;
        if scale < 90 as libc::c_int {
            if Rand_ZeroOne() < 0.1f32 {
                gravity = -(80 as libc::c_int) as s16;
                arg5 = 96 as libc::c_int as s16
            } else {
                gravity = -(80 as libc::c_int) as s16;
                arg5 = 64 as libc::c_int as s16
            }
        } else {
            gravity = -(100 as libc::c_int) as s16;
            arg5 = 64 as libc::c_int as s16
        }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             gravity, arg5, 40 as libc::c_int as s16,
                             3 as libc::c_int as s16, 0 as libc::c_int as s16,
                             scale as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             ((scale >> 3 as libc::c_int) + 40 as libc::c_int)
                                 as s16 as s32, -(1 as libc::c_int) as s16,
                             1 as libc::c_int as s16,
                             sBreakDlists[(i & 1 as libc::c_int) as usize]);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_UpdateLeaves(mut this: *mut ObjBean) {
    Math_StepToS(&mut (*this).unk_1C2, (*this).unk_1C4, (*this).unk_1C6);
    Math_StepToS(&mut (*this).unk_1C8, (*this).unk_1CA, (*this).unk_1CC);
    (*this).unk_1CE =
        ((*this).unk_1CE as libc::c_int + (*this).unk_1C8 as libc::c_int) as
            s16;
    (*this).leafRotFactor =
        (6372.0f32 - Math_SinS((*this).unk_1CE) * (*this).unk_1C2 as f32_0) as
            s16;
    (*this).dyna.actor.scale.y =
        Math_SinS((*this).leafRotFactor) * 0.17434467f32;
    (*this).dyna.actor.scale.z =
        Math_CosS((*this).leafRotFactor) * 0.12207746f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupLeavesStill(mut this: *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_LeavesStill as
                 unsafe extern "C" fn(_: *mut ObjBean) -> ());
    (*this).unk_1C0 =
        Rand_S16Offset(12 as libc::c_int as s16, 40 as libc::c_int as s16);
    (*this).unk_1C4 =
        Rand_S16Offset(0xc8 as libc::c_int as s16,
                       0x190 as libc::c_int as s16);
    (*this).unk_1C6 = 0x14 as libc::c_int as s16;
    (*this).unk_1CA =
        Rand_S16Offset(0x64 as libc::c_int as s16,
                       0x320 as libc::c_int as s16);
    (*this).unk_1CC = 0x14 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_LeavesStill(mut this: *mut ObjBean) {
    (*this).unk_1C0 -= 1;
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupShakeLeaves(mut this: *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_ShakeLeaves as
                 unsafe extern "C" fn(_: *mut ObjBean) -> ());
    (*this).unk_1C0 =
        Rand_S16Offset(30 as libc::c_int as s16, 4 as libc::c_int as s16);
    (*this).unk_1C4 =
        Rand_S16Offset(0x7d0 as libc::c_int as s16,
                       0x3e8 as libc::c_int as s16);
    (*this).unk_1C6 = 0xc8 as libc::c_int as s16;
    (*this).unk_1CA =
        Rand_S16Offset(0x36b0 as libc::c_int as s16,
                       0x1770 as libc::c_int as s16);
    (*this).unk_1CC = 0xfa0 as libc::c_int as s16;
    (*this).leafRotFactor = 0x18e4 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_ShakeLeaves(mut this: *mut ObjBean) {
    (*this).unk_1C0 =
        ((*this).unk_1C0 as libc::c_int + -(1 as libc::c_int)) as s16;
    if (*this).unk_1C0 as libc::c_int == 14 as libc::c_int {
        (*this).unk_1C4 =
            Rand_S16Offset(0xc8 as libc::c_int as s16,
                           0x190 as libc::c_int as s16);
        (*this).unk_1CA =
        ...
        (*this).unk_1CC = 0x7d0 as libc::c_int as s16
    }
    ObjBean_UpdateLeaves(this);
    if ((*this).unk_1C0 as libc::c_int) < 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupShakeLeavesFast(mut this:
                                                          *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_ShakeLeavesFast as
                 unsafe extern "C" fn(_: *mut ObjBean) -> ());
    (*this).unk_1C0 = 0x28 as libc::c_int as s16;
    (*this).unk_1C4 = 0xbb8 as libc::c_int as s16;
    (*this).unk_1C6 = 0x12c as libc::c_int as s16;
    (*this).unk_1CA = 0x3a98 as libc::c_int as s16;
    (*this).unk_1CC = 0xfa0 as libc::c_int as s16;
    (*this).leafRotFactor = 0x18e4 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_ShakeLeavesFast(mut this: *mut ObjBean) {
    (*this).unk_1C0 =
        ((*this).unk_1C0 as libc::c_int + -(1 as libc::c_int)) as s16;
    if Rand_ZeroOne() < 0.1f32 {
        (*this).unk_1C4 =
            Rand_S16Offset(0x898 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16);
        (*this).unk_1CA =
            Rand_S16Offset(0x2ee0 as libc::c_int as s16,
                           0x1f40 as libc::c_int as s16)
    }
    ObjBean_UpdateLeaves(this);
    if ((*this).unk_1C0 as s32) < 0 as libc::c_int {
        ObjBean_SetupGrow(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrow(mut this: *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_Grow as unsafe extern "C" fn(_: *mut ObjBean) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Grow(mut this: *mut ObjBean) {
    Math_StepToS(&mut (*this).leafRotFactor, 0x33e9 as libc::c_int as s16,
                 0x168 as libc::c_int as s16);
    (*this).dyna.actor.scale.y =
        Math_SinS((*this).leafRotFactor) * 0.17434467f32;
    (*this).dyna.actor.scale.z =
        Math_CosS((*this).leafRotFactor) * 0.12207746f32;
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupFlattenLeaves(mut this: *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_FlattenLeaves as
                 unsafe extern "C" fn(_: *mut ObjBean) -> ());
    (*this).leafRotFactor = 0x33e9 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_FlattenLeaves(mut this: *mut ObjBean) {
    (*this).leafRotFactor =
        ((*this).leafRotFactor as libc::c_int - 0x960 as libc::c_int) as s16;
    (*this).dyna.actor.scale.y =
        Math_SinS((*this).leafRotFactor) * 0.17434467f32;
    (*this).dyna.actor.scale.z =
        Math_CosS((*this).leafRotFactor) * 0.12207746f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
    if ((*this).leafRotFactor as libc::c_int) < 0x18e4 as libc::c_int {
        ObjBean_SetupGrown(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrown(mut this: *mut ObjBean) {
    (*this).transformFunc =
        Some(ObjBean_Grown as unsafe extern "C" fn(_: *mut ObjBean) -> ());
    (*this).unk_1C2 = 0xbb8 as libc::c_int as s16;
    (*this).unk_1C4 = 0 as libc::c_int as s16;
    (*this).unk_1C6 = 0xc8 as libc::c_int as s16;
    (*this).unk_1C8 = 0x3e80 as libc::c_int as s16;
    (*this).unk_1CA = 0x1f4 as libc::c_int as s16;
    (*this).unk_1CC = 0 as libc::c_int as s16;
    (*this).unk_1C0 = 0x10 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Grown(mut this: *mut ObjBean) {
    (*this).unk_1C0 -= 1;
    if (*this).unk_1C0 as libc::c_int == 6 as libc::c_int {
        (*this).unk_1CC = 0x7d0 as libc::c_int as s16
    }
    ObjBean_UpdateLeaves(this);
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut path: s32 = 0;
    ...
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        if Flags_GetSwitch(globalCtx,
               ...
               (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                                      16 as libc::c_int + 1 as libc::c_int) as
                                     usize] as libc::c_int == 1 as libc::c_int
           {
            path =
                (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
                    0x1f as libc::c_int;
            if path == 0x1f as libc::c_int {
                osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as
                                 *const libc::c_char);
                // "No path data?"
                osSyncPrintf(b"\xe3\x83\x91\xe3\x82\xb9\xe3\x83\x87\xe3\x83\xbc\xe3\x82\xbf\xe3\x81\x8c\xe7\x84\xa1\xe3\x81\x84\xef\xbc\x9f(%s %d)(arg_data %xH)\n\x00"
                                 as *const u8 as *const libc::c_char,
                             b"../z_obj_bean.c\x00" as *const u8 as
            ...
            if ((*(*globalCtx).setupPathList.offset(path as isize)).count as
                    libc::c_int) < 3 as libc::c_int {
                osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as
                                 *const libc::c_char);
                // "Incorrect number of path data"
                osSyncPrintf(b"\xe3\x83\x91\xe3\x82\xb9\xe3\x83\x87\xe3\x83\xbc\xe3\x82\xbf\xe6\x95\xb0\xe3\x81\x8c\xe4\xb8\x8d\xe6\xad\xa3(%s %d)(arg_data %xH)\n\x00"
                                 as *const u8 as *const libc::c_char,
                             b"../z_obj_bean.c\x00" as *const u8 as
                                 *const libc::c_char, 921 as libc::c_int,
                             (*this).dyna.actor.params as libc::c_int);
                osSyncPrintf(b"\x1b[m\x00" as *const u8 as
                                 *const libc::c_char);
                Actor_Kill(&mut (*this).dyna.actor);
            ...
            ObjBean_InitDynaPoly(this, globalCtx, &mut gMagicBeanPlatformCol,
                                 DPM_UNK3 as libc::c_int);
            (*this).stateFlags =
                ((*this).stateFlags as libc::c_int |
                     (1 as libc::c_int) << 5 as libc::c_int) as u8_0;
            ObjBean_InitCollider(&mut (*this).dyna.actor, globalCtx);
            (*this).stateFlags =
                ((*this).stateFlags as libc::c_int |
            ...
            (*this).unk_1F6 =
                ((*this).dyna.actor.home.rot.z as libc::c_int &
                     3 as libc::c_int) as u8_0
        } else { Actor_Kill(&mut (*this).dyna.actor); return }
    } else if Flags_GetSwitch(globalCtx,
                              (*this).dyna.actor.params as libc::c_int &
    ...
    (*this).dyna.actor.shape.rot.z = 0 as libc::c_int as s16;
    (*this).dyna.actor.home.rot.z = (*this).dyna.actor.shape.rot.z;
    (*this).dyna.actor.world.rot.z = (*this).dyna.actor.home.rot.z;
    // "Magic bean tree lift"
    osSyncPrintf(b"(\xe9\xad\x94\xe6\xb3\x95\xe3\x81\xae\xe8\xb1\x86\xe3\x81\xae\xe6\x9c\xa8\xe3\x83\xaa\xe3\x83\x95\xe3\x83\x88)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjBean = thisx as *mut ObjBean;
    ...
    if D_80B90E30 == this { D_80B90E30 = 0 as *mut ObjBean };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupWaitForBean(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_WaitForBean as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int) as u8_0);
    (*this).dyna.actor.textId = 0x2f as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_WaitForBean(mut this: *mut ObjBean,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).dyna.actor, globalCtx) != 0 {
        ...
        func_8002F298(&mut (*this).dyna.actor, globalCtx, 40.0f32,
                      EXCH_ITEM_BEAN as libc::c_int as u32_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8FE00(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B8FE3C as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int) as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B8FE3C(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B8FE6C(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B8FEAC as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn func_80B8FEAC(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_v1: s32 = 1 as libc::c_int;
    temp_v1 &=
        Math_StepToF(&mut (*this).dyna.actor.scale.y, 0.16672663f32, 0.01f32);
    temp_v1 &=
        Math_StepToF(&mut (*this).dyna.actor.scale.x, 0.03569199f32,
                     0.00113f32);
    ...
    } else { (*this).timer = 1 as libc::c_int as s16 }
    func_8002F974(&mut (*this).dyna.actor,
                  (0x8c6 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8FF50(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B8FF8C as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
                             (1 as libc::c_int) << 1 as libc::c_int) as u8_0);
    (*this).unk_1B6.x = 0x33e9 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B8FF8C(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_1B6.x =
        ((*this).unk_1B6.x as libc::c_int - 0x960 as libc::c_int) as s16;
    (*this).dyna.actor.scale.y = Math_SinS((*this).unk_1B6.x) * 0.17434467f32;
    (*this).dyna.actor.scale.z = Math_CosS((*this).unk_1B6.x) * 0.12207746f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
    if ((*this).unk_1B6.x as libc::c_int) < 0x18e4 as libc::c_int {
        func_80B90010(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B90010(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B90050 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
                             (1 as libc::c_int) << 1 as libc::c_int) as u8_0);
    (*this).unk_1B6.x = 0 as libc::c_int as s16;
    (*this).unk_1B6.y = 0xbb8 as libc::c_int as s16;
}
// Control is returned to the player and the leaves start to flatten out
#[no_mangle]
pub unsafe extern "C" fn func_80B90050(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_a0: s16 = 0;
    let mut temp_f2: f32_0 = 0.;
    (*this).unk_1B6.x =
        ((*this).unk_1B6.x as libc::c_int + 0x3e80 as libc::c_int) as s16;
    (*this).unk_1B6.y =
        ((*this).unk_1B6.y as libc::c_int + -(0xc8 as libc::c_int)) as s16;
    temp_a0 =
        (6372.0f32 -
             Math_SinS((*this).unk_1B6.x) *
                 (*this).unk_1B6.y as libc::c_int as libc::c_float) as s16;
    (*this).dyna.actor.scale.y = Math_SinS(temp_a0) * 0.17434467f32;
    (*this).dyna.actor.scale.z = Math_CosS(temp_a0) * 0.12207746f32;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.z;
    if ((*this).unk_1B6.y as libc::c_int) < 0 as libc::c_int {
        ObjBean_SetupWaitForWater(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupWaitForWater(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_WaitForWater as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_WaitForWater(mut this: *mut ObjBean,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).transformFunc.expect("non-null function pointer")(this);
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 6 as libc::c_int == 0 &&
           Flags_GetEnv(globalCtx, 5 as libc::c_int as s16) != 0 &&
           D_80B90E30.is_null() && (*this).dyna.actor.xzDistToPlayer < 50.0f32
       {
        ObjBean_SetupGrowWaterPhase1(this);
        D_80B90E30 = this;
        OnePointCutscene_Init(globalCtx, 2210 as libc::c_int as s16,
    ...
    if D_80B90E30 == this &&
           Flags_GetEnv(globalCtx, 5 as libc::c_int as s16) == 0 {
        D_80B90E30 = 0 as *mut ObjBean;
        !D_80B90E30.is_null();
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrowWaterPhase1(mut this:
                                                          *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_GrowWaterPhase1 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_GrowWaterPhase1(mut this: *mut ObjBean,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).transformFunc.expect("non-null function pointer")(this);
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrowWaterPhase2(mut this:
                                                          *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_GrowWaterPhase2 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
    ...
    (*this).stalkSizeMultiplier = 0.0f32;
}
// BeanStalk is visable and is growing
#[no_mangle]
pub unsafe extern "C" fn ObjBean_GrowWaterPhase2(mut this: *mut ObjBean,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).transformFunc.expect("non-null function pointer")(this);
    (*this).stalkSizeMultiplier += 0.001f32;
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.home.rot.y as libc::c_int +
             ((*this).stalkSizeMultiplier * 700000.0f32) as s16 as
                 libc::c_int) as s16;
    (*this).dyna.actor.world.pos.y =
        (*this).dyna.actor.home.pos.y +
            (*this).stalkSizeMultiplier * 800.0f32;
    if (*this).stalkSizeMultiplier >= 0.1f32 {
        // 100 Frames
        ObjBean_SetupGrowWaterPhase3(this);
    }
    func_8002F974(&mut (*this).dyna.actor,
                  (0x8c7 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrowWaterPhase3(mut this:
                                                          *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_GrowWaterPhase3 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 1 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_GrowWaterPhase3(mut this: *mut ObjBean,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut itemDropPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).transformFunc.expect("non-null function pointer")(this);
    if (*this).timer as libc::c_int == 40 as libc::c_int {
        ObjBean_SetupFlattenLeaves(this);
    } else if (*this).timer as libc::c_int == 30 as libc::c_int {
        if (*this).stateFlags as libc::c_int &
               (1 as libc::c_int) << 6 as libc::c_int == 0 {
            itemDropPos.x = (*this).dyna.actor.world.pos.x;
            itemDropPos.y = (*this).dyna.actor.world.pos.y - 25.0f32;
            itemDropPos.z = (*this).dyna.actor.world.pos.z;
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                Item_DropCollectible(globalCtx, &mut itemDropPos,
                                     ITEM00_FLEXIBLE as libc::c_int as s16);
                i += 1
            }
            (*this).stateFlags =
                ((*this).stateFlags as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrowWaterPhase4(mut this:
                                                          *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_GrowWaterPhase4 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 1 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_GrowWaterPhase4(mut this: *mut ObjBean,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).transformFunc.expect("non-null function pointer")(this);
    (*this).stalkSizeMultiplier -= 0.001f32;
    ...
    (*this).dyna.actor.world.pos.y =
        (*this).dyna.actor.home.pos.y +
            (*this).stalkSizeMultiplier * 800.0f32;
    if (*this).stalkSizeMultiplier <= 0.0f32 {
        (*this).stalkSizeMultiplier = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupGrowWaterPhase5(mut this:
                                                          *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_GrowWaterPhase5 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_GrowWaterPhase5(mut this: *mut ObjBean,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).transformFunc.expect("non-null function pointer")(this);
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupWaitForPlayer(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_WaitForPlayer as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_WaitForPlayer(mut this: *mut ObjBean,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 {
        ...
        if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT10 as libc::c_int
           {
            ...
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 CAM_SET_BEAN_LOST_WOODS as libc::c_int as
                                     s16);
        } else {
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 CAM_SET_BEAN_GENERIC as libc::c_int as s16);
        }
    }
    ObjBean_UpdatePosition(this);
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupFly(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_Fly as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Fly(mut this: *mut ObjBean,
                                     mut globalCtx: *mut GlobalContext) {
    let mut camera: *mut Camera =
        0 as *mut Camera; // Never stop updating (disable)
    ObjBean_FollowPath(this, globalCtx);
    if (*this).currentPointIndex as libc::c_int ==
           (*this).pathCount as libc::c_int {
        ObjBean_SetupPathCount(this, globalCtx);
        ObjBean_SetupPath(this, globalCtx);
        ...
        if (*camera).setting as libc::c_int ==
               CAM_SET_BEAN_LOST_WOODS as libc::c_int ||
               (*camera).setting as libc::c_int ==
                   CAM_SET_BEAN_GENERIC as libc::c_int {
            Camera_ChangeSetting(camera,
                                 CAM_SET_NORMAL0 as libc::c_int as s16);
        }
    } else if func_8004356C(&mut (*this).dyna) != 0 as libc::c_int {
        // Player is on top
        func_8002F974(&mut (*this).dyna.actor,
                      (0x8ca as libc::c_int - 0x800 as libc::c_int) as u16_0);
        if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT10 as libc::c_int
           {
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
    ...
    } else if (*this).stateFlags as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_SetupWaitForStepOff(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(ObjBean_WaitForStepOff as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 2 as libc::c_int) as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_WaitForStepOff(mut this: *mut ObjBean,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if func_80043590(&mut (*this).dyna) == 0 {
        ObjBean_SetupWaitForPlayer(this);
    }
    ObjBean_UpdatePosition(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B908EC(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B90918 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this, 0 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B90918(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) == 0 {
        ObjBean_SetupPathCount(this, globalCtx);
        ObjBean_SetupPath(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B90970(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B909B0 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this, 0 as libc::c_int as u8_0);
    (*this).timer = 100 as libc::c_int as s16;
    func_80B8EDF4(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B909B0(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B909F8(mut this: *mut ObjBean) {
    (*this).actionFunc =
        Some(func_80B90A34 as
                 unsafe extern "C" fn(_: *mut ObjBean, _: *mut GlobalContext)
                     -> ());
    ObjBean_SetDrawMode(this,
                        ((1 as libc::c_int) << 2 as libc::c_int) as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B90A34(mut this: *mut ObjBean,
                                       mut globalCtx: *mut GlobalContext) {
    let mut trampled: s32 = ObjBean_CheckForHorseTrample(this, globalCtx);
    func_80B8EE24(this);
    if trampled != 0 {
    ...
    if (*this).timer as libc::c_int <= 0 as libc::c_int && trampled == 0 {
        func_80B8EBC8(this);
        ObjBean_SetupWaitForPlayer(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjBean = thisx as *mut ObjBean;
    ...
    if (*this).stateFlags as libc::c_int &
        ...
        ObjBean_Move(this);
        if (*this).dyna.actor.xzDistToPlayer < 150.0f32 {
            (*this).collider.dim.radius =
                ((*this).dyna.actor.scale.x * 640.0f32 + 0.5f32) as s16;
            Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                    &mut (*this).collider);
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).collider.base);
        }
        ObjBean_FindFloor(this, globalCtx);
        (*this).dyna.actor.shape.shadowDraw =
            Some(ActorShadow_DrawCircle as
                     unsafe extern "C" fn(_: *mut Actor, _: *mut Lights,
                                          _: *mut GlobalContext) -> ());
        (*this).dyna.actor.shape.shadowScale =
            (*this).dyna.actor.scale.x * 88.0f32;
        if ObjBean_CheckForHorseTrample(this, globalCtx) != 0 {
            osSyncPrintf(b"\x1b[36m\x00" as *const u8 as *const libc::c_char);
            // "Horse and bean tree lift collision"
            osSyncPrintf(b"\xe9\xa6\xac\xe3\x81\xa8\xe8\xb1\x86\xe3\x81\xae\xe6\x9c\xa8\xe3\x83\xaa\xe3\x83\x95\xe3\x83\x88\xe8\xa1\x9d\xe7\xaa\x81\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81\n\x00"
                             as *const u8 as *const libc::c_char);
    ...
    } else { (*this).dyna.actor.shape.shadowDraw = None }
    Actor_SetFocus(&mut (*this).dyna.actor, 6.0f32);
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 5 as libc::c_int != 0 {
        if func_8004356C(&mut (*this).dyna) != 0 {
            (*this).stateFlags =
...
#[no_mangle]
pub unsafe extern "C" fn ObjBean_DrawSoftSoilSpot(mut this: *mut ObjBean,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    Matrix_Translate((*this).dyna.actor.home.pos.x,
                     (*this).dyna.actor.home.pos.y,
                     (*this).dyna.actor.home.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateY((*this).dyna.actor.home.rot.y as libc::c_int as
                       libc::c_float *
    ...
    Matrix_Scale(0.1f32, 0.1f32, 0.1f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Gfx_DrawDListOpa(globalCtx, gMagicBeanSoftSoilDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_DrawBeanstalk(mut this: *mut ObjBean,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    Matrix_Translate((*this).dyna.actor.world.pos.x,
                     ...
                     (*this).dyna.actor.world.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateY((*this).dyna.actor.shape.rot.y as libc::c_int as
                       libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(0.1f32, (*this).stalkSizeMultiplier, 0.1f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Gfx_DrawDListOpa(globalCtx, gMagicBeanStemDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn ObjBean_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjBean = thisx as *mut ObjBean;
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        Gfx_DrawDListOpa(globalCtx, gMagicBeanSeedlingDL.as_mut_ptr());
    }
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 2 as libc::c_int != 0 {
        Gfx_DrawDListOpa(globalCtx, gMagicBeanPlatformDL.as_mut_ptr());
    }
    if (*this).stateFlags as libc::c_int &
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneScale as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(200 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneDownward as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(1600 as libc::c_int);
             init
         }]
}
#[used]
