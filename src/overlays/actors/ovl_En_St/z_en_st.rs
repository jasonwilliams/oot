...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsBlast_SpawnWhiteCustomScale(globalCtx: *mut GlobalContext,
                                           pos: *mut Vec3f,
                                           velocity: *mut Vec3f,
...
pub struct EnSt {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnStActionFunc,
    pub colCylinder: [ColliderCylinder; 6],
    pub colSph: ColliderJntSph,
    pub colSphItems: [ColliderJntSphElement; 1],
    pub initalYaw: s16,
    pub deathYawTarget: s16,
    pub groundBounces: s16,
    pub animFrames: s16,
    pub swayTimer: s16,
    pub setTargetYawTimer: s16,
    pub rotAwayTimer: s16,
    pub rotTowardsTimer: s16,
    pub takeDamageSpinTimer: s16,
    pub stunTimer: s16,
    pub invulnerableTimer: s16,
    pub sfxTimer: s16,
    pub gaveDamageSpinTimer: s16,
    pub finishDeathTimer: s16,
    pub deathTimer: s16,
    pub absPrevSwayAngle: s16,
    pub playSwayFlag: u8_0,
    pub teethR: u8_0,
    pub teethG: u8_0,
    pub teethB: u8_0,
    pub unk_3E0: [libc::c_char; 4],
    pub unusedPos: Vec3f,
    pub ceilingPos: Vec3f,
    pub unk_3FC: [libc::c_char; 8],
    pub blureIdx: s32,
    pub colliderScale: f32_0,
    pub floorHeightOffset: f32_0,
    pub swayAngle: s16,
    pub jointTable: [Vec3s; 30],
    pub morphTable: [Vec3s; 30],
}
pub type EnStActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSt, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_St_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ST as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnSt>() as libc::c_ulong,
                          init:
...
static mut sColChkInit: CollisionCheckInfoInit2 =
    {
        let mut init =
            CollisionCheckInfoInit2{health: 2 as libc::c_int as u8_0,
...
static mut sJntSphElementsInit: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
...
static mut sAnimations: [struct_80034EC0_Entry; 8] =
    unsafe {
        [{
             let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetupAction(mut this: *mut EnSt,
                                          mut actionFunc: EnStActionFunc) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_SpawnDust(mut this: *mut EnSt,
    ...
    let mut yAngle: s16 = 0;
    let mut i: s32 = 0;
    yAngle = ((Rand_ZeroOne() - 0.5f32) * 65536.0f32) as s16;
    dustPos.y = (*this).actor.floorHeight;
    i = dustCnt;
    while i >= 0 as libc::c_int {
        dustAccel.x = (Rand_ZeroOne() - 0.5f32) * 4.0f32;
        dustAccel.z = (Rand_ZeroOne() - 0.5f32) * 4.0f32;
        dustPos.x = (*this).actor.world.pos.x + Math_SinS(yAngle) * 22.0f32;
        dustPos.z = (*this).actor.world.pos.z + Math_CosS(yAngle) * 22.0f32;
        func_8002836C(globalCtx, &mut dustPos, &mut dustVel, &mut dustAccel,
                      &mut primColor, &mut envColor,
                      120 as libc::c_int as s16, 40 as libc::c_int as s16,
                      10 as libc::c_int as s16);
        i -= 1;
        yAngle =
            (yAngle as libc::c_int +
                 (0x10000 as libc::c_int / dustCnt) as s16 as libc::c_int) as
                s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SpawnBlastEffect(mut this: *mut EnSt,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut blastPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    blastPos.x = (*this).actor.world.pos.x;
    blastPos.y = (*this).actor.floorHeight;
    blastPos.z = (*this).actor.world.pos.z;
    EffectSsBlast_SpawnWhiteCustomScale(globalCtx, &mut blastPos,
                                        &mut zeroVec, &mut zeroVec,
                                        100 as libc::c_int as s16,
                                        220 as libc::c_int as s16,
                                        8 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SpawnDeadEffect(mut this: *mut EnSt,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut firePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    firePos.x =
        (*this).actor.world.pos.x + (Rand_ZeroOne() - 0.5f32) * 60.0f32;
    firePos.y =
        (*this).actor.world.pos.y + 10.0f32 +
            (Rand_ZeroOne() - 0.5f32) * 45.0f32;
    firePos.z =
        (*this).actor.world.pos.z + (Rand_ZeroOne() - 0.5f32) * 60.0f32;
    EffectSsDeadDb_Spawn(globalCtx, &mut firePos, &mut zeroVec, &mut zeroVec,
                         100 as libc::c_int as s16, 0 as libc::c_int as s16,
                         ...
                         9 as libc::c_int, 1 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_CreateBlureEffect(mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
    let mut blureInit: EffectBlureInit1 =
        EffectBlureInit1{unk_00: [0; 388],
                         ...
                         unkFlag: 0,
                         calcMode: 0,};
    let mut p1StartColor: [u8_0; 4] =
        [255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
         255 as libc::c_int as u8_0, 75 as libc::c_int as u8_0];
    let mut p2StartColor: [u8_0; 4] =
        [255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
         255 as libc::c_int as u8_0, 75 as libc::c_int as u8_0];
    let mut p1EndColor: [u8_0; 4] =
        [255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
         255 as libc::c_int as u8_0, 0 as libc::c_int as u8_0];
    let mut p2EndColor: [u8_0; 4] =
        [255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
         255 as libc::c_int as u8_0, 0 as libc::c_int as u8_0];
    let mut i: s32 = 0;
    let mut blureIdx: s32 = 0;
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        blureInit.p1StartColor[i as usize] = p1StartColor[i as usize];
        blureInit.p2StartColor[i as usize] = p2StartColor[i as usize];
        blureInit.p1EndColor[i as usize] = p1EndColor[i as usize];
        blureInit.p2EndColor[i as usize] = p2EndColor[i as usize];
        i += 1
    }
    blureInit.elemDuration = 6 as libc::c_int;
    blureInit.unkFlag = 0 as libc::c_int;
    blureInit.calcMode = 3 as libc::c_int;
    Effect_Add(globalCtx, &mut blureIdx, EFFECT_BLURE1 as libc::c_int,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckCeilingPos(mut this: *mut EnSt,
                                              mut globalCtx:
    ...
    checkPos.y = (*this).actor.world.pos.y + 1000.0f32;
    checkPos.z = (*this).actor.world.pos.z;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                               &mut (*this).actor.world.pos, &mut checkPos,
                               &mut (*this).ceilingPos, &mut poly,
                               0 as libc::c_int, 0 as libc::c_int,
                               1 as libc::c_int, 1 as libc::c_int, &mut bgId)
           == 0 {
        return 0 as libc::c_int
    }
    (*this).unusedPos = (*this).actor.world.pos;
    (*this).unusedPos.y -= 100.0f32;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_AddBlurVertex(mut this: *mut EnSt) {
    let mut v1: Vec3f =
        { let mut init = Vec3f{x: 834.0f32, y: 834.0f32, z: 0.0f32,}; init };
    let mut v2: Vec3f =
        { let mut init = Vec3f{x: 834.0f32, y: -584.0f32, z: 0.0f32,}; init };
    let mut v1Pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut v2Pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    Matrix_Push();
    Matrix_MultVec3f(&mut v1, &mut v1Pos);
    Matrix_MultVec3f(&mut v2, &mut v2Pos);
    Matrix_Pop();
    EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIdx) as
                              *mut EffectBlure, &mut v1Pos, &mut v2Pos);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_AddBlurSpace(mut this: *mut EnSt) {
    EffectBlure_AddSpace(Effect_GetByIndex((*this).blureIdx) as
                             *mut EffectBlure);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetWaitingAnimation(mut this: *mut EnSt) {
    func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                  3 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetReturnToCeilingAnimation(mut this:
                                                              *mut EnSt) {
    Audio_PlayActorSound2(&mut (*this).actor, 0x3869 as libc::c_int as u16_0);
    func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                  2 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetLandAnimation(mut this: *mut EnSt) {
    (*this).actor.world.pos.y =
        (*this).actor.floorHeight + (*this).floorHeightOffset;
    func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                  4 as libc::c_int);
    (*this).sfxTimer = 0 as libc::c_int as s16;
    (*this).animFrames = (*this).skelAnime.animLength as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetDropAnimAndVel(mut this: *mut EnSt) {
    if (*this).takeDamageSpinTimer as libc::c_int == 0 as libc::c_int {
        func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                      4 as libc::c_int);
        (*this).animFrames = (*this).skelAnime.animLength as s16
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_InitColliders(mut this: *mut EnSt,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut cylinders: [*mut ColliderCylinderInit; 6] =
        [&mut sCylinderInit, &mut sCylinderInit, &mut sCylinderInit,
         &mut sCylinderInit2, &mut sCylinderInit2, &mut sCylinderInit2];
    let mut i: s32 = 0;
    let mut pad: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[*mut ColliderCylinderInit; 6]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<*mut ColliderCylinderInit>()
                                                   as libc::c_ulong) as s32 {
        Collider_InitCylinder(globalCtx,
                              &mut *(*this).colCylinder.as_mut_ptr().offset(i
                                                                                as
                                                                                isize));
        Collider_SetCylinder(globalCtx,
                             &mut *(*this).colCylinder.as_mut_ptr().offset(i
                                                                               as
                                                                               isize),
                             &mut (*this).actor, cylinders[i as usize]);
        i += 1
    }
    (*this).colCylinder[0 as libc::c_int as usize].info.bumper.dmgFlags =
        0x3f8f9 as libc::c_int as u32_0;
    (*this).colCylinder[1 as libc::c_int as usize].info.bumper.dmgFlags =
        0xffc00706 as libc::c_uint;
    (*this).colCylinder[2 as libc::c_int as usize].base.colType =
        COLTYPE_METAL as libc::c_int as u8_0;
    (*this).colCylinder[2 as libc::c_int as usize].info.bumperFlags =
        ((1 as libc::c_int) << 0 as libc::c_int |
             (1 as libc::c_int) << 2 as libc::c_int |
             (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
    (*this).colCylinder[2 as libc::c_int as usize].info.elemType =
        ELEMTYPE_UNK2 as libc::c_int as u8_0;
    (*this).colCylinder[2 as libc::c_int as usize].info.bumper.dmgFlags =
        0xffcc0706 as libc::c_uint;
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(2 as libc::c_int),
                            &mut sColChkInit);
    Collider_InitJntSph(globalCtx, &mut (*this).colSph);
    Collider_SetJntSph(globalCtx, &mut (*this).colSph, &mut (*this).actor,
                       &mut sJntSphInit, (*this).colSphItems.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckBodyStickHit(mut this: *mut EnSt,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut body: *mut ColliderInfo =
        &mut (*(*this).colCylinder.as_mut_ptr().offset(0 as libc::c_int as
                                                           isize)).info;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*player).unk_860 as libc::c_int != 0 as libc::c_int {
        (*body).bumper.dmgFlags |= 2 as libc::c_int as libc::c_uint;
        (*this).colCylinder[1 as libc::c_int as usize].info.bumper.dmgFlags &=
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetBodyCylinderAC(mut this: *mut EnSt,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    Collider_UpdateCylinder(&mut (*this).actor,
                            &mut *(*this).colCylinder.as_mut_ptr().offset(0 as
                                                                              libc::c_int
                                                                              as
                                                                              isize));
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetLegsCylinderAC(mut this: *mut EnSt,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut angleTowardsLink: s16 =
    ...
    if (angleTowardsLink as libc::c_int) < 0x3ffc as libc::c_int {
        Collider_UpdateCylinder(&mut (*this).actor,
                                &mut *(*this).colCylinder.as_mut_ptr().offset(2
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
        ...
        Collider_UpdateCylinder(&mut (*this).actor,
                                &mut *(*this).colCylinder.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetCylinderOC(mut this: *mut EnSt,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut cyloffsets: [Vec3f; 3] =
        [{ let mut init = Vec3f{x: 40.0f32, y: 0.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: -40.0f32, y: 0.0f32, z: 0.0f32,}; init }];
    let mut cylPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        cylPos = (*this).actor.world.pos;
        cyloffsets[i as usize].x *= (*this).colliderScale;
        cyloffsets[i as usize].y *= (*this).colliderScale;
        cyloffsets[i as usize].z *= (*this).colliderScale;
        Matrix_Push();
        Matrix_Translate(cylPos.x, cylPos.y, cylPos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY((*this).initalYaw as libc::c_int as libc::c_float /
                           32768.0f32 * 3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut *cyloffsets.as_mut_ptr().offset(i as isize),
                         &mut cylPos);
        Matrix_Pop();
        (*this).colCylinder[(i + 3 as libc::c_int) as usize].dim.pos.x =
            cylPos.x as s16;
        (*this).colCylinder[(i + 3 as libc::c_int) as usize].dim.pos.y =
            cylPos.y as s16;
        (*this).colCylinder[(i + 3 as libc::c_int) as usize].dim.pos.z =
            cylPos.z as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_UpdateCylinders(mut this: *mut EnSt,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int ||
           (*this).actionFunc ==
               Some(EnSt_FinishBouncing as
                        unsafe extern "C" fn(_: *mut EnSt,
                                             _: *mut GlobalContext) -> ()) {
        if (if (*this).gaveDamageSpinTimer as libc::c_int == 0 as libc::c_int
               {
                0 as libc::c_int
            } else {
                (*this).gaveDamageSpinTimer -= 1;
                (*this).gaveDamageSpinTimer as libc::c_int
            }) == 0 as libc::c_int {
            EnSt_SetCylinderOC(this, globalCtx);
        }
        if (*this).invulnerableTimer as libc::c_int == 0 as libc::c_int {
        } else { (*this).invulnerableTimer -= 1 };
        if (*this).takeDamageSpinTimer as libc::c_int == 0 as libc::c_int {
        } else { (*this).takeDamageSpinTimer -= 1 };
        if (*this).invulnerableTimer as libc::c_int == 0 as libc::c_int &&
               (*this).takeDamageSpinTimer as libc::c_int == 0 as libc::c_int
           {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckHitLink(mut this: *mut EnSt,
                                           mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    hit = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if !(((*this).colCylinder[(i + 3 as libc::c_int) as
                                      usize].base.ocFlags2 as libc::c_int &
                  (1 as libc::c_int) << 0 as libc::c_int != 0 as libc::c_int)
                 as libc::c_int == 0 as libc::c_int) {
            (*this).colCylinder[(i + 3 as libc::c_int) as usize].base.ocFlags2
                =
                ((*this).colCylinder[(i + 3 as libc::c_int) as
                                         usize].base.ocFlags2 as libc::c_int &
    ...
    if hit == 0 { return 0 as libc::c_int }
    if (*this).swayTimer as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3884 as libc::c_int as u16_0);
    }
    (*this).gaveDamageSpinTimer = 30 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckHitFrontside(mut this: *mut EnSt) -> s32 {
    let mut acFlags: u8_0 =
        (*this).colCylinder[2 as libc::c_int as usize].base.acFlags;
    if (acFlags as libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0)
           as libc::c_int == 0 as libc::c_int {
        // not hit
        return 0 as libc::c_int
    } else {
        (*this).colCylinder[2 as libc::c_int as usize].base.acFlags =
            ((*this).colCylinder[2 as libc::c_int as usize].base.acFlags as
                 libc::c_int & !((1 as libc::c_int) << 1 as libc::c_int)) as
                u8_0; // ac hit flags from colliders 0 and 1
        (*this).invulnerableTimer = 8 as libc::c_int as s16;
        (*this).playSwayFlag = 0 as libc::c_int as u8_0;
        (*this).swayTimer = 60 as libc::c_int as s16;
        return 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckHitBackside(mut this: *mut EnSt,
                                               mut globalCtx:
                                                   *mut GlobalContext)
 -> s32 {
    let mut cyl: *mut ColliderCylinder =
        &mut *(*this).colCylinder.as_mut_ptr().offset(0 as libc::c_int as
                                                          isize) as
            *mut ColliderCylinder;
    let mut flags: s32 = 0 as libc::c_int;
    let mut hit: s32 = 0 as libc::c_int;
    if (*cyl).base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*cyl).base.acFlags =
            ((*cyl).base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        hit = 1 as libc::c_int;
        flags =
            (flags as libc::c_uint |
                 (*(*cyl).info.acHitInfo).toucher.dmgFlags) as s32
    }
    cyl =
        &mut *(*this).colCylinder.as_mut_ptr().offset(1 as libc::c_int as
                                                          isize) as
            *mut ColliderCylinder;
    if (*cyl).base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
    ...
    if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
           1 as libc::c_int {
        if (*this).stunTimer as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x389e as libc::c_int as u16_0);
            (*this).stunTimer = 120 as libc::c_int as s16;
            Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                                 0xc8 as libc::c_int as s16,
                                 0 as libc::c_int as s16, (*this).stunTimer);
        }
        return 0 as libc::c_int
    }
    (*this).stunTimer = 0 as libc::c_int as s16;
    (*this).swayTimer = (*this).stunTimer;
    (*this).gaveDamageSpinTimer = 1 as libc::c_int as s16;
    func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                  3 as libc::c_int);
    (*this).takeDamageSpinTimer = (*this).skelAnime.animLength as s16;
    ...
    (*this).groundBounces = 3 as libc::c_int as s16;
    (*this).deathTimer = 20 as libc::c_int as s16;
    (*this).actor.gravity = -1.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3885 as libc::c_int as u16_0);
    if flags & 0x1f820 as libc::c_int != 0 {
        // arrow, fire arrow, ice arrow, light arrow,
        // and three unknows, unused arrows?
        EnSt_SetupAction(this,
                         Some(EnSt_Die as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
        (*this).finishDeathTimer = 8 as libc::c_int as s16
    } else {
        EnSt_SetupAction(this,
                         Some(EnSt_BounceAround as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
    }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_CheckColliders(mut this: *mut EnSt,
                                             mut globalCtx:
                                                 *mut GlobalContext) -> s32 {
    if EnSt_CheckHitFrontside(this) != 0 {
        // player has hit the front shield area of the Skulltula
        return 0 as libc::c_int
    }
    if (*globalCtx).actorCtx.unk_02 as libc::c_int != 0 as libc::c_int {
        return 1 as libc::c_int
    }
    if EnSt_CheckHitBackside(this, globalCtx) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetColliderScale(mut this: *mut EnSt) {
    let mut scaleAmount: f32_0 = 1.0f32;
    let mut radius: f32_0 = 0.;
    let mut height: f32_0 = 0.;
    let mut yShift: f32_0 = 0.;
    let mut i: s32 = 0;
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        scaleAmount = 1.4f32
    }
    radius =
        (*(*this).colSph.elements.offset(0 as libc::c_int as
                                             isize)).dim.modelSphere.radius as
            f32_0;
    radius *= scaleAmount;
    (*(*this).colSph.elements.offset(0 as libc::c_int as
    ...
    while i < 6 as libc::c_int {
        yShift = (*this).colCylinder[i as usize].dim.yShift as f32_0;
        radius = (*this).colCylinder[i as usize].dim.radius as f32_0;
        height = (*this).colCylinder[i as usize].dim.height as f32_0;
        yShift *= scaleAmount;
        radius *= scaleAmount;
        height *= scaleAmount;
        (*this).colCylinder[i as usize].dim.yShift = yShift as s16;
        (*this).colCylinder[i as usize].dim.radius = radius as s16;
        (*this).colCylinder[i as usize].dim.height = height as s16;
        i += 1
    }
    Actor_SetScale(&mut (*this).actor, 0.04f32 * scaleAmount);
    (*this).colliderScale = scaleAmount;
    (*this).floorHeightOffset = 32.0f32 * scaleAmount;
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_SetTeethColor(mut this: *mut EnSt,
                                            mut redTarget: s16,
                                            mut greenTarget: s16,
                                            mut blueTarget: s16,
                                            mut minMaxStep: s16) -> s32 {
    let mut red: s16 = (*this).teethR as s16;
    let mut green: s16 = (*this).teethG as s16;
    let mut blue: s16 = (*this).teethB as s16;
    minMaxStep =
        (255 as libc::c_int /
             (0.6f32 * minMaxStep as libc::c_int as libc::c_float) as s16 as
                 libc::c_int) as s16;
    if minMaxStep as libc::c_int <= 0 as libc::c_int {
        minMaxStep = 1 as libc::c_int as s16
    }
    Math_SmoothStepToS(&mut red, redTarget, 1 as libc::c_int as s16,
                       minMaxStep, minMaxStep);
    Math_SmoothStepToS(&mut green, greenTarget, 1 as libc::c_int as s16,
                       minMaxStep, minMaxStep);
    Math_SmoothStepToS(&mut blue, blueTarget, 1 as libc::c_int as s16,
                       minMaxStep, minMaxStep);
    (*this).teethR = red as u8_0;
    (*this).teethG = green as u8_0;
    (*this).teethB = blue as u8_0;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_DecrStunTimer(mut this: *mut EnSt) -> s32 {
    if (*this).stunTimer as libc::c_int == 0 as libc::c_int {
        return 0 as libc::c_int
    }
    (*this).stunTimer -= 1;
    panic!("Reached end of non-void function without returning");
    // ! @bug  no return but v0 ends up being stunTimer before decrement
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_UpdateYaw(mut this: *mut EnSt,
                                        mut globalCtx: *mut GlobalContext) {
    let mut yawDir: u16_0 = 0 as libc::c_int as u16_0;
    let mut rot: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut yawDiff: s16 = 0;
    let mut timer: s16 = 0;
    let mut yawTarget: s16 = 0;
    // Shake towards the end of the stun.
    if (*this).stunTimer as libc::c_int != 0 as libc::c_int {
        if ((*this).stunTimer as libc::c_int) < 30 as libc::c_int {
            if (*this).stunTimer as libc::c_int % 2 as libc::c_int !=
                   0 as libc::c_int {
    ...
    if (*this).swayTimer as libc::c_int == 0 as libc::c_int &&
           (*this).deathTimer as libc::c_int == 0 as libc::c_int &&
           (*this).finishDeathTimer as libc::c_int == 0 as libc::c_int {
        // not swaying or dying
        if (*this).takeDamageSpinTimer as libc::c_int != 0 as libc::c_int ||
               (*this).gaveDamageSpinTimer as libc::c_int != 0 as libc::c_int
           {
        ...
        if (*this).actionFunc !=
               Some(EnSt_WaitOnGround as
                        unsafe extern "C" fn(_: *mut EnSt,
                                             _: *mut GlobalContext) -> ()) {
            // set the timers to turn away or turn towards the player
            (*this).rotAwayTimer = 30 as libc::c_int as s16;
            (*this).rotTowardsTimer = 0 as libc::c_int as s16
        }
        if (*this).rotAwayTimer as libc::c_int != 0 as libc::c_int {
            // turn away from the player
            (*this).rotAwayTimer -= 1;
            if (*this).rotAwayTimer as libc::c_int == 0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3884 as libc::c_int as u16_0);
                (*this).rotTowardsTimer = 30 as libc::c_int as s16
            }
        } else if (*this).rotTowardsTimer as libc::c_int != 0 as libc::c_int {
            // turn towards the player
            (*this).rotTowardsTimer -= 1;
            if (*this).rotTowardsTimer as libc::c_int == 0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3884 as libc::c_int as u16_0);
                (*this).rotAwayTimer = 30 as libc::c_int as s16
            }
            yawDir = 0x8000 as libc::c_int as u16_0
        }
        ...
        yawTarget =
            if (*this).actionFunc ==
               ...
               {
                (*this).actor.yawTowardsPlayer as libc::c_int
            } else { (*this).initalYaw as libc::c_int } as s16;
        yawDiff =
            (rot.y as libc::c_int -
                 (yawTarget as libc::c_int ^ yawDir as libc::c_int)) as s16;
        if (if yawDiff as libc::c_int >= 0 as libc::c_int {
                yawDiff as libc::c_int
            } else { -(yawDiff as libc::c_int) }) <= 0x4000 as libc::c_int {
            Math_SmoothStepToS(&mut rot.y,
                               (yawTarget as libc::c_int ^
                                    yawDir as libc::c_int) as s16,
                               4 as libc::c_int as s16,
                               0x2000 as libc::c_int as s16,
                               1 as libc::c_int as s16);
        } else {
            rot.y = (rot.y as libc::c_int + 0x2000 as libc::c_int) as s16
        }
        (*this).actor.world.rot = rot;
        (*this).actor.shape.rot = (*this).actor.world.rot;
        // Do the shaking animation.
        if yawDir as libc::c_int == 0 as libc::c_int &&
               ((*this).rotAwayTimer as libc::c_int) < 0xa as libc::c_int {
            timer = (*this).rotAwayTimer
        } else if yawDir as libc::c_int == 0x8000 as libc::c_int &&
                      ((*this).rotTowardsTimer as libc::c_int) <
                          0xa as libc::c_int {
            timer = (*this).rotTowardsTimer
        } else { return }
        if timer as libc::c_int % 2 as libc::c_int != 0 as libc::c_int {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
                     0x800 as libc::c_int) as s16
        } else {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_IsDoneBouncing(mut this: *mut EnSt,
                                             mut globalCtx:
                                                 *mut GlobalContext) -> s32 {
    if (*this).actor.velocity.y > 0.0f32 ||
           (*this).groundBounces as libc::c_int == 0 as libc::c_int {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x387b as libc::c_int as u16_0);
    EnSt_SpawnDust(this, globalCtx, 10 as libc::c_int);
    // creates an elastic bouncing effect, boucing up less for each hit on the ground.
    (*this).actor.velocity.y =
        6.0f32 /
            (4 as libc::c_int - (*this).groundBounces as libc::c_int) as
                libc::c_float;
    (*this).groundBounces -= 1;
    if (*this).groundBounces as libc::c_int != 0 as libc::c_int {
        return 0 as libc::c_int
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_Bob(mut this: *mut EnSt,
                                  mut globalCtx: *mut GlobalContext) {
    let mut ySpeedTarget: f32_0 = 0.5f32;
    if (*globalCtx).state.frames & 8 as libc::c_int as libc::c_uint !=
           0 as libc::c_int as libc::c_uint {
        ySpeedTarget *= -1.0f32
    }
    Math_SmoothStepToF(&mut (*this).actor.velocity.y, ySpeedTarget, 0.4f32,
                       1000.0f32, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_IsCloseToPlayer(mut this: *mut EnSt,
                                              mut globalCtx:
                                                  *mut GlobalContext) -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if yDist < 0.0f32 || yDist > 400.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_IsCloseToInitalPos(mut this: *mut EnSt) -> s32 {
    let mut velY: f32_0 = (*this).actor.velocity.y;
    let mut checkY: f32_0 = (*this).actor.world.pos.y + velY * 2.0f32;
    if checkY >= (*this).actor.home.pos.y { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_IsCloseToGround(mut this: *mut EnSt) -> s32 {
    let mut velY: f32_0 = (*this).actor.velocity.y;
    let mut checkY: f32_0 = (*this).actor.world.pos.y + velY * 2.0f32;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_Sway(mut this: *mut EnSt) {
    let mut amtToTranslate: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut translatedPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut swayAmt: f32_0 = 0.;
    let mut rotAngle: s16 = 0;
    if (*this).swayTimer as libc::c_int != 0 as libc::c_int {
        (*this).swayAngle =
            ((*this).swayAngle as libc::c_int + 0xa28 as libc::c_int) as s16;
        (*this).swayTimer -= 1;
        if (*this).swayTimer as libc::c_int == 0 as libc::c_int {
            (*this).swayAngle = 0 as libc::c_int as s16
        }
        swayAmt =
            (*this).swayTimer as libc::c_int as libc::c_float *
                (7.0f32 / 15.0f32);
        rotAngle =
            (Math_SinS((*this).swayAngle) *
                 (swayAmt * (65536.0f32 / 360.0f32))) as s16;
        if (*this).absPrevSwayAngle as libc::c_int >=
               (if rotAngle as libc::c_int >= 0 as libc::c_int {
                    rotAngle as libc::c_int
                } else { -(rotAngle as libc::c_int) }) &&
               (*this).playSwayFlag as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39e0 as libc::c_int as u16_0);
            (*this).playSwayFlag = 1 as libc::c_int as u8_0
        }
        if ((*this).absPrevSwayAngle as libc::c_int) <
               (if rotAngle as libc::c_int >= 0 as libc::c_int {
                    rotAngle as libc::c_int
        ...
        (*this).absPrevSwayAngle =
            if rotAngle as libc::c_int >= 0 as libc::c_int {
                rotAngle as libc::c_int
            } else { -(rotAngle as libc::c_int) } as s16;
        amtToTranslate.x = Math_SinS(rotAngle) * -200.0f32;
        amtToTranslate.y = Math_CosS(rotAngle) * -200.0f32;
        amtToTranslate.z = 0.0f32;
        Matrix_Push();
        Matrix_Translate((*this).ceilingPos.x, (*this).ceilingPos.y,
                         (*this).ceilingPos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY((*this).actor.world.rot.y as libc::c_int as
                           libc::c_float *
                           (3.14159265358979323846f32 / 32768.0f32),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut amtToTranslate, &mut translatedPos);
        Matrix_Pop();
        (*this).actor.shape.rot.z =
            -(rotAngle as libc::c_int * 2 as libc::c_int) as s16;
        (*this).actor.world.pos.x = translatedPos.x;
        (*this).actor.world.pos.z = translatedPos.z
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSt = thisx as *mut EnSt;
    let mut pad: s32 = 0;
    ...
    if (*thisx).params as libc::c_int == 2 as libc::c_int {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
    }
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        (*this).actor.naviEnemyId = 0x5 as libc::c_int as u8_0
    } else { (*this).actor.naviEnemyId = 0x4 as libc::c_int as u8_0 }
    ...
    EnSt_SetupAction(this,
                     Some(EnSt_StartOnCeilingOrGround as
                              unsafe extern "C" fn(_: *mut EnSt,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSt = thisx as *mut EnSt;
    let mut i: s32 = 0;
    ...
    Collider_DestroyJntSph(globalCtx, &mut (*this).colSph);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_WaitOnCeiling(mut this: *mut EnSt,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if EnSt_IsCloseToPlayer(this, globalCtx) != 0 {
        EnSt_SetDropAnimAndVel(this);
        EnSt_SetupAction(this,
                         Some(EnSt_MoveToGround as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
    } else { EnSt_Bob(this, globalCtx); };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_WaitOnGround(mut this: *mut EnSt,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).takeDamageSpinTimer as libc::c_int != 0 as libc::c_int {
        (*this).takeDamageSpinTimer -= 1;
        if (*this).takeDamageSpinTimer as libc::c_int == 0 as libc::c_int {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          3 as libc::c_int);
        }
    }
    if (*this).animFrames as libc::c_int != 0 as libc::c_int {
        (*this).animFrames -= 1;
        if (*this).animFrames as libc::c_int == 0 as libc::c_int {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          3 as libc::c_int);
    ...
    if EnSt_IsCloseToPlayer(this, globalCtx) == 0 {
        ...
        EnSt_SetupAction(this,
                         Some(EnSt_ReturnToCeiling as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
        return
    }
    if (if (*this).sfxTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).sfxTimer -= 1; (*this).sfxTimer as libc::c_int }) ==
           0 as libc::c_int {
        // play the "laugh" sfx every 64 frames.
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x386a as libc::c_int as u16_0);
        (*this).sfxTimer = 64 as libc::c_int as s16
    }
    // simply bob up and down.
    EnSt_Bob(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_LandOnGround(mut this: *mut EnSt,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).animFrames as libc::c_int != 0 as libc::c_int {
        (*this).animFrames -= 1;
    ...
    (*this).sfxTimer += 1;
    if (*this).sfxTimer as libc::c_int == 14 as libc::c_int {
        // play the sound effect of the Skulltula hitting the ground.
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39e1 as libc::c_int as u16_0);
    }
    if (*this).actor.floorHeight + (*this).floorHeightOffset <
           (*this).actor.world.pos.y {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_MoveToGround(mut this: *mut EnSt,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).takeDamageSpinTimer as libc::c_int != 0 as libc::c_int {
        (*this).takeDamageSpinTimer -= 1;
        ...
        EnSt_SetupAction(this,
                         Some(EnSt_ReturnToCeiling as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
    } else if EnSt_IsCloseToGround(this) != 0 {
        // The Skulltula has become close to the ground.
        EnSt_SpawnBlastEffect(this, globalCtx);
        EnSt_SetLandAnimation(this);
        EnSt_SetupAction(this,
                         Some(EnSt_LandOnGround as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
                                      -> ()));
    } else if (if (*this).sfxTimer as libc::c_int == 0 as libc::c_int {
                   0 as libc::c_int
               } else {
                   (*this).sfxTimer -= 1;
                   (*this).sfxTimer as libc::c_int
               }) == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3868 as libc::c_int as u16_0);
        (*this).sfxTimer = 3 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_ReturnToCeiling(mut this: *mut EnSt,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut animPctDone: f32_0 =
        (*this).skelAnime.curFrame / ((*this).skelAnime.animLength - 1.0f32);
    if animPctDone == 1.0f32 { EnSt_SetReturnToCeilingAnimation(this); }
    if EnSt_IsCloseToPlayer(this, globalCtx) != 0 {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_BounceAround(mut this: *mut EnSt,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).actor.colorFilterTimer = (*this).deathTimer as u8_0;
    func_8002D868(&mut (*this).actor);
    (*this).actor.world.rot.x =
        ((*this).actor.world.rot.x as libc::c_int + 0x800 as libc::c_int) as
            s16;
    (*this).actor.world.rot.z =
        ((*this).actor.world.rot.z as libc::c_int - 0x800 as libc::c_int) as
            s16;
    (*this).actor.shape.rot = (*this).actor.world.rot;
    if EnSt_IsDoneBouncing(this, globalCtx) != 0 {
        ...
        Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, 400.0f32, 0.4f32,
                           10000.0f32, 0.0f32);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_FinishBouncing(mut this: *mut EnSt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if (if (*this).deathTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).deathTimer -= 1; (*this).deathTimer as libc::c_int })
           == 0 as libc::c_int {
    ...
    if (if (*this).setTargetYawTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).setTargetYawTimer -= 1;
            (*this).setTargetYawTimer as libc::c_int
        }) == 0 as libc::c_int {
        (*this).deathYawTarget =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        (*this).setTargetYawTimer = 8 as libc::c_int as s16
    }
    Math_SmoothStepToS(&mut (*this).actor.world.rot.x,
                       0x3ffc as libc::c_int as s16, 4 as libc::c_int as s16,
                       0x2710 as libc::c_int as s16, 1 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.world.rot.z,
                       0 as libc::c_int as s16, 4 as libc::c_int as s16,
                       0x2710 as libc::c_int as s16, 1 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).deathYawTarget,
                       0xa as libc::c_int as s16,
                       0x2710 as libc::c_int as s16, 1 as libc::c_int as s16);
    (*this).actor.shape.rot = (*this).actor.world.rot;
    func_8002D868(&mut (*this).actor);
    (*this).groundBounces = 2 as libc::c_int as s16;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnSt_Die(mut this: *mut EnSt,
                                  mut globalCtx: *mut GlobalContext) {
    if (if (*this).finishDeathTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).finishDeathTimer -= 1;
            (*this).finishDeathTimer as libc::c_int
        }) != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_StartOnCeilingOrGround(mut this: *mut EnSt,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if EnSt_IsCloseToGround(this) == 0 {
        (*this).rotAwayTimer = 60 as libc::c_int as s16;
        EnSt_SetupAction(this,
                         Some(EnSt_WaitOnCeiling as
                                  unsafe extern "C" fn(_: *mut EnSt,
                                                       _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSt = thisx as *mut EnSt;
    let mut pad: s32 = 0;
    ...
    if (*this).actor.flags &
        ...
        if (*this).actionFunc ==
               Some(EnSt_WaitOnGround as
                        unsafe extern "C" fn(_: *mut EnSt,
                                             _: *mut GlobalContext) -> ()) {
            if (*globalCtx).state.frames & 0x10 as libc::c_int as libc::c_uint
                   != 0 as libc::c_int as libc::c_uint {
                color.r = 255 as libc::c_int as u8_0
            }
        }
        EnSt_SetTeethColor(this, color.r as s16, color.g as s16,
                           color.b as s16, 8 as libc::c_int as s16);
        EnSt_UpdateCylinders(this, globalCtx);
        Actor_SetFocus(&mut (*this).actor, 0.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
                                               mut dListP: *mut *mut Gfx,
                                               mut pos: *mut Vec3f,
                                               mut rot: *mut Vec3s,
 ...
 -> s32 {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_st.c\x00" as *const u8 as *const libc::c_char,
                    2260 as libc::c_int);
    match limbIndex {
        1 => {
            if (*this).gaveDamageSpinTimer as libc::c_int != 0 as libc::c_int
                   && (*this).swayTimer as libc::c_int == 0 as libc::c_int {
                if (*this).gaveDamageSpinTimer as libc::c_int >=
                       2 as libc::c_int {
                    EnSt_AddBlurVertex(this);
                } else { EnSt_AddBlurSpace(this); }
            }
        }
        4 => {
            // teeth
            ...
            (*_g_0).words.w0 =
                (0xfb as libc::c_int as u32_0 &
                    ...
                    24 as libc::c_int;
            (*_g_0).words.w1 =
                ((*this).teethR as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    ((*this).teethG as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*this).teethB as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnSt_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dListP: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnSt = thisx as *mut EnSt;
    Collider_UpdateSpheres(limbIndex, &mut (*this).colSph);
}
#[no_mangle]
pub unsafe extern "C" fn EnSt_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSt = thisx as *mut EnSt;
