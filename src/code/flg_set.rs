...
#[no_mangle]
pub unsafe extern "C" fn FlagSet_Update(mut globalCtx: *mut GlobalContext) {
    static mut entryIdx: s32 =
        0 as libc::c_int; // ? this doesn't need to be static
    static mut curBit: u32_0 = 0 as libc::c_int as u32_0;
    static mut timer: s32 = 0 as libc::c_int;
    static mut bitIdx: s32 = 0;
    let mut entries: [FlagSetEntry; 53] =
        [{
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(0
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[0]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[1]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(2
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[2]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(3
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[3]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(4
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[4]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(5
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[5]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(6
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[6]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(7
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[7]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(8
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[8]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(9
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[9]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(10
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[10]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(11
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[11]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(12
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[12]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventChkInf.as_mut_ptr().offset(13
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         isize)
                                      as *mut u16_0,
                              name:
                                  b"event_chk_inf[13]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.itemGetInf.as_mut_ptr().offset(0
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        isize)
                                      as *mut u16_0,
                              name:
                                  b"item_get_inf[0]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.itemGetInf.as_mut_ptr().offset(1
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        isize)
                                      as *mut u16_0,
                              name:
                                  b"item_get_inf[1]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.itemGetInf.as_mut_ptr().offset(2
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        isize)
                                      as *mut u16_0,
                              name:
                                  b"item_get_inf[2]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.itemGetInf.as_mut_ptr().offset(3
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        isize)
                                      as *mut u16_0,
                              name:
                                  b"item_get_inf[3]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(0
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[0]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[1]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[2]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(3
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[3]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(4
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[4]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(5
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[5]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(6
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[6]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(7
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[7]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(8
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[8]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(9
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[9]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(10
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[10]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(11
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[11]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(12
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[12]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(13
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[13]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(14
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[14]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(15
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[15]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(16
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[16]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(17
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[17]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(18
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[18]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(19
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[19]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(20
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[20]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(21
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[21]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(22
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[22]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(23
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[23]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(24
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[24]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(25
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[25]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(26
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[26]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(27
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[27]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(28
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[28]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.infTable.as_mut_ptr().offset(29
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"inf_table[29]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventInf.as_mut_ptr().offset(0
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"event_inf[0]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventInf.as_mut_ptr().offset(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"event_inf[1]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventInf.as_mut_ptr().offset(2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"event_inf[2]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         {
             let mut init =
                 FlagSetEntry{value:
                                  &mut *gSaveContext.eventInf.as_mut_ptr().offset(3
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize)
                                      as *mut u16_0,
                              name:
                                  b"event_inf[3]\x00" as *const u8 as
                                      *const libc::c_char,};
             init
         },
         FlagSetEntry{value: 0 as *mut u16_0,
    ...
    let mut polyOpa: *mut Gfx = 0 as *mut Gfx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../flg_set.c\x00" as *const u8 as *const libc::c_char,
                    131 as libc::c_int);
    ...
    GfxPrint_SetColor(&mut printer, 250 as libc::c_int as u32_0,
                      50 as libc::c_int as u32_0, 50 as libc::c_int as u32_0,
    ...
    GfxPrint_Printf(&mut printer as *mut GfxPrint,
                    entries[entryIdx as usize].name);
    GfxPrint_SetPos(&mut printer, 4 as libc::c_int, 15 as libc::c_int);
    bitIdx = 15 as libc::c_int;
    while bitIdx >= 0 as libc::c_int {
        if bitIdx as u32_0 == curBit {
            GfxPrint_SetColor(&mut printer, 200 as libc::c_int as u32_0,
                              200 as libc::c_int as u32_0,
                              200 as libc::c_int as u32_0,
                              255 as libc::c_int as u32_0);
        } else {
            GfxPrint_SetColor(&mut printer, 100 as libc::c_int as u32_0,
                              100 as libc::c_int as u32_0,
                              100 as libc::c_int as u32_0,
                              255 as libc::c_int as u32_0);
        }
        if *entries[entryIdx as usize].value as libc::c_int &
               (1 as libc::c_int) << bitIdx != 0 {
            GfxPrint_Printf(&mut printer as *mut GfxPrint,
        ...
        if bitIdx % 4 as libc::c_int == 0 as libc::c_int {
            GfxPrint_Printf(&mut printer as *mut GfxPrint,
    ...
    curBit =
        (curBit as
             libc::c_uint).wrapping_rem(16 as libc::c_int as libc::c_uint) as
            u32_0 as u32_0;
    if !((*input).press.button as libc::c_int | !(0x800 as libc::c_int)) ==
           0 as libc::c_int {
        entryIdx -= 1;
        if entryIdx < 0 as libc::c_int { entryIdx = 0 as libc::c_int }
        timer = 10 as libc::c_int
    }
    if !((*input).press.button as libc::c_int | !(0x400 as libc::c_int)) ==
        ...
        timer = 10 as libc::c_int;
        entryIdx += 1;
        if entries[entryIdx as usize].value.is_null() { entryIdx -= 1 }
    }
    if timer == 0 as libc::c_int {
    ...
    if !((*input).press.button as libc::c_int | !(0x8000 as libc::c_int)) ==
           0 as libc::c_int {
        *entries[entryIdx as usize].value =
            (*entries[entryIdx as usize].value as libc::c_int ^
                 (1 as libc::c_int) << curBit) as u16_0
    }
    if timer != 0 as libc::c_int { timer -= 1 }
    gfx = GfxPrint_Close(&mut printer);
    ...
    if !((*input).press.button as libc::c_int | !(0x20 as libc::c_int)) ==
           0 as libc::c_int {
        (*globalCtx).pauseCtx.debugState = 0 as libc::c_int as u16_0
    }
