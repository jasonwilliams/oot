...
pub const FIRE_ROCK_ON_FLOOR: C2RustUnnamed_19 = 6;
pub const FIRE_ROCK_CEILING_SPOT_SPAWNER: C2RustUnnamed_19 = 5;
pub const FIRE_ROCK_SPAWNED_FALLING2: C2RustUnnamed_19 = 3;
pub const FIRE_ROCK_BROKEN_PIECE2: C2RustUnnamed_19 = 2;
pub const FIRE_ROCK_BROKEN_PIECE1: C2RustUnnamed_19 = 1;
pub const FIRE_ROCK_SPAWNED_FALLING1: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFireRock {
    pub actor: Actor,
    pub angularVelocity: Vec3f,
    pub rockRotation: Vec3f,
    pub unk164: [libc::c_char; 4],
    pub actionFunc: EnFireRockActionFunc,
    pub scale: f32_0,
    pub relativePos: Vec3f,
    pub unk17C: Vec3f,
    pub timer: s16,
    pub timer2: s16,
    pub type_0: s16,
    pub playerNearby: u8_0,
    pub spawner: *mut EnEncount2,
    pub collider: ColliderCylinder,
}
pub type EnFireRockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFireRock, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const ENCOUNT2_ACTIVE_GANONS_TOWER: C2RustUnnamed_20 = 2;
pub const ENCOUNT2_ACTIVE_DEATH_MOUNTAIN: C2RustUnnamed_20 = 1;
pub const ENCOUNT2_INACTIVE: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut En_Encount2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ENCOUNT2 as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEncount2_Init
                                                                          as
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEncount2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEncount2_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEncount2 = thisx as *mut EnEncount2;
    if (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT16 as libc::c_int {
        (*this).isNotDeathMountain = 1 as libc::c_int as s16
    }
    if (*this).isNotDeathMountain == 0 {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "☆☆☆☆☆ Death Mountain Encount2 set ☆☆☆☆☆"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
        ...
        if gSaveContext.linkAge == 0 as libc::c_int &&
            ...
            // flag for having used fire temple blue warp
            Actor_Kill(thisx);
        }
    } else {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "☆☆☆☆☆ Ganon Tower Escape Encount2 set ☆☆☆☆☆"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
    }
    (*this).actionFunc =
        Some(EnEncount2_Wait as
                 unsafe extern "C" fn(_: *mut EnEncount2,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_Wait(mut this: *mut EnEncount2,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut quakeIndex: s16 = 0;
    let mut spawnerState: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    spawnerState = ENCOUNT2_INACTIVE as libc::c_int as s16;
    if (*this).isNotDeathMountain == 0 {
        if (*player).actor.world.pos.y > 1500.0f32 &&
               (*player).actor.world.pos.x > -700.0f32 &&
               (*player).actor.world.pos.x < 100.0f32 &&
               (*player).actor.world.pos.z < -1290.0f32 &&
               (*player).actor.world.pos.z > -3600.0f32 {
            spawnerState =
                ENCOUNT2_ACTIVE_DEATH_MOUNTAIN as libc::c_int as s16
        }
    } else if (*this).actor.xzDistToPlayer < 700.0f32 &&
                  Flags_GetSwitch(globalCtx, 0x37 as libc::c_int) != 0 {
        let mut scene: s16 = (*globalCtx).sceneNum;
        if (scene as libc::c_int == SCENE_GANON_DEMO as libc::c_int ||
                scene as libc::c_int == SCENE_GANON_FINAL as libc::c_int ||
                scene as libc::c_int == SCENE_GANON_SONOGO as libc::c_int ||
                scene as libc::c_int == SCENE_GANONTIKA_SONOGO as libc::c_int)
               && (*this).collapseSpawnerInactive == 0 {
            spawnerState = ENCOUNT2_ACTIVE_GANONS_TOWER as libc::c_int as s16
        }
    }
    let mut current_block_31: u64;
    match spawnerState as libc::c_int {
        0 => {
            (*this).isQuaking = 0 as libc::c_int as u64_0;
            (*this).envEffectsTimer -= 1;
            if (*this).envEffectsTimer as libc::c_int <= 0 as libc::c_int {
                (*this).envEffectsTimer = 0 as libc::c_int as s16
            }
            current_block_31 = 9520865839495247062;
        }
        1 => {
            if (*this).deathMountainSpawnerTimer as libc::c_int ==
                   1 as libc::c_int || (*this).isQuaking == 0 {
                quakeIndex =
                    Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                          as usize],
                              1 as libc::c_int as u32_0);
                Quake_SetSpeed(quakeIndex, 0x7fff as libc::c_int as s16);
                Quake_SetQuakeValues(quakeIndex, 50 as libc::c_int as s16,
                                     0 as libc::c_int as s16,
                                     0 as libc::c_int as s16,
                                     0 as libc::c_int as s16);
                Quake_SetCountdown(quakeIndex, 300 as libc::c_int as s16);
                (*this).isQuaking = 1 as libc::c_int as u64_0
            }
            current_block_31 = 7726973535289537441;
        }
        2 => { current_block_31 = 7726973535289537441; }
        _ => { current_block_31 = 9520865839495247062; }
    }
    match current_block_31 {
        7726973535289537441 => {
            (*this).envEffectsTimer += 1;
            if (*this).envEffectsTimer as libc::c_int > 60 as libc::c_int {
                (*this).envEffectsTimer = 60 as libc::c_int as s16
            }
            if (*this).deathMountainSpawnerTimer as libc::c_int ==
                   0 as libc::c_int {
                (*this).deathMountainSpawnerTimer = 200 as libc::c_int as s16;
                (*this).numSpawnedRocks = 0 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(EnEncount2_SpawnRocks as
                             unsafe extern "C" fn(_: *mut EnEncount2,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_SpawnRocks(mut this: *mut EnEncount2,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut spawnedRock: *mut EnFireRock = 0 as *mut EnFireRock;
    let mut tempVec1X: f32_0 = 0.;
    let mut tempVec1Y: f32_0 = 0.;
    let mut tempVec1Z: f32_0 = 0.;
    let mut magnitude: f32_0 = 0.;
    let mut tempVec2X: f32_0 = 0.;
    let mut tempVec2Y: f32_0 = 0.;
    let mut tempVec2Z: f32_0 = 0.;
    let mut particleScale: f32_0 = 0.;
    let mut particlePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spawnedRockType: s16 = 0;
    let mut spawnerState: s16 = 0;
    let mut maxRocks: s16 = 0;
    (*this).envEffectsTimer += 1;
    if (*this).envEffectsTimer as libc::c_int > 60 as libc::c_int {
        (*this).envEffectsTimer = 60 as libc::c_int as s16
    }
    ...
    if (*this).isNotDeathMountain == 0 {
        if (*this).deathMountainSpawnerTimer as libc::c_int ==
               0 as libc::c_int {
            (*this).deathMountainSpawnerTimer = 100 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnEncount2_Wait as
                         unsafe extern "C" fn(_: *mut EnEncount2,
                                              _: *mut GlobalContext) -> ());
        ...
        if (*player).actor.world.pos.y > 1500.0f32 &&
               ...
               (*player).actor.world.pos.x < 100.0f32 &&
               (*player).actor.world.pos.z < -1290.0f32 &&
               (*player).actor.world.pos.z > -3860.0f32 {
            maxRocks = 2 as libc::c_int as s16;
            spawnerState =
                ENCOUNT2_ACTIVE_DEATH_MOUNTAIN as libc::c_int as s16
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x2849 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    } else if (*this).actor.xzDistToPlayer < 700.0f32 &&
                  Flags_GetSwitch(globalCtx, 0x37 as libc::c_int) !=
                      0 as libc::c_int {
        let mut scene: s16 = (*globalCtx).sceneNum;
        if (scene as libc::c_int == SCENE_GANON_DEMO as libc::c_int ||
                scene as libc::c_int == SCENE_GANON_FINAL as libc::c_int ||
                ...
                scene as libc::c_int == SCENE_GANONTIKA_SONOGO as libc::c_int)
               && (*this).collapseSpawnerInactive == 0 {
            maxRocks = 1 as libc::c_int as s16;
            spawnerState = ENCOUNT2_ACTIVE_GANONS_TOWER as libc::c_int as s16
        }
    }
    if spawnerState as libc::c_int != ENCOUNT2_INACTIVE as libc::c_int {
        ...
        magnitude =
            sqrtf(tempVec1X * tempVec1X + tempVec1Y * tempVec1Y +
                      tempVec1Z * tempVec1Z);
        ...
        tempVec1X = (*globalCtx).view.eye.x + tempVec2X * 300.0f32;
        tempVec1Y = (*globalCtx).view.eye.y + tempVec2Y * 160.0f32 + 400.0f32;
        tempVec1Z = (*globalCtx).view.eye.z + tempVec2Z * 300.0f32;
        ...
        particlePos.x =
            Rand_CenteredFloat(200.0f32) +
                ((*globalCtx).view.eye.x + tempVec2X * 200.0f32);
        particlePos.y = Rand_CenteredFloat(50.0f32) + tempVec1Y;
        particlePos.z =
            Rand_CenteredFloat(200.0f32) +
                ((*globalCtx).view.eye.z + tempVec2Z * 200.0f32);
        particleScale = Rand_CenteredFloat(0.005f32) + 0.007f32;
        if spawnerState as libc::c_int ==
               ENCOUNT2_ACTIVE_DEATH_MOUNTAIN as libc::c_int {
            EnEncount2_ParticleInit(this, &mut particlePos, particleScale);
        } else if (*this).particleSpawnTimer as libc::c_int ==
                      0 as libc::c_int {
            EnEncount2_ParticleInit(this, &mut particlePos, particleScale);
            (*this).particleSpawnTimer = 5 as libc::c_int as s16
        }
        if ((*this).numSpawnedRocks as libc::c_int) < maxRocks as libc::c_int
               &&
               (*this).timerBetweenRockSpawns as libc::c_int ==
                   0 as libc::c_int {
            if spawnerState as libc::c_int ==
                   ENCOUNT2_ACTIVE_DEATH_MOUNTAIN as libc::c_int {
                (*this).timerBetweenRockSpawns = 4 as libc::c_int as s16;
                spawnedRockType =
                    FIRE_ROCK_SPAWNED_FALLING1 as libc::c_int as s16;
                if Rand_ZeroFloat(1.99f32) < 1.0f32 &&
                    ...
                    if (*player).linearVelocity != 0.0f32 {
                    ...
                    spawnedRockType =
                        FIRE_ROCK_SPAWNED_FALLING2 as libc::c_int as s16
                }
            } else {
                (*this).timerBetweenRockSpawns = 50 as libc::c_int as s16;
                spawnedRockType =
                    FIRE_ROCK_SPAWNED_FALLING2 as libc::c_int as s16;
                // rock spawn pos X,Z at a random position roughly 300 units ahead of camera
                tempVec2X = Rand_CenteredFloat(100.0f32) + tempVec1X;
                tempVec2Z = Rand_CenteredFloat(100.0f32) + tempVec1Z;
            ...
            spawnedRock =
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   ...
                                   ACTOR_EN_FIRE_ROCK as libc::c_int as s16,
                                   tempVec2X, tempVec1Y, tempVec2Z,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16, spawnedRockType)
                    as *mut EnFireRock;
            if !spawnedRock.is_null() {
                (*spawnedRock).spawner = this;
                (*this).numSpawnedRocks += 1;
                return
            }
            // "☆☆☆☆☆ Can't occur! ☆☆☆☆☆"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\n\x1b[m\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_Update(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut this: *mut EnEncount2 = thisx as *mut EnEncount2;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    if (*this).deathMountainSpawnerTimer as libc::c_int != 0 as libc::c_int {
        (*this).deathMountainSpawnerTimer -= 1
    }
    if (*this).timerBetweenRockSpawns as libc::c_int != 0 as libc::c_int {
        (*this).timerBetweenRockSpawns -= 1
    }
    if (*this).particleSpawnTimer as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).isNotDeathMountain == 0 {
        (*this).unk17C =
            (*this).envEffectsTimer as libc::c_int as libc::c_float / 60.0f32;
        (*this).unk160 = (*this).unk17C * -50.0f32;
        (*globalCtx).envCtx.adjAmbientColor[0 as libc::c_int as usize] =
            ((*this).unk160 as s16 as libc::c_int as libc::c_float * -1.5f32)
                as s16;
        (*globalCtx).envCtx.adjAmbientColor[2 as libc::c_int as usize] =
            (*this).unk160 as s16;
        (*globalCtx).envCtx.adjAmbientColor[1 as libc::c_int as usize] =
            (*globalCtx).envCtx.adjAmbientColor[2 as libc::c_int as usize];
        (*this).unk168 = (*this).unk17C * -20.0f32;
        (*globalCtx).envCtx.adjLight1Color[0 as libc::c_int as usize] =
            ((*this).unk168 as s16 as libc::c_int as libc::c_float * -1.5f32)
                as s16;
        (*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize] =
            (*this).unk168 as s16;
        (*globalCtx).envCtx.adjLight1Color[1 as libc::c_int as usize] =
            (*globalCtx).envCtx.adjLight1Color[2 as libc::c_int as usize];
        (*this).unk170 = (*this).unk17C * -50.0f32;
        (*globalCtx).envCtx.adjFogNear = (*this).unk170 as s16;
        (*globalCtx).envCtx.adjFogColor[0 as libc::c_int as usize] =
            ((160.0f32 -
                  (*globalCtx).envCtx.lightSettings.fogColor[0 as libc::c_int
                                                                 as usize] as
                      libc::c_int as libc::c_float) * (*this).unk17C) as u8_0
                as s16;
        (*globalCtx).envCtx.adjFogColor[1 as libc::c_int as usize] =
            ((160.0f32 -
                  (*globalCtx).envCtx.lightSettings.fogColor[1 as libc::c_int
                                                                 as usize] as
                      libc::c_int as libc::c_float) * (*this).unk17C) as u8_0
                as s16;
        (*globalCtx).envCtx.adjFogColor[2 as libc::c_int as usize] =
            ((150.0f32 -
                  (*globalCtx).envCtx.lightSettings.fogColor[2 as libc::c_int
                                                                 as usize] as
                      libc::c_int as libc::c_float) * (*this).unk17C) as u8_0
                as s16
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEncount2 = thisx as *mut EnEncount2;
    EnEncount2_ParticleDraw(&mut (*this).actor, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_ParticleInit(mut this: *mut EnEncount2,
                                                 mut particlePos: *mut Vec3f,
                                                 mut scale: f32_0) {
    let mut particle: *mut EnEncount2Particle =
        (*this).particles.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnEncount2Particle; 50]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnEncount2Particle>()
                                                   as libc::c_ulong) as s32 {
        if (*particle).isAlive == 0 {
            (*particle).pos = *particlePos;
            (*particle).scale = scale;
            (*particle).rot.x = 0.0f32;
            (*particle).rot.y = 0.0f32;
            (*particle).rot.z = 0.0f32;
            (*particle).moveDirection.x = Rand_CenteredFloat(20.0f32);
            (*particle).moveDirection.y = -20.0f32;
            (*particle).moveDirection.z = Rand_CenteredFloat(20.0f32);
            (*particle).isAlive = 1 as libc::c_int as u8_0;
            break ;
        } else { i += 1; particle = particle.offset(1) }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_ParticleUpdate(mut this: *mut EnEncount2,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut i: s16 = 0;
    let mut particle: *mut EnEncount2Particle =
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnEncount2Particle; 50]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnEncount2Particle>()
                                                   as libc::c_ulong) as s32 {
        if (*particle).isAlive != 0 {
            (*particle).rot.x += Rand_ZeroOne() * 500.0f32;
            (*particle).rot.y += Rand_ZeroOne() * 500.0f32;
            (*particle).rot.z += Rand_ZeroOne() * 500.0f32;
            ...
            Math_ApproachF(&mut (*particle).pos.x, targetPos.x, 0.3f32,
                           30.0f32);
            Math_ApproachF(&mut (*particle).pos.y, targetPos.y, 0.8f32,
                           250.0f32);
            Math_ApproachF(&mut (*particle).pos.z, targetPos.z, 0.3f32,
                           30.0f32);
            Math_ApproachF(&mut (*particle).moveDirection.y, -20.0f32, 0.9f32,
                           1.0f32);
            if (*globalCtx).sceneNum as libc::c_int !=
                   SCENE_SPOT16 as libc::c_int {
                if (*particle).pos.y < (*player).actor.floorHeight - 50.0f32 {
                    (*particle).isAlive = 0 as libc::c_int as u8_0
                }
            } else if (*particle).pos.y < 1500.0f32 {
                (*particle).isAlive = 0 as libc::c_int as u8_0
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount2_ParticleDraw(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnEncount2 = thisx as *mut EnEncount2;
    let mut particle: *mut EnEncount2Particle =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_encount2.c\x00" as *const u8 as
                        *const libc::c_char, 642 as libc::c_int);
    objBankIndex =
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            (*globalCtx).objectCtx.status[objBankIndex as usize].segment as
                libc::c_uint;
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) <
                  (::std::mem::size_of::<[EnEncount2Particle; 50]>() as
            ...
            if (*particle).isAlive != 0 {
                ...
                Matrix_RotateX((*particle).rot.x *
                                   (3.14159265358979323846f32 / 180.0f32),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateY((*particle).rot.y *
                                   (3.14159265358979323846f32 / 180.0f32),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateZ((*particle).rot.z *
                                   (3.14159265358979323846f32 / 180.0f32),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_Scale((*particle).scale, (*particle).scale,
                             (*particle).scale,
                             MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (*_g_3).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_en_encount2.c\x00" as *const u8 as
                                      ...
                                      *mut libc::c_char, 669 as libc::c_int)
                        as libc::c_uint;
                ...
                (*_g_4).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_4).words.w1 =
                    object_efc_star_field_DL_000DE0.as_mut_ptr() as
                        libc::c_uint
            }
            particle = particle.offset(1);
            i += 1
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_en_encount2.c\x00" as *const u8 as
                         *const libc::c_char, 678 as libc::c_int);
}
