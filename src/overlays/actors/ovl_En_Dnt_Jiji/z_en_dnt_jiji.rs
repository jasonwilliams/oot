...
extern "C" {
    ...
    #[no_mangle]
    static mut gDntJijiBurrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiCowerAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiHideAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiTalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiUnburrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntJijiFlowerDL: [Gfx; 0];
    #[no_mangle]
    static mut gDntJijiEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntJijiEyeShutTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntJijiEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntJijiSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDntJijiWalkAnim: AnimationHeader;
}
...
pub const UPG_NUTS: C2RustUnnamed_21 = 7;
pub const UPG_STICKS: C2RustUnnamed_21 = 6;
pub const UPG_BULLET_BAG: C2RustUnnamed_21 = 5;
pub const UPG_WALLET: C2RustUnnamed_21 = 4;
pub const UPG_SCALE: C2RustUnnamed_21 = 3;
pub const UPG_STRENGTH: C2RustUnnamed_21 = 2;
pub const UPG_BOMB_BAG: C2RustUnnamed_21 = 1;
pub const UPG_QUIVER: C2RustUnnamed_21 = 0;
...
pub const DNT_SIGNAL_UNUSED: C2RustUnnamed_26 = 6;
pub const DNT_SIGNAL_RETURN: C2RustUnnamed_26 = 5;
pub const DNT_SIGNAL_HIDE: C2RustUnnamed_26 = 4;
pub const DNT_SIGNAL_DANCE: C2RustUnnamed_26 = 3;
pub const DNT_SIGNAL_CELEBRATE: C2RustUnnamed_26 = 2;
pub const DNT_SIGNAL_LOOK: C2RustUnnamed_26 = 1;
pub const DNT_SIGNAL_NONE: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const DNT_LEADER_ACTION_ATTACK: C2RustUnnamed_27 = 3;
pub const DNT_LEADER_ACTION_UNUSED: C2RustUnnamed_27 = 2;
pub const DNT_LEADER_ACTION_UP: C2RustUnnamed_27 = 1;
pub const DNT_LEADER_ACTION_NONE: C2RustUnnamed_27 = 0;
pub type C2RustUnnamed_28 = libc::c_uint;
pub const DNT_LEADER_SIGNAL_RETURN: C2RustUnnamed_28 = 3;
pub const DNT_LEADER_SIGNAL_BURROW: C2RustUnnamed_28 = 2;
pub const DNT_LEADER_SIGNAL_UP: C2RustUnnamed_28 = 1;
pub const DNT_LEADER_SIGNAL_NONE: C2RustUnnamed_28 = 0;
pub type C2RustUnnamed_29 = libc::c_uint;
pub const DNT_ACTION_PRIZE: C2RustUnnamed_29 = 5;
pub const DNT_ACTION_HIGH_RUPEES: C2RustUnnamed_29 = 4;
pub const DNT_ACTION_LOW_RUPEES: C2RustUnnamed_29 = 3;
pub const DNT_ACTION_ATTACK: C2RustUnnamed_29 = 2;
pub const DNT_ACTION_DANCE: C2RustUnnamed_29 = 1;
pub const DNT_ACTION_NONE: C2RustUnnamed_29 = 0;
#[no_mangle]
pub static mut En_Dnt_Jiji_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DNT_JIJI as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_DNS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDntJiji>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntJiji_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntJiji_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDntJiji = thisx as *mut EnDntJiji;
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 0.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gDntJijiSkel,
                   &mut gDntJijiBurrowAnim, (*this).jointTable.as_mut_ptr(),
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInit);
    (*this).stage = (*this).actor.parent as *mut EnDntDemo;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Deku Scrub mask show elder"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x87\xe3\x82\xb0\xe3\x83\x8a\xe3\x83\x83\xe3\x83\x84\xe3\x81\x8a\xe9\x9d\xa2\xe5\x93\x81\xe8\xa9\x95\xe4\xbc\x9a\xe9\x95\xb7\xe8\x80\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char, (*this).stage);
    (*this).actor.flags &=
    ...
    (*this).actionFunc =
        Some(EnDntJiji_SetFlower as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.gravity = -2.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntJiji = thisx as *mut EnDntJiji;
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetFlower(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).flowerPos = (*this).actor.world.pos;
        (*this).actionFunc =
            Some(EnDntJiji_SetupWait as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupWait(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiBurrowAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiBurrowAnim, 0.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).skelAnime.curFrame = 8.0f32;
    (*this).action = DNT_LEADER_ACTION_NONE as libc::c_int as s16;
    (*this).isSolid = (*this).action as u8_0;
    (*this).actionFunc =
        Some(EnDntJiji_Wait as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Wait(mut this: *mut EnDntJiji,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 1 as libc::c_int &&
        ...
        OnePointCutscene_Init(globalCtx, 2230 as libc::c_int as s16,
        ...
        (*this).actionFunc =
            Some(EnDntJiji_SetupUnburrow as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupUp(mut this: *mut EnDntJiji,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiUpAnim as *mut AnimationHeader as
                                   *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiUpAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos, 6.0f32,
                             0 as libc::c_int as s16,
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x387c as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnDntJiji_Up as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Up(mut this: *mut EnDntJiji,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).actor.xzDistToPlayer < 150.0f32 {
        (*this).actionFunc =
            Some(EnDntJiji_SetupCower as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupUnburrow(mut this: *mut EnDntJiji,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiUnburrowAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiUnburrowAnim,
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x387c as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnDntJiji_Unburrow as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Unburrow(mut this: *mut EnDntJiji,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).endFrame as libc::c_int as libc::c_float <= frame {
        if (*this).action as libc::c_int !=
               DNT_LEADER_ACTION_ATTACK as libc::c_int {
            (*this).actionFunc =
                Some(EnDntJiji_SetupWalk as
                         unsafe extern "C" fn(_: *mut EnDntJiji,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(EnDntJiji_SetupReturn as
                         unsafe extern "C" fn(_: *mut EnDntJiji,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupWalk(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiWalkAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.speedXZ = 1.0f32;
    (*this).isSolid = 1 as libc::c_int as u8_0;
    (*this).unburrow = 1 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDntJiji_Walk as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Walk(mut this: *mut EnDntJiji,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
    ...
    Math_ApproachF(&mut (*this).actor.speedXZ, 1.0f32, 0.2f32, 0.4f32);
    if (*this).sfxTimer as libc::c_int == 0 as libc::c_int {
        (*this).sfxTimer = 5 as libc::c_int as s16;
    ...
    if (*this).actor.xzDistToPlayer < 100.0f32 {
        if (gSaveContext.inventory.upgrades &
            ...
            (*this).getItemId = GI_STICK_UPGRADE_20 as libc::c_int
        } else { (*this).getItemId = GI_STICK_UPGRADE_30 as libc::c_int }
        (*this).actor.textId = 0x104d as libc::c_int as u16_0;
        Message_StartTextbox(globalCtx, (*this).actor.textId,
                             0 as *mut Actor);
        (*this).actor.speedXZ = 0.0f32;
        (*this).unused = 5 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDntJiji_Talk as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupBurrow(mut this: *mut EnDntJiji,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiBurrowAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiBurrowAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos, 6.0f32,
                             0 as libc::c_int as s16,
                             ...
                             10 as libc::c_int as s16, 0 as *mut Gfx);
    Audio_PlayActorSound2(&mut (*this).actor, 0x387c as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x387d as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnDntJiji_Burrow as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Burrow(mut this: *mut EnDntJiji,
                                          mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupCower(mut this: *mut EnDntJiji,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiCowerAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiCowerAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos, 3.0f32,
                             0 as libc::c_int as s16, 9 as libc::c_int as s16,
    ...
    if (gSaveContext.inventory.upgrades &
           ...
           gUpgradeShifts[UPG_NUTS as libc::c_int as usize] as libc::c_int ==
           1 as libc::c_int ||
           (gSaveContext.inventory.upgrades &
                gUpgradeMasks[UPG_NUTS as libc::c_int as usize]) as s32 >>
               gUpgradeShifts[UPG_NUTS as libc::c_int as usize] as libc::c_int
               == 0 as libc::c_int {
        (*this).getItemId = GI_NUT_UPGRADE_30 as libc::c_int
    } else { (*this).getItemId = GI_NUT_UPGRADE_40 as libc::c_int }
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.textId = 0x10db as libc::c_int as u16_0;
    (*this).unused = 5 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDntJiji_Cower as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Cower(mut this: *mut EnDntJiji,
                                         mut globalCtx: *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupTalk(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiTalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiTalkAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnDntJiji_Talk as
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Talk(mut this: *mut EnDntJiji,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8002F434(&mut (*this).actor, globalCtx, (*this).getItemId,
                      400.0f32, 200.0f32);
        (*this).actionFunc =
            Some(EnDntJiji_SetupGivePrize as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupGivePrize(mut this: *mut EnDntJiji,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnDntJiji_GivePrize as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx, (*this).getItemId,
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_GivePrize(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if (*this).getItemId == GI_NUT_UPGRADE_30 as libc::c_int ||
               (*this).getItemId == GI_NUT_UPGRADE_40 as libc::c_int {
            // "nut"
            osSyncPrintf(b"\xe5\xae\x9f \n\x00" as *const u8 as
                             *const libc::c_char);
            osSyncPrintf(b"\xe5\xae\x9f \n\x00" as *const u8 as
                             *const libc::c_char);
            osSyncPrintf(b"\xe5\xae\x9f \n\x00" as *const u8 as
        ...
        if !(*this).stage.is_null() && (*(*this).stage).actor.update.is_some()
           {
            (*(*this).stage).action = DNT_ACTION_NONE as libc::c_int as s16;
            if (*this).unburrow == 0 {
                (*(*this).stage).leaderSignal =
                    DNT_SIGNAL_HIDE as libc::c_int as s16
            } else {
                (*(*this).stage).leaderSignal =
                    DNT_SIGNAL_RETURN as libc::c_int as s16
            }
        }
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupHide(mut this: *mut EnDntJiji,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiHideAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntJijiHideAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnDntJiji_Hide as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Hide(mut this: *mut EnDntJiji,
                                        mut globalCtx: *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).endFrame as libc::c_int as libc::c_float <= frame {
...
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_SetupReturn(mut this: *mut EnDntJiji,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntJijiWalkAnim as *mut AnimationHeader
    ...
    (*this).unburrow = 1 as libc::c_int as s16;
    (*this).isSolid = (*this).unburrow as u8_0;
    (*this).actionFunc =
        Some(EnDntJiji_Return as
                 unsafe extern "C" fn(_: *mut EnDntJiji,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Return(mut this: *mut EnDntJiji,
                                          mut globalCtx: *mut GlobalContext) {
    let mut dx: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if fabsf(dx) < 5.0f32 && fabsf(dz) < 5.0f32 {
        ...
        (*this).actionFunc =
            Some(EnDntJiji_SetupBurrow as
                     unsafe extern "C" fn(_: *mut EnDntJiji,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntJiji = thisx as *mut EnDntJiji;
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
           ...
           != 0 {
        // "time"
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x99\x82\xe9\x96\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
    ...
    match (*this).stageSignal as libc::c_int {
        1 => {
            (*this).isSolid = 1 as libc::c_int as u8_0;
            (*this).action = DNT_LEADER_ACTION_UP as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDntJiji_SetupUp as
                         unsafe extern "C" fn(_: *mut EnDntJiji,
                                              _: *mut GlobalContext) -> ())
        }
        2 => {
    ...
    if (*this).stageSignal as libc::c_int !=
           DNT_LEADER_SIGNAL_NONE as libc::c_int {
        (*this).stageSignal = DNT_LEADER_SIGNAL_NONE as libc::c_int as s16
    }
    if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
        (*this).eyeState += 1;
        if (*this).eyeState as libc::c_int > 2 as libc::c_int {
    ...
    if (*this).isSolid as libc::c_int != 0 as libc::c_int {
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntJiji_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut blinkTex: [*mut libc::c_void; 3] =
        unsafe {
            [gDntJijiEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDntJijiEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDntJijiEyeShutTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnDntJiji = thisx as *mut EnDntJiji;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dnt_jiji.c\x00" as *const u8 as
                        *const libc::c_char, 1019 as libc::c_int);
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gDntJijiFlowerDL.as_mut_ptr() as libc::c_uint;
