...
extern "C" {
    ...
    #[no_mangle]
    fn Math3D_PointInSquare2D(upperLeftX: f32_0, lowerRightX: f32_0,
                              upperLeftY: f32_0, lowerRightY: f32_0, x: f32_0,
                              y: f32_0) -> s32;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGameCheckBase {
    pub actor: Actor,
    pub type_0: s32,
}
pub type EnHorseGameCheckFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                _: *mut GlobalContext) -> s32>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGameCheckIngoRace {
    pub base: EnHorseGameCheckBase,
    pub startFlags: s32,
    pub playerCheck: [s32; 3],
    pub ingoCheck: [s32; 3],
    pub ingoHorse: *mut Actor,
    pub startTimer: s32,
    pub result: s32,
    pub finishTimer: s32,
    pub playerFinish: s32,
    pub ingoFinish: s32,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGameCheckGerudoArchery {
    pub base: EnHorseGameCheckBase,
    pub unk_150: s32,
    pub startTimer: u32_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGameCheck3 {
    pub base: EnHorseGameCheckBase,
    pub unk_150: s32,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGameCheckMalonRace {
    pub base: EnHorseGameCheckBase,
    pub startTimer: s32,
    pub raceFlags: s32,
    pub fenceCheck: [s32; 16],
    pub finishTimer: s32,
    pub result: s32,
    pub lapCount: s32,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub union EnHorseGameCheck {
    pub ingo: EnHorseGameCheckIngoRace,
    pub gerudo: EnHorseGameCheckGerudoArchery,
    pub type3: EnHorseGameCheck3,
    pub malon: EnHorseGameCheckMalonRace,
}
pub type C2RustUnnamed_19 = libc::c_uint;
pub const HORSEGAME_MALON_RACE: C2RustUnnamed_19 = 4;
pub const HORSEGAME_TYPE3: C2RustUnnamed_19 = 3;
pub const HORSEGAME_GERUDO_ARCHERY: C2RustUnnamed_19 = 2;
pub const HORSEGAME_INGO_RACE: C2RustUnnamed_19 = 1;
pub const HORSEGAME_NONE: C2RustUnnamed_19 = 0;
...
pub const INGORACE_TIME_UP: C2RustUnnamed_20 = 3;
pub const INGORACE_INGO_WIN: C2RustUnnamed_20 = 2;
pub const INGORACE_PLAYER_WIN: C2RustUnnamed_20 = 1;
pub const INGORACE_NO_RESULT: C2RustUnnamed_20 = 0;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const MALONRACE_FAILURE: C2RustUnnamed_21 = 4;
pub const MALONRACE_UNUSED: C2RustUnnamed_21 = 3;
pub const MALONRACE_TIME_UP: C2RustUnnamed_21 = 2;
pub const MALONRACE_SUCCESS: C2RustUnnamed_21 = 1;
pub const MALONRACE_NO_RESULT: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut En_Horse_Game_Check_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HORSE_GAME_CHECK as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnHorseGameCheck>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGameCheck_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGameCheck_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGameCheck_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGameCheck_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sIngoRaceCheckpoints: [Vec3f; 3] =
    [{ let mut init = Vec3f{x: 1700.0f32, y: 1.0f32, z: -540.0f32,}; init },
     { let mut init = Vec3f{x: 117.0f32, y: 1.0f32, z: 488.0f32,}; init },
     { let mut init = Vec3f{x: -1700.0f32, y: 1.0f32, z: -540.0f32,}; init }];
static mut sFinishLine: [f32_0; 4] =
    [-200.0f32, 80.0f32, -2300.0f32, -1470.0f32];
static mut sRanchExit: [f32_0; 4] =
    [800.0f32, 1000.0f32, -2900.0f32, -2700.0f32];
static mut sFencePos: [Vec3f; 8] =
    [{ let mut init = Vec3f{x: 820.0f32, y: -44.0f32, z: -1655.0f32,}; init },
     {
         let mut init = Vec3f{x: 1497.0f32, y: -21.0f32, z: -1198.0f32,};
         init
     },
     { let mut init = Vec3f{x: 1655.0f32, y: -44.0f32, z: -396.0f32,}; init },
     { let mut init = Vec3f{x: 1291.0f32, y: -44.0f32, z: 205.0f32,}; init },
     { let mut init = Vec3f{x: 379.0f32, y: -21.0f32, z: 455.0f32,}; init },
     { let mut init = Vec3f{x: -95.0f32, y: -21.0f32, z: 455.0f32,}; init },
     { let mut init = Vec3f{x: -939.0f32, y: 1.0f32, z: 455.0f32,}; init },
     {
         let mut init = Vec3f{x: -1644.0f32, y: -21.0f32, z: -1035.0f32,};
         init
     }];
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_InitIngoRace(mut base:
                                                           *mut EnHorseGameCheckBase,
                                                       mut globalCtx:
                                                           *mut GlobalContext)
 -> s32 {
    let mut this: *mut EnHorseGameCheckIngoRace =
        base as *mut EnHorseGameCheckIngoRace;
    let mut i: s32 = 0;
    (*this).base.type_0 = HORSEGAME_INGO_RACE as libc::c_int;
    (*this).startFlags = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        (*this).playerCheck[i as usize] = 0 as libc::c_int;
        i += 1
    }
    (*this).ingoHorse =
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_HORSE as libc::c_int as s16, -250.0f32, 1.0f32,
                    -1650.0f32, 0 as libc::c_int as s16,
                    0x4000 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0x8003 as libc::c_int as s16);
    if (*this).ingoHorse.is_null() {
        LogUtils_HungupThread(b"../z_en_horse_game_check.c\x00" as *const u8
                                  as *const libc::c_char, 385 as libc::c_int);
    }
    (*this).startTimer = 0 as libc::c_int;
    (*this).finishTimer = 0 as libc::c_int;
    (*this).result = INGORACE_NO_RESULT as libc::c_int;
    (*this).playerFinish = 0 as libc::c_int;
    (*this).ingoFinish = 0 as libc::c_int;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_DestroyIngoRace(mut base:
                                                              *mut EnHorseGameCheckBase,
                                                          mut globalCtx:
                                                              *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_FinishIngoRace(mut this:
                                                             *mut EnHorseGameCheckIngoRace,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    gSaveContext.cutsceneIndex = 0 as libc::c_int;
    if (*this).result == INGORACE_PLAYER_WIN as libc::c_int {
        (*globalCtx).nextEntranceIndex = 0x4ce as libc::c_int as s16;
        if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
            ...
            Environment_ForcePlaySequence(0x42 as libc::c_int as u16_0);
        } else {
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0xf as libc::c_int) | 4 as libc::c_int)
                    as u16_0;
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0x8000 as libc::c_int) |
        ...
        (*globalCtx).nextEntranceIndex = 0x558 as libc::c_int as s16;
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0xf as libc::c_int) | 3 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_UpdateIngoRace(mut base:
                                                             *mut EnHorseGameCheckBase,
                                                         mut globalCtx:
                                                             *mut GlobalContext)
 -> s32 {
    ...
    let mut i: s32 = 0;
    let mut ingoHorse: *mut EnHorse = 0 as *mut EnHorse;
    let mut horse: *mut EnHorse = 0 as *mut EnHorse;
    if (*this).startTimer > 50 as libc::c_int &&
           (*this).startFlags & (1 as libc::c_int) << 1 as libc::c_int == 0 {
        (*this).startFlags |= (1 as libc::c_int) << 1 as libc::c_int;
        func_80088B34(0 as libc::c_int as s16);
    } else if (*this).startTimer > 80 as libc::c_int &&
                  !(*player).rideActor.is_null() &&
                  (*this).startFlags & (1 as libc::c_int) << 0 as libc::c_int
                      == 0 {
        (*this).startFlags |= (1 as libc::c_int) << 0 as libc::c_int;
        horse = (*player).rideActor as *mut EnHorse;
        (*horse).inRace = 1 as libc::c_int
    } else if (*this).startTimer > 81 as libc::c_int &&
                  (*this).startFlags & (1 as libc::c_int) << 2 as libc::c_int
                      == 0 {
        ingoHorse = (*this).ingoHorse as *mut EnHorse;
        (*ingoHorse).inRace = 1 as libc::c_int;
        (*this).startFlags |= (1 as libc::c_int) << 2 as libc::c_int;
        Audio_PlaySoundGeneral(0x4835 as libc::c_int as u16_0,
    ...
    while i < 3 as libc::c_int {
        if !(*player).rideActor.is_null() &&
               Math3D_Vec3f_DistXYZ(&mut *sIngoRaceCheckpoints.as_mut_ptr().offset(i
                                                                                       as
                                                                                       isize),
                                    &mut (*(*player).rideActor).world.pos) <
                   400.0f32 {
            if i > 0 as libc::c_int &&
                   (*this).playerCheck[(i - 1 as libc::c_int) as usize] ==
                       1 as libc::c_int {
                (*this).playerCheck[i as usize] = 1 as libc::c_int
            } else if i == 0 as libc::c_int {
                (*this).playerCheck[i as usize] = 1 as libc::c_int
            }
        }
        if Math3D_Vec3f_DistXYZ(&mut *sIngoRaceCheckpoints.as_mut_ptr().offset(i
                                                                                   as
                                                                                   isize),
                                &mut (*(*this).ingoHorse).world.pos) <
               400.0f32 {
            if i > 0 as libc::c_int &&
                   (*this).ingoCheck[(i - 1 as libc::c_int) as usize] ==
                       1 as libc::c_int {
                (*this).ingoCheck[i as usize] = 1 as libc::c_int
            } else if i == 0 as libc::c_int {
                (*this).ingoCheck[i as usize] = 1 as libc::c_int
            }
        }
    ...
    if (*this).result == INGORACE_NO_RESULT as libc::c_int {
        let mut player2: *mut Player = player;
        if !(*player2).rideActor.is_null() &&
               (*this).playerCheck[2 as libc::c_int as usize] ==
                   1 as libc::c_int &&
               Math3D_PointInSquare2D(sFinishLine[0 as libc::c_int as usize],
                                      sFinishLine[1 as libc::c_int as usize],
                                      sFinishLine[2 as libc::c_int as usize],
                                      sFinishLine[3 as libc::c_int as usize],
                                      (*(*player2).rideActor).world.pos.x,
                                      (*(*player2).rideActor).world.pos.z) !=
                   0 {
            (*this).playerFinish += 1;
            if (*this).playerFinish > 0 as libc::c_int {
                (*this).result = INGORACE_PLAYER_WIN as libc::c_int;
                (*this).finishTimer = 55 as libc::c_int;
        ...
        if !(*this).ingoHorse.is_null() &&
               (*this).ingoCheck[2 as libc::c_int as usize] ==
                   1 as libc::c_int &&
               Math3D_PointInSquare2D(sFinishLine[0 as libc::c_int as usize],
                                      sFinishLine[1 as libc::c_int as usize],
                                      sFinishLine[2 as libc::c_int as usize],
                                      sFinishLine[3 as libc::c_int as usize],
                                      (*(*this).ingoHorse).world.pos.x,
                                      (*(*this).ingoHorse).world.pos.z) != 0 {
            (*this).ingoFinish += 1;
            if (*this).ingoFinish > 0 as libc::c_int {
                ingoHorse = (*this).ingoHorse as *mut EnHorse;
                (*this).result = INGORACE_INGO_WIN as libc::c_int;
                (*this).finishTimer = 70 as libc::c_int;
                (*ingoHorse).stateFlags |=
            ...
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                (*this).ingoCheck[i as usize] = 0 as libc::c_int;
                i += 1
            }
        }
        if !(*player2).rideActor.is_null() &&
               Math3D_PointInSquare2D(sRanchExit[0 as libc::c_int as usize],
                                      sRanchExit[1 as libc::c_int as usize],
                                      sRanchExit[2 as libc::c_int as usize],
                                      sRanchExit[3 as libc::c_int as usize],
                                      (*(*player2).rideActor).world.pos.x,
                                      (*(*player2).rideActor).world.pos.z) !=
                   0 ||
               Math3D_PointInSquare2D(sRanchExit[0 as libc::c_int as usize],
                                      ...
                                      sRanchExit[2 as libc::c_int as usize],
                                      sRanchExit[3 as libc::c_int as usize],
                                      (*player2).actor.world.pos.x,
                                      (*player2).actor.world.pos.z) != 0 {
            Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                                   24 as libc::c_int | 0x41 as libc::c_int) as
                                  u32_0);
            (*this).result = INGORACE_INGO_WIN as libc::c_int;
            (*this).finishTimer = 20 as libc::c_int
        }
        if gSaveContext.timer1Value as libc::c_int >= 180 as libc::c_int &&
               (*this).startFlags & 2 as libc::c_int != 0 {
            Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                                   24 as libc::c_int | 0x41 as libc::c_int) as
                                  u32_0);
            (*this).result = INGORACE_TIME_UP as libc::c_int;
            (*this).finishTimer = 20 as libc::c_int
        }
    } else if (*this).finishTimer > 0 as libc::c_int {
        (*this).finishTimer -= 1
    } else { EnHorseGameCheck_FinishIngoRace(this, globalCtx); }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_InitGerudoArchery(mut base:
                                                                *mut EnHorseGameCheckBase,
                                                            mut globalCtx:
                                                                *mut GlobalContext)
 -> s32 {
    let mut this: *mut EnHorseGameCheckGerudoArchery =
        base as *mut EnHorseGameCheckGerudoArchery;
    (*this).base.type_0 = HORSEGAME_GERUDO_ARCHERY as libc::c_int;
    (*this).unk_150 = 0 as libc::c_int;
    (*this).startTimer = 0 as libc::c_int as u32_0;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_DestroyGerudoArchery(mut base:
                                                                   *mut EnHorseGameCheckBase,
                                                               mut globalCtx:
                                                                   *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_UpdateGerudoArchery(mut base:
                                                                  *mut EnHorseGameCheckBase,
                                                              mut globalCtx:
                                                                  *mut GlobalContext)
 -> s32 {
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut horse: *mut EnHorse = (*player).rideActor as *mut EnHorse;
    if horse.is_null() { return 1 as libc::c_int }
    if (*this).startTimer > 90 as libc::c_int as libc::c_uint {
        !globalCtx.is_null();
        (*horse).hbaStarted = 1 as libc::c_int
    }
    (*this).startTimer = (*this).startTimer.wrapping_add(1);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_InitType3(mut base:
                                                        *mut EnHorseGameCheckBase,
                                                    mut globalCtx:
                                                        *mut GlobalContext)
 -> s32 {
    let mut this: *mut EnHorseGameCheck3 = base as *mut EnHorseGameCheck3;
    (*this).base.type_0 = HORSEGAME_TYPE3 as libc::c_int;
    (*this).unk_150 = 0 as libc::c_int;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_DestroyType3(mut base:
                                                           *mut EnHorseGameCheckBase,
                                                       mut globalCtx:
                                                           *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_UpdateType3(mut base:
                                                          *mut EnHorseGameCheckBase,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_InitMalonRace(mut base:
                                                            *mut EnHorseGameCheckBase,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    let mut this: *mut EnHorseGameCheckMalonRace =
        base as *mut EnHorseGameCheckMalonRace;
    let mut i: s32 = 0;
    (*this).base.type_0 = HORSEGAME_MALON_RACE as libc::c_int;
    (*this).raceFlags = 0 as libc::c_int;
    (*this).finishTimer = 0 as libc::c_int;
    (*this).result = MALONRACE_NO_RESULT as libc::c_int;
    i = 0 as libc::c_int;
    while i < 16 as libc::c_int {
        (*this).fenceCheck[i as usize] = 0 as libc::c_int;
        i += 1
    }
    (*this).lapCount = 0 as libc::c_int;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_DestroyMalonRace(mut base:
                                                               *mut EnHorseGameCheckBase,
                                                           mut globalCtx:
                                                               *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_FinishMalonRace(mut this:
                                                              *mut EnHorseGameCheckMalonRace,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    if (*this).result == MALONRACE_SUCCESS as libc::c_int ||
           (*this).result == MALONRACE_TIME_UP as libc::c_int {
        gSaveContext.cutsceneIndex = 0 as libc::c_int;
        (*globalCtx).nextEntranceIndex = 0x4ce as libc::c_int as s16;
        (*globalCtx).fadeTransition = 0x2e as libc::c_int as u8_0;
        (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8
    } else if (*this).result == MALONRACE_FAILURE as libc::c_int {
        gSaveContext.timer1Value = 240 as libc::c_int as s16;
        gSaveContext.timer1State = 0xf as libc::c_int as s16;
        gSaveContext.cutsceneIndex = 0 as libc::c_int;
        (*globalCtx).nextEntranceIndex = 0x4ce as libc::c_int as s16;
        (*globalCtx).fadeTransition = 0x2e as libc::c_int as u8_0;
        (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8
        ...
        // "not supported"
        osSyncPrintf(b"En_HGC_Spot20_Ta_end():\xe5\xaf\xbe\xe5\xbf\x9c\xe3\x81\x9b\xe3\x81\x9a\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_UpdateMalonRace(mut base:
                                                              *mut EnHorseGameCheckBase,
                                                          mut globalCtx:
                                                              *mut GlobalContext)
 -> s32 {
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut horse: *mut EnHorse = 0 as *mut EnHorse;
    if (*this).raceFlags & (1 as libc::c_int) << 6 as libc::c_int == 0 &&
           Math3D_PointInSquare2D(sFinishLine[0 as libc::c_int as usize],
                                  sFinishLine[1 as libc::c_int as usize],
                                  sFinishLine[2 as libc::c_int as usize],
                                  sFinishLine[3 as libc::c_int as usize],
                                  (*(*player).rideActor).world.pos.x,
                                  (*(*player).rideActor).world.pos.z) != 0 {
        (*this).raceFlags |= (1 as libc::c_int) << 6 as libc::c_int
    } else if (*this).raceFlags & (1 as libc::c_int) << 6 as libc::c_int != 0
                  &&
                  (*this).raceFlags & (1 as libc::c_int) << 5 as libc::c_int
                      == 0 &&
                  Math3D_PointInSquare2D(sFinishLine[0 as libc::c_int as
                                                         usize],
                                         sFinishLine[1 as libc::c_int as
                                                         usize],
                                         sFinishLine[2 as libc::c_int as
                                                         usize],
                                         sFinishLine[3 as libc::c_int as
                                                         usize],
                                         (*(*player).rideActor).world.pos.x,
                                         (*(*player).rideActor).world.pos.z)
                      == 0 {
        (*this).raceFlags |= (1 as libc::c_int) << 5 as libc::c_int
    }
    if (*this).startTimer > 50 as libc::c_int &&
           (*this).raceFlags & (1 as libc::c_int) << 1 as libc::c_int == 0 {
        (*this).raceFlags |= (1 as libc::c_int) << 1 as libc::c_int;
        func_80088B34(0 as libc::c_int as s16);
    } else if (*this).startTimer > 80 as libc::c_int &&
                  !(*player).rideActor.is_null() &&
                  (*this).raceFlags & (1 as libc::c_int) << 0 as libc::c_int
                      == 0 {
        (*this).raceFlags |= (1 as libc::c_int) << 0 as libc::c_int;
        horse = (*player).rideActor as *mut EnHorse;
        (*horse).inRace = 1 as libc::c_int
    } else if (*this).startTimer > 81 as libc::c_int &&
                  (*this).raceFlags & (1 as libc::c_int) << 4 as libc::c_int
                      == 0 {
        (*this).raceFlags |= (1 as libc::c_int) << 4 as libc::c_int;
        Audio_PlaySoundGeneral(0x4835 as libc::c_int as u16_0,
                               &mut D_801333D4, 4 as libc::c_int as u8_0,
    ...
    (*this).startTimer += 1;
    if (*this).result == MALONRACE_NO_RESULT as libc::c_int {
        let mut player2: *mut Player = player;
        let mut dist: f32_0 = 0.;
        i = 0 as libc::c_int;
        while i < 16 as libc::c_int {
            if (*this).lapCount == 0 as libc::c_int && i >= 8 as libc::c_int {
                break ;
            }
            dist =
                Math_Vec3f_DistXZ(&mut *sFencePos.as_mut_ptr().offset((i %
                                                                           8
                                                                               as
                                                                               libc::c_int)
                                                                          as
                                                                          isize),
                                  &mut (*(*player2).rideActor).world.pos);
            if !(*player).rideActor.is_null() && dist < 250.0f32 {
                horse = (*player2).rideActor as *mut EnHorse;
                if (*horse).stateFlags &
                       ((1 as libc::c_int) << 2 as libc::c_int) as
                           libc::c_uint != 0 {
                    if i > 0 as libc::c_int &&
                           (*this).fenceCheck[(i - 1 as libc::c_int) as usize]
                               == 1 as libc::c_int {
                        (*this).fenceCheck[i as usize] = 1 as libc::c_int
                    } else if i == 0 as libc::c_int {
                        (*this).fenceCheck[i as usize] = 1 as libc::c_int
                    }
                    if (*this).fenceCheck[(i - 1 as libc::c_int) as usize] ==
                           0 as libc::c_int &&
                           (*this).raceFlags &
                        ...
                        Message_StartTextbox(globalCtx,
                                             0x208c as libc::c_int as u16_0,
                                             0 as *mut Actor);
                        (*this).result = 4 as libc::c_int;
                        (*this).finishTimer = 30 as libc::c_int
                    }
                }
            }
            i += 1
        ...
        if !(*player2).rideActor.is_null() &&
               (*this).raceFlags & (1 as libc::c_int) << 5 as libc::c_int != 0
               &&
               Math3D_PointInSquare2D(sFinishLine[0 as libc::c_int as usize],
                                      sFinishLine[1 as libc::c_int as usize],
                                      sFinishLine[2 as libc::c_int as usize],
                                      ...
                                      (*(*player2).rideActor).world.pos.z) !=
                   0 {
            if (*this).lapCount == 1 as libc::c_int &&
                   (*this).fenceCheck[15 as libc::c_int as usize] ==
                       0 as libc::c_int &&
                   (*(*player2).rideActor).prevPos.x < -200.0f32 {
                (*this).raceFlags |= (1 as libc::c_int) << 3 as libc::c_int;
                Message_StartTextbox(globalCtx,
                                     0x208c as libc::c_int as u16_0,
                                     0 as *mut Actor);
                (*this).result = MALONRACE_FAILURE as libc::c_int;
                (*this).finishTimer = 30 as libc::c_int
            } else if (*this).fenceCheck[15 as libc::c_int as usize] ==
                          1 as libc::c_int {
                (*this).lapCount = 2 as libc::c_int;
                Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                                       24 as libc::c_int |
                                       0x41 as libc::c_int) as u32_0);
                Audio_PlaySoundGeneral(0x4835 as libc::c_int as u16_0,
                                       ...
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
                (*this).result = MALONRACE_SUCCESS as libc::c_int;
                (*this).finishTimer = 70 as libc::c_int;
                gSaveContext.timer1State = 0xf as libc::c_int as s16
            } else if (*this).fenceCheck[7 as libc::c_int as usize] ==
                          1 as libc::c_int &&
                          (*this).raceFlags &
                              (1 as libc::c_int) << 2 as libc::c_int == 0 {
                (*this).lapCount = 1 as libc::c_int;
                (*this).raceFlags |= (1 as libc::c_int) << 2 as libc::c_int;
                Message_StartTextbox(globalCtx,
                                     0x208d as libc::c_int as u16_0,
                                     0 as *mut Actor);
            } else if (*this).fenceCheck[7 as libc::c_int as usize] ==
                          0 as libc::c_int {
                (*this).raceFlags |= (1 as libc::c_int) << 3 as libc::c_int;
                ...
                (*this).result = MALONRACE_FAILURE as libc::c_int;
                (*this).finishTimer = 30 as libc::c_int
            } else if (*(*player2).rideActor).prevPos.x > 80.0f32 {
                (*this).raceFlags |= (1 as libc::c_int) << 3 as libc::c_int;
                Message_StartTextbox(globalCtx,
                                     0x208c as libc::c_int as u16_0,
                                     0 as *mut Actor);
        ...
        (*this).finishTimer -= 1
    } else { EnHorseGameCheck_FinishMalonRace(this, globalCtx); }
    return 1 as libc::c_int;
}
static mut sInitFuncs: [EnHorseGameCheckFunc; 5] =
    unsafe {
        [None,
         Some(EnHorseGameCheck_InitIngoRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_InitGerudoArchery as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_InitType3 as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_InitMalonRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32)]
    };
static mut sDestroyFuncs: [EnHorseGameCheckFunc; 5] =
    unsafe {
        [None,
         Some(EnHorseGameCheck_DestroyIngoRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_DestroyGerudoArchery as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_DestroyType3 as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_DestroyMalonRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32)]
    };
static mut sUpdateFuncs: [EnHorseGameCheckFunc; 5] =
    unsafe {
        [None,
         Some(EnHorseGameCheck_UpdateIngoRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_UpdateGerudoArchery as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_UpdateType3 as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32),
         Some(EnHorseGameCheck_UpdateMalonRace as
                  unsafe extern "C" fn(_: *mut EnHorseGameCheckBase,
                                       _: *mut GlobalContext) -> s32)]
    };
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHorseGameCheckBase =
        thisx as *mut EnHorseGameCheckBase;
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT20 as libc::c_int &&
        ...
        (*this).actor.params = HORSEGAME_MALON_RACE as libc::c_int as s16
    }
    if sInitFuncs[(*this).actor.params as usize].is_some() {
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHorseGameCheckBase =
        thisx as *mut EnHorseGameCheckBase;
    if sDestroyFuncs[(*this).actor.params as usize].is_some() {
        sDestroyFuncs[(*this).actor.params as
                          usize].expect("non-null function pointer")(this,
                                                                     globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnHorseGameCheckBase =
        thisx as *mut EnHorseGameCheckBase;
    if sUpdateFuncs[(*this).type_0 as usize].is_some() {
        sUpdateFuncs[(*this).type_0 as
                         usize].expect("non-null function pointer")(this,
                                                                    globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGameCheck_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
