...
extern "C" {
    ...
    #[no_mangle]
    static mut gDekuNutsDekuNutDL: [Gfx; 0];
    #[no_mangle]
    static mut gHintNutsNutDL: [Gfx; 0];
    #[no_mangle]
    static mut gBusinessScrubDekuNutDL: [Gfx; 0];
    #[no_mangle]
    static mut gDntJijiNutDL: [Gfx; 0];
    #[no_mangle]
    static mut gDntStageNutDL: [Gfx; 0];
}
...
pub struct EnNutsball {
    pub actor: Actor,
    pub actionFunc: EnNutsballActionFunc,
    pub objBankIndex: s8,
    pub timer: s16,
    pub collider: ColliderCylinder,
}
pub type EnNutsballActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNutsball, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Nutsball_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NUTSBALL as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNutsball_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNutsball_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNutsball_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sObjectIDs: [s16; 5] =
    [OBJECT_DEKUNUTS as libc::c_int as s16,
     OBJECT_HINTNUTS as libc::c_int as s16,
     OBJECT_SHOPNUTS as libc::c_int as s16, OBJECT_DNS as libc::c_int as s16,
     OBJECT_DNK as libc::c_int as s16];
static mut sDLists: [*mut Gfx; 5] =
    unsafe {
        [gDekuNutsDekuNutDL.as_ptr() as *mut _,
         gHintNutsNutDL.as_ptr() as *mut _,
         gBusinessScrubDekuNutDL.as_ptr() as *mut _,
         gDntJijiNutDL.as_ptr() as *mut _, gDntStageNutDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn EnNutsball_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNutsball = thisx as *mut EnNutsball;
    let mut pad: s32 = 0;
    ActorShape_Init(&mut (*this).actor.shape, 400.0f32,
    ...
    (*this).objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        sObjectIDs[(*this).actor.params as usize]) as s8;
    if ((*this).objBankIndex as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    } else {
        (*this).actionFunc =
            Some(func_80ABBB34 as
                     unsafe extern "C" fn(_: *mut EnNutsball,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnNutsball_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnNutsball = thisx as *mut EnNutsball;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABBBA8(mut this: *mut EnNutsball,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actor.home.rot.z =
        ((*this).actor.home.rot.z as libc::c_int + 0x2aa8 as libc::c_int) as
            s16;
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 ||
        ...
        if (*player).currentShield as libc::c_int ==
            ...
            if (*this).collider.base.atFlags as libc::c_int &
                ...
                Matrix_MtxFToYXZRotS(&mut (*player).shieldMf, &mut sp4C,
                                     0 as libc::c_int);
                (*this).actor.world.rot.y =
                    (sp4C.y as libc::c_int + 0x8000 as libc::c_int) as s16;
                (*this).timer = 30 as libc::c_int as s16;
                return
            }
        }
        ...
        sp40.y =
            (*this).actor.world.pos.y + 4 as libc::c_int as libc::c_float;
        sp40.z = (*this).actor.world.pos.z;
        EffectSsHahen_SpawnBurst(globalCtx, &mut sp40, 6.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnNutsball_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnNutsball = thisx as *mut EnNutsball;
    let mut player: *mut Player =
    ...
    if (*player).stateFlags1 & 0x300000c0 as libc::c_int as libc::c_uint == 0
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor,
                                ...
                                sCylinderInit.dim.radius as f32_0,
                                sCylinderInit.dim.height as f32_0,
                                5 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnNutsball_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_nutsball.c\x00" as *const u8 as
                        *const libc::c_char, 327 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_Mult(&mut (*globalCtx).billboardMtxF,
                MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZ((*thisx).home.rot.z as libc::c_int as libc::c_float *
                       9.58738e-05f32, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = sDLists[(*thisx).params as usize] as libc::c_uint;
