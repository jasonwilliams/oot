...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002DEEC(player: *mut Player) -> s32;
    #[no_mangle]
...
pub type ObjMakekinsutaActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut ObjMakekinsuta, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Makekinsuta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_MAKEKINSUTA as libc::c_int as s16,
                          category:
                          ...
                          instanceSize:
                              ::std::mem::size_of::<ObjMakekinsuta>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMakekinsuta_Init
                                                                          as
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMakekinsuta_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjMakekinsuta_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjMakekinsuta = thisx as *mut ObjMakekinsuta;
    if (*this).actor.params as libc::c_int & 0x6000 as libc::c_int ==
           0x4000 as libc::c_int {
        osSyncPrintf(b"\x1b[34m\x00" as *const u8 as *const libc::c_char);
        // "Gold Star Enemy(arg_data %x)"
        osSyncPrintf(b"\xe9\x87\x91\xe3\x82\xb9\xe3\x82\xbf\xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb5(arg_data %x)\n\x00"
        ...
        osSyncPrintf(b"\xe5\xbc\x95\xe6\x95\xb0\xe4\xb8\x8d\xe6\xad\xa3 (arg_data %x)(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int,
                     b"../z_obj_makekinsuta.c\x00" as *const u8 as
                         *const libc::c_char, 119 as libc::c_int);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
    }
    (*this).actionFunc =
        Some(func_80B98320 as
                 unsafe extern "C" fn(_: *mut ObjMakekinsuta,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B98320(mut this: *mut ObjMakekinsuta,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_152 as libc::c_int != 0 as libc::c_int {
        if (*this).timer as libc::c_int >= 60 as libc::c_int &&
               func_8002DEEC((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER
                                                                  as
                                                                  libc::c_int
                                                                  as
                                                                  usize].head
            ...
            (*this).actionFunc =
                Some(ObjMakekinsuta_DoNothing as
                         unsafe extern "C" fn(_: *mut ObjMakekinsuta,
                                              _: *mut GlobalContext) -> ())
        } else { (*this).timer += 1 }
...
#[no_mangle]
pub unsafe extern "C" fn ObjMakekinsuta_DoNothing(mut this:
                                                      *mut ObjMakekinsuta,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ObjMakekinsuta_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut ObjMakekinsuta = thisx as *mut ObjMakekinsuta;
