...
extern "C" {
    ...
    #[no_mangle]
    static mut gOctorokShootAnim: AnimationHeader;
    #[no_mangle]
    static mut gOctorokDieAnim: AnimationHeader;
    #[no_mangle]
    static mut gOctorokHideAnim: AnimationHeader;
    #[no_mangle]
    static mut gOctorokFloatAnim: AnimationHeader;
    #[no_mangle]
    static mut gOctorokProjectileDL: [Gfx; 0];
    #[no_mangle]
    static mut gOctorokSkel: SkeletonHeader;
    #[no_mangle]
    static mut gOctorokHitAnim: AnimationHeader;
    #[no_mangle]
    static mut gOctorokAppearAnim: AnimationHeader;
}
...
pub const PLAYER_SHIELD_MAX: C2RustUnnamed_19 = 4;
pub const PLAYER_SHIELD_MIRROR: C2RustUnnamed_19 = 3;
pub const PLAYER_SHIELD_HYLIAN: C2RustUnnamed_19 = 2;
pub const PLAYER_SHIELD_DEKU: C2RustUnnamed_19 = 1;
pub const PLAYER_SHIELD_NONE: C2RustUnnamed_19 = 0;
...
pub struct EnOkuta {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnOkutaActionFunc,
    pub timer: s16,
    pub numShots: s16,
    pub jointTable: [Vec3s; 38],
    pub morphTable: [Vec3s; 38],
    pub jumpHeight: f32_0,
    pub headScale: Vec3f,
    pub collider: ColliderCylinder,
}
pub type EnOkutaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Okuta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_OKUTA as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_OKUTA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnOkuta>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnOkuta_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sProjectileColliderInit: ColliderCylinderInit =
    {
        let mut init =
...
static mut sOctorockColliderInit: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 1 as libc::c_int as u8_0,
                                   cylRadius: 15 as libc::c_int as s16,
                                   cylHeight: 60 as libc::c_int as s16,
                                   mass: 100 as libc::c_int as u8_0,};
        init
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOkuta = thisx as *mut EnOkuta;
    let mut pad: s32 = 0;
    let mut outWaterBox: *mut WaterBox = 0 as *mut WaterBox;
    ...
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gOctorokSkel,
                       &mut gOctorokAppearAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 38 as libc::c_int);
        Collider_InitCylinder(globalCtx, &mut (*this).collider);
        Collider_SetCylinder(globalCtx, &mut (*this).collider, thisx,
                             &mut sOctorockColliderInit);
        CollisionCheck_SetInfo(&mut (*thisx).colChkInfo, &mut sDamageTable,
                               &mut sColChkInfoInit);
        if (*this).numShots as libc::c_int == 0xff as libc::c_int ||
               (*this).numShots as libc::c_int == 0 as libc::c_int {
            (*this).numShots = 1 as libc::c_int as s16
        }
        (*thisx).floorHeight =
            BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                        &mut (*thisx).floorPoly, &mut sp30,
                                        thisx, &mut (*thisx).world.pos);
        ...
        if WaterBox_GetSurfaceImpl(globalCtx, &mut (*globalCtx).colCtx,
                                   ...
                                   &mut ySurface, &mut outWaterBox) == 0 ||
               ySurface <= (*thisx).floorHeight {
            Actor_Kill(thisx);
        } else { (*thisx).home.pos.y = ySurface }
        EnOkuta_SetupWaitToAppear(this);
    } else {
        ActorShape_Init(&mut (*thisx).shape, 1100.0f32,
        ...
        (*this).actionFunc =
            Some(EnOkuta_ProjectileFly as
                     unsafe extern "C" fn(_: *mut EnOkuta,
                                          _: *mut GlobalContext) -> ());
        (*thisx).speedXZ = 10.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOkuta = thisx as *mut EnOkuta;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SpawnBubbles(mut this: *mut EnOkuta,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 10 as libc::c_int {
        EffectSsBubble_Spawn(globalCtx, &mut (*this).actor.world.pos,
                             -10.0f32, 10.0f32, 30.0f32, 0.25f32);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SpawnDust(mut pos: *mut Vec3f,
    ...
    func_8002829C(globalCtx, pos, velocity, &mut accel, &mut primColor,
                  &mut envColor, 0x190 as libc::c_int as s16, scaleStep);
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SpawnSplash(mut this: *mut EnOkuta,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    EffectSsGSplash_Spawn(globalCtx, &mut (*this).actor.home.pos,
                          0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                          0 as libc::c_int as s16,
                          1300 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SpawnRipple(mut this: *mut EnOkuta,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if (*globalCtx).gameplayFrames.wrapping_rem(7 as libc::c_int as
           ...
           ((*this).actionFunc !=
                Some(EnOkuta_Shoot as
                         unsafe extern "C" fn(_: *mut EnOkuta,
                                              _: *mut GlobalContext) -> ()) ||
                (*this).actor.world.pos.y - (*this).actor.home.pos.y <
                    50.0f32) {
        EffectSsGRipple_Spawn(globalCtx, &mut pos, 250 as libc::c_int as s16,
                              650 as libc::c_int as s16,
                              0 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupWaitToAppear(mut this: *mut EnOkuta) {
    (*this).actor.draw = None;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnOkuta_WaitToAppear as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
    (*this).actor.world.pos.y = (*this).actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupAppear(mut this: *mut EnOkuta,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).actor.draw =
        Some(EnOkuta_Draw as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gOctorokAppearAnim);
    EnOkuta_SpawnBubbles(this, globalCtx);
    (*this).actionFunc =
        Some(EnOkuta_Appear as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupHide(mut this: *mut EnOkuta) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gOctorokHideAnim);
    (*this).actionFunc =
        Some(EnOkuta_Hide as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupWaitToShoot(mut this: *mut EnOkuta) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gOctorokFloatAnim);
    (*this).timer =
        if (*this).actionFunc ==
               Some(EnOkuta_Shoot as
                        unsafe extern "C" fn(_: *mut EnOkuta,
    ...
    (*this).actionFunc =
        Some(EnOkuta_WaitToShoot as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupShoot(mut this: *mut EnOkuta,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gOctorokShootAnim);
    if (*this).actionFunc !=
           Some(EnOkuta_Shoot as
                    unsafe extern "C" fn(_: *mut EnOkuta,
                                         _: *mut GlobalContext) -> ()) {
    ...
    (*this).jumpHeight = (*this).actor.yDistToPlayer + 20.0f32;
    (*this).jumpHeight =
        if (*this).jumpHeight < 10.0f32 {
            10.0f32
        } else { (*this).jumpHeight };
    if (*this).jumpHeight > 50.0f32 { EnOkuta_SpawnSplash(this, globalCtx); }
    if (*this).jumpHeight > 50.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c2 as libc::c_int as u16_0);
    }
    (*this).actionFunc =
        Some(EnOkuta_Shoot as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupWaitToDie(mut this: *mut EnOkuta) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gOctorokHitAnim,
                              -5.0f32);
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x38c6 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnOkuta_WaitToDie as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupDie(mut this: *mut EnOkuta) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gOctorokDieAnim,
                              -3.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SetupFreeze(mut this: *mut EnOkuta) {
    (*this).timer = 80 as libc::c_int as s16;
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         0xff as libc::c_int as s16, 0 as libc::c_int as s16,
                         0x50 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnOkuta_Freeze as
                 unsafe extern "C" fn(_: *mut EnOkuta, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_SpawnProjectile(mut this: *mut EnOkuta,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    pos.x = (*this).actor.world.pos.x + 25.0f32 * sin;
    pos.y = (*this).actor.world.pos.y - 6.0f32;
    pos.z = (*this).actor.world.pos.z + 25.0f32 * cos;
    if !Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_OKUTA as libc::c_int as s16, pos.x, pos.y, pos.z,
                    (*this).actor.shape.rot.x, (*this).actor.shape.rot.y,
                    (*this).actor.shape.rot.z,
                    0x10 as libc::c_int as s16).is_null() {
        pos.x = (*this).actor.world.pos.x + 40.0f32 * sin;
        pos.z = (*this).actor.world.pos.z + 40.0f32 * cos;
        pos.y = (*this).actor.world.pos.y;
        velocity.x = 1.5f32 * sin;
        velocity.y = 0.0f32;
        velocity.z = 1.5f32 * cos;
        EnOkuta_SpawnDust(&mut pos, &mut velocity, 20 as libc::c_int as s16,
                          globalCtx);
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x387e as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_WaitToAppear(mut this: *mut EnOkuta,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).actor.world.pos.y = (*this).actor.home.pos.y;
    if (*this).actor.xzDistToPlayer < 480.0f32 &&
           (*this).actor.xzDistToPlayer > 200.0f32 {
        EnOkuta_SetupAppear(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Appear(mut this: *mut EnOkuta,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.xzDistToPlayer < 160.0f32 {
            EnOkuta_SetupHide(this);
        } else { EnOkuta_SetupWaitToShoot(this); }
    } else if (*this).skelAnime.curFrame <= 4.0f32 {
        Actor_SetScale(&mut (*this).actor,
                       (*this).skelAnime.curFrame * 0.25f32 * 0.01f32);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 5.0f32) != 0 {
        Actor_SetScale(&mut (*this).actor, 0.01f32);
    }
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 12.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c3 as libc::c_int as u16_0);
    }
    if Animation_OnFrame(&mut (*this).skelAnime, 3.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 15.0f32) != 0 {
        EnOkuta_SpawnSplash(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Hide(mut this: *mut EnOkuta,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                   0.5f32, 30.0f32);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
        ...
        Actor_SetScale(&mut (*this).actor,
                       (6.0f32 - (*this).skelAnime.curFrame) * 0.5f32 *
                           0.01f32);
    }
    if Animation_OnFrame(&mut (*this).skelAnime, 2.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c4 as libc::c_int as u16_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_WaitToShoot(mut this: *mut EnOkuta,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut temp_v0_2: s16 = 0;
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 0.5f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c1 as libc::c_int as u16_0);
    }
    if (*this).actor.xzDistToPlayer < 160.0f32 ||
           (*this).actor.xzDistToPlayer > 560.0f32 {
        EnOkuta_SetupHide(this);
    } else {
        temp_v0_2 =
        ...
        phi_v1 =
            if temp_v0_2 as libc::c_int >= 0 as libc::c_int {
                temp_v0_2 as libc::c_int
            } else { -(temp_v0_2 as libc::c_int) };
        if phi_v1 < 0x38e as libc::c_int &&
               (*this).timer as libc::c_int == 0 as libc::c_int &&
               (*this).actor.yDistToPlayer < 200.0f32 {
            EnOkuta_SetupShoot(this, globalCtx);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Shoot(mut this: *mut EnOkuta,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        } else { EnOkuta_SetupShoot(this, globalCtx); }
    } else {
        let mut curFrame: f32_0 = (*this).skelAnime.curFrame;
        if curFrame < 13.0f32 {
            (*this).actor.world.pos.y =
                sinf(0.08333f32 * 3.14159265358979323846f32 * curFrame) *
                    (*this).jumpHeight + (*this).actor.home.pos.y
        }
    ...
    if (*this).actor.xzDistToPlayer < 160.0f32 { EnOkuta_SetupHide(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_WaitToDie(mut this: *mut EnOkuta,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Die(mut this: *mut EnOkuta,
                                     mut globalCtx: *mut GlobalContext) {
    static mut accel: Vec3f =
    ...
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 { (*this).timer += 1 }
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                   0.5f32, 5.0f32);
    if (*this).timer as libc::c_int == 5 as libc::c_int {
        pos.x = (*this).actor.world.pos.x;
        pos.y = (*this).actor.world.pos.y + 40.0f32;
        pos.z = (*this).actor.world.pos.z;
        velocity.x = 0.0f32;
        velocity.y = -0.5f32;
        velocity.z = 0.0f32;
        EnOkuta_SpawnDust(&mut pos, &mut velocity,
                          -(0x14 as libc::c_int) as s16, globalCtx);
        Audio_PlayActorSound2(&mut (*this).actor,
    ...
    if ((*this).timer as libc::c_int) < 3 as libc::c_int {
        Actor_SetScale(&mut (*this).actor,
                       ((*this).timer as libc::c_int as libc::c_float *
                            0.25f32 + 1.0f32) * 0.01f32);
    } else if ((*this).timer as libc::c_int) < 6 as libc::c_int {
        Actor_SetScale(&mut (*this).actor,
                       (1.5f32 -
                            ((*this).timer as libc::c_int - 2 as libc::c_int)
                                as libc::c_float * 0.2333f32) * 0.01f32);
    } else if ((*this).timer as libc::c_int) < 11 as libc::c_int {
        Actor_SetScale(&mut (*this).actor,
                       (((*this).timer as libc::c_int - 5 as libc::c_int) as
                            libc::c_float * 0.04f32 + 0.8f32) * 0.01f32);
    } else {
        if Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, 0.0005f32) != 0 {
            ...
            Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                       ...
                                       0x70 as libc::c_int as s16);
            i = 0 as libc::c_int;
            while i < 20 as libc::c_int {
                velocity.x = (Rand_ZeroOne() - 0.5f32) * 7.0f32;
                velocity.y = Rand_ZeroOne() * 7.0f32;
                velocity.z = (Rand_ZeroOne() - 0.5f32) * 7.0f32;
                EffectSsDtBubble_SpawnCustomColor(globalCtx,
                                                  &mut (*this).actor.world.pos,
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Freeze(mut this: *mut EnOkuta,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if (*this).timer as libc::c_int >= 64 as libc::c_int &&
           (*this).timer as libc::c_int & 1 as libc::c_int != 0 {
        temp_v1 =
            ((*this).timer as libc::c_int - 64 as libc::c_int >>
                 1 as libc::c_int) as s16;
        pos.y =
            (*this).actor.world.pos.y - 32.0f32 +
                8.0f32 *
                    (8 as libc::c_int - temp_v1 as libc::c_int) as
                        libc::c_float;
        pos.x =
            (*this).actor.world.pos.x +
                (if temp_v1 as libc::c_int & 2 as libc::c_int != 0 {
                     10.0f32
                 } else { -10.0f32 });
        pos.z =
            (*this).actor.world.pos.z +
                (if temp_v1 as libc::c_int & 1 as libc::c_int != 0 {
                     10.0f32
                 } else { -10.0f32 });
        EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).actor,
                                       &mut pos, 150 as libc::c_int as s16,
                                       ...
                                       Rand_ZeroOne() * 0.2f32 + 1.9f32);
    }
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                   0.5f32, 5.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_ProjectileFly(mut this: *mut EnOkuta,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    (*this).actor.home.rot.z =
        ((*this).actor.home.rot.z as libc::c_int + 0x1554 as libc::c_int) as
            s16;
    if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0 {
        (*this).actor.gravity = -1.0f32;
        (*this).actor.speedXZ -= 0.1f32;
        (*this).actor.speedXZ =
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 ||
        ...
        if ((*player).currentShield as libc::c_int ==
                PLAYER_SHIELD_DEKU as libc::c_int ||
                (*player).currentShield as libc::c_int ==
            ...
            Matrix_MtxFToYXZRotS(&mut (*player).shieldMf, &mut sp40,
                                 0 as libc::c_int);
            (*this).actor.world.rot.y =
                (sp40.y as libc::c_int + 0x8000 as libc::c_int) as s16;
            (*this).timer = 30 as libc::c_int as s16
        } else {
            pos.x = (*this).actor.world.pos.x;
            pos.y = (*this).actor.world.pos.y + 11.0f32;
            pos.z = (*this).actor.world.pos.z;
            EffectSsHahen_SpawnBurst(globalCtx, &mut pos, 6.0f32,
                                     0 as libc::c_int as s16,
                                     1 as libc::c_int as s16,
                                     ...
                                     gOctorokProjectileDL.as_mut_ptr());
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      20 as libc::c_int,
                                      0x38c0 as libc::c_int as u16_0);
            Actor_Kill(&mut (*this).actor);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_UpdateHeadScale(mut this: *mut EnOkuta) {
    let mut curFrame: f32_0 = (*this).skelAnime.curFrame;
    if (*this).actionFunc ==
           Some(EnOkuta_Appear as
                    unsafe extern "C" fn(_: *mut EnOkuta,
                                         _: *mut GlobalContext) -> ()) {
        if curFrame < 8.0f32 {
            (*this).headScale.z = 1.0f32;
            (*this).headScale.y = (*this).headScale.z;
            (*this).headScale.x = (*this).headScale.y
        } else if curFrame < 10.0f32 {
            (*this).headScale.z = 1.0f32;
            (*this).headScale.x = (*this).headScale.z;
            (*this).headScale.y = (curFrame - 7.0f32) * 0.4f32 + 1.0f32
        } else if curFrame < 14.0f32 {
            (*this).headScale.z = (curFrame - 9.0f32) * 0.075f32 + 1.0f32;
            (*this).headScale.x = (*this).headScale.z;
            (*this).headScale.y = 1.8f32 - (curFrame - 9.0f32) * 0.25f32
        } else {
            (*this).headScale.z = 1.3f32 - (curFrame - 13.0f32) * 0.05f32;
            (*this).headScale.x = (*this).headScale.z;
            (*this).headScale.y = (curFrame - 13.0f32) * 0.0333f32 + 0.8f32
        }
     ...
     {
        if curFrame < 3.0f32 {
            (*this).headScale.y = 1.0f32
        } else if curFrame < 4.0f32 {
            (*this).headScale.y = curFrame - 2.0f32 + 1.0f32
        } else {
            (*this).headScale.y = 2.0f32 - (curFrame - 3.0f32) * 0.333f32
        }
        (*this).headScale.z = 1.0f32;
        (*this).headScale.x = (*this).headScale.z
    } else if (*this).actionFunc ==
     ...
     {
        if curFrame < 5.0f32 {
            (*this).headScale.z = curFrame * 0.125f32 + 1.0f32;
            (*this).headScale.y = (*this).headScale.z;
            (*this).headScale.x = (*this).headScale.y
        } else if curFrame < 7.0f32 {
            (*this).headScale.z = 1.5f32 - (curFrame - 4.0f32) * 0.35f32;
            (*this).headScale.y = (*this).headScale.z;
            (*this).headScale.x = (*this).headScale.y
        } else if curFrame < 17.0f32 {
            (*this).headScale.z = (curFrame - 6.0f32) * 0.05f32 + 0.8f32;
            (*this).headScale.x = (*this).headScale.z;
            (*this).headScale.y = 0.8f32
        } else {
            (*this).headScale.z = 1.3f32 - (curFrame - 16.0f32) * 0.1f32;
            (*this).headScale.x = (*this).headScale.z;
            (*this).headScale.y = (curFrame - 16.0f32) * 0.0666f32 + 0.8f32
        }
    } else if (*this).actionFunc ==
                  Some(EnOkuta_WaitToShoot as
                           unsafe extern "C" fn(_: *mut EnOkuta,
                                                _: *mut GlobalContext) -> ())
     {
        ...
        (*this).headScale.y =
            sinf(3.14159265358979323846f32 /
                     16 as libc::c_int as libc::c_float * curFrame) * 0.2f32 +
                1.0f32
    } else {
        (*this).headScale.z = 1.0f32;
        (*this).headScale.y = (*this).headScale.z;
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_ColliderCheck(mut this: *mut EnOkuta,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            } else { EnOkuta_SetupWaitToDie(this); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Update(mut thisx: *mut Actor,
    ...
    if (*player).stateFlags1 & 0x300000c0 as libc::c_int as libc::c_uint == 0
       {
        if (*this).actor.params as libc::c_int == 0 as libc::c_int {
            ...
            } else { (*this).actor.home.pos.y = ySurface }
        }
        ...
        if (*this).actor.params as libc::c_int == 0 as libc::c_int {
            ...
            (*this).collider.dim.height =
                ((sOctorockColliderInit.dim.height as libc::c_int as
                      libc::c_float * (*this).headScale.y -
                      (*this).collider.dim.yShift as libc::c_int as
                          libc::c_float) * (*this).actor.scale.y * 100.0f32)
                    as s16
        } else {
            sp34 = 0 as libc::c_int;
            Actor_MoveForward(&mut (*this).actor);
            Math_Vec3f_Copy(&mut sp38, &mut (*this).actor.world.pos);
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32,
                                    15.0f32, 30.0f32, 5 as libc::c_int);
            ...
            if sp34 != 0 &&
                   (*this).actor.bgCheckFlags as libc::c_int &
                       9 as libc::c_int == 0 {
                Math_Vec3f_Copy(&mut (*this).actor.world.pos, &mut sp38);
            }
        }
        ...
        if (*this).actionFunc ==
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            (*this).collider.dim.pos.y =
                ((*this).actor.world.pos.y +
                     (*(*this).skelAnime.jointTable).y as libc::c_int as
                         libc::c_float * (*this).actor.scale.y) as s16;
            (*this).collider.dim.radius =
                (sOctorockColliderInit.dim.radius as libc::c_int as
                     libc::c_float * (*this).actor.scale.x * 100.0f32) as s16
        }
        ...
        Actor_SetFocus(&mut (*this).actor, 15.0f32);
        if (*this).actor.params as libc::c_int == 0 as libc::c_int &&
               (*this).actor.draw.is_some() {
            EnOkuta_SpawnRipple(this, globalCtx);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_GetSnoutScale(mut this: *mut EnOkuta,
                                               mut curFrame: f32_0,
                                               mut scale: *mut Vec3f) -> s32 {
    if (*this).actionFunc ==
           Some(EnOkuta_WaitToShoot as
                    unsafe extern "C" fn(_: *mut EnOkuta,
                                         _: *mut GlobalContext) -> ()) {
        ...
        (*scale).y =
            sinf(3.14159265358979323846f32 /
                     16 as libc::c_int as libc::c_float * curFrame) * 0.4f32 +
                1.0f32
    } else if (*this).actionFunc ==
                  Some(EnOkuta_Shoot as
                           unsafe extern "C" fn(_: *mut EnOkuta,
                                                _: *mut GlobalContext) -> ())
     {
        if curFrame < 5.0f32 {
            (*scale).x = 1.0f32;
            (*scale).z = curFrame * 0.25f32 + 1.0f32;
            (*scale).y = (*scale).z
        } else if curFrame < 7.0f32 {
            (*scale).x = (curFrame - 4.0f32) * 0.5f32 + 1.0f32;
            (*scale).z = 2.0f32 - (curFrame - 4.0f32) * 0.5f32;
            (*scale).y = (*scale).z
        } else {
            (*scale).x = 2.0f32 - (curFrame - 6.0f32) * 0.0769f32;
            (*scale).z = 1.0f32;
            (*scale).y = (*scale).z
        }
    } else if (*this).actionFunc ==
                  Some(EnOkuta_Die as
                           unsafe extern "C" fn(_: *mut EnOkuta,
                                                _: *mut GlobalContext) -> ())
     {
        if curFrame >= 35.0f32 || curFrame < 25.0f32 {
            return 0 as libc::c_int
        }
        if curFrame < 27.0f32 {
            (*scale).x = 1.0f32;
            (*scale).z = (curFrame - 24.0f32) * 0.5f32 + 1.0f32;
            (*scale).y = (*scale).z
        } else if curFrame < 30.0f32 {
            (*scale).x = (curFrame - 26.0f32) * 0.333f32 + 1.0f32;
            (*scale).z = 2.0f32 - (curFrame - 26.0f32) * 0.333f32;
            (*scale).y = (*scale).z
        } else {
            (*scale).x = 2.0f32 - (curFrame - 29.0f32) * 0.2f32;
            (*scale).z = 1.0f32;
            (*scale).y = (*scale).z
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnOkuta = thisx as *mut EnOkuta;
    let mut curFrame: f32_0 = (*this).skelAnime.curFrame;
    let mut scale: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut doScale: s32 = 0 as libc::c_int;
    if (*this).actionFunc ==
           Some(EnOkuta_Die as
                    unsafe extern "C" fn(_: *mut EnOkuta,
                                         _: *mut GlobalContext) -> ()) {
        curFrame += (*this).timer as libc::c_int as libc::c_float
    }
    if limbIndex == 5 as libc::c_int {
        if (*this).headScale.x != 1.0f32 || (*this).headScale.y != 1.0f32 ||
               (*this).headScale.z != 1.0f32 {
            scale = (*this).headScale;
            doScale = 1 as libc::c_int
        }
    } else if limbIndex == 8 as libc::c_int {
        doScale = EnOkuta_GetSnoutScale(this, curFrame, &mut scale)
    }
    if doScale != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnOkuta_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOkuta = thisx as *mut EnOkuta;
    let mut pad: s32 = 0;
    ...
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnOkuta_OverrideLimbDraw as
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_okuta.c\x00" as *const u8 as
                            *const libc::c_char, 1653 as libc::c_int);
        Matrix_Mult(&mut (*globalCtx).billboardMtxF,
                    MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ((*this).actor.home.rot.z as libc::c_int as
                           libc::c_float *
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gOctorokProjectileDL.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_okuta.c\x00" as *const u8 as
                             *const libc::c_char, 1662 as libc::c_int);
    };
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x42 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_value(6500 as libc::c_int);
             init
         }]
}
#[used]
