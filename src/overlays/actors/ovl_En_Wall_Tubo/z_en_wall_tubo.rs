...
pub type BgBowlWallActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut BgBowlWall, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Wall_Tubo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WALL_TUBO as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWallTubo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWallTubo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWallTubo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWallTubo = thisx as *mut EnWallTubo;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Wall Target"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa3\x81\xe3\x81\xae\xe3\x83\x84\xe3\x83\x9c \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).unk_164 = (*this).actor.world.pos;
    (*this).actionFunc =
        Some(EnWallTubo_FindGirl as
                 unsafe extern "C" fn(_: *mut EnWallTubo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_FindGirl(mut this: *mut EnWallTubo,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    while !lookForGirl.is_null() {
        ...
        } else { (*this).chuGirl = lookForGirl as *mut EnBomBowlMan; break ; }
    }
    (*this).actionFunc =
        Some(EnWallTubo_DetectChu as
                 unsafe extern "C" fn(_: *mut EnWallTubo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_DetectChu(mut this: *mut EnWallTubo,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if (*(*this).chuGirl).minigamePlayStatus as libc::c_int !=
           0 as libc::c_int {
            ...
            while !chu.is_null() {
                if &mut (*chu).actor as *mut Actor ==
                    ...
                    if (fabsf(chuPosDiff.x) < 40.0f32 ||
                        ...
                        Quake_SetSpeed(quakeIndex,
                                       0x7fff as libc::c_int as s16);
                        Quake_SetQuakeValues(quakeIndex,
                                             100 as libc::c_int as s16,
                                             0 as libc::c_int as s16,
                                             0 as libc::c_int as s16,
                                             0 as libc::c_int as s16);
                        Quake_SetCountdown(quakeIndex,
                                           100 as libc::c_int as s16);
                        (*this).actionFunc =
                            Some(EnWallTubo_SetWallFall as
                                     unsafe extern "C" fn(_: *mut EnWallTubo,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_SetWallFall(mut this: *mut EnWallTubo,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut wall: *mut BgBowlWall = 0 as *mut BgBowlWall;
    let mut effAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.1f32, z: 0.0f32,}; init };
    let mut effVelocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    ...
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint ==
        ...
        effPos.x = (*this).explosionCenter.x + Rand_CenteredFloat(300.0f32);
        effPos.y = (*this).explosionCenter.y + Rand_CenteredFloat(300.0f32);
        effPos.z = (*this).explosionCenter.z;
        EffectSsBomb2_SpawnLayered(globalCtx, &mut effPos, &mut effVelocity,
                                   &mut effAccel, 100 as libc::c_int as s16,
                                   30 as libc::c_int as s16);
        EffectSsHahen_SpawnBurst(globalCtx, &mut effPos, 10.0f32,
                                 0 as libc::c_int as s16,
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        wall = (*this).actor.parent as *mut BgBowlWall;
        if !wall.is_null() && (*wall).dyna.actor.update.is_some() {
            (*wall).isHit = 1 as libc::c_int as s16;
            // "You did it field!" (repeated 5 times)
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xa3\xe3\x81\x9f\xe5\x8e\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xa3\xe3\x81\x9f\xe5\x8e\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[34m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xa3\xe3\x81\x9f\xe5\x8e\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xa3\xe3\x81\x9f\xe5\x8e\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xa3\xe3\x81\x9f\xe5\x8e\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnWallTubo_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnWallTubo = thisx as *mut EnWallTubo;
