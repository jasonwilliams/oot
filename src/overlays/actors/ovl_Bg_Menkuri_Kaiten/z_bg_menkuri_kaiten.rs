...
extern "C" {
    ...
    #[no_mangle]
    static mut gGTGRotatingRingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gGTGRotatingRingPlatformCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMenkuriKaiten {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut Bg_Menkuri_Kaiten_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MENKURI_KAITEN as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMenkuriKaiten>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriKaiten_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriKaiten_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriKaiten_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriKaiten_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriKaiten_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgMenkuriKaiten = thisx as *mut BgMenkuriKaiten;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gGTGRotatingRingPlatformCol as
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriKaiten_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgMenkuriKaiten = thisx as *mut BgMenkuriKaiten;
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriKaiten_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgMenkuriKaiten = thisx as *mut BgMenkuriKaiten;
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriKaiten_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gGTGRotatingRingPlatformDL.as_mut_ptr());
}
