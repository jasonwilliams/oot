...
pub type EnKakasiFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnKakasi, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut En_Kakasi_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_KAKASI as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnKakasi_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi = thisx as *mut EnKakasi;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
    // ! @bug SkelAnime_Free is not called
}
#[no_mangle]
pub unsafe extern "C" fn EnKakasi_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi = thisx as *mut EnKakasi;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xef\xbc\xac\xef\xbd\x85\xef\xbd\x94\xe2\x80\x99\xef\xbd\x93 \xef\xbc\xa4\xef\xbc\xa1\xef\xbc\xae\xef\xbc\xa3\xef\xbc\xa5\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
    ...
    (*this).actionFunc =
        Some(func_80A8F660 as
                 unsafe extern "C" fn(_: *mut EnKakasi, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A8F28C(mut this: *mut EnKakasi) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A8F320(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg: s16) {
    ...
    match ocarinaNote as libc::c_int {
        ...
        2 => {
            (*this).unk_19A += 1;
            if (*this).unk_1AC as libc::c_int == 0 as libc::c_int {
                (*this).unk_1AC = 0x1388 as libc::c_int as s16
            }
        }
        3 => {
            (*this).unk_19A += 1;
            if (*this).unk_1A8 as libc::c_int == 0 as libc::c_int {
                (*this).unk_1A8 = 0x1388 as libc::c_int as s16
            }
        }
    ...
    if (*this).unk_19A as libc::c_int != 0 as libc::c_int {
        ...
        Math_ApproachF(&mut (*this).skelanime.playSpeed, (*this).unk_1B8,
                       0.1f32, 0.2f32);
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, (*this).unk_1A8,
                           5 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.z, (*this).unk_1AC,
                           5 as libc::c_int as s16,
                           0x3e8 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if (*this).unk_1A8 as libc::c_int != 0 as libc::c_int &&
               fabsf(((*this).actor.shape.rot.x as libc::c_int -
                          (*this).unk_1A8 as libc::c_int) as f32_0) < 50.0f32
           {
            (*this).unk_1A8 =
                ((*this).unk_1A8 as libc::c_float * -1.0f32) as s16
        }
        if (*this).unk_1AC as libc::c_int != 0 as libc::c_int &&
               fabsf(((*this).actor.shape.rot.z as libc::c_int -
                          (*this).unk_1AC as libc::c_int) as f32_0) < 50.0f32
           {
            (*this).unk_1AC =
                ((*this).unk_1AC as libc::c_float * -1.0f32) as s16
        }
        if (*this).unk_1A4 as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A8F660(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actor.textId = 0x4076 as libc::c_int as u16_0;
    (*this).unk_196 = TEXT_STATE_DONE as libc::c_int as s16;
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        (*this).unk_194 = 0 as libc::c_int as u8_0;
        if gSaveContext.scarecrowCustomSongSet != 0 {
            (*this).actor.textId = 0x407a as libc::c_int as u16_0;
            (*this).unk_196 = TEXT_STATE_EVENT as libc::c_int as s16
        }
    } else {
        (*this).unk_194 = 1 as libc::c_int as u8_0;
        if gSaveContext.scarecrowCustomSongSet != 0 {
            (*this).actor.textId = 0x4079 as libc::c_int as u16_0;
            (*this).unk_196 = TEXT_STATE_EVENT as libc::c_int as s16
        }
    }
    (*this).actionFunc =
        Some(func_80A8F75C as
                 unsafe extern "C" fn(_: *mut EnKakasi, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A8F75C(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).unk_196 as libc::c_int == TEXT_STATE_EVENT as libc::c_int {
            (*this).actionFunc =
                Some(func_80A8F9C8 as
                         unsafe extern "C" fn(_: *mut EnKakasi,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(func_80A8F660 as
        ...
        if !((*this).actor.xzDistToPlayer > 120.0f32) {
            let mut absyawTowardsPlayer: s16 =
                if yawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
                    yawTowardsPlayer as libc::c_int
                } else { -(yawTowardsPlayer as libc::c_int) } as s16;
            if (absyawTowardsPlayer as libc::c_int) < 0x4300 as libc::c_int {
                if (*this).unk_194 == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A8F8D0(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
        ...
        // "end?"
        osSyncPrintf(b"\x1b[34m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xb5\x82\xe3\x82\x8a\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        if (*this).unk_19A as libc::c_int != 0 as libc::c_int {
            Message_CloseTextbox(globalCtx);
            (*this).actor.textId = 0x4077 as libc::c_int as u16_0;
            (*this).unk_196 = TEXT_STATE_EVENT as libc::c_int as s16;
        ...
        func_80A8F320(this, globalCtx, 0 as libc::c_int as s16);
        (*player).stateFlags2 |= 0x800000 as libc::c_int as libc::c_uint
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A8F9C8(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A8F28C(this);
    SkelAnime_Update(&mut (*this).skelanime);
    func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
    if (*this).unk_196 as libc::c_int ==
        ...
        (*this).camId =
            OnePointCutscene_Init(globalCtx, 2270 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).actor,
                                  0 as libc::c_int as s16);
        ...
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_SCARECROW_LONG_PLAYBACK as libc::c_int as
                          u16_0);
        (*this).actionFunc =
            Some(func_80A8FAA4 as
                     unsafe extern "C" fn(_: *mut EnKakasi,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A8FAA4(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int !=
           OCARINA_MODE_0F as libc::c_int {
        func_80A8F320(this, globalCtx, 1 as libc::c_int as s16);
        return
    }
    osSyncPrintf(b"game_play->message.msg_mode=%d\n\x00" as *const u8 as
                     *const libc::c_char,
                 (*globalCtx).msgCtx.msgMode as libc::c_int);
    if (*globalCtx).msgCtx.msgMode as libc::c_int ==
        ...
        if (*this).unk_194 != 0 {
            ...
            (*this).actor.textId = 0x4078 as libc::c_int as u16_0;
            (*this).unk_196 = TEXT_STATE_EVENT as libc::c_int as s16;
            Message_StartTextbox(globalCtx, (*this).actor.textId,
                                 0 as *mut Actor);
        }
        (*this).actionFunc =
            Some(func_80A8FBB8 as
                     unsafe extern "C" fn(_: *mut EnKakasi,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_EndCutscene(globalCtx, (*this).camId);
        (*this).camId = -(1 as libc::c_int) as s16;
        (*this).camId =
            OnePointCutscene_Init(globalCtx, 2260 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).actor,
                                  0 as libc::c_int as s16);
        func_8005B1A4((*globalCtx).cameraPtrs[(*this).camId as usize]);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A8FBB8(mut this: *mut EnKakasi,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A8F28C(this);
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).unk_196 as libc::c_int ==
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi = thisx as *mut EnKakasi;
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnKakasi_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnKakasi = thisx as *mut EnKakasi;
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x95\xe3\x83\xa9\xe3\x82\xb0\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     gSaveContext.scarecrowCustomSongSet as libc::c_int);
    }
