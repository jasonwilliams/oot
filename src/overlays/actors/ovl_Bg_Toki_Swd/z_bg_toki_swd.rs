...
extern "C" {
    ...
    #[no_mangle]
    static mut object_toki_objects_DL_001BD0: [Gfx; 0];
    #[no_mangle]
    static mut D_808BB2F0: [CutsceneData; 0];
    #[no_mangle]
    static mut D_808BB7A0: [CutsceneData; 0];
    #[no_mangle]
    static mut D_808BBD90: [CutsceneData; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgTokiSwd {
    pub actor: Actor,
    pub actionFunc: BgTokiSwdActionFunc,
    pub collider: ColliderCylinder,
}
pub type BgTokiSwdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgTokiSwd, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Toki_Swd_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_TOKI_SWD as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_TOKI_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgTokiSwd>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiSwd_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiSwd_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiSwd_SetupAction(mut this: *mut BgTokiSwd,
                                               mut actionFunc:
                                                   BgTokiSwdActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgTokiSwd_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgTokiSwd = thisx as *mut BgTokiSwd;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).actor.shape.yOffset = 800.0f32;
    BgTokiSwd_SetupAction(this,
                          Some(func_808BAF40 as
                                   unsafe extern "C" fn(_: *mut BgTokiSwd,
                                                        _: *mut GlobalContext)
                                       -> ()));
    if gSaveContext.linkAge == 0 as libc::c_int { (*this).actor.draw = None }
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiSwd_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgTokiSwd = thisx as *mut BgTokiSwd;
...
#[no_mangle]
pub unsafe extern "C" fn func_808BAF40(mut this: *mut BgTokiSwd,
                                       mut globalCtx: *mut GlobalContext) {
    if gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int &
           ...
           Actor_IsFacingAndNearPlayer(&mut (*this).actor, 800.0f32,
                                       0x7530 as libc::c_int as s16) != 0 &&
        ...
        (*globalCtx).csCtx.segment =
            D_808BBD90.as_mut_ptr() as *mut libc::c_void;
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) ||
        ...
        if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
            if !(gSaveContext.linkAge == 0 as libc::c_int) {
                ...
                (*globalCtx).csCtx.segment =
                    D_808BB2F0.as_mut_ptr() as *mut libc::c_void
            } else {
                (*globalCtx).csCtx.segment =
                    D_808BB7A0.as_mut_ptr() as *mut libc::c_void
            }
            Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                                   24 as libc::c_int |
                                   0x100000ff as libc::c_int) as u32_0);
            Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as libc::c_int) <<
                                   24 as libc::c_int | 0x53 as libc::c_int) as
                                  u32_0);
            gSaveContext.cutsceneTrigger = 1 as libc::c_int as u8_0;
            (*this).actor.parent = 0 as *mut Actor;
            BgTokiSwd_SetupAction(this,
                                  Some(func_808BB0AC as
                                           unsafe extern "C" fn(_:
                                                                    *mut BgTokiSwd,
                                                                _:
                                                                    *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_808BB0AC(mut this: *mut BgTokiSwd,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x182d as libc::c_int as u16_0);
            (*this).actor.draw = None
            // sword has been pulled, dont draw sword
        } else {
            (*this).actor.draw =
                Some(BgTokiSwd_Draw as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ())
            // sword has been placed, draw the master sword
        }
        BgTokiSwd_SetupAction(this,
                              Some(func_808BB128 as
                                       unsafe extern "C" fn(_: *mut BgTokiSwd,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
        ...
        (*player).interactRangeActor = &mut (*this).actor
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808BB128(mut this: *mut BgTokiSwd,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiSwd_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgTokiSwd = thisx as *mut BgTokiSwd;
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiSwd_Draw(mut thisx: *mut Actor,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_toki_swd.c\x00" as *const u8 as
                        *const libc::c_char, 727 as libc::c_int);
    ...
    (*_g).words.w1 =
        Gfx_TexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int as u32_0,
                      (*globalCtx).gameplayFrames.wrapping_rem(0x80 as
                                                                   libc::c_int
                                                                   as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        object_toki_objects_DL_001BD0.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_toki_swd.c\x00" as *const u8 as
                         *const libc::c_char, 776 as libc::c_int);
}
