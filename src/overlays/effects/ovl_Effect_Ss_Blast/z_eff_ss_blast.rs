...
#[no_mangle]
pub static mut Effect_Ss_Blast_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_BLAST as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsBlast_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsBlast_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsBlastParams =
        initParamsx as *mut EffectSsBlastParams;
    (*this).pos = (*initParams).pos;
    (*this).pos.y += 5.0f32;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).gfx =
        gSegments[((gEffShockwaveDL.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffShockwaveDL.as_mut_ptr() as
                                              u32_0 &
    ...
    (*this).draw =
        Some(EffectSsBlast_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsBlast_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    ...
    (*this).regs[8 as libc::c_int as usize] =
        ((*initParams).primColor.a as libc::c_int /
             (*initParams).life as libc::c_int) as s16;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).scaleStep;
    (*this).regs[11 as libc::c_int as usize] = (*initParams).sclaeStepDecay;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsBlast_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_blast.c\x00" as *const u8 as
                        *const libc::c_char, 170 as libc::c_int);
    radius =
    ...
    func_800BFCB8(globalCtx, &mut mf, &mut (*this).pos);
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsBlast_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    Math_StepToS(&mut *(*this).regs.as_mut_ptr().offset(3 as libc::c_int as
                                                            isize),
