...
extern "C" {
    ...
    #[no_mangle]
    static mut gAnubiceFireAttackDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnAnubiceFire {
    pub actor: Actor,
    pub actionFunc: EnAnubiceFireActionFunc,
    pub scale: f32_0,
    pub unk_154: f32_0,
    pub unused: s16,
    pub unk_15A: s16,
...
pub type EnAnubiceFireActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAnubiceFire, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Anubice_Fire_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ANUBICE_FIRE as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnAnubiceFire>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceFire_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceFire_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceFire_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceFire_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceFire_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnAnubiceFire = thisx as *mut EnAnubiceFire;
    let mut i: s32 = 0;
    Collider_InitCylinder(globalCtx, &mut (*this).cylinder);
    Collider_SetCylinder(globalCtx, &mut (*this).cylinder, &mut (*this).actor,
                         &mut sCylinderInit);
    (*this).unk_15A = 30 as libc::c_int as s16;
    (*this).unk_154 = 2.0f32;
    (*this).scale = 0.0f32;
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        (*this).unk_160[i as usize] = (*this).actor.world.pos;
        i += 1
    }
    (*this).unk_15E = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809B26EC as
                 unsafe extern "C" fn(_: *mut EnAnubiceFire,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceFire_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnAnubiceFire = thisx as *mut EnAnubiceFire;
...
#[no_mangle]
pub unsafe extern "C" fn func_809B26EC(mut this: *mut EnAnubiceFire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    Matrix_Push();
    Matrix_RotateY((*this).actor.world.rot.y as f32_0 / 32768.0f32 *
                       3.14159265358979323846f32,
                   MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateX((*this).actor.world.rot.x as f32_0 / 32768.0f32 *
                       3.14159265358979323846f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
    velocity.z = 15.0f32;
    Matrix_MultVec3f(&mut velocity, &mut (*this).actor.velocity);
    Matrix_Pop();
    (*this).actionFunc =
        Some(func_809B27D8 as
                 unsafe extern "C" fn(_: *mut EnAnubiceFire,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_809B27D8(mut this: *mut EnAnubiceFire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    ...
    if (*this).unk_15A as libc::c_int == 0 as libc::c_int &&
        ...
        if Player_HasMirrorShieldEquipped(globalCtx) != 0 {
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x399d as libc::c_int as u16_0);
            (*this).actionFunc =
                Some(func_809B2B48 as
                         unsafe extern "C" fn(_: *mut EnAnubiceFire,
                                              _: *mut GlobalContext) -> ())
        }
    } else if !((*this).scale < 0.4f32) {
        let mut scale: f32_0 = 1000.0f32;
        let mut life: f32_0 = 10.0f32;
        let mut i: s32 = 0;
        i = 0 as libc::c_int;
        while i < 10 as libc::c_int {
            pos.x =
                (*this).actor.world.pos.x +
                    (Rand_ZeroOne() - 0.5f32) * ((*this).scale * 20.0f32);
            pos.y =
                (*this).actor.world.pos.y +
                    (Rand_ZeroOne() - 0.5f32) * ((*this).scale * 20.0f32);
            pos.z = (*this).actor.world.pos.z;
            EffectSsKiraKira_SpawnDispersed(globalCtx, &mut pos,
                                            &mut velocity, &mut accel,
                                            &mut primColor, &mut envColor,
                                            scale as s16, life as s32);
            i += 1
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x399c as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B2B48(mut this: *mut EnAnubiceFire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut accel: Vec3f =
    ...
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
    if (*this).unk_15C as libc::c_int == 0 as libc::c_int {
        i = 0 as libc::c_int;
        while i < 20 as libc::c_int {
            pos.x = (*this).actor.world.pos.x;
            pos.y = (*this).actor.world.pos.y;
            pos.z = (*this).actor.world.pos.z;
            accel.x = Rand_CenteredFloat(8.0f32);
            accel.y = Rand_CenteredFloat(2.0f32);
            accel.z = Rand_CenteredFloat(8.0f32);
            EffectSsKiraKira_SpawnDispersed(globalCtx, &mut pos,
                                            &mut velocity, &mut accel,
                                            &mut primColor, &mut envColor,
        ...
        (*this).unk_15E += 1;
        if (*this).unk_15E as libc::c_int >= 6 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceFire_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnAnubiceFire = thisx as *mut EnAnubiceFire;
    let mut pad: s32 = 0;
    ...
    (*this).unk_160[0 as libc::c_int as usize] = (*this).actor.world.pos;
    i = 4 as libc::c_int;
    while i >= 0 as libc::c_int {
        (*this).unk_160[(i + 1 as libc::c_int) as usize] =
            (*this).unk_160[i as usize];
        i -= 1
    }
    if (*this).unk_15A as libc::c_int != 0 as libc::c_int {
        (*this).unk_15A -= 1
    ...
    if !((*this).scale < 0.6f32 ||
                                               ...
                                               _: *mut GlobalContext) -> ()))
       {
        (*this).cylinder.dim.radius =
            ((*this).scale * 15.0f32 + 5.0f32) as s16;
        (*this).cylinder.dim.height =
            ((*this).scale * 15.0f32 + 5.0f32) as s16;
        (*this).cylinder.dim.yShift =
            ((*this).scale * -0.75f32 + -15.0f32) as s16;
        if (*this).unk_15A as libc::c_int != 0 as libc::c_int {
        ...
        if BgCheck_SphVsFirstPoly(&mut (*globalCtx).colCtx,
                                  &mut (*this).actor.world.pos, 30.0f32) != 0
           {
            (*this).actor.velocity.z = 0.0f32;
            (*this).actor.velocity.y = (*this).actor.velocity.z;
            (*this).actor.velocity.x = (*this).actor.velocity.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceFire_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    static mut D_809B3270: [*mut libc::c_void; 8] =
        unsafe {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_anubice_fire.c\x00" as *const u8 as
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gSegments[((D_809B3270[0 as libc::c_int as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(D_809B3270[0 as libc::c_int as
                                                         usize] as u32_0 &
    ...
    Matrix_Push();
    i = (*this).unk_15E as s32;
    while i < 6 as libc::c_int {
        let mut scale: f32_0 =
            (*this).actor.scale.x - i as libc::c_float * 0.2f32;
        if scale < 0.0f32 { scale = 0.0f32 }
        if scale >= 0.1f32 {
            Matrix_Translate((*this).unk_160[i as usize].x,
                             (*this).unk_160[i as usize].y,
                             (*this).unk_160[i as usize].z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_Scale(scale, scale, scale,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            func_800D1FD4(&mut (*globalCtx).billboardMtxF);
            Matrix_RotateZ((*this).actor.world.rot.z as libc::c_int as
                               libc::c_float + i as libc::c_float * 1000.0f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gAnubiceFireAttackDL.as_mut_ptr() as libc::c_uint
        }
        if (*this).scale < 0.1f32 { break ; }
        i += 1
    }
    Matrix_Pop();
