...
extern "C" {
    ...
    #[no_mangle]
    fn guPosition(_: *mut Mtx, _: f32_0, _: f32_0, _: f32_0, _: f32_0,
                  _: f32_0, _: f32_0, _: f32_0);
}
...
#[no_mangle]
pub unsafe extern "C" fn Sample_HandleStateChange(mut this:
                                                      *mut SampleContext) {
    if !((*this).state.input[0 as libc::c_int as usize].press.button as
...
#[no_mangle]
pub unsafe extern "C" fn Sample_Draw(mut this: *mut SampleContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_sample.c\x00" as *const u8 as *const libc::c_char,
                    62 as libc::c_int);
    ...
    func_800AAA50(view, 15 as libc::c_int);
    let mut mtx: *mut Mtx =
        Graph_Alloc(gfxCtx,
    ...
    (*__gfxCtx).polyOpa.p =
        Gfx_SetFog2((*__gfxCtx).polyOpa.p, 255 as libc::c_int,
                    255 as libc::c_int, 255 as libc::c_int, 0 as libc::c_int,
    ...
    (*_g_3).words.w1 =
        (0x8 as libc::c_int | 0x10 as libc::c_int | 0x20 as libc::c_int |
             ...
             0x2000 as libc::c_int | (0 as libc::c_int) << 30 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn Sample_Main(mut thisx: *mut GameState) {
    let mut this: *mut SampleContext = thisx as *mut SampleContext;
    Sample_Draw(this);
    Sample_HandleStateChange(this);
}
#[no_mangle]
pub unsafe extern "C" fn Sample_Destroy(mut thisx: *mut GameState) { }
#[no_mangle]
pub unsafe extern "C" fn Sample_SetupView(mut this: *mut SampleContext) {
    let mut view: *mut View = &mut (*this).view;
    let mut gfxCtx: *mut GraphicsContext = (*this).state.gfxCtx;
    ...
    View_SetViewport(view, &mut viewport);
    func_800AA460(view, 60.0f32, 10.0f32, 12800.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn Sample_LoadTitleStatic(mut this:
                                                    *mut SampleContext) {
    let mut size: u32_0 =
        _title_staticSegmentRomEnd.as_mut_ptr().wrapping_offset_from(_title_staticSegmentRomStart.as_mut_ptr())
            as libc::c_int as u32_0;
    (*this).staticSegment =
        GameState_Alloc(&mut (*this).state, size as size_t,
                        b"../z_sample.c\x00" as *const u8 as
                            *const libc::c_char as *mut libc::c_char,
                        163 as libc::c_int) as *mut u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn Sample_Init(mut thisx: *mut GameState) {
    let mut this: *mut SampleContext = thisx as *mut SampleContext;
    (*this).state.main =
        Some(Sample_Main as unsafe extern "C" fn(_: *mut GameState) -> ());
    (*this).state.destroy =
        Some(Sample_Destroy as unsafe extern "C" fn(_: *mut GameState) -> ());
