...
extern "C" {
    ...
    #[no_mangle]
    static mut gGerudoFortressWastelandGateDL: [Gfx; 0];
    #[no_mangle]
    static mut gGerudoFortressWastelandGateCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot12Gate {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot12GateActionFunc,
    pub unk_168: s16,
}
pub type BgSpot12GateActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot12Gate, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot12_Gate_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT12_GATE as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT12_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot12Gate>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Gate_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Gate_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Gate_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Gate_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Gate_InitDynaPoly(mut this:
                                                       *mut BgSpot12Gate,
                                                   mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_spot12_gate.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Gate_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot12Gate = thisx as *mut BgSpot12Gate;
    BgSpot12Gate_InitDynaPoly(this, globalCtx,
                              &mut gGerudoFortressWastelandGateCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        func_808B3274(this);
    } else { func_808B30C0(this); };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Gate_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot12Gate = thisx as *mut BgSpot12Gate;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B30C0(mut this: *mut BgSpot12Gate) {
    (*this).actionFunc =
        Some(func_808B30D8 as
                 unsafe extern "C" fn(_: *mut BgSpot12Gate,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y = (*this).dyna.actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B30D8(mut this: *mut BgSpot12Gate,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
                           0x3f as libc::c_int) != 0 {
        func_808B3134(this);
        OnePointCutscene_Init(globalCtx, 4160 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3134(mut this: *mut BgSpot12Gate) {
    (*this).actionFunc =
        Some(func_808B314C as
                 unsafe extern "C" fn(_: *mut BgSpot12Gate,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_168 = 40 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B314C(mut this: *mut BgSpot12Gate,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B317C(mut this: *mut BgSpot12Gate) {
    (*this).actionFunc =
        Some(func_808B318C as
                 unsafe extern "C" fn(_: *mut BgSpot12Gate,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B318C(mut this: *mut BgSpot12Gate,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut var: s32 = 0;
    Math_StepToF(&mut (*this).dyna.actor.velocity.y, 1.6f32, 0.03f32);
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
        ...
        Quake_SetSpeed(var as s16, -(0x3cb0 as libc::c_int) as s16);
        Quake_SetQuakeValues(var as s16, 3 as libc::c_int as s16,
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16);
        Quake_SetCountdown(var as s16, 0xc as libc::c_int as s16);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x280e as libc::c_int as u16_0);
    } else {
        func_8002F974(&mut (*this).dyna.actor,
                      (0x2867 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3274(mut this: *mut BgSpot12Gate) {
    (*this).actionFunc =
        Some(func_808B3298 as
                 unsafe extern "C" fn(_: *mut BgSpot12Gate,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y = (*this).dyna.actor.home.pos.y + 200.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3298(mut this: *mut BgSpot12Gate,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Gate_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot12Gate = thisx as *mut BgSpot12Gate;
    if (*this).unk_168 as libc::c_int > 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Gate_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gGerudoFortressWastelandGateDL.as_mut_ptr());
}
