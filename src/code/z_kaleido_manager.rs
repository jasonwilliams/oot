...
extern "C" {
    ...
    #[no_mangle]
    static mut _ovl_player_actorSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_player_actorSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_player_actorSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_player_actorSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_kaleido_scopeSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_kaleido_scopeSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_kaleido_scopeSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_kaleido_scopeSegmentRomStart: [u8_0; 0];
}
...
#[no_mangle]
pub static mut gKaleidoMgrOverlayTable: [KaleidoMgrOverlay; 2] =
    [KaleidoMgrOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                       vromStart: 0,
                       vromEnd: 0,
                       vramStart: 0 as *mut libc::c_void,
                       vramEnd: 0 as *mut libc::c_void,
                       offset: 0,
                       name: 0 as *const libc::c_char,}; 2];
#[no_mangle]
pub static mut sKaleidoAreaPtr: *mut libc::c_void =
    0 as *const libc::c_void as *mut libc::c_void;
#[no_mangle]
pub static mut gKaleidoMgrCurOvl: *mut KaleidoMgrOverlay =
    0 as *const KaleidoMgrOverlay as *mut KaleidoMgrOverlay;
#[no_mangle]
pub static mut gBossMarkState: u8_0 = 0 as libc::c_int as u8_0;
#[no_mangle]
pub unsafe extern "C" fn KaleidoManager_LoadOvl(mut ovl:
                                                    *mut KaleidoMgrOverlay) {
    LogUtils_CheckNullPointer(b"KaleidoArea_allocp\x00" as *const u8 as
                                  *const libc::c_char, sKaleidoAreaPtr,
                              b"../z_kaleido_manager.c\x00" as *const u8 as
                                  *const libc::c_char, 99 as libc::c_int);
    (*ovl).loadedRamAddr = sKaleidoAreaPtr;
    Overlay_Load((*ovl).vromStart, (*ovl).vromEnd, (*ovl).vramStart,
                 (*ovl).vramEnd, (*ovl).loadedRamAddr);
    osSyncPrintf(b"\x1b[32m\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"OVL(k):Seg:%08x-%08x Ram:%08x-%08x Off:%08x %s\n\x00" as
                     *const u8 as *const libc::c_char, (*ovl).vramStart,
                 (*ovl).vramEnd, (*ovl).loadedRamAddr,
                 ((*ovl).loadedRamAddr as
                      u32_0).wrapping_add((*ovl).vramEnd as
                                              u32_0).wrapping_sub((*ovl).vramStart
                                                                      as
                                                                      u32_0),
                 ((*ovl).vramStart as
                      u32_0).wrapping_sub((*ovl).loadedRamAddr as u32_0),
                 (*ovl).name);
    osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
    (*ovl).offset =
        ((*ovl).loadedRamAddr as
             u32_0).wrapping_sub((*ovl).vramStart as u32_0);
    gKaleidoMgrCurOvl = ovl;
}
#[no_mangle]
pub unsafe extern "C" fn KaleidoManager_ClearOvl(mut ovl:
                                                     *mut KaleidoMgrOverlay) {
    if !(*ovl).loadedRamAddr.is_null() {
        (*ovl).offset = 0 as libc::c_int as u32_0;
        bzero((*ovl).loadedRamAddr,
              ((*ovl).vramEnd as
                   u32_0).wrapping_sub((*ovl).vramStart as u32_0));
        (*ovl).loadedRamAddr = 0 as *mut libc::c_void;
        gKaleidoMgrCurOvl = 0 as *mut KaleidoMgrOverlay
    };
}
#[no_mangle]
pub unsafe extern "C" fn KaleidoManager_Init(mut globalCtx:
                                                 *mut GlobalContext) {
    let mut largestSize: s32 = 0 as libc::c_int;
    let mut size: s32 = 0;
    let mut i: u32_0 = 0;
    i = 0 as libc::c_int as u32_0;
    while i <
              (::std::mem::size_of::<[KaleidoMgrOverlay; 2]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<KaleidoMgrOverlay>()
                                                   as libc::c_ulong) as s32 as
                  libc::c_uint {
        size =
            (gKaleidoMgrOverlayTable[i as usize].vramEnd as
                 u32_0).wrapping_sub(gKaleidoMgrOverlayTable[i as
                                                                 usize].vramStart
                                         as u32_0) as s32;
    ...
    osSyncPrintf(b"\x1b[32m\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"KaleidoArea \xe3\x81\xae\xe6\x9c\x80\xe5\xa4\xa7\xe3\x82\xb5\xe3\x82\xa4\xe3\x82\xba\xe3\x81\xaf %d \xe3\x83\x90\xe3\x82\xa4\xe3\x83\x88\xe3\x82\x92\xe7\xa2\xba\xe4\xbf\x9d\xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99\n\x00"
                     as *const u8 as *const libc::c_char, largestSize);
    osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
    sKaleidoAreaPtr =
        GameState_Alloc(&mut (*globalCtx).state, largestSize as size_t,
                        b"../z_kaleido_manager.c\x00" as *const u8 as
    ...
    osSyncPrintf(b"\x1b[32m\x00" as *const u8 as *const libc::c_char);
    osSyncPrintf(b"KaleidoArea %08x - %08x\n\x00" as *const u8 as
                     *const libc::c_char, sKaleidoAreaPtr,
                 (sKaleidoAreaPtr as
                      u32_0).wrapping_add(largestSize as libc::c_uint));
    osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
    gKaleidoMgrCurOvl = 0 as *mut KaleidoMgrOverlay;
}
#[no_mangle]
pub unsafe extern "C" fn KaleidoManager_Destroy() {
    if !gKaleidoMgrCurOvl.is_null() {
        KaleidoManager_ClearOvl(gKaleidoMgrCurOvl);
        gKaleidoMgrCurOvl = 0 as *mut KaleidoMgrOverlay
    }
    sKaleidoAreaPtr = 0 as *mut libc::c_void;
}
// NOTE: this function looks messed up and probably doesn't work how it was intended to
#[no_mangle]
pub unsafe extern "C" fn KaleidoManager_GetRamAddr(mut vram:
                                                       *mut libc::c_void)
 -> *mut libc::c_void {
    let mut current_block: u64;
    let mut iter: *mut KaleidoMgrOverlay = gKaleidoMgrCurOvl;
    let mut ovl: *mut KaleidoMgrOverlay = iter;
    let mut i: u32_0 = 0;
    if ovl.is_null() {
        iter =
            &mut *gKaleidoMgrOverlayTable.as_mut_ptr().offset(0 as libc::c_int
                                                                  as isize) as
                *mut KaleidoMgrOverlay;
        i = 0 as libc::c_int as u32_0;
        loop  {
            ...
            if vram as u32_0 >= (*iter).vramStart as u32_0 &&
                   (*iter).vramEnd as u32_0 >= vram as u32_0 {
                KaleidoManager_LoadOvl(iter);
                ovl = iter;
                current_block = 11440217771949174788;
                break ;
            } else { i = i.wrapping_add(1) }
            // ! @bug Probably missing iter++ here
        } // "Abnormal"
        match current_block {
            11440217771949174788 => { }
            _ => {
                osSyncPrintf(b"\xe7\x95\xb0\xe5\xb8\xb8\n\x00" as *const u8 as
                                 *const libc::c_char);
                return 0 as *mut libc::c_void
            }
        }
    }
    if ovl.is_null() || (vram as u32_0) < (*ovl).vramStart as u32_0 ||
           vram as u32_0 >= (*ovl).vramEnd as u32_0 {
        return 0 as *mut libc::c_void
    }
    return (vram as u32_0).wrapping_add((*ovl).offset) as *mut libc::c_void;
}
    ...
    gKaleidoMgrOverlayTable =
        [{
             let mut init =
                 KaleidoMgrOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                   vromStart:
                                       _ovl_kaleido_scopeSegmentRomStart.as_mut_ptr()
                                           as u32_0,
                                   vromEnd:
                                       _ovl_kaleido_scopeSegmentRomEnd.as_mut_ptr()
                                           as u32_0,
                                   vramStart:
                                       _ovl_kaleido_scopeSegmentStart.as_mut_ptr()
                                           as *mut libc::c_void,
                                   vramEnd:
                                       _ovl_kaleido_scopeSegmentEnd.as_mut_ptr()
                                           as *mut libc::c_void,
                                   offset: 0 as libc::c_int as u32_0,
                                   name:
                                       b"kaleido_scope\x00" as *const u8 as
                                           *const libc::c_char,};
             init
         },
         {
             let mut init =
                 KaleidoMgrOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                   vromStart:
                                       _ovl_player_actorSegmentRomStart.as_mut_ptr()
                                           as u32_0,
                                   vromEnd:
                                       _ovl_player_actorSegmentRomEnd.as_mut_ptr()
                                           as u32_0,
                                   vramStart:
                                       _ovl_player_actorSegmentStart.as_mut_ptr()
                                           as *mut libc::c_void,
                                   vramEnd:
                                       _ovl_player_actorSegmentEnd.as_mut_ptr()
                                           as *mut libc::c_void,
                                   offset: 0 as libc::c_int as u32_0,
                                   name:
                                       b"player_actor\x00" as *const u8 as
                                           *const libc::c_char,};
             init
         }]
}
