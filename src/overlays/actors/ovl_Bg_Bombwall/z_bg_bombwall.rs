...
extern "C" {
    ...
    #[no_mangle]
    static mut gBgBombwallNormalDL: [Gfx; 0];
    #[no_mangle]
    static mut gBgBombwallBrokenDL: [Gfx; 0];
    #[no_mangle]
    static mut gBgBombwallCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgBombwall {
    pub dyna: DynaPolyActor,
    pub collider: ColliderTris,
    pub colliderItems: [ColliderTrisElement; 3],
    pub actionFunc: BgBombwallActionFunc,
    pub dList: *mut Gfx,
    pub unk_2A0: s16,
    pub unk_2A2: u8_0,
    pub unk_2A3: u8_0,
}
pub type BgBombwallActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgBombwall, _: *mut GlobalContext)
               -> ()>;
static mut sTrisElementsInit: [ColliderTrisElementInit; 3] =
    [{
         let mut init =
...
#[no_mangle]
pub static mut Bg_Bombwall_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BOMBWALL as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBombwall_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBombwall_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBombwall_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBombwall_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_InitDynapoly(mut this: *mut BgBombwall,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gBgBombwallCol as *mut CollisionHeader as
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_bombwall.c\x00" as *const u8 as
                         *const libc::c_char, 243 as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_RotateVec(mut arg0: *mut Vec3f,
                                              mut arg1: *mut Vec3f,
                                              mut arg2: f32_0,
                                              mut arg3: f32_0) {
...
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut vecs: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut sp80: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: s32 = 0;
    let mut this: *mut BgBombwall = thisx as *mut BgBombwall;
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        (*this).unk_2A2 =
            ((*this).unk_2A2 as libc::c_int | 2 as libc::c_int) as u8_0;
                ...
                sp80.z =
                    (*sTrisInit.elements.offset(i as
                                                    isize)).dim.vtx[j as
                                                                        usize].z
                        + 2.0f32;
                BgBombwall_RotateVec(&mut *vecs.as_mut_ptr().offset(j as
                                                                        isize),
                                     &mut sp80, sin, cos);
                vecs[j as usize].x += (*this).dyna.actor.world.pos.x;
                vecs[j as usize].y += (*this).dyna.actor.world.pos.y;
                vecs[j as usize].z += (*this).dyna.actor.world.pos.z;
                j += 1
            }
            Collider_SetTrisVertices(&mut (*this).collider, i,
                                     &mut *vecs.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *vecs.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *vecs.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
            i += 1
        ...
        (*this).unk_2A2 =
            ((*this).unk_2A2 as libc::c_int | 1 as libc::c_int) as u8_0;
        func_8086ED50(this, globalCtx);
    }
    osSyncPrintf(b"(field keep \xe6\xb1\x8e\xe7\x94\xa8\xe7\x88\x86\xe5\xbc\xbe\xe5\xa3\x81)(arg_data 0x%04x)(angY %d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int,
                 (*this).dyna.actor.shape.rot.y as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_DestroyCollision(mut this:
                                                         *mut BgBombwall,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).unk_2A2 as libc::c_int & 2 as libc::c_int != 0 {
        DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                               (*this).dyna.bgId);
        (*this).unk_2A2 =
            ((*this).unk_2A2 as libc::c_int & !(2 as libc::c_int)) as u8_0
    }
    if (*this).unk_2A2 as libc::c_int & 1 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgBombwall = thisx as *mut BgBombwall;
    BgBombwall_DestroyCollision(this, globalCtx);
}
static mut D_8086F010: [Vec3s; 7] =
    [{
         let mut init =
             Vec3s{x: 40 as libc::c_int as s16,
                   y: 85 as libc::c_int as s16,
                   z: 21 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: -(43 as libc::c_int) as s16,
                   y: 107 as libc::c_int as s16,
                   z: 14 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: -(1 as libc::c_int) as s16,
                   y: 142 as libc::c_int as s16,
                   z: 14 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: -(27 as libc::c_int) as s16,
                   y: 44 as libc::c_int as s16,
                   z: 27 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 28 as libc::c_int as s16,
                   y: 24 as libc::c_int as s16,
                   z: 20 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: -(39 as libc::c_int) as s16,
                   y: 54 as libc::c_int as s16,
                   z: 21 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Vec3s{x: 49 as libc::c_int as s16,
                   y: 50 as libc::c_int as s16,
                   z: 20 as libc::c_int as s16,};
         init
     }];
#[no_mangle]
pub unsafe extern "C" fn func_8086EB5C(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
    let mut rand: s16 = 0;
    let mut rand2: s16 = 0;
    ...
    while i < 7 as libc::c_int {
        new_var = D_8086F010[i as usize].x as f32_0;
        temp = new_var * cos;
        sp88.x =
            sin * D_8086F010[i as usize].z as libc::c_int as libc::c_float +
                temp + (*pos).x;
        sp88.y =
            (*pos).y +
                D_8086F010[i as usize].y as libc::c_int as libc::c_float;
        sp88.z =
            D_8086F010[i as usize].z as libc::c_int as libc::c_float * cos -
                sin * D_8086F010[i as usize].x as libc::c_int as libc::c_float
                + (*pos).z;
        rand =
        ...
        rand2 =
            ((Rand_ZeroOne() * 240.0f32) as s16 as libc::c_int +
                 0x14 as libc::c_int) as s16;
        func_80033480(globalCtx, &mut sp88, 50.0f32, 2 as libc::c_int, rand,
                      rand2, 1 as libc::c_int as u8_0);
        i += 1
    }
    sp88.x = (*pos).x;
    new_var = (*pos).y + 90.0f32;
    sp88.y = (*pos).y + 90.0f32;
    sp88.z = (*pos).z + 15.0f32;
    func_80033480(globalCtx, &mut sp88, 40.0f32, 4 as libc::c_int,
                  0xa as libc::c_int as s16, 0x32 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_8086ED50(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dList = gBgBombwallNormalDL.as_mut_ptr();
    (*this).actionFunc =
        Some(func_8086ED70 as
                 unsafe extern "C" fn(_: *mut BgBombwall,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086ED70(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8086EDFC(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dList = gBgBombwallNormalDL.as_mut_ptr();
    (*this).unk_2A0 = 1 as libc::c_int as s16;
    func_8086EB5C(this, globalCtx);
    (*this).actionFunc =
        Some(func_8086EE40 as
                 unsafe extern "C" fn(_: *mut BgBombwall,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8086EE40(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8086EE94(mut this: *mut BgBombwall,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dList = gBgBombwallBrokenDL.as_mut_ptr();
    BgBombwall_DestroyCollision(this, globalCtx);
    (*this).actionFunc = None;
}
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgBombwall = thisx as *mut BgBombwall;
...
#[no_mangle]
pub unsafe extern "C" fn BgBombwall_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgBombwall = thisx as *mut BgBombwall;
