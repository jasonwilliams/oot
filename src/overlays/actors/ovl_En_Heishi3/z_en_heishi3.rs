...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHeishi3 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
    pub actionFunc: EnHeishi3ActionFunc,
    pub unk_260: [libc::c_char; 2],
    pub unk_262: s16,
    pub unk_264: s16,
    pub unk_266: [libc::c_char; 8],
    pub unk_26E: s16,
    pub unk_270: [libc::c_char; 2],
    pub caughtTimer: s16,
    pub unk_274: s16,
    pub respawnFlag: u8_0,
    pub unk_278: s16,
    pub unk_27A: [libc::c_char; 2],
    pub collider: ColliderCylinder,
}
pub type EnHeishi3ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHeishi3, _: *mut GlobalContext)
               -> ()>;
static mut sPlayerCaught: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut En_Heishi3_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HEISHI3 as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHeishi3>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi3_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHeishi3_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi3 = thisx as *mut EnHeishi3;
    sPlayerCaught = 0 as libc::c_int as s16;
    if (*this).actor.params as libc::c_int <= 0 as libc::c_int {
        (*this).unk_278 = 0 as libc::c_int as s16
    } else {
        (*this).unk_278 = 1 as libc::c_int as s16;
        if (*this).actor.world.pos.x < -290.0f32 {
    ...
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x9f\x8e\xe9\x96\x80\xe5\x85\xb5\xe3\x83\x91\xe3\x83\xaf\xe3\x83\xbc\xe3\x82\xa2\xe3\x83\x83\xe3\x83\x97 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).actor.gravity = -3.0f32;
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actionFunc =
        Some(EnHeishi3_SetupGuardType as
                 unsafe extern "C" fn(_: *mut EnHeishi3,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHeishi3 = thisx as *mut EnHeishi3;
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_SetupGuardType(mut this: *mut EnHeishi3,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    if (*this).unk_278 as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(EnHeishi3_StandSentinelInGrounds as
                     unsafe extern "C" fn(_: *mut EnHeishi3,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(EnHeishi3_StandSentinelInCastle as
                     unsafe extern "C" fn(_: *mut EnHeishi3,
                                          _: *mut GlobalContext) -> ())
    };
}
 ...
 **/
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_StandSentinelInGrounds(mut this:
                                                              *mut EnHeishi3,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player; // "Discovered!"
    let mut yawDiff: s16 = 0;
    let mut yawDiffNew: s16 = 0;
    let mut sightRange: f32_0 = 0.;
    player =
 ...
 **/
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_StandSentinelInCastle(mut this:
                                                             *mut EnHeishi3,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as
            *mut Player; // "Discovered!"
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*player).actor.world.pos.x < -190.0f32 &&
           (*player).actor.world.pos.x > -380.0f32 &&
           fabsf((*player).actor.world.pos.y - (*this).actor.world.pos.y) <
               100.0f32 && (*player).actor.world.pos.z < 1020.0f32 &&
           (*player).actor.world.pos.z > 700.0f32 &&
           sPlayerCaught as libc::c_int == 0 as libc::c_int {
        if (*this).unk_278 as libc::c_int == 1 as libc::c_int {
            if (*player).actor.world.pos.x < -290.0f32 { return }
        } else if (*player).actor.world.pos.x > -290.0f32 { return }
        sPlayerCaught = 1 as libc::c_int as s16;
        Message_StartTextbox(globalCtx, 0x702d as libc::c_int as u16_0,
                             &mut (*this).actor);
        func_80078884(0x482c as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_CatchStart(mut this: *mut EnHeishi3,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gEnHeishiWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiWalkAnim, 1.0f32,
                     0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).caughtTimer = 20 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80A55BD4 as
                 unsafe extern "C" fn(_: *mut EnHeishi3,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 2.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A55BD4(mut this: *mut EnHeishi3,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).caughtTimer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(EnHeishi3_ResetAnimationToIdle as
                     unsafe extern "C" fn(_: *mut EnHeishi3,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_ResetAnimationToIdle(mut this:
                                                            *mut EnHeishi3,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut frameCount: f32_0 =
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gEnHeishiIdleAnim, 1.0f32,
                     ...
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(func_80A55D00 as
                 unsafe extern "C" fn(_: *mut EnHeishi3,
                                      _: *mut GlobalContext) -> ());
}
// This function initiates the respawn after the player gets caught.
#[no_mangle]
pub unsafe extern "C" fn func_80A55D00(mut this: *mut EnHeishi3,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime); // Hyrule Castle from Guard Capture (outside)
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           ...
           (*this).respawnFlag as libc::c_int == 0 as libc::c_int {
        ...
        (*globalCtx).nextEntranceIndex = 0x47e as libc::c_int as s16;
        (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8;
        (*this).respawnFlag = 1 as libc::c_int as u8_0;
        (*globalCtx).fadeTransition = 0x2e as libc::c_int as u8_0;
        gSaveContext.nextTransition = 0x2e as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi3 = thisx as *mut EnHeishi3;
    let mut pad: s32 = 0;
    Actor_SetFocus(&mut (*this).actor, 60.0f32);
    (*this).unk_274 =
        ((*this).unk_274 as libc::c_int + 1 as libc::c_int) as s16;
    if (*this).caughtTimer as libc::c_int != 0 as libc::c_int {
        (*this).caughtTimer =
            ((*this).caughtTimer as libc::c_int - 1 as libc::c_int) as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 9 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_26E as libc::c_int) as s16
    }
    if limbIndex == 16 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_262 as libc::c_int) as s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_264 as libc::c_int) as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHeishi3_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHeishi3 = thisx as *mut EnHeishi3;
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnHeishi3_OverrideLimbDraw as
