...
extern "C" {
    ...
    #[no_mangle]
    static mut object_haka_objects_DL_00BF20: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_DL_0021F0: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaSgami {
    pub actor: Actor,
    pub actionFunc: BgHakaSgamiActionFunc,
    pub requiredObjBankIndex: s8,
    pub unk_151: s8,
    pub timer: s16,
    pub blureEffectIndex: [s32; 2],
    pub colliderScytheCenter: ColliderCylinder,
    pub colliderScythe: ColliderTris,
    pub colliderScytheItems: [ColliderTrisElement; 4],
}
pub type BgHakaSgamiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaSgami, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const SCYTHE_TRAP_ICE_CAVERN: C2RustUnnamed_22 = 2;
pub const SCYTHE_TRAP_SHADOW_TEMPLE_INVISIBLE: C2RustUnnamed_22 = 1;
pub const SCYTHE_TRAP_SHADOW_TEMPLE: C2RustUnnamed_22 = 0;
#[no_mangle]
pub static mut Bg_Haka_Sgami_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_SGAMI as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHakaSgami>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaSgami_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaSgami_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaSgami_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTrisElementsInit: [ColliderTrisElementInit; 4] =
    [{
         let mut init =
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 0 as libc::c_int as u8_0,
                                   ...
                                   cylHeight: 130 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    static mut sP1StartColor: [u8_0; 4] =
        [250 as libc::c_int as u8_0, 250 as libc::c_int as u8_0,
         250 as libc::c_int as u8_0, 200 as libc::c_int as u8_0];
    static mut sP2StartColor: [u8_0; 4] =
        [200 as libc::c_int as u8_0, 200 as libc::c_int as u8_0,
         200 as libc::c_int as u8_0, 130 as libc::c_int as u8_0];
    static mut sP1EndColor: [u8_0; 4] =
        [200 as libc::c_int as u8_0, 200 as libc::c_int as u8_0,
         200 as libc::c_int as u8_0, 60 as libc::c_int as u8_0];
    static mut sP2EndColor: [u8_0; 4] =
        [150 as libc::c_int as u8_0, 150 as libc::c_int as u8_0,
         150 as libc::c_int as u8_0, 20 as libc::c_int as u8_0];
    let mut this: *mut BgHakaSgami = thisx as *mut BgHakaSgami;
    let mut blureInit: EffectBlureInit1 =
        EffectBlureInit1{unk_00: [0; 388],
                         ...
                         calcMode: 0,};
    let mut i: s32 = 0;
    let mut colliderScythe: *mut ColliderTris = &mut (*this).colliderScythe;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    (*this).unk_151 =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s8;
    (*thisx).params =
    ...
    Collider_SetTris(globalCtx, colliderScythe, thisx, &mut sTrisInit,
                     (*this).colliderScytheItems.as_mut_ptr());
    Collider_InitCylinder(globalCtx, &mut (*this).colliderScytheCenter);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderScytheCenter, thisx,
                         &mut sCylinderInit);
    (*this).colliderScytheCenter.dim.pos.x = (*thisx).world.pos.x as s16;
    (*this).colliderScytheCenter.dim.pos.y = (*thisx).world.pos.y as s16;
    (*this).colliderScytheCenter.dim.pos.z = (*thisx).world.pos.z as s16;
    CollisionCheck_SetInfo(&mut (*thisx).colChkInfo, 0 as *mut DamageTable,
                           &mut sColChkInfoInit);
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        blureInit.p1StartColor[i as usize] = sP1StartColor[i as usize];
        blureInit.p2StartColor[i as usize] = sP2StartColor[i as usize];
        blureInit.p1EndColor[i as usize] = sP1EndColor[i as usize];
        blureInit.p2EndColor[i as usize] = sP2EndColor[i as usize];
        i += 1
    }
    blureInit.elemDuration = 10 as libc::c_int;
    blureInit.unkFlag = 0 as libc::c_int;
    blureInit.calcMode = 2 as libc::c_int;
    Effect_Add(globalCtx,
               &mut *(*this).blureEffectIndex.as_mut_ptr().offset(0 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
    ...
    Effect_Add(globalCtx,
               &mut *(*this).blureEffectIndex.as_mut_ptr().offset(1 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
               EFFECT_BLURE1 as libc::c_int, 0 as libc::c_int as u8_0,
    ...
    if (*thisx).params as libc::c_int ==
           SCYTHE_TRAP_SHADOW_TEMPLE as libc::c_int {
        (*this).requiredObjBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_HAKA_OBJECTS as libc::c_int as s16) as s8;
        (*thisx).flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
    } else {
        (*this).requiredObjBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_ICE_OBJECTS as libc::c_int as s16) as s8;
        (*this).colliderScytheCenter.dim.radius = 30 as libc::c_int as s16;
        (*this).colliderScytheCenter.dim.height = 70 as libc::c_int as s16;
        Actor_SetFocus(thisx, 40.0f32);
    }
    ...
    (*this).actionFunc =
        Some(BgHakaSgami_SetupSpin as
                 unsafe extern "C" fn(_: *mut BgHakaSgami,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHakaSgami = thisx as *mut BgHakaSgami;
    Effect_Delete(globalCtx,
                  (*this).blureEffectIndex[0 as libc::c_int as usize]);
    Effect_Delete(globalCtx,
                  (*this).blureEffectIndex[1 as libc::c_int as usize]);
    Collider_DestroyTris(globalCtx, &mut (*this).colliderScythe);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderScytheCenter);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_SetupSpin(mut this: *mut BgHakaSgami,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        (*this).actionFunc =
            Some(BgHakaSgami_Spin as
                     unsafe extern "C" fn(_: *mut BgHakaSgami,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_Spin(mut this: *mut BgHakaSgami,
                                          mut globalCtx: *mut GlobalContext) {
    static mut blureEffectVertices2: [Vec3f; 2] =
        [{
             let mut init = Vec3f{x: -20.0f32, y: 50.0f32, z: 130.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -50.0f32, y: 33.0f32, z: 20.0f32,};
             init
         }];
    static mut blureEffectVertices1: [Vec3f; 2] =
        [{ let mut init = Vec3f{x: 380.0f32, y: 50.0f32, z: 50.0f32,}; init },
         { let mut init = Vec3f{x: 310.0f32, y: 33.0f32, z: 0.0f32,}; init }];
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut scytheVertices: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut actorRotYSin: f32_0 = 0.;
    let mut actorRotYCos: f32_0 = 0.;
    let mut iterateCount: s32 = 0;
    let mut elementInit: *mut ColliderTrisElementInit =
        ...
        ((*this).actor.shape.rot.y as libc::c_int +
             ((512.0f32 *
                   sinf((*this).timer as libc::c_int as libc::c_float *
                            (3.14159265358979323846f32 / 16.0f32))) as s16 as
                  libc::c_int + 0x400 as libc::c_int >> 1 as libc::c_int)) as
            s16;
    ...
    i = iterateCount - 2 as libc::c_int;
    while i < iterateCount {
        elementInit =
            &mut *sTrisInit.elements.offset(i as isize) as
                *mut ColliderTrisElementInit;
        j = 0 as libc::c_int;
        while j < 3 as libc::c_int {
            scytheVertices[j as usize].x =
                (*this).actor.world.pos.x +
                    (*elementInit).dim.vtx[j as usize].z * actorRotYSin +
                    (*elementInit).dim.vtx[j as usize].x * actorRotYCos;
            scytheVertices[j as usize].y =
                (*this).actor.world.pos.y +
                    (*elementInit).dim.vtx[j as usize].y;
            scytheVertices[j as usize].z =
                (*this).actor.world.pos.z +
                    (*elementInit).dim.vtx[j as usize].z * actorRotYCos -
                    (*elementInit).dim.vtx[j as usize].x * actorRotYSin;
            j += 1
        }
        Collider_SetTrisVertices(&mut (*this).colliderScythe, i,
                                 &mut *scytheVertices.as_mut_ptr().offset(0 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
                                 &mut *scytheVertices.as_mut_ptr().offset(1 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
                                 &mut *scytheVertices.as_mut_ptr().offset(2 as
                                                                              libc::c_int
                                                                              as
                                                                              isize));
        j = 0 as libc::c_int;
        while j < 3 as libc::c_int {
            scytheVertices[j as usize].x =
                2 as libc::c_int as libc::c_float * (*this).actor.world.pos.x
                    - scytheVertices[j as usize].x;
            scytheVertices[j as usize].z =
                2 as libc::c_int as libc::c_float * (*this).actor.world.pos.z
                    - scytheVertices[j as usize].z;
            j += 1
        }
        Collider_SetTrisVertices(&mut (*this).colliderScythe,
                                 (i + 2 as libc::c_int) % 4 as libc::c_int,
                                 &mut *scytheVertices.as_mut_ptr().offset(0 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
    ...
    if (*this).unk_151 as libc::c_int == 0 as libc::c_int ||
        ...
        scytheVertices[0 as libc::c_int as usize].x =
            (*this).actor.world.pos.x +
                blureEffectVertices1[(*this).actor.params as usize].z *
                    actorRotYSin +
                blureEffectVertices1[(*this).actor.params as usize].x *
                    actorRotYCos;
        scytheVertices[0 as libc::c_int as usize].y =
            (*this).actor.world.pos.y +
                blureEffectVertices1[(*this).actor.params as usize].y;
        scytheVertices[0 as libc::c_int as usize].z =
            (*this).actor.world.pos.z +
                blureEffectVertices1[(*this).actor.params as usize].z *
                    actorRotYCos -
                blureEffectVertices1[(*this).actor.params as usize].x *
                    actorRotYSin;
        scytheVertices[1 as libc::c_int as usize].x =
            (*this).actor.world.pos.x +
                blureEffectVertices2[(*this).actor.params as usize].z *
                    actorRotYSin +
                blureEffectVertices2[(*this).actor.params as usize].x *
                    actorRotYCos;
        scytheVertices[1 as libc::c_int as usize].y =
            (*this).actor.world.pos.y +
                blureEffectVertices2[(*this).actor.params as usize].y;
        scytheVertices[1 as libc::c_int as usize].z =
            (*this).actor.world.pos.z +
                blureEffectVertices2[(*this).actor.params as usize].z *
                    actorRotYCos -
                blureEffectVertices2[(*this).actor.params as usize].x *
                    actorRotYSin;
        EffectBlure_AddVertex(Effect_GetByIndex((*this).blureEffectIndex[0 as
                                                                             libc::c_int
                                                                             as
                                                                             usize])
                                  as *mut EffectBlure,
        ...
        EffectBlure_AddVertex(Effect_GetByIndex((*this).blureEffectIndex[1 as
                                                                             libc::c_int
                                                                             as
                                                                             usize])
                                  as *mut EffectBlure,
    ...
    CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderScythe.base);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderScytheCenter.base);
    func_8002F974(&mut (*this).actor,
                  (0x284c as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHakaSgami = thisx as *mut BgHakaSgami;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaSgami_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaSgami = thisx as *mut BgHakaSgami;
    if (*this).unk_151 as libc::c_int != 0 as libc::c_int {
        Gfx_DrawDListXlu(globalCtx,
                         object_haka_objects_DL_00BF20.as_mut_ptr());
        ...
        Gfx_DrawDListOpa(globalCtx,
                         object_ice_objects_DL_0021F0.as_mut_ptr());
    };
}
