...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ice_objects_DL_0023D0: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_Col_002594: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgIceTurara {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgIceTuraraActionFunc,
    pub shiverTimer: s16,
    pub collider: ColliderCylinder,
}
pub type BgIceTuraraActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgIceTurara, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const TURARA_STALACTITE_REGROW: C2RustUnnamed_22 = 2;
pub const TURARA_STALACTITE: C2RustUnnamed_22 = 1;
pub const TURARA_STALAGMITE: C2RustUnnamed_22 = 0;
...
#[no_mangle]
pub static mut Bg_Ice_Turara_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_ICE_TURARA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgIceTurara>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceTurara_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceTurara_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceTurara_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceTurara_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgIceTurara = thisx as *mut BgIceTurara;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut object_ice_objects_Col_002594 as
    ...
    if (*this).dyna.actor.params as libc::c_int ==
           TURARA_STALAGMITE as libc::c_int {
        (*this).actionFunc =
            Some(BgIceTurara_Stalagmite as
                     unsafe extern "C" fn(_: *mut BgIceTurara,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).dyna.actor.shape.rot.x = -(0x8000 as libc::c_int) as s16;
        (*this).dyna.actor.shape.yOffset = 1200.0f32;
        (*this).actionFunc =
            Some(BgIceTurara_Wait as
                     unsafe extern "C" fn(_: *mut BgIceTurara,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgIceTurara = thisx as *mut BgIceTurara;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Break(mut this: *mut BgIceTurara,
                                           mut globalCtx: *mut GlobalContext,
                                           mut arg2: f32_0) {
    ...
    while i < 2 as libc::c_int {
        ...
        while j < 10 as libc::c_int {
            pos.x =
                (*this).dyna.actor.world.pos.x + Rand_CenteredFloat(8.0f32);
            pos.y =
                (*this).dyna.actor.world.pos.y + Rand_ZeroOne() * arg2 +
                    i as libc::c_float * arg2;
            pos.z =
                (*this).dyna.actor.world.pos.z + Rand_CenteredFloat(8.0f32);
            vel.x = Rand_CenteredFloat(7.0f32);
            vel.z = Rand_CenteredFloat(7.0f32);
            vel.y = Rand_ZeroOne() * 4.0f32 + 8.0f32;
            EffectSsEnIce_Spawn(globalCtx, &mut pos,
                                Rand_ZeroOne() * 0.2f32 + 0.1f32, &mut vel,
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Stalagmite(mut this: *mut BgIceTurara,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        BgIceTurara_Break(this, globalCtx, 50.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Wait(mut this: *mut BgIceTurara,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).dyna.actor.xzDistToPlayer < 60.0f32 {
        (*this).shiverTimer = 10 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgIceTurara_Shiver as
                     unsafe extern "C" fn(_: *mut BgIceTurara,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Shiver(mut this: *mut BgIceTurara,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut phi_v0_3: s16 = 0;
    let mut phi_v0_2: s16 = 0;
    let mut sp28: f32_0 = 0.;
    if (*this).shiverTimer as libc::c_int != 0 as libc::c_int {
        (*this).shiverTimer -= 1
    }
    if (*this).shiverTimer as libc::c_int % 4 as libc::c_int == 0 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28d4 as libc::c_int as u16_0);
    }
    if (*this).shiverTimer as libc::c_int == 0 as libc::c_int {
        ...
        (*this).dyna.actor.world.pos.x =
            phi_v0_2 as libc::c_int as libc::c_float *
                (0.5f32 * sp28 + 0.5f32) + (*this).dyna.actor.home.pos.x;
        sp28 = Rand_ZeroOne();
        phi_v0_3 =
            if Rand_ZeroOne() < 0.5f32 {
                -(1 as libc::c_int)
        ...
        (*this).dyna.actor.world.pos.z =
            phi_v0_3 as libc::c_int as libc::c_float *
                (0.5f32 * sp28 + 0.5f32) + (*this).dyna.actor.home.pos.z
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Fall(mut this: *mut BgIceTurara,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).dyna.actor.bgCheckFlags as libc::c_int & 1 as libc::c_int
               != 0 {
        ...
        BgIceTurara_Break(this, globalCtx, 40.0f32);
        if (*this).dyna.actor.params as libc::c_int ==
               TURARA_STALACTITE_REGROW as libc::c_int {
            (*this).dyna.actor.world.pos.y =
                (*this).dyna.actor.home.pos.y + 120.0f32;
            func_8003EC50(globalCtx, &mut (*globalCtx).colCtx.dyna,
                          (*this).dyna.bgId);
            (*this).actionFunc =
                Some(BgIceTurara_Regrow as
                         unsafe extern "C" fn(_: *mut BgIceTurara,
                                              _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Regrow(mut this: *mut BgIceTurara,
                                            mut globalCtx:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgIceTurara = thisx as *mut BgIceTurara;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceTurara_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, object_ice_objects_DL_0023D0.as_mut_ptr());
}
