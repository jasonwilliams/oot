...
extern "C" {
    ...
    #[no_mangle]
    static mut gLonLonMilkCrateDL: [Gfx; 0];
    #[no_mangle]
    static mut gLonLonMilkCrateCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot15Rrbox {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot15RrboxActionFunc,
    pub unk_168: s16,
    pub unk_16C: f32_0,
    pub unk_170: f32_0,
    pub unk_174: f32_0,
...
pub type BgSpot15RrboxActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot15Rrbox, _: *mut GlobalContext)
               -> ()>;
static mut D_808B4590: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Bg_Spot15_Rrbox_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT15_RRBOX as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT15_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot15Rrbox>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Rrbox_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Rrbox_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Rrbox_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot15Rrbox_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B45C4: [Vec3f; 2] =
    [{ let mut init = Vec3f{x: 770.0f32, y: 1490.0f32, z: -299.0f32,}; init },
     {
         let mut init = Vec3f{x: 770.0f32, y: 1550.0f32, z: -299.0f32,};
         init
     }];
static mut D_808B45DC: [Vec3f; 5] =
    [{ let mut init = Vec3f{x: 29.99f32, y: 0.01f32, z: -29.99f32,}; init },
     { let mut init = Vec3f{x: -29.99f32, y: 0.01f32, z: -29.99f32,}; init },
     { let mut init = Vec3f{x: -29.99f32, y: 0.01f32, z: 29.99f32,}; init },
     { let mut init = Vec3f{x: 29.99f32, y: 0.01f32, z: 29.99f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.01f32, z: 0.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn func_808B3960(mut this: *mut BgSpot15Rrbox,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_spot15_rrbox.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_808B39E8(mut arg0: *mut Vec3f,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3A34(mut this: *mut BgSpot15Rrbox) {
    (*this).bgId = 50 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3A40(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut dynaPolyActor: *mut DynaPolyActor =
        DynaPoly_GetActor(&mut (*globalCtx).colCtx, (*this).bgId);
    if !dynaPolyActor.is_null() &&
           Math3D_Dist2DSq((*dynaPolyActor).actor.world.pos.x,
                           (*dynaPolyActor).actor.world.pos.z,
                           (*this).dyna.actor.world.pos.x,
                           (*this).dyna.actor.world.pos.z) < 0.01f32 {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3AAC(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut rotY: s16 = 0;
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SOUKO as libc::c_int {
        ...
        if func_808B3A40(this, globalCtx) != 0 { return 0 as libc::c_int }
    }
    if (*actor).world.pos.x <= 930.0f32 && (*actor).world.pos.z >= -360.0f32 {
        if (*this).dyna.unk_150 >= 0.0f32 {
            rotY = (*actor).world.rot.y
        } else {
            rotY =
                ((*actor).world.rot.y as libc::c_int + 0x8000 as libc::c_int)
                    as s16
        }
        if (rotY as libc::c_int) < 0x2000 as libc::c_int &&
               rotY as libc::c_int > -(0x6000 as libc::c_int) {
            return gSaveContext.eventChkInf[1 as libc::c_int as usize] as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Rrbox_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot15Rrbox = thisx as *mut BgSpot15Rrbox;
    func_808B3960(this, globalCtx, &mut gLonLonMilkCrateCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        (*this).dyna.actor.world.pos = D_808B45C4[D_808B4590 as usize];
        D_808B4590 += 1
    } else { func_808B4084(this, globalCtx); }
    osSyncPrintf(b"(spot15 \xe3\x83\xad\xe3\x83\xb3\xe3\x83\xad\xe3\x83\xb3\xe6\x9c\xa8\xe7\xae\xb1)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Rrbox_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot15Rrbox = thisx as *mut BgSpot15Rrbox;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    D_808B4590 = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3CA0(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) -> s32 {
    let mut chkDist: f32_0 = 0.0f32;
    let mut actorPosition: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut actorScale: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    func_808B3A34(this);
    actorScale.x =
        D_808B45DC[arg2 as usize].x * ((*this).dyna.actor.scale.x * 10.0f32);
    actorScale.y =
        D_808B45DC[arg2 as usize].y * ((*this).dyna.actor.scale.y * 10.0f32);
    actorScale.z =
        D_808B45DC[arg2 as usize].z * ((*this).dyna.actor.scale.z * 10.0f32);
    func_808B39E8(&mut actorPosition, &mut actorScale, (*this).unk_16C,
                  (*this).unk_170);
    ...
    (*this).dyna.actor.floorHeight =
        BgCheck_EntityRaycastFloor6(&mut (*globalCtx).colCtx,
                                    &mut (*this).dyna.actor.floorPoly,
                                    &mut (*this).bgId,
                                    &mut (*this).dyna.actor,
                                    &mut actorPosition, chkDist);
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3DDC(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext)
 -> f32_0 {
    let mut i: s32 = 0;
    ...
    let mut returnValue: f32_0 = -32000.0f32;
    let mut bgId: s32 = 0;
    func_808B3A34(this);
    i = 0 as libc::c_int;
    while i <
        ...
        scale.x = D_808B45DC[i as usize].x * ((*actor).scale.x * 10.0f32);
        scale.y = D_808B45DC[i as usize].y * ((*actor).scale.y * 10.0f32);
        scale.z = D_808B45DC[i as usize].z * ((*actor).scale.z * 10.0f32);
        func_808B39E8(&mut position, &mut scale, (*this).unk_16C,
                      (*this).unk_170);
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3F58(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if func_808B3CA0(this, globalCtx, 0 as libc::c_int) != 0 {
        return 1 as libc::c_int
    }
    if func_808B3CA0(this, globalCtx, 1 as libc::c_int) != 0 {
        return 1 as libc::c_int
    }
    if func_808B3CA0(this, globalCtx, 2 as libc::c_int) != 0 {
        return 1 as libc::c_int
    }
    if func_808B3CA0(this, globalCtx, 3 as libc::c_int) != 0 {
        return 1 as libc::c_int
    }
    if func_808B3CA0(this, globalCtx, 4 as libc::c_int) != 0 {
        return 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B4010(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    return (func_800435D8(globalCtx, &mut (*this).dyna,
                          ((*this).dyna.actor.scale.x * 290.0f32) as s16,
                          ((*this).dyna.actor.scale.x * 290.0f32 + 20.0f32) as
                              s16, 1.0f32 as s16) == 0) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B4084(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actionFunc =
        Some(func_808B40AC as
                 unsafe extern "C" fn(_: *mut BgSpot15Rrbox,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.gravity = 0.0f32;
    (*this).dyna.actor.velocity.x = 0.0f32;
    (*this).dyna.actor.velocity.y = 0.0f32;
    (*this).dyna.actor.velocity.z = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B40AC(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).unk_168 as libc::c_int <= 0 as libc::c_int &&
           fabsf((*this).dyna.unk_150) > 0.001f32 {
        if func_808B3AAC(this, globalCtx) != 0 &&
               func_808B4010(this, globalCtx) == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B4178(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actionFunc =
        Some(func_808B4194 as
                 unsafe extern "C" fn(_: *mut BgSpot15Rrbox,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.gravity = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B4194(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sign: f32_0 = 0.;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut tempUnk178: f32_0 = 0.;
    let mut approxFResult: s32 = 0;
    let mut actor: *mut Actor = &mut (*this).dyna.actor;
    (*this).unk_174 += 0.5f32;
    (*this).unk_174 =
        if (*this).unk_174 > 2.0f32 { 2.0f32 } else { (*this).unk_174 };
    approxFResult =
        Math_StepToF(&mut (*this).unk_178, 20.0f32, (*this).unk_174);
    sign = if (*this).unk_17C >= 0.0f32 { 1.0f32 } else { -1.0f32 };
    tempUnk178 = sign * (*this).unk_178;
    ...
    if func_808B3F58(this, globalCtx) == 0 {
    ...
    } else if approxFResult != 0 {
        player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        if func_808B4010(this, globalCtx) != 0 {
            Audio_PlayActorSound2(actor, 0x28c9 as libc::c_int as u16_0);
        }
        ...
        (*this).unk_178 = 0.0f32;
        (*this).unk_174 = 0.0f32;
        (*this).unk_168 = 10 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B4380(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dyna.actor.velocity.x = 0.0f32;
    (*this).dyna.actor.velocity.y = 0.0f32;
    (*this).dyna.actor.velocity.z = 0.0f32;
    ...
    (*this).actionFunc =
        Some(func_808B43D0 as
                 unsafe extern "C" fn(_: *mut BgSpot15Rrbox,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B43D0(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    let mut floorHeight: f32_0 = 0.;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut actor: *mut Actor = &mut (*this).dyna.actor;
    ...
    if (*actor).world.pos.y <= -32000.0f32 + 10.0f32 {
        // "Lon Lon wooden crate fell too much"
        osSyncPrintf(b"Warning : \xe3\x83\xad\xe3\x83\xb3\xe3\x83\xad\xe3\x83\xb3\xe6\x9c\xa8\xe7\xae\xb1\xe8\x90\xbd\xe3\x81\xa1\xe3\x81\x99\xe3\x81\x8e\xe3\x81\x9f(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_spot15_rrbox.c\x00" as *const u8 as
                         *const libc::c_char, 599 as libc::c_int,
                     (*actor).params as libc::c_int);
        Actor_Kill(actor);
        return
    }
    floorHeight = (*actor).floorHeight;
    if floorHeight - (*actor).world.pos.y >= -0.001f32 {
        (*actor).world.pos.y = floorHeight;
        func_808B4084(this, globalCtx);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28c9 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B44B8(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actionFunc =
        Some(func_808B44CC as
                 unsafe extern "C" fn(_: *mut BgSpot15Rrbox,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B44CC(mut this: *mut BgSpot15Rrbox,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Rrbox_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot15Rrbox = thisx as *mut BgSpot15Rrbox;
    if (*this).unk_168 as libc::c_int > 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot15Rrbox_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gLonLonMilkCrateDL.as_mut_ptr());
}
