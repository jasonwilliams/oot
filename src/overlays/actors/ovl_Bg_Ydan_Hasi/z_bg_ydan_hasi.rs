...
extern "C" {
    ...
    #[no_mangle]
    static mut gDTRisingPlatformsDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTRisingPlatformsCol: CollisionHeader;
    #[no_mangle]
    static mut gDTWaterPlaneDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTSlidingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTSlidingPlatformCol: CollisionHeader;
}
...
pub struct BgYdanHasi {
    ...
    pub actionFunc: BgYdanHasiActionFunc,
    pub type_0: u8_0,
    pub timer: s16,
}
pub type BgYdanHasiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgYdanHasi, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const HASI_THREE_BLOCKS: C2RustUnnamed_19 = 2;
pub const HASI_WATER: C2RustUnnamed_19 = 1;
pub const HASI_WATER_BLOCK: C2RustUnnamed_19 = 0;
#[no_mangle]
pub static mut Bg_Ydan_Hasi_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_YDAN_HASI as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanHasi_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanHasi_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanHasi_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanHasi_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgYdanHasi = thisx as *mut BgYdanHasi;
    ...
    waterBox =
        &mut *(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(1 as
                                                                     libc::c_int
                                                                     as isize)
            as *mut WaterBox;
    DynaPolyActor_Init(&mut (*this).dyna, DPM_PLAYER as libc::c_int);
    if (*thisx).params as libc::c_int == HASI_WATER as libc::c_int {
        // Water the moving platform floats on in B1. Never runs in Master Quest
        (*thisx).home.pos.y += -5.0f32;
        (*thisx).world.pos.y = (*thisx).home.pos.y;
        (*waterBox).ySurface = (*thisx).world.pos.y as s16;
        (*this).actionFunc =
            Some(BgYdanHasi_InitWater as
                     unsafe extern "C" fn(_: *mut BgYdanHasi,
                                          _: *mut GlobalContext) -> ())
    } else {
        if (*thisx).params as libc::c_int == HASI_WATER_BLOCK as libc::c_int {
            // Moving platform on the water in B1
            CollisionHeader_GetVirtual(&mut gDTSlidingPlatformCol as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
            (*thisx).scale.z = 0.15f32;
            (*thisx).scale.x = 0.15f32;
            (*thisx).world.pos.y =
                (*waterBox).ySurface as libc::c_int as libc::c_float +
                    20.0f32;
            (*this).actionFunc =
                Some(BgYdanHasi_UpdateFloatingBlock as
                         unsafe extern "C" fn(_: *mut BgYdanHasi,
                                              _: *mut GlobalContext) -> ())
        } else {
            // 3 platforms on 2F
            CollisionHeader_GetVirtual(&mut gDTRisingPlatformsCol as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
            (*thisx).draw = None;
            (*this).actionFunc =
                Some(BgYdanHasi_SetupThreeBlocks as
                         unsafe extern "C" fn(_: *mut BgYdanHasi,
                                              _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgYdanHasi = thisx as *mut BgYdanHasi;
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_UpdateFloatingBlock(mut this:
                                                            *mut BgYdanHasi,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut waterBox: *mut WaterBox = 0 as *mut WaterBox;
    let mut framesAfterMath: f32_0 = 0.;
    framesAfterMath =
        sinf(((*globalCtx).gameplayFrames &
                  0xff as libc::c_int as libc::c_uint) as libc::c_float *
                 (3.14159265358979323846f32 /
                      128 as libc::c_int as libc::c_float)) * 165.0f32;
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).dyna.actor.world.rot.y) * framesAfterMath +
            (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).dyna.actor.world.rot.y) * framesAfterMath +
    ...
    (*this).dyna.actor.world.pos.y =
        (*waterBox).ySurface as libc::c_int as libc::c_float + 20.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_InitWater(mut this: *mut BgYdanHasi,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).type_0 as s32) != 0 {
        (*this).timer = 600 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgYdanHasi_MoveWater as
                     unsafe extern "C" fn(_: *mut BgYdanHasi,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_MoveWater(mut this: *mut BgYdanHasi,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut waterBox: *mut WaterBox = 0 as *mut WaterBox;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
               ...
               0 as libc::c_int {
            Flags_UnsetSwitch(globalCtx, (*this).type_0 as s32);
            (*this).actionFunc =
                Some(BgYdanHasi_InitWater as
                         unsafe extern "C" fn(_: *mut BgYdanHasi,
                                              _: *mut GlobalContext) -> ())
        ...
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y - 47.0f32, 0.5f32) != 0
           {
            (*this).actionFunc =
                Some(BgYdanHasi_DecWaterTimer as
                         unsafe extern "C" fn(_: *mut BgYdanHasi,
                                              _: *mut GlobalContext) -> ())
        }
        func_8002F948(&mut (*this).dyna.actor,
    ...
    waterBox =
        &mut *(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(1 as
                                                                     ...
                                                                     as isize)
            as *mut WaterBox;
    (*waterBox).ySurface = (*this).dyna.actor.world.pos.y as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_DecWaterTimer(mut this: *mut BgYdanHasi,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_SetupThreeBlocks(mut this:
                                                         *mut BgYdanHasi,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).type_0 as s32) != 0 {
        (*this).timer = 260 as libc::c_int as s16;
        (*this).dyna.actor.draw =
            Some(BgYdanHasi_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFunc =
            Some(BgYdanHasi_UpdateThreeBlocks as
                     unsafe extern "C" fn(_: *mut BgYdanHasi,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 3040 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_UpdateThreeBlocks(mut this:
                                                          *mut BgYdanHasi,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y, 3.0f32) !=
               0 as libc::c_int {
            Flags_UnsetSwitch(globalCtx, (*this).type_0 as s32);
            ...
            func_8002F948(&mut (*this).dyna.actor,
                          (0x2824 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
    } else if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                           (*this).dyna.actor.home.pos.y + 120.0f32, 3.0f32)
                  == 0 {
        func_8002F948(&mut (*this).dyna.actor,
                      (0x2824 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    } else { func_8002F994(&mut (*this).dyna.actor, (*this).timer as s32); };
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgYdanHasi = thisx as *mut BgYdanHasi;
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanHasi_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 3] =
        unsafe {
            [gDTSlidingPlatformDL.as_ptr() as *mut _,
             gDTWaterPlaneDL.as_ptr() as *mut _,
             gDTRisingPlatformsDL.as_ptr() as *mut _]
        };
    let mut this: *mut BgYdanHasi = thisx as *mut BgYdanHasi;
    if (*this).dyna.actor.params as libc::c_int ==
           HASI_WATER_BLOCK as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int ==
               HASI_THREE_BLOCKS as libc::c_int {
        Gfx_DrawDListOpa(globalCtx,
                         dLists[(*this).dyna.actor.params as usize]);
    } else {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_bg_ydan_hasi.c\x00" as *const u8 as
                            *const libc::c_char, 577 as libc::c_int);
        ...
        (*_g).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             (*globalCtx).gameplayFrames.wrapping_neg().wrapping_rem(128
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint),
                             (*globalCtx).gameplayFrames.wrapping_rem(128 as
                                                                          libc::c_int
                                                                          as
                                                                          libc::c_uint),
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = gDTWaterPlaneDL.as_mut_ptr() as libc::c_uint;
