...
extern "C" {
    ...
    #[no_mangle]
    fn Actor_IsFacingAndNearPlayer(actor: *mut Actor, range: f32_0,
                                   angle: s16) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_efc_star_field_DL_000080: [Gfx; 0];
    #[no_mangle]
    static mut object_efc_star_field_DL_000DE0: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_007440: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_007578: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_008390: [Gfx; 0];
    // adult warp songs cutscenes
    #[no_mangle]
    static mut gAdultWarpInCS: [CutsceneData; 0];
    #[no_mangle]
    static mut gAdultWarpOutCS: [CutsceneData; 0];
    // adult warp songs cutscenes in temple of time
    #[no_mangle]
    static mut gAdultWarpInToTCS: [CutsceneData; 0];
    #[no_mangle]
    static mut gAdultWarpOutToTCS: [CutsceneData; 0];
    // child warp songs cutscenes
    #[no_mangle]
    static mut gChildWarpInCS: [CutsceneData; 0];
    #[no_mangle]
    static mut gChildWarpOutCS: [CutsceneData; 0];
    // child warp songs cutscenes in temple of time
    #[no_mangle]
    static mut gChildWarpInToTCS: [CutsceneData; 0];
    #[no_mangle]
    static mut gChildWarpOutToTCS: [CutsceneData; 0];
}
...
pub struct DemoKankyo {
    pub actor: Actor,
    pub objBankIndex: u8_0,
    pub sparkleCounter: u8_0,
    pub warpTimer: u8_0,
    pub unk_150: [DemoKankyoUnk150; 30],
    pub actionFunc: DemoKankyoActionFunc,
}
pub type DemoKankyoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoKankyo, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const DEMOKANKYO_SPARKLES: C2RustUnnamed_20 = 17;
pub const DEMOKANKYO_WARP_IN: C2RustUnnamed_20 = 16;
pub const DEMOKANKYO_WARP_OUT: C2RustUnnamed_20 = 15;
pub const DEMOKANKYO_LIGHT_PLANE: C2RustUnnamed_20 = 14;
pub const DEMOKANKYO_DOOR_OF_TIME: C2RustUnnamed_20 = 13;
pub const DEMOKANKYO_C: C2RustUnnamed_20 = 12;
pub const DEMOKANKYO_B: C2RustUnnamed_20 = 11;
pub const DEMOKANKYO_A: C2RustUnnamed_20 = 10;
pub const DEMOKANKYO_9: C2RustUnnamed_20 = 9;
pub const DEMOKANKYO_8: C2RustUnnamed_20 = 8;
pub const DEMOKANKYO_CLOUDS: C2RustUnnamed_20 = 7;
pub const DEMOKANKYO_ROCK_5: C2RustUnnamed_20 = 6;
pub const DEMOKANKYO_ROCK_4: C2RustUnnamed_20 = 5;
pub const DEMOKANKYO_ROCK_3: C2RustUnnamed_20 = 4;
pub const DEMOKANKYO_ROCK_2: C2RustUnnamed_20 = 3;
pub const DEMOKANKYO_ROCK_1: C2RustUnnamed_20 = 2;
pub const DEMOKANKYO_BLUE_RAIN_2: C2RustUnnamed_20 = 1;
pub const DEMOKANKYO_BLUE_RAIN: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut Demo_Kankyo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_KANKYO as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKankyo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKankyo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKankyo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKankyo_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sObjIds: [s16; 18] =
    [OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     ...
     OBJECT_EFC_STAR_FIELD as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GI_MELODY as libc::c_int as s16,
     OBJECT_GI_MELODY as libc::c_int as s16,
     OBJECT_GI_MELODY as libc::c_int as s16,
     OBJECT_GI_MELODY as libc::c_int as s16,
     OBJECT_GI_MELODY as libc::c_int as s16,
     OBJECT_TOKI_OBJECTS as libc::c_int as s16,
     OBJECT_TOKI_OBJECTS as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16];
static mut sWarpSparkleEnvColors: [Color_RGB8; 6] =
    [{
         let mut init =
...
static mut sWarpOutCameraPoints: [CutsceneCameraPoint; 14] =
    [{
         let mut init =
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x: 0 as libc::c_int as s16,
                                                   y:
                                                       0x17 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x24 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x1c as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x32 as libc::c_int as
                                                           s16,
                                                   z:
                                         ...
                                         let mut init =
                                             Vec3s{x:
                                                       0x1 as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x18 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xffd9 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x: 0 as libc::c_int as s16,
                                                   y:
                                                       0x25 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x37 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x4f as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x66 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x29 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xa6 as libc::c_int as
                                                           s16,
                                                   y:
                                                       0xad as libc::c_int as
                                                           s16,
                                                   z:
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x10d as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x15a as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xff4c as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x19f as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x245 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xfe35 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x1ce as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x36f as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xfcc2 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
...
static mut sWarpInCameraPoints: [CutsceneCameraPoint; 14] =
    [{
         let mut init =
             CutsceneCameraPoint{continueFlag: 0 as libc::c_int as s8,
                                 cameraRoll: 0 as libc::c_int as s8,
...
static mut sSparkleEnvColors: [Color_RGB8; 6] =
    [{
         let mut init =
             Color_RGB8{r: 0 as libc::c_int as u8_0,
                        g: 200 as libc::c_int as u8_0,
...
static mut sSparklesCameraPoints: [CutsceneCameraPoint; 54] =
    [{
         let mut init =
             CutsceneCameraPoint{continueFlag: 0 as libc::c_int as s8,
                                 cameraRoll: 0 as libc::c_int as s8,
                                 nextPointFrame: 2 as libc::c_int as u16_0,
                                 viewAngle: 45.0f32,
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xfff7 as libc::c_int
                                                           as s16,
                                                   y: 0 as libc::c_int as s16,
                                                   z:
                                                       0xffd0 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xffe8 as libc::c_int
                                                           as s16,
                                                   y:
                                                       0x1 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x27 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xffd5 as libc::c_int
                                                           as s16,
                                                   y:
                                                       0x9 as libc::c_int as
                                                           s16,
                                                   z:
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x14 as libc::c_int as
                                                           s16,
                                                   y:
                                                       0xb as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x29 as libc::c_int as
                                                           s16,};
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x11 as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x10 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x28 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xffdd as libc::c_int
                                                           as s16,
                                                   y:
                                                       0x14 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xffec as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                         ...
                                         let mut init =
                                             Vec3s{x:
                                                       0x1c as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x1a as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xffe2 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0xffdf as libc::c_int
                                                           as s16,
                                                   y:
                                                       0x2b as libc::c_int as
                                                           s16,
                                                   z:
                                                       0x19 as libc::c_int as
                                                           s16,};
                                         init
                                     },};
         init
                                 ...
                                 pos:
                                     {
                                         let mut init =
                                             Vec3s{x:
                                                       0x2a as libc::c_int as
                                                           s16,
                                                   y:
                                                       0x30 as libc::c_int as
                                                           s16,
                                                   z:
                                                       0xffe7 as libc::c_int
                                                           as s16,};
                                         init
                                     },};
         init
...
static mut D_8098CF80: s16 = 0;
static mut sRainScale: s16 = 0;
static mut D_8098CF84: s16 = 0;
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_SetupAction(mut this: *mut DemoKankyo,
                                                mut actionFunc:
                                                    DemoKankyoActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut i: s16 = 0;
    let mut objBankIndex: s32 =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        sObjIds[(*this).actor.params as usize]);
    osSyncPrintf(b"bank_ID = %d\n\x00" as *const u8 as *const libc::c_char,
                 objBankIndex);
    if objBankIndex < 0 as libc::c_int {
        if 0 as libc::c_int != 0 {
        } else {
            __assert(b"0\x00" as *const u8 as *const libc::c_char,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 521 as libc::c_int);
        };
    } else { (*this).objBankIndex = objBankIndex as u8_0 }
    match (*this).actor.params as libc::c_int {
        0 | 1 => {
            match (*globalCtx).sceneNum as libc::c_int {
                71 => {
                    (*globalCtx).roomCtx.curRoom.segment =
                        0 as *mut libc::c_void;
                    D_8098CF80 = 10 as libc::c_int as s16;
                    sRainScale = 8 as libc::c_int as s16
                }
                67 => {
                    D_8098CF80 = 14 as libc::c_int as s16;
                    sRainScale = 8 as libc::c_int as s16
                }
                81 => {
                    D_8098CF80 = 1 as libc::c_int as s16;
                    sRainScale = 5 as libc::c_int as s16
                }
        ...
        2 | 3 | 4 | 5 | 6 => {
            ...
            (*this).actor.scale.z = Rand_ZeroOne() * 0.5f32 + 0.5f32;
            (*this).actor.scale.y = (*this).actor.scale.z;
            (*this).actor.scale.x = (*this).actor.scale.y;
            (*this).unk_150[0 as libc::c_int as usize].unk_0.x =
                Rand_ZeroOne() * 3.0f32 + 1.0f32;
            (*this).unk_150[0 as libc::c_int as usize].unk_0.y =
                Rand_ZeroOne() * 3.0f32 + 1.0f32;
            (*this).unk_150[0 as libc::c_int as usize].unk_0.z =
                Rand_ZeroOne() * 3.0f32 + 1.0f32
        }
        7 => {
            i = 0 as libc::c_int as s16;
            while (i as libc::c_int) < 30 as libc::c_int {
                (*this).unk_150[i as usize].unk_20 =
                    (Rand_ZeroOne() * 65535.0f32) as s16;
                (*this).unk_150[i as usize].unk_18 =
                    Rand_ZeroOne() * 100.0f32 + 60.0f32;
                i += 1
            }
        }
        13 => {
            ...
            (*this).actor.scale.y = (*this).actor.scale.z;
            (*this).actor.scale.x = (*this).actor.scale.y;
            (*this).unk_150[0 as libc::c_int as usize].unk_18 = 0.0f32;
            if gSaveContext.eventChkInf[4 as libc::c_int as usize] as
                ...
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   ...
                                   ACTOR_DOOR_TOKI as libc::c_int as s16,
        ...
        15 | 16 => {
            ...
            (*this).warpTimer = 35 as libc::c_int as u8_0;
            (*this).sparkleCounter = 0 as libc::c_int as u8_0;
            (*this).actor.scale.z = 1.0f32;
            (*this).actor.scale.y = (*this).actor.scale.z;
            (*this).actor.scale.x = (*this).actor.scale.y;
            if (*this).actor.params as libc::c_int ==
                   DEMOKANKYO_WARP_OUT as libc::c_int {
                Audio_PlaySoundGeneral(0x28a6 as libc::c_int as u16_0,
                                       &mut D_801333D4,
    ...
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 30 as libc::c_int {
        (*this).unk_150[i as usize].unk_22 = 0 as libc::c_int as u8_0;
        i += 1
    }
    DemoKankyo_SetupAction(this,
                           Some(DemoKankyo_SetupType as
                                    unsafe extern "C" fn(_: *mut DemoKankyo,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    !thisx.is_null();
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_SetupType(mut this: *mut DemoKankyo,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if (*this).actor.objBankIndex as libc::c_int ==
           (*this).objBankIndex as libc::c_int {
        match (*this).actor.params as libc::c_int {
            2 | 3 | 4 | 5 | 6 => {
                DemoKankyo_SetupAction(this,
                                       Some(DemoKankyo_UpdateRock as
                                                unsafe extern "C" fn(_:
                                                                         *mut DemoKankyo,
                                                                     _:
                                                                         *mut GlobalContext)
            ...
            7 => {
                DemoKankyo_SetupAction(this,
                                       Some(DemoKankyo_UpdateClouds as
                                                unsafe extern "C" fn(_:
                                                                         *mut DemoKankyo,
                                                                     _:
                                                                         *mut GlobalContext)
            ...
            13 => {
                if Flags_GetEnv(globalCtx, 2 as libc::c_int as s16) != 0 {
                    DemoKankyo_SetupAction(this,
                                           Some(DemoKankyo_UpdateDoorOfTime as
                                                    unsafe extern "C" fn(_:
                                                                             *mut DemoKankyo,
                                                                         _:
                                                                             *mut GlobalContext)
            ...
            15 => {
                ...
                if ((*this).warpTimer as libc::c_int) < 21 as libc::c_int &&
                       (*this).warpTimer as libc::c_int >= 15 as libc::c_int {
                    temp =
                        ((*this).warpTimer as libc::c_int as libc::c_float -
                             15.0f32) / 5.0f32;
                    ...
                    (*globalCtx).envCtx.screenFillColor[3 as libc::c_int as
                        ...
                        (255 as libc::c_int as libc::c_float -
                             255 as libc::c_int as libc::c_float * temp) as
                            u8_0
                }
                if ((*this).warpTimer as libc::c_int) < 15 as libc::c_int &&
                       (*this).warpTimer as libc::c_int >= 4 as libc::c_int {
                    temp =
                        ((*this).warpTimer as libc::c_int as libc::c_float -
                             4.0f32) / 10.0f32;
                    (*globalCtx).envCtx.fillScreen = 1 as libc::c_int as u8_0;
                    (*globalCtx).envCtx.screenFillColor[3 as libc::c_int as
                                                            usize] =
                        (255 as libc::c_int as libc::c_float * temp) as u8_0
                }
                if (*this).warpTimer as libc::c_int == 15 as libc::c_int {
                    (*player).actor.draw = None
                }
                if (*this).warpTimer as u32_0 !=
                       0 as libc::c_int as libc::c_uint {
                    (*this).warpTimer = (*this).warpTimer.wrapping_sub(1)
                }
                if (*this).warpTimer as libc::c_int == 1 as libc::c_int {
                    if (*globalCtx).sceneNum as libc::c_int ==
                           SCENE_TOKINOMA as libc::c_int {
                        D_8098CF84 = 25 as libc::c_int as s16;
                        if !(gSaveContext.linkAge == 0 as libc::c_int) {
                            (*globalCtx).csCtx.segment =
                                gChildWarpInToTCS.as_mut_ptr() as
                                    *mut libc::c_void
                        } else {
                            (*globalCtx).csCtx.segment =
                                gAdultWarpInToTCS.as_mut_ptr() as
                                    *mut libc::c_void
                        }
                    } else {
                        D_8098CF84 = 32 as libc::c_int as s16;
                        if !(gSaveContext.linkAge == 0 as libc::c_int) {
                            (*globalCtx).csCtx.segment =
                                gChildWarpInCS.as_mut_ptr() as
                                    *mut libc::c_void
                        } else {
                            (*globalCtx).csCtx.segment =
                                gAdultWarpInCS.as_mut_ptr() as
                                    *mut libc::c_void
                        }
                    }
                    if func_800C0CB8(globalCtx) != 0 as libc::c_int {
                        gSaveContext.cutsceneTrigger =
                            1 as libc::c_int as u8_0
                    }
                    DemoKankyo_SetupAction(this,
                                           Some(DemoKankyo_DoNothing as
                                                    unsafe extern "C" fn(_:
                                                                             *mut DemoKankyo,
                                                                         _:
                                                                             *mut GlobalContext)
            ...
            16 => {
                if (*globalCtx).sceneNum as libc::c_int ==
                    ...
                    if !(gSaveContext.linkAge == 0 as libc::c_int) {
                        (*globalCtx).csCtx.segment =
                            gChildWarpOutToTCS.as_mut_ptr() as
                                *mut libc::c_void
                    } else {
                        (*globalCtx).csCtx.segment =
                            gAdultWarpOutToTCS.as_mut_ptr() as
                                *mut libc::c_void
                    }
                } else if !(gSaveContext.linkAge == 0 as libc::c_int) {
                    (*globalCtx).csCtx.segment =
                        gChildWarpOutCS.as_mut_ptr() as *mut libc::c_void
                } else {
                    (*globalCtx).csCtx.segment =
                        gAdultWarpOutCS.as_mut_ptr() as *mut libc::c_void
                }
                gSaveContext.cutsceneTrigger = 1 as libc::c_int as u8_0;
                DemoKankyo_SetupAction(this,
                                       Some(DemoKankyo_DoNothing2 as
                                                unsafe extern "C" fn(_:
                                                                         *mut DemoKankyo,
                                                                     _:
                                                                         *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DoNothing(mut this: *mut DemoKankyo,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DoNothing2(mut this: *mut DemoKankyo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoKankyo_SetupAction(this,
                           Some(DemoKankyo_DoNothing as
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_SetRockPos(mut this: *mut DemoKankyo,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut params: s32) {
    let mut startPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut endPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut csAction: *mut CsCmdActorAction =
        (*globalCtx).csCtx.npcActions[params as usize];
    let mut temp_f0: f32_0 = 0.;
    startPos.x = (*csAction).startPos.x as f32_0;
    startPos.y = (*csAction).startPos.y as f32_0;
    startPos.z = (*csAction).startPos.z as f32_0;
    endPos.x = (*csAction).endPos.x as f32_0;
    endPos.y = (*csAction).endPos.y as f32_0;
    endPos.z = (*csAction).endPos.z as f32_0;
    temp_f0 =
        Environment_LerpWeight((*csAction).endFrame, (*csAction).startFrame,
                               (*globalCtx).csCtx.frames);
    (*this).actor.world.pos.x =
        (endPos.x - startPos.x) * temp_f0 + startPos.x;
    (*this).actor.world.pos.y =
        (endPos.y - startPos.y) * temp_f0 + startPos.y;
    (*this).actor.world.pos.z =
        (endPos.z - startPos.z) * temp_f0 + startPos.z;
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_UpdateRock(mut this: *mut DemoKankyo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[((*this).actor.params as libc::c_int
                                               - 2 as libc::c_int) as
                                              usize].is_null() {
        DemoKankyo_SetRockPos(this, globalCtx,
                              (*this).actor.params as libc::c_int -
                                  2 as libc::c_int);
    }
    (*this).unk_150[0 as libc::c_int as usize].unk_C.x +=
        (*this).unk_150[0 as libc::c_int as usize].unk_0.x;
    (*this).unk_150[0 as libc::c_int as usize].unk_C.y +=
        (*this).unk_150[0 as libc::c_int as usize].unk_0.y;
    (*this).unk_150[0 as libc::c_int as usize].unk_C.z +=
        (*this).unk_150[0 as libc::c_int as usize].unk_0.z;
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_UpdateClouds(mut this: *mut DemoKankyo,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut i: u8_0 = 0;
    ...
    while (i as libc::c_int) < 30 as libc::c_int {
        (*this).unk_150[i as usize].unk_20 =
            ((*this).unk_150[i as usize].unk_20 as libc::c_int +
                 (*this).unk_150[i as usize].unk_18 as s16 as libc::c_int) as
                s16;
        i = i.wrapping_add(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_UpdateDoorOfTime(mut this:
                                                         *mut DemoKankyo,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x281e as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    (*this).unk_150[0 as libc::c_int as usize].unk_18 += 1.0f32;
    if (*this).unk_150[0 as libc::c_int as usize].unk_18 >= 102.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2893 as libc::c_int as u16_0);
        ...
        DemoKankyo_SetupAction(this,
                               Some(DemoKankyo_KillDoorOfTimeCollision as
                                        unsafe extern "C" fn(_:
                                                                 *mut DemoKankyo,
                                                             _:
                                                                 *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_KillDoorOfTimeCollision(mut this:
                                                                *mut DemoKankyo,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    Actor_Kill((*this).actor.child);
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    if (*this).actor.objBankIndex as libc::c_int ==
           (*this).objBankIndex as libc::c_int {
            ...
            0 | 1 => {
                if (*globalCtx).sceneNum as libc::c_int ==
                    ...
                    if Flags_GetEnv(globalCtx, 1 as libc::c_int as s16) == 0 {
                        current_block_6 = 15345278821338558188;
                    } else if Actor_IsFacingAndNearPlayer(&mut (*this).actor,
                                                          300.0f32,
                                                          0x7530 as
                                                              libc::c_int as
                                                              s16) == 0 {
                        ...
                        if ((*globalCtx).csCtx.frames as libc::c_int) <
                            ...
                            current_block_6 = 15345278821338558188;
                        } else { current_block_6 = 8236137900636309791; }
                ...
                match current_block_6 {
                    ...
                    _ => { DemoKankyo_DrawRain(thisx, globalCtx); }
                }
            }
            2 | 3 | 4 | 5 | 6 => { DemoKankyo_DrawRock(thisx, globalCtx); }
            7 => { DemoKankyo_DrawClouds(thisx, globalCtx); }
            13 => { DemoKankyo_DrawDoorOfTime(thisx, globalCtx); }
            14 => { DemoKankyo_DrawLightPlane(thisx, globalCtx); }
            15 | 16 => { DemoKankyo_DrawWarpSparkles(thisx, globalCtx); }
            17 => { DemoKankyo_DrawSparkles(thisx, globalCtx); }
            _ => { }
        }
    }
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).objBankIndex as s32) != 0 {
        (*this).actor.objBankIndex = (*this).objBankIndex as s8
    };
}
// transform relating to blue rain
#[no_mangle]
pub unsafe extern "C" fn func_80989B54(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut i: s16) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    match (*globalCtx).sceneNum as libc::c_int {
        71 => {
            (*this).unk_150[i as usize].unk_0.x =
                (Rand_ZeroOne() - 0.5f32) * 500.0f32;
            (*this).unk_150[i as usize].unk_0.y = 500.0f32;
            (*this).unk_150[i as usize].unk_0.z =
                (Rand_ZeroOne() - 0.5f32) * 500.0f32
        }
        67 => {
            (*this).unk_150[i as usize].unk_C.x = 0.0f32;
            (*this).unk_150[i as usize].unk_C.y = 0.0f32;
            (*this).unk_150[i as usize].unk_C.z = 0.0f32;
            (*this).unk_150[i as usize].unk_0.x =
                (Rand_ZeroOne() - 0.5f32) * 180.0f32;
            (*this).unk_150[i as usize].unk_0.y = 10.0f32;
            (*this).unk_150[i as usize].unk_0.z =
                (Rand_ZeroOne() - 0.5f32) * 180.0f32
        }
        81 => {
            (*this).unk_150[i as usize].unk_0.x =
                (Rand_ZeroOne() - 0.5f32) * 600.0f32;
            (*this).unk_150[i as usize].unk_0.y = -500.0f32;
            (*this).unk_150[i as usize].unk_0.z =
                (Rand_ZeroOne() - 0.5f32) * 600.0f32
        }
    ...
    (*this).unk_150[i as usize].unk_18 =
        Rand_ZeroOne() * (D_8098CF80 as libc::c_int as libc::c_float * 4.0f32)
            + D_8098CF80 as libc::c_int as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawRain(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    ...
    let mut dy: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    let mut norm: f32_0 = 0.;
    let mut translateX: f32_0 = 0.;
    let mut translateY: f32_0 = 0.;
    let mut translateZ: f32_0 = 0.;
    let mut j: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_kankyo.c\x00" as *const u8 as
                        *const libc::c_char, 1186 as libc::c_int);
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 30 as libc::c_int {
        ...
        if (*globalCtx).sceneNum as libc::c_int !=
               SCENE_TOKINOMA as libc::c_int {
            (*this).unk_150[i as usize].unk_C.x =
                (*globalCtx).view.eye.x + dx / norm * 350.0f32;
            (*this).unk_150[i as usize].unk_C.y =
                (*globalCtx).view.eye.y + dy / norm * 80.0f32;
            (*this).unk_150[i as usize].unk_C.z =
                (*globalCtx).view.eye.z + dz / norm * 350.0f32
        }
        match (*this).unk_150[i as usize].unk_22 as libc::c_int {
            0 => {
                func_80989B54(thisx, globalCtx, i);
                if gSaveContext.entranceIndex == 0xa0 as libc::c_int {
                    // Cutscene Map
                    (*this).unk_150[i as usize].unk_0.y =
                        Rand_ZeroOne() * 500.0f32
                } else {
                    (*this).unk_150[i as usize].unk_0.y =
                        Rand_ZeroOne() * -500.0f32
                }
                (*this).unk_150[i as usize].unk_22 =
                    (*this).unk_150[i as usize].unk_22.wrapping_add(1)
            }
            1 => {
                temp_f12_2 = (*globalCtx).view.eye.y + dy / norm * 150.0f32;
                if gSaveContext.entranceIndex == 0xa0 as libc::c_int {
                    // Cutscene Map
                    (*this).unk_150[i as usize].unk_0.y -=
                        (*this).unk_150[i as usize].unk_18
                ...
                if gSaveContext.entranceIndex == 0xa0 as libc::c_int {
                    // Cutscene Map
                    if (*this).unk_150[i as usize].unk_C.y +
                           (*this).unk_150[i as usize].unk_0.y <
                           temp_f12_2 - 300.0f32 {
                        (*this).unk_150[i as usize].unk_22 =
                            (*this).unk_150[i as usize].unk_22.wrapping_add(1)
                    }
                } else if gSaveContext.entranceIndex == 0xcd as libc::c_int {
                    // Hyrule Field
                    if temp_f12_2 + 300.0f32 <
                           (*this).unk_150[i as usize].unk_C.y +
                               (*this).unk_150[i as usize].unk_0.y {
                        (*this).unk_150[i as usize].unk_22 =
                            (*this).unk_150[i as usize].unk_22.wrapping_add(1)
            ...
            2 => {
                func_80989B54(thisx, globalCtx, i);
                (*this).unk_150[i as usize].unk_22 =
                    (*this).unk_150[i as usize].unk_22.wrapping_sub(1)
            }
            _ => { }
        }
        Matrix_Translate((*this).unk_150[i as usize].unk_C.x +
                             (*this).unk_150[i as usize].unk_0.x,
                         (*this).unk_150[i as usize].unk_C.y +
                             (*this).unk_150[i as usize].unk_0.y,
                         (*this).unk_150[i as usize].unk_C.z +
        ...
        Matrix_Scale(sRainScale as libc::c_int as libc::c_float * 0.001f32,
                     sRainScale as libc::c_int as libc::c_float * 0.001f32,
                     sRainScale as libc::c_int as libc::c_float * 0.001f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        while (j as libc::c_int) < 5 as libc::c_int {
            ...
            if (*globalCtx).sceneNum as libc::c_int !=
                   SCENE_TOKINOMA as libc::c_int {
                if (*this).unk_150[i as usize].unk_0.x >= 0.0f32 {
                    translateX =
                        -(j as libc::c_int) as libc::c_float * 1500.0f32
                } else {
                    translateX = j as libc::c_int as libc::c_float * 1500.0f32
                }
                if (*this).unk_150[i as usize].unk_0.z >= 0.0f32 {
                    translateZ =
                        -(j as libc::c_int) as libc::c_float * 1500.0f32
                } else {
                    translateZ = j as libc::c_int as libc::c_float * 1500.0f32
                }
                if j as libc::c_int % 2 as libc::c_int != 0 as libc::c_int {
                    translateY = j as libc::c_int as libc::c_float * 4000.0f32
                } else {
                    translateY =
                        -(j as libc::c_int) as libc::c_float * 4000.0f32
                }
            } else {
                translateX = 0.0f32;
                translateY = j as libc::c_int as libc::c_float * 10.0f32;
                translateZ = 0.0f32
            }
            Matrix_Translate(translateX, translateY, translateZ,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_5).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                object_efc_star_field_DL_000080.as_mut_ptr() as libc::c_uint;
            j += 1
        }
        i += 1
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 1358 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawRock(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_kankyo.c\x00" as *const u8 as
                        *const libc::c_char, 1376 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_Translate((*this).actor.world.pos.x, (*this).actor.world.pos.y,
                     (*this).actor.world.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateX((*this).unk_150[0 as libc::c_int as usize].unk_C.x *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateY((*this).unk_150[0 as libc::c_int as usize].unk_C.y *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZ((*this).unk_150[0 as libc::c_int as usize].unk_C.z *
                       (3.14159265358979323846f32 / 180.0f32),
                   MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        object_efc_star_field_DL_000DE0.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 1409 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawClouds(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut i: s16 = 0;
    ...
    while (i as libc::c_int) < 30 as libc::c_int {
        dx =
            -(Math_SinS(((*this).unk_150[i as usize].unk_20 as libc::c_int -
                             0x8000 as libc::c_int) as s16) * 120.0f32) *
                (30.0f32 +
                     i as libc::c_int as libc::c_float / 30.0f32 * 10.0f32);
        dy =
            Math_CosS(((*this).unk_150[i as usize].unk_20 as libc::c_int -
                           0x8000 as libc::c_int) as s16) * 5.0f32 +
                1200.0f32;
        dz =
            Math_CosS(((*this).unk_150[i as usize].unk_20 as libc::c_int -
                           0x8000 as libc::c_int) as s16) * 120.0f32 *
                (30.0f32 +
                     i as libc::c_int as libc::c_float / 30.0f32 * 10.0f32);
        Matrix_Translate((*globalCtx).view.eye.x + dx,
                         (*globalCtx).view.eye.y + dy +
                             (i as libc::c_int as libc::c_float - 12.0f32) *
                                 300.0f32, (*globalCtx).view.eye.z + dz,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_Scale(125.0f32, 60.0f32, 125.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_5).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_5).words.w1 =
            gSegments[((gDust5Tex.as_mut_ptr() as u32_0) << 4 as libc::c_int
                           >> 28 as libc::c_int) as
                          usize].wrapping_add(gDust5Tex.as_mut_ptr() as u32_0
                                                  &
            ...
            (0xda as libc::c_int as u32_0 &
                ...
                (((0 as libc::c_int | 0 as libc::c_int | 0 as libc::c_int) ^
                     ...
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = &mut D_01000000 as *mut Mtx as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_7).words.w1 = gEffDustDL.as_mut_ptr() as libc::c_uint;
        i += 1
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 1474 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawDoorOfTime(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut pad: s32 = 0;
    ...
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_Translate(-(*this).unk_150[0 as libc::c_int as usize].unk_18,
                     0.0f32, 0.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        object_toki_objects_DL_007440.as_mut_ptr() as libc::c_uint;
    Matrix_Translate((*this).unk_150[0 as libc::c_int as usize].unk_18 +
                         (*this).unk_150[0 as libc::c_int as usize].unk_18,
                     0.0f32, 0.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        object_toki_objects_DL_007578.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 1501 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawLightPlane(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut pad: s32 = 0;
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            object_toki_objects_DL_008390.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 1534 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Vec3fCopy(mut src: *mut Vec3f,
                                              mut dst: *mut Vec3f) {
    (*dst).x = (*src).x;
    (*dst).y = (*src).y;
    (*dst).z = (*src).z;
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Vec3fAddVecSph(mut dst: *mut Vec3f,
                                                   mut vec: *mut Vec3f,
                                                   mut sph: *mut VecSph)
 -> *mut Vec3f {
    let mut result: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sphVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    OLib_VecSphGeoToVec3f(&mut sphVec, sph);
...
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_Vec3fAddPosRot(mut posRot: *mut PosRot,
                                                   mut vec: *mut Vec3f,
                                                   mut dst: *mut Vec3f) {
    let mut sph: VecSph = VecSph{r: 0., pitch: 0, yaw: 0,};
    let mut vecCopy: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    DemoKankyo_Vec3fCopy(vec, &mut vecCopy);
    OLib_Vec3fToVecSphGeo(&mut sph, &mut vecCopy);
    sph.yaw =
        (sph.yaw as libc::c_int + (*posRot).rot.y as libc::c_int) as s16;
    DemoKankyo_Vec3fAddVecSph(dst, &mut (*posRot).pos, &mut sph);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawWarpSparkles(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut sWarpRoll: f32_0 = 0.;
    static mut sWarpFoV: f32_0 = 0.;
    // the following 2 vars are unused
    static mut D_8098CF90: u32_0 = 0;
    static mut D_8098CF94: u32_0 = 0;
    static mut D_8098CF98: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s16 = 0;
    let mut temp_f22: f32_0 = 0.;
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut disp: *mut Gfx = 0 as *mut Gfx;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut camPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut translateX: f32_0 = 0.;
    let mut translateY: f32_0 = 0.;
    let mut translateZ: f32_0 = 0.;
    let mut posRot: PosRot =
        PosRot{pos: Vec3f{x: 0., y: 0., z: 0.,},
               rot: Vec3s{x: 0, y: 0, z: 0,},};
    let mut linkAge: u8_0 = gSaveContext.linkAge as u8_0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    if ((*this).sparkleCounter as libc::c_int) < 30 as libc::c_int {
        (*this).sparkleCounter =
            ((*this).sparkleCounter as libc::c_int + 2 as libc::c_int) as u8_0
    }
    i = ((*this).sparkleCounter as libc::c_int - 1 as libc::c_int) as s16;
    while i as libc::c_int >= 0 as libc::c_int {
        temp_f22 =
            1.0f32 -
                i as libc::c_int as libc::c_float /
                    (*this).sparkleCounter as f32_0;
        let mut current_block_42: u64;
        match (*this).unk_150[i as usize].unk_22 as libc::c_int {
            0 => {
                (*this).unk_150[i as usize].unk_20 = 0 as libc::c_int as s16;
                (*this).unk_150[i as usize].unk_1C =
                    0 as libc::c_int as f32_0;
                (*this).unk_150[i as usize].unk_0.x =
                    ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as s16 as
                        f32_0;
                (*this).unk_150[i as usize].unk_0.y =
                    ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as s16 as
                        f32_0;
                (*this).unk_150[i as usize].unk_0.z =
                    ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as s16 as
                        f32_0;
                (*this).unk_150[i as usize].unk_23 = 0 as libc::c_int as u8_0;
                (*this).unk_150[i as usize].unk_22 =
                    (*this).unk_150[i as usize].unk_22.wrapping_add(1);
                current_block_42 = 18415497256852884872;
            }
            1 => { current_block_42 = 18415497256852884872; }
            2 => {
                if (*this).actor.params as libc::c_int ==
                       DEMOKANKYO_WARP_OUT as libc::c_int {
                    if i as libc::c_int == 0 as libc::c_int {
                        ...
                        (*this).unk_150[i as usize].unk_22 =
                            (*this).unk_150[i as usize].unk_22.wrapping_add(1)
                              ...
                              (*this).sparkleCounter as libc::c_int &&
                              (*globalCtx).csCtx.state as libc::c_int ==
                                  CS_STATE_IDLE as libc::c_int {
                    func_80088AF0(globalCtx);
                    Actor_Kill(&mut (*this).actor);
                }
                current_block_42 = 2290177392965769716;
            }
            _ => { current_block_42 = 2290177392965769716; }
        }
        match current_block_42 {
            18415497256852884872 => {
                if (*this).actor.params as libc::c_int ==
                       DEMOKANKYO_WARP_OUT as libc::c_int {
                    if func_800BB2B4(&mut camPos, &mut sWarpRoll,
                                     &mut sWarpFoV,
                                     sWarpOutCameraPoints.as_mut_ptr(),
                                     &mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                    as
                                                                                    isize)).unk_20,
                                     &mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                    as
                    ...
                    Audio_PlaySoundGeneral((0x28a7 as libc::c_int -
                    ...
                    if func_800BB2B4(&mut camPos, &mut sWarpRoll,
                                     &mut sWarpFoV,
                                     sWarpInCameraPoints.as_mut_ptr(),
                                     &mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                    as
                                                                                    isize)).unk_20,
                                     &mut (*(*this).unk_150.as_mut_ptr().offset(i
                ...
                Actor_GetWorld(&mut posRot, &mut (*player).actor);
                DemoKankyo_Vec3fAddPosRot(&mut posRot, &mut camPos,
                                          &mut D_8098CF98);
            }
            _ => { }
        }
        (*this).unk_150[i as usize].unk_C.x = D_8098CF98.x;
        (*this).unk_150[i as usize].unk_C.y = D_8098CF98.y;
        (*this).unk_150[i as usize].unk_C.z = D_8098CF98.z;
        let mut current_block_60: u64;
        match (*this).unk_150[i as usize].unk_23 as libc::c_int {
            0 => {
                (*this).unk_150[i as usize].unk_18 = Rand_ZeroOne();
                (*this).unk_150[i as usize].unk_23 =
                    (*this).unk_150[i as usize].unk_23.wrapping_add(1);
                current_block_60 = 9710521031450935281;
            }
            1 => { current_block_60 = 9710521031450935281; }
            2 => {
                Math_SmoothStepToF(&mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize)).unk_18,
                                   0.0f32, 0.5f32, 0.3f32, 0.2f32);
                if (*this).unk_150[i as usize].unk_18 <= 0.0f32 {
                    (*this).unk_150[i as usize].unk_0.x =
                        ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as
                            s16 as f32_0;
                    (*this).unk_150[i as usize].unk_0.y =
                        ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as
                            s16 as f32_0;
                    (*this).unk_150[i as usize].unk_0.z =
                        ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f22) as
                            s16 as f32_0;
                    (*this).unk_150[i as usize].unk_18 = 0.0f32;
                    (*this).unk_150[i as usize].unk_23 =
                        1 as libc::c_int as u8_0
                }
                current_block_60 = 7178192492338286402;
            }
            _ => { current_block_60 = 7178192492338286402; }
        }
        match current_block_60 {
            9710521031450935281 => {
                Math_SmoothStepToF(&mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize)).unk_18,
                                   1.0f32, 0.5f32, 0.4f32, 0.2f32);
                if (*this).unk_150[i as usize].unk_18 >= 1.0f32 {
                    (*this).unk_150[i as usize].unk_23 =
        ...
        translateZ =
            (*this).unk_150[i as usize].unk_C.z +
                (*this).unk_150[i as usize].unk_0.z;
        if ((*this).unk_150[i as usize].unk_22 as libc::c_int) <
               2 as libc::c_int {
            disp = gEffFlash1DL.as_mut_ptr() as u32_0 as *mut Gfx;
            if linkAge as libc::c_int != 0 as libc::c_int {
                Matrix_Translate(translateX, translateY, translateZ,
                                 MTXMODE_NEW as libc::c_int as u8_0);
            } else {
                (translateY) != 0.;
                Matrix_Translate(translateX, translateY + 15.0f32, translateZ,
                                 MTXMODE_NEW as libc::c_int as u8_0);
            }
            Matrix_Scale((*this).unk_150[i as usize].unk_18 *
                             (0.018f32 * temp_f22),
                         (*this).unk_150[i as usize].unk_18 *
                             (0.018f32 * temp_f22),
                         (*this).unk_150[i as usize].unk_18 *
            ...
            if (*this).actor.params as libc::c_int ==
                ...
                (*_g_0).words.w0 =
                    (0xfb as libc::c_int as u32_0 &
                        ...
                        24 as libc::c_int;
                (*_g_0).words.w1 =
                    (sWarpSparkleEnvColors[(*globalCtx).msgCtx.lastPlayedSong
                                               as usize].r as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                ...
                let mut respawnData: s8 =
                    gSaveContext.respawn[1 as libc::c_int as usize].data;
                ...
                (*_g_1).words.w0 =
                    (0xfb as libc::c_int as u32_0 &
                        ...
                        24 as libc::c_int;
                (*_g_1).words.w1 =
                    (sWarpSparkleEnvColors[respawnData as usize].r as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        (sWarpSparkleEnvColors[respawnData as usize].g as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            16 as libc::c_int |
                        (sWarpSparkleEnvColors[respawnData as usize].b as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            8 as libc::c_int |
            ...
            Matrix_Mult(&mut (*globalCtx).billboardMtxF,
                        MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*this).unk_150[i as usize].unk_24 as libc::c_int
                               as libc::c_float *
                               (3.14159265358979323846f32 / 180.0f32),
                           MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = disp as libc::c_uint;
            (*this).unk_150[i as usize].unk_24 =
                ((*this).unk_150[i as usize].unk_24 as libc::c_int +
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kankyo.c\x00" as *const u8 as
                         *const libc::c_char, 2019 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKankyo_DrawSparkles(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    static mut sSparklesRoll: f32_0 = 0.;
    static mut sSparklesFoV: f32_0 = 0.;
    // the following 3 vars are unused
    static mut D_8098CFAC: u32_0 = 0;
    static mut D_8098CFB0: u32_0 = 0;
    static mut D_8098CFB4: u32_0 = 0;
    static mut D_8098CFB8: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut this: *mut DemoKankyo = thisx as *mut DemoKankyo;
    let mut translateX: f32_0 = 0.;
    let mut translateY: f32_0 = 0.;
    let mut translateZ: f32_0 = 0.;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_kankyo.c\x00" as *const u8 as
                        *const libc::c_char, 2434 as libc::c_int);
    if ((*this).sparkleCounter as libc::c_int) < 20 as libc::c_int {
        (*this).sparkleCounter = (*this).sparkleCounter.wrapping_add(1)
    }
    i = ((*this).sparkleCounter as libc::c_int - 1 as libc::c_int) as s16;
    while i as libc::c_int >= 0 as libc::c_int {
        temp_f20 =
        ...
        match (*this).unk_150[i as usize].unk_22 as libc::c_int {
            0 => {
                ...
                (*this).unk_150[i as usize].unk_1C =
                    0 as libc::c_int as f32_0;
                (*this).unk_150[i as usize].unk_0.x =
                    ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f20) as s16 as
                        f32_0;
                (*this).unk_150[i as usize].unk_0.y =
                    ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f20) as s16 as
                        f32_0;
                ...
                (*this).unk_150[i as usize].unk_22 =
                    (*this).unk_150[i as usize].unk_22.wrapping_add(1);
                current_block_22 = 13902069308445005081;
            }
            1 => { current_block_22 = 13902069308445005081; }
            2 => {
            ...
            _ => { current_block_22 = 9853141518545631134; }
        }
        match current_block_22 {
            13902069308445005081 => {
                if func_800BB2B4(&mut camPos, &mut sSparklesRoll,
                                 &mut sSparklesFoV,
                                 sSparklesCameraPoints.as_mut_ptr(),
                                 &mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                as
                                                                                isize)).unk_20,
                                 &mut (*(*this).unk_150.as_mut_ptr().offset(i
                ...
                Actor_GetWorld(&mut posRot, &mut (*this).actor);
                DemoKankyo_Vec3fAddPosRot(&mut posRot, &mut camPos,
                                          &mut D_8098CFB8);
            }
            _ => { }
        }
        (*this).unk_150[i as usize].unk_C.x = D_8098CFB8.x;
        (*this).unk_150[i as usize].unk_C.y = D_8098CFB8.y;
        (*this).unk_150[i as usize].unk_C.z = D_8098CFB8.z;
        ...
        match (*this).unk_150[i as usize].unk_23 as libc::c_int {
            0 => {
                ...
                (*this).unk_150[i as usize].unk_23 =
                    (*this).unk_150[i as usize].unk_23.wrapping_add(1);
                current_block_40 = 6577272322560618830;
            }
            1 => { current_block_40 = 6577272322560618830; }
            2 => {
                Math_SmoothStepToF(&mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize)).unk_18,
                ...
                if (*this).unk_150[i as usize].unk_18 <= 0.0f32 {
                    (*this).unk_150[i as usize].unk_0.x =
                        ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f20) as
                            s16 as f32_0;
                    (*this).unk_150[i as usize].unk_0.y =
                        ((Rand_ZeroOne() - 0.5f32) * 16.0f32 * temp_f20) as
                            s16 as f32_0;
                ...
                current_block_40 = 2516253395664191498;
            }
            _ => { current_block_40 = 2516253395664191498; }
        }
        match current_block_40 {
            6577272322560618830 => {
                Math_SmoothStepToF(&mut (*(*this).unk_150.as_mut_ptr().offset(i
                                                                                  ...
                                                                                  isize)).unk_18,
                                   1.0f32, 0.5f32, 0.4f32, 0.2f32);
                if 1.0f32 <= (*this).unk_150[i as usize].unk_18 {
                    (*this).unk_150[i as usize].unk_23 =
                        2 as libc::c_int as u8_0
                }
            }
        ...
        if ((*this).unk_150[i as usize].unk_22 as libc::c_int) <
            ...
            Matrix_Translate(translateX, translateY, translateZ,
                             MTXMODE_NEW as libc::c_int as u8_0);
            scale = (*this).unk_150[i as usize].unk_18 * (0.02f32 * temp_f20);
            ...
            (*_g_0).words.w0 =
                (0xfb as libc::c_int as u32_0 &
                    ...
                    24 as libc::c_int;
            (*_g_0).words.w1 =
                (sSparkleEnvColors[3 as libc::c_int as usize].r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (sSparkleEnvColors[3 as libc::c_int as usize].g as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    (sSparkleEnvColors[3 as libc::c_int as usize].b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (255 as libc::c_int as u32_0 &
            ...
            (*_g_1).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_demo_kankyo.c\x00" as *const u8 as
                                  *const libc::c_char as *mut libc::c_char,
                              2572 as libc::c_int) as libc::c_uint;
            let fresh35 = (*__gfxCtx).polyXlu.p;
            (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
            let mut _g_2: *mut Gfx = fresh35;
            (*_g_2).words.w0 =
                (0xde as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
