...
extern "C" {
    ...
    #[no_mangle]
    static mut gWindmillManPlayAndMoveHeadAnim: AnimationHeader;
    #[no_mangle]
    static mut gWindmillManPlayStillAnim: AnimationHeader;
    #[no_mangle]
    static mut gWindmillManEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManEyeAngryTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManMouthOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManMouthAngryTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gSongOfStormsCs: [CutsceneData; 0];
}
...
pub struct EnFu {
    ...
    pub lookAngleOffset: Vec3s,
    pub unk_2A2: Vec3s,
    pub behaviorFlags: u16_0,
    pub facialExpression: u16_0,
    pub actionFunc: EnFuActionFunc,
}
pub type EnFuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const FU_LIMB_MAX: C2RustUnnamed_26 = 16;
pub const FU_LIMB_HORN: C2RustUnnamed_26 = 15;
pub const FU_LIMB_HEAD: C2RustUnnamed_26 = 14;
pub const FU_LIMB_RIGHT_HAND_AND_CRANK: C2RustUnnamed_26 = 13;
pub const FU_LIMB_RIGHT_ARM: C2RustUnnamed_26 = 12;
pub const FU_LIMB_RIGHT_SHOULDER: C2RustUnnamed_26 = 11;
pub const FU_LIMB_UNK: C2RustUnnamed_26 = 10;
pub const FU_LIMB_LEFT_ARM_MUSIC_BOX: C2RustUnnamed_26 = 9;
pub const FU_LIMB_CHEST_MUSIC_BOX: C2RustUnnamed_26 = 8;
pub const FU_LIMB_RIGHT_FOOT: C2RustUnnamed_26 = 7;
pub const FU_LIMB_RIGHT_LEG: C2RustUnnamed_26 = 6;
pub const FU_LIMB_RIGHT_THIGH: C2RustUnnamed_26 = 5;
pub const FU_LIMB_LEFT_FOOT: C2RustUnnamed_26 = 4;
pub const FU_LIMB_LEFT_LEG: C2RustUnnamed_26 = 3;
pub const FU_LIMB_LEFT_THIGH: C2RustUnnamed_26 = 2;
pub const FU_LIMB_TORSO: C2RustUnnamed_26 = 1;
pub const FU_LIMB_ROOT: C2RustUnnamed_26 = 0;
pub const FU_FACE_MAD: C2RustUnnamed_27 = 1;
pub const FU_FACE_CALM: C2RustUnnamed_27 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
#[no_mangle]
pub static mut En_Fu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FU as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_FU as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnFu>() as libc::c_ulong,
                          init:
...
static mut sMtxSrc: Vec3f =
    { let mut init = Vec3f{x: 700.0f32, y: 700.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnFu_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFu = thisx as *mut EnFu;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelanime,
                       &mut gWindmillManSkel, &mut gWindmillManPlayStillAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(),
                       FU_LIMB_MAX as libc::c_int);
    Animation_PlayLoop(&mut (*this).skelanime,
                       &mut gWindmillManPlayStillAnim);
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        (*this).actionFunc =
            Some(EnFu_WaitChild as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ());
        (*this).facialExpression = FU_FACE_CALM as libc::c_int as u16_0
    } else {
        (*this).actionFunc =
            Some(EnFu_WaitAdult as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ());
        (*this).facialExpression = FU_FACE_MAD as libc::c_int as u16_0;
        (*this).skelanime.playSpeed = 2.0f32
    }
    (*this).behaviorFlags = 0 as libc::c_int as u16_0;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
}
#[no_mangle]
pub unsafe extern "C" fn EnFu_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFu = thisx as *mut EnFu;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A1D94C(mut this: *mut EnFu,
                                       mut globalCtx: *mut GlobalContext,
                                       mut textID: u16_0,
                                       mut actionFunc: EnFuActionFunc)
 -> s32 {
    ...
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
        ...
        } else { -(yawDiff as libc::c_int) }) < 0x2301 as libc::c_int &&
           (*this).actor.xzDistToPlayer < 100.0f32 {
        func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
    } else {
        (*this).behaviorFlags =
            ((*this).behaviorFlags as libc::c_int |
                 (1 as libc::c_int) << 0 as libc::c_int) as u16_0
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A1DA04(mut this: *mut EnFu,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        ...
        if (*this).skelanime.animation ==
               &mut gWindmillManPlayAndMoveHeadAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            Animation_Change(&mut (*this).skelanime,
                             &mut gWindmillManPlayStillAnim, 1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut gWindmillManPlayStillAnim
                                                        as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnFu_WaitChild(mut this: *mut EnFu,
                                        mut globalCtx: *mut GlobalContext) {
    let mut textID: u16_0 =
        Text_GetFaceReaction(globalCtx, 0xb as libc::c_int as u32_0);
    if textID as libc::c_int == 0 as libc::c_int {
        textID =
            if gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                ...
                0x5033 as libc::c_int
            } else { 0x5032 as libc::c_int } as u16_0
    }
    ...
    if func_80A1D94C(this, globalCtx, textID,
                     Some(func_80A1DA04 as
                              unsafe extern "C" fn(_: *mut EnFu,
                                                   _: *mut GlobalContext)
                                  -> ())) != 0 {
        if textID as libc::c_int == 0x5033 as libc::c_int {
            Animation_Change(&mut (*this).skelanime,
                             &mut gWindmillManPlayAndMoveHeadAnim, 1.0f32,
                             0.0f32,
                             Animation_GetLastFrame(&mut gWindmillManPlayAndMoveHeadAnim
                                                        as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A1DB60(mut this: *mut EnFu,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A1DBA0(mut this: *mut EnFu,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnFu_WaitAdult as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A1DBD4(mut this: *mut EnFu,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int >=
        ...
        (*this).actionFunc =
            Some(func_80A1DB60 as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ());
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*globalCtx).csCtx.segment =
            gSegments[((gSongOfStormsCs.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gSongOfStormsCs.as_mut_ptr() as
                                                  u32_0 &
        ...
        Item_Give(globalCtx, ITEM_SONG_STORMS as libc::c_int as u8_0);
        (*globalCtx).msgCtx.ocarinaMode =
        ...
        (*player).stateFlags2 &= !(0x1000000 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(EnFu_WaitAdult as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnFu_WaitForPlayback(mut this: *mut EnFu,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_PLAYBACK_STORMS as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80A1DBD4 as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFu_TeachSong(mut this: *mut EnFu,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).behaviorFlags =
            ((*this).behaviorFlags as libc::c_int &
                ...
                u16_0; // seems to be related to setting instrument type
        Audio_OcaSetInstrument(4 as libc::c_int as u8_0);
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_TEACH_STORMS as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnFu_WaitForPlayback as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFu_WaitAdult(mut this: *mut EnFu,
                                        mut globalCtx: *mut GlobalContext) {
    static mut yawDiff: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    yawDiff =
    ...
    if gSaveContext.eventChkInf[5 as libc::c_int as usize] as libc::c_int &
        ...
        func_80A1D94C(this, globalCtx, 0x508e as libc::c_int as u16_0,
                      Some(func_80A1DBA0 as
                               unsafe extern "C" fn(_: *mut EnFu,
                                                    _: *mut GlobalContext)
                                   -> ()));
    } else if (*player).stateFlags2 & 0x1000000 as libc::c_int as libc::c_uint
                  != 0 {
        (*this).actor.textId = 0x5035 as libc::c_int as u16_0;
        Message_StartTextbox(globalCtx, (*this).actor.textId,
                             0 as *mut Actor);
        (*this).actionFunc =
            Some(EnFu_TeachSong as
                     unsafe extern "C" fn(_: *mut EnFu, _: *mut GlobalContext)
                         -> ());
        (*this).behaviorFlags =
            ((*this).behaviorFlags as libc::c_int |
        ...
        if (*this).actor.xzDistToPlayer < 100.0f32 {
            (*this).actor.textId = 0x5034 as libc::c_int as u16_0;
            func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
            (*player).stateFlags2 |= 0x800000 as libc::c_int as libc::c_uint
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFu_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFu = thisx as *mut EnFu;
    ...
    if (*this).behaviorFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int == 0 &&
           SkelAnime_Update(&mut (*this).skelanime) != 0 as libc::c_int {
        Animation_Change(&mut (*this).skelanime,
                         (*this).skelanime.animation as *mut AnimationHeader,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame((*this).skelanime.animation)
    ...
    if (*this).behaviorFlags as libc::c_int &
        ...
        Math_SmoothStepToS(&mut (*this).lookAngleOffset.x,
                           0 as libc::c_int as s16, 6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).lookAngleOffset.y,
                           0 as libc::c_int as s16, 6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2A2.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_2A2.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        (*this).behaviorFlags =
        ...
        func_80038290(globalCtx, &mut (*this).actor,
                      &mut (*this).lookAngleOffset, &mut (*this).unk_2A2,
                      (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFu_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnFu = thisx as *mut EnFu;
    let mut pad: s32 = 0;
    if limbIndex == FU_LIMB_UNK as libc::c_int { return 0 as libc::c_int }
    match limbIndex {
        14 => {
            (*rot).x =
                ((*rot).x as libc::c_int +
                     (*this).lookAngleOffset.y as libc::c_int) as s16;
            (*rot).z =
                ((*rot).z as libc::c_int +
                     (*this).lookAngleOffset.x as libc::c_int) as s16
        }
        8 | _ => { }
    }
    if (*this).behaviorFlags as libc::c_int &
    ...
    if limbIndex == FU_LIMB_CHEST_MUSIC_BOX as libc::c_int {
        (*rot).y =
...
#[no_mangle]
pub unsafe extern "C" fn EnFu_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnFu = thisx as *mut EnFu;
    if limbIndex == FU_LIMB_HEAD as libc::c_int {
        Matrix_MultVec3f(&mut sMtxSrc, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFu_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut sEyesSegments: [*mut libc::c_void; 2] =
        unsafe {
            [gWindmillManEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void,
             gWindmillManEyeAngryTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    static mut sMouthSegments: [*mut libc::c_void; 2] =
        unsafe {
            [gWindmillManMouthOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gWindmillManMouthAngryTex.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut pad: s32 = 0;
    let mut this: *mut EnFu = thisx as *mut EnFu;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fu.c\x00" as *const u8 as *const libc::c_char,
                    773 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((sEyesSegments[(*this).facialExpression as usize] as u32_0)
                       << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sEyesSegments[(*this).facialExpression
                                                            as usize] as u32_0
                                              &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((sMouthSegments[(*this).facialExpression as usize] as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sMouthSegments[(*this).facialExpression
                                                             as usize] as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
