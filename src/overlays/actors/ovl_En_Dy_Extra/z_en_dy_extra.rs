...
extern "C" {
    ...
    #[no_mangle]
    static mut gGreatFairySpiralBeamVtx: [Vtx; 0];
    #[no_mangle]
    static mut gGreatFairySpiralBeamDL: [Gfx; 0];
}
...
pub type EnDyExtraActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnDyExtra, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Dy_Extra_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DY_EXTRA as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDyExtra_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDyExtra_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDyExtra = thisx as *mut EnDyExtra;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Big fairy effect"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa4\xa7\xe5\xa6\x96\xe7\xb2\xbe\xe5\x8a\xb9\xe6\x9e\x9c \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    (*this).type_0 = (*this).actor.params;
    (*this).scale.x = 0.025f32;
    (*this).scale.y = 0.039f32;
    (*this).scale.z = 0.025f32;
    (*this).unk_168 = (*this).actor.world.pos;
    (*this).actor.gravity = -0.2f32;
    (*this).unk_158 = 1.0f32;
    (*this).timer = 60 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDyExtra_WaitForTrigger as
                 unsafe extern "C" fn(_: *mut EnDyExtra,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_WaitForTrigger(mut this: *mut EnDyExtra,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    Math_ApproachF(&mut (*this).actor.gravity, 0.0f32, 0.1f32, 0.005f32);
    if (*this).actor.world.pos.y < -55.0f32 {
        (*this).actor.velocity.y = 0.0f32
    }
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           (*this).trigger as libc::c_int != 0 as libc::c_int {
        (*this).timer = 200 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDyExtra_FallAndKill as
                     unsafe extern "C" fn(_: *mut EnDyExtra,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_FallAndKill(mut this: *mut EnDyExtra,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    Math_ApproachF(&mut (*this).actor.gravity, 0.0f32, 0.1f32, 0.005f32);
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           (*this).unk_158 < 0.02f32 {
        Actor_Kill(&mut (*this).actor);
        return
    }
    Math_ApproachZeroF(&mut (*this).unk_158, 0.03f32, 0.05f32);
    if (*this).actor.world.pos.y < -55.0f32 {
        (*this).actor.velocity.y = 0.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDyExtra = thisx as *mut EnDyExtra;
    ...
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x8c4 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_MoveForward(&mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn EnDyExtra_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut primColors: [Color_RGBA8; 2] =
        [{
             let mut init =
    ...
    static mut envColors: [Color_RGBA8; 2] =
        [{
             let mut init =
                 Color_RGBA8{r: 255 as libc::c_int as u8_0,
    ...
    let mut vertices: *mut Vtx =
        gSegments[((gGreatFairySpiralBeamVtx.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gGreatFairySpiralBeamVtx.as_mut_ptr()
                                              as u32_0 &
    ...
    let mut i: s32 = 0;
    let mut unk: [u8_0; 3] = [0; 3];
    unk[0 as libc::c_int as usize] = 0.0f32 as u8_0;
    unk[1 as libc::c_int as usize] =
        ((*this).unk_158 * 240.0f32) as s8 as u8_0;
    unk[2 as libc::c_int as usize] =
        ((*this).unk_158 * 255.0f32) as s8 as u8_0;
    i = 0 as libc::c_int;
    while i < 27 as libc::c_int {
        if D_809FFC50[i as usize] != 0 {
            (*vertices.offset(i as isize)).v.cn[3 as libc::c_int as usize] =
                unk[D_809FFC50[i as usize] as usize]
        }
        i += 1
    }
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_dy_extra.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).state.frames.wrapping_mul(-(8 as
                                                                      libc::c_int)
                                                                    as
                                                                    libc::c_uint),
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (0x80 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        (primColors[(*this).type_0 as usize].r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (primColors[(*this).type_0 as usize].g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (primColors[(*this).type_0 as usize].b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
    ...
    (*_g_3).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_3).words.w1 =
        (envColors[(*this).type_0 as usize].r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (envColors[(*this).type_0 as usize].g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (envColors[(*this).type_0 as usize].b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = gGreatFairySpiralBeamDL.as_mut_ptr() as libc::c_uint;
