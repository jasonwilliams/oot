...
extern "C" {
    ...
    #[no_mangle]
    static mut gZurerukabeDL: [Gfx; 0];
    #[no_mangle]
    static mut gZurerukabeCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaZurerukabe {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaZurerukabeActionFunc,
    pub unk_168: s16,
    pub unk_16A: s16,
    pub unk_16C: s16,
    pub unk_16E: s16,
}
pub type BgJyaZurerukabeActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaZurerukabe,
                                _: *mut GlobalContext) -> ()>;
static mut D_8089B9C0: [f32_0; 4] = [0.0f32, 0.0f32, 0.0f32, 0.0f32];
#[no_mangle]
pub static mut Bg_Jya_Zurerukabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_ZURERUKABE as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJyaZurerukabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaZurerukabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaZurerukabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaZurerukabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaZurerukabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_8089B9F0: [s16; 4] =
    [943 as libc::c_int as s16, 1043 as libc::c_int as s16,
     1243 as libc::c_int as s16, 1343 as libc::c_int as s16];
static mut D_8089B9F8: [s16; 4] =
    [-(1 as libc::c_int) as s16, 1 as libc::c_int as s16,
     -(1 as libc::c_int) as s16, 1 as libc::c_int as s16];
static mut D_8089BA00: [s16; 4] =
    [48 as libc::c_int as s16, 48 as libc::c_int as s16,
     36 as libc::c_int as s16, 36 as libc::c_int as s16];
static mut D_8089BA08: [f32_0; 4] = [8.0f32, 8.0f32, 10.0f32, 10.0f32];
static mut D_8089BA18: [[s16; 2]; 6] =
    [[0x388 as libc::c_int as s16, 0x395 as libc::c_int as s16],
     [0x3ea as libc::c_int as s16, 0x3ff as libc::c_int as s16],
     [0x454 as libc::c_int as s16, 0x467 as libc::c_int as s16],
     [0x4b4 as libc::c_int as s16, 0x4c1 as libc::c_int as s16],
     [0x518 as libc::c_int as s16, 0x528 as libc::c_int as s16],
     [0x581 as libc::c_int as s16, 0x590 as libc::c_int as s16]];
static mut D_8089BA30: [s16; 6] =
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaZurerukabe_InitDynaPoly(mut this:
                                                          *mut BgJyaZurerukabe,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_zurerukabe.c\x00" as *const u8 as
                         *const libc::c_char, 194 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8089B4C8(mut this: *mut BgJyaZurerukabe,
    ...
    if (*player).stateFlags1 == 0x200000 as libc::c_int as libc::c_uint &&
           !(*player).actor.wallPoly.is_null() {
        let mut i: s32 = 0;
        i = 0 as libc::c_int;
        while i <
                  (::std::mem::size_of::<[[s16; 2]; 6]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<[s16; 2]>()
                                                       as libc::c_ulong) as
                      s32 {
            let mut posY: f32_0 = (*player).actor.world.pos.y;
            if posY >=
                   D_8089BA18[i as usize][0 as libc::c_int as usize] as
                       libc::c_int as libc::c_float &&
                   posY <=
                       D_8089BA18[i as usize][1 as libc::c_int as usize] as
                           libc::c_int as libc::c_float {
                break ;
            }
            i += 1
        ...
        match i {
            0 | 2 | 3 | 5 => {
                if fabsf(D_8089B9C0[D_8089BA30[i as usize] as usize]) > 1.0f32
                   {
                    func_8002F6D4(globalCtx, &mut (*this).dyna.actor, 1.5f32,
                                  (*this).dyna.actor.shape.rot.y, 0.0f32,
                                  0 as libc::c_int as u32_0);
                }
            }
            1 | 4 => {
                if fabsf(D_8089B9C0[D_8089BA30[i as usize] as usize] -
                             D_8089B9C0[D_8089BA30[(i + 1 as libc::c_int) as
                                                       usize] as usize]) >
                       1.0f32 {
                    func_8002F6D4(globalCtx, &mut (*this).dyna.actor, 1.5f32,
                                  (*this).dyna.actor.shape.rot.y, 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaZurerukabe_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaZurerukabe = thisx as *mut BgJyaZurerukabe;
    let mut i: s32 = 0;
    BgJyaZurerukabe_InitDynaPoly(this, globalCtx, &mut gZurerukabeCol,
    ...
    while i <
              (::std::mem::size_of::<[s16; 4]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        if fabsf(D_8089B9F0[i as usize] as libc::c_int as libc::c_float -
                     (*this).dyna.actor.home.pos.y) < 1.0f32 {
            (*this).unk_168 = i as s16;
            break ;
        } else { i += 1 }
    }
    if i ==
        ...
        osSyncPrintf(b"home pos \xe3\x81\x8c\xe5\xa4\x89\xe6\x9b\xb4\xe3\x81\x95\xe3\x82\x8c\xe3\x81\x9f\xe3\x81\xbf\xe3\x81\x9f\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_jya_zurerukabe.c\x00" as *const u8 as
                         *const libc::c_char, 299 as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
    }
    (*this).unk_16E = D_8089B9F8[(*this).unk_168 as usize];
    func_8089B7B4(this);
    osSyncPrintf(b"(jya \xe3\x81\x9a\xe3\x82\x8c\xe3\x82\x8b\xe5\xa3\x81)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaZurerukabe_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgJyaZurerukabe = thisx as *mut BgJyaZurerukabe;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    D_8089B9C0[(*this).unk_168 as usize] = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8089B7B4(mut this: *mut BgJyaZurerukabe) {
    (*this).actionFunc =
        Some(func_8089B7C4 as
                 unsafe extern "C" fn(_: *mut BgJyaZurerukabe,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_8089B7C4(mut this: *mut BgJyaZurerukabe,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_16A as libc::c_int <= 0 as libc::c_int {
        func_8089B80C(this);
    }
    D_8089B9C0[(*this).unk_168 as usize] = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8089B80C(mut this: *mut BgJyaZurerukabe) {
    (*this).actionFunc =
        Some(func_8089B870 as
                 unsafe extern "C" fn(_: *mut BgJyaZurerukabe,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_16A = D_8089BA00[(*this).unk_168 as usize];
    if (if (*this).unk_16C as libc::c_int >= 0 as libc::c_int {
            (*this).unk_16C as libc::c_int
        } else { -((*this).unk_16C as libc::c_int) }) == 4 as libc::c_int {
        (*this).unk_16E = -((*this).unk_16E as libc::c_int) as s16
    }
    (*this).unk_16C =
        ((*this).unk_16C as libc::c_int + (*this).unk_16E as libc::c_int) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8089B870(mut this: *mut BgJyaZurerukabe,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.x,
                    (*this).dyna.actor.home.pos.x +
                        ((*this).unk_16C as libc::c_int * 75 as libc::c_int)
                            as libc::c_float,
                    D_8089BA08[(*this).unk_168 as usize]) != 0 {
        func_8089B7B4(this);
    }
    D_8089B9C0[(*this).unk_168 as usize] =
        D_8089BA08[(*this).unk_168 as usize] *
            (*this).unk_16E as libc::c_int as libc::c_float;
    func_8002F974(&mut (*this).dyna.actor,
                  (0x2824 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaZurerukabe_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgJyaZurerukabe = thisx as *mut BgJyaZurerukabe;
    if (*this).unk_16A as libc::c_int > 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaZurerukabe_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gZurerukabeDL.as_mut_ptr());
}
