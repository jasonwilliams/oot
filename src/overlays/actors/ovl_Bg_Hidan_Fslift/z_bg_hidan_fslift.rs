...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleHookshotElevatorDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleHookshotElevatorCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanFslift {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanFsliftActionFunc,
    pub timer: s16,
    pub unk_16A: s16,
}
pub type BgHidanFsliftActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanFslift, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Fslift_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_FSLIFT as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanFslift>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFslift_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFslift_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFslift_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanFslift_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFslift_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut this: *mut BgHidanFslift = thisx as *mut BgHidanFslift;
    ...
    CollisionHeader_GetVirtual(&mut gFireTempleHookshotElevatorCol as
                                   *mut CollisionHeader as *mut libc::c_void,
                               &mut colHeader);
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna, thisx,
                            colHeader);
    if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).dyna.actor,
                          globalCtx, ACTOR_OBJ_HSBLOCK as libc::c_int as s16,
                          (*this).dyna.actor.world.pos.x,
                          (*this).dyna.actor.world.pos.y + 40.0f32,
                          (*this).dyna.actor.world.pos.z + -28.0f32,
    ...
    (*this).actionFunc =
        Some(func_80886FCC as
                 unsafe extern "C" fn(_: *mut BgHidanFslift,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80886F24(mut this: *mut BgHidanFslift) {
    if !(*this).dyna.actor.child.is_null() &&
           (*(*this).dyna.actor.child).update.is_some() {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFslift_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgHidanFslift = thisx as *mut BgHidanFslift;
...
#[no_mangle]
pub unsafe extern "C" fn func_80886FB4(mut this: *mut BgHidanFslift) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80886FCC(mut this: *mut BgHidanFslift,
                                       mut globalCtx: *mut GlobalContext) {
    let mut heightBool: s32 = 0;
    if (*this).timer != 0 { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        heightBool = 0 as libc::c_int;
        if (*this).dyna.actor.world.pos.y - (*this).dyna.actor.home.pos.y <
               0.5f32 {
            heightBool = 1 as libc::c_int
        }
        if func_80043590(&mut (*this).dyna) != 0 && heightBool != 0 {
            (*this).actionFunc =
                Some(func_808870D8 as
                         unsafe extern "C" fn(_: *mut BgHidanFslift,
                                              _: *mut GlobalContext) -> ())
        } else if heightBool == 0 {
            (*this).actionFunc =
                Some(func_8088706C as
                         unsafe extern "C" fn(_: *mut BgHidanFslift,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8088706C(mut this: *mut BgHidanFslift,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y, 4.0f32) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_808870D8(mut this: *mut BgHidanFslift,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80043590(&mut (*this).dyna) != 0 {
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y + 790.0f32, 4.0f32) != 0
           {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2835 as libc::c_int as u16_0);
            func_80886FB4(this);
    ...
    } else { func_80886FB4(this); }
    func_80886F24(this);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanFslift_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanFslift = thisx as *mut BgHidanFslift;
    ...
    if func_8004356C(&mut (*this).dyna) != 0 {
        if (*this).unk_16A as libc::c_int == 0 as libc::c_int {
            (*this).unk_16A = 3 as libc::c_int as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanFslift_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gFireTempleHookshotElevatorDL.as_mut_ptr());
}
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneDownward as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(350 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
