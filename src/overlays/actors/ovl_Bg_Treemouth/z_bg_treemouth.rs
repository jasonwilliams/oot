...
extern "C" {
    ...
    #[no_mangle]
    static mut D_8015FCC0: u16_0;
    #[no_mangle]
    static mut D_8015FCC2: u16_0;
    #[no_mangle]
    static mut D_8015FCC4: u16_0;
    #[no_mangle]
    static mut gDekuTreeMouthDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuTreeMouthCol: CollisionHeader;
    #[no_mangle]
    static mut D_808BCE20: [CutsceneData; 0];
    #[no_mangle]
    static mut D_808BD2A0: [CutsceneData; 0];
    #[no_mangle]
    static mut D_808BD520: [CutsceneData; 0];
    #[no_mangle]
    static mut D_808BD790: [CutsceneData; 0];
}
...
pub struct BgTreemouth {
    ...
    pub unk_168: f32_0,
    pub actionFunc: BgTreemouthActionFunc,
}
pub type BgTreemouthActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgTreemouth, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Treemouth_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_TREEMOUTH as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId:
                              OBJECT_SPOT04_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgTreemouth>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTreemouth_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTreemouth_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTreemouth_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTreemouth_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_SetupAction(mut this: *mut BgTreemouth,
                                                 mut actionFunc:
                                                     BgTreemouthActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgTreemouth = thisx as *mut BgTreemouth;
    ...
    CollisionHeader_GetVirtual(&mut gDekuTreeMouthCol as *mut CollisionHeader
    ...
    if gSaveContext.sceneSetupIndex < 4 as libc::c_int &&
        ...
        BgTreemouth_SetupAction(this,
                                Some(func_808BC8B8 as
                                         unsafe extern "C" fn(_:
                                                                  *mut BgTreemouth,
                                                              _:
                                                                  *mut GlobalContext)
    ...
    (*thisx).textId = 0x905 as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgTreemouth = thisx as *mut BgTreemouth;
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC65C(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        ...
        if !npcAction.is_null() {
            if (*npcAction).action as libc::c_int == 2 as libc::c_int {
                BgTreemouth_SetupAction(this,
                                        Some(func_808BC80C as
                                                 unsafe extern "C" fn(_:
                                                                          *mut BgTreemouth,
                                                                      _:
                                                                          *mut GlobalContext)
                                                     -> ()));
            } else if (*npcAction).action as libc::c_int == 3 as libc::c_int {
                Audio_PlaySoundGeneral(0x2866 as libc::c_int as u16_0,
                                       &mut D_801333D4,
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC6F8(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp34: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_168 < 1.0f32 {
        (*this).unk_168 += 0.01f32
    } else { (*this).unk_168 = 1.0f32 }
    if gSaveContext.sceneSetupIndex == 6 as libc::c_int &&
           (*globalCtx).csCtx.frames as libc::c_int >= 0x2bd as libc::c_int &&
           (*globalCtx).state.frames.wrapping_rem(8 as libc::c_int as
                                                      libc::c_uint) ==
               0 as libc::c_int as libc::c_uint {
        sp34.x = Rand_ZeroOne() * 1158.0f32 + 3407.0f32;
        sp34.y = 970.0f32;
        sp34.z = Rand_ZeroOne() * 2026.0f32 + -2163.0f32;
        EffectSsHahen_SpawnBurst(globalCtx, &mut sp34, 0.8f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC80C(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_168 += 0.05f32;
    if (*this).unk_168 >= 0.8f32 {
        BgTreemouth_SetupAction(this,
                                Some(func_808BC864 as
                                         unsafe extern "C" fn(_:
                                                                  *mut BgTreemouth,
                                                              _:
                                                                  *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC864(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_168 -= 0.03f32;
    if (*this).unk_168 <= 0.0f32 {
        BgTreemouth_SetupAction(this,
                                Some(func_808BC65C as
                                         unsafe extern "C" fn(_:
                                                                  *mut BgTreemouth,
                                                              _:
                                                                  *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC8B8(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetEventChkInf(5 as libc::c_int) == 0 ||
           gSaveContext.linkAge == 0 as libc::c_int {
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            if Flags_GetEventChkInf(0xc as libc::c_int) != 0 {
                if Actor_IsFacingAndNearPlayer(&mut (*this).dyna.actor,
                                               1658.0f32,
                    ...
                    if (*this).dyna.actor.isTargeted != 0 {
                        ...
                        (*globalCtx).csCtx.segment =
                            D_808BD2A0.as_mut_ptr() as *mut libc::c_void;
                        gSaveContext.cutsceneTrigger =
                            1 as libc::c_int as u8_0;
                        BgTreemouth_SetupAction(this,
                                                Some(func_808BC9EC as
                                                         unsafe extern "C" fn(_:
                                                                                  *mut BgTreemouth,
                                                                              _:
                                                                                  *mut GlobalContext)
                                                  ...
                                                  1658.0f32,
                                                  0x4e20 as libc::c_int as
                                                      s16) != 0 {
                Flags_SetEventChkInf(0xc as libc::c_int);
                (*globalCtx).csCtx.segment =
                    D_808BCE20.as_mut_ptr() as *mut libc::c_void;
...
#[no_mangle]
pub unsafe extern "C" fn func_808BC9EC(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*globalCtx).csCtx.state as libc::c_int ==
        ...
        if Actor_IsFacingAndNearPlayer(&mut (*this).dyna.actor, 350.0f32,
                                       0x7530 as libc::c_int as s16) != 0 {
            (*player).actor.world.pos.x = 3827.0f32;
            (*player).actor.world.pos.y = -161.0f32;
            (*player).actor.world.pos.z = -1142.0f32
        }
        (*globalCtx).csCtx.frames = 0 as libc::c_int as u16_0;
        (*globalCtx).csCtx.unk_18 = 0xffff as libc::c_int as u16_0;
        D_8015FCC0 = 0xffff as libc::c_int as u16_0;
        D_8015FCC2 = 0xffff as libc::c_int as u16_0;
        D_8015FCC4 = 0xffff as libc::c_int as u16_0;
        (*globalCtx).csCtx.unk_1A = 0 as libc::c_int as u8_0;
        (*globalCtx).csCtx.unk_1B = 0 as libc::c_int as u8_0;
        (*globalCtx).csCtx.state =
            CS_STATE_SKIPPABLE_EXEC as libc::c_int as u8_0;
        if (*globalCtx).msgCtx.choiceIndex as libc::c_int == 0 as libc::c_int
           {
            (*globalCtx).csCtx.segment =
                D_808BD520.as_mut_ptr() as *mut libc::c_void;
            Flags_SetEventChkInf(5 as libc::c_int);
            BgTreemouth_SetupAction(this,
                                    Some(func_808BCAF0 as
                                             unsafe extern "C" fn(_:
                                                                      *mut BgTreemouth,
                                                                  _:
                                                                      *mut GlobalContext)
            ...
            (*globalCtx).csCtx.segment =
                D_808BD790.as_mut_ptr() as *mut libc::c_void;
            (*globalCtx).csCtx.frames = 0 as libc::c_int as u16_0;
            BgTreemouth_SetupAction(this,
                                    Some(func_808BC8B8 as
                                             unsafe extern "C" fn(_:
...
#[no_mangle]
pub unsafe extern "C" fn func_808BCAF0(mut this: *mut BgTreemouth,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
...
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_DoNothing(mut this: *mut BgTreemouth,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgTreemouth = thisx as *mut BgTreemouth;
    let mut unk_168: f32_0 = 0.;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    unk_168 = (*this).unk_168;
    (*thisx).world.pos.x = unk_168 * -160.0f32 + 4029.0f32;
    (*thisx).world.pos.y = unk_168 * -399.0f32 + 136.0f32;
    (*thisx).world.pos.z = unk_168 * 92.0f32 + -1255.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgTreemouth_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut alpha: u16_0 = 500 as libc::c_int as u16_0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_treemouth.c\x00" as *const u8 as
    ...
    if gSaveContext.sceneSetupIndex < 4 as libc::c_int ||
        ...
        if gSaveContext.eventChkInf[0 as libc::c_int as usize] as libc::c_int
            ...
            alpha = 2150 as libc::c_int as u16_0
        }
    }
    if gSaveContext.sceneSetupIndex == 6 as libc::c_int {
        alpha =
            ((*globalCtx).roomCtx.unk_74[0 as libc::c_int as usize] as
                 libc::c_int + 0x1f4 as libc::c_int) as u16_0
    }
    ...
    (*_g).words.w1 =
        (128 as libc::c_int as u32_0 &
            ...
            ((alpha as libc::c_int as libc::c_float * 0.1f32) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gDekuTreeMouthDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_treemouth.c\x00" as *const u8 as
                         *const libc::c_char, 937 as libc::c_int);
}
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(8000 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
