...
extern "C" {
    ...
    #[no_mangle]
    static mut object_d_elevator_DL_000180: [Gfx; 0];
    #[no_mangle]
    static mut object_d_elevator_Col_000360: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjElevator {
    pub dyna: DynaPolyActor,
    pub actionFunc: ObjElevatorActionFunc,
    pub unk_168: f32_0,
    pub unk_16C: f32_0,
    pub unk_170: u8_0,
}
pub type ObjElevatorActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjElevator, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Elevator_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_ELEVATOR as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_D_ELEVATOR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjElevator>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjElevator_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjElevator_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjElevator_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjElevator_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjElevator_SetupAction(mut this: *mut ObjElevator,
                                                 mut actionFunc:
                                                     ObjElevatorActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B92B08(mut this: *mut ObjElevator,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_obj_elevator.c\x00" as *const u8 as
                         *const libc::c_char, 136 as libc::c_int,
                     (*thisx).id as libc::c_int,
                     (*thisx).params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjElevator_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjElevator = thisx as *mut ObjElevator;
    let mut temp_f0: f32_0 = 0.;
    func_80B92B08(this, globalCtx, &mut object_d_elevator_Col_000360,
                  DPM_PLAYER as libc::c_int);
    Actor_SetScale(thisx,
                   sScales[((*thisx).params as libc::c_int & 1 as libc::c_int)
                               as usize]);
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    temp_f0 =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int &
             0xf as libc::c_int) as f32_0;
    (*this).unk_16C = temp_f0 + temp_f0;
    func_80B92C5C(this);
    osSyncPrintf(b"(Dungeon Elevator)(arg_data 0x%04x)\n\x00" as *const u8 as
                     *const libc::c_char, (*thisx).params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjElevator_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjElevator = thisx as *mut ObjElevator;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B92C5C(mut this: *mut ObjElevator) {
    ObjElevator_SetupAction(this,
                            Some(func_80B92C80 as
                                     unsafe extern "C" fn(_: *mut ObjElevator,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80B92C80(mut this: *mut ObjElevator,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sub: f32_0 = 0.;
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if (*this).dyna.unk_160 as libc::c_int & 2 as libc::c_int != 0 &&
        ...
        } else { (*this).unk_168 = (*thisx).home.pos.y }
        func_80B92D20(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B92D20(mut this: *mut ObjElevator) {
    ObjElevator_SetupAction(this,
                            Some(func_80B92D44 as
                                     unsafe extern "C" fn(_: *mut ObjElevator,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn func_80B92D44(mut this: *mut ObjElevator,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if fabsf(Math_SmoothStepToF(&mut (*thisx).world.pos.y, (*this).unk_168,
                                1.0f32, (*this).unk_16C, 0.0f32)) < 0.001f32 {
        Audio_PlayActorSound2(thisx, 0x2815 as libc::c_int as u16_0);
        func_80B92C5C(this);
    } else {
        Audio_PlayActorSound2(thisx,
                              (0x281e as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjElevator_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut ObjElevator = thisx as *mut ObjElevator;
...
#[no_mangle]
pub unsafe extern "C" fn ObjElevator_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, object_d_elevator_DL_000180.as_mut_ptr());
}
