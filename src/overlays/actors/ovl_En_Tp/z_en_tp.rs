...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsDtBubble_SpawnCustomColor(globalCtx: *mut GlobalContext,
                                         pos: *mut Vec3f,
                                         velocity: *mut Vec3f,
                                         accel: *mut Vec3f,
                                         primColor: *mut Color_RGBA8,
                                         envColor: *mut Color_RGBA8,
                                         scale: s16, life: s16, randXZ: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gTailpasaranTailSegmentDL: [Gfx; 0];
    #[no_mangle]
    static mut gTailpasaranHeadDL: [Gfx; 0];
    #[no_mangle]
    static mut gTailpasaranTailSegmentTex: [u64_0; 0];
}
...
pub struct EnTp {
    ...
    pub actionIndex: s32,
    pub unk_150: s32,
    pub actionFunc: EnTpActionFunc,
    pub damageEffect: u8_0,
    pub timer: s16,
    pub unk_15C: s16,
    pub alpha: s16,
    pub red: s16,
    pub kiraSpawnTimer: s16,
    pub unk_164: s16,
    pub heightPhase: f32_0,
    pub horizontalVariation: f32_0,
    pub extraHeightVariation: f32_0,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub head: *mut EnTp,
}
pub type EnTpActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTp, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_int;
pub const TAILPASARAN_HEAD_DYING: C2RustUnnamed_22 = 12;
pub const TAILPASARAN_TAIL_DYING: C2RustUnnamed_22 = 11;
pub const TAILPASARAN_FRAGMENT: C2RustUnnamed_22 = 10;
pub const TAILPASARAN_TAIL: C2RustUnnamed_22 = 0;
pub const TAILPASARAN_HEAD: C2RustUnnamed_22 = -1;
pub const TAILPASARAN_ACTION_FRAGMENT_FADE: C2RustUnnamed_23 = 0;
pub const TAILPASARAN_ACTION_DIE: C2RustUnnamed_23 = 1;
pub const TAILPASARAN_ACTION_TAIL_FOLLOWHEAD: C2RustUnnamed_23 = 2;
pub const TAILPASARAN_ACTION_HEAD_BURROWRETURNHOME: C2RustUnnamed_23 = 9;
pub const TAILPASARAN_ACTION_HEAD_APPROACHPLAYER: C2RustUnnamed_23 = 7;
pub const TAILPASARAN_ACTION_HEAD_TAKEOFF: C2RustUnnamed_23 = 8;
pub const TAILPASARAN_ACTION_HEAD_WAIT: C2RustUnnamed_23 = 4;
pub const TAILPASARAN_DMGEFF_NONE: C2RustUnnamed_24 = 0;
pub const TAILPASARAN_DMGEFF_SHOCKING: C2RustUnnamed_24 = 14;
pub const TAILPASARAN_DMGEFF_INSULATING: C2RustUnnamed_24 = 15;
pub const TAILPASARAN_DMGEFF_DEKUNUT: C2RustUnnamed_24 = 1;
pub type C2RustUnnamed_23 = libc::c_uint;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut En_Tp_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TP as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_TP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTp>() as libc::c_ulong,
                          init:
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_DEKUNUT as libc::c_int)
                                      << 4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_INSULATING as
                                       libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (0 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (0 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_SHOCKING as libc::c_int)
                                      << 4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (TAILPASARAN_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_SetupAction(mut this: *mut EnTp,
                                          mut actionFunc: EnTpActionFunc) {
    (*this).actionFunc =
        actionFunc; // Very fake, but needed to get the s registers right
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Init(mut thisx: *mut Actor,
                                   mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnTp = thisx as *mut EnTp;
    let mut now: *mut EnTp = 0 as *mut EnTp;
    let mut next: *mut EnTp = 0 as *mut EnTp;
    let mut i: s32 = 0;
    ...
    if (*this).actor.params as libc::c_int <= TAILPASARAN_HEAD as libc::c_int
       {
        (*this).actor.naviEnemyId = 0x6 as libc::c_int as u8_0;
                ...
                if i == 2 as libc::c_int {
                    (*next).actor.flags |=
                        ((1 as libc::c_int) << 0 as libc::c_int |
                            ...
                            libc::c_uint;
                    (*next).unk_150 = 1 as libc::c_int
                    // Why?
                }
                (*next).unk_15C = (i * -(5 as libc::c_int)) as s16;
                (*next).timer = (*next).unk_15C;
                (*next).horizontalVariation =
                    6.0f32 - i as libc::c_float * 0.75f32;
                now = next;
                (0 as libc::c_int * i) != 0;
            }
            i += 1
                  ...
                  TAILPASARAN_TAIL as libc::c_int {
        EnTp_Tail_SetupFollowHead(this);
    } else { EnTp_Fragment_SetupFade(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTp = thisx as *mut EnTp;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Tail_SetupFollowHead(mut this: *mut EnTp) {
    (*this).actionIndex = TAILPASARAN_ACTION_TAIL_FOLLOWHEAD as libc::c_int;
    EnTp_SetupAction(this,
                     Some(EnTp_Tail_FollowHead as
                              unsafe extern "C" fn(_: *mut EnTp,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Tail_FollowHead(mut this: *mut EnTp,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut angle: s16 = 0;
    let mut phase: s16 = 0;
    if (*this).actor.params as libc::c_int ==
           TAILPASARAN_TAIL_DYING as libc::c_int {
        (*this).actionIndex = TAILPASARAN_ACTION_DIE as libc::c_int;
        if (*this).actor.parent.is_null() { EnTp_SetupDie(this); }
    } else {
        if (*this).unk_150 != 0 as libc::c_int {
            (*this).actor.flags |=
                ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
        }
        if (*(*this).head).unk_150 != 0 as libc::c_int {
            (*this).heightPhase = 0.0f32;
            (*this).actor.velocity.y = (*this).heightPhase;
            (*this).red = (*this).actor.velocity.y as s16;
            (*this).actor.speedXZ = (*this).red as f32_0;
            ...
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*(*this).actor.parent).world.pos.y - 4.0f32,
                               1.0f32, 1.0f32, 0.0f32);
            angle =
                ((*(*this).head).actor.shape.rot.y as libc::c_int +
                     0x4000 as libc::c_int) as s16;
            phase =
                (2000 as libc::c_int *
                     ((*(*this).head).unk_15C as libc::c_int +
                          (*this).timer as libc::c_int)) as s16;
            (*this).actor.world.pos.x =
                (*this).actor.home.pos.x +
                    Math_SinS(phase) *
                        (Math_SinS(angle) * (*this).horizontalVariation);
            (*this).actor.world.pos.z =
                (*this).actor.home.pos.z +
                    Math_SinS(phase) *
                        (Math_CosS(angle) * (*this).horizontalVariation)
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_SetupApproachPlayer(mut this: *mut EnTp) {
    (*this).actionIndex =
        TAILPASARAN_ACTION_HEAD_APPROACHPLAYER as libc::c_int;
    (*this).timer = 200 as libc::c_int as s16;
    EnTp_SetupAction(this,
                     Some(EnTp_Head_ApproachPlayer as
                              unsafe extern "C" fn(_: *mut EnTp,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_ApproachPlayer(mut this: *mut EnTp,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*player).actor.world.pos.y + 30.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    Audio_PlaySoundGeneral((0x3864 as libc::c_int - 0x800 as libc::c_int) as
                               u16_0, &mut (*this).actor.projectedPos,
    ...
    if (*this).collider.base.atFlags as libc::c_int &
        ...
        if &mut (*player).actor as *mut Actor == (*this).collider.base.at {
            (*this).timer = 1 as libc::c_int as s16
        }
    }
    if ((*this).red as libc::c_int) < 255 as libc::c_int {
        (*this).red = ((*this).red as libc::c_int + 15 as libc::c_int) as s16
    }
    if Math_CosF((*this).heightPhase) == 0.0f32 {
        (*this).extraHeightVariation = 2.0f32 * Rand_ZeroOne()
    }
    (*this).actor.world.pos.y +=
        Math_CosF((*this).heightPhase) *
            (2.0f32 + (*this).extraHeightVariation);
    (*this).heightPhase += 0.2f32;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 2.5f32, 0.1f32, 0.2f32,
                       0.0f32);
    (*this).timer -= 1;
    if (*this).timer as libc::c_int != 0 as libc::c_int {
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           1 as libc::c_int as s16, 750 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y
    } else { EnTp_Head_SetupBurrowReturnHome(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_SetupDie(mut this: *mut EnTp) {
    let mut now: *mut Actor = 0 as *mut Actor;
    (*this).timer = 2 as libc::c_int as s16;
    if (*this).actor.params as libc::c_int <= TAILPASARAN_HEAD as libc::c_int
       {
        now = (*this).actor.child;
        while !now.is_null() {
            (*now).params = TAILPASARAN_TAIL_DYING as libc::c_int as s16;
            (*now).colChkInfo.health = 0 as libc::c_int as u8_0;
            now = (*now).child
        }
        (*this).timer = 13 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3866 as libc::c_int as u16_0);
    }
    (*this).actionIndex = TAILPASARAN_ACTION_DIE as libc::c_int;
    EnTp_SetupAction(this,
                     Some(EnTp_Die as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTp_Die(mut this: *mut EnTp,
                                  mut globalCtx: *mut GlobalContext) {
    let mut now: *mut EnTp = 0 as *mut EnTp;
    let mut i: s16 = 0;
    let mut pad: s32 = 0;
    let mut effectVelAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
    let mut effectPos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    (*this).timer -= 1;
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
        if (*this).actor.params as libc::c_int ==
               TAILPASARAN_HEAD_DYING as libc::c_int {
            effectPos.x =
                (Rand_ZeroOne() - 0.5f32) * 15.0f32 +
                    (*this).actor.world.pos.x;
            effectPos.z =
                (Rand_ZeroOne() - 0.5f32) * 15.0f32 +
                    (*this).actor.world.pos.z;
            effectPos.y =
                (Rand_ZeroOne() - 0.5f32) * 5.0f32 +
                    (*this).actor.world.pos.y;
            EffectSsDeadDb_Spawn(globalCtx, &mut effectPos,
                                 &mut effectVelAccel, &mut effectVelAccel,
            ...
            while (i as libc::c_int) < 1 as libc::c_int {
                now =
                    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                ...
                                0 as libc::c_int as s16,
                                0 as libc::c_int as s16,
                                TAILPASARAN_FRAGMENT as libc::c_int as s16) as
                        *mut EnTp;
                if !now.is_null() {
                    Actor_SetScale(&mut (*now).actor,
                                   (*this).actor.scale.z * 0.5f32);
                    (*now).red = (*this).red
                }
                i += 1
            }
        ...
        if !(*this).actor.child.is_null() {
            (*(*this).actor.child).parent = 0 as *mut Actor;
            (*(*this).actor.child).params =
                TAILPASARAN_TAIL_DYING as libc::c_int as s16;
            (*(*this).actor.child).colChkInfo.health =
                0 as libc::c_int as u8_0
        }
        (*this).unk_150 = 2 as libc::c_int;
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Fragment_SetupFade(mut this: *mut EnTp) {
    (*this).actionIndex = TAILPASARAN_ACTION_FRAGMENT_FADE as libc::c_int;
    (*this).actor.world.pos.x += (Rand_ZeroOne() - 0.5f32) * 5.0f32;
    (*this).actor.world.pos.y += (Rand_ZeroOne() - 0.5f32) * 5.0f32;
    (*this).actor.world.pos.z += (Rand_ZeroOne() - 0.5f32) * 5.0f32;
    (*this).actor.velocity.x = (Rand_ZeroOne() - 0.5f32) * 1.5f32;
    (*this).actor.velocity.y = (Rand_ZeroOne() - 0.5f32) * 1.5f32;
    (*this).actor.velocity.z = (Rand_ZeroOne() - 0.5f32) * 1.5f32;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    EnTp_SetupAction(this,
                     Some(EnTp_Fragment_Fade as
                              unsafe extern "C" fn(_: *mut EnTp,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Fragment_Fade(mut this: *mut EnTp,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    func_8002D7EC(&mut (*this).actor);
    (*this).alpha = ((*this).alpha as libc::c_int - 20 as libc::c_int) as s16;
    if ((*this).alpha as libc::c_int) < 20 as libc::c_int {
        (*this).alpha = 0 as libc::c_int as s16;
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_SetupTakeOff(mut this: *mut EnTp) {
    (*this).timer = (Rand_ZeroOne() * 15.0f32 + 40.0f32) as s16;
    (*this).actionIndex = TAILPASARAN_ACTION_HEAD_TAKEOFF as libc::c_int;
    EnTp_SetupAction(this,
                     Some(EnTp_Head_TakeOff as
                              unsafe extern "C" fn(_: *mut EnTp,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_TakeOff(mut this: *mut EnTp,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
    ...
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 2.5f32, 0.1f32, 0.2f32,
                       0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                       (*player).actor.world.pos.y + 85.0f32 +
                           (*this).horizontalVariation, 1.0f32,
                       (*this).actor.speedXZ * 0.25f32, 0.0f32);
    Audio_PlaySoundGeneral((0x3864 as libc::c_int - 0x800 as libc::c_int) as
                               u16_0, &mut (*this).actor.projectedPos,
                           4 as libc::c_int as u8_0, &mut D_801333E0,
                           &mut D_801333E0, &mut D_801333E8);
    ...
    if (*this).red as libc::c_int != 0 as libc::c_int {
        (*this).red = ((*this).red as libc::c_int - 15 as libc::c_int) as s16
    }
    if Math_CosF((*this).heightPhase) == 0.0f32 {
        (*this).extraHeightVariation = Rand_ZeroOne() * 4.0f32
    }
    (*this).actor.world.pos.y +=
        Math_CosF((*this).heightPhase) *
            ((*this).actor.speedXZ * 0.25f32 + (*this).extraHeightVariation);
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             (*this).unk_164 as libc::c_int) as s16;
    (*this).heightPhase += 0.2f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_SetupWait(mut this: *mut EnTp) {
    (*this).actionIndex = TAILPASARAN_ACTION_HEAD_WAIT as libc::c_int;
    (*this).unk_150 = 0 as libc::c_int;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_Wait(mut this: *mut EnTp,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as
            *mut Player; // Required to match, usage can maybe be improved
    let mut yaw: s16 =
        0; // Can eliminate this and just use now, but they're used differently
    (*this).unk_15C -= 1;
    if (*this).actor.xzDistToPlayer < 200.0f32 {
        ...
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            ...
            yaw =
                (Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                                &mut (*player).actor.world.pos) as libc::c_int
                     + 0x4000 as libc::c_int) as s16;
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*this).actor.home.pos.y + 30.0f32, 0.3f32,
                               1.0f32, 0.3f32);
            (*this).actor.world.pos.x =
                (*this).actor.home.pos.x +
                    Math_SinS((2000 as libc::c_int *
                                   (*this).unk_15C as libc::c_int) as s16) *
                        (Math_SinS(yaw) * (*this).horizontalVariation);
            (*this).actor.world.pos.z =
                (*this).actor.home.pos.z +
                    Math_SinS((2000 as libc::c_int *
                                   (*this).unk_15C as libc::c_int) as s16) *
                        (Math_CosS(yaw) * (*this).horizontalVariation)
        } else {
            (*this).actor.shape.rot.x = 0 as libc::c_int as s16;
            (*this).unk_150 = 1 as libc::c_int;
        ...
        if Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                              (*this).actor.home.pos.y, 0.3f32, 1.5f32,
                              0.3f32) == 0.0f32 {
            (*this).timer = 60 as libc::c_int as s16
        } else {
            yaw =
            ...
            (*this).actor.world.pos.x =
                (*this).actor.home.pos.x +
                    Math_SinS((2000 as libc::c_int *
                                   (*this).unk_15C as libc::c_int) as s16) *
                        (Math_SinS(yaw) * 6.0f32);
            (*this).actor.world.pos.z =
                (*this).actor.home.pos.z +
                    Math_SinS((2000 as libc::c_int *
                                   (*this).unk_15C as libc::c_int) as s16) *
                        (Math_CosS(yaw) * 6.0f32)
        }
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).actor.world.pos.y != (*this).actor.home.pos.y {
        Audio_PlaySoundGeneral((0x3864 as libc::c_int - 0x800 as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_SetupBurrowReturnHome(mut this:
                                                             *mut EnTp) {
    (*this).actionIndex =
        TAILPASARAN_ACTION_HEAD_BURROWRETURNHOME as libc::c_int;
    (*this).timer = 0 as libc::c_int as s16;
    EnTp_SetupAction(this,
                     Some(EnTp_Head_BurrowReturnHome as
                              unsafe extern "C" fn(_: *mut EnTp,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTp_Head_BurrowReturnHome(mut this: *mut EnTp,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    static mut bubbleAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -0.5f32, z: 0.0f32,}; init };
    static mut bubblePrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut bubbleEnvColor: Color_RGBA8 =
        {
            let mut init =
    ...
    let mut bubbleVelocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut bubblePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut closeToFloor: s32 = 0;
    let mut now: *mut EnTp = 0 as *mut EnTp;
    let mut temp_v0: s16 = 0;
    closeToFloor = 0 as libc::c_int;
    temp_v0 = (*this).timer;
    (*this).unk_15C -= 1;
    if temp_v0 as libc::c_int != 0 as libc::c_int ||
           (*this).actor.home.pos.y - (*this).actor.world.pos.y > 60.0f32 {
        (*this).timer = (temp_v0 as libc::c_int - 1 as libc::c_int) as s16;
        temp_v0 = (*this).timer;
        if temp_v0 as libc::c_int == 0 as libc::c_int {
            EnTp_Head_SetupWait(this);
            now = (*this).actor.child as *mut EnTp;
            while !now.is_null() {
                (*now).unk_15C = (*now).timer;
                now = (*now).actor.child as *mut EnTp
            }
        } else {
            if (*this).actor.shape.rot.x as libc::c_int !=
                ...
                now = (*this).actor.child as *mut EnTp;
                while !now.is_null() {
                    (*now).actor.velocity.y = 0.0f32;
                    (*now).actor.speedXZ = 0.0f32;
                    (*now).actor.world.pos = (*this).actor.home.pos;
                    (*now).actor.world.pos.y =
                        (*this).actor.home.pos.y - 80.0f32;
                    now = (*now).actor.child as *mut EnTp
                }
            }
            (*this).actor.world.pos.y =
        ...
        if (*this).red as libc::c_int != 0 as libc::c_int {
            (*this).red =
                ((*this).red as libc::c_int - 15 as libc::c_int) as s16
        }
        (*this).actor.speedXZ = 2.0f32 * Math_CosS((*this).actor.shape.rot.x);
        (*this).actor.velocity.y =
            Math_SinS((*this).actor.shape.rot.x) * -2.0f32;
        if (*this).actor.world.pos.y - (*this).actor.floorHeight < 20.0f32 {
            closeToFloor = 1 as libc::c_int
        }
        if (*this).actor.world.pos.y != (*this).actor.home.pos.y {
            Audio_PlaySoundGeneral((0x3864 as libc::c_int -
        ...
        if closeToFloor != 0 &&
            ...
            bubbleVelocity.x = Rand_CenteredFloat(5.0f32);
            bubbleVelocity.y = Rand_ZeroOne() * 3.5f32 + 1.5f32;
            bubbleVelocity.z = Rand_CenteredFloat(5.0f32);
            EffectSsDtBubble_SpawnCustomColor(globalCtx, &mut bubblePos,
                                              &mut bubbleVelocity,
                                              &mut bubbleAccel,
                                              &mut bubblePrimColor,
                                              &mut bubbleEnvColor,
                                              Rand_S16Offset(100 as
                                                                 libc::c_int
                                                                 as s16,
                                                             50 as libc::c_int
                                                                 as s16),
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_UpdateDamage(mut this: *mut EnTp,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut phi_s2: s32 = 0;
    let mut phi_s4: s32 = 0;
    let mut head: *mut EnTp = 0 as *mut EnTp;
    let mut now: *mut EnTp = 0 as *mut EnTp;
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 &&
           (*this).actionIndex >=
               TAILPASARAN_ACTION_TAIL_FOLLOWHEAD as libc::c_int {
        phi_s2 = 0 as libc::c_int;
        phi_s4 = phi_s2;
        if (*this).actor.params as libc::c_int <=
               TAILPASARAN_HEAD as libc::c_int {
            phi_s2 = 1 as libc::c_int
        }
        (*this).collider.base.acFlags =
            ((*this).collider.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   TAILPASARAN_DMGEFF_DEKUNUT as libc::c_int {
                phi_s4 = 1 as libc::c_int
            }
            // Head is invincible
            if phi_s2 == 0 as libc::c_int {
            ...
            if (*this).actor.colChkInfo.health as libc::c_int ==
                ...
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
                head = (*this).head;
                if (*head).actor.params as libc::c_int <=
                       TAILPASARAN_HEAD as libc::c_int {
                    EnTp_SetupDie(head);
                    (*head).damageEffect =
                        (*this).actor.colChkInfo.damageEffect;
                    (*head).actor.params =
                        TAILPASARAN_HEAD_DYING as libc::c_int as s16
                }
            } else {
                if phi_s4 != 0 as libc::c_int {
                    (*this).actor.freezeTimer = 80 as libc::c_int as u16_0;
                    Audio_PlayActorSound2(&mut (*this).actor,
                ...
                now = (*this).actor.parent as *mut EnTp;
                while !now.is_null() {
                    (*now).collider.base.acFlags =
                        ((*now).collider.base.acFlags as libc::c_int &
                             !((1 as libc::c_int) << 1 as libc::c_int)) as
                            u8_0;
                    if phi_s4 != 0 as libc::c_int {
                        (*now).actor.freezeTimer = 80 as libc::c_int as u16_0;
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x389e as libc::c_int as u16_0);
                        if phi_s2 != 0 as libc::c_int {
                            Actor_SetColorFilter(&mut (*now).actor,
                                                 0 as libc::c_int as s16,
                                                 0xff as libc::c_int as s16,
                                                 0 as libc::c_int as s16,
                                                 0x50 as libc::c_int as s16);
                    ...
                    now = (*now).actor.parent as *mut EnTp
                }
                now = (*this).actor.child as *mut EnTp;
                while !now.is_null() {
                    (*now).collider.base.acFlags =
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnTp = thisx as *mut EnTp;
    let mut kiraVelocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut kiraAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -0.6f32, z: 0.0f32,}; init };
    let mut kiraPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut kiraPrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    let mut kiraEnvColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 0 as libc::c_int as u8_0,
                            g: 0 as libc::c_int as u8_0,
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut yawToWall: s16 = 0;
    if (*player).stateFlags1 & 0x4000000 as libc::c_int as libc::c_uint != 0 {
        // Shielding
        (*this).damageEffect = TAILPASARAN_DMGEFF_NONE as libc::c_int as u8_0
    }
    ...
    if (*this).actor.params as libc::c_int <= TAILPASARAN_HEAD as libc::c_int
       {
        ...
        if (*this).actionIndex !=
            ...
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32,
                                    15.0f32, 10.0f32, 5 as libc::c_int);
        }
        // Turn away from wall
        if (*this).actor.speedXZ != 0.0f32 &&
            ...
            if (if yawToWall as libc::c_int >= 0 as libc::c_int {
                    yawToWall as libc::c_int
                } else { -(yawToWall as libc::c_int) }) >
                   0x4000 as libc::c_int {
                if yawToWall as libc::c_int >= 0 as libc::c_int {
                    (*this).actor.world.rot.y =
                        ((*this).actor.world.rot.y as libc::c_int -
                             500 as libc::c_int) as s16
                } else {
        ...
        (*this).actor.shape.rot.z =
            ((*this).actor.shape.rot.z as libc::c_int + 0x800 as libc::c_int)
                as s16;
        if (*this).actor.shape.rot.z as libc::c_int == 0 as libc::c_int {
            Audio_PlaySoundGeneral(0x3865 as libc::c_int as u16_0,
                                   &mut (*this).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
        }
    ...
    if (*this).actor.params as libc::c_int !=
           TAILPASARAN_TAIL_DYING as libc::c_int {
        (*this).kiraSpawnTimer -= 1;
        (*this).kiraSpawnTimer =
            ((*this).kiraSpawnTimer as libc::c_int & 7 as libc::c_int) as s16
    }
    (*this).actor.focus.pos = (*this).actor.world.pos;
    ...
    if (*this).kiraSpawnTimer as libc::c_int & 7 as libc::c_int ==
           0 as libc::c_int {
        kiraPrimColor.r = (*this).red as u8_0;
        kiraAccel.x = -(*this).actor.velocity.x * 0.25f32;
        kiraAccel.y = -(*this).actor.velocity.y * 0.25f32;
        kiraAccel.z = -(*this).actor.velocity.z * 0.25f32;
        kiraPos.x =
            (Rand_ZeroOne() - 0.5f32) * 25.0f32 + (*this).actor.world.pos.x;
        kiraPos.y =
            (Rand_ZeroOne() - 0.5f32) * 20.0f32 + (*this).actor.world.pos.y;
        kiraPos.z =
            (Rand_ZeroOne() - 0.5f32) * 25.0f32 + (*this).actor.world.pos.z;
        EffectSsKiraKira_SpawnSmall(globalCtx, &mut kiraPos,
                                    &mut kiraVelocity, &mut kiraAccel,
                                    &mut kiraPrimColor, &mut kiraEnvColor);
    }
    if (*this).actionIndex >=
           TAILPASARAN_ACTION_TAIL_FOLLOWHEAD as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnTp_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnTp = thisx as *mut EnTp;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tp.c\x00" as *const u8 as *const libc::c_char,
                    1451 as libc::c_int);
    if (*this).unk_150 != 2 as libc::c_int {
        if (*thisx).params as libc::c_int <= TAILPASARAN_HEAD as libc::c_int
               ||
            ...
            (*_g).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_tp.c\x00" as *const u8 as
            ...
            (*_g_0).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gTailpasaranHeadDL.as_mut_ptr() as libc::c_uint;
            Matrix_Translate(0.0f32, 0.0f32, 8.0f32,
            ...
            (*_g_5).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                gSegments[((gTailpasaranTailSegmentTex.as_mut_ptr() as u32_0)
                               << 4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gTailpasaranTailSegmentTex.as_mut_ptr()
                                                      as u32_0 &
            ...
            (*_g_8).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_8).words.w1 =
                gTailpasaranTailSegmentDL.as_mut_ptr() as libc::c_uint
        }
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tp.c\x00" as *const u8 as *const libc::c_char,
                     1495 as libc::c_int);
    if (*thisx).params as libc::c_int <= TAILPASARAN_TAIL as libc::c_int ||
           (*thisx).params as libc::c_int ==
               TAILPASARAN_TAIL_DYING as libc::c_int {
