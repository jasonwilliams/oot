...
pub struct EnOE2 {
    pub actor: Actor,
    pub unk_14C: [libc::c_char; 68],
    pub actionFunc: EnOE2ActionFunc,
}
pub type EnOE2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnOE2, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_OE2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_OE2 as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_OE2 as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnOE2>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnOE2_SetupAction(mut this: *mut EnOE2,
                                           mut actionFunc: EnOE2ActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnOE2_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnOE2 = thisx as *mut EnOE2;
    EnOE2_SetupAction(this,
                      Some(EnOE2_DoNothing as
                               unsafe extern "C" fn(_: *mut EnOE2,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnOE2_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnOE2_DoNothing(mut this: *mut EnOE2,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnOE2_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnOE2_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
}
