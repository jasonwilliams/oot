...
pub type EnSyatekiNiwActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnSyatekiNiw, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Syateki_Niw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SYATEKI_NIW as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnSyatekiNiw>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiNiw_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiNiw_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiNiw_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSyatekiNiw_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiNiw_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnSyatekiNiw = thisx as *mut EnSyatekiNiw;
    ...
    if ((*this).unk_29E as libc::c_int) < 0 as libc::c_int {
    ...
    if (*this).unk_29E as libc::c_int == 0 as libc::c_int {
        ...
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xb0\x84\xe7\x9a\x84\xe5\xa0\xb4\xe9\xb6\x8f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Actor_SetScale(&mut (*this).actor, 0.01f32);
    } else {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "Bomb chicken"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x9c\xe3\x83\xa0\xe3\x81\xab\xe3\x82\x8f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
    ...
    (*this).actionFunc =
        Some(func_80B11DEC as
                 unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiNiw_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnSyatekiNiw = thisx as *mut EnSyatekiNiw;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B11A94(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s16) {
    if (*this).unk_254 as libc::c_int == 0 as libc::c_int {
        if arg2 as libc::c_int == 0 as libc::c_int {
            (*this).unk_264 = 0.0f32
        } else { (*this).unk_264 = -10000.0f32 }
        (*this).unk_28E =
            ((*this).unk_28E as libc::c_int + 1 as libc::c_int) as s16;
        (*this).unk_254 = 3 as libc::c_int as s16;
        if (*this).unk_28E as libc::c_int & 1 as libc::c_int == 0 {
            (*this).unk_264 = 0.0f32;
            if arg2 as libc::c_int == 0 as libc::c_int {
                (*this).unk_254 = Rand_ZeroFloat(30.0f32) as s16
            }
        }
    }
    if (*this).unk_258 as libc::c_int == 0 as libc::c_int {
        (*this).unk_292 += 1;
        (*this).unk_292 =
            ((*this).unk_292 as libc::c_int & 1 as libc::c_int) as s16;
        match arg2 as libc::c_int {
            0 => { (*this).unk_26C = 0.0f32; (*this).unk_268 = 0.0f32 }
            1 => {
                (*this).unk_258 = 3 as libc::c_int as s16;
                (*this).unk_26C = 7000.0f32;
                (*this).unk_268 = 7000.0f32;
                if (*this).unk_292 as libc::c_int == 0 as libc::c_int {
                    (*this).unk_26C = 0.0f32;
                    (*this).unk_268 = 0.0f32
                }
            }
            2 => {
                ...
                (*this).unk_26C = -10000.0f32;
                (*this).unk_268 = (*this).unk_26C;
                (*this).unk_278 = 25000.0f32;
                (*this).unk_280 = (*this).unk_278;
                (*this).unk_27C = 6000.0f32;
                (*this).unk_284 = (*this).unk_27C;
                if (*this).unk_292 as libc::c_int == 0 as libc::c_int {
                    (*this).unk_278 = 8000.0f32;
                    (*this).unk_280 = 8000.0f32
                }
            }
            3 => {
                (*this).unk_258 = 2 as libc::c_int as s16;
                (*this).unk_278 = 10000.0f32;
                (*this).unk_280 = 10000.0f32;
                if (*this).unk_292 as libc::c_int == 0 as libc::c_int {
                    (*this).unk_278 = 3000.0f32;
                    (*this).unk_280 = 3000.0f32
                }
            }
            4 => {
                (*this).unk_256 = 5 as libc::c_int as s16;
                (*this).unk_254 = (*this).unk_256
            }
            5 => {
                (*this).unk_258 = 5 as libc::c_int as s16;
                (*this).unk_278 = 14000.0f32;
                (*this).unk_280 = 14000.0f32;
                if (*this).unk_292 as libc::c_int == 0 as libc::c_int {
                    (*this).unk_278 = 10000.0f32;
                    (*this).unk_280 = 10000.0f32
                }
    ...
    if (*this).unk_264 != (*this).unk_2BC.x {
        Math_ApproachF(&mut (*this).unk_2BC.x, (*this).unk_264, 0.5f32,
                       4000.0f32);
    }
    if (*this).unk_26C != (*this).unk_2A4.x {
        Math_ApproachF(&mut (*this).unk_2A4.x, (*this).unk_26C, 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_280 != (*this).unk_2A4.y {
        Math_ApproachF(&mut (*this).unk_2A4.y, (*this).unk_280, 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_284 != (*this).unk_2A4.z {
        Math_ApproachF(&mut (*this).unk_2A4.z, (*this).unk_284, 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_268 != (*this).unk_2B0.x {
        Math_ApproachF(&mut (*this).unk_2B0.x, (*this).unk_268, 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_278 != (*this).unk_2B0.y {
        Math_ApproachF(&mut (*this).unk_2B0.y, (*this).unk_278, 0.8f32,
                       7000.0f32);
    }
    if (*this).unk_27C != (*this).unk_2B0.z {
        Math_ApproachF(&mut (*this).unk_2B0.z, (*this).unk_27C, 0.8f32,
                       7000.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B11DEC(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_29E as libc::c_int != 0 as libc::c_int {
        Actor_SetScale(&mut (*this).actor, (*this).unk_2F4);
    }
    (*this).actionFunc =
        Some(func_80B11E78 as
                 unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B11E78(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut dustVelocity: Vec3f =
    ...
    let mut dustPrimColor: Color_RGBA8 =
        {
            let mut init =
    ...
    let mut dustEnvColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 0 as libc::c_int as u8_0,
                            g: 0 as libc::c_int as u8_0,
    ...
    if (*this).unk_29C as libc::c_int != 0 as libc::c_int &&
           (*this).unk_29E as libc::c_int == 0 as libc::c_int &&
           (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_29C = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B123A8 as
                     unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                          _: *mut GlobalContext) -> ());
        return
    }
    sp4A = 0 as libc::c_int as s16;
    if (*this).unk_25E as libc::c_int == 0 as libc::c_int &&
           (*this).unk_25C as libc::c_int == 0 as libc::c_int {
        (*this).unk_294 += 1;
        if (*this).unk_294 as libc::c_int >= 8 as libc::c_int {
            (*this).unk_25E = Rand_ZeroFloat(30.0f32) as s16;
            (*this).unk_294 = Rand_ZeroFloat(3.99f32) as s16;
            match (*this).unk_29E as libc::c_int {
                0 => {
                    sp50 = Rand_CenteredFloat(100.0f32);
                    if sp50 < 0.0f32 {
                        sp50 -= 100.0f32
                    } else { sp50 += 100.0f32 }
                    sp4C = Rand_CenteredFloat(100.0f32);
                    if sp4C < 0.0f32 {
                        sp4C -= 100.0f32
                    } else { sp4C += 100.0f32 }
                    (*this).unk_2E8.x = (*this).unk_2DC.x + sp50;
                    (*this).unk_2E8.z = (*this).unk_2DC.z + sp4C;
                    if (*this).unk_2E8.x < -150.0f32 {
                        (*this).unk_2E8.x = -150.0f32
                    }
                    if (*this).unk_2E8.x > 150.0f32 {
                        (*this).unk_2E8.x = 150.0f32
                    }
                    if (*this).unk_2E8.z < -60.0f32 {
                        (*this).unk_2E8.z = -60.0f32
                    }
                    if (*this).unk_2E8.z > -40.0f32 {
                        (*this).unk_2E8.z = -40.0f32
                    }
                }
                1 => {
                    sp50 = Rand_CenteredFloat(50.0f32);
                    if sp50 < 0.0f32 {
                        sp50 -= 50.0f32
                    } else { sp50 += 50.0f32 }
                    sp4C = Rand_CenteredFloat(30.0f32);
                    if sp4C < 0.0f32 {
                        sp4C -= 30.0f32
                    } else { sp4C += 30.0f32 }
                    (*this).unk_2E8.x = (*this).unk_2DC.x + sp50;
            ...
            (*this).unk_25C = 4 as libc::c_int as s16;
            if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                   0 {
                (*this).actor.velocity.y = 2.5f32;
                if Rand_ZeroFloat(10.0f32) < 1.0f32 &&
                       (*this).unk_29E as libc::c_int == 0 as libc::c_int {
                    (*this).unk_25C = 0xc as libc::c_int as s16;
    ...
    if (*this).unk_25C as libc::c_int != 0 as libc::c_int {
        sp4A = 1 as libc::c_int as s16;
        Math_ApproachF(&mut (*this).actor.world.pos.x, (*this).unk_2E8.x,
                       1.0f32, (*this).unk_2C8.y);
        Math_ApproachF(&mut (*this).actor.world.pos.z, (*this).unk_2E8.z,
                       1.0f32, (*this).unk_2C8.y);
        Math_ApproachF(&mut (*this).unk_2C8.y, 3.0f32, 1.0f32, 0.3f32);
        tmpf1 = (*this).unk_2E8.x - (*this).actor.world.pos.x;
        tmpf2 = (*this).unk_2E8.z - (*this).actor.world.pos.z;
        if fabsf(tmpf1) < 10.0f32 { tmpf1 = 0 as libc::c_int as f32_0 }
        if fabsf(tmpf2) < 10.0f32 { tmpf2 = 0.0f32 }
        if tmpf1 == 0.0f32 && tmpf2 == 0.0f32 {
            (*this).unk_25C = 0 as libc::c_int as s16;
            (*this).unk_294 = 7 as libc::c_int as s16
        }
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           (Math_FAtan2F(tmpf1, tmpf2) *
                                (0x8000 as libc::c_int as libc::c_float /
                                     3.14159265358979323846f32)) as s16,
                           3 as libc::c_int as s16, (*this).unk_2C8.z as s16,
                           0 as libc::c_int as s16);
        Math_ApproachF(&mut (*this).unk_2C8.z, 10000.0f32, 1.0f32, 1000.0f32);
    }
    if (*this).unk_260 as libc::c_int == 0 as libc::c_int {
    ...
    if (*globalCtx).gameplayFrames.wrapping_rem(4 as libc::c_int as
        ...
        dustVelocity.y = Rand_CenteredFloat(5.0f32);
        dustAccel.y = 0.2f32;
        dustPos = (*this).actor.world.pos;
        func_8002836C(globalCtx, &mut dustPos, &mut dustVelocity,
                      &mut dustAccel, &mut dustPrimColor, &mut dustEnvColor,
                      600 as libc::c_int as s16, 40 as libc::c_int as s16,
                      30 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B123A8(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gCuccoAnim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gCuccoAnim as
                                                *mut AnimationHeader as
                     ...
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).unk_27C = 6000.0f32;
    (*this).unk_288 = -10000.0f32;
    (*this).unk_2B0.z = 6000.0f32;
    (*this).unk_2B0.y = 10000.0f32;
    (*this).actionFunc =
        Some(func_80B12460 as
                 unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_2A4.z = 6000.0f32;
    (*this).unk_284 = 6000.0f32;
    (*this).unk_2B0.x = -10000.0f32;
    (*this).unk_268 = -10000.0f32;
    (*this).unk_2A4.y = -10000.0f32;
    (*this).unk_2A4.x = -10000.0f32;
    (*this).unk_26C = -10000.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B12460(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut phi_f16: f32_0 = 0.0f32;
    (*player).actor.freezeTimer = 10 as libc::c_int as u16_0;
    match (*this).unk_29A as libc::c_int {
        0 => {
            (*this).unk_296 = 2 as libc::c_int as s16;
            (*this).unk_2C8.y = 0.0f32;
            (*this).unk_29A = 1 as libc::c_int as s16
        }
        1 => {
            (*this).actor.speedXZ = 2.0f32;
            if (*this).unk_25C as libc::c_int == 0 as libc::c_int {
                (*this).unk_25C = 3 as libc::c_int as s16;
                (*this).actor.velocity.y = 3.5f32
            }
            if (*this).unk_25A as libc::c_int == 0 as libc::c_int {
                (*this).unk_298 += 1;
                (*this).unk_298 =
                    ((*this).unk_298 as libc::c_int & 1 as libc::c_int) as
                        s16;
                (*this).unk_25A = 5 as libc::c_int as s16
            }
            phi_f16 =
                if (*this).unk_298 as libc::c_int == 0 as libc::c_int {
                    5000.0f32
                } else { -5000.0f32 };
            if (*this).actor.world.pos.z > 100.0f32 {
                (*this).actor.speedXZ = 2.0f32;
                (*this).actor.gravity = -0.3f32;
                (*this).actor.velocity.y = 5.0f32;
                (*this).unk_29A = 2 as libc::c_int as s16
            }
        }
        2 => {
            if (*player).actor.world.pos.z - 40.0f32 <
                   (*this).actor.world.pos.z {
                (*this).actor.speedXZ = 0.0f32
            }
            if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                   0 && (*this).actor.world.pos.z > 110.0f32 {
                ...
                (*this).unk_256 = 0 as libc::c_int as s16;
                (*this).unk_254 = (*this).unk_256;
                (*this).unk_290 = 0 as libc::c_int as s16;
                (*this).unk_28E = (*this).unk_290;
                (*this).unk_296 = 1 as libc::c_int as s16;
                (*this).unk_29A = 3 as libc::c_int as s16
            }
        }
        3 => {
            if (*player).actor.world.pos.z - 50.0f32 <
                   (*this).actor.world.pos.z {
                (*this).actor.speedXZ = 0.0f32;
                (*this).unk_262 = 0x3c as libc::c_int as s16;
                (*this).unk_25A = 0x14 as libc::c_int as s16;
                (*this).unk_264 = 10000.0f32;
                (*this).unk_29A = 4 as libc::c_int as s16
            }
        }
        4 => {
            if (*this).unk_25A as libc::c_int == 0 as libc::c_int {
                (*this).unk_296 = 4 as libc::c_int as s16;
                (*this).unk_264 = 5000.0f32;
                (*this).unk_26C = 0.0f32;
                (*this).unk_268 = 0.0f32;
                (*this).unk_284 = 0.0f32;
                (*this).unk_27C = 0.0f32;
                ...
                (*this).unk_25A = 0x1e as libc::c_int as s16;
                (*this).unk_256 = (*this).unk_25A;
                (*this).unk_254 = (*this).unk_256;
                (*this).unk_29A = 5 as libc::c_int as s16
            }
        }
        5 => {
            if (*this).unk_25A as libc::c_int == 1 as libc::c_int {
                (*this).unk_258 = 0 as libc::c_int as s16;
                (*this).unk_296 = 5 as libc::c_int as s16;
            ...
            if (*this).unk_25A as libc::c_int == 0 as libc::c_int &&
                   (*player).actor.world.pos.z - 30.0f32 <
                       (*this).actor.world.pos.z {
                Audio_PlaySoundGeneral(0x680b as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
                (*this).unk_25E = 0x14 as libc::c_int as s16;
                (*this).unk_29A = 6 as libc::c_int as s16;
                (*this).actor.speedXZ = 0.0f32
            }
        }
        6 => {
            if (*this).unk_25E as libc::c_int == 1 as libc::c_int {
                (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8;
                (*globalCtx).nextEntranceIndex =
                    gSaveContext.entranceIndex as s16;
                (*globalCtx).shootingGalleryStatus = 0 as libc::c_int as s8;
                (*player).actor.freezeTimer = 20 as libc::c_int as u16_0;
                (*this).unk_25E = 0x14 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_80B128D8 as
                             unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       ((Math_FAtan2F((*player).actor.world.pos.x -
                                          (*this).actor.world.pos.x,
                                      (*player).actor.world.pos.z -
                                          (*this).actor.world.pos.z) *
                             (0x8000 as libc::c_int as libc::c_float /
                                  3.14159265358979323846f32)) as s16 as
                            libc::c_int as libc::c_float + phi_f16) as s16,
                       5 as libc::c_int as s16, (*this).unk_2C8.y as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2C8.y, 3000.0f32, 1.0f32, 500.0f32);
    if (*this).unk_296 as libc::c_int == 2 as libc::c_int {
        (*this).unk_256 = 10 as libc::c_int as s16;
        (*this).unk_254 = (*this).unk_256
    }
    func_80B11A94(this, globalCtx, (*this).unk_296);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B128D8(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_25E as libc::c_int == 1 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B128F8(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp26: s16 = 0;
    let mut sp24: s16 = 0;
    Actor_SetFocus(&mut (*this).actor, (*this).unk_2D4);
    Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp26, &mut sp24);
    if (*this).actor.projectedPos.z > 200.0f32 &&
           (*this).actor.projectedPos.z < 800.0f32 &&
           sp26 as libc::c_int > 0 as libc::c_int &&
        ...
        (*this).unk_298 = Rand_ZeroFloat(1.99f32) as s16;
        (*this).unk_2D8 = Rand_CenteredFloat(8000.0f32) + -10000.0f32;
        (*this).unk_262 = 0x1e as libc::c_int as s16;
        (*this).unk_25E = 0x64 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80B129EC as
                     unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B129EC(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    let mut tmpf2: f32_0 = 0.;
    Actor_SetFocus(&mut (*this).actor, (*this).unk_2D4);
    Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp2E, &mut sp2C);
    if (*this).unk_25E as libc::c_int == 0 as libc::c_int ||
           (*this).actor.projectedPos.z < -70.0f32 ||
           (sp2E as libc::c_int) < 0 as libc::c_int ||
    ...
    (*this).unk_2A0 = 1 as libc::c_int as s16;
    if (*this).unk_25C as libc::c_int == 0 as libc::c_int {
        (*this).unk_298 += 1;
        (*this).unk_298 =
            ((*this).unk_298 as libc::c_int & 1 as libc::c_int) as s16;
        (*this).unk_25C =
            (Rand_CenteredFloat(4.0f32) as s16 as libc::c_int +
                 5 as libc::c_int) as s16;
        if Rand_ZeroFloat(5.0f32) < 1.0f32 &&
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, tmpf2 as s16,
                       3 as libc::c_int as s16, (*this).unk_2C8.y as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_2C8.y, 3000.0f32, 1.0f32, 500.0f32);
    func_80B11A94(this, globalCtx, 2 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B12BA4(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
        ...
        match (*this).unk_29E as libc::c_int {
            0 => {
                if (*this).unk_29C as libc::c_int == 0 as libc::c_int {
                    ...
                    (*this).unk_29C = 1 as libc::c_int as s16;
                    (*this).unk_2A0 = 1 as libc::c_int as s16;
                    (*this).actionFunc =
                        Some(func_80B123A8 as
                                 unsafe extern "C" fn(_: *mut EnSyatekiNiw,
            ...
            1 => {
                ...
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x2812 as libc::c_int as u16_0);
                (*this).unk_260 = 100 as libc::c_int as s16;
                (*this).unk_2A0 = 1 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiNiw_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnSyatekiNiw = thisx as *mut EnSyatekiNiw;
    let mut pad: s32 = 0;
    ...
    if (*this).unk_262 as libc::c_int != 0 as libc::c_int {
        (*this).unk_262 -= 1
    }
    if (*this).unk_260 as libc::c_int != 0 as libc::c_int {
        (*this).unk_260 -= 1
    ...
    (*this).actor.shape.shadowScale = 15.0f32;
    ...
    if (*this).unk_2A0 as libc::c_int != 0 as libc::c_int {
        ...
        while (i as libc::c_int) < 20 as libc::c_int {
            sp78.x = Rand_CenteredFloat(10.0f32) + (*this).actor.world.pos.x;
            sp78.y =
                Rand_CenteredFloat(10.0f32) +
                    ((*this).actor.world.pos.y + 20.0f32);
            sp78.z = Rand_CenteredFloat(10.0f32) + (*this).actor.world.pos.z;
            sp6C.x = Rand_CenteredFloat(3.0f32);
            sp6C.y = Rand_ZeroFloat(2.0f32) * 0.5f32 + 2.0f32;
            sp6C.z = Rand_CenteredFloat(3.0f32);
            sp60.x = 0.0f32;
            sp60.z = sp60.x;
            sp60.y = -0.15f32;
            func_80B131B8(this, &mut sp78, &mut sp6C, &mut sp60,
                          Rand_ZeroFloat(8.0f32) + 8.0f32);
            i += 1
        }
        (*this).unk_2A0 = 0 as libc::c_int as s16
    }
    ...
    if (*this).unk_262 as libc::c_int == 0 as libc::c_int {
        if (*this).actionFunc ==
               Some(func_80B11E78 as
                        unsafe extern "C" fn(_: *mut EnSyatekiNiw,
                                             _: *mut GlobalContext) -> ()) {
            (*this).unk_262 = 0x12c as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn SyatekiNiw_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 13 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int +
                 (*this).unk_2BC.x as s16 as libc::c_int) as s16
    }
    if limbIndex == 11 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int +
                 (*this).unk_2B0.z as s16 as libc::c_int) as s16;
        (*rot).y =
            ((*rot).y as libc::c_int +
                 (*this).unk_2B0.y as s16 as libc::c_int) as s16;
        (*rot).z =
            ((*rot).z as libc::c_int +
                 (*this).unk_2B0.x as s16 as libc::c_int) as s16
    }
    if limbIndex == 7 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int +
                 (*this).unk_2A4.z as s16 as libc::c_int) as s16;
        (*rot).y =
            ((*rot).y as libc::c_int +
                 (*this).unk_2A4.y as s16 as libc::c_int) as s16;
        (*rot).z =
            ((*rot).z as libc::c_int +
                 (*this).unk_2A4.x as s16 as libc::c_int) as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSyatekiNiw_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnSyatekiNiw = thisx as *mut EnSyatekiNiw;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B131B8(mut this: *mut EnSyatekiNiw,
                                       mut arg1: *mut Vec3f,
                                       mut arg2: *mut Vec3f,
                                       mut arg3: *mut Vec3f,
                                       mut arg4: f32_0) {
    let mut i: s16 = 0;
    let mut ptr: *mut EnSyatekiNiw_1 =
        &mut *(*this).unk_348.as_mut_ptr().offset(0 as libc::c_int as isize)
            as *mut EnSyatekiNiw_1;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 5 as libc::c_int {
        if (*ptr).unk_00 as libc::c_int == 0 as libc::c_int {
            (*ptr).unk_00 = 1 as libc::c_int as u8_0;
            (*ptr).unk_04 = *arg1;
            (*ptr).unk_10 = *arg2;
            (*ptr).unk_1C = *arg3;
            (*ptr).unk_34 = 0 as libc::c_int as u8_0;
            (*ptr).unk_2C = arg4 / 1000.0f32;
            (*ptr).unk_28 =
                (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int +
                     0x28 as libc::c_int) as s16;
            (*ptr).unk_2A = Rand_ZeroFloat(1000.0f32) as s16;
            return
        }
        i += 1;
        ptr = ptr.offset(1)
...
#[no_mangle]
pub unsafe extern "C" fn func_80B132A8(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s16 = 0;
    let mut ptr: *mut EnSyatekiNiw_1 =
        &mut *(*this).unk_348.as_mut_ptr().offset(0 as libc::c_int as isize)
    ...
    while (i as libc::c_int) < 5 as libc::c_int {
        if (*ptr).unk_00 as libc::c_int != 0 as libc::c_int {
            ...
            (*ptr).unk_34 = (*ptr).unk_34.wrapping_add(1);
            (*ptr).unk_10.x += (*ptr).unk_1C.x;
            (*ptr).unk_10.y += (*ptr).unk_1C.y;
            (*ptr).unk_10.z += (*ptr).unk_1C.z;
            if (*ptr).unk_00 as libc::c_int == 1 as libc::c_int {
                (*ptr).unk_2A += 1;
                Math_ApproachF(&mut (*ptr).unk_10.x, 0.0f32, 1.0f32, 0.05f32);
                Math_ApproachF(&mut (*ptr).unk_10.z, 0.0f32, 1.0f32, 0.05f32);
                if (*ptr).unk_10.y < -0.5f32 { (*ptr).unk_10.y = 0.5f32 }
                (*ptr).unk_30 =
                    Math_SinS(((*ptr).unk_2A as libc::c_int *
                                   3000 as libc::c_int) as s16) *
                        3.14159265358979323846f32 * 0.2f32;
                if ((*ptr).unk_28 as libc::c_int) <
                       (*ptr).unk_34 as libc::c_int {
                    (*ptr).unk_00 = 0 as libc::c_int as u8_0
                }
            }
        }
        i += 1;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B13464(mut this: *mut EnSyatekiNiw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_syateki_niw.c\x00" as *const u8 as
                        *const libc::c_char, 1234 as libc::c_int);
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_en_syateki_niw.c\x00" as *const u8 as
                         *const libc::c_char, 1257 as libc::c_int);
}
