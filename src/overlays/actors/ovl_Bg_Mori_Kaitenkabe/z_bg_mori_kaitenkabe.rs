...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriKaitenkabeDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriKaitenkabeCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriKaitenkabe {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriKaitenkabeActionFunc,
    pub timer: s32,
    pub rotDirection: f32_0,
    pub rotSpeed: f32_0,
    pub rotYdeg: f32_0,
    pub lockedPlayerPos: Vec3f,
    pub moriTexObjIndex: s8,
}
pub type BgMoriKaitenkabeActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriKaitenkabe,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Mori_Kaitenkabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_KAITENKABE as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriKaitenkabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriKaitenkabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriKaitenkabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriKaitenkabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_CrossProduct(mut dest: *mut Vec3f,
                                                       mut v1: *mut Vec3f,
                                                       mut v2: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriKaitenkabe = thisx as *mut BgMoriKaitenkabe;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    // "Forest Temple object 【Rotating Wall (arg_data: 0x% 04x)】 appears"
    osSyncPrintf(b"\xe2\x97\xaf\xe2\x97\xaf\xe2\x97\xaf\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf\xe3\x82\xaa\xe3\x83\x96\xe3\x82\xb8\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe3\x80\x90\xe5\x9b\x9e\xe8\xbb\xa2\xe5\xa3\x81(arg_data : 0x%04x)\xe3\x80\x91\xe5\x87\xba\xe7\x8f\xbe \n\x00"
    ...
    CollisionHeader_GetVirtual(&mut gMoriKaitenkabeCol as *mut CollisionHeader
    ...
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        ...
        osSyncPrintf(b"\xe3\x80\x90\xe5\x9b\x9e\xe8\xbb\xa2\xe5\xa3\x81\xe3\x80\x91 \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x8d\xb1\xe9\x99\xba\xef\xbc\x81(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_mori_kaitenkabe.c\x00" as *const u8 as
                         *const libc::c_char, 176 as libc::c_int);
    } else {
        (*this).actionFunc =
            Some(BgMoriKaitenkabe_WaitForMoriTex as
                     unsafe extern "C" fn(_: *mut BgMoriKaitenkabe,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriKaitenkabe = thisx as *mut BgMoriKaitenkabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_WaitForMoriTex(mut this:
                                                             *mut BgMoriKaitenkabe,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        (*this).dyna.actor.draw =
            Some(BgMoriKaitenkabe_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_SetupWait(mut this:
                                                        *mut BgMoriKaitenkabe) {
    (*this).actionFunc =
        Some(BgMoriKaitenkabe_Wait as
                 unsafe extern "C" fn(_: *mut BgMoriKaitenkabe,
                                      _: *mut GlobalContext) -> ());
    (*this).timer = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Wait(mut this:
                                                   *mut BgMoriKaitenkabe,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut push: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut leverArm: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut torque: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if (*this).dyna.unk_150 > 0.001f32 {
        (*this).timer += 1;
        if (*this).timer > 28 as libc::c_int &&
            ...
            Math_Vec3f_Copy(&mut (*this).lockedPlayerPos,
                            &mut (*player).actor.world.pos);
            push.x = Math_SinS((*this).dyna.unk_158);
            push.y = 0.0f32;
            push.z = Math_CosS((*this).dyna.unk_158);
            leverArm.x =
                (*this).dyna.actor.world.pos.x - (*player).actor.world.pos.x;
            leverArm.y = 0.0f32;
            leverArm.z =
                (*this).dyna.actor.world.pos.z - (*player).actor.world.pos.z;
            BgMoriKaitenkabe_CrossProduct(&mut torque, &mut push,
                                          &mut leverArm);
            (*this).rotDirection =
                if torque.y > 0.0f32 { 1.0f32 } else { -1.0f32 }
        }
    } else { (*this).timer = 0 as libc::c_int }
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_SetupRotate(mut this:
                                                          *mut BgMoriKaitenkabe) {
    (*this).actionFunc =
        Some(BgMoriKaitenkabe_Rotate as
                 unsafe extern "C" fn(_: *mut BgMoriKaitenkabe,
                                      _: *mut GlobalContext) -> ());
    (*this).rotSpeed = 0.0f32;
    (*this).rotYdeg = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Rotate(mut this:
                                                     *mut BgMoriKaitenkabe,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut player: *mut Player =
    ...
    let mut rotY: s16 = 0;
    Math_StepToF(&mut (*this).rotSpeed, 0.6f32, 0.02f32);
    if Math_StepToF(&mut (*this).rotYdeg, (*this).rotDirection * 45.0f32,
                    (*this).rotSpeed) != 0 {
        BgMoriKaitenkabe_SetupWait(this);
        func_8002DF54(globalCtx, thisx, 7 as libc::c_int as u8_0);
        if (*this).rotDirection > 0.0f32 {
            (*thisx).home.rot.y =
                ((*thisx).home.rot.y as libc::c_int + 0x2000 as libc::c_int)
                    as s16
        } else {
            (*thisx).home.rot.y =
                ((*thisx).home.rot.y as libc::c_int - 0x2000 as libc::c_int)
        ...
        (*thisx).shape.rot.y = (*thisx).home.rot.y;
        (*thisx).world.rot.y = (*thisx).shape.rot.y;
        func_800788CC(0x2893 as libc::c_int as u16_0);
    } else {
        rotY =
            ((*this).rotYdeg *
                 (0x10000 as libc::c_int as libc::c_float / 360.0f32)) as s16;
        (*thisx).shape.rot.y =
            ((*thisx).home.rot.y as libc::c_int + rotY as libc::c_int) as s16;
        (*thisx).world.rot.y = (*thisx).shape.rot.y;
        func_800788CC((0x2883 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    if fabsf((*this).dyna.unk_150) > 0.001f32 {
        (*this).dyna.unk_150 = 0.0f32;
    ...
    Math_Vec3f_Copy(&mut (*player).actor.world.pos,
                    &mut (*this).lockedPlayerPos);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriKaitenkabe = thisx as *mut BgMoriKaitenkabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriKaitenkabe_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriKaitenkabe = thisx as *mut BgMoriKaitenkabe;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gMoriKaitenkabeDL.as_mut_ptr() as libc::c_uint;
