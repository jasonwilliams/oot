...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsHahen_SpawnBurst(globalCtx: *mut GlobalContext,
                                pos: *mut Vec3f, burstScale: f32_0,
                                unused: s16, scale: s16, randScaleRange: s16,
                                count: s16, objId: s16, life: s16,
                                dList: *mut Gfx);
    #[no_mangle]
    ...
    fn Lights_PointGlowSetInfo(info: *mut LightInfo, x: s16, y: s16, z: s16,
                               r: u8_0, g: u8_0, b: u8_0, radius: s16);
    #[no_mangle]
    fn Lights_PointSetColorAndRadius(info: *mut LightInfo, r: u8_0, g: u8_0,
                                     b: u8_0, radius: s16);
    #[no_mangle]
    ...
    fn Gfx_TwoTexScroll(gfxCtx: *mut GraphicsContext, tile1: s32, x1: u32_0,
     ...
     -> *mut Gfx;
    #[no_mangle]
    fn Gfx_EnvColor(gfxCtx: *mut GraphicsContext, r: s32, g: s32, b: s32,
                    a: s32) -> *mut Gfx;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gPoeFieldDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFieldFleeAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFieldFloatAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFieldAppearAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFieldDisappearAnim: AnimationHeader;
    #[no_mangle]
    static mut gBigPoeSoulTex: [u64_0; 0];
    #[no_mangle]
    static mut gPoeFieldSoulTex: [u64_0; 0];
    #[no_mangle]
    static mut gPoeFieldSoulDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeFieldLanternDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeFieldLanternTopDL: [Gfx; 0];
    #[no_mangle]
    static mut gBigPoeCloakDL: [Gfx; 0];
    #[no_mangle]
    static mut gBigPoeFaceDL: [Gfx; 0];
    #[no_mangle]
    static mut gBigPoeBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeFieldBurnDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeFieldSkel: SkeletonHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPoField {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnPoFieldActionFunc,
    pub unk_194: u8_0,
    pub spawnFlagIndex: u8_0,
    pub actionTimer: s16,
    pub flameRotation: s16,
    pub flameTimer: s16,
    pub jointTable: [Vec3s; 10],
    pub morphTable: [Vec3s; 10],
    pub lightColor: Color_RGBA8,
    pub soulColor: Color_RGBA8,
    pub scaleModifier: f32_0,
    pub flameScale: f32_0,
    pub flamePosition: Vec3f,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
    pub collider: ColliderCylinder,
    pub flameCollider: ColliderCylinder,
}
pub type EnPoFieldActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPoField, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const EN_PO_FIELD_BIG: C2RustUnnamed_24 = 1;
pub const EN_PO_FIELD_SMALL: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPoFieldInfo {
    pub primColor: Color_RGB8,
    pub lightColor: Color_RGB8,
    pub envColor: Color_RGB8,
    pub unk_9: s8,
    pub soulTexture: *mut libc::c_void,
}
#[no_mangle]
pub static mut En_Po_Field_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PO_FIELD as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_PO_FIELD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnPoField>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoField_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoField_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80AD7080: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80AD70AC: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut D_80AD70D8: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 4 as libc::c_int as u8_0,
                                   cylRadius: 25 as libc::c_int as s16,
                                   cylHeight: 50 as libc::c_int as s16,
                                   mass: 40 as libc::c_int as u8_0,};
        init
    };
...
static mut sNumSpawned: s32 = 0 as libc::c_int;
static mut sFieldMiddle: Vec3f =
    { let mut init = Vec3f{x: -1000.0f32, y: 0.0f32, z: 6500.0f32,}; init };
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
static mut D_80AD7114: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 3.0f32, z: 0.0f32,}; init };
static mut D_80AD7120: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut sPoFieldInfo: [EnPoFieldInfo; 2] =
    unsafe {
        [{
             let mut init =
                 EnPoFieldInfo{primColor:
                                   {
                                       let mut init =
                                           Color_RGB8{r:
                                                          255 as libc::c_int
                               ...
                               unk_9: 248 as libc::c_int as s8,
                               soulTexture:
                                   gPoeFieldSoulTex.as_ptr() as *mut _ as
                                       *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 EnPoFieldInfo{primColor:
                               ...
                               unk_9: 241 as libc::c_int as s8,
                               soulTexture:
                                   gBigPoeSoulTex.as_ptr() as *mut _ as
                                       *mut libc::c_void,};
             init
         }]
    };
static mut D_80AD714C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 1400.0f32, z: 0.0f32,}; init };
static mut sSpawnPositions: [Vec3s; 10] = [Vec3s{x: 0, y: 0, z: 0,}; 10];
static mut sSpawnSwitchFlags: [u8_0; 10] = [0; 10];
static mut sLimb7Mtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    let mut pad: s32 = 0;
    if sNumSpawned != 10 as libc::c_int {
        sSpawnPositions[sNumSpawned as usize].x =
            (*this).actor.world.pos.x as s16;
        sSpawnPositions[sNumSpawned as usize].y =
            (*this).actor.world.pos.y as s16;
        sSpawnPositions[sNumSpawned as usize].z =
            (*this).actor.world.pos.z as s16;
        sSpawnSwitchFlags[sNumSpawned as usize] =
            ((*this).actor.params as libc::c_int & 0xff as libc::c_int) as
                u8_0;
        sNumSpawned += 1
    }
    if sNumSpawned >= 2 as libc::c_int {
        (*this).actor.params = 0xff as libc::c_int as s16;
        Actor_Kill(&mut (*this).actor);
        return
    }
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gPoeFieldSkel,
                   &mut gPoeFieldFloatAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 10 as libc::c_int);
    Collider_InitCylinder(globalCtx, &mut (*this).collider);
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut D_80AD7080);
    Collider_InitCylinder(globalCtx, &mut (*this).flameCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).flameCollider,
                         &mut (*this).actor, &mut D_80AD70AC);
    ...
    (*this).lightNode =
        LightContext_InsertLight(globalCtx, &mut (*globalCtx).lightCtx,
                                 &mut (*this).lightInfo);
    Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                            (*this).actor.home.pos.x as s16,
                            (*this).actor.home.pos.y as s16,
                            (*this).actor.home.pos.z as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    if (*this).actor.params as libc::c_int != 0xff as libc::c_int {
        LightContext_RemoveLight(globalCtx, &mut (*globalCtx).lightCtx,
                                 (*this).lightNode);
        Collider_DestroyCylinder(globalCtx, &mut (*this).flameCollider);
        Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupWaitForSpawn(mut this: *mut EnPoField,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    (*this).actor.update =
        Some(EnPoField_Update as
    ...
    Lights_PointSetColorAndRadius(&mut (*this).lightInfo,
                                  0 as libc::c_int as u8_0,
                                  0 as libc::c_int as u8_0,
                                  0 as libc::c_int as u8_0,
                                  0 as libc::c_int as s16);
    (*this).actionTimer = 200 as libc::c_int as s16;
    ...
    (*this).collider.base.ocFlags1 =
        ((1 as libc::c_int) << 0 as libc::c_int |
             ((1 as libc::c_int) << 3 as libc::c_int |
                  (1 as libc::c_int) << 4 as libc::c_int |
                  (1 as libc::c_int) << 5 as libc::c_int)) as u8_0;
    (*this).actor.colChkInfo.health = D_80AD70D8.health;
    (*this).actor.gravity = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actionFunc =
        Some(EnPoField_WaitForSpawn as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupAppear(mut this: *mut EnPoField) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gPoeFieldAppearAnim);
    (*this).actor.draw =
        Some(EnPoField_Draw as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).lightColor.r = 255 as libc::c_int as u8_0;
    (*this).lightColor.g = 255 as libc::c_int as u8_0;
    (*this).lightColor.b = 210 as libc::c_int as u8_0;
    (*this).lightColor.a = 0 as libc::c_int as u8_0;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
    (*this).actor.shape.yOffset = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3873 as libc::c_int as u16_0);
    (*this).actor.home.pos.y = (*this).actor.world.pos.y;
    if (*this).actor.params as libc::c_int == EN_PO_FIELD_BIG as libc::c_int {
        (*this).actor.speedXZ = 12.0f32;
        (*this).collider.dim.radius = 35 as libc::c_int as s16;
        (*this).collider.dim.height = 100 as libc::c_int as s16;
        (*this).collider.dim.yShift = 10 as libc::c_int as s16;
        (*this).actor.shape.shadowScale = 45.0f32;
        (*this).scaleModifier = 0.014f32;
        (*this).actor.naviEnemyId = 0x5a as libc::c_int as u8_0
    } else {
        ...
        (*this).actor.shape.shadowScale = 37.0f32;
        (*this).scaleModifier = 0.01f32;
        (*this).actor.naviEnemyId = 0x5c as libc::c_int as u8_0
    }
    (*this).actionFunc =
        Some(EnPoField_Appear as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupCirclePlayer(mut this: *mut EnPoField,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gPoeFieldFloatAnim);
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    ...
    if (*this).actionFunc !=
           Some(EnPoField_Damage as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actionTimer = 600 as libc::c_int as s16;
        (*this).unk_194 = 32 as libc::c_int as u8_0
    }
    (*this).actionFunc =
        Some(EnPoField_CirclePlayer as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupFlee(mut this: *mut EnPoField) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gPoeFieldFleeAnim,
                          -5.0f32);
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(EnPoField_Flee as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 12.0f32;
    if (*this).actionFunc !=
        ...
        (*this).actor.world.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x8000 as libc::c_int)
                as s16;
        (*this).actionTimer = 2000 as libc::c_int as s16;
        (*this).unk_194 = 32 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupDamage(mut this: *mut EnPoField) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gPoeFieldDamagedAnim, -6.0f32);
    if (*(*this).collider.info.acHitInfo).toucher.dmgFlags &
           0x1f824 as libc::c_int as libc::c_uint != 0 {
        (*this).actor.world.rot.y = (*(*this).collider.base.ac).world.rot.y
    } else {
        (*this).actor.world.rot.y =
            (Actor_WorldYawTowardActor(&mut (*this).actor,
                                       (*this).collider.base.ac) as
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupDeath(mut this: *mut EnPoField) {
    (*this).actionTimer = 0 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actor.naviEnemyId = 0xff as libc::c_int as u8_0;
    if (*this).flameTimer as libc::c_int >= 20 as libc::c_int {
        (*this).flameTimer = 19 as libc::c_int as s16
    }
    (*this).actionFunc =
        Some(EnPoField_Death as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupDisappear(mut this: *mut EnPoField) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gPoeFieldDisappearAnim,
                          -6.0f32);
    (*this).actionTimer = 16 as libc::c_int as s16;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int |
                   (1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ec as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3874 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoField_Disappear as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupSoulIdle(mut this: *mut EnPoField,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    (*this).actor.update =
        Some(EnPoField_UpdateDead as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actor.draw =
        Some(EnPoField_DrawSoul as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actor.shape.shadowDraw = None;
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).actor.gravity = -1.0f32;
    (*this).actor.shape.yOffset = 1500.0f32;
    (*this).actor.shape.rot.x = -(0x8000 as libc::c_int) as s16;
    (*this).actionTimer = 60 as libc::c_int as s16;
    (*this).actor.world.pos.y -= 15.0f32;
    Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                         &mut (*this).actor,
                         ACTORCAT_MISC as libc::c_int as u8_0);
    (*this).actionFunc =
        Some(EnPoField_SoulIdle as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AD42B0(mut this: *mut EnPoField) {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x28e0 as libc::c_int as u16_0);
    if (*this).actor.params as libc::c_int == EN_PO_FIELD_BIG as libc::c_int {
        func_80078884(0x4807 as libc::c_int as u16_0);
    }
    (*this).actionFunc =
        Some(func_80AD587C as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AD4384(mut this: *mut EnPoField) {
    (*this).actor.home.pos.y = (*this).actor.world.pos.y;
    Actor_SetFocus(&mut (*this).actor, -10.0f32);
    (*this).collider.dim.radius = 13 as libc::c_int as s16;
    (*this).collider.dim.height = 30 as libc::c_int as s16;
    (*this).collider.dim.yShift = 0 as libc::c_int as s16;
    (*this).collider.dim.pos.x = (*this).actor.world.pos.x as s16;
    (*this).collider.dim.pos.y = ((*this).actor.world.pos.y - 20.0f32) as s16;
    (*this).collider.dim.pos.z = (*this).actor.world.pos.z as s16;
    (*this).collider.base.ocFlags1 =
        ((1 as libc::c_int) << 0 as libc::c_int |
             (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
    (*this).actor.textId = 0x5005 as libc::c_int as u16_0;
    (*this).actionTimer = 400 as libc::c_int as s16;
    (*this).unk_194 = 32 as libc::c_int as u8_0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(func_80AD58D4 as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupSoulDisappear(mut this:
                                                          *mut EnPoField) {
    (*this).actionFunc =
        Some(EnPoField_SoulDisappear as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetupInteractWithSoul(mut this:
                                                             *mut EnPoField) {
    (*this).actionFunc =
        Some(EnPoField_SoulInteract as
                 unsafe extern "C" fn(_: *mut EnPoField,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.home.pos.y = (*this).actor.world.pos.y - 15.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_CorrectYPos(mut this: *mut EnPoField,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
        (*this).unk_194 = 32 as libc::c_int as u8_0
    }
    if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
        (*this).unk_194 =
            ((*this).unk_194 as libc::c_int - 1 as libc::c_int) as u8_0
    }
    if (*this).actor.floorHeight == -32000.0f32 {
        EnPoField_SetupDisappear(this);
        return
    }
    Math_ApproachF(&mut (*this).actor.home.pos.y,
                   (if (*player).actor.world.pos.y > (*this).actor.floorHeight
                       {
                        (*player).actor.world.pos.y
                    } else { (*this).actor.floorHeight }) + 13.0f32, 0.2f32,
                   5.0f32);
    (*this).actor.world.pos.y =
        Math_SinS(((*this).unk_194 as libc::c_int * 0x800 as libc::c_int) as
                      s16) * 13.0f32 + (*this).actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SetFleeSpeed(mut this: *mut EnPoField,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> f32_0 {
    let mut player: *mut Player =
    ...
    let mut speed: f32_0 =
        if (*player).stateFlags1 & 0x800000 as libc::c_int as libc::c_uint !=
               0 && !(*player).rideActor.is_null() {
            (*(*player).rideActor).speedXZ
        } else { 12.0f32 };
    if (*this).actor.xzDistToPlayer < 300.0f32 {
        (*this).actor.speedXZ = speed * 1.5f32 + 2.0f32
    } else if (*this).actor.xzDistToPlayer < 400.0f32 {
        (*this).actor.speedXZ = speed * 1.25f32 + 2.0f32
    } else if (*this).actor.xzDistToPlayer < 500.0f32 {
        (*this).actor.speedXZ = speed + 2.0f32
    } else { (*this).actor.speedXZ = 12.0f32 }
    (*this).actor.speedXZ =
        if (*this).actor.speedXZ < 12.0f32 {
            12.0f32
        } else { (*this).actor.speedXZ };
    panic!("Reached end of non-void function without returning");
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_WaitForSpawn(mut this: *mut EnPoField,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut spawnDist: f32_0 = 0.;
    let mut i: s32 = 0;
    let mut bgId: s32 = 0;
    ...
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        i = 0 as libc::c_int;
        while i < sNumSpawned {
            if fabsf(sSpawnPositions[i as usize].x as libc::c_int as
                         libc::c_float - (*player).actor.world.pos.x) <
                   150.0f32 &&
                   fabsf(sSpawnPositions[i as usize].z as libc::c_int as
                             libc::c_float - (*player).actor.world.pos.z) <
                       150.0f32 {
                if Flags_GetSwitch(globalCtx,
                                   sSpawnSwitchFlags[i as usize] as s32) != 0
                   {
                    if (*player).stateFlags1 &
                        ...
                        (*this).actor.params =
                            EN_PO_FIELD_SMALL as libc::c_int as s16;
                        spawnDist = 300.0f32
                    }
                              ...
                              Rand_ZeroOne() < 0.4f32 {
                    (*this).actor.params =
                        EN_PO_FIELD_BIG as libc::c_int as s16;
                    (*this).spawnFlagIndex = i as u8_0;
                    spawnDist = 480.0f32
                } else {
                    (*this).actor.params =
                        EN_PO_FIELD_SMALL as libc::c_int as s16;
                ...
                (*this).actor.world.pos.x =
                    Math_SinS((*player).actor.shape.rot.y) * spawnDist +
                        (*player).actor.world.pos.x;
                (*this).actor.world.pos.z =
                    Math_CosS((*player).actor.shape.rot.y) * spawnDist +
                        (*player).actor.world.pos.z;
                (*this).actor.world.pos.y =
                    (*player).actor.world.pos.y + 1000.0f32;
                (*this).actor.world.pos.y =
                    BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                                &mut (*this).actor.floorPoly,
                                                &mut bgId, &mut (*this).actor,
                                                &mut (*this).actor.world.pos);
                if (*this).actor.world.pos.y != -32000.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Appear(mut this: *mut EnPoField,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).lightColor.a = 255 as libc::c_int as u8_0;
        Actor_SetScale(&mut (*this).actor, (*this).scaleModifier);
        if (*this).actor.params as libc::c_int ==
               EN_PO_FIELD_BIG as libc::c_int {
            EnPoField_SetupFlee(this);
        } else { EnPoField_SetupCirclePlayer(this, globalCtx); }
    } else if (*this).skelAnime.curFrame > 10.0f32 {
        (*this).lightColor.a =
            (((*this).skelAnime.curFrame - 10.0f32) * 0.05f32 * 255.0f32) as
                u8_0
    } else {
        (*this).actor.scale.x += (*this).scaleModifier * 0.1f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_CirclePlayer(mut this: *mut EnPoField,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut temp_v1: s32 = 16 as libc::c_int - (*this).unk_194 as libc::c_int;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
    }
    if (if temp_v1 >= 0 as libc::c_int { temp_v1 } else { -temp_v1 }) <
           16 as libc::c_int {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_float +
                 512.0f32 *
                     fabsf(Math_SinS(((*this).unk_194 as libc::c_int *
                                          0x800 as libc::c_int) as s16))) as
                s16
    }
    Math_ApproachF(&mut (*this).scaleModifier, 180.0f32, 0.5f32, 10.0f32);
    Math_ApproachF(&mut (*this).actor.home.pos.x, (*player).actor.world.pos.x,
                   0.2f32, 6.0f32);
    Math_ApproachF(&mut (*this).actor.home.pos.z, (*player).actor.world.pos.z,
                   0.2f32, 6.0f32);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.world.rot.y, 1 as libc::c_int as s16,
                       0x800 as libc::c_int as s16,
                       0x200 as libc::c_int as s16);
    if (*this).actor.home.pos.x - (*player).actor.world.pos.x > 100.0f32 {
        (*this).actor.home.pos.x = (*player).actor.world.pos.x + 100.0f32
    } else if (*this).actor.home.pos.x - (*player).actor.world.pos.x <
                  -100.0f32 {
        (*this).actor.home.pos.x = (*player).actor.world.pos.x + -100.0f32
    }
    if (*this).actor.home.pos.z - (*player).actor.world.pos.z > 100.0f32 {
        (*this).actor.home.pos.z = (*player).actor.world.pos.z + 100.0f32
    } else if (*this).actor.home.pos.z - (*player).actor.world.pos.z <
                  -100.0f32 {
        (*this).actor.home.pos.z = (*player).actor.world.pos.z + -100.0f32
    }
    (*this).actor.world.pos.x =
        (*this).actor.home.pos.x -
            Math_SinS((*this).actor.world.rot.y) * (*this).scaleModifier;
    (*this).actor.world.pos.z =
        (*this).actor.home.pos.z -
            Math_CosS((*this).actor.world.rot.y) * (*this).scaleModifier;
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnPoField_SetupDisappear(this);
    } else { EnPoField_SpawnFlame(this); }
    EnPoField_CorrectYPos(this, globalCtx);
    func_8002F974(&mut (*this).actor,
                  (0x3871 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Flee(mut this: *mut EnPoField,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_WorldDistXZToPoint(&mut (*this).actor, &mut sFieldMiddle) >
           3000.0f32 {
        phi_t0 =
            (((*this).actor.yawTowardsPlayer as libc::c_int -
                  Actor_WorldYawTowardPoint(&mut (*this).actor,
                                            &mut sFieldMiddle) as libc::c_int
                  - 0x8000 as libc::c_int) as s16 as libc::c_int as
                 libc::c_float * 0.2f32) as s16
    } else { phi_t0 = 0 as libc::c_int as s16 }
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
                   ((*this).actor.yawTowardsPlayer as libc::c_int -
                        phi_t0 as libc::c_int) as s16,
                   6 as libc::c_int as s16, 0x400 as libc::c_int as s16);
    EnPoField_SetFleeSpeed(this, globalCtx);
    (*this).actor.world.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x8000 as libc::c_int) as
            s16;
    temp_f6 =
        Math_SinS(((*this).actionTimer as libc::c_int * 0x800 as libc::c_int)
                      as s16) * 3.0f32;
    (*this).actor.world.pos.x -=
        temp_f6 * Math_CosS((*this).actor.shape.rot.y);
    (*this).actor.world.pos.z +=
        temp_f6 * Math_SinS((*this).actor.shape.rot.y);
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int ||
           (*this).actor.xzDistToPlayer > 1500.0f32 {
        EnPoField_SetupDisappear(this);
    } else { EnPoField_CorrectYPos(this, globalCtx); }
    func_8002F974(&mut (*this).actor,
                  (0x3872 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Damage(mut this: *mut EnPoField,
                                          mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.5f32);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Death(mut this: *mut EnPoField,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actionTimer += 1;
    if ((*this).actionTimer as libc::c_int) < 8 as libc::c_int {
        if ((*this).actionTimer as libc::c_int) < 5 as libc::c_int {
            sp6C.y =
                Math_SinS(((*this).actionTimer as libc::c_int *
                               0x1000 as libc::c_int - 0x4000 as libc::c_int)
                              as s16) * 23.0f32 +
                    ((*this).actor.world.pos.y + 40.0f32);
            sp68 =
                Math_CosS(((*this).actionTimer as libc::c_int *
                               0x1000 as libc::c_int - 0x4000 as libc::c_int)
                              as s16) * 23.0f32;
            sp6C.x =
                Math_SinS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           as
                                                                           usize])
                               as libc::c_int + 0x4800 as libc::c_int) as s16)
                    * sp68 + (*this).actor.world.pos.x;
            sp6C.z =
                Math_CosS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           as
                                                                           usize])
                               as libc::c_int + 0x4800 as libc::c_int) as s16)
                    * sp68 + (*this).actor.world.pos.z
        } else {
            sp6C.y =
                (*this).actor.world.pos.y + 40.0f32 +
                    15.0f32 *
                        ((*this).actionTimer as libc::c_int -
            ...
            sp6C.x =
                Math_SinS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           ...
                                                                           usize])
                               as libc::c_int + 0x4800 as libc::c_int) as s16)
                    * 23.0f32 + (*this).actor.world.pos.x;
            sp6C.z =
                Math_CosS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           as
                                                                           usize])
                               as libc::c_int + 0x4800 as libc::c_int) as s16)
                    * 23.0f32 + (*this).actor.world.pos.z
        }
        EffectSsDeadDb_Spawn(globalCtx, &mut sp6C, &mut D_80AD7114,
                             &mut D_80AD7120,
                             ((*this).actionTimer as libc::c_int *
                                  10 as libc::c_int + 80 as libc::c_int) as
        ...
        sp6C.x =
            (*this).actor.world.pos.x + (*this).actor.world.pos.x - sp6C.x;
        sp6C.z =
            (*this).actor.world.pos.z + (*this).actor.world.pos.z - sp6C.z;
        EffectSsDeadDb_Spawn(globalCtx, &mut sp6C, &mut D_80AD7114,
                             &mut D_80AD7120,
                             ((*this).actionTimer as libc::c_int *
                                  10 as libc::c_int + 80 as libc::c_int) as
        ...
        EffectSsDeadDb_Spawn(globalCtx, &mut sp6C, &mut D_80AD7114,
                             ...
                             1 as libc::c_int as s16, 9 as libc::c_int,
                             1 as libc::c_int as s16);
        if (*this).actionTimer as libc::c_int == 1 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3878 as libc::c_int as u16_0);
        }
    } else if (*this).actionTimer as libc::c_int == 28 as libc::c_int {
        EnPoField_SetupSoulIdle(this, globalCtx);
    } else if (*this).actionTimer as libc::c_int >= 19 as libc::c_int {
        temp_f0 =
            (28 as libc::c_int - (*this).actionTimer as libc::c_int) as
                libc::c_float * 0.001f32;
        (*this).actor.world.pos.y += 5.0f32;
        (*this).actor.scale.z = temp_f0;
        (*this).actor.scale.y = temp_f0;
        (*this).actor.scale.x = temp_f0
    }
    if (*this).actionTimer as libc::c_int == 18 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3877 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Disappear(mut this: *mut EnPoField,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x1000 as libc::c_int) as
            s16;
    (*this).lightColor.a =
        ((*this).actionTimer as libc::c_int as libc::c_float * 15.9375f32) as
            u8_0;
    (*this).actor.shape.shadowAlpha = (*this).lightColor.a;
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnPoField_SetupWaitForSpawn(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SoulIdle(mut this: *mut EnPoField,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
                                 6.0f32, 0 as libc::c_int as s16,
                                 1 as libc::c_int as s16,
                                 1 as libc::c_int as s16,
                                 15 as libc::c_int as s16,
                                 OBJECT_PO_FIELD as libc::c_int as s16,
                                 10 as libc::c_int as s16,
                                 gPoeFieldLanternDL.as_mut_ptr());
        func_80AD42B0(this);
    } else if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnPoField_SetupWaitForSpawn(this, globalCtx);
    }
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32, 10.0f32,
                            10.0f32, 4 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SoulUpdateProperties(mut this:
                                                            *mut EnPoField,
                                                        mut arg1: s32) {
    let mut info: *mut EnPoFieldInfo =
        &mut *sPoFieldInfo.as_mut_ptr().offset((*this).actor.params as isize)
            as *mut EnPoFieldInfo;
    let mut multiplier: f32_0 = 0.;
    (*this).lightColor.a =
        if (*this).lightColor.a as libc::c_int + arg1 < 0 as libc::c_int {
            0 as libc::c_int
        } else if (*this).lightColor.a as libc::c_int + arg1 >
                      255 as libc::c_int {
            255 as libc::c_int
        } else { ((*this).lightColor.a as libc::c_int) + arg1 } as u8_0;
    if arg1 < 0 as libc::c_int {
        multiplier =
            (*this).lightColor.a as libc::c_int as libc::c_float *
                (1.0f32 / 255 as libc::c_int as libc::c_float);
        (*this).actor.scale.z =
            0.0056000003f32 * multiplier + 0.0014000001f32;
        (*this).actor.scale.x = (*this).actor.scale.z;
        (*this).actor.scale.y = 0.007f32 - 0.007f32 * multiplier + 0.007f32
    } else {
        multiplier = 1.0f32;
        (*this).actor.scale.z =
            (*this).lightColor.a as libc::c_int as libc::c_float *
                (0.007f32 / 255 as libc::c_int as libc::c_float);
    ...
    (*this).lightColor.r =
        ((*info).lightColor.r as libc::c_int as libc::c_float * multiplier) as
            u8_0;
    (*this).lightColor.g =
        ((*info).lightColor.g as libc::c_int as libc::c_float * multiplier) as
            u8_0;
    (*this).lightColor.b =
        ((*info).lightColor.b as libc::c_int as libc::c_float * multiplier) as
            u8_0;
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).actor.world.pos.x as s16,
                              (*this).actor.world.pos.y as s16,
                              (*this).actor.world.pos.z as s16,
                              (*info).lightColor.r, (*info).lightColor.g,
                              (*info).lightColor.b,
                              ((*this).lightColor.a as libc::c_int as
                                   libc::c_float *
                                   (200.0f32 /
...
#[no_mangle]
pub unsafe extern "C" fn func_80AD587C(mut this: *mut EnPoField,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.home.pos.y += 2.0f32;
    EnPoField_SoulUpdateProperties(this, 20 as libc::c_int);
    if (*this).lightColor.a as libc::c_int == 255 as libc::c_int {
        func_80AD4384(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AD58D4(mut this: *mut EnPoField,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
    }
    ...
    (*this).actor.world.pos.y =
        Math_SinS(((*this).unk_194 as libc::c_int * 0x800 as libc::c_int) as
                      s16) * 5.0f32 + (*this).actor.home.pos.y;
    if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
        (*this).unk_194 =
            ((*this).unk_194 as libc::c_int - 1 as libc::c_int) as u8_0
    }
    ...
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              ...
                              (*this).actor.world.pos.y as s16,
                              (*this).actor.world.pos.z as s16,
                              (*this).lightInfo.params.point.color[0 as
                                                                       libc::c_int
                                                                       as
                                                                       usize],
                              (*this).lightInfo.params.point.color[1 as
                                                                       libc::c_int
                                                                       as
                                                                       usize],
                              (*this).lightInfo.params.point.color[2 as
                                                                       libc::c_int
                                                                       as
                                                                       usize],
                              ((*this).lightColor.a as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SoulDisappear(mut this: *mut EnPoField,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    EnPoField_SoulUpdateProperties(this, -(13 as libc::c_int));
    if (*this).lightColor.a as libc::c_int == 0 as libc::c_int {
        EnPoField_SetupWaitForSpawn(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SoulInteract(mut this: *mut EnPoField,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).actor.textId as libc::c_int != 0x5005 as libc::c_int {
        EnPoField_SoulUpdateProperties(this, -(13 as libc::c_int));
    } else {
        func_8002F974(&mut (*this).actor,
                      (0x39e8 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        if Message_ShouldAdvance(globalCtx) != 0 {
            Audio_StopSfxByPosAndId(&mut (*this).actor.projectedPos,
                                    (0x39e8 as libc::c_int -
                                         0x800 as libc::c_int) as u16_0);
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   0 as libc::c_int {
                if Inventory_HasEmptyBottle() != 0 {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3883 as libc::c_int as u16_0);
                    if (*this).actor.params as libc::c_int == 0 as libc::c_int
                       {
                        Item_Give(globalCtx, ITEM_POE as libc::c_int as u8_0);
                        (*this).actor.textId = 0x5008 as libc::c_int as u16_0
                    } else {
                        (*this).actor.textId = 0x508f as libc::c_int as u16_0;
                        Item_Give(globalCtx,
                                  ITEM_BIG_POE as libc::c_int as u8_0);
                        Flags_SetSwitch(globalCtx,
                                        sSpawnSwitchFlags[(*this).spawnFlagIndex
                                                              as usize] as
                                            s32);
                    }
                } else {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x38ec as libc::c_int as u16_0);
                    (*this).actor.textId = 0x5006 as libc::c_int as u16_0
                }
            } else {
                (*this).actor.textId = 0x5007 as libc::c_int as u16_0;
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38ec as libc::c_int as u16_0);
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_TestForDamage(mut this: *mut EnPoField,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                ...
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3876 as libc::c_int as u16_0);
            } else {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3875 as libc::c_int as u16_0);
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_SpawnFlame(mut this: *mut EnPoField) {
    if (*this).flameTimer as libc::c_int == 0 as libc::c_int {
        (*this).flamePosition.x = (*this).lightInfo.params.point.x as f32_0;
        (*this).flamePosition.y = (*this).lightInfo.params.point.y as f32_0;
        (*this).flamePosition.z = (*this).lightInfo.params.point.z as f32_0;
        (*this).flameTimer = 70 as libc::c_int as s16;
        (*this).flameRotation = (*this).actor.shape.rot.y
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_UpdateFlame(mut this: *mut EnPoField,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).flameTimer as libc::c_int != 0 as libc::c_int {
        if (*this).flameTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).flameCollider.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            (*this).flameCollider.base.atFlags =
                ((*this).flameCollider.base.atFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            (*this).flameTimer = 19 as libc::c_int as s16
        }
        if ((*this).flameTimer as libc::c_int) < 20 as libc::c_int {
            Math_StepToF(&mut (*this).flameScale, 0.0f32, 0.00015f32);
            return
        }
        if Math_StepToF(&mut (*this).flameScale, 0.003f32, 0.0006f32) !=
               0 as libc::c_int {
            (*this).flamePosition.x +=
                2.5f32 * Math_SinS((*this).flameRotation);
            (*this).flamePosition.z +=
                2.5f32 * Math_CosS((*this).flameRotation)
        }
        (*this).flameCollider.dim.pos.x = (*this).flamePosition.x as s16;
        (*this).flameCollider.dim.pos.y = (*this).flamePosition.y as s16;
        (*this).flameCollider.dim.pos.z = (*this).flamePosition.z as s16;
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).flameCollider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_DrawFlame(mut this: *mut EnPoField,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if (*this).flameTimer as libc::c_int != 0 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_po_field.c\x00" as *const u8 as
                            *const libc::c_char, 1669 as libc::c_int);
        ...
        (*_g).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             (*globalCtx).gameplayFrames.wrapping_mul(-(20 as
                                                                            libc::c_int)
                                                                          as
                ...
                libc::c_uint;
        sp4C = (*this).flameScale * 85000.0f32;
                ...
                (255 as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            Matrix_Scale((*this).flameScale, (*this).flameScale,
                         (*this).flameScale,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        } else {
                ...
                (sp4C as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            Matrix_Scale((*this).flameScale * 0.7f32 + 0.00090000004f32,
                         0.003f32 - (*this).flameScale + 0.003f32, 0.003f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        }
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gEffFire1DL.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_po_field.c\x00" as *const u8 as
                             *const libc::c_char, 1712 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AD619C(mut this: *mut EnPoField) {
    let mut temp_var: s16 = 0;
    if (*this).actionFunc ==
           Some(EnPoField_Flee as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) {
        (*this).lightColor.r =
            if ((*this).lightColor.r as libc::c_int + 5 as libc::c_int) as s16
                   as libc::c_int > 80 as libc::c_int {
                80 as libc::c_int
            } else {
                ((*this).lightColor.r as libc::c_int + 5 as libc::c_int) as
                    s16 as libc::c_int
            } as u8_0;
        (*this).lightColor.g =
            if ((*this).lightColor.g as libc::c_int + 5 as libc::c_int) as s16
                   as libc::c_int > 255 as libc::c_int {
                255 as libc::c_int
            } else {
                ((*this).lightColor.g as libc::c_int + 5 as libc::c_int) as
                    s16 as libc::c_int
            } as u8_0;
        temp_var =
            ((*this).lightColor.b as libc::c_int + 5 as libc::c_int) as s16;
        (*this).lightColor.b =
            if temp_var as libc::c_int > 225 as libc::c_int {
                225 as libc::c_int
            } else { temp_var as libc::c_int } as u8_0
    } else if (*this).actionFunc ==
                  Some(EnPoField_Damage as
                           unsafe extern "C" fn(_: *mut EnPoField,
                                                _: *mut GlobalContext) -> ())
     {
        if (*this).actor.colorFilterTimer as libc::c_int & 2 as libc::c_int !=
               0 {
            (*this).lightColor.r = 0 as libc::c_int as u8_0;
            (*this).lightColor.g = 0 as libc::c_int as u8_0;
            (*this).lightColor.b = 0 as libc::c_int as u8_0
        } else {
            (*this).lightColor.r = 80 as libc::c_int as u8_0;
            (*this).lightColor.g = 255 as libc::c_int as u8_0;
            (*this).lightColor.b = 225 as libc::c_int as u8_0
        }
    } else {
        (*this).lightColor.r =
            if ((*this).lightColor.r as libc::c_int + 5 as libc::c_int) as s16
        ...
        if (*this).lightColor.b as libc::c_int > 210 as libc::c_int {
            temp_var =
                ((*this).lightColor.b as libc::c_int - 5 as libc::c_int) as
                    s16;
            (*this).lightColor.b =
                if (temp_var as libc::c_int) < 210 as libc::c_int {
                    210 as libc::c_int
                } else { temp_var as libc::c_int } as u8_0
        } else {
            temp_var =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AD6330(mut this: *mut EnPoField) {
    let mut rand: f32_0 = 0.;
    if (*this).actionFunc ==
           Some(EnPoField_Appear as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) &&
           (*this).skelAnime.curFrame < 12.0f32 {
        (*this).soulColor.b =
            (((*this).skelAnime.curFrame * 16.66f32) as s16 as libc::c_int +
                 55 as libc::c_int) as u8_0;
        (*this).soulColor.g = (*this).soulColor.b;
        (*this).soulColor.r = (*this).soulColor.g;
        (*this).soulColor.a =
            ((*this).skelAnime.curFrame * (100.0f32 / 6.0f32)) as u8_0
    } else {
        rand = Rand_ZeroOne();
        (*this).soulColor.r =
            ((rand * 30.0f32) as s16 as libc::c_int + 225 as libc::c_int) as
                u8_0;
        (*this).soulColor.g =
            ((rand * 100.0f32) as s16 as libc::c_int + 155 as libc::c_int) as
                u8_0;
        (*this).soulColor.b =
            ((rand * 160.0f32) as s16 as libc::c_int + 95 as libc::c_int) as
                u8_0;
        (*this).soulColor.a = 200 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    ...
    if (*this).actionFunc !=
           Some(EnPoField_WaitForSpawn as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) {
        Actor_SetFocus(&mut (*this).actor, 42.0f32);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32,
                                27.0f32, 60.0f32, 4 as libc::c_int);
        func_80AD619C(this);
        func_80AD6330(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_OverrideLimbDraw2(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    if (*this).lightColor.a as libc::c_int == 0 as libc::c_int ||
           limbIndex == 7 as libc::c_int ||
           (*this).actionFunc ==
               Some(EnPoField_Death as
                        unsafe extern "C" fn(_: *mut EnPoField,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).actionTimer as libc::c_int >= 2 as libc::c_int {
        *dList = 0 as *mut Gfx
    } else if (*this).actor.params as libc::c_int ==
                  EN_PO_FIELD_BIG as libc::c_int {
        if limbIndex == 1 as libc::c_int {
            *dList = gBigPoeFaceDL.as_mut_ptr()
        } else if limbIndex == 8 as libc::c_int {
            *dList = gBigPoeCloakDL.as_mut_ptr()
        } else if limbIndex == 9 as libc::c_int {
            *dList = gBigPoeBodyDL.as_mut_ptr()
        }
    }
    if (*this).actionFunc ==
           Some(EnPoField_Disappear as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) &&
           limbIndex == 7 as libc::c_int {
        Matrix_Scale((*this).actionTimer as libc::c_int as libc::c_float /
                         16.0f32,
                     (*this).actionTimer as libc::c_int as libc::c_float /
                         16.0f32,
                     (*this).actionTimer as libc::c_int as libc::c_float /
                         16.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_PostLimDraw2(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut rot: *mut Vec3s,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gPoeFieldBurnDL.as_mut_ptr() as libc::c_uint
    }
    if limbIndex == 7 as libc::c_int {
        let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        Matrix_MultVec3f(&mut D_80AD714C, &mut vec);
        if (*this).actionFunc ==
               Some(EnPoField_Death as
                        unsafe extern "C" fn(_: *mut EnPoField,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).actionTimer as libc::c_int >= 19 as libc::c_int &&
               (*this).actor.scale.x != 0.0f32 {
            let mut mtxScale: f32_0 = 0.01f32 / (*this).actor.scale.x;
            Matrix_Scale(mtxScale, mtxScale, mtxScale,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        }
        Matrix_Get(&mut sLimb7Mtx);
        if (*this).actionFunc ==
               Some(EnPoField_Death as
                        unsafe extern "C" fn(_: *mut EnPoField,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).actionTimer as libc::c_int == 27 as libc::c_int {
            (*this).actor.world.pos.x = sLimb7Mtx.c2rust_unnamed.xw;
            (*this).actor.world.pos.y = sLimb7Mtx.c2rust_unnamed.yw;
            (*this).actor.world.pos.z = sLimb7Mtx.c2rust_unnamed.zw
        }
        Lights_PointGlowSetInfo(&mut (*this).lightInfo, vec.x as s16,
                                vec.y as s16, vec.z as s16,
                                (*this).soulColor.r, (*this).soulColor.g,
                                (*this).soulColor.b,
                                ((*this).soulColor.a as libc::c_int as
                                     libc::c_float *
                                     (200.0f32 /
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    let mut info: *mut EnPoFieldInfo =
        &mut *sPoFieldInfo.as_mut_ptr().offset((*this).actor.params as isize)
    ...
    if (*this).actionFunc !=
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_po_field.c\x00" as *const u8 as
                            *const libc::c_char, 1976 as libc::c_int);
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            Gfx_EnvColor((*globalCtx).state.gfxCtx, (*info).envColor.r as s32,
                         (*info).envColor.g as s32, (*info).envColor.b as s32,
                         255 as libc::c_int) as libc::c_uint;
        if (*this).lightColor.a as libc::c_int == 255 as libc::c_int ||
               (*this).lightColor.a as libc::c_int == 0 as libc::c_int {
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                Gfx_EnvColor((*globalCtx).state.gfxCtx,
                             (*this).lightColor.r as s32,
                             (*this).lightColor.g as s32,
                             (*this).lightColor.b as s32,
                             (*this).lightColor.a as s32) as libc::c_uint;
            ...
            (*__gfxCtx).polyOpa.p =
                SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                               ...
                               Some(EnPoField_OverrideLimbDraw2 as
                                        unsafe extern "C" fn(_:
                                                                 *mut GlobalContext,
                                                             _: s32,
                                                             _: *mut *mut Gfx,
                                                             ...
                                                             _: *mut *mut Gfx)
                                            -> s32),
                               Some(EnPoField_PostLimDraw2 as
                                        unsafe extern "C" fn(_:
                                                                 *mut GlobalContext,
                                                             _: s32,
                                                             _: *mut *mut Gfx,
                ...
                SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                               ...
                               Some(EnPoField_PostLimDraw2 as
                                        unsafe extern "C" fn(_:
                                            ...
                                            -> ()),
                               &mut (*this).actor as *mut Actor as
                                   *mut libc::c_void, (*__gfxCtx).polyXlu.p)
        }
        ...
        (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
        let mut _g_5: *mut Gfx = fresh14;
        (*_g_5).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_5).words.w1 =
            ((*this).soulColor.r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*this).soulColor.g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                ((*this).soulColor.b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        Matrix_Put(&mut sLimb7Mtx);
        let fresh15 = (*__gfxCtx).polyOpa.p;
        (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
        let mut _g_6: *mut Gfx = fresh15;
        (*_g_6).words.w0 =
            (0xda as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_7).words.w1 = gPoeFieldLanternDL.as_mut_ptr() as libc::c_uint;
        let fresh17 = (*__gfxCtx).polyOpa.p;
        (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
        let mut _g_8: *mut Gfx = fresh17;
        (*_g_8).words.w0 =
            (0xde as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_8).words.w1 = gPoeFieldLanternTopDL.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_po_field.c\x00" as *const u8 as
                             *const libc::c_char, 2039 as libc::c_int);
    }
    EnPoField_DrawFlame(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoField_UpdateDead(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoField_DrawSoul(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnPoField = thisx as *mut EnPoField;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_po_field.c\x00" as *const u8 as
                        *const libc::c_char, 2077 as libc::c_int);
    if (*this).actionFunc ==
           Some(EnPoField_SoulIdle as
                    unsafe extern "C" fn(_: *mut EnPoField,
                                         _: *mut GlobalContext) -> ()) {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = gPoeFieldLanternDL.as_mut_ptr() as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gPoeFieldLanternTopDL.as_mut_ptr() as libc::c_uint
    } else {
        func_80093D84((*globalCtx).state.gfxCtx);
        ...
        (*_g_4).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             (*globalCtx).gameplayFrames.wrapping_mul((*info).unk_9
                                                                          as
                                                                          libc::c_uint)
                                 & 0x1ff as libc::c_int as libc::c_uint,
                             0x20 as libc::c_int, 0x80 as libc::c_int) as
                libc::c_uint;
        ...
        (*_g_5).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_5).words.w1 =
            gSegments[(((*info).soulTexture as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add((*info).soulTexture as u32_0 &
        ...
        (*_g_6).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (0x80 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_6).words.w1 =
            ((*info).primColor.r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*info).primColor.g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                ((*info).primColor.b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).lightColor.a as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        let fresh26 = (*__gfxCtx).polyXlu.p;
        (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
        let mut _g_7: *mut Gfx = fresh26;
        (*_g_7).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        ...
        Matrix_RotateY((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                        ...
                                                                        usize])
                            as libc::c_int + 0x8000 as libc::c_int) as s16 as
                           libc::c_int as libc::c_float * 9.58738e-05f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        let fresh27 = (*__gfxCtx).polyXlu.p;
        (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
        let mut _g_8: *mut Gfx = fresh27;
        (*_g_8).words.w0 =
            (0xda as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_9).words.w1 = gPoeFieldSoulDL.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_po_field.c\x00" as *const u8 as
                         *const libc::c_char, 2149 as libc::c_int);
    EnPoField_DrawFlame(this, globalCtx);
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(3200 as libc::c_int);
             init
         }]
}
#[used]
