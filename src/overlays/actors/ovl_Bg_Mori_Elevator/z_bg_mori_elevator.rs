...
extern "C" {
    ...
    #[no_mangle]
    static mut gMoriElevatorDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriElevatorCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriElevator {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriElevatorActionFunc,
    pub targetY: f32_0,
    pub unk_16C: s32,
    pub unk_170: u8_0,
...
pub type BgMoriElevatorActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriElevator, _: *mut GlobalContext)
               -> ()>;
static mut sIsSpawned: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Bg_Mori_Elevator_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_ELEVATOR as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriElevator>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriElevator_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriElevator_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriElevator_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn func_808A1800(mut pValue: *mut f32_0,
                                       mut target: f32_0, mut scale: f32_0,
                                       mut maxStep: f32_0, mut minStep: f32_0)
 -> f32_0 {
    let mut var: f32_0 = (target - *pValue) * scale;
    if *pValue < target {
        if maxStep < var {
            var = maxStep
        } else if var < minStep { var = minStep }
        *pValue = *pValue + var;
        if target < *pValue { *pValue = target }
    } else if target < *pValue {
        if var < -maxStep {
            var = -maxStep
        } else if -minStep < var { var = -minStep }
        *pValue = *pValue + var;
...
#[no_mangle]
pub unsafe extern "C" fn func_808A18FC(mut this: *mut BgMoriElevator,
                                       mut distTo: f32_0) {
    let mut temp: f32_0 = 0.;
    temp = fabsf(distTo) * 0.09f32;
    func_800F436C(&mut (*this).dyna.actor.projectedPos,
                  (0x2879 as libc::c_int - 0x800 as libc::c_int) as u16_0,
                  if temp < 0.0f32 {
                      0.0f32
                  } else if temp > 1.0f32 { 1.0f32 } else { temp });
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgMoriElevator = thisx as *mut BgMoriElevator;
    let mut pad: s32 = 0;
    ...
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        ...
        osSyncPrintf(b"Error : \xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf obj elevator \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x8d\xb1\xe9\x99\xba\xef\xbc\x81(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_mori_elevator.c\x00" as *const u8 as
                         *const libc::c_char, 277 as libc::c_int);
    } else {
        match sIsSpawned as libc::c_int {
            0 => {
                // "Forest Temple elevator CT"
                osSyncPrintf(b"\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf elevator CT\n\x00"
                                 as *const u8 as *const libc::c_char);
                sIsSpawned = 1 as libc::c_int as s16;
                (*this).dyna.actor.room = -(1 as libc::c_int) as s8;
                Actor_ProcessInitChain(&mut (*this).dyna.actor,
                                       sInitChain.as_mut_ptr());
                DynaPolyActor_Init(&mut (*this).dyna,
                                   DPM_PLAYER as libc::c_int);
                CollisionHeader_GetVirtual(&mut gMoriElevatorCol as
                                               *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
                (*this).dyna.bgId =
                    DynaPoly_SetBgActor(globalCtx,
                                        &mut (*globalCtx).colCtx.dyna, thisx,
                                        colHeader);
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgMoriElevator = thisx as *mut BgMoriElevator;
    if (*this).unk_172 as libc::c_int == 0 as libc::c_int {
        // "Forest Temple elevator DT"
        osSyncPrintf(b"\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf elevator DT\n\x00"
                         as *const u8 as *const libc::c_char);
        DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                               (*this).dyna.bgId);
        sIsSpawned = 0 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_IsPlayerRiding(mut this:
                                                           *mut BgMoriElevator,
                                                       mut globalCtx:
                                                           *mut GlobalContext)
 -> s32 {
    return ((*this).dyna.unk_160 as libc::c_int & 2 as libc::c_int != 0 &&
                (*this).unk_170 as libc::c_int & 2 as libc::c_int == 0 &&
                (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                        libc::c_int as
                                                        usize].head as
                       *mut Player)).actor.world.pos.y -
                    (*this).dyna.actor.world.pos.y < 80.0f32) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_SetupWaitAfterInit(mut this:
                                                               *mut BgMoriElevator) {
    (*this).actionFunc =
        Some(BgMoriElevator_WaitAfterInit as
                 unsafe extern "C" fn(_: *mut BgMoriElevator,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_WaitAfterInit(mut this:
                                                          *mut BgMoriElevator,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        if Flags_GetSwitch(globalCtx,
            ...
            if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                   2 as libc::c_int {
                (*this).dyna.actor.world.pos.y = 73.0f32;
                BgMoriElevator_SetupSetPosition(this);
            } else {
                // "Error: Forest Temple obj elevator Room setting is dangerous"
                osSyncPrintf(b"Error : \xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf obj elevator \xe9\x83\xa8\xe5\xb1\x8b\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x8c\xe5\x8d\xb1\xe9\x99\xba(%s %d)\n\x00"
                                 as *const u8 as *const libc::c_char,
                             b"../z_bg_mori_elevator.c\x00" as *const u8 as
                                 *const libc::c_char, 371 as libc::c_int);
            }
        } else { BgMoriElevator_SetupSetPosition(this); }
        (*this).dyna.actor.draw =
            Some(BgMoriElevator_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808A1C30(mut this: *mut BgMoriElevator) {
    (*this).actionFunc =
        Some(BgMoriElevator_MoveIntoGround as
                 unsafe extern "C" fn(_: *mut BgMoriElevator,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_MoveIntoGround(mut this:
                                                           *mut BgMoriElevator,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut distToTarget: f32_0 = 0.;
    func_808A1800(&mut (*this).dyna.actor.velocity.y, 2.0f32, 0.05f32, 1.0f32,
                  0.0f32);
    distToTarget =
        func_808A1800(&mut (*this).dyna.actor.world.pos.y, 73.0f32, 0.08f32,
                      (*this).dyna.actor.velocity.y, 1.5f32);
    if fabsf(distToTarget) < 0.001f32 {
        BgMoriElevator_SetupSetPosition(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x287a as libc::c_int as u16_0);
    } else { func_808A18FC(this, distToTarget); };
}
#[no_mangle]
pub unsafe extern "C" fn func_808A1CF4(mut this: *mut BgMoriElevator,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actionFunc =
        Some(BgMoriElevator_MoveAboveGround as
                 unsafe extern "C" fn(_: *mut BgMoriElevator,
                                      _: *mut GlobalContext) -> ());
    OnePointCutscene_Init(globalCtx, 3230 as libc::c_int as s16,
                          70 as libc::c_int as s16, &mut (*this).dyna.actor,
                          0 as libc::c_int as s16);
    OnePointCutscene_Init(globalCtx, 1020 as libc::c_int as s16,
                          15 as libc::c_int as s16, &mut (*this).dyna.actor,
                          0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_MoveAboveGround(mut this:
                                                            *mut BgMoriElevator,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut distToTarget: f32_0 = 0.;
    func_808A1800(&mut (*this).dyna.actor.velocity.y, 2.0f32, 0.05f32, 1.0f32,
                  0.0f32);
    distToTarget =
        func_808A1800(&mut (*this).dyna.actor.world.pos.y, 233.0f32, 0.08f32,
                      (*this).dyna.actor.velocity.y, 1.5f32);
    if fabsf(distToTarget) < 0.001f32 {
        BgMoriElevator_SetupSetPosition(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_SetupSetPosition(mut this:
                                                             *mut BgMoriElevator) {
    (*this).actionFunc =
        Some(BgMoriElevator_SetPosition as
                 unsafe extern "C" fn(_: *mut BgMoriElevator,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_SetPosition(mut this:
                                                        *mut BgMoriElevator,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut pad: s32 = 0;
    if BgMoriElevator_IsPlayerRiding(this, globalCtx) != 0 {
        if (*globalCtx).roomCtx.curRoom.num as libc::c_int == 2 as libc::c_int
           {
            (*this).targetY = -779.0f32;
            BgMoriElevator_StopMovement(this);
        } else if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                      17 as libc::c_int {
            (*this).targetY = 233.0f32;
            BgMoriElevator_StopMovement(this);
        } else {
            ...
            osSyncPrintf(b"Error : \xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf obj elevator \xe9\x83\xa8\xe5\xb1\x8b\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x8c\xe5\x8d\xb1\xe9\x99\xba(%s %d)\n\x00"
                  ...
                  2 as libc::c_int &&
                  (*this).dyna.actor.world.pos.y < -275.0f32 {
        (*this).targetY = 233.0f32;
        BgMoriElevator_StopMovement(this);
    } else if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                  17 as libc::c_int &&
                  -275.0f32 < (*this).dyna.actor.world.pos.y {
        (*this).targetY = -779.0f32;
        BgMoriElevator_StopMovement(this);
    } else if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                  2 as libc::c_int &&
                  Flags_GetSwitch(globalCtx,
                                  (*this).dyna.actor.params as libc::c_int &
                                      0x3f as libc::c_int) != 0 &&
                  (*this).unk_16C == 0 as libc::c_int {
        (*this).targetY = 73.0f32;
        func_808A1C30(this);
    } else if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                  2 as libc::c_int &&
                  Flags_GetSwitch(globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_StopMovement(mut this:
                                                         *mut BgMoriElevator) {
    (*this).actionFunc =
        Some(func_808A2008 as
                 unsafe extern "C" fn(_: *mut BgMoriElevator,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.velocity.y = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_808A2008(mut this: *mut BgMoriElevator,
                                       mut globalCtx: *mut GlobalContext) {
    let mut distTo: f32_0 = 0.;
    func_808A1800(&mut (*this).dyna.actor.velocity.y, 12.0f32, 0.1f32, 1.0f32,
                  0.0f32);
    distTo =
        func_808A1800(&mut (*this).dyna.actor.world.pos.y, (*this).targetY,
                      0.1f32, (*this).dyna.actor.velocity.y, 0.3f32);
    if fabsf(distTo) < 0.001f32 {
        BgMoriElevator_SetupSetPosition(this);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x287a as libc::c_int as u16_0);
    } else { func_808A18FC(this, distTo); };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgMoriElevator = thisx as *mut BgMoriElevator;
    ...
    (*this).unk_16C =
        Flags_GetSwitch(globalCtx,
                        (*thisx).params as libc::c_int & 0x3f as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriElevator_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriElevator = thisx as *mut BgMoriElevator;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mori_elevator.c\x00" as *const u8 as
                        *const libc::c_char, 575 as libc::c_int);
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gMoriElevatorDL.as_mut_ptr() as libc::c_uint;
