...
extern "C" {
    #[no_mangle]
    fn WaterBox_GetSurface2(globalCtx: *mut GlobalContext,
                            colCtx: *mut CollisionContext, pos: *mut Vec3f,
                            surfaceChkDist: f32_0,
    ...
    #[no_mangle]
    static mut gEffWaterRippleTex: [u64_0; 0];
    #[no_mangle]
...
#[no_mangle]
pub static mut Effect_Ss_G_Ripple_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_G_RIPPLE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGRipple_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsGRipple_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
 ...
 -> u32_0 {
    ...
    let mut initParams: *mut EffectSsGRippleInitParams =
        initParamsx as *mut EffectSsGRippleInitParams;
    waterBox = 0 as *mut WaterBox;
    (*this).accel = zeroVec;
    (*this).velocity = (*this).accel;
    (*this).pos = (*initParams).pos;
    (*this).gfx =
        gSegments[((gEffWaterRippleDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffWaterRippleDL.as_mut_ptr() as
                                              u32_0 &
            ...
            as *mut libc::c_void;
    (*this).life =
        ((*initParams).life as libc::c_int + 20 as libc::c_int) as s16;
    (*this).flags = 0 as libc::c_int as u16_0;
    (*this).draw =
        Some(EffectSsGRipple_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsGRipple_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[1 as libc::c_int as usize] = (*initParams).radius;
    (*this).regs[2 as libc::c_int as usize] = (*initParams).radiusMax;
    ...
    (*this).regs[6 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[7 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[8 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[9 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[10 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[0 as libc::c_int as usize] =
        WaterBox_GetSurface2(globalCtx, &mut (*globalCtx).colCtx,
                             &mut (*initParams).pos, 3.0f32, &mut waterBox) as
            s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGRipple_DrawRipple(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut this: *mut EffectSs,
                                                    mut segment:
                                                        *mut libc::c_void) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_g_ripple.c\x00" as *const u8 as
    ...
    if (*this).regs[0 as libc::c_int as usize] as libc::c_int !=
           ...
           ((*this).regs[0 as libc::c_int as usize] as libc::c_int) <
               (*(*globalCtx).colCtx.colHeader).numWaterBoxes as libc::c_int {
        yPos =
            (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset((*this).regs[0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  usize]
                                                                     ...
                                                                     isize)).ySurface
                as f32_0
    } else { yPos = (*this).pos.y }
    SkinMatrix_SetTranslate(&mut mfTrans, (*this).pos.x, yPos, (*this).pos.z);
    SkinMatrix_SetScale(&mut mfScale, radius, radius, radius);
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsGRipple_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    if (*this).regs[11 as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int {
        EffectSsGRipple_DrawRipple(globalCtx, this,
                                   gEffWaterRippleTex.as_mut_ptr() as
                                       *mut libc::c_void);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGRipple_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    let mut radius: f32_0 = 0.;
    let mut primAlpha: f32_0 = 0.;
    let mut envAlpha: f32_0 = 0.;
    if (if (*this).regs[11 as libc::c_int as usize] as libc::c_int ==
               0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).regs[11 as libc::c_int as usize] -= 1;
            (*this).regs[11 as libc::c_int as usize] as libc::c_int
        }) == 0 as libc::c_int {
        radius = (*this).regs[1 as libc::c_int as usize] as f32_0;
        Math_SmoothStepToF(&mut radius,
                           (*this).regs[2 as libc::c_int as usize] as f32_0,
                           0.2f32, 30.0f32, 1.0f32);
        (*this).regs[1 as libc::c_int as usize] = radius as s16;
        primAlpha = (*this).regs[6 as libc::c_int as usize] as f32_0;
        envAlpha = (*this).regs[10 as libc::c_int as usize] as f32_0;
        Math_SmoothStepToF(&mut primAlpha, 0.0f32, 0.2f32, 15.0f32, 7.0f32);
        Math_SmoothStepToF(&mut envAlpha, 0.0f32, 0.2f32, 15.0f32, 7.0f32);
        (*this).regs[6 as libc::c_int as usize] = primAlpha as s16;
        (*this).regs[10 as libc::c_int as usize] = envAlpha as s16
    };
}
