...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gFireTempleMetalFence2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleMetalFenceDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleMetalFenceWithSlantDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleMetalFenceWithSlantCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleMetalFenceCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleMetalFence2Col: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanKousi {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanKousiActionFunc,
    pub unk_168: s16,
}
pub type BgHidanKousiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanKousi, _: *mut GlobalContext)
               -> ()>;
static mut D_80889E40: [f32_0; 3] = [120.0f32, 150.0f32, 150.0f32];
#[no_mangle]
pub static mut Bg_Hidan_Kousi_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_KOUSI as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanKousi>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKousi_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKousi_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKousi_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanKousi_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sMetalFencesCollisions: [*mut CollisionHeader; 3] =
    unsafe {
        [&gFireTempleMetalFenceWithSlantCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gFireTempleMetalFenceCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gFireTempleMetalFence2Col as *const CollisionHeader as
             *mut CollisionHeader]
    };
static mut D_80889E7C: [s16; 4] =
    [0x4000 as libc::c_int as s16, 0xc000 as libc::c_int as s16,
     0xc000 as libc::c_int as s16, 0 as libc::c_int as s16];
static mut sMetalFencesDLs: [*mut Gfx; 3] =
    unsafe {
        [gFireTempleMetalFenceWithSlantDL.as_ptr() as *mut _,
         gFireTempleMetalFenceDL.as_ptr() as *mut _,
         gFireTempleMetalFence2DL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgHidanKousi_SetupAction(mut this: *mut BgHidanKousi,
                                                  mut actionFunc:
                                                      BgHidanKousiActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKousi_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHidanKousi = thisx as *mut BgHidanKousi;
    let mut pad: s32 = 0;
    ...
    osSyncPrintf(b"\xe2\x97\xaf\xe2\x97\xaf\xe2\x97\xaf\xe7\x82\x8e\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf\xe3\x82\xaa\xe3\x83\x96\xe3\x82\xb8\xe3\x82\xa7\xe3\x82\xaf\xe3\x83\x88\xe3\x80\x90\xe6\xa0\xbc\xe5\xad\x90(arg_data : %0x)\xe3\x80\x91\xe5\x87\xba\xe7\x8f\xbe (%d %d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*thisx).params as libc::c_int,
                 (*thisx).params as libc::c_int & 0xff as libc::c_int,
                 (*thisx).params as s32 >> 8 as libc::c_int &
                     0xff as libc::c_int);
    ...
    if ((*thisx).params as libc::c_int & 0xff as libc::c_int) <
           ...
           (*thisx).params as libc::c_int & 0xff as libc::c_int >=
               3 as libc::c_int {
        osSyncPrintf(b"arg_data \xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84 \xe3\x80\x90\xe6\xa0\xbc\xe5\xad\x90\xe3\x80\x91\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    CollisionHeader_GetVirtual(sMetalFencesCollisions[((*thisx).params as
                                                           libc::c_int &
                                                           0xff as
                                                               libc::c_int) as
                                                          usize] as
    ...
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna, thisx,
                            colHeader);
    (*thisx).world.rot.y =
        (D_80889E7C[((*this).dyna.actor.params as libc::c_int &
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        func_80889ACC(this);
        BgHidanKousi_SetupAction(this,
                                 Some(func_80889D28 as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgHidanKousi,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKousi_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanKousi = thisx as *mut BgHidanKousi;
...
#[no_mangle]
pub unsafe extern "C" fn func_80889ACC(mut this: *mut BgHidanKousi) {
    let mut pad: [s32; 2] = [0; 2];
    let mut rot: *mut Vec3s = &mut (*this).dyna.actor.world.rot;
    let mut temp1: f32_0 =
        D_80889E40[((*this).dyna.actor.params as libc::c_int &
                        0xff as libc::c_int) as usize] * Math_SinS((*rot).y);
    let mut temp2: f32_0 =
        D_80889E40[((*this).dyna.actor.params as libc::c_int &
                        0xff as libc::c_int) as usize] * Math_CosS((*rot).y);
    (*this).dyna.actor.world.pos.x = (*this).dyna.actor.home.pos.x + temp1;
    (*this).dyna.actor.world.pos.z = (*this).dyna.actor.home.pos.z + temp2;
}
#[no_mangle]
pub unsafe extern "C" fn func_80889B5C(mut this: *mut BgHidanKousi,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0xff as libc::c_int) != 0 {
        BgHidanKousi_SetupAction(this,
                                 Some(func_80889BC0 as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgHidanKousi,
                                                               _:
                                                                   *mut GlobalContext)
        ...
        (*this).unk_168 = 0xc8 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80889BC0(mut this: *mut BgHidanKousi,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_168 =
        ((*this).unk_168 as libc::c_int - 1 as libc::c_int) as s16;
    if (*this).dyna.actor.category as libc::c_int == func_8005B198() ||
           (*this).unk_168 as libc::c_int <= 0 as libc::c_int {
        BgHidanKousi_SetupAction(this,
                                 Some(func_80889C18 as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgHidanKousi,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80889C18(mut this: *mut BgHidanKousi,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).dyna.actor.speedXZ += 0.2f32;
    if (*this).dyna.actor.speedXZ > 2.0f32 {
        (*this).dyna.actor.speedXZ = 2.0f32;
        BgHidanKousi_SetupAction(this,
                                 Some(func_80889C90 as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgHidanKousi,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80889C90(mut this: *mut BgHidanKousi,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002D7EC(&mut (*this).dyna.actor);
    if D_80889E40[((*this).dyna.actor.params as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn func_80889D28(mut this: *mut BgHidanKousi,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanKousi_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanKousi = thisx as *mut BgHidanKousi;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanKousi_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_kousi.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        sMetalFencesDLs[((*thisx).params as libc::c_int & 0xff as libc::c_int)
