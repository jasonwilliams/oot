...
pub struct ObjMure3 {
    pub actor: Actor,
    pub actionFunc: ObjMure3ActionFunc,
    pub unk_150: [*mut EnItem00; 7],
    pub unk_16C: u16_0,
}
pub type ObjMure3ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjMure3, _: *mut GlobalContext)
               -> ()>;
pub type ObjMure3SpawnFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjMure3, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Mure3_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_MURE3 as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjMure3>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMure3_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMure3_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sRupeeCounts: [s16; 4] =
    [5 as libc::c_int as s16, 5 as libc::c_int as s16,
     7 as libc::c_int as s16, 0 as libc::c_int as s16];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
#[no_mangle]
pub unsafe extern "C" fn func_80B9A9D0(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut spawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Math_Vec3f_Copy(&mut spawnPos, &mut (*this).actor.world.pos);
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        if (*this).unk_16C as libc::c_int >> i & 1 as libc::c_int == 0 {
            (*this).unk_150[i as usize] =
                Item_DropCollectible2(globalCtx, &mut spawnPos,
                                      (0x4000 as libc::c_int |
                                           ITEM00_RUPEE_BLUE as libc::c_int)
                                          as s16);
            if !(*this).unk_150[i as usize].is_null() {
                (*(*this).unk_150[i as usize]).actor.room = (*this).actor.room
            }
        }
        i += 1;
        spawnPos.y += 20.0f32
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9AA90(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut spawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sn: f32_0 = Math_SinS((*this).actor.world.rot.y);
    let mut cos: f32_0 = Math_CosS((*this).actor.world.rot.y);
    ...
    while i < 5 as libc::c_int {
        if (*this).unk_16C as libc::c_int >> i & 1 as libc::c_int == 0 {
            ...
            (*this).unk_150[i as usize] =
                Item_DropCollectible2(globalCtx, &mut spawnPos,
                                      (0x4000 as libc::c_int |
                                           ITEM00_RUPEE_GREEN as libc::c_int)
                                          as s16);
            if !(*this).unk_150[i as usize].is_null() {
                (*(*this).unk_150[i as usize]).actor.room = (*this).actor.room
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9ABA0(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut spawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut yRot: s16 = 0;
    ...
    while i < 6 as libc::c_int {
        if (*this).unk_16C as libc::c_int >> i & 1 as libc::c_int == 0 {
            spawnPos.x =
                Math_SinS(yRot) * 40.0f32 + (*this).actor.world.pos.x;
            spawnPos.z =
                Math_CosS(yRot) * 40.0f32 + (*this).actor.world.pos.z;
            (*this).unk_150[i as usize] =
                Item_DropCollectible2(globalCtx, &mut spawnPos,
                                      (0x4000 as libc::c_int |
                                           ITEM00_RUPEE_GREEN as libc::c_int)
        ...
        yRot = (yRot as libc::c_int + 0x2aaa as libc::c_int) as s16;
        i += 1
    }
    if (*this).unk_16C as libc::c_int >> 6 as libc::c_int & 1 as libc::c_int
           == 0 {
        spawnPos.x = (*this).actor.world.pos.x;
        spawnPos.z = (*this).actor.world.pos.z;
        (*this).unk_150[6 as libc::c_int as usize] =
            Item_DropCollectible2(globalCtx, &mut spawnPos,
                                  (0x4000 as libc::c_int |
                                       ITEM00_RUPEE_RED as libc::c_int) as
                                      s16);
        if !(*this).unk_150[6 as libc::c_int as usize].is_null() {
            (*(*this).unk_150[6 as libc::c_int as usize]).actor.room =
                (*this).actor.room
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9ACE4(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut count: s16 =
        sRupeeCounts[((*this).actor.params as libc::c_int >> 13 as libc::c_int
                          & 7 as libc::c_int) as usize];
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < count as libc::c_int {
        let mut collectible: *mut *mut EnItem00 =
            &mut *(*this).unk_150.as_mut_ptr().offset(i as isize) as
                *mut *mut EnItem00;
        if (*this).unk_16C as libc::c_int >> i & 1 as libc::c_int == 0 &&
               !(*collectible).is_null() {
            if Actor_HasParent(&mut (**collectible).actor, globalCtx) != 0 ||
                   (**collectible).actor.update.is_none() {
                (*this).unk_16C =
                    ((*this).unk_16C as libc::c_int | (1 as libc::c_int) << i)
                        as u16_0
            } else { Actor_Kill(&mut (**collectible).actor); }
        }
        *collectible = 0 as *mut EnItem00;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9ADCC(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    let mut count: s16 =
        sRupeeCounts[((*this).actor.params as libc::c_int >> 13 as libc::c_int
                          & 7 as libc::c_int) as usize];
    ...
    while i < count as libc::c_int {
        ...
        if !(*collectible).is_null() &&
               (*this).unk_16C as libc::c_int >> i & 1 as libc::c_int == 0 {
            if Actor_HasParent(&mut (**collectible).actor, globalCtx) != 0 {
                Flags_SetSwitch(globalCtx,
                                (*this).actor.params as libc::c_int &
                                    0x3f as libc::c_int);
            }
            if (**collectible).actor.update.is_none() {
                (*this).unk_16C =
                    ((*this).unk_16C as libc::c_int | (1 as libc::c_int) << i)
                        as u16_0;
                (*this).unk_150[i as usize] = 0 as *mut EnItem00
            }
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure3_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjMure3 = thisx as *mut ObjMure3;
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure3_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9AF24(mut this: *mut ObjMure3) {
    (*this).actionFunc =
        Some(func_80B9AF34 as
                 unsafe extern "C" fn(_: *mut ObjMure3, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9AF34(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B9AF54(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9AF54(mut this: *mut ObjMure3) {
    (*this).actionFunc =
        Some(func_80B9AF64 as
                 unsafe extern "C" fn(_: *mut ObjMure3, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9AF64(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    static mut spawnFuncs: [ObjMure3SpawnFunc; 3] =
        unsafe {
            [Some(func_80B9A9D0 as
                      unsafe extern "C" fn(_: *mut ObjMure3,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80B9AA90 as
                      unsafe extern "C" fn(_: *mut ObjMure3,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80B9ABA0 as
                      unsafe extern "C" fn(_: *mut ObjMure3,
                                           _: *mut GlobalContext) -> ())]
        };
    if Math3D_Dist1DSq((*this).actor.projectedPos.x,
                       (*this).actor.projectedPos.z) < 1150.0f32 * 1150.0f32 {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
        spawnFuncs[((*this).actor.params as libc::c_int >> 13 as libc::c_int &
                        7 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9AFEC(mut this: *mut ObjMure3) {
    (*this).actionFunc =
        Some(func_80B9AFFC as
                 unsafe extern "C" fn(_: *mut ObjMure3, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9AFFC(mut this: *mut ObjMure3,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B9ADCC(this, globalCtx);
    if Math3D_Dist1DSq((*this).actor.projectedPos.x,
                       (*this).actor.projectedPos.z) >= 1450.0f32 * 1450.0f32
       {
        (*this).actor.flags &=
            !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure3_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjMure3 = thisx as *mut ObjMure3;
