...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002BE04(globalCtx: *mut GlobalContext, arg1: *mut Vec3f,
                     arg2: *mut Vec3f, arg3: *mut f32_0);
    #[no_mangle]
    fn func_8006F0A0(arg0: s32) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gGlowCircleTextureLoadDL: [Gfx; 0];
    #[no_mangle]
    static mut gGlowCircleDL: [Gfx; 0];
}
...
pub const LIGHT_POINT_GLOW: C2RustUnnamed_3 = 2;
pub const LIGHT_DIRECTIONAL: C2RustUnnamed_3 = 1;
pub const LIGHT_POINT_NOGLOW: C2RustUnnamed_3 = 0;
pub type LightsBindFunc
    =
    Option<unsafe extern "C" fn(_: *mut Lights, _: *mut LightParams,
                                _: *mut Vec3f) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct LightsBuffer {
    pub numOccupied: s32,
    pub searchIndex: s32,
    pub buf: [LightNode; 32],
}
// size = 0x188
#[no_mangle]
pub static mut sLightsBuffer: LightsBuffer =
    LightsBuffer{numOccupied: 0,
                 searchIndex: 0,
                 buf:
                     [LightNode{info: 0 as *const LightInfo as *mut LightInfo,
                                prev: 0 as *const LightNode as *mut LightNode,
                                next:
                                    0 as *const LightNode as *mut LightNode,};
                         32],};
#[no_mangle]
pub unsafe extern "C" fn Lights_PointSetInfo(mut info: *mut LightInfo,
                                             mut x: s16, mut y: s16,
                                             mut z: s16, mut r: u8_0,
                                             mut g: u8_0, mut b: u8_0,
                                             mut radius: s16,
                                             mut type_0: s32) {
    (*info).type_0 = type_0 as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn Lights_PointNoGlowSetInfo(mut info: *mut LightInfo,
                                                   mut x: s16, mut y: s16,
                                                   mut z: s16, mut r: u8_0,
                                                   mut g: u8_0, mut b: u8_0,
                                                   mut radius: s16) {
    Lights_PointSetInfo(info, x, y, z, r, g, b, radius,
                        LIGHT_POINT_NOGLOW as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Lights_PointGlowSetInfo(mut info: *mut LightInfo,
                                                 mut x: s16, mut y: s16,
                                                 mut z: s16, mut r: u8_0,
                                                 mut g: u8_0, mut b: u8_0,
                                                 mut radius: s16) {
    Lights_PointSetInfo(info, x, y, z, r, g, b, radius,
                        LIGHT_POINT_GLOW as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Lights_PointSetColorAndRadius(mut info:
                                                           *mut LightInfo,
                                                       mut r: u8_0,
                                                       mut g: u8_0,
                                                       mut b: u8_0,
                                                       mut radius: s16) {
    (*info).params.point.color[0 as libc::c_int as usize] = r;
    (*info).params.point.color[1 as libc::c_int as usize] = g;
    (*info).params.point.color[2 as libc::c_int as usize] = b;
    (*info).params.point.radius = radius;
}
#[no_mangle]
pub unsafe extern "C" fn Lights_DirectionalSetInfo(mut info: *mut LightInfo,
                                                   mut x: s8, mut y: s8,
                                                   mut z: s8, mut r: u8_0,
                                                   mut g: u8_0, mut b: u8_0) {
    (*info).type_0 = LIGHT_DIRECTIONAL as libc::c_int as u8_0;
    (*info).params.dir.x = x;
    (*info).params.dir.y = y;
    (*info).params.dir.z = z;
    (*info).params.dir.color[0 as libc::c_int as usize] = r;
    (*info).params.dir.color[1 as libc::c_int as usize] = g;
    (*info).params.dir.color[2 as libc::c_int as usize] = b;
}
// unused
#[no_mangle]
pub unsafe extern "C" fn Lights_Reset(mut lights: *mut Lights,
                                      mut ambentR: u8_0, mut ambentG: u8_0,
                                      mut ambentB: u8_0) {
    (*lights).l.a.l.colc[0 as libc::c_int as usize] = ambentR;
    (*lights).l.a.l.col[0 as libc::c_int as usize] =
        (*lights).l.a.l.colc[0 as libc::c_int as usize];
    (*lights).l.a.l.colc[1 as libc::c_int as usize] = ambentG;
    (*lights).l.a.l.col[1 as libc::c_int as usize] =
        (*lights).l.a.l.colc[1 as libc::c_int as usize];
    (*lights).l.a.l.colc[2 as libc::c_int as usize] = ambentB;
    (*lights).l.a.l.col[2 as libc::c_int as usize] =
        (*lights).l.a.l.colc[2 as libc::c_int as usize];
    (*lights).numLights = 0 as libc::c_int as u8_0;
}
/*
 * Draws every light in the provided Lights group
 */
#[no_mangle]
pub unsafe extern "C" fn Lights_Draw(mut lights: *mut Lights,
                                     mut gfxCtx: *mut GraphicsContext) {
    let mut light: *mut Light =
        0 as *mut Light; // abmient light is total number of lights + 1
    let mut i: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_lights.c\x00" as *const u8 as *const libc::c_char,
                    339 as libc::c_int);
    ...
    (*_g).words.w1 =
        ((*lights).numLights as libc::c_int * 24 as libc::c_int) as
            libc::c_uint;
    ...
    i = 0 as libc::c_int;
    light =
        &mut *(*lights).l.l.as_mut_ptr().offset(0 as libc::c_int as isize) as
            *mut Light;
    while i < (*lights).numLights as libc::c_int {
        i += 1;
        ...
        (*_g_1).words.w0 =
            (0xdc as libc::c_int as u32_0 &
                ...
                ((::std::mem::size_of::<Light>() as
                    ...
                    19 as libc::c_int |
                (((i * 24 as libc::c_int + 24 as libc::c_int) /
                ...
                (10 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = light as libc::c_uint;
            ...
            (0xdc as libc::c_int as u32_0 &
                ...
                (10 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = light as libc::c_uint;
        light = light.offset(1)
    }
    i += 1;
    ...
    (*_g_3).words.w0 =
        (0xdc as libc::c_int as u32_0 &
            ...
            |
            (((i * 24 as libc::c_int + 24 as libc::c_int) / 8 as libc::c_int)
                 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
            ...
            (10 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = &mut (*lights).l.a as *mut Ambient as libc::c_uint;
    ...
    (*_g_4).words.w0 =
        (0xdc as libc::c_int as u32_0 &
            ...
            (10 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = &mut (*lights).l.a as *mut Ambient as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_lights.c\x00" as *const u8 as *const libc::c_char,
                     352 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn Lights_FindSlot(mut lights: *mut Lights)
 -> *mut Light {
    if (*lights).numLights as libc::c_int >= 7 as libc::c_int {
        return 0 as *mut Light
    } else {
        let fresh6 = (*lights).numLights;
        (*lights).numLights = (*lights).numLights.wrapping_add(1);
        return &mut *(*lights).l.l.as_mut_ptr().offset(fresh6 as isize) as
                   *mut Light
    };
}
#[no_mangle]
pub unsafe extern "C" fn Lights_BindPoint(mut lights: *mut Lights,
                                          mut params: *mut LightParams,
                                          mut vec: *mut Vec3f) {
    ...
    let mut light: *mut Light = 0 as *mut Light;
    if !vec.is_null() {
        xDiff = (*params).point.x as libc::c_int as libc::c_float - (*vec).x;
        yDiff = (*params).point.y as libc::c_int as libc::c_float - (*vec).y;
        zDiff = (*params).point.z as libc::c_int as libc::c_float - (*vec).z;
        scale = (*params).point.radius as f32_0;
        posDiff = xDiff * xDiff + yDiff * yDiff + zDiff * zDiff;
        if posDiff < scale * scale {
            light = Lights_FindSlot(lights);
            if !light.is_null() {
                posDiff = sqrtf(posDiff);
                scale = posDiff / scale;
                scale = 1 as libc::c_int as libc::c_float - scale * scale;
                (*light).l.colc[0 as libc::c_int as usize] =
                    ((*params).point.color[0 as libc::c_int as usize] as
                         libc::c_int as libc::c_float * scale) as
                        libc::c_uchar;
                (*light).l.col[0 as libc::c_int as usize] =
                    (*light).l.colc[0 as libc::c_int as usize];
                (*light).l.colc[1 as libc::c_int as usize] =
                    ((*params).point.color[1 as libc::c_int as usize] as
                         libc::c_int as libc::c_float * scale) as
                        libc::c_uchar;
                (*light).l.col[1 as libc::c_int as usize] =
                    (*light).l.colc[1 as libc::c_int as usize];
                (*light).l.colc[2 as libc::c_int as usize] =
                    ((*params).point.color[2 as libc::c_int as usize] as
                         libc::c_int as libc::c_float * scale) as
                        libc::c_uchar;
                (*light).l.col[2 as libc::c_int as usize] =
                    (*light).l.colc[2 as libc::c_int as usize];
                scale =
                    if posDiff < 1.0f32 {
                        120.0f32
                    } else { (120.0f32) / posDiff };
                (*light).l.dir[0 as libc::c_int as usize] =
                    (xDiff * scale) as libc::c_schar;
                (*light).l.dir[1 as libc::c_int as usize] =
                    (yDiff * scale) as libc::c_schar;
                (*light).l.dir[2 as libc::c_int as usize] =
                    (zDiff * scale) as libc::c_schar
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn Lights_BindDirectional(mut lights: *mut Lights,
                                                mut params: *mut LightParams,
                                                mut vec: *mut Vec3f) {
    let mut light: *mut Light = Lights_FindSlot(lights);
    if !light.is_null() {
        (*light).l.colc[0 as libc::c_int as usize] =
            (*params).dir.color[0 as libc::c_int as usize];
        (*light).l.col[0 as libc::c_int as usize] =
            (*light).l.colc[0 as libc::c_int as usize];
        (*light).l.colc[1 as libc::c_int as usize] =
            (*params).dir.color[1 as libc::c_int as usize];
        (*light).l.col[1 as libc::c_int as usize] =
            (*light).l.colc[1 as libc::c_int as usize];
        (*light).l.colc[2 as libc::c_int as usize] =
            (*params).dir.color[2 as libc::c_int as usize];
        (*light).l.col[2 as libc::c_int as usize] =
            (*light).l.colc[2 as libc::c_int as usize];
        (*light).l.dir[0 as libc::c_int as usize] = (*params).dir.x;
        (*light).l.dir[1 as libc::c_int as usize] = (*params).dir.y;
        (*light).l.dir[2 as libc::c_int as usize] = (*params).dir.z
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Lights_BindAll(mut lights: *mut Lights,
                                        mut listHead: *mut LightNode,
                                        mut vec: *mut Vec3f) {
    let mut bindFuncs: [LightsBindFunc; 3] =
        [Some(Lights_BindPoint as
                  unsafe extern "C" fn(_: *mut Lights, _: *mut LightParams,
                                       _: *mut Vec3f) -> ()),
         Some(Lights_BindDirectional as
                  unsafe extern "C" fn(_: *mut Lights, _: *mut LightParams,
                                       _: *mut Vec3f) -> ()),
         Some(Lights_BindPoint as
                  unsafe extern "C" fn(_: *mut Lights, _: *mut LightParams,
                                       _: *mut Vec3f) -> ())];
    let mut info: *mut LightInfo = 0 as *mut LightInfo;
    while !listHead.is_null() {
        info = (*listHead).info;
        bindFuncs[(*info).type_0 as
                      usize].expect("non-null function pointer")(lights,
                                                                 &mut (*info).params,
                                                                 vec);
...
#[no_mangle]
pub unsafe extern "C" fn Lights_FindBufSlot() -> *mut LightNode {
    let mut node: *mut LightNode = 0 as *mut LightNode;
    if sLightsBuffer.numOccupied >= 32 as libc::c_int {
        return 0 as *mut LightNode
    }
    node =
        &mut *sLightsBuffer.buf.as_mut_ptr().offset(sLightsBuffer.searchIndex
                                                        as isize) as
            *mut LightNode;
    while !(*node).info.is_null() {
        sLightsBuffer.searchIndex += 1;
        if sLightsBuffer.searchIndex < 32 as libc::c_int {
            node = node.offset(1)
        } else {
            sLightsBuffer.searchIndex = 0 as libc::c_int;
            node =
                &mut *sLightsBuffer.buf.as_mut_ptr().offset(0 as libc::c_int
                                                                as isize) as
                    *mut LightNode
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn Lights_FreeNode(mut light: *mut LightNode) -> s32 {
    if !light.is_null() {
        sLightsBuffer.numOccupied -= 1;
        (*light).info = 0 as *mut LightInfo;
        sLightsBuffer.searchIndex =
            (light.wrapping_offset_from(sLightsBuffer.buf.as_mut_ptr()) as
                 libc::c_int as
                 libc::c_uint).wrapping_div(::std::mem::size_of::<LightNode>()
                                                as libc::c_ulong) as s32
    }
    panic!("Reached end of non-void function without returning");
}
#[no_mangle]
pub unsafe extern "C" fn LightContext_Init(mut globalCtx: *mut GlobalContext,
                                           mut lightCtx: *mut LightContext) {
    LightContext_InitList(globalCtx, lightCtx);
    LightContext_SetAmbientColor(lightCtx, 80 as libc::c_int as u8_0,
                                 80 as libc::c_int as u8_0,
                                 80 as libc::c_int as u8_0);
    LightContext_SetFog(lightCtx, 0 as libc::c_int as u8_0,
                        0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
                        996 as libc::c_int as s16,
                        12800 as libc::c_int as s16);
    bzero(&mut sLightsBuffer as *mut LightsBuffer as *mut libc::c_void,
          ::std::mem::size_of::<LightsBuffer>() as libc::c_ulong);
}
#[no_mangle]
pub unsafe extern "C" fn LightContext_SetAmbientColor(mut lightCtx:
                                                          *mut LightContext,
                                                      mut r: u8_0,
                                                      mut g: u8_0,
                                                      mut b: u8_0) {
    (*lightCtx).ambientColor[0 as libc::c_int as usize] = r;
    (*lightCtx).ambientColor[1 as libc::c_int as usize] = g;
    (*lightCtx).ambientColor[2 as libc::c_int as usize] = b;
}
#[no_mangle]
pub unsafe extern "C" fn LightContext_SetFog(mut lightCtx: *mut LightContext,
                                             mut r: u8_0, mut g: u8_0,
                                             mut b: u8_0, mut fogNear: s16,
                                             mut fogFar: s16) {
    (*lightCtx).fogColor[0 as libc::c_int as usize] = r;
    (*lightCtx).fogColor[1 as libc::c_int as usize] = g;
    (*lightCtx).fogColor[2 as libc::c_int as usize] = b;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn LightContext_NewLights(mut lightCtx:
                                                    *mut LightContext,
                                                mut gfxCtx:
                                                    *mut GraphicsContext)
 -> *mut Lights {
    return Lights_New(gfxCtx,
...
#[no_mangle]
pub unsafe extern "C" fn LightContext_InitList(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut lightCtx:
                                                   *mut LightContext) {
    (*lightCtx).listHead = 0 as *mut LightNode;
}
#[no_mangle]
pub unsafe extern "C" fn LightContext_DestroyList(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut lightCtx:
                                                      *mut LightContext) {
    while !(*lightCtx).listHead.is_null() {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn LightContext_InsertLight(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut lightCtx:
                                                      *mut LightContext,
                                                  mut info: *mut LightInfo)
 -> *mut LightNode {
    let mut node: *mut LightNode = 0 as *mut LightNode;
    node = Lights_FindBufSlot();
    if !node.is_null() {
        (*node).info = info;
        (*node).prev = 0 as *mut LightNode;
        (*node).next = (*lightCtx).listHead;
        if !(*lightCtx).listHead.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn LightContext_RemoveLight(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut lightCtx:
                                                      *mut LightContext,
                                                  mut node: *mut LightNode) {
    if !node.is_null() {
        if !(*node).prev.is_null() {
            (*(*node).prev).next = (*node).next
        } else { (*lightCtx).listHead = (*node).next }
...
// unused
#[no_mangle]
pub unsafe extern "C" fn Lights_NewAndDraw(mut gfxCtx: *mut GraphicsContext,
                                           mut ambientR: u8_0,
                                           mut ambientG: u8_0,
                                           mut ambientB: u8_0,
                                           mut numLights: u8_0, mut r: u8_0,
                                           mut g: u8_0, mut b: u8_0,
                                           mut x: s8, mut y: s8, mut z: s8)
 -> *mut Lights {
    let mut lights: *mut Lights = 0 as *mut Lights;
    let mut i: s32 = 0;
    lights =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<Lights>() as libc::c_ulong as
                        size_t) as *mut Lights;
    (*lights).l.a.l.colc[0 as libc::c_int as usize] = ambientR;
    (*lights).l.a.l.col[0 as libc::c_int as usize] =
        (*lights).l.a.l.colc[0 as libc::c_int as usize];
    (*lights).l.a.l.colc[1 as libc::c_int as usize] = ambientG;
    (*lights).l.a.l.col[1 as libc::c_int as usize] =
        (*lights).l.a.l.colc[1 as libc::c_int as usize];
    (*lights).l.a.l.colc[2 as libc::c_int as usize] = ambientB;
    (*lights).l.a.l.col[2 as libc::c_int as usize] =
        (*lights).l.a.l.colc[2 as libc::c_int as usize];
    (*lights).numLights = numLights;
    i = 0 as libc::c_int;
    while i < numLights as libc::c_int {
        (*lights).l.l[i as usize].l.colc[0 as libc::c_int as usize] = r;
        (*lights).l.l[i as usize].l.col[0 as libc::c_int as usize] =
            (*lights).l.l[i as usize].l.colc[0 as libc::c_int as usize];
        (*lights).l.l[i as usize].l.colc[1 as libc::c_int as usize] = g;
        (*lights).l.l[i as usize].l.col[1 as libc::c_int as usize] =
            (*lights).l.l[i as usize].l.colc[1 as libc::c_int as usize];
        (*lights).l.l[i as usize].l.colc[2 as libc::c_int as usize] = b;
        (*lights).l.l[i as usize].l.col[2 as libc::c_int as usize] =
            (*lights).l.l[i as usize].l.colc[2 as libc::c_int as usize];
        (*lights).l.l[i as usize].l.dir[0 as libc::c_int as usize] = x;
        (*lights).l.l[i as usize].l.dir[1 as libc::c_int as usize] = y;
        (*lights).l.l[i as usize].l.dir[2 as libc::c_int as usize] = z;
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn Lights_New(mut gfxCtx: *mut GraphicsContext,
                                    mut ambientR: u8_0, mut ambientG: u8_0,
                                    mut ambientB: u8_0) -> *mut Lights {
    let mut lights: *mut Lights = 0 as *mut Lights;
    lights =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<Lights>() as libc::c_ulong as
...
#[no_mangle]
pub unsafe extern "C" fn Lights_GlowCheck(mut globalCtx: *mut GlobalContext) {
    let mut node: *mut LightNode = 0 as *mut LightNode;
    let mut params: *mut LightPoint = 0 as *mut LightPoint;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut multDest: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    while !node.is_null() {
        params = &mut (*(*node).info).params.point;
        if (*(*node).info).type_0 as libc::c_int ==
               LIGHT_POINT_GLOW as libc::c_int {
            pos.x = (*params).x as f32_0;
            pos.y = (*params).y as f32_0;
            pos.z = (*params).z as f32_0;
            func_8002BE04(globalCtx, &mut pos, &mut multDest, &mut wDest);
            (*params).drawGlow = 0 as libc::c_int as u8_0;
            wX = multDest.x * wDest;
            wY = multDest.y * wDest;
            if multDest.z > 1.0f32 && fabsf(wX) < 1.0f32 && fabsf(wY) < 1.0f32
               {
                wZ =
                    (multDest.z * wDest * 16352.0f32) as s32 +
                        16352 as libc::c_int;
                zBuf =
                    gZBuffer[(wY * -120.0f32 + 120.0f32) as s32 as
                                 usize][(wX * 160.0f32 + 160.0f32) as s32 as
                                            usize] as libc::c_int *
                        4 as libc::c_int;
                if wZ < func_8006F0A0(zBuf) >> 3 as libc::c_int {
                    (*params).drawGlow = 1 as libc::c_int as u8_0
                }
            }
        }
        node = (*node).next
...
#[no_mangle]
pub unsafe extern "C" fn Lights_DrawGlow(mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut node: *mut LightNode = 0 as *mut LightNode;
    node = (*globalCtx).lightCtx.listHead;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
    (*__gfxCtx).polyXlu.p = func_800947AC(fresh7);
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gGlowCircleTextureLoadDL.as_mut_ptr() as libc::c_uint;
    while !node.is_null() {
        let mut info: *mut LightInfo = 0 as *mut LightInfo;
        let mut params: *mut LightPoint = 0 as *mut LightPoint;
        let mut scale: f32_0 = 0.;
        let mut pad_0: [s32; 4] = [0; 4];
        info = (*node).info;
        params = &mut (*info).params.point;
        if (*info).type_0 as libc::c_int == LIGHT_POINT_GLOW as libc::c_int &&
               (*params).drawGlow as libc::c_int != 0 {
            scale =
                ((*params).radius as libc::c_int *
                     (*params).radius as libc::c_int) as libc::c_float *
                    0.0000026f32;
            ...
            (*_g_2).words.w0 =
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                ((*params).color[0 as libc::c_int as usize] as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    ((*params).color[1 as libc::c_int as usize] as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*params).color[2 as libc::c_int as usize] as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (50 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            Matrix_Translate((*params).x as f32_0, (*params).y as f32_0,
                             (*params).z as f32_0,
            ...
            (*_g_3).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_lights.c\x00" as *const u8 as
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_4).words.w1 = gGlowCircleDL.as_mut_ptr() as libc::c_uint
        }
        node = (*node).next
    }
