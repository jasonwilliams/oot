...
#[no_mangle]
pub unsafe extern "C" fn __osEPiRawStartDma(mut handle: *mut OSPiHandle,
                                            mut direction: s32,
                                            mut cartAddr: u32_0,
    ...
    *fresh0 =
    ...
    let ref mut fresh1 =
        *((0x4600004 as libc::c_int as libc::c_uint |
               0xa0000000 as libc::c_uint) as *mut *mut libc::c_void);
    *fresh1 =
        (((*handle).baseAddress | cartAddr) &
             0x1fffffff as libc::c_int as libc::c_uint) as *mut libc::c_void
            as *mut libc::c_void;
    match direction {
        0 => {
