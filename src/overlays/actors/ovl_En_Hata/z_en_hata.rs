...
extern "C" {
    ...
    #[no_mangle]
    static mut gFlagpoleCol: CollisionHeader;
    #[no_mangle]
    static mut gFlagpoleFlapAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlagpoleSkel: SkeletonHeader;
}
...
pub const FLAGPOLE_LIMB_MAX: C2RustUnnamed_20 = 21;
pub const FLAGPOLE_LIMB_FLAG_2_HOIST_END: C2RustUnnamed_20 = 20;
pub const FLAGPOLE_LIMB_FLAG_2_HOIST_MID: C2RustUnnamed_20 = 19;
pub const FLAGPOLE_LIMB_FLAG_2_FLY_MID: C2RustUnnamed_20 = 18;
pub const FLAGPOLE_LIMB_FLAG_2_FLY_END: C2RustUnnamed_20 = 17;
pub const FLAGPOLE_LIMB_FLAG_2_FLY_END_BASE: C2RustUnnamed_20 = 16;
pub const FLAGPOLE_LIMB_FLAG_2_FLY_MID_BASE: C2RustUnnamed_20 = 15;
pub const FLAGPOLE_LIMB_FLAG_2_HOIST_MID_BASE: C2RustUnnamed_20 = 14;
pub const FLAGPOLE_LIMB_FLAG_2_HOIST_END_BASE: C2RustUnnamed_20 = 13;
pub const FLAGPOLE_LIMB_FLAG_2_BASE: C2RustUnnamed_20 = 12;
pub const FLAGPOLE_LIMB_FLAG_1_HOIST_END: C2RustUnnamed_20 = 11;
pub const FLAGPOLE_LIMB_FLAG_1_HOIST_MID: C2RustUnnamed_20 = 10;
pub const FLAGPOLE_LIMB_FLAG_1_FLY_MID: C2RustUnnamed_20 = 9;
pub const FLAGPOLE_LIMB_FLAG_1_FLY_END: C2RustUnnamed_20 = 8;
pub const FLAGPOLE_LIMB_FLAG_1_FLY_END_BASE: C2RustUnnamed_20 = 7;
pub const FLAGPOLE_LIMB_FLAG_1_FLY_MID_BASE: C2RustUnnamed_20 = 6;
pub const FLAGPOLE_LIMB_FLAG_1_HOIST_MID_BASE: C2RustUnnamed_20 = 5;
pub const FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE: C2RustUnnamed_20 = 4;
pub const FLAGPOLE_LIMB_FLAG_1_BASE: C2RustUnnamed_20 = 3;
pub const FLAGPOLE_LIMB_POLE: C2RustUnnamed_20 = 2;
pub const FLAGPOLE_LIMB_POLE_BASE: C2RustUnnamed_20 = 1;
pub const FLAGPOLE_LIMB_NONE: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHata {
...
#[no_mangle]
pub static mut En_Hata_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HATA as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_HATA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHata>() as
                                  libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnHata_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHata = thisx as *mut EnHata;
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gFlagpoleFlapAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Actor_SetScale(&mut (*this).dyna.actor, 1.0f32 / 75.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gFlagpoleSkel,
                   &mut gFlagpoleFlapAnim, 0 as *mut Vec3s, 0 as *mut Vec3s,
                   0 as libc::c_int);
    Animation_Change(&mut (*this).skelAnime, &mut gFlagpoleFlapAnim, 1.0f32,
                     0.0f32, frameCount, ANIMMODE_LOOP as libc::c_int as u8_0,
                     0.0f32);
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
    CollisionHeader_GetVirtual(&mut gFlagpoleCol as *mut CollisionHeader as
                                   *mut libc::c_void, &mut colHeader);
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, colHeader);
    (*this).dyna.actor.uncullZoneScale = 500.0f32;
    (*this).dyna.actor.uncullZoneDownward = 550.0f32;
    (*this).dyna.actor.uncullZoneForward = 2200.0f32;
    (*this).invScale = 6 as libc::c_int as s16;
    (*this).maxStep = 1000 as libc::c_int as s16;
    (*this).minStep = 1 as libc::c_int as s16;
    (*this).unk_278 =
        (Rand_ZeroOne() * 0xffff as libc::c_int as libc::c_float) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHata_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHata = thisx as *mut EnHata;
...
#[no_mangle]
pub unsafe extern "C" fn EnHata_Update(mut thisx: *mut Actor,
    ...
    let mut windVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sin: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    // Rotate to hang down by default
    (*this).limbs[FLAGPOLE_LIMB_FLAG_2_BASE as libc::c_int as usize].y =
        -(0x4000 as libc::c_int) as s16;
    (*this).limbs[FLAGPOLE_LIMB_FLAG_1_BASE as libc::c_int as usize].y =
        (*this).limbs[FLAGPOLE_LIMB_FLAG_2_BASE as libc::c_int as usize].y;
    windVec.x = (*globalCtx).envCtx.windDirection.x as f32_0;
    windVec.y = (*globalCtx).envCtx.windDirection.y as f32_0;
    windVec.z = (*globalCtx).envCtx.windDirection.z as f32_0;
    if (*globalCtx).envCtx.windSpeed > 255.0f32 {
        (*globalCtx).envCtx.windSpeed = 255.0f32
    }
    if (*globalCtx).envCtx.windSpeed < 0.0f32 {
        (*globalCtx).envCtx.windSpeed = 0.0f32
    }
    if Rand_ZeroOne() > 0.5f32 {
        (*this).unk_278 =
            ((*this).unk_278 as libc::c_int + 6000 as libc::c_int) as s16
    } else {
        (*this).unk_278 =
            ((*this).unk_278 as libc::c_int + 3000 as libc::c_int) as s16
    }
    // Mimic varying wind gusts
    sin = Math_SinS((*this).unk_278) * 80.0f32;
    pitch = -(Math_Vec3f_Pitch(&mut zeroVec, &mut windVec) as libc::c_int);
    pitch =
        ((15000 as libc::c_int - pitch) as libc::c_float *
             (1.0f32 - (*globalCtx).envCtx.windSpeed / (255.0f32 - sin))) as
            s32 + pitch;
    Math_SmoothStepToS(&mut (*(*this).limbs.as_mut_ptr().offset(FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE
                                                                    as
                                                                    libc::c_int
                                                                    as
                                                                    isize)).y,
                       pitch as s16, (*this).invScale, (*this).maxStep,
                       (*this).minStep);
    (*this).limbs[FLAGPOLE_LIMB_FLAG_2_HOIST_END_BASE as libc::c_int as
                      usize].y =
        (*this).limbs[FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE as libc::c_int as
                          usize].y;
    (*this).limbs[FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE as libc::c_int as
                      usize].z =
        -(Math_Vec3f_Yaw(&mut zeroVec, &mut windVec) as libc::c_int) as s16;
    (*this).limbs[FLAGPOLE_LIMB_FLAG_2_HOIST_END_BASE as libc::c_int as
                      usize].z =
        (*this).limbs[FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE as libc::c_int as
                          usize].z;
    (*this).skelAnime.playSpeed =
        (Rand_ZeroFloat(1.25f32) + 2.75f32) *
            ((*globalCtx).envCtx.windSpeed / 255.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnHata_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnHata = thisx as *mut EnHata;
    let mut limbs: *mut Vec3s = 0 as *mut Vec3s;
    if limbIndex == FLAGPOLE_LIMB_FLAG_2_BASE as libc::c_int ||
           limbIndex == FLAGPOLE_LIMB_FLAG_1_BASE as libc::c_int ||
           limbIndex == FLAGPOLE_LIMB_FLAG_2_HOIST_END_BASE as libc::c_int ||
           limbIndex == FLAGPOLE_LIMB_FLAG_1_HOIST_END_BASE as libc::c_int {
        limbs = (*this).limbs.as_mut_ptr();
        (*rot).x =
            ((*rot).x as libc::c_int +
                 (*limbs.offset(limbIndex as isize)).x as libc::c_int) as s16;
        (*rot).y =
            ((*rot).y as libc::c_int +
                 (*limbs.offset(limbIndex as isize)).y as libc::c_int) as s16;
        (*rot).z =
            ((*rot).z as libc::c_int +
                 (*limbs.offset(limbIndex as isize)).z as libc::c_int) as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHata_PostLimbDraw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut limbIndex: s32,
                                             mut dList: *mut *mut Gfx,
                                             mut rot: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn EnHata_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHata = thisx as *mut EnHata;
    func_800943C8((*globalCtx).state.gfxCtx);
    Matrix_Scale(1.0f32, 1.1f32, 1.0f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnHata_OverrideLimbDraw as
