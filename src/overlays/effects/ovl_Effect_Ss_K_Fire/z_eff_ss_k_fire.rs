...
#[no_mangle]
pub static mut Effect_Ss_K_Fire_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_K_FIRE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsKFire_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsKFire_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsKFireInitParams =
        initParamsx as *mut EffectSsKFireInitParams;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).life = 100 as libc::c_int as s16;
    (*this).regs[6 as libc::c_int as usize] = (*initParams).scaleMax;
    (*this).regs[0 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[2 as libc::c_int as usize] =
        (Rand_ZeroFloat(5.0f32) as s16 as libc::c_int - 0x19 as libc::c_int)
            as s16;
    (*this).regs[3 as libc::c_int as usize] = (*initParams).type_0 as s16;
    (*this).draw =
        Some(EffectSsKFire_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsKFire_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsKFire_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).state.frames.wrapping_mul((*this).regs[2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 usize]
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = gEffFire1DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_k_fire.c\x00" as *const u8 as
                         *const libc::c_char, 220 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsKFire_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    ...
    if (*this).regs[3 as libc::c_int as usize] as libc::c_int ==
           3 as libc::c_int {
        (*this).regs[4 as libc::c_int as usize] += 1
    };
}
