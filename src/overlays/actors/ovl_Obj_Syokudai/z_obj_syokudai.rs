...
extern "C" {
    ...
    #[no_mangle]
    static mut gGoldenTorchDL: [Gfx; 0];
    #[no_mangle]
    static mut gWoodenTorchDL: [Gfx; 0];
    #[no_mangle]
    static mut gTimedTorchDL: [Gfx; 0];
}
...
pub type EnArrowActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnArrow, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Obj_Syokudai_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_SYOKUDAI as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 10 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SYOKUDAI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjSyokudai>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSyokudai_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSyokudai_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSyokudai_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjSyokudai_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCylInitStand: ColliderCylinderInit =
    {
        let mut init =
...
static mut sCylInitFlame: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sLitTorchCount: s32 = 0;
#[no_mangle]
pub unsafe extern "C" fn ObjSyokudai_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    static mut sColTypesStand: [u8_0; 3] =
        [0x9 as libc::c_int as u8_0, 0xb as libc::c_int as u8_0,
         0xb as libc::c_int as u8_0];
    let mut pad: s32 = 0;
    let mut this: *mut ObjSyokudai = thisx as *mut ObjSyokudai;
    let mut torchType: s32 =
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).colliderStand);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderStand,
                         &mut (*this).actor, &mut sCylInitStand);
    (*this).colliderStand.base.colType =
        sColTypesStand[((*this).actor.params as libc::c_int >>
                            0xc as libc::c_int) as usize];
    Collider_InitCylinder(globalCtx, &mut (*this).colliderFlame);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderFlame,
                         &mut (*this).actor, &mut sCylInitFlame);
    ...
    Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                            ...
                            ((*this).actor.world.pos.y + 70.0f32) as s16,
    ...
    (*this).lightNode =
        LightContext_InsertLight(globalCtx, &mut (*globalCtx).lightCtx,
                                 &mut (*this).lightInfo);
    if (*this).actor.params as libc::c_int & 0x400 as libc::c_int != 0 ||
           torchType != 2 as libc::c_int &&
               Flags_GetSwitch(globalCtx,
                               (*this).actor.params as libc::c_int &
                                   0x3f as libc::c_int) != 0 {
        (*this).litTimer = -(1 as libc::c_int) as s16
    }
    (*this).flameTexScroll = (Rand_ZeroOne() * 20.0f32) as s32 as u8_0;
    sLitTorchCount = 0 as libc::c_int;
    Actor_SetFocus(&mut (*this).actor, 60.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSyokudai_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjSyokudai = thisx as *mut ObjSyokudai;
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderStand);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderFlame);
    LightContext_RemoveLight(globalCtx, &mut (*globalCtx).lightCtx,
                             (*this).lightNode);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSyokudai_Update(mut thisx: *mut Actor,
                                            mut globalCtx2:
                                                *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut ObjSyokudai = thisx as *mut ObjSyokudai;
    let mut torchCount: s32 =
    ...
    let mut torchType: s32 =
        (*this).actor.params as libc::c_int & 0xf000 as libc::c_int;
    let mut litTimeScale: s32 = 0;
    let mut dummy: *mut WaterBox = 0 as *mut WaterBox;
    let mut waterSurface: f32_0 = 0.;
    let mut lightRadius: s32 = -(1 as libc::c_int);
    let mut brightness: u8_0 = 0 as libc::c_int as u8_0;
    let mut player: *mut Player = 0 as *mut Player;
    let mut arrow: *mut EnArrow = 0 as *mut EnArrow;
    let mut interactionType: s32 = 0;
    let mut dmgFlags: u32_0 = 0;
    let mut tipToFlame: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    litTimeScale = torchCount;
    if torchCount == 10 as libc::c_int { torchCount = 24 as libc::c_int }
    if WaterBox_GetSurfaceImpl(globalCtx, &mut (*globalCtx).colCtx,
                               (*this).actor.world.pos.x,
                               (*this).actor.world.pos.z, &mut waterSurface,
                               &mut dummy) != 0 &&
           waterSurface - (*this).actor.world.pos.y > 52.0f32 {
        (*this).litTimer = 0 as libc::c_int as s16;
        if torchType == 1 as libc::c_int {
            Flags_UnsetSwitch(globalCtx, switchFlag);
            if torchCount != 0 as libc::c_int {
                (*this).litTimer = 1 as libc::c_int as s16
            }
        }
    } else {
        ...
        interactionType = 0 as libc::c_int;
        if (*this).actor.params as libc::c_int & 0x400 as libc::c_int != 0 {
            (*this).litTimer = -(1 as libc::c_int) as s16
        }
        if torchCount != 0 as libc::c_int {
            if Flags_GetSwitch(globalCtx, switchFlag) != 0 {
                if (*this).litTimer as libc::c_int == 0 as libc::c_int {
                    (*this).litTimer = -(1 as libc::c_int) as s16;
                    if torchType == 0 as libc::c_int {
                        OnePointCutscene_Attention(globalCtx,
                                                   &mut (*this).actor);
                    }
                } else if (*this).litTimer as libc::c_int > 0 as libc::c_int {
                    (*this).litTimer = -(1 as libc::c_int) as s16
                }
            } else if ((*this).litTimer as libc::c_int) < 0 as libc::c_int {
                (*this).litTimer = 20 as libc::c_int as s16
            }
        }
        if (*this).colliderFlame.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            dmgFlags =
                (*(*this).colliderFlame.info.acHitInfo).toucher.dmgFlags;
            if dmgFlags & 0x20820 as libc::c_int as libc::c_uint != 0 {
                interactionType = 1 as libc::c_int
            }
        } else if (*player).heldItemActionParam as libc::c_int ==
                      PLAYER_AP_STICK as libc::c_int {
            Math_Vec3f_Diff(&mut (*(*player).swordInfo.as_mut_ptr().offset(0
                                                                               as
                                                                               libc::c_int
                                                                               as
                                                                               isize)).tip,
                            &mut (*this).actor.world.pos, &mut tipToFlame);
            tipToFlame.y -= 67.0f32;
            if tipToFlame.x * tipToFlame.x + tipToFlame.y * tipToFlame.y +
                   tipToFlame.z * tipToFlame.z < 20.0f32 * 20.0f32 {
                interactionType = -(1 as libc::c_int)
            }
        }
        if interactionType != 0 as libc::c_int {
            if (*this).litTimer as libc::c_int != 0 as libc::c_int {
                if interactionType < 0 as libc::c_int {
                    if (*player).unk_860 as libc::c_int == 0 as libc::c_int {
                        (*player).unk_860 = 210 as libc::c_int as s16;
                        Audio_PlaySoundGeneral(0x2822 as libc::c_int as u16_0,
                                               &mut (*this).actor.projectedPos,
                                               4 as libc::c_int as u8_0,
                                               &mut D_801333E0,
                                               &mut D_801333E0,
                                               &mut D_801333E8);
                    } else if ((*player).unk_860 as libc::c_int) <
                                  200 as libc::c_int {
                        (*player).unk_860 = 200 as libc::c_int as s16
                    }
                } else if dmgFlags & 0x20 as libc::c_int as libc::c_uint != 0
                 {
                    arrow = (*this).colliderFlame.base.ac as *mut EnArrow;
                    if (*arrow).actor.update.is_some() &&
                           (*arrow).actor.id as libc::c_int ==
                               ACTOR_EN_ARROW as libc::c_int {
                        (*arrow).actor.params = 0 as libc::c_int as s16;
                        (*arrow).collider.info.toucher.dmgFlags =
                            0x800 as libc::c_int as u32_0
                    }
                }
                if 0 as libc::c_int <= (*this).litTimer as libc::c_int &&
                       ((*this).litTimer as libc::c_int) <
                           50 as libc::c_int * litTimeScale +
                               100 as libc::c_int &&
                       torchType != 0 as libc::c_int {
                    (*this).litTimer =
                        (50 as libc::c_int * litTimeScale +
                             100 as libc::c_int) as s16
                }
            } else if torchType != 0 as libc::c_int &&
                          (interactionType > 0 as libc::c_int &&
                               dmgFlags &
                                   0x20800 as libc::c_int as libc::c_uint != 0
                               ||
                               interactionType < 0 as libc::c_int &&
                                   (*player).unk_860 as libc::c_int !=
                                       0 as libc::c_int) {
                if interactionType < 0 as libc::c_int &&
                       ((*player).unk_860 as libc::c_int) < 200 as libc::c_int
                   {
                    (*player).unk_860 = 200 as libc::c_int as s16
                }
                if torchCount == 0 as libc::c_int {
                    (*this).litTimer = -(1 as libc::c_int) as s16;
                    if torchType != 2 as libc::c_int {
    ...
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).colliderStand);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderStand.base);
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderStand.base);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).colliderFlame);
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderFlame.base);
    if (*this).litTimer as libc::c_int > 0 as libc::c_int {
        (*this).litTimer -= 1;
        if (*this).litTimer as libc::c_int == 0 as libc::c_int &&
               torchType != 0 as libc::c_int {
    ...
    if (*this).litTimer as libc::c_int != 0 as libc::c_int {
        if ((*this).litTimer as libc::c_int) < 0 as libc::c_int ||
               (*this).litTimer as libc::c_int >= 20 as libc::c_int {
            lightRadius = 200 as libc::c_int
        } else {
            lightRadius =
                ((*this).litTimer as libc::c_int as libc::c_float * 200.0f32 /
                     20.0f32) as s32
        }
        brightness =
    ...
    Lights_PointSetColorAndRadius(&mut (*this).lightInfo, brightness,
                                  brightness, 0 as libc::c_int as u8_0,
                                  lightRadius as s16);
    (*this).flameTexScroll = (*this).flameTexScroll.wrapping_add(1);
}
#[no_mangle]
pub unsafe extern "C" fn ObjSyokudai_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    static mut displayLists: [*mut Gfx; 3] =
        unsafe {
            [gGoldenTorchDL.as_ptr() as *mut _,
             gTimedTorchDL.as_ptr() as *mut _,
             gWoodenTorchDL.as_ptr() as *mut _]
        };
    let mut pad: s32 = 0;
    let mut this: *mut ObjSyokudai = thisx as *mut ObjSyokudai;
    let mut timerMax: s32 = 0;
    timerMax =
        ((*this).actor.params as libc::c_int >> 6 as libc::c_int &
             0xf as libc::c_int) * 50 as libc::c_int + 100 as libc::c_int;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_syokudai.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        displayLists[((*this).actor.params as u16_0 as libc::c_int >>
                          0xc as libc::c_int) as usize] as libc::c_uint;
    if (*this).litTimer as libc::c_int != 0 as libc::c_int {
        let mut flameScale: f32_0 = 1.0f32;
        if (*this).litTimer as libc::c_int > timerMax {
            flameScale =
                (timerMax - (*this).litTimer as libc::c_int +
                     10 as libc::c_int) as libc::c_float / 10.0f32
        } else if (*this).litTimer as libc::c_int > 0 as libc::c_int &&
                      ((*this).litTimer as libc::c_int) < 20 as libc::c_int {
            flameScale =
                (*this).litTimer as libc::c_int as libc::c_float / 20.0f32
        }
        flameScale *= 0.0027f32;
        ...
        (*_g_1).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             ((*this).flameTexScroll as libc::c_int *
            ...
            (255 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        Matrix_Translate(0.0f32, 52.0f32, 0.0f32,
        ...
        Matrix_RotateY((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                       ...
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(flameScale, flameScale, flameScale,
                     MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_5).words.w1 = gEffFire1DL.as_mut_ptr() as libc::c_uint
    }
