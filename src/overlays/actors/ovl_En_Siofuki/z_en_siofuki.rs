...
extern "C" {
    ...
    #[no_mangle]
    static mut object_siofuki_DL_000B70: [Gfx; 0];
    #[no_mangle]
    static mut object_siofuki_Col_000D78: CollisionHeader;
}
...
pub const EN_SIOFUKI_LOWERING: C2RustUnnamed_20 = 1;
pub const EN_SIOFUKI_RAISING: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSiofuki {
    pub dyna: DynaPolyActor,
    pub actionFunc: EnSiofukiActionFunc,
    pub timer: s32,
    pub initPosY: f32_0,
    pub unk_170: f32_0,
    pub unk_174: f32_0,
    pub oscillation: f32_0,
    pub targetHeight: f32_0,
    pub currentHeight: f32_0,
    pub splashTimer: s32,
    pub applySpeed: s32,
    pub appliedSpeed: f32_0,
    pub targetAppliedSpeed: f32_0,
    pub appliedYaw: s16,
    pub activeTime: s16,
    pub maxHeight: f32_0,
    pub sfxFlags: u8_0,
}
pub type EnSiofukiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSiofuki, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Siofuki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SIOFUKI as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SIOFUKI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSiofuki>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSiofuki_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSiofuki_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnSiofuki_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSiofuki = thisx as *mut EnSiofuki;
    let mut type_0: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad: s32 = 0;
    if (*thisx).room as libc::c_int == 10 as libc::c_int &&
           Flags_GetSwitch(globalCtx, 0x1e as libc::c_int) != 0 {
        Actor_Kill(thisx);
        return
    }
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    DynaPolyActor_Init(&mut (*this).dyna, DPM_PLAYER as libc::c_int);
    CollisionHeader_GetVirtual(&mut object_siofuki_Col_000D78 as
    ...
    (*this).unk_174 = 35.0f32;
    (*this).unk_170 = -6058.0f32 + (*this).unk_174;
    if (*thisx).shape.rot.x as libc::c_int != 0 as libc::c_int {
        (*this).maxHeight =
            (*thisx).shape.rot.x as libc::c_int as libc::c_float * 40.0f32;
        (*this).currentHeight = (*this).maxHeight
    }
    (*this).activeTime = 0 as libc::c_int as s16;
    if (*thisx).shape.rot.y as libc::c_int != 0 as libc::c_int {
        (*this).activeTime = (*thisx).shape.rot.y
    }
    if (*thisx).shape.rot.z as libc::c_int != 0 as libc::c_int {
        (*thisx).scale.x =
            (*thisx).shape.rot.z as libc::c_int as libc::c_float *
                (1.0f32 / 1.73f32) * 0.1f32;
        (*thisx).scale.z =
            (*thisx).shape.rot.z as libc::c_int as libc::c_float * 0.5f32 *
                0.1f32
    }
    (*thisx).world.rot.x = 0 as libc::c_int as s16;
    ...
    type_0 =
        (*thisx).params as u16_0 as libc::c_int >> 0xc as libc::c_int &
            0xf as libc::c_int;
    if type_0 == EN_SIOFUKI_RAISING as libc::c_int {
        (*this).currentHeight = 10.0f32;
        (*this).targetHeight = 10.0f32;
        (*this).actionFunc =
            Some(func_80AFC34C as
                     unsafe extern "C" fn(_: *mut EnSiofuki,
                                          _: *mut GlobalContext) -> ())
    } else if type_0 == EN_SIOFUKI_LOWERING as libc::c_int {
        if Flags_GetTreasure(globalCtx,
                             (*thisx).params as u16_0 as libc::c_int &
                                 0x3f as libc::c_int) != 0 {
            (*this).currentHeight = -45.0f32;
            (*this).targetHeight = -45.0f32;
            (*this).actionFunc =
                Some(func_80AFC544 as
                         unsafe extern "C" fn(_: *mut EnSiofuki,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).targetHeight = (*this).currentHeight;
            (*this).actionFunc =
                Some(func_80AFC478 as
                         unsafe extern "C" fn(_: *mut EnSiofuki,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnSiofuki_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnSiofuki = thisx as *mut EnSiofuki;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFBDC8(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).oscillation =
        sinf(((*globalCtx).gameplayFrames &
                  0x1f as libc::c_int as libc::c_uint) as libc::c_float /
                 32.0f32 * 3.14159265358979323846f32 * 2.0f32) * 4.0f32;
    (*this).unk_170 =
        (*this).unk_174 * 10.0f32 + -6058.0f32 -
            (*this).oscillation * 10.0f32;
    (*this).unk_174 = 35.0f32;
    (*this).dyna.actor.world.pos.y =
        (*this).initPosY + (*this).currentHeight + (*this).oscillation;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFBE8C(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut dZ: f32_0 = 0.;
    let mut angle: s16 = 0;
    let mut dAngle: s16 = 0;
    let mut dist2d: f32_0 = 0.;
    let mut speedScale: f32_0 = 0.;
    ...
    if dX > (*this).dyna.actor.scale.x * -346.0f32 &&
           dX < (*this).dyna.actor.scale.x * 346.0f32 &&
           dZ > (*this).dyna.actor.scale.z * -400.0f32 &&
           dZ < (*this).dyna.actor.scale.z * 400.0f32 && dY < 0.0f32 {
        if func_8004356C(&mut (*this).dyna) != 0 {
            if (*this).splashTimer <= 0 as libc::c_int {
                EffectSsGSplash_Spawn(globalCtx,
                                      &mut (*player).actor.world.pos,
                                      0 as *mut Color_RGBA8,
                                      0 as *mut Color_RGBA8,
                                      1 as libc::c_int as s16,
                                      1 as libc::c_int as s16);
                (*this).splashTimer = 10 as libc::c_int
            } else { (*this).splashTimer -= 1 }
            (*this).applySpeed = 0 as libc::c_int;
            (*this).appliedSpeed = 0.0f32;
            (*this).targetAppliedSpeed = 0.0f32
        } else {
            dist2d = sqrtf(dX * dX + dZ * dZ);
            (*this).applySpeed = 1 as libc::c_int;
            (*this).splashTimer = 0 as libc::c_int;
            angle =
                (Math_FAtan2F(dX, dZ) *
            ...
            dAngle =
                (((*player).actor.world.rot.y as libc::c_int ^
                      0x8000 as libc::c_int) - angle as libc::c_int) as s16;
            (*player).actor.gravity = 0.0f32;
            (*player).actor.velocity.y = 0.0f32;
            Math_SmoothStepToF(&mut (*player).actor.world.pos.y,
                               (*this).dyna.actor.world.pos.y, 0.5f32, 4.0f32,
                               1.0f32);
            if (dAngle as libc::c_int) < 0x4000 as libc::c_int &&
                   dAngle as libc::c_int > -(0x4000 as libc::c_int) {
                (*this).appliedYaw =
                    ((*player).actor.world.rot.y as libc::c_int ^
                         0x8000 as libc::c_int) as s16;
                speedScale =
                    dist2d / ((*this).dyna.actor.scale.x * 40.0f32 * 10.0f32);
                speedScale =
                    if speedScale < 0.0f32 { 0.0f32 } else { speedScale };
                speedScale =
                    if speedScale > 1.0f32 { 1.0f32 } else { speedScale };
                (*player).linearVelocity *= speedScale;
                Math_ApproachF(&mut (*this).targetAppliedSpeed, 3.0f32,
                               1.0f32, 1.0f32);
                Math_ApproachF(&mut (*this).appliedSpeed,
                               (*this).targetAppliedSpeed, 1.0f32,
                               0.3f32 * speedScale);
            } else {
                (*this).appliedYaw = (*player).actor.world.rot.y;
                (*player).linearVelocity /= 2.0f32;
                Math_ApproachF(&mut (*this).targetAppliedSpeed, 3.0f32,
                               1.0f32, 1.0f32);
                Math_ApproachF(&mut (*this).appliedSpeed,
                               (*this).targetAppliedSpeed, 1.0f32, 0.1f32);
            }
            (*player).windDirection = (*this).appliedYaw;
            (*player).windSpeed = (*this).appliedSpeed
        }
    } else {
        if (*this).applySpeed != 0 {
            (*player).linearVelocity =
                (*this).appliedSpeed + (*player).linearVelocity;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFC1D0(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).currentHeight, (*this).targetHeight,
                       0.8f32, 3.0f32, 0.01f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFC218(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer < 0 as libc::c_int {
        Flags_UnsetSwitch(globalCtx,
                          (*this).dyna.actor.params as u16_0 as libc::c_int >>
                              6 as libc::c_int & 0x3f as libc::c_int);
    ...
    } else { func_8002F994(&mut (*this).dyna.actor, (*this).timer); }
    if (*this).dyna.actor.params as u16_0 as libc::c_int >> 0xc as libc::c_int
           & 0xf as libc::c_int == EN_SIOFUKI_LOWERING as libc::c_int &&
           Flags_GetTreasure(globalCtx,
                             (*this).dyna.actor.params as u16_0 as libc::c_int
                                 & 0x3f as libc::c_int) != 0 {
        (*this).currentHeight = -45.0f32;
        (*this).targetHeight = -45.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFC34C(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AFBDC8(this, globalCtx);
    func_80AFBE8C(this, globalCtx);
    func_80AFC1D0(this, globalCtx);
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as u16_0 as libc::c_int >>
                           6 as libc::c_int & 0x3f as libc::c_int) != 0 {
        (*this).targetHeight = 400.0f32;
        (*this).timer = 300 as libc::c_int;
        (*this).actionFunc =
            Some(func_80AFC218 as
                     unsafe extern "C" fn(_: *mut EnSiofuki,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFC3C8(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AFBDC8(this, globalCtx);
    func_80AFBE8C(this, globalCtx);
    func_80AFC1D0(this, globalCtx);
    (*this).timer -= 1;
    if (*this).timer < 0 as libc::c_int {
        (*this).timer = (*this).activeTime as libc::c_int * 20 as libc::c_int;
        (*this).targetHeight = -45.0f32;
        (*this).actionFunc =
            Some(func_80AFC218 as
                     unsafe extern "C" fn(_: *mut EnSiofuki,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFC478(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AFBDC8(this, globalCtx);
    func_80AFBE8C(this, globalCtx);
    func_80AFC1D0(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFC544(mut this: *mut EnSiofuki,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AFBDC8(this, globalCtx);
    func_80AFC1D0(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnSiofuki_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSiofuki = thisx as *mut EnSiofuki;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnSiofuki_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSiofuki = thisx as *mut EnSiofuki;
    let mut x: u32_0 = 0;
    let mut y: u32_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_siofuki.c\x00" as *const u8 as
                        *const libc::c_char, 654 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    Matrix_Translate(0.0f32, (*this).unk_170, 0.0f32,
    ...
    x = gameplayFrames.wrapping_mul(15 as libc::c_int as libc::c_uint);
    y = gameplayFrames.wrapping_mul(-(15 as libc::c_int) as libc::c_uint);
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int, x, y,
                         64 as libc::c_int, 64 as libc::c_int,
                         1 as libc::c_int, x, y, 64 as libc::c_int,
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = object_siofuki_DL_000B70.as_mut_ptr() as libc::c_uint;
    ...
    if (*this).sfxFlags as libc::c_int & 1 as libc::c_int != 0 {
        let mut heightRatio: f32_0 = 0.;
        match (*thisx).params as u16_0 as libc::c_int >> 0xc as libc::c_int &
                  0xf as libc::c_int {
            0 => {
                heightRatio =
                    ((*this).currentHeight - 10.0f32) / (400.0f32 - 10.0f32);
                func_800F436C(&mut (*thisx).projectedPos,
                              (0x2841 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0, 1.0f32 + heightRatio);
            }
            1 => {
                if (*this).currentHeight > -35.0f32 {
                    heightRatio =
                        ((*this).currentHeight - -35.0f32) /
                            ((*this).maxHeight - -35.0f32);
                    func_800F436C(&mut (*thisx).projectedPos,
                                  (0x2841 as libc::c_int -
