...
extern "C" {
    ...
    fn Graph_CloseDisps(dispRefs: *mut *mut Gfx, gfxCtx: *mut GraphicsContext,
                        file: *const libc::c_char, line: s32);
    #[no_mangle]
    static mut object_ssh_Anim_000304: AnimationHeader;
    #[no_mangle]
    static mut object_ssh_Tex_0007E0: [u64_0; 0];
    #[no_mangle]
    static mut object_ssh_Tex_000C60: [u64_0; 0];
    #[no_mangle]
    static mut object_ssh_Tex_001060: [u64_0; 0];
    #[no_mangle]
    static mut object_ssh_DL_004080: [Gfx; 0];
    #[no_mangle]
    static mut object_ssh_DL_0046C0: [Gfx; 0];
    #[no_mangle]
    static mut object_ssh_DL_004DE8: [Gfx; 0];
    #[no_mangle]
    static mut object_ssh_Skel_0052E0: SkeletonHeader;
    #[no_mangle]
    static mut object_ssh_Anim_0055F8: AnimationHeader;
    #[no_mangle]
    static mut object_ssh_Anim_005BE8: AnimationHeader;
}
...
pub struct EnSsh {
    ...
    pub actionFunc: EnSshActionFunc,
    pub colCylinder: [ColliderCylinder; 6],
    pub colSph: ColliderJntSph,
    pub colSphElements: [ColliderJntSphElement; 1],
    pub initialYaw: s16,
    pub maxTurnRate: s16,
    pub unkTimer: s16,
    pub spinTimer: s16,
...
pub type EnSshActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSsh, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const SSH_ANIM_UNK6: C2RustUnnamed_23 = 6;
pub const SSH_ANIM_UNK5: C2RustUnnamed_23 = 5;
pub const SSH_ANIM_DROP: C2RustUnnamed_23 = 4;
pub const SSH_ANIM_LAND: C2RustUnnamed_23 = 3;
pub const SSH_ANIM_WAIT: C2RustUnnamed_23 = 2;
pub const SSH_ANIM_UP: C2RustUnnamed_23 = 1;
pub const SSH_ANIM_UNK0: C2RustUnnamed_23 = 0;
#[no_mangle]
pub static mut En_Ssh_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SSH as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_SSH as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSsh>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetupAction(mut this: *mut EnSsh,
                                           mut actionFunc: EnSshActionFunc) {
    (*this).actionFunc = actionFunc; // Needed for matching
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SpawnShockwave(mut this: *mut EnSsh,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    EffectSsBlast_SpawnWhiteCustomScale(globalCtx, &mut pos, &mut zeroVec,
                                        &mut zeroVec,
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CreateBlureEffect(mut globalCtx:
                                                     *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CheckCeilingPos(mut this: *mut EnSsh,
                                               mut globalCtx:
                                                   *mut GlobalContext)
 -> s32 {
    let mut poly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgId: s32 = 0;
    let mut posB: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    posB.x = (*this).actor.world.pos.x;
    posB.y = (*this).actor.world.pos.y + 1000.0f32;
    posB.z = (*this).actor.world.pos.z;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                               &mut (*this).actor.world.pos, &mut posB,
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_AddBlureVertex(mut this: *mut EnSsh) {
    let mut p1base: Vec3f =
        { let mut init = Vec3f{x: 834.0f32, y: 834.0f32, z: 0.0f32,}; init };
    let mut p2base: Vec3f =
        { let mut init = Vec3f{x: 834.0f32, y: -584.0f32, z: 0.0f32,}; init };
    let mut p1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut p2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    Matrix_Push();
    Matrix_MultVec3f(&mut p1base, &mut p1);
    Matrix_MultVec3f(&mut p2base, &mut p2);
    Matrix_Pop();
    EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIdx) as
                              *mut EffectBlure, &mut p1, &mut p2);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_AddBlureSpace(mut this: *mut EnSsh) {
    EffectBlure_AddSpace(Effect_GetByIndex((*this).blureIdx) as
                             *mut EffectBlure);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_InitColliders(mut this: *mut EnSsh,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut cylinders: [*mut ColliderCylinderInit; 6] =
        [&mut sCylinderInit1, &mut sCylinderInit1, &mut sCylinderInit1,
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).colSph, &mut (*this).actor,
                       &mut sJntSphInit, (*this).colSphElements.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetAnimation(mut this: *mut EnSsh,
                                            mut animIndex: s32) -> f32_0 {
    let mut animation: [*mut AnimationHeader; 7] =
        [&mut object_ssh_Anim_005BE8, &mut object_ssh_Anim_000304,
         &mut object_ssh_Anim_000304, &mut object_ssh_Anim_0055F8,
         &mut object_ssh_Anim_000304, &mut object_ssh_Anim_000304,
         &mut object_ssh_Anim_005BE8];
    let mut playbackSpeed: [f32_0; 7] =
        [1.0f32, 4.0f32, 1.0f32, 1.0f32, 8.0f32, 6.0f32, 2.0f32];
    let mut mode: [u8_0; 7] =
    ...
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(animation[animIndex as usize] as
                                   *mut libc::c_void) as f32_0;
    let mut pad: s32 = 0;
    Animation_Change(&mut (*this).skelAnime, animation[animIndex as usize],
                     playbackSpeed[animIndex as usize], 0.0f32, frameCount,
                     mode[animIndex as usize], -6.0f32);
    return frameCount;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetWaitAnimation(mut this: *mut EnSsh) {
    EnSsh_SetAnimation(this, SSH_ANIM_WAIT as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetReturnAnimation(mut this: *mut EnSsh) {
    Audio_PlayActorSound2(&mut (*this).actor, 0x3869 as libc::c_int as u16_0);
    EnSsh_SetAnimation(this, SSH_ANIM_UP as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetLandAnimation(mut this: *mut EnSsh) {
    (*this).actor.world.pos.y =
        (*this).floorHeightOffset + (*this).actor.floorHeight;
    (*this).animTimer =
        EnSsh_SetAnimation(this, SSH_ANIM_LAND as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetDropAnimation(mut this: *mut EnSsh) {
    if (*this).unkTimer as libc::c_int == 0 as libc::c_int {
        (*this).animTimer =
            EnSsh_SetAnimation(this, SSH_ANIM_DROP as libc::c_int) as s16
    }
    (*this).actor.velocity.y = -10.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetStunned(mut this: *mut EnSsh) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetColliderScale(mut this: *mut EnSsh,
                                                mut scale: f32_0,
                                                mut radiusMod: f32_0) {
    ...
    Actor_SetScale(&mut (*this).actor, 0.04f32 * scale);
    (*this).floorHeightOffset = 40.0f32 * scale;
    (*this).colliderScale = scale * 1.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Damaged(mut this: *mut EnSsh) -> s32 {
    if (*this).stunTimer as libc::c_int == 120 as libc::c_int &&
           (*this).stateFlags as libc::c_int &
    ...
    if (if (*this).stunTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).stunTimer -= 1; (*this).stunTimer as libc::c_int })
           != 0 as libc::c_int {
        Math_SmoothStepToS(&mut (*this).maxTurnRate,
        ...
        (*this).spinTimer = 0 as libc::c_int as s16;
        if (*this).swayTimer as libc::c_int == 0 as libc::c_int {
            (*this).spinTimer = 30 as libc::c_int as s16
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3884 as libc::c_int as u16_0);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x6868 as libc::c_int as u16_0);
        return 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Turn(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
    if (*this).hitTimer as libc::c_int != 0 as libc::c_int {
        (*this).hitTimer -= 1
    }
    if (if (*this).spinTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).spinTimer -= 1; (*this).spinTimer as libc::c_int })
           != 0 as libc::c_int {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_float +
                 10000.0f32 *
                     ((*this).spinTimer as libc::c_int as libc::c_float /
                          30.0f32)) as s16
    } else if (*this).swayTimer as libc::c_int == 0 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Stunned(mut this: *mut EnSsh,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).swayTimer as libc::c_int == 0 as libc::c_int &&
           (*this).stunTimer as libc::c_int == 0 as libc::c_int {
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                           ...
                           4 as libc::c_int as s16, (*this).maxTurnRate,
                           1 as libc::c_int as s16);
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_UpdateYaw(mut this: *mut EnSsh,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).stunTimer as libc::c_int != 0 as libc::c_int {
        EnSsh_Stunned(this, globalCtx);
    } else { EnSsh_Turn(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Bob(mut this: *mut EnSsh,
                                   mut globalCtx: *mut GlobalContext) {
    let mut bobVel: f32_0 = 0.5f32;
    if (*globalCtx).state.frames & 8 as libc::c_int as libc::c_uint !=
           0 as libc::c_int as libc::c_uint {
        bobVel *= -1.0f32
    }
    Math_SmoothStepToF(&mut (*this).actor.velocity.y, bobVel, 0.4f32,
                       1000.0f32, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_IsCloseToLink(mut this: *mut EnSsh,
                                             mut globalCtx:
    ...
    if (*this).actor.xzDistToPlayer > 160.0f32 { return 0 as libc::c_int }
    yDist = (*this).actor.world.pos.y - (*player).actor.world.pos.y;
    if yDist < 0.0f32 || yDist > 400.0f32 { return 0 as libc::c_int }
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_IsCloseToHome(mut this: *mut EnSsh) -> s32 {
    let mut vel: f32_0 = (*this).actor.velocity.y;
    let mut nextY: f32_0 =
        (*this).actor.world.pos.y + 2.0f32 * (*this).actor.velocity.y;
    if nextY >= (*this).actor.home.pos.y { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_IsCloseToGround(mut this: *mut EnSsh) -> s32 {
    let mut vel: f32_0 = (*this).actor.velocity.y;
    let mut nextY: f32_0 =
        (*this).actor.world.pos.y + 2.0f32 * (*this).actor.velocity.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Sway(mut this: *mut EnSsh) {
    let mut swayVecBase: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut swayVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp: f32_0 = 0.;
    let mut swayAngle: s16 = 0;
    if (*this).swayTimer as libc::c_int != 0 as libc::c_int {
        (*this).swayAngle =
            ((*this).swayAngle as libc::c_int + 0x640 as libc::c_int) as s16;
        (*this).swayTimer -= 1;
        if (*this).swayTimer as libc::c_int == 0 as libc::c_int {
        ...
        temp =
            (*this).swayTimer as libc::c_int as libc::c_float *
                (1.0f32 / 6 as libc::c_int as libc::c_float);
        swayAngle =
            (temp * (0x10000 as libc::c_int as libc::c_float / 360.0f32) *
                 Math_SinS((*this).swayAngle)) as s16;
        ...
        Matrix_MultVec3f(&mut swayVecBase, &mut swayVec);
        Matrix_Pop();
        (*this).actor.shape.rot.z =
            -(swayAngle as libc::c_int * 2 as libc::c_int) as s16;
        (*this).actor.world.pos.x = swayVec.x;
        (*this).actor.world.pos.z = swayVec.z
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CheckBodyStickHit(mut this: *mut EnSsh,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    if (*player).unk_860 as libc::c_int != 0 as libc::c_int {
        (*info).bumper.dmgFlags |= 2 as libc::c_int as libc::c_uint;
        (*this).colCylinder[1 as libc::c_int as usize].info.bumper.dmgFlags &=
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CheckHitPlayer(mut this: *mut EnSsh,
                                              mut globalCtx:
                                                  *mut GlobalContext) -> s32 {
    let mut i: s32 = 0;
    let mut hit: s32 = 0 as libc::c_int;
    if (*this).hitCount as libc::c_int == 0 as libc::c_int &&
           (*this).spinTimer as libc::c_int == 0 as libc::c_int {
        return 0 as libc::c_int
    }
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if (*this).colCylinder[(i + 3 as libc::c_int) as usize].base.ocFlags2
    ...
    (*this).hitTimer = 30 as libc::c_int as s16;
    if (*this).swayTimer as libc::c_int == 0 as libc::c_int {
        (*this).spinTimer = (*this).hitTimer
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x3884 as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x6868 as libc::c_int as u16_0);
    ...
    (*this).hitCount = (*this).hitCount.wrapping_sub(1);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CheckHitFront(mut this: *mut EnSsh) -> s32 {
    let mut acFlags: u32_0 = 0;
    ((*this).colCylinder[2 as libc::c_int as usize].base.acFlags) != 0;
    acFlags =
        (*this).colCylinder[2 as libc::c_int as usize].base.acFlags as u32_0;
    if (acFlags & ((1 as libc::c_int) << 1 as libc::c_int) as libc::c_uint !=
            0) as libc::c_int == 0 as libc::c_int {
        return 0 as libc::c_int
    } else {
        (*this).colCylinder[2 as libc::c_int as usize].base.acFlags =
            ((*this).colCylinder[2 as libc::c_int as usize].base.acFlags as
                ...
                u8_0;
        (*this).invincibilityTimer = 8 as libc::c_int as s16;
        if (*this).swayTimer as libc::c_int == 0 as libc::c_int &&
               (*this).hitTimer as libc::c_int == 0 as libc::c_int &&
               (*this).stunTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CheckHitBack(mut this: *mut EnSsh,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_CollisionCheck(mut this: *mut EnSsh,
                                              mut globalCtx:
                                                  *mut GlobalContext) -> s32 {
    if (*this).stunTimer as libc::c_int == 0 as libc::c_int {
        EnSsh_CheckHitPlayer(this, globalCtx);
    }
    if EnSsh_CheckHitFront(this) != 0 {
        return 0 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetBodyCylinderAC(mut this: *mut EnSsh,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetLegsCylinderAC(mut this: *mut EnSsh,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    if (angleTowardsLink as libc::c_int) <
           90 as libc::c_int * (0x10000 as libc::c_int / 360 as libc::c_int) {
        Collider_UpdateCylinder(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_SetCylinderOC(mut this: *mut EnSsh,
                                             mut globalCtx:
                                                 *mut GlobalContext) -> s32 {
    ...
    while i < 3 as libc::c_int {
        ...
        Matrix_Translate(cylPos.x, cylPos.y, cylPos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY((*this).initialYaw as libc::c_int as libc::c_float /
...
pub unsafe extern "C" fn EnSsh_SetColliders(mut this: *mut EnSsh,
    ...
    if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int {
        ...
        if (if (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 = 0.;
    let mut pad: s32 = 0;
    let mut this: *mut EnSsh = thisx as *mut EnSsh;
    frameCount =
        Animation_GetLastFrame(&mut object_ssh_Anim_000304 as
    ...
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_ssh_Skel_0052E0, 0 as *mut AnimationHeader,
                   (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 30 as libc::c_int);
    Animation_Change(&mut (*this).skelAnime, &mut object_ssh_Anim_000304,
    ...
    (*this).hitCount = 0 as libc::c_int as u8_0;
    EnSsh_CheckCeilingPos(this, globalCtx);
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        EnSsh_SetColliderScale(this, 0.5f32, 1.0f32);
    } else { EnSsh_SetColliderScale(this, 0.75f32, 1.0f32); }
    (*this).actor.gravity = 0.0f32;
    (*this).initialYaw = (*this).actor.world.rot.y;
    EnSsh_SetupAction(this,
                      Some(EnSsh_Start as
                               unsafe extern "C" fn(_: *mut EnSsh,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSsh = thisx as *mut EnSsh;
    let mut i: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Wait(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
    if EnSsh_IsCloseToLink(this, globalCtx) != 0 {
        ...
        EnSsh_SetupAction(this,
                          Some(EnSsh_Drop as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
                                       -> ()));
    } else { EnSsh_Bob(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Talk(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Idle(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        if (*this).actor.textId as libc::c_int == 0x26 as libc::c_int ||
               (*this).actor.textId as libc::c_int == 0x27 as libc::c_int {
            gSaveContext.infTable[25 as libc::c_int as usize] =
                (gSaveContext.infTable[25 as libc::c_int as usize] as
                     libc::c_int | 0x40 as libc::c_int) as u16_0
        }
        if (*this).actor.textId as libc::c_int == 0x24 as libc::c_int ||
               (*this).actor.textId as libc::c_int == 0x25 as libc::c_int {
            gSaveContext.infTable[25 as libc::c_int as usize] =
                (gSaveContext.infTable[25 as libc::c_int as usize] as
                    ...
                    if (*this).actor.params as libc::c_int == 0 as libc::c_int
                       {
                        if gSaveContext.inventory.gsTokens as libc::c_int >=
                               50 as libc::c_int {
                            (*this).actor.textId =
                                0x29 as libc::c_int as u16_0
                        } else if gSaveContext.inventory.gsTokens as
                                      libc::c_int >= 10 as libc::c_int {
                            if gSaveContext.infTable[25 as libc::c_int as
                                                         usize] as libc::c_int
                                   & 0x80 as libc::c_int != 0 {
                                (*this).actor.textId =
                                    0x24 as libc::c_int as u16_0
                            } else {
                                (*this).actor.textId =
                                    0x25 as libc::c_int as u16_0
                            }
                        } else if gSaveContext.infTable[25 as libc::c_int as
                                                            usize] as
                                      libc::c_int & 0x40 as libc::c_int != 0 {
                            (*this).actor.textId =
                                0x27 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x26 as libc::c_int as u16_0
                        }
                    } else {
                        (*this).actor.textId = 0x22 as libc::c_int as u16_0
                    }
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Land(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
    if (*this).unkTimer as libc::c_int != 0 as libc::c_int &&
           (if (*this).unkTimer as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else { (*this).unkTimer -= 1; (*this).unkTimer as libc::c_int })
               == 0 as libc::c_int {
        EnSsh_SetAnimation(this, SSH_ANIM_WAIT as libc::c_int);
    }
    if (*this).animTimer as libc::c_int != 0 as libc::c_int &&
    ...
    if (*this).actor.floorHeight + (*this).floorHeightOffset <=
        ...
        Math_SmoothStepToF(&mut (*this).actor.velocity.y, 2.0f32, 0.6f32,
                           1000.0f32, 0.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Drop(mut this: *mut EnSsh,
                                    mut globalCtx: *mut GlobalContext) {
    if (*this).unkTimer as libc::c_int != 0 as libc::c_int &&
           (if (*this).unkTimer as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
               ...
               == 0 as libc::c_int {
        EnSsh_SetAnimation(this, SSH_ANIM_DROP as libc::c_int);
    }
    if EnSsh_IsCloseToLink(this, globalCtx) == 0 {
        EnSsh_SetReturnAnimation(this);
        EnSsh_SetupAction(this,
                          Some(EnSsh_Return as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
                                       -> ()));
    } else if EnSsh_IsCloseToGround(this) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Return(mut this: *mut EnSsh,
                                      mut globalCtx: *mut GlobalContext) {
    let mut frameRatio: f32_0 =
        (*this).skelAnime.curFrame / ((*this).skelAnime.animLength - 1.0f32);
    if frameRatio == 1.0f32 { EnSsh_SetReturnAnimation(this); }
    if EnSsh_IsCloseToLink(this, globalCtx) != 0 {
        EnSsh_SetDropAnimation(this);
        EnSsh_SetupAction(this,
                          Some(EnSsh_Drop as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
                                       -> ()));
    } else if EnSsh_IsCloseToHome(this) != 0 {
        ...
        EnSsh_SetupAction(this,
                          Some(EnSsh_Wait as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
                                       -> ()));
    } else { (*this).actor.velocity.y = 4.0f32 * frameRatio };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_UpdateColliderScale(mut this: *mut EnSsh) {
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 4 as libc::c_int != 0 {
        if (*this).spinTimer as libc::c_int == 0 as libc::c_int {
            (*this).stateFlags =
                ((*this).stateFlags as libc::c_int &
    ...
    } else if (*this).spinTimer as libc::c_int != 0 as libc::c_int {
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int |
                 (1 as libc::c_int) << 4 as libc::c_int) as u16_0;
        if (*this).actor.params as libc::c_int != 0 as libc::c_int {
            EnSsh_SetColliderScale(this, 0.5f32, 2.0f32);
        } else { EnSsh_SetColliderScale(this, 0.75f32, 2.0f32); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Start(mut this: *mut EnSsh,
                                     mut globalCtx: *mut GlobalContext) {
    if EnSsh_IsCloseToGround(this) == 0 {
        EnSsh_SetupAction(this,
                          Some(EnSsh_Wait as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
        ...
        EnSsh_SetLandAnimation(this);
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int | 4 as libc::c_int) as u16_0;
        EnSsh_SetupAction(this,
                          Some(EnSsh_Land as
                                   unsafe extern "C" fn(_: *mut EnSsh,
                                                        _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnSsh = thisx as *mut EnSsh;
    EnSsh_UpdateColliderScale(this);
    if EnSsh_CollisionCheck(this, globalCtx) != 0 {
        return
        // EnSsh_CollisionCheck always returns false, so this never happens
    }
    if (*this).stunTimer as libc::c_int != 0 as libc::c_int {
        EnSsh_Damaged(this);
    } else {
    ...
    if (*this).blinkState as libc::c_int >= 3 as libc::c_int {
        (*this).blinkState = 0 as libc::c_int as s16
    }
    EnSsh_SetColliders(this, globalCtx);
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnSsh_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
    ...
    match limbIndex {
        1 => {
            if (*this).spinTimer as libc::c_int != 0 as libc::c_int &&
                ...
                if (*this).spinTimer as libc::c_int >= 2 as libc::c_int {
                    EnSsh_AddBlureVertex(this);
                } else { EnSsh_AddBlureSpace(this); }
            }
        }
        4 => {
            if (*this).actor.params as libc::c_int == 0 as libc::c_int {
                *dList = object_ssh_DL_0046C0.as_mut_ptr()
            }
        }
        5 => {
            if (*this).actor.params as libc::c_int == 0 as libc::c_int {
                *dList = object_ssh_DL_004080.as_mut_ptr()
            }
        }
        8 => {
            if (*this).actor.params as libc::c_int == 0 as libc::c_int {
                *dList = object_ssh_DL_004DE8.as_mut_ptr()
            }
        }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSsh_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    static mut blinkTex: [*mut libc::c_void; 3] =
        unsafe {
            [object_ssh_Tex_0007E0.as_ptr() as *mut _ as *mut libc::c_void,
             object_ssh_Tex_000C60.as_ptr() as *mut _ as *mut libc::c_void,
             object_ssh_Tex_001060.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut pad: s32 = 0;
    let mut this: *mut EnSsh = thisx as *mut EnSsh;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ssh.c\x00" as *const u8 as *const libc::c_char,
                    2333 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((blinkTex[(*this).blinkState as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(blinkTex[(*this).blinkState as
                                                       usize] as u32_0 &
    ...
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      ...
                      Some(EnSsh_OverrideLimbDraw as
                ...
                ColliderJntSphInit{base:
                                   ...
                                   count:
                                       (::std::mem::size_of::<[ColliderJntSphElementInit; 1]>()
                                           ...
                                           as s32,
                                   elements:
                                       sJntSphElementsInit.as_mut_ptr(),};
            init
        }
}
#[used]
