...
extern "C" {
    ...
    fn OnePointCutscene_Init(globalCtx: *mut GlobalContext, csId: s16,
     ...
     -> s16;
    #[no_mangle]
    static mut gGerudoFortressGTGShutterDL: [Gfx; 0];
    #[no_mangle]
    static mut gGerudoFortressGTGShutterCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot12Saku {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot12SakuActionFunc,
    pub timer: s16,
}
pub type BgSpot12SakuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot12Saku, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot12_Saku_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT12_SAKU as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT12_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot12Saku>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Saku_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Saku_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Saku_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot12Saku_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3420(mut this: *mut BgSpot12Saku,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_spot12_saku.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Saku_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot12Saku = thisx as *mut BgSpot12Saku;
    func_808B3420(this, globalCtx, &mut gGerudoFortressGTGShutterCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        func_808B3714(this);
    } else { func_808B3550(this); };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Saku_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot12Saku = thisx as *mut BgSpot12Saku;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3550(mut this: *mut BgSpot12Saku) {
    (*this).actionFunc =
        Some(func_808B357C as
                 unsafe extern "C" fn(_: *mut BgSpot12Saku,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_808B357C(mut this: *mut BgSpot12Saku,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
                           0x3f as libc::c_int) != 0 {
        ...
        OnePointCutscene_Init(globalCtx, 4170 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B35E4(mut this: *mut BgSpot12Saku) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_808B3604 as
                     unsafe extern "C" fn(_: *mut BgSpot12Saku,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B3604(mut this: *mut BgSpot12Saku,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_ret: f32_0 =
        Math_SmoothStepToF(&mut (*this).dyna.actor.scale.x,
                           0.001f32 / 0.14f32, 0.16f32, 0.0022f32, 0.001f32);
    let mut temp_f18: f32_0 =
        (0.1f32 - (*this).dyna.actor.scale.x) * 840.0f32;
    (*this).dyna.actor.world.pos.x =
        (*this).dyna.actor.home.pos.x -
            Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16) * temp_f18;
    (*this).dyna.actor.world.pos.z =
        (*this).dyna.actor.home.pos.z -
            Math_CosS(((*this).dyna.actor.shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16) * temp_f18;
    if fabsf(temp_ret) < 0.0001f32 {
        func_808B3714(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_808B3714(mut this: *mut BgSpot12Saku) {
    (*this).actionFunc =
        Some(func_808B37AC as
                 unsafe extern "C" fn(_: *mut BgSpot12Saku,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.scale.x = 0.001f32 / 0.14f32;
    (*this).dyna.actor.world.pos.x =
        (*this).dyna.actor.home.pos.x -
            Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16) * 78.0f32;
    (*this).dyna.actor.world.pos.z =
        (*this).dyna.actor.home.pos.z -
            Math_CosS(((*this).dyna.actor.shape.rot.y as libc::c_int +
                           0x4000 as libc::c_int) as s16) * 78.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B37AC(mut this: *mut BgSpot12Saku,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Saku_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot12Saku = thisx as *mut BgSpot12Saku;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot12Saku_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gGerudoFortressGTGShutterDL.as_mut_ptr());
}
