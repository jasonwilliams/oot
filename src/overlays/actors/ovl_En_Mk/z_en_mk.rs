...
extern "C" {
    ...
    #[no_mangle]
    static mut object_mk_Anim_000368: AnimationHeader;
    #[no_mangle]
    static mut object_mk_Anim_000724: AnimationHeader;
    #[no_mangle]
    static mut object_mk_Anim_000AC0: AnimationHeader;
    #[no_mangle]
    static mut object_mk_Anim_000D88: AnimationHeader;
    #[no_mangle]
    static mut object_mk_Skel_005DF0: FlexSkeletonHeader;
}
...
pub const PLAYER_BOOTS_MAX: C2RustUnnamed_20 = 6;
pub const PLAYER_BOOTS_NORMAL_CHILD: C2RustUnnamed_20 = 5;
pub const PLAYER_BOOTS_IRON_UNDERWATER: C2RustUnnamed_20 = 4;
pub const PLAYER_BOOTS_INDOOR: C2RustUnnamed_20 = 3;
pub const PLAYER_BOOTS_HOVER: C2RustUnnamed_20 = 2;
pub const PLAYER_BOOTS_IRON: C2RustUnnamed_20 = 1;
pub const PLAYER_BOOTS_NORMAL: C2RustUnnamed_20 = 0;
...
pub const EXCH_ITEM_MAX: C2RustUnnamed_24 = 30;
pub const EXCH_ITEM_LETTER_RUTO: C2RustUnnamed_24 = 29;
pub const EXCH_ITEM_BIG_POE: C2RustUnnamed_24 = 28;
pub const EXCH_ITEM_POE: C2RustUnnamed_24 = 27;
pub const EXCH_ITEM_BUG: C2RustUnnamed_24 = 26;
pub const EXCH_ITEM_BLUE_FIRE: C2RustUnnamed_24 = 25;
pub const EXCH_ITEM_FISH: C2RustUnnamed_24 = 24;
pub const EXCH_ITEM_MASK_GERUDO: C2RustUnnamed_24 = 23;
pub const EXCH_ITEM_MASK_ZORA: C2RustUnnamed_24 = 22;
pub const EXCH_ITEM_MASK_GORON: C2RustUnnamed_24 = 21;
pub const EXCH_ITEM_MASK_TRUTH: C2RustUnnamed_24 = 20;
pub const EXCH_ITEM_MASK_BUNNY: C2RustUnnamed_24 = 19;
pub const EXCH_ITEM_MASK_KEATON: C2RustUnnamed_24 = 18;
pub const EXCH_ITEM_MASK_SPOOKY: C2RustUnnamed_24 = 17;
pub const EXCH_ITEM_MASK_SKULL: C2RustUnnamed_24 = 16;
pub const EXCH_ITEM_CLAIM_CHECK: C2RustUnnamed_24 = 15;
pub const EXCH_ITEM_EYEDROPS: C2RustUnnamed_24 = 14;
pub const EXCH_ITEM_FROG: C2RustUnnamed_24 = 13;
pub const EXCH_ITEM_PRESCRIPTION: C2RustUnnamed_24 = 12;
pub const EXCH_ITEM_SWORD_BROKEN: C2RustUnnamed_24 = 11;
pub const EXCH_ITEM_SAW: C2RustUnnamed_24 = 10;
pub const EXCH_ITEM_ODD_POTION: C2RustUnnamed_24 = 9;
pub const EXCH_ITEM_ODD_MUSHROOM: C2RustUnnamed_24 = 8;
pub const EXCH_ITEM_COJIRO: C2RustUnnamed_24 = 7;
pub const EXCH_ITEM_POCKET_CUCCO: C2RustUnnamed_24 = 6;
pub const EXCH_ITEM_POCKET_EGG: C2RustUnnamed_24 = 5;
pub const EXCH_ITEM_BEAN: C2RustUnnamed_24 = 4;
pub const EXCH_ITEM_CHICKEN: C2RustUnnamed_24 = 3;
pub const EXCH_ITEM_WEIRD_EGG: C2RustUnnamed_24 = 2;
pub const EXCH_ITEM_LETTER_ZELDA: C2RustUnnamed_24 = 1;
pub const EXCH_ITEM_NONE: C2RustUnnamed_24 = 0;
...
pub struct EnMk {
    ...
    pub headRotation: Vec3s,
    pub flags: u16_0,
    pub swimFlag: s16,
    pub timer: u16_0,
    pub actionFunc: EnMkActionFunc,
}
pub type EnMkActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Mk_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MK as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_MK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMk>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnMk_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMk = thisx as *mut EnMk;
    let mut swimFlag: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_mk_Skel_005DF0, &mut object_mk_Anim_000D88,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 13 as libc::c_int);
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_mk_Anim_000D88);
    ...
    (*this).actionFunc =
        Some(EnMk_Wait as
                 unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                     -> ());
    (*this).flags = 0 as libc::c_int as u16_0;
    (*this).swimFlag = 0 as libc::c_int as s16;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    if gSaveContext.itemGetInf[1 as libc::c_int as usize] as libc::c_int &
           1 as libc::c_int != 0 {
        (*this).flags =
            ((*this).flags as libc::c_int | 4 as libc::c_int) as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMk_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMk = thisx as *mut EnMk;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AACA40(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).flags =
        ((*this).flags as libc::c_int | 1 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AACA94(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) !=
           0 as libc::c_int as libc::c_uint {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).actionFunc =
            Some(func_80AACA40 as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        func_80088AA0(240 as libc::c_int as s16);
        gSaveContext.eventInf[1 as libc::c_int as usize] =
            (gSaveContext.eventInf[1 as libc::c_int as usize] as libc::c_int &
                 !(1 as libc::c_int)) as u16_0
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_EYEDROPS as libc::c_int, 10000.0f32, 50.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AACB14(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80AACA94 as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_EYEDROPS as libc::c_int, 10000.0f32, 50.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACB6C(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80AACB14 as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ())
    }
    (*this).flags =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACBAC(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer = (*this).timer.wrapping_sub(1);
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int - 0x800 as libc::c_int)
                as s16
    } else {
        (*this).actionFunc =
            Some(func_80AACB6C as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        Message_ContinueTextbox(globalCtx, 0x4030 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AACC04(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer = (*this).timer.wrapping_sub(1)
    } else {
        (*this).timer = 16 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80AACBAC as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        Animation_Change(&mut (*this).skelAnime, &mut object_mk_Anim_000D88,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_mk_Anim_000D88 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         -4.0f32);
        (*this).flags =
            ((*this).flags as libc::c_int & !(2 as libc::c_int)) as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AACCA0(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer = (*this).timer.wrapping_sub(1);
        (*this).actor.shape.rot.y =
        ...
        (*this).timer = 120 as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80AACC04 as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        Animation_Change(&mut (*this).skelAnime, &mut object_mk_Anim_000724,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_mk_Anim_000724 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         -4.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACD48(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACE2C(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x4001 as libc::c_int as u16_0);
        Animation_Change(&mut (*this).skelAnime, &mut object_mk_Anim_000AC0,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_mk_Anim_000AC0 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACEE8(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_ContinueTextbox(globalCtx, 0x4000 as libc::c_int as u16_0);
        Animation_Change(&mut (*this).skelAnime, &mut object_mk_Anim_000AC0,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_mk_Anim_000AC0 as
                                                    *mut AnimationHeader as
...
#[no_mangle]
pub unsafe extern "C" fn func_80AACFA0(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_HEART_PIECE as libc::c_int, 10000.0f32, 50.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAD014(mut this: *mut EnMk,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80AACFA0 as
                     unsafe extern "C" fn(_: *mut EnMk, _: *mut GlobalContext)
                         -> ());
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_HEART_PIECE as libc::c_int, 10000.0f32, 50.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnMk_Wait(mut this: *mut EnMk,
                                   mut globalCtx: *mut GlobalContext) {
    let mut angle: s16 = 0;
    let mut swimFlag: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut playerExchangeItem: s32 = 0;
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        playerExchangeItem = func_8002F368(globalCtx) as s32;
        if (*this).actor.textId as libc::c_int != 0x4018 as libc::c_int {
            (*player).actor.textId = (*this).actor.textId;
            (*this).actionFunc =
                Some(func_80AACA40 as
                         unsafe extern "C" fn(_: *mut EnMk,
                                              _: *mut GlobalContext) -> ())
        } else if gSaveContext.inventory.items[gItemSlots[ITEM_ODD_MUSHROOM as
                                                              libc::c_int as
                                                              usize] as usize]
                      as libc::c_int == ITEM_EYEDROPS as libc::c_int {
            (*player).actor.textId = 0x4032 as libc::c_int as u16_0;
            (*this).actionFunc =
                Some(func_80AACA40 as
                         unsafe extern "C" fn(_: *mut EnMk,
                                              _: *mut GlobalContext) -> ())
        } else {
            match playerExchangeItem {
                0 => {
                    if (*this).swimFlag as libc::c_int >= 8 as libc::c_int {
                        if gSaveContext.itemGetInf[1 as libc::c_int as usize]
                               as libc::c_int & 1 as libc::c_int != 0 {
                            (*player).actor.textId =
                                0x4075 as libc::c_int as u16_0;
                            (*this).actionFunc =
                                Some(func_80AACA40 as
                                         unsafe extern "C" fn(_: *mut EnMk,
                                                              _:
                            ...
                            (*player).actor.textId =
                                0x4074 as libc::c_int as u16_0;
                            (*this).actionFunc =
                                Some(func_80AAD014 as
                                         unsafe extern "C" fn(_: *mut EnMk,
                                                              _:
                                                                  *mut GlobalContext)
                                             -> ());
                    ...
                    } else if (*this).swimFlag as libc::c_int ==
                                  0 as libc::c_int {
                        (*player).actor.textId =
                            0x4018 as libc::c_int as u16_0;
                        (*this).actionFunc =
                            Some(func_80AACA40 as
                                     unsafe extern "C" fn(_: *mut EnMk,
                                                          _:
                        ...
                        (*player).actor.textId =
                            (0x406c as libc::c_int +
                                 (*this).swimFlag as libc::c_int) as u16_0;
                        (*this).actionFunc =
                            Some(func_80AACA40 as
                                     unsafe extern "C" fn(_: *mut EnMk,
                                                          _:
                ...
                13 => {
                    (*player).actor.textId = 0x4019 as libc::c_int as u16_0;
                    (*this).actionFunc =
                        Some(func_80AACEE8 as
                                 unsafe extern "C" fn(_: *mut EnMk,
                                                      _: *mut GlobalContext)
                                     -> ());
                    Animation_Change(&mut (*this).skelAnime,
                                     &mut object_mk_Anim_000368, 1.0f32,
                                     0.0f32,
                                     Animation_GetLastFrame(&mut object_mk_Anim_000368
                                                                as
                                                                *mut AnimationHeader
                                                                as
                                                                *mut libc::c_void)
        ...
        (*this).actor.textId =
            Text_GetFaceReaction(globalCtx, 0x1a as libc::c_int as u32_0);
        if (*this).actor.textId as libc::c_int == 0 as libc::c_int {
            (*this).actor.textId = 0x4018 as libc::c_int as u16_0
        }
        angle =
        ...
        if (if angle as libc::c_int >= 0 as libc::c_int {
                angle as libc::c_int
            } else { -(angle as libc::c_int) }) < 0x2151 as libc::c_int &&
               (*this).actor.xzDistToPlayer < 100.0f32 {
            func_8002F298(&mut (*this).actor, globalCtx, 100.0f32,
                          EXCH_ITEM_FROG as libc::c_int as u32_0);
            (*this).flags =
                ((*this).flags as libc::c_int | 1 as libc::c_int) as u16_0
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnMk_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMk = thisx as *mut EnMk;
    let mut pad: s32 = 0;
    let mut vec: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut player: *mut Player = 0 as *mut Player;
    let mut swimFlag: s16 = 0;
    ...
    if (*this).flags as libc::c_int & 1 as libc::c_int != 0 {
        func_80038290(globalCtx, &mut (*this).actor,
                      &mut (*this).headRotation, &mut vec,
                      (*this).actor.focus.pos);
    } else {
        Math_SmoothStepToS(&mut (*this).headRotation.x,
                           0 as libc::c_int as s16, 6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).headRotation.y,
                           0 as libc::c_int as s16, 6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
    }
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).flags as libc::c_int & 8 as libc::c_int != 0 {
        if (*player).stateFlags2 & 0x400 as libc::c_int as libc::c_uint == 0 {
            (*this).flags =
                ((*this).flags as libc::c_int & !(8 as libc::c_int)) as u16_0
        }
    } else if (*player).currentBoots as libc::c_int ==
                  PLAYER_BOOTS_IRON as libc::c_int {
        (*this).flags =
            ((*this).flags as libc::c_int | 8 as libc::c_int) as u16_0
    } else if (*player).stateFlags2 & 0x400 as libc::c_int as libc::c_uint !=
                  0 {
        swimFlag = (*player).actor.yDistToWater as s16;
        if swimFlag as libc::c_int > 0 as libc::c_int {
            if swimFlag as libc::c_int >= 320 as libc::c_int {
                if swimFlag as libc::c_int >= 355 as libc::c_int {
                    swimFlag = 8 as libc::c_int as s16
                } else { swimFlag = 7 as libc::c_int as s16 }
            } else if (swimFlag as libc::c_int) < 80 as libc::c_int {
                swimFlag = 1 as libc::c_int as s16
            } else {
                swimFlag = (swimFlag as libc::c_float * 0.025f32) as s16
            }
            if ((*this).swimFlag as libc::c_int) < swimFlag as libc::c_int {
                (*this).swimFlag = swimFlag;
                if (*this).flags as libc::c_int & 4 as libc::c_int == 0 &&
                       (*this).swimFlag as libc::c_int >= 8 as libc::c_int {
                    (*this).flags =
                        ((*this).flags as libc::c_int | 4 as libc::c_int) as
                            u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnMk_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 11 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int - (*this).headRotation.y as libc::c_int)
                as s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).headRotation.x as libc::c_int)
                as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnMk_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut D_80AAD64C: Vec3f =
        {
            let mut init = Vec3f{x: 1000.0f32, y: -100.0f32, z: 0.0f32,};
            init
        };
    let mut this: *mut EnMk = thisx as *mut EnMk;
    if limbIndex == 11 as libc::c_int {
        Matrix_MultVec3f(&mut D_80AAD64C, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMk_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMk = thisx as *mut EnMk;
