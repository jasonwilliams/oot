...
extern "C" {
    ...
    #[no_mangle]
    static mut gPillarDL: [Gfx; 0];
    #[no_mangle]
    static mut gObjectJyaIronDL_000880: [Gfx; 0];
    #[no_mangle]
    static mut gPillarCol: CollisionHeader;
    #[no_mangle]
    static mut gThroneDL: [Gfx; 0];
    #[no_mangle]
    static mut gThroneCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaIronobj {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaIronobjActionFunc,
    pub colCylinder: ColliderCylinder,
}
pub type BgJyaIronobjActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaIronobj, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnIk {
...
pub type BgJyaIronobjIkFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaIronobj, _: *mut GlobalContext,
                                _: *mut EnIk) -> ()>;
#[no_mangle]
pub static mut Bg_Jya_Ironobj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_IRONOBJ as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JYA_IRON as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaIronobj>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaIronobj_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaIronobj_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaIronobj_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaIronobj_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sOpaDL: [*mut Gfx; 2] =
    unsafe { [gPillarDL.as_ptr() as *mut _, gThroneDL.as_ptr() as *mut _] };
...
static mut D_808994D8: [s16; 4] =
    [0x8700 as libc::c_int as s16, 0x4000 as libc::c_int as s16,
     0xc000 as libc::c_int as s16, 0 as libc::c_int as s16];
// Pillar
static mut D_808994E0: [s16; 8] =
    [5 as libc::c_int as s16, 8 as libc::c_int as s16,
     ...
     23 as libc::c_int as s16, 26 as libc::c_int as s16];
static mut D_808994F0: [s16; 8] =
    [18 as libc::c_int as s16, 26 as libc::c_int as s16,
...
static mut D_80899500: [s16; 8] =
    [48 as libc::c_int as s16, 42 as libc::c_int as s16,
     36 as libc::c_int as s16, 32 as libc::c_int as s16,
     28 as libc::c_int as s16, 24 as libc::c_int as s16,
     20 as libc::c_int as s16, 16 as libc::c_int as s16];
// Throne
static mut D_80899510: [s16; 8] =
    [5 as libc::c_int as s16, 8 as libc::c_int as s16,
     11 as libc::c_int as s16, 14 as libc::c_int as s16,
     17 as libc::c_int as s16, 20 as libc::c_int as s16,
     23 as libc::c_int as s16, 26 as libc::c_int as s16];
static mut D_80899520: [s16; 8] =
    [18 as libc::c_int as s16, 26 as libc::c_int as s16,
     34 as libc::c_int as s16, 42 as libc::c_int as s16,
     50 as libc::c_int as s16, 60 as libc::c_int as s16,
     70 as libc::c_int as s16, 80 as libc::c_int as s16];
static mut D_80899530: [s16; 8] =
    [48 as libc::c_int as s16, 42 as libc::c_int as s16,
     36 as libc::c_int as s16, 32 as libc::c_int as s16,
     28 as libc::c_int as s16, 24 as libc::c_int as s16,
     20 as libc::c_int as s16, 16 as libc::c_int as s16];
...
static mut sCollisionHeaders: [*mut CollisionHeader; 2] =
    unsafe {
        [&gPillarCol as *const CollisionHeader as *mut CollisionHeader,
         &gThroneCol as *const CollisionHeader as *mut CollisionHeader]
    };
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_InitCylinder(mut this:
                                                       *mut BgJyaIronobj,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut colCylinder: *mut ColliderCylinder = &mut (*this).colCylinder;
    Collider_InitCylinder(globalCtx, colCylinder);
    Collider_SetCylinder(globalCtx, colCylinder, &mut (*this).dyna.actor,
                         &mut sCylinderInit);
    if (*this).dyna.actor.params as libc::c_int & 1 as libc::c_int ==
           1 as libc::c_int {
        (*this).colCylinder.dim.radius = 40 as libc::c_int as s16;
        (*this).colCylinder.dim.height = 100 as libc::c_int as s16
    }
    Collider_UpdateCylinder(&mut (*this).dyna.actor, colCylinder);
}
/*
 * Spawns particles for the destroyed pillar
 */
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_SpawnPillarParticles(mut this:
                                                               *mut BgJyaIronobj,
                                                           mut globalCtx:
                                                               *mut GlobalContext,
                                                           mut enIk:
    ...
    if (*enIk).unk_2FF as libc::c_int <= 0 as libc::c_int ||
           (*enIk).unk_2FF as libc::c_int >= 4 as libc::c_int {
        osSyncPrintf(b"Error \xe6\x94\xbb\xe6\x92\x83\xe6\x96\xb9\xe6\xb3\x95\xe3\x81\x8c\xe5\x88\x86\xe3\x81\x8b\xe3\x82\x89\xe3\x81\xaa\xe3\x81\x84(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_jya_ironobj.c\x00" as *const u8 as
                         *const libc::c_char, 233 as libc::c_int,
                     (*enIk).unk_2FF as libc::c_int);
        return
    }
    osSyncPrintf(b"\xc2\xa2 attack_type(%d)\n\x00" as *const u8 as
                     *const libc::c_char, (*enIk).unk_2FF as libc::c_int);
    rotY =
        (Actor_WorldYawTowardActor(&mut (*this).dyna.actor,
                                   &mut (*enIk).actor) as libc::c_int +
             D_808994D8[((*enIk).unk_2FF as libc::c_int - 1 as libc::c_int) as
                            usize] as libc::c_int) as s16;
    i = 0 as libc::c_int;
    while i < 8 as libc::c_int {
        let mut actor: *mut Actor =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_BG_JYA_HAHENIRON as libc::c_int as s16,
                        (*this).dyna.actor.world.pos.x,
                        Rand_ZeroOne() * 80.0f32 +
                            (*this).dyna.actor.world.pos.y + 20.0f32,
                        (*this).dyna.actor.world.pos.z,
                        0 as libc::c_int as s16,
                        ((Rand_ZeroOne() *
                              0x4000 as libc::c_int as libc::c_float) as s16
                             as libc::c_int + rotY as libc::c_int -
                             0x2000 as libc::c_int) as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16);
        if !actor.is_null() {
            (*actor).speedXZ = Rand_ZeroOne() * 8.0f32 + 9.0f32;
            (*actor).velocity.y = Rand_ZeroOne() * 10.0f32 + 6.0f32
        }
        i += 1
    }
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_BG_JYA_HAHENIRON as libc::c_int as s16,
                (*this).dyna.actor.world.pos.x,
                (*this).dyna.actor.world.pos.y + 150.0f32,
    ...
    while j < 32 as libc::c_int {
        ...
        if rand < 0.1f32 {
            unkArg5 = 0x60 as libc::c_int as s16
        } else if rand < 0.8f32 {
            unkArg5 = 0x40 as libc::c_int as s16
        } else { unkArg5 = 0x20 as libc::c_int as s16 }
        pos.x = (*this).dyna.actor.world.pos.x;
        pos.y =
            (*this).dyna.actor.world.pos.y +
                (4.375f32 * j as libc::c_float + 10.0f32);
        pos.z = (*this).dyna.actor.world.pos.z;
        temp_f22 =
            fabsf(j as libc::c_float - 15.5f32) *
                (1.0f32 / 31 as libc::c_int as libc::c_float) + 0.5f32;
        vel.x =
            2.0f32 * (Rand_ZeroOne() * 6.0f32 - 3.0f32) +
                Rand_ZeroOne() * sins * 8.0f32 * temp_f22;
        vel.y = Rand_ZeroOne() * 8.0f32 - 3.0f32;
        vel.z =
            2.0f32 * (Rand_ZeroOne() * 6.0f32 - 3.0f32) +
                Rand_ZeroOne() * coss * 8.0f32 * temp_f22;
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut vel, &mut pos,
                             -(350 as libc::c_int) as s16, unkArg5,
                             D_80899500[(j & 7 as libc::c_int) as usize],
                             4 as libc::c_int as s16, 0 as libc::c_int as s16,
                             D_808994E0[(j & 7 as libc::c_int) as usize],
                             0 as libc::c_int as s16, 5 as libc::c_int as s16,
                             D_808994F0[(j & 7 as libc::c_int) as usize] as
                                 s32, -(1 as libc::c_int) as s16,
                             OBJECT_JYA_IRON as libc::c_int as s16,
                             gObjectJyaIronDL_000880.as_mut_ptr());
        if Rand_ZeroOne() < 0.26f32 {
            func_80033480(globalCtx, &mut pos, 200.0f32, 1 as libc::c_int,
                          (D_808994E0[(j & 7 as libc::c_int) as usize] as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_SpawnThoneParticles(mut this:
                                                              *mut BgJyaIronobj,
                                                          mut arg1:
                                                              *mut GlobalContext,
                                                          mut enIk:
    ...
    while i < 8 as libc::c_int {
        let mut actor: *mut Actor =
            Actor_Spawn(&mut (*arg1).actorCtx, arg1,
                        ACTOR_BG_JYA_HAHENIRON as libc::c_int as s16,
                        (*this).dyna.actor.world.pos.x,
                        Rand_ZeroOne() * 80.0f32 +
                        ...
                        0 as libc::c_int as s16,
                        ((Rand_ZeroOne() *
                              0x4000 as libc::c_int as libc::c_float) as s32
                             as s16 as libc::c_int + rotY as libc::c_int -
                             0x2000 as libc::c_int) as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16);
        if !actor.is_null() {
            (*actor).speedXZ = Rand_ZeroOne() * 8.0f32 + 9.0f32;
    ...
    while j < 32 as libc::c_int {
        ...
        pos.x =
            (*this).dyna.actor.world.pos.x +
                (Rand_ZeroOne() * 40 as libc::c_int as libc::c_float -
                     20 as libc::c_int as libc::c_float);
        pos.y = (*this).dyna.actor.world.pos.y + 3.75f32 * j as libc::c_float;
        pos.z =
            (*this).dyna.actor.world.pos.z +
                (Rand_ZeroOne() * 40 as libc::c_int as libc::c_float -
                     20 as libc::c_int as libc::c_float);
        ...
        vel.z =
            2.0f32 * (Rand_ZeroOne() * 6.0f32 - 3.0f32) +
                Rand_ZeroOne() * coss * 8.0f32 * temp_f22;
        EffectSsKakera_Spawn(arg1, &mut pos, &mut vel, &mut pos,
                             -(350 as libc::c_int) as s16, unkArg5,
                             D_80899530[(j & 7 as libc::c_int) as usize],
                             4 as libc::c_int as s16, 0 as libc::c_int as s16,
                             D_80899510[(j & 7 as libc::c_int) as usize],
                             0 as libc::c_int as s16, 5 as libc::c_int as s16,
                             D_80899520[(j & 7 as libc::c_int) as usize] as
                                 s32, -(1 as libc::c_int) as s16,
                             OBJECT_JYA_IRON as libc::c_int as s16,
                             gObjectJyaIronDL_000880.as_mut_ptr());
        if Rand_ZeroOne() < 0.26f32 {
            func_80033480(arg1, &mut pos, 200.0f32, 1 as libc::c_int,
                          (D_80899510[(j & 7 as libc::c_int) as usize] as
                               libc::c_int * 4 as libc::c_int +
                               60 as libc::c_int) as s16,
                          (D_80899510[(j & 7 as libc::c_int) as usize] as
                               libc::c_int * 4 as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaIronobj = thisx as *mut BgJyaIronobj;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(sCollisionHeaders[((*thisx).params as
                                                      libc::c_int &
                                                      1 as libc::c_int) as
                                                     usize] as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaIronobj = thisx as *mut BgJyaIronobj;
...
#[no_mangle]
pub unsafe extern "C" fn func_808992D8(mut this: *mut BgJyaIronobj) {
    (*this).actionFunc =
        Some(func_808992E8 as
                 unsafe extern "C" fn(_: *mut BgJyaIronobj,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808992E8(mut this: *mut BgJyaIronobj,
                                       mut globalCtx: *mut GlobalContext) {
    static mut particleFunc: [BgJyaIronobjIkFunc; 2] =
        unsafe {
            [Some(BgJyaIronobj_SpawnPillarParticles as
                      unsafe extern "C" fn(_: *mut BgJyaIronobj,
                                           _: *mut GlobalContext,
                                           _: *mut EnIk) -> ()),
             Some(BgJyaIronobj_SpawnThoneParticles as
                      unsafe extern "C" fn(_: *mut BgJyaIronobj,
                                           _: *mut GlobalContext,
                                           _: *mut EnIk) -> ())]
        };
    ...
    if (*this).colCylinder.base.acFlags as libc::c_int &
        ...
        if !actor.is_null() &&
               (*actor).id as libc::c_int == ACTOR_EN_IK as libc::c_int {
            particleFunc[((*this).dyna.actor.params as libc::c_int &
                              1 as libc::c_int) as
            ...
            Audio_PlaySoundAtPosition(globalCtx,
                                      ...
                                      80 as libc::c_int,
                                      0x39ad as libc::c_int as u16_0);
            dropPos.x = (*this).dyna.actor.world.pos.x;
            dropPos.y = (*this).dyna.actor.world.pos.y + 20.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaIronobj = thisx as *mut BgJyaIronobj;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaIronobj_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx,
                     sOpaDL[((*thisx).params as libc::c_int &
