...
extern "C" {
    #[no_mangle]
    fn func_80027DD4(arg0: s16, arg1: s16, arg2: s32) -> s16;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gEffHitMark1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark9Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark10Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark11Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark12Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark13Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark14Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark15Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark16Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark17Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark18Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark19Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark20Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark21Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark22Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark23Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMark24Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffHitMarkDL: [Gfx; 0];
}
...
pub const EFFECT_HITMARK_METAL: C2RustUnnamed_15 = 3;
pub const EFFECT_HITMARK_RED: C2RustUnnamed_15 = 2;
pub const EFFECT_HITMARK_DUST: C2RustUnnamed_15 = 1;
pub const EFFECT_HITMARK_WHITE: C2RustUnnamed_15 = 0;
static mut sColors: [Color_RGB8; 16] =
    [{
         let mut init =
...
static mut sTextures: [*mut libc::c_void; 32] =
    unsafe {
        [gEffHitMark1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark5Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark6Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark7Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark8Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark9Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark10Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark11Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark12Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark13Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark14Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark15Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark16Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark17Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark18Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark19Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark20Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark21Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark22Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark23Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark24Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffHitMark4Tex.as_ptr() as *mut _ as *mut libc::c_void,
...
#[no_mangle]
pub static mut Effect_Ss_HitMark_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_HITMARK as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsHitMark_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsHitMark_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
 ...
 -> u32_0 {
    ...
    let mut initParams: *mut EffectSsHitMarkInitParams =
        initParamsx as *mut EffectSsHitMarkInitParams;
    (*this).pos = (*initParams).pos;
    (*this).gfx =
        gSegments[((gEffHitMarkDL.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffHitMarkDL.as_mut_ptr() as u32_0
                                              &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void;
    if (*initParams).type_0 == EFFECT_HITMARK_DUST as libc::c_int {
        (*this).life = 16 as libc::c_int as s16
    } else { (*this).life = 8 as libc::c_int as s16 }
    (*this).draw =
        Some(EffectSsHitMark_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsHitMark_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    colorIdx = (*initParams).type_0 * 4 as libc::c_int;
    (*this).regs[0 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[1 as libc::c_int as usize] = (*initParams).type_0 as s16;
    (*this).regs[2 as libc::c_int as usize] =
        sColors[colorIdx as usize].r as s16;
    (*this).regs[3 as libc::c_int as usize] =
        sColors[colorIdx as usize].g as s16;
    (*this).regs[4 as libc::c_int as usize] =
        sColors[colorIdx as usize].b as s16;
    (*this).regs[5 as libc::c_int as usize] =
        sColors[(colorIdx + 1 as libc::c_int) as usize].r as s16;
    (*this).regs[6 as libc::c_int as usize] =
        sColors[(colorIdx + 1 as libc::c_int) as usize].g as s16;
    (*this).regs[7 as libc::c_int as usize] =
        sColors[(colorIdx + 1 as libc::c_int) as usize].b as s16;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).scale;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsHitMark_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_hitmark.c\x00" as *const u8 as
    ...
    SkinMatrix_SetScale(&mut mfScale, scale, scale, 1.0f32);
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((sTextures[((*this).regs[1 as libc::c_int as usize] as
                                       libc::c_int * 8 as libc::c_int +
                                       (*this).regs[0 as libc::c_int as usize]
                                           as libc::c_int) as usize] as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(sTextures[((*this).regs[1 as
                                                                          libc::c_int
                                                                          as
                                                                          usize]
                                                             as libc::c_int *
        ...
        (*_g_2).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            ((*this).regs[2 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsHitMark_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    let mut colorIdx: s32 = 0;
    if (*this).regs[1 as libc::c_int as usize] as libc::c_int ==
           EFFECT_HITMARK_DUST as libc::c_int {
        (*this).regs[0 as libc::c_int as usize] =
            ((15 as libc::c_int - (*this).life as libc::c_int) /
                 2 as libc::c_int) as s16
    } else {
        (*this).regs[0 as libc::c_int as usize] =
            (7 as libc::c_int - (*this).life as libc::c_int) as s16
    }
    if (*this).regs[0 as libc::c_int as usize] as libc::c_int !=
           0 as libc::c_int {
        colorIdx =
            (*this).regs[1 as libc::c_int as usize] as libc::c_int *
                4 as libc::c_int + 2 as libc::c_int;
        (*this).regs[2 as libc::c_int as usize] =
            func_80027DD4((*this).regs[2 as libc::c_int as usize],
                          sColors[colorIdx as usize].r as s16,
                          (*this).life as libc::c_int + 1 as libc::c_int);
        (*this).regs[3 as libc::c_int as usize] =
            func_80027DD4((*this).regs[3 as libc::c_int as usize],
                          sColors[colorIdx as usize].g as s16,
                          (*this).life as libc::c_int + 1 as libc::c_int);
        (*this).regs[4 as libc::c_int as usize] =
            func_80027DD4((*this).regs[4 as libc::c_int as usize],
                          sColors[colorIdx as usize].b as s16,
                          (*this).life as libc::c_int + 1 as libc::c_int);
        (*this).regs[5 as libc::c_int as usize] =
            func_80027DD4((*this).regs[5 as libc::c_int as usize],
                          sColors[(colorIdx + 1 as libc::c_int) as usize].r as
                              s16,
                          (*this).life as libc::c_int + 1 as libc::c_int);
        (*this).regs[6 as libc::c_int as usize] =
            func_80027DD4((*this).regs[6 as libc::c_int as usize],
                          sColors[(colorIdx + 1 as libc::c_int) as usize].g as
                              s16,
                          (*this).life as libc::c_int + 1 as libc::c_int);
        (*this).regs[7 as libc::c_int as usize] =
            func_80027DD4((*this).regs[7 as libc::c_int as usize],
                          sColors[(colorIdx + 1 as libc::c_int) as usize].b as
                              s16,
                          (*this).life as libc::c_int + 1 as libc::c_int)
    };
}
