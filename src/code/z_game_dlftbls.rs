...
extern "C" {
    #[no_mangle]
    fn Gameplay_Destroy(thisx: *mut GameState);
    #[no_mangle]
    fn Gameplay_Init(thisx: *mut GameState);
    #[no_mangle]
    fn TitleSetup_Destroy(gameState: *mut GameState);
    #[no_mangle]
    fn TitleSetup_Init(gameState: *mut GameState);
    #[no_mangle]
    fn Title_Destroy(thisx: *mut GameState);
    #[no_mangle]
    fn Title_Init(thisx: *mut GameState);
    #[no_mangle]
    fn Opening_Destroy(thisx: *mut GameState);
    #[no_mangle]
    fn Opening_Init(thisx: *mut GameState);
    #[no_mangle]
    fn Select_Destroy(thisx: *mut GameState);
    #[no_mangle]
    fn FileChoose_Init(thisx: *mut GameState);
    #[no_mangle]
    fn FileChoose_Destroy(thisx: *mut GameState);
    #[no_mangle]
    fn Select_Init(thisx: *mut GameState);
    #[no_mangle]
    static mut _ovl_titleSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_titleSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_titleSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_titleSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_selectSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_selectSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_selectSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_selectSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_openingSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_openingSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_openingSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_openingSegmentRomEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_file_chooseSegmentStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_file_chooseSegmentEnd: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_file_chooseSegmentRomStart: [u8_0; 0];
    #[no_mangle]
    static mut _ovl_file_chooseSegmentRomEnd: [u8_0; 0];
}
...
#[no_mangle]
pub static mut gGameStateOverlayTable: [GameStateOverlay; 6] =
    [GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                      vromStart: 0,
                      vromEnd: 0,
                      vramStart: 0 as *mut libc::c_void,
                      vramEnd: 0 as *mut libc::c_void,
                      unk_14: 0 as *mut libc::c_void,
                      init: 0 as *mut libc::c_void,
                      destroy: 0 as *mut libc::c_void,
                      unk_20: 0 as *mut libc::c_void,
                      unk_24: 0 as *mut libc::c_void,
                      unk_28: 0,
                      instanceSize: 0,}; 6];
unsafe extern "C" fn run_static_initializers() {
    gGameStateOverlayTable =
        [{
             let mut init =
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  vromStart: 0 as libc::c_int as u32_0,
                                  ...
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(TitleSetup_Init
                                                                                          as
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(TitleSetup_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  unk_20: 0 as *mut libc::c_void,
                                  unk_24: 0 as *mut libc::c_void,
                                  unk_28: 0 as libc::c_int,
                                  instanceSize:
                                      ::std::mem::size_of::<GameState>() as
                                          libc::c_ulong,};
             init
         },
         {
             let mut init =
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  vromStart:
                                      _ovl_selectSegmentRomStart.as_mut_ptr()
                                          as u32_0,
                                  vromEnd:
                                      _ovl_selectSegmentRomEnd.as_mut_ptr() as
                                          u32_0,
                                  vramStart:
                                      _ovl_selectSegmentStart.as_mut_ptr() as
                                          *mut libc::c_void,
                                  vramEnd:
                                      _ovl_selectSegmentEnd.as_mut_ptr() as
                                          *mut libc::c_void,
                                  unk_14: 0 as *mut libc::c_void,
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Select_Init
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Select_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
         ...
         },
         {
             let mut init =
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  vromStart:
                                      _ovl_titleSegmentRomStart.as_mut_ptr()
                                          as u32_0,
                                  vromEnd:
                                      _ovl_titleSegmentRomEnd.as_mut_ptr() as
                                          u32_0,
                                  vramStart:
                                      _ovl_titleSegmentStart.as_mut_ptr() as
                                          *mut libc::c_void,
                                  vramEnd:
                                      _ovl_titleSegmentEnd.as_mut_ptr() as
                                          *mut libc::c_void,
                                  unk_14: 0 as *mut libc::c_void,
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Title_Init
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Title_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  unk_28: 0 as libc::c_int,
                                  instanceSize:
                                      ::std::mem::size_of::<TitleContext>() as
                                          libc::c_ulong,};
             init
         },
         {
                 ...
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  ...
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Gameplay_Init
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Gameplay_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
         ...
         },
         {
             let mut init =
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  vromStart:
                                      _ovl_openingSegmentRomStart.as_mut_ptr()
                                          as u32_0,
                                  vromEnd:
                                      _ovl_openingSegmentRomEnd.as_mut_ptr()
                                          as u32_0,
                                  vramStart:
                                      _ovl_openingSegmentStart.as_mut_ptr() as
                                          *mut libc::c_void,
                                  vramEnd:
                                      _ovl_openingSegmentEnd.as_mut_ptr() as
                                          *mut libc::c_void,
                                  unk_14: 0 as *mut libc::c_void,
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Opening_Init
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(Opening_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  unk_28: 0 as libc::c_int,
                                  instanceSize:
                                      ::std::mem::size_of::<OpeningContext>()
                                          as libc::c_ulong,};
             init
         },
         {
             let mut init =
                 GameStateOverlay{loadedRamAddr: 0 as *mut libc::c_void,
                                  vromStart:
                                      _ovl_file_chooseSegmentRomStart.as_mut_ptr()
                                          as u32_0,
                                  vromEnd:
                                      _ovl_file_chooseSegmentRomEnd.as_mut_ptr()
                                          as u32_0,
                                  vramStart:
                                      _ovl_file_chooseSegmentStart.as_mut_ptr()
                                          as *mut libc::c_void,
                                  vramEnd:
                                      _ovl_file_chooseSegmentEnd.as_mut_ptr()
                                          as *mut libc::c_void,
                                  unk_14: 0 as *mut libc::c_void,
                                  init:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(FileChoose_Init
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
                                  ...
                                  destroy:
                                      ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                         ...
                                                                         ->
                                                                             ()>,
                                                              *mut libc::c_void>(Some(FileChoose_Destroy
                                                                                          as
                                                                                          unsafe extern "C" fn(_:
                                                                                                                   *mut GameState)
                                                                                              ->
