...
extern "C" {
    ...
    #[no_mangle]
    static mut gGoronCityVaseDL: [Gfx; 0];
    #[no_mangle]
    static mut gGoronCityVaseCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot18Basket {
    pub dyna: DynaPolyActor,
    pub colliderJntSph: ColliderJntSph,
    pub ColliderJntSphElements: [ColliderJntSphElement; 2],
    pub actionFunc: BgSpot18BasketActionFunc,
    pub unk_208: f32_0,
    pub unk_20C: s16,
    pub unk_20E: s16,
    pub unk_210: s16,
...
pub type BgSpot18BasketActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot18Basket, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot18_Basket_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT18_BASKET as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SPOT18_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot18Basket>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Basket_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Basket_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Basket_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Basket_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B85C8: [s16; 4] =
    [0x8000 as libc::c_int as s16, 0x2aaa as libc::c_int as s16,
     0xd555 as libc::c_int as s16, 0 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn func_808B7710(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgSpot18Basket = thisx as *mut BgSpot18Basket;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).colliderJntSph,
                       ...
                       (*this).ColliderJntSphElements.as_mut_ptr());
    (*this).dyna.actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7770(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: f32_0) {
    static mut D_808B85D0: s16 = 0 as libc::c_int as s16;
    let mut acceleration: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut position: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut cosValue: f32_0 = 0.;
    let mut i: s32 = 0;
    let mut randomValue: f32_0 = 0.;
    ...
    while i != count {
        ...
        if !(arg2 < Rand_ZeroOne()) {
            D_808B85D0 =
                (D_808B85D0 as libc::c_int + 0x7530 as libc::c_int) as s16;
            sinValue = Math_SinS(D_808B85D0);
            cosValue = Math_CosS(D_808B85D0);
            randomValue = Rand_ZeroOne() * 35.0f32 + 35.0f32;
            position.x =
                randomValue * sinValue + (*this).dyna.actor.world.pos.x;
            position.y = (*this).dyna.actor.world.pos.y + 10.0f32;
            position.z =
                randomValue * cosValue + (*this).dyna.actor.world.pos.z;
            velocity.x = sinValue;
            velocity.y = 0.0f32;
            velocity.z = cosValue;
            acceleration.x = 0.0f32;
            acceleration.y = 0.5f32;
            acceleration.z = 0.0f32;
            func_800286CC(globalCtx, &mut position, &mut velocity,
                          &mut acceleration,
                          (Rand_ZeroOne() * 16 as libc::c_int as libc::c_float
                               + 80 as libc::c_int as libc::c_float) as s16,
                          (Rand_ZeroOne() * 30 as libc::c_int as libc::c_float
                               + 80 as libc::c_int as libc::c_float) as s16);
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Basket_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSpot18Basket = thisx as *mut BgSpot18Basket;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK3 as libc::c_int);
    func_808B7710(&mut (*this).dyna.actor, globalCtx);
    CollisionHeader_GetVirtual(&mut gGoronCityVaseCol as *mut CollisionHeader
    ...
    ActorShape_Init(&mut (*this).dyna.actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 15.0f32);
    (*this).dyna.actor.home.pos.y += 0.01f32;
    ...
    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).dyna.actor,
                       globalCtx, ACTOR_BG_SPOT18_FUTA as libc::c_int as s16,
    ...
    if (*this).dyna.actor.child.is_null() {
        ...
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : \xe5\xa4\x89\xe5\x8c\x96\xe5\xa3\xb7\xe8\x93\x8b\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_spot18_basket.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Basket_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgSpot18Basket = thisx as *mut BgSpot18Basket;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B7AEC(mut this: *mut BgSpot18Basket) {
    (*this).actionFunc =
        Some(func_808B7AFC as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7AFC(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0x3f as libc::c_int) != 0 {
        OnePointCutscene_Init(globalCtx, 4220 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B7B58(mut this: *mut BgSpot18Basket) {
    (*this).actionFunc =
        Some(func_808B7B6C as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_216 = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7B6C(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_216 as libc::c_int > 20 as libc::c_int {
        func_808B7BB0(this);
        (*(*this).dyna.actor.child).parent = 0 as *mut Actor;
        (*this).dyna.actor.child = 0 as *mut Actor
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7BB0(mut this: *mut BgSpot18Basket) {
    (*this).actionFunc =
        Some(func_808B7BCC as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_808B7BCC(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    let mut positionDiff: f32_0 = 0.;
    let mut colliderBaseAc: *mut Actor = 0 as *mut Actor;
    Math_StepToS(&mut (*this).unk_210, 0x1f4 as libc::c_int as s16,
                 0x1e as libc::c_int as s16);
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.shape.rot.y as libc::c_int +
             (*this).unk_210 as libc::c_int) as s16;
    Math_StepToF(&mut (*this).unk_208, 50.0f32, 1.5f32);
    Math_StepToS(&mut (*this).unk_20C, 400 as libc::c_int as s16,
                 15 as libc::c_int as s16);
    (*this).unk_20E =
        ((*this).unk_20E as libc::c_int + (*this).unk_20C as libc::c_int) as
            s16;
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).unk_20E) * (*this).unk_208 +
            (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).unk_20E) * (*this).unk_208 +
    ...
    if (*this).colliderJntSph.base.acFlags as libc::c_int &
        ...
        if !colliderBaseAc.is_null() {
            positionDiff =
                (*colliderBaseAc).world.pos.y -
                    (*this).dyna.actor.world.pos.y;
            if positionDiff > 120.0f32 && positionDiff < 200.0f32 {
                if Math3D_Dist2DSq((*colliderBaseAc).world.pos.z,
                                   (*(*this).colliderJntSph.base.ac).world.pos.x,
                                   (*this).dyna.actor.world.pos.z,
                                   (*this).dyna.actor.world.pos.x) <
                       32.0f32 * 32.0f32 {
                    OnePointCutscene_Init(globalCtx,
                                          4210 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B7D38(mut this: *mut BgSpot18Basket) {
    (*this).actionFunc =
        Some(func_808B7D50 as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_216 = 0 as libc::c_int as s16;
    (*this).unk_214 = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7D50(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    let mut tempValue2: f32_0 = 0.;
    let mut tempValue: f32_0 = 0.;
    if (*this).unk_216 as libc::c_int > 120 as libc::c_int {
        Math_StepToS(&mut (*this).unk_210, 0x3e8 as libc::c_int as s16,
                     0x32 as libc::c_int as s16);
    } else {
        Math_StepToS(&mut (*this).unk_210, 0xbb8 as libc::c_int as s16,
                     0x64 as libc::c_int as s16);
    }
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.shape.rot.y as libc::c_int +
             (*this).unk_210 as libc::c_int) as s16;
    if ((*this).unk_216 as libc::c_int) < 70 as libc::c_int {
        Math_StepToF(&mut (*this).unk_208, 100.0f32, 2.0f32);
    } else { Math_StepToF(&mut (*this).unk_208, 0.0f32, 2.0f32); }
    Math_StepToS(&mut (*this).unk_20C, 1000 as libc::c_int as s16,
    ...
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).unk_20E) * (*this).unk_208 +
            (*this).dyna.actor.home.pos.z;
    (*this).unk_212 =
        ((*this).unk_212 as libc::c_int + 0xbb8 as libc::c_int) as s16;
    Math_StepToS(&mut (*this).unk_214, 0x5dc as libc::c_int as s16,
                 0x1e as libc::c_int as s16);
    (*this).dyna.actor.shape.rot.x =
        (Math_CosS((*this).unk_212) *
             (*this).unk_214 as libc::c_int as libc::c_float) as s16;
    (*this).dyna.actor.shape.rot.z =
        (-Math_SinS((*this).unk_212) *
             (*this).unk_214 as libc::c_int as libc::c_float) as s16;
    if (*this).unk_216 as libc::c_int > 140 as libc::c_int {
        func_808B7F74(this);
    }
    if ((*this).unk_216 as libc::c_int) < 80 as libc::c_int {
        func_808B7770(this, globalCtx, 1.0f32);
    } else { func_808B7770(this, globalCtx, 0.8f32); }
    tempValue2 =
        ((*this).unk_210 as libc::c_int - 500 as libc::c_int) as libc::c_float
            * 0.0006f32;
    tempValue =
        if tempValue2 < 0.0f32 {
            0.0f32
        } else if tempValue2 > 1.5f32 { 1.5f32 } else { tempValue2 };
    func_800F436C(&mut (*this).dyna.actor.projectedPos,
                  (0x8cb as libc::c_int - 0x800 as libc::c_int) as u16_0,
                  tempValue);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7F74(mut this: *mut BgSpot18Basket) {
    let mut shapeRotY: s16 = 0;
    shapeRotY = (*this).dyna.actor.shape.rot.y;
    (*this).actionFunc =
        Some(func_808B7FC0 as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
    if (shapeRotY as libc::c_int) < -(0x2e93 as libc::c_int) ||
           shapeRotY as libc::c_int >= 0x7c19 as libc::c_int {
        (*this).unk_218 = 2 as libc::c_int as s16
    } else if (shapeRotY as libc::c_int) < 0x26c2 as libc::c_int {
        (*this).unk_218 = 1 as libc::c_int as s16
    } else { (*this).unk_218 = 0 as libc::c_int as s16 }
    (*this).unk_216 = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7FC0(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut tempUnk214: s32 = 0;
    let mut tempUnk210: f32_0 = 0.;
    let mut arrayValue: s16 = 0;
    let mut clampedTempUnk210: f32_0 = 0.;
    (*this).unk_212 =
        ((*this).unk_212 as libc::c_int + 0xbb8 as libc::c_int) as s16;
    if (*this).unk_216 as libc::c_int >= 13 as libc::c_int {
        tempUnk214 =
            Math_StepToS(&mut (*this).unk_214, 0 as libc::c_int as s16,
                         55 as libc::c_int as s16)
    } else { tempUnk214 = 0 as libc::c_int }
    (*this).dyna.actor.shape.rot.x =
        (Math_CosS((*this).unk_212) *
             (*this).unk_214 as libc::c_int as libc::c_float) as s16;
    (*this).dyna.actor.shape.rot.z =
    ...
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.shape.rot.y as libc::c_int +
             (*this).unk_210 as libc::c_int) as s16;
    if tempUnk214 != 0 as libc::c_int {
        arrayValue = D_808B85C8[(*this).unk_218 as usize];
        if ((*this).dyna.actor.shape.rot.y as libc::c_int -
                arrayValue as libc::c_int) as s16 as libc::c_int >=
               0 as libc::c_int {
    ...
    if ((*this).unk_216 as libc::c_int) < 30 as libc::c_int {
        func_808B7770(this, globalCtx, 0.5f32);
    } else { func_808B7770(this, globalCtx, 0.3f32); }
    tempUnk210 =
        ((*this).unk_210 as libc::c_int - 500 as libc::c_int) as libc::c_float
            * 0.0006f32;
    clampedTempUnk210 =
        if tempUnk210 < 0.0f32 {
            0.0f32
        } else if tempUnk210 > 1.5f32 { 1.5f32 } else { tempUnk210 };
    func_800F436C(&mut (*this).dyna.actor.projectedPos,
                  (0x8cb as libc::c_int - 0x800 as libc::c_int) as u16_0,
                  clampedTempUnk210);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B818C(mut this: *mut BgSpot18Basket) {
    (*this).actionFunc =
        Some(func_808B81A0 as
                 unsafe extern "C" fn(_: *mut BgSpot18Basket,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_216 = 0 as libc::c_int as s16;
}
static mut D_808B85E4: [s16; 3] =
    [-(0xfa0 as libc::c_int) as s16, 0x320 as libc::c_int as s16,
     0xfa0 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn func_808B81A0(mut this: *mut BgSpot18Basket,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut actor: *mut Actor = &mut (*this).dyna.actor;
    let mut tempVector: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut collectible: *mut EnItem00 = 0 as *mut EnItem00;
    if (*this).unk_216 as libc::c_int == 1 as libc::c_int {
        tempVector.x = (*actor).world.pos.x;
        tempVector.y = (*actor).world.pos.y + 170.0f32;
        tempVector.z = (*actor).world.pos.z;
        if (*this).unk_218 as libc::c_int == 0 as libc::c_int {
            i = 0 as libc::c_int;
            while i <
                      (::std::mem::size_of::<[s16; 3]>() as
                          ...
                          as s32 {
                collectible =
                    Item_DropCollectible(globalCtx, &mut tempVector,
                                         ITEM00_BOMBS_A as libc::c_int as
                                             s16);
                if !collectible.is_null() {
                    (*collectible).actor.velocity.y = 11.0f32;
                    (*collectible).actor.world.rot.y = D_808B85E4[i as usize]
                }
                i += 1
            }
        } else if (*this).unk_218 as libc::c_int == 1 as libc::c_int {
            i = 0 as libc::c_int;
            while i <
                      (::std::mem::size_of::<[s16; 3]>() as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>()
                ...
                collectible =
                    Item_DropCollectible(globalCtx, &mut tempVector,
                                         ITEM00_RUPEE_GREEN as libc::c_int as
                                             s16);
                if !collectible.is_null() {
                    (*collectible).actor.velocity.y = 11.0f32;
                    (*collectible).actor.world.rot.y = D_808B85E4[i as usize]
        ...
        } else if (*this).unk_218 as libc::c_int == 2 as libc::c_int {
            if (*this).unk_21A as libc::c_int != 0 as libc::c_int ||
                ...
                if !collectible.is_null() {
                    (*collectible).actor.velocity.y = 11.0f32;
                    (*collectible).actor.world.rot.y =
                        D_808B85E4[1 as libc::c_int as usize]
                }
            } else {
                collectible =
                    Item_DropCollectible(globalCtx, &mut tempVector,
                ...
                if !collectible.is_null() {
                    ...
                    (*collectible).actor.world.rot.y =
                        D_808B85E4[1 as libc::c_int as usize];
                    (*this).unk_21A = 1 as libc::c_int as u8_0
                }
            }
            collectible =
                Item_DropCollectible(globalCtx, &mut tempVector,
            ...
            if !collectible.is_null() {
                (*collectible).actor.velocity.y = 11.0f32;
                (*collectible).actor.world.rot.y =
                    D_808B85E4[0 as libc::c_int as usize]
            }
            collectible =
                Item_DropCollectible(globalCtx, &mut tempVector,
            ...
            if !collectible.is_null() {
                (*collectible).actor.velocity.y = 11.0f32;
                (*collectible).actor.world.rot.y =
                    D_808B85E4[2 as libc::c_int as usize]
            }
        }
    } else if (*this).unk_216 as libc::c_int == 2 as libc::c_int {
        if (*this).unk_218 as libc::c_int == 2 as libc::c_int {
            func_80078884(0x4802 as libc::c_int as u16_0);
        } else { func_80078884(0x4807 as libc::c_int as u16_0); }
    } else if (*this).unk_216 as libc::c_int == 200 as libc::c_int {
        func_808B7BB0(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Basket_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSpot18Basket = thisx as *mut BgSpot18Basket;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Basket_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot18Basket = thisx as *mut BgSpot18Basket;
    Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).colliderJntSph);
    Collider_UpdateSpheres(1 as libc::c_int, &mut (*this).colliderJntSph);
    Gfx_DrawDListOpa(globalCtx, gGoronCityVaseDL.as_mut_ptr());
}
