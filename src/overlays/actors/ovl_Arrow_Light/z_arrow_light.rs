...
pub struct ArrowLight {
    ...
    pub unk_160: f32_0,
    pub unk_164: f32_0,
    pub actionFunc: ArrowLightActionFunc,
}
pub type ArrowLightActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ArrowLight, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnArrow {
...
#[no_mangle]
pub static mut Arrow_Light_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ARROW_LIGHT as libc::c_int as s16,
                          category:
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowLight_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowLight_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowLight_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArrowLight_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_SetupAction(mut this: *mut ArrowLight,
                                                mut actionFunc:
                                                    ArrowLightActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArrowLight = thisx as *mut ArrowLight;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).radius = 0 as libc::c_int as s16;
    (*this).unk_160 = 1.0f32;
    ArrowLight_SetupAction(this,
                           Some(ArrowLight_Charge as
                                    unsafe extern "C" fn(_: *mut ArrowLight,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*this).alpha = 130 as libc::c_int as u8_0;
    (*this).timer = 0 as libc::c_int as u16_0;
    (*this).unk_164 = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    func_800876C8(globalCtx);
    LogUtils_LogThreadId(b"../z_arrow_light.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Charge(mut this: *mut ArrowLight,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80869E6C(mut unkPos: *mut Vec3f,
                                       mut lightPos: *mut Vec3f,
                                       mut scale: f32_0) {
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Hit(mut this: *mut ArrowLight,
                                        mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Fly(mut this: *mut ArrowLight,
                                        mut globalCtx: *mut GlobalContext) {
    let mut arrow: *mut EnArrow = (*this).actor.parent as *mut EnArrow;
    ...
    func_80869E6C(&mut (*this).unkPos, &mut (*this).actor.world.pos, 0.05f32);
    if (*arrow).hitFlags as libc::c_int & 1 as libc::c_int != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x183c as libc::c_int as u16_0);
        ArrowLight_SetupAction(this,
                               Some(ArrowLight_Hit as
                                        unsafe extern "C" fn(_:
                                                                 *mut ArrowLight,
                                                             _:
                                                                 *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ArrowLight = thisx as *mut ArrowLight;
...
#[no_mangle]
pub unsafe extern "C" fn ArrowLight_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArrowLight = thisx as *mut ArrowLight;
    let mut pad: s32 = 0;
    ...
    if !arrow.is_null() && (*arrow).actor.update.is_some() &&
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_arrow_light.c\x00" as *const u8 as
                            *const libc::c_char, 598 as libc::c_int);
            ...
            (*_g).words.w0 =
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                (((30.0f32 * (*this).unk_164) as s32 & 0xff as libc::c_int) as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (((40.0f32 * (*this).unk_164) as s32 &
                             ...
                             (511 as libc::c_int as
                                  libc::c_uint).wrapping_sub(stateFrames.wrapping_mul(5
                                                                                          ...
                                                                                          libc::c_uint).wrapping_rem(512
                                                                                                                         ...
                                                                                                                         as
                                                                                                                         libc::c_uint)),
                             0 as libc::c_int as u32_0, 4 as libc::c_int,
                             ...
                             (511 as libc::c_int as
                                  libc::c_uint).wrapping_sub(stateFrames.wrapping_mul(10
                                                                                          ...
                                                                                          libc::c_uint).wrapping_rem(512
                                                                                                                         ...
                                                                                                                         libc::c_uint)),
                             (511 as libc::c_int as
                                  libc::c_uint).wrapping_sub(stateFrames.wrapping_mul(30
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_uint).wrapping_rem(512
                                                                                                                         ...
                                                                                                                         as
                                                                                                                         libc::c_uint)),
                             8 as libc::c_int, 16 as libc::c_int) as
                libc::c_uint;
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_arrow_light.c\x00" as *const u8 as
                             *const libc::c_char, 664 as libc::c_int);
    };
}
