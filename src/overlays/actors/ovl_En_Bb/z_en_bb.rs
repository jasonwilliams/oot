...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsEnFire_SpawnVec3f(globalCtx: *mut GlobalContext,
                                 actor: *mut Actor, pos: *mut Vec3f,
                                 scale: s16, unk_12: s16, flags: s16,
                                 bodyPart: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_Bb_Anim_000184: AnimationHeader;
    #[no_mangle]
    static mut object_Bb_Anim_000444: AnimationHeader;
    #[no_mangle]
    static mut object_Bb_Skel_001A30: SkeletonHeader;
}
...
pub const EFFECT_SHIELD_PARTICLE: C2RustUnnamed_20 = 3;
pub const EFFECT_BLURE2: C2RustUnnamed_20 = 2;
pub const EFFECT_BLURE1: C2RustUnnamed_20 = 1;
pub const EFFECT_SPARK: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
...
pub struct EnBb {
    ...
    pub actionVar1: s16,
    pub actionVar2: s16,
    pub flameScrollMod: s16,
    pub bobPhase: f32_0,
    pub bobSize: f32_0,
    pub maxSpeed: f32_0,
    pub flyHeightMod: f32_0,
    pub bobSpeedMod: f32_0,
    pub flameScaleY: f32_0,
    pub flameScaleX: f32_0,
    pub waypointPos: Vec3f,
    pub path: u8_0,
    pub waypoint: u8_0,
    pub flamePrimBlue: u8_0,
    pub flamePrimAlpha: u8_0,
    pub flameEnvColor: Color_RGB8,
    pub blureIdx: s32,
    pub fireIceTimer: s16,
    pub dmgEffect: u8_0,
...
pub type EnBbActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBb, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_int;
pub const ENBB_KILL_TRAIL: C2RustUnnamed_23 = 11;
pub const ENBB_FLAME_TRAIL: C2RustUnnamed_23 = 0;
pub const ENBB_BLUE: C2RustUnnamed_23 = -1;
pub const ENBB_RED: C2RustUnnamed_23 = -2;
pub const ENBB_WHITE: C2RustUnnamed_23 = -3;
pub const ENBB_GREEN: C2RustUnnamed_23 = -4;
pub const ENBB_GREEN_BIG: C2RustUnnamed_23 = -5;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const BB_GREEN: C2RustUnnamed_24 = 9;
pub const BB_WHITE: C2RustUnnamed_24 = 8;
pub const BB_RED: C2RustUnnamed_24 = 7;
pub const BB_BLUE: C2RustUnnamed_24 = 6;
pub const BB_UNUSED: C2RustUnnamed_24 = 5;
pub const BB_STUNNED: C2RustUnnamed_24 = 4;
pub const BB_DOWN: C2RustUnnamed_24 = 3;
pub const BB_FLAME_TRAIL: C2RustUnnamed_24 = 2;
pub const BB_KILL: C2RustUnnamed_24 = 1;
pub const BB_DAMAGE: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const BBMOVE_HIDDEN: C2RustUnnamed_25 = 2;
pub const BBMOVE_NOCLIP: C2RustUnnamed_25 = 1;
pub const BBMOVE_NORMAL: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const BBBLUE_AGGRO: C2RustUnnamed_26 = 1;
pub const BBBLUE_NORMAL: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const BBRED_HIDE: C2RustUnnamed_27 = 2;
pub const BBRED_ATTACK: C2RustUnnamed_27 = 1;
pub const BBRED_WAIT: C2RustUnnamed_27 = 0;
pub type C2RustUnnamed_28 = libc::c_uint;
pub const BBGREEN_FLAME_OFF: C2RustUnnamed_28 = 1;
pub const BBGREEN_FLAME_ON: C2RustUnnamed_28 = 0;
static mut sDamageTableBlueGreen: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                             ...
                             (1 as libc::c_int |
                                 ...
                                 u8_0,
                             (2 as libc::c_int |
                                  (0xa as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (0 as libc::c_int |
                                  (0xf as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             ...
                             (2 as libc::c_int |
                                 ...
                                 u8_0,
                             (4 as libc::c_int |
                                  (0xc as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (4 as libc::c_int |
                                  (0xb as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (0 as libc::c_int |
                                  (0 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             ...
                             (0 as libc::c_int |
                                 ...
                                 u8_0,
                             (3 as libc::c_int |
                                  (0x9 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (3 as libc::c_int |
                                  (0x8 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (0 as libc::c_int |
                                  (0xa as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
...
static mut sDamageTableRed: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
...
static mut sDamageTableWhite: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                             ...
                             (4 as libc::c_int |
                                 ...
                                 u8_0,
                             (4 as libc::c_int |
                                  (0x5 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (2 as libc::c_int |
                                  (0xe as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             ...
                             (2 as libc::c_int |
                                 ...
                                 u8_0,
                             (4 as libc::c_int |
                                  (0x7 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (0 as libc::c_int |
                                  (0x6 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
...
#[no_mangle]
pub static mut En_Bb_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BB as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBb>() as libc::c_ulong,
                          init:
...
static mut sJntSphElementInit: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupAction(mut this: *mut EnBb,
                                          mut actionFunc: EnBbActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_FindExplosive(mut globalCtx: *mut GlobalContext,
                                            mut this: *mut EnBb,
                                            mut range: f32_0) -> *mut Actor {
    let mut explosive: *mut Actor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_EXPLOSIVE as libc::c_int as
                                             usize].head;
    let mut dist: f32_0 = 0.;
    while !explosive.is_null() {
        if (*explosive).params as libc::c_int != 0 as libc::c_int {
            explosive = (*explosive).next
        } else {
            dist = Actor_WorldDistXYZToActor(&mut (*this).actor, explosive);
            if (*explosive).params as libc::c_int == 0 as libc::c_int &&
                   dist <= range {
                return explosive
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SpawnFlameTrail(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut this: *mut EnBb,
                                              mut startAtZero: s16) {
    let mut now: *mut EnBb = this;
    let mut next: *mut EnBb = 0 as *mut EnBb;
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        next =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_BB as libc::c_int as s16,
                        (*this).actor.world.pos.x, (*this).actor.world.pos.y,
                        (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16) as *mut EnBb;
        if !next.is_null() {
            (*now).actor.child = &mut (*next).actor;
            (*next).actor.parent = &mut (*now).actor;
            (*next).targetActor = &mut (*this).actor;
            (*next).actionVar1 = (i + 1 as libc::c_int) as s16;
            (*next).actor.scale.x = 1.0f32;
            (*next).flamePrimAlpha =
                (255 as libc::c_int - i * 40 as libc::c_int) as u8_0;
            (*next).actionVar2 = (*next).flamePrimAlpha as s16;
            (*next).actor.scale.y = 0.8f32 - i as libc::c_float * 0.075f32;
            (*next).flameScaleY = (*next).actor.scale.y;
            (*next).actor.scale.z = 1.0f32 - i as libc::c_float * 0.094f32;
            (*next).flameScaleX = (*next).actor.scale.z;
            if startAtZero != 0 {
                (*next).flamePrimAlpha = 0 as libc::c_int as u8_0;
                (*next).flameScaleX = 0.0f32;
                (*next).flameScaleY = (*next).flameScaleX
            }
            (*next).flameScrollMod = (i + 1 as libc::c_int) as s16;
            (*next).timer = 2 as libc::c_int * i + 2 as libc::c_int;
            (*next).flameEnvColor.r = 255 as libc::c_int as u8_0;
            now = next
        }
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_KillFlameTrail(mut this: *mut EnBb) {
    let mut actor: *mut Actor = &mut (*this).actor;
    while !(*actor).child.is_null() {
        let mut nextActor: *mut Actor = (*actor).child;
        if (*nextActor).id as libc::c_int == ACTOR_EN_BB as libc::c_int {
            (*nextActor).parent = 0 as *mut Actor;
            (*actor).child = 0 as *mut Actor;
            (*nextActor).params = ENBB_KILL_TRAIL as libc::c_int as s16
        }
        actor = nextActor
    }
...
// Main functions
#[no_mangle]
pub unsafe extern "C" fn EnBb_Init(mut thisx: *mut Actor,
    ...
    let mut blureInit: EffectBlureInit1 =
        EffectBlureInit1{unk_00: [0; 388],
                         ...
                         calcMode: 0,};
    let mut pad: s32 = 0;
    let mut this: *mut EnBb = thisx as *mut EnBb;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_Bb_Skel_001A30, &mut object_Bb_Anim_000444,
                   (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 16 as libc::c_int);
    (*this).unk_254 = 0 as libc::c_int;
    (*thisx).colChkInfo.health = 4 as libc::c_int as u8_0;
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider, thisx,
                       &mut sJntSphInit, (*this).elements.as_mut_ptr());
    (*this).actionState =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int) as s16;
    if (*thisx).params as libc::c_int & 0x80 as libc::c_int != 0 {
        (*thisx).params =
            ((*thisx).params as libc::c_int | 0xff00 as libc::c_int) as s16
    }
    if (*thisx).params as libc::c_int <= ENBB_BLUE as libc::c_int {
        ActorShape_Init(&mut (*thisx).shape, 200.0f32,
    ...
    if (*thisx).params as libc::c_int & 0xff00 as libc::c_int != 0 {
        (*this).timer = 0 as libc::c_int;
        (*this).flameScaleY = 80.0f32;
        (*this).flameScaleX = 100.0f32;
        (*(*this).collider.elements.offset(0 as libc::c_int as
                                               isize)).info.toucherFlags =
            ((1 as libc::c_int) << 0 as libc::c_int |
                 (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
        (*(*this).collider.elements.offset(0 as libc::c_int as
                                               isize)).info.toucher.dmgFlags =
            0xffcfffff as libc::c_uint;
        (*(*this).collider.elements.offset(0 as libc::c_int as
                                               isize)).info.toucher.damage =
            8 as libc::c_int as u8_0;
        (*this).bobSize =
            (*this).actionState as libc::c_int as libc::c_float * 20.0f32;
        (*this).flamePrimAlpha = 255 as libc::c_int as u8_0;
        (*this).moveMode = BBMOVE_NORMAL as libc::c_int;
        Actor_SetScale(thisx, 0.01f32);
        let mut current_block_56: u64;
        match (*thisx).params as libc::c_int {
            -1 => {
                (*thisx).naviEnemyId = 0x1c as libc::c_int as u8_0;
                (*thisx).colChkInfo.damageTable = &mut sDamageTableBlueGreen;
                (*this).flameEnvColor.b = 255 as libc::c_int as u8_0;
                (*this).flamePrimBlue = (*this).flameEnvColor.b;
                (*thisx).world.pos.y += 50.0f32;
                EnBb_SetupBlue(this);
                (*thisx).flags |=
                    ((1 as libc::c_int) << 14 as libc::c_int) as libc::c_uint;
                current_block_56 = 1724319918354933278;
            }
            -2 => {
                (*thisx).naviEnemyId = 0x24 as libc::c_int as u8_0;
                (*thisx).colChkInfo.damageTable = &mut sDamageTableRed;
                (*this).flameEnvColor.r = 255 as libc::c_int as u8_0;
                (*(*this).collider.elements.offset(0 as libc::c_int as
                                                       isize)).info.toucher.effect
                    = 1 as libc::c_int as u8_0;
                EnBb_SetupRed(globalCtx, this);
                current_block_56 = 1724319918354933278;
            }
            -3 => {
                (*thisx).naviEnemyId = 0x1d as libc::c_int as u8_0;
                (*thisx).colChkInfo.damageTable = &mut sDamageTableWhite;
                (*this).path = (*this).actionState as u8_0;
                ...
                blureInit.p2EndColor[3 as libc::c_int as usize] =
                    0 as libc::c_int as u8_0;
                blureInit.elemDuration = 16 as libc::c_int;
                blureInit.unkFlag = 0 as libc::c_int;
                blureInit.calcMode = 2 as libc::c_int;
                Effect_Add(globalCtx, &mut (*this).blureIdx,
                           EFFECT_BLURE1 as libc::c_int,
                           0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
                           &mut blureInit as *mut EffectBlureInit1 as
                               *mut libc::c_void);
            ...
            -5 => {
                (*this).path =
                    ((*this).actionState as libc::c_int >> 4 as libc::c_int)
                        as u8_0;
                (*(*this).collider.elements.offset(0 as libc::c_int as
                                                       isize)).dim.modelSphere.radius
                    = 0x16 as libc::c_int as s16;
                Actor_SetScale(thisx, 0.03f32);
                current_block_56 = 15206252865582047828;
            }
            -4 => { current_block_56 = 15206252865582047828; }
            _ => { current_block_56 = 1724319918354933278; }
        }
        match current_block_56 {
            15206252865582047828 => {
                (*thisx).naviEnemyId = 0x1e as libc::c_int as u8_0;
                (*this).bobSize =
                    ((*this).actionState as libc::c_int & 0xf as libc::c_int)
                        as libc::c_float * 20.0f32;
                (*thisx).colChkInfo.damageTable = &mut sDamageTableBlueGreen;
                (*this).flameEnvColor.g = 255 as libc::c_int as u8_0;
                (*thisx).colChkInfo.health = 1 as libc::c_int as u8_0;
                EnBb_InitGreen(this, globalCtx);
            }
            _ => { }
        }
        (*thisx).focus.pos = (*thisx).world.pos
    } else { EnBb_SetupFlameTrail(this); }
    (*(*this).collider.elements.offset(0 as libc::c_int as
        ...
        ((*(*this).collider.elements.offset(0 as libc::c_int as
             ...
             (*(*this).collider.elements.offset(0 as libc::c_int as
                                                    isize)).dim.scale) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBb = thisx as *mut EnBb;
...
// Action functions
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupFlameTrail(mut this: *mut EnBb) {
    (*this).action = BB_FLAME_TRAIL as libc::c_int;
    (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
    (*this).actor.flags &=
    ...
    EnBb_SetupAction(this,
                     Some(EnBb_FlameTrail as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_FlameTrail(mut this: *mut EnBb,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.params as libc::c_int == ENBB_KILL_TRAIL as libc::c_int {
        if (*this).actor.parent.is_null() {
            EnBb_SetupDeath(this, globalCtx);
        }
    } else if (*this).timer == 0 as libc::c_int {
        if (*((*this).targetActor as *mut EnBb)).flameScaleY != 0.0f32 {
            Math_SmoothStepToF(&mut (*this).flameScaleY,
                               (*this).actor.scale.y, 1.0f32,
                               (*this).actor.scale.y * 0.1f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).flameScaleX,
                               (*this).actor.scale.z, 1.0f32,
                               (*this).actor.scale.z * 0.1f32, 0.0f32);
            if (*this).flamePrimAlpha as libc::c_int !=
                   (*this).actionVar2 as libc::c_int {
                (*this).flamePrimAlpha =
                    ((*this).flamePrimAlpha as libc::c_int +
                         10 as libc::c_int) as u8_0;
                if ((*this).actionVar2 as libc::c_int) <
                       (*this).flamePrimAlpha as libc::c_int {
                    (*this).flamePrimAlpha = (*this).actionVar2 as u8_0
                }
            }
        } else if (*this).flamePrimAlpha == 0 {
            Actor_Kill(&mut (*this).actor);
            return
        } else {
            if (*this).flamePrimAlpha as libc::c_int <= 20 as libc::c_int {
                (*this).flamePrimAlpha = 0 as libc::c_int as u8_0
            } else {
                (*this).flamePrimAlpha =
                    ((*this).flamePrimAlpha as libc::c_int -
        ...
        (*this).timer -= 1;
        (*this).actor.world.rot.y = (*(*this).actor.parent).world.rot.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupDeath(mut this: *mut EnBb,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.params as libc::c_int <= ENBB_BLUE as libc::c_int {
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.speedXZ = -7.0f32;
        (*this).timer = 5 as libc::c_int;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int + 0x4e20 as libc::c_int)
                as s16;
        EffectSsDeadSound_SpawnStationary(globalCtx,
                                          &mut (*this).actor.projectedPos,
                                          0x38ce as libc::c_int as u16_0,
                                          1 as libc::c_int as s16,
                                          1 as libc::c_int as s16,
                                          0x28 as libc::c_int);
    }
    (*this).action = BB_KILL as libc::c_int;
    EnBb_SetupAction(this,
                     Some(EnBb_Death as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Death(mut this: *mut EnBb,
                                    mut globalCtx: *mut GlobalContext) {
    let mut enpartType: s16 = 3 as libc::c_int as s16;
    let mut sp40: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
    let mut sp34: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if (*this).actor.params as libc::c_int <= ENBB_BLUE as libc::c_int {
        Math_SmoothStepToF(&mut (*this).flameScaleY, 0.0f32, 1.0f32, 30.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).flameScaleX, 0.0f32, 1.0f32, 30.0f32,
                           0.0f32);
        ...
        if (*this).bodyBreak.val == 0 as libc::c_int {
            BodyBreak_Alloc(&mut (*this).bodyBreak, 12 as libc::c_int,
                            globalCtx);
        }
        if (*this).dmgEffect as libc::c_int == 7 as libc::c_int ||
               (*this).dmgEffect as libc::c_int == 5 as libc::c_int {
            enpartType = 11 as libc::c_int as s16
        }
        if BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
                                globalCtx, enpartType) == 0 {
            return
        }
        ...
        if (*this).flamePrimAlpha as libc::c_int <= 20 as libc::c_int {
            ...
            (*this).flamePrimAlpha =
                ((*this).flamePrimAlpha as libc::c_int - 20 as libc::c_int) as
                    u8_0
        }
        return
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupDamage(mut this: *mut EnBb) {
    (*this).action = BB_DAMAGE as libc::c_int;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38e3 as libc::c_int as u16_0);
    if (*this).actor.params as libc::c_int > ENBB_GREEN as libc::c_int {
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    ...
    if (*this).actor.params as libc::c_int == ENBB_RED as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Damage(mut this: *mut EnBb,
                                     mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    if (*this).actor.speedXZ == 0.0f32 {
        (*this).actor.shape.yOffset = 200.0f32;
        EnBb_SetupDown(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupBlue(mut this: *mut EnBb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000444);
    (*this).actor.speedXZ = Rand_ZeroOne() * 0.5f32 + 0.5f32;
    (*this).timer = (Rand_ZeroOne() * 20.0f32 + 40.0f32) as s32;
    (*this).unk_264 = (Rand_ZeroOne() * 30.0f32 + 180.0f32) as s32;
    (*this).targetActor = 0 as *mut Actor;
    (*this).action = BB_BLUE as libc::c_int;
    EnBb_SetupAction(this,
                     Some(EnBb_Blue as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Blue(mut this: *mut EnBb,
                                   mut globalCtx: *mut GlobalContext) {
    let mut explosive: *mut Actor = 0 as *mut Actor;
    let mut moveYawToWall: s16 = 0;
    let mut thisYawToWall: s16 = 0;
    let mut afterHitAngle: s16 = 0;
    Math_SmoothStepToF(&mut (*this).flameScaleY, 80.0f32, 1.0f32, 10.0f32,
                       0.0f32);
    Math_SmoothStepToF(&mut (*this).flameScaleX, 100.0f32, 1.0f32, 10.0f32,
                       0.0f32);
    if (*this).actor.floorHeight > -32000.0f32 {
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.floorHeight + 50.0f32 +
                               (*this).flyHeightMod, 1.0f32, 0.5f32, 0.0f32);
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_CosF((*this).bobPhase) == 0.0f32 {
        if (*this).charge != 0 {
            (*this).bobSpeedMod = Rand_ZeroOne() * 2.0f32
        } else { (*this).bobSpeedMod = Rand_ZeroOne() * 4.0f32 }
    }
    (*this).actor.world.pos.y +=
        Math_CosF((*this).bobPhase) * (1.0f32 + (*this).bobSpeedMod);
    (*this).bobPhase += 0.2f32;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).maxSpeed, 1.0f32,
                       0.5f32, 0.0f32);
    if Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
        ...
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).actionVar2,
                           1 as libc::c_int as s16,
        ...
        if (*this).timer <= 0 as libc::c_int {
            (*this).charge =
                ((*this).charge as libc::c_int ^ 1 as libc::c_int) as s16;
            (*this).flyHeightMod =
                (Math_CosF((*this).bobPhase) * 10.0f32) as s16 as f32_0;
            (*this).actor.speedXZ = 0.0f32;
            if (*this).charge as libc::c_int != 0 &&
                   (*this).targetActor.is_null() {
                (*this).actionVar2 = (*this).actor.world.rot.y;
                if (*this).actor.xzDistToPlayer < 200.0f32 {
                    Animation_PlayLoop(&mut (*this).skelAnime,
                                       &mut object_Bb_Anim_000184);
                    (*this).actionVar2 = (*this).actor.yawTowardsPlayer
                }
                (*this).maxSpeed = Rand_ZeroOne() * 1.5f32 + 6.0f32;
                (*this).timer = (Rand_ZeroOne() * 5.0f32 + 20.0f32) as s32;
                (*this).actionState = BBBLUE_NORMAL as libc::c_int as s16
            } else {
                Animation_PlayLoop(&mut (*this).skelAnime,
                                   &mut object_Bb_Anim_000444);
                (*this).maxSpeed = Rand_ZeroOne() * 1.5f32 + 1.0f32;
                (*this).timer = (Rand_ZeroOne() * 20.0f32 + 40.0f32) as s32;
                (*this).actionVar2 =
                    (Math_SinF((*this).bobPhase) * 65535.0f32) as s16
            }
        }
        if (*this).actor.xzDistToPlayer < 150.0f32 &&
               (*this).actionState as libc::c_int !=
                   BBBLUE_NORMAL as libc::c_int {
            if (*this).charge == 0 {
                Animation_PlayLoop(&mut (*this).skelAnime,
                                   &mut object_Bb_Anim_000184);
                (*this).maxSpeed = Rand_ZeroOne() * 1.5f32 + 6.0f32;
                (*this).timer = (Rand_ZeroOne() * 5.0f32 + 20.0f32) as s32;
                (*this).actionVar2 = (*this).actor.yawTowardsPlayer;
                (*this).charge = 1 as libc::c_int as s16;
                (*this).actionState = (*this).charge
                // Sets actionState to BBBLUE_AGGRO
            }
        } else if (*this).actor.xzDistToPlayer < 200.0f32 {
            (*this).actionVar2 = (*this).actor.yawTowardsPlayer
        }
        if (*this).targetActor.is_null() {
            explosive = EnBb_FindExplosive(globalCtx, this, 300.0f32)
        } else if (*(*this).targetActor).params as libc::c_int ==
                      0 as libc::c_int {
            explosive = (*this).targetActor
        } else { explosive = 0 as *mut Actor }
        if !explosive.is_null() {
            (*this).actionVar2 =
                Actor_WorldYawTowardActor(&mut (*this).actor, explosive);
            if (*this).actionVar1 as libc::c_int == 0 as libc::c_int &&
                   explosive != (*this).targetActor {
                (*this).actionVar1 = -(0x8000 as libc::c_int) as s16;
                (*this).targetActor = explosive;
                (*this).actor.speedXZ *= 0.5f32
            }
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                               (*this).actionVar2, 1 as libc::c_int as s16,
                               0x1388 as libc::c_int as s16,
                               0 as libc::c_int as s16);
            Math_SmoothStepToF(&mut (*this).actor.world.pos.x,
                               (*explosive).world.pos.x, 1.0f32, 1.5f32,
                               0.0f32);
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*explosive).world.pos.y + 40.0f32, 1.0f32,
                               1.5f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).actor.world.pos.z,
                               (*explosive).world.pos.z, 1.0f32, 1.5f32,
                               0.0f32);
        } else { (*this).targetActor = 0 as *mut Actor }
        if (*this).actionVar1 as libc::c_int != 0 as libc::c_int {
            (*this).actor.world.pos.y +=
                -Math_CosS((*this).actionVar1) * 10.0f32;
            (*this).actionVar1 =
                ((*this).actionVar1 as libc::c_int + 0x1000 as libc::c_int) as
                    s16;
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                               (*this).actionVar2, 1 as libc::c_int as s16,
                               0x7d0 as libc::c_int as s16,
        ...
        moveYawToWall =
            ((*this).actor.wallYaw as libc::c_int -
                 (*this).actionVar2 as libc::c_int) as s16;
        if (*this).targetActor.is_null() &&
               (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int !=
                   0 &&
               ((if thisYawToWall as libc::c_int >= 0 as libc::c_int {
                     thisYawToWall as libc::c_int
                 } else { -(thisYawToWall as libc::c_int) }) >
                    0x4000 as libc::c_int ||
                    (if moveYawToWall as libc::c_int >= 0 as libc::c_int {
                         moveYawToWall as libc::c_int
                     } else { -(moveYawToWall as libc::c_int) }) >
                        0x4000 as libc::c_int) {
            (*this).actionVar2 =
                ((*this).actor.wallYaw as libc::c_int +
                     (*this).actor.wallYaw as libc::c_int -
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).actionVar2,
                       1 as libc::c_int as s16, 0x3e8 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).collider.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            afterHitAngle = -(0x8000 as libc::c_int) as s16
        } else {
            afterHitAngle = 0x4000 as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38cb as libc::c_int as u16_0);
        ...
        (*this).actor.world.rot.y =
            ((*this).actor.yawTowardsPlayer as libc::c_int +
                 afterHitAngle as libc::c_int) as s16;
    ...
    if (*this).maxSpeed >= 6.0f32 {
        if (*this).skelAnime.curFrame as s32 == 0 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 5 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38c9 as libc::c_int as u16_0);
        } else if (*this).skelAnime.curFrame as s32 == 2 as libc::c_int ||
                      (*this).skelAnime.curFrame as s32 == 7 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38c8 as libc::c_int as u16_0);
        }
    } else if (*this).skelAnime.curFrame as s32 == 5 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c8 as libc::c_int as u16_0);
    }
    if (*this).skelAnime.curFrame as s32 == 0 as libc::c_int &&
           Rand_ZeroOne() < 0.1f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ca as libc::c_int as u16_0);
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupDown(mut this: *mut EnBb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000444);
    (*this).action = BB_DOWN as libc::c_int;
    (*this).timer = 200 as libc::c_int;
    ...
    (*this).flameScaleX = 0.0f32;
    (*this).flameScaleY = 0.0f32;
    (*this).actor.gravity = -2.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38cd as libc::c_int as u16_0);
    EnBb_SetupAction(this,
                     Some(EnBb_Down as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Down(mut this: *mut EnBb,
                                   mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 =
        ((*this).actor.world.rot.y as libc::c_int -
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
        if (*this).actor.params as libc::c_int == ENBB_RED as libc::c_int {
            let mut floorType: s32 =
                func_80041D4C(&mut (*globalCtx).colCtx,
                              (*this).actor.floorPoly,
                              (*this).actor.floorBgId as s32) as s32;
            if floorType == 2 as libc::c_int || floorType == 3 as libc::c_int
                   || floorType == 9 as libc::c_int {
                (*this).moveMode = BBMOVE_HIDDEN as libc::c_int;
                (*this).timer = 10 as libc::c_int;
                (*this).actionState += 1;
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
                (*this).action = BB_RED as libc::c_int;
                EnBb_SetupAction(this,
                                 Some(EnBb_Red as
                                          unsafe extern "C" fn(_: *mut EnBb,
                                                               _:
        ...
        if (*this).actor.velocity.y < -14.0f32 {
            (*this).actor.velocity.y *= -0.7f32
        } else { (*this).actor.velocity.y = 10.0f32 }
        (*this).actor.bgCheckFlags =
            ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int))
                as u16_0;
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).actor.world.pos, 7.0f32,
    ...
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).skelAnime.curFrame as s32 == 5 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c8 as libc::c_int as u16_0);
    }
    if (*this).timer == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38cc as libc::c_int as u16_0);
        match (*this).actor.params as libc::c_int {
            ...
            -2 => {
                if (*this).actor.velocity.y == 10.0f32 {
                    EnBb_SetupRed(globalCtx, this);
                    EnBb_SpawnFlameTrail(globalCtx, this,
                                         1 as libc::c_int as s16);
                }
            }
            -3 => {
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupRed(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut EnBb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000184);
    if (*this).action == BB_DOWN as libc::c_int {
        (*this).actor.speedXZ = 5.0f32;
        (*this).actor.gravity = -1.0f32;
        (*this).actor.velocity.y = 16.0f32;
        (*this).actionState = BBRED_ATTACK as libc::c_int as s16;
        (*this).timer = 0 as libc::c_int;
        (*this).moveMode = BBMOVE_NORMAL as libc::c_int;
        (*this).actor.bgCheckFlags =
            ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int))
        ...
        (*this).actor.colChkInfo.health = 4 as libc::c_int as u8_0;
        (*this).timer = 0 as libc::c_int;
        (*this).actionState = BBRED_WAIT as libc::c_int as s16;
        (*this).moveMode = BBMOVE_HIDDEN as libc::c_int;
        (*this).actor.world.pos.y -= 80.0f32;
        (*this).actor.home.pos = (*this).actor.world.pos;
        (*this).actor.speedXZ = 0.0f32;
        (*this).actor.gravity = (*this).actor.speedXZ;
...
pub unsafe extern "C" fn EnBb_Red(mut this: *mut EnBb,
    ...
    match (*this).actionState as libc::c_int {
        0 => {
            if Actor_WorldDistXYZToActor(&mut (*this).actor,
                                         &mut (*player).actor) <= 250.0f32 &&
                ...
                (*this).actor.speedXZ = 5.0f32;
                (*this).actor.gravity = -1.0f32;
                (*this).actor.velocity.y = 18.0f32;
                (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
                (*this).timer = 7 as libc::c_int;
                (*this).actor.bgCheckFlags =
        ...
        1 => {
            ...
            Math_SmoothStepToF(&mut (*this).flameScaleY, 80.0f32, 1.0f32,
                               10.0f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).flameScaleX, 100.0f32, 1.0f32,
                               10.0f32, 0.0f32);
            if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int !=
                   0 {
                yawDiff =
            ...
            if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                ...
                floorType =
                    func_80041D4C(&mut (*globalCtx).colCtx,
                                  (*this).actor.floorPoly,
                                  (*this).actor.floorBgId as s32) as s32;
                if floorType == 2 as libc::c_int ||
                       floorType == 3 as libc::c_int ||
                       floorType == 9 as libc::c_int {
                    (*this).moveMode = BBMOVE_HIDDEN as libc::c_int;
                    (*this).timer = 10 as libc::c_int;
                    (*this).actionState += 1;
                    ...
                    (*this).actor.velocity.y *= -1.06f32;
                    if (*this).actor.velocity.y > 13.0f32 {
                        (*this).actor.velocity.y = 13.0f32
                    }
                    (*this).actor.world.rot.y =
                        (Math_SinF((*this).bobPhase) * 65535.0f32) as s16
                }
            ...
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
            if !Actor_GetCollidedExplosive(globalCtx,
                                           &mut (*this).collider.base).is_null()
               {
                EnBb_SetupDown(this);
            }
        }
        2 => {
            if (*this).timer == 0 as libc::c_int {
                ...
                (*this).actor.velocity.y = 0.0f32;
                (*this).actionState = BBRED_WAIT as libc::c_int as s16;
                (*this).timer = 120 as libc::c_int;
                (*this).actor.world.pos = (*this).actor.home.pos;
                (*this).actor.world.rot = (*this).actor.home.rot;
    ...
    if (*this).actionState as libc::c_int != BBRED_WAIT as libc::c_int {
        if (*this).skelAnime.curFrame as s32 == 0 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 5 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38c9 as libc::c_int as u16_0);
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x38cf as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    };
}
// Helper functions
#[no_mangle]
pub unsafe extern "C" fn EnBb_FaceWaypoint(mut this: *mut EnBb) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetWaypoint(mut this: *mut EnBb,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).waypoint as libc::c_int ==
           ((*path).count as libc::c_int - 1 as libc::c_int) as s16 as
               libc::c_int {
        (*this).waypoint = 0 as libc::c_int as u8_0
    } else { (*this).waypoint = (*this).waypoint.wrapping_add(1) }
    point =
    ...
    (*this).waypointPos.x = (*point).x as f32_0;
    (*this).waypointPos.y = (*point).y as f32_0;
    (*this).waypointPos.z = (*point).z as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupWhite(mut globalCtx: *mut GlobalContext,
                                         mut this: *mut EnBb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000444);
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.world.pos.y += 60.0f32;
    (*this).flameScaleX = 100.0f32;
    (*this).action = BB_WHITE as libc::c_int;
    (*this).waypoint = 0 as libc::c_int as u8_0;
    (*this).timer = (Rand_ZeroOne() * 30.0f32 + 40.0f32) as s32;
    (*this).maxSpeed = 7.0f32;
    EnBb_SetupAction(this,
                     Some(EnBb_White as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_White(mut this: *mut EnBb,
                                    mut globalCtx: *mut GlobalContext) {
    if (*this).actor.speedXZ == 0.0f32 {
        let mut distL1: f32_0 = 0.;
        let mut vx: f32_0 = 0.;
        let mut vz: f32_0 = 0.;
        let mut pitch: s16 =
            Math_Vec3f_Pitch(&mut (*this).actor.world.pos,
                             &mut (*this).waypointPos);
        let mut vy: f32_0 = Math_SinS(pitch) * (*this).maxSpeed;
        let mut vxz: f32_0 = Math_CosS(pitch) * (*this).maxSpeed;
        vx = Math_SinS((*this).actor.shape.rot.y) * vxz;
        vz = Math_CosS((*this).actor.shape.rot.y) * vxz;
        distL1 =
            Math_SmoothStepToF(&mut (*this).actor.world.pos.x,
                               (*this).waypointPos.x, 1.0f32,
                               if vx >= 0 as libc::c_int as libc::c_float {
                                   vx
                               } else { -vx }, 0.0f32);
        distL1 +=
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*this).waypointPos.y, 1.0f32,
                               if vy >= 0 as libc::c_int as libc::c_float {
                                   vy
                               } else { -vy }, 0.0f32);
        distL1 +=
            Math_SmoothStepToF(&mut (*this).actor.world.pos.z,
                               (*this).waypointPos.z, 1.0f32,
                               if vz >= 0 as libc::c_int as libc::c_float {
                                   vz
                               } else { -vz }, 0.0f32);
        (*this).bobPhase += 0.05f32 + Rand_ZeroOne() * 0.01f32;
        if distL1 == 0.0f32 {
            (*this).timer -= 1;
            if (*this).timer == 0 as libc::c_int {
                EnBb_SetWaypoint(this, globalCtx);
                ...
                if (*this).moveMode != BBMOVE_NORMAL as libc::c_int {
                    Animation_PlayLoop(&mut (*this).skelAnime,
                                       &mut object_Bb_Anim_000444);
                }
                (*this).actor.world.rot.y =
            ...
            (*this).moveMode = BBMOVE_NORMAL as libc::c_int;
            (*this).maxSpeed = 0.0f32
        } else {
            (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
            (*this).maxSpeed = 10.0f32
        }
        ...
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y
    } else if Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32,
    ...
    if (*this).maxSpeed != 0.0f32 &&
           ((*this).skelAnime.curFrame as s32 == 0 as libc::c_int ||
                (*this).skelAnime.curFrame as s32 == 5 as libc::c_int) {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38c9 as libc::c_int as u16_0);
    } else if (*this).skelAnime.curFrame as s32 == 2 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_InitGreen(mut this: *mut EnBb,
                                        mut globalCtx: *mut GlobalContext) {
    let mut bobOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000444);
    (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
    (*this).actionState = BBGREEN_FLAME_ON as libc::c_int as s16;
    (*this).bobPhase = Rand_ZeroOne();
    (*this).actor.shape.rot.z = 0 as libc::c_int as s16;
    (*this).actor.shape.rot.x = (*this).actor.shape.rot.z;
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    if (*this).actor.params as libc::c_int == ENBB_GREEN_BIG as libc::c_int {
        EnBb_SetWaypoint(this, globalCtx);
        EnBb_FaceWaypoint(this);
    }
    Matrix_Translate((*this).actor.home.pos.x, (*this).actor.home.pos.y,
    ...
    Matrix_RotateZ((*this).bobPhase, MTXMODE_APPLY as libc::c_int as u8_0);
    bobOffset.y = (*this).bobSize;
    Matrix_MultVec3f(&mut bobOffset, &mut (*this).actor.world.pos);
    (*this).targetActor = 0 as *mut Actor;
    (*this).action = BB_GREEN as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actionVar2 = (Rand_ZeroOne() * 30.0f32 + 180.0f32) as s16;
    EnBb_SetupAction(this,
                     Some(EnBb_Green as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupGreen(mut this: *mut EnBb) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_Bb_Anim_000444);
    (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
    (*this).actionState = BBGREEN_FLAME_ON as libc::c_int as s16;
    (*this).targetActor = 0 as *mut Actor;
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Green(mut this: *mut EnBb,
                                    mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut bobOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut nextPos: Vec3f = (*player).actor.world.pos;
    nextPos.y += 30.0f32;
    if (*this).actor.params as libc::c_int == ENBB_GREEN_BIG as libc::c_int {
        if (*this).actor.speedXZ == 0.0f32 {
            let mut pitch: s16 =
                Math_Vec3f_Pitch(&mut (*this).actor.home.pos,
                                 &mut (*this).waypointPos);
            let mut yaw: s16 =
            ...
            vz =
                Math_SmoothStepToF(&mut (*this).actor.home.pos.x,
                                   (*this).waypointPos.x, 1.0f32,
                                   if vx >= 0 as libc::c_int as libc::c_float
                                      {
                                       vx
            ...
            vz +=
                Math_SmoothStepToF(&mut (*this).actor.home.pos.y,
                                   (*this).waypointPos.y, 1.0f32,
                                   if vy >= 0 as libc::c_int as libc::c_float
                                      {
                                       vy
            ...
            vz +=
                Math_SmoothStepToF(&mut (*this).actor.home.pos.z,
                                   (*this).waypointPos.z, 1.0f32,
                                   if distL1 >=
            ...
            (*this).bobPhase += 0.05f32 + Rand_ZeroOne() * 0.01f32;
            if vz == 0.0f32 { EnBb_SetWaypoint(this, globalCtx); }
            (*this).moveMode = BBMOVE_NOCLIP as libc::c_int;
            (*this).maxSpeed = 10.0f32;
            if (*this).collider.base.atFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 {
            ...
            if Math_CosF((*this).bobPhase) == 0.0f32 {
                if (*this).charge != 0 {
                    ...
                    (*this).bobSpeedMod = Rand_ZeroOne() * 3.0f32;
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x38ca as libc::c_int as u16_0);
                }
            }
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y
        } else if Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32,
                                     1.0f32, 0.5f32, 0.0f32) == 0.0f32 {
            EnBb_FaceWaypoint(this);
        }
    } else {
    ...
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_CosF((*this).bobPhase) <= 0.002f32 {
        (*this).bobSpeedMod = Rand_ZeroOne() * 0.05f32
    }
    Matrix_Translate((*this).actor.home.pos.x, (*this).actor.home.pos.y,
                     (*this).actor.home.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    ...
    Matrix_RotateZ((*this).bobPhase, MTXMODE_APPLY as libc::c_int as u8_0);
    bobOffset.y = (*this).bobSize;
    Matrix_MultVec3f(&mut bobOffset, &mut nextPos);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.x, nextPos.x, 1.0f32,
                       (*this).bobPhase * 0.75f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.y, nextPos.y, 1.0f32,
                       (*this).bobPhase * 0.75f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.world.pos.z, nextPos.z, 1.0f32,
                       (*this).bobPhase * 0.75f32, 0.0f32);
    (*this).bobPhase += 0.1f32 + (*this).bobSpeedMod;
    if !Actor_GetCollidedExplosive(globalCtx,
                                   &mut (*this).collider.base).is_null() ||
           {
               (*this).actionVar2 -= 1;
               ((*this).actionVar2 as libc::c_int) == 0 as libc::c_int
           } {
        (*this).actionState += 1;
        (*this).timer = (Rand_ZeroOne() * 30.0f32 + 60.0f32) as s32;
        if (*this).actionVar2 as libc::c_int != 0 as libc::c_int {
            (*this).collider.base.acFlags =
                ((*this).collider.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38cd as libc::c_int as u16_0);
    }
    if (*this).actionState as libc::c_int != BBGREEN_FLAME_ON as libc::c_int {
        (*this).timer -= 1;
        if (*this).timer == 0 as libc::c_int {
            (*this).actionState = BBGREEN_FLAME_ON as libc::c_int as s16;
            (*this).actionVar2 = (Rand_ZeroOne() * 30.0f32 + 180.0f32) as s16;
        ...
        Math_SmoothStepToF(&mut (*this).flameScaleY, 0.0f32, 1.0f32, 10.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).flameScaleX, 0.0f32, 1.0f32, 10.0f32,
                           0.0f32);
    } else {
        Math_SmoothStepToF(&mut (*this).flameScaleY, 80.0f32, 1.0f32, 10.0f32,
                           0.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_SetupStunned(mut this: *mut EnBb) {
    (*this).action = BB_STUNNED as libc::c_int;
    if (*this).actor.params as libc::c_int != ENBB_WHITE as libc::c_int {
        if (*this).actor.params as libc::c_int != ENBB_RED as libc::c_int {
            if (*this).actor.params as libc::c_int > ENBB_GREEN as libc::c_int
               {
                (*this).actor.gravity = -2.0f32;
            ...
            (*this).flameScaleX = 0.0f32;
            (*this).flameScaleY = 0.0f32
        } else { EnBb_KillFlameTrail(this); }
    }
    let mut current_block_17: u64;
    match (*this).dmgEffect as libc::c_int {
        8 => {
        ...
        9 => {
            (*this).fireIceTimer = 0x30 as libc::c_int as s16;
            current_block_17 = 4965451588476121035;
        }
        15 => { current_block_17 = 4965451588476121035; }
        _ => { current_block_17 = 6057473163062296781; }
    }
    ...
    (*this).actor.bgCheckFlags =
        ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int)) as
            u16_0;
    EnBb_SetupAction(this,
                     Some(EnBb_Stunned as
                              unsafe extern "C" fn(_: *mut EnBb,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBb_Stunned(mut this: *mut EnBb,
                                      mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 =
        ((*this).actor.world.rot.y as libc::c_int -
             (*this).actor.wallYaw as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_CollisionCheck(mut this: *mut EnBb,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if (*this).collider.base.atFlags as libc::c_int &
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        Actor_SetDropFlag(&mut (*this).actor,
                          &mut (*(*this).collider.elements.offset(0 as
                                                                      libc::c_int
                                                                      as
                                                                      isize)).info,
                          0 as libc::c_int);
        ...
        match (*this).dmgEffect as libc::c_int {
            7 => {
                (*this).actor.freezeTimer =
                    (*(*(*this).collider.elements.offset(0 as libc::c_int as
                                                             isize)).info.acHitInfo).toucher.damage
                        as u16_0;
                current_block_54 = 1579445924976015738;
            }
            5 => { current_block_54 = 1579445924976015738; }
            6 => {
                (*this).actor.freezeTimer =
                    (*(*(*this).collider.elements.offset(0 as libc::c_int as
                                                             isize)).info.acHitInfo).toucher.damage
                        as u16_0;
                current_block_54 = 7343950298149844727;
            }
            8 | 9 | 15 => {
                if (*this).action != BB_STUNNED as libc::c_int {
                    Actor_ApplyDamage(&mut (*this).actor);
                    EnBb_SetupStunned(this);
                }
                current_block_54 = 7343950298149844727;
            }
            13 => { current_block_54 = 7343950298149844727; }
            _ => { current_block_54 = 16293764807557091517; }
        }
        match current_block_54 {
            1579445924976015738 => {
                (*this).fireIceTimer = 0x30 as libc::c_int as s16;
                current_block_54 = 16293764807557091517;
            }
            _ => { }
        }
        match current_block_54 {
            16293764807557091517 =>
            // ! @bug
            ...
            {
                if (*this).dmgEffect as libc::c_int == 14 as libc::c_int ||
                       (*this).dmgEffect as libc::c_int == 12 as libc::c_int
                       ||
                       (*this).dmgEffect as libc::c_int == 11 as libc::c_int
                       ||
                       (*this).dmgEffect as libc::c_int == 10 as libc::c_int
                       || (*this).dmgEffect as libc::c_int == 7 as libc::c_int
                       || (*this).dmgEffect as libc::c_int == 5 as libc::c_int
                   {
                    if (*this).action != BB_DOWN as libc::c_int ||
                           (*this).timer < 190 as libc::c_int {
                        Actor_ApplyDamage(&mut (*this).actor);
                    }
                    if (*this).action != BB_DOWN as libc::c_int &&
                           (*this).actor.params as libc::c_int !=
                ...
                } else if (*this).action == BB_DOWN as libc::c_int &&
                              (*this).timer < 190 as libc::c_int ||
                              (*this).actor.params as libc::c_int !=
                                  ENBB_WHITE as libc::c_int &&
                                  (*this).flameScaleX < 20.0f32 {
                    Actor_ApplyDamage(&mut (*this).actor);
                } else {
                    (*this).collider.base.acFlags =
                        ((*this).collider.base.acFlags as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_Update(mut thisx: *mut Actor,
    ...
    let mut sp4C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut sp40: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -0.6f32, z: 0.0f32,}; init };
    let mut sp3C: Color_RGBA8 =
        {
            let mut init =
    ...
    if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
        ...
        if (*this).moveMode == BBMOVE_NORMAL as libc::c_int {
            if (*this).actor.world.pos.y - 20.0f32 <=
                   (*this).actor.floorHeight {
                sp34 = 20.0f32
            }
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, sp34,
                                    25.0f32, 20.0f32, 5 as libc::c_int);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnBb_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnBb = thisx as *mut EnBb;
    BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex, 4 as libc::c_int,
                      15 as libc::c_int, 15 as libc::c_int as u32_0, dList,
                      -(1 as libc::c_int) as s16);
}
static mut sFireIceOffsets: [Vec3f; 12] =
    [{ let mut init = Vec3f{x: 13.0f32, y: 10.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 5.0f32, y: 25.0f32, z: 5.0f32,}; init },
     { let mut init = Vec3f{x: -5.0f32, y: 25.0f32, z: 5.0f32,}; init },
     { let mut init = Vec3f{x: -13.0f32, y: 10.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 5.0f32, y: 25.0f32, z: -5.0f32,}; init },
     { let mut init = Vec3f{x: -5.0f32, y: 25.0f32, z: -5.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 10.0f32, z: -13.0f32,}; init },
     { let mut init = Vec3f{x: 5.0f32, y: 0.0f32, z: 5.0f32,}; init },
     { let mut init = Vec3f{x: 5.0f32, y: 0.0f32, z: -5.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 10.0f32, z: 13.0f32,}; init },
     { let mut init = Vec3f{x: -5.0f32, y: 0.0f32, z: 5.0f32,}; init },
     { let mut init = Vec3f{x: -5.0f32, y: 0.0f32, z: -5.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnBb_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBb = thisx as *mut EnBb;
    let mut blureBase1: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 5000.0f32, z: 0.0f32,}; init };
    let mut blureBase2: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 2000.0f32, z: 0.0f32,}; init };
    let mut blureVtx1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut blureVtx2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bb.c\x00" as *const u8 as *const libc::c_char,
                    2044 as libc::c_int);
    blureBase1.z = (*this).maxSpeed * 80.0f32;
    blureBase2.z = (*this).maxSpeed * 80.0f32;
    if (*this).moveMode != BBMOVE_HIDDEN as libc::c_int {
        if (*this).actor.params as libc::c_int <= ENBB_BLUE as libc::c_int {
            func_80093D18((*globalCtx).state.gfxCtx);
            SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                              (*this).skelAnime.jointTable, None,
                              Some(EnBb_PostLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
            ...
            if (*this).fireIceTimer as libc::c_int != 0 as libc::c_int {
                ...
                (*this).fireIceTimer -= 1;
                if (*this).fireIceTimer as libc::c_int % 4 as libc::c_int ==
                       0 as libc::c_int {
                    let mut sp70: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
                    let mut index: s32 =
                        (*this).fireIceTimer as libc::c_int >>
                            2 as libc::c_int;
                    sp70.x =
                        (*this).actor.world.pos.x +
                            sFireIceOffsets[index as usize].x;
                    sp70.y =
                        (*this).actor.world.pos.y +
                            sFireIceOffsets[index as usize].y;
                    sp70.z =
                        (*this).actor.world.pos.z +
                            sFireIceOffsets[index as usize].z;
                    if (*this).dmgEffect as libc::c_int != 7 as libc::c_int &&
                           (*this).dmgEffect as libc::c_int !=
                               5 as libc::c_int {
                        EffectSsEnIce_SpawnFlyingVec3f(globalCtx,
                                                       &mut (*this).actor,
                                                       &mut sp70,
                                                       0x96 as libc::c_int as
                                                           s16,
                                                       0x96 as libc::c_int as
                                                           s16,
                                                       0x96 as libc::c_int as
                                                           s16,
                                                       0xfa as libc::c_int as
                                                           s16,
                                                       0xeb as libc::c_int as
                                                           s16,
                                                       0xf5 as libc::c_int as
                                                           s16,
                                                       0xff as libc::c_int as
                                                           s16, 0.8f32);
                    } else {
                        sp70.y -= 17.0f32;
                        EffectSsEnFire_SpawnVec3f(globalCtx,
                                                  &mut (*this).actor,
                                                  &mut sp70,
                                                  0x28 as libc::c_int as s16,
                                                  1 as libc::c_int as s16,
                                                  0 as libc::c_int as s16,
                                                  -(1 as libc::c_int) as s16);
                    }
            ...
            Matrix_Translate(0.0f32, (*this).flameScaleX * -40.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
        } else {
            Matrix_Translate(0.0f32, -40.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
        }
        if (*this).actor.params as libc::c_int != ENBB_WHITE as libc::c_int {
            ...
            (*_g).words.w1 =
                Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 ...
                                 (*globalCtx).gameplayFrames.wrapping_add(((*this).flameScrollMod
                                                                               as
                                                                               libc::c_int
                                                                               *
                                                                               10
                                                                                                              ...
                                                                                                              (*this).flameScrollMod
                                                                                                                  ...
                                                                                                                  *
                                                                                                                  -(2
                                                                                                                        ...
                                                                                                                        libc::c_int))
                                                                                                             as
                                                                                                             libc::c_uint).wrapping_rem(0x200
                                                                                                                                            as
                                                                                                                                            libc::c_int
                                                                                                                                            as
                                                                                                                                            libc::c_uint),
                ...
                (255 as libc::c_int as u32_0 &
                    ...
                    (255 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*this).flamePrimBlue as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    ((*this).flamePrimAlpha as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            ...
            (*_g_1).words.w0 =
                (0xfb as libc::c_int as u32_0 &
                    ...
                    24 as libc::c_int;
            (*_g_1).words.w1 =
                ((*this).flameEnvColor.r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    ((*this).flameEnvColor.g as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*this).flameEnvColor.b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (0 as libc::c_int as u32_0 &
            ...
            Matrix_RotateY((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                           ...
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale((*this).flameScaleX * 0.01f32,
                         (*this).flameScaleY * 0.01f32, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_2).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_bb.c\x00" as *const u8 as
            ...
            Matrix_MultVec3f(&mut blureBase1, &mut blureVtx1);
            Matrix_MultVec3f(&mut blureBase2, &mut blureVtx2);
            if (*this).maxSpeed != 0.0f32 &&
                   (*this).action == BB_WHITE as libc::c_int &&
                ...
                EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIdx) as
                                          *mut EffectBlure, &mut blureVtx1,
                                      &mut blureVtx2);
            } else if (*this).action != BB_WHITE as libc::c_int {
