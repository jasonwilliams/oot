...
extern "C" {
    ...
    #[no_mangle]
    static mut object_lightbox_DL_000B70: [Gfx; 0];
    #[no_mangle]
    static mut object_lightbox_Col_001F10: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnLightbox {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut En_Lightbox_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_LIGHTBOX as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_LIGHTBOX as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnLightbox>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnLightbox_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnLightbox_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnLightbox_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnLightbox_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnLightbox_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut this: *mut EnLightbox = thisx as *mut EnLightbox;
    let mut pad: [s32; 4] = [0; 4];
    match (*thisx).params as libc::c_int {
        0 => { Actor_SetScale(thisx, 0.025f32); }
        1 => { Actor_SetScale(thisx, 0.05f32); }
        2 => { Actor_SetScale(thisx, 0.075f32); }
        3 => { Actor_SetScale(thisx, 0.1f32); }
        _ => { }
    }
    (*thisx).focus.pos = (*thisx).world.pos;
    (*thisx).colChkInfo.cylRadius = 30 as libc::c_int as s16;
    (*thisx).colChkInfo.cylHeight = 50 as libc::c_int as s16;
    ...
    (*this).dyna.unk_15C = 0 as libc::c_int as u32_0;
    (*thisx).targetMode = 0 as libc::c_int as s8;
    (*thisx).gravity = -2.0f32;
    CollisionHeader_GetVirtual(&mut object_lightbox_Col_001F10 as
...
#[no_mangle]
pub unsafe extern "C" fn EnLightbox_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnLightbox = thisx as *mut EnLightbox;
...
#[no_mangle]
pub unsafe extern "C" fn EnLightbox_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnLightbox = thisx as *mut EnLightbox;
    if (*this).dyna.unk_162 as libc::c_int != 0 as libc::c_int {
        if Actor_HasNoParent(thisx, globalCtx) != 0 {
            (*this).dyna.unk_162 = 0 as libc::c_int as s16
        }
    } else if Actor_HasParent(thisx, globalCtx) != 0 {
        (*this).dyna.unk_162 += 1
    } else {
        if (*thisx).speedXZ != 0. {
            if (*thisx).bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
                ...
                Audio_PlaySoundGeneral(0x282f as libc::c_int as u16_0,
        ...
        if (*thisx).bgCheckFlags as libc::c_int & 1 as libc::c_int ==
               0 as libc::c_int {
            Math_StepToF(&mut (*thisx).speedXZ, 0 as libc::c_int as f32_0,
            ...
            Math_StepToF(&mut (*thisx).speedXZ, 0 as libc::c_int as f32_0,
                         (*gGameInfo).data[(9 as libc::c_int *
                             ...
                             as libc::c_int as libc::c_float / 100.0f32);
            if (*thisx).bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 &&
                   (*thisx).velocity.y <
            ...
            } else { func_8002F580(thisx, globalCtx); }
        }
    }
    Actor_MoveForward(thisx);
    Actor_UpdateBgCheckInfo(globalCtx, thisx,
                            (*thisx).colChkInfo.cylHeight as f32_0,
                            (*thisx).colChkInfo.cylRadius as f32_0,
                            (*thisx).colChkInfo.cylRadius as f32_0,
                            0x1d as libc::c_int);
    (*thisx).focus.pos = (*thisx).world.pos;
}
#[no_mangle]
pub unsafe extern "C" fn EnLightbox_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, object_lightbox_DL_000B70.as_mut_ptr());
}
