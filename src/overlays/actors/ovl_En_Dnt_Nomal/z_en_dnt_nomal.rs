...
extern "C" {
    ...
    fn EffectSsHahen_SpawnBurst(globalCtx: *mut GlobalContext,
                                ...
                                dList: *mut Gfx);
    #[no_mangle]
    fn EffectSsExtra_Spawn(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                           velocity: *mut Vec3f, accel: *mut Vec3f,
                           scale: s16, scoreIdx: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDntStageSpitAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntStageHideAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntStageDanceAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntStageUnburrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntStageUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gDntStageFlowerDL: [Gfx; 0];
    #[no_mangle]
    static mut gDntStageEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntStageEyeShutTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntStageEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gDntStageSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDntStageWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsSpitAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsFlowerDL: [Gfx; 0];
    #[no_mangle]
    static mut gHintNutsSkel: SkeletonHeader;
    #[no_mangle]
    static mut gHintNutsBurrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsUnburrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsTalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsRunAnim: AnimationHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDntNomal {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 11],
    pub morphTable: [Vec3s; 11],
    pub actionFunc: EnDntNomalActionFunc,
    pub isSolid: u8_0,
    pub flowerPos: Vec3f,
    pub targetVtx: [Vec3f; 4],
    pub timer1: s16,
    pub timer2: s16,
    pub timer4: s16,
    pub timer5: s16,
    ...
    pub endFrame: s16,
    pub stageSignal: s16,
    pub rotDirection: s16,
    pub action: s16,
    pub ignore: u8_0,
    pub spawnedItem: u8_0,
    pub stagePrize: u8_0,
    pub objIndex: s8,
    pub mouthPos: Vec3f,
    pub targetPos: Vec3f,
    pub targetQuad: ColliderQuad,
    pub bodyCyl: ColliderCylinder,
}
pub type EnDntNomalActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDntNomal, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const DNT_SIGNAL_UNUSED: C2RustUnnamed_23 = 6;
pub const DNT_SIGNAL_RETURN: C2RustUnnamed_23 = 5;
pub const DNT_SIGNAL_HIDE: C2RustUnnamed_23 = 4;
pub const DNT_SIGNAL_DANCE: C2RustUnnamed_23 = 3;
pub const DNT_SIGNAL_CELEBRATE: C2RustUnnamed_23 = 2;
pub const DNT_SIGNAL_LOOK: C2RustUnnamed_23 = 1;
pub const DNT_SIGNAL_NONE: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const DNT_PRIZE_STICK: C2RustUnnamed_24 = 2;
pub const DNT_PRIZE_NUTS: C2RustUnnamed_24 = 1;
pub const DNT_PRIZE_NONE: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const DNT_ACTION_PRIZE: C2RustUnnamed_25 = 5;
pub const DNT_ACTION_HIGH_RUPEES: C2RustUnnamed_25 = 4;
pub const DNT_ACTION_LOW_RUPEES: C2RustUnnamed_25 = 3;
pub const DNT_ACTION_ATTACK: C2RustUnnamed_25 = 2;
pub const DNT_ACTION_DANCE: C2RustUnnamed_25 = 1;
pub const DNT_ACTION_NONE: C2RustUnnamed_25 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnExRuppy {
    pub actor: Actor,
    pub actionFunc: EnExRuppyActionFunc,
    pub colorIdx: s16,
    pub type_0: s16,
    pub invisible: s16,
    pub timer: s16,
...
pub type EnExRuppyActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnExRuppy, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const EXITEM_BULLET_BAG: C2RustUnnamed_26 = 19;
pub const EXITEM_MAGIC_DARK: C2RustUnnamed_26 = 18;
pub const EXITEM_MAGIC_WIND: C2RustUnnamed_26 = 17;
pub const EXITEM_MAGIC_FIRE: C2RustUnnamed_26 = 16;
pub const EXITEM_SMALL_KEY_CHEST: C2RustUnnamed_26 = 15;
pub const EXITEM_14: C2RustUnnamed_26 = 14;
pub const EXITEM_13: C2RustUnnamed_26 = 13;
pub const EXITEM_RED_RUPEE_CHEST: C2RustUnnamed_26 = 12;
pub const EXITEM_BLUE_RUPEE_CHEST: C2RustUnnamed_26 = 11;
pub const EXITEM_GREEN_RUPEE_CHEST: C2RustUnnamed_26 = 10;
pub const EXITEM_PURPLE_RUPEE_COUNTER: C2RustUnnamed_26 = 9;
pub const EXITEM_BOMBS_COUNTER: C2RustUnnamed_26 = 8;
pub const EXITEM_BOMBCHUS_COUNTER: C2RustUnnamed_26 = 7;
pub const EXITEM_HEART_PIECE_COUNTER: C2RustUnnamed_26 = 6;
pub const EXITEM_BOMB_BAG_COUNTER: C2RustUnnamed_26 = 5;
pub const EXITEM_PURPLE_RUPEE_BOWLING: C2RustUnnamed_26 = 4;
pub const EXITEM_BOMBS_BOWLING: C2RustUnnamed_26 = 3;
pub const EXITEM_BOMBCHUS_BOWLING: C2RustUnnamed_26 = 2;
pub const EXITEM_HEART_PIECE_BOWLING: C2RustUnnamed_26 = 1;
pub const EXITEM_BOMB_BAG_BOWLING: C2RustUnnamed_26 = 0;
#[no_mangle]
pub static mut En_Dnt_Nomal_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DNT_NOMAL as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntNomal_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntNomal_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntNomal_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTargetQuadInit: ColliderQuadInit =
    {
        let mut init =
...
static mut sLeafColors: [Color_RGBA8; 9] =
    [{
         let mut init =
     ...
     },
     {
         let mut init =
             Color_RGBA8{r: 255 as libc::c_int as u8_0,
                         g: 195 as libc::c_int as u8_0,
                         b: 175 as libc::c_int as u8_0,
                         a: 255 as libc::c_int as u8_0,};
         init
     },
     {
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    (*this).type_0 = (*this).actor.params;
    if ((*this).type_0 as libc::c_int) < 0 as libc::c_int {
        (*this).type_0 = 0 as libc::c_int as s16
    }
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).objId = -(1 as libc::c_int) as s16;
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "Deku Scrub target"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x87\xe3\x82\xb0\xe3\x83\x8a\xe3\x83\x83\xe3\x83\x84\xe7\x9a\x84\xe5\xbd\x93\xe3\x81\xa6 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Collider_InitQuad(globalCtx, &mut (*this).targetQuad);
        Collider_SetQuad(globalCtx, &mut (*this).targetQuad,
                         &mut (*this).actor, &mut sTargetQuadInit);
        (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        (*this).objId = OBJECT_HINTNUTS as libc::c_int as s16
    } else {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "Deku Scrub mask show audience"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x87\xe3\x82\xb0\xe3\x83\x8a\xe3\x83\x83\xe3\x83\x84\xe3\x81\x8a\xe9\x9d\xa2\xe5\x93\x81\xe8\xa9\x95\xe4\xbc\x9a\xe4\xb8\x80\xe8\x88\xac\xe4\xba\xba \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Collider_InitCylinder(globalCtx, &mut (*this).bodyCyl);
        Collider_SetCylinder(globalCtx, &mut (*this).bodyCyl,
                             &mut (*this).actor, &mut sBodyCylinderInit);
        (*this).objId = OBJECT_DNK as libc::c_int as s16
    }
    if (*this).objId as libc::c_int >= 0 as libc::c_int {
        (*this).objIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx, (*this).objId) as s8;
        if ((*this).objIndex as libc::c_int) < 0 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            // "What?"
            osSyncPrintf(b"\x1b[35m \xe3\x81\xaa\xe3\x81\xab\xe3\x81\xbf\xe3\x81\xae\xef\xbc\x9f %d\n\x1b[m\n\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).objIndex as libc::c_int);
            // "Bank is funny"
            osSyncPrintf(b"\x1b[36m \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84\xe3\x81\x97\xe3\x81\x9e\xef\xbc\x81%d\n\x1b[m\n\x00"
                             as *const u8 as *const libc::c_char,
    ...
    (*this).actionFunc =
        Some(EnDntNomal_WaitForObject as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        Collider_DestroyQuad(globalCtx, &mut (*this).targetQuad);
    } else { Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCyl); };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_WaitForObject(mut this: *mut EnDntNomal,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, (*this).objIndex as s32)
           != 0 {
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objIndex as usize].segment
        ...
        if (*this).type_0 as libc::c_int == 0 as libc::c_int {
            SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                           &mut gHintNutsSkel, &mut gHintNutsBurrowAnim,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           10 as libc::c_int);
            (*this).actor.draw =
                Some(EnDntNomal_DrawTargetScrub as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ())
        } else {
            SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                           &mut gDntStageSkel, &mut gDntStageHideAnim,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           11 as libc::c_int);
            (*this).actor.draw =
                Some(EnDntNomal_DrawStageScrub as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ())
        }
        (*this).actionFunc =
            Some(EnDntNomal_SetFlower as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetFlower(mut this: *mut EnDntNomal,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        if (*this).type_0 as libc::c_int == 0 as libc::c_int {
            (*this).actionFunc =
                Some(EnDntNomal_SetupTargetWait as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageWait as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupTargetWait(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gHintNutsBurrowAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gHintNutsBurrowAnim, 0.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).skelAnime.curFrame = 8.0f32;
    (*this).actionFunc =
        Some(EnDntNomal_TargetWait as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetWait(mut this: *mut EnDntNomal,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut scorePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut targetX: f32_0 = 1340.0f32;
    let mut targetY: f32_0 = 50.0f32;
    let mut targetZ: f32_0 = -30.0f32;
    let mut dx: f32_0 = 0.;
    let mut dy: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    let mut scoreAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut scoreVel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    (*this).targetVtx[3 as libc::c_int as usize].x = targetX;
    (*this).targetVtx[2 as libc::c_int as usize].x =
        (*this).targetVtx[3 as libc::c_int as usize].x;
    (*this).targetVtx[1 as libc::c_int as usize].x =
        (*this).targetVtx[2 as libc::c_int as usize].x;
    (*this).targetVtx[0 as libc::c_int as usize].x =
        (*this).targetVtx[1 as libc::c_int as usize].x;
    (*this).targetVtx[0 as libc::c_int as usize].y = targetY - 24.0f32;
    (*this).targetVtx[1 as libc::c_int as usize].y =
        (*this).targetVtx[0 as libc::c_int as usize].y;
    (*this).targetVtx[0 as libc::c_int as usize].z = targetZ + 24.0f32;
    (*this).targetVtx[2 as libc::c_int as usize].z =
        (*this).targetVtx[0 as libc::c_int as usize].z;
    (*this).targetVtx[1 as libc::c_int as usize].z = targetZ - 24.0f32;
    (*this).targetVtx[3 as libc::c_int as usize].z =
        (*this).targetVtx[1 as libc::c_int as usize].z;
    (*this).targetVtx[2 as libc::c_int as usize].y = targetY + 24.0f32;
    (*this).targetVtx[3 as libc::c_int as usize].y =
        (*this).targetVtx[2 as libc::c_int as usize].y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).targetQuad.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 0 as libc::c_int) as
                                 usize] as libc::c_int != 0 {
        (*this).targetQuad.base.acFlags =
            ((*this).targetQuad.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        dx =
            fabsf(targetX -
                      (*this).targetQuad.info.bumper.hitPos.x as libc::c_int
                          as libc::c_float);
        dy =
            fabsf(targetY -
                      (*this).targetQuad.info.bumper.hitPos.y as libc::c_int
                          as libc::c_float);
        dz =
            fabsf(targetZ -
                      (*this).targetQuad.info.bumper.hitPos.z as libc::c_int
                          as libc::c_float);
        scoreVel.y = 5.0f32;
        if sqrtf(dx * dx + dy * dy + dz * dz) < 8.0f32 {
            scorePos.x = (*this).actor.world.pos.x - 20.0f32;
            scorePos.y = (*this).actor.world.pos.y + 20.0f32;
            scorePos.z = (*this).actor.world.pos.z;
            EffectSsExtra_Spawn(globalCtx, &mut scorePos, &mut scoreVel,
                                &mut scoreAccel, 4 as libc::c_int as s16,
                                2 as libc::c_int as s16);
            Audio_StopSfxById(0x4807 as libc::c_int as u32_0);
            func_80078884(0x4807 as libc::c_int as u16_0);
            // "Big hit"
            osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa4\xa7\xe5\xbd\x93\xe3\x82\x8a \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).hitCounter as libc::c_int);
            if !(gSaveContext.linkAge == 0 as libc::c_int) &&
                ...
                (*this).hitCounter += 1;
                if (*this).hitCounter as libc::c_int >= 3 as libc::c_int {
                    OnePointCutscene_Init(globalCtx,
                                          4140 as libc::c_int as s16,
                                          -(99 as libc::c_int) as s16,
                                          &mut (*this).actor,
                                          0 as libc::c_int as s16);
                    func_8002DF54(globalCtx, &mut (*this).actor,
                                  1 as libc::c_int as u8_0);
                    (*this).timer4 = 50 as libc::c_int as s16;
                    (*this).actionFunc =
                        Some(EnDntNomal_SetupTargetUnburrow as
                                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
            }
        } else if sqrtf(dx * dx + dy * dy + dz * dz) < 24.0f32 {
            ...
            EffectSsExtra_Spawn(globalCtx, &mut scorePos, &mut scoreVel,
                                &mut scoreAccel, 4 as libc::c_int as s16,
                                0 as libc::c_int as s16);
            (*this).hitCounter = 0 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupTargetUnburrow(mut this:
                                                            *mut EnDntNomal,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    ...
    if (*this).timer4 as libc::c_int == 0 as libc::c_int {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gHintNutsUnburrowAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gHintNutsUnburrowAnim,
                         1.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        spawnPos = (*this).actor.world.pos;
        spawnPos.y = (*this).actor.world.pos.y + 50.0f32;
        EffectSsHahen_SpawnBurst(globalCtx, &mut spawnPos, 4.0f32,
                                 0 as libc::c_int as s16,
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387c as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnDntNomal_TargetUnburrow as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetUnburrow(mut this: *mut EnDntNomal,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frame >= (*this).endFrame as libc::c_int as libc::c_float {
        (*this).actionFunc =
            Some(EnDntNomal_SetupTargetWalk as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupTargetWalk(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gHintNutsRunAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gHintNutsRunAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.speedXZ = 1.0f32;
    (*this).actor.colChkInfo.mass = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnDntNomal_TargetWalk as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetWalk(mut this: *mut EnDntNomal,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut dx: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    dx = 1340.0f32 + 3.0f32 - (*this).actor.world.pos.x;
    dz = 0.0f32 - (*this).actor.world.pos.z;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ...
                       0xbb8 as libc::c_int as s16, 0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 6.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387f as libc::c_int as u16_0);
    }
    if (*this).actor.world.pos.z > -30.0f32 {
        (*this).actor.speedXZ = 0.0f32;
        (*this).actionFunc =
            Some(EnDntNomal_TargetFacePlayer as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetFacePlayer(mut this:
                                                         *mut EnDntNomal,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if fabsf(((*this).actor.shape.rot.y as libc::c_int -
                  (*this).actor.yawTowardsPlayer as libc::c_int) as f32_0) <
           30.0f32 {
        (*this).actionFunc =
            Some(EnDntNomal_SetupTargetTalk as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupTargetTalk(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gHintNutsTalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gHintNutsTalkAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.textId = 0x10af as libc::c_int as u16_0;
    Message_StartTextbox(globalCtx, (*this).actor.textId, 0 as *mut Actor);
    (*this).actionFunc =
        Some(EnDntNomal_TargetTalk as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetTalk(mut this: *mut EnDntNomal,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_8005B1A4((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                  usize]);
        (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize]).csId =
            0 as libc::c_int as s16;
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        (*this).actionFunc =
            Some(EnDntNomal_SetupTargetGivePrize as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupTargetGivePrize(mut this:
                                                             *mut EnDntNomal,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gHintNutsSpitAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gHintNutsSpitAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnDntNomal_TargetGivePrize as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetGivePrize(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frame >= 8.0f32 && (*this).spawnedItem == 0 {
        let mut itemX: f32_0 = (*this).mouthPos.x - 10.0f32;
        let mut itemY: f32_0 = (*this).mouthPos.y;
        let mut itemZ: f32_0 = (*this).mouthPos.z;
        if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                              globalCtx,
                              ACTOR_EN_EX_ITEM as libc::c_int as s16, itemX,
                              itemY, itemZ, 0 as libc::c_int as s16,
                              0 as libc::c_int as s16,
                              0 as libc::c_int as s16,
                              EXITEM_BULLET_BAG as libc::c_int as
                                  s16).is_null() {
            func_8002DF54(globalCtx, 0 as *mut Actor,
                          7 as libc::c_int as u8_0);
            Actor_Kill(&mut (*this).actor);
        }
        (*this).spawnedItem = 1 as libc::c_int as u8_0;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387e as libc::c_int as u16_0);
    }
    if frame >= (*this).endFrame as libc::c_int as libc::c_float {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gHintNutsRunAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gHintNutsRunAnim,
                         1.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
        (*this).actionFunc =
            Some(EnDntNomal_TargetReturn as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetReturn(mut this: *mut EnDntNomal,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut dx: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    ...
    dz = -180.0f32 - (*this).actor.world.pos.z;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (Math_FAtan2F(dx, dz) *
                            (0x8000 as libc::c_int as libc::c_float /
                                 3.14159265358979323846f32)) as s16,
    ...
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    if (*this).actor.world.pos.z < -172.0f32 {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gHintNutsBurrowAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gHintNutsBurrowAnim,
                         1.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        (*this).actor.world.pos.z = -173.0f32;
        (*this).actor.speedXZ = 0.0f32;
        (*this).actionFunc =
            Some(EnDntNomal_TargetBurrow as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_TargetBurrow(mut this: *mut EnDntNomal,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageWait(mut this: *mut EnDntNomal,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if (*this).timer3 as libc::c_int == 0 as libc::c_int {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gDntStageHideAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gDntStageHideAnim,
                         0.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        (*this).skelAnime.curFrame = 8.0f32;
        (*this).isSolid = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnDntNomal_StageWait as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageWait(mut this: *mut EnDntNomal,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageUp(mut this: *mut EnDntNomal,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).timer3 as libc::c_int == 0 as libc::c_int {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gDntStageUpAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gDntStageUpAnim, 1.0f32,
                         0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        if (*this).action as libc::c_int != DNT_ACTION_ATTACK as libc::c_int {
            (*this).rotDirection = -(1 as libc::c_int) as s16
        }
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
                                 4.0f32, 0 as libc::c_int as s16,
                                 10 as libc::c_int as s16,
                                 3 as libc::c_int as s16,
                                 15 as libc::c_int as s16,
                                 -(1 as libc::c_int) as s16,
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387c as libc::c_int as u16_0);
        (*this).isSolid = 1 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnDntNomal_StageUp as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageUp(mut this: *mut EnDntNomal,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut rotTarget: s16 = 0;
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    let mut turnMod: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frame >= (*this).endFrame as libc::c_int as libc::c_float &&
           (*this).action as libc::c_int == DNT_ACTION_ATTACK as libc::c_int {
        (*this).actionFunc =
            Some(EnDntNomal_SetupStageAttack as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    } else {
        if (*this).timer4 as libc::c_int == 0 as libc::c_int {
            turnMod = 0.0f32;
            if (*this).stagePrize as libc::c_int ==
                   DNT_PRIZE_NONE as libc::c_int {
                Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                                   (*this).actor.yawTowardsPlayer,
                                   3 as libc::c_int as s16,
            ...
            if Rand_ZeroFloat(10.0f32 + turnMod) < 1.0f32 &&
                   (*this).action as libc::c_int !=
                       DNT_ACTION_ATTACK as libc::c_int {
                (*this).timer4 =
            ...
            if (*this).timer2 as libc::c_int == 0 as libc::c_int {
                (*this).rotDirection += 1;
                if (*this).rotDirection as libc::c_int > 1 as libc::c_int {
                    (*this).rotDirection = -(1 as libc::c_int) as s16
                }
                (*this).timer2 =
            ...
            if (*this).rotDirection as libc::c_int != 0 as libc::c_int {
                rotTarget =
                    (rotTarget as libc::c_int +
                         (*this).rotDirection as libc::c_int *
                             0x1388 as libc::c_int) as s16
            }
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, rotTarget,
                               3 as libc::c_int as s16,
                               0x1388 as libc::c_int as s16,
                               0 as libc::c_int as s16);
        }
        if (*this).actor.xzDistToPlayer < 70.0f32 {
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageHide as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageUnburrow(mut this:
                                                           *mut EnDntNomal,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if (*this).timer3 as libc::c_int == 0 as libc::c_int {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gDntStageUnburrowAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gDntStageUnburrowAnim,
                         1.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        (*this).isSolid = 0 as libc::c_int as u8_0;
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387c as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnDntNomal_StageUnburrow as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageUnburrow(mut this: *mut EnDntNomal,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frame >= (*this).endFrame as libc::c_int as libc::c_float {
        if (*this).action as libc::c_int != DNT_ACTION_DANCE as libc::c_int {
            (*this).timer3 =
                (Rand_ZeroFloat(2.0f32) as s16 as libc::c_int +
                     ((*this).type_0 as libc::c_int as libc::c_float * 0.5f32)
                         as s16 as libc::c_int) as s16;
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageCelebrate as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).timer2 = 300 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageDance as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageCelebrate(mut this:
                                                            *mut EnDntNomal,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntStageWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntStageWalkAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.speedXZ = 3.0f32;
    (*this).isSolid = 1 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnDntNomal_StageCelebrate as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageCelebrate(mut this: *mut EnDntNomal,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer1 as libc::c_int == 0 as libc::c_int &&
           (*this).timer3 as libc::c_int == 0 as libc::c_int {
        let mut dx: f32_0 = (*this).targetPos.x - (*this).actor.world.pos.x;
        let mut dz: f32_0 = (*this).targetPos.z - (*this).actor.world.pos.z;
        if fabsf(dx) < 10.0f32 && fabsf(dz) < 10.0f32 &&
               Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int !=
                   TEXT_STATE_NONE as libc::c_int {
            (*this).action = DNT_ACTION_PRIZE as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageDance as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ());
        ...
        if (*this).timer1 as libc::c_int == 1 as libc::c_int {
            (*this).timer3 =
                (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int as
                     libc::c_float + 20.0f32) as s16
        }
    ...
    if (*this).timer5 as libc::c_int == 0 as libc::c_int {
        (*this).timer5 = 20 as libc::c_int as s16;
        if (*this).type_0 as libc::c_int & 1 as libc::c_int ==
               0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3880 as libc::c_int as u16_0);
        }
    } else if (*this).timer5 as libc::c_int & 3 as libc::c_int ==
                  0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387f as libc::c_int as u16_0);
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 &&
        ...
        (*this).actor.velocity.y = 7.5f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageDance(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntStageDanceAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntStageDanceAnim, 1.0f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).isSolid = 1 as libc::c_int as u8_0;
    (*this).timer3 =
        (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int as libc::c_float +
             20.0f32) as s16;
    (*this).rotDirection = -(1 as libc::c_int) as s16;
    if Rand_ZeroFloat(1.99f32) < 1.0f32 {
        (*this).rotDirection = 1 as libc::c_int as s16
    }
    (*this).actionFunc =
        Some(EnDntNomal_StageDance as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageDance(mut this: *mut EnDntNomal,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer2 as libc::c_int == 0 as libc::c_int {
        if (*this).action as libc::c_int == DNT_ACTION_DANCE as libc::c_int {
            (*this).action = DNT_ACTION_HIGH_RUPEES as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDntNomal_SetupStageHide as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).action = DNT_ACTION_NONE as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnDntNomal_StageSetupReturn as
                         unsafe extern "C" fn(_: *mut EnDntNomal,
                                              _: *mut GlobalContext) -> ())
        }
        ...
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           ...
                           0x1388 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if (*this).timer3 as libc::c_int == 1 as libc::c_int {
            (*this).timer4 =
                (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int as
                     libc::c_float + 20.0f32) as s16;
            (*this).rotDirection =
                -((*this).rotDirection as libc::c_int) as s16
        }
    } else if (*this).timer4 as libc::c_int != 0 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).rotDirection as libc::c_int * 0x800 as libc::c_int)
                as s16;
        if (*this).timer4 as libc::c_int == 1 as libc::c_int {
            (*this).timer3 =
                (Rand_ZeroFloat(20.0f32) as s16 as libc::c_int as
                     libc::c_float + 20.0f32) as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageHide(mut this: *mut EnDntNomal,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if (*this).timer3 as libc::c_int != 0 as libc::c_int {
        if (*this).timer3 as libc::c_int == 1 as libc::c_int &&
               (*this).ignore as libc::c_int == 1 as libc::c_int {
        ...
        (*this).isSolid = 0 as libc::c_int as u8_0;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387d as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnDntNomal_StageHide as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageHide(mut this: *mut EnDntNomal,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut rupee: *mut EnExRuppy = 0 as *mut EnExRuppy;
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    let mut rupeeColor: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if frame >= (*this).endFrame as libc::c_int as libc::c_float {
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
                                 4.0f32, 0 as libc::c_int as s16,
        ...
        match (*this).action as libc::c_int {
            ...
            2 => {
                (*this).actionFunc =
                    Some(EnDntNomal_StageAttackHide as
                             unsafe extern "C" fn(_: *mut EnDntNomal,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
            3 | 4 => {
                rupee =
                    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                ...
                                0 as libc::c_int as s16,
                                0 as libc::c_int as s16,
                                3 as libc::c_int as s16) as *mut EnExRuppy;
                if !rupee.is_null() {
                    rupeeColor =
                        ((*this).action as libc::c_int -
                             DNT_ACTION_LOW_RUPEES as libc::c_int) as s16;
                    (*rupee).colorIdx = rupeeColor;
                    if Rand_ZeroFloat(3.99f32) < 1.0f32 {
                        (*rupee).colorIdx =
                            (rupeeColor as libc::c_int + 1 as libc::c_int) as
                                s16
                    }
                    (*rupee).actor.velocity.y = 5.0f32;
                    if (*rupee).colorIdx as libc::c_int == 2 as libc::c_int {
                        (*rupee).actor.velocity.y = 7.0f32
                    }
                    func_80078884(0x4807 as libc::c_int as u16_0);
                }
                (*this).action = DNT_ACTION_NONE as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageAttackHide(mut this: *mut EnDntNomal,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if (*this).actor.xzDistToPlayer > 70.0f32 {
        (*this).actionFunc =
            Some(EnDntNomal_SetupStageUp as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_SetupStageAttack(mut this:
                                                         *mut EnDntNomal,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).timer3 as libc::c_int == 0 as libc::c_int {
        (*this).endFrame =
            Animation_GetLastFrame(&mut gDntStageSpitAnim as
                                       *mut AnimationHeader as
                                       *mut libc::c_void) as f32_0 as s16;
        Animation_Change(&mut (*this).skelAnime, &mut gDntStageSpitAnim,
                         1.0f32, 0.0f32, (*this).endFrame as f32_0,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
        (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
        (*this).isSolid = 1 as libc::c_int as u8_0;
        ...
        (*this).actionFunc =
            Some(EnDntNomal_StageAttack as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageAttack(mut this: *mut EnDntNomal,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut nut: *mut Actor = 0 as *mut Actor;
    let mut frame: f32_0 = (*this).skelAnime.curFrame;
    let mut dz: f32_0 = 0.;
    let mut dx: f32_0 = 0.;
    let mut dy: f32_0 = 0.;
    ...
    dy = (*player).actor.world.pos.y + 30.0f32 - (*this).mouthPos.y;
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       -((Math_FAtan2F(dy, sqrtf(dx * dx + dz * dz)) *
                             ...
                             libc::c_int) as s16, 3 as libc::c_int as s16,
                       0x1388 as libc::c_int as s16, 0 as libc::c_int as s16);
    if frame >= (*this).endFrame as libc::c_int as libc::c_float &&
    ...
    if (*this).timer2 as libc::c_int == 1 as libc::c_int {
        (*this).spawnedItem = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnDntNomal_SetupStageAttack as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).actor.xzDistToPlayer < 50.0f32 {
        (*this).action = DNT_ACTION_ATTACK as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDntNomal_SetupStageHide as
                     unsafe extern "C" fn(_: *mut EnDntNomal,
                                          _: *mut GlobalContext) -> ())
    } else if frame >= 8.0f32 && (*this).spawnedItem == 0 {
        let mut baseOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut spawnOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        ...
        baseOffset.y = 0.0f32;
        baseOffset.z = 5.0f32;
        Matrix_MultVec3f(&mut baseOffset, &mut spawnOffset);
        spawnX = (*this).mouthPos.x + spawnOffset.x;
        spawnY = (*this).mouthPos.y + spawnOffset.y;
        spawnZ = (*this).mouthPos.z + spawnOffset.z;
        nut =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_NUTSBALL as libc::c_int as s16, spawnX,
                        spawnY, spawnZ, (*this).actor.shape.rot.x,
                        (*this).actor.shape.rot.y, (*this).actor.shape.rot.z,
                        4 as libc::c_int as s16);
        if !nut.is_null() { (*nut).velocity.y = spawnOffset.y * 0.5f32 }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387e as libc::c_int as u16_0);
        (*this).spawnedItem = 1 as libc::c_int as u8_0
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageSetupReturn(mut this:
                                                         *mut EnDntNomal,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    (*this).endFrame =
        Animation_GetLastFrame(&mut gDntStageWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0 as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gDntStageWalkAnim, 1.5f32,
                     0.0f32, (*this).endFrame as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.speedXZ = 4.0f32;
    (*this).isSolid = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnDntNomal_StageReturn as
                 unsafe extern "C" fn(_: *mut EnDntNomal,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_StageReturn(mut this: *mut EnDntNomal,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    } else if (*this).timer5 as libc::c_int & 1 as libc::c_int == 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387f as libc::c_int as u16_0);
    }
    if fabsf(sp2C) < 7.0f32 && fabsf(sp28) < 7.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    ...
    (*this).unkCounter += 1;
    if (*this).type_0 as libc::c_int != 0 as libc::c_int {
        match (*this).stageSignal as libc::c_int {
            1 => {
                if (*this).stagePrize as libc::c_int ==
                       DNT_PRIZE_NONE as libc::c_int {
                    (*this).actionFunc =
            ...
            2 => {
                ...
                (*this).timer3 =
                    (Rand_ZeroFloat(3.0f32) as s16 as libc::c_int +
                         ((*this).type_0 as libc::c_int as libc::c_float *
                              0.5f32) as s16 as libc::c_int) as s16;
                (*this).actionFunc =
                    Some(EnDntNomal_SetupStageUnburrow as
                             unsafe extern "C" fn(_: *mut EnDntNomal,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
            3 => {
                (*this).action = DNT_ACTION_DANCE as libc::c_int as s16;
                (*this).actionFunc =
                    Some(EnDntNomal_SetupStageUnburrow as
                             unsafe extern "C" fn(_: *mut EnDntNomal,
                                                  _: *mut GlobalContext)
    ...
    if (*this).stageSignal as libc::c_int != DNT_SIGNAL_NONE as libc::c_int {
        (*this).stageSignal = DNT_SIGNAL_NONE as libc::c_int as s16
    }
    if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
        (*this).eyeState += 1;
        if (*this).eyeState as libc::c_int >= 3 as libc::c_int {
            (*this).eyeState = 0 as libc::c_int as s16;
            (*this).blinkTimer =
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 20.0f32,
                            60.0f32, 0x1d as libc::c_int);
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        Collider_SetQuadVertices(&mut (*this).targetQuad,
                                 &mut *(*this).targetVtx.as_mut_ptr().offset(0
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                 &mut *(*this).targetVtx.as_mut_ptr().offset(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                 &mut *(*this).targetVtx.as_mut_ptr().offset(2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                 &mut *(*this).targetVtx.as_mut_ptr().offset(3
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize));
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).targetQuad.base);
    } else {
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).bodyCyl);
        if (*this).isSolid != 0 {
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).bodyCyl.base);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    if limbIndex == 1 as libc::c_int || limbIndex == 3 as libc::c_int ||
           limbIndex == 4 as libc::c_int || limbIndex == 5 as libc::c_int ||
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_dnt_nomal.c\x00" as *const u8 as
                            *const libc::c_char, 1733 as libc::c_int);
        ...
        (*_g_0).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_0).words.w1 =
            (sLeafColors[((*this).type_0 as libc::c_int - 1 as libc::c_int) as
                             usize].r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (sLeafColors[((*this).type_0 as libc::c_int -
                                  1 as libc::c_int) as usize].g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (sLeafColors[((*this).type_0 as libc::c_int -
                                  1 as libc::c_int) as usize].b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_dnt_nomal.c\x00" as *const u8 as
                             *const libc::c_char, 1743 as libc::c_int);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
                                                 mut dList: *mut *mut Gfx,
                                                 mut rot: *mut Vec3s,
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        if limbIndex == 5 as libc::c_int {
            Matrix_MultVec3f(&mut zeroVec, &mut (*this).mouthPos);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_DrawStageScrub(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    static mut blinkTex: [*mut libc::c_void; 3] =
        unsafe {
            [gDntStageEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDntStageEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDntStageEyeShutTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    let mut dustScale: Vec3f =
        { let mut init = Vec3f{x: 0.25f32, y: 0.25f32, z: 0.25f32,}; init };
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dnt_nomal.c\x00" as *const u8 as
                        *const libc::c_char, 1790 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((blinkTex[(*this).eyeState as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(blinkTex[(*this).eyeState as usize]
                                              as u32_0 &
    ...
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      ...
                      Some(EnDntNomal_OverrideLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    ...
                                                    _: *mut libc::c_void)
                                   -> s32),
                      Some(EnDntNomal_PostLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: s32, _: *mut *mut Gfx,
                                                    _: *mut Vec3s,
                                                    _: *mut libc::c_void)
                                   -> ()), this as *mut libc::c_void);
    Matrix_Translate((*this).flowerPos.x, (*this).flowerPos.y,
                     (*this).flowerPos.z, MTXMODE_NEW as libc::c_int as u8_0);
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gDntStageFlowerDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dnt_nomal.c\x00" as *const u8 as
                         *const libc::c_char, 1817 as libc::c_int);
    if (*this).actionFunc ==
           Some(EnDntNomal_StageCelebrate as
                    unsafe extern "C" fn(_: *mut EnDntNomal,
                                         _: *mut GlobalContext) -> ()) {
        func_80033C30(&mut (*this).actor.world.pos, &mut dustScale,
                      255 as libc::c_int as u8_0, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntNomal_DrawTargetScrub(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut EnDntNomal = thisx as *mut EnDntNomal;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dnt_nomal.c\x00" as *const u8 as
                        *const libc::c_char, 1833 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gHintNutsFlowerDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dnt_nomal.c\x00" as *const u8 as
                         *const libc::c_char, 1851 as libc::c_int);
}
