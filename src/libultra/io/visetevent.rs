...
#[no_mangle]
pub unsafe extern "C" fn osViSetEvent(mut mq: *mut OSMesgQueue,
                                      mut msg: OSMesg,
                                      mut retraceCount: u32_0) {
    let mut prevInt: u32_0 = __osDisableInt() as u32_0;
    (*__osViNext).mq = mq;
    (*__osViNext).msg = msg as *mut OSMesg;
    (*__osViNext).retraceCount = retraceCount as u16_0;
