...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gBowlingRound1WallDL: [Gfx; 0];
    #[no_mangle]
    static mut gBowlingFirstAndFinalRoundCol: CollisionHeader;
    #[no_mangle]
    static mut gBowlingRound2WallDL: [Gfx; 0];
    #[no_mangle]
    static mut gBowlingSecondRoundCol: CollisionHeader;
}
...
pub const DPM_UNK3: C2RustUnnamed_17 = 3;
pub const DPM_ENEMY: C2RustUnnamed_17 = 2;
pub const DPM_PLAYER: C2RustUnnamed_17 = 1;
pub const DPM_UNK: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnExItem {
    pub actor: Actor,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgBowlWall {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgBowlWallActionFunc,
    pub initPos: Vec3f,
    pub bullseyeCenter: Vec3f,
    pub isHit: s16,
    pub timer: s16,
    pub chuGirl: *mut EnBomBowlMan,
}
pub type BgBowlWallActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgBowlWall, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnWallTubo {
    pub actor: Actor,
    pub actionFunc: EnWallTuboActionFunc,
    pub timer: s16,
    pub explosionCenter: Vec3f,
    pub chuGirl: *mut EnBomBowlMan,
    pub unk_164: Vec3f,
}
pub type EnWallTuboActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWallTubo, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Bowl_Wall_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BOWL_WALL as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BOWL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgBowlWall>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBowlWall_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBowlWall_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBowlWall_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBowlWall_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                                                                                                   *mut GlobalContext)
                                                                              ->
                                                                                  ())),}; // wall slides downwards
            init
        }
    };
static mut sBullseyeOffset: [Vec3f; 4] =
    [{ let mut init = Vec3f{x: 0.0f32, y: 210.0f32, z: -20.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 170.0f32, z: -20.0f32,}; init },
     { let mut init = Vec3f{x: -170.0f32, y: 0.0f32, z: -20.0f32,}; init },
     { let mut init = Vec3f{x: 170.0f32, y: 0.0f32, z: -20.0f32,}; init }];
static mut sTargetRot: [s16; 4] =
    [0 as libc::c_int as s16, 0 as libc::c_int as s16,
     0x3fff as libc::c_int as s16, -(0x3fff as libc::c_int) as s16];
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgBowlWall = thisx as *mut BgBowlWall;
    let mut pad1: s32 = 0;
    let mut pad2: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gBowlingFirstAndFinalRoundCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gBowlingSecondRoundCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    }
    (*this).dyna.bgId =
    ...
    osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x9c\xe3\x83\xbc\xe3\x83\xaa\xe3\x83\xb3\xe3\x82\xb0\xe3\x81\x8a\xe3\x81\x98\xe3\x82\x83\xe3\x81\xbe\xe5\xa3\x81\xe7\x99\xba\xe7\x94\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
    (*this).actionFunc =
        Some(BgBowlWall_SpawnBullseyes as
                 unsafe extern "C" fn(_: *mut BgBowlWall,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.scale.z = 1.0f32;
    (*this).dyna.actor.scale.y = (*this).dyna.actor.scale.z;
    (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.y;
}
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgBowlWall = thisx as *mut BgBowlWall;
...
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_SpawnBullseyes(mut this: *mut BgBowlWall,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut bullseye: *mut EnWallTubo = 0 as *mut EnWallTubo;
    let mut lookForGirl: *mut Actor = 0 as *mut Actor;
    let mut type_0: s16 = 0;
    type_0 = (*this).dyna.actor.params;
    if type_0 as libc::c_int != 0 as libc::c_int {
        type_0 =
            (type_0 as libc::c_int +
                 Rand_ZeroFloat(2.99f32) as s16 as libc::c_int) as s16;
        (*this).dyna.actor.world.rot.z = sTargetRot[type_0 as usize];
        (*this).dyna.actor.shape.rot.z = (*this).dyna.actor.world.rot.z;
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    }
    (*this).bullseyeCenter.x =
        sBullseyeOffset[type_0 as usize].x + (*this).dyna.actor.world.pos.x;
    (*this).bullseyeCenter.y =
        sBullseyeOffset[type_0 as usize].y + (*this).dyna.actor.world.pos.y;
    (*this).bullseyeCenter.z =
        sBullseyeOffset[type_0 as usize].z + (*this).dyna.actor.world.pos.z;
    bullseye =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_EN_WALL_TUBO as libc::c_int as s16,
                           (*this).bullseyeCenter.x, (*this).bullseyeCenter.y,
                           (*this).bullseyeCenter.z, 0 as libc::c_int as s16,
                           0 as libc::c_int as s16, 0 as libc::c_int as s16,
                           (*this).dyna.actor.params) as *mut EnWallTubo;
    if !bullseye.is_null() {
        (*bullseye).explosionCenter = (*this).bullseyeCenter;
        if type_0 as libc::c_int != 0 as libc::c_int {
            (*this).bullseyeCenter = (*this).dyna.actor.world.pos;
            (*bullseye).explosionCenter = (*this).bullseyeCenter
        }
        if (*this).chuGirl.is_null() {
            lookForGirl =
                (*globalCtx).actorCtx.actorLists[ACTORCAT_NPC as libc::c_int
                                                     as usize].head;
            while !lookForGirl.is_null() {
                if (*lookForGirl).id as libc::c_int !=
                       ACTOR_EN_BOM_BOWL_MAN as libc::c_int {
                    lookForGirl = (*lookForGirl).next
                } else {
                    (*this).chuGirl = lookForGirl as *mut EnBomBowlMan;
                    break ;
                }
            }
        }
        (*this).actionFunc =
            Some(BgBowlWall_WaitForHit as
                     unsafe extern "C" fn(_: *mut BgBowlWall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_WaitForHit(mut this: *mut BgBowlWall,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).isHit != 0 {
        (*this).actionFunc =
            Some(BgBowlWall_FallDoEffects as
                     unsafe extern "C" fn(_: *mut BgBowlWall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_FallDoEffects(mut this: *mut BgBowlWall,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s16 = 0;
    ...
    let mut wallFallen: s32 = 0;
    let mut i: s32 = 0;
    wallFallen = 0 as libc::c_int;
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        // wall collapses backwards
        Math_SmoothStepToS(&mut (*this).dyna.actor.shape.rot.x,
                           -(0x3e80 as libc::c_int) as s16,
                           3 as libc::c_int as s16, 500 as libc::c_int as s16,
        ...
        if ((*this).dyna.actor.shape.rot.x as libc::c_int) <
               -(0x3c1e as libc::c_int) {
            wallFallen = 1 as libc::c_int
        }
    } else {
        Math_ApproachF(&mut (*this).dyna.actor.world.pos.y,
                       (*this).initPos.y - 450.0f32, 0.3f32, 10.0f32);
        if (*this).dyna.actor.world.pos.y < (*this).initPos.y - 400.0f32 {
            wallFallen = 1 as libc::c_int
        }
    }
    if wallFallen != 0 {
        ...
        while i < 15 as libc::c_int {
            effectPos.x =
                Rand_CenteredFloat(300.0f32) + (*this).bullseyeCenter.x;
            effectPos.y = -100.0f32;
            effectPos.z =
                Rand_CenteredFloat(400.0f32) + (*this).bullseyeCenter.z;
            EffectSsBomb2_SpawnLayered(globalCtx, &mut effectPos,
                                       &mut effectVelocity, &mut effectAccel,
                                       100 as libc::c_int as s16,
                                       30 as libc::c_int as s16);
            effectPos.y = -50.0f32;
            EffectSsHahen_SpawnBurst(globalCtx, &mut effectPos, 10.0f32,
                                     0 as libc::c_int as s16,
        ...
        Quake_SetQuakeValues(quakeIndex, 300 as libc::c_int as s16,
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16);
        Quake_SetCountdown(quakeIndex, 30 as libc::c_int as s16);
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgBowlWall_FinishFall as
                     unsafe extern "C" fn(_: *mut BgBowlWall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_FinishFall(mut this: *mut BgBowlWall,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).timer as libc::c_int >= 2 as libc::c_int {
        ...
        (*this).dyna.actor.shape.rot.x = 0 as libc::c_int as s16;
        (*this).dyna.actor.world.rot.x = (*this).dyna.actor.shape.rot.x;
        (*this).dyna.actor.world.pos.y = (*this).initPos.y - 450.0f32;
        (*(*this).chuGirl).wallStatus[(*this).dyna.actor.params as usize] =
            2 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgBowlWall_Reset as
                     unsafe extern "C" fn(_: *mut BgBowlWall,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_Reset(mut this: *mut BgBowlWall,
                                          mut globalCtx: *mut GlobalContext) {
    if (*(*this).chuGirl).wallStatus[(*this).dyna.actor.params as usize] as
           libc::c_int != 2 as libc::c_int {
        Math_ApproachF(&mut (*this).dyna.actor.world.pos.y, (*this).initPos.y,
                       0.3f32, 50.0f32);
        if fabsf((*this).dyna.actor.world.pos.y - (*this).initPos.y) <=
               10.0f32 {
            (*this).dyna.actor.world.pos.y = (*this).initPos.y;
            (*this).isHit = 0 as libc::c_int as s16;
            (*this).actionFunc =
                Some(BgBowlWall_SpawnBullseyes as
                         unsafe extern "C" fn(_: *mut BgBowlWall,
                                              _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgBowlWall = thisx as *mut BgBowlWall;
...
#[no_mangle]
pub unsafe extern "C" fn BgBowlWall_Draw(mut thisx: *mut Actor,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_bowl_wall.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = gBowlingRound1WallDL.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gBowlingRound2WallDL.as_mut_ptr() as libc::c_uint
    }
