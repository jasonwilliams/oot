...
extern "C" {
    ...
    fn Graph_CloseDisps(dispRefs: *mut *mut Gfx, gfxCtx: *mut GraphicsContext,
                        file: *const libc::c_char, line: s32);
    #[no_mangle]
    fn func_800D2CEC(mtx: *mut Mtx, arg1: f32_0, arg2: f32_0, arg3: f32_0,
                     arg4: f32_0, arg5: f32_0, arg6: f32_0);
    #[no_mangle]
    static mut gSaveContext: SaveContext;
    #[no_mangle]
    static mut gHeartEmptyTex: [u64_0; 0];
    #[no_mangle]
    static mut gHeartQuarterTex: [u64_0; 0];
    #[no_mangle]
    static mut gHeartHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gHeartThreeQuarterTex: [u64_0; 0];
    #[no_mangle]
    static mut gHeartFullTex: [u64_0; 0];
    #[no_mangle]
    static mut gDefenseHeartEmptyTex: [u64_0; 0];
    #[no_mangle]
    static mut gDefenseHeartQuarterTex: [u64_0; 0];
    #[no_mangle]
    static mut gDefenseHeartHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gDefenseHeartThreeQuarterTex: [u64_0; 0];
    #[no_mangle]
...
static mut sHeartsPrimColors: [[s16; 3]; 3] =
    [[255 as libc::c_int as s16, 70 as libc::c_int as s16,
      50 as libc::c_int as s16],
     [255 as libc::c_int as s16, 190 as libc::c_int as s16,
      0 as libc::c_int as s16],
     [100 as libc::c_int as s16, 100 as libc::c_int as s16,
      255 as libc::c_int as s16]];
static mut sHeartsEnvColors: [[s16; 3]; 3] =
    [[50 as libc::c_int as s16, 40 as libc::c_int as s16,
      60 as libc::c_int as s16],
     [255 as libc::c_int as s16, 0 as libc::c_int as s16, 0],
     [0 as libc::c_int as s16, 0 as libc::c_int as s16,
      255 as libc::c_int as s16]];
static mut sHeartsPrimFactors: [[s16; 3]; 3] =
    [[(255 as libc::c_int - 255 as libc::c_int) as s16,
      (70 as libc::c_int - 70 as libc::c_int) as s16,
      (50 as libc::c_int - 50 as libc::c_int) as s16],
     [(255 as libc::c_int - 255 as libc::c_int) as s16,
      (190 as libc::c_int - 70 as libc::c_int) as s16,
      (0 as libc::c_int - 50 as libc::c_int) as s16],
     [(100 as libc::c_int - 255 as libc::c_int) as s16,
      (100 as libc::c_int - 70 as libc::c_int) as s16,
      (255 as libc::c_int - 50 as libc::c_int) as s16]];
static mut sHeartsEnvFactors: [[s16; 3]; 3] =
    [[(50 as libc::c_int - 50 as libc::c_int) as s16,
      (40 as libc::c_int - 40 as libc::c_int) as s16,
      (60 as libc::c_int - 60 as libc::c_int) as s16],
     [(255 as libc::c_int - 50 as libc::c_int) as s16,
      (0 as libc::c_int - 40 as libc::c_int) as s16,
      (0 as libc::c_int - 60 as libc::c_int) as s16],
     [(0 as libc::c_int - 50 as libc::c_int) as s16,
      (0 as libc::c_int - 40 as libc::c_int) as s16,
      (255 as libc::c_int - 60 as libc::c_int) as s16]];
static mut sHeartsDDPrimColors: [[s16; 3]; 3] =
    [[255 as libc::c_int as s16, 255 as libc::c_int as s16,
     ...
     [100 as libc::c_int as s16, 100 as libc::c_int as s16,
      255 as libc::c_int as s16]];
static mut sHeartsDDEnvColors: [[s16; 3]; 3] =
    [[200 as libc::c_int as s16, 0 as libc::c_int as s16,
     ...
     [0 as libc::c_int as s16, 0 as libc::c_int as s16,
      255 as libc::c_int as s16]];
static mut sHeartsDDPrimFactors: [[s16; 3]; 3] =
    [[(255 as libc::c_int - 255 as libc::c_int) as s16,
      (255 as libc::c_int - 255 as libc::c_int) as s16,
      (255 as libc::c_int - 255 as libc::c_int) as s16],
     [(255 as libc::c_int - 255 as libc::c_int) as s16,
      (190 as libc::c_int - 255 as libc::c_int) as s16,
      (0 as libc::c_int - 255 as libc::c_int) as s16],
     [(100 as libc::c_int - 255 as libc::c_int) as s16,
      (100 as libc::c_int - 255 as libc::c_int) as s16,
      (255 as libc::c_int - 255 as libc::c_int) as s16]];
static mut sHeartsDDEnvFactors: [[s16; 3]; 3] =
    [[(200 as libc::c_int - 200 as libc::c_int) as s16,
      (0 as libc::c_int - 0 as libc::c_int) as s16,
      (0 as libc::c_int - 0 as libc::c_int) as s16],
     [(255 as libc::c_int - 200 as libc::c_int) as s16,
      (0 as libc::c_int - 0 as libc::c_int) as s16,
      (0 as libc::c_int - 0 as libc::c_int) as s16],
     [(0 as libc::c_int - 200 as libc::c_int) as s16,
      (0 as libc::c_int - 0 as libc::c_int) as s16,
      (255 as libc::c_int - 0 as libc::c_int) as s16]];
// Current colors for the double defense hearts
#[no_mangle]
pub static mut sBeatingHeartsDDPrim: [s16; 3] = [0; 3];
#[no_mangle]
pub static mut sBeatingHeartsDDEnv: [s16; 3] = [0; 3];
#[no_mangle]
pub static mut sHeartsDDPrim: [[s16; 3]; 2] = [[0; 3]; 2];
#[no_mangle]
pub static mut sHeartsDDEnv: [[s16; 3]; 2] = [[0; 3]; 2];
#[no_mangle]
pub unsafe extern "C" fn HealthMeter_Init(mut globalCtx: *mut GlobalContext) {
    let mut interfaceCtx: *mut InterfaceContext =
        &mut (*globalCtx).interfaceCtx;
    (*interfaceCtx).unk_228 = 0x140 as libc::c_int as s16;
    (*interfaceCtx).unk_226 = gSaveContext.health;
    (*interfaceCtx).unk_1FE = 0 as libc::c_int as s16;
    (*interfaceCtx).unk_22A = (*interfaceCtx).unk_1FE;
    (*interfaceCtx).unk_200 = 0 as libc::c_int as s16;
    (*interfaceCtx).unk_22C = (*interfaceCtx).unk_200;
    (*interfaceCtx).heartsPrimR[0 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimG[0 as libc::c_int as usize] =
        70 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimB[0 as libc::c_int as usize] =
        50 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvR[0 as libc::c_int as usize] =
        50 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvG[0 as libc::c_int as usize] =
        40 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvB[0 as libc::c_int as usize] =
        60 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimR[1 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimG[1 as libc::c_int as usize] =
        70 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimB[1 as libc::c_int as usize] =
        50 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvR[1 as libc::c_int as usize] =
        50 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvG[1 as libc::c_int as usize] =
        40 as libc::c_int as s16;
    (*interfaceCtx).heartsEnvB[1 as libc::c_int as usize] =
        60 as libc::c_int as s16;
    sHeartsDDPrim[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    sHeartsDDPrim[0 as libc::c_int as usize][0 as libc::c_int as usize] =
        sHeartsDDPrim[1 as libc::c_int as usize][0 as libc::c_int as usize];
    sHeartsDDPrim[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    sHeartsDDPrim[0 as libc::c_int as usize][1 as libc::c_int as usize] =
        sHeartsDDPrim[1 as libc::c_int as usize][1 as libc::c_int as usize];
    sHeartsDDPrim[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    sHeartsDDPrim[0 as libc::c_int as usize][2 as libc::c_int as usize] =
        sHeartsDDPrim[1 as libc::c_int as usize][2 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        200 as libc::c_int as s16;
    sHeartsDDEnv[0 as libc::c_int as usize][0 as libc::c_int as usize] =
        sHeartsDDEnv[1 as libc::c_int as usize][0 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        0 as libc::c_int as s16;
    sHeartsDDEnv[0 as libc::c_int as usize][1 as libc::c_int as usize] =
        sHeartsDDEnv[1 as libc::c_int as usize][1 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        0 as libc::c_int as s16;
    sHeartsDDEnv[0 as libc::c_int as usize][2 as libc::c_int as usize] =
        sHeartsDDEnv[1 as libc::c_int as usize][2 as libc::c_int as usize];
}
#[no_mangle]
pub unsafe extern "C" fn HealthMeter_Update(mut globalCtx:
                                                *mut GlobalContext) {
    let mut interfaceCtx: *mut InterfaceContext =
        &mut (*globalCtx).interfaceCtx;
    let mut factor: f32_0 =
        (*interfaceCtx).unk_1FE as libc::c_int as libc::c_float * 0.1f32;
    let mut ddFactor: f32_0 = 0.;
    let mut type_0: s32 = 0 as libc::c_int;
    let mut ddType: s32 = 0;
    let mut rFactor: s16 = 0;
    let mut gFactor: s16 = 0;
    let mut bFactor: s16 = 0;
    !interfaceCtx.is_null();
    if (*interfaceCtx).unk_200 as libc::c_int != 0 as libc::c_int {
        (*interfaceCtx).unk_1FE -= 1;
        if (*interfaceCtx).unk_1FE as libc::c_int <= 0 as libc::c_int {
            (*interfaceCtx).unk_1FE = 0 as libc::c_int as s16;
            (*interfaceCtx).unk_200 = 0 as libc::c_int as s16
        }
    } else {
        (*interfaceCtx).unk_1FE += 1;
        if (*interfaceCtx).unk_1FE as libc::c_int >= 10 as libc::c_int {
            (*interfaceCtx).unk_1FE = 10 as libc::c_int as s16;
            (*interfaceCtx).unk_200 = 1 as libc::c_int as s16
        }
    }
    ddFactor = factor;
    (*interfaceCtx).heartsPrimR[0 as libc::c_int as usize] =
    ...
    (*interfaceCtx).heartsEnvB[0 as libc::c_int as usize] =
        60 as libc::c_int as s16;
    (*interfaceCtx).heartsPrimR[1 as libc::c_int as usize] =
        sHeartsPrimColors[type_0 as usize][0 as libc::c_int as usize];
    (*interfaceCtx).heartsPrimG[1 as libc::c_int as usize] =
        sHeartsPrimColors[type_0 as usize][1 as libc::c_int as usize];
    (*interfaceCtx).heartsPrimB[1 as libc::c_int as usize] =
        sHeartsPrimColors[type_0 as usize][2 as libc::c_int as usize];
    (*interfaceCtx).heartsEnvR[1 as libc::c_int as usize] =
        sHeartsEnvColors[type_0 as usize][0 as libc::c_int as usize];
    (*interfaceCtx).heartsEnvG[1 as libc::c_int as usize] =
        sHeartsEnvColors[type_0 as usize][1 as libc::c_int as usize];
    (*interfaceCtx).heartsEnvB[1 as libc::c_int as usize] =
        sHeartsEnvColors[type_0 as usize][2 as libc::c_int as usize];
    rFactor =
        (sHeartsPrimFactors[0 as libc::c_int as
                                usize][0 as libc::c_int as usize] as
             libc::c_int as libc::c_float * factor) as s16;
    gFactor =
        (sHeartsPrimFactors[0 as libc::c_int as
    ...
    bFactor =
        (sHeartsPrimFactors[0 as libc::c_int as
             ...
             libc::c_int as libc::c_float * factor) as s16;
    (*interfaceCtx).beatingHeartPrim[0 as libc::c_int as usize] =
        ((rFactor as libc::c_int + 255 as libc::c_int) as u8_0 as libc::c_int
             & 0xff as libc::c_int) as s16;
    (*interfaceCtx).beatingHeartPrim[1 as libc::c_int as usize] =
        ((gFactor as libc::c_int + 70 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    (*interfaceCtx).beatingHeartPrim[2 as libc::c_int as usize] =
        ((bFactor as libc::c_int + 50 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    rFactor =
        (sHeartsEnvFactors[0 as libc::c_int as
                               usize][0 as libc::c_int as usize] as
             libc::c_int as libc::c_float * factor) as s16;
    gFactor =
        (sHeartsEnvFactors[0 as libc::c_int as
    ...
    bFactor =
        (sHeartsEnvFactors[0 as libc::c_int as
             ...
             libc::c_int as libc::c_float * factor) as s16;
    ddType = type_0;
    (*interfaceCtx).beatingHeartEnv[0 as libc::c_int as usize] =
        ((rFactor as libc::c_int + 50 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    (*interfaceCtx).beatingHeartEnv[1 as libc::c_int as usize] =
        ((gFactor as libc::c_int + 40 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    (*interfaceCtx).beatingHeartEnv[2 as libc::c_int as usize] =
        ((bFactor as libc::c_int + 60 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    sHeartsDDPrim[0 as libc::c_int as usize][0 as libc::c_int as usize] =
        255 as libc::c_int as s16;
    sHeartsDDPrim[0 as libc::c_int as usize][1 as libc::c_int as usize] =
    ...
    sHeartsDDEnv[0 as libc::c_int as usize][2 as libc::c_int as usize] =
        0 as libc::c_int as s16;
    sHeartsDDPrim[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        sHeartsDDPrimColors[ddType as usize][0 as libc::c_int as usize];
    sHeartsDDPrim[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        sHeartsDDPrimColors[ddType as usize][1 as libc::c_int as usize];
    sHeartsDDPrim[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        sHeartsDDPrimColors[ddType as usize][2 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][0 as libc::c_int as usize] =
        sHeartsDDEnvColors[ddType as usize][0 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][1 as libc::c_int as usize] =
        sHeartsDDEnvColors[ddType as usize][1 as libc::c_int as usize];
    sHeartsDDEnv[1 as libc::c_int as usize][2 as libc::c_int as usize] =
        sHeartsDDEnvColors[ddType as usize][2 as libc::c_int as usize];
    rFactor =
        (sHeartsDDPrimFactors[ddType as usize][0 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    gFactor =
        (sHeartsDDPrimFactors[ddType as usize][1 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    bFactor =
        (sHeartsDDPrimFactors[ddType as usize][2 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    sBeatingHeartsDDPrim[0 as libc::c_int as usize] =
        ((rFactor as libc::c_int + 255 as libc::c_int) as u8_0 as libc::c_int
             & 0xff as libc::c_int) as s16;
    sBeatingHeartsDDPrim[1 as libc::c_int as usize] =
        ((gFactor as libc::c_int + 255 as libc::c_int) as u8_0 as libc::c_int
             & 0xff as libc::c_int) as s16;
    sBeatingHeartsDDPrim[2 as libc::c_int as usize] =
        ((bFactor as libc::c_int + 255 as libc::c_int) as u8_0 as libc::c_int
             & 0xff as libc::c_int) as s16;
    rFactor =
        (sHeartsDDEnvFactors[ddType as usize][0 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    gFactor =
        (sHeartsDDEnvFactors[ddType as usize][1 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    bFactor =
        (sHeartsDDEnvFactors[ddType as usize][2 as libc::c_int as usize] as
             libc::c_int as libc::c_float * ddFactor) as s16;
    sBeatingHeartsDDEnv[0 as libc::c_int as usize] =
        ((rFactor as libc::c_int + 200 as libc::c_int) as u8_0 as libc::c_int
             & 0xff as libc::c_int) as s16;
    sBeatingHeartsDDEnv[1 as libc::c_int as usize] =
        ((gFactor as libc::c_int + 0 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
    sBeatingHeartsDDEnv[2 as libc::c_int as usize] =
        ((bFactor as libc::c_int + 0 as libc::c_int) as u8_0 as libc::c_int &
             0xff as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80078E18(mut globalCtx: *mut GlobalContext)
 -> s32 {
    gSaveContext.health = (*globalCtx).interfaceCtx.unk_226;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80078E34(mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut interfaceCtx: *mut InterfaceContext =
        &mut (*globalCtx).interfaceCtx;
    (*interfaceCtx).unk_228 = 0x140 as libc::c_int as s16;
    (*interfaceCtx).unk_226 =
        ((*interfaceCtx).unk_226 as libc::c_int + 0x10 as libc::c_int) as s16;
    if (*interfaceCtx).unk_226 as libc::c_int >=
...
#[no_mangle]
pub unsafe extern "C" fn func_80078E84(mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut interfaceCtx: *mut InterfaceContext =
        &mut (*globalCtx).interfaceCtx;
    if (*interfaceCtx).unk_228 as libc::c_int != 0 as libc::c_int {
        (*interfaceCtx).unk_228 -= 1
    } else {
        (*interfaceCtx).unk_228 = 0x140 as libc::c_int as s16;
        (*interfaceCtx).unk_226 =
            ((*interfaceCtx).unk_226 as libc::c_int - 0x10 as libc::c_int) as
                s16;
        if (*interfaceCtx).unk_226 as libc::c_int <= 0 as libc::c_int {
            (*interfaceCtx).unk_226 = 0 as libc::c_int as s16;
...
static mut sHeartTextures: [*mut libc::c_void; 16] =
    unsafe {
        [gHeartFullTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sHeartDDTextures: [*mut libc::c_void; 16] =
    unsafe {
        [gDefenseHeartFullTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDefenseHeartThreeQuarterTex.as_ptr() as *mut _ as *mut libc::c_void]
...
#[no_mangle]
pub unsafe extern "C" fn HealthMeter_Draw(mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 5] = [0; 5];
    let mut heartBgImg: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut curColorSet: u32_0 = 0;
    ...
    let mut sp154: *mut Vtx = (*interfaceCtx).beatingHeartVtx;
    let mut curHeartFraction: s32 =
        gSaveContext.health as libc::c_int % 0x10 as libc::c_int;
    let mut totalHeartCount: s16 =
        (gSaveContext.healthCapacity as libc::c_int / 0x10 as libc::c_int) as
            s16;
    let mut fullHeartCount: s16 =
        (gSaveContext.health as libc::c_int / 0x10 as libc::c_int) as s16;
    let mut pad2: s32 = 0;
    let mut sp144: f32_0 =
        (*interfaceCtx).unk_22A as libc::c_int as libc::c_float * 0.1f32;
    let mut curCombineModeSet: s32 = 0 as libc::c_int;
    let mut curBgImgLoaded: *mut u8_0 = 0 as *mut u8_0;
    let mut ddHeartCountMinusOne: s32 =
        gSaveContext.inventory.defenseHearts as libc::c_int -
            1 as libc::c_int;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_lifemeter.c\x00" as *const u8 as
                        *const libc::c_char, 353 as libc::c_int);
    if gSaveContext.health as libc::c_int % 0x10 as libc::c_int == 0 {
        fullHeartCount -= 1
    }
    curColorSet = -(1 as libc::c_int) as u32_0;
    offsetY = 0.0f32;
    offsetX = 0.0f32;
    i = 0 as libc::c_int;
    while i < totalHeartCount as libc::c_int {
        if ddHeartCountMinusOne < 0 as libc::c_int || i > ddHeartCountMinusOne
           {
            if i < fullHeartCount as libc::c_int {
                if curColorSet != 0 as libc::c_int as libc::c_uint {
                    curColorSet = 0 as libc::c_int as u32_0;
                    ...
                    (*_g_0).words.w0 =
                        (0xfa as libc::c_int as u32_0 &
                            ...
                            (0 as libc::c_int as u32_0 &
                                ...
                                0 as libc::c_int;
                    (*_g_0).words.w1 =
                        ((*interfaceCtx).heartsPrimR[0 as libc::c_int as
                                                         usize] as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                            ((*interfaceCtx).heartsPrimG[0 as libc::c_int as
                                                             usize] as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                16 as libc::c_int |
                            ((*interfaceCtx).heartsPrimB[0 as libc::c_int as
                                                             usize] as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                8 as libc::c_int |
                            ((*interfaceCtx).healthAlpha as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                0 as libc::c_int;
                    ...
                    (*_g_1).words.w1 =
                        ((*interfaceCtx).heartsEnvR[0 as libc::c_int as usize]
                             ...
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                            ((*interfaceCtx).heartsEnvG[0 as libc::c_int as
                                                            usize] as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                16 as libc::c_int |
                            ((*interfaceCtx).heartsEnvB[0 as libc::c_int as
                                                            usize] as u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                8 as libc::c_int |
            ...
            } else if i == fullHeartCount as libc::c_int {
                if curColorSet != 1 as libc::c_int as libc::c_uint {
                    curColorSet = 1 as libc::c_int as u32_0;
                    ...
                    (*_g_3).words.w0 =
                        (0xfa as libc::c_int as u32_0 &
                            ...
                            (0 as libc::c_int as u32_0 &
                                ...
                                0 as libc::c_int;
                    (*_g_3).words.w1 =
                        ((*interfaceCtx).beatingHeartPrim[0 as libc::c_int as
                                                              usize] as u32_0
                             &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                            ((*interfaceCtx).beatingHeartPrim[1 as libc::c_int
                                                                  as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                16 as libc::c_int |
                            ((*interfaceCtx).beatingHeartPrim[2 as libc::c_int
                                                                  as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                    ...
                    (*_g_4).words.w0 =
                        (0xfb as libc::c_int as u32_0 &
                            ...
                            24 as libc::c_int;
                    (*_g_4).words.w1 =
                        ((*interfaceCtx).beatingHeartEnv[0 as libc::c_int as
                                                             usize] as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                            ((*interfaceCtx).beatingHeartEnv[1 as libc::c_int
                                                                 as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                16 as libc::c_int |
                            ((*interfaceCtx).beatingHeartEnv[2 as libc::c_int
                                                                 as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                ...
                if curColorSet != 2 as libc::c_int as libc::c_uint {
                    curColorSet = 2 as libc::c_int as u32_0;
            ...
            } else if curColorSet != 3 as libc::c_int as libc::c_uint {
                curColorSet = 3 as libc::c_int as u32_0;
                ...
                (*_g_9).words.w0 =
                    (0xfa as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_9).words.w1 =
                    ((*interfaceCtx).heartsPrimR[1 as libc::c_int as usize] as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
                        ((*interfaceCtx).heartsPrimG[1 as libc::c_int as
                                                         usize] as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            16 as libc::c_int |
                        ((*interfaceCtx).heartsPrimB[1 as libc::c_int as
                                                         usize] as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            8 as libc::c_int |
                ...
                (*_g_10).words.w0 =
                    (0xfb as libc::c_int as u32_0 &
                        ...
                        24 as libc::c_int;
                (*_g_10).words.w1 =
                    ((*interfaceCtx).heartsEnvR[1 as libc::c_int as usize] as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        24 as libc::c_int |
            ...
            if i < fullHeartCount as libc::c_int {
                heartBgImg = gHeartFullTex.as_mut_ptr() as *mut libc::c_void
            } else if i == fullHeartCount as libc::c_int {
                heartBgImg = sHeartTextures[curHeartFraction as usize]
            } else {
                heartBgImg = gHeartEmptyTex.as_mut_ptr() as *mut libc::c_void
            }
        } else {
            if i < fullHeartCount as libc::c_int {
                if curColorSet != 4 as libc::c_int as libc::c_uint {
                    curColorSet = 4 as libc::c_int as u32_0;
                    ...
                    (*_g_12).words.w0 =
                        (0xfa as libc::c_int as u32_0 &
                            ...
                            (0 as libc::c_int as u32_0 &
                                ...
                                0 as libc::c_int;
                    (*_g_12).words.w1 =
                        (sHeartsDDPrim[0 as libc::c_int as
                    ...
                    (*_g_13).words.w0 =
                        (0xfb as libc::c_int as u32_0 &
                            ...
                            24 as libc::c_int;
                    (*_g_13).words.w1 =
                        (sHeartsDDEnv[0 as libc::c_int as
                                          usize][0 as libc::c_int as usize] as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                ...
                if curColorSet != 5 as libc::c_int as libc::c_uint {
                    curColorSet = 5 as libc::c_int as u32_0;
                    ...
                    (*_g_15).words.w0 =
                        (0xfa as libc::c_int as u32_0 &
                            ...
                            (0 as libc::c_int as u32_0 &
                                ...
                                0 as libc::c_int;
                    (*_g_15).words.w1 =
                        (sBeatingHeartsDDPrim[0 as libc::c_int as usize] as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                    ...
                    (*_g_16).words.w0 =
                        (0xfb as libc::c_int as u32_0 &
                            ...
                            24 as libc::c_int;
                    (*_g_16).words.w1 =
                        (sBeatingHeartsDDEnv[0 as libc::c_int as usize] as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            24 as libc::c_int |
                            (sBeatingHeartsDDEnv[1 as libc::c_int as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                16 as libc::c_int |
                            (sBeatingHeartsDDEnv[2 as libc::c_int as usize] as
                                 u32_0 &
                                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                      1 as libc::c_int) as libc::c_uint) <<
                                8 as libc::c_int |
                ...
                if curColorSet != 6 as libc::c_int as libc::c_uint {
                    curColorSet = 6 as libc::c_int as u32_0;
            ...
            } else if curColorSet != 7 as libc::c_int as libc::c_uint {
                curColorSet = 7 as libc::c_int as u32_0;
                ...
                (*_g_21).words.w0 =
                    (0xfa as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_21).words.w1 =
                    (sHeartsDDPrim[1 as libc::c_int as
                                       usize][0 as libc::c_int as usize] as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                ...
                (*_g_22).words.w0 =
                    (0xfb as libc::c_int as u32_0 &
                        ...
                        24 as libc::c_int;
                (*_g_22).words.w1 =
                    (sHeartsDDEnv[1 as libc::c_int as
                                      usize][0 as libc::c_int as usize] as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
            ...
            if i < fullHeartCount as libc::c_int {
                heartBgImg =
                    gDefenseHeartFullTex.as_mut_ptr() as *mut libc::c_void
            } else if i == fullHeartCount as libc::c_int {
                heartBgImg = sHeartDDTextures[curHeartFraction as usize]
            } else {
                heartBgImg =
                    gDefenseHeartEmptyTex.as_mut_ptr() as *mut libc::c_void
            }
        }
        if curBgImgLoaded != heartBgImg as *mut u8_0 {
            curBgImgLoaded = heartBgImg as *mut u8_0;
                ...
                (0xfd as libc::c_int as u32_0 &
                    ...
                    ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                         (((0x1 as libc::c_int) << 12 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_23).words.w1 = heartBgImg as libc::c_uint;
        ...
        if i != fullHeartCount as libc::c_int {
            if ddHeartCountMinusOne < 0 as libc::c_int ||
                   i > ddHeartCountMinusOne {
                if curCombineModeSet != 1 as libc::c_int {
                    curCombineModeSet = 1 as libc::c_int;
            ...
            } else if curCombineModeSet != 3 as libc::c_int {
                curCombineModeSet = 3 as libc::c_int;
                func_80094520(gfxCtx);
            ...
            temp3 = 26.0f32 + offsetY;
            temp2 = 30.0f32 + offsetX;
            temp4 = 1.0f32;
            temp4 /= 0.68f32;
            temp4 *=
            ...
            (*_g_32).words.w0 =
                (0xe4 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (((temp2 + temp1) * 4 as libc::c_int as libc::c_float) as
                         s32 as u32_0 &
                         (((0x1 as libc::c_int) << 12 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        12 as libc::c_int |
                    (((temp3 + temp1) * 4 as libc::c_int as libc::c_float) as
                         s32 as u32_0 &
                         (((0x1 as libc::c_int) << 12 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            ...
            if ddHeartCountMinusOne < 0 as libc::c_int ||
                   i > ddHeartCountMinusOne {
                if curCombineModeSet != 2 as libc::c_int {
                    curCombineModeSet = 2 as libc::c_int;
            ...
            } else if curCombineModeSet != 4 as libc::c_int {
                curCombineModeSet = 4 as libc::c_int;
                func_80094A14(gfxCtx);
            ...
            let mut matrix: *mut Mtx =
                Graph_Alloc(gfxCtx,
                            ::std::mem::size_of::<Mtx>() as libc::c_ulong as
                                size_t) as *mut Mtx;
            func_800D2CEC(matrix, 1.0f32 - 0.32f32 * sp144,
                          1.0f32 - 0.32f32 * sp144, 1.0f32 - 0.32f32 * sp144,
                          -130.0f32 + offsetX, 94.5f32 - offsetY, 0.0f32);
                ...
                (0xda as libc::c_int as u32_0 &
                    ...
                    (((0 as libc::c_int | 0x2 as libc::c_int) ^
                         ...
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_37).words.w1 = matrix as libc::c_uint;
                ...
                (0x1 as libc::c_int as u32_0 &
                    ...
                    ((0 as libc::c_int + 4 as libc::c_int) as u32_0 &
                         (((0x1 as libc::c_int) << 7 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        1 as libc::c_int;
            (*_g_38).words.w1 = sp154 as libc::c_uint;
        ...
        offsetX += 10.0f32;
        if i == 9 as libc::c_int { offsetY += 10.0f32; offsetX = 0.0f32 }
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn HealthMeter_HandleCriticalAlarm(mut globalCtx:
                                                             *mut GlobalContext) {
    let mut interfaceCtx: *mut InterfaceContext =
        &mut (*globalCtx).interfaceCtx;
    if (*interfaceCtx).unk_22C as libc::c_int != 0 as libc::c_int {
        (*interfaceCtx).unk_22A -= 1;
        if (*interfaceCtx).unk_22A as libc::c_int <= 0 as libc::c_int {
            (*interfaceCtx).unk_22A = 0 as libc::c_int as s16;
            (*interfaceCtx).unk_22C = 0 as libc::c_int as s16;
            if Player_InCsMode(globalCtx) == 0 &&
                   (*globalCtx).pauseCtx.state as libc::c_int ==
                       0 as libc::c_int &&
                   (*globalCtx).pauseCtx.debugState as libc::c_int ==
                       0 as libc::c_int && HealthMeter_IsCritical() != 0 &&
                   Gameplay_InCsMode(globalCtx) == 0 {
                func_80078884(0x481b as libc::c_int as u16_0);
            }
        }
    } else {
        (*interfaceCtx).unk_22A += 1;
        if (*interfaceCtx).unk_22A as libc::c_int >= 10 as libc::c_int {
            (*interfaceCtx).unk_22A = 10 as libc::c_int as s16;
            (*interfaceCtx).unk_22C = 1 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn HealthMeter_IsCritical() -> u32_0 {
    let mut var: s32 = 0;
    if gSaveContext.healthCapacity as libc::c_int <= 0x50 as libc::c_int {
        var = 0x10 as libc::c_int
    } else if gSaveContext.healthCapacity as libc::c_int <=
                  0xa0 as libc::c_int {
        var = 0x18 as libc::c_int
    } else if gSaveContext.healthCapacity as libc::c_int <=
                  0xf0 as libc::c_int {
        var = 0x20 as libc::c_int
    } else { var = 0x2c as libc::c_int }
    if var >= gSaveContext.health as libc::c_int &&
