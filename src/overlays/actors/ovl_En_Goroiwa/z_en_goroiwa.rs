...
extern "C" {
    ...
    #[no_mangle]
    fn Math3D_Vec3f_Cross(a: *mut Vec3f, b: *mut Vec3f, ret: *mut Vec3f);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBoulderFragmentsDL: [Gfx; 0];
    #[no_mangle]
    static mut gRollingRockDL: [Gfx; 0];
}
...
pub struct EnGoroiwa {
    pub actor: Actor,
    pub actionFunc: EnGoroiwaActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub prevUnitRollAxis: Vec3f,
    pub prevRollAngleDiff: f32_0,
    pub rollRotSpeed: f32_0,
    pub waitTimer: s16,
    pub bounceCount: s16,
    pub collisionDisabledTimer: s16,
    pub endWaypoint: s16,
    pub currentWaypoint: s16,
    pub nextWaypoint: s16,
    pub pathDirection: s16,
    pub isInKokiri: u8_0,
    pub stateFlags: u8_0,
}
pub type EnGoroiwaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGoroiwa, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_23 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_23 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_23 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_23 = -1;
pub type EnGoroiwaUnkFunc1
    =
    Option<unsafe extern "C" fn(_: *mut EnGoroiwa, _: *mut GlobalContext)
               -> s32>;
pub type EnGoroiwaUnkFunc2
    =
    Option<unsafe extern "C" fn(_: *mut EnGoroiwa) -> ()>;
#[no_mangle]
pub static mut En_Goroiwa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GOROIWA as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_GOROIWA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnGoroiwa>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGoroiwa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGoroiwa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 0 as libc::c_int as u8_0,
                                   cylRadius: 12 as libc::c_int as s16,
                                   cylHeight: 60 as libc::c_int as s16,
                                   mass: 0xfe as libc::c_int as u8_0,};
        init
    };
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_UpdateCollider(mut this: *mut EnGoroiwa) {
    static mut yOffsets: [f32_0; 2] = [0.0f32, 59.5f32];
    let mut worldSphere: *mut Sphere16 =
        &mut (*(*this).collider.elements.offset(0 as libc::c_int as
                                                    isize)).dim.worldSphere;
    (*worldSphere).center.x = (*this).actor.world.pos.x as s16;
    (*worldSphere).center.y =
        ((*this).actor.world.pos.y +
             yOffsets[((*this).actor.params as libc::c_int >>
                           10 as libc::c_int & 1 as libc::c_int) as usize]) as
            s16;
    (*worldSphere).center.z = (*this).actor.world.pos.z as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_InitCollider(mut this: *mut EnGoroiwa,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit, (*this).colliderItems.as_mut_ptr());
    EnGoroiwa_UpdateCollider(this);
    (*(*this).collider.elements.offset(0 as libc::c_int as
                                           isize)).dim.worldSphere.radius =
        58 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_UpdateFlags(mut this: *mut EnGoroiwa,
                                               mut setFlags: u8_0) {
    (*this).stateFlags =
    ...
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int | setFlags as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Vec3fNormalize(mut ret: *mut Vec3f,
                                                  mut a: *mut Vec3f) -> s32 {
    let mut magnitude: f32_0 = Math3D_Vec3fMagnitude(a);
    let mut scale: f32_0 = 0.;
    if magnitude < 0.001f32 { return 0 as libc::c_int }
    scale = 1.0f32 / magnitude;
    (*ret).x = (*a).x * scale;
    (*ret).y = (*a).y * scale;
    (*ret).z = (*a).z * scale;
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetSpeed(mut this: *mut EnGoroiwa,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT04 as libc::c_int {
        (*this).isInKokiri = 1 as libc::c_int as u8_0;
        (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 12 as libc::c_int) as
                              usize] = 920 as libc::c_int as s16
    } else {
        (*this).isInKokiri = 0 as libc::c_int as u8_0;
        (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 12 as libc::c_int) as
                              usize] = 1000 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_FaceNextWaypoint(mut this: *mut EnGoroiwa,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    let mut nextPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
             ...
             *mut Vec3s).offset((*this).nextWaypoint as libc::c_int as isize);
    let mut nextPosF: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    nextPosF.x = (*nextPos).x as f32_0;
    nextPosF.y = (*nextPos).y as f32_0;
    nextPosF.z = (*nextPos).z as f32_0;
    (*this).actor.world.rot.y =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut nextPosF);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_GetPrevWaypointDiff(mut this:
                                                           *mut EnGoroiwa,
                                                       mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut dest: *mut Vec3f) {
    let mut loopMode: s16 =
    ...
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset(((*this).actor.params as
                                                     ...
                                                     0xff as libc::c_int) as
                                                    isize) as *mut Path;
    let mut prevWaypoint: s16 =
        ((*this).currentWaypoint as libc::c_int -
             (*this).pathDirection as libc::c_int) as s16;
    let mut prevPointPos: *mut Vec3s = 0 as *mut Vec3s;
    let mut currentPointPos: *mut Vec3s = 0 as *mut Vec3s;
    if (prevWaypoint as libc::c_int) < 0 as libc::c_int {
        if loopMode as libc::c_int == 0 as libc::c_int ||
               loopMode as libc::c_int == 1 as libc::c_int {
            prevWaypoint = (*this).endWaypoint
        } else if loopMode as libc::c_int == 3 as libc::c_int {
            prevWaypoint = 1 as libc::c_int as s16
        }
    } else if prevWaypoint as libc::c_int > (*this).endWaypoint as libc::c_int
     {
        if loopMode as libc::c_int == 0 as libc::c_int ||
               loopMode as libc::c_int == 1 as libc::c_int {
            prevWaypoint = 0 as libc::c_int as s16
        } else if loopMode as libc::c_int == 3 as libc::c_int {
            prevWaypoint =
                ((*this).endWaypoint as libc::c_int - 1 as libc::c_int) as s16
        }
    }
    currentPointPos =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
                       ...
                       usize].wrapping_add((*path).points as u32_0 &
                                               0xffffff as libc::c_int as
                                                   libc::c_uint).wrapping_add(0x80000000
                                                                                  ...
                                                                                  libc::c_uint)
             as *mut libc::c_void as
             *mut Vec3s).offset((*this).currentWaypoint as libc::c_int as
                                    isize);
    prevPointPos =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
                        28 as libc::c_int) as
                       usize].wrapping_add((*path).points as u32_0 &
                                               0xffffff as libc::c_int as
                                                   libc::c_uint).wrapping_add(0x80000000
                                                                                  ...
                                                                                  libc::c_uint)
             as *mut libc::c_void as
             *mut Vec3s).offset(prevWaypoint as libc::c_int as isize);
    (*dest).x =
        ((*currentPointPos).x as libc::c_int -
             (*prevPointPos).x as libc::c_int) as f32_0;
    (*dest).y =
        ((*currentPointPos).x as libc::c_int -
             (*prevPointPos).y as libc::c_int) as f32_0;
    (*dest).z =
        ((*currentPointPos).x as libc::c_int -
             (*prevPointPos).z as libc::c_int) as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiw_CheckEndOfPath(mut this: *mut EnGoroiwa) {
    let mut loopMode: s16 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int &
             3 as libc::c_int) as s16;
    if ((*this).nextWaypoint as libc::c_int) < 0 as libc::c_int {
        if loopMode as libc::c_int == 0 as libc::c_int ||
               loopMode as libc::c_int == 1 as libc::c_int {
            (*this).currentWaypoint = (*this).endWaypoint;
            (*this).nextWaypoint =
                ((*this).endWaypoint as libc::c_int - 1 as libc::c_int) as
                    s16;
            (*this).pathDirection = -(1 as libc::c_int) as s16
        } else if loopMode as libc::c_int == 3 as libc::c_int {
            (*this).currentWaypoint = 0 as libc::c_int as s16;
            (*this).nextWaypoint = 1 as libc::c_int as s16;
            (*this).pathDirection = 1 as libc::c_int as s16
        }
    } else if (*this).nextWaypoint as libc::c_int >
                  (*this).endWaypoint as libc::c_int {
        if loopMode as libc::c_int == 0 as libc::c_int ||
               loopMode as libc::c_int == 1 as libc::c_int {
            (*this).currentWaypoint = 0 as libc::c_int as s16;
            (*this).nextWaypoint = 1 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetNextWaypoint(mut this: *mut EnGoroiwa) {
    (*this).currentWaypoint = (*this).nextWaypoint;
    (*this).nextWaypoint =
        ((*this).nextWaypoint as libc::c_int +
             (*this).pathDirection as libc::c_int) as s16;
    EnGoroiw_CheckEndOfPath(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_ReverseDirection(mut this:
                                                        *mut EnGoroiwa) {
    (*this).pathDirection =
        ((*this).pathDirection as libc::c_int * -(1 as libc::c_int)) as s16;
    (*this).currentWaypoint = (*this).nextWaypoint;
    (*this).nextWaypoint =
        ((*this).nextWaypoint as libc::c_int +
             (*this).pathDirection as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_InitPath(mut this: *mut EnGoroiwa,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    (*this).endWaypoint =
        ((*(*globalCtx).setupPathList.offset(((*this).actor.params as
                                                  libc::c_int &
                                                  0xff as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_TeleportToWaypoint(mut this:
                                                          *mut EnGoroiwa,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut waypoint: s32) {
                       ...
                       usize].wrapping_add((*path).points as u32_0 &
                                               0xffffff as libc::c_int as
                                                   libc::c_uint).wrapping_add(0x80000000
                                                                                  as
                                                                                  libc::c_uint)
             as *mut libc::c_void as *mut Vec3s).offset(waypoint as isize);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_InitRotation(mut this: *mut EnGoroiwa) {
    (*this).prevUnitRollAxis.x = 1.0f32;
    (*this).rollRotSpeed = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_GetAscendDirection(mut this:
                                                          *mut EnGoroiwa,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
    ...
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset(((*this).actor.params as
                                                     ...
                                                     0xff as libc::c_int) as
                                                    isize) as *mut Path;
    let mut nextPointPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
                        28 as libc::c_int) as
                       usize].wrapping_add((*path).points as u32_0 &
                                               0xffffff as libc::c_int as
             ...
             as *mut libc::c_void as
             *mut Vec3s).offset((*this).nextWaypoint as libc::c_int as isize);
    let mut currentPointPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
                        28 as libc::c_int) as
                       usize].wrapping_add((*path).points as u32_0 &
                                               0xffffff as libc::c_int as
             ...
             *mut Vec3s).offset((*this).currentWaypoint as libc::c_int as
                                    isize);
    if (*nextPointPos).x as libc::c_int == (*currentPointPos).x as libc::c_int
           &&
           (*nextPointPos).z as libc::c_int ==
               (*currentPointPos).z as libc::c_int {
        if (*nextPointPos).y as libc::c_int ==
               (*currentPointPos).y as libc::c_int {
            // "Error: Invalid path data (points overlap)"
            osSyncPrintf(b"Error : \xe3\x83\xac\xe3\x83\xbc\xe3\x83\xab\xe3\x83\x87\xe3\x83\xbc\xe3\x82\xbf\xe4\xb8\x8d\xe6\xad\xa3(\xe7\x82\xb9\xe3\x81\x8c\xe9\x87\x8d\xe3\x81\xaa\xe3\x81\xa3\xe3\x81\xa6\xe3\x81\x84\xe3\x82\x8b)\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"(%s %d)(arg_data 0x%04x)\n\x00" as *const u8 as
                             *const libc::c_char,
                         b"../z_en_gr.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SpawnDust(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut pos: *mut Vec3f) {
    ...
    let mut randPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    ...
    while i < 8 as libc::c_int {
        ...
        randPos.x =
            (*pos).x +
                47.0f32 * (Rand_ZeroOne() * 0.5f32 + 0.5f32) *
                    Math_SinS(angle);
        randPos.y = (*pos).y + (Rand_ZeroOne() - 0.5f32) * 40.0f32;
        randPos.z =
            (*pos).z +
                47.0f32 * (Rand_ZeroOne() * 0.5f32 + 0.5f32) *
                    Math_CosS(angle);
        func_800286CC(globalCtx, &mut randPos, &mut velocity, &mut accel,
                      ((Rand_ZeroOne() * 30.0f32) as s16 as libc::c_int +
                           100 as libc::c_int) as s16,
                      80 as libc::c_int as s16);
        func_800286CC(globalCtx, &mut randPos, &mut velocity, &mut accel,
                      ((Rand_ZeroOne() * 20.0f32) as s16 as libc::c_int +
                           80 as libc::c_int) as s16,
                      80 as libc::c_int as s16);
        i += 1
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SpawnWaterEffects(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut contactPos:
                                                         *mut Vec3f) {
    ...
    while i < 11 as libc::c_int {
        angle = (angle as libc::c_int + 0x1746 as libc::c_int) as s16;
        splashPos.x = (*contactPos).x + Math_SinS(angle) * 55.0f32;
        splashPos.y = (*contactPos).y;
        splashPos.z = (*contactPos).z + Math_CosS(angle) * 55.0f32;
        EffectSsGSplash_Spawn(globalCtx, &mut splashPos,
                              0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                              0 as libc::c_int as s16,
                              350 as libc::c_int as s16);
        i += 1
    }
    EffectSsGRipple_Spawn(globalCtx, contactPos, 300 as libc::c_int as s16,
                          700 as libc::c_int as s16, 0 as libc::c_int as s16);
    EffectSsGRipple_Spawn(globalCtx, contactPos, 500 as libc::c_int as s16,
                          900 as libc::c_int as s16, 4 as libc::c_int as s16);
    EffectSsGRipple_Spawn(globalCtx, contactPos, 500 as libc::c_int as s16,
                          1300 as libc::c_int as s16,
                          8 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveAndFall(mut this: *mut EnGoroiwa,
                                               mut globalCtx:
                                                   *mut GlobalContext)
 -> s32 {
    ...
    let mut pad: s32 = 0;
    let mut nextPointPos: *mut Vec3s = 0 as *mut Vec3s;
    Math_StepToF(&mut (*this).actor.speedXZ,
                 (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 12 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float * 0.01f32, 0.3f32);
    ...
    result &=
        Math_StepToF(&mut (*this).actor.world.pos.x,
                     (*nextPointPos).x as f32_0,
                     fabsf((*this).actor.velocity.x));
    result &=
        Math_StepToF(&mut (*this).actor.world.pos.z,
                     (*nextPointPos).z as f32_0,
                     fabsf((*this).actor.velocity.z));
    (*this).actor.world.pos.y += (*this).actor.velocity.y;
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Move(mut this: *mut EnGoroiwa,
 ...
 -> s32 {
    ...
    let mut currentPointPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
             ...
             *mut Vec3s).offset((*this).currentWaypoint as libc::c_int as
                                    isize);
    let mut nextPointReached: s32 = 0;
    let mut posDiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut nextPointPosF: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    nextPointPosF.x = (*nextPointPos).x as f32_0;
    nextPointPosF.y = (*nextPointPos).y as f32_0;
    nextPointPosF.z = (*nextPointPos).z as f32_0;
    Math_StepToF(&mut (*this).actor.speedXZ,
                 (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 12 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float * 0.01f32, 0.3f32);
    if Math3D_Vec3fDistSq(&mut nextPointPosF, &mut (*this).actor.world.pos) <
           5.0f32 * 5.0f32 {
        Math_Vec3f_Diff(&mut nextPointPosF, &mut (*this).actor.world.pos,
                        &mut posDiff);
    } else {
        posDiff.x =
            nextPointPosF.x -
                (*currentPointPos).x as libc::c_int as libc::c_float;
        posDiff.y =
            nextPointPosF.y -
                (*currentPointPos).y as libc::c_int as libc::c_float;
        posDiff.z =
            nextPointPosF.z -
                (*currentPointPos).z as libc::c_int as libc::c_float
    }
    EnGoroiwa_Vec3fNormalize(&mut (*this).actor.velocity, &mut posDiff);
    (*this).actor.velocity.x *= (*this).actor.speedXZ;
    (*this).actor.velocity.y *= (*this).actor.speedXZ;
    (*this).actor.velocity.z *= (*this).actor.speedXZ;
    nextPointReached = 1 as libc::c_int;
    nextPointReached &=
        Math_StepToF(&mut (*this).actor.world.pos.x, nextPointPosF.x,
                     fabsf((*this).actor.velocity.x));
    nextPointReached &=
        Math_StepToF(&mut (*this).actor.world.pos.y, nextPointPosF.y,
                     fabsf((*this).actor.velocity.y));
    nextPointReached &=
        Math_StepToF(&mut (*this).actor.world.pos.z, nextPointPosF.z,
                     fabsf((*this).actor.velocity.z));
    return nextPointReached;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveUpToNextWaypoint(mut this:
                                                            *mut EnGoroiwa,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    ...
    let mut nextPointPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
             ...
             as *mut libc::c_void as
             *mut Vec3s).offset((*this).nextWaypoint as libc::c_int as isize);
    Math_StepToF(&mut (*this).actor.velocity.y,
                 (*gGameInfo).data[(23 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 12 as libc::c_int)
                                       as usize] as libc::c_int as
                     libc::c_float * 0.01f32 * 0.5f32, 0.18f32);
    (*this).actor.world.pos.x = (*nextPointPos).x as f32_0;
    (*this).actor.world.pos.z = (*nextPointPos).z as f32_0;
    return Math_StepToF(&mut (*this).actor.world.pos.y,
                        (*nextPointPos).y as f32_0,
                        fabsf((*this).actor.velocity.y));
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveDownToNextWaypoint(mut this:
                                                              *mut EnGoroiwa,
                                                          mut globalCtx:
                                                              *mut GlobalContext)
 -> s32 {
    ...
    let mut nextPointPos: *mut Vec3s =
        (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
             ...
             as *mut libc::c_void as
             *mut Vec3s).offset((*this).nextWaypoint as libc::c_int as isize);
    let mut nextPointY: f32_0 = 0.;
    let mut thisY: f32_0 = 0.;
    let mut yDistToFloor: f32_0 = 0.;
    let mut quakeIdx: s32 = 0;
    let mut floorPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut raycastFrom: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    let mut ySurface: f32_0 = 0.;
    let mut waterHitPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    nextPointY = (*nextPointPos).y as f32_0;
    Math_StepToF(&mut (*this).actor.velocity.y, -14.0f32, 1.0f32);
    (*this).actor.world.pos.x = (*nextPointPos).x as f32_0;
    (*this).actor.world.pos.z = (*nextPointPos).z as f32_0;
    thisY = (*this).actor.world.pos.y;
    (*this).actor.world.pos.y += (*this).actor.velocity.y;
    if (*this).actor.velocity.y < 0.0f32 &&
           (*this).actor.world.pos.y <= nextPointY {
        if (*this).bounceCount as libc::c_int == 0 as libc::c_int {
            if (*this).actor.xzDistToPlayer < 600.0f32 {
                quakeIdx =
                    Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                          as usize],
                              3 as libc::c_int as u32_0) as s32;
                Quake_SetSpeed(quakeIdx as s16,
                               -(0x3cb0 as libc::c_int) as s16);
                Quake_SetQuakeValues(quakeIdx as s16, 3 as libc::c_int as s16,
                                     0 as libc::c_int as s16,
                                     0 as libc::c_int as s16,
                                     0 as libc::c_int as s16);
                Quake_SetCountdown(quakeIdx as s16, 7 as libc::c_int as s16);
            }
            (*this).rollRotSpeed = 0.0f32;
            if (*this).stateFlags as libc::c_int &
                   (1 as libc::c_int) << 4 as libc::c_int == 0 {
                raycastFrom.x = (*this).actor.world.pos.x;
                raycastFrom.y = (*this).actor.world.pos.y + 50.0f32;
                raycastFrom.z = (*this).actor.world.pos.z;
                floorY =
                    BgCheck_EntityRaycastFloor5(globalCtx,
                                                &mut (*globalCtx).colCtx,
                                                &mut floorPoly,
                                                &mut floorBgId,
                                                &mut (*this).actor,
                                                &mut raycastFrom);
                yDistToFloor = floorY - ((*this).actor.world.pos.y - 59.5f32);
                if fabsf(yDistToFloor) < 15.0f32 {
                    dustPos.x = (*this).actor.world.pos.x;
                    dustPos.y = floorY + 10.0f32;
                    dustPos.z = (*this).actor.world.pos.z;
                    EnGoroiwa_SpawnDust(globalCtx, &mut dustPos);
                }
            }
        }
        if (*this).bounceCount as libc::c_int >= 1 as libc::c_int {
            return 1 as libc::c_int
        }
        (*this).bounceCount += 1;
        (*this).actor.velocity.y *= -0.3f32;
        (*this).actor.world.pos.y =
            nextPointY - ((*this).actor.world.pos.y - nextPointY) * 0.3f32
    }
    if (*this).bounceCount as libc::c_int == 0 as libc::c_int &&
           WaterBox_GetSurfaceImpl(globalCtx, &mut (*globalCtx).colCtx,
                                   (*this).actor.world.pos.x,
                                   (*this).actor.world.pos.z, &mut ySurface,
                                   &mut waterBox) != 0 &&
        ...
        if ySurface < thisY {
            ...
            EnGoroiwa_SpawnWaterEffects(globalCtx, &mut waterHitPos);
            (*this).actor.velocity.y *= 0.2f32
        }
        if (*this).actor.velocity.y < -8.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_UpdateRotation(mut this: *mut EnGoroiwa,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    static mut unitY: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 1.0f32, z: 0.0f32,}; init };
    let mut pad: s32 = 0;
    let mut rollAxisPtr: *mut Vec3f = 0 as *mut Vec3f;
    let mut rollAngleDiff: f32_0 = 0.;
    let mut rollAxis: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut unitRollAxis: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut mtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut unusedDiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 3 as libc::c_int != 0 {
        rollAngleDiff = (*this).prevRollAngleDiff
    } else {
        (*this).prevRollAngleDiff =
            Math3D_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                 &mut (*this).actor.prevPos) *
                (1.0f32 / 59.5f32);
        rollAngleDiff = (*this).prevRollAngleDiff
    }
    rollAngleDiff *= (*this).rollRotSpeed;
    rollAxisPtr = &mut rollAxis;
    if (*this).stateFlags as libc::c_int &
           (1 as libc::c_int) << 3 as libc::c_int != 0 {
        /*
         ...
         */
        EnGoroiwa_GetPrevWaypointDiff(this, globalCtx, &mut unusedDiff);
        Math3D_Vec3f_Cross(&mut unitY, &mut (*this).actor.velocity,
                           rollAxisPtr);
    } else {
        Math3D_Vec3f_Cross(&mut unitY, &mut (*this).actor.velocity,
                           rollAxisPtr);
    }
    if EnGoroiwa_Vec3fNormalize(&mut unitRollAxis, rollAxisPtr) != 0 {
        (*this).prevUnitRollAxis = unitRollAxis
    } else { unitRollAxis = (*this).prevUnitRollAxis }
    Matrix_RotateAxis(rollAngleDiff, &mut unitRollAxis,
                      MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateY((*this).actor.shape.rot.y as libc::c_int as libc::c_float *
                       (2.0f32 * 3.14159265358979323846f32 /
    ...
    Matrix_RotateZ((*this).actor.shape.rot.z as libc::c_int as libc::c_float *
                   ...
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Get(&mut mtx);
    Matrix_MtxFToYXZRotS(&mut mtx, &mut (*this).actor.shape.rot,
                         0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_NextWaypoint(mut this: *mut EnGoroiwa,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut loopMode: s16 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int &
    ...
    if loopMode as libc::c_int == 0 as libc::c_int ||
           loopMode as libc::c_int == 1 as libc::c_int {
        if (*this).currentWaypoint as libc::c_int == 0 as libc::c_int ||
               (*this).currentWaypoint as libc::c_int ==
                   (*this).endWaypoint as libc::c_int {
            EnGoroiwa_TeleportToWaypoint(this, globalCtx,
                                         (*this).currentWaypoint as s32);
        }
    }
    EnGoroiwa_FaceNextWaypoint(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SpawnFragments(mut this: *mut EnGoroiwa,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    static mut yOffsets: [f32_0; 2] = [0.0f32, 59.5f32];
    ...
    let mut fragmentVelocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut cos1: f32_0 = 0.;
    let mut sin1: f32_0 = 0.;
    let mut sin2: f32_0 = 0.;
    let mut yOffsetIdx: s16 =
        ((*this).actor.params as libc::c_int >> 10 as libc::c_int &
             1 as libc::c_int) as s16;
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    angle1 = 0 as libc::c_int as s16;
    while i < 16 as libc::c_int {
        sin1 = Math_SinS(angle1);
        cos1 = Math_CosS(angle1);
        angle2 =
            (Rand_ZeroOne() * 0xffff as libc::c_int as libc::c_float) as s16;
        effectPos.x = Rand_ZeroOne() * 50.0f32 * sin1 * Math_SinS(angle2);
        sin2 = Math_SinS(angle2);
        effectPos.y =
            (Rand_ZeroOne() - 0.5f32) * 100.0f32 * sin2 +
                yOffsets[yOffsetIdx as usize];
        effectPos.z = Rand_ZeroOne() * 50.0f32 * cos1 * Math_SinS(angle2);
        fragmentVelocity.x = effectPos.x * 0.2f32;
        fragmentVelocity.y = Rand_ZeroOne() * 15.0f32 + 2.0f32;
        fragmentVelocity.z = effectPos.z * 0.2f32;
        Math_Vec3f_Sum(&mut effectPos, thisPos, &mut effectPos);
        EffectSsKakera_Spawn(globalCtx, &mut effectPos, &mut fragmentVelocity,
                             &mut effectPos, -(340 as libc::c_int) as s16,
                             33 as libc::c_int as s16,
                             28 as libc::c_int as s16,
                             2 as libc::c_int as s16, 0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 7.0f32 + 1.0f32) as s16,
                             1 as libc::c_int as s16, 0 as libc::c_int as s16,
                             70 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             1 as libc::c_int as s16,
                             gBoulderFragmentsDL.as_mut_ptr());
        i += 1;
        angle1 = (angle1 as libc::c_int + 0x4e20 as libc::c_int) as s16
    }
    effectPos.x = (*thisPos).x;
    effectPos.y = (*thisPos).y + yOffsets[yOffsetIdx as usize];
    effectPos.z = (*thisPos).z;
    func_80033480(globalCtx, &mut effectPos, 80.0f32, 5 as libc::c_int,
                  70 as libc::c_int as s16, 110 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
    func_80033480(globalCtx, &mut effectPos, 90.0f32, 5 as libc::c_int,
                  110 as libc::c_int as s16, 160 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 6] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 6];
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut yOffsets: [f32_0; 2] = [0.0f32, 595.0f32];
    let mut this: *mut EnGoroiwa = thisx as *mut EnGoroiwa;
    let mut pathIdx: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    EnGoroiwa_InitCollider(this, globalCtx);
    pathIdx = (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    if pathIdx == 0xff as libc::c_int {
        // "Error: Invalid arg_data"
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : arg_data \xe3\x81\x8c\xe4\xb8\x8d\xe6\xad\xa3(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_en_gr.c\x00" as *const u8 as *const libc::c_char,
                     1033 as libc::c_int,
                     (*this).actor.params as libc::c_int);
        Actor_Kill(&mut (*this).actor);
        return
    }
    if ((*(*globalCtx).setupPathList.offset(pathIdx as isize)).count as
            libc::c_int) < 2 as libc::c_int {
        // "Error: Invalid Path Data"
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : \xe3\x83\xac\xe3\x83\xbc\xe3\x83\xab\xe3\x83\x87\xe3\x83\xbc\xe3\x82\xbf \xe3\x81\x8c\xe4\xb8\x8d\xe6\xad\xa3(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_en_gr.c\x00" as *const u8 as *const libc::c_char,
                     1043 as libc::c_int);
        Actor_Kill(&mut (*this).actor);
    ...
    ActorShape_Init(&mut (*this).actor.shape,
                    yOffsets[((*this).actor.params as libc::c_int >>
                                  10 as libc::c_int & 1 as libc::c_int) as
                                 usize],
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 9.4f32);
    (*this).actor.shape.shadowAlpha = 200 as libc::c_int as u8_0;
    EnGoroiwa_SetSpeed(this, globalCtx);
    EnGoroiwa_InitPath(this, globalCtx);
    EnGoroiwa_TeleportToWaypoint(this, globalCtx, 0 as libc::c_int);
    EnGoroiwa_InitRotation(this);
    EnGoroiwa_FaceNextWaypoint(this, globalCtx);
    EnGoroiwa_SetupRoll(this);
    // "(Goroiwa)"
    osSyncPrintf(b"(\xe3\x81\x94\xe3\x82\x8d\xe5\xb2\xa9)(arg 0x%04x)(rail %d)(end %d)(bgc %d)(hit %d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int,
                 ...
                 (*this).actor.home.rot.z as libc::c_int &
                     1 as libc::c_int); // "Player knocked down"
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetupRoll(mut this: *mut EnGoroiwa) {
    (*this).actionFunc =
        Some(EnGoroiwa_Roll as
                 unsafe extern "C" fn(_: *mut EnGoroiwa,
                                      _: *mut GlobalContext) -> ());
    EnGoroiwa_UpdateFlags(this,
                          ((1 as libc::c_int) << 0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Roll(mut this: *mut EnGoroiwa,
                                        mut globalCtx: *mut GlobalContext) {
    static mut moveFuncs: [EnGoroiwaUnkFunc1; 2] =
        unsafe {
            [Some(EnGoroiwa_Move as
                      unsafe extern "C" fn(_: *mut EnGoroiwa,
                                           _: *mut GlobalContext) -> s32),
             Some(EnGoroiwa_MoveAndFall as
                      unsafe extern "C" fn(_: *mut EnGoroiwa,
                                           _: *mut GlobalContext) -> s32)]
        };
    static mut onHitSetupFuncs: [EnGoroiwaUnkFunc2; 2] =
        unsafe {
            [Some(EnGoroiwa_SetupWait as
                      unsafe extern "C" fn(_: *mut EnGoroiwa) -> ()),
             Some(EnGoroiwa_SetupMoveAndFallToGround as
                      unsafe extern "C" fn(_: *mut EnGoroiwa) -> ())]
        };
    let mut ascendDirection: s32 = 0;
    let mut yawDiff: s16 = 0;
    let mut loopMode: s16 = 0;
    if (*this).collider.base.atFlags as libc::c_int &
        ...
        if yawDiff as libc::c_int > -(0x4000 as libc::c_int) &&
               (yawDiff as libc::c_int) < 0x4000 as libc::c_int {
            (*this).stateFlags =
                ((*this).stateFlags as libc::c_int |
                     (1 as libc::c_int) << 2 as libc::c_int) as u8_0;
            if (*this).actor.params as libc::c_int >> 10 as libc::c_int &
                   1 as libc::c_int != 0 ||
                   (*this).actor.home.rot.z as libc::c_int & 1 as libc::c_int
                       != 1 as libc::c_int {
        ...
        osSyncPrintf(b"Player \xe3\x81\xb6\xe3\x81\xa3\xe9\xa3\x9b\xe3\x81\xb0\xe3\x81\x97\n\x00"
                         as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
        onHitSetupFuncs[((*this).actor.params as libc::c_int >>
                             10 as libc::c_int & 1 as libc::c_int) as
        ...
        if (*this).actor.home.rot.z as libc::c_int & 1 as libc::c_int ==
               1 as libc::c_int {
            (*this).collisionDisabledTimer = 50 as libc::c_int as s16
        }
    } else if moveFuncs[((*this).actor.params as libc::c_int >>
                             10 as libc::c_int & 1 as libc::c_int) as
                            usize].expect("non-null function pointer")(this,
                                                                       globalCtx)
                  != 0 {
        loopMode =
            ((*this).actor.params as libc::c_int >> 8 as libc::c_int &
                 3 as libc::c_int) as s16;
        if loopMode as libc::c_int == 1 as libc::c_int &&
               ((*this).nextWaypoint as libc::c_int == 0 as libc::c_int ||
                    (*this).nextWaypoint as libc::c_int ==
                        (*this).endWaypoint as libc::c_int) {
            EnGoroiwa_SpawnFragments(this, globalCtx);
        }
        EnGoroiwa_NextWaypoint(this, globalCtx);
        if loopMode as libc::c_int == 3 as libc::c_int &&
               ((*this).currentWaypoint as libc::c_int == 0 as libc::c_int ||
                    (*this).currentWaypoint as libc::c_int ==
                        (*this).endWaypoint as libc::c_int) {
            EnGoroiwa_SetupWait(this);
        } else if (*this).actor.params as libc::c_int >> 10 as libc::c_int &
                      1 as libc::c_int == 0 &&
                      (*this).currentWaypoint as libc::c_int !=
                          0 as libc::c_int &&
                      (*this).currentWaypoint as libc::c_int !=
            ...
            if ascendDirection > 0 as libc::c_int {
                EnGoroiwa_SetupMoveUp(this);
            } else if ascendDirection < 0 as libc::c_int {
                EnGoroiwa_SetupMoveDown(this);
            } else { EnGoroiwa_SetupRoll(this); }
        } else { EnGoroiwa_SetupRoll(this); }
    }
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x28b8 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetupMoveAndFallToGround(mut this:
                                                                *mut EnGoroiwa) {
    (*this).actionFunc =
        Some(EnGoroiwa_MoveAndFallToGround as
                 unsafe extern "C" fn(_: *mut EnGoroiwa,
                                      _: *mut GlobalContext) -> ());
    EnGoroiwa_UpdateFlags(this,
                          ((1 as libc::c_int) << 1 as libc::c_int) as u8_0);
    (*this).actor.gravity = -0.86f32;
    (*this).actor.minVelocityY = -15.0f32;
    (*this).actor.speedXZ *= 0.15f32;
    (*this).actor.velocity.y = 5.0f32;
    (*this).rollRotSpeed = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveAndFallToGround(mut this:
                                                           *mut EnGoroiwa,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetupWait(mut this: *mut EnGoroiwa) {
    static mut waitDurations: [s16; 2] =
        [20 as libc::c_int as s16, 6 as libc::c_int as s16];
    (*this).actionFunc =
        Some(EnGoroiwa_Wait as
                 unsafe extern "C" fn(_: *mut EnGoroiwa,
                                      _: *mut GlobalContext) -> ());
    ...
    EnGoroiwa_UpdateFlags(this,
                          ((1 as libc::c_int) << 1 as libc::c_int) as u8_0);
    (*this).waitTimer =
        waitDurations[((*this).actor.home.rot.z as libc::c_int &
                           1 as libc::c_int) as usize];
    (*this).rollRotSpeed = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Wait(mut this: *mut EnGoroiwa,
                                        mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetupMoveUp(mut this: *mut EnGoroiwa) {
    (*this).actionFunc =
        Some(EnGoroiwa_MoveUp as
                 unsafe extern "C" fn(_: *mut EnGoroiwa,
                                      _: *mut GlobalContext) -> ());
    EnGoroiwa_UpdateFlags(this,
                          ((1 as libc::c_int) << 0 as libc::c_int |
                              ...
                              u8_0);
    (*this).rollRotSpeed = 0.0f32;
    (*this).actor.velocity.y = fabsf((*this).actor.speedXZ) * 0.1f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveUp(mut this: *mut EnGoroiwa,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).collider.base.atFlags =
    ...
    } else if EnGoroiwa_MoveUpToNextWaypoint(this, globalCtx) != 0 {
        EnGoroiwa_NextWaypoint(this, globalCtx);
        EnGoroiwa_SetupRoll(this);
        (*this).actor.speedXZ = 0.0f32
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_SetupMoveDown(mut this: *mut EnGoroiwa) {
    (*this).actionFunc =
        Some(EnGoroiwa_MoveDown as
                 unsafe extern "C" fn(_: *mut EnGoroiwa,
                                      _: *mut GlobalContext) -> ());
    EnGoroiwa_UpdateFlags(this,
                          ((1 as libc::c_int) << 0 as libc::c_int |
                               (1 as libc::c_int) << 1 as libc::c_int) as
                              u8_0);
    (*this).rollRotSpeed = 0.3f32;
    (*this).bounceCount = 0 as libc::c_int as s16;
    (*this).actor.velocity.y = fabsf((*this).actor.speedXZ) * -0.3f32;
    (*this).stateFlags =
        ((*this).stateFlags as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_MoveDown(mut this: *mut EnGoroiwa,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (*this).collider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
    ...
    } else if EnGoroiwa_MoveDownToNextWaypoint(this, globalCtx) != 0 {
        EnGoroiwa_NextWaypoint(this, globalCtx);
        EnGoroiwa_SetupRoll(this);
        (*this).stateFlags =
            ((*this).stateFlags as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGoroiwa = thisx as *mut EnGoroiwa;
    ...
    let mut pad: s32 = 0;
    let mut sp30: s32 = 0;
    if (*player).stateFlags1 & 0x300000c0 as libc::c_int as libc::c_uint == 0
       {
        if (*this).collisionDisabledTimer as libc::c_int > 0 as libc::c_int {
            (*this).collisionDisabledTimer -= 1
        }
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        match (*this).actor.params as libc::c_int >> 10 as libc::c_int &
                  1 as libc::c_int {
            1 => {
        ...
        if (*this).actor.xzDistToPlayer < 300.0f32 {
            ...
            if (*this).stateFlags as libc::c_int &
                   ...
                   (*this).collisionDisabledTimer as libc::c_int <=
                       0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoroiwa_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gRollingRockDL.as_mut_ptr());
}
    ...
    sInitChain =
        [{
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).gravity as *mut f32_0
                                 as size_t as u32_0);
             init.set_value(-(860 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             init.set_cont(1 as libc::c_int as u32_0);
             init.set_type_0(ICHAINTYPE_F32_DIV1000 as libc::c_int as u32_0);
             init.set_offset(&mut (*(0 as *mut Actor)).minVelocityY as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(-(15000 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneScale as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(150 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
