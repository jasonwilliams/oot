...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gEffIceFragment1DL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_Ice_Piece_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_ICE_PIECE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsIcePiece_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsIcePiece_Init(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               ...
                                               mut initParamsx:
                                                   *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsIcePieceInitParams =
        initParamsx as *mut EffectSsIcePieceInitParams;
    ...
    (*this).draw =
        Some(EffectSsIcePiece_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsIcePiece_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    ...
    (*this).regs[3 as libc::c_int as usize] =
        ((fabsf((*initParams).velocity.x) + fabsf((*initParams).velocity.y)) *
             100.0f32 * (Rand_ZeroFloat(1.0f32) + 0.5f32)) as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsIcePiece_Draw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    ...
    scale =
        (*this).regs[4 as libc::c_int as usize] as libc::c_int as
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ice_piece.c\x00" as *const u8 as
                        *const libc::c_char, 161 as libc::c_int);
    ...
    (*_g_0).words.w1 =
        (0 as libc::c_int as u32_0 &
            ...
            (100 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((alpha as s32 & 0xff as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    func_8003435C(&mut (*this).pos, globalCtx);
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         0 as libc::c_int as u32_0,
                         (1 as libc::c_int as
                              libc::c_uint).wrapping_mul(frames).wrapping_rem(256
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint),
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gEffIceFragment1DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_ice_piece.c\x00" as *const u8 as
                         *const libc::c_char, 209 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsIcePiece_Update(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut index: u32_0,
                                                 mut this: *mut EffectSs) {
    ...
    (*this).velocity.x = (*this).velocity.x * 0.85f32;
    (*this).velocity.y = (*this).velocity.y * 0.85f32;
    (*this).velocity.z = (*this).velocity.z * 0.85f32;
}
