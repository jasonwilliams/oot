...
extern "C" {
    ...
    #[no_mangle]
    static mut object_spot07_object_DL_000460: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_DL_000BE0: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_DL_001CF0: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_DL_001F68: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_Col_002590: CollisionHeader;
    #[no_mangle]
    static mut object_spot07_object_DL_003210: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_DL_0032D8: [Gfx; 0];
    #[no_mangle]
    static mut object_spot07_object_Col_0038FC: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot07Taki {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot07TakiActionFunc,
}
pub type BgSpot07TakiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot07Taki, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot07_Taki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT07_TAKI as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId:
                              OBJECT_SPOT07_OBJECT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot07Taki>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot07Taki_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot07Taki_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot07Taki_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot07Taki_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot07Taki_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot07Taki = thisx as *mut BgSpot07Taki;
    let mut pad: s32 = 0;
    ...
    if gSaveContext.linkAge == 0 as libc::c_int {
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            CollisionHeader_GetVirtual(&mut object_spot07_object_Col_002590 as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
        } else {
            CollisionHeader_GetVirtual(&mut object_spot07_object_Col_0038FC as
                                           *mut CollisionHeader as
                                           *mut libc::c_void, &mut colHeader);
        }
        (*this).dyna.bgId =
    ...
    (*this).actionFunc =
        Some(BgSpot07Taki_DoNothing as
                 unsafe extern "C" fn(_: *mut BgSpot07Taki,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot07Taki_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot07Taki = thisx as *mut BgSpot07Taki;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot07Taki_DoNothing(mut this: *mut BgSpot07Taki,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot07Taki_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot07Taki = thisx as *mut BgSpot07Taki;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot07Taki_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot07Taki = thisx as *mut BgSpot07Taki;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot07_taki.c\x00" as *const u8 as
            ...
            (*_g_0).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                object_spot07_object_DL_001CF0.as_mut_ptr() as libc::c_uint
        } else {
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                object_spot07_object_DL_003210.as_mut_ptr() as libc::c_uint
        }
    }
    ...
    (*_g_3).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         frames.wrapping_mul(1 as libc::c_int as libc::c_uint)
                             & 0x7f as libc::c_int as libc::c_uint,
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            ...
            (*_g_6).words.w1 =
                Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 frames.wrapping_mul(0 as libc::c_int as
                                                         libc::c_uint),
                                 frames.wrapping_mul(3 as libc::c_int as
                                                         libc::c_uint) &
            ...
            (*_g_7).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_7).words.w1 =
                object_spot07_object_DL_000460.as_mut_ptr() as libc::c_uint
        } else {
            ...
            (*_g_10).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_10).words.w1 =
                object_spot07_object_DL_000BE0.as_mut_ptr() as libc::c_uint
        }
        ...
        (*_g_11).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_11).words.w1 =
            object_spot07_object_DL_001F68.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_12).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_12).words.w1 =
            object_spot07_object_DL_0032D8.as_mut_ptr() as libc::c_uint
    }
