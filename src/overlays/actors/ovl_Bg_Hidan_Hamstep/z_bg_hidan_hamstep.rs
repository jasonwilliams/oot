...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleStoneStep2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStoneStep1DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStoneStep2Col: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleStoneStep1Col: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanHamstep {
    pub dyna: DynaPolyActor,
    pub collider: ColliderTris,
    pub colliderItems: [ColliderTrisElement; 2],
    pub actionFunc: BgHidanHamstepActionFunc,
    pub action: s32,
    pub unk_244: s32,
}
pub type BgHidanHamstepActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanHamstep, _: *mut GlobalContext)
               -> ()>;
static mut sYPosOffsets: [f32_0; 5] =
    [-20.0f32, -120.0f32, -220.0f32, -320.0f32, -420.0f32];
...
#[no_mangle]
pub static mut Bg_Hidan_Hamstep_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_HAMSTEP as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanHamstep>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHamstep_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHamstep_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHamstep_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHamstep_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sActionFuncs: [BgHidanHamstepActionFunc; 5] =
    unsafe {
        [Some(func_808887C4 as
                  unsafe extern "C" fn(_: *mut BgHidanHamstep,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80888860 as
                  unsafe extern "C" fn(_: *mut BgHidanHamstep,
                                       _: *mut GlobalContext) -> ()),
         Some(func_808889B8 as
                  unsafe extern "C" fn(_: *mut BgHidanHamstep,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80888A58 as
                  unsafe extern "C" fn(_: *mut BgHidanHamstep,
                                       _: *mut GlobalContext) -> ()),
         Some(BgHidanHamstep_DoNothing as
                  unsafe extern "C" fn(_: *mut BgHidanHamstep,
                                       _: *mut GlobalContext) -> ())]
    };
...
static mut sEffectPositions: [[f32_0; 2]; 11] =
    [[-100.0f32, 40.0f32], [100.0f32, 40.0f32], [-100.0f32, 0.0f32],
     [100.0f32, 0.0f32], [-100.0f32, -40.0f32], [100.0f32, 40.0f32],
     [-100.0f32, -80.0f32], [-50.0f32, -80.0f32], [0.0f32, -80.0f32],
     [50.0f32, -80.0f32], [100.0f32, -80.0f32]];
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_SetupAction(mut this:
                                                        *mut BgHidanHamstep,
                                                    mut action: s32) {
    (*this).action = action; // Required to match
    (*this).actionFunc = sActionFuncs[action as usize];
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_SpawnChildren(mut this:
                                                          *mut BgHidanHamstep,
                                                      mut globalCtx2:
                                                          *mut GlobalContext)
 -> s32 {
    let mut step: *mut BgHidanHamstep = this;
    let mut i: s32 = 0;
    ...
    pos = pos;
    pos.y = (*this).dyna.actor.home.pos.y - 100.0f32;
    sin =
    ...
    while i < 5 as libc::c_int {
        pos.x =
            (i as libc::c_float * 160.0f32 + 60.0f32) * sin +
                (*this).dyna.actor.home.pos.x;
        pos.z =
            (i as libc::c_float * 160.0f32 + 60.0f32) * cos +
                (*this).dyna.actor.home.pos.z;
        params = (i + 1 as libc::c_int & 0xff as libc::c_int) as s16;
        params =
        ...
        step =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                               &mut (*step).dyna.actor, globalCtx,
                               ACTOR_BG_HIDAN_HAMSTEP as libc::c_int as s16,
                               pos.x, pos.y, pos.z,
                               (*this).dyna.actor.world.rot.x,
                               (*this).dyna.actor.world.rot.y,
                               (*this).dyna.actor.world.rot.z, params) as
                *mut BgHidanHamstep;
        if step.is_null() { return 0 as libc::c_int }
        i += 1
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanHamstep = thisx as *mut BgHidanHamstep;
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut sp48: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut i: s32 = 0;
    let mut i2: s32 = 0;
    let mut step: *mut BgHidanHamstep = 0 as *mut BgHidanHamstep;
    ...
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
        ...
        Collider_SetTris(globalCtx, &mut (*this).collider,
        ...
        while i < 2 as libc::c_int {
            ...
            while i2 < 3 as libc::c_int {
                sp48[i2 as usize].x =
                    (*sTrisInit.elements.offset(i as
                                                    isize)).dim.vtx[i2 as
                                                                        usize].x
                        + (*this).dyna.actor.home.pos.x;
                sp48[i2 as usize].y =
            ...
            Collider_SetTrisVertices(&mut (*this).collider, i,
                                     &mut *sp48.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp48.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp48.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
            i += 1
    ...
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
           0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gFireTempleStoneStep1Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gFireTempleStoneStep2Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    }
    (*this).dyna.bgId =
    ...
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           8 as libc::c_int & 0xff as libc::c_int) != 0 {
        if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
               0 as libc::c_int {
            (*this).dyna.actor.world.pos.y =
                (*this).dyna.actor.home.pos.y + -20.0f32;
            BgHidanHamstep_SetupAction(this, 4 as libc::c_int);
        } else {
            (*this).dyna.actor.world.pos.y =
                sYPosOffsets[(((*this).dyna.actor.params as libc::c_int &
                                   0xff as libc::c_int) - 1 as libc::c_int) as
                                 usize] + (*this).dyna.actor.home.pos.y;
            BgHidanHamstep_SetupAction(this, 4 as libc::c_int);
        }
    } else if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int
                  == 0 as libc::c_int {
        BgHidanHamstep_SetupAction(this, 0 as libc::c_int);
    } else { BgHidanHamstep_SetupAction(this, 2 as libc::c_int); }
    (*this).dyna.actor.gravity = -1.2f32;
    (*this).dyna.actor.minVelocityY = -12.0f32;
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
           0 as libc::c_int {
        // "Fire Temple Object [Hammer Step] appears"
        osSyncPrintf(b"\n\x00"
                         as *const u8 as *const libc::c_char);
        if BgHidanHamstep_SpawnChildren(this, globalCtx) == 0 as libc::c_int {
            step = this;
            // "[Hammer Step] I can't create a step!"
            osSyncPrintf(b"\xe3\x80\x90\xe3\x83\x8f\xe3\x83\xb3\xe3\x83\x9e\xe3\x83\xbc\xe3\x82\xb9\xe3\x83\x86\xe3\x83\x83\xe3\x83\x97\xe3\x80\x91 \xe8\xb6\xb3\xe5\xa0\xb4\xe7\x94\xa3\xe3\x82\x8c\xe3\x81\xaa\xe3\x81\x84\xef\xbc\x81\xef\xbc\x81\n\x00"
                             as *const u8 as *const libc::c_char);
            osSyncPrintf(b"%s %d\n\x00" as *const u8 as *const libc::c_char,
                         b"../z_bg_hidan_hamstep.c\x00" as *const u8 as
                             *const libc::c_char, 425 as libc::c_int);
            while !step.is_null() {
                Actor_Kill(&mut (*step).dyna.actor);
                step = (*step).dyna.actor.child as *mut BgHidanHamstep
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgHidanHamstep = thisx as *mut BgHidanHamstep;
...
#[no_mangle]
pub unsafe extern "C" fn func_808884C8(mut step: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = (*step).dyna.actor.world.pos;
    let mut i: s32 = 0;
    let mut sin: f32_0 = 0.;
    let mut cos: f32_0 = 0.;
    pos.y -= 20.0f32;
    func_80033480(globalCtx, &mut pos, 0.0f32, 0 as libc::c_int,
                  600 as libc::c_int as s16, 300 as libc::c_int as s16,
                  0 as libc::c_int as u8_0);
    sin =
        Math_SinS(((*step).dyna.actor.shape.rot.y as libc::c_int +
                       0x8000 as libc::c_int) as s16);
    cos =
        Math_CosS(((*step).dyna.actor.shape.rot.y as libc::c_int +
                       0x8000 as libc::c_int) as s16);
    pos.y = (*step).dyna.actor.world.pos.y;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[[f32_0; 2]; 11]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<[f32_0; 2]>()
                                                   as libc::c_ulong) as s32 {
        pos.x =
            sEffectPositions[i as usize][1 as libc::c_int as usize] * sin +
                sEffectPositions[i as usize][0 as libc::c_int as usize] * cos
                + (*step).dyna.actor.world.pos.x;
        pos.z =
            sEffectPositions[i as usize][1 as libc::c_int as usize] * cos -
                sEffectPositions[i as usize][0 as libc::c_int as usize] * sin
                + (*step).dyna.actor.world.pos.z;
        func_80033480(globalCtx, &mut pos, 0.0f32, 0 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn func_80888638(mut this: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    let mut child: *mut BgHidanHamstep =
        (*this).dyna.actor.child as *mut BgHidanHamstep;
    while !child.is_null() {
        if (*child).dyna.actor.params as libc::c_int & 0xff as libc::c_int !=
               0 as libc::c_int {
            func_808884C8(child, globalCtx);
        }
        child = (*child).dyna.actor.child as *mut BgHidanHamstep
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80888694(mut this: *mut BgHidanHamstep,
                                       mut parent: *mut BgHidanHamstep) {
    let mut child: *mut BgHidanHamstep = 0 as *mut BgHidanHamstep;
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int >=
           2 as libc::c_int {
        if (*parent).dyna.actor.world.pos.y < (*this).dyna.actor.world.pos.y {
            (*this).dyna.actor.world.pos.y = (*parent).dyna.actor.world.pos.y
        } else if (*this).dyna.actor.world.pos.y -
                      (*parent).dyna.actor.world.pos.y < -100.0f32 {
            (*this).dyna.actor.world.pos.y =
                (*parent).dyna.actor.world.pos.y - 100.0f32
        }
    }
    child = (*this).dyna.actor.child as *mut BgHidanHamstep;
    while !child.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn func_80888734(mut this: *mut BgHidanHamstep) {
    let mut parent: *mut BgHidanHamstep =
        (*this).dyna.actor.parent as *mut BgHidanHamstep;
    let mut frameDivisor: f32_0 =
    ...
    if !parent.is_null() {
        ...
        if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
            ...
            (*this).dyna.actor.world.pos.y +=
                (*this).dyna.actor.velocity.y * frameDivisor
        }
        func_80888694(this, parent);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808887C4(mut this: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        OnePointCutscene_Init(globalCtx, 3310 as libc::c_int as s16,
                              100 as libc::c_int as s16,
                              &mut (*this).dyna.actor,
                              0 as libc::c_int as s16);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x283a as libc::c_int as u16_0);
        (*this).collider.base.acFlags = 0 as libc::c_int as u8_0;
        BgHidanHamstep_SetupAction(this, 1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80888860(mut this: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    ...
    if (*this).dyna.actor.world.pos.y - (*this).dyna.actor.home.pos.y <
           -20.0f32 - (*this).dyna.actor.minVelocityY &&
           (*this).dyna.actor.velocity.y <= 0.0f32 {
        (*this).unk_244 += 1;
        if (*this).unk_244 >= 7 as libc::c_int {
            (*this).dyna.actor.world.pos.y =
                (*this).dyna.actor.home.pos.y + -20.0f32;
            BgHidanHamstep_SetupAction(this, 4 as libc::c_int);
        } else {
            (*this).dyna.actor.velocity.y *= -0.24f32;
            if (*this).unk_244 == 1 as libc::c_int {
                quakeIndex =
                    Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                          as usize],
                              3 as libc::c_int as u32_0) as s32;
                Quake_SetSpeed(quakeIndex as s16,
                               -(15536 as libc::c_int) as s16);
...
#[no_mangle]
pub unsafe extern "C" fn func_808889B8(mut this: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut parent: *mut BgHidanHamstep =
        (*this).dyna.actor.parent as *mut BgHidanHamstep;
    func_80888734(this);
    if (*parent).action == 4 as libc::c_int ||
           (*parent).action == 3 as libc::c_int &&
               (*parent).unk_244 >= 5 as libc::c_int {
        if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int ==
               1 as libc::c_int {
            (*this).dyna.actor.world.pos.y =
                sYPosOffsets[(((*this).dyna.actor.params as libc::c_int &
                                 ...
                                 usize] + (*this).dyna.actor.home.pos.y;
            BgHidanHamstep_SetupAction(this, 4 as libc::c_int);
        } else { BgHidanHamstep_SetupAction(this, 3 as libc::c_int); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80888A58(mut this: *mut BgHidanHamstep,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    let mut quakeIndex: s32 = 0;
    Actor_MoveForward(&mut (*this).dyna.actor);
    func_80888694(this, (*this).dyna.actor.parent as *mut BgHidanHamstep);
    if (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int <=
           0 as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int >=
               6 as libc::c_int {
        // "[Hammer Step] arg_data strange (arg_data = %d)"
        osSyncPrintf(b"\xe3\x80\x90\xe3\x83\x8f\xe3\x83\xb3\xe3\x83\x9e\xe3\x83\xbc\xe3\x82\xb9\xe3\x83\x86\xe3\x83\x83\xe3\x83\x97\xe3\x80\x91 arg_data \xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84 (arg_data = %d)\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).dyna.actor.params as libc::c_int);
        osSyncPrintf(b"%s %d\n\x00" as *const u8 as *const libc::c_char,
                     b"../z_bg_hidan_hamstep.c\x00" as *const u8 as
    ...
    if (*this).dyna.actor.world.pos.y - (*this).dyna.actor.home.pos.y <=
           sYPosOffsets[(((*this).dyna.actor.params as libc::c_int &
                              0xff as libc::c_int) - 1 as libc::c_int) as
                            usize] && (*this).dyna.actor.velocity.y <= 0.0f32
       {
        (*this).unk_244 += 1;
        if (*this).unk_244 >= 7 as libc::c_int {
            (*this).dyna.actor.world.pos.y =
                sYPosOffsets[(((*this).dyna.actor.params as libc::c_int &
                                   0xff as libc::c_int) - 1 as libc::c_int) as
                                 usize] + (*this).dyna.actor.home.pos.y;
            BgHidanHamstep_SetupAction(this, 3 as libc::c_int);
        } else {
            (*this).dyna.actor.velocity.y *= -0.24f32;
            if (*this).unk_244 == 1 as libc::c_int {
                quakeIndex =
                ...
                Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                      0x2835 as libc::c_int as u16_0);
                func_800AA000(10000.0f32, 255 as libc::c_int as u8_0,
                              20 as libc::c_int as u8_0,
                              150 as libc::c_int as u8_0);
                func_808884C8(this, globalCtx);
                if (*this).dyna.actor.params as libc::c_int &
                       0xff as libc::c_int == 5 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_DoNothing(mut this:
                                                      *mut BgHidanHamstep,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgHidanHamstep = thisx as *mut BgHidanHamstep;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHamstep_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gFireTempleStoneStep1DL.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gFireTempleStoneStep2DL.as_mut_ptr() as libc::c_uint
    }
