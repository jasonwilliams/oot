...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPoDesert {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnPoDesertActionFunc,
    pub actionTimer: s16,
    pub speedModifier: s16,
    pub currentPathPoint: s32,
    pub initDistToNextPoint: f32_0,
    pub yDiff: f32_0,
    pub targetY: f32_0,
...
pub type EnPoDesertActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPoDesert, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Po_Desert_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PO_DESERT as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoDesert_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoDesert_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoDesert_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPoDesert_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColliderInit: ColliderCylinderInit =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnPoDesert = thisx as *mut EnPoDesert;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 37.0f32);
    (*this).currentPathPoint = 1 as libc::c_int;
    (*this).actor.params =
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnPoDesert = thisx as *mut EnPoDesert;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_SetNextPathPoint(mut this:
                                                         *mut EnPoDesert,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset((*this).actor.params as isize)
            as *mut Path;
    let mut pathPoint: *mut Vec3s = 0 as *mut Vec3s;
    ...
    pathPoint =
        &mut *((*gSegments.as_mut_ptr().offset((((*path).points as u32_0) <<
                   ...
                   *mut Vec3s).offset((*this).currentPathPoint as isize) as
            *mut Vec3s;
    (*this).actor.home.pos.x = (*pathPoint).x as f32_0;
    (*this).actor.home.pos.y = (*pathPoint).y as f32_0;
    (*this).actor.home.pos.z = (*pathPoint).z as f32_0;
    (*this).initDistToNextPoint =
        Actor_WorldDistXZToPoint(&mut (*this).actor,
                                 &mut (*this).actor.home.pos);
    (*this).initDistToNextPoint =
        if (*this).initDistToNextPoint < 1.0f32 {
            1.0f32
        } else { (*this).initDistToNextPoint };
    (*this).currentPathPoint += 1;
    (*this).yDiff = (*this).actor.home.pos.y - (*this).actor.world.pos.y;
    (*this).actor.speedXZ = 0.0f32;
    if (*path).count as libc::c_int == (*this).currentPathPoint {
        (*this).currentPathPoint = 0 as libc::c_int
    }
    (*this).actionFunc =
        Some(EnPoDesert_WaitForPlayer as
                 unsafe extern "C" fn(_: *mut EnPoDesert,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_SetupMoveToNextPoint(mut this:
                                                             *mut EnPoDesert) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gPoeFieldFloatAnim,
                          -5.0f32);
    (*this).actionFunc =
        Some(EnPoDesert_MoveToNextPoint as
                 unsafe extern "C" fn(_: *mut EnPoDesert,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_SetupDisappear(mut this:
                                                       *mut EnPoDesert) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gPoeFieldDisappearAnim, -6.0f32);
    (*this).actionTimer = 16 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3874 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoDesert_Disappear as
                 unsafe extern "C" fn(_: *mut EnPoDesert,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_UpdateSpeedModifier(mut this:
                                                            *mut EnPoDesert) {
    if (*this).speedModifier as libc::c_int == 0 as libc::c_int {
        (*this).speedModifier = 32 as libc::c_int as s16
    }
    if (*this).speedModifier as libc::c_int != 0 as libc::c_int {
        (*this).speedModifier -= 1
    }
    (*this).actor.world.pos.y =
        Math_SinS(((*this).speedModifier as libc::c_int *
                       0x800 as libc::c_int) as s16) * 13.0f32 +
            (*this).targetY;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_WaitForPlayer(mut this: *mut EnPoDesert,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    func_8002F974(&mut (*this).actor,
                  (0x3871 as libc::c_int - 0x800 as libc::c_int) as u16_0);
    if (*this).actor.xzDistToPlayer < 200.0f32 &&
           ((*this).currentPathPoint != 2 as libc::c_int ||
                (*globalCtx).actorCtx.unk_03 as libc::c_int != 0) {
        if (*this).currentPathPoint == 2 as libc::c_int {
            ...
            Message_StartTextbox(globalCtx, 0x600b as libc::c_int as u16_0,
                                 0 as *mut Actor);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_MoveToNextPoint(mut this: *mut EnPoDesert,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    temp_f20 =
        sinf((*this).actionTimer as libc::c_int as libc::c_float *
                 (3.14159265358979323846f32 / 20.0f32)) * 5.0f32;
    (*this).actor.world.pos.x +=
        temp_f20 * Math_CosS((*this).actor.shape.rot.y);
    (*this).actor.world.pos.z +=
        temp_f20 * Math_SinS((*this).actor.shape.rot.y);
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        (*this).actionTimer = 40 as libc::c_int as s16
    }
    temp_f20 =
        Actor_WorldDistXZToPoint(&mut (*this).actor,
                                 &mut (*this).actor.home.pos);
    ...
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
                   ...
                   5 as libc::c_int as s16, 0x400 as libc::c_int as s16);
    (*this).actor.speedXZ =
        sinf((*this).speedModifier as libc::c_int as libc::c_float *
                 (3.14159265358979323846f32 / 32.0f32)) * 2.5f32 + 5.5f32;
    func_8002F974(&mut (*this).actor,
                  (0x3871 as libc::c_int - 0x800 as libc::c_int) as u16_0);
    (*this).targetY =
        (*this).actor.home.pos.y -
            temp_f20 * (*this).yDiff / (*this).initDistToNextPoint;
    if temp_f20 < 40.0f32 {
        if (*this).currentPathPoint != 0 as libc::c_int {
            EnPoDesert_SetNextPathPoint(this, globalCtx);
        } else { EnPoDesert_SetupDisappear(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_Disappear(mut this: *mut EnPoDesert,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnPoDesert = thisx as *mut EnPoDesert;
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if (*this).actionFunc ==
        ...
        mtxScale =
            (*this).actionTimer as libc::c_int as libc::c_float / 16.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
                                                 mut dList: *mut *mut Gfx,
                                                 mut rot: *mut Vec3s,
    ...
    if limbIndex == 7 as libc::c_int {
            ...
            *gfxP = (*gfxP).offset(1);
            ...
            (*_g_1).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_po_desert.c\x00" as *const u8 as
            ...
            (*_g_2).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                gPoeFieldLanternDL.as_mut_ptr() as libc::c_uint;
            let fresh4 = *gfxP;
            *gfxP = (*gfxP).offset(1);
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gPoeFieldLanternTopDL.as_mut_ptr() as libc::c_uint;
            let fresh5 = *gfxP;
            *gfxP = (*gfxP).offset(1);
        ...
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo, lightPos.x as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnPoDesert_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoDesert = thisx as *mut EnPoDesert;
    ...
    (*_g).words.w1 =
        Gfx_EnvColor((*globalCtx).state.gfxCtx, 255 as libc::c_int,
                     85 as libc::c_int, 0 as libc::c_int, 255 as libc::c_int)
            as libc::c_uint;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        Gfx_EnvColor((*globalCtx).state.gfxCtx, (*this).lightColor.r as s32,
                     (*this).lightColor.g as s32, (*this).lightColor.b as s32,
    ...
    (*__gfxCtx).polyXlu.p =
        SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                       ...
                       Some(EnPoDesert_OverrideLimbDraw as
                                unsafe extern "C" fn(_: *mut GlobalContext,
                                                     ...
                                                     _: *mut *mut Gfx)
                                    -> s32),
                       Some(EnPoDesert_PostLimbDraw as
                                unsafe extern "C" fn(_: *mut GlobalContext,
                                                     _: s32, _: *mut *mut Gfx,
                                                     _: *mut Vec3s,
                                                     _: *mut libc::c_void,
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x5c as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
