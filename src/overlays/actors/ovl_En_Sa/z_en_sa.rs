...
extern "C" {
    ...
    #[no_mangle]
    static mut gSariaOcarinaToMouthAnim: AnimationHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gSariaPlayingOcarinaAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaStopPlayingOcarinaAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaLinkLearnedSariasSongAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaReturnToOcarinaAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaLookUpArmExtendedAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaRunAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaWaveAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaLookOverShoulderAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaTransitionHandsSideToBackAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaHandsOutAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaTransitionHandsSideToHipsAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaHandsBehindBackWaitAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaTransitionHandsSideToChestToSideAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaRightArmExtendedWaitAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaStandHandsOnHipsAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaExtendRightArmAnim: AnimationHeader;
    #[no_mangle]
    static mut gSariaHandsOnFaceAnim: AnimationHeader;
    #[no_mangle]
    static mut gSpot04Cs_10E20: [CutsceneData; 0];
    #[no_mangle]
    static mut spot05_scene_Cs_005730: [CutsceneData; 0];
}
...
pub struct EnSa {
    ...
    pub unk_20E: s16,
    pub unk_210: s16,
    pub rightEyeIndex: s16,
    pub leftEyeIndex: s16,
    pub mouthIndex: s16,
    pub alpha: s16,
    pub unk_21A: Vec3s,
...
pub type EnSaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSa, _: *mut GlobalContext) -> ()>;
...
pub const SARIA_EYE_OPEN: C2RustUnnamed_28 = 0;
pub const SARIA_EYE_SUPRISED: C2RustUnnamed_28 = 3;
pub const SARIA_EYE_CLOSED: C2RustUnnamed_28 = 2;
pub type C2RustUnnamed_28 = libc::c_uint;
pub const SARIA_EYE_SAD: C2RustUnnamed_28 = 4;
pub const SARIA_EYE_HALF: C2RustUnnamed_28 = 1;
#[no_mangle]
pub static mut En_Sa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnSa>() as libc::c_ulong,
                          init:
...
static mut sAnimationInfo: [struct_D_80AA1678; 12] =
    unsafe {
        [{
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gSariaWaitArmsToSideAnim as
         ...
         },
         {
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gSariaLookUpArmExtendedAnim as
                                           *const AnimationHeader as
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
         ...
         },
         {
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gSariaStopPlayingOcarinaAnim as
                                           *const AnimationHeader as
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
                                   mode: ANIMMODE_ONCE as libc::c_int as u8_0,
         ...
         },
         {
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gSariaLinkLearnedSariasSongAnim as
                                           *const AnimationHeader as
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
                                   mode: ANIMMODE_ONCE as libc::c_int as u8_0,
...
static mut sAnimations: [struct_80034EC0_Entry; 10] =
    unsafe {
        [{
             let mut init =
                 ...
                 struct_80034EC0_Entry{animation:
                                       ...
                                       mode:
                                           ANIMMODE_LOOP as libc::c_int as
                                               u8_0,
                                       transitionRate: -4.0f32,};
             init
         },
         {
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gSariaRightArmExtendedWaitAnim as
                                               *const AnimationHeader as
                                               *mut AnimationHeader,
                                       playbackSpeed: 1.0f32,
                                       startFrame: 0.0f32,
         ...
         },
         {
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gSariaHandsBehindBackWaitAnim as
                                               *const AnimationHeader as
                                               *mut AnimationHeader,
                                       playbackSpeed: 1.0f32,
                                       startFrame: 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5560(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext)
 -> s16 {
    let mut textState: s16 =
    ...
    if (*this).unk_209 as libc::c_int ==
        ...
        if textState as libc::c_int != (*this).unk_209 as libc::c_int {
            (*this).unk_208 = (*this).unk_208.wrapping_add(1)
        }
    }
    (*this).unk_209 = textState as u8_0;
    return textState;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF55E0(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> u16_0 {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    let mut reaction: u16_0 =
        Text_GetFaceReaction(globalCtx, 0x10 as libc::c_int as u32_0);
    ...
    if gBitFlags[QUEST_SONG_SARIA as libc::c_int as usize] &
        ...
        return 0x10ad as libc::c_int as u16_0
    }
    if gBitFlags[QUEST_KOKIRI_EMERALD as libc::c_int as usize] &
        ...
        if gSaveContext.infTable[0 as libc::c_int as usize] as libc::c_int &
            ...
            return 0x1048 as libc::c_int as u16_0
        } else { return 0x1047 as libc::c_int as u16_0 }
    }
    if gSaveContext.eventChkInf[0 as libc::c_int as usize] as libc::c_int &
        ...
        if gSaveContext.infTable[0 as libc::c_int as usize] as libc::c_int &
               8 as libc::c_int != 0 {
            return 0x1032 as libc::c_int as u16_0
        } else { return 0x1031 as libc::c_int as u16_0 }
    }
    if gSaveContext.infTable[0 as libc::c_int as usize] as libc::c_int &
           1 as libc::c_int != 0 {
        (*this).unk_208 = 0 as libc::c_int as u8_0;
        ...
        if gSaveContext.infTable[0 as libc::c_int as usize] as libc::c_int &
               2 as libc::c_int != 0 {
            return 0x1003 as libc::c_int as u16_0
        } else { return 0x1002 as libc::c_int as u16_0 }
    }
    return 0x1001 as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF56F4(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut ret: s16 = 1 as libc::c_int as s16;
    let mut this: *mut EnSa = thisx as *mut EnSa;
    match func_80AF5560(this, globalCtx) as libc::c_int {
        2 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF57D8(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT05 as libc::c_int ||
           ...
           (*this).unk_1E0.unk_00 as libc::c_int != 0 as libc::c_int {
        func_800343CC(globalCtx, &mut (*this).actor,
                      ...
                      Some(func_80AF55E0 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> u16_0),
                      Some(func_80AF56F4 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> s16));
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF5894(mut this: *mut EnSa) -> f32_0 {
    let mut endFrame: f32_0 = (*this).skelAnime.endFrame;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF58B8(mut this: *mut EnSa) {
    ...
    match (*this).unk_20A as libc::c_int {
        0 => {
            ...
            current_block_5 = 8125801243075930082;
        }
        1 => { current_block_5 = 8125801243075930082; }
        _ => { current_block_5 = 7351195479953500246; }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF594C(mut this: *mut EnSa) {
    let mut current_block_5: u64;
    match (*this).unk_20A as libc::c_int {
        0 => {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          8 as libc::c_int);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_5 = 13134184863065528237;
        }
        1 => { current_block_5 = 13134184863065528237; }
        _ => { current_block_5 = 7351195479953500246; }
    }
    match current_block_5 {
        13134184863065528237 => {
            if Animation_OnFrame(&mut (*this).skelAnime,
                                 (*this).skelAnime.endFrame) != 0 {
                func_80034EC0(&mut (*this).skelAnime,
                              sAnimations.as_mut_ptr(), 9 as libc::c_int);
                (*this).unk_20A = (*this).unk_20A.wrapping_add(1)
            }
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF59E0(mut this: *mut EnSa) {
    let mut current_block_5: u64;
    match (*this).unk_20A as libc::c_int {
        0 => {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          1 as libc::c_int);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_5 = 9482354835123468063;
        }
        1 => { current_block_5 = 9482354835123468063; }
        _ => { current_block_5 = 7351195479953500246; }
    }
    match current_block_5 {
        9482354835123468063 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5A74(mut this: *mut EnSa) {
    ...
    match (*this).unk_20A as libc::c_int {
        0 => {
            ...
            func_80AF5894(this);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_6 = 5597019656031029904;
        }
        1 => { current_block_6 = 5597019656031029904; }
        _ => { current_block_6 = 14523784380283086299; }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5B10(mut this: *mut EnSa) {
    let mut current_block_5: u64;
    match (*this).unk_20A as libc::c_int {
        0 => {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          6 as libc::c_int);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_5 = 1119045277619603618;
        }
        1 => { current_block_5 = 1119045277619603618; }
        _ => { current_block_5 = 7351195479953500246; }
    }
    match current_block_5 {
        1119045277619603618 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5BA4(mut this: *mut EnSa) {
    let mut current_block_6: u64;
    match (*this).unk_20A as libc::c_int {
        0 => {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
            ...
            func_80AF5894(this);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_6 = 593649643153251862;
        }
        1 => { current_block_6 = 593649643153251862; }
        _ => { current_block_6 = 14523784380283086299; }
    }
    match current_block_6 {
        593649643153251862 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5C40(mut this: *mut EnSa) {
    let mut current_block_5: u64;
    match (*this).unk_20A as libc::c_int {
        0 => {
            func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                          5 as libc::c_int);
            (*this).unk_20A = (*this).unk_20A.wrapping_add(1);
            current_block_5 = 5945380374615013383;
        }
        1 => { current_block_5 = 5945380374615013383; }
        _ => { current_block_5 = 7351195479953500246; }
    }
    match current_block_5 {
        5945380374615013383 => {
            if Animation_OnFrame(&mut (*this).skelAnime,
                                 (*this).skelAnime.endFrame) != 0 {
                func_80034EC0(&mut (*this).skelAnime,
                              sAnimations.as_mut_ptr(), 0 as libc::c_int);
                (*this).unk_20A = (*this).unk_20A.wrapping_add(1)
            }
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5CD4(mut this: *mut EnSa, mut arg1: u8_0) {
    (*this).unk_20B = arg1;
    (*this).unk_20A = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF5CE4(mut this: *mut EnSa) {
    match (*this).unk_20B as libc::c_int {
        1 => { func_80AF58B8(this); }
        2 => { func_80AF594C(this); }
        3 => { func_80AF59E0(this); }
        4 => { func_80AF5A74(this); }
        5 => { func_80AF5B10(this); }
        6 => { func_80AF5BA4(this); }
        7 => { func_80AF5C40(this); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSa_ChangeAnim(mut this: *mut EnSa,
                                         mut action: s32) {
    Animation_Change(&mut (*this).skelAnime,
                     sAnimationInfo[action as usize].animation, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sAnimationInfo[action as
                                                               usize].animation
                                                as *mut libc::c_void) as
                         f32_0, sAnimationInfo[action as usize].mode,
                     sAnimationInfo[action as usize].transitionRate);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF5DFC(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    if (*globalCtx).sceneNum as libc::c_int ==
           SCENE_KOKIRI_HOME5 as libc::c_int &&
           !(gSaveContext.linkAge == 0 as libc::c_int) &&
           gSaveContext.inventory.items[gItemSlots[ITEM_OCARINA_FAIRY as
                                                       libc::c_int as usize]
                                            as usize] as libc::c_int ==
               ITEM_OCARINA_FAIRY as libc::c_int &&
           gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int
               & 1 as libc::c_int == 0 {
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int &&
           gSaveContext.eventChkInf[4 as libc::c_int as usize] as libc::c_int
               & 1 as libc::c_int != 0 {
        return if gBitFlags[QUEST_SONG_SARIA as libc::c_int as usize] &
                      gSaveContext.inventory.questItems != 0 {
                   2 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF5F34(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT04 as libc::c_int {
        phi_a3 =
            if (*this).actionFunc ==
                   Some(func_80AF68E4 as
                            unsafe extern "C" fn(_: *mut EnSa,
                                                 _: *mut GlobalContext) -> ())
               {
                1 as libc::c_int
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int {
        phi_a3 =
            if (*this).skelAnime.animation ==
                   &mut gSariaPlayingOcarinaAnim as *mut AnimationHeader as
                       *mut libc::c_void {
                1 as libc::c_int
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int &&
           (*this).actionFunc ==
               Some(func_80AF6448 as
                        unsafe extern "C" fn(_: *mut EnSa,
                                             _: *mut GlobalContext) -> ()) &&
           (*this).skelAnime.animation ==
               &mut gSariaStopPlayingOcarinaAnim as *mut AnimationHeader as
                   *mut libc::c_void {
           ...
           (*this).actionFunc ==
               Some(func_80AF68E4 as
                        unsafe extern "C" fn(_: *mut EnSa,
                                             _: *mut GlobalContext) -> ()) &&
           (*this).skelAnime.animation ==
               &mut gSariaOcarinaToMouthAnim as *mut AnimationHeader as
                   *mut libc::c_void {
        phi_a3 = 1 as libc::c_int as s16
    }
    (*this).unk_1E0.unk_18 = (*player).actor.world.pos;
    (*this).unk_1E0.unk_14 = 4.0f32;
    func_80034A14(&mut (*this).actor, &mut (*this).unk_1E0,
                  2 as libc::c_int as s16, phi_a3);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF603C(mut this: *mut EnSa) -> s32 {
    if (*this).skelAnime.animation !=
           &mut gSariaPlayingOcarinaAnim as *mut AnimationHeader as
               *mut libc::c_void &&
           (*this).skelAnime.animation !=
    ...
    (*this).unk_20E = 0 as libc::c_int as s16;
    if (*this).rightEyeIndex as libc::c_int != SARIA_EYE_CLOSED as libc::c_int
       {
        return 0 as libc::c_int
    }
    return 1 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF609C(mut this: *mut EnSa) {
    let mut phi_v1: s16 = 0;
    if func_80AF603C(this) == 0 as libc::c_int {
        if (*this).unk_20E as libc::c_int == 0 as libc::c_int {
            phi_v1 = 0 as libc::c_int as s16
        } else { (*this).unk_20E -= 1; phi_v1 = (*this).unk_20E }
        if phi_v1 as libc::c_int == 0 as libc::c_int {
            (*this).rightEyeIndex += 1;
            if ((*this).rightEyeIndex as libc::c_int) <
                   SARIA_EYE_SUPRISED as libc::c_int {
                (*this).leftEyeIndex = (*this).rightEyeIndex
            } else {
                (*this).unk_20E =
                    Rand_S16Offset(30 as libc::c_int as s16,
                                   30 as libc::c_int as s16);
                (*this).leftEyeIndex = SARIA_EYE_OPEN as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF6130(mut csAction: *mut CsCmdActorAction,
                                       mut dst: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF6170(mut csAction: *mut CsCmdActorAction,
                                       mut dst: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSa_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    let mut pad: s32 = 0;
    ...
    match func_80AF5DFC(this, globalCtx) {
        2 => {
            EnSa_ChangeAnim(this, 0xb as libc::c_int);
            (*this).actionFunc =
                Some(func_80AF6448 as
                         unsafe extern "C" fn(_: *mut EnSa,
                                              _: *mut GlobalContext) -> ())
        ...
        5 => {
            EnSa_ChangeAnim(this, 0xb as libc::c_int);
            (*this).actionFunc =
                Some(func_80AF683C as
                         unsafe extern "C" fn(_: *mut EnSa,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
            (*this).actor.gravity = -1.0f32;
            EnSa_ChangeAnim(this, 0 as libc::c_int);
            (*this).actionFunc =
                Some(func_80AF6448 as
                         unsafe extern "C" fn(_: *mut EnSa,
                                              _: *mut GlobalContext) -> ())
        ...
        4 => {
            (*this).unk_210 = 0 as libc::c_int as s16;
            (*this).actor.gravity = -1.0f32;
            (*globalCtx).csCtx.segment =
                gSegments[((gSpot04Cs_10E20.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gSpot04Cs_10E20.as_mut_ptr()
                                                      as u32_0 &
            ...
            EnSa_ChangeAnim(this, 4 as libc::c_int);
            (*this).actionFunc =
                Some(func_80AF68E4 as
                         unsafe extern "C" fn(_: *mut EnSa,
                                              _: *mut GlobalContext) -> ())
        ...
        0 => { Actor_Kill(&mut (*this).actor); return }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnSa_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF6448(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT04 as libc::c_int {
        if (*this).unk_1E0.unk_00 as libc::c_int != 0 as libc::c_int {
            match (*this).actor.textId as libc::c_int {
                4098 => {
                    if (*this).unk_208 as libc::c_int == 0 as libc::c_int &&
                       ...
                       {
                        func_80AF5CD4(this, 1 as libc::c_int as u8_0);
                        (*this).mouthIndex = 1 as libc::c_int as s16
                    }
                    if (*this).unk_208 as libc::c_int == 2 as libc::c_int &&
                           (*this).unk_20B as libc::c_int != 2 as libc::c_int
                       {
                        func_80AF5CD4(this, 2 as libc::c_int as u8_0);
                        (*this).mouthIndex = 1 as libc::c_int as s16
                    }
                    if (*this).unk_208 as libc::c_int == 5 as libc::c_int {
                        (*this).mouthIndex = 0 as libc::c_int as s16
                    }
                }
                4099 => {
                    if (*this).unk_208 as libc::c_int == 0 as libc::c_int &&
                           (*this).unk_20B as libc::c_int != 4 as libc::c_int
                       {
                        func_80AF5CD4(this, 4 as libc::c_int as u8_0);
                    }
                }
                4145 => {
                    if (*this).unk_208 as libc::c_int == 0 as libc::c_int &&
                           ...
                           &&
                           (*this).skelAnime.animation ==
                               &mut gSariaHandsBehindBackWaitAnim as
                                   *mut AnimationHeader as *mut libc::c_void {
                        func_80AF5CD4(this, 4 as libc::c_int as u8_0);
                        (*this).mouthIndex = 3 as libc::c_int as s16
                    }
                    if (*this).unk_208 as libc::c_int == 2 as libc::c_int &&
                           (*this).unk_20B as libc::c_int != 5 as libc::c_int
                       {
                        func_80AF5CD4(this, 5 as libc::c_int as u8_0);
                        (*this).mouthIndex = 2 as libc::c_int as s16
                    }
                    if (*this).unk_208 as libc::c_int == 4 as libc::c_int &&
                           (*this).unk_20B as libc::c_int != 6 as libc::c_int
                       {
                        func_80AF5CD4(this, 6 as libc::c_int as u8_0);
                        (*this).mouthIndex = 0 as libc::c_int as s16
                    }
                }
                4146 => {
                ...
                4167 => {
                    if (*this).unk_208 as libc::c_int == 1 as libc::c_int &&
                       ...
                       {
                        func_80AF5CD4(this, 7 as libc::c_int as u8_0);
                    }
                }
                4168 => {
                    if (*this).unk_208 as libc::c_int == 0 as libc::c_int &&
        ...
        } else if gBitFlags[QUEST_KOKIRI_EMERALD as libc::c_int as usize] &
                      gSaveContext.inventory.questItems == 0 &&
                      (gSaveContext.infTable[0 as libc::c_int as usize] as
                           libc::c_int & 2 as libc::c_int != 0 ||
                           gSaveContext.infTable[0 as libc::c_int as usize] as
                               libc::c_int & 8 as libc::c_int != 0) {
            if (*this).unk_20B as libc::c_int != 3 as libc::c_int {
                func_80AF5CD4(this, 3 as libc::c_int as u8_0);
            }
        } else { func_80AF5CD4(this, 0 as libc::c_int as u8_0); }
        func_80AF5CE4(this);
    }
    if (*this).skelAnime.animation ==
           &mut gSariaStopPlayingOcarinaAnim as *mut AnimationHeader as
        ...
        if (*this).skelAnime.curFrame as s32 == 0 as libc::c_int {
            EnSa_ChangeAnim(this, 6 as libc::c_int);
        }
    }
    if (*this).unk_1E0.unk_00 as libc::c_int != 0 as libc::c_int &&
           (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int
       {
        Animation_Change(&mut (*this).skelAnime,
                         &mut gSariaStopPlayingOcarinaAnim, 1.0f32, 0.0f32,
                         10.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                         -10.0f32);
        (*this).actionFunc =
            Some(func_80AF67D0 as
                     unsafe extern "C" fn(_: *mut EnSa, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AF67D0(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_1E0.unk_00 as libc::c_int == 0 as libc::c_int {
        Animation_Change(&mut (*this).skelAnime,
                         &mut gSariaStopPlayingOcarinaAnim, 0.0f32, 10.0f32,
                         0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                         -10.0f32);
        (*this).actionFunc =
            Some(func_80AF6448 as
                     unsafe extern "C" fn(_: *mut EnSa, _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF683C(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if !((*player).actor.world.pos.z >= -2220.0f32) &&
           Gameplay_InCsMode(globalCtx) == 0 {
        (*globalCtx).csCtx.segment =
            gSegments[((spot05_scene_Cs_005730.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(spot05_scene_Cs_005730.as_mut_ptr()
                                                  as u32_0 &
...
pub unsafe extern "C" fn func_80AF68E4(mut this: *mut EnSa,
    ...
    let mut gravity: f32_0 = 0.;
    if (*globalCtx).csCtx.state as libc::c_int == CS_STATE_IDLE as libc::c_int
       {
        (*this).actionFunc =
            Some(func_80AF6B20 as
                     unsafe extern "C" fn(_: *mut EnSa, _: *mut GlobalContext)
                         -> ());
        return
    }
    csAction = (*globalCtx).csCtx.npcActions[1 as libc::c_int as usize];
    if !csAction.is_null() {
        func_80AF6130(csAction, &mut startPos);
        func_80AF6170(csAction, &mut endPos);
        if (*this).unk_210 as libc::c_int == 0 as libc::c_int {
            (*this).actor.world.pos = startPos
        }
        if (*this).unk_210 as libc::c_int != (*csAction).action as libc::c_int
           {
            match (*csAction).action as libc::c_int {
                2 => { (*this).mouthIndex = 1 as libc::c_int as s16 }
                9 => { (*this).mouthIndex = 1 as libc::c_int as s16 }
                _ => { (*this).mouthIndex = 0 as libc::c_int as s16 }
            }
            EnSa_ChangeAnim(this, (*csAction).action as s32);
            (*this).unk_210 = (*csAction).action as s16
        }
        (phi_v0) != 0;
        if (*csAction).action as libc::c_int == 3 as libc::c_int {
            if (*this).unk_20C as libc::c_int == 0 as libc::c_int {
                phi_v0 = 0 as libc::c_int as s16
            } else { (*this).unk_20C -= 1; phi_v0 = (*this).unk_20C }
            if phi_v0 as libc::c_int == 0 as libc::c_int {
                Audio_PlaySoundGeneral(0x800 as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
                (*this).unk_20C = 8 as libc::c_int as s16
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AF6B20(mut this: *mut EnSa,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int {
        Item_Give(globalCtx, ITEM_SONG_SARIA as libc::c_int as u8_0);
        EnSa_ChangeAnim(this, 6 as libc::c_int);
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT04 as libc::c_int {
        EnSa_ChangeAnim(this, 4 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnSa_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    let mut pad: s32 = 0;
    ...
    if (*this).skelAnime.animation ==
           ...
           (*this).skelAnime.curFrame >=
               Animation_GetLastFrame(&mut gSariaOcarinaToMouthAnim as
    ...
    if (*this).actionFunc !=
           Some(func_80AF68E4 as
                    unsafe extern "C" fn(_: *mut EnSa, _: *mut GlobalContext)
                        -> ()) {
        (*this).alpha =
            func_80034DD4(&mut (*this).actor, globalCtx, (*this).alpha,
                          400.0f32)
    } else { (*this).alpha = 255 as libc::c_int as s16 }
...
#[no_mangle]
pub unsafe extern "C" fn EnSa_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    let mut pad: s32 = 0;
    let mut sp18: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    if limbIndex == 16 as libc::c_int {
        ...
        Matrix_RotateX(sp18.y as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(sp18.x as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(-900.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    if limbIndex == 9 as libc::c_int {
        ...
        Matrix_RotateY(sp18.y as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX(sp18.x as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT05 as libc::c_int &&
           limbIndex == 15 as libc::c_int {
        *dList = gSariaRightHandAndOcarinaDL.as_mut_ptr()
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnSa_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void,
                                           mut gfx: *mut *mut Gfx) {
    let mut this: *mut EnSa = thisx as *mut EnSa;
    let mut D_80AF7454: Vec3f =
        {
            let mut init = Vec3f{x: 400.0f64 as f32_0, y: 0.0f32, z: 0.0f32,};
            init
        };
    if limbIndex == 16 as libc::c_int {
        Matrix_MultVec3f(&mut D_80AF7454, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSa_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut mouthTextures: [*mut libc::c_void; 5] =
        unsafe {
            [gSariaMouthClosed2Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gSariaMouthSmilingOpenTex.as_ptr() as *mut _ as
                 *mut libc::c_void,
    ...
    static mut eyeTextures: [*mut libc::c_void; 5] =
        unsafe {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_sa.c\x00" as *const u8 as *const libc::c_char,
                    1444 as libc::c_int);
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((eyeTextures[(*this).rightEyeIndex as usize] as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(eyeTextures[(*this).rightEyeIndex
                                                              as usize] as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((eyeTextures[(*this).leftEyeIndex as usize] as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(eyeTextures[(*this).leftEyeIndex
                                                              as usize] as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((mouthTextures[(*this).mouthIndex as usize] as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(mouthTextures[(*this).mouthIndex
                                                                as usize] as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
