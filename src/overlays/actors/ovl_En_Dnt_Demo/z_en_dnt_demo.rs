...
pub const PLAYER_MASK_MAX: C2RustUnnamed_16 = 9;
pub const PLAYER_MASK_TRUTH: C2RustUnnamed_16 = 8;
pub const PLAYER_MASK_GERUDO: C2RustUnnamed_16 = 7;
pub const PLAYER_MASK_ZORA: C2RustUnnamed_16 = 6;
pub const PLAYER_MASK_GORON: C2RustUnnamed_16 = 5;
pub const PLAYER_MASK_BUNNY: C2RustUnnamed_16 = 4;
pub const PLAYER_MASK_SPOOKY: C2RustUnnamed_16 = 3;
pub const PLAYER_MASK_SKULL: C2RustUnnamed_16 = 2;
pub const PLAYER_MASK_KEATON: C2RustUnnamed_16 = 1;
pub const PLAYER_MASK_NONE: C2RustUnnamed_16 = 0;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDntDemo {
    pub actor: Actor,
    pub actionFunc: EnDntDemoActionFunc,
    pub judgeTimer: s16,
    pub unkTimer1: s16,
    pub unkTimer2: s16,
    pub debugArrowTimer: s16,
    pub leaderSignal: s16,
    pub action: s16,
    pub prize: s16,
    pub subCamera: s16,
    pub scrubPos: [Vec3f; 9],
    pub leaderPos: Vec3f,
    pub scrubs: [*mut EnDntNomal; 9],
    pub leader: *mut EnDntJiji,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDntJiji {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 13],
    pub morphTable: [Vec3s; 13],
    pub actionFunc: EnDntJijiActionFunc,
    pub flowerPos: Vec3f,
    pub isSolid: u8_0,
    pub action: s16,
    pub timer: s16,
    ...
    pub attackFlag: s16,
    pub getItemId: s32,
    pub stage: *mut EnDntDemo,
    pub collider: ColliderCylinder,
}
pub type EnDntJijiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDntJiji, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type EnDntNomalActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnDntNomal, _: *mut GlobalContext)
               -> ()>;
pub type EnDntDemoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDntDemo, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const DNT_SIGNAL_UNUSED: C2RustUnnamed_19 = 6;
pub const DNT_SIGNAL_RETURN: C2RustUnnamed_19 = 5;
pub const DNT_SIGNAL_HIDE: C2RustUnnamed_19 = 4;
pub const DNT_SIGNAL_DANCE: C2RustUnnamed_19 = 3;
pub const DNT_SIGNAL_CELEBRATE: C2RustUnnamed_19 = 2;
pub const DNT_SIGNAL_LOOK: C2RustUnnamed_19 = 1;
pub const DNT_SIGNAL_NONE: C2RustUnnamed_19 = 0;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const DNT_LEADER_ACTION_ATTACK: C2RustUnnamed_20 = 3;
pub const DNT_LEADER_ACTION_UNUSED: C2RustUnnamed_20 = 2;
pub const DNT_LEADER_ACTION_UP: C2RustUnnamed_20 = 1;
pub const DNT_LEADER_ACTION_NONE: C2RustUnnamed_20 = 0;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const DNT_LEADER_SIGNAL_RETURN: C2RustUnnamed_21 = 3;
pub const DNT_LEADER_SIGNAL_BURROW: C2RustUnnamed_21 = 2;
pub const DNT_LEADER_SIGNAL_UP: C2RustUnnamed_21 = 1;
pub const DNT_LEADER_SIGNAL_NONE: C2RustUnnamed_21 = 0;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const DNT_PRIZE_STICK: C2RustUnnamed_22 = 2;
pub const DNT_PRIZE_NUTS: C2RustUnnamed_22 = 1;
pub const DNT_PRIZE_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const DNT_ACTION_PRIZE: C2RustUnnamed_23 = 5;
pub const DNT_ACTION_HIGH_RUPEES: C2RustUnnamed_23 = 4;
pub const DNT_ACTION_LOW_RUPEES: C2RustUnnamed_23 = 3;
pub const DNT_ACTION_ATTACK: C2RustUnnamed_23 = 2;
pub const DNT_ACTION_DANCE: C2RustUnnamed_23 = 1;
pub const DNT_ACTION_NONE: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const DNT_LOVE: C2RustUnnamed_24 = 2;
pub const DNT_HATE: C2RustUnnamed_24 = 1;
pub const DNT_LIKE: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut En_Dnt_Demo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DNT_DEMO as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDntDemo>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntDemo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDntDemo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sResultTable: [[s16; 7]; 8] =
    [[DNT_LIKE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_LOVE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16],
     [DNT_HATE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_LOVE as libc::c_int as s16],
     [DNT_LOVE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16],
     [DNT_HATE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16],
     [DNT_LIKE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      ...
      DNT_HATE as libc::c_int as s16],
     [DNT_LIKE as libc::c_int as s16, DNT_LIKE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_LIKE as libc::c_int as s16],
     [DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16, DNT_HATE as libc::c_int as s16,
      DNT_HATE as libc::c_int as s16],
     [DNT_LOVE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_LOVE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_LOVE as libc::c_int as s16, DNT_LOVE as libc::c_int as s16,
      DNT_LOVE as libc::c_int as s16]];
static mut sResultValues: [[s16; 2]; 3] =
    [[DNT_SIGNAL_HIDE as libc::c_int as s16,
      DNT_ACTION_LOW_RUPEES as libc::c_int as s16],
     [DNT_SIGNAL_HIDE as libc::c_int as s16,
      DNT_ACTION_ATTACK as libc::c_int as s16],
     [DNT_SIGNAL_DANCE as libc::c_int as s16,
      DNT_ACTION_DANCE as libc::c_int as s16]];
static mut sScrubPos: [Vec3f; 9] =
    [{ let mut init = Vec3f{x: 3810.0f32, y: -20.0f32, z: 1010.0f32,}; init },
     { let mut init = Vec3f{x: 3890.0f32, y: -20.0f32, z: 990.0f32,}; init },
     { let mut init = Vec3f{x: 3730.0f32, y: -20.0f32, z: 950.0f32,}; init },
     { let mut init = Vec3f{x: 3840.0f32, y: -20.0f32, z: 930.0f32,}; init },
     { let mut init = Vec3f{x: 3910.0f32, y: -20.0f32, z: 870.0f32,}; init },
     { let mut init = Vec3f{x: 3780.0f32, y: -20.0f32, z: 860.0f32,}; init },
     { let mut init = Vec3f{x: 3710.0f32, y: -20.0f32, z: 840.0f32,}; init },
     { let mut init = Vec3f{x: 3860.0f32, y: -20.0f32, z: 790.0f32,}; init },
     { let mut init = Vec3f{x: 3750.0f32, y: -20.0f32, z: 750.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Init(mut thisx: *mut Actor,
                                        mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnDntDemo = thisx as *mut EnDntDemo;
    let mut i: s32 = 0;
    let mut pad: s32 = 0;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Deku Scrub mask show start"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x87\xe3\x82\xb0\xe3\x83\x8a\xe3\x83\x83\xe3\x83\x84\xe3\x81\x8a\xe9\x9d\xa2\xe5\x93\x81\xe8\xa9\x95\xe4\xbc\x9a\xe9\x96\x8b\xe5\xa7\x8b \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    i = 0 as libc::c_int;
    while i < 9 as libc::c_int {
        (*this).scrubPos[i as usize] = sScrubPos[i as usize];
        (*this).scrubs[i as usize] =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               ACTOR_EN_DNT_NOMAL as libc::c_int as s16,
                               (*this).scrubPos[i as usize].x,
                               (*this).scrubPos[i as usize].y,
                               (*this).scrubPos[i as usize].z,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               (i + 1 as libc::c_int) as s16) as
                *mut EnDntNomal;
        if !(*this).scrubs[i as usize].is_null() {
            // "zako zako" [small fries]
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xb6\xe3\x82\xb3\xe3\x82\xb6\xe3\x82\xb3 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).scrubs[i as usize]);
        }
        i += 1
    }
    (*this).leaderPos.x = 4050.0f32;
    (*this).leaderPos.y = -20.0f32;
    (*this).leaderPos.z = 1000.0f32;
    (*this).leader =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_DNT_JIJI as libc::c_int as s16,
                           (*this).leaderPos.x, (*this).leaderPos.y,
                           (*this).leaderPos.z, 0 as libc::c_int as s16,
                           0 as libc::c_int as s16, 0 as libc::c_int as s16,
                           0 as libc::c_int as s16) as *mut EnDntJiji;
    if !(*this).leader.is_null() {
        // "jiji jiji jiji jiji jiji" [onomatopoeia for the scrub sound?]
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x98\xe3\x81\x84 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, (*this).leader);
    }
    (*this).subCamera = 0 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnDntDemo_Judge as
                 unsafe extern "C" fn(_: *mut EnDntDemo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Judge(mut this: *mut EnDntDemo,
                                         mut globalCtx: *mut GlobalContext) {
    let mut delay: s16 = 0;
    let mut reaction: s16 = 0;
    let mut rand9: s16 = 0;
    let mut maskIdx: s16 = 0;
    let mut resultIdx: s16 = 0;
    let mut ignore: u8_0 = 0;
    let mut i: s32 = 0;
    if (*this).leaderSignal as libc::c_int != DNT_SIGNAL_NONE as libc::c_int {
        i = 0 as libc::c_int;
        while i < 9 as libc::c_int {
            (*(*this).scrubs[i as usize]).stageSignal = (*this).leaderSignal;
            (*(*this).scrubs[i as usize]).action = (*this).action;
            (*(*this).scrubs[i as usize]).stagePrize =
                DNT_PRIZE_NONE as libc::c_int as u8_0;
            i += 1
        }
        if (*(*this).leader).isSolid != 0 {
            (*(*this).leader).stageSignal =
                DNT_LEADER_SIGNAL_BURROW as libc::c_int as s16
        }
        (*this).leaderSignal = DNT_SIGNAL_NONE as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDntDemo_Results as
                     unsafe extern "C" fn(_: *mut EnDntDemo,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).actor.xzDistToPlayer > 30.0f32 ||
                  Player_GetMask(globalCtx) as libc::c_int == 0 as libc::c_int
     {
        (*this).debugArrowTimer += 1;
        if (*this).subCamera as libc::c_int != 0 as libc::c_int {
            (*this).subCamera = 0 as libc::c_int as s16
        }
        if (*this).judgeTimer as libc::c_int != 0 as libc::c_int {
            i = 0 as libc::c_int;
            while i < 9 as libc::c_int {
                (*(*this).scrubs[i as usize]).stageSignal =
                    DNT_SIGNAL_HIDE as libc::c_int as s16;
                i += 1
            }
            (*this).judgeTimer = 0 as libc::c_int as s16
        }
    } else {
        if Player_GetMask(globalCtx) as libc::c_int != 0 as libc::c_int &&
               (*this).subCamera as libc::c_int == 0 as libc::c_int {
            (*this).subCamera =
                OnePointCutscene_Init(globalCtx, 2220 as libc::c_int as s16,
                                      -(99 as libc::c_int) as s16,
                                      &mut (**(*this).scrubs.as_mut_ptr().offset(3
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize)).actor,
        ...
        (*this).debugArrowTimer = 0 as libc::c_int as s16;
        if (*this).judgeTimer as libc::c_int == 40 as libc::c_int {
            i = 0 as libc::c_int;
            while i < 9 as libc::c_int {
                (*(*this).scrubs[i as usize]).stageSignal =
                    DNT_SIGNAL_LOOK as libc::c_int as s16;
                i += 1
            }
        }
        if (*this).judgeTimer as libc::c_int > 40 as libc::c_int {
            // "gera gera" [onomatopoeia for loud giggling]
            osSyncPrintf(b"\x1b[31m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x92\xe3\x82\x89\xe3\x81\x92\xe3\x82\x89 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            func_800F436C(&mut (*this).actor.projectedPos,
                          (0x285d as libc::c_int - 0x800 as libc::c_int) as
                              u16_0, 2.0f32);
        }
        if ((*this).judgeTimer as libc::c_int) < 120 as libc::c_int {
            (*this).judgeTimer += 1
        } else {
            ignore = 0 as libc::c_int as u8_0;
            reaction = DNT_SIGNAL_NONE as libc::c_int as s16;
            delay = 0 as libc::c_int as s16;
            let mut current_block_88: u64;
            match Player_GetMask(globalCtx) as libc::c_int {
                2 => {
                    if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
                           libc::c_int & 0x4000 as libc::c_int == 0 {
                        reaction = DNT_SIGNAL_CELEBRATE as libc::c_int as s16;
                        (*this).prize = DNT_PRIZE_STICK as libc::c_int as s16;
                        Audio_QueueSeqCmd(((SEQ_PLAYER_BGM_MAIN as
                                                libc::c_int) <<
                                               24 as libc::c_int |
                                               0x3e as libc::c_int) as u32_0);
                        current_block_88 = 15734707049249739970;
                    } else { current_block_88 = 5756141056716048759; }
                }
                8 => { current_block_88 = 5756141056716048759; }
                1 | 3 | 4 | 5 | 6 | 7 => {
                    current_block_88 = 4868156511244245068;
                }
                _ => { current_block_88 = 15734707049249739970; }
            }
                ...
                5756141056716048759 => {
                    if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
                        ...
                        Audio_PlaySoundGeneral(0x4807 as libc::c_int as u16_0,
                                               ...
                                               &mut D_801333E0,
                                               &mut D_801333E8);
                        (*this).prize = DNT_PRIZE_NUTS as libc::c_int as s16;
                        (*(*this).leader).stageSignal =
                            DNT_LEADER_SIGNAL_UP as libc::c_int as s16;
                        reaction = DNT_SIGNAL_LOOK as libc::c_int as s16;
                        if (*this).subCamera as libc::c_int !=
                               0 as libc::c_int {
                            (*this).subCamera = 0 as libc::c_int as s16;
                            reaction = DNT_SIGNAL_LOOK as libc::c_int as s16;
                            OnePointCutscene_Init(globalCtx,
                                                  2340 as libc::c_int as s16,
                                                  -(99 as libc::c_int) as s16,
                                                  &mut (*(*this).leader).actor,
                                                  0 as libc::c_int as s16);
                        }
                        current_block_88 = 15734707049249739970;
                    } else { current_block_88 = 4868156511244245068; }
                }
                _ => { }
            }
            match current_block_88 {
                4868156511244245068 => {
                    rand9 = Rand_ZeroFloat(8.99f32) as s16;
                    maskIdx = Player_GetMask(globalCtx) as s16;
                    maskIdx -= 1;
                    if rand9 as libc::c_int == 8 as libc::c_int {
                        ignore = 1 as libc::c_int as u8_0;
                        delay = 8 as libc::c_int as s16;
                        reaction = DNT_SIGNAL_HIDE as libc::c_int as s16;
                        // "Special!"
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x89\xb9\xe5\x88\xa5\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char);
                    } else {
                        if maskIdx as libc::c_int >=
                               PLAYER_MASK_MAX as libc::c_int -
                                   1 as libc::c_int {
                            // "This is dangerous!"
                            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xa4\xe3\x83\x90\xe3\x81\x84\xe3\x82\x88\xe3\x81\x93\xe3\x82\x8c\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xa4\xe3\x83\x90\xe3\x81\x84\xe3\x82\x88\xe3\x81\x93\xe3\x82\x8c\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xa4\xe3\x83\x90\xe3\x81\x84\xe3\x82\x88\xe3\x81\x93\xe3\x82\x8c\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xa4\xe3\x83\x90\xe3\x81\x84\xe3\x82\x88\xe3\x81\x93\xe3\x82\x8c\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            maskIdx = Rand_ZeroFloat(7.99f32) as s16
                        }
                        resultIdx =
                            sResultTable[rand9 as usize][maskIdx as usize];
                        reaction =
                            sResultValues[resultIdx as
                        ...
                        osSyncPrintf(b"\n\n\x00" as *const u8 as
                                         *const libc::c_char);
                        // "Each index 1"
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x90\x84\xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9\xef\xbc\x91 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     rand9 as libc::c_int);
                        // "Each index 2"
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x90\x84\xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9\xef\xbc\x92 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     maskIdx as libc::c_int);
                        // "Each index 3"
                        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x90\x84\xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9\xef\xbc\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     resultIdx as libc::c_int);
                        osSyncPrintf(b"\n\x00" as *const u8 as
                                         *const libc::c_char);
                        // "What kind of evaluation?"
                        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xa9\xe3\x81\x86\xe3\x81\x84\xe3\x81\x86\xe8\xa9\x95\xe4\xbe\xa1\xef\xbc\x9f  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
                                     reaction as libc::c_int);
                        // "What kind of action?"
                        osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xa9\xe3\x81\x86\xe3\x81\x84\xe3\x81\x86\xe3\x82\xa2\xe3\x82\xaf\xe3\x82\xb7\xe3\x83\xa7\xe3\x83\xb3\xef\xbc\x9f  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char,
            ...
            if reaction as libc::c_int != DNT_SIGNAL_NONE as libc::c_int {
                i = 0 as libc::c_int;
                while i < 9 as libc::c_int {
                    if delay as libc::c_int != 0 as libc::c_int {
                        (*(*this).scrubs[i as usize]).timer3 =
                            (delay as libc::c_int * i) as s16
                    }
                    (*(*this).scrubs[i as usize]).action = (*this).action;
                    (*(*this).scrubs[i as usize]).stageSignal = reaction;
                    (*(*this).scrubs[i as usize]).ignore = ignore;
                    if (*this).prize as libc::c_int !=
                           DNT_PRIZE_NONE as libc::c_int {
                        (*(*this).scrubs[i as usize]).timer1 =
                            300 as libc::c_int as s16;
                        (*(*this).scrubs[i as usize]).stagePrize =
                            (*this).prize as u8_0;
                        (*(*this).scrubs[i as usize]).targetPos =
                            (*(*this).leader).actor.world.pos;
                        if (*this).prize as libc::c_int ==
                               DNT_PRIZE_NUTS as libc::c_int {
                            (*(*this).leader).stageSignal =
                                DNT_LEADER_SIGNAL_UP as libc::c_int as s16
                        }
                        if (*this).prize as libc::c_int ==
                               DNT_PRIZE_STICK as libc::c_int {
                            (*(*this).leader).timer =
                                300 as libc::c_int as s16
                        }
                    }
...
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Results(mut this: *mut EnDntDemo,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*this).leaderSignal as libc::c_int != DNT_SIGNAL_NONE as libc::c_int {
        ...
        if (*(*this).leader).action as libc::c_int ==
               DNT_LEADER_ACTION_UP as libc::c_int {
            (*(*this).leader).stageSignal =
                DNT_LEADER_SIGNAL_BURROW as libc::c_int as s16
        } else if (*(*this).leader).unburrow != 0 {
            (*(*this).leader).stageSignal =
                DNT_LEADER_SIGNAL_RETURN as libc::c_int as s16
        } else {
            (*(*this).leader).action =
                DNT_LEADER_ACTION_ATTACK as libc::c_int as s16
        }
        (*(*this).leader).timer = 0 as libc::c_int as s16;
        (*this).action = DNT_SIGNAL_NONE as libc::c_int as s16;
        (*this).leaderSignal = (*this).action;
        (*this).actionFunc =
            Some(EnDntDemo_Prize as
                     unsafe extern "C" fn(_: *mut EnDntDemo,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).prize as libc::c_int == DNT_PRIZE_STICK as libc::c_int {
        i = 0 as libc::c_int;
        while i < 9 as libc::c_int {
            let mut offsetAngle: s16 =
                -((*(*this).leader).actor.shape.rot.y as libc::c_int) as s16;
            let mut leaderPos: Vec3f = (*(*this).leader).actor.world.pos;
            let mut offsetDist: f32_0 = 0.;
            if i & 1 as libc::c_int == 0 {
                offsetAngle =
                    (offsetAngle as libc::c_int - 0x59d8 as libc::c_int) as
                        s16
            }
            offsetDist =
                (i + 1 as libc::c_int) as libc::c_float * 20.0f32 + 20.0f32;
            (*(*this).scrubs[i as usize]).timer2 = 10 as libc::c_int as s16;
            (*(*this).scrubs[i as usize]).targetPos.x =
                leaderPos.x + Math_SinS(offsetAngle) * offsetDist;
            (*(*this).scrubs[i as usize]).targetPos.y = leaderPos.y;
            (*(*this).scrubs[i as usize]).targetPos.z =
                leaderPos.z + Math_CosS(offsetAngle) * offsetDist;
            i += 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Prize(mut this: *mut EnDntDemo,
                                         mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*this).leaderSignal as libc::c_int != DNT_SIGNAL_NONE as libc::c_int {
        i = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnDntDemo_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDntDemo = thisx as *mut EnDntDemo;
    if (*this).unkTimer2 as libc::c_int != 0 as libc::c_int {
        (*this).unkTimer2 -= 1
    }
    if (*this).unkTimer1 as libc::c_int != 0 as libc::c_int {
        (*this).unkTimer1 -= 1
    }
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
           ...
           != 0 {
        if (*this).debugArrowTimer as libc::c_int != 0 as libc::c_int {
            if (*this).debugArrowTimer as libc::c_int & 1 as libc::c_int == 0
               {
