...
extern "C" {
    ...
    #[no_mangle]
    static mut gNiwGirlRunAnim: AnimationHeader;
    #[no_mangle]
    static mut gNiwGirlEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gNiwGirlEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gNiwGirlEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gNiwGirlSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gNiwGirlJumpAnim: AnimationHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNiwGirl {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
    pub actionFunc: EnNiwGirlActionFunc,
    pub unk_260: Vec3s,
    pub unk_266: Vec3s,
    pub jumpTimer: s16,
    pub unkUpTimer: s16,
    ...
    pub unk_27C: f32_0,
    pub unk_280: f32_0,
    pub chasedEnNiw: *mut EnNiw,
    pub collider: ColliderCylinder,
    pub unk_2D4: struct_80034A14_arg1,
}
pub type EnNiwGirlActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNiwGirl, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Niw_Girl_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NIW_GIRL as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_GR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnNiwGirl>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNiwGirl_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnNiwGirl_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNiwGirl = thisx as *mut EnNiwGirl;
    let mut pad: s32 = 0;
    let mut vec1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vec2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad2: s32 = 0;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gNiwGirlSkel,
                       &mut gNiwGirlRunAnim, (*this).jointTable.as_mut_ptr(),
    ...
    vec1.y = 0.0f32;
    vec1.x = vec1.y;
    vec1.z = 50.0f64 as f32_0;
    Matrix_MultVec3f(&mut vec1, &mut vec2);
    (*this).chasedEnNiw =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_NIW as libc::c_int as s16,
                           (*this).actor.world.pos.x + vec2.x,
                           (*this).actor.world.pos.y + vec2.y,
                           (*this).actor.world.pos.z + vec2.z,
                           0 as libc::c_int as s16, (*this).actor.world.rot.y,
                           0 as libc::c_int as s16, 0xa as libc::c_int as s16)
            as *mut EnNiw;
    if !(*this).chasedEnNiw.is_null() {
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xb7\xe3\x83\x84\xe3\x83\xac\xe3\x82\xa4\xe3\x81\x97\xe3\x81\xa1\xe3\x82\x83\xe3\x81\x86\xe3\x82\x8f\xe3\x81\xad\xef\xbc\x81\xe3\x83\x97\xe3\x83\xb3\xe3\x83\x97\xe3\x83\xb3 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8d\xe3\x82\x83\xe3\x81\xaf\xe3\x81\xaf\xe3\x81\xaf\xe3\x81\xaf\xe3\x81\xaf\xe3\x80\x81\xe3\x81\xbe\xe3\x81\xa6\xe3\x83\xbc \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).path as libc::c_int);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnNiwGirl_Talk as
                     unsafe extern "C" fn(_: *mut EnNiwGirl,
                                          _: *mut GlobalContext) -> ())
    } else {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xaa\xe3\x81\x9c\xe3\x81\x8b\xe3\x80\x81\xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xe3\x81\xa7\xe3\x81\x8d\xe3\x82\x80\xe3\x81\x85\xe3\x81\x82\xe3\x81\x9b\xe3\x82\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x93\xe3\x82\x93\xe3\x81\x8c\xe3\x81\x8f\xe3\x81\x8f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).path as libc::c_int);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Jump(mut this: *mut EnNiwGirl,
                                        mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gNiwGirlRunAnim as *mut AnimationHeader as
                                   *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gNiwGirlRunAnim, 1.0f32,
                     0.0f32, frameCount, 0 as libc::c_int as u8_0, -10.0f32);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(func_80AB9210 as
                 unsafe extern "C" fn(_: *mut EnNiwGirl,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB9210(mut this: *mut EnNiwGirl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut path: *mut Path =
        &mut *(*globalCtx).setupPathList.offset((*this).path as isize) as
            *mut Path;
    let mut xDistBetween: f32_0 = 0.;
    let mut zDistBetween: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ApproachF(&mut (*this).actor.speedXZ, 3.0f32, 0.2f32, 0.4f32);
    // Find the X and Z distance between the girl and the cuckoo she is chasing
    xDistBetween =
        (*(*this).chasedEnNiw).actor.world.pos.x - (*this).actor.world.pos.x;
    zDistBetween =
        (*(*this).chasedEnNiw).actor.world.pos.z - (*this).actor.world.pos.z;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int !=
           TEXT_STATE_NONE as libc::c_int {
        (*(*this).chasedEnNiw).path = 0 as libc::c_int as s16
    }
    if sqrtf(xDistBetween * xDistBetween + zDistBetween * zDistBetween) <
           70.0f32 {
        (*(*this).chasedEnNiw).path =
            ((*this).path as libc::c_int + 1 as libc::c_int) as s16;
        (*(*this).chasedEnNiw).unk_2EC = (*path).count as s16
    } else if sqrtf(xDistBetween * xDistBetween + zDistBetween * zDistBetween)
                  > 150.0f32 {
        (*(*this).chasedEnNiw).path = 0 as libc::c_int as s16
    }
    // Change her angle so that she is always facing the cuckoo
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (Math_FAtan2F(xDistBetween, zDistBetween) *
                            (0x8000 as libc::c_int as libc::c_float /
                                 3.14159265358979323846f32)) as s16,
                       3 as libc::c_int as s16, (*this).unk_27C as s16,
                       0 as libc::c_int as s16);
    Math_ApproachF(&mut (*this).unk_27C, 5000.0f32, 30.0f32, 150.0f32);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    // Only allow Link to talk to her when she is playing the jumping animation
    if (*this).jumpTimer as libc::c_int == 0 as libc::c_int ||
           Player_GetMask(globalCtx) as libc::c_int !=
               PLAYER_MASK_NONE as libc::c_int {
        (*this).jumpTimer = 60 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnNiwGirl_Talk as
                     unsafe extern "C" fn(_: *mut EnNiwGirl,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Talk(mut this: *mut EnNiwGirl,
                                        mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gNiwGirlJumpAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gNiwGirlJumpAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0 as libc::c_int as u8_0, -10.0f32);
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.textId = 0x7000 as libc::c_int as u16_0;
    if gSaveContext.eventChkInf[8 as libc::c_int as usize] as libc::c_int &
           1 as libc::c_int != 0 &&
           (*this).unk_27A as libc::c_int == 0 as libc::c_int {
        (*this).actor.textId = 0x70ea as libc::c_int as u16_0
    }
    match Player_GetMask(globalCtx) as libc::c_int {
        1 => { (*this).actor.textId = 0x7118 as libc::c_int as u16_0 }
        3 => { (*this).actor.textId = 0x7119 as libc::c_int as u16_0 }
        4 | 6 | 7 => { (*this).actor.textId = 0x711a as libc::c_int as u16_0 }
        2 | 5 | 8 => { (*this).actor.textId = 0x711b as libc::c_int as u16_0 }
        _ => { }
    }
    (*this).unk_270 = 6 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80AB94D0 as
                 unsafe extern "C" fn(_: *mut EnNiwGirl,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AB94D0(mut this: *mut EnNiwGirl,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int !=
           TEXT_STATE_NONE as libc::c_int {
    ...
    Math_ApproachZeroF(&mut (*this).actor.speedXZ, 0.8f32, 0.2f32);
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.textId as libc::c_int == 0x70ea as libc::c_int {
            (*this).unk_27A = 1 as libc::c_int as s16
        }
    } else if (*this).jumpTimer as libc::c_int == 0 as libc::c_int &&
                  Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
                      TEXT_STATE_NONE as libc::c_int {
        (*this).jumpTimer = (Rand_ZeroFloat(100.0f32) + 250.0f32) as s16;
        (*this).actionFunc =
            Some(EnNiwGirl_Jump as
                     unsafe extern "C" fn(_: *mut EnNiwGirl,
                                          _: *mut GlobalContext) -> ())
    } else { func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32); };
}
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNiwGirl = thisx as *mut EnNiwGirl;
    let mut tempActionFunc: EnNiwGirlActionFunc = None;
    ...
    if tempActionFunc == (*this).actionFunc {
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            (*this).unk_2D4.unk_18.y = (*player).actor.world.pos.y - 10.0f32
        }
        ...
        Math_SmoothStepToS(&mut (*this).unk_266.y, 0 as libc::c_int as s16,
                           5 as libc::c_int as s16,
                           3000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_260.y, 0 as libc::c_int as s16,
                           5 as libc::c_int as s16,
                           3000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_260.z, 0 as libc::c_int as s16,
                           5 as libc::c_int as s16,
                           3000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    }
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 100.0f32, 100.0f32,
                            200.0f32, 0x1c as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirlOverrideLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
...
static mut sConstVec3f: Vec3f =
    { let mut init = Vec3f{x: 0.2f32, y: 0.2f32, z: 0.2f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnNiwGirl_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gNiwGirlEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gNiwGirlEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gNiwGirlEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnNiwGirl = thisx as *mut EnNiwGirl;
    let mut pad: s32 = 0;
    let mut sp4C: Vec3f = sConstVec3f;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_niw_girl.c\x00" as *const u8 as
                        *const libc::c_char, 573 as libc::c_int);
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnNiwGirlOverrideLimbDraw as
