...
extern "C" {
    ...
    #[no_mangle]
    fn func_800F6268(dist: f32_0, _: u16_0);
    #[no_mangle]
    fn func_800F6584(arg0: u8_0);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gMalonChildIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gMalonChildEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildNeutralMouthTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildSmilingMouthTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildTalkingMouthTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonChildSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gMalonChildSingAnim: AnimationHeader;
}
...
pub struct EnMa1 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnMa1ActionFunc,
...
pub type EnMa1ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMa1, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ma1_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MA1 as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_MA1 as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMa1>() as libc::c_ulong,
                          init:
...
static mut sAnimationInfo: [struct_D_80AA1678; 4] =
    unsafe {
        [{
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gMalonChildIdleAnim as
...
static mut D_80AA16B8: Vec3f =
    { let mut init = Vec3f{x: 800.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut sMouthTextures: [*mut libc::c_void; 3] =
    unsafe {
        [gMalonChildNeutralMouthTex.as_ptr() as *mut _ as *mut libc::c_void,
         gMalonChildSmilingMouthTex.as_ptr() as *mut _ as *mut libc::c_void,
         gMalonChildTalkingMouthTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sEyeTextures: [*mut libc::c_void; 3] =
    unsafe {
        [gMalonChildEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
         gMalonChildEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gMalonChildEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnMa1_GetText(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> u16_0 {
    let mut faceReaction: u16_0 =
        Text_GetFaceReaction(globalCtx, 0x17 as libc::c_int as u32_0);
    ...
    if gBitFlags[QUEST_SONG_EPONA as libc::c_int as usize] &
        ...
        return 0x204a as libc::c_int as u16_0
    }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x40 as libc::c_int != 0 {
        return 0x2049 as libc::c_int as u16_0
    }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x20 as libc::c_int != 0 {
        if gSaveContext.infTable[8 as libc::c_int as usize] as libc::c_int &
               0x20 as libc::c_int != 0 {
            return 0x2049 as libc::c_int as u16_0
        } else { return 0x2048 as libc::c_int as u16_0 }
    }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x10 as libc::c_int != 0 {
        return 0x2047 as libc::c_int as u16_0
    }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           4 as libc::c_int != 0 {
        return 0x2044 as libc::c_int as u16_0
    }
    if gSaveContext.infTable[8 as libc::c_int as usize] as libc::c_int &
           0x10 as libc::c_int != 0 {
        if gSaveContext.infTable[8 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int != 0 {
            return 0x2043 as libc::c_int as u16_0
        } else { return 0x2042 as libc::c_int as u16_0 }
    }
    return 0x2041 as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA0778(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut ret: s16 = 1 as libc::c_int as s16;
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        2 => {
            match (*thisx).textId as libc::c_int {
                8257 => {
                    gSaveContext.infTable[8 as libc::c_int as usize] =
                        (gSaveContext.infTable[8 as libc::c_int as usize] as
                             libc::c_int | 0x10 as libc::c_int) as u16_0;
                    gSaveContext.eventChkInf[1 as libc::c_int as usize] =
                        (gSaveContext.eventChkInf[1 as libc::c_int as usize]
                             as libc::c_int | 1 as libc::c_int) as u16_0;
                    ret = 0 as libc::c_int as s16
                }
                8259 => { ret = 1 as libc::c_int as s16 }
                8263 => {
                    gSaveContext.eventChkInf[1 as libc::c_int as usize] =
                        (gSaveContext.eventChkInf[1 as libc::c_int as usize]
                ...
                8265 => {
                    gSaveContext.eventChkInf[1 as libc::c_int as usize] =
                        (gSaveContext.eventChkInf[1 as libc::c_int as usize]
                             as libc::c_int | 0x40 as libc::c_int) as u16_0;
                    ret = 0 as libc::c_int as s16
                }
                8289 => { ret = 2 as libc::c_int as s16 }
                _ => { ret = 0 as libc::c_int as s16 }
            }
        }
        4 | 5 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                ret = 2 as libc::c_int as s16
            }
        }
        6 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                ret = 3 as libc::c_int as s16
            }
        }
        0 | 1 | 3 | 7 | 8 | 9 => { ret = 1 as libc::c_int as s16 }
        _ => { }
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA08C4(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actor.shape.rot.z as libc::c_int == 3 as libc::c_int &&
           gSaveContext.sceneSetupIndex == 5 as libc::c_int {
        return 1 as libc::c_int
    }
    if !(gSaveContext.linkAge == 1 as libc::c_int) { return 0 as libc::c_int }
    if ((*globalCtx).sceneNum as libc::c_int ==
            SCENE_MARKET_NIGHT as libc::c_int ||
           ...
           gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               & 0x10 as libc::c_int == 0 &&
           gSaveContext.infTable[8 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int == 0 {
        return 1 as libc::c_int
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT15 as libc::c_int &&
           gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               & 0x10 as libc::c_int == 0 {
        if gSaveContext.infTable[8 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa1_UpdateEyes(mut this: *mut EnMa1) {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa1_ChangeAnimation(mut this: *mut EnMa1,
                                               mut idx: s32) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(sAnimationInfo[idx as usize].animation as
                                   *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime,
                     sAnimationInfo[idx as usize].animation, 1.0f32, 0.0f32,
                     frameCount, sAnimationInfo[idx as usize].mode,
                     sAnimationInfo[idx as usize].transitionRate);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA0AF4(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_1E8.unk_00 as libc::c_int == 0 as libc::c_int &&
           (*this).skelAnime.animation ==
               &mut gMalonChildSingAnim as *mut AnimationHeader as
                   *mut libc::c_void {
        phi_a3 = 1 as libc::c_int as s16
    } else { phi_a3 = 0 as libc::c_int as s16 }
    (*this).unk_1E8.unk_18 = (*player).actor.world.pos;
    (*this).unk_1E8.unk_18.y -= -10.0f32;
    func_80034A14(&mut (*this).actor, &mut (*this).unk_1E8,
                  0 as libc::c_int as s16, phi_a3);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA0B74(mut this: *mut EnMa1) {
    if (*this).skelAnime.animation ==
           &mut gMalonChildSingAnim as *mut AnimationHeader as
               *mut libc::c_void {
        if (*this).unk_1E8.unk_00 as libc::c_int == 0 as libc::c_int {
            if (*this).unk_1E0 as libc::c_int != 0 as libc::c_int {
                (*this).unk_1E0 = 0 as libc::c_int as s16;
                func_800F6584(0 as libc::c_int as u8_0);
            }
        } else if (*this).unk_1E0 as libc::c_int == 0 as libc::c_int {
            (*this).unk_1E0 = 1 as libc::c_int as s16;
            func_800F6584(1 as libc::c_int as u8_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMa1_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa1 = thisx as *mut EnMa1;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gMalonChildSkel, 0 as *mut AnimationHeader,
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(22 as libc::c_int),
                            &mut sColChkInfoInit);
    ...
    (*this).unk_1E8.unk_00 = 0 as libc::c_int as s16;
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x10 as libc::c_int == 0 ||
           gBitFlags[QUEST_SONG_EPONA as libc::c_int as usize] &
               gSaveContext.inventory.questItems != 0 {
        (*this).actionFunc =
            Some(func_80AA0D88 as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ());
        EnMa1_ChangeAnimation(this, 2 as libc::c_int);
    } else {
        (*this).actionFunc =
            Some(func_80AA0F44 as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ());
        EnMa1_ChangeAnimation(this, 2 as libc::c_int);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnMa1_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa1 = thisx as *mut EnMa1;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA0D88(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_1E8.unk_00 as libc::c_int != 0 as libc::c_int {
        if (*this).skelAnime.animation !=
               &mut gMalonChildIdleAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            EnMa1_ChangeAnimation(this, 1 as libc::c_int);
        }
    } else if (*this).skelAnime.animation !=
                  &mut gMalonChildSingAnim as *mut AnimationHeader as
                      *mut libc::c_void {
        EnMa1_ChangeAnimation(this, 3 as libc::c_int);
    }
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT15 as libc::c_int &&
           gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               & 0x10 as libc::c_int != 0 {
        Actor_Kill(&mut (*this).actor);
                  ...
                  gBitFlags[QUEST_SONG_EPONA as libc::c_int as usize] &
                      gSaveContext.inventory.questItems != 0 {
        if (*this).unk_1E8.unk_00 as libc::c_int == 2 as libc::c_int {
            (*this).actionFunc =
                Some(func_80AA0EA0 as
                         unsafe extern "C" fn(_: *mut EnMa1,
                                              _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA0EA0(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).actionFunc =
            Some(func_80AA0EFC as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_WEIRD_EGG as libc::c_int, 120.0f32, 10.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA0EFC(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA0F44(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
        ...
        if (*player).stateFlags2 & 0x1000000 as libc::c_int as libc::c_uint !=
            ...
            (*this).actor.textId = 0x2061 as libc::c_int as u16_0;
            ...
            (*this).actionFunc =
                Some(func_80AA106C as
                         unsafe extern "C" fn(_: *mut EnMa1,
                                              _: *mut GlobalContext) -> ())
        } else if (*this).actor.xzDistToPlayer <
                      30.0f32 + (*this).collider.dim.radius as f32_0 {
            (*player).stateFlags2 |= 0x800000 as libc::c_int as libc::c_uint
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA106C(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    let ref mut fresh0 =
        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                usize].head as
               *mut Player)).stateFlags2;
    *fresh0 |= 0x800000 as libc::c_int as libc::c_uint;
    if (*this).unk_1E8.unk_00 as libc::c_int == 2 as libc::c_int {
        Audio_OcaSetInstrument(2 as libc::c_int as u8_0);
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_TEACH_EPONA as libc::c_int as u16_0);
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(func_80AA10EC as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA10EC(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    let ref mut fresh1 =
        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                usize].head as
               *mut Player)).stateFlags2;
    *fresh1 |= 0x800000 as libc::c_int as libc::c_uint;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_SONG_DEMO_DONE as libc::c_int {
        func_8010BD58(globalCtx,
                      OCARINA_ACTION_PLAYBACK_EPONA as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_80AA1150 as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA1150(mut this: *mut EnMa1,
                                       mut globalCtx: *mut GlobalContext) {
    let ref mut fresh2 =
        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                usize].head as
               *mut Player)).stateFlags2;
    *fresh2 |= 0x800000 as libc::c_int as libc::c_uint;
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
        ...
        (*globalCtx).fadeTransition = 42 as libc::c_int as u8_0;
        (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8;
        (*this).actionFunc =
            Some(EnMa1_DoNothing as
                     unsafe extern "C" fn(_: *mut EnMa1,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMa1_DoNothing(mut this: *mut EnMa1,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnMa1_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa1 = thisx as *mut EnMa1;
    let mut pad: s32 = 0;
    ...
    if (*this).actionFunc !=
           Some(EnMa1_DoNothing as
                    unsafe extern "C" fn(_: *mut EnMa1, _: *mut GlobalContext)
                        -> ()) {
        func_800343CC(globalCtx, &mut (*this).actor,
                      &mut (*this).unk_1E8.unk_00,
                      (*this).collider.dim.radius as f32_0 + 30.0f32,
                      Some(EnMa1_GetText as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> u16_0),
                      Some(func_80AA0778 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> s16));
    }
    func_80AA0B74(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnMa1_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 2 as libc::c_int || limbIndex == 5 as libc::c_int {
        *dList = 0 as *mut Gfx
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnMa1_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    let mut this: *mut EnMa1 = thisx as *mut EnMa1;
    let mut vec: Vec3f = D_80AA16B8;
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut vec, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMa1_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa1 = thisx as *mut EnMa1;
    let mut camera: *mut Camera = 0 as *mut Camera;
    let mut distFromCamera: f32_0 = 0.;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ma1.c\x00" as *const u8 as *const libc::c_char,
                    1226 as libc::c_int);
    camera = (*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize];
    distFromCamera =
        Math_Vec3f_DistXZ(&mut (*this).actor.world.pos, &mut (*camera).eye);
    func_800F6268(distFromCamera, 0x2f as libc::c_int as u16_0);
    ...
    (*_g).words.w1 =
        gSegments[((sMouthTextures[(*this).mouthIndex as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sMouthTextures[(*this).mouthIndex as
                                                             usize] as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnMa1_OverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3f,
