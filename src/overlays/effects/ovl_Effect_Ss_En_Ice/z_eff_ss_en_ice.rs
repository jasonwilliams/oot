...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffIceFragment2DL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_En_Ice_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_EN_ICE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsEnIce_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnIce_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsEnIceInitParams =
        initParamsx as *mut EffectSsEnIceInitParams;
    if (*initParams).type_0 as libc::c_int == 0 as libc::c_int {
        ...
        (*this).accel = zeroVec;
        (*this).life = 10 as libc::c_int as s16;
        (*this).actor = (*initParams).actor;
        (*this).draw =
            Some(EffectSsEnIce_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsEnIce_UpdateFlying as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).regs[12 as libc::c_int as usize] =
            ((*initParams).scale * 100.0f32) as s16;
        ...
        (*this).regs[11 as libc::c_int as usize] = 1 as libc::c_int as s16;
        ...
        (*this).draw =
            Some(EffectSsEnIce_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsEnIce_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).regs[0 as libc::c_int as usize] = (*initParams).life as s16;
        (*this).regs[12 as libc::c_int as usize] =
            ((*initParams).scale * 100.0f32) as s16;
        (*this).regs[1 as libc::c_int as usize] =
            Math_Atan2S((*initParams).velocity.z, (*initParams).velocity.x);
        ...
        osSyncPrintf(b"Effect_Ss_En_Ice_ct():pid->mode_sw\xe3\x81\x8c\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc\xe3\x81\xa7\xe3\x81\x99\xe3\x80\x82\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnIce_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut pad: s32 = 0;
    let mut scale: f32_0 = 0.;
    let mut hiliteLightDir: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut gameplayFrames: u32_0 = 0;
    let mut alpha: f32_0 = 0.;
    scale =
        (*this).regs[12 as libc::c_int as usize] as libc::c_int as
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_en_ice.c\x00" as *const u8 as
                        *const libc::c_char, 235 as libc::c_int);
    if (*this).regs[11 as libc::c_int as usize] as libc::c_int !=
           0 as libc::c_int {
        alpha = ((*this).life as libc::c_int * 12 as libc::c_int) as f32_0
    } else if (*this).regs[0 as libc::c_int as usize] as libc::c_int >
                  0 as libc::c_int &&
                  ((*this).life as libc::c_int) <
                      (*this).regs[0 as libc::c_int as usize] as libc::c_int
                          >> 1 as libc::c_int {
        alpha =
            (*this).life as libc::c_int as libc::c_float * 2.0f32 /
    ...
    Matrix_RotateY((*this).regs[1 as libc::c_int as usize] as libc::c_int as
                       libc::c_float *
    ...
    hiliteLightDir.x = 89.8f32;
    hiliteLightDir.y = 0.0f32;
    hiliteLightDir.z = 89.8f32;
    func_80093D84((*globalCtx).state.gfxCtx);
    func_8002EB44(&mut (*this).pos, &mut (*globalCtx).view.eye,
                  &mut hiliteLightDir, (*globalCtx).state.gfxCtx);
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         gameplayFrames & 0xff as libc::c_int as libc::c_uint,
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gEffIceFragment2DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_en_ice.c\x00" as *const u8 as
                         *const libc::c_char, 294 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnIce_UpdateFlying(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut index: u32_0,
                                                    mut this: *mut EffectSs) {
    let mut rand: s16 = 0;
    if !(*this).actor.is_null() && (*(*this).actor).update.is_some() {
        if (*this).life as libc::c_int >= 9 as libc::c_int &&
               (*(*this).actor).colorFilterTimer as libc::c_int !=
                   0 as libc::c_int &&
               (*(*this).actor).colorFilterParams as libc::c_int &
                   0xc000 as libc::c_int == 0 {
            ...
            (*this).life += 1
        } else if (*this).life as libc::c_int == 9 as libc::c_int {
            (*this).accel.x =
                Math_SinS(Math_Vec3f_Yaw(&mut (*(*this).actor).world.pos,
                                         &mut (*this).pos)) *
                    (Rand_ZeroOne() + 1.0f32);
            (*this).accel.z =
                Math_CosS(Math_Vec3f_Yaw(&mut (*(*this).actor).world.pos,
                                         &mut (*this).pos)) *
                    (Rand_ZeroOne() + 1.0f32);
            (*this).accel.y = -1.5f32;
            (*this).velocity.y = 5.0f32
        }
    } else if (*this).life as libc::c_int >= 9 as libc::c_int {
        rand = Rand_CenteredFloat(65535.0f32) as s16;
        (*this).accel.x = Math_SinS(rand) * (Rand_ZeroOne() + 1.0f32);
        (*this).accel.z = Math_CosS(rand) * (Rand_ZeroOne() + 1.0f32);
        (*this).life = 8 as libc::c_int as s16;
        (*this).accel.y = -1.5f32;
        (*this).velocity.y = 5.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnIce_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    (*this).regs[2 as libc::c_int as usize] =
        ((*this).regs[2 as libc::c_int as usize] as libc::c_int +
             (*this).regs[3 as libc::c_int as usize] as libc::c_int) as s16;
    // rRotSpeed is not initialized so this does nothing
}
