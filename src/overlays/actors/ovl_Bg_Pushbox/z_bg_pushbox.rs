...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002DF90(dynaActor: *mut DynaPolyActor);
    #[no_mangle]
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gBlockSmallDL: [Gfx; 0];
    #[no_mangle]
    static mut gBlockSmallCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgPushbox {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgPushboxActionFunc,
}
pub type BgPushboxActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgPushbox, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Pushbox_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_PUSHBOX as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPushbox_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPushbox_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_SetupAction(mut this: *mut BgPushbox,
                                               mut actionFunc:
                                                   BgPushboxActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgPushbox = thisx as *mut BgPushbox;
    ...
    CollisionHeader_GetVirtual(&mut gBlockSmallCol as *mut CollisionHeader as
    ...
    BgPushbox_SetupAction(this,
                          Some(BgPushbox_UpdateImpl as
                                   unsafe extern "C" fn(_: *mut BgPushbox,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgPushbox = thisx as *mut BgPushbox;
...
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_UpdateImpl(mut this: *mut BgPushbox,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).dyna.actor.speedXZ += (*this).dyna.unk_150 * 0.2f32;
    (*this).dyna.actor.speedXZ =
        if (*this).dyna.actor.speedXZ < -1.0f32 {
            -1.0f32
        } else if (*this).dyna.actor.speedXZ > 1.0f32 {
            1.0f32
        } else { (*this).dyna.actor.speedXZ };
    Math_StepToF(&mut (*this).dyna.actor.speedXZ, 0.0f32, 0.2f32);
    (*this).dyna.actor.world.rot.y = (*this).dyna.unk_158;
    Actor_MoveForward(&mut (*this).dyna.actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor, 20.0f32,
                            40.0f32, 40.0f32, 0x1d as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgPushbox = thisx as *mut BgPushbox;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    func_8002DF90(&mut (*this).dyna);
}
#[no_mangle]
pub unsafe extern "C" fn BgPushbox_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_pushbox.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBlockSmallDL.as_mut_ptr() as libc::c_uint;
