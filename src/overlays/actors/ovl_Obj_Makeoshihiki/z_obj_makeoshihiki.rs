...
pub const PUSHBLOCK_HUGE_START_OFF: C2RustUnnamed_17 = 7;
pub const PUSHBLOCK_LARGE_START_OFF: C2RustUnnamed_17 = 6;
pub const PUSHBLOCK_MEDIUM_START_OFF: C2RustUnnamed_17 = 5;
pub const PUSHBLOCK_SMALL_START_OFF: C2RustUnnamed_17 = 4;
pub const PUSHBLOCK_HUGE_START_ON: C2RustUnnamed_17 = 3;
pub const PUSHBLOCK_LARGE_START_ON: C2RustUnnamed_17 = 2;
pub const PUSHBLOCK_MEDIUM_START_ON: C2RustUnnamed_17 = 1;
pub const PUSHBLOCK_SMALL_START_ON: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut Obj_Makeoshihiki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_MAKEOSHIHIKI as libc::c_int as s16,
                          ...
                          objectId:
                              OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as
                                  s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjMakeoshihiki>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMakeoshihiki_Init
                                                                          as
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMakeoshihiki_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x2C
static mut sBlocks: [BlockConfig; 2] =
    [{
         let mut init =
             BlockConfig{posVecs:
                             [{
                         ...
                         color: 0xff as libc::c_int as u8_0,
                         type_0:
                             PUSHBLOCK_LARGE_START_ON as libc::c_int as u8_0,
                         rotY: 0 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             BlockConfig{posVecs:
                         ...
                         color: 0xff as libc::c_int as u8_0,
                         type_0:
                             PUSHBLOCK_SMALL_START_ON as libc::c_int as u8_0,
                         rotY: 0 as libc::c_int as s16,};
         init
     }];
static mut sFlags: [[u32_0; 2]; 3] =
    [[0 as libc::c_int as u32_0, 0 as libc::c_int as u32_0],
     [1 as libc::c_int as u32_0, 0 as libc::c_int as u32_0],
     [0 as libc::c_int as u32_0, 1 as libc::c_int as u32_0]];
static mut sFlagSwitchFuncs:
       [Option<unsafe extern "C" fn(_: *mut GlobalContext, _: s32) -> ()>; 2]
       =
    unsafe {
        [Some(Flags_UnsetSwitch as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: s32) -> ()),
         Some(Flags_SetSwitch as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: s32) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn ObjMakeoshihiki_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut block: *mut BlockConfig =
        &mut *sBlocks.as_mut_ptr().offset(((*thisx).home.rot.z as libc::c_int
                                               & 1 as libc::c_int) as isize)
            as *mut BlockConfig;
    let mut typeIdx: s32 = 0;
    let mut spawnPos: *mut Vec3f = 0 as *mut Vec3f;
    if (*thisx).params as libc::c_int >> 6 as libc::c_int & 1 as libc::c_int
           == 0 &&
           Flags_GetSwitch(globalCtx,
                           (*thisx).params as libc::c_int &
                               0x3f as libc::c_int) != 0 {
        typeIdx = 1 as libc::c_int
    } else if (*thisx).params as libc::c_int >> 0xe as libc::c_int &
                  1 as libc::c_int == 0 &&
                  Flags_GetSwitch(globalCtx,
                                  (*thisx).params as libc::c_int >>
                                      8 as libc::c_int & 0x3f as libc::c_int)
                      != 0 {
        typeIdx = 2 as libc::c_int
    } else { typeIdx = 0 as libc::c_int }
    spawnPos =
        &mut *(*block).posVecs.as_mut_ptr().offset(typeIdx as isize) as
            *mut Vec3f;
    if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, thisx, globalCtx,
                          ACTOR_OBJ_OSHIHIKI as libc::c_int as s16,
                          (*spawnPos).x, (*spawnPos).y, (*spawnPos).z,
                          0 as libc::c_int as s16, (*block).rotY,
                          0 as libc::c_int as s16,
                          (((*block).color as libc::c_int) << 6 as libc::c_int
                               & 0xc0 as libc::c_int |
                               (*block).type_0 as libc::c_int &
                                   0xf as libc::c_int | 0xff00 as libc::c_int)
                              as s16).is_null() {
        // "Push-pull block failure"
        osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : \xe6\x8a\xbc\xe3\x81\x97\xe5\xbc\x95\xe3\x81\x8d\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_makeoshihiki.c\x00" as *const u8 as
                         *const libc::c_char, 194 as libc::c_int);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
        Actor_Kill(thisx);
        return
    }
    if (*block).unk_24[typeIdx as usize] as libc::c_int & 2 as libc::c_int !=
           0 {
        (*((*thisx).child as *mut ObjOshihiki)).cantMove =
            1 as libc::c_int as u8_0
    }
    (*thisx).shape.rot.z = 0 as libc::c_int as s16;
    (*thisx).world.rot.z = (*thisx).shape.rot.z;
    osSyncPrintf(b"(%s)(arg_data %04xF)(angleZ %d)\n\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_obj_makeoshihiki.c\x00" as *const u8 as
                     *const libc::c_char, (*thisx).params as libc::c_int,
                 (*thisx).home.rot.z as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjMakeoshihiki_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut block: *mut BlockConfig =
        &mut *sBlocks.as_mut_ptr().offset(((*thisx).home.rot.z as libc::c_int
            ...
            as *mut BlockConfig;
    let mut i: s32 = 0;
    let mut sfxCond1: s32 = 0;
    let mut sfxCond2: s32 = 0;
    let mut cond: s32 = 0;
    let mut cond2: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        if Math3D_Vec3fDistSq(&mut (*(*thisx).child).world.pos,
                              &mut *(*block).posVecs.as_mut_ptr().offset(i as
                                                                             isize))
               < 0.001f32 {
            if (*block).unk_24[i as usize] as libc::c_int & 1 as libc::c_int
                   != 0 {
                if (*thisx).params as libc::c_int >> 6 as libc::c_int &
                       1 as libc::c_int != 0 {
                    sfxCond1 = 0 as libc::c_int
                } else {
                    if Flags_GetSwitch(globalCtx,
                                       (*thisx).params as libc::c_int &
                                           0x3f as libc::c_int) != 0 {
                        cond = 1 as libc::c_int
                    } else { cond = 0 as libc::c_int }
                    sfxCond1 =
                        (sFlags[i as usize][0 as libc::c_int as usize] ^
                             cond as libc::c_uint) as s32
                }
                if (*thisx).params as libc::c_int >> 0xe as libc::c_int &
                       1 as libc::c_int != 0 {
                    sfxCond2 = 0 as libc::c_int
                } else {
                    if Flags_GetSwitch(globalCtx,
                                       (*thisx).params as libc::c_int >>
                                           8 as libc::c_int &
                                           0x3f as libc::c_int) != 0 {
                        cond2 = 1 as libc::c_int
                    } else { cond2 = 0 as libc::c_int }
                    sfxCond2 =
                        (sFlags[i as usize][1 as libc::c_int as usize] ^
                             cond2 as libc::c_uint) as s32
                }
                if sfxCond1 != 0 || sfxCond2 != 0 {
                    func_80078884(0x4807 as libc::c_int as u16_0);
                }
            }
            sFlagSwitchFuncs[sFlags[i as usize][0 as libc::c_int as usize] as
                                 usize].expect("non-null function pointer")(globalCtx,
                                                                            (*thisx).params
                                                                                ...
                                                                                0x3f
                                                                                    as
                                                                                    libc::c_int);
            sFlagSwitchFuncs[sFlags[i as usize][1 as libc::c_int as usize] as
                                 usize].expect("non-null function pointer")(globalCtx,
                                                                            (*thisx).params
                                                                                as
                                                                                libc::c_int
                                                                                ...
                                                                                0x3f
                                                                                    as
                                                                                    libc::c_int);
            if (*block).unk_24[i as usize] as libc::c_int & 2 as libc::c_int
                   != 0 {
                (*((*thisx).child as *mut ObjOshihiki)).cantMove =
                    1 as libc::c_int as u8_0
            }
