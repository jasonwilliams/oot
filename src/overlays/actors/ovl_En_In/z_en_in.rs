...
extern "C" {
    ...
    fn Text_GetFaceReaction(globalCtx: *mut GlobalContext, reactionSet: u32_0)
     -> u16_0;
    #[no_mangle]
    fn Environment_ForcePlaySequence(_: u16_0);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_in_Anim_0003B4: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_000CB0: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_001BE0: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_001CC0: AnimationHeader;
    #[no_mangle]
    static mut gIngoHeadGradient2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoEyeClosed2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoChildEraBasketDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoChildEraPitchForkDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraChestDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraHeadDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraMustacheDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightEyebrowDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftEyebrowDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightShoulderDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightArmDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightHandDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftShoulderDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftArmDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftHandDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraTorsoDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightThighDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightLegDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraRightFootDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftThighDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftLegDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoAdultEraLeftFootDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_in_Anim_013C6C: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_013D60: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_01431C: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_014CA8: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_0151C8: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_015814: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_015DF0: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_01646C: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_016B3C: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_0175D0: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_017B58: AnimationHeader;
    #[no_mangle]
    static mut object_in_Anim_018C38: AnimationHeader;
}
...
pub const INGO_LIMB_MAX: C2RustUnnamed_26 = 20;
pub const INGO_MUSTACHE_LIMB: C2RustUnnamed_26 = 19;
pub const INGO_RIGHTEYEBROW_LIMB: C2RustUnnamed_26 = 18;
pub const INGO_LEFT_EYEBROW_LIMB: C2RustUnnamed_26 = 17;
pub const INGO_HEAD_LIMB: C2RustUnnamed_26 = 16;
pub const INGO_RIGHT_HAND_LIMB: C2RustUnnamed_26 = 15;
pub const INGO_RIGHT_ARM_LIMB: C2RustUnnamed_26 = 14;
pub const INGO_RIGHT_SHOULDER_LIMB: C2RustUnnamed_26 = 13;
pub const INGO_LEFT_HAND_LIMB: C2RustUnnamed_26 = 12;
pub const INGO_LEFT_ARM_LIMB: C2RustUnnamed_26 = 11;
pub const INGO_LEFT_SHOULDER_LIMB: C2RustUnnamed_26 = 10;
pub const INGO_CHEST_LIMB: C2RustUnnamed_26 = 9;
pub const INGO_TORSO_LIMB: C2RustUnnamed_26 = 8;
pub const INGO_RIGHT_FOOT_LIMB: C2RustUnnamed_26 = 7;
pub const INGO_RIGHT_LEG_LIMB: C2RustUnnamed_26 = 6;
pub const INGO_RIGHT_THIGH_LIMB: C2RustUnnamed_26 = 5;
pub const INGO_LEFT_FOOT_LIMB: C2RustUnnamed_26 = 4;
pub const INGO_LEFT_LEG_LIMB: C2RustUnnamed_26 = 3;
pub const INGO_LEFT_THIGH_LIMB: C2RustUnnamed_26 = 2;
pub const INGO_LIMB_ROOT: C2RustUnnamed_26 = 1;
pub const INGO_LIMB_NONE: C2RustUnnamed_26 = 0;
...
pub type EnHorsePostdrawFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnHorse, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_In_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_IN as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_IN as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnIn>() as libc::c_ulong,
                          init:
...
static mut sAnimationInfo: [struct_D_80AA1678; 10] =
    unsafe {
        [{
             let mut init =
                 struct_D_80AA1678{animation:
                                       &object_in_Anim_001CC0 as
...
static mut D_80A7B918: [*mut AnimationHeader; 8] =
    unsafe {
        [&object_in_Anim_0151C8 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_015DF0 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_016B3C as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_015814 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_01646C as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_0175D0 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_017B58 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_in_Anim_018C38 as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut sAdultEraDLs: [*mut Gfx; 20] =
    unsafe {
        [0 as *const Gfx as *mut Gfx, 0 as *const Gfx as *mut Gfx,
         gIngoAdultEraLeftThighDL.as_ptr() as *mut _,
         gIngoAdultEraLeftLegDL.as_ptr() as *mut _,
         gIngoAdultEraLeftFootDL.as_ptr() as *mut _,
         gIngoAdultEraRightThighDL.as_ptr() as *mut _,
         gIngoAdultEraRightLegDL.as_ptr() as *mut _,
         gIngoAdultEraRightFootDL.as_ptr() as *mut _,
         gIngoAdultEraTorsoDL.as_ptr() as *mut _,
         gIngoAdultEraChestDL.as_ptr() as *mut _,
         gIngoAdultEraLeftShoulderDL.as_ptr() as *mut _,
         gIngoAdultEraLeftArmDL.as_ptr() as *mut _,
         gIngoAdultEraLeftHandDL.as_ptr() as *mut _,
         gIngoAdultEraRightShoulderDL.as_ptr() as *mut _,
         gIngoAdultEraRightArmDL.as_ptr() as *mut _,
         gIngoAdultEraRightHandDL.as_ptr() as *mut _,
         gIngoAdultEraHeadDL.as_ptr() as *mut _,
         gIngoAdultEraLeftEyebrowDL.as_ptr() as *mut _,
         gIngoAdultEraRightEyebrowDL.as_ptr() as *mut _,
         gIngoAdultEraMustacheDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn func_80A78FB0(mut globalCtx: *mut GlobalContext)
 -> u16_0 {
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x10 as libc::c_int != 0 {
        if gSaveContext.infTable[9 as libc::c_int as usize] as libc::c_int &
               0x80 as libc::c_int != 0 {
            return 0x2046 as libc::c_int as u16_0
        } else { return 0x2045 as libc::c_int as u16_0 }
    }
    if gSaveContext.infTable[9 as libc::c_int as usize] as libc::c_int &
           0x10 as libc::c_int != 0 {
        return 0x2040 as libc::c_int as u16_0
    } else { return 0x203f as libc::c_int as u16_0 };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79010(mut globalCtx: *mut GlobalContext)
 -> u16_0 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut temp_v0: u16_0 =
        Text_GetFaceReaction(globalCtx, 25 as libc::c_int as u32_0);
    if temp_v0 as libc::c_int != 0 as libc::c_int { return temp_v0 }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x100 as libc::c_int != 0 {
        if gSaveContext.nightFlag == 0 as libc::c_int {
            return 0x205f as libc::c_int as u16_0
        } else { return 0x2057 as libc::c_int as u16_0 }
    }
    if gSaveContext.nightFlag == 1 as libc::c_int {
        return 0x204e as libc::c_int as u16_0
    }
    match gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
              0xf as libc::c_int {
        1 => {
            if (*player).stateFlags1 & 0x800000 as libc::c_int as libc::c_uint
                   == 0 {
                return 0x2036 as libc::c_int as u16_0
            } else if gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                          libc::c_int & 0x800 as libc::c_int != 0 {
                if gSaveContext.infTable[10 as libc::c_int as usize] as
                       libc::c_int & 4 as libc::c_int != 0 {
                    return 0x2036 as libc::c_int as u16_0
                } else { return 0x2038 as libc::c_int as u16_0 }
            } else { return 0x2037 as libc::c_int as u16_0 }
        }
        3 => {
            if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int
                ...
                return 0x203e as libc::c_int as u16_0
            } else { return 0x203d as libc::c_int as u16_0 }
        }
        4 => { return 0x203a as libc::c_int as u16_0 }
        5 | 6 => { return 0x203c as libc::c_int as u16_0 }
        7 => { return 0x205b as libc::c_int as u16_0 }
        2 | _ => {
            if gSaveContext.infTable[0x9 as libc::c_int as usize] as
                   libc::c_int & 0x400 as libc::c_int != 0 {
                return 0x2031 as libc::c_int as u16_0
            } else { return 0x2030 as libc::c_int as u16_0 }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79168(mut globalCtx: *mut GlobalContext,
    ...
    } else { return func_80A79010(globalCtx) };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A791CC(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut ret: s32 = 0 as libc::c_int;
    match (*thisx).textId as libc::c_int {
        8261 => {
            gSaveContext.infTable[9 as libc::c_int as usize] =
                (gSaveContext.infTable[9 as libc::c_int as usize] as
                     libc::c_int | 0x80 as libc::c_int) as u16_0
        }
        8254 => { ret = 2 as libc::c_int }
        8255 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7924C(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut this: *mut EnIn = thisx as *mut EnIn;
    let mut sp18: s32 = 1 as libc::c_int;
    match (*this).actor.textId as libc::c_int {
        8240 | 8241 => {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   1 as libc::c_int {
                (*this).actor.textId = 0x2032 as libc::c_int as u16_0
            } else if (gSaveContext.rupees as libc::c_int) < 10 as libc::c_int
             {
                (*this).actor.textId = 0x2033 as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x2034 as libc::c_int as u16_0 }
        ...
        8244 => {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                ...
                (*this).actor.textId = 0x205c as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x2035 as libc::c_int as u16_0 }
            Message_ContinueTextbox(globalCtx, (*this).actor.textId);
        }
        8246 | 8247 => {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   1 as libc::c_int {
                sp18 = 2 as libc::c_int
            } else {
                (*this).actor.textId = 0x201f as libc::c_int as u16_0;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
            }
        }
        8248 => {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   0 as libc::c_int &&
                   gSaveContext.rupees as libc::c_int >= 50 as libc::c_int {
                sp18 = 2 as libc::c_int
            } else {
                (*this).actor.textId = 0x2039 as libc::c_int as u16_0;
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
                gSaveContext.infTable[10 as libc::c_int as usize] =
                    (gSaveContext.infTable[10 as libc::c_int as usize] as
        ...
        8283 => {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                ...
                gSaveContext.eventInf[0 as libc::c_int as usize] =
                    (gSaveContext.eventInf[0 as libc::c_int as usize] as
                         libc::c_int & !(0xf as libc::c_int)) as u16_0;
                gSaveContext.eventInf[0 as libc::c_int as usize] =
                    (gSaveContext.eventInf[0 as libc::c_int as usize] as
                ...
                (*this).actionFunc =
                    Some(func_80A7A4C8 as
                             unsafe extern "C" fn(_: *mut EnIn,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7949C(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut phi_v1: s32 = 1 as libc::c_int;
    if (*thisx).textId as libc::c_int == 0x2035 as libc::c_int {
        Rupees_ChangeBy(-(10 as libc::c_int) as s16);
        (*thisx).textId = 0x205c as libc::c_int as u16_0;
        Message_ContinueTextbox(globalCtx, (*thisx).textId);
    } else { phi_v1 = 2 as libc::c_int }
    return phi_v1 as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79500(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    let mut sp1E: s16 = 1 as libc::c_int as s16;
    osSyncPrintf(b"message_check->(%d[%x])\n\x00" as *const u8 as
                     *const libc::c_char,
                 Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int,
                 (*thisx).textId as libc::c_int);
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        2 => { sp1E = func_80A791CC(globalCtx, thisx) }
        4 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A795C8(mut this: *mut EnIn,
    ...
    if (*this).skelAnime.animation ==
           &mut object_in_Anim_0003B4 as *mut AnimationHeader as
               *mut libc::c_void ||
           (*this).skelAnime.animation ==
               &mut object_in_Anim_001BE0 as *mut AnimationHeader as
                   *mut libc::c_void ||
           (*this).skelAnime.animation ==
               &mut object_in_Anim_013D60 as *mut AnimationHeader as
                   *mut libc::c_void {
        phi_a3 = 1 as libc::c_int as s16
    } else { phi_a3 = 0 as libc::c_int as s16 }
    if (*this).actionFunc ==
           Some(func_80A7A568 as
                    unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                        -> ()) {
        phi_a3 = 4 as libc::c_int as s16
    }
    if (*this).actionFunc ==
           Some(func_80A7B024 as
                    unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                        -> ()) {
        (*this).unk_308.unk_18 = (*globalCtx).view.eye;
        (*this).unk_308.unk_14 = 60.0f32
    } else {
        (*this).unk_308.unk_18 = (*player).actor.world.pos;
        (*this).unk_308.unk_14 = 16.0f32
    }
    func_80034A14(&mut (*this).actor, &mut (*this).unk_308,
                  1 as libc::c_int as s16, phi_a3);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79690(mut skelAnime: *mut SkelAnime,
                                       mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A796EC(mut this: *mut EnIn, mut arg1: s32) {
    Animation_Change(&mut (*this).skelAnime,
                     sAnimationInfo[arg1 as usize].animation, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(sAnimationInfo[arg1 as
                                                               usize].animation
                                                as *mut libc::c_void) as
                         f32_0, sAnimationInfo[arg1 as usize].mode,
                     sAnimationInfo[arg1 as usize].transitionRate);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7975C(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actor.params as libc::c_int != 1 as libc::c_int ||
           (*this).actor.shape.rot.z as libc::c_int != 1 as libc::c_int ||
           !(gSaveContext.linkAge == 0 as libc::c_int) {
        return 0 as libc::c_int
    }
    (*this).animationIdx = 1 as libc::c_int as s16;
    (*this).collider.base.ocFlags1 =
        ((*this).collider.base.ocFlags1 as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    Animation_Change(&mut (*this).skelAnime,
                     D_80A7B918[(*this).animationIdx as usize], 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(D_80A7B918[(*this).animationIdx as
                                                           usize] as
                                                *mut libc::c_void) as f32_0,
                     2 as libc::c_int as u8_0, 0.0f32);
    (*this).actionFunc =
        Some(func_80A7A304 as
                 unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                     -> ());
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79830(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT20 as libc::c_int &&
           ...
           (*this).actor.shape.rot.z as libc::c_int == 1 as libc::c_int &&
           gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               & 0x10 as libc::c_int == 0 {
        return 1 as libc::c_int
    }
    if (*globalCtx).sceneNum as libc::c_int ==
           ...
           gSaveContext.linkAge == 1 as libc::c_int &&
           gSaveContext.nightFlag == 0 as libc::c_int &&
           (*this).actor.shape.rot.z as libc::c_int == 3 as libc::c_int &&
           gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               & 0x10 as libc::c_int != 0 {
        return 1 as libc::c_int
    }
    if (*globalCtx).sceneNum as libc::c_int ==
        ...
        if (*this).actor.shape.rot.z as libc::c_int == 2 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x10 as libc::c_int == 0 {
            return 1 as libc::c_int
        }
        if (*this).actor.shape.rot.z as libc::c_int == 4 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x10 as libc::c_int != 0 {
            return 1 as libc::c_int
        }
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT20 as libc::c_int &&
           gSaveContext.linkAge == 0 as libc::c_int &&
           gSaveContext.nightFlag == 0 as libc::c_int {
        if (*this).actor.shape.rot.z as libc::c_int == 5 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x100 as libc::c_int == 0 {
            return 2 as libc::c_int
        }
        if (*this).actor.shape.rot.z as libc::c_int == 7 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x100 as libc::c_int != 0 {
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SOUKO as libc::c_int &&
           gSaveContext.linkAge == 0 as libc::c_int &&
           gSaveContext.nightFlag == 1 as libc::c_int {
        if (*this).actor.shape.rot.z as libc::c_int == 6 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x100 as libc::c_int == 0 {
            return 3 as libc::c_int
        }
        if (*this).actor.shape.rot.z as libc::c_int == 8 as libc::c_int &&
               gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                   libc::c_int & 0x100 as libc::c_int != 0 {
            return 3 as libc::c_int
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnIn_UpdateEyes(mut this: *mut EnIn) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A79AB4(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut f: u32_0 = 0 as libc::c_int as u32_0;
    if (*this).skelAnime.animation !=
           &mut object_in_Anim_014CA8 as *mut AnimationHeader as
               *mut libc::c_void {
        f = (*globalCtx).gameplayFrames
    }
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[Vec3s; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<Vec3s>()
                                                   as libc::c_ulong) as s32 {
        (*this).unk_330[i as usize].y =
            ((2068 as libc::c_int + 50 as libc::c_int * i) as
                 libc::c_uint).wrapping_mul(f) as s16;
        (*this).unk_330[i as usize].z =
            ((2368 as libc::c_int + 50 as libc::c_int * i) as
                 libc::c_uint).wrapping_mul(f) as s16;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A79BAC(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext,
                                       mut index: s32, mut arg3: u32_0) {
    let mut entrances: [s16; 3] =
        [0x558 as libc::c_int as s16, 0x4ca as libc::c_int as s16,
         0x157 as libc::c_int as s16];
    (*globalCtx).nextEntranceIndex = entrances[index as usize];
    if index == 2 as libc::c_int {
        gSaveContext.nextCutsceneIndex = 0xfff0 as libc::c_int as u16_0
    }
    (*globalCtx).fadeTransition = arg3 as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A79C78(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    sp48.y = (*this).actor.world.pos.y + 60.0f32;
    sp48.z = (*this).actor.world.pos.z;
    sp3C.x = sp48.x;
    sp3C.y = sp48.y - 22.0f32;
    sp3C.z = sp48.z + 40.0f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).camId, &mut sp48, &mut sp3C);
    (*this).actor.shape.rot.y =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut sp3C);
    (*this).unk_308.unk_08 = zeroVec;
    (*this).unk_308.unk_0E = zeroVec;
    Message_StartTextbox(globalCtx, 0x2025 as libc::c_int as u16_0,
                         0 as *mut Actor);
    (*this).unk_308.unk_00 = 1 as libc::c_int as s16;
    (*player).actor.world.pos = (*this).actor.world.pos;
    (*player).actor.world.pos.x +=
        100.0f32 * Math_SinS((*this).actor.shape.rot.y);
    (*player).actor.world.pos.z +=
        100.0f32 * Math_CosS((*this).actor.shape.rot.y);
    if !(*player).rideActor.is_null() {
        (*(*player).rideActor).world.pos = (*player).actor.world.pos;
        (*(*player).rideActor).freezeTimer = 10 as libc::c_int as u16_0
    }
...
static mut D_80A7B998: s32 = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn EnIn_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIn = thisx as *mut EnIn;
    let mut respawn: *mut RespawnData =
        &mut *gSaveContext.respawn.as_mut_ptr().offset(RESPAWN_MODE_DOWN as
                                                           libc::c_int as
                                                           isize) as
            *mut RespawnData;
    let mut respawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).ingoObjBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_IN as libc::c_int as s16) as s8;
    if ((*this).ingoObjBankIndex as libc::c_int) < 0 as libc::c_int &&
           (*this).actor.params as libc::c_int > 0 as libc::c_int {
        (*this).actionFunc = None;
        Actor_Kill(&mut (*this).actor);
        return
    }
    respawnPos = (*respawn).pos;
    // hardcoded coords for lon lon entrance
    if D_80A7B998 == 0 as libc::c_int && respawnPos.x == 1107.0f32 &&
           respawnPos.y == 0.0f32 && respawnPos.z == -3740.0f32 {
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            0 as libc::c_int as u16_0;
        D_80A7B998 = 1 as libc::c_int
    }
    (*this).actionFunc =
        Some(func_80A79FB0 as
                 unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnIn_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIn = thisx as *mut EnIn;
    if (*this).actionFunc.is_some() &&
           (*this).actionFunc !=
               Some(func_80A79FB0 as
                        unsafe extern "C" fn(_: *mut EnIn,
                                             _: *mut GlobalContext) -> ()) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A79FB0(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp3C: s32 = 0 as libc::c_int;
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).ingoObjBankIndex as s32) != 0 ||
           (*this).actor.params as libc::c_int <= 0 as libc::c_int {
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      ...
                                                      _: *mut GlobalContext)
                                     -> ()), 36.0f32);
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gIngoSkel,
        ...
        (*this).unk_308.unk_00 = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80A7A4BC as
                     unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                         -> ());
        match func_80A79830(this, globalCtx) {
            1 => {
                func_80A796EC(this, 9 as libc::c_int);
                (*this).actionFunc =
                    Some(func_80A7A4BC as
                             unsafe extern "C" fn(_: *mut EnIn,
                                                  _: *mut GlobalContext)
            ...
            3 => {
                func_80A796EC(this, 7 as libc::c_int);
                (*this).actionFunc =
                    Some(func_80A7A4BC as
                             unsafe extern "C" fn(_: *mut EnIn,
                                                  _: *mut GlobalContext)
            ...
            4 => {
                func_80A796EC(this, 8 as libc::c_int);
                (*this).eyeIndex = 3 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_80A7A4BC as
                             unsafe extern "C" fn(_: *mut EnIn,
                                                  _: *mut GlobalContext)
            ...
            0 => { Actor_Kill(&mut (*this).actor); }
            _ => {
                match gSaveContext.eventInf[0 as libc::c_int as usize] as
                ...
                match gSaveContext.eventInf[0 as libc::c_int as usize] as
                          libc::c_int & 0xf as libc::c_int {
                    0 | 2 => {
                        func_80A796EC(this, 2 as libc::c_int);
                        (*this).actionFunc =
                            Some(func_80A7A4C8 as
                                     unsafe extern "C" fn(_: *mut EnIn,
                                                          _:
                            ...
                            Some(func_80A7A568 as
                                     unsafe extern "C" fn(_: *mut EnIn,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ());
                        func_80088B34(0x3c as libc::c_int as s16);
                    }
                    3 => {
                        func_80A796EC(this, 4 as libc::c_int);
                        (*this).actionFunc =
                            Some(func_80A7A770 as
                                     unsafe extern "C" fn(_: *mut EnIn,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ())
                    ...
                    4 => {
                        func_80A796EC(this, 6 as libc::c_int);
                        (*this).unk_1EC = 8 as libc::c_int as s16;
                        (*this).actionFunc =
                            Some(func_80A7A940 as
                                     unsafe extern "C" fn(_: *mut EnIn,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7A304(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).skelAnime.animation ==
           &mut object_in_Anim_015814 as *mut AnimationHeader as
               *mut libc::c_void ||
           (*this).skelAnime.animation ==
               &mut object_in_Anim_01646C as *mut AnimationHeader as
                   *mut libc::c_void {
        if (*this).skelAnime.curFrame == 8.0f32 {
            Audio_PlaySoundRandom(&mut (*this).actor.projectedPos,
                                  0x6856 as libc::c_int as u16_0,
                                  (0x6857 as libc::c_int -
                                       0x6856 as libc::c_int +
                                       1 as libc::c_int) as u8_0);
        }
    }
    if (*this).skelAnime.animation ==
           &mut object_in_Anim_018C38 as *mut AnimationHeader as
               *mut libc::c_void && (*this).skelAnime.curFrame == 20.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x6854 as libc::c_int as u16_0);
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        (*this).animationIdx =
            ((*this).animationIdx as libc::c_int % 8 as libc::c_int) as s16;
        (*this).unk_1E8 = (*this).animationIdx;
        if (*this).animationIdx as libc::c_int == 3 as libc::c_int ||
               (*this).animationIdx as libc::c_int == 4 as libc::c_int {
            Audio_PlaySoundGeneral(0x181e as libc::c_int as u16_0,
        ...
        Animation_Change(&mut (*this).skelAnime,
                         D_80A7B918[(*this).animationIdx as usize], 1.0f32,
                         0.0f32,
                         Animation_GetLastFrame(D_80A7B918[(*this).animationIdx
                                                               as usize] as
                                                    *mut libc::c_void) as
                             f32_0, 2 as libc::c_int as u8_0, -10.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7A4BC(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7A4C8(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        func_80A79BAC(this, globalCtx, 1 as libc::c_int,
                      0x20 as libc::c_int as u32_0);
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0xf as libc::c_int) | 0x1 as libc::c_int) as u16_0;
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0x8000 as libc::c_int) | 0x8000 as libc::c_int) as u16_0;
        gSaveContext.infTable[10 as libc::c_int as usize] =
            (gSaveContext.infTable[10 as libc::c_int as usize] as libc::c_int
                 & !(4 as libc::c_int)) as u16_0;
        Environment_ForcePlaySequence(0x40 as libc::c_int as u16_0);
        (*globalCtx).msgCtx.stateTimer = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7A568(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut phi_a2: s32 = 0;
    ...
    if gSaveContext.timer1State as libc::c_int == 10 as libc::c_int {
        Audio_PlaySoundGeneral(0x482c as libc::c_int as u16_0,
        ...
        (*this).actionFunc =
            Some(func_80A7B024 as
                     unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                         -> ());
        gSaveContext.timer1State = 0 as libc::c_int as s16
    } else if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        if (*globalCtx).msgCtx.choiceIndex as libc::c_int == 0 as libc::c_int
           {
            if (gSaveContext.rupees as libc::c_int) < 50 as libc::c_int {
            ...
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     ...
                     (*((*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                                libc::c_int as
                                                                usize].head as
                               *mut Player)).rideActor as
                            *mut EnHorse)).type_0 << 4 as libc::c_int) as
                    u16_0;
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0xf as libc::c_int) | 2 as libc::c_int)
                    as u16_0;
            phi_a2 = 2 as libc::c_int;
            phi_a3 = 2 as libc::c_int
        } else {
            Audio_PlaySoundGeneral(0x482c as libc::c_int as u16_0,
                                   &mut D_801333D4, 4 as libc::c_int as u8_0,
                                   &mut D_801333E0, &mut D_801333E0,
            ...
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0xf as libc::c_int)) as u16_0;
            phi_a2 = 0 as libc::c_int;
            phi_a3 = 0x20 as libc::c_int
        }
        func_80A79BAC(this, globalCtx, phi_a2, phi_a3 as u32_0);
        (*globalCtx).msgCtx.stateTimer = 0 as libc::c_int as u8_0;
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0x8000 as libc::c_int) | 0x8000 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7A770(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_308.unk_00 as libc::c_int == 0 as libc::c_int {
        (*this).actor.flags |=
        ...
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        func_80A796EC(this, 3 as libc::c_int);
        (*this).actionFunc =
            Some(func_80A7A848 as
                     unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                         -> ());
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0xf as libc::c_int) | 7 as libc::c_int) as u16_0;
        (*this).unk_308.unk_00 = 0 as libc::c_int as s16;
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 0xffff as libc::c_int | 0x20 as libc::c_int) as u16_0;
        if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
               0x40 as libc::c_int == 0 {
            (*globalCtx).msgCtx.stateTimer = 4 as libc::c_int as u8_0;
            (*globalCtx).msgCtx.msgMode =
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7A848(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        if (*globalCtx).msgCtx.choiceIndex as libc::c_int == 0 as libc::c_int
               && (gSaveContext.rupees as libc::c_int) < 50 as libc::c_int ||
               (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   1 as libc::c_int {
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0xf as libc::c_int)) as u16_0;
            ...
            func_80A79BAC(this, globalCtx, 2 as libc::c_int,
                          0x26 as libc::c_int as u32_0);
            gSaveContext.eventInf[0 as libc::c_int as usize] =
                (gSaveContext.eventInf[0 as libc::c_int as usize] as
                     libc::c_int & !(0xf as libc::c_int) | 2 as libc::c_int)
                    as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7A940(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_308.unk_00 as libc::c_int == 0 as libc::c_int {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
    ...
    if (*this).unk_1EC as libc::c_int != 0 as libc::c_int {
        (*this).unk_1EC -= 1;
        if (*this).unk_1EC as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x6855 as libc::c_int as u16_0);
        }
    }
    if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        (*this).actor.flags &=
        ...
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0xf as libc::c_int) | 0x2 as libc::c_int) as u16_0;
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 !(0x8000 as libc::c_int) | 0x8000 as libc::c_int) as u16_0;
        (*globalCtx).msgCtx.stateTimer = 0 as libc::c_int as u8_0;
        ...
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
                 0xffff as libc::c_int | 0x40 as libc::c_int) as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7AA40(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Gameplay_ChangeCameraStatus(globalCtx, (*this).activeCamId,
                                1 as libc::c_int as s16);
    Gameplay_ChangeCameraStatus(globalCtx, (*this).camId,
                                7 as libc::c_int as s16);
    (*this).unk_2F0 = 0.0f32;
    (*this).unk_2F4 = 50.0f32;
    (*this).unk_2F8 = 0.0f32;
    (*this).unk_2FC = 0.0f32;
    (*this).unk_300 = 50.0f32;
    (*this).unk_304 = 50.0f32;
    ...
    sp24.y += (*this).unk_300;
    sp24.z += (*this).unk_304;
    Gameplay_CameraSetAtEye(globalCtx, (*this).camId, &mut sp30, &mut sp24);
    (*this).actor.textId = 0x203b as libc::c_int as u16_0;
    Message_StartTextbox(globalCtx, (*this).actor.textId, 0 as *mut Actor);
    (*this).unk_308.unk_00 = 1 as libc::c_int as s16;
    (*this).unk_1FC = 0 as libc::c_int as s16;
    (*globalCtx).csCtx.frames = 0 as libc::c_int as u16_0;
    ShrinkWindow_SetVal(0x20 as libc::c_int);
    Interface_ChangeAlpha(2 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_80A7ABD4 as
                 unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7ABD4(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    (*player).actor.freezeTimer = 10 as libc::c_int as u16_0;
    if (*this).actor.textId as libc::c_int == 0x203b as libc::c_int {
        if (*this).unk_1EC as libc::c_int != 0 as libc::c_int {
            (*this).unk_1EC -= 1;
            if (*this).unk_1EC as libc::c_int == 0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
    ...
    if (*this).unk_308.unk_00 as libc::c_int != 0 as libc::c_int {
        if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
            if (*this).actor.textId as libc::c_int == 0x203b as libc::c_int {
                (*this).actor.textId = 0x203c as libc::c_int as u16_0;
        ...
        let fresh0 = (*globalCtx).csCtx.frames;
        (*globalCtx).csCtx.frames = (*globalCtx).csCtx.frames.wrapping_add(1);
        if fresh0 as libc::c_int >= 50 as libc::c_int {
            (*this).actionFunc =
                Some(func_80A7AE84 as
                         unsafe extern "C" fn(_: *mut EnIn,
                                              _: *mut GlobalContext) -> ());
            return
        }
        if (*globalCtx).csCtx.frames as libc::c_int == 44 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28e6 as libc::c_int as u16_0);
        }
        Math_SmoothStepToF(&mut (*this).unk_2F0, 0.0f32, 0.06f32, 10000.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).unk_2F4, 50.0f32, 0.06f32, 10000.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).unk_2F8, 0.0f32, 0.06f32, 10000.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).unk_2FC, 0.0f32, 0.06f32, 10000.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).unk_300, 150.0f32, 0.06f32,
                           10000.0f32, 0.0f32);
        Math_SmoothStepToF(&mut (*this).unk_304, 300.0f32, 0.06f32,
                           10000.0f32, 0.0f32);
        ...
        sp3C.y += (*this).unk_300;
        sp3C.z += (*this).unk_304;
        Gameplay_CameraSetAtEye(globalCtx, (*this).camId, &mut sp48,
                                &mut sp3C);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7AE84(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    Gameplay_ChangeCameraStatus(globalCtx, (*this).activeCamId,
                                7 as libc::c_int as s16);
    Gameplay_ClearCamera(globalCtx, (*this).camId);
    func_8002DF54(globalCtx, &mut (*this).actor, 7 as libc::c_int as u8_0);
    Interface_ChangeAlpha(0x32 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(func_80A7AEF0 as
                 unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7AEF0(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    pos.x += 90.0f32 * Math_SinS((*this).actor.shape.rot.y);
    pos.z += 90.0f32 * Math_CosS((*this).actor.shape.rot.y);
    yaw = Math_Vec3f_Yaw(&mut pos, &mut (*player).actor.world.pos) as s32;
    if (if yaw >= 0 as libc::c_int { yaw } else { -yaw }) >
           0x4000 as libc::c_int {
        (*globalCtx).nextEntranceIndex = 0x476 as libc::c_int as s16;
        (*globalCtx).sceneLoadFlag = 0x14 as libc::c_int as s8;
        (*globalCtx).fadeTransition = 5 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(func_80A7B018 as
                     unsafe extern "C" fn(_: *mut EnIn, _: *mut GlobalContext)
                         -> ())
    } else if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        (*globalCtx).msgCtx.stateTimer = 4 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7B018(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7B024(mut this: *mut EnIn,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).unk_308.unk_00 as libc::c_int == 2 as libc::c_int {
        ...
        func_80A79BAC(this, globalCtx, 0 as libc::c_int,
                      0x26 as libc::c_int as u32_0);
        gSaveContext.eventInf[0 as libc::c_int as usize] =
            (gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn EnIn_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actionFunc !=
        ...
        if (*this).skelAnime.animation ==
            ...
            func_80A79690(&mut (*this).skelAnime, this, globalCtx);
        }
    ...
    if (*this).actionFunc !=
        ...
        if (gSaveContext.timer2Value as libc::c_int) < 6 as libc::c_int &&
               gSaveContext.timer2State as libc::c_int != 0 as libc::c_int &&
               (*this).unk_308.unk_00 as libc::c_int == 0 as libc::c_int {
            (Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx)) != 0;
        } else {
            func_800343CC(globalCtx, &mut (*this).actor,
                          &mut (*this).unk_308.unk_00,
                          (if (*this).actor.targetMode as libc::c_int ==
                                  6 as libc::c_int {
                               80.0f32
                           } else { 320.0f32 }) +
                              (*this).collider.dim.radius as libc::c_int as
                                  libc::c_float,
                          Some(func_80A79168 as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: *mut Actor)
                                       -> u16_0),
                          Some(func_80A79500 as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: *mut Actor)
                                       -> s16));
            if (*this).unk_308.unk_00 as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnIn_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if (*this).actor.params as libc::c_int > 0 as libc::c_int &&
           limbIndex != INGO_HEAD_LIMB as libc::c_int {
        if !sAdultEraDLs[limbIndex as usize].is_null() {
            *dList = sAdultEraDLs[limbIndex as usize]
        }
    }
    if limbIndex == INGO_HEAD_LIMB as libc::c_int {
        Matrix_Translate(1500.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        sp2C = (*this).unk_308.unk_08;
        Matrix_RotateZ(sp2C.x as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX(sp2C.y as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(-1500.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    }
    if limbIndex == INGO_CHEST_LIMB as libc::c_int {
        sp2C = (*this).unk_308.unk_0E;
        Matrix_RotateX(sp2C.x as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY(sp2C.y as f32_0 / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
    }
    if limbIndex == INGO_CHEST_LIMB as libc::c_int ||
           limbIndex == INGO_LEFT_SHOULDER_LIMB as libc::c_int ||
           limbIndex == INGO_RIGHT_SHOULDER_LIMB as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*this).unk_330[limbIndex as usize].y) * 200.0f32)
                as s16;
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*this).unk_330[limbIndex as usize].z) * 200.0f32)
                as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnIn_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnIn = thisx as *mut EnIn;
    let mut D_80A7B9A8: Vec3f =
        {
            let mut init =
                Vec3f{x: 1600.0f64 as f32_0, y: 0.0f32, z: 0.0f32,};
            init
        };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_in.c\x00" as *const u8 as *const libc::c_char,
                    2335 as libc::c_int);
    if limbIndex == INGO_HEAD_LIMB as libc::c_int {
        Matrix_MultVec3f(&mut D_80A7B9A8, &mut (*this).actor.focus.pos);
        (*this).actor.focus.rot = (*this).actor.world.rot
    }
    if limbIndex == INGO_LEFT_HAND_LIMB as libc::c_int &&
           (*this).skelAnime.animation ==
               &mut object_in_Anim_014CA8 as *mut AnimationHeader as
                   *mut libc::c_void {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g).words.w1 = gIngoChildEraBasketDL.as_mut_ptr() as libc::c_uint
    }
    if limbIndex == INGO_RIGHT_HAND_LIMB as libc::c_int &&
           (*this).skelAnime.animation ==
               &mut object_in_Anim_014CA8 as *mut AnimationHeader as
                   *mut libc::c_void {
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gIngoChildEraPitchForkDL.as_mut_ptr() as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnIn_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 4] =
        unsafe {
            [gIngoEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gIngoEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gIngoEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void,
             gIngoEyeClosed2Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnIn = thisx as *mut EnIn;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((gIngoHeadGradient2Tex.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gIngoHeadGradient2Tex.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
