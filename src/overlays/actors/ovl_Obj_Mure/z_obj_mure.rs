...
pub struct ObjMure {
    pub actor: Actor,
    pub actionFunc: ObjMureActionFunc,
    pub chNum: s16,
    pub ptn: s16,
    pub svNum: s16,
    pub type_0: s16,
    pub children: [*mut Actor; 15],
    pub childrenStates: [u8_0; 15],
    pub unk_1A4: s16,
    pub unk_1A6: s16,
    pub unk_1A8: s16,
}
pub type ObjMureActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
               -> ()>;
pub const OBJMURE_CHILD_STATE_1: C2RustUnnamed_19 = 1;
pub const OBJMURE_CHILD_STATE_0: C2RustUnnamed_19 = 0;
pub const OBJMURE_CHILD_STATE_2: C2RustUnnamed_19 = 2;
pub const OBJMURE_TYPE_BUTTERFLY: C2RustUnnamed_18 = 4;
pub const OBJMURE_TYPE_BUGS: C2RustUnnamed_18 = 3;
pub const OBJMURE_TYPE_FISH: C2RustUnnamed_18 = 2;
pub type C2RustUnnamed_18 = libc::c_uint;
pub const OBJMURE_TYPE_UNDEFINED: C2RustUnnamed_18 = 1;
pub const OBJMURE_TYPE_GRASS: C2RustUnnamed_18 = 0;
pub type C2RustUnnamed_19 = libc::c_uint;
#[no_mangle]
pub static mut Obj_Mure_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_MURE as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMure_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sZClip: [f32_0; 5] =
    [1600.0f32, 1600.0f32, 1000.0f32, 1000.0f32, 1000.0f32];
static mut sMaxChildSpawns: [s32; 4] =
    [12 as libc::c_int, 9 as libc::c_int, 8 as libc::c_int, 0 as libc::c_int];
static mut sSpawnActorIds: [s16; 5] =
    [ACTOR_EN_KUSA as libc::c_int as s16, 0 as libc::c_int as s16,
     ACTOR_EN_FISH as libc::c_int as s16,
     ACTOR_EN_INSECT as libc::c_int as s16,
     ACTOR_EN_BUTTE as libc::c_int as s16];
static mut sSpawnParams: [s16; 5] =
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SetCullingImpl(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
    let mut this: *mut ObjMure = thisx as *mut ObjMure;
    ...
    match (*this).type_0 as libc::c_int {
        ...
        _ => {
            ...
            osSyncPrintf(b"Error : \xe3\x82\xab\xe3\x83\xaa\xe3\x83\xb3\xe3\x82\xb0\xe3\x81\xae\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x8c\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SetCulling(mut thisx: *mut Actor,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    if ObjMure_SetCullingImpl(thisx, globalCtx) == 0 {
        return 0 as libc::c_int
    }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjMure = thisx as *mut ObjMure;
    (*this).chNum =
    ...
    (*this).svNum =
        ((*thisx).params as libc::c_int >> 5 as libc::c_int &
             0x3 as libc::c_int) as s16;
    (*this).type_0 =
        ((*thisx).params as libc::c_int & 0x1f as libc::c_int) as s16;
    if (*this).ptn as libc::c_int >= 4 as libc::c_int {
        osSyncPrintf(b"Error \xe7\xbe\xa4\xe3\x82\x8c\xe3\x81\xaa\xe6\x95\xb5 (%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_mure.c\x00" as *const u8 as
        ...
        if (*this).type_0 as libc::c_int >= 5 as libc::c_int {
            osSyncPrintf(b"Error \xe7\xbe\xa4\xe3\x82\x8c\xe3\x81\xaa\xe6\x95\xb5 (%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure.c\x00" as *const u8 as
                             *const libc::c_char, 245 as libc::c_int,
                         (*thisx).params as libc::c_int);
            Actor_Kill(&mut (*this).actor);
            return
        } else {
            if ObjMure_SetCulling(thisx, globalCtx) == 0 {
                Actor_Kill(&mut (*this).actor);
                return
            }
        }
    ...
    (*this).actionFunc =
        Some(ObjMure_InitialAction as
                 unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
                     -> ());
    osSyncPrintf(b"\xe7\xbe\xa4\xe3\x82\x8c\xe3\x81\xaa\xe6\x95\xb5 (arg_data 0x%04x)(chNum(%d) ptn(%d) svNum(%d) type(%d))\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*thisx).params as libc::c_int, (*this).chNum as libc::c_int,
                 (*this).ptn as libc::c_int, (*this).svNum as libc::c_int,
                 (*this).type_0 as libc::c_int);
    if ObjMure_GetMaxChildSpawns(this) <= 0 as libc::c_int {
        osSyncPrintf(b"Warning : \xe5\x80\x8b\xe4\xbd\x93\xe6\x95\xb0\xe3\x81\x8c\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_mure.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_GetMaxChildSpawns(mut this: *mut ObjMure)
 -> s32 {
    if (*this).chNum as libc::c_int == 0 as libc::c_int {
        return sMaxChildSpawns[(*this).ptn as usize]
    }
    return (*this).chNum as s32;
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_GetSpawnPos(mut outPos: *mut Vec3f,
                                             mut inPos: *mut Vec3f,
                                             mut ptn: s32, mut idx: s32) {
    if ptn >= 4 as libc::c_int {
        osSyncPrintf(b"\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\xaa\xe3\x81\xae (%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_obj_mure.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SpawnActors0(mut this: *mut ObjMure,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut ac: *mut ActorContext = 0 as *mut ActorContext;
    let mut i: s32 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: s32 = 0;
    let mut maxChildren: s32 = ObjMure_GetMaxChildSpawns(this);
    i = 0 as libc::c_int;
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            // "Error: I already have a child(%s %d)(arg_data 0x%04x)"
            osSyncPrintf(b"Error : \xe6\x97\xa2\xe3\x81\xab\xe5\xad\x90\xe4\xbe\x9b\xe3\x81\x8c\xe3\x81\x84\xe3\x82\x8b(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure.c\x00" as *const u8 as
                             *const libc::c_char, 333 as libc::c_int,
                         (*this).actor.params as libc::c_int); // fake match
        }
        match (*this).childrenStates[i as usize] as libc::c_int {
            1 => { }
            2 => {
                ac = &mut (*globalCtx).actorCtx;
                ObjMure_GetSpawnPos(&mut pos, &mut (*this).actor.world.pos,
                                    (*this).ptn as s32, i);
                (*this).children[i as usize] =
                    Actor_Spawn(ac, globalCtx,
                                sSpawnActorIds[(*this).type_0 as usize],
                                pos.x, pos.y, pos.z,
                                (*this).actor.world.rot.x,
                                (*this).actor.world.rot.y,
                                (*this).actor.world.rot.z,
                                sSpawnParams[(*this).type_0 as usize]);
                if !(*this).children[i as usize].is_null() {
                    (*(*this).children[i as usize]).flags |=
                        ((1 as libc::c_int) << 11 as libc::c_int) as
                            libc::c_uint;
                    (*(*this).children[i as usize]).room = (*this).actor.room
                } else {
                    osSyncPrintf(b"warning \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                                     as *const u8 as *const libc::c_char,
                                 b"../z_obj_mure.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SpawnActors1(mut this: *mut ObjMure,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut ac: *mut ActorContext = globalCtx as *mut ActorContext;
    ...
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            osSyncPrintf(b"Error : \xe6\x97\xa2\xe3\x81\xab\xe5\xad\x90\xe4\xbe\x9b\xe3\x81\x8c\xe3\x81\x84\xe3\x82\x8b(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure.c\x00" as *const u8 as
                             *const libc::c_char, 407 as libc::c_int,
                         (*actor).params as libc::c_int);
        }
        ac = &mut (*globalCtx).actorCtx;
        ObjMure_GetSpawnPos(&mut spawnPos, &mut (*actor).world.pos,
                            (*this).ptn as s32, i);
        (*this).children[i as usize] =
            Actor_Spawn(ac, globalCtx,
                        sSpawnActorIds[(*this).type_0 as usize], spawnPos.x,
                        spawnPos.y, spawnPos.z, (*actor).world.rot.x,
                        (*actor).world.rot.y, (*actor).world.rot.z,
                        if (*this).type_0 as libc::c_int == 4 as libc::c_int
                               && i == 0 as libc::c_int {
                            1 as libc::c_int
                        } else {
                            sSpawnParams[(*this).type_0 as usize] as
                                libc::c_int
                        } as s16);
        if !(*this).children[i as usize].is_null() {
            (*this).childrenStates[i as usize] =
                OBJMURE_CHILD_STATE_0 as libc::c_int as u8_0;
            (*(*this).children[i as usize]).room = (*actor).room
        } else {
            (*this).childrenStates[i as usize] =
                OBJMURE_CHILD_STATE_1 as libc::c_int as u8_0;
            osSyncPrintf(b"warning \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure.c\x00" as *const u8 as
                             *const libc::c_char, 438 as libc::c_int);
        }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SpawnActors(mut this: *mut ObjMure,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    match (*this).svNum as libc::c_int {
        0 => { ObjMure_SpawnActors0(this, globalCtx); }
        1 => { ObjMure_SpawnActors1(this, globalCtx); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_KillActorsImpl(mut this: *mut ObjMure,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut maxChildren: s32 = ObjMure_GetMaxChildSpawns(this);
    let mut i: s32 = 0;
    ...
    while i < maxChildren {
        match (*this).childrenStates[i as usize] as libc::c_int {
            1 => { (*this).children[i as usize] = 0 as *mut Actor }
            2 => {
                if !(*this).children[i as usize].is_null() {
                    Actor_Kill((*this).children[i as usize]);
                    (*this).children[i as usize] = 0 as *mut Actor
                }
            }
            _ => {
                if !(*this).children[i as usize].is_null() {
                    if Actor_HasParent((*this).children[i as usize],
                                       globalCtx) != 0 {
                        (*this).children[i as usize] = 0 as *mut Actor
                    } else {
                        Actor_Kill((*this).children[i as usize]);
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_KillActors(mut this: *mut ObjMure,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ObjMure_KillActorsImpl(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_CheckChildren(mut this: *mut ObjMure,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut maxChildren: s32 = ObjMure_GetMaxChildSpawns(this);
    let mut i: s32 = 0;
    ...
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            if (*this).childrenStates[i as usize] as libc::c_int ==
                   OBJMURE_CHILD_STATE_0 as libc::c_int {
                if (*(*this).children[i as usize]).update.is_some() {
                    if (*(*this).children[i as usize]).flags &
                           ((1 as libc::c_int) << 11 as libc::c_int) as
                               libc::c_uint != 0 {
                        (*this).childrenStates[i as usize] =
                            OBJMURE_CHILD_STATE_2 as libc::c_int as u8_0
                    }
                } else {
                    (*this).childrenStates[i as usize] =
                        OBJMURE_CHILD_STATE_1 as libc::c_int as u8_0;
            ...
            } else if (*this).childrenStates[i as usize] as libc::c_int ==
                          OBJMURE_CHILD_STATE_2 as libc::c_int &&
                          (*(*this).children[i as usize]).update.is_none() {
                (*this).childrenStates[i as usize] =
                    OBJMURE_CHILD_STATE_1 as libc::c_int as u8_0;
                (*this).children[i as usize] = 0 as *mut Actor
            }
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_InitialAction(mut this: *mut ObjMure,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*this).actionFunc =
        Some(ObjMure_CulledState as
                 unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_CulledState(mut this: *mut ObjMure,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if fabsf((*this).actor.projectedPos.z) < sZClip[(*this).type_0 as usize] {
        (*this).actionFunc =
            Some(ObjMure_ActiveState as
                     unsafe extern "C" fn(_: *mut ObjMure,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SetFollowTargets(mut this: *mut ObjMure,
                                                  mut randMax: f32_0) {
    let mut index: s32 = 0;
    let mut maxChildren: s32 = ObjMure_GetMaxChildSpawns(this);
    let mut i: s32 = 0;
    ...
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            (*(*this).children[i as usize]).child = 0 as *mut Actor;
            if Rand_ZeroOne() <= randMax {
                index =
                    (Rand_ZeroOne() * (maxChildren as libc::c_float - 0.5f32))
                        as s32;
                if i != index {
                    (*(*this).children[i as usize]).child =
                        (*this).children[index as usize]
                }
            }
        }
        i += 1
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ObjMure_SetChildToFollowPlayer(mut this:
                                                            *mut ObjMure,
                                                        mut idx1: s32) {
    let mut maxChildren: s32 = ObjMure_GetMaxChildSpawns(this);
    let mut i: s32 = 0;
    ...
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            if i2 < idx1 {
                ...
                while j < maxChildren {
                    if i != j &&
                           (*(*this).children[j as usize]).child ==
                               (*this).children[i as usize] {
                        (*(*this).children[j as usize]).child =
                            0 as *mut Actor
                    }
            ...
            } else if (*(*this).children[i as usize]).child ==
                          (*this).children[i as usize] {
                (*(*this).children[i as usize]).child = 0 as *mut Actor
            }
        }
...
// Fish, Bugs
#[no_mangle]
pub unsafe extern "C" fn ObjMure_GroupBehavior0(mut this: *mut ObjMure,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).unk_1A4 as libc::c_int <= 0 as libc::c_int {
        if (*this).unk_1A6 != 0 {
            (*this).unk_1A6 = 0 as libc::c_int as s16;
            ObjMure_SetFollowTargets(this, Rand_ZeroOne() * 0.5f32 + 0.1f32);
            if (*this).actor.xzDistToPlayer < 60.0f32 {
                (*this).unk_1A4 =
                    ((Rand_ZeroOne() * 5.5f32) as s16 as libc::c_int +
                         4 as libc::c_int) as s16
            } else {
                (*this).unk_1A4 =
                    ((Rand_ZeroOne() * 40.5f32) as s16 as libc::c_int +
                         4 as libc::c_int) as s16
            }
        } else {
            (*this).unk_1A6 = 1 as libc::c_int as s16;
            if (*this).actor.xzDistToPlayer < 60.0f32 {
                (*this).unk_1A4 =
                    ((Rand_ZeroOne() * 10.5f32) as s16 as libc::c_int +
                         4 as libc::c_int) as s16;
                ObjMure_SetFollowTargets(this,
                                         Rand_ZeroOne() * 0.2f32 + 0.8f32);
            } else {
                (*this).unk_1A4 =
                    ((Rand_ZeroOne() * 10.5f32) as s16 as libc::c_int +
                         4 as libc::c_int) as s16;
                ObjMure_SetFollowTargets(this,
                                         Rand_ZeroOne() * 0.2f32 + 0.6f32);
            }
        }
    }
    if (*this).actor.xzDistToPlayer < 120.0f32 {
        (*this).unk_1A8 += 1
    } else { (*this).unk_1A8 = 0 as libc::c_int as s16 }
    if (*this).unk_1A8 as libc::c_int >= 80 as libc::c_int {
        ObjMure_SetChildToFollowPlayer(this, 1 as libc::c_int);
    } else { ObjMure_SetChildToFollowPlayer(this, 0 as libc::c_int); };
}
// Butterflies
#[no_mangle]
pub unsafe extern "C" fn ObjMure_GroupBehavior1(mut this: *mut ObjMure,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut maxChildren: s32 = 0;
    let mut i: s32 = 0;
    if (*this).unk_1A4 as libc::c_int <= 0 as libc::c_int {
        if (*this).unk_1A6 != 0 {
            (*this).unk_1A6 = 0 as libc::c_int as s16;
            ObjMure_SetFollowTargets(this, Rand_ZeroOne() * 0.2f32);
            if (*this).actor.xzDistToPlayer < 60.0f32 {
                (*this).unk_1A4 =
                    ((Rand_ZeroOne() * 5.5f32) as s16 as libc::c_int +
                         4 as libc::c_int) as s16
            ...
            (*this).unk_1A6 = 1 as libc::c_int as s16;
            ObjMure_SetFollowTargets(this, Rand_ZeroOne() * 0.7f32);
            (*this).unk_1A4 =
                ((Rand_ZeroOne() * 10.5f32) as s16 as libc::c_int +
                     4 as libc::c_int) as s16
        }
    ...
    while i < maxChildren {
        if !(*this).children[i as usize].is_null() {
            if !(*(*this).children[i as usize]).child.is_null() &&
                   (*(*(*this).children[i as usize]).child).update.is_none() {
                (*(*this).children[i as usize]).child = 0 as *mut Actor
            }
        }
        i += 1
...
static mut sTypeGroupBehaviorFunc: [ObjMureActionFunc; 5] =
    unsafe {
        [None, None,
         Some(ObjMure_GroupBehavior0 as
                  unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
                      -> ()),
         Some(ObjMure_GroupBehavior0 as
                  unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
                      -> ()),
         Some(ObjMure_GroupBehavior1 as
                  unsafe extern "C" fn(_: *mut ObjMure, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn ObjMure_ActiveState(mut this: *mut ObjMure,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ObjMure_CheckChildren(this, globalCtx);
    if sZClip[(*this).type_0 as usize] + 40.0f32 <=
           fabsf((*this).actor.projectedPos.z) {
        (*this).actionFunc =
            Some(ObjMure_CulledState as
                     unsafe extern "C" fn(_: *mut ObjMure,
                                          _: *mut GlobalContext) -> ());
    ...
    } else if sTypeGroupBehaviorFunc[(*this).type_0 as usize].is_some() {
        sTypeGroupBehaviorFunc[(*this).type_0 as
                                   usize].expect("non-null function pointer")(this,
                                                                              globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjMure = thisx as *mut ObjMure;
    if (*this).unk_1A4 as libc::c_int > 0 as libc::c_int {
        (*this).unk_1A4 -= 1
