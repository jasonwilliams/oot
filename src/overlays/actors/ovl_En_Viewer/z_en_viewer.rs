...
extern "C" {
    ...
    fn Animation_MorphToLoop(skelAnime: *mut SkelAnime,
                             ...
                             morphFrames: f32_0);
    #[no_mangle]
    fn Animation_PlayLoopSetSpeed(skelAnime: *mut SkelAnime,
                                  animation: *mut AnimationHeader,
                                  playSpeed: f32_0);
    #[no_mangle]
    fn func_800A6330(actor: *mut Actor, globalCtx: *mut GlobalContext,
                     skin: *mut PSkinAwb, callback: SkinCallback, arg4: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gChildZeldaCutsceneDressDL: [Gfx; 0];
    #[no_mangle]
    static mut gChildZeldaOcarinaOfTimeDL: [Gfx; 0];
    #[no_mangle]
    static mut gChildZeldaSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gEffFire1DL: [Gfx; 0];
    #[no_mangle]
    static mut gHorseZeldaSkel: SkeletonHeader;
    #[no_mangle]
    static mut gHorseZeldaGallopingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonGallopingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonRearingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonSkel: SkeletonHeader;
    #[no_mangle]
    static mut gImpaEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gImpaHeadMaskedDL: [Gfx; 0];
    #[no_mangle]
    static mut gImpaSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_gndd_Anim_0005B4: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_0008A0: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_000BC8: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_000F54: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_0014F4: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_001D28: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_002928: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_003284: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_003428: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_003D84: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_004260: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_004534: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_0048B0: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_Anim_0050A8: AnimationHeader;
    #[no_mangle]
    static mut object_gndd_DL_00E1A8: [Gfx; 0];
    #[no_mangle]
    static mut object_gndd_Tex_00F178: [u64_0; 0];
    #[no_mangle]
    static mut object_gndd_Tex_00F378: [u64_0; 0];
    #[no_mangle]
    static mut object_gndd_Tex_00F578: [u64_0; 0];
    #[no_mangle]
    static mut object_gndd_Tex_00F778: [u64_0; 0];
    #[no_mangle]
    static mut object_gndd_Skel_0119E8: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_ganon_Tex_00A4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_ganon_DL_00BE90: [Gfx; 0];
    #[no_mangle]
    static mut object_ganon_Anim_011348: AnimationHeader;
    #[no_mangle]
    static mut gDorfSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_000450: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_001410: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_002574: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_0029CC: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_00420C: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_0048FC: AnimationHeader;
    #[no_mangle]
    static mut object_opening_demo1_Anim_00504C: AnimationHeader;
}
...
pub const SEQ_PLAYER_BGM_SUB: C2RustUnnamed_19 = 3;
pub const SEQ_PLAYER_SFX: C2RustUnnamed_19 = 2;
pub const SEQ_PLAYER_FANFARE: C2RustUnnamed_19 = 1;
pub const SEQ_PLAYER_BGM_MAIN: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
...
pub const MTXMODE_APPLY: C2RustUnnamed_21 = 1;
pub const MTXMODE_NEW: C2RustUnnamed_21 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnViewer {
    pub actor: Actor,
    pub skin: PSkinAwb,
    pub animObjBankIndex: s8,
    pub drawFuncIndex: u8_0,
    pub actionFunc: EnViewerActionFunc,
    pub unused: u8_0,
    pub state: u8_0,
    pub isVisible: u8_0,
    pub fireEffects: [EnViewerFireEffect; 20],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnViewerFireEffect {
    pub startPos: Vec3f,
    pub endPos: Vec3f,
    pub pos: Vec3f,
    pub lerpFactorSpeed: f32_0,
    pub scale: f32_0,
    pub lerpFactor: f32_0,
    pub state: u8_0,
}
pub type EnViewerActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnViewer, _: *mut GlobalContext)
               -> ()>;
pub type EnViewerDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnViewer, _: *mut GlobalContext)
               -> ()>;
pub type EnViewerInitAnimFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnViewer, _: *mut GlobalContext,
                                _: *mut libc::c_void, _: *mut AnimationHeader)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const ENVIEWER_TYPE_9_GANONDORF: C2RustUnnamed_22 = 9;
pub const ENVIEWER_TYPE_8_GANONDORF: C2RustUnnamed_22 = 8;
pub const ENVIEWER_TYPE_7_GANONDORF: C2RustUnnamed_22 = 7;
pub const ENVIEWER_TYPE_6_HORSE_GANONDORF: C2RustUnnamed_22 = 6;
pub const ENVIEWER_TYPE_5_GANONDORF: C2RustUnnamed_22 = 5;
pub const ENVIEWER_TYPE_4_HORSE_GANONDORF: C2RustUnnamed_22 = 4;
pub const ENVIEWER_TYPE_3_GANONDORF: C2RustUnnamed_22 = 3;
pub const ENVIEWER_TYPE_2_ZELDA: C2RustUnnamed_22 = 2;
pub const ENVIEWER_TYPE_1_IMPA: C2RustUnnamed_22 = 1;
pub const ENVIEWER_TYPE_0_HORSE_ZELDA: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const ENVIEWER_DRAW_IMPA: C2RustUnnamed_23 = 3;
pub const ENVIEWER_DRAW_ZELDA: C2RustUnnamed_23 = 2;
pub const ENVIEWER_DRAW_HORSE: C2RustUnnamed_23 = 1;
pub const ENVIEWER_DRAW_GANONDORF: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const ENVIEWER_SHADOW_HORSE: C2RustUnnamed_24 = 2;
pub const ENVIEWER_SHADOW_CIRCLE: C2RustUnnamed_24 = 1;
pub const ENVIEWER_SHADOW_NONE: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnViewerInitData {
    pub skeletonObject: s16,
    pub animObject: s16,
    pub scale: u8_0,
    pub yOffset: s8,
    pub shadowType: u8_0,
    pub shadowScale: u8_0,
    pub drawType: u8_0,
    pub skeletonHeaderSeg: *mut libc::c_void,
...
static mut sHorseSfxPlayed: u8_0 = 0 as libc::c_int as u8_0;
#[no_mangle]
pub static mut En_Viewer_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_VIEWER as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnViewer_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnViewer_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sInitData: [EnViewerInitData; 10] =
    unsafe {
        [{
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_HORSE_ZELDA as libc::c_int as
                                          s16,
                                  animObject:
                                      OBJECT_HORSE_ZELDA as libc::c_int as
                                          s16,
                                  scale: 1 as libc::c_int as u8_0,
                                  yOffset: 0 as libc::c_int as s8,
                                  shadowType:
                                      ENVIEWER_SHADOW_HORSE as libc::c_int as
                                          u8_0,
                                  shadowScale: 20 as libc::c_int as u8_0,
                                  drawType:
                                      ENVIEWER_DRAW_HORSE as libc::c_int as
                                          u8_0,
                                  skeletonHeaderSeg:
                                      &gHorseZeldaSkel as
                                          *const SkeletonHeader as
                                          *mut SkeletonHeader as
                                          *mut libc::c_void,
                                  anim:
                                      &gHorseZeldaGallopingAnim as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,}; // has no effect, speed/velocity and gravity are 0
             init
         },
         {
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_IM as libc::c_int as s16,
                                  animObject:
                                      OBJECT_OPENING_DEMO1 as libc::c_int as
                                          s16,
                                  scale: 1 as libc::c_int as u8_0,
                                  yOffset: 0 as libc::c_int as s8,
                                  shadowType:
                                      ENVIEWER_SHADOW_NONE as libc::c_int as
                                          u8_0,
                                  shadowScale: 10 as libc::c_int as u8_0,
                                  drawType:
                                      ENVIEWER_DRAW_IMPA as libc::c_int as
                                          u8_0,
                                  skeletonHeaderSeg:
                                      &gImpaSkel as *const FlexSkeletonHeader
                                          as *mut FlexSkeletonHeader as
                                          *mut libc::c_void,
                                  anim:
                                      &object_opening_demo1_Anim_0029CC as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,};
             init
         },
         {
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_ZL4 as libc::c_int as s16,
                                  animObject:
                                      OBJECT_OPENING_DEMO1 as libc::c_int as
                                          s16,
                                  scale: 1 as libc::c_int as u8_0,
                                  ...
                                  shadowScale: 10 as libc::c_int as u8_0,
                                  drawType:
                                      ENVIEWER_DRAW_ZELDA as libc::c_int as
                                          u8_0,
                                  skeletonHeaderSeg:
                                      &gChildZeldaSkel as
                                          *const FlexSkeletonHeader as
                                          *mut FlexSkeletonHeader as
                                          *mut libc::c_void,
                                  anim:
                                      &object_opening_demo1_Anim_000450 as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,};
             init
         },
         {
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_GNDD as libc::c_int as s16,
                                  animObject:
                                      OBJECT_GNDD as libc::c_int as s16,
                                  scale: 1 as libc::c_int as u8_0,
                                  yOffset: -(6 as libc::c_int) as s8,
                                  shadowType:
                                      ENVIEWER_SHADOW_NONE as libc::c_int as
                                          u8_0,
                                  shadowScale: 10 as libc::c_int as u8_0,
                                  drawType:
                                      ENVIEWER_DRAW_GANONDORF as libc::c_int
                                          as u8_0,
                                  skeletonHeaderSeg:
                                      &object_gndd_Skel_0119E8 as
                                          *const FlexSkeletonHeader as
                                          *mut FlexSkeletonHeader as
                                          *mut libc::c_void,
                                  anim:
                                      &object_gndd_Anim_002928 as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,};
             init
         },
         {
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_HORSE_GANON as libc::c_int as
                                          s16,
                                  animObject:
                                      OBJECT_HORSE_GANON as libc::c_int as
                                          s16,
         ...
         },
         {
             let mut init =
                 EnViewerInitData{skeletonObject:
                                      OBJECT_GANON as libc::c_int as s16,
                                  animObject:
                                      OBJECT_GANON as libc::c_int as s16,
                                  scale: 1 as libc::c_int as u8_0,
                                  yOffset: -(6 as libc::c_int) as s8,
                                  ...
                                  drawType:
                                      ENVIEWER_DRAW_GANONDORF as libc::c_int
                                          as u8_0,
                                  skeletonHeaderSeg:
                                      &gDorfSkel as *const FlexSkeletonHeader
                                          as *mut FlexSkeletonHeader as
                                          *mut libc::c_void,
                                  anim:
                                      &object_ganon_Anim_011348 as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,};
             init
         }]
    };
static mut sGanondorfCape: *mut EnGanonMant =
    0 as *const EnGanonMant as *mut EnGanonMant;
static mut sGanondorfNeckWorldPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
#[no_mangle]
pub unsafe extern "C" fn EnViewer_SetupAction(mut this: *mut EnViewer,
                                              mut actionFunc:
                                                  EnViewerActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnViewer = thisx as *mut EnViewer;
    let mut type_0: u8_0 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    EnViewer_SetupAction(this,
                         Some(EnViewer_InitImpl as
                                  unsafe extern "C" fn(_: *mut EnViewer,
                                                       _: *mut GlobalContext)
                                      -> ()));
    sHorseSfxPlayed = 0 as libc::c_int as u8_0;
    type_0 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as u8_0;
    (*this).unused = 0 as libc::c_int as u8_0;
    (*this).state = 0 as libc::c_int as u8_0;
    (*this).isVisible = 0 as libc::c_int as u8_0;
    if type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
           type_0 as libc::c_int == ENVIEWER_TYPE_5_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_7_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_8_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_9_GANONDORF as libc::c_int {
        sGanondorfCape =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               ...
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               35 as libc::c_int as s16) as *mut EnGanonMant
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnViewer = thisx as *mut EnViewer;
    func_800A6888(globalCtx, &mut (*this).skin);
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_InitAnimGanondorfOrZelda(mut this:
                                                               *mut EnViewer,
                                                           mut globalCtx:
                                                               *mut GlobalContext,
                                                           ...
                                                           mut anim:
                                                               *mut AnimationHeader) {
    let mut type_0: s16 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as s16;
    if type_0 as libc::c_int == ENVIEWER_TYPE_2_ZELDA as libc::c_int ||
           type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_5_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_7_GANONDORF as libc::c_int
           ...
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_9_GANONDORF as libc::c_int {
        SkelAnime_InitFlex(globalCtx, &mut (*this).skin.skelAnime,
                           skeletonHeaderSeg as *mut FlexSkeletonHeader,
                           0 as *mut AnimationHeader, 0 as *mut Vec3s,
                           0 as *mut Vec3s, 0 as libc::c_int);
    } else {
        SkelAnime_Init(globalCtx, &mut (*this).skin.skelAnime,
                       skeletonHeaderSeg as *mut SkeletonHeader,
                       0 as *mut AnimationHeader, 0 as *mut Vec3s,
                       0 as *mut Vec3s, 0 as libc::c_int);
    }
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).animObjBankIndex as
                                           usize].segment as
    ...
    if type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
           ...
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_9_GANONDORF as libc::c_int {
        Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime, anim, 1.0f32);
    } else {
        Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime, anim, 3.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_InitAnimImpa(mut this: *mut EnViewer,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut skeletonHeaderSeg:
                                                   *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_InitAnimHorse(mut this: *mut EnViewer,
                                                mut globalCtx:
                                                    *mut GlobalContext,
                                                mut skeletonHeaderSeg:
                                                    *mut libc::c_void,
    ...
    func_800A663C(globalCtx, &mut (*this).skin,
                  skeletonHeaderSeg as *mut SkeletonHeader, anim);
    type_0 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as u8_0;
    if !(type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
             type_0 as libc::c_int ==
                 ENVIEWER_TYPE_4_HORSE_GANONDORF as libc::c_int ||
             type_0 as libc::c_int == ENVIEWER_TYPE_7_GANONDORF as libc::c_int
             ||
             type_0 as libc::c_int == ENVIEWER_TYPE_8_GANONDORF as libc::c_int
             ||
             type_0 as libc::c_int ==
                 ENVIEWER_TYPE_9_GANONDORF as libc::c_int) {
        Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime, anim, 3.0f32);
    } else {
        Animation_PlayOnceSetSpeed(&mut (*this).skin.skelAnime, anim, 1.0f32);
    };
}
static mut sInitAnimFuncs: [EnViewerInitAnimFunc; 4] =
    unsafe {
        [Some(EnViewer_InitAnimGanondorfOrZelda as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext,
                                       _: *mut libc::c_void,
                                       _: *mut AnimationHeader) -> ()),
         Some(EnViewer_InitAnimHorse as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext,
                                       _: *mut libc::c_void,
                                       _: *mut AnimationHeader) -> ()),
         Some(EnViewer_InitAnimGanondorfOrZelda as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       ...
                                       _: *mut libc::c_void,
                                       _: *mut AnimationHeader) -> ()),
         Some(EnViewer_InitAnimImpa as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext,
                                       _: *mut libc::c_void,
                                       _: *mut AnimationHeader) -> ())]
    };
static mut sShadowDrawFuncs: [ActorShadowFunc; 3] =
    unsafe {
        [None,
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_InitImpl(mut this: *mut EnViewer,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut initData: *mut EnViewerInitData =
        &mut *sInitData.as_mut_ptr().offset(((*this).actor.params as
                                                 libc::c_int >>
                                                 8 as libc::c_int) as isize)
            as *mut EnViewerInitData;
    let mut skelObjBankIndex: s32 =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        (*initData).skeletonObject);
    if skelObjBankIndex >= 0 as libc::c_int {
    } else {
        __assert(b"bank_ID >= 0\x00" as *const u8 as *const libc::c_char,
                 b"../z_en_viewer.c\x00" as *const u8 as *const libc::c_char,
                 576 as libc::c_int);
    };
    (*this).animObjBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx, (*initData).animObject)
            as s8;
    if (*this).animObjBankIndex as libc::c_int >= 0 as libc::c_int {
    } else {
        __assert(b"this->anime_bank_ID >= 0\x00" as *const u8 as
                     *const libc::c_char,
                 b"../z_en_viewer.c\x00" as *const u8 as *const libc::c_char,
                 579 as libc::c_int);
    };
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, skelObjBankIndex) == 0 ||
           Object_IsLoaded(&mut (*globalCtx).objectCtx,
                           (*this).animObjBankIndex as s32) == 0 {
        (*this).actor.flags &=
            !((1 as libc::c_int) << 6 as libc::c_int) as libc::c_uint;
        return
    }
    (*this).isVisible = 1 as libc::c_int as u8_0;
    (*this).actor.objBankIndex = skelObjBankIndex as s8;
    Actor_SetObjectDependency(globalCtx, &mut (*this).actor);
    Actor_SetScale(&mut (*this).actor,
                   (*initData).scale as libc::c_int as libc::c_float /
                       100.0f32);
    ActorShape_Init(&mut (*this).actor.shape,
                    ((*initData).yOffset as libc::c_int * 100 as libc::c_int)
                        as f32_0,
                    sShadowDrawFuncs[(*initData).shadowType as usize],
                    (*initData).shadowScale as f32_0);
    (*this).drawFuncIndex = (*initData).drawType;
    sInitAnimFuncs[(*this).drawFuncIndex as
                       usize].expect("non-null function pointer")(this,
                                                                  globalCtx,
                                                                  (*initData).skeletonHeaderSeg,
                                                                  (*initData).anim);
    EnViewer_SetupAction(this,
                         Some(EnViewer_UpdateImpl as
                                  unsafe extern "C" fn(_: *mut EnViewer,
                                                       _: *mut GlobalContext)
                                      -> ()));
}
static mut sTimer: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub unsafe extern "C" fn EnViewer_UpdateImpl(mut this: *mut EnViewer,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut type_0: u8_0 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as u8_0;
    let mut csFrames: u16_0 = 0;
    let mut animationEnded: s32 = 0;
    if type_0 as libc::c_int == ENVIEWER_TYPE_2_ZELDA as libc::c_int {
        if gSaveContext.sceneSetupIndex == 5 as libc::c_int {
            csFrames = (*globalCtx).csCtx.frames;
            if csFrames as libc::c_int == 792 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x686e as libc::c_int as u16_0);
            } else if csFrames as libc::c_int == 845 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x686f as libc::c_int as u16_0);
            }
        }
    } else if type_0 as libc::c_int ==
                  ENVIEWER_TYPE_7_GANONDORF as libc::c_int {
        Actor_SetScale(&mut (*this).actor, 0.3f32);
        (*this).actor.uncullZoneForward = 10000.0f32;
        (*this).actor.uncullZoneScale = 10000.0f32;
        (*this).actor.uncullZoneDownward = 10000.0f32
    } else if type_0 as libc::c_int ==
                  ENVIEWER_TYPE_3_GANONDORF as libc::c_int {
        if gSaveContext.sceneSetupIndex == 4 as libc::c_int {
            match (*globalCtx).csCtx.frames as libc::c_int {
                20 | 59 | 71 | 129 | 140 | 219 | 280 | 320 | 380 | 409 | 438
                => {
                    Audio_PlaySoundGeneral(0x481d as libc::c_int as u16_0,
                                           &mut D_801333D4,
        ...
        if gSaveContext.sceneSetupIndex == 5 as libc::c_int {
            if (*globalCtx).csCtx.frames as libc::c_int == 1508 as libc::c_int
               {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x39d6 as libc::c_int as u16_0);
            }
            if (*globalCtx).csCtx.frames as libc::c_int == 1545 as libc::c_int
               {
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx,
                                   ACTOR_DEMO_6K as libc::c_int as s16,
                                   32.0f32, 101.0f32, 1226.0f32,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
        ...
        if (*globalCtx).csCtx.frames as libc::c_int == 1020 as libc::c_int {
            Audio_QueueSeqCmd(((SEQ_PLAYER_FANFARE as libc::c_int) <<
                                   24 as libc::c_int | 0x23 as libc::c_int) as
                                  u32_0);
        }
        if (*globalCtx).csCtx.frames as libc::c_int == 960 as libc::c_int {
            Audio_PlaySoundGeneral(0x2816 as libc::c_int as u16_0,
                  ...
                  ENVIEWER_TYPE_6_HORSE_GANONDORF as libc::c_int {
        if gSaveContext.sceneSetupIndex == 5 as libc::c_int ||
               gSaveContext.sceneSetupIndex == 10 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  (0x2878 as libc::c_int -
                                       0x800 as libc::c_int) as u16_0);
        }
    } else if type_0 as libc::c_int ==
                  ENVIEWER_TYPE_4_HORSE_GANONDORF as libc::c_int {
        let mut curFrame: s16 = (*this).skin.skelAnime.curFrame as s16;
        if (*this).skin.skelAnime.animation ==
               &mut gHorseGanonRearingAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            if curFrame as libc::c_int == 8 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x283d as libc::c_int as u16_0);
            }
            if curFrame as libc::c_int == 30 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x282b as libc::c_int as u16_0);
            }
        } else if (*this).skin.skelAnime.animation ==
                      &mut gHorseGanonIdleAnim as *mut AnimationHeader as
                          *mut libc::c_void {
            if curFrame as libc::c_int == 25 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x282c as libc::c_int as u16_0);
            }
        } else if (*this).skin.skelAnime.animation ==
                      &mut gHorseGanonGallopingAnim as *mut AnimationHeader as
                          *mut libc::c_void {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  (0x2878 as libc::c_int -
                                       0x800 as libc::c_int) as u16_0);
    ...
    if sTimer as libc::c_int != 0 as libc::c_int { sTimer -= 1 }
    EnViewer_UpdatePosition(this, globalCtx);
    Actor_MoveForward(&mut (*this).actor);
    animationEnded = SkelAnime_Update(&mut (*this).skin.skelAnime);
    if type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
           type_0 as libc::c_int ==
               ENVIEWER_TYPE_4_HORSE_GANONDORF as libc::c_int {
        if (*globalCtx).csCtx.state as libc::c_int !=
               CS_STATE_IDLE as libc::c_int &&
               !(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                  usize].is_null() {
            if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                   usize]).action as
                   libc::c_int == 2 as libc::c_int &&
                   sTimer as libc::c_int == 0 as libc::c_int {
                if type_0 as libc::c_int ==
                       ENVIEWER_TYPE_3_GANONDORF as libc::c_int {
                    if (*this).skin.skelAnime.animation !=
                           &mut object_gndd_Anim_002928 as
                               *mut AnimationHeader as *mut libc::c_void {
                        Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                                   &mut object_gndd_Anim_002928,
                                                   1.0f32);
                    }
                } else if (*this).skin.skelAnime.animation !=
                              &mut gHorseGanonIdleAnim as *mut AnimationHeader
                                  as *mut libc::c_void {
                    Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                               &mut gHorseGanonIdleAnim,
                                               1.0f32);
                }
            } else if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                          usize]).action as
                          libc::c_int == 1 as libc::c_int {
                sTimer = 100 as libc::c_int as s16;
                if type_0 as libc::c_int ==
                       ENVIEWER_TYPE_3_GANONDORF as libc::c_int {
                    if (*this).skin.skelAnime.animation !=
                           &mut object_gndd_Anim_001D28 as
                               *mut AnimationHeader as *mut libc::c_void {
                        Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                                   &mut object_gndd_Anim_001D28,
                                                   1.0f32);
                    }
                } else if (*this).skin.skelAnime.animation !=
                              &mut gHorseGanonRearingAnim as
                                  *mut AnimationHeader as *mut libc::c_void {
                    Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                               &mut gHorseGanonRearingAnim,
                                               1.0f32);
                }
            } else if type_0 as libc::c_int ==
                          ENVIEWER_TYPE_3_GANONDORF as libc::c_int {
                match (*this).state as libc::c_int {
                    0 => {
                        if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                            ...
                            Animation_MorphToPlayOnce(&mut (*this).skin.skelAnime,
                                                      &mut object_gndd_Anim_000F54,
                                                      -5.0f32);
                            (*this).state = (*this).state.wrapping_add(1)
                        }
                    }
                    1 => {
                        if animationEnded != 0 {
                            Animation_MorphToLoop(&mut (*this).skin.skelAnime,
                                                  &mut object_gndd_Anim_0014F4,
                                                  -5.0f32);
                            (*this).state = (*this).state.wrapping_add(1)
                        }
                    }
                    ...
                    6 => {
                        if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                            ...
                            Audio_PlayActorSound2(&mut (*this).actor,
                                                  0x39c8 as libc::c_int as
                                                      u16_0);
                            Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                                       &mut object_gndd_Anim_0005B4,
                                                       3.0f32);
                            (*this).state = (*this).state.wrapping_add(1)
                        }
                    }
                    7 => { (*this).state = 0 as libc::c_int as u8_0 }
                    _ => { }
                }
            } else if (*this).skin.skelAnime.animation !=
                          &mut gHorseGanonGallopingAnim as
                              *mut AnimationHeader as *mut libc::c_void &&
                          (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                              usize]).action
                              as libc::c_int == 12 as libc::c_int {
                Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                           &mut gHorseGanonGallopingAnim,
                                           3.0f32);
            }
        }
    } else if type_0 as libc::c_int == ENVIEWER_TYPE_1_IMPA as libc::c_int {
        if gSaveContext.sceneSetupIndex == 5 as libc::c_int {
            if (*globalCtx).csCtx.frames as libc::c_int == 845 as libc::c_int
               {
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx,
                                   ACTOR_ITEM_OCARINA as libc::c_int as s16,
                                   4.0f32, 81.0f32, 2600.0f32,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16);
            }
        } else if (*globalCtx).csCtx.frames as libc::c_int ==
                      195 as libc::c_int {
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               ACTOR_ITEM_OCARINA as libc::c_int as s16,
                               4.0f32, 81.0f32, 2035.0f32,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
        ...
        match (*this).state as libc::c_int {
            0 => {
                if (*globalCtx).csCtx.state as libc::c_int !=
                       ...
                       (*this).skin.skelAnime.animation !=
                           &mut object_opening_demo1_Anim_002574 as
                               *mut AnimationHeader as *mut libc::c_void {
                    Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                               &mut object_opening_demo1_Anim_002574,
                                               1.5f32);
                    (*this).state = (*this).state.wrapping_add(1)
                }
            }
            1 => {
                if (*globalCtx).csCtx.state as libc::c_int !=
                       ...
                       (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                           ...
                           libc::c_int == 2 as libc::c_int &&
                       (*this).skin.skelAnime.animation !=
                           &mut object_opening_demo1_Anim_0029CC as
                               *mut AnimationHeader as *mut libc::c_void {
                    Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                               &mut object_opening_demo1_Anim_0029CC,
                                               3.0f32);
                    (*this).state = (*this).state.wrapping_add(1)
                }
            }
    ...
    } else if type_0 as libc::c_int == ENVIEWER_TYPE_2_ZELDA as libc::c_int {
        if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT00 as libc::c_int
           {
            ...
            match (*this).state as libc::c_int {
                0 => {
                    if (*globalCtx).csCtx.state as libc::c_int !=
                           CS_STATE_IDLE as libc::c_int {
                        if !(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                              usize].is_null()
                               &&
                               (*(*globalCtx).csCtx.npcActions[0 as
                                                                   libc::c_int
                                                                   as
                                                                   usize]).action
                                   as libc::c_int == 6 as libc::c_int &&
                               (*this).skin.skelAnime.animation !=
                                   &mut object_opening_demo1_Anim_001410 as
                                       *mut AnimationHeader as
                                       *mut libc::c_void {
                            Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                                       &mut object_opening_demo1_Anim_001410,
                                                       1.5f32);
                            (*this).state = (*this).state.wrapping_add(1)
                        }
                    }
                ...
                1 => {
                    if (*globalCtx).csCtx.state as libc::c_int !=
                        ...
                        if !(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                               ...
                               (*this).skin.skelAnime.animation !=
                                   &mut object_opening_demo1_Anim_000450 as
                                       *mut AnimationHeader as
                                       *mut libc::c_void {
                            Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                                       &mut object_opening_demo1_Anim_000450,
                                                       3.0f32);
                            (*this).state = (*this).state.wrapping_add(1)
                        }
                    }
            ...
            match (*this).state as libc::c_int {
                0 => {
                    Animation_PlayLoopSetSpeed(&mut (*this).skin.skelAnime,
                                               &mut object_opening_demo1_Anim_00504C,
                                               1.0f32);
                    (*this).state = (*this).state.wrapping_add(1)
                }
                1 => {
                    if (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                        ...
                        Animation_MorphToPlayOnce(&mut (*this).skin.skelAnime,
                                                  &mut object_opening_demo1_Anim_00420C,
                                                  -5.0f32);
                        (*this).state = (*this).state.wrapping_add(1)
                    }
                }
                2 => {
                    if animationEnded != 0 {
                        Animation_MorphToLoop(&mut (*this).skin.skelAnime,
                                              &mut object_opening_demo1_Anim_0048FC,
                                              -5.0f32);
                        (*this).state = (*this).state.wrapping_add(1)
                    }
                }
        ...
        match (*this).state as libc::c_int {
            0 => {
                if (*globalCtx).csCtx.state as libc::c_int !=
                    ...
                    Audio_PlaySoundGeneral(0x39c7 as libc::c_int as u16_0,
                                           &mut D_801333D4,
                                           4 as libc::c_int as u8_0,
                                           &mut D_801333E0, &mut D_801333E0,
                                           &mut D_801333E8);
                    Animation_MorphToPlayOnce(&mut (*this).skin.skelAnime,
                                              &mut object_gndd_Anim_004534,
                                              -5.0f32);
                    (*this).state = (*this).state.wrapping_add(1)
                }
            }
            ...
            _ => { }
                  ...
                  ENVIEWER_TYPE_8_GANONDORF as libc::c_int {
        match (*this).state as libc::c_int {
            0 => {
                if (*globalCtx).csCtx.state as libc::c_int !=
                       CS_STATE_IDLE as libc::c_int {
            ...
            3 => {
                if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                    ...
                    Animation_MorphToPlayOnce(&mut (*this).skin.skelAnime,
                                              &mut object_gndd_Anim_003428,
                                              -5.0f32);
                    (*this).state = (*this).state.wrapping_add(1)
                }
            }
            _ => { (*this).state = 0 as libc::c_int as u8_0 }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnViewer = thisx as *mut EnViewer;
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).animObjBankIndex as
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Ganondorf3OverrideLimbDraw(mut globalCtx:
                                                                 *mut GlobalContext,
                                                             mut limbIndex:
                                                                 s32,
                                                             mut dList:
 ...
 -> s32 {
    if gSaveContext.sceneSetupIndex == 4 as libc::c_int {
        if (*globalCtx).csCtx.frames as libc::c_int >= 400 as libc::c_int {
            if limbIndex == 5 as libc::c_int {
                *dList = object_gndd_DL_00E1A8.as_mut_ptr()
            }
        }
    } else if (*globalCtx).csCtx.frames as libc::c_int >= 1510 as libc::c_int
                  &&
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Ganondorf9PostLimbDraw(mut globalCtx:
                                                             *mut GlobalContext,
                                                         mut limbIndex: s32,
                                                         mut dList:
                                                             *mut *mut Gfx,
    ...
    if limbIndex == 11 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_viewer.c\x00" as *const u8 as
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_viewer.c\x00" as *const u8 as
                             *const libc::c_char, 1372 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_GanondorfPostLimbDrawUpdateCapeVec(mut globalCtx:
                                                                         *mut GlobalContext,
                                                                     mut limbIndex:
                                                                         s32,
                                                                     mut dList:
    ...
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut zeroVec, &mut sGanondorfNeckWorldPos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_DrawGanondorf(mut this: *mut EnViewer,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut frames: s16 = 0 as libc::c_int as s16;
    let mut type_0: s16 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_viewer.c\x00" as *const u8 as
                        *const libc::c_char, 1405 as libc::c_int);
    type_0 = ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as s16;
    if type_0 as libc::c_int == ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
           type_0 as libc::c_int == ENVIEWER_TYPE_5_GANONDORF as libc::c_int
           ||
           type_0 as libc::c_int == ENVIEWER_TYPE_7_GANONDORF as libc::c_int
           ...
           type_0 as libc::c_int == ENVIEWER_TYPE_8_GANONDORF as libc::c_int {
        if gSaveContext.sceneSetupIndex != 4 as libc::c_int {
            frames = 149 as libc::c_int as s16
        }
        if frames as libc::c_int + 1127 as libc::c_int >=
               (*globalCtx).csCtx.frames as libc::c_int {
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                gSegments[((&mut object_gndd_Tex_00F178 as *mut [u64_0; 0] as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(&mut object_gndd_Tex_00F178
                                                      as *mut [u64_0; 0] as
                                                      u32_0 &
                              ...
                              usize].wrapping_add(&mut object_gndd_Tex_00F178
                                                      ...
                                                      0xffffff as libc::c_int
                                                          ...
                                                          libc::c_uint).wrapping_add(0x80000000
                                                                                         ...
                                                                                         libc::c_uint)
                    as *mut libc::c_void as libc::c_uint
        } else if frames as libc::c_int + 1128 as libc::c_int >=
                      (*globalCtx).csCtx.frames as libc::c_int {
            ...
            (*_g_1).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gSegments[((&mut object_gndd_Tex_00F378 as *mut [u64_0; 0] as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(&mut object_gndd_Tex_00F378
                                                      as *mut [u64_0; 0] as
                                                      u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                              ...
                              usize].wrapping_add(&mut object_gndd_Tex_00F378
                                                      ...
                                                      0xffffff as libc::c_int
                                                          ...
                                                          libc::c_uint).wrapping_add(0x80000000
                                                                                         ...
                                                                                         libc::c_uint)
                    as *mut libc::c_void as libc::c_uint
        } else if frames as libc::c_int + 1129 as libc::c_int >=
                      (*globalCtx).csCtx.frames as libc::c_int {
            ...
            (*_g_3).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gSegments[((&mut object_gndd_Tex_00F578 as *mut [u64_0; 0] as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(&mut object_gndd_Tex_00F578
                                                      as *mut [u64_0; 0] as
                                                      u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
            ...
            (*_g_5).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                gSegments[((&mut object_gndd_Tex_00F778 as *mut [u64_0; 0] as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(&mut object_gndd_Tex_00F778
                                                      as *mut [u64_0; 0] as
                                                      u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
        ...
        (*_g_7).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_7).words.w1 =
            gSegments[((&mut object_ganon_Tex_00A4E0 as *mut [u64_0; 0] as
                            u32_0) << 4 as libc::c_int >> 28 as libc::c_int)
                          as
                          usize].wrapping_add(&mut object_ganon_Tex_00A4E0 as
                                                  *mut [u64_0; 0] as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
    ...
    if type_0 as libc::c_int == ENVIEWER_TYPE_9_GANONDORF as libc::c_int {
        SkelAnime_DrawFlexOpa(globalCtx, (*this).skin.skelAnime.skeleton,
                              (*this).skin.skelAnime.jointTable,
                              (*this).skin.skelAnime.dListCount as s32, None,
                              Some(EnViewer_Ganondorf9PostLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
        ...
        SkelAnime_DrawFlexOpa(globalCtx, (*this).skin.skelAnime.skeleton,
                              (*this).skin.skelAnime.jointTable,
                              (*this).skin.skelAnime.dListCount as s32,
                              Some(EnViewer_Ganondorf3OverrideLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
                                                            ...
                                                            _:
                                                                *mut libc::c_void)
                                           -> s32),
                              Some(EnViewer_GanondorfPostLimbDrawUpdateCapeVec
                                       as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
        ...
        EnViewer_UpdateGanondorfCape(globalCtx, this);
                  ...
                  ENVIEWER_TYPE_3_GANONDORF as libc::c_int ||
                  type_0 as libc::c_int ==
                      ENVIEWER_TYPE_5_GANONDORF as libc::c_int ||
                  type_0 as libc::c_int ==
                      ENVIEWER_TYPE_7_GANONDORF as libc::c_int ||
                  type_0 as libc::c_int ==
                      ENVIEWER_TYPE_8_GANONDORF as libc::c_int {
        ...
        SkelAnime_DrawOpa(globalCtx, (*this).skin.skelAnime.skeleton,
                          (*this).skin.skelAnime.jointTable, None, None,
                          this as *mut libc::c_void);
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_viewer.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_DrawHorse(mut this: *mut EnViewer,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    func_800A6330(&mut (*this).actor, globalCtx, &mut (*this).skin, None,
                  1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_ZeldaOverrideLimbDraw(mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut limbIndex: s32,
                                                        mut dList:
                                                            *mut *mut Gfx,
 ...
 -> s32 {
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT00 as libc::c_int {
        ...
        if limbIndex == 2 as libc::c_int {
            *dList = gChildZeldaCutsceneDressDL.as_mut_ptr()
        }
        if limbIndex == 7 as libc::c_int { *dList = 0 as *mut Gfx }
        if limbIndex == 8 as libc::c_int { *dList = 0 as *mut Gfx }
        if limbIndex == 9 as libc::c_int { *dList = 0 as *mut Gfx }
        if limbIndex == 3 as libc::c_int { *dList = 0 as *mut Gfx }
        if limbIndex == 5 as libc::c_int { *dList = 0 as *mut Gfx }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_ZeldaPostLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
            ...
            (*_g).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                gChildZeldaOcarinaOfTimeDL.as_mut_ptr() as libc::c_uint;
            Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                             b"../z_en_viewer.c\x00" as *const u8 as
                                 *const libc::c_char, 1570 as libc::c_int);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_DrawZelda(mut this: *mut EnViewer,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_viewer.c\x00" as *const u8 as
                        *const libc::c_char, 1583 as libc::c_int);
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT00 as libc::c_int {
        // Hyrule Field
        if ((*globalCtx).csCtx.frames as libc::c_int) < 771 as libc::c_int {
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                gSegments[((gChildZeldaEyeInTex.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaEyeInTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gSegments[((gChildZeldaEyeOutTex.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaEyeOutTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
            ...
            (*_g_1).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                gSegments[((gChildZeldaEyeBlinkTex.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaEyeBlinkTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
            ...
            (*_g_3).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gSegments[((gChildZeldaEyeShutTex.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaEyeShutTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
            ...
            (*_g_5).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                gSegments[((gChildZeldaEyeWideTex.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaEyeWideTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
        ...
        if gSaveContext.sceneSetupIndex == 6 as libc::c_int {
            ...
            (*_g_13).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_13).words.w1 =
                gSegments[((gChildZeldaMouthSurprisedTex.as_mut_ptr() as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaMouthSurprisedTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
            ...
            (*_g_14).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_14).words.w1 =
                gSegments[((gChildZeldaMouthWorriedTex.as_mut_ptr() as u32_0)
                               << 4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gChildZeldaMouthWorriedTex.as_mut_ptr()
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
                                                          as
                                                          libc::c_uint).wrapping_add(0x80000000
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skin.skelAnime.skeleton,
                          (*this).skin.skelAnime.jointTable,
                          (*this).skin.skelAnime.dListCount as s32,
                          Some(EnViewer_ZeldaOverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        ...
                                                        _: *mut libc::c_void)
                                       -> s32),
                          Some(EnViewer_ZeldaPostLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_ImpaOverrideLimbDraw(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut limbIndex: s32,
                                                       mut dList:
                                                           *mut *mut Gfx,
 ...
 -> s32 {
    if limbIndex == 16 as libc::c_int {
        *dList = gImpaHeadMaskedDL.as_mut_ptr()
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_DrawImpa(mut this: *mut EnViewer,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_viewer.c\x00" as *const u8 as
                        *const libc::c_char, 1717 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((gImpaEyeOpenTex.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gImpaEyeOpenTex.as_mut_ptr() as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skin.skelAnime.skeleton,
                          (*this).skin.skelAnime.jointTable,
                          (*this).skin.skelAnime.dListCount as s32,
                          Some(EnViewer_ImpaOverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3f,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_viewer.c\x00" as *const u8 as
                         *const libc::c_char, 1740 as libc::c_int);
}
static mut sDrawFuncs: [EnViewerDrawFunc; 4] =
    unsafe {
        [Some(EnViewer_DrawGanondorf as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext) -> ()),
         Some(EnViewer_DrawHorse as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext) -> ()),
         Some(EnViewer_DrawZelda as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext) -> ()),
         Some(EnViewer_DrawImpa as
                  unsafe extern "C" fn(_: *mut EnViewer,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnViewer_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnViewer = thisx as *mut EnViewer;
    let mut pad: s32 = 0;
    let mut type_0: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_viewer.c\x00" as *const u8 as
                        *const libc::c_char, 1760 as libc::c_int);
    if (*this).isVisible != 0 {
        type_0 =
            ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as s16;
        if type_0 as libc::c_int <= ENVIEWER_TYPE_2_ZELDA as libc::c_int {
            // zelda's horse, impa and zelda
            if (*globalCtx).csCtx.state as libc::c_int !=
                   CS_STATE_IDLE as libc::c_int &&
                   !(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                      usize].is_null() {
                func_80093D18((*globalCtx).state.gfxCtx); // ganondorf and ganondorf's horse
                sDrawFuncs[(*this).drawFuncIndex as
                               usize].expect("non-null function pointer")(this,
                                                                          globalCtx);
            }
        } else if (*globalCtx).csCtx.state as libc::c_int !=
                      CS_STATE_IDLE as libc::c_int &&
                      !(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                         usize].is_null() ||
                      type_0 as libc::c_int ==
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_viewer.c\x00" as *const u8 as
                         *const libc::c_char, 1784 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_UpdatePosition(mut this: *mut EnViewer,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut startPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut endPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut lerpFactor: f32_0 = 0.;
    let mut type_0: s16 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int) as s16;
    if type_0 as libc::c_int <= ENVIEWER_TYPE_2_ZELDA as libc::c_int {
        // zelda's horse, impa and zelda
        if (*globalCtx).csCtx.state as libc::c_int !=
               ...
               ((*globalCtx).csCtx.frames as libc::c_int) <
                   (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                       ...
                       libc::c_int {
            if type_0 as libc::c_int ==
                   ENVIEWER_TYPE_0_HORSE_ZELDA as libc::c_int {
                if sHorseSfxPlayed == 0 {
                    sHorseSfxPlayed = 1 as libc::c_int as u8_0;
            ...
            endPos.x =
                (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                    usize]).endPos.x as f32_0;
            endPos.y =
                (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                    usize]).endPos.y as f32_0;
            endPos.z =
                (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as
                                                    usize]).endPos.z as f32_0;
            lerpFactor =
                Environment_LerpWeight((*(*globalCtx).csCtx.npcActions[0 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]).endFrame,
                                       (*(*globalCtx).csCtx.npcActions[0 as
            ...
            (*this).actor.world.pos.x =
                (endPos.x - startPos.x) * lerpFactor + startPos.x;
            (*this).actor.world.pos.y =
                (endPos.y - startPos.y) * lerpFactor + startPos.y;
            (*this).actor.world.pos.z =
                (endPos.z - startPos.z) * lerpFactor + startPos.z
        }
    } else {
        if (*globalCtx).csCtx.state as libc::c_int !=
               CS_STATE_IDLE as libc::c_int &&
            ...
            endPos.z =
                (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                    usize]).endPos.z as f32_0;
            lerpFactor =
                Environment_LerpWeight((*(*globalCtx).csCtx.npcActions[1 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]).endFrame,
                                       (*(*globalCtx).csCtx.npcActions[1 as
                                                                           libc::c_int
                                                                           as
                                                                           usize]).startFrame,
                                       (*globalCtx).csCtx.frames);
            ...
            if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                                                   usize]).action as
                   libc::c_int == 12 as libc::c_int {
                let mut yaw: s16 = Math_Vec3f_Yaw(&mut startPos, &mut endPos);
                Math_SmoothStepToS(&mut (*this).actor.world.rot.y, yaw,
                                   0xa as libc::c_int as s16,
                                   0x3e8 as libc::c_int as s16,
                                   1 as libc::c_int as s16);
                Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, yaw,
                                   0xa as libc::c_int as s16,
                                   0x3e8 as libc::c_int as s16,
                                   1 as libc::c_int as s16);
            }
        ...
        if type_0 as libc::c_int == ENVIEWER_TYPE_5_GANONDORF as libc::c_int {
            Audio_PlaySoundGeneral((0x28b3 as libc::c_int -
                                        0x800 as libc::c_int) as u16_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_InitFireEffect(mut this: *mut EnViewer,
                                                 mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut i: s16) {
    let mut eff: *mut EnViewerFireEffect = 0 as *mut EnViewerFireEffect;
    if i as libc::c_int % 2 as libc::c_int == 0 as libc::c_int {
        eff =
            &mut *(*this).fireEffects.as_mut_ptr().offset(i as isize) as
                *mut EnViewerFireEffect;
        (*eff).startPos.x = 100.0f32;
        (*eff).startPos.y = -420.0f32;
        (*eff).startPos.z = 400.0f32;
        (*eff).endPos.x = 100.0f32;
        (*eff).endPos.y = -420.0f32;
        (*eff).endPos.z = -400.0f32;
        (*eff).scale = (Rand_ZeroOne() * 5.0f32 + 12.0f32) * 0.001f32
    } else {
        eff =
            &mut *(*this).fireEffects.as_mut_ptr().offset(i as isize) as
                *mut EnViewerFireEffect;
...
#[no_mangle]
pub unsafe extern "C" fn EnViewer_DrawFireEffects(mut this2: *mut EnViewer,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut EnViewer = this2;
    let mut i: s16 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_viewer.c\x00" as *const u8 as
                        *const libc::c_char, 1941 as libc::c_int);
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnViewerFireEffect; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnViewerFireEffect>()
                                                   as libc::c_ulong) as s32 {
        match (*this).fireEffects[i as usize].state as libc::c_int {
            0 => {
                EnViewer_InitFireEffect(this, globalCtx, i);
                (*this).fireEffects[i as usize].lerpFactor =
                    (i as libc::c_int >> 1 as libc::c_int) as libc::c_float *
                        0.1f32;
                (*this).fireEffects[i as usize].lerpFactorSpeed = 0.01f32;
                (*this).fireEffects[i as usize].state =
                    (*this).fireEffects[i as usize].state.wrapping_add(1)
            }
            1 => {
                Math_SmoothStepToF(&mut (*(*this).fireEffects.as_mut_ptr().offset(i
                                                                                      as
                                                                                      isize)).lerpFactor,
                                   1.0f32, 1.0f32,
                                   (*this).fireEffects[i as
                                                           usize].lerpFactorSpeed,
                                   (*this).fireEffects[i as
                                                           usize].lerpFactorSpeed);
                (*this).fireEffects[i as usize].pos.x =
                    (*this).fireEffects[i as usize].startPos.x +
                        ((*this).fireEffects[i as usize].endPos.x -
                             (*this).fireEffects[i as usize].startPos.x) *
                            (*this).fireEffects[i as usize].lerpFactor;
                (*this).fireEffects[i as usize].pos.y =
                    (*this).fireEffects[i as usize].startPos.y +
                        ((*this).fireEffects[i as usize].endPos.y -
                             (*this).fireEffects[i as usize].startPos.y) *
                            (*this).fireEffects[i as usize].lerpFactor;
                (*this).fireEffects[i as usize].pos.z =
                    (*this).fireEffects[i as usize].startPos.z +
                        ((*this).fireEffects[i as usize].endPos.z -
                             (*this).fireEffects[i as usize].startPos.z) *
                            (*this).fireEffects[i as usize].lerpFactor;
                if (*this).fireEffects[i as usize].lerpFactor >= 1.0f32 {
                    (*this).fireEffects[i as usize].state =
                        (*this).fireEffects[i as usize].state.wrapping_add(1)
                }
            }
            2 => {
                EnViewer_InitFireEffect(this, globalCtx, i);
                (*this).fireEffects[i as usize].lerpFactor = 0.0f32;
                (*this).fireEffects[i as usize].lerpFactorSpeed = 0.01f32;
                (*this).fireEffects[i as usize].state =
                    (*this).fireEffects[i as usize].state.wrapping_sub(1)
            }
            _ => { }
        }
        func_80093D84((*globalCtx).state.gfxCtx);
        Matrix_Translate((*this).fireEffects[i as usize].pos.x,
                         (*this).fireEffects[i as usize].pos.y,
                         (*this).fireEffects[i as usize].pos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_Scale((*this).fireEffects[i as usize].scale,
                     (*this).fireEffects[i as usize].scale,
                     (*this).fireEffects[i as usize].scale,
        ...
        (*_g).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             ((10 as libc::c_int * i as libc::c_int) as
                                  libc::c_uint).wrapping_sub((20 as
                                                                  libc::c_int
                                                                  as
                                                                  libc::c_uint).wrapping_mul((*globalCtx).state.frames)).wrapping_rem(512
                                                                                                                                          as
                                                                                                                                          libc::c_int
                                                                                                                                          as
                                                                                                                                          libc::c_uint),
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_viewer.c\x00" as *const u8 as
                         *const libc::c_char, 2034 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnViewer_UpdateGanondorfCape(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut this:
                                                          *mut EnViewer) {
    static mut yOscillationPhase: s16 = 0 as libc::c_int as s16;
    let mut forearmModelOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut forearmWorldOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).actor.params as libc::c_int >> 8 as libc::c_int ==
           ENVIEWER_TYPE_5_GANONDORF as libc::c_int {
        (*sGanondorfCape).backPush =
            (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 54 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float /
                10.0f32;
        (*sGanondorfCape).backSwayMagnitude =
            ((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 60 as libc::c_int) as
                                   usize] as libc::c_int + 25 as libc::c_int)
                as libc::c_float / 100.0f32;
        (*sGanondorfCape).sideSwayMagnitude =
            ((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 55 as libc::c_int) as
                                   usize] as libc::c_int - 45 as libc::c_int)
                as libc::c_float / 10.0f32;
        (*sGanondorfCape).minY = -10000.0f32;
        (*sGanondorfCape).minDist = 0.0f32;
        (*sGanondorfCape).gravity =
            ((*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 67 as libc::c_int) as
                                   usize] as libc::c_int - 10 as libc::c_int)
                as libc::c_float / 10.0f32;
        forearmModelOffset.x =
            (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 16 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float -
                13.0f32;
        forearmModelOffset.y =
            (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 17 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float +
                3.0f32 +
                Math_SinS(yOscillationPhase) *
                    (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           20 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float;
        forearmModelOffset.z =
            (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 18 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float -
                10.0f32;
        yOscillationPhase =
            (yOscillationPhase as libc::c_int +
                 ((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                         16 as libc::c_int +
        ...
        Matrix_RotateY((*this).actor.shape.rot.y as libc::c_int as
                       ...
                       MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut forearmModelOffset, &mut forearmWorldOffset);
        (*sGanondorfCape).rightForearmPos.x =
            sGanondorfNeckWorldPos.x + forearmWorldOffset.x;
        (*sGanondorfCape).rightForearmPos.y =
            sGanondorfNeckWorldPos.y + forearmWorldOffset.y;
        (*sGanondorfCape).rightForearmPos.z =
            sGanondorfNeckWorldPos.z + forearmWorldOffset.z;
        forearmModelOffset.x =
            -((*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 16 as libc::c_int) as
                                    usize] as libc::c_int as libc::c_float -
                  13.0f32);
        Matrix_MultVec3f(&mut forearmModelOffset, &mut forearmWorldOffset);
        (*sGanondorfCape).leftForearmPos.x =
            sGanondorfNeckWorldPos.x + forearmWorldOffset.x;
        (*sGanondorfCape).leftForearmPos.y =
            sGanondorfNeckWorldPos.y + forearmWorldOffset.y;
        (*sGanondorfCape).leftForearmPos.z =
            sGanondorfNeckWorldPos.z + forearmWorldOffset.z
    };
}
