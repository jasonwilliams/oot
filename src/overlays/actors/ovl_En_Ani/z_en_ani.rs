...
extern "C" {
    ...
    #[no_mangle]
    static mut gRoofManSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gRoofManEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gRoofManEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gRoofManEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gRoofManKnockbackAnim: AnimationHeader;
    #[no_mangle]
    static mut gRoofManGettingUpAfterKnockbackAnim: AnimationHeader;
    #[no_mangle]
    static mut gRoofManIdleAnim: AnimationHeader;
}
...
pub struct EnAni {
    ...
    pub eyeIndex: s16,
    pub blinkTimer: s16,
    pub actionFunc: EnAniActionFunc,
}
pub type EnAniActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAni, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ani_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ANI as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_ANI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnAni>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnAni_SetupAction(mut this: *mut EnAni,
                                           mut actionFunc: EnAniActionFunc) {
...
#[no_mangle]
pub unsafe extern "C" fn EnAni_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnAni = thisx as *mut EnAni;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*this).actor.shape, -2800.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 36.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gRoofManSkel,
                       &mut gRoofManIdleAnim, (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 0x10 as libc::c_int);
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gRoofManIdleAnim);
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        EnAni_SetupAction(this,
                          Some(func_809B064C as
                                   unsafe extern "C" fn(_: *mut EnAni,
                                                        _: *mut GlobalContext)
                                       -> ()));
    } else {
        EnAni_SetupAction(this,
                          Some(func_809B07F8 as
                                   unsafe extern "C" fn(_: *mut EnAni,
                                                        _: *mut GlobalContext)
                                       -> ()));
    }
    (*this).unk_2AA = 0 as libc::c_int as u16_0;
    (*this).unk_2A8 = 0 as libc::c_int as u16_0;
    (*this).actor.minVelocityY = -1.0f32;
    (*this).actor.velocity.y = -1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnAni_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAni = thisx as *mut EnAni;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnAni_SetText(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext,
                                       mut textId: u16_0) -> s32 {
    (*this).actor.textId = textId;
    (*this).unk_2A8 =
        ((*this).unk_2A8 as libc::c_int | 1 as libc::c_int) as u16_0;
    func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809B04F0(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_809B0524(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        EnAni_SetupAction(this,
                          Some(func_809B07F8 as
...
pub unsafe extern "C" fn func_809B0558(mut this: *mut EnAni,
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ...
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_HEART_PIECE as libc::c_int, 10000.0f32, 200.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B05F0(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        EnAni_SetupAction(this,
                          Some(func_809B0558 as
                                   unsafe extern "C" fn(_: *mut EnAni,
                                                        _: *mut GlobalContext)
                                       -> ()));
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_809B064C(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    let mut textId: u16_0 = 0;
    let mut yawDiff: s16 = 0;
    let mut textId2: u16_0 = 0;
    textId2 = Text_GetFaceReaction(globalCtx, 0xa as libc::c_int as u32_0);
    textId = (textId2 as libc::c_int & 0xffff as libc::c_int) as u16_0;
    (textId) == 0;
    if textId2 as libc::c_int == 0 as libc::c_int {
        textId =
            if !(gSaveContext.nightFlag == 0 as libc::c_int) {
                0x5051 as libc::c_int
            } else { 0x5050 as libc::c_int } as u16_0
    }
    yawDiff =
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.textId as libc::c_int == 0x5056 as libc::c_int {
            EnAni_SetupAction(this,
                              Some(func_809B04F0 as
                                       unsafe extern "C" fn(_: *mut EnAni,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
        } else if (*this).actor.textId as libc::c_int == 0x5055 as libc::c_int
         {
            EnAni_SetupAction(this,
                              Some(func_809B05F0 as
                                       unsafe extern "C" fn(_: *mut EnAni,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
    ...
    } else if yawDiff as libc::c_int >= -(0x36af as libc::c_int) &&
                  (yawDiff as libc::c_int) < 0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 150.0f32 &&
                  -80.0f32 < (*this).actor.yDistToPlayer {
        if gSaveContext.itemGetInf[1 as libc::c_int as usize] as libc::c_int &
               0x20 as libc::c_int != 0 {
            EnAni_SetText(this, globalCtx, 0x5056 as libc::c_int as u16_0);
        } else {
            EnAni_SetText(this, globalCtx, 0x5055 as libc::c_int as u16_0);
        }
    } else if yawDiff as libc::c_int >= -(0x3e7 as libc::c_int) &&
                  (yawDiff as libc::c_int) < 0x36b0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 350.0f32 {
        EnAni_SetText(this, globalCtx, textId);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B07F8(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s16 = 0;
    let mut yawDiff: s16 = 0;
    let mut textId: u16_0 = 0;
    ...
    } else if yawDiff as libc::c_int > -(0x36b0 as libc::c_int) &&
                  (yawDiff as libc::c_int) < 0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 150.0f32 &&
                  -80.0f32 < (*this).actor.yDistToPlayer {
        if gSaveContext.itemGetInf[1 as libc::c_int as usize] as libc::c_int &
    ...
    } else if yawDiff as libc::c_int > -(0x3e8 as libc::c_int) &&
                  (yawDiff as libc::c_int) < 0x36b0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 350.0f32 {
        if gSaveContext.eventChkInf[2 as libc::c_int as usize] as libc::c_int
               & 0x8000 as libc::c_int == 0 {
            textId = 0x5052 as libc::c_int as u16_0
        } else {
            textId =
                if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
                       libc::c_int & 0x20 as libc::c_int != 0 {
                    0x5054 as libc::c_int
                } else { 0x5053 as libc::c_int } as u16_0
        }
        EnAni_SetText(this, globalCtx, textId);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809B0988(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_809B0994(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    if (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as usize]).action as
        ...
        Animation_Change(&mut (*this).skelAnime,
                         &mut gRoofManGettingUpAfterKnockbackAnim, 1.0f32,
                         0.0f32,
                         Animation_GetLastFrame(&mut gRoofManGettingUpAfterKnockbackAnim
                                                    as *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         -4.0f32);
        (*this).unk_2AA = (*this).unk_2AA.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn func_809B0A28(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_809B0A6C(mut this: *mut EnAni,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
    ...
    if (*(*globalCtx).csCtx.npcActions[0 as libc::c_int as usize]).action as
        ...
        Animation_Change(&mut (*this).skelAnime, &mut gRoofManKnockbackAnim,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut gRoofManKnockbackAnim as
...
#[no_mangle]
pub unsafe extern "C" fn EnAni_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAni = thisx as *mut EnAni;
    ...
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           ...
           !(*globalCtx).csCtx.npcActions[0 as libc::c_int as usize].is_null()
       {
        match (*this).unk_2AA as libc::c_int {
            0 => { func_809B0A6C(this, globalCtx); }
            1 => { func_809B0A28(this, globalCtx); }
            2 => { func_809B0994(this, globalCtx); }
            3 => { func_809B0A28(this, globalCtx); }
            4 => { func_809B0988(this, globalCtx); }
            _ => { }
        }
        if (*globalCtx).csCtx.frames as libc::c_int == 100 as libc::c_int {
            func_800788CC(0x1845 as libc::c_int as u16_0);
        }
    } else {
    ...
    if (*this).unk_2A8 as libc::c_int & 1 as libc::c_int != 0 {
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_29C,
        ...
        Math_SmoothStepToS(&mut (*this).unk_29C.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_29C.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnAni_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 15 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_29C.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_29C.x as libc::c_int) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnAni_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    static mut sMultVec: Vec3f =
        { let mut init = Vec3f{x: 800.0f32, y: 500.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnAni = thisx as *mut EnAni;
    if limbIndex == 15 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnAni_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gRoofManEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gRoofManEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gRoofManEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnAni = thisx as *mut EnAni;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ani.c\x00" as *const u8 as *const libc::c_char,
                    719 as libc::c_int);
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnAni_OverrideLimbDraw as
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(850 as libc::c_int);
             init
         }]
}
#[used]
