...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    fn Audio_PlaySoundWaterfall(pos: *mut Vec3f, freqScale: f32_0);
    #[no_mangle]
    static mut gSegments: [u32_0; 16];
    #[no_mangle]
    static mut object_spot03_object_Vtx_000800: [Vtx; 0];
    #[no_mangle]
    static mut object_spot03_object_Vtx_000990: [Vtx; 0];
    #[no_mangle]
    static mut object_spot03_object_DL_000B20: [Gfx; 0];
    #[no_mangle]
    static mut object_spot03_object_DL_000BC0: [Gfx; 0];
    #[no_mangle]
    static mut object_spot03_object_Col_000C98: CollisionHeader;
    #[no_mangle]
    static mut object_spot03_object_DL_001580: [Gfx; 0];
}
...
pub const WATERFALL_CLOSING: C2RustUnnamed_19 = 4;
pub const WATERFALL_OPENED: C2RustUnnamed_19 = 3;
pub const WATERFALL_OPENING_ANIMATED: C2RustUnnamed_19 = 2;
pub const WATERFALL_OPENING_IDLE: C2RustUnnamed_19 = 1;
pub const WATERFALL_CLOSED: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot03Taki {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot03TakiActionFunc,
    pub timer: s16,
    pub state: u8_0,
    pub switchFlag: u16_0,
    pub openingAlpha: f32_0,
    pub bufferIndex: u8_0,
}
pub type BgSpot03TakiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot03Taki, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Spot03_Taki_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT03_TAKI as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId:
                              OBJECT_SPOT03_OBJECT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot03Taki>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot03Taki_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot03Taki_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot03Taki_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot03Taki_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot03Taki_ApplyOpeningAlpha(mut this:
                                                            *mut BgSpot03Taki,
                                                        mut bufferIndex:
                                                            s32) {
    let mut i: s32 = 0;
    let mut vtx: *mut Vtx =
        if bufferIndex == 0 as libc::c_int {
            gSegments[((object_spot03_object_Vtx_000800.as_mut_ptr() as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_spot03_object_Vtx_000800.as_mut_ptr()
                                                  as u32_0 &
            ...
            gSegments[((object_spot03_object_Vtx_000990.as_mut_ptr() as u32_0)
                           << 4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_spot03_object_Vtx_000990.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
    ...
    while i < 5 as libc::c_int {
        (*vtx.offset((i + 10 as libc::c_int) as
                         isize)).v.cn[3 as libc::c_int as usize] =
            (*this).openingAlpha as libc::c_uchar;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot03Taki_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot03Taki = thisx as *mut BgSpot03Taki;
    let mut pad: s16 = 0;
    ...
    CollisionHeader_GetVirtual(&mut object_spot03_object_Col_000C98 as
    ...
    (*this).bufferIndex = 0 as libc::c_int as u8_0;
    (*this).openingAlpha = 255.0f32;
    BgSpot03Taki_ApplyOpeningAlpha(this, 0 as libc::c_int);
    BgSpot03Taki_ApplyOpeningAlpha(this, 1 as libc::c_int);
    (*this).actionFunc =
        Some(func_808ADEF0 as
                 unsafe extern "C" fn(_: *mut BgSpot03Taki,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot03Taki_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot03Taki = thisx as *mut BgSpot03Taki;
...
#[no_mangle]
pub unsafe extern "C" fn func_808ADEF0(mut this: *mut BgSpot03Taki,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).state as libc::c_int == WATERFALL_CLOSED as libc::c_int {
        if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
            (*this).state = WATERFALL_OPENING_ANIMATED as libc::c_int as u8_0;
            (*this).timer = 40 as libc::c_int as s16;
            OnePointCutscene_Init(globalCtx, 4100 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  0 as *mut Actor, 0 as libc::c_int as s16);
        }
    } else if (*this).state as libc::c_int ==
                  WATERFALL_OPENING_IDLE as libc::c_int {
        (*this).timer -= 1;
        if ((*this).timer as libc::c_int) < 0 as libc::c_int {
            (*this).state = WATERFALL_OPENING_ANIMATED as libc::c_int as u8_0
        }
    } else if (*this).state as libc::c_int ==
                  WATERFALL_OPENING_ANIMATED as libc::c_int {
        if (*this).openingAlpha > 0 as libc::c_int as libc::c_float {
            (*this).openingAlpha -= 5 as libc::c_int as libc::c_float;
            if (*this).openingAlpha <= 0.0f32 {
                func_8003EBF8(globalCtx, &mut (*globalCtx).colCtx.dyna,
                              (*this).dyna.bgId);
                (*this).timer = 400 as libc::c_int as s16;
                (*this).state = WATERFALL_OPENED as libc::c_int as u8_0;
                (*this).openingAlpha = 0 as libc::c_int as f32_0
            }
        }
    } else if (*this).state as libc::c_int == WATERFALL_OPENED as libc::c_int
     {
        (*this).timer -= 1;
        if ((*this).timer as libc::c_int) < 0 as libc::c_int {
            (*this).state = WATERFALL_CLOSING as libc::c_int as u8_0
        }
    } else if (*this).state as libc::c_int == WATERFALL_CLOSING as libc::c_int
     {
        if (*this).openingAlpha < 255.0f32 {
            (*this).openingAlpha += 5.0f32;
            if (*this).openingAlpha >= 255.0f32 {
                func_8003EC50(globalCtx, &mut (*globalCtx).colCtx.dyna,
                              (*this).dyna.bgId);
                (*this).state = WATERFALL_CLOSED as libc::c_int as u8_0;
                (*this).openingAlpha = 255.0f32;
                Flags_UnsetSwitch(globalCtx, (*this).switchFlag as s32);
            }
        }
    }
    BgSpot03Taki_ApplyOpeningAlpha(this, (*this).bufferIndex as s32);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot03Taki_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot03Taki = thisx as *mut BgSpot03Taki;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot03Taki_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot03Taki = thisx as *mut BgSpot03Taki;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot03_taki.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        object_spot03_object_DL_000B20.as_mut_ptr() as libc::c_uint;
    if (*this).bufferIndex as libc::c_int == 0 as libc::c_int {
        ...
        (*_g_2).words.w0 =
            (0x1 as libc::c_int as u32_0 &
                ...
                (25 as libc::c_int as u32_0 &
                    ...
                    12 as libc::c_int |
                ((0 as libc::c_int + 25 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 7 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    1 as libc::c_int;
        (*_g_2).words.w1 =
            object_spot03_object_Vtx_000800.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_3).words.w0 =
            (0x1 as libc::c_int as u32_0 &
                ...
                ((0 as libc::c_int + 25 as libc::c_int) as u32_0 &
                    ...
                    1 as libc::c_int;
        (*_g_3).words.w1 =
            object_spot03_object_Vtx_000990.as_mut_ptr() as libc::c_uint
    }
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 =
        object_spot03_object_DL_000BC0.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_5).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         gameplayFrames.wrapping_mul(3 as libc::c_int as
                                                         libc::c_uint),
                         64 as libc::c_int, 64 as libc::c_int,
                         1 as libc::c_int, gameplayFrames.wrapping_neg(),
                         gameplayFrames.wrapping_mul(3 as libc::c_int as
                                                         libc::c_uint),
                         64 as libc::c_int, 64 as libc::c_int) as
            libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 =
        object_spot03_object_DL_001580.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_spot03_taki.c\x00" as *const u8 as
                         *const libc::c_char, 358 as libc::c_int);
    (*this).bufferIndex =
        ((*this).bufferIndex as libc::c_int == 0 as libc::c_int) as
            libc::c_int as u8_0;
    if (*this).state as libc::c_int >= WATERFALL_OPENING_IDLE as libc::c_int
           && (*this).state as libc::c_int <= WATERFALL_OPENED as libc::c_int
       {
        Audio_PlaySoundWaterfall(&mut (*this).dyna.actor.projectedPos,
                                 0.5f32);
    } else {
        Audio_PlaySoundWaterfall(&mut (*this).dyna.actor.projectedPos,
                                 1.0f32);
