...
extern "C" {
    ...
    #[no_mangle]
    fn Collider_SetCylinderPosition(collider: *mut ColliderCylinder,
                                    pos: *mut Vec3s);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gLakeHyliaFireArrowsCS: [CutsceneData; 0];
}
...
pub struct ShotSun {
    pub actor: Actor,
    pub collider: ColliderCylinder,
    pub actionFunc: ShotSunActionFunc,
    pub hitboxPos: Vec3s,
    pub timer: s16,
    pub unk_1A4: u8_0,
}
pub type ShotSunActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ShotSun, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const FAIRY_HEAL_BIG: C2RustUnnamed_25 = 7;
pub const FAIRY_HEAL: C2RustUnnamed_25 = 6;
pub const FAIRY_REVIVE_DEATH: C2RustUnnamed_25 = 5;
pub const FAIRY_SPAWNER: C2RustUnnamed_25 = 4;
pub const FAIRY_KOKIRI: C2RustUnnamed_25 = 3;
pub const FAIRY_HEAL_TIMED: C2RustUnnamed_25 = 2;
pub const FAIRY_REVIVE_BOTTLE: C2RustUnnamed_25 = 1;
pub const FAIRY_NAVI: C2RustUnnamed_25 = 0;
#[no_mangle]
pub static mut Shot_Sun_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_SHOT_SUN as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ShotSun_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ShotSun_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ShotSun = thisx as *mut ShotSun;
    let mut params: s32 = 0;
    // "Ocarina secret occurrence"
    osSyncPrintf(b"%d ---- \xe3\x82\xaa\xe3\x82\xab\xe3\x83\xaa\xe3\x83\x8a\xe3\x81\xae\xe7\xa7\x98\xe5\xaf\x86\xe7\x99\xba\xe7\x94\x9f!!!!!!!!!!!!!\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    params = (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    if params == 0x40 as libc::c_int || params == 0x41 as libc::c_int {
        (*this).unk_1A4 = 0 as libc::c_int as u8_0;
        (*this).actor.flags |=
            ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
        (*this).actor.flags |=
            ((1 as libc::c_int) << 25 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(func_80BADF0C as
                     unsafe extern "C" fn(_: *mut ShotSun,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.flags |=
        ...
        (*this).actionFunc =
            Some(ShotSun_UpdateHyliaSun as
                     unsafe extern "C" fn(_: *mut ShotSun,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.flags &=
...
#[no_mangle]
pub unsafe extern "C" fn ShotSun_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ShotSun = thisx as *mut ShotSun;
    let mut params: s32 =
...
#[no_mangle]
pub unsafe extern "C" fn ShotSun_SpawnFairy(mut this: *mut ShotSun,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut params: s32 =
        (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    let mut fairyType: s32 = 0;
    if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer -= 1
    } else {
        match params {
            64 => { fairyType = FAIRY_HEAL_BIG as libc::c_int }
            65 => { fairyType = FAIRY_HEAL_BIG as libc::c_int }
            _ => { }
        }
        ...
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    (*this).actor.home.pos.z, 0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn ShotSun_TriggerFairy(mut this: *mut ShotSun,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if func_8005B198() == (*this).actor.category as libc::c_int ||
           (*this).timer as libc::c_int != 0 as libc::c_int {
        (*this).actionFunc =
            Some(ShotSun_SpawnFairy as
                     unsafe extern "C" fn(_: *mut ShotSun,
                                          _: *mut GlobalContext) -> ());
        ...
        func_80078914(&mut (*this).actor.projectedPos,
                      0x287b as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80BADF0C(mut this: *mut ShotSun,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut params: s32 =
        (*this).actor.params as libc::c_int & 0xff as libc::c_int;
    if Math3D_Vec3fDistSq(&mut (*this).actor.world.pos,
        ...
        if (*this).unk_1A4 as libc::c_int == 0 as libc::c_int {
            if (*player).stateFlags2 &
                ...
                return
            } else { (*this).unk_1A4 = 1 as libc::c_int as u8_0 }
        }
        if (*this).unk_1A4 as libc::c_int == 1 as libc::c_int {
            func_8010BD58(globalCtx,
                          OCARINA_ACTION_FREE_PLAY as libc::c_int as u16_0);
            (*this).unk_1A4 = 2 as libc::c_int as u8_0
        } else if (*this).unk_1A4 as libc::c_int == 2 as libc::c_int &&
                      (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
                          OCARINA_MODE_04 as libc::c_int {
            if params == 0x40 as libc::c_int &&
                   (*globalCtx).msgCtx.lastPlayedSong as libc::c_int ==
                       OCARINA_SONG_SUNS as libc::c_int ||
                   params == 0x41 as libc::c_int &&
                       (*globalCtx).msgCtx.lastPlayedSong as libc::c_int ==
                           OCARINA_SONG_STORMS as libc::c_int {
                (*this).actionFunc =
                    Some(ShotSun_TriggerFairy as
                             unsafe extern "C" fn(_: *mut ShotSun,
                                                  _: *mut GlobalContext)
                                 -> ());
                OnePointCutscene_Attention(globalCtx, &mut (*this).actor);
                (*this).timer = 0 as libc::c_int as s16
            } else { (*this).unk_1A4 = 0 as libc::c_int as u8_0 }
            (*this).unk_1A4 = 0 as libc::c_int as u8_0
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ShotSun_UpdateHyliaSun(mut this: *mut ShotSun,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut cylinderPos: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        osSyncPrintf(b"\x1b[36mSHOT_SUN HIT!!!!!!!\n\x1b[m\x00" as *const u8
                         as *const libc::c_char);
        if gSaveContext.inventory.items[gItemSlots[ITEM_ARROW_FIRE as
                                                       libc::c_int as usize]
                                            as usize] as libc::c_int ==
               ITEM_NONE as libc::c_int {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_ITEM_ETCETERA as libc::c_int as s16, 700.0f32,
                        -800.0f32, 7261.0f32, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16,
                        7 as libc::c_int as s16);
            (*globalCtx).csCtx.segment =
                gSegments[((gLakeHyliaFireArrowsCS.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gLakeHyliaFireArrowsCS.as_mut_ptr()
                                                      as u32_0 &
            ...
            spawnPos.x = 700.0f32;
            spawnPos.y = -800.0f32;
            spawnPos.z = 7261.0f32;
            collectible =
                Item_DropCollectible(globalCtx, &mut spawnPos,
                                     ITEM00_MAGIC_LARGE as libc::c_int as
                                         s16);
            if !collectible.is_null() {
                (*collectible).unk_15A = 6000 as libc::c_int as s16;
        ...
        cylinderPos.x =
            ((*player).bodyPartsPos[7 as libc::c_int as usize].x +
                 (*globalCtx).envCtx.sunPos.x * (1.0f32 / 6.0f32)) as s16;
        cylinderPos.y =
            ((*player).bodyPartsPos[7 as libc::c_int as usize].y - 30.0f32 +
                 (*globalCtx).envCtx.sunPos.y * (1.0f32 / 6.0f32)) as s16;
        cylinderPos.z =
            ((*player).bodyPartsPos[7 as libc::c_int as usize].z +
                 (*globalCtx).envCtx.sunPos.z * (1.0f32 / 6.0f32)) as s16;
        (*this).hitboxPos = cylinderPos;
        Collider_SetCylinderPosition(&mut (*this).collider, &mut cylinderPos);
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ShotSun_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ShotSun = thisx as *mut ShotSun;
