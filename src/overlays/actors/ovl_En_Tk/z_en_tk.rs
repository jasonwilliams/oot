...
extern "C" {
    ...
    #[no_mangle]
    static mut gDampeDigAnim: AnimationHeader;
    #[no_mangle]
    static mut gDampeWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gDampeRestAnim: AnimationHeader;
    #[no_mangle]
    static mut gDampeEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gDampeEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gDampeEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gDampeShovelDL: [Gfx; 0];
    #[no_mangle]
    static mut gDampeEff1DL: [Gfx; 0];
    #[no_mangle]
    static mut gDampeEff2DL: [Gfx; 0];
    #[no_mangle]
    static mut gDampeSkel: FlexSkeletonHeader;
}
...
pub struct EnTk {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnTkActionFunc,
    pub collider: ColliderCylinder,
    pub h_1E0: s16,
    pub unk_1E2: [libc::c_char; 38],
    pub validDigHere: u8_0,
    pub rewardCount: [u8_0; 4],
    pub currentSpot: *mut Actor,
    pub currentReward: s32,
    pub blinkCycles: s16,
    pub rewardTimer: s16,
    pub actionCountdown: s16,
    pub h_21E: s16,
    pub unk_220: [libc::c_char; 2],
    pub eyeTextureIdx: s16,
    pub blinkCountdown: s16,
    pub headRot: s16,
...
pub type EnTkActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTk, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Tk_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TK as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_TK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTk>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnTkEff_Create(mut this: *mut EnTk,
                                        mut pos: *mut Vec3f,
                                        mut speed: *mut Vec3f,
                                        mut accel: *mut Vec3f,
                                        mut duration: u8_0, mut size: f32_0,
                                        mut growth: f32_0) {
    let mut i: s16 = 0;
    let mut eff: *mut EnTkEff = (*this).eff.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnTkEff; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnTkEff>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).active as libc::c_int != 1 as libc::c_int {
            (*eff).size = size;
            (*eff).growth = growth;
            (*eff).timeLeft = duration;
            (*eff).timeTotal = (*eff).timeLeft;
            (*eff).active = 1 as libc::c_int as u8_0;
            (*eff).pos = *pos;
            (*eff).accel = *accel;
            (*eff).speed = *speed;
            break ;
        } else { eff = eff.offset(1); i += 1 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTkEff_Update(mut this: *mut EnTk) {
    let mut i: s16 = 0;
    let mut eff: *mut EnTkEff = 0 as *mut EnTkEff;
    eff = (*this).eff.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnTkEff; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnTkEff>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).active as libc::c_int != 0 as libc::c_int {
            (*eff).timeLeft = (*eff).timeLeft.wrapping_sub(1);
            if (*eff).timeLeft as libc::c_int == 0 as libc::c_int {
                (*eff).active = 0 as libc::c_int as u8_0
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnTkEff_Draw(mut this: *mut EnTk,
    ...
    let mut eff: *mut EnTkEff = (*this).eff.as_mut_ptr();
    let mut imageIdx: s16 = 0;
    let mut gfxSetup: s16 = 0;
    let mut alpha: s16 = 0;
    let mut i: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tk_eff.c\x00" as *const u8 as
                        *const libc::c_char, 114 as libc::c_int);
    gfxSetup = 0 as libc::c_int as s16;
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnTkEff; 20]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnTkEff>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).active as libc::c_int != 0 as libc::c_int {
            if gfxSetup as libc::c_int == 0 as libc::c_int {
                (*__gfxCtx).polyXlu.p =
                    ...
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 16 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g).words.w1 = gDampeEff1DL.as_mut_ptr() as libc::c_uint;
                    ...
                    (100 as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                gfxSetup = 1 as libc::c_int as s16
            }
            alpha =
                ((*eff).timeLeft as libc::c_int as libc::c_float *
                     (255.0f32 /
                          (*eff).timeTotal as libc::c_int as libc::c_float))
                    as s16;
            ...
            Matrix_Scale((*eff).size, (*eff).size, 1.0f32,
            ...
            imageIdx =
                ((*eff).timeLeft as libc::c_int as libc::c_float *
                     ((::std::mem::size_of::<[*mut libc::c_void; 8]>() as
            ...
            (*_g_4).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gSegments[((dustTextures[imageIdx as usize] as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(dustTextures[imageIdx as
                                                                   usize] as
                                                      u32_0 &
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_5).words.w1 = gDampeEff2DL.as_mut_ptr() as libc::c_uint
        }
        eff = eff.offset(1);
        i += 1
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tk_eff.c\x00" as *const u8 as
                         *const libc::c_char, 154 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnTkEff_CreateDflt(mut this: *mut EnTk,
                                            mut pos: *mut Vec3f,
                                            mut duration: u8_0,
                                            mut size: f32_0,
                                            mut growth: f32_0,
                                            mut yAccelMax: f32_0) -> s32 {
    let mut speed: Vec3f =
    ...
    EnTkEff_Create(this, pos, &mut speed, &mut accel, duration, size, growth);
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_RestAnim(mut this: *mut EnTk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut anim: *mut AnimationHeader = &mut gDampeRestAnim;
    Animation_Change(&mut (*this).skelAnime, anim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gDampeRestAnim as
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_WalkAnim(mut this: *mut EnTk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut anim: *mut AnimationHeader = &mut gDampeWalkAnim;
    Animation_Change(&mut (*this).skelAnime, anim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gDampeRestAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionCountdown =
        Rand_S16Offset(240 as libc::c_int as s16, 240 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_DigAnim(mut this: *mut EnTk,
                                      mut globalCtx: *mut GlobalContext) {
    let mut anim: *mut AnimationHeader = &mut gDampeDigAnim;
    Animation_Change(&mut (*this).skelAnime, anim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gDampeDigAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    if EnTk_CheckNextSpot(this, globalCtx) >= 0 as libc::c_int {
        (*this).validDigHere = 1 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_UpdateEyes(mut this: *mut EnTk) {
    if (if (*this).blinkCountdown as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).blinkCountdown -= 1;
            (*this).blinkCountdown as libc::c_int
        }) == 0 as libc::c_int {
        (*this).eyeTextureIdx += 1;
        if (*this).eyeTextureIdx as libc::c_int > 2 as libc::c_int {
            (*this).blinkCycles -= 1;
            if ((*this).blinkCycles as libc::c_int) < 0 as libc::c_int {
                (*this).blinkCountdown =
                    Rand_S16Offset(30 as libc::c_int as s16,
                                   30 as libc::c_int as s16);
                (*this).blinkCycles = 2 as libc::c_int as s16;
                if Rand_ZeroOne() > 0.5f32 { (*this).blinkCycles += 1 }
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_CheckFacingPlayer(mut this: *mut EnTk) -> s32 {
    let mut v0: s16 = 0;
    let mut v1: s16 = 0;
    if (*this).actor.xyzDistToPlayerSq > 10000.0f32 {
        return 0 as libc::c_int
    }
    v0 = (*this).actor.shape.rot.y;
    v0 = (v0 as libc::c_int - (*this).h_21E as libc::c_int) as s16;
    v0 = (v0 as libc::c_int - (*this).headRot as libc::c_int) as s16;
    v1 =
        ((*this).actor.yawTowardsPlayer as libc::c_int - v0 as libc::c_int) as
            s16;
    if (if v1 as libc::c_int >= 0 as libc::c_int {
            v1 as libc::c_int
        } else { -(v1 as libc::c_int) }) < 0x1554 as libc::c_int {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_CheckNextSpot(mut this: *mut EnTk,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    prop =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PROP as libc::c_int as
                                             usize].head;
    while !prop.is_null() {
        if (*prop).id as libc::c_int != ACTOR_EN_IT as libc::c_int {
            prop = (*prop).next
        } else if prop == (*this).currentSpot {
            prop = (*prop).next
        } else {
            dy = (*prop).world.pos.y - (*this).actor.floorHeight;
            dxz = Actor_WorldDistXZToActor(&mut (*this).actor, prop);
            if dxz > 40.0f32 || dy > 10.0f32 {
                prop = (*prop).next
            } else {
                (*this).currentSpot = prop;
                return (*prop).params as s32
            }
        }
    }
    return -(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_CheckCurrentSpot(mut this: *mut EnTk) {
    let mut dxz: f32_0 = 0.;
    let mut dy: f32_0 = 0.;
    if !(*this).currentSpot.is_null() {
        dy = (*(*this).currentSpot).world.pos.y - (*this).actor.floorHeight;
        dxz =
            Actor_WorldDistXZToActor(&mut (*this).actor, (*this).currentSpot);
        if dxz > 40.0f32 || dy > 10.0f32 {
            (*this).currentSpot = 0 as *mut Actor
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Step(mut this: *mut EnTk,
                                   mut globalCtx: *mut GlobalContext)
 -> f32_0 {
    let mut stepFrames: [f32_0; 2] = [36.0f32, 10.0f32];
    let mut a1_: f32_0 = 0.;
    let mut i: s32 = 0;
    if (*this).skelAnime.curFrame == 0.0f32 ||
           (*this).skelAnime.curFrame == 25.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38b8 as libc::c_int as u16_0);
    }
    if (*this).skelAnime.animation !=
           &mut gDampeWalkAnim as *mut AnimationHeader as *mut libc::c_void {
        return 0.0f32
    }
    a1_ = (*this).skelAnime.curFrame;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[f32_0; 2]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<f32_0>()
                                                   as libc::c_ulong) as s32 {
        if a1_ < stepFrames[i as usize] + 12.0f32 &&
               a1_ >= stepFrames[i as usize] {
            break ;
        }
        i += 1
    }
    if i >=
        ...
        a1_ =
            0x8000 as libc::c_int as libc::c_float / 12.0f32 *
                (a1_ - stepFrames[i as usize]);
        return Math_SinS(a1_ as s16) * 2.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Orient(mut this: *mut EnTk,
                                     mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    path =
        &mut *(*globalCtx).setupPathList.offset(0 as libc::c_int as isize) as
            *mut Path;
    point =
    ...
    point = point.offset((*this).currentWaypoint as libc::c_int as isize);
    dx =
    ...
    if dx * dx + dz * dz < 10.0f32 {
        (*this).currentWaypoint += 1;
        if (*this).currentWaypoint as libc::c_int >=
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1C54C(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> u16_0 {
    let mut ret: u16_0 = 0;
    ret = Text_GetFaceReaction(globalCtx, 14 as libc::c_int as u32_0);
    if ret as libc::c_int != 0 as libc::c_int { return ret }
    if gSaveContext.infTable[13 as libc::c_int as usize] as libc::c_int &
           0x200 as libc::c_int != 0 {
        /* "Do you want me to dig here? ..." */
        return 0x5019 as libc::c_int as u16_0
    } else {
        /* "Hey kid! ..." */
        return 0x5018 as libc::c_int as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B1C5A0(mut globalCtx: *mut GlobalContext,
    ...
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        2 => {
            ...
            if (*thisx).textId as libc::c_int == 0x5028 as libc::c_int {
                gSaveContext.infTable[13 as libc::c_int as usize] =
                    (gSaveContext.infTable[13 as libc::c_int as usize] as
        ...
        4 => {
            if Message_ShouldAdvance(globalCtx) as libc::c_int != 0 &&
                   ((*thisx).textId as libc::c_int == 0x5018 as libc::c_int ||
                        (*thisx).textId as libc::c_int ==
                            0x5019 as libc::c_int) {
                if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                       1 as libc::c_int {
                    /* "Thanks a lot!" */
                    (*thisx).textId = 0x84 as libc::c_int as u16_0
                } else if (gSaveContext.rupees as libc::c_int) <
                              10 as libc::c_int {
                    /* "You don't have enough Rupees!" */
                    (*thisx).textId = 0x85 as libc::c_int as u16_0
                } else {
        ...
        5 => {
            if Message_ShouldAdvance(globalCtx) as libc::c_int != 0 &&
                   ((*thisx).textId as libc::c_int == 0x84 as libc::c_int ||
                        (*thisx).textId as libc::c_int == 0x85 as libc::c_int)
               {
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_ChooseReward(mut this: *mut EnTk) -> s32 {
    let mut luck: f32_0 = 0.;
    let mut reward: s32 = 0;
    luck = Rand_ZeroOne();
    if luck < 0.4f32 {
        reward = 0 as libc::c_int
    } else if (luck as libc::c_double) < 0.7f64 {
        reward = 1 as libc::c_int
    } else if (luck as libc::c_double) < 0.9f64 {
        reward = 2 as libc::c_int
    } else { reward = 3 as libc::c_int }
    match reward {
        0 => {
            if ((*this).rewardCount[0 as libc::c_int as usize] as libc::c_int)
                   < 8 as libc::c_int {
                (*this).rewardCount[0 as libc::c_int as usize] =
                    ((*this).rewardCount[0 as libc::c_int as usize] as
                         libc::c_int + 1 as libc::c_int) as u8_0;
                return reward
            }
        }
        1 => {
            if ((*this).rewardCount[1 as libc::c_int as usize] as libc::c_int)
                   < 4 as libc::c_int {
                (*this).rewardCount[1 as libc::c_int as usize] =
                    ((*this).rewardCount[1 as libc::c_int as usize] as
                         libc::c_int + 1 as libc::c_int) as u8_0;
                return reward
            }
        }
        2 => {
            if ((*this).rewardCount[2 as libc::c_int as usize] as libc::c_int)
                   < 2 as libc::c_int {
                (*this).rewardCount[2 as libc::c_int as usize] =
                    ((*this).rewardCount[2 as libc::c_int as usize] as
                         libc::c_int + 1 as libc::c_int) as u8_0;
                return reward
            }
        }
        3 => {
            if ((*this).rewardCount[3 as libc::c_int as usize] as libc::c_int)
                   < 1 as libc::c_int {
                (*this).rewardCount[3 as libc::c_int as usize] =
                    ((*this).rewardCount[3 as libc::c_int as usize] as
                         libc::c_int + 1 as libc::c_int) as u8_0;
                return reward
            }
        }
    ...
    if ((*this).rewardCount[0 as libc::c_int as usize] as libc::c_int) <
           8 as libc::c_int {
        (*this).rewardCount[0 as libc::c_int as usize] =
            ((*this).rewardCount[0 as libc::c_int as usize] as libc::c_int +
                 1 as libc::c_int) as u8_0;
        reward = 0 as libc::c_int
    } else if ((*this).rewardCount[1 as libc::c_int as usize] as libc::c_int)
                  < 4 as libc::c_int {
        (*this).rewardCount[1 as libc::c_int as usize] =
            ((*this).rewardCount[1 as libc::c_int as usize] as libc::c_int +
                 1 as libc::c_int) as u8_0;
        reward = 1 as libc::c_int
    } else if ((*this).rewardCount[2 as libc::c_int as usize] as libc::c_int)
                  < 2 as libc::c_int {
        (*this).rewardCount[2 as libc::c_int as usize] =
            ((*this).rewardCount[2 as libc::c_int as usize] as libc::c_int +
                 1 as libc::c_int) as u8_0;
        reward = 2 as libc::c_int
    } else if ((*this).rewardCount[3 as libc::c_int as usize] as libc::c_int)
                  < 1 as libc::c_int {
        (*this).rewardCount[3 as libc::c_int as usize] =
            ((*this).rewardCount[3 as libc::c_int as usize] as libc::c_int +
                 1 as libc::c_int) as u8_0;
        reward = 3 as libc::c_int
    } else {
        reward = 0 as libc::c_int;
        (*this).rewardCount[0 as libc::c_int as usize] =
            1 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_DigEff(mut this: *mut EnTk) {
    let mut pos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut speed: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.3f32, z: 0.0f32,}; init };
    if (*this).skelAnime.curFrame >= 32.0f32 &&
           (*this).skelAnime.curFrame < 40.0f32 {
        pos.x = (Rand_ZeroOne() - 0.5f32) * 12.0f32 + (*this).v3f_304.x;
        pos.y = (Rand_ZeroOne() - 0.5f32) * 8.0f32 + (*this).v3f_304.y;
        pos.z = (Rand_ZeroOne() - 0.5f32) * 12.0f32 + (*this).v3f_304.z;
        EnTkEff_CreateDflt(this, &mut pos, 12 as libc::c_int as u8_0, 0.2f32,
                           0.1f32, 0.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTk = thisx as *mut EnTk;
    let mut pad: s32 = 0;
    ActorShape_Init(&mut (*this).actor.shape, 0 as libc::c_int as f32_0,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 24.0f32);
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gDampeSkel,
                       0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 18 as libc::c_int);
    Animation_Change(&mut (*this).skelAnime, &mut gDampeRestAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gDampeRestAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
    ...
    if gSaveContext.dayTime as libc::c_int <= 0xc000 as libc::c_int ||
           gSaveContext.dayTime as libc::c_int >= 0xe000 as libc::c_int ||
           gSaveContext.linkAge == 0 as libc::c_int ||
           (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT02 as libc::c_int
       {
    ...
    (*this).currentReward = -(1 as libc::c_int);
    (*this).currentSpot = 0 as *mut Actor;
    (*this).actionFunc =
        Some(EnTk_Rest as
                 unsafe extern "C" fn(_: *mut EnTk, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTk = thisx as *mut EnTk;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Rest(mut this: *mut EnTk,
                                   mut globalCtx: *mut GlobalContext) {
    let mut v1: s16 = 0;
    let mut a1_: s16 = 0;
    if (*this).h_1E0 as libc::c_int != 0 as libc::c_int {
        v1 = (*this).actor.shape.rot.y;
        v1 = (v1 as libc::c_int - (*this).h_21E as libc::c_int) as s16;
        v1 =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 v1 as libc::c_int) as s16;
        if (*this).h_1E0 as libc::c_int == 2 as libc::c_int {
            EnTk_DigAnim(this, globalCtx);
            (*this).h_1E0 = 0 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnTk_Dig as
                         unsafe extern "C" fn(_: *mut EnTk,
                                              _: *mut GlobalContext) -> ());
            return
        }
        func_800343CC(globalCtx, &mut (*this).actor, &mut (*this).h_1E0,
                      (*this).collider.dim.radius as libc::c_int as
                          libc::c_float + 30.0f32,
                      Some(func_80B1C54C as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> u16_0),
                      Some(func_80B1C5A0 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> s16));
        ...
        v1 =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 v1 as libc::c_int) as s16;
        (*this).actionCountdown = 0 as libc::c_int as s16;
        func_800343CC(globalCtx, &mut (*this).actor, &mut (*this).h_1E0,
                      (*this).collider.dim.radius as libc::c_int as
                          libc::c_float + 30.0f32,
                      Some(func_80B1C54C as
        ...
        v1 =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 v1 as libc::c_int) as s16;
        (*this).actionCountdown = 0 as libc::c_int as s16;
        (*this).h_1E0 = 1 as libc::c_int as s16
    } else if (if (*this).actionCountdown as libc::c_int == 0 as libc::c_int {
                   0 as libc::c_int
               } else {
                   (*this).actionCountdown -= 1;
                   (*this).actionCountdown as libc::c_int
               }) == 0 as libc::c_int {
    ...
    } else { v1 = 0 as libc::c_int as s16 }
    a1_ =
        if (-(v1 as libc::c_int)) < 1270 as libc::c_int {
            1270 as libc::c_int
        } else if -(v1 as libc::c_int) > 10730 as libc::c_int {
            10730 as libc::c_int
        } else { -(v1 as libc::c_int) } as s16;
    Math_SmoothStepToS(&mut (*this).headRot, a1_, 6 as libc::c_int as s16,
                       1000 as libc::c_int as s16, 1 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Walk(mut this: *mut EnTk,
                                   mut globalCtx: *mut GlobalContext) {
    if (*this).h_1E0 as libc::c_int == 2 as libc::c_int {
        EnTk_DigAnim(this, globalCtx);
        (*this).h_1E0 = 0 as libc::c_int as s16;
        ...
        if (*this).actionCountdown as libc::c_int == 0 as libc::c_int {
        } else { (*this).actionCountdown -= 1 };
        if EnTk_CheckFacingPlayer(this) != 0 ||
               (*this).actionCountdown as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_Dig(mut this: *mut EnTk,
                                  mut globalCtx: *mut GlobalContext) {
    let mut rewardOrigin: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut rewardPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut rewardParams: [s32; 5] =
        [ITEM00_RUPEE_GREEN as libc::c_int, ITEM00_RUPEE_BLUE as libc::c_int,
         ITEM00_RUPEE_RED as libc::c_int, ITEM00_RUPEE_PURPLE as libc::c_int,
         ITEM00_HEART_PIECE as libc::c_int];
    EnTk_DigEff(this);
    if (*this).skelAnime.curFrame == 32.0f32 {
        /* What's gonna come out? */
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x28c8 as libc::c_int as u16_0);
        (*this).rewardTimer = 0 as libc::c_int as s16;
        if (*this).validDigHere as libc::c_int == 1 as libc::c_int {
            rewardOrigin.x = 0.0f32;
            rewardOrigin.y = 0.0f32;
            rewardOrigin.z = -40.0f32;
            Matrix_RotateY((*this).actor.shape.rot.y as f32_0,
                           MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_MultVec3f(&mut rewardOrigin, &mut rewardPos);
            ...
            if (*this).currentReward == 3 as libc::c_int {
                /*
                ...
                if gSaveContext.itemGetInf[1 as libc::c_int as usize] as
                    ...
                    (*this).currentReward = 4 as libc::c_int
                }
            }
            Item_DropCollectible(globalCtx, &mut rewardPos,
                                 rewardParams[(*this).currentReward as usize]
                                     as s16);
        }
    }
    if (*this).skelAnime.curFrame >= 32.0f32 &&
           (*this).rewardTimer as libc::c_int == 10 as libc::c_int {
        /* Play a reward sound shortly after digging */
        if (*this).validDigHere as libc::c_int == 0 as libc::c_int {
            /* Bad dig spot */
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x4806 as libc::c_int as u16_0);
        } else if (*this).currentReward == 4 as libc::c_int {
            /* Heart piece */
            ...
            /* Rupee */
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x4807 as libc::c_int as u16_0);
        }
    }
    (*this).rewardTimer += 1;
    if Animation_OnFrame(&mut (*this).skelAnime, (*this).skelAnime.endFrame)
           != 0 {
        if (*this).currentReward < 0 as libc::c_int {
            /* "Nope, nothing here!" */
            Message_StartTextbox(globalCtx, 0x501a as libc::c_int as u16_0,
                                 0 as *mut Actor);
        } else { Message_CloseTextbox(globalCtx); }
        EnTk_RestAnim(this, globalCtx);
        (*this).currentReward = -(1 as libc::c_int);
        (*this).validDigHere = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnTk_Rest as
                     unsafe extern "C" fn(_: *mut EnTk, _: *mut GlobalContext)
                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTk = thisx as *mut EnTk;
    let mut pad: s32 = 0;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 40.0f32, 10.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B1D200(mut globalCtx: *mut GlobalContext) {
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tk.c\x00" as *const u8 as *const libc::c_char,
                    1188 as libc::c_int);
    ...
    (*_g).words.w1 = gDampeShovelDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tk.c\x00" as *const u8 as *const libc::c_char,
                     1190 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    match limbIndex {
        ...
        16 => {
            /* Limb 16 - Jaw */
            (*this).h_21E =
                ((*this).h_21E as libc::c_int + (*rot).y as libc::c_int) as
                    s16;
            (*rot).y =
...
#[no_mangle]
pub unsafe extern "C" fn EnTk_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    let mut this: *mut EnTk = thisx as *mut EnTk;
    let mut sp28: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 4600.0f32,}; init };
    let mut sp1C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    /* Limb 16 - Jaw */
    if limbIndex == 16 as libc::c_int {
        Matrix_MultVec3f(&mut sp1C, &mut (*this).actor.focus.pos);
    }
    /* Limb 14 - Neck */
    if limbIndex == 14 as libc::c_int {
        Matrix_MultVec3f(&mut sp28, &mut (*this).v3f_304);
        func_80B1D200(globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTk_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut sEyesSegments: [*mut libc::c_void; 3] =
        unsafe {
            [gDampeEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDampeEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gDampeEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnTk = thisx as *mut EnTk;
    Matrix_Push();
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        gSegments[((sEyesSegments[(*this).eyeTextureIdx as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sEyesSegments[(*this).eyeTextureIdx
                                                            as usize] as u32_0
                                              &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
