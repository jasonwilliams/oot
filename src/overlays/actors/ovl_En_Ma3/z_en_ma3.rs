...
pub struct EnMa3 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnMa3ActionFunc,
...
pub type EnMa3ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMa3, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const MALON_ADULT_LIMB_MAX: C2RustUnnamed_24 = 19;
pub const MALON_ADULT_LIMB_HEAD: C2RustUnnamed_24 = 18;
pub const MALON_ADULT_LIMB_RIGHT_HAND: C2RustUnnamed_24 = 17;
pub const MALON_ADULT_LIMB_RIGHT_ARM: C2RustUnnamed_24 = 16;
pub const MALON_ADULT_LIMB_RIGHT_SHOULDER: C2RustUnnamed_24 = 15;
pub const MALON_ADULT_LIMB_LEFT_HAND: C2RustUnnamed_24 = 14;
pub const MALON_ADULT_LIMB_LEFT_ARM: C2RustUnnamed_24 = 13;
pub const MALON_ADULT_LIMB_LEFT_SHOULDER: C2RustUnnamed_24 = 12;
pub const MALON_ADULT_LIMB_CHEST_AND_NECK: C2RustUnnamed_24 = 11;
pub const MALON_ADULT_LIMB_DRESS: C2RustUnnamed_24 = 10;
pub const MALON_ADULT_LIMB_TORSO: C2RustUnnamed_24 = 9;
pub const MALON_ADULT_LIMB_RIGHT_FOOT: C2RustUnnamed_24 = 8;
pub const MALON_ADULT_LIMB_RIGHT_LEG: C2RustUnnamed_24 = 7;
pub const MALON_ADULT_LIMB_RIGHT_THIGH: C2RustUnnamed_24 = 6;
pub const MALON_ADULT_LIMB_LEFT_FOOT: C2RustUnnamed_24 = 5;
pub const MALON_ADULT_LIMB_LEFT_LEG: C2RustUnnamed_24 = 4;
pub const MALON_ADULT_LIMB_LEFT_THIGH: C2RustUnnamed_24 = 3;
pub const MALON_ADULT_LIMB_LOWER_CONTROL: C2RustUnnamed_24 = 2;
pub const MALON_ADULT_LIMB_ROOT: C2RustUnnamed_24 = 1;
pub const MALON_ADULT_LIMB_NONE: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut En_Ma3_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MA3 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnMa3>() as libc::c_ulong,
                          init:
                                                      ...
                                                      ActorFunc>(Some(EnMa3_Draw
                                                                          ...
                                                                          unsafe extern "C" fn(_:
                                                                                               ...
                                                                                               _:
                                                                                                   *mut GlobalContext)
                                                                              ->
                                                                                  ())),}; // weirdness with this necessary to match
            init
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA2AA0(mut globalCtx: *mut GlobalContext,
    ...
    let mut timer1ValuePtr: *mut s16 = 0 as *mut s16;
    if gSaveContext.infTable[11 as libc::c_int as usize] as libc::c_int &
           0x100 as libc::c_int == 0 {
        return 0x2000 as libc::c_int as u16_0
    }
    timer1ValuePtr = &mut gSaveContext.timer1Value;
    if gSaveContext.eventInf[0 as libc::c_int as usize] as libc::c_int &
        ...
        if gSaveContext.timer1Value as libc::c_int >= 0xd3 as libc::c_int {
            return 0x208e as libc::c_int as u16_0
        }
        if gSaveContext.highScores[HS_HORSE_RACE as libc::c_int as usize] ==
               0 as libc::c_int ||
               gSaveContext.highScores[HS_HORSE_RACE as libc::c_int as usize]
                   >= 0xb4 as libc::c_int {
            gSaveContext.highScores[HS_HORSE_RACE as libc::c_int as usize] =
                0xb4 as libc::c_int;
        ...
        if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
               ...
               (gSaveContext.timer1Value as libc::c_int) < 0x32 as libc::c_int
           {
            return 0x208f as libc::c_int as u16_0
        } else if (gSaveContext.timer1Value as libc::c_int) <
                      gSaveContext.highScores[HS_HORSE_RACE as libc::c_int as
                                                  usize] {
            return 0x2012 as libc::c_int as u16_0
        } else { return 0x2004 as libc::c_int as u16_0 }
    }
    if (*player).stateFlags1 & 0x800000 as libc::c_int as libc::c_uint == 0 &&
           Actor_FindNearby(globalCtx, thisx,
                            ACTOR_EN_HORSE as libc::c_int as s16,
                            1 as libc::c_int as u8_0, 1200.0f32).is_null() {
        return 0x2001 as libc::c_int as u16_0
    }
    if gSaveContext.infTable[11 as libc::c_int as usize] as libc::c_int &
           0x200 as libc::c_int == 0 {
        return 0x2002 as libc::c_int as u16_0
    } else { return 0x2003 as libc::c_int as u16_0 };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AA2BD4(mut globalCtx: *mut GlobalContext,
    ...
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
                ...
                if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                    ...
                    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as
                        ...
                        Message_ContinueTextbox(globalCtx,
                                                0x2091 as libc::c_int as
                                                    u16_0);
                    } else if gSaveContext.highScores[HS_HORSE_RACE as
                                                          libc::c_int as
                                                          usize] ==
                                  0 as libc::c_int {
                        Message_ContinueTextbox(globalCtx,
                                                0x2092 as libc::c_int as
                                                    u16_0);
                    } else {
                        Message_ContinueTextbox(globalCtx,
                                                0x2090 as libc::c_int as
                                                    u16_0);
                    }
                }
            }
        ...
        2 => {
            ...
            match (*thisx).textId as libc::c_int {
                ...
                8335 => {
                    gSaveContext.eventChkInf[1 as libc::c_int as usize] =
                        (gSaveContext.eventChkInf[1 as libc::c_int as usize]
                             as libc::c_int | 0x4000 as libc::c_int) as u16_0;
                    current_block_35 = 15537180957427692153;
                }
                8196 | 8210 => { current_block_35 = 15537180957427692153; }
                8334 => { current_block_35 = 16393110436039791164; }
                8194 => {
                    gSaveContext.infTable[11 as libc::c_int as usize] =
                        (gSaveContext.infTable[11 as libc::c_int as usize] as
                             libc::c_int | 0x200 as libc::c_int) as u16_0;
                    current_block_35 = 5756141056716048759;
                }
                8195 => { current_block_35 = 5756141056716048759; }
                _ => {
                    ret = 0 as libc::c_int as s16;
                    current_block_35 = 7226443171521532240;
                }
            ...
            match current_block_35 {
                15537180957427692153 => {
                    if gSaveContext.highScores[HS_HORSE_RACE as libc::c_int as
                                                   usize] >
                           gSaveContext.timer1Value as libc::c_int {
                        gSaveContext.highScores[HS_HORSE_RACE as libc::c_int
                                                    as usize] =
                            gSaveContext.timer1Value as s32
                    }
                    current_block_35 = 16393110436039791164;
                }
                5756141056716048759 => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA2E54(mut this: *mut EnMa3,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA2EC8(mut this: *mut EnMa3,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if gSaveContext.linkAge == 1 as libc::c_int { return 2 as libc::c_int }
    if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int &
           0x100 as libc::c_int == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA2F28(mut this: *mut EnMa3) -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_UpdateEyes(mut this: *mut EnMa3) {
    if func_80AA2F28(this) == 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_ChangeAnim(mut this: *mut EnMa3,
                                          mut idx: s32) {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa3 = thisx as *mut EnMa3;
    let mut pad: s32 = 0;
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            ...
                            &mut sColChkInfoInit);
    match func_80AA2EC8(this, globalCtx) {
        0 => {
            EnMa3_ChangeAnim(this, 0 as libc::c_int);
            (*this).actionFunc =
                Some(func_80AA3200 as
                         unsafe extern "C" fn(_: *mut EnMa3,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
            EnMa3_ChangeAnim(this, 0 as libc::c_int);
        ...
        2 => { Actor_Kill(&mut (*this).actor); return }
        _ => { }
    }
    ...
    (*this).unk_1E0.unk_00 = 0 as libc::c_int as u16_0 as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnMa3_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa3 = thisx as *mut EnMa3;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AA3200(mut this: *mut EnMa3,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMa3 = thisx as *mut EnMa3;
    let mut pad: s32 = 0;
    ...
    func_800343CC(globalCtx, &mut (*this).actor, &mut (*this).unk_1E0.unk_00,
                  (*this).collider.dim.radius as f32_0 + 150.0f32,
                  Some(func_80AA2AA0 as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> u16_0),
                  Some(func_80AA2BD4 as
                           unsafe extern "C" fn(_: *mut GlobalContext,
                                                _: *mut Actor) -> s16));
    if (*this).unk_1E0.unk_00 as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == MALON_ADULT_LIMB_LEFT_THIGH as libc::c_int ||
           limbIndex == MALON_ADULT_LIMB_RIGHT_THIGH as libc::c_int {
        *dList = 0 as *mut Gfx
    }
    if limbIndex == MALON_ADULT_LIMB_HEAD as libc::c_int {
    ...
    if limbIndex == MALON_ADULT_LIMB_CHEST_AND_NECK as libc::c_int {
    ...
    if limbIndex == MALON_ADULT_LIMB_CHEST_AND_NECK as libc::c_int ||
           limbIndex == MALON_ADULT_LIMB_LEFT_SHOULDER as libc::c_int ||
           limbIndex == MALON_ADULT_LIMB_RIGHT_SHOULDER as libc::c_int {
        (*rot).y =
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ma3.c\x00" as *const u8 as *const libc::c_char,
                    927 as libc::c_int);
    if limbIndex == MALON_ADULT_LIMB_HEAD as libc::c_int {
        Matrix_MultVec3f(&mut vec, &mut (*this).actor.focus.pos);
    }
    if limbIndex == MALON_ADULT_LIMB_LEFT_HAND as libc::c_int &&
           (*this).skelAnime.animation ==
...
#[no_mangle]
pub unsafe extern "C" fn EnMa3_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnMa3_OverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3f,
