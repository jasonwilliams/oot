...
extern "C" {
    ...
    fn Item_DropCollectibleRandom(globalCtx: *mut GlobalContext,
                                  ...
                                  params: s16);
    #[no_mangle]
    fn EffectSsLightning_Spawn(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                               primColor: *mut Color_RGBA8,
                               envColor: *mut Color_RGBA8, scale: s16,
                               yaw: s16, life: s16, numBolts: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBariWaitingAnim: AnimationHeader;
    #[no_mangle]
    static mut gBariRetaliatingAnim: AnimationHeader;
    #[no_mangle]
    static mut gBariMovingArmsDownAnim: AnimationHeader;
    #[no_mangle]
    static mut gBariLurkingAnim: AnimationHeader;
    #[no_mangle]
    static mut gBariInnerHoodDL: [Gfx; 0];
    #[no_mangle]
    static mut gBariNucleusDL: [Gfx; 0];
    #[no_mangle]
    static mut gBariOuterHoodDL: [Gfx; 0];
    #[no_mangle]
    static mut gBariSkel: SkeletonHeader;
}
...
pub struct EnVali {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnValiActionFunc,
    pub lightningTimer: u8_0,
    pub slingshotReactionTimer: u8_0,
    pub timer: s16,
    pub jointTable: [Vec3s; 29],
    pub morphTable: [Vec3s; 29],
    pub armScale: f32_0,
    pub floatHomeHeight: f32_0,
    pub leftArmCollider: ColliderQuad,
    pub rightArmCollider: ColliderQuad,
    pub bodyCollider: ColliderCylinder,
}
pub type EnValiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const EN_VALI_LIMB_MAX: C2RustUnnamed_22 = 29;
pub const EN_VALI_LIMB_OUTER_HOOD: C2RustUnnamed_22 = 28;
pub const EN_VALI_LIMB_INNER_HOOD: C2RustUnnamed_22 = 27;
pub const EN_VALI_LIMB_RIGHT_UPPER_ARM: C2RustUnnamed_22 = 26;
pub const EN_VALI_LIMB_RIGHT_FOREARM: C2RustUnnamed_22 = 25;
pub const EN_VALI_LIMB_RIGHT_CLAW_BODY: C2RustUnnamed_22 = 24;
pub const EN_VALI_LIMB_RIGHT_CLAW_TIP: C2RustUnnamed_22 = 23;
pub const EN_VALI_LIMB_RIGHT_CLAW_TIP_BASE: C2RustUnnamed_22 = 22;
pub const EN_VALI_LIMB_RIGHT_CLAW_BODY_BASE: C2RustUnnamed_22 = 21;
pub const EN_VALI_LIMB_RIGHT_FOREARM_BASE: C2RustUnnamed_22 = 20;
pub const EN_VALI_LIMB_RIGHT_UPPER_ARM_BASE: C2RustUnnamed_22 = 19;
pub const EN_VALI_LIMB_RIGHT_ARM_BASE: C2RustUnnamed_22 = 18;
pub const EN_VALI_LIMB_LEFT_UPPER_ARM: C2RustUnnamed_22 = 17;
pub const EN_VALI_LIMB_LEFT_FOREARM: C2RustUnnamed_22 = 16;
pub const EN_VALI_LIMB_LEFT_CLAW_BODY: C2RustUnnamed_22 = 15;
pub const EN_VALI_LIMB_LEFT_CLAW_TIP: C2RustUnnamed_22 = 14;
pub const EN_VALI_LIMB_LEFT_CLAW_TIP_BASE: C2RustUnnamed_22 = 13;
pub const EN_VALI_LIMB_LEFT_CLAW_BODY_BASE: C2RustUnnamed_22 = 12;
pub const EN_VALI_LIMB_LEFT_FOREARM_BASE: C2RustUnnamed_22 = 11;
pub const EN_VALI_LIMB_LEFT_UPPER_ARM_BASE: C2RustUnnamed_22 = 10;
pub const EN_VALI_LIMB_LEFT_ARM_BASE: C2RustUnnamed_22 = 9;
pub const EN_VALI_LIMB_LEFT_MANDIBLE: C2RustUnnamed_22 = 8;
pub const EN_VALI_LIMB_LEFT_MANDIBLE_BASE: C2RustUnnamed_22 = 7;
pub const EN_VALI_LIMB_LEFT_MANDIBLE_BASE_BASE: C2RustUnnamed_22 = 6;
pub const EN_VALI_LIMB_RIGHT_MANDIBLE: C2RustUnnamed_22 = 5;
pub const EN_VALI_LIMB_RIGHT_MANDIBLE_BASE: C2RustUnnamed_22 = 4;
pub const EN_VALI_LIMB_RIGHT_MANDIBLE_BASE_BASE: C2RustUnnamed_22 = 3;
pub const EN_VALI_LIMB_NUCLEUS: C2RustUnnamed_22 = 2;
pub const EN_VALI_LIMB_NUCLEUS_BASE: C2RustUnnamed_22 = 1;
pub const EN_VALI_LIMB_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const BARI_TYPE_SWORD_DAMAGE: C2RustUnnamed_23 = 1;
pub const BARI_TYPE_NORMAL: C2RustUnnamed_23 = 0;
pub const BARI_DMGEFF_NONE: C2RustUnnamed_24 = 0;
pub const BARI_DMGEFF_ICE: C2RustUnnamed_24 = 3;
pub const BARI_DMGEFF_FIRE: C2RustUnnamed_24 = 2;
pub const BARI_DMGEFF_SWORD: C2RustUnnamed_24 = 15;
pub const BARI_DMGEFF_STUN: C2RustUnnamed_24 = 1;
pub const BARI_DMGEFF_SLINGSHOT: C2RustUnnamed_24 = 14;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut En_Vali_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_VALI as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_VALI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnVali>() as
                                  libc::c_ulong,
                          init:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 2 as libc::c_int as u8_0,
                                   cylRadius: 18 as libc::c_int as s16,
                                   cylHeight: 32 as libc::c_int as s16,
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (BARI_DMGEFF_STUN as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BARI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (BARI_DMGEFF_SLINGSHOT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BARI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (BARI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (BARI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BARI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BARI_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BARI_DMGEFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (BARI_DMGEFF_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (BARI_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVali = thisx as *mut EnVali;
    let mut bgId: s32 = 0;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 27.0f32);
    (*this).actor.shape.shadowAlpha = 155 as libc::c_int as u8_0;
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gBariSkel,
                   &mut gBariLurkingAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(),
                   EN_VALI_LIMB_MAX as libc::c_int);
    Collider_InitQuad(globalCtx, &mut (*this).leftArmCollider);
    Collider_SetQuad(globalCtx, &mut (*this).leftArmCollider,
                     &mut (*this).actor, &mut sQuadInit);
    Collider_InitQuad(globalCtx, &mut (*this).rightArmCollider);
    Collider_SetQuad(globalCtx, &mut (*this).rightArmCollider,
                     &mut (*this).actor, &mut sQuadInit);
    ...
    (*this).actor.params = BARI_TYPE_NORMAL as libc::c_int as s16;
    if (*this).actor.floorHeight == -32000.0f32 {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnVali = thisx as *mut EnVali;
    Collider_DestroyQuad(globalCtx, &mut (*this).leftArmCollider);
    Collider_DestroyQuad(globalCtx, &mut (*this).rightArmCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupLurk(mut this: *mut EnVali) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gBariLurkingAnim);
    ...
    (*this).actionFunc =
        Some(EnVali_Lurk as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupDropAppear(mut this: *mut EnVali) {
    (*this).actor.draw =
        Some(EnVali_Draw as
    ...
    (*this).actionFunc =
        Some(EnVali_DropAppear as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupFloatIdle(mut this: *mut EnVali) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gBariWaitingAnim,
                          -3.0f32);
    (*this).rightArmCollider.dim.quad[1 as libc::c_int as usize] =
        (*this).actor.world.pos;
    (*this).rightArmCollider.dim.quad[0 as libc::c_int as usize] =
        (*this).rightArmCollider.dim.quad[1 as libc::c_int as usize];
    (*this).leftArmCollider.dim.quad[1 as libc::c_int as usize] =
        (*this).rightArmCollider.dim.quad[0 as libc::c_int as usize];
    (*this).leftArmCollider.dim.quad[0 as libc::c_int as usize] =
        (*this).leftArmCollider.dim.quad[1 as libc::c_int as usize];
    (*this).rightArmCollider.dim.quad[3 as libc::c_int as usize] =
        (*this).leftArmCollider.dim.quad[0 as libc::c_int as usize];
    (*this).rightArmCollider.dim.quad[2 as libc::c_int as usize] =
        (*this).rightArmCollider.dim.quad[3 as libc::c_int as usize];
    (*this).leftArmCollider.dim.quad[3 as libc::c_int as usize] =
        (*this).rightArmCollider.dim.quad[2 as libc::c_int as usize];
    (*this).leftArmCollider.dim.quad[2 as libc::c_int as usize] =
        (*this).leftArmCollider.dim.quad[3 as libc::c_int as usize];
    (*this).rightArmCollider.dim.quad[1 as libc::c_int as usize].y =
        (*this).actor.world.pos.y - 10.0f32;
    (*this).rightArmCollider.dim.quad[0 as libc::c_int as usize].y =
        (*this).rightArmCollider.dim.quad[1 as libc::c_int as usize].y;
    (*this).leftArmCollider.dim.quad[1 as libc::c_int as usize].y =
        (*this).rightArmCollider.dim.quad[0 as libc::c_int as usize].y;
    (*this).leftArmCollider.dim.quad[0 as libc::c_int as usize].y =
        (*this).leftArmCollider.dim.quad[1 as libc::c_int as usize].y;
    (*this).rightArmCollider.dim.quad[3 as libc::c_int as usize].y =
        (*this).leftArmCollider.dim.quad[0 as libc::c_int as usize].y;
    (*this).rightArmCollider.dim.quad[2 as libc::c_int as usize].y =
        (*this).rightArmCollider.dim.quad[3 as libc::c_int as usize].y;
    (*this).leftArmCollider.dim.quad[3 as libc::c_int as usize].y =
        (*this).rightArmCollider.dim.quad[2 as libc::c_int as usize].y;
    (*this).leftArmCollider.dim.quad[2 as libc::c_int as usize].y =
        (*this).leftArmCollider.dim.quad[3 as libc::c_int as usize].y;
    (*this).actor.flags &=
    ...
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).slingshotReactionTimer = 0 as libc::c_int as u8_0;
    (*this).floatHomeHeight = (*this).actor.world.pos.y;
    (*this).actionFunc =
        Some(EnVali_FloatIdle as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupAttacked(mut this: *mut EnVali) {
    (*this).lightningTimer = 20 as libc::c_int as u8_0; // Shock?
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnVali_Attacked as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupRetaliate(mut this: *mut EnVali) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gBariRetaliatingAnim, -5.0f32);
    ...
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnVali_Retaliate as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupMoveArmsDown(mut this: *mut EnVali) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gBariMovingArmsDownAnim);
    (*this).actionFunc =
        Some(EnVali_MoveArmsDown as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupBurnt(mut this: *mut EnVali) {
    (*this).timer = 2 as libc::c_int as s16;
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
                         ...
                         30 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnVali_Burnt as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupDivideAndDie(mut this: *mut EnVali,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 3 as libc::c_int {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_BILI as libc::c_int as s16,
        ...
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int +
                 0x10000 as libc::c_int / 3 as libc::c_int) as s16;
        i += 1
    }
    ...
    (*this).timer =
        Rand_S16Offset(10 as libc::c_int as s16, 10 as libc::c_int as s16);
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                              40 as libc::c_int,
                              0x3887 as libc::c_int as u16_0);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.draw = None;
    (*this).actionFunc =
        Some(EnVali_DivideAndDie as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupStunned(mut this: *mut EnVali) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gBariWaitingAnim,
                              10.0f32);
    ...
    (*this).bodyCollider.info.bumper.effect = 0 as libc::c_int as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x389e as libc::c_int as u16_0);
    (*this).actor.velocity.y = 1.0f32;
    (*this).actionFunc =
        Some(EnVali_Stunned as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupFrozen(mut this: *mut EnVali) {
    (*this).actor.velocity.y = 0.0f32;
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         255 as libc::c_int as s16,
                         0x2000 as libc::c_int as s16,
    ...
    (*this).actionFunc =
        Some(EnVali_Frozen as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetupReturnToLurk(mut this: *mut EnVali) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gBariLurkingAnim,
                              10.0f32);
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnVali_ReturnToLurk as
                 unsafe extern "C" fn(_: *mut EnVali, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_DischargeLightning(mut this: *mut EnVali,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    while i < 4 as libc::c_int {
        ...
        sin =
            Math_SinS(Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                      as
                                                                      usize]));
        if ((*this).lightningTimer as libc::c_int + (i << 1 as libc::c_int)) %
               4 as libc::c_int == 0 {
            yaw =
                (Rand_CenteredFloat(12288.0f32) as s16 as libc::c_int +
                     i * 0x4000 as libc::c_int + 0x2000 as libc::c_int) as
                    s16;
            pos.x =
                (*this).actor.world.pos.x + Math_SinS(yaw) * 12.0f32 * cos;
            pos.y =
                (*this).actor.world.pos.y - Math_CosS(yaw) * 12.0f32 +
                    10.0f32;
            pos.z =
                (*this).actor.world.pos.z + Math_SinS(yaw) * 12.0f32 * sin;
            EffectSsLightning_Spawn(globalCtx, &mut pos, &mut primColor,
                                    &mut envColor, 17 as libc::c_int as s16,
                                    yaw, 6 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Lurk(mut this: *mut EnVali,
                                     mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_DropAppear(mut this: *mut EnVali,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).actor.velocity.y *= 1.5f32;
    (*this).actor.velocity.y =
        if (*this).actor.velocity.y > 40.0f32 {
            40.0f32
        } else { (*this).actor.velocity.y };
    if Math_StepToF(&mut (*this).actor.world.pos.y, (*this).actor.floorHeight,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_FloatIdle(mut this: *mut EnVali,
                                          mut globalCtx: *mut GlobalContext) {
    let mut curFrame: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).slingshotReactionTimer as libc::c_int != 0 as libc::c_int {
        (*this).slingshotReactionTimer =
            (*this).slingshotReactionTimer.wrapping_sub(1)
    }
    curFrame = (*this).skelAnime.curFrame as s32;
    Math_StepToF(&mut (*this).floatHomeHeight,
                 (*this).actor.floorHeight + 40.0f32, 1.2f32);
    (*this).actor.world.pos.y =
        (*this).floatHomeHeight -
            sinf(curFrame as libc::c_float * 3.14159265358979323846f32 *
                     0.0125f32) * 8.0f32;
    if (*this).slingshotReactionTimer != 0 {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x800 as libc::c_int)
                as s16;
        if (*this).slingshotReactionTimer as libc::c_int % 6 as libc::c_int ==
               0 as libc::c_int && curFrame > 15 as libc::c_int &&
               curFrame <= 55 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x389d as libc::c_int as u16_0);
        }
    } else if curFrame == 16 as libc::c_int || curFrame == 30 as libc::c_int
                  || curFrame == 42 as libc::c_int ||
                  curFrame == 55 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x389d as libc::c_int as u16_0);
    }
    curFrame =
        if curFrame > 40 as libc::c_int {
            (80 as libc::c_int) - curFrame
        } else { curFrame };
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             ((curFrame + 4 as libc::c_int) as libc::c_float * 0.4f32 *
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Attacked(mut this: *mut EnVali,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).lightningTimer as libc::c_int != 0 as libc::c_int {
        (*this).lightningTimer = (*this).lightningTimer.wrapping_sub(1)
    }
    ...
    if (*this).lightningTimer as libc::c_int == 0 as libc::c_int {
        ...
        if (*this).actor.params as libc::c_int ==
               BARI_TYPE_SWORD_DAMAGE as libc::c_int {
            EnVali_SetupRetaliate(this);
        } else {
            (*this).actionFunc =
                Some(EnVali_FloatIdle as
                         unsafe extern "C" fn(_: *mut EnVali,
                                              _: *mut GlobalContext) -> ())
        }
    } else if (*this).lightningTimer as libc::c_int % 2 as libc::c_int !=
                  0 as libc::c_int {
        (*this).actor.world.pos.y += 1.0f32
    } else { (*this).actor.world.pos.y -= 1.0f32 };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_Retaliate(mut this: *mut EnVali,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        } else { EnVali_SetupDivideAndDie(this, globalCtx); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_MoveArmsDown(mut this: *mut EnVali,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnVali_SetupFloatIdle(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Burnt(mut this: *mut EnVali,
                                      mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_DivideAndDie(mut this: *mut EnVali,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    while i < 2 as libc::c_int {
        ...
        pos.y = (*this).actor.world.pos.y + Rand_CenteredFloat(8.0f32);
        pos.z = (*this).actor.world.pos.z + Rand_CenteredFloat(20.0f32);
        velocity.y = Rand_ZeroOne() + 1.0f32;
        scale =
            Rand_S16Offset(40 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Stunned(mut this: *mut EnVali,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).bodyCollider.info.bumper.effect = 1 as libc::c_int as u8_0;
        EnVali_SetupFloatIdle(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_Frozen(mut this: *mut EnVali,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_v0: s32 = 0;
    let mut temp_v1: s32 = 0;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    temp_v1 = (*this).timer as libc::c_int - 20 as libc::c_int;
    (*this).actor.colorFilterTimer = 36 as libc::c_int as u8_0;
    if temp_v1 > 0 as libc::c_int {
        temp_v0 = temp_v1 >> 1 as libc::c_int;
        if (*this).timer as libc::c_int % 2 as libc::c_int != 0 as libc::c_int
           {
            pos.y =
                (*this).actor.world.pos.y - 20.0f32 +
                    (-temp_v0 * 5 as libc::c_int + 40 as libc::c_int) as
                        libc::c_float;
            pos.x =
                (*this).actor.world.pos.x +
                    (if temp_v0 & 2 as libc::c_int != 0 {
                         12.0f32
                     } else { -12.0f32 });
            pos.z =
                (*this).actor.world.pos.z +
                    (if temp_v0 & 1 as libc::c_int != 0 {
                         12.0f32
                     } else { -12.0f32 });
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_ReturnToLurk(mut this: *mut EnVali,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                          (*this).actor.home.pos.y, 0.5f32, 15.0f32, 0.1f32) <
           0.01f32 {
        EnVali_SetupLurk(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_UpdateDamage(mut this: *mut EnVali,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                ...
                if (*this).actionFunc !=
                    ...
                    Actor_SetColorFilter(&mut (*this).actor,
                                         ...
                                         30 as libc::c_int as s16);
                    (*this).actor.params =
                        BARI_TYPE_SWORD_DAMAGE as libc::c_int as s16;
                    EnVali_SetupAttacked(this);
                } else { EnVali_SetupRetaliate(this); }
            } else if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                          BARI_DMGEFF_FIRE as libc::c_int {
                ...
                EnVali_SetupFrozen(this);
                          ...
                          BARI_DMGEFF_SLINGSHOT as libc::c_int {
                if (*this).slingshotReactionTimer as libc::c_int ==
                       0 as libc::c_int {
                    (*this).slingshotReactionTimer = 20 as libc::c_int as u8_0
                }
            } else { EnVali_SetupRetaliate(this); }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVali = thisx as *mut EnVali;
    if (*this).bodyCollider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).leftArmCollider.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 ||
           (*this).rightArmCollider.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).leftArmCollider.base.atFlags =
            ((*this).leftArmCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        (*this).rightArmCollider.base.atFlags =
            ((*this).rightArmCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        (*this).bodyCollider.base.atFlags =
            ((*this).bodyCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        EnVali_SetupAttacked(this);
    }
    ...
    if (*this).actionFunc !=
        ...
        if (*this).actionFunc ==
            ...
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).leftArmCollider.base);
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).rightArmCollider.base);
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_PulseOutside(mut this: *mut EnVali,
                                             mut curFrame: f32_0,
                                             mut scale: *mut Vec3f) {
    let mut scaleChange: f32_0 = 0.;
    if (*this).actionFunc ==
           Some(EnVali_Attacked as
                    unsafe extern "C" fn(_: *mut EnVali,
                                         _: *mut GlobalContext) -> ()) {
        let mut scalePhase: s32 =
            20 as libc::c_int -
                (*this).lightningTimer as libc::c_int % 20 as libc::c_int;
        if scalePhase >= 10 as libc::c_int { scalePhase -= 10 as libc::c_int }
        (*scale).y -=
            0.2f32 *
                sinf(3.14159265358979323846f32 /
                         10 as libc::c_int as libc::c_float *
                         scalePhase as libc::c_float)
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        scaleChange =
            sinf(3.14159265358979323846f32 /
                     10 as libc::c_int as libc::c_float * curFrame);
        (*scale).y -= 0.24f32 * scaleChange;
        (*scale).x -= 0.13f32 * scaleChange;
        (*scale).z = (*scale).x
    } else if (*this).actionFunc ==
                  Some(EnVali_MoveArmsDown as
                           unsafe extern "C" fn(_: *mut EnVali,
     ...
     {
        scaleChange =
            cosf(3.14159265358979323846f32 /
                     50 as libc::c_int as libc::c_float * curFrame);
        (*scale).y -= 0.24f32 * scaleChange;
        (*scale).x -= 0.13f32 * scaleChange;
        (*scale).z = (*scale).x
    } else if (*this).actionFunc ==
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        scaleChange =
            sinf(3.14159265358979323846f32 /
                     10 as libc::c_int as libc::c_float *
                     (*this).timer as libc::c_int as libc::c_float) * 0.08f32;
        (*scale).x += scaleChange;
        (*scale).y -= scaleChange;
        (*scale).z += scaleChange
    } else {
        if curFrame >= 40.0f32 { curFrame -= 40.0f32 }
        (*scale).y -=
            0.2f32 *
                sinf(3.14159265358979323846f32 /
                         40 as libc::c_int as libc::c_float * curFrame)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_PulseInsides(mut this: *mut EnVali,
                                             mut curFrame: f32_0,
                                             mut scale: *mut Vec3f) {
    let mut scaleChange: f32_0 = 0.;
    if (*this).actionFunc ==
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        scaleChange =
            sinf(3.14159265358979323846f32 /
                     10 as libc::c_int as libc::c_float * curFrame);
        (*scale).y -= 0.18f32 * scaleChange;
        (*scale).x -= 0.1f32 * scaleChange;
        (*scale).z = (*scale).x
    } else if (*this).actionFunc ==
                  Some(EnVali_MoveArmsDown as
                           unsafe extern "C" fn(_: *mut EnVali,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_SetArmLength(mut this: *mut EnVali,
                                             mut curFrame: f32_0) -> s32 {
    let mut targetArmScale: f32_0 = 0.;
    if (*this).actionFunc ==
           Some(EnVali_FloatIdle as
                    unsafe extern "C" fn(_: *mut EnVali,
                                         _: *mut GlobalContext) -> ()) {
        if curFrame <= 10.0f32 {
            targetArmScale = curFrame * 0.05f32 + 1.0f32
        } else if curFrame > 70.0f32 {
            targetArmScale = (80.0f32 - curFrame) * 0.05f32 + 1.0f32
        } else { targetArmScale = 1.5f32 }
    } else if (*this).actionFunc ==
                  Some(EnVali_Retaliate as
                           unsafe extern "C" fn(_: *mut EnVali,
                                                _: *mut GlobalContext) -> ())
    ...
    } else { targetArmScale = 1.0f32 }
    Math_StepToF(&mut (*this).armScale, targetArmScale, 0.1f32);
    if (*this).armScale == 1.0f32 {
        return 0 as libc::c_int
    } else { return 1 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn EnVali_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == EN_VALI_LIMB_NUCLEUS as libc::c_int ||
           limbIndex == EN_VALI_LIMB_OUTER_HOOD as libc::c_int ||
           limbIndex == EN_VALI_LIMB_INNER_HOOD as libc::c_int {
        *dList = 0 as *mut Gfx;
        return 0 as libc::c_int
    } else {
        curFrame = (*this).skelAnime.curFrame;
        if limbIndex == EN_VALI_LIMB_LEFT_ARM_BASE as libc::c_int ||
               limbIndex == EN_VALI_LIMB_RIGHT_ARM_BASE as libc::c_int {
            if EnVali_SetArmLength(this, curFrame) != 0 {
                Matrix_Scale((*this).armScale, 1.0f32, 1.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_PostLimbDraw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut limbIndex: s32,
                                             mut dList: *mut *mut Gfx,
                                             mut rot: *mut Vec3s,
                                             mut thisx: *mut libc::c_void,
                                             mut gfx: *mut *mut Gfx) {
    static mut D_80B28970: Vec3f =
        { let mut init = Vec3f{x: 3000.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut D_80B2897C: Vec3f =
    ...
    if (*this).actionFunc ==
           Some(EnVali_FloatIdle as
                    unsafe extern "C" fn(_: *mut EnVali,
                                         _: *mut GlobalContext) -> ()) {
        if limbIndex == EN_VALI_LIMB_LEFT_FOREARM_BASE as libc::c_int ||
               limbIndex == EN_VALI_LIMB_RIGHT_FOREARM_BASE as libc::c_int {
            Matrix_MultVec3f(&mut D_80B28970, &mut sp3C);
            Matrix_MultVec3f(&mut D_80B2897C, &mut sp30);
            if limbIndex == EN_VALI_LIMB_LEFT_FOREARM_BASE as libc::c_int {
                Collider_SetQuadVertices(&mut (*this).leftArmCollider,
                                         &mut sp30, &mut sp3C,
                                         &mut *(*this).leftArmCollider.dim.quad.as_mut_ptr().offset(0
                                                                                                        as
                                                                                                        libc::c_int
                                                                                                        as
                                                                                                        isize),
                                         &mut *(*this).leftArmCollider.dim.quad.as_mut_ptr().offset(1
                                                                                                        as
                                                                                                        libc::c_int
                                                                                                        as
                                                                                                        isize));
            } else {
                Collider_SetQuadVertices(&mut (*this).rightArmCollider,
                                         &mut sp30, &mut sp3C,
                                         &mut *(*this).rightArmCollider.dim.quad.as_mut_ptr().offset(0
                                                                                                         as
                                                                                                         libc::c_int
                                                                                                         as
                                                                                                         isize),
                                         &mut *(*this).rightArmCollider.dim.quad.as_mut_ptr().offset(1
                                                                                                         as
                                                                                                         libc::c_int
                                                                                                         as
                                                                                                         isize));
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_DrawBody(mut this: *mut EnVali,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_vali.c\x00" as *const u8 as *const libc::c_char,
                    1428 as libc::c_int);
    Matrix_Get(&mut mtx);
    curFrame = (*this).skelAnime.curFrame;
    EnVali_PulseInsides(this, curFrame, &mut scale);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_vali.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBariInnerHoodDL.as_mut_ptr() as libc::c_uint;
    Matrix_Put(&mut mtx);
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gBariNucleusDL.as_mut_ptr() as libc::c_uint;
    Matrix_Translate(506.0f32 * cos + 372.0f32 * sin, 1114.0f32,
                     372.0f32 * cos - 506.0f32 * sin,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = gBariNucleusDL.as_mut_ptr() as libc::c_uint;
    Matrix_Translate(-964.0f32 * cos - 804.0f32 * sin, -108.0f32,
                     -804.0f32 * cos + 964.0f32 * sin,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = gBariNucleusDL.as_mut_ptr() as libc::c_uint;
    Matrix_Put(&mut mtx);
    scale.z = 1.0f32;
    scale.y = scale.z;
    scale.x = scale.y;
    EnVali_PulseOutside(this, curFrame, &mut scale);
    Matrix_Scale(scale.x, scale.y, scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn EnVali_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVali = thisx as *mut EnVali;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    (*_g).words.w1 =
        Gfx_TexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int as u32_0,
                      (127 as libc::c_int as
                           libc::c_uint).wrapping_sub((*globalCtx).gameplayFrames.wrapping_mul(12
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
    ...
    if (*this).lightningTimer as libc::c_int % 2 as libc::c_int !=
           0 as libc::c_int {
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = D_80B28998.as_mut_ptr() as libc::c_uint
    } else {
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_vali.c\x00" as *const u8 as
                         *const libc::c_char, 1538 as libc::c_int);
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x18 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_value(5000 as libc::c_int);
             init
         }]
}
#[used]
