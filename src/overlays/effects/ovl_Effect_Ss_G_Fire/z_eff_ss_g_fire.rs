...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffFireFootprint1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprint8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffFireFootprintDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_G_Fire_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_G_FIRE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGFire_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsGFire_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsGFireInitParams =
        initParamsx as *mut EffectSsGFireInitParams;
    ...
    (*this).draw =
        Some(EffectSsGFire_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsGFire_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).gfx =
        gSegments[((gEffFireFootprintDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffFireFootprintDL.as_mut_ptr() as
                                              u32_0 &
    ...
    (*this).regs[1 as libc::c_int as usize] = 200 as libc::c_int as s16;
    (*this).regs[0 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[2 as libc::c_int as usize] = 50 as libc::c_int as s16;
    (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[4 as libc::c_int as usize] = 220 as libc::c_int as s16;
    (*this).regs[5 as libc::c_int as usize] = 80 as libc::c_int as s16;
    (*this).regs[6 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[7 as libc::c_int as usize] = 130 as libc::c_int as s16;
    (*this).regs[8 as libc::c_int as usize] = 30 as libc::c_int as s16;
    (*this).regs[9 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[10 as libc::c_int as usize] = 0 as libc::c_int as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGFire_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    let mut fireFootprintTextures: [*mut libc::c_void; 8] =
        [gEffFireFootprint1Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint2Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint3Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint4Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint5Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint6Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint7Tex.as_mut_ptr() as *mut libc::c_void,
         gEffFireFootprint8Tex.as_mut_ptr() as *mut libc::c_void];
    let mut texIdx: s16 =
        ((*this).regs[0 as libc::c_int as usize] as libc::c_int /
             100 as libc::c_int % 7 as libc::c_int) as s16;
    EffectSs_DrawGEffect(globalCtx, this,
                         fireFootprintTextures[texIdx as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGFire_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
