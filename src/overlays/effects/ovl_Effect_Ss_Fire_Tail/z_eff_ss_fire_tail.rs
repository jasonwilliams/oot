...
#[no_mangle]
pub static mut Effect_Ss_Fire_Tail_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_FIRE_TAIL as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsFireTail_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsFireTail_Init(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               ...
                                               mut initParamsx:
                                                   *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsFireTailInitParams =
        initParamsx as *mut EffectSsFireTailInitParams;
    ...
    (*this).draw =
        Some(EffectSsFireTail_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsFireTail_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[0 as libc::c_int as usize] =
        ((*initParams).scale * 1000.0f32) as s16;
    (*this).regs[1 as libc::c_int as usize] = (*initParams).life as s16;
    (*this).regs[2 as libc::c_int as usize] = -(0xa as libc::c_int) as s16;
    (*this).regs[3 as libc::c_int as usize] = -(0xf as libc::c_int) as s16;
    if (*initParams).unk_20 as libc::c_int == 0 as libc::c_int {
        (*initParams).unk_20 = 1 as libc::c_int as s16
    }
    (*this).regs[10 as libc::c_int as usize] = (*initParams).unk_20;
    ...
    (*this).regs[7 as libc::c_int as usize] = (*initParams).envColor.r as s16;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).envColor.g as s16;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).envColor.b as s16;
    (*this).regs[11 as libc::c_int as usize] = (*initParams).bodyPart;
    (*this).regs[12 as libc::c_int as usize] = (*initParams).type_0;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsFireTail_Draw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_fire_tail.c\x00" as *const u8 as
    ...
    if !(*this).actor.is_null() {
        ...
        if ((*this).regs[11 as libc::c_int as usize] as libc::c_int) <
               0 as libc::c_int {
            Matrix_Translate((*this).pos.x + (*(*this).actor).world.pos.x,
                             (*this).pos.y + (*(*this).actor).world.pos.y,
                             (*this).pos.z + (*(*this).actor).world.pos.z,
            ...
            let mut player: *mut Player =
                (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                     ...
                                                     usize].head as
                    *mut Player;
            let mut bodyPart: s16 = (*this).regs[11 as libc::c_int as usize];
            (*this).pos.x =
                (*player).bodyPartsPos[bodyPart as usize].x -
                    Math_SinS(Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                              ...
                                                                              usize]))
                        * 5.0f32;
            (*this).pos.y = (*player).bodyPartsPos[bodyPart as usize].y;
            (*this).pos.z =
    ...
    yaw =
        (Math_Vec3f_Yaw(&mut scale, &mut (*this).vec) as libc::c_int -
    ...
    temp2 = Math_SinS(yaw);
    dist =
        Math_Vec3f_DistXZ(&mut scale, &mut (*this).vec) /
    ...
    temp1 =
        (*this).regs[3 as libc::c_int as usize] as libc::c_int as
            libc::c_float * 0.01f32 * temp1 * dist + 1.0f32;
    if temp1 < 0.1f32 { temp1 = 0.1f32 }
    Matrix_Scale(1.0f32, temp1, 1.0f32 / temp1,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_2).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).state.frames.wrapping_mul(-(0x14 as
                                                                      libc::c_int)
                                                                    as
                                                                    libc::c_uint)
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_fire_tail.c\x00" as *const u8 as
                         *const libc::c_char, 273 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsFireTail_Update(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut index: u32_0,
                                                 mut this: *mut EffectSs) {
    (*this).regs[0 as libc::c_int as usize] =
        ((*this).regs[0 as libc::c_int as usize] as libc::c_float * 0.9f32) as
            s16;
}
