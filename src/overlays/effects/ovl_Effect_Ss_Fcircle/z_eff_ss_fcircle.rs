...
#[no_mangle]
pub static mut Effect_Ss_Fcircle_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_FCIRCLE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsFcircle_Init as
 ...
 */
// probably supposed to be an alpha
#[no_mangle]
pub unsafe extern "C" fn EffectSsFcircle_Init(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              ...
                                              mut initParamsx:
                                                  *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsFcircleInitParams =
        initParamsx as *mut EffectSsFcircleInitParams;
    ...
    (*this).gfx = gEffFireCircleDL.as_mut_ptr() as *mut libc::c_void;
    (*this).life = 20 as libc::c_int as s16;
    (*this).draw =
        Some(EffectSsFcircle_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsFcircle_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).radius;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).height;
    (*this).regs[10 as libc::c_int as usize] =
        (*(*initParams).actor).shape.rot.y;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsFcircle_Draw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_fcircle.c\x00" as *const u8 as
                        *const libc::c_char, 149 as libc::c_int);
    scale =
        (*this).regs[11 as libc::c_int as usize] as libc::c_int as
            libc::c_float *
            (0.5f32 + (*this).life as libc::c_int as libc::c_float * 0.025f32)
            * 0.01f32;
    yScale =
        (*this).regs[9 as libc::c_int as usize] as libc::c_int as
            libc::c_float * 0.001f32 * scale;
    xzScale =
    ...
    Matrix_RotateY((*this).regs[10 as libc::c_int as usize] as libc::c_int as
                       libc::c_float *
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (*globalCtx).gameplayFrames.wrapping_mul(-(0xf as
                                                                        libc::c_int)
                                                                      as
    ...
    (*_g_1).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((*this).life as libc::c_int as libc::c_float * 12.75f32) as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsFcircle_Update(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    let mut actor: *mut Actor = (*this).actor;
    if !actor.is_null() {
        if (*actor).update.is_some() {
            (*this).pos.x = (*actor).world.pos.x + (*this).vec.x;
            (*this).pos.y = (*actor).world.pos.y + (*this).vec.y;
            (*this).pos.z = (*actor).world.pos.z + (*this).vec.z;
            (*this).regs[10 as libc::c_int as usize] = (*actor).shape.rot.y;
            if (*actor).colorFilterTimer as libc::c_int > 20 as libc::c_int {
                (*this).life = 20 as libc::c_int as s16
            } else { (*this).life = (*actor).colorFilterTimer as s16 }
            Math_StepToS(&mut *(*this).regs.as_mut_ptr().offset(11 as
                                                                    libc::c_int
                                                                    as isize),
                         100 as libc::c_int as s16, 20 as libc::c_int as s16);
