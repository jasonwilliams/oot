...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnArowTrap {
    pub actor: Actor,
    pub unk_14C: u32_0,
    pub attackTimer: u32_0,
}
pub type C2RustUnnamed_17 = libc::c_int;
pub const ARROW_NUT: C2RustUnnamed_17 = 10;
pub const ARROW_SEED: C2RustUnnamed_17 = 9;
pub const ARROW_0E: C2RustUnnamed_17 = 8;
pub const ARROW_0D: C2RustUnnamed_17 = 7;
pub const ARROW_0C: C2RustUnnamed_17 = 6;
pub const ARROW_LIGHT: C2RustUnnamed_17 = 5;
pub const ARROW_ICE: C2RustUnnamed_17 = 4;
pub const ARROW_FIRE: C2RustUnnamed_17 = 3;
pub const ARROW_NORMAL: C2RustUnnamed_17 = 2;
pub const ARROW_NORMAL_HORSE: C2RustUnnamed_17 = 1;
pub const ARROW_NORMAL_LIT: C2RustUnnamed_17 = 0;
pub const ARROW_NORMAL_SILENT: C2RustUnnamed_17 = -1;
pub const ARROW_CS_NUT: C2RustUnnamed_17 = -10;
#[no_mangle]
pub static mut En_Arow_Trap_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_AROW_TRAP as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnArowTrap_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnArowTrap_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnArowTrap_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnArowTrap_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnArowTrap = thisx as *mut EnArowTrap;
    Actor_SetScale(&mut (*this).actor, 0.01f64 as f32_0);
    (*this).unk_14C = 0 as libc::c_int as u32_0;
    (*this).attackTimer = 80 as libc::c_int as u32_0;
    (*this).actor.focus.pos = (*this).actor.world.pos;
}
#[no_mangle]
pub unsafe extern "C" fn EnArowTrap_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnArowTrap_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnArowTrap = thisx as *mut EnArowTrap;
    if (*this).actor.xzDistToPlayer <= 400 as libc::c_int as libc::c_float {
        (*this).attackTimer = (*this).attackTimer.wrapping_sub(1);
        if (*this).attackTimer == 0 as libc::c_int as libc::c_uint {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        ARROW_NORMAL_SILENT as libc::c_int as s16);
            (*this).attackTimer = 80 as libc::c_int as u32_0
        }
    };
}
