...
extern "C" {
    ...
    #[no_mangle]
    static mut gStalchildAttackingAnim: AnimationHeader;
    #[no_mangle]
    static mut gStalchildDyingAnim: AnimationHeader;
    #[no_mangle]
    static mut gStalchildDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gStalchildUncurlingAnim: AnimationHeader;
    #[no_mangle]
    static mut gStalchildSkel: SkeletonHeader;
    #[no_mangle]
    static mut gStalchildWalkingAnim: AnimationHeader;
}
...
pub struct EnSkb {
    ...
    pub unk_282: u8_0,
    pub unk_283: u8_0,
    pub actionFunc: EnSkbActionFunc,
    pub unk_288: s16,
    pub bodyBreak: BodyBreak,
    pub collider: ColliderJntSph,
    pub colliderItem: [ColliderJntSphElement; 2],
}
pub type EnSkbActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSkb, _: *mut GlobalContext) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnReeba {
    pub actor: Actor,
...
pub type EnEncount1UpdateFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnEncount1, _: *mut GlobalContext)
               -> ()>;
static mut sJntSphElementsInit: [ColliderJntSphElementInit; 2] =
    [{
         let mut init =
...
#[no_mangle]
pub static mut En_Skb_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SKB as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_SKB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSkb>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_SetupAction(mut this: *mut EnSkb,
                                           mut actionFunc: EnSkbActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnSkb_SpawnDebris(mut globalCtx: *mut GlobalContext,
                                           mut this: *mut EnSkb,
    ...
    pos.x = Math_SinF(spreadAngle) * 15.0f32 + (*spawnPos).x;
    pos.z = Math_CosF(spreadAngle) * 15.0f32 + (*spawnPos).z;
    accel.x = Rand_CenteredFloat(1.0f32);
    accel.z = Rand_CenteredFloat(1.0f32);
    vel.y += (Rand_ZeroOne() - 0.5f32) * 4.0f32;
    scale = Rand_ZeroOne() * 5.0f32 + 12.0f32;
    EffectSsHahen_Spawn(globalCtx, &mut pos, &mut vel, &mut accel,
                        2 as libc::c_int as s16, (scale * 0.8f32) as s16,
                        -(1 as libc::c_int) as s16, 10 as libc::c_int as s16,
                        0 as *mut Gfx);
    func_80033480(globalCtx, &mut pos, 10.0f32, 1 as libc::c_int,
                  150 as libc::c_int as s16, 0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSkb = thisx as *mut EnSkb;
    let mut paramOffsetBody: s16 = 0;
    let mut paramOffsetArm: s16 = 0;
    ...
    (*this).actor.shape.yOffset = -8000.0f32;
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gStalchildSkel,
                   &mut gStalchildUncurlingAnim,
                   (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 20 as libc::c_int);
    (*this).actor.naviEnemyId = 0x55 as libc::c_int as u8_0;
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit, (*this).colliderItem.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor,
                   ((*this).actor.params as libc::c_int as libc::c_float *
                        0.1f32 + 1.0f32) * 0.01f32);
    paramOffsetBody =
        ((*this).actor.params as libc::c_int + 0xa as libc::c_int) as s16;
    ...
    (*(*this).collider.elements.offset(1 as libc::c_int as
                                           isize)).dim.worldSphere.radius =
        paramOffsetArm;
    (*(*this).collider.elements.offset(1 as libc::c_int as
                                           isize)).dim.modelSphere.radius =
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSkb = thisx as *mut EnSkb;
    if !(*this).actor.parent.is_null() {
        let mut spawner: *mut EnEncount1 =
            (*this).actor.parent as *mut EnEncount1;
        if (*spawner).actor.update.is_some() {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFCD60(mut this: *mut EnSkb) {
                  ...
                  (*this).actor.xzDistToPlayer <
                      60.0f32 +
                          (*this).actor.params as libc::c_int as libc::c_float
                              * 6.0f32 {
        func_80AFD33C(this);
    } else { func_80AFD0A4(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFCDF8(mut this: *mut EnSkb) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                               &mut gStalchildUncurlingAnim, 1.0f32);
    (*this).unk_280 = 0 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3986 as libc::c_int as u16_0);
    EnSkb_SetupAction(this,
                      Some(func_80AFCE5C as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFCE5C(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, 0.0f32, 1.0f32,
                       800.0f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).actor.shape.shadowScale, 25.0f32, 1.0f32,
                       2.5f32, 0.0f32);
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint !=
           0 as libc::c_int as libc::c_uint {
        EnSkb_SpawnDebris(globalCtx, this, &mut (*this).actor.world.pos);
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int &&
           0.0f32 == (*this).actor.shape.yOffset {
        func_80AFCD60(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFCF48(mut this: *mut EnSkb) {
    Animation_Change(&mut (*this).skelAnime, &mut gStalchildUncurlingAnim,
                     -1.0f32,
                     Animation_GetLastFrame(&mut gStalchildUncurlingAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    (*this).unk_280 = 0 as libc::c_int as u8_0;
    (*this).unk_281 = 0 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3987 as libc::c_int as u16_0);
    EnSkb_SetupAction(this,
                      Some(func_80AFCFF0 as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFCFF0(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_SmoothStepToF(&mut (*this).actor.shape.yOffset, -8000.0f32,
                          1.0f32, 500.0f32, 0.0f32) != 0.0f32 &&
           (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0
       {
        EnSkb_SpawnDebris(globalCtx, this, &mut (*this).actor.world.pos);
    }
    Math_SmoothStepToF(&mut (*this).actor.shape.shadowScale, 0.0f32, 1.0f32,
                       2.5f32, 0.0f32);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFD0A4(mut this: *mut EnSkb) {
    Animation_Change(&mut (*this).skelAnime, &mut gStalchildWalkingAnim,
                     0.96000004f32, 0.0f32,
                     Animation_GetLastFrame(&mut gStalchildWalkingAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -4.0f32);
    (*this).unk_280 = 4 as libc::c_int as u8_0;
    (*this).unk_288 = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = (*this).actor.scale.y * 160.0f32;
    EnSkb_SetupAction(this,
                      Some(EnSkb_Advance as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnSkb_Advance(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_283 as libc::c_int != 0 as libc::c_int &&
           (*globalCtx).gameplayFrames & 0xf as libc::c_int as libc::c_uint ==
               0 as libc::c_int as libc::c_uint {
        (*this).unk_288 = Rand_CenteredFloat(50000.0f32) as s16
    }
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ((*this).actor.yawTowardsPlayer as libc::c_int +
                            (*this).unk_288 as libc::c_int) as s16,
    ...
    } else { playSpeed = -(*this).skelAnime.playSpeed }
    prevKeyFrame = ((*this).skelAnime.curFrame - playSpeed) as s32;
    if (*this).skelAnime.playSpeed >= 0.0f32 {
        playSpeed = (*this).skelAnime.playSpeed
    } else { playSpeed = -(*this).skelAnime.playSpeed }
    if thisKeyFrame != (*this).skelAnime.curFrame as s32 {
        if prevKeyFrame < 9 as libc::c_int &&
               playSpeed as s32 + thisKeyFrame >= 8 as libc::c_int ||
               !(prevKeyFrame >= 16 as libc::c_int ||
                     playSpeed as s32 + thisKeyFrame < 15 as libc::c_int) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3830 as libc::c_int as u16_0);
        }
    }
    if Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                         &mut (*player).actor.world.pos) > 800.0f32 ||
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFD33C(mut this: *mut EnSkb) {
    Animation_Change(&mut (*this).skelAnime, &mut gStalchildAttackingAnim,
                     0.6f32, 0.0f32,
                     Animation_GetLastFrame(&mut gStalchildAttackingAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, 4.0f32);
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int & !(4 as libc::c_int))
            as u8_0;
    (*this).unk_280 = 3 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnSkb_SetupAction(this,
                      Some(EnSkb_SetupAttack as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnSkb_SetupAttack(mut this: *mut EnSkb,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut frameData: s32 = 0;
    frameData = (*this).skelAnime.curFrame as s32;
    if frameData == 3 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3831 as libc::c_int as u16_0);
        (*this).unk_281 = 1 as libc::c_int as u8_0
    } else if frameData == 6 as libc::c_int {
        (*this).unk_281 = 0 as libc::c_int as u8_0
    }
    if (*this).collider.base.atFlags as libc::c_int & 4 as libc::c_int != 0 {
        (*this).collider.base.atFlags =
            ((*this).collider.base.atFlags as libc::c_int &
                 !(6 as libc::c_int)) as u8_0;
        func_80AFD47C(this);
    } else if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        func_80AFCD60(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD47C(mut this: *mut EnSkb) {
    Animation_Change(&mut (*this).skelAnime, &mut gStalchildAttackingAnim,
                     -0.4f32, (*this).skelAnime.curFrame - 1.0f32, 0.0f32,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, 0.0f32);
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int & !(4 as libc::c_int))
            as u8_0;
    (*this).unk_280 = 5 as libc::c_int as u8_0;
    (*this).unk_281 = 0 as libc::c_int as u8_0;
    EnSkb_SetupAction(this,
                      Some(func_80AFD508 as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD508(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        func_80AFCD60(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_SetupStunned(mut this: *mut EnSkb) {
    ...
    (*this).unk_281 = 0 as libc::c_int as u8_0;
    (*this).unk_280 = 6 as libc::c_int as u8_0;
    EnSkb_SetupAction(this,
                      Some(func_80AFD59C as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD59C(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int &&
        ...
        } else { func_80AFCD60(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD644(mut this: *mut EnSkb) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gStalchildDamagedAnim, -4.0f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.speedXZ = -4.0f32
    }
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3832 as libc::c_int as u16_0);
    (*this).unk_280 = 2 as libc::c_int as u8_0;
    EnSkb_SetupAction(this,
                      Some(func_80AFD6CC as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD6CC(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    // this cast is likely not real, but allows for a match
    let mut new_var: *mut u8_0 = 0 as *mut u8_0;
    new_var = &mut (*this).unk_283;
    if (*this).unk_283 as libc::c_int != 1 as libc::c_int ||
           BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
                                globalCtx, 1 as libc::c_int as s16) != 0 {
        if *new_var as libc::c_int != 0 as libc::c_int {
            (*this).unk_283 =
                (*new_var as libc::c_int | 2 as libc::c_int) as u8_0
        }
        if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            if (*this).actor.speedXZ < 0.0f32 {
                (*this).actor.speedXZ += 0.05f32
            }
        }
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           1 as libc::c_int as s16,
                           0x1194 as libc::c_int as s16,
                           0 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFD7B4(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gStalchildDyingAnim, -4.0f32);
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.speedXZ = -6.0f32
    }
    (*this).unk_280 = 1 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    BodyBreak_Alloc(&mut (*this).bodyBreak, 18 as libc::c_int, globalCtx);
    (*this).unk_283 =
        ((*this).unk_283 as libc::c_int | 4 as libc::c_int) as u8_0;
    EffectSsDeadSound_SpawnStationary(globalCtx,
                                      &mut (*this).actor.projectedPos,
                                      0x3833 as libc::c_int as u16_0,
                                      1 as libc::c_int as s16,
                                      1 as libc::c_int as s16,
                                      0x28 as libc::c_int);
    EnSkb_SetupAction(this,
                      Some(func_80AFD880 as
                               unsafe extern "C" fn(_: *mut EnSkb,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD880(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    if BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
        ...
        } else if (*this).actor.scale.x <= 0.015f32 {
        ...
        (*this).unk_283 =
            ((*this).unk_283 as libc::c_int | 8 as libc::c_int) as u8_0;
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFD968(mut this: *mut EnSkb,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s16 = 0;
    let mut i: s32 = 0;
    ...
    if (*this).unk_280 as libc::c_int != 1 as libc::c_int &&
           (*this).actor.bgCheckFlags as libc::c_int & 0x60 as libc::c_int !=
               0 && (*this).actor.yDistToWater >= 40.0f32 {
        (*this).actor.colChkInfo.health = 0 as libc::c_int as u8_0;
        (*this).unk_281 = 0 as libc::c_int as u8_0;
        func_80AFD7B4(this, globalCtx);
    } else if (*this).unk_280 as libc::c_int >= 3 as libc::c_int {
        if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int !=
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
                ...
                Actor_SetDropFlag(&mut (*this).actor,
                                  &mut (*(*this).collider.elements.offset(1 as
                                                                              libc::c_int
                                                                              as
                                                                              isize)).info,
                                  1 as libc::c_int);
                ...
                if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       1 as libc::c_int {
                    if (*this).unk_280 as libc::c_int != 6 as libc::c_int {
                    ...
                    phi_v1 = 8 as libc::c_int as s16;
                    if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                           7 as libc::c_int {
                        scale = ((*this).actor.scale.y * 7500.0f32) as s16;
                        i = 4 as libc::c_int;
                        while i >= 0 as libc::c_int {
                            flamePos = (*this).actor.world.pos;
                            flamePos.x += Rand_CenteredFloat(20.0f32);
                            flamePos.z += Rand_CenteredFloat(20.0f32);
                            flamePos.y += Rand_ZeroOne() * 25.0f32;
                        ...
                        phi_v1 = 25 as libc::c_int as s16
                    }
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0x4000 as libc::c_int as s16,
                                         0xff as libc::c_int as s16,
                                         0 as libc::c_int as s16, phi_v1);
                    ...
                    player =
                        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                            ...
                            *mut Player;
                    if (*this).unk_283 as libc::c_int == 0 as libc::c_int {
                        if (*this).actor.colChkInfo.damageEffect as
                               libc::c_int == 0xd as libc::c_int ||
                               (*this).actor.colChkInfo.damageEffect as
                                   libc::c_int == 0xe as libc::c_int &&
                                   ((*player).swordAnimation as libc::c_int >=
                                        4 as libc::c_int &&
                                        (*player).swordAnimation as
                                        ...
                                        ((*player).swordAnimation as
                                             ...
                                             (*player).swordAnimation as
                                                 libc::c_int ==
                                                 21 as libc::c_int)) {
                            BodyBreak_Alloc(&mut (*this).bodyBreak,
                                            2 as libc::c_int, globalCtx);
                            (*this).unk_283 = 1 as libc::c_int as u8_0
                        }
                    }
                    func_80AFD644(this);
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSkb = thisx as *mut EnSkb;
    let mut pad: s32 = 0;
    func_80AFD968(this, globalCtx);
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 15.0f32, 30.0f32,
                            60.0f32, 0x1d as libc::c_int);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actor.focus.pos.y += 3000.0f32 * (*this).actor.scale.y;
    if (*this).unk_281 as libc::c_int != 0 as libc::c_int {
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    }
    if (*this).unk_280 as libc::c_int >= 3 as libc::c_int {
        if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int
               ||
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 11 as libc::c_int {
        if (*this).unk_283 as libc::c_int & 2 as libc::c_int ==
               0 as libc::c_int {
            ...
            Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                            b"../z_en_skb.c\x00" as *const u8 as
                                *const libc::c_char, 972 as libc::c_int);
            color =
                ((if (Math_SinS((*globalCtx).gameplayFrames.wrapping_mul(0x1770
                                                                             as
                                                                             libc::c_int
                                                                             as
                                                                             libc::c_uint)
                                    as s16) * 95.0f32) as s16 as libc::c_int
                         >= 0 as libc::c_int {
                      (Math_SinS((*globalCtx).gameplayFrames.wrapping_mul(0x1770
                                                                              as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_uint)
            ...
            Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                  ...
                  (*this).unk_283 as libc::c_int & 2 as libc::c_int !=
                      0 as libc::c_int {
        *dList = 0 as *mut Gfx
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnSkb_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    ...
    if (*this).unk_283 as libc::c_int ^ 1 as libc::c_int == 0 as libc::c_int {
        BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex,
                          11 as libc::c_int, 12 as libc::c_int,
                          18 as libc::c_int as u32_0, dList,
                          -(1 as libc::c_int) as s16);
    } else if (*this).unk_283 as libc::c_int ^
                  ((*this).unk_283 as libc::c_int | 4 as libc::c_int) ==
                  0 as libc::c_int {
        BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex, 0 as libc::c_int,
                          18 as libc::c_int, 18 as libc::c_int as u32_0,
                          dList, -(1 as libc::c_int) as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSkb_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSkb = thisx as *mut EnSkb;
    func_80093D18((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnSkb_OverrideLimbDraw as
