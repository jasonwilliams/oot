...
extern "C" {
    ...
    #[no_mangle]
    static mut object_efc_erupc_DL_001720: [Gfx; 0];
    #[no_mangle]
    static mut object_efc_erupc_DL_002570: [Gfx; 0];
    #[no_mangle]
    static mut object_efc_erupc_DL_002760: [Gfx; 0];
    #[no_mangle]
    static mut object_efc_erupc_DL_0027D8: [Gfx; 0];
}
...
pub struct EfcErupc {
    ...
    pub unk152: s16,
    pub unk154: s16,
    pub particles: [EfcErupcParticles; 100],
    pub actionFunc: EfcErupcActionFunc,
}
pub type EfcErupcActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EfcErupc, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EfcErupcParticles {
    pub pos: Vec3f,
    pub vel: Vec3f,
    pub accel: Vec3f,
    pub isActive: u8_0,
    ...
    pub scale: f32_0,
    pub unk_34: [libc::c_char; 8],
}
#[no_mangle]
pub static mut Efc_Erupc_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EFC_ERUPC as libc::c_int as s16,
                          category:
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_EFC_ERUPC as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EfcErupc>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EfcErupc_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EfcErupc_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_SetupAction(mut this: *mut EfcErupc,
                                              mut actionFunc:
                                                  EfcErupcActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EfcErupc = thisx as *mut EfcErupc;
    EfcErupc_SetupAction(this,
                         Some(EfcErupc_UpdateAction as
                                  unsafe extern "C" fn(_: *mut EfcErupc,
                                                       _: *mut GlobalContext)
                                      -> ()));
    Actor_SetScale(&mut (*this).actor, 1.0f32);
    EfcErupc_InitParticles((*this).particles.as_mut_ptr());
    (*this).unk150 = 0 as libc::c_int as s16;
    (*this).unk14E = (*this).unk150;
    (*this).unk14C = (*this).unk14E;
    (*this).unk152 = 5 as libc::c_int as s16;
    (*this).unk154 = -(100 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_UpdateAction(mut this: *mut EfcErupc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
        ...
        if !(*globalCtx).csCtx.npcActions[1 as libc::c_int as usize].is_null()
           {
            if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as
                ...
                if (*this).unk150 as libc::c_int == 30 as libc::c_int {
                    func_800788CC(0x1845 as libc::c_int as u16_0);
                }
                if (*this).unk150 as libc::c_int <= 64 as libc::c_int {
                    if ((*this).unk154 as libc::c_int) < 200 as libc::c_int {
                        (*this).unk154 =
                            ((*this).unk154 as libc::c_int +
                                 10 as libc::c_int) as s16
                    }
                } else if (*this).unk154 as libc::c_int >
                              -(100 as libc::c_int) {
                    (*this).unk154 =
                        ((*this).unk154 as libc::c_int - 10 as libc::c_int) as
                            s16
                }
                (*this).unk150 += 1
            } else if (*this).unk154 as libc::c_int > -(100 as libc::c_int) {
                (*this).unk154 =
                    ((*this).unk154 as libc::c_int - 10 as libc::c_int) as s16
            }
        }
    }
    if (*globalCtx).csCtx.state as libc::c_int != 0 as libc::c_int {
        if !(*globalCtx).csCtx.npcActions[2 as libc::c_int as usize].is_null()
           {
            match (*(*globalCtx).csCtx.npcActions[2 as libc::c_int as
                                                      usize]).action as
                      libc::c_int {
                2 => {
                    if (*this).unk14E as libc::c_int == 0 as libc::c_int {
                        func_800F3F3C(6 as libc::c_int as u8_0);
                        gSaveContext.eventChkInf[2 as libc::c_int as usize] =
                            (gSaveContext.eventChkInf[2 as libc::c_int as
                                                          usize] as
                                 libc::c_int | 0x8000 as libc::c_int) as u16_0
                    }
                    (*this).unk14E += 1
                }
                3 => { (*this).unk14E = 30 as libc::c_int as s16 }
                _ => { }
            }
            (*this).unk14C += 1
        }
    ...
    accel.z = 0.0f32;
    accel.x = 0.0f32;
    pos.y = (*this).actor.world.pos.y + 300.0f32;
    i = 0 as libc::c_int;
    while i < (*this).unk152 as libc::c_int {
        pos.x = Rand_CenteredFloat(100.0f32) + (*this).actor.world.pos.x;
        pos.z = Rand_CenteredFloat(100.0f32) + (*this).actor.world.pos.z;
        vel.x = Rand_CenteredFloat(100.0f32);
        vel.y = Rand_ZeroFloat(100.0f32);
        vel.z = Rand_CenteredFloat(100.0f32);
        accel.y = (*this).unk154 as libc::c_int as libc::c_float * 0.1f32;
        EfcErupc_AddParticle((*this).particles.as_mut_ptr(), &mut pos,
                             &mut vel, &mut accel, 80.0f32);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EfcErupc = thisx as *mut EfcErupc;
...
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EfcErupc = thisx as *mut EfcErupc;
    let mut csAction: u16_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_efc_erupc.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ((*this).unk14C as libc::c_int * 1 as libc::c_int) as
                             u32_0,
                         ((*this).unk14E as libc::c_int * -(4 as libc::c_int))
                             as u32_0, 32 as libc::c_int, 64 as libc::c_int,
                         1 as libc::c_int,
                         ((*this).unk14C as libc::c_int * 4 as libc::c_int) as
                             u32_0,
                         ((*this).unk14E as libc::c_int *
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         ((*this).unk150 as libc::c_int * -(4 as libc::c_int))
                             as u32_0, 16 as libc::c_int, 128 as libc::c_int,
                         1 as libc::c_int, 0 as libc::c_int as u32_0,
                         ((*this).unk150 as libc::c_int * 12 as libc::c_int)
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                object_efc_erupc_DL_002570.as_mut_ptr() as libc::c_uint
        }
    }
    Matrix_Pop();
    Matrix_Scale(3.4f32, 3.4f32, 3.4f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    if (*globalCtx).csCtx.state as libc::c_int != 0 as libc::c_int {
        let mut csActorAction: *mut CsCmdActorAction =
            (*globalCtx).csCtx.npcActions[2 as libc::c_int as usize];
        if !csActorAction.is_null() {
            csAction = (*csActorAction).action;
            if csAction as libc::c_int == 2 as libc::c_int ||
                   csAction as libc::c_int == 3 as libc::c_int {
                ...
                (*_g_7).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_7).words.w1 =
                    object_efc_erupc_DL_001720.as_mut_ptr() as libc::c_uint
            }
        }
    }
    ...
    EfcErupc_DrawParticles((*this).particles.as_mut_ptr(), globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_DrawParticles(mut particles:
                                                    *mut EfcErupcParticles,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    while (i as libc::c_int) < 100 as libc::c_int {
        if (*particles).isActive != 0 {
            ...
            (*_g).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                object_efc_erupc_DL_002760.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_0).words.w0 =
                (0xfa as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                ((*particles).color.r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    ((*particles).color.g as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    ((*particles).color.b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    ((*particles).alpha as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            ...
            Matrix_Translate((*particles).pos.x, (*particles).pos.y,
                             (*particles).pos.z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            func_800D1FD4(&mut (*globalCtx).billboardMtxF);
            Matrix_Scale((*particles).scale, (*particles).scale, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                object_efc_erupc_DL_0027D8.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        particles = particles.offset(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_UpdateParticles(mut this: *mut EfcErupc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut i: s16 = 0;
    let mut index: s16 = 0;
    let mut particleColors: [Color_RGB8; 4] =
        [{
             let mut init =
    ...
    let mut cur: *mut EfcErupcParticles = (*this).particles.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 100 as libc::c_int {
        if (*cur).isActive != 0 {
            (*cur).pos.x += (*cur).vel.x;
            ...
            (*cur).animTimer =
                ((*cur).animTimer as libc::c_int + 1 as libc::c_int) as u8_0;
            index =
                ((*cur).animTimer as libc::c_int % 4 as libc::c_int) as s16;
            color =
                &mut *particleColors.as_mut_ptr().offset(index as isize) as
                    *mut Color_RGB8;
            (*cur).color.r = (*color).r;
            (*cur).color.g = (*color).g;
            (*cur).color.b = (*color).b;
            (*cur).alpha =
                ((*cur).alpha as libc::c_int - 20 as libc::c_int) as s16;
            if (*cur).alpha as libc::c_int <= 0 as libc::c_int {
                (*cur).alpha = 0 as libc::c_int as s16;
                (*cur).isActive = 0 as libc::c_int as u8_0
            }
        }
        i += 1;
        cur = cur.offset(1)
...
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_AddParticle(mut particles:
                                                  *mut EfcErupcParticles,
                                              mut pos: *mut Vec3f,
                                              mut vel: *mut Vec3f,
                                              mut accel: *mut Vec3f,
                                              mut scaleFactor: f32_0) {
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 100 as libc::c_int {
        if (*particles).isActive == 0 {
            (*particles).isActive = 1 as libc::c_int as u8_0;
            (*particles).pos = *pos;
            (*particles).vel = *vel;
            (*particles).accel = *accel;
            (*particles).scale = scaleFactor / 1000.0f32;
            (*particles).alpha = 255 as libc::c_int as s16;
            (*particles).animTimer = Rand_ZeroFloat(10.0f32) as s16 as u8_0;
            return
        }
        i += 1;
        particles = particles.offset(1)
...
#[no_mangle]
pub unsafe extern "C" fn EfcErupc_InitParticles(mut particles:
                                                    *mut EfcErupcParticles) {
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < 100 as libc::c_int {
        (*particles).isActive = 0 as libc::c_int as u8_0;
        i += 1;
        particles = particles.offset(1)
    };
}
