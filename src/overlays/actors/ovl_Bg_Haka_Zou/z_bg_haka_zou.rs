...
extern "C" {
    ...
    #[no_mangle]
    static mut gBotwBombSpotDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotwBombSpotCol: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_005CE0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_005E30: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_0064E0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_006F70: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaZou {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaZouActionFunc,
    pub requiredObjBankIndex: s8,
    pub switchFlag: u8_0,
    pub timer: s16,
    pub collider: ColliderCylinder,
}
pub type BgHakaZouActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaZou, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const STA_UNKNOWN: C2RustUnnamed_21 = 3;
pub const STA_BOMBABLE_RUBBLE: C2RustUnnamed_21 = 2;
pub const STA_BOMBABLE_SKULL_WALL: C2RustUnnamed_21 = 1;
pub const STA_GIANT_BIRD_STATUE: C2RustUnnamed_21 = 0;
...
#[no_mangle]
pub static mut Bg_Haka_Zou_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_ZOU as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaZou_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaZou_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHakaZou = thisx as *mut BgHakaZou;
    ...
    if (*thisx).params as libc::c_int == STA_UNKNOWN as libc::c_int {
        Actor_SetScale(thisx, Rand_ZeroOne() * 0.005f32 + 0.025f32);
        ...
        (*thisx).world.rot.x =
            (Rand_S16Offset(0x100 as libc::c_int as s16,
                            0x300 as libc::c_int as s16) as libc::c_int *
                 (if Rand_ZeroOne() < 0.5f32 {
                      -(1 as libc::c_int)
                  } else { 1 as libc::c_int })) as s16;
        (*thisx).world.rot.z =
            (Rand_S16Offset(0x400 as libc::c_int as s16,
                            0x800 as libc::c_int as s16) as libc::c_int *
                 (if Rand_ZeroOne() < 0.5f32 {
                      -(1 as libc::c_int)
                  } else { 1 as libc::c_int })) as s16
    } else {
        ...
        if (*thisx).params as libc::c_int ==
               STA_GIANT_BIRD_STATUE as libc::c_int {
            (*thisx).uncullZoneForward = 2000.0f32;
            (*thisx).uncullZoneScale = 3000.0f32;
            (*thisx).uncullZoneDownward = 3000.0f32
        }
    }
    (*this).requiredObjBankIndex =
        if (*thisx).params as libc::c_int ==
               STA_BOMBABLE_RUBBLE as libc::c_int {
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_HAKACH_OBJECTS as libc::c_int as s16)
        } else {
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_HAKA_OBJECTS as libc::c_int as s16)
        } as s8;
    if ((*this).requiredObjBankIndex as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(thisx);
    } else if (*thisx).params as libc::c_int != STA_UNKNOWN as libc::c_int &&
                  Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        if (*thisx).params as libc::c_int !=
               STA_GIANT_BIRD_STATUE as libc::c_int {
            Actor_Kill(thisx);
        } else {
            (*thisx).shape.rot.x = -(0x4000 as libc::c_int) as s16;
            (*thisx).world.pos.z -= 80.0f32;
            (*thisx).world.pos.y -= 54.0f32
        }
    }
    (*this).actionFunc =
        Some(BgHakaZou_Wait as
                 unsafe extern "C" fn(_: *mut BgHakaZou,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaZou = thisx as *mut BgHakaZou;
    if (*this).dyna.actor.params as libc::c_int != STA_UNKNOWN as libc::c_int
       {
...
#[no_mangle]
pub unsafe extern "C" fn func_808828F4(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut effectVelocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut rand: f32_0 = 0.;
    let mut i: s32 = 0;
    effectVelocity.x = 0.0f32;
    effectVelocity.y = 1.0f32;
    effectVelocity.z = 2.0f32;
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        if i == 0 as libc::c_int {
            effectPos.x =
                (*this).dyna.actor.world.pos.x -
                    (Rand_CenteredFloat(10.0f32) + 112.0f32)
        } else {
            effectPos.x =
                Rand_CenteredFloat(10.0f32) + (*this).dyna.actor.world.pos.x
        }
        rand = Rand_ZeroOne();
        effectPos.y = (*this).dyna.actor.world.pos.y + 60.0f32 * rand;
        effectPos.z = (*this).dyna.actor.world.pos.z + 112.0f32 * rand;
        func_800286CC(globalCtx, &mut effectPos, &mut effectVelocity,
                      &mut sZeroVec,
                      (Rand_ZeroOne() * 200.0f32 + 1000.0f32) as s16,
                      100 as libc::c_int as s16);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_Wait(mut this: *mut BgHakaZou,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        if (*this).dyna.actor.params as libc::c_int ==
            ...
            if (*this).dyna.actor.params as libc::c_int ==
                   STA_GIANT_BIRD_STATUE as libc::c_int {
                CollisionHeader_GetVirtual(&mut object_haka_objects_Col_006F70
                                               as *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
                (*this).collider.dim.radius = 80 as libc::c_int as s16;
                (*this).collider.dim.height = 100 as libc::c_int as s16;
                (*this).collider.dim.yShift = -(30 as libc::c_int) as s16;
                (*this).collider.dim.pos.x =
                    ((*this).collider.dim.pos.x as libc::c_int -
                         56 as libc::c_int) as s16;
                (*this).collider.dim.pos.z =
                    ((*this).collider.dim.pos.z as libc::c_int +
                         56 as libc::c_int) as s16;
                (*this).dyna.actor.uncullZoneScale = 1500.0f32
            } else if (*this).dyna.actor.params as libc::c_int ==
                          STA_BOMBABLE_SKULL_WALL as libc::c_int {
                CollisionHeader_GetVirtual(&mut object_haka_objects_Col_005E30
                                               as *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
                (*this).collider.dim.yShift = -(50 as libc::c_int) as s16
            } else {
                CollisionHeader_GetVirtual(&mut gBotwBombSpotCol as
                                               *mut CollisionHeader as
                                               *mut libc::c_void,
                                           &mut colHeader);
                (*this).collider.dim.radius = 55 as libc::c_int as s16;
            ...
            if (*this).dyna.actor.params as libc::c_int ==
               ...
               {
                (*this).actionFunc =
                    Some(BgHakaZou_DoNothing as
                             unsafe extern "C" fn(_: *mut BgHakaZou,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
                (*this).actionFunc =
                    Some(func_80883000 as
                             unsafe extern "C" fn(_: *mut BgHakaZou,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80882BDC(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).dyna.actor.shape.rot.x =
        ((*this).dyna.actor.shape.rot.x as libc::c_int +
             (*this).dyna.actor.world.rot.x as libc::c_int) as s16;
    ...
    if (*this).dyna.actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0
       {
        if (*this).dyna.actor.velocity.y < -8.0f32 {
            (*this).dyna.actor.velocity.y *= -0.6f32;
            ...
            (*this).dyna.actor.speedXZ = 2.0f32
...
#[no_mangle]
pub unsafe extern "C" fn func_80882CC4(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut actorSpawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sin: f32_0 = 0.;
    let mut cos: f32_0 = 0.;
    let mut pad: s32 = 0;
    sin =
        Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int -
                       0x4000 as libc::c_int) as s16) * 40.0f32;
    cos =
    ...
    while i < 3 as libc::c_int {
        ...
        while j < 3 as libc::c_int {
            actorSpawnPos.x =
                (*this).dyna.actor.world.pos.x +
                    (j - 1 as libc::c_int) as libc::c_float * sin;
            actorSpawnPos.z =
                (*this).dyna.actor.world.pos.z +
                    (j - 1 as libc::c_int) as libc::c_float * cos;
            actorSpawnPos.y =
                (*this).dyna.actor.world.pos.y +
                    ((i - 1 as libc::c_int) * 55 as libc::c_int) as
                        libc::c_float;
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_BG_HAKA_ZOU as libc::c_int as s16,
                        actorSpawnPos.x, actorSpawnPos.y, actorSpawnPos.z,
                        0 as libc::c_int as s16,
                        (*this).dyna.actor.shape.rot.y,
                        0 as libc::c_int as s16,
                        ((*this).dyna.actor.params as libc::c_int +
                             2 as libc::c_int) as s16);
            func_800286CC(globalCtx, &mut actorSpawnPos, &mut sZeroVec,
                          &mut sZeroVec, 1000 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80882E54(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut fragmentPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut num: s32 = 25 as libc::c_int;
    fragmentPos.x = (*this).collider.dim.pos.x as f32_0;
    fragmentPos.y = (*this).collider.dim.pos.y as f32_0;
    fragmentPos.z = (*this).collider.dim.pos.z as f32_0;
    EffectSsHahen_SpawnBurst(globalCtx, &mut fragmentPos, 10.0f32,
                             0 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             4 as libc::c_int as s16,
                             141 as libc::c_int as s16,
                             40 as libc::c_int as s16,
                             gBotwBombSpotDL.as_mut_ptr());
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        j = 0 as libc::c_int;
        while j < 2 as libc::c_int {
            fragmentPos.x =
                ((*this).collider.dim.pos.x as libc::c_int +
                     (j * 2 as libc::c_int - 1 as libc::c_int) * num) as
                    f32_0;
            fragmentPos.z =
                ((*this).collider.dim.pos.z as libc::c_int +
                     (i * 2 as libc::c_int - 1 as libc::c_int) * num) as
                    f32_0;
            EffectSsHahen_SpawnBurst(globalCtx, &mut fragmentPos, 10.0f32,
                                     0 as libc::c_int as s16,
                                     10 as libc::c_int as s16,
                                     ...
                                     40 as libc::c_int as s16,
                                     gBotwBombSpotDL.as_mut_ptr());
            func_800286CC(globalCtx, &mut fragmentPos, &mut sZeroVec,
                          &mut sZeroVec, 1000 as libc::c_int as s16,
                          50 as libc::c_int as s16);
            j += 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80883000(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).dyna.actor.params as libc::c_int ==
            ...
            (*this).timer = 20 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80883144 as
                         unsafe extern "C" fn(_: *mut BgHakaZou,
                                              _: *mut GlobalContext) -> ());
            OnePointCutscene_Init(globalCtx, 3400 as libc::c_int as s16,
                                  999 as libc::c_int as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
        } else if (*this).dyna.actor.params as libc::c_int == 2 as libc::c_int
         {
...
#[no_mangle]
pub unsafe extern "C" fn func_80883104(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
...
#[no_mangle]
pub unsafe extern "C" fn func_80883144(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int % 4 as libc::c_int == 0 {
        explosionPos.x =
            Rand_CenteredFloat(200.0f32) +
                ((*this).dyna.actor.world.pos.x - 56.0f32);
        explosionPos.y =
            Rand_ZeroOne() * 80.0f32 + (*this).dyna.actor.world.pos.y;
        explosionPos.z =
            Rand_CenteredFloat(200.0f32) +
                ((*this).dyna.actor.world.pos.z + 56.0f32);
        EffectSsBomb2_SpawnLayered(globalCtx, &mut explosionPos,
                                   &mut sZeroVec, &mut sZeroVec,
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_80883254 as
                     unsafe extern "C" fn(_: *mut BgHakaZou,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80883254(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut moveDist: f32_0 = Rand_ZeroOne() * 0.5f32 + 0.5f32;
    Math_StepToF(&mut (*this).dyna.actor.world.pos.z,
                 (*this).dyna.actor.home.pos.z - 80.0f32, 2.0f32 * moveDist);
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y - 40.0f32, moveDist) != 0 {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            (*this).timer = 60 as libc::c_int as s16;
            (*this).dyna.actor.world.rot.x = 8 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_80883328 as
                         unsafe extern "C" fn(_: *mut BgHakaZou,
                                              _: *mut GlobalContext) -> ())
        }
    } else { func_808828F4(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80883328(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    (*this).dyna.actor.world.rot.x =
        ((*this).dyna.actor.world.rot.x as libc::c_float +
             (*this).dyna.actor.world.rot.x as libc::c_int as libc::c_float /
                 8.0f32) as s16;
    if Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.x,
        ...
        while j < 2 as libc::c_int {
            ...
            while i < 4 as libc::c_int {
                effectPos.z -=
                    if i == 2 as libc::c_int { 550.0f32 } else { 50.0f32 };
                func_800286CC(globalCtx, &mut effectPos, &mut sZeroVec,
                              &mut sZeroVec,
                              (Rand_ZeroOne() * 200.0f32 + 1000.0f32) as s16,
                              200 as libc::c_int as s16);
                i += 1
            }
            effectPos.x -= 112.0f32;
            j += 1
        }
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
        ...
        (*this).actionFunc =
            Some(func_808834D8 as
                     unsafe extern "C" fn(_: *mut BgHakaZou,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808834D8(mut this: *mut BgHakaZou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut moveDist: f32_0 = 0.;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    moveDist =
        if (*this).timer as libc::c_int % 2 as libc::c_int != 0 {
            15.0f32
        } else { -15.0f32 };
    (*this).dyna.actor.world.pos.y +=
        ((*this).timer as libc::c_int & 0xfe as libc::c_int) as libc::c_float
            * 0.04f32 * moveDist;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgHakaZou_DoNothing as
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_DoNothing(mut this: *mut BgHakaZou,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaZou = thisx as *mut BgHakaZou;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaZou_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 4] =
        unsafe {
            [object_haka_objects_DL_0064E0.as_ptr() as *mut _,
             object_haka_objects_DL_005CE0.as_ptr() as *mut _,
             gBotwBombSpotDL.as_ptr() as *mut _,
             object_haka_objects_DL_005CE0.as_ptr() as *mut _]
        };
