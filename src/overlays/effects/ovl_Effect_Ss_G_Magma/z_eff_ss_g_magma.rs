...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffMagmaBubble1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubble8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffMagmaBubbleDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_G_Magma_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_G_MAGMA as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsGMagma_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsGMagmaInitParams =
        initParamsx as *mut EffectSsGMagmaInitParams;
    ...
    (*this).draw =
        Some(EffectSsGMagma_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsGMagma_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).gfx =
        gSegments[((gEffMagmaBubbleDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffMagmaBubbleDL.as_mut_ptr() as
                                              u32_0 &
...
static mut sTextures: [*mut libc::c_void; 8] =
    unsafe {
        [gEffMagmaBubble1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble5Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble6Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble7Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gEffMagmaBubble8Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    let mut texIdx: s16 =
    ...
    EffectSs_DrawGEffect(globalCtx, this, sTextures[texIdx as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsGMagma_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
