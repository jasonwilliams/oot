...
#[no_mangle]
pub static mut Effect_Ss_Sibuki_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_SIBUKI as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsSibuki_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsSibukiInitParams =
        initParamsx as *mut EffectSsSibukiInitParams;
    ...
    if (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
        ...
        (*this).gfx =
            gSegments[((gEffBubble2Tex.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gEffBubble2Tex.as_mut_ptr() as
                                                  u32_0 &
        ...
        (*this).gfx =
            gSegments[((gEffBubble1Tex.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gEffBubble1Tex.as_mut_ptr() as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
        ...
        ((Rand_ZeroOne() *
              (500.0f32 +
                   (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                       ...
                       libc::c_int as libc::c_float) * 0.01f32) as s16 as
             libc::c_int +
             (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
    ...
    (*this).regs[8 as libc::c_int as usize] =
        ((*initParams).moveDelay as libc::c_int + 1 as libc::c_int) as s16;
    (*this).draw =
        Some(EffectSsSibuki_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsSibuki_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[9 as libc::c_int as usize] = (*initParams).direction;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[0 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[1 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[2 as libc::c_int as usize] = 100 as libc::c_int as s16;
    (*this).regs[3 as libc::c_int as usize] = 100 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_sibuki.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsSibuki_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    let mut pad: [s32; 3] = [0; 3];
    let mut xzVelScale: f32_0 = 0.;
    let mut yaw: s16 = 0;
    ...
    } else if (*this).regs[10 as libc::c_int as usize] as libc::c_int !=
                  0 as libc::c_int {
