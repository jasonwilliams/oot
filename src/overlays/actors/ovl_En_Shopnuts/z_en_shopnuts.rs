...
extern "C" {
    ...
    #[no_mangle]
    static mut gBusinessScrubAnim_1EC: AnimationHeader;
    #[no_mangle]
    static mut gBusinessScrubAnim_39C: AnimationHeader;
    #[no_mangle]
    static mut gBusinessScrubRotateAnim: AnimationHeader;
    #[no_mangle]
    static mut gBusinessScrubLookAroundAnim: AnimationHeader;
    #[no_mangle]
    static mut gBusinessScrubAnim_139C: AnimationHeader;
    #[no_mangle]
    static mut gBusinessScrubNoseDL: [Gfx; 0];
    #[no_mangle]
    static mut gBusinessScrubSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gBusinessScrubAnim_4574: AnimationHeader;
}
...
pub struct EnShopnuts {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnShopnutsActionFunc,
    pub animFlagAndTimer: s16,
    pub jointTable: [Vec3s; 18],
    pub morphTable: [Vec3s; 18],
    pub collider: ColliderCylinder,
}
pub type EnShopnutsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnShopnuts, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Shopnuts_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SHOPNUTS as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnShopnuts_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnShopnuts_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnShopnuts_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnShopnuts_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 1 as libc::c_int as u8_0,
                                   cylRadius: 20 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnShopnuts = thisx as *mut EnShopnuts;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gBusinessScrubSkel, &mut gBusinessScrubAnim_4574,
    ...
    if (*this).actor.params as libc::c_int == 0x2 as libc::c_int &&
           gSaveContext.itemGetInf[0 as libc::c_int as usize] as libc::c_int &
               0x800 as libc::c_int != 0 ||
           (*this).actor.params as libc::c_int == 0x9 as libc::c_int &&
    ...
    } else { EnShopnuts_SetupWait(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnShopnuts = thisx as *mut EnShopnuts;
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupWait(mut this: *mut EnShopnuts) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                               &mut gBusinessScrubAnim_139C, 0.0f32);
    ...
    (*this).actionFunc =
        Some(EnShopnuts_Wait as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupLookAround(mut this:
                                                        *mut EnShopnuts) {
    Animation_PlayLoop(&mut (*this).skelAnime,
                       &mut gBusinessScrubLookAroundAnim);
    (*this).animFlagAndTimer = 2 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnShopnuts_LookAround as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupThrowNut(mut this: *mut EnShopnuts) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gBusinessScrubAnim_1EC);
    (*this).actionFunc =
        Some(EnShopnuts_ThrowNut as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupStand(mut this: *mut EnShopnuts) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut gBusinessScrubAnim_4574, -3.0f32);
    if (*this).actionFunc ==
           Some(EnShopnuts_ThrowNut as
                    unsafe extern "C" fn(_: *mut EnShopnuts,
                                         _: *mut GlobalContext) -> ()) {
    ...
    (*this).actionFunc =
        Some(EnShopnuts_Stand as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupBurrow(mut this: *mut EnShopnuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gBusinessScrubAnim_39C, -5.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x387d as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnShopnuts_Burrow as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SetupSpawnSalesman(mut this:
                                                           *mut EnShopnuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gBusinessScrubRotateAnim, -3.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3880 as libc::c_int as u16_0);
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnShopnuts_SpawnSalesman as
                 unsafe extern "C" fn(_: *mut EnShopnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Wait(mut this: *mut EnShopnuts,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if hasSlowPlaybackSpeed == 0 && (*this).actor.xzDistToPlayer < 120.0f32 {
        ...
        } else { EnShopnuts_SetupStand(this); }
    }
    if hasSlowPlaybackSpeed != 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_LookAround(mut this: *mut EnShopnuts,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Stand(mut this: *mut EnShopnuts,
                                          mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_ThrowNut(mut this: *mut EnShopnuts,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Burrow(mut this: *mut EnShopnuts,
                                           mut globalCtx:
                                               *mut GlobalContext) {
        ...
        (*this).collider.dim.height =
            ((4.0f32 -
                  (if (*this).skelAnime.curFrame > 4.0f32 {
                       4.0f32
                   } else { (*this).skelAnime.curFrame })) * 10.0f32 + 5.0f32)
                as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_SpawnSalesman(mut this: *mut EnShopnuts,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_DNS as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_ColliderCheck(mut this: *mut EnShopnuts,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnShopnuts = thisx as *mut EnShopnuts;
        ...
        Actor_SetFocus(&mut (*this).actor,
                       20.0f32 -
                           (*this).skelAnime.curFrame * 20.0f32 /
                               Animation_GetLastFrame(&mut gBusinessScrubAnim_39C
                                                          as
                                                          *mut AnimationHeader
                                                          as
                                                          *mut libc::c_void)
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
                                                 mut dList: *mut *mut Gfx,
                                                 mut rot: *mut Vec3s,
    ...
    if limbIndex == 9 as libc::c_int &&
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_shopnuts.c\x00" as *const u8 as
                            *const libc::c_char, 682 as libc::c_int);
        curFrame = (*this).skelAnime.curFrame;
        if curFrame <= 6.0f32 {
            y = 1.0f32 - curFrame * 0.0833f32;
            z = curFrame * 0.1167f32 + 1.0f32;
            x = z
            ...
            y = 1.5f32 - (curFrame - 7.0f32) * 0.1667f32;
            z = 1.0f32;
            x = z
        } else { z = 1.0f32; y = z; x = y }
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gBusinessScrubNoseDL.as_mut_ptr() as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnShopnuts_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnShopnuts = thisx as *mut EnShopnuts;
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          (*this).skelAnime.jointTable,
                          (*this).skelAnime.dListCount as s32,
                          Some(EnShopnuts_OverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        ...
                                                        _: *mut libc::c_void)
                                       -> s32),
                          Some(EnShopnuts_PostLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3s,
