...
extern "C" {
    ...
    #[no_mangle]
    static mut gObjectJyaIronDL_000600: [Gfx; 0];
    #[no_mangle]
    static mut gObjectJyaIronDL_000880: [Gfx; 0];
    #[no_mangle]
    static mut gObjectJyaIronDL_000AE0: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaHaheniron {
    pub actor: Actor,
    pub actionFunc: BgJyaHahenironActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub timer: s16,
}
pub type BgJyaHahenironActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaHaheniron, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Bg_Jya_Haheniron_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_HAHENIRON as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJyaHaheniron>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaHaheniron_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaHaheniron_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaHaheniron_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaHaheniron_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sKakeraScales: [s16; 5] =
...
static mut D_80898794: [f32_0; 3] = [0.13f32, 0.1f32, 0.1f32];
static mut D_808987A0: [Vec3f; 1] =
    [{ let mut init = Vec3f{x: 0.0f32, y: 14.0f32, z: 0.0f32,}; init }];
static mut D_808987AC: [Vec3f; 1] =
    [{ let mut init = Vec3f{x: 0.0f32, y: 8.0f32, z: 0.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_ColliderInit(mut this:
                                                         *mut BgJyaHaheniron,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_SpawnFragments(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut vec1: *mut Vec3f,
                                                       mut vec2: *mut Vec3f) {
    ...
    while i <
              (::std::mem::size_of::<[s16; 5]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        rand1 = Rand_ZeroOne() * 10.0f32;
        vel.x = Math_SinS(angle as s16) * rand1 + (*vec2).x;
        vel.y = Rand_ZeroOne() * 10.0f32 + (*vec2).y;
        vel.z = Math_CosS(angle as s16) * rand1 + (*vec2).z;
        rand1 = Rand_ZeroOne();
        if rand1 < 0.2f32 {
            arg5 = 96 as libc::c_int as s16
        } else if rand1 < 0.8f32 {
            arg5 = 64 as libc::c_int as s16
        } else { arg5 = 32 as libc::c_int as s16 }
        EffectSsKakera_Spawn(globalCtx, vec1, &mut vel, vec1,
                             -(350 as libc::c_int) as s16, arg5,
                             40 as libc::c_int as s16,
                             4 as libc::c_int as s16, 0 as libc::c_int as s16,
                             sKakeraScales[i as usize],
                             0 as libc::c_int as s16,
                             20 as libc::c_int as s16, 40 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_JYA_IRON as libc::c_int as s16,
                             gObjectJyaIronDL_000880.as_mut_ptr());
        angle += 0x3333 as libc::c_int;
        i += 1
    }
    pos.x = (*vec1).x + (*vec2).x * 5.0f32;
    pos.y = (*vec1).y + (*vec2).y * 5.0f32;
    pos.z = (*vec1).z + (*vec2).z * 5.0f32;
    func_80033480(globalCtx, &mut pos, 100.0f32, 4 as libc::c_int,
                  100 as libc::c_int as s16, 160 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaHaheniron = thisx as *mut BgJyaHaheniron;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor,
                   D_80898794[(*this).actor.params as usize]);
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        BgJyaHaheniron_ColliderInit(this, globalCtx);
        (*this).actor.shape.rot.z = (Rand_ZeroOne() * 65535.0f32) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaHaheniron = thisx as *mut BgJyaHaheniron;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_SetupChairCrumble(mut this:
                                                              *mut BgJyaHaheniron) {
    (*this).actionFunc =
        Some(BgJyaHaheniron_ChairCrumble as
                 unsafe extern "C" fn(_: *mut BgJyaHaheniron,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_ChairCrumble(mut this:
                                                         *mut BgJyaHaheniron,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32, 8.0f32,
                            0.0f32, 0x85 as libc::c_int);
    if (*this).actor.bgCheckFlags as libc::c_int & 9 as libc::c_int != 0 ||
           (*this).collider.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               !(*this).collider.base.at.is_null() &&
               (*(*this).collider.base.at).category as libc::c_int ==
        ...
        BgJyaHaheniron_SpawnFragments(globalCtx, &mut (*this).actor.world.pos,
                                      &mut vec);
        Actor_Kill(&mut (*this).actor);
    } else if (*this).timer as libc::c_int > 60 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    } else {
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x4b0 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + 0xfa0 as libc::c_int) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_SetupPillarCrumble(mut this:
                                                               *mut BgJyaHaheniron) {
    (*this).actionFunc =
        Some(BgJyaHaheniron_PillarCrumble as
                 unsafe extern "C" fn(_: *mut BgJyaHaheniron,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_PillarCrumble(mut this:
                                                          *mut BgJyaHaheniron,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*this).timer as libc::c_int >= 8 as libc::c_int {
        Actor_MoveForward(&mut (*this).actor);
    } else if (*this).timer as libc::c_int >= 17 as libc::c_int {
        BgJyaHaheniron_SpawnFragments(globalCtx, &mut (*this).actor.world.pos,
                                      D_808987A0.as_mut_ptr());
        Actor_Kill(&mut (*this).actor);
    }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x258 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + 0x3e8 as libc::c_int) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_SetupRubbleCollide(mut this:
                                                               *mut BgJyaHaheniron) {
    (*this).actionFunc =
        Some(BgJyaHaheniron_RubbleCollide as
                 unsafe extern "C" fn(_: *mut BgJyaHaheniron,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_RubbleCollide(mut this:
                                                          *mut BgJyaHaheniron,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*this).timer as libc::c_int >= 17 as libc::c_int {
        BgJyaHaheniron_SpawnFragments(globalCtx, &mut (*this).actor.world.pos,
                                      D_808987AC.as_mut_ptr());
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                  80 as libc::c_int,
                                  0x39ac as libc::c_int as u16_0);
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaHaheniron = thisx as *mut BgJyaHaheniron;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaHaheniron_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 3] =
        unsafe {
            [gObjectJyaIronDL_000880.as_ptr() as *mut _,
             gObjectJyaIronDL_000AE0.as_ptr() as *mut _,
             gObjectJyaIronDL_000600.as_ptr() as *mut _]
        };
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaHaheniron = thisx as *mut BgJyaHaheniron;
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
    ...
    Gfx_DrawDListOpa(globalCtx, dLists[(*this).actor.params as usize]);
}
