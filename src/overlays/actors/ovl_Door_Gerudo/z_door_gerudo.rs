...
extern "C" {
    ...
    #[no_mangle]
    static mut gGerudoCellDoorDL: [Gfx; 0];
    #[no_mangle]
    static mut gGerudoCellDoorCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DoorGerudo {
    pub dyna: DynaPolyActor,
    pub unk_164: s16,
    pub unk_166: u8_0,
    pub actionFunc: DoorGerudoActionFunc,
}
pub type DoorGerudoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DoorGerudo, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Door_Gerudo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DOOR_GERUDO as libc::c_int as s16,
                          category:
                              ACTORCAT_ITEMACTION as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_DOOR_GERUDO as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DoorGerudo>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorGerudo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorGerudo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorGerudo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DoorGerudo_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn DoorGerudo_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DoorGerudo = thisx as *mut DoorGerudo;
    ...
    CollisionHeader_GetVirtual(&mut gGerudoCellDoorCol as *mut CollisionHeader
    ...
    if Flags_GetSwitch(globalCtx,
           ...
           != 0 {
        (*this).actionFunc =
            Some(func_8099485C as
                     unsafe extern "C" fn(_: *mut DoorGerudo,
                                          _: *mut GlobalContext) -> ());
        (*thisx).world.pos.y = (*thisx).home.pos.y + 200.0f32
    } else {
        (*this).actionFunc =
            Some(func_8099485C as
                     unsafe extern "C" fn(_: *mut DoorGerudo,
                                          _: *mut GlobalContext) -> ());
        (*this).unk_166 = 10 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn DoorGerudo_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut DoorGerudo = thisx as *mut DoorGerudo;
...
#[no_mangle]
pub unsafe extern "C" fn func_809946BC(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut DoorGerudo,
    ...
    func_8002DBD0(&mut (*this).dyna.actor, &mut sp1C, &mut playerPos);
    if arg3 < fabsf(sp1C.x) || arg4 < fabsf(sp1C.y) {
        return 340282346638528859811704183484516925440.0f32
    } else { return sp1C.z };
}
#[no_mangle]
pub unsafe extern "C" fn func_80994750(mut this: *mut DoorGerudo,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    let mut rotYDiff: s16 = 0;
    if Player_InCsMode(globalCtx) == 0 {
        temp_f0 = func_809946BC(globalCtx, this, 0.0f32, 20.0f32, 15.0f32);
        if fabsf(temp_f0) < 40.0f32 {
            rotYDiff =
                ((*player).actor.shape.rot.y as libc::c_int -
                     (*this).dyna.actor.shape.rot.y as libc::c_int) as s16;
            if temp_f0 > 0.0f32 {
                rotYDiff =
                    (0x8000 as libc::c_int - rotYDiff as libc::c_int) as s16
            }
            if (if rotYDiff as libc::c_int >= 0 as libc::c_int {
                    rotYDiff as libc::c_int
                } else { -(rotYDiff as libc::c_int) }) < 0x2000 as libc::c_int
               {
                return if temp_f0 >= 0.0f32 { 1.0f32 } else { -1.0f32 } as s32
            }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_8099485C(mut this: *mut DoorGerudo,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_164 as libc::c_int != 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_8099496C as
                     unsafe extern "C" fn(_: *mut DoorGerudo,
                                          _: *mut GlobalContext) -> ());
        ...
        let mut direction: s32 = func_80994750(this, globalCtx);
        if direction != 0 as libc::c_int {
            ...
            if gSaveContext.inventory.dungeonKeys[gSaveContext.mapIndex as
                ...
                (*player).naviTextId = -(0x225 as libc::c_int) as s16
            } else {
                (*player).doorType =
                    PLAYER_DOORTYPE_SLIDING as libc::c_int as s8;
                (*player).doorDirection = direction as s8;
...
#[no_mangle]
pub unsafe extern "C" fn func_8099496C(mut this: *mut DoorGerudo,
                                       mut globalCtx: *mut GlobalContext) {
    if (if (*this).unk_166 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).unk_166 = (*this).unk_166.wrapping_sub(1);
            (*this).unk_166 as libc::c_int
        }) == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x2814 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_809949C8 as
                     unsafe extern "C" fn(_: *mut DoorGerudo,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809949C8(mut this: *mut DoorGerudo,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DoorGerudo_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut DoorGerudo = thisx as *mut DoorGerudo;
...
#[no_mangle]
pub unsafe extern "C" fn DoorGerudo_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DoorGerudo = thisx as *mut DoorGerudo;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_door_gerudo.c\x00" as *const u8 as
                        *const libc::c_char, 361 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gGerudoCellDoorDL.as_mut_ptr() as libc::c_uint;
    if (*this).unk_166 as libc::c_int != 0 as libc::c_int {
        Matrix_Scale(0.01f32, 0.01f32, 0.025f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Actor_DrawDoorLock(globalCtx, (*this).unk_166 as s32,
                           DOORLOCK_NORMAL as libc::c_int);
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_door_gerudo.c\x00" as *const u8 as
                         *const libc::c_char, 377 as libc::c_int);
}
