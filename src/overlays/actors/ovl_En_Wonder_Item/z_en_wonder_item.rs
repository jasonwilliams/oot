...
pub struct EnWonderItem {
    pub actor: Actor,
    pub updateFunc: EnWonderItemUpdateFunc,
    pub unkHeight: f32_0,
    pub wonderMode: s16,
    pub itemDrop: s16,
    pub numTagPoints: s16,
    pub dropCount: s16,
    pub timer: s16,
    pub tagFlags: s16,
    pub tagCount: s16,
    pub switchFlag: s16,
    pub unk_164: [libc::c_char; 4],
    pub nextTag: s16,
    pub timerMod: s16,
    pub unkPos: Vec3f,
    pub unk_178: [libc::c_char; 8],
    pub collider: ColliderCylinder,
    pub unk_1CC: [libc::c_char; 4],
}
pub type EnWonderItemUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWonderItem, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const WONDERITEM_ROLL_DROP: C2RustUnnamed_21 = 9;
pub const WONDERITEM_BOMB_SOLDIER: C2RustUnnamed_21 = 8;
pub const WONDERITEM_PROXIMITY_SWITCH: C2RustUnnamed_21 = 7;
pub const WONDERITEM_TAG_POINT_ORDERED: C2RustUnnamed_21 = 6;
pub const WONDERITEM_MULTITAG_ORDERED: C2RustUnnamed_21 = 5;
pub const WONDERITEM_UNUSED: C2RustUnnamed_21 = 4;
pub const WONDERITEM_INTERACT_SWITCH: C2RustUnnamed_21 = 3;
pub const WONDERITEM_PROXIMITY_DROP: C2RustUnnamed_21 = 2;
pub const WONDERITEM_TAG_POINT_FREE: C2RustUnnamed_21 = 1;
pub const WONDERITEM_MULTITAG_FREE: C2RustUnnamed_21 = 0;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const WONDERITEM_DROP_RANDOM: C2RustUnnamed_22 = 12;
pub const WONDERITEM_DROP_FLEXIBLE: C2RustUnnamed_22 = 11;
pub const WONDERITEM_DROP_RED_RUPEE: C2RustUnnamed_22 = 10;
pub const WONDERITEM_DROP_BLUE_RUPEE: C2RustUnnamed_22 = 9;
pub const WONDERITEM_DROP_GREEN_RUPEE: C2RustUnnamed_22 = 8;
pub const WONDERITEM_DROP_ARROWS_LARGE: C2RustUnnamed_22 = 7;
pub const WONDERITEM_DROP_ARROWS_MEDIUM: C2RustUnnamed_22 = 6;
pub const WONDERITEM_DROP_ARROWS_SMALL: C2RustUnnamed_22 = 5;
pub const WONDERITEM_DROP_HEART: C2RustUnnamed_22 = 4;
pub const WONDERITEM_DROP_MAGIC_SMALL: C2RustUnnamed_22 = 3;
pub const WONDERITEM_DROP_MAGIC_LARGE: C2RustUnnamed_22 = 2;
pub const WONDERITEM_DROP_HEART_PIECE: C2RustUnnamed_22 = 1;
pub const WONDERITEM_DROP_NUTS: C2RustUnnamed_22 = 0;
...
#[no_mangle]
pub static mut En_Wonder_Item_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WONDER_ITEM as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnWonderItem>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderItem_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderItem_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderItem_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTagPointsFree: [Vec3f; 9] = [Vec3f{x: 0., y: 0., z: 0.,}; 9];
static mut sTagPointsOrdered: [Vec3f; 9] = [Vec3f{x: 0., y: 0., z: 0.,}; 9];
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnWonderItem = thisx as *mut EnWonderItem;
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_DropCollectible(mut this:
                                                          *mut EnWonderItem,
                                                      mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut autoCollect: s32) {
    static mut dropTable: [s16; 12] =
        [ITEM00_NUTS as libc::c_int as s16,
         ITEM00_HEART_PIECE as libc::c_int as s16,
         ITEM00_MAGIC_LARGE as libc::c_int as s16,
         ITEM00_MAGIC_SMALL as libc::c_int as s16,
         ITEM00_HEART as libc::c_int as s16,
         ITEM00_ARROWS_SMALL as libc::c_int as s16,
         ITEM00_ARROWS_MEDIUM as libc::c_int as s16,
         ITEM00_ARROWS_LARGE as libc::c_int as s16,
    ...
    let mut i: s32 = 0;
    let mut randomDrop: s32 = 0;
    func_80078884(0x4824 as libc::c_int as u16_0);
    if (*this).dropCount as libc::c_int == 0 as libc::c_int {
        (*this).dropCount += 1
    }
    i = (*this).dropCount as s32;
    while i > 0 as libc::c_int {
        if ((*this).itemDrop as libc::c_int) <
               WONDERITEM_DROP_RANDOM as libc::c_int {
            if (*this).itemDrop as libc::c_int ==
                   WONDERITEM_DROP_FLEXIBLE as libc::c_int || autoCollect == 0
               {
                Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                                     dropTable[(*this).itemDrop as usize]);
            } else {
                Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                                     (dropTable[(*this).itemDrop as usize] as
                                          libc::c_int | 0x8000 as libc::c_int)
                                         as s16);
            }
        } else {
            randomDrop =
                (*this).itemDrop as libc::c_int -
                    WONDERITEM_DROP_RANDOM as libc::c_int;
            if autoCollect == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut collisionTypes: [u32_0; 7] =
        [0x702 as libc::c_int as u32_0, 0x1f820 as libc::c_int as u32_0,
         0x40 as libc::c_int as u32_0, 0x8 as libc::c_int as u32_0,
         0x4 as libc::c_int as u32_0, 0x10 as libc::c_int as u32_0,
         0x80 as libc::c_int as u32_0];
    let mut pad: s32 = 0;
    let mut colTypeIndex: s16 = 0;
    let mut this: *mut EnWonderItem = thisx as *mut EnWonderItem;
    let mut rotZover10: s16 = 0;
    let mut tagIndex: s16 = 0;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Mysterious mystery, very mysterious"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xb8\x8d\xe6\x80\x9d\xe8\xad\xb0\xe4\xb8\x8d\xe6\x80\x9d\xe8\xad\xb0\xe3\x81\xbe\xe3\x81\x8b\xe4\xb8\x8d\xe6\x80\x9d\xe8\xad\xb0 \t   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).wonderMode =
        ((*this).actor.params as libc::c_int >> 0xb as libc::c_int &
    ...
    match (*this).wonderMode as libc::c_int {
        0 => {
            (*this).numTagPoints =
                ((*this).actor.world.rot.z as libc::c_int &
                     0xf as libc::c_int) as s16;
            rotZover10 = 0 as libc::c_int as s16;
            if (*this).actor.world.rot.z as libc::c_int >= 10 as libc::c_int {
                rotZover10 =
                    ((*this).actor.world.rot.z as libc::c_int /
                         10 as libc::c_int) as s16;
                (*this).timerMod =
                    (rotZover10 as libc::c_int * 20 as libc::c_int) as s16
            }
            (*this).numTagPoints =
                ((*this).actor.world.rot.z as libc::c_int -
                     rotZover10 as libc::c_int * 10 as libc::c_int) as s16;
            // i.e timerMod = rot.z / 10 seconds, numTagPoints = rot.z % 10
            (*this).updateFunc =
                Some(EnWonderItem_MultitagFree as
                         unsafe extern "C" fn(_: *mut EnWonderItem,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
            tagIndex =
            ...
            sTagPointsFree[tagIndex as usize] = (*this).actor.world.pos;
            Actor_Kill(&mut (*this).actor);
        }
        2 => {
            (*this).dropCount =
                ((*this).actor.world.rot.z as libc::c_int &
                     0xff as libc::c_int) as s16;
            (*this).updateFunc =
                Some(EnWonderItem_ProximityDrop as
                         unsafe extern "C" fn(_: *mut EnWonderItem,
                                              _: *mut GlobalContext) -> ())
        }
        3 => {
        ...
        5 => {
            ...
            // i.e timerMod = rot.z / 10 seconds, numTagPoints = rot.z % 10
            (*this).updateFunc =
                Some(EnWonderItem_MultitagOrdered as
                         unsafe extern "C" fn(_: *mut EnWonderItem,
                                              _: *mut GlobalContext) -> ())
        }
        6 => {
            tagIndex =
                ((*this).actor.world.rot.z as libc::c_int &
                     0xff as libc::c_int) as s16; // slingshot
            sTagPointsOrdered[tagIndex as usize] = (*this).actor.world.pos;
            Actor_Kill(&mut (*this).actor);
        }
        7 => {
            (*this).updateFunc =
                Some(EnWonderItem_ProximitySwitch as
                         unsafe extern "C" fn(_: *mut EnWonderItem,
                                              _: *mut GlobalContext) -> ())
        }
        8 => {
            ...
            (*this).collider.dim.height = 75 as libc::c_int as s16;
            (*this).updateFunc =
                Some(EnWonderItem_BombSoldier as
                         unsafe extern "C" fn(_: *mut EnWonderItem,
                                              _: *mut GlobalContext) -> ())
        }
        9 => {
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_MultitagFree(mut this:
                                                       *mut EnWonderItem,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    let mut prevTagFlags: s32 = (*this).tagFlags as s32;
    let mut i: s32 = 0;
    let mut mask: s32 = 0;
    i = 0 as libc::c_int;
    mask = 1 as libc::c_int;
    while i < (*this).numTagPoints as libc::c_int {
        if prevTagFlags & mask == 0 {
            let mut dx: f32_0 =
                (*player).actor.world.pos.x - sTagPointsFree[i as usize].x;
            let mut dy: f32_0 =
                (*player).actor.world.pos.y - sTagPointsFree[i as usize].y;
            let mut dz: f32_0 =
                (*player).actor.world.pos.z - sTagPointsFree[i as usize].z;
            if sqrtf(dx * dx + dy * dy + dz * dz) < 50.0f32 {
                (*this).tagFlags =
                    ((*this).tagFlags as libc::c_int | mask) as s16;
                (*this).tagCount += 1;
                (*this).timer =
                    ((*this).timerMod as libc::c_int + 81 as libc::c_int) as
                        s16;
                return
            }
            if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
               ...
               {
                DebugDisplay_AddObject(sTagPointsFree[i as usize].x,
                                       sTagPointsFree[i as usize].y,
                                       sTagPointsFree[i as usize].z,
    ...
    if (*this).tagCount as libc::c_int == (*this).numTagPoints as libc::c_int
       {
        if (*this).switchFlag as libc::c_int >= 0 as libc::c_int {
            Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
        }
        EnWonderItem_DropCollectible(this, globalCtx, 1 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_ProximityDrop(mut this:
                                                        *mut EnWonderItem,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut player: *mut Player =
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_InteractSwitch(mut this:
                                                         *mut EnWonderItem,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        EnWonderItem_DropCollectible(this, globalCtx, 0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_ProximitySwitch(mut this:
                                                          *mut EnWonderItem,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut player: *mut Player =
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_MultitagOrdered(mut this:
                                                          *mut EnWonderItem,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut player: *mut Player =
    ...
    while i < (*this).numTagPoints as libc::c_int {
        if prevTagFlags & mask == 0 {
            let mut dx: f32_0 =
                (*player).actor.world.pos.x - sTagPointsOrdered[i as usize].x;
            let mut dy: f32_0 =
                (*player).actor.world.pos.y - sTagPointsOrdered[i as usize].y;
            let mut dz: f32_0 =
                (*player).actor.world.pos.z - sTagPointsOrdered[i as usize].z;
            if sqrtf(dx * dx + dy * dy + dz * dz) < 50.0f32 {
                if prevTagFlags & mask != 0 {
                    return
                } else if i == (*this).nextTag as libc::c_int {
                    (*this).tagFlags =
                        ((*this).tagFlags as libc::c_int | mask) as s16;
                    (*this).tagCount += 1;
                    (*this).nextTag += 1;
                    (*this).timer =
                        ((*this).timerMod as libc::c_int + 81 as libc::c_int)
                            as s16;
                    return
                ...
                if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                    ...
                    DebugDisplay_AddObject(sTagPointsOrdered[i as usize].x,
                                           sTagPointsOrdered[i as usize].y,
                                           sTagPointsOrdered[i as usize].z,
                                           (*this).actor.world.rot.x,
                                           (*this).actor.world.rot.y,
                                           (*this).actor.world.rot.z, 1.0f32,
                                           1.0f32, 1.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_BombSoldier(mut this: *mut EnWonderItem,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        ...
        if !Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_HEISHI2 as libc::c_int as s16,
                        (*this).actor.world.pos.x, (*this).actor.world.pos.y,
                        (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                        (*this).actor.yawTowardsPlayer,
                        0 as libc::c_int as s16,
                        9 as libc::c_int as s16).is_null() {
            // "Careless soldier spawned"
            osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x86\xe3\x81\xa3\xe3\x81\x8b\xe3\x82\x8a\xe5\x85\xb5\xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88\xe5\xae\x8c\xe4\xba\x86 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as
                             *const libc::c_char); // These seem to be mistyped. Logically they should be s16[13][3] and be indexed as [colorIndex][i]
        }
        if (*this).switchFlag as libc::c_int >= 0 as libc::c_int {
            Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_RollDrop(mut this: *mut EnWonderItem,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderItem_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut debugArrowColors: [s16; 39] =
        [255 as libc::c_int as s16, 255 as libc::c_int as s16,
         ...
         0 as libc::c_int as s16, 0 as libc::c_int as s16,
         0 as libc::c_int as s16, 255 as libc::c_int as s16,
         128 as libc::c_int as s16, 128 as libc::c_int as s16,
         128 as libc::c_int as s16, 128 as libc::c_int as s16,
         128 as libc::c_int as s16, 0 as libc::c_int as s16,
         128 as libc::c_int as s16, 0 as libc::c_int as s16,
         128 as libc::c_int as s16, 0 as libc::c_int as s16,
         128 as libc::c_int as s16, 0 as libc::c_int as s16,
         128 as libc::c_int as s16, 0 as libc::c_int as s16,
    ...
    let mut pad: s32 = 0;
    let mut this: *mut EnWonderItem = thisx as *mut EnWonderItem;
    let mut colorIndex: s32 = 0;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).updateFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).wonderMode as libc::c_int == WONDERITEM_UNUSED as libc::c_int {
        Actor_SetFocus(&mut (*this).actor, (*this).unkHeight);
    }
    if (*this).wonderMode as libc::c_int ==
           WONDERITEM_INTERACT_SWITCH as libc::c_int ||
           (*this).wonderMode as libc::c_int ==
               WONDERITEM_BOMB_SOLDIER as libc::c_int {
    ...
    colorIndex = (*this).wonderMode as s32;
    if (*this).wonderMode as libc::c_int > 12 as libc::c_int {
        colorIndex = 0 as libc::c_int
    }
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        DebugDisplay_AddObject((*this).actor.world.pos.x,
                               ...
                               1.0f32,
                               debugArrowColors[colorIndex as usize] as u8_0,
                               debugArrowColors[(colorIndex +
                                                     1 as libc::c_int) as
                                                    usize] as u8_0,
                               debugArrowColors[(colorIndex +
                                                     2 as libc::c_int) as
