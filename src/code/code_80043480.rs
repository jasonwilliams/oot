...
#[no_mangle]
pub unsafe extern "C" fn DynaPolyActor_Init(mut dynaActor: *mut DynaPolyActor,
                                            mut flags: s32) {
    (*dynaActor).bgId = -(1 as libc::c_int);
    (*dynaActor).unk_15C = flags as u32_0;
    (*dynaActor).unk_160 = 0 as libc::c_int as u8_0;
    (*dynaActor).unk_150 = 0.0f32;
    (*dynaActor).unk_154 = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_800434A0(mut dynaActor: *mut DynaPolyActor) {
    (*dynaActor).unk_160 = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_800434A8(mut dynaActor: *mut DynaPolyActor) {
    (*dynaActor).unk_160 =
        ((*dynaActor).unk_160 as libc::c_int | 1 as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_800434B8(mut dynaActor: *mut DynaPolyActor) {
    (*dynaActor).unk_160 =
        ((*dynaActor).unk_160 as libc::c_int | 2 as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_800434C8(mut colCtx: *mut CollisionContext,
                                       mut floorBgId: s32) {
    let mut dynaActor: *mut DynaPolyActor =
        DynaPoly_GetActor(colCtx, floorBgId);
    if !dynaActor.is_null() { func_800434B8(dynaActor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_800434F8(mut dynaActor: *mut DynaPolyActor) {
    (*dynaActor).unk_160 =
        ((*dynaActor).unk_160 as libc::c_int | 4 as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80043508(mut colCtx: *mut CollisionContext,
                                       mut floorBgId: s32) {
    let mut dynaActor: *mut DynaPolyActor =
        DynaPoly_GetActor(colCtx, floorBgId);
    if !dynaActor.is_null() { func_800434F8(dynaActor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80043538(mut dynaActor: *mut DynaPolyActor) {
    (*dynaActor).unk_160 =
        ((*dynaActor).unk_160 as libc::c_int | 8 as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80043548(mut dynaActor: *mut DynaPolyActor)
 -> s32 {
    if (*dynaActor).unk_160 as libc::c_int & 1 as libc::c_int != 0 {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_8004356C(mut dynaActor: *mut DynaPolyActor)
 -> s32 {
    if (*dynaActor).unk_160 as libc::c_int & 2 as libc::c_int != 0 {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_80043590(mut dynaActor: *mut DynaPolyActor)
 -> s32 {
    if (*dynaActor).unk_160 as libc::c_int & 4 as libc::c_int != 0 {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_800435B4(mut dynaActor: *mut DynaPolyActor)
 -> s32 {
    if (*dynaActor).unk_160 as libc::c_int & 8 as libc::c_int != 0 {
        return 1 as libc::c_int
    } else { return 0 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_800435D8(mut globalCtx: *mut GlobalContext,
                                       mut dynaActor: *mut DynaPolyActor,
    ...
    let mut sin: f32_0 = Math_SinS((*dynaActor).unk_158);
    let mut cos: f32_0 = Math_CosS((*dynaActor).unk_158);
    let mut bgId: s32 = 0;
    let mut poly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut a2: f32_0 = 0.;
    let mut a3: f32_0 = 0.;
    let mut sign: f32_0 =
        if 0.0f32 <= (*dynaActor).unk_150 { 1.0f32 } else { -1.0f32 };
    a2 = arg2 as f32_0 - 0.1f32;
    posA.x = (*dynaActor).actor.world.pos.x + a2 * cos;
    posA.y =
        (*dynaActor).actor.world.pos.y + arg4 as libc::c_int as libc::c_float;
    posA.z = (*dynaActor).actor.world.pos.z - a2 * sin;
    a3 = arg3 as f32_0 - 0.1f32;
    posB.x = sign * a3 * sin + posA.x;
    posB.y = posA.y;
    posB.z = sign * a3 * cos + posA.z;
    if BgCheck_EntityLineTest3(&mut (*globalCtx).colCtx, &mut posA, &mut posB,
                               &mut posResult, &mut poly, 1 as libc::c_int,
                               0 as libc::c_int, 0 as libc::c_int,
                               1 as libc::c_int, &mut bgId,
                               &mut (*dynaActor).actor, 0.0f32) != 0 {
        return 0 as libc::c_int
    }
    posA.x =
        (*dynaActor).actor.world.pos.x * 2 as libc::c_int as libc::c_float -
            posA.x;
    posA.z =
        (*dynaActor).actor.world.pos.z * 2 as libc::c_int as libc::c_float -
            posA.z;
    posB.x = sign * a3 * sin + posA.x;
    posB.z = sign * a3 * cos + posA.z;
    if BgCheck_EntityLineTest3(&mut (*globalCtx).colCtx, &mut posA, &mut posB,
