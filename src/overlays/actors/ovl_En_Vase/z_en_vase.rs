...
extern "C" {
    ...
    #[no_mangle]
    static mut gUnusedVaseDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut En_Vase_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_VASE as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_VASE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnVase>() as
                                  libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnVase_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnVase = thisx as *mut EnVase;
...
#[no_mangle]
pub unsafe extern "C" fn EnVase_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnVase_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gUnusedVaseDL.as_mut_ptr());
}
