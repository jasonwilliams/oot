...
pub const TEXT_STATE_AWAITING_NEXT: C2RustUnnamed_17 = 10;
pub const TEXT_STATE_9: C2RustUnnamed_17 = 9;
pub const TEXT_STATE_8: C2RustUnnamed_17 = 8;
pub const TEXT_STATE_SONG_DEMO_DONE: C2RustUnnamed_17 = 7;
pub const TEXT_STATE_DONE: C2RustUnnamed_17 = 6;
pub const TEXT_STATE_EVENT: C2RustUnnamed_17 = 5;
pub const TEXT_STATE_CHOICE: C2RustUnnamed_17 = 4;
pub const TEXT_STATE_DONE_FADING: C2RustUnnamed_17 = 3;
pub const TEXT_STATE_CLOSING: C2RustUnnamed_17 = 2;
pub const TEXT_STATE_DONE_HAS_NEXT: C2RustUnnamed_17 = 1;
pub const TEXT_STATE_NONE: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnWonderTalk {
    pub actor: Actor,
    pub actionFunc: EnWonderTalkFunc,
    pub unk_150: s16,
    pub unk_152: s16,
    pub switchFlag: s16,
    pub unk_156: s16,
...
pub type EnWonderTalkFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWonderTalk, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Wonder_Talk_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WONDER_TALK as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnWonderTalk>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderTalk_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderTalk_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWonderTalk_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderTalk_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnWonderTalk_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnWonderTalk = thisx as *mut EnWonderTalk;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Special conversation"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x89\xb9\xe6\xae\x8a\xe4\xbc\x9a\xe8\xa9\xb1\xe3\x81\x8f\xe3\x82\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
    ...
    (*this).actionFunc =
        Some(func_80B391CC as
                 unsafe extern "C" fn(_: *mut EnWonderTalk,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_15C = 40.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B391CC(mut this: *mut EnWonderTalk,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).switchFlag as libc::c_int) < 0 as libc::c_int ||
           Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) == 0 {
        match (*this).unk_150 as libc::c_int {
            1 => {
                // "Slate GO!"
                osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x9f\xb3\xe6\x9d\xbf\xef\xbc\xa7\xef\xbc\xaf\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
                (*this).height = 0.0f32;
                (*this).unk_15C = 80.0f32;
                // "Attention coordinates"
                osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\xb3\xa8\xe7\x9b\xae\xe5\xba\xa7\xe6\xa8\x99\t       \t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             0.0f32 as libc::c_double);
                if !(gSaveContext.linkAge == 0 as libc::c_int) {
                    (*this).actor.textId = 0x7040 as libc::c_int as u16_0;
                    // "Children"
                    osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x93\xe3\x81\xa9\xe3\x82\x82 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char);
                } else {
                    // "Adult"
                    osSyncPrintf(b"\x1b[36m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8a\xe3\x81\xa8\xe3\x81\xaa \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char);
                    (*this).actor.textId = 0x7088 as libc::c_int as u16_0
                }
                (*this).unk_156 = TEXT_STATE_EVENT as libc::c_int as s16;
                osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->actor.talk_message    \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*this).actor.textId as libc::c_int);
            }
            2 => {
                // "Diary start!"
                osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x97\xa5\xe8\xa8\x98\xe5\xb8\xb3\xe3\x82\xb9\xe3\x82\xbf\xe3\x83\xbc\xe3\x83\x88\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
                (*this).actor.textId = 0x5002 as libc::c_int as u16_0;
                (*this).unk_156 = TEXT_STATE_CHOICE as libc::c_int as s16;
                (*this).height = 30.0f32;
                (*this).unk_15C = 40.0f32;
                // "Attention coordinates"
                osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\xb3\xa8\xe7\x9b\xae\xe5\xba\xa7\xe6\xa8\x99\t       \t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             30.0f32 as libc::c_double);
            }
            3 => {
                (*this).actor.textId = 0x501e as libc::c_int as u16_0;
                (*this).unk_156 = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).height = 0.0f32;
                (*this).unk_15C = 110.0f32;
                // "Attention coordinates"
                osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\xb3\xa8\xe7\x9b\xae\xe5\xba\xa7\xe6\xa8\x99\t       \t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             0.0f32 as libc::c_double);
            ...
            4 => {
                (*this).actor.textId = 0x5020 as libc::c_int as u16_0;
                (*this).unk_156 = TEXT_STATE_DONE as libc::c_int as s16;
                (*this).height = 0.0f32;
                // "Attention coordinates"
                osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\xb3\xa8\xe7\x9b\xae\xe5\xba\xa7\xe6\xa8\x99\t       \t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             0.0f32 as libc::c_double);
                (*this).unk_15C = 120.0f32;
            ...
            5 => {
                (*this).actor.textId = 0x501f as libc::c_int as u16_0;
                (*this).unk_156 = TEXT_STATE_EVENT as libc::c_int as s16;
                (*this).height = 0.0f32;
                (*this).unk_15C = 110.0f32;
                // "Attention coordinates"
        ...
        osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 this->actor.talk_message    \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     ...
                     (*this).actor.textId as libc::c_int);
        (*this).actionFunc =
            Some(func_80B3943C as
                     unsafe extern "C" fn(_: *mut EnWonderTalk,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B3943C(mut this: *mut EnWonderTalk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 = 0;
    let mut yawDiffTemp: s16 = 0;
    (*this).unk_15A += 1;
    if (*this).unk_150 as libc::c_int == 4 as libc::c_int &&
    ...
    if ((*this).switchFlag as libc::c_int) < 0 as libc::c_int ||
        ...
        if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
            if (*this).unk_156 as libc::c_int !=
                   TEXT_STATE_DONE as libc::c_int {
                (*this).actionFunc =
                    Some(func_80B395F0 as
                             unsafe extern "C" fn(_: *mut EnWonderTalk,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
            ...
            if (yawDiff as libc::c_int) < 0x4000 as libc::c_int {
                if (*this).unk_15A as libc::c_int >= 2 as libc::c_int {
                    osSyncPrintf(b"\n\n\x00" as *const u8 as
                                     *const libc::c_char);
                    // "Save information"
                    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xbb\xe3\x83\xbc\xe3\x83\x96\xe6\x83\x85\xe5\xa0\xb1\t\t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char,
                                 (*this).switchFlag as libc::c_int);
                    // "Type index"
                    osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xa8\xae\xe9\xa1\x9e\xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9\t\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char,
                                 (*this).unk_150 as libc::c_int);
                    // "Actual message type"
                ...
                func_8002F2CC(&mut (*this).actor, globalCtx, (*this).unk_15C);
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B395F0(mut this: *mut EnWonderTalk,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_156 as libc::c_int ==
        ...
        match (*this).unk_150 as libc::c_int {
            ...
            2 => {
                match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
                    0 => {
                        if !(gSaveContext.linkAge == 0 as libc::c_int) {
                            // "I'm still a child!"
                            osSyncPrintf(b"\x1b[32m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xbe\xe3\x81\xa0\xe3\x82\xb3\xe3\x83\x89\xe3\x83\xa2\xe3\x81\xaa\xe3\x81\xae\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            (*this).actor.textId =
                                0x5001 as libc::c_int as u16_0
                        } else {
                            // "I'm an adult. .. .."
                            osSyncPrintf(b"\x1b[33m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa2\xe3\x83\x80\xe3\x83\xab\xe3\x83\x88\xe3\x81\xaa\xe3\x81\xae\xe3\x80\x82\xe3\x80\x82\xe3\x80\x82 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                             as *const u8 as
                                             *const libc::c_char);
                            (*this).actor.textId =
                                0x5003 as libc::c_int as u16_0
                        }
                    }
                    1 => {
                        // "Out!"
                        osSyncPrintf(b"\x1b[35m \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xaf\xe3\x81\x9a\xe3\x82\x8c\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                                         as *const u8 as *const libc::c_char);
                        (*this).actor.textId = 0x5004 as libc::c_int as u16_0
                    }
                    _ => { }
                }
                (*this).unk_156 = TEXT_STATE_DONE as libc::c_int as s16;
            ...
            3 => {
                ...
                if (*this).unk_164 as libc::c_int == 0 as libc::c_int {
                    ...
                    (*this).unk_164 = 1 as libc::c_int as u8_0
                }
                (*this).actionFunc =
                    Some(func_80B391CC as
                             unsafe extern "C" fn(_: *mut EnWonderTalk,
...
#[no_mangle]
pub unsafe extern "C" fn EnWonderTalk_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnWonderTalk = thisx as *mut EnWonderTalk;
