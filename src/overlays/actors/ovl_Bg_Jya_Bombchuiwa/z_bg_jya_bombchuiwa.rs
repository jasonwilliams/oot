...
extern "C" {
    ...
    #[no_mangle]
    static mut gBombchuiwaLight2DL: [Gfx; 0];
    #[no_mangle]
    static mut gBombchuiwaLight1DL: [Gfx; 0];
    #[no_mangle]
    static mut gBombchuiwaDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombiwaEffectDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombchuiwa2DL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaBombchuiwa {
    pub actor: Actor,
    pub actionFunc: BgJyaBombchuiwaActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: ColliderJntSphElement,
    pub lightRayIntensity: f32_0,
    pub timer: s16,
    pub drawFlags: u8_0,
}
pub type BgJyaBombchuiwaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaBombchuiwa,
                                _: *mut GlobalContext) -> ()>;
...
#[no_mangle]
pub static mut Bg_Jya_Bombchuiwa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_BOMBCHUIWA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJyaBombchuiwa>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombchuiwa_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombchuiwa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombchuiwa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombchuiwa_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_SetupCollider(mut this:
                                                           *mut BgJyaBombchuiwa,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit, &mut (*this).colliderItems);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_SetDrawFlags(mut this:
                                                          *mut BgJyaBombchuiwa,
                                                      mut drawFlags: u8_0) {
    (*this).drawFlags =
        ((*this).drawFlags as libc::c_int & !(7 as libc::c_int)) as u8_0;
    (*this).drawFlags =
        ((*this).drawFlags as libc::c_int | drawFlags as libc::c_int) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaBombchuiwa = thisx as *mut BgJyaBombchuiwa;
    ...
    } else { BgJyaBombchuiwa_SetupWaitForExplosion(this, globalCtx); }
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx2:
                                                     *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_Break(mut this: *mut BgJyaBombchuiwa,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ...
    while i < 20 as libc::c_int {
        pos.x =
            Rand_ZeroOne() * 10.0f32 + (*this).actor.world.pos.x - 10.0f32;
        pos.y =
            Rand_ZeroOne() * 40.0f32 + (*this).actor.world.pos.y - 20.0f32;
        pos.z =
            Rand_ZeroOne() * 50.0f32 + (*this).actor.world.pos.z - 25.0f32;
        velocity.x = Rand_ZeroOne() * 3.0f32 - 0.3f32;
        velocity.y = Rand_ZeroOne() * 18.0f32;
        velocity.z = (Rand_ZeroOne() - 0.5f32) * 15.0f32;
        scale = ((Rand_ZeroOne() * 20.0f32) as s32 + 1 as libc::c_int) as s16;
        if scale as libc::c_int > 10 as libc::c_int {
            arg5 = 5 as libc::c_int as s16
        } else { arg5 = 1 as libc::c_int as s16 }
        if Rand_ZeroOne() < 0.4f32 {
            arg5 = (arg5 as libc::c_int | 0x40 as libc::c_int) as s16;
            arg6 = 0xc as libc::c_int as s16;
            arg7 = 8 as libc::c_int as s16
        } else {
            arg5 = (arg5 as libc::c_int | 0x20 as libc::c_int) as s16;
            arg6 = 0xc as libc::c_int as s16;
            arg7 = 8 as libc::c_int as s16;
            if (scale as libc::c_int) < 8 as libc::c_int {
                arg6 = 0x46 as libc::c_int as s16;
                arg7 = 0x28 as libc::c_int as s16
            }
        }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             -(300 as libc::c_int) as s16, arg5, arg6, arg7,
                             0 as libc::c_int as s16, scale,
                             1 as libc::c_int as s16,
                             15 as libc::c_int as s16, 80 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_JYA_OBJ as libc::c_int as s16,
                             gBombiwaEffectDL.as_mut_ptr());
        i += 1
    }
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 100.0f32,
                  8 as libc::c_int, 100 as libc::c_int as s16,
                  160 as libc::c_int as s16, 0 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_SetupWaitForExplosion(mut this:
                                                                   *mut BgJyaBombchuiwa,
                                                               mut globalCtx:
                                                                   *mut GlobalContext) {
    (*this).actionFunc =
        Some(BgJyaBombchuiwa_WaitForExplosion as
                 unsafe extern "C" fn(_: *mut BgJyaBombchuiwa,
                                      _: *mut GlobalContext) -> ());
    BgJyaBombchuiwa_SetDrawFlags(this, 3 as libc::c_int as u8_0);
    (*this).timer = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_WaitForExplosion(mut this:
                                                              *mut BgJyaBombchuiwa,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 3410 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_CleanUpAfterExplosion(mut this:
                                                                   *mut BgJyaBombchuiwa,
                                                               mut globalCtx:
                                                                   *mut GlobalContext) {
    (*this).actionFunc =
        Some(func_808949B8 as
                 unsafe extern "C" fn(_: *mut BgJyaBombchuiwa,
                                      _: *mut GlobalContext) -> ());
    BgJyaBombchuiwa_SetDrawFlags(this, 4 as libc::c_int as u8_0);
    (*this).lightRayIntensity = 0.3f32;
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn func_808949B8(mut this: *mut BgJyaBombchuiwa,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).timer += 1;
    if (*this).timer as libc::c_int & 4 as libc::c_int != 0 {
        func_80033480(globalCtx, &mut (*this).actor.world.pos, 60.0f32,
                      3 as libc::c_int, 100 as libc::c_int as s16,
                      100 as libc::c_int as s16, 0 as libc::c_int as u8_0);
    }
    if Math_StepToF(&mut (*this).lightRayIntensity, 1.0f32, 0.028f64 as f32_0)
           != 0 {
        BgJyaBombchuiwa_SpawnLightRay(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_SpawnLightRay(mut this:
                                                           *mut BgJyaBombchuiwa,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    (*this).actionFunc = None;
    (*this).lightRayIntensity = 153.0f32;
    BgJyaBombchuiwa_SetDrawFlags(this, 4 as libc::c_int as u8_0);
    if Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
        ...
        // "Occurrence failure"
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : Mir_Ray \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_jya_bombchuiwa.c\x00" as *const u8 as
                         *const libc::c_char, 410 as libc::c_int,
                     (*this).actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgJyaBombchuiwa = thisx as *mut BgJyaBombchuiwa;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_DrawRock(mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_bombchuiwa.c\x00" as *const u8 as
                        *const libc::c_char, 436 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBombchuiwa2DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_bombchuiwa.c\x00" as *const u8 as
                         *const libc::c_char, 443 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_DrawLight(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut this: *mut BgJyaBombchuiwa = thisx as *mut BgJyaBombchuiwa;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    (*_g_0).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((if ((*this).lightRayIntensity * 153.0f32) as u32_0 >
                     153 as libc::c_int as libc::c_uint {
                  153 as libc::c_int as libc::c_uint
              } else { ((*this).lightRayIntensity * 153.0f32) as u32_0 }) &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gBombchuiwaLight1DL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_3).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((if ((*this).lightRayIntensity * 255.0f32) as u32_0 >
                     255 as libc::c_int as libc::c_uint {
                  255 as libc::c_int as libc::c_uint
              } else { ((*this).lightRayIntensity * 255.0f32) as u32_0 }) &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = gBombchuiwaLight2DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_bombchuiwa.c\x00" as *const u8 as
                         *const libc::c_char, 472 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombchuiwa_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut D_80894F88: Vec3f =
        {
            let mut init = Vec3f{x: -920.0f32, y: 480.0f32, z: -889.0f32,};
            init
        };
    static mut D_80894F94: Vec3s =
        {
            let mut init =
    ...
    let mut this: *mut BgJyaBombchuiwa = thisx as *mut BgJyaBombchuiwa;
    if (*this).drawFlags as libc::c_int & 1 as libc::c_int != 0 {
        Gfx_DrawDListOpa(globalCtx, gBombchuiwaDL.as_mut_ptr());
        Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).collider);
    }
    if (*this).drawFlags as libc::c_int & 2 as libc::c_int != 0 {
        BgJyaBombchuiwa_DrawRock(globalCtx);
    }
    if (*this).drawFlags as libc::c_int & 4 as libc::c_int != 0 {
        func_800D1694(D_80894F88.x, D_80894F88.y, D_80894F88.z,
                      &mut D_80894F94);
