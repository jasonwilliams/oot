...
#[no_mangle]
pub static mut En_It_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_IT as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnIt>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnIt_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIt = thisx as *mut EnIt;
    (*this).actor.params = 0xd05 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnIt_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIt = thisx as *mut EnIt;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnIt_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIt = thisx as *mut EnIt;
    let mut pad: s32 = 0;
