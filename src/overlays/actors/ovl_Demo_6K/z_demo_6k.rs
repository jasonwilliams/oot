...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsKiraKira_SpawnFocused(globalCtx: *mut GlobalContext,
    ...
    #[no_mangle]
    static mut gEffFlash2DL: [Gfx; 0];
    #[no_mangle]
    static mut gGlowCircleSmallDL: [Gfx; 0];
    #[no_mangle]
    static mut object_demo_6k_DL_001040: [Gfx; 0];
    #[no_mangle]
    static mut object_demo_6k_DL_0022B0: [Gfx; 0];
    #[no_mangle]
    static mut object_demo_6kVtx_0035E0: [Vtx; 0];
    #[no_mangle]
    static mut object_demo_6k_DL_0039D0: [Gfx; 0];
    #[no_mangle]
    static mut object_gnd_magic_DL_001190: [Gfx; 0];
}
...
pub struct Demo6K {
    pub actor: Actor,
    pub initActionFunc: Demo6KActionFunc,
    ...
    pub unk_16C: f32_0,
    pub unk_170: f32_0,
    pub unk_174: [f32_0; 16],
    pub unk_1B4: [f32_0; 16],
    pub unk_1F4: [f32_0; 16],
    pub unk_234: [f32_0; 16],
    pub unk_274: [u8_0; 16],
    pub drawFunc: ActorFunc,
    pub actionFunc: Demo6KActionFunc,
    pub flags: u16_0,
    pub timer1: u16_0,
    pub timer2: u16_0,
...
pub type Demo6KActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut Demo6K, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_20 = libc::c_uint;
pub const EFF_DUST_TYPE_4: C2RustUnnamed_20 = 4;
pub const EFF_DUST_TYPE_3: C2RustUnnamed_20 = 3;
pub const EFF_DUST_TYPE_2: C2RustUnnamed_20 = 2;
pub const EFF_DUST_TYPE_1: C2RustUnnamed_20 = 1;
pub const EFF_DUST_TYPE_0: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut Demo_6K_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_6K as libc::c_int as s16,
...
static mut sObjectIds: [s16; 20] =
    [OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_DEMO_6K as libc::c_int as s16,
     OBJECT_DEMO_6K as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     ...
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GND_MAGIC as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     ...
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
     OBJECT_GAMEPLAY_KEEP as libc::c_int as s16];
static mut sEnvColors: [Color_RGB8; 6] =
    [{
         let mut init =
...
static mut D_8096930C: [f32_0; 4] = [1.0f32, 1.04f32, 1.0f32, 0.96f32];
static mut D_8096931C: [f32_0; 4] = [1.1f32, 1.0f32, 0.9f32, 0.8f32];
#[no_mangle]
pub unsafe extern "C" fn Demo6K_SetupAction(mut this: *mut Demo6K,
                                            mut actionFunc:
                                                Demo6KActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn Demo6K_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    let mut pad: s32 = 0;
    ...
    osSyncPrintf(b"no = %d\n\x00" as *const u8 as *const libc::c_char,
                 params);
    if sObjectIds[params as usize] as libc::c_int !=
           OBJECT_GAMEPLAY_KEEP as libc::c_int {
        objBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            sObjectIds[params as usize])
    } else { objBankIndex = 0 as libc::c_int }
    ...
    if objBankIndex < 0 as libc::c_int {
        if 0 as libc::c_int != 0 {
            ...
            __assert(b"0\x00" as *const u8 as *const libc::c_char,
                     b"../z_demo_6k.c\x00" as *const u8 as
                         *const libc::c_char, 334 as libc::c_int);
        };
    } else { (*this).objBankIndex = objBankIndex as u8_0 }
    Demo6K_SetupAction(this,
                       Some(func_80966DB0 as
                                unsafe extern "C" fn(_: *mut Demo6K,
                                                     _: *mut GlobalContext)
                                    -> ()));
    (*this).timer1 = 0 as libc::c_int as u16_0;
    (*this).flags = 0 as libc::c_int as u16_0;
    (*this).timer2 = 0 as libc::c_int as u16_0;
    match params {
        0 => {
            (*this).drawFunc =
                Some(func_809688C4 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).initActionFunc =
                Some(func_80967AD0 as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
            ...
            while i < 16 as libc::c_int {
                ...
                (*this).unk_1B4[i as usize] = 0.0f32;
                i += 1
            }
            (*this).unk_170 = 0.0f32
        }
        1 => {
            (*this).drawFunc =
                Some(func_80967FFC as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).initActionFunc =
                Some(func_80966E04 as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
            Actor_SetScale(&mut (*this).actor, 0.228f32);
        }
        2 => {
            (*this).drawFunc =
                Some(func_80968298 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).initActionFunc =
                Some(func_80966F84 as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
        ...
        3 | 4 | 5 | 6 | 7 | 8 => {
            (*this).drawFunc =
                Some(func_8096865C as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).initActionFunc =
                Some(func_8096712C as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
            Actor_SetScale(&mut (*this).actor, 0.0f32);
            (*this).unk_293 = (params - 3 as libc::c_int) as u8_0
        }
        9 | 10 => {
            (*this).drawFunc =
                Some(func_8096865C as
        ...
        11 => {
            ...
            Actor_SetScale(&mut (*this).actor, 0.0f32);
            (*this).initActionFunc =
                Some(func_8096784C as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
            (*this).actor.velocity.z = 0.0f32;
            (*this).actor.velocity.y = (*this).actor.velocity.z;
            (*this).actor.velocity.x = (*this).actor.velocity.y;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28a5 as libc::c_int as u16_0);
        }
        12 => {
            Actor_SetScale(&mut (*this).actor, 0.0f32);
            (*this).initActionFunc =
                Some(func_80967F10 as
                         unsafe extern "C" fn(_: *mut Demo6K,
                                              _: *mut GlobalContext) -> ());
            (*this).drawFunc =
                Some(func_80968B70 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
        ...
        13 => {
            ...
            Demo6K_SetupAction(this,
                               Some(func_80967DBC as
                                        unsafe extern "C" fn(_: *mut Demo6K,
                                                             _:
                                                                 *mut GlobalContext)
                                            -> ()));
            (*this).actor.draw =
                Some(func_80968FB0 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).unk_293 = 0 as libc::c_int as u8_0
        }
        14 | 15 | 16 | 17 | 18 | 19 => {
            (*this).actor.flags |=
    ...
    match params {
        9 => { (*this).unk_293 = 0 as libc::c_int as u8_0 }
        10 => { (*this).unk_293 = 5 as libc::c_int as u8_0 }
        11 => { (*this).unk_293 = 4 as libc::c_int as u8_0 }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn Demo6K_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
...
#[no_mangle]
pub unsafe extern "C" fn func_80966DB0(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80966E04(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).csCtx.frames as libc::c_int > 214 as libc::c_int {
        func_8002F948(&mut (*this).actor,
                      (0x2847 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    if (*globalCtx).csCtx.frames as libc::c_int > 264 as libc::c_int {
        func_8002F948(&mut (*this).actor,
                      (0x289a as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80966E98(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*globalCtx).csCtx.frames as libc::c_int) < 353 as libc::c_int {
        func_8002F948(&mut (*this).actor,
                      (0x2847 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
        func_8002F948(&mut (*this).actor,
    ...
    if (*globalCtx).csCtx.frames as libc::c_int == 342 as libc::c_int {
        func_800F3F3C(2 as libc::c_int as u8_0);
    }
    if (*this).timer1 as libc::c_int == 39 as libc::c_int {
        func_800788CC(0x289c as libc::c_int as u16_0);
    ...
    if (*this).timer1 as libc::c_int == 64 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    }
    (*this).timer1 = (*this).timer1.wrapping_add(1);
}
#[no_mangle]
pub unsafe extern "C" fn func_80966F84(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).timer1 as libc::c_int) < 5 as libc::c_int {
        (*this).unk_168 =
            D_8096930C[((*this).timer1 as libc::c_int & 3 as libc::c_int) as
                           usize]
    } else if ((*this).timer1 as libc::c_int) < 15 as libc::c_int {
        (*this).actor.scale.x += 0.012f32;
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
        Math_StepToF(&mut (*this).unk_170, 0.6f32, 0.05f32);
        (*this).unk_168 = 1.0f32
    } else {
        if (*this).timer1 as libc::c_int == 15 as libc::c_int {
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx,
                               ACTOR_EFF_DUST as libc::c_int as s16,
                               (*this).actor.world.pos.x,
                               ...
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               EFF_DUST_TYPE_1 as libc::c_int as s16);
        }
        Math_StepToF(&mut (*this).unk_16C, 1.0f32, 0.02f32);
        (*this).unk_168 =
            D_8096930C[((*this).timer1 as libc::c_int & 1 as libc::c_int) as
                           usize]
    }
    (*this).timer1 = (*this).timer1.wrapping_add(1);
}
#[no_mangle]
pub unsafe extern "C" fn func_809670AC(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if ((*this).timer1 as libc::c_int) < 10 as libc::c_int {
        (*this).timer1 = (*this).timer1.wrapping_add(1)
    } else if (*this).actor.scale.x > 0.0f32 {
        (*this).actor.scale.x -= 1.0f32 / 120.0f32;
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    } else { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_8096712C(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_8096932C: [u16_0; 6] =
        [275 as libc::c_int as u16_0, 275 as libc::c_int as u16_0,
         275 as libc::c_int as u16_0, 275 as libc::c_int as u16_0,
         275 as libc::c_int as u16_0, 275 as libc::c_int as u16_0];
    let mut frames: u32_0 = (*globalCtx).state.frames;
    if (*this).actor.scale.x < 0.1f32 {
        (*this).actor.scale.x += 0.0017f32
    } else if frames & 1 as libc::c_int as libc::c_uint != 0 {
        (*this).actor.scale.x = 0.1f32 * 1.04f32
    } else { (*this).actor.scale.x = 0.1f32 }
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[6 as libc::c_int as usize].is_null()
           &&
           (*(*globalCtx).csCtx.npcActions[6 as libc::c_int as usize]).action
               as libc::c_int == 2 as libc::c_int {
        Demo6K_SetupAction(this,
                           Some(func_809670AC as
                                    unsafe extern "C" fn(_: *mut Demo6K,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
        (*this).timer1 = 0 as libc::c_int as u16_0;
        (*this).actor.scale.x = 0.1f32
    }
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if (*globalCtx).sceneNum as libc::c_int == SCENE_GANONTIKA as libc::c_int
           &&
           ((*globalCtx).csCtx.frames as libc::c_int) <
               D_8096932C[((*this).actor.params as libc::c_int -
...
#[no_mangle]
pub unsafe extern "C" fn func_80967244(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    rand1 = Rand_ZeroFloat(0xffff as libc::c_int as f32_0) as s16;
    rand2 = Rand_ZeroFloat(0xffff as libc::c_int as f32_0) as s16;
    velocity.x = Math_SinS(rand2) * Math_CosS(rand1) * 20.0f32;
    velocity.z = Math_CosS(rand2) * Math_CosS(rand1) * 20.0f32;
    velocity.y = Math_SinS(rand1) * 20.0f32;
    accel.y = 0.0f32;
    envColor.r = sEnvColors[(*this).unk_293 as usize].r;
    envColor.g = sEnvColors[(*this).unk_293 as usize].g;
    envColor.b = sEnvColors[(*this).unk_293 as usize].b;
    if (*globalCtx).sceneNum as libc::c_int == SCENE_TOKINOMA as libc::c_int {
        scale = 6000 as libc::c_int
    } else if ((*globalCtx).csCtx.frames as libc::c_int) < 419 as libc::c_int
     {
        scale = 6000 as libc::c_int
    } else { scale = 18000 as libc::c_int }
    EffectSsKiraKira_SpawnFocused(globalCtx, &mut pos, &mut velocity,
                                  &mut accel, &mut primColor, &mut envColor,
                                  scale as s16, 20 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80967410(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    let mut params: s32 =
        (*this).actor.params as libc::c_int - 14 as libc::c_int;
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    Actor_SetScale(&mut (*this).actor, 0.2f32);
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           && !(*globalCtx).csCtx.npcActions[params as usize].is_null() {
        func_809691BC(this, globalCtx, params);
        if (*(*globalCtx).csCtx.npcActions[params as usize]).action as
...
#[no_mangle]
pub unsafe extern "C" fn func_809674E0(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u32_0 = (*globalCtx).state.frames;
    if (*this).actor.scale.x < 0.05f32 {
        (*this).actor.scale.x += 0.005f32
    } else if frames & 1 as libc::c_int as libc::c_uint != 0 {
        (*this).actor.scale.x = 0.05f32 * 1.04f32
    } else { (*this).actor.scale.x = 0.05f32 }
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if (*this).timer2 as libc::c_int > 47 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    } else if (*this).timer2 as libc::c_int > 39 as libc::c_int {
        let mut dTimer: f32_0 =
            ((*this).timer2 as libc::c_int - 39 as libc::c_int) as f32_0;
        let mut temp: f32_0 = 1.0f32 / (9.0f32 - dTimer);
        (*this).actor.world.pos.x +=
            (-1611.0f32 - (*this).actor.world.pos.x) * temp;
        (*this).actor.world.pos.y +=
            (19.0f32 - (*this).actor.world.pos.y) * temp;
        (*this).actor.world.pos.z +=
            (1613.0f32 - (*this).actor.world.pos.z) * temp;
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x38a7 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    }
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).actor.world.pos.x as s16,
                              (*this).actor.world.pos.y as s16,
                              (*this).actor.world.pos.z as s16,
                              sEnvColors[(*this).unk_293 as usize].r,
                              sEnvColors[(*this).unk_293 as usize].g,
                              sEnvColors[(*this).unk_293 as usize].b,
                              ((*this).actor.scale.x * 4000.0f32) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_809676A4(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    static mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut accel: Vec3f =
    ...
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp: f32_0 = (*this).actor.scale.x * 500.0f32;
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 8 as libc::c_int {
        ...
        velocity.x = Rand_CenteredFloat(2.0f32);
        velocity.y = (Rand_ZeroFloat(-10.0f32) - 5.0f32) * 0.1f32;
        velocity.z = Rand_CenteredFloat(2.0f32);
        accel.y = 0.0f32;
        EffectSsKiraKira_SpawnFocused(globalCtx, &mut pos, &mut velocity,
...
#[no_mangle]
pub unsafe extern "C" fn func_8096784C(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u32_0 = (*globalCtx).state.frames;
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if (*this).timer2 as libc::c_int > 24 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    } else if (*this).timer2 as libc::c_int > 4 as libc::c_int {
        (*this).actor.velocity.x += Rand_CenteredFloat(0.2f32);
        (*this).actor.velocity.y += 0.12f32;
        (*this).actor.velocity.z += Rand_CenteredFloat(0.2f32);
        ...
        (*this).actor.scale.x = 0.033f32
    } else { (*this).actor.scale.x = 0.03f32 }
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).actor.world.pos.x as s16,
                              (*this).actor.world.pos.y as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80967A04(mut this: *mut Demo6K, mut i: s32) {
    (*this).unk_174[i as usize] = i as libc::c_float * 10.0f32 - 80.0f32;
    (*this).unk_1B4[i as usize] = Rand_ZeroFloat(100.0f32) + 100.0f32;
    (*this).unk_1F4[i as usize] = -3.0f32 - Rand_ZeroFloat(6.0f32);
    (*this).unk_274[i as usize] = Rand_ZeroFloat(6.0f32) as s32 as u8_0;
    (*this).unk_234[i as usize] = Rand_ZeroFloat(0.02f32) + 0.01f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80967AD0(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
           &&
           !(*globalCtx).csCtx.npcActions[1 as libc::c_int as usize].is_null()
       {
        if (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as usize]).action
               as libc::c_int == 2 as libc::c_int {
            (*this).unk_170 += 1.;
            func_8002F948(&mut (*this).actor,
                          (0x28bc as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
        func_809691BC(this, globalCtx, 1 as libc::c_int);
    }
    i = 0 as libc::c_int;
    while i < (*this).unk_170 as s32 && i < 16 as libc::c_int {
        (*this).unk_1B4[i as usize] += (*this).unk_1F4[i as usize];
        if (*this).unk_1B4[i as usize] < 0.0f32 { func_80967A04(this, i); }
        i += 1
    }
    (*this).timer1 = (*this).timer1.wrapping_add(1);
}
#[no_mangle]
pub unsafe extern "C" fn func_80967BF8(mut player: *mut Player,
                                       mut globalCtx: *mut GlobalContext) {
    static mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut accel: Vec3f =
    ...
    while i < 150 as libc::c_int {
        pos.x = Rand_CenteredFloat(15.0f32) + (*player).actor.world.pos.x;
        pos.y =
            Rand_CenteredFloat(15.0f32) + (*player).actor.world.pos.y +
                30.0f32;
        pos.z = Rand_CenteredFloat(15.0f32) + (*player).actor.world.pos.z;
        velocity.x = Rand_CenteredFloat(8.0f32) + 1.0f32;
        velocity.y = Rand_CenteredFloat(4.0f32);
        velocity.z = Rand_CenteredFloat(8.0f32) + 2.0f32;
        accel.y = 0.0f32;
        EffectSsKiraKira_SpawnFocused(globalCtx, &mut pos, &mut velocity,
                                      &mut accel, &mut primColor,
                                      &mut envColor,
                                      1000 as libc::c_int as s16,
                                      Rand_ZeroFloat(60.0f32) as s32 +
                                          60 as libc::c_int);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80967DBC(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x38b4 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if (*this).timer2 as libc::c_int > 44 as libc::c_int {
        if ((*this).unk_293 as libc::c_int) < 236 as libc::c_int {
            (*this).unk_293 =
                ((*this).unk_293 as libc::c_int + 20 as libc::c_int) as u8_0
        } else { (*this).unk_293 = 255 as libc::c_int as u8_0 }
        if (*this).timer2 as libc::c_int > 104 as libc::c_int {
            func_80967BF8((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                               libc::c_int as
                                                               usize].head as
                              *mut Player, globalCtx);
            Actor_Kill(&mut (*this).actor);
            Audio_PlayActorSound2(&mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                                     as
                                                                                                     libc::c_int
                                                                                                     as
                                                                                                     isize)).head
        ...
        } else if (*this).timer2 as libc::c_int > 94 as libc::c_int {
            Actor_SetScale(&mut (*this).actor,
                           (*this).actor.scale.x + 0.03f32);
            if (*this).timer2 as libc::c_int == 95 as libc::c_int {
                osSyncPrintf(b"\x1b[36m  NA_SE_EN_GANON_FIRE_DEMO\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char);
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38b5 as libc::c_int as u16_0);
            }
        }
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                                  (*this).actor.world.pos.x as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80967F10(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).timer2 = (*this).timer2.wrapping_add(1);
    if (*this).timer2 as libc::c_int > 60 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    }
    Actor_SetScale(&mut (*this).actor,
                   0.05f32 -
                       (*this).timer2 as libc::c_int as libc::c_float *
                           0.00075f32);
}
#[no_mangle]
pub unsafe extern "C" fn Demo6K_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80967FFC(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    let mut pad: s32 = 0;
    let mut timer1: u16_0 = (*this).timer1;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_6k.c\x00" as *const u8 as *const libc::c_char,
                    1070 as libc::c_int);
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         (0x7fff as libc::c_int -
                              (timer1 as libc::c_int * 8 as libc::c_int &
        ...
        (*_g_2).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (0x80 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            (colors[i as usize][0 as libc::c_int as usize].r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (colors[i as usize][0 as libc::c_int as usize].g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (colors[i as usize][0 as libc::c_int as usize].b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
        ...
        (*_g_3).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_3).words.w1 =
            (colors[i as usize][1 as libc::c_int as usize].r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (colors[i as usize][1 as libc::c_int as usize].g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (colors[i as usize][1 as libc::c_int as usize].b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                (255 as libc::c_int as u32_0 &
        ...
        (*_g_4).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_4).words.w1 =
            object_demo_6k_DL_0022B0.as_mut_ptr() as libc::c_uint;
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80968298(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    static mut skipIndices: [u8_0; 16] =
        [6 as libc::c_int as u8_0, 7 as libc::c_int as u8_0,
         11 as libc::c_int as u8_0, 16 as libc::c_int as u8_0,
         20 as libc::c_int as u8_0, 24 as libc::c_int as u8_0,
         28 as libc::c_int as u8_0, 33 as libc::c_int as u8_0,
         35 as libc::c_int as u8_0, 41 as libc::c_int as u8_0,
         45 as libc::c_int as u8_0, 50 as libc::c_int as u8_0,
         57 as libc::c_int as u8_0, 58 as libc::c_int as u8_0,
         62 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    let mut pad: s32 = 0;
    let mut timer1: u32_0 = (*this).timer1 as u32_0;
    let mut scale: f32_0 = (*this).unk_164 * (*this).unk_168;
    let mut vertices: *mut Vtx =
        gSegments[((object_demo_6kVtx_0035E0.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(object_demo_6kVtx_0035E0.as_mut_ptr()
                                              as u32_0 &
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_demo_6k.c\x00" as *const u8 as *const libc::c_char,
                    1145 as libc::c_int);
    alpha = ((*this).unk_170 * 255.0f32) as s32 as u8_0;
        ...
        (0 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 10 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 2 as libc::c_int;
    func_80093D84((*globalCtx).state.gfxCtx);
    alpha = ((*this).unk_16C * 255.0f32) as s32 as u8_0;
    i2 = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 63 as libc::c_int {
        if i == skipIndices[i2 as usize] as libc::c_int {
            i2 += 1
        } else {
    ...
    (*_g_6).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (0xfff as libc::c_int as
                              libc::c_uint).wrapping_sub(timer1.wrapping_mul(6
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint))
                             & 0xfff as libc::c_int as libc::c_uint,
                         timer1.wrapping_mul(12 as libc::c_int as
                                                 libc::c_uint) &
                             0xfff as libc::c_int as libc::c_uint,
    ...
    (*_g_11).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_11).words.w1 = object_demo_6k_DL_001040.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_6k.c\x00" as *const u8 as
                         *const libc::c_char, 1198 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096865C(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    let mut pad: s32 = 0;
    ...
    if (*this).flags as libc::c_int & 1 as libc::c_int == 0 {
        if (*this).actor.params as libc::c_int > 8 as libc::c_int {
            displayList = gEffFlash1DL.as_mut_ptr()
        } else { displayList = gEffFlash2DL.as_mut_ptr() }
        func_80093D84((*globalCtx).state.gfxCtx);
        ...
        (*_g_0).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_0).words.w1 =
            (sEnvColors[(*this).unk_293 as usize].r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (sEnvColors[(*this).unk_293 as usize].g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (sEnvColors[(*this).unk_293 as usize].b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                (255 as libc::c_int as u32_0 &
        ...
        Matrix_Mult(&mut (*globalCtx).billboardMtxF,
                    MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Push();
        Matrix_RotateZ(((*this).timer2 as libc::c_int * 6 as libc::c_int) as
                           f32_0 * (3.14159265358979323846f32 / 180.0f32),
                       MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = displayList as libc::c_uint;
        Matrix_Pop();
        Matrix_RotateZ(-(((*this).timer2 as libc::c_int * 6 as libc::c_int) as
                             f32_0) * (3.14159265358979323846f32 / 180.0f32),
                       MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = displayList as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_6k.c\x00" as *const u8 as
                         *const libc::c_char, 1242 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809688C4(mut thisx: *mut Actor,
    ...
    i =
        ((*globalCtx).csCtx.state as libc::c_int !=
            ...
            libc::c_int;
    if i != 0 &&
           (*(*globalCtx).csCtx.npcActions[1 as libc::c_int as usize]).action
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_demo_6k.c\x00" as *const u8 as
                            *const libc::c_char, 1277 as libc::c_int);
        func_80093D84((*globalCtx).state.gfxCtx);
        ...
        while i < 16 as libc::c_int {
            ...
            (*_g_1).words.w0 =
                (0xfb as libc::c_int as u32_0 &
                    ...
                    24 as libc::c_int;
            (*_g_1).words.w1 =
                (sEnvColors[(*this).unk_274[i as usize] as usize].r as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (sEnvColors[(*this).unk_274[i as usize] as usize].g as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        16 as libc::c_int |
                    (sEnvColors[(*this).unk_274[i as usize] as usize].b as
                         u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (255 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            Matrix_Push();
            Matrix_Translate((*this).unk_174[i as usize],
                             (*this).unk_1B4[i as usize], 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale((*this).unk_234[i as usize] *
                             D_8096931C[(frames.wrapping_add(i as
                                                                 libc::c_uint)
                                             &
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gEffFlash1DL.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_demo_6k.c\x00" as *const u8 as
                             *const libc::c_char, 1305 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80968B70(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut Demo6K = thisx as *mut Demo6K;
    let mut timer2: u32_0 = (*this).timer2 as u32_0;
    let mut primColor: [u8_0; 4] = [0; 4];
    let mut envColor: [u8_0; 3] = [0; 3];
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (0xff as libc::c_int as
                              libc::c_uint).wrapping_sub(timer2.wrapping_mul(2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint)
                         ...
                         (0xff as libc::c_int as
                              libc::c_uint).wrapping_sub(timer2.wrapping_mul(2
                                                             ...
                                                             0xff as
                                                                 ...
                                                                 as
                                                                 libc::c_uint),
                         timer2.wrapping_mul(15 as libc::c_int as
                                                 libc::c_uint) &
                             0x3ff as libc::c_int as libc::c_uint,
                         16 as libc::c_int, 64 as libc::c_int) as
            libc::c_uint;
    if ((*this).timer2 as libc::c_int) < 40 as libc::c_int {
        primColor[2 as libc::c_int as usize] =
            (100 as libc::c_int as libc::c_float -
                 (*this).timer2 as libc::c_int as libc::c_float * 2.5f32) as
                u8_0;
        primColor[0 as libc::c_int as usize] =
            primColor[2 as libc::c_int as usize];
        envColor[1 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        primColor[1 as libc::c_int as usize] =
            envColor[1 as libc::c_int as usize];
        envColor[0 as libc::c_int as usize] =
            (100 as libc::c_int -
                 primColor[2 as libc::c_int as usize] as libc::c_int) as u8_0;
        primColor[3 as libc::c_int as usize] =
            ((*this).timer2 as libc::c_int as libc::c_float * 6.375f32) as
                u8_0;
        envColor[2 as libc::c_int as usize] =
            (envColor[0 as libc::c_int as usize] as libc::c_int *
                 2 as libc::c_int) as u8_0
    } else if ((*this).timer2 as libc::c_int) < 50 as libc::c_int {
        primColor[0 as libc::c_int as usize] =
            ((*this).timer2 as libc::c_int * 5 as libc::c_int -
                 200 as libc::c_int) as u8_0;
        primColor[2 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        primColor[1 as libc::c_int as usize] =
            primColor[2 as libc::c_int as usize];
        primColor[3 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
        envColor[0 as libc::c_int as usize] =
            (100 as libc::c_int -
                 primColor[0 as libc::c_int as usize] as libc::c_int) as u8_0;
        envColor[1 as libc::c_int as usize] =
            (primColor[0 as libc::c_int as usize] as libc::c_int *
                 2 as libc::c_int) as u8_0;
        envColor[2 as libc::c_int as usize] =
            (200 as libc::c_int -
                 primColor[0 as libc::c_int as usize] as libc::c_int *
        ...
        primColor[2 as libc::c_int as usize] =
            ((*this).timer2 as libc::c_int * 5 as libc::c_int -
                 250 as libc::c_int) as u8_0;
        envColor[2 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        primColor[1 as libc::c_int as usize] =
            (primColor[2 as libc::c_int as usize] as libc::c_int *
                 3 as libc::c_int) as u8_0;
        primColor[3 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
        envColor[0 as libc::c_int as usize] =
            (primColor[2 as libc::c_int as usize] as libc::c_int *
                 2 as libc::c_int + 50 as libc::c_int) as u8_0;
        primColor[0 as libc::c_int as usize] =
            envColor[0 as libc::c_int as usize];
        envColor[1 as libc::c_int as usize] =
            (100 as libc::c_int -
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (0x80 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        (primColor[0 as libc::c_int as usize] as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (primColor[1 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (primColor[2 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (primColor[3 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh34 = (*__gfxCtx).polyXlu.p;
    (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
    let mut _g_2: *mut Gfx = fresh34;
    (*_g_2).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_2).words.w1 =
        (envColor[0 as libc::c_int as usize] as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (envColor[1 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (envColor[2 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        object_gnd_magic_DL_001190.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_6k.c\x00" as *const u8 as
                         *const libc::c_char, 1368 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80968FB0(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_809693CC: [u8_0; 16] =
        [0 as libc::c_int as u8_0, 1 as libc::c_int as u8_0,
         ...
         6 as libc::c_int as u8_0, 7 as libc::c_int as u8_0,
         8 as libc::c_int as u8_0, 7 as libc::c_int as u8_0,
         6 as libc::c_int as u8_0, 5 as libc::c_int as u8_0,
         4 as libc::c_int as u8_0, 3 as libc::c_int as u8_0,
        ...
        Graph_Alloc((*globalCtx).state.gfxCtx,
                    (4 as libc::c_int as
                         libc::c_uint).wrapping_mul(::std::mem::size_of::<Gfx>()
                                                        as libc::c_ulong) as
                        size_t) as *mut Gfx;
    let mut frames: u16_0 = (*globalCtx).gameplayFrames as u16_0;
    ...
    func_80093D84((*globalCtx).state.gfxCtx);
    scaleFactor =
        D_809693CC[(frames as libc::c_int * 4 as libc::c_int &
                        0xf as libc::c_int) as usize] as s16 as libc::c_int as
    ...
    (*_g_2).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*this).unk_293 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh40 = displayList;
    displayList = displayList.offset(1);
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = gGlowCircleSmallDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_6k.c\x00" as *const u8 as
                         *const libc::c_char, 1411 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809691BC(mut this: *mut Demo6K,
                                       mut globalCtx: *mut GlobalContext,
                                       mut params: s32) {
