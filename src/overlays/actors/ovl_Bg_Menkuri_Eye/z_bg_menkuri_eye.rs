...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gGTGEyeStatueEyeDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMenkuriEye {
    pub actor: Actor,
    pub framesUntilDisable: s16,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
}
#[no_mangle]
pub static mut Bg_Menkuri_Eye_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MENKURI_EYE as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_MENKURI_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgMenkuriEye>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriEye_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriEye_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriEye_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriEye_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriEye_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgMenkuriEye = thisx as *mut BgMenkuriEye;
    let mut colliderList: *mut ColliderJntSphElement =
    ...
    (*colliderList).dim.worldSphere.radius =
        (*colliderList).dim.modelSphere.radius;
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) == 0 {
        D_8089C1A0 = 0 as libc::c_int
    }
    (*this).framesUntilDisable = -(1 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriEye_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgMenkuriEye = thisx as *mut BgMenkuriEye;
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriEye_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgMenkuriEye = thisx as *mut BgMenkuriEye;
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) == 0 {
        if (*this).framesUntilDisable as libc::c_int != -(1 as libc::c_int) {
            if (*this).framesUntilDisable as libc::c_int != 0 as libc::c_int {
                (*this).framesUntilDisable =
                    ((*this).framesUntilDisable as libc::c_int -
                         1 as libc::c_int) as s16
            }
            if (*this).framesUntilDisable as libc::c_int == 0 as libc::c_int {
                (*this).framesUntilDisable = -(1 as libc::c_int) as s16;
                D_8089C1A0 -= 1 as libc::c_int
            }
        }
    }
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 &&
           (if ((*(*this).collider.base.ac).world.rot.y as libc::c_int -
        ...
        if (*this).framesUntilDisable as libc::c_int == -(1 as libc::c_int) {
            ...
            D_8089C1A0 += 1 as libc::c_int;
            D_8089C1A0 =
                if D_8089C1A0 > 4 as libc::c_int {
                    4 as libc::c_int
                } else { D_8089C1A0 }
        }
        (*this).framesUntilDisable = 416 as libc::c_int as s16;
        if D_8089C1A0 == 4 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriEye_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgMenkuriEye = thisx as *mut BgMenkuriEye;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_menkuri_eye.c\x00" as *const u8 as
            ...
            (200 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int
    } else if (*this).framesUntilDisable as libc::c_int == -(1 as libc::c_int)
     {
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gGTGEyeStatueEyeDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_menkuri_eye.c\x00" as *const u8 as
                         *const libc::c_char, 335 as libc::c_int);
}
