...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ice_objects_DL_0006F0: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_DL_0012A0: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_Col_001C1C: CollisionHeader;
    #[no_mangle]
    static mut object_ice_objects_DL_002640: [Gfx; 0];
    #[no_mangle]
    static mut object_ice_objects_Col_002920: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgIceShelter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgIceShelterActionFunc,
    pub cylinder1: ColliderCylinder,
    pub cylinder2: ColliderCylinder,
    pub alpha: s16,
}
pub type BgIceShelterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgIceShelter, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Ice_Shelter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_ICE_SHELTER as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_ICE_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgIceShelter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShelter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShelter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShelter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgIceShelter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sScales: [f32_0; 5] = [0.1f32, 0.06f32, 0.1f32, 0.1f32, 0.25f32];
...
static mut D_8089170C: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80891738: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
#[no_mangle]
pub unsafe extern "C" fn func_80890740(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext) {
    static mut cylinderRadii: [s16; 5] =
        [47 as libc::c_int as s16, 33 as libc::c_int as s16,
         44 as libc::c_int as s16, 41 as libc::c_int as s16,
         100 as libc::c_int as s16];
    static mut cylinderHeights: [s16; 5] =
        [80 as libc::c_int as s16, 54 as libc::c_int as s16,
         90 as libc::c_int as s16, 60 as libc::c_int as s16,
         200 as libc::c_int as s16];
    let mut pad: s32 = 0;
    let mut type_0: s32 =
        (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
            7 as libc::c_int;
    Collider_InitCylinder(globalCtx, &mut (*this).cylinder1);
    Collider_SetCylinder(globalCtx, &mut (*this).cylinder1,
                         &mut (*this).dyna.actor, &mut D_8089170C);
    Collider_UpdateCylinder(&mut (*this).dyna.actor, &mut (*this).cylinder1);
    (*this).cylinder1.dim.radius = cylinderRadii[type_0 as usize];
    (*this).cylinder1.dim.height = cylinderHeights[type_0 as usize];
    if type_0 == 0 as libc::c_int || type_0 == 1 as libc::c_int ||
           type_0 == 4 as libc::c_int {
        Collider_InitCylinder(globalCtx, &mut (*this).cylinder2);
        Collider_SetCylinder(globalCtx, &mut (*this).cylinder2,
                             &mut (*this).dyna.actor, &mut D_80891738);
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).cylinder2);
        (*this).cylinder2.dim.radius = cylinderRadii[type_0 as usize];
        (*this).cylinder2.dim.height = cylinderHeights[type_0 as usize]
    }
    if type_0 == 4 as libc::c_int {
        (*this).cylinder1.dim.pos.z =
            ((*this).cylinder1.dim.pos.z as libc::c_int + 30 as libc::c_int)
                as s16;
        (*this).cylinder2.dim.pos.z =
            ((*this).cylinder2.dim.pos.z as libc::c_int + 30 as libc::c_int)
                as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80890874(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_ice_shelter.c\x00" as *const u8 as
                         *const libc::c_char, 362 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808908FC(mut dest: *mut Vec3f,
                                       mut src: *mut Vec3f, mut angle: s16) {
    let mut sin: f32_0 = Math_SinS(angle);
    let mut cos: f32_0 = Math_CosS(angle);
...
#[no_mangle]
pub unsafe extern "C" fn BgIceShelter_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut kzIceScale: Vec3f =
        { let mut init = Vec3f{x: 0.18f32, y: 0.27f32, z: 0.24f32,}; init };
    let mut this: *mut BgIceShelter = thisx as *mut BgIceShelter;
    let mut type_0: s16 =
        ((*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
    ...
    if type_0 as libc::c_int == 4 as libc::c_int {
        (*this).dyna.actor.world.rot.x =
            ((*this).dyna.actor.world.rot.x as libc::c_int +
                 0xbb8 as libc::c_int) as s16;
        (*this).dyna.actor.world.pos.y -= 45.0f32;
        (*this).dyna.actor.shape.rot.x = (*this).dyna.actor.world.rot.x;
        (*this).dyna.actor.world.pos.z -= 38.0f32
    }
    if type_0 as libc::c_int == 4 as libc::c_int {
        Math_Vec3f_Copy(&mut (*this).dyna.actor.scale, &mut kzIceScale);
    } else {
        Actor_SetScale(&mut (*this).dyna.actor, sScales[type_0 as usize]);
    }
    match type_0 as libc::c_int {
        2 => {
            func_80890874(this, globalCtx, &mut object_ice_objects_Col_001C1C,
                          0 as libc::c_int);
        }
        3 => {
            func_80890874(this, globalCtx, &mut object_ice_objects_Col_002920,
                          0 as libc::c_int);
        }
        _ => { }
    }
    ...
    func_80891064(this);
    osSyncPrintf(b"(ice shelter)(arg_data 0x%04x)\n\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgIceShelter_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgIceShelter = thisx as *mut BgIceShelter;
    match (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
              7 as libc::c_int {
        2 | 3 => {
        ...
        0 | 1 | 4 => {
            Collider_DestroyCylinder(globalCtx, &mut (*this).cylinder2);
        }
        _ => { }
    }
    Collider_DestroyCylinder(globalCtx, &mut (*this).cylinder1);
}
static mut D_80891794: [s16; 8] =
    [0 as libc::c_int as s16, 0x4000 as libc::c_int as s16,
     0x2000 as libc::c_int as s16, 0x6000 as libc::c_int as s16,
     0x1000 as libc::c_int as s16, 0x5000 as libc::c_int as s16,
     0x3000 as libc::c_int as s16, 0x7000 as libc::c_int as s16];
static mut D_808917A4: [s16; 8] =
    [0 as libc::c_int as s16, 0x3c as libc::c_int as s16,
     0x18 as libc::c_int as s16, 0x54 as libc::c_int as s16,
     0x30 as libc::c_int as s16, 0xc as libc::c_int as s16,
     0x48 as libc::c_int as s16, 0x24 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn func_80890B8C(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext,
                                       mut chance: f32_0, mut scale: f32_0) {
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    let mut xzOffset: f32_0 = 0.;
    let mut icePos: *mut Vec3f = 0 as *mut Vec3f;
    let mut angle: s16 = 0;
    ...
    let mut dustAccel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    frames =
        ((*globalCtx).state.frames as s16 as libc::c_int & 7 as libc::c_int)
            as s16;
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        if !(chance < Rand_ZeroOne()) {
            xzOffset = 42.0f32 * scale;
            icePos = &mut (*this).dyna.actor.world.pos;
            angle =
                (D_80891794[frames as usize] as libc::c_int +
                     i * 0x8000 as libc::c_int) as s16;
            sin = Math_SinS(angle);
            cos = Math_CosS(angle);
            dustPos.x = xzOffset * sin + (*icePos).x;
            dustPos.y = 16.0f32 * scale + (*icePos).y;
            dustPos.z = xzOffset * cos + (*icePos).z;
            dustVel.x = (Rand_ZeroOne() * 3.0f32 - 1.0f32) * sin;
            dustVel.y = 0.0f32;
            dustVel.z = (Rand_ZeroOne() * 3.0f32 - 1.0f32) * cos;
            dustAccel.x = 0.07f32 * sin;
            dustAccel.y = 0.8f32;
            dustAccel.z = 0.07f32 * cos;
            func_8002829C(globalCtx, &mut dustPos, &mut dustVel,
                          &mut dustAccel, &mut sDustPrimColor,
                          &mut sDustEnvColor, (450.0f32 * scale) as s16,
                          ((Rand_ZeroOne() * 40.0f32 + 40.0f32) as s16 as
                               libc::c_int as libc::c_float * scale) as s16);
        }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80890E00(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext,
                                       mut chance: f32_0, mut arg3: f32_0) {
    static mut D_808917B4: [f32_0; 2] = [-1.0f32, 1.0f32];
    let mut icePos: *mut Vec3f = 0 as *mut Vec3f;
    let mut frames: s16 = 0;
    let mut pad: [s32; 2] = [0; 2];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustVel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustAccel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut posOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    frames =
        ((*globalCtx).state.frames as s16 as libc::c_int & 7 as libc::c_int)
            as s16;
    ...
    while i < 2 as libc::c_int {
        ...
        if !(chance < Rand_ZeroOne()) {
            posOffset.x =
                (D_808917A4[frames as usize] as libc::c_int as libc::c_float +
                     (Rand_ZeroOne() * 12.0f32 - 6.0f32)) *
                    D_808917B4[i as usize];
            posOffset.y = 15.0f32;
            posOffset.z =
                (84.0f32 - posOffset.x) * 0.2f32 + Rand_ZeroOne() * 20.0f32;
            func_808908FC(&mut dustPos, &mut posOffset,
                          (*this).dyna.actor.world.rot.y);
            Math_Vec3f_Sum(&mut dustPos, icePos, &mut dustPos);
            dustVel.x = Rand_ZeroOne() * 3.0f32 - 1.5f32;
            dustVel.y = 0.0f32;
            dustVel.z = Rand_ZeroOne() * 3.0f32 - 1.5f32;
            dustAccel.x = Rand_ZeroOne() * 0.14f32 - 0.07f32;
            dustAccel.y = 0.8f32;
            dustAccel.z = Rand_ZeroOne() * 0.14f32 - 0.07f32;
            func_8002829C(globalCtx, &mut dustPos, &mut dustVel,
                          &mut dustAccel, &mut sDustPrimColor,
                          &mut sDustEnvColor, 450 as libc::c_int as s16,
                          (Rand_ZeroOne() * 40.0f32 + 40.0f32) as s16);
        }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80891064(mut this: *mut BgIceShelter) {
    (*this).actionFunc =
        Some(func_8089107C as
                 unsafe extern "C" fn(_: *mut BgIceShelter,
                                      _: *mut GlobalContext) -> ());
    (*this).alpha = 255 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8089107C(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut type_0: s16 =
        ((*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
    ...
    if type_0 as libc::c_int == 4 as libc::c_int {
        if !(*this).dyna.actor.parent.is_null() {
            (*(*this).dyna.actor.parent).freezeTimer =
                10000 as libc::c_int as u16_0
        }
    }
    if (*this).cylinder1.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).cylinder1.base.acFlags =
            ((*this).cylinder1.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if !(*this).cylinder1.base.ac.is_null() &&
               (*(*this).cylinder1.base.ac).id as libc::c_int ==
                   ACTOR_EN_ICE_HONO as libc::c_int {
            if type_0 as libc::c_int == 4 as libc::c_int {
                if !(*this).dyna.actor.parent.is_null() {
                    (*(*this).dyna.actor.parent).freezeTimer =
...
#[no_mangle]
pub unsafe extern "C" fn func_808911BC(mut this: *mut BgIceShelter) {
    (*this).actionFunc =
        Some(func_808911D4 as
                 unsafe extern "C" fn(_: *mut BgIceShelter,
                                      _: *mut GlobalContext) -> ());
    (*this).alpha = 255 as libc::c_int as s16;
}
static mut D_808917BC: [f32_0; 5] =
    [-0.0015f32, -0.0009f32, -0.0016f32, -0.0016f32, -0.00375f32];
static mut D_808917D0: [f32_0; 5] = [1.0f32, 0.6f32, 1.2f32, 1.0f32, 1.8f32];
static mut sEffSpawnFuncs:
       [Option<unsafe extern "C" fn(_: *mut BgIceShelter,
                                    _: *mut GlobalContext, _: f32_0, _: f32_0)
                   -> ()>; 5] =
    unsafe {
        [Some(func_80890B8C as
                  unsafe extern "C" fn(_: *mut BgIceShelter,
                                       _: *mut GlobalContext, _: f32_0,
                                       _: f32_0) -> ()),
         Some(func_80890B8C as
                  unsafe extern "C" fn(_: *mut BgIceShelter,
                                       _: *mut GlobalContext, _: f32_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_808911D4(mut this: *mut BgIceShelter,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut type_0: s32 =
        (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
    ...
    (*this).alpha = ((*this).alpha as libc::c_int - 5 as libc::c_int) as s16;
    (*this).alpha =
        if ((*this).alpha as libc::c_int) < 0 as libc::c_int {
            0 as libc::c_int
        } else if (*this).alpha as libc::c_int > 255 as libc::c_int {
            255 as libc::c_int
        } else { (*this).alpha as libc::c_int } as s16;
    (*this).dyna.actor.scale.y += D_808917BC[type_0 as usize];
    (*this).dyna.actor.scale.y =
        if (*this).dyna.actor.scale.y < 0.0001f32 {
            0.0001f32
        } else { (*this).dyna.actor.scale.y };
    if (*this).alpha as libc::c_int > 80 as libc::c_int {
        match type_0 {
            0 | 1 | 4 => {
                CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                     &mut (*this).cylinder1.base);
    ...
    if (*this).alpha as libc::c_int > 180 as libc::c_int {
        phi_f0 = 1.0f32
    } else if (*this).alpha as libc::c_int > 60 as libc::c_int {
        phi_f0 = 0.5f32
    } else { phi_f0 = 0.0f32 }
    sEffSpawnFuncs[type_0 as
...
#[no_mangle]
pub unsafe extern "C" fn BgIceShelter_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgIceShelter = thisx as *mut BgIceShelter;
...
#[no_mangle]
pub unsafe extern "C" fn BgIceShelter_Draw(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    ...
    match (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
              7 as libc::c_int {
        0 | 1 | 2 | 4 => {
            func_8002ED80(&mut (*this).dyna.actor, globalCtx,
                          0 as libc::c_int);
        }
        _ => { }
    }
        ...
        0 | 1 | 4 => {
            ...
            (*_g_1).words.w1 =
                Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 (*globalCtx).gameplayFrames.wrapping_neg() &
            ...
            (*_g_2).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                object_ice_objects_DL_0006F0.as_mut_ptr() as libc::c_uint
        }
        2 => {
            ...
            (*_g_5).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                object_ice_objects_DL_0012A0.as_mut_ptr() as libc::c_uint
        }
        3 => {
            ...
            (*_g_6).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_6).words.w1 =
                object_ice_objects_DL_002640.as_mut_ptr() as libc::c_uint
        }
        _ => { }
    }
