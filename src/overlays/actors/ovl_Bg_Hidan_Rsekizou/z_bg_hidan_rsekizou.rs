...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleSpinningFlamethrowerDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleSpinningFlamethrowerCol: CollisionHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanRsekizou {
    pub dyna: DynaPolyActor,
    pub bendFrame: s16,
    pub burnFrame: s16,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 6],
}
#[no_mangle]
pub static mut Bg_Hidan_Rsekizou_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_RSEKIZOU as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanRsekizou>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRsekizou_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRsekizou_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRsekizou_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanRsekizou_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRsekizou_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanRsekizou =
        thisx as *mut BgHidanRsekizou; // Approximately 2 Degrees per Frame
    let mut i: s32 = 0;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gFireTempleSpinningFlamethrowerCol as
    ...
    (*this).burnFrame = 0 as libc::c_int as s16;
    (*this).bendFrame = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanRsekizou_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgHidanRsekizou = thisx as *mut BgHidanRsekizou;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanRsekizou_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgHidanRsekizou = thisx as *mut BgHidanRsekizou;
    let mut i: s32 = 0;
    let mut sphere: *mut ColliderJntSphElement =
        0 as *mut ColliderJntSphElement;
    let mut pad: s32 = 0;
    let mut yawSine: f32_0 = 0.;
    let mut yawCosine: f32_0 = 0.;
    (*this).burnFrame =
        (((*this).burnFrame as libc::c_int + 1 as libc::c_int) %
             8 as libc::c_int) as s16;
    if (*this).bendFrame as libc::c_int != 0 as libc::c_int {
        (*this).bendFrame -= 1
    }
    if (*this).bendFrame as libc::c_int == 0 as libc::c_int {
        (*this).bendFrame = 3 as libc::c_int as s16
    }
    (*this).dyna.actor.shape.rot.y =
        ((*this).dyna.actor.shape.rot.y as libc::c_int + 0x180 as libc::c_int)
            as s16;
    ...
    while i <
        ...
        (*sphere).dim.worldSphere.center.x =
            ((*this).dyna.actor.home.pos.x +
                 yawCosine *
                     (*sphere).dim.modelSphere.center.x as libc::c_int as
                         libc::c_float +
                 yawSine *
                     (*sphere).dim.modelSphere.center.z as libc::c_int as
                         libc::c_float) as s16;
        (*sphere).dim.worldSphere.center.y =
            ((*this).dyna.actor.home.pos.y as s16 as libc::c_int +
                 (*sphere).dim.modelSphere.center.y as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRsekizou_DrawFireball(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut this:
                                                          *mut BgHidanRsekizou,
                                                      mut frame: s16,
 ...
 -> *mut Gfx {
    ...
    let mut temp: s32 = 0;
    let mut fVar6: f32_0 = 0.;
    let mut tmpf7: f32_0 = 0.;
    temp =
        ((((*this).burnFrame as libc::c_int + frame as libc::c_int) %
              8 as libc::c_int * 7 as libc::c_int) as libc::c_float *
             (1.0f32 / 7.0f32)) as s32;
    let fresh0 = displayList;
    ...
    (*_g).words.w1 =
        gSegments[((sFireballsTexs[temp as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sFireballsTexs[temp as usize] as
                                              u32_0 &
    ...
    frame += 1;
    fVar6 =
        if frame as libc::c_int != 4 as libc::c_int {
            (frame as libc::c_int as libc::c_float) +
                (3 as libc::c_int - (*this).bendFrame as libc::c_int) as
                    libc::c_float * (1.0f32 / 3.0f32)
        } else { frame as libc::c_int as libc::c_float };
    ...
    if a == 0 as libc::c_int {
        sins =
            -Math_SinS(((*this).dyna.actor.shape.rot.y as libc::c_int -
                            frame as libc::c_int * 1500 as libc::c_int) as
                           s16);
        coss =
        ...
        coss =
            Math_CosS(((*this).dyna.actor.shape.rot.y as libc::c_int -
                           frame as libc::c_int * 1500 as libc::c_int) as s16)
    }
    (*mf).c2rust_unnamed.zz = 0.7f32 * fVar6 + 0.5f32;
    (*mf).c2rust_unnamed.yy = (*mf).c2rust_unnamed.zz;
    (*mf).c2rust_unnamed.xx = (*mf).c2rust_unnamed.yy;
    tmpf7 = (0.7f32 * fVar6 + 0.5f32) * 10.0f32 * fVar6 + 20.0f32;
    (*mf).c2rust_unnamed.xw = tmpf7 * sins + (*this).dyna.actor.world.pos.x;
    (*mf).c2rust_unnamed.yw =
        (*this).dyna.actor.world.pos.y + 30.0f32 + 7.0f32 / 10.0f32 * fVar6;
    (*mf).c2rust_unnamed.zw = tmpf7 * coss + (*this).dyna.actor.world.pos.z;
    let fresh3 = displayList;
    displayList = displayList.offset(1);
    ...
    (*_g_2).words.w1 =
        Matrix_MtxFToMtx(Matrix_CheckFloats(mf,
                                            b"../z_bg_hidan_rsekizou.c\x00" as
                                                *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanRsekizou_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanRsekizou = thisx as *mut BgHidanRsekizou;
    let mut i: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_rsekizou.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gFireTempleSpinningFlamethrowerDL.as_mut_ptr() as libc::c_uint;
    Matrix_MtxFCopy(&mut mf, &mut gMtxFClear);
    (*__gfxCtx).polyXlu.p =
    ...
    if (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                        as usize]) as
            libc::c_int - (*this).dyna.actor.shape.rot.y as libc::c_int -
            0x2e6c as libc::c_int) as s16 as libc::c_int >= 0 as libc::c_int {
        i = 3 as libc::c_int;
        while i >= 0 as libc::c_int {
            (*__gfxCtx).polyXlu.p =
                BgHidanRsekizou_DrawFireball(globalCtx, this, i as s16,
                                             &mut mf, 0 as libc::c_int,
                                             (*__gfxCtx).polyXlu.p);
            i -= 1
        }
        i = 0 as libc::c_int;
