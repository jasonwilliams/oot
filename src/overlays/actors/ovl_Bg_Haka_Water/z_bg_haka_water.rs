...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gBotwWaterRingDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotwWaterFallDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaWater {
    pub actor: Actor,
    pub actionFunc: BgHakaWaterActionFunc,
    pub isLowered: u8_0,
}
pub type BgHakaWaterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaWater, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_Water_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_WATER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHakaWater>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaWater_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaWater_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaWater_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaWater_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaWater = thisx as *mut BgHakaWater;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        (*this).isLowered = 1 as libc::c_int as u8_0;
        (*this).actor.home.pos.y -= 200.0f32;
        (*this).actor.world.pos.y = (*this).actor.home.pos.y
    } else { (*this).isLowered = 0 as libc::c_int as u8_0 }
    BgHakaWater_LowerWater(this, globalCtx);
    (*this).actionFunc =
        Some(BgHakaWater_Wait as
                 unsafe extern "C" fn(_: *mut BgHakaWater,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_LowerWater(mut this: *mut BgHakaWater,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 9 as libc::c_int {
        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(i as
                                                                 isize)).ySurface
            =
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_Wait(mut this: *mut BgHakaWater,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).isLowered == 0 &&
           Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 ||
           (*this).isLowered as libc::c_int != 0 &&
               Flags_GetSwitch(globalCtx, (*this).actor.params as s32) == 0 {
        if (*this).isLowered != 0 {
            (*this).isLowered = 0 as libc::c_int as u8_0;
            (*this).actor.draw =
                Some(BgHakaWater_Draw as
        ...
        (*this).actionFunc =
            Some(BgHakaWater_ChangeWaterLevel as
                     unsafe extern "C" fn(_: *mut BgHakaWater,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_ChangeWaterLevel(mut this:
                                                          *mut BgHakaWater,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if (*this).isLowered == 0 &&
        ...
        (*this).isLowered = 1 as libc::c_int as u8_0;
        (*this).actor.home.pos.y -= 200.0f32
    } else if (*this).isLowered as libc::c_int != 0 &&
                  Flags_GetSwitch(globalCtx, (*this).actor.params as s32) == 0
     {
        (*this).isLowered = 0 as libc::c_int as u8_0;
        (*this).actor.home.pos.y += 200.0f32
    ...
    if Math_StepToF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                    0.5f32) != 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgHakaWater_Wait as
                     unsafe extern "C" fn(_: *mut BgHakaWater,
                                          _: *mut GlobalContext) -> ());
        if (*this).isLowered != 0 { (*this).actor.draw = None }
    }
    BgHakaWater_LowerWater(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHakaWater = thisx as *mut BgHakaWater;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaWater_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaWater = thisx as *mut BgHakaWater;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_haka_water.c\x00" as *const u8 as
    ...
    if (*this).isLowered != 0 {
        ...
        temp =
            (*this).actor.world.pos.y - ((*this).actor.home.pos.y - 200.0f32)
    }
    ...
    (*_g).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((0.765f32 * temp) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gBotwWaterRingDL.as_mut_ptr() as libc::c_uint;
    Matrix_Translate(0.0f32, 92.0f32, -1680.0f32,
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = gBotwWaterFallDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_haka_water.c\x00" as *const u8 as
                         *const libc::c_char, 332 as libc::c_int);
}
