...
extern "C" {
    ...
    #[no_mangle]
    static mut gGerudoRedStandAnim: AnimationHeader;
}
...
pub const GELDB_LIMB_MAX: C2RustUnnamed_23 = 24;
pub const GELDB_LIMB_WAIST: C2RustUnnamed_23 = 23;
pub const GELDB_LIMB_R_FOOT: C2RustUnnamed_23 = 22;
pub const GELDB_LIMB_R_SHIN: C2RustUnnamed_23 = 21;
pub const GELDB_LIMB_R_THIGH: C2RustUnnamed_23 = 20;
pub const GELDB_LIMB_L_FOOT: C2RustUnnamed_23 = 19;
pub const GELDB_LIMB_L_SHIN: C2RustUnnamed_23 = 18;
pub const GELDB_LIMB_L_THIGH: C2RustUnnamed_23 = 17;
pub const GELDB_LIMB_L_SWORD: C2RustUnnamed_23 = 16;
pub const GELDB_LIMB_L_HAND: C2RustUnnamed_23 = 15;
pub const GELDB_LIMB_L_WRIST: C2RustUnnamed_23 = 14;
pub const GELDB_LIMB_L_FOREARM: C2RustUnnamed_23 = 13;
pub const GELDB_LIMB_L_UPPER_ARM: C2RustUnnamed_23 = 12;
pub const GELDB_LIMB_R_SWORD: C2RustUnnamed_23 = 11;
pub const GELDB_LIMB_R_HAND: C2RustUnnamed_23 = 10;
pub const GELDB_LIMB_R_WRIST: C2RustUnnamed_23 = 9;
pub const GELDB_LIMB_R_FOREARM: C2RustUnnamed_23 = 8;
pub const GELDB_LIMB_R_UPPER_ARM: C2RustUnnamed_23 = 7;
pub const GELDB_LIMB_HEAD: C2RustUnnamed_23 = 6;
pub const GELDB_LIMB_VEIL: C2RustUnnamed_23 = 5;
pub const GELDB_LIMB_PONYTAIL: C2RustUnnamed_23 = 4;
pub const GELDB_LIMB_NECK: C2RustUnnamed_23 = 3;
pub const GELDB_LIMB_TORSO: C2RustUnnamed_23 = 2;
pub const GELDB_LIMB_ROOT: C2RustUnnamed_23 = 1;
pub const GELDB_LIMB_NONE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnGe3 {
    pub actor: Actor,
    ...
    pub unk_306: Vec3s,
    pub unk_30C: u16_0,
    pub actionFunc: EnGe3ActionFunc,
}
pub type EnGe3ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGe3, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ge3_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GE3 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnGe3>() as libc::c_ulong,
                          init:
...
static mut sActionFuncs: [EnGe3ActionFunc; 1] =
    unsafe {
        [Some(EnGe3_WaitLookAtPlayer as
                  unsafe extern "C" fn(_: *mut EnGe3, _: *mut GlobalContext)
                      -> ())]
    };
static mut sAnimations: [*mut AnimationHeader; 1] =
    unsafe {
        [&gGerudoRedStandAnim as *const AnimationHeader as
             *mut AnimationHeader]
    };
// Idle with right hand on hip and left over mouth
static mut sAnimationModes: [u8_0; 1] =
    [ANIMMODE_LOOP as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn EnGe3_ChangeAction(mut this: *mut EnGe3,
                                            mut i: s32) {
    ...
    Animation_Change(&mut (*this).skelAnime, sAnimations[i as usize], 1.0f32,
                     ...
                     sAnimationModes[i as usize], -8.0f32);
    (*this).unk_30C =
        ((*this).unk_30C as libc::c_int & !(2 as libc::c_int)) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnGe3_Init(mut thisx: *mut Actor,
                                    mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnGe3 = thisx as *mut EnGe3;
    ...
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gGerudoRedStandAnim);
    ...
    EnGe3_ChangeAction(this, 0 as libc::c_int);
    (*this).actionFunc =
        Some(EnGe3_ForceTalk as
                 unsafe extern "C" fn(_: *mut EnGe3, _: *mut GlobalContext)
                     -> ());
    (*this).unk_30C = 0 as libc::c_int as u16_0;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    (*this).actor.minVelocityY = -4.0f32;
    (*this).actor.gravity = -1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGe3_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGe3 = thisx as *mut EnGe3;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe3_TurnToFacePlayer(mut this: *mut EnGe3,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if (if angleDiff as libc::c_int >= 0 as libc::c_int {
        ...
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).headRot,
                      &mut (*this).unk_306, (*this).actor.focus.pos);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_LookAtPlayer(mut this: *mut EnGe3,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
            ...
            -(((*this).actor.yawTowardsPlayer as libc::c_int -
                   (*this).actor.shape.rot.y as libc::c_int) as s16 as
                  libc::c_int)
        }) <= 0x2300 as libc::c_int && (*this).actor.xzDistToPlayer < 100.0f32
       {
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).headRot,
                      &mut (*this).unk_306, (*this).actor.focus.pos);
    } else {
        ...
        Math_SmoothStepToS(&mut (*this).headRot.y, 0 as libc::c_int as s16,
                           ...
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_306.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_306.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_Wait(mut this: *mut EnGe3,
                                    mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnGe3_WaitLookAtPlayer as
                     unsafe extern "C" fn(_: *mut EnGe3,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.update =
            Some(EnGe3_UpdateWhenNotTalking as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.flags &=
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_WaitLookAtPlayer(mut this: *mut EnGe3,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    EnGe3_LookAtPlayer(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnGe3_WaitTillCardGiven(mut this: *mut EnGe3,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_GiveCard(mut this: *mut EnGe3,
                                        mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(EnGe3_WaitTillCardGiven as
                     unsafe extern "C" fn(_: *mut EnGe3,
                                          _: *mut GlobalContext) -> ());
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_GERUDO_CARD as libc::c_int, 10000.0f32, 50.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_ForceTalk(mut this: *mut EnGe3,
                                         mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnGe3_GiveCard as
                     unsafe extern "C" fn(_: *mut EnGe3,
                                          _: *mut GlobalContext) -> ())
    } else {
        if (*this).unk_30C as libc::c_int & 4 as libc::c_int == 0 {
            func_8002DF54(globalCtx, &mut (*this).actor,
                          7 as libc::c_int as u8_0);
            (*this).unk_30C =
                ((*this).unk_30C as libc::c_int | 4 as libc::c_int) as u16_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_UpdateCollision(mut this: *mut EnGe3,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    ...
    if (*this).unk_30C as libc::c_int & 2 as libc::c_int == 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_MoveAndBlink(mut this: *mut EnGe3,
                                            mut globalCtx:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_UpdateWhenNotTalking(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut EnGe3 = thisx as *mut EnGe3;
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGe3 = thisx as *mut EnGe3;
    EnGe3_UpdateCollision(this, globalCtx);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    match limbIndex {
        ...
        6 => {
            // Turn head
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).headRot.y as libc::c_int)
                    as s16
        }
        _ => { }
    }
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ge3.c\x00" as *const u8 as *const libc::c_char,
                    547 as libc::c_int);
    match limbIndex {
        3 => { }
        6 => {
...
#[no_mangle]
pub unsafe extern "C" fn EnGe3_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    let mut this: *mut EnGe3 = thisx as *mut EnGe3;
    let mut D_80A351C8: Vec3f =
        { let mut init = Vec3f{x: 600.0f32, y: 700.0f32, z: 0.0f32,}; init };
    if limbIndex == GELDB_LIMB_HEAD as libc::c_int {
        Matrix_MultVec3f(&mut D_80A351C8, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGe3_Draw(mut thisx: *mut Actor,
                                    mut globalCtx2: *mut GlobalContext) {
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnGe3_OverrideLimbDraw as
