...
pub unsafe extern "C" fn func_80026230(mut globalCtx: *mut GlobalContext,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_eff_ss_dead.c\x00" as *const u8 as
                        *const libc::c_char, 113 as libc::c_int);
    displayListHead = (*__gfxCtx).polyOpa.p;
    cos =
        Math_CosS((0x8000 as libc::c_int / arg3 as libc::c_int *
                       arg2 as libc::c_int) as s16);
    absCos =
        if cos >= 0 as libc::c_int as libc::c_float { cos } else { -cos };
    ...
    (*_g_2).words.w1 =
        ((128000 as libc::c_int /
              ((absCos * 3000.0f32) as s16 as libc::c_int +
                   1500 as libc::c_int - 0 as libc::c_int)) as u32_0 &
             (((0x1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 16 as libc::c_int |
            (((500 as libc::c_int - 0 as libc::c_int) * 256 as libc::c_int /
                  ((absCos * 3000.0f32) as s16 as libc::c_int +
                       1500 as libc::c_int - 0 as libc::c_int)) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*__gfxCtx).polyOpa.p = displayListHead;
    // Necessary to match
...
#[no_mangle]
pub unsafe extern "C" fn func_80026400(mut globalCtx: *mut GlobalContext,
                                       mut color: *mut Color_RGBA8,
                                       mut arg2: s16, mut arg3: s16) {
    let mut displayListHead: *mut Gfx = 0 as *mut Gfx;
    let mut cos: f32_0 = 0.;
    if arg3 as libc::c_int != 0 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_eff_ss_dead.c\x00" as *const u8 as
                            *const libc::c_char, 141 as libc::c_int);
        cos =
            Math_CosS((0x4000 as libc::c_int / arg3 as libc::c_int *
                           arg2 as libc::c_int) as s16);
        displayListHead = (*__gfxCtx).polyOpa.p;
        ...
        (*_g_1).words.w1 =
            ((128000 as libc::c_int /
                  ((2800.0f32 *
                        (if cos >= 0 as libc::c_int as libc::c_float {
                             cos
                         } else { -cos })) as s16 as libc::c_int +
                       1700 as libc::c_int - 0 as libc::c_int)) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
                |
                (((500 as libc::c_int - 0 as libc::c_int) * 256 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80026608(mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_eff_ss_dead.c\x00" as *const u8 as
                        *const libc::c_char, 159 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80026690(mut globalCtx: *mut GlobalContext,
                                       mut color: *mut Color_RGBA8,
                                       mut arg2: s16, mut arg3: s16) {
    let mut cos: f32_0 = 0.;
    let mut displayListHead: *mut Gfx = 0 as *mut Gfx;
    ...
    displayListHead = (*__gfxCtx).polyXlu.p;
    cos =
        Math_CosS((0x8000 as libc::c_int / arg3 as libc::c_int *
                       arg2 as libc::c_int) as s16);
    absCos =
    ...
    (*_g_2).words.w1 =
        ((128000 as libc::c_int /
            ...
            (((500 as libc::c_int - 0 as libc::c_int) * 256 as libc::c_int /
                 ...
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*__gfxCtx).polyXlu.p = displayListHead;
    // Necessary to match
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_eff_ss_dead.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80026860(mut globalCtx: *mut GlobalContext,
                                       mut color: *mut Color_RGBA8,
                                       mut arg2: s16, mut arg3: s16) {
    let mut cos: f32_0 = 0.;
    let mut displayListHead: *mut Gfx = 0 as *mut Gfx;
...
#[no_mangle]
pub unsafe extern "C" fn func_80026A6C(mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    ...
    (*_g).words.w0 =
        (0xe7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g).words.w1 = 0 as libc::c_int as libc::c_uint;
    (*__gfxCtx).polyXlu.p = Gameplay_SetFog(globalCtx, (*__gfxCtx).polyXlu.p);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_eff_ss_dead.c\x00" as *const u8 as
