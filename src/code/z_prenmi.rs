...
extern "C" {
    ...
    #[no_mangle]
    fn func_800940B0(gfxCtx: *mut GraphicsContext);
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn func_80092320(mut this: *mut PreNMIContext) {
    (*this).state.running = 0 as libc::c_int as u32_0;
    (*this).state.init = None;
    (*this).state.size = 0 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn PreNMI_Update(mut this: *mut PreNMIContext) {
    osSyncPrintf(b"\x1b[43;30mprenmi_move\n\x1b[m\x00" as *const u8 as
                     *const libc::c_char);
    // Strings existing only in rodata
    if (*this).timer == 0 as libc::c_int as libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn PreNMI_Draw(mut this: *mut PreNMIContext) {
    let mut gfxCtx: *mut GraphicsContext = (*this).state.gfxCtx;
    osSyncPrintf(b"\x1b[43;30mprenmi_draw\n\x1b[m\x00" as *const u8 as
                     *const libc::c_char);
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_prenmi.c\x00" as *const u8 as *const libc::c_char,
                    96 as libc::c_int);
    ...
    (*_g_1).words.w0 =
        (0xf6 as libc::c_int as u32_0 &
            ...
            |
            ((*this).timer.wrapping_add(100 as libc::c_int as libc::c_uint) &
                 (((0x1 as libc::c_int) << 10 as libc::c_int) -
...
#[no_mangle]
pub unsafe extern "C" fn PreNMI_Main(mut thisx: *mut GameState) {
    let mut this: *mut PreNMIContext = thisx as *mut PreNMIContext;
    PreNMI_Update(this);
    PreNMI_Draw(this);
    (*this).state.unk_A0 = 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn PreNMI_Destroy(mut thisx: *mut GameState) { }
#[no_mangle]
pub unsafe extern "C" fn PreNMI_Init(mut thisx: *mut GameState) {
    let mut this: *mut PreNMIContext = thisx as *mut PreNMIContext;
    (*this).state.main =
        Some(PreNMI_Main as unsafe extern "C" fn(_: *mut GameState) -> ());
    (*this).state.destroy =
        Some(PreNMI_Destroy as unsafe extern "C" fn(_: *mut GameState) -> ());
    (*this).timer = 30 as libc::c_int as u32_0;
    (*this).unk_A8 = 10 as libc::c_int;
