...
extern "C" {
    ...
    fn Actor_SetColorFilter(actor: *mut Actor, colorFlag: s16,
                            ...
                            duration: s16);
    #[no_mangle]
    fn Actor_SetDropFlagJntSph(actor: *mut Actor,
                               colBody: *mut ColliderJntSph, freezeFlag: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDekuBabaPauseChompAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuBabaFastChompAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuBabaBaseLeavesDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuBabaStemTopDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuBabaStemMiddleDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuBabaStemBaseDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuBabaSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDekuBabaStickDropDL: [Gfx; 0];
    #[no_mangle]
...
pub struct EnDekubaba {
    pub actor: Actor,
    pub bodyPartsPos: [Vec3f; 4],
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDekubabaActionFunc,
    pub pad: [libc::c_char; 2],
    pub timer: s16,
    pub targetSwayAngle: s16,
    pub stemSectionAngle: [s16; 3],
    pub jointTable: [Vec3s; 8],
    pub morphTable: [Vec3s; 8],
    pub size: f32_0,
    pub boundFloor: *mut CollisionPoly,
    pub collider: ColliderJntSph,
    pub colliderElements: [ColliderJntSphElement; 7],
}
pub type EnDekubabaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDekubaba, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const DEKUBABA_BIG: C2RustUnnamed_25 = 1;
pub const DEKUBABA_NORMAL: C2RustUnnamed_25 = 0;
pub const DEKUBABA_DMGEFF_NONE: C2RustUnnamed_26 = 0;
pub const DEKUBABA_DMGEFF_SWORD: C2RustUnnamed_26 = 15;
pub const DEKUBABA_DMGEFF_FIRE: C2RustUnnamed_26 = 2;
pub const DEKUBABA_DMGEFF_BOOMERANG: C2RustUnnamed_26 = 14;
pub const DEKUBABA_DMGEFF_DEKUNUT: C2RustUnnamed_26 = 1;
pub type C2RustUnnamed_26 = libc::c_uint;
static mut sZeroVec: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub static mut En_Dekubaba_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DEKUBABA as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_DEKUBABA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDekubaba>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekubaba_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekubaba_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekubaba_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekubaba_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sJntSphElementsInit: [ColliderJntSphElementInit; 7] =
    [{
         let mut init =
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 2 as libc::c_int as u8_0,
                                   cylRadius: 25 as libc::c_int as s16,
                                   cylHeight: 25 as libc::c_int as s16,
                                   mass: 0xff as libc::c_int as u8_0,};
        init
    };
static mut sDekuBabaDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (DEKUBABA_DMGEFF_DEKUNUT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_BOOMERANG as libc::c_int)
                                      << 4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (DEKUBABA_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (DEKUBABA_DMGEFF_SWORD as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (DEKUBABA_DMGEFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
// cannot kill.
static mut sBigDekuBabaDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDekubaba = thisx as *mut EnDekubaba;
    let mut i: s32 = 0;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 22.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gDekuBabaSkel,
                   &mut gDekuBabaFastChompAnim,
                   (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 8 as libc::c_int);
    Collider_InitJntSph(globalCtx, &mut (*this).collider);
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit,
                       (*this).colliderElements.as_mut_ptr());
    if (*this).actor.params as libc::c_int == DEKUBABA_BIG as libc::c_int {
        (*this).size = 2.5f32;
        i = 0 as libc::c_int;
        while i < sJntSphInit.count {
            let ref mut fresh0 =
                (*(*this).collider.elements.offset(i as
                                                       isize)).dim.modelSphere.radius;
            *fresh0 =
                (sJntSphElementsInit[i as usize].dim.modelSphere.radius as
                     libc::c_int as libc::c_float * 2.50f32) as s16;
            (*(*this).collider.elements.offset(i as
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            sBigDekuBabaDamageTable.table[0x1b as libc::c_int as usize] =
                (4 as libc::c_int |
                     (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                         4 as libc::c_int) as u8_0
            // DMG_JUMP_MASTER
        ...
        CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo,
                               &mut sBigDekuBabaDamageTable,
                               &mut sColChkInfoInit);
        (*this).actor.colChkInfo.health = 4 as libc::c_int as u8_0;
        (*this).actor.naviEnemyId = 0x8 as libc::c_int as u8_0;
        (*this).actor.targetMode = 2 as libc::c_int as s8
    } else {
        (*this).size = 1.0f32;
        i = 0 as libc::c_int;
        while i < sJntSphInit.count {
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            sDekuBabaDamageTable.table[0x1b as libc::c_int as usize] =
                (4 as libc::c_int |
                     (DEKUBABA_DMGEFF_NONE as libc::c_int) <<
                         4 as libc::c_int) as u8_0
            // DMG_JUMP_MASTER
        ...
        CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo,
                               &mut sDekuBabaDamageTable,
                               &mut sColChkInfoInit);
        (*this).actor.naviEnemyId = 0x7 as libc::c_int as u8_0;
        (*this).actor.targetMode = 1 as libc::c_int as s8
    }
    EnDekubaba_SetupWait(this);
    (*this).timer = 0 as libc::c_int as s16;
    (*this).boundFloor = 0 as *mut CollisionPoly;
    (*this).bodyPartsPos[3 as libc::c_int as usize] = (*this).actor.home.pos;
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnDekubaba = thisx as *mut EnDekubaba;
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DisableHitboxes(mut this:
                                                        *mut EnDekubaba) {
    let mut i: s32 = 0;
    i = 1 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 7]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElement>()
                                                   as libc::c_ulong) as s32 {
        let ref mut fresh1 =
            (*(*this).collider.elements.offset(i as isize)).info.bumperFlags;
        *fresh1 =
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupWait(mut this: *mut EnDekubaba) {
    let mut i: s32 = 0;
    let mut element: *mut ColliderJntSphElement =
        0 as *mut ColliderJntSphElement;
    (*this).actor.shape.rot.x = -(0x4000 as libc::c_int) as s16;
    (*this).stemSectionAngle[2 as libc::c_int as usize] =
        (*this).actor.shape.rot.x;
    (*this).stemSectionAngle[1 as libc::c_int as usize] =
        (*this).stemSectionAngle[2 as libc::c_int as usize];
    (*this).stemSectionAngle[0 as libc::c_int as usize] =
        (*this).stemSectionAngle[1 as libc::c_int as usize];
    (*this).actor.world.pos.x = (*this).actor.home.pos.x;
    (*this).actor.world.pos.z = (*this).actor.home.pos.z;
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y + 14.0f32 * (*this).size;
    Actor_SetScale(&mut (*this).actor, (*this).size * 0.01f32 * 0.5f32);
    (*this).collider.base.colType = COLTYPE_HARD as libc::c_int as u8_0;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 2 as libc::c_int) as u8_0;
    (*this).timer = 45 as libc::c_int as s16;
    i = 1 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 7]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElement>()
    ...
    (*this).actionFunc =
        Some(EnDekubaba_Wait as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupGrow(mut this: *mut EnDekubaba) {
    let mut i: s32 = 0;
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
                     Animation_GetLastFrame(&mut gDekuBabaFastChompAnim as
    ...
    (*this).timer = 15 as libc::c_int as s16;
    i = 2 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 7]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElement>()
                                                   as libc::c_ulong) as s32 {
        let ref mut fresh2 =
            (*(*this).collider.elements.offset(i as isize)).info.ocElemFlags;
        *fresh2 =
            (*fresh2 as libc::c_int | (1 as libc::c_int) << 0 as libc::c_int)
                as u8_0;
        i += 1
    }
    (*this).collider.base.colType = COLTYPE_HIT6 as libc::c_int as u8_0;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x39e2 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnDekubaba_Grow as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupRetract(mut this: *mut EnDekubaba) {
    let mut i: s32 = 0;
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
                     -1.5f32,
                     Animation_GetLastFrame(&mut gDekuBabaFastChompAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    (*this).timer = 15 as libc::c_int as s16;
    i = 2 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 7]>() as
    ...
    (*this).actionFunc =
        Some(EnDekubaba_Retract as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupDecideLunge(mut this:
                                                         *mut EnDekubaba) {
    (*this).timer =
        (Animation_GetLastFrame(&mut gDekuBabaFastChompAnim as
                                    *mut AnimationHeader as *mut libc::c_void)
             as libc::c_int * 2 as libc::c_int) as s16;
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
                          -3.0f32);
    (*this).actionFunc =
        Some(EnDekubaba_DecideLunge as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupPrepareLunge(mut this:
                                                          *mut EnDekubaba) {
    (*this).timer = 8 as libc::c_int as s16;
    (*this).skelAnime.playSpeed = 0.0f32;
    (*this).actionFunc =
        Some(EnDekubaba_PrepareLunge as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupLunge(mut this: *mut EnDekubaba) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gDekuBabaPauseChompAnim);
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDekubaba_Lunge as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupPullBack(mut this: *mut EnDekubaba) {
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaPauseChompAnim,
                     1.0f32, 15.0f32,
                     Animation_GetLastFrame(&mut gDekuBabaPauseChompAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDekubaba_PullBack as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupRecover(mut this: *mut EnDekubaba) {
    ...
    (*this).actionFunc =
        Some(EnDekubaba_Recover as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupHit(mut this: *mut EnDekubaba,
                                             mut arg1: s32) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gDekuBabaPauseChompAnim, -5.0f32);
    (*this).timer = arg1 as s16;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    Actor_SetScale(&mut (*this).actor, (*this).size * 0.01f32);
    if arg1 == 2 as libc::c_int {
    ...
    (*this).actionFunc =
        Some(EnDekubaba_Hit as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupPrunedSomersault(mut this:
                                                              *mut EnDekubaba) {
    (*this).timer = 0 as libc::c_int as s16;
    (*this).skelAnime.playSpeed = 0.0f32;
    (*this).actor.gravity = -0.8f32;
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actor.speedXZ = (*this).size * 3.0f32;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int |
             (1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnDekubaba_PrunedSomersault as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupShrinkDie(mut this:
                                                       *mut EnDekubaba) {
    Animation_Change(&mut (*this).skelAnime, &mut gDekuBabaFastChompAnim,
                     -1.5f32,
                     Animation_GetLastFrame(&mut gDekuBabaFastChompAnim as
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnDekubaba_ShrinkDie as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupStunnedVertical(mut this:
                                                             *mut EnDekubaba) {
    let mut i: s32 = 0;
    i = 1 as libc::c_int;
    while i <
        ...
        let ref mut fresh4 =
            (*(*this).collider.elements.offset(i as isize)).info.bumperFlags;
        *fresh4 =
            (*fresh4 as libc::c_int | (1 as libc::c_int) << 0 as libc::c_int)
                as u8_0;
        i += 1
    }
    ...
    (*this).actor.world.pos.x = (*this).actor.home.pos.x;
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y + 60.0f32 * (*this).size;
    (*this).actor.world.pos.z = (*this).actor.home.pos.z;
    (*this).actionFunc =
        Some(EnDekubaba_StunnedVertical as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupSway(mut this: *mut EnDekubaba) {
    (*this).targetSwayAngle = -(0x6000 as libc::c_int) as s16;
    (*this).stemSectionAngle[2 as libc::c_int as usize] =
        -(0x5000 as libc::c_int) as s16;
    (*this).stemSectionAngle[1 as libc::c_int as usize] =
        -(0x4800 as libc::c_int) as s16;
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnDekubaba_Sway as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_SetupDeadStickDrop(mut this:
                                                           *mut EnDekubaba,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    Actor_SetScale(&mut (*this).actor, 0.03f32);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int - 0x4000 as libc::c_int) as
            s16;
    (*this).actor.shape.yOffset = 1000.0f32;
    (*this).actor.gravity = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.shape.shadowScale = 3.0f32;
    ...
    (*this).actionFunc =
        Some(EnDekubaba_DeadStickDrop as
                 unsafe extern "C" fn(_: *mut EnDekubaba,
                                      _: *mut GlobalContext) -> ());
}
// Action functions
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Wait(mut this: *mut EnDekubaba,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           (*this).actor.xzDistToPlayer < 200.0f32 * (*this).size &&
           fabsf((*this).actor.yDistToPlayer) < 30.0f32 * (*this).size {
        EnDekubaba_SetupGrow(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Grow(mut this: *mut EnDekubaba,
                                         mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut headDistHorizontal: f32_0 = 0.;
    let mut headDistVertical: f32_0 = 0.;
    let mut headShiftX: f32_0 = 0.;
    let mut headShiftZ: f32_0 = 0.;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).actor.scale.z =
        (*this).size * 0.01f32 *
            (0.5f32 +
                 (15 as libc::c_int - (*this).timer as libc::c_int) as
                     libc::c_float * 0.5f32 / 15.0f32);
    ...
    headDistVertical =
        sinf((if (15 as libc::c_int - (*this).timer as libc::c_int) as
                     libc::c_float *
                     (1.0f32 / 15 as libc::c_int as libc::c_float) > 0.7f32 {
                  0.7f32
              } else {
                  ((15 as libc::c_int - (*this).timer as libc::c_int) as
                       libc::c_float) *
                      (1.0f32 / 15 as libc::c_int as libc::c_float)
              }) * 3.14159265358979323846f32) * 32.0f32 + 14.0f32;
    if ((*this).actor.shape.rot.x as libc::c_int) < -(0x38e3 as libc::c_int) {
        headDistHorizontal = 0.0f32
    } else if ((*this).actor.shape.rot.x as libc::c_int) <
                  -(0x238e as libc::c_int) {
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                           -(0x5555 as libc::c_int) as s16,
                           0x38e as libc::c_int as s16);
        headDistHorizontal =
            Math_CosS((*this).stemSectionAngle[0 as libc::c_int as usize]) *
                20.0f32
    } else if ((*this).actor.shape.rot.x as libc::c_int) <
                  -(0xe38 as libc::c_int) {
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                  ...
                                                                                  as
                                                                                  isize),
                           -(0xaaa as libc::c_int) as s16,
                           0x38e as libc::c_int as s16);
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                           -(0x5555 as libc::c_int) as s16,
                           0x38e as libc::c_int as s16);
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize),
                           -(0x5555 as libc::c_int) as s16,
                           0x222 as libc::c_int as s16);
        headDistHorizontal =
            20.0f32 *
                (Math_CosS((*this).stemSectionAngle[0 as libc::c_int as
                                                        usize]) +
                     Math_CosS((*this).stemSectionAngle[1 as libc::c_int as
                                                            usize])) +
                (headDistVertical -
                     20.0f32 *
                         (-Math_SinS((*this).stemSectionAngle[0 as libc::c_int
                                                                  as usize]) -
                              Math_SinS((*this).stemSectionAngle[1 as
                                                                     libc::c_int
                                                                     as
                                                                     usize])))
                    *
                    Math_CosS((*this).stemSectionAngle[2 as libc::c_int as
                                                           usize]) /
                    -Math_SinS((*this).stemSectionAngle[2 as libc::c_int as
                                                            usize])
    } else {
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                  as
    ...
    if ((*this).timer as libc::c_int) < 10 as libc::c_int {
        Math_ApproachS(&mut (*this).actor.shape.rot.y,
                       Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                                      &mut (*player).actor.world.pos),
                       2 as libc::c_int as s16, 0xe38 as libc::c_int as s16);
        (headShiftZ) != 0.;
        // One way of fake-matching
    }
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y + headDistVertical * (*this).size;
    headShiftX =
        headDistHorizontal * (*this).size *
            Math_SinS((*this).actor.shape.rot.y);
    headShiftZ =
        headDistHorizontal * (*this).size *
    ...
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.home.pos,
                             (*this).size * 3.0f32, 0 as libc::c_int as s16,
                             ((*this).size * 12.0f32) as s16,
                             ((*this).size * 5.0f32) as s16,
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        } else { EnDekubaba_SetupRetract(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Retract(mut this: *mut EnDekubaba,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut headDistHorizontal: f32_0 = 0.;
    let mut headDistVertical: f32_0 = 0.;
    let mut xShift: f32_0 = 0.;
        ...
        (*this).size * 0.01f32 *
            (0.5f32 +
                 (*this).timer as libc::c_int as libc::c_float *
                     (1.0f32 / 30 as libc::c_int as libc::c_float));
    (*this).actor.scale.y = (*this).actor.scale.z;
    (*this).actor.scale.x = (*this).actor.scale.y;
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
    ...
    headDistVertical =
        sinf((if (*this).timer as libc::c_int as libc::c_float * 0.033f32 >
                     0.7f32 {
                  0.7f32
              } else {
                  ((*this).timer as libc::c_int as libc::c_float) * 0.033f32
              }) * 3.14159265358979323846f32) * 32.0f32 + 14.0f32;
    if ((*this).actor.shape.rot.x as libc::c_int) < -(0x38e3 as libc::c_int) {
        headDistHorizontal = 0.0f32
    } else if ((*this).actor.shape.rot.x as libc::c_int) <
    ...
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.home.pos,
                             ...
                             1 as libc::c_int as s16,
                             -(1 as libc::c_int) as s16,
                             0xa as libc::c_int as s16, 0 as *mut Gfx);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        EnDekubaba_SetupWait(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_UpdateHeadPosition(mut this:
                                                           *mut EnDekubaba) {
    let mut horizontalHeadShift: f32_0 =
        (Math_CosS((*this).stemSectionAngle[0 as libc::c_int as usize]) +
             Math_CosS((*this).stemSectionAngle[1 as libc::c_int as usize]) +
             Math_CosS((*this).stemSectionAngle[2 as libc::c_int as usize])) *
            20.0f32;
    (*this).actor.world.pos.x =
        (*this).actor.home.pos.x +
            Math_SinS((*this).actor.shape.rot.y) *
                (horizontalHeadShift * (*this).size);
    (*this).actor.world.pos.y =
        (*this).actor.home.pos.y -
            (Math_SinS((*this).stemSectionAngle[0 as libc::c_int as usize]) +
                 Math_SinS((*this).stemSectionAngle[1 as libc::c_int as
                                                        usize]) +
                 Math_SinS((*this).stemSectionAngle[2 as libc::c_int as
                                                        usize])) * 20.0f32 *
                (*this).size;
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DecideLunge(mut this: *mut EnDekubaba,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 12.0f32) != 0 {
        if (*this).actor.params as libc::c_int == DEKUBABA_BIG as libc::c_int
           {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x385c as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3860 as libc::c_int as u16_0);
        }
    }
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
                   ...
                   ((*this).timer as libc::c_int % 5 as libc::c_int *
                        0x222 as libc::c_int) as s16);
    if ((*this).timer as libc::c_int) < 10 as libc::c_int {
        (*this).stemSectionAngle[0 as libc::c_int as usize] =
            ((*this).stemSectionAngle[0 as libc::c_int as usize] as
                 libc::c_int + 0x16c as libc::c_int) as s16;
        (*this).stemSectionAngle[1 as libc::c_int as usize] =
            ((*this).stemSectionAngle[1 as libc::c_int as usize] as
                 libc::c_int + 0x16c as libc::c_int) as s16;
        (*this).stemSectionAngle[2 as libc::c_int as usize] =
            ((*this).stemSectionAngle[2 as libc::c_int as usize] as
                 libc::c_int + 0xb6 as libc::c_int) as s16;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int + 0x222 as libc::c_int)
                as s16
        ...
        (*this).stemSectionAngle[1 as libc::c_int as usize] =
            ((*this).stemSectionAngle[1 as libc::c_int as usize] as
                 libc::c_int + 0x111 as libc::c_int) as s16;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int + 0x16c as libc::c_int)
                as s16
        ...
        (*this).stemSectionAngle[1 as libc::c_int as usize] =
            ((*this).stemSectionAngle[1 as libc::c_int as usize] as
                 libc::c_int - 0x111 as libc::c_int) as s16;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int - 0xb6 as libc::c_int)
                as s16
    } else {
        (*this).stemSectionAngle[1 as libc::c_int as usize] =
            ((*this).stemSectionAngle[1 as libc::c_int as usize] as
    ...
    if 240.0f32 * (*this).size <
           Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                             &mut (*player).actor.world.pos) {
        EnDekubaba_SetupRetract(this);
    } else if (*this).timer as libc::c_int == 0 as libc::c_int ||
                  (*this).actor.xzDistToPlayer < 80.0f32 * (*this).size {
        EnDekubaba_SetupPrepareLunge(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Lunge(mut this: *mut EnDekubaba,
                                          mut globalCtx: *mut GlobalContext) {
    static mut primColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 105 as libc::c_int as u8_0,
                            g: 255 as libc::c_int as u8_0,
                            b: 105 as libc::c_int as u8_0,
    ...
    let mut allStepsDone: s32 = 0;
    let mut curFrame10: s16 = 0;
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if Animation_OnFrame(&mut (*this).skelAnime, 1.0f32) != 0 {
            if (*this).actor.params as libc::c_int ==
                   DEKUBABA_BIG as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x385d as libc::c_int as u16_0);
            } else {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3861 as libc::c_int as u16_0);
            }
        }
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           0 as libc::c_int as s16,
                           0x222 as libc::c_int as s16);
        curFrame10 = ((*this).skelAnime.curFrame * 10.0f32) as s16;
        allStepsDone = 1 as libc::c_int;
        allStepsDone &=
            Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                      as
                                                                                      libc::c_int
        ...
        allStepsDone &=
            Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                               ...
                               (curFrame10 as libc::c_int +
                                    0xe38 as libc::c_int) as s16);
        if allStepsDone != 0 {
            Animation_PlayLoopSetSpeed(&mut (*this).skelAnime,
                                       &mut gDekuBabaFastChompAnim, 4.0f32);
            velocity.x = Math_SinS((*this).actor.shape.rot.y) * 5.0f32;
            velocity.y = 0.0f32;
            velocity.z = Math_CosS((*this).actor.shape.rot.y) * 5.0f32;
            func_8002829C(globalCtx, &mut (*this).actor.world.pos,
                          &mut velocity, &mut sZeroVec, &mut primColor,
                          &mut envColor, 1 as libc::c_int as s16,
                          ((*this).size * 100.0f32) as s16);
            (*this).timer = 1 as libc::c_int as s16;
            (*this).collider.base.acFlags =
                ((*this).collider.base.acFlags as libc::c_int |
                     (1 as libc::c_int) << 0 as libc::c_int) as u8_0
        }
    } else if (*this).timer as libc::c_int > 10 as libc::c_int {
        EnDekubaba_SetupPullBack(this);
    } else {
        (*this).timer += 1;
        if (*this).timer as libc::c_int >= 4 as libc::c_int &&
               Actor_IsFacingPlayer(&mut (*this).actor,
                                    0x16c as libc::c_int as s16) == 0 {
            Math_ApproachS(&mut (*this).actor.shape.rot.y,
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_PrepareLunge(mut this: *mut EnDekubaba,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       0x1800 as libc::c_int as s16, 2 as libc::c_int as s16,
                       0xe38 as libc::c_int as s16,
                       0x71c as libc::c_int as s16);
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
                   Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                                  &mut (*player).actor.world.pos),
                   2 as libc::c_int as s16, 0xe38 as libc::c_int as s16);
    Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
                       0xaaa as libc::c_int as s16,
                       0x444 as libc::c_int as s16);
    Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
                       -(0x4718 as libc::c_int) as s16,
                       0x888 as libc::c_int as s16);
    Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2 as
                                                                              libc::c_int
                                                                              as
                                                                              isize),
                       -(0x6aa4 as libc::c_int) as s16,
                       0x888 as libc::c_int as s16);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_PullBack(mut this: *mut EnDekubaba,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut xIncr: f32_0 = 0.;
    let mut zIncr: f32_0 = 0.;
    let mut i: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           -(0x93e as libc::c_int) as s16,
                           0x38e as libc::c_int as s16);
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                  as
                                                                                  libc::c_int
        ...
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                           ...
                           -(0x888 as libc::c_int) as s16,
                           0x16c as libc::c_int as s16);
        if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize),
                              ...
                              0x16c as libc::c_int as s16) != 0 {
            xIncr =
                Math_SinS((*this).actor.shape.rot.y) * 30.0f32 * (*this).size;
            zIncr =
                Math_CosS((*this).actor.shape.rot.y) * 30.0f32 * (*this).size;
            dustPos = (*this).actor.home.pos;
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                func_800286CC(globalCtx, &mut dustPos, &mut sZeroVec,
                              &mut sZeroVec, ((*this).size * 500.0f32) as s16,
                              ((*this).size * 50.0f32) as s16);
                dustPos.x += xIncr;
                dustPos.z += zIncr;
                i += 1
            }
    ...
    } else if (*this).timer as libc::c_int == 11 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           -(0x93e as libc::c_int) as s16,
        ...
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                  ...
                                                                                  as
                                                                                  isize),
                           -(0x5c71 as libc::c_int) as s16,
                           0x200 as libc::c_int as s16);
        if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize),
                              0x238c as libc::c_int as s16,
                              0x200 as libc::c_int as s16) != 0 {
            (*this).timer = 12 as libc::c_int as s16
        }
    } else if (*this).timer as libc::c_int == 18 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           0x2aa8 as libc::c_int as s16,
                           0xaaa as libc::c_int as s16);
        if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize),
                              0x1554 as libc::c_int as s16,
                              0x5b0 as libc::c_int as s16) != 0 {
            (*this).timer = 25 as libc::c_int as s16
        }
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
        ...
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                  ...
                                                                                  isize),
                           -(0x5c71 as libc::c_int) as s16,
                           0x2d8 as libc::c_int as s16);
    } else if (*this).timer as libc::c_int == 25 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           -(0x5550 as libc::c_int) as s16,
                           0xaaa as libc::c_int as s16);
        if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     isize),
                              -(0x6388 as libc::c_int) as s16,
                              0x93e as libc::c_int as s16) != 0 {
            (*this).timer = 26 as libc::c_int as s16
        }
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
        ...
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                           ...
                           -(0x238c as libc::c_int) as s16,
                           0x444 as libc::c_int as s16);
    } else if (*this).timer as libc::c_int == 26 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           0x1800 as libc::c_int as s16,
                           0x93e as libc::c_int as s16);
        if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                     ...
                                                                                     as
                                                                                     isize),
                              -(0x1555 as libc::c_int) as s16,
                              0x71c as libc::c_int as s16) != 0 {
            (*this).timer = 27 as libc::c_int as s16
        }
        Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
    ...
    } else if (*this).timer as libc::c_int >= 27 as libc::c_int {
        (*this).timer += 1;
        if (*this).timer as libc::c_int > 30 as libc::c_int {
            if (*this).actor.xzDistToPlayer < 80.0f32 * (*this).size {
                EnDekubaba_SetupPrepareLunge(this);
            } else { EnDekubaba_SetupDecideLunge(this); }
        }
    } else {
        (*this).timer += 1;
        if (*this).timer as libc::c_int == 10 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3863 as libc::c_int as u16_0);
        }
        if (*this).timer as libc::c_int >= 12 as libc::c_int {
            Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize),
                               -(0x5c71 as libc::c_int) as s16,
                               0x88 as libc::c_int as s16);
        }
    }
    EnDekubaba_UpdateHeadPosition(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Recover(mut this: *mut EnDekubaba,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut anyStepsDone: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int > 8 as libc::c_int {
        anyStepsDone =
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                               0x1800 as libc::c_int as s16,
                               1 as libc::c_int as s16,
                               0x11c6 as libc::c_int as s16,
                               0x71c as libc::c_int as s16) as s32;
        anyStepsDone |=
            Math_SmoothStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(0
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize),
                               ...
                               1 as libc::c_int as s16,
                               0xaaa as libc::c_int as s16,
                               0x71c as libc::c_int as s16) as libc::c_int;
        anyStepsDone |=
            Math_SmoothStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize),
                               ...
                               0x71c as libc::c_int as s16) as libc::c_int;
        anyStepsDone |=
            Math_SmoothStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      isize),
                               ...
                               0x11c6 as libc::c_int as s16,
                               0x71c as libc::c_int as s16) as libc::c_int;
        if anyStepsDone == 0 { (*this).timer = 8 as libc::c_int as s16 }
    } else {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Hit(mut this: *mut EnDekubaba,
                                        mut globalCtx: *mut GlobalContext) {
    let mut allStepsDone: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    allStepsDone = 1 as libc::c_int;
        ...
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            ...
            if (*this).timer as libc::c_int == 0 as libc::c_int {
                if (*this).actor.xzDistToPlayer < 80.0f32 * (*this).size {
                    EnDekubaba_SetupPrepareLunge(this);
                } else { EnDekubaba_SetupRecover(this); }
            } else { EnDekubaba_SetupStunnedVertical(this); }
        }
    }
    EnDekubaba_UpdateHeadPosition(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_StunnedVertical(mut this: *mut EnDekubaba,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Sway(mut this: *mut EnDekubaba,
                                         mut globalCtx: *mut GlobalContext) {
    let mut angleToVertical: s16 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       (*this).stemSectionAngle[0 as libc::c_int as usize],
                       0x71c as libc::c_int as s16);
    ...
    if Math_ScaledStepToS(&mut *(*this).stemSectionAngle.as_mut_ptr().offset(2
                                                                                 ...
                                                                                 as
                                                                                 isize),
                          (*this).targetSwayAngle,
                          0x71c as libc::c_int as s16) != 0 {
        (*this).targetSwayAngle =
            (-(0x4000 as libc::c_int) as libc::c_float -
                 ((*this).targetSwayAngle as libc::c_int +
                      0x4000 as libc::c_int) as libc::c_float * 0.8f32) as s16
    }
    angleToVertical =
        ((*this).targetSwayAngle as libc::c_int + 0x4000 as libc::c_int) as
            s16;
    if (if angleToVertical as libc::c_int >= 0 as libc::c_int {
            angleToVertical as libc::c_int
        } else { -(angleToVertical as libc::c_int) }) < 0x100 as libc::c_int {
        (*this).collider.base.acFlags =
            ((*this).collider.base.acFlags as libc::c_int |
                 (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
        if (*this).actor.xzDistToPlayer < 80.0f32 * (*this).size {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_PrunedSomersault(mut this:
                                                         *mut EnDekubaba,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, (*this).size * 0.1f32);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                           0x4800 as libc::c_int as s16,
                           0x71c as libc::c_int as s16);
        ...
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
                                 ...
                                 -(1 as libc::c_int) as s16,
                                 10 as libc::c_int as s16, 0 as *mut Gfx);
        if (*this).actor.scale.x > 0.005f32 &&
    ...
    } else if (*this).timer as libc::c_int == 1 as libc::c_int {
        dustPos = (*this).actor.world.pos;
        deltaY = 20.0f32 * Math_SinS((*this).actor.shape.rot.x);
        deltaX =
            -20.0f32 * Math_CosS((*this).actor.shape.rot.x) *
                Math_SinS((*this).actor.shape.rot.y);
        deltaZ =
            -20.0f32 * Math_CosS((*this).actor.shape.rot.x) *
                Math_CosS((*this).actor.shape.rot.y);
        ...
        while i < 4 as libc::c_int {
            func_800286CC(globalCtx, &mut dustPos, &mut sZeroVec,
                          &mut sZeroVec, 500 as libc::c_int as s16,
        ...
        func_800286CC(globalCtx, &mut (*this).actor.home.pos, &mut sZeroVec,
                      &mut sZeroVec, ((*this).size * 500.0f32) as s16,
                      ((*this).size * 100.0f32) as s16);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_ShrinkDie(mut this: *mut EnDekubaba,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Math_StepToF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                 (*this).size * 5.0f32);
    if Math_StepToF(&mut (*this).actor.scale.x,
                    (*this).size * 0.1f32 * 0.01f32,
                    (*this).size * 0.1f32 * 0.01f32) != 0 {
        func_800286CC(globalCtx, &mut (*this).actor.home.pos, &mut sZeroVec,
                      &mut sZeroVec, ((*this).size * 500.0f32) as s16,
                      ((*this).size * 100.0f32) as s16);
        if (*this).actor.dropFlag as libc::c_int == 0 as libc::c_int {
            Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                                 ITEM00_NUTS as libc::c_int as s16);
            if (*this).actor.params as libc::c_int ==
                   DEKUBABA_BIG as libc::c_int {
                Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                                     ITEM00_NUTS as libc::c_int as s16);
    ...
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_int + 0x1c70 as libc::c_int) as
            s16;
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.home.pos,
                             (*this).size * 3.0f32, 0 as libc::c_int as s16,
                             ((*this).size * 12.0f32) as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DeadStickDrop(mut this: *mut EnDekubaba,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    ...
    func_8002F554(&mut (*this).actor, globalCtx, GI_STICKS_1 as libc::c_int);
}
// Update and associated functions
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_UpdateDamage(mut this: *mut EnDekubaba,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut firePos: *mut Vec3f =
        0 as *mut Vec3f; // Used for both health and iterator
    let mut fireScale: f32_0 = 0.;
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        Actor_SetDropFlagJntSph(&mut (*this).actor, &mut (*this).collider,
                                1 as libc::c_int);
        if (*this).collider.base.colType as libc::c_int !=
            ...
            if (*this).actionFunc !=
                                                 ...
                                                 _: *mut GlobalContext) -> ())
               {
                if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                    ...
                    if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                           DEKUBABA_DMGEFF_BOOMERANG as libc::c_int {
                        phi_s0 = (*this).actor.colChkInfo.health as s32
                    }
                    EnDekubaba_SetupHit(this, 2 as libc::c_int);
                    ...
                    EnDekubaba_SetupHit(this, 1 as libc::c_int);
                } else { EnDekubaba_SetupHit(this, 0 as libc::c_int); }
                ...
                } else { EnDekubaba_SetupPrunedSomersault(this); }
            } else if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
                          DEKUBABA_DMGEFF_DEKUNUT as libc::c_int {
                EnDekubaba_SetupHit(this, 0 as libc::c_int);
            } else { return }
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   DEKUBABA_DMGEFF_FIRE as libc::c_int {
                firePos = &mut (*this).actor.world.pos;
                fireScale = (*this).size * 70.0f32;
                phi_s0 = 0 as libc::c_int;
                while phi_s0 < 4 as libc::c_int {
                    EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                              firePos, fireScale as s16,
                                              0 as libc::c_int as s16,
                                              0 as libc::c_int as s16,
                                              phi_s0 as s16);
                    phi_s0 += 1
    ...
    } else if (*globalCtx).actorCtx.unk_02 as libc::c_int != 0 as libc::c_int
                  &&
                  (*this).collider.base.colType as libc::c_int !=
                      COLTYPE_HARD as libc::c_int &&
                  (*this).actionFunc !=
                      Some(EnDekubaba_StunnedVertical as
                               unsafe extern "C" fn(_: *mut EnDekubaba,
        ...
        (*this).actor.dropFlag = 0 as libc::c_int as u8_0;
        EnDekubaba_SetupHit(this, 1 as libc::c_int);
    } else { return }
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).actor.params as libc::c_int == DEKUBABA_BIG as libc::c_int
           {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x385f as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3862 as libc::c_int as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDekubaba = thisx as *mut EnDekubaba;
...
// Draw functions
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DrawStemRetracted(mut this:
                                                          *mut EnDekubaba,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut horizontalScale: f32_0 = 0.;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dekubaba.c\x00" as *const u8 as
                        *const libc::c_char, 2445 as libc::c_int);
    horizontalScale = (*this).size * 0.01f32;
    Matrix_Translate((*this).actor.home.pos.x,
                     (*this).actor.home.pos.y + -6.0f32 * (*this).size,
                     (*this).actor.home.pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateZYX((*this).stemSectionAngle[0 as libc::c_int as usize],
                     (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(horizontalScale, horizontalScale, horizontalScale,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      ...
                      2461 as libc::c_int) as libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gDekuBabaStemTopDL.as_mut_ptr() as libc::c_uint;
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dekubaba.c\x00" as *const u8 as
                         *const libc::c_char, 2468 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DrawStemExtended(mut this:
                                                         *mut EnDekubaba,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut stemDLists: [*mut Gfx; 3] =
        unsafe {
            [gDekuBabaStemTopDL.as_ptr() as *mut _,
             gDekuBabaStemMiddleDL.as_ptr() as *mut _,
             gDekuBabaStemBaseDL.as_ptr() as *mut _]
        };
    let mut mtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut i: s32 = 0;
    let mut horizontalStepSize: f32_0 = 0.;
    let mut spA4: f32_0 = 0.;
    let mut scale: f32_0 = 0.;
    let mut stemSections: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dekubaba.c\x00" as *const u8 as
                        *const libc::c_char, 2487 as libc::c_int);
    if (*this).actionFunc ==
           Some(EnDekubaba_PrunedSomersault as
                    unsafe extern "C" fn(_: *mut EnDekubaba,
                                         _: *mut GlobalContext) -> ()) {
        stemSections = 2 as libc::c_int
    } else { stemSections = 3 as libc::c_int }
    scale = (*this).size * 0.01f32;
    ...
    if (*this).actor.colorFilterTimer as libc::c_int != 0 as libc::c_int {
        spA4 = (*this).size * 20.0f32;
        (*this).bodyPartsPos[2 as libc::c_int as usize].x =
            (*this).actor.world.pos.x;
        (*this).bodyPartsPos[2 as libc::c_int as usize].y =
            (*this).actor.world.pos.y - spA4;
        (*this).bodyPartsPos[2 as libc::c_int as usize].z =
            (*this).actor.world.pos.z
    }
    i = 0 as libc::c_int;
    while i < stemSections {
        mtx.c2rust_unnamed.yw +=
            20.0f32 * Math_SinS((*this).stemSectionAngle[i as usize]) *
                (*this).size;
        horizontalStepSize =
            20.0f32 * Math_CosS((*this).stemSectionAngle[i as usize]) *
                (*this).size;
        mtx.c2rust_unnamed.xw -=
            horizontalStepSize * Math_SinS((*this).actor.shape.rot.y);
        mtx.c2rust_unnamed.zw -=
            horizontalStepSize * Math_CosS((*this).actor.shape.rot.y);
        Matrix_Put(&mut mtx);
        Matrix_RotateZYX((*this).stemSectionAngle[i as usize],
                         (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = stemDLists[i as usize] as libc::c_uint;
        Collider_UpdateSpheres(51 as libc::c_int + 2 as libc::c_int * i,
                               &mut (*this).collider);
        Collider_UpdateSpheres(52 as libc::c_int + 2 as libc::c_int * i,
                               &mut (*this).collider);
            ...
            if (*this).actionFunc !=
                   Some(EnDekubaba_Sway as
                            unsafe extern "C" fn(_: *mut EnDekubaba,
                                                 _: *mut GlobalContext) -> ())
               {
                (*this).actor.focus.pos.x = mtx.c2rust_unnamed.xw;
                (*this).actor.focus.pos.y = mtx.c2rust_unnamed.yw;
                (*this).actor.focus.pos.z = mtx.c2rust_unnamed.zw
            } else {
                (*this).actor.focus.pos.x = (*this).actor.home.pos.x;
                (*this).actor.focus.pos.y =
                    (*this).actor.home.pos.y + 40.0f32 * (*this).size;
        ...
        if i < 2 as libc::c_int &&
            ...
            (*this).bodyPartsPos[i as usize].x = mtx.c2rust_unnamed.xw;
            (*this).bodyPartsPos[i as usize].y = mtx.c2rust_unnamed.yw - spA4;
            (*this).bodyPartsPos[i as usize].z = mtx.c2rust_unnamed.zw
        }
        i += 1
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dekubaba.c\x00" as *const u8 as
                         *const libc::c_char, 2569 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DrawStemBasePruned(mut this:
                                                           *mut EnDekubaba,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dekubaba.c\x00" as *const u8 as
                        *const libc::c_char, 2579 as libc::c_int);
    Matrix_RotateZYX((*this).stemSectionAngle[2 as libc::c_int as usize],
                     (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_dekubaba.c\x00" as *const u8 as
                          *const libc::c_char as *mut libc::c_char,
                      2586 as libc::c_int) as libc::c_uint;
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gDekuBabaStemBaseDL.as_mut_ptr() as libc::c_uint;
    Collider_UpdateSpheres(55 as libc::c_int, &mut (*this).collider);
    Collider_UpdateSpheres(56 as libc::c_int, &mut (*this).collider);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dekubaba.c\x00" as *const u8 as
                         *const libc::c_char, 2596 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_DrawBaseShadow(mut this: *mut EnDekubaba,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut mtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut horizontalScale: f32_0 = 0.;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dekubaba.c\x00" as *const u8 as
                        *const libc::c_char, 2692 as libc::c_int);
    ...
    (*_g).words.w1 =
        (0 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    func_80038A28((*this).boundFloor, (*this).actor.home.pos.x,
                  (*this).actor.home.pos.y, (*this).actor.home.pos.z,
                  &mut mtx);
    Matrix_Mult(&mut mtx, MTXMODE_NEW as libc::c_int as u8_0);
    horizontalScale = (*this).size * 0.15f32;
    Matrix_Scale(horizontalScale, 1.0f32, horizontalScale,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_0).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_dekubaba.c\x00" as *const u8 as
                          *const libc::c_char as *mut libc::c_char,
                      2710 as libc::c_int) as libc::c_uint;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dekubaba.c\x00" as *const u8 as
                         *const libc::c_char, 2715 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnDekubaba_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDekubaba = thisx as *mut EnDekubaba;
    let mut scale: f32_0 = 0.;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dekubaba.c\x00" as *const u8 as
                        *const libc::c_char, 2752 as libc::c_int);
    ...
    if (*this).actionFunc !=
        ...
        SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnDekubaba_PostLimbDraw as
        ...
        } else { EnDekubaba_DrawStemExtended(this, globalCtx); }
        scale = (*this).size * 0.01f32;
        Matrix_Translate((*this).actor.home.pos.x, (*this).actor.home.pos.y,
                         (*this).actor.home.pos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_RotateY((*this).actor.home.rot.y as libc::c_int as
                           libc::c_float *
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gDekuBabaBaseLeavesDL.as_mut_ptr() as libc::c_uint;
        if (*this).actionFunc ==
               Some(EnDekubaba_PrunedSomersault as
                        unsafe extern "C" fn(_: *mut EnDekubaba,
                                             _: *mut GlobalContext) -> ()) {
    ...
    } else if (*this).timer as libc::c_int > 40 as libc::c_int ||
                  (*this).timer as libc::c_int % 2 as libc::c_int !=
                      0 as libc::c_int {
        Matrix_Translate(0.0f32, 0.0f32, 200.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_1).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_dekubaba.c\x00" as *const u8 as
                              *const libc::c_char as *mut libc::c_char,
                          2797 as libc::c_int) as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = gDekuBabaStickDropDL.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_dekubaba.c\x00" as *const u8 as
                         *const libc::c_char, 2804 as libc::c_int);
}
