...
extern "C" {
    ...
    #[no_mangle]
    static mut gBirdFlyAnim: AnimationHeader;
    #[no_mangle]
    static mut gBirdSkel: SkeletonHeader;
}
...
pub struct EnBird {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnBirdActionFunc,
    pub unk_194: u32_0,
    pub unk_198: s32,
    pub unk_19C: s16,
    pub unk_19E: [libc::c_char; 2],
    pub unk_1A0: f32_0,
    pub unk_1A4: f32_0,
    pub unk_1A8: f32_0,
    pub unk_1AC: f32_0,
    ...
    pub unk_1BC: f32_0,
    pub unk_1C0: s16,
    pub unk_1C2: [libc::c_char; 26],
}
pub type EnBirdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBird, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Bird_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BIRD as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_BIRD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBird>() as
                                  libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnBird_SetupAction(mut this: *mut EnBird,
                                            mut actionFunc:
                                                EnBirdActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBird_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBird = thisx as *mut EnBird;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 0.01f64 as f32_0);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gBirdSkel,
                   &mut gBirdFlyAnim, 0 as *mut Vec3s, 0 as *mut Vec3s,
                   0 as libc::c_int);
    ActorShape_Init(&mut (*this).actor.shape, 5500 as libc::c_int as f32_0,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 4 as libc::c_int as f32_0);
    (*this).unk_194 = 0 as libc::c_int as u32_0;
    (*this).unk_198 = 0 as libc::c_int;
    (*this).unk_1C0 = 0x9c4 as libc::c_int as s16;
    ...
    (*this).unk_1A4 = 0.0f32;
    (*this).unk_1B8 = 0.0f32;
    (*this).unk_1B0 = 40.0f32;
    (*this).unk_1BC = 70.0f32;
    func_809C1CAC(this, (*this).actor.params);
}
#[no_mangle]
pub unsafe extern "C" fn EnBird_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_809C1CAC(mut this: *mut EnBird,
                                       mut params: s16) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gBirdFlyAnim as *mut AnimationHeader as
                                   *mut libc::c_void) as f32_0;
    let mut playbackSpeed: f32_0 =
        if (*this).unk_19C as libc::c_int != 0 { 0.0f32 } else { 1.0f32 };
    let mut anim: *mut AnimationHeader = &mut gBirdFlyAnim;
    (*this).unk_198 =
        Rand_S16Offset(5 as libc::c_int as s16, 0x23 as libc::c_int as s16) as
            s32;
    Animation_Change(&mut (*this).skelAnime, anim, playbackSpeed, 0.0f32,
                     frameCount, ANIMMODE_LOOP as libc::c_int as u8_0,
                     0.0f32);
    EnBird_SetupAction(this,
                       Some(func_809C1D60 as
                                unsafe extern "C" fn(_: *mut EnBird,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809C1D60(mut this: *mut EnBird,
                                       mut globalCtx: *mut GlobalContext) {
    let mut fVar2: f32_0 = sinf((*this).unk_1B4);
    (*this).actor.shape.yOffset =
        (*this).actor.shape.yOffset + fVar2 * (*this).unk_1A0;
    ...
    (*this).unk_198 -= 1 as libc::c_int;
    if (*this).unk_198 <= 0 as libc::c_int {
        func_809C1E00(this, (*this).actor.params);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809C1E00(mut this: *mut EnBird,
                                       mut params: s16) {
    (*this).unk_198 =
        Rand_S16Offset(0x14 as libc::c_int as s16, 0x2d as libc::c_int as s16)
            as s32;
    EnBird_SetupAction(this,
                       Some(func_809C1E40 as
                                unsafe extern "C" fn(_: *mut EnBird,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809C1E40(mut this: *mut EnBird,
                                       mut globalCtx: *mut GlobalContext) {
    let mut fVar4: f32_0 = sinf((*this).unk_1B4);
    (*this).actor.shape.yOffset += fVar4 * (*this).unk_1A0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).unk_1A8, 0.1f32,
                       (*this).unk_1AC, 0.0f32);
    if (*this).unk_1B0 <
           Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
                             &mut (*this).actor.home.pos) ||
           (*this).unk_198 < 4 as libc::c_int {
        ...
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int +
                 (fVar4 * (*this).unk_1A4) as s16 as libc::c_int) as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnBird_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBird = thisx as *mut EnBird;
...
#[no_mangle]
pub unsafe extern "C" fn EnBird_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBird = thisx as *mut EnBird;
