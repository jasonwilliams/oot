...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleStationaryFlamethrowerTallDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStationaryFlamethrowerShortDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStationaryFlamethrowerShortCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleStationaryFlamethrowerTallCol: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleFireballDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleFireball0Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gFireTempleFireball7Tex: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanSekizou {
    pub dyna: DynaPolyActor,
    pub updateFunc: BgHidanSekizouUpdateFunc,
    pub unk_168: [s16; 4],
    pub unk_170: s16,
    pub collider: ColliderJntSph,
    pub elements: [ColliderJntSphElement; 6],
}
pub type BgHidanSekizouUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanSekizou, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Sekizou_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_SEKIZOU as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanSekizou>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSekizou_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSekizou_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSekizou_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSekizou_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sJntSphElementsInit: [ColliderJntSphElementInit; 6] =
    [{
         let mut init =
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 1 as libc::c_int as u8_0,
                                   cylRadius: 40 as libc::c_int as s16,
                                   cylHeight: 240 as libc::c_int as s16,
...
static mut sFireballsTexs: [*mut libc::c_void; 8] =
    unsafe {
        [gFireTempleFireball0Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball4Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball5Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball6Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gFireTempleFireball7Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn func_8088CEC0(mut this: *mut BgHidanSekizou,
                                       mut arg1: s32, mut arg2: s16) {
    let mut i: s32 = 0;
    let mut start: s32 = arg1 * 3 as libc::c_int;
    let mut end: s32 = start + 3 as libc::c_int;
    let mut sp30: f32_0 = Math_SinS(arg2);
    let mut sp2C: f32_0 = Math_CosS(arg2);
    i = start;
    while i < end {
        ...
        (*element).dim.worldSphere.center.x =
            ((*this).dyna.actor.home.pos.x +
                 sp2C *
                     (*element).dim.modelSphere.center.x as libc::c_int as
                         libc::c_float +
                 sp30 *
                     (*element).dim.modelSphere.center.z as libc::c_int as
                         libc::c_float) as s16;
        (*element).dim.worldSphere.center.y =
            ((*this).dyna.actor.home.pos.y as s16 as libc::c_int +
                 (*element).dim.modelSphere.center.y as libc::c_int) as s16;
        (*element).dim.worldSphere.center.z =
            ((*this).dyna.actor.home.pos.z -
                 ...
                 sp2C *
                     (*element).dim.modelSphere.center.z as libc::c_int as
                         libc::c_float) as s16;
        (*element).info.toucherFlags =
            ((*element).info.toucherFlags as libc::c_int |
                 (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
        (*element).info.ocElemFlags =
            ((*element).info.ocElemFlags as libc::c_int |
                 (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSekizou_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanSekizou = thisx as *mut BgHidanSekizou;
    let mut i: s32 = 0;
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 6]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElement>()
                                                   as libc::c_ulong) as s32 {
        (*(*this).collider.elements.offset(i as isize)).dim.worldSphere.radius
            =
            (*(*this).collider.elements.offset(i as
                                                   isize)).dim.modelSphere.radius;
        i += 1
    }
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        (*this).unk_168[0 as libc::c_int as usize] = 36 as libc::c_int as s16;
        i = 0 as libc::c_int;
        while i < 2 as libc::c_int {
            func_8088CEC0(this, i,
                          ((*this).dyna.actor.shape.rot.y as libc::c_int +
                               (if i == 0 as libc::c_int {
                                    0x2000 as libc::c_int
                                } else { -(0x2000 as libc::c_int) })) as s16);
            i += 1
        }
        CollisionHeader_GetVirtual(&mut gFireTempleStationaryFlamethrowerShortCol
                                       as *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).updateFunc =
            Some(func_8088D720 as
                     unsafe extern "C" fn(_: *mut BgHidanSekizou,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).unk_168[3 as libc::c_int as usize] = 0 as libc::c_int as s16;
        (*this).unk_168[2 as libc::c_int as usize] =
            (*this).unk_168[3 as libc::c_int as usize];
        (*this).unk_168[1 as libc::c_int as usize] =
            (*this).unk_168[2 as libc::c_int as usize];
        (*this).unk_168[0 as libc::c_int as usize] =
            (*this).unk_168[1 as libc::c_int as usize];
        CollisionHeader_GetVirtual(&mut gFireTempleStationaryFlamethrowerTallCol
                                       as *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).updateFunc =
            Some(func_8088D434 as
                     unsafe extern "C" fn(_: *mut BgHidanSekizou,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).unk_170 = 0 as libc::c_int as s16;
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, colHeader);
    CollisionCheck_SetInfo(&mut (*this).dyna.actor.colChkInfo,
                           0 as *mut DamageTable, &mut sColChkInfoInit);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSekizou_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx2:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8088D434(mut this: *mut BgHidanSekizou,
    ...
    let mut i: s32 = 0;
    let mut isAligned: [s32; 2] = [0; 2];
    let mut isClose: s32 = 0;
    let mut phi_s4: s32 = 0;
    isClose = ((*this).dyna.actor.xzDistToPlayer < 300.0f32) as libc::c_int;
    isAligned[0 as libc::c_int as usize] =
        (fabsf((*this).dyna.actor.world.pos.x - (*player).actor.world.pos.x) <
             80.0f32) as libc::c_int;
    isAligned[1 as libc::c_int as usize] =
        (fabsf((*this).dyna.actor.world.pos.z - (*player).actor.world.pos.z) <
             80.0f32) as libc::c_int;
    phi_s4 = 0 as libc::c_int;
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        let mut diff: s16 = 0;
        let mut temp: *mut s16 =
            &mut *(*this).unk_168.as_mut_ptr().offset(i as isize) as *mut s16;
        if *temp as libc::c_int == 0 as libc::c_int { } else { *temp -= 1 };
        diff =
            ((*this).dyna.actor.yawTowardsPlayer as libc::c_int -
                 i * 0x4000 as libc::c_int) as s16;
        if isAligned[(i % 2 as libc::c_int) as usize] != 0 && isClose != 0 {
            if (if diff as libc::c_int >= 0 as libc::c_int {
                    diff as libc::c_int
                } else { -(diff as libc::c_int) }) <= 0x4000 as libc::c_int {
                if (*temp as libc::c_int) < 4 as libc::c_int {
                    *temp = (35 as libc::c_int - *temp as libc::c_int) as s16
                }
                func_8088CEC0(this,
                              if phi_s4 > 1 as libc::c_int {
                                  1 as libc::c_int
                              } else { phi_s4 },
                              ((*this).dyna.actor.shape.rot.y as libc::c_int +
                                   i * 0x4000 as libc::c_int) as s16);
    ...
    i = 3 as libc::c_int * phi_s4;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElement; 6]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElement>()
                                                   as libc::c_ulong) as s32 {
        let ref mut fresh0 =
            (*(*this).collider.elements.offset(i as isize)).info.toucherFlags;
        *fresh0 =
...
#[no_mangle]
pub unsafe extern "C" fn func_8088D720(mut this: *mut BgHidanSekizou,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_168[0 as libc::c_int as usize] -= 1;
    if (*this).unk_168[0 as libc::c_int as usize] as libc::c_int <=
           -(36 as libc::c_int) {
        (*this).unk_168[0 as libc::c_int as usize] = 36 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8088D750(mut this: *mut BgHidanSekizou,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_a3: s16 = 0;
    if (*this).dyna.actor.xzDistToPlayer > 200.0f32 {
        phi_a3 = (*this).dyna.actor.yawTowardsPlayer
    } else if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        phi_a3 =
            ((*this).dyna.actor.yawTowardsPlayer as libc::c_int -
                 (*this).dyna.actor.shape.rot.y as libc::c_int) as s16;
        if phi_a3 as libc::c_int > 0x2000 as libc::c_int {
            phi_a3 =
                ((*this).dyna.actor.shape.rot.y as libc::c_int +
                     0x6000 as libc::c_int) as s16
        } else if (phi_a3 as libc::c_int) < -(0x2000 as libc::c_int) {
            phi_a3 =
                ((*this).dyna.actor.shape.rot.y as libc::c_int -
                     0x6000 as libc::c_int) as s16
        } else if phi_a3 as libc::c_int > 0 as libc::c_int {
            phi_a3 =
                ((*this).dyna.actor.shape.rot.y as libc::c_int -
        ...
        phi_a3 = (*this).dyna.actor.yawTowardsPlayer;
        if phi_a3 as libc::c_int > 0x6000 as libc::c_int {
            phi_a3 = 0x4000 as libc::c_int as s16
        } else if phi_a3 as libc::c_int > 0x4000 as libc::c_int {
            phi_a3 = -(0x8000 as libc::c_int) as s16
        } else if phi_a3 as libc::c_int > 0x2000 as libc::c_int {
            phi_a3 = 0 as libc::c_int as s16
        } else if phi_a3 as libc::c_int > 0 as libc::c_int {
            phi_a3 = 0x4000 as libc::c_int as s16
        } else if (phi_a3 as libc::c_int) < -(0x6000 as libc::c_int) {
            phi_a3 = -(0x4000 as libc::c_int) as s16
        } else if (phi_a3 as libc::c_int) < -(0x4000 as libc::c_int) {
            phi_a3 = -(0x8000 as libc::c_int) as s16
        } else if (phi_a3 as libc::c_int) < -(0x2000 as libc::c_int) {
            phi_a3 = 0 as libc::c_int as s16
        } else { phi_a3 = -(0x4000 as libc::c_int) as s16 }
    }
    func_8002F71C(globalCtx, &mut (*this).dyna.actor, 5.0f32, phi_a3, 1.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSekizou_Update(mut thisx: *mut Actor,
                                               mut globalCtx2:
                                                   *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut BgHidanSekizou = thisx as *mut BgHidanSekizou;
    ...
    if (*this).unk_170 as libc::c_int == 0 as libc::c_int {
        (*this).unk_170 = 4 as libc::c_int as s16
    }
    ...
    } else if (*this).unk_168[0 as libc::c_int as usize] as libc::c_int >
                  0 as libc::c_int ||
                  (*this).unk_168[1 as libc::c_int as usize] as libc::c_int >
                      0 as libc::c_int ||
                  (*this).unk_168[2 as libc::c_int as usize] as libc::c_int >
                      0 as libc::c_int ||
                  (*this).unk_168[3 as libc::c_int as usize] as libc::c_int >
                      0 as libc::c_int {
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
...
#[no_mangle]
pub unsafe extern "C" fn func_8088D9F4(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut BgHidanSekizou,
                                       mut arg2: s16, mut arg3: *mut MtxF,
                                       mut arg4: f32_0, mut arg5: f32_0,
                                       mut arg6: s16, mut arg7: *mut Gfx)
 -> *mut Gfx {
    let mut temp_f0: f32_0 = 0.;
    let mut temp_f2: f32_0 = 0.;
    let mut phi_f12: f32_0 = 0.;
    arg6 =
        (((arg6 as libc::c_int + arg2 as libc::c_int) % 8 as libc::c_int *
              7 as libc::c_int) as libc::c_float *
             (1 as libc::c_int as libc::c_float / 7.0f32)) as s16;
    arg2 += 1;
    let fresh2 = arg7;
    arg7 = arg7.offset(1);
    ...
    (*_g).words.w1 =
        gSegments[((sFireballsTexs[arg6 as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sFireballsTexs[arg6 as usize] as
                                              u32_0 &
    ...
    if arg2 as libc::c_int != 4 as libc::c_int {
        phi_f12 =
            arg2 as libc::c_int as libc::c_float +
                (4 as libc::c_int - (*this).unk_170 as libc::c_int) as
                    libc::c_float / 4.0f32
    } else { phi_f12 = arg2 as f32_0 }
    let fresh3 = arg7;
    arg7 = arg7.offset(1);
    ...
    (*_g_1).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*arg3).c2rust_unnamed.zz = 0.7f32 * phi_f12 + 0.5f32;
    (*arg3).c2rust_unnamed.yy = (*arg3).c2rust_unnamed.zz;
    (*arg3).c2rust_unnamed.xx = (*arg3).c2rust_unnamed.yy;
    temp_f2 = (*arg3).c2rust_unnamed.xx * 10.0f32 * phi_f12 + 20.0f32;
    (*arg3).c2rust_unnamed.xw =
        temp_f2 * arg4 + (*this).dyna.actor.world.pos.x;
    (*arg3).c2rust_unnamed.yw =
        (*this).dyna.actor.world.pos.y + 30.0f32 + 0.7f32 * phi_f12;
    (*arg3).c2rust_unnamed.zw =
        temp_f2 * arg5 + (*this).dyna.actor.world.pos.z;
    let fresh5 = arg7;
    arg7 = arg7.offset(1);
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gFireTempleFireballDL.as_mut_ptr() as libc::c_uint;
    return arg7;
}
#[no_mangle]
pub unsafe extern "C" fn func_8088DC50(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut BgHidanSekizou,
                                       mut arg2: s16, mut arg3: s16,
                                       mut arg4: *mut Gfx) -> *mut Gfx {
    let mut pad: s32 = 0;
    ...
    let mut sp68: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut i: s32 = 0;
    if (arg3 as libc::c_int) < 4 as libc::c_int {
        phi_s1 = 4 as libc::c_int - arg3 as libc::c_int;
        phi_s2 = 4 as libc::c_int
    } else {
        phi_s1 = 0 as libc::c_int;
        phi_s2 = 36 as libc::c_int - arg3 as libc::c_int;
        phi_s2 =
            if phi_s2 > 4 as libc::c_int { 4 as libc::c_int } else { phi_s2 }
    }
    temp_f20 = Math_SinS(arg2);
    temp_f22 = Math_CosS(arg2);
    Matrix_MtxFCopy(&mut sp68, &mut gMtxFClear);
    temp_v1 =
        (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                         as usize]) as
             libc::c_int - arg2 as libc::c_int) as s16;
    if (if temp_v1 as libc::c_int >= 0 as libc::c_int {
            temp_v1 as libc::c_int
        } else { -(temp_v1 as libc::c_int) }) < 0x4000 as libc::c_int {
        i = phi_s2 - 1 as libc::c_int;
        while i >= phi_s1 {
            arg4 =
                func_8088D9F4(globalCtx, this, i as s16, &mut sp68, temp_f20,
                              temp_f22, arg3, arg4);
            i -= 1
        }
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_8088DE08(mut arg0: s16, mut arg1: s16,
                                       mut arg2: *mut s32) {
    let mut diff: s16 = (arg0 as libc::c_int - arg1 as libc::c_int) as s16;
    if (if diff as libc::c_int >= 0 as libc::c_int {
            diff as libc::c_int
        } else { -(diff as libc::c_int) }) <= 0x2000 as libc::c_int {
        *arg2.offset(0 as libc::c_int as isize) = 0 as libc::c_int;
        *arg2.offset(1 as libc::c_int as isize) = 1 as libc::c_int;
        *arg2.offset(2 as libc::c_int as isize) = 3 as libc::c_int;
        *arg2.offset(3 as libc::c_int as isize) = 2 as libc::c_int
    } else if (if diff as libc::c_int >= 0 as libc::c_int {
                   diff as libc::c_int
               } else { -(diff as libc::c_int) }) >= 0x6000 as libc::c_int {
        *arg2.offset(0 as libc::c_int as isize) = 2 as libc::c_int;
        *arg2.offset(1 as libc::c_int as isize) = 3 as libc::c_int;
        *arg2.offset(2 as libc::c_int as isize) = 1 as libc::c_int;
        *arg2.offset(3 as libc::c_int as isize) = 0 as libc::c_int
    } else if diff as libc::c_int > 0x2000 as libc::c_int {
        *arg2.offset(0 as libc::c_int as isize) = 1 as libc::c_int;
        *arg2.offset(1 as libc::c_int as isize) = 0 as libc::c_int;
        *arg2.offset(2 as libc::c_int as isize) = 2 as libc::c_int;
        *arg2.offset(3 as libc::c_int as isize) = 3 as libc::c_int
    } else {
        *arg2.offset(0 as libc::c_int as isize) = 3 as libc::c_int;
        *arg2.offset(1 as libc::c_int as isize) = 2 as libc::c_int;
        *arg2.offset(2 as libc::c_int as isize) = 0 as libc::c_int;
        *arg2.offset(3 as libc::c_int as isize) = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSekizou_Draw(mut thisx: *mut Actor,
                                             mut globalCtx2:
                                                 *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut BgHidanSekizou = thisx as *mut BgHidanSekizou;
    let mut i: s32 = 0;
    let mut sp6C: [s32; 4] = [0; 4];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_sekizou.c\x00" as *const u8 as
                        *const libc::c_char, 827 as libc::c_int);
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gFireTempleStationaryFlamethrowerShortDL.as_mut_ptr() as
                libc::c_uint
    } else {
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gFireTempleStationaryFlamethrowerTallDL.as_mut_ptr() as
                libc::c_uint
    }
    (*__gfxCtx).polyXlu.p =
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        if (*this).unk_168[0 as libc::c_int as usize] as libc::c_int >
               0 as libc::c_int {
            if (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                as usize]) as
                    libc::c_int -
                    (*this).dyna.actor.shape.rot.y as libc::c_int) as s16 as
                   libc::c_int >= 0 as libc::c_int {
                (*__gfxCtx).polyXlu.p =
                    func_8088DC50(globalCtx, this,
                                  ((*this).dyna.actor.shape.rot.y as
                                       libc::c_int + 0x2000 as libc::c_int) as
                                      s16,
                                  (*this).unk_168[0 as libc::c_int as usize],
                                  (*__gfxCtx).polyXlu.p);
                (*__gfxCtx).polyXlu.p =
        ...
        func_8088DE08(Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                      as
                                                                      usize]),
                      (*this).dyna.actor.shape.rot.y, sp6C.as_mut_ptr());
        i = 0 as libc::c_int;
        while i < 4 as libc::c_int {
            let mut index: s32 = sp6C[i as usize];
            if (*this).unk_168[index as usize] as libc::c_int >
                   0 as libc::c_int {
                (*__gfxCtx).polyXlu.p =
                    func_8088DC50(globalCtx, this,
                                  ((*this).dyna.actor.shape.rot.y as
                                       libc::c_int +
                                       index * 0x4000 as libc::c_int) as s16,
                                  (*this).unk_168[index as usize],
                                  (*__gfxCtx).polyXlu.p)
            }
            i += 1
        }
