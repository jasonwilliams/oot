...
#[no_mangle]
pub static mut Effect_Ss_KiraKira_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_KIRAKIRA as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsKiraKira_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsKiraKira_Init(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               ...
                                               mut initParamsx:
                                                   *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsKiraKiraInitParams =
        initParamsx as *mut EffectSsKiraKiraInitParams;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).life = (*initParams).life as s16;
    if ((*this).life as libc::c_int) < 0 as libc::c_int {
        (*this).life = -((*this).life as libc::c_int) as s16;
        (*this).gfx =
            gSegments[((gEffSparklesDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gEffSparklesDL.as_mut_ptr() as
                                                  u32_0 &
                          ...
                          usize].wrapping_add(gEffSparklesDL.as_mut_ptr() as
                                                  ...
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     ...
                                                                                     libc::c_uint)
                as *mut libc::c_void;
        if (*initParams).updateMode as libc::c_int == 0 as libc::c_int {
            (*this).update =
                Some(func_809AABF0 as
                         unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                              _: *mut EffectSs) -> ())
        } else {
            (*this).update =
                Some(func_809AACAC as
                         unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                              _: *mut EffectSs) -> ())
        }
        (*this).regs[9 as libc::c_int as usize] =
            (*initParams).envColor.a as s16;
        (*this).regs[11 as libc::c_int as usize] = (*initParams).scale
    }
    (*this).draw =
        Some(EffectSsKiraKira_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[0 as libc::c_int as usize] = (*initParams).rotSpeed;
    ...
    (*this).regs[10 as libc::c_int as usize] = (*initParams).alphaStep;
    (*this).regs[12 as libc::c_int as usize] = (*initParams).life as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsKiraKira_Draw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    ...
    let mut mfRotY: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mfScale: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mfTrans11DA0: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mfTrans11DA0RotY: MtxF = MtxF{mf: [[0.; 4]; 4],};
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_kirakira.c\x00" as *const u8 as
                        *const libc::c_char, 257 as libc::c_int);
    SkinMatrix_SetTranslate(&mut mfTrans, (*this).pos.x, (*this).pos.y,
                            (*this).pos.z);
    SkinMatrix_SetRotateZYX(&mut mfRotY, 0 as libc::c_int as s16,
    ...
    SkinMatrix_MtxFMtxFMult(&mut mfTrans, &mut (*globalCtx).billboardMtxF,
                            &mut mfTrans11DA0);
    SkinMatrix_MtxFMtxFMult(&mut mfTrans11DA0, &mut mfRotY,
                            &mut mfTrans11DA0RotY);
    SkinMatrix_MtxFMtxFMult(&mut mfTrans11DA0RotY, &mut mfScale,
                            &mut mfResult);
            ...
            ((*this).regs[2 as libc::c_int as usize] as u32_0 &
                ...
                (((55.0f32 /
                       (*this).regs[12 as libc::c_int as usize] as libc::c_int
                           as libc::c_float *
                       (*this).life as libc::c_int as libc::c_float) as s8 as
                      libc::c_int + 200 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_ss_kirakira.c\x00" as *const u8 as
                         *const libc::c_char, 301 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809AABF0(mut globalCtx: *mut GlobalContext,
                                       mut index: u32_0,
                                       mut this: *mut EffectSs) {
    ...
    if ((*this).regs[9 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
        (*this).regs[9 as libc::c_int as usize] = 0 as libc::c_int as s16;
        (*this).regs[10 as libc::c_int as usize] =
            -((*this).regs[10 as libc::c_int as usize] as libc::c_int) as s16
    } else if (*this).regs[9 as libc::c_int as usize] as libc::c_int >
                  255 as libc::c_int {
        (*this).regs[9 as libc::c_int as usize] = 255 as libc::c_int as s16;
        (*this).regs[10 as libc::c_int as usize] =
            -((*this).regs[10 as libc::c_int as usize] as libc::c_int) as s16
    }
    (*this).regs[1 as libc::c_int as usize] =
        ((*this).regs[1 as libc::c_int as usize] as libc::c_int +
             (*this).regs[0 as libc::c_int as usize] as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_809AACAC(mut globalCtx: *mut GlobalContext,
                                       mut index: u32_0,
                                       mut this: *mut EffectSs) {
    (*this).velocity.x *= 0.95f32;
    (*this).velocity.z *= 0.95f32;
    (*this).accel.x = Rand_CenteredFloat(0.2f32);
    (*this).accel.z = Rand_CenteredFloat(0.2f32);
    (*this).regs[9 as libc::c_int as usize] =
        ((*this).regs[9 as libc::c_int as usize] as libc::c_int +
             (*this).regs[10 as libc::c_int as usize] as libc::c_int) as s16;
    if ((*this).regs[9 as libc::c_int as usize] as libc::c_int) <
