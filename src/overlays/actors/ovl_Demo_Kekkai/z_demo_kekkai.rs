...
extern "C" {
    ...
    #[no_mangle]
    static mut gTowerBarrierDL: [Gfx; 0];
    #[no_mangle]
    static mut gTrialBarrierFloorDL: [Gfx; 0];
    #[no_mangle]
    static mut gTrialBarrierEnergyVtx: [Vtx; 0];
    #[no_mangle]
    static mut gTrialBarrierEnergyDL: [Gfx; 0];
    #[no_mangle]
    static mut gTrialBarrierOrbDL: [Gfx; 0];
    #[no_mangle]
    static mut gForestTrialSageCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gWaterTrialSageCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gShadowTrialSageCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gFireTrialSageCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gLightTrialSageCs: [CutsceneData; 0];
    #[no_mangle]
    static mut gSpiritTrialSageCs: [CutsceneData; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DemoKekkai {
    pub actor: Actor,
    pub collider1: ColliderCylinder,
    pub collider2: ColliderCylinder,
    pub energyAlpha: f32_0,
    pub orbScale: f32_0,
    pub barrierScroll: f32_0,
    pub barrierScrollRate: f32_0,
    pub timer: u16_0,
    pub sfxFlag: u16_0,
    pub updateFunc: DemoKekkaiUpdateFunc,
}
pub type DemoKekkaiUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoKekkai, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const KEKKAI_FOREST: C2RustUnnamed_22 = 6;
pub const KEKKAI_SPIRIT: C2RustUnnamed_22 = 5;
pub const KEKKAI_SHADOW: C2RustUnnamed_22 = 4;
pub const KEKKAI_FIRE: C2RustUnnamed_22 = 3;
pub const KEKKAI_LIGHT: C2RustUnnamed_22 = 2;
pub const KEKKAI_WATER: C2RustUnnamed_22 = 1;
pub const KEKKAI_TOWER: C2RustUnnamed_22 = 0;
#[no_mangle]
pub static mut Demo_Kekkai_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_KEKKAI as libc::c_int as s16,
                          category:
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_DEMO_KEKKAI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DemoKekkai>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKekkai_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKekkai_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKekkai_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoKekkai_DrawTowerBarrier
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sEnergyColors: [u8_0; 36] =
    [170 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     50 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     170 as libc::c_int as u8_0, 200 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     170 as libc::c_int as u8_0, 200 as libc::c_int as u8_0,
     0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 170 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 100 as libc::c_int as u8_0,
     0 as libc::c_int as u8_0, 200 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     170 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     120 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     255 as libc::c_int as u8_0, 255 as libc::c_int as u8_0,
     170 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     200 as libc::c_int as u8_0, 0 as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_CheckEventFlag(mut params: s32) -> s32 {
    static mut eventFlags: [s32; 7] =
        [0xc3 as libc::c_int, 0xbc as libc::c_int, 0xbf as libc::c_int,
         0xbe as libc::c_int, 0xbd as libc::c_int, 0xad as libc::c_int,
         0xbb as libc::c_int];
    if params < KEKKAI_TOWER as libc::c_int ||
           params > KEKKAI_FOREST as libc::c_int {
        return 1 as libc::c_int
    }
    return Flags_GetEventChkInf(eventFlags[params as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    (*this).sfxFlag = 0 as libc::c_int as u16_0;
    (*this).energyAlpha = 1.0f32;
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider1, thisx,
                         &mut sCylinderInit);
    Collider_InitCylinder(globalCtx, &mut (*this).collider2);
    Collider_SetCylinder(globalCtx, &mut (*this).collider2, thisx,
                         &mut sCylinderInit);
    ...
    (*this).barrierScrollRate = 1.0f32;
    (*this).barrierScroll = 0.0f32;
    match (*thisx).params as libc::c_int {
        0 => {
            (*this).updateFunc =
                Some(DemoKekkai_TowerBarrier as
                         unsafe extern "C" fn(_: *mut DemoKekkai,
                                              _: *mut GlobalContext) -> ());
            (*this).collider2.dim.radius =
                ((*thisx).scale.x * 6100.0f32) as s16;
            (*this).collider2.dim.height =
                ((*thisx).scale.y * 5000.0f32) as s16;
            (*this).collider2.dim.yShift = 300 as libc::c_int as s16
        }
        1 | 2 | 3 | 4 | 5 | 6 => {
            (*this).energyAlpha = 1.0f32;
            (*this).orbScale = 1.0f32;
            Actor_SetScale(thisx, 0.1f32);
            (*thisx).update =
                Some(DemoKekkai_TrialBarrierIdle as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*thisx).draw =
                Some(DemoKekkai_DrawTrialBarrier as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).collider1.dim.radius =
                ((*thisx).scale.x * 120.0f32) as s16;
            (*this).collider1.dim.height =
                ((*thisx).scale.y * 2000.0f32) as s16;
            (*this).collider1.dim.yShift = 0 as libc::c_int as s16;
            (*this).collider2.dim.radius =
                ((*thisx).scale.x * 320.0f32) as s16;
            (*this).collider2.dim.height =
                ((*thisx).scale.y * 510.0f32) as s16;
            (*this).collider2.dim.yShift = 95 as libc::c_int as s16
        }
        _ => { }
    }
    if DemoKekkai_CheckEventFlag((*thisx).params as s32) != 0 {
        if (*thisx).params as libc::c_int == KEKKAI_TOWER as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
...
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_SpawnParticles(mut this: *mut DemoKekkai,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    static mut vel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut lightYellow: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut darkRed: Color_RGBA8 =
        {
            let mut init =
    ...
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 85 as libc::c_int {
        let mut roll: s16 = Rand_ZeroFloat(65535.0f32) as s16;
        let mut yaw: s16 = Rand_ZeroFloat(65535.0f32) as s16;
        vel.x = Math_SinS(yaw) * Math_CosS(roll) * Rand_ZeroFloat(8.0f32);
        vel.z = Math_CosS(yaw) * Math_CosS(roll) * Rand_ZeroFloat(8.0f32);
        vel.y = Math_SinS(roll) * Rand_ZeroFloat(3.0f32);
        pos.x = vel.x * 7.0f32 + (*this).actor.world.pos.x;
        pos.y = vel.y * 20.0f32 + (*this).actor.world.pos.y + 120.0f32;
        pos.z = vel.z * 7.0f32 + (*this).actor.world.pos.z;
        EffectSsKiraKira_SpawnFocused(globalCtx, &mut pos, &mut vel,
                                      &mut accel, &mut lightYellow,
                                      &mut darkRed,
...
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_TowerBarrier(mut this: *mut DemoKekkai,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
        ...
        if (*this).sfxFlag as libc::c_int & 1 as libc::c_int == 0 {
            func_800F3F3C(0xc as libc::c_int as u8_0);
            (*this).sfxFlag =
                ((*this).sfxFlag as libc::c_int | 1 as libc::c_int) as u16_0
        }
        if (*this).barrierScrollRate < 7.0f32 {
            (*this).barrierScrollRate += 0.2f32
        } else {
            (*this).timer = (*this).timer.wrapping_add(1);
            if (*this).timer as libc::c_int > 100 as libc::c_int {
                Flags_SetEventChkInf(0xc3 as libc::c_int);
                Actor_Kill(&mut (*this).actor);
                return
            } else {
                if (*this).timer as libc::c_int > 40 as libc::c_int {
                    (*this).actor.scale.x += 0.003f32;
    ...
    if (*this).sfxFlag as libc::c_int & 1 as libc::c_int == 0 {
        func_8002F974(&mut (*this).actor,
                      (0x28ee as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_Update(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    if (*this).energyAlpha > 0.99f32 {
    ...
    if (*this).barrierScroll > 65536.0f32 {
        (*this).barrierScroll -= 65536.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_TrialBarrierDispel(mut thisx: *mut Actor,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    static mut csFrames: [u16_0; 7] =
        [0 as libc::c_int as u16_0, 280 as libc::c_int as u16_0,
         280 as libc::c_int as u16_0, 280 as libc::c_int as u16_0,
         280 as libc::c_int as u16_0, 280 as libc::c_int as u16_0,
         280 as libc::c_int as u16_0];
    let mut pad: s32 = 0;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    if (*globalCtx).csCtx.frames as libc::c_int ==
           csFrames[(*this).actor.params as usize] as libc::c_int {
        func_800F3F3C(0xa as libc::c_int as u8_0);
    }
    if (*this).energyAlpha >= 0.05f32 {
        (*this).energyAlpha -= 0.05f32
    } else { (*this).energyAlpha = 0.0f32 }
    if ((*this).timer as libc::c_int) < 40 as libc::c_int {
        (*this).orbScale =
            (80 as libc::c_int - (*this).timer as libc::c_int) as
                libc::c_float * (*this).timer as f32_0 * 0.000625f32 + 1.0f32
    } else if ((*this).timer as libc::c_int) < 50 as libc::c_int {
        (*this).orbScale = 2.0f32
    } else if (*this).timer as libc::c_int == 50 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x1842 as libc::c_int as u16_0);
        DemoKekkai_SpawnParticles(this, globalCtx);
    } else { (*this).orbScale = 0.0f32 }
    if (*this).orbScale != 0.0f32 {
        func_8002F974(&mut (*this).actor,
                      (0x28ed as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    (*this).timer = (*this).timer.wrapping_add(1);
}
static mut sSageCutscenes: [*mut CutsceneData; 7] =
    unsafe {
        [0 as *const CutsceneData as *mut CutsceneData,
         gWaterTrialSageCs.as_ptr() as *mut _,
         gLightTrialSageCs.as_ptr() as *mut _,
         gFireTrialSageCs.as_ptr() as *mut _,
         gShadowTrialSageCs.as_ptr() as *mut _,
         gSpiritTrialSageCs.as_ptr() as *mut _,
         gForestTrialSageCs.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_TrialBarrierIdle(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    if (*this).collider1.base.atFlags as libc::c_int &
        ...
        func_8002F71C(globalCtx, &mut (*this).actor, 5.0f32,
                      (*this).actor.yawTowardsPlayer, 5.0f32);
    }
    CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider1.base);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
    ...
    if (*this).collider2.base.acFlags as libc::c_int &
        ...
        // "I got it"
        LogUtils_LogThreadId(b"../z_demo_kekkai.c\x00" as *const u8 as
                                 *const libc::c_char, 572 as libc::c_int);
        osSyncPrintf(b"\"\xe5\xbd\x93\xe3\x81\xa3\xe3\x81\x9f\xe3\x82\x88\" = %s\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"\xe5\xbd\x93\xe3\x81\xa3\xe3\x81\x9f\xe3\x82\x88\x00"
                         as *const u8 as *const libc::c_char);
        (*this).actor.update =
            Some(DemoKekkai_TrialBarrierDispel as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).timer = 0 as libc::c_int as u16_0;
        (*globalCtx).csCtx.segment =
            gSegments[((sSageCutscenes[(*this).actor.params as usize] as
                            u32_0) << 4 as libc::c_int >> 28 as libc::c_int)
                          as
                          usize].wrapping_add(sSageCutscenes[(*this).actor.params
                                                                 as usize] as
                                                  u32_0 &
    ...
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider2.base);
    func_8002F974(&mut (*this).actor,
                  (0x28ed as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_DrawTrialBarrier(mut thisx: *mut Actor,
                                                     mut globalCtx2:
                                                         *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut frames: s32 =
    ...
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    let mut alphas: [u8_0; 3] = [0; 3];
    let mut energyVtx: *mut Vtx =
        gSegments[((gTrialBarrierEnergyVtx.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gTrialBarrierEnergyVtx.as_mut_ptr()
                                              as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
    ...
    let mut i: s32 = 0;
    if (*this).orbScale != 0.0f32 {
        alphas[2 as libc::c_int as usize] =
            ((*this).energyAlpha * 202.0f32) as s32 as u8_0;
        alphas[1 as libc::c_int as usize] =
            ((*this).energyAlpha * 126.0f32) as s32 as u8_0;
        alphas[0 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
        i = 0 as libc::c_int;
        while i < 102 as libc::c_int {
            (*energyVtx.offset(i as isize)).v.cn[3 as libc::c_int as usize] =
                alphas[alphaIndex[i as usize] as usize];
            i += 1
        }
        colorIndex =
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_demo_kekkai.c\x00" as *const u8 as
                            *const libc::c_char, 632 as libc::c_int);
        func_80093D84((*globalCtx).state.gfxCtx);
        Matrix_Push();
        Matrix_Translate(0.0f32, 1200.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale((*this).orbScale, (*this).orbScale, (*this).orbScale,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(0.0f32, -1200.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_0).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             (frames * 5 as libc::c_int) as u32_0,
                             (frames * -(10 as libc::c_int)) as u32_0,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = gTrialBarrierOrbDL.as_mut_ptr() as libc::c_uint;
        Matrix_Pop();
        ...
        (*_g_5).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             frames as u32_0, frames as u32_0,
                             0x20 as libc::c_int, 0x20 as libc::c_int) as
                libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = gTrialBarrierFloorDL.as_mut_ptr() as libc::c_uint;
        ...
        (*_g_8).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (0x80 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_8).words.w1 =
            (sEnergyColors[(colorIndex + 0 as libc::c_int) as usize] as u32_0
                 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (sEnergyColors[(colorIndex + 1 as libc::c_int) as usize] as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (sEnergyColors[(colorIndex + 2 as libc::c_int) as usize] as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
        ...
        (*_g_9).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_9).words.w1 =
            (sEnergyColors[(colorIndex + 3 as libc::c_int) as usize] as u32_0
                 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (sEnergyColors[(colorIndex + 4 as libc::c_int) as usize] as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (sEnergyColors[(colorIndex + 5 as libc::c_int) as usize] as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
        ...
        (*_g_11).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_11).words.w1 =
            gTrialBarrierEnergyDL.as_mut_ptr() as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn DemoKekkai_DrawTowerBarrier(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoKekkai = thisx as *mut DemoKekkai;
    let mut scroll: s32 = 0;
    scroll = (*this).barrierScroll as s32 & 0xffff as libc::c_int;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (scroll * 2 as libc::c_int) as u32_0,
                         (scroll * -(4 as libc::c_int)) as u32_0,
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gTowerBarrierDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_demo_kekkai.c\x00" as *const u8 as
