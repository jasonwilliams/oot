...
extern "C" {
    ...
    #[no_mangle]
    fn func_800A63CC(actor: *mut Actor, globalCtx: *mut GlobalContext,
                     skin: *mut PSkinAwb, callback: SkinCallback,
                     arg4: SkinCallback2, arg5: s32, arg6: s32, arg7: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gHorseNormalGallopingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalJumpingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalJumpingHighAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalTrottingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalRearingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalRefuseAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalWhinnyAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalWalkingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseNormalSkel: SkeletonHeader;
}
...
pub struct EnHorseNormal {
    ...
    pub unk_200: s32,
    pub unk_204: Vec3f,
    pub unk_210: [libc::c_char; 8],
    pub unk_218: f32_0,
    pub unk_21C: s16,
    pub unk_21E: s16,
    pub unk_220: f32_0,
    pub unk_224: [libc::c_char; 4],
    pub bodyCollider: ColliderCylinder,
    pub headCollider: ColliderJntSph,
    pub headElements: [ColliderJntSphElement; 1],
    pub cloneCollider: ColliderCylinder,
    pub unk_320: [libc::c_char; 4],
    pub waypoint: s32,
}
pub type EnHorseNormalActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHorseNormal, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const HORSE_FOLLOW_PATH: C2RustUnnamed_24 = 4;
pub const HORSE_WAIT_CLONE: C2RustUnnamed_24 = 3;
pub const HORSE_WAIT: C2RustUnnamed_24 = 2;
pub const HORSE_WANDER: C2RustUnnamed_24 = 1;
pub const HORSE_CYCLE_ANIMATIONS: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut En_Horse_Normal_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HORSE_NORMAL as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_HORSE_NORMAL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHorseNormal>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseNormal_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseNormal_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseNormal_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseNormal_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sAnimations: [*mut AnimationHeader; 9] =
    unsafe {
        [&gHorseNormalIdleAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalWhinnyAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalRefuseAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalRearingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalWalkingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalTrottingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalGallopingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalJumpingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseNormalJumpingHighAnim as *const AnimationHeader as
             *mut AnimationHeader]
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6B250(mut this: *mut EnHorseNormal) {
    static mut D_80A6D4C0: [s32; 2] = [0 as libc::c_int, 16 as libc::c_int];
    if (D_80A6D4C0[(*this).unk_200 as usize] as libc::c_float) <
           (*this).skin.skelAnime.curFrame &&
           ((*this).unk_200 != 0 as libc::c_int ||
                !((D_80A6D4C0[1 as libc::c_int as usize] as libc::c_float) <
                      (*this).skin.skelAnime.curFrame)) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6B30C(mut this: *mut EnHorseNormal)
 -> f32_0 {
    static mut D_80A6D4C8: [f32_0; 9] =
        [1.0f32, 1.0f32, 1.0f32, 1.0f32, 1.5f32, 1.5f32, 1.5f32, 1.5f32,
         1.0f32];
    let mut result: f32_0 = 0.;
    if (*this).animationIdx == 4 as libc::c_int {
        result =
            D_80A6D4C8[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1 as libc::c_int as libc::c_float / 2.0f32)
    } else if (*this).animationIdx == 5 as libc::c_int {
        result =
            D_80A6D4C8[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1 as libc::c_int as libc::c_float / 3.0f32)
    } else if (*this).animationIdx == 6 as libc::c_int {
        result =
            D_80A6D4C8[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1 as libc::c_int as libc::c_float / 5.0f32)
    } else { result = D_80A6D4C8[(*this).animationIdx as usize] }
    return result;
}
// Initialized in run_static_initializers
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnHorseNormal = thisx as *mut EnHorseNormal;
    let mut pad: s32 = 0;
    ...
    (*this).action = HORSE_CYCLE_ANIMATIONS as libc::c_int;
    (*this).animationIdx = 0 as libc::c_int;
    ...
    Collider_InitJntSph(globalCtx, &mut (*this).headCollider);
    Collider_SetJntSph(globalCtx, &mut (*this).headCollider,
                       &mut (*this).actor, &mut sJntSphInit,
                       (*this).headElements.as_mut_ptr());
    Collider_InitCylinder(globalCtx, &mut (*this).cloneCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).cloneCollider,
    ...
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT20 as libc::c_int {
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            if Flags_GetEventChkInf(0x14 as libc::c_int) != 0 {
                if (*this).actor.world.rot.z as libc::c_int !=
                       3 as libc::c_int {
                    Actor_Kill(&mut (*this).actor);
                    return
                }
            } else if (*this).actor.world.rot.z as libc::c_int !=
                          1 as libc::c_int {
                Actor_Kill(&mut (*this).actor);
                return
            }
            ...
            if (*this).actor.world.rot.z as libc::c_int != 7 as libc::c_int {
                Actor_Kill(&mut (*this).actor);
                return
            }
        } else if (*this).actor.world.rot.z as libc::c_int != 5 as libc::c_int
         {
            Actor_Kill(&mut (*this).actor);
            return
        }
        ...
        func_800A663C(globalCtx, &mut (*this).skin, &mut gHorseNormalSkel,
                      &mut gHorseNormalIdleAnim);
        Animation_PlayOnce(&mut (*this).skin.skelAnime,
                           sAnimations[(*this).animationIdx as usize]);
        if (*this).actor.world.pos.x == -730.0f32 &&
               (*this).actor.world.pos.y == 0.0f32 &&
               (*this).actor.world.pos.z == -1100.0f32 ||
               (*this).actor.world.pos.x == 880.0f32 &&
                   (*this).actor.world.pos.y == 0.0f32 &&
                   (*this).actor.world.pos.z == -1170.0f32 {
            func_80A6C6B0(this);
            return
        }
        ...
        if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT12 as libc::c_int
           {
            if (*this).actor.world.pos.x == 3707.0f32 &&
                   (*this).actor.world.pos.y == 1413.0f32 &&
                   (*this).actor.world.pos.z == -665.0f32 {
                func_800A663C(globalCtx, &mut (*this).skin,
                              &mut gHorseNormalSkel,
                              &mut gHorseNormalIdleAnim);
                Animation_PlayOnce(&mut (*this).skin.skelAnime,
                                   sAnimations[(*this).animationIdx as
                                                   usize]);
                func_80A6C4CC(this);
                return
            }
    ...
    if (*this).actor.params as libc::c_int & 0xf0 as libc::c_int ==
           0x10 as libc::c_int &&
           (*this).actor.params as libc::c_int & 0xf as libc::c_int !=
               0xf as libc::c_int {
        func_80A6B91C(this, globalCtx);
    } else { func_80A6BC48(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnHorseNormal = thisx as *mut EnHorseNormal;
    func_800A6888(globalCtx, &mut (*this).skin);
    Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).cloneCollider);
    Collider_DestroyJntSph(globalCtx, &mut (*this).headCollider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6B91C(mut this: *mut EnHorseNormal,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.flags |=
        ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
    (*this).action = HORSE_FOLLOW_PATH as libc::c_int;
    (*this).animationIdx = 6 as libc::c_int;
    (*this).waypoint = 0 as libc::c_int;
    (*this).actor.speedXZ = 7.0f32;
    Animation_Change(&mut (*this).skin.skelAnime,
                     sAnimations[(*this).animationIdx as usize],
                     func_80A6B30C(this), 0.0f32,
                     Animation_GetLastFrame(sAnimations[(*this).animationIdx
                                                            as usize] as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_FollowPath(mut this:
                                                      *mut EnHorseNormal,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    let mut dz: f32_0 = 0.;
    let mut pad: s32 = 0;
    pointPos = pointPos.offset((*this).waypoint as isize);
    dx =
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       ...
                       0xa as libc::c_int as s16, 0x7d0 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if dx * dx + dz * dz < 600.0f32 {
        (*this).waypoint += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_NextAnimation(mut this:
                                                         *mut EnHorseNormal) {
    (*this).action = HORSE_CYCLE_ANIMATIONS as libc::c_int;
    (*this).animationIdx += 1;
    if (*this).animationIdx >=
           (::std::mem::size_of::<[*mut AnimationHeader; 9]>() as
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_CycleAnimations(mut this:
                                                           *mut EnHorseNormal,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    (*this).actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6BC48(mut this: *mut EnHorseNormal) {
    (*this).action = HORSE_WANDER as libc::c_int;
    (*this).animationIdx = 0 as libc::c_int;
    (*this).unk_21C = 0 as libc::c_int as s16;
    (*this).unk_21E = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).unk_218 = 0.0f32;
    Animation_Change(&mut (*this).skin.skelAnime,
                     sAnimations[(*this).animationIdx as usize],
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6BCEC(mut this: *mut EnHorseNormal) {
    if (*this).animationIdx == 5 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6BD7C(mut this: *mut EnHorseNormal) {
    let mut frame: f32_0 = (*this).skin.skelAnime.curFrame;
    if (*this).animationIdx == 0 as libc::c_int && frame > 28.0f32 &&
           (*this).unk_1E4 as libc::c_int & 1 as libc::c_int == 0 {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int | 1 as libc::c_int) as u16_0;
        Audio_PlaySoundGeneral(0x282c as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if (*this).animationIdx == 3 as libc::c_int && frame > 25.0f32 &&
                  (*this).unk_1E4 as libc::c_int & 2 as libc::c_int == 0 {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int | 2 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Wander(mut this: *mut EnHorseNormal,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut D_80A6D4F4: [s32; 7] =
        [0 as libc::c_int, 1 as libc::c_int, 4 as libc::c_int,
         5 as libc::c_int, 6 as libc::c_int, 2 as libc::c_int,
         3 as libc::c_int];
    static mut D_80A6D510: [s32; 9] =
    ...
    let mut phi_t0: s32 = (*this).animationIdx;
    let mut pad: s32 = 0;
    match D_80A6D510[(*this).animationIdx as usize] {
        0 => {
            func_80A6BD7C(this);
            (*this).actor.speedXZ = 0.0f32;
            (*this).unk_218 = 0.0f32
        ...
        1 => {
            if Rand_ZeroOne() < 0.1f32 {
                (*this).unk_218 = 2.0f32 * Rand_ZeroOne() - 1.0f32
            }
            (*this).actor.speedXZ += (*this).unk_218;
            if (*this).actor.speedXZ <= 0.0f32 {
                (*this).actor.speedXZ = 0.0f32;
                (*this).unk_218 = 0.0f32;
                phi_t0 = 0 as libc::c_int
            } else if (*this).actor.speedXZ < 3.0f32 {
                func_80A6B250(this);
                phi_t0 = 4 as libc::c_int
            } else if (*this).actor.speedXZ < 6.0f32 {
                phi_t0 = 5 as libc::c_int
            } else if (*this).actor.speedXZ < 8.0f32 {
                phi_t0 = 6 as libc::c_int
            } else {
                (*this).actor.speedXZ = 8.0f32;
                phi_t0 = 6 as libc::c_int
            }
            if Rand_ZeroOne() < 0.1f32 ||
                   (*this).unk_21E as libc::c_int == 0 as libc::c_int &&
                       ((*this).actor.bgCheckFlags as libc::c_int &
                            8 as libc::c_int != 0 ||
                            (*this).bodyCollider.base.ocFlags1 as libc::c_int
                                & (1 as libc::c_int) << 1 as libc::c_int != 0
                            ||
                            (*this).headCollider.base.ocFlags1 as libc::c_int
                                & (1 as libc::c_int) << 1 as libc::c_int != 0)
               {
                (*this).unk_21E =
                    ((*this).unk_21E as libc::c_float +
                         (Rand_ZeroOne() * 30.0f32 - 15.0f32)) as s16;
                if (*this).unk_21E as libc::c_int > 50 as libc::c_int {
                    (*this).unk_21E = 50 as libc::c_int as s16
                } else if ((*this).unk_21E as libc::c_int) <
                              -(50 as libc::c_int) {
                    (*this).unk_21E = -(50 as libc::c_int) as s16
                }
            }
            (*this).unk_21C =
                ((*this).unk_21C as libc::c_int +
                     (*this).unk_21E as libc::c_int) as s16;
            if ((*this).unk_21C as libc::c_int) < -(300 as libc::c_int) {
                (*this).unk_21C = -(300 as libc::c_int) as s16
            } else if (*this).unk_21C as libc::c_int > 300 as libc::c_int {
                (*this).unk_21C = 300 as libc::c_int as s16
            } else if Rand_ZeroOne() < 0.25f32 &&
                          fabsf((*this).unk_21C as f32_0) < 100.0f32 {
                (*this).unk_21C = 0 as libc::c_int as s16;
                (*this).unk_21E = 0 as libc::c_int as s16
            }
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_int +
                     (*this).unk_21C as libc::c_int) as s16;
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y
        }
        2 | 3 | _ => { }
    }
    if phi_t0 != (*this).animationIdx ||
           SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
        if phi_t0 != (*this).animationIdx {
            (*this).animationIdx = phi_t0;
            (*this).unk_1E4 =
                ((*this).unk_1E4 as libc::c_int & !(1 as libc::c_int)) as
                    u16_0;
            (*this).unk_1E4 =
                ((*this).unk_1E4 as libc::c_int & !(2 as libc::c_int)) as
                    u16_0;
            if phi_t0 == 1 as libc::c_int {
                Audio_PlaySoundGeneral(0x2816 as libc::c_int as u16_0,
                                       &mut (*this).unk_204,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
            } else if phi_t0 == 3 as libc::c_int {
                Audio_PlaySoundGeneral(0x2805 as libc::c_int as u16_0,
                                       &mut (*this).unk_204,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
            } else { func_80A6BCEC(this); }
            Animation_Change(&mut (*this).skin.skelAnime,
                             sAnimations[(*this).animationIdx as usize],
                             func_80A6B30C(this), 0.0f32,
                             Animation_GetLastFrame(sAnimations[(*this).animationIdx
            ...
            match D_80A6D510[(*this).animationIdx as usize] {
                0 => {
                    if Rand_ZeroOne() < 0.25f32 {
                        (*this).unk_218 = 1.0f32;
                        phi_t0 = 4 as libc::c_int
                    } else {
                        phi_t0 =
                            D_80A6D4F4[(Rand_ZeroOne() *
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6C4CC(mut this: *mut EnHorseNormal) {
    (*this).action = HORSE_WAIT as libc::c_int;
    (*this).animationIdx = 0 as libc::c_int;
    (*this).unk_21C = 0 as libc::c_int as s16;
    (*this).unk_21E = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Wait(mut this: *mut EnHorseNormal,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
        ...
        if rand < 0.4f32 {
            ...
            (*this).animationIdx = 1 as libc::c_int;
            Audio_PlaySoundGeneral(0x2816 as libc::c_int as u16_0,
                                   &mut (*this).unk_204,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
        } else {
            (*this).animationIdx = 3 as libc::c_int;
            Audio_PlaySoundGeneral(0x2805 as libc::c_int as u16_0,
                                   &mut (*this).unk_204,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6C6B0(mut this: *mut EnHorseNormal) {
    (*this).action = HORSE_WAIT_CLONE as libc::c_int;
    (*this).animationIdx = 0 as libc::c_int;
    (*this).unk_21C = 0 as libc::c_int as s16;
    (*this).unk_21E = 0 as libc::c_int as s16;
    (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_WaitClone(mut this: *mut EnHorseNormal,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    func_80A6BD7C(this);
    if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
        ...
        if rand < 0.4f32 {
            ...
            (*this).animationIdx = 1 as libc::c_int;
            (*this).unk_1E4 =
                ((*this).unk_1E4 as libc::c_int | 0x20 as libc::c_int) as
                    u16_0;
            Audio_PlaySoundGeneral(0x2816 as libc::c_int as u16_0,
                                   &mut (*this).unk_204,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
        ...
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int & !(2 as libc::c_int)) as u16_0;
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int & !(8 as libc::c_int)) as u16_0;
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int & !(0x10 as libc::c_int)) as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6C8E0(mut this: *mut EnHorseNormal,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp38: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut pad2: s32 = 0;
    ...
    sp28.x =
        Math_SinS((*this).actor.shape.rot.y) * 30.0f32 +
            (*this).actor.world.pos.x;
    sp28.y = (*this).actor.world.pos.y + 60.0f32;
    sp28.z =
        Math_CosS((*this).actor.shape.rot.y) * 30.0f32 +
            (*this).actor.world.pos.z;
    (*this).unk_220 =
        BgCheck_EntityRaycastFloor3(&mut (*globalCtx).colCtx, &mut sp38,
                                    &mut sp24, &mut sp28);
    (*this).actor.shape.rot.x =
        (Math_FAtan2F((*this).actor.world.pos.y - (*this).unk_220, 30.0f32) *
             (0x8000 as libc::c_int as libc::c_float /
                  3.14159265358979323846f32)) as s16;
}
static mut sActionFuncs: [EnHorseNormalActionFunc; 5] =
    unsafe {
        [Some(EnHorseNormal_CycleAnimations as
                  unsafe extern "C" fn(_: *mut EnHorseNormal,
                                       _: *mut GlobalContext) -> ()),
         Some(EnHorseNormal_Wander as
                  unsafe extern "C" fn(_: *mut EnHorseNormal,
                                       _: *mut GlobalContext) -> ()),
         Some(EnHorseNormal_Wait as
                  unsafe extern "C" fn(_: *mut EnHorseNormal,
                                       _: *mut GlobalContext) -> ()),
         Some(EnHorseNormal_WaitClone as
                  unsafe extern "C" fn(_: *mut EnHorseNormal,
                                       _: *mut GlobalContext) -> ()),
         Some(EnHorseNormal_FollowPath as
                  unsafe extern "C" fn(_: *mut EnHorseNormal,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnHorseNormal = thisx as *mut EnHorseNormal;
    let mut pad: s32 = 0;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 35.0f32,
                            100.0f32, 0x1d as libc::c_int);
    if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT20 as libc::c_int &&
           (*this).actor.world.pos.z < -2400.0f32 {
        (*this).actor.world.pos.z = -2400.0f32
    }
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actor.focus.pos.y += 70.0f32;
    (*this).unk_204 = (*this).actor.projectedPos;
    (*this).unk_204.y += 120.0f32;
    ...
    } else { (*this).actor.colChkInfo.mass = 0xfe as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6CAFC(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
    ...
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < (*this).headCollider.count {
        sp4C.x =
            (*(*this).headCollider.elements.offset(i as
    ...
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).headCollider.base);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6CC88(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut EnHorseNormal,
                                       mut arg2: *mut Vec3f) {
    let mut curFrame: f32_0 = (*this).skin.skelAnime.curFrame;
    let mut wDest: f32_0 = 0.;
    SkinMatrix_Vec3fMtxFMultXYZW(&mut (*globalCtx).viewProjectionMtxF, arg2,
                                 &mut (*this).unk_1E8, &mut wDest);
    (*this).unk_1F4 = (*this).unk_1E8;
    (*this).unk_1F4.y += 120.0f32;
    if (*this).animationIdx == 0 as libc::c_int && curFrame > 28.0f32 &&
           (*this).unk_1E4 as libc::c_int & 8 as libc::c_int == 0 {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int | 8 as libc::c_int) as u16_0;
        Audio_PlaySoundGeneral(0x282c as libc::c_int as u16_0,
                               &mut (*this).unk_1E8, 4 as libc::c_int as u8_0,
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
    } else if (*this).animationIdx == 3 as libc::c_int && curFrame > 25.0f32
                  && (*this).unk_1E4 as libc::c_int & 0x10 as libc::c_int == 0
     {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int | 0x10 as libc::c_int) as u16_0;
        Audio_PlaySoundGeneral(0x282b as libc::c_int as u16_0,
                               ...
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
    } else if (*this).animationIdx == 3 as libc::c_int &&
                  (*this).unk_1E4 as libc::c_int & 0x20 as libc::c_int != 0 {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int & !(0x20 as libc::c_int)) as
                u16_0;
        Audio_PlaySoundGeneral(0x2805 as libc::c_int as u16_0,
                               &mut (*this).unk_1F4, 4 as libc::c_int as u8_0,
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
    } else if (*this).animationIdx == 1 as libc::c_int &&
                  (*this).unk_1E4 as libc::c_int & 0x20 as libc::c_int != 0 {
        (*this).unk_1E4 =
            ((*this).unk_1E4 as libc::c_int & !(0x20 as libc::c_int)) as
                u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseNormal_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnHorseNormal = thisx as *mut EnHorseNormal;
    let mut mtx2: *mut Mtx = 0 as *mut Mtx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_horse_normal.c\x00" as *const u8 as
                        *const libc::c_char, 2224 as libc::c_int);
    if (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT20 as libc::c_int ||
    ...
    func_800A6330(&mut (*this).actor, globalCtx, &mut (*this).skin,
                  Some(func_80A6CAFC as
                           unsafe extern "C" fn(_: *mut Actor,
                                                _: *mut GlobalContext,
                                                _: *mut PSkinAwb) -> ()),
                  1 as libc::c_int);
    if (*this).action == HORSE_WAIT_CLONE as libc::c_int {
        let mut skinMtx: MtxF = MtxF{mf: [[0.; 4]; 4],};
        let mut mtx1: *mut Mtx = 0 as *mut Mtx;
        let mut clonePos: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut cloneRotY: s16 = 0;
        let mut distFromGround: f32_0 =
            (*this).actor.world.pos.y - (*this).actor.floorHeight;
        let mut temp_f0_4: f32_0 = 0.;
        if (*globalCtx).sceneNum as libc::c_int ==
               SCENE_MALON_STABLE as libc::c_int {
            if (*this).actor.world.pos.x == 355.0f32 &&
                   (*this).actor.world.pos.y == 0.0f32 &&
                   (*this).actor.world.pos.z == -245.0f32 {
                clonePos.x = 235.0f32;
                clonePos.y = 0.0f32;
                clonePos.z = 100.0f32;
                cloneRotY = 0x7fff as libc::c_int as s16
            } else if (*this).actor.world.pos.x == 238.0f32 &&
                          (*this).actor.world.pos.y == 0.0f32 &&
                          (*this).actor.world.pos.z == -245.0f32 {
                clonePos.x = 478.0f32;
                clonePos.y = 0.0f32;
            ...
            if (*this).actor.world.pos.x == -730.0f32 &&
                ...
                clonePos.y = 0.0f32;
                clonePos.z = -80.0f32;
                cloneRotY = 0 as libc::c_int as s16
            } else if (*this).actor.world.pos.x == 880.0f32 &&
                          (*this).actor.world.pos.y == 0.0f32 &&
                          (*this).actor.world.pos.z == -1170.0f32 {
                clonePos.x = -1000.0f32;
                clonePos.y = 0.0f32;
                clonePos.z = -70.0f32;
                cloneRotY = 0 as libc::c_int as s16
            }
        }
        func_80A6CC88(globalCtx, this, &mut clonePos);
        SkinMatrix_SetTranslateRotateYXZScale(&mut skinMtx,
                                              (*this).actor.scale.x,
                                              (*this).actor.scale.y,
                                              (*this).actor.scale.z,
                                              (*this).actor.shape.rot.x,
                                              ...
                                              (*this).actor.shape.yOffset *
                                                  (*this).actor.scale.y +
                                                  clonePos.y, clonePos.z);
        mtx1 =
            SkinMatrix_MtxFToNewMtx((*globalCtx).state.gfxCtx, &mut skinMtx);
        if mtx1.is_null() { return }
            ...
            (0xda as libc::c_int as u32_0 &
                ...
                (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                     ...
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = mtx1 as libc::c_uint;
        func_800A63CC(&mut (*this).actor, globalCtx, &mut (*this).skin, None,
                      None, 1 as libc::c_int, 0 as libc::c_int,
                      3 as libc::c_int);
        (*this).cloneCollider.dim.pos.x = clonePos.x as s16;
        (*this).cloneCollider.dim.pos.y = clonePos.y as s16;
        (*this).cloneCollider.dim.pos.z = clonePos.z as s16;
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).cloneCollider.base);
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        Matrix_Translate(clonePos.x, clonePos.y, clonePos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        temp_f0_4 =
            (1.0f32 - distFromGround * 0.01f32) *
                (*this).actor.shape.shadowScale;
        Matrix_Scale((*this).actor.scale.x * temp_f0_4, 1.0f32,
                     (*this).actor.scale.z * temp_f0_4,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY(cloneRotY as libc::c_int as libc::c_float *
                ...
                (0xda as libc::c_int as u32_0 &
                    ...
                    (((0 as libc::c_int | 0x2 as libc::c_int |
                         ...
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_2).words.w1 = mtx2 as libc::c_uint;
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = gHorseShadowDL.as_mut_ptr() as libc::c_uint
        }
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_horse_normal.c\x00" as *const u8 as
                         *const libc::c_char, 2339 as libc::c_int);
}
