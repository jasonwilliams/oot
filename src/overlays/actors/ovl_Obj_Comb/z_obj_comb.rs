...
extern "C" {
    ...
    #[no_mangle]
    static mut gFieldBeehiveDL: [Gfx; 0];
    #[no_mangle]
    static mut gFieldBeehiveFragmentDL: [Gfx; 0];
}
...
pub struct ObjComb {
    pub actor: Actor,
    pub actionFunc: ObjCombActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub unk_1B0: s16,
    pub unk_1B2: s16,
}
pub type ObjCombActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjComb, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Obj_Comb_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_COMB as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjComb_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Break(mut this: *mut ObjComb,
    ...
    let mut dlist: *mut Gfx = gFieldBeehiveFragmentDL.as_mut_ptr();
    let mut scale: s16 = 0;
    ...
    while i < 31 as libc::c_int {
        ...
        pos1.y = (i - 15 as libc::c_int) as libc::c_float * 0.7f32;
        pos1.z = Math_CosS(angle) * rand1;
        Math_Vec3f_Sum(&mut pos1, &mut (*this).actor.world.pos, &mut pos);
        velocity.x = Rand_ZeroOne() - 0.5f32 + pos1.x * 0.5f32;
        velocity.y = Rand_ZeroOne() - 0.5f32 + pos1.y * 0.6f32;
        velocity.z = Rand_ZeroOne() - 0.5f32 + pos1.z * 0.5f32;
        scale = (Rand_ZeroOne() * 72.0f32 + 25.0f32) as s16;
        if (scale as libc::c_int) < 40 as libc::c_int {
            gravity = -(200 as libc::c_int) as s16;
            arg6 = 40 as libc::c_int as u8_0
        } else if (scale as libc::c_int) < 70 as libc::c_int {
            gravity = -(280 as libc::c_int) as s16;
            arg6 = 30 as libc::c_int as u8_0
        } else {
            gravity = -(340 as libc::c_int) as s16;
            arg6 = 20 as libc::c_int as u8_0
        }
        rand2 = Rand_ZeroOne();
        if rand2 < 0.1f32 {
            arg5 = 96 as libc::c_int as u8_0
        } else if rand2 < 0.8f32 {
            arg5 = 64 as libc::c_int as u8_0
        } else { arg5 = 32 as libc::c_int as u8_0 }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             gravity, arg5 as s16, arg6 as s16,
                             4 as libc::c_int as s16, 0 as libc::c_int as s16,
                             scale, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16, 80 as libc::c_int,
    ...
    pos.y = (*this).actor.world.pos.y - 10.0f32;
    pos.z = (*this).actor.world.pos.z;
    func_80033480(globalCtx, &mut pos, 40.0f32, 6 as libc::c_int,
                  70 as libc::c_int as s16, 60 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjComb_ChooseItemDrop(mut this: *mut ObjComb,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut params: s16 =
        ((*this).actor.params as libc::c_int & 0x1f as libc::c_int) as s16;
    if params as libc::c_int > 0 as libc::c_int ||
           (params as libc::c_int) < 0x1a as libc::c_int {
        if params as libc::c_int == 6 as libc::c_int {
            if Flags_GetCollectible(globalCtx,
                                    (*this).actor.params as libc::c_int >>
                                        8 as libc::c_int &
                                        0x3f as libc::c_int) != 0 {
                params = -(1 as libc::c_int) as s16
            } else {
                params =
...
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjComb = thisx as *mut ObjComb;
...
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Destroy(mut thisx: *mut Actor,
...
#[no_mangle]
pub unsafe extern "C" fn ObjComb_SetupWait(mut this: *mut ObjComb) {
    (*this).actionFunc =
        Some(ObjComb_Wait as
                 unsafe extern "C" fn(_: *mut ObjComb, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Wait(mut this: *mut ObjComb,
                                      mut globalCtx: *mut GlobalContext) {
    let mut dmgFlags: s32 = 0;
    (*this).unk_1B0 =
        ((*this).unk_1B0 as libc::c_int - 50 as libc::c_int) as s16;
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        dmgFlags =
            (*(*(*this).collider.elements.offset(0 as libc::c_int as
                                                     isize)).info.acHitInfo).toucher.dmgFlags
                as s32;
        if dmgFlags & 0x4001f866 as libc::c_int != 0 {
            (*this).unk_1B0 = 1500 as libc::c_int as s16
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjComb = thisx as *mut ObjComb;
    (*this).unk_1B2 =
        ((*this).unk_1B2 as libc::c_int + 0x2ee0 as libc::c_int) as s16;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    (*this).actor.shape.rot.x =
        (Math_SinS((*this).unk_1B2) *
             (*this).unk_1B0 as libc::c_int as libc::c_float +
             (*this).actor.home.rot.x as libc::c_int as libc::c_float) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjComb_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjComb = thisx as *mut ObjComb;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gFieldBeehiveDL.as_mut_ptr() as libc::c_uint;
