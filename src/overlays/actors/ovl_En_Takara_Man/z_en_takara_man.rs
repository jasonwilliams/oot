...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ts_Anim_000498: AnimationHeader;
    #[no_mangle]
    static mut object_ts_Tex_000970: [u64_0; 0];
    #[no_mangle]
    static mut object_ts_Tex_000D70: [u64_0; 0];
    #[no_mangle]
    static mut object_ts_Skel_004FE0: FlexSkeletonHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnTakaraMan {
    pub actor: Actor,
    pub actionFunc: EnTakaraManActionFunc,
    pub skelAnime: SkelAnime,
...
pub type EnTakaraManActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTakaraMan, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Takara_Man_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TAKARA_MAN as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_TS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTakaraMan>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTakaraMan_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTakaraMan_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTakaraMan_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTakaraMan_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTakaraIsInitialized: u8_0 = 0 as libc::c_int as u8_0;
#[no_mangle]
pub unsafe extern "C" fn EnTakaraMan_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnTakaraMan_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTakaraMan = thisx as *mut EnTakaraMan;
    if sTakaraIsInitialized != 0 {
    ...
    sTakaraIsInitialized = 1 as libc::c_int as u8_0;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Bun! %x" (needs a better translation)
    osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\xb0\xe3\x81\x85\xe3\x82\x93\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*globalCtx).actorCtx.flags.chest);
    (*globalCtx).actorCtx.flags.chest = 0 as libc::c_int as u32_0;
    gSaveContext.inventory.dungeonKeys[gSaveContext.mapIndex as usize] =
        -(1 as libc::c_int) as s8;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_ts_Skel_004FE0, &mut object_ts_Anim_000498,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 10 as libc::c_int);
    (*thisx).focus.pos = (*thisx).world.pos;
    (*this).pos = (*thisx).world.pos;
    (*thisx).world.pos.x = 133.0f32;
    (*thisx).world.pos.y = -12.0f32;
    (*thisx).world.pos.z = 102.0f32;
    Actor_SetScale(&mut (*this).actor, 0.013f32);
    (*this).height = 90.0f32;
    (*this).originalRoomNum = (*thisx).room as s16;
    (*thisx).room = -(1 as libc::c_int) as s8;
    (*thisx).shape.rot.y = -(0x4e20 as libc::c_int) as s16;
    (*thisx).world.rot.y = (*thisx).shape.rot.y;
    (*thisx).targetMode = 1 as libc::c_int as s8;
    (*this).actionFunc =
        Some(func_80B176E0 as
                 unsafe extern "C" fn(_: *mut EnTakaraMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B176E0(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut object_ts_Anim_000498 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_ts_Anim_000498,
                     1.0f32, 0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    if (*this).unk_214 == 0 {
        (*this).actor.textId = 0x6d as libc::c_int as u16_0;
        (*this).dialogState = TEXT_STATE_CHOICE as libc::c_int as s16
    }
    (*this).actionFunc =
        Some(func_80B1778C as
                 unsafe extern "C" fn(_: *mut EnTakaraMan,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B1778C(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 &&
        ...
        if (*this).unk_214 == 0 {
            (*this).actionFunc =
                Some(func_80B17934 as
                         unsafe extern "C" fn(_: *mut EnTakaraMan,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(func_80B17B14 as
                         unsafe extern "C" fn(_: *mut EnTakaraMan,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
        ...
        if (*globalCtx).roomCtx.curRoom.num as libc::c_int == 6 as libc::c_int
               && (*this).unk_21A == 0 {
            (*this).actor.textId = 0x6e as libc::c_int as u16_0;
            (*this).unk_21A = 1 as libc::c_int as s16;
            (*this).dialogState = TEXT_STATE_DONE as libc::c_int as s16
        }
        if (*this).unk_21A == 0 && (*this).unk_214 as libc::c_int != 0 {
            if Flags_GetSwitch(globalCtx, 0x32 as libc::c_int) != 0 {
                (*this).actor.textId = 0x84 as libc::c_int as u16_0;
                (*this).dialogState = TEXT_STATE_EVENT as libc::c_int as s16
            } else {
                (*this).actor.textId = 0x704c as libc::c_int as u16_0;
                (*this).dialogState = TEXT_STATE_DONE as libc::c_int as s16
            }
        }
        absYawDiff =
        ...
        if (absYawDiff as libc::c_int) < 0x4300 as libc::c_int {
            if (*globalCtx).roomCtx.curRoom.num as libc::c_int !=
                   (*this).originalRoomNum as libc::c_int {
                (*this).actor.flags &=
                ...
                if (*this).unk_218 == 0 {
                    (*this).actor.flags |=
                        ((1 as libc::c_int) << 0 as libc::c_int) as
                            libc::c_uint;
                    (*this).unk_218 = 1 as libc::c_int as s16
                }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B17934(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if gSaveContext.rupees as libc::c_int >= 10 as libc::c_int {
                    ...
                    (*this).unk_214 = 1 as libc::c_int as s16;
                    (*this).actor.parent = 0 as *mut Actor;
                    func_8002F434(&mut (*this).actor, globalCtx,
                                  GI_DOOR_KEY as libc::c_int, 2000.0f32,
                                  1000.0f32);
                    (*this).actionFunc =
                        Some(func_80B17A6C as
                                 unsafe extern "C" fn(_: *mut EnTakaraMan,
                                                      _: *mut GlobalContext)
                                     -> ())
                } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B17A6C(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80B17AC4 as
                     unsafe extern "C" fn(_: *mut EnTakaraMan,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_DOOR_KEY as libc::c_int, 2000.0f32, 1000.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B17AC4(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B17B14(mut this: *mut EnTakaraMan,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).dialogState as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnTakaraMan_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnTakaraMan = thisx as *mut EnTakaraMan;
    ...
    func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_22C,
                  &mut (*this).unk_232, (*this).actor.focus.pos);
    if (*this).eyeTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnTakaraMan_OverrideLimbDraw(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut limbIndex: s32,
                                                      mut dList:
                                                          *mut *mut Gfx,
 ...
 -> s32 {
    ...
    if limbIndex == 1 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_232.y as libc::c_int) as
                s16
    }
    if limbIndex == 8 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).unk_22C.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).unk_22C.z as libc::c_int) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnTakaraMan_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 2] =
        unsafe {
            [object_ts_Tex_000970.as_ptr() as *mut _ as *mut libc::c_void,
             object_ts_Tex_000D70.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnTakaraMan = thisx as *mut EnTakaraMan;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_takara_man.c\x00" as *const u8 as
                        *const libc::c_char, 528 as libc::c_int);
    ...
    (*_g).words.w1 =
        gSegments[((eyeTextures[(*this).eyeTextureIdx as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(eyeTextures[(*this).eyeTextureIdx as
                                                          usize] as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnTakaraMan_OverrideLimbDraw as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_takara_man.c\x00" as *const u8 as
                         *const libc::c_char, 544 as libc::c_int);
}
