...
extern "C" {
    ...
    fn coss(_: u16_0) -> s16;
    #[no_mangle]
    static mut gCraterBombableWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gCraterBombableWallCracksDL: [Gfx; 0];
    #[no_mangle]
    static mut gCraterBombableWallCol: CollisionHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot17Bakudankabe {
...
#[no_mangle]
pub static mut Bg_Spot17_Bakudankabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id:
                              ACTOR_BG_SPOT17_BAKUDANKABE as libc::c_int as
                                  s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT17_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot17Bakudankabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Bakudankabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Bakudankabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Bakudankabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Bakudankabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn func_808B6BC0(mut this: *mut BgSpot17Bakudankabe,
    ...
    Math_Vec3f_Copy(&mut burstDepthY, &mut (*this).dyna.actor.world.pos);
    func_80033480(globalCtx, &mut burstDepthY, 60.0f32, 4 as libc::c_int,
                  110 as libc::c_int as s16, 160 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
    burstDepthY.y += 40.0f32;
    func_80033480(globalCtx, &mut burstDepthY, 60.0f32, 4 as libc::c_int,
                  120 as libc::c_int as s16, 160 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
    burstDepthY.y += 40.0f32;
    func_80033480(globalCtx, &mut burstDepthY, 60.0f32, 4 as libc::c_int,
                  110 as libc::c_int as s16, 160 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Bakudankabe_Init(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgSpot17Bakudankabe =
        thisx as *mut BgSpot17Bakudankabe;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gCraterBombableWallCol as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Bakudankabe_Destroy(mut thisx: *mut Actor,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut this: *mut BgSpot17Bakudankabe =
        thisx as *mut BgSpot17Bakudankabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Bakudankabe_Update(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut BgSpot17Bakudankabe =
        thisx as *mut BgSpot17Bakudankabe;
    if (*this).dyna.actor.xzDistToPlayer < 650.0f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Bakudankabe_Draw(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut r: s8 =
        (coss((*globalCtx).gameplayFrames.wrapping_mul(1500 as libc::c_int as
                                                           libc::c_uint) as
                  u16_0) as libc::c_int >> 8 as libc::c_int) as s8;
    let mut g: s8 =
        (coss((*globalCtx).gameplayFrames.wrapping_mul(1500 as libc::c_int as
                                                           libc::c_uint) as
                  u16_0) as libc::c_int >> 8 as libc::c_int) as s8;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot17_bakudankabe.c\x00" as *const u8 as
    ...
    r = ((r as libc::c_int >> 1 as libc::c_int) + 0xc0 as libc::c_int) as s8;
    g = ((g as libc::c_int >> 1 as libc::c_int) + 0xc0 as libc::c_int) as s8;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gCraterBombableWallDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_spot17_bakudankabe.c\x00" as *const u8 as
                         *const libc::c_char, 283 as libc::c_int);
    ...
    let fresh3 = (*__gfxCtx_0).polyXlu.p;
    ...
    let fresh4 = (*__gfxCtx_0).polyXlu.p;
    (*__gfxCtx_0).polyXlu.p = (*__gfxCtx_0).polyXlu.p.offset(1);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gCraterBombableWallCracksDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs_0.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_spot17_bakudankabe.c\x00" as *const u8 as
                         *const libc::c_char, 295 as libc::c_int);
}
