...
extern "C" {
    ...
    fn DynaPoly_GetActor(colCtx: *mut CollisionContext, bgId: s32)
     -> *mut DynaPolyActor;
    #[no_mangle]
    fn SurfaceType_IsHookshotSurface(colCtx: *mut CollisionContext,
    ...
    #[no_mangle]
    static mut D_0602B288: [Gfx; 0];
    #[no_mangle]
    static mut D_0602AFF0: [Gfx; 0];
}
...
pub type ArmsHookActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut ArmsHook, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Arms_Hook_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ARMS_HOOK as libc::c_int as s16,
                          category:
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_LINK_BOY as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ArmsHook>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArmsHook_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ArmsHook_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80865B70: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80865B7C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 900.0f32,}; init };
static mut D_80865B88: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 500.0f32, z: -3000.0f32,}; init };
static mut D_80865B94: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: -500.0f32, z: -3000.0f32,}; init };
static mut D_80865BA0: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 500.0f32, z: 1200.0f32,}; init };
static mut D_80865BAC: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: -500.0f32, z: 1200.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_SetupAction(mut this: *mut ArmsHook,
                                              mut actionFunc:
                                                  ArmsHookActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArmsHook = thisx as *mut ArmsHook;
    Collider_InitQuad(globalCtx, &mut (*this).collider);
    Collider_SetQuad(globalCtx, &mut (*this).collider, &mut (*this).actor,
                     &mut sQuadInit);
    ArmsHook_SetupAction(this,
                         Some(ArmsHook_Wait as
                                  unsafe extern "C" fn(_: *mut ArmsHook,
                                                       _: *mut GlobalContext)
                                      -> ()));
    (*this).unk_1E8 = (*this).actor.world.pos;
}
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArmsHook = thisx as *mut ArmsHook;
    if !(*this).grabbed.is_null() {
        (*(*this).grabbed).flags &=
...
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Wait(mut this: *mut ArmsHook,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.parent.is_null() {
        ...
        let mut length: s32 =
            if (*player).heldItemActionParam as libc::c_int ==
                ...
                13 as libc::c_int
            } else { 26 as libc::c_int };
        ArmsHook_SetupAction(this,
                             Some(ArmsHook_Shoot as
                                      unsafe extern "C" fn(_: *mut ArmsHook,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
        func_8002D9A4(&mut (*this).actor, 20.0f32);
        (*this).actor.parent =
            &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                               ...
                                                                               isize)).head
                        as *mut Player)).actor;
        (*this).timer = length as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80865044(mut this: *mut ArmsHook) {
    (*this).actor.child = (*this).actor.parent;
    (*(*this).actor.parent).parent = &mut (*this).actor;
}
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_AttachToPlayer(mut this: *mut ArmsHook,
                                                 mut player: *mut Player)
 -> s32 {
    (*player).actor.child = &mut (*this).actor;
    (*player).heldActor = &mut (*this).actor;
...
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_DetachHookFromActor(mut this:
                                                          *mut ArmsHook) {
    if !(*this).grabbed.is_null() {
        (*(*this).grabbed).flags &=
            !((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint;
        (*this).grabbed = 0 as *mut Actor
    };
}
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_CheckForCancel(mut this: *mut ArmsHook)
 -> s32 {
    let mut player: *mut Player = (*this).actor.parent as *mut Player;
    if Player_HoldsHookshot(player) != 0 {
        if (*player).itemActionParam as libc::c_int !=
               (*player).heldItemActionParam as libc::c_int ||
               (*player).actor.flags &
                   ((1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint !=
                   0 ||
               (*player).stateFlags1 &
                   0x4000080 as libc::c_int as libc::c_uint != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_AttachHookToActor(mut this: *mut ArmsHook,
                                                    mut actor: *mut Actor) {
    (*actor).flags |=
        ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint;
    (*this).grabbed = actor;
    Math_Vec3f_Diff(&mut (*actor).world.pos, &mut (*this).actor.world.pos,
                    &mut (*this).grabbedDistDiff);
}
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Shoot(mut this: *mut ArmsHook,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut touchedActor: *mut Actor = 0 as *mut Actor;
    let mut grabbed: *mut Actor = 0 as *mut Actor;
    let mut bodyDistDiffVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut newPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut bodyDistDiff: f32_0 = 0.;
    ...
    let mut prevFrameDiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp60: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp5C: f32_0 = 0.;
    let mut sp58: f32_0 = 0.;
    let mut velocity: f32_0 = 0.;
    let mut pad1: s32 = 0;
    if (*this).actor.parent.is_null() || Player_HoldsHookshot(player) == 0 {
        ArmsHook_DetachHookFromActor(this);
    ...
    if (*this).timer as libc::c_int != 0 as libc::c_int &&
        ...
        if (*touchedActor).update.is_some() &&
               (*touchedActor).flags &
                   ((1 as libc::c_int) << 9 as libc::c_int |
                        (1 as libc::c_int) << 10 as libc::c_int) as
                       libc::c_uint != 0 {
            if (*(*this).collider.info.atHitInfo).bumperFlags as libc::c_int &
                   (1 as libc::c_int) << 2 as libc::c_int != 0 {
                ArmsHook_AttachHookToActor(this, touchedActor);
                if (*touchedActor).flags &
                       ((1 as libc::c_int) << 10 as libc::c_int) as
                           libc::c_uint ==
                       ((1 as libc::c_int) << 10 as libc::c_int) as
                           libc::c_uint {
        ...
        (*this).timer = 0 as libc::c_int as s16;
        Audio_PlaySoundGeneral(0x1814 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if (if (*this).timer as libc::c_int == 0 as libc::c_int {
                   0 as libc::c_int
               } else { (*this).timer -= 1; (*this).timer as libc::c_int }) ==
                  0 as libc::c_int {
        grabbed = (*this).grabbed;
        if !grabbed.is_null() {
            if (*grabbed).update.is_none() ||
                   !((*grabbed).flags &
                         ((1 as libc::c_int) << 13 as libc::c_int) as
                             libc::c_uint ==
                         ((1 as libc::c_int) << 13 as libc::c_int) as
                             libc::c_uint) {
                grabbed = 0 as *mut Actor;
                (*this).grabbed = 0 as *mut Actor
            } else if !(*this).actor.child.is_null() {
                sp94 = Actor_WorldDistXYZToActor(&mut (*this).actor, grabbed);
                sp90 =
                    sqrtf((*this).grabbedDistDiff.x *
                              (*this).grabbedDistDiff.x +
                              (*this).grabbedDistDiff.y *
                                  (*this).grabbedDistDiff.y +
                              (*this).grabbedDistDiff.z *
                                  (*this).grabbedDistDiff.z);
                Math_Vec3f_Diff(&mut (*grabbed).world.pos,
                                &mut (*this).grabbedDistDiff,
                                &mut (*this).actor.world.pos);
                if 50.0f32 < sp94 - sp90 {
                    ArmsHook_DetachHookFromActor(this);
                    grabbed = 0 as *mut Actor
                }
            }
        ...
        bodyDistDiff =
            Math_Vec3f_DistXYZAndStoreDiff(&mut (*player).unk_3C8,
                                           &mut (*this).actor.world.pos,
                                           &mut bodyDistDiffVec);
        if bodyDistDiff < 30.0f32 {
            velocity = 0.0f32;
            phi_f16 = 0.0f32
        } else {
            if !(*this).actor.child.is_null() {
                velocity = 30.0f32
            } else if !grabbed.is_null() {
                velocity = 50.0f32
            } else { velocity = 200.0f32 }
            phi_f16 = bodyDistDiff - velocity;
            if bodyDistDiff <= velocity { phi_f16 = 0.0f32 }
        ...
        if (*this).actor.child.is_null() {
            if !grabbed.is_null() &&
                   (*grabbed).id as libc::c_int ==
                       ACTOR_BG_SPOT06_OBJECTS as libc::c_int {
                Math_Vec3f_Diff(&mut (*grabbed).world.pos,
                                &mut (*this).grabbedDistDiff,
                                &mut (*this).actor.world.pos);
                phi_f16 = 1.0f32
            } else {
                Math_Vec3f_Sum(&mut (*player).unk_3C8, &mut newPos,
                               &mut (*this).actor.world.pos);
                if !grabbed.is_null() {
                    Math_Vec3f_Sum(&mut (*this).actor.world.pos,
                                   &mut (*this).grabbedDistDiff,
                                   &mut (*grabbed).world.pos);
                }
            }
        } else {
            Math_Vec3f_Diff(&mut bodyDistDiffVec, &mut newPos,
                            &mut (*player).actor.velocity);
            (*player).actor.world.rot.x =
                Math_Atan2S(sqrtf(bodyDistDiffVec.x * bodyDistDiffVec.x +
                                      bodyDistDiffVec.z * bodyDistDiffVec.z),
                            -bodyDistDiffVec.y)
        }
        if phi_f16 < 50.0f32 {
            ArmsHook_DetachHookFromActor(this);
            if phi_f16 == 0.0f32 {
                ...
                if ArmsHook_AttachToPlayer(this, player) != 0 {
                    Math_Vec3f_Diff(&mut (*this).actor.world.pos,
                                    &mut (*player).actor.world.pos,
                                    &mut (*player).actor.velocity);
                    (*player).actor.velocity.y -= 20.0f32
                }
            }
        }
    } else {
        ...
        Math_Vec3f_Diff(&mut (*this).actor.world.pos,
                        &mut (*this).actor.prevPos, &mut prevFrameDiff);
        Math_Vec3f_Sum(&mut (*this).unk_1E8, &mut prevFrameDiff,
                       &mut (*this).unk_1E8);
        ...
        if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut sp60,
                                   &mut (*this).unk_1E8, &mut sp78, &mut poly,
                                   1 as libc::c_int, 1 as libc::c_int,
                                   1 as libc::c_int, 1 as libc::c_int,
                                   &mut bgId) != 0 &&
               func_8002F9EC(globalCtx, &mut (*this).actor, poly, bgId,
                             &mut sp78) == 0 {
            sp5C =
            ...
            sp58 =
                (*poly).normal.z as libc::c_int as libc::c_float *
                    (1.0f32 / 32767.0f32);
            Math_Vec3f_Copy(&mut (*this).actor.world.pos, &mut sp78);
            (*this).actor.world.pos.x += 10.0f32 * sp5C;
            (*this).actor.world.pos.z += 10.0f32 * sp58;
            (*this).timer = 0 as libc::c_int as s16;
            if SurfaceType_IsHookshotSurface(&mut (*globalCtx).colCtx, poly,
                                             bgId) != 0 {
                if bgId != 50 as libc::c_int {
                    dynaPolyActor =
                        DynaPoly_GetActor(&mut (*globalCtx).colCtx, bgId);
                    if !dynaPolyActor.is_null() {
                        ArmsHook_AttachHookToActor(this,
                                                   &mut (*dynaPolyActor).actor);
                    }
                }
                func_80865044(this);
                Audio_PlaySoundGeneral(0x1829 as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                ...
                CollisionCheck_SpawnShieldParticlesMetal(globalCtx,
                                                         &mut (*this).actor.world.pos);
                Audio_PlaySoundGeneral(0x1813 as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
            }
        } else if (*globalCtx).state.input[0 as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ArmsHook = thisx as *mut ArmsHook;
...
#[no_mangle]
pub unsafe extern "C" fn ArmsHook_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ArmsHook = thisx as *mut ArmsHook;
    let mut player: *mut Player =
    ...
    let mut sp5C: f32_0 = 0.;
    let mut sp58: f32_0 = 0.;
    if (*player).actor.draw.is_some() &&
           (*player).rightHandType as libc::c_int == 15 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_arms_hook.c\x00" as *const u8 as
                            *const libc::c_char, 850 as libc::c_int);
        if Some(ArmsHook_Shoot as
                    unsafe extern "C" fn(_: *mut ArmsHook,
                                         _: *mut GlobalContext) -> ()) !=
               (*this).actionFunc ||
               (*this).timer as libc::c_int <= 0 as libc::c_int {
            Matrix_MultVec3f(&mut D_80865B70, &mut (*this).unk_1E8);
            Matrix_MultVec3f(&mut D_80865B88, &mut sp6C);
            Matrix_MultVec3f(&mut D_80865B94, &mut sp60);
            (*this).hookInfo.active = 0 as libc::c_int
        } else {
            Matrix_MultVec3f(&mut D_80865B7C, &mut (*this).unk_1E8);
            Matrix_MultVec3f(&mut D_80865BA0, &mut sp6C);
            Matrix_MultVec3f(&mut D_80865BAC, &mut sp60);
        }
        func_80090480(globalCtx, &mut (*this).collider, &mut (*this).hookInfo,
                      &mut sp6C, &mut sp60);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = D_0602B288.as_mut_ptr() as libc::c_uint;
        Matrix_Translate((*this).actor.world.pos.x, (*this).actor.world.pos.y,
                         (*this).actor.world.pos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Math_Vec3f_Diff(&mut (*player).unk_3C8, &mut (*this).actor.world.pos,
                        &mut sp78);
        sp58 = sp78.x * sp78.x + sp78.z * sp78.z;
        sp5C = sqrtf(sp58);
        Matrix_RotateY(Math_FAtan2F(sp78.x, sp78.z),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateX(Math_FAtan2F(-sp78.y, sp5C),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(0.015f32, 0.015f32,
                     sqrtf(sp78.y * sp78.y + sp58) * 0.01f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = D_0602AFF0.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_arms_hook.c\x00" as *const u8 as
                             *const libc::c_char, 913 as libc::c_int);
    };
}
