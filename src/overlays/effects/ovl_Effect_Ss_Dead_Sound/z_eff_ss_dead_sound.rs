...
#[no_mangle]
pub static mut Effect_Ss_Dead_Sound_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_DEAD_SOUND as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDeadSound_Init as
 ...
 */
// sound is replayed every update. unused in the original game
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadSound_Init(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                ...
                                                mut initParamsx:
                                                    *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsDeadSoundInitParams =
        initParamsx as *mut EffectSsDeadSoundInitParams; // "constructor 3"
    (*this).pos =
        (*initParams).pos; // decrement to 0 so sound only plays once
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).flags = 2 as libc::c_int as u16_0;
    (*this).life = (*initParams).life as s16;
    (*this).draw = None;
    (*this).update =
        Some(EffectSsDeadSound_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[11 as libc::c_int as usize] = (*initParams).repeatMode;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).sfxId as s16;
    osSyncPrintf(b"\xe3\x82\xb3\xe3\x83\xb3\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x82\xbf\xe3\x83\xbc3\n\x00"
                     as *const u8 as *const libc::c_char);
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadSound_Update(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut index: u32_0,
                                                  mut this: *mut EffectSs) {
    match (*this).regs[11 as libc::c_int as usize] as libc::c_int {
        1 => { (*this).regs[11 as libc::c_int as usize] -= 1 }
        2 => { }
        _ => { return }
    }
    Audio_PlaySoundGeneral((*this).regs[10 as libc::c_int as usize] as u16_0,
                           &mut (*this).pos, 4 as libc::c_int as u8_0,
