...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsFireTail_SpawnFlame(globalCtx: *mut GlobalContext,
                                   actor: *mut Actor, pos: *mut Vec3f,
                                   arg3: f32_0, bodyPart: s16,
    ...
    #[no_mangle]
    static mut gLinkChildDekuShieldDL: [Gfx; 0];
}
...
pub struct ItemShield {
    ...
    pub unk_19E: [u8_0; 8],
    pub unk_1A8: [Vec3f; 8],
    pub actionFunc: ItemShieldActionFunc,
}
pub type ItemShieldActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ItemShield, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Item_Shield_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ITEM_SHIELD as libc::c_int as s16,
                          category:
                              ACTORCAT_ITEMACTION as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_LINK_CHILD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ItemShield>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemShield_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemShield_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemShield_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemShield_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ItemShield_SetupAction(mut this: *mut ItemShield,
                                                mut actionFunc:
                                                    ItemShieldActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ItemShield_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemShield = thisx as *mut ItemShield;
    let mut i: s32 = 0;
    (*this).timer = 0 as libc::c_int as s16;
    (*this).unk_19C = 0 as libc::c_int as s16;
    match (*this).actor.params as libc::c_int {
        0 => {
            ActorShape_Init(&mut (*this).actor.shape, 1400.0f32, None,
                            0.0f32);
            (*this).actor.shape.rot.x = 0x4000 as libc::c_int as s16;
            ItemShield_SetupAction(this,
                                   Some(func_80B86BC8 as
                                            unsafe extern "C" fn(_:
                                                                     *mut ItemShield,
                                                                 _:
                                                                     *mut GlobalContext)
            ...
            ItemShield_SetupAction(this,
                                   Some(func_80B86F68 as
                                            unsafe extern "C" fn(_:
                                                ...
                                                -> ()));
            (*this).unk_19C =
                ((*this).unk_19C as libc::c_int | 2 as libc::c_int) as s16;
            i = 0 as libc::c_int;
            while i < 8 as libc::c_int {
                (*this).unk_19E[i as usize] =
                    (1 as libc::c_int + 2 as libc::c_int * i) as u8_0;
                (*this).unk_1A8[i as usize].x = Rand_CenteredFloat(10.0f32);
                (*this).unk_1A8[i as usize].y = Rand_CenteredFloat(10.0f32);
                (*this).unk_1A8[i as usize].z = Rand_CenteredFloat(10.0f32);
                i += 1
            }
        }
        _ => { }
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInit);
    osSyncPrintf(b"\x1b[32mItem_Shild %d \n\x1b[m\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ItemShield_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut ItemShield = thisx as *mut ItemShield;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B86AC8(mut this: *mut ItemShield,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    func_8002F434(&mut (*this).actor, globalCtx,
                  GI_SHIELD_DEKU as libc::c_int, 30.0f32, 50.0f32);
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        if ((*this).timer as libc::c_int) < 60 as libc::c_int {
            if (*this).timer as libc::c_int & 1 as libc::c_int != 0 {
                (*this).unk_19C =
                    ((*this).unk_19C as libc::c_int | 2 as libc::c_int) as s16
            } else {
                (*this).unk_19C =
                    ((*this).unk_19C as libc::c_int & !(2 as libc::c_int)) as
                        s16
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B86BC8(mut this: *mut ItemShield,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        Actor_Kill(&mut (*this).actor);
        return
...
#[no_mangle]
pub unsafe extern "C" fn func_80B86CA8(mut this: *mut ItemShield,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_80B871F4: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut D_80B87200: [f32_0; 16] =
        [0.3f32, 0.6f32, 0.9f32, 1.0f32, 1.0f32, 1.0f32, 1.0f32, 1.0f32,
         1.0f32, 0.85f32, 0.7f32, 0.55f32, 0.4f32, 0.25f32, 0.1f32, 0.0f32];
    static mut D_80B87240: [f32_0; 16] =
        [1.0f32, 1.0f32, 1.0f32, 1.0f32, 1.0f32, 1.0f32, 1.0f32, 0.8f32,
         0.6f32, 0.4f32, 0.2f32, 0.0f32, 0.0f32, 0.0f32, 0.0f32, 0.0f32];
    let mut i: s32 = 0;
    let mut temp: s32 = 0;
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32, 10.0f32,
    ...
    (*this).actor.shape.yOffset =
        (if Math_SinS((*this).actor.shape.rot.x) >=
                0 as libc::c_int as libc::c_float {
             Math_SinS((*this).actor.shape.rot.x)
         } else { -Math_SinS((*this).actor.shape.rot.x) }) * 1500.0f32;
    i = 0 as libc::c_int;
    while i < 8 as libc::c_int {
        temp = 15 as libc::c_int - (*this).unk_19E[i as usize] as libc::c_int;
        D_80B871F4.x = (*this).unk_1A8[i as usize].x;
        D_80B871F4.y =
            (*this).unk_1A8[i as usize].y +
                (*this).actor.shape.yOffset * 0.01f32 +
                D_80B87200[temp as usize] * -10.0f32 * 0.2f32;
        D_80B871F4.z = (*this).unk_1A8[i as usize].z;
        EffectSsFireTail_SpawnFlame(globalCtx, &mut (*this).actor,
                                    &mut D_80B871F4,
                                    D_80B87200[temp as usize] * 0.2f32,
                                    -(1 as libc::c_int) as s16,
                                    D_80B87240[temp as usize]);
        if (*this).unk_19E[i as usize] as libc::c_int != 0 as libc::c_int {
            (*this).unk_19E[i as usize] =
                (*this).unk_19E[i as usize].wrapping_sub(1)
        } else if (*this).timer as libc::c_int > 16 as libc::c_int {
            (*this).unk_19E[i as usize] = 15 as libc::c_int as u8_0;
            (*this).unk_1A8[i as usize].x = Rand_CenteredFloat(15.0f32);
            (*this).unk_1A8[i as usize].y = Rand_CenteredFloat(10.0f32);
            (*this).unk_1A8[i as usize].z = Rand_CenteredFloat(15.0f32)
        }
        i += 1
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        (*this).unk_198 =
            ((*this).unk_198 as libc::c_int -
                 ((*this).unk_198 as libc::c_int >> 2 as libc::c_int)) as s16;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int +
                 (*this).unk_198 as libc::c_int) as s16;
        if (*this).timer as libc::c_int >= 8 as libc::c_int &&
               ((*this).timer as libc::c_int) < 24 as libc::c_int {
            Actor_SetScale(&mut (*this).actor,
                           ((*this).timer as libc::c_int - 8 as libc::c_int)
                               as libc::c_float * 0.000625f32);
        }
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
...
#[no_mangle]
pub unsafe extern "C" fn func_80B86F68(mut this: *mut ItemShield,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut shield: *mut MtxF = &mut (*player).shieldMf;
    (*this).actor.world.pos.x = (*shield).c2rust_unnamed.xw;
    (*this).actor.world.pos.y = (*shield).c2rust_unnamed.yw;
    (*this).actor.world.pos.z = (*shield).c2rust_unnamed.zw;
    (*this).unk_19C =
        ((*this).unk_19C as libc::c_int & !(2 as libc::c_int)) as s16;
    (*this).actor.shape.rot.y =
        Math_Atan2S(-(*shield).c2rust_unnamed.zz,
                    -(*shield).c2rust_unnamed.xz);
    (*this).actor.shape.rot.x =
        Math_Atan2S(-(*shield).c2rust_unnamed.yz,
                    sqrtf((*shield).c2rust_unnamed.zz *
                              (*shield).c2rust_unnamed.zz +
                              (*shield).c2rust_unnamed.xz *
                                  (*shield).c2rust_unnamed.xz));
    if (if (*this).actor.shape.rot.x as libc::c_int >= 0 as libc::c_int {
            (*this).actor.shape.rot.x as libc::c_int
        } else { -((*this).actor.shape.rot.x as libc::c_int) }) >
           0x4000 as libc::c_int {
        (*this).unk_19C =
            ((*this).unk_19C as libc::c_int | 1 as libc::c_int) as s16
    }
    ItemShield_SetupAction(this,
                           Some(func_80B86CA8 as
                                    unsafe extern "C" fn(_: *mut ItemShield,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
    (*this).actor.velocity.y = 4.0f64 as f32_0;
    (*this).actor.minVelocityY = -4.0f64 as f32_0;
    (*this).actor.gravity = -0.8f64 as f32_0;
    (*this).unk_198 = 0 as libc::c_int as s16;
    (*this).timer = 70 as libc::c_int as s16;
    (*this).actor.speedXZ = 0 as libc::c_int as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn ItemShield_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ItemShield = thisx as *mut ItemShield;
...
#[no_mangle]
pub unsafe extern "C" fn ItemShield_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemShield = thisx as *mut ItemShield;
    if (*this).unk_19C as libc::c_int & 2 as libc::c_int == 0 {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_item_shield.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((gLinkChildDekuShieldDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gLinkChildDekuShieldDL.as_mut_ptr()
                                                  as u32_0 &
