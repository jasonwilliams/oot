...
extern "C" {
    ...
    #[no_mangle]
    static mut object_dodojr_Anim_0004A0: AnimationHeader;
    #[no_mangle]
    static mut object_dodojr_Anim_0005F0: AnimationHeader;
    #[no_mangle]
    static mut object_dodojr_Anim_000724: AnimationHeader;
    #[no_mangle]
    static mut object_dodojr_Anim_000860: AnimationHeader;
    #[no_mangle]
    static mut object_dodojr_Anim_0009D4: AnimationHeader;
    #[no_mangle]
    static mut object_dodojr_Skel_0020E0: SkeletonHeader;
}
...
pub struct EnDodojr {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDodojrActionFunc,
...
pub type EnDodojrActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDodojr, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
...
pub const BOMB_EXPLOSION: C2RustUnnamed_22 = 1;
pub const BOMB_BODY: C2RustUnnamed_22 = 0;
#[no_mangle]
pub static mut En_Dodojr_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DODOJR as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_DODOJR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDodojr>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDodojr_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDodojr_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnDodojr_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDodojr = thisx as *mut EnDodojr;
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32, None, 18.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_dodojr_Skel_0020E0,
                   &mut object_dodojr_Anim_0009D4,
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(4 as libc::c_int),
                            &mut sColChkInit);
    (*this).actor.naviEnemyId = 0xe as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Actor_SetScale(&mut (*this).actor, 0.02f32);
    (*this).actionFunc =
        Some(func_809F73AC as
                 unsafe extern "C" fn(_: *mut EnDodojr, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDodojr_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDodojr = thisx as *mut EnDodojr;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_809F64D0(mut this: *mut EnDodojr) {
    Audio_PlayActorSound2(&mut (*this).actor, 0x180e as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6510(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext,
                                       mut count: s32) {
    let mut prim: Color_RGBA8 =
        {
            let mut init =
    ...
    while i >= 0 as libc::c_int {
        accel.x = (Rand_ZeroOne() - 0.5f32) * 4.0f32;
        accel.z = (Rand_ZeroOne() - 0.5f32) * 4.0f32;
        pos.x = Math_SinS(angle) * 22.0f32 + (*this).dustPos.x;
        pos.z = Math_CosS(angle) * 22.0f32 + (*this).dustPos.z;
        func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel,
                      &mut prim, &mut env, 120 as libc::c_int as s16,
                      40 as libc::c_int as s16, 10 as libc::c_int as s16);
        i -= 1;
        angle =
            (angle as libc::c_int +
                 (0x10000 as libc::c_int / count) as s16 as libc::c_int) as
                s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809F6730(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: *mut Vec3f) {
    let mut prim: Color_RGBA8 =
        {
    ...
    accel.x = (Rand_ZeroOne() - 0.5f32) * 2 as libc::c_int as libc::c_float;
    accel.z = (Rand_ZeroOne() - 0.5f32) * 2 as libc::c_int as libc::c_float;
    pos.x = Math_SinS(angle) * 11.0f32 + (*arg2).x;
    pos.z = Math_CosS(angle) * 11.0f32 + (*arg2).z;
    func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel, &mut prim,
                  &mut env, 100 as libc::c_int as s16,
                  60 as libc::c_int as s16, 8 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_809F68B0(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actor.velocity.y >= 0.0f32 { return 0 as libc::c_int }
    if (*this).unk_1FC as libc::c_int == 0 as libc::c_int {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        func_809F6510(this, globalCtx, 10 as libc::c_int);
        (*this).actor.velocity.y =
            10.0f32 /
                (4 as libc::c_int - (*this).unk_1FC as libc::c_int) as
                    libc::c_float;
        (*this).unk_1FC -= 1;
        if (*this).unk_1FC as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6994(mut this: *mut EnDodojr) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_dodojr_Anim_000860 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_dodojr_Anim_000860,
                     1.8f32, 0.0f32, lastFrame,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -10.0f32);
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.speedXZ = 2.6f32;
    (*this).actor.gravity = -0.8f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_809F6A20(mut this: *mut EnDodojr) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_dodojr_Anim_0004A0 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_dodojr_Anim_0004A0,
    ...
    (*this).actor.gravity = -0.8f32;
    if (*this).unk_1FC as libc::c_int == 0 as libc::c_int {
        (*this).unk_1FC = 3 as libc::c_int as s16;
        (*this).actor.velocity.y = 10.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809F6AC4(mut this: *mut EnDodojr) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_dodojr_Anim_0005F0 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_dodojr_Anim_0005F0,
                     1.0f32, 0.0f32, lastFrame,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6B38(mut this: *mut EnDodojr) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_dodojr_Anim_000724 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_dodojr_Anim_000724,
                     1.0f32, 0.0f32, lastFrame,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6BBC(mut this: *mut EnDodojr) {
    ...
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.gravity = -0.8f32;
    (*this).timer3 = 30 as libc::c_int as s16;
    (*this).dustPos = (*this).actor.world.pos;
}
#[no_mangle]
pub unsafe extern "C" fn func_809F6C24(mut this: *mut EnDodojr) {
    Animation_Change(&mut (*this).skelAnime, &mut object_dodojr_Anim_000724,
                     1.0f32, 8.0f32, 12.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3826 as libc::c_int as u16_0);
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.x = 0.0f32;
    (*this).actor.velocity.z = 0.0f32;
    (*this).actor.gravity = -0.8f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6CA4(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut bomb: *mut Actor = 0 as *mut Actor;
    let mut unkVec: Vec3f =
        {
            let mut init =
                Vec3f{x: 99999.0f32, y: 99999.0f32, z: 99999.0f32,};
            init
        };
    let mut retVar: s32 = 0 as libc::c_int;
    ...
    bomb =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_EXPLOSIVE as libc::c_int as
                                             usize].head;
    (*this).bomb = 0 as *mut Actor;
    while !bomb.is_null() {
        if (*bomb).params as libc::c_int != 0 as libc::c_int ||
               !(*bomb).parent.is_null() || (*bomb).update.is_none() {
            bomb = (*bomb).next
        } else if (*bomb).id as libc::c_int != ACTOR_EN_BOM as libc::c_int {
            bomb = (*bomb).next
        } else {
            ...
            if fabsf(xDist) >= fabsf(unkVec.x) ||
                   fabsf(yDist) >= fabsf(unkVec.y) ||
                   fabsf(zDist) >= fabsf(unkVec.z) {
                bomb = (*bomb).next
            } else {
                (*this).bomb = bomb;
                unkVec = (*bomb).world.pos;
                retVar = 1 as libc::c_int;
                bomb = (*bomb).next
            }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_809F6DD0(mut this: *mut EnDodojr) -> s32 {
    if (*this).bomb.is_null() {
        return 0 as libc::c_int
    } else if !(*(*this).bomb).parent.is_null() {
        return 0 as libc::c_int
    } else if Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                 &mut (*(*this).bomb).world.pos) > 30.0f32 {
        return 0 as libc::c_int
    } else {
        (*(*this).bomb).parent = &mut (*this).actor;
        return 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809F6E54(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angles: [f32_0; 12] =
        [0.0f32, 210.0f32, 60.0f32, 270.0f32, 120.0f32, 330.0f32, 180.0f32,
         30.0f32, 240.0f32, 90.0f32, 300.0f32, 150.0f32];
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut angleIndex: s16 = 0;
    if (*this).bomb.is_null() || (*(*this).bomb).update.is_none() ||
           !(*this).bomb.is_null() && !(*(*this).bomb).parent.is_null() {
        func_809F6CA4(this, globalCtx);
    }
    if !(*this).bomb.is_null() {
        pos = (*(*this).bomb).world.pos
    } else { pos = (*player).actor.world.pos }
    if Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos, &mut pos) > 80.0f32 {
        angleIndex =
            (((*this).actor.home.pos.x + (*this).actor.home.pos.y +
                  (*this).actor.home.pos.z +
                  (*globalCtx).state.frames.wrapping_div(30 as libc::c_int as
                                                             libc::c_uint) as
                      libc::c_float) as s16 as libc::c_int %
                 12 as libc::c_int) as s16;
        angleIndex =
            if angleIndex as libc::c_int >= 0 as libc::c_int {
                angleIndex as libc::c_int
            } else { -(angleIndex as libc::c_int) } as s16;
        pos.x += 80.0f32 * sinf(angles[angleIndex as usize]);
        pos.z += 80.0f32 * cosf(angles[angleIndex as usize])
    }
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut pos),
                       10 as libc::c_int as s16, 1000 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_809F706C(mut this: *mut EnDodojr) -> s32 {
    if (*this).actor.xzDistToPlayer > 40.0f32 {
        return 0 as libc::c_int
    } else { return 1 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_809F709C(mut this: *mut EnDodojr) {
    Audio_PlayActorSound2(&mut (*this).actor, 0x3821 as libc::c_int as u16_0);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    func_809F6A20(this);
    (*this).actionFunc =
        Some(func_809F7AB8 as
                 unsafe extern "C" fn(_: *mut EnDodojr, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809F70E8(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actionFunc ==
           Some(func_809F773C as
                    unsafe extern "C" fn(_: *mut EnDodojr,
                                         _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F77AC as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F784C as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F7A00 as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F7AB8 as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F7B3C as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(func_809F7BE4 as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) {
        return 0 as libc::c_int
    }
    ...
    if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int == 0 {
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
               1 as libc::c_int &&
               (*this).actionFunc !=
                   Some(func_809F78EC as
                            unsafe extern "C" fn(_: *mut EnDodojr,
                                                 _: *mut GlobalContext) -> ())
               &&
               (*this).actionFunc !=
                   Some(func_809F786C as
                            unsafe extern "C" fn(_: *mut EnDodojr,
                                                 _: *mut GlobalContext) -> ())
           {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x389e as libc::c_int as u16_0);
            (*this).timer1 = 120 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_809F72A4(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
        ...
        if (*this).actionFunc ==
               Some(func_809F74C4 as
                        unsafe extern "C" fn(_: *mut EnDodojr,
                                             _: *mut GlobalContext) -> ()) ||
               (*this).actionFunc ==
                   Some(func_809F758C as
                            unsafe extern "C" fn(_: *mut EnDodojr,
                                                 _: *mut GlobalContext) -> ())
               ||
               (*this).actionFunc ==
                   Some(func_809F799C as
                            unsafe extern "C" fn(_: *mut EnDodojr,
                                                 _: *mut GlobalContext) -> ())
           {
...
#[no_mangle]
pub unsafe extern "C" fn func_809F73AC(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut object_dodojr_Anim_000860 as
                                   *mut AnimationHeader as *mut libc::c_void)
    ...
    if !((*this).actor.xzDistToPlayer >= 320.0f32) {
        ...
        if !(dist >= 40.0f32) {
            Animation_Change(&mut (*this).skelAnime,
                             &mut object_dodojr_Anim_000860, 1.8f32, 0.0f32,
                             lastFrame,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F74C4(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    sp2C = (*this).actor.shape.rot.x as f32_0;
    sp2C /= 16384.0f32;
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 60.0f32 * sp2C;
    func_809F6510(this, globalCtx, 3 as libc::c_int);
    if sp2C == 0.0f32 {
        (*this).actor.shape.shadowDraw =
            Some(ActorShadow_DrawCircle as
                     unsafe extern "C" fn(_: *mut Actor, _: *mut Lights,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F758C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002D868(&mut (*this).actor);
    func_809F6730(this, globalCtx, &mut (*this).actor.world.pos);
    if (if (*this).timer4 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer4 -= 1; (*this).timer4 as libc::c_int }) ==
           0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3822 as libc::c_int as u16_0);
        (*this).timer4 = 5 as libc::c_int as s16
    }
    if func_809F6DD0(this) != 0 as libc::c_int {
        func_809F6C24(this);
        (*this).actionFunc =
            Some(func_809F768C as
                     unsafe extern "C" fn(_: *mut EnDodojr,
                                          _: *mut GlobalContext) -> ());
        return
    }
    func_809F6E54(this, globalCtx);
    if func_809F706C(this) != 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3820 as libc::c_int as u16_0);
        func_809F6B38(this);
        (*this).actionFunc =
            Some(func_809F799C as
                     unsafe extern "C" fn(_: *mut EnDodojr,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F768C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    if ((*this).skelAnime.curFrame as s16 as libc::c_int - 8 as libc::c_int) <
           4 as libc::c_int {
        bomb = (*this).bomb as *mut EnBom;
        (*bomb).timer += 1;
        ...
        (*this).timer3 = 24 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_809F773C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    if (if (*this).timer3 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer3 -= 1; (*this).timer3 as libc::c_int }) ==
           0 as libc::c_int {
        func_809F64D0(this);
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn func_809F77AC(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).rootScale = 1.2f32;
    (*this).rootScale *=
        (*this).actor.colorFilterTimer as f32_0 /
            8 as libc::c_int as libc::c_float;
    func_8002D868(&mut (*this).actor);
    if func_809F68B0(this, globalCtx) != 0 as libc::c_int {
        (*this).timer3 = 60 as libc::c_int as s16;
        func_809F6AC4(this);
        (*this).unk_1FC = 7 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_809F784C as
                     unsafe extern "C" fn(_: *mut EnDodojr,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_809F784C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    func_809F7B3C(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_809F786C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002D868(&mut (*this).actor);
    if func_809F68B0(this, globalCtx) != 0 as libc::c_int {
        func_809F6AC4(this);
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       0 as libc::c_int as s16, 4 as libc::c_int as s16,
                       1000 as libc::c_int as s16, 10 as libc::c_int as s16);
    (*this).actor.world.rot.x = (*this).actor.shape.rot.x;
    (*this).actor.colorFilterTimer = (*this).timer1 as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_809F78EC(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    if (if (*this).timer1 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer1 -= 1; (*this).timer1 as libc::c_int }) !=
           0 as libc::c_int {
        if ((*this).timer1 as libc::c_int) < 30 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809F799C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn func_809F7A00(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    let mut tmp: f32_0 = 0.;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                       0x4000 as libc::c_int as s16, 4 as libc::c_int as s16,
                       1000 as libc::c_int as s16, 100 as libc::c_int as s16);
    if (if (*this).timer3 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer3 -= 1; (*this).timer3 as libc::c_int }) !=
           0 as libc::c_int {
        tmp =
            (30 as libc::c_int - (*this).timer3 as libc::c_int) as
                libc::c_float / 30.0f32;
        (*this).actor.world.pos.y = (*this).actor.home.pos.y - 60.0f32 * tmp
    } else { Actor_Kill(&mut (*this).actor); }
    func_809F6510(this, globalCtx, 3 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809F7AB8(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    func_8002D868(&mut (*this).actor);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       0 as libc::c_int as s16, 4 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_809F7B3C(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    if (*this).unk_1FC as libc::c_int != 0 as libc::c_int {
        if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
            Actor_SetColorFilter(&mut (*this).actor,
                                 0x4000 as libc::c_int as s16,
                                 200 as libc::c_int as s16,
                                 0 as libc::c_int as s16, (*this).unk_1FC);
            (*this).unk_1FC -= 1
        }
    } else {
        bomb =
        ...
        (*this).timer3 = 8 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_809F7BE4 as
                     unsafe extern "C" fn(_: *mut EnDodojr,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_809F7BE4(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    if (if (*this).timer3 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer3 -= 1; (*this).timer3 as libc::c_int }) ==
...
#[no_mangle]
pub unsafe extern "C" fn func_809F7C48(mut this: *mut EnDodojr,
                                       mut globalCtx: *mut GlobalContext) {
    if (if (*this).timer2 as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer2 -= 1; (*this).timer2 as libc::c_int }) ==
           0 as libc::c_int {
        func_809F709C(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDodojr_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDodojr = thisx as *mut EnDodojr;
    ...
    if (*this).actionFunc !=
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor,
                                ...
                                (*this).collider.dim.height as f32_0, 0.0f32,
                                5 as libc::c_int);
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_809F7D50(mut globalCtx: *mut GlobalContext,
                                       mut limbIndex: s32,
    ...
    let mut this: *mut EnDodojr = thisx as *mut EnDodojr;
    let mut D_809F7F64: Vec3f =
        { let mut init = Vec3f{x: 480.0f32, y: 620.0f32, z: 0.0f32,}; init };
    if limbIndex == 1 as libc::c_int {
        Matrix_Scale((*this).rootScale * 0.5f32 + 1.0f32,
                     (*this).rootScale + 1.0f32,
                     (*this).rootScale * 0.5f32 + 1.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    }
    if limbIndex == 4 as libc::c_int {
        Matrix_MultVec3f(&mut D_809F7F64, &mut (*this).headPos);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_809F7DFC(mut globalCtx: *mut GlobalContext,
                                       mut limbIndex: s32,
                                       mut dList: *mut *mut Gfx,
                                       mut rot: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn EnDodojr_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDodojr = thisx as *mut EnDodojr;
    if (*this).actionFunc !=
           Some(func_809F73AC as
