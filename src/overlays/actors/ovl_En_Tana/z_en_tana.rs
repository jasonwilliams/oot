...
extern "C" {
    ...
    #[no_mangle]
    static mut gShopDungenWoodenShelvesDL: [Gfx; 0];
    #[no_mangle]
    static mut gShopDungenStone1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gShopDungenStone2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gShopDungenStoneShelvesDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut En_Tana_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TANA as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SHOP_DUNGEN as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTana>() as
                                  libc::c_ulong,
                          init:
...
static mut sShelfTypes: [*const libc::c_char; 2] =
    [b"\xe6\x9c\xa8\xe3\x81\xae\xe6\xa3\x9a\x00" as *const u8 as
         *const libc::c_char,
     b"\xe7\x9f\xb3\xe3\x81\xae\xe6\xa3\x9a\x00" as *const u8 as
         *const libc::c_char];
static mut sDrawFuncs: [ActorFunc; 3] =
    unsafe {
        [Some(EnTana_DrawWoodenShelves as
                  unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                      -> ()),
         Some(EnTana_DrawStoneShelves as
                  unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                      -> ()),
         Some(EnTana_DrawStoneShelves as
                  unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
...
static mut sShelfDLists: [*mut Gfx; 3] =
    unsafe {
        [gShopDungenWoodenShelvesDL.as_ptr() as *mut _,
         gShopDungenStoneShelvesDL.as_ptr() as *mut _,
         gShopDungenStoneShelvesDL.as_ptr() as *mut _]
    };
static mut sStoneTextures: [*mut libc::c_void; 3] =
    unsafe {
        [0 as *const libc::c_void as *mut libc::c_void,
         gShopDungenStone1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gShopDungenStone2Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnTana_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTana = thisx as *mut EnTana;
    osSyncPrintf(b"\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %s \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\n\x00"
                     as *const u8 as *const libc::c_char,
                 sShelfTypes[(*thisx).params as usize]);
    Actor_SetScale(thisx, 1.0f32);
    (*thisx).flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*thisx).draw = sDrawFuncs[(*thisx).params as usize];
}
#[no_mangle]
pub unsafe extern "C" fn EnTana_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnTana_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnTana_DrawWoodenShelves(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut EnTana = thisx as *mut EnTana;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tana.c\x00" as *const u8 as *const libc::c_char,
                    148 as libc::c_int);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_tana.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = sShelfDLists[(*thisx).params as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tana.c\x00" as *const u8 as
                         *const libc::c_char, 157 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnTana_DrawStoneShelves(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnTana = thisx as *mut EnTana;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        gSegments[((sStoneTextures[(*thisx).params as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sStoneTextures[(*thisx).params as
                                                             usize] as u32_0 &
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = sShelfDLists[(*thisx).params as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tana.c\x00" as *const u8 as
