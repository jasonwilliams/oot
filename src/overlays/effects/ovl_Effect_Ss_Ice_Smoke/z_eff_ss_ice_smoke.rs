...
#[no_mangle]
pub static mut Effect_Ss_Ice_Smoke_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_ICE_SMOKE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsIceSmoke_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsIceSmoke_Init(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
 ...
 -> u32_0 {
    ...
    if objBankIdx > -(1 as libc::c_int) &&
        ...
        (*this).regs[0 as libc::c_int as usize] = objBankIdx as s16;
        (*this).regs[1 as libc::c_int as usize] = 0 as libc::c_int as s16;
        (*this).regs[2 as libc::c_int as usize] = (*initParams).scale;
        (*this).life = 50 as libc::c_int as s16;
        (*this).draw =
            Some(EffectSsIceSmoke_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsIceSmoke_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        gSegments[6 as libc::c_int as usize] = oldSeg6 as u32_0;
        return 1 as libc::c_int as u32_0
    }
    osSyncPrintf(b"Effect_SS_Ice_Smoke_ct():\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf Object_Bank_Fz\xe3\x81\x8c\xe6\x9c\x89\xe3\x82\x8a\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xe3\x80\x82\n\x00"
                     as *const u8 as *const libc::c_char);
    return 0 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsIceSmoke_Draw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_eff_ss_ice_smoke.c\x00" as *const u8 as
    ...
    if objBankIdx > -(1 as libc::c_int) &&
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = object as libc::c_uint;
        ...
        (*_g_4).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ((*this).life as libc::c_int * 3 as libc::c_int)
                                 as u32_0,
                             ((*this).life as libc::c_int * 15 as libc::c_int)
        ...
        scale =
            (*this).regs[2 as libc::c_int as usize] as libc::c_int as
                libc::c_float * 0.0001f32;
        Matrix_Scale(scale, scale, 1.0f32,
    ...
    } else { (*this).life = -(1 as libc::c_int) as s16 }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_eff_ss_ice_smoke.c\x00" as *const u8 as
                         *const libc::c_char, 210 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsIceSmoke_Update(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut index: u32_0,
                                                 mut this: *mut EffectSs) {
    let mut objBankIdx: s32 = 0;
