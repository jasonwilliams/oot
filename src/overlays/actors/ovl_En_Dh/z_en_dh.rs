...
extern "C" {
    ...
    #[no_mangle]
    static mut object_dh_Anim_001A3C: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_002148: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_0032BC: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_00375C: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_003A8C: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_003D6C: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_004658: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Anim_005880: AnimationHeader;
    #[no_mangle]
    static mut object_dh_Skel_007E88: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_dh_DL_007FC0: [Gfx; 0];
}
...
pub struct EnDh {
    ...
    pub limbRotTable: [Vec3s; 16],
    pub actionState: u8_0,
    pub retreat: u8_0,
    pub drawDirtWave: u8_0,
    pub actionFunc: EnDhActionFunc,
    pub unk_258: u8_0,
    pub unused_259: u8_0,
    pub alpha: u8_0,
    pub curAction: u8_0,
    pub timer: s16,
    pub dirtWavePhase: s16,
    pub collider1: ColliderCylinder,
    pub collider2: ColliderJntSph,
    pub elements: [ColliderJntSphElement; 1],
    pub headPos: Vec3f,
    pub dirtWaveSpread: f32_0,
    pub dirtWaveHeight: f32_0,
    pub dirtWaveAlpha: f32_0,
}
pub type EnDhActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDh, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_int;
pub const ENDH_DEATH: C2RustUnnamed_23 = 10;
pub const ENDH_START_ATTACK_BOMB: C2RustUnnamed_23 = 5;
pub const ENDH_START_ATTACK_GRAB: C2RustUnnamed_23 = 1;
pub const ENDH_WAIT_UNDERGROUND: C2RustUnnamed_23 = 0;
pub const ENDH_HANDS_KILLED_1: C2RustUnnamed_23 = -1;
pub const ENDH_HANDS_KILLED_2: C2RustUnnamed_23 = -2;
pub const ENDH_HANDS_KILLED_3: C2RustUnnamed_23 = -3;
pub const ENDH_HANDS_KILLED_4: C2RustUnnamed_23 = -4;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const DH_DAMAGE: C2RustUnnamed_24 = 6;
pub const DH_DEATH: C2RustUnnamed_24 = 5;
pub const DH_ATTACK: C2RustUnnamed_24 = 4;
pub const DH_WALK: C2RustUnnamed_24 = 3;
pub const DH_BURROW: C2RustUnnamed_24 = 2;
pub const DH_RETREAT: C2RustUnnamed_24 = 1;
pub const DH_WAIT: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut En_Dh_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DH as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_DH as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDh>() as libc::c_ulong,
                          init:
...
static mut D_809EC620: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupAction(mut this: *mut EnDh,
                                          mut actionFunc: EnDhActionFunc) {
    (*this).actionFunc = actionFunc; // also TOUCH_NONE
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDh =
        thisx as *mut EnDh; // also TOUCH_ON | TOUCH_SFX_WOOD
    Actor_ProcessInitChain(&mut (*this).actor,
                           sInitChain.as_mut_ptr()); // also TOUCH_NONE
    (*this).actor.colChkInfo.damageTable = &mut D_809EC620; // also TOUCH_NONE
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_dh_Skel_007E88, &mut object_dh_Anim_005880,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).limbRotTable.as_mut_ptr(),
                       16 as libc::c_int); // also TOUCH_ON | TOUCH_SFX_WOOD
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 64.0f32); // Also TOUCH_NONE
    (*this).actor.params =
        ENDH_WAIT_UNDERGROUND as libc::c_int as s16; // also TOUCH_NONE
    (*this).actor.colChkInfo.mass = 0xfe as libc::c_int as u8_0;
    (*this).actor.colChkInfo.health =
        if gSaveContext.linkAge == 0 as libc::c_int {
            14 as libc::c_int
        } else { 20 as libc::c_int } as u8_0;
    (*this).unk_258 = 255 as libc::c_int as u8_0;
    (*this).alpha = (*this).unk_258;
    (*this).actor.flags &=
    ...
    Collider_InitJntSph(globalCtx, &mut (*this).collider2);
    Collider_SetJntSph(globalCtx, &mut (*this).collider2, &mut (*this).actor,
                       &mut sJntSphInit, (*this).elements.as_mut_ptr());
    EnDh_SetupWait(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDh = thisx as *mut EnDh;
    func_800F5B58();
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider1);
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider2);
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_SpawnDebris(mut globalCtx: *mut GlobalContext,
                                          mut this: *mut EnDh,
                                          mut spawnPos: *mut Vec3f,
                                          mut spread: f32_0, mut arg4: s32,
                                          mut accelXZ: f32_0,
                                          mut scale: f32_0) {
    ...
    let mut spreadAngle: f32_0 = 0.;
    let mut scaleMod: f32_0 = 0.;
    spreadAngle = (Rand_ZeroOne() - 0.5f32) * 6.28f32;
    pos.y = (*this).actor.floorHeight;
    pos.x = Math_SinF(spreadAngle) * spread + (*spawnPos).x;
    pos.z = Math_CosF(spreadAngle) * spread + (*spawnPos).z;
    accel.x = (Rand_ZeroOne() - 0.5f32) * accelXZ;
    accel.z = (Rand_ZeroOne() - 0.5f32) * accelXZ;
    vel.y += (Rand_ZeroOne() - 0.5f32) * 4.0f32;
    scaleMod = Rand_ZeroOne() * 5.0f32 + 12.0f32;
    EffectSsHahen_Spawn(globalCtx, &mut pos, &mut vel, &mut accel,
                        arg4 as s16, (scaleMod * scale) as s16,
                        -(1 as libc::c_int) as s16, 10 as libc::c_int as s16,
                        0 as *mut Gfx);
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupWait(mut this: *mut EnDh) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_dh_Anim_003A8C);
    (*this).curAction = DH_WAIT as libc::c_int as u8_0;
    (*this).actor.world.pos.x =
        Rand_CenteredFloat(600.0f32) + (*this).actor.home.pos.x;
    (*this).actor.world.pos.z =
        Rand_CenteredFloat(600.0f32) + (*this).actor.home.pos.z;
    (*this).actor.shape.yOffset = -15000.0f32;
    (*this).actor.speedXZ = 0.0f32;
    (*this).dirtWaveSpread = (*this).actor.speedXZ;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
    (*this).actor.params = ENDH_WAIT_UNDERGROUND as libc::c_int as s16;
    (*this).actionState = (*this).actor.params as u8_0;
    (*this).dirtWavePhase = (*this).actionState as s16;
    EnDh_SetupAction(this,
                     Some(EnDh_Wait as
                              unsafe extern "C" fn(_: *mut EnDh,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_Wait(mut this: *mut EnDh,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    if !Actor_GetCollidedExplosive(globalCtx,
                                   &mut (*this).collider1.base).is_null() {
        (*this).actor.params = ENDH_START_ATTACK_BOMB as libc::c_int as s16
    }
    if (*this).actor.params as libc::c_int >=
           ENDH_START_ATTACK_GRAB as libc::c_int ||
           (*this).actor.params as libc::c_int <=
               ENDH_HANDS_KILLED_4 as libc::c_int {
        ...
        match (*this).actionState as libc::c_int {
            0 => {
                ...
                (*this).actor.flags &=
                    !((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint;
                (*this).actionState = (*this).actionState.wrapping_add(1);
                (*this).drawDirtWave = (*this).drawDirtWave.wrapping_add(1);
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x39a8 as libc::c_int as u16_0);
                current_block_24 = 10673492977221247335;
            }
            1 => { current_block_24 = 10673492977221247335; }
            2 => {
                EnDh_SetupWalk(this);
                current_block_24 = 16203760046146113240;
            }
            _ => { current_block_24 = 16203760046146113240; }
        }
        match current_block_24 {
            10673492977221247335 => {
                (*this).dirtWavePhase =
                    ((*this).dirtWavePhase as libc::c_int +
                         0x3a7 as libc::c_int) as s16;
                Math_SmoothStepToF(&mut (*this).dirtWaveSpread, 300.0f32,
                                   1.0f32, 5.0f32, 0.0f32);
                (*this).dirtWaveHeight =
                    Math_SinS((*this).dirtWavePhase) * 55.0f32;
                (*this).dirtWaveAlpha =
                    (Math_SinS((*this).dirtWavePhase) * 255.0f32) as s16 as
                        f32_0;
                EnDh_SpawnDebris(globalCtx, this,
                                 &mut (*this).actor.world.pos,
                                 (*this).dirtWaveSpread, 4 as libc::c_int,
                                 2.05f32, 1.2f32);
                if (*this).actor.shape.yOffset == 0.0f32 {
                    (*this).drawDirtWave = 0 as libc::c_int as u8_0;
                    (*this).actionState = (*this).actionState.wrapping_add(1)
                } else if (*this).dirtWavePhase as libc::c_int >
                              0x12c0 as libc::c_int {
                    (*this).actor.shape.yOffset += 500.0f32
                }
            }
            _ => { }
        }
        ...
        if (*this).actor.params as libc::c_int !=
               ENDH_START_ATTACK_BOMB as libc::c_int {
            func_8008EEAC(globalCtx, &mut (*this).actor);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupWalk(mut this: *mut EnDh) {
    Animation_Change(&mut (*this).skelAnime, &mut object_dh_Anim_003A8C,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_dh_Anim_003A8C as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as
                         libc::c_int as libc::c_float - 3.0f32,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -6.0f32);
    (*this).curAction = DH_WALK as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Walk(mut this: *mut EnDh,
                                   mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
    ...
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).skelAnime.curFrame as s32 % 8 as libc::c_int ==
           0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3901 as libc::c_int as u16_0);
    }
    if (*globalCtx).gameplayFrames & 0x5f as libc::c_int as libc::c_uint ==
           0 as libc::c_int as libc::c_uint {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39a7 as libc::c_int as u16_0);
    }
    if (*this).actor.xzDistToPlayer <= 100.0f32 {
        (*this).actor.speedXZ = 0.0f32;
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                (60 as libc::c_int * 0x10000 as libc::c_int /
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupRetreat(mut this: *mut EnDh,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut object_dh_Anim_005880,
                          -4.0f32);
    (*this).curAction = DH_RETREAT as libc::c_int as u8_0;
    (*this).timer = 70 as libc::c_int as s16;
    (*this).actor.speedXZ = 1.0f32;
    EnDh_SetupAction(this,
                     Some(EnDh_Retreat as
                              unsafe extern "C" fn(_: *mut EnDh,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_Retreat(mut this: *mut EnDh,
                                      mut globalCtx: *mut GlobalContext) {
    (*this).timer -= 1;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupAttack(mut this: *mut EnDh) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_dh_Anim_004658, -6.0f32);
    (*this).actionState = 0 as libc::c_int as u8_0;
    (*this).timer = (*this).actionState as s16;
    (*this).curAction = DH_ATTACK as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnDh_SetupAction(this,
                     Some(EnDh_Attack as
                              unsafe extern "C" fn(_: *mut EnDh,
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Attack(mut this: *mut EnDh,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
        ...
        (*this).actionState = (*this).actionState.wrapping_add(1)
                  ...
                  Actor_IsFacingPlayer(&mut (*this).actor,
                                       (60 as libc::c_int *
                                            ...
                                            360 as libc::c_int) as s16) == 0 {
        Animation_Change(&mut (*this).skelAnime, &mut object_dh_Anim_004658,
                         -1.0f32, (*this).skelAnime.curFrame, 0.0f32,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
        (*this).actionState = 4 as libc::c_int as u8_0;
        let ref mut fresh0 =
            (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                    isize)).info.toucherFlags;
        *fresh0 = 0 as libc::c_int as u8_0;
        (*this).collider2.base.atFlags = *fresh0;
        let ref mut fresh1 =
            (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                    isize)).info.toucher.damage;
        *fresh1 = 0 as libc::c_int as u8_0;
        (*(*this).collider2.elements.offset(0 as libc::c_int as
    ...
    match (*this).actionState as libc::c_int {
        1 => {
            Animation_PlayOnce(&mut (*this).skelAnime,
                               &mut object_dh_Anim_001A3C);
            (*this).actionState = (*this).actionState.wrapping_add(1);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3900 as libc::c_int as u16_0);
            current_block_37 = 1449564267866812662;
        }
        0 => { current_block_37 = 1449564267866812662; }
        2 => {
            if (*this).skelAnime.curFrame >= 4.0f32 {
                let ref mut fresh2 =
                    (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                            isize)).info.toucherFlags;
                *fresh2 =
                ...
                (*this).collider2.base.atFlags = *fresh2;
                (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                        isize)).info.toucher.dmgFlags
            ...
            if (*this).collider2.base.atFlags as libc::c_int &
                   (1 as libc::c_int) << 2 as libc::c_int != 0 {
                (*this).collider2.base.atFlags =
                    ((*this).collider2.base.atFlags as libc::c_int &
                ...
                let ref mut fresh3 =
                    (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                            isize)).info.toucherFlags;
                *fresh3 = 0 as libc::c_int as u8_0;
                (*this).collider2.base.atFlags = *fresh3;
                let ref mut fresh4 =
                    (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                            isize)).info.toucher.damage;
                *fresh4 = 0 as libc::c_int as u8_0;
                (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                        isize)).info.toucher.dmgFlags
                    = *fresh4 as u32_0;
                (*this).actionState = (*this).actionState.wrapping_add(1)
            } else if (*this).collider2.base.atFlags as libc::c_int &
                          (1 as libc::c_int) << 1 as libc::c_int != 0 {
                (*this).collider2.base.atFlags =
                    ((*this).collider2.base.atFlags as libc::c_int &
                         !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
                func_8002F71C(globalCtx, &mut (*this).actor, 8.0f32,
                              (*this).actor.shape.rot.y, 8.0f32);
            }
            current_block_37 = 7746103178988627676;
        }
        3 => {
            if (*this).actor.xzDistToPlayer <= 100.0f32 &&
                   Actor_IsFacingPlayer(&mut (*this).actor,
                                             ...
                                             360 as libc::c_int) as s16) != 0
               {
                Animation_Change(&mut (*this).skelAnime,
                                 &mut object_dh_Anim_004658, 1.0f32, 20.0f32,
                                 Animation_GetLastFrame(&mut object_dh_Anim_004658
                                                            as
                                                            *mut AnimationHeader
                                                            as
                                                            *mut libc::c_void)
                ...
                Animation_Change(&mut (*this).skelAnime,
                                 &mut object_dh_Anim_004658, -1.0f32,
                                 Animation_GetLastFrame(&mut object_dh_Anim_004658
                                                            as
                                                            *mut AnimationHeader
                                                            as
                ...
                let ref mut fresh5 =
                    (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                            isize)).info.toucherFlags;
                *fresh5 = 0 as libc::c_int as u8_0;
                (*this).collider2.base.atFlags = *fresh5;
                let ref mut fresh6 =
                    (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                            isize)).info.toucher.damage;
                *fresh6 = 0 as libc::c_int as u8_0;
                (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                        isize)).info.toucher.dmgFlags
                    = *fresh6 as u32_0
            }
        ...
        5 => { EnDh_SetupWalk(this); current_block_37 = 7746103178988627676; }
        4 | _ => { current_block_37 = 7746103178988627676; }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupBurrow(mut this: *mut EnDh) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_dh_Anim_002148, -6.0f32);
    (*this).curAction = DH_BURROW as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).dirtWaveSpread = (*this).actor.speedXZ;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).dirtWavePhase = 0 as libc::c_int as s16;
    (*this).actionState = 0 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Audio_PlayActorSound2(&mut (*this).actor, 0x39a8 as libc::c_int as u16_0);
    EnDh_SetupAction(this,
                     Some(EnDh_Burrow as
                              unsafe extern "C" fn(_: *mut EnDh,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Burrow(mut this: *mut EnDh,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    match (*this).actionState as libc::c_int {
        0 => {
            (*this).actionState = (*this).actionState.wrapping_add(1);
            (*this).drawDirtWave = (*this).drawDirtWave.wrapping_add(1);
            (*this).collider1.info.toucherFlags =
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int) as u8_0;
            (*this).collider1.base.atFlags =
                (*this).collider1.info.toucherFlags;
            (*this).collider1.info.toucher.dmgFlags =
                0xffcfffff as libc::c_uint;
            (*this).collider1.info.toucher.damage = 4 as libc::c_int as u8_0;
            current_block_18 = 6493045843095659053;
        }
        1 => { current_block_18 = 6493045843095659053; }
        2 => {
            (*this).drawDirtWave = 0 as libc::c_int as u8_0;
            (*this).collider1.dim.radius = 35 as libc::c_int as s16;
            (*this).collider1.info.toucherFlags = 0 as libc::c_int as u8_0;
            (*this).collider1.base.atFlags =
                (*this).collider1.info.toucherFlags;
            (*this).collider1.info.toucher.damage = 0 as libc::c_int as u8_0;
            (*this).collider1.info.toucher.dmgFlags =
                (*this).collider1.info.toucher.damage as u32_0;
            EnDh_SetupWait(this);
            current_block_18 = 15904375183555213903;
        }
        _ => { current_block_18 = 15904375183555213903; }
    }
    match current_block_18 {
        6493045843095659053 => {
            (*this).dirtWavePhase =
                ((*this).dirtWavePhase as libc::c_int + 0x47e as libc::c_int)
                    as s16;
            Math_SmoothStepToF(&mut (*this).dirtWaveSpread, 300.0f32, 1.0f32,
                               8.0f32, 0.0f32);
            (*this).dirtWaveHeight =
                Math_SinS((*this).dirtWavePhase) * 55.0f32;
            (*this).dirtWaveAlpha =
                (Math_SinS((*this).dirtWavePhase) * 255.0f32) as s16 as f32_0;
            EnDh_SpawnDebris(globalCtx, this, &mut (*this).actor.world.pos,
                             (*this).dirtWaveSpread, 4 as libc::c_int,
                             2.05f32, 1.2f32);
            (*this).collider1.dim.radius =
                ((*this).dirtWaveSpread * 0.6f32) as s16;
            if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
                (*this).actionState = (*this).actionState.wrapping_add(1)
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupDamage(mut this: *mut EnDh) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_dh_Anim_003D6C, -6.0f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.speedXZ = -1.0f32
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x39a9 as libc::c_int as u16_0);
    (*this).curAction = DH_DAMAGE as libc::c_int as u8_0;
    EnDh_SetupAction(this,
                     Some(EnDh_Damage as
                              unsafe extern "C" fn(_: *mut EnDh,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Damage(mut this: *mut EnDh,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (*this).retreat != 0 {
        ...
        } else if (*this).actor.xzDistToPlayer <= 105.0f32 &&
                      Actor_IsFacingPlayer(&mut (*this).actor,
                                           (60 as libc::c_int *
                                                0x10000 as libc::c_int /
            ...
            let mut frames: f32_0 =
                Animation_GetLastFrame(&mut object_dh_Anim_004658 as
                                           *mut AnimationHeader as
                                           *mut libc::c_void) as f32_0;
            EnDh_SetupAttack(this);
            Animation_Change(&mut (*this).skelAnime,
                             &mut object_dh_Anim_004658, 1.0f32, 20.0f32,
                             frames, ANIMMODE_ONCE as libc::c_int as u8_0,
                             -6.0f32);
        } else { EnDh_SetupWalk(this); }
        (*this).unk_258 = 255 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_SetupDeath(mut this: *mut EnDh) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_dh_Anim_0032BC, -1.0f32);
    (*this).curAction = DH_DEATH as libc::c_int as u8_0;
    (*this).timer = 300 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    func_800F5B58();
    (*this).actor.params = ENDH_DEATH as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x39ab as libc::c_int as u16_0);
    EnDh_SetupAction(this,
                     Some(EnDh_Death as
                              unsafe extern "C" fn(_: *mut EnDh,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Death(mut this: *mut EnDh,
                                    mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 ||
           (*this).timer as libc::c_int != 300 as libc::c_int {
        if (*this).timer as libc::c_int == 300 as libc::c_int {
            Animation_PlayLoop(&mut (*this).skelAnime,
                               &mut object_dh_Anim_00375C);
        }
        (*this).timer -= 1;
        if ((*this).timer as libc::c_int) < 150 as libc::c_int {
        ...
        if (*this).skelAnime.curFrame as s32 == 53 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 56 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 61 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x387a as libc::c_int as u16_0);
        }
        if (*this).skelAnime.curFrame as s32 == 61 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_CollisionCheck(mut this: *mut EnDh,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    let mut lastHealth: s32 = 0;
    if (*this).collider2.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 && (*this).retreat == 0
       {
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            let ref mut fresh7 =
                (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                        isize)).info.toucherFlags;
            *fresh7 = 0 as libc::c_int as u8_0;
            (*this).collider2.base.atFlags = *fresh7;
            let ref mut fresh8 =
                (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                        isize)).info.toucher.damage;
            *fresh8 = 0 as libc::c_int as u8_0;
            (*(*this).collider2.elements.offset(0 as libc::c_int as
                                                    isize)).info.toucher.dmgFlags
                = *fresh8 as u32_0;
            ...
            lastHealth = (*this).actor.colChkInfo.health as s32;
            if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                ...
                if lastHealth >= 15 as libc::c_int &&
                       ((*this).actor.colChkInfo.health as libc::c_int) <
                           15 as libc::c_int ||
                       lastHealth >= 9 as libc::c_int &&
                           ((*this).actor.colChkInfo.health as libc::c_int) <
                               9 as libc::c_int ||
                       lastHealth >= 3 as libc::c_int &&
                           ((*this).actor.colChkInfo.health as libc::c_int) <
                               3 as libc::c_int {
                    (*this).retreat = (*this).retreat.wrapping_add(1)
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDh = thisx as *mut EnDh;
    let mut player: *mut Player =
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 45.0f32,
                            45.0f32, 0x1d as libc::c_int);
    ...
    if (*this).actor.colChkInfo.health as libc::c_int > 0 as libc::c_int {
        if (*this).curAction as libc::c_int == DH_WAIT as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDh_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
    ...
    let mut headOffset: Vec3f =
        {
            let mut init = Vec3f{x: 2000.0f32, y: 1000.0f32, z: 0.0f32,};
            init
        };
    let mut this: *mut EnDh = thisx as *mut EnDh;
    if limbIndex == 13 as libc::c_int {
        ...
        Matrix_Push();
        Matrix_Translate(headOffset.x, headOffset.y, headOffset.z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Collider_UpdateSpheres(1 as libc::c_int, &mut (*this).collider2);
        Matrix_Pop();
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDh_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDh = thisx as *mut EnDh;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_dh.c\x00" as *const u8 as *const libc::c_char,
                    1099 as libc::c_int);
    ...
    if (*this).drawDirtWave != 0 {
        ...
        (*_g_4).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             (*globalCtx).state.frames.wrapping_mul(-(10 as
                                                                          libc::c_int)
                                                                        as
                                                                        libc::c_uint).wrapping_rem(0x80
                                                                                                       as
                                                                                                       ...
                                                                                                       as
                                                                                                       libc::c_uint),
                             (*globalCtx).state.frames.wrapping_mul(-(20 as
                                                                          libc::c_int)
                                                                        as
                                                                        libc::c_uint).wrapping_rem(0x100
                                                                                                       as
                                                                                                       libc::c_int
                                                                                                       as
                                                                                                       libc::c_uint),
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).dirtWaveAlpha as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        Matrix_Translate(0.0f32, -(*this).actor.shape.yOffset, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale((*this).dirtWaveSpread * 0.01f32,
                     (*this).dirtWaveHeight * 0.01f32,
                     (*this).dirtWaveSpread * 0.01f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (*_g_6).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_dh.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_7).words.w1 = object_dh_DL_007FC0.as_mut_ptr() as libc::c_uint
    }
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x2f as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
