...
extern "C" {
    ...
    #[no_mangle]
    static mut gCowBodyChewAnim: AnimationHeader;
    #[no_mangle]
    static mut gCowBodySkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gCowBodyMoveHeadAnim: AnimationHeader;
    #[no_mangle]
    static mut gCowTailIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gCowTailSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gCowTailSwishAnim: AnimationHeader;
}
...
pub struct EnCow {
    pub actor: Actor,
    pub colliders: [ColliderCylinder; 2],
    pub skelAnime: SkelAnime,
    ...
    pub unk_278: u16_0,
    pub unk_27A: u16_0,
    pub actionFunc: EnCowActionFunc,
}
pub type EnCowActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnCow, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Cow_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_COW as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_COW as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnCow>() as libc::c_ulong,
                          init:
...
static mut D_809E010C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: -1300.0f32, z: 1100.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn func_809DEE00(mut vec: *mut Vec3f, mut rotY: s16) {
    let mut xCalc: f32_0 = 0.;
    let mut rotCalcTemp: f32_0 = 0.;
...
#[no_mangle]
pub unsafe extern "C" fn func_809DEE9C(mut this: *mut EnCow) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    vec.y = 0.0f32;
    vec.x = 0.0f32;
    vec.z = 30.0f32;
    func_809DEE00(&mut vec, (*this).actor.shape.rot.y);
    (*this).colliders[0 as libc::c_int as usize].dim.pos.x =
        ((*this).actor.world.pos.x + vec.x) as s16;
    (*this).colliders[0 as libc::c_int as usize].dim.pos.y =
        (*this).actor.world.pos.y as s16;
    (*this).colliders[0 as libc::c_int as usize].dim.pos.z =
        ((*this).actor.world.pos.z + vec.z) as s16;
    vec.x = 0.0f32;
    vec.y = 0.0f32;
    vec.z = -20.0f32;
    func_809DEE00(&mut vec, (*this).actor.shape.rot.y);
    (*this).colliders[1 as libc::c_int as usize].dim.pos.x =
        ((*this).actor.world.pos.x + vec.x) as s16;
    (*this).colliders[1 as libc::c_int as usize].dim.pos.y =
        (*this).actor.world.pos.y as s16;
    (*this).colliders[1 as libc::c_int as usize].dim.pos.z =
        ((*this).actor.world.pos.z + vec.z) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_809DEF94(mut this: *mut EnCow) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    vec.x = 0.0f32;
    vec.y = 57.0f32;
    vec.z = -36.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnCow_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
    let mut pad: s32 = 0;
    ...
    match (*this).actor.params as libc::c_int {
        0 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut gCowBodySkel, 0 as *mut AnimationHeader,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               6 as libc::c_int);
            Animation_PlayLoop(&mut (*this).skelAnime, &mut gCowBodyChewAnim);
            Collider_InitCylinder(globalCtx,
                                  &mut *(*this).colliders.as_mut_ptr().offset(0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
            ...
            Collider_InitCylinder(globalCtx,
                                  &mut *(*this).colliders.as_mut_ptr().offset(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  isize));
            ...
            func_809DEE9C(this);
            (*this).actionFunc =
                Some(func_809DF96C as
                         unsafe extern "C" fn(_: *mut EnCow,
                                              _: *mut GlobalContext) -> ());
            ...
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx, ACTOR_EN_COW as libc::c_int as s16,
            ...
            (*this).unk_278 = (Rand_ZeroFloat(1000.0f32) + 40.0f32) as u16_0;
            (*this).unk_27A = 0 as libc::c_int as u16_0;
        ...
        1 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut gCowTailSkel, 0 as *mut AnimationHeader,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               6 as libc::c_int);
            Animation_PlayLoop(&mut (*this).skelAnime, &mut gCowTailIdleAnim);
            (*this).actor.update =
                Some(func_809DFE98 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).actor.draw =
                Some(func_809E0070 as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).actionFunc =
                Some(func_809DFA84 as
                         unsafe extern "C" fn(_: *mut EnCow,
                                              _: *mut GlobalContext) -> ());
            func_809DEF94(this);
            (*this).actor.flags &=
            ...
            (*this).unk_278 =
                ((Rand_ZeroFloat(1000.0f32) as u32_0 &
                      0xffff as libc::c_int as libc::c_uint) as libc::c_float
                     + 40.0f32) as u16_0
        }
        _ => { }
    }
    ...
    (*this).unk_276 = 0 as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnCow_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
...
#[no_mangle]
pub unsafe extern "C" fn func_809DF494(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_278 as libc::c_int > 0 as libc::c_int {
        (*this).unk_278 =
            ((*this).unk_278 as libc::c_int - 1 as libc::c_int) as u16_0
    } else {
        (*this).unk_278 = (Rand_ZeroFloat(500.0f32) + 40.0f32) as u16_0;
        Animation_Change(&mut (*this).skelAnime, &mut gCowBodyChewAnim,
                         1.0f32, (*this).skelAnime.curFrame,
                         Animation_GetLastFrame(&mut gCowBodyChewAnim as
    ...
    if (*this).actor.xzDistToPlayer < 150.0f32 &&
           (*this).unk_276 as libc::c_int & 2 as libc::c_int == 0 {
        (*this).unk_276 =
            ((*this).unk_276 as libc::c_int | 2 as libc::c_int) as u16_0;
        if (*this).skelAnime.animation ==
               &mut gCowBodyChewAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            (*this).unk_278 = 0 as libc::c_int as u16_0
        }
    }
    (*this).unk_27A =
        ((*this).unk_27A as libc::c_int + 1 as libc::c_int) as u16_0;
    if (*this).unk_27A as libc::c_int >= 0x31 as libc::c_int {
        (*this).unk_27A = 0 as libc::c_int as u16_0
    }
    // (1.0f / 100.0f) instead of 0.01f below is necessary so 0.01f doesn't get reused mistakenly
    if ((*this).unk_27A as libc::c_int) < 0x20 as libc::c_int {
        (*this).actor.scale.x =
            (Math_SinS((((*this).unk_27A as libc::c_int) <<
                            0xa as libc::c_int) as s16) * (1.0f32 / 100.0f32)
                 + 1.0f32) * 0.01f32
    } else { (*this).actor.scale.x = 0.01f32 }
    if (*this).unk_27A as libc::c_int >= 0x11 as libc::c_int {
        (*this).actor.scale.y =
            (Math_SinS(((((*this).unk_27A as libc::c_int) <<
                             0xa as libc::c_int) - 0x4000 as libc::c_int) as
                           s16) * (1.0f32 / 100.0f32) + 1.0f32) * 0.01f32
    } else { (*this).actor.scale.y = 0.01f32 };
}
#[no_mangle]
pub unsafe extern "C" fn func_809DF6BC(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_809DF730(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_809DF7D8(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_809DF870(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if Inventory_HasEmptyBottle() != 0 {
            Message_ContinueTextbox(globalCtx,
                                    0x2007 as libc::c_int as u16_0);
            (*this).actionFunc =
                Some(func_809DF7D8 as
                         unsafe extern "C" fn(_: *mut EnCow,
                                              _: *mut GlobalContext) -> ())
        } else {
            Message_ContinueTextbox(globalCtx,
                                    0x2013 as libc::c_int as u16_0);
            (*this).actionFunc =
                Some(func_809DF6BC as
                         unsafe extern "C" fn(_: *mut EnCow,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_809DF8FC(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_809DF870 as
                     unsafe extern "C" fn(_: *mut EnCow,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        func_8002F2CC(&mut (*this).actor, globalCtx, 170.0f32);
        (*this).actor.textId = 0x2006 as libc::c_int as u16_0
    }
    func_809DF494(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_809DF96C(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).msgCtx.ocarinaMode as libc::c_int ==
           OCARINA_MODE_00 as libc::c_int ||
        ...
        if (*gGameInfo).data[(7 as libc::c_int * 6 as libc::c_int *
            ...
            if (*this).unk_276 as libc::c_int & 4 as libc::c_int != 0 {
                (*this).unk_276 =
                    ((*this).unk_276 as libc::c_int & !(0x4 as libc::c_int))
                        as u16_0;
                (*gGameInfo).data[(7 as libc::c_int * 6 as libc::c_int *
                          ...
                          (if ((*this).actor.yawTowardsPlayer as libc::c_int -
                           ...
                           }) < 0x61a8 as libc::c_int {
                (*gGameInfo).data[(7 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 53 as libc::c_int)
                                      as usize] = 0 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_809DF8FC as
                             unsafe extern "C" fn(_: *mut EnCow,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).actor.flags |=
                ...
                (*this).unk_276 =
                    ((*this).unk_276 as libc::c_int | 4 as libc::c_int) as
                        u16_0
            }
        } else {
            (*this).unk_276 =
                ((*this).unk_276 as libc::c_int & !(0x4 as libc::c_int)) as
                    u16_0
        }
    }
    func_809DF494(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_809DFA84(mut this: *mut EnCow,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_278 as libc::c_int > 0 as libc::c_int {
        (*this).unk_278 = (*this).unk_278.wrapping_sub(1)
    } else {
        (*this).unk_278 = (Rand_ZeroFloat(200.0f32) + 40.0f32) as u16_0;
        Animation_Change(&mut (*this).skelAnime, &mut gCowTailIdleAnim,
                         1.0f32, (*this).skelAnime.curFrame,
                         Animation_GetLastFrame(&mut gCowTailIdleAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         1.0f32);
    ...
    if (*this).actor.xzDistToPlayer < 150.0f32 &&
           (if ((*this).actor.yawTowardsPlayer as libc::c_int -
                ...
                -(((*this).actor.yawTowardsPlayer as libc::c_int -
                       (*this).actor.shape.rot.y as libc::c_int) as s16 as
                      libc::c_int)
            }) >= 0x61a9 as libc::c_int &&
           (*this).unk_276 as libc::c_int & 2 as libc::c_int == 0 {
        (*this).unk_276 =
            ((*this).unk_276 as libc::c_int | 2 as libc::c_int) as u16_0;
        if (*this).skelAnime.animation ==
               &mut gCowTailIdleAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            (*this).unk_278 = 0 as libc::c_int as u16_0
        }
    };
...
pub unsafe extern "C" fn EnCow_Update(mut thisx: *mut Actor,
    ...
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*(*this).colliders.as_mut_ptr().offset(0 as
                                                                          libc::c_int
                                                                          as
                                                                          isize)).base);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*(*this).colliders.as_mut_ptr().offset(1 as
                                                                          libc::c_int
                                                                          as
                                                                          isize)).base);
    Actor_MoveForward(thisx);
    Actor_UpdateBgCheckInfo(globalCtx, thisx, 0.0f32, 0.0f32, 0.0f32,
                            4 as libc::c_int);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        if (*this).skelAnime.animation ==
               &mut gCowBodyChewAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            Audio_PlayActorSound2(thisx, 0x28df as libc::c_int as u16_0);
            Animation_Change(&mut (*this).skelAnime,
                             &mut gCowBodyMoveHeadAnim, 1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut gCowBodyMoveHeadAnim
                                                        as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
                             ANIMMODE_ONCE as libc::c_int as u8_0, 1.0f32);
        } else {
            Animation_Change(&mut (*this).skelAnime, &mut gCowBodyChewAnim,
                             1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut gCowBodyChewAnim as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
                             ANIMMODE_LOOP as libc::c_int as u8_0, 1.0f32);
        }
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*thisx).xzDistToPlayer < 150.0f32 &&
           (if Math_Vec3f_Yaw(&mut (*thisx).world.pos,
                              &mut (*player).actor.world.pos) as libc::c_int
                   >= 0 as libc::c_int {
                Math_Vec3f_Yaw(&mut (*thisx).world.pos,
                               &mut (*player).actor.world.pos) as libc::c_int
            } else {
                -(Math_Vec3f_Yaw(&mut (*thisx).world.pos,
        ...
        targetX =
            Math_Vec3f_Pitch(&mut (*thisx).focus.pos,
                             &mut (*player).actor.focus.pos);
        targetY =
            (Math_Vec3f_Yaw(&mut (*thisx).focus.pos,
                            &mut (*player).actor.focus.pos) as libc::c_int -
                 (*thisx).shape.rot.y as libc::c_int) as s16;
        if targetX as libc::c_int > 0x1000 as libc::c_int {
            targetX = 0x1000 as libc::c_int as s16
        } else if (targetX as libc::c_int) < -(0x1000 as libc::c_int) {
            targetX = -(0x1000 as libc::c_int) as s16
        }
        if targetY as libc::c_int > 0x2500 as libc::c_int {
            targetY = 0x2500 as libc::c_int as s16
        } else if (targetY as libc::c_int) < -(0x2500 as libc::c_int) {
            targetY = -(0x2500 as libc::c_int) as s16
        }
    } else {
        targetY = 0 as libc::c_int as s16;
        targetX = 0 as libc::c_int as s16
    }
    Math_SmoothStepToS(&mut (*this).someRot.x, targetX,
                       0xa as libc::c_int as s16, 0xc8 as libc::c_int as s16,
                       0xa as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).someRot.y, targetY,
                       0xa as libc::c_int as s16, 0xc8 as libc::c_int as s16,
                       0xa as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_809DFE98(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
    let mut pad: s32 = 0;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        if (*this).skelAnime.animation ==
               &mut gCowTailIdleAnim as *mut AnimationHeader as
                   *mut libc::c_void {
            Animation_Change(&mut (*this).skelAnime, &mut gCowTailSwishAnim,
                             1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut gCowTailSwishAnim as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
                             ANIMMODE_ONCE as libc::c_int as u8_0, 1.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnCow_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 2 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).someRot.y as libc::c_int) as
                s16;
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).someRot.x as libc::c_int) as
                s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnCow_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
    if limbIndex == 2 as libc::c_int {
        Matrix_MultVec3f(&mut D_809E010C, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCow_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnCow_OverrideLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn func_809E0070(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCow = thisx as *mut EnCow;
    func_800943C8((*globalCtx).state.gfxCtx);
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
