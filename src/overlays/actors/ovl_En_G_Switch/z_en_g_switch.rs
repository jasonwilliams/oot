...
extern "C" {
    pub type EnExRuppy;
    pub type EnSyatekiMan;
    #[no_mangle]
    fn fabsf(f: f32_0) -> f32_0;
    #[no_mangle]
    fn osSyncPrintf(fmt: *const libc::c_char, _: ...);
    #[no_mangle]
    fn EffectSsHitMark_SpawnCustomScale(globalCtx: *mut GlobalContext,
                                        type_0: s32, scale: s16,
                                        pos: *mut Vec3f);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gRupeeSilverTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeDL: [Gfx; 0];
    #[no_mangle]
    static mut object_tsubo_DL_0017C0: [Gfx; 0];
    #[no_mangle]
    static mut object_tsubo_DL_001960: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnGSwitch {
    pub actor: Actor,
    pub actionFunc: EnGSwitchActionFunc,
    pub type_0: s16,
    pub silverCount: s16,
    pub switchFlag: s16,
    pub killTimer: s16,
    ...
    pub effects: [EnGSwitchEffect; 100],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnGSwitchEffect {
    pub pos: Vec3f,
    pub scale: s16,
    pub timer: s16,
    pub colorIdx: s16,
...
pub type EnGSwitchActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGSwitch, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const GSWITCH_RIGHT: C2RustUnnamed_22 = 5;
pub const GSWITCH_LEFT: C2RustUnnamed_22 = 4;
pub const GSWITCH_UNUSED: C2RustUnnamed_22 = 3;
pub const GSWITCH_THROW: C2RustUnnamed_22 = 2;
pub const GSWITCH_APPEAR: C2RustUnnamed_22 = 1;
pub const GSWITCH_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const ENGSWITCH_TARGET_RUPEE: C2RustUnnamed_23 = 3;
pub const ENGSWITCH_ARCHERY_POT: C2RustUnnamed_23 = 2;
pub const ENGSWITCH_SILVER_RUPEE: C2RustUnnamed_23 = 1;
pub const ENGSWITCH_SILVER_TRACKER: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSyatekiItm {
    pub actor: Actor,
    pub actionFunc: EnSyatekiItmActionFunc,
    pub timer: s16,
    pub unkTimer: s16,
    pub signal: s16,
    pub hitCount: s16,
    pub roundNum: s16,
    pub roundFlags: [s16; 6],
    pub targetState: [s16; 2],
    pub numTargets: s16,
    pub targetHome: [Vec3f; 2],
    pub targetFinal: [Vec3f; 2],
    pub markers: [*mut EnExRuppy; 10],
    pub targets: [*mut EnGSwitch; 2],
    pub man: *mut EnSyatekiMan,
    pub curMarkers: [*mut EnExRuppy; 2],
}
pub type EnSyatekiItmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSyatekiItm, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const ENSYATEKIHIT_HIT: C2RustUnnamed_24 = 2;
pub const ENSYATEKIHIT_MISS: C2RustUnnamed_24 = 1;
pub const ENSYATEKIHIT_NONE: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_25 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_25 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_25 = -1;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const EFFECT_HITMARK_METAL: C2RustUnnamed_26 = 3;
pub const EFFECT_HITMARK_RED: C2RustUnnamed_26 = 2;
pub const EFFECT_HITMARK_DUST: C2RustUnnamed_26 = 1;
pub const EFFECT_HITMARK_WHITE: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const MOVE_HOME: C2RustUnnamed_27 = 1;
pub const MOVE_TARGET: C2RustUnnamed_27 = 0;
static mut sCollectedCount: s16 = 0 as libc::c_int as s16;
...
#[no_mangle]
pub static mut En_G_Switch_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_G_SWITCH as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGSwitch_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGSwitch_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGSwitch = thisx as *mut EnGSwitch;
    (*this).type_0 =
        ((*this).actor.params as libc::c_int >> 0xc as libc::c_int &
             0xf as libc::c_int) as s16;
    (*this).switchFlag =
        ((*this).actor.params as libc::c_int & 0x3f as libc::c_int) as s16;
    (*this).numEffects =
        (::std::mem::size_of::<[EnGSwitchEffect; 100]>() as
             libc::c_ulong).wrapping_div(::std::mem::size_of::<EnGSwitchEffect>()
                                             as libc::c_ulong) as s32 as s16;
    // "index"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa4\xe3\x83\xb3\xe3\x83\x87\xe3\x83\x83\xe3\x82\xaf\xe3\x82\xb9 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).type_0 as libc::c_int);
    // "save"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xbb\xe3\x83\xbc\xe3\x83\x96\t     \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
    ...
    match (*this).type_0 as libc::c_int {
        0 => {
            ...
            // "parent switch spawn"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe8\xa6\xaa\xe3\x82\xb9\xe3\x82\xa4\xe3\x83\x83\xe3\x83\x81\xe7\x99\xba\xe7\x94\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).actor.params as libc::c_int);
            sCollectedCount = 0 as libc::c_int as s16;
            (*this).silverCount =
                ((*this).actor.params as libc::c_int >> 6 as libc::c_int) as
                    s16;
            (*this).silverCount =
                ((*this).silverCount as libc::c_int & 0x3f as libc::c_int) as
                    s16;
            // "maximum number of checks"
            osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9c\x80\xe5\xa4\xa7\xe3\x83\x81\xe3\x82\xa7\xe3\x83\x83\xe3\x82\xaf\xe6\x95\xb0 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).silverCount as libc::c_int);
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
                ...
                (*this).actionFunc =
                    Some(EnGSwitch_SilverRupeeTracker as
                             unsafe extern "C" fn(_: *mut EnGSwitch,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        }
        1 => {
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            // "child switch spawn"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xad\x90\xe3\x82\xb9\xe3\x82\xa4\xe3\x83\x83\xe3\x83\x81\xe7\x99\xba\xe7\x94\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).actor.params as libc::c_int);
            (*this).colorIdx = 5 as libc::c_int as s16;
            (*this).numEffects = 20 as libc::c_int as s16;
            ...
            (*this).actor.draw =
                Some(EnGSwitch_DrawRupee as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).actor.shape.yOffset = 700.0f32;
            if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
                osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xef\xbc\xb9\xef\xbd\x8f\xef\xbd\x95 \xef\xbd\x81\xef\xbd\x92\xef\xbd\x85 \xef\xbc\xb3\xef\xbd\x88\xef\xbd\x8f\xef\xbd\x83\xef\xbd\x8b\xef\xbc\x81  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*this).switchFlag as libc::c_int);
                ...
                (*this).actionFunc =
                    Some(EnGSwitch_SilverRupeeIdle as
                             unsafe extern "C" fn(_: *mut EnGSwitch,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        ...
        2 => {
            ...
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x84\xe3\x81\xb6\xe3\x81\x95\xe3\x82\x81\xe3\x81\xb6\xe3\x81\xa1\xe6\x8a\x9c\xe3\x81\x8d\xe5\xa3\xb7 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actor.gravity = -3.0f32;
            (*this).colorIdx = Rand_ZeroFloat(2.99f32) as s16;
            Collider_InitCylinder(globalCtx, &mut (*this).collider);
            Collider_SetCylinder(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut sCylinderInit);
            (*this).actor.scale.x = 0.25f32;
            (*this).actor.scale.y = 0.45f32;
            (*this).actor.scale.z = 0.25f32;
            (*this).collider.info.bumper.dmgFlags =
                0x1f820 as libc::c_int as u32_0;
            (*this).objId = OBJECT_TSUBO as libc::c_int as s16;
            (*this).objIndex =
                Object_GetIndex(&mut (*globalCtx).objectCtx, (*this).objId) as
                    s8;
            ...
            (*this).collider.dim.radius = 24 as libc::c_int as s16;
            (*this).collider.dim.height = 74 as libc::c_int as s16;
            (*this).collider.dim.yShift = 0 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnGSwitch_WaitForObject as
                         unsafe extern "C" fn(_: *mut EnGSwitch,
                                              _: *mut GlobalContext) -> ())
        }
        3 => {
            ...
            (*this).collider.dim.height = 60 as libc::c_int as s16;
            (*this).collider.dim.yShift = 5 as libc::c_int as s16;
            (*this).actionFunc =
                Some(EnGSwitch_GalleryRupee as
                         unsafe extern "C" fn(_: *mut EnGSwitch,
                                              _: *mut GlobalContext) -> ())
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGSwitch = thisx as *mut EnGSwitch;
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_Break(mut this: *mut EnGSwitch,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut i: s32 = 0;
    randPos.x = (*this).actor.world.pos.x + Rand_CenteredFloat(40.0f32);
    randPos.y =
        (*this).actor.world.pos.y + 30.0f32 + Rand_CenteredFloat(35.0f32);
    randPos.z = (*this).actor.world.pos.z + Rand_CenteredFloat(40.0f32);
    hitPos.x = (*this).collider.info.bumper.hitPos.x as f32_0;
    hitPos.y = (*this).collider.info.bumper.hitPos.y as f32_0;
    hitPos.z = (*this).collider.info.bumper.hitPos.z as f32_0;
    EffectSsHitMark_SpawnCustomScale(globalCtx,
                                     EFFECT_HITMARK_WHITE as libc::c_int,
                                     700 as libc::c_int as s16, &mut hitPos);
    if (*this).type_0 as libc::c_int == ENGSWITCH_ARCHERY_POT as libc::c_int {
        velocity.y = 15.0f32;
        EffectSsExtra_Spawn(globalCtx, &mut hitPos, &mut velocity, &mut accel,
                            5 as libc::c_int as s16, 2 as libc::c_int as s16);
    }
    if (*this).type_0 as libc::c_int == ENGSWITCH_TARGET_RUPEE as libc::c_int
       {
        i = 0 as libc::c_int;
        while i < (*this).numEffects as libc::c_int {
            EnGSwitch_SpawnEffects(this, &mut randPos,
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_WaitForObject(mut this: *mut EnGSwitch,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, (*this).objIndex as s32)
        ...
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objIndex as usize].segment
                 as *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize))
                as u32_0;
        (*this).actor.objBankIndex = (*this).objIndex;
        (*this).actor.draw =
            Some(EnGSwitch_DrawPot as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFunc =
            Some(EnGSwitch_ArcheryPot as
                     unsafe extern "C" fn(_: *mut EnGSwitch,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_SilverRupeeTracker(mut this:
                                                          *mut EnGSwitch,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    static mut majorScale: [s8; 5] =
        [0 as libc::c_int as s8, 2 as libc::c_int as s8,
         4 as libc::c_int as s8, 5 as libc::c_int as s8,
         7 as libc::c_int as s8];
    if ((*this).noteIndex as libc::c_int) < sCollectedCount as libc::c_int {
        if (sCollectedCount as libc::c_int) < 5 as libc::c_int {
            // "sound?"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe9\x9f\xb3\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).noteIndex as libc::c_int);
            Audio_PlaySoundTransposed(&mut D_801333D4,
                                      0x28e8 as libc::c_int as u16_0,
                                      majorScale[(*this).noteIndex as usize]);
            (*this).noteIndex = sCollectedCount
        }
    }
    if sCollectedCount as libc::c_int >= (*this).silverCount as libc::c_int {
        // "It is now the end of the century."
        // This another reference to Hokuto no Ken.
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x99\x82\xe3\x81\xaf\xe3\x81\xbe\xe3\x81\x95\xe3\x81\xab\xe4\xb8\x96\xe7\xb4\x80\xe6\x9c\xab\xe3\x80\x9c  \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).switchFlag as libc::c_int);
        // "Last!"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x89\xe3\x81\x99\xe3\x81\xa8\xe3\x81\x89\xef\xbc\x81          \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        if (*globalCtx).sceneNum as libc::c_int == SCENE_MEN as libc::c_int &&
               (*this).actor.room as libc::c_int == 2 as libc::c_int {
            Flags_SetTempClear(globalCtx, (*this).actor.room as s32);
        } else {
            func_80078884(0x4802 as libc::c_int as u16_0);
            Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
        }
        func_80078884(0x4803 as libc::c_int as u16_0);
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_SilverRupeeIdle(mut this: *mut EnGSwitch,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x800 as libc::c_int) as
            s16;
    if (*this).actor.xyzDistToPlayerSq < 900.0f32 {
        ...
        (*this).killTimer = 15 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnGSwitch_SilverRupeeCollected as
                     unsafe extern "C" fn(_: *mut EnGSwitch,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_SilverRupeeCollected(mut this:
                                                            *mut EnGSwitch,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x3c0 as libc::c_int) as
            s16;
    if (*this).killTimer as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).actor.world.pos = (*player).actor.world.pos;
    (*this).actor.world.pos.y =
        (*player).actor.world.pos.y + 40.0f32 +
            (*this).killTimer as libc::c_int as libc::c_float * 0.3f32 *
                Math_SinS(((*this).killTimer as libc::c_int *
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_GalleryRupee(mut this: *mut EnGSwitch,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut gallery: *mut EnSyatekiItm = 0 as *mut EnSyatekiItm;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x3c0 as libc::c_int) as
            s16;
    if (*this).delayTimer as libc::c_int == 0 as libc::c_int {
        match (*this).moveMode as libc::c_int {
            2 => {
                Actor_MoveForward(&mut (*this).actor);
                if (*this).actor.velocity.y < 0.0f32 &&
                       (*this).actor.world.pos.y <
                           (*this).actor.home.pos.y - 50.0f32 {
                    gallery = (*this).actor.parent as *mut EnSyatekiItm;
                    (*this).actor.velocity.y = 0.0f32;
                    (*this).actor.gravity = 0.0f32;
                    if (*gallery).actor.update.is_some() {
                        (*gallery).targetState[(*this).index as usize] =
                            ENSYATEKIHIT_MISS as libc::c_int as s16
                    }
                    Actor_Kill(&mut (*this).actor);
                }
            }
            4 => {
                ...
                if (*this).actor.velocity.x < 0.0f32 &&
            ...
            _ => {
                match (*this).moveState as libc::c_int {
                    0 => {
                        if fabsf((*this).actor.world.pos.x -
                                     (*this).targetPos.x) > 5.0f32 ||
                               fabsf((*this).actor.world.pos.y -
                                         (*this).targetPos.y) > 5.0f32 {
                            Math_ApproachF(&mut (*this).actor.world.pos.x,
                                           (*this).targetPos.x, 0.3f32,
                                           30.0f32);
                            Math_ApproachF(&mut (*this).actor.world.pos.y,
                                           (*this).targetPos.y, 0.3f32,
                                           30.0f32);
                        } else {
                            (*this).moveState =
                                MOVE_HOME as libc::c_int as s16;
                            (*this).waitTimer = 60 as libc::c_int as s16
                        }
                    }
                    1 => {
                        if (*this).waitTimer as libc::c_int ==
                               0 as libc::c_int {
                            if fabsf((*this).actor.world.pos.x -
                                         (*this).actor.home.pos.x) > 5.0f32 ||
                                   fabsf((*this).actor.world.pos.y -
                                ...
                                gallery =
                                    (*this).actor.parent as *mut EnSyatekiItm;
                                if (*gallery).actor.update.is_some() {
                                    (*gallery).targetState[(*this).index as
                                                               usize] =
                                        ENSYATEKIHIT_MISS as libc::c_int as
                                            s16
                                }
                                Actor_Kill(&mut (*this).actor);
                            }
        ...
        if (*this).collider.base.acFlags as libc::c_int &
            ...
            if (*gallery).actor.update.is_some() {
                (*gallery).hitCount += 1;
                (*gallery).targetState[(*this).index as usize] =
                    ENSYATEKIHIT_HIT as libc::c_int as s16;
                func_80078884(0x28d3 as libc::c_int as u16_0);
                func_80078884(0x4803 as libc::c_int as u16_0);
                // "Yeah !"
                osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x84\xe3\x81\x87\xe3\x81\x87\xe3\x83\xbc\xe3\x81\x99\xef\xbc\x81\xef\xbc\xa8\xef\xbc\xa9\xef\xbc\xb4\xef\xbc\x81\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                 as *const u8 as *const libc::c_char,
                             (*gallery).hitCount as libc::c_int);
                EnGSwitch_Break(this, globalCtx);
                (*this).killTimer = 50 as libc::c_int as s16;
                (*this).broken = 1 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(EnGSwitch_Kill as
                             unsafe extern "C" fn(_: *mut EnGSwitch,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_ArcheryPot(mut this: *mut EnGSwitch,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut angle: s16 = 0;
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        while i < 30 as libc::c_int {
            ...
            let mut pad: s32 = 0;
            pos.x = sn * 8.0f32;
            pos.y = 10.0f32 + Rand_CenteredFloat(5.0f32);
            pos.z = cs * 8.0f32;
            vel.x = pos.x / 2.0f32;
            vel.y = 10.0f32 + Rand_ZeroOne() * 15.0f32;
            vel.z = pos.z / 2.0f32;
            pos.x += (*thisPos).x;
            pos.y += (*thisPos).y;
            pos.z += (*thisPos).z;
            rand = Rand_ZeroOne();
            if rand < 0.2f32 {
                phi_s0 = 0x60 as libc::c_int
            } else if rand < 0.6f32 {
                phi_s0 = 0x40 as libc::c_int
            } else { phi_s0 = 0x20 as libc::c_int }
            scale = (30.0f32 + Rand_ZeroOne() * 130.0f32) as s32;
            EffectSsKakera_Spawn(globalCtx, &mut pos, &mut vel, thisPos,
                                 -(240 as libc::c_int) as s16, phi_s0 as s16,
                                 10 as libc::c_int as s16,
                                 10 as libc::c_int as s16,
                                 0 as libc::c_int as s16, scale as s16,
                                 0 as libc::c_int as s16,
                                 0x20 as libc::c_int as s16,
                                 60 as libc::c_int,
                                 KAKERA_COLOR_NONE as libc::c_int as s16,
                                 OBJECT_TSUBO as libc::c_int as s16,
                                 object_tsubo_DL_001960.as_mut_ptr());
            i += 1;
            angle = (angle as libc::c_int + 0x4e20 as libc::c_int) as s16
        }
        func_80033480(globalCtx, thisPos, 30.0f32, 4 as libc::c_int,
                      20 as libc::c_int as s16, 50 as libc::c_int as s16,
                      0 as libc::c_int as u8_0);
        Audio_PlaySoundAtPosition(globalCtx, thisPos, 40 as libc::c_int,
                                  0x2887 as libc::c_int as u16_0);
        EnGSwitch_Break(this, globalCtx);
        (*this).killTimer = 50 as libc::c_int as s16;
        (*this).broken = 1 as libc::c_int as s16;
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_Kill(mut this: *mut EnGSwitch,
                                        mut globalCtx: *mut GlobalContext) {
    if (*this).killTimer as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGSwitch = thisx as *mut EnGSwitch;
    ...
    if (*this).type_0 as libc::c_int !=
           ENGSWITCH_SILVER_TRACKER as libc::c_int &&
           (*this).type_0 as libc::c_int !=
               ENGSWITCH_SILVER_RUPEE as libc::c_int &&
           (*this).type_0 as libc::c_int !=
               ENGSWITCH_TARGET_RUPEE as libc::c_int {
        Actor_MoveForward(&mut (*this).actor);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 50.0f32,
                                50.0f32, 100.0f32, 0x1c as libc::c_int);
    }
    if (*this).actor.draw.is_some() {
        if (*this).type_0 as libc::c_int ==
               ENGSWITCH_TARGET_RUPEE as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_DrawPot(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGSwitch = thisx as *mut EnGSwitch;
    if (*this).broken == 0 {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_g_switch.c\x00" as *const u8 as
                            *const libc::c_char, 918 as libc::c_int);
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            object_tsubo_DL_0017C0.as_mut_ptr() as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_g_switch.c\x00" as *const u8 as
                             *const libc::c_char, 928 as libc::c_int);
    };
}
static mut sRupeeTextures: [*mut libc::c_void; 6] =
    unsafe {
        [gRupeeGreenTex.as_ptr() as *mut _ as *mut libc::c_void,
         ...
         gRupeeSilverTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_DrawRupee(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGSwitch = thisx as *mut EnGSwitch;
    if (*this).broken == 0 {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_g_switch.c\x00" as *const u8 as
                            *const libc::c_char, 951 as libc::c_int);
        func_80093D18((*globalCtx).state.gfxCtx);
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((sRupeeTextures[(*this).colorIdx as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(sRupeeTextures[(*this).colorIdx
                                                                 as usize] as
                                                  u32_0 &
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_SpawnEffects(mut this: *mut EnGSwitch,
                                                mut pos: *mut Vec3f,
                                                mut scale: s16,
                                                mut colorIdx: s16) {
    let mut effect: *mut EnGSwitchEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < (*this).numEffects as libc::c_int {
        if (*effect).flag == 0 {
            let mut baseVel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut pitch: f32_0 = 0.;
            let mut yaw: f32_0 = 0.;
            (*effect).pos = *pos;
            (*effect).scale = scale;
            (*effect).colorIdx = colorIdx;
            (*effect).timer = 30 as libc::c_int as s16;
            (*effect).rot.z = 0.0f32;
            (*effect).rot.y = (*effect).rot.z;
            (*effect).rot.x = (*effect).rot.y;
            pitch = Rand_CenteredFloat(1000.0f32) - 13000.0f32;
            yaw = Rand_CenteredFloat(65535.0f32);
            Matrix_RotateY(yaw, MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_RotateX(pitch, MTXMODE_APPLY as libc::c_int as u8_0);
            baseVel.y = 0.0f32;
            baseVel.x = baseVel.y;
            baseVel.z = 20.0f32;
            Matrix_MultVec3f(&mut baseVel, &mut (*effect).velocity);
            (*effect).flag = 1 as libc::c_int as u8_0;
            return
        }
        i += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_UpdateEffects(mut this: *mut EnGSwitch,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut temp: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s16 = 0;
    let mut effect: *mut EnGSwitchEffect = (*this).effects.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) < (*this).numEffects as libc::c_int {
        if (*effect).flag != 0 {
            (*effect).rot.x += Rand_ZeroOne() * 10.0f32 + 15.0f32;
            (*effect).rot.y += Rand_ZeroOne() * 10.0f32 + 15.0f32;
            (*effect).rot.z += Rand_ZeroOne() * 10.0f32 + 15.0f32;
            temp.x = (*effect).pos.x + (*effect).velocity.x;
            temp.y = (*effect).pos.y + (*effect).velocity.y;
            temp.z = (*effect).pos.z + (*effect).velocity.z;
            Math_ApproachF(&mut (*effect).pos.x, temp.x, 0.3f32, 30.0f32);
            Math_ApproachF(&mut (*effect).pos.y, temp.y, 0.8f32, 250.0f32);
            Math_ApproachF(&mut (*effect).pos.z, temp.z, 0.3f32, 30.0f32);
            Math_ApproachF(&mut (*effect).velocity.y, -20.0f32, 0.9f32,
                           1.0f32);
            if (*effect).timer as libc::c_int != 0 as libc::c_int {
                (*effect).timer -= 1
            } else if ((*effect).scale as libc::c_int) < 10 as libc::c_int {
                (*effect).flag = 0 as libc::c_int as u8_0
            } else {
                (*effect).scale =
                    ((*effect).scale as libc::c_int - 2 as libc::c_int) as s16
            }
        }
        i += 1;
        effect = effect.offset(1)
...
#[no_mangle]
pub unsafe extern "C" fn EnGSwitch_DrawEffects(mut this: *mut EnGSwitch,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ...
    while (i as libc::c_int) < (*this).numEffects as libc::c_int {
        if (*effect).flag != 0 {
            scale =
                (*effect).scale as libc::c_int as libc::c_float / 10000.0f32;
            ...
            Matrix_RotateX((*effect).rot.x,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateY((*effect).rot.y,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*effect).rot.z,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gSegments[((sRupeeTextures[(*effect).colorIdx as usize] as
                                u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(sRupeeTextures[(*effect).colorIdx
                                                                     as usize]
                                                      as u32_0 &
