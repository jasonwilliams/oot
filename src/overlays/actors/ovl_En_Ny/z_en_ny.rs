...
extern "C" {
    ...
    #[no_mangle]
    static mut gEnNyRockBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gEnNyMetalBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gEnNySpikeDL: [Gfx; 0];
}
...
pub struct EnNy {
    ...
    pub unk_1F0: f32_0,
    pub unk_1F4: f32_0,
    pub unk_1F8: [Vec3f; 16],
}
pub type EnNyActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Ny_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NY as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_NY as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnNy>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sColliderInit, (*this).elements.as_mut_ptr());
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 20.0f32);
    (*this).unk_1CA = 0 as libc::c_int as s16;
    (*this).unk_1D0 = 0 as libc::c_int as u8_0;
    ...
    (*this).hitPlayer = 0 as libc::c_int as s16;
    (*this).unk_1CE = 2 as libc::c_int as u16_0;
    (*this).actor.velocity.y = 0.0f32;
    (*this).unk_1D4 = 0xff as libc::c_int;
    (*this).unk_1D8 = 0 as libc::c_int;
    (*this).unk_1E8 = 0.0f32;
    (*this).unk_1E0 = 0.25f32;
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        // "New initials"
        osSyncPrintf(b"\xe3\x83\x8b\xe3\x83\xa5\xe3\x82\xa6 \xe3\x82\xa4\xe3\x83\x8b\xe3\x82\xb7\xe3\x83\xa3\xe3\x83\xab[ %d ] \xef\xbc\x81\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
        (*this).actor.colChkInfo.mass = 0 as libc::c_int as u8_0;
        (*this).unk_1D4 = 0 as libc::c_int;
        (*this).unk_1D8 = 0xff as libc::c_int;
        (*this).unk_1E0 = 1.0f32;
        func_80ABCDBC(this);
    } else {
        // This mode is unused in the final game
        // "Dummy new initials"
        osSyncPrintf(b"\xe3\x83\x80\xe3\x83\x9f\xe3\x83\xbc\xe3\x83\x8b\xe3\x83\xa5\xe3\x82\xa6 \xe3\x82\xa4\xe3\x83\x8b\xe3\x82\xb7\xe3\x83\xa3\xe3\x83\xab[ %d ] \xef\xbc\x81\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
        osSyncPrintf(b"En_Ny_actor_move2[ %x ] \xef\xbc\x81\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char,
                     Some(EnNy_UpdateUnused as
                              unsafe extern "C" fn(_: *mut Actor,
                                                   _: *mut GlobalContext)
                                  -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCD40(mut this: *mut EnNy) {
    let mut temp: f32_0 = 0.;
    temp = if (*this).actor.yDistToWater > 0.0f32 { 0.7f32 } else { 1.0f32 };
    (*this).unk_1E8 = 2.8f32 * temp;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCD84(mut this: *mut EnNy) {
    (*this).actionFunc =
        Some(func_80ABCE50 as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCD94(mut this: *mut EnNy) {
    (*this).stoneTimer = 0x14 as libc::c_int;
    (*this).actionFunc =
        Some(func_80ABCE90 as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCDAC(mut this: *mut EnNy) {
    (*this).actionFunc =
        Some(func_80ABCEEC as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCDBC(mut this: *mut EnNy) {
    (*this).unk_1F4 = 0.0f32;
    func_80ABCD40(this);
    (*this).stoneTimer = 180 as libc::c_int;
    (*this).actionFunc =
        Some(EnNy_Move as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_SetupTurnToStone(mut this: *mut EnNy) {
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ea as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnNy_TurnToStone as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
    (*this).unk_1E8 = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCE38(mut this: *mut EnNy) {
    (*this).stoneTimer = 0x3c as libc::c_int;
    (*this).actionFunc =
        Some(func_80ABD11C as
                 unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCE50(mut this: *mut EnNy,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.xyzDistToPlayerSq <= 25600.0f32 { func_80ABCD94(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ABCE90(mut this: *mut EnNy,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_v1: s32 = 0;
    let mut phi_v0: s32 = 0;
    phi_v1 = (*this).unk_1D4 - 0x40 as libc::c_int;
    phi_v0 = (*this).unk_1D8 + 0x40 as libc::c_int;
    if phi_v0 >= 0xff as libc::c_int {
        phi_v1 = 0 as libc::c_int;
        phi_v0 = 0xff as libc::c_int;
        func_80ABCDAC(this);
    }
    (*this).unk_1D4 = phi_v1;
    (*this).unk_1D8 = phi_v0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABCEEC(mut this: *mut EnNy,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_f0: f32_0 = 0.;
    phi_f0 = (*this).unk_1E0;
    phi_f0 += 2.0f32;
    if phi_f0 >= 1.0f32 { phi_f0 = 1.0f32; func_80ABCDBC(this); }
    (*this).unk_1E0 = phi_f0;
}
#[no_mangle]
pub unsafe extern "C" fn EnNy_Move(mut this: *mut EnNy,
                                   mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: f32_0 = 0.;
    let mut stoneTimer: s32 = 0;
    if !((*this).unk_1F0 < (*this).actor.yDistToWater) {
        func_8002F974(&mut (*this).actor,
                      (0x38e9 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    func_80ABCD40(this);
    stoneTimer = (*this).stoneTimer;
    (*this).stoneTimer -= 1;
    if stoneTimer <= 0 as libc::c_int ||
           (*this).hitPlayer as libc::c_int != 0 as libc::c_int {
        EnNy_SetupTurnToStone(this);
    } else {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           0xa as libc::c_int as s16, (*this).unk_1F4 as s16,
                           0 as libc::c_int as s16);
        Math_ApproachF(&mut (*this).unk_1F4, 2000.0f32, 1.0f32, 100.0f32);
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        yawDiff =
            Math_FAtan2F((*this).actor.yDistToPlayer,
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_TurnToStone(mut this: *mut EnNy,
                                          mut globalCtx: *mut GlobalContext) {
    let mut phi_f0: f32_0 = 0.;
    phi_f0 = (*this).unk_1E0;
    phi_f0 -= 2.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABD11C(mut this: *mut EnNy,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_v0: s32 = 0;
    let mut phi_v1: s32 = 0;
    phi_v0 = (*this).unk_1D4;
    ...
    phi_v1 = (*this).unk_1D8;
    phi_v1 -= 0x40 as libc::c_int;
    if phi_v0 >= 0xff as libc::c_int {
        phi_v0 = 0xff as libc::c_int;
        phi_v1 = 0 as libc::c_int;
        if (*this).stoneTimer != 0 as libc::c_int {
            (*this).stoneTimer -= 1
        } else { func_80ABCD84(this); }
    }
    (*this).unk_1D4 = phi_v0;
    (*this).unk_1D8 = phi_v1;
}
#[no_mangle]
pub unsafe extern "C" fn EnNy_CollisionCheck(mut this: *mut EnNy,
                                             mut globalCtx:
                                                 *mut GlobalContext) -> s32 {
    let mut sp3F: u8_0 = 0;
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    sp3F = 0 as libc::c_int as u8_0;
    (*this).hitPlayer = 0 as libc::c_int as s16;
    if (*this).collider.base.atFlags as libc::c_int & 4 as libc::c_int != 0 {
        ...
        (*this).hitPlayer = 1 as libc::c_int as s16;
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.speedXZ = -4.0f32;
        return 0 as libc::c_int
    }
    if (*this).collider.base.atFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).collider.base.atFlags =
            ((*this).collider.base.atFlags as libc::c_int &
        ...
        if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int !=
            ...
            effectPos.x =
                (*(*this).collider.elements.offset(0 as libc::c_int as
                                                       isize)).info.bumper.hitPos.x
                    as f32_0;
            effectPos.y =
                (*(*this).collider.elements.offset(0 as libc::c_int as
                                                       isize)).info.bumper.hitPos.y
                    as f32_0;
            effectPos.z =
                (*(*this).collider.elements.offset(0 as libc::c_int as
                                                       isize)).info.bumper.hitPos.z
                    as f32_0;
            if (*this).unk_1E0 == 0.25f32 &&
                   (*this).unk_1D4 == 0xff as libc::c_int {
                let mut current_block_24: u64;
                match (*this).actor.colChkInfo.damageEffect as libc::c_int {
                    14 => {
                        sp3F = 1 as libc::c_int as u8_0;
                        current_block_24 = 1596945661838045217;
                    }
                    15 => { current_block_24 = 1596945661838045217; }
                    1 => {
                        ...
                        current_block_24 = 14818589718467733107;
                    }
                    2 => {
                        (*this).unk_1CA = 4 as libc::c_int as s16;
                        Actor_ApplyDamage(&mut (*this).actor);
                        Actor_SetColorFilter(&mut (*this).actor,
                                             0x4000 as libc::c_int as s16,
                                             0xff as libc::c_int as s16,
                    ...
                    _ => { current_block_24 = 14818589718467733107; }
                }
            ...
            (*this).stoneTimer = 0 as libc::c_int;
            ...
            EffectSsHitMark_SpawnFixedScale(globalCtx, 0 as libc::c_int,
                                            &mut effectPos);
            return 0 as libc::c_int
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ABD3B8(mut this: *mut EnNy, mut arg1: f32_0,
                                       mut arg2: f32_0) {
    if (*this).unk_1E8 == 0.0f32 {
        (*this).actor.gravity = -0.4f32
    } else if !(arg1 < (*this).actor.yDistToWater) {
        (*this).actor.gravity = -0.4f32
    } else if arg2 < (*this).actor.yDistToWater {
        (*this).actor.gravity = 0.0f64 as f32_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    ...
    let mut i: s32 = 0;
    (*this).timer += 1;
    temp_f20 = (*this).unk_1E0 - 0.25f32;
    if (*this).unk_1CA as libc::c_int != 0 as libc::c_int {
        (*this).unk_1CA -= 1
    }
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    (*(*this).collider.elements.offset(0 as libc::c_int as isize)).dim.scale =
        1.33f32 * temp_f20 + 1.0f32;
    temp_f22 = 24.0f32 * temp_f20 + 12.0f32;
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int +
             ((*this).unk_1E8 * 1000.0f32) as s16 as libc::c_int) as s16;
    func_80ABD3B8(this, temp_f22 + 10.0f32, temp_f22 - 10.0f32);
    Actor_MoveForward(&mut (*this).actor);
    Math_StepToF(&mut (*this).unk_1E4, (*this).unk_1E8, 0.1f32);
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 20.0f32,
                            60.0f32, 7 as libc::c_int);
    (*this).unk_1F0 = temp_f22;
    (*this).actor.world.pos.y += temp_f22;
    if EnNy_CollisionCheck(this, globalCtx) != 0 as libc::c_int {
        i = 0 as libc::c_int;
        while i < 8 as libc::c_int {
            (*this).unk_1F8[i as usize].x =
                Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
            (*this).unk_1F8[i as usize].y =
                Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.y;
            (*this).unk_1F8[i as usize].z =
                Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
            i += 1
        }
        (*this).timer = 0 as libc::c_int as s16;
        (*this).actor.update =
            Some(EnNy_UpdateDeath as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.draw =
            Some(EnNy_DrawDeathEffect as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actionFunc =
            Some(EnNy_SetupDie as
                     unsafe extern "C" fn(_: *mut EnNy, _: *mut GlobalContext)
                         -> ());
        return
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_SetupDie(mut this: *mut EnNy,
                                       mut globalCtx: *mut GlobalContext) {
    let mut effectScale: s32 = 0;
    let mut i: s32 = 0;
    let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if (*this).timer as libc::c_int >= 2 as libc::c_int {
        if (*this).actor.yDistToWater > 0.0f32 {
            ...
            while i < 10 as libc::c_int {
                effectPos.x =
                    Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.x;
                effectPos.y =
                    Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.y;
                effectPos.z =
                    Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.z;
                effectScale =
                    Rand_S16Offset(0x50 as libc::c_int as s16,
                                   0x64 as libc::c_int as s16) as s32;
            ...
            while i < 0x14 as libc::c_int {
                ...
                effectPos.z =
                    Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.z;
                EffectSsBubble_Spawn(globalCtx, &mut effectPos, 10.0f32,
                                     10.0f32, 30.0f32, 0.25f32);
                i += 1
            }
        }
        i = 0 as libc::c_int;
        while i < 8 as libc::c_int {
            (*this).unk_1F8[(i + 8 as libc::c_int) as usize].x =
                Rand_CenteredFloat(10.0f32);
            (*this).unk_1F8[(i + 8 as libc::c_int) as usize].z =
                Rand_CenteredFloat(10.0f32);
            (*this).unk_1F8[(i + 8 as libc::c_int) as usize].y =
                Rand_ZeroFloat(4.0f32) + 4.0f32;
            i += 1
        }
        (*this).timer = 0 as libc::c_int as s16;
        if (*this).unk_1D0 as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_Die(mut this: *mut EnNy,
                                  mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*this).actor.yDistToWater > 0.0f32 {
        i = 0 as libc::c_int;
        while i < 8 as libc::c_int {
            ...
            (*this).unk_1F8[i as usize].z +=
                (*this).unk_1F8[(i + 8 as libc::c_int) as usize].z;
            Math_StepToF(&mut (*(*this).unk_1F8.as_mut_ptr().offset((i +
                                                                         8 as
                                                                             libc::c_int)
                                                                        as
                                                                        isize)).x,
        ...
        if (*this).timer as libc::c_int >= 0x1f as libc::c_int {
        ...
        if (*this).timer as libc::c_int >= 0x10 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            return
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_UpdateDeath(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    (*this).timer += 1;
    if (*this).unk_1CA as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_UpdateUnused(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    ...
    sp3C = (*this).unk_1E0 - 0.25f32;
    (*this).timer += 1;
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    temp_f0 = 24.0f32 * sp3C + 12.0f32;
...
static mut sFireOffsets: [Vec3f; 4] =
    [{ let mut init = Vec3f{x: 5.0f32, y: 0.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: -5.0f32, y: 0.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 5.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -5.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnNy_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNy = thisx as *mut EnNy;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ny.c\x00" as *const u8 as *const libc::c_char,
                    837 as libc::c_int);
    Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).collider);
    func_8002ED80(&mut (*this).actor, globalCtx, 1 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gEnNyMetalBodyDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_7).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_7).words.w1 = gEnNyRockBodyDL.as_mut_ptr() as libc::c_uint;
    if (*this).unk_1E0 > 0.25f32 {
        Matrix_Scale((*this).unk_1E0, (*this).unk_1E0, (*this).unk_1E0,
        ...
        (*_g_8).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_ny.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_9).words.w1 = gEnNySpikeDL.as_mut_ptr() as libc::c_uint
    }
    ...
    if (*this).unk_1CA as libc::c_int != 0 as libc::c_int {
        ...
        let mut fireOffset: *mut Vec3f = 0 as *mut Vec3f;
        let mut temp: s16 = 0;
        temp = ((*this).unk_1CA as libc::c_int - 1 as libc::c_int) as s16;
        (*this).actor.colorFilterTimer =
            (*this).actor.colorFilterTimer.wrapping_add(1);
        if temp as libc::c_int == 0 as libc::c_int {
            fireOffset =
                &mut *sFireOffsets.as_mut_ptr().offset((temp as libc::c_int &
                                                            3 as libc::c_int)
                                                           as isize) as
                    *mut Vec3f;
            tempVec.x =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.x + (*fireOffset).x);
            tempVec.y =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.y + (*fireOffset).y);
            tempVec.z =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.z + (*fireOffset).z);
            EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                      &mut tempVec, 100 as libc::c_int as s16,
                                      0 as libc::c_int as s16,
                                      0 as libc::c_int as s16,
                                      -(1 as libc::c_int) as s16);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnNy_DrawDeathEffect(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnNy = thisx as *mut EnNy;
    let mut temp: *mut Vec3f = 0 as *mut Vec3f;
    ...
    i = 0 as libc::c_int;
    while i < 8 as libc::c_int {
        if ((*this).timer as libc::c_int) < i + 22 as libc::c_int {
            temp =
                &mut *(*this).unk_1F8.as_mut_ptr().offset(i as isize) as
                    *mut Vec3f;
            Matrix_Translate((*temp).x, (*temp).y, (*temp).z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            scale =
                (*this).actor.scale.x * 0.4f32 *
                    (1.0f32 + i as libc::c_float * 0.04f32);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = gEnNyRockBodyDL.as_mut_ptr() as libc::c_uint
        }
        i += 1
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    if (*this).unk_1CA as libc::c_int != 0 as libc::c_int {
        let mut tempVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut fireOffset: *mut Vec3f = 0 as *mut Vec3f;
        let mut fireOffsetIndex: s16 = 0;
        fireOffsetIndex =
            ((*this).unk_1CA as libc::c_int - 1 as libc::c_int) as s16;
        (*this).actor.colorFilterTimer =
            (*this).actor.colorFilterTimer.wrapping_add(1);
        if fireOffsetIndex as libc::c_int & 1 as libc::c_int ==
               0 as libc::c_int {
            fireOffset =
                &mut *sFireOffsets.as_mut_ptr().offset((fireOffsetIndex as
                                                            libc::c_int &
                                                            3 as libc::c_int)
                                                           as isize) as
                    *mut Vec3f;
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x28 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
