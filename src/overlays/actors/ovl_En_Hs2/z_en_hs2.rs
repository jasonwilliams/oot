...
pub struct EnHs2 {
    ...
    pub unk_2A2: Vec3s,
    pub unk_2A8: u16_0,
    pub actionFunc: EnHs2ActionFunc,
}
pub type EnHs2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHs2, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Hs2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HS2 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnHs2>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnHs2_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    let mut pad: s32 = 0;
    ...
    (*this).actionFunc =
        Some(func_80A6F1A4 as
                 unsafe extern "C" fn(_: *mut EnHs2, _: *mut GlobalContext)
                     -> ());
    (*this).unk_2A8 = 0 as libc::c_int as u16_0;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
}
#[no_mangle]
pub unsafe extern "C" fn EnHs2_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6F0B4(mut this: *mut EnHs2,
                                       mut globalCtx: *mut GlobalContext,
                                       mut textId: u16_0,
                                       mut actionFunc: EnHs2ActionFunc)
 -> s32 {
    ...
    if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
            ...
            -(((*this).actor.yawTowardsPlayer as libc::c_int -
                   (*this).actor.shape.rot.y as libc::c_int) as s16 as
                  libc::c_int)
        }) < 0x2151 as libc::c_int && (*this).actor.xzDistToPlayer < 100.0f32
       {
        (*this).unk_2A8 =
            ((*this).unk_2A8 as libc::c_int | 0x1 as libc::c_int) as u16_0;
        func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6F164(mut this: *mut EnHs2,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80A6F1A4 as
                     unsafe extern "C" fn(_: *mut EnHs2,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).unk_2A8 =
        ((*this).unk_2A8 as libc::c_int | 0x1 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6F1A4(mut this: *mut EnHs2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut textId: u16_0 = 0;
    textId = Text_GetFaceReaction(globalCtx, 9 as libc::c_int as u32_0);
    if textId as libc::c_int == 0 as libc::c_int {
        textId = 0x5069 as libc::c_int as u16_0
    }
    func_80A6F0B4(this, globalCtx, textId,
                  Some(func_80A6F164 as
                           unsafe extern "C" fn(_: *mut EnHs2,
                                                _: *mut GlobalContext)
                               -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnHs2_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    let mut pad: s32 = 0;
    ...
    if (*this).unk_2A8 as libc::c_int & 0x1 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHs2_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    match limbIndex {
        12 | 13 => { *dList = 0 as *mut Gfx; return 0 as libc::c_int }
        9 => {
            (*rot).x =
...
#[no_mangle]
pub unsafe extern "C" fn EnHs2_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    static mut D_80A6F4CC: Vec3f =
        { let mut init = Vec3f{x: 300.0f32, y: 1000.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    if limbIndex == 9 as libc::c_int {
        Matrix_MultVec3f(&mut D_80A6F4CC, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHs2_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHs2 = thisx as *mut EnHs2;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnHs2_OverrideLimbDraw as
