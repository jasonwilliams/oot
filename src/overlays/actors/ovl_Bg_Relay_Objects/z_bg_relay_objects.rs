...
extern "C" {
    ...
    #[no_mangle]
    static mut gDampeRaceDoorDL: [Gfx; 0];
    #[no_mangle]
    static mut gDampeRaceDoorCol: CollisionHeader;
    #[no_mangle]
    static mut gWindmillRotatingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gWindmillRotatingPlatformCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgRelayObjects {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgRelayObjectsActionFunc,
    pub switchFlag: u8_0,
    pub unk_169: s8,
    pub timer: s16,
}
pub type BgRelayObjectsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgRelayObjects, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const WINDMILL_DAMPE_STONE_DOOR: C2RustUnnamed_19 = 1;
pub const WINDMILL_ROTATING_GEAR: C2RustUnnamed_19 = 0;
#[no_mangle]
pub static mut Bg_Relay_Objects_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_RELAY_OBJECTS as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_RELAY_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgRelayObjects>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgRelayObjects_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgRelayObjects_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgRelayObjects_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgRelayObjects_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgRelayObjects_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut D_808A9508: u32_0 = 0 as libc::c_int as u32_0;
    let mut this: *mut BgRelayObjects = thisx as *mut BgRelayObjects;
    let mut pad: s32 = 0;
    ...
    DynaPolyActor_Init(&mut (*this).dyna, 3 as libc::c_int);
    if (*thisx).params as libc::c_int == WINDMILL_ROTATING_GEAR as libc::c_int
       {
        CollisionHeader_GetVirtual(&mut gWindmillRotatingPlatformCol as
        ...
        if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int
            ...
            (*thisx).world.rot.y = 0x400 as libc::c_int as s16
        } else { (*thisx).world.rot.y = 0x80 as libc::c_int as s16 }
        func_800F5718();
        (*thisx).room = -(1 as libc::c_int) as s8;
        (*thisx).flags |=
            ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
        if D_808A9508 & 2 as libc::c_int as libc::c_uint != 0 {
            (*thisx).params = 0xff as libc::c_int as s16;
            Actor_Kill(thisx);
        } else {
            D_808A9508 |= 2 as libc::c_int as libc::c_uint;
            (*this).actionFunc =
                Some(func_808A939C as
                         unsafe extern "C" fn(_: *mut BgRelayObjects,
                                              _: *mut GlobalContext) -> ())
        }
    } else {
        CollisionHeader_GetVirtual(&mut gDampeRaceDoorCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        if (*thisx).room as libc::c_int == 0 as libc::c_int {
            (*this).unk_169 =
                ((*this).switchFlag as libc::c_int - 0x33 as libc::c_int) as
                    s8
        } else {
            (*this).unk_169 =
                ((*thisx).room as libc::c_int + 1 as libc::c_int) as s8
        }
        (*thisx).room = -(1 as libc::c_int) as s8;
        (*this).timer = 1 as libc::c_int as s16;
        if (*this).unk_169 as libc::c_int >= 6 as libc::c_int {
            if D_808A9508 & 1 as libc::c_int as libc::c_uint != 0 {
                Actor_Kill(thisx);
            } else {
                D_808A9508 |= 1 as libc::c_int as libc::c_uint;
                (*this).actionFunc =
                    Some(BgRelayObjects_DoNothing as
                             unsafe extern "C" fn(_: *mut BgRelayObjects,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        } else if (*this).unk_169 as libc::c_int != 5 as libc::c_int {
            Flags_UnsetSwitch(globalCtx, (*this).switchFlag as s32);
            if D_808A9508 &
                   ((1 as libc::c_int) << (*this).unk_169 as libc::c_int) as
                       libc::c_uint != 0 {
                Actor_Kill(thisx);
            } else {
                D_808A9508 |=
            ...
            (*this).actionFunc =
                Some(func_808A91AC as
                         unsafe extern "C" fn(_: *mut BgRelayObjects,
                                              _: *mut GlobalContext) -> ());
            (*thisx).world.pos.y += 120.0f32;
            D_808A9508 |= 1 as libc::c_int as libc::c_uint
        }
    }
    (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn BgRelayObjects_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgRelayObjects = thisx as *mut BgRelayObjects;
    ...
    if (*this).dyna.actor.params as libc::c_int ==
           WINDMILL_ROTATING_GEAR as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_808A90F4(mut this: *mut BgRelayObjects,
    ...
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            ...
            } else { (*this).timer = 160 as libc::c_int as s16 }
        }
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y + 120.0f32, 12.0f32) !=
               0 {
            (*this).actionFunc =
                Some(func_808A91AC as
                         unsafe extern "C" fn(_: *mut BgRelayObjects,
...
#[no_mangle]
pub unsafe extern "C" fn func_808A91AC(mut this: *mut BgRelayObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_169 as libc::c_int != 5 as libc::c_int {
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           (*this).unk_169 as libc::c_int ==
               (*globalCtx).roomCtx.curRoom.num as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x281c as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_808A9234 as
                     unsafe extern "C" fn(_: *mut BgRelayObjects,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808A9234(mut this: *mut BgRelayObjects,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
        ...
        func_800AA000((*this).dyna.actor.xyzDistToPlayerSq,
                      180 as libc::c_int as u8_0, 20 as libc::c_int as u8_0,
                      100 as libc::c_int as u8_0);
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x281d as libc::c_int as u16_0);
        if (*this).unk_169 as libc::c_int !=
               (*globalCtx).roomCtx.curRoom.num as libc::c_int {
            func_800788CC(0x38ec as libc::c_int as u16_0);
            (*this).timer = 5 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_808A932C as
                         unsafe extern "C" fn(_: *mut BgRelayObjects,
                                              _: *mut GlobalContext) -> ());
            return
        }
        ...
        if (*globalCtx).roomCtx.curRoom.num as libc::c_int == 4 as libc::c_int
           {
...
#[no_mangle]
pub unsafe extern "C" fn BgRelayObjects_DoNothing(mut this:
                                                      *mut BgRelayObjects,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808A932C(mut this: *mut BgRelayObjects,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_808A939C(mut this: *mut BgRelayObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetEnv(globalCtx, 5 as libc::c_int as s16) != 0 {
        gSaveContext.eventChkInf[6 as libc::c_int as usize] =
            (gSaveContext.eventChkInf[6 as libc::c_int as usize] as
                 libc::c_int | 0x20 as libc::c_int) as u16_0
    }
    if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int &
           0x20 as libc::c_int != 0 {
        Math_ScaledStepToS(&mut (*this).dyna.actor.world.rot.y,
    ...
    func_800F436C(&mut (*this).dyna.actor.projectedPos,
                  (0x2876 as libc::c_int - 0x800 as libc::c_int) as u16_0,
                  ((*this).dyna.actor.world.rot.y as libc::c_int -
                       0x80 as libc::c_int) as libc::c_float *
                      (1.0f32 / 0x380 as libc::c_int as libc::c_float) +
                      1.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgRelayObjects_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgRelayObjects = thisx as *mut BgRelayObjects;
...
#[no_mangle]
pub unsafe extern "C" fn BgRelayObjects_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgRelayObjects = thisx as *mut BgRelayObjects;
    if (*this).dyna.actor.params as libc::c_int ==
           WINDMILL_ROTATING_GEAR as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gWindmillRotatingPlatformDL.as_mut_ptr());
    } else { Gfx_DrawDListOpa(globalCtx, gDampeRaceDoorDL.as_mut_ptr()); };
}
