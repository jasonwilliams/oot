...
extern "C" {
    ...
    #[no_mangle]
    fn BgCheck_EntitySphVsWall1(colCtx: *mut CollisionContext,
    ...
    #[no_mangle]
    fn Collider_FreeJntSph(globalCtx: *mut GlobalContext,
                           collider: *mut ColliderJntSph) -> s32;
    #[no_mangle]
    fn Collider_SetJntSphAllocType1(globalCtx: *mut GlobalContext,
                                    dest: *mut ColliderJntSph,
                                    actor: *mut Actor,
                                    src: *mut ColliderJntSphInitType1) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gCuccoChickSetupBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickSetupEyeDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickEyesDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickSetupBeakDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickBeakDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickSetupShadowDL: [Gfx; 0];
    #[no_mangle]
    static mut gCuccoChickShadowDL: [Gfx; 0];
}
...
pub struct EnNwc {
    ...
    pub count: u8_0,
    pub chicks: [EnNwcChick; 16],
    pub updateFunc: EnNwcUpdateFunc,
}
pub type EnNwcUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNwc, _: *mut GlobalContext) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnNwcChick {
    pub type_0: s8,
    pub bgFlags: u8_0,
    pub floorY: f32_0,
    pub pos: Vec3f,
    ...
    pub height: u16_0,
    pub floorPoly: *mut CollisionPoly,
    pub unk_3C: [libc::c_char; 32],
}
pub type EnNwcChickFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnNwcChick, _: *mut EnNwc,
                                _: *mut GlobalContext) -> ()>;
pub const CHICK_NORMAL: C2RustUnnamed_21 = 1;
pub const CHICK_NONE: C2RustUnnamed_21 = 0;
pub type C2RustUnnamed_21 = libc::c_uint;
#[no_mangle]
pub static mut En_Nwc_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_NWC as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_NWC as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnNwc>() as libc::c_ulong,
                          init:
...
static mut sJntSphElementInit: ColliderJntSphElementInit =
    {
        let mut init =
...
static mut sJntSphInit: ColliderJntSphInitType1 =
    {
        let mut init =
            ColliderJntSphInitType1{base:
                                        {
                                            let mut init =
                                    ...
                                    elements:
                                        0 as *const ColliderJntSphElementInit
                                            as
                                            *mut ColliderJntSphElementInit,};
        init
    };
#[no_mangle]
pub unsafe extern "C" fn EnNwc_SetUpdate(mut this: *mut EnNwc,
                                         mut updateFunc: EnNwcUpdateFunc) {
    (*this).updateFunc = updateFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_ChickNoop(mut chick: *mut EnNwcChick,
                                         mut this: *mut EnNwc,
                                         mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_ChickBgCheck(mut chick: *mut EnNwcChick,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut outPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgId: s32 = 0;
    let mut outPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dy: f32_0 = 0.;
    (*chick).bgFlags =
        ((*chick).bgFlags as libc::c_int &
             (!((1 as libc::c_int) << 1 as libc::c_int) &
                  !((1 as libc::c_int) << 0 as libc::c_int))) as u8_0;
    outPos.x = (*chick).pos.x;
    outPos.y = (*chick).pos.y;
    outPos.z = (*chick).pos.z;
    if BgCheck_EntitySphVsWall1(&mut (*globalCtx).colCtx, &mut outPos,
                                &mut (*chick).pos, &mut (*chick).lastPos,
                                10.0f32, &mut (*chick).floorPoly, 20.0f32) !=
           0 {
        (*chick).bgFlags =
            ((*chick).bgFlags as libc::c_int |
    ...
    (*chick).floorY =
        BgCheck_EntityRaycastFloor3(&mut (*globalCtx).colCtx, &mut outPoly,
                                    &mut bgId, &mut outPos);
    dy = (*chick).floorY - (*chick).pos.y;
    if 0.0f32 <= dy && dy < 40.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnNwc_ChickFall(mut chick: *mut EnNwcChick,
                                         mut this: *mut EnNwc,
                                         mut globalCtx: *mut GlobalContext) {
    (*chick).velY -= 0.1f32;
    if (*chick).velY < -10.0f32 { (*chick).velY = -10.0f32 }
    (*chick).pos.y += (*chick).velY;
    EnNwc_ChickBgCheck(chick, globalCtx);
    !chick.is_null();
    // Needed for matching. Possibly from remnant of unfinished code?
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_UpdateChicks(mut this: *mut EnNwc,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    static mut chickActionFuncs: [EnNwcChickFunc; 2] =
        unsafe {
            [Some(EnNwc_ChickNoop as
                      unsafe extern "C" fn(_: *mut EnNwcChick, _: *mut EnNwc,
                                           _: *mut GlobalContext) -> ()),
             Some(EnNwc_ChickFall as
                      unsafe extern "C" fn(_: *mut EnNwcChick, _: *mut EnNwc,
                                           _: *mut GlobalContext) -> ())]
        };
    let mut chick: *mut EnNwcChick = (*this).chicks.as_mut_ptr();
    let mut element: *mut ColliderJntSphElement = (*this).collider.elements;
    let mut prevChickPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut i: s32 = 0;
    let mut test: f32_0 = 0.;
    prevChickPos.y = 99999.9f32;
    i = 0 as libc::c_int;
    while i < (*this).count as libc::c_int {
        Math_Vec3f_Copy(&mut (*chick).lastPos, &mut (*chick).pos);
        chickActionFuncs[(*chick).type_0 as
                             usize].expect("non-null function pointer")(chick,
                                                                        this,
                                                                        globalCtx);
        (*element).dim.worldSphere.center.x = (*chick).pos.x as s16;
        (*element).dim.worldSphere.center.y = (*chick).pos.y as s16;
        (*element).dim.worldSphere.center.z = (*chick).pos.z as s16;
        test = (*chick).pos.y - prevChickPos.y;
        if fabsf(test) < 10.0f32 {
            let mut dx: f32_0 = (*chick).pos.x - prevChickPos.x;
            let mut dz: f32_0 = (*chick).pos.z - prevChickPos.z;
            test = dx * dx + dz * dz;
            if test < 10.0f32 * 10.0f32 {
                if test != 0.0f32 {
                    (*chick).pos.x += dx / sqrtf(test);
                    (*chick).pos.z += dz / sqrtf(test)
                } else { (*chick).pos.x += 1.0f32; (*chick).pos.z += 1.0f32 }
            }
        }
        i += 1;
        prevChickPos = (*chick).pos;
        chick = chick.offset(1);
        element = element.offset(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_DrawChicks(mut this: *mut EnNwc,
                                          mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut dList1: *mut Gfx = 0 as *mut Gfx;
    let mut dList2: *mut Gfx = 0 as *mut Gfx;
    let mut dList3: *mut Gfx = 0 as *mut Gfx;
    let mut floorMat: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut chick: *mut EnNwcChick = 0 as *mut EnNwcChick;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_nwc.c\x00" as *const u8 as *const libc::c_char,
                    316 as libc::c_int);
    func_80093C80(globalCtx);
    dList1 = (*__gfxCtx).polyXlu.p;
    dList2 =
        dList1.offset((3 as libc::c_int * (*this).count as libc::c_int) as
                          isize).offset(1 as libc::c_int as isize);
    dList3 =
        dList2.offset((2 as libc::c_int * (*this).count as libc::c_int) as
                          isize).offset(1 as libc::c_int as isize);
    let fresh0 = dList1;
    dList1 = dList1.offset(1);
    ...
    (*_g).words.w1 = gCuccoChickSetupBodyDL.as_mut_ptr() as libc::c_uint;
    let fresh1 = dList2;
    dList2 = dList2.offset(1);
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gCuccoChickSetupEyeDL.as_mut_ptr() as libc::c_uint;
    let fresh2 = dList3;
    dList3 = dList3.offset(1);
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gCuccoChickSetupBeakDL.as_mut_ptr() as libc::c_uint;
    chick = (*this).chicks.as_mut_ptr();
    i = 0 as libc::c_int;
    while i < (*this).count as libc::c_int {
        if (*chick).type_0 as libc::c_int != CHICK_NONE as libc::c_int {
            let mut mtx: *mut Mtx = 0 as *mut Mtx;
            func_800D1694((*chick).pos.x,
                          (*chick).pos.y +
                              (*chick).height as libc::c_int as libc::c_float,
                          (*chick).pos.z, &mut (*chick).rot);
            Matrix_Scale(0.01f32, 0.01f32, 0.01f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            mtx =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_nwc.c\x00" as *const u8 as
                ...
                (0xda as libc::c_int as u32_0 &
                    ...
                    (((0 as libc::c_int | 0x2 as libc::c_int |
                         ...
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = mtx as libc::c_uint;
            let fresh5 = dList1;
            dList1 = dList1.offset(1);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_4).words.w1 = gCuccoChickBodyDL.as_mut_ptr() as libc::c_uint;
            let fresh6 = dList2;
            dList2 = dList2.offset(1);
                ...
                (0xda as libc::c_int as u32_0 &
                    ...
                    (((0 as libc::c_int | 0x2 as libc::c_int |
                         ...
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_5).words.w1 = mtx as libc::c_uint;
            let fresh7 = dList2;
            dList2 = dList2.offset(1);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_6).words.w1 = gCuccoChickEyesDL.as_mut_ptr() as libc::c_uint;
            let fresh8 = dList3;
            dList3 = dList3.offset(1);
                ...
                (0xda as libc::c_int as u32_0 &
                    ...
                    (((0 as libc::c_int | 0x2 as libc::c_int |
                         ...
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_7).words.w1 = mtx as libc::c_uint;
            let fresh9 = dList3;
            dList3 = dList3.offset(1);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_8).words.w1 = gCuccoChickBeakDL.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        chick = chick.offset(1)
    }
    chick = (*this).chicks.as_mut_ptr();
    (*__gfxCtx).polyXlu.p = dList3;
    ...
    (*_g_9).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_9).words.w1 = gCuccoChickSetupShadowDL.as_mut_ptr() as libc::c_uint;
    i = 0 as libc::c_int;
    while i < (*this).count as libc::c_int {
        if (*chick).type_0 as libc::c_int != CHICK_NONE as libc::c_int &&
               !(*chick).floorPoly.is_null() {
            func_80038A28((*chick).floorPoly, (*chick).pos.x, (*chick).floorY,
                          (*chick).pos.z, &mut floorMat);
            Matrix_Put(&mut floorMat);
            Matrix_RotateY((*chick).rot.y as libc::c_int as libc::c_float *
            ...
            (*_g_11).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_11).words.w1 =
                gCuccoChickShadowDL.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        chick = chick.offset(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnNwc_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNwc = thisx as *mut EnNwc;
    let mut elementInits: [ColliderJntSphElementInit; 16] =
        [ColliderJntSphElementInit{info:
                                       ColliderInfoInit{elemType: 0,
                                                        toucher:
                                                            ColliderTouch{dmgFlags:
                                                                              0,
                                                                          effect:
                                                        ...
                                                        ocElemFlags: 0,},
                                   dim:
                                       ColliderJntSphElementDimInit{limb: 0,
                                                                    modelSphere:
                                                                        Sphere16{center:
                                                                                     Vec3s{x:
                                                                                               0,
                                                                    ...
                                                                    scale:
                                                                        0,},};
            16];
    let mut element: *mut ColliderJntSphElementInit =
        0 as *mut ColliderJntSphElementInit;
    let mut chick: *mut EnNwcChick = 0 as *mut EnNwcChick;
    let mut i: s32 = 0;
    sJntSphInit.elements = elementInits.as_mut_ptr();
    element = sJntSphInit.elements;
    i = 0 as libc::c_int;
    ...
    Collider_SetJntSphAllocType1(globalCtx, &mut (*this).collider,
                                 &mut (*this).actor, &mut sJntSphInit);
    (*this).count = 16 as libc::c_int as u8_0;
    chick = (*this).chicks.as_mut_ptr();
    i = 0 as libc::c_int;
    while i < (*this).count as libc::c_int {
        (*chick).type_0 = CHICK_NORMAL as libc::c_int as s8;
        (*chick).pos.x =
            (*thisx).world.pos.x + (Rand_ZeroOne() * 100.0f32 - 50.0f32);
        (*chick).pos.y = (*thisx).world.pos.y + 20.0f32;
        (*chick).pos.z =
            (*thisx).world.pos.z + (Rand_ZeroOne() * 100.0f32 - 50.0f32);
        (*chick).height = 5 as libc::c_int as u16_0;
        i += 1;
        chick = chick.offset(1)
    }
    EnNwc_SetUpdate(this,
                    Some(EnNwc_Idle as
                             unsafe extern "C" fn(_: *mut EnNwc,
                                                  _: *mut GlobalContext)
                                 -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNwc = thisx as *mut EnNwc;
    Collider_FreeJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_Idle(mut this: *mut EnNwc,
                                    mut globalCtx: *mut GlobalContext) {
    EnNwc_UpdateChicks(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnNwc_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNwc = thisx as *mut EnNwc;
...
#[no_mangle]
pub unsafe extern "C" fn EnNwc_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnNwc = thisx as *mut EnNwc;
