...
extern "C" {
    ...
    #[no_mangle]
    static mut gDekuNutsSpitAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsDamageAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsBurrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsDieAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsUnburrowAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsLookAroundAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsStandAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsGaspAnim: AnimationHeader;
    #[no_mangle]
    static mut gDekuNutsFlowerDL: [Gfx; 0];
    #[no_mangle]
    static mut gDekuNutsSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDekuNutsRunAnim: AnimationHeader;
}
...
pub struct EnDekunuts {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDekunutsActionFunc,
    pub playWalkSound: u8_0,
    pub runAwayCount: u8_0,
    pub animFlagAndTimer: s16,
    pub runDirection: s16,
    pub shotsPerRound: s16,
    pub jointTable: [Vec3s; 25],
    pub morphTable: [Vec3s; 25],
    pub collider: ColliderCylinder,
}
pub type EnDekunutsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDekunuts, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Dekunuts_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DEKUNUTS as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_DEKUNUTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDekunuts>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekunuts_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekunuts_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekunuts_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDekunuts_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 0x1 as libc::c_int as u8_0,
                                   cylRadius: 0x12 as libc::c_int as s16,
                                   cylHeight: 0x20 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDekunuts = thisx as *mut EnDekunuts;
    let mut pad: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    if (*thisx).params as libc::c_int == 10 as libc::c_int {
        (*thisx).flags &=
            !((1 as libc::c_int) << 0 as libc::c_int |
        ...
        ActorShape_Init(&mut (*thisx).shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      ...
                                                      _: *mut GlobalContext)
                                     -> ()), 35.0f32);
        SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gDekuNutsSkel,
                       &mut gDekuNutsStandAnim,
        ...
        if (*this).shotsPerRound as libc::c_int == 0xff as libc::c_int ||
               (*this).shotsPerRound as libc::c_int == 0 as libc::c_int {
            (*this).shotsPerRound = 1 as libc::c_int as s16
        }
        EnDekunuts_SetupWait(this);
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, thisx, globalCtx,
                           ACTOR_EN_DEKUNUTS as libc::c_int as s16,
                           (*thisx).world.pos.x, (*thisx).world.pos.y,
                           (*thisx).world.pos.z, 0 as libc::c_int as s16,
                           (*thisx).world.rot.y, 0 as libc::c_int as s16,
                           10 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnDekunuts = thisx as *mut EnDekunuts;
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupWait(mut this: *mut EnDekunuts) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime, &mut gDekuNutsUpAnim,
                               0.0f32);
    (*this).animFlagAndTimer =
        Rand_S16Offset(100 as libc::c_int as s16, 50 as libc::c_int as s16);
    (*this).collider.dim.height = 5 as libc::c_int as s16;
    ...
    (*this).actionFunc =
        Some(EnDekunuts_Wait as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupLookAround(mut this:
                                                        *mut EnDekunuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gDekuNutsLookAroundAnim);
    (*this).animFlagAndTimer = 2 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDekunuts_LookAround as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupThrowNut(mut this: *mut EnDekunuts) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gDekuNutsSpitAnim);
    (*this).animFlagAndTimer = (*this).shotsPerRound;
    (*this).actionFunc =
        Some(EnDekunuts_ThrowNut as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupStand(mut this: *mut EnDekunuts) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gDekuNutsStandAnim,
                          -3.0f32);
    if (*this).actionFunc ==
           Some(EnDekunuts_ThrowNut as
                    unsafe extern "C" fn(_: *mut EnDekunuts,
                                         _: *mut GlobalContext) -> ()) {
        (*this).animFlagAndTimer =
            (2 as libc::c_int | 0x1000 as libc::c_int) as s16
        // sets timer and flag
    } else { (*this).animFlagAndTimer = 1 as libc::c_int as s16 }
    (*this).actionFunc =
        Some(EnDekunuts_Stand as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupBurrow(mut this: *mut EnDekunuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gDekuNutsBurrowAnim, -5.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x387d as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnDekunuts_Burrow as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupBeginRun(mut this: *mut EnDekunuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gDekuNutsUnburrowAnim, -3.0f32);
    (*this).collider.dim.height = 37 as libc::c_int as s16;
    (*this).actor.colChkInfo.mass = 0x32 as libc::c_int as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3880 as libc::c_int as u16_0);
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnDekunuts_BeginRun as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupRun(mut this: *mut EnDekunuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gDekuNutsRunAnim);
    (*this).animFlagAndTimer = 2 as libc::c_int as s16;
    (*this).playWalkSound = 0 as libc::c_int as u8_0;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(EnDekunuts_Run as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupGasp(mut this: *mut EnDekunuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gDekuNutsGaspAnim);
    (*this).animFlagAndTimer = 3 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    if (*this).runAwayCount as libc::c_int != 0 as libc::c_int {
        (*this).runAwayCount = (*this).runAwayCount.wrapping_sub(1)
    }
    (*this).actionFunc =
        Some(EnDekunuts_Gasp as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupBeDamaged(mut this:
                                                       *mut EnDekunuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gDekuNutsDamageAnim, -3.0f32);
    if (*(*this).collider.info.acHitInfo).toucher.dmgFlags &
           0x1f824 as libc::c_int as libc::c_uint !=
    ...
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
                         ...
                         Animation_GetLastFrame(&mut gDekuNutsDamageAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void));
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupBeStunned(mut this:
                                                       *mut EnDekunuts) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gDekuNutsDamageAnim,
                          -3.0f32);
    (*this).animFlagAndTimer = 5 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDekunuts_BeStunned as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
    ...
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         ...
                         (Animation_GetLastFrame(&mut gDekuNutsDamageAnim as
                                                     ...
                                                     *mut libc::c_void) as
                              libc::c_int *
                              (*this).animFlagAndTimer as libc::c_int) as
                             s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_SetupDie(mut this: *mut EnDekunuts) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gDekuNutsDieAnim);
    (*this).actionFunc =
        Some(EnDekunuts_Die as
                 unsafe extern "C" fn(_: *mut EnDekunuts,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3881 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Wait(mut this: *mut EnDekunuts,
                                         mut globalCtx: *mut GlobalContext) {
    let mut hasSlowPlaybackSpeed: s32 = 0 as libc::c_int;
    if (*this).skelAnime.playSpeed < 0.5f32 {
        hasSlowPlaybackSpeed = 1 as libc::c_int
    }
    if hasSlowPlaybackSpeed != 0 &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 9.0f32) != 0 {
        (*this).collider.base.acFlags =
            ((*this).collider.base.acFlags as libc::c_int |
                 (1 as libc::c_int) << 0 as libc::c_int) as u8_0
    } else if Animation_OnFrame(&mut (*this).skelAnime, 8.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387c as libc::c_int as u16_0);
    }
    (*this).collider.dim.height =
        (((if (*this).skelAnime.curFrame < 9.0f32 {
               9.0f32
           } else {
               (if (*this).skelAnime.curFrame > 12.0f32 {
                    12.0f32
                } else { (*this).skelAnime.curFrame })
           }) - 9.0f32) * 9.0f32 + 5.0f32) as s16;
    if hasSlowPlaybackSpeed == 0 && (*this).actor.xzDistToPlayer < 120.0f32 {
        EnDekunuts_SetupBurrow(this);
    } else if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.xzDistToPlayer < 120.0f32 {
            EnDekunuts_SetupBurrow(this);
        } else if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int
                      && (*this).actor.xzDistToPlayer > 320.0f32 {
            EnDekunuts_SetupLookAround(this);
        } else { EnDekunuts_SetupStand(this); }
    }
    if hasSlowPlaybackSpeed != 0 &&
           ((*this).actor.xzDistToPlayer > 160.0f32 &&
                fabsf((*this).actor.yDistToPlayer) < 120.0f32) &&
           ((*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int ||
                (*this).actor.xzDistToPlayer < 480.0f32) {
        (*this).skelAnime.playSpeed = 1.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_LookAround(mut this: *mut EnDekunuts,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Stand(mut this: *mut EnDekunuts,
                                          mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).animFlagAndTimer as libc::c_int & 0x1000 as libc::c_int == 0 {
        Math_ApproachS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       2 as libc::c_int as s16, 0xe38 as libc::c_int as s16);
    }
    if (*this).animFlagAndTimer as libc::c_int == 0x1000 as libc::c_int {
        if (*this).actor.xzDistToPlayer > 480.0f32 ||
               (*this).actor.xzDistToPlayer < 120.0f32 {
            EnDekunuts_SetupBurrow(this);
        } else { EnDekunuts_SetupThrowNut(this); }
    } else if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int {
        EnDekunuts_SetupThrowNut(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_ThrowNut(mut this: *mut EnDekunuts,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    } else if Animation_OnFrame(&mut (*this).skelAnime, 6.0f32) != 0 {
        spawnPos.x =
            (*this).actor.world.pos.x +
                Math_SinS((*this).actor.shape.rot.y) * 23.0f32;
        spawnPos.y = (*this).actor.world.pos.y + 12.0f32;
        spawnPos.z =
            (*this).actor.world.pos.z +
                Math_CosS((*this).actor.shape.rot.y) * 23.0f32;
        if !Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_NUTSBALL as libc::c_int as s16, spawnPos.x,
                        spawnPos.y, spawnPos.z, (*this).actor.shape.rot.x,
                        (*this).actor.shape.rot.y, (*this).actor.shape.rot.z,
                        0 as libc::c_int as s16).is_null() {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x387e as libc::c_int as u16_0);
        }
    } else if (*this).animFlagAndTimer as libc::c_int > 1 as libc::c_int &&
                  Animation_OnFrame(&mut (*this).skelAnime, 12.0f32) != 0 {
        Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                  &mut gDekuNutsSpitAnim, -3.0f32);
        if (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
            (*this).animFlagAndTimer -= 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Burrow(mut this: *mut EnDekunuts,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnDekunuts_SetupWait(this);
    ...
    Math_ApproachF(&mut (*this).actor.world.pos.x, (*this).actor.home.pos.x,
                   0.5f32, 3.0f32);
    Math_ApproachF(&mut (*this).actor.world.pos.z, (*this).actor.home.pos.z,
                   0.5f32, 3.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_BeginRun(mut this: *mut EnDekunuts,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).runDirection =
        ...
        (*this).runAwayCount = 3 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Run(mut this: *mut EnDekunuts,
                                        mut globalCtx: *mut GlobalContext) {
    let mut diffRotInit: s16 = 0;
    let mut diffRot: s16 = 0;
    ...
    if (*this).playWalkSound != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387f as libc::c_int as u16_0);
        (*this).playWalkSound = 0 as libc::c_int as u8_0
    } else { (*this).playWalkSound = 1 as libc::c_int as u8_0 }
    Math_StepToF(&mut (*this).actor.speedXZ, 7.5f32, 1.0f32);
    if Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                          (*this).runDirection, 1 as libc::c_int as s16,
                          0xe38 as libc::c_int as s16,
                          0xb6 as libc::c_int as s16) as libc::c_int ==
           0 as libc::c_int {
        ...
        } else if (*this).runAwayCount as libc::c_int == 0 as libc::c_int {
            diffRotInit =
                Actor_WorldYawTowardPoint(&mut (*this).actor,
                                          &mut (*this).actor.home.pos);
            diffRot =
                (diffRotInit as libc::c_int -
                     (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
            if (if diffRot as libc::c_int >= 0 as libc::c_int {
                    diffRot as libc::c_int
                } else { -(diffRot as libc::c_int) }) > 0x2000 as libc::c_int
               {
                (*this).runDirection = diffRotInit
            } else {
                phi_f0 =
                    if diffRot as libc::c_int as libc::c_float >= 0.0f32 {
                        1.0f32
                    } else { -1.0f32 };
                (*this).runDirection =
                    (phi_f0 * -(0x2000 as libc::c_int) as libc::c_float +
    ...
    if (*this).runAwayCount as libc::c_int == 0 as libc::c_int &&
           ...
           fabsf((*this).actor.world.pos.y - (*this).actor.home.pos.y) <
               2.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Gasp(mut this: *mut EnDekunuts,
                                         mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_BeDamaged(mut this: *mut EnDekunuts,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_BeStunned(mut this: *mut EnDekunuts,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 {
        ...
        if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int {
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3882 as libc::c_int as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Die(mut this: *mut EnDekunuts,
                                        mut globalCtx: *mut GlobalContext) {
    static mut effectVelAndAccel: Vec3f =
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        effectPos.y = (*this).actor.world.pos.y + 18.0f32;
        effectPos.z = (*this).actor.world.pos.z;
        EffectSsDeadDb_Spawn(globalCtx, &mut effectPos,
                             &mut effectVelAndAccel, &mut effectVelAndAccel,
                             ...
                             150 as libc::c_int as s16,
                             150 as libc::c_int as s16,
                             1 as libc::c_int as s16, 13 as libc::c_int,
                             1 as libc::c_int as s16);
        effectPos.y = (*this).actor.world.pos.y + 10.0f32;
        EffectSsHahen_SpawnBurst(globalCtx, &mut effectPos, 3.0f32,
                                 0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_ColliderCheck(mut this: *mut EnDekunuts,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        Actor_SetDropFlag(&mut (*this).actor, &mut (*this).collider.info,
                          1 as libc::c_int);
        if (*this).actor.colChkInfo.mass as libc::c_int == 0x32 as libc::c_int
           {
        ...
        } else { EnDekunuts_SetupBeginRun(this); }
    } else if (*this).actor.colChkInfo.mass as libc::c_int ==
                  0xff as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnDekunuts = thisx as *mut EnDekunuts;
    let mut pad: s32 = 0;
    if (*this).actor.params as libc::c_int != 10 as libc::c_int {
        ...
        if (*this).actionFunc ==
               Some(EnDekunuts_Wait as
                        unsafe extern "C" fn(_: *mut EnDekunuts,
                                             _: *mut GlobalContext) -> ()) {
            Actor_SetFocus(&mut (*this).actor, (*this).skelAnime.curFrame);
        } else if (*this).actionFunc ==
                      Some(EnDekunuts_Burrow as
                               unsafe extern "C" fn(_: *mut EnDekunuts,
                                                    _: *mut GlobalContext)
            ...
            Actor_SetFocus(&mut (*this).actor,
                           20.0f32 -
                               (*this).skelAnime.curFrame * 20.0f32 /
                                   Animation_GetLastFrame(&mut gDekuNutsBurrowAnim
                                                              as
                                                              *mut AnimationHeader
                                                              as
                                                              *mut libc::c_void)
                                       as libc::c_int as libc::c_float);
        } else { Actor_SetFocus(&mut (*this).actor, 20.0f32); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 7 as libc::c_int &&
        ...
        if curFrame <= 6.0f32 {
            x = 1.0f32 - curFrame * 0.0833f32;
            z = 1.0f32 + curFrame * 0.1167f32;
            y = 1.0f32 + curFrame * 0.1167f32
        } else if curFrame <= 7.0f32 {
            curFrame -= 6.0f32;
            x = 0.5f32 + curFrame;
            z = 1.7f32 - curFrame * 0.7f32;
            y = 1.7f32 - curFrame * 0.7f32
        } else if curFrame <= 10.0f32 {
            x = 1.5f32 - (curFrame - 7.0f32) * 0.1667f32;
            z = 1.0f32;
            y = 1.0f32
        } else { return 0 as libc::c_int }
        Matrix_Scale(x, y, z, MTXMODE_APPLY as libc::c_int as u8_0);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnDekunuts_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDekunuts = thisx as *mut EnDekunuts;
    if (*this).actor.params as libc::c_int == 10 as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gDekuNutsFlowerDL.as_mut_ptr());
    } else {
        SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                          (*this).skelAnime.jointTable,
                          Some(EnDekunuts_OverrideLimbDraw as
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x4d as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_value(2600 as libc::c_int);
             init
         }]
}
#[used]
