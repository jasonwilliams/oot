...
extern "C" {
    ...
    #[no_mangle]
    static mut gWaterTrialIceBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gWaterTrialIceBlockCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGndIceblock {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgGndIceblockActionFunc,
    pub targetPos: Vec3f,
}
pub type BgGndIceblockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGndIceblock, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const GNDICE_HOLE: C2RustUnnamed_19 = 2;
pub const GNDICE_FALL: C2RustUnnamed_19 = 1;
pub const GNDICE_IDLE: C2RustUnnamed_19 = 0;
#[no_mangle]
pub static mut Bg_Gnd_Iceblock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GND_ICEBLOCK as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgGndIceblock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndIceblock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndIceblock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndIceblock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndIceblock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBlockPositions: [u8_0; 2] = [0; 2];
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndIceblock = thisx as *mut BgGndIceblock;
    ...
    CollisionHeader_GetVirtual(&mut gWaterTrialIceBlockCol as
                                   *mut CollisionHeader as *mut libc::c_void,
                               &mut colHeader);
    (*this).targetPos = (*this).dyna.actor.home.pos;
    (*this).actionFunc =
        Some(BgGndIceblock_Idle as
                 unsafe extern "C" fn(_: *mut BgGndIceblock,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, colHeader);
    if (*this).dyna.actor.world.pos.x == 2792.0f32 {
        (*this).dyna.actor.params = 0 as libc::c_int as s16;
        sBlockPositions[0 as libc::c_int as usize] = 7 as libc::c_int as u8_0
    } else if (*this).dyna.actor.world.pos.x == 3032.0f32 {
        (*this).dyna.actor.params = 1 as libc::c_int as s16;
        sBlockPositions[1 as libc::c_int as usize] = 14 as libc::c_int as u8_0
    } else {
        LogUtils_LogThreadId(b"../z_bg_gnd_iceblock.c\x00" as *const u8 as
                                 *const libc::c_char, 138 as libc::c_int);
        osSyncPrintf(b"thisx->world.position.x = %f\n\x00" as *const u8 as
                         *const libc::c_char,
                     (*this).dyna.actor.world.pos.x as libc::c_double);
        if 0 as libc::c_int != 0 {
        } else {
            __assert(b"0\x00" as *const u8 as *const libc::c_char,
                     b"../z_bg_gnd_iceblock.c\x00" as *const u8 as
                         *const libc::c_char, 139 as libc::c_int);
        };
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndIceblock = thisx as *mut BgGndIceblock;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_SetPosition(mut this:
                                                       *mut BgGndIceblock,
                                                   mut blockPosition: s32) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    let mut xPosIdx: [u8_0; 22] =
    ...
    let mut zPosIdx: [u8_0; 22] =
        [5 as libc::c_int as u8_0, 4 as libc::c_int as u8_0,
         ...
         6 as libc::c_int as u8_0, 1 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 5 as libc::c_int as u8_0,
         3 as libc::c_int as u8_0, 2 as libc::c_int as u8_0,
         5 as libc::c_int as u8_0, 4 as libc::c_int as u8_0,
         3 as libc::c_int as u8_0, 2 as libc::c_int as u8_0,
         1 as libc::c_int as u8_0, 0 as libc::c_int as u8_0];
    sBlockPositions[(*thisx).params as usize] = blockPosition as u8_0;
    (*this).targetPos.x =
        2552.0f32 +
            xPosIdx[blockPosition as usize] as libc::c_int as libc::c_float *
                120.0f32;
    (*this).targetPos.z =
        -540.0f32 -
            zPosIdx[blockPosition as usize] as libc::c_int as libc::c_float *
                120.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_CheckForBlock(mut blockPosition: s32)
 -> s32 {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < 2 as libc::c_int {
        if blockPosition == sBlockPositions[i as usize] as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_NextAction(mut this:
                                                      *mut BgGndIceblock)
 -> s32 {
    match sBlockPositions[(*this).dyna.actor.params as usize] as libc::c_int {
        0 | 1 | 5 | 13 | 16 | 20 | 21 => { return GNDICE_FALL as libc::c_int }
        8 => { return GNDICE_HOLE as libc::c_int }
        _ => { return GNDICE_IDLE as libc::c_int }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_SetNextPosition(mut this:
                                                           *mut BgGndIceblock) {
    if (*this).dyna.unk_158 as libc::c_int == 0 as libc::c_int {
        match sBlockPositions[(*this).dyna.actor.params as usize] as
                  libc::c_int {
            3 | 4 => { BgGndIceblock_SetPosition(this, 5 as libc::c_int); }
            7 => {
                if BgGndIceblock_CheckForBlock(8 as libc::c_int) != 0 {
                    BgGndIceblock_SetPosition(this, 9 as libc::c_int);
                } else { BgGndIceblock_SetPosition(this, 8 as libc::c_int); }
            }
            11 => { BgGndIceblock_SetPosition(this, 12 as libc::c_int); }
            14 => { BgGndIceblock_SetPosition(this, 15 as libc::c_int); }
            18 | 19 => { BgGndIceblock_SetPosition(this, 20 as libc::c_int); }
            _ => { }
        }
    } else if (*this).dyna.unk_158 as libc::c_int == -(0x8000 as libc::c_int)
     {
        match sBlockPositions[(*this).dyna.actor.params as usize] as
                  libc::c_int {
            2 | 3 => { BgGndIceblock_SetPosition(this, 1 as libc::c_int); }
            7 | 9 => { BgGndIceblock_SetPosition(this, 6 as libc::c_int); }
            11 => { BgGndIceblock_SetPosition(this, 10 as libc::c_int); }
            14 | 15 => { BgGndIceblock_SetPosition(this, 13 as libc::c_int); }
            17 => { BgGndIceblock_SetPosition(this, 16 as libc::c_int); }
            18 => {
                if BgGndIceblock_CheckForBlock(17 as libc::c_int) == 0 {
                    BgGndIceblock_SetPosition(this, 16 as libc::c_int);
                }
            }
            _ => { }
        }
    } else if (*this).dyna.unk_158 as libc::c_int == 0x4000 as libc::c_int {
        match sBlockPositions[(*this).dyna.actor.params as usize] as
                  libc::c_int {
            6 => { BgGndIceblock_SetPosition(this, 13 as libc::c_int); }
            7 => { BgGndIceblock_SetPosition(this, 17 as libc::c_int); }
            9 => { BgGndIceblock_SetPosition(this, 11 as libc::c_int); }
            12 => { BgGndIceblock_SetPosition(this, 21 as libc::c_int); }
            14 => { BgGndIceblock_SetPosition(this, 18 as libc::c_int); }
            15 => { BgGndIceblock_SetPosition(this, 19 as libc::c_int); }
            _ => { }
        }
    } else if (*this).dyna.unk_158 as libc::c_int == -(0x4000 as libc::c_int)
     {
        match sBlockPositions[(*this).dyna.actor.params as usize] as
                  libc::c_int {
            6 => { BgGndIceblock_SetPosition(this, 0 as libc::c_int); }
            7 => { BgGndIceblock_SetPosition(this, 1 as libc::c_int); }
            9 | 11 => { BgGndIceblock_SetPosition(this, 4 as libc::c_int); }
            14 => { BgGndIceblock_SetPosition(this, 2 as libc::c_int); }
            15 => {
                if BgGndIceblock_CheckForBlock(8 as libc::c_int) != 0 {
                    BgGndIceblock_SetPosition(this, 3 as libc::c_int);
                } else { BgGndIceblock_SetPosition(this, 8 as libc::c_int); }
            }
            _ => { }
        }
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Idle(mut this: *mut BgGndIceblock,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    if (*this).dyna.unk_150 != 0.0f32 {
        ...
        if (*this).dyna.unk_150 > 0.0f32 {
            ...
            if Actor_WorldDistXZToPoint(&mut (*this).dyna.actor,
                ...
                func_8002DF54(globalCtx, &mut (*this).dyna.actor,
                              8 as libc::c_int as u8_0);
                (*this).actionFunc =
                    Some(BgGndIceblock_Slide as
                             unsafe extern "C" fn(_: *mut BgGndIceblock,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Reset(mut this: *mut BgGndIceblock,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Math_StepToF(&mut (*thisx).world.pos.y, (*thisx).home.pos.y, 1.0f32) !=
           0 {
        ...
        match (*thisx).params as libc::c_int {
            0 => {
                sBlockPositions[0 as libc::c_int as usize] =
                    7 as libc::c_int as u8_0
            }
            1 => {
                sBlockPositions[1 as libc::c_int as usize] =
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Fall(mut this: *mut BgGndIceblock,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    (*thisx).velocity.y += 1.0f32;
    if Math_StepToF(&mut (*thisx).world.pos.y, (*thisx).home.pos.y - 300.0f32,
                    (*thisx).velocity.y) != 0 {
        (*thisx).velocity.y = 0.0f32;
        (*thisx).world.pos.x = (*thisx).home.pos.x;
        (*thisx).world.pos.y = (*thisx).home.pos.y - 100.0f32;
        (*thisx).world.pos.z = (*thisx).home.pos.z;
        if Player_InCsMode(globalCtx) != 0 {
            func_8002DF54(globalCtx, thisx, 7 as libc::c_int as u8_0);
        }
        (*this).actionFunc =
            Some(BgGndIceblock_Reset as
                     unsafe extern "C" fn(_: *mut BgGndIceblock,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Hole(mut this: *mut BgGndIceblock,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    (*thisx).velocity.y += 1.0f32;
    if Math_StepToF(&mut (*thisx).world.pos.y, (*thisx).home.pos.y - 100.0f32,
                    (*thisx).velocity.y) != 0 {
        (*thisx).velocity.y = 0.0f32;
        if Player_InCsMode(globalCtx) != 0 {
            func_8002DF54(globalCtx, thisx, 7 as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Slide(mut this: *mut BgGndIceblock,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut atTarget: s32 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spread: f32_0 = 0.;
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    Math_StepToF(&mut (*thisx).speedXZ, 10.0f32, 0.5f32);
    atTarget =
        Math_StepToF(&mut (*thisx).world.pos.x, (*this).targetPos.x,
                     (*thisx).speedXZ);
    atTarget &=
        Math_StepToF(&mut (*thisx).world.pos.z, (*this).targetPos.z,
                     (*thisx).speedXZ);
    if atTarget != 0 {
        (*thisx).speedXZ = 0.0f32;
        ...
        match BgGndIceblock_NextAction(this) {
            0 => {
                (*this).actionFunc =
                    Some(BgGndIceblock_Idle as
                             unsafe extern "C" fn(_: *mut BgGndIceblock,
    ...
    } else if (*thisx).speedXZ > 6.0f32 {
        spread = Rand_CenteredFloat(120.0f32);
        velocity.x =
            -(1.5f32 + Rand_ZeroOne()) * Math_SinS((*this).dyna.unk_158);
        velocity.y = Rand_ZeroOne() + 1.0f32;
        velocity.z =
            -(1.5f32 + Rand_ZeroOne()) * Math_CosS((*this).dyna.unk_158);
        pos.x =
            (*thisx).world.pos.x - 60.0f32 * Math_SinS((*this).dyna.unk_158) -
                Math_CosS((*this).dyna.unk_158) * spread;
        pos.z =
            (*thisx).world.pos.z - 60.0f32 * Math_CosS((*this).dyna.unk_158) +
                Math_SinS((*this).dyna.unk_158) * spread;
        pos.y = (*thisx).world.pos.y;
        func_8002829C(globalCtx, &mut pos, &mut velocity, &mut sZeroVec,
                      &mut sWhite, &mut sGray, 250 as libc::c_int as s16,
        ...
        func_8002829C(globalCtx, &mut pos, &mut velocity, &mut sZeroVec,
                      ...
                      Rand_S16Offset(40 as libc::c_int as s16,
                                     15 as libc::c_int as s16));
        func_8002F974(thisx,
                      (0x8df as libc::c_int - 0x800 as libc::c_int) as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndIceblock = thisx as *mut BgGndIceblock;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndIceblock_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndIceblock = thisx as *mut BgGndIceblock;
    Gfx_DrawDListOpa(globalCtx, gWaterTrialIceBlockDL.as_mut_ptr());
}
