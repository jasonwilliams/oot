...
extern "C" {
    #[no_mangle]
    fn Environment_InitGameOverLights(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn Environment_FadeInGameOverLights(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn Environment_FadeOutGameOverLights(globalCtx: *mut GlobalContext);
    #[no_mangle]
...
pub const GAMEOVER_REVIVE_FADE_OUT: C2RustUnnamed_16 = 24;
pub const GAMEOVER_REVIVE_WAIT_FAIRY: C2RustUnnamed_16 = 23;
pub const GAMEOVER_REVIVE_WAIT_GROUND: C2RustUnnamed_16 = 22;
pub const GAMEOVER_REVIVE_RUMBLE: C2RustUnnamed_16 = 21;
pub const GAMEOVER_REVIVE_START: C2RustUnnamed_16 = 20;
pub const GAMEOVER_DEATH_MENU: C2RustUnnamed_16 = 4;
pub const GAMEOVER_DEATH_DELAY_MENU: C2RustUnnamed_16 = 3;
pub const GAMEOVER_DEATH_WAIT_GROUND: C2RustUnnamed_16 = 2;
pub const GAMEOVER_DEATH_START: C2RustUnnamed_16 = 1;
pub const GAMEOVER_INACTIVE: C2RustUnnamed_16 = 0;
#[no_mangle]
pub unsafe extern "C" fn GameOver_Init(mut globalCtx: *mut GlobalContext) {
    (*globalCtx).gameOverCtx.state =
        GAMEOVER_INACTIVE as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn GameOver_FadeInLights(mut globalCtx:
                                                   *mut GlobalContext) {
    let mut gameOverCtx: *mut GameOverContext = &mut (*globalCtx).gameOverCtx;
    if (*gameOverCtx).state as libc::c_int >=
           GAMEOVER_DEATH_WAIT_GROUND as libc::c_int &&
           ((*gameOverCtx).state as libc::c_int) <
               GAMEOVER_REVIVE_START as libc::c_int ||
           (*gameOverCtx).state as libc::c_int >=
               GAMEOVER_REVIVE_RUMBLE as libc::c_int &&
               ((*gameOverCtx).state as libc::c_int) <
                   GAMEOVER_REVIVE_FADE_OUT as libc::c_int {
        Environment_FadeInGameOverLights(globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn GameOver_Update(mut globalCtx: *mut GlobalContext) {
    let mut gameOverCtx: *mut GameOverContext = &mut (*globalCtx).gameOverCtx;
    let mut i: s16 = 0;
    let mut j: s16 = 0;
    let mut v90: s32 = 0;
    let mut v91: s32 = 0;
    let mut v92: s32 = 0;
    match (*gameOverCtx).state as libc::c_int {
        1 => {
            ...
            gSaveContext.eventInf[1 as libc::c_int as usize] =
                (gSaveContext.eventInf[1 as libc::c_int as usize] as
            ...
            while (i as libc::c_int) <
                ...
                if gSaveContext.inventory.items[gItemSlots[ITEM_POCKET_EGG as
                    ...
                    gSaveContext.inventory.items[gItemSlots[gSpoilingItemReverts[i
                                                                                     as
                                                                                     usize]
                                                                as usize] as
                                                     usize] =
                    ...
                    while (j as libc::c_int) <
                              (::std::mem::size_of::<[u8_0; 4]>() as
                                   libc::c_ulong).wrapping_div(::std::mem::size_of::<u8_0>()
                                                                   ...
                                                                   libc::c_ulong)
                                  as s32 {
                        if gSaveContext.equips.buttonItems[j as usize] as
                               libc::c_int ==
                               gSpoilingItems[i as usize] as libc::c_int {
            ...
            gSaveContext.nayrusLoveTimer = 2000 as libc::c_int as s16;
            ...
            gGameOverTimer = 20 as libc::c_int as s16;
            v90 =
            ...
            v92 =
                (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                      ...
                                      as usize] as s32;
            func_800AA000(0.0f32,
                          if v90 > 0x64 as libc::c_int {
                              0xff as libc::c_int
                          } else {
                              (v90 * 0xff as libc::c_int) /
                                  0x64 as libc::c_int
                          } as u8_0,
                          if v91 * 3 as libc::c_int > 0xff as libc::c_int {
                              0xff as libc::c_int
                          } else { (v91) * 3 as libc::c_int } as u8_0,
                          if v92 > 0x64 as libc::c_int {
                              0xff as libc::c_int
                          } else {
                              (v92 * 0xff as libc::c_int) /
                                  0x64 as libc::c_int
                          } as u8_0);
            (*gameOverCtx).state =
                GAMEOVER_DEATH_WAIT_GROUND as libc::c_int as u16_0
        }
        3 => {
            gGameOverTimer -= 1;
            if gGameOverTimer as libc::c_int == 0 as libc::c_int {
                (*globalCtx).pauseCtx.state = 8 as libc::c_int as u16_0;
        ...
        20 => {
            (*gameOverCtx).state = (*gameOverCtx).state.wrapping_add(1);
            gGameOverTimer = 0 as libc::c_int as s16;
            Environment_InitGameOverLights(globalCtx);
            ShrinkWindow_SetVal(0x20 as libc::c_int);
            return
        }
        21 => {
            gGameOverTimer = 50 as libc::c_int as s16;
            (*gameOverCtx).state = (*gameOverCtx).state.wrapping_add(1);
            v90 =
                (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 90 as libc::c_int)
        ...
        22 => {
            gGameOverTimer -= 1;
            if gGameOverTimer as libc::c_int == 0 as libc::c_int {
                gGameOverTimer = 64 as libc::c_int as s16;
                (*gameOverCtx).state = (*gameOverCtx).state.wrapping_add(1)
            }
        }
        23 => {
