...
extern "C" {
    ...
    #[no_mangle]
    static mut gVolvagiaRockDL: [Gfx; 0];
    #[no_mangle]
...
pub const BFD_FX_SKULL_PIECE: C2RustUnnamed_21 = 5;
pub const BFD_FX_FIRE_BREATH: C2RustUnnamed_21 = 4;
pub const BFD_FX_DUST: C2RustUnnamed_21 = 3;
pub const BFD_FX_DEBRIS: C2RustUnnamed_21 = 2;
pub const BFD_FX_EMBER: C2RustUnnamed_21 = 1;
pub const BFD_FX_NONE: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut En_Vb_Ball_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnVbBall_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnVbBall_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVbBall = thisx as *mut EnVbBall;
    let mut pad2: s32 = 0;
    let mut angle: f32_0 = 0.;
    if (*this).actor.params as libc::c_int >= 200 as libc::c_int {
        // Volvagia's bones
        (*this).yRotVel = Rand_CenteredFloat(0x300 as libc::c_int as f32_0);
        (*this).xRotVel = Rand_CenteredFloat(0x300 as libc::c_int as f32_0);
        angle =
            Math_FAtan2F((*this).actor.world.pos.x,
                         (*this).actor.world.pos.z);
        (*this).actor.velocity.y = Rand_ZeroFloat(3.0f32);
        (*this).actor.velocity.x = 2.0f32 * sinf(angle);
        (*this).actor.velocity.z = 2.0f32 * cosf(angle);
        ...
        Actor_SetScale(&mut (*this).actor,
                       (*this).actor.world.rot.z as libc::c_int as
                           libc::c_float / 10000.0f32);
        (*this).collider.dim.radius =
            ((*this).actor.scale.y * 3000.0f32) as s16;
        (*this).collider.dim.height =
            ((*this).actor.scale.y * 5000.0f32) as s16;
        (*this).collider.dim.yShift =
            ((*this).actor.scale.y * -2500.0f32) as s16;
        (*this).xRotVel = Rand_CenteredFloat(0x2000 as libc::c_int as f32_0);
        (*this).yRotVel = Rand_CenteredFloat(0x2000 as libc::c_int as f32_0);
        (*this).shadowSize = (*this).actor.scale.y * 68.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVbBall = thisx as *mut EnVbBall;
    if ((*this).actor.params as libc::c_int) < 200 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_SpawnDebris(mut globalCtx:
                                                  *mut GlobalContext,
...
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_SpawnDust(mut globalCtx: *mut GlobalContext,
                                            mut effect: *mut BossFdEffect,
                                            mut position: *mut Vec3f,
                                            mut velocity: *mut Vec3f,
                                            mut acceleration: *mut Vec3f,
...
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_UpdateBones(mut this: *mut EnVbBall,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 &&
        ...
        (*this).xRotVel = Rand_CenteredFloat(0x4000 as libc::c_int as f32_0);
        (*this).yRotVel = Rand_CenteredFloat(0x4000 as libc::c_int as f32_0);
        angle =
            Math_FAtan2F((*this).actor.world.pos.x,
                         (*this).actor.world.pos.z);
        (*this).actor.velocity.x = sinf(angle) * 10.0f32;
        (*this).actor.velocity.z = cosf(angle) * 10.0f32;
        (*this).actor.velocity.y *= -0.5f32;
        if (*this).actor.params as libc::c_int & 1 as libc::c_int != 0 {
            Audio_PlaySoundGeneral(0x3927 as libc::c_int as u16_0,
        ...
        while (i as libc::c_int) < 10 as libc::c_int {
            ...
            dustVel.x = Rand_CenteredFloat(8.0f32);
            dustVel.y = Rand_ZeroFloat(1.0f32);
            dustVel.z = Rand_CenteredFloat(8.0f32);
            dustAcc.y = 0.3f32;
            dustPos.x =
                Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
            dustPos.y = (*this).actor.floorHeight + 10.0f32;
            dustPos.z =
                Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
            EnVbBall_SpawnDust(globalCtx, (*bossFd).effects.as_mut_ptr(),
                               &mut dustPos, &mut dustVel, &mut dustAcc,
                               Rand_ZeroFloat(80.0f32) + 200.0f32);
            i += 1
        }
    }
    if (*this).actor.world.pos.y < 50.0f32 {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_Update(mut thisx: *mut Actor,
    ...
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int +
             (*this).xRotVel as s16 as libc::c_int) as s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).yRotVel as s16 as libc::c_int) as s16;
    ...
    if (*this).actor.params as libc::c_int >= 200 as libc::c_int {
        ...
        Math_ApproachF(&mut (*this).shadowOpacity, 175.0f32, 1.0f32, 40.0f32);
        radius = (*this).actor.scale.y * 1700.0f32;
        (*this).actor.world.pos.y -= radius;
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 50.0f32,
                                50.0f32, 100.0f32, 4 as libc::c_int);
        (*this).actor.world.pos.y += radius;
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0
               && (*this).actor.velocity.y <= 0.0f32 {
            if (*this).actor.params as libc::c_int == 100 as libc::c_int ||
                   (*this).actor.params as libc::c_int == 101 as libc::c_int {
                Actor_Kill(&mut (*this).actor);
                if (*this).actor.params as libc::c_int == 100 as libc::c_int {
                ...
                if (*this).actor.params as libc::c_int == 100 as libc::c_int {
                    spawnNum = 2 as libc::c_int as s16
                } else { spawnNum = 2 as libc::c_int as s16 }
                i = 0 as libc::c_int as s16;
                while (i as libc::c_int) < spawnNum as libc::c_int {
                    let mut spawnOffset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
                    let mut newActor: *mut EnVbBall = 0 as *mut EnVbBall;
                    let mut xRotVel: f32_0 = 0.;
                    if (*this).actor.params as libc::c_int ==
                           100 as libc::c_int {
                        spawnOffset.x = Rand_CenteredFloat(13.0f32);
                        spawnOffset.y = Rand_ZeroFloat(5.0f32) + 6.0f32;
                        spawnOffset.z =
                            Rand_CenteredFloat(13 as libc::c_int as f32_0)
                    } else {
                        spawnOffset.x = Rand_CenteredFloat(10.0f32);
                        spawnOffset.y = Rand_ZeroFloat(3.0f32) + 4.0f32;
                        spawnOffset.z = Rand_CenteredFloat(10.0f32)
                    }
                    newActor =
                    ...
                    if !newActor.is_null() {
                        if i as libc::c_int == 0 as libc::c_int &&
                               (*this).actor.params as libc::c_int ==
                                   100 as libc::c_int {
                            Audio_PlaySoundGeneral(0x38d7 as libc::c_int as
                                                       u16_0,
                                                   &mut (*newActor).actor.projectedPos,
                        ...
                        (*newActor).yRotVel = 0.0f32;
                        xRotVel =
                            sqrtf(spawnOffset.x * spawnOffset.x +
                                      spawnOffset.z * spawnOffset.z);
                        (*newActor).xRotVel =
                            0x1000 as libc::c_int as libc::c_float / 10.0f32 *
                                xRotVel;
                        (*newActor).actor.shape.rot.y =
                            (Math_FAtan2F(spawnOffset.x, spawnOffset.z) *
                                 (0x8000 as libc::c_int as f32_0 /
                                      3.14159265358979323846f32)) as s16;
                        (*newActor).shadowOpacity = 200.0f32
                    }
                    i += 1
                }
                i = 0 as libc::c_int as s16;
                while (i as libc::c_int) < 15 as libc::c_int {
                    let mut debrisVel1: Vec3f =
                        {
                            let mut init =
                                Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,};
                            init
                        };
                    let mut debrisAcc1: Vec3f =
                        {
                            let mut init =
                                Vec3f{x: 0.0f32, y: -1.0f32, z: 0.0f32,};
                            init
                        };
                    let mut debrisPos1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
                    debrisVel1.x = Rand_CenteredFloat(25.0f32);
                    debrisVel1.y =
                        Rand_ZeroFloat(5.0f32) +
                            8 as libc::c_int as libc::c_float;
                    debrisVel1.z = Rand_CenteredFloat(25.0f32);
                    debrisPos1.x =
                    ...
                    debrisPos1.z =
                        Rand_CenteredFloat(10.0f32) +
                            (*this).actor.world.pos.z;
                    EnVbBall_SpawnDebris(globalCtx,
                                         (*bossFd).effects.as_mut_ptr(),
                                         &mut debrisPos1, &mut debrisVel1,
                                         &mut debrisAcc1,
                                         (Rand_ZeroFloat(12.0f32) as s16 as
                ...
                while (i as libc::c_int) < 10 as libc::c_int {
                    ...
                    dustVel.y = Rand_ZeroFloat(1.0f32);
                    dustVel.z = Rand_CenteredFloat(8.0f32);
                    dustAcc.y = 1.0f32 / 2 as libc::c_int as libc::c_float;
                    dustPos.x =
                    ...
                    dustPos.z =
                        Rand_CenteredFloat(30.0f32) +
                            (*this).actor.world.pos.z;
                    EnVbBall_SpawnDust(globalCtx,
                                       (*bossFd).effects.as_mut_ptr(),
                                       &mut dustPos, &mut dustVel,
                                       &mut dustAcc,
                                       Rand_ZeroFloat(100.0f32) + 350.0f32);
                    i += 1
                }
            } else {
                i = 0 as libc::c_int as s16;
                while (i as libc::c_int) < 5 as libc::c_int {
                    let mut debrisVel2: Vec3f =
                        {
                            let mut init =
                                Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,};
                            init
                        };
                    let mut debrisAcc2: Vec3f =
                        {
                            let mut init =
                                Vec3f{x: 0.0f32, y: -1.0f32, z: 0.0f32,};
                            init
                        };
                    let mut debrisPos2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
                    debrisVel2.x = Rand_CenteredFloat(10.0f32);
                    debrisVel2.y = Rand_ZeroFloat(3.0f32) + 3.0f32;
                    debrisVel2.z = Rand_CenteredFloat(10.0f32);
                    debrisPos2.x =
...
#[no_mangle]
pub unsafe extern "C" fn EnVbBall_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnVbBall = thisx as *mut EnVbBall;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_vb_ball.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((gVolvagiaRibsDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gVolvagiaRibsDL.as_mut_ptr() as
                                                  u32_0 &
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((gVolvagiaRockDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gVolvagiaRockDL.as_mut_ptr() as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).shadowOpacity as s8 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        Matrix_Translate((*this).actor.world.pos.x, 100.0f32,
                         (*this).actor.world.pos.z,
                         MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_Scale((*this).shadowSize, 1.0f32, (*this).shadowSize,
