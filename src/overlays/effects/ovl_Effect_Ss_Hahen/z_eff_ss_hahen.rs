...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffFragments1DL: [Gfx; 0];
    #[no_mangle]
...
#[no_mangle]
pub static mut Effect_Ss_Hahen_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_HAHEN as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsHahen_Init as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsHahen_CheckForObject(mut this: *mut EffectSs,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    (*this).regs[5 as libc::c_int as usize] =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        (*this).regs[4 as libc::c_int as usize]) as s16;
    if ((*this).regs[5 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int ||
           Object_IsLoaded(&mut (*globalCtx).objectCtx,
                           (*this).regs[5 as libc::c_int as usize] as s32) ==
               0 {
        (*this).life = -(1 as libc::c_int) as s16;
        (*this).draw = None
    };
}
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsHahen_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsHahenInitParams =
        initParamsx as *mut EffectSsHahenInitParams;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).life = 200 as libc::c_int as s16;
    if !(*initParams).dList.is_null() {
        (*this).gfx = (*initParams).dList as *mut libc::c_void;
        (*this).regs[4 as libc::c_int as usize] = (*initParams).objId;
        EffectSsHahen_CheckForObject(this, globalCtx);
    } else {
        (*this).gfx =
            gSegments[((gEffFragments1DL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gEffFragments1DL.as_mut_ptr() as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     ...
                                                                                     libc::c_uint)
                as *mut libc::c_void;
        (*this).regs[4 as libc::c_int as usize] = -(1 as libc::c_int) as s16
    }
    if (*this).regs[4 as libc::c_int as usize] as libc::c_int ==
           OBJECT_HAKA_OBJECTS as libc::c_int &&
           (*this).gfx == gEffFragments2DL.as_mut_ptr() as *mut libc::c_void {
        (*this).draw =
            Some(EffectSsHahen_DrawGray as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ())
    } else {
        (*this).draw =
            Some(EffectSsHahen_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ())
    }
    (*this).update =
        Some(EffectSsHahen_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[2 as libc::c_int as usize] = (*initParams).unused;
    (*this).regs[3 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[0 as libc::c_int as usize] =
        (Rand_ZeroOne() * 314.0f32) as s16;
    (*this).regs[1 as libc::c_int as usize] =
        (Rand_ZeroOne() * 314.0f32) as s16;
    (*this).regs[6 as libc::c_int as usize] =
        (200 as libc::c_int - (*initParams).life as libc::c_int) as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsHahen_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut pad: s32 = 0;
    let mut scale: f32_0 =
        (*this).regs[3 as libc::c_int as usize] as libc::c_int as
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_hahen.c\x00" as *const u8 as
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            (*globalCtx).objectCtx.status[(*this).regs[5 as libc::c_int as
                                                           usize] as
    ...
    Matrix_RotateX((*this).regs[0 as libc::c_int as usize] as libc::c_int as
                       libc::c_float * 0.01f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = (*this).gfx as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsHahen_DrawGray(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsHahen_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
