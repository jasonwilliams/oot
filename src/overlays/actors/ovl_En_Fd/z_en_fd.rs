...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002DE04(globalCtx: *mut GlobalContext, actorA: *mut Actor,
                     actorB: *mut Actor);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gFlareDancerCastingFireAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gFlareDancerBackflipAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerGettingUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerChasingAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerTwirlAnim: AnimationHeader;
    #[no_mangle]
    static mut gFlareDancerDL_7928: [Gfx; 0];
    #[no_mangle]
    static mut gFlareDancerSquareParticleDL: [Gfx; 0];
    #[no_mangle]
    static mut gFlareDancerDL_79F8: [Gfx; 0];
    #[no_mangle]
    static mut gFlareDancerTriangleParticleDL: [Gfx; 0];
}
...
pub struct EnFd {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnFdActionFunc,
    pub collider: ColliderJntSph,
    pub colSphs: [ColliderJntSphElement; 12],
    pub coreActive: u8_0,
    pub initYawToInitPos: s16,
    pub curYawToInitPos: s16,
    pub runDir: s16,
    pub firstUpdateFlag: s16,
    pub spinTimer: s16,
    pub circlesToComplete: s16,
    pub invincibilityTimer: s16,
    pub attackTimer: s16,
    pub runRadius: f32_0,
    pub fadeAlpha: f32_0,
    pub corePos: Vec3f,
    pub jointTable: [Vec3s; 27],
    pub morphTable: [Vec3s; 27],
    pub effects: [EnFdEffect; 200],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFdEffect {
    pub type_0: u8_0,
    pub timer: u8_0,
...
pub type EnFdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const FD_EFFECT_DOT: C2RustUnnamed_22 = 2;
pub const FD_EFFECT_FLAME: C2RustUnnamed_22 = 1;
pub const FD_EFFECT_NONE: C2RustUnnamed_22 = 0;
#[no_mangle]
pub static mut En_Fd_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FD as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_FW as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnFd>() as libc::c_ulong,
                          init:
...
static mut sColChkInit: CollisionCheckInfoInit2 =
    {
        let mut init =
            CollisionCheckInfoInit2{health: 24 as libc::c_int as u8_0,
...
static mut sAnimations: [struct_80034EC0_Entry; 5] =
    unsafe {
        [{
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gFlareDancerCastingFireAnim as
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_SpawnCore(mut this: *mut EnFd,
 ...
 -> s32 {
    ...
    if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                          globalCtx, ACTOR_EN_FW as libc::c_int as s16,
                          (*this).corePos.x, (*this).corePos.y,
                          (*this).corePos.z, 0 as libc::c_int as s16,
                          (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                          (*this).runDir).is_null() {
        return 0 as libc::c_int
    }
    (*(*this).actor.child).colChkInfo.health =
        ((*this).actor.colChkInfo.health as libc::c_int % 8 as libc::c_int) as
            u8_0;
    if (*(*this).actor.child).colChkInfo.health as libc::c_int ==
           0 as libc::c_int {
        (*(*this).actor.child).colChkInfo.health = 8 as libc::c_int as u8_0
    }
    if (*this).actor.flags &
           ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint ==
           ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint {
        func_8002DE04(globalCtx, &mut (*this).actor, (*this).actor.child);
    }
    (*this).coreActive = 1 as libc::c_int as u8_0;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFd_SpawnChildFire(mut this: *mut EnFd,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut fireCnt: s16,
                                             mut color: s16) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < fireCnt as libc::c_int {
        let mut angle: s16 =
            ((i as libc::c_float * 360.0f32 /
                  fireCnt as libc::c_int as libc::c_float *
        ...
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_FD_FIRE as libc::c_int as s16,
                           (*this).actor.world.pos.x,
                           (*this).actor.world.pos.y,
                           (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                           angle, 0 as libc::c_int as s16,
                           ((color as libc::c_int) << 0xf as libc::c_int | i)
                               as s16);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFd_SpawnDot(mut this: *mut EnFd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f =
    ...
    if (*this).actionFunc ==
           Some(EnFd_Run as
                    unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                        -> ()) ||
           (*this).actionFunc ==
               Some(EnFd_SpinAndSpawnFire as
                        unsafe extern "C" fn(_: *mut EnFd,
                                             _: *mut GlobalContext) -> ()) {
        pos.x = (*this).actor.world.pos.x;
        pos.y = (*this).actor.floorHeight + 4.0f32;
        pos.z = (*this).actor.world.pos.z;
        accel.x = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        accel.y = (Rand_ZeroOne() - 0.5f32) * 0.2f32 + 0.3f32;
        accel.z = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
        EnFd_AddEffect(this, FD_EFFECT_FLAME as libc::c_int as u8_0, &mut pos,
                       &mut velocity, &mut accel, 8 as libc::c_int as u8_0,
                       0.6f32, 0.2f32);
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFd_CheckHammer(mut this: *mut EnFd,
                                          mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actionFunc ==
           Some(EnFd_Reappear as
                    unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                        -> ()) ||
           (*this).actionFunc ==
               Some(EnFd_SpinAndGrow as
                        unsafe extern "C" fn(_: *mut EnFd,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(EnFd_JumpToGround as
                        unsafe extern "C" fn(_: *mut EnFd,
                                             _: *mut GlobalContext) -> ()) ||
           (*this).actionFunc ==
               Some(EnFd_WaitForCore as
                        unsafe extern "C" fn(_: *mut EnFd,
                                             _: *mut GlobalContext) -> ()) {
        return 0 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_ColliderCheck(mut this: *mut EnFd,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    if (*this).collider.base.acFlags as libc::c_int &
           ...
           EnFd_CheckHammer(this, globalCtx) != 0 {
        ...
        if EnFd_SpawnCore(this, globalCtx) == 0 { return 0 as libc::c_int }
        (*this).invincibilityTimer = 30 as libc::c_int as s16;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x397a as libc::c_int as u16_0);
        Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
        return 1 as libc::c_int
    } else {
        if (if (*this).attackTimer as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else {
                (*this).attackTimer -= 1;
            ...
            (*this).attackTimer = 30 as libc::c_int as s16;
...
pub unsafe extern "C" fn EnFd_CanSeeActor(mut this: *mut EnFd,
 ...
 -> s32 {
    ...
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                               ...
                               &mut (*actor).world.pos, &mut colPoint,
                               &mut colPoly, 1 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_FindBomb(mut this: *mut EnFd,
                                       mut globalCtx: *mut GlobalContext)
 -> *mut Actor {
    ...
    while !actor.is_null() {
        if (*actor).params as libc::c_int != 0 as libc::c_int ||
            ...
            actor = (*actor).next
        } else if (*actor).id as libc::c_int != ACTOR_EN_BOM as libc::c_int {
            actor = (*actor).next
        } else if EnFd_CanSeeActor(this, actor, globalCtx) != 1 as libc::c_int
         {
            actor = (*actor).next
        } else { return actor }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_FindPotentialTheat(mut this: *mut EnFd,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> *mut Actor {
    let mut player: *mut Player = 0 as *mut Player;
    let mut bomb: *mut Actor = EnFd_FindBomb(this, globalCtx);
    if !bomb.is_null() { return bomb }
    ...
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if EnFd_CanSeeActor(this, &mut (*player).actor, globalCtx) == 0 {
        return 0 as *mut Actor
    }
    return &mut (*player).actor;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFd_GetPosAdjAroundCircle(mut dst: *mut Vec3f,
                                                    mut this: *mut EnFd,
                                                    mut radius: f32_0,
                                                    mut dir: s16)
 -> *mut Vec3f {
    let mut angle: s16 = 0; // ~30 degrees
    let mut newPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    angle =
        (Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                        &mut (*this).actor.world.pos) as libc::c_int +
             dir as libc::c_int * 0x1554 as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_ShouldStopRunning(mut this: *mut EnFd,
                                                mut globalCtx:
                                                    *mut GlobalContext,
                                                mut radius: f32_0,
                                                mut runDir: *mut s16) -> s32 {
    ...
    EnFd_GetPosAdjAroundCircle(&mut pos, this, radius, *runDir);
    pos.x += (*this).actor.world.pos.x;
    pos.y = (*this).actor.world.pos.y;
    pos.z += (*this).actor.world.pos.z;
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx,
                               &mut (*this).actor.world.pos, &mut pos,
                               &mut colPoint, &mut poly, 1 as libc::c_int,
                               0 as libc::c_int, 0 as libc::c_int,
                               1 as libc::c_int, &mut bgId) != 0 {
        *runDir = -(*runDir as libc::c_int) as s16;
        return 1 as libc::c_int
    }
    if (*this).circlesToComplete as libc::c_int != 0 as libc::c_int ||
           (if (*this).spinTimer as libc::c_int == 0 as libc::c_int {
                0 as libc::c_int
            } else {
                (*this).spinTimer -= 1;
                (*this).spinTimer as libc::c_int
            }) != 0 as libc::c_int {
        return 0 as libc::c_int
    }
    if Rand_ZeroOne() > 0.5f32 { *runDir = -(*runDir as libc::c_int) as s16 }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFd_Fade(mut this: *mut EnFd,
                                   mut globalCtx: *mut GlobalContext) {
    if (*this).invincibilityTimer as libc::c_int != 0 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).fadeAlpha, 0.0f32, 0.3f32, 10.0f32,
                           0.0f32);
        (*this).actor.shape.shadowAlpha = (*this).fadeAlpha as u8_0;
        if !((*this).fadeAlpha >= 0.9f32) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gFlareDancerSkel, 0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 27 as libc::c_int);
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sJntSphInit, (*this).colSphs.as_mut_ptr());
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            DamageTable_Get(0xf as libc::c_int),
                            &mut sColChkInit);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.flags |=
    ...
    (*this).firstUpdateFlag = 1 as libc::c_int as s16;
    (*this).actor.gravity = -1.0f32;
    (*this).runDir =
        if Rand_ZeroOne() < 0.5f32 {
            -(1 as libc::c_int)
        } else { 1 as libc::c_int } as s16;
    (*this).actor.naviEnemyId = 0x22 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnFd_Reappear as
                 unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnFd_Reappear(mut this: *mut EnFd,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.pos = (*this).actor.home.pos;
    (*this).actor.params = 0 as libc::c_int as s16;
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
    (*this).coreActive = 0 as libc::c_int as u8_0;
    (*this).actor.scale.y = 0.0f32;
    (*this).fadeAlpha = 255.0f32;
    func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                  0 as libc::c_int);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3981 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnFd_SpinAndGrow as
                 unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                     -> ());
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, (*this).skelAnime.endFrame)
        ...
        (*this).actor.scale.y =
            (*this).skelAnime.curFrame *
                (0.01f32 / (*this).skelAnime.animLength);
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_JumpToGround(mut this: *mut EnFd,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_Land(mut this: *mut EnFd,
                                   mut globalCtx: *mut GlobalContext) {
    let mut adjPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Math_SmoothStepToF(&mut (*this).skelAnime.playSpeed, 1.0f32, 0.1f32,
                       1.0f32, 0.0f32);
    if Animation_OnFrame(&mut (*this).skelAnime, (*this).skelAnime.endFrame)
           != 0 {
        (*this).spinTimer =
        ...
        EnFd_GetPosAdjAroundCircle(&mut adjPos, this, (*this).runRadius,
                                   (*this).runDir);
        (*this).actor.world.rot.y =
            (Math_FAtan2F(adjPos.x, adjPos.z) *
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_SpinAndSpawnFire(mut this: *mut EnFd,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut deceleration: f32_0 = 0.;
    let mut tgtSpeed: f32_0 = 0.;
    let mut rotSpeed: f32_0 = 0.;
    if ((*this).spinTimer as libc::c_int) < 31 as libc::c_int &&
           (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
        func_8002F974(&mut (*this).actor,
                      (0x3983 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    } else {
        func_8002F974(&mut (*this).actor,
                      (0x397e as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    if (if (*this).spinTimer as libc::c_int == 0 as libc::c_int {
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).runDir as libc::c_int * 0x2000 as libc::c_int) as
                s16;
        if (*this).spinTimer as libc::c_int == 30 as libc::c_int &&
               (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
            if (*this).actor.xzDistToPlayer > 160.0f32 {
                // orange flames
                EnFd_SpawnChildFire(this, globalCtx, 8 as libc::c_int as s16,
        ...
        deceleration = (*this).actor.world.rot.y as f32_0;
        deceleration -=
            (*this).actor.shape.rot.y as libc::c_int as libc::c_float;
        rotSpeed = 0.0f32;
        tgtSpeed = fabsf(deceleration);
        deceleration /= tgtSpeed;
        Math_ApproachF(&mut rotSpeed, tgtSpeed, 0.6f32,
                       0x2000 as libc::c_int as f32_0);
        rotSpeed *= deceleration;
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 rotSpeed as s16 as libc::c_int) as s16;
        rotSpeed = fabsf(rotSpeed);
        if rotSpeed as s32 <= 300 as libc::c_int {
            // ~1.6 degrees
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y
        }
        if (*this).actor.shape.rot.y as libc::c_int ==
               (*this).actor.world.rot.y as libc::c_int {
            (*this).initYawToInitPos =
                Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                               &mut (*this).actor.world.pos);
            (*this).curYawToInitPos =
                if ((*this).runDir as libc::c_int) < 0 as libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFd_Run(mut this: *mut EnFd,
                                  mut globalCtx: *mut GlobalContext) {
    let mut potentialThreat: *mut Actor = 0 as *mut Actor;
    let mut yawToYawTarget: s16 = 0;
    let mut runRadiusTarget: f32_0 = 0.;
    let mut adjPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if EnFd_ShouldStopRunning(this, globalCtx, (*this).runRadius,
                              &mut (*this).runDir) != 0 {
        if (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_int ^
    ...
    yawToYawTarget =
        (Math_Vec3f_Yaw(&mut (*this).actor.home.pos,
                        &mut (*this).actor.world.pos) as libc::c_int -
             (*this).initYawToInitPos as libc::c_int) as s16;
    if (*this).runDir as libc::c_int > 0 as libc::c_int {
        if (*this).curYawToInitPos as u16_0 as libc::c_int >
               yawToYawTarget as u16_0 as libc::c_int {
            (*this).circlesToComplete -= 1
        }
    } else if ((*this).curYawToInitPos as u16_0 as libc::c_int) <
                  yawToYawTarget as u16_0 as libc::c_int {
        (*this).circlesToComplete -= 1
    }
    if ((*this).circlesToComplete as libc::c_int) < 0 as libc::c_int {
        (*this).circlesToComplete = 0 as libc::c_int as s16
    }
    ...
    if !potentialThreat.is_null() &&
           (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
        runRadiusTarget =
            Math_Vec3f_DistXYZ(&mut (*this).actor.home.pos,
                               &mut (*potentialThreat).world.pos)
    } else { runRadiusTarget = 200.0f32 }
    Math_SmoothStepToF(&mut (*this).runRadius, runRadiusTarget, 0.3f32,
                       100.0f32, 0.0f32);
    EnFd_GetPosAdjAroundCircle(&mut adjPos, this, (*this).runRadius,
                               (*this).runDir);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (Math_FAtan2F(adjPos.x, adjPos.z) *
                            (0x8000 as libc::c_int as libc::c_float /
                                 3.14159265358979323846f32)) as s16,
                       4 as libc::c_int as s16, 0xfa0 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    (*this).actor.world.rot = (*this).actor.shape.rot;
    func_8002F974(&mut (*this).actor,
                  (0x397d as libc::c_int - 0x800 as libc::c_int) as u16_0);
    if (*this).skelAnime.curFrame == 6.0f32 ||
           (*this).skelAnime.curFrame == 13.0f32 ||
           (*this).skelAnime.curFrame == 28.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x397c as libc::c_int as u16_0);
    }
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 8.0f32, 0.1f32, 1.0f32,
                       0.0f32);
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFd_WaitForCore(mut this: *mut EnFd,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).spinTimer as libc::c_int != 0 as libc::c_int {
        (*this).spinTimer -= 1;
        if (*this).spinTimer as libc::c_int == 0 as libc::c_int {
    ...
    } else if (*this).actor.params as libc::c_int & 0x8000 as libc::c_int != 0
     {
        (*this).actionFunc =
            Some(EnFd_Reappear as
                     unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                         -> ())
    } else if (*this).actor.params as libc::c_int & 0x4000 as libc::c_int != 0
     {
        (*this).actor.params = 0 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    let mut pad: s32 = 0;
    if (*this).firstUpdateFlag != 0 {
        func_800F5ACC(0x38 as libc::c_int as u16_0);
        (*this).firstUpdateFlag = 0 as libc::c_int as s16
    }
    if (*this).actionFunc !=
           Some(EnFd_Reappear as
                    unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
    ...
    if (*this).actor.flags &
           ...
           ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint {
        // has been hookshoted
        if EnFd_SpawnCore(this, globalCtx) != 0 {
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            (*this).invincibilityTimer = 30 as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    if (*this).invincibilityTimer as libc::c_int != 0 as libc::c_int {
        match limbIndex { 13 | 21 => { *dList = 0 as *mut Gfx } _ => { } }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFd_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void,
                                           mut gfxP: *mut *mut Gfx) {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    let mut unused0: Vec3f =
        { let mut init = Vec3f{x: 6800.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut unused1: Vec3f =
        { let mut init = Vec3f{x: 6800.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut initialPos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut accel: Vec3f =
    ...
    if limbIndex == 21 as libc::c_int {
        Matrix_MultVec3f(&mut initialPos, &mut (*this).corePos);
    }
    if limbIndex == 13 as libc::c_int {
        Matrix_MultVec3f(&mut initialPos, &mut (*this).actor.focus.pos);
    }
    if limbIndex == 3 as libc::c_int || limbIndex == 6 as libc::c_int ||
           limbIndex == 7 as libc::c_int || limbIndex == 10 as libc::c_int ||
           limbIndex == 14 as libc::c_int || limbIndex == 15 as libc::c_int ||
           limbIndex == 17 as libc::c_int || limbIndex == 18 as libc::c_int ||
           limbIndex == 20 as libc::c_int || limbIndex == 22 as libc::c_int ||
           limbIndex == 23 as libc::c_int || limbIndex == 24 as libc::c_int ||
           limbIndex == 25 as libc::c_int || limbIndex == 26 as libc::c_int {
        if (*globalCtx).state.frames.wrapping_rem(2 as libc::c_int as
                                                      libc::c_uint) !=
               0 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int;
            while i < 1 as libc::c_int {
                Matrix_MultVec3f(&mut initialPos, &mut pos);
                pos.x += (Rand_ZeroOne() - 0.5f32) * 20.0f32;
                pos.y += (Rand_ZeroOne() - 0.5f32) * 40.0f32;
                pos.z += (Rand_ZeroOne() - 0.5f32) * 20.0f32;
                accel.x = (Rand_ZeroOne() - 0.5f32) * 0.4f32;
                accel.y = (Rand_ZeroOne() - 0.5f32) * 0.2f32 + 0.6f32;
                accel.z = (Rand_ZeroOne() - 0.5f32) * 0.4f32;
                EnFd_AddEffect(this, FD_EFFECT_DOT as libc::c_int as u8_0,
                               &mut pos, &mut velocity, &mut accel,
                               0 as libc::c_int as u8_0, 0.006f32, 0.0f32);
                i += 1
            }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFd = thisx as *mut EnFd;
    let mut clampedHealth: s32 = 0;
    let mut primColors: [Color_RGBA8; 3] =
        [{
             let mut init =
    ...
    let mut envColors: [Color_RGBA8; 3] =
        [{
             let mut init =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fd.c\x00" as *const u8 as *const libc::c_char,
                    1751 as libc::c_int);
    Matrix_Push();
    ...
    if (*this).actionFunc !=
           Some(EnFd_Reappear as
                    unsafe extern "C" fn(_: *mut EnFd, _: *mut GlobalContext)
                        -> ()) && !((*this).fadeAlpha < 0.9f32) {
        func_80093D84((*globalCtx).state.gfxCtx);
        clampedHealth =
            if ((*thisx).colChkInfo.health as libc::c_int - 1 as libc::c_int)
                   < 0 as libc::c_int {
                0 as libc::c_int
            } else if (*thisx).colChkInfo.health as libc::c_int -
                          1 as libc::c_int > 23 as libc::c_int {
                23 as libc::c_int
            } else {
                ((*thisx).colChkInfo.health as libc::c_int) - 1 as libc::c_int
            };
        ...
        (*_g).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (128 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            (primColors[(clampedHealth / 8 as libc::c_int) as usize].r as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (primColors[(clampedHealth / 8 as libc::c_int) as usize].g as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (primColors[(clampedHealth / 8 as libc::c_int) as usize].b as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).fadeAlpha as u8_0 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        ...
        (*_g_0).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g_0).words.w1 =
            (envColors[(clampedHealth / 8 as libc::c_int) as usize].r as u32_0
                 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (envColors[(clampedHealth / 8 as libc::c_int) as usize].g as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                (envColors[(clampedHealth / 8 as libc::c_int) as usize].b as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
            ...
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             (0xff as libc::c_int -
                                  frames.wrapping_mul(6 as libc::c_int as
                                                          libc::c_uint) as
                                      u8_0 as libc::c_int) as u32_0,
                             8 as libc::c_int, 0x40 as libc::c_int) as
                libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_AddEffect(mut this: *mut EnFd, mut type_0: u8_0,
                                        mut pos: *mut Vec3f,
                                        mut velocity: *mut Vec3f,
                                        mut accel: *mut Vec3f,
                                        mut timer: u8_0, mut scale: f32_0,
                                        mut scaleStep: f32_0) {
    let mut eff: *mut EnFdEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFdEffect; 200]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFdEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).type_0 as libc::c_int != FD_EFFECT_NONE as libc::c_int {
            i += 1;
            eff = eff.offset(1)
        } else {
            (*eff).scale = scale;
            ...
            (*eff).timer = timer;
            (*eff).initialTimer = (*eff).timer;
            (*eff).type_0 = type_0;
            (*eff).pos = *pos;
            (*eff).accel = *accel;
            (*eff).velocity = *velocity;
            if (*eff).type_0 as libc::c_int == FD_EFFECT_DOT as libc::c_int {
                (*eff).color.a = 255 as libc::c_int as u8_0;
                (*eff).timer = (Rand_ZeroOne() * 10.0f32) as s16 as u8_0
            }
            return
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_UpdateFlames(mut this: *mut EnFd) {
    let mut i: s16 = 0;
    let mut eff: *mut EnFdEffect = (*this).effects.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFdEffect; 200]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFdEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*eff).type_0 as libc::c_int == FD_EFFECT_FLAME as libc::c_int {
            (*eff).timer = (*eff).timer.wrapping_sub(1);
            if (*eff).timer as libc::c_int == 0 as libc::c_int {
                (*eff).type_0 = FD_EFFECT_NONE as libc::c_int as u8_0
            }
            (*eff).accel.x = Rand_ZeroOne() * 0.4f32 - 0.2f32;
            (*eff).accel.z = Rand_ZeroOne() * 0.4f32 - 0.2f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_UpdateDots(mut this: *mut EnFd) {
    let mut eff: *mut EnFdEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    let mut dotColors: [Color_RGBA8; 4] =
        [{
             let mut init =
                 Color_RGBA8{r: 255 as libc::c_int as u8_0,
    ...
    while (i as libc::c_int) <
        ...
        if (*eff).type_0 as libc::c_int == FD_EFFECT_DOT as libc::c_int {
            ...
            (*eff).velocity.z += (*eff).accel.z;
            (*eff).color.r =
                dotColors[((*eff).timer as libc::c_int % 4 as libc::c_int) as
                              usize].r;
            (*eff).color.g =
                dotColors[((*eff).timer as libc::c_int % 4 as libc::c_int) as
                              usize].g;
            (*eff).color.b =
                dotColors[((*eff).timer as libc::c_int % 4 as libc::c_int) as
                              usize].b;
            if (*eff).color.a as libc::c_int > 30 as libc::c_int {
                (*eff).color.a =
                    ((*eff).color.a as libc::c_int - 30 as libc::c_int) as
                        u8_0
            } else {
                (*eff).color.a = 0 as libc::c_int as u8_0;
                (*eff).type_0 = FD_EFFECT_NONE as libc::c_int as u8_0
            }
        }
        i += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_DrawFlames(mut this: *mut EnFd,
                                         mut globalCtx: *mut GlobalContext) {
    static mut dustTextures: [*mut libc::c_void; 8] =
        unsafe {
        ...
        if (*eff).type_0 as libc::c_int == FD_EFFECT_FLAME as libc::c_int {
                ...
                (*_g).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g).words.w1 =
                    gFlareDancerDL_7928.as_mut_ptr() as libc::c_uint;
                ...
                (*_g_0).words.w1 =
                    (255 as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            8 as libc::c_int |
                        (((*this).fadeAlpha / 255.0f32 *
                              255 as libc::c_int as libc::c_float) as u8_0 as
                             u32_0 &
                             (((0x1 as libc::c_int) << 8 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                firstDone = 1 as libc::c_int
            }
            ...
            (*_g_3).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_fd.c\x00" as *const u8 as
                                  *const libc::c_char as *mut libc::c_char,
                              2006 as libc::c_int) as libc::c_uint;
            idx =
                ((*eff).timer as libc::c_int as libc::c_float *
                     (8.0f32 /
                          (*eff).initialTimer as libc::c_int as
                              libc::c_float)) as s16;
            ...
            (*_g_4).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gSegments[((dustTextures[idx as usize] as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(dustTextures[idx as usize]
                                                      as u32_0 &
            ...
            (*_g_5).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                gFlareDancerSquareParticleDL.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        eff = eff.offset(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFd_DrawDots(mut this: *mut EnFd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s16 = 0;
                ...
                (*_g).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g).words.w1 =
                    gFlareDancerDL_79F8.as_mut_ptr() as libc::c_uint;
                ...
                ((*eff).color.r as u32_0 &
                    ...
                    ((*eff).color.b as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        8 as libc::c_int |
                    (((*eff).color.a as libc::c_int as libc::c_float *
                          ((*this).fadeAlpha / 255.0f32)) as u8_0 as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gFlareDancerTriangleParticleDL.as_mut_ptr() as libc::c_uint
        }
        i += 1;
        eff = eff.offset(1)
    }
