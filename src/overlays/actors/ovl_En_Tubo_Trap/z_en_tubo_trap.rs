...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnTuboTrap {
    pub actor: Actor,
    pub actionFunc: EnTuboTrapActionFunc,
    pub targetY: f32_0,
    pub originPos: Vec3f,
    pub collider: ColliderCylinder,
}
pub type EnTuboTrapActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTuboTrap, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_20 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_20 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_20 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_20 = -1;
...
#[no_mangle]
pub static mut En_Tubo_Trap_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TUBO_TRAP as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTuboTrap_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTuboTrap_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTuboTrap_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnTuboTrap_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTuboTrap = thisx as *mut EnTuboTrap;
    ...
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\xa3\xb7\xe3\x83\x88\xe3\x83\xa9\xe3\x83\x83\xe3\x83\x97 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
    ...
    (*this).actionFunc =
        Some(EnTuboTrap_WaitForProximity as
                 unsafe extern "C" fn(_: *mut EnTuboTrap,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnTuboTrap = thisx as *mut EnTuboTrap;
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_DropCollectible(mut this: *mut EnTuboTrap,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut params: s16 = (*this).actor.params;
    let mut param3FF: s16 =
        (params as libc::c_int >> 6 as libc::c_int & 0x3ff as libc::c_int) as
            s16;
    if param3FF as libc::c_int >= 0 as libc::c_int &&
           (param3FF as libc::c_int) < 0x1a as libc::c_int {
        Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                             (param3FF as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_SpawnEffectsOnLand(mut this:
                                                           *mut EnTuboTrap,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    ...
    let mut arg5: s32 = 0;
    let mut i: s32 = 0;
    let mut actorPos: *mut Vec3f = &mut (*this).actor.world.pos;
    i = 0 as libc::c_int;
    ...
    while i < 15 as libc::c_int {
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, actorPos,
                             -(240 as libc::c_int) as s16, arg5 as s16,
                             10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 65.0f32 + 15.0f32) as s16,
                             0 as libc::c_int as s16,
                             32 as libc::c_int as s16, 60 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as
                                 s16, gPotFragmentDL.as_mut_ptr());
        i += 1;
        var = (var as libc::c_int + 20000 as libc::c_int) as s16
    }
    func_80033480(globalCtx, actorPos, 30.0f32, 4 as libc::c_int,
                  20 as libc::c_int as s16, 50 as libc::c_int as s16,
                  0 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_SpawnEffectsInWater(mut this:
                                                            *mut EnTuboTrap,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut rand: f32_0 = 0.;
    ...
    while i < 15 as libc::c_int {
        ...
        pos.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        pos.z = cos * 8.0f32;
        velocity.x = pos.x * 0.20f32;
        velocity.y = Rand_ZeroOne() * 4.0f32 + 2.0f32;
        velocity.z = pos.z * 0.20f32;
        pos.x += (*actorPos).x;
        pos.y += (*actorPos).y;
        pos.z += (*actorPos).z;
        rand = Rand_ZeroOne();
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, actorPos,
                             -(180 as libc::c_int) as s16, arg5 as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_HandleImpact(mut this: *mut EnTuboTrap,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_WaitForProximity(mut this:
                                                         *mut EnTuboTrap,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut targetHeight: f32_0 = 0.;
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
                              16 as libc::c_int + 2 as libc::c_int) as usize]
           as libc::c_int != 0 as libc::c_int {
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x8f\xe3\x81\xa6     \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.world.pos.y as libc::c_double);
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x8a\xe3\x81\x84\xe3\x81\xa9\xe3\x82\x93 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*player).actor.world.pos.y as libc::c_double);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    }
    if (*this).actor.xzDistToPlayer < 200.0f32 &&
        ...
        targetHeight =
            40.0f32 + -10.0f32 * gSaveContext.linkAge as libc::c_float;
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x28c4 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnTuboTrap_Levitate as
                     unsafe extern "C" fn(_: *mut EnTuboTrap,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Levitate(mut this: *mut EnTuboTrap,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 5000 as libc::c_int) as
            s16;
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).targetY, 0.8f32,
                   3.0f32);
    if fabsf((*this).actor.world.pos.y - (*this).targetY) < 10.0f32 {
        (*this).actor.speedXZ = 10.0f32;
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actionFunc =
            Some(EnTuboTrap_Fly as
                     unsafe extern "C" fn(_: *mut EnTuboTrap,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Fly(mut this: *mut EnTuboTrap,
                                        mut globalCtx: *mut GlobalContext) {
    let mut dx: f32_0 = (*this).originPos.x - (*this).actor.world.pos.x;
    let mut dy: f32_0 = (*this).originPos.y - (*this).actor.world.pos.y;
    let mut dz: f32_0 = (*this).originPos.z - (*this).actor.world.pos.z;
    Audio_PlayActorSound2(&mut (*this).actor,
                          (0x3837 as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    if 240.0f32 < sqrtf(dx * dx + dy * dy + dz * dz) {
        Math_ApproachF(&mut (*this).actor.gravity, -3.0f32, 0.2f32, 0.5f32);
    }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 5000 as libc::c_int) as
            s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnTuboTrap = thisx as *mut EnTuboTrap;
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn EnTuboTrap_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gPotDL.as_mut_ptr());
}
