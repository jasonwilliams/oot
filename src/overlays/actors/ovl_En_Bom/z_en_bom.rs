...
extern "C" {
    ...
    #[no_mangle]
    static mut gBombBodyDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombCapDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut En_Bom_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOM as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnBom>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnBom_SetupAction(mut this: *mut EnBom,
                                           mut actionFunc: EnBomActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBom_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBom = thisx as *mut EnBom;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*thisx).shape, 700.0f32,
    ...
    (*thisx).colChkInfo.cylRadius = 5 as libc::c_int as s16;
    (*thisx).colChkInfo.cylHeight = 10 as libc::c_int as s16;
    (*this).timer = 70 as libc::c_int as s16;
    (*this).flashSpeedScale = 7 as libc::c_int as s16;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).explosionCollider, thisx,
                       ...
                       &mut *(*this).explosionColliderItems.as_mut_ptr().offset(0
                                                                                    ...
                                                                                    as
                                                                                    isize));
    (*this).explosionColliderItems[0 as libc::c_int as
                                       usize].info.toucher.damage =
        ((*this).explosionColliderItems[0 as libc::c_int as
                                            usize].info.toucher.damage as
             libc::c_int +
             (((*thisx).shape.rot.z as libc::c_int & 0xff00 as libc::c_int) >>
                  8 as libc::c_int)) as u8_0;
    (*thisx).shape.rot.z =
        ((*thisx).shape.rot.z as libc::c_int & 0xff as libc::c_int) as s16;
    if (*thisx).shape.rot.z as libc::c_int & 0x80 as libc::c_int != 0 {
        (*thisx).shape.rot.z =
            ((*thisx).shape.rot.z as libc::c_int | 0xff00 as libc::c_int) as
                s16
    }
    EnBom_SetupAction(this,
                      Some(EnBom_Move as
                               unsafe extern "C" fn(_: *mut EnBom,
                                                    _: *mut GlobalContext)
                                   -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBom_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBom = thisx as *mut EnBom;
...
pub unsafe extern "C" fn EnBom_Move(mut this: *mut EnBom,
    ...
    if (*this).actor.speedXZ != 0.0f32 &&
        ...
        if (if ((*this).actor.wallYaw as libc::c_int -
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int == 0 {
        Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.08f32);
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnBom_WaitForRelease(mut this: *mut EnBom,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnBom_Explode(mut this: *mut EnBom,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    *fresh0 =
        (*fresh0 as libc::c_int +
             ((*this).actor.shape.rot.z as libc::c_int + 8 as libc::c_int)) as
            s16;
    if (*this).actor.params as libc::c_int == BOMB_EXPLOSION as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnBom_Update(mut thisx: *mut Actor,
    ...
    let mut this: *mut EnBom = thisx as *mut EnBom;
    (*thisx).gravity = -1.2f32;
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 67 as libc::c_int {
        Audio_PlayActorSound2(thisx, 0x834 as libc::c_int as u16_0);
        Actor_SetScale(thisx, 0.01f32);
    }
    if (*thisx).xzDistToPlayer >= 20.0f32 ||
           (if (*thisx).yDistToPlayer >= 0 as libc::c_int as libc::c_float {
                (*thisx).yDistToPlayer
    ...
    Actor_UpdateBgCheckInfo(globalCtx, thisx, 5.0f32, 10.0f32, 15.0f32,
                            0x1f as libc::c_int);
    if (*thisx).params as libc::c_int == BOMB_BODY as libc::c_int {
        if ((*this).timer as libc::c_int) < 63 as libc::c_int {
            dustAccel.y = 0.2f32;
            ...
            func_8002829C(globalCtx, &mut effPos, &mut effVelocity,
                          ...
                          50 as libc::c_int as s16, 5 as libc::c_int as s16);
        }
        if (*this).bombCollider.base.acFlags as libc::c_int &
            ...
            (*thisx).shape.rot.z = 0 as libc::c_int as s16
        ...
        if (*this).timer as libc::c_int == 3 as libc::c_int ||
               ...
               (*this).timer as libc::c_int == 40 as libc::c_int {
            (*thisx).shape.rot.z = 0 as libc::c_int as s16;
            (*this).flashSpeedScale =
                ((*this).flashSpeedScale as libc::c_int >> 1 as libc::c_int)
                    as s16
        }
        if ((*this).timer as libc::c_int) < 100 as libc::c_int &&
               (*this).timer as libc::c_int &
                   (*this).flashSpeedScale as libc::c_int + 1 as libc::c_int
                   != 0 as libc::c_int {
            Math_SmoothStepToF(&mut (*this).flashIntensity, 140.0f32, 1.0f32,
                               140.0f32 /
                                   (*this).flashSpeedScale as libc::c_int as
                                       libc::c_float, 0.0f32);
        } else {
            Math_SmoothStepToF(&mut (*this).flashIntensity, 0.0f32, 1.0f32,
                               140.0f32 /
                                   (*this).flashSpeedScale as libc::c_int as
                                       libc::c_float, 0.0f32);
        }
        ...
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            effPos = (*thisx).world.pos;
            effPos.y += 10.0f32;
            if Actor_HasParent(thisx, globalCtx) != 0 { effPos.y += 30.0f32 }
            ...
            Camera_AddQuake(&mut (*globalCtx).mainCamera, 2 as libc::c_int,
                            0xb as libc::c_int as s16, 8 as libc::c_int);
            (*thisx).params = BOMB_EXPLOSION as libc::c_int as s16;
            (*this).timer = 10 as libc::c_int as s16;
            (*thisx).flags |=
                ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
            EnBom_SetupAction(this,
                              Some(EnBom_Explode as
                                       unsafe extern "C" fn(_: *mut EnBom,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
    ...
    if (*thisx).scale.x >= 0.01f32 &&
           (*thisx).params as libc::c_int != BOMB_EXPLOSION as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnBom_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBom = thisx as *mut EnBom;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bom.c\x00" as *const u8 as *const libc::c_char,
                    913 as libc::c_int);
    if (*thisx).params as libc::c_int == BOMB_BODY as libc::c_int {
        ...
        (*_g).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_bom.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gBombCapDL.as_mut_ptr() as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_5).words.w1 = gBombBodyDL.as_mut_ptr() as libc::c_uint;
