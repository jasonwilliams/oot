...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002F994(actor: *mut Actor, arg1: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gJabuWaterDL: [Gfx; 0];
    #[no_mangle]
    static mut gJabuElevatorPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gJabuElevatorCol: CollisionHeader;
    #[no_mangle]
    static mut gJabuFallingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gJabuLoweringPlatformCol: CollisionHeader;
    #[no_mangle]
    static mut gJabuObjectsLargeRotatingSpikePlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gJabuBigOctoPlatformCol: CollisionHeader;
}
...
pub type BgBdanObjectsActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut BgBdanObjects, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Bdan_Objects_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BDAN_OBJECTS as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgBdanObjects>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanObjects_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanObjects_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanObjects_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBdanObjects_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDLists: [*mut Gfx; 4] =
    unsafe {
        [gJabuObjectsLargeRotatingSpikePlatformDL.as_ptr() as *mut _,
         gJabuElevatorPlatformDL.as_ptr() as *mut _,
         gJabuWaterDL.as_ptr() as *mut _,
         gJabuFallingPlatformDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_GetContactRu1(mut this:
                                                         *mut BgBdanObjects,
                                                     mut arg1: s32) -> s32 {
    match arg1 {
        0 => {
            return ((*this).cameraSetting == CAM_SET_NORMAL0 as libc::c_int)
                       as libc::c_int
        }
        4 => {
            return gSaveContext.infTable[20 as libc::c_int as usize] as
                       libc::c_int & 0x40 as libc::c_int
        }
        3 => {
            return ((*this).cameraSetting == CAM_SET_DUNGEON1 as libc::c_int)
                       as libc::c_int
        }
        _ => {
            osSyncPrintf(b"Bg_Bdan_Objects_Get_Contact_Ru1\n\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8f\x97\xe4\xbf\xa1\xe3\x83\xa2\xe3\x83\xbc\xe3\x83\x89\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84%d!!!!!!!!\n\x00"
                             as *const u8 as *const libc::c_char); // pi * 150
            return -(1 as libc::c_int)
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_SetContactRu1(mut this:
                                                         *mut BgBdanObjects,
                                                     mut arg1: s32) {
    match arg1 {
        1 => { (*this).cameraSetting = CAM_SET_NORMAL1 as libc::c_int }
        2 => { (*this).cameraSetting = CAM_SET_DUNGEON0 as libc::c_int }
        4 => {
        ...
        _ => {
            osSyncPrintf(b"Bg_Bdan_Objects_Set_Contact_Ru1\n\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe9\x80\x81\xe4\xbf\xa1\xe3\x83\xa2\xe3\x83\xbc\xe3\x83\x89\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84%d!!!!!!!!\n\x00"
                             as *const u8 as *const libc::c_char);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgBdanObjects = thisx as *mut BgBdanObjects;
    ...
    if (*thisx).params as libc::c_int == 2 as libc::c_int {
        ...
        (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(7 as libc::c_int
                                                                 as
                                                                 isize)).ySurface
            = (*thisx).world.pos.y as s16;
        (*this).actionFunc =
            Some(func_8086C9A8 as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ());
        return
    }
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gJabuBigOctoPlatformCol as
        ...
        (*thisx).world.pos.y += -79.0f32;
        if Flags_GetClear(globalCtx, (*thisx).room as s32) != 0 {
            Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
            (*this).actionFunc =
                Some(func_8086C6EC as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        } else if BgBdanObjects_GetContactRu1(this, 4 as libc::c_int) != 0 {
            if !Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).dyna.actor, globalCtx,
                                   ACTOR_EN_BIGOKUTA as libc::c_int as s16,
                                   (*thisx).home.pos.x, (*thisx).home.pos.y,
                                   (*thisx).home.pos.z,
                                   0 as libc::c_int as s16,
                                   ((*thisx).shape.rot.y as libc::c_int +
                                        0x8000 as libc::c_int) as s16,
                                   0 as libc::c_int as s16,
                                   3 as libc::c_int as s16).is_null() {
                (*(*thisx).child).world.pos.z =
                    (*(*thisx).child).home.pos.z + 263.0f32
            }
            (*thisx).world.rot.y = 0 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_8086C618 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ());
            (*thisx).world.pos.y = (*thisx).home.pos.y + -70.0f32
        } else {
            Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
            (*this).timer = 0 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_8086C054 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        }
    } else if (*thisx).params as libc::c_int == 1 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gJabuElevatorCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).timer = 512 as libc::c_int as s16;
        (*this).switchFlag = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(func_8086C874 as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ())
    } else {
        CollisionHeader_GetVirtual(&mut gJabuLoweringPlatformCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
            (*this).actionFunc =
                Some(BgBdanObjects_DoNothing as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ());
            (*thisx).world.pos.y = (*thisx).home.pos.y - 400.0f32
        } else {
            (*this).actionFunc =
                Some(func_8086CB10 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgBdanObjects = thisx as *mut BgBdanObjects;
...
#[no_mangle]
pub unsafe extern "C" fn func_8086C054(mut this: *mut BgBdanObjects,
    ...
    if BgBdanObjects_GetContactRu1(this, 0 as libc::c_int) != 0 {
        if (*this).dyna.actor.xzDistToPlayer < 250.0f32 {
            BgBdanObjects_SetContactRu1(this, 1 as libc::c_int);
            (*this).timer = 20 as libc::c_int as s16;
            OnePointCutscene_Init(globalCtx, 3070 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
            (*player).actor.world.pos.x = -1130.0f32;
            (*player).actor.world.pos.y = -1025.0f32;
            (*player).actor.world.pos.z = -3300.0f32;
        ...
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            (*this).actionFunc =
                Some(func_8086C1A0 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        }
    }
    if Gameplay_InCsMode(globalCtx) == 0 &&
           BgBdanObjects_GetContactRu1(this, 0 as libc::c_int) == 0 {
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y + -79.0f32
    } else {
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y + -79.0f32 - 5.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C1A0(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                          (*this).dyna.actor.home.pos.y + 500.0f32, 0.5f32,
                          7.5f32, 1.0f32) < 0.1f32 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x289e as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_8086C29C as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ());
        (*this).timer = 30 as libc::c_int as s16;
        BgBdanObjects_SetContactRu1(this, 2 as libc::c_int);
        func_800AA000(0.0f32, 0xff as libc::c_int as u8_0,
                      0x14 as libc::c_int as u8_0,
                      0x96 as libc::c_int as u8_0);
    } else {
        ...
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            func_800AA000(0.0f32, 0x78 as libc::c_int as u8_0,
                          0x14 as libc::c_int as u8_0,
                          0xa as libc::c_int as u8_0);
            (*this).timer = 11 as libc::c_int as s16
        }
        func_8002F974(&mut (*this).dyna.actor,
                      (0x288f as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C29C(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp: s32 = 0;
    if (*this).timer as libc::c_int != 0 as libc::c_int {
        (*this).timer -= 1;
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            temp =
                Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                      usize],
                          1 as libc::c_int as u32_0) as s32;
            Quake_SetSpeed(temp as s16, 0x3a98 as libc::c_int as s16);
            Quake_SetQuakeValues(temp as s16, 0 as libc::c_int as s16,
                                 1 as libc::c_int as s16,
                                 0xfa as libc::c_int as s16,
                                 1 as libc::c_int as s16);
            Quake_SetCountdown(temp as s16, 0xa as libc::c_int as s16);
        }
    }
    if BgBdanObjects_GetContactRu1(this, 3 as libc::c_int) != 0 {
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_EN_BIGOKUTA as libc::c_int as s16,
                           (*this).dyna.actor.world.pos.x,
                           (*this).dyna.actor.world.pos.y + 140.0f32,
                           (*this).dyna.actor.world.pos.z,
                           0 as libc::c_int as s16,
                           ((*this).dyna.actor.shape.rot.y as libc::c_int +
                                0x8000 as libc::c_int) as s16,
                           0 as libc::c_int as s16, 0 as libc::c_int as s16);
        BgBdanObjects_SetContactRu1(this, 4 as libc::c_int);
        (*this).timer = 10 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8086C55C as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_8086C3D8(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + -70.0f32,
                    (*this).dyna.actor.velocity.y) != 0 {
        (*this).dyna.actor.world.rot.y = 0 as libc::c_int as s16;
        ...
        (*(*this).dyna.actor.child).world.pos.y =
            (*this).dyna.actor.world.pos.y + 140.0f32;
        (*this).actionFunc =
            Some(func_8086C5BC as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 3080 as libc::c_int as s16,
                              -(99 as libc::c_int) as s16,
                              (*this).dyna.actor.child,
                              0 as libc::c_int as s16);
        (*player).actor.world.pos.x = -1130.0f32;
        (*player).actor.world.pos.y = -1025.0f32;
        (*player).actor.world.pos.z = -3500.0f32;
        (*player).actor.shape.rot.y = 0x7530 as libc::c_int as s16;
        ...
        func_8002F974(&mut (*this).dyna.actor,
                      (0x2890 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).timer -= 1
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_8086C55C(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).timer -= 1;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Flags_UnsetSwitch(globalCtx, (*this).switchFlag as s32);
    } else if (*this).timer as libc::c_int == -(40 as libc::c_int) {
        (*this).timer = 0 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8086C3D8 as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C5BC(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           !(*this).dyna.actor.child.is_null() {
        if (*(*this).dyna.actor.child).params as libc::c_int ==
               2 as libc::c_int {
            (*this).actionFunc =
                Some(func_8086C618 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        } else if (*(*this).dyna.actor.child).params as libc::c_int ==
                      0 as libc::c_int {
            (*(*this).dyna.actor.child).params = 1 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C618(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Flags_GetClear(globalCtx, (*this).dyna.actor.room as s32) != 0 {
        ...
        (*this).dyna.actor.home.rot.y =
            (((*this).dyna.actor.shape.rot.y as libc::c_int +
                  0x2000 as libc::c_int) as s16 as libc::c_int &
                 0xc000 as libc::c_int) as s16;
        (*this).actionFunc =
            Some(func_8086C6EC as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ())
        ...
        func_800F436C(&mut (*this).dyna.actor.projectedPos,
                      0x2063 as libc::c_int as u16_0,
                      (if (*this).dyna.actor.world.rot.y as libc::c_int >=
                              0 as libc::c_int {
                           (*this).dyna.actor.world.rot.y as libc::c_int
                       } else {
                           -((*this).dyna.actor.world.rot.y as libc::c_int)
                       }) as libc::c_float / 512.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C6EC(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    let mut cond: s32 =
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + -125.0f32, 3.0f32) != 0 {
        if cond != 0 {
            (*this).actionFunc =
                Some(func_8086C76C as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8086C76C(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 {
        if (*this).dyna.actor.xzDistToPlayer < 120.0f32 {
            (*this).actionFunc =
                Some(func_8086C7D0 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ());
            OnePointCutscene_Init(globalCtx, 3090 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_8086C7D0(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                          (*this).dyna.actor.home.pos.y + 965.0f32, 0.5f32,
                          15.0f32, 0.2f32) < 0.01f32 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x289e as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(BgBdanObjects_DoNothing as
...
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_DoNothing(mut this: *mut BgBdanObjects,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C874(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).switchFlag as libc::c_int == 0 as libc::c_int {
        if func_8004356C(&mut (*this).dyna) != 0 {
            (*this).cameraSetting =
                (*(*globalCtx).cameraPtrs[0 as libc::c_int as usize]).setting
                    as s32;
            ...
            (*this).switchFlag = 10 as libc::c_int as u8_0
        }
    } else {
        Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                         usize],
        ...
        if func_8004356C(&mut (*this).dyna) == 0 {
            if (*this).switchFlag as libc::c_int != 0 as libc::c_int {
                (*this).switchFlag = (*this).switchFlag.wrapping_sub(1)
            }
        }
        if (*this).switchFlag as libc::c_int == 0 as libc::c_int {
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 (*this).cameraSetting as s16);
    ...
    (*this).dyna.actor.world.pos.y =
        (*this).dyna.actor.home.pos.y -
            sinf((*this).timer as libc::c_int as libc::c_float *
                     (3.14159265358979323846f32 / 256.0f32)) * 471.24f32;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).timer = 512 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C9A8(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        (*this).timer = 100 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8086C9F0 as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8086C9F0(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y, 0.5f32) != 0 {
            Flags_UnsetSwitch(globalCtx, (*this).switchFlag as s32);
            (*this).actionFunc =
                Some(func_8086C9A8 as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
        ...
        func_8002F948(&mut (*this).dyna.actor,
                      (0x285e as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    } else {
        if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                        (*this).dyna.actor.home.pos.y + 75.0f32, 0.5f32) != 0
           {
            (*this).actionFunc =
                Some(func_8086CABC as
                         unsafe extern "C" fn(_: *mut BgBdanObjects,
                                              _: *mut GlobalContext) -> ())
        }
        func_8002F948(&mut (*this).dyna.actor,
    ...
    (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(7 as libc::c_int as
                                                             isize)).ySurface
        = (*this).dyna.actor.world.pos.y as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_8086CABC(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    func_8002F994(&mut (*this).dyna.actor, (*this).timer as s32);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_8086C9F0 as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
...
#[no_mangle]
pub unsafe extern "C" fn func_8086CB10(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 {
        Flags_SetSwitch(globalCtx, (*this).switchFlag as s32);
        (*this).timer = 50 as libc::c_int as s16;
        (*this).actionFunc =
            Some(func_8086CB8C as
                     unsafe extern "C" fn(_: *mut BgBdanObjects,
                                          _: *mut GlobalContext) -> ());
        (*this).dyna.actor.home.pos.y -= 200.0f32;
        OnePointCutscene_Init(globalCtx, 3100 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_8086CB8C(mut this: *mut BgBdanObjects,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).dyna.actor.world.pos.y =
        (*this).dyna.actor.home.pos.y -
            cosf((*this).timer as libc::c_int as libc::c_float *
                     (3.14159265358979323846f32 / 50.0f32)) * 200.0f32;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x289f as libc::c_int as u16_0);
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgBdanObjects = thisx as *mut BgBdanObjects;
    Actor_SetFocus(thisx, 50.0f32);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgBdanObjects_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgBdanObjects = thisx as *mut BgBdanObjects;
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        if (*this).actionFunc ==
               Some(func_8086C054 as
                        unsafe extern "C" fn(_: *mut BgBdanObjects,
                                             _: *mut GlobalContext) -> ()) {
            if (*thisx).home.pos.y + -79.0f32 - 5.0f32 < (*thisx).world.pos.y
               {
                Matrix_Translate(0.0f32, -50.0f32, 0.0f32,
                                 MTXMODE_APPLY as libc::c_int as u8_0);
            }
        }
    }
    if (*thisx).params as libc::c_int == 2 as libc::c_int {
        Gfx_DrawDListXlu(globalCtx, gJabuWaterDL.as_mut_ptr());
    } else {
        Gfx_DrawDListOpa(globalCtx, sDLists[(*thisx).params as usize]);
    };
}
