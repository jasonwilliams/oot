...
#[no_mangle]
pub static mut En_Torch_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TORCH as libc::c_int as s16,
                          category:
...
static mut sChestContents: [u8_0; 8] =
    [GI_RUPEE_BLUE as libc::c_int as u8_0,
     GI_RUPEE_RED as libc::c_int as u8_0,
     GI_RUPEE_GOLD as libc::c_int as u8_0, GI_BOMBS_20 as libc::c_int as u8_0,
     GI_BOMBS_1 as libc::c_int as u8_0, GI_BOMBS_1 as libc::c_int as u8_0,
     GI_BOMBS_1 as libc::c_int as u8_0, GI_BOMBS_1 as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn EnTorch_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTorch = thisx as *mut EnTorch;
    let mut returnData: s8 =
    ...
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ACTOR_EN_BOX as libc::c_int as s16, (*this).actor.world.pos.x,
                (*this).actor.world.pos.y, (*this).actor.world.pos.z,
                0 as libc::c_int as s16, (*this).actor.shape.rot.y,
                0 as libc::c_int as s16,
                ((sChestContents[(returnData as libc::c_int >>
                                      0x5 as libc::c_int & 0x7 as libc::c_int)
                                     as usize] as libc::c_int) <<
                     0x5 as libc::c_int | 0x5000 as libc::c_int |
                     returnData as libc::c_int & 0x1f as libc::c_int) as s16);
