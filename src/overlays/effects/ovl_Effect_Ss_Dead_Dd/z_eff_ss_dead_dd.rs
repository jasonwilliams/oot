...
#[no_mangle]
pub static mut Effect_Ss_Dead_Dd_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_DEAD_DD as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDeadDd_Init as
 ...
 * Description:
 */
// if mode is 0 alpha decreases over time, otherwise it increases
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDd_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
    ...
    let mut i: s32 = 0;
    let mut initParams: *mut EffectSsDeadDdInitParams =
        initParamsx as *mut EffectSsDeadDdInitParams;
    if (*initParams).type_0 as libc::c_int == 0 as libc::c_int {
        (*this).pos = (*initParams).pos;
        (*this).velocity = (*initParams).velocity;
        (*this).accel = (*initParams).accel;
        (*this).life = (*initParams).life as s16;
        (*this).regs[9 as libc::c_int as usize] = (*initParams).scaleStep;
        (*this).regs[11 as libc::c_int as usize] = (*initParams).alphaStep;
        if (*initParams).alphaStep as libc::c_int != 0 as libc::c_int {
            (*this).regs[10 as libc::c_int as usize] = (*initParams).alphaStep
        } else {
            (*this).regs[10 as libc::c_int as usize] =
                ((*initParams).alpha as libc::c_int / (*initParams).life) as
                    s16
        }
        (*this).draw =
            Some(EffectSsDeadDd_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsDeadDd_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        ...
        (*this).regs[5 as libc::c_int as usize] = (*initParams).alpha as s16;
    ...
    } else if (*initParams).type_0 as libc::c_int == 1 as libc::c_int {
        (*this).life = (*initParams).life as s16;
        (*this).regs[9 as libc::c_int as usize] = (*initParams).scaleStep;
        (*this).regs[11 as libc::c_int as usize] = 0 as libc::c_int as s16;
        (*this).regs[10 as libc::c_int as usize] =
            (155 as libc::c_int / (*initParams).life) as s16;
        (*this).regs[0 as libc::c_int as usize] = (*initParams).scale;
        (*this).regs[2 as libc::c_int as usize] = 255 as libc::c_int as s16;
        (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
        (*this).regs[4 as libc::c_int as usize] = 155 as libc::c_int as s16;
        (*this).regs[5 as libc::c_int as usize] = 155 as libc::c_int as s16;
        (*this).regs[6 as libc::c_int as usize] = 250 as libc::c_int as s16;
        (*this).regs[7 as libc::c_int as usize] = 180 as libc::c_int as s16;
        ...
        (*this).update =
            Some(EffectSsDeadDd_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        i = (*initParams).randIter;
        while i > 0 as libc::c_int {
            (*this).pos.x =
                (Rand_ZeroOne() - 0.5f32) * (*initParams).randPosScale +
                    (*initParams).pos.x;
            (*this).pos.y =
                (Rand_ZeroOne() - 0.5f32) * (*initParams).randPosScale +
                    (*initParams).pos.y;
            (*this).pos.z =
                (Rand_ZeroOne() - 0.5f32) * (*initParams).randPosScale +
                    (*initParams).pos.z;
            (*this).velocity.x = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
            (*this).accel.x = (*this).velocity.x;
            (*this).velocity.y = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
            (*this).accel.y = (*this).velocity.y;
            (*this).velocity.z = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
            (*this).accel.z = (*this).velocity.z;
            i -= 1
        }
    } else {
        osSyncPrintf(b"Effect_SS_Dd_disp_mode():mode_sw\xe3\x81\x8c\xe5\xa4\x89\xe3\x81\xa7\xe3\x81\x99\xe3\x80\x82\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDd_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_dead_dd.c\x00" as *const u8 as
            ...
            (0xda as libc::c_int as u32_0 &
                ...
                (((0 as libc::c_int | 0 as libc::c_int | 0 as libc::c_int) ^
                     ...
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_2).words.w1 = &mut D_01000000 as *mut Mtx as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gLensFlareCircleDL.as_mut_ptr() as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDd_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    ...
    if (*this).regs[11 as libc::c_int as usize] as libc::c_int !=
        ...
        (*this).regs[5 as libc::c_int as usize] =
            ((*this).regs[5 as libc::c_int as usize] as libc::c_int +
                 (*this).regs[10 as libc::c_int as usize] as libc::c_int) as
                s16;
        if (*this).regs[5 as libc::c_int as usize] as libc::c_int >
               255 as libc::c_int {
            (*this).regs[5 as libc::c_int as usize] =
                255 as libc::c_int as s16
        }
    } else if ((*this).regs[5 as libc::c_int as usize] as libc::c_int) <
