...
extern "C" {
    ...
    #[no_mangle]
    static mut gCollapsingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gCollapsingPlatformCol: CollisionHeader;
}
...
pub struct ObjLift {
    ...
    pub actionFunc: ObjLiftActionFunc,
    pub unk168: Vec3s,
    pub timer: s16,
}
pub type ObjLiftActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjLift, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_19 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_19 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_19 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_19 = -1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjLiftFramgentScale {
    pub x: s16,
    pub z: s16,
}
#[no_mangle]
pub static mut Obj_Lift_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_LIFT as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_D_LIFT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjLift>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjLift_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sFallTimerDurations: [s16; 7] =
    [0 as libc::c_int as s16, 10 as libc::c_int as s16,
     20 as libc::c_int as s16, 30 as libc::c_int as s16,
     40 as libc::c_int as s16, 50 as libc::c_int as s16,
     60 as libc::c_int as s16];
// size = 0x4
static mut sFragmentScales: [ObjLiftFramgentScale; 9] =
    [{
         let mut init =
             ObjLiftFramgentScale{x: 120 as libc::c_int as s16,
                                  z: -(120 as libc::c_int) as s16,};
         init
     },
     {
         let mut init =
     ...
     {
         let mut init =
             ObjLiftFramgentScale{x: 0 as libc::c_int as s16,
                                  z: -(120 as libc::c_int) as s16,};
         init
     },
     {
...
static mut sScales: [f32_0; 2] = [0.1f32, 0.05f32];
static mut sMaxFallDistances: [f32_0; 2] = [-18.0f32, -9.0f32];
#[no_mangle]
pub unsafe extern "C" fn ObjLift_SetupAction(mut this: *mut ObjLift,
                                             mut actionFunc:
                                                 ObjLiftActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLift_InitDynaPoly(mut this: *mut ObjLift,
                                              mut globalCtx:
                                                  *mut GlobalContext,
                                              mut collision:
                                                  *mut CollisionHeader,
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_obj_lift.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B96160(mut this: *mut ObjLift,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_s3: *mut Vec3f = 0 as *mut Vec3f;
    let mut pad0: s32 = 0;
    let mut i: s32 = 0;
    temp_s3 = &mut (*this).dyna.actor.world.pos;
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ObjLiftFramgentScale; 9]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ObjLiftFramgentScale>()
                                                   as libc::c_ulong) as s32 {
        pos.x =
            sFragmentScales[i as usize].x as libc::c_int as libc::c_float *
                (*this).dyna.actor.scale.x + (*temp_s3).x;
        pos.y = (*temp_s3).y;
        pos.z =
            sFragmentScales[i as usize].z as libc::c_int as libc::c_float *
                (*this).dyna.actor.scale.z + (*temp_s3).z;
        velocity.x =
            sFragmentScales[i as usize].x as libc::c_int as libc::c_float *
                (*this).dyna.actor.scale.x * 0.8f32;
        velocity.y = Rand_ZeroOne() * 10.0f32 + 6.0f32;
        velocity.z =
            sFragmentScales[i as usize].z as libc::c_int as libc::c_float *
                (*this).dyna.actor.scale.z * 0.8f32;
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, temp_s3,
                             -(256 as libc::c_int) as s16,
                             if Rand_ZeroOne() < 0.5f32 {
                                 64 as libc::c_int
                             } else { 32 as libc::c_int } as s16,
                             15 as libc::c_int as s16,
                             15 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             ((Rand_ZeroOne() * 50.0f32 + 50.0f32) *
                                  (*this).dyna.actor.scale.x) as s16,
                             0 as libc::c_int as s16,
                             32 as libc::c_int as s16, 50 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_D_LIFT as libc::c_int as s16,
                             gCollapsingPlatformDL.as_mut_ptr());
        i += 1
    }
    if (*this).dyna.actor.params as libc::c_int >> 1 as libc::c_int &
           1 as libc::c_int == 0 as libc::c_int {
        func_80033480(globalCtx, &mut (*this).dyna.actor.world.pos, 120.0f32,
                      12 as libc::c_int, 120 as libc::c_int as s16,
                      100 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    } else if (*this).dyna.actor.params as libc::c_int >> 1 as libc::c_int &
                  1 as libc::c_int == 1 as libc::c_int {
        func_80033480(globalCtx, &mut (*this).dyna.actor.world.pos, 60.0f32,
                      8 as libc::c_int, 60 as libc::c_int as s16,
                      100 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjLift_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjLift = thisx as *mut ObjLift;
    ObjLift_InitDynaPoly(this, globalCtx, &mut gCollapsingPlatformCol,
                         DPM_PLAYER as libc::c_int);
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int >>
                           2 as libc::c_int & 0x3f as libc::c_int) != 0 {
    ...
    (*this).unk168.x = (Rand_ZeroOne() * 65535.5f32) as s16;
    (*this).unk168.y = (Rand_ZeroOne() * 65535.5f32) as s16;
    (*this).unk168.z = (Rand_ZeroOne() * 65535.5f32) as s16;
    func_80B9651C(this);
    osSyncPrintf(b"(Dungeon Lift)(arg_data 0x%04x)\n\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjLift_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjLift = thisx as *mut ObjLift;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9651C(mut this: *mut ObjLift) {
    (*this).timer =
        sFallTimerDurations[((*this).dyna.actor.params as libc::c_int >>
                                 8 as libc::c_int & 7 as libc::c_int) as
                                usize];
    ObjLift_SetupAction(this,
                        Some(func_80B96560 as
                                 unsafe extern "C" fn(_: *mut ObjLift,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80B96560(mut this: *mut ObjLift,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9664C(mut this: *mut ObjLift) {
    (*this).timer = 20 as libc::c_int as s16;
    ObjLift_SetupAction(this,
                        Some(func_80B96678 as
                                 unsafe extern "C" fn(_: *mut ObjLift,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80B96678(mut this: *mut ObjLift,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
        func_80B967C0(this);
    } else {
        (*this).unk168.x =
            ((*this).unk168.x as libc::c_int + 10000 as libc::c_int) as s16;
        (*this).dyna.actor.world.rot.x =
            ((Math_SinS((*this).unk168.x) * 300.0f32) as s16 as libc::c_int +
                 (*this).dyna.actor.home.rot.x as libc::c_int) as s16;
        (*this).dyna.actor.world.rot.z =
            ((Math_CosS((*this).unk168.x) * 300.0f32) as s16 as libc::c_int +
                 (*this).dyna.actor.home.rot.z as libc::c_int) as s16;
        (*this).dyna.actor.shape.rot.x = (*this).dyna.actor.world.rot.x;
        (*this).dyna.actor.shape.rot.z = (*this).dyna.actor.world.rot.z;
        (*this).unk168.y =
            ((*this).unk168.y as libc::c_int + 18000 as libc::c_int) as s16;
        (*this).dyna.actor.world.pos.y =
            Math_SinS((*this).unk168.y) + (*this).dyna.actor.home.pos.y;
        (*this).unk168.z =
            ((*this).unk168.z as libc::c_int + 18000 as libc::c_int) as s16;
        (*this).dyna.actor.world.pos.x =
            Math_SinS((*this).unk168.z) * 3.0f32 +
                (*this).dyna.actor.home.pos.x;
        (*this).dyna.actor.world.pos.z =
            Math_CosS((*this).unk168.z) * 3.0f32 +
                (*this).dyna.actor.home.pos.z
    }
    if (*this).timer as libc::c_int & 3 as libc::c_int == 3 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B967C0(mut this: *mut ObjLift) {
    ObjLift_SetupAction(this,
                        Some(func_80B96840 as
                                 unsafe extern "C" fn(_: *mut ObjLift,
                                                      _: *mut GlobalContext)
                                     -> ()));
    Math_Vec3f_Copy(&mut (*this).dyna.actor.world.pos,
                    &mut (*this).dyna.actor.home.pos);
    (*this).dyna.actor.world.rot = (*this).dyna.actor.home.rot;
    (*this).dyna.actor.shape.rot = (*this).dyna.actor.world.rot;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B96840(mut this: *mut ObjLift,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut bgId: s32 = 0;
    let mut sp2C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Actor_MoveForward(&mut (*this).dyna.actor);
    Math_Vec3f_Copy(&mut sp2C, &mut (*this).dyna.actor.prevPos);
    sp2C.y +=
        sMaxFallDistances[((*this).dyna.actor.params as libc::c_int >>
    ...
    if (*this).dyna.actor.floorHeight - (*this).dyna.actor.world.pos.y >=
        ...
        Flags_SetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int >>
                            2 as libc::c_int & 0x3f as libc::c_int);
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjLift_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjLift = thisx as *mut ObjLift;
...
#[no_mangle]
pub unsafe extern "C" fn ObjLift_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gCollapsingPlatformDL.as_mut_ptr());
}
