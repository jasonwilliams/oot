...
pub type EnAnubiceTagActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnAnubiceTag, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Anubice_Tag_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ANUBICE_TAG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnAnubiceTag>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceTag_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceTag_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceTag_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubiceTag_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnAnubiceTag = thisx as *mut EnAnubiceTag;
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "Anubis control tag generated"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa2\xe3\x83\x8c\xe3\x83\x93\xe3\x82\xb9\xe5\x88\xb6\xe5\xbe\xa1\xe3\x82\xbf\xe3\x82\xb0\xe7\x99\xba\xe7\x94\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
    ...
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        (*this).triggerRange =
            (*this).actor.params as libc::c_int as libc::c_float * 40.0f32
    }
    (*this).actionFunc =
        Some(EnAnubiceTag_SpawnAnubis as
                 unsafe extern "C" fn(_: *mut EnAnubiceTag,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_SpawnAnubis(mut this: *mut EnAnubiceTag,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).anubis =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_ANUBICE as libc::c_int as s16,
            ...
            as *mut EnAnubice;
    if !(*this).anubis.is_null() {
        (*this).actionFunc =
            Some(EnAnubiceTag_ManageAnubis as
                     unsafe extern "C" fn(_: *mut EnAnubiceTag,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_ManageAnubis(mut this:
                                                       *mut EnAnubiceTag,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut anubis: *mut EnAnubice = 0 as *mut EnAnubice;
    let mut offset: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if !(*this).anubis.is_null() {
        anubis = (*this).anubis;
        if (*anubis).actor.update.is_none() { return }
    } else { Actor_Kill(&mut (*this).actor); return }
    if (*anubis).deathTimer as libc::c_int != 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
    }
    if (*this).actor.xzDistToPlayer < 200.0f32 + (*this).triggerRange {
        if (*anubis).isLinkOutOfRange == 0 {
            if (*anubis).isKnockedback == 0 {
                (*anubis).isMirroringLink = 1 as libc::c_int as s16;
                offset.x =
                ...
                offset.z =
                    -Math_CosS((*this).actor.yawTowardsPlayer) *
                        (*this).actor.xzDistToPlayer;
                Math_ApproachF(&mut (*anubis).actor.world.pos.x,
                               (*this).actor.world.pos.x + offset.x, 0.3f32,
                               10.0f32);
                Math_ApproachF(&mut (*anubis).actor.world.pos.z,
                               (*this).actor.world.pos.z + offset.z, 0.3f32,
                               10.0f32);
                return
            }
        }
    } else if (*anubis).isMirroringLink != 0 {
        (*anubis).isLinkOutOfRange = 1 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnAnubiceTag = thisx as *mut EnAnubiceTag;
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubiceTag_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnAnubiceTag = thisx as *mut EnAnubiceTag;
