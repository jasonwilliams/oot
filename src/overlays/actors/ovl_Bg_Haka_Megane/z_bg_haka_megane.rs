...
extern "C" {
    ...
    #[no_mangle]
    static mut gBotwHoleTrap2DL: [Gfx; 0];
    #[no_mangle]
    static mut gBotwFakeWallsAndFloorsDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotwBloodSplatterDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotw1Col: CollisionHeader;
    #[no_mangle]
    static mut gBotwThreeFakeFloorsDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotw2Col: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_001120: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_0018F0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_002ED0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_003CF0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_DL_0040F0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_004330: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_0043B0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_0044D0: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_0045A0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_004780: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_0047F0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_004940: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_0049B0: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_004B00: CollisionHeader;
    #[no_mangle]
    static mut object_haka_objects_DL_004B70: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_objects_Col_004CC0: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaMegane {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaMeganeActionFunc,
    pub unk_168: [libc::c_char; 1],
    pub objBankIndex: s8,
    pub unk_16A: [libc::c_char; 2],
}
pub type BgHakaMeganeActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaMegane, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_Megane_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_MEGANE as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHakaMegane>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMegane_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMegane_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaMegane_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCollisionHeaders: [*mut CollisionHeader; 13] =
    unsafe {
        [&gBotw1Col as *const CollisionHeader as *mut CollisionHeader,
         &gBotw2Col as *const CollisionHeader as *mut CollisionHeader,
         0 as *const CollisionHeader as *mut CollisionHeader,
         &object_haka_objects_Col_004330 as *const CollisionHeader as
             *mut CollisionHeader,
         &object_haka_objects_Col_0044D0 as *const CollisionHeader as
             *mut CollisionHeader,
         0 as *const CollisionHeader as *mut CollisionHeader,
         &object_haka_objects_Col_004780 as *const CollisionHeader as
             *mut CollisionHeader,
         &object_haka_objects_Col_004940 as *const CollisionHeader as
             *mut CollisionHeader,
         0 as *const CollisionHeader as *mut CollisionHeader,
         &object_haka_objects_Col_004B00 as *const CollisionHeader as
             *mut CollisionHeader,
         0 as *const CollisionHeader as *mut CollisionHeader,
         &object_haka_objects_Col_004CC0 as *const CollisionHeader as
             *mut CollisionHeader,
         0 as *const CollisionHeader as *mut CollisionHeader]
    };
static mut sDLists: [*mut Gfx; 13] =
    unsafe {
        [gBotwFakeWallsAndFloorsDL.as_ptr() as *mut _,
         gBotwThreeFakeFloorsDL.as_ptr() as *mut _,
         gBotwHoleTrap2DL.as_ptr() as *mut _,
         object_haka_objects_DL_0040F0.as_ptr() as *mut _,
         object_haka_objects_DL_0043B0.as_ptr() as *mut _,
         object_haka_objects_DL_001120.as_ptr() as *mut _,
         object_haka_objects_DL_0045A0.as_ptr() as *mut _,
         object_haka_objects_DL_0047F0.as_ptr() as *mut _,
         object_haka_objects_DL_0018F0.as_ptr() as *mut _,
         object_haka_objects_DL_0049B0.as_ptr() as *mut _,
         object_haka_objects_DL_003CF0.as_ptr() as *mut _,
         object_haka_objects_DL_004B70.as_ptr() as *mut _,
         object_haka_objects_DL_002ED0.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgHakaMegane_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaMegane = thisx as *mut BgHakaMegane;
    ...
    if ((*thisx).params as libc::c_int) < 3 as libc::c_int {
        (*this).objBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_HAKACH_OBJECTS as libc::c_int as s16) as s8
    } else {
        (*this).objBankIndex =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
    ...
    if ((*this).objBankIndex as libc::c_int) < 0 as libc::c_int {
        ...
        (*this).actionFunc =
            Some(func_8087DB24 as
                     unsafe extern "C" fn(_: *mut BgHakaMegane,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaMegane_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHakaMegane = thisx as *mut BgHakaMegane;
...
pub unsafe extern "C" fn func_8087DB24(mut this: *mut BgHakaMegane,
    ...
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        if (*globalCtx).roomCtx.curRoom.showInvisActors != 0 {
            (*this).actionFunc =
                Some(func_8087DBF0 as
                         unsafe extern "C" fn(_: *mut BgHakaMegane,
                                              _: *mut GlobalContext) -> ());
            collision = sCollisionHeaders[(*this).dyna.actor.params as usize];
            ...
            (*this).actionFunc =
                Some(BgHakaMegane_DoNothing as
                         unsafe extern "C" fn(_: *mut BgHakaMegane,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8087DBF0(mut this: *mut BgHakaMegane,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaMegane_DoNothing(mut this: *mut BgHakaMegane,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaMegane_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHakaMegane = thisx as *mut BgHakaMegane;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaMegane_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaMegane = thisx as *mut BgHakaMegane;
    if (*thisx).flags &
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint ==
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint {
        Gfx_DrawDListXlu(globalCtx, sDLists[(*thisx).params as usize]);
    } else { Gfx_DrawDListOpa(globalCtx, sDLists[(*thisx).params as usize]); }
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        Gfx_DrawDListXlu(globalCtx, gBotwBloodSplatterDL.as_mut_ptr());
    };
}
