...
extern "C" {
    ...
    #[no_mangle]
    static mut gLargerCubeCol: CollisionHeader;
    #[no_mangle]
    static mut gFlatBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gSmallerFlatBlockCol: CollisionHeader;
    #[no_mangle]
    static mut gFlatRotBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gLargerFlatBlockCol: CollisionHeader;
    #[no_mangle]
    static mut gSmallCubeDL: [Gfx; 0];
    #[no_mangle]
    static mut gSmallerCubeCol: CollisionHeader;
    #[no_mangle]
    static mut gTreeStumpDL: [Gfx; 0];
    #[no_mangle]
    static mut gGrassBladesDL: [Gfx; 0];
    #[no_mangle]
    static mut gSignRectangularDL: [Gfx; 0];
    #[no_mangle]
    static mut gSignDirectionalDL: [Gfx; 0];
    #[no_mangle]
    static mut D_06000730: CollisionHeader;
}
...
pub const A_OBJ_MAX: C2RustUnnamed_17 = 12;
pub const A_OBJ_BOULDER_FRAGMENT: C2RustUnnamed_17 = 11;
pub const A_OBJ_SIGNPOST_ARROW: C2RustUnnamed_17 = 10;
pub const A_OBJ_SIGNPOST_OBLONG: C2RustUnnamed_17 = 9;
pub const A_OBJ_TREE_STUMP: C2RustUnnamed_17 = 8;
pub const A_OBJ_GRASS_CLUMP: C2RustUnnamed_17 = 7;
pub const A_OBJ_UNKNOWN_6: C2RustUnnamed_17 = 6;
pub const A_OBJ_CUBE_SMALL: C2RustUnnamed_17 = 5;
pub const A_OBJ_BLOCK_LARGE_ROT: C2RustUnnamed_17 = 4;
pub const A_OBJ_BLOCK_SMALL_ROT: C2RustUnnamed_17 = 3;
pub const A_OBJ_BLOCK_HUGE: C2RustUnnamed_17 = 2;
pub const A_OBJ_BLOCK_LARGE: C2RustUnnamed_17 = 1;
pub const A_OBJ_BLOCK_SMALL: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnAObj {
    pub dyna: DynaPolyActor,
    pub actionFunc: EnAObjActionFunc,
    pub rotateWaitTimer: s32,
    pub textId: s16,
    pub rotateState: s16,
    pub rotateForTimer: s16,
    pub rotSpeedY: s16,
    pub rotSpeedX: s16,
    pub focusYoffset: f32_0,
    pub collider: ColliderCylinder,
}
pub type EnAObjActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAObj, _: *mut GlobalContext) -> ()>;
...
#[no_mangle]
pub static mut En_A_Obj_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_A_OBJ as libc::c_int as s16,
...
// gHookshotTargetCol ?
static mut sColHeaders: [*mut CollisionHeader; 6] =
    unsafe {
        [&gLargerCubeCol as *const CollisionHeader as *mut CollisionHeader,
         &gLargerCubeCol as *const CollisionHeader as *mut CollisionHeader,
         &gSmallerFlatBlockCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gLargerFlatBlockCol as *const CollisionHeader as
             *mut CollisionHeader,
         &gSmallerCubeCol as *const CollisionHeader as *mut CollisionHeader,
         &D_06000730 as *const CollisionHeader as *mut CollisionHeader]
    };
static mut sDLists: [*mut Gfx; 12] =
    unsafe {
        [gFlatBlockDL.as_ptr() as *mut _, gFlatBlockDL.as_ptr() as *mut _,
         gFlatBlockDL.as_ptr() as *mut _, gFlatRotBlockDL.as_ptr() as *mut _,
         gFlatRotBlockDL.as_ptr() as *mut _, gSmallCubeDL.as_ptr() as *mut _,
         0x6000210 as libc::c_int as *mut Gfx,
         gGrassBladesDL.as_ptr() as *mut _, gTreeStumpDL.as_ptr() as *mut _,
         gSignRectangularDL.as_ptr() as *mut _,
         gSignDirectionalDL.as_ptr() as *mut _,
         gBoulderFragmentsDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn EnAObj_SetupAction(mut this: *mut EnAObj,
                                            mut actionFunc:
                                                EnAObjActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad: s32 = 0;
    let mut this: *mut EnAObj = thisx as *mut EnAObj;
    ...
    match (*thisx).params as libc::c_int {
        0 => { Actor_SetScale(thisx, 0.025f32); }
        1 => { Actor_SetScale(thisx, 0.05f32); }
        2 | 5 | 6 => { Actor_SetScale(thisx, 0.1f32); }
        3 => { Actor_SetScale(thisx, 0.005f32); }
        4 | _ => { Actor_SetScale(thisx, 0.01f32); }
    }
    if (*thisx).params as libc::c_int >= A_OBJ_SIGNPOST_OBLONG as libc::c_int
       {
        shadowScale = 12.0f32
    }
    ...
    (*this).dyna.bgId = -(1 as libc::c_int);
    (*this).dyna.unk_160 = 0 as libc::c_int as u8_0;
    (*this).dyna.unk_15C = DPM_UNK as libc::c_int as u32_0;
    (*thisx).uncullZoneDownward = 1200.0f32;
    (*thisx).uncullZoneScale = 200.0f32;
    match (*thisx).params as libc::c_int {
        1 | 2 => {
            (*this).dyna.bgId = 1 as libc::c_int;
        ...
        3 | 4 => {
            (*this).dyna.bgId = 3 as libc::c_int;
            Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx, thisx,
                                 ACTORCAT_BG as libc::c_int as u8_0);
        ...
        6 => {
            ...
            (*this).dyna.bgId = 5 as libc::c_int;
            (*this).focusYoffset = 10.0f32;
            // clang-format on
            (*thisx).gravity = -2.0f32;
            EnAObj_SetupWaitTalk(this, (*thisx).params);
        }
        7 | 8 => {
            (*this).dyna.bgId = 0 as libc::c_int;
            EnAObj_SetupWaitTalk(this, (*thisx).params);
        }
        9 | 10 => {
            (*thisx).textId =
                ((*this).textId as libc::c_int & 0xff as libc::c_int |
                     0x300 as libc::c_int) as u16_0;
            // clang-format off
            (*thisx).flags |=
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint;
            (*thisx).targetArrowOffset = 500.0f32;
            // clang-format on
            (*this).focusYoffset = 45.0f32;
            EnAObj_SetupWaitTalk(this, (*thisx).params);
    ...
    if (*thisx).params as libc::c_int <= A_OBJ_BLOCK_LARGE_ROT as libc::c_int
       {
        // A_OBJ_BLOCK_*
        (*thisx).colChkInfo.mass = 0xff as libc::c_int as u8_0
    }
    if (*this).dyna.bgId != -(1 as libc::c_int) {
        CollisionHeader_GetVirtual(sColHeaders[(*this).dyna.bgId as usize] as
...
#[no_mangle]
pub unsafe extern "C" fn EnAObj_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAObj = thisx as *mut EnAObj;
...
#[no_mangle]
pub unsafe extern "C" fn EnAObj_WaitFinishedTalking(mut this: *mut EnAObj,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if Actor_TextboxIsClosing(&mut (*this).dyna.actor, globalCtx) != 0 {
        EnAObj_SetupWaitTalk(this, (*this).dyna.actor.params);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_SetupWaitTalk(mut this: *mut EnAObj,
                                              mut type_0: s16) {
    EnAObj_SetupAction(this,
                       Some(EnAObj_WaitTalk as
                                unsafe extern "C" fn(_: *mut EnAObj,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_WaitTalk(mut this: *mut EnAObj,
                                         mut globalCtx: *mut GlobalContext) {
    let mut relYawTowardsPlayer: s16 = 0;
    if (*this).dyna.actor.textId as libc::c_int != 0 as libc::c_int {
        relYawTowardsPlayer =
        ...
        if (if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int {
               ...
               (*this).dyna.actor.params as libc::c_int ==
                   A_OBJ_SIGNPOST_ARROW as libc::c_int &&
                   (if relYawTowardsPlayer as libc::c_int >= 0 as libc::c_int
                       {
                        relYawTowardsPlayer as libc::c_int
                    } else { -(relYawTowardsPlayer as libc::c_int) }) >
                       0x5800 as libc::c_int {
            if Actor_ProcessTalkRequest(&mut (*this).dyna.actor, globalCtx) !=
                   0 {
                EnAObj_SetupAction(this,
                                   Some(EnAObj_WaitFinishedTalking as
                                            unsafe extern "C" fn(_:
                                                                     *mut EnAObj,
                                                                 _:
                                                                     *mut GlobalContext)
                                                -> ()));
            } else { func_8002F2F4(&mut (*this).dyna.actor, globalCtx); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_SetupBlockRot(mut this: *mut EnAObj,
                                              mut type_0: s16) {
    (*this).rotateState = 0 as libc::c_int as s16;
    (*this).rotateWaitTimer = 10 as libc::c_int;
    (*this).dyna.actor.world.rot.y = 0 as libc::c_int as s16;
    (*this).dyna.actor.shape.rot = (*this).dyna.actor.world.rot;
    EnAObj_SetupAction(this,
                       Some(EnAObj_BlockRot as
                                unsafe extern "C" fn(_: *mut EnAObj,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_BlockRot(mut this: *mut EnAObj,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).rotateState as libc::c_int == 0 as libc::c_int {
        if (*this).dyna.unk_160 as libc::c_int != 0 as libc::c_int {
            (*this).rotateState += 1;
            (*this).rotateForTimer = 20 as libc::c_int as s16;
            if (((*this).dyna.actor.yawTowardsPlayer as libc::c_int +
                     0x4000 as libc::c_int) as s16 as libc::c_int) <
                   0 as libc::c_int {
                (*this).rotSpeedX = -(0x3e8 as libc::c_int) as s16
            } else { (*this).rotSpeedX = 0x3e8 as libc::c_int as s16 }
            if ((*this).dyna.actor.yawTowardsPlayer as libc::c_int) <
                   0 as libc::c_int {
                (*this).rotSpeedY = -((*this).rotSpeedX as libc::c_int) as s16
            } else { (*this).rotSpeedY = (*this).rotSpeedX }
        }
    } else if (*this).rotateWaitTimer != 0 as libc::c_int {
        (*this).rotateWaitTimer -= 1
    } else {
        (*this).dyna.actor.shape.rot.y =
            ((*this).dyna.actor.shape.rot.y as libc::c_int +
                 (*this).rotSpeedY as libc::c_int) as s16;
        (*this).dyna.actor.shape.rot.x =
            ((*this).dyna.actor.shape.rot.x as libc::c_int +
                 (*this).rotSpeedX as libc::c_int) as s16;
        (*this).rotateForTimer -= 1;
        (*this).dyna.actor.gravity = -1.0f32;
        if (*this).rotateForTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnAObj_SetupBoulderFragment(mut this: *mut EnAObj,
                                                     mut type_0: s16) {
    EnAObj_SetupAction(this,
                       Some(EnAObj_BoulderFragment as
                                unsafe extern "C" fn(_: *mut EnAObj,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_BoulderFragment(mut this: *mut EnAObj,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).dyna.actor.speedXZ, 1.0f32, 1.0f32,
                       0.5f32, 0.0f32);
    (*this).dyna.actor.shape.rot.x =
        ((*this).dyna.actor.shape.rot.x as libc::c_int +
    ...
    if (*this).dyna.actor.speedXZ != 0.0f32 &&
           (*this).dyna.actor.bgCheckFlags as libc::c_int & 0x8 as libc::c_int
               != 0 {
    ...
    if (*this).dyna.actor.bgCheckFlags as libc::c_int & 0x2 as libc::c_int !=
           0 {
        if (*this).dyna.actor.velocity.y < -8.0f32 {
            (*this).dyna.actor.velocity.y *= -0.6f32;
            (*this).dyna.actor.speedXZ *= 0.6f32;
            (*this).dyna.actor.bgCheckFlags =
                ((*this).dyna.actor.bgCheckFlags as libc::c_int &
                     !(0x3 as libc::c_int)) as u16_0
        } else { Actor_Kill(&mut (*this).dyna.actor); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_SetupBlock(mut this: *mut EnAObj,
                                           mut type_0: s16) {
    (*this).dyna.actor.uncullZoneDownward = 1200.0f32;
    (*this).dyna.actor.uncullZoneScale = 720.0f32;
    EnAObj_SetupAction(this,
                       Some(EnAObj_Block as
                                unsafe extern "C" fn(_: *mut EnAObj,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAObj_Block(mut this: *mut EnAObj,
                                      mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnAObj_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAObj = thisx as *mut EnAObj;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Actor_MoveForward(&mut (*this).dyna.actor);
    if (*this).dyna.actor.gravity != 0.0f32 {
        if (*this).dyna.actor.params as libc::c_int !=
               A_OBJ_BOULDER_FRAGMENT as libc::c_int {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor,
                                    5.0f32, 40.0f32, 0.0f32,
                                    0x1d as libc::c_int);
        } else {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor,
                                    5.0f32, 20.0f32, 0.0f32,
                                    0x1d as libc::c_int);
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnAObj_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut type_0: s32 = (*thisx).params as s32;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_a_keep.c\x00" as *const u8 as
                        *const libc::c_char, 701 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if type_0 >= A_OBJ_MAX as libc::c_int {
        type_0 = A_OBJ_BOULDER_FRAGMENT as libc::c_int
    }
    if (*thisx).params as libc::c_int == A_OBJ_BOULDER_FRAGMENT as libc::c_int
       {
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = sDLists[type_0 as usize] as libc::c_uint;
