...
extern "C" {
    ...
    #[no_mangle]
    static mut gGraveyardKidWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gGraveyardKidSwingStickUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gGraveyardKidGrabStickTwoHandsAnim: AnimationHeader;
    #[no_mangle]
    static mut gGraveyardKidIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gGraveyardKidEyesOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gGraveyardKidEyesHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gGraveyardKidEyesClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gGraveyardKidSkel: FlexSkeletonHeader;
    #[no_mangle]
...
pub struct EnCs {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnCsActionFunc,
    pub collider: ColliderCylinder,
    pub talkState: s32,
    pub eyeIndex: s32,
    pub eyeBlinkTimer: s32,
    pub unk_1EC: s32,
    pub unk_1F0: [libc::c_char; 4],
    pub path: s32,
    pub unk_1F8: [libc::c_char; 4],
    pub waypoint: s32,
    pub animLoopCount: s32,
    pub walkAngle: f32_0,
    pub walkDist: f32_0,
    pub walkSpeed: f32_0,
    pub currentAnimIndex: s32,
    pub unk_214: [libc::c_char; 4],
    pub spookyMaskMtx: MtxF,
    pub npcInfo: struct_80034A14_arg1,
    pub flag: s32,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
}
pub type EnCsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnCs, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Cs_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_CS as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_CS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnCs>() as libc::c_ulong,
                          init:
                                                      ...
                                                      ActorFunc>(Some(EnCs_Draw
                                                                          ...
                                                                          unsafe extern "C" fn(_:
                                                                                               ...
                                                                                               _:
                                                                                                   *mut GlobalContext)
                                                                              ->
                                                                                  ())),}; // This variable is unused anywhere else
            init
        }
    };
...
static mut sAnimations: [struct_D_80AA1678; 4] =
    unsafe {
        [{
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gGraveyardKidWalkAnim as
         ...
         },
         {
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gGraveyardKidSwingStickUpAnim as
                                           *const AnimationHeader as
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
                                   mode: ANIMMODE_ONCE as libc::c_int as u8_0,
         ...
         },
         {
             let mut init =
                 struct_D_80AA1678{animation:
                                       &gGraveyardKidGrabStickTwoHandsAnim as
                                           *const AnimationHeader as
                                           *mut AnimationHeader,
                                   frameCount: 1.0f32,
                                   mode: ANIMMODE_ONCE as libc::c_int as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_SetAnimFromIndex(mut this: *mut EnCs,
                                               mut animIndex: s32,
    ...
    if sAnimations[animIndex as usize].frameCount >= 0.0f32 {
        Animation_Change(&mut (*this).skelAnime,
                         sAnimations[animIndex as usize].animation,
                         sAnimations[animIndex as usize].frameCount, 0.0f32,
        ...
        Animation_Change(&mut (*this).skelAnime,
                         sAnimations[animIndex as usize].animation,
                         sAnimations[animIndex as usize].frameCount,
                         Animation_GetLastFrame(sAnimations[animIndex as
                                                                usize].animation
                                                    as *mut libc::c_void) as
                             f32_0, 0.0f32,
                         sAnimations[animIndex as usize].mode, morphFrames);
    }
    *currentAnimIndex = animIndex;
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCs = thisx as *mut EnCs;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gGraveyardKidSkel, 0 as *mut AnimationHeader,
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            sDamageTable.as_mut_ptr(), &mut sColChkInfoInit2);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 0.0f32, 0.0f32,
                            0.0f32, 4 as libc::c_int);
    Animation_Change(&mut (*this).skelAnime,
                     sAnimations[0 as libc::c_int as usize].animation, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sAnimations[0 as libc::c_int as
                                                            usize].animation
                                                as *mut libc::c_void) as
                         f32_0, sAnimations[0 as libc::c_int as usize].mode,
    ...
    (*this).unk_1EC = 0 as libc::c_int;
    (*this).talkState = 0 as libc::c_int;
    (*this).currentAnimIndex = -(1 as libc::c_int);
    (*this).actor.gravity = -1.0f32;
    EnCs_SetAnimFromIndex(this, 0 as libc::c_int,
                          &mut (*this).currentAnimIndex);
    (*this).actionFunc =
        Some(EnCs_Walk as
                 unsafe extern "C" fn(_: *mut EnCs, _: *mut GlobalContext)
                     -> ());
    (*this).walkSpeed = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCs = thisx as *mut EnCs;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_GetTalkState(mut this: *mut EnCs,
                                           mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    let mut talkState: s32 = 1 as libc::c_int;
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        4 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                       0 as libc::c_int {
                    (*this).actor.textId = 0x2026 as libc::c_int as u16_0;
                    EnCs_SetAnimFromIndex(this, 3 as libc::c_int,
                                          &mut (*this).currentAnimIndex);
                    talkState = 2 as libc::c_int
                } else {
                    (*this).actor.textId = 0x2024 as libc::c_int as u16_0;
                    EnCs_SetAnimFromIndex(this, 1 as libc::c_int,
                                          &mut (*this).currentAnimIndex);
                    talkState = 2 as libc::c_int
                }
            }
        ...
        6 => {
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*this).actor.textId as libc::c_int ==
                    ...
                    (*this).actor.textId = 0x2027 as libc::c_int as u16_0;
                    talkState = 2 as libc::c_int
                } else { talkState = 0 as libc::c_int }
            }
        }
        0 | 1 | 2 | 3 | 5 | _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_GetTextID(mut this: *mut EnCs,
                                        mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    let mut textId: s32 =
        Text_GetFaceReaction(globalCtx, 15 as libc::c_int as u32_0) as s32;
    if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
           0x400 as libc::c_int != 0 {
        if textId == 0 as libc::c_int { textId = 0x2028 as libc::c_int }
    } else if (*player).currentMask as libc::c_int ==
                  PLAYER_MASK_SPOOKY as libc::c_int {
        textId = 0x2023 as libc::c_int
    } else if textId == 0 as libc::c_int { textId = 0x2022 as libc::c_int }
    return textId;
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_HandleTalking(mut this: *mut EnCs,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp2A: s16 = 0;
    ...
    if (*this).talkState == 2 as libc::c_int {
        ...
        (*this).talkState = 1 as libc::c_int
    } else if (*this).talkState == 1 as libc::c_int {
        (*this).talkState = EnCs_GetTalkState(this, globalCtx)
    } else if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.textId as libc::c_int == 0x2022 as libc::c_int ||
               (*this).actor.textId as libc::c_int != 0x2022 as libc::c_int &&
                   (*this).actor.textId as libc::c_int !=
                       0x2028 as libc::c_int {
            EnCs_SetAnimFromIndex(this, 3 as libc::c_int,
                                  &mut (*this).currentAnimIndex);
        }
        if (*this).actor.textId as libc::c_int == 0x2023 as libc::c_int ||
               (*this).actor.textId as libc::c_int == 0x2028 as libc::c_int {
            EnCs_SetAnimFromIndex(this, 1 as libc::c_int,
                                  &mut (*this).currentAnimIndex);
        }
        if (*this).actor.textId as libc::c_int == 0x2023 as libc::c_int {
        ...
        Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp2A,
                           &mut sp28);
        if sp2A as libc::c_int >= 0 as libc::c_int &&
               sp2A as libc::c_int <= 320 as libc::c_int &&
               sp28 as libc::c_int >= 0 as libc::c_int &&
               sp28 as libc::c_int <= 240 as libc::c_int &&
               func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32) != 0 {
            (*this).actor.textId = EnCs_GetTextID(this, globalCtx) as u16_0
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_GetwaypointCount(mut pathList: *mut Path,
                                               mut pathIndex: s32) -> s32 {
    let mut path: *mut Path =
        &mut *pathList.offset(pathIndex as isize) as *mut Path;
    return (*path).count as s32;
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_GetPathPoint(mut pathList: *mut Path,
                                           mut dest: *mut Vec3f,
                                           mut pathIndex: s32,
                                           mut waypoint: s32) -> s32 {
    let mut path: *mut Path = pathList;
    let mut pathPos: *mut Vec3s = 0 as *mut Vec3s;
    path = path.offset(pathIndex as isize);
    pathPos =
    ...
    (*dest).x = (*pathPos).x as f32_0;
    (*dest).y = (*pathPos).y as f32_0;
    (*dest).z = (*pathPos).z as f32_0;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_HandleWalking(mut this: *mut EnCs,
                                            mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut xDiff: f32_0 = 0.;
    let mut zDiff: f32_0 = 0.;
    let mut pathPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut waypointCount: s32 = 0;
    let mut walkAngle1: s16 = 0;
    let mut walkAngle2: s16 = 0;
    EnCs_GetPathPoint((*globalCtx).setupPathList, &mut pathPos, (*this).path,
                      (*this).waypoint);
    ...
    (*this).walkAngle = walkAngle1 as f32_0;
    (*this).walkDist = sqrtf(xDiff * xDiff + zDiff * zDiff);
    while (*this).walkDist <= 10.44f32 {
        (*this).waypoint += 1;
        waypointCount =
            EnCs_GetwaypointCount((*globalCtx).setupPathList, (*this).path);
        if (*this).waypoint < 0 as libc::c_int ||
               !((*this).waypoint < waypointCount) {
            (*this).waypoint = 0 as libc::c_int
        }
        EnCs_GetPathPoint((*globalCtx).setupPathList, &mut pathPos,
        ...
        walkAngle2 =
            (Math_FAtan2F(xDiff, zDiff) *
                 (32768.0f32 / 3.14159265358979323846f32)) as s16;
        (*this).walkAngle = walkAngle2 as f32_0;
        (*this).walkDist = sqrtf(xDiff * xDiff + zDiff * zDiff)
    }
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).walkAngle as s16, 1 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_Walk(mut this: *mut EnCs,
                                   mut globalCtx: *mut GlobalContext) {
    let mut rnd: s32 = 0;
    let mut animIndex: s32 = 0;
    let mut curAnimFrame: s32 = 0;
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (*this).talkState == 0 as libc::c_int {
            if gSaveContext.itemGetInf[3 as libc::c_int as usize] as
                ...
                rnd = (Rand_ZeroOne() * 10.0f32) as s32
            } else { rnd = (Rand_ZeroOne() * 5.0f32) as s32 }
            if rnd == 0 as libc::c_int {
                if gSaveContext.itemGetInf[3 as libc::c_int as usize] as
                       libc::c_int & 0x400 as libc::c_int != 0 {
                    animIndex = (2.0f32 * Rand_ZeroOne()) as s32;
                    animIndex =
                        if animIndex == 0 as libc::c_int {
                            2 as libc::c_int
                        } else { 1 as libc::c_int }
                } else { animIndex = 2 as libc::c_int }
                (*this).actionFunc =
                    Some(EnCs_Wait as
                             unsafe extern "C" fn(_: *mut EnCs,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else { animIndex = 0 as libc::c_int }
        }
        EnCs_SetAnimFromIndex(this, animIndex, &mut (*this).currentAnimIndex);
    }
    if (*this).talkState == 0 as libc::c_int {
        curAnimFrame = (*this).skelAnime.curFrame as s32;
        if curAnimFrame >= 8 as libc::c_int &&
               curAnimFrame < 16 as libc::c_int ||
               curAnimFrame >= 23 as libc::c_int &&
                   curAnimFrame < 30 as libc::c_int ||
               curAnimFrame == 0 as libc::c_int {
            (*this).walkSpeed = 0.0f32
        } else { (*this).walkSpeed = 1.0f32 }
        EnCs_HandleWalking(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_Wait(mut this: *mut EnCs,
                                   mut globalCtx: *mut GlobalContext) {
    let mut animIndex: s32 = 0;
    if (*this).talkState != 0 as libc::c_int {
        (*this).actionFunc =
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        animIndex = (*this).currentAnimIndex;
        if (*this).talkState == 0 as libc::c_int {
            if (*this).animLoopCount > 0 as libc::c_int {
                (*this).animLoopCount -= 1;
                animIndex = (*this).currentAnimIndex
            } else {
                animIndex = 0 as libc::c_int;
                (*this).actionFunc =
                    Some(EnCs_Walk as
                             unsafe extern "C" fn(_: *mut EnCs,
                                                  _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_Talk(mut this: *mut EnCs,
                                   mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        EnCs_SetAnimFromIndex(this, (*this).currentAnimIndex,
                              &mut (*this).currentAnimIndex);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    static mut eyeBlinkFrames: [s32; 3] =
        [70 as libc::c_int, 1 as libc::c_int, 1 as libc::c_int];
    let mut this: *mut EnCs = thisx as *mut EnCs;
    let mut pad: s32 = 0;
    if (*this).currentAnimIndex == 0 as libc::c_int {
        if (*this).skelAnime.curFrame as s32 == 9 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 23 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28ef as libc::c_int as u16_0);
        }
    } else if (*this).currentAnimIndex == 1 as libc::c_int {
        if (*this).skelAnime.curFrame as s32 == 10 as libc::c_int ||
               (*this).skelAnime.curFrame as s32 == 25 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28ef as libc::c_int as u16_0);
        }
    } else if (*this).currentAnimIndex == 2 as libc::c_int &&
                  (*this).skelAnime.curFrame as s32 == 20 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x28ef as libc::c_int as u16_0);
    }
    ...
    if (*this).eyeBlinkTimer < 0 as libc::c_int {
        (*this).eyeIndex += 1;
        if (*this).eyeIndex >= 3 as libc::c_int {
            (*this).eyeIndex = 0 as libc::c_int
        }
        (*this).eyeBlinkTimer = eyeBlinkFrames[(*this).eyeIndex as usize]
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCs_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gGraveyardKidEyesOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGraveyardKidEyesHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGraveyardKidEyesClosedTex.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut this: *mut EnCs = thisx as *mut EnCs;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_cs.c\x00" as *const u8 as *const libc::c_char,
                    968 as libc::c_int);
    ...
    if gSaveContext.itemGetInf[3 as libc::c_int as usize] as libc::c_int &
           0x400 as libc::c_int != 0 {
        let mut childLinkObjectIndex: s32 =
        ...
        if childLinkObjectIndex >= 0 as libc::c_int {
            let mut mtx: *mut Mtx = 0 as *mut Mtx;
            Matrix_Put(&mut (*this).spookyMaskMtx);
            mtx =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_cs.c\x00" as *const u8 as
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                (*globalCtx).objectCtx.status[childLinkObjectIndex as
                                                  usize].segment as
                    libc::c_uint;
            ...
            (*_g_1).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0xd as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                mtx.offset(-(7 as libc::c_int as isize)) as libc::c_uint;
            ...
            (*_g_2).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                gLinkChildSpookyMaskDL.as_mut_ptr() as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnCs = thisx as *mut EnCs;
    if (*this).flag & 1 as libc::c_int != 0 {
        match limbIndex {
            8 => {
                (*rot).x =
                    ((*rot).x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn EnCs_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut D_809E2970: Vec3f =
        { let mut init = Vec3f{x: 500.0f32, y: 800.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnCs = thisx as *mut EnCs;
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut D_809E2970, &mut (*this).actor.focus.pos);
        Matrix_Translate(0.0f32, -200.0f32, 0.0f32,
        ...
        Matrix_RotateZ((5.0f64 * 3.14159265358979323846f32 as libc::c_double /
                            9.0f64) as f32_0,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Get(&mut (*this).spookyMaskMtx);
    };
}
