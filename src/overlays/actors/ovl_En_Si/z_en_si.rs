...
pub struct EnSi {
    pub actor: Actor,
    pub actionFunc: EnSiActionFunc,
    pub collider: ColliderCylinder,
    pub unk_19C: u8_0,
}
pub type EnSiActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSi, _: *mut GlobalContext) -> ()>;
...
static mut D_80AFBADC: CollisionCheckInfoInit2 =
    {
        let mut init =
...
#[no_mangle]
pub static mut En_Si_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SI as libc::c_int as s16,
                          category:
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnSi>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnSi_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSi = thisx as *mut EnSi;
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            0 as *mut DamageTable, &mut D_80AFBADC);
    Actor_SetScale(&mut (*this).actor, 0.025f32);
    (*this).unk_19C = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(func_80AFB768 as
                 unsafe extern "C" fn(_: *mut EnSi, _: *mut GlobalContext)
                     -> ());
    (*this).actor.shape.yOffset = 42.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnSi_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSi = thisx as *mut EnSi;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AFB748(mut this: *mut EnSi,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFB768(mut this: *mut EnSi,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.flags &
           ...
           ((1 as libc::c_int) << 13 as libc::c_int) as libc::c_uint {
        (*this).actionFunc =
            Some(func_80AFB89C as
                     unsafe extern "C" fn(_: *mut EnSi, _: *mut GlobalContext)
                         -> ())
    } else {
        Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.25f32, 0.4f32,
                           1.0f32, 0.0f32);
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x400 as libc::c_int)
                as s16;
        if Player_InCsMode(globalCtx) == 0 {
            ...
            if (*this).collider.base.ocFlags2 as libc::c_int &
                ...
                Item_Give(globalCtx, ITEM_SKULL_TOKEN as libc::c_int as u8_0);
                (*player).actor.freezeTimer = 10 as libc::c_int as u16_0;
                Message_StartTextbox(globalCtx, 0xb4 as libc::c_int as u16_0,
                                     0 as *mut Actor);
                Audio_PlayFanfare(0x39 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(func_80AFB950 as
                             unsafe extern "C" fn(_: *mut EnSi,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFB89C(mut this: *mut EnSi,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.25f32, 0.4f32, 1.0f32,
                       0.0f32);
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    (*this).actor.shape.rot.y =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AFB950(mut this: *mut EnSi,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int !=
        ...
        gSaveContext.gsFlags[(((*this).actor.params as libc::c_int &
                                   0x1f00 as libc::c_int) >> 8 as libc::c_int
                                  >> 2 as libc::c_int) as usize] |=
            ((*this).actor.params as libc::c_int & 0xff as libc::c_int) <<
                gGsFlagsShifts[(((*this).actor.params as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn EnSi_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSi = thisx as *mut EnSi;
    ...
    Actor_SetFocus(&mut (*this).actor, 16.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnSi_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSi = thisx as *mut EnSi;
    if (*this).actionFunc !=
           Some(func_80AFB950 as
        ...
        GetItem_Draw(globalCtx, GID_SKULL_TOKEN_2 as libc::c_int as s16);
    };
}
