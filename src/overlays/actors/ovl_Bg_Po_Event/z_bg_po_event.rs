...
extern "C" {
    ...
    #[no_mangle]
    static mut gPoSistersJoellePaintingDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoSistersBethPaintingDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoSistersAmyPaintingDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoSistersAmyBlockDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoSistersAmyBlockCol: CollisionHeader;
    #[no_mangle]
    static mut gPoSistersAmyBethBlockDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgPoEvent {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgPoEventActionFunc,
    pub type_0: u8_0,
    pub index: u8_0,
    pub direction: s8,
    pub timer: s16,
    pub collider: ColliderTris,
    pub colliderItems: [ColliderTrisElement; 2],
}
pub type BgPoEventActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgPoEvent, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Po_Event_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_PO_EVENT as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_PO_SISTERS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgPoEvent>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoEvent_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoEvent_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBlocksAtRest: u8_0 = 0 as libc::c_int as u8_0;
static mut sZeroVec: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut sPuzzleState: u8_0 = 0;
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_InitPaintings(mut this: *mut BgPoEvent,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    static mut paintingPosX: [s16; 4] =
        [-(1302 as libc::c_int) as s16, -(866 as libc::c_int) as s16,
         1421 as libc::c_int as s16, 985 as libc::c_int as s16];
    static mut paintingPosY: [s16; 2] =
        [1107 as libc::c_int as s16, 1091 as libc::c_int as s16];
    static mut paintingPosZ: [s16; 2] =
        [-(3384 as libc::c_int) as s16, -(3252 as libc::c_int) as s16];
    let mut item: *mut ColliderTrisElementInit =
        0 as *mut ColliderTrisElementInit;
    let mut vtxVec: *mut Vec3f = 0 as *mut Vec3f;
    let mut i1: s32 = 0;
    let mut i2: s32 = 0;
    let mut sp9C: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut coss: f32_0 = 0.;
    let mut sins: f32_0 = 0.;
    let mut scaleY: f32_0 = 0.;
    let mut phi_t2: s32 = 0;
    let mut newPainting: *mut Actor = 0 as *mut Actor;
    sins = Math_SinS((*this).dyna.actor.shape.rot.y);
    coss = Math_CosS((*this).dyna.actor.shape.rot.y);
    if (*this).type_0 as libc::c_int == 4 as libc::c_int {
        sins *= 2.4f32;
        scaleY = 1.818f32;
        coss *= 2.4f32
    } else { scaleY = 1.0f32 }
    i1 = 0 as libc::c_int;
    while i1 < sTrisInit.count {
        item =
            &mut *sTrisInit.elements.offset(i1 as isize) as
                *mut ColliderTrisElementInit;
        // This section looks like a macro of some sort.
        i2 = 0 as libc::c_int;
        while i2 < 3 as libc::c_int {
            vtxVec =
                &mut *(*item).dim.vtx.as_mut_ptr().offset(i2 as isize) as
                    *mut Vec3f;
            sp9C[i2 as usize].x =
                (*vtxVec).x * coss +
                    ((*this).dyna.actor.home.pos.x + sins * (*vtxVec).z);
            sp9C[i2 as usize].y =
                (*vtxVec).y * scaleY + (*this).dyna.actor.home.pos.y;
            sp9C[i2 as usize].z =
                (*this).dyna.actor.home.pos.z + coss * (*vtxVec).z -
                    (*vtxVec).x * sins;
            i2 += 1
        }
        Collider_SetTrisVertices(&mut (*this).collider, i1,
    ...
    if (*this).type_0 as libc::c_int != 4 as libc::c_int &&
           (*this).index as libc::c_int != 2 as libc::c_int {
        phi_t2 =
            if (*this).type_0 as libc::c_int == 2 as libc::c_int {
                (*this).index as libc::c_int
            } else { ((*this).index as libc::c_int) + 2 as libc::c_int };
        newPainting =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                               &mut (*this).dyna.actor, globalCtx,
                               ACTOR_BG_PO_EVENT as libc::c_int as s16,
                               paintingPosX[phi_t2 as usize] as f32_0,
                               paintingPosY[(*this).index as usize] as f32_0,
                               paintingPosZ[(*this).index as usize] as f32_0,
                               ...
                               ((((*this).index as libc::c_int +
                                   ...
                                   as s16);
        if newPainting.is_null() {
            Actor_Kill(&mut (*this).dyna.actor);
            return
        }
        if (*this).index as libc::c_int == 0 as libc::c_int {
            if (*(*this).dyna.actor.child).child.is_null() {
                Actor_Kill(&mut (*this).dyna.actor);
                return
            }
            (*this).dyna.actor.parent = (*(*this).dyna.actor.child).child;
            (*(*(*this).dyna.actor.child).child).child =
                &mut (*this).dyna.actor
        }
    }
    (*this).timer = 0 as libc::c_int as s16;
    if (*this).type_0 as libc::c_int == 4 as libc::c_int {
        sPuzzleState = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(BgPoEvent_AmyWait as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    } else {
        sPuzzleState =
            ((Rand_ZeroOne() * 3.0f32) as s32 % 3 as libc::c_int) as u8_0;
        (*this).actionFunc =
            Some(BgPoEvent_PaintingEmpty as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_InitBlocks(mut this: *mut BgPoEvent,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut blockPosX: [s16; 3] =
        [2149 as libc::c_int as s16, 1969 as libc::c_int as s16,
         1909 as libc::c_int as s16];
    static mut blockPosZ: [s16; 3] =
        [-(1410 as libc::c_int) as s16, -(1350 as libc::c_int) as s16,
         -(1530 as libc::c_int) as s16];
    let mut newBlock: *mut Actor = 0 as *mut Actor;
    ...
    CollisionHeader_GetVirtual(&mut gPoSistersAmyBlockCol as
                                   *mut CollisionHeader as *mut libc::c_void,
                               &mut colHeader);
    (*this).dyna.bgId =
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int &&
           (*this).index as libc::c_int != 3 as libc::c_int {
        newBlock =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                               &mut (*this).dyna.actor, globalCtx,
                               ACTOR_BG_PO_EVENT as libc::c_int as s16,
                               blockPosX[(*this).index as usize] as f32_0,
                               (*this).dyna.actor.world.pos.y,
                               blockPosZ[(*this).index as usize] as f32_0,
                               0 as libc::c_int as s16,
                               ...
                               ((((*this).index as libc::c_int +
                                    ...
                                    (*this).dyna.actor.params as libc::c_int)
                                   as s16);
        if newBlock.is_null() { Actor_Kill(&mut (*this).dyna.actor); return }
        if (*this).index as libc::c_int == 0 as libc::c_int {
            if (*(*this).dyna.actor.child).child.is_null() {
                Actor_Kill(&mut (*this).dyna.actor);
                return
            }
            if (*(*(*this).dyna.actor.child).child).child.is_null() {
                Actor_Kill(&mut (*this).dyna.actor);
                Actor_Kill((*this).dyna.actor.child);
                return
            }
            (*this).dyna.actor.parent =
                (*(*(*this).dyna.actor.child).child).child;
            (*(*(*(*this).dyna.actor.child).child).child).child =
                &mut (*this).dyna.actor
        }
    }
    (*this).dyna.actor.world.pos.y = 833.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0; // this->index == 1
    let mut this: *mut BgPoEvent =
        thisx as *mut BgPoEvent; // this->index == 2
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    (*this).type_0 =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int &
             0xf as libc::c_int) as u8_0;
    (*this).index =
        ((*thisx).params as libc::c_int >> 0xc as libc::c_int &
             0xf as libc::c_int) as u8_0;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0x3f as libc::c_int) as s16;
    if (*this).type_0 as libc::c_int >= 2 as libc::c_int {
        Collider_InitTris(globalCtx, &mut (*this).collider);
        Collider_SetTris(globalCtx, &mut (*this).collider, thisx,
                         &mut sTrisInit, (*this).colliderItems.as_mut_ptr());
        if Flags_GetSwitch(globalCtx, (*thisx).params as s32) != 0 {
            Actor_Kill(thisx);
        } else { BgPoEvent_InitPaintings(this, globalCtx); }
    } else {
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        if Flags_GetSwitch(globalCtx, (*thisx).params as s32) != 0 {
            Actor_Kill(thisx);
        } else { BgPoEvent_InitBlocks(this, globalCtx); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgPoEvent = thisx as *mut BgPoEvent;
    if (*this).type_0 as libc::c_int >= 2 as libc::c_int {
        ...
        if (*this).type_0 as libc::c_int == 1 as libc::c_int &&
               gSaveContext.timer1Value as libc::c_int > 0 as libc::c_int {
            gSaveContext.timer1State = 0xa as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockWait(mut this: *mut BgPoEvent,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.world.pos.y = 833.0f32;
    if sPuzzleState as libc::c_int == 0x3f as libc::c_int {
        if (*this).type_0 as libc::c_int == 1 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 3150 as libc::c_int as s16,
                                  65 as libc::c_int as s16, 0 as *mut Actor,
                                  0 as libc::c_int as s16);
        }
        (*this).timer = 45 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgPoEvent_BlockShake as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).dyna.actor.xzDistToPlayer > 50.0f32 {
        if (*this).type_0 as libc::c_int != 1 as libc::c_int {
            sPuzzleState =
                (sPuzzleState as libc::c_int |
                     (1 as libc::c_int) << (*this).index as libc::c_int) as
                    u8_0
        } else {
            sPuzzleState =
                (sPuzzleState as libc::c_int | 0x10 as libc::c_int) as u8_0
        }
    } else if (*this).type_0 as libc::c_int != 1 as libc::c_int {
        sPuzzleState =
            (sPuzzleState as libc::c_int &
                 !((1 as libc::c_int) << (*this).index as libc::c_int)) as
                u8_0
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockShake(mut this: *mut BgPoEvent,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
    } else { (*this).timer -= 1 };
    if ((*this).timer as libc::c_int) < 15 as libc::c_int {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        (*this).actionFunc =
            Some(BgPoEvent_BlockFall as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_CheckBlock(mut this: *mut BgPoEvent) {
    let mut phi_v1: s32 = 0;
    let mut phi_a1: s32 = 0;
    let mut phi_t0: s32 = 0;
    let mut phi_a3: s32 = 0;
    if (*this).index as libc::c_int == 3 as libc::c_int ||
           (*this).index as libc::c_int == 1 as libc::c_int {
        phi_v1 = (*this).dyna.actor.world.pos.z as s32;
        phi_a1 = (*(*this).dyna.actor.child).world.pos.z as s32;
        if (*this).index as libc::c_int == 3 as libc::c_int {
            phi_a3 = (*this).dyna.actor.world.pos.x as s32;
            phi_t0 = (*(*this).dyna.actor.child).world.pos.x as s32
        } else {
            phi_a3 = (*(*this).dyna.actor.child).world.pos.x as s32;
            phi_t0 = (*this).dyna.actor.world.pos.x as s32
        }
    } else {
        phi_v1 = (*this).dyna.actor.world.pos.x as s32;
        phi_a1 = (*(*this).dyna.actor.child).world.pos.x as s32;
        if (*this).index as libc::c_int == 0 as libc::c_int {
            phi_a3 = (*this).dyna.actor.world.pos.z as s32;
            phi_t0 = (*(*this).dyna.actor.child).world.pos.z as s32
        } else {
            phi_a3 = (*(*this).dyna.actor.child).world.pos.z as s32;
            phi_t0 = (*this).dyna.actor.world.pos.z as s32
        }
    }
    if phi_v1 == phi_a1 && phi_t0 - phi_a3 == 60 as libc::c_int {
        sPuzzleState =
            (sPuzzleState as libc::c_int |
                 (1 as libc::c_int) << (*this).index as libc::c_int) as u8_0
    } else {
        sPuzzleState =
            (sPuzzleState as libc::c_int &
                 !((1 as libc::c_int) << (*this).index as libc::c_int)) as
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockFall(mut this: *mut BgPoEvent,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut firstFall: s32 = 0 as libc::c_int;
    (*this).dyna.actor.velocity.y += 1.;
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y, 433.0f32,
                    (*this).dyna.actor.velocity.y) != 0 {
        (*this).dyna.actor.flags &=
            !((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
        (*this).dyna.actor.velocity.y = 0.0f32;
        sBlocksAtRest = sBlocksAtRest.wrapping_add(1);
        if (*this).type_0 as libc::c_int != 1 as libc::c_int {
            BgPoEvent_CheckBlock(this);
        } else {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x281d as libc::c_int as u16_0);
            func_80033E88(&mut (*this).dyna.actor, globalCtx,
                          5 as libc::c_int as s16, 5 as libc::c_int as s16);
            func_80088B34((*this).timer);
            if firstFall == 0 as libc::c_int {
                firstFall = 1 as libc::c_int
            } else {
        ...
        (*this).direction = 0 as libc::c_int as s8;
        (*this).actionFunc =
            Some(BgPoEvent_BlockIdle as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockIdle(mut this: *mut BgPoEvent,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut amy: *mut Actor = 0 as *mut Actor;
    if sPuzzleState as libc::c_int == 0xf as libc::c_int {
        (*this).actionFunc =
            Some(BgPoEvent_BlockSolved as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ());
        if (*this).type_0 as libc::c_int == 0 as libc::c_int &&
               (*this).index as libc::c_int == 0 as libc::c_int {
            amy =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_PO_SISTERS as libc::c_int as s16,
                            (*this).dyna.actor.world.pos.x + 30.0f32,
                            (*this).dyna.actor.world.pos.y - 30.0f32,
                            (*this).dyna.actor.world.pos.z + 30.0f32,
                            0 as libc::c_int as s16,
                            (*this).dyna.actor.shape.rot.y,
                            0 as libc::c_int as s16,
                            ((*this).dyna.actor.params as libc::c_int +
            ...
            if !amy.is_null() {
                OnePointCutscene_Init(globalCtx, 3170 as libc::c_int as s16,
                                      30 as libc::c_int as s16, amy,
                                      0 as libc::c_int as s16);
            }
        ...
        if gSaveContext.timer1Value as libc::c_int == 0 as libc::c_int &&
               sBlocksAtRest as libc::c_int == 5 as libc::c_int {
            (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint;
            sPuzzleState = 0x10 as libc::c_int as u8_0;
            sBlocksAtRest = 0 as libc::c_int as u8_0
        }
        if sPuzzleState as libc::c_int == 0x40 as libc::c_int ||
               sPuzzleState as libc::c_int == 0x10 as libc::c_int &&
                   Player_InCsMode(globalCtx) == 0 {
            (*this).dyna.actor.world.rot.z = (*this).dyna.actor.shape.rot.z;
            (*this).actionFunc =
                Some(BgPoEvent_BlockReset as
                         unsafe extern "C" fn(_: *mut BgPoEvent,
                                              _: *mut GlobalContext) -> ());
            if sPuzzleState as libc::c_int == 0x10 as libc::c_int {
                sPuzzleState = 0x40 as libc::c_int as u8_0;
                Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                      0x28a4 as libc::c_int as u16_0);
                func_8002DF54(globalCtx, &mut (*player).actor,
                              8 as libc::c_int as u8_0);
            }
        } else if (*this).dyna.unk_150 != 0.0f32 {
            if (*this).direction as libc::c_int == 0 as libc::c_int {
                if func_800435D8(globalCtx, &mut (*this).dyna,
                                 0x1e as libc::c_int as s16,
                                 0x32 as libc::c_int as s16,
                                 -(0x14 as libc::c_int) as s16) !=
                       0 as libc::c_int {
                    sBlocksAtRest = sBlocksAtRest.wrapping_sub(1);
                    (*this).direction =
                        if (*this).dyna.unk_150 >= 0.0f32 {
                            1.0f32
                        } else { -1.0f32 } as s8;
                    (*this).actionFunc =
                        Some(BgPoEvent_BlockPush as
                                 unsafe extern "C" fn(_: *mut BgPoEvent,
                                                      _: *mut GlobalContext)
                                     -> ())
                } else {
        ...
        } else { (*this).direction = 0 as libc::c_int as s8 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockPush(mut this: *mut BgPoEvent,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut blockPushDist: f32_0 = 0.0f32;
    let mut displacement: f32_0 = 0.;
    let mut blockStop: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    (*this).dyna.actor.speedXZ += 0.1f32;
    (*this).dyna.actor.speedXZ =
        if (*this).dyna.actor.speedXZ > 2.0f32 {
            2.0f32
        } else { (*this).dyna.actor.speedXZ };
    blockStop =
        Math_StepToF(&mut blockPushDist, 20.0f32, (*this).dyna.actor.speedXZ);
    displacement =
        (*this).direction as libc::c_int as libc::c_float * blockPushDist;
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).dyna.unk_158) * displacement +
            (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).dyna.unk_158) * displacement +
    ...
    if blockStop != 0 {
        ...
        blockPushDist = 0.0f32;
        (*this).dyna.actor.speedXZ = 0.0f32;
        (*this).direction = 5 as libc::c_int as s8;
        sBlocksAtRest = sBlocksAtRest.wrapping_add(1);
        (*this).actionFunc =
            Some(BgPoEvent_BlockIdle as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ());
        if (*this).type_0 as libc::c_int == 1 as libc::c_int { return }
        BgPoEvent_CheckBlock(this);
        BgPoEvent_CheckBlock((*this).dyna.actor.parent as *mut BgPoEvent);
    }
    func_8002F974(&mut (*this).dyna.actor,
                  (0x280a as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockReset(mut this: *mut BgPoEvent,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y, 493.0f32, 1.0f32) !=
           0 &&
           Math_ScaledStepToS(&mut (*this).dyna.actor.shape.rot.z,
                              ((*this).dyna.actor.world.rot.z as libc::c_int -
                                   0x4000 as libc::c_int) as s16,
        ...
        if (*this).type_0 as libc::c_int == 1 as libc::c_int {
            (*this).timer =
                ((*this).timer as libc::c_int + 10 as libc::c_int) as s16;
            (*this).timer =
                if (*this).timer as libc::c_int > 120 as libc::c_int {
                    120 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_BlockSolved(mut this: *mut BgPoEvent,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y, 369.0f32, 2.0f32) !=
           0 {
        sPuzzleState = 0x20 as libc::c_int as u8_0;
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_AmyWait(mut this: *mut BgPoEvent,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        sPuzzleState =
            (sPuzzleState as libc::c_int | 0x20 as libc::c_int) as u8_0;
        ...
        (*this).actionFunc =
            Some(BgPoEvent_AmyPuzzle as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
// Amy is the green Poe
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_AmyPuzzle(mut this: *mut BgPoEvent,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if sPuzzleState as libc::c_int == 0xf as libc::c_int {
        pos.x = (*this).dyna.actor.world.pos.x - 5.0f32;
        pos.y = Rand_CenteredFloat(120.0f32) + (*this).dyna.actor.world.pos.y;
        pos.z = Rand_CenteredFloat(120.0f32) + (*this).dyna.actor.world.pos.z;
        EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut sZeroVec,
                             &mut sZeroVec, 170 as libc::c_int as s16,
                             0 as libc::c_int as s16,
    ...
    } else if sPuzzleState as libc::c_int == 0x20 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
    } else {
        if (*this).timer as libc::c_int == 0 as libc::c_int {
        } else { (*this).timer -= 1 };
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_NextPainting(mut this: *mut BgPoEvent)
 -> s32 {
    if !(*this).dyna.actor.parent.is_null() &&
           !(*this).dyna.actor.child.is_null() {
        if Rand_ZeroOne() < 0.5f32 {
            sPuzzleState =
                (*((*this).dyna.actor.parent as *mut BgPoEvent)).index
        } else {
            sPuzzleState =
                (*((*this).dyna.actor.child as *mut BgPoEvent)).index
        }
    } else if !(*this).dyna.actor.parent.is_null() {
        sPuzzleState = (*((*this).dyna.actor.parent as *mut BgPoEvent)).index
    } else if !(*this).dyna.actor.child.is_null() {
        sPuzzleState = (*((*this).dyna.actor.child as *mut BgPoEvent)).index
    } else { return 0 as libc::c_int }
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_PaintingEmpty(mut this: *mut BgPoEvent,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if sPuzzleState as libc::c_int == (*this).index as libc::c_int {
        (*this).timer = 255 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgPoEvent_PaintingAppear as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_PaintingAppear(mut this: *mut BgPoEvent,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).timer = ((*this).timer as libc::c_int - 20 as libc::c_int) as s16;
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
        (*this).timer = 1000 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgPoEvent_PaintingPresent as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_PaintingVanish(mut this: *mut BgPoEvent,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).timer = ((*this).timer as libc::c_int + 20 as libc::c_int) as s16;
    if (*this).timer as libc::c_int >= 255 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_PaintingPresent(mut this: *mut BgPoEvent,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    if ((*this).timer as libc::c_int == 0 as libc::c_int ||
            (*thisx).xzDistToPlayer < 150.0f32 &&
                (*thisx).yDistToPlayer < 50.0f32 ||
            func_8002DD78(player) != 0 && (*thisx).xzDistToPlayer < 320.0f32
                &&
                (if (*this).index as libc::c_int != 2 as libc::c_int {
                     ((*thisx).yDistToPlayer < 100.0f32) as libc::c_int
                 } else { ((*thisx).yDistToPlayer < 0.0f32) as libc::c_int })
                    != 0 &&
                Player_IsFacingActor(thisx, 0x2000 as libc::c_int as s16,
                                     globalCtx) != 0) &&
           (!(*thisx).parent.is_null() || !(*thisx).child.is_null()) {
        ...
        (*this).timer = 0 as libc::c_int as s16;
        Audio_PlayActorSound2(thisx, 0x38ec as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(BgPoEvent_PaintingVanish as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).collider.base.acFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 {
        if BgPoEvent_NextPainting(this) == 0 {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_PO_SISTERS as libc::c_int as s16,
                        (*thisx).world.pos.x, (*thisx).world.pos.y - 40.0f32,
                        (*thisx).world.pos.z, 0 as libc::c_int as s16,
                        (*thisx).shape.rot.y, 0 as libc::c_int as s16,
                        ((*thisx).params as libc::c_int +
                             (((*this).type_0 as libc::c_int -
                                   1 as libc::c_int) << 8 as libc::c_int)) as
                            s16);
            OnePointCutscene_Init(globalCtx, 3160 as libc::c_int as s16,
                                  80 as libc::c_int as s16, thisx,
                                  0 as libc::c_int as s16);
            func_80078884(0x4802 as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(thisx, 0x38ef as libc::c_int as u16_0);
            OnePointCutscene_Init(globalCtx, 3160 as libc::c_int as s16,
                                  35 as libc::c_int as s16, thisx,
                                  0 as libc::c_int as s16);
        }
        if !(*thisx).parent.is_null() {
            (*(*thisx).parent).child = 0 as *mut Actor;
            (*thisx).parent = 0 as *mut Actor
        }
        if !(*thisx).child.is_null() {
            (*(*thisx).child).parent = 0 as *mut Actor;
            (*thisx).child = 0 as *mut Actor
        }
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgPoEvent_PaintingBurn as
                     unsafe extern "C" fn(_: *mut BgPoEvent,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_PaintingBurn(mut this: *mut BgPoEvent,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut sp54: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).timer -= 1;
    sp54.x =
        Math_SinS((*this).dyna.actor.shape.rot.y) * 5.0f32 +
            (*this).dyna.actor.world.pos.x;
    sp54.y = Rand_CenteredFloat(66.0f32) + (*this).dyna.actor.world.pos.y;
    sp54.z = Rand_CenteredFloat(50.0f32) + (*this).dyna.actor.world.pos.z;
    if (*this).timer as libc::c_int >= 0 as libc::c_int {
        if (*this).type_0 as libc::c_int == 2 as libc::c_int {
            EffectSsDeadDb_Spawn(globalCtx, &mut sp54, &mut sZeroVec,
                                 &mut sZeroVec, 100 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
    ...
    if ((*this).timer as libc::c_int) < -(60 as libc::c_int) {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgPoEvent = thisx as *mut BgPoEvent;
...
#[no_mangle]
pub unsafe extern "C" fn BgPoEvent_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut displayLists: [*mut Gfx; 5] =
        unsafe {
            [gPoSistersAmyBlockDL.as_ptr() as *mut _,
             gPoSistersAmyBethBlockDL.as_ptr() as *mut _,
             gPoSistersJoellePaintingDL.as_ptr() as *mut _,
             gPoSistersBethPaintingDL.as_ptr() as *mut _,
             gPoSistersAmyPaintingDL.as_ptr() as *mut _]
        };
    let mut pad: s32 = 0;
    let mut this: *mut BgPoEvent = thisx as *mut BgPoEvent;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_po_event.c\x00" as *const u8 as
                        *const libc::c_char, 1481 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if (*this).type_0 as libc::c_int == 3 as libc::c_int ||
           (*this).type_0 as libc::c_int == 2 as libc::c_int {
        if (*this).actionFunc ==
               Some(BgPoEvent_PaintingEmpty as
                        unsafe extern "C" fn(_: *mut BgPoEvent,
                                             _: *mut GlobalContext) -> ()) {
            alpha = 255 as libc::c_int as u8_0
        } else if (*this).actionFunc ==
                      Some(BgPoEvent_PaintingPresent as
                               unsafe extern "C" fn(_: *mut BgPoEvent,
                                                    _: *mut GlobalContext)
                                   -> ()) {
            alpha = 0 as libc::c_int as u8_0
        } else { alpha = (*this).timer as u8_0 }
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = displayLists[(*this).type_0 as usize] as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_po_event.c\x00" as *const u8 as
                         *const libc::c_char, 1508 as libc::c_int);
    if (*this).type_0 as libc::c_int == 0 as libc::c_int ||
           (*this).type_0 as libc::c_int == 1 as libc::c_int {
        sp48 = (833.0f32 - (*this).dyna.actor.world.pos.y) * 0.0025f32;
        if !(sp48 > 1.0f32) {
            sp58.x = (*this).dyna.actor.world.pos.x;
            sp58.y = (*this).dyna.actor.world.pos.y - 30.0f32;
            sp58.z = (*this).dyna.actor.world.pos.z;
            sp4C.y = 1.0f32;
            sp4C.z = sp48 * 0.3f32 + 0.4f32;
            sp4C.x = sp4C.z;
            func_80033C30(&mut sp58, &mut sp4C,
                          (155.0f32 + sp48 * 100.0f32) as u8_0, globalCtx);
        }
    };
}
