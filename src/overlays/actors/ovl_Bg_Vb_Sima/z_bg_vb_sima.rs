...
extern "C" {
    ...
    #[no_mangle]
    static mut gVolvagiaPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gVolvagiaPlatformCol: CollisionHeader;
}
...
pub struct BgVbSima {
    ...
    pub unk_164: [libc::c_char; 16],
    pub shakeTimer: s16,
    pub unk_176: [libc::c_char; 6],
}
pub type C2RustUnnamed_19 = libc::c_uint;
pub const VBSIMA_KILL: C2RustUnnamed_19 = 2;
pub const VBSIMA_COLLAPSE: C2RustUnnamed_19 = 1;
pub const VBSIMA_STAND: C2RustUnnamed_19 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BossFd {
    pub actor: Actor,
...
pub const BFD_FX_SKULL_PIECE: C2RustUnnamed_20 = 5;
pub const BFD_FX_FIRE_BREATH: C2RustUnnamed_20 = 4;
pub const BFD_FX_DUST: C2RustUnnamed_20 = 3;
pub const BFD_FX_DEBRIS: C2RustUnnamed_20 = 2;
pub const BFD_FX_EMBER: C2RustUnnamed_20 = 1;
pub const BFD_FX_NONE: C2RustUnnamed_20 = 0;
#[no_mangle]
pub static mut Bg_Vb_Sima_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_VB_SIMA as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_FD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgVbSima>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgVbSima_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgVbSima_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgVbSima_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgVbSima = thisx as *mut BgVbSima;
    ...
    CollisionHeader_GetVirtual(&mut gVolvagiaPlatformCol as
...
#[no_mangle]
pub unsafe extern "C" fn BgVbSima_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgVbSima = thisx as *mut BgVbSima;
...
#[no_mangle]
pub unsafe extern "C" fn BgVbSima_SpawnEmber(mut effect: *mut BossFdEffect,
...
#[no_mangle]
pub unsafe extern "C" fn BgVbSima_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    let mut pad: s32 = 0;
    let mut this: *mut BgVbSima = thisx as *mut BgVbSima;
    let mut bossFd: *mut BossFd = (*this).dyna.actor.parent as *mut BossFd;
    let mut minus1: f32_0 = -1.0f32;
    (*this).shakeTimer += 1;
    if Flags_GetClear(globalCtx, (*globalCtx).roomCtx.curRoom.num as s32) == 0
       {
        let mut signal: s32 = (*bossFd).platformSignal as s32;
        if signal == VBSIMA_COLLAPSE as libc::c_int {
            Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                               -1000.0f32, 1.0f32, 1.5f32, 0.0f32);
            (*this).dyna.actor.world.pos.z +=
                2.0f32 *
                    Math_CosS(((*this).shakeTimer as libc::c_int *
                                   0x8000 as libc::c_int) as s16);
            (*this).dyna.actor.shape.rot.x =
                (Math_SinS(((*this).shakeTimer as libc::c_int *
                                0x7000 as libc::c_int) as s16) as s16 as
                     libc::c_int * 0x37 as libc::c_int) as s16;
            (*this).dyna.actor.shape.rot.z =
                (Math_SinS(((*this).shakeTimer as libc::c_int *
                                0x5000 as libc::c_int) as s16) as s16 as
                     libc::c_int * 0x37 as libc::c_int) as s16;
        ...
        } else if signal == VBSIMA_KILL as libc::c_int {
            Actor_Kill(&mut (*this).dyna.actor);
        }
        if (*bossFd).platformSignal as libc::c_int !=
               VBSIMA_STAND as libc::c_int {
            let mut i2: s16 = 0;
            let mut i1: s16 = 0;
            let mut splashVel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut splashAcc: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut splashPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut emberPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut emberVel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut emberAcc: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut edgeX: f32_0 = 0.;
            let mut edgeZ: f32_0 = 0.;
            i1 = 0 as libc::c_int as s16;
            while (i1 as libc::c_int) < 10 as libc::c_int {
                if Rand_ZeroOne() < 0.33f32 {
                    edgeX = -80.0f32;
                    edgeZ = Rand_CenteredFloat(160.0f32)
                } else {
                    edgeZ = 80.0f32;
                    if Rand_ZeroOne() < 0.5f32 { edgeZ = 80.0f32 * minus1 }
                    edgeX = Rand_CenteredFloat(160.0f32)
                }
                splashVel.x = edgeX * 0.05f32;
                splashVel.y = Rand_ZeroFloat(3.0f32) + 3.0f32;
                splashVel.z = edgeZ * 0.05f32;
                splashAcc.y = -0.3f32;
                ...
                func_8002836C(globalCtx, &mut splashPos, &mut splashVel,
                              &mut splashAcc, &mut colorYellow, &mut colorRed,
                ...
                while (i2 as libc::c_int) < 3 as libc::c_int {
                    ...
                    emberVel.y = Rand_ZeroFloat(5.0f32);
                    emberVel.z = splashVel.z;
                    emberAcc.y = 0.4f32;
                    emberAcc.x = Rand_CenteredFloat(0.5f32);
                    emberAcc.z = Rand_CenteredFloat(0.5f32);
                    emberPos.x = Rand_CenteredFloat(60.0f32) + splashPos.x;
                    emberPos.y = Rand_ZeroFloat(40.0f32) + splashPos.y;
                    emberPos.z = Rand_CenteredFloat(60.0f32) + splashPos.z;
                    BgVbSima_SpawnEmber((*bossFd).effects.as_mut_ptr(),
                                        &mut emberPos, &mut emberVel,
                                        &mut emberAcc,
...
#[no_mangle]
pub unsafe extern "C" fn BgVbSima_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_vb_sima.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gVolvagiaPlatformDL.as_mut_ptr() as libc::c_uint;
