...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoWellWaterDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot01Idomizu {
    pub actor: Actor,
    pub actionFunc: BgSpot01IdomizuActionFunc,
    pub waterHeight: f32_0,
    pub unk_154: [libc::c_char; 4],
}
pub type BgSpot01IdomizuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Idomizu,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Spot01_Idomizu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT01_IDOMIZU as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot01Idomizu>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idomizu_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idomizu_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idomizu_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idomizu_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idomizu_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot01Idomizu = thisx as *mut BgSpot01Idomizu;
    ...
    if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int &
        ...
        (*this).waterHeight = -550.0f32
    } else { (*this).waterHeight = 52.0f32 }
    (*this).actionFunc =
        Some(func_808ABB84 as
                 unsafe extern "C" fn(_: *mut BgSpot01Idomizu,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.world.pos.y = (*this).waterHeight;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idomizu_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808ABB84(mut this: *mut BgSpot01Idomizu,
                                       mut globalCtx: *mut GlobalContext) {
    if gSaveContext.eventChkInf[6 as libc::c_int as usize] as libc::c_int &
           0x80 as libc::c_int != 0 {
        (*this).waterHeight = -550.0f32
    }
    (*(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(0 as libc::c_int as
                                                             isize)).ySurface
        = (*this).actor.world.pos.y as s16;
    if (*this).waterHeight < (*this).actor.world.pos.y {
        Audio_PlaySoundGeneral((0x285e as libc::c_int - 0x800 as libc::c_int)
                                   as u16_0, &mut D_801333D4,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    }
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).waterHeight,
                   1.0f32, 2.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idomizu_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgSpot01Idomizu = thisx as *mut BgSpot01Idomizu;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idomizu_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot01_idomizu.c\x00" as *const u8 as
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (127 as libc::c_int as
                              libc::c_uint).wrapping_sub(frames.wrapping_rem(128
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint)),
                         frames & 0x7f as libc::c_int as libc::c_uint,
                         32 as libc::c_int, 32 as libc::c_int,
                         1 as libc::c_int,
                         frames.wrapping_rem(128 as libc::c_int as
                                                 libc::c_uint),
                         frames & 0x7f as libc::c_int as libc::c_uint,
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gKakarikoWellWaterDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_spot01_idomizu.c\x00" as *const u8 as
                         *const libc::c_char, 244 as libc::c_int);
}
