...
extern "C" {
    ...
    #[no_mangle]
    static mut gGTGFakeWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gGTGFakeCeilingDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMenkuriNisekabe {
    pub actor: Actor,
}
#[no_mangle]
pub static mut Bg_Menkuri_Nisekabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MENKURI_NISEKABE as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_MENKURI_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgMenkuriNisekabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriNisekabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriNisekabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriNisekabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMenkuriNisekabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDLists: [*mut Gfx; 2] =
    unsafe {
        [gGTGFakeWallDL.as_ptr() as *mut _,
         gGTGFakeCeilingDL.as_ptr() as *mut _]
    };
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriNisekabe_Init(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgMenkuriNisekabe = thisx as *mut BgMenkuriNisekabe;
    Actor_SetScale(&mut (*this).actor, 0.1f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriNisekabe_Destroy(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriNisekabe_Update(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgMenkuriNisekabe = thisx as *mut BgMenkuriNisekabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgMenkuriNisekabe_Draw(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgMenkuriNisekabe = thisx as *mut BgMenkuriNisekabe;
    let mut index: u32_0 =
    ...
    if (*this).actor.flags &
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint ==
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint {
        Gfx_DrawDListXlu(globalCtx, sDLists[index as usize]);
    } else { Gfx_DrawDListOpa(globalCtx, sDLists[index as usize]); };
}
