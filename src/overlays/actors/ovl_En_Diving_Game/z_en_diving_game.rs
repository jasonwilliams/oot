...
extern "C" {
    ...
    fn Gameplay_CameraSetFov(globalCtx: *mut GlobalContext, camId: s16,
                             fov: f32_0) -> s32;
    #[no_mangle]
    fn func_800C0DB4(globalCtx: *mut GlobalContext, pos: *mut Vec3f) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gZoraThrowRupeesAnim: AnimationHeader;
    #[no_mangle]
    static mut gZoraIdleAnim: AnimationHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDivingGame {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 20],
    pub morphTable: [Vec3s; 20],
    pub actionFunc: EnDivingGameActionFunc,
    pub vec_284: Vec3s,
    pub vec_28A: Vec3s,
    pub unk_290: s16,
    pub unk_292: s16,
    pub csCameraTimer: s16,
    pub unk_296: s16,
    pub eyeTimer: s16,
    pub spawnRuppyTimer: s16,
    pub phase: s16,
    pub eyeTexIndex: s16,
    pub subCamId: s16,
    pub unk_2A2: s16,
    pub grabbedRupeesCounter: s16,
    pub rupeesLeftToThrow: s16,
    pub state: s16,
    pub extraWinCount: s16,
    pub unk_2AC: [libc::c_char; 12],
    pub camLookAt: Vec3f,
    pub camEye: Vec3f,
    pub unk_2D0: Vec3f,
    pub unk_2DC: Vec3f,
    ...
    pub unk_30C: Vec3f,
    pub unk_318: f32_0,
    pub unk_31C: libc::c_char,
    pub notPlayingMinigame: u8_0,
    pub allRupeesThrown: u8_0,
    pub unk_31F: u8_0,
    pub unk_320: [libc::c_char; 4],
    pub unk_324: struct_80034A14_arg1,
    pub collider: ColliderCylinder,
}
pub type EnDivingGameActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDivingGame, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const ENDIVINGGAME_PHASE_2: C2RustUnnamed_24 = 2;
pub const ENDIVINGGAME_PHASE_1: C2RustUnnamed_24 = 1;
pub const ENDIVINGGAME_PHASE_ENDED: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const ENDIVINGGAME_STATE_PLAYING: C2RustUnnamed_25 = 2;
pub const ENDIVINGGAME_STATE_AWARDPRIZE: C2RustUnnamed_25 = 1;
pub const ENDIVINGGAME_STATE_NOTPLAYING: C2RustUnnamed_25 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type EnExRuppyActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnExRuppy, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Diving_Game_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DIVING_GAME as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_ZO as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDivingGame>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDivingGame_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDivingGame_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDivingGame_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDivingGame_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_809EF0B0: u8_0 = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnDivingGame = thisx as *mut EnDivingGame;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gZoraSkel,
                       &mut gZoraIdleAnim, (*this).jointTable.as_mut_ptr(),
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInit);
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xb4\xa0\xe3\x82\x82\xe3\x81\x90\xe3\x82\x8a\xef\xbc\xa7\xef\xbc\xaf \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).actor.room = -(1 as libc::c_int) as s8;
    (*this).actor.scale.x = 0.01f32;
    (*this).actor.scale.y = 0.012999999f32;
    (*this).actor.scale.z = 0.0139999995f32;
    if D_809EF0B0 != 0 {
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x82\xe3\x81\x86\xe3\x81\x84\xe3\x81\xa6\xe3\x82\x8b\xe5\x8e\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        (*this).unk_31F = 1 as libc::c_int as u8_0;
        Actor_Kill(&mut (*this).actor);
    } else {
        D_809EF0B0 = 1 as libc::c_int as u8_0;
        (*this).actor.targetMode = 0 as libc::c_int as s8;
        (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(func_809EDCB0 as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnDivingGame = thisx as *mut EnDivingGame;
    if (*this).unk_31F as libc::c_int == 0 as libc::c_int {
        gSaveContext.timer1State = 0 as libc::c_int as s16
    }
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_SpawnRuppy(mut this: *mut EnDivingGame,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut rupee: *mut EnExRuppy = 0 as *mut EnExRuppy;
    let mut rupeePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    rupeePos.x =
        (Rand_ZeroOne() - 0.5f32) * 30.0f32 + (*this).actor.world.pos.x;
    rupeePos.y =
        (Rand_ZeroOne() - 0.5f32) * 20.0f32 +
            ((*this).actor.world.pos.y + 30.0f32);
    rupeePos.z =
        (Rand_ZeroOne() - 0.5f32) * 20.0f32 + (*this).actor.world.pos.z;
    rupee =
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_EX_RUPPY as libc::c_int as s16,
                           rupeePos.x, rupeePos.y, rupeePos.z,
                           0 as libc::c_int as s16,
                           (Rand_CenteredFloat(3500.0f32) as s16 as
                                libc::c_int - 1000 as libc::c_int) as s16,
                           (*this).rupeesLeftToThrow, 0 as libc::c_int as s16)
            as *mut EnExRuppy;
    if !rupee.is_null() {
        (*rupee).actor.speedXZ = 12.0f32;
        (*rupee).actor.velocity.y = 6.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_HasMinigameFinished(mut this:
                                                              *mut EnDivingGame,
                                                          mut globalCtx:
                                                              *mut GlobalContext)
 -> s32 {
    if gSaveContext.timer1State as libc::c_int == 10 as libc::c_int &&
        ...
        Message_StartTextbox(globalCtx, (*this).actor.textId,
                             0 as *mut Actor);
        (*this).unk_292 = TEXT_STATE_EVENT as libc::c_int as s16;
        (*this).grabbedRupeesCounter = 0 as libc::c_int as s16;
        (*this).unk_2A2 = (*this).grabbedRupeesCounter;
        (*this).phase = (*this).unk_2A2;
        (*this).state = (*this).phase;
        (*this).allRupeesThrown = (*this).state as u8_0;
        func_8002DF54(globalCtx, 0 as *mut Actor, 8 as libc::c_int as u8_0);
        (*this).actionFunc =
            Some(func_809EE048 as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ());
        return 1 as libc::c_int
    } else {
        let mut rupeesNeeded: s32 = 5 as libc::c_int;
        if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               & 0x100 as libc::c_int != 0 {
            rupeesNeeded = 10 as libc::c_int
        }
        if (*this).grabbedRupeesCounter as libc::c_int >= rupeesNeeded {
            // Won.
            gSaveContext.timer1State = 0 as libc::c_int as s16;
            (*this).grabbedRupeesCounter = 0 as libc::c_int as s16;
            (*this).unk_2A2 = (*this).grabbedRupeesCounter;
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                ...
                (*this).actor.textId = 0x4055 as libc::c_int as u16_0
            } else {
                (*this).actor.textId = 0x405d as libc::c_int as u16_0;
                if ((*this).extraWinCount as libc::c_int) < 100 as libc::c_int
                   {
                    (*this).extraWinCount += 1
                }
            }
            Message_StartTextbox(globalCtx, (*this).actor.textId,
                                 0 as *mut Actor);
...
#[no_mangle]
pub unsafe extern "C" fn func_809EDCB0(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gZoraIdleAnim as *mut AnimationHeader as
                                   *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gZoraIdleAnim, 1.0f32,
                     0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).notPlayingMinigame = 1 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(EnDivingGame_Talk as
                 unsafe extern "C" fn(_: *mut EnDivingGame,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_Talk(mut this: *mut EnDivingGame,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).state as libc::c_int !=
           ENDIVINGGAME_STATE_PLAYING as libc::c_int ||
           EnDivingGame_HasMinigameFinished(this, globalCtx) == 0 {
        if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
            if (*this).unk_292 as libc::c_int !=
                ...
                match (*this).state as libc::c_int {
                    0 => {
                        func_8002DF54(globalCtx, 0 as *mut Actor,
                                      8 as libc::c_int as u8_0);
                        (*this).actionFunc =
                            Some(EnDivingGame_HandlePlayChoice as
                                     unsafe extern "C" fn(_:
                                                              *mut EnDivingGame,
                                                          _:
                                                              *mut GlobalContext)
            ...
            if Text_GetFaceReaction(globalCtx, 0x1d as libc::c_int as u32_0)
                   as libc::c_int != 0 as libc::c_int {
                (*this).actor.textId =
                    Text_GetFaceReaction(globalCtx,
                                         0x1d as libc::c_int as u32_0);
                (*this).unk_292 = TEXT_STATE_DONE as libc::c_int as s16
            } else {
                match (*this).state as libc::c_int {
                    0 => {
                        (*this).unk_292 =
                            TEXT_STATE_CHOICE as libc::c_int as s16;
                        if gSaveContext.eventChkInf[3 as libc::c_int as usize]
                               as libc::c_int & 0x100 as libc::c_int == 0 {
                            (*this).actor.textId =
                                0x4053 as libc::c_int as u16_0;
                            (*this).phase =
                                ENDIVINGGAME_PHASE_1 as libc::c_int as s16
                        } else {
                            (*this).actor.textId =
                                0x405c as libc::c_int as u16_0;
                            (*this).phase =
                                ENDIVINGGAME_PHASE_2 as libc::c_int as s16
                        }
                    }
                    1 => {
                        (*this).actor.textId = 0x4056 as libc::c_int as u16_0;
                        (*this).unk_292 =
                            TEXT_STATE_EVENT as libc::c_int as s16
                    }
                    2 => {
                        (*this).actor.textId = 0x405b as libc::c_int as u16_0;
                        (*this).unk_292 =
                            TEXT_STATE_EVENT as libc::c_int as s16
                    }
                    _ => { }
            ...
            func_8002F2CC(&mut (*this).actor, globalCtx, 80.0f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_HandlePlayChoice(mut this:
                                                           *mut EnDivingGame,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
        ...
        match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
            0 => {
                ...
                if gSaveContext.rupees as libc::c_int >= 20 as libc::c_int {
                    ...
                    (*this).actor.textId = 0x4054 as libc::c_int as u16_0
                } else {
        ...
        if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               ...
               (*this).actor.textId as libc::c_int == 0x2d as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809EE048(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        if (*this).phase as libc::c_int ==
               ENDIVINGGAME_PHASE_ENDED as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809EE0FC(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut gZoraThrowRupeesAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gZoraThrowRupeesAnim,
                     1.0f32, 0.0f32, frameCount as s16 as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).notPlayingMinigame = 0 as libc::c_int as u8_0;
    (*this).actionFunc =
        Some(func_809EE194 as
                 unsafe extern "C" fn(_: *mut EnDivingGame,
                                      _: *mut GlobalContext) -> ());
}
// Wait a bit before start throwing the rupees.
#[no_mangle]
pub unsafe extern "C" fn func_809EE194(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    let mut currentFrame: f32_0 = (*this).skelAnime.curFrame;
    SkelAnime_Update(&mut (*this).skelAnime);
    if currentFrame >= 15.0f32 {
        (*this).actionFunc =
            Some(EnDivingGame_SetupRupeeThrow as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_SetupRupeeThrow(mut this:
                                                          *mut EnDivingGame,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    (*this).spawnRuppyTimer = 10 as libc::c_int as s16;
    (*this).unk_2F4.x = -210.0f32;
    (*this).unk_2F4.y = -80.0f32;
    (*this).unk_2F4.z = -1020.0f32;
    (*this).unk_2D0.x = -280.0f32;
    (*this).unk_2D0.y = -20.0f32;
    (*this).unk_2D0.z = -240.0f32;
    if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int &
           0x100 as libc::c_int == 0 {
        (*this).rupeesLeftToThrow = 5 as libc::c_int as s16
    } else { (*this).rupeesLeftToThrow = 10 as libc::c_int as s16 }
    (*this).unk_300.z = 0.1f32;
    (*this).unk_300.y = (*this).unk_300.z;
    (*this).unk_300.x = (*this).unk_300.y;
    (*this).unk_2DC.z = (*this).unk_300.x;
    (*this).unk_2DC.y = (*this).unk_2DC.z;
    (*this).unk_2DC.x = (*this).unk_2DC.y;
    ...
    (*this).camEye.y = (*globalCtx).view.eye.y + 80.0f32;
    (*this).camEye.z = (*globalCtx).view.eye.z + 250.0f32;
    (*this).unk_2E8.x = fabsf((*this).camEye.x - (*this).unk_2D0.x) * 0.04f32;
    (*this).unk_2E8.y = fabsf((*this).camEye.y - (*this).unk_2D0.y) * 0.04f32;
    (*this).unk_2E8.z = fabsf((*this).camEye.z - (*this).unk_2D0.z) * 0.04f32;
    (*this).unk_30C.x =
        fabsf((*this).camLookAt.x - (*this).unk_2F4.x) * 0.04f32;
    (*this).unk_30C.y =
        fabsf((*this).camLookAt.y - (*this).unk_2F4.y) * 0.04f32;
    (*this).unk_30C.z =
        fabsf((*this).camLookAt.z - (*this).unk_2F4.z) * 0.04f32;
    Gameplay_CameraSetAtEye(globalCtx, (*this).subCamId,
                            &mut (*this).camLookAt, &mut (*this).camEye);
    Gameplay_CameraSetFov(globalCtx, (*this).subCamId,
                          (*globalCtx).mainCamera.fov);
    (*this).csCameraTimer = 60 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnDivingGame_RupeeThrow as
                 unsafe extern "C" fn(_: *mut EnDivingGame,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_318 = 0.0f32;
}
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_RupeeThrow(mut this: *mut EnDivingGame,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if func_800C0DB4(globalCtx, &mut (*this).actor.projectedPos) != 0 {
        Audio_SetExtraFilter(0 as libc::c_int as u8_0);
    }
    if (*this).subCamId as libc::c_int != 0 as libc::c_int {
        Math_ApproachF(&mut (*this).camEye.x, (*this).unk_2D0.x,
                       (*this).unk_2DC.x,
                       (*this).unk_2E8.x * (*this).unk_318);
        Math_ApproachF(&mut (*this).camEye.z, (*this).unk_2D0.z,
                       (*this).unk_2DC.z,
                       (*this).unk_2E8.z * (*this).unk_318);
        Math_ApproachF(&mut (*this).camLookAt.x, (*this).unk_2F4.x,
                       (*this).unk_300.x,
                       (*this).unk_30C.x * (*this).unk_318);
        Math_ApproachF(&mut (*this).camLookAt.y, (*this).unk_2F4.y,
                       (*this).unk_300.y,
                       (*this).unk_30C.y * (*this).unk_318);
        Math_ApproachF(&mut (*this).camLookAt.z, (*this).unk_2F4.z,
                       (*this).unk_300.z,
                       (*this).unk_30C.z * (*this).unk_318);
        Math_ApproachF(&mut (*this).unk_318, 1.0f32, 1.0f32, 0.02f32);
    }
    Gameplay_CameraSetAtEye(globalCtx, (*this).subCamId,
                            &mut (*this).camLookAt, &mut (*this).camEye);
    if (*this).allRupeesThrown == 0 &&
           (*this).spawnRuppyTimer as libc::c_int == 0 as libc::c_int {
        (*this).spawnRuppyTimer = 5 as libc::c_int as s16;
        EnDivingGame_SpawnRuppy(this, globalCtx);
        (*this).rupeesLeftToThrow -= 1;
        if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               & 0x100 as libc::c_int == 0 {
            (*this).unk_296 = 30 as libc::c_int as s16
        } else { (*this).unk_296 = 5 as libc::c_int as s16 }
        if (*this).rupeesLeftToThrow as libc::c_int <= 0 as libc::c_int {
            (*this).rupeesLeftToThrow = 0 as libc::c_int as s16;
            (*this).allRupeesThrown = 1 as libc::c_int as u8_0
        }
    }
    if (*this).csCameraTimer as libc::c_int == 0 as libc::c_int ||
           fabsf((*this).camEye.x - (*this).unk_2D0.x) < 2.0f32 &&
               fabsf((*this).camEye.y - (*this).unk_2D0.y) < 2.0f32 &&
               fabsf((*this).camEye.z - (*this).unk_2D0.z) < 2.0f32 &&
               fabsf((*this).camLookAt.x - (*this).unk_2F4.x) < 2.0f32 &&
               fabsf((*this).camLookAt.y - (*this).unk_2F4.y) < 2.0f32 &&
               fabsf((*this).camLookAt.z - (*this).unk_2F4.z) < 2.0f32 {
        if (*this).unk_2A2 as libc::c_int != 0 as libc::c_int {
            (*this).csCameraTimer = 70 as libc::c_int as s16;
            (*this).unk_2A2 = 2 as libc::c_int as s16;
            (*this).actionFunc =
                Some(func_809EE780 as
                         unsafe extern "C" fn(_: *mut EnDivingGame,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(EnDivingGame_SetupUnderwaterViewCs as
                         unsafe extern "C" fn(_: *mut EnDivingGame,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_SetupUnderwaterViewCs(mut this:
                                                                *mut EnDivingGame,
                                                            mut globalCtx:
                                                                *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_296 as libc::c_int == 0 as libc::c_int {
        (*this).unk_2A2 = 1 as libc::c_int as s16;
        (*this).csCameraTimer = 100 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDivingGame_RupeeThrow as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ());
        (*this).unk_2F4.x = -210.0f32;
        (*this).camLookAt.x = (*this).unk_2F4.x;
        (*this).unk_2F4.y = -80.0f32;
        (*this).camLookAt.y = (*this).unk_2F4.y;
        (*this).unk_2F4.z = -1020.0f32;
        (*this).camLookAt.z = (*this).unk_2F4.z;
        (*this).unk_2D0.x = -280.0f32;
        (*this).camEye.x = (*this).unk_2D0.x;
        (*this).unk_2D0.y = -20.0f32;
        (*this).camEye.y = (*this).unk_2D0.y;
        (*this).unk_2D0.z = -240.0f32;
        (*this).camEye.z = (*this).unk_2D0.z
    };
}
// EnDivingGame_SayStartAndWait ?
#[no_mangle]
pub unsafe extern "C" fn func_809EE780(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).csCameraTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809EE800(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
        ...
        if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               & 0x100 as libc::c_int == 0 {
            func_80088B34(((*gGameInfo).data[(25 as libc::c_int *
                                                  6 as libc::c_int *
                                                  16 as libc::c_int +
        ...
        (*this).actor.textId = 0x405b as libc::c_int as u16_0;
        (*this).unk_292 = TEXT_STATE_EVENT as libc::c_int as s16;
        (*this).state = ENDIVINGGAME_STATE_PLAYING as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDivingGame_Talk as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_809EE8F0(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
        ...
        (*this).actionFunc =
            Some(EnDivingGame_Talk as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
    } else { EnDivingGame_HasMinigameFinished(this, globalCtx); };
}
// EnDivingGame_SayCongratsAndWait ? // EnDivingGame_PlayerWonPhase1
#[no_mangle]
pub unsafe extern "C" fn func_809EE96C(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
        ...
        (*this).actor.textId = 0x4056 as libc::c_int as u16_0;
        (*this).unk_292 = TEXT_STATE_EVENT as libc::c_int as s16;
        (*this).state = ENDIVINGGAME_STATE_AWARDPRIZE as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnDivingGame_Talk as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_809EEA00(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_292 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
        ...
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_SCALE_SILVER as libc::c_int, 90.0f32, 10.0f32);
        (*this).actionFunc =
            Some(func_809EEA90 as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809EEA90(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_809EEAF8 as
                     unsafe extern "C" fn(_: *mut EnDivingGame,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
...
// Award the scale?
#[no_mangle]
pub unsafe extern "C" fn func_809EEAF8(mut this: *mut EnDivingGame,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_Update(mut thisx: *mut Actor,
                                             mut globalCtx2:
                                                 *mut GlobalContext) {
    ...
    if (*this).csCameraTimer as libc::c_int != 0 as libc::c_int {
        (*this).csCameraTimer -= 1
    }
    if (*this).unk_296 as libc::c_int != 0 as libc::c_int {
        (*this).unk_296 -= 1
    }
    if (*this).eyeTimer as libc::c_int != 0 as libc::c_int {
        (*this).eyeTimer -= 1
    }
    if (*this).spawnRuppyTimer as libc::c_int != 0 as libc::c_int {
        (*this).spawnRuppyTimer -= 1
    }
    if gSaveContext.timer1Value as libc::c_int == 10 as libc::c_int {
        func_800F5918();
    }
    if (*this).eyeTimer as libc::c_int == 0 as libc::c_int {
        (*this).eyeTimer = 2 as libc::c_int as s16;
        (*this).eyeTexIndex += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_EmptyDList(mut gfxCtx:
                                                     *mut GraphicsContext)
 -> *mut Gfx {
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_OverrideLimbDraw(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut limbIndex: s32,
                                                       mut dList:
                                                           *mut *mut Gfx,
 ...
 -> s32 {
    ...
    if limbIndex == 6 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).vec_28A.y as libc::c_int) as
                s16
    }
    if limbIndex == 15 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).vec_284.y as libc::c_int) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_int + (*this).vec_284.z as libc::c_int) as
                s16
    }
    if (*this).notPlayingMinigame as libc::c_int != 0 &&
           (limbIndex == 8 as libc::c_int || limbIndex == 9 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn EnDivingGame_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnDivingGame = thisx as *mut EnDivingGame;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_diving_game.c\x00" as *const u8 as
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0xc as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        EnDivingGame_EmptyDList((*globalCtx).state.gfxCtx) as libc::c_uint;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        gSegments[((sEyeTextures[(*this).eyeTexIndex as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sEyeTextures[(*this).eyeTexIndex as
                                                           usize] as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnDivingGame_OverrideLimbDraw as
