...
static mut D_8082A6E0: [s16; 2] =
    [100 as libc::c_int as s16, 255 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn KaleidoScope_UpdatePrompt(mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    let mut input: *mut Input =
        &mut *(*globalCtx).state.input.as_mut_ptr().offset(0 as libc::c_int as
                                                               isize) as
            *mut Input;
    let mut relStickX: s8 = (*input).rel.stick_x;
    let mut step: s16 = 0;
    if (*pauseCtx).state as libc::c_int == 7 as libc::c_int &&
           (*pauseCtx).unk_1EC as libc::c_int == 1 as libc::c_int ||
        ...
        if (*pauseCtx).promptChoice as libc::c_int == 0 as libc::c_int &&
               relStickX as libc::c_int >= 30 as libc::c_int {
            Audio_PlaySoundGeneral(0x4809 as libc::c_int as u16_0,
                                   &mut D_801333D4, 4 as libc::c_int as u8_0,
                                   &mut D_801333E0, &mut D_801333E0,
                                   &mut D_801333E8);
            (*pauseCtx).promptChoice = 4 as libc::c_int as s16
        } else if (*pauseCtx).promptChoice as libc::c_int != 0 as libc::c_int
                      && relStickX as libc::c_int <= -(30 as libc::c_int) {
            Audio_PlaySoundGeneral(0x4809 as libc::c_int as u16_0,
                                   &mut D_801333D4, 4 as libc::c_int as u8_0,
                                   &mut D_801333E0, &mut D_801333E0,
        ...
        step =
            ((if (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                     ...
                     D_8082A6E0[(*gGameInfo).data[(20 as libc::c_int *
                                                       6 as libc::c_int *
                                                       16 as libc::c_int +
                                                       62 as libc::c_int) as
                                                      usize] as usize] as
        ...
        if (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
            ...
            (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                  ...
                                  usize] =
                ((*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                        16 as libc::c_int + 60 as libc::c_int)
                                       as usize] as libc::c_int +
                     (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                            16 as libc::c_int +
