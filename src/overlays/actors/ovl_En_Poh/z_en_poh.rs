...
extern "C" {
    ...
    fn Actor_WorldDistXZToPoint(actor: *mut Actor, refPoint: *mut Vec3f)
     -> f32_0;
    #[no_mangle]
    fn Player_IsFacingActor(actor: *mut Actor, angle: s16,
                            globalCtx: *mut GlobalContext) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gPoeAttackAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFleeAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeFloatAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeAppearAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeDisappearAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeBurnDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeLanternDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeSoulDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeSkel: SkeletonHeader;
    #[no_mangle]
    static mut gPoeComposerAttackAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerFleeAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerFloatAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerAppearAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerDisappearAnim: AnimationHeader;
    #[no_mangle]
    static mut gPoeComposerSoulDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerLanternBottomDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerLanternTopDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerLanternDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerFlatHeadDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerBurnDL: [Gfx; 0];
    #[no_mangle]
    static mut gPoeComposerSkel: FlexSkeletonHeader;
}
...
pub struct EnPoh {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnPohActionFunc,
    pub unk_194: u8_0,
    pub unk_195: u8_0,
    pub objectIdx: s8,
    pub infoIdx: u8_0,
    pub unk_198: s16,
    pub visibilityTimer: s16,
    pub unk_19C: s16,
    pub jointTable: [Vec3s; 21],
    pub morphTable: [Vec3s; 21],
    pub lightColor: Color_RGBA8,
    pub envColor: Color_RGBA8,
    pub info: *mut EnPohInfo,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
    pub colliderCyl: ColliderCylinder,
    pub colliderSph: ColliderJntSph,
    pub colliderSphItem: ColliderJntSphElement,
    pub unk_368: MtxF,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnPohInfo {
    pub primColor: Color_RGB8,
    pub lightColor: Color_RGB8,
    pub unk_6: u8_0,
    pub unk_7: u8_0,
    pub unk_8: s8,
    pub idleAnim: *mut AnimationHeader,
    pub idleAnim2: *mut AnimationHeader,
    pub damageAnim: *mut AnimationHeader,
    pub fleeAnim: *mut AnimationHeader,
    pub lanternDisplayList: *mut Gfx,
    pub burnDisplayList: *mut Gfx,
    pub soulDisplayList: *mut Gfx,
}
pub type EnPohActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const EN_POH_FLAT: C2RustUnnamed_26 = 3;
pub const EN_POH_SHARP: C2RustUnnamed_26 = 2;
pub const EN_POH_RUPEE: C2RustUnnamed_26 = 1;
pub const EN_POH_NORMAL: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const EN_POH_INFO_COMPOSER: C2RustUnnamed_27 = 1;
pub const EN_POH_INFO_NORMAL: C2RustUnnamed_27 = 0;
static mut D_80AE1A50: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut En_Poh_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_POH as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnPoh>() as libc::c_ulong,
                          init:
...
static mut D_80AE1AA0: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
    ...
    unsafe {
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   elements: D_80AE1AA0.as_ptr() as *mut _,};
            init
        }
    };
...
static mut sPoeInfo: [EnPohInfo; 2] =
    unsafe {
        [{
             let mut init =
                 EnPohInfo{primColor:
                           ...
                           unk_6: 18 as libc::c_int as u8_0,
                           unk_7: 5 as libc::c_int as u8_0,
                           unk_8: 248 as libc::c_int as s8,
                           idleAnim:
                               &gPoeDisappearAnim as *const AnimationHeader as
                                   *mut AnimationHeader,
                           idleAnim2:
                               &gPoeFloatAnim as *const AnimationHeader as
                                   *mut AnimationHeader,
                           damageAnim:
                               &gPoeDamagedAnim as *const AnimationHeader as
                                   *mut AnimationHeader,
                           fleeAnim:
                               &gPoeFleeAnim as *const AnimationHeader as
                                   *mut AnimationHeader,
                           lanternDisplayList:
                               gPoeLanternDL.as_ptr() as *mut _,
                           burnDisplayList: gPoeBurnDL.as_ptr() as *mut _,
                           soulDisplayList: gPoeSoulDL.as_ptr() as *mut _,};
             init
         },
         {
             let mut init =
                 EnPohInfo{primColor:
                           ...
                           unk_6: 9 as libc::c_int as u8_0,
                           unk_7: 1 as libc::c_int as u8_0,
                           unk_8: 244 as libc::c_int as s8,
                           idleAnim:
                               &gPoeComposerDisappearAnim as
                                   *const AnimationHeader as
                                   *mut AnimationHeader,
                           idleAnim2:
                               &gPoeComposerFloatAnim as
                                   *const AnimationHeader as
                                   *mut AnimationHeader,
                           damageAnim:
                               &gPoeComposerDamagedAnim as
                                   *const AnimationHeader as
                                   *mut AnimationHeader,
                           fleeAnim:
                               &gPoeComposerFleeAnim as *const AnimationHeader
                                   as *mut AnimationHeader,
                           lanternDisplayList:
                               gPoeComposerLanternDL.as_ptr() as *mut _,
                           burnDisplayList:
                               gPoeComposerBurnDL.as_ptr() as *mut _,
                           soulDisplayList:
                               gPoeComposerSoulDL.as_ptr() as *mut _,};
             init
         }]
    };
static mut D_80AE1B4C: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 75 as libc::c_int as u8_0,
                        g: 20 as libc::c_int as u8_0,
                        b: 25 as libc::c_int as u8_0,
                        a: 255 as libc::c_int as u8_0,};
        init
    };
static mut D_80AE1B50: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 80 as libc::c_int as u8_0,
                        g: 110 as libc::c_int as u8_0,
                        b: 90 as libc::c_int as u8_0,
                        a: 255 as libc::c_int as u8_0,};
        init
    };
static mut D_80AE1B54: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 90 as libc::c_int as u8_0,
                        g: 85 as libc::c_int as u8_0,
                        b: 50 as libc::c_int as u8_0,
                        a: 255 as libc::c_int as u8_0,};
        init
    };
static mut D_80AE1B58: Color_RGBA8 =
    {
        let mut init =
...
static mut D_80AE1B60: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 3.0f32, z: 0.0f32,}; init };
static mut D_80AE1B6C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut collectible: *mut EnItem00 = 0 as *mut EnItem00;
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).colliderSph,
                       ...
                       &mut (*this).colliderSphItem);
    (*(*this).colliderSph.elements.offset(0 as libc::c_int as
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    (*this).unk_194 = 0 as libc::c_int as u8_0;
    (*this).unk_195 = 32 as libc::c_int as u8_0;
    (*this).visibilityTimer =
        Rand_S16Offset(700 as libc::c_int as s16, 300 as libc::c_int as s16);
    (*this).lightNode =
    ...
    if (*this).actor.params as libc::c_int >= 4 as libc::c_int {
        (*this).actor.params = EN_POH_NORMAL as libc::c_int as s16
    }
    if (*this).actor.params as libc::c_int == EN_POH_RUPEE as libc::c_int {
        D_80AE1A50 += 1;
        if D_80AE1A50 as libc::c_int >= 3 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        } else {
            collectible =
                Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                                     (0x4000 as libc::c_int |
                                          ITEM00_RUPEE_BLUE as libc::c_int) as
                                         s16);
            if !collectible.is_null() {
                (*collectible).actor.speedXZ = 0.0f32
            }
        }
    } else if (*this).actor.params as libc::c_int ==
                  EN_POH_FLAT as libc::c_int {
        if Flags_GetSwitch(globalCtx, 0x28 as libc::c_int) != 0 ||
               Flags_GetSwitch(globalCtx, 0x9 as libc::c_int) != 0 {
            Actor_Kill(&mut (*this).actor);
        } else { Flags_SetSwitch(globalCtx, 0x28 as libc::c_int); }
    } else if (*this).actor.params as libc::c_int ==
                  EN_POH_SHARP as libc::c_int {
        if Flags_GetSwitch(globalCtx, 0x29 as libc::c_int) != 0 ||
               Flags_GetSwitch(globalCtx, 0x9 as libc::c_int) != 0 {
            Actor_Kill(&mut (*this).actor);
        } else { Flags_SetSwitch(globalCtx, 0x29 as libc::c_int); }
    }
    if ((*this).actor.params as libc::c_int) < EN_POH_SHARP as libc::c_int {
        (*this).objectIdx =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_POH as libc::c_int as s16) as s8;
        (*this).infoIdx = EN_POH_INFO_NORMAL as libc::c_int as u8_0;
        (*this).actor.naviEnemyId = 0x44 as libc::c_int as u8_0
    } else {
        (*this).objectIdx =
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_PO_COMPOSER as libc::c_int as s16) as s8;
        (*this).infoIdx = EN_POH_INFO_COMPOSER as libc::c_int as u8_0;
        (*this).actor.naviEnemyId = 0x43 as libc::c_int as u8_0
    }
    (*this).info =
        &mut *sPoeInfo.as_mut_ptr().offset((*this).infoIdx as isize) as
            *mut EnPohInfo;
    if ((*this).objectIdx as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADE114(mut this: *mut EnPoh) {
    Animation_PlayLoop(&mut (*this).skelAnime, (*(*this).info).idleAnim);
    (*this).unk_198 =
        Rand_S16Offset(2 as libc::c_int as s16, 3 as libc::c_int as s16);
    (*this).actionFunc =
        Some(func_80ADEAC4 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupIdle(mut this: *mut EnPoh) {
    Animation_PlayLoop(&mut (*this).skelAnime, (*(*this).info).idleAnim2);
    (*this).unk_198 =
        Rand_S16Offset(15 as libc::c_int as s16, 3 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnPoh_Idle as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADE1BC(mut this: *mut EnPoh) {
    Animation_PlayLoop(&mut (*this).skelAnime, (*(*this).info).idleAnim2);
    (*this).actionFunc =
        Some(func_80ADEC9C as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
    (*this).unk_198 = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 2.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupAttack(mut this: *mut EnPoh) {
    if (*this).infoIdx as libc::c_int == EN_POH_INFO_NORMAL as libc::c_int {
        Animation_MorphToLoop(&mut (*this).skelAnime, &mut gPoeAttackAnim,
                              -6.0f32);
    } else {
        Animation_PlayLoop(&mut (*this).skelAnime,
                           &mut gPoeComposerAttackAnim);
    }
    (*this).unk_198 = 12 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ec as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoh_Attack as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE28C(mut this: *mut EnPoh) {
    if (*this).infoIdx as libc::c_int == EN_POH_INFO_NORMAL as libc::c_int {
        Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                  &mut gPoeDamagedAnim, -6.0f32);
    } else {
        Animation_PlayOnce(&mut (*this).skelAnime,
                           &mut gPoeComposerDamagedAnim);
    }
    if (*(*this).colliderCyl.info.acHitInfo).toucher.dmgFlags &
    ...
    (*this).actionFunc =
        Some(func_80ADEECC as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE368(mut this: *mut EnPoh) {
    Animation_MorphToLoop(&mut (*this).skelAnime, (*(*this).info).fleeAnim,
                          -5.0f32);
    (*this).actor.speedXZ = 5.0f32;
    (*this).actor.world.rot.y =
    ...
    (*this).colliderCyl.base.acFlags =
        ((*this).colliderCyl.base.acFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).unk_198 = 200 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_80ADF894 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupInitialAction(mut this: *mut EnPoh) {
    ...
    if (*this).infoIdx as libc::c_int == EN_POH_INFO_NORMAL as libc::c_int {
        Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                                   &mut gPoeAppearAnim, 0.0f32);
        (*this).actionFunc =
            Some(func_80ADEF38 as
                     unsafe extern "C" fn(_: *mut EnPoh,
                                          _: *mut GlobalContext) -> ())
    } else {
        Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                                   &mut gPoeComposerAppearAnim, 1.0f32);
        (*this).actor.world.pos.y = (*this).actor.home.pos.y + 20.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ec as libc::c_int as u16_0);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3873 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnPoh_ComposerAppear as
                     unsafe extern "C" fn(_: *mut EnPoh,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE48C(mut this: *mut EnPoh) {
    (*this).actor.speedXZ = 0.0f32;
    ...
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(func_80ADF15C as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE4C8(mut this: *mut EnPoh) {
    Animation_PlayOnce(&mut (*this).skelAnime, (*(*this).info).idleAnim2);
    (*this).actionFunc =
        Some(func_80ADF574 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
    (*this).actor.speedXZ = -5.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE514(mut this: *mut EnPoh) {
    Animation_PlayLoop(&mut (*this).skelAnime, (*(*this).info).idleAnim);
    (*this).unk_19C =
        ((*this).actor.world.rot.y as libc::c_int + 0x8000 as libc::c_int) as
            s16;
    (*this).actionFunc =
        Some(func_80ADF5E0 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupDisappear(mut this: *mut EnPoh) {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ec as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoh_Disappear as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupAppear(mut this: *mut EnPoh) {
    (*this).unk_194 = 0 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3873 as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x38ec as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnPoh_Appear as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_SetupDeath(mut this: *mut EnPoh,
                                          mut globalCtx: *mut GlobalContext) {
    (*this).actor.update =
        Some(EnPoh_UpdateDead as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actor.draw =
        Some(EnPoh_DrawSoul as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    ...
    if (*this).infoIdx as libc::c_int != EN_POH_INFO_COMPOSER as libc::c_int {
        (*this).actor.shape.rot.x = -(0x8000 as libc::c_int) as s16
    }
    Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                         &mut (*this).actor, 8 as libc::c_int as u8_0);
    (*this).unk_198 = 60 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnPoh_Death as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADE6D4(mut this: *mut EnPoh) {
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              ...
                              0 as libc::c_int as u8_0,
                              0 as libc::c_int as s16);
    (*this).visibilityTimer = 0 as libc::c_int as s16;
    ...
    if (*this).actor.params as libc::c_int >= EN_POH_SHARP as libc::c_int {
        (*this).lightColor.g = 200 as libc::c_int as u8_0;
        (*this).lightColor.b = 0 as libc::c_int as u8_0
    } else {
        (*this).lightColor.g = 0 as libc::c_int as u8_0;
        (*this).lightColor.b = 200 as libc::c_int as u8_0
    }
    ...
    (*this).actionFunc =
        Some(func_80ADFE28 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Talk(mut this: *mut EnPoh,
                                    mut globalCtx: *mut GlobalContext) {
    (*this).actor.home.pos.y = (*this).actor.world.pos.y;
    Actor_SetFocus(&mut (*this).actor, -10.0f32);
    (*this).colliderCyl.dim.radius = 13 as libc::c_int as s16;
    (*this).colliderCyl.dim.height = 30 as libc::c_int as s16;
    (*this).colliderCyl.dim.yShift = 0 as libc::c_int as s16;
    (*this).colliderCyl.dim.pos.x = (*this).actor.world.pos.x as s16;
    (*this).colliderCyl.dim.pos.y =
        ((*this).actor.world.pos.y - 20.0f32) as s16;
    (*this).colliderCyl.dim.pos.z = (*this).actor.world.pos.z as s16;
    (*this).colliderCyl.base.ocFlags1 =
        ((1 as libc::c_int) << 0 as libc::c_int |
             (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
    if (*this).actor.params as libc::c_int == EN_POH_FLAT as libc::c_int ||
           (*this).actor.params as libc::c_int == EN_POH_SHARP as libc::c_int
       {
        if gBitFlags[QUEST_SONG_SUN as libc::c_int as usize] &
               gSaveContext.inventory.questItems != 0 {
            (*this).actor.textId = 0x5000 as libc::c_int as u16_0
        } else if Flags_GetSwitch(globalCtx, 0xa as libc::c_int) == 0 &&
                      Flags_GetSwitch(globalCtx, 0xb as libc::c_int) == 0 {
            (*this).actor.textId = 0x500f as libc::c_int as u16_0
        } else if (*this).actor.params as libc::c_int ==
                      EN_POH_FLAT as libc::c_int &&
                      Flags_GetSwitch(globalCtx, 0xa as libc::c_int) != 0 ||
                      (*this).actor.params as libc::c_int ==
                          EN_POH_SHARP as libc::c_int &&
                          Flags_GetSwitch(globalCtx, 0xb as libc::c_int) != 0
         {
            (*this).actor.textId = 0x5013 as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x5012 as libc::c_int as u16_0 }
    } else { (*this).actor.textId = 0x5005 as libc::c_int as u16_0 }
    (*this).unk_198 = 200 as libc::c_int as s16;
    (*this).unk_195 = 32 as libc::c_int as u8_0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(func_80ADFE80 as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE950(mut this: *mut EnPoh, mut arg1: s32) {
    if arg1 != 0 {
        Audio_StopSfxByPosAndId(&mut (*this).actor.projectedPos,
                                (0x39e8 as libc::c_int - 0x800 as libc::c_int)
                                    as u16_0);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38ec as libc::c_int as u16_0);
    }
    (*this).actionFunc =
        Some(func_80AE009C as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE998(mut this: *mut EnPoh) {
    (*this).actionFunc =
        Some(EnPoh_TalkRegular as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
    (*this).actor.home.pos.y = (*this).actor.world.pos.y - 15.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADE9BC(mut this: *mut EnPoh) {
    (*this).actionFunc =
        Some(EnPoh_TalkComposer as
                 unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_MoveTowardsPlayerHeight(mut this: *mut EnPoh,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Math_StepToF(&mut (*this).actor.world.pos.y, (*player).actor.world.pos.y,
                 1.0f32);
    (*this).actor.world.pos.y +=
        2.5f32 *
            Math_SinS(((*this).unk_195 as libc::c_int * 0x800 as libc::c_int)
                          as s16);
    if (*this).unk_195 as libc::c_int != 0 as libc::c_int {
        (*this).unk_195 =
            ((*this).unk_195 as libc::c_int - 1 as libc::c_int) as u8_0
    }
    if (*this).unk_195 as libc::c_int == 0 as libc::c_int {
        (*this).unk_195 = 32 as libc::c_int as u8_0
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADEA5C(mut this: *mut EnPoh) {
    ...
    Math_ScaledStepToS(&mut (*this).actor.world.rot.y, (*this).unk_19C,
                       0x71c as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADEAC4(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 &&
           (*this).unk_198 as libc::c_int != 0 as libc::c_int {
        (*this).unk_198 -= 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Idle(mut this: *mut EnPoh,
                                    mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
    if (*this).actor.xzDistToPlayer < 200.0f32 &&
           ((*this).unk_198 as libc::c_int) < 19 as libc::c_int {
        func_80ADE1BC(this);
    } else if (*this).unk_198 as libc::c_int == 0 as libc::c_int {
        if Rand_ZeroOne() < 0.1f32 {
            func_80ADE514(this);
        } else { func_80ADE114(this); }
    }
    if (*this).lightColor.a as libc::c_int == 255 as libc::c_int {
        func_8002F974(&mut (*this).actor,
                      (0x3871 as libc::c_int - 0x800 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADEC9C(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut facingDiff: s16 = 0;
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if facingDiff as libc::c_int >= 0x3001 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                           ((*this).actor.yawTowardsPlayer as libc::c_int +
                                0x3000 as libc::c_int) as s16,
                           0x71c as libc::c_int as s16);
    } else if (facingDiff as libc::c_int) < -(0x3000 as libc::c_int) {
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                           ((*this).actor.yawTowardsPlayer as libc::c_int -
                                0x3000 as libc::c_int) as s16,
                           0x71c as libc::c_int as s16);
    ...
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
    if (*this).actor.xzDistToPlayer > 280.0f32 {
        EnPoh_SetupIdle(this);
    } else if (*this).unk_198 as libc::c_int == 0 as libc::c_int &&
                  (*this).actor.xzDistToPlayer < 140.0f32 &&
                  Player_IsFacingActor(&mut (*this).actor,
                                       0x2aaa as libc::c_int as s16,
                                       globalCtx) == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Attack(mut this: *mut EnPoh,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3870 as libc::c_int as u16_0);
        if (*this).unk_198 as libc::c_int != 0 as libc::c_int {
            (*this).unk_198 -= 1
        }
    }
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
    if (*this).unk_198 as libc::c_int >= 10 as libc::c_int {
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           0xe38 as libc::c_int as s16);
    } else if (*this).unk_198 as libc::c_int == 9 as libc::c_int {
        (*this).actor.speedXZ = 5.0f32;
        (*this).skelAnime.playSpeed = 2.0f32
    } else if (*this).unk_198 as libc::c_int == 0 as libc::c_int {
        EnPoh_SetupIdle(this);
        (*this).unk_198 = 23 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADEECC(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int
           {
            func_80ADE368(this);
        } else { func_80ADE48C(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADEF38(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).lightColor.a = 255 as libc::c_int as u8_0;
        (*this).visibilityTimer =
            Rand_S16Offset(700 as libc::c_int as s16,
    ...
    if (*this).skelAnime.playSpeed < 0.5f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_ComposerAppear(mut this: *mut EnPoh,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).lightColor.a = 255 as libc::c_int as u8_0;
        ...
        (*this).lightColor.a =
            if ((*this).skelAnime.curFrame * 25.5f32) as s32 >
                   255 as libc::c_int {
                255 as libc::c_int
            } else { ((*this).skelAnime.curFrame * 25.5f32) as s32 } as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADF15C(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut multiplier: f32_0 = 0.;
    let mut newScale: f32_0 = 0.;
    let mut pad: s32 = 0;
    let mut pad1: s32 = 0;
    (*this).unk_198 += 1;
    if ((*this).unk_198 as libc::c_int) < 8 as libc::c_int {
        if ((*this).unk_198 as libc::c_int) < 5 as libc::c_int {
            vec.y =
                Math_SinS(((*this).unk_198 as libc::c_int *
                               0x1000 as libc::c_int - 0x4000 as libc::c_int)
                              as s16) * 23.0f32 +
                    ((*this).actor.world.pos.y + 40.0f32);
            multiplier =
                Math_CosS(((*this).unk_198 as libc::c_int *
                               0x1000 as libc::c_int - 0x4000 as libc::c_int)
                              as s16) * 23.0f32;
            vec.x =
                Math_SinS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                    ...
                    * multiplier + (*this).actor.world.pos.x;
            vec.z =
                Math_CosS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           as
                                                                           usize])
                               as libc::c_int + 0x4800 as libc::c_int) as s16)
                    * multiplier + (*this).actor.world.pos.z
        } else {
            vec.y =
                (*this).actor.world.pos.y + 40.0f32 +
                    15.0f32 *
                        ((*this).unk_198 as libc::c_int - 5 as libc::c_int) as
                            libc::c_float;
            vec.x =
                Math_SinS((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                           as
        ...
        EffectSsDeadDb_Spawn(globalCtx, &mut vec, &mut D_80AE1B60,
                             &mut D_80AE1B6C,
                             ((*this).unk_198 as libc::c_int *
    ...
    } else if (*this).unk_198 as libc::c_int == 28 as libc::c_int {
        EnPoh_SetupDeath(this, globalCtx);
    } else if (*this).unk_198 as libc::c_int >= 19 as libc::c_int {
        newScale =
            (28 as libc::c_int - (*this).unk_198 as libc::c_int) as
    ...
    if (*this).unk_198 as libc::c_int == 18 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3877 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADF574(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        EnPoh_SetupIdle(this);
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x1000 as libc::c_int)
                as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADF5E0(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, (*this).unk_19C,
                          1820 as libc::c_int as s16) != 0 as libc::c_int {
        EnPoh_SetupIdle(this);
    }
    if (*this).actor.xzDistToPlayer < 200.0f32 { func_80ADE1BC(this); }
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Disappear(mut this: *mut EnPoh,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).unk_194 as libc::c_int != 0 as libc::c_int {
        (*this).unk_194 = (*this).unk_194.wrapping_sub(1)
    }
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int + 0x1000 as libc::c_int) as
            s16;
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
    (*this).lightColor.a =
        ((*this).unk_194 as libc::c_int as libc::c_float * 7.96875f32) as
            u8_0;
    if (*this).unk_194 as libc::c_int == 0 as libc::c_int {
        (*this).visibilityTimer =
            Rand_S16Offset(100 as libc::c_int as s16,
                           50 as libc::c_int as s16);
        EnPoh_SetupIdle(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Appear(mut this: *mut EnPoh,
                                      mut globalCtx: *mut GlobalContext) {
    (*this).unk_194 = (*this).unk_194.wrapping_add(1);
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int - 0x1000 as libc::c_int) as
            s16;
    EnPoh_MoveTowardsPlayerHeight(this, globalCtx);
    (*this).lightColor.a =
        ((*this).unk_194 as libc::c_int as libc::c_float * 7.96875f32) as
            u8_0;
    if (*this).unk_194 as libc::c_int == 32 as libc::c_int {
        (*this).visibilityTimer =
            Rand_S16Offset(700 as libc::c_int as s16,
                           300 as libc::c_int as s16);
        (*this).unk_194 = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADF894(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    let mut multiplier: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    multiplier =
        Math_SinS(((*this).unk_195 as libc::c_int * 0x800 as libc::c_int) as
                      s16) * 3.0f32;
    (*this).actor.world.pos.x -=
        multiplier * Math_CosS((*this).actor.shape.rot.y);
    (*this).actor.world.pos.z +=
        multiplier * Math_SinS((*this).actor.shape.rot.y);
    Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                       ((*this).actor.yawTowardsPlayer as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Death(mut this: *mut EnPoh,
                                     mut globalCtx: *mut GlobalContext) {
    let mut objId: s32 = 0;
    if (*this).unk_198 as libc::c_int != 0 as libc::c_int {
        (*this).unk_198 -= 1
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        objId =
            if (*this).infoIdx as libc::c_int ==
                   EN_POH_INFO_COMPOSER as libc::c_int {
                OBJECT_PO_COMPOSER as libc::c_int
            } else { OBJECT_POH as libc::c_int };
        EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos,
                                 6.0f32, 0 as libc::c_int as s16,
                                 1 as libc::c_int as s16,
                                 1 as libc::c_int as s16,
                                 15 as libc::c_int as s16, objId as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADFA90(mut this: *mut EnPoh, mut arg1: s32) {
    let mut multiplier: f32_0 = 0.;
    (*this).lightColor.a =
    ...
    if arg1 < 0 as libc::c_int {
        ...
        (*this).actor.scale.z =
            0.0056000002f32 * multiplier + 0.0014000001f32;
        ...
        (*this).actor.scale.z =
            (*this).lightColor.a as libc::c_int as libc::c_float *
                (0.007f32 / 0xff as libc::c_int as libc::c_float);
    ...
    (*this).lightColor.r =
        ((*(*this).info).lightColor.r as libc::c_int as libc::c_float *
             multiplier) as u8_0;
    (*this).lightColor.g =
        ((*(*this).info).lightColor.g as libc::c_int as libc::c_float *
             multiplier) as u8_0;
    (*this).lightColor.b =
        ((*(*this).info).lightColor.b as libc::c_int as libc::c_float *
             multiplier) as u8_0;
    Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                              (*this).actor.world.pos.x as s16,
                              (*this).actor.world.pos.y as s16,
                              (*this).actor.world.pos.z as s16,
                              (*(*this).info).lightColor.r,
                              (*(*this).info).lightColor.g,
                              (*(*this).info).lightColor.b,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ADFE28(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.home.pos.y += 2.0f32;
    func_80ADFA90(this, 20 as libc::c_int);
    if (*this).lightColor.a as libc::c_int == 255 as libc::c_int {
        EnPoh_Talk(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ADFE80(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_198 as libc::c_int != 0 as libc::c_int {
        (*this).unk_198 -= 1
    }
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.params as libc::c_int >= EN_POH_SHARP as libc::c_int
           {
            func_80ADE9BC(this);
        } else { func_80ADE998(this); }
        return
    }
    if (*this).unk_198 as libc::c_int == 0 as libc::c_int {
        func_80ADE950(this, 1 as libc::c_int);
        (*this).actor.flags &=
            !((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        return
    }
    if (*this).colliderCyl.base.ocFlags1 as libc::c_int &
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE009C(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
    func_80ADFA90(this, -(13 as libc::c_int));
    if (*this).lightColor.a as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_TalkRegular(mut this: *mut EnPoh,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        func_80ADE950(this, 0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_TalkComposer(mut this: *mut EnPoh,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    func_8002F974(&mut (*this).actor,
                  (0x39e8 as libc::c_int - 0x800 as libc::c_int) as u16_0);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_CHOICE as libc::c_int {
        if Message_ShouldAdvance(globalCtx) != 0 {
            if (*globalCtx).msgCtx.choiceIndex as libc::c_int ==
                   0 as libc::c_int {
                if Flags_GetSwitch(globalCtx, 0xb as libc::c_int) == 0 &&
                       Flags_GetSwitch(globalCtx, 0xa as libc::c_int) == 0 {
                    (*this).actor.textId = 0x5010 as libc::c_int as u16_0
                } else {
                    (*this).actor.textId = 0x5014 as libc::c_int as u16_0
                }
                Message_ContinueTextbox(globalCtx, (*this).actor.textId);
            } else {
                if (*this).actor.params as libc::c_int ==
                       EN_POH_SHARP as libc::c_int {
                    Flags_SetSwitch(globalCtx, 0xb as libc::c_int);
                } else { Flags_SetSwitch(globalCtx, 0xa as libc::c_int); }
                func_80ADE950(this, 1 as libc::c_int);
            }
        }
    } else if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.textId as libc::c_int == 0x5000 as libc::c_int {
            Flags_SetSwitch(globalCtx, 9 as libc::c_int);
        }
        func_80ADE950(this, 1 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE032C(mut this: *mut EnPoh,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_UpdateVisibility(mut this: *mut EnPoh) {
    if (*this).actionFunc !=
           Some(EnPoh_Appear as
                    unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                        -> ()) &&
           ...
           (*this).actionFunc !=
               Some(EnPoh_ComposerAppear as
                        unsafe extern "C" fn(_: *mut EnPoh,
                                             _: *mut GlobalContext) -> ()) {
        if (*this).visibilityTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).lightColor.a as libc::c_int == 255 as libc::c_int {
            if (*this).actor.isTargeted != 0 {
                (*this).unk_194 = (*this).unk_194.wrapping_add(1);
                (*this).unk_194 =
                    if (*this).unk_194 as libc::c_int > 20 as libc::c_int {
                        20 as libc::c_int
                    } else { (*this).unk_194 as libc::c_int } as u8_0
            } else { (*this).unk_194 = 0 as libc::c_int as u8_0 }
            if ((*this).unk_194 as libc::c_int == 20 as libc::c_int ||
                    (*this).visibilityTimer as libc::c_int ==
                        0 as libc::c_int) &&
                   ((*this).actionFunc ==
                        Some(func_80ADEAC4 as
                                 unsafe extern "C" fn(_: *mut EnPoh,
        ...
        } else if (*this).lightColor.a as libc::c_int == 0 as libc::c_int &&
                      (*this).visibilityTimer as libc::c_int ==
                          0 as libc::c_int &&
                      ((*this).actionFunc ==
                           Some(func_80ADEAC4 as
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, (*this).objectIdx as s32)
           != 0 as libc::c_int {
        (*this).actor.objBankIndex = (*this).objectIdx;
        (*this).actor.update =
            Some(EnPoh_UpdateLiving as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        Actor_SetObjectDependency(globalCtx, &mut (*this).actor);
        if (*this).infoIdx as libc::c_int == EN_POH_INFO_NORMAL as libc::c_int
           {
            SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gPoeSkel,
                           &mut gPoeFloatAnim,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           21 as libc::c_int);
            (*this).actor.draw =
                Some(EnPoh_DrawRegular as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ())
        } else {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut gPoeComposerSkel,
                               &mut gPoeComposerFloatAnim,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               12 as libc::c_int);
            (*this).actor.draw =
                Some(EnPoh_DrawComposer as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*(*this).colliderSph.elements.offset(0 as libc::c_int as
                                                      isize)).dim.limb =
            ...
            *fresh0 = (*fresh0 as libc::c_int * -(1 as libc::c_int)) as s16;
            ...
            (*this).colliderCyl.dim.radius = 20 as libc::c_int as s16;
            (*this).colliderCyl.dim.height = 55 as libc::c_int as s16;
            (*this).colliderCyl.dim.yShift = 15 as libc::c_int as s16
        }
        (*this).actor.flags &=
            !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE067C(mut this: *mut EnPoh) {
    ...
    if (*this).actionFunc ==
        ...
        (*this).lightColor.g =
            if (((*this).lightColor.g as libc::c_int - 5 as libc::c_int) as
                    s16 as libc::c_int) < 50 as libc::c_int {
                50 as libc::c_int
            } else {
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        ...
        if (*this).lightColor.b as libc::c_int >= 211 as libc::c_int {
            temp_var =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE089C(mut this: *mut EnPoh) {
    ...
    if ((*this).actionFunc ==
        ...
        (*this).envColor.g = (*this).envColor.b;
        (*this).envColor.r = (*this).envColor.g;
        (*this).envColor.a =
        ...
        (*this).envColor.b =
            ((rand * 160.0f32) as s16 as libc::c_int + 95 as libc::c_int) as
                u8_0;
        (*this).envColor.a = 200 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_UpdateLiving(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    let mut pad: s32 = 0;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp38: s32 = 0;
    if (*this).colliderSph.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
    ...
    if (*this).actionFunc ==
           Some(EnPoh_Attack as
                    unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                        -> ()) &&
           ((*this).unk_198 as libc::c_int) < 10 as libc::c_int {
        (*this).actor.flags |=
    ...
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).colliderCyl);
    if (*this).colliderCyl.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 0 as libc::c_int != 0 &&
           (*this).lightColor.a as libc::c_int == 255 as libc::c_int {
        ...
        if (*this).actionFunc ==
            ...
            (*this).actor.shape.rot.y =
                ((*this).actor.world.rot.y as libc::c_int +
                     0x8000 as libc::c_int) as s16
        } else { (*this).actor.shape.rot.y = (*this).actor.world.rot.y }
    }
    vec.x = (*this).actor.world.pos.x;
    vec.y = (*this).actor.world.pos.y + 20.0f32;
    vec.z = (*this).actor.world.pos.z;
    (*this).actor.floorHeight =
        BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                    &mut (*this).actor.floorPoly, &mut sp38,
                                    &mut (*this).actor, &mut vec);
    func_80AE089C(this);
    (*this).actor.shape.shadowAlpha = (*this).lightColor.a;
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    if (*this).lightColor.a as libc::c_int == 0 as libc::c_int ||
           limbIndex == (*(*this).info).unk_6 as libc::c_int ||
           (*this).actionFunc ==
               Some(func_80ADF15C as
                        unsafe extern "C" fn(_: *mut EnPoh,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).unk_198 as libc::c_int >= 2 as libc::c_int {
        *dList = 0 as *mut Gfx
    } else if (*this).actor.params as libc::c_int ==
                  EN_POH_FLAT as libc::c_int &&
                  limbIndex == 0xa as libc::c_int {
        // Replace Sharp's head with Flat's
        *dList = gPoeComposerFlatHeadDL.as_mut_ptr()
    }
    if limbIndex == 0x13 as libc::c_int &&
           (*this).infoIdx as libc::c_int == EN_POH_INFO_NORMAL as libc::c_int
       {
        let fresh1 = *gfxP;
        *gfxP = (*gfxP).offset(1);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void,
                                            mut gfxP: *mut *mut Gfx) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    Collider_UpdateSpheres(limbIndex, &mut (*this).colliderSph);
    if (*this).actionFunc ==
           Some(func_80ADF15C as
                    unsafe extern "C" fn(_: *mut EnPoh, _: *mut GlobalContext)
                        -> ()) &&
           (*this).unk_198 as libc::c_int >= 2 as libc::c_int &&
           limbIndex == (*(*this).info).unk_7 as libc::c_int {
        let fresh3 = *gfxP;
        *gfxP = (*gfxP).offset(1);
        ...
        (*_g).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_poh.c\x00" as *const u8 as
                              *const libc::c_char as *mut libc::c_char,
                          2460 as libc::c_int) as libc::c_uint;
        let fresh4 = *gfxP;
        *gfxP = (*gfxP).offset(1);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = (*(*this).info).burnDisplayList as libc::c_uint
    }
    if limbIndex == (*(*this).info).unk_6 as libc::c_int {
        if (*this).actionFunc ==
               Some(func_80ADF15C as
                        unsafe extern "C" fn(_: *mut EnPoh,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).unk_198 as libc::c_int >= 19 as libc::c_int &&
               0.0f32 != (*this).actor.scale.x {
        ...
        Matrix_Get(&mut (*this).unk_368);
        if (*this).actionFunc ==
               Some(func_80ADF15C as
                        unsafe extern "C" fn(_: *mut EnPoh,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).unk_198 as libc::c_int == 27 as libc::c_int {
            (*this).actor.world.pos.x = (*this).unk_368.c2rust_unnamed.xw;
            (*this).actor.world.pos.y = (*this).unk_368.c2rust_unnamed.yw;
            (*this).actor.world.pos.z = (*this).unk_368.c2rust_unnamed.zw
        }
        Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                                (*(*this).colliderSph.elements.offset(0 as
                                                                          libc::c_int
                                                                          as
                                                                          isize)).dim.worldSphere.center.x,
                                (*(*this).colliderSph.elements.offset(0 as
                                ...
                                (*this).envColor.r, (*this).envColor.g,
                                (*this).envColor.b,
                                ((*this).envColor.a as libc::c_int as
                                     libc::c_float *
                                     (200.0f32 /
                                          255 as libc::c_int as
                                              libc::c_float)) as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_DrawRegular(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char,
                    2629 as libc::c_int);
    func_80AE067C(this);
    ...
    if (*this).lightColor.a as libc::c_int == 255 as libc::c_int ||
        ...
        (*__gfxCtx).polyOpa.p =
            SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                           ...
                           Some(EnPoh_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
    ...
    (*_g_5).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 2676 as libc::c_int) as
            libc::c_uint;
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = (*(*this).info).lanternDisplayList as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char,
                     2681 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_DrawComposer(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    let mut sp90: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut phi_t0: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    if (*this).actor.params as libc::c_int == EN_POH_SHARP as libc::c_int {
        sp90 = &mut D_80AE1B4C;
        phi_t0 = &mut D_80AE1B54
    } else { sp90 = &mut D_80AE1B50; phi_t0 = &mut D_80AE1B58 }
    if (*this).lightColor.a as libc::c_int == 255 as libc::c_int ||
           (*this).lightColor.a as libc::c_int == 0 as libc::c_int {
        func_80093D18((*globalCtx).state.gfxCtx);
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            Gfx_EnvColor((*globalCtx).state.gfxCtx, (*sp90).r as s32,
                         (*sp90).g as s32, (*sp90).b as s32,
                         (*this).lightColor.a as s32) as libc::c_uint;
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xb as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            Gfx_EnvColor((*globalCtx).state.gfxCtx, (*phi_t0).r as s32,
                         (*phi_t0).g as s32, (*phi_t0).b as s32,
                         (*this).lightColor.a as s32) as libc::c_uint;
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xc as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = D_80116280.as_mut_ptr() as libc::c_uint;
        (*__gfxCtx).polyXlu.p =
            SkelAnime_DrawFlex(globalCtx, (*this).skelAnime.skeleton,
                               (*this).skelAnime.jointTable,
                               (*this).skelAnime.dListCount as s32,
    ...
    (*_g_9).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 2787 as libc::c_int) as
            libc::c_uint;
    ...
    (*_g_10).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_10).words.w1 = (*(*this).info).lanternDisplayList as libc::c_uint;
    let fresh25 = (*__gfxCtx).polyOpa.p;
    (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
    let mut _g_11: *mut Gfx = fresh25;
    (*_g_11).words.w0 =
        (0xde as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_11).words.w1 =
        gPoeComposerLanternBottomDL.as_mut_ptr() as libc::c_uint;
    let fresh26 = (*__gfxCtx).polyOpa.p;
    (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
    let mut _g_12: *mut Gfx = fresh26;
    (*_g_12).words.w0 =
        (0xe7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    ...
    (*_g_14).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_14).words.w1 = gPoeComposerLanternTopDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char,
                     2802 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnPoh_UpdateDead(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).actionFunc !=
...
#[no_mangle]
pub unsafe extern "C" fn EnPoh_DrawSoul(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPoh = thisx as *mut EnPoh;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    if (*this).actionFunc ==
        ...
        (*_g_0).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_poh.c\x00" as *const u8 as
                              *const libc::c_char as *mut libc::c_char,
                          2854 as libc::c_int) as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = (*(*this).info).lanternDisplayList as libc::c_uint;
        if (*this).infoIdx as libc::c_int ==
               EN_POH_INFO_COMPOSER as libc::c_int {
            let mut envColor: *mut Color_RGBA8 =
                if (*this).actor.params as libc::c_int ==
                       EN_POH_SHARP as libc::c_int {
                    &mut D_80AE1B4C
                } else { &mut D_80AE1B50 };
            ...
            (*_g_5).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                gPoeComposerLanternTopDL.as_mut_ptr() as libc::c_uint
        }
    } else {
        func_80093D84((*globalCtx).state.gfxCtx);
        let fresh36 = (*__gfxCtx).polyXlu.p;
        (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
        let mut _g_6: *mut Gfx = fresh36;
        (*_g_6).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
        ...
        (*_g_6).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             (((*this).visibilityTimer as libc::c_int *
                                   (*(*this).info).unk_8 as libc::c_int) as
                                  libc::c_uint).wrapping_rem(512 as
                                                                 libc::c_uint),
                             0x20 as libc::c_int, 0x80 as libc::c_int) as
                libc::c_uint;
        let fresh37 = (*__gfxCtx).polyXlu.p;
        (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
        let mut _g_7: *mut Gfx = fresh37;
        (*_g_7).words.w0 =
            (0xfa as libc::c_int as u32_0 &
                ...
                (0x80 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_7).words.w1 =
            ((*(*this).info).primColor.r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*(*this).info).primColor.g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                ((*(*this).info).primColor.b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).lightColor.a as u32_0 &
        ...
        (*_g_9).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_poh.c\x00" as *const u8 as
                              *const libc::c_char as *mut libc::c_char,
                          2910 as libc::c_int) as libc::c_uint;
        let fresh40 = (*__gfxCtx).polyXlu.p;
        (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
        let mut _g_10: *mut Gfx = fresh40;
        (*_g_10).words.w0 =
            (0xde as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_10).words.w1 = (*(*this).info).soulDisplayList as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_poh.c\x00" as *const u8 as *const libc::c_char,
                     2916 as libc::c_int);
