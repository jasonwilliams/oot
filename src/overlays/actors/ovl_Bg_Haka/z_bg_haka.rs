...
extern "C" {
    ...
    #[no_mangle]
    static mut gGravestoneStoneDL: [Gfx; 0];
    #[no_mangle]
    static mut gGravestoneEarthDL: [Gfx; 0];
    #[no_mangle]
    static mut gGravestoneCol: CollisionHeader;
}
...
pub struct BgHaka {
    ...
    pub actionFunc: BgHakaActionFunc,
}
pub type BgHakaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHaka, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Haka_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_HAKA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHaka>() as
                                  libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn BgHaka_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHaka = thisx as *mut BgHaka;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gGravestoneCol as *mut CollisionHeader as
                                   *mut libc::c_void, &mut colHeader);
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, colHeader);
    (*this).actionFunc =
        Some(func_8087B7E8 as
                 unsafe extern "C" fn(_: *mut BgHaka, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgHaka_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHaka = thisx as *mut BgHaka;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087B758(mut this: *mut BgHaka,
                                       mut player: *mut Player) {
    let mut sp1C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    func_8002DBD0(&mut (*this).dyna.actor, &mut sp1C,
                  &mut (*player).actor.world.pos);
    if fabsf(sp1C.x) < 34.6f32 && sp1C.z > -112.8f32 && sp1C.z < -36.0f32 {
        (*player).stateFlags2 |= 0x200 as libc::c_int as libc::c_uint
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8087B7E8(mut this: *mut BgHaka,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).dyna.unk_150 != 0.0f32 {
        if (*globalCtx).sceneNum as libc::c_int == SCENE_SPOT02 as libc::c_int
            ...
            if Gameplay_InCsMode(globalCtx) == 0 {
                Message_StartTextbox(globalCtx,
                                     0x5073 as libc::c_int as u16_0,
                                     0 as *mut Actor);
                (*this).dyna.actor.params = 100 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(func_8087BAE4 as
                             unsafe extern "C" fn(_: *mut BgHaka,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        } else if 0.0f32 < (*this).dyna.unk_150 ||
                      (*globalCtx).sceneNum as libc::c_int ==
                          SCENE_SPOT06 as libc::c_int &&
                          !(gSaveContext.linkAge == 0 as libc::c_int) &&
                          Flags_GetSwitch(globalCtx, 0x23 as libc::c_int) == 0
         {
            (*this).dyna.unk_150 = 0.0f32;
            (*player).stateFlags2 &= !(0x10 as libc::c_int) as libc::c_uint
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_8087B938(mut this: *mut BgHaka,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut sp38: s32 = 0;
    (*this).dyna.actor.speedXZ += 0.05f32;
    (*this).dyna.actor.speedXZ =
        if (*this).dyna.actor.speedXZ > 1.5f32 {
            1.5f32
        } else { (*this).dyna.actor.speedXZ };
    sp38 =
        Math_StepToF(&mut (*this).dyna.actor.minVelocityY, 60.0f32,
                     (*this).dyna.actor.speedXZ);
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).dyna.actor.world.rot.y) *
            (*this).dyna.actor.minVelocityY + (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).dyna.actor.world.rot.y) *
            (*this).dyna.actor.minVelocityY + (*this).dyna.actor.home.pos.z;
    if sp38 != 0 as libc::c_int {
        ...
        if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int {
            ...
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_POH as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_8087BAAC(mut this: *mut BgHaka,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087BAE4(mut this: *mut BgHaka,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).dyna.actor.params as libc::c_int != 0 as libc::c_int {
        (*this).dyna.actor.params =
            ((*this).dyna.actor.params as libc::c_int - 1 as libc::c_int) as
                s16
    }
    if (*this).dyna.unk_150 != 0.0f32 {
        (*this).dyna.unk_150 = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgHaka_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHaka = thisx as *mut BgHaka;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgHaka_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_haka.c\x00" as *const u8 as *const libc::c_char,
                    401 as libc::c_int);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_bg_haka.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gGravestoneStoneDL.as_mut_ptr() as libc::c_uint;
    Matrix_Translate(0.0f32, 0.0f32, (*thisx).minVelocityY * 10.0f32,
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gGravestoneEarthDL.as_mut_ptr() as libc::c_uint;
