...
extern "C" {
    #[no_mangle]
    fn func_8009435C(gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    fn func_80094678(gfxCtx: *mut GraphicsContext);
    #[no_mangle]
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gDebugCircleTex: [u64_0; 0];
    #[no_mangle]
    static mut gDebugBallTex: [u64_0; 0];
    #[no_mangle]
    static mut gDebugCursorTex: [u64_0; 0];
    #[no_mangle]
    static mut gDebugCrossTex: [u64_0; 0];
    #[no_mangle]
    static mut gDebugArrowDL: [Gfx; 0];
    #[no_mangle]
    static mut gDebugCameraDL: [Gfx; 0];
    #[no_mangle]
    static mut gDebugSpriteDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct DebugDispObjectInfo {
    pub drawType: s16,
    pub drawArg: *mut libc::c_void,
}
// size = 0x8
pub type DebugDispObject_DrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DebugDispObject, _: *mut libc::c_void,
                                _: *mut GlobalContext) -> ()>;
static mut sDebugObjectDrawFuncTable: [DebugDispObject_DrawFunc; 2] =
    unsafe {
        [Some(DebugDisplay_DrawSpriteI8 as
                  unsafe extern "C" fn(_: *mut DebugDispObject,
                                       _: *mut libc::c_void,
                                       _: *mut GlobalContext) -> ()),
         Some(DebugDisplay_DrawPolygon as
                  unsafe extern "C" fn(_: *mut DebugDispObject,
                                       _: *mut libc::c_void,
                                       _: *mut GlobalContext) -> ())]
    };
static mut sDebugObjectInfoTable: [DebugDispObjectInfo; 6] =
    unsafe {
        [{
             let mut init =
                 DebugDispObjectInfo{drawType: 0 as libc::c_int as s16,
                                     drawArg:
                                         gDebugCircleTex.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DebugDispObjectInfo{drawType: 0 as libc::c_int as s16,
                                     drawArg:
                                         gDebugCrossTex.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DebugDispObjectInfo{drawType: 0 as libc::c_int as s16,
                                     drawArg:
                                         gDebugBallTex.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DebugDispObjectInfo{drawType: 0 as libc::c_int as s16,
                                     drawArg:
                                         gDebugCursorTex.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DebugDispObjectInfo{drawType: 1 as libc::c_int as s16,
                                     drawArg:
                                         gDebugArrowDL.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         },
         {
             let mut init =
                 DebugDispObjectInfo{drawType: 1 as libc::c_int as s16,
                                     drawArg:
                                         gDebugCameraDL.as_ptr() as *mut _ as
                                             *mut libc::c_void,};
             init
         }]
    };
static mut sDebugObjectLights: Lights1 =
    {
        let mut init =
            Lights1{a:
                        Ambient{l:
...
static mut sDebugObjectListHead: *mut DebugDispObject =
    0 as *const DebugDispObject as *mut DebugDispObject;
#[no_mangle]
pub unsafe extern "C" fn DebugDisplay_Init() {
    sDebugObjectListHead = 0 as *mut DebugDispObject;
}
#[no_mangle]
pub unsafe extern "C" fn DebugDisplay_AddObject(mut posX: f32_0,
                                                mut posY: f32_0,
                                                mut posZ: f32_0,
                                                ...
                                                mut gfxCtx:
                                                    *mut GraphicsContext)
 -> *mut DebugDispObject {
    let mut prevHead: *mut DebugDispObject = sDebugObjectListHead;
    sDebugObjectListHead =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<DebugDispObject>() as libc::c_ulong
                        as size_t) as *mut DebugDispObject;
    ...
    (*sDebugObjectListHead).type_0 = type_0;
    (*sDebugObjectListHead).next = prevHead;
    return sDebugObjectListHead;
}
#[no_mangle]
pub unsafe extern "C" fn DebugDisplay_DrawObjects(mut globalCtx:
                                                      *mut GlobalContext) {
    let mut dispObj: *mut DebugDispObject = sDebugObjectListHead;
    let mut objInfo: *mut DebugDispObjectInfo = 0 as *mut DebugDispObjectInfo;
    while !dispObj.is_null() {
        objInfo =
            &mut *sDebugObjectInfoTable.as_mut_ptr().offset((*dispObj).type_0
                                                                as isize) as
                *mut DebugDispObjectInfo;
        sDebugObjectDrawFuncTable[(*objInfo).drawType as
                                      usize].expect("non-null function pointer")(dispObj,
                                                                                 (*objInfo).drawArg,
                                                                                 globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DebugDisplay_DrawSpriteI8(mut dispObj:
                                                       *mut DebugDispObject,
                                                   mut texture:
                                                       *mut libc::c_void,
                                                   mut globalCtx:
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_debug_display.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        ((*dispObj).color.r as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*dispObj).color.g as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*dispObj).color.b as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*dispObj).color.a as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    Matrix_Translate((*dispObj).pos.x, (*dispObj).pos.y, (*dispObj).pos.z,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_Scale((*dispObj).scale.x, (*dispObj).scale.y, (*dispObj).scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Mult(&mut (*globalCtx).billboardMtxF,
                MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZYX((*dispObj).rot.x, (*dispObj).rot.y, (*dispObj).rot.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xfd as libc::c_int as u32_0 &
            ...
            ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = texture as libc::c_uint;
    ...
    (*_g_3).words.w1 =
        (7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((if ((16 as libc::c_int * 16 as libc::c_int + 1 as libc::c_int >>
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_8).words.w1 = gDebugSpriteDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_debug_display.c\x00" as *const u8 as
                         *const libc::c_char, 192 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DebugDisplay_DrawPolygon(mut dispObj:
                                                      *mut DebugDispObject,
                                                  mut dlist:
                                                      *mut libc::c_void,
                                                  mut globalCtx:
    ...
    (*_g_0).words.w0 =
        (0xdb as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = (1 as libc::c_int * 24 as libc::c_int) as libc::c_uint;
        ...
        (0xdc as libc::c_int as u32_0 &
            ...
            (10 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        &mut *sDebugObjectLights.l.as_mut_ptr().offset(0 as libc::c_int as
                                                           isize) as
        ...
        (0xdc as libc::c_int as u32_0 &
            ...
            (10 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        &mut sDebugObjectLights.a as *mut Ambient as libc::c_uint;
    func_800D1694((*dispObj).pos.x, (*dispObj).pos.y, (*dispObj).pos.z,
                  &mut (*dispObj).rot);
    Matrix_Scale((*dispObj).scale.x, (*dispObj).scale.y, (*dispObj).scale.z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
