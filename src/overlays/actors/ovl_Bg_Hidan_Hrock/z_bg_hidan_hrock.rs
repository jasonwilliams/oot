...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleTallestPillarAboveRoomBeforeBossDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTemplePillarInsertedInGroundDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleTallestPillarAboveRoomBeforeBossCol:
           CollisionHeader;
    #[no_mangle]
    static mut gFireTemplePillarInsertedInGroundCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanHrock {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanHrockActionFunc,
    pub unk_168: s16,
    pub unk_16A: u8_0,
    pub collider: ColliderTris,
    pub colliderItems: [ColliderTrisElement; 2],
}
pub type BgHidanHrockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanHrock, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Hrock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_HROCK as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanHrock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHrock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHrock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHrock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanHrock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHrock_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHidanHrock = thisx as *mut BgHidanHrock;
    let mut colliderElementInit: *mut ColliderTrisElementInit =
        0 as *mut ColliderTrisElementInit;
    let mut vertices: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut cosRotY: f32_0 = 0.;
    let mut sinRotY: f32_0 = 0.;
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    ...
    Collider_SetTris(globalCtx, &mut (*this).collider, thisx, &mut sTrisInit,
    ...
    while i < 2 as libc::c_int {
        ...
        while j < 3 as libc::c_int {
            let mut vtx: *mut Vec3f =
                &mut *(*colliderElementInit).dim.vtx.as_mut_ptr().offset(j as
                                                                             isize)
                    as *mut Vec3f;
            vertices[j as usize].x =
                (*vtx).z * sinRotY +
                    ((*thisx).home.pos.x + (*vtx).x * cosRotY);
            vertices[j as usize].y = (*vtx).y + (*thisx).home.pos.y;
            vertices[j as usize].z =
                (*vtx).z * cosRotY +
                    ((*thisx).home.pos.z - (*vtx).x * sinRotY);
            j += 1
        }
        Collider_SetTrisVertices(&mut (*this).collider, i,
                                 &mut *vertices.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                 &mut *vertices.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                 &mut *vertices.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
        i += 1
    }
    if Flags_GetSwitch(globalCtx, (*this).unk_16A as s32) != 0 {
        (*this).actionFunc =
            Some(func_808894A4 as
                     unsafe extern "C" fn(_: *mut BgHidanHrock,
                                          _: *mut GlobalContext) -> ());
        if (*thisx).params as libc::c_int == 0 as libc::c_int {
            (*thisx).world.pos.y -= 2800.0f32;
            (*thisx).uncullZoneForward = 3000.0f32
        } else if (*thisx).params as libc::c_int == 1 as libc::c_int {
            (*thisx).world.pos.y -= 800.0f32
        } else if (*thisx).params as libc::c_int == 2 as libc::c_int {
            (*thisx).world.pos.y -= 240.0f32
        }
    } else {
        if (*thisx).params as libc::c_int == 0 as libc::c_int {
            (*thisx).flags |=
        ...
        (*this).actionFunc =
            Some(func_808896B8 as
                     unsafe extern "C" fn(_: *mut BgHidanHrock,
                                          _: *mut GlobalContext) -> ())
    }
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gFireTempleTallestPillarAboveRoomBeforeBossCol
                                       as *mut CollisionHeader as
                                       *mut libc::c_void,
                                   &mut collisionHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gFireTemplePillarInsertedInGroundCol
                                       as *mut CollisionHeader as
                                       *mut libc::c_void,
                                   &mut collisionHeader);
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHrock_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHidanHrock = thisx as *mut BgHidanHrock;
...
#[no_mangle]
pub unsafe extern "C" fn func_808894A4(mut this: *mut BgHidanHrock,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808894B0(mut this: *mut BgHidanHrock,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    (*this).dyna.actor.world.pos.x =
        Math_SinS(((*this).dyna.actor.world.rot.y as libc::c_int +
                       (((*this).unk_168 as libc::c_int) <<
                            0xe as libc::c_int)) as s16) * 5.0f32 +
    ...
    if (*this).unk_168 as libc::c_int % 4 as libc::c_int == 0 {
    ...
    if (*this).unk_168 as libc::c_int == 0 as libc::c_int {
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            (*this).dyna.actor.home.pos.y -= 2800.0f32
        } else if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int
         {
            (*this).dyna.actor.home.pos.y -= 800.0f32
        } else { (*this).dyna.actor.home.pos.y -= 240.0f32 }
        (*this).actionFunc =
            Some(func_8088960C as
                     unsafe extern "C" fn(_: *mut BgHidanHrock,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn func_8088960C(mut this: *mut BgHidanHrock,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
        ...
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                   10 as libc::c_int {
                (*this).dyna.actor.room = 10 as libc::c_int as s8
...
#[no_mangle]
pub unsafe extern "C" fn func_808896B8(mut this: *mut BgHidanHrock,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int != 0 {
        ...
        Flags_SetSwitch(globalCtx, (*this).unk_16A as s32);
    } else {
    ...
    if func_8004356C(&mut (*this).dyna) != 0 {
        Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                     (*this).dyna.actor.home.pos.y - 5.0f32, 1.0f32);
    } else {
        Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHrock_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanHrock = thisx as *mut BgHidanHrock;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanHrock_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut dlists: [*mut Gfx; 3] =
        unsafe {
            [gFireTempleTallestPillarAboveRoomBeforeBossDL.as_ptr() as *mut _,
             gFireTemplePillarInsertedInGroundDL.as_ptr() as *mut _,
             gFireTemplePillarInsertedInGroundDL.as_ptr() as *mut _]
        };
