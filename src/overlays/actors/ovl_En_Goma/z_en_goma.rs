...
extern "C" {
    ...
    #[no_mangle]
    fn func_80094E78(gfxCtx: *mut GraphicsContext, x: u32_0, y: u32_0)
     -> *mut Gfx;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBrownFragmentDL: [Gfx; 0];
    #[no_mangle]
    static mut gObjectGolLandFromJumpAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolDeadTwitchingAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolJumpHeadbuttAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolDeathAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolPrepareJumpAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolStandAnim: AnimationHeader;
    #[no_mangle]
    static mut gObjectGolEggDL: [Gfx; 0];
    #[no_mangle]
    static mut gObjectGolSkel: SkeletonHeader;
    #[no_mangle]
    static mut gObjectGolRunningAnim: AnimationHeader;
}
...
pub const ENGOMA_BOSSLIMB: C2RustUnnamed_23 = 3;
pub const ENGOMA_HATCH_DEBRIS: C2RustUnnamed_23 = 2;
pub const ENGOMA_EGG: C2RustUnnamed_23 = 1;
pub const ENGOMA_NORMAL: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnGoma {
    pub actor: Actor,
...
pub const GOMA_LIMB_MAX: C2RustUnnamed_24 = 24;
pub const GOMA_LIMB_R_THIGH: C2RustUnnamed_24 = 23;
pub const GOMA_LIMB_R_SHIN: C2RustUnnamed_24 = 22;
pub const GOMA_LIMB_R_FOOT: C2RustUnnamed_24 = 21;
pub const GOMA_LIMB_R_FOOT_ROOT: C2RustUnnamed_24 = 20;
pub const GOMA_LIMB_R_SHIN_ROOT: C2RustUnnamed_24 = 19;
pub const GOMA_LIMB_R_LEG_ROOT2: C2RustUnnamed_24 = 18;
pub const GOMA_LIMB_R_LEG_ROOT1: C2RustUnnamed_24 = 17;
pub const GOMA_LIMB_L_THIGH: C2RustUnnamed_24 = 16;
pub const GOMA_LIMB_L_SHIN: C2RustUnnamed_24 = 15;
pub const GOMA_LIMB_L_FOOT: C2RustUnnamed_24 = 14;
pub const GOMA_LIMB_L_FOOT_ROOT: C2RustUnnamed_24 = 13;
pub const GOMA_LIMB_L_SHIN_ROOT: C2RustUnnamed_24 = 12;
pub const GOMA_LIMB_L_LEG_ROOT2: C2RustUnnamed_24 = 11;
pub const GOMA_LIMB_L_LEG_ROOT1: C2RustUnnamed_24 = 10;
pub const GOMA_LIMB_EYE_IRIS: C2RustUnnamed_24 = 9;
pub const GOMA_LIMB_EYE_IRIS_ROOT2: C2RustUnnamed_24 = 8;
pub const GOMA_LIMB_EYE_IRIS_ROOT1: C2RustUnnamed_24 = 7;
pub const GOMA_LIMB_ANTENNA: C2RustUnnamed_24 = 6;
pub const GOMA_LIMB_ANTENNA_ROOT2: C2RustUnnamed_24 = 5;
pub const GOMA_LIMB_ANTENNA_ROOT1: C2RustUnnamed_24 = 4;
pub const GOMA_LIMB_BODY: C2RustUnnamed_24 = 3;
pub const GOMA_LIMB_ROOT2: C2RustUnnamed_24 = 2;
pub const GOMA_LIMB_ROOT1: C2RustUnnamed_24 = 1;
pub const GOMA_LIMB_NONE: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BossGoma {
    pub actor: Actor,
...
pub type BossGomaActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut BossGoma, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Goma_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BOSS_GOMA as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_GOL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnGoma>() as
                                  libc::c_ulong,
                          init:
...
static mut D_80A4B7A0: ColliderCylinderInit =
    {
        let mut init =
...
static mut D_80A4B7CC: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sSpawnNum: u8_0 = 0 as libc::c_int as u8_0;
static mut sDeadEffectVel: Vec3f =
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGoma = thisx as *mut EnGoma;
    let mut params: s16 = 0;
    (*this).eggTimer = (Rand_ZeroOne() * 200.0f32) as s16;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 0.01f32);
    params = (*this).actor.params;
    if params as libc::c_int >= 100 as libc::c_int {
        // piece of boss goma
        Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                             &mut (*this).actor,
                             ACTORCAT_BOSS as libc::c_int as u8_0); // Egg
        (*this).actionFunc =
            Some(EnGoma_BossLimb as
                     unsafe extern "C" fn(_: *mut EnGoma,
                                          _: *mut GlobalContext) -> ());
        (*this).gomaType = ENGOMA_BOSSLIMB as libc::c_int as s16;
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                     ...
                                     -> ()), 0.0f32);
        (*this).actionTimer =
            ((*this).actor.params as libc::c_int + 150 as libc::c_int) as s16;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint
    } else if params as libc::c_int >= 10 as libc::c_int {
        // Debris when hatching
        (*this).actor.gravity = -1.3f32;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actionTimer = 50 as libc::c_int as s16;
        (*this).gomaType = ENGOMA_HATCH_DEBRIS as libc::c_int as s16;
        (*this).eggScale = 1.0f32;
        (*this).actor.velocity.y = Rand_ZeroOne() * 5.0f32 + 5.0f32;
        (*this).actionFunc =
            Some(EnGoma_Debris as
                     unsafe extern "C" fn(_: *mut EnGoma,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.speedXZ = Rand_ZeroOne() * 2.3f32 + 1.5f32;
        (*this).actionTimer = 30 as libc::c_int as s16;
        (*this).actor.scale.x = Rand_ZeroOne() * 0.005f32 + 0.01f32;
        (*this).actor.scale.y = Rand_ZeroOne() * 0.005f32 + 0.01f32;
        (*this).actor.scale.z = Rand_ZeroOne() * 0.005f32 + 0.01f32;
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      _: *mut Lights,
        ...
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      ...
                                                      _: *mut GlobalContext)
                                     -> ()), 40.0f32);
        SkelAnime_Init(globalCtx, &mut (*this).skelanime, &mut gObjectGolSkel,
                       &mut gObjectGolStandAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(),
                       GOMA_LIMB_MAX as libc::c_int);
        Animation_PlayLoop(&mut (*this).skelanime, &mut gObjectGolStandAnim);
        (*this).actor.colChkInfo.health = 2 as libc::c_int as u8_0;
        if ((*this).actor.params as libc::c_int) < 3 as libc::c_int {
            // Spawned by boss
            (*this).actionFunc =
                Some(EnGoma_EggFallToGround as
                         unsafe extern "C" fn(_: *mut EnGoma,
                                              _: *mut GlobalContext) -> ());
            (*this).invincibilityTimer = 10 as libc::c_int as s16;
                      ...
                      (*this).actor.params as libc::c_int == 6 as libc::c_int
         {
            (*this).actionFunc =
                Some(EnGoma_Egg as
                         unsafe extern "C" fn(_: *mut EnGoma,
                                              _: *mut GlobalContext) -> ());
            let fresh0 = sSpawnNum;
            sSpawnNum = sSpawnNum.wrapping_add(1);
            (*this).spawnNum = fresh0 as s16
        } else if (*this).actor.params as libc::c_int == 9 as libc::c_int ||
                      (*this).actor.params as libc::c_int == 7 as libc::c_int
         {
            (*this).actionFunc =
                Some(EnGoma_Egg as
                         unsafe extern "C" fn(_: *mut EnGoma,
        ...
        if (*this).actor.params as libc::c_int >= 8 as libc::c_int {
            // on ceiling
            (*this).eggYOffset = -1500.0f32
        } else { (*this).eggYOffset = 1500.0f32 }
        (*this).gomaType = ENGOMA_EGG as libc::c_int as s16;
        (*this).eggScale = 1.0f32;
        (*this).eggSquishAngle = Rand_ZeroOne() * 1000.0f32;
        (*this).actionTimer = 50 as libc::c_int as s16;
        Collider_InitCylinder(globalCtx, &mut (*this).colCyl1);
        Collider_SetCylinder(globalCtx, &mut (*this).colCyl1,
                             &mut (*this).actor, &mut D_80A4B7A0);
        Collider_InitCylinder(globalCtx, &mut (*this).colCyl2);
        Collider_SetCylinder(globalCtx, &mut (*this).colCyl2,
                             &mut (*this).actor, &mut D_80A4B7CC);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGoma = thisx as *mut EnGoma;
    if ((*this).actor.params as libc::c_int) < 10 as libc::c_int {
        Collider_DestroyCylinder(globalCtx, &mut (*this).colCyl1);
        Collider_DestroyCylinder(globalCtx, &mut (*this).colCyl2);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupFlee(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolRunningAnim,
                     2.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolRunningAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -2.0f32);
    (*this).actionFunc =
        Some(EnGoma_Flee as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    ...
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3819 as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x395f as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Flee(mut this: *mut EnGoma,
                                     mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    Math_ApproachF(&mut (*this).actor.speedXZ, 20.0f32 / 3.0f32, 0.5f32,
                   2.0f32);
    ...
    Math_ApproachS(&mut (*this).actor.shape.rot.y, (*this).actor.world.rot.y,
                   2 as libc::c_int as s16, 3000 as libc::c_int as s16);
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnGoma_SetupStand(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_EggFallToGround(mut this: *mut EnGoma,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    (*this).actor.gravity = -1.3f32;
    (*this).eggSquishAccel += 0.03f32;
    (*this).eggSquishAngle += 1.0f32 + (*this).eggSquishAccel;
    Math_ApproachZeroF(&mut (*this).eggSquishAmount, 1.0f32, 0.005f32);
    Math_ApproachF(&mut (*this).eggYOffset, 1500.0f32, 1.0f32, 150.0f32);
    match (*this).hatchState as libc::c_int {
        0 => {
            if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                ...
                if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3814 as libc::c_int as u16_0);
                } else {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3961 as libc::c_int as u16_0);
                }
                if (*this).actor.params as libc::c_int > 5 as libc::c_int {
                    EnGoma_SetupHatch(this, globalCtx);
                } else {
                    (*this).hatchState = 1 as libc::c_int as s16;
                    (*this).actionTimer = 3 as libc::c_int as s16;
                    Math_ApproachF(&mut (*this).eggScale, 1.5f32, 0.5f32,
                                   1.0f32);
                }
            }
        }
        1 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                (*this).hatchState = 2 as libc::c_int as s16;
                (*this).actionTimer = 3 as libc::c_int as s16;
                Math_ApproachF(&mut (*this).eggScale, 0.75f32, 0.5f32,
                               1.0f32);
                (*this).actor.velocity.y = 5.0f32;
                (*this).actor.speedXZ = 2.0f32
            } else {
                Math_ApproachF(&mut (*this).eggScale, 1.5f32, 0.5f32, 1.0f32);
            }
        }
        2 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                (*this).hatchState = 3 as libc::c_int as s16;
                (*this).actionTimer = 80 as libc::c_int as s16
            } else {
                Math_ApproachF(&mut (*this).eggScale, 0.75f32, 0.5f32,
                               1.0f32);
            }
        ...
        3 => {
            Math_ApproachF(&mut (*this).eggScale, 1.0f32, 0.1f32, 0.1f32);
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                EnGoma_SetupHatch(this, globalCtx);
            }
        }
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_ApproachZeroF(&mut (*this).actor.speedXZ, 0.2f32, 0.05f32);
    }
    (*this).eggPitch += (*this).actor.speedXZ * 0.1f32;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Egg(mut this: *mut EnGoma,
                                    mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut i: s32 = 0;
    (*this).eggSquishAngle += 1.0f32;
    Math_ApproachF(&mut (*this).eggSquishAmount, 0.1f32, 1.0f32, 0.005f32);
    if fabsf((*this).actor.world.pos.x - (*player).actor.world.pos.x) <
           100.0f32 &&
           fabsf((*this).actor.world.pos.z - (*player).actor.world.pos.z) <
               100.0f32 {
        (*this).playerDetectionTimer += 1;
        if (*this).playerDetectionTimer as libc::c_int > 9 as libc::c_int {
            (*this).actionFunc =
                Some(EnGoma_EggFallToGround as
                         unsafe extern "C" fn(_: *mut EnGoma,
                                              _: *mut GlobalContext) -> ())
        }
    } else { (*this).playerDetectionTimer = 0 as libc::c_int as s16 }
    if (*this).eggTimer as libc::c_int & 0xf as libc::c_int == 0 &&
           Rand_ZeroOne() < 0.5f32 {
        i = 0 as libc::c_int;
        while i < 2 as libc::c_int {
            ...
            pos.x = Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.x;
            pos.y = Rand_ZeroFloat(30.0f32) + (*this).actor.world.pos.y;
            pos.z = Rand_CenteredFloat(30.0f32) + (*this).actor.world.pos.z;
            EffectSsHahen_Spawn(globalCtx, &mut pos, &mut vel, &mut acc,
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupHatch(mut this: *mut EnGoma,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolJumpHeadbuttAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolJumpHeadbuttAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).actionFunc =
        Some(EnGoma_Hatch as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    Actor_SetScale(&mut (*this).actor, 0.005f32);
    (*this).gomaType = ENGOMA_NORMAL as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Hatch(mut this: *mut EnGoma,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnGoma_SetupStand(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupHurt(mut this: *mut EnGoma,
                                          mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolDamagedAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolDamagedAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
    ...
    } else { (*this).actionTimer = 10 as libc::c_int as s16 }
    ...
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3818 as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x395e as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Hurt(mut this: *mut EnGoma,
                                     mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_ApproachZeroF(&mut (*this).actor.speedXZ, 1.0f32, 2.0f32);
    }
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        if (*this).actor.colChkInfo.health as s8 as libc::c_int <=
               0 as libc::c_int {
            EnGoma_SetupDie(this);
        } else { EnGoma_SetupFlee(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupDie(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolDeathAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolDeathAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -2.0f32);
    (*this).actionFunc =
    ...
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x381a as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3960 as libc::c_int as u16_0);
    }
    (*this).invincibilityTimer = 100 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Die(mut this: *mut EnGoma,
                                    mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_ApproachZeroF(&mut (*this).actor.speedXZ, 1.0f32, 2.0f32);
    }
    if (*this).actionTimer as libc::c_int == 17 as libc::c_int {
        if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39e3 as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39e5 as libc::c_int as u16_0);
        }
    }
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupDead(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolDeadTwitchingAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolDeadTwitchingAnim
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Dead(mut this: *mut EnGoma,
                                     mut globalCtx: *mut GlobalContext) {
    let mut accel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    SkelAnime_Update(&mut (*this).skelanime);
    Math_ApproachZeroF(&mut (*this).actor.speedXZ, 1.0f32, 2.0f32);
    if (*this).actionTimer as libc::c_int == 2 as libc::c_int {
        pos.x = (*this).actor.world.pos.x;
        pos.y = (*this).actor.world.pos.y + 5.0f32 - 10.0f32;
        pos.z = (*this).actor.world.pos.z;
        accel = sDeadEffectVel;
        accel.y = 0.03f32;
        EffectSsKFire_Spawn(globalCtx, &mut pos, &mut sDeadEffectVel,
                            &mut accel, 40 as libc::c_int as s16,
                            0 as libc::c_int as u8_0);
    }
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int &&
           Math_SmoothStepToF(&mut (*this).actor.scale.y, 0.0f32, 0.5f32,
                              0.00225f32, 0.00001f32) <= 0.001f32 {
        if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
            let mut parent: *mut BossGoma =
                (*this).actor.parent as *mut BossGoma;
            (*parent).childrenGohmaState[(*this).actor.params as usize] =
                -(1 as libc::c_int) as s16
        }
        Audio_PlaySoundGeneral(0x3878 as libc::c_int as u16_0,
    ...
    (*this).visualState = 2 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupStand(mut this: *mut EnGoma) {
    let mut lastFrame: f32_0 = 0.;
    lastFrame =
        Animation_GetLastFrame(&mut gObjectGolStandAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).actionTimer =
        Rand_S16Offset(10 as libc::c_int as s16, 30 as libc::c_int as s16);
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolStandAnim, 1.0f32,
                     0.0f32, lastFrame, ANIMMODE_LOOP as libc::c_int as u8_0,
                     -5.0f32);
    (*this).actionFunc =
        Some(EnGoma_Stand as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    (*this).gomaType = ENGOMA_NORMAL as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupChasePlayer(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolRunningAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolRunningAnim as
                                                *mut AnimationHeader as
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupPrepareJump(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolPrepareJumpAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolPrepareJumpAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -5.0f32);
    (*this).actionFunc =
        Some(EnGoma_PrepareJump as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    (*this).actionTimer = 30 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_PrepareJump(mut this: *mut EnGoma,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut targetAngle: s16 = 0;
    SkelAnime_Update(&mut (*this).skelanime);
    ...
    targetAngle =
        Actor_WorldYawTowardActor(&mut (*this).actor,
                                  &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                                     ...
                                                                                                     isize)).head
                                              as *mut Player)).actor);
    Math_ApproachS(&mut (*this).actor.world.rot.y, targetAngle,
                   2 as libc::c_int as s16, 4000 as libc::c_int as s16);
    Math_ApproachS(&mut (*this).actor.shape.rot.y, targetAngle,
                   2 as libc::c_int as s16, 3000 as libc::c_int as s16);
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        EnGoma_SetupJump(this);
    }
    (*this).visualState = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupLand(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolLandFromJumpAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolLandFromJumpAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).actionFunc =
        Some(EnGoma_Land as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    (*this).actionTimer = 10 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Land(mut this: *mut EnGoma,
                                     mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_ApproachZeroF(&mut (*this).actor.speedXZ, 1.0f32, 2.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupJump(mut this: *mut EnGoma) {
    Animation_Change(&mut (*this).skelanime, &mut gObjectGolJumpHeadbuttAnim,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut gObjectGolJumpHeadbuttAnim as
                                                *mut AnimationHeader as
    ...
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3817 as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x395d as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Jump(mut this: *mut EnGoma,
                                     mut globalCtx: *mut GlobalContext) {
    (*this).actor.flags |=
        ((1 as libc::c_int) << 24 as libc::c_int) as libc::c_uint;
    SkelAnime_Update(&mut (*this).skelanime);
    Math_ApproachF(&mut (*this).actor.speedXZ, 10.0f32, 0.5f32, 5.0f32);
    if (*this).actor.velocity.y <= 0.0f32 &&
           (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        EnGoma_SetupLand(this);
        if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39e4 as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39e6 as libc::c_int as u16_0);
        }
    }
    (*this).visualState = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Stand(mut this: *mut EnGoma,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    Math_ApproachZeroF(&mut (*this).actor.speedXZ, 0.5f32, 2.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_ChasePlayer(mut this: *mut EnGoma,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if Animation_OnFrame(&mut (*this).skelanime, 1.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelanime, 5.0f32) != 0 {
        if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3816 as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x395c as libc::c_int as u16_0);
        }
    }
    Math_ApproachF(&mut (*this).actor.speedXZ, 10.0f32 / 3.0f32, 0.5f32,
                   2.0f32);
    Math_ApproachS(&mut (*this).actor.world.rot.y,
                   (*this).actor.yawTowardsPlayer, 3 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetupStunned(mut this: *mut EnGoma,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).actionFunc =
        Some(EnGoma_Stunned as
                 unsafe extern "C" fn(_: *mut EnGoma, _: *mut GlobalContext)
                     -> ());
    (*this).stunTimer = 100 as libc::c_int as s16;
    Animation_MorphToLoop(&mut (*this).skelanime, &mut gObjectGolStandAnim,
                          -5.0f32);
    (*this).actionTimer =
        (Rand_ZeroFloat(15.0f32) as s16 as libc::c_int + 3 as libc::c_int) as
            s16;
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x381f as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Stunned(mut this: *mut EnGoma,
                                        mut globalCtx: *mut GlobalContext) {
    Actor_SetColorFilter(&mut (*this).actor, 0 as libc::c_int as s16,
                         180 as libc::c_int as s16, 0 as libc::c_int as s16,
    ...
    if (*this).stunTimer as libc::c_int == 0 as libc::c_int {
        ...
        if ((*this).stunTimer as libc::c_int) < 30 as libc::c_int {
            if (*this).stunTimer as libc::c_int & 1 as libc::c_int != 0 {
                (*this).actor.world.pos.x += 1.5f32;
                (*this).actor.world.pos.z += 1.5f32
            } else {
                (*this).actor.world.pos.x -= 1.5f32;
                (*this).actor.world.pos.z -= 1.5f32
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_LookAtPlayer(mut this: *mut EnGoma,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut eyePitch: s16 = 0;
    let mut eyeYaw: s16 = 0;
    eyeYaw =
        (Actor_WorldYawTowardActor(&mut (*this).actor,
                                   &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                                      as
             ...
             libc::c_int - (*this).actor.shape.rot.y as libc::c_int) as s16;
    eyePitch =
        (Actor_WorldPitchTowardActor(&mut (*this).actor,
                                     &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                                        ...
                                                                                                        isize)).head
                                                 as *mut Player)).actor) as
             libc::c_int - (*this).actor.shape.rot.x as libc::c_int) as s16;
    if eyeYaw as libc::c_int > 6000 as libc::c_int {
        eyeYaw = 6000 as libc::c_int as s16
    }
    if (eyeYaw as libc::c_int) < -(6000 as libc::c_int) {
        eyeYaw = -(6000 as libc::c_int) as s16
    }
    Math_ApproachS(&mut (*this).eyeYaw, eyeYaw, 3 as libc::c_int as s16,
                   2000 as libc::c_int as s16);
    Math_ApproachS(&mut (*this).eyePitch, eyePitch, 3 as libc::c_int as s16,
                   2000 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_UpdateHit(mut this: *mut EnGoma,
                                          mut globalCtx: *mut GlobalContext) {
    static mut sShieldKnockbackVel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 20.0f32,}; init };
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).hurtTimer as libc::c_int != 0 as libc::c_int {
        (*this).hurtTimer -= 1
    } else {
        let mut acHitInfo: *mut ColliderInfo = 0 as *mut ColliderInfo;
        let mut swordDamage: u8_0 = 0;
        if (*this).colCyl1.base.atFlags as libc::c_int & 2 as libc::c_int != 0
               &&
               (*this).actionFunc ==
                   Some(EnGoma_Jump as
                            unsafe extern "C" fn(_: *mut EnGoma,
        ...
        if (*this).colCyl2.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               (*this).actor.colChkInfo.health as s8 as libc::c_int >
                   0 as libc::c_int {
            acHitInfo = (*this).colCyl2.info.acHitInfo;
            (*this).colCyl2.base.acFlags =
                ((*this).colCyl2.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*this).gomaType as libc::c_int == ENGOMA_NORMAL as libc::c_int
               {
                let mut dmgFlags: u32_0 = (*acHitInfo).toucher.dmgFlags;
                if dmgFlags & 0x100000 as libc::c_int as libc::c_uint != 0 {
                    if (*this).actionFunc ==
                           Some(EnGoma_Jump as
                                    unsafe extern "C" fn(_: *mut EnGoma,
                                                         _:
                        ...
                        Matrix_RotateY((*player).actor.shape.rot.y as
                                           libc::c_int as libc::c_float /
                                           0x8000 as libc::c_int as f32_0 *
                                           3.14159265358979323846f32,
                                       MTXMODE_NEW as libc::c_int as u8_0);
                        Matrix_MultVec3f(&mut sShieldKnockbackVel,
                                         &mut (*this).shieldKnockbackVel);
                        (*this).invincibilityTimer = 5 as libc::c_int as s16
                    }
                } else if dmgFlags & 1 as libc::c_int as libc::c_uint != 0 {
                    // stun
                    if (*this).actionFunc !=
                           Some(EnGoma_Stunned as
                                    unsafe extern "C" fn(_: *mut EnGoma,
                        ...
                        (*this).hurtTimer = 8 as libc::c_int as s16
                    }
                } else {
                    swordDamage =
                        CollisionCheck_GetSwordDamage(dmgFlags as s32);
                    if swordDamage != 0 {
                    ...
                    (*this).actor.colChkInfo.health =
                        ((*this).actor.colChkInfo.health as libc::c_int -
                             swordDamage as libc::c_int) as u8_0;
                    ...
                    (*this).hurtTimer = 13 as libc::c_int as s16
                }
            } else {
                // die if still an egg
                if (*this).actor.params as libc::c_int <= 5 as libc::c_int {
                    // ! BossGoma only has 3 children
                    let mut parent: *mut BossGoma =
                        (*this).actor.parent as *mut BossGoma;
                    (*parent).childrenGohmaState[(*this).actor.params as
                                                     usize] =
                        -(1 as libc::c_int) as s16
                }
                EnGoma_SpawnHatchDebris(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_UpdateEyeEnvColor(mut this: *mut EnGoma) {
    static mut sTargetEyeEnvColors: [[f32_0; 3]; 3] =
        [[255.0f32, 0.0f32, 50.0f32], [17.0f32, 255.0f32, 50.0f32],
         [0.0f32, 170.0f32, 50.0f32]];
    Math_ApproachF(&mut *(*this).eyeEnvColor.as_mut_ptr().offset(0 as
                                                                     libc::c_int
                                                                     as
                                                                     isize),
                   sTargetEyeEnvColors[0 as libc::c_int as
                                           usize][(*this).visualState as
                                                      usize], 0.5f32,
                   20.0f32);
    Math_ApproachF(&mut *(*this).eyeEnvColor.as_mut_ptr().offset(1 as
                                                                     ...
                                                                     as
                                                                     isize),
                   sTargetEyeEnvColors[1 as libc::c_int as
                                           usize][(*this).visualState as
                                                      usize], 0.5f32,
                   20.0f32);
    Math_ApproachF(&mut *(*this).eyeEnvColor.as_mut_ptr().offset(2 as
                                                                     ...
                                                                     as
                                                                     isize),
                   sTargetEyeEnvColors[2 as libc::c_int as
                                           usize][(*this).visualState as
                                                      usize], 0.5f32,
                   20.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SetFloorRot(mut this: *mut EnGoma) {
    let mut nx: f32_0 = 0.;
    let mut ny: f32_0 = 0.;
    let mut nz: f32_0 = 0.;
    if !(*this).actor.floorPoly.is_null() {
        ...
        nz =
            (*(*this).actor.floorPoly).normal.z as libc::c_int as
                libc::c_float * (1.0f32 / 32767.0f32);
        Math_ApproachS(&mut (*this).slopePitch,
                       (-Math_FAtan2F(-nz * ny, 1.0f32) *
                            (0x8000 as libc::c_int as libc::c_float /
                                 3.14159265358979323846f32)) as s16,
                       1 as libc::c_int as s16, 1000 as libc::c_int as s16);
        Math_ApproachS(&mut (*this).slopeRoll,
                       (Math_FAtan2F(-nx * ny, 1.0f32) *
                            (0x8000 as libc::c_int as libc::c_float /
                                 3.14159265358979323846f32)) as s16,
                       1 as libc::c_int as s16, 1000 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGoma = thisx as *mut EnGoma;
    let mut pad: s32 = 0;
    let mut player: *mut Player =
    ...
    Math_ApproachZeroF(&mut (*this).shieldKnockbackVel.x, 1.0f32, 3.0f32);
    Math_ApproachZeroF(&mut (*this).shieldKnockbackVel.z, 1.0f32, 3.0f32);
    if ((*this).actor.params as libc::c_int) < 10 as libc::c_int {
        (*this).eggTimer += 1;
        Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.01f32, 0.5f32,
                           0.00075f32, 0.000001f32);
        Math_SmoothStepToF(&mut (*this).actor.scale.y, 0.01f32, 0.5f32,
                           0.00075f32, 0.000001f32);
        Math_SmoothStepToF(&mut (*this).actor.scale.z, 0.01f32, 0.5f32,
                           0.00075f32, 0.000001f32);
        EnGoma_UpdateHit(this, globalCtx);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 50.0f32,
                                50.0f32, 100.0f32, 5 as libc::c_int);
        ...
        (*this).visualState = 1 as libc::c_int as s16;
        if (*player).swordState as libc::c_int != 0 as libc::c_int {
            (*this).colCyl2.dim.radius = 35 as libc::c_int as s16;
            (*this).colCyl2.dim.height = 35 as libc::c_int as s16;
            (*this).colCyl2.dim.yShift = 0 as libc::c_int as s16
        } else {
            (*this).colCyl2.dim.radius = 15 as libc::c_int as s16;
            (*this).colCyl2.dim.height = 30 as libc::c_int as s16;
            (*this).colCyl2.dim.yShift = 10 as libc::c_int as s16
        }
        if (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
            Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).colCyl1);
            Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).colCyl2);
            CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colCyl1.base);
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colCyl2.base);
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_goma.c\x00" as *const u8 as *const libc::c_char,
                    1976 as libc::c_int);
    ...
    (*_g).words.w1 =
        ((*this).eyeEnvColor[0 as libc::c_int as usize] as s16 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*this).eyeEnvColor[1 as libc::c_int as usize] as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*this).eyeEnvColor[2 as libc::c_int as usize] as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if limbIndex == GOMA_LIMB_EYE_IRIS_ROOT1 as libc::c_int {
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).eyePitch as libc::c_int) as
                s16;
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).eyeYaw as libc::c_int) as s16
    } else if limbIndex == GOMA_LIMB_BODY as libc::c_int &&
                  (*this).hurtTimer as libc::c_int != 0 as libc::c_int {
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_goma.c\x00" as *const u8 as
                         *const libc::c_char, 2011 as libc::c_int);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_NoBackfaceCullingDlist(mut gfxCtx:
                                                           *mut GraphicsContext)
 -> *mut Gfx {
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGoma = thisx as *mut EnGoma;
    let mut y: s32 = 0;
    let mut pad: s32 = 0;
    ...
    match (*this).gomaType as libc::c_int {
        0 => {
            (*this).actor.naviEnemyId = 0x3 as libc::c_int as u8_0;
            Matrix_Translate((*this).actor.world.pos.x,
                             ...
                             (*this).actor.world.pos.z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_RotateX((*this).slopePitch as libc::c_int as libc::c_float
                               / 0x8000 as libc::c_int as f32_0 *
                               3.14159265358979323846f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*this).slopeRoll as libc::c_int as libc::c_float /
                               0x8000 as libc::c_int as f32_0 *
                               3.14159265358979323846f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            SkelAnime_DrawOpa(globalCtx, (*this).skelanime.skeleton,
                              ...
                              Some(EnGoma_OverrideLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
        ...
        1 => {
            (*this).actor.naviEnemyId = 0x2 as libc::c_int as u8_0;
            y =
                (sinf((*this).eggTimer as libc::c_int as libc::c_float *
                          5.0f32 * 3.1415f32 / 180.0f32) * 31.9f32) as s16 as
                    s32;
            y = (y + 31 as libc::c_int) as s16 as s32;
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                func_80094E78((*globalCtx).state.gfxCtx,
                              0 as libc::c_int as u32_0, y as u32_0) as
                    libc::c_uint;
            Matrix_Push();
            Matrix_Scale((*this).eggScale, 1.0f32 / (*this).eggScale,
                         (*this).eggScale,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateY((*this).eggSquishAngle * 0.15f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*this).eggSquishAngle * 0.1f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(0.95f32 - (*this).eggSquishAmount,
                         (*this).eggSquishAmount + 1.05f32,
                         0.95f32 - (*this).eggSquishAmount,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ(-((*this).eggSquishAngle * 0.1f32),
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateY(-((*this).eggSquishAngle * 0.15f32),
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Translate(0.0f32, (*this).eggYOffset, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateX((*this).eggPitch,
                           MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_1).words.w1 = gObjectGolEggDL.as_mut_ptr() as libc::c_uint;
            Matrix_Pop();
        }
        2 => {
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_3).words.w1 = gBrownFragmentDL.as_mut_ptr() as libc::c_uint
        }
        3 => {
            if !(*this).bossLimbDl.is_null() {
                ...
                (*_g_4).words.w0 =
                    (0xdb as libc::c_int as u32_0 &
                        ...
                        ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_4).words.w1 =
                    EnGoma_NoBackfaceCullingDlist((*globalCtx).state.gfxCtx)
                        as libc::c_uint;
                ...
                (*_g_5).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_en_goma.c\x00" as *const u8 as
                                      ...
                                      *mut libc::c_char, 2114 as libc::c_int)
                        as libc::c_uint;
                    ...
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 16 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_6).words.w1 = (*this).bossLimbDl as libc::c_uint
            }
        }
        _ => { }
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_goma.c\x00" as *const u8 as
                         *const libc::c_char, 2119 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_Debris(mut this: *mut EnGoma,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 2500 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + 3500 as libc::c_int) as
            s16;
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGoma_SpawnHatchDebris(mut this: *mut EnGoma,
                                                 mut globalCtx2:
                                                     *mut GlobalContext) {
    ...
    if ((*this).actor.params as libc::c_int) < 6 as libc::c_int {
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                  0x28 as libc::c_int,
                                  0x3815 as libc::c_int as u16_0);
    } else {
        Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                  0x28 as libc::c_int,
                                  0x3962 as libc::c_int as u16_0);
    }
    ...
    while (i as libc::c_int) < 15 as libc::c_int {
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           ...
                           Rand_CenteredFloat(10.0f32) +
                               (*this).actor.world.pos.z,
                           0 as libc::c_int as s16,
                           Rand_CenteredFloat(0x10000 as libc::c_int as
                                                  libc::c_float - 0.01f32) as
                               s16, 0 as libc::c_int as s16,
                           (i as libc::c_int + 10 as libc::c_int) as s16);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGoma_BossLimb(mut this: *mut EnGoma,
                                         mut globalCtx: *mut GlobalContext) {
    let mut vel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut accel: Vec3f =
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.velocity.y = 0.0f32
    } else if ((*this).actionTimer as libc::c_int) < 250 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 2000 as libc::c_int)
                as s16
    }
    if (*this).actionTimer as libc::c_int == 250 as libc::c_int {
        (*this).actor.gravity = -1.0f32
    }
    if ((*this).actionTimer as libc::c_int) < 121 as libc::c_int {
        if Math_SmoothStepToF(&mut (*this).actor.scale.y, 0.0f32, 1.0f32,
                              0.00075f32, 0 as libc::c_int as f32_0) <=
               0.001f32 {
            Actor_Kill(&mut (*this).actor);
        }
    ...
    if (*this).actionTimer as libc::c_int % 8 as libc::c_int ==
           0 as libc::c_int &&
           (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        pos.x = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
        pos.y = Rand_CenteredFloat(10.0f32) + (*this).actor.world.pos.y;
        pos.z = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
        func_8002836C(globalCtx, &mut pos, &mut vel, &mut accel,
                      &mut primColor, &mut envColor,
                      500 as libc::c_int as s16, 10 as libc::c_int as s16,
    ...
    sInitChain =
        [{
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).targetMode as *mut s8
                                 as size_t as u32_0);
             init.set_value(3 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_value(0x3 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
