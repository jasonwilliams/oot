...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaBlock {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut Bg_Jya_Block_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_BLOCK as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBlock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBlock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBlock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBlock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBlock_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaBlock = thisx as *mut BgJyaBlock;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    DynaPolyActor_Init(&mut (*this).dyna, 0 as libc::c_int);
    CollisionHeader_GetVirtual(&mut gPushBlockCol as *mut CollisionHeader as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBlock_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgJyaBlock = thisx as *mut BgJyaBlock;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBlock_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaBlock = thisx as *mut BgJyaBlock;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBlock_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_block.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        gSegments[((gPushBlockGrayTex.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gPushBlockGrayTex.as_mut_ptr() as
                                              u32_0 &
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gPushBlockDL.as_mut_ptr() as libc::c_uint;
    ...
    sInitChain =
        [{
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).scale as *mut Vec3f as
                                 size_t as u32_0);
             init.set_value(333 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
