...
extern "C" {
    ...
    #[no_mangle]
    static mut object_tite_Anim_0004F8: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Anim_00069C: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Anim_00083C: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Anim_000A14: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Anim_000C70: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Anim_0012E4: AnimationHeader;
    #[no_mangle]
    static mut object_tite_Tex_001300: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Tex_001700: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Tex_001900: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Tex_001B00: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Tex_001F00: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Tex_002100: [u64_0; 0];
    #[no_mangle]
    static mut object_tite_Skel_003A20: SkeletonHeader;
}
...
pub struct EnTite {
    ...
    pub action: u8_0,
    pub flipState: u8_0,
    pub actionFunc: EnTiteActionFunc,
    pub bodyBreak: BodyBreak,
    pub unk_2DC: s32,
    pub actionVar1: s16,
    pub actionVar2: u8_0,
    pub spawnIceTimer: u8_0,
    pub damageEffect: u8_0,
    pub collider: ColliderJntSph,
    pub colliderItem: ColliderJntSphElement,
    pub frontLeftFootPos: Vec3f,
    pub frontRightFootPos: Vec3f,
    pub backRightFootPos: Vec3f,
    pub backLeftFootPos: Vec3f,
}
pub type EnTiteActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTite, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_int;
pub const TEKTITE_RED: C2RustUnnamed_22 = -1;
pub const TEKTITE_BLUE: C2RustUnnamed_22 = -2;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnReeba {
    pub actor: Actor,
...
pub const TEKTITE_MOVE_TOWARD_PLAYER: C2RustUnnamed_23 = 12;
pub const TEKTITE_UNK9: C2RustUnnamed_23 = 11;
pub const TEKTITE_TURN_TOWARD_PLAYER: C2RustUnnamed_23 = 10;
pub const TEKTITE_ATTACK: C2RustUnnamed_23 = 9;
pub const TEKTITE_UNK_8: C2RustUnnamed_23 = 8;
pub const TEKTITE_STUNNED: C2RustUnnamed_23 = 7;
pub const TEKTITE_IDLE: C2RustUnnamed_23 = 6;
pub const TEKTITE_FALL_APART: C2RustUnnamed_23 = 5;
pub const TEKTITE_UNK_4: C2RustUnnamed_23 = 4;
pub const TEKTITE_RECOIL: C2RustUnnamed_23 = 3;
pub const TEKTITE_UNK_2: C2RustUnnamed_23 = 2;
pub const TEKTITE_UNK_1: C2RustUnnamed_23 = 1;
pub const TEKTITE_DEATH_CRY: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const TEKTITE_SUBMERGED: C2RustUnnamed_24 = 3;
pub const TEKTITE_LANDED: C2RustUnnamed_24 = 2;
pub const TEKTITE_MID_LUNGE: C2RustUnnamed_24 = 1;
pub const TEKTITE_BEGIN_LUNGE: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const TEKTITE_FLIPPED: C2RustUnnamed_25 = 2;
pub const TEKTITE_UNFLIPPED: C2RustUnnamed_25 = 1;
pub const TEKTITE_INITIAL: C2RustUnnamed_25 = 0;
#[no_mangle]
pub static mut En_Tite_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TITE as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_TITE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTite>() as
                                  libc::c_ulong,
                          init:
...
static mut D_80B1B634: [*mut AnimationHeader; 6] =
    unsafe {
        [&object_tite_Anim_00083C as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tite_Anim_0004F8 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tite_Anim_00069C as *const AnimationHeader as
             *mut AnimationHeader,
         0 as *const AnimationHeader as *mut AnimationHeader,
         0 as *const AnimationHeader as *mut AnimationHeader,
         0 as *const AnimationHeader as *mut AnimationHeader]
    };
// Some kind of offset for the position of each tektite foot
static mut sFootOffset: Vec3f =
    { let mut init = Vec3f{x: 2800.0f32, y: -200.0f32, z: 0.0f32,}; init };
// Relative positions to spawn ice chunks when tektite is frozen
static mut sIceChunks: [Vec3f; 12] =
    [{
         let mut init =
             Vec3f{x: 20.0f32,
                   y: 20.0f32,
                   z:
                       0.0f32,}; // Don't use the actor engine's ripple spawning code
         init
     }, { let mut init = Vec3f{x: 10.0f32, y: 40.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 40.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -20.0f32, y: 20.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 40.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 40.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 20.0f32, z: -20.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 0.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 0.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 20.0f32, z: 20.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 0.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 0.0f32, z: -10.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupAction(mut this: *mut EnTite,
                                            mut actionFunc:
                                                EnTiteActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    ...
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_tite_Skel_003A20, &mut object_tite_Anim_0012E4,
    ...
    ActorShape_Init(&mut (*thisx).shape, -200.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 70.0f32);
    (*this).flipState = TEKTITE_INITIAL as libc::c_int as u8_0;
    (*thisx).colChkInfo.damageTable = sDamageTable.as_mut_ptr();
    (*this).actionVar1 = 0 as libc::c_int as s16;
    (*this).bodyBreak.val = 0 as libc::c_int;
    (*thisx).focus.pos = (*thisx).world.pos;
    (*thisx).focus.pos.y += 20.0f32;
    (*thisx).colChkInfo.health = 2 as libc::c_int as u8_0;
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, thisx,
                       &mut sJntSphInit, &mut (*this).colliderItem);
    (*this).unk_2DC = 0x1d as libc::c_int;
    if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int {
        (*this).unk_2DC |= 0x40 as libc::c_int;
        (*thisx).colChkInfo.health = 4 as libc::c_int as u8_0;
        (*thisx).naviEnemyId =
            ((*thisx).naviEnemyId as libc::c_int + 1 as libc::c_int) as u8_0
    }
    EnTite_SetupIdle(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    let mut spawner: *mut EnEncount1 = 0 as *mut EnEncount1;
    if !(*thisx).parent.is_null() {
        spawner = (*thisx).parent as *mut EnEncount1;
        if (*spawner).curNumSpawn as libc::c_int > 0 as libc::c_int {
            (*spawner).curNumSpawn -= 1
        }
        ...
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x90\x8c\xe6\x99\x82\xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb0 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86%d\n\x1b[m\x00"
                     ...
                     (*spawner).curNumSpawn as libc::c_int);
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    }
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupIdle(mut this: *mut EnTite) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_tite_Anim_0012E4, 4.0f32);
    (*this).action = TEKTITE_IDLE as libc::c_int as u8_0;
    (*this).actionVar1 =
        Rand_S16Offset(15 as libc::c_int as s16, 30 as libc::c_int as s16);
    (*this).actor.speedXZ = 0.0f32;
    EnTite_SetupAction(this,
                       Some(EnTite_Idle as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Idle(mut this: *mut EnTite,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int {
        if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int !=
            ...
            (*this).actor.gravity =
                0.0f32; // for deciding whether to change animation
            Math_SmoothStepToF(&mut (*this).actor.velocity.y, 0.0f32, 1.0f32,
                               2.0f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*this).actor.world.pos.y +
                                   (*this).actor.yDistToWater, 1.0f32, 2.0f32,
                               0.0f32);
        } else { (*this).actor.gravity = -1.0f32 }
    }
    ...
    if (*this).actionVar1 as libc::c_int > 0 as libc::c_int {
        (*this).actionVar1 -= 1
    } else if (*this).actor.xzDistToPlayer < 300.0f32 &&
                  (*this).actor.yDistToPlayer <= 80.0f32 {
        EnTite_SetupTurnTowardPlayer(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupAttack(mut this: *mut EnTite) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut object_tite_Anim_00083C);
    (*this).action = TEKTITE_ATTACK as libc::c_int as u8_0;
    (*this).actionVar1 = TEKTITE_BEGIN_LUNGE as libc::c_int as s16;
    (*this).actionVar2 =
        Rand_S16Offset(1 as libc::c_int as s16, 3 as libc::c_int as s16) as
            u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnTite_SetupAction(this,
                       Some(EnTite_Attack as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Attack(mut this: *mut EnTite,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angleToPlayer: s16 = 0;
    let mut attackState: s32 = 0;
    let mut ripplePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        attackState = (*this).actionVar1 as s32;
        match (*this).actionVar1 as libc::c_int {
            0 => {
                // Snap to ground or water, then lunge into the air with some initial speed
                (*this).actionVar1 = TEKTITE_MID_LUNGE as libc::c_int as s16;
                if (*this).actor.params as libc::c_int !=
                       TEKTITE_BLUE as libc::c_int ||
            ...
            1 => {
                ...
                if (*this).actor.bgCheckFlags as libc::c_int &
                    ...
                    if (*this).actor.velocity.y <= 0.0f32 {
                        (*this).actionVar1 =
                            TEKTITE_LANDED as libc::c_int as s16;
                        if (*this).actor.params as libc::c_int !=
                               TEKTITE_BLUE as libc::c_int ||
                               (*this).actor.bgCheckFlags as libc::c_int &
                                   0x20 as libc::c_int == 0 {
                            if -32000.0f32 < (*this).actor.floorHeight {
                                (*this).actor.world.pos.y =
            ...
            2 => {
                ...
                if (*this).actionVar2 as libc::c_int != 0 as libc::c_int {
                    (*this).actionVar2 = (*this).actionVar2.wrapping_sub(1);
                    (*this).actionVar1 =
                        TEKTITE_BEGIN_LUNGE as libc::c_int as s16;
                    (*this).collider.base.atFlags =
                        ((*this).collider.base.atFlags as libc::c_int &
                             !((1 as libc::c_int) << 1 as libc::c_int)) as
                            u8_0
                } else { EnTite_SetupTurnTowardPlayer(this); }
            }
            3 => {
                // Check if floated to surface
                if (*this).actor.yDistToWater == 0.0f32 {
                    (*this).actionVar1 = TEKTITE_LANDED as libc::c_int as s16;
                    attackState = (*this).actionVar1 as s32
                }
            }
            _ => { }
        ...
        if attackState != (*this).actionVar1 as libc::c_int {
            Animation_PlayOnce(&mut (*this).skelAnime,
                               D_80B1B634[(*this).actionVar1 as usize]);
        }
    }
    match (*this).actionVar1 as libc::c_int {
        0 => {
            ...
            if (*this).actor.xzDistToPlayer > 300.0f32 &&
                   (*this).actor.yDistToPlayer > 80.0f32 {
                EnTite_SetupIdle(this);
            } else if (if angleToPlayer as libc::c_int >= 0 as libc::c_int {
                           angleToPlayer as libc::c_int
                       } else { -(angleToPlayer as libc::c_int) }) >=
                          9000 as libc::c_int {
                EnTite_SetupTurnTowardPlayer(this);
            }
        }
        1 => {
            ...
            if (*this).actor.velocity.y >= 5.0f32 {
                if (*this).actor.bgCheckFlags as libc::c_int &
                       1 as libc::c_int != 0 {
                    func_800355B8(globalCtx, &mut (*this).frontLeftFootPos);
                    func_800355B8(globalCtx, &mut (*this).frontRightFootPos);
                    func_800355B8(globalCtx, &mut (*this).backRightFootPos);
                    func_800355B8(globalCtx, &mut (*this).backLeftFootPos);
                }
            }
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int ==
               0 {
            func_80033480(globalCtx, &mut (*this).frontLeftFootPos, 1.0f32,
                          2 as libc::c_int, 80 as libc::c_int as s16,
                          15 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            func_80033480(globalCtx, &mut (*this).frontRightFootPos, 1.0f32,
                          2 as libc::c_int, 80 as libc::c_int as s16,
                          15 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            func_80033480(globalCtx, &mut (*this).backRightFootPos, 1.0f32,
                          2 as libc::c_int, 80 as libc::c_int as s16,
                          15 as libc::c_int as s16, 1 as libc::c_int as u8_0);
            func_80033480(globalCtx, &mut (*this).backLeftFootPos, 1.0f32,
                          2 as libc::c_int, 80 as libc::c_int as s16,
                          15 as libc::c_int as s16, 1 as libc::c_int as u8_0);
        }
    }
    ...
    if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int {
        if (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int !=
               0 {
            (*this).actor.speedXZ = 0.0f32;
            if (*this).actionVar1 as libc::c_int ==
                   TEKTITE_SUBMERGED as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x388a as libc::c_int as u16_0);
            } else {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x388f as libc::c_int as u16_0);
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupTurnTowardPlayer(mut this: *mut EnTite) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_tite_Anim_000A14);
    (*this).action = TEKTITE_TURN_TOWARD_PLAYER as libc::c_int as u8_0;
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 ||
           (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
               &&
               (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int
                   != 0 {
        if (*this).actor.velocity.y <= 0.0f32 {
            (*this).actor.gravity = 0.0f32;
            (*this).actor.velocity.y = 0.0f32;
    ...
    EnTite_SetupAction(this,
                       Some(EnTite_TurnTowardPlayer as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_TurnTowardPlayer(mut this: *mut EnTite,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut angleToPlayer: s16 = 0;
    let mut turnVelocity: s16 = 0;
    if ((*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 ||
            (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
                &&
                (*this).actor.bgCheckFlags as libc::c_int &
    ...
    if angleToPlayer as libc::c_int > 0 as libc::c_int {
        turnVelocity =
            (angleToPlayer as libc::c_int as libc::c_float / 42.0f32 +
                 10.0f32) as s16;
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int +
                 turnVelocity as libc::c_int * 2 as libc::c_int) as s16
    } else {
        turnVelocity =
            (angleToPlayer as libc::c_int as libc::c_float / 42.0f32 -
                 10.0f32) as s16;
    ...
    if angleToPlayer as libc::c_int > 0 as libc::c_int {
        (*this).skelAnime.playSpeed =
            turnVelocity as libc::c_int as libc::c_float * 0.01f32
    } else {
        (*this).skelAnime.playSpeed =
            turnVelocity as libc::c_int as libc::c_float * 0.01f32
    }
     ...
     */
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).skelAnime.curFrame as s16 as libc::c_int & 7 as libc::c_int ==
           0 as libc::c_int {
        if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
               &&
               (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int
                   != 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3835 as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x386f as libc::c_int as u16_0);
        }
    }
    ...
    if (*this).actor.xzDistToPlayer > 300.0f32 &&
        ...
        EnTite_SetupIdle(this);
                                   ...
                                   3640 as libc::c_int as s16) != 0 {
        if (*this).actor.xzDistToPlayer <= 180.0f32 &&
               (*this).actor.yDistToPlayer <= 80.0f32 {
            EnTite_SetupAttack(this);
        } else { EnTite_SetupMoveTowardPlayer(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupMoveTowardPlayer(mut this: *mut EnTite) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut object_tite_Anim_000C70);
    (*this).action = TEKTITE_MOVE_TOWARD_PLAYER as libc::c_int as u8_0;
    ...
    EnTite_SetupAction(this,
                       Some(EnTite_MoveTowardPlayer as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_MoveTowardPlayer(mut this: *mut EnTite,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32, 1.0f32,
                       0.0f32);
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.bgCheckFlags as libc::c_int & 0x42 as libc::c_int != 0 {
        if (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int ==
               0 {
            func_80033480(globalCtx, &mut (*this).frontLeftFootPos, 1.0f32,
                          2 as libc::c_int, 80 as libc::c_int as s16,
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 ||
           (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
               &&
               (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int
                   != 0 {
        if (*this).actionVar2 as libc::c_int != 0 as libc::c_int {
            (*this).actionVar2 = (*this).actionVar2.wrapping_sub(1)
        } else { EnTite_SetupIdle(this); }
    }
    if ((*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 ||
            (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
                &&
                (*this).actor.bgCheckFlags as libc::c_int &
                    0x60 as libc::c_int != 0) &&
           (*this).actor.velocity.y <= 0.0f32 {
        ...
        if (*this).actor.params as libc::c_int != TEKTITE_BLUE as libc::c_int
            ...
            let mut ripplePos: Vec3f = (*this).actor.world.pos;
            (*this).actor.bgCheckFlags =
                ((*this).actor.bgCheckFlags as libc::c_int &
                     !(0x40 as libc::c_int)) as u16_0;
            ripplePos.y += (*this).actor.yDistToWater;
        ...
        if (*this).actor.xzDistToPlayer > 300.0f32 &&
               (*this).actor.yDistToPlayer > 80.0f32 {
            EnTite_SetupIdle(this);
        } else if (*this).actor.xzDistToPlayer <= 180.0f32 &&
                      (*this).actor.yDistToPlayer <= 80.0f32 {
            if (*this).actionVar2 as libc::c_int <= 0 as libc::c_int {
                EnTite_SetupTurnTowardPlayer(this);
            } else {
        ...
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           ...
                           1000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if (*this).actor.velocity.y >= 6.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupRecoil(mut this: *mut EnTite) {
    (*this).action = TEKTITE_RECOIL as libc::c_int as u8_0;
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_tite_Anim_0012E4, 4.0f32);
    (*this).actor.speedXZ = -6.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_Recoil(mut this: *mut EnTite,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angleToPlayer: s16 = 0;
    ...
    if (*this).actor.speedXZ == 0.0f32 &&
        ...
        if (*this).actor.xzDistToPlayer > 300.0f32 &&
               ...
               (if (*this).actor.shape.rot.x as libc::c_int >=
                ...
                } else { -((*this).actor.shape.rot.x as libc::c_int) }) <
                   4000 as libc::c_int &&
               (if (*this).actor.shape.rot.z as libc::c_int >=
                       0 as libc::c_int {
                    (*this).actor.shape.rot.z as libc::c_int
                } else { -((*this).actor.shape.rot.z as libc::c_int) }) <
                   4000 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupStunned(mut this: *mut EnTite) {
    Animation_Change(&mut (*this).skelAnime, &mut object_tite_Anim_0012E4,
                     0.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_tite_Anim_0012E4 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, 4.0f32);
    (*this).action = TEKTITE_STUNNED as libc::c_int as u8_0;
    (*this).actor.speedXZ = -6.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    if (*this).damageEffect as libc::c_int == 0xf as libc::c_int {
        (*this).spawnIceTimer = 48 as libc::c_int as u8_0
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x389e as libc::c_int as u16_0);
    EnTite_SetupAction(this,
                       Some(EnTite_Stunned as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_Stunned(mut this: *mut EnTite,
                                        mut globalCtx: *mut GlobalContext) {
    let mut angleToPlayer: s16 = 0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    ...
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int &&
        ...
        } else if (*this).flipState as libc::c_int ==
                      TEKTITE_FLIPPED as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupDeathCry(mut this: *mut EnTite) {
    (*this).action = TEKTITE_DEATH_CRY as libc::c_int as u8_0;
    (*this).actor.colorFilterTimer = 0 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnTite_SetupAction(this,
                       Some(EnTite_DeathCry as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_DeathCry(mut this: *mut EnTite,
                                         mut globalCtx: *mut GlobalContext) {
    EffectSsDeadSound_SpawnStationary(globalCtx,
                                      &mut (*this).actor.projectedPos,
                                      0x386e as libc::c_int as u16_0,
                                      1 as libc::c_int as s16,
                                      1 as libc::c_int as s16,
                                      40 as libc::c_int);
    (*this).action = TEKTITE_FALL_APART as libc::c_int as u8_0;
    EnTite_SetupAction(this,
                       Some(EnTite_FallApart as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
    BodyBreak_Alloc(&mut (*this).bodyBreak, 24 as libc::c_int, globalCtx);
}
/* *
 * Spawn EnPart and drop items
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_FallApart(mut this: *mut EnTite,
                                          mut globalCtx: *mut GlobalContext) {
    if BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
                            globalCtx,
                            ((*this).actor.params as libc::c_int +
                                 0xb as libc::c_int) as s16) != 0 {
        if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
           {
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupFlipOnBack(mut this: *mut EnTite) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime,
                               &mut object_tite_Anim_000A14, 1.5f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3888 as libc::c_int as u16_0);
    (*this).flipState = TEKTITE_FLIPPED as libc::c_int as u8_0;
    (*this).actionVar1 = 500 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.gravity = -1.0f32;
    (*this).actionVar2 = (Rand_ZeroOne() * 50.0f32) as u8_0;
    (*this).actor.velocity.y = 11.0f32;
    EnTite_SetupAction(this,
                       Some(EnTite_FlipOnBack as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnTite_FlipOnBack(mut this: *mut EnTite,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       0x7fff as libc::c_int as s16, 1 as libc::c_int as s16,
                       4000 as libc::c_int as s16, 0 as libc::c_int as s16);
    // randomly reset the leg wiggling animation whenever timer reaches 0 to give illusion of twitching legs
    (*this).actionVar2 = (*this).actionVar2.wrapping_sub(1);
    if (*this).actionVar2 as libc::c_int == 0 as libc::c_int {
        (*this).actionVar2 = (Rand_ZeroOne() * 30.0f32) as u8_0;
        (*this).skelAnime.curFrame = Rand_ZeroOne() * 5.0f32
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
    ...
    } else if (*this).actor.shape.yOffset < 2800.0f32 {
        (*this).actor.shape.yOffset += 400.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_SetupFlipUpright(mut this: *mut EnTite) {
    (*this).flipState = TEKTITE_UNFLIPPED as libc::c_int as u8_0;
    ...
    (*this).actionVar1 =
        1000 as libc::c_int as
            s16; // value unused here and overwritten in SetupIdle
    // ! @bug flying tektite: water sets gravity to 0 so y velocity will never decrease from 13
    (*this).actor.velocity.y = 13.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3888 as libc::c_int as u16_0);
    EnTite_SetupAction(this,
                       Some(EnTite_FlipUpright as
                                unsafe extern "C" fn(_: *mut EnTite,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_FlipUpright(mut this: *mut EnTite,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       0 as libc::c_int as s16, 1 as libc::c_int as s16,
                       0xfa0 as libc::c_int as s16, 0 as libc::c_int as s16);
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_CheckDamage(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 &&
           (*this).action as libc::c_int >= TEKTITE_IDLE as libc::c_int {
        ...
        if (*thisx).colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*thisx).colChkInfo.damageEffect as libc::c_int ==
                   1 as libc::c_int ||
                   (*thisx).colChkInfo.damageEffect as libc::c_int ==
                       0xf as libc::c_int {
                if (*this).action as libc::c_int !=
                       TEKTITE_STUNNED as libc::c_int {
                    Actor_SetColorFilter(thisx, 0 as libc::c_int as s16,
                ...
                if (*thisx).colorFilterTimer as libc::c_int ==
                       0 as libc::c_int ||
                       (*thisx).colorFilterParams as libc::c_int &
                           0x4000 as libc::c_int == 0 as libc::c_int {
                    Actor_SetColorFilter(thisx, 0x4000 as libc::c_int as s16,
                ...
                if (*thisx).colChkInfo.health as libc::c_int ==
                    ...
                    Audio_PlayActorSound2(thisx,
                                          0x386d as libc::c_int as u16_0);
                    if (*this).flipState as libc::c_int !=
                           TEKTITE_FLIPPED as libc::c_int {
                        EnTite_SetupRecoil(this);
                    } else { EnTite_SetupFlipUpright(this); }
                }
            }
        }
    } else if (*thisx).colChkInfo.health as libc::c_int != 0 as libc::c_int &&
                  (*globalCtx).actorCtx.unk_02 as libc::c_int !=
                      0 as libc::c_int && (*thisx).xzDistToPlayer <= 400.0f32
                  &&
                  (*thisx).bgCheckFlags as libc::c_int & 1 as libc::c_int != 0
     {
        if (*this).flipState as libc::c_int == TEKTITE_FLIPPED as libc::c_int
           {
            EnTite_SetupFlipUpright(this);
        } else if (*this).action as libc::c_int >= TEKTITE_IDLE as libc::c_int
                      ||
                      (*this).action as libc::c_int >=
                          TEKTITE_IDLE as libc::c_int {
            EnTite_SetupFlipOnBack(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    ...
    let mut waterSurfaceY: f32_0 = 0.;
    EnTite_CheckDamage(thisx, globalCtx);
    // Stay still if hit by immunity damage type this frame
    if (*thisx).colChkInfo.damageEffect as libc::c_int != 0xe as libc::c_int {
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        Actor_MoveForward(thisx);
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 25.0f32, 40.0f32, 20.0f32,
                                (*this).unk_2DC);
        // If on water, snap feet to surface and spawn ripples
        if (*this).actor.params as libc::c_int == TEKTITE_BLUE as libc::c_int
               &&
               (*thisx).bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0
           {
            ...
            if ((*globalCtx).gameplayFrames.wrapping_rem(8 as libc::c_int as
                   ...
                   WaterBox_GetSurfaceImpl(globalCtx,
                                           &mut (*globalCtx).colCtx,
                                           (*this).backRightFootPos.x,
                                           (*this).backRightFootPos.z,
                                           &mut waterSurfaceY, &mut waterBox)
                       != 0 && (*this).backRightFootPos.y <= waterSurfaceY {
                (*this).backRightFootPos.y = waterSurfaceY;
                EffectSsGRipple_Spawn(globalCtx,
                                      &mut (*this).backRightFootPos,
                                      0 as libc::c_int as s16,
                                      220 as libc::c_int as s16,
                                      0 as libc::c_int as s16);
            }
            if ((*globalCtx).gameplayFrames.wrapping_add(2 as libc::c_int as
                                                             libc::c_uint).wrapping_rem(8
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                                                                                            libc::c_uint)
                   ...
                   WaterBox_GetSurfaceImpl(globalCtx,
                                           &mut (*globalCtx).colCtx,
                                           (*this).backLeftFootPos.x,
                                           (*this).backLeftFootPos.z,
                                           &mut waterSurfaceY, &mut waterBox)
                       != 0 && (*this).backLeftFootPos.y <= waterSurfaceY {
                (*this).backLeftFootPos.y = waterSurfaceY;
                EffectSsGRipple_Spawn(globalCtx, &mut (*this).backLeftFootPos,
                                      0 as libc::c_int as s16,
                                      220 as libc::c_int as s16,
                                      0 as libc::c_int as s16);
            }
            if ((*globalCtx).gameplayFrames.wrapping_add(4 as libc::c_int as
                                                             libc::c_uint).wrapping_rem(8
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                   ...
                   WaterBox_GetSurfaceImpl(globalCtx,
                                           &mut (*globalCtx).colCtx,
                                           (*this).frontLeftFootPos.x,
                                           (*this).frontLeftFootPos.z,
                                           &mut waterSurfaceY, &mut waterBox)
                       != 0 && (*this).frontLeftFootPos.y <= waterSurfaceY {
                (*this).frontLeftFootPos.y = waterSurfaceY;
                EffectSsGRipple_Spawn(globalCtx,
                                      &mut (*this).frontLeftFootPos,
                                      0 as libc::c_int as s16,
                                      220 as libc::c_int as s16,
                                      0 as libc::c_int as s16);
            }
            if ((*globalCtx).gameplayFrames.wrapping_add(1 as libc::c_int as
                                                             libc::c_uint).wrapping_rem(8
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                   ...
                   WaterBox_GetSurfaceImpl(globalCtx,
                                           &mut (*globalCtx).colCtx,
                                           (*this).frontRightFootPos.x,
                                           (*this).frontRightFootPos.z,
                                           &mut waterSurfaceY, &mut waterBox)
                       != 0 && (*this).frontRightFootPos.y <= waterSurfaceY {
                (*this).frontRightFootPos.y = waterSurfaceY;
                EffectSsGRipple_Spawn(globalCtx,
                                      &mut (*this).frontRightFootPos,
                                      0 as libc::c_int as s16,
                                      220 as libc::c_int as s16,
                                      0 as libc::c_int as s16);
            }
        ...
        if (*thisx).bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
            func_800359B8(thisx, (*thisx).shape.rot.y,
                          &mut (*thisx).shape.rot);
            if (*this).flipState as libc::c_int >=
                   TEKTITE_FLIPPED as libc::c_int {
                (*thisx).shape.rot.z =
                    ((*thisx).shape.rot.z as libc::c_int +
            ...
            Math_SmoothStepToS(&mut (*thisx).shape.rot.x,
                               ...
                               0 as libc::c_int as s16);
            if (*this).flipState as libc::c_int <=
                   TEKTITE_UNFLIPPED as libc::c_int {
                Math_SmoothStepToS(&mut (*thisx).shape.rot.z,
                                   0 as libc::c_int as s16,
                                   1 as libc::c_int as s16,
                                   1000 as libc::c_int as s16,
                                   0 as libc::c_int as s16);
                if (*thisx).shape.yOffset > 0 as libc::c_int as libc::c_float
                   {
                    (*thisx).shape.yOffset -= 400.0f32
                }
            }
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnTite_PostLimbDraw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut limbIndex: s32,
                                             mut limbDList: *mut *mut Gfx,
                                             mut rot: *mut Vec3s,
                                             mut thisx: *mut libc::c_void) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    match limbIndex {
        8 => {
            Matrix_MultVec3f(&mut sFootOffset, &mut (*this).backRightFootPos);
        }
        13 => {
            Matrix_MultVec3f(&mut sFootOffset,
                             &mut (*this).frontRightFootPos);
        }
        18 => {
            Matrix_MultVec3f(&mut sFootOffset, &mut (*this).backLeftFootPos);
        }
        23 => {
            Matrix_MultVec3f(&mut sFootOffset, &mut (*this).frontLeftFootPos);
        }
        _ => { }
    }
    BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex, 0 as libc::c_int,
                      24 as libc::c_int, 24 as libc::c_int as u32_0,
                      limbDList, -(1 as libc::c_int) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnTite_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTite = thisx as *mut EnTite;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_tite.c\x00" as *const u8 as *const libc::c_char,
                    1704 as libc::c_int);
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((object_tite_Tex_001300.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_001300.as_mut_ptr()
                                                  as u32_0 &
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((object_tite_Tex_001700.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_001700.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((object_tite_Tex_001900.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_001900.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
        ...
        (*_g_2).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gSegments[((object_tite_Tex_001B00.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_001B00.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
        ...
        (*_g_3).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_3).words.w1 =
            gSegments[((object_tite_Tex_001F00.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_001F00.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
        ...
        (*_g_4).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_4).words.w1 =
            gSegments[((object_tite_Tex_002100.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(object_tite_Tex_002100.as_mut_ptr()
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_tite.c\x00" as *const u8 as
                         *const libc::c_char, 1735 as libc::c_int);
    if (*this).spawnIceTimer as libc::c_int != 0 as libc::c_int {
        // Spawn chunks of ice all over the tektite's body
        (*thisx).colorFilterTimer = (*thisx).colorFilterTimer.wrapping_add(1);
        (*this).spawnIceTimer = (*this).spawnIceTimer.wrapping_sub(1);
        if (*this).spawnIceTimer as libc::c_int & 3 as libc::c_int ==
               0 as libc::c_int {
            let mut iceChunk: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut idx: s32 =
                (*this).spawnIceTimer as libc::c_int >> 2 as libc::c_int;
            iceChunk.x = (*thisx).world.pos.x + sIceChunks[idx as usize].x;
            iceChunk.y = (*thisx).world.pos.y + sIceChunks[idx as usize].y;
            iceChunk.z = (*thisx).world.pos.z + sIceChunks[idx as usize].z;
            EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).actor,
                                           ...
                                           255 as libc::c_int as s16, 1.0f32);
        }
    };
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x45 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).minVelocityY as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(-(40 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
