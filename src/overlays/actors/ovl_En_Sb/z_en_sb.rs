...
extern "C" {
    ...
    fn SkelAnime_Free(skelAnime: *mut SkelAnime,
                      globalCtx: *mut GlobalContext);
    #[no_mangle]
    static mut object_sb_Anim_00004C: AnimationHeader;
    #[no_mangle]
    static mut object_sb_Anim_0000B4: AnimationHeader;
    #[no_mangle]
    static mut object_sb_Anim_000124: AnimationHeader;
    #[no_mangle]
    static mut object_sb_Anim_000194: AnimationHeader;
    #[no_mangle]
    static mut object_sb_Skel_002BF0: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_sb_Anim_002C8C: AnimationHeader;
}
...
pub struct EnSb {
    ...
    pub attackYaw: s16,
    pub bouncesLeft: s16,
    pub hitByWindArrow: u8_0,
}
pub type EnSbActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext) -> ()>;
pub const SHELLBLADE_BOUNCE: C2RustUnnamed_21 = 4;
pub const SHELLBLADE_LUNGE: C2RustUnnamed_21 = 3;
pub const SHELLBLADE_WAIT_OPEN: C2RustUnnamed_21 = 2;
pub const SHELLBLADE_OPEN: C2RustUnnamed_21 = 0;
pub const SHELLBLADE_WAIT_CLOSED: C2RustUnnamed_21 = 1;
pub type C2RustUnnamed_21 = libc::c_uint;
#[no_mangle]
pub static mut En_Sb_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SB as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSb>() as libc::c_ulong,
                          init:
...
pub unsafe extern "C" fn EnSb_Init(mut thisx: *mut Actor,
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_sb_Skel_002BF0, &mut object_sb_Anim_000194,
    ...
    (*this).isDead = 0 as libc::c_int as s16;
    (*this).actor.colChkInfo.mass = 0 as libc::c_int as u8_0;
    Actor_SetScale(&mut (*this).actor, 0.006f32);
    (*this).actor.shape.rot.y = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.gravity = -0.35f32;
    (*this).fire = 0 as libc::c_int as s16;
    (*this).hitByWindArrow = 0 as libc::c_int as u8_0;
    (*this).actor.velocity.y = -1.0f32;
    EnSb_SetupWaitClosed(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSb = thisx as *mut EnSb;
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_SpawnBubbles(mut globalCtx: *mut GlobalContext,
                                           mut this: *mut EnSb) {
    let mut i: s32 = 0;
    if (*this).actor.yDistToWater > 0 as libc::c_int as libc::c_float {
        i = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupWaitClosed(mut this: *mut EnSb) {
    Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_00004C,
                     1.0f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_sb_Anim_00004C as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = SHELLBLADE_WAIT_CLOSED as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_WaitClosed as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupOpen(mut this: *mut EnSb) {
    Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_000194,
                     1.0f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_sb_Anim_000194 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = SHELLBLADE_OPEN as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_Open as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
    Audio_PlayActorSound2(&mut (*this).actor, 0x3849 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupWaitOpen(mut this: *mut EnSb) {
    Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_002C8C,
                     1.0f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_sb_Anim_002C8C as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = SHELLBLADE_WAIT_OPEN as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_WaitOpen as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupLunge(mut this: *mut EnSb) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut object_sb_Anim_000124 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    let mut playbackSpeed: f32_0 =
        if (*this).actor.yDistToWater > 0.0f32 { 1.0f32 } else { 0.0f32 };
    Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_000124,
                     playbackSpeed, 0.0f32, frameCount,
                     ANIMMODE_ONCE as libc::c_int as u8_0,
                     0 as libc::c_int as f32_0);
    (*this).behavior = SHELLBLADE_LUNGE as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_Lunge as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupBounce(mut this: *mut EnSb) {
    Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_0000B4,
                     1.0f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_sb_Anim_0000B4 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = SHELLBLADE_BOUNCE as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_Bounce as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_SetupCooldown(mut this: *mut EnSb,
                                            mut changeSpeed: s32) {
    let mut frameCount: f32_0 =
        Animation_GetLastFrame(&mut object_sb_Anim_00004C as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    if (*this).behavior as libc::c_int !=
           SHELLBLADE_WAIT_CLOSED as libc::c_int {
        Animation_Change(&mut (*this).skelAnime, &mut object_sb_Anim_00004C,
    ...
    if changeSpeed != 0 {
        if (*this).actor.yDistToWater > 0.0f32 {
            ...
            if (*this).actor.velocity.y < 0.0f32 {
                (*this).actor.velocity.y = 2.1f32
            }
        } else {
            (*this).actor.speedXZ = -6.0f32;
            if (*this).actor.velocity.y < 0.0f32 {
                (*this).actor.velocity.y = 1.4f32
            }
        }
    }
    (*this).timer = 60 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnSb_Cooldown as
                 unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_WaitClosed(mut this: *mut EnSb,
                                         mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_Open(mut this: *mut EnSb,
                                   mut globalCtx: *mut GlobalContext) {
    let mut currentFrame: f32_0 = (*this).skelAnime.curFrame;
    if Animation_GetLastFrame(&mut object_sb_Anim_000194 as
                                  *mut AnimationHeader as *mut libc::c_void)
           as libc::c_int as libc::c_float <= currentFrame {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_WaitOpen(mut this: *mut EnSb,
                                       mut globalCtx: *mut GlobalContext) {
    let mut timer: s16 = (*this).timer;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0xa as libc::c_int as s16, 0x7d0 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    ...
    if timer as libc::c_int != 0 as libc::c_int {
        (*this).timer = (timer as libc::c_int - 1 as libc::c_int) as s16
    } else {
        (*this).timer = 0 as libc::c_int as s16;
        (*this).attackYaw = (*this).actor.yawTowardsPlayer;
        (*this).actionFunc =
            Some(EnSb_TurnAround as
                     unsafe extern "C" fn(_: *mut EnSb, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_TurnAround(mut this: *mut EnSb,
                                         mut globalCtx: *mut GlobalContext) {
    let mut invertedYaw: s16 = 0;
    invertedYaw =
        ((*this).attackYaw as libc::c_int + 0x8000 as libc::c_int) as s16;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, invertedYaw,
                       0x1 as libc::c_int as s16,
                       0x1f40 as libc::c_int as s16,
                       0xa as libc::c_int as s16);
    if (*this).actor.shape.rot.y as libc::c_int == invertedYaw as libc::c_int
       {
        ...
        (*this).bouncesLeft = 3 as libc::c_int as s16;
        EnSb_SetupLunge(this);
        // "Attack!!"
        osSyncPrintf(b"\xe3\x82\xa2\xe3\x82\xbf\xe3\x82\xa1\xe3\x80\x9c\xe3\x83\x83\xe3\x82\xaf\xef\xbc\x81\xef\xbc\x81\n\x00"
                         as *const u8 as *const libc::c_char);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_Lunge(mut this: *mut EnSb,
                                    mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.2f32);
    if (*this).actor.velocity.y <= -0.1f32 ||
           (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        if !((*this).actor.yDistToWater > 0.0f32) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_Bounce(mut this: *mut EnSb,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if currentFrame == frameCount {
        if (*this).bouncesLeft as libc::c_int != 0 as libc::c_int {
            (*this).bouncesLeft -= 1;
            ...
            (*this).timer = 1 as libc::c_int as s16;
            EnSb_SetupWaitClosed(this);
            osSyncPrintf(b"\x1b[31m\xe6\x94\xbb\xe6\x92\x83\xe7\xb5\x82\xe4\xba\x86\xef\xbc\x81\xef\xbc\x81\x1b[m\n\x00"
                             as *const u8 as *const libc::c_char);
            // "Attack Complete!"
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_Cooldown(mut this: *mut EnSb,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_IsVulnerable(mut this: *mut EnSb) -> s32 {
    match (*this).behavior as libc::c_int {
        0 => {
        ...
        1 => {
            if (*this).skelAnime.curFrame >= 0.0f32 &&
                   (*this).skelAnime.curFrame <= 1.0f32 {
                return 1 as libc::c_int
            }
        }
        2 => {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_UpdateDamage(mut this: *mut EnSb,
                                           mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut hitPoint: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut hitY: f32_0 = 0.;
    let mut yawDiff: s16 = 0;
    let mut tookDamage: s32 = 0;
    let mut hitByWindArrow: u8_0 = 0;
    // hit box collided, switch to cool down
    if (*this).collider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        EnSb_SetupCooldown(this, 1 as libc::c_int);
        return 1 as libc::c_int
    }
    // hurt box collided, take damage if appropriate
    if (*this).collider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        hitByWindArrow = 0 as libc::c_int as u8_0;
        tookDamage = 0 as libc::c_int;
        ...
        match (*this).actor.colChkInfo.damageEffect as libc::c_int {
            14 => {
                // wind arrow
                hitByWindArrow = 1 as libc::c_int as u8_0;
                current_block_30 = 8002499179692188734;
            }
            15 => { current_block_30 = 8002499179692188734; }
            2 => {
                // fire arrow, dins fire
                (*this).fire = 4 as libc::c_int as s16;
                ...
                tookDamage = 1 as libc::c_int;
                current_block_30 = 7333393191927787629;
            }
            1 | 13 => {
                // hookshot/longshot
                // all sword damage
                if EnSb_IsVulnerable(this) != 0 {
                    hitY =
                        (*this).collider.info.bumper.hitPos.y as libc::c_int
                            as libc::c_float - (*this).actor.world.pos.y;
                    yawDiff =
                        ((*this).actor.yawTowardsPlayer as libc::c_int -
                             (*this).actor.shape.rot.y as libc::c_int) as s16;
                    if hitY < 30.0f32 && hitY > 10.0f32 &&
                           yawDiff as libc::c_int >= -(0x1fff as libc::c_int)
                           && (yawDiff as libc::c_int) < 0x2000 as libc::c_int
                       {
                        Actor_ApplyDamage(&mut (*this).actor);
                        Actor_SetColorFilter(&mut (*this).actor,
                                             0x4000 as libc::c_int as s16,
                                             ...
                                             0x50 as libc::c_int as s16);
                        tookDamage = 1 as libc::c_int;
                        EnSb_SetupCooldown(this, 0 as libc::c_int);
                    }
                }
                current_block_30 = 7333393191927787629;
            }
            _ => { current_block_30 = 7333393191927787629; }
        }
        match current_block_30 {
            8002499179692188734 => {
                // explosions, arrow, hammer, ice arrow, light arrow, spirit arrow, shadow arrow
                if EnSb_IsVulnerable(this) != 0 {
                    hitY =
                        (*this).collider.info.bumper.hitPos.y as libc::c_int
                            as libc::c_float - (*this).actor.world.pos.y;
        ...
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            ...
            BodyBreak_Alloc(&mut (*this).bodyBreak, 8 as libc::c_int,
                            globalCtx);
            (*this).isDead = 1 as libc::c_int as s16;
            Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
            Audio_PlaySoundAtPosition(globalCtx, &mut (*this).actor.world.pos,
                                      40 as libc::c_int,
                                      0x384a as libc::c_int as u16_0);
            return 1 as libc::c_int
        }
        // if player attack didn't do damage, play recoil sound and spawn sparks
        if tookDamage == 0 {
            hitPoint.x = (*this).collider.info.bumper.hitPos.x as f32_0;
            hitPoint.y = (*this).collider.info.bumper.hitPos.y as f32_0;
            hitPoint.z = (*this).collider.info.bumper.hitPos.z as f32_0;
            CollisionCheck_SpawnShieldParticlesMetal2(globalCtx,
                                                      &mut hitPoint);
        }
    }
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSb = thisx as *mut EnSb;
    let mut pad: s32 = 0;
    if (*this).isDead != 0 {
        if (*this).actor.yDistToWater > 0.0f32 {
            (*this).actor.params = 4 as libc::c_int as s16
        } else { (*this).actor.params = 1 as libc::c_int as s16 }
        if BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
                                globalCtx, (*this).actor.params) != 0 {
            if (*this).hitByWindArrow == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnSb_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
    ...
    BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex, 0 as libc::c_int,
                      6 as libc::c_int, 8 as libc::c_int as u32_0, dList,
                      -(1 as libc::c_int) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnSb_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnSb = thisx as *mut EnSb;
    let mut flamePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut offset: *mut Vec3f = 0 as *mut Vec3f;
    let mut fireDecr: s16 = 0;
    ...
    if (*this).fire as libc::c_int != 0 as libc::c_int {
        (*this).actor.colorFilterTimer =
            (*this).actor.colorFilterTimer.wrapping_add(1);
        fireDecr = ((*this).fire as libc::c_int - 1 as libc::c_int) as s16;
        ...
        if fireDecr as libc::c_int & 1 as libc::c_int == 0 as libc::c_int {
            offset =
                &mut *sFlamePosOffsets.as_mut_ptr().offset((fireDecr as
                                                                libc::c_int &
                                                                3 as
                                                                    libc::c_int)
                                                               as isize) as
            ...
            flamePos.x =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.x + (*offset).x);
            flamePos.y =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.y + (*offset).y);
            flamePos.z =
                Rand_CenteredFloat(5.0f32) +
                    ((*this).actor.world.pos.z + (*offset).z);
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x27 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
