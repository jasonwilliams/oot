 ...
 */
#[no_mangle]
pub unsafe extern "C" fn Opening_SetupTitleScreen(mut this:
                                                      *mut OpeningContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80803C5C(mut this: *mut OpeningContext) { }
#[no_mangle]
pub unsafe extern "C" fn Opening_Main(mut thisx: *mut GameState) {
    let mut this: *mut OpeningContext = thisx as *mut OpeningContext;
...
#[no_mangle]
pub unsafe extern "C" fn Opening_Destroy(mut thisx: *mut GameState) { }
#[no_mangle]
pub unsafe extern "C" fn Opening_Init(mut thisx: *mut GameState) {
    let mut this: *mut OpeningContext = thisx as *mut OpeningContext;
    ...
    (*this).state.main =
        Some(Opening_Main as unsafe extern "C" fn(_: *mut GameState) -> ());
    (*this).state.destroy =
        Some(Opening_Destroy as
