...
pub const ITEM00_BOMBS_SPECIAL: C2RustUnnamed_14 = 25;
pub const ITEM00_TUNIC_GORON: C2RustUnnamed_14 = 24;
pub const ITEM00_TUNIC_ZORA: C2RustUnnamed_14 = 23;
pub const ITEM00_SHIELD_HYLIAN: C2RustUnnamed_14 = 22;
pub const ITEM00_SHIELD_DEKU: C2RustUnnamed_14 = 21;
pub const ITEM00_RUPEE_PURPLE: C2RustUnnamed_14 = 20;
pub const ITEM00_RUPEE_ORANGE: C2RustUnnamed_14 = 19;
pub const ITEM00_FLEXIBLE: C2RustUnnamed_14 = 18;
pub const ITEM00_SMALL_KEY: C2RustUnnamed_14 = 17;
pub const ITEM00_SEEDS: C2RustUnnamed_14 = 16;
pub const ITEM00_MAGIC_SMALL: C2RustUnnamed_14 = 15;
pub const ITEM00_MAGIC_LARGE: C2RustUnnamed_14 = 14;
pub const ITEM00_STICK: C2RustUnnamed_14 = 13;
pub const ITEM00_NUTS: C2RustUnnamed_14 = 12;
pub const ITEM00_BOMBS_B: C2RustUnnamed_14 = 11;
pub const ITEM00_ARROWS_LARGE: C2RustUnnamed_14 = 10;
pub const ITEM00_ARROWS_MEDIUM: C2RustUnnamed_14 = 9;
pub const ITEM00_ARROWS_SMALL: C2RustUnnamed_14 = 8;
pub const ITEM00_HEART_CONTAINER: C2RustUnnamed_14 = 7;
pub const ITEM00_HEART_PIECE: C2RustUnnamed_14 = 6;
pub const ITEM00_ARROWS_SINGLE: C2RustUnnamed_14 = 5;
pub const ITEM00_BOMBS_A: C2RustUnnamed_14 = 4;
pub const ITEM00_HEART: C2RustUnnamed_14 = 3;
pub const ITEM00_RUPEE_RED: C2RustUnnamed_14 = 2;
pub const ITEM00_RUPEE_BLUE: C2RustUnnamed_14 = 1;
pub const ITEM00_RUPEE_GREEN: C2RustUnnamed_14 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnItem00 {
    pub actor: Actor,
...
pub const ENDIVINGGAME_PHASE_2: C2RustUnnamed_18 = 2;
pub const ENDIVINGGAME_PHASE_1: C2RustUnnamed_18 = 1;
pub const ENDIVINGGAME_PHASE_ENDED: C2RustUnnamed_18 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnExRuppyParentActor {
    pub actor: Actor,
    pub unk_14C: [libc::c_char; 282],
    pub unk_226: s16,
}
static mut sEnExRuppyCollectibleTypes: [s16; 5] =
    [ITEM00_RUPEE_GREEN as libc::c_int as s16,
     ITEM00_RUPEE_BLUE as libc::c_int as s16,
     ITEM00_RUPEE_RED as libc::c_int as s16,
     ITEM00_RUPEE_ORANGE as libc::c_int as s16,
     ITEM00_RUPEE_PURPLE as libc::c_int as s16];
#[no_mangle]
pub static mut En_Ex_Ruppy_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_EX_RUPPY as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnExRuppy_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnExRuppy_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnExRuppy = thisx as *mut EnExRuppy;
    let mut divingGame: *mut EnDivingGame = 0 as *mut EnDivingGame;
    ...
    match (*this).type_0 as libc::c_int {
        0 => {
            (*this).unk_160 = 0.01f32;
            Actor_SetScale(&mut (*this).actor, (*this).unk_160);
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                ...
                (*this).rupeeValue = 5 as libc::c_int as s16;
                (*this).colorIdx = 1 as libc::c_int as s16
            } else {
                temp1 = 200.99f32;
                if !(*this).actor.parent.is_null() {
                    divingGame = (*this).actor.parent as *mut EnDivingGame;
                    if (*divingGame).actor.update.is_some() {
                        temp2 =
                            (*divingGame).extraWinCount as libc::c_int as
                                libc::c_float * 10.0f32;
                        temp1 += temp2
                    }
                }
                temp3 = Rand_ZeroFloat(temp1) as s16;
                if temp3 as libc::c_int >= 0 as libc::c_int &&
                       (temp3 as libc::c_int) < 40 as libc::c_int {
                    (*this).rupeeValue = 1 as libc::c_int as s16;
                    (*this).colorIdx = 0 as libc::c_int as s16
                } else if temp3 as libc::c_int >= 40 as libc::c_int &&
                              (temp3 as libc::c_int) < 170 as libc::c_int {
                    (*this).rupeeValue = 5 as libc::c_int as s16;
                    (*this).colorIdx = 1 as libc::c_int as s16
                } else if temp3 as libc::c_int >= 170 as libc::c_int &&
                              (temp3 as libc::c_int) < 190 as libc::c_int {
                    (*this).rupeeValue = 20 as libc::c_int as s16;
                    (*this).colorIdx = 2 as libc::c_int as s16
                } else if temp3 as libc::c_int >= 190 as libc::c_int &&
                              (temp3 as libc::c_int) < 200 as libc::c_int {
                    (*this).rupeeValue = 50 as libc::c_int as s16;
                    (*this).colorIdx = 4 as libc::c_int as s16
                } else {
                    (*this).unk_160 = 0.02f32;
                    Actor_SetScale(&mut (*this).actor, (*this).unk_160);
                    (*this).rupeeValue = 500 as libc::c_int as s16;
                    (*this).colorIdx = 3 as libc::c_int as s16;
                    if !(*this).actor.parent.is_null() {
                        divingGame =
                            (*this).actor.parent as *mut EnDivingGame;
                        if (*divingGame).actor.update.is_some() {
                            (*divingGame).extraWinCount =
                                0 as libc::c_int as s16
                        }
                    }
                }
            }
            (*this).actor.shape.shadowScale = 7.0f32;
            ...
            (*this).actionFunc =
                Some(EnExRuppy_DropIntoWater as
                         unsafe extern "C" fn(_: *mut EnExRuppy,
                                              _: *mut GlobalContext) -> ())
        }
        1 | 2 => {
            // Giant pink ruppe that explodes when you touch it
            if (*this).type_0 as libc::c_int == 1 as libc::c_int {
                Actor_SetScale(&mut (*this).actor, 0.1f32);
                (*this).colorIdx = 4 as libc::c_int as s16
            } else {
                Actor_SetScale(thisx, 0.02f32);
                (*this).colorIdx =
                    (Rand_ZeroFloat(3.99f32) as s16 as libc::c_int +
                         1 as libc::c_int) as s16
            }
            (*this).actor.gravity = -3.0f32;
            // "Wow Coin"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\x8f\xe3\x83\xbc\xe3\x81\xaa\xe3\x83\xbc\xe3\x82\xb3\xe3\x82\xa4\xe3\x83\xb3 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actor.shape.shadowScale = 6.0f32;
            (*this).actor.shape.yOffset = 700.0f32;
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            (*this).actionFunc =
                Some(EnExRuppy_WaitToBlowUp as
                         unsafe extern "C" fn(_: *mut EnExRuppy,
                                              _: *mut GlobalContext) -> ())
        }
        3 => {
            // Spawned by the guard in Hyrule courtyard
            Actor_SetScale(&mut (*this).actor, 0.02f32);
            (*this).colorIdx = 0 as libc::c_int as s16;
            match Rand_ZeroFloat(30.99f32) as s16 as libc::c_int {
                0 => { (*this).colorIdx = 2 as libc::c_int as s16 }
                10 | 20 | 30 => { (*this).colorIdx = 1 as libc::c_int as s16 }
                _ => { }
            }
            (*this).actor.gravity = -3.0f32;
            // "Normal rupee"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x8e\xe3\x83\xbc\xe3\x83\x9e\xe3\x83\xab\xe3\x83\xab\xe3\x83\x94\xe3\x83\xbc \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            (*this).actor.shape.shadowScale = 6.0f32;
            (*this).actor.shape.yOffset = 700.0f32;
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            (*this).actionFunc =
                Some(EnExRuppy_WaitAsCollectible as
                         unsafe extern "C" fn(_: *mut EnExRuppy,
                                              _: *mut GlobalContext) -> ())
        }
        4 => {
            // Progress markers in the shooting gallery
            (*this).actor.gravity =
                -3.0f32; // Net effect is this->invisible = !this->invisible;
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            ...
            (*this).actor.shape.yOffset = -700.0f32;
            (*this).actionFunc =
                Some(EnExRuppy_GalleryTarget as
                         unsafe extern "C" fn(_: *mut EnExRuppy,
                                              _: *mut GlobalContext) -> ())
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_SpawnSparkles(mut this: *mut EnExRuppy,
                                                 mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut numSparkles: s16,
                                                 mut movementType: s32) {
    static mut velocities: [Vec3f; 2] =
        [{ let mut init = Vec3f{x: 0.0f32, y: 0.1f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init }];
    static mut accelerations: [Vec3f; 2] =
    ...
    let mut scale: s16 = 0;
    let mut life: s16 = 0;
    if (numSparkles as libc::c_int) < 1 as libc::c_int {
        numSparkles = 1 as libc::c_int as s16
    }
    ...
    envColor.b = 255 as libc::c_int as u8_0;
    velocity = velocities[movementType as usize];
    accel = accelerations[movementType as usize];
    scale = 3000 as libc::c_int as s16;
    life = 16 as libc::c_int as s16;
    i = 0 as libc::c_int;
    while i < numSparkles as libc::c_int {
        if movementType == 1 as libc::c_int {
            accel.x = Rand_CenteredFloat(20.0f32);
            accel.z = Rand_CenteredFloat(20.0f32);
            scale = 5000 as libc::c_int as s16;
            life = 20 as libc::c_int as s16
        }
        pos.x =
            (Rand_ZeroOne() - 0.5f32) * 10.0f32 + (*this).actor.world.pos.x;
        pos.y =
            (Rand_ZeroOne() - 0.5f32) * 10.0f32 +
                ((*this).actor.world.pos.y + (*this).unk_160 * 600.0f32);
        pos.z =
            (Rand_ZeroOne() - 0.5f32) * 10.0f32 + (*this).actor.world.pos.z;
        EffectSsKiraKira_SpawnDispersed(globalCtx, &mut pos, &mut velocity,
                                        &mut accel, &mut primColor,
                                        &mut envColor, scale, life as s32);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_DropIntoWater(mut this: *mut EnExRuppy,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut divingGame: *mut EnDivingGame = 0 as *mut EnDivingGame;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x7a8 as libc::c_int) as
            s16;
    Math_ApproachF(&mut (*this).actor.gravity, -2.0f32, 0.3f32, 1.0f32);
    EnExRuppy_SpawnSparkles(this, globalCtx, 2 as libc::c_int as s16,
                            0 as libc::c_int);
    func_80078884((0x28bc as libc::c_int - 0x800 as libc::c_int) as u16_0);
    divingGame = (*this).actor.parent as *mut EnDivingGame;
    if !divingGame.is_null() && (*divingGame).actor.update.is_some() &&
           ((*divingGame).unk_296 as libc::c_int == 0 as libc::c_int ||
        ...
        (*this).actionFunc =
            Some(EnExRuppy_EnterWater as
                     unsafe extern "C" fn(_: *mut EnExRuppy,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_EnterWater(mut this: *mut EnExRuppy,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut divingGame: *mut EnDivingGame =
        (*this).actor.parent as *mut EnDivingGame;
    let mut temp_f2: f32_0 = 0.;
    if !divingGame.is_null() && (*divingGame).actor.update.is_some() &&
           (*divingGame).unk_2A2 as libc::c_int == 2 as libc::c_int {
        (*this).invisible = 0 as libc::c_int as s16;
        (*this).actor.world.pos.x =
            (Rand_ZeroOne() - 0.5f32) * 300.0f32 + -260.0f32;
        (*this).actor.world.pos.y =
            (Rand_ZeroOne() - 0.5f32) * 200.0f32 + 370.0f32;
        temp_f2 = (*this).unk_15A as libc::c_int as libc::c_float * -50.0f32;
        if gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               & 0x100 as libc::c_int == 0 {
            temp_f2 += -500.0f32;
            (*this).actor.world.pos.z =
                (Rand_ZeroOne() - 0.5f32) * 80.0f32 + temp_f2
        } else {
            temp_f2 += -300.0f32;
            (*this).actor.world.pos.z =
                (Rand_ZeroOne() - 0.5f32) * 60.0f32 + temp_f2
        }
        (*this).actionFunc =
            Some(EnExRuppy_Sink as
                     unsafe extern "C" fn(_: *mut EnExRuppy,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Sink(mut this: *mut EnExRuppy,
                                        mut globalCtx: *mut GlobalContext) {
    let mut divingGame: *mut EnDivingGame = 0 as *mut EnDivingGame;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: s32 = 0;
    if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int != 0 &&
           (*this).actor.yDistToWater > 15.0f32 {
        ...
        func_80078914(&mut (*this).actor.projectedPos,
                      0x2817 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(EnExRuppy_WaitInGame as
                     unsafe extern "C" fn(_: *mut EnExRuppy,
                                          _: *mut GlobalContext) -> ())
    }
    divingGame = (*this).actor.parent as *mut EnDivingGame;
    if !divingGame.is_null() && (*divingGame).actor.update.is_some() &&
           (*divingGame).phase as libc::c_int ==
               ENDIVINGGAME_PHASE_ENDED as libc::c_int {
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnExRuppy_Kill as
                     unsafe extern "C" fn(_: *mut EnExRuppy,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_WaitInGame(mut this: *mut EnExRuppy,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut divingGame: *mut EnDivingGame = 0 as *mut EnDivingGame;
    let mut D_80A0B388: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.1f32, z: 0.0f32,}; init };
    let mut D_80A0B394: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut localConst: f32_0 = 30.0f32;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).timer = 10 as libc::c_int as s16;
        EffectSsBubble_Spawn(globalCtx, &mut (*this).actor.world.pos, 0.0f32,
                             5.0f32, 5.0f32,
                             Rand_ZeroFloat(0.03f32) + 0.07f32);
    }
    if !(*this).actor.parent.is_null() {
        divingGame = (*this).actor.parent as *mut EnDivingGame;
        if (*divingGame).actor.update.is_some() {
            if (*divingGame).phase as libc::c_int ==
                   ENDIVINGGAME_PHASE_ENDED as libc::c_int {
                (*this).timer = 20 as libc::c_int as s16;
                (*this).actionFunc =
                    Some(EnExRuppy_Kill as
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Kill(mut this: *mut EnExRuppy,
                                        mut globalCtx: *mut GlobalContext) {
    (*this).invisible =
        ((*this).invisible as libc::c_int + 1 as libc::c_int) as s16;
    (*this).invisible =
        ((*this).invisible as libc::c_int & 1 as libc::c_int) as s16;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
...
// Unclear what actor was intended to spawn this.
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_WaitToBlowUp(mut this: *mut EnExRuppy,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut parent: *mut EnExRuppyParentActor =
        0 as *mut EnExRuppyParentActor;
    let mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.1f32, z: 0.0f32,}; init };
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut distToBlowUp: f32_0 = 50.0f32;
    let mut explosionScale: s16 = 0;
    let mut explosionScaleStep: s16 = 0;
    if (*this).type_0 as libc::c_int == 2 as libc::c_int {
        distToBlowUp = 30.0f32
    }
    if (*this).actor.xyzDistToPlayerSq < distToBlowUp * distToBlowUp {
        parent = (*this).actor.parent as *mut EnExRuppyParentActor;
        if !parent.is_null() {
            if (*parent).actor.update.is_some() {
                (*parent).unk_226 = 1 as libc::c_int as s16
            }
        } else {
            // "That idiot! error"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x9d\xe3\x80\x81\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe3\x81\xb0\xe3\x81\x8b\xe3\x81\xaa\xef\xbc\x81\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as
                             *const libc::c_char); // "Stupid!"
        }
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\x90\xe3\x82\xab\xe3\x82\x81\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        explosionScale = 100 as libc::c_int as s16;
        explosionScaleStep = 30 as libc::c_int as s16;
        if (*this).type_0 as libc::c_int == 2 as libc::c_int {
            explosionScale = 20 as libc::c_int as s16;
            explosionScaleStep = 6 as libc::c_int as s16
        }
        EffectSsBomb2_SpawnLayered(globalCtx, &mut (*this).actor.world.pos,
                                   &mut velocity, &mut accel, explosionScale,
                                   explosionScaleStep);
        func_8002F71C(globalCtx, &mut (*this).actor, 2.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_WaitAsCollectible(mut this: *mut EnExRuppy,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut localConst: f32_0 = 30.0f32;
    if (*this).actor.xyzDistToPlayerSq < localConst * localConst {
        func_80078884(0x4803 as libc::c_int as u16_0);
        Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                             (sEnExRuppyCollectibleTypes[(*this).colorIdx as
                                                             usize] as
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_GalleryTarget(mut this: *mut EnExRuppy,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).galleryFlag != 0 {
        Math_ApproachF(&mut (*this).actor.shape.yOffset, 700.0f32, 0.5f32,
                       200.0f32);
    } else {
        Math_ApproachF(&mut (*this).actor.shape.yOffset, -700.0f32, 0.5f32,
                       200.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnExRuppy = thisx as *mut EnExRuppy;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 1960 as libc::c_int) as
            s16;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 20.0f32,
                            50.0f32, 0x1c as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnExRuppy_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    static mut rupeeTextures: [*mut libc::c_void; 5] =
        unsafe {
    ...
    if (*this).invisible == 0 {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_ex_ruppy.c\x00" as *const u8 as
                            *const libc::c_char, 774 as libc::c_int);
        ...
        (*_g_0).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gSegments[((rupeeTextures[(*this).colorIdx as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(rupeeTextures[(*this).colorIdx
                                                                as usize] as
                                                  u32_0 &
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_ex_ruppy.c\x00" as *const u8 as
                             *const libc::c_char, 784 as libc::c_int);
    };
}
