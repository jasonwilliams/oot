...
pub const LEEVER_BIG: C2RustUnnamed_20 = 1;
pub const LEEVER_SMALL: C2RustUnnamed_20 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const SPAWNER_WOLFOS: C2RustUnnamed_21 = 3;
pub const SPAWNER_STALCHILDREN: C2RustUnnamed_21 = 2;
pub const SPAWNER_TEKTITE: C2RustUnnamed_21 = 1;
pub const SPAWNER_LEEVER: C2RustUnnamed_21 = 0;
pub type C2RustUnnamed_22 = libc::c_int;
pub const TEKTITE_RED: C2RustUnnamed_22 = -1;
pub const TEKTITE_BLUE: C2RustUnnamed_22 = -2;
static mut sLeeverAngles: [s16; 5] =
    [0 as libc::c_int as s16, 0x2710 as libc::c_int as s16,
     0x7148 as libc::c_int as s16, 0x8eb8 as libc::c_int as s16,
     0xd8f0 as libc::c_int as s16];
static mut sLeeverDists: [f32_0; 5] =
    [200.0f32, 170.0f32, 120.0f32, 120.0f32, 170.0f32];
#[no_mangle]
pub static mut En_Encount1_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ENCOUNT1 as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEncount1_Init
                                                                          as
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEncount1_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount1_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnEncount1 = thisx as *mut EnEncount1;
    let mut spawnRange: f32_0 = 0.;
    if (*this).actor.params as libc::c_int <= 0 as libc::c_int {
        osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        // "Input error death!"
        osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x85\xa5\xe5\x8a\x9b\xe3\x82\xa8\xe3\x83\xa9\xe3\x83\xbc\xe3\x83\x87\xe3\x83\x83\xe3\x82\xb9\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
    ...
    (*this).totalNumSpawn = 0 as libc::c_int as s16;
    (*this).curNumSpawn = (*this).totalNumSpawn;
    spawnRange =
        120.0f32 +
            40.0f32 *
    ...
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x95\xb5\xe7\x99\xba\xe7\x94\x9f\xe3\x82\xbe\xe3\x83\xbc\xe3\x83\xb3\xe3\x81\xa7\xe3\x81\x9f\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
    // "Type"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\xa8\xae\xe9\xa1\x9e\t\t   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).spawnType as libc::c_int);
    // "Maximum number of simultaneous spawns"
    osSyncPrintf(b"\x1b[35m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9c\x80\xe5\xa4\xa7\xe5\x90\x8c\xe6\x99\x82\xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb0     \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).maxCurSpawns as libc::c_int);
    // "Maximum number of spawns"
    osSyncPrintf(b"\x1b[36m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe6\x9c\x80\xe5\xa4\xa7\xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb0  \t   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).maxTotalSpawns as libc::c_int);
    // "Spawn check range"
    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x83\x81\xe3\x82\xa7\xe3\x83\x83\xe3\x82\xaf\xe7\xaf\x84\xe5\x9b\xb2   \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).spawnRange as libc::c_double);
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    match (*this).spawnType as libc::c_int {
        0 => {
            (*this).timer = 30 as libc::c_int as s16;
            (*this).maxCurSpawns = 5 as libc::c_int as s16;
            if (*globalCtx).sceneNum as libc::c_int ==
                   SCENE_SPOT13 as libc::c_int {
                // Haunted Wasteland
                (*this).reduceLeevers = 1 as libc::c_int as u8_0;
                (*this).maxCurSpawns = 3 as libc::c_int as s16
            }
            (*this).updateFunc =
                Some(EnEncount1_SpawnLeevers as
                         unsafe extern "C" fn(_: *mut EnEncount1,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
            (*this).maxCurSpawns = 2 as libc::c_int as s16;
            (*this).updateFunc =
                Some(EnEncount1_SpawnTektites as
                         unsafe extern "C" fn(_: *mut EnEncount1,
                                              _: *mut GlobalContext) -> ())
        }
        2 | 3 => {
            if (*globalCtx).sceneNum as libc::c_int ==
                ...
                // Hyrule Field
                (*this).maxTotalSpawns = 10000 as libc::c_int as s16
            }
            (*this).updateFunc =
                Some(EnEncount1_SpawnStalchildOrWolfos as
                         unsafe extern "C" fn(_: *mut EnEncount1,
                                              _: *mut GlobalContext) -> ())
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount1_SpawnLeevers(mut this: *mut EnEncount1,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    let mut spawnParams: s32 = 0;
    let mut spawnLimit: s16 = 0;
    let mut spawnAngle: s16 = 0;
    let mut spawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut floorPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgId: s32 = 0;
    let mut floorY: f32_0 = 0.;
    let mut leever: *mut EnReeba = 0 as *mut EnReeba;
    (*this).outOfRangeTimer = 0 as libc::c_int as s16;
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           ...
           (*this).curNumSpawn as libc::c_int <=
               (*this).maxCurSpawns as libc::c_int &&
           ((*this).curNumSpawn as libc::c_int) < 5 as libc::c_int {
        floorType =
            func_80041D4C(&mut (*globalCtx).colCtx, (*player).actor.floorPoly,
                          (*player).actor.floorBgId as s32) as s32;
        if floorType != 4 as libc::c_int && floorType != 7 as libc::c_int &&
               floorType != 12 as libc::c_int {
            (*this).numLeeverSpawns = 0 as libc::c_int as s16
        } else if !((*this).reduceLeevers as libc::c_int != 0 &&
                        (*this).actor.xzDistToPlayer > 1300.0f32) {
            spawnLimit = 5 as libc::c_int as s16;
            if (*this).reduceLeevers != 0 {
                spawnLimit = 3 as libc::c_int as s16
            }
            while ((*this).curNumSpawn as libc::c_int) <
                      (*this).maxCurSpawns as libc::c_int &&
                      ((*this).curNumSpawn as libc::c_int) <
                          spawnLimit as libc::c_int &&
                      (*this).timer as libc::c_int == 0 as libc::c_int {
                spawnDist = sLeeverDists[(*this).leeverIndex as usize];
                spawnAngle =
                    (sLeeverAngles[(*this).leeverIndex as usize] as
                         libc::c_int +
                         (*player).actor.shape.rot.y as libc::c_int) as s16;
                spawnParams = LEEVER_SMALL as libc::c_int;
                if (*this).killCount as libc::c_int >= 10 as libc::c_int &&
                       (*this).bigLeever.is_null() {
                    (*this).numLeeverSpawns = 0 as libc::c_int as s16;
                    (*this).killCount = (*this).numLeeverSpawns;
                    spawnAngle = sLeeverAngles[0 as libc::c_int as usize];
                    spawnDist = sLeeverDists[2 as libc::c_int as usize];
                    spawnParams = LEEVER_BIG as libc::c_int
                }
                spawnPos.x =
                    (*player).actor.world.pos.x +
                        Math_SinS(spawnAngle) * spawnDist;
                spawnPos.y = (*player).actor.floorHeight + 120.0f32;
                spawnPos.z =
                    (*player).actor.world.pos.z +
                        Math_CosS(spawnAngle) * spawnDist;
                floorY =
                    BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                                &mut floorPoly, &mut bgId,
                                                &mut (*this).actor,
                                                &mut spawnPos);
                if floorY <= -32000.0f32 { break ; }
                spawnPos.y = floorY;
                leever =
                    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                       &mut (*this).actor, globalCtx,
                                       ACTOR_EN_REEBA as libc::c_int as s16,
                                       spawnPos.x, spawnPos.y, spawnPos.z,
                                       0 as libc::c_int as s16,
                                       0 as libc::c_int as s16,
                                       0 as libc::c_int as s16,
                                       spawnParams as s16) as *mut EnReeba;
                if !leever.is_null() {
                    (*this).curNumSpawn += 1;
                    let fresh0 = (*this).leeverIndex;
                    (*this).leeverIndex = (*this).leeverIndex + 1;
                    (*leever).unk_280 = fresh0;
                    if (*this).leeverIndex as libc::c_int >= 5 as libc::c_int
                       {
                        (*this).leeverIndex = 0 as libc::c_int as s16
                    }
                    (*this).numLeeverSpawns += 1;
                    if (*this).numLeeverSpawns as libc::c_int >=
                           12 as libc::c_int {
                        (*this).timer = 150 as libc::c_int as s16;
                        (*this).numLeeverSpawns = 0 as libc::c_int as s16
                    }
                    if spawnParams != LEEVER_SMALL as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount1_SpawnTektites(mut this: *mut EnEncount1,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        if fabsf((*player).actor.world.pos.y - (*this).actor.world.pos.y) >
               100.0f32 || (*this).actor.xzDistToPlayer > (*this).spawnRange {
            (*this).outOfRangeTimer += 1
        } else {
            (*this).outOfRangeTimer = 0 as libc::c_int as s16;
            if ((*this).curNumSpawn as libc::c_int) <
                   (*this).maxCurSpawns as libc::c_int &&
                   ((*this).totalNumSpawn as libc::c_int) <
                       (*this).maxTotalSpawns as libc::c_int {
                spawnPos.x =
                    (*this).actor.world.pos.x + Rand_CenteredFloat(50.0f32);
                spawnPos.y = (*this).actor.world.pos.y + 120.0f32;
                spawnPos.z =
                    (*this).actor.world.pos.z + Rand_CenteredFloat(50.0f32);
                floorY =
                    BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                                &mut floorPoly, &mut bgId,
                                                &mut (*this).actor,
                                                &mut spawnPos);
                if floorY <= -32000.0f32 { return }
                spawnPos.y = floorY;
                if !Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                       &mut (*this).actor, globalCtx,
                                       ACTOR_EN_TITE as libc::c_int as s16,
                                       spawnPos.x, spawnPos.y, spawnPos.z,
                                       0 as libc::c_int as s16,
                                       0 as libc::c_int as s16,
                                       0 as libc::c_int as s16,
                                       TEKTITE_RED as libc::c_int as
                                           s16).is_null() {
                    // Red tektite
                    (*this).curNumSpawn += 1;
                    (*this).totalNumSpawn += 1
                } else {
                    // "Cannot spawn!"
                    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x99\xba\xe7\x94\x9f\xe3\x81\xa7\xe3\x81\x8d\xe3\x81\xbe\xe3\x81\x9b\xe3\x82\x93\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount1_SpawnStalchildOrWolfos(mut this:
                                                               *mut EnEncount1,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
    let mut player: *mut Player =
    ...
    let mut spawnDist: f32_0 = 0.;
    let mut spawnAngle: s16 = 0;
    let mut spawnId: s16 = 0;
    let mut spawnParams: s16 = 0;
    let mut kcOver10: s16 = 0;
    let mut tempmod: s16 = 0;
    let mut spawnPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut floorPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut bgId: s32 = 0;
    let mut floorY: f32_0 = 0.;
    if (*globalCtx).sceneNum as libc::c_int != SCENE_SPOT00 as libc::c_int {
        ...
        (*this).killCount = 0 as libc::c_int as s16;
        return
    }
    (*this).outOfRangeTimer = 0 as libc::c_int as s16;
    spawnPos = (*this).actor.world.pos;
    if ((*this).curNumSpawn as libc::c_int) <
        ...
        while ((*this).curNumSpawn as libc::c_int) <
            ...
            if (*globalCtx).sceneNum as libc::c_int ==
                   SCENE_SPOT00 as libc::c_int {
                if (*player).unk_89E as libc::c_int == 0 as libc::c_int ||
                       (*player).actor.floorBgId as libc::c_int !=
                           50 as libc::c_int ||
                       (*player).actor.bgCheckFlags as libc::c_int &
                           1 as libc::c_int == 0 ||
                       (*player).stateFlags1 &
                           0x8000000 as libc::c_int as libc::c_uint != 0 {
                    (*this).fieldSpawnTimer = 60 as libc::c_int as s16;
                    break ;
                } else {
                    if (*this).fieldSpawnTimer as libc::c_int ==
                           60 as libc::c_int {
                        (*this).maxCurSpawns = 2 as libc::c_int as s16
                    }
                    if (*this).fieldSpawnTimer as libc::c_int !=
                           0 as libc::c_int {
                        (*this).fieldSpawnTimer -= 1;
                        break ;
                    } else {
                        spawnDist = Rand_CenteredFloat(40.0f32) + 200.0f32;
                        spawnAngle = (*player).actor.shape.rot.y;
                        if (*this).curNumSpawn as libc::c_int !=
                               0 as libc::c_int {
                            spawnAngle = -(spawnAngle as libc::c_int) as s16;
                            spawnDist = Rand_CenteredFloat(40.0f32) + 100.0f32
                        }
                        spawnPos.x =
                            (*player).actor.world.pos.x +
                                Math_SinS(spawnAngle) * spawnDist +
                        ...
                        floorY =
                            BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                                        ...
                                                        &mut spawnPos);
                        if floorY <= -32000.0f32 { break ; }
                        if (*player).actor.yDistToWater != -32000.0f32 &&
                               floorY <
            ...
            if (*this).spawnType as libc::c_int ==
                   SPAWNER_WOLFOS as libc::c_int {
                spawnId = ACTOR_EN_WF as libc::c_int as s16;
                spawnParams =
                    ((0xff as libc::c_int) << 8 as libc::c_int |
                         0 as libc::c_int) as s16
            } else {
                spawnId = ACTOR_EN_SKB as libc::c_int as s16;
                spawnParams = 0 as libc::c_int as s16;
                kcOver10 =
                    ((*this).killCount as libc::c_int / 10 as libc::c_int) as
                        s16;
                if kcOver10 as libc::c_int > 0 as libc::c_int {
                    tempmod =
                        ((*this).killCount as libc::c_int % 10 as libc::c_int)
                            as s16;
                    if tempmod as libc::c_int == 0 as libc::c_int {
                        spawnParams =
                            (kcOver10 as libc::c_int * 5 as libc::c_int) as
                                s16
                    }
                }
                (*this).killCount += 1
            ...
            if !Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   &mut (*this).actor, globalCtx, spawnId,
                                   spawnPos.x, spawnPos.y, spawnPos.z,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                                   0 as libc::c_int as s16,
                ...
                if (*this).curNumSpawn as libc::c_int >=
                       (*this).maxCurSpawns as libc::c_int {
                    (*this).fieldSpawnTimer = 100 as libc::c_int as s16
                }
                if (*globalCtx).sceneNum as libc::c_int !=
                       SCENE_SPOT00 as libc::c_int {
                    (*this).totalNumSpawn += 1
...
#[no_mangle]
pub unsafe extern "C" fn EnEncount1_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnEncount1 = thisx as *mut EnEncount1;
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
        ...
        if (*this).outOfRangeTimer as libc::c_int != 0 as libc::c_int {
            if (*this).outOfRangeTimer as libc::c_int & 1 as libc::c_int ==
                   0 as libc::c_int {
