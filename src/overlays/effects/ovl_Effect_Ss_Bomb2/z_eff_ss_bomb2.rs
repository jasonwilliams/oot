...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffBombExplosion1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion4Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion5Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion6Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion7Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion8Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBombExplosion1DL: [Gfx; 0];
    #[no_mangle]
    static mut gEffBombExplosion2DL: [Gfx; 0];
    #[no_mangle]
    static mut gEffBombExplosion3DL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_Bomb2_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_BOMB2 as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsBomb2_Init as
...
static mut sDrawFuncs: [EffectSsDrawFunc; 2] =
    unsafe {
        [Some(EffectSsBomb2_DrawFade as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                       _: *mut EffectSs) -> ()),
         Some(EffectSsBomb2_DrawLayered as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                       _: *mut EffectSs) -> ())]
    };
/*
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb2_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsBomb2InitParams =
        initParamsx as *mut EffectSsBomb2InitParams;
    Math_Vec3f_Copy(&mut (*this).pos, &mut (*initParams).pos);
    Math_Vec3f_Copy(&mut (*this).velocity, &mut (*initParams).velocity);
    Math_Vec3f_Copy(&mut (*this).accel, &mut (*initParams).accel);
    (*this).gfx =
        gSegments[((gEffBombExplosion1DL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffBombExplosion1DL.as_mut_ptr() as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void;
    (*this).life = 24 as libc::c_int as s16;
    (*this).update =
        Some(EffectSsBomb2_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).draw = sDrawFuncs[(*initParams).drawMode as usize];
    (*this).regs[0 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scaleStep;
    (*this).regs[2 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[4 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[5 as libc::c_int as usize] = 255 as libc::c_int as s16;
    (*this).regs[6 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[7 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[8 as libc::c_int as usize] = 200 as libc::c_int as s16;
    return 1 as libc::c_int as u32_0;
}
// unused in the original game. looks like EffectSsBomb but with color
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb2_DrawFade(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    static mut textures: [*mut libc::c_void; 8] =
        unsafe {
            [gEffBombExplosion1Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion2Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion3Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion4Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion5Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion6Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion7Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gEffBombExplosion8Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_bomb2.c\x00" as *const u8 as
                        *const libc::c_char, 298 as libc::c_int);
    scale =
        (*this).regs[0 as libc::c_int as usize] as libc::c_int as
        ...
        (*_g_2).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gSegments[((textures[(*this).regs[1 as libc::c_int as usize] as
                                     usize] as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add(textures[(*this).regs[1 as
                                                                        libc::c_int
                                                                        as
                                                                        usize]
                                                           as usize] as u32_0
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb2_DrawLayered(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut index: u32_0,
                                                   mut this: *mut EffectSs) {
    static mut textures: [*mut libc::c_void; 8] =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_bomb2.c\x00" as *const u8 as
                        *const libc::c_char, 386 as libc::c_int);
    depth = (*this).regs[10 as libc::c_int as usize] as f32_0;
    scale =
        (*this).regs[0 as libc::c_int as usize] as libc::c_int as
            libc::c_float * 0.01f32;
    SkinMatrix_SetTranslate(&mut mfTrans, (*this).pos.x, (*this).pos.y,
        ...
        (*_g).words.w0 =
            (0xda as libc::c_int as u32_0 &
                ...
                (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 = mtx as libc::c_uint;
        mtx2 = SkinMatrix_MtxFToNewMtx(gfxCtx, &mut mfResult);
        if !mtx2.is_null() {
            func_80094BC4(gfxCtx);
            ...
            (*_g_2).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_2).words.w1 =
                gSegments[((textures[(*this).regs[1 as libc::c_int as usize]
                                         as usize] as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(textures[(*this).regs[1 as
                                                                            libc::c_int
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gEffBombExplosion2DL.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gEffBombExplosion3DL.as_mut_ptr() as libc::c_uint;
            Matrix_MtxToMtxF(mtx2, &mut mtx2F);
            Matrix_Put(&mut mtx2F);
            i = 1 as libc::c_int;
            while i >= 0 as libc::c_int {
                Matrix_Translate(0.0f32, 0.0f32, depth,
                                 MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateZ((*this).life as libc::c_int as libc::c_float *
                                   0.02f32 + 180.0f32,
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_Scale(layer2Scale, layer2Scale, layer2Scale,
                             MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (*_g_5).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_eff_ss_bomb2.c\x00" as *const u8 as
                                      ...
                                      *mut libc::c_char, 448 as libc::c_int)
                        as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsBomb2_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    let mut divisor: s32 = 0;
    (*this).regs[1 as libc::c_int as usize] =
        ((23 as libc::c_int - (*this).life as libc::c_int) / 3 as libc::c_int)
            as s16;
    (*this).regs[0 as libc::c_int as usize] =
        ((*this).regs[0 as libc::c_int as usize] as libc::c_int +
             (*this).regs[9 as libc::c_int as usize] as libc::c_int) as s16;
    if (*this).regs[9 as libc::c_int as usize] as libc::c_int ==
           30 as libc::c_int {
        (*this).regs[10 as libc::c_int as usize] =
            ((*this).regs[10 as libc::c_int as usize] as libc::c_float +
                 4.0f32) as s16
    } else {
        (*this).regs[10 as libc::c_int as usize] =
            ((*this).regs[10 as libc::c_int as usize] as libc::c_float +
    ...
    if ((*this).life as libc::c_int) < 23 as libc::c_int &&
           (*this).life as libc::c_int > 13 as libc::c_int {
        divisor = (*this).life as libc::c_int - 13 as libc::c_int;
        (*this).regs[2 as libc::c_int as usize] =
            func_80027DD4((*this).regs[2 as libc::c_int as usize],
                          255 as libc::c_int as s16, divisor);
        ...
        (*this).regs[4 as libc::c_int as usize] =
            func_80027DD4((*this).regs[4 as libc::c_int as usize],
                          150 as libc::c_int as s16, divisor);
        ...
        (*this).regs[7 as libc::c_int as usize] =
            func_80027DD4((*this).regs[7 as libc::c_int as usize],
                          0 as libc::c_int as s16, divisor);
        (*this).regs[8 as libc::c_int as usize] =
            func_80027DD4((*this).regs[8 as libc::c_int as usize],
                          0 as libc::c_int as s16, divisor)
    } else if ((*this).life as libc::c_int) < 14 as libc::c_int &&
                  (*this).life as libc::c_int > -(1 as libc::c_int) {
        divisor = (*this).life as libc::c_int + 1 as libc::c_int;
        (*this).regs[2 as libc::c_int as usize] =
            func_80027DD4((*this).regs[2 as libc::c_int as usize],
                          50 as libc::c_int as s16, divisor);
        (*this).regs[3 as libc::c_int as usize] =
            func_80027DD4((*this).regs[3 as libc::c_int as usize],
                          50 as libc::c_int as s16, divisor);
        (*this).regs[4 as libc::c_int as usize] =
        ...
        (*this).regs[6 as libc::c_int as usize] =
            func_80027DD4((*this).regs[6 as libc::c_int as usize],
                          10 as libc::c_int as s16, divisor);
        (*this).regs[7 as libc::c_int as usize] =
            func_80027DD4((*this).regs[7 as libc::c_int as usize],
                          10 as libc::c_int as s16, divisor);
        (*this).regs[8 as libc::c_int as usize] =
