...
extern "C" {
    ...
    #[no_mangle]
    static mut gDeathMountainCloudCircleFieryDL: [Gfx; 0];
    #[no_mangle]
    static mut gDeathMountainCloudCircleNormalDL: [Gfx; 0];
}
...
pub struct BgSpot16Doughnut {
    ...
    pub envColorAlpha: u8_0,
}
#[no_mangle]
pub static mut Bg_Spot16_Doughnut_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT16_DOUGHNUT as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_EFC_DOUGHNUT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot16Doughnut>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot16Doughnut_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot16Doughnut_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot16Doughnut_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot16Doughnut_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sScales: [s16; 5] =
    [0 as libc::c_int as s16, 0 as libc::c_int as s16,
     70 as libc::c_int as s16, 210 as libc::c_int as s16,
     300 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot16Doughnut = thisx as *mut BgSpot16Doughnut;
    let mut params: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 0.1f32);
    (*this).fireFlag = 0 as libc::c_int as u16_0;
    (*this).envColorAlpha = 255 as libc::c_int as u8_0;
    params = (*this).actor.params as s32;
    if params == 1 as libc::c_int || params == 2 as libc::c_int ||
           params == 3 as libc::c_int || params == 4 as libc::c_int {
        Actor_SetScale(&mut (*this).actor,
                       sScales[(*this).actor.params as usize] as libc::c_int
                           as libc::c_float * 1.0e-4f32);
        (*this).actor.draw =
            Some(BgSpot16Doughnut_DrawExpanding as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.update =
            Some(BgSpot16Doughnut_UpdateExpanding as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    } else {
        ...
        match (*globalCtx).sceneNum as libc::c_int {
            82 => { Actor_SetScale(&mut (*this).actor, 0.04f32); }
            35 | 36 | 37 => { Actor_SetScale(&mut (*this).actor, 0.018f32); }
            _ => { Actor_SetScale(&mut (*this).actor, 0.1f32); }
        }
        osSyncPrintf(b"\x1b[36m%f\x1b[m\n\x00" as *const u8 as
                         *const libc::c_char,
        ...
        if !(gSaveContext.linkAge == 0 as libc::c_int) ||
            ...
            (*this).fireFlag =
                ((*this).fireFlag as libc::c_int & !(1 as libc::c_int)) as
                    u16_0
        } else {
            (*this).fireFlag =
                ((*this).fireFlag as libc::c_int | 1 as libc::c_int) as u16_0
        }
        osSyncPrintf(b"(\xef\xbd\x93\xef\xbd\x90\xef\xbd\x8f\xef\xbd\x94\xef\xbc\x91\xef\xbc\x96 \xe3\x83\x89\xe3\x83\xbc\xe3\x83\x8a\xe3\x83\x84\xe9\x9b\xb2)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot16Doughnut = thisx as *mut BgSpot16Doughnut;
    if (*this).fireFlag as libc::c_int & 1 as libc::c_int == 0 {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int - 0x20 as libc::c_int)
                as s16;
        if ((*this).envColorAlpha as libc::c_int) < 255 as libc::c_int {
            (*this).envColorAlpha =
                ((*this).envColorAlpha as libc::c_int + 5 as libc::c_int) as
                    u8_0
        } else { (*this).envColorAlpha = 255 as libc::c_int as u8_0 }
        ...
        if (*this).envColorAlpha as libc::c_int >= 6 as libc::c_int {
            (*this).envColorAlpha =
                ((*this).envColorAlpha as libc::c_int - 5 as libc::c_int) as
                    u8_0
        } else {
            (*this).envColorAlpha = 0 as libc::c_int as u8_0;
            (*this).fireFlag =
                ((*this).fireFlag as libc::c_int & !(1 as libc::c_int)) as
                    u16_0
        }
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_UpdateExpanding(mut thisx:
                                                              *mut Actor,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut this: *mut BgSpot16Doughnut = thisx as *mut BgSpot16Doughnut;
    if (*this).envColorAlpha as libc::c_int >= 6 as libc::c_int {
        (*this).envColorAlpha =
            ((*this).envColorAlpha as libc::c_int - 5 as libc::c_int) as u8_0
    } else { Actor_Kill(&mut (*this).actor); }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int - 0x20 as libc::c_int) as
            s16;
    Actor_SetScale(&mut (*this).actor,
                   (*this).actor.scale.x + 0.0019999998f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot16Doughnut = thisx as *mut BgSpot16Doughnut;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot16_doughnut.c\x00" as *const u8 as
    ...
    if (*this).fireFlag as libc::c_int & 1 as libc::c_int != 0 {
        ...
        (*_g_0).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             32 as libc::c_int, 1 as libc::c_int, scroll,
        ...
        (*_g_2).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gDeathMountainCloudCircleFieryDL.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_5).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_5).words.w1 =
            gDeathMountainCloudCircleNormalDL.as_mut_ptr() as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot16Doughnut_DrawExpanding(mut thisx: *mut Actor,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut this: *mut BgSpot16Doughnut = thisx as *mut BgSpot16Doughnut;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
