...
extern "C" {
    ...
    #[no_mangle]
    static mut object_bwall_DL_000040: [Gfx; 0];
    #[no_mangle]
    static mut object_bwall_Col_000118: CollisionHeader;
    #[no_mangle]
    static mut object_kingdodongo_Col_025B64: CollisionHeader;
    #[no_mangle]
    static mut object_kingdodongo_DL_025BD0: [Gfx; 0];
    #[no_mangle]
    static mut object_kingdodongo_Col_0264A8: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgBreakwall {
    pub dyna: DynaPolyActor,
    pub bombableWallDList: *mut Gfx,
    pub colType: s8,
    pub bankIndex: s8,
    pub collider: ColliderQuad,
    pub actionFunc: BgBreakwallActionFunc,
}
pub type BgBreakwallActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgBreakwall, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const BWALL_KD_LAVA_COVER: C2RustUnnamed_23 = 3;
pub const BWALL_KD_FLOOR: C2RustUnnamed_23 = 2;
pub const BWALL_WALL: C2RustUnnamed_23 = 1;
pub const BWALL_DC_ENTRANCE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BombableWallInfo {
    pub colHeader: *mut CollisionHeader,
    pub dList: *mut Gfx,
    pub colType: s8,
}
#[no_mangle]
pub static mut Bg_Breakwall_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_BREAKWALL as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgBreakwall>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBreakwall_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBreakwall_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgBreakwall_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBombableWallInfo: [BombableWallInfo; 4] =
    unsafe {
        [{
             let mut init =
                 BombableWallInfo{colHeader:
                                      &object_bwall_Col_000118 as
                                          *const CollisionHeader as
                                          *mut CollisionHeader,
                                  dList:
                                      object_bwall_DL_000040.as_ptr() as
                                          *mut _,
                                  colType: 0 as libc::c_int as s8,};
             init
         },
         {
             let mut init =
         ...
         },
         {
             let mut init =
                 BombableWallInfo{colHeader:
                                      &object_kingdodongo_Col_0264A8 as
                                          *const CollisionHeader as
                                          *mut CollisionHeader,
                                  dList:
                                      object_kingdodongo_DL_025BD0.as_ptr() as
                                          *mut _,
                                  colType: 1 as libc::c_int as s8,};
             init
         },
         {
             let mut init =
                 BombableWallInfo{colHeader:
                                      &object_kingdodongo_Col_025B64 as
                                          *const CollisionHeader as
                                          *mut CollisionHeader,
                                  dList: 0 as *const Gfx as *mut Gfx,
                                  colType: -(1 as libc::c_int) as s8,};
             init
         }]
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_SetupAction(mut this: *mut BgBreakwall,
                                                 mut actionFunc:
                                                     BgBreakwallActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgBreakwall = thisx as *mut BgBreakwall;
    let mut pad: s32 = 0;
    let mut wallType: s32 =
        (*this).dyna.actor.params as libc::c_int >> 13 as libc::c_int &
    ...
    (*this).bombableWallDList = sBombableWallInfo[wallType as usize].dList;
    (*this).colType = sBombableWallInfo[wallType as usize].colType;
    if (*this).colType as libc::c_int == 1 as libc::c_int {
        (*this).dyna.actor.world.rot.x = 0x4000 as libc::c_int as s16
    }
    if !(*this).bombableWallDList.is_null() {
        ...
        Collider_SetQuad(globalCtx, &mut (*this).collider,
                         &mut (*this).dyna.actor, &mut sQuadInit);
    } else { (*this).dyna.actor.world.pos.y -= 40.0f32 }
    (*this).bankIndex =
        if wallType >= BWALL_KD_FLOOR as libc::c_int {
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_KINGDODONGO as libc::c_int as s16)
        } else {
            Object_GetIndex(&mut (*globalCtx).objectCtx,
                            OBJECT_BWALL as libc::c_int as s16)
        } as s8;
    if ((*this).bankIndex as libc::c_int) < 0 as libc::c_int {
        Actor_Kill(&mut (*this).dyna.actor);
    } else {
        BgBreakwall_SetupAction(this,
                                Some(BgBreakwall_WaitForObject as
                                         unsafe extern "C" fn(_:
                                                                  *mut BgBreakwall,
                                                              _:
                                                                  *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgBreakwall = thisx as *mut BgBreakwall;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_SpawnFragments(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut this:
                                                        *mut BgBreakwall,
                                                    mut pos: *mut Vec3f,
 ...
 -> *mut Actor {
    ...
    let mut actorScaleList: [Vec3f; 4] =
        [{
             let mut init = Vec3f{x: 0.004f32, y: 0.004f32, z: 0.004f32,};
             init
         },
         {
             let mut init = Vec3f{x: 0.004f32, y: 0.004f32, z: 0.004f32,};
    ...
    let mut actorPosList: [[Vec3f; 4]; 4] =
        [[{ let mut init = Vec3f{x: 40.0f32, y: 15.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: 30.0f32, y: 57.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: 50.0f32, y: 57.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: 40.0f32, y: 70.0f32, z: 0.0f32,}; init }],
         [{ let mut init = Vec3f{x: 55.0f32, y: -15.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: 30.0f32, y: -32.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: 50.0f32, y: -32.0f32, z: 0.0f32,}; init },
          {
              let mut init = Vec3f{x: 20.0f32, y: -10.0f32, z: 0.0f32,};
              init
          }],
         [{ let mut init = Vec3f{x: -40.0f32, y: 14.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: -50.0f32, y: 57.0f32, z: 0.0f32,}; init },
          { let mut init = Vec3f{x: -30.0f32, y: 57.0f32, z: 0.0f32,}; init },
          {
              let mut init = Vec3f{x: -40.0f32, y: 70.0f32, z: 0.0f32,};
              init
          }],
         [{
              let mut init = Vec3f{x: -55.0f32, y: -15.0f32, z: 0.0f32,};
              init
          },
          {
              let mut init = Vec3f{x: -55.0f32, y: -32.0f32, z: 0.0f32,};
              init
          },
          {
              let mut init = Vec3f{x: -30.0f32, y: -32.0f32, z: 0.0f32,};
              init
          },
          {
              let mut init = Vec3f{x: -20.0f32, y: -10.0f32, z: 0.0f32,};
    ...
    while k >= 0 as libc::c_int {
        if k == 0 as libc::c_int || k == 3 as libc::c_int {
            actorScaleList[k as usize].x *= scaleX;
            actorScaleList[k as usize].y *= scaleY;
            actorScaleList[k as usize].z *= scaleY
        } else {
            actorScaleList[k as usize].x *= scaleY;
            actorScaleList[k as usize].y *= scaleX;
            actorScaleList[k as usize].z *= scaleX
        }
        k -= 1
    }
    i = 0 as libc::c_int;
    while i < count {
        angle1 =
            ((if (*this).dyna.actor.world.rot.y as libc::c_int >=
              ...
              } else { -((*this).dyna.actor.world.rot.y as libc::c_int) }) +
                 angle2 as libc::c_int) as s16;
        ...
        while j >= 0 as libc::c_int {
            k = 3 as libc::c_int;
            while k >= 0 as libc::c_int {
                Matrix_MultVec3f(&mut *(*actorPosList.as_mut_ptr().offset(j as
                                                                              isize)).as_mut_ptr().offset(k
                                                                                                              as
                                                                                                              isize),
                                 &mut actorPos);
                actor =
                    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                ACTOR_EN_A_OBJ as libc::c_int as s16,
                                Rand_CenteredFloat(20.0f32) + actorPos.x,
                                Rand_CenteredFloat(20.0f32) + actorPos.y,
                                Rand_CenteredFloat(20.0f32) + actorPos.z,
                                actorRotList[k as usize].x,
                                (actorRotList[k as usize].y as libc::c_int +
                                     angle1 as libc::c_int) as s16,
                                actorRotList[k as usize].z,
                                0xb as libc::c_int as s16);
                if j & 1 as libc::c_int == 0 as libc::c_int {
                    func_80033480(globalCtx, &mut actorPos,
                                  velocity * 200.0f32, 1 as libc::c_int,
                                  650 as libc::c_int as s16,
                                  150 as libc::c_int as s16,
                                  1 as libc::c_int as u8_0);
                }
                if !actor.is_null() {
                    (*actor).speedXZ = Rand_ZeroOne() + accel * 0.6f32;
                    (*actor).velocity.y = Rand_ZeroOne() + accel * 0.6f32;
                    (*actor).world.rot.y =
                        ((*actor).world.rot.y as libc::c_int +
                             ((Rand_ZeroOne() - 0.5f32) * 3000.0f32) as s16 as
                                 libc::c_int) as s16;
                    (*actor).world.rot.x =
                        ((Rand_ZeroOne() * 3500.0f32) as s16 as libc::c_int +
                             2000 as libc::c_int) as s16;
                    (*actor).world.rot.z =
                        ((Rand_ZeroOne() * 3500.0f32) as s16 as libc::c_int +
                             2000 as libc::c_int) as s16;
                    (*actor).parent = &mut (*this).dyna.actor;
                    (*actor).scale.x =
                        actorScaleList[k as usize].x +
                            Rand_CenteredFloat(0.001f32);
                    (*actor).scale.y =
                        actorScaleList[k as usize].y +
                            Rand_CenteredFloat(0.001f32);
                    (*actor).scale.z =
                        actorScaleList[k as usize].z +
                            Rand_CenteredFloat(0.001f32)
                }
                k -= 1
            }
        ...
        angle2 = (angle2 as libc::c_int + 0x4000 as libc::c_int) as s16;
        i += 1
    }
    return actor;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_WaitForObject(mut this: *mut BgBreakwall,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, (*this).bankIndex as s32)
           != 0 {
        ...
        (*this).dyna.actor.draw =
            Some(BgBreakwall_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        CollisionHeader_GetVirtual(sBombableWallInfo[wallType as
                                                         usize].colHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).dyna.bgId =
            DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                                &mut (*this).dyna.actor, colHeader);
        if wallType == BWALL_KD_LAVA_COVER as libc::c_int {
            BgBreakwall_SetupAction(this,
                                    Some(BgBreakwall_LavaCoverMove as
                                             unsafe extern "C" fn(_:
                                                                      *mut BgBreakwall,
                                                                  _:
                                                                      *mut GlobalContext)
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_Wait(mut this: *mut BgBreakwall,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int & 2 as libc::c_int != 0 {
        ...
        DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                               (*this).dyna.bgId);
        effectPos.x = 0.0f32;
        effectPos.z = effectPos.x;
        effectPos.y = effectPos.z;
        if (*this).dyna.actor.world.rot.x as libc::c_int == 0 as libc::c_int {
            effectPos.y = 55.0f32
        } else { effectPos.z = 25.0f32; effectPos.y = -10.0f32 }
        BgBreakwall_SpawnFragments(globalCtx, this, &mut effectPos, 0.0f32,
                                   6.4f32, 5.0f32, 1 as libc::c_int, 2.0f32);
        ...
        if wallType == BWALL_DC_ENTRANCE as libc::c_int &&
               Flags_GetEventChkInf(0xb0 as libc::c_int) == 0 {
            Flags_SetEventChkInf(0xb0 as libc::c_int);
            Cutscene_SetSegment(globalCtx,
                                gDcOpeningCs.as_mut_ptr() as
                                    *mut libc::c_void);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_LavaCoverMove(mut this: *mut BgBreakwall,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                 (*gGameInfo).data[(13 as libc::c_int * 6 as libc::c_int *
                     ...
                     libc::c_float + (*this).dyna.actor.home.pos.y, 1.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgBreakwall = thisx as *mut BgBreakwall;
 ...
 */
static mut sColQuadList: [[Vec3f; 4]; 2] =
    [[{ let mut init = Vec3f{x: 800.0f32, y: 1600.0f32, z: 100.0f32,}; init },
      {
          let mut init = Vec3f{x: -800.0f32, y: 1600.0f32, z: 100.0f32,};
          init
      }, { let mut init = Vec3f{x: 800.0f32, y: 0.0f32, z: 100.0f32,}; init },
      { let mut init = Vec3f{x: -800.0f32, y: 0.0f32, z: 100.0f32,}; init }],
     [{ let mut init = Vec3f{x: 10.0f32, y: 0.0f32, z: 10.0f32,}; init },
      ...
      { let mut init = Vec3f{x: -10.0f32, y: 0.0f32, z: -10.0f32,}; init }]];
#[no_mangle]
pub unsafe extern "C" fn BgBreakwall_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgBreakwall = thisx as *mut BgBreakwall;
    if !(*this).bombableWallDList.is_null() {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_bg_breakwall.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = (*this).bombableWallDList as libc::c_uint;
        if (*this).colType as libc::c_int >= 0 as libc::c_int {
            let mut colQuad: [Vec3f; 4] = [Vec3f{x: 0., y: 0., z: 0.,}; 4];
            let mut src: *mut Vec3f =
                &mut *(*sColQuadList.as_mut_ptr().offset((*this).colType as
                                                             isize)).as_mut_ptr().offset(0
                                                                                             ...
                                                                                             isize)
                    as *mut Vec3f;
            let mut dst: *mut Vec3f =
                &mut *colQuad.as_mut_ptr().offset(0 as libc::c_int as isize)
                    as *mut Vec3f;
            let mut i: s32 = 0;
            i = 0 as libc::c_int;
            while i < 4 as libc::c_int {
                ...
                let fresh3 = dst;
                dst = dst.offset(1);
                Matrix_MultVec3f(fresh2, fresh3);
                i += 1
            }
            Collider_SetQuadVertices(&mut (*this).collider,
                                     &mut *colQuad.as_mut_ptr().offset(0 as
                                                                           libc::c_int
                                                                           as
                                                                           isize),
                                     &mut *colQuad.as_mut_ptr().offset(1 as
                                                                           libc::c_int
                                                                           as
                                                                           isize),
                                     &mut *colQuad.as_mut_ptr().offset(2 as
                                                                           libc::c_int
                                                                           as
                                                                           isize),
                                     &mut *colQuad.as_mut_ptr().offset(3 as
                                                                           libc::c_int
                                                                           as
                                                                           isize));
