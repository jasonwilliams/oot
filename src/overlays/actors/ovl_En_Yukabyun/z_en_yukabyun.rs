...
extern "C" {
    ...
    #[no_mangle]
    static mut gFloorTileEnemyBottomTex: [u64_0; 0];
    #[no_mangle]
    static mut gFloorTileEnemyDL: [Gfx; 0];
    #[no_mangle]
    static mut gFloorTileEnemyFragmentDL: [Gfx; 0];
    #[no_mangle]
    static mut gFloorTileEnemyTopTex: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnYukabyun {
    pub actor: Actor,
    pub actionfunc: EnYukabyunActionFunc,
    pub unk_150: s16,
    pub unk_152: u8_0,
    pub collider: ColliderCylinder,
}
pub type EnYukabyunActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnYukabyun, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Yukabyun_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_YUKABYUN as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_YUKABYUN as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnYukabyun>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYukabyun_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYukabyun_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYukabyun_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnYukabyun_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_80B43F64: [*mut libc::c_void; 2] =
    unsafe {
        [gFloorTileEnemyTopTex.as_ptr() as *mut _ as *mut libc::c_void,
         gFloorTileEnemyBottomTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnYukabyun_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnYukabyun = thisx as *mut EnYukabyun;
    ...
    (*this).unk_150 =
        ((*this).actor.params as u8_0 as libc::c_int * 0xa as libc::c_int +
             0x14 as libc::c_int) as s16;
    (*this).actionfunc =
        Some(func_80B43A94 as
                 unsafe extern "C" fn(_: *mut EnYukabyun,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnYukabyun_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnYukabyun = thisx as *mut EnYukabyun;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B43A94(mut this: *mut EnYukabyun,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_150 as libc::c_int == 0 as libc::c_int {
        ...
        (*this).actionfunc =
            Some(func_80B43AD4 as
                     unsafe extern "C" fn(_: *mut EnYukabyun,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B43AD4(mut this: *mut EnYukabyun,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_150 =
        ((*this).unk_150 as libc::c_int + 0xa0 as libc::c_int) as s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).unk_150 as libc::c_int) as s16;
    if (*this).unk_150 as libc::c_int >= 0x2000 as libc::c_int {
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.speedXZ = 10.0f32;
        (*this).actionfunc =
            Some(func_80B43B6C as
                     unsafe extern "C" fn(_: *mut EnYukabyun,
                                          _: *mut GlobalContext) -> ())
    }
    Math_StepToF(&mut (*this).actor.world.pos.y,
                 (*this).actor.home.pos.y + 30.0f32, 1.0f32);
    func_8002F974(&mut (*this).actor,
                  (0x3979 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B43B6C(mut this: *mut EnYukabyun,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).unk_150 as libc::c_int) as s16;
    if (*this).actor.xzDistToPlayer > 5000.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnYukabyun_Break(mut this: *mut EnYukabyun,
                                          mut globalCtx: *mut GlobalContext) {
    EffectSsHahen_SpawnBurst(globalCtx, &mut (*this).actor.world.pos, 8.0f32,
                             0 as libc::c_int as s16,
                             1300 as libc::c_int as s16,
                             300 as libc::c_int as s16,
                             15 as libc::c_int as s16,
                             OBJECT_YUKABYUN as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             gFloorTileEnemyFragmentDL.as_mut_ptr());
    Actor_Kill(&mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn EnYukabyun_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnYukabyun = thisx as *mut EnYukabyun;
    let mut pad: s32 = 0;
    if (*this).collider.base.atFlags as libc::c_int &
           ...
           (*this).collider.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               !((*(*this).collider.base.oc).id as libc::c_int ==
                     ACTOR_EN_YUKABYUN as libc::c_int) ||
           (*this).actionfunc ==
               Some(func_80B43B6C as
                        unsafe extern "C" fn(_: *mut EnYukabyun,
                                             _: *mut GlobalContext) -> ()) &&
    ...
    if !((*this).actionfunc ==
                                               ...
                                               _: *mut GlobalContext) -> ()))
       {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                20.0f32, 8.0f32, 5 as libc::c_int);
    ...
    Actor_SetFocus(&mut (*this).actor, 4.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnYukabyun_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnYukabyun = thisx as *mut EnYukabyun;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_yukabyun.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        gSegments[((D_80B43F64[(*this).unk_152 as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(D_80B43F64[(*this).unk_152 as usize]
                                              as u32_0 &
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gFloorTileEnemyDL.as_mut_ptr() as libc::c_uint;
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(16 as libc::c_int);
             init
         }]
}
#[used]
