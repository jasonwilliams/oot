...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriHashiraPlatformsDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriHashira1Col: CollisionHeader;
    #[no_mangle]
    static mut gMoriHashiraGateDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriHashira2Col: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriHashira4 {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriHashira4ActionFunc,
    pub moriTexObjIndex: s8,
    pub switchFlag: s8,
    pub gateTimer: s16,
}
pub type BgMoriHashira4ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriHashira4, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Mori_Hashira4_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_HASHIRA4 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriHashira4>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashira4_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashira4_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriHashira4_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDisplayLists: [*mut Gfx; 2] =
    unsafe {
        [gMoriHashiraPlatformsDL.as_ptr() as *mut _,
         gMoriHashiraGateDL.as_ptr() as *mut _]
    };
static mut sUnkTimer: s16 = 0;
// seems to be unused
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_SetupAction(mut this:
                                                        *mut BgMoriHashira4,
                                                    mut actionFunc:
                                                        BgMoriHashira4ActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_InitDynaPoly(mut this:
                                                         *mut BgMoriHashira4,
                                                     mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_mori_hashira4.c\x00" as *const u8 as
                         *const libc::c_char, 155 as libc::c_int,
                     (*this).dyna.actor.id as libc::c_int,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashira4 = thisx as *mut BgMoriHashira4;
    (*this).switchFlag =
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        BgMoriHashira4_InitDynaPoly(this, globalCtx, &mut gMoriHashira1Col,
                                    DPM_UNK3 as libc::c_int);
    } else {
        BgMoriHashira4_InitDynaPoly(this, globalCtx, &mut gMoriHashira2Col,
    ...
    osSyncPrintf(b"(\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf \xef\xbc\x94\xe6\x9c\xac\xe6\x9f\xb1)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
    sUnkTimer = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashira4 = thisx as *mut BgMoriHashira4;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_SetupWaitForMoriTex(mut this:
                                                                *mut BgMoriHashira4) {
    BgMoriHashira4_SetupAction(this,
                               Some(BgMoriHashira4_WaitForMoriTex as
                                        unsafe extern "C" fn(_:
                                                                 *mut BgMoriHashira4,
                                                             _:
                                                                 *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_WaitForMoriTex(mut this:
                                                           *mut BgMoriHashira4,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).moriTexObjIndex as s32) != 0 {
        (*this).gateTimer = 0 as libc::c_int as s16;
        if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
            BgMoriHashira4_SetupPillarsRotate(this);
        } else {
            BgMoriHashira4_SetupAction(this,
                                       Some(BgMoriHashira4_GateWait as
                                                unsafe extern "C" fn(_:
                                                                         *mut BgMoriHashira4,
                                                                     _:
                                                                         *mut GlobalContext)
        ...
        (*this).dyna.actor.draw =
            Some(BgMoriHashira4_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_SetupPillarsRotate(mut this:
                                                               *mut BgMoriHashira4) {
    BgMoriHashira4_SetupAction(this,
                               Some(BgMoriHashira4_PillarsRotate as
                                        unsafe extern "C" fn(_:
                                                                 *mut BgMoriHashira4,
                                                             _:
                                                                 *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_PillarsRotate(mut this:
                                                          *mut BgMoriHashira4,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    (*this).dyna.actor.world.rot.y =
        ((*this).dyna.actor.world.rot.y as libc::c_int + 0x96 as libc::c_int)
            as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_GateWait(mut this:
                                                     *mut BgMoriHashira4,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 ||
           (*this).gateTimer as libc::c_int != 0 as libc::c_int {
        (*this).gateTimer += 1;
        if (*this).gateTimer as libc::c_int > 30 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2859 as libc::c_int as u16_0);
            BgMoriHashira4_SetupAction(this,
                                       Some(BgMoriHashira4_GateOpen as
                                                unsafe extern "C" fn(_:
                                                                         *mut BgMoriHashira4,
                                                                     _:
                                                                         *mut GlobalContext)
                                                    -> ()));
            OnePointCutscene_Init(globalCtx, 6010 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_GateOpen(mut this:
                                                     *mut BgMoriHashira4,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + 120.0f32, 10.0f32) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashira4 = thisx as *mut BgMoriHashira4;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriHashira4_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriHashira4 = thisx as *mut BgMoriHashira4;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        sDisplayLists[(*this).dyna.actor.params as usize] as libc::c_uint;
