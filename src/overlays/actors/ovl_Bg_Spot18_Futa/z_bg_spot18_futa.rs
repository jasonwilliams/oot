...
extern "C" {
    ...
    #[no_mangle]
    static mut gGoronCityVaseLidDL: [Gfx; 0];
    #[no_mangle]
    static mut gGoronCityVaseLidCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot18Futa {
    pub dyna: DynaPolyActor,
}
#[no_mangle]
pub static mut Bg_Spot18_Futa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT18_FUTA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot18Futa>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Futa_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Futa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Futa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Futa_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Futa_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgSpot18Futa = thisx as *mut BgSpot18Futa;
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
    CollisionHeader_GetVirtual(&mut gGoronCityVaseLidCol as
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Futa_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot18Futa = thisx as *mut BgSpot18Futa;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Futa_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgSpot18Futa = thisx as *mut BgSpot18Futa;
    let mut iVar1: s32 = 0;
    if (*this).dyna.actor.parent.is_null() {
        iVar1 =
            Math_StepToF(&mut (*this).dyna.actor.scale.x,
                         0 as libc::c_int as f32_0, 0.005f64 as f32_0);
        if iVar1 != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Futa_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gGoronCityVaseLidDL.as_mut_ptr());
}
