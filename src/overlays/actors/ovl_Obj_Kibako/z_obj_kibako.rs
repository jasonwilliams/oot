...
extern "C" {
    ...
    #[no_mangle]
    static mut gSmallWoodenBoxDL: [Gfx; 0];
    #[no_mangle]
    static mut gSmallWoodenBoxFragmentDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjKibako {
    pub actor: Actor,
    pub actionFunc: ObjKibakoActionFunc,
    pub collider: ColliderCylinder,
}
pub type ObjKibakoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjKibako, _: *mut GlobalContext)
               -> ()>;
...
#[no_mangle]
pub static mut Obj_Kibako_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_KIBAKO as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjKibako_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_SpawnCollectible(mut this: *mut ObjKibako,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut collectible: s16 = 0;
    collectible =
        ((*this).actor.params as libc::c_int & 0x1f as libc::c_int) as s16;
    if collectible as libc::c_int >= 0 as libc::c_int &&
           collectible as libc::c_int <= 0x19 as libc::c_int {
        Item_DropCollectible(globalCtx, &mut (*this).actor.world.pos,
                             (collectible as libc::c_int |
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_ApplyGravity(mut this: *mut ObjKibako) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_InitCollider(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut ObjKibako = thisx as *mut ObjKibako;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjKibako = thisx as *mut ObjKibako;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    (*this).actor.gravity = -1.2f32;
    (*this).actor.minVelocityY = -13.0f32;
    ObjKibako_InitCollider(&mut (*this).actor, globalCtx);
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo,
                           0 as *mut DamageTable, &mut sCCInfoInit);
    ObjKibako_SetupIdle(this);
    // "wooden box"
    osSyncPrintf(b"(dungeon keep \xe6\x9c\xa8\xe7\xae\xb1)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_AirBreak(mut this: *mut ObjKibako,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut angle: s16 = 0;
    let mut i: s32 = 0;
    let mut breakPos: *mut Vec3f = &mut (*this).actor.world.pos;
    ...
    while i < 12 as libc::c_int {
        ...
        if temp_rand < 0.1f32 {
            phi_s0 = 0x60 as libc::c_int as s16
        } else if temp_rand < 0.7f32 {
            phi_s0 = 0x40 as libc::c_int as s16
        } else { phi_s0 = 0x20 as libc::c_int as s16 }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, breakPos,
                             -(200 as libc::c_int) as s16, phi_s0,
                             10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 30.0f32 + 10.0f32) as s16,
                             0 as libc::c_int as s16,
                             32 as libc::c_int as s16, 60 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GAMEPLAY_DANGEON_KEEP as libc::c_int as
                                 s16, gSmallWoodenBoxFragmentDL.as_mut_ptr());
        i += 1;
        angle = (angle as libc::c_int + 0x4e20 as libc::c_int) as s16
    }
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 40.0f32,
                  3 as libc::c_int, 50 as libc::c_int as s16,
                  140 as libc::c_int as s16, 1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_WaterBreak(mut this: *mut ObjKibako,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut angle: s16 = 0;
    let mut i: s32 = 0;
    ...
    while i < 12 as libc::c_int {
        ...
        pos.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        pos.z = cs * 16.0f32;
        velocity.x = pos.x * 0.18f32;
        velocity.y = Rand_ZeroOne() * 4.0f32 + 2.0f32;
        velocity.z = pos.z * 0.18f32;
        pos.x += (*breakPos).x;
        pos.y += (*breakPos).y;
        pos.z += (*breakPos).z;
        temp_rand = Rand_ZeroOne();
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, breakPos,
                             -(180 as libc::c_int) as s16, phi_s0,
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_SetupIdle(mut this: *mut ObjKibako) {
    (*this).actionFunc =
        Some(ObjKibako_Idle as
                 unsafe extern "C" fn(_: *mut ObjKibako,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.colChkInfo.mass = 0xfe as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Idle(mut this: *mut ObjKibako,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        ObjKibako_SetupHeld(this);
                  ...
                  != 0 && (*this).actor.yDistToWater > 19.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_SetupHeld(mut this: *mut ObjKibako) {
    (*this).actionFunc =
        Some(ObjKibako_Held as
                 unsafe extern "C" fn(_: *mut ObjKibako,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.room = -(1 as libc::c_int) as s8;
    func_8002F7DC(&mut (*this).actor, 0x878 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Held(mut this: *mut ObjKibako,
                                        mut globalCtx: *mut GlobalContext) {
    if Actor_HasNoParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.room = (*globalCtx).roomCtx.curRoom.num;
        if fabsf((*this).actor.speedXZ) < 0.1f32 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28ab as libc::c_int as u16_0);
            ObjKibako_SetupIdle(this);
            (*this).collider.base.ocFlags1 =
                ((*this).collider.base.ocFlags1 as libc::c_int &
                     !((1 as libc::c_int) << 3 as libc::c_int)) as u8_0
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_SetupThrown(mut this: *mut ObjKibako) {
    ...
    (*this).actionFunc =
        Some(ObjKibako_Thrown as
                 unsafe extern "C" fn(_: *mut ObjKibako,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Thrown(mut this: *mut ObjKibako,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjKibako = thisx as *mut ObjKibako;
...
#[no_mangle]
pub unsafe extern "C" fn ObjKibako_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjKibako = thisx as *mut ObjKibako;
    Gfx_DrawDListOpa(globalCtx, gSmallWoodenBoxDL.as_mut_ptr());
}
