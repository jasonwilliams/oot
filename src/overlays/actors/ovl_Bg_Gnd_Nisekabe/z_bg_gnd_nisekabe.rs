...
extern "C" {
    ...
    #[no_mangle]
    static mut gLightTrialFakeWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleUnusedFakeWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gGanonsCastleScrubsFakeWallDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGndNisekabe {
    pub actor: Actor,
}
#[no_mangle]
pub static mut Bg_Gnd_Nisekabe_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GND_NISEKABE as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgGndNisekabe>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndNisekabe_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndNisekabe_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndNisekabe_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndNisekabe_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGndNisekabe_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgGndNisekabe = thisx as *mut BgGndNisekabe;
    Actor_SetScale(&mut (*this).actor, 0.1f64 as f32_0);
    (*this).actor.uncullZoneForward = 3000.0f64 as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgGndNisekabe_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgGndNisekabe_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgGndNisekabe = thisx as *mut BgGndNisekabe;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndNisekabe_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 3] =
        unsafe {
            [gLightTrialFakeWallDL.as_ptr() as *mut _,
             gGanonsCastleUnusedFakeWallDL.as_ptr() as *mut _,
             gGanonsCastleScrubsFakeWallDL.as_ptr() as *mut _]
        };
    let mut this: *mut BgGndNisekabe = thisx as *mut BgGndNisekabe;
    let mut index: u32_0 =
        ((*this).actor.params as libc::c_int & 0xff as libc::c_int) as u32_0;
    if (*this).actor.flags &
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint ==
           ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint {
        Gfx_DrawDListXlu(globalCtx, dLists[index as usize]);
    } else { Gfx_DrawDListOpa(globalCtx, dLists[index as usize]); };
}
