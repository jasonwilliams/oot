...
extern "C" {
    ...
    #[no_mangle]
    static mut gTreasureChestCurveAnim_4B60: TransformUpdateIndex;
    #[no_mangle]
    static mut gTreasureChestCurveAnim_4F70: TransformUpdateIndex;
    #[no_mangle]
    static mut gTreasureChestCurveSkel: SkelCurveLimbList;
}
...
pub type DemoTreLgtActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoTreLgt, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_17 = libc::c_uint;
pub const DEMO_TRE_LGT_ACTION_ANIMATE: C2RustUnnamed_17 = 1;
pub const DEMO_TRE_LGT_ACTION_WAIT: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBox {
...
// size = 0x10
static mut sDemoTreLgtInfo: [DemoTreLgtInfo; 2] =
    [{
         let mut init =
             DemoTreLgtInfo{startFrame: 1.0f32,
                            endFrame: 136.0f32,
                            unk_08: 190.0f32,
                            unk_0C: 40.0f32,};
         init
...
#[no_mangle]
pub static mut Demo_Tre_Lgt_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_TRE_LGT as libc::c_int as s16,
                          category:
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoTreLgt_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoTreLgt_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoTreLgt_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoTreLgt_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTransformUpdIdx: [*mut TransformUpdateIndex; 2] =
    unsafe {
        [&gTreasureChestCurveAnim_4B60 as *const TransformUpdateIndex as
             *mut TransformUpdateIndex,
         &gTreasureChestCurveAnim_4F70 as *const TransformUpdateIndex as
             *mut TransformUpdateIndex]
    };
static mut sActionFuncs: [DemoTreLgtActionFunc; 2] =
    unsafe {
        [Some(func_8099375C as
                  unsafe extern "C" fn(_: *mut DemoTreLgt,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80993848 as
                  unsafe extern "C" fn(_: *mut DemoTreLgt,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoTreLgt_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoTreLgt = thisx as *mut DemoTreLgt;
    if SkelCurve_Init(globalCtx, &mut (*this).skelCurve,
                      &mut gTreasureChestCurveSkel,
                      sTransformUpdIdx[0 as libc::c_int as usize]) == 0 {
        // "Demo_Tre_Lgt_Actor_ct (); Construct failed"
        osSyncPrintf(b"Demo_Tre_Lgt_Actor_ct();\xe3\x82\xb3\xe3\x83\xb3\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x83\x88\xe5\xa4\xb1\xe6\x95\x97\n\x00"
                         as *const u8 as *const libc::c_char);
    }
    if 1 as libc::c_int != 0 {
    } else {
        __assert(b"1\x00" as *const u8 as *const libc::c_char,
                 b"../z_demo_tre_lgt.c\x00" as *const u8 as
                     *const libc::c_char, 1 as libc::c_int);
    };
    (*this).unk_170 = 255 as libc::c_int as u32_0;
    (*this).unk_174 = 255 as libc::c_int as u32_0;
    (*this).status = 0 as libc::c_int as u8_0;
    func_80993754(this);
}
#[no_mangle]
pub unsafe extern "C" fn DemoTreLgt_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut DemoTreLgt = thisx as *mut DemoTreLgt;
...
#[no_mangle]
pub unsafe extern "C" fn func_80993754(mut this: *mut DemoTreLgt) {
    (*this).action = DEMO_TRE_LGT_ACTION_WAIT as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8099375C(mut this: *mut DemoTreLgt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut treasureChest: *mut EnBox = (*this).actor.parent as *mut EnBox;
    if !treasureChest.is_null() &&
           Animation_OnFrame(&mut (*treasureChest).skelanime, 10.0f32) != 0 {
        func_809937B4(this, globalCtx, (*treasureChest).skelanime.curFrame);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809937B4(mut this: *mut DemoTreLgt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut currentFrame: f32_0) {
    let mut skelCurve: *mut SkelAnimeCurve = &mut (*this).skelCurve;
    let mut pad: [s32; 2] = [0; 2];
    (*this).action = DEMO_TRE_LGT_ACTION_ANIMATE as libc::c_int;
    SkelCurve_SetAnim(skelCurve,
                      sTransformUpdIdx[gSaveContext.linkAge as usize], 1.0f32,
                      sDemoTreLgtInfo[gSaveContext.linkAge as usize].endFrame
                          +
                          sDemoTreLgtInfo[gSaveContext.linkAge as
                                              usize].unk_08, currentFrame,
                      1.0f32);
    SkelCurve_Update(globalCtx, skelCurve);
}
#[no_mangle]
pub unsafe extern "C" fn func_80993848(mut this: *mut DemoTreLgt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut currentFrame: f32_0 = (*this).skelCurve.animCurFrame;
    if currentFrame < sDemoTreLgtInfo[gSaveContext.linkAge as usize].endFrame
       {
        (*this).unk_170 = 255 as libc::c_int as u32_0
    } else if currentFrame <=
                  sDemoTreLgtInfo[gSaveContext.linkAge as usize].endFrame +
                      sDemoTreLgtInfo[gSaveContext.linkAge as usize].unk_08 {
        (*this).unk_170 =
            ((sDemoTreLgtInfo[gSaveContext.linkAge as usize].endFrame -
                  currentFrame) /
                 sDemoTreLgtInfo[gSaveContext.linkAge as usize].unk_08 *
                 255.0f32 + 255.0f32) as u32_0
    } else { (*this).unk_170 = 0 as libc::c_int as u32_0 }
    if currentFrame < sDemoTreLgtInfo[gSaveContext.linkAge as usize].unk_0C {
        (*this).unk_174 = 255 as libc::c_int as u32_0
    } else if currentFrame <
                  sDemoTreLgtInfo[gSaveContext.linkAge as usize].unk_0C +
                      10.0f32 {
        (*this).unk_174 =
            ((sDemoTreLgtInfo[gSaveContext.linkAge as usize].unk_0C -
                  currentFrame) / 10.0f32 * 255.0f32 + 255.0f32) as u32_0
    } else { (*this).unk_174 = 0 as libc::c_int as u32_0 }
    if currentFrame > 30.0f32 &&
           (*this).status as libc::c_int & 1 as libc::c_int == 0 {
        (*this).status =
            ((*this).status as libc::c_int | 1 as libc::c_int) as u8_0;
        Audio_PlaySoundGeneral(0x2884 as libc::c_int as u16_0,
...
#[no_mangle]
pub unsafe extern "C" fn DemoTreLgt_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut DemoTreLgt = thisx as *mut DemoTreLgt;
...
#[no_mangle]
pub unsafe extern "C" fn DemoTreLgt_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut skelCurve:
                                                     *mut SkelAnimeCurve,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (*globalCtx).state.frames.wrapping_mul(2 as
                                                                    libc::c_int
                                                                    as
            ...
            (255 as libc::c_int as u32_0 &
                ...
                ((*this).unk_170 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int
    } else if limbIndex == 13 as libc::c_int || limbIndex == 7 as libc::c_int
                  || limbIndex == 4 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn DemoTreLgt_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).action != DEMO_TRE_LGT_ACTION_ANIMATE as libc::c_int { return }
    ...
    (*_g).words.w1 =
        (200 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    SkelCurve_Draw(&mut (*this).actor, globalCtx, &mut (*this).skelCurve,
                   Some(DemoTreLgt_PostLimbDraw as
