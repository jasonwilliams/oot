...
extern "C" {
    ...
    fn OnePointCutscene_Init(globalCtx: *mut GlobalContext, csId: s16,
     ...
     -> s16;
    #[no_mangle]
    static mut gDodongoRisingPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gDodongoRisingPlatformCol: CollisionHeader;
}
...
pub struct BgDdanJd {
    ...
    pub actionFunc: BgDdanJdActionFunc,
    pub state: u8_0,
    pub ySpeed: u8_0,
    pub idleTimer: s16,
    pub targetY: f32_0,
}
pub type BgDdanJdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgDdanJd, _: *mut GlobalContext)
               -> ()>;
pub const STATE_GO_MIDDLE_FROM_BOTTOM: C2RustUnnamed_19 = 1;
pub const STATE_GO_MIDDLE_FROM_TOP: C2RustUnnamed_19 = 2;
pub const STATE_GO_TOP: C2RustUnnamed_19 = 3;
pub const STATE_GO_BOTTOM: C2RustUnnamed_19 = 0;
pub type C2RustUnnamed_19 = libc::c_uint;
#[no_mangle]
pub static mut Bg_Ddan_Jd_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_DDAN_JD as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDdanJd_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDdanJd_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgDdanJd = thisx as *mut BgDdanJd;
    ...
    CollisionHeader_GetVirtual(&mut gDodongoRisingPlatformCol as
    ...
    (*this).idleTimer = 100 as libc::c_int as s16;
    (*this).state = STATE_GO_BOTTOM as libc::c_int as u8_0;
    ...
    if Flags_GetSwitch(globalCtx, (*this).dyna.actor.params as s32) != 0 {
        (*this).ySpeed = 5 as libc::c_int as u8_0
    } else { (*this).ySpeed = 1 as libc::c_int as u8_0 }
    (*this).actionFunc =
        Some(BgDdanJd_Idle as
                 unsafe extern "C" fn(_: *mut BgDdanJd, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDdanJd = thisx as *mut BgDdanJd;
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Idle(mut this: *mut BgDdanJd,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).idleTimer as libc::c_int != 0 as libc::c_int {
        (*this).idleTimer -= 1
    }
    // if this is the platform that rises all the way to the top, and the switch state has just changed to on
    if (*this).ySpeed as libc::c_int == 1 as libc::c_int &&
           ((*this).dyna.actor.params as libc::c_int) < 0x40 as libc::c_int &&
           Flags_GetSwitch(globalCtx, (*this).dyna.actor.params as s32) != 0 {
        (*this).ySpeed = 5 as libc::c_int as u8_0;
        (*this).state = STATE_GO_MIDDLE_FROM_BOTTOM as libc::c_int as u8_0;
        (*this).idleTimer = 0 as libc::c_int as s16;
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y + 140.0f32;
        OnePointCutscene_Init(globalCtx, 3060 as libc::c_int as s16,
    ...
    if (*this).idleTimer as libc::c_int == 0 as libc::c_int {
        (*this).idleTimer = 100 as libc::c_int as s16;
        if (*this).state as libc::c_int == STATE_GO_BOTTOM as libc::c_int {
            (*this).state =
                STATE_GO_MIDDLE_FROM_BOTTOM as libc::c_int as u8_0;
            (*this).targetY = (*this).dyna.actor.home.pos.y + 140.0f32
        } else if (*this).state as libc::c_int ==
                      STATE_GO_MIDDLE_FROM_BOTTOM as libc::c_int {
            // If the platform has been activated as a shortcut
            if (*this).ySpeed as libc::c_int != 1 as libc::c_int {
                (*this).state = STATE_GO_TOP as libc::c_int as u8_0;
                (*this).targetY = (*this).dyna.actor.home.pos.y + 700.0f32
            } else {
                (*this).state = STATE_GO_BOTTOM as libc::c_int as u8_0;
                (*this).targetY = (*this).dyna.actor.home.pos.y
            }
        } else if (*this).state as libc::c_int ==
                      STATE_GO_MIDDLE_FROM_TOP as libc::c_int {
            // If the platform has been activated as a shortcut
            if (*this).ySpeed as libc::c_int != 1 as libc::c_int {
                (*this).state = STATE_GO_TOP as libc::c_int as u8_0;
                (*this).targetY = (*this).dyna.actor.home.pos.y + 700.0f32
        ...
        } else if (*this).state as libc::c_int == STATE_GO_TOP as libc::c_int
         {
            (*this).state = STATE_GO_MIDDLE_FROM_TOP as libc::c_int as u8_0;
            (*this).targetY = (*this).dyna.actor.home.pos.y + 140.0f32
        }
        (*this).actionFunc =
            Some(BgDdanJd_Move as
                     unsafe extern "C" fn(_: *mut BgDdanJd,
                                          _: *mut GlobalContext) -> ())
    };
}
// Handles dust particles and sfx when moving
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_MoveEffects(mut this: *mut BgDdanJd,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0 {
        dustPos.x = (*this).dyna.actor.world.pos.x + 65.0f32;
        dustPos.z =
            Rand_CenteredFloat(110.0f32) + (*this).dyna.actor.world.pos.z;
        func_80033480(globalCtx, &mut dustPos, 5.0f32, 1 as libc::c_int,
                      20 as libc::c_int as s16, 60 as libc::c_int as s16,
        ...
        dustPos.x =
            Rand_CenteredFloat(110.0f32) + (*this).dyna.actor.world.pos.x;
        dustPos.z = (*this).dyna.actor.world.pos.z + 65.0f32;
        func_80033480(globalCtx, &mut dustPos, 5.0f32, 1 as libc::c_int,
                      20 as libc::c_int as s16, 60 as libc::c_int as s16,
                      1 as libc::c_int as u8_0);
        dustPos.x =
    ...
    if (*this).ySpeed as libc::c_int == 5 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Move(mut this: *mut BgDdanJd,
                                       mut globalCtx: *mut GlobalContext) {
    // if this is the platform that rises all the way to the top, and the switch state has just changed to on
    if (*this).ySpeed as libc::c_int == 1 as libc::c_int &&
           ((*this).dyna.actor.params as libc::c_int) < 0x40 as libc::c_int &&
        ...
        OnePointCutscene_Init(globalCtx, 3060 as libc::c_int as s16,
                           ...
                           (*this).targetY, (*this).ySpeed as f32_0) != 0 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28f1 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(BgDdanJd_Idle as
                     unsafe extern "C" fn(_: *mut BgDdanJd,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDdanJd = thisx as *mut BgDdanJd;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgDdanJd_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gDodongoRisingPlatformDL.as_mut_ptr());
}
