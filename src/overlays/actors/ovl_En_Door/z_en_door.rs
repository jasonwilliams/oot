...
extern "C" {
    ...
    #[no_mangle]
    static mut gDoor1Anim: AnimationHeader;
    #[no_mangle]
    static mut gDoor2Anim: AnimationHeader;
    #[no_mangle]
    static mut gDoor3Anim: AnimationHeader;
    #[no_mangle]
    static mut gDoorLeftDL: [Gfx; 0];
    #[no_mangle]
    static mut gDoorRightDL: [Gfx; 0];
    #[no_mangle]
    static mut gDoorSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDoor4Anim: AnimationHeader;
    #[no_mangle]
    static mut gFieldDoor1DL: [Gfx; 0];
    #[no_mangle]
    static mut gFieldDoor2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleDoorWithHandleBackDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleDoorWithHandleFrontDL: [Gfx; 0];
    #[no_mangle]
    static mut gWaterTempleDoorLeftDL: [Gfx; 0];
    #[no_mangle]
    static mut gWaterTempleDoorRightDL: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_door_DL_0013B8: [Gfx; 0];
    #[no_mangle]
    static mut object_haka_door_DL_001420: [Gfx; 0];
}
...
pub const DOORLOCK_NORMAL_SPIRIT: C2RustUnnamed_16 = 2;
pub const DOORLOCK_BOSS: C2RustUnnamed_16 = 1;
pub const DOORLOCK_NORMAL: C2RustUnnamed_16 = 0;
pub type C2RustUnnamed_17 = libc::c_int;
pub const PLAYER_DOORTYPE_FAKE: C2RustUnnamed_17 = 3;
pub const PLAYER_DOORTYPE_SLIDING: C2RustUnnamed_17 = 2;
pub const PLAYER_DOORTYPE_HANDLE: C2RustUnnamed_17 = 1;
pub const PLAYER_DOORTYPE_NONE: C2RustUnnamed_17 = 0;
pub const PLAYER_DOORTYPE_AJAR: C2RustUnnamed_17 = -1;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDoorInfo {
    pub sceneNum: s16,
    pub dListIndex: u8_0,
    pub objectId: s16,
}
pub type C2RustUnnamed_21 = libc::c_uint;
pub const DOOR_ROOMLOAD7: C2RustUnnamed_21 = 7;
pub const DOOR_EVENING: C2RustUnnamed_21 = 6;
pub const DOOR_CHECKABLE: C2RustUnnamed_21 = 5;
pub const DOOR_AJAR: C2RustUnnamed_21 = 4;
pub const DOOR_SCENEEXIT: C2RustUnnamed_21 = 3;
pub const DOOR_ROOMLOAD2: C2RustUnnamed_21 = 2;
pub const DOOR_LOCKED: C2RustUnnamed_21 = 1;
pub const DOOR_ROOMLOAD: C2RustUnnamed_21 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDoor {
    pub actor: Actor,
...
#[no_mangle]
pub static mut En_Door_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DOOR as libc::c_int as s16,
 ...
 */
static mut sDoorInfo: [EnDoorInfo; 6] =
    [{
         let mut init =
             EnDoorInfo{sceneNum: SCENE_HIDAN as libc::c_int as s16,
                        dListIndex: 1 as libc::c_int as u8_0,
                        objectId:
     ...
     {
         let mut init =
             EnDoorInfo{sceneNum: SCENE_MIZUSIN as libc::c_int as s16,
                        dListIndex: 2 as libc::c_int as u8_0,
                        objectId: OBJECT_MIZU_OBJECTS as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnDoorInfo{sceneNum: SCENE_HAKADAN as libc::c_int as s16,
                        dListIndex: 3 as libc::c_int as u8_0,
                        objectId: OBJECT_HAKA_DOOR as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnDoorInfo{sceneNum: SCENE_HAKADANCH as libc::c_int as s16,
                        dListIndex: 3 as libc::c_int as u8_0,
                        objectId: OBJECT_HAKA_DOOR as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnDoorInfo{sceneNum: -(1 as libc::c_int) as s16,
                        dListIndex: 0 as libc::c_int as u8_0,
                        objectId:
                            OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnDoorInfo{sceneNum: -(1 as libc::c_int) as s16,
                        dListIndex: 4 as libc::c_int as u8_0,
                        objectId:
...
static mut D_809FCECC: [*mut AnimationHeader; 4] =
    unsafe {
        [&gDoor3Anim as *const AnimationHeader as *mut AnimationHeader,
         &gDoor1Anim as *const AnimationHeader as *mut AnimationHeader,
         &gDoor4Anim as *const AnimationHeader as *mut AnimationHeader,
         &gDoor2Anim as *const AnimationHeader as *mut AnimationHeader]
    };
static mut sDoorAnimOpenFrames: [u8_0; 4] =
    [25 as libc::c_int as u8_0, 25 as libc::c_int as u8_0,
     25 as libc::c_int as u8_0, 25 as libc::c_int as u8_0];
static mut sDoorAnimCloseFrames: [u8_0; 4] =
    [60 as libc::c_int as u8_0, 70 as libc::c_int as u8_0,
     60 as libc::c_int as u8_0, 70 as libc::c_int as u8_0];
static mut D_809FCEE4: [[*mut Gfx; 2]; 5] =
    unsafe {
        [[gDoorLeftDL.as_ptr() as *mut _, gDoorRightDL.as_ptr() as *mut _],
         [gFireTempleDoorWithHandleFrontDL.as_ptr() as *mut _,
          gFireTempleDoorWithHandleBackDL.as_ptr() as *mut _],
         [gWaterTempleDoorLeftDL.as_ptr() as *mut _,
          gWaterTempleDoorRightDL.as_ptr() as *mut _],
         [object_haka_door_DL_0013B8.as_ptr() as *mut _,
          object_haka_door_DL_001420.as_ptr() as *mut _],
         [gFieldDoor1DL.as_ptr() as *mut _, gFieldDoor2DL.as_ptr() as *mut _]]
    };
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Init(mut thisx: *mut Actor,
                                     mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnDoor = thisx as *mut EnDoor;
    let mut objectInfo: *mut EnDoorInfo = 0 as *mut EnDoorInfo;
    let mut i: s32 = 0;
    let mut objBankIndex: s32 = 0;
    let mut xOffset: f32_0 = 0.;
    let mut zOffset: f32_0 = 0.;
    objectInfo =
        &mut *sDoorInfo.as_mut_ptr().offset(0 as libc::c_int as isize) as
            *mut EnDoorInfo;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gDoorSkel,
                   &mut gDoor3Anim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 5 as libc::c_int);
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[EnDoorInfo; 6]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnDoorInfo>()
                                                   as libc::c_ulong) as s32 -
                  2 as libc::c_int {
        if (*globalCtx).sceneNum as libc::c_int ==
               (*objectInfo).sceneNum as libc::c_int {
            break ;
        }
        i += 1;
        objectInfo = objectInfo.offset(1)
    }
    if i >=
           (::std::mem::size_of::<[EnDoorInfo; 6]>() as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<EnDoorInfo>()
    ...
    (*this).dListIndex = (*objectInfo).dListIndex as s8;
    objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx, (*objectInfo).objectId);
    if objBankIndex < 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).requiredObjBankIndex = objBankIndex as s8;
    (*this).dListIndex = (*objectInfo).dListIndex as s8;
    if (*this).actor.objBankIndex as libc::c_int ==
        ...
        (*this).actionFunc =
            Some(EnDoor_SetupType as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ())
    }
    // Double doors
    if (*this).actor.params as libc::c_int & 0x40 as libc::c_int != 0 {
        let mut other: *mut EnDoor = 0 as *mut EnDoor;
        xOffset = Math_CosS((*this).actor.shape.rot.y) * 30.0f32;
        zOffset = Math_SinS((*this).actor.shape.rot.y) * 30.0f32;
        other =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               globalCtx, ACTOR_EN_DOOR as libc::c_int as s16,
                               ...
                               ((*this).actor.params as libc::c_int &
                                    !(0x40 as libc::c_int)) as s16) as
                *mut EnDoor;
        if !other.is_null() { (*other).unk_192 = 1 as libc::c_int as u8_0 }
        (*this).actor.world.pos.x -= xOffset;
        (*this).actor.world.pos.z += zOffset
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut transitionEntry: *mut TransitionActorEntry =
        0 as *mut TransitionActorEntry;
    let mut this: *mut EnDoor = thisx as *mut EnDoor;
    transitionEntry =
        &mut *(*globalCtx).transiActorCtx.list.offset(((*this).actor.params as
                                                           u16_0 as
                                                           libc::c_int >>
                                                           0xa as libc::c_int)
                                                          as isize) as
            *mut TransitionActorEntry;
    if ((*transitionEntry).id as libc::c_int) < 0 as libc::c_int {
        (*transitionEntry).id = -((*transitionEntry).id as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_SetupType(mut this: *mut EnDoor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut doorType: s32 = 0;
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        (*this).actionFunc =
            Some(EnDoor_Idle as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ());
        if doorType == DOOR_EVENING as libc::c_int {
            doorType =
                if gSaveContext.dayTime as libc::c_int > 0xc000 as libc::c_int
                       &&
                       (gSaveContext.dayTime as libc::c_int) <
                           0xe000 as libc::c_int {
                    DOOR_SCENEEXIT as libc::c_int
                } else { DOOR_CHECKABLE as libc::c_int }
        }
        (*this).actor.world.rot.y = 0 as libc::c_int as s16;
        if doorType == DOOR_LOCKED as libc::c_int {
            if Flags_GetSwitch(globalCtx,
                               (*this).actor.params as libc::c_int &
                                   0x3f as libc::c_int) == 0 {
                (*this).lockTimer = 10 as libc::c_int as s16
            }
        } else if doorType == DOOR_AJAR as libc::c_int {
            if Actor_WorldDistXZToActor(&mut (*this).actor,
                   ...
                   120.0f32 {
                (*this).actionFunc =
                    Some(EnDoor_AjarWait as
                             unsafe extern "C" fn(_: *mut EnDoor,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).actor.world.rot.y = -(0x1800 as libc::c_int) as s16
            }
        } else if doorType == DOOR_CHECKABLE as libc::c_int {
            (*this).actor.textId =
                (((*this).actor.params as libc::c_int & 0x3f as libc::c_int) +
                     0x200 as libc::c_int) as u16_0;
            if (*this).actor.textId as libc::c_int == 0x229 as libc::c_int &&
                ...
                doorType = DOOR_SCENEEXIT as libc::c_int
            } else {
                (*this).actionFunc =
                    Some(EnDoor_WaitForCheck as
                             unsafe extern "C" fn(_: *mut EnDoor,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).actor.flags |=
        ...
        (*this).actor.params =
            ((*this).actor.params as libc::c_int & !(0x380 as libc::c_int) |
                 doorType << 7 as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Idle(mut this: *mut EnDoor,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).playerIsOpening as libc::c_int != 0 as libc::c_int {
        (*this).actionFunc =
            Some(EnDoor_Open as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ());
        Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                                   D_809FCECC[(*this).animStyle as usize],
                                   if (*player).stateFlags1 &
                                          0x8000000 as libc::c_int as
                                              libc::c_uint != 0 {
                                       0.75f32
                                   } else { 1.5f32 });
        if (*this).lockTimer as libc::c_int != 0 as libc::c_int {
        ...
        if fabsf(playerPosRelToDoor.y) < 20.0f32 &&
               ...
               fabsf(playerPosRelToDoor.z) < 50.0f32 {
            phi_v0 =
            ...
            if (if phi_v0 as libc::c_int >= 0 as libc::c_int {
                    ...
                    if gSaveContext.inventory.dungeonKeys[gSaveContext.mapIndex
                        ...
                        let mut player2: *mut Player =
                            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER
                                ...
                                as *mut Player;
                        (*player2).naviTextId =
                            -(0x203 as libc::c_int) as s16;
                        return
                    } else { (*player).doorTimer = 10 as libc::c_int as s16 }
                }
                (*player).doorType =
                    if doorType == DOOR_AJAR as libc::c_int {
                        PLAYER_DOORTYPE_AJAR as libc::c_int
                    } else { PLAYER_DOORTYPE_HANDLE as libc::c_int } as s8;
                ...
                (*player).doorActor = &mut (*this).actor
                      ...
                      (*this).actor.xzDistToPlayer >
                          2 as libc::c_int as libc::c_float * 120.0f32 {
            (*this).actionFunc =
                Some(EnDoor_AjarOpen as
                         unsafe extern "C" fn(_: *mut EnDoor,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnDoor_WaitForCheck(mut this: *mut EnDoor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnDoor_Check as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ())
    } else { func_8002F2CC(&mut (*this).actor, globalCtx, 40.0f32); };
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Check(mut this: *mut EnDoor,
                                      mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDoor_AjarWait(mut this: *mut EnDoor,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.xzDistToPlayer < 120.0f32 {
        (*this).actionFunc =
            Some(EnDoor_AjarClose as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_AjarOpen(mut this: *mut EnDoor,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.xzDistToPlayer < 120.0f32 {
        (*this).actionFunc =
            Some(EnDoor_AjarClose as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ())
    } else if Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
...
#[no_mangle]
pub unsafe extern "C" fn EnDoor_AjarClose(mut this: *mut EnDoor,
                                          mut globalCtx: *mut GlobalContext) {
    if Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                          0 as libc::c_int as s16,
                          0x700 as libc::c_int as s16) != 0 {
        (*this).actionFunc =
            Some(EnDoor_Idle as
                     unsafe extern "C" fn(_: *mut EnDoor,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Open(mut this: *mut EnDoor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut numEffects: s32 = 0;
    if (if (*this).lockTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).lockTimer -= 1; (*this).lockTimer as libc::c_int })
           == 0 as libc::c_int {
        if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
            ...
            (*this).playerIsOpening = 0 as libc::c_int as u8_0
                                    ...
                                    sDoorAnimOpenFrames[(*this).animStyle as
                                                            usize] as f32_0)
                      != 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  if (*globalCtx).sceneNum as libc::c_int ==
                                         ...
                                         (*globalCtx).sceneNum as libc::c_int
                                             == SCENE_HAKADANCH as libc::c_int
                                         ||
                                         (*globalCtx).sceneNum as libc::c_int
                                             == SCENE_HIDAN as libc::c_int {
                                      0x28db as libc::c_int
                                  } else { 0x5802 as libc::c_int } as u16_0);
            if (*this).skelAnime.playSpeed < 1.5f32 {
                numEffects =
                    (Rand_ZeroOne() * 30.0f32) as s32 + 50 as libc::c_int;
                i = 0 as libc::c_int;
                while i < numEffects {
                    EffectSsBubble_Spawn(globalCtx,
                                         &mut (*this).actor.world.pos,
                                         60.0f32, 100.0f32, 50.0f32, 0.15f32);
                    i += 1
                }
            }
        } else if Animation_OnFrame(&mut (*this).skelAnime,
                                    sDoorAnimCloseFrames[(*this).animStyle as
                                                             usize] as f32_0)
                      != 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  if (*globalCtx).sceneNum as libc::c_int ==
                                         ...
                                         (*globalCtx).sceneNum as libc::c_int
                                             == SCENE_HIDAN as libc::c_int {
                                      0x28dc as libc::c_int
                                  } else { 0x2801 as libc::c_int } as u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDoor = thisx as *mut EnDoor;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
 ...
 -> s32 {
    ...
    let mut transitionEntry: *mut TransitionActorEntry =
        0 as *mut TransitionActorEntry;
    let mut temp_a2: *mut *mut Gfx = 0 as *mut *mut Gfx;
    let mut pad2: s32 = 0;
    let mut phi_v0_2: s16 = 0;
    let mut phi_v0: s32 = 0;
    let mut this: *mut EnDoor = thisx as *mut EnDoor;
    if limbIndex == 4 as libc::c_int {
        temp_a2 = D_809FCEE4[(*this).dListIndex as usize].as_mut_ptr();
        transitionEntry =
            &mut *(*globalCtx).transiActorCtx.list.offset(((*this).actor.params
                                                               as u16_0 as
                                                               libc::c_int >>
                                                               0xa as
                                                                   libc::c_int)
        ...
        if (*globalCtx).roomCtx.prevRoom.num as libc::c_int >=
               0 as libc::c_int ||
               (*transitionEntry).sides[0 as libc::c_int as usize].room as
                   libc::c_int ==
            ...
            phi_v0_2 =
                ((*this).actor.shape.rot.y as libc::c_int +
                     (*(*this).skelAnime.jointTable.offset(3 as libc::c_int as
                                                               isize)).z as
                         libc::c_int + (*rot).z as libc::c_int -
                     Math_Vec3f_Yaw(&mut (*globalCtx).view.eye,
                                    &mut (*this).actor.world.pos) as
                         libc::c_int) as s16;
            *dList =
                if (if phi_v0_2 as libc::c_int >= 0 as libc::c_int {
                        phi_v0_2 as libc::c_int
                    } else { -(phi_v0_2 as libc::c_int) }) <
                       0x4000 as libc::c_int {
                    *temp_a2.offset(0 as libc::c_int as isize)
                } else { *temp_a2.offset(1 as libc::c_int as isize) }
        } else {
            phi_v0 = (*this).unk_192 as s32;
            if (*transitionEntry).sides[0 as libc::c_int as usize].room as
                   libc::c_int != (*this).actor.room as libc::c_int {
                phi_v0 ^= 1 as libc::c_int
            }
            *dList = *temp_a2.offset(phi_v0 as isize)
        }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnDoor_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDoor = thisx as *mut EnDoor;
    if (*this).actor.objBankIndex as libc::c_int ==
           (*this).requiredObjBankIndex as libc::c_int {
        ...
        SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          &mut (*this).actor as *mut Actor as
                              *mut libc::c_void);
        if (*this).actor.world.rot.y as libc::c_int != 0 as libc::c_int {
            if (*this).actor.world.rot.y as libc::c_int > 0 as libc::c_int {
                    ...
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 16 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g).words.w1 = gDoorRightDL.as_mut_ptr() as libc::c_uint
            } else {
                    ...
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                             (((0x1 as libc::c_int) << 16 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            0 as libc::c_int;
                (*_g_0).words.w1 = gDoorLeftDL.as_mut_ptr() as libc::c_uint
            }
        }
        if (*this).lockTimer as libc::c_int != 0 as libc::c_int {
            Actor_DrawDoorLock(globalCtx, (*this).lockTimer as s32,
                               DOORLOCK_NORMAL as libc::c_int);
        }
