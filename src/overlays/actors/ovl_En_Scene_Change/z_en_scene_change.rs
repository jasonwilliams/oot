...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnSceneChange {
    pub actor: Actor,
    pub actionFunc: EnSceneChangeActionFunc,
}
pub type EnSceneChangeActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnSceneChange, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Scene_Change_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_SCENE_CHANGE as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnSceneChange>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSceneChange_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSceneChange_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSceneChange_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnSceneChange_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_SetupAction(mut this:
                                                       *mut EnSceneChange,
                                                   mut actionFunc:
                                                       EnSceneChangeActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnSceneChange = thisx as *mut EnSceneChange;
    EnSceneChange_SetupAction(this,
                              Some(EnSceneChange_DoNothing as
                                       unsafe extern "C" fn(_:
                                                                *mut EnSceneChange,
                                                            _:
                                                                *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_DoNothing(mut this: *mut EnSceneChange,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnSceneChange = thisx as *mut EnSceneChange;
...
#[no_mangle]
pub unsafe extern "C" fn EnSceneChange_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    displayList =
        Graph_Alloc((*globalCtx).state.gfxCtx, 0x3c0 as libc::c_int as size_t)
            as *mut Gfx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_scene_change.c\x00" as *const u8 as
