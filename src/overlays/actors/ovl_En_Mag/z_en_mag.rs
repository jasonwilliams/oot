...
extern "C" {
    ...
    #[no_mangle]
    fn func_8009457C(gfxp: *mut *mut Gfx);
    #[no_mangle]
    fn func_80094D28(gfxp: *mut *mut Gfx);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gTitleZeldaShieldLogoMQTex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleCopyright19982003Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleMasterQuestSubtitleTex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask00Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask01Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask02Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask10Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask11Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask12Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask20Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask21Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleEffectMask22Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleFlameEffectTex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleTheLegendOfTextTex: [u64_0; 0];
    #[no_mangle]
    static mut gTitleOcarinaOfTimeTMTextTex: [u64_0; 0];
}
...
pub struct EnMag {
    ...
    pub font: Font,
    pub effectFadeInState: s16,
    pub effectFadeInTimer: s16,
    pub globalState: s16,
    pub effectPrimLodFrac: f32_0,
    pub effectPrimColor: [f32_0; 3],
    pub effectEnvColor: [f32_0; 3],
    pub effectAlpha: f32_0,
    pub mainAlpha: f32_0,
    pub subAlpha: f32_0,
    pub copyrightAlpha: f32_0,
    pub unk_E30C: s16,
    pub effectScroll: s16,
    pub unk_E310: [libc::c_char; 2],
    pub copyrightAlphaStep: s16,
    pub fadeOutAlphaStep: s16,
    pub unk_E316: s16,
    pub unk_E318: s16,
    pub unk_E31C: s32,
    pub unk_E320: s32,
    pub unk_E324: [libc::c_char; 4],
}
pub type C2RustUnnamed_17 = libc::c_uint;
pub const MAG_STATE_POST_DISPLAY: C2RustUnnamed_17 = 4;
pub const MAG_STATE_FADE_OUT: C2RustUnnamed_17 = 3;
pub const MAG_STATE_DISPLAY: C2RustUnnamed_17 = 2;
pub const MAG_STATE_FADE_IN: C2RustUnnamed_17 = 1;
pub const MAG_STATE_INITIAL: C2RustUnnamed_17 = 0;
#[no_mangle]
pub static mut En_Mag_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MAG as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_MAG as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnMag>() as libc::c_ulong,
                          init:
...
static mut sDelayTimer: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub unsafe extern "C" fn EnMag_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMag = thisx as *mut EnMag;
    ...
    (*this).copyrightAlphaStep = 6 as libc::c_int as s16;
    (*this).fadeOutAlphaStep = 10 as libc::c_int as s16;
    (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
    ...
    (*this).effectScroll = 0 as libc::c_int as s16;
    (*this).unk_E30C = 0 as libc::c_int as s16;
    (*this).effectPrimColor[0 as libc::c_int as usize] = 0.0f32;
    (*this).effectPrimColor[1 as libc::c_int as usize] = 100.0f32;
    (*this).effectPrimColor[2 as libc::c_int as usize] = 170.0f32;
    (*this).effectEnvColor[0 as libc::c_int as usize] = 0.0f32;
    (*this).effectEnvColor[1 as libc::c_int as usize] = 100.0f32;
    (*this).effectEnvColor[2 as libc::c_int as usize] = 0.0f32;
    (*this).effectFadeInTimer = 40 as libc::c_int as s16;
    (*this).copyrightAlpha = 0.0f32;
    (*this).subAlpha = (*this).copyrightAlpha;
    (*this).mainAlpha = (*this).subAlpha;
    (*this).effectAlpha = (*this).mainAlpha;
    (*this).globalState = (*this).effectAlpha as s16;
    (*this).effectPrimLodFrac = (*this).globalState as f32_0;
    (*this).effectFadeInState = (*this).effectPrimLodFrac as s16;
    if gSaveContext.unk_13E7 as libc::c_int != 0 as libc::c_int {
        (*this).mainAlpha = 210 as libc::c_int as f32_0;
        (*this).subAlpha = 255 as libc::c_int as f32_0;
        (*this).copyrightAlpha = 255 as libc::c_int as f32_0;
        (*this).effectPrimLodFrac = 128.0f32;
        (*this).effectAlpha = 255.0f32;
        (*this).effectPrimColor[0 as libc::c_int as usize] =
            170 as libc::c_int as f32_0;
        (*this).effectPrimColor[1 as libc::c_int as usize] = 255.0f32;
        (*this).effectPrimColor[2 as libc::c_int as usize] = 255.0f32;
        (*this).effectEnvColor[0 as libc::c_int as usize] = 200.0f32;
        (*this).effectEnvColor[1 as libc::c_int as usize] = 255.0f32;
        (*this).effectEnvColor[2 as libc::c_int as usize] =
            0 as libc::c_int as f32_0;
        gSaveContext.unk_13E7 = 0 as libc::c_int as u8_0;
        (*this).globalState = MAG_STATE_DISPLAY as libc::c_int as s16;
        sDelayTimer = 20 as libc::c_int as s16;
        gSaveContext.fadeDuration = 1 as libc::c_int as u8_0;
        gSaveContext.unk_1419 = 255 as libc::c_int as u8_0
    }
    Font_LoadOrderedFont(&mut (*this).font);
    (*this).unk_E316 = 0 as libc::c_int as s16;
    (*this).unk_E318 = 0 as libc::c_int as s16;
    (*this).unk_E31C = 0 as libc::c_int;
    (*this).unk_E320 = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnMag_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnMag_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut this: *mut EnMag = thisx as *mut EnMag;
    if gSaveContext.fileNum != 0xfedc as libc::c_int {
        if ((*this).globalState as libc::c_int) <
               MAG_STATE_DISPLAY as libc::c_int {
            if !((*globalCtx).state.input[0 as libc::c_int as
        ...
        } else if (*this).globalState as libc::c_int >=
                      MAG_STATE_DISPLAY as libc::c_int {
            if sDelayTimer as libc::c_int == 0 as libc::c_int {
                if !((*globalCtx).state.input[0 as libc::c_int as
                                                  usize].press.button as
                         libc::c_int | !(0x1000 as libc::c_int)) ==
                       0 as libc::c_int ||
                    ...
                    if (*globalCtx).sceneLoadFlag as libc::c_int !=
                        ...
                        Audio_PlaySoundGeneral(0x4823 as libc::c_int as u16_0,
                                               ...
                                               &mut D_801333E0,
                                               &mut D_801333E8);
                        gSaveContext.gameMode = 2 as libc::c_int;
                        (*globalCtx).sceneLoadFlag = 20 as libc::c_int as s8;
                        (*globalCtx).fadeTransition = 2 as libc::c_int as u8_0
                    }
                    (*this).copyrightAlphaStep = 15 as libc::c_int as s16;
                    (*this).fadeOutAlphaStep = 25 as libc::c_int as s16;
                    (*this).globalState =
                        MAG_STATE_FADE_OUT as libc::c_int as s16
                }
            } else { sDelayTimer -= 1 }
        }
    }
    if (*this).globalState as libc::c_int == MAG_STATE_FADE_IN as libc::c_int
       {
        if (*this).effectFadeInState as libc::c_int == 0 as libc::c_int {
            (*this).effectAlpha += 6.375f32;
            (*this).effectPrimLodFrac += 0.8f32;
            (*this).effectPrimColor[0 as libc::c_int as usize] += 6.375f32;
            (*this).effectPrimColor[1 as libc::c_int as usize] += 3.875f32;
            (*this).effectPrimColor[2 as libc::c_int as usize] += 2.125f32;
            (*this).effectEnvColor[0 as libc::c_int as usize] += 6.375f32;
            (*this).effectEnvColor[1 as libc::c_int as usize] += 3.875f32;
            (*this).effectFadeInTimer -= 1;
            if (*this).effectFadeInTimer as libc::c_int == 0 as libc::c_int {
                (*this).effectPrimLodFrac = 32.0f32;
                (*this).effectAlpha = 255.0f32;
                (*this).effectPrimColor[0 as libc::c_int as usize] = 255.0f32;
                (*this).effectPrimColor[1 as libc::c_int as usize] = 255.0f32;
                (*this).effectPrimColor[2 as libc::c_int as usize] = 255.0f32;
                (*this).effectEnvColor[0 as libc::c_int as usize] = 255.0f32;
                (*this).effectEnvColor[1 as libc::c_int as usize] = 255.0f32;
                (*this).effectFadeInTimer = 40 as libc::c_int as s16;
                (*this).effectFadeInState = 1 as libc::c_int as s16
            }
        } else if (*this).effectFadeInState as libc::c_int == 1 as libc::c_int
         {
            (*this).effectPrimColor[0 as libc::c_int as usize] += -2.125f32;
            (*this).effectEnvColor[0 as libc::c_int as usize] += -1.375f32;
            (*this).effectPrimLodFrac += 2.4f32;
            (*this).effectFadeInTimer -= 1;
            if (*this).effectFadeInTimer as libc::c_int == 0 as libc::c_int {
                (*this).effectPrimLodFrac = 128.0f32;
                (*this).effectPrimColor[0 as libc::c_int as usize] = 170.0f32;
                (*this).effectEnvColor[0 as libc::c_int as usize] = 200.0f32;
                (*this).effectFadeInTimer = 32 as libc::c_int as s16;
                (*this).effectFadeInState = 2 as libc::c_int as s16
            }
        }
        if (*this).effectAlpha > 160 as libc::c_int as libc::c_float {
            (*this).mainAlpha +=
                (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 5 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float;
            if (*this).mainAlpha >= 210.0f32 { (*this).mainAlpha = 210.0f32 }
            if (*this).mainAlpha >= 210 as libc::c_int as libc::c_float {
                (*this).subAlpha +=
                    (*gGameInfo).data[(20 as libc::c_int * 6 as libc::c_int *
                                           16 as libc::c_int +
                                           6 as libc::c_int) as usize] as
                        libc::c_int as libc::c_float;
                if (*this).subAlpha >= 255.0f32 {
                    (*this).subAlpha = 255.0f32
                }
                if (*this).subAlpha >= 200 as libc::c_int as libc::c_float {
                    (*this).copyrightAlpha +=
                        (*this).copyrightAlphaStep as libc::c_int as
                            libc::c_float;
                    if (*this).copyrightAlpha >= 255.0f32 {
                        (*this).copyrightAlpha = 255.0f32;
                        (*this).globalState =
                            MAG_STATE_DISPLAY as libc::c_int as s16;
                        sDelayTimer = 20 as libc::c_int as s16
                    }
                }
            }
                  ...
                  MAG_STATE_FADE_OUT as libc::c_int {
        (*this).effectAlpha -=
            (*this).fadeOutAlphaStep as libc::c_int as libc::c_float;
        if (*this).effectAlpha < 0.0f32 { (*this).effectAlpha = 0.0f32 }
        (*this).mainAlpha -=
            (*this).fadeOutAlphaStep as libc::c_int as libc::c_float;
        if (*this).mainAlpha < 0.0f32 { (*this).mainAlpha = 0.0f32 }
        (*this).subAlpha -=
            (*this).fadeOutAlphaStep as libc::c_int as libc::c_float;
        if (*this).subAlpha < 0.0f32 { (*this).subAlpha = 0.0f32 }
        (*this).copyrightAlpha -=
            (*this).copyrightAlphaStep as libc::c_int as libc::c_float;
        if (*this).copyrightAlpha < 0.0f32 {
            (*this).copyrightAlpha = 0.0f32;
            (*this).globalState = MAG_STATE_POST_DISPLAY as libc::c_int as s16
        }
    }
    if (*this).globalState as libc::c_int == MAG_STATE_INITIAL as libc::c_int
       {
        if Flags_GetEnv(globalCtx, 3 as libc::c_int as s16) != 0 {
            (*this).effectFadeInTimer = 40 as libc::c_int as s16;
            (*this).globalState = MAG_STATE_FADE_IN as libc::c_int as s16
        }
    } else if (*this).globalState as libc::c_int ==
                  MAG_STATE_DISPLAY as libc::c_int {
        if Flags_GetEnv(globalCtx, 4 as libc::c_int as s16) != 0 {
            (*this).globalState = MAG_STATE_FADE_OUT as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMag_DrawTextureI8(mut gfxp: *mut *mut Gfx,
    ...
    (*_g_2).words.w1 =
        (7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((if ((texWidth as libc::c_int * texHeight as libc::c_int +
                       1 as libc::c_int >> 1 as libc::c_int) -
                      1 as libc::c_int) < 2047 as libc::c_int {
                  (texWidth as libc::c_int * texHeight as libc::c_int +
                       1 as libc::c_int >> 1 as libc::c_int) -
                      1 as libc::c_int
            ...
            (((((1 as libc::c_int) << 11 as libc::c_int) +
                   (if 1 as libc::c_int >
                           texWidth as libc::c_int * 1 as libc::c_int /
                               8 as libc::c_int {
                        1 as libc::c_int
                    } else {
                        (texWidth as libc::c_int * 1 as libc::c_int) /
        ...
        (0xf5 as libc::c_int as u32_0 &
            ...
            (1 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 2 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 19 as libc::c_int
            |
            ((texWidth as libc::c_int * 1 as libc::c_int + 7 as libc::c_int >>
        ...
        (0 as libc::c_int as u32_0 &
            ...
            (((texWidth as libc::c_int - 1 as libc::c_int) <<
                 ...
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 12 as libc::c_int
            |
            (((texHeight as libc::c_int - 1 as libc::c_int) <<
                  2 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh7 = gfx;
    ...
    (*_g_6).words.w1 =
        (0 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((rectLeft as libc::c_int) << 2 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 12 as libc::c_int
            |
            (((rectTop as libc::c_int) << 2 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh8 = gfx;
    gfx = gfx.offset(1);
...
#[no_mangle]
pub unsafe extern "C" fn EnMag_DrawEffectTextures(mut gfxp: *mut *mut Gfx,
                                                  mut maskTex:
                                                      *mut libc::c_void,
                                                  mut effectTex:
                                                      *mut libc::c_void,
    ...
    (*_g).words.w0 =
        (0xfd as libc::c_int as u32_0 &
            ...
            ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 = maskTex as libc::c_uint;
    let fresh11 = gfx;
    gfx = gfx.offset(1);
    ...
    (*_g_2).words.w1 =
        (7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((if ((maskWidth as libc::c_int * maskHeight as libc::c_int +
                       3 as libc::c_int >> 2 as libc::c_int) -
                      1 as libc::c_int) < 2047 as libc::c_int {
                  (maskWidth as libc::c_int * maskHeight as libc::c_int +
                       3 as libc::c_int >> 2 as libc::c_int) -
                      1 as libc::c_int
              } else { 2047 as libc::c_int }) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
            ...
            (((((1 as libc::c_int) << 11 as libc::c_int) +
                   (if 1 as libc::c_int >
                           maskWidth as libc::c_int / 16 as libc::c_int {
                        1 as libc::c_int
                    } else { (maskWidth as libc::c_int) / 16 as libc::c_int })
                   - 1 as libc::c_int) /
                  (if 1 as libc::c_int >
                          maskWidth as libc::c_int / 16 as libc::c_int {
                       1 as libc::c_int
        ...
        (0xf5 as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 2 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 19 as libc::c_int
            |
            (((maskWidth as libc::c_int >> 1 as libc::c_int) +
        ...
        (0 as libc::c_int as u32_0 &
            ...
            (((maskWidth as libc::c_int - 1 as libc::c_int) <<
                 ...
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 12 as libc::c_int
            |
            (((maskHeight as libc::c_int - 1 as libc::c_int) <<
                  2 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if flag == 0 {
            ...
            (0xfd as libc::c_int as u32_0 &
                ...
                ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = effectTex as libc::c_uint;
        let fresh18 = gfx;
        gfx = gfx.offset(1);
        ...
        (*_g_9).words.w1 =
            (7 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 3 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((if ((effectWidth as libc::c_int *
                           effectHeight as libc::c_int + 1 as libc::c_int >>
                           1 as libc::c_int) - 1 as libc::c_int) <
                         2047 as libc::c_int {
                      (effectWidth as libc::c_int *
                           effectHeight as libc::c_int + 1 as libc::c_int >>
                           1 as libc::c_int) - 1 as libc::c_int
                  } else { 2047 as libc::c_int }) as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                ...
                (((((1 as libc::c_int) << 11 as libc::c_int) +
                       (if 1 as libc::c_int >
                               effectWidth as libc::c_int * 1 as libc::c_int /
                                   8 as libc::c_int {
                            1 as libc::c_int
                        } else {
                            (effectWidth as libc::c_int * 1 as libc::c_int) /
            ...
            (0xf2 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
                (((*this).effectScroll as libc::c_int & 0x7f as libc::c_int)
                     as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnMag_DrawImageRGBA32(mut gfxp: *mut *mut Gfx,
                                               mut centerX: s16,
                                               mut centerY: s16,
                                               mut source: *mut u8_0,
                                               mut width: u32_0,
                                               mut height: u32_0) {
    let mut gfx: *mut Gfx = *gfxp;
    let mut curTexture: *mut u8_0 = 0 as *mut u8_0;
    let mut textureCount: s32 = 0;
    let mut rectLeft: u32_0 = 0;
    let mut rectTop: u32_0 = 0;
    let mut textureHeight: u32_0 = 0;
    let mut remainingSize: s32 = 0;
    let mut textureSize: s32 = 0;
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
    func_80094D28(&mut gfx);
    curTexture = source;
    rectLeft =
        (centerX as
    ...
    textureHeight =
        (4096 as libc::c_int as
             libc::c_uint).wrapping_div(width << 2 as libc::c_int);
    remainingSize = (width.wrapping_mul(height) << 2 as libc::c_int) as s32;
    textureSize =
        (width.wrapping_mul(textureHeight) << 2 as libc::c_int) as s32;
    textureCount = remainingSize / textureSize;
    if remainingSize % textureSize != 0 as libc::c_int {
        textureCount += 1 as libc::c_int
    }
    let fresh28 = gfx;
    gfx = gfx.offset(1);
        ...
        (0xf5 as libc::c_int as u32_0 &
            ...
            (3 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 2 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 19 as libc::c_int
            |
            (width.wrapping_mul(2 as libc::c_int as
    ...
    (*_g_4).words.w1 =
        (0 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (width.wrapping_sub(1 as libc::c_int as libc::c_uint) <<
                 2 as libc::c_int &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 12 as libc::c_int
            |
            (textureHeight.wrapping_sub(1 as libc::c_int as libc::c_uint) <<
                 2 as libc::c_int &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
            ...
            (0xfd as libc::c_int as u32_0 &
                ...
                (width.wrapping_sub(1 as libc::c_int as libc::c_uint) &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_5).words.w1 = curTexture as libc::c_uint;
        let fresh35 = gfx;
        gfx = gfx.offset(1);
        ...
        (*_g_8).words.w0 =
            (0xe4 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (rectLeft.wrapping_add(width as s32 as libc::c_uint) <<
                     2 as libc::c_int &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
                (rectTop.wrapping_add(textureHeight) << 2 as libc::c_int &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_8).words.w1 =
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 3 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (rectLeft << 2 as libc::c_int &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
                (rectTop << 2 as libc::c_int &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        let fresh38 = gfx;
            ...
            (((1 as libc::c_int) << 10 as libc::c_int) as u32_0 &
                ...
                (((1 as libc::c_int) << 10 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        curTexture = curTexture.offset(textureSize as isize);
        rectTop =
            (rectTop as libc::c_uint).wrapping_add(textureHeight) as u32_0 as
                u32_0;
        if remainingSize - textureSize < 0 as libc::c_int {
            if remainingSize > 0 as libc::c_int {
                textureHeight =
                    (remainingSize / (width << 2 as libc::c_int) as s32) as
                        u32_0;
                remainingSize -= textureSize;
                let fresh40 = gfx;
                gfx = gfx.offset(1);
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        (width.wrapping_sub(1 as libc::c_int as libc::c_uint)
                             ...
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
                            12 as libc::c_int |
                        (textureHeight.wrapping_sub(1 as libc::c_int as
                                                        libc::c_uint) <<
                             2 as libc::c_int &
                             (((0x1 as libc::c_int) << 12 as libc::c_int) -
                                  1 as libc::c_int) as libc::c_uint) <<
...
#[no_mangle]
pub unsafe extern "C" fn EnMag_DrawCharTexture(mut gfxp: *mut *mut Gfx,
                                               mut texture: *mut u8_0,
                                               mut rectLeft: s32,
                                               mut rectTop: s32) {
    let mut gfx: *mut Gfx = *gfxp;
    (*gGameInfo).data[(6 as libc::c_int * 6 as libc::c_int * 16 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnMag_DrawInner(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext,
                                         mut gfxp: *mut *mut Gfx) {
    static mut textAlpha: s16 = 0 as libc::c_int as s16;
    static mut textFadeDirection: s16 = 0 as libc::c_int as s16;
    static mut textFadeTimer: s16 = 0 as libc::c_int as s16;
    static mut noControllerFontIndexes: [u8_0; 12] =
        [0x17 as libc::c_int as u8_0, 0x18 as libc::c_int as u8_0,
         0xc as libc::c_int as u8_0, 0x18 as libc::c_int as u8_0,
         0x17 as libc::c_int as u8_0, 0x1d as libc::c_int as u8_0,
         0x1b as libc::c_int as u8_0, 0x18 as libc::c_int as u8_0,
         0x15 as libc::c_int as u8_0, 0x15 as libc::c_int as u8_0,
         0xe as libc::c_int as u8_0, 0x1b as libc::c_int as u8_0];
    static mut pressStartFontIndexes: [u8_0; 10] =
        [0x19 as libc::c_int as u8_0, 0x1b as libc::c_int as u8_0,
         0xe as libc::c_int as u8_0, 0x1c as libc::c_int as u8_0,
         0x1c as libc::c_int as u8_0, 0x1c as libc::c_int as u8_0,
         0x1d as libc::c_int as u8_0, 0xa as libc::c_int as u8_0,
         0x1b as libc::c_int as u8_0, 0x1d as libc::c_int as u8_0];
    static mut effectMaskTextures: [*mut libc::c_void; 9] =
        unsafe {
            [gTitleEffectMask00Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask01Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask02Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask10Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask11Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask12Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask20Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask21Tex.as_ptr() as *mut _ as *mut libc::c_void,
             gTitleEffectMask22Tex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut this: *mut EnMag = thisx as *mut EnMag;
    ...
    let mut j: u16_0 = 0;
    let mut k: u16_0 = 0;
    let mut rectLeft: u16_0 = 0;
    let mut rectTop: u16_0 = 0;
    let fresh56 = gfx;
    gfx = gfx.offset(1);
    ...
    func_8009457C(&mut gfx);
    (*this).effectScroll =
        ((*this).effectScroll as libc::c_int - 2 as libc::c_int) as s16;
    let fresh57 = gfx;
    gfx = gfx.offset(1);
    ...
    (*_g_1).words.w0 =
        (0xe2 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((32 as libc::c_int - 0 as libc::c_int - 2 as libc::c_int) as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((2 as libc::c_int - 1 as libc::c_int) as u32_0 &
    ...
    (*_g_4).words.w0 =
        (0xfa as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*this).effectPrimLodFrac as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 =
        ((*this).effectPrimColor[0 as libc::c_int as usize] as s16 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*this).effectPrimColor[1 as libc::c_int as usize] as s16 as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*this).effectPrimColor[2 as libc::c_int as usize] as s16 as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*this).effectAlpha as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    let fresh62 = gfx;
    gfx = gfx.offset(1);
    let mut _g_5: *mut Gfx = fresh62;
    (*_g_5).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_5).words.w1 =
        ((*this).effectEnvColor[0 as libc::c_int as usize] as s16 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*this).effectEnvColor[1 as libc::c_int as usize] as s16 as u32_0
                 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            ((*this).effectEnvColor[2 as libc::c_int as usize] as s16 as u32_0
                 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).effectPrimLodFrac as s16 as libc::c_int != 0 as libc::c_int {
        k = 0 as libc::c_int as u16_0;
        i = 0 as libc::c_int as u16_0;
        rectTop = 0 as libc::c_int as u16_0;
        while (i as libc::c_int) < 3 as libc::c_int {
            j = 0 as libc::c_int as u16_0;
            rectLeft = 56 as libc::c_int as u16_0;
            while (j as libc::c_int) < 3 as libc::c_int {
                EnMag_DrawEffectTextures(&mut gfx,
                                         effectMaskTextures[k as usize],
                                         gTitleFlameEffectTex.as_mut_ptr() as
                                             *mut libc::c_void,
                                         64 as libc::c_int as s16,
                                         64 as libc::c_int as s16,
                                         32 as libc::c_int as s16,
                                         32 as libc::c_int as s16,
                                         rectLeft as s16, rectTop as s16,
                                         64 as libc::c_int as s16,
                                         64 as libc::c_int as s16,
                                         1024 as libc::c_int as u16_0,
                                         1024 as libc::c_int as u16_0,
                                         1 as libc::c_int as u16_0,
                                         1 as libc::c_int as u16_0, k, this);
                j = j.wrapping_add(1);
                k = k.wrapping_add(1);
                rectLeft =
                    (rectLeft as libc::c_int + 64 as libc::c_int) as u16_0
            }
            i = i.wrapping_add(1);
            rectTop = (rectTop as libc::c_int + 64 as libc::c_int) as u16_0
        }
    }
    let fresh63 = gfx;
    gfx = gfx.offset(1);
    let mut _g_6: *mut Gfx = fresh63;
    (*_g_6).words.w0 =
        (0xfa as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
    ...
    (*_g_6).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((*this).mainAlpha as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).mainAlpha as s16 as libc::c_int != 0 as libc::c_int {
        EnMag_DrawImageRGBA32(&mut gfx, 152 as libc::c_int as s16,
                              100 as libc::c_int as s16,
                              gTitleZeldaShieldLogoMQTex.as_mut_ptr() as
                                  *mut u8_0, 160 as libc::c_int as u32_0,
                              160 as libc::c_int as u32_0);
    }
    func_8009457C(&mut gfx);
    let fresh64 = gfx;
    gfx = gfx.offset(1);
    let mut _g_7: *mut Gfx = fresh64;
    (*_g_7).words.w0 =
        (0xe7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
            ...
            ((5 as libc::c_int as u32_0 &
                 ...
                 (7 as libc::c_int as u32_0 &
                      (((0x1 as libc::c_int) << 3 as libc::c_int) -
                           1 as libc::c_int) as libc::c_uint) <<
                     0 as libc::c_int);
    if ((*this).mainAlpha as s16 as libc::c_int) < 100 as libc::c_int {
        let fresh67 = gfx;
        gfx = gfx.offset(1);
        let mut _g_10: *mut Gfx = fresh67;
        (*_g_10).words.w0 =
            (0xe2 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
        ...
        (0 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).mainAlpha as s16 as libc::c_int != 0 as libc::c_int {
        EnMag_DrawTextureI8(&mut gfx,
                            gTitleTheLegendOfTextTex.as_mut_ptr() as
                                *mut libc::c_void, 72 as libc::c_int as s16,
                            8 as libc::c_int as s16,
                            146 as libc::c_int as s16,
                            73 as libc::c_int as s16,
                            72 as libc::c_int as s16, 8 as libc::c_int as s16,
                            1024 as libc::c_int as u16_0,
                            1024 as libc::c_int as u16_0);
        EnMag_DrawTextureI8(&mut gfx,
                            gTitleOcarinaOfTimeTMTextTex.as_mut_ptr() as
                                *mut libc::c_void, 96 as libc::c_int as s16,
                            8 as libc::c_int as s16,
                            144 as libc::c_int as s16,
                            127 as libc::c_int as s16,
                            96 as libc::c_int as s16, 8 as libc::c_int as s16,
                            1024 as libc::c_int as u16_0,
                            1024 as libc::c_int as u16_0);
        let fresh71 = gfx;
        gfx = gfx.offset(1);
        let mut _g_14: *mut Gfx = fresh71;
        (*_g_14).words.w0 =
            (0xe7 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        ...
        EnMag_DrawTextureI8(&mut gfx,
                            gTitleTheLegendOfTextTex.as_mut_ptr() as
                                *mut libc::c_void, 72 as libc::c_int as s16,
                            8 as libc::c_int as s16,
                            145 as libc::c_int as s16,
                            72 as libc::c_int as s16,
                            72 as libc::c_int as s16, 8 as libc::c_int as s16,
                            1024 as libc::c_int as u16_0,
                            1024 as libc::c_int as u16_0);
        EnMag_DrawTextureI8(&mut gfx,
            ...
            (255 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).subAlpha as s16 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        EnMag_DrawImageRGBA32(&mut gfx, 174 as libc::c_int as s16,
                              145 as libc::c_int as s16,
                              gTitleMasterQuestSubtitleTex.as_mut_ptr() as
                                  *mut u8_0, 128 as libc::c_int as u32_0,
                              32 as libc::c_int as u32_0);
    }
    func_8009457C(&mut gfx);
    let fresh76 = gfx;
    gfx = gfx.offset(1);
    let mut _g_19: *mut Gfx = fresh76;
    (*_g_19).words.w0 =
        (0xe2 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_21).words.w1 =
        ((*this).copyrightAlpha as s16 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((*this).copyrightAlpha as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
            ...
            ((*this).copyrightAlpha as s16 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    if (*this).copyrightAlpha as s16 as libc::c_int != 0 as libc::c_int {
        let fresh79 = gfx;
        gfx = gfx.offset(1);
        let mut _g_22: *mut Gfx = fresh79;
        (*_g_22).words.w0 =
            (0xfd as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                ...
                ((1 as libc::c_int - 1 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_22).words.w1 =
            gTitleCopyright19982003Tex.as_mut_ptr() as libc::c_uint;
        let fresh80 = gfx;
        gfx = gfx.offset(1);
        let mut _g_23: *mut Gfx = fresh80;
        (*_g_23).words.w0 =
            (0xf5 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
        ...
        (*_g_25).words.w1 =
            (7 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 3 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((if ((160 as libc::c_int * 16 as libc::c_int +
                           1 as libc::c_int >> 1 as libc::c_int) -
                          1 as libc::c_int) < 2047 as libc::c_int {
            ...
            (0xf5 as libc::c_int as u32_0 &
                ...
                (1 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 2 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    19 as libc::c_int |
                ((160 as libc::c_int * 1 as libc::c_int + 7 as libc::c_int >>
                      3 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 9 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    9 as libc::c_int |
        ...
        (*_g_28).words.w1 =
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 3 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (((160 as libc::c_int - 1 as libc::c_int) << 2 as libc::c_int)
                     as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
        ...
        let fresh86 = gfx;
        gfx = gfx.offset(1);
        let mut _g_29: *mut Gfx = fresh86;
        (*_g_29).words.w0 =
            (0xe4 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (952 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
                (856 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_29).words.w1 =
            (0 as libc::c_int as u32_0 &
                ...
                (312 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    12 as libc::c_int |
                (792 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 12 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        let fresh87 = gfx;
        gfx = gfx.offset(1);
        let mut _g_30: *mut Gfx = fresh87;
        (*_g_30).words.w0 =
            (0xe1 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
    ...
    if gSaveContext.fileNum == 0xfedc as libc::c_int {
        ...
        textAlpha = (textFadeTimer as libc::c_int * 10 as libc::c_int) as s16;
        if textAlpha as libc::c_int >= 255 as libc::c_int {
            textAlpha = 255 as libc::c_int as s16
        }
        // Text Shadow
        let fresh89 = gfx;
        gfx = gfx.offset(1);
        let mut _g_32: *mut Gfx = fresh89;
        (*_g_32).words.w0 =
            (0xe7 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        ...
        while (i as libc::c_int) <
                  (::std::mem::size_of::<[u8_0; 12]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<u8_0>()
                                                       as libc::c_ulong) as
                      s32 {
            EnMag_DrawCharTexture(&mut gfx,
                                  (*font).fontBuf.as_mut_ptr().offset((noControllerFontIndexes[i
                                                                                                   as
                                                                                                   usize]
                                                                           as
                                                                           libc::c_int
    ...
    } else if (*this).copyrightAlpha >= 200.0f32 {
        ...
        i = 0 as libc::c_int as u16_0;
        while (i as libc::c_int) <
                  (::std::mem::size_of::<[u8_0; 10]>() as
                       libc::c_ulong).wrapping_div(::std::mem::size_of::<u8_0>()
                                                       as libc::c_ulong) as
                      s32 {
            EnMag_DrawCharTexture(&mut gfx,
                                  (*font).fontBuf.as_mut_ptr().offset((pressStartFontIndexes[i
                                                                                                 as
                                                                                                 usize]
                                                                           as
                                                                           libc::c_int
    ...
    if textFadeDirection as libc::c_int != 0 as libc::c_int {
        textFadeTimer -= 1;
        if textFadeTimer as libc::c_int == 0 as libc::c_int {
            textFadeDirection = 0 as libc::c_int as s16
        }
    } else {
        textFadeTimer += 1;
        if textFadeTimer as libc::c_int >= 26 as libc::c_int {
            textFadeDirection = 1 as libc::c_int as s16
        }
    }
    *gfxp = gfx;
}
#[no_mangle]
pub unsafe extern "C" fn EnMag_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_mag.c\x00" as *const u8 as *const libc::c_char,
                    1151 as libc::c_int);
    ...
    EnMag_DrawInner(thisx, globalCtx, &mut gfx);
    let fresh100 = gfx;
    gfx = gfx.offset(1);
