...
extern "C" {
    ...
    #[no_mangle]
    static mut gWallmasterLungeAnim: AnimationHeader;
    #[no_mangle]
...
pub const WMT_FLAG: C2RustUnnamed_23 = 2;
pub const WMT_PROXIMITY: C2RustUnnamed_23 = 1;
pub const WMT_TIMER: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnWallmas {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnWallmasActionFunc,
    pub timer: s16,
    pub switchFlag: s16,
...
pub type EnWallmasActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWallmas, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Wallmas_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WALLMAS as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWallmas_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnWallmas_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWallmas = thisx as *mut EnWallmas;
    ...
    CollisionCheck_SetInfo(&mut (*thisx).colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    (*this).switchFlag =
        ((*thisx).params as libc::c_int >> 0x8 as libc::c_int) as u8_0 as s16;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    if (*thisx).params as libc::c_int == WMT_FLAG as libc::c_int {
        if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) !=
               0 as libc::c_int {
            Actor_Kill(thisx);
            return
        }
        EnWallmas_ProximityOrSwitchInit(this);
    } else if (*thisx).params as libc::c_int == WMT_PROXIMITY as libc::c_int {
        EnWallmas_ProximityOrSwitchInit(this);
    } else { EnWallmas_TimerInit(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnWallmas = thisx as *mut EnWallmas;
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_TimerInit(mut this: *mut EnWallmas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    (*this).timer = 0x82 as libc::c_int as s16;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.world.pos.y = (*player).actor.world.pos.y;
    (*this).actor.floorHeight = (*player).actor.floorHeight;
    (*this).actor.draw =
        Some(EnWallmas_Draw as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actionFunc =
        Some(EnWallmas_WaitToDrop as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupDrop(mut this: *mut EnWallmas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut objSegChangee: *mut AnimationHeader = &mut gWallmasterLungeAnim;
    Animation_Change(&mut (*this).skelAnime, objSegChangee, 0.0f32, 20.0f32,
                     Animation_GetLastFrame(&mut gWallmasterLungeAnim as
    ...
    (*this).actor.world.pos.y = (*player).actor.world.pos.y + 300.0f32;
    ...
    (*this).actor.flags &=
        !((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnWallmas_Drop as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupLand(mut this: *mut EnWallmas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut objSegFrameCount: *mut AnimationHeader = &mut gWallmasterJumpAnim;
    let mut objSegChangee: *mut AnimationHeader = &mut gWallmasterJumpAnim;
    Animation_Change(&mut (*this).skelAnime, objSegChangee, 1.0f32, 41.0f32,
                     Animation_GetLastFrame(objSegFrameCount as
                                                *mut libc::c_void) as f32_0,
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x3893 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnWallmas_Land as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupStand(mut this: *mut EnWallmas) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWallmasterStandUpAnim);
    (*this).actionFunc =
        Some(EnWallmas_Stand as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupWalk(mut this: *mut EnWallmas) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                               &mut gWallmasterWalkAnim, 3.0f32);
    (*this).actionFunc =
        Some(EnWallmas_Walk as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 3.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupJumpToCeiling(mut this:
                                                          *mut EnWallmas) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWallmasterStopWalkAnim);
    (*this).actionFunc =
        Some(EnWallmas_JumpToCeiling as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupReturnToCeiling(mut this:
                                                            *mut EnWallmas) {
    let mut objSegFrameCount: *mut AnimationHeader = &mut gWallmasterJumpAnim;
    let mut objSegChangee: *mut AnimationHeader = &mut gWallmasterJumpAnim;
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, objSegChangee, 3.0f32, 0.0f32,
                     Animation_GetLastFrame(objSegFrameCount as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    (*this).actionFunc =
        Some(EnWallmas_ReturnToCeiling as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupTakeDamage(mut this: *mut EnWallmas) {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupCooldown(mut this: *mut EnWallmas) {
    ...
    (*this).actionFunc =
        Some(EnWallmas_Cooldown as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupDie(mut this: *mut EnWallmas,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    EffectSsDeadDb_Spawn(globalCtx, &mut (*this).actor.world.pos,
    ...
    (*this).actionFunc =
        Some(EnWallmas_Die as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupTakePlayer(mut this: *mut EnWallmas,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gWallmasterHoverAnim, -5.0f32);
    (*this).timer = -(0x1e as libc::c_int) as s16;
    (*this).actionFunc =
        Some(EnWallmas_TakePlayer as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).yTarget = (*this).actor.yDistToPlayer;
    func_8002DF38(globalCtx, &mut (*this).actor, 0x25 as libc::c_int as u8_0);
    OnePointCutscene_Init(globalCtx, 9500 as libc::c_int as s16,
                          9999 as libc::c_int as s16, &mut (*this).actor,
                          0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_ProximityOrSwitchInit(mut this:
                                                             *mut EnWallmas) {
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actor.draw = None;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    if (*this).actor.params as libc::c_int == WMT_PROXIMITY as libc::c_int {
        (*this).actionFunc =
            Some(EnWallmas_WaitForProximity as
                     unsafe extern "C" fn(_: *mut EnWallmas,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(EnWallmas_WaitForSwitchFlag as
                     unsafe extern "C" fn(_: *mut EnWallmas,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_SetupStun(mut this: *mut EnWallmas) {
    ...
    (*this).timer = 0x50 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnWallmas_Stun as
                 unsafe extern "C" fn(_: *mut EnWallmas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_WaitToDrop(mut this: *mut EnWallmas,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if (*player).stateFlags1 & 0x100000 as libc::c_int as libc::c_uint != 0 ||
           (*player).stateFlags1 & 0x8000000 as libc::c_int as libc::c_uint !=
               0 ||
           (*player).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int == 0
           ||
           (*this).actor.params as libc::c_int == 1 as libc::c_int &&
               320.0f32 <
                   Math_Vec3f_DistXZ(&mut (*this).actor.home.pos, playerPos) {
        Audio_StopSfxById(0x3890 as libc::c_int as u32_0);
        (*this).timer = 0x82 as libc::c_int as s16
    }
    if (*this).timer as libc::c_int == 0x50 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3890 as libc::c_int as u16_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Drop(mut this: *mut EnWallmas,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Player_InCsMode(globalCtx) == 0 &&
           (*player).stateFlags2 & 0x10 as libc::c_int as libc::c_uint == 0 &&
           (*player).invincibilityTimer as libc::c_int >= 0 as libc::c_int &&
           (*this).actor.xzDistToPlayer < 30.0f32 &&
           (*this).actor.yDistToPlayer < -5.0f32 &&
           (-(((*player).cylinder.dim.height as libc::c_int +
                   10 as libc::c_int) as f32_0)) < (*this).actor.yDistToPlayer
       {
        EnWallmas_SetupTakePlayer(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Land(mut this: *mut EnWallmas,
                                        mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Stand(mut this: *mut EnWallmas,
                                         mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
    ...
    Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                       ((*this).actor.yawTowardsPlayer as libc::c_int +
                            0x8000 as libc::c_int) as s16,
                       0xb6 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Walk(mut this: *mut EnWallmas,
                                        mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        EnWallmas_SetupJumpToCeiling(this);
    }
    Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                       ((*this).actor.yawTowardsPlayer as s32 +
                            0x8000 as libc::c_int) as s16,
                       0xb6 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_JumpToCeiling(mut this: *mut EnWallmas,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_ReturnToCeiling(mut this: *mut EnWallmas,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if (*this).skelAnime.curFrame > 20.0f32 {
        (*this).timer =
            ((*this).timer as libc::c_int + 9 as libc::c_int) as s16;
        (*this).actor.world.pos.y = (*this).actor.world.pos.y + 30.0f32
    }
    if Animation_OnFrame(&mut (*this).skelAnime, 20.0f32) != 0 as libc::c_int
       {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3891 as libc::c_int as u16_0);
    }
    if (*this).actor.yDistToPlayer < -900.0f32 {
        if (*this).actor.params as libc::c_int == WMT_FLAG as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            return
        }
        if (*this).actor.params as libc::c_int == WMT_TIMER as libc::c_int ||
               Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                                 &mut (*player).actor.world.pos) < 200.0f32 {
            EnWallmas_TimerInit(this, globalCtx);
        } else { EnWallmas_ProximityOrSwitchInit(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_TakeDamage(mut this: *mut EnWallmas,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        ...
        } else { EnWallmas_SetupCooldown(this); }
    }
    if Animation_OnFrame(&mut (*this).skelAnime, 13.0f32) != 0 as libc::c_int
       {
        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Cooldown(mut this: *mut EnWallmas,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        EnWallmas_SetupReturnToCeiling(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Die(mut this: *mut EnWallmas,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, 0.0015f64 as f32_0) !=
           0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_TakePlayer(mut this: *mut EnWallmas,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Animation_OnFrame(&mut (*this).skelAnime, 1.0f32) != 0 as libc::c_int {
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            func_8002F7DC(&mut (*this).actor, 0x6825 as libc::c_int as u16_0);
        } else {
            func_8002F7DC(&mut (*this).actor, 0x6805 as libc::c_int as u16_0);
        }
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3892 as libc::c_int as u16_0);
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        (*player).actor.world.pos.x = (*this).actor.world.pos.x;
        (*player).actor.world.pos.z = (*this).actor.world.pos.z;
        if ((*this).timer as libc::c_int) < 0 as libc::c_int {
            (*this).actor.world.pos.y = (*this).actor.world.pos.y + 2.0f32
        } else {
            (*this).actor.world.pos.y = (*this).actor.world.pos.y + 10.0f32
        }
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
            (*player).actor.world.pos.y = (*this).actor.world.pos.y - 30.0f32
        } else {
            (*player).actor.world.pos.y = (*this).actor.world.pos.y - 50.0f32
        }
        if (*this).timer as libc::c_int == -(0x1e as libc::c_int) {
            if !(gSaveContext.linkAge == 0 as libc::c_int) {
                func_8002F7DC(&mut (*this).actor,
                              0x682c as libc::c_int as u16_0);
            } else {
                func_8002F7DC(&mut (*this).actor,
                              0x680c as libc::c_int as u16_0);
            }
        }
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
    ...
    Math_StepToF(&mut (*this).actor.world.pos.x, (*player).actor.world.pos.x,
                 3.0f32);
    Math_StepToF(&mut (*this).actor.world.pos.z, (*player).actor.world.pos.z,
                 3.0f32);
    if (*this).timer as libc::c_int == 0x1e as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_WaitForProximity(mut this: *mut EnWallmas,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_WaitForSwitchFlag(mut this: *mut EnWallmas,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) !=
           0 as libc::c_int {
        EnWallmas_TimerInit(this, globalCtx);
        (*this).timer = 0x51 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Stun(mut this: *mut EnWallmas,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            EnWallmas_SetupDie(this, globalCtx);
        } else { EnWallmas_SetupReturnToCeiling(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_ColUpdate(mut this: *mut EnWallmas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWallmas = thisx as *mut EnWallmas;
    ...
    if (*this).actionFunc !=
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32,
                                25.0f32, 0.0f32, 0x1d as libc::c_int);
    ...
    if (*this).actionFunc !=
        ...
        if (*this).actionFunc !=
               ...
               (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                   0 as libc::c_int &&
               (*this).actor.freezeTimer as libc::c_int == 0 as libc::c_int {
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).collider.base);
        }
    }
    Actor_SetFocus(&mut (*this).actor, 25.0f32);
    if (*this).actionFunc ==
           Some(EnWallmas_TakeDamage as
                    unsafe extern "C" fn(_: *mut EnWallmas,
                                         _: *mut GlobalContext) -> ()) {
...
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_DrawXlu(mut this: *mut EnWallmas,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if (*this).actor.floorPoly.is_null() ||
           (*this).timer as libc::c_int >= 0x51 as libc::c_int &&
               (*this).actionFunc !=
                   Some(EnWallmas_Stun as
                            unsafe extern "C" fn(_: *mut EnWallmas,
                                                 _: *mut GlobalContext) -> ())
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_wallmas.c\x00" as *const u8 as
    ...
    (*_g).words.w1 =
        (0 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    func_80038A28((*this).actor.floorPoly, (*this).actor.world.pos.x,
                  (*this).actor.floorHeight, (*this).actor.world.pos.z,
                  &mut mf);
    Matrix_Mult(&mut mf, MTXMODE_NEW as libc::c_int as u8_0);
    if (*this).actionFunc !=
           Some(EnWallmas_WaitToDrop as
                    unsafe extern "C" fn(_: *mut EnWallmas,
                                         _: *mut GlobalContext) -> ()) &&
           ...
           (*this).actionFunc !=
               Some(EnWallmas_WaitForSwitchFlag as
                        unsafe extern "C" fn(_: *mut EnWallmas,
                                             _: *mut GlobalContext) -> ()) {
        xzScale = (*this).actor.scale.x * 50.0f32
    } else {
        xzScale =
            (if 0x50 as libc::c_int - (*this).timer as libc::c_int >=
                    0x51 as libc::c_int {
                 0x50 as libc::c_int
             } else { (0x50 as libc::c_int) - (*this).timer as libc::c_int })
                as libc::c_float *
                (62500000 as libc::c_longlong as f32_0 /
                     10000000000 as libc::c_longlong as libc::c_float)
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnWallMas_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn EnWallMas_PostLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut rot: *mut Vec3s,
    ...
    if limbIndex == 2 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_wallmas.c\x00" as *const u8 as
                            *const libc::c_char, 1478 as libc::c_int);
        Matrix_Push();
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_wallmas.c\x00" as *const u8 as
                             *const libc::c_char, 1495 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWallmas_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWallmas = thisx as *mut EnWallmas;
    if (*this).actionFunc !=
           Some(EnWallmas_WaitToDrop as
        ...
        SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                              ...
                              Some(EnWallMas_OverrideLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
                                                            ...
                                                            _:
                                                                *mut libc::c_void)
                                           -> s32),
                              Some(EnWallMas_PostLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x30 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
