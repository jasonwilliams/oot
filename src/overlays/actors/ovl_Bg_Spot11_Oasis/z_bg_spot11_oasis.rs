...
extern "C" {
    ...
    fn Graph_CloseDisps(dispRefs: *mut *mut Gfx, gfxCtx: *mut GraphicsContext,
                        file: *const libc::c_char, line: s32);
    #[no_mangle]
    fn Math3D_TriChkPointParaYSlopedY(v0: *mut Vec3f, v1: *mut Vec3f,
                                      v2: *mut Vec3f, z: f32_0, x: f32_0)
     -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDesertColossusOasisDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot11Oasis {
    pub actor: Actor,
    pub actionFunc: BgSpot11OasisActionFunc,
    pub unk_150: u8_0,
    pub unk_151: u8_0,
}
pub type BgSpot11OasisActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot11Oasis, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_18 = libc::c_uint;
pub const FAIRY_HEAL_BIG: C2RustUnnamed_18 = 7;
pub const FAIRY_HEAL: C2RustUnnamed_18 = 6;
pub const FAIRY_REVIVE_DEATH: C2RustUnnamed_18 = 5;
pub const FAIRY_SPAWNER: C2RustUnnamed_18 = 4;
pub const FAIRY_KOKIRI: C2RustUnnamed_18 = 3;
pub const FAIRY_HEAL_TIMED: C2RustUnnamed_18 = 2;
pub const FAIRY_REVIVE_BOTTLE: C2RustUnnamed_18 = 1;
pub const FAIRY_NAVI: C2RustUnnamed_18 = 0;
#[no_mangle]
pub static mut Bg_Spot11_Oasis_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT11_OASIS as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_SPOT11_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot11Oasis>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Oasis_Init
                                                                          as
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot11Oasis_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_808B2E10: [[s16; 2]; 5] =
    [[1260 as libc::c_int as s16, 2040 as libc::c_int as s16],
     [1259 as libc::c_int as s16, 1947 as libc::c_int as s16],
     [1135 as libc::c_int as s16, 1860 as libc::c_int as s16],
     [1087 as libc::c_int as s16, 1912 as libc::c_int as s16],
     [1173 as libc::c_int as s16, 2044 as libc::c_int as s16]];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut D_808B2E34: [Vec3f; 5] =
    [{ let mut init = Vec3f{x: 0.0f32, y: -100.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 100.0f32, y: -80.0f32, z: -50.0f32,}; init },
     { let mut init = Vec3f{x: -50.0f32, y: -80.0f32, z: -100.0f32,}; init },
     { let mut init = Vec3f{x: -75.0f32, y: -90.0f32, z: 90.0f32,}; init },
     { let mut init = Vec3f{x: 30.0f32, y: -100.0f32, z: 40.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn func_808B27F0(mut globalCtx: *mut GlobalContext,
                                       mut waterSurface: s16) {
    let mut waterBox: *mut WaterBox =
        &mut *(*(*globalCtx).colCtx.colHeader).waterBoxes.offset(0 as
                                                                     libc::c_int
                                                                     as isize)
            as *mut WaterBox;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B280C(mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    let mut i: s32 = 0;
    sp58.x =
        D_808B2E10[0 as libc::c_int as usize][0 as libc::c_int as usize] as
            f32_0;
    sp58.z =
        D_808B2E10[0 as libc::c_int as usize][1 as libc::c_int as usize] as
            f32_0;
    sp58.y = 0.0f32;
    sp4C.y = 0.0f32;
    sp40.y = 0.0f32;
    i = 1 as libc::c_int;
    while i <
              (::std::mem::size_of::<[[s16; 2]; 5]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<[s16; 2]>()
                                                   as libc::c_ulong) as s32 -
                  1 as libc::c_int {
        sp4C.x = D_808B2E10[i as usize][0 as libc::c_int as usize] as f32_0;
        sp4C.z = D_808B2E10[i as usize][1 as libc::c_int as usize] as f32_0;
        sp40.x =
            D_808B2E10[(i + 1 as libc::c_int) as
                           usize][0 as libc::c_int as usize] as f32_0;
        sp40.z =
            D_808B2E10[(i + 1 as libc::c_int) as
                           usize][1 as libc::c_int as usize] as f32_0;
        if Math3D_TriChkPointParaYSlopedY(&mut sp58, &mut sp4C, &mut sp40,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Oasis_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot11Oasis = thisx as *mut BgSpot11Oasis;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    func_808B2970(this);
    (*this).actor.world.pos.y = -100.0f32;
    func_808B27F0(globalCtx, -(100 as libc::c_int) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B2970(mut this: *mut BgSpot11Oasis) {
    (*this).actionFunc =
        Some(func_808B2980 as
                 unsafe extern "C" fn(_: *mut BgSpot11Oasis,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B2980(mut this: *mut BgSpot11Oasis,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetEnv(globalCtx, 5 as libc::c_int as s16) != 0 &&
           func_808B280C(globalCtx) != 0 {
        OnePointCutscene_Init(globalCtx, 4150 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B29E0(mut this: *mut BgSpot11Oasis) {
    (*this).actionFunc =
        Some(func_808B29F0 as
                 unsafe extern "C" fn(_: *mut BgSpot11Oasis,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B29F0(mut this: *mut BgSpot11Oasis,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).actor.world.pos.y, 0.0f32, 0.7f32) != 0 {
        func_808B2AA8(this);
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    FAIRY_SPAWNER as libc::c_int as s16);
        func_80078884(0x4802 as libc::c_int as u16_0);
    }
    func_808B27F0(globalCtx, (*this).actor.world.pos.y as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_808B2AA8(mut this: *mut BgSpot11Oasis) {
    (*this).actionFunc =
        Some(func_808B2AB8 as
                 unsafe extern "C" fn(_: *mut BgSpot11Oasis,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B2AB8(mut this: *mut BgSpot11Oasis,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Oasis_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot11Oasis = thisx as *mut BgSpot11Oasis;
    let mut pad: s32 = 0;
    ...
    (*this).actor.draw =
        Some(BgSpot11Oasis_Draw as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    if (*this).unk_150 as libc::c_int != 0 &&
           (*this).actor.projectedPos.z < 400.0f32 &&
           (*this).actor.projectedPos.z > -40.0f32 {
        gameplayFrames = (*globalCtx).gameplayFrames;
        if gameplayFrames & 4 as libc::c_int as libc::c_uint != 0 {
            Math_Vec3f_Sum(&mut (*this).actor.world.pos,
                           &mut *D_808B2E34.as_mut_ptr().offset((*this).unk_151
                                                                    as isize),
                           &mut sp30);
            EffectSsBubble_Spawn(globalCtx, &mut sp30, 0.0f32, 15.0f32,
                                 50.0f32, Rand_ZeroOne() * 0.12f32 + 0.02f32);
            if Rand_ZeroOne() < 0.3f32 {
                (*this).unk_151 = (Rand_ZeroOne() * 4.9f32) as u8_0
            }
        }
    } else { (*this).unk_150 = 1 as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot11Oasis_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot11_oasis.c\x00" as *const u8 as
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gDesertColossusOasisDL.as_mut_ptr() as libc::c_uint;
