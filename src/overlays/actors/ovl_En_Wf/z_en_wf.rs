...
extern "C" {
    ...
    fn Item_DropCollectibleRandom(globalCtx: *mut GlobalContext,
                                  ...
                                  params: s16);
    #[no_mangle]
    fn EffectSsEnFire_SpawnVec3s(globalCtx: *mut GlobalContext,
                                 actor: *mut Actor, vec: *mut Vec3s,
                                 scale: s16, arg4: s16, flags: s16,
                                 bodyPart: s16);
    #[no_mangle]
    ...
    fn Actor_SetDropFlag(actor: *mut Actor, colBody: *mut ColliderInfo,
                         freezeFlag: s32);
    #[no_mangle]
    fn func_800359B8(actor: *mut Actor, arg1: s16, arg2: *mut Vec3s);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gWolfosWhiteEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosWhiteEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosWhiteEyeNarrowTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosWhiteSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gWolfosSlashingAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosBackflippingAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosBlockingAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosRearingUpFallingOverAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosRunningAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosNormalEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosNormalEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosNormalEyeNarrowTex: [u64_0; 0];
    #[no_mangle]
    static mut gWolfosNormalSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gWolfosSidesteppingAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosDamagedAnim: AnimationHeader;
    #[no_mangle]
    static mut gWolfosWaitingAnim: AnimationHeader;
}
...
pub struct EnWf {
    ...
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 22],
    pub morphTable: [Vec3s; 22],
    pub action: s32,
    pub unk_2D8: [libc::c_char; 4],
    pub actionFunc: EnWfActionFunc,
    pub unk_2E0: s16,
    pub unk_2E2: s16,
    pub fireTimer: s16,
    pub damageEffect: u8_0,
    ...
    pub unk_300: s16,
    pub eyeIndex: u8_0,
    pub colliderSpheres: ColliderJntSph,
    pub colliderSpheresElements: [ColliderJntSphElement; 4],
    pub colliderCylinderBody: ColliderCylinder,
    pub colliderCylinderTail: ColliderCylinder,
    pub unk_4BC: Vec3f,
    pub unk_4C8: Vec3f,
    pub unk_4D4: Vec3s,
}
pub type EnWfActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnWf, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const WOLFOS_LIMB_MAX: C2RustUnnamed_22 = 22;
pub const WOLFOS_LIMB_FRONT_LEFT_CLAW: C2RustUnnamed_22 = 21;
pub const WOLFOS_LIMB_FRONT_LEFT_LOWER_LEG: C2RustUnnamed_22 = 20;
pub const WOLFOS_LIMB_FRONT_LEFT_UPPER_LEG: C2RustUnnamed_22 = 19;
pub const WOLFOS_LIMB_EYES: C2RustUnnamed_22 = 18;
pub const WOLFOS_LIMB_HEAD: C2RustUnnamed_22 = 17;
pub const WOLFOS_LIMB_HEAD_ROOT: C2RustUnnamed_22 = 16;
pub const WOLFOS_LIMB_FRONT_RIGHT_CLAW: C2RustUnnamed_22 = 15;
pub const WOLFOS_LIMB_FRONT_RIGHT_LOWER_LEG: C2RustUnnamed_22 = 14;
pub const WOLFOS_LIMB_FRONT_RIGHT_UPPER_LEG: C2RustUnnamed_22 = 13;
pub const WOLFOS_LIMB_THORAX: C2RustUnnamed_22 = 12;
pub const WOLFOS_LIMB_BACK_RIGHT_PAW: C2RustUnnamed_22 = 11;
pub const WOLFOS_LIMB_BACK_RIGHT_PASTERN: C2RustUnnamed_22 = 10;
pub const WOLFOS_LIMB_BACK_RIGHT_SHIN: C2RustUnnamed_22 = 9;
pub const WOLFOS_LIMB_BACK_RIGHT_THIGH: C2RustUnnamed_22 = 8;
pub const WOLFOS_LIMB_ABDOMEN: C2RustUnnamed_22 = 7;
pub const WOLFOS_LIMB_TAIL: C2RustUnnamed_22 = 6;
pub const WOLFOS_LIMB_BACK_LEFT_PAW: C2RustUnnamed_22 = 5;
pub const WOLFOS_LIMB_BACK_LEFT_PASTERN: C2RustUnnamed_22 = 4;
pub const WOLFOS_LIMB_BACK_LEFT_SHIN: C2RustUnnamed_22 = 3;
pub const WOLFOS_LIMB_BACK_LEFT_THIGH: C2RustUnnamed_22 = 2;
pub const WOLFOS_LIMB_ROOT: C2RustUnnamed_22 = 1;
pub const WOLFOS_LIMB_NONE: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const WOLFOS_ACTION_STUNNED: C2RustUnnamed_23 = 15;
pub const WOLFOS_ACTION_SIDESTEP: C2RustUnnamed_23 = 14;
pub const WOLFOS_ACTION_RECOIL_FROM_BLOCKED_SLASH: C2RustUnnamed_23 = 12;
pub const WOLFOS_ACTION_RUN_AROUND_PLAYER: C2RustUnnamed_23 = 11;
pub const WOLFOS_ACTION_SEARCH_FOR_PLAYER: C2RustUnnamed_23 = 10;
pub const WOLFOS_ACTION_RUN_AT_PLAYER: C2RustUnnamed_23 = 9;
pub const WOLFOS_ACTION_SLASH: C2RustUnnamed_23 = 8;
pub const WOLFOS_ACTION_BLOCKING: C2RustUnnamed_23 = 7;
pub const WOLFOS_ACTION_WAIT: C2RustUnnamed_23 = 6;
pub const WOLFOS_ACTION_BACKFLIP_AWAY: C2RustUnnamed_23 = 5;
pub const WOLFOS_ACTION_TURN_TOWARDS_PLAYER: C2RustUnnamed_23 = 4;
pub const WOLFOS_ACTION_DAMAGED: C2RustUnnamed_23 = 3;
pub const WOLFOS_ACTION_DIE: C2RustUnnamed_23 = 2;
pub const WOLFOS_ACTION_WAIT_TO_APPEAR: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const WOLFOS_WHITE: C2RustUnnamed_24 = 1;
pub const WOLFOS_NORMAL: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnReeba {
    pub actor: Actor,
    ...
    pub unk_268: [libc::c_char; 4],
    pub actionfunc: EnReebaActionFunc,
    pub unk_270: s16,
    pub unk_272: s16,
    pub unk_274: s16,
    pub unk_276: s16,
...
pub type EnReebaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnEncount1 {
    pub actor: Actor,
    pub updateFunc: EnEncount1UpdateFunc,
    pub maxCurSpawns: s16,
    pub curNumSpawn: s16,
    pub spawnType: s16,
    pub maxTotalSpawns: s16,
    pub totalNumSpawn: s16,
    pub outOfRangeTimer: s16,
    pub fieldSpawnTimer: s16,
    pub killCount: s16,
    pub numLeeverSpawns: s16,
    pub leeverIndex: s16,
    pub timer: s16,
    pub reduceLeevers: u8_0,
    pub spawnRange: f32_0,
    pub bigLeever: *mut EnReeba,
}
pub type EnEncount1UpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnEncount1, _: *mut GlobalContext)
               -> ()>;
pub const ENWF_DMGEFF_NONE: C2RustUnnamed_25 = 0;
pub const ENWF_DMGEFF_LIGHT_MAGIC: C2RustUnnamed_25 = 13;
pub const ENWF_DMGEFF_ICE_MAGIC: C2RustUnnamed_25 = 6;
pub const ENWF_DMGEFF_FIRE: C2RustUnnamed_25 = 14;
pub const ENWF_DMGEFF_STUN: C2RustUnnamed_25 = 1;
pub const ENWF_DMGEFF_UNDEF: C2RustUnnamed_25 = 15;
pub type C2RustUnnamed_25 = libc::c_uint;
static mut sJntSphItemsInit: [ColliderJntSphElementInit; 4] =
    [{
         let mut init =
...
static mut sTailCylinderInit: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (ENWF_DMGEFF_STUN as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENWF_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (ENWF_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (4 as libc::c_int |
                                  (ENWF_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (ENWF_DMGEFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (ENWF_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (4 as libc::c_int |
                                  (ENWF_DMGEFF_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (ENWF_DMGEFF_ICE_MAGIC as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (3 as libc::c_int |
                                  (ENWF_DMGEFF_LIGHT_MAGIC as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (ENWF_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub static mut En_Wf_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_WF as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_WF as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnWf>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupAction(mut this: *mut EnWf,
                                          mut actionFunc: EnWfActionFunc) {
    (*this).actionFunc = actionFunc; // Set and not used
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnWf = thisx as *mut EnWf;
    ...
    (*thisx).colChkInfo.health = 8 as libc::c_int as u8_0;
    ...
    (*this).eyeIndex = 0 as libc::c_int as u8_0;
    (*this).unk_2F4 = 10.0f32;
    Collider_InitJntSph(globalCtx, &mut (*this).colliderSpheres);
    Collider_SetJntSph(globalCtx, &mut (*this).colliderSpheres, thisx,
                       &mut sJntSphInit,
                       (*this).colliderSpheresElements.as_mut_ptr());
    Collider_InitCylinder(globalCtx, &mut (*this).colliderCylinderBody);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderCylinderBody, thisx,
                         &mut sBodyCylinderInit);
    Collider_InitCylinder(globalCtx, &mut (*this).colliderCylinderTail);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderCylinderTail, thisx,
                         &mut sTailCylinderInit);
    if (*thisx).params as libc::c_int == WOLFOS_NORMAL as libc::c_int {
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut gWolfosNormalSkel, &mut gWolfosWaitingAnim,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           WOLFOS_LIMB_MAX as libc::c_int);
        Actor_SetScale(thisx, 0.0075f32);
        (*thisx).naviEnemyId = 0x4c as libc::c_int as u8_0
        // Wolfos
    } else {
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut gWolfosWhiteSkel, &mut gWolfosWaitingAnim,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           WOLFOS_LIMB_MAX as libc::c_int);
        Actor_SetScale(thisx, 0.01f32);
        let ref mut fresh0 =
            (*(*this).colliderSpheres.elements.offset(1 as libc::c_int as
                                                          isize)).info.toucher.damage;
        *fresh0 = 8 as libc::c_int as u8_0;
        (*(*this).colliderSpheres.elements.offset(0 as libc::c_int as
                                                      isize)).info.toucher.damage
            = *fresh0;
        (*thisx).naviEnemyId = 0x57 as libc::c_int as u8_0
        // White Wolfos
    }
    EnWf_SetupWaitToAppear(this);
    if (*this).switchFlag as libc::c_int != 0xff as libc::c_int &&
           Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
        Actor_Kill(thisx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWf = thisx as *mut EnWf;
    Collider_DestroyJntSph(globalCtx, &mut (*this).colliderSpheres);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderCylinderBody);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderCylinderTail);
    if (*this).actor.params as libc::c_int != WOLFOS_NORMAL as libc::c_int &&
           (*this).switchFlag as libc::c_int != 0xff as libc::c_int {
        func_800F5B58();
    }
    if !(*this).actor.parent.is_null() {
        let mut parent: *mut EnEncount1 =
            (*this).actor.parent as *mut EnEncount1;
        if (*parent).actor.update.is_some() {
            if (*parent).curNumSpawn as libc::c_int > 0 as libc::c_int {
                (*parent).curNumSpawn -= 1
            }
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
            // "☆☆☆☆☆ Number of concurrent events ☆☆☆☆☆"
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe5\x90\x8c\xe6\x99\x82\xe7\x99\xba\xe7\x94\x9f\xe6\x95\xb0 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86%d\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char,
                         (*parent).curNumSpawn as libc::c_int);
            osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_ChangeAction(mut globalCtx: *mut GlobalContext,
                                           mut this: *mut EnWf,
                                           mut mustChoose: s16) -> s32 {
    ...
    playerYawDiff =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    playerYawDiff =
        if playerYawDiff as libc::c_int >= 0 as libc::c_int {
            playerYawDiff as libc::c_int
        } else { -(playerYawDiff as libc::c_int) } as s16;
    if func_800354B4(globalCtx, &mut (*this).actor, 100.0f32,
                     0x2710 as libc::c_int as s16,
                     0x2ee0 as libc::c_int as s16, (*this).actor.shape.rot.y)
           != 0 {
    ...
    if func_800354B4(globalCtx, &mut (*this).actor, 100.0f32,
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0
            ...
            EnWf_SetupBlocking(this);
            return 1 as libc::c_int
        } else if (*this).actor.xzDistToPlayer < 80.0f32 &&
            ...
            EnWf_SetupBlocking(this);
            return 1 as libc::c_int
        } else { EnWf_SetupBackflipAway(this); return 1 as libc::c_int }
    }
    explosive =
    ...
    if !explosive.is_null() {
        ...
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0
               && (wallYawDiff as libc::c_int) < 0x2ee0 as libc::c_int ||
    ...
    if mustChoose != 0 {
        let mut playerFacingAngleDiff: s16 = 0;
        if playerYawDiff as libc::c_int >= 0x1b58 as libc::c_int {
            EnWf_SetupSidestep(this, globalCtx);
            return 1 as libc::c_int
        }
        playerFacingAngleDiff =
        ...
        if (*this).actor.xzDistToPlayer <= 80.0f32 &&
               ...
               ((*globalCtx).gameplayFrames.wrapping_rem(8 as libc::c_int as
                                                             libc::c_uint) !=
                    0 as libc::c_int as libc::c_uint ||
                    (if playerFacingAngleDiff as libc::c_int >=
                            0 as libc::c_int {
                         playerFacingAngleDiff as libc::c_int
                     } else { -(playerFacingAngleDiff as libc::c_int) }) <
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupWaitToAppear(mut this: *mut EnWf) {
    Animation_Change(&mut (*this).skelAnime,
                     &mut gWolfosRearingUpFallingOverAnim, 0.5f32, 0.0f32,
                     7.0f32, ANIMMODE_ONCE_INTERP as libc::c_int as u8_0,
                     0.0f32);
    (*this).actor.world.pos.y = (*this).actor.home.pos.y - 5.0f32;
    (*this).actionTimer = 20 as libc::c_int;
    (*this).unk_300 = 0 as libc::c_int as s16;
    (*this).action = WOLFOS_ACTION_WAIT_TO_APPEAR as libc::c_int;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.scale.y = 0.0f32;
    (*this).actor.gravity = 0.0f32;
    EnWf_SetupAction(this,
                     Some(EnWf_WaitToAppear as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_WaitToAppear(mut this: *mut EnWf,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).actionTimer >= 6 as libc::c_int {
        (*this).actor.world.pos.y = (*this).actor.home.pos.y - 5.0f32;
        if (*this).actor.xzDistToPlayer < 240.0f32 {
            (*this).actionTimer = 5 as libc::c_int;
            (*this).actor.flags |=
                ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            if (*this).actor.params as libc::c_int !=
                   WOLFOS_NORMAL as libc::c_int &&
                   (*this).switchFlag as libc::c_int != 0xff as libc::c_int {
                func_800F5ACC(0x38 as libc::c_int as u16_0);
                // Mini-Boss Battle Theme
            }
        }
    } else if (*this).actionTimer != 0 as libc::c_int {
        (*this).actor.scale.y +=
            (*this).actor.scale.x * 0.2f32; // actionTimer == 0
        (*this).actor.world.pos.y += 0.5f32;
        Math_SmoothStepToF(&mut (*this).actor.shape.shadowScale, 70.0f32,
                           1.0f32, 14.0f32, 0.0f32);
        (*this).actionTimer -= 1;
        if (*this).actionTimer == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x383c as libc::c_int as u16_0);
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupWait(mut this: *mut EnWf) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gWolfosWaitingAnim,
                          -4.0f32);
    (*this).action = WOLFOS_ACTION_WAIT as libc::c_int;
    (*this).actionTimer = (Rand_ZeroOne() * 10.0f32 + 2.0f32) as s32;
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_Wait(mut this: *mut EnWf,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_2E2 as libc::c_int != 0 as libc::c_int {
        angle =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int -
                 (*this).unk_4D4.y as libc::c_int) as s16;
        if (if angle as libc::c_int >= 0 as libc::c_int {
                angle as libc::c_int
            } else { -(angle as libc::c_int) }) > 0x2000 as libc::c_int {
            (*this).unk_2E2 -= 1;
            return
        }
        (*this).unk_2E2 = 0 as libc::c_int as s16
    }
    angle =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    angle =
        if angle as libc::c_int >= 0 as libc::c_int {
            angle as libc::c_int
        } else { -(angle as libc::c_int) } as s16;
    if EnWf_DodgeRanged(globalCtx, this) == 0 {
        // Only use of unk_2E0: never not zero, so this if block never runs
        if (*this).unk_2E0 as libc::c_int != 0 as libc::c_int {
            (*this).unk_2E0 -= 1;
            if angle as libc::c_int >= 0x1ffe as libc::c_int { return }
            (*this).unk_2E0 = 0 as libc::c_int as s16
        } else if EnWf_ChangeAction(globalCtx, this, 0 as libc::c_int as s16)
                      != 0 {
            return
        }
        angle =
        ...
        if (*this).actor.xzDistToPlayer < 80.0f32 &&
               ...
               angle as libc::c_int >= 0x1f40 as libc::c_int {
            (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
            EnWf_SetupRunAroundPlayer(this);
        } else {
            ...
            if (*this).actionTimer == 0 as libc::c_int {
                if Actor_IsFacingPlayer(&mut (*this).actor,
                    ...
                    } else { EnWf_SetupRunAroundPlayer(this); }
                } else { EnWf_SetupSearchForPlayer(this); }
                if (*globalCtx).gameplayFrames &
                       95 as libc::c_int as libc::c_uint ==
                       0 as libc::c_int as libc::c_uint {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x383e as libc::c_int as u16_0);
                }
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupRunAtPlayer(mut this: *mut EnWf,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gWolfosRunningAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gWolfosRunningAnim, 1.0f32,
                     0.0f32, lastFrame,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    (*this).action = WOLFOS_ACTION_RUN_AT_PLAYER as libc::c_int;
    EnWf_SetupAction(this,
                     Some(EnWf_RunAtPlayer as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_RunAtPlayer(mut this: *mut EnWf,
                                          mut globalCtx: *mut GlobalContext) {
    let mut animPrevFrame: s32 = 0;
    let mut sp58: s32 = 0;
    let mut pad: s32 = 0;
    ...
    if EnWf_DodgeRanged(globalCtx, this) == 0 {
        ...
        if (*this).actor.xzDistToPlayer <= 50.0f32 + baseRange {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, -8.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else if 65.0f32 + baseRange < (*this).actor.xzDistToPlayer {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, 8.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else {
        ...
        (*this).skelAnime.playSpeed = (*this).actor.speedXZ * 0.175f32;
        playerFacingAngleDiff =
            ((*player).actor.shape.rot.y as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        playerFacingAngleDiff =
            if playerFacingAngleDiff as libc::c_int >= 0 as libc::c_int {
                playerFacingAngleDiff as libc::c_int
            } else { -(playerFacingAngleDiff as libc::c_int) } as s16;
        if (*this).actor.xzDistToPlayer < 150.0f32 + baseRange &&
               (*player).swordState as libc::c_int != 0 as libc::c_int &&
               playerFacingAngleDiff as libc::c_int >= 8000 as libc::c_int {
            (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
        ...
        animPrevFrame = (*this).skelAnime.curFrame as s32;
        SkelAnime_Update(&mut (*this).skelAnime);
        sp58 =
        ...
        if Actor_IsFacingPlayer(&mut (*this).actor,
            ...
            if Rand_ZeroOne() > 0.5f32 {
                EnWf_SetupRunAroundPlayer(this);
            } else { EnWf_SetupWait(this); }
        } else if (*this).actor.xzDistToPlayer < 90.0f32 + baseRange {
            let mut temp_v1: s16 =
                ((*player).actor.shape.rot.y as libc::c_int -
                     (*this).actor.shape.rot.y as libc::c_int) as s16;
            if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
        ...
        if EnWf_ChangeAction(globalCtx, this, 0 as libc::c_int as s16) == 0 {
            if (*globalCtx).gameplayFrames & 95 as libc::c_int as libc::c_uint
                   == 0 as libc::c_int as libc::c_uint {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x383e as libc::c_int as u16_0);
            }
            if animPrevFrame != (*this).skelAnime.curFrame as s32 &&
                   sp58 <= 0 as libc::c_int &&
                   playSpeed + animPrevFrame > 0 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x385a as libc::c_int as u16_0);
                Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                         &mut (*this).actor.world.pos,
                                         20.0f32, 3 as libc::c_int, 3.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupSearchForPlayer(mut this: *mut EnWf) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut gWolfosSidesteppingAnim, -4.0f32);
    (*this).action = WOLFOS_ACTION_SEARCH_FOR_PLAYER as libc::c_int;
    EnWf_SetupAction(this,
                     Some(EnWf_SearchForPlayer as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_SearchForPlayer(mut this: *mut EnWf,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    if EnWf_DodgeRanged(globalCtx, this) == 0 &&
           EnWf_ChangeAction(globalCtx, this, 0 as libc::c_int as s16) == 0 {
        yawDiff =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        phi_v1 =
            if yawDiff as libc::c_int > 0 as libc::c_int {
                (yawDiff as libc::c_int as libc::c_float * 0.25f32) +
                    2000.0f32
            } else {
                (yawDiff as libc::c_int as libc::c_float * 0.25f32) -
                    2000.0f32
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + phi_v1 as libc::c_int)
                as s16;
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        if yawDiff as libc::c_int > 0 as libc::c_int {
            phi_f2 = phi_v1 as libc::c_int as libc::c_float * 0.5f32;
            phi_f2 = if phi_f2 > 1.0f32 { 1.0f32 } else { phi_f2 }
        } else {
            phi_f2 = phi_v1 as libc::c_int as libc::c_float * 0.5f32;
            phi_f2 = if phi_f2 < -1.0f32 { -1.0f32 } else { phi_f2 }
        }
        ...
        if Actor_IsFacingPlayer(&mut (*this).actor,
            ...
            if Rand_ZeroOne() > 0.8f32 {
                EnWf_SetupRunAroundPlayer(this);
            } else { EnWf_SetupRunAtPlayer(this, globalCtx); }
        }
        if (*globalCtx).gameplayFrames & 95 as libc::c_int as libc::c_uint ==
               0 as libc::c_int as libc::c_uint {
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupRunAroundPlayer(mut this: *mut EnWf) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gWolfosRunningAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gWolfosRunningAnim, 1.0f32,
                     ...
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    if Rand_ZeroOne() > 0.5f32 {
        (*this).runAngle = 16000 as libc::c_int as s16
    } else { (*this).runAngle = -(16000 as libc::c_int) as s16 }
    (*this).actor.speedXZ = 6.0f32;
    (*this).skelAnime.playSpeed = (*this).actor.speedXZ;
    (*this).skelAnime.playSpeed *= 0.175f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actionTimer = (Rand_ZeroOne() * 30.0f32 + 30.0f32) as s32;
    (*this).action = WOLFOS_ACTION_RUN_AROUND_PLAYER as libc::c_int;
    (*this).runSpeed = 0.0f32;
    EnWf_SetupAction(this,
                     Some(EnWf_RunAroundPlayer as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_RunAroundPlayer(mut this: *mut EnWf,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut angle1: s16 = 0;
    let mut angle2: s16 = 0;
    let mut pad: s32 = 0;
    let mut baseRange: f32_0 = 0.0f32;
    let mut animPrevFrame: s32 = 0;
    let mut animFrameSpeedDiff: s32 = 0;
    let mut animSpeed: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ((*this).actor.yawTowardsPlayer as libc::c_int +
                            (*this).runAngle as libc::c_int) as s16,
    ...
    if EnWf_DodgeRanged(globalCtx, this) == 0 &&
        ...
        angle1 =
            ((*player).actor.shape.rot.y as libc::c_int +
                 (*this).runAngle as libc::c_int + 0x8000 as libc::c_int) as
                s16;
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0
            ...
            if (if angle2 as libc::c_int >= 0 as libc::c_int {
                    angle2 as libc::c_int
                } else { -(angle2 as libc::c_int) }) > 0x2ee0 as libc::c_int {
                (*this).runAngle = -((*this).runAngle as libc::c_int) as s16
            }
        } // Set and not used
        if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) != 0 {
            baseRange = 150.0f32
        }
        if (*this).actor.xzDistToPlayer <= 60.0f32 + baseRange {
            Math_SmoothStepToF(&mut (*this).runSpeed, -4.0f32, 1.0f32, 1.5f32,
                               0.0f32);
        } else if 80.0f32 + baseRange < (*this).actor.xzDistToPlayer {
            Math_SmoothStepToF(&mut (*this).runSpeed, 4.0f32, 1.0f32, 1.5f32,
                               0.0f32);
        } else {
            Math_SmoothStepToF(&mut (*this).runSpeed, 0.0f32, 1.0f32, 6.65f32,
                               0.0f32);
        }
        if (*this).runSpeed != 0.0f32 {
            (*this).actor.world.pos.x +=
                Math_SinS((*this).actor.shape.rot.y) * (*this).runSpeed;
            (*this).actor.world.pos.z +=
                Math_CosS((*this).actor.shape.rot.y) * (*this).runSpeed
        }
        if (if (*this).runSpeed >= 0 as libc::c_int as libc::c_float {
                (*this).runSpeed
            } else { -(*this).runSpeed }) <
            ...
            (*this).skelAnime.playSpeed = (*this).actor.speedXZ * 0.175f32
        } else { (*this).skelAnime.playSpeed = (*this).runSpeed * 0.175f32 }
        (*this).skelAnime.playSpeed =
        ...
        if animPrevFrame != (*this).skelAnime.curFrame as s32 &&
               animFrameSpeedDiff <= 0 as libc::c_int &&
               animSpeed + animPrevFrame > 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x385a as libc::c_int as u16_0);
            Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                     &mut (*this).actor.world.pos, 20.0f32,
                                     3 as libc::c_int, 3.0f32,
                                     50 as libc::c_int as s16,
                                     50 as libc::c_int as s16,
                                     1 as libc::c_int as u8_0);
        }
        ...
        if Math_CosS((angle1 as libc::c_int -
                          (*this).actor.shape.rot.y as libc::c_int) as s16) <
               -0.85f32 &&
               Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
               (*this).actor.xzDistToPlayer <= 80.0f32 {
            ...
            if (*this).actionTimer == 0 as libc::c_int {
                if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) != 0
                    ...
                    EnWf_SetupWait(this);
                    (*this).actionTimer =
                        (Rand_ZeroOne() * 3.0f32 + 1.0f32) as s32
                }
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupSlash(mut this: *mut EnWf) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWolfosSlashingAnim);
    (*this).colliderSpheres.base.atFlags =
        ((*this).colliderSpheres.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).action = WOLFOS_ACTION_SLASH as libc::c_int;
    (*this).unk_2FA = 0 as libc::c_int as s16;
    (*this).actionTimer = 7 as libc::c_int;
    (*this).skelAnime.endFrame = 20.0f32;
    (*this).actor.speedXZ = 0.0f32;
    EnWf_SetupAction(this,
                     Some(EnWf_Slash as
                              unsafe extern "C" fn(_: *mut EnWf,
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_Slash(mut this: *mut EnWf,
                                    mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut shapeAngleDiff: s16 =
        ((*player).actor.shape.rot.y as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    let mut yawAngleDiff: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    let mut curFrame: s32 = (*this).skelAnime.curFrame as s32;
    shapeAngleDiff =
        if shapeAngleDiff as libc::c_int >= 0 as libc::c_int {
            shapeAngleDiff as libc::c_int
        } else { -(shapeAngleDiff as libc::c_int) } as s16;
    yawAngleDiff =
        if yawAngleDiff as libc::c_int >= 0 as libc::c_int {
            yawAngleDiff as libc::c_int
        } else { -(yawAngleDiff as libc::c_int) } as s16;
    (*this).actor.speedXZ = 0.0f32;
    if curFrame >= 9 as libc::c_int && curFrame <= 12 as libc::c_int ||
           curFrame >= 17 as libc::c_int && curFrame <= 19 as libc::c_int {
        if (*this).slashStatus as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x383f as libc::c_int as u16_0);
        }
        (*this).slashStatus = 1 as libc::c_int as s16
    } else { (*this).slashStatus = 0 as libc::c_int as s16 }
    if curFrame == 15 as libc::c_int &&
           Actor_IsTargeted(globalCtx, &mut (*this).actor) == 0 &&
           (Actor_IsFacingPlayer(&mut (*this).actor,
                                 0x2000 as libc::c_int as s16) == 0 ||
                (*this).actor.xzDistToPlayer >= 100.0f32) ||
           SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if curFrame != 15 as libc::c_int &&
               (*this).actionTimer != 0 as libc::c_int {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
                     (3276.0f32 *
                          (1.5f32 +
                               ((*this).actionTimer - 4 as libc::c_int) as
                                   libc::c_float * 0.4f32)) as s16 as
                         libc::c_int) as s16;
            Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                     &mut (*this).actor.world.pos, 15.0f32,
                                     1 as libc::c_int, 2.0f32,
                                     50 as libc::c_int as s16,
                                     50 as libc::c_int as s16,
                                     1 as libc::c_int as u8_0);
            (*this).actionTimer -= 1
                      ...
                      curFrame != 15 as libc::c_int {
            EnWf_SetupWait(this);
            (*this).actionTimer = (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
            if yawAngleDiff as libc::c_int > 13000 as libc::c_int {
                (*this).unk_2E2 = 7 as libc::c_int as s16
            }
            ...
            if Rand_ZeroOne() > 0.7f32 {
                EnWf_SetupSidestep(this, globalCtx);
            } else if shapeAngleDiff as libc::c_int <= 10000 as libc::c_int {
                if yawAngleDiff as libc::c_int > 16000 as libc::c_int {
                    (*this).actor.world.rot.y =
                        (*this).actor.yawTowardsPlayer;
                    EnWf_SetupRunAroundPlayer(this);
                } else {
                    EnWf_ChangeAction(globalCtx, this,
                                      1 as libc::c_int as s16);
                }
            } else { EnWf_SetupRunAroundPlayer(this); }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupRecoilFromBlockedSlash(mut this:
                                                              *mut EnWf) {
    let mut endFrame: f32_0 = 1.0f32;
    if (*this).skelAnime.curFrame as s32 >= 16 as libc::c_int {
        endFrame = 15.0f32
    }
    Animation_Change(&mut (*this).skelAnime, &mut gWolfosSlashingAnim,
                     -0.5f32, (*this).skelAnime.curFrame - 1.0f32, endFrame,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, 0.0f32);
    (*this).action = WOLFOS_ACTION_RECOIL_FROM_BLOCKED_SLASH as libc::c_int;
    (*this).slashStatus = 0 as libc::c_int as s16;
    EnWf_SetupAction(this,
                     Some(EnWf_RecoilFromBlockedSlash as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_RecoilFromBlockedSlash(mut this: *mut EnWf,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    let mut angle2: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    angle1 =
        if angle1 as libc::c_int >= 0 as libc::c_int {
            angle1 as libc::c_int
        } else { -(angle1 as libc::c_int) } as s16;
    angle2 =
        if angle2 as libc::c_int >= 0 as libc::c_int {
            angle2 as libc::c_int
        } else { -(angle2 as libc::c_int) } as s16;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                0x1554 as libc::c_int as s16) == 0 {
            EnWf_SetupWait(this);
            (*this).actionTimer = (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
            if angle2 as libc::c_int > 0x32c8 as libc::c_int {
                (*this).unk_2E2 = 30 as libc::c_int as s16
            }
        } else if Rand_ZeroOne() > 0.7f32 ||
                      (*this).actor.xzDistToPlayer >= 120.0f32 {
            EnWf_SetupWait(this);
            ...
            if Rand_ZeroOne() > 0.7f32 {
                EnWf_SetupSidestep(this, globalCtx);
            } else if angle1 as libc::c_int <= 0x2710 as libc::c_int {
                if angle2 as libc::c_int > 0x3e80 as libc::c_int {
                    (*this).actor.world.rot.y =
                        (*this).actor.yawTowardsPlayer;
                    EnWf_SetupRunAroundPlayer(this);
                } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupBackflipAway(mut this: *mut EnWf) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gWolfosBackflippingAnim, -3.0f32);
    (*this).actor.speedXZ = -6.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    (*this).actionTimer = 0 as libc::c_int;
    (*this).unk_300 = 1 as libc::c_int as s16;
    (*this).action = WOLFOS_ACTION_BACKFLIP_AWAY as libc::c_int;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    EnWf_SetupAction(this,
                     Some(EnWf_BackflipAway as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_BackflipAway(mut this: *mut EnWf,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
    ...
    if (*globalCtx).state.frames & 95 as libc::c_int as libc::c_uint ==
           0 as libc::c_int as libc::c_uint {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x383e as libc::c_int as u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupStunned(mut this: *mut EnWf) {
    ...
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                               &mut gWolfosDamagedAnim, 0.0f32);
    (*this).action = WOLFOS_ACTION_STUNNED as libc::c_int;
    EnWf_SetupAction(this,
                     Some(EnWf_Stunned as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Stunned(mut this: *mut EnWf,
                                      mut globalCtx: *mut GlobalContext) {
        ...
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            ...
            EnWf_ChangeAction(globalCtx, this, 1 as libc::c_int as s16);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupDamaged(mut this: *mut EnWf) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gWolfosDamagedAnim,
                              -4.0f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_300 = 0 as libc::c_int as s16;
        (*this).actor.speedXZ = -4.0f32
    } else { (*this).unk_300 = 1 as libc::c_int as s16 }
    (*this).unk_2E2 = 0 as libc::c_int as s16;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3843 as libc::c_int as u16_0);
    (*this).action = WOLFOS_ACTION_DAMAGED as libc::c_int;
    EnWf_SetupAction(this,
                     Some(EnWf_Damaged as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Damaged(mut this: *mut EnWf,
                                      mut globalCtx: *mut GlobalContext) {
    ...
    if EnWf_ChangeAction(globalCtx, this, 0 as libc::c_int as s16) == 0 &&
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            ...
            if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int !=
                   ...
                   (*this).actor.xzDistToPlayer < 120.0f32 {
                EnWf_SetupSomersaultAndAttack(this);
            } else if EnWf_DodgeRanged(globalCtx, this) == 0 {
                if (*this).actor.xzDistToPlayer <= 80.0f32 &&
                       Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) ==
                           0 &&
                       (*globalCtx).gameplayFrames.wrapping_rem(8 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
                           != 0 as libc::c_int as libc::c_uint {
                    ...
                    EnWf_SetupWait(this);
                    (*this).actionTimer =
                        (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
                    (*this).unk_2E2 = 30 as libc::c_int as s16
                } else { EnWf_SetupBackflipAway(this); }
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupSomersaultAndAttack(mut this: *mut EnWf) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gWolfosBackflippingAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gWolfosBackflippingAnim,
                     -1.0f32, lastFrame, 0.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    (*this).actionTimer = 0 as libc::c_int;
    (*this).unk_300 = 0 as libc::c_int as s16;
    (*this).action = WOLFOS_ACTION_TURN_TOWARDS_PLAYER as libc::c_int;
    (*this).actor.speedXZ = 6.5f32;
    (*this).actor.velocity.y = 15.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnWf_SetupAction(this,
                     Some(EnWf_SomersaultAndAttack as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_SomersaultAndAttack(mut this: *mut EnWf,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
    ...
    if (*this).actor.velocity.y >= 5.0f32 {
        ...
        func_800355B8(globalCtx, &mut (*this).unk_4C8);
        func_800355B8(globalCtx, &mut (*this).unk_4BC);
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 &&
        ...
        (*this).actor.speedXZ = (*this).actor.velocity.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupBlocking(mut this: *mut EnWf) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gWolfosBlockingAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    if (*this).slashStatus as libc::c_int != 0 as libc::c_int {
        (*this).slashStatus = -(1 as libc::c_int) as s16
    ...
    (*this).actor.speedXZ = 0.0f32;
    (*this).action = WOLFOS_ACTION_BLOCKING as libc::c_int;
    (*this).actionTimer = 10 as libc::c_int;
    Animation_Change(&mut (*this).skelAnime, &mut gWolfosBlockingAnim, 0.0f32,
                     0.0f32, lastFrame,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, -4.0f32);
    EnWf_SetupAction(this,
                     Some(EnWf_Blocking as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Blocking(mut this: *mut EnWf,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (if yawDiff as libc::c_int >= 0 as libc::c_int {
               ...
               (*this).actor.xzDistToPlayer < 60.0f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupSidestep(mut this: *mut EnWf,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut angle: s16 = 0;
    let mut player: *mut Player = 0 as *mut Player;
    ...
    angle =
        ((*player).actor.shape.rot.y as libc::c_int +
             (*this).runAngle as libc::c_int) as s16;
    if Math_SinS((angle as libc::c_int -
                      (*this).actor.yawTowardsPlayer as libc::c_int) as s16) >
           0.0f32 {
        (*this).runAngle = 16000 as libc::c_int as s16
    } else if Math_SinS((angle as libc::c_int -
    ...
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).runSpeed = 0.0f32;
    (*this).actionTimer = (Rand_ZeroOne() * 10.0f32 + 5.0f32) as s32;
    (*this).action = WOLFOS_ACTION_SIDESTEP as libc::c_int;
    EnWf_SetupAction(this,
                     Some(EnWf_Sidestep as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_Sidestep(mut this: *mut EnWf,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angleDiff1: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut animPrevFrame: s32 = 0;
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ((*this).actor.yawTowardsPlayer as libc::c_int +
                            (*this).runAngle as libc::c_int) as s16,
                       1 as libc::c_int as s16, 3000 as libc::c_int as s16,
                       1 as libc::c_int as s16);
    // Actor_TestFloorInDirection is useless here (see comment below)
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 ||
           Actor_TestFloorInDirection(&mut (*this).actor, globalCtx,
        ...
        if (if angle as libc::c_int >= 0 as libc::c_int {
                angle as libc::c_int
            } else { -(angle as libc::c_int) }) > 0x2ee0 as libc::c_int {
            (*this).runAngle = -((*this).runAngle as libc::c_int) as s16
        }
        ...
        if (*this).actionTimer == 0 as libc::c_int {
            angleDiff1 =
                ((*player).actor.shape.rot.y as libc::c_int -
                     (*this).actor.yawTowardsPlayer as libc::c_int) as s16;
            angleDiff1 =
                if angleDiff1 as libc::c_int >= 0 as libc::c_int {
                    angleDiff1 as libc::c_int
                } else { -(angleDiff1 as libc::c_int) } as s16;
            if angleDiff1 as libc::c_int >= 0x3a98 as libc::c_int {
                EnWf_SetupWait(this);
                (*this).actionTimer =
                    (Rand_ZeroOne() * 3.0f32 + 1.0f32) as s32
            } else {
                ...
                if (*this).actor.xzDistToPlayer <= 80.0f32 &&
                       ...
                       ((*globalCtx).gameplayFrames.wrapping_rem(4 as
                                                                     ...
                                                                     libc::c_uint)
                            == 0 as libc::c_int as libc::c_uint ||
                            (if angleDiff2 as libc::c_int >= 0 as libc::c_int
                                {
                                 angleDiff2 as libc::c_int
                             } else { -(angleDiff2 as libc::c_int) }) <
                                0x38e0 as libc::c_int) {
                    EnWf_SetupSlash(this);
                } else { EnWf_SetupRunAtPlayer(this, globalCtx); }
            }
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_SetupDie(mut this: *mut EnWf) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gWolfosRearingUpFallingOverAnim, -4.0f32);
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).unk_300 = 0 as libc::c_int as s16;
        (*this).actor.speedXZ = -6.0f32
    } else { (*this).unk_300 = 1 as libc::c_int as s16 }
    (*this).action = WOLFOS_ACTION_DIE as libc::c_int;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionTimer = (*this).skelAnime.animLength as s32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x384b as libc::c_int as u16_0);
    EnWf_SetupAction(this,
                     Some(EnWf_Die as
                              unsafe extern "C" fn(_: *mut EnWf,
                                                   _: *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_Die(mut this: *mut EnWf,
                                  mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).actor.speedXZ = 0.0f32
    }
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        let mut velAndAccel: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,}; init };
        (*this).actionTimer -= 1;
        i =
            (*this).skelAnime.animLength as s32 - (*this).actionTimer >>
                1 as libc::c_int;
        while i >= 0 as libc::c_int {
            ...
            EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut velAndAccel,
                                 &mut velAndAccel, 100 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B36F40(mut this: *mut EnWf,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).action == WOLFOS_ACTION_WAIT as libc::c_int &&
           (*this).unk_2E2 as libc::c_int != 0 as libc::c_int {
        (*this).unk_4D4.y =
            (Math_SinS(((*this).unk_2E2 as libc::c_int * 4200 as libc::c_int)
                           as s16) * 8920.0f32) as s16
    } else if (*this).action != WOLFOS_ACTION_STUNNED as libc::c_int {
        if (*this).action != WOLFOS_ACTION_SLASH as libc::c_int {
            Math_SmoothStepToS(&mut (*this).unk_4D4.y,
                               ((*this).actor.yawTowardsPlayer as libc::c_int
                                    -
                                    (*this).actor.shape.rot.y as libc::c_int)
                               ...
                               0 as libc::c_int as s16);
            (*this).unk_4D4.y =
                if ((*this).unk_4D4.y as libc::c_int) <
                       -(0x3127 as libc::c_int) {
                    -(0x3127 as libc::c_int)
                } else if (*this).unk_4D4.y as libc::c_int >
                              0x3127 as libc::c_int {
                    0x3127 as libc::c_int
                } else { (*this).unk_4D4.y as libc::c_int } as s16
        } else { (*this).unk_4D4.y = 0 as libc::c_int as s16 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_UpdateDamage(mut this: *mut EnWf,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).colliderSpheres.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 7 as libc::c_int != 0 {
        (*this).colliderSpheres.base.acFlags =
            ((*this).colliderSpheres.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int |
                       (1 as libc::c_int) << 7 as libc::c_int)) as u8_0;
        (*this).colliderCylinderBody.base.acFlags =
            ((*this).colliderCylinderBody.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        (*this).colliderCylinderTail.base.acFlags =
            ((*this).colliderCylinderTail.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0
    } else if (*this).colliderCylinderBody.base.acFlags as libc::c_int &
        ...
        if (*this).action >= WOLFOS_ACTION_WAIT as libc::c_int {
            let mut yawDiff: s16 =
                ((*this).actor.yawTowardsPlayer as libc::c_int -
                     (*this).actor.shape.rot.y as libc::c_int) as s16;
            if (*this).colliderCylinderBody.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int == 0 &&
                   (*this).colliderCylinderTail.base.acFlags as libc::c_int &
                       (1 as libc::c_int) << 1 as libc::c_int != 0 ||
                   (if yawDiff as libc::c_int >= 0 as libc::c_int {
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
                ...
                Actor_SetDropFlag(&mut (*this).actor,
                                  &mut (*this).colliderCylinderBody.info,
                                  1 as libc::c_int);
                (*this).slashStatus = 0 as libc::c_int as s16;
                if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       ENWF_DMGEFF_STUN as libc::c_int ||
                       (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                           ENWF_DMGEFF_UNDEF as libc::c_int {
                    if (*this).action != WOLFOS_ACTION_STUNNED as libc::c_int
                       {
                    ...
                    if (*this).damageEffect as libc::c_int ==
                           ENWF_DMGEFF_FIRE as libc::c_int {
                        (*this).fireTimer = 40 as libc::c_int as s16
                    }
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnWf = thisx as *mut EnWf;
    ...
    if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 32.0f32,
    ...
    if (*this).actor.bgCheckFlags as libc::c_int &
           (1 as libc::c_int | 2 as libc::c_int) != 0 {
        func_800359B8(&mut (*this).actor, (*this).actor.shape.rot.y,
    ...
    if (*this).action >= WOLFOS_ACTION_WAIT as libc::c_int {
        if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int
            ...
            Collider_UpdateCylinder(&mut (*this).actor,
                                    &mut (*this).colliderCylinderBody);
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colliderCylinderTail.base);
            CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colliderCylinderBody.base);
        }
    }
    if (*this).action == WOLFOS_ACTION_BLOCKING as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderSpheres.base);
    }
    if (*this).slashStatus as libc::c_int > 0 as libc::c_int {
        if (*this).colliderSpheres.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 2 as libc::c_int == 0 {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colliderSpheres.base);
        } else { EnWf_SetupRecoilFromBlockedSlash(this); }
    }
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actor.focus.pos.y += 25.0f32;
    if (*this).eyeIndex as libc::c_int == 0 as libc::c_int {
        if Rand_ZeroOne() < 0.2f32 &&
               ...
               (*this).actor.colorFilterTimer as libc::c_int ==
                   0 as libc::c_int {
            (*this).eyeIndex = (*this).eyeIndex.wrapping_add(1)
        }
    } else {
        (*this).eyeIndex =
            ((*this).eyeIndex as libc::c_int + 1 as libc::c_int &
                 3 as libc::c_int) as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnWf = thisx as *mut EnWf;
    if limbIndex == WOLFOS_LIMB_HEAD as libc::c_int ||
           limbIndex == WOLFOS_LIMB_EYES as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int - (*this).unk_4D4.y as libc::c_int) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnWf_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void) {
    static mut colliderVec: Vec3f =
        { let mut init = Vec3f{x: 1200.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut bodyPartVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnWf = thisx as *mut EnWf;
    let mut bodyPartIndex: s32 = -(1 as libc::c_int);
    Collider_UpdateSpheres(limbIndex, &mut (*this).colliderSpheres);
    if limbIndex == WOLFOS_LIMB_TAIL as libc::c_int {
        let mut colliderPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        bodyPartIndex = -(1 as libc::c_int);
        Matrix_MultVec3f(&mut colliderVec, &mut colliderPos);
        (*this).colliderCylinderTail.dim.pos.x = colliderPos.x as s16;
        (*this).colliderCylinderTail.dim.pos.y = colliderPos.y as s16;
        (*this).colliderCylinderTail.dim.pos.z = colliderPos.z as s16
    }
    if (*this).fireTimer as libc::c_int != 0 as libc::c_int ||
           (*this).actor.colorFilterTimer as libc::c_int != 0 as libc::c_int
               &&
               (*this).actor.colorFilterParams as libc::c_int &
                   0x4000 as libc::c_int != 0 {
        match limbIndex {
            18 => { bodyPartIndex = 0 as libc::c_int }
            14 => { bodyPartIndex = 1 as libc::c_int }
            20 => { bodyPartIndex = 2 as libc::c_int }
            12 => { bodyPartIndex = 3 as libc::c_int }
            7 => { bodyPartIndex = 4 as libc::c_int }
            6 => { bodyPartIndex = 5 as libc::c_int }
            9 => { bodyPartIndex = 6 as libc::c_int }
            37 => {
                ...
                bodyPartIndex = 7 as libc::c_int
            }
            10 => { bodyPartIndex = 8 as libc::c_int }
            5 => { bodyPartIndex = 9 as libc::c_int }
            _ => { }
        }
        if bodyPartIndex >= 0 as libc::c_int {
            let mut bodyPartPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            Matrix_MultVec3f(&mut bodyPartVec, &mut bodyPartPos);
            (*this).bodyPartsPos[bodyPartIndex as usize].x =
                bodyPartPos.x as s16;
            (*this).bodyPartsPos[bodyPartIndex as usize].y =
                bodyPartPos.y as s16;
            (*this).bodyPartsPos[bodyPartIndex as usize].z =
                bodyPartPos.z as s16
        }
    };
}
static mut sWolfosNormalEyeTextures: [*mut libc::c_void; 4] =
    unsafe {
        [gWolfosNormalEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosNormalEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosNormalEyeNarrowTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosNormalEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sWolfosWhiteEyeTextures: [*mut libc::c_void; 4] =
    unsafe {
        [gWolfosWhiteEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosWhiteEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosWhiteEyeNarrowTex.as_ptr() as *mut _ as *mut libc::c_void,
         gWolfosWhiteEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnWf_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnWf = thisx as *mut EnWf;
    ...
    if (*this).action != WOLFOS_ACTION_WAIT_TO_APPEAR as libc::c_int ||
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                gSegments[((sWolfosNormalEyeTextures[(*this).eyeIndex as
                                                         usize] as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(sWolfosNormalEyeTextures[(*this).eyeIndex
                                                                               as
                                                                               usize]
                                                      as u32_0 &
            ...
            (*_g_0).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                gSegments[((sWolfosWhiteEyeTextures[(*this).eyeIndex as usize]
                                as u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(sWolfosWhiteEyeTextures[(*this).eyeIndex
                                                                              as
                                                                              usize]
                                                      as u32_0 &
                                                      0xffffff as libc::c_int
        ...
        if (*this).fireTimer as libc::c_int != 0 as libc::c_int {
            (*this).actor.colorFilterTimer =
                (*this).actor.colorFilterTimer.wrapping_add(1);
            (*this).fireTimer -= 1;
            if (*this).fireTimer as libc::c_int % 4 as libc::c_int ==
                   0 as libc::c_int {
                let mut fireIndex: s32 =
                    (*this).fireTimer as libc::c_int >> 2 as libc::c_int;
                EffectSsEnFire_SpawnVec3s(globalCtx, &mut (*this).actor,
                                          &mut *(*this).bodyPartsPos.as_mut_ptr().offset(fireIndex
                                                                                             as
                                                                                             isize),
...
#[no_mangle]
pub unsafe extern "C" fn EnWf_DodgeRanged(mut globalCtx: *mut GlobalContext,
                                          mut this: *mut EnWf) -> s32 {
    ...
    if !actor.is_null() {
        ...
        if (if angleToFacing as libc::c_int >= 0 as libc::c_int {
               ...
               0x2ee0 as libc::c_int && sqrt(dist as f64_0) < 400.0f64 {
            EnWf_SetupBlocking(this);
        } else {
            (*this).actor.world.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
    ...
    sJntSphInit =
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   count:
                                       (::std::mem::size_of::<[ColliderJntSphElementInit; 4]>()
                                            as
                                            libc::c_ulong).wrapping_div(::std::mem::size_of::<ColliderJntSphElementInit>()
                                                                            as
                                                                            libc::c_ulong)
                                           as s32,
                                   elements: sJntSphItemsInit.as_mut_ptr(),};
            init
        };
    sInitChain =
        [{
