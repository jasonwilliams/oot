...
#[no_mangle]
pub static mut osViModeMpalLan1: OSViMode =
    {
        let mut init =
            OSViMode{type_0: 0x1e as libc::c_int as u8_0,
                     comRegs:
                         {
                             let mut init =
                                 OSViCommonRegs{ctrl:
                                                ...
                                                width:
                                                    320 as libc::c_int as
                                                        u32_0,
                                                burst:
                                                    0x4651e39 as libc::c_int
                                                        as u32_0,
                                                vSync:
                                                    0x20d as libc::c_int as
                                                        u32_0,
                                                hSync:
                                                    0x40c11 as libc::c_int as
                                                        u32_0,
                                                leap:
                                                    0xc190c1a as libc::c_int
                                                        as u32_0,
                                                hStart:
