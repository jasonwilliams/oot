...
extern "C" {
    ...
    #[no_mangle]
    static mut object_tite_DL_002FF0: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_015380: [Gfx; 0];
}
...
pub type EnPartActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnPart, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Part_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PART as libc::c_int as s16,
                          category:
...
#[no_mangle]
pub unsafe extern "C" fn EnPart_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnPart_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACDDE8(mut this: *mut EnPart,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sign: f32_0 = 1.0f32;
    (*this).action = 1 as libc::c_int as u8_0;
    (*this).actor.world.rot.y = (Rand_ZeroOne() * 20000.0f32) as s16;
    let mut current_block_34: u64;
    match (*this).actor.params as libc::c_int {
        0 => {
            (*this).actor.velocity.y = 0.0f32;
            (*this).actor.gravity = -0.3f32 - Rand_ZeroOne() * 0.5f32;
            (*this).rotZSpeed = 0.3f32;
            (*this).timer = 25 as libc::c_int as s16;
            (*this).actor.speedXZ = (Rand_ZeroOne() - 0.5f32) * 2.0f32;
            current_block_34 = 4090602189656566074;
        }
        13 => {
            (*this).timer = 400 as libc::c_int as s16;
            current_block_34 = 17754809568836010492;
        }
        12 => { current_block_34 = 17754809568836010492; }
        14 => {
            EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                      &mut (*this).actor.world.pos,
                                      40 as libc::c_int as s16,
                                      0x8001 as libc::c_int as s16,
                                      0 as libc::c_int as s16,
                                      -(1 as libc::c_int) as s16);
            current_block_34 = 16329935132192744577;
        }
        1 | 4 | 9 | 10 => { current_block_34 = 16329935132192744577; }
        2 => { current_block_34 = 12490093154690919916; }
        11 => {
            EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                                      &mut (*this).actor.world.pos,
                                      40 as libc::c_int as s16,
                                      ...
                                      0 as libc::c_int as s16,
                                      -(1 as libc::c_int) as s16);
            current_block_34 = 6277541591924132655;
        }
        3 => { current_block_34 = 6277541591924132655; }
        5 | 6 | 7 | 8 => {
            (*this).actor.world.rot.y = (*(*this).actor.parent).shape.rot.y;
            if (*this).displayList == object_ik_DL_015380.as_mut_ptr() {
                sign = -1.0f32
            }
            (*this).actor.velocity.y = 0.0f32;
            (*this).actor.speedXZ = 6.0f32 * sign;
            (*this).actor.gravity = -1.2f32;
            (*this).rotZSpeed = 0.15f32 * sign;
        ...
        _ => { current_block_34 = 4090602189656566074; }
    }
    match current_block_34 {
        6277541591924132655 => {
            (*this).actor.speedXZ = (Rand_ZeroOne() - 0.5f32) * 3.0f32;
            (*this).timer =
                ((Rand_ZeroOne() * 17.0f32) as s16 as libc::c_int +
                     10 as libc::c_int) as s16;
            (*this).actor.velocity.y = Rand_ZeroOne() * 3.0f32 + 8.0f32;
            (*this).actor.gravity = -0.6f32 - Rand_ZeroOne() * 0.3f32;
            (*this).rotZSpeed = 0.15f32;
            current_block_34 = 4090602189656566074;
        }
        17754809568836010492 => {
            (*this).actor.speedXZ = Rand_CenteredFloat(6.0f32);
            (*this).actor.home.pos = (*this).actor.world.pos;
            (*this).timer =
                ((*this).timer as libc::c_int + 60 as libc::c_int) as s16;
            (*this).actor.velocity.y = Rand_ZeroOne() * 5.0f32 + 4.0f32;
            (*this).actor.gravity = -0.6f32 - Rand_ZeroOne() * 0.5f32;
            (*this).rotZSpeed = 0.15f32;
            current_block_34 = 4090602189656566074;
        }
        16329935132192744577 => {
            (*this).timer =
                ((*this).timer as libc::c_int +
                     ((Rand_ZeroOne() * 17.0f32) as s16 as libc::c_int +
                          5 as libc::c_int)) as s16;
            current_block_34 = 12490093154690919916;
        }
        _ => { }
    }
    match current_block_34 {
        12490093154690919916 => {
            (*this).actor.velocity.y = Rand_ZeroOne() * 5.0f32 + 4.0f32;
            (*this).actor.gravity = -0.6f32 - Rand_ZeroOne() * 0.5f32;
            (*this).rotZSpeed = 0.15f32
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACE13C(mut this: *mut EnPart,
                                       mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    let mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if (*this).actor.params as libc::c_int == 12 as libc::c_int ||
           (*this).actor.params as libc::c_int == 13 as libc::c_int {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                15.0f32, 0.0f32, 0x1d as libc::c_int);
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0
               || (*this).actor.world.pos.y <= (*this).actor.floorHeight {
            (*this).action = 4 as libc::c_int as u8_0;
            (*this).actor.speedXZ = 0.0f32;
            (*this).actor.gravity = 0.0f32;
            (*this).actor.velocity.y = 0.0f32
        }
        if (*this).actor.params as libc::c_int == 13 as libc::c_int &&
        ...
        match (*this).actor.params as libc::c_int {
            1 | 9 | 10 | 14 => {
                EffectSsDeadDb_Spawn(globalCtx, &mut (*this).actor.world.pos,
                                     ...
                                     (((*this).actor.scale.y * 100.0f32) as
                                          s16 as libc::c_int *
                                          40 as libc::c_int) as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACE5B8(mut this: *mut EnPart,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).action = 3 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACE5C8(mut this: *mut EnPart,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        if sqrt((*this).actor.xyzDistToPlayerSq as f64_0) <=
               40.0f32 as libc::c_double {
            let mut prevInvincibilityTimer: u8_0 =
            ...
            func_8002F71C(globalCtx, (*this).actor.parent,
                          (650.0f32 - (*(*this).actor.parent).xzDistToPlayer)
                              * 0.04f32 + 4.0f32,
                          (*(*this).actor.parent).world.rot.y, 8.0f32);
            (*player).invincibilityTimer = prevInvincibilityTimer as s8;
            (*this).timer = 1 as libc::c_int as s16
        }
        func_80033480(globalCtx, &mut (*this).actor.world.pos, 0.0f32,
                      1 as libc::c_int, 300 as libc::c_int as s16,
                      150 as libc::c_int as s16, 1 as libc::c_int as u8_0);
        velocity.x = Rand_CenteredFloat(16.0f32);
        EffectSsHahen_Spawn(globalCtx, &mut (*this).actor.world.pos,
                            &mut velocity, &mut accel,
                            20 as libc::c_int as s16,
                            ((Rand_ZeroOne() * 5.0f32 + 12.0f32) *
                                 2 as libc::c_int as libc::c_float) as s32 as
                                s16, -(1 as libc::c_int) as s16,
                            10 as libc::c_int as s16, 0 as *mut Gfx);
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x38e0 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80ACE7E8(mut this: *mut EnPart,
                                       mut globalCtx: *mut GlobalContext) {
    let mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    if (*this).actor.parent.is_null() ||
        ...
        EffectSsDeadDb_Spawn(globalCtx, &mut (*this).actor.world.pos,
                             &mut zeroVec, &mut zeroVec,
                             (((*this).actor.scale.y * 100.0f32) as s16 as
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        let mut diffsSum: f32_0 =
            Math_SmoothStepToF(&mut (*this).actor.world.pos.x,
                               (*this).actor.home.pos.x, 1.0f32, 5.0f32,
                               0.0f32);
        diffsSum +=
            Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                               (*this).actor.home.pos.y, 1.0f32, 5.0f32,
                               0.0f32);
        diffsSum +=
            Math_SmoothStepToF(&mut (*this).actor.world.pos.z,
                               (*this).actor.home.pos.z, 1.0f32, 5.0f32,
                               0.0f32);
        diffsSum +=
            Math_SmoothStepToF(&mut (*this).rotZ, 0.0f32, 1.0f32, 0.25f32,
                               0.0f32);
        if diffsSum == 0.0f32 {
            (*(*this).actor.parent).home.rot.x -= 1;
            (*this).timer -= 1;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x383a as libc::c_int as u16_0);
        }
    } else if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).timer -= 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnPart_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    static mut sActionFuncs: [EnPartActionFunc; 5] =
        unsafe {
            [Some(func_80ACDDE8 as
                      unsafe extern "C" fn(_: *mut EnPart,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80ACE13C as
                      unsafe extern "C" fn(_: *mut EnPart,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80ACE5B8 as
                      unsafe extern "C" fn(_: *mut EnPart,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80ACE5C8 as
                      unsafe extern "C" fn(_: *mut EnPart,
                                           _: *mut GlobalContext) -> ()),
             Some(func_80ACE7E8 as
                      unsafe extern "C" fn(_: *mut EnPart,
                                           _: *mut GlobalContext) -> ())]
        };
    let mut this: *mut EnPart = thisx as *mut EnPart;
    Actor_MoveForward(&mut (*this).actor);
    if (*this).actor.params as libc::c_int > 4 as libc::c_int &&
           ((*this).actor.params as libc::c_int) < 9 as libc::c_int ||
           ((*this).actor.params as libc::c_int) < 0 as libc::c_int {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                15.0f32, 0.0f32, 5 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80ACEAC0(mut gfxCtx: *mut GraphicsContext,
...
#[no_mangle]
pub unsafe extern "C" fn EnPart_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPart = thisx as *mut EnPart;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_part.c\x00" as *const u8 as *const libc::c_char,
                    647 as libc::c_int);
    if (*thisx).params as libc::c_int > 0 as libc::c_int {
        Matrix_RotateZ((*this).rotZ, MTXMODE_APPLY as libc::c_int as u8_0);
    }
    func_80093D18((*globalCtx).state.gfxCtx);
    func_8002EBCC(thisx, globalCtx, 0 as libc::c_int);
    if (*thisx).params as libc::c_int == 5 as libc::c_int {
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            func_80ACEAC0((*globalCtx).state.gfxCtx,
    ...
    } else if (*thisx).params as libc::c_int == 6 as libc::c_int {
        ...
        (*_g_4).words.w1 =
            func_80ACEAC0((*globalCtx).state.gfxCtx,
                          ...
                          20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint
    } else if (*thisx).params as libc::c_int == 7 as libc::c_int {
        ...
        (*_g_7).words.w1 =
            func_80ACEAC0((*globalCtx).state.gfxCtx,
                          ...
                          20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint
    } else if (*thisx).params as libc::c_int == 9 as libc::c_int &&
                  (*this).displayList == object_tite_DL_002FF0.as_mut_ptr() {
                          ...
                          usize].wrapping_add(object_tite_Tex_001900.as_mut_ptr()
                                                  ...
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     ...
                                                                                     libc::c_uint)
                as *mut libc::c_void as libc::c_uint
    } else if (*thisx).params as libc::c_int == 10 as libc::c_int &&
                  (*this).displayList == object_tite_DL_002FF0.as_mut_ptr() {
    ...
    if !(*this).displayList.is_null() {
        ...
        (*_g_14).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_part.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_15).words.w1 = (*this).displayList as libc::c_uint
    }
