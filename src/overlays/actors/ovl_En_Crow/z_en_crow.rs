...
extern "C" {
    ...
    #[no_mangle]
    static mut gGuayFlyAnim: AnimationHeader;
    #[no_mangle]
    static mut gGuaySkel: FlexSkeletonHeader;
}
...
pub struct EnCrow {
    ...
    pub skelAnime: SkelAnime,
    pub actionFunc: EnCrowActionFunc,
    pub timer: s16,
    pub aimRotX: s16,
    pub aimRotY: s16,
...
pub type EnCrowActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext) -> ()>;
static mut sZeroVecAccel: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub static mut En_Crow_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_CROW as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_CROW as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnCrow>() as
                                  libc::c_ulong,
                          init:
...
static mut sDeathCount: u32_0 = 0 as libc::c_int as u32_0;
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut sHeadVec: Vec3f =
    { let mut init = Vec3f{x: 2500.0f32, y: 0.0f32, z: 0.0f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCrow = thisx as *mut EnCrow;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gGuaySkel,
                       &mut gGuayFlyAnim, (*this).jointTable.as_mut_ptr(),
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    ActorShape_Init(&mut (*this).actor.shape, 2000.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 20.0f32);
    sDeathCount = 0 as libc::c_int as u32_0;
    EnCrow_SetupFlyIdle(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCrow = thisx as *mut EnCrow;
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupFlyIdle(mut this: *mut EnCrow) {
    ...
    (*this).actionFunc =
        Some(EnCrow_FlyIdle as
                 unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext)
                     -> ());
    (*this).skelAnime.playSpeed = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupDiveAttack(mut this: *mut EnCrow) {
    (*this).timer = 300 as libc::c_int as s16;
    (*this).actor.speedXZ = 4.0f32;
    (*this).skelAnime.playSpeed = 2.0f32;
    (*this).actionFunc =
        Some(EnCrow_DiveAttack as
                 unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupDamaged(mut this: *mut EnCrow,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut i: s32 = 0;
    ...
    Animation_Change(&mut (*this).skelAnime, &mut gGuayFlyAnim, 0.4f32,
                     0.0f32, 0.0f32,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -3.0f32);
    scale = (*this).actor.scale.x * 100.0f32;
    (*this).actor.world.pos.y += 20.0f32 * scale;
    (*this).actor.bgCheckFlags =
        ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int)) as
            u16_0;
    (*this).actor.shape.yOffset = 0.0f32;
    (*this).actor.targetArrowOffset = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38eb as libc::c_int as u16_0);
        ...
        while i < 8 as libc::c_int {
            iceParticlePos.x =
                (if i & 1 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) *
                    scale + (*this).actor.world.pos.x;
            iceParticlePos.y =
                (if i & 2 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) *
                    scale + (*this).actor.world.pos.y;
            iceParticlePos.z =
                (if i & 4 as libc::c_int != 0 { 7.0f32 } else { -7.0f32 }) *
                    scale + (*this).actor.world.pos.z;
    ...
    (*this).actionFunc =
        Some(EnCrow_Damaged as
                 unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupDie(mut this: *mut EnCrow) {
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupTurnAway(mut this: *mut EnCrow) {
    (*this).timer = 100 as libc::c_int as s16;
    (*this).actor.speedXZ = 3.5f32;
    (*this).aimRotX = -(0x1000 as libc::c_int) as s16;
    (*this).aimRotY =
    ...
    (*this).actionFunc =
        Some(EnCrow_TurnAway as
                 unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_SetupRespawn(mut this: *mut EnCrow) {
    if sDeathCount == 10 as libc::c_int as libc::c_uint {
        ...
        (*(*this).collider.elements.offset(0 as libc::c_int as
            ...
            ((*sJntSphInit.elements.offset(0 as libc::c_int as
                                               isize)).dim.modelSphere.radius
                 as libc::c_int as libc::c_float * 0.03f32 * 100.0f32) as s16
    } else {
    ...
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gGuayFlyAnim);
    ...
    (*this).timer = 300 as libc::c_int as s16;
    (*this).actor.shape.yOffset = 2000 as libc::c_int as f32_0;
    (*this).actor.targetArrowOffset = 2000.0f32;
    (*this).actor.draw = None;
    (*this).actionFunc =
        Some(EnCrow_Respawn as
                 unsafe extern "C" fn(_: *mut EnCrow, _: *mut GlobalContext)
                     -> ());
}
// Action functions
#[no_mangle]
pub unsafe extern "C" fn EnCrow_FlyIdle(mut this: *mut EnCrow,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    (*this).actor.speedXZ = Rand_ZeroOne() * 1.5f32 + 3.0f32;
    ...
    if Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, (*this).aimRotY,
                          5 as libc::c_int as s16,
                          0x300 as libc::c_int as s16,
                          0x10 as libc::c_int as s16) as libc::c_int ==
           0 as libc::c_int && skelanimeUpdated != 0 &&
           Rand_ZeroOne() < 0.1f32 {
        var =
            (Actor_WorldYawTowardPoint(&mut (*this).actor,
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38b6 as libc::c_int as u16_0);
    }
    if (*this).actor.yDistToWater > -40.0f32 {
        (*this).aimRotX = -(0x1000 as libc::c_int) as s16
    } else if (*this).actor.world.pos.y < (*this).actor.home.pos.y - 50.0f32 {
        (*this).aimRotX =
            (-(0x800 as libc::c_int) as libc::c_float -
                 Rand_ZeroOne() * 0x800 as libc::c_int as libc::c_float) as
                s16
    } else if (*this).actor.world.pos.y > (*this).actor.home.pos.y + 50.0f32 {
        (*this).aimRotX =
            (0x800 as libc::c_int as libc::c_float +
    ...
    if Math_SmoothStepToS(&mut (*this).actor.shape.rot.x, (*this).aimRotX,
                          10 as libc::c_int as s16,
                          0x100 as libc::c_int as s16,
                          8 as libc::c_int as s16) as libc::c_int ==
           0 as libc::c_int && skelanimeUpdated != 0 &&
           Rand_ZeroOne() < 0.1f32 {
        if (*this).actor.home.pos.y < (*this).actor.world.pos.y {
            (*this).aimRotX =
                ((*this).aimRotX as libc::c_float -
                     (0x400 as libc::c_int as libc::c_float * Rand_ZeroOne() +
                          0x400 as libc::c_int as libc::c_float)) as s16
        } else {
            (*this).aimRotX =
                ((*this).aimRotX as libc::c_float +
                     (0x400 as libc::c_int as libc::c_float * Rand_ZeroOne() +
        ...
        (*this).aimRotX =
            if ((*this).aimRotX as libc::c_int) < -(0x1000 as libc::c_int) {
                -(0x1000 as libc::c_int)
            } else if (*this).aimRotX as libc::c_int > 0x1000 as libc::c_int {
                0x1000 as libc::c_int
            } else { (*this).aimRotX as libc::c_int } as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_DiveAttack(mut this: *mut EnCrow,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut facingPlayer: s32 = 0;
    ...
    if facingPlayer != 0 {
        ...
        pos.y = (*player).actor.world.pos.y + 20.0f32;
        pos.z = (*player).actor.world.pos.z;
        target = Actor_WorldPitchTowardPoint(&mut (*this).actor, &mut pos);
        if target as libc::c_int > 0x3000 as libc::c_int {
            target = 0x3000 as libc::c_int as s16
        }
        Math_ApproachS(&mut (*this).actor.shape.rot.x, target,
                       2 as libc::c_int as s16, 0x400 as libc::c_int as s16);
    } else {
        Math_ApproachS(&mut (*this).actor.shape.rot.x,
                       -(0x1000 as libc::c_int) as s16,
                       2 as libc::c_int as s16, 0x100 as libc::c_int as s16);
    }
    if facingPlayer != 0 || (*this).actor.xzDistToPlayer > 80.0f32 {
        Math_ApproachS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       4 as libc::c_int as s16, 0xc00 as libc::c_int as s16);
    }
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           Player_GetMask(globalCtx) as libc::c_int ==
               PLAYER_MASK_SKULL as libc::c_int ||
           ...
           (*this).actor.bgCheckFlags as libc::c_int & 9 as libc::c_int != 0
           ||
           (*player).stateFlags1 & 0x800000 as libc::c_int as libc::c_uint !=
               0 || (*this).actor.yDistToWater > -40.0f32 {
        if (*this).collider.base.atFlags as libc::c_int &
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x38b7 as libc::c_int as u16_0);
        }
        EnCrow_SetupFlyIdle(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Damaged(mut this: *mut EnCrow,
                                        mut globalCtx: *mut GlobalContext) {
        ...
        if (*this).actor.colorFilterParams as libc::c_int &
            ...
            (*this).actor.shape.rot.z =
                ((*this).actor.shape.rot.z as libc::c_int +
                     0x1780 as libc::c_int) as s16
        }
        if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0
               || (*this).actor.floorHeight == -32000.0f32 {
            EffectSsDeadDb_Spawn(globalCtx, &mut (*this).actor.world.pos,
                                 &mut sZeroVecAccel, &mut sZeroVecAccel,
                                 ((*this).actor.scale.x * 10000.0f32) as s16,
                                 0 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Die(mut this: *mut EnCrow,
                                    mut globalCtx: *mut GlobalContext) {
    let mut step: f32_0 = 0.;
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        step = 0.006f32
    } else { step = 0.002f32 }
    if Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, step) != 0 {
        if (*this).actor.params as libc::c_int == 0 as libc::c_int {
            sDeathCount = sDeathCount.wrapping_add(1);
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_TurnAway(mut this: *mut EnCrow,
                                         mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        (*this).aimRotY = (*this).actor.wallYaw
    ...
    Math_ApproachS(&mut (*this).actor.shape.rot.y, (*this).aimRotY,
                   3 as libc::c_int as s16, 0xc00 as libc::c_int as s16);
    Math_ApproachS(&mut (*this).actor.shape.rot.x, (*this).aimRotX,
                   5 as libc::c_int as s16, 0x100 as libc::c_int as s16);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        EnCrow_SetupFlyIdle(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Respawn(mut this: *mut EnCrow,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        ...
        if Math_StepToF(&mut (*this).actor.scale.x, target, target * 0.1f32)
               != 0 {
            (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_UpdateDamage(mut this: *mut EnCrow,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCrow = thisx as *mut EnCrow;
    let mut pad: f32_0 = 0.;
    ...
    if (*this).actionFunc !=
           Some(EnCrow_Respawn as
                    unsafe extern "C" fn(_: *mut EnCrow,
                                         _: *mut GlobalContext) -> ()) {
        if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int
           {
            height = 20.0f32 * scale;
            func_8002D97C(&mut (*this).actor);
        } else { height = 0.0f32; Actor_MoveForward(&mut (*this).actor); }
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor,
                                12.0f32 * scale, 25.0f32 * scale,
                                50.0f32 * scale, 7 as libc::c_int);
    } else { height = 0.0f32 }
    (*(*this).collider.elements.offset(0 as libc::c_int as
    ...
    (*(*this).collider.elements.offset(0 as libc::c_int as
        ...
        ((*this).actor.world.pos.y + height) as s16;
    (*(*this).collider.elements.offset(0 as libc::c_int as
    ...
    Actor_SetFocus(&mut (*this).actor, height);
    if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int &&
           Animation_OnFrame(&mut (*this).skelAnime, 3.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3897 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_OverrideLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
        ...
        if limbIndex == 7 as libc::c_int {
            (*rot).y =
                ((*rot).y as libc::c_float +
                     0xc00 as libc::c_int as libc::c_float *
                         sinf((*this).skelAnime.curFrame *
                                  (3.14159265358979323846f32 /
                                       4 as libc::c_int as libc::c_float))) as
                    s16
        } else if limbIndex == 8 as libc::c_int {
            (*rot).y =
                ((*rot).y as libc::c_float +
                     0x1400 as libc::c_int as libc::c_float *
                         sinf(((*this).skelAnime.curFrame + 2.5f32) *
                                  (3.14159265358979323846f32 /
                                       4 as libc::c_int as libc::c_float))) as
                    s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnCrow_PostLimbDraw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut limbIndex: s32,
                                             mut dList: *mut *mut Gfx,
                                             mut rot: *mut Vec3s,
    ...
    if limbIndex == 2 as libc::c_int {
        Matrix_MultVec3f(&mut sHeadVec,
                         &mut *(*this).bodyPartsPos.as_mut_ptr().offset(0 as
                                                                            libc::c_int
                                                                            as
                                                                            isize));
        (*this).bodyPartsPos[0 as libc::c_int as usize].y -= 20.0f32
    } else if limbIndex == 4 as libc::c_int || limbIndex == 6 as libc::c_int
        ...
        vec =
            &mut *(*this).bodyPartsPos.as_mut_ptr().offset(((limbIndex >>
                                                               ...
                                                               as isize) as
                *mut Vec3f;
        Matrix_MultVec3f(&mut sZeroVecAccel, vec);
        (*vec).y -= 20.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnCrow_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnCrow = thisx as *mut EnCrow;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnCrow_OverrideLimbDraw as
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(0x58 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
