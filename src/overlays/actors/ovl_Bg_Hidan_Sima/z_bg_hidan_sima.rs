...
extern "C" {
    ...
    #[no_mangle]
    static mut gFireTempleStonePlatform1DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStonePlatform2DL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleFireballDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTempleStonePlatform2Col: CollisionHeader;
    #[no_mangle]
    static mut gFireTempleStonePlatform1Col: CollisionHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanSima {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHidanSimaActionFunc,
    pub timer: s16,
    pub collider: ColliderJntSph,
    pub elements: [ColliderJntSphElement; 2],
}
pub type BgHidanSimaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanSima, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Hidan_Sima_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_SIMA as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_HIDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHidanSima>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSima_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSima_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSima_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanSima_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanSima_Init(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanSima = thisx as *mut BgHidanSima;
    let mut pad: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        CollisionHeader_GetVirtual(&mut gFireTempleStonePlatform1Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    } else {
        CollisionHeader_GetVirtual(&mut gFireTempleStonePlatform2Col as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
    }
    (*this).dyna.bgId =
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[ColliderJntSphElementInit; 2]>() as
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_8088E518 as
                     unsafe extern "C" fn(_: *mut BgHidanSima,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(func_8088E760 as
                     unsafe extern "C" fn(_: *mut BgHidanSima,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSima_Destroy(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanSima = thisx as *mut BgHidanSima;
...
#[no_mangle]
pub unsafe extern "C" fn func_8088E518(mut this: *mut BgHidanSima,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                 (*this).dyna.actor.home.pos.y, 3.4f32);
    if func_8004356C(&mut (*this).dyna) != 0 &&
           (*player).stateFlags1 & 0x6000 as libc::c_int as libc::c_uint == 0
       {
        ...
        if (*this).dyna.actor.home.pos.y <= (*this).dyna.actor.world.pos.y {
            (*this).actionFunc =
                Some(func_8088E5D0 as
                         unsafe extern "C" fn(_: *mut BgHidanSima,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(func_8088E6D0 as
                         unsafe extern "C" fn(_: *mut BgHidanSima,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8088E5D0(mut this: *mut BgHidanSima,
                                       mut globalCtx: *mut GlobalContext) {
        ...
        (*this).dyna.actor.world.pos.x =
            Math_SinS(((*this).dyna.actor.world.rot.y as libc::c_int +
                           (*this).timer as libc::c_int *
                               0x4000 as libc::c_int) as s16) * 5.0f32 +
    ...
    if (*this).timer as libc::c_int % 4 as libc::c_int == 0 {
        func_800AA000((*this).dyna.actor.xyzDistToPlayerSq,
                      180 as libc::c_int as u8_0, 10 as libc::c_int as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_8088E6D0(mut this: *mut BgHidanSima,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8004356C(&mut (*this).dyna) != 0 {
        (*this).timer = 20 as libc::c_int as s16
    ...
    Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                 (*this).dyna.actor.home.pos.y - 100.0f32, 1.7f32);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_8088E518 as
                     unsafe extern "C" fn(_: *mut BgHidanSima,
...
#[no_mangle]
pub unsafe extern "C" fn func_8088E760(mut this: *mut BgHidanSima,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).dyna.actor.world.rot.y =
        ...
        (*this).actionFunc =
            Some(func_8088E7A8 as
                     unsafe extern "C" fn(_: *mut BgHidanSima,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8088E7A8(mut this: *mut BgHidanSima,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).dyna.actor.world.rot.y as libc::c_int !=
        ...
        temp =
            (sinf((((60 as libc::c_int - (*this).timer as libc::c_int) as
                        libc::c_double * 0.01667f64 - 0.5f64) *
                       3.14159265358979323846f32 as libc::c_double) as f32_0)
                 + 1 as libc::c_int as libc::c_float) *
                200 as libc::c_int as libc::c_float
    } else {
        temp =
            (sinf((((*this).timer as libc::c_int as libc::c_double *
                        0.01667f64 - 0.5f64) *
                       3.14159265358979323846f32 as libc::c_double) as f32_0)
                 + 1 as libc::c_int as libc::c_float) *
                -(200 as libc::c_int) as libc::c_float
    ...
    (*this).dyna.actor.world.pos.x =
        Math_SinS((*this).dyna.actor.world.rot.y) * temp +
            (*this).dyna.actor.home.pos.x;
    (*this).dyna.actor.world.pos.z =
        Math_CosS((*this).dyna.actor.world.rot.y) * temp +
            (*this).dyna.actor.home.pos.z;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).timer = 20 as libc::c_int as s16;
        (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn func_8088E90C(mut this: *mut BgHidanSima) {
    let mut elem: *mut ColliderJntSphElement =
    ...
    while i < 2 as libc::c_int {
        ...
        (*elem).dim.worldSphere.center.x =
            ((*this).dyna.actor.world.pos.x +
                 sin *
                     (*elem).dim.modelSphere.center.z as libc::c_int as
                         libc::c_float) as s16;
        (*elem).dim.worldSphere.center.y =
            ((*this).dyna.actor.world.pos.y as s16 as libc::c_int +
                 (*elem).dim.modelSphere.center.y as libc::c_int) as s16;
        (*elem).dim.worldSphere.center.z =
            ((*this).dyna.actor.world.pos.z +
                 cos *
                     (*elem).dim.modelSphere.center.z as libc::c_int as
                         libc::c_float) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanSima_Update(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHidanSima = thisx as *mut BgHidanSima;
    let mut pad: s32 = 0;
    ...
    if (*this).dyna.actor.params as libc::c_int != 0 as libc::c_int {
        let mut temp: s32 =
            if (*this).dyna.actor.world.rot.y as libc::c_int ==
                ...
                (*this).timer as libc::c_int
            } else { ((*this).timer as libc::c_int) + 80 as libc::c_int };
        if (*this).actionFunc ==
               Some(func_8088E7A8 as
                        unsafe extern "C" fn(_: *mut BgHidanSima,
                                             _: *mut GlobalContext) -> ()) {
            temp += 20 as libc::c_int
        }
        (*this).dyna.actor.world.pos.y =
            (*this).dyna.actor.home.pos.y -
                (1.0f32 -
                     cosf(temp as libc::c_float *
...
#[no_mangle]
pub unsafe extern "C" fn func_8088EB54(mut globalCtx: *mut GlobalContext,
                                       mut this: *mut BgHidanSima,
                                       mut gfx: *mut Gfx) -> *mut Gfx {
    let mut mtxF: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut phi_s5: s32 = 0;
    let mut s3: s32 = 0;
    let mut v0: s32 = 0;
    let mut cos: f32_0 = 0.;
    let mut sin: f32_0 = 0.;
    let mut pad: [s32; 2] = [0; 2];
    Matrix_MtxFCopy(&mut mtxF, &mut gMtxFClear);
    cos =
        Math_CosS(((*this).dyna.actor.world.rot.y as libc::c_int +
                       0x8000 as libc::c_int) as s16);
    sin =
        Math_SinS(((*this).dyna.actor.world.rot.y as libc::c_int +
                       0x8000 as libc::c_int) as s16);
    phi_s5 =
        60 as libc::c_int - (*this).timer as libc::c_int >> 1 as libc::c_int;
    phi_s5 =
        if phi_s5 > 3 as libc::c_int { 3 as libc::c_int } else { phi_s5 };
    v0 =
        3 as libc::c_int - ((*this).timer as libc::c_int >> 1 as libc::c_int);
    v0 = if v0 < 0 as libc::c_int { 0 as libc::c_int } else { v0 };
    mtxF.c2rust_unnamed.xw =
        (*this).dyna.actor.world.pos.x +
            (79 as libc::c_int -
                 (*this).timer as libc::c_int % 6 as libc::c_int *
                     4 as libc::c_int + v0 * 25 as libc::c_int) as
                libc::c_float * sin;
    mtxF.c2rust_unnamed.zw =
        (*this).dyna.actor.world.pos.z +
            (79 as libc::c_int -
                 (*this).timer as libc::c_int % 6 as libc::c_int *
                     4 as libc::c_int + v0 * 25 as libc::c_int) as
                libc::c_float * cos;
    mtxF.c2rust_unnamed.yw = (*this).dyna.actor.world.pos.y + 40.0f32;
    mtxF.c2rust_unnamed.zz = v0 as libc::c_float * 0.4f32 + 1.0f32;
    mtxF.c2rust_unnamed.yy = v0 as libc::c_float * 0.4f32 + 1.0f32;
    mtxF.c2rust_unnamed.xx = v0 as libc::c_float * 0.4f32 + 1.0f32;
    s3 = v0;
    while s3 < phi_s5 {
        mtxF.c2rust_unnamed.xw += 25.0f32 * sin;
        mtxF.c2rust_unnamed.zw += 25.0f32 * cos;
        mtxF.c2rust_unnamed.xx += 0.4f32;
        mtxF.c2rust_unnamed.yy += 0.4f32;
        mtxF.c2rust_unnamed.zz += 0.4f32;
        let fresh0 = gfx;
        gfx = gfx.offset(1);
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((sFireballsTexs[(((*this).timer as libc::c_int + s3) %
                                            7 as libc::c_int) as usize] as
                            u32_0) << 4 as libc::c_int >> 28 as libc::c_int)
                          as
                          usize].wrapping_add(sFireballsTexs[(((*this).timer
                                                                   as
                                                                   libc::c_int
                                                                   + s3) %
                                                                  7 as
        ...
        (*_g_0).words.w0 =
            (0xda as libc::c_int as u32_0 &
                ...
                (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            Matrix_MtxFToMtx(Matrix_CheckFloats(&mut mtxF,
                                                b"../z_bg_hidan_sima.c\x00" as
                                                    *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = gFireTempleFireballDL.as_mut_ptr() as libc::c_uint;
        s3 += 1
    }
    mtxF.c2rust_unnamed.xw =
        (*this).dyna.actor.world.pos.x +
            (phi_s5 * 25 as libc::c_int + 80 as libc::c_int) as libc::c_float
                * sin;
    mtxF.c2rust_unnamed.zw =
        (*this).dyna.actor.world.pos.z +
            (phi_s5 * 25 as libc::c_int + 80 as libc::c_int) as libc::c_float
    ...
    (*_g_2).words.w1 =
        gSegments[((sFireballsTexs[(((*this).timer as libc::c_int + s3) %
                                        7 as libc::c_int) as usize] as u32_0)
                       << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sFireballsTexs[(((*this).timer as
                                                               libc::c_int +
                                                               s3) %
                                                              7 as
                                                                  libc::c_int)
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = gFireTempleFireballDL.as_mut_ptr() as libc::c_uint;
    return gfx;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanSima_Draw(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHidanSima = thisx as *mut BgHidanSima;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_sima.c\x00" as *const u8 as
                        *const libc::c_char, 641 as libc::c_int);
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gFireTempleStonePlatform1DL.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gFireTempleStonePlatform2DL.as_mut_ptr() as libc::c_uint;
        if (*this).actionFunc ==
               Some(func_8088E7A8 as
                        unsafe extern "C" fn(_: *mut BgHidanSima,
                                             _: *mut GlobalContext) -> ()) {
            ...
            (*_g_3).words.w1 =
                (255 as libc::c_int as u32_0 &
                    ...
                    (255 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*__gfxCtx).polyXlu.p =
                func_8088EB54(globalCtx, this, (*__gfxCtx).polyXlu.p)
        }
    }
