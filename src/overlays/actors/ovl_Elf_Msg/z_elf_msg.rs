...
pub type EnElfUnkFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnElf, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Elf_Msg_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ELF_MSG as libc::c_int as s16,
                          category:
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_SetupAction(mut this: *mut ElfMsg,
                                            mut actionFunc:
                                                ElfMsgActionFunc) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_KillCheck(mut this: *mut ElfMsg,
                                          mut globalCtx: *mut GlobalContext)
 -> s32 {
    if (*this).actor.world.rot.y as libc::c_int > 0 as libc::c_int &&
           ((*this).actor.world.rot.y as libc::c_int) < 0x41 as libc::c_int &&
           Flags_GetSwitch(globalCtx,
                           (*this).actor.world.rot.y as libc::c_int -
                               1 as libc::c_int) != 0 {
        LogUtils_LogThreadId(b"../z_elf_msg.c\x00" as *const u8 as
                                 *const libc::c_char,
                             161 as libc::c_int); // "Mutual destruction"
        osSyncPrintf(b"\"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\" = %s\n\x00" as
                         *const u8 as *const libc::c_char,
                     b"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\x00" as *const u8
                         as *const libc::c_char); // "Mutual destruction"
        ...
        if (*this).actor.world.rot.y as libc::c_int == -(1 as libc::c_int) &&
               Flags_GetClear(globalCtx, (*this).actor.room as s32) != 0 {
            LogUtils_LogThreadId(b"../z_elf_msg.c\x00" as *const u8 as
                                     *const libc::c_char, 172 as libc::c_int);
            osSyncPrintf(b"\"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\" = %s\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"\xe5\x85\xb1\xe5\x80\x92\xe3\x82\x8c\x00" as
                             *const u8 as *const libc::c_char);
            if (*this).actor.params as libc::c_int >> 8 as libc::c_int &
                   0x3f as libc::c_int != 0x3f as libc::c_int {
                Flags_SetSwitch(globalCtx,
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ElfMsg = thisx as *mut ElfMsg;
    // "Conditions for Elf Tag disappearing"
    osSyncPrintf(b"\x1b[36m\n\xe3\x82\xa8\xe3\x83\xab\xe3\x83\x95 \xe3\x82\xbf\xe3\x82\xb0 \xe6\xb6\x88\xe3\x81\x88\xe3\x82\x8b\xe6\x9d\xa1\xe4\xbb\xb6 %d\x1b[m\n\x00"
                     as *const u8 as *const libc::c_char,
    ...
    if (*thisx).shape.rot.y as libc::c_int >= 0x41 as libc::c_int {
        // "Conditions for Elf Tag appearing"
        osSyncPrintf(b"\x1b[36m\n\xe3\x82\xa8\xe3\x83\xab\xe3\x83\x95 \xe3\x82\xbf\xe3\x82\xb0 \xe5\x87\xba\xe7\x8f\xbe\xe6\x9d\xa1\xe4\xbb\xb6 %d\x1b[m\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*thisx).shape.rot.y as libc::c_int -
                         0x41 as libc::c_int);
    }
    if ElfMsg_KillCheck(this, globalCtx) == 0 {
        Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
        if (*thisx).world.rot.x as libc::c_int == 0 as libc::c_int {
            (*thisx).scale.z = 0.4f32;
            (*thisx).scale.x = 0.4f32
        } else {
            (*thisx).scale.z =
                (*thisx).world.rot.x as libc::c_int as libc::c_float *
                    0.04f32;
            (*thisx).scale.x = (*thisx).scale.z
        }
        if (*thisx).world.rot.z as libc::c_int == 0 as libc::c_int {
            (*thisx).scale.y = 0.4f32
        } else {
            (*thisx).scale.y =
                (*thisx).world.rot.z as libc::c_int as libc::c_float * 0.04f32
        }
        if (*thisx).params as libc::c_int & 0x4000 as libc::c_int != 0 {
            ElfMsg_SetupAction(this,
                               Some(ElfMsg_CallNaviCuboid as
                                        unsafe extern "C" fn(_: *mut ElfMsg,
                                                             _:
                                                                 *mut GlobalContext)
                                            -> ()));
        } else {
            ElfMsg_SetupAction(this,
                               Some(ElfMsg_CallNaviCylinder as
                                        unsafe extern "C" fn(_: *mut ElfMsg,
                                                             _:
                                                                 *mut GlobalContext)
                                            -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_GetMessageId(mut this: *mut ElfMsg) -> s32 {
    // Negative message ID forces link to talk to Navi
    if (*this).actor.params as libc::c_int & 0x8000 as libc::c_int != 0 {
        return ((*this).actor.params as libc::c_int & 0xff as libc::c_int) +
                   0x100 as libc::c_int
    } else {
        return -(((*this).actor.params as libc::c_int & 0xff as libc::c_int) +
                     0x100 as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_CallNaviCuboid(mut this: *mut ElfMsg,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut navi: *mut EnElf = (*player).naviActor as *mut EnElf;
    if fabsf((*player).actor.world.pos.x - (*this).actor.world.pos.x) <
           100.0f32 * (*this).actor.scale.x &&
           (*this).actor.world.pos.y <= (*player).actor.world.pos.y &&
           (*player).actor.world.pos.y - (*this).actor.world.pos.y <
               100.0f32 * (*this).actor.scale.y &&
           fabsf((*player).actor.world.pos.z - (*this).actor.world.pos.z) <
               100.0f32 * (*this).actor.scale.z {
        (*player).naviTextId = ElfMsg_GetMessageId(this) as s16;
        (*navi).elfMsg = this
    };
}
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_WithinXZDistance(mut pos1: *mut Vec3f,
                                                 mut pos2: *mut Vec3f,
                                                 mut distance: f32_0) -> s32 {
    return (((*pos2).x - (*pos1).x) * ((*pos2).x - (*pos1).x) +
                ((*pos2).z - (*pos1).z) * ((*pos2).z - (*pos1).z) <
                distance * distance) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_CallNaviCylinder(mut this: *mut ElfMsg,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut navi: *mut EnElf = (*player).naviActor as *mut EnElf;
    if ElfMsg_WithinXZDistance(&mut (*player).actor.world.pos,
                               &mut (*this).actor.world.pos,
                               (*this).actor.scale.x * 100.0f32) != 0 &&
           (*this).actor.world.pos.y <= (*player).actor.world.pos.y &&
           (*player).actor.world.pos.y - (*this).actor.world.pos.y <
               100.0f32 * (*this).actor.scale.y {
        (*player).naviTextId = ElfMsg_GetMessageId(this) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ElfMsg = thisx as *mut ElfMsg;
    if ElfMsg_KillCheck(this, globalCtx) == 0 {
        ...
        if (*this).actor.world.rot.y as libc::c_int <= 0x41 as libc::c_int ||
               (*this).actor.world.rot.y as libc::c_int > 0x80 as libc::c_int
               ||
               Flags_GetSwitch(globalCtx,
                               (*this).actor.world.rot.y as libc::c_int -
                                   0x41 as libc::c_int) != 0 {
            (*this).actionFunc.expect("non-null function pointer")(this,
                                                                   globalCtx);
        }
    };
}
static mut D_809AD278: [Gfx; 8] =
    [Gfx{words:
             {
                 let mut init =
                     Gwords{w0:
...
// Initialized in run_static_initializers
static mut sCubeDL: [Gfx; 8] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 8];
// Initialized in run_static_initializers
static mut sCylinderDL: [Gfx; 16] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 16];
static mut sCylinderVtx: [Vtx; 16] =
    [Vtx{v:
             {
                 let mut init =
                     Vtx_t{ob:
...
#[no_mangle]
pub unsafe extern "C" fn ElfMsg_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_elf_msg.c\x00" as *const u8 as *const libc::c_char,
                    436 as libc::c_int);
    ...
    (*_g_1).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_elf_msg.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = D_809AD278.as_mut_ptr() as libc::c_uint;
    if (*thisx).params as libc::c_int & 0x4000 as libc::c_int != 0 {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = sCubeDL.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = sCylinderDL.as_mut_ptr() as libc::c_uint
    }
                                    ...
                                    (0x1 as libc::c_int as u32_0 &
                                        ...
                                        ((0 as libc::c_int + 8 as libc::c_int)
                                             ...
                                             (((0x1 as libc::c_int) <<
                                                 ...
                                                 libc::c_uint) <<
                                            1 as libc::c_int,
                                w1: sCubeVtx.as_mut_ptr() as libc::c_uint,};
                     init
                 },},
         Gfx{words:
                 {
