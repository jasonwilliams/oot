...
extern "C" {
    ...
    fn OnePointCutscene_Init(globalCtx: *mut GlobalContext, csId: s16,
     ...
     -> s16;
    #[no_mangle]
    static mut gLiftDL: [Gfx; 0];
    #[no_mangle]
    static mut gLiftCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaLift {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaLiftActionFunc,
    pub moveDelay: s16,
    pub isSpawned: u8_0,
    pub unk_16B: u8_0,
}
pub type BgJyaLiftActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaLift, _: *mut GlobalContext)
               -> ()>;
static mut sIsSpawned: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Bg_Jya_Lift_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_LIFT as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaLift_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaLift_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_InitDynapoly(mut this: *mut BgJyaLift,
                                                mut globalCtx:
                                                    *mut GlobalContext,
                                                mut collisionHeader:
                                                    *mut CollisionHeader,
    ...
    CollisionHeader_GetVirtual(collisionHeader as *mut libc::c_void,
                               &mut colHeader);
    (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJyaLift = thisx as *mut BgJyaLift;
    (*this).isSpawned = 0 as libc::c_int as u8_0;
    if sIsSpawned != 0 { Actor_Kill(thisx); return }
    // "Goddess lift CT"
    osSyncPrintf(b"\xe5\xa5\xb3\xe7\xa5\x9e\xe3\x83\xaa\xe3\x83\x95\xe3\x83\x88 CT\n\x00"
                     as *const u8 as *const libc::c_char);
    BgJyaLift_InitDynapoly(this, globalCtx, &mut gLiftCol,
    ...
    } else { BgJyaLift_SetInitPosY(this); }
    (*thisx).room = -(1 as libc::c_int) as s8;
    sIsSpawned = 1 as libc::c_int as s16;
    (*this).isSpawned = 1 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaLift = thisx as *mut BgJyaLift;
    if (*this).isSpawned != 0 {
        // "Goddess Lift DT"
        osSyncPrintf(b"\xe5\xa5\xb3\xe7\xa5\x9e\xe3\x83\xaa\xe3\x83\x95\xe3\x83\x88 DT\n\x00"
                         as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_SetInitPosY(mut this: *mut BgJyaLift) {
    (*this).actionFunc =
        Some(BgJyaLift_DelayMove as
                 unsafe extern "C" fn(_: *mut BgJyaLift,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y = 1613.0f32;
    (*this).moveDelay = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_DelayMove(mut this: *mut BgJyaLift,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
                           0x3f as libc::c_int) != 0 ||
           (*this).moveDelay as libc::c_int > 0 as libc::c_int {
        (*this).moveDelay += 1;
        if (*this).moveDelay as libc::c_int >= 20 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 3430 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_SetupMove(mut this: *mut BgJyaLift) {
    (*this).actionFunc =
        Some(BgJyaLift_Move as
                 unsafe extern "C" fn(_: *mut BgJyaLift,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_Move(mut this: *mut BgJyaLift,
                                        mut globalCtx: *mut GlobalContext) {
    let mut distFromBottom: f32_0 = 0.;
    let mut tempVelocity: f32_0 = 0.;
    Math_SmoothStepToF(&mut (*this).dyna.actor.velocity.y, 4.0f32, 0.1f32,
                       1.0f32, 0.0f32);
    tempVelocity =
        if (*this).dyna.actor.velocity.y < 0.2f32 {
            0.2f32
        } else { (*this).dyna.actor.velocity.y };
    distFromBottom =
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y, 973.0f32,
                           0.1f32, tempVelocity, 0.2f32);
    if (*this).dyna.actor.world.pos.y < 1440.0f32 &&
           1440.0f32 <= (*this).dyna.actor.prevPos.y {
        func_8005B1A4((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                  usize]);
    }
    if fabsf(distFromBottom) < 0.001f32 {
        BgJyaLift_SetFinalPosY(this);
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_SetFinalPosY(mut this: *mut BgJyaLift) {
    (*this).actionFunc = None;
    (*this).dyna.actor.world.pos.y = 973.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_Update(mut thisx: *mut Actor,
                                          mut globalCtx2:
                                              *mut GlobalContext) {
    let mut this: *mut BgJyaLift = thisx as *mut BgJyaLift;
    ...
    if (*this).dyna.unk_160 as libc::c_int & 4 as libc::c_int != 0 &&
           (*this).unk_16B as libc::c_int & 4 as libc::c_int ==
               0 as libc::c_int {
        Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                         usize],
                             CAM_SET_DIRECTED_YAW as libc::c_int as s16);
    } else if (*this).dyna.unk_160 as libc::c_int & 4 as libc::c_int ==
                  0 as libc::c_int &&
                  (*this).unk_16B as libc::c_int & 4 as libc::c_int != 0 &&
                  (*(*globalCtx).cameraPtrs[0 as libc::c_int as
                                                usize]).setting as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaLift_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gLiftDL.as_mut_ptr());
}
