...
pub struct ItemBHeart {
    pub actor: Actor,
    pub unk_14C: [libc::c_char; 12],
    pub unk_158: f32_0,
    pub unk_15C: [libc::c_char; 8],
    pub unk_164: s16,
    pub unk_166: [libc::c_char; 6],
}
#[no_mangle]
pub static mut Item_B_Heart_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_ITEM_B_HEART as libc::c_int as s16,
                          category: ACTORCAT_MISC as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_GI_HEARTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ItemBHeart>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemBHeart_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemBHeart_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemBHeart_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ItemBHeart_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ItemBHeart_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemBHeart = thisx as *mut ItemBHeart;
    if Flags_GetCollectible(globalCtx, 0x1f as libc::c_int) != 0 {
        Actor_Kill(&mut (*this).actor);
    } else {
        Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32, None, 0.8f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ItemBHeart_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ItemBHeart_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ItemBHeart = thisx as *mut ItemBHeart;
    ...
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        Flags_SetCollectible(globalCtx, 0x1f as libc::c_int);
        Actor_Kill(&mut (*this).actor);
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_HEART_CONTAINER_2 as libc::c_int, 30.0f32, 40.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B85264(mut this: *mut ItemBHeart,
                                       mut globalCtx: *mut GlobalContext) {
    let mut yOffset: f32_0 = 0.;
    (*this).unk_164 += 1;
    yOffset =
        Math_SinS(((*this).unk_164 as libc::c_int * 0x60c as libc::c_int) as
                      s16) * 5.0f32 + 20.0f32;
    Math_ApproachF(&mut (*this).actor.world.pos.y,
                   (*this).actor.home.pos.y + yOffset, 0.1f32,
                   (*this).unk_158);
    Math_ApproachF(&mut (*this).unk_158, 2.0f32, 1.0f32, 0.1f32);
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x400 as libc::c_int) as
            s16;
    Math_ApproachF(&mut (*this).actor.scale.x, 0.4f32, 0.1f32, 0.01f32);
    (*this).actor.scale.z = (*this).actor.scale.x;
    (*this).actor.scale.y = (*this).actor.scale.z;
}
#[no_mangle]
pub unsafe extern "C" fn ItemBHeart_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ItemBHeart = thisx as *mut ItemBHeart;
    let mut actorIt: *mut Actor = 0 as *mut Actor;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_item_b_heart.c\x00" as *const u8 as
    ...
    while !actorIt.is_null() {
        if (*actorIt).id as libc::c_int == ACTOR_DOOR_WARP1 as libc::c_int &&
               (*actorIt).projectedPos.z > (*this).actor.projectedPos.z {
            flag = 1 as libc::c_int as u8_0;
            break ;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gGiHeartBorderDL.as_mut_ptr() as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = gGiHeartContainerDL.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gGiHeartBorderDL.as_mut_ptr() as libc::c_uint;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = gGiHeartContainerDL.as_mut_ptr() as libc::c_uint
    }
