...
extern "C" {
    ...
    #[no_mangle]
    static mut gZelda2Eye07Tex: [u64_0; 0];
    #[no_mangle]
    static mut gZelda2Eye08Tex: [u64_0; 0];
    #[no_mangle]
    static mut gZelda2OcarinaDL: [Gfx; 0];
    #[no_mangle]
    static mut gZelda2Skel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_0003BC: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_000A50: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_000EB0: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_001010: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_0013A0: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_001670: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_001B48: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_0022D0: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_002750: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_002B14: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_002F30: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00325C: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_003538: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_004900: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_005F40: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_006778: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_007D0C: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_0087B8: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_0090D8: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_009AD4: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00A15C: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00A79C: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00AAD4: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00AFE0: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00B224: AnimationHeader;
    #[no_mangle]
    static mut gZelda2Anime1Anim_00B5FC: AnimationHeader;
}
...
pub struct EnZl2 {
    ...
    pub eyeTexIndex: s16,
    pub blinkTimer: s16,
    pub eyeTexIndex2: s16,
    pub unk_196: [libc::c_char; 2],
    pub mouthTexIndex: s16,
    pub unk_19A: [libc::c_char; 2],
    pub action: s32,
    pub drawConfig: s32,
    pub unk_1A4: [libc::c_char; 4],
    pub alpha: s32,
    pub unk_1AC: [s16; 24],
    pub unk_1DC: [s16; 24],
    pub unk_20C: [s16; 24],
    ...
    pub unk_250: s32,
    pub unk_254: s32,
    pub unk_258: [libc::c_char; 12],
    pub overrideLimbDrawConfig: s32,
    pub unk_268: [libc::c_char; 12],
    pub unk_274: s32,
    pub unk_278: f32_0,
    pub unk_27C: f32_0,
}
pub type EnZl2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext) -> ()>;
pub type EnZl2DrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const WARP_RED: C2RustUnnamed_20 = 10;
pub const WARP_GREEN: C2RustUnnamed_20 = 9;
pub const WARP_ORANGE: C2RustUnnamed_20 = 8;
pub const WARP_UNK_7: C2RustUnnamed_20 = 7;
pub const WARP_DESTINATION: C2RustUnnamed_20 = 6;
pub const WARP_BLUE_RUTO: C2RustUnnamed_20 = 5;
pub const WARP_YELLOW: C2RustUnnamed_20 = 4;
pub const WARP_PURPLE_CRYSTAL: C2RustUnnamed_20 = 3;
pub const WARP_SAGES: C2RustUnnamed_20 = 2;
pub const WARP_CLEAR_FLAG: C2RustUnnamed_20 = 1;
pub const WARP_DUNGEON_CHILD: C2RustUnnamed_20 = 0;
pub const WARP_DUNGEON_ADULT: C2RustUnnamed_20 = -1;
pub const WARP_BLUE_CRYSTAL: C2RustUnnamed_20 = -2;
static mut sEyeTextures: [*mut libc::c_void; 9] =
    unsafe {
        [gZelda2EyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
         ...
         gZelda2Eye07Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gZelda2Eye08Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
...
static mut sActionFuncs: [EnZl2ActionFunc; 36] =
    unsafe {
        [Some(func_80B521A0 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50BBC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50BEC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50C40 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50CA8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50CFC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50D50 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50D94 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50DE8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50E3C as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50E90 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50EE4 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50F38 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50F8C as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B50FE8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51034 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51080 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B510CC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51118 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51164 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B511B0 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B511FC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51250 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B512B8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51310 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51A5C as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51A8C as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51AE4 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51B44 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51BA8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51C0C as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51C64 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B51CA8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B52068 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B52098 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B52108 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ())]
    };
static mut sOverrideLimbDrawFuncs: [OverrideLimbDraw; 1] =
    unsafe {
        [Some(func_80B4F45C as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: s32,
                                       _: *mut *mut Gfx, _: *mut Vec3f,
                                       _: *mut Vec3s, _: *mut libc::c_void,
                                       _: *mut *mut Gfx) -> s32)]
    };
static mut sDrawFuncs: [EnZl2DrawFunc; 3] =
    unsafe {
        [Some(func_80B523BC as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B523C8 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ()),
         Some(func_80B525D4 as
                  unsafe extern "C" fn(_: *mut EnZl2, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub static mut En_Zl2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ZL2 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnZl2>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnZl2_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_UpdateEyes(mut this: *mut EnZl2) {
    let mut pad: [s32; 4] = [0; 4];
    let mut eyeTexIndex2: *mut s16 = &mut (*this).eyeTexIndex2;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4EA40(mut this: *mut EnZl2) {
    let mut eyeTexIndex: *mut s16 = &mut (*this).eyeTexIndex;
    let mut unk_27C: *mut f32_0 = &mut (*this).unk_27C;
    if *unk_27C < 3.0f32 {
        *eyeTexIndex = 0 as libc::c_int as s16
    } else if *unk_27C < 6.0f32 {
        *eyeTexIndex = 1 as libc::c_int as s16
    } else if *unk_27C < 9.0f32 {
        *eyeTexIndex = 2 as libc::c_int as s16
    } else {
        *eyeTexIndex = 5 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4EAF4(mut this: *mut EnZl2) {
    let mut eyeTexIndex: *mut s16 = &mut (*this).eyeTexIndex;
    let mut unk_27C: *mut f32_0 = &mut (*this).unk_27C;
    if *unk_27C < 2.0f32 {
        *eyeTexIndex = 5 as libc::c_int as s16
    } else if *unk_27C < 4.0f32 {
        *eyeTexIndex = 2 as libc::c_int as s16
    } else if *unk_27C < 6.0f32 {
        *eyeTexIndex = 1 as libc::c_int as s16
    } else { EnZl2_UpdateEyes(this); return }
    *unk_27C += 1.0f32;
    (*this).eyeTexIndex2 = *eyeTexIndex;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4EBB8(mut this: *mut EnZl2) {
    let mut eyeTexIndex: *mut s16 = &mut (*this).eyeTexIndex;
    let mut unk_27C: *mut f32_0 = &mut (*this).unk_27C;
    if *unk_27C < 2.0f32 {
        *eyeTexIndex = 0 as libc::c_int as s16
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4EC48(mut this: *mut EnZl2) {
    let mut eyeTexIndex: *mut s16 = &mut (*this).eyeTexIndex;
    let mut unk_27C: *mut f32_0 = &mut (*this).unk_27C;
    if *unk_27C < 2.0f32 {
        *eyeTexIndex = 2 as libc::c_int as s16
...
#[no_mangle]
pub unsafe extern "C" fn EnZl2_setEyesIndex(mut this: *mut EnZl2,
                                            mut index: s16) {
    (*this).eyeTexIndex = index;
    (*this).eyeTexIndex2 = (*this).eyeTexIndex;
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_setEyeIndex2(mut this: *mut EnZl2,
                                            mut index: s16) {
    (*this).eyeTexIndex2 = index;
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_setMouthIndex(mut this: *mut EnZl2,
                                             mut index: s16) {
    (*this).mouthTexIndex = index;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4ED2C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 30.0f32,
                            30.0f32, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_UpdateSkelAnime(mut this: *mut EnZl2) -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_GetNpcAction(mut globalCtx: *mut GlobalContext,
                                            mut idx: s32)
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4EDB8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, arg2);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4EE38(mut this: *mut EnZl2, mut arg1: s16,
                                       mut arg2: s32) {
    let mut phi_a3: s32 = 0;
    let mut temp_v1: s32 = 0;
    let mut phi_v0: s32 = arg2;
    if (*this).unk_24C != 0 as libc::c_int {
        temp_v1 =
            (arg1 as libc::c_int +
                 (*this).unk_1DC[phi_v0 as usize] as libc::c_int) as s16 as
                s32;
        phi_a3 =
            arg1 as libc::c_int -
                (*this).unk_20C[phi_v0 as usize] as libc::c_int;
        phi_v0 = (*this).unk_1AC[phi_v0 as usize] as s32;
        if fabsf(phi_a3 as f32_0) as s32 > 0x8000 as libc::c_int {
            if arg1 as libc::c_int > 0 as libc::c_int {
                phi_a3 -= 0x10000 as libc::c_int
            } else { phi_a3 += 0x10000 as libc::c_int }
        }
        if phi_a3 != 0 as libc::c_int {
            phi_v0 += (phi_a3 - phi_v0) / 16 as libc::c_int
        }
        if phi_v0 != 0 as libc::c_int { phi_v0 -= phi_v0 / 10 as libc::c_int }
        if (temp_v1 - arg1 as libc::c_int) as s16 as libc::c_int !=
               0 as libc::c_int {
            phi_v0 -=
                (temp_v1 - arg1 as libc::c_int) as s16 as libc::c_int /
                    50 as libc::c_int
        }
        temp_v1 += phi_v0;
        if (*this).unk_1AC[arg2 as usize] as libc::c_int * phi_v0 <=
               0 as libc::c_int &&
               (temp_v1 - arg1 as libc::c_int) as s16 as libc::c_int >
                   -(0x64 as libc::c_int) &&
               ((temp_v1 - arg1 as libc::c_int) as s16 as libc::c_int) <
        ...
        (*this).unk_1AC[arg2 as usize] = phi_v0 as s16;
        (*this).unk_1DC[arg2 as usize] =
            (temp_v1 - arg1 as libc::c_int) as s16
    }
    (*this).unk_20C[arg2 as usize] = arg1;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4EF64(mut this: *mut EnZl2, mut arg1: s16,
                                       mut arg2: s32) {
    let mut temp_t0: s32 = arg2;
    ...
    let mut unk_278: f32_0 = 0.;
    if temp_t0 == 2 as libc::c_int {
        phi_a0 = 0x3a98 as libc::c_int;
        phi_t1 = 0 as libc::c_int
    } else if temp_t0 == 5 as libc::c_int {
        phi_a0 = 0x32c8 as libc::c_int;
        phi_t1 = 3 as libc::c_int
    } else if temp_t0 == 8 as libc::c_int {
        phi_a0 = 0x2ee0 as libc::c_int;
        phi_t1 = 6 as libc::c_int
    } else if temp_t0 == 11 as libc::c_int {
        phi_a0 = 0x4000 as libc::c_int;
        phi_t1 = 9 as libc::c_int
    } else if temp_t0 == 14 as libc::c_int {
        phi_a0 = 0x4000 as libc::c_int;
        phi_t1 = 12 as libc::c_int
    } else if temp_t0 == 17 as libc::c_int {
        phi_a0 = 0x4000 as libc::c_int;
        phi_t1 = 15 as libc::c_int
    } else { phi_a0 = 0x4000 as libc::c_int; phi_t1 = 18 as libc::c_int }
    if (*this).unk_24C != 0 as libc::c_int {
        phi_v0 =
            (*this).unk_1DC[temp_t0 as usize] as libc::c_int +
                arg1 as libc::c_int;
        temp_v1 = (phi_v0 & 0xffff as libc::c_int) as s16 as s32;
        temp_t2 =
            arg1 as libc::c_int -
                (*this).unk_20C[temp_t0 as usize] as libc::c_int;
        phi_v0 = (*this).unk_1AC[temp_t0 as usize] as s32;
        if fabsf(temp_t2 as f32_0) as s32 > 0x8000 as libc::c_int {
            if arg1 as libc::c_int > 0 as libc::c_int {
                temp_t2 -= 0x10000 as libc::c_int
            } else { temp_t2 += 0x10000 as libc::c_int }
        }
        if phi_t1 >= 0 as libc::c_int {
            temp_t2 +=
                (if (*this).unk_1AC[phi_t1 as usize] as libc::c_int >=
                        0 as libc::c_int {
                     (*this).unk_1AC[phi_t1 as usize] as libc::c_int
                 } else {
                     -((*this).unk_1AC[phi_t1 as usize] as libc::c_int)
                 }) / 3 as libc::c_int
        }
        if temp_t2 != 0 as libc::c_int {
            phi_v0 += (temp_t2 - phi_v0) / 16 as libc::c_int
        }
        if phi_v0 != 0 as libc::c_int { phi_v0 -= phi_v0 / 10 as libc::c_int }
        if (temp_v1 - phi_a0) as s16 as libc::c_int != 0 as libc::c_int {
            phi_v0 -=
                (temp_v1 - phi_a0) as s16 as libc::c_int / 50 as libc::c_int
        }
        temp_v1 += phi_v0;
        if (*this).unk_1AC[arg2 as usize] as libc::c_int * phi_v0 <=
               0 as libc::c_int &&
               (temp_v1 - phi_a0) as s16 as libc::c_int >
                   -(0x64 as libc::c_int) &&
               ((temp_v1 - phi_a0) as s16 as libc::c_int) <
                   0x64 as libc::c_int {
            temp_v1 = phi_a0;
        ...
        if arg2 == 2 as libc::c_int {
            if (*this).action == 5 as libc::c_int ||
                   (*this).action == 30 as libc::c_int {
                curFrame = (*this).skelAnime.curFrame;
                unk_278 = (*this).unk_278;
                temp_t0 = (3500.0f32 * curFrame / unk_278) as s32 + phi_a0;
                if temp_t0 >= temp_v1 {
                    temp_v1 = temp_t0;
                    phi_v0 /= -(2 as libc::c_int)
                }
            } else if (*this).action == 6 as libc::c_int ||
                          (*this).action == 31 as libc::c_int {
                temp_t0 = phi_a0 + 0xdac as libc::c_int;
                if temp_t0 >= temp_v1 {
                    temp_v1 = temp_t0;
                    phi_v0 /= -(2 as libc::c_int)
                }
            } else if (*this).action == 20 as libc::c_int {
                temp_t0 = phi_a0 - 0x3e8 as libc::c_int;
                if temp_t0 >= temp_v1 {
                    temp_v1 = temp_t0;
                    phi_v0 /= -(2 as libc::c_int)
                }
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4F230(mut this: *mut EnZl2, mut arg1: s16,
                                       mut arg2: s32) {
    let mut temp_v1: s32 = 0;
    ...
    let mut phi_v0: s32 = 0;
    let mut index1AC: s32 = 0;
    let mut phi_t5: s32 = 0;
    if (*this).unk_24C != 0 as libc::c_int {
        temp_v1 =
            (*this).unk_1DC[arg2 as usize] as libc::c_int -
                arg1 as libc::c_int;
        temp_t0 = temp_v1 as s16;
        temp_t2 = temp_t0 as s32;
        temp_t3 = (*this).unk_1AC[arg2 as usize] as s32;
        phi_v0 = temp_t3;
        temp_t3 =
            arg1 as libc::c_int -
                (*this).unk_20C[arg2 as usize] as libc::c_int;
        if arg2 == 1 as libc::c_int {
            index1AC = 0 as libc::c_int;
            phi_t5 = (*this).unk_1AC[index1AC as usize] as s32
        } else if arg2 == 4 as libc::c_int {
            index1AC = 3 as libc::c_int;
            phi_t5 = (*this).unk_1AC[index1AC as usize] as s32
        } else if arg2 == 7 as libc::c_int {
            index1AC = 6 as libc::c_int;
            phi_t5 = (*this).unk_1AC[index1AC as usize] as s32
        } else if arg2 == 10 as libc::c_int {
            index1AC = 9 as libc::c_int;
            phi_t5 =
                if (*this).unk_1AC[index1AC as usize] as libc::c_int >=
                       0 as libc::c_int {
                    (*this).unk_1AC[index1AC as usize] as libc::c_int
                } else {
                    -((*this).unk_1AC[index1AC as usize] as libc::c_int)
                }
        } else if arg2 == 13 as libc::c_int {
            index1AC = 12 as libc::c_int;
            phi_t5 =
                if (*this).unk_1AC[index1AC as usize] as libc::c_int >=
                       0 as libc::c_int {
                    (*this).unk_1AC[index1AC as usize] as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4F45C(mut globalCtx: *mut GlobalContext,
                                       mut limbIndex: s32,
    ...
    let mut pad: s32 = 0;
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
    let mut sp74: *mut Mtx = 0 as *mut Mtx;
    let mut sp34: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut sp2C: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut pad2: s16 = 0;
    let mut unk_1DC: *mut s16 = (*this).unk_1DC.as_mut_ptr();
    if limbIndex == 14 as libc::c_int {
        ...
        *gfx = (*gfx).offset(1);
            ...
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xc as libc::c_int * 4 as libc::c_int) as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g).words.w1 = sp74 as libc::c_uint;
        Matrix_Push();
        ...
        Matrix_Translate(362.0f32, -133.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Get(&mut sp34);
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 0 as libc::c_int);
            func_80B4F230(this, sp2C.x, 1 as libc::c_int);
            func_80B4EF64(this, sp2C.z, 2 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(0 as libc::c_int as isize) as
                              libc::c_int +
                             ...
                             s16,
                         (*unk_1DC.offset(1 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(2 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-188.0f32, -184.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(0 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1056 as libc::c_int);
        Matrix_Get(&mut sp34);
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 3 as libc::c_int);
            func_80B4F230(this, sp2C.x, 4 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(3 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(4 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(5 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-410.0f32, -184.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(1 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1100 as libc::c_int);
        Matrix_Get(&mut sp34);
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 6 as libc::c_int);
            func_80B4F230(this, sp2C.x, 7 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(6 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(7 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(8 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-1019.0f32, -26.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(2 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1120 as libc::c_int);
        Matrix_Pop();
        Matrix_Push();
        ...
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 9 as libc::c_int);
            func_80B4F230(this, sp2C.x, 10 as libc::c_int);
            func_80B4EF64(this, sp2C.z, 11 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(9 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(10 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(11 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-427.0f32, -1.0f32, -3.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(3 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1145 as libc::c_int);
        Matrix_Get(&mut sp34);
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 12 as libc::c_int);
            func_80B4F230(this, sp2C.x, 13 as libc::c_int);
            func_80B4EF64(this, sp2C.z, 14 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(12 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(13 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(14 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-446.0f32, -52.0f32, 84.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(4 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1164 as libc::c_int);
        Matrix_Pop();
        Matrix_Push();
        Matrix_Translate(467.0f32, 265.0f32, -389.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 15 as libc::c_int);
            func_80B4F230(this, sp2C.x, 16 as libc::c_int);
            func_80B4EF64(this, sp2C.z, 17 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(15 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(16 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(17 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-427.0f32, -1.0f32, 3.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(5 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1189 as libc::c_int);
        Matrix_Get(&mut sp34);
        Matrix_MtxFToYXZRotS(&mut sp34, &mut sp2C, 0 as libc::c_int);
        if FrameAdvance_IsEnabled(globalCtx) == 0 {
            func_80B4EE38(this, sp2C.y, 18 as libc::c_int);
            func_80B4F230(this, sp2C.x, 19 as libc::c_int);
            func_80B4EF64(this, sp2C.z, 20 as libc::c_int);
        }
        Matrix_RotateZYX((*unk_1DC.offset(18 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(19 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
                                                    ...
                                                    usize] as libc::c_int) as
                             s16,
                         (*unk_1DC.offset(20 as libc::c_int as isize) as
                              libc::c_int +
                              (*gGameInfo).data[(27 as libc::c_int *
                                                     6 as libc::c_int *
                                                     16 as libc::c_int +
        ...
        Matrix_Translate(-446.0f32, -52.0f32, -84.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(&mut *sp74.offset(6 as libc::c_int as isize),
                     b"../z_en_zl2.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1208 as libc::c_int);
        Matrix_Pop();
        Matrix_Pop();
        (*this).unk_24C = 1 as libc::c_int
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void,
    ...
    if limbIndex == 10 as libc::c_int {
        if (*this).unk_254 != 0 as libc::c_int &&
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g).words.w1 = gZelda2OcarinaDL.as_mut_ptr() as libc::c_uint
        }
        let mut player: *mut Player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        Matrix_Push();
        if (*player).rightHandType as libc::c_int == 0xff as libc::c_int {
            Matrix_Put(&mut (*player).shieldMf);
            Matrix_Translate(180.0f32, 979.0f32, -375.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZYX(-(0x5de7 as libc::c_int) as s16,
                             -(0x53e9 as libc::c_int) as s16,
                             0x3333 as libc::c_int as s16,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(1.2f32, 1.2f32, 1.2f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            let fresh2 = *gfx;
            *gfx = (*gfx).offset(1);
            ...
            (*_g_0).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_zl2.c\x00" as *const u8 as
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_1).words.w1 = gZelda2OcarinaDL.as_mut_ptr() as libc::c_uint
        }
        Matrix_Pop();
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FCCC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut unk_274: s32 = (*this).unk_274;
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[unk_274 as usize].segment as
             *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize)) as
            u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FD00(mut this: *mut EnZl2,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4FD90(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00B5FC,
                  0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
    (*this).action = 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FDD4(mut this: *mut EnZl2) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B4FE10(mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).csCtx.frames as libc::c_int >= 830 as libc::c_int &&
           ((*globalCtx).csCtx.frames as libc::c_int) < 1081 as libc::c_int {
        func_800788CC((0x2898 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FE48(mut this: *mut EnZl2) {
    func_80078914(&mut (*this).actor.projectedPos,
                  (0x2886 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FE6C(mut this: *mut EnZl2) {
    func_80078914(&mut (*this).actor.projectedPos,
                  0x39c7 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FE90(mut this: *mut EnZl2) {
    func_80078914(&mut (*this).actor.projectedPos,
                  0x6878 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FEB4(mut this: *mut EnZl2) {
    func_80078914(&mut (*this).actor.projectedPos,
                  0x6879 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FED8(mut this: *mut EnZl2) {
    func_80078914(&mut (*this).actor.projectedPos,
                  0x6875 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_GiveLightArrows(mut this: *mut EnZl2,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut posX: f32_0 = 0.;
    let mut posY: f32_0 = 0.;
    let mut posZ: f32_0 = 0.;
    if (*this).unk_244 == 0 as libc::c_int {
        player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        posX = (*player).actor.world.pos.x;
        posY = (*player).actor.world.pos.y + 80.0f32;
        posZ = (*player).actor.world.pos.z;
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_DEMO_EFFECT as libc::c_int as s16, posX, posY, posZ,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 0x17 as libc::c_int as s16);
        Item_Give(globalCtx, ITEM_ARROW_LIGHT as libc::c_int as u8_0);
        (*this).unk_244 = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FF84(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut posX: f32_0 = 0.;
    let mut posY: f32_0 = 0.;
    let mut posZ: f32_0 = 0.;
    if (*this).unk_250 == 0 as libc::c_int {
        posX = (*this).actor.world.pos.x;
        posY = (*this).actor.world.pos.y;
        posZ = (*this).actor.world.pos.z;
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_DOOR_WARP1 as libc::c_int as s16, posX, posY, posZ,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16,
                    WARP_YELLOW as libc::c_int as s16);
        (*this).unk_250 = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B4FFF0(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut posX: f32_0 = 0.;
    let mut posY: f32_0 = 0.;
    let mut posZ: f32_0 = 0.;
    if (*this).unk_248 == 0 as libc::c_int {
        posX = (*this).actor.world.pos.x;
        posY =
        ...
        (*this).unk_248 = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5008C(mut this: *mut EnZl2) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B500E0(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B501C4(mut this: *mut EnZl2, mut alpha: s32) {
    if !(*this).actor.child.is_null() {
        (*((*this).actor.child as *mut DoorWarp1)).crystalAlpha =
            alpha as f32_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B501E8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    if !npcAction.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50260(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).action = 1 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50278(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    (*this).actor.world.pos.x = (*npcAction).startPos.x as f32_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50304(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut shape: *mut ActorShape = &mut (*this).actor.shape;
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    let mut actionXDelta: f32_0 = 0.;
    let mut actionZDelta: f32_0 = 0.;
    actionXDelta = ((*npcAction).endPos.x - (*npcAction).startPos.x) as f32_0;
    actionZDelta = ((*npcAction).endPos.z - (*npcAction).startPos.z) as f32_0;
    func_80B4FD00(this, &mut gZelda2Anime1Anim_0003BC,
    ...
    (*shape).rot.y =
        (Math_FAtan2F(actionXDelta, actionZDelta) *
             (0x8000 as libc::c_int as libc::c_float /
                  3.14159265358979323846f32)) as s16;
    (*this).actor.world.rot.y = (*shape).rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B503DC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    if !npcAction.is_null() &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80B5042C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_0022D0,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50488(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_002750,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B504D4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00325C,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    (*this).action = 7 as libc::c_int;
    (*this).drawConfig = 1 as libc::c_int;
    (*this).unk_27C = 0.0f32;
    EnZl2_setMouthIndex(this, 1 as libc::c_int as s16);
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5053C(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_003538,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
        (*this).action = 8 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50580(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_000A50,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B505D4(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_000EB0,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
        (*this).action = 10 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50618(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    EnZl2_GiveLightArrows(this, globalCtx);
    (*this).action = 11 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50644(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FF84(this, globalCtx);
    (*this).action = 12 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50670(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00B5FC,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B506C4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00AAD4,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    (*this).action = 14 as libc::c_int;
    (*this).drawConfig = 1 as libc::c_int;
    EnZl2_setEyesIndex(this, 4 as libc::c_int as s16);
    EnZl2_setMouthIndex(this, 2 as libc::c_int as s16);
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
    func_80B4FE90(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5073C(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_00AFE0,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
        (*this).action = 15 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50780(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_001670,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    (*this).action = 16 as libc::c_int;
    (*this).drawConfig = 1 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
    func_80B4FFF0(this, globalCtx);
    EnZl2_setEyesIndex(this, 3 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B507E8(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_001B48,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
        (*this).action = 17 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5082C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_002B14,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50880(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_002F30,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B508C8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_001010,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    (*this).action = 20 as libc::c_int;
    (*this).drawConfig = 1 as libc::c_int;
    EnZl2_setEyesIndex(this, 6 as libc::c_int as s16);
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50928(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_0013A0,
                      0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50970(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).action = 22 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50980(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B509A0(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    if !npcAction.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50A04(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    let mut newAction: s32 = 0;
    let mut unk_240: s32 = 0;
    if !npcAction.is_null() {
        newAction = (*npcAction).action as s32;
        unk_240 = (*this).unk_240;
        if newAction != unk_240 {
            match newAction {
                1 => { func_80B50260(this, globalCtx); }
                2 => { func_80B50278(this, globalCtx); }
                3 => { func_80B50304(this, globalCtx); }
                4 => { func_80B5042C(this, globalCtx); }
                5 => { func_80B504D4(this, globalCtx); }
                6 => { func_80B50580(this, globalCtx); }
                7 => { func_80B50618(this, globalCtx); }
                8 => { func_80B50670(this, globalCtx); }
                9 => { func_80B506C4(this, globalCtx); }
                10 => { func_80B50780(this, globalCtx); }
                11 => { func_80B5082C(this, globalCtx); }
                12 => { func_80B508C8(this, globalCtx); }
                13 => { func_80B50970(this, globalCtx); }
                14 => { func_80B50980(this, globalCtx); }
                15 => { func_80B50644(this, globalCtx); }
                _ => {
                    osSyncPrintf(b"En_Zl2_inAgain_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50BBC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B50A04(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B50BEC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50C40(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FDD4(this);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50CA8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50CFC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    func_80B4EA40(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50D50(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateSkelAnime(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50D94(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    func_80B4EAF4(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50DE8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50E3C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50E90(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50EE4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50F38(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50F8C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B50FE8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51034(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51080(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B510CC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51118(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51164(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B511B0(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE10(globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B511FC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateSkelAnime(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51250(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4FE48(this);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B512B8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateSkelAnime(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51310(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut child: *mut Actor = 0 as *mut Actor;
    if EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int).is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B5135C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00A15C,
                  0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
    (*this).action = 25 as libc::c_int;
    (*this).unk_254 = 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B513A8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut posX: f32_0 = 0.;
    let mut posY: f32_0 = 0.;
    ...
    if (*this).unk_250 == 0 as libc::c_int {
        ...
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16,
                    WARP_UNK_7 as libc::c_int as s16);
        (*this).unk_250 = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51418(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    EnZl2_UpdateEyes(this);
    if ((*globalCtx).csCtx.frames as libc::c_int) < 431 as libc::c_int {
        EnZl2_setMouthIndex(this, 1 as libc::c_int as s16);
    } else { EnZl2_setMouthIndex(this, 0 as libc::c_int as s16); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5146C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4EA40(this);
    EnZl2_setMouthIndex(this, 0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5149C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*globalCtx).csCtx.frames as libc::c_int) < 988 as libc::c_int {
        EnZl2_setEyesIndex(this, 7 as libc::c_int as s16);
        EnZl2_setEyeIndex2(this, 8 as libc::c_int as s16);
    } else { EnZl2_UpdateEyes(this); }
    EnZl2_setMouthIndex(this, 0 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B514F8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    EnZl2_UpdateEyes(this);
    if ((*globalCtx).csCtx.frames as libc::c_int) < 1190 as libc::c_int {
        EnZl2_setMouthIndex(this, 1 as libc::c_int as s16);
    } else { EnZl2_setMouthIndex(this, 0 as libc::c_int as s16); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B5154C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut csCtx: *mut CutsceneContext = 0 as *mut CutsceneContext;
    if (*this).skelAnime.mode as libc::c_int != 0 as libc::c_int {
        EnZl2_UpdateEyes(this);
    } else {
        csCtx = &mut (*globalCtx).csCtx;
        if ((*csCtx).frames as libc::c_int) < 0x5f0 as libc::c_int {
            func_80B4EBB8(this);
        } else if (*csCtx).frames as libc::c_int == 0x5f0 as libc::c_int {
            (*this).unk_27C = 0.0f32
        } else { func_80B4EC48(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B515C4(mut this: *mut EnZl2) {
    (*this).action = 25 as libc::c_int;
    (*this).drawConfig = 0 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B515D8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00A15C,
                  0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    func_80B4EDB8(this, globalCtx, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51644(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_0087B8,
                      0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51678(mut this: *mut EnZl2) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_007D0C,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B516D0(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_009AD4,
                      0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51704(mut this: *mut EnZl2) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_0090D8,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B5175C(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_006778,
                      0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51790(mut this: *mut EnZl2) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_005F40,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B517E0(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_002750,
                      0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
        (*this).action = 31 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51824(mut this: *mut EnZl2) {
    func_80B4FD00(this, &mut gZelda2Anime1Anim_0022D0,
                  2 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
    (*this).action = 30 as libc::c_int;
    (*this).drawConfig = 1 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_80B5187C(mut this: *mut EnZl2, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        func_80B4FD00(this, &mut gZelda2Anime1Anim_00A79C,
                      0 as libc::c_int as u8_0, -8.0f32, 0 as libc::c_int);
        (*this).unk_27C = 0.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B518C0(mut this: *mut EnZl2) {
    func_80B4FD00(this,
                  gSegments[((&mut gZelda2Anime1Anim_004900 as
                                  *mut AnimationHeader as u32_0) <<
                                 4 as libc::c_int >> 28 as libc::c_int) as
                                usize].wrapping_add(&mut gZelda2Anime1Anim_004900
                                                        as
                                                        *mut AnimationHeader
                                                        as u32_0 &
                                                        0xffffff as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51948(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    let mut newAction: s32 = 0;
    ...
    if !npcAction.is_null() {
        ...
        if newAction != unk_240 {
            match newAction {
                1 => { func_80B515C4(this); }
                2 => { func_80B515D8(this, globalCtx); }
                16 => { func_80B51678(this); }
                17 => { func_80B51704(this); }
                18 => { func_80B51790(this); }
                4 => { func_80B51824(this); }
                20 => { func_80B518C0(this); }
                21 => { func_80B513A8(this, globalCtx); }
                _ => {
                    osSyncPrintf(b"En_Zl2_inEnding_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
                                     as *const u8 as *const libc::c_char);
                }
            }
            (*this).unk_240 = newAction
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51A5C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B51948(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51A8C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51AE4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51B44(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51BA8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51C0C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51C64(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateSkelAnime(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51CA8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51D0C(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51D24(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut sfxId: u32_0 = 0;
    let mut skelAnime: *mut SkelAnime = &mut (*this).skelAnime;
    if Animation_OnFrame(skelAnime, 6.0f32) != 0 ||
           Animation_OnFrame(skelAnime, 0.0f32) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51DA4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    let mut thisPos: *mut Vec3f = &mut (*this).actor.world.pos;
    ...
    if !npcAction.is_null() {
        ...
        (*thisPos).y = (endY - startY) * someFloat + startY;
        (*thisPos).z = (endZ - startZ) * someFloat + startZ;
        if ((*npcAction).endFrame as libc::c_int) <
               (*globalCtx).csCtx.frames as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51EA8(mut this: *mut EnZl2) {
    (*this).action = 33 as libc::c_int;
    (*this).drawConfig = 0 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B51EBC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut shape: *mut ActorShape = &mut (*this).actor.shape;
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    ...
    (*this).actor.world.rot.y = (*shape).rot.y;
    func_80B4FD00(this, &mut gZelda2Anime1Anim_00B224,
                  0 as libc::c_int as u8_0, 0.0f32, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51F38(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    if !npcAction.is_null() {
        if (*globalCtx).csCtx.frames as libc::c_int - 8 as libc::c_int >=
               (*npcAction).endFrame as libc::c_int {
            func_80B4FD00(this, &mut gZelda2Anime1Anim_00B5FC,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B51FA8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnZl2_GetNpcAction(globalCtx, 0 as libc::c_int);
    ...
    if !npcAction.is_null() {
        ...
        if action != unk_240 {
            match action {
                1 => { func_80B51EA8(this); }
                2 => { func_80B51EBC(this, globalCtx); }
                14 => { Actor_Kill(&mut (*this).actor); }
                _ => {
                    osSyncPrintf(b"En_Zl2_inRunning_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
                                     as *const u8 as *const libc::c_char);
                }
            }
            (*this).unk_240 = action
...
#[no_mangle]
pub unsafe extern "C" fn func_80B52068(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B51FA8(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B52098(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B4FCCC(this, globalCtx);
    func_80B4ED2C(this, globalCtx);
    EnZl2_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80B52108(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80B52114(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    match (*this).actor.params as libc::c_int {
        1 => { func_80B5135C(this, globalCtx); }
        4 => { func_80B51D0C(this, globalCtx); }
        0 => { func_80B4FD90(this, globalCtx); }
        _ => {
...
#[no_mangle]
pub unsafe extern "C" fn func_80B521A0(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut objectCtx: *mut ObjectContext = &mut (*globalCtx).objectCtx;
    let mut bankIndex: s32 =
        Object_GetIndex(objectCtx, OBJECT_ZL2_ANIME1 as libc::c_int as s16);
    let mut pad2: s32 = 0;
    if bankIndex < 0 as libc::c_int {
        osSyncPrintf(b"\x1b[31mEn_Zl2_main_bank\xe3\x82\xa2\xe3\x83\x8b\xe3\x83\xa1\xe3\x83\xbc\xe3\x82\xb7\xe3\x83\xa7\xe3\x83\xb3\xe3\x81\xae\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x82\x92\xe8\xaa\xad\xe3\x82\x81\xe3\x81\xaa\xe3\x81\x84!!!!!!!!!!!!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        return
    }
    if Object_IsLoaded(objectCtx, bankIndex) != 0 {
        (*this).unk_274 = bankIndex;
        func_80B4FCCC(this, globalCtx);
        (*this).unk_278 =
            Animation_GetLastFrame(&mut gZelda2Anime1Anim_0022D0 as
...
#[no_mangle]
pub unsafe extern "C" fn EnZl2_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
    if (*this).action < 0 as libc::c_int ||
           (*this).action >= 0x24 as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn EnZl2_Init(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
    let mut shape: *mut ActorShape = &mut (*thisx).shape;
    let mut pad: s32 = 0;
    ...
    match (*thisx).params as libc::c_int {
        1 => { Audio_SetSoundBanksMute(0x6f as libc::c_int as u16_0); }
        4 => { gSaveContext.timer2State = 0 as libc::c_int as s16 }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZl2_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut pos: *mut Vec3f,
 ...
 -> s32 {
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
    if (*this).overrideLimbDrawConfig < 0 as libc::c_int ||
           (*this).overrideLimbDrawConfig > 0 as libc::c_int ||
           sOverrideLimbDrawFuncs[(*this).overrideLimbDrawConfig as
                                      usize].is_none() {
    ...
    return sOverrideLimbDrawFuncs[(*this).overrideLimbDrawConfig as
...
#[no_mangle]
pub unsafe extern "C" fn func_80B523BC(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80B523C8(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut eyeTexIndex: s16 = (*this).eyeTexIndex;
    let mut eyeTexIndex2: s16 = (*this).eyeTexIndex2;
    let mut eyeTex: *mut libc::c_void = sEyeTextures[eyeTexIndex as usize];
    let mut eyeTex2: *mut libc::c_void = sEyeTextures[eyeTexIndex2 as usize];
    let mut skelAnime: *mut SkelAnime = &mut (*this).skelAnime;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((eyeTex2 as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(eyeTex2 as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
    ...
    (*__gfxCtx).polyOpa.p =
        SkelAnime_DrawFlex(globalCtx, (*skelAnime).skeleton,
                           ...
                           Some(EnZl2_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B525D4(mut this: *mut EnZl2,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut eyeTexIndex: s16 = (*this).eyeTexIndex;
    let mut eyeTex: *mut libc::c_void = sEyeTextures[eyeTexIndex as usize];
...
#[no_mangle]
pub unsafe extern "C" fn EnZl2_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZl2 = thisx as *mut EnZl2;
