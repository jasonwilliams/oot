...
extern "C" {
    ...
    #[no_mangle]
    static mut object_reeba_Anim_0001E4: AnimationHeader;
    #[no_mangle]
    static mut object_reeba_Skel_001EE8: SkeletonHeader;
}
...
#[no_mangle]
pub static mut En_Reeba_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_REEBA as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_REEBA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnReeba>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnReeba_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnReeba_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnReeba = thisx as *mut EnReeba;
    let mut surfaceType: s32 = 0;
    (*this).actor.naviEnemyId = 0x47 as libc::c_int as u8_0;
    (*this).actor.targetMode = 3 as libc::c_int as s8;
    (*this).actor.gravity = -3.5f32;
    (*this).actor.focus.pos = (*this).actor.world.pos;
    SkelAnime_Init(globalCtx, &mut (*this).skelanime,
                   &mut object_reeba_Skel_001EE8,
                   &mut object_reeba_Anim_0001E4,
    ...
    if (*this).isBig != 0 {
        ...
        (*this).collider.dim.height = 45 as libc::c_int as s16;
        (*this).scale *= 1.5f32;
        osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x83\xaa\xe3\x83\xbc\xe3\x83\x90\xe3\x81\xbc\xe3\x81\x99\xe7\x99\xbb\xe5\xa0\xb4 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %f\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).scale as libc::c_double);
        (*this).actor.colChkInfo.health = 20 as libc::c_int as u8_0;
        (*this).collider.info.toucher.effect = 4 as libc::c_int as u8_0;
        (*this).collider.info.toucher.damage = 16 as libc::c_int as u8_0;
        Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                             &mut (*this).actor,
                             ACTORCAT_ENEMY as libc::c_int as u8_0);
    }
    (*this).unk_284 = (*this).scale * -27500.0f32;
    (*this).actor.shape.yOffset = (*this).unk_284;
    ActorShape_Init(&mut (*this).actor.shape, (*this).actor.shape.yOffset,
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 35.0f32, 60.0f32,
                            60.0f32, 0x1d as libc::c_int);
    surfaceType =
        func_80041D4C(&mut (*globalCtx).colCtx, (*this).actor.floorPoly,
                      (*this).actor.floorBgId as s32) as s32;
    if surfaceType != 4 as libc::c_int && surfaceType != 7 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).actionfunc =
        Some(func_80AE4F40 as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnReeba_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnReeba = thisx as *mut EnReeba;
    ...
    if !(*this).actor.parent.is_null() {
        ...
        if (*spawner).actor.update.is_some() {
            ...
            if (*this).isBig != 0 {
                (*spawner).bigLeever = 0 as *mut EnReeba;
                (*spawner).timer = 600 as libc::c_int as s16
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE4F40(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_reeba_Anim_0001E4 as
    ...
    let mut playerSpeed: s16 = 0;
    Animation_Change(&mut (*this).skelanime, &mut object_reeba_Anim_0001E4,
                     2.0f32, 0.0f32, frames,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    playerSpeed = fabsf((*player).linearVelocity) as s16;
    (*this).unk_278 =
        (20 as libc::c_int - playerSpeed as libc::c_int * 2 as libc::c_int) as
            s16;
    if ((*this).unk_278 as libc::c_int) < 0 as libc::c_int {
        (*this).unk_278 = 2 as libc::c_int as s16
    }
    if (*this).unk_278 as libc::c_int > 20 as libc::c_int {
        (*this).unk_278 = 20 as libc::c_int as s16
    }
    (*this).actor.flags &=
    ...
    if (*this).isBig != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39ee as libc::c_int as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3986 as libc::c_int as u16_0);
    }
    (*this).actionfunc =
        Some(func_80AE5054 as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE5054(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut playerLinearVel: f32_0 = 0.;
    ...
    if (*this).unk_278 as libc::c_int == 0 as libc::c_int {
        ...
        if (*this).actor.shape.yOffset < 0.0f32 {
                ...
                1 => {
                    (*this).actor.world.rot.y =
                        ((*this).actor.yawTowardsPlayer as libc::c_int as
                             libc::c_float + 800.0f32 * playerLinearVel) as
                            s16
                }
                2 | 3 => {
                    (*this).actor.world.rot.y =
                        ((*this).actor.yawTowardsPlayer as libc::c_int as
                             ...
                             ((*player).actor.shape.rot.y as libc::c_int -
                                 ...
                                 (playerLinearVel * 0.15f32)) as s16
                }
                4 => {
                    (*this).actor.world.rot.y =
                        ((*this).actor.yawTowardsPlayer as libc::c_int as
            ...
            if (*this).isBig != 0 {
                (*this).actionfunc =
                    Some(func_80AE538C as
                             unsafe extern "C" fn(_: *mut EnReeba,
                                                  _: *mut GlobalContext)
                                 -> ())
            } else {
                (*this).unk_272 = 130 as libc::c_int as s16;
                (*this).actor.speedXZ = Rand_ZeroFloat(4.0f32) + 6.0f32;
                (*this).actionfunc =
                    Some(func_80AE5270 as
                             unsafe extern "C" fn(_: *mut EnReeba,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5270(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    let mut surfaceType: s32 = 0;
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.shape.shadowScale < 12.0f32 {
        Math_ApproachF(&mut (*this).actor.shape.shadowScale, 12.0f32, 3.0f32,
                       1.0f32);
    }
    surfaceType =
        func_80041D4C(&mut (*globalCtx).colCtx, (*this).actor.floorPoly,
    ...
    if surfaceType != 4 as libc::c_int && surfaceType != 7 as libc::c_int {
        ...
        (*this).actionfunc =
            Some(func_80AE5688 as
                     unsafe extern "C" fn(_: *mut EnReeba,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).unk_272 as libc::c_int == 0 as libc::c_int ||
        ...
        (*this).actionfunc =
            Some(func_80AE5688 as
                     unsafe extern "C" fn(_: *mut EnReeba,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).unk_274 as libc::c_int == 0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x398a as libc::c_int as u16_0);
        (*this).unk_274 = 10 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE538C(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int |
             (1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
    (*this).actionfunc =
        Some(func_80AE53AC as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE53AC(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if surfaceType != 4 as libc::c_int && surfaceType != 7 as libc::c_int ||
        ...
        if (*this).actor.xzDistToPlayer < 70.0f32 &&
               (*this).unk_270 as libc::c_int == 0 as libc::c_int {
            (*this).unk_270 = 30 as libc::c_int as s16
        }
        speed =
            ((*this).actor.xzDistToPlayer - 20.0f32) /
                (Rand_ZeroOne() * 50.0f32 + 150.0f32);
        (*this).actor.speedXZ += speed * 1.8f32;
        if (*this).actor.speedXZ >= 3.0f32 { (*this).actor.speedXZ = 3.0f32 }
        if (*this).actor.speedXZ < -3.0f32 { (*this).actor.speedXZ = -3.0f32 }
        yawDiff =
            if (*this).unk_270 as libc::c_int == 0 as libc::c_int {
                (*this).actor.yawTowardsPlayer as libc::c_int
            } else { -((*this).actor.yawTowardsPlayer as libc::c_int) } as
                s16;
        yawDiff =
        ...
        yaw =
            if yawDiff as libc::c_int > 0 as libc::c_int {
                (yawDiff as libc::c_int as libc::c_float / 31.0f32) + 10.0f32
            } else {
                (yawDiff as libc::c_int as libc::c_float / 31.0f32) - 10.0f32
            } as s16;
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_float +
                 yaw as libc::c_int as libc::c_float * 2.0f32) as s16;
        if (*this).unk_274 as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x398a as libc::c_int as u16_0);
            (*this).unk_274 = 20 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE561C(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    Math_ApproachZeroF(&mut (*this).actor.speedXZ, 1.0f32, 0.3f32);
    if (*this).unk_272 as libc::c_int == 0 as libc::c_int {
        if (*this).isBig != 0 {
            (*this).actionfunc =
                Some(func_80AE538C as
                         unsafe extern "C" fn(_: *mut EnReeba,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5688(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_27E = 0 as libc::c_int as s16;
    ...
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int |
              (1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
    (*this).actionfunc =
        Some(func_80AE56E0 as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE56E0(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    Math_ApproachZeroF(&mut (*this).actor.shape.shadowScale, 1.0f32, 0.3f32);
    Math_ApproachZeroF(&mut (*this).actor.speedXZ, 0.1f32, 0.3f32);
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).unk_284 + 10.0f32 <= (*this).actor.shape.yOffset {
        if (*globalCtx).gameplayFrames.wrapping_rem(4 as libc::c_int as
                                                        libc::c_uint) ==
               0 as libc::c_int as libc::c_uint {
            Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
        ...
        Math_ApproachF(&mut (*this).actor.shape.yOffset, (*this).unk_284,
                       1.0f32, (*this).unk_288);
        Math_ApproachF(&mut (*this).unk_288, 300.0f32, 1.0f32, 5.0f32);
    } else { Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE57F0(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_276 = 14 as libc::c_int as s16;
    ...
    (*this).actionfunc =
        Some(func_80AE5854 as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE5854(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.speedXZ < 0.0f32 { (*this).actor.speedXZ += 1.0f32 }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE58EC(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).unk_278 = 14 as libc::c_int as s16;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.speedXZ = -8.0f32;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 27 as libc::c_int) as libc::c_uint;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int |
              (1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
    (*this).actionfunc =
        Some(func_80AE5938 as
                 unsafe extern "C" fn(_: *mut EnReeba, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE5938(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_278 as libc::c_int != 0 as libc::c_int {
        ...
        (*this).actor.speedXZ = 0.0f32;
        if (*this).unk_27E as libc::c_int == 4 as libc::c_int ||
               (*this).actor.colChkInfo.health as libc::c_int !=
                   0 as libc::c_int {
            if (*this).unk_27E as libc::c_int == 2 as libc::c_int {
                pos.x =
            ...
            (*this).unk_278 = 66 as libc::c_int as s16;
            (*this).actionfunc =
                Some(func_80AE5E48 as
                         unsafe extern "C" fn(_: *mut EnReeba,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).unk_278 = 30 as libc::c_int as s16;
            (*this).actionfunc =
                Some(func_80AE5A9C as
                         unsafe extern "C" fn(_: *mut EnReeba,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5A9C(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut scale: f32_0 = 0.;
    if (*this).unk_278 as libc::c_int != 0 as libc::c_int {
        if (*this).unk_27E as libc::c_int == 2 as libc::c_int &&
               (*this).unk_278 as libc::c_int & 0xf as libc::c_int ==
                   0 as libc::c_int {
            pos.x = (*this).actor.world.pos.x + Rand_CenteredFloat(20.0f32);
            pos.y = (*this).actor.world.pos.y + Rand_CenteredFloat(20.0f32);
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3989 as libc::c_int as u16_0);
        Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
        (*this).actionfunc =
            Some(func_80AE5C38 as
                     unsafe extern "C" fn(_: *mut EnReeba,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE5BC4(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.speedXZ = -8.0f32;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5C38(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut accel: Vec3f =
    ...
    if (*this).unk_278 as libc::c_int != 0 as libc::c_int {
        ...
        (*this).actor.speedXZ = 0.0f32;
        Math_ApproachZeroF(&mut (*this).scale, 0.1f32, 0.01f32);
        if (*this).scale < 0.01f32 {
            pos.x = (*this).actor.world.pos.x;
            pos.y = (*this).actor.world.pos.y;
            pos.z = (*this).actor.world.pos.z;
            velocity.y = 4.0f32;
            EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut velocity,
                                 &mut accel, 120 as libc::c_int as s16,
            ...
            if !(*this).actor.parent.is_null() {
                let mut spawner: *mut EnEncount1 =
                    (*this).actor.parent as *mut EnEncount1;
                if (*spawner).actor.update.is_some() && (*this).isBig == 0 {
                    if ((*spawner).killCount as libc::c_int) <
                           10 as libc::c_int {
                        (*spawner).killCount += 1
                    }
                    // "How many are dead?"
                    osSyncPrintf(b"\n\n\x00" as *const u8 as
                                     *const libc::c_char);
                    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe4\xbd\x95\xe5\x8c\xb9\xef\xbc\xa4\xef\xbc\xa5\xef\xbc\xa1\xef\xbc\xa4\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86%d\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char,
                                 (*spawner).killCount as libc::c_int);
                    osSyncPrintf(b"\n\n\x00" as *const u8 as
                                     *const libc::c_char);
                }
                Actor_Kill(&mut (*this).actor);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5E48(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
    if ((*this).unk_278 as libc::c_int) < 37 as libc::c_int {
        (*this).actor.shape.rot.x = Rand_CenteredFloat(3000.0f32) as s16;
        (*this).actor.shape.rot.z = Rand_CenteredFloat(3000.0f32) as s16;
        if (*this).unk_278 as libc::c_int == 0 as libc::c_int {
            if (*this).isBig != 0 {
                (*this).actionfunc =
                    Some(func_80AE538C as
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE5EDC(mut this: *mut EnReeba,
                                       mut globalCtx: *mut GlobalContext) {
        ...
        if (*this).actionfunc !=
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            ...
            match (*this).actor.colChkInfo.damageEffect as libc::c_int {
                11 => {
                    // none
                    current_block_33 = 10836067035700167634;
                }
                12 => { current_block_33 = 10836067035700167634; }
                13 => { current_block_33 = 9969358685514762747; }
                14 => { current_block_33 = 17818566425257324576; }
                3 => {
                    // ice arrows/ice magic
                    Actor_ApplyDamage(&mut (*this).actor);
                    (*this).unk_27C = 2 as libc::c_int as s16;
                    (*this).unk_27E = 2 as libc::c_int as s16;
                    ...
                    (*this).actionfunc =
                        Some(func_80AE58EC as
                                 unsafe extern "C" fn(_: *mut EnReeba,
                                                      _: *mut GlobalContext)
                                     -> ());
                    current_block_33 = 7659304154607701039;
                }
                1 => {
                    // unknown
                    if (*this).unk_27E as libc::c_int != 4 as libc::c_int {
                        (*this).unk_27E = 4 as libc::c_int as s16;
                        Actor_SetColorFilter(&mut (*this).actor,
                                             0 as libc::c_int as s16,
                                             0xff as libc::c_int as s16,
                                             0 as libc::c_int as s16,
                ...
                _ => { current_block_33 = 7659304154607701039; }
            }
            match current_block_33 {
                10836067035700167634 =>
                // boomerang
                {
                    if (*this).actor.colChkInfo.health as libc::c_int >
                           1 as libc::c_int &&
                           (*this).unk_27E as libc::c_int != 4 as libc::c_int
                       {
                        (*this).unk_27E = 4 as libc::c_int as s16;
                        Audio_PlayActorSound2(&mut (*this).actor,
                        ...
                        (*this).actionfunc =
                            Some(func_80AE58EC as
                                     unsafe extern "C" fn(_: *mut EnReeba,
                                         ...
                                         -> ());
                        current_block_33 = 7659304154607701039;
                    } else { current_block_33 = 9969358685514762747; }
                }
                _ => { }
            }
            match current_block_33 {
                        ...
                        (*this).actionfunc =
                            Some(func_80AE58EC as
                                     unsafe extern "C" fn(_: *mut EnReeba,
                                         ...
                                         -> ());
                        current_block_33 = 7659304154607701039;
                    } else { current_block_33 = 17818566425257324576; }
                }
                _ => { }
            }
            match current_block_33 {
                17818566425257324576 => {
                    (*this).unk_27C = 6 as libc::c_int as s16;
                    Actor_ApplyDamage(&mut (*this).actor);
                    if (*this).actor.colChkInfo.health as libc::c_int ==
                           0 as libc::c_int {
                        Audio_PlayActorSound2(&mut (*this).actor,
                        ...
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x3988 as libc::c_int as u16_0);
                        (*this).actionfunc =
                            Some(func_80AE57F0 as
                                     unsafe extern "C" fn(_: *mut EnReeba,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnReeba_Update(mut thisx: *mut Actor,
    ...
    if (*this).collider.base.atFlags as libc::c_int &
        ...
        if (*this).actionfunc ==
                                                 ...
                                                 _: *mut GlobalContext) -> ())
           {
            (*this).actor.speedXZ = 8.0f32;
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_float * -1.0f32) as s16;
            (*this).unk_272 = 14 as libc::c_int as s16;
            (*this).actionfunc =
                Some(func_80AE561C as
                         unsafe extern "C" fn(_: *mut EnReeba,
                                              _: *mut GlobalContext) -> ());
            return
        }
    ...
    (*this).actor.focus.pos = (*this).actor.world.pos;
    if (*this).isBig == 0 {
        (*this).actor.focus.pos.y += 15.0f32
    } else { (*this).actor.focus.pos.y += 30.0f32 }
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
    if (*this).actor.shape.yOffset >= -700.0f32 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnReeba_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnReeba = thisx as *mut EnReeba;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_reeba.c\x00" as *const u8 as
    ...
    if (*gGameInfo).data[(25 as libc::c_int * 6 as libc::c_int *
           ...
           != 0 {
        let mut debugPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        debugPos.x =
            Math_SinS((*this).actor.world.rot.y) * 30.0f32 +
                (*this).actor.world.pos.x;
        debugPos.y = (*this).actor.world.pos.y + 20.0f32;
        debugPos.z =
            Math_CosS((*this).actor.world.rot.y) * 30.0f32 +
                (*this).actor.world.pos.z;
        DebugDisplay_AddObject(debugPos.x, debugPos.y, debugPos.z,
