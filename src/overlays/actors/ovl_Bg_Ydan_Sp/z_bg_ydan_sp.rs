...
extern "C" {
    ...
    fn OnePointCutscene_Init(globalCtx: *mut GlobalContext, csId: s16,
     ...
     -> s16;
    #[no_mangle]
    fn Player_IsBurningStickInRange(globalCtx: *mut GlobalContext,
                                    pos: *mut Vec3f, radius: f32_0,
                                    arg3: f32_0) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDTUnknownWebDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTWebWallDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTWebWallCol: CollisionHeader;
    #[no_mangle]
    static mut gDTWebFloorDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTWebFloorCol: CollisionHeader;
}
...
pub struct BgYdanSp {
    ...
    pub actionFunc: BgYdanSpActionFunc,
    pub isDestroyedSwitchFlag: u8_0,
    pub burnSwitchFlag: u8_0,
    pub timer: s16,
    pub unk16C: f32_0,
    pub trisCollider: ColliderTris,
    pub trisColliderItems: [ColliderTrisElement; 2],
}
pub type BgYdanSpActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgYdanSp, _: *mut GlobalContext)
               -> ()>;
pub const WEB_FLOOR: C2RustUnnamed_24 = 0;
pub const WEB_WALL: C2RustUnnamed_24 = 1;
pub type C2RustUnnamed_24 = libc::c_uint;
#[no_mangle]
pub static mut Bg_Ydan_Sp_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_YDAN_SP as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_YDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgYdanSp>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanSp_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanSp_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sTrisItemsInit: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
    ...
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sTrisItemsInit.as_ptr() as *mut _,};
            init
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgYdanSp = thisx as *mut BgYdanSp;
    let mut ti0: *mut ColliderTrisElementInit =
        &mut *sTrisItemsInit.as_mut_ptr().offset(0 as libc::c_int as isize) as
            *mut ColliderTrisElementInit;
    let mut tri: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut i: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut ti1: *mut ColliderTrisElementInit =
        &mut *sTrisItemsInit.as_mut_ptr().offset(1 as libc::c_int as isize) as
            *mut ColliderTrisElementInit;
    let mut cossY: f32_0 = 0.;
    let mut sinsY: f32_0 = 0.;
    let mut cossX: f32_0 = 0.;
    let mut nSinsX: f32_0 = 0.;
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
    (*this).isDestroyedSwitchFlag =
        ((*thisx).params as libc::c_int & 0x3f as libc::c_int) as u8_0;
    (*this).burnSwitchFlag =
        ((*thisx).params as libc::c_int >> 6 as libc::c_int &
    ...
    Collider_InitTris(globalCtx, &mut (*this).trisCollider);
    Collider_SetTris(globalCtx, &mut (*this).trisCollider,
                     &mut (*this).dyna.actor, &mut sTrisInit,
                     (*this).trisColliderItems.as_mut_ptr());
    if (*this).dyna.actor.params as libc::c_int == WEB_FLOOR as libc::c_int {
        CollisionHeader_GetVirtual(&mut gDTWebFloorCol as *mut CollisionHeader
                                       as *mut libc::c_void, &mut colHeader);
        (*this).actionFunc =
            Some(BgYdanSp_FloorWebIdle as
                     unsafe extern "C" fn(_: *mut BgYdanSp,
                                          _: *mut GlobalContext) -> ());
        i = 0 as libc::c_int;
        while i < 3 as libc::c_int {
            tri[i as usize].x =
                (*ti0).dim.vtx[i as usize].x + (*this).dyna.actor.world.pos.x;
            tri[i as usize].y =
                (*ti0).dim.vtx[i as usize].y + (*this).dyna.actor.world.pos.y;
            tri[i as usize].z =
                (*ti0).dim.vtx[i as usize].z + (*this).dyna.actor.world.pos.z;
            i += 1
        }
        Collider_SetTrisVertices(&mut (*this).trisCollider, 0 as libc::c_int,
                                 &mut *tri.as_mut_ptr().offset(0 as
                                                                   libc::c_int
                                                                   as isize),
                                 &mut *tri.as_mut_ptr().offset(1 as
                                                                   libc::c_int
                                                                   as isize),
                                 &mut *tri.as_mut_ptr().offset(2 as
                                                                   libc::c_int
                                                                   as isize));
        tri[1 as libc::c_int as usize].x = tri[0 as libc::c_int as usize].x;
        tri[1 as libc::c_int as usize].z = tri[2 as libc::c_int as usize].z;
        Collider_SetTrisVertices(&mut (*this).trisCollider, 1 as libc::c_int,
                                 &mut *tri.as_mut_ptr().offset(0 as
                                                                   libc::c_int
                                                                   as isize),
                                 &mut *tri.as_mut_ptr().offset(2 as
        ...
        CollisionHeader_GetVirtual(&mut gDTWebWallCol as *mut CollisionHeader
                                       as *mut libc::c_void, &mut colHeader);
        (*this).actionFunc =
            Some(BgYdanSp_WallWebIdle as
                     unsafe extern "C" fn(_: *mut BgYdanSp,
                                          _: *mut GlobalContext) -> ());
        Actor_SetFocus(&mut (*this).dyna.actor, 30.0f32);
        ...
        while i < 3 as libc::c_int {
            tri[i as usize].x =
                (*this).dyna.actor.world.pos.x +
                    cossY * (*ti1).dim.vtx[i as usize].x -
                    sinsY * (*ti1).dim.vtx[i as usize].y * nSinsX;
            tri[i as usize].y =
                (*this).dyna.actor.world.pos.y +
                    (*ti1).dim.vtx[i as usize].y * cossX;
            tri[i as usize].z =
                (*this).dyna.actor.world.pos.z -
                    sinsY * (*ti1).dim.vtx[i as usize].x +
                    (*ti1).dim.vtx[i as usize].y * cossY * nSinsX;
            i += 1
        }
        Collider_SetTrisVertices(&mut (*this).trisCollider, 0 as libc::c_int,
                                 &mut *tri.as_mut_ptr().offset(0 as
                                 ...
                                 &mut *tri.as_mut_ptr().offset(2 as
                                                                   libc::c_int
                                                                   as isize));
        tri[1 as libc::c_int as usize].x =
            (*this).dyna.actor.world.pos.x +
                cossY * (*ti1).dim.vtx[0 as libc::c_int as usize].x -
                (*ti1).dim.vtx[2 as libc::c_int as usize].y * sinsY * nSinsX;
        tri[1 as libc::c_int as usize].y =
            (*this).dyna.actor.world.pos.y +
                (*ti1).dim.vtx[2 as libc::c_int as usize].y * cossX;
        tri[1 as libc::c_int as usize].z =
            (*this).dyna.actor.world.pos.z -
                sinsY * (*ti1).dim.vtx[0 as libc::c_int as usize].x +
                (*ti1).dim.vtx[2 as libc::c_int as usize].y * cossY * nSinsX;
        Collider_SetTrisVertices(&mut (*this).trisCollider, 1 as libc::c_int,
                                 &mut *tri.as_mut_ptr().offset(0 as
                                                                   libc::c_int
                                                                   as isize),
    ...
    if Flags_GetSwitch(globalCtx, (*this).isDestroyedSwitchFlag as s32) != 0 {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgYdanSp = thisx as *mut BgYdanSp;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Collider_DestroyTris(globalCtx, &mut (*this).trisCollider);
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_UpdateFloorWebCollision(mut this:
                                                              *mut BgYdanSp) {
    let mut newY: s16 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    colHeader =
        gSegments[((&mut gDTWebFloorCol as *mut CollisionHeader as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(&mut gDTWebFloorCol as
                                              *mut CollisionHeader as u32_0 &
    ...
    newY =
        (((*this).dyna.actor.home.pos.y - (*this).dyna.actor.world.pos.y) *
             10 as libc::c_int as libc::c_float) as s16;
    (*(*colHeader).vtxList.offset(14 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(12 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(10 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(9 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(6 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(5 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(1 as libc::c_int as isize)).y = newY;
    (*(*colHeader).vtxList.offset(0 as libc::c_int as isize)).y = newY;
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_BurnWeb(mut this: *mut BgYdanSp,
                                          mut globalCtx: *mut GlobalContext) {
    (*this).timer = 30 as libc::c_int as s16;
    this = this;
    func_80078884(0x4802 as libc::c_int as u16_0);
    Flags_SetSwitch(globalCtx, (*this).isDestroyedSwitchFlag as s32);
    if (*this).dyna.actor.params as libc::c_int == WEB_FLOOR as libc::c_int {
        (*this).actionFunc =
            Some(BgYdanSp_BurnFloorWeb as
                     unsafe extern "C" fn(_: *mut BgYdanSp,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(BgYdanSp_BurnWallWeb as
                     unsafe extern "C" fn(_: *mut BgYdanSp,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_BurnFloorWeb(mut this: *mut BgYdanSp,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut accel: Vec3f =
        {
            let mut init = Vec3f{x: 0 as libc::c_int as f32_0, y: 0., z: 0.,};
            init
        };
    ...
    if (*this).timer as libc::c_int % 3 as libc::c_int == 0 as libc::c_int {
        rot2 =
            (Rand_ZeroOne() * 0x2aaa as libc::c_int as libc::c_float) as s16;
        velocity.y = 0.0f32;
        pos2.y = (*this).dyna.actor.world.pos.y;
        i = 0 as libc::c_int;
        while i < 6 as libc::c_int {
            rot =
                (Rand_CenteredFloat(0x2800 as libc::c_int as f32_0) +
                     rot2 as libc::c_int as libc::c_float) as s16;
            sins = Math_SinS(rot);
            coss = Math_CosS(rot);
            pos2.x = (*this).dyna.actor.world.pos.x + 120.0f32 * sins;
            pos2.z = (*this).dyna.actor.world.pos.z + 120.0f32 * coss;
            distXZ =
                Math_Vec3f_DistXZ(&mut (*this).dyna.actor.home.pos, &mut pos2)
                    * (1.0f32 / 120.0f32);
            if distXZ < 0.7f32 {
                sins =
                    Math_SinS((rot as libc::c_int + 0x8000 as libc::c_int) as
                                  s16);
                coss =
                    Math_CosS((rot as libc::c_int + 0x8000 as libc::c_int) as
                                  s16);
                pos2.x = (*this).dyna.actor.world.pos.x + 120.0f32 * sins;
                pos2.z = (*this).dyna.actor.world.pos.z + 120.0f32 * coss;
                distXZ =
                    Math_Vec3f_DistXZ(&mut (*this).dyna.actor.home.pos,
                                      &mut pos2) * (1.0f32 / 120.0f32)
            }
            velocity.x = 7.0f32 * sins * distXZ;
            velocity.y = 0.0f32;
            velocity.z = 7.0f32 * coss * distXZ;
            EffectSsDeadDb_Spawn(globalCtx, &mut (*this).dyna.actor.home.pos,
                                 ...
                                 0 as libc::c_int as s16,
                                 1 as libc::c_int as s16, 0xe as libc::c_int,
                                 1 as libc::c_int as s16);
            rot2 = (rot2 as libc::c_int + 0x2aaa as libc::c_int) as s16;
            i += 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_FloorWebBroken(mut this: *mut BgYdanSp,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_FloorWebBreaking(mut this: *mut BgYdanSp,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    ...
    static mut envColor: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 180 as libc::c_int as u8_0,
                            g: 180 as libc::c_int as u8_0,
                            b: 180 as libc::c_int as u8_0,
                            a: 255 as libc::c_int as u8_0,};
            init
        };
    ...
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    (*this).dyna.actor.world.pos.y =
        sinf((*this).timer as f32_0 *
                 (3.14159265358979323846f32 /
                      20 as libc::c_int as libc::c_float)) * (*this).unk16C +
    ...
    if (*this).dyna.actor.home.pos.y - (*this).dyna.actor.world.pos.y >
        ...
        Flags_SetSwitch(globalCtx, (*this).isDestroyedSwitchFlag as s32);
        (*this).actionFunc =
            Some(BgYdanSp_FloorWebBroken as
                     unsafe extern "C" fn(_: *mut BgYdanSp,
                                          _: *mut GlobalContext) -> ());
        pos.y = (*this).dyna.actor.world.pos.y - 60.0f32;
        rot = 0 as libc::c_int as s16;
        i = 0 as libc::c_int;
        while i < 6 as libc::c_int {
            pos.x = Math_SinS(rot) * 60.0f32 + (*this).dyna.actor.world.pos.x;
            pos.z = Math_CosS(rot) * 60.0f32 + (*this).dyna.actor.world.pos.z;
            func_8002829C(globalCtx, &mut pos, &mut zeroVec, &mut zeroVec,
                          &mut primColor, &mut envColor,
                          1000 as libc::c_int as s16,
                          10 as libc::c_int as s16);
            rot = (rot as libc::c_int + 0x2aaa as libc::c_int) as s16;
            i += 1
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_FloorWebIdle(mut this: *mut BgYdanSp,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut webPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sqrtFallDistance: f32_0 = 0.;
    let mut unk: f32_0 = 0.;
    player =
    ...
    webPos.y = (*this).dyna.actor.world.pos.y - 50.0f32;
    webPos.z = (*this).dyna.actor.world.pos.z;
    if Player_IsBurningStickInRange(globalCtx, &mut webPos, 70.0f32, 50.0f32)
           != 0 as libc::c_int {
    ...
    if (*this).trisCollider.base.acFlags as libc::c_int & 2 as libc::c_int !=
           0 as libc::c_int {
        BgYdanSp_BurnWeb(this, globalCtx);
        return
    }
    if func_8004356C(&mut (*this).dyna) != 0 {
        sqrtFallDistance =
            sqrtf(if ((*player).fallDistance as libc::c_int as libc::c_float)
                         < 0.0f32 {
                      0.0f32
                  } else {
                      (*player).fallDistance as libc::c_int as libc::c_float
                  });
        if (*player).fallDistance as libc::c_int as libc::c_float > 750.0f32 {
            if (*this).dyna.actor.xzDistToPlayer < 80.0f32 {
                (*this).unk16C = 200.0f32;
                ...
                Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                      0x2862 as libc::c_int as u16_0);
                (*this).actionFunc =
                    Some(BgYdanSp_FloorWebBreaking as
                             unsafe extern "C" fn(_: *mut BgYdanSp,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
        ...
        if (*this).unk16C < unk {
            if unk > 2.0f32 {
                (*this).unk16C = unk;
                (*this).timer = 14 as libc::c_int as s16
            }
        }
        if (*player).actor.speedXZ != 0.0f32 {
            if (*this).unk16C < 0.1f32 {
                (*this).timer = 14 as libc::c_int as s16
            }
            if (*this).unk16C < 2.0f32 {
                (*this).unk16C = 2.0f32
            } else { (*this).unk16C = (*this).unk16C }
        }
    }
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
    ...
    (*this).dyna.actor.world.pos.y =
        sinf((*this).timer as f32_0 *
                 (3.14159265358979323846f32 /
                      7 as libc::c_int as libc::c_float)) * (*this).unk16C +
            (*this).dyna.actor.home.pos.y;
    Math_ApproachZeroF(&mut (*this).unk16C, 1.0f32, 0.8f32);
    if (*this).timer as libc::c_int == 13 as libc::c_int {
        if (*this).unk16C > 3.0f32 {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x2861 as libc::c_int as u16_0);
        } else { Audio_StopSfxById(0x2861 as libc::c_int as u32_0); }
    }
    BgYdanSp_UpdateFloorWebCollision(this);
    CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).trisCollider.base);
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_BurnWallWeb(mut this: *mut BgYdanSp,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut accel: Vec3f =
        {
    ...
    if (*this).timer as libc::c_int % 3 as libc::c_int == 0 as libc::c_int {
        ...
        while i < 6 as libc::c_int {
            ...
            spC8.x = (*this).dyna.actor.world.pos.x + 140.0f32 * coss2;
            spC8.y =
                (*this).dyna.actor.world.pos.y + 140.0f32 * (1.0f32 + coss);
            spC8.z = (*this).dyna.actor.world.pos.z - 140.0f32 * sins;
            distXYZ =
                Math_Vec3f_DistXYZ(&mut (*this).dyna.actor.home.pos,
                                   &mut spC8) * (1.0f32 / 140.0f32);
            if distXYZ < 0.65f32 {
                sins =
                    Math_SinS((rot as libc::c_int + 0x8000 as libc::c_int) as
                                  s16);
                ...
                spC8.y =
                    (*this).dyna.actor.world.pos.y +
                        140.0f32 * (1.0f32 + coss);
                spC8.z = (*this).dyna.actor.world.pos.z - 140.0f32 * sins;
                distXYZ =
                    Math_Vec3f_DistXYZ(&mut (*this).dyna.actor.home.pos,
                                       &mut spC8) * (1.0f32 / 140.0f32)
            }
            velocity.x = 6.5f32 * coss2 * distXYZ;
            velocity.y = 6.5f32 * coss * distXYZ;
            velocity.z = -6.5f32 * sins * distXYZ;
            EffectSsDeadDb_Spawn(globalCtx, &mut (*this).dyna.actor.home.pos,
                                 &mut velocity, &mut accel,
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_WallWebIdle(mut this: *mut BgYdanSp,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    ...
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if Flags_GetSwitch(globalCtx, (*this).burnSwitchFlag as s32) != 0 ||
           (*this).trisCollider.base.acFlags as libc::c_int & 2 as libc::c_int
               != 0 {
        (*this).dyna.actor.home.pos.y =
            (*this).dyna.actor.world.pos.y + 80.0f32;
        BgYdanSp_BurnWeb(this, globalCtx);
    } else if (*player).heldItemActionParam as libc::c_int ==
                  PLAYER_AP_STICK as libc::c_int &&
                  (*player).unk_860 as libc::c_int != 0 as libc::c_int {
        func_8002DBD0(&mut (*this).dyna.actor, &mut sp30,
                      &mut (*(*player).swordInfo.as_mut_ptr().offset(0 as
                                                                         libc::c_int
                                                                         as
                                                                         isize)).tip);
        if fabsf(sp30.x) < 100.0f32 && sp30.z < 1.0f32 && sp30.y < 200.0f32 {
            OnePointCutscene_Init(globalCtx, 3020 as libc::c_int as s16,
                                  40 as libc::c_int as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
            Math_Vec3f_Copy(&mut (*this).dyna.actor.home.pos,
                            &mut (*(*player).swordInfo.as_mut_ptr().offset(0
                                                                               as
                                                                               libc::c_int
                                                                               as
                                                                               isize)).tip);
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgYdanSp = thisx as *mut BgYdanSp;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanSp_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgYdanSp = thisx as *mut BgYdanSp;
    let mut i: s32 = 0;
    let mut mtxF: MtxF = MtxF{mf: [[0.; 4]; 4],};
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_ydan_sp.c\x00" as *const u8 as
                        *const libc::c_char, 781 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    if (*thisx).params as libc::c_int == WEB_WALL as libc::c_int {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gDTWebWallDL.as_mut_ptr() as libc::c_uint
                                                ...
                                                _: *mut GlobalContext) -> ())
     {
        ...
        if (*this).timer as libc::c_int == 40 as libc::c_int {
            Matrix_Translate(0.0f32,
                             ((*thisx).home.pos.y - (*thisx).world.pos.y) *
                                 10.0f32, 0.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(1.0f32,
                         ((*thisx).home.pos.y - (*thisx).world.pos.y +
                              10.0f32) * 0.1f32, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_2).words.w1 = gDTWebFloorDL.as_mut_ptr() as libc::c_uint
        }
        i = 0 as libc::c_int;
        while i < 8 as libc::c_int {
            Matrix_Put(&mut mtxF);
            Matrix_RotateZYX(-(0x5a0 as libc::c_int) as s16,
                             (i * 0x2000 as libc::c_int) as s16,
                             0 as libc::c_int as s16,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Translate(0.0f32, 700.0f32, -900.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(3.5f32, 5.0f32, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_4).words.w1 = gDTUnknownWebDL.as_mut_ptr() as libc::c_uint;
            i += 1
        }
    } else {
        Matrix_Translate(0.0f32,
                         ...
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(1.0f32,
                     ((*thisx).home.pos.y - (*thisx).world.pos.y + 10.0f32) *
                         0.1f32, 1.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_6).words.w1 = gDTWebFloorDL.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_ydan_sp.c\x00" as *const u8 as
                         *const libc::c_char, 856 as libc::c_int);
}
