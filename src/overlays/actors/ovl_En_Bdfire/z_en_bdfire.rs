...
extern "C" {
    ...
    fn LightContext_RemoveLight(globalCtx: *mut GlobalContext,
                                ...
                                node: *mut LightNode);
    #[no_mangle]
    fn func_80094968(gfx: *mut Gfx) -> *mut Gfx;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_kingdodongo_DL_01D950: [Gfx; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0264E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0274E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0284E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_0294E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02A4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02B4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02C4E0: [u64_0; 0];
    #[no_mangle]
    static mut object_kingdodongo_Tex_02D4E0: [u64_0; 0];
}
...
pub struct EnBdfire {
    pub actor: Actor,
    pub actionFunc: EnBdfireActionFunc,
    pub drawFunc: EnBdfireDrawFunc,
    pub unk_154: s16,
    pub unk_156: s16,
    pub unk_158: s16,
    pub unk_15A: [libc::c_char; 46],
    pub unk_188: f32_0,
    pub unk_18C: f32_0,
    pub unk_190: f32_0,
    pub unk_194: f32_0,
    pub unk_198: [libc::c_char; 56],
    pub lightNode: *mut LightNode,
    pub lightInfoNoGlow: LightInfo,
}
pub type EnBdfireDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBdfire, _: *mut GlobalContext)
               -> ()>;
pub type EnBdfireActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBdfire, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Bdfire_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBdfire_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBdfire_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_SetupAction(mut this: *mut EnBdfire,
                                              mut actionFunc:
                                                  EnBdfireActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnbdFire_SetupDraw(mut this: *mut EnBdfire,
                                            mut drawFunc: EnBdfireDrawFunc) {
    (*this).drawFunc = drawFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBdfire = thisx as *mut EnBdfire;
    let mut pad: s32 = 0;
    Actor_SetScale(&mut (*this).actor, 0.6f32);
    EnbdFire_SetupDraw(this,
                       Some(EnBdfire_DrawFire as
                                unsafe extern "C" fn(_: *mut EnBdfire,
                                                     _: *mut GlobalContext)
                                    -> ()));
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int {
        EnBdfire_SetupAction(this,
                             Some(func_809BC2A4 as
                                      unsafe extern "C" fn(_: *mut EnBdfire,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
        (*this).actor.scale.x = 2.8f32;
        (*this).unk_154 = 90 as libc::c_int as s16;
        ...
        (*this).unk_154 =
            (25 as libc::c_int -
                 ((*this).actor.params as libc::c_int as libc::c_float *
                      0.8f32) as s32) as s16;
        if ((*this).unk_154 as libc::c_int) < 0 as libc::c_int {
            (*this).unk_154 = 0 as libc::c_int as s16
        }
        (*this).unk_188 =
            4.2000003f32 -
                (*this).actor.params as libc::c_int as libc::c_float * 0.25f32
                    * 0.6f32;
        if (*this).unk_188 < 0.90000004f32 { (*this).unk_188 = 0.90000004f32 }
        (*this).unk_18C =
            255.0f32 -
                (*this).actor.params as libc::c_int as libc::c_float *
                    10.0f32;
        if (*this).unk_18C < 20.0f32 { (*this).unk_18C = 20.0f32 }
        (*this).unk_156 = (Rand_ZeroOne() * 8.0f32) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBdfire = thisx as *mut EnBdfire;
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_809BC2A4(mut this: *mut EnBdfire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut kingDodongo: *mut BossDodongo = 0 as *mut BossDodongo;
    let mut temp: s32 = 0;
    kingDodongo = (*this).actor.parent as *mut BossDodongo;
    ...
    if (*kingDodongo).unk_1E2 as libc::c_int == 0 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.0f32, 1.0f32, 0.6f32,
                           0.0f32);
        if Math_SmoothStepToF(&mut (*this).unk_18C, 0.0f32, 1.0f32, 20.0f32,
                              0.0f32) == 0.0f32 {
            Actor_Kill(&mut (*this).actor);
        }
    } else {
        if ((*this).unk_154 as libc::c_int) < 70 as libc::c_int {
            Math_SmoothStepToF(&mut (*this).unk_18C, 128.0f32, 0.1f32, 1.5f32,
                               0.0f32);
            Math_SmoothStepToF(&mut (*this).unk_190, 255.0f32, 1.0f32,
                               3.8249998f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).unk_194, 100.0f32, 1.0f32, 1.5f32,
                               0.0f32);
        }
        if (*this).unk_154 as libc::c_int == 0 as libc::c_int {
            temp = 0 as libc::c_int
        } else { (*this).unk_154 -= 1; temp = (*this).unk_154 as s32 }
        if temp == 0 as libc::c_int {
            Math_SmoothStepToF(&mut (*this).actor.scale.x, 0.0f32, 1.0f32,
                               0.3f32, 0.0f32);
            Math_SmoothStepToF(&mut (*this).unk_190, 0.0f32, 1.0f32, 25.5f32,
                               0.0f32);
            Math_SmoothStepToF(&mut (*this).unk_194, 0.0f32, 1.0f32, 10.0f32,
                               0.0f32);
            if Math_SmoothStepToF(&mut (*this).unk_18C, 0.0f32, 1.0f32,
                                  10.0f32, 0.0f32) == 0.0f32 {
                Actor_Kill(&mut (*this).actor);
            }
        }
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
        Lights_PointSetColorAndRadius(&mut (*this).lightInfoNoGlow,
                                      (*this).unk_190 as u8_0,
                                      (*this).unk_194 as u8_0,
                                      0 as libc::c_int as u8_0,
                                      300 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809BC598(mut this: *mut EnBdfire,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_v1_2: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut distToBurn: f32_0 = 0.;
    let mut bossDodongo: *mut BossDodongo = 0 as *mut BossDodongo;
    let mut i: s16 = 0;
    let mut phi_v1: s16 = 0;
    let mut temp: s32 = 0;
    bossDodongo = (*this).actor.parent as *mut BossDodongo;
    (*this).unk_158 = (*bossDodongo).unk_1A2;
    phi_v1_2 = 0 as libc::c_int as s16;
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        Audio_PlaySoundGeneral((0x3809 as libc::c_int - 0x800 as libc::c_int)
                                   as u16_0, &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    }
    Math_SmoothStepToF(&mut (*this).actor.scale.x, (*this).unk_188, 0.3f32,
                       0.5f32, 0.0f32);
    Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x);
    if (*this).actor.world.pos.x < -1390.0f32 {
        if (*this).actor.velocity.x < -10.0f32 {
            (*this).actor.world.pos.x = -1390.0f32;
            phi_v1_2 = 1 as libc::c_int as s16
        }
    }
    if (*this).actor.world.pos.x > -390.0f32 &&
           (*this).actor.velocity.x > 10.0f32 {
        (*this).actor.world.pos.x = -390.0f32;
        phi_v1_2 = 1 as libc::c_int as s16
    }
    if (*this).actor.world.pos.z > -2804.0f32 &&
           (*this).actor.velocity.z > 10.0f32 {
        (*this).actor.world.pos.z = -2804.0f32;
        phi_v1_2 = 1 as libc::c_int as s16
    }
    if (*this).actor.world.pos.z < -3804.0f32 &&
           (*this).actor.velocity.z < -10.0f32 {
        (*this).actor.world.pos.z = -3804.0f32;
        phi_v1_2 = 1 as libc::c_int as s16
    }
    if phi_v1_2 as libc::c_int != 0 as libc::c_int {
    ...
    if temp == 0 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).unk_18C, 0.0f32, 1.0f32, 10.0f32,
                           0.0f32);
        if (*this).unk_18C < 10.0f32 {
            Actor_Kill(&mut (*this).actor);
            return
        }
    } else if (*player).isBurning == 0 {
        distToBurn = (*this).actor.scale.x * 130.0f32 / 4.2000003f32;
        if (*this).actor.xyzDistToPlayerSq < distToBurn * distToBurn {
            ...
            func_8002F6D4(globalCtx, &mut (*this).actor, 20.0f32,
                          (*this).actor.world.rot.y, 0.0f32,
                          8 as libc::c_int as u32_0);
            osSyncPrintf(b"POWER\n\x00" as *const u8 as *const libc::c_char);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBdfire = thisx as *mut EnBdfire;
    (*this).unk_156 += 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_DrawFire(mut this: *mut EnBdfire,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut D_809BCB10: [*mut libc::c_void; 8] =
        unsafe {
            [object_kingdodongo_Tex_0264E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_0274E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_0284E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_0294E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_02A4E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_02B4E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_02C4E0.as_ptr() as *mut _ as
                 *mut libc::c_void,
             object_kingdodongo_Tex_02D4E0.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut temp: s16 = 0;
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bdfire.c\x00" as *const u8 as
                        *const libc::c_char, 612 as libc::c_int);
    temp = ((*this).unk_156 as libc::c_int & 7 as libc::c_int) as s16;
    func_800D1FD4(&mut (*globalCtx).billboardMtxF);
    func_80094BC4((*globalCtx).state.gfxCtx);
    (*__gfxCtx).polyXlu.p = func_80094968((*__gfxCtx).polyXlu.p);
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gSegments[((D_809BCB10[temp as usize] as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(D_809BCB10[temp as usize] as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as libc::c_uint;
    Matrix_Translate(0.0f32, 11.0f32, 0.0f32,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 =
        object_kingdodongo_DL_01D950.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_bdfire.c\x00" as *const u8 as
                         *const libc::c_char, 651 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnBdfire_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBdfire = thisx as *mut EnBdfire;
    (*this).drawFunc.expect("non-null function pointer")(this, globalCtx);
}
