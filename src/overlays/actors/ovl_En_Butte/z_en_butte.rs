...
extern "C" {
    ...
    fn Actor_Spawn(actorCtx: *mut ActorContext, globalCtx: *mut GlobalContext,
     ...
     -> *mut Actor;
    #[no_mangle]
    fn Camera_GetCamDir(dir: *mut Vec3s, camera: *mut Camera) -> *mut Vec3s;
    #[no_mangle]
...
pub struct EnButte {
    ...
    pub actionFunc: EnButteActionFunc,
    pub timer: s16,
    pub flightParamsIdx: u8_0,
    pub unk_257: u8_0,
    pub drawSkelAnime: u8_0,
    pub swordDownTimer: s16,
    pub unk_25C: s16,
    pub unk_25E: s16,
    pub unk_260: s16,
    pub posYTarget: f32_0,
}
pub type EnButteActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnButte, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const FAIRY_HEAL_BIG: C2RustUnnamed_24 = 7;
pub const FAIRY_HEAL: C2RustUnnamed_24 = 6;
pub const FAIRY_REVIVE_DEATH: C2RustUnnamed_24 = 5;
pub const FAIRY_SPAWNER: C2RustUnnamed_24 = 4;
pub const FAIRY_KOKIRI: C2RustUnnamed_24 = 3;
pub const FAIRY_HEAL_TIMED: C2RustUnnamed_24 = 2;
pub const FAIRY_REVIVE_BOTTLE: C2RustUnnamed_24 = 1;
pub const FAIRY_NAVI: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnButteFlightParams {
    pub minTime: s16,
    pub maxTime: s16,
    pub speedXZTarget: f32_0,
    pub speedXZScale: f32_0,
    pub speedXZStep: f32_0,
    pub rotYStep: s16,
}
...
#[no_mangle]
pub static mut En_Butte_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BUTTE as libc::c_int as s16,
                          category:
                              ACTORCAT_ITEMACTION as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_FIELD_KEEP as libc::c_int as
                                  s16,
                          instanceSize:
                              ::std::mem::size_of::<EnButte>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnButte_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x14
static mut sFlyAroundParams: [EnButteFlightParams; 3] =
    [{
         let mut init =
             EnButteFlightParams{minTime: 5 as libc::c_int as s16,
                                 maxTime: 35 as libc::c_int as s16,
                                 speedXZTarget: 0.0f32,
                                 speedXZScale: 0.1f32,
                                 speedXZStep: 0.5f32,
                                 rotYStep: 0 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnButteFlightParams{minTime: 10 as libc::c_int as s16,
                                 maxTime: 45 as libc::c_int as s16,
                                 speedXZTarget: 1.1f32,
                                 speedXZScale: 0.1f32,
                                 speedXZStep: 0.25f32,
                                 rotYStep: 1000 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnButteFlightParams{minTime: 10 as libc::c_int as s16,
                                 maxTime: 40 as libc::c_int as s16,
                                 speedXZTarget: 1.5f32,
                                 speedXZScale: 0.1f32,
                                 speedXZStep: 0.3f32,
                                 rotYStep: 2000 as libc::c_int as s16,};
         init
     }];
static mut sFollowLinkParams: [EnButteFlightParams; 3] =
    [{
         let mut init =
             EnButteFlightParams{minTime: 3 as libc::c_int as s16,
                                 maxTime: 3 as libc::c_int as s16,
                                 speedXZTarget: 0.8f32,
                                 speedXZScale: 0.1f32,
                                 speedXZStep: 0.2f32,
                                 rotYStep: 0 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             EnButteFlightParams{minTime: 10 as libc::c_int as s16,
                                 maxTime: 20 as libc::c_int as s16,
                                 speedXZTarget: 2.0f32,
                                 speedXZScale: 0.3f32,
                                 speedXZStep: 1.0f32,
                                 rotYStep: 0 as libc::c_int as s16,};
         init
...
#[no_mangle]
pub unsafe extern "C" fn EnButte_SelectFlightParams(mut this: *mut EnButte,
                                                    mut flightParams:
                                                        *mut EnButteFlightParams) {
    if (*this).flightParamsIdx as libc::c_int == 0 as libc::c_int {
        if Rand_ZeroOne() < 0.6f32 {
            (*this).flightParamsIdx = 1 as libc::c_int as u8_0
        } else { (*this).flightParamsIdx = 2 as libc::c_int as u8_0 }
    } else { (*this).flightParamsIdx = 0 as libc::c_int as u8_0 }
    (*this).timer =
        Rand_S16Offset((*flightParams).minTime, (*flightParams).maxTime);
}
static mut sTransformationEffectScale: f32_0 = 0.0f32;
static mut sTransformationEffectAlpha: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub unsafe extern "C" fn EnButte_ResetTransformationEffect() {
    sTransformationEffectScale = 0.0f32;
    sTransformationEffectAlpha = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_UpdateTransformationEffect() {
    sTransformationEffectScale += 0.003f32;
    sTransformationEffectAlpha =
        (sTransformationEffectAlpha as libc::c_int + 4000 as libc::c_int) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_DrawTransformationEffect(mut this:
                                                              *mut EnButte,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    static mut D_809CE3C4: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -3.0f32,}; init };
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_choo.c\x00" as *const u8 as *const libc::c_char,
                    295 as libc::c_int);
    func_80093C14((*globalCtx).state.gfxCtx);
    alpha =
        (Math_SinS(sTransformationEffectAlpha) *
             250 as libc::c_int as libc::c_float) as s32;
    alpha =
        if alpha < 0 as libc::c_int {
            0 as libc::c_int
        } else if alpha > 255 as libc::c_int {
            255 as libc::c_int
        } else { alpha };
    Camera_GetCamDir(&mut camDir,
                     (*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                 usize]);
    Matrix_RotateY(camDir.y as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateX(camDir.x as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZ(camDir.z as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut D_809CE3C4, &mut sp5C);
    func_800D1694((*this).actor.focus.pos.x + sp5C.x,
                  (*this).actor.focus.pos.y + sp5C.y,
                  (*this).actor.focus.pos.z + sp5C.z, &mut camDir);
    Matrix_Scale(sTransformationEffectScale, sTransformationEffectScale,
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_choo.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gSegments[((gEffFlash1DL.as_mut_ptr() as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(gEffFlash1DL.as_mut_ptr() as u32_0 &
...
#[no_mangle]
pub unsafe extern "C" fn EnButte_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnButte = thisx as *mut EnButte;
    ...
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gButterflySkel,
                   &mut gButterflyAnim, (*this).jointTable.as_mut_ptr(),
    ...
    (*this).unk_260 =
        (Rand_ZeroOne() * 0xffff as libc::c_int as libc::c_float) as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gButterflyAnim, 1.0f32,
                     0.0f32, 0.0f32,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, 0.0f32);
    EnButte_SetupFlyAround(this);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int - 0x2320 as libc::c_int) as
            s16;
    (*this).drawSkelAnime = 1 as libc::c_int as u8_0;
    // "field keep butterfly"
    osSyncPrintf(b"(field keep \xe8\x9d\xb6)(%x)(arg_data 0x%04x)\n\x00" as
                     *const u8 as *const libc::c_char, this,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_Destroy(mut thisx: *mut Actor,
...
#[no_mangle]
pub unsafe extern "C" fn func_809CD56C(mut this: *mut EnButte) {
    static mut D_809CE3E0: [f32_0; 3] = [50.0f32, 80.0f32, 100.0f32];
    static mut D_809CE3EC: [f32_0; 3] = [30.0f32, 40.0f32, 50.0f32];
    (*this).actor.shape.yOffset +=
        Math_SinS((*this).unk_25C) *
            D_809CE3E0[(*this).flightParamsIdx as usize] +
            Math_SinS((*this).unk_25E) *
                D_809CE3EC[(*this).flightParamsIdx as usize];
    (*this).actor.shape.yOffset =
        if (*this).actor.shape.yOffset < -2000.0f32 {
            -2000.0f32
        } else if (*this).actor.shape.yOffset > 2000.0f32 {
            2000.0f32
        } else { (*this).actor.shape.yOffset };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CD634(mut this: *mut EnButte) {
    static mut D_809CE3F8: [f32_0; 3] = [15.0f32, 20.0f32, 25.0f32];
    static mut D_809CE404: [f32_0; 3] = [7.5f32, 10.0f32, 12.5f32];
    (*this).actor.shape.yOffset +=
        Math_SinS((*this).unk_25C) *
            D_809CE3F8[(*this).flightParamsIdx as usize] +
            Math_SinS((*this).unk_25E) *
                D_809CE404[(*this).flightParamsIdx as usize];
    (*this).actor.shape.yOffset =
        if (*this).actor.shape.yOffset < -500.0f32 {
            -500.0f32
        } else if (*this).actor.shape.yOffset > 500.0f32 {
            500.0f32
        } else { (*this).actor.shape.yOffset };
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_Turn(mut this: *mut EnButte) {
    let mut target: s16 =
        ((*this).actor.world.rot.y as libc::c_int + 0x8000 as libc::c_int) as
            s16;
    let mut diff: s16 =
        (target as libc::c_int - (*this).actor.shape.rot.y as libc::c_int) as
            s16;
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.y, target,
                       ((if diff as libc::c_int >= 0 as libc::c_int {
                             diff as libc::c_int
                         } else { -(diff as libc::c_int) }) >>
                            3 as libc::c_int) as s16);
    (*this).actor.shape.rot.x =
        ((sinf((*this).unk_260 as f32_0) * 600.0f32) as s16 as libc::c_int -
             0x2320 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_SetupFlyAround(mut this: *mut EnButte) {
    EnButte_SelectFlightParams(this,
                               &mut *sFlyAroundParams.as_mut_ptr().offset((*this).flightParamsIdx
                                                                              as
                                                                              isize));
    (*this).actionFunc =
        Some(EnButte_FlyAround as
                 unsafe extern "C" fn(_: *mut EnButte, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_FlyAround(mut this: *mut EnButte,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut flightParams: *mut EnButteFlightParams =
        &mut *sFlyAroundParams.as_mut_ptr().offset((*this).flightParamsIdx as
                                                       isize) as
            *mut EnButteFlightParams;
    let mut yaw: s16 = 0;
    ...
    let mut distSqFromHome: f32_0 = 0.;
    let mut maxDistSqFromHome: f32_0 = 0.;
    let mut minAnimSpeed: f32_0 = 0.;
    let mut animSpeed: f32_0 = 0.;
    let mut rotStep: s16 = 0;
    distSqFromHome =
        Math3D_Dist2DSq((*this).actor.world.pos.x, (*this).actor.world.pos.z,
                        (*this).actor.home.pos.x, (*this).actor.home.pos.z);
    func_809CD56C(this);
    Math_SmoothStepToF(&mut (*this).actor.speedXZ,
                       (*flightParams).speedXZTarget,
                       (*flightParams).speedXZScale,
                       (*flightParams).speedXZStep, 0.0f32);
    if (*this).unk_257 as libc::c_int == 1 as libc::c_int {
        maxDistSqFromHome = 100.0f32 * 100.0f32;
        rotStep = 1000 as libc::c_int as s16
    } else {
        maxDistSqFromHome = 35.0f32 * 35.0f32;
        rotStep = 600 as libc::c_int as s16
    }
    minAnimSpeed = 0.0f32;
    (*this).posYTarget = (*this).actor.home.pos.y;
    if (*this).flightParamsIdx as libc::c_int != 0 as libc::c_int &&
           (distSqFromHome > maxDistSqFromHome ||
                ((*this).timer as libc::c_int) < 4 as libc::c_int) {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
                              (*flightParams).rotYStep) == 0 as libc::c_int {
            minAnimSpeed = 0.5f32
        }
    } else if (*this).unk_257 as libc::c_int == 0 as libc::c_int &&
                  !(*this).actor.child.is_null() &&
                  (*this).actor.child != &mut (*this).actor as *mut Actor {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*(*this).actor.child).world.pos);
        if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw, rotStep) ==
               0 as libc::c_int {
            minAnimSpeed = 0.3f32
        }
    } else if (*this).unk_257 as libc::c_int == 1 as libc::c_int {
        yaw =
            ((*this).actor.yawTowardsPlayer as libc::c_int +
                 0x8000 as libc::c_int +
                 ((Rand_ZeroOne() - 0.5f32) *
                      0x6000 as libc::c_int as libc::c_float) as s16 as
                     libc::c_int) as s16;
        if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw, rotStep) ==
               0 as libc::c_int {
            minAnimSpeed = 0.4f32
        ...
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int +
                 (sinf((*this).unk_25C as f32_0) * 100.0f32) as s16 as
                     libc::c_int) as s16
    }
    EnButte_Turn(this);
    animSpeed =
        (*this).actor.speedXZ / 2.0f32 + Rand_ZeroOne() * 0.2f32 +
            (1.0f32 - Math_SinS((*this).unk_260)) * 0.15f32 +
            (1.0f32 - Math_SinS((*this).unk_25E)) * 0.3f32 + minAnimSpeed;
    (*this).skelAnime.playSpeed =
        if animSpeed < 0.2f32 {
            0.2f32
        } else if animSpeed > 1.5f32 { 1.5f32 } else { animSpeed };
    ...
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
           ...
           (*this).swordDownTimer as libc::c_int <= 0 as libc::c_int &&
           (Math3D_Dist2DSq((*player).actor.world.pos.x,
                            (*player).actor.world.pos.z,
                            (*this).actor.home.pos.x,
                            (*this).actor.home.pos.z) < 120.0f32 * 120.0f32 ||
                (*this).actor.xzDistToPlayer < 60.0f32) {
        EnButte_SetupFollowLink(this);
        (*this).unk_257 = 2 as libc::c_int as u8_0
    } else if ((*this).actor.xzDistToPlayer as libc::c_double) < 120.0f64 {
        (*this).unk_257 = 1 as libc::c_int as u8_0
    } else { (*this).unk_257 = 0 as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_SetupFollowLink(mut this: *mut EnButte) {
    EnButte_SelectFlightParams(this,
                               &mut *sFollowLinkParams.as_mut_ptr().offset((*this).flightParamsIdx
                                                                               as
                                                                               isize));
    (*this).actionFunc =
        Some(EnButte_FollowLink as
                 unsafe extern "C" fn(_: *mut EnButte, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_FollowLink(mut this: *mut EnButte,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    static mut D_809CE410: s32 = 1500 as libc::c_int;
    let mut flightParams: *mut EnButteFlightParams =
        &mut *sFollowLinkParams.as_mut_ptr().offset((*this).flightParamsIdx as
                                                        isize) as
            *mut EnButteFlightParams;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    let mut animSpeed: f32_0 = 0.;
    let mut minAnimSpeed: f32_0 = 0.;
    let mut distSqFromSword: f32_0 = 0.;
    let mut yaw: s16 = 0;
    func_809CD634(this);
    Math_SmoothStepToF(&mut (*this).actor.speedXZ,
                       (*flightParams).speedXZTarget,
    ...
    minAnimSpeed = 0.0f32;
    if (*this).flightParamsIdx as libc::c_int != 0 as libc::c_int &&
           ((*this).timer as libc::c_int) < 12 as libc::c_int {
        swordTip.x =
            (*player).swordInfo[0 as libc::c_int as usize].tip.x +
                Math_SinS((*player).actor.shape.rot.y) * 10.0f32;
        swordTip.y = (*player).swordInfo[0 as libc::c_int as usize].tip.y;
        swordTip.z =
            (*player).swordInfo[0 as libc::c_int as usize].tip.z +
                Math_CosS((*player).actor.shape.rot.y) * 10.0f32;
        yaw =
            (Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut swordTip) as
                 libc::c_int +
                 (Rand_ZeroOne() * D_809CE410 as libc::c_float) as s16 as
                     libc::c_int) as s16;
        if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
                              2000 as libc::c_int as s16) != 0 as libc::c_int
           {
            if (*globalCtx).gameplayFrames.wrapping_rem(2 as libc::c_int as
                                                            libc::c_uint) != 0
               {
                (*this).actor.world.rot.y =
                    ((*this).actor.world.rot.y as libc::c_int +
                         (sinf((*this).unk_25C as f32_0) * 60.0f32) as s16 as
                             libc::c_int) as s16
            }
        } else { minAnimSpeed = 0.3f32 }
    }
    (*this).posYTarget =
        if (*player).actor.world.pos.y + 30.0f32 >
               (*player).swordInfo[0 as libc::c_int as usize].tip.y {
            ((*player).actor.world.pos.y) + 30.0f32
        } else { (*player).swordInfo[0 as libc::c_int as usize].tip.y };
    EnButte_Turn(this);
    animSpeed =
        (*this).actor.speedXZ / 2.0f32 + Rand_ZeroOne() * 0.2f32 +
            (1.0f32 - Math_SinS((*this).unk_260)) * 0.15f32 +
    ...
    distSqFromHome =
        Math3D_Dist2DSq((*this).actor.world.pos.x, (*this).actor.world.pos.z,
                        (*this).actor.home.pos.x, (*this).actor.home.pos.z);
    if !((*player).heldItemActionParam as libc::c_int ==
             PLAYER_AP_STICK as libc::c_int &&
             fabsf((*player).actor.speedXZ) < 1.8f32 &&
             (*this).swordDownTimer as libc::c_int <= 0 as libc::c_int &&
             distSqFromHome < 320.0f32 * 320.0f32) {
        EnButte_SetupFlyAround(this);
    } else if distSqFromHome > 240.0f32 * 240.0f32 {
        distSqFromSword =
            Math3D_Dist2DSq((*player).swordInfo[0 as libc::c_int as
                                                    usize].tip.x,
                            (*player).swordInfo[0 as libc::c_int as
                                                    usize].tip.z,
                            (*this).actor.world.pos.x,
                            (*this).actor.world.pos.z);
        if distSqFromSword < 60.0f32 * 60.0f32 {
            EnButte_SetupTransformIntoFairy(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_SetupTransformIntoFairy(mut this:
                                                             *mut EnButte) {
    ...
    (*this).actionFunc =
        Some(EnButte_TransformIntoFairy as
                 unsafe extern "C" fn(_: *mut EnButte, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_TransformIntoFairy(mut this: *mut EnButte,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).timer as libc::c_int == 5 as libc::c_int {
        ...
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    (*this).actor.focus.pos.x, (*this).actor.focus.pos.y,
                    (*this).actor.focus.pos.z, 0 as libc::c_int as s16,
                    (*this).actor.shape.rot.y, 0 as libc::c_int as s16,
                    FAIRY_HEAL_TIMED as libc::c_int as s16);
        (*this).drawSkelAnime = 0 as libc::c_int as u8_0
    } else if (*this).timer as libc::c_int <= 0 as libc::c_int {
        EnButte_SetupWaitToDie(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_SetupWaitToDie(mut this: *mut EnButte) {
    (*this).timer = 64 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnButte_WaitToDie as
                 unsafe extern "C" fn(_: *mut EnButte, _: *mut GlobalContext)
                     -> ());
    (*this).actor.draw = None;
}
#[no_mangle]
pub unsafe extern "C" fn EnButte_WaitToDie(mut this: *mut EnButte,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnButte_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnButte = thisx as *mut EnButte;
    if !(*this).actor.child.is_null() &&
           (*(*this).actor.child).update.is_none() &&
           (*this).actor.child != &mut (*this).actor as *mut Actor {
        (*this).actor.child = 0 as *mut Actor
    }
    if (*this).timer as libc::c_int > 0 as libc::c_int { (*this).timer -= 1 }
    (*this).unk_25C =
        ((*this).unk_25C as libc::c_int + 0x222 as libc::c_int) as s16;
    (*this).unk_25E =
        ((*this).unk_25E as libc::c_int + 0x1000 as libc::c_int) as s16;
    (*this).unk_260 =
        ((*this).unk_260 as libc::c_int + 0x600 as libc::c_int) as s16;
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
           1 as libc::c_int {
        if (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int
                                                   as usize].head as
                  *mut Player)).swordState as libc::c_int == 0 as libc::c_int
           {
            if (*this).swordDownTimer as libc::c_int > 0 as libc::c_int {
                (*this).swordDownTimer -= 1
            }
        } else { (*this).swordDownTimer = 80 as libc::c_int as s16 }
    }
    ...
    if (*this).actor.update.is_some() {
        ...
        Math_StepToF(&mut (*this).actor.world.pos.y, (*this).posYTarget,
                     0.6f32);
        if (*this).actor.xyzDistToPlayerSq < 5000.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnButte_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnButte = thisx as *mut EnButte;
    ...
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
           ...
           (*this).actionFunc ==
               Some(EnButte_TransformIntoFairy as
                        unsafe extern "C" fn(_: *mut EnButte,
                                             _: *mut GlobalContext) -> ()) {
