...
extern "C" {
    ...
    #[no_mangle]
    fn KaleidoSetup_Init(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn KaleidoSetup_Destroy(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn ShrinkWindow_GetCurrentVal() -> u32_0;
    #[no_mangle]
    fn KaleidoManager_LoadOvl(ovl: *mut KaleidoMgrOverlay);
    #[no_mangle]
    fn KaleidoManager_ClearOvl(ovl: *mut KaleidoMgrOverlay);
    #[no_mangle]
    fn KaleidoManager_GetRamAddr(vram: *mut libc::c_void)
     -> *mut libc::c_void;
    #[no_mangle]
    static mut gKaleidoMgrOverlayTable: [KaleidoMgrOverlay; 2];
    #[no_mangle]
    static mut gKaleidoMgrCurOvl: *mut KaleidoMgrOverlay;
    #[no_mangle]
    static mut gGameInfo: *mut GameInfo;
    #[no_mangle]
    fn KaleidoScope_Update(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn KaleidoScope_Draw(globalCtx: *mut GlobalContext);
}
...
pub const KALEIDO_OVL_MAX: C2RustUnnamed_14 = 2;
pub const KALEIDO_OVL_PLAYER_ACTOR: C2RustUnnamed_14 = 1;
pub const KALEIDO_OVL_KALEIDO_SCOPE: C2RustUnnamed_14 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut sKaleidoScopeUpdateFunc:
           Option<unsafe extern "C" fn(_: *mut GlobalContext) -> ()> =
    None;
#[no_mangle]
pub static mut sKaleidoScopeDrawFunc:
           Option<unsafe extern "C" fn(_: *mut GlobalContext) -> ()> =
    None;
#[no_mangle]
pub static mut gBossMarkScale: f32_0 = 0.;
#[no_mangle]
pub static mut D_8016139C: u32_0 = 0;
#[no_mangle]
pub static mut gLoadedPauseMarkDataTable: *mut PauseMapMarksData =
    0 as *const PauseMapMarksData as *mut PauseMapMarksData;
#[no_mangle]
pub unsafe extern "C" fn KaleidoScopeCall_LoadPlayer() {
    let mut playerActorOvl: *mut KaleidoMgrOverlay =
        &mut *gKaleidoMgrOverlayTable.as_mut_ptr().offset(KALEIDO_OVL_PLAYER_ACTOR
                                                              as libc::c_int
                                                              as isize) as
            *mut KaleidoMgrOverlay; // "Kaleido area forced exclusion"
    if gKaleidoMgrCurOvl != playerActorOvl {
        if !gKaleidoMgrCurOvl.is_null() {
            osSyncPrintf(b"\x1b[32m\x00" as *const u8 as
                             *const libc::c_char); // "Player actor import"
            osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe9\xa0\x98\xe5\x9f\x9f \xe5\xbc\xb7\xe5\x88\xb6\xe6\x8e\x92\xe9\x99\xa4\n\x00"
        ...
        osSyncPrintf(b"\xe3\x83\x97\xe3\x83\xac\xe3\x82\xa4\xe3\x83\xa4\xe3\x83\xbc\xe3\x82\xa2\xe3\x82\xaf\xe3\x82\xbf\xe3\x83\xbc\xe6\x90\xac\xe5\x85\xa5\n\x00"
                         as *const u8 as *const libc::c_char);
        osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn KaleidoScopeCall_Init(mut globalCtx:
                                                   *mut GlobalContext) {
    // "Kaleidoscope replacement construction"
    osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe3\x83\xbb\xe3\x82\xb9\xe3\x82\xb3\xe3\x83\xbc\xe3\x83\x97\xe5\x85\xa5\xe3\x82\x8c\xe6\x9b\xbf\xe3\x81\x88 \xe3\x82\xb3\xe3\x83\xb3\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x83\x88 \n\x00"
                     as *const u8 as *const libc::c_char);
    sKaleidoScopeUpdateFunc =
        ::std::mem::transmute::<*mut libc::c_void,
                                Option<unsafe extern "C" fn(_:
                                                                *mut GlobalContext)
                                           ->
                                               ()>>(KaleidoManager_GetRamAddr(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                                      *mut GlobalContext)
                                                                                                                 ->
                                                                                                                     ()>,
                                                                                                      *mut libc::c_void>(Some(KaleidoScope_Update
                                                                                                                                  as
                                ...
                                Option<unsafe extern "C" fn(_:
                                           ...
                                           ->
                                               ()>>(KaleidoManager_GetRamAddr(::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                                                 ...
                                                                                                                 ->
                                                                                                                     ()>,
                                                                                                      *mut libc::c_void>(Some(KaleidoScope_Draw
                                                                                                                                  as
                                                                                                                                  unsafe extern "C" fn(_:
                                                                                                                                                           *mut GlobalContext)
                                                                                                                                      ->
                                                                                                                                          ()))));
    LogUtils_LogThreadId(b"../z_kaleido_scope_call.c\x00" as *const u8 as
                             *const libc::c_char, 98 as libc::c_int);
    osSyncPrintf(b"kaleido_scope_move = %08x\n\x00" as *const u8 as
                     *const libc::c_char,
                 Some(KaleidoScope_Update as
                          unsafe extern "C" fn(_: *mut GlobalContext) -> ()));
    LogUtils_LogThreadId(b"../z_kaleido_scope_call.c\x00" as *const u8 as
                             *const libc::c_char, 99 as libc::c_int);
    osSyncPrintf(b"kaleido_scope_move_func = %08x\n\x00" as *const u8 as
                     *const libc::c_char, sKaleidoScopeUpdateFunc);
    LogUtils_LogThreadId(b"../z_kaleido_scope_call.c\x00" as *const u8 as
                             *const libc::c_char, 100 as libc::c_int);
    osSyncPrintf(b"kaleido_scope_draw = %08x\n\x00" as *const u8 as
                     *const libc::c_char,
                 Some(KaleidoScope_Draw as
                          unsafe extern "C" fn(_: *mut GlobalContext) -> ()));
    LogUtils_LogThreadId(b"../z_kaleido_scope_call.c\x00" as *const u8 as
                             *const libc::c_char, 101 as libc::c_int);
    osSyncPrintf(b"kaleido_scope_draw_func = %08x\n\x00" as *const u8 as
                     *const libc::c_char, sKaleidoScopeDrawFunc);
    KaleidoSetup_Init(globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn KaleidoScopeCall_Destroy(mut globalCtx:
                                                      *mut GlobalContext) {
    // "Kaleidoscope replacement destruction"
    osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe3\x83\xbb\xe3\x82\xb9\xe3\x82\xb3\xe3\x83\xbc\xe3\x83\x97\xe5\x85\xa5\xe3\x82\x8c\xe6\x9b\xbf\xe3\x81\x88 \xe3\x83\x87\xe3\x82\xb9\xe3\x83\x88\xe3\x83\xa9\xe3\x82\xaf\xe3\x83\x88 \n\x00"
                     as *const u8 as *const libc::c_char);
    KaleidoSetup_Destroy(globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn KaleidoScopeCall_Update(mut globalCtx:
                                                     *mut GlobalContext) {
    let mut kaleidoScopeOvl: *mut KaleidoMgrOverlay =
        &mut *gKaleidoMgrOverlayTable.as_mut_ptr().offset(KALEIDO_OVL_KALEIDO_SCOPE
                                                              as libc::c_int
                                                              as isize) as
            *mut KaleidoMgrOverlay;
    ...
    if (*pauseCtx).state as libc::c_int != 0 as libc::c_int ||
        ...
        if (*pauseCtx).state as libc::c_int == 1 as libc::c_int {
            if ShrinkWindow_GetCurrentVal() ==
                ...
                (*pauseCtx).state =
                    (((*pauseCtx).state as libc::c_int &
                          0xffff as libc::c_int) + 1 as libc::c_int) as u16_0
            }
        } else if (*pauseCtx).state as libc::c_int == 8 as libc::c_int {
            (*gGameInfo).data[(21 as libc::c_int * 6 as libc::c_int *
            ...
            (*pauseCtx).unk_1EC = 0 as libc::c_int as u16_0;
            (*pauseCtx).state =
                (((*pauseCtx).state as libc::c_int & 0xffff as libc::c_int) +
                     1 as libc::c_int) as u16_0
        } else if (*pauseCtx).state as libc::c_int == 2 as libc::c_int ||
                      (*pauseCtx).state as libc::c_int == 9 as libc::c_int {
            osSyncPrintf(b"PR_KAREIDOSCOPE_MODE=%d\n\x00" as *const u8 as
                             *const libc::c_char,
        ...
        } else if (*pauseCtx).state as libc::c_int != 0 as libc::c_int {
            if gKaleidoMgrCurOvl != kaleidoScopeOvl {
                if !gKaleidoMgrCurOvl.is_null() {
                    osSyncPrintf(b"\x1b[32m\x00" as *const u8 as
                                     *const libc::c_char);
                    // "Kaleido area Player Forced Elimination"
                    osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe9\xa0\x98\xe5\x9f\x9f \xe3\x83\x97\xe3\x83\xac\xe3\x82\xa4\xe3\x83\xa4\xe3\x83\xbc \xe5\xbc\xb7\xe5\x88\xb6\xe6\x8e\x92\xe9\x99\xa4\n\x00"
                                     as *const u8 as *const libc::c_char);
                ...
                osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe9\xa0\x98\xe5\x9f\x9f \xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe3\x82\xb9\xe3\x82\xb3\xe3\x83\xbc\xe3\x83\x97\xe6\x90\xac\xe5\x85\xa5\n\x00"
                                 as *const u8 as *const libc::c_char);
                osSyncPrintf(b"\x1b[m\x00" as *const u8 as
                                 *const libc::c_char);
            ...
            if gKaleidoMgrCurOvl == kaleidoScopeOvl {
                sKaleidoScopeUpdateFunc.expect("non-null function pointer")(globalCtx);
                if (*globalCtx).pauseCtx.state as libc::c_int ==
                    ...
                    osSyncPrintf(b"\xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe9\xa0\x98\xe5\x9f\x9f \xe3\x82\xab\xe3\x83\xac\xe3\x82\xa4\xe3\x83\x89\xe3\x82\xb9\xe3\x82\xb3\xe3\x83\xbc\xe3\x83\x97\xe6\x8e\x92\xe5\x87\xba\n\x00"
                                     as *const u8 as *const libc::c_char);
                    osSyncPrintf(b"\x1b[m\x00" as *const u8 as
                                     *const libc::c_char);
...
#[no_mangle]
pub unsafe extern "C" fn KaleidoScopeCall_Draw(mut globalCtx:
                                                   *mut GlobalContext) {
    let mut kaleidoScopeOvl: *mut KaleidoMgrOverlay =
        &mut *gKaleidoMgrOverlayTable.as_mut_ptr().offset(KALEIDO_OVL_KALEIDO_SCOPE
                                                              as libc::c_int
    ...
    if (*gGameInfo).data[(1 as libc::c_int * 6 as libc::c_int *
        ...
        if (*globalCtx).pauseCtx.state as libc::c_int >= 4 as libc::c_int &&
               (*globalCtx).pauseCtx.state as libc::c_int <= 7 as libc::c_int
               ||
               (*globalCtx).pauseCtx.state as libc::c_int >= 11 as libc::c_int
                   &&
                   (*globalCtx).pauseCtx.state as libc::c_int <=
                       18 as libc::c_int {
            if gKaleidoMgrCurOvl == kaleidoScopeOvl {
                sKaleidoScopeDrawFunc.expect("non-null function pointer")(globalCtx);
            }
        }
    };
}
