...
extern "C" {
    ...
    #[no_mangle]
    static mut object_daiku_Anim_000C44: AnimationHeader;
    #[no_mangle]
    static mut object_daiku_Anim_001AB0: AnimationHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_daiku_Anim_007DE0: AnimationHeader;
    #[no_mangle]
    static mut object_daiku_Anim_008164: AnimationHeader;
    #[no_mangle]
    static mut object_daiku_Anim_00885C: AnimationHeader;
}
...
pub struct EnDaiku {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnDaikuActionFunc,
    pub collider: ColliderCylinder,
    pub unk_1E0: [libc::c_char; 4],
    pub talkState: s32,
    pub unk_1E8: [libc::c_char; 4],
    pub waypoint: s32,
    pub runSpeed: f32_0,
    pub currentAnimIndex: s32,
    pub unk_1F8: [libc::c_char; 4],
    pub subCamActive: s32,
    pub escapeSubCamTimer: s32,
    pub subCamId: s32,
    pub rotYtowardsPath: s16,
    pub subCamEyeInit: Vec3f,
    pub subCamAtTarget: Vec3f,
    pub subCamEye: Vec3f,
    pub subCamAt: Vec3f,
    pub stateFlags: s32,
    pub startFightSwitchFlag: s32,
    pub unk_244: struct_80034A14_arg1,
    pub jointTable: [Vec3s; 17],
    pub morphTable: [Vec3s; 17],
    pub initRot: Vec3s,
    pub initPos: Vec3f,
}
pub type EnDaikuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDaiku, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnGeldB {
...
pub const ENDAIKU_ANIM_SIT: C2RustUnnamed_24 = 4;
pub const ENDAIKU_ANIM_RUN: C2RustUnnamed_24 = 3;
pub const ENDAIKU_ANIM_CELEBRATE: C2RustUnnamed_24 = 2;
pub const ENDAIKU_ANIM_STAND: C2RustUnnamed_24 = 1;
pub const ENDAIKU_ANIM_SHOUT: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDaikuEscapeSubCamParam {
    pub eyePosDeltaLocal: Vec3f,
    pub maxFramesActive: s32,
}
pub type C2RustUnnamed_25 = libc::c_uint;
pub const ENDAIKU_STATE_NO_TALK: C2RustUnnamed_25 = 3;
pub const ENDAIKU_STATE_TALKING: C2RustUnnamed_25 = 2;
pub const ENDAIKU_STATE_CAN_TALK: C2RustUnnamed_25 = 0;
#[no_mangle]
pub static mut En_Daiku_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DAIKU as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_DAIKU as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDaiku>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDaiku_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit2: CollisionCheckInfoInit2 =
    {
        let mut init =
...
static mut sAnimations: [EnDaikuAnimation; 5] =
    unsafe {
        [{
             let mut init =
                 EnDaikuAnimation{anim:
                                      &object_daiku_Anim_001AB0 as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,
                                  unk_4: 1.0f32,
                                  mode: 0 as libc::c_int as u8_0,
                                  transitionRate: 0 as libc::c_int as f32_0,};
             init
         },
         {
             let mut init =
                 EnDaikuAnimation{anim:
                                      &object_daiku_Anim_007DE0 as
                                          *const AnimationHeader as
                                          *mut AnimationHeader,
                                  unk_4: 1.0f32,
                                  mode: 0 as libc::c_int as u8_0,
...
static mut sEscapeSubCamParams: [EnDaikuEscapeSubCamParam; 4] =
    [{
         let mut init =
             EnDaikuEscapeSubCamParam{eyePosDeltaLocal:
                                          {
                                              let mut init =
                                                  Vec3f{x:
                                                            0 as libc::c_int
                                      ...
                                      maxFramesActive: 100 as libc::c_int,};
         init
     },
     {
         let mut init =
             EnDaikuEscapeSubCamParam{eyePosDeltaLocal:
                                      ...
                                      maxFramesActive: 110 as libc::c_int,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             EnDaikuEscapeSubCamParam{eyePosDeltaLocal:
                                      ...
                                      maxFramesActive: 120 as libc::c_int,};
         init
     }];
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Change(mut this: *mut EnDaiku,
                                        mut animIndex: s32,
                                        mut currentAnimIndex: *mut s32) {
    let mut transitionRate: f32_0 = 0.;
    if *currentAnimIndex < 0 as libc::c_int || *currentAnimIndex == animIndex
       {
        transitionRate = 0.0f32
    } else { transitionRate = sAnimations[animIndex as usize].transitionRate }
    Animation_Change(&mut (*this).skelAnime,
                     sAnimations[animIndex as usize].anim, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(sAnimations[animIndex as
                                                            usize].anim as
                                                *mut libc::c_void) as f32_0,
                     sAnimations[animIndex as usize].mode, transitionRate);
    *currentAnimIndex = animIndex;
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDaiku = thisx as *mut EnDaiku;
    let mut pad: s32 = 0;
    let mut noKill: s32 = 1 as libc::c_int;
    let mut isFree: s32 = 0 as libc::c_int;
    if (*this).actor.params as libc::c_int & 3 as libc::c_int ==
           0 as libc::c_int &&
           gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int
               & 1 as libc::c_int != 0 {
        isFree = 1 as libc::c_int
    ...
    if isFree == 1 as libc::c_int &&
           (*globalCtx).sceneNum as libc::c_int ==
               SCENE_GERUDOWAY as libc::c_int {
        noKill = 0 as libc::c_int
    } else if isFree == 0 as libc::c_int &&
                  (*globalCtx).sceneNum as libc::c_int ==
                      SCENE_TENT as libc::c_int {
        noKill = 0 as libc::c_int
    }
    (*this).startFightSwitchFlag =
        (*this).actor.shape.rot.z as libc::c_int & 0x3f as libc::c_int;
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                            &mut sColChkInfoInit2);
    Animation_Change(&mut (*this).skelAnime,
                     sAnimations[0 as libc::c_int as usize].anim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(sAnimations[0 as libc::c_int as
                                                            usize].anim as
                                                *mut libc::c_void) as f32_0,
                     sAnimations[0 as libc::c_int as usize].mode,
                     sAnimations[0 as libc::c_int as usize].transitionRate);
    ...
    (*this).currentAnimIndex = -(1 as libc::c_int);
    (*this).runSpeed = 5.0f32;
    (*this).initRot = (*this).actor.world.rot;
    (*this).initPos = (*this).actor.world.pos;
    if (*globalCtx).sceneNum as libc::c_int == SCENE_GERUDOWAY as libc::c_int
       {
        EnDaiku_Change(this, ENDAIKU_ANIM_STAND as libc::c_int,
                       &mut (*this).currentAnimIndex);
        (*this).stateFlags |=
            (1 as libc::c_int) << 1 as libc::c_int |
                (1 as libc::c_int) << 2 as libc::c_int;
        (*this).actionFunc =
            Some(EnDaiku_Jailed as
                     unsafe extern "C" fn(_: *mut EnDaiku,
                                          _: *mut GlobalContext) -> ())
    } else {
        if (*this).actor.params as libc::c_int & 3 as libc::c_int ==
               1 as libc::c_int ||
               (*this).actor.params as libc::c_int & 3 as libc::c_int ==
                   3 as libc::c_int {
            EnDaiku_Change(this, ENDAIKU_ANIM_SIT as libc::c_int,
                           &mut (*this).currentAnimIndex);
            (*this).stateFlags |= (1 as libc::c_int) << 1 as libc::c_int
        } else {
            EnDaiku_Change(this, ENDAIKU_ANIM_SHOUT as libc::c_int,
                           &mut (*this).currentAnimIndex);
            (*this).stateFlags |=
                (1 as libc::c_int) << 1 as libc::c_int |
                    (1 as libc::c_int) << 2 as libc::c_int
        ...
        (*this).skelAnime.curFrame =
            (Rand_ZeroOne() * (*this).skelAnime.endFrame) as s32 as f32_0;
        (*this).actionFunc =
            Some(EnDaiku_TentIdle as
                     unsafe extern "C" fn(_: *mut EnDaiku,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDaiku = thisx as *mut EnDaiku;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_UpdateTalking(mut this: *mut EnDaiku,
                                               mut globalCtx:
                                                   *mut GlobalContext)
 -> s32 {
    let mut newTalkState: s32 = ENDAIKU_STATE_TALKING as libc::c_int;
        ...
        if (*globalCtx).sceneNum as libc::c_int ==
            ...
            if Message_ShouldAdvance(globalCtx) != 0 {
                if (*this).actor.textId as libc::c_int ==
                       0x6007 as libc::c_int {
                    Flags_SetSwitch(globalCtx, (*this).startFightSwitchFlag);
                    newTalkState = ENDAIKU_STATE_CAN_TALK as libc::c_int
                } else {
                    (*this).actionFunc =
                        Some(EnDaiku_InitEscape as
                                 unsafe extern "C" fn(_: *mut EnDaiku,
                                                      _: *mut GlobalContext)
                                     -> ());
                    newTalkState = ENDAIKU_STATE_NO_TALK as libc::c_int
                }
            }
            ...
            if Message_ShouldAdvance(globalCtx) != 0 {
                match (*this).actor.textId as libc::c_int {
                    24673 => {
                        gSaveContext.infTable[23 as libc::c_int as usize] =
                            (gSaveContext.infTable[23 as libc::c_int as usize]
                                 as libc::c_int | 0x40 as libc::c_int) as
                                u16_0
                    }
                    24676 => {
                        gSaveContext.infTable[23 as libc::c_int as usize] =
                            (gSaveContext.infTable[23 as libc::c_int as usize]
                                 as libc::c_int | 0x100 as libc::c_int) as
                                u16_0
                    }
                    _ => { }
                }
...
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_UpdateText(mut this: *mut EnDaiku,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut carpenterType: s32 = 0;
    let mut freedCount: s32 = 0;
    let mut sp2E: s16 = 0;
    let mut sp2C: s16 = 0;
    if (*this).talkState == ENDAIKU_STATE_TALKING as libc::c_int {
        (*this).talkState = EnDaiku_UpdateTalking(this, globalCtx)
    } else if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).talkState = ENDAIKU_STATE_TALKING as libc::c_int
    } else {
        Actor_GetScreenPos(globalCtx, &mut (*this).actor, &mut sp2E,
                           &mut sp2C);
        if sp2E as libc::c_int >= 0 as libc::c_int &&
               sp2E as libc::c_int <= 320 as libc::c_int &&
               sp2C as libc::c_int >= 0 as libc::c_int &&
               sp2C as libc::c_int <= 240 as libc::c_int &&
               (*this).talkState == ENDAIKU_STATE_CAN_TALK as libc::c_int &&
               func_8002F2CC(&mut (*this).actor, globalCtx, 100.0f32) ==
                   1 as libc::c_int {
            if (*globalCtx).sceneNum as libc::c_int ==
                   SCENE_GERUDOWAY as libc::c_int {
                if (*this).stateFlags & (1 as libc::c_int) << 4 as libc::c_int
                       != 0 {
                    freedCount = 0 as libc::c_int;
                    carpenterType = 0 as libc::c_int;
                    while carpenterType < 4 as libc::c_int {
                        if gSaveContext.eventChkInf[9 as libc::c_int as usize]
                               as libc::c_int &
                               (1 as libc::c_int) << carpenterType != 0 {
                            freedCount += 1
                        }
                        carpenterType += 1
                    }
                    match freedCount {
                        0 => {
                            (*this).actor.textId =
                                0x605b as libc::c_int as u16_0
                        }
                        1 => {
                            (*this).actor.textId =
                                0x605c as libc::c_int as u16_0
                        }
                        2 => {
                            (*this).actor.textId =
                                0x605d as libc::c_int as u16_0
                        }
                        3 => {
                            (*this).actor.textId =
                                0x605e as libc::c_int as u16_0
                        }
                        _ => { }
                    }
                              ...
                              0 {
                    (*this).actor.textId = 0x6007 as libc::c_int as u16_0
                }
            } else if (*globalCtx).sceneNum as libc::c_int ==
                          SCENE_TENT as libc::c_int {
                match (*this).actor.params as libc::c_int & 3 as libc::c_int {
                    0 => {
                        if gBitFlags[QUEST_MEDALLION_SPIRIT as libc::c_int as
                                         usize] &
                               gSaveContext.inventory.questItems != 0 {
                            (*this).actor.textId =
                                0x6060 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x605f as libc::c_int as u16_0
                        }
                    }
                    1 => {
                        if gBitFlags[QUEST_MEDALLION_SPIRIT as libc::c_int as
                               ...
                               gSaveContext.inventory.questItems != 0 {
                            (*this).actor.textId =
                                0x6063 as libc::c_int as u16_0
                        } else if gSaveContext.infTable[23 as libc::c_int as
                                                            usize] as
                                      libc::c_int & 0x40 as libc::c_int == 0 {
                            (*this).actor.textId =
                                0x6061 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x6062 as libc::c_int as u16_0
                        }
                    }
                    2 => {
                        if gBitFlags[QUEST_MEDALLION_SPIRIT as libc::c_int as
                               ...
                               gSaveContext.inventory.questItems != 0 {
                            (*this).actor.textId =
                                0x6066 as libc::c_int as u16_0
                        } else if gSaveContext.infTable[23 as libc::c_int as
                                                            usize] as
                                      libc::c_int & 0x100 as libc::c_int == 0
                         {
                            (*this).actor.textId =
                                0x6064 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x6065 as libc::c_int as u16_0
                        }
                    }
                    3 => {
                        if gBitFlags[QUEST_MEDALLION_SPIRIT as libc::c_int as
                               ...
                               gSaveContext.inventory.questItems != 0 {
                            (*this).actor.textId =
                                0x6068 as libc::c_int as u16_0
                        } else {
                            (*this).actor.textId =
                                0x6067 as libc::c_int as u16_0
                        }
                    }
                    _ => { }
                }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_TentIdle(mut this: *mut EnDaiku,
                                          mut globalCtx: *mut GlobalContext) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Jailed(mut this: *mut EnDaiku,
                                        mut globalCtx: *mut GlobalContext) {
    let mut gerudo: *mut EnGeldB = 0 as *mut EnGeldB;
    let mut temp_t9: s32 = 0;
    let mut temp_v1: s32 = 0;
    if (*this).stateFlags & (1 as libc::c_int) << 3 as libc::c_int == 0 {
        EnDaiku_UpdateText(this, globalCtx);
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    gerudo =
        Actor_Find(&mut (*globalCtx).actorCtx, ACTOR_EN_GELDB as libc::c_int,
                   ACTORCAT_ENEMY as libc::c_int) as *mut EnGeldB;
    if gerudo.is_null() {
        (*this).stateFlags |= (1 as libc::c_int) << 4 as libc::c_int;
        (*this).stateFlags &= !((1 as libc::c_int) << 3 as libc::c_int);
        EnDaiku_Change(this, ENDAIKU_ANIM_CELEBRATE as libc::c_int,
                       &mut (*this).currentAnimIndex);
        (*this).actionFunc =
            Some(EnDaiku_WaitFreedom as
                     unsafe extern "C" fn(_: *mut EnDaiku,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).stateFlags & (1 as libc::c_int) << 3 as libc::c_int == 0
                  && (*gerudo).invisible == 0 {
        (*this).stateFlags |= (1 as libc::c_int) << 3 as libc::c_int;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int |
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_WaitFreedom(mut this: *mut EnDaiku,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_InitEscape(mut this: *mut EnDaiku,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    let mut exitLoop: s32 = 0;
    Audio_PlayFanfare(0x51 as libc::c_int as u16_0);
    EnDaiku_Change(this, ENDAIKU_ANIM_RUN as libc::c_int,
                   &mut (*this).currentAnimIndex);
    (*this).stateFlags &=
        !((1 as libc::c_int) << 1 as libc::c_int |
              (1 as libc::c_int) << 2 as libc::c_int);
    gSaveContext.eventChkInf[9 as libc::c_int as usize] =
        (gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int |
             (1 as libc::c_int) <<
                 ((*this).actor.params as libc::c_int & 3 as libc::c_int)) as
            u16_0;
    (*this).actor.gravity = -1.0f32;
    (*this).escapeSubCamTimer =
        sEscapeSubCamParams[((*this).actor.params as libc::c_int &
                                 3 as libc::c_int) as usize].maxFramesActive;
    EnDaiku_InitSubCamera(this, globalCtx);
    exitLoop = 0 as libc::c_int;
    path =
    ...
    while exitLoop == 0 {
        pointPos =
            (gSegments[(((*path).points as u32_0) << 4 as libc::c_int >>
                 ...
                 *mut Vec3s).offset((*this).waypoint as isize);
        dx =
        ...
        (*this).rotYtowardsPath =
            (Math_FAtan2F(dx, dz) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        dxz = sqrtf(dx * dx + dz * dz);
        if dxz > 10.0f32 {
            exitLoop = 1 as libc::c_int
        } else { (*this).waypoint += 1 }
    }
    (*this).actionFunc =
        Some(EnDaiku_EscapeRotate as
                 unsafe extern "C" fn(_: *mut EnDaiku, _: *mut GlobalContext)
                     -> ());
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_EscapeRotate(mut this: *mut EnDaiku,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut diff: s16 = 0;
    diff =
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).rotYtowardsPath, 1 as libc::c_int as s16,
                           0x1388 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    SkelAnime_Update(&mut (*this).skelAnime);
    if diff as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(EnDaiku_EscapeRun as
                     unsafe extern "C" fn(_: *mut EnDaiku,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_InitSubCamera(mut this: *mut EnDaiku,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut eyePosDeltaLocal: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut eyePosDeltaWorld: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    (*this).subCamActive = 1 as libc::c_int;
    (*this).escapeSubCamTimer =
        sEscapeSubCamParams[((*this).actor.params as libc::c_int &
                                 3 as libc::c_int) as usize].maxFramesActive;
    eyePosDeltaLocal.x =
        sEscapeSubCamParams[((*this).actor.params as libc::c_int &
                                 3 as libc::c_int) as
                                usize].eyePosDeltaLocal.x;
    eyePosDeltaLocal.y =
        sEscapeSubCamParams[((*this).actor.params as libc::c_int &
                                 3 as libc::c_int) as
                                usize].eyePosDeltaLocal.y;
    eyePosDeltaLocal.z =
        sEscapeSubCamParams[((*this).actor.params as libc::c_int &
                                 3 as libc::c_int) as
                                usize].eyePosDeltaLocal.z;
    Matrix_RotateY((*this).actor.world.rot.y as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut eyePosDeltaLocal, &mut eyePosDeltaWorld);
    (*this).subCamEye.x = (*this).actor.world.pos.x + eyePosDeltaWorld.x;
    (*this).subCamEyeInit.x = (*this).subCamEye.x;
    (*this).subCamEye.y = (*this).actor.world.pos.y + eyePosDeltaWorld.y;
    (*this).subCamEyeInit.y = (*this).subCamEye.y;
    (*this).subCamEye.z = (*this).actor.world.pos.z + eyePosDeltaWorld.z;
    (*this).subCamEyeInit.z = (*this).subCamEye.z;
    (*this).subCamAt.x = (*this).actor.world.pos.x;
    (*this).subCamAtTarget.x = (*this).subCamAt.x;
    (*this).subCamAt.y = (*this).actor.world.pos.y + 60.0f32;
    (*this).subCamAtTarget.y = (*this).subCamAt.y;
    (*this).subCamAt.z = (*this).actor.world.pos.z;
    (*this).subCamAtTarget.z = (*this).subCamAt.z;
    (*this).subCamId = Gameplay_CreateSubCamera(globalCtx) as s32;
    Gameplay_ChangeCameraStatus(globalCtx, 0 as libc::c_int as s16,
                                1 as libc::c_int as s16);
    Gameplay_ChangeCameraStatus(globalCtx, (*this).subCamId as s16,
                                7 as libc::c_int as s16);
    Gameplay_CameraSetAtEye(globalCtx, (*this).subCamId as s16,
                            &mut (*this).subCamAt, &mut (*this).subCamEye);
    Gameplay_CameraSetFov(globalCtx, (*this).subCamId as s16,
                          (*globalCtx).mainCamera.fov);
    func_8002DF54(globalCtx, &mut (*this).actor, 1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_UpdateSubCamera(mut this: *mut EnDaiku,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    (*this).subCamAtTarget.x = (*this).actor.world.pos.x;
    (*this).subCamAtTarget.y = (*this).actor.world.pos.y + 60.0f32;
    (*this).subCamAtTarget.z = (*this).actor.world.pos.z;
    Math_SmoothStepToF(&mut (*this).subCamAt.x, (*this).subCamAtTarget.x,
                       1.0f32, 1000.0f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).subCamAt.y, (*this).subCamAtTarget.y,
                       1.0f32, 1000.0f32, 0.0f32);
    Math_SmoothStepToF(&mut (*this).subCamAt.z, (*this).subCamAtTarget.z,
                       1.0f32, 1000.0f32, 0.0f32);
    Gameplay_CameraSetAtEye(globalCtx, (*this).subCamId as s16,
                            &mut (*this).subCamAt, &mut (*this).subCamEye);
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_EscapeSuccess(mut this: *mut EnDaiku,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut D_809E4148: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 120.0f32,}; init };
    let mut gerudoGuard: *mut Actor = 0 as *mut Actor;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Gameplay_ClearCamera(globalCtx, (*this).subCamId as s16);
    Gameplay_ChangeCameraStatus(globalCtx, 0 as libc::c_int as s16,
                                7 as libc::c_int as s16);
    (*this).subCamActive = 0 as libc::c_int;
    if gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int &
           0xf as libc::c_int == 0xf as libc::c_int {
        Matrix_RotateY((*this).initRot.y as libc::c_int as libc::c_float *
                           (3.14159265358979323846f32 /
                                0x8000 as libc::c_int as libc::c_float),
                       MTXMODE_NEW as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut D_809E4148, &mut vec);
        gerudoGuard =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_GE3 as libc::c_int as s16,
                        (*this).initPos.x + vec.x, (*this).initPos.y + vec.y,
                        (*this).initPos.z + vec.z, 0 as libc::c_int as s16,
                        (Math_FAtan2F(-vec.x, -vec.z) *
                             (0x8000 as libc::c_int as libc::c_float /
                                  3.14159265358979323846f32)) as s16,
                        0 as libc::c_int as s16, 2 as libc::c_int as s16);
        if gerudoGuard.is_null() { Actor_Kill(&mut (*this).actor); }
    } else {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_EscapeRun(mut this: *mut EnDaiku,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut path: *mut Path = 0 as *mut Path;
    ...
    if dxz <= 20.88f32 {
        (*this).waypoint += 1;
        if (*this).waypoint >= (*path).count as libc::c_int {
            if (*this).subCamActive != 0 {
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, ry,
                       1 as libc::c_int as s16, 0xfa0 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).runSpeed, 0.6f32,
                       dxz, 0.0f32);
    ...
    if (*this).subCamActive != 0 {
        ...
        let fresh0 = (*this).escapeSubCamTimer;
        (*this).escapeSubCamTimer = (*this).escapeSubCamTimer - 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDaiku = thisx as *mut EnDaiku;
    ...
    if (*this).currentAnimIndex == ENDAIKU_ANIM_RUN as libc::c_int {
        curFrame = (*this).skelAnime.curFrame as s32;
        if curFrame == 6 as libc::c_int || curFrame == 15 as libc::c_int {
    ...
    if (*this).stateFlags & (1 as libc::c_int) << 1 as libc::c_int != 0 {
        ...
        if (*this).stateFlags & (1 as libc::c_int) << 2 as libc::c_int != 0 {
            func_80034A14(&mut (*this).actor, &mut (*this).unk_244,
...
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDaiku = thisx as *mut EnDaiku;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_daiku.c\x00" as *const u8 as
                        *const libc::c_char, 1227 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if (*thisx).params as libc::c_int & 3 as libc::c_int == 0 as libc::c_int {
            ...
            (170 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int
    } else if (*thisx).params as libc::c_int & 3 as libc::c_int ==
                  1 as libc::c_int {
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnDaiku_OverrideLimbDraw as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_daiku.c\x00" as *const u8 as
                         *const libc::c_char, 1255 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limb: s32,
 ...
 -> s32 {
    ...
    match limb {
        8 => {
            ...
            (*rot).x =
                ((*rot).x as libc::c_int +
                     (*this).unk_244.unk_0E.y as libc::c_int) as s16;
            (*rot).y =
                ((*rot).y as libc::c_int -
                     (*this).unk_244.unk_0E.x as libc::c_int) as s16
        }
        15 => {
            // head
            (*rot).x =
                ((*rot).x as libc::c_int +
                     (*this).unk_244.unk_08.y as libc::c_int) as s16;
            (*rot).z =
                ((*rot).z as libc::c_int +
                     (*this).unk_244.unk_08.x as libc::c_int) as s16
        }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnDaiku_PostLimbDraw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut limb: s32,
                                              mut dList: *mut *mut Gfx,
                                              mut rot: *mut Vec3s,
                                              mut thisx: *mut libc::c_void) {
    static mut hairDLists: [*mut Gfx; 4] =
        unsafe {
            [object_daiku_DL_005BD0.as_ptr() as *mut _,
             object_daiku_DL_005AC0.as_ptr() as *mut _,
             object_daiku_DL_005990.as_ptr() as *mut _,
             object_daiku_DL_005880.as_ptr() as *mut _]
        };
    static mut targetPosHeadLocal: Vec3f =
        {
            let mut init =
                Vec3f{x: 700 as libc::c_int as f32_0,
                      y: 1100 as libc::c_int as f32_0,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_daiku.c\x00" as *const u8 as
                        *const libc::c_char, 1323 as libc::c_int);
    if limb == 15 as libc::c_int {
        // head
        Matrix_MultVec3f(&mut targetPosHeadLocal,
        ...
        (*_g).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            hairDLists[((*this).actor.params as libc::c_int &
                            3 as libc::c_int) as usize] as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_daiku.c\x00" as *const u8 as
                         *const libc::c_char, 1330 as libc::c_int);
}
