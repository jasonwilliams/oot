...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002843C(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                     velocity: *mut Vec3f, accel: *mut Vec3f,
                     primColor: *mut Color_RGBA8, envColor: *mut Color_RGBA8,
                     scale: s16, scaleStep: s16, life: s16);
    #[no_mangle]
    fn EffectSsBomb2_SpawnLayered(globalCtx: *mut GlobalContext,
                                  pos: *mut Vec3f, velocity: *mut Vec3f,
                                  accel: *mut Vec3f, scale: s16,
                                  scaleStep: s16);
    #[no_mangle]
    fn EffectSsKakera_Spawn(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                            velocity: *mut Vec3f, arg3: *mut Vec3f,
                            gravity: s16, arg5: s16, arg6: s16, arg7: s16,
                            arg8: s16, scale: s16, arg10: s16, arg11: s16,
                            life: s32, colorIdx: s16, objId: s16,
                            dList: *mut Gfx);
    #[no_mangle]
    ...
    #[no_mangle]
    fn Matrix_RotateAxis(f: f32_0, vec: *mut Vec3f, mode: u8_0);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gTowerCollapseCsExteriorStructureDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsFlameSmokeDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsCollapsedStructureInnerDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsCollapsedStructureInnerCol: CollisionHeader;
    #[no_mangle]
    static mut gTowerCollapseCsCollapsedStructureOuterDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsCollapsedStructureOuterCol: CollisionHeader;
    #[no_mangle]
    static mut gTowerCollapseCsStandalonePillarDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsWalkwayDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseCsAlternativeWalkwayDL: [Gfx; 0];
    #[no_mangle]
...
pub const ICHAINTYPE_VEC3S: C2RustUnnamed_18 = 10;
pub const ICHAINTYPE_VEC3F_DIV1000: C2RustUnnamed_18 = 9;
pub const ICHAINTYPE_VEC3F: C2RustUnnamed_18 = 8;
pub const ICHAINTYPE_F32_DIV1000: C2RustUnnamed_18 = 7;
pub const ICHAINTYPE_F32: C2RustUnnamed_18 = 6;
pub const ICHAINTYPE_S32: C2RustUnnamed_18 = 5;
pub const ICHAINTYPE_U32: C2RustUnnamed_18 = 4;
pub const ICHAINTYPE_S16: C2RustUnnamed_18 = 3;
pub const ICHAINTYPE_U16: C2RustUnnamed_18 = 2;
pub const ICHAINTYPE_S8: C2RustUnnamed_18 = 1;
pub const ICHAINTYPE_U8: C2RustUnnamed_18 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct GameInfo {
    pub regPage: s32,
...
pub const DPM_UNK3: C2RustUnnamed_19 = 3;
pub const DPM_ENEMY: C2RustUnnamed_19 = 2;
pub const DPM_PLAYER: C2RustUnnamed_19 = 1;
pub const DPM_UNK: C2RustUnnamed_19 = 0;
...
pub type DemoGtUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext) -> ()>;
pub type DemoGtDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_21 = libc::c_int;
pub const KAKERA_COLOR_BROWN: C2RustUnnamed_21 = 1;
pub const KAKERA_COLOR_WHITE: C2RustUnnamed_21 = 0;
pub const KAKERA_COLOR_NONE: C2RustUnnamed_21 = -1;
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGt = thisx as *mut DemoGt;
    if (*this).dyna.actor.params as libc::c_int == 1 as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int == 2 as libc::c_int {
        DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                               (*this).dyna.bgId);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_PlayEarthquakeSfx() {
    func_800788CC((0x2898 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_PlayExplosion1Sfx(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut pos: *mut Vec3f) {
    Audio_PlaySoundAtPosition(globalCtx, pos, 60 as libc::c_int,
                              0x180e as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_PlayExplosion2Sfx(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut pos: *mut Vec3f) {
    Audio_PlaySoundAtPosition(globalCtx, pos, 60 as libc::c_int,
                              0x28c2 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Rumble(mut globalCtx: *mut GlobalContext) {
    func_800AA000(0.0f32, 0x32 as libc::c_int as u8_0,
                  0xa as libc::c_int as u8_0, 5 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_SpawnDust(mut globalCtx: *mut GlobalContext,
                                          mut pos: *mut Vec3f,
                                          mut velocity: *mut Vec3f,
                                          mut accel: *mut Vec3f,
                                          mut scale: f32_0,
                                          mut scaleStep: s16, mut life: s16) {
    static mut brownPrim: Color_RGBA8 =
        {
            let mut init =
    ...
    static mut redEnv: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 255 as libc::c_int as u8_0,
                            g: 110 as libc::c_int as u8_0,
                            b: 96 as libc::c_int as u8_0,
                            a: 0 as libc::c_int as u8_0,};
            init
        };
    func_8002843C(globalCtx, pos, velocity, accel, &mut brownPrim,
                  &mut redEnv,
                  (Rand_ZeroOne() * (scale * 0.2f32) + scale) as s16,
                  scaleStep, life);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097D7D8(mut globalCtx: *mut GlobalContext,
                                       mut pos: *mut Vec3f,
                                       mut velOffset: *mut Vec3f,
                                       mut scale: f32_0, mut arg4: s32,
                                       mut arg5: s32, mut life: s16) {
    let mut pad: s32 = 0;
    if FrameAdvance_IsEnabled(globalCtx) == 0 {
        let mut frames: s32 = (*globalCtx).gameplayFrames as s32;
        if (if frames % arg4 >= 0 as libc::c_int {
                (frames) % arg4
            } else { -(frames % arg4) }) == arg5 {
            let mut pad_0: [s32; 2] = [0; 2];
            let mut velocity: Vec3f =
                {
                    let mut init = Vec3f{x: 0.0f32, y: 6.0f32, z: 0.0f32,};
                    init
                };
            let mut accel: Vec3f =
                {
            ...
            accel.y *= scale;
            accel.z *= scale;
            DemoGt_SpawnDust(globalCtx, pos, &mut velocity, &mut accel,
                             300.0f32 * scale, (15.0f32 * scale) as s16,
                             life);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_SpawnCloudRing(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut pos: *mut Vec3f,
                                               mut params: s16)
 -> *mut Actor {
    return Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                       ACTOR_BG_SPOT16_DOUGHNUT as libc::c_int as s16,
                       (*pos).x, (*pos).y, (*pos).z, 0 as libc::c_int as s16,
                       0 as libc::c_int as s16, 0 as libc::c_int as s16,
                       params);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_SpawnExplosionWithSound(mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut pos: *mut Vec3f,
                                                        mut scale: f32_0) {
    let mut pad: s32 = 0;
    ...
    let mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    EffectSsBomb2_SpawnLayered(globalCtx, pos, &mut velocity, &mut accel,
                               (100.0f32 * scale) as s16,
                               (15.0f32 * scale) as s16);
    DemoGt_PlayExplosion1Sfx(globalCtx, pos);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_SpawnExplosionNoSound(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut pos: *mut Vec3f,
                                                      mut velocity:
                                                          *mut Vec3f,
                                                      mut accel: *mut Vec3f,
                                                      mut scale: f32_0) {
    EffectSsBomb2_SpawnLayered(globalCtx, pos, velocity, accel,
                               (100.0f32 * scale) as s16,
                               (25.0f32 * scale) as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097DAC8(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut spawnerPos: *mut Vec3f) {
    ...
    while i < 12 as libc::c_int {
        pos.x = Math_SinS(angle) * 46.0f32;
        pos.y = Rand_ZeroOne() * 75.0f32 + 2.0f32;
        pos.z = Math_CosS(angle) * 46.0f32;
        velocity.x = pos.x * 0.1f32 + 20.0f32;
        velocity.y = Rand_ZeroOne() * 16.0f32;
        velocity.z = pos.z * 0.1f32;
        pos.x += (*spawnerPos).x;
        pos.y += (*spawnerPos).y;
        pos.z += (*spawnerPos).z;
        temp_f0 = Rand_ZeroOne();
        if temp_f0 < 0.1f32 {
            phi_s0 = 96 as libc::c_int as s16
        } else if temp_f0 < 0.7f32 {
            phi_s0 = 64 as libc::c_int as s16
        } else { phi_s0 = 32 as libc::c_int as s16 }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, spawnerPos,
                             -(247 as libc::c_int) as s16, phi_s0,
                             3 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 10.0f32 + 30.0f32) as s32 as
                                 s16, 2 as libc::c_int as s16,
                             300 as libc::c_int as s16,
                             (Rand_ZeroOne() * 0.0f32) as s32 +
                                 30 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GEFF as libc::c_int as s16,
                             gGanonRubbleDL.as_mut_ptr());
        angle = (angle as libc::c_int + 0x1555 as libc::c_int) as s16;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097DD28(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut spawnerPos: *mut Vec3f) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    while i < 8 as libc::c_int {
        pos.x = Math_SinS(angle) * 30.0f32;
        pos.y = Rand_ZeroOne() * 75.0f32 + 2.0f32;
        pos.z = Math_CosS(angle) * 30.0f32;
        velocity.x = 0.0f32;
        velocity.y = Rand_ZeroOne() * -4.0f32;
        velocity.z = pos.z * 0.1f32;
        pos.x += (*spawnerPos).x;
        pos.y += (*spawnerPos).y;
        pos.z += (*spawnerPos).z;
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, spawnerPos,
                             ...
                             OBJECT_GEFF as libc::c_int as s16,
                             gGanonRubbleDL.as_mut_ptr());
        angle = (angle as libc::c_int + 0x2000 as libc::c_int) as s16;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097DF70(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut spawnerPos: *mut Vec3f) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    i = 0 as libc::c_int;
    while i < 12 as libc::c_int {
        pos.x = Math_SinS(angle) * 16.0f32;
        pos.y = Rand_ZeroOne() * 5.0f32 + 2.0f32;
        pos.z = Math_CosS(angle) * 16.0f32;
        velocity.x = pos.x * 0.6f32;
        velocity.y = Rand_ZeroOne() * 36.0f32 + 6.0f32;
        velocity.z = pos.z * 0.6f32;
        pos.x += (*spawnerPos).x;
        pos.y += (*spawnerPos).y;
        pos.z += (*spawnerPos).z;
        temp_f0 = Rand_ZeroOne();
        if temp_f0 < 0.1f32 {
            phi_s0 = 97 as libc::c_int as s16
        } else if temp_f0 < 0.7f32 {
            phi_s0 = 65 as libc::c_int as s16
        } else { phi_s0 = 33 as libc::c_int as s16 }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, spawnerPos,
                             -(200 as libc::c_int) as s16, phi_s0,
                             10 as libc::c_int as s16,
                             10 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 30.0f32 + 30.0f32) as s16,
                             2 as libc::c_int as s16,
                             300 as libc::c_int as s16,
                             (Rand_ZeroOne() * 30.0f32) as s32 +
                                 30 as libc::c_int,
                             KAKERA_COLOR_NONE as libc::c_int as s16,
                             OBJECT_GEFF as libc::c_int as s16,
                             gGanonRubbleDL.as_mut_ptr());
...
#[no_mangle]
pub unsafe extern "C" fn func_8097E1D4(mut globalCtx: *mut GlobalContext,
                                       mut arg1: *mut Vec3f, mut arg2: s16) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_f0: f32_0 = 0.;
    let mut angle: s16 = 0;
    ...
    while i < 1 as libc::c_int {
        pos.x = Math_SinS(angle) * 46.0f32;
        pos.y = Rand_ZeroOne() * 75.0f32 - 28.0f32;
        pos.z = Math_CosS(angle) * 46.0f32;
        velocity.x = Math_SinS(arg2) * 3.0f32;
        velocity.y = Rand_ZeroOne() * -4.0f32 + 10.0f32;
        velocity.z = Math_CosS(arg2) * 3.0f32;
        pos.x += (*arg1).x;
        pos.y += (*arg1).y;
        pos.z += (*arg1).z;
        temp_f0 = Rand_ZeroOne();
        ...
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, arg1,
                             -(247 as libc::c_int) as s16, phi_s0,
                             3 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16,
                             (Rand_ZeroOne() * 10.0f32 + 30.0f32) as s32 as
                             ...
                             OBJECT_GEFF as libc::c_int as s16,
                             gGanonRubbleDL.as_mut_ptr());
        angle = (angle as libc::c_int + 0x10000 as libc::c_int) as s16;
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097E454(mut globalCtx: *mut GlobalContext,
                                       mut spawnerPos: *mut Vec3f,
                                       mut velocity: *mut Vec3f,
                                       mut accel: *mut Vec3f, mut arg4: f32_0,
                                       mut scale: f32_0, mut arg6: s32,
                                       mut arg7: s32, mut life: s16) {
    let mut pad2: [s32; 3] = [0; 3];
    let mut increment: s16 = 0;
    let mut frames: s32 = 0;
    let mut i: s32 = 0;
    let mut phi_s0: s16 = 0;
    let mut dustScaleStep: s16 = (15.0f32 * scale) as s16;
    let mut dustScale: f32_0 = 300.0f32 * scale;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if FrameAdvance_IsEnabled(globalCtx) == 0 && arg7 > 0 as libc::c_int &&
           arg6 > 0 as libc::c_int {
        frames =
            (if (*globalCtx).gameplayFrames as s32 >= 0 as libc::c_int {
                 (*globalCtx).gameplayFrames as s32
             } else { -((*globalCtx).gameplayFrames as s32) }) % arg7;
        phi_s0 = (0x10000 as libc::c_int * frames / arg6) as s16;
        increment = (0x10000 as libc::c_int / arg6) as s16;
        i = frames;
        while i < arg6 {
            pos.x = Math_SinS(phi_s0) * arg4 + (*spawnerPos).x;
            pos.y = (*spawnerPos).y;
            pos.z = Math_CosS(phi_s0) * arg4 + (*spawnerPos).z;
            DemoGt_SpawnDust(globalCtx, &mut pos, velocity, accel, dustScale,
                             dustScaleStep, life);
            if Rand_ZeroOne() <= 0.05f32 {
                func_8097E1D4(globalCtx, &mut pos, phi_s0);
            }
            phi_s0 =
                (phi_s0 as libc::c_int + increment as libc::c_int) as s16;
            i += arg7
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097E69C(mut globalCtx: *mut GlobalContext)
 -> u8_0 {
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_GetNpcAction(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut actionIdx: u32_0)
 -> *mut CsCmdActorAction {
    let mut pad: [s32; 2] = [0; 2];
    let mut ret: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    if func_8097E69C(globalCtx) == 0 {
        ret = (*globalCtx).csCtx.npcActions[actionIdx as usize]
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn func_8097E704(mut globalCtx: *mut GlobalContext,
                                       mut arg1: u16_0, mut arg2: s32)
 -> u8_0 {
    let mut action: *mut CsCmdActorAction =
        DemoGt_GetNpcAction(globalCtx, arg2 as u32_0);
    if !action.is_null() &&
           (*action).action as libc::c_int == arg1 as libc::c_int {
        return 1 as libc::c_int as u8_0
    } else { return 0 as libc::c_int as u8_0 };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097E744(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut actionIdx: u32_0) {
    let mut npcAction: *mut CsCmdActorAction =
        DemoGt_GetNpcAction(globalCtx, actionIdx);
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
...
pub unsafe extern "C" fn func_8097E824(mut this: *mut DemoGt, mut arg1: s32) {
    ...
    if arg1 == 1 as libc::c_int {
        ...
        phi_a2 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 38 as libc::c_int) as
                                   usize] as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        phi_a3 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 39 as libc::c_int) as
                                   usize] as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        phi_f14 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        phi_f2 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  ...
                                  usize] as libc::c_int as libc::c_float *
                0.1f32
    } else if arg1 == 5 as libc::c_int {
        phi_a1 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 43 as libc::c_int) as
                                   usize] as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        phi_a2 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        phi_f14 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 40 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float *
                0.1f32;
        phi_f12 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        phi_f12 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 47 as libc::c_int) as
                                  usize] as libc::c_int as libc::c_float *
                0.1f32 + 0.5f32;
        phi_f2 =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
    ...
    (*unk16C).x = ((*unk16C).x as libc::c_int + phi_a1 as libc::c_int) as s16;
    (*unk16C).y = ((*unk16C).y as libc::c_int + phi_a2 as libc::c_int) as s16;
    (*unk16C).z = ((*unk16C).z as libc::c_int + phi_a3 as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_8097ED64(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut actionIdx: s32) {
    func_8097E744(this, globalCtx, actionIdx as u32_0);
    func_8097E824(this, actionIdx);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097ED94() -> u8_0 {
    ...
    } else { return 1 as libc::c_int as u8_0 };
}
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
#[no_mangle]
pub unsafe extern "C" fn func_8097EDD8(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut collision: *mut CollisionHeader) {
    let mut pad: [s32; 3] = [0; 3];
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    if !collision.is_null() {
        Actor_ProcessInitChain(&mut (*this).dyna.actor,
                               sInitChain.as_mut_ptr());
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        colHeader = 0 as *mut CollisionHeader;
        CollisionHeader_GetVirtual(collision as *mut libc::c_void,
                                   &mut colHeader);
        (*this).dyna.bgId =
...
#[no_mangle]
pub unsafe extern "C" fn func_8097EE44(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext,
                                       mut updateMode: s32,
                                       mut drawConfig: s32,
                                       mut colHeader: *mut CollisionHeader)
 -> u8_0 {
    if func_8097ED94() != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097EEA8_Init0(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 0 as libc::c_int, 1 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097EF00(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 527 as libc::c_int {
        func_800F3F3C(13 as libc::c_int as u8_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097EF34(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_8097EF40(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pad1: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -16.0f32, z: 0.0f32,}; init };
    let mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 1.2f32, z: 0.0f32,}; init };
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut pad: s32 = 0;
    if (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                              16 as libc::c_int + 1 as libc::c_int) as usize]
           as libc::c_int == 20 as libc::c_int ||
           frames as libc::c_int == 220 as libc::c_int {
        dustPos.x = (*pos).x + 256.0f32;
        dustPos.y = (*pos).y + 679.0f32;
        dustPos.z = (*pos).z + 82.0f32;
        DemoGt_SpawnDust(globalCtx, &mut dustPos, &mut velocity, &mut accel,
                         1700.0f32, 15 as libc::c_int as s16,
                         30 as libc::c_int as s16);
        dustPos.x = (*pos).x + 256.0f32;
        dustPos.y = (*pos).y + 679.0f32;
        dustPos.z = (*pos).z - 60.0f32;
        DemoGt_SpawnDust(globalCtx, &mut dustPos, &mut velocity, &mut accel,
                         1700.0f32, 15 as libc::c_int as s16,
                         30 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8097F0AC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut sp38: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad1: [s16; 3] = [0; 3];
    let mut sp24: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pad2: s32 = 0;
    if frames as libc::c_int == 140 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 19 as libc::c_int {
        sp38.x = (*this).dyna.actor.world.pos.x + 260.0f32;
        sp38.y = (*this).dyna.actor.world.pos.y + 340.0f32;
        sp38.z = (*this).dyna.actor.world.pos.z + 45.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut sp38, 2.0f32);
    }
    if frames as libc::c_int == 176 as libc::c_int {
        sp24.x = (*this).dyna.actor.world.pos.x + 260.0f32;
        sp24.y = (*this).dyna.actor.world.pos.y + 840.0f32;
        sp24.z = (*this).dyna.actor.world.pos.z + 45.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut sp24, 2.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F19C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097F1D8(mut this: *mut DemoGt) {
    let mut temp_v0: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp_v0 *
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
             ...
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                  ...
                  10.0f32)) as s16;
    (*this).unk_172 =
        ((*this).unk_172 as libc::c_int + (*this).unk_174 as libc::c_int) as
            s16;
    if (*this).unk_172 as libc::c_int >
           ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                   16 as libc::c_int + 73 as libc::c_int) as
                                  usize] as libc::c_int +
                0x250 as libc::c_int) as s16 as libc::c_int {
        (*this).unk_172 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 73 as libc::c_int) as
                                   usize] as libc::c_int +
                 0x250 as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F280(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut unk178: *mut s32 = (*this).unk_178.as_mut_ptr();
    let mut unk188: *mut s32 = (*this).unk_188.as_mut_ptr();
    let mut unk198: *mut s32 = (*this).unk_198.as_mut_ptr();
    let mut temp_f0: f32_0 = 0.;
    if ((*globalCtx).csCtx.frames as libc::c_int) < 160 as libc::c_int {
        *unk178.offset(0 as libc::c_int as isize) = 100 as libc::c_int;
        *unk178.offset(1 as libc::c_int as isize) = 255 as libc::c_int;
        *unk178.offset(2 as libc::c_int as isize) = 200 as libc::c_int;
        *unk188.offset(0 as libc::c_int as isize) = 255 as libc::c_int;
        *unk188.offset(1 as libc::c_int as isize) = 120 as libc::c_int;
        *unk188.offset(2 as libc::c_int as isize) = 100 as libc::c_int;
        let ref mut fresh0 = *unk198.offset(0 as libc::c_int as isize);
        *fresh0 += 1;
        let ref mut fresh1 = *unk198.offset(1 as libc::c_int as isize);
        *fresh1 -= 1
    } else if ((*globalCtx).csCtx.frames as libc::c_int) < 170 as libc::c_int
     {
        temp_f0 =
            Environment_LerpWeightAccelDecel(170 as libc::c_int as u16_0,
                                             160 as libc::c_int as u16_0,
                                             (*globalCtx).csCtx.frames,
                                             0 as libc::c_int as u16_0,
                                             0 as libc::c_int as u16_0);
        *unk178.offset(0 as libc::c_int as isize) =
            (temp_f0 * -63.0f32 + 163.0f32) as s32;
        *unk178.offset(1 as libc::c_int as isize) =
            (temp_f0 * -155.0f32 + 255.0f32) as s32;
        *unk178.offset(2 as libc::c_int as isize) =
            (temp_f0 * -100.0f32 + 200.0f32) as s32;
        *unk188.offset(0 as libc::c_int as isize) =
            (temp_f0 * -155.0f32 + 255.0f32) as s32;
        *unk188.offset(1 as libc::c_int as isize) =
            (temp_f0 * -20.0f32 + 120.0f32) as s32;
        *unk188.offset(2 as libc::c_int as isize) = 100 as libc::c_int
    } else {
        *unk178.offset(0 as libc::c_int as isize) = 100 as libc::c_int;
        *unk178.offset(1 as libc::c_int as isize) = 100 as libc::c_int;
        *unk178.offset(2 as libc::c_int as isize) = 100 as libc::c_int;
        *unk188.offset(0 as libc::c_int as isize) = 100 as libc::c_int;
        *unk188.offset(1 as libc::c_int as isize) = 100 as libc::c_int;
        *unk188.offset(2 as libc::c_int as isize) = 100 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F3EC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 1 as libc::c_int)
           != 0 {
        (*this).updateMode = 8 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update0(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097F280(this, globalCtx);
    func_8097E824(this, 1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update8(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097F280(this, globalCtx);
    func_8097F1D8(this);
    func_8097ED64(this, globalCtx, 1 as libc::c_int);
    func_8097F19C(this, globalCtx);
    DemoGt_PlayEarthquakeSfx();
    DemoGt_Rumble(globalCtx);
    func_8097EF00(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw1(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut gameplayFrames: u32_0 = (*globalCtx).gameplayFrames;
    let mut pad2: [s16; 2] = [0; 2];
    let mut spC6: s16 = 0;
    let mut spC0: f32_0 = 0.;
    let mut spBC: f32_0 = 0.;
    let mut spBA: s16 = 0;
    let mut spB8: s16 = 0;
    let mut spB4: *mut Mtx = 0 as *mut Mtx;
    let mut spA8: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp9C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp98: f32_0 = 0.;
    let mut unk198: *mut s32 = 0 as *mut s32;
    let mut unk188: *mut s32 = 0 as *mut s32;
    let mut unk178: *mut s32 = 0 as *mut s32;
    spC6 = (*this).unk_172;
    spC0 =
        fabsf(spC6 as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       0x8000 as libc::c_int as libc::c_float));
    spBC =
        (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 71 as libc::c_int) as
                              usize] as f32_0;
    spB8 =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 70 as libc::c_int) as
                               usize] as s32 as s16 as libc::c_int +
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part1.c\x00" as *const u8 as
                        *const libc::c_char, 458 as libc::c_int);
    ...
    Matrix_Push();
    Matrix_RotateAxis(spC0, &mut spA8, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate(sp9C.x, sp9C.y, sp9C.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(spB4,
                 b"../z_demo_gt_part1.c\x00" as *const u8 as
                     *const libc::c_char as *mut libc::c_char,
                 474 as libc::c_int);
    unk198 = (*this).unk_198.as_mut_ptr();
    unk188 = (*this).unk_188.as_mut_ptr();
    unk178 = (*this).unk_178.as_mut_ptr();
    Matrix_Pop();
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScrollEnvColor(gfxCtx, 0 as libc::c_int,
                                 0 as libc::c_int as u32_0,
                                 *unk198.offset(0 as libc::c_int as isize) as
                                     u32_0, 0x20 as libc::c_int,
                                 0x40 as libc::c_int, 1 as libc::c_int,
                                 0 as libc::c_int as u32_0,
                                 *unk198.offset(1 as libc::c_int as isize) as
                                     u32_0, 0x20 as libc::c_int,
                                 0x40 as libc::c_int,
                                 *unk178.offset(0 as libc::c_int as isize),
                                 *unk178.offset(1 as libc::c_int as isize),
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScrollEnvColor(gfxCtx, 0 as libc::c_int,
                                 ...
                                 *unk188.offset(0 as libc::c_int as isize),
                                 *unk188.offset(1 as libc::c_int as isize),
                                 *unk188.offset(2 as libc::c_int as isize),
                                 0x80 as libc::c_int) as libc::c_uint;
    ...
    (*_g_1).words.w0 =
        (0xda as libc::c_int as u32_0 &
            ...
            (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                 ...
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = spB4 as libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gTowerCollapseCsExteriorStructureDL.as_mut_ptr() as libc::c_uint;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 =
        Gfx_TwoTexScroll(gfxCtx, 0 as libc::c_int, 0 as libc::c_int as u32_0,
                         gameplayFrames.wrapping_mul(0x14 as libc::c_int as
                                                         libc::c_uint),
                         0x10 as libc::c_int, 0x200 as libc::c_int,
                         1 as libc::c_int, 0 as libc::c_int as u32_0,
                         gameplayFrames.wrapping_mul(0x1e as libc::c_int as
                                                         libc::c_uint),
                         0x10 as libc::c_int, 0x200 as libc::c_int) as
            libc::c_uint;
    ...
    (*_g_5).words.w0 =
        (0xda as libc::c_int as u32_0 &
            ...
            (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                 ...
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 = spB4 as libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 =
        gTowerCollapseCsFlameSmokeDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part1.c\x00" as *const u8 as
                         *const libc::c_char, 557 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F904_Init1(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 1 as libc::c_int, 2 as libc::c_int,
                  &mut gTowerCollapseCsCollapsedStructureInnerCol);
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F960(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_8097F96C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    static mut cloudRing: *mut Actor = 0 as *const Actor as *mut Actor;
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut actor: *mut Actor = 0 as *mut Actor;
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int > 1059 as libc::c_int &&
           (frames as libc::c_int) < 1062 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 17 as libc::c_int {
        pos.x = (*this).dyna.actor.world.pos.x;
        pos.y = (*this).dyna.actor.world.pos.y + 612.0f32;
        pos.z = (*this).dyna.actor.world.pos.z;
        if cloudRing.is_null() {
            cloudRing =
                DemoGt_SpawnCloudRing(globalCtx, &mut pos,
                                      2 as libc::c_int as s16)
        } else {
            actor = cloudRing;
...
#[no_mangle]
pub unsafe extern "C" fn func_8097FA1C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut velOffset: Vec3f =
        {
            let mut init =
                Vec3f{x: -12.0f32, y: -17.0f64 as f32_0, z: 5.0f64 as f32_0,};
            init
        };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 502 as libc::c_int &&
           !(frames as libc::c_int >= 581 as libc::c_int) ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 5 as libc::c_int {
        dustPos.x = (*pos).x + 300.0f32;
        dustPos.y = (*pos).y + 360.0f32;
        dustPos.z = (*pos).z - 377.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
                      6 as libc::c_int, 1 as libc::c_int,
                      35 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097FAFC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    static mut velocity: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 1.0f32, z: 0.0f32,}; init };
    static mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut arg4: f32_0 = 280.0f32;
    static mut scale: f32_0 = 8.0f32;
    static mut arg6: s32 = 11 as libc::c_int;
    static mut arg7: s32 = 1 as libc::c_int;
    static mut life: s16 = 3 as libc::c_int as s16;
    let mut pad: [s32; 2] = [0; 2];
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut new_var: f32_0 = -200.0f64 as f32_0;
    if frames as libc::c_int > 582 as libc::c_int &&
           (frames as libc::c_int) < 683 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 6 as libc::c_int {
        pos = (*this).dyna.actor.world.pos;
        pos.y += 680.0f32;
        if frames as libc::c_int == 682 as libc::c_int {
            velocity.y += new_var
        } else if frames as libc::c_int == 681 as libc::c_int {
            accel.y += new_var
        }
        func_8097E454(globalCtx, &mut pos, &mut velocity, &mut accel, arg4,
                      scale, arg6, arg7, life);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097FC1C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -16.0f32, z: -16.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 682 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 7 as libc::c_int {
        dustPos.x = (*pos).x + 260.0f32;
        dustPos.y = (*pos).y + 360.0f32;
        dustPos.z = (*pos).z + 260.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_8097FCE4(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 0x1f7 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 4 as libc::c_int {
        vec.x = (*this).dyna.actor.world.pos.x + 300.0f32;
        vec.y = (*this).dyna.actor.world.pos.y + 560.0f32;
        vec.z = (*this).dyna.actor.world.pos.z - 377.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut vec, 2.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097FD70(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8097FDDC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut unk178: *mut s32 = (*this).unk_178.as_mut_ptr();
    let mut unk198: *mut s32 = (*this).unk_198.as_mut_ptr();
    if ((*globalCtx).csCtx.frames as libc::c_int) < 610 as libc::c_int {
        *unk178.offset(0 as libc::c_int as isize) = 163 as libc::c_int;
        *unk178.offset(1 as libc::c_int as isize) = 193 as libc::c_int;
        *unk178.offset(2 as libc::c_int as isize) = 193 as libc::c_int;
        let ref mut fresh10 = *unk198.offset(0 as libc::c_int as isize);
        *fresh10 += 1;
        let ref mut fresh11 = *unk198.offset(1 as libc::c_int as isize);
        *fresh11 -= 1
    } else if ((*globalCtx).csCtx.frames as libc::c_int) < 620 as libc::c_int
     {
        let mut temp_f0: f32_0 =
            Environment_LerpWeightAccelDecel(620 as libc::c_int as u16_0,
                                             610 as libc::c_int as u16_0,
                                             (*globalCtx).csCtx.frames,
                                             0 as libc::c_int as u16_0,
                                             0 as libc::c_int as u16_0);
        *unk178.offset(0 as libc::c_int as isize) =
            (temp_f0 * -13.0f32 + 163.0f32) as s32;
        *unk178.offset(1 as libc::c_int as isize) =
            (temp_f0 * -43.0f32 + 193.0f32) as s32;
        *unk178.offset(2 as libc::c_int as isize) =
            (temp_f0 * -43.0f32 + 193.0f32) as s32
    } else {
        *unk178.offset(0 as libc::c_int as isize) = 150 as libc::c_int;
        *unk178.offset(1 as libc::c_int as isize) = 150 as libc::c_int;
        *unk178.offset(2 as libc::c_int as isize) = 150 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8097FED8(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 2 as libc::c_int)
           != 0 {
        (*this).updateMode = 9 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update1(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097FDDC(this, globalCtx);
    func_8097E824(this, 2 as libc::c_int);
    func_8097FD70(this, globalCtx);
    func_8097FED8(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update9(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097FDDC(this, globalCtx);
    func_8097ED64(this, globalCtx, 2 as libc::c_int);
    func_8097FD70(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw2(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut unk198: *mut s32 = 0 as *mut s32;
    let mut unk178: *mut s32 = 0 as *mut s32;
    ...
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part2.c\x00" as *const u8 as
                        *const libc::c_char, 470 as libc::c_int);
    func_80093D18(gfxCtx);
    unk198 = (*this).unk_198.as_mut_ptr();
    unk178 = (*this).unk_178.as_mut_ptr();
    ...
    (*_g_0).words.w0 =
        (0xda as libc::c_int as u32_0 &
            ...
            ((0 as libc::c_int / 8 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((0x1 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                  0x1 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        gTowerCollapseCsCollapsedStructureInnerDL.as_mut_ptr() as
            libc::c_uint;
    let fresh15 = (*__gfxCtx).polyOpa.p;
    (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
    let mut _g_2: *mut Gfx = fresh15;
    (*_g_2).words.w0 =
        (0xd8 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((64 as libc::c_int - 1 as libc::c_int) / 8 as libc::c_int) as
                 u32_0 &
                 (((0x1 as libc::c_int) << 5 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 19 as libc::c_int
            |
            ...
            (2 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = (1 as libc::c_int * 64 as libc::c_int) as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part2.c\x00" as *const u8 as
                         *const libc::c_char, 489 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80980110_Init2(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 2 as libc::c_int, 3 as libc::c_int,
                  &mut gTowerCollapseCsCollapsedStructureOuterCol);
}
#[no_mangle]
pub unsafe extern "C" fn func_8098016C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80980178(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80980184(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    static mut cloudRing: *mut Actor = 0 as *const Actor as *mut Actor;
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut actor: *mut Actor = 0 as *mut Actor;
    if (*globalCtx).csCtx.frames as libc::c_int > 1027 as libc::c_int &&
           ((*globalCtx).csCtx.frames as libc::c_int) < 1031 as libc::c_int {
        pos.x = (*this).dyna.actor.world.pos.x;
        pos.y = (*this).dyna.actor.world.pos.y + 247.0f32;
        pos.z = (*this).dyna.actor.world.pos.z;
        if cloudRing.is_null() {
            cloudRing =
                DemoGt_SpawnCloudRing(globalCtx, &mut pos,
...
#[no_mangle]
pub unsafe extern "C" fn func_80980218(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    static mut cloudRing: *mut Actor = 0 as *const Actor as *mut Actor;
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut actor: *mut Actor = 0 as *mut Actor;
    if (*globalCtx).csCtx.frames as libc::c_int > 997 as libc::c_int &&
           ((*globalCtx).csCtx.frames as libc::c_int) < 1001 as libc::c_int {
        pos.x = (*this).dyna.actor.home.pos.x;
        pos.y = (*this).dyna.actor.home.pos.y + 38.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_809802AC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -10.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 109 as libc::c_int &&
           (frames as libc::c_int) < 140 as libc::c_int {
        dustPos.x = (*pos).x - 100.0f32;
        dustPos.y = (*pos).y + 1260.0f32;
        dustPos.z = (*pos).z - 323.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 4.0f32,
                      3 as libc::c_int, 0 as libc::c_int,
                      20 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8098036C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut world: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -3.0f32, z: 0.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 284 as libc::c_int &&
           (frames as libc::c_int) < 421 as libc::c_int {
        dustPos.x = (*world).x + 760.0f32;
        dustPos.y = (*world).y - 40.0f32;
        dustPos.z = (*world).z - 240.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
                      6 as libc::c_int, 1 as libc::c_int,
                      35 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80980430(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -3.0f32, z: 0.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames > 709 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 8 as libc::c_int {
        dustPos.x = (*pos).x + 760.0f32;
        dustPos.y = (*pos).y - 40.0f32;
        dustPos.z = (*pos).z - 240.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
                      6 as libc::c_int, 1 as libc::c_int,
                      35 as libc::c_int as s16);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80980504(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    ...
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -16.0f32, z: -16.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 704 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 9 as libc::c_int {
        dustPos.x = (*pos).x + 830.0f32;
        dustPos.y = (*pos).y + 60.0f32;
        dustPos.z = (*pos).z + 390.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_809805D8(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut homePos: *mut Vec3f = &mut (*this).dyna.actor.home.pos;
    let mut velOffset: Vec3f =
        {
            let mut init =
                Vec3f{x: 15.0f32, y: -26.0f64 as f32_0, z: 0.0f32,};
            init
        };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 739 as libc::c_int &&
           (frames as libc::c_int) < 781 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 11 as libc::c_int {
        dustPos.x = (*homePos).x + 550.0f32;
        dustPos.y = (*homePos).y - 110.0f32;
        dustPos.z = (*homePos).z + 50.0f32;
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 6.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_809806B8(mut this: *mut DemoGt,
                                       mut globalContext:
                                           *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalContext).csCtx.frames;
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -16.0f32, z: -16.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 964 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 12 as libc::c_int {
        dustPos.x = (*pos).x + 460.0f32;
        dustPos.y = (*pos).y + 60.0f32;
        dustPos.z = (*pos).z + 760.0f32;
        func_8097D7D8(globalContext, &mut dustPos, &mut velOffset, 6.0f32,
                      6 as libc::c_int, 3 as libc::c_int,
                      35 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8098078C(mut this: *mut DemoGt,
                                       mut globalContext:
                                           *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    let mut velOffset: Vec3f =
        { let mut init = Vec3f{x: 5.0f32, y: -16.0f32, z: -16.0f32,}; init };
    let mut pad1: [s32; 3] = [0; 3];
    if frames as libc::c_int > 939 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 14 as libc::c_int {
        dustPos.x = (*pos).x + 360.0f32;
        dustPos.y = (*pos).y + 70.0f32;
        dustPos.z = (*pos).z - 640.0f32;
        func_8097D7D8(globalContext, &mut dustPos, &mut velOffset,
                      6.0f64 as f32_0, 6 as libc::c_int, 0 as libc::c_int,
                      35 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8098085C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut sp28: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut pos: *mut Vec3f = &mut (*this).dyna.actor.world.pos;
    if frames as libc::c_int == 58 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 1 as libc::c_int {
        sp28.x = (*pos).x + 900.0f32;
        sp28.y = (*pos).y - 50.0f32;
        sp28.z = (*pos).z + 93.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut sp28, 2.0f32);
    } else if frames as libc::c_int == 80 as libc::c_int {
        sp28.x = (*pos).x + 810.0f32;
        sp28.y = (*pos).y + 200.0f32;
        sp28.z = (*pos).z - 37.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut sp28, 0.9f32);
    } else if frames as libc::c_int == 90 as libc::c_int {
        sp28.x = (*pos).x - 220.0f32;
        sp28.y = (*pos).y + 1350.0f32;
        sp28.z = (*pos).z - 287.0f32;
        DemoGt_SpawnExplosionWithSound(globalCtx, &mut sp28, 2.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809809C0(mut this: *mut DemoGt,
                                       mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this2: *mut DemoGt = this;
    let mut gameplayFrames: s32 = (*globalCtx).gameplayFrames as s32;
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    let mut sp54: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: [s16; 3] = [0; 3];
    if frames as libc::c_int > 469 as libc::c_int &&
           (frames as libc::c_int) < 481 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 3 as libc::c_int {
        let mut sp40: Vec3f =
            { let mut init = Vec3f{x: 20.0f32, y: 6.0f32, z: 0.0f32,}; init };
        let mut sp34: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut pad2: [s16; 3] = [0; 3];
        sp54.x = (*this2).dyna.actor.world.pos.x + 790.0f32;
        sp54.y = (*this2).dyna.actor.world.pos.y + 60.0f32;
        sp54.z = (*this2).dyna.actor.world.pos.z + 23.0f32;
        if (if gameplayFrames % 12 as libc::c_int >= 0 as libc::c_int {
                (gameplayFrames) % 12 as libc::c_int
            } else { -(gameplayFrames % 12 as libc::c_int) }) ==
               0 as libc::c_int {
            DemoGt_SpawnExplosionNoSound(globalCtx, &mut sp54, &mut sp40,
                                         &mut sp34, 2.0f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80980AD4(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 477 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 2 as libc::c_int) as
                                 usize] as libc::c_int == 1 as libc::c_int {
        pos.x = (*this).dyna.actor.world.pos.x + 790.0f32;
        pos.y = (*this).dyna.actor.world.pos.y + 60.0f32;
        pos.z = (*this).dyna.actor.world.pos.z + 23.0f32;
        func_8097DAC8(this, globalCtx, &mut pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &mut pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80980B68(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 317 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 3 as libc::c_int) as
                                 usize] as libc::c_int == 1 as libc::c_int {
        pos.x = (*this).dyna.actor.world.pos.x + 980.0f32;
        pos.y = (*this).dyna.actor.world.pos.y + 410.0f32;
        pos.z = (*this).dyna.actor.world.pos.z - 177.0f32;
        func_8097DD28(this, globalCtx, &mut pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &mut pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80980BFC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 4] = [0; 4];
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 740 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        pos.y = (*this).dyna.actor.world.pos.y + 60.0f32;
        pos.z = (*this).dyna.actor.world.pos.z + 23.0f32;
        func_8097DF70(this, globalCtx, &mut pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &mut pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80980C90(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80980D74(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 3 as libc::c_int)
           != 0 {
        (*this).updateMode = 10 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update2(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 3 as libc::c_int);
    func_80980C90(this, globalCtx);
    func_80980D74(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update10(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097ED64(this, globalCtx, 3 as libc::c_int);
    func_80980C90(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw3(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part3.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gTowerCollapseCsCollapsedStructureOuterDL.as_mut_ptr() as
            libc::c_uint;
    ...
    (*_g_1).words.w0 =
        (0xd8 as libc::c_int as u32_0 &
            ...
            (2 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = (1 as libc::c_int * 64 as libc::c_int) as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part3.c\x00" as *const u8 as
                         *const libc::c_char, 1032 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80980F00_Init5(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 3 as libc::c_int, 4 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_80980F58(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 244 as libc::c_int {
        func_80078914(&mut (*this).dyna.actor.projectedPos,
                      (0x28de as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80980F8C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut sp58: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int > 259 as libc::c_int &&
           (frames as libc::c_int) < 289 as libc::c_int {
        let mut velOfset: Vec3f =
            {
                let mut init = Vec3f{x: 0.0f32, y: -17.0f32, z: 0.0f32,};
                init
            };
        let mut pad_0: [s32; 3] = [0; 3];
        sp58.x = 640.0f32;
        sp58.y = 2100.0f32;
        sp58.z = -170.0f32;
        Matrix_MultVec3f(&mut sp58, &mut dustPos);
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOfset, 3.0f32,
                      5 as libc::c_int, 0 as libc::c_int,
                      30 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8098103C(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 4 as libc::c_int)
           != 0 {
        (*this).updateMode = 11 as libc::c_int
    } else if func_8097E704(globalCtx, 3 as libc::c_int as u16_0,
                            4 as libc::c_int) != 0 {
        (*this).updateMode = 16 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update3(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 4 as libc::c_int);
    func_80980F58(this, globalCtx);
    func_8098103C(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update11(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097ED64(this, globalCtx, 4 as libc::c_int);
    func_80980F58(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update16(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    let mut temp: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp *
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 64 as libc::c_int) as
    ...
    (*this).unk_172 =
        ((*this).unk_172 as libc::c_int + (*this).unk_174 as libc::c_int) as
            s16;
    if (*this).unk_172 as libc::c_int > 0x4000 as libc::c_int {
        (*this).unk_172 = 0x4000 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw4(mut this: *mut DemoGt,
                                      mut globalCtx2: *mut GlobalContext) {
    ...
    let mut sp68: s16 = 0;
    let mut pad2: s16 = 0;
    let mut sp60: *mut Mtx = 0 as *mut Mtx;
    let mut sp54: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp48: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp44: f32_0 = 0.;
    if (frames as libc::c_int) < 301 as libc::c_int {
        sp76 = (*this).unk_172;
        sp70 =
            fabsf(sp76 as libc::c_int as libc::c_float *
                      (3.14159265358979323846f32 /
                           0x8000 as libc::c_int as libc::c_float));
        sp6C =
            (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
        ...
        sp60 =
            Graph_Alloc(gfxCtx,
                        ::std::mem::size_of::<Mtx>() as libc::c_ulong as
                            size_t) as *mut Mtx;
        sp44 = 1.0f32 - Math_CosS(sp76);
        let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
        let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
        __gfxCtx = gfxCtx;
        Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                        b"../z_demo_gt_part4_1.c\x00" as *const u8 as
        ...
        Matrix_Push();
        Matrix_RotateAxis(sp70, &mut sp54,
                          MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(sp48.x, sp48.y, sp48.z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(sp60,
                     b"../z_demo_gt_part4_1.c\x00" as *const u8 as
                         *const libc::c_char as *mut libc::c_char,
            ...
            (0xda as libc::c_int as u32_0 &
                ...
                (((0x1 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int)
                     ...
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g).words.w1 = sp60 as libc::c_uint;
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            gTowerCollapseCsStandalonePillarDL.as_mut_ptr() as libc::c_uint;
        ...
        (*_g_1).words.w0 =
            (0xd8 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                (((64 as libc::c_int - 1 as libc::c_int) / 8 as libc::c_int)
                     as u32_0 &
                     (((0x1 as libc::c_int) << 5 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    19 as libc::c_int |
                ...
                (2 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            (1 as libc::c_int * 64 as libc::c_int) as libc::c_uint;
        Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                         b"../z_demo_gt_part4_1.c\x00" as *const u8 as
                             *const libc::c_char, 246 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809813CC_Init6(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 4 as libc::c_int, 5 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_80981424(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 789 as libc::c_int {
        func_80078914(&mut (*this).dyna.actor.projectedPos,
                      (0x28de as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80981458(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut sp58: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int > 855 as libc::c_int &&
           (frames as libc::c_int) < 891 as libc::c_int ||
           (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  16 as libc::c_int + 1 as libc::c_int) as
                                 usize] as libc::c_int == 13 as libc::c_int {
        let mut velOffset: Vec3f =
            {
                let mut init = Vec3f{x: 0.0f32, y: -30.0f32, z: 0.0f32,};
                init
            };
        let mut pad1: [s32; 3] = [0; 3];
        sp58.x = 0.0f32;
        ...
        sp58.z = -1100.0f32;
        Matrix_MultVec3f(&mut sp58, &mut dustPos);
        func_8097D7D8(globalCtx, &mut dustPos, &mut velOffset, 7.1f32,
                      5 as libc::c_int, 1 as libc::c_int,
                      30 as libc::c_int as s16);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80981524(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 5 as libc::c_int)
           != 0 {
        (*this).updateMode = 12 as libc::c_int
    } else if func_8097E704(globalCtx, 3 as libc::c_int as u16_0,
                            5 as libc::c_int) != 0 {
        (*this).updateMode = 17 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update4(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 5 as libc::c_int);
    func_80981424(this, globalCtx);
    func_80981524(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update12(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097ED64(this, globalCtx, 5 as libc::c_int);
    func_80981424(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update17(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    let mut temp: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp *
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw5(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut pad: s32 = 0;
    let mut sp76: s16 = 0;
    ...
    sp6A =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               ...
                               usize] as libc::c_int - 0x4000 as libc::c_int)
            as s16;
    sp68 =
        (((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                 16 as libc::c_int + 59 as libc::c_int) as
                                usize] as libc::c_int - 0x4000 as libc::c_int)
             as s16 as libc::c_int + 0x4000 as libc::c_int) as s16;
    gfxCtx = (*globalCtx).state.gfxCtx;
    sp60 =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<Mtx>() as libc::c_ulong as size_t)
            as *mut Mtx;
    sp44 = 1 as libc::c_int as libc::c_float - Math_CosS(sp76);
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part4_2.c\x00" as *const u8 as
    ...
    sp48.z = Math_SinS(sp6A) * sp6C * sp44;
    Matrix_Push();
    Matrix_RotateAxis(sp70, &mut sp54, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate(sp48.x, sp48.y, sp48.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(sp60,
                 b"../z_demo_gt_part4_2.c\x00" as *const u8 as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part4_2.c\x00" as *const u8 as
                         *const libc::c_char, 241 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_809818A4_Init7(mut this: *mut DemoGt,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 5 as libc::c_int, 6 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_809818FC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 845 as libc::c_int {
        func_80078914(&mut (*this).dyna.actor.projectedPos,
                      (0x28de as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80981930(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 6 as libc::c_int)
           != 0 {
        (*this).updateMode = 13 as libc::c_int
    } else if func_8097E704(globalCtx, 3 as libc::c_int as u16_0,
                            6 as libc::c_int) != 0 {
        (*this).updateMode = 18 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update5(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 6 as libc::c_int);
    func_809818FC(this, globalCtx);
    func_80981930(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update13(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_8097ED64(this, globalCtx, 6 as libc::c_int);
    func_809818FC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update18(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    let mut temp: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp *
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                  ...
                  0.001f32 + 0.005f32) +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 69 as libc::c_int) as
                                    usize] as libc::c_int as libc::c_float +
                  50.0f32)) as s16;
    (*this).unk_172 =
        ((*this).unk_172 as libc::c_int + (*this).unk_174 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw6(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this2: *mut DemoGt = this;
    let mut sp78: s16 = (*this2).unk_172;
    let mut sp74: f32_0 = 0.;
    let mut sp70: f32_0 = 0.;
    let mut sp6E: s16 = 0;
    let mut sp6C: s16 = 0;
    let mut gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut sp64: *mut Mtx = 0 as *mut Mtx;
    let mut sp58: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp4C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp48: f32_0 = 0.;
    sp74 =
        fabsf(sp78 as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       0x8000 as libc::c_int as libc::c_float));
    sp70 =
        (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
    ...
    sp6C =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               ...
                               usize] as libc::c_int + 0x4000 as libc::c_int)
            as s16;
    sp6C = (sp6C as libc::c_int + 0x4000 as libc::c_int) as s16;
    gfxCtx = (*globalCtx).state.gfxCtx;
    sp64 =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<Mtx>() as libc::c_ulong as size_t)
            as *mut Mtx;
    sp48 = 1.0f32 - Math_CosS(sp78);
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part4_3.c\x00" as *const u8 as
    ...
    Matrix_Push();
    Matrix_RotateAxis(sp74, &mut sp58, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate(sp4C.x, sp4C.y, sp4C.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(sp64,
                 b"../z_demo_gt_part4_3.c\x00" as *const u8 as
                     *const libc::c_char as *mut libc::c_char,
    ...
    (*_g).words.w0 =
        (0xda as libc::c_int as u32_0 &
            ...
            (((0x1 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                 ...
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 = sp64 as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn func_80981C94_Init23(mut this: *mut DemoGt,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 6 as libc::c_int, 7 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_80981CEC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 183 as libc::c_int {
        func_80078914(&mut (*this).dyna.actor.projectedPos,
                      (0x28de as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80981D20(mut this: *mut DemoGt) {
    let mut temp: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp *
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
    ...
    if (*this).unk_172 as libc::c_int >
           ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                  ...
                                  usize] as libc::c_int +
                0x4000 as libc::c_int) as s16 as libc::c_int {
        (*this).unk_172 =
            ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                    16 as libc::c_int + 80 as libc::c_int) as
                                   usize] as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn func_80981DC8(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 7 as libc::c_int)
           != 0 {
        (*this).updateMode = 0xe as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update6(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 7 as libc::c_int);
    func_80981CEC(this, globalCtx);
    func_80981DC8(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update14(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_80981D20(this);
    func_8097ED64(this, globalCtx, 7 as libc::c_int);
    func_80981CEC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw7(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this2: *mut DemoGt = this;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut sp6E: s16 = 0;
    ...
    sp62 =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               ...
                               usize] as libc::c_int + 0x7fec as libc::c_int)
            as s16;
    sp60 =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 74 as libc::c_int) as
                               usize] as libc::c_int + 0x7fec as libc::c_int)
            as s16;
    sp60 = (sp60 as libc::c_int + 0x4000 as libc::c_int) as s16;
    sp5C =
        Graph_Alloc(gfxCtx,
                    ::std::mem::size_of::<Mtx>() as libc::c_ulong as size_t)
            as *mut Mtx;
    sp40 = 1.0f32 - Math_CosS(sp6E);
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part5.c\x00" as *const u8 as
    ...
    Matrix_Push();
    Matrix_RotateAxis(sp68, &mut sp50, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate(sp44.x, sp44.y, sp44.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_ToMtx(sp5C,
                 b"../z_demo_gt_part5.c\x00" as *const u8 as
                     *const libc::c_char as *mut libc::c_char,
    ...
    (*_g).words.w0 =
        (0xda as libc::c_int as u32_0 &
            ...
            (((0 as libc::c_int | 0x2 as libc::c_int | 0 as libc::c_int) ^
                 ...
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 = sp5C as libc::c_uint;
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gTowerCollapseCsWalkwayDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part5.c\x00" as *const u8 as
                         *const libc::c_char, 160 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80982054_Init24(mut this: *mut DemoGt,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    (*this).dyna.actor.scale.x *= 10.0f32;
    (*this).dyna.actor.scale.y *= 10.0f32;
    (*this).dyna.actor.scale.z *= 10.0f32;
    func_8097EE44(this, globalCtx, 7 as libc::c_int, 8 as libc::c_int,
                  0 as *mut CollisionHeader);
}
#[no_mangle]
pub unsafe extern "C" fn func_809820AC(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: u16_0 = (*globalCtx).csCtx.frames;
    if frames as libc::c_int == 154 as libc::c_int {
        func_80078914(&mut (*this).dyna.actor.projectedPos,
                      (0x28de as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_809820E0(mut this: *mut DemoGt) {
    let mut temp: f32_0 = (*this).unk_172 as f32_0;
    (*this).unk_174 =
        (temp *
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                  ...
                  0.001f32 + 0.048f32) +
             ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                     16 as libc::c_int + 79 as libc::c_int) as
                                    usize] as libc::c_int as libc::c_float +
                  100.0f32)) as s16;
    (*this).unk_172 =
        ((*this).unk_172 as libc::c_int + (*this).unk_174 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80982188(mut this: *mut DemoGt,
                                       mut globalCtx: *mut GlobalContext) {
    if func_8097E704(globalCtx, 2 as libc::c_int as u16_0, 9 as libc::c_int)
           as libc::c_int != 0 as libc::c_int {
        (*this).updateMode = 15 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update7(mut this: *mut DemoGt,
                                        mut globalCtx: *mut GlobalContext) {
    func_8097E824(this, 9 as libc::c_int);
    func_809820AC(this, globalCtx);
    func_80982188(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update15(mut this: *mut DemoGt,
                                         mut globalCtx: *mut GlobalContext) {
    func_809820E0(this);
    func_8097ED64(this, globalCtx, 9 as libc::c_int);
    func_809820AC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw8(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this2: *mut DemoGt = this;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut sp6E: s16 = 0;
    ...
    sp64 =
        (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                               16 as libc::c_int + 78 as libc::c_int) as
                              usize] as f32_0;
    sp62 =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 77 as libc::c_int) as
                               usize] as libc::c_int + 0xbe80 as libc::c_int)
            as s16;
    sp60 =
        ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                16 as libc::c_int + 77 as libc::c_int) as
    ...
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_gt_part6.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gTowerCollapseCsAlternativeWalkwayDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_gt_part6.c\x00" as *const u8 as
                         *const libc::c_char, 163 as libc::c_int);
}
static mut sUpdateFuncs: [DemoGtUpdateFunc; 19] =
    unsafe {
        [Some(DemoGt_Update0 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update1 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update2 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update3 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update4 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update5 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update6 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update7 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update8 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update9 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update10 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update11 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update12 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update13 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update14 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update15 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update16 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update17 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Update18 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGt = thisx as *mut DemoGt;
    let mut updateFunc: DemoGtUpdateFunc = None;
    if (*this).updateMode < 0 as libc::c_int ||
           (*this).updateMode >= 19 as libc::c_int ||
           {
               updateFunc = sUpdateFuncs[(*this).updateMode as usize];
               updateFunc.is_none()
           } {
    ...
    updateFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGt = thisx as *mut DemoGt;
    match (*this).dyna.actor.params as libc::c_int {
        0 => { func_8097EEA8_Init0(this, globalCtx); }
        1 => { func_8097F904_Init1(this, globalCtx); }
        2 => { func_80980110_Init2(this, globalCtx); }
        5 => { func_80980F00_Init5(this, globalCtx); }
        6 => { func_809813CC_Init6(this, globalCtx); }
        7 => { func_809818A4_Init7(this, globalCtx); }
        23 => { func_80981C94_Init23(this, globalCtx); }
        24 => { func_80982054_Init24(this, globalCtx); }
        _ => {
            // "Demo_Gt_Actor_ct There is no such argument !"
            osSyncPrintf(b"Demo_Gt_Actor_ct \xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\xbc\x95\xe6\x95\xb0\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n\x00"
                             as *const u8 as *const libc::c_char);
            Actor_Kill(&mut (*this).dyna.actor);
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw0(mut this: *mut DemoGt,
                                      mut globalCtx: *mut GlobalContext) {
}
static mut sDrawFuncs: [DemoGtDrawFunc; 9] =
    unsafe {
        [Some(DemoGt_Draw0 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw1 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw2 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw3 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw4 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw5 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw6 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw7 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ()),
         Some(DemoGt_Draw8 as
                  unsafe extern "C" fn(_: *mut DemoGt, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoGt_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGt = thisx as *mut DemoGt;
    let mut drawFunc: DemoGtDrawFunc = None;
    if (*this).drawConfig < 0 as libc::c_int ||
           (*this).drawConfig >= 9 as libc::c_int ||
           {
               drawFunc = sDrawFuncs[(*this).drawConfig as usize];
               drawFunc.is_none()
           } {
    ...
    drawFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub static mut Demo_Gt_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_GT as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_GT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DemoGt>() as
                                  libc::c_ulong,
                          init:
