...
pub struct EnHoll {
    ...
    pub side: u8_0,
    pub unk_14F: u8_0,
    pub actionFunc: EnHollActionFunc,
}
pub type EnHollActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Holl_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HOLL as libc::c_int as s16,
...
static mut sActionFuncs: [EnHollActionFunc; 7] =
    unsafe {
        [Some(func_80A58DD4 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A591C0 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A59520 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A59618 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A59014 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A593A4 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A59014 as
                  unsafe extern "C" fn(_: *mut EnHoll, _: *mut GlobalContext)
 ...
 */
static mut sHorizTriggerDists: [[f32_0; 4]; 2] =
    [[200.0f32, 150.0f32, 100.0f32, 50.0f32],
     [100.0f32, 75.0f32, 50.0f32, 25.0f32]];
#[no_mangle]
pub unsafe extern "C" fn EnHoll_SetupAction(mut this: *mut EnHoll,
                                            mut func: EnHollActionFunc) {
    (*this).actionFunc = func;
}
#[no_mangle]
pub unsafe extern "C" fn EnHoll_IsKokiriSetup8() -> s32 {
    return (gSaveContext.entranceIndex == 0xee as libc::c_int &&
                gSaveContext.sceneSetupIndex == 8 as libc::c_int) as
               libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHoll_ChooseAction(mut this: *mut EnHoll) {
    let mut action: s32 = 0;
    action =
        (*this).actor.params as libc::c_int >> 6 as libc::c_int &
            7 as libc::c_int;
    EnHoll_SetupAction(this, sActionFuncs[action as usize]);
    if action != 0 as libc::c_int {
        (*this).actor.draw = None
    } else { (*this).planeAlpha = 255 as libc::c_int as s16 };
}
#[no_mangle]
pub unsafe extern "C" fn EnHoll_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHoll = thisx as *mut EnHoll;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    EnHoll_ChooseAction(this);
    (*this).unk_14F = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnHoll_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut transitionActorIdx: s32 =
        (*thisx).params as u16_0 as libc::c_int >> 0xa as libc::c_int;
    let mut transitionEntry: *mut TransitionActorEntry =
        &mut *(*globalCtx).transiActorCtx.list.offset(transitionActorIdx as
                                                          isize) as
            *mut TransitionActorEntry;
    (*transitionEntry).id = -((*transitionEntry).id as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHoll_SwapRooms(mut globalCtx: *mut GlobalContext) {
    let mut tempRoom: Room =
        Room{num: 0,
             unk_01: 0,
             unk_02: 0,
             unk_03: 0,
             ...
             showInvisActors: 0,
             mesh: 0 as *mut Mesh,
             segment: 0 as *mut libc::c_void,
             unk_10: [0; 4],};
    let mut roomCtx: *mut RoomContext = &mut (*globalCtx).roomCtx;
    tempRoom = (*roomCtx).curRoom;
    (*roomCtx).curRoom = (*roomCtx).prevRoom;
    (*roomCtx).prevRoom = tempRoom;
    (*globalCtx).roomCtx.unk_30 =
        ((*globalCtx).roomCtx.unk_30 as libc::c_int ^ 1 as libc::c_int) as
            u8_0;
}
// Horizontal Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A58DD4(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut phi_t0: s32 =
        ((if (*globalCtx).sceneNum as libc::c_int ==
             ...
             0xffffffff as libc::c_uint) as s32;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut absZ: f32_0 = 0.;
    let mut transitionActorIdx: s32 = 0;
    func_8002DBD0(&mut (*this).actor, &mut vec,
                  &mut (*player).actor.world.pos);
    (*this).side =
        if vec.z < 0.0f32 { 0 as libc::c_int } else { 1 as libc::c_int } as
            u8_0;
    absZ = fabsf(vec.z);
    if vec.y > -50.0f32 && vec.y < 200.0f32 && fabsf(vec.x) < 100.0f32 &&
           absZ <
               sHorizTriggerDists[phi_t0 as usize][0 as libc::c_int as usize]
       {
        transitionActorIdx =
            (*this).actor.params as u16_0 as libc::c_int >>
                0xa as libc::c_int;
        if absZ >
               sHorizTriggerDists[phi_t0 as usize][1 as libc::c_int as usize]
           {
            if (*globalCtx).roomCtx.prevRoom.num as libc::c_int >=
                   0 as libc::c_int &&
                   (*globalCtx).roomCtx.status as libc::c_int ==
                       0 as libc::c_int {
                (*this).actor.room =
                    (*(*globalCtx).transiActorCtx.list.offset(transitionActorIdx
                                                                  as
                                                                  isize)).sides[(*this).side
                                                                                    as
                                                                                    usize].room;
            ...
            if ((*globalCtx).roomCtx.prevRoom.num as libc::c_int) <
                ...
                func_8009728C(globalCtx, &mut (*globalCtx).roomCtx,
                              (*this).actor.room as s32);
            } else {
                (*this).planeAlpha =
                    (255.0f32 /
                         (sHorizTriggerDists[phi_t0 as
                        ...
                        s16;
                (*this).planeAlpha =
                    if ((*this).planeAlpha as libc::c_int) < 0 as libc::c_int
                       {
                        0 as libc::c_int
                    } else if (*this).planeAlpha as libc::c_int >
                                  255 as libc::c_int {
                        255 as libc::c_int
                    } else { (*this).planeAlpha as libc::c_int } as s16;
...
// Horizontal Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A59014(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut useViewEye: s32 =
        (gDbgCamEnabled != 0 ||
             (*globalCtx).csCtx.state as libc::c_int !=
                 CS_STATE_IDLE as libc::c_int) as libc::c_int;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp: s32 = 0;
    let mut planeHalfWidth: f32_0 = 0.;
    let mut absZ: f32_0 = 0.;
    func_8002DBD0(&mut (*this).actor, &mut vec,
                  if useViewEye != 0 {
                      &mut (*globalCtx).view.eye
                  } else { &mut (*player).actor.world.pos });
    planeHalfWidth =
    ...
    if temp != 0 ||
           -50.0f32 < vec.y && vec.y < 200.0f32 &&
               fabsf(vec.x) < planeHalfWidth &&
               { absZ = fabsf(vec.z); (100.0f32 > absZ) && absZ > 50.0f32 } {
        let mut transitionActorIdx: s32 =
            (*this).actor.params as u16_0 as libc::c_int >>
                0xa as libc::c_int;
        let mut side: s32 =
            if vec.z < 0.0f32 { 0 as libc::c_int } else { 1 as libc::c_int };
        let mut transitionEntry: *mut TransitionActorEntry =
            &mut *(*globalCtx).transiActorCtx.list.offset(transitionActorIdx
                                                              as isize) as
                *mut TransitionActorEntry;
        let mut room: s32 =
            (*transitionEntry).sides[side as usize].room as s32;
        (*this).actor.room = room as s8;
        (temp) != 0;
        if (*this).actor.room as libc::c_int !=
               (*globalCtx).roomCtx.curRoom.num as libc::c_int {
            (room) != 0;
            if func_8009728C(globalCtx, &mut (*globalCtx).roomCtx,
                             (*this).actor.room as s32) != 0 {
                EnHoll_SetupAction(this,
                                   Some(EnHoll_NextAction as
                                            unsafe extern "C" fn(_:
                                                                     *mut EnHoll,
                                                                 _:
                                                                     *mut GlobalContext)
...
// Vertical Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A591C0(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut absY: f32_0 = fabsf((*this).actor.yDistToPlayer);
    let mut transitionActorIdx: s32 = 0;
    if (*this).actor.xzDistToPlayer < 500.0f32 && absY < 700.0f32 {
        transitionActorIdx =
            (*this).actor.params as u16_0 as libc::c_int >>
                0xa as libc::c_int;
        if absY < 95.0f32 {
            (*globalCtx).unk_11E18 = 0xff as libc::c_int as s16
        } else if absY > 605.0f32 {
            (*globalCtx).unk_11E18 = 0 as libc::c_int as s16
        } else {
            (*globalCtx).unk_11E18 =
                ((605.0f32 - absY) as s16 as libc::c_int as libc::c_float *
                     0.5f32) as s16
        }
        if absY < 95.0f32 {
            (*this).actor.room =
            ...
            Math_SmoothStepToF(&mut (*player).actor.world.pos.x,
                               (*this).actor.world.pos.x, 1.0f32, 50.0f32,
                               10.0f32);
            Math_SmoothStepToF(&mut (*player).actor.world.pos.z,
                               (*this).actor.world.pos.z, 1.0f32, 50.0f32,
                               10.0f32);
            if (*this).actor.room as libc::c_int !=
                   (*globalCtx).roomCtx.curRoom.num as libc::c_int &&
                   func_8009728C(globalCtx, &mut (*globalCtx).roomCtx,
                                   ...
                                   Some(EnHoll_NextAction as
                                            unsafe extern "C" fn(_:
                                                                 ...
                                                                 _:
                                                                     *mut GlobalContext)
                                                -> ()));
                (*this).unk_14F = 1 as libc::c_int as u8_0;
                (*player).actor.speedXZ = 0.0f32
            }
        }
    } else if (*this).unk_14F as libc::c_int != 0 as libc::c_int {
        (*globalCtx).unk_11E18 = 0 as libc::c_int as s16;
        (*this).unk_14F = 0 as libc::c_int as u8_0
    };
}
// Vertical Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A593A4(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    let mut absY: f32_0 = 0.;
    let mut side: s32 = 0;
    let mut transitionActorIdx: s32 = 0;
    if (*this).actor.xzDistToPlayer < 120.0f32 &&
           { absY = fabsf((*this).actor.yDistToPlayer); (absY) < 200.0f32 } {
        if absY < 50.0f32 {
            (*globalCtx).unk_11E18 = 0xff as libc::c_int as s16
        } else {
            (*globalCtx).unk_11E18 = ((200.0f32 - absY) * 1.7f32) as s16
        }
        if absY > 50.0f32 {
            transitionActorIdx =
                (*this).actor.params as u16_0 as libc::c_int >>
                    0xa as libc::c_int;
            side =
                if 0.0f32 < (*this).actor.yDistToPlayer {
                    0 as libc::c_int
...
// Vertical Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A59520(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    let mut absY: f32_0 = 0.;
    let mut side: s8 = 0;
    let mut transitionActorIdx: s32 = 0;
...
// Horizontal Planes
#[no_mangle]
pub unsafe extern "C" fn func_80A59618(mut this: *mut EnHoll,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        if (*this).unk_14F as libc::c_int != 0 as libc::c_int {
            (*globalCtx).unk_11E18 = 0 as libc::c_int as s16;
            (*this).unk_14F = 0 as libc::c_int as u8_0
        }
    } else {
        func_8002DBD0(&mut (*this).actor, &mut vec,
                      &mut (*player).actor.world.pos);
        absZ = fabsf(vec.z);
        if -50.0f32 < vec.y && vec.y < 200.0f32 && fabsf(vec.x) < 200.0f32 &&
               absZ < 100.0f32 {
            (*this).unk_14F = 1 as libc::c_int as u8_0;
            transitionActorIdx =
                (*this).actor.params as u16_0 as libc::c_int >>
                    0xa as libc::c_int;
            (*globalCtx).unk_11E18 =
                (0xff as libc::c_int - ((absZ - 50.0f32) * 5.9f32) as s32) as
                    s16;
            if (*globalCtx).unk_11E18 as libc::c_int >= 0x100 as libc::c_int {
                (*globalCtx).unk_11E18 = 0xff as libc::c_int as s16
            } else if ((*globalCtx).unk_11E18 as libc::c_int) <
                          0 as libc::c_int {
                (*globalCtx).unk_11E18 = 0 as libc::c_int as s16
            }
            if absZ < 50.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHoll_NextAction(mut this: *mut EnHoll,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if EnHoll_IsKokiriSetup8() == 0 &&
           (*globalCtx).roomCtx.status as libc::c_int == 0 as libc::c_int {
        func_80097534(globalCtx, &mut (*globalCtx).roomCtx);
        if (*globalCtx).unk_11E18 as libc::c_int == 0 as libc::c_int {
            (*this).unk_14F = 0 as libc::c_int as u8_0
        }
        EnHoll_ChooseAction(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnHoll_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHoll = thisx as *mut EnHoll;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
// Initialized in run_static_initializers
static mut sPlaneDL: [Gfx; 5] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 5];
static mut sPlaneVtx: [Vtx; 4] =
    [Vtx{v:
             {
                 let mut init =
                     Vtx_t{ob:
                               [22000 as libc::c_int as libc::c_short,
...
#[no_mangle]
pub unsafe extern "C" fn EnHoll_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHoll = thisx as *mut EnHoll;
    let mut gfxP: *mut Gfx = 0 as *mut Gfx;
    let mut setupDlIdx: u32_0 = 0;
    ...
    if (*this).planeAlpha as libc::c_int != 0 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_holl.c\x00" as *const u8 as
                            *const libc::c_char, 805 as libc::c_int);
        if (*this).planeAlpha as libc::c_int == 255 as libc::c_int {
            gfxP = (*__gfxCtx).polyOpa.p;
            setupDlIdx = 37 as libc::c_int as u32_0
        } else {
            gfxP = (*__gfxCtx).polyXlu.p;
            setupDlIdx = 0 as libc::c_int as u32_0
        }
        gfxP = Gfx_CallSetupDL(gfxP, setupDlIdx);
        if (*this).side as libc::c_int == 0 as libc::c_int {
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).planeAlpha as u8_0 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        let fresh2 = gfxP;
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = sPlaneDL.as_mut_ptr() as libc::c_uint;
        if (*this).planeAlpha as libc::c_int == 255 as libc::c_int {
            (*__gfxCtx).polyOpa.p = gfxP
        } else { (*__gfxCtx).polyXlu.p = gfxP }
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_holl.c\x00" as *const u8 as
                             *const libc::c_char, 831 as libc::c_int);
    };
}
                                    ...
                                    (0x1 as libc::c_int as u32_0 &
                                        ...
                                        ((0 as libc::c_int + 4 as libc::c_int)
                                             ...
                                             (((0x1 as libc::c_int) <<
                                                 ...
                                                 libc::c_uint) <<
                                            1 as libc::c_int,
                                w1: sPlaneVtx.as_mut_ptr() as libc::c_uint,};
                     init
                 },},
         Gfx{words:
                 {
