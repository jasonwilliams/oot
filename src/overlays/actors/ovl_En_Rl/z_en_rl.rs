...
extern "C" {
    ...
    #[no_mangle]
    static mut object_rl_Anim_00040C: AnimationHeader;
    #[no_mangle]
    static mut object_rl_Anim_000830: AnimationHeader;
    #[no_mangle]
    static mut object_rl_Anim_000A3C: AnimationHeader;
    #[no_mangle]
    static mut object_rl_Tex_003620: [u64_0; 0];
    #[no_mangle]
    static mut object_rl_Tex_003960: [u64_0; 0];
    #[no_mangle]
    static mut object_rl_Tex_003B60: [u64_0; 0];
    #[no_mangle]
    static mut object_rl_Skel_007B38: FlexSkeletonHeader;
}
...
pub struct EnRl {
    ...
    pub unk_19C: f32_0,
    pub alpha: s32,
    pub lightBallSpawned: u32_0,
    pub lightMedallionGiven: s32,
}
pub type EnRlActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext) -> ()>;
pub type EnRlDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext) -> ()>;
static mut D_80AE81A0: [*mut libc::c_void; 3] =
    unsafe {
        [object_rl_Tex_003620.as_ptr() as *mut _ as *mut libc::c_void,
         object_rl_Tex_003960.as_ptr() as *mut _ as *mut libc::c_void,
         object_rl_Tex_003B60.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnRl_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRl = thisx as *mut EnRl;
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE72D0(mut this: *mut EnRl) {
    let mut pad: [s32; 3] = [0; 3];
    let mut timer: *mut s16 = &mut (*this).timer;
    let mut eyeTextureIndex: *mut s16 = &mut (*this).eyeTextureIndex;
    if (if *timer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { *timer -= 1; *timer as libc::c_int }) == 0 as libc::c_int {
        *timer =
            Rand_S16Offset(60 as libc::c_int as s16, 60 as libc::c_int as s16)
    }
    *eyeTextureIndex = *timer;
    if *eyeTextureIndex as libc::c_int > 2 as libc::c_int {
        *eyeTextureIndex = 0 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7358(mut this: *mut EnRl) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rl_Anim_000A3C,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_rl_Anim_000A3C as
    ...
    (*this).lightBallSpawned = 0 as libc::c_int as u32_0;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
    (*this).unk_19C = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE73D8(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_80AE81AC: s32 = 0 as libc::c_int;
    if (*globalCtx).csCtx.state as libc::c_int == CS_STATE_IDLE as libc::c_int
       {
        if D_80AE81AC != 0 {
            ...
            D_80AE81AC = 0 as libc::c_int
        }
    } else if D_80AE81AC == 0 { D_80AE81AC = 1 as libc::c_int };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE744C(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 30.0f32,
                            30.0f32, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7494(mut this: *mut EnRl) -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE74B4(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext,
 ...
 -> s32 {
    ...
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        csCmdActorAction = (*globalCtx).csCtx.npcActions[arg3 as usize];
        if !csCmdActorAction.is_null() &&
               (*csCmdActorAction).action as libc::c_int ==
                   arg2 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE74FC(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: u16_0, mut arg3: s32)
 -> s32 {
    let mut csCmdActorAction: *mut CsCmdActorAction =
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7544(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_rl_Skel_007B38, &mut object_rl_Anim_000A3C,
                       0 as *mut Vec3s, 0 as *mut Vec3s, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7590(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if gSaveContext.sceneSetupIndex == 4 as libc::c_int &&
           sceneNum as libc::c_int == SCENE_KENJYANOMA as libc::c_int &&
           ...
           (*this).lightMedallionGiven == 0 {
        player =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                                 usize].head as *mut Player;
        pos.x = (*player).actor.world.pos.x;
        pos.y = (*player).actor.world.pos.y + 80.0f32;
        pos.z = (*player).actor.world.pos.z;
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_DEMO_EFFECT as libc::c_int as s16, pos.x, pos.y,
                    pos.z, 0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 0xe as libc::c_int as s16);
        Item_Give(globalCtx, ITEM_MEDALLION_LIGHT as libc::c_int as u8_0);
        (*this).lightMedallionGiven = 1 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7668(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7698(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut csCmdActorAction: *mut CsCmdActorAction =
        0 as *mut CsCmdActorAction;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        csCmdActorAction =
            (*globalCtx).csCtx.npcActions[0 as libc::c_int as usize];
        if !csCmdActorAction.is_null() &&
               (*csCmdActorAction).action as libc::c_int == 3 as libc::c_int {
            Animation_Change(&mut (*this).skelAnime,
                             &mut object_rl_Anim_00040C, 1.0f32, 0.0f32,
                             Animation_GetLastFrame(&mut object_rl_Anim_00040C
                                                        as
                                                        *mut AnimationHeader
                                                        as *mut libc::c_void)
                                 as f32_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE772C(mut this: *mut EnRl, mut arg1: s32) {
    if arg1 != 0 {
        Animation_Change(&mut (*this).skelAnime, &mut object_rl_Anim_000830,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_rl_Anim_000830 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7798(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AE7668(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE77B8(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE77F8(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp: s32 = 0;
    func_80AE744C(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7838(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AE744C(this, globalCtx);
    func_80AE7494(this);
    func_80AE72D0(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7878(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_rl_Skel_007B38, &mut object_rl_Anim_000A3C,
                       0 as *mut Vec3s, 0 as *mut Vec3s, 0 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE78D4(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7954(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80AE74B4(this, globalCtx, 4 as libc::c_int as u16_0,
                     0 as libc::c_int) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE79A4(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut unk_19C: *mut f32_0 = &mut (*this).unk_19C;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7AF8(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    if func_80AE74B4(this, globalCtx, 3 as libc::c_int as u16_0,
                     0 as libc::c_int) != 0 {
        Animation_Change(&mut (*this).skelAnime, &mut object_rl_Anim_00040C,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_rl_Anim_00040C as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         -8.0f32);
        (*this).action = 6 as libc::c_int
    } else if func_80AE74FC(this, globalCtx, 4 as libc::c_int as u16_0,
                            0 as libc::c_int) != 0 {
        (*this).action = 5 as libc::c_int;
        (*this).drawConfig = 2 as libc::c_int;
        (*this).unk_19C =
        ...
        if (*this).lightBallSpawned == 0 {
            func_80AE78D4(this, globalCtx);
            (*this).lightBallSpawned = 1 as libc::c_int as u32_0
        }
        (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7BF8(mut this: *mut EnRl, mut arg1: s32) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7C64(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AE7954(this, globalCtx);
    func_80AE73D8(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7C94(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AE744C(this, globalCtx);
    func_80AE7494(this);
    func_80AE72D0(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7CE8(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp: s32 = 0;
    func_80AE744C(this, globalCtx);
    temp = func_80AE7494(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7D40(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    func_80AE744C(this, globalCtx);
    func_80AE7494(this);
    func_80AE72D0(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE7D94(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut temp: s16 = (*this).eyeTextureIndex;
    let mut tex: *mut libc::c_void = D_80AE81A0[temp as usize];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_rl_inKenjyanomaDemo02.c\x00" as *const u8 as
...
static mut sActionFuncs: [EnRlActionFunc; 8] =
    unsafe {
        [Some(func_80AE7798 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE77B8 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE77F8 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7838 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7C64 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7C94 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7CE8 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7D40 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnRl_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRl = thisx as *mut EnRl;
    if (*this).action < 0 as libc::c_int || (*this).action > 7 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnRl_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRl = thisx as *mut EnRl;
    ...
    } else { func_80AE7544(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7FD0(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE7FDC(mut this: *mut EnRl,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut temp: s16 = (*this).eyeTextureIndex;
    let mut tex: *mut libc::c_void = D_80AE81A0[temp as usize];
    ...
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_rl.c\x00" as *const u8 as *const libc::c_char,
                    416 as libc::c_int);
...
static mut sDrawFuncs: [EnRlDrawFunc; 3] =
    unsafe {
        [Some(func_80AE7FD0 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7FDC as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ()),
         Some(func_80AE7D94 as
                  unsafe extern "C" fn(_: *mut EnRl, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnRl_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRl = thisx as *mut EnRl;
...
#[no_mangle]
pub static mut En_Rl_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_RL as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_RL as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnRl>() as libc::c_ulong,
                          init:
