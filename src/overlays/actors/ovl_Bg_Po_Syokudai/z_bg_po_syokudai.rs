...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgPoSyokudai {
    pub actor: Actor,
    pub flameColor: u8_0,
    pub flameTextureScroll: s16,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
    pub collider: ColliderCylinder,
}
pub type C2RustUnnamed_22 = libc::c_uint;
pub const POE_FLAME_GREEN: C2RustUnnamed_22 = 3;
pub const POE_FLAME_BLUE: C2RustUnnamed_22 = 2;
pub const POE_FLAME_RED: C2RustUnnamed_22 = 1;
pub const POE_FLAME_PURPLE: C2RustUnnamed_22 = 0;
...
static mut sPrimColors: [Color_RGBA8; 4] =
    [{
         let mut init =
...
static mut sEnvColors: [Color_RGBA8; 4] =
    [{
         let mut init =
...
#[no_mangle]
pub static mut Bg_Po_Syokudai_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_PO_SYOKUDAI as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SYOKUDAI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgPoSyokudai>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoSyokudai_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoSyokudai_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoSyokudai_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgPoSyokudai_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgPoSyokudai_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgPoSyokudai = thisx as *mut BgPoSyokudai;
    let mut pad: s32 = 0;
    ...
    Lights_PointGlowSetInfo(&mut (*this).lightInfo,
                            ...
                            ((*thisx).world.pos.y as s16 as libc::c_int +
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider, thisx,
                         &mut sCylinderInit);
    (*this).collider.dim.pos.x = (*thisx).world.pos.x as s16;
    (*this).collider.dim.pos.y = (*thisx).world.pos.y as s16;
    (*this).collider.dim.pos.z = (*thisx).world.pos.z as s16;
    if (*this).flameColor as libc::c_int == POE_FLAME_PURPLE as libc::c_int &&
           Flags_GetSwitch(globalCtx,
                           0x1c as libc::c_int +
                               POE_FLAME_GREEN as libc::c_int) != 0 &&
           Flags_GetSwitch(globalCtx,
                           0x1c as libc::c_int +
                               POE_FLAME_BLUE as libc::c_int) != 0 &&
           Flags_GetSwitch(globalCtx,
                           0x1c as libc::c_int + POE_FLAME_RED as libc::c_int)
               != 0 && Flags_GetSwitch(globalCtx, (*thisx).params as s32) == 0
       {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_PO_SISTERS as libc::c_int as s16, 119.0f32,
                    225.0f32, -1566.0f32, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    (*thisx).params);
        (*globalCtx).envCtx.unk_BF = 0x4 as libc::c_int as u8_0
    } else if Flags_GetSwitch(globalCtx,
                              0x1c as libc::c_int +
                                  POE_FLAME_PURPLE as libc::c_int) == 0 &&
                  Flags_GetSwitch(globalCtx, 0x1b as libc::c_int) == 0 {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_PO_SISTERS as libc::c_int as s16,
                    (*thisx).world.pos.x, (*thisx).world.pos.y + 52.0f32,
                    (*thisx).world.pos.z, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    ((((*this).flameColor as libc::c_int) << 8 as libc::c_int)
                         + (*thisx).params as libc::c_int +
                         0x1000 as libc::c_int) as s16);
    } else if Flags_GetSwitch(globalCtx, (*thisx).params as s32) == 0 {
        if (*globalCtx).envCtx.unk_BF as libc::c_int == 0xff as libc::c_int {
            (*globalCtx).envCtx.unk_BF = 4 as libc::c_int as u8_0
        }
    }
    (*this).flameTextureScroll = (Rand_ZeroOne() * 20.0f32) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgPoSyokudai_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgPoSyokudai = thisx as *mut BgPoSyokudai;
...
#[no_mangle]
pub unsafe extern "C" fn BgPoSyokudai_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgPoSyokudai = thisx as *mut BgPoSyokudai;
    let mut pad: s32 = 0;
    ...
    (*this).flameTextureScroll += 1;
}
#[no_mangle]
pub unsafe extern "C" fn BgPoSyokudai_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgPoSyokudai = thisx as *mut BgPoSyokudai;
    let mut lightBrightness: f32_0 = 0.;
    let mut red: u8_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_po_syokudai.c\x00" as *const u8 as
                        *const libc::c_char, 315 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gGoldenTorchDL.as_mut_ptr() as libc::c_uint;
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        let mut primColor: *mut Color_RGBA8 =
            &mut *sPrimColors.as_mut_ptr().offset((*this).flameColor as isize)
                as *mut Color_RGBA8;
        let mut envColor: *mut Color_RGBA8 =
            &mut *sEnvColors.as_mut_ptr().offset((*this).flameColor as isize)
                as *mut Color_RGBA8;
        lightBrightness = 0.3f32 * Rand_ZeroOne() + 0.7f32;
        red =
            ((*primColor).r as libc::c_int as libc::c_float * lightBrightness)
                as u8_0;
        green =
            ((*primColor).g as libc::c_int as libc::c_float * lightBrightness)
                as u8_0;
        blue =
            ((*primColor).b as libc::c_int as libc::c_float * lightBrightness)
                as u8_0;
        Lights_PointSetColorAndRadius(&mut (*this).lightInfo, red, green,
                                      blue, 200 as libc::c_int as s16);
        ...
        (*_g_1).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             ((*this).flameTextureScroll as libc::c_int *
                                  -(20 as libc::c_int) & 0x1ff as libc::c_int)
                                 as u32_0, 32 as libc::c_int,
        ...
        Matrix_RotateY((Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                       ...
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Scale(0.0027f32, 0.0027f32, 0.0027f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
