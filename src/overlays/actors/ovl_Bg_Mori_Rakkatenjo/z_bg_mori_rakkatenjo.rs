...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriRakkatenjoDL: [Gfx; 0];
    #[no_mangle]
    static mut gMoriRakkatenjoCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriRakkatenjo {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMoriRakkatenjoActionFunction,
    pub timer: s32,
    pub bounceCount: s32,
    pub fallCount: s32,
    pub moriTexObjIndex: s8,
}
pub type BgMoriRakkatenjoActionFunction
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                _: *mut GlobalContext) -> ()>;
static mut sCamSetting: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Bg_Mori_Rakkatenjo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_RAKKATENJO as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_MORI_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgMoriRakkatenjo>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriRakkatenjo_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriRakkatenjo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriRakkatenjo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriRakkatenjo = thisx as *mut BgMoriRakkatenjo;
    ...
    osSyncPrintf(b"\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf obj. \xe8\x90\xbd\xe4\xb8\x8b\xe5\xa4\xa9\xe4\xba\x95 (home posY %f)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.home.pos.y as libc::c_double);
    if fabsf(1991.0f32 - (*this).dyna.actor.home.pos.x) > 0.001f32 ||
           fabsf(683.0f32 - (*this).dyna.actor.home.pos.y) > 0.001f32 ||
           fabsf(-2520.0f32 - (*this).dyna.actor.home.pos.z) > 0.001f32 {
        // "The set position has been changed. Let's fix the program."
        osSyncPrintf(b"Warning : \n\x00"
                         as *const u8 as *const libc::c_char);
    }
    if (*this).dyna.actor.home.rot.y as libc::c_int != 0x8000 as libc::c_int {
        // "The set Angle has changed. Let's fix the program."
        osSyncPrintf(b"Warning : \xe3\x82\xbb\xe3\x83\x83\xe3\x83\x88 Angle \n\x00"
                         as *const u8 as *const libc::c_char);
    }
    (*this).moriTexObjIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_MORI_TEX as libc::c_int as s16) as s8;
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        // "Forest Temple obj Falling Ceiling Bank Danger!"
        osSyncPrintf(b"Error : \xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf obj \xe8\x90\xbd\xe4\xb8\x8b\xe5\xa4\xa9\xe4\xba\x95 \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x8d\xb1\xe9\x99\xba\xef\xbc\x81(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_mori_rakkatenjo.c\x00" as *const u8 as
    ...
    CollisionHeader_GetVirtual(&mut gMoriRakkatenjoCol as *mut CollisionHeader
    ...
    sCamSetting = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriRakkatenjo = thisx as *mut BgMoriRakkatenjo;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_IsLinkUnder(mut this:
                                                          *mut BgMoriRakkatenjo,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
    let mut pos: *mut Vec3f =
    ...
    return (-3300.0f32 < (*pos).z && (*pos).z < -1840.0f32 &&
                1791.0f32 < (*pos).x && (*pos).x < 2191.0f32) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_IsLinkClose(mut this:
                                                          *mut BgMoriRakkatenjo,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> s32 {
    let mut pos: *mut Vec3f =
        &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                           ...
                                                                           isize)).head
                    as *mut Player)).actor.world.pos;
    return (-3360.0f32 < (*pos).z && (*pos).z < -1840.0f32 &&
                1791.0f32 < (*pos).x && (*pos).x < 2191.0f32) as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_SetupWaitForMoriTex(mut this:
                                                                  *mut BgMoriRakkatenjo) {
    (*this).actionFunc =
        Some(BgMoriRakkatenjo_WaitForMoriTex as
                 unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_WaitForMoriTex(mut this:
                                                             *mut BgMoriRakkatenjo,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).moriTexObjIndex as s32) != 0 {
        BgMoriRakkatenjo_SetupWait(this);
        (*this).dyna.actor.draw =
            Some(BgMoriRakkatenjo_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_SetupWait(mut this:
                                                        *mut BgMoriRakkatenjo) {
    (*this).timer =
        if (*this).fallCount > 0 as libc::c_int {
            100 as libc::c_int
        } else { 21 as libc::c_int };
    (*this).dyna.actor.world.pos.y = 683.0f32;
    (*this).actionFunc =
        Some(BgMoriRakkatenjo_Wait as
                 unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Wait(mut this:
                                                   *mut BgMoriRakkatenjo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).fallCount == 0 as libc::c_int {
        if BgMoriRakkatenjo_IsLinkClose(this, globalCtx) != 0 ||
               (*this).timer < 20 as libc::c_int {
            if (*this).timer <= 0 as libc::c_int {
                BgMoriRakkatenjo_SetupFall(this);
            }
        } else { (*this).timer = 21 as libc::c_int }
    } else if BgMoriRakkatenjo_IsLinkUnder(this, globalCtx) != 0 ||
                  (*this).timer < 20 as libc::c_int {
        if (*this).timer <= 0 as libc::c_int {
            BgMoriRakkatenjo_SetupFall(this);
        }
    } else { (*this).timer = 100 as libc::c_int }
    if (*this).timer < 20 as libc::c_int {
        func_800788CC((0x285c as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_SetupFall(mut this:
                                                        *mut BgMoriRakkatenjo) {
    (*this).actionFunc =
        Some(BgMoriRakkatenjo_Fall as
                 unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                      _: *mut GlobalContext) -> ());
    (*this).bounceCount = 0 as libc::c_int;
    (*this).dyna.actor.velocity.y = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Fall(mut this:
                                                   *mut BgMoriRakkatenjo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut bounceVel: [f32_0; 4] = [4.0f32, 1.5f32, 0.4f32, 0.1f32];
    let mut pad: s32 = 0;
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    let mut quake: s32 = 0;
    Actor_MoveForward(thisx);
    if (*thisx).velocity.y < 0.0f32 && (*thisx).world.pos.y <= 403.0f32 {
        if (*this).bounceCount >=
               (::std::mem::size_of::<[f32_0; 4]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<f32_0>()
                                                    as libc::c_ulong) as s32 {
            BgMoriRakkatenjo_SetupRest(this);
        } else {
            if (*this).bounceCount == 0 as libc::c_int {
                (*this).fallCount += 1;
                func_800788CC(0x281d as libc::c_int as u16_0);
                func_800AA000((*thisx).yDistToPlayer * (*thisx).yDistToPlayer,
            ...
            (*thisx).world.pos.y =
                403.0f32 -
                    ((*thisx).world.pos.y - 403.0f32) *
                        bounceVel[(*this).bounceCount as usize] /
                        fabsf((*thisx).velocity.y);
            (*thisx).velocity.y = bounceVel[(*this).bounceCount as usize];
            (*this).bounceCount += 1;
            quake =
                Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera as
                                                      usize],
                          3 as libc::c_int as u32_0) as s32;
            Quake_SetSpeed(quake as s16, 50000 as libc::c_int as s16);
            Quake_SetQuakeValues(quake as s16, 5 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
                                 0 as libc::c_int as s16);
            Quake_SetCountdown(quake as s16, 5 as libc::c_int as s16);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_SetupRest(mut this:
                                                        *mut BgMoriRakkatenjo) {
    (*this).actionFunc =
        Some(BgMoriRakkatenjo_Rest as
                 unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.world.pos.y = 403.0f32;
    (*this).timer = 20 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Rest(mut this:
                                                   *mut BgMoriRakkatenjo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).timer <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_SetupRise(mut this:
                                                        *mut BgMoriRakkatenjo) {
    (*this).actionFunc =
        Some(BgMoriRakkatenjo_Rise as
                 unsafe extern "C" fn(_: *mut BgMoriRakkatenjo,
                                      _: *mut GlobalContext) -> ());
    (*this).dyna.actor.velocity.y = -0.1f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Rise(mut this:
                                                   *mut BgMoriRakkatenjo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).dyna.actor.velocity.y, 5.0f32, 0.06f32,
                       0.1f32, 0.0f32);
    (*this).dyna.actor.world.pos.y += (*this).dyna.actor.velocity.y;
    if (*this).dyna.actor.world.pos.y >= 683.0f32 {
        BgMoriRakkatenjo_SetupWait(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriRakkatenjo = thisx as *mut BgMoriRakkatenjo;
    ...
    if BgMoriRakkatenjo_IsLinkUnder(this, globalCtx) != 0 {
        if sCamSetting as libc::c_int == CAM_SET_NONE as libc::c_int {
            osSyncPrintf(b"camera changed (mori rakka tenjyo) ... \n\x00" as
            ...
            Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                             usize],
                                 CAM_SET_FOREST_BIRDS_EYE as libc::c_int as
                                     s16);
        }
    } else if sCamSetting as libc::c_int != CAM_SET_NONE as libc::c_int {
        osSyncPrintf(b"camera changed (previous) ... \n\x00" as *const u8 as
                         *const libc::c_char);
        Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                         usize],
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriRakkatenjo_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriRakkatenjo = thisx as *mut BgMoriRakkatenjo;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mori_rakkatenjo.c\x00" as *const u8 as
                        *const libc::c_char, 497 as libc::c_int);
    ...
    (*_g).words.w1 =
        (*globalCtx).objectCtx.status[(*this).moriTexObjIndex as
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gMoriRakkatenjoDL.as_mut_ptr() as libc::c_uint;
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(-(11 as libc::c_int));
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
