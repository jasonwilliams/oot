...
extern "C" {
    ...
    #[no_mangle]
    static mut gObjectMizuObjectsShutterDL_007130: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsShutterCol_007250: CollisionHeader;
    #[no_mangle]
    static mut gObjectMizuObjectsShutterDL_0072D0: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsShutterCol_0073F0: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMizuShutter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMizuShutterActionFunc,
    pub timer: s32,
    pub timerMax: s32,
...
pub type BgMizuShutterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMizuShutter, _: *mut GlobalContext)
               -> ()>;
pub type BgMizuShutterSize = libc::c_uint;
pub const BGMIZUSHUTTER_LARGE: BgMizuShutterSize = 1;
pub const BGMIZUSHUTTER_SMALL: BgMizuShutterSize = 0;
#[no_mangle]
pub static mut Bg_Mizu_Shutter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MIZU_SHUTTER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMizuShutter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuShutter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuShutter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgMizuShutter,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuShutter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgMizuShutter,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuShutter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgMizuShutter,
                                                                                               _:
...
static mut sDisplayLists: [*mut Gfx; 2] =
    unsafe {
        [gObjectMizuObjectsShutterDL_007130.as_ptr() as *mut _,
         gObjectMizuObjectsShutterDL_0072D0.as_ptr() as *mut _]
    };
static mut sCollisionHeaders: [*mut CollisionHeader; 2] =
    unsafe {
        [&gObjectMizuObjectsShutterCol_007250 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsShutterCol_0073F0 as *const CollisionHeader as
             *mut CollisionHeader]
    };
static mut sDisplacements: [Vec3f; 2] =
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_Init(mut thisx: *mut BgMizuShutter,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMizuShutter = thisx;
    let mut pad2: s32 = 0;
    let mut sp30: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad3: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
    (*this).displayList =
        sDisplayLists[((*this).dyna.actor.params as u16_0 as libc::c_int >>
                           0xc as libc::c_int & 0xf as libc::c_int) as usize];
    DynaPolyActor_Init(&mut (*this).dyna, DPM_PLAYER as libc::c_int);
    CollisionHeader_GetVirtual(sCollisionHeaders[((*this).dyna.actor.params as
                                                      u16_0 as libc::c_int >>
                                                      0xc as libc::c_int &
                                                      0xf as libc::c_int) as
                                                     usize] as
                                   *mut libc::c_void, &mut sp30);
    (*this).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                            &mut (*this).dyna.actor, sp30);
    if (*this).dyna.actor.params as u16_0 as libc::c_int >> 0xc as libc::c_int
           & 0xf as libc::c_int == BGMIZUSHUTTER_SMALL as libc::c_int ||
           (*this).dyna.actor.params as u16_0 as libc::c_int >>
               0xc as libc::c_int & 0xf as libc::c_int ==
               BGMIZUSHUTTER_LARGE as libc::c_int {
        (*this).closedPos = (*this).dyna.actor.world.pos;
        (*this).timer = 0 as libc::c_int;
        (*this).timerMax =
            ((*this).dyna.actor.params as u16_0 as libc::c_int >>
                 6 as libc::c_int & 0x3f as libc::c_int) * 20 as libc::c_int;
        ...
        Matrix_RotateX((*this).dyna.actor.world.rot.x as libc::c_int as
                           libc::c_float *
                           (3.14159265358979323846f32 /
                                0x8000 as libc::c_int as libc::c_float),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ((*this).dyna.actor.world.rot.z as libc::c_int as
                           libc::c_float *
                           (3.14159265358979323846f32 /
                                0x8000 as libc::c_int as libc::c_float),
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_MultVec3f(&mut *sDisplacements.as_mut_ptr().offset(((*this).dyna.actor.params
                                                                       as
                                                                       u16_0
                                                                       as
                                                                       libc::c_int
        ...
        if (*this).timerMax != 0x3f as libc::c_int * 20 as libc::c_int {
        ...
        if Flags_GetSwitch(globalCtx,
            ...
            (*this).actionFunc =
                Some(BgMizuShutter_WaitForTimer as
                         unsafe extern "C" fn(_: *mut BgMizuShutter,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(BgMizuShutter_WaitForSwitch as
                         unsafe extern "C" fn(_: *mut BgMizuShutter,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_Destroy(mut thisx: *mut BgMizuShutter,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMizuShutter = thisx;
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_WaitForSwitch(mut this:
                                                         *mut BgMizuShutter,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as u16_0 as libc::c_int &
                           0x3f as libc::c_int) != 0 {
        if (if (*this).dyna.actor.world.rot.x as libc::c_int >=
                   0 as libc::c_int {
                (*this).dyna.actor.world.rot.x as libc::c_int
            } else { -((*this).dyna.actor.world.rot.x as libc::c_int) }) >
               0x2c60 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 4510 as libc::c_int as s16,
        ...
        (*this).actionFunc =
            Some(BgMizuShutter_WaitForCutscene as
                     unsafe extern "C" fn(_: *mut BgMizuShutter,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_WaitForCutscene(mut this:
                                                           *mut BgMizuShutter,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    ...
    if fresh0 == 0 as libc::c_int {
        ...
        (*this).actionFunc =
            Some(BgMizuShutter_Move as
                     unsafe extern "C" fn(_: *mut BgMizuShutter,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_Move(mut this: *mut BgMizuShutter,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as u16_0 as libc::c_int &
        ...
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.x,
                           (*this).openPos.x, 1.0f32, 4.0f32, 0.1f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                           (*this).openPos.y, 1.0f32, 4.0f32, 0.1f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.z,
                           (*this).openPos.z, 1.0f32, 4.0f32, 0.1f32);
        if (*this).dyna.actor.world.pos.x == (*this).openPos.x &&
               (*this).dyna.actor.world.pos.y == (*this).openPos.y &&
        ...
        Math_SmoothStepToF(&mut (*this).maxSpeed, 20.0f32, 1.0f32, 3.0f32,
                           0.1f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.x,
                           (*this).closedPos.x, 1.0f32, (*this).maxSpeed,
                           0.1f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.y,
                           (*this).closedPos.y, 1.0f32, (*this).maxSpeed,
                           0.1f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.z,
                           (*this).closedPos.z, 1.0f32, (*this).maxSpeed,
                           0.1f32);
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_WaitForTimer(mut this:
                                                        *mut BgMizuShutter,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if (*this).timerMax != 0x3f as libc::c_int * 20 as libc::c_int {
        (*this).timer -= 1;
        func_8002F994(&mut (*this).dyna.actor, (*this).timer);
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_Update(mut thisx: *mut BgMizuShutter,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMizuShutter = thisx;
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuShutter_Draw(mut thisx: *mut BgMizuShutter,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMizuShutter = thisx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mizu_shutter.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = (*this).displayList as libc::c_uint
    }
