...
extern "C" {
    ...
    #[no_mangle]
    static mut gTowerCollapseBarsDL: [Gfx; 0];
    #[no_mangle]
    static mut gTowerCollapseBarsCol: CollisionHeader;
}
...
pub type BgZgActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgZg, _: *mut GlobalContext) -> ()>;
pub type BgZgDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgZg, _: *mut GlobalContext) -> ()>;
static mut sActionFuncs: [BgZgActionFunc; 2] =
    unsafe {
        [Some(func_808C0CD4 as
                  unsafe extern "C" fn(_: *mut BgZg, _: *mut GlobalContext)
                      -> ()),
         Some(func_808C0D08 as
                  unsafe extern "C" fn(_: *mut BgZg, _: *mut GlobalContext)
                      -> ())]
    };
...
static mut sDrawFuncs: [BgZgDrawFunc; 1] =
    unsafe {
        [Some(func_808C0EEC as
                  unsafe extern "C" fn(_: *mut BgZg, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub static mut Bg_Zg_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_ZG as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_ZG as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgZg>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn BgZg_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgZg = thisx as *mut BgZg;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
}
#[no_mangle]
pub unsafe extern "C" fn func_808C0C50(mut this: *mut BgZg) {
    Audio_PlaySoundGeneral(0x2859 as libc::c_int as u16_0,
                           &mut (*this).dyna.actor.projectedPos,
                           4 as libc::c_int as u8_0, &mut D_801333E0,
                           &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_808C0C98(mut this: *mut BgZg,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut flag: s32 =
...
#[no_mangle]
pub unsafe extern "C" fn func_808C0CC8(mut this: *mut BgZg) -> s32 {
    let mut flag: s32 =
        (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int;
    return flag;
}
#[no_mangle]
pub unsafe extern "C" fn func_808C0CD4(mut this: *mut BgZg,
                                       mut globalCtx: *mut GlobalContext) {
    if func_808C0C98(this, globalCtx) != 0 as libc::c_int {
        (*this).action = 1 as libc::c_int;
        func_808C0C50(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808C0D08(mut this: *mut BgZg,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if ((*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                              ...
                              usize] as libc::c_int as libc::c_float +
            200.0f32) * 1.2f32 + (*this).dyna.actor.home.pos.y <=
           (*this).dyna.actor.world.pos.y {
        Actor_Kill(&mut (*this).dyna.actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgZg_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgZg = thisx as *mut BgZg;
    let mut action: s32 = (*this).action;
    if action < 0 as libc::c_int || (1 as libc::c_int) < action ||
...
#[no_mangle]
pub unsafe extern "C" fn BgZg_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    ...
    CollisionHeader_GetVirtual(&mut gTowerCollapseBarsCol as
    ...
    if func_808C0CC8(this) == 8 as libc::c_int ||
           func_808C0CC8(this) == 9 as libc::c_int {
        (*this).dyna.actor.scale.x = (*this).dyna.actor.scale.x * 1.3f32;
        (*this).dyna.actor.scale.z = (*this).dyna.actor.scale.z * 1.3f32;
        (*this).dyna.actor.scale.y = (*this).dyna.actor.scale.y * 1.2f32
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_808C0EEC(mut this: *mut BgZg,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), localGfxCtx,
                    b"../z_bg_zg.c\x00" as *const u8 as *const libc::c_char,
                    311 as libc::c_int);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx(localGfxCtx,
                      b"../z_bg_zg.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 315 as libc::c_int) as
            libc::c_uint;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gTowerCollapseBarsDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), localGfxCtx,
                     b"../z_bg_zg.c\x00" as *const u8 as *const libc::c_char,
                     320 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgZg_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgZg = thisx as *mut BgZg;
    let mut drawConfig: s32 = (*this).drawConfig;
    if drawConfig < 0 as libc::c_int || drawConfig > 0 as libc::c_int ||
