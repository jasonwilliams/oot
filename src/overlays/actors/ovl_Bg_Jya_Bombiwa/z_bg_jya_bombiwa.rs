...
extern "C" {
    ...
    #[no_mangle]
    static mut gBombiwaDL: [Gfx; 0];
    #[no_mangle]
    static mut gBombiwaCol: CollisionHeader;
    #[no_mangle]
...
#[no_mangle]
pub static mut Bg_Jya_Bombiwa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_BOMBIWA as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_JYA_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaBombiwa>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombiwa_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombiwa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombiwa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaBombiwa_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_SetupDynaPoly(mut this:
                                                        *mut BgJyaBombiwa,
                                                    mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_bombiwa.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_InitCollider(mut this:
                                                       *mut BgJyaBombiwa,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaBombiwa = thisx as *mut BgJyaBombiwa;
    if (*this).dyna.actor.params as libc::c_int & 0x3f as libc::c_int !=
           0x29 as libc::c_int {
        osSyncPrintf(b"\x1b[43;30m\x00" as *const u8 as *const libc::c_char);
        // "Warning: Switch Number changed (%s %d)(SW %d)"
        osSyncPrintf(b"\xef\xbc\xb7\xef\xbd\x81\xef\xbd\x92\xef\xbd\x8e\xef\xbd\x89\xef\xbd\x8e\xef\xbd\x87 : Switch Number \xe3\x81\x8c\xe5\xa4\x89\xe6\x9b\xb4\xe3\x81\x95\xe3\x82\x8c\xe3\x81\x9f(%s %d)(SW %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_jya_bombiwa.c\x00" as *const u8 as
    ...
    BgJyaBombiwa_SetupDynaPoly(this, globalCtx, &mut gBombiwaCol,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        osSyncPrintf(b"(jya \xe7\x88\x86\xe5\xbc\xbe\xe3\x81\xa7\xe7\xa0\xb4\xe5\xa3\x8a\xe5\xb2\xa9)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).dyna.actor.params as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaBombiwa = thisx as *mut BgJyaBombiwa;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_Break(mut this: *mut BgJyaBombiwa,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    ...
    while i < 16 as libc::c_int {
        pos.x =
            Rand_ZeroOne() * 80.0f32 + (*this).dyna.actor.world.pos.x -
                40.0f32;
        pos.y = Rand_ZeroOne() * 140.0f32 + (*this).dyna.actor.world.pos.y;
        pos.z =
            Rand_ZeroOne() * 80.0f32 + (*this).dyna.actor.world.pos.z -
                40.0f32;
        velocity.x = (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        velocity.y = Rand_ZeroOne() * 12.0f32;
        velocity.z = (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        scale =
            ((i as libc::c_float * 1.8f32) as s32 + 3 as libc::c_int) as s16;
        if scale as libc::c_int > 15 as libc::c_int {
        ...
        if Rand_ZeroOne() < 0.4f32 {
            ...
            arg6 = 0xc as libc::c_int as s8;
            arg7 = 8 as libc::c_int as s8
        } else {
            arg5 = (arg5 as libc::c_int | 0x20 as libc::c_int) as s16;
            arg6 = 0xc as libc::c_int as s8;
            arg7 = 8 as libc::c_int as s8;
            if (scale as libc::c_int) < 10 as libc::c_int {
                arg6 = 0x50 as libc::c_int as s8;
                arg7 = 80 as libc::c_int as s8
            }
        }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             -(400 as libc::c_int) as s16, arg5, arg6 as s16,
                             arg7 as s16, 0 as libc::c_int as s16, scale,
                             1 as libc::c_int as s16,
                             20 as libc::c_int as s16, 80 as libc::c_int,
    ...
    pos.y = (*this).dyna.actor.world.pos.y + 70.0f32;
    pos.z = (*this).dyna.actor.world.pos.z;
    func_80033480(globalCtx, &mut pos, 100.0f32, 0xa as libc::c_int,
                  0x64 as libc::c_int as s16, 0xa0 as libc::c_int as s16,
                  1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgJyaBombiwa = thisx as *mut BgJyaBombiwa;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaBombiwa_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaBombiwa = thisx as *mut BgJyaBombiwa;
    Gfx_DrawDListOpa(globalCtx, gBombiwaDL.as_mut_ptr());
