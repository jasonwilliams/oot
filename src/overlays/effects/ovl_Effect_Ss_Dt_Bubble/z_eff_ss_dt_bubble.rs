...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffBubbleDL: [Gfx; 0];
    #[no_mangle]
    static mut gEffBubble1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gEffBubble2Tex: [u64_0; 0];
}
...
static mut sPrimColors: [Color_RGBA8; 3] =
    [{
         let mut init =
...
static mut sEnvColors: [Color_RGBA8; 3] =
    [{
         let mut init =
...
#[no_mangle]
pub static mut Effect_Ss_Dt_Bubble_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_DT_BUBBLE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDtBubble_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsDtBubble_Init(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               ...
                                               mut initParamsx:
                                                   *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsDtBubbleInitParams =
        initParamsx as *mut EffectSsDtBubbleInitParams;
    ...
    (*this).gfx =
        gSegments[(((if Rand_ZeroOne() < 0.5f32 {
                         gEffBubble1Tex.as_mut_ptr()
                     } else { gEffBubble2Tex.as_mut_ptr() }) as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add((if Rand_ZeroOne() < 0.5f32 {
                                               gEffBubble1Tex.as_mut_ptr()
                                           } else {
                                               gEffBubble2Tex.as_mut_ptr()
                                           }) as u32_0 &
    ...
    if (*initParams).customColor == 0 {
        (*this).regs[0 as libc::c_int as usize] =
            sPrimColors[(*initParams).colorProfile as usize].r as s16;
        (*this).regs[1 as libc::c_int as usize] =
            sPrimColors[(*initParams).colorProfile as usize].g as s16;
        (*this).regs[2 as libc::c_int as usize] =
            sPrimColors[(*initParams).colorProfile as usize].b as s16;
        (*this).regs[3 as libc::c_int as usize] =
            sPrimColors[(*initParams).colorProfile as usize].a as s16;
        (*this).regs[4 as libc::c_int as usize] =
            sEnvColors[(*initParams).colorProfile as usize].r as s16;
        (*this).regs[5 as libc::c_int as usize] =
            sEnvColors[(*initParams).colorProfile as usize].g as s16;
        (*this).regs[6 as libc::c_int as usize] =
            sEnvColors[(*initParams).colorProfile as usize].b as s16;
        (*this).regs[7 as libc::c_int as usize] =
            sEnvColors[(*initParams).colorProfile as usize].a as s16
    } else {
        (*this).regs[0 as libc::c_int as usize] =
    ...
    (*this).regs[8 as libc::c_int as usize] = (*initParams).randXZ;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).life;
    (*this).draw =
        Some(EffectSsDtBubble_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsDtBubble_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsDtBubble_Draw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        gSegments[((gEffBubbleDL.as_mut_ptr() as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(gEffBubbleDL.as_mut_ptr() as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDtBubble_Update(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut index: u32_0,
                                                 mut this: *mut EffectSs) {
    ...
    if (*this).regs[8 as libc::c_int as usize] as libc::c_int ==
           1 as libc::c_int {
        rand = Rand_ZeroOne();
        (*this).pos.x += rand * 2.0f32 - 1.0f32;
        rand = Rand_ZeroOne();
        (*this).pos.z += rand * 2.0f32 - 1.0f32
    };
}
