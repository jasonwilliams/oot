...
pub struct EnGm {
    ...
    pub updateFunc: EnGmUpdateFunc,
    pub actionFunc: EnGmActionFunc,
    pub collider: ColliderCylinder,
    pub objGmBankIndex: s8,
    pub timer: s16,
    pub blinkTimer: s16,
    pub eyeTexIndex: u8_0,
    pub talkPos: Vec3f,
}
pub type EnGmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext) -> ()>;
pub type EnGmUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Gm_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GM as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnGm>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnGm_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGm = thisx as *mut EnGm;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    // "Medi Goron"
    osSyncPrintf(b"\x1b[32m%s[%d] : \xe4\xb8\xad\xe3\x82\xb4\xe3\x83\xad\xe3\x83\xb3[%d]\x1b[m\n\x00"
                     as *const u8 as *const libc::c_char,
                 b"../z_en_gm.c\x00" as *const u8 as *const libc::c_char,
                 133 as libc::c_int, (*this).actor.params as libc::c_int);
    (*this).objGmBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_GM as libc::c_int as s16) as s8;
    if ((*this).objGmBankIndex as libc::c_int) < 0 as libc::c_int {
        osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as *const libc::c_char);
        // "There is no model bank! !! (Medi Goron)"
        osSyncPrintf(b"\xe3\x83\xa2\xe3\x83\x87\xe3\x83\xab \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x81\x8c\xe7\x84\xa1\xe3\x81\x84\xe3\x82\x88\xef\xbc\x81\xef\xbc\x81\xef\xbc\x88\xe4\xb8\xad\xe3\x82\xb4\xe3\x83\xad\xe3\x83\xb3\xef\xbc\x89\n\x00"
                         as *const u8 as *const libc::c_char);
    ...
    (*this).updateFunc =
        Some(func_80A3D838 as
                 unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnGm_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGm = thisx as *mut EnGm;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A3D7C8() -> s32 {
    if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
            5 as libc::c_int
        } else { 17 as libc::c_int }) == 5 as libc::c_int {
        return 0 as libc::c_int
    } else if gBitFlags[2 as libc::c_int as usize] &
...
#[no_mangle]
pub unsafe extern "C" fn func_80A3D838(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).objGmBankIndex as s32) != 0 {
        (*this).actor.flags &=
        ...
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).objGmBankIndex as
                                               usize].segment as
                 *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize)) as
                u32_0;
        Animation_Change(&mut (*this).skelAnime, &mut object_gm_Anim_0002B8,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_gm_Anim_0002B8 as
        ...
        (*this).actor.textId = 0x3049 as libc::c_int as u16_0;
        (*this).updateFunc =
            Some(func_80A3DFBC as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ());
        (*this).actionFunc =
            Some(func_80A3DB04 as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnGm_UpdateEye(mut this: *mut EnGm) {
    if (*this).blinkTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).eyeTexIndex as libc::c_int >= 3 as libc::c_int {
            (*this).eyeTexIndex = 0 as libc::c_int as u8_0;
            (*this).blinkTimer = (Rand_ZeroFloat(60.0f32) + 20.0f32) as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGm_SetTextID(mut this: *mut EnGm) {
    match func_80A3D7C8() {
        0 => {
            if gSaveContext.infTable[11 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                (*this).actor.textId = 0x304b as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x304a as libc::c_int as u16_0 }
        }
        1 => {
            if gSaveContext.infTable[11 as libc::c_int as usize] as
                   libc::c_int & 2 as libc::c_int != 0 {
                (*this).actor.textId = 0x304f as libc::c_int as u16_0
            } else { (*this).actor.textId = 0x304c as libc::c_int as u16_0 }
        }
        2 => { (*this).actor.textId = 0x304e as libc::c_int as u16_0 }
        3 => { (*this).actor.textId = 0x304d as libc::c_int as u16_0 }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A3DB04(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut dx: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    ...
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        EnGm_SetTextID(this);
        (*this).actionFunc =
            Some(func_80A3DC44 as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ())
    } else if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80A3DBF4 as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ())
    } else if (*this).collider.base.ocFlags1 as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 ||
                  dx * dx + dz * dz < 100.0f32 * 100.0f32 {
        (*this).collider.base.acFlags =
            ((*this).collider.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        func_8002F2CC(&mut (*this).actor, globalCtx, 415.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A3DBF4(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A3DC44(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut dx: f32_0 = 0.;
    let mut dz: f32_0 = 0.;
    let mut pad: s32 = 0;
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        ...
        match func_80A3D7C8() {
            0 => {
                ...
                current_block_8 = 6678786911050887708;
            }
            3 => { current_block_8 = 6678786911050887708; }
            1 => {
                gSaveContext.infTable[11 as libc::c_int as usize] =
                    (gSaveContext.infTable[11 as libc::c_int as usize] as
                         libc::c_int | 2 as libc::c_int) as u16_0;
                current_block_8 = 10730214075080373359;
            }
            2 => { current_block_8 = 10730214075080373359; }
            _ => { current_block_8 = 7062641858472886451; }
        }
        match current_block_8 {
            6678786911050887708 => {
                (*this).actionFunc =
                    Some(func_80A3DD7C as
                             unsafe extern "C" fn(_: *mut EnGm,
                                                  _: *mut GlobalContext)
                                 -> ());
                return
            }
            10730214075080373359 => {
                (*this).actionFunc =
                    Some(EnGm_ProcessChoiceIndex as
                             unsafe extern "C" fn(_: *mut EnGm,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A3DD7C(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut dialogState: u8_0 = Message_GetState(&mut (*globalCtx).msgCtx);
    if (dialogState as libc::c_int == TEXT_STATE_DONE as libc::c_int ||
            dialogState as libc::c_int == TEXT_STATE_EVENT as libc::c_int) &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        (*this).actionFunc =
            Some(func_80A3DC44 as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ());
        if dialogState as libc::c_int == TEXT_STATE_EVENT as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnGm_ProcessChoiceIndex(mut this: *mut EnGm,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
            ...
            0 => {
                ...
                if (gSaveContext.rupees as libc::c_int) < 200 as libc::c_int {
                    ...
                    func_8002F434(&mut (*this).actor, globalCtx,
                                  GI_SWORD_KNIFE as libc::c_int, 415.0f32,
                                  10.0f32);
                    (*this).actionFunc =
                        Some(func_80A3DF00 as
                                 unsafe extern "C" fn(_: *mut EnGm,
                                                      _: *mut GlobalContext)
                                     -> ())
                }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A3DF00(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor;
        (*this).actionFunc =
            Some(func_80A3DF60 as
                     unsafe extern "C" fn(_: *mut EnGm, _: *mut GlobalContext)
                         -> ())
    } else {
        func_8002F434(&mut (*this).actor, globalCtx,
                      GI_SWORD_KNIFE as libc::c_int, 415.0f32, 10.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A3DF60(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_DONE as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A3DFBC(mut this: *mut EnGm,
                                       mut globalCtx: *mut GlobalContext) {
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).objGmBankIndex as
                                           usize].segment as
...
#[no_mangle]
pub unsafe extern "C" fn EnGm_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGm = thisx as *mut EnGm;
    (*this).updateFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A3E090(mut this: *mut EnGm) {
    let mut vec1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vec2: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Matrix_Push();
    Matrix_Translate(0.0f32, 0.0f32, 2600.0f32,
    ...
    (*this).collider.dim.pos.x = vec2.x as s16;
    (*this).collider.dim.pos.y = vec2.y as s16;
    (*this).collider.dim.pos.z = vec2.z as s16;
    Matrix_Pop();
    Matrix_Push();
    Matrix_Translate(0.0f32, 0.0f32, 4300.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZYX((*this).actor.world.rot.x, (*this).actor.world.rot.y,
                     (*this).actor.world.rot.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    vec1.y = vec1.z;
    vec1.x = vec1.y;
    Matrix_MultVec3f(&mut vec1, &mut (*this).talkPos);
    Matrix_Pop();
    Matrix_Translate(0.0f32, 0.0f32, 3800.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateZYX((*this).actor.world.rot.x, (*this).actor.world.rot.y,
                     (*this).actor.world.rot.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    vec1.y = vec1.z;
    vec1.x = vec1.y;
    Matrix_MultVec3f(&mut vec1, &mut (*this).actor.focus.pos);
    (*this).actor.focus.pos.y += 100.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnGm_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
