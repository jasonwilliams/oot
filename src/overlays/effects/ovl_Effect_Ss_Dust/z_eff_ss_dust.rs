...
#[no_mangle]
pub static mut Effect_Ss_Dust_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_DUST as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDust_Init as
...
static mut sUpdateFuncs: [EffectSsUpdateFunc; 2] =
    unsafe {
        [Some(EffectSsDust_Update as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                       _: *mut EffectSs) -> ()),
         Some(EffectSsBlast_UpdateFire as
                  unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                       _: *mut EffectSs) -> ())]
    };
/*
 ...
 */
// this reg is also used to set specific colors in the fire update function
#[no_mangle]
pub unsafe extern "C" fn EffectSsDust_Init(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs,
                                           mut initParamsx: *mut libc::c_void)
 -> u32_0 {
    let mut randColorOffset: s32 = 0;
    let mut initParams: *mut EffectSsDustInitParams =
        initParamsx as *mut EffectSsDustInitParams;
    ...
    (*this).gfx =
        gSegments[((gEffDustDL.as_mut_ptr() as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(gEffDustDL.as_mut_ptr() as u32_0 &
    ...
    (*this).update = sUpdateFuncs[(*initParams).updateMode as usize];
    (*this).draw =
        Some(EffectSsDust_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    if (*initParams).drawFlags as libc::c_int & 4 as libc::c_int != 0 {
        randColorOffset = (Rand_ZeroOne() * 20.0f32 - 10.0f32) as s32;
        (*this).regs[0 as libc::c_int as usize] =
            ((*initParams).primColor.r as libc::c_int + randColorOffset) as
                s16;
        (*this).regs[1 as libc::c_int as usize] =
            ((*initParams).primColor.g as libc::c_int + randColorOffset) as
                s16;
        (*this).regs[2 as libc::c_int as usize] =
            ((*initParams).primColor.b as libc::c_int + randColorOffset) as
                s16;
        (*this).regs[4 as libc::c_int as usize] =
            ((*initParams).envColor.r as libc::c_int + randColorOffset) as
                s16;
        (*this).regs[5 as libc::c_int as usize] =
            ((*initParams).envColor.g as libc::c_int + randColorOffset) as
                s16;
        (*this).regs[6 as libc::c_int as usize] =
            ((*initParams).envColor.b as libc::c_int + randColorOffset) as s16
    } else {
        (*this).regs[0 as libc::c_int as usize] =
        ...
        (*this).regs[4 as libc::c_int as usize] =
            (*initParams).envColor.r as s16;
        (*this).regs[5 as libc::c_int as usize] =
            (*initParams).envColor.g as s16;
        (*this).regs[6 as libc::c_int as usize] =
            (*initParams).envColor.b as s16
    }
    (*this).regs[3 as libc::c_int as usize] =
        (*initParams).primColor.a as s16;
    (*this).regs[7 as libc::c_int as usize] = (*initParams).envColor.a as s16;
    (*this).regs[8 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).scaleStep;
    (*this).regs[12 as libc::c_int as usize] = (*initParams).life;
    (*this).regs[11 as libc::c_int as usize] = (*initParams).drawFlags as s16;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsDust_Draw(mut globalCtx: *mut GlobalContext,
                                           mut index: u32_0,
                                           mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_dust.c\x00" as *const u8 as
    ...
    if !mtx.is_null() {
        ...
        (*_g_2).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_2).words.w1 =
            gSegments[((dustTextures[(*this).regs[8 as libc::c_int as usize]
                                         as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(dustTextures[(*this).regs[8 as
                                                                            libc::c_int
                                                                            as
                                                                            usize]
                                                               as usize] as
        ...
        (*__gfxCtx).polyXlu.p =
            Gfx_CallSetupDL((*__gfxCtx).polyXlu.p, 0 as libc::c_int as u32_0);
            ...
            (*_g_6).words.w0 =
                (0xd9 as libc::c_int as u32_0 &
                    ...
                    (!(0 as libc::c_int as u32_0) &
                        ...
                        0 as libc::c_int;
            (*_g_6).words.w1 =
                (0x10000 as libc::c_int | 0x20000 as libc::c_int) as u32_0
        } else if (*this).regs[11 as libc::c_int as usize] as libc::c_int &
                      2 as libc::c_int != 0 {
            ...
            (*_g_8).words.w0 =
                (0xd9 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    24 as libc::c_int |
                    (!((0x10000 as libc::c_int | 0x20000 as libc::c_int) as
                           u32_0) &
                         (((0x1 as libc::c_int) << 24 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_8).words.w1 = 0 as libc::c_int as u32_0
        } else {
                ...
                (0xd9 as libc::c_int as u32_0 &
                    ...
                    (!(0x20000 as libc::c_int as u32_0) &
                         (((0x1 as libc::c_int) << 24 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_9).words.w1 = 0 as libc::c_int as u32_0
        }
        ...
        (*_g_11).words.w1 =
            ((*this).regs[0 as libc::c_int as usize] as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*this).regs[1 as libc::c_int as usize] as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_13).words.w1 = (*this).gfx as libc::c_uint
    }
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDust_Update(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    (*this).accel.x = Rand_ZeroOne() * 0.4f32 - 0.2f32;
    (*this).accel.z = Rand_ZeroOne() * 0.4f32 - 0.2f32;
    if (*this).life as libc::c_int <=
           (*this).regs[12 as libc::c_int as usize] as libc::c_int &&
           (*this).life as libc::c_int >=
               (*this).regs[12 as libc::c_int as usize] as libc::c_int -
                   7 as libc::c_int {
        if (*this).regs[12 as libc::c_int as usize] as libc::c_int >=
               5 as libc::c_int {
            (*this).regs[8 as libc::c_int as usize] =
                ((*this).regs[12 as libc::c_int as usize] as libc::c_int -
                     (*this).life as libc::c_int) as s16
        } else {
            (*this).regs[8 as libc::c_int as usize] =
                (((*this).regs[12 as libc::c_int as usize] as libc::c_int -
                      (*this).life as libc::c_int) *
                     (8 as libc::c_int /
                          (*this).regs[12 as libc::c_int as usize] as
                              libc::c_int)) as s16
        }
    } else {
        (*this).regs[8 as libc::c_int as usize] = 7 as libc::c_int as s16
    }
    (*this).regs[9 as libc::c_int as usize] =
        ((*this).regs[9 as libc::c_int as usize] as libc::c_int +
             (*this).regs[10 as libc::c_int as usize] as libc::c_int) as s16;
}
// this update mode is unused in the original game
#[no_mangle]
pub unsafe extern "C" fn EffectSsBlast_UpdateFire(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut index: u32_0,
                                                  mut this: *mut EffectSs) {
    (*this).accel.x = Rand_ZeroOne() * 0.4f32 - 0.2f32;
    (*this).accel.z = Rand_ZeroOne() * 0.4f32 - 0.2f32;
    match (*this).regs[8 as libc::c_int as usize] as libc::c_int {
        0 => {
            (*this).regs[0 as libc::c_int as usize] =
        ...
        1 => {
            ...
            (*this).regs[5 as libc::c_int as usize] = 0 as libc::c_int as s16;
            (*this).regs[6 as libc::c_int as usize] = 0 as libc::c_int as s16
        }
        2 => {
            (*this).regs[0 as libc::c_int as usize] =
    ...
    if ((*this).regs[8 as libc::c_int as usize] as libc::c_int) <
           7 as libc::c_int {
        (*this).regs[8 as libc::c_int as usize] += 1
    }
    (*this).regs[9 as libc::c_int as usize] =
        ((*this).regs[9 as libc::c_int as usize] as libc::c_int +
             (*this).regs[10 as libc::c_int as usize] as libc::c_int) as s16;
