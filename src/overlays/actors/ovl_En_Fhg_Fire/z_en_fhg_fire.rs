...
extern "C" {
    ...
    #[no_mangle]
    fn func_8002F698(globalCtx: *mut GlobalContext, actor: *mut Actor,
    ...
    #[no_mangle]
    static mut gPhantomWarpDL: [Gfx; 0];
    #[no_mangle]
    static mut gPhantomLightningBlastDL: [Gfx; 0];
    #[no_mangle]
    static mut gPhantomLightningDL: [Gfx; 0];
    #[no_mangle]
    static mut gPhantomEnergyBallDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFhgFire {
    pub actor: Actor,
    pub updateFunc: EnFhgFireUpdateFunc,
    pub work: [s16; 7],
    pub fwork: [f32_0; 15],
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
    pub collider: ColliderCylinder,
    pub lensFlareOn: u8_0,
    pub lensFlareTimer: s16,
    pub lensFlareScale: f32_0,
}
pub type EnFhgFireUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFhgFire, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_21 = libc::c_uint;
pub const FHGFIRE_LIGHTNING_TRAIL: C2RustUnnamed_21 = 100;
pub const FHGFIRE_ENERGY_BALL: C2RustUnnamed_21 = 50;
pub const FHGFIRE_WARP_DEATH: C2RustUnnamed_21 = 41;
pub const FHGFIRE_WARP_RETREAT: C2RustUnnamed_21 = 40;
pub const FHGFIRE_WARP_EMERGE: C2RustUnnamed_21 = 39;
pub const FHGFIRE_SPEAR_LIGHT: C2RustUnnamed_21 = 38;
pub const FHGFIRE_LIGHTNING_BURST: C2RustUnnamed_21 = 36;
pub const FHGFIRE_LIGHTNING_SHOCK: C2RustUnnamed_21 = 35;
pub const FHGFIRE_LIGHTNING_STRIKE: C2RustUnnamed_21 = 1;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const FHGFIRE_LIGHT_REFLECT: C2RustUnnamed_22 = 2;
pub const FHGFIRE_LIGHT_BLUE: C2RustUnnamed_22 = 1;
pub const FHGFIRE_LIGHT_GREEN: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const FHGFIRE_SHORT_COUNT: C2RustUnnamed_23 = 7;
pub const FHGFIRE_KILL_TIMER: C2RustUnnamed_23 = 6;
pub const FHGFIRE_RETURN_COUNT: C2RustUnnamed_23 = 5;
pub const FHGFIRE_FIRE_MODE: C2RustUnnamed_23 = 4;
pub const FHGFIRE_VARIANCE_TIMER: C2RustUnnamed_23 = 3;
pub const FHGFIRE_US_2: C2RustUnnamed_23 = 2;
pub const FHGFIRE_FX_TIMER: C2RustUnnamed_23 = 1;
pub const FHGFIRE_TIMER: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const FHGFIRE_FLOAT_COUNT: C2RustUnnamed_24 = 15;
pub const FHGFIRE_BURST_SCALE: C2RustUnnamed_24 = 11;
pub const FHGFIRE_WARP_ALPHA: C2RustUnnamed_24 = 10;
pub const FHGFIRE_WARP_TEX_SPEED: C2RustUnnamed_24 = 9;
pub const FHGFIRE_WARP_TEX_2_Y: C2RustUnnamed_24 = 8;
pub const FHGFIRE_WARP_TEX_2_X: C2RustUnnamed_24 = 7;
pub const FHGFIRE_WARP_TEX_1_Y: C2RustUnnamed_24 = 6;
pub const FHGFIRE_WARP_TEX_1_X: C2RustUnnamed_24 = 5;
pub const FHGFIRE_UF_4: C2RustUnnamed_24 = 4;
pub const FHGFIRE_SCALE: C2RustUnnamed_24 = 3;
pub const FHGFIRE_UF_2: C2RustUnnamed_24 = 2;
pub const FHGFIRE_UF_1: C2RustUnnamed_24 = 1;
pub const FHGFIRE_ALPHA: C2RustUnnamed_24 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const GND_FLY_CHARGE: C2RustUnnamed_25 = 4;
pub const GND_FLY_RETURN: C2RustUnnamed_25 = 3;
pub const GND_FLY_VOLLEY: C2RustUnnamed_25 = 2;
pub const GND_FLY_NEUTRAL: C2RustUnnamed_25 = 1;
pub const GND_FLY_PAINTING: C2RustUnnamed_25 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnfHG {
    pub actor: Actor,
...
pub const FHGFLASH_LIGHTBALL_WHITE2: C2RustUnnamed_26 = 8;
pub const FHGFLASH_LIGHTBALL_WHITE1: C2RustUnnamed_26 = 7;
pub const FHGFLASH_LIGHTBALL_ORANGE: C2RustUnnamed_26 = 6;
pub const FHGFLASH_LIGHTBALL_PURPLE: C2RustUnnamed_26 = 5;
pub const FHGFLASH_LIGHTBALL_BLUE: C2RustUnnamed_26 = 4;
pub const FHGFLASH_LIGHTBALL_YELLOW: C2RustUnnamed_26 = 3;
pub const FHGFLASH_LIGHTBALL_RED: C2RustUnnamed_26 = 2;
pub const FHGFLASH_LIGHTBALL_LIGHTBLUE: C2RustUnnamed_26 = 1;
pub const FHGFLASH_LIGHTBALL_GREEN: C2RustUnnamed_26 = 0;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const FHGFLASH_SHOCK_PG: C2RustUnnamed_27 = 2;
pub const FHGFLASH_SHOCK_PLAYER: C2RustUnnamed_27 = 1;
pub const FHGFLASH_SHOCK_NO_ACTOR: C2RustUnnamed_27 = 0;
pub type C2RustUnnamed_28 = libc::c_uint;
pub const STRIKE_TRAILS: C2RustUnnamed_28 = 11;
pub const STRIKE_BURST: C2RustUnnamed_28 = 10;
pub const STRIKE_INIT: C2RustUnnamed_28 = 0;
pub type C2RustUnnamed_29 = libc::c_uint;
pub const TRAIL_DISSIPATE: C2RustUnnamed_29 = 2;
pub const TRAIL_APPEAR: C2RustUnnamed_29 = 1;
pub const TRAIL_INIT: C2RustUnnamed_29 = 0;
pub type C2RustUnnamed_30 = libc::c_uint;
pub const BALL_IMPACT: C2RustUnnamed_30 = 2;
pub const BALL_BURST: C2RustUnnamed_30 = 1;
pub const BALL_FIZZLE: C2RustUnnamed_30 = 0;
#[no_mangle]
pub static mut En_Fhg_Fire_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFhgFire_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFhgFire_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_SetUpdate(mut this: *mut EnFhgFire,
                                             mut updateFunc:
                                                 EnFhgFireUpdateFunc) {
    (*this).updateFunc = updateFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFhgFire = thisx as *mut EnFhgFire;
    ...
    if (*this).actor.params as libc::c_int ==
           FHGFIRE_LIGHTNING_SHOCK as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               FHGFIRE_LIGHTNING_BURST as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               FHGFIRE_ENERGY_BALL as libc::c_int {
    ...
    (*this).fwork[FHGFIRE_ALPHA as libc::c_int as usize] = 200.0f32;
    Actor_SetScale(&mut (*this).actor, 0.0f32);
    if (*this).actor.params as libc::c_int ==
           FHGFIRE_LIGHTNING_STRIKE as libc::c_int {
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_LightningStrike as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        Audio_PlayActorSound2(&mut (*this).actor,
                  ...
                  FHGFIRE_LIGHTNING_TRAIL as libc::c_int {
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_LightningTrail as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
    ...
    if (*this).actor.params as libc::c_int ==
        ...
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_LightningShock as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38a3 as libc::c_int as u16_0);
    } else if (*this).actor.params as libc::c_int ==
                  FHGFIRE_LIGHTNING_BURST as libc::c_int {
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_LightningBurst as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        (*this).fwork[FHGFIRE_ALPHA as libc::c_int as usize] = 255.0f32;
        (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
            32 as libc::c_int as s16;
        (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] =
            50 as libc::c_int as s16;
        (*this).lensFlareTimer = 10 as libc::c_int as s16;
        (*this).fwork[FHGFIRE_BURST_SCALE as libc::c_int as usize] =
        ...
        (*this).collider.dim.yShift = 0 as libc::c_int as s16
                  ...
                  FHGFIRE_SPEAR_LIGHT as libc::c_int {
        osSyncPrintf(b"yari hikari ct 1\n\x00" as *const u8 as
                         *const libc::c_char);
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_SpearLight as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        osSyncPrintf(b"yari hikari ct 2\n\x00" as *const u8 as
                         *const libc::c_char);
        (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
            (*this).actor.world.rot.x;
        (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] =
            (*this).actor.world.rot.y
    } else if (*this).actor.params as libc::c_int ==
                  FHGFIRE_WARP_EMERGE as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      FHGFIRE_WARP_RETREAT as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      FHGFIRE_WARP_DEATH as libc::c_int {
        Actor_SetScale(&mut (*this).actor, 7.0f32);
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_PhantomWarp as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        if (*this).actor.params as libc::c_int ==
            ...
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x283f as libc::c_int as u16_0);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2853 as libc::c_int as u16_0);
        }
    } else if (*this).actor.params as libc::c_int ==
                  FHGFIRE_ENERGY_BALL as libc::c_int {
        let mut dxL: f32_0 = 0.;
        let mut dyL: f32_0 = 0.;
        let mut dzL: f32_0 = 0.;
        let mut dxzL: f32_0 = 0.;
        (*this).actor.speedXZ =
            if (*this).actor.world.rot.x as libc::c_int == 0 as libc::c_int {
                8.0f32
            } else { 3.0f32 };
        EnFhgFire_SetUpdate(this,
                            Some(EnFhgFire_EnergyBall as
                                     unsafe extern "C" fn(_: *mut EnFhgFire,
                                                          _:
                                                              *mut GlobalContext)
                                         -> ()));
        ...
        dyL =
            (*player).actor.world.pos.y + 30.0f32 - (*this).actor.world.pos.y;
        dzL = (*player).actor.world.pos.z - (*this).actor.world.pos.z;
        (*this).actor.world.rot.y =
            (Math_FAtan2F(dxL, dzL) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        dxzL = sqrtf(dxL * dxL + dzL * dzL);
        (*this).actor.world.rot.x =
            (Math_FAtan2F(dyL, dxzL) *
                 (0x8000 as libc::c_int as libc::c_float /
                      3.14159265358979323846f32)) as s16;
        (*this).collider.dim.radius = 40 as libc::c_int as s16;
        (*this).collider.dim.height = 50 as libc::c_int as s16;
        (*this).collider.dim.yShift = -(25 as libc::c_int) as s16;
        (*this).lightNode =
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFhgFire = thisx as *mut EnFhgFire;
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_LightningStrike(mut this: *mut EnFhgFire,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut camera: *mut Camera =
        Gameplay_GetCamera(globalCtx, 0 as libc::c_int as s16);
    let mut i: s16 = 0;
    match (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as
              libc::c_int {
        0 => {
            (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] =
                STRIKE_BURST as libc::c_int as s16;
            (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
                7 as libc::c_int as s16
        }
        10 => {
            (*this).actor.shape.rot.y =
                (Camera_GetInputDirYaw(camera) as libc::c_int +
                     0x8000 as libc::c_int *
                         ((*this).work[FHGFIRE_VARIANCE_TIMER as libc::c_int
                                           as usize] as libc::c_int &
                              0xff as libc::c_int)) as s16;
            Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_SCALE
                                                                       as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
                           1.0f32, 1.0f32, 0.2f32);
            if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as
                   libc::c_int == 0 as libc::c_int {
                (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] =
                    STRIKE_TRAILS as libc::c_int as s16;
                ...
                Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                   ...
                                   0 as libc::c_int as s16,
                                   FHGFIRE_LIGHTNING_BURST as libc::c_int as
                                       s16);
                ...
                while (i as libc::c_int) < 35 as libc::c_int {
                    sp7C.x = Rand_CenteredFloat(30.0f32);
                    sp7C.y = Rand_ZeroFloat(5.0f32) + 3.0f32;
                    sp7C.z = Rand_CenteredFloat(30.0f32);
                    sp70.y = -0.2f32;
                    EffectSsFhgFlash_SpawnLightBall(globalCtx,
        ...
        11 => {
            (*this).actor.shape.rot.y =
                (Camera_GetInputDirYaw(camera) as libc::c_int +
                     ((*this).work[FHGFIRE_VARIANCE_TIMER as libc::c_int as
                                       usize] as libc::c_int &
                          0xff as libc::c_int) * 0x8000 as libc::c_int) as
                    s16;
            Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_SCALE
                                                                       as
                                                                       libc::c_int
            ...
            if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as
                ...
                while (i as libc::c_int) < 8 as libc::c_int {
                    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                       &mut (*this).actor, globalCtx,
                                       ACTOR_EN_FHG_FIRE as libc::c_int as
    ...
    Actor_SetScale(&mut (*this).actor,
                   (*this).fwork[FHGFIRE_SCALE as libc::c_int as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_LightningTrail(mut this: *mut EnFhgFire,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    osSyncPrintf(b"FF MOVE 1\n\x00" as *const u8 as *const libc::c_char);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int +
             ((Rand_ZeroOne() * 4000.0f32) as s16 as libc::c_int +
                  0x4000 as libc::c_int)) as s16;
    ...
    match (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as
        ...
        0 => {
            (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] =
                TRAIL_APPEAR as libc::c_int as s16;
            (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
                ((Rand_ZeroOne() * 7.0f32) as s16 as libc::c_int +
                     7 as libc::c_int) as s16;
            current_block_15 = 2869606469423317812;
        }
        1 => { current_block_15 = 2869606469423317812; }
        2 => {
            Math_ApproachZeroF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_SCALE
                                                                           as
                                                                           libc::c_int
                                                                           as
                                                                           isize),
        ...
        _ => { current_block_15 = 7149356873433890176; }
    }
    match current_block_15 {
        2869606469423317812 => {
            Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_SCALE
                                                                       ...
                                                                       as
                                                                       isize),
                           1.7f32, 1.0f32, 0.34f32);
            if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as
                   libc::c_int == 0 as libc::c_int {
                (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] =
                    TRAIL_DISSIPATE as libc::c_int as s16;
                (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
                    10 as libc::c_int as s16;
                (*this).actor.world.pos.z +=
    ...
    Actor_SetScale(&mut (*this).actor,
                   (*this).fwork[FHGFIRE_SCALE as libc::c_int as usize]);
    if (*this).actor.scale.x > 1.0f32 { (*this).actor.scale.x = 1.0f32 }
    osSyncPrintf(b"FF MOVE 2\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_LightningShock(mut this: *mut EnFhgFire,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if Rand_ZeroOne() < 0.5f32 {
        ...
        pos.y -= 20.0f32;
        EffectSsFhgFlash_SpawnShock(globalCtx, &mut (*this).actor, &mut pos,
                                    200 as libc::c_int as s16,
                                    FHGFLASH_SHOCK_NO_ACTOR as libc::c_int as
                                        u8_0);
    }
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 50.0f32, 50.0f32,
                            100.0f32, 1 as libc::c_int);
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_LightningBurst(mut this: *mut EnFhgFire,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x1000 as libc::c_int) as
            s16;
    if (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] as libc::c_int
           == 49 as libc::c_int {
    ...
    if (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] as libc::c_int
        ...
        (*globalCtx).envCtx.screenFillColor[0 as libc::c_int as usize] =
            (*globalCtx).envCtx.screenFillColor[1 as libc::c_int as usize];
        if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int
    ...
    if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int <=
           20 as libc::c_int {
        Math_ApproachZeroF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_ALPHA
                                                                       as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
        ...
        Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_SCALE
                                                                   ...
                                                                   libc::c_int
                                                                   as isize),
                       (*this).fwork[FHGFIRE_BURST_SCALE as libc::c_int as
                                         usize], 0.5f32, 3.0f32);
    }
    Actor_SetScale(&mut (*this).actor,
                   (*this).fwork[FHGFIRE_SCALE as libc::c_int as usize]);
    if (*this).fwork[FHGFIRE_BURST_SCALE as libc::c_int as usize] > 3.0f32 {
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
        if (*player).invincibilityTimer as libc::c_int == 0 as libc::c_int {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).collider.base);
    ...
    if (*this).lensFlareTimer as libc::c_int != 0 as libc::c_int {
        ...
        (*this).lensFlareOn = 1 as libc::c_int as u8_0;
        Math_ApproachF(&mut (*this).lensFlareScale, 40.0f32, 0.3f32, 10.0f32);
    } else {
        Math_ApproachZeroF(&mut (*this).lensFlareScale, 1.0f32, 5.0f32);
        if (*this).lensFlareScale == 0.0f32 {
            (*this).lensFlareOn = 0 as libc::c_int as u8_0
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_SpearLight(mut this: *mut EnFhgFire,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut bossGnd: *mut BossGanondrof = 0 as *mut BossGanondrof;
    let mut i: s16 = 0;
    osSyncPrintf(b"yari hikari 1\n\x00" as *const u8 as *const libc::c_char);
    bossGnd = (*this).actor.parent as *mut BossGanondrof;
    if (*this).work[FHGFIRE_VARIANCE_TIMER as libc::c_int as usize] as
    ...
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_int +
             ((Rand_ZeroOne() * 0x4e20 as libc::c_int as libc::c_float) as s16
                  as libc::c_int + 0x4000 as libc::c_int)) as s16;
    osSyncPrintf(b"yari hikari 2\n\x00" as *const u8 as *const libc::c_char);
    if (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as libc::c_int
           == FHGFIRE_LIGHT_GREEN as libc::c_int {
        let mut ballPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut ballVel: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut ballAccel: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        osSyncPrintf(b"FLASH !!\n\x00" as *const u8 as *const libc::c_char);
        i = 0 as libc::c_int as s16;
        while (i as libc::c_int) < 2 as libc::c_int {
            ...
            ballAccel.y = -0.08f32;
            EffectSsFhgFlash_SpawnLightBall(globalCtx, &mut ballPos,
                                            &mut ballVel, &mut ballAccel,
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_EnergyBall(mut this: *mut EnFhgFire,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut dxL: f32_0 = 0.;
    let mut dyL: f32_0 = 0.;
    let mut dzL: f32_0 = 0.;
    let mut dxzL: f32_0 = 0.;
    let mut dxPG: f32_0 = 0.;
    let mut dyPG: f32_0 = 0.;
    let mut dzPG: f32_0 = 0.;
    let mut killMode: u8_0 = BALL_FIZZLE as libc::c_int as u8_0;
    let mut canBottleReflect1: u8_0 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).work[FHGFIRE_KILL_TIMER as libc::c_int as usize] as libc::c_int
           != 0 as libc::c_int {
        (*this).work[FHGFIRE_KILL_TIMER as libc::c_int as usize] -= 1;
        if (*this).work[FHGFIRE_KILL_TIMER as libc::c_int as usize] as
               libc::c_int == 0 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            return
        }
    } else {
        let mut canBottleReflect2: s32 = 0;
        ...
        (*this).actor.shape.rot.z =
            ((*this).actor.shape.rot.z as libc::c_int +
                 ((Rand_ZeroOne() * 0x4e20 as libc::c_int as libc::c_float) as
                      s16 as libc::c_int + 0x4000 as libc::c_int)) as s16;
        let mut lightBallColor1: u8_0 =
            FHGFLASH_LIGHTBALL_GREEN as libc::c_int as u8_0;
        let mut i1: s16 = 0;
        ...
        let mut spBC: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        if (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as
               libc::c_int >= FHGFIRE_LIGHT_BLUE as libc::c_int {
            lightBallColor1 =
                FHGFLASH_LIGHTBALL_LIGHTBLUE as libc::c_int as u8_0
        }
        i1 = 0 as libc::c_int as s16;
        while (i1 as libc::c_int) < 3 as libc::c_int {
            spD4.x = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.x;
            spD4.y = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.y;
            spD4.z = Rand_CenteredFloat(20.0f32) + (*this).actor.world.pos.z;
            spBC.y = -0.08f32;
            EffectSsFhgFlash_SpawnLightBall(globalCtx, &mut spD4, &mut spC8,
                                            &mut spBC,
                                            ((Rand_ZeroOne() * 80.0f32) as s16
                                                 as libc::c_int +
                                                 150 as libc::c_int) as s16,
        ...
        match (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as
            ...
            0 => {
                canBottleReflect1 =
                    if (*player).stateFlags1 &
                           ...
                           (if ((*player).actor.shape.rot.y as libc::c_int -
                                    ((*bossGnd).actor.yawTowardsPlayer as
                ...
                if (*this).collider.base.acFlags as libc::c_int &
                    ...
                    let mut sp9C: Vec3f =
                        {
                            let mut init =
                                Vec3f{x: 0.0f32, y: -0.5f32, z: 0.0f32,};
                            init
                        };
                    let mut angleModX: s16 = 0;
                    let mut angleModY: s16 = 0;
                    i2 = 0 as libc::c_int as s16;
                    while (i2 as libc::c_int) < 30 as libc::c_int {
                        spA8.x = Rand_CenteredFloat(20.0f32);
                        spA8.y = Rand_CenteredFloat(20.0f32);
                        spA8.z = Rand_CenteredFloat(20.0f32);
                        EffectSsFhgFlash_SpawnLightBall(globalCtx,
                                                        &mut (*this).actor.world.pos,
                                                        &mut spA8, &mut sp9C,
                                                        ((Rand_ZeroOne() *
                    ...
                    canBottleReflect2 = canBottleReflect1 as s32;
                    if canBottleReflect2 == 0 &&
                           (*hurtbox).toucher.dmgFlags &
                               0x100000 as libc::c_int as libc::c_uint != 0 {
                        killMode = BALL_IMPACT as libc::c_int as u8_0;
                        ...
                        if (*bossGnd).flyMode as libc::c_int ==
                               GND_FLY_NEUTRAL as libc::c_int {
                            angleModX =
                                Rand_CenteredFloat(0x2000 as libc::c_int as
                                                       f32_0) as s16;
                            angleModY =
                                Rand_CenteredFloat(0x2000 as libc::c_int as
                                                       f32_0) as s16;
                            ...
                            angleModX = 0 as libc::c_int as s16;
                            angleModY = 0 as libc::c_int as s16;
                            (*this).work[FHGFIRE_RETURN_COUNT as libc::c_int
                                             as usize] += 1;
                            if (*this).work[FHGFIRE_RETURN_COUNT as
                                                libc::c_int as usize] as
                                   libc::c_int > 3 as libc::c_int &&
                                   Rand_ZeroOne() < 0.5f32 {
                                (*this).work[FHGFIRE_RETURN_COUNT as
                                                 libc::c_int as usize] =
                            ...
                            if canBottleReflect2 == 0 &&
                                ...
                                (*this).work[FHGFIRE_RETURN_COUNT as
                                                 libc::c_int as usize] =
                                    4 as libc::c_int as s16
                            } else { (*this).actor.speedXZ += 1.0f32 }
                        }
                        (*this).actor.world.rot.y =
                            ((Math_FAtan2F(dxPG, dzPG) *
                                  (0x8000 as libc::c_int as libc::c_float /
                                       3.14159265358979323846f32)) as s16 as
                                 libc::c_int + angleModY as libc::c_int) as
                                s16;
                        (*this).actor.world.rot.x =
                            ((Math_FAtan2F(dyPG,
                                           sqrtf(dxPG * dxPG + dzPG * dzPG)) *
                                  (0x8000 as libc::c_int as libc::c_float /
                                       3.14159265358979323846f32)) as s16 as
                                 libc::c_int + angleModX as libc::c_int) as
                                s16;
                        (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as
                                         usize] =
                ...
                } else if sqrtf(dxL * dxL + dyL * dyL + dzL * dzL) <= 25.0f32
                 {
                    killMode = BALL_BURST as libc::c_int as u8_0;
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x38a8 as libc::c_int as u16_0);
                    if (*bossGnd).flyMode as libc::c_int >=
                           GND_FLY_VOLLEY as libc::c_int &&
                           (*this).work[FHGFIRE_RETURN_COUNT as libc::c_int as
                                            usize] as libc::c_int >=
                               2 as libc::c_int {
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x38b0 as libc::c_int as u16_0);
                    }
                    func_8002F698(globalCtx, &mut (*this).actor, 3.0f32,
                ...
                if (*bossGnd).flyMode as libc::c_int ==
                    ...
                    (*this).actor.world.rot.y =
                        (Math_FAtan2F(dxPG, dzPG) *
                             (0x8000 as libc::c_int as libc::c_float /
                                  3.14159265358979323846f32)) as s16;
                    if sqrtf(dxPG * dxPG + dzPG * dzPG) <
                           150.0f32 + (*this).actor.speedXZ * 8.0f32 {
                        (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as
                                         usize] =
                            FHGFIRE_LIGHT_REFLECT as libc::c_int as s16;
                        (*bossGnd).returnSuccess = 1 as libc::c_int as u8_0;
                        (*this).work[FHGFIRE_TIMER as libc::c_int as usize] =
                            8 as libc::c_int as s16
                    }
                } else {
                    if (*this).work[FHGFIRE_RETURN_COUNT as libc::c_int as
                                        usize] as libc::c_int >=
                           100 as libc::c_int {
                        if sqrtf(dxPG * dxPG + dyPG * dyPG + dzPG * dzPG) <
                               100.0f32 {
                            (*bossGnd).returnSuccess =
                    ...
                    if fabsf(dxPG) < 30.0f32 && fabsf(dzPG) < 30.0f32 &&
                           fabsf(dyPG) < 45.0f32 {
                        killMode = BALL_IMPACT as libc::c_int as u8_0;
                        (*bossGnd).returnCount =
                            ((*this).work[FHGFIRE_RETURN_COUNT as libc::c_int
                                              as usize] as libc::c_int +
                                 1 as libc::c_int) as u8_0;
                        Audio_PlaySoundGeneral(0x38a8 as libc::c_int as u16_0,
                                               &mut (*bossGnd).actor.projectedPos,
                                               4 as libc::c_int as u8_0,
                                               &mut D_801333E0,
                                               &mut D_801333E0,
                                               &mut D_801333E8);
                        Audio_PlaySoundGeneral(0x38ae as libc::c_int as u16_0,
                                               &mut (*bossGnd).actor.projectedPos,
                                               4 as libc::c_int as u8_0,
                                               &mut D_801333E0,
                                               &mut D_801333E0,
            ...
            2 => {
                if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as
                    ...
                    while (i3 as libc::c_int) < 30 as libc::c_int {
                        sp88.x = Rand_CenteredFloat(20.0f32);
                        sp88.y = Rand_CenteredFloat(20.0f32);
                        sp88.z = Rand_CenteredFloat(20.0f32);
                        EffectSsFhgFlash_SpawnLightBall(globalCtx,
                                                        &mut (*this).actor.world.pos,
                                                        &mut sp88, &mut sp7C,
                                                        ((Rand_ZeroOne() *
        ...
        osSyncPrintf(b"F_FIRE_MODE %d\n\x00" as *const u8 as
                         *const libc::c_char,
                     (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize]
                         as libc::c_int);
        osSyncPrintf(b"fly_mode    %d\n\x00" as *const u8 as
                         *const libc::c_char,
                     (*bossGnd).flyMode as libc::c_int);
        if (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] as
               libc::c_int == 0 as libc::c_int {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 50.0f32,
                                    50.0f32, 100.0f32, 7 as libc::c_int);
            if (*this).actor.bgCheckFlags as libc::c_int & 0x19 as libc::c_int
                   != 0 || killMode as libc::c_int != 0 {
                let mut lightBallColor2: u8_0 =
                    FHGFLASH_LIGHTBALL_GREEN as libc::c_int as u8_0;
                let mut i4: s16 = 0;
                ...
                if (*this).work[FHGFIRE_FIRE_MODE as libc::c_int as usize] as
                       libc::c_int > FHGFIRE_LIGHT_GREEN as libc::c_int {
                    lightBallColor2 =
                        FHGFLASH_LIGHTBALL_LIGHTBLUE as libc::c_int as u8_0
                }
                i4 = 0 as libc::c_int as s16;
                while (i4 as libc::c_int) < 30 as libc::c_int {
                    sp6C.x = Rand_CenteredFloat(20.0f32);
                    sp6C.y = Rand_CenteredFloat(20.0f32);
                    sp6C.z = Rand_CenteredFloat(20.0f32);
                    sp60.y = -0.1f32;
                    EffectSsFhgFlash_SpawnLightBall(globalCtx,
                                                    &mut (*this).actor.world.pos,
                                                    &mut sp6C, &mut sp60,
                ...
                if killMode as libc::c_int == BALL_BURST as libc::c_int {
                    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                                       &mut (*this).actor, globalCtx,
                                       ACTOR_EN_FHG_FIRE as libc::c_int as
                                           s16, (*this).actor.world.pos.x,
                ...
                (*bossGnd).flyMode = GND_FLY_NEUTRAL as libc::c_int as u8_0;
                (*this).work[FHGFIRE_KILL_TIMER as libc::c_int as usize] =
                    30 as libc::c_int as s16;
                (*this).actor.draw = None;
                if killMode as libc::c_int == BALL_FIZZLE as libc::c_int {
                    Audio_PlayActorSound2(&mut (*this).actor,
                ...
                Collider_UpdateCylinder(&mut (*this).actor,
                                        &mut (*this).collider);
                osSyncPrintf(b"BEFORE setAC   %d\n\x00" as *const u8 as
                                 *const libc::c_char,
                             (*this).collider.base.shape as libc::c_int);
                CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                                     &mut (*this).collider.base);
                osSyncPrintf(b"AFTER  setAC\n\x00" as *const u8 as
                                 *const libc::c_char);
            }
        }
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                                  ...
                                  255 as libc::c_int as u8_0,
                                  200 as libc::c_int as s16);
        if (*this).actor.speedXZ > 20.0f32 { (*this).actor.speedXZ = 20.0f32 }
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x38a7 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        // "Why ah ah ah ah"
        osSyncPrintf(b"\xe3\x81\xaa\xe3\x81\x9c\xe3\x81\xa0\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82\xe3\x81\x82      %d\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_PhantomWarp(mut this: *mut EnFhgFire,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut horse: *mut EnfHG = (*this).actor.parent as *mut EnfHG;
    let mut scrollDirection: f32_0 = 0.;
    (*this).fwork[FHGFIRE_WARP_TEX_1_X as libc::c_int as usize] +=
        25.0f32 *
            (*this).fwork[FHGFIRE_WARP_TEX_SPEED as libc::c_int as usize];
    (*this).fwork[FHGFIRE_WARP_TEX_1_Y as libc::c_int as usize] -=
        40.0f32 *
            (*this).fwork[FHGFIRE_WARP_TEX_SPEED as libc::c_int as usize];
    (*this).fwork[FHGFIRE_WARP_TEX_2_X as libc::c_int as usize] +=
        5.0f32 *
            (*this).fwork[FHGFIRE_WARP_TEX_SPEED as libc::c_int as usize];
    (*this).fwork[FHGFIRE_WARP_TEX_2_Y as libc::c_int as usize] -=
        30.0f32 *
            (*this).fwork[FHGFIRE_WARP_TEX_SPEED as libc::c_int as usize];
    if (*this).actor.params as libc::c_int ==
           FHGFIRE_WARP_DEATH as libc::c_int {
        if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int
               > 70 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  (0x2840 as libc::c_int -
                                       0x800 as libc::c_int) as u16_0);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  (0x2854 as libc::c_int -
                                       0x800 as libc::c_int) as u16_0);
        }
        if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int
               == 70 as libc::c_int {
    ...
    if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int >
           50 as libc::c_int {
        scrollDirection = 1.0f32;
        if (*this).actor.params as libc::c_int >
               FHGFIRE_WARP_EMERGE as libc::c_int {
            scrollDirection = -1.0f32
        }
        Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_WARP_TEX_SPEED
                                                                   as
                                                                   libc::c_int
                                                                   as isize),
                       scrollDirection, 1.0f32, 0.04f32);
        Math_ApproachF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_WARP_ALPHA
                                                                   as
                                                                   libc::c_int
                                                                   as isize),
                       255.0f32, 1.0f32, 10.2f32);
    } else if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as
                  libc::c_int <= 25 as libc::c_int {
        Math_ApproachZeroF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_WARP_TEX_SPEED
                                                                       as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
                           1.0f32, 0.04f32);
        Math_ApproachZeroF(&mut *(*this).fwork.as_mut_ptr().offset(FHGFIRE_WARP_ALPHA
                                                                       as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
    ...
    osSyncPrintf(b"EFC 1\n\x00" as *const u8 as *const libc::c_char);
    if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int ==
           0 as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               FHGFIRE_WARP_EMERGE as libc::c_int &&
               (*horse).fhgFireKillWarp as libc::c_int != 0 {
        Actor_Kill(&mut (*this).actor);
    }
    osSyncPrintf(b"EFC 2\n\x00" as *const u8 as *const libc::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFhgFire = thisx as *mut EnFhgFire;
    (*this).work[FHGFIRE_VARIANCE_TIMER as libc::c_int as usize] += 1;
    if (*this).work[FHGFIRE_TIMER as libc::c_int as usize] as libc::c_int !=
           0 as libc::c_int {
        (*this).work[FHGFIRE_TIMER as libc::c_int as usize] -= 1
    }
    if (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] as libc::c_int
           != 0 as libc::c_int {
        (*this).work[FHGFIRE_FX_TIMER as libc::c_int as usize] -= 1
    }
    (*this).updateFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnFhgFire_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnFhgFire = thisx as *mut EnFhgFire;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fhg_fire.c\x00" as *const u8 as
    ...
    if (*this).actor.params as libc::c_int ==
            ...
            (255 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).fwork[FHGFIRE_ALPHA as libc::c_int as usize] as s8 as
                     u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        ...
        (*_g_3).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_3).words.w1 =
            gSegments[((gPhantomLightningBlastDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gPhantomLightningBlastDL.as_mut_ptr()
                                                  as u32_0 &
                ...
                as *mut libc::c_void as libc::c_uint
                  ...
                  (*this).actor.params as libc::c_int ==
                      FHGFIRE_ENERGY_BALL as libc::c_int {
        osSyncPrintf(b"yari hikari draw 1\n\x00" as *const u8 as
                         *const libc::c_char);
        ...
        Matrix_RotateZ((*this).actor.shape.rot.z as libc::c_int as
                           ...
                           3.1416f32, MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_9).words.w1 = gPhantomEnergyBallDL.as_mut_ptr() as libc::c_uint
    } else if (*this).actor.params as libc::c_int ==
                  FHGFIRE_WARP_EMERGE as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      FHGFIRE_WARP_RETREAT as libc::c_int ||
            ...
            (0 as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).fwork[FHGFIRE_WARP_ALPHA as libc::c_int as usize] as
                     u8_0 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
            ...
            (90 as libc::c_int as u32_0 &
                ...
                (95 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                (((*this).fwork[FHGFIRE_WARP_ALPHA as libc::c_int as usize] *
                      0.5f32) as s8 as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        ...
        (*_g_14).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             (*this).fwork[FHGFIRE_WARP_TEX_1_X as libc::c_int
                                               as usize] as s16 as u32_0,
                             (*this).fwork[FHGFIRE_WARP_TEX_1_Y as libc::c_int
                                               as usize] as s16 as u32_0,
                             0x40 as libc::c_int, 0x40 as libc::c_int,
                             1 as libc::c_int,
                             (*this).fwork[FHGFIRE_WARP_TEX_2_X as libc::c_int
                                               as usize] as s16 as u32_0,
                             (*this).fwork[FHGFIRE_WARP_TEX_2_Y as libc::c_int
                                               as usize] as s16 as u32_0,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_15).words.w1 = gPhantomWarpDL.as_mut_ptr() as libc::c_uint
    } else {
        osSyncPrintf(b"FF DRAW 1\n\x00" as *const u8 as *const libc::c_char);
        Matrix_Translate(0.0f32, -100.0f32, 0.0f32,
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_20).words.w1 = gPhantomLightningDL.as_mut_ptr() as libc::c_uint;
        osSyncPrintf(b"FF DRAW 2\n\x00" as *const u8 as *const libc::c_char);
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_fhg_fire.c\x00" as *const u8 as
                         *const libc::c_char, 1900 as libc::c_int);
}
