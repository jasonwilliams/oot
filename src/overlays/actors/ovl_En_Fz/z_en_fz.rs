...
extern "C" {
    ...
    fn Item_DropCollectibleRandom(globalCtx: *mut GlobalContext,
                                  ...
                                  params: s16);
    #[no_mangle]
    fn EffectSsEnIce_Spawn(arg0: *mut GlobalContext, pos: *mut Vec3f,
                           scale: f32_0, velocity: *mut Vec3f,
                           accel: *mut Vec3f, primColor: *mut Color_RGBA8,
                           envColor: *mut Color_RGBA8, life: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gFreezardIntactDL: [Gfx; 0];
    #[no_mangle]
    static mut gFreezardTopRightHornChippedDL: [Gfx; 0];
    #[no_mangle]
    static mut gFreezardHeadChippedDL: [Gfx; 0];
    #[no_mangle]
    static mut gFreezardSteamStartDL: [Gfx; 0];
    #[no_mangle]
    static mut gFreezardSteamDL: [Gfx; 0];
}
...
pub struct EnFz {
    pub actor: Actor,
    pub actionFunc: EnFzActionFunc,
    pub collider1: ColliderCylinder,
    pub collider2: ColliderCylinder,
    pub collider3: ColliderCylinder,
    pub posOrigin: Vec3f,
    pub counter: s16,
    pub unusedTimer1: s16,
    pub timer: s16,
    pub updateBgInfo: u8_0,
    pub isMoving: u8_0,
    pub isFreezing: u8_0,
    pub unusedCounter: u8_0,
    pub iceSmokeFreezingSpawnHeight: f32_0,
    pub unusedFloat: f32_0,
    pub speedXZ: f32_0,
    pub envAlpha: u32_0,
    pub unusedNum1: u16_0,
    pub unusedNum2: u16_0,
    pub state: u8_0,
    pub isActive: u8_0,
    pub isDespawning: u8_0,
    pub unusedTimer2: u8_0,
    pub wallHitPos: Vec3f,
    pub distToTargetSq: f32_0,
    pub iceSmoke: [EnFzEffectSsIceSmoke; 40],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFzEffectSsIceSmoke {
    pub type_0: u8_0,
    pub timer: u8_0,
    pub pos: Vec3f,
    pub velocity: Vec3f,
    pub accel: Vec3f,
    pub unk_28: [libc::c_char; 4],
    pub primAlpha: s16,
    pub primAlphaState: s16,
    pub xyScale: f32_0,
    pub xyScaleTarget: f32_0,
    pub isTimerMod8: u8_0,
}
pub type EnFzActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext) -> ()>;
pub type EnFzSpawnIceSmokeFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFz) -> ()>;
#[no_mangle]
pub static mut En_Fz_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FZ as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_FZ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnFz>() as libc::c_ulong,
                          init:
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFz = thisx as *mut EnFz;
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).collider3);
    Collider_SetCylinderType1(globalCtx, &mut (*this).collider3,
                              &mut (*this).actor, &mut sCylinderInit3);
    ...
    (*this).unusedTimer1 = 0 as libc::c_int as s16;
    (*this).unusedCounter = 0 as libc::c_int as u8_0;
    (*this).updateBgInfo = 1 as libc::c_int as u8_0;
    (*this).isMoving = 0 as libc::c_int as u8_0;
    (*this).isFreezing = 0 as libc::c_int as u8_0;
    (*this).isActive = 1 as libc::c_int as u8_0;
    (*this).isDespawning = 0 as libc::c_int as u8_0;
    ...
    (*this).unusedFloat = 135.0f32;
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int {
        (*this).envAlpha = 0 as libc::c_int as u32_0;
        (*this).actor.scale.y = 0.0f32;
        EnFz_SetupWait(this);
    } else {
        (*this).envAlpha = 255 as libc::c_int as u32_0;
        EnFz_SetupBlowSmokeStationary(this);
    }
    EnFz_UpdateTargetPos(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFz = thisx as *mut EnFz;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider1);
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider2);
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider3);
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_UpdateTargetPos(mut this: *mut EnFz,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    let mut bgId: s32 = 0;
    let mut hitPoly: *mut CollisionPoly = 0 as *mut CollisionPoly;
    pos.x = (*this).actor.world.pos.x;
    pos.y = (*this).actor.world.pos.y + 20.0f32;
    pos.z = (*this).actor.world.pos.z;
    Matrix_Translate(pos.x, pos.y, pos.z, MTXMODE_NEW as libc::c_int as u8_0);
    ...
    vec1.x = vec1.y;
    vec1.z = 220.0f32;
    Matrix_MultVec3f(&mut vec1, &mut (*this).wallHitPos);
    if BgCheck_EntityLineTest1(&mut (*globalCtx).colCtx, &mut pos,
                               &mut (*this).wallHitPos, &mut hitPos,
                               &mut hitPoly, 1 as libc::c_int,
                               0 as libc::c_int, 0 as libc::c_int,
                               1 as libc::c_int, &mut bgId) != 0 {
        Math_Vec3f_Copy(&mut (*this).wallHitPos, &mut hitPos);
    }
    pos.x = (*this).actor.world.pos.x - (*this).wallHitPos.x;
    pos.z = (*this).actor.world.pos.z - (*this).wallHitPos.z;
    (*this).distToTargetSq = pos.x * pos.x + pos.z * pos.z;
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_ReachedTarget(mut this: *mut EnFz,
                                            mut vec: *mut Vec3f) -> s32 {
    if (*this).distToTargetSq <=
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_Damaged(mut this: *mut EnFz,
                                      mut globalCtx: *mut GlobalContext,
                                      mut vec: *mut Vec3f,
                                      mut numEffects: s32,
                                      mut unkFloat: f32_0) {
    ...
    let mut life: s32 = 0;
    primColor.r = 155 as libc::c_int as u8_0;
    primColor.g = 255 as libc::c_int as u8_0;
    primColor.b = 255 as libc::c_int as u8_0;
    primColor.a = 255 as libc::c_int as u8_0;
    envColor.r = 200 as libc::c_int as u8_0;
    envColor.g = 200 as libc::c_int as u8_0;
    envColor.b = 200 as libc::c_int as u8_0;
    accel.z = 0.0f32;
    accel.x = accel.z;
    accel.y = -1.0f32;
    i = 0 as libc::c_int;
    while i < numEffects {
        scale = Rand_CenteredFloat(0.3f32) + 0.6f32;
        life = Rand_CenteredFloat(5.0f32) as s32 + 12 as libc::c_int;
        pos.x = Rand_CenteredFloat(unkFloat) + (*vec).x;
        pos.y = Rand_ZeroFloat(unkFloat) + (*vec).y;
        pos.z = Rand_CenteredFloat(unkFloat) + (*vec).z;
        vel.x = Rand_CenteredFloat(10.0f32);
        vel.y = Rand_ZeroFloat(10.0f32) + 2.0f32;
        vel.z = Rand_CenteredFloat(10.0f32);
        EffectSsEnIce_Spawn(globalCtx, &mut pos, scale, &mut vel, &mut accel,
                            &mut primColor, &mut envColor, life);
        i += 1
    }
    CollisionCheck_SpawnShieldParticles(globalCtx, vec);
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_SpawnIceSmokeHiddenState(mut this: *mut EnFz) {
}
// Fully grown
#[no_mangle]
pub unsafe extern "C" fn EnFz_SpawnIceSmokeGrowingState(mut this: *mut EnFz) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut accel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).counter as libc::c_int % 16 as libc::c_int == 0 as libc::c_int
       {
        pos.x = Rand_CenteredFloat(40.0f32) + (*this).actor.world.pos.x;
        pos.y =
            Rand_CenteredFloat(40.0f32) + (*this).actor.world.pos.y + 30.0f32;
        pos.z = Rand_CenteredFloat(40.0f32) + (*this).actor.world.pos.z;
        accel.z = 0.0f32;
        accel.x = accel.z;
        accel.y = 0.1f32;
        velocity.z = 0.0f32;
        ...
        EnFz_SpawnIceSmokeNoFreeze(this, &mut pos, &mut velocity, &mut accel,
                                   Rand_ZeroFloat(7.5f32) + 15.0f32);
    };
}
// (2) Growing or Shrinking to/from hiding or (3) melting from fire
#[no_mangle]
pub unsafe extern "C" fn EnFz_SpawnIceSmokeActiveState(mut this: *mut EnFz) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut accel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).counter as libc::c_int % 4 as libc::c_int == 0 as libc::c_int {
        pos.x = Rand_CenteredFloat(40.0f32) + (*this).actor.world.pos.x;
...
pub unsafe extern "C" fn EnFz_ApplyDamage(mut this: *mut EnFz,
    ...
    if (*this).isFreezing != 0 {
        if ((*this).actor.params as libc::c_int) < 0 as libc::c_int &&
            ...
            (*this).speedXZ = 0.0f32;
            (*this).actor.speedXZ = (*this).speedXZ;
            (*this).timer = 10 as libc::c_int as s16;
            EnFz_SetupDisappear(this);
        } else if (*this).collider2.base.acFlags as libc::c_int &
            ...
            (*this).collider1.base.acFlags =
                ((*this).collider1.base.acFlags as libc::c_int &
                     !(2 as libc::c_int)) as u8_0
        } else if (*this).collider1.base.acFlags as libc::c_int &
                      2 as libc::c_int != 0 {
            (*this).collider1.base.acFlags =
                ((*this).collider1.base.acFlags as libc::c_int &
                     !(2 as libc::c_int)) as u8_0;
                ...
                if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                    ...
                    if (*this).actor.colChkInfo.health != 0 {
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x39a5 as libc::c_int as u16_0);
                        vec.x = (*this).actor.world.pos.x;
                        vec.y = (*this).actor.world.pos.y;
                        vec.z = (*this).actor.world.pos.z;
                        EnFz_Damaged(this, globalCtx, &mut vec,
                                     10 as libc::c_int, 0.0f32);
                        (*this).unusedCounter =
                            (*this).unusedCounter.wrapping_add(1)
                    } else {
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x39a6 as libc::c_int as u16_0);
                        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetYawTowardsPlayer(mut this: *mut EnFz) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       10 as libc::c_int as s16, 2000 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupDisappear(mut this: *mut EnFz) {
    (*this).state = 2 as libc::c_int as u8_0;
    (*this).isFreezing = 0 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnFz_Disappear as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_Disappear(mut this: *mut EnFz,
                                        mut globalCtx: *mut GlobalContext) {
    (*this).envAlpha =
        ((*this).envAlpha as
             libc::c_uint).wrapping_sub(16 as libc::c_int as libc::c_uint) as
            u32_0 as u32_0;
    if (*this).envAlpha > 255 as libc::c_int as libc::c_uint {
        (*this).envAlpha = 0 as libc::c_int as u32_0
    }
    if Math_SmoothStepToF(&mut (*this).actor.scale.y, 0.0f32, 1.0f32,
                          0.0005f32, 0 as libc::c_int as f32_0) == 0.0f32 {
        EnFz_SetupWait(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupWait(mut this: *mut EnFz) {
    (*this).state = 0 as libc::c_int as u8_0;
    (*this).unusedNum2 = 0 as libc::c_int as u16_0;
    (*this).unusedNum1 = 0 as libc::c_int as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_Wait(mut this: *mut EnFz,
                                   mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupAppear(mut this: *mut EnFz) {
    (*this).state = 2 as libc::c_int as u8_0;
    (*this).timer = 20 as libc::c_int as s16;
    (*this).unusedNum2 = 4000 as libc::c_int as u16_0;
    (*this).actionFunc =
        Some(EnFz_Appear as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_Appear(mut this: *mut EnFz,
                                     mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).envAlpha =
            ((*this).envAlpha as
        ...
        if Math_SmoothStepToF(&mut (*this).actor.scale.y, 0.008f32, 1.0f32,
                              0.0005f32, 0.0f32) == 0.0f32 {
            EnFz_SetupAimForMove(this);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupAimForMove(mut this: *mut EnFz) {
    (*this).state = 1 as libc::c_int as u8_0;
    (*this).timer = 40 as libc::c_int as s16;
    (*this).updateBgInfo = 1 as libc::c_int as u8_0;
    (*this).isFreezing = 1 as libc::c_int as u8_0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnFz_AimForMove as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
    (*this).actor.gravity = -1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_AimForMove(mut this: *mut EnFz,
                                         mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupMoveTowardsPlayer(mut this: *mut EnFz) {
    (*this).state = 1 as libc::c_int as u8_0;
    (*this).isMoving = 1 as libc::c_int as u8_0;
    (*this).timer = 100 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnFz_MoveTowardsPlayer as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
    (*this).speedXZ = 4.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_MoveTowardsPlayer(mut this: *mut EnFz,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           (*this).isMoving == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupAimForFreeze(mut this: *mut EnFz) {
    (*this).state = 1 as libc::c_int as u8_0;
    (*this).timer = 40 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnFz_AimForFreeze as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
    (*this).speedXZ = 0.0f32;
    (*this).actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_AimForFreeze(mut this: *mut EnFz,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    EnFz_SetYawTowardsPlayer(this);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupBlowSmoke(mut this: *mut EnFz,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).state = 1 as libc::c_int as u8_0;
    (*this).timer = 80 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnFz_BlowSmoke as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
    EnFz_UpdateTargetPos(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_BlowSmoke(mut this: *mut EnFz,
                                        mut globalCtx: *mut GlobalContext) {
    let mut vec1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut accel: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut isTimerMod8: u8_0 = 0;
    let mut primAlpha: s16 = 0;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        EnFz_SetupDisappear(this);
    } else if (*this).timer as libc::c_int >= 11 as libc::c_int {
        isTimerMod8 = 0 as libc::c_int as u8_0;
        primAlpha = 150 as libc::c_int as s16;
        func_8002F974(&mut (*this).actor,
                      (0x39a4 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
        ...
        vec1.y = -2.0f32;
        vec1.z = 20.0f32;
        Matrix_MultVec3f(&mut vec1, &mut velocity);
        if (*this).timer as libc::c_int % 8 as libc::c_int == 0 as libc::c_int
           {
            isTimerMod8 = 1 as libc::c_int as u8_0
        }
        EnFz_SpawnIceSmokeFreeze(this, &mut pos, &mut velocity, &mut accel,
                                 2.0f32, 25.0f32, primAlpha, isTimerMod8);
        pos.x += velocity.x * 0.5f32;
        pos.y += velocity.y * 0.5f32;
        pos.z += velocity.z * 0.5f32;
        EnFz_SpawnIceSmokeFreeze(this, &mut pos, &mut velocity, &mut accel,
                                 2.0f32, 25.0f32, primAlpha,
                                 0 as libc::c_int as u8_0);
    };
}
// Death
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupDespawn(mut this: *mut EnFz,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).state = 0 as libc::c_int as u8_0;
    (*this).updateBgInfo = 1 as libc::c_int as u8_0;
    (*this).isFreezing = 0 as libc::c_int as u8_0;
    (*this).isDespawning = 1 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    ...
    Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                               ...
                               0x60 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnFz_Despawn as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_Despawn(mut this: *mut EnFz,
                                      mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupMelt(mut this: *mut EnFz) {
    (*this).state = 3 as libc::c_int as u8_0;
    (*this).isFreezing = 0 as libc::c_int as u8_0;
    (*this).isDespawning = 1 as libc::c_int as u8_0;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_Melt(mut this: *mut EnFz,
                                   mut globalCtx: *mut GlobalContext) {
    Math_StepToF(&mut (*this).actor.scale.y, 0.0006f32, 0.0002f32);
    if (*this).actor.scale.y < 0.006f32 {
        (*this).actor.scale.x += 0.0004f32;
        (*this).actor.scale.z += 0.0004f32
    }
    if (*this).actor.scale.y < 0.004f32 {
        (*this).envAlpha =
            ((*this).envAlpha as
    ...
    if (*this).envAlpha == 0 as libc::c_int as libc::c_uint {
        EnFz_SetupDespawn(this, globalCtx);
    };
}
// Stationary Freezard
#[no_mangle]
pub unsafe extern "C" fn EnFz_SetupBlowSmokeStationary(mut this: *mut EnFz) {
    (*this).state = 1 as libc::c_int as u8_0;
    (*this).timer = 40 as libc::c_int as s16;
    (*this).updateBgInfo = 1 as libc::c_int as u8_0;
    (*this).isFreezing = 1 as libc::c_int as u8_0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actionFunc =
        Some(EnFz_BlowSmokeStationary as
                 unsafe extern "C" fn(_: *mut EnFz, _: *mut GlobalContext)
                     -> ());
    (*this).actor.gravity = -1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_BlowSmokeStationary(mut this: *mut EnFz,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut vec1: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    let mut isTimerMod8: u8_0 = 0;
    let mut primAlpha: s16 = 0;
    if (*this).counter as libc::c_int & 0xc0 as libc::c_int != 0 {
        EnFz_SetYawTowardsPlayer(this);
        EnFz_UpdateTargetPos(this, globalCtx);
    } else {
        isTimerMod8 = 0 as libc::c_int as u8_0;
        ...
        func_8002F974(&mut (*this).actor,
                      (0x39a4 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
        if (*this).counter as libc::c_int & 0x3f as libc::c_int >=
               48 as libc::c_int {
            primAlpha =
                (630 as libc::c_int -
                     ((*this).counter as libc::c_int & 0x3f as libc::c_int) *
        ...
        vec1.z = 20.0f32;
        Matrix_MultVec3f(&mut vec1, &mut velocity);
        if (*this).counter as libc::c_int % 8 as libc::c_int ==
               0 as libc::c_int {
            isTimerMod8 = 1 as libc::c_int as u8_0
        }
        EnFz_SpawnIceSmokeFreeze(this, &mut pos, &mut velocity, &mut accel,
...
static mut iceSmokeSpawnFuncs: [EnFzSpawnIceSmokeFunc; 4] =
    unsafe {
        [Some(EnFz_SpawnIceSmokeHiddenState as
                  unsafe extern "C" fn(_: *mut EnFz) -> ()),
         Some(EnFz_SpawnIceSmokeGrowingState as
                  unsafe extern "C" fn(_: *mut EnFz) -> ()),
         Some(EnFz_SpawnIceSmokeActiveState as
                  unsafe extern "C" fn(_: *mut EnFz) -> ()),
         Some(EnFz_SpawnIceSmokeActiveState as
                  unsafe extern "C" fn(_: *mut EnFz) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnFz_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFz = thisx as *mut EnFz;
    let mut pad: s32 = 0;
    (*this).counter += 1;
    if (*this).unusedTimer1 as libc::c_int != 0 as libc::c_int {
        (*this).unusedTimer1 -= 1
    }
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).unusedTimer2 as libc::c_int != 0 as libc::c_int {
        (*this).unusedTimer2 = (*this).unusedTimer2.wrapping_sub(1)
    }
    ...
    if (*this).isDespawning as libc::c_int == 0 as libc::c_int {
    ...
    Math_StepToF(&mut (*this).actor.speedXZ, (*this).speedXZ, 0.2f32);
    Actor_MoveForward(&mut (*this).actor);
    if (*this).updateBgInfo != 0 {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32,
                                20.0f32, 20.0f32, 5 as libc::c_int);
    }
    iceSmokeSpawnFuncs[(*this).state as
                           usize].expect("non-null function pointer")(this);
    EnFz_UpdateIceSmoke(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    static mut displayLists: [*mut Gfx; 3] =
        unsafe {
            [gFreezardIntactDL.as_ptr() as *mut _,
             gFreezardTopRightHornChippedDL.as_ptr() as *mut _,
             gFreezardHeadChippedDL.as_ptr() as *mut _]
        };
    let mut this: *mut EnFz = thisx as *mut EnFz;
    let mut pad: s32 = 0;
    let mut index: s32 = 0;
    index =
        6 as libc::c_int - (*this).actor.colChkInfo.health as libc::c_int >>
            1 as libc::c_int;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_fz.c\x00" as *const u8 as *const libc::c_char,
                    1167 as libc::c_int);
    ...
    if (*this).isActive != 0 {
        ...
        (*_g).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             (2 as libc::c_int as
                                  libc::c_uint).wrapping_mul((*globalCtx).state.frames)
                                 & 0x7f as libc::c_int as libc::c_uint,
        ...
        (*_g_0).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_fz.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_4).words.w1 = displayLists[index as usize] as libc::c_uint
    }
...
// Ice Smoke Effects
#[no_mangle]
pub unsafe extern "C" fn EnFz_SpawnIceSmokeNoFreeze(mut this: *mut EnFz,
                                                    mut pos: *mut Vec3f,
                                                    mut velocity: *mut Vec3f,
                                                    mut accel: *mut Vec3f,
                                                    mut xyScale: f32_0) {
    let mut iceSmoke: *mut EnFzEffectSsIceSmoke =
        (*this).iceSmoke.as_mut_ptr(); // Becoming more transparent
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFzEffectSsIceSmoke; 40]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFzEffectSsIceSmoke>()
                                                   as libc::c_ulong) as s32 {
        if (*iceSmoke).type_0 as libc::c_int == 0 as libc::c_int {
            (*iceSmoke).type_0 = 1 as libc::c_int as u8_0;
            (*iceSmoke).pos = *pos;
            (*iceSmoke).velocity = *velocity;
            (*iceSmoke).accel = *accel;
            (*iceSmoke).primAlphaState = 0 as libc::c_int as s16;
            (*iceSmoke).xyScale = xyScale / 1000.0f32;
            (*iceSmoke).primAlpha = 0 as libc::c_int as s16;
            (*iceSmoke).timer = 0 as libc::c_int as u8_0;
            break ;
        } else { iceSmoke = iceSmoke.offset(1); i += 1 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_SpawnIceSmokeFreeze(mut this: *mut EnFz,
                                                  mut pos: *mut Vec3f,
                                                  mut velocity: *mut Vec3f,
                                                  mut accel: *mut Vec3f,
                                                  mut xyScale: f32_0,
                                                  mut xyScaleTarget: f32_0,
                                                  mut primAlpha: s16,
                                                  mut isTimerMod8: u8_0) {
    let mut iceSmoke: *mut EnFzEffectSsIceSmoke =
        (*this).iceSmoke.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFzEffectSsIceSmoke; 40]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFzEffectSsIceSmoke>()
                                                   as libc::c_ulong) as s32 {
        if (*iceSmoke).type_0 as libc::c_int == 0 as libc::c_int {
            (*iceSmoke).type_0 = 2 as libc::c_int as u8_0;
            (*iceSmoke).pos = *pos;
            (*iceSmoke).velocity = *velocity;
            (*iceSmoke).accel = *accel;
            (*iceSmoke).primAlphaState = 0 as libc::c_int as s16;
            (*iceSmoke).xyScale = xyScale / 1000.0f32;
            (*iceSmoke).xyScaleTarget = xyScaleTarget / 1000.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnFz_UpdateIceSmoke(mut this: *mut EnFz,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut iceSmoke: *mut EnFzEffectSsIceSmoke =
        (*this).iceSmoke.as_mut_ptr();
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnFzEffectSsIceSmoke; 40]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnFzEffectSsIceSmoke>()
                                                   as libc::c_ulong) as s32 {
        if (*iceSmoke).type_0 != 0 {
            (*iceSmoke).pos.x += (*iceSmoke).velocity.x;
            (*iceSmoke).pos.y += (*iceSmoke).velocity.y;
            (*iceSmoke).pos.z += (*iceSmoke).velocity.z;
            (*iceSmoke).timer = (*iceSmoke).timer.wrapping_add(1);
            (*iceSmoke).velocity.x += (*iceSmoke).accel.x;
            (*iceSmoke).velocity.y += (*iceSmoke).accel.y;
            (*iceSmoke).velocity.z += (*iceSmoke).accel.z;
            if (*iceSmoke).type_0 as libc::c_int == 1 as libc::c_int {
                if (*iceSmoke).primAlphaState as libc::c_int ==
                       0 as libc::c_int {
                    // Becoming more opaque
                    (*iceSmoke).primAlpha =
                        ((*iceSmoke).primAlpha as libc::c_int +
                             10 as libc::c_int) as s16;
                    if (*iceSmoke).primAlpha as libc::c_int >=
                           100 as libc::c_int {
                        (*iceSmoke).primAlphaState += 1
                    }
                } else {
                    (*iceSmoke).primAlpha =
                        ((*iceSmoke).primAlpha as libc::c_int -
                    ...
                    if (*iceSmoke).primAlpha as libc::c_int <=
                           0 as libc::c_int {
                        (*iceSmoke).primAlpha = 0 as libc::c_int as s16;
                        (*iceSmoke).type_0 = 0 as libc::c_int as u8_0
                    }
                }
            } else if (*iceSmoke).type_0 as libc::c_int == 2 as libc::c_int {
                // Freezing
                Math_ApproachF(&mut (*iceSmoke).xyScale,
                               (*iceSmoke).xyScaleTarget, 0.1f32,
                               (*iceSmoke).xyScaleTarget /
                                   10.0f32); // Becoming more transparent, slows down
                if (*iceSmoke).primAlphaState as libc::c_int ==
                       0 as libc::c_int {
                    // Becoming more opaque
                    if (*iceSmoke).timer as libc::c_int >= 7 as libc::c_int {
                        (*iceSmoke).primAlphaState += 1
                    }
                } else {
                    (*iceSmoke).accel.y = 2.0f32;
                    (*iceSmoke).primAlpha =
                        ((*iceSmoke).primAlpha as libc::c_int -
                             17 as libc::c_int) as s16;
                    (*iceSmoke).velocity.x *= 0.75f32;
                    (*iceSmoke).velocity.z *= 0.75f32;
                    if (*iceSmoke).primAlpha as libc::c_int <=
                           0 as libc::c_int {
                        (*iceSmoke).primAlpha = 0 as libc::c_int as s16;
                        (*iceSmoke).type_0 = 0 as libc::c_int as u8_0
                ...
                if (*this).unusedTimer2 as libc::c_int == 0 as libc::c_int &&
                       (*iceSmoke).primAlpha as libc::c_int >=
                           101 as libc::c_int &&
                       (*iceSmoke).isTimerMod8 as libc::c_int != 0 {
                    (*this).collider3.dim.pos.x = (*iceSmoke).pos.x as s16;
                    (*this).collider3.dim.pos.y = (*iceSmoke).pos.y as s16;
                    (*this).collider3.dim.pos.z = (*iceSmoke).pos.z as s16;
                    CollisionCheck_SetAT(globalCtx,
                                         &mut (*globalCtx).colChkCtx,
                                         &mut (*this).collider3.base);
                }
                pos.x = (*iceSmoke).pos.x;
                pos.y = (*iceSmoke).pos.y + 10.0f32;
                pos.z = (*iceSmoke).pos.z;
                if (*iceSmoke).primAlphaState as libc::c_int !=
                       2 as libc::c_int &&
                       EnFz_ReachedTarget(this, &mut pos) != 0 {
                    (*iceSmoke).primAlphaState = 2 as libc::c_int as s16;
                    (*iceSmoke).velocity.x = 0.0f32;
                    (*iceSmoke).velocity.z = 0.0f32
                }
            }
        }
        iceSmoke = iceSmoke.offset(1);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFz_DrawIceSmoke(mut this: *mut EnFz,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut iceSmoke: *mut EnFzEffectSsIceSmoke =
        (*this).iceSmoke.as_mut_ptr();
    ...
    let mut texLoaded: u8_0 = 0 as libc::c_int as u8_0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    ...
    while (i as libc::c_int) <
        ...
        if (*iceSmoke).type_0 as libc::c_int > 0 as libc::c_int {
            ...
            if texLoaded == 0 {
                ...
                (*_g_0).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_0).words.w1 =
                    gSegments[((gFreezardSteamStartDL.as_mut_ptr() as u32_0)
                                   << 4 as libc::c_int >> 28 as libc::c_int)
                                  as
                                  usize].wrapping_add(gFreezardSteamStartDL.as_mut_ptr()
                                                          as u32_0 &
                                                          0xffffff as
                                                              libc::c_int as
                ...
                texLoaded = texLoaded.wrapping_add(1)
            }
            ...
            (*_g_2).words.w1 =
                Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 (3 as libc::c_int *
                                      ((*iceSmoke).timer as libc::c_int +
                                           3 as libc::c_int *
                                               i as libc::c_int)) as u32_0,
                                 (15 as libc::c_int *
                                      ((*iceSmoke).timer as libc::c_int +
                                           3 as libc::c_int *
                                               i as libc::c_int)) as u32_0,
            ...
            Matrix_Translate((*iceSmoke).pos.x, (*iceSmoke).pos.y,
                             (*iceSmoke).pos.z,
                             MTXMODE_NEW as libc::c_int as u8_0);
            func_800D1FD4(&mut (*globalCtx).billboardMtxF);
            Matrix_Scale((*iceSmoke).xyScale, (*iceSmoke).xyScale, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gSegments[((gFreezardSteamDL.as_mut_ptr() as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(gFreezardSteamDL.as_mut_ptr()
                                                      as u32_0 &
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x3b as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
