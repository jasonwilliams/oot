...
extern "C" {
    ...
    #[no_mangle]
    static mut gDemoEcCuccoLadyAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcCarpenterAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcWindmillManAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcGerudoAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcGoronAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcGoron2Anim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcIngoAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcDancingKokiriAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcKokiriAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcOldManAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcAnim_006220: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcAnim_006930: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcKingZoraAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcAnim_008D1C: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcAnim_009234: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcMidoAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcJumpingCuccoAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcJumpingCucco2Anim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcWalkingCuccoAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcPotionShopOwnerAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcTalonAnim: AnimationHeader;
    #[no_mangle]
    static mut gDemoEcDancingZoraAnim: AnimationHeader;
    #[no_mangle]
    static mut gMalonAdultEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonAdultEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonAdultEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonAdultMouthHappyTex: [u64_0; 0];
    #[no_mangle]
    static mut gMalonAdultSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gMalonAdultSingAnim: AnimationHeader;
    #[no_mangle]
    static mut gIngoRedTex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoEyeClosed2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gIngoSkel: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gWindmillManEyeClosedTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManMouthAngryTex: [u64_0; 0];
    #[no_mangle]
    static mut gWindmillManSkel: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gTalonEyeClosed2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonRedTex: [u64_0; 0];
    #[no_mangle]
    static mut gTalonSkel: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_toryo_Skel_007150: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_daiku_DL_005880: [Gfx; 0];
    #[no_mangle]
    static mut object_daiku_DL_005990: [Gfx; 0];
    #[no_mangle]
    static mut object_daiku_DL_005AC0: [Gfx; 0];
    #[no_mangle]
    static mut object_daiku_DL_005BD0: [Gfx; 0];
    #[no_mangle]
    static mut object_daiku_Skel_007958: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_kz_Skel_0086D0: FlexSkeletonHeader;
    #[no_mangle]
    static mut gMidoSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gCuccoSkel: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_gm_Anim_0002B8: AnimationHeader;
    #[no_mangle]
    static mut gKm1Skel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gKw1Skel: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gCuccoLadySkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_bji_Skel_0000F0: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_ahg_Skel_0000F0: FlexSkeletonHeader;
}
...
pub struct DemoEc {
    ...
    pub drawConfig: s32,
    pub npcAction: s32,
    pub drawObjBankIndex: s32,
    pub animObjBankIndex: s32,
}
pub type DemoEcInitFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext) -> ()>;
pub type DemoEcUpdateFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext) -> ()>;
pub type DemoEcDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext) -> ()>;
pub const EC_DRAW_COMMON: C2RustUnnamed_20 = 0;
pub const EC_UPDATE_COMMON: C2RustUnnamed_19 = 0;
pub const EC_UPDATE_20: C2RustUnnamed_19 = 20;
pub const EC_UPDATE_18: C2RustUnnamed_19 = 18;
pub const EC_UPDATE_17: C2RustUnnamed_19 = 17;
pub const EC_DRAW_MALON: C2RustUnnamed_20 = 23;
pub const EC_UPDATE_MALON: C2RustUnnamed_19 = 28;
pub const EC_DRAW_GORON: C2RustUnnamed_20 = 22;
pub const EC_UPDATE_GORON: C2RustUnnamed_19 = 27;
pub const EC_DRAW_BOMBCHU_SHOP_OWNER: C2RustUnnamed_20 = 21;
pub const EC_UPDATE_BOMBCHU_SHOP_OWNER: C2RustUnnamed_19 = 26;
pub const EC_DRAW_FISHING_MAN: C2RustUnnamed_20 = 20;
pub const EC_UPDATE_FISHING_MAN: C2RustUnnamed_19 = 25;
pub const EC_DRAW_MASK_SHOP_OWNER: C2RustUnnamed_20 = 19;
pub const EC_UPDATE_MASK_SHOP_OWNER: C2RustUnnamed_19 = 24;
pub const EC_DRAW_POTION_SHOP_OWNER: C2RustUnnamed_20 = 18;
pub const EC_UPDATE_POTION_SHOP_OWNER: C2RustUnnamed_19 = 23;
pub const EC_DRAW_CUCCO_LADY: C2RustUnnamed_20 = 17;
pub const EC_UPDATE_CUCCO_LADY: C2RustUnnamed_19 = 22;
pub const EC_DRAW_CUCCO: C2RustUnnamed_20 = 16;
pub const EC_UPDATE_CUCCO: C2RustUnnamed_19 = 21;
pub const EC_DRAW_MIDO: C2RustUnnamed_20 = 15;
pub const EC_UPDATE_MIDO: C2RustUnnamed_19 = 19;
pub const EC_DRAW_KING_ZORA: C2RustUnnamed_20 = 14;
pub const EC_UPDATE_KING_ZORA: C2RustUnnamed_19 = 16;
pub const EC_DRAW_DANCING_ZORA: C2RustUnnamed_20 = 13;
pub const EC_UPDATE_DANCING_ZORA: C2RustUnnamed_19 = 15;
pub const EC_DRAW_GERUDO: C2RustUnnamed_20 = 12;
pub const EC_UPDATE_GERUDO: C2RustUnnamed_19 = 14;
pub const EC_DRAW_KOKIRI_GIRL: C2RustUnnamed_20 = 5;
pub const EC_UPDATE_DANCING_KOKIRI_GIRL: C2RustUnnamed_19 = 13;
pub const EC_DRAW_KOKIRI_BOY: C2RustUnnamed_20 = 4;
pub const EC_UPDATE_DANCING_KOKIRI_BOY: C2RustUnnamed_19 = 12;
pub const EC_DRAW_CARPENTER: C2RustUnnamed_20 = 11;
pub const EC_UPDATE_CARPENTER: C2RustUnnamed_19 = 11;
pub const EC_DRAW_BOSS_CARPENTER: C2RustUnnamed_20 = 10;
pub const EC_UPDATE_BOSS_CARPENTER: C2RustUnnamed_19 = 10;
pub const EC_DRAW_OLD_WOMAN: C2RustUnnamed_20 = 9;
pub const EC_UPDATE_OLD_WOMAN: C2RustUnnamed_19 = 9;
pub const EC_DRAW_WOMAN: C2RustUnnamed_20 = 8;
pub const EC_UPDATE_WOMAN: C2RustUnnamed_19 = 8;
pub const EC_DRAW_BEARDED_MAN: C2RustUnnamed_20 = 7;
pub const EC_UPDATE_BEARDED_MAN: C2RustUnnamed_19 = 7;
pub const EC_DRAW_OLD_MAN: C2RustUnnamed_20 = 6;
pub const EC_UPDATE_OLD_MAN: C2RustUnnamed_19 = 6;
pub const EC_UPDATE_KOKIRI_GIRL: C2RustUnnamed_19 = 5;
pub const EC_UPDATE_KOKIRI_BOY: C2RustUnnamed_19 = 4;
pub const EC_DRAW_WINDMILL_MAN: C2RustUnnamed_20 = 3;
pub const EC_UPDATE_WINDMILL_MAN: C2RustUnnamed_19 = 3;
pub const EC_DRAW_TALON: C2RustUnnamed_20 = 2;
pub const EC_UPDATE_TALON: C2RustUnnamed_19 = 2;
pub const EC_DRAW_INGO: C2RustUnnamed_20 = 1;
pub const EC_UPDATE_INGO: C2RustUnnamed_19 = 1;
pub type C2RustUnnamed_19 = libc::c_uint;
pub type C2RustUnnamed_20 = libc::c_uint;
static mut sDrawObjects: [s16; 35] =
    [OBJECT_IN as libc::c_int as s16, OBJECT_TA as libc::c_int as s16,
     OBJECT_FU as libc::c_int as s16, OBJECT_KM1 as libc::c_int as s16,
     OBJECT_KW1 as libc::c_int as s16, OBJECT_BJI as libc::c_int as s16,
     OBJECT_AHG as libc::c_int as s16, OBJECT_BOB as libc::c_int as s16,
     OBJECT_BBA as libc::c_int as s16, OBJECT_TORYO as libc::c_int as s16,
     OBJECT_DAIKU as libc::c_int as s16, OBJECT_DAIKU as libc::c_int as s16,
     OBJECT_DAIKU as libc::c_int as s16, OBJECT_DAIKU as libc::c_int as s16,
     OBJECT_KM1 as libc::c_int as s16, OBJECT_KW1 as libc::c_int as s16,
     OBJECT_GE1 as libc::c_int as s16, OBJECT_GE1 as libc::c_int as s16,
     OBJECT_GE1 as libc::c_int as s16, OBJECT_ZO as libc::c_int as s16,
     OBJECT_KZ as libc::c_int as s16, OBJECT_MD as libc::c_int as s16,
     OBJECT_NIW as libc::c_int as s16, OBJECT_NIW as libc::c_int as s16,
     OBJECT_NIW as libc::c_int as s16, OBJECT_ANE as libc::c_int as s16,
     OBJECT_DS2 as libc::c_int as s16, OBJECT_OS as libc::c_int as s16,
     OBJECT_FISH as libc::c_int as s16, OBJECT_RS as libc::c_int as s16,
     OBJECT_OF1D_MAP as libc::c_int as s16,
     OBJECT_OF1D_MAP as libc::c_int as s16,
     OBJECT_OF1D_MAP as libc::c_int as s16,
     OBJECT_OF1D_MAP as libc::c_int as s16, OBJECT_MA2 as libc::c_int as s16];
static mut sAnimationObjects: [s16; 35] =
    [OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     ...
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_EC as libc::c_int as s16,
     OBJECT_EC as libc::c_int as s16, OBJECT_GM as libc::c_int as s16,
     OBJECT_MA2 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn DemoEc_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoEc = thisx as *mut DemoEc;
    SkelAnime_Free(&mut (*this).skelAnime, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoEc = thisx as *mut DemoEc;
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int ||
           (*this).actor.params as libc::c_int > 34 as libc::c_int {
        osSyncPrintf(b"\x1b[31mDemo_Ec_Actor_ct:arg_data\xe3\x81\x8c\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84!!!!!!!!!!!!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char);
        Actor_Kill(&mut (*this).actor);
    } else {
        (*this).updateMode = EC_UPDATE_COMMON as libc::c_int;
        (*this).drawConfig = EC_DRAW_COMMON as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateSkelAnime(mut this: *mut DemoEc)
 -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateBgFlags(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 30.0f32, 25.0f32,
                            30.0f32, 7 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096D594(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8096D5D4(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_8096D64C(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).skelAnime.moveFlags =
        ((*this).skelAnime.moveFlags as libc::c_int | 3 as libc::c_int) as
            u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateEyes(mut this: *mut DemoEc) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_SetEyeTexIndex(mut this: *mut DemoEc,
                                               mut texIndex: s16) {
    (*this).eyeTexIndex = texIndex;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitSkelAnime(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext,
                                              mut skeletonHeader:
                                                  *mut FlexSkeletonHeader) {
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       gSegments[((skeletonHeader as u32_0) <<
                                      4 as libc::c_int >> 28 as libc::c_int)
                                     as
                                     usize].wrapping_add(skeletonHeader as
                                                             u32_0 &
                                                             0xffffff as
                                                                 libc::c_int
                                                                 as
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_ChangeAnimation(mut this: *mut DemoEc,
                                                mut animation:
                                                    *mut AnimationHeader,
                                                mut mode: u8_0,
    ...
    let mut anim: *mut AnimationHeader = 0 as *mut AnimationHeader;
    let mut playbackSpeed: f32_0 = 0.;
    let mut frameCountS: s16 = 0;
    anim =
    ...
    frameCountS = Animation_GetLastFrame(anim as *mut libc::c_void);
    if reverse == 0 {
        startFrame = 0.0f32;
        frameCount = frameCountS as f32_0;
        playbackSpeed = 1.0f32
    } else {
        frameCount = 0.0f32;
        startFrame = frameCountS as f32_0;
        playbackSpeed = -1.0f32
    }
    Animation_Change(&mut (*this).skelAnime, anim, playbackSpeed, startFrame,
                     frameCount, mode, transitionRate);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_AllocColorDList(mut gfxCtx:
                                                    *mut GraphicsContext,
                                                mut color: *mut u8_0)
 -> *mut Gfx {
    ...
    (*_g).words.w1 =
        (*color.offset(0 as libc::c_int as isize) as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (*color.offset(1 as libc::c_int as isize) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (*color.offset(2 as libc::c_int as isize) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (*color.offset(3 as libc::c_int as isize) as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawSkeleton(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut eyeTexture:
                                                 *mut libc::c_void,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_ec.c\x00" as *const u8 as *const libc::c_char,
                    565 as libc::c_int);
    func_80093D18(gfxCtx);
    if !eyeTexture.is_null() {
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((arg3 as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add(arg3 as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
    ...
    (*__gfxCtx).polyOpa.p =
        SkelAnime_DrawFlex(globalCtx, (*skelAnime).skeleton,
                           ...
                           &mut (*this).actor as *mut Actor as
                               *mut libc::c_void, (*__gfxCtx).polyOpa.p);
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_ec.c\x00" as *const u8 as
                         *const libc::c_char, 595 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawSkeletonCustomColor(mut this: *mut DemoEc,
                                                        mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut arg2: *mut Gfx,
                                                        mut arg3: *mut Gfx,
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((arg2 as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add(arg2 as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((DemoEc_AllocColorDList(gfxCtx, color1) as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(DemoEc_AllocColorDList(gfxCtx,
                                                                     color1)
                                                  as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UseDrawObject(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut drawObjBankIndex: s32 = (*this).drawObjBankIndex;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x6 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        (*globalCtx).objectCtx.status[drawObjBankIndex as usize].segment as
            libc::c_uint;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_demo_ec.c\x00" as *const u8 as
                         *const libc::c_char, 670 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UseAnimationObject(mut this: *mut DemoEc,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut animObjBankIndex: s32 = (*this).animObjBankIndex;
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[animObjBankIndex as usize].segment as
             u32_0).wrapping_add(0x80000000 as libc::c_uint) as
            *mut libc::c_void as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_GetNpcAction(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut actionIndex: s32)
 -> *mut CsCmdActorAction {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        return (*globalCtx).csCtx.npcActions[actionIndex as usize]
    } else { return 0 as *mut CsCmdActorAction };
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_SetNpcActionPosRot(mut this: *mut DemoEc,
                                                   mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut actionIndex: s32) {
    let mut npcAction: *mut CsCmdActorAction =
        DemoEc_GetNpcAction(globalCtx, actionIndex);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitIngo(mut this: *mut DemoEc,
                                         mut globalCtx: *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gIngoSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcIngoAnim,
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_INGO as libc::c_int;
    (*this).drawConfig = EC_DRAW_INGO as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateIngo(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawIngo(mut this: *mut DemoEc,
                                         mut globalCtx: *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx,
                        gIngoEyeClosed2Tex.as_mut_ptr() as *mut libc::c_void,
                        gIngoRedTex.as_mut_ptr() as *mut libc::c_void, None,
                        None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitTalon(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gTalonSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcTalonAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D64C(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_TALON as libc::c_int;
    (*this).drawConfig = EC_DRAW_TALON as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateTalon(mut this: *mut DemoEc,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawTalon(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx,
                        gTalonEyeClosed2Tex.as_mut_ptr() as *mut libc::c_void,
                        gTalonRedTex.as_mut_ptr() as *mut libc::c_void, None,
                        None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitWindmillMan(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gWindmillManSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcWindmillManAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_WINDMILL_MAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_WINDMILL_MAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateWindmillMan(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawWindmillMan(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx,
                        gWindmillManEyeClosedTex.as_mut_ptr() as
                            *mut libc::c_void,
                        gWindmillManMouthAngryTex.as_mut_ptr() as
                            *mut libc::c_void, None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitKokiriBoy(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gKm1Skel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcKokiriAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_KOKIRI_BOY as libc::c_int;
    (*this).drawConfig = EC_DRAW_KOKIRI_BOY as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitDancingKokiriBoy(mut this: *mut DemoEc,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gKm1Skel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcDancingKokiriAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_DANCING_KOKIRI_BOY as libc::c_int;
    (*this).drawConfig = EC_DRAW_KOKIRI_BOY as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateKokiriBoy(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateDancingKokiriBoy(mut this: *mut DemoEc,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    DemoEc_UpdateKokiriBoy(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawKokiriBoy(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut color1: [u8_0; 4] =
        [0 as libc::c_int as u8_0, 130 as libc::c_int as u8_0,
         70 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    static mut color2: [u8_0; 4] =
        [110 as libc::c_int as u8_0, 170 as libc::c_int as u8_0,
         20 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    DemoEc_DrawSkeletonCustomColor(this, globalCtx, 0 as *mut Gfx,
                                   0 as *mut Gfx, color1.as_mut_ptr(),
                                   color2.as_mut_ptr(), None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitKokiriGirl(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gKw1Skel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcKokiriAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_KOKIRI_GIRL as libc::c_int;
    (*this).drawConfig = EC_DRAW_KOKIRI_GIRL as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitDancingKokiriGirl(mut this: *mut DemoEc,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gKw1Skel);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_DANCING_KOKIRI_GIRL as libc::c_int;
    (*this).drawConfig = EC_DRAW_KOKIRI_GIRL as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateKokiriGirl(mut this: *mut DemoEc,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateDancingKokiriGirl(mut this: *mut DemoEc,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    DemoEc_UpdateKokiriGirl(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawKokiriGirl(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [0x6000f4c as libc::c_int as *mut libc::c_void,
             0x6001a0c as libc::c_int as *mut libc::c_void,
             0x6001e0c as libc::c_int as *mut libc::c_void]
        };
    static mut color1: [u8_0; 4] =
        [70 as libc::c_int as u8_0, 190 as libc::c_int as u8_0,
         60 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    static mut color2: [u8_0; 4] =
        [100 as libc::c_int as u8_0, 30 as libc::c_int as u8_0,
         0 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeletonCustomColor(this, globalCtx, eyeTexture as *mut Gfx,
                                   0 as *mut Gfx, color1.as_mut_ptr(),
                                   color2.as_mut_ptr(), None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitOldMan(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_bji_Skel_0000F0);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcOldManAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_OLD_MAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_OLD_MAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateOldMan(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawOldMan(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
    ...
    static mut color1: [u8_0; 4] =
        [0 as libc::c_int as u8_0, 50 as libc::c_int as u8_0,
         100 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    static mut color2: [u8_0; 4] =
        [0 as libc::c_int as u8_0, 50 as libc::c_int as u8_0,
         160 as libc::c_int as u8_0, 255 as libc::c_int as u8_0];
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeletonCustomColor(this, globalCtx, eyeTexture as *mut Gfx,
                                   0 as *mut Gfx, color1.as_mut_ptr(),
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitBeardedMan(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_ahg_Skel_0000F0);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcOldManAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_BEARDED_MAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_BEARDED_MAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateBeardedMan(mut this: *mut DemoEc,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawBeardedMan(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitWoman(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_bob_Skel_0000F0);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcOldManAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_WOMAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_WOMAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateWoman(mut this: *mut DemoEc,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawWoman(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut Gfx; 3] =
        unsafe {
            [0x60007c8 as libc::c_int as *mut Gfx,
             0x6000fc8 as libc::c_int as *mut Gfx,
             0x60017c8 as libc::c_int as *mut Gfx]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void =
        eyeTextures[eyeTexIndex as usize] as *mut libc::c_void;
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
                        None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitOldWoman(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_bba_Skel_0000F0);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcOldManAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_OLD_WOMAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_OLD_WOMAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateOldWoman(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawOldWoman(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx,
                        &mut object_bba_Tex_0004C8 as *mut [u64_0; 0] as
                            *mut libc::c_void, 0 as *mut libc::c_void, None,
                        None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitBossCarpenter(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_toryo_Skel_007150);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcCarpenterAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_BOSS_CARPENTER as libc::c_int;
    (*this).drawConfig = EC_DRAW_BOSS_CARPENTER as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateBossCarpenter(mut this: *mut DemoEc,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawBossCarpenter(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx, 0 as *mut libc::c_void,
                        0 as *mut libc::c_void, None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitCarpenter(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_daiku_Skel_007958);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcCarpenterAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_CARPENTER as libc::c_int;
    (*this).drawConfig = EC_DRAW_CARPENTER as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateCarpenter(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_CarpenterOverrideLimbDraw(mut globalCtx:
                                                              *mut GlobalContext,
                                                          mut limbIndex: s32,
                                                          mut dList:
                                                              *mut *mut Gfx,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_GetCarpenterPostLimbDList(mut this:
                                                              *mut DemoEc)
 -> *mut Gfx {
    match (*this).actor.params as libc::c_int {
        10 => { return object_daiku_DL_005BD0.as_mut_ptr() }
        11 => { return object_daiku_DL_005AC0.as_mut_ptr() }
        12 => { return object_daiku_DL_005990.as_mut_ptr() }
        13 => { return object_daiku_DL_005880.as_mut_ptr() }
        _ => {
            osSyncPrintf(b"\x1b[31m\xe3\x81\x8b\xe3\x81\xa4\xe3\x82\x89\xe3\x81\x8c\xe7\x84\xa1\xe3\x81\x84!!!!!!!!!!!!!!!!\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            return 0 as *mut Gfx
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_CarpenterPostLimbDraw(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut limbIndex: s32,
                                                      mut dList:
                                                          *mut *mut Gfx,
                                                      ...
                                                      mut gfx:
                                                          *mut *mut Gfx) {
    let mut this: *mut DemoEc = thisx as *mut DemoEc;
    let mut postLimbDList: *mut Gfx = 0 as *mut Gfx;
        ...
        (*_g).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((postLimbDList as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add(postLimbDList as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawCarpenter(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx, 0 as *mut libc::c_void,
                        0 as *mut libc::c_void,
                        Some(DemoEc_CarpenterOverrideLimbDraw as
                                 unsafe extern "C" fn(_: *mut GlobalContext,
                                                      ...
                                                      _: *mut *mut Gfx)
                                     -> s32),
                        Some(DemoEc_CarpenterPostLimbDraw as
                                 unsafe extern "C" fn(_: *mut GlobalContext,
                                                      _: s32,
                                                      _: *mut *mut Gfx,
                                                      _: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitGerudo(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gGerudoWhiteSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcGerudoAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_GERUDO as libc::c_int;
    (*this).drawConfig = EC_DRAW_GERUDO as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateGerudo(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_GetGerudoPostLimbDList(mut this: *mut DemoEc)
 -> *mut Gfx {
    match (*this).actor.params as libc::c_int {
        16 => { return gGerudoWhiteHairstyleBobDL.as_mut_ptr() }
        17 => { return gGerudoWhiteHairstyleStraightFringeDL.as_mut_ptr() }
        18 => { return gGerudoWhiteHairstyleSpikyDL.as_mut_ptr() }
        _ => {
            osSyncPrintf(b"\x1b[31m\xe3\x81\x8b\xe3\x81\xa4\xe3\x82\x89\xe3\x81\x8c\xe7\x84\xa1\xe3\x81\x84!!!!!!!!!!!!!!!!\n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
            return 0 as *mut Gfx
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_GerudoPostLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawGerudo(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [0x6000708 as libc::c_int as *mut libc::c_void,
             0x6000f08 as libc::c_int as *mut libc::c_void,
             0x6001708 as libc::c_int as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
                        None,
                        Some(DemoEc_GerudoPostLimbDraw as
                                 unsafe extern "C" fn(_: *mut GlobalContext,
                                                      _: s32,
                                                      _: *mut *mut Gfx,
                                                      _: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitDancingZora(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gZoraSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcDancingZoraAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_DANCING_ZORA as libc::c_int;
    (*this).drawConfig = EC_DRAW_DANCING_ZORA as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateDancingZora(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawDancingZora(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitKingZora(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_kz_Skel_0086D0);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcKingZoraAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_KING_ZORA as libc::c_int;
    (*this).drawConfig = EC_DRAW_KING_ZORA as libc::c_int;
    DemoEc_SetEyeTexIndex(this, 3 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F1D4(mut this: *mut DemoEc) {
    let mut currentFrame: f32_0 = (*this).skelAnime.curFrame;
    if currentFrame <= 32.0f32 {
        DemoEc_SetEyeTexIndex(this, 3 as libc::c_int as s16);
    } else { DemoEc_UpdateEyes(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F224(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcAnim_006930,
                           2 as libc::c_int as u8_0, -8.0f32,
                           0 as libc::c_int);
    (*this).updateMode = EC_UPDATE_17 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F26C(mut this: *mut DemoEc, mut arg1: s32) {
    if arg1 != 0 as libc::c_int {
        DemoEc_ChangeAnimation(this, &mut gDemoEcAnim_006220,
                               0 as libc::c_int as u8_0, 0.0f32,
                               0 as libc::c_int);
        (*this).updateMode = EC_UPDATE_18 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F2B0(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    ...
    if !npcAction.is_null() {
        sp18 = (*npcAction).action as s32;
        if sp18 != (*this).npcAction {
            ((*this).npcAction) != 0;
            if sp18 == 2 as libc::c_int { func_8096F224(this, globalCtx); }
            (*this).npcAction = sp18
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateKingZora(mut this: *mut DemoEc,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
    DemoEc_SetNpcActionPosRot(this, globalCtx, 6 as libc::c_int);
    DemoEc_UpdateBgFlags(this, globalCtx);
    func_8096F2B0(this, globalCtx, 6 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F378(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    let mut animDone: s32 = DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
    func_8096F1D4(this);
    DemoEc_UpdateBgFlags(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_8096F3D4(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
    DemoEc_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawKingZora(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 4] =
        unsafe {
            [0x6001470 as libc::c_int as *mut libc::c_void,
             0x6001870 as libc::c_int as *mut libc::c_void,
             0x6001c70 as libc::c_int as *mut libc::c_void,
             0x6002070 as libc::c_int as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitMido(mut this: *mut DemoEc,
                                         mut globalCtx: *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gMidoSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcMidoAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_MIDO as libc::c_int;
    (*this).drawConfig = EC_DRAW_MIDO as libc::c_int;
    DemoEc_SetEyeTexIndex(this, 3 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F4FC(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcAnim_008D1C,
                           2 as libc::c_int as u8_0, -8.0f32,
                           0 as libc::c_int);
    (*this).updateMode = EC_UPDATE_20 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F544(mut this: *mut DemoEc,
                                       mut changeAnim: s32) {
    if changeAnim != 0 {
        DemoEc_ChangeAnimation(this, &mut gDemoEcAnim_009234,
                               0 as libc::c_int as u8_0, 0.0f32,
                               0 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F578(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    let mut npcAction: *mut CsCmdActorAction = 0 as *mut CsCmdActorAction;
    let mut sp18: s32 = 0;
    ...
    if !npcAction.is_null() {
        ...
        if sp18 != (*this).npcAction {
            ((*this).npcAction) != 0;
            if sp18 == 2 as libc::c_int { func_8096F4FC(this, globalCtx); }
            (*this).npcAction = sp18
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateMido(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
    DemoEc_SetNpcActionPosRot(this, globalCtx, 7 as libc::c_int);
    DemoEc_UpdateBgFlags(this, globalCtx);
    func_8096F578(this, globalCtx, 7 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_8096F640(mut this: *mut DemoEc,
                                       mut globalCtx: *mut GlobalContext) {
    let mut animDone: s32 = DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
    DemoEc_UpdateEyes(this);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawMido(mut this: *mut DemoEc,
                                         mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 4] =
        unsafe {
            [0x6004ff0 as libc::c_int as *mut libc::c_void,
             0x6005930 as libc::c_int as *mut libc::c_void,
             0x6005d30 as libc::c_int as *mut libc::c_void,
             0x6006130 as libc::c_int as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitCucco(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    let mut animation: *mut AnimationHeader = 0 as *mut AnimationHeader;
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gCuccoSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    if (*this).actor.params as libc::c_int == 22 as libc::c_int {
        animation = &mut gDemoEcJumpingCuccoAnim
    } else if (*this).actor.params as libc::c_int == 23 as libc::c_int {
        animation = &mut gDemoEcJumpingCucco2Anim
    } else { animation = &mut gDemoEcWalkingCuccoAnim }
    DemoEc_ChangeAnimation(this, animation, 0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D64C(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_CUCCO as libc::c_int;
    (*this).drawConfig = EC_DRAW_CUCCO as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateCucco(mut this: *mut DemoEc,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawCucco(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx, 0 as *mut libc::c_void,
                        0 as *mut libc::c_void, None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitCuccoLady(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gCuccoLadySkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcCuccoLadyAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_CUCCO_LADY as libc::c_int;
    (*this).drawConfig = EC_DRAW_CUCCO_LADY as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateCuccoLady(mut this: *mut DemoEc,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawCuccoLady(mut this: *mut DemoEc,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [0x60008c8 as libc::c_int as *mut libc::c_void,
             0x60010c8 as libc::c_int as *mut libc::c_void,
             0x60018c8 as libc::c_int as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitPotionShopOwner(mut this: *mut DemoEc,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_ds2_Skel_004258);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcPotionShopOwnerAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_POTION_SHOP_OWNER as libc::c_int;
    (*this).drawConfig = EC_DRAW_POTION_SHOP_OWNER as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdatePotionShopOwner(mut this: *mut DemoEc,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawPotionShopOwner(mut this: *mut DemoEc,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [0x60030d8 as libc::c_int as *mut libc::c_void,
             0x60034d8 as libc::c_int as *mut libc::c_void,
             0x60038d8 as libc::c_int as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitMaskShopOwner(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_os_Skel_004658);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcPotionShopOwnerAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_MASK_SHOP_OWNER as libc::c_int;
    (*this).drawConfig = EC_DRAW_MASK_SHOP_OWNER as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateMaskShopOwner(mut this: *mut DemoEc,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawMaskShopOwner(mut this: *mut DemoEc,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    DemoEc_DrawSkeleton(this, globalCtx,
                        gOsEyeClosedTex.as_mut_ptr() as *mut libc::c_void,
                        0 as *mut libc::c_void, None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitFishingOwner(mut this: *mut DemoEc,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gFishingOwnerSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcPotionShopOwnerAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_FISHING_MAN as libc::c_int;
    (*this).drawConfig = EC_DRAW_FISHING_MAN as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateFishingOwner(mut this: *mut DemoEc,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_FishingOwnerPostLimbDraw(mut globalCtx:
                                                             *mut GlobalContext,
                                                         mut limbIndex: s32,
                                                         mut dList:
                                                             *mut *mut Gfx,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawFishingOwner(mut this: *mut DemoEc,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gFishingOwnerEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             ...
             gFishingOwnerEyeClosedTex.as_ptr() as *mut _ as
                 *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture, 0 as *mut libc::c_void,
                        None,
                        Some(DemoEc_FishingOwnerPostLimbDraw as
                                 unsafe extern "C" fn(_: *mut GlobalContext,
                                                      _: s32,
                                                      _: *mut *mut Gfx,
                                                      _: *mut Vec3s,
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitBombchuShopOwner(mut this: *mut DemoEc,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut object_rs_Skel_004868);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gDemoEcPotionShopOwnerAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_BOMBCHU_SHOP_OWNER as libc::c_int;
    (*this).drawConfig = EC_DRAW_BOMBCHU_SHOP_OWNER as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DempEc_UpdateBombchuShopOwner(mut this: *mut DemoEc,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawBombchuShopOwner(mut this: *mut DemoEc,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitGorons(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut animation: *mut AnimationHeader = 0 as *mut AnimationHeader;
    let mut goronScale: f32_0 = 0.;
    let mut scale: *mut Vec3f = &mut (*this).actor.scale;
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gGoronSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    if (*this).actor.params as libc::c_int == 30 as libc::c_int {
        animation = &mut gDemoEcGoronAnim;
        goronScale = 1.0f32
    } else if (*this).actor.params as libc::c_int == 31 as libc::c_int {
        animation = &mut gDemoEcGoron2Anim;
        goronScale = 1.0f32
    } else if (*this).actor.params as libc::c_int == 32 as libc::c_int {
        animation = &mut gDemoEcGoronAnim;
        goronScale = 15.0f32
    } else { goronScale = 5.0f32; animation = &mut object_gm_Anim_0002B8 }
    DemoEc_ChangeAnimation(this, animation, 0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    (*scale).x *= goronScale;
    (*scale).y *= goronScale;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_GORON as libc::c_int;
    (*this).drawConfig = EC_DRAW_GORON as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateGorons(mut this: *mut DemoEc,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawGorons(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
    ...
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture,
                        gGoronCsMouthNeutralTex.as_mut_ptr() as
                            *mut libc::c_void, None, None);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitMalon(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    DemoEc_UseDrawObject(this, globalCtx);
    DemoEc_InitSkelAnime(this, globalCtx, &mut gMalonAdultSkel);
    DemoEc_UseAnimationObject(this, globalCtx);
    DemoEc_ChangeAnimation(this, &mut gMalonAdultSingAnim,
                           0 as libc::c_int as u8_0, 0.0f32,
                           0 as libc::c_int);
    func_8096D5D4(this, globalCtx);
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    (*this).updateMode = EC_UPDATE_MALON as libc::c_int;
    (*this).drawConfig = EC_DRAW_MALON as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_UpdateMalon(mut this: *mut DemoEc,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    DemoEc_UpdateSkelAnime(this);
    func_8096D594(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawMalon(mut this: *mut DemoEc,
                                          mut globalCtx: *mut GlobalContext) {
    static mut eyeTextures: [*mut libc::c_void; 3] =
        unsafe {
            [gMalonAdultEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gMalonAdultEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gMalonAdultEyeClosedTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut eyeTexIndex: s32 = (*this).eyeTexIndex as s32;
    let mut eyeTexture: *mut libc::c_void = eyeTextures[eyeTexIndex as usize];
    DemoEc_DrawSkeleton(this, globalCtx, eyeTexture,
                        gMalonAdultMouthHappyTex.as_mut_ptr() as
                            *mut libc::c_void, None, None);
}
static mut sInitFuncs: [DemoEcInitFunc; 35] =
    unsafe {
        [Some(DemoEc_InitIngo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitTalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitWindmillMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitKokiriBoy as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitKokiriGirl as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitOldMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitBeardedMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitOldWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitBossCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
         ...
         Some(DemoEc_InitCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitDancingKokiriBoy as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitDancingKokiriGirl as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitGerudo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitGerudo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
         ...
         Some(DemoEc_InitGerudo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitDancingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitKingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitMido as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitCucco as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitCucco as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
         ...
         Some(DemoEc_InitCucco as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitCuccoLady as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitPotionShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitMaskShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitFishingOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitBombchuShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitGorons as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitGorons as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
         ...
         Some(DemoEc_InitGorons as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_InitMalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitNpc(mut this: *mut DemoEc,
                                        mut globalCtx: *mut GlobalContext) {
    let mut type_0: s16 = (*this).actor.params;
    if sInitFuncs[type_0 as usize].is_none() {
        // "Demo_Ec_main_init: Initialization process is wrong arg_data"
        osSyncPrintf(b"\x1b[31m Demo_Ec_main_init:\xe5\x88\x9d\xe6\x9c\x9f\xe5\x8c\x96\xe5\x87\xa6\xe7\x90\x86\xe3\x81\x8c\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84arg_data = %d!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     type_0 as libc::c_int);
        Actor_Kill(&mut (*this).actor);
        return
    }
    sInitFuncs[type_0 as
                   usize].expect("non-null function pointer")(this,
                                                              globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_InitCommon(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut primary: s16 = 0;
    let mut type_0: s32 = 0;
    let mut pad2: s16 = 0;
    let mut sp28: s16 = 0;
    let mut primaryBankIndex: s32 = 0;
    let mut secondaryBankIndex: s32 = 0;
    type_0 = (*this).actor.params as s32;
    primary = sDrawObjects[type_0 as usize];
    sp28 = sAnimationObjects[type_0 as usize];
    primaryBankIndex = Object_GetIndex(&mut (*globalCtx).objectCtx, primary);
    secondaryBankIndex = Object_GetIndex(&mut (*globalCtx).objectCtx, sp28);
    if secondaryBankIndex < 0 as libc::c_int ||
           primaryBankIndex < 0 as libc::c_int {
        // "Demo_Ec_main_bank: Bank unreadable arg_data = %d!"
        osSyncPrintf(b"\x1b[31mDemo_Ec_main_bank:\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x82\x92\xe8\xaa\xad\xe3\x82\x81\xe3\x81\xaa\xe3\x81\x84 arg_data = %d!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, type_0);
        Actor_Kill(&mut (*this).actor);
        return
    }
    if Object_IsLoaded(&mut (*globalCtx).objectCtx, primaryBankIndex) != 0 &&
           Object_IsLoaded(&mut (*globalCtx).objectCtx, secondaryBankIndex) !=
               0 {
...
static mut sUpdateFuncs: [DemoEcUpdateFunc; 29] =
    unsafe {
        [Some(DemoEc_InitCommon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateIngo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateTalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateWindmillMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateKokiriBoy as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateKokiriGirl as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateOldMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateBeardedMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateOldWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateBossCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateDancingKokiriBoy as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateDancingKokiriGirl as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateGerudo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateDancingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateKingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(func_8096F378 as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(func_8096F3D4 as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateMido as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(func_8096F640 as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateCucco as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateCuccoLady as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdatePotionShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateMaskShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateFishingOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DempEc_UpdateBombchuShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateGorons as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_UpdateMalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoEc_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoEc = thisx as *mut DemoEc;
    let mut updateMode: s32 = (*this).updateMode;
    if updateMode < 0 as libc::c_int ||
           updateMode >=
               (::std::mem::size_of::<[DemoEcUpdateFunc; 29]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoEcUpdateFunc>()
                                                    as libc::c_ulong) as s32
           || sUpdateFuncs[updateMode as usize].is_none() {
        ...
        if updateMode != EC_UPDATE_COMMON as libc::c_int {
            DemoEc_UseAnimationObject(this, globalCtx);
        }
        sUpdateFuncs[updateMode as
                         usize].expect("non-null function pointer")(this,
                                                                    globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoEc_DrawCommon(mut this: *mut DemoEc,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
static mut sDrawFuncs: [DemoEcDrawFunc; 24] =
    unsafe {
        [Some(DemoEc_DrawCommon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawIngo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawTalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawWindmillMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawKokiriBoy as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawKokiriGirl as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawOldMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawBeardedMan as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawOldWoman as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawBossCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawCarpenter as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawGerudo as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawDancingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawKingZora as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawMido as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawCucco as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawCuccoLady as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawPotionShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawMaskShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawFishingOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawBombchuShopOwner as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawGorons as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ()),
         Some(DemoEc_DrawMalon as
                  unsafe extern "C" fn(_: *mut DemoEc, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoEc_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoEc = thisx as *mut DemoEc;
    let mut drawConfig: s32 = (*this).drawConfig;
    if drawConfig < 0 as libc::c_int ||
           drawConfig >=
               (::std::mem::size_of::<[DemoEcDrawFunc; 24]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoEcDrawFunc>()
                                                    as libc::c_ulong) as s32
           || sDrawFuncs[drawConfig as usize].is_none() {
        // "The main mode is strange !!!!!!!!!!!!!!!!!!!!!!!!!"
        ...
        if drawConfig != EC_DRAW_COMMON as libc::c_int {
            DemoEc_UseDrawObject(this, globalCtx);
        }
        sDrawFuncs[drawConfig as
                       usize].expect("non-null function pointer")(this,
                                                                  globalCtx);
    };
}
#[no_mangle]
pub static mut Demo_Ec_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_EC as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_EC as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DemoEc>() as
                                  libc::c_ulong,
                          init:
