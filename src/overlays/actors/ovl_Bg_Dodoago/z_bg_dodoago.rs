...
extern "C" {
    ...
    #[no_mangle]
    static mut gDodongoLowerJawDL: [Gfx; 0];
    #[no_mangle]
    static mut gDodongoLowerJawCol: CollisionHeader;
}
...
pub const BGDODOAGO_EYE_RIGHT: C2RustUnnamed_22 = 1;
pub const BGDODOAGO_EYE_LEFT: C2RustUnnamed_22 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgDodoago {
    pub dyna: DynaPolyActor,
    pub state: s16,
    pub colliderMain: ColliderCylinder,
    pub colliderLeft: ColliderCylinder,
    pub colliderRight: ColliderCylinder,
    pub actionFunc: BgDodoagoActionFunc,
}
pub type BgDodoagoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgDodoago, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
...
#[no_mangle]
pub static mut Bg_Dodoago_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_DODOAGO as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_DDAN_OBJECTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgDodoago>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDodoago_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgDodoago_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColCylinderInitMain: ColliderCylinderInit =
    {
        let mut init =
...
static mut sColCylinderInitLeftRight: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sFirstExplosiveFlag: s16 = 0 as libc::c_int as s16;
static mut sDisableBombCatcher: u8_0 = 0;
// unknown length
static mut sTimer: s32 = 0;
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_SetupAction(mut this: *mut BgDodoago,
                                               mut actionFunc:
                                                   BgDodoagoActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_SpawnSparkles(mut meanPos: *mut Vec3f,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    static mut acceleration: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -0.2f32, z: 0.0f32,}; init };
    let mut i: s32 = 0;
    i = 4 as libc::c_int;
    while i > 0 as libc::c_int {
        pos.x = Rand_CenteredFloat(20.0f32) + (*meanPos).x;
        pos.y = Rand_CenteredFloat(10.0f32) + (*meanPos).y;
        pos.z = Rand_CenteredFloat(20.0f32) + (*meanPos).z;
        EffectSsKiraKira_SpawnSmall(globalCtx, &mut pos, &mut velocity,
                                    &mut acceleration, &mut primColor,
                                    &mut envColor);
        i -= 1
    };
}
...
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDodoago = thisx as *mut BgDodoago;
    let mut pad: s32 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gDodongoLowerJawCol as
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        BgDodoago_SetupAction(this,
                              Some(BgDodoago_DoNothing as
                                       unsafe extern "C" fn(_: *mut BgDodoago,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
        (*this).dyna.actor.shape.rot.x = 0x1333 as libc::c_int as s16;
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).colliderMain);
    Collider_InitCylinder(globalCtx, &mut (*this).colliderLeft);
    Collider_InitCylinder(globalCtx, &mut (*this).colliderRight);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderMain,
                         &mut (*this).dyna.actor, &mut sColCylinderInitMain);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderLeft,
                         &mut (*this).dyna.actor,
                         &mut sColCylinderInitLeftRight);
    Collider_SetCylinder(globalCtx, &mut (*this).colliderRight,
                         &mut (*this).dyna.actor,
                         &mut sColCylinderInitLeftRight);
    BgDodoago_SetupAction(this,
                          Some(BgDodoago_WaitExplosives as
                                   unsafe extern "C" fn(_: *mut BgDodoago,
                                                        _: *mut GlobalContext)
                                       -> ()));
    sDisableBombCatcher = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgDodoago = thisx as *mut BgDodoago;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderMain);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderLeft);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderRight);
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_WaitExplosives(mut this: *mut BgDodoago,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut explosive: *mut Actor =
        Actor_GetCollidedExplosive(globalCtx, &mut (*this).colliderMain.base);
    if !explosive.is_null() {
        (*this).state =
            if Math_Vec3f_Yaw(&mut (*this).dyna.actor.world.pos,
                              &mut (*explosive).world.pos) as libc::c_int >=
                   (*this).dyna.actor.shape.rot.y as libc::c_int {
                BGDODOAGO_EYE_RIGHT as libc::c_int
            } else { BGDODOAGO_EYE_LEFT as libc::c_int } as s16;
        if (*globalCtx).roomCtx.unk_74[BGDODOAGO_EYE_LEFT as libc::c_int as
                                           usize] as libc::c_int ==
               255 as libc::c_int &&
               (*this).state as libc::c_int ==
                   BGDODOAGO_EYE_RIGHT as libc::c_int ||
               (*globalCtx).roomCtx.unk_74[BGDODOAGO_EYE_RIGHT as libc::c_int
                                               as usize] as libc::c_int ==
                   255 as libc::c_int &&
                   (*this).state as libc::c_int ==
                       BGDODOAGO_EYE_LEFT as libc::c_int {
            Flags_SetSwitch(globalCtx,
                            (*this).dyna.actor.params as libc::c_int &
                                0x3f as libc::c_int);
            (*this).state = 0 as libc::c_int as s16;
            Audio_PlaySoundGeneral(0x4802 as libc::c_int as u16_0,
                                   &mut D_801333D4, 4 as libc::c_int as u8_0,
                                   &mut D_801333E0, &mut D_801333E0,
                                   &mut D_801333E8);
            BgDodoago_SetupAction(this,
                                  Some(BgDodoago_OpenJaw as
                                           unsafe extern "C" fn(_:
                                                                    *mut BgDodoago,
                                                                _:
                                                                    *mut GlobalContext)
                                               -> ()));
            OnePointCutscene_Init(globalCtx, 3380 as libc::c_int as s16,
                                  160 as libc::c_int as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
        } else if (*globalCtx).roomCtx.unk_74[(*this).state as usize] as
                      libc::c_int == 0 as libc::c_int {
            OnePointCutscene_Init(globalCtx, 3065 as libc::c_int as s16,
                                  40 as libc::c_int as s16,
                                  &mut (*this).dyna.actor,
                                  0 as libc::c_int as s16);
            BgDodoago_SetupAction(this,
                                  Some(BgDodoago_LightOneEye as
                                           unsafe extern "C" fn(_:
                                                                    *mut BgDodoago,
                                                                _:
                                                                    *mut GlobalContext)
            ...
            Audio_PlaySoundGeneral(0x4806 as libc::c_int as u16_0,
                                   ...
                                   &mut D_801333E0, &mut D_801333E0,
                                   &mut D_801333E8);
            sTimer += 30 as libc::c_int;
            return
        }
        // the flag is never set back to false, so this only runs once
        if sFirstExplosiveFlag == 0 {
            // this disables the bomb catcher (see BgDodoago_Update) for a few seconds
            (*this).dyna.actor.parent = explosive;
            sFirstExplosiveFlag = 1 as libc::c_int as s16;
            sTimer = 50 as libc::c_int
        }
    } else if Flags_GetEventChkInf(0xb0 as libc::c_int) != 0 {
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).colliderMain);
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).colliderLeft);
        Collider_UpdateCylinder(&mut (*this).dyna.actor,
                                &mut (*this).colliderRight);
        (*this).colliderMain.dim.pos.z =
            ((*this).colliderMain.dim.pos.z as libc::c_int +
                 200 as libc::c_int) as s16;
        (*this).colliderLeft.dim.pos.z =
            ((*this).colliderLeft.dim.pos.z as libc::c_int +
                 215 as libc::c_int) as s16;
        (*this).colliderLeft.dim.pos.x =
            ((*this).colliderLeft.dim.pos.x as libc::c_int +
                 90 as libc::c_int) as s16;
        (*this).colliderRight.dim.pos.z =
            ((*this).colliderRight.dim.pos.z as libc::c_int +
                 215 as libc::c_int) as s16;
        (*this).colliderRight.dim.pos.x =
            ((*this).colliderRight.dim.pos.x as libc::c_int -
                 90 as libc::c_int) as s16;
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderMain.base);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderLeft.base);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderRight.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_OpenJaw(mut this: *mut BgDodoago,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut dustOffsets: [Vec3f; 11] =
        [{
             let mut init = Vec3f{x: 0.0f32, y: -200.0f32, z: 430.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 20.0f32, y: -200.0f32, z: 420.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -20.0f32, y: -200.0f32, z: 420.0f32,};
         ...
         {
             let mut init =
                 Vec3f{x: 40.0f64 as f32_0, y: -200.0f32, z: 380.0f32,};
             init
         },
         {
             let mut init =
         ...
         {
             let mut init =
                 Vec3f{x: 50.0f64 as f32_0, y: -200.0f32, z: 350.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -50.0f32, y: -200.0f32, z: 350.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 60.0f32, y: -200.0f32, z: 320.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -60.0f32, y: -200.0f32, z: 320.0f32,};
         ...
         {
             let mut init = Vec3f{x: 70.0f32, y: -200.0f32, z: 290.0f32,};
             init
         },
         {
             let mut init =
                 Vec3f{x: -70.0f64 as f32_0, y: -200.0f32, z: 290.0f32,};
             init
         }];
    let mut i: s32 = 0;
    ...
    if ((*globalCtx).roomCtx.unk_74[BGDODOAGO_EYE_RIGHT as libc::c_int as
                                        usize] as libc::c_int) <
           255 as libc::c_int {
        (*globalCtx).roomCtx.unk_74[BGDODOAGO_EYE_RIGHT as libc::c_int as
                                        usize] =
    ...
    if (*globalCtx).roomCtx.unk_74[BGDODOAGO_EYE_LEFT as libc::c_int as usize]
    ...
    if sTimer == 108 as libc::c_int {
        i =
            (::std::mem::size_of::<[Vec3f; 11]>() as
                 libc::c_ulong).wrapping_div(::std::mem::size_of::<Vec3f>() as
                                                 libc::c_ulong) as s32 -
                1 as libc::c_int;
        while i >= 0 as libc::c_int {
            pos.x =
                dustOffsets[i as usize].x + (*this).dyna.actor.world.pos.x;
            pos.y =
                dustOffsets[i as usize].y + (*this).dyna.actor.world.pos.y;
            pos.z =
                dustOffsets[i as usize].z + (*this).dyna.actor.world.pos.z;
            func_80033480(globalCtx, &mut pos, 2.0f32, 3 as libc::c_int,
                          200 as libc::c_int as s16, 75 as libc::c_int as s16,
                          1 as libc::c_int as u8_0);
            i -= 1
        }
    }
    pos.x = (*this).dyna.actor.world.pos.x + 200.0f32;
    pos.y = (*this).dyna.actor.world.pos.y - 20.0f32;
    pos.z = (*this).dyna.actor.world.pos.z + 100.0f32;
    BgDodoago_SpawnSparkles(&mut pos, globalCtx);
    pos.x = (*this).dyna.actor.world.pos.x - 200.0f32;
    pos.y = (*this).dyna.actor.world.pos.y - 20.0f32;
    pos.z = (*this).dyna.actor.world.pos.z + 100.0f32;
    BgDodoago_SpawnSparkles(&mut pos, globalCtx);
    Math_StepToS(&mut (*this).state, 100 as libc::c_int as s16,
                 3 as libc::c_int as s16);
    func_800AA000(500.0f32, 0x78 as libc::c_int as u8_0,
                  0x14 as libc::c_int as u8_0, 0xa as libc::c_int as u8_0);
    if Math_SmoothStepToS(&mut (*this).dyna.actor.shape.rot.x,
                          0x1333 as libc::c_int as s16,
                          (110 as libc::c_int - (*this).state as libc::c_int)
                              as s16, 0x3e8 as libc::c_int as s16,
                          0x32 as libc::c_int as s16) as libc::c_int ==
           0 as libc::c_int {
        BgDodoago_SetupAction(this,
                              Some(BgDodoago_DoNothing as
                                       unsafe extern "C" fn(_: *mut BgDodoago,
                                                            _:
                                                                *mut GlobalContext)
                                           -> ()));
        Audio_PlaySoundGeneral(0x281d as libc::c_int as u16_0,
                               &mut (*this).dyna.actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else {
        Audio_PlaySoundGeneral((0x281e as libc::c_int - 0x800 as libc::c_int)
                                   as u16_0,
                               &mut (*this).dyna.actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
...
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_DoNothing(mut this: *mut BgDodoago,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_LightOneEye(mut this: *mut BgDodoago,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    (*globalCtx).roomCtx.unk_74[(*this).state as usize] =
        ((*globalCtx).roomCtx.unk_74[(*this).state as usize] as libc::c_int +
             5 as libc::c_int) as s16;
    if (*globalCtx).roomCtx.unk_74[(*this).state as usize] as libc::c_int ==
           255 as libc::c_int {
        BgDodoago_SetupAction(this,
                              Some(BgDodoago_WaitExplosives as
                                       unsafe extern "C" fn(_: *mut BgDodoago,
...
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgDodoago = thisx as *mut BgDodoago;
    ...
    if (*this).dyna.actor.parent.is_null() {
        ...
        if (*this).colliderLeft.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 ||
               (*this).colliderRight.base.ocFlags1 as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 {
            if (*this).colliderLeft.base.ocFlags1 as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 {
                actor = (*this).colliderLeft.base.oc
            } else { actor = (*this).colliderRight.base.oc }
            (*this).colliderLeft.base.ocFlags1 =
                ((*this).colliderLeft.base.ocFlags1 as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            (*this).colliderRight.base.ocFlags1 =
                ((*this).colliderRight.base.ocFlags1 as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*actor).category as libc::c_int ==
                   ACTORCAT_EXPLOSIVE as libc::c_int &&
                   (*actor).id as libc::c_int == ACTOR_EN_BOM as libc::c_int
                   && (*actor).params as libc::c_int == 0 as libc::c_int {
                bomb = actor as *mut EnBom;
                // disable the bomb catcher for a few seconds
                (*this).dyna.actor.parent = &mut (*bomb).actor;
                (*bomb).timer = 50 as libc::c_int as s16;
                (*bomb).actor.speedXZ = 0.0f32;
                sTimer = 0 as libc::c_int
            }
        }
    } else {
        sTimer += 1;
        Flags_GetSwitch(globalCtx,
                        (*this).dyna.actor.params as libc::c_int &
                            0x3f as libc::c_int);
        if sDisableBombCatcher == 0 && sTimer > 140 as libc::c_int {
            if Flags_GetSwitch(globalCtx,
                               (*this).dyna.actor.params as libc::c_int &
                                   0x3f as libc::c_int) != 0 {
                // this prevents clearing the actor's parent pointer, effectively disabling the bomb catcher
                sDisableBombCatcher = sDisableBombCatcher.wrapping_add(1)
            } else { (*this).dyna.actor.parent = 0 as *mut Actor }
        }
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgDodoago_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_dodoago.c\x00" as *const u8 as
                        *const libc::c_char, 672 as libc::c_int);
    if Flags_GetEventChkInf(0xb0 as libc::c_int) != 0 {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gDodongoLowerJawDL.as_mut_ptr() as libc::c_uint
    }
