...
extern "C" {
    #[no_mangle]
    fn EffectSs_Delete(effectSs: *mut EffectSs);
    #[no_mangle]
    fn EffectSs_Insert(globalCtx: *mut GlobalContext,
                       effectSs: *mut EffectSs);
    #[no_mangle]
...
#[no_mangle]
pub static mut Effect_Ss_Lightning_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_LIGHTNING as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsLightning_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsLightning_Init(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                ...
                                                mut initParamsx:
                                                    *mut libc::c_void)
 -> u32_0 {
    let mut initParams: *mut EffectSsLightningInitParams =
        initParamsx as *mut EffectSsLightningInitParams;
    (*this).pos = (*initParams).pos;
    (*this).gfx =
        gSegments[((gEffLightningDL.as_mut_ptr() as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffLightningDL.as_mut_ptr() as
                                              u32_0 &
    ...
    (*this).draw =
        Some(EffectSsLightning_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsLightning_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    ...
    (*this).regs[4 as libc::c_int as usize] = (*initParams).envColor.r as s16;
    (*this).regs[5 as libc::c_int as usize] = (*initParams).envColor.g as s16;
    (*this).regs[6 as libc::c_int as usize] = (*initParams).envColor.b as s16;
    (*this).regs[7 as libc::c_int as usize] = (*initParams).envColor.a as s16;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).numBolts;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).yaw;
    (*this).regs[11 as libc::c_int as usize] = (*initParams).life;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsLightning_NewLightning(mut globalCtx:
                                                            *mut GlobalContext,
                                                        mut pos: *mut Vec3f,
                                                        mut yaw: s16,
                                                        mut this:
                                                            *mut EffectSs) {
    let mut newLightning: EffectSs =
        EffectSs{pos: Vec3f{x: 0., y: 0., z: 0.,},
                 velocity: Vec3f{x: 0., y: 0., z: 0.,},
                 accel: Vec3f{x: 0., y: 0., z: 0.,},
                 update: None,
                 draw: None,
                 vec: Vec3f{x: 0., y: 0., z: 0.,},
                 gfx: 0 as *mut libc::c_void,
                 ...
                 priority: 0,
                 type_0: 0,};
    EffectSs_Delete(&mut newLightning);
    newLightning = *this;
    newLightning.pos = *pos;
    newLightning.regs[8 as libc::c_int as usize] -= 1;
    newLightning.regs[10 as libc::c_int as usize] = yaw;
    newLightning.life = newLightning.regs[11 as libc::c_int as usize];
    EffectSs_Insert(globalCtx, &mut newLightning);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsLightning_Draw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut index: u32_0,
                                                mut this: *mut EffectSs) {
    static mut lightningTextures: [*mut libc::c_void; 8] =
        unsafe {
    ...
    let mut mfRotate: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mfTrans11DA0: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mfTrans11DA0Rotate: MtxF = MtxF{mf: [[0.; 4]; 4],};
    let mut mtx: *mut Mtx = 0 as *mut Mtx;
    let mut yScale: f32_0 = 0.;
    let mut texIdx: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_lightning.c\x00" as *const u8 as
    ...
    if texIdx as libc::c_int > 7 as libc::c_int {
        texIdx = 7 as libc::c_int as s16
    }
    SkinMatrix_SetTranslate(&mut mfTrans, (*this).pos.x, (*this).pos.y,
                            (*this).pos.z);
    xzScale = yScale * 0.6f32;
    SkinMatrix_SetScale(&mut mfScale, xzScale, yScale, xzScale);
    SkinMatrix_SetRotateZYX(&mut mfRotate, (*this).vec.x as s16,
                            (*this).vec.y as s16,
                            (*this).regs[10 as libc::c_int as usize]);
    SkinMatrix_MtxFMtxFMult(&mut mfTrans, &mut (*globalCtx).billboardMtxF,
                            &mut mfTrans11DA0);
    SkinMatrix_MtxFMtxFMult(&mut mfTrans11DA0, &mut mfRotate,
                            &mut mfTrans11DA0Rotate);
    SkinMatrix_MtxFMtxFMult(&mut mfTrans11DA0Rotate, &mut mfScale,
                            &mut mfResult);
        ...
        (*_g_1).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            gSegments[((lightningTextures[texIdx as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(lightningTextures[texIdx as
                                                                    usize] as
                                                  u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsLightning_Update(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut index: u32_0,
                                                  mut this: *mut EffectSs) {
    let mut pad: s32 = 0;
    ...
    if (*this).regs[8 as libc::c_int as usize] as libc::c_int !=
           ...
           (*this).life as libc::c_int + 1 as libc::c_int ==
               (*this).regs[11 as libc::c_int as usize] as libc::c_int {
        yaw =
            ((*this).regs[10 as libc::c_int as usize] as libc::c_int +
                 (if Rand_ZeroOne() < 0.5f32 {
                      -(1 as libc::c_int)
                  } else { 1 as libc::c_int }) *
                     ((Rand_ZeroOne() * 3640.0f32) as s16 as libc::c_int +
                          0xe38 as libc::c_int)) as s16;
        scale =
            (*this).regs[9 as libc::c_int as usize] as libc::c_int as
                libc::c_float * 0.01f32 * 80.0f32;
        pos.y =
            (*this).pos.y +
                Math_SinS(((*this).regs[10 as libc::c_int as usize] as
                               libc::c_int - 0x4000 as libc::c_int) as s16) *
                    scale;
        scale =
            Math_CosS(((*this).regs[10 as libc::c_int as usize] as libc::c_int
                           - 0x4000 as libc::c_int) as s16) * scale;
        pos.x =
            (*this).pos.x -
                Math_CosS(Camera_GetInputDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                            as
                                                                            usize]))
                    * scale;
        pos.z =
            (*this).pos.z +
                Math_SinS(Camera_GetInputDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                            as
                                                                            usize]))
                    * scale;
        EffectSsLightning_NewLightning(globalCtx, &mut pos, yaw, this);
        if Rand_ZeroOne() < 0.1f32 {
            EffectSsLightning_NewLightning(globalCtx, &mut pos,
                                           ((*this).regs[10 as libc::c_int as
                                                             usize] as
