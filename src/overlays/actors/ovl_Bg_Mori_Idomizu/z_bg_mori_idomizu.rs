...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gMoriIdomizuWaterDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMoriIdomizu {
    pub actor: Actor,
    pub actionFunc: BgMoriIdomizuActionFunc,
    pub targetWaterLevel: f32_0,
    pub prevSwitchFlagSet: s32,
    pub isLoaded: s16,
    pub drainTimer: s16,
    pub moriTexObjIndex: s8,
}
pub type BgMoriIdomizuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMoriIdomizu, _: *mut GlobalContext)
               -> ()>;
static mut sIsSpawned: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut Bg_Mori_Idomizu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MORI_IDOMIZU as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMoriIdomizu>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriIdomizu_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriIdomizu_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMoriIdomizu_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_SetupAction(mut this:
                                                       *mut BgMoriIdomizu,
                                                   mut actionFunc:
                                                       BgMoriIdomizuActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_SetWaterLevel(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut waterLevel: s16) {
    let mut waterBox: *mut WaterBox =
        (*(*globalCtx).colCtx.colHeader).waterBoxes;
    (*waterBox.offset(2 as libc::c_int as isize)).ySurface = waterLevel;
    (*waterBox.offset(3 as libc::c_int as isize)).ySurface = waterLevel;
    (*waterBox.offset(4 as libc::c_int as isize)).ySurface = waterLevel;
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriIdomizu = thisx as *mut BgMoriIdomizu;
    if sIsSpawned != 0 { Actor_Kill(&mut (*this).actor); return }
    (*this).actor.scale.x = 1.1f32;
    (*this).actor.scale.y = 1.0f32;
    (*this).actor.scale.z = 1.0f32;
    (*this).actor.world.pos.x = 119.0f32;
    (*this).actor.world.pos.z = -1820.0f32;
    (*this).prevSwitchFlagSet =
        Flags_GetSwitch(globalCtx,
                        (*this).actor.params as libc::c_int &
                            0x3f as libc::c_int);
    if (*this).prevSwitchFlagSet != 0 as libc::c_int {
        (*this).actor.world.pos.y = -282.0f32;
        BgMoriIdomizu_SetWaterLevel(globalCtx, -(282 as libc::c_int) as s16);
    } else {
        (*this).actor.world.pos.y = 184.0f32;
        BgMoriIdomizu_SetWaterLevel(globalCtx, 184 as libc::c_int as s16);
    }
    ...
    if ((*this).moriTexObjIndex as libc::c_int) < 0 as libc::c_int {
        ...
        osSyncPrintf(b"Error : \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe5\x8d\xb1\xe9\x99\xba\xef\xbc\x81(arg_data 0x%04x)(%s %d)\n\x00"
                     ...
                     (*this).actor.params as libc::c_int,
                     b"../z_bg_mori_idomizu.c\x00" as *const u8 as
                         *const libc::c_char, 202 as libc::c_int);
        return
    }
    BgMoriIdomizu_SetupWaitForMoriTex(this);
    sIsSpawned = 1 as libc::c_int as s16;
    (*this).isLoaded = 1 as libc::c_int as s16;
    (*this).actor.room = -(1 as libc::c_int) as s8;
    // "Forest Temple well water"
    osSyncPrintf(b"(\xe6\xa3\xae\xe3\x81\xae\xe7\xa5\x9e\xe6\xae\xbf \xe4\xba\x95\xe6\x88\xb8\xe6\xb0\xb4)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriIdomizu = thisx as *mut BgMoriIdomizu;
    if (*this).isLoaded != 0 { sIsSpawned = 0 as libc::c_int as s16 };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_SetupWaitForMoriTex(mut this:
                                                               *mut BgMoriIdomizu) {
    BgMoriIdomizu_SetupAction(this,
                              Some(BgMoriIdomizu_WaitForMoriTex as
                                       unsafe extern "C" fn(_:
                                                                *mut BgMoriIdomizu,
                                                            _:
                                                                *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_WaitForMoriTex(mut this:
                                                          *mut BgMoriIdomizu,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
        ...
        (*this).actor.draw =
            Some(BgMoriIdomizu_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_SetupMain(mut this:
                                                     *mut BgMoriIdomizu) {
    BgMoriIdomizu_SetupAction(this,
                              Some(BgMoriIdomizu_Main as
                                       unsafe extern "C" fn(_:
                                                                *mut BgMoriIdomizu,
                                                            _:
                                                                *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_Main(mut this: *mut BgMoriIdomizu,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut roomNum: s8 = 0;
    ...
    if switchFlagSet != 0 {
        (*this).targetWaterLevel = -282.0f32
    } else { (*this).targetWaterLevel = 184.0f32 }
    if switchFlagSet != 0 && (*this).prevSwitchFlagSet == 0 {
        OnePointCutscene_Init(globalCtx, 3240 as libc::c_int as s16,
                              70 as libc::c_int as s16, thisx,
                              0 as libc::c_int as s16);
        (*this).drainTimer = 90 as libc::c_int as s16
    } else if switchFlagSet == 0 && (*this).prevSwitchFlagSet != 0 {
        OnePointCutscene_Init(globalCtx, 3240 as libc::c_int as s16,
                              70 as libc::c_int as s16, thisx,
                              0 as libc::c_int as s16);
        (*this).drainTimer = 90 as libc::c_int as s16;
        (*thisx).world.pos.y = 0.0f32
    }
    (*this).drainTimer -= 1;
    if roomNum as libc::c_int == 7 as libc::c_int ||
           roomNum as libc::c_int == 8 as libc::c_int ||
           roomNum as libc::c_int == 9 as libc::c_int {
        if ((*this).drainTimer as libc::c_int) < 70 as libc::c_int {
            Math_StepToF(&mut (*thisx).world.pos.y, (*this).targetWaterLevel,
                         3.5f32);
            BgMoriIdomizu_SetWaterLevel(globalCtx,
                                        (*thisx).world.pos.y as s16);
            if (*this).drainTimer as libc::c_int > 0 as libc::c_int {
                if switchFlagSet != 0 {
                    func_800788CC((0x285e as libc::c_int -
        ...
        BgMoriIdomizu_SetWaterLevel(globalCtx, (*thisx).world.pos.y as s16);
        Actor_Kill(thisx);
        return
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriIdomizu = thisx as *mut BgMoriIdomizu;
...
#[no_mangle]
pub unsafe extern "C" fn BgMoriIdomizu_Draw(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMoriIdomizu = thisx as *mut BgMoriIdomizu;
    ...
    (*_g_2).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (0x7f as libc::c_int as
                              libc::c_uint).wrapping_sub(gameplayFrames &
                                                             0x7f as
                                                                 libc::c_int
                                                                 as
                                                                 libc::c_uint),
                         gameplayFrames.wrapping_rem(0x80 as libc::c_int as
                                                         libc::c_uint),
                         0x20 as libc::c_int, 0x20 as libc::c_int,
                         1 as libc::c_int,
                         gameplayFrames & 0x7f as libc::c_int as libc::c_uint,
                         gameplayFrames.wrapping_rem(0x80 as libc::c_int as
                                                         libc::c_uint),
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = gMoriIdomizuWaterDL.as_mut_ptr() as libc::c_uint;
