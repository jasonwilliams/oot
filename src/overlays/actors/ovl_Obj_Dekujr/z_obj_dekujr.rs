...
extern "C" {
    ...
    #[no_mangle]
    fn func_80037C30(globalCtx: *mut GlobalContext, arg1: s16) -> u16_0;
    #[no_mangle]
    fn func_80037D98(globalCtx: *mut GlobalContext, actor: *mut Actor,
                     arg2: s16, arg3: *mut s32) -> s32;
    #[no_mangle]
    fn Collider_InitCylinder(globalCtx: *mut GlobalContext,
                             collider: *mut ColliderCylinder) -> s32;
    #[no_mangle]
    fn Collider_SetCylinderToActor(globalCtx: *mut GlobalContext,
                                   collider: *mut ColliderCylinder,
                                   src: *mut ColliderCylinderInitToActor)
     -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_dekujr_DL_0030D0: [Gfx; 0];
    #[no_mangle]
    static mut object_dekujr_DL_0032D8: [Gfx; 0];
}
...
pub const COLSHAPE_INVALID: C2RustUnnamed_14 = 4;
pub const COLSHAPE_QUAD: C2RustUnnamed_14 = 3;
pub const COLSHAPE_TRIS: C2RustUnnamed_14 = 2;
pub const COLSHAPE_CYLINDER: C2RustUnnamed_14 = 1;
pub const COLSHAPE_JNTSPH: C2RustUnnamed_14 = 0;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjDekujr {
    pub actor: Actor,
    pub collider: ColliderCylinder,
    pub unk_198: [libc::c_char; 3],
    pub unk_19B: u8_0,
    pub unk_19C: u8_0,
    pub unk_19D: [libc::c_char; 3],
    pub unk_1A0: s32,
}
#[no_mangle]
pub static mut Obj_Dekujr_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_DEKUJR as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 3 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_DEKUJR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjDekujr>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjDekujr_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjDekujr_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCylinderInit: ColliderCylinderInitToActor =
    {
        let mut init =
            ColliderCylinderInitToActor{base:
                                            {
                                                let mut init =
                                                    ColliderInitToActor{actor:
                                                                            0
                                                                                as
                                                                                *const Actor
                                                                                as
...
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjDekujr = thisx as *mut ObjDekujr;
    let mut pad: s32 = 0;
    if gSaveContext.cutsceneIndex < 0xfff0 as libc::c_int {
        ...
        (*this).unk_19B = 0 as libc::c_int as u8_0
    } else {
        (*this).unk_19C = 0 as libc::c_int as u8_0;
        (*this).unk_19B = 1 as libc::c_int as u8_0
    }
    if gBitFlags[QUEST_MEDALLION_FOREST as libc::c_int as usize] &
        ...
        Collider_SetCylinderToActor(globalCtx, &mut (*this).collider,
                                    &mut sCylinderInit);
        (*thisx).colChkInfo.mass = 0xff as libc::c_int as u8_0;
        (*thisx).textId = func_80037C30(globalCtx, 0xf as libc::c_int as s16);
        Actor_SetScale(thisx, 0.4f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_SetInitialPos(mut npcAction:
                                                     *mut CsCmdActorAction,
                                                 mut initPos: *mut Vec3f) {
    (*initPos).x = (*npcAction).startPos.x as f32_0;
    (*initPos).y = (*npcAction).startPos.y as f32_0;
    (*initPos).z = (*npcAction).startPos.z as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_SetFinalPos(mut npcAction:
                                                   *mut CsCmdActorAction,
                                               mut finalPos: *mut Vec3f) {
    (*finalPos).x = (*npcAction).endPos.x as f32_0;
    (*finalPos).y = (*npcAction).endPos.y as f32_0;
    (*finalPos).z = (*npcAction).endPos.z as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_ComeUp(mut this: *mut ObjDekujr,
                                          mut globalCtx: *mut GlobalContext) {
    let mut csCmdNPCAction: *mut CsCmdActorAction =
        0 as *mut CsCmdActorAction;
    let mut initPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut finalPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    if (*globalCtx).csCtx.state as libc::c_int == CS_STATE_IDLE as libc::c_int
       {
        ...
        if (*globalCtx).csCtx.frames as libc::c_int == 351 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x28bf as libc::c_int as u16_0);
        }
        csCmdNPCAction =
            (*globalCtx).csCtx.npcActions[1 as libc::c_int as usize];
        if !csCmdNPCAction.is_null() {
            ObjDekujr_SetInitialPos(csCmdNPCAction, &mut initPos);
            ObjDekujr_SetFinalPos(csCmdNPCAction, &mut finalPos);
            if (*this).unk_19C as libc::c_int == 0 as libc::c_int {
                (*this).actor.world.pos = initPos;
                (*this).unk_19C = 1 as libc::c_int as u8_0
            }
            (*this).actor.shape.rot.x =
                (*csCmdNPCAction).c2rust_unnamed.urot.x as s16;
            (*this).actor.shape.rot.y =
                (*csCmdNPCAction).c2rust_unnamed.urot.y as s16;
            (*this).actor.shape.rot.z =
                (*csCmdNPCAction).c2rust_unnamed.urot.z as s16;
            (*this).actor.velocity = velocity;
            if (*csCmdNPCAction).endFrame as libc::c_int >=
                ...
                (*this).actor.velocity.x =
                    (finalPos.x - initPos.x) / actionLength;
                gravity = (*this).actor.gravity;
                (*this).actor.velocity.y =
                    (finalPos.y - initPos.y) / actionLength;
                (*this).actor.velocity.y += gravity;
                if (*this).actor.velocity.y < (*this).actor.minVelocityY {
                    (*this).actor.velocity.y = (*this).actor.minVelocityY
                }
                (*this).actor.velocity.z =
                    (finalPos.z - initPos.z) / actionLength
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjDekujr = thisx as *mut ObjDekujr;
    let mut pad: s32 = 0;
    ...
    if gSaveContext.cutsceneIndex >= 0xfff0 as libc::c_int &&
           (*this).unk_19B as libc::c_int == 0 as libc::c_int {
        (*this).unk_19C = 0 as libc::c_int as u8_0;
        (*this).unk_19B = 1 as libc::c_int as u8_0
    }
    if (*this).unk_19B as libc::c_int == 1 as libc::c_int {
        ObjDekujr_ComeUp(this, globalCtx);
        (*this).actor.world.pos.x += (*this).actor.velocity.x;
        (*this).actor.world.pos.y += (*this).actor.velocity.y;
        (*this).actor.world.pos.z += (*this).actor.velocity.z
    } else {
        func_80037D98(globalCtx, &mut (*this).actor,
                      0xf as libc::c_int as s16, &mut (*this).unk_1A0);
        Actor_SetFocus(&mut (*this).actor, 40.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjDekujr_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut frameCount: u32_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_dekujr.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = object_dekujr_DL_0030D0.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         frameCount.wrapping_rem(128 as libc::c_int as
                                                     libc::c_uint),
    ...
    (*_g_3).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = object_dekujr_DL_0032D8.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_dekujr.c\x00" as *const u8 as
                         *const libc::c_char, 409 as libc::c_int);
}
