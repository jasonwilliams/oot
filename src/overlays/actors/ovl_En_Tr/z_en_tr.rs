...
extern "C" {
    ...
    #[no_mangle]
    static mut object_tr_Anim_000BFC: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_0013CC: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_001CDC: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_002BC4: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_0035CC: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_003FC8: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Anim_0049C8: AnimationHeader;
    #[no_mangle]
    static mut object_tr_Tex_0086D8: [u64_0; 0];
    #[no_mangle]
    static mut object_tr_Tex_0094D8: [u64_0; 0];
    #[no_mangle]
    static mut object_tr_Tex_0098D8: [u64_0; 0];
    #[no_mangle]
    static mut object_tr_Skel_00C530: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_tr_Skel_011688: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_tr_Anim_012E1C: AnimationHeader;
}
...
pub struct EnTr {
    ...
    pub timer: u16_0,
    pub actionIndex: s16,
    pub actionFunc: EnTrActionFunc,
    pub eyeIndex: s16,
    pub blinkTimer: s16,
    pub animation: *mut AnimationHeader,
}
pub type EnTrActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnTr, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_19 = libc::c_uint;
pub const TR_KOTAKE: C2RustUnnamed_19 = 1;
pub const TR_KOUME: C2RustUnnamed_19 = 0;
#[no_mangle]
pub static mut En_Tr_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_TR as libc::c_int as s16,
                          category: ACTORCAT_NPC as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_TR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnTr>() as libc::c_ulong,
                          init:
...
static mut D_80B24368: [*mut AnimationHeader; 2] =
    unsafe {
        [&object_tr_Anim_002BC4 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tr_Anim_000BFC as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut D_80B24370: [*mut AnimationHeader; 2] =
    unsafe {
        [&object_tr_Anim_0035CC as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tr_Anim_0013CC as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut D_80B24378: [*mut AnimationHeader; 2] =
    unsafe {
        [&object_tr_Anim_0049C8 as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tr_Anim_0049C8 as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut D_80B24380: [*mut AnimationHeader; 2] =
    unsafe {
        [&object_tr_Anim_012E1C as *const AnimationHeader as
             *mut AnimationHeader,
         &object_tr_Anim_012E1C as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut D_80B24388: [f32_0; 7] =
    [0.0f32, 20.0f32, -30.0f32, 20.0f32, -20.0f32, -20.0f32, 30.0f32];
static mut D_80B243A4: [f32_0; 7] =
    [0.0f32, 30.0f32, 0.0f32, -30.0f32, 30.0f32, -30.0f32, 0.0f32];
// Has to be 1-dimensional to match
static mut D_80B243C0: [Color_RGBA8; 4] =
    [{
         let mut init =
             Color_RGBA8{r: 255 as libc::c_int as u8_0,
                         g: 200 as libc::c_int as u8_0,
                         b: 0 as libc::c_int as u8_0,
                         a: 255 as libc::c_int as u8_0,}; // Set and not used
         init
     },
     {
         let mut init =
...
static mut sEyeTextures: [*mut libc::c_void; 3] =
    unsafe {
        [object_tr_Tex_0086D8.as_ptr() as *mut _ as *mut libc::c_void,
         object_tr_Tex_0094D8.as_ptr() as *mut _ as *mut libc::c_void,
         object_tr_Tex_0098D8.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EnTr_SetupAction(mut this: *mut EnTr,
                                          mut actionFunc: EnTrActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnTr = thisx as *mut EnTr;
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 30.0f32);
    EnTr_SetupAction(this,
                     Some(EnTr_DoNothing as
                              unsafe extern "C" fn(_: *mut EnTr,
                                                   _: *mut GlobalContext)
                                  -> ()));
    (*this).unk_2D4 = 0 as libc::c_int as s16;
    ...
    match (*this).actor.params as libc::c_int {
        0 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut object_tr_Skel_011688,
                               &mut object_tr_Anim_003FC8,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               27 as libc::c_int);
            Animation_PlayOnce(&mut (*this).skelAnime,
                               &mut object_tr_Anim_003FC8);
            (*this).animation = 0 as *mut AnimationHeader;
            EnTr_SetupAction(this,
                             Some(EnTr_ChooseAction1 as
                                      unsafe extern "C" fn(_: *mut EnTr,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
            (*this).actionIndex = 3 as libc::c_int as s16
        }
        1 => {
            SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                               &mut object_tr_Skel_00C530,
                               &mut object_tr_Anim_001CDC,
                               (*this).jointTable.as_mut_ptr(),
                               (*this).morphTable.as_mut_ptr(),
                               27 as libc::c_int);
            Animation_PlayOnce(&mut (*this).skelAnime,
                             ...
                             Some(EnTr_ChooseAction1 as
                                      unsafe extern "C" fn(_: *mut EnTr,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
            (*this).actionIndex = 2 as libc::c_int as s16
        }
        _ => {
            if 0 as libc::c_int != 0 {
            } else {
                __assert(b"0\x00" as *const u8 as *const libc::c_char,
                         b"../z_en_tr.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_CrySpellcast(mut this: *mut EnTr,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).timer as libc::c_int == 11 as libc::c_int {
        ...
        if (*this).actor.params as libc::c_int != TR_KOUME as libc::c_int ||
               gSaveContext.sceneSetupIndex == 6 as libc::c_int {
            Audio_PlaySoundGeneral(0x39b3 as libc::c_int as u16_0,
    ...
    func_8002F974(&mut (*this).actor,
                  (0x397b as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_DoNothing(mut this: *mut EnTr,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_ChooseAction2(mut this: *mut EnTr,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        if !(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                                              usize].is_null() {
            match (*(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                                                      usize]).action as
                      libc::c_int {
                4 => {
                    Actor_SetScale(&mut (*this).actor, 0.01f32);
                    EnTr_SetupAction(this,
                                     Some(EnTr_ShrinkVanish as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnTr,
                                                                   _:
                                                                       *mut GlobalContext)
                                                  -> ()));
                    (*this).timer = 24 as libc::c_int as u16_0;
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3877 as libc::c_int as u16_0);
                }
                6 => {
                    Animation_Change(&mut (*this).skelAnime,
                                     D_80B24380[(*this).actor.params as
                                                    usize], 1.0f32, 0.0f32,
                                     Animation_GetLastFrame(D_80B24380[(*this).actor.params
                                                                           as
                                                                           usize]
                                                                as
                                                                *mut libc::c_void)
                    ...
                    EnTr_SetupAction(this,
                                     Some(EnTr_CrySpellcast as
                                              unsafe extern "C" fn(_:
                                                  ...
                                                  -> ()));
                    (*this).animation =
                        D_80B24378[(*this).actor.params as usize];
                    (*this).timer = 39 as libc::c_int as u16_0;
                ...
                _ => {
                    func_80B24038(this, globalCtx,
                                  (*this).actionIndex as s32);
                    EnTr_UpdateRotation(this, globalCtx,
                                        (*this).actionIndex as s32);
                }
            }
            func_8002F974(&mut (*this).actor,
                          (0x397b as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_FlyKidnapCutscene(mut this: *mut EnTr,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut originalPos: Vec3f = (*this).actor.world.pos;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        if !(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                                              usize].is_null() {
            if (*(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                ...
                func_80B24038(this, globalCtx, (*this).actionIndex as s32);
                (*this).actor.world.rot.y =
                    Math_Atan2S((*this).actor.velocity.z,
                ...
                EnTr_SetStartPosRot(this, globalCtx,
                                    (*this).actionIndex as s32);
                (*this).actor.world.pos.x +=
                    Math_SinS((*this).timer as s16) * 150.0f32;
                (*this).actor.world.pos.y += -100.0f32;
                (*this).actor.world.pos.z +=
                    Math_CosS((*this).timer as s16) * 150.0f32;
                (*this).actor.shape.rot.y =
                    ((*this).timer as s16 as libc::c_int +
                         0x4000 as libc::c_int) as s16;
                (*this).timer =
                    ((*this).timer as libc::c_int + 0x400 as libc::c_int) as
                        u16_0;
                (*this).actor.velocity.x =
                    (*this).actor.world.pos.x - originalPos.x;
                (*this).actor.velocity.y =
                    (*this).actor.world.pos.y - originalPos.y;
                (*this).actor.velocity.z =
                    (*this).actor.world.pos.z - originalPos.z
            }
            if ((*globalCtx).csCtx.frames as libc::c_int) < 670 as libc::c_int
               {
                func_8002F974(&mut (*this).actor,
                              (0x397b as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80B23254(mut this: *mut EnTr,
                                       mut globalCtx: *mut GlobalContext,
    ...
    let mut primColor: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut envColor: *mut Color_RGBA8 = 0 as *mut Color_RGBA8;
    let mut cameraEye: Vec3f =
        (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize]).eye;
    let mut yaw: s16 =
        Math_Vec3f_Yaw(&mut cameraEye, &mut (*this).actor.world.pos);
    let mut reversePitch: s16 =
        -(Math_Vec3f_Pitch(&mut cameraEye, &mut (*this).actor.world.pos) as
              libc::c_int) as s16;
    ...
    accel.y = 0.5f32;
    primColor =
        &mut *D_80B243C0.as_mut_ptr().offset((2 as libc::c_int *
    ...
    sp58.x -= velocity.x * 10.0f32;
    sp58.y -= velocity.y * 10.0f32;
    sp58.z -= velocity.z * 10.0f32;
    pos.x = sp58.x + D_80B24388[arg2 as usize] * scale * Math_CosS(yaw);
    pos.y = sp58.y + D_80B243A4[arg2 as usize] * scale;
    pos.z = sp58.z - D_80B24388[arg2 as usize] * scale * Math_SinS(yaw);
    func_8002829C(globalCtx, &mut pos, &mut velocity, &mut accel, primColor,
                  envColor, (800.0f32 * scale) as s32 as s16,
                  (80.0f32 * scale) as s32 as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_ShrinkVanish(mut this: *mut EnTr,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).timer as libc::c_int >= 17 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int -
                 (*this).timer as libc::c_int * 0x28f as libc::c_int +
                 0x3d68 as libc::c_int) as s16
        ...
        let mut temp_hi: s32 =
            (*this).timer as libc::c_int * 2 as libc::c_int %
                7 as libc::c_int;
        func_80B23254(this, globalCtx, temp_hi, 5.0f32, 0.2f32);
        func_80B23254(this, globalCtx,
                      (temp_hi + 1 as libc::c_int) % 7 as libc::c_int, 5.0f32,
                      0.2f32);
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x * 0.9f32);
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int -
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_Reappear(mut this: *mut EnTr,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int >= 31 as libc::c_int {
        let mut temp_hi: s32 =
            (*this).timer as libc::c_int * 2 as libc::c_int %
                7 as libc::c_int;
        func_80B23254(this, globalCtx, temp_hi, 5.0f32, 1.0f32);
        func_80B23254(this, globalCtx,
                      (temp_hi + 1 as libc::c_int) % 7 as libc::c_int, 5.0f32,
                      1.0f32);
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).timer as libc::c_int * 0x1a6 as libc::c_int) as s16
    } else if (*this).timer as libc::c_int > 0 as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).timer as libc::c_int * 0x1a6 as libc::c_int) as s16;
        Actor_SetScale(&mut (*this).actor,
                       (*this).actor.scale.x * 0.8f32 + 0.002f32);
    } else {
        EnTr_SetupAction(this,
                         Some(EnTr_ChooseAction2 as
                                  unsafe extern "C" fn(_: *mut EnTr,
                                                       _: *mut GlobalContext)
                                      -> ()));
        Actor_SetScale(&mut (*this).actor, 0.01f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_WaitToReappear(mut this: *mut EnTr,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        if !(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                                              usize].is_null() &&
               ((*(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                                                    usize]).action as
            ...
            (*this).timer = 34 as libc::c_int as u16_0;
            EnTr_SetStartPosRot(this, globalCtx, (*this).actionIndex as s32);
            EnTr_SetupAction(this,
                             Some(EnTr_Reappear as
                                      unsafe extern "C" fn(_: *mut EnTr,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
            Animation_PlayLoop(&mut (*this).skelAnime,
                               &mut object_tr_Anim_0049C8);
            (*this).animation = 0 as *mut AnimationHeader;
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_TakeOff(mut this: *mut EnTr,
                                      mut globalCtx: *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(D_80B24378[(*this).actor.params as usize] as
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_TurnLookOverShoulder(mut this: *mut EnTr,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(D_80B24368[(*this).actor.params as usize] as
                                   *mut libc::c_void) as f32_0;
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        if !(*globalCtx).csCtx.npcActions[(*this).actionIndex as
            ...
            Animation_Change(&mut (*this).skelAnime,
                             D_80B24368[(*this).actor.params as usize],
                             1.0f32, 0.0f32, lastFrame,
                             ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
            (*this).animation = D_80B24370[(*this).actor.params as usize];
            EnTr_SetupAction(this,
                             Some(EnTr_TakeOff as
                                      unsafe extern "C" fn(_: *mut EnTr,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_ChooseAction1(mut this: *mut EnTr,
                                            mut globalCtx:
                                                *mut GlobalContext) {
            ...
            match (*(*globalCtx).csCtx.npcActions[(*this).actionIndex as
                ...
                1 => {
                    EnTr_SetStartPosRot(this, globalCtx,
                                        (*this).actionIndex as s32);
                    EnTr_SetupAction(this,
                                     Some(EnTr_TurnLookOverShoulder as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnTr,
                                                                   _:
                                                                       *mut GlobalContext)
                ...
                7 => {
                    EnTr_SetupAction(this,
                                     Some(EnTr_FlyKidnapCutscene as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnTr,
                                                                   _:
                                                                       *mut GlobalContext)
                    ...
                    (*this).timer =
                        if (*this).actor.params as libc::c_int !=
                               TR_KOUME as libc::c_int {
                            (frames as u8_0 as libc::c_int *
                                 0x400 as libc::c_int) + 0x8000 as libc::c_int
                        } else {
                            (frames as u8_0 as libc::c_int) *
                                0x400 as libc::c_int
                        } as u16_0
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnTr = thisx as *mut EnTr;
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        if !(*this).animation.is_null() {
            if (*this).animation ==
                   &mut object_tr_Anim_0035CC as *mut AnimationHeader ||
                   (*this).animation ==
                       &mut object_tr_Anim_0013CC as *mut AnimationHeader {
                if (*this).actor.params as libc::c_int !=
                       TR_KOUME as libc::c_int {
                    Audio_PlayActorSound2(&mut (*this).actor,
                ...
                Animation_PlayLoop(&mut (*this).skelAnime, (*this).animation);
            } else if (*this).animation ==
                          &mut object_tr_Anim_0049C8 as *mut AnimationHeader {
                EnTr_SetupAction(this,
                                 Some(EnTr_ChooseAction2 as
                                          unsafe extern "C" fn(_: *mut EnTr,
                                                               _:
                                              ...
                                              -> ()));
                Animation_Change(&mut (*this).skelAnime,
                                 &mut object_tr_Anim_0049C8, 1.0f32, 0.0f32,
                                 Animation_GetLastFrame(&mut object_tr_Anim_0049C8
                                                            as
                                                            *mut AnimationHeader
                                                            as
                                                            *mut libc::c_void)
            ...
            (*this).animation = 0 as *mut AnimationHeader
        } else { (*this).skelAnime.curFrame = 0.0f32 }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut src: Vec3f =
        {
            let mut init = Vec3f{x: 2300.0f32, y: 0.0f32, z: -600.0f32,};
            init
        };
    let mut dest: Vec3f =
    ...
    if !child.is_null() && limbIndex == 19 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnTr_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnTr = thisx as *mut EnTr;
    if (*globalCtx).csCtx.state as libc::c_int == CS_STATE_IDLE as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80B23FDC(mut globalCtx: *mut GlobalContext,
                                       mut actionIndex: s32) -> f32_0 {
    let mut phi_f2: f32_0 =
        Environment_LerpWeight((*(*globalCtx).csCtx.npcActions[actionIndex as
                                                                   usize]).endFrame,
                               (*(*globalCtx).csCtx.npcActions[actionIndex as
                                                                   usize]).startFrame,
...
#[no_mangle]
pub unsafe extern "C" fn func_80B24038(mut this: *mut EnTr,
                                       mut globalCtx: *mut GlobalContext,
                                       mut actionIndex: s32) {
    ...
    startPos.x =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).startPos.x as
            f32_0;
    startPos.y =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).startPos.y as
            f32_0;
    startPos.z =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).startPos.z as
            f32_0;
    endPos.x =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).endPos.x as
            f32_0;
    endPos.y =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).endPos.y as
            f32_0;
    endPos.z =
        (*(*globalCtx).csCtx.npcActions[actionIndex as usize]).endPos.z as
            f32_0;
    ...
    endPos.x = (startPos.x - (*this).actor.world.pos.x) * 0.1f32;
    endPos.y = (startPos.y - (*this).actor.world.pos.y) * 0.1f32;
    endPos.z = (startPos.z - (*this).actor.world.pos.z) * 0.1f32;
    temp_f0_2 =
        sqrtf(endPos.x * endPos.x + endPos.y * endPos.y +
                  endPos.z * endPos.z);
    phi_f12 =
        if temp_f0_2 < 0.0f32 {
            0.0f32
        } else if temp_f0_2 > 20.0f32 { 20.0f32 } else { temp_f0_2 };
    if temp_f0_2 != phi_f12 && temp_f0_2 != 0.0f32 {
        endPos.x *= phi_f12 / temp_f0_2;
        endPos.y *= phi_f12 / temp_f0_2;
        endPos.z *= phi_f12 / temp_f0_2
    }
    Math_StepToF(&mut (*this).actor.velocity.x, endPos.x, 1.0f32);
    Math_StepToF(&mut (*this).actor.velocity.y, endPos.y, 1.0f32);
    Math_StepToF(&mut (*this).actor.velocity.z, endPos.z, 1.0f32);
    func_8002D7EC(&mut (*this).actor);
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_UpdateRotation(mut this: *mut EnTr,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut actionIndex: s32) {
    let mut rotY: s16 =
        (*(*globalCtx).csCtx.npcActions[actionIndex as
                                            usize]).c2rust_unnamed.rot.y;
    let mut rotDiff: s32 =
        (*this).actor.world.rot.y as libc::c_int - rotY as libc::c_int;
    let mut rotSign: s32 = 0;
    if rotDiff < 0 as libc::c_int {
        rotDiff = -rotDiff;
        rotSign = 1 as libc::c_int
    } else { rotSign = -(1 as libc::c_int) }
    if rotDiff >= 0x8000 as libc::c_int {
        rotSign = -rotSign;
        rotDiff = 0x10000 as libc::c_int - rotDiff
    }
    rotDiff = (rotDiff as libc::c_float * 0.1f32) as s32;
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int + rotDiff * rotSign) as s16;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnTr_SetStartPosRot(mut this: *mut EnTr,
                                             mut globalCtx:
                                                 *mut GlobalContext,
                                             mut actionIndex: s32) {
    let mut startPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
