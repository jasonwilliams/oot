...
extern "C" {
    ...
    #[no_mangle]
    static mut gChildEponaEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gChildEponaEyeCloseTex: [u64_0; 0];
    #[no_mangle]
    static mut gChildEponaEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gChildEponaGallopingAnim: AnimationHeader;
    #[no_mangle]
    static mut gChildEponaTrottingAnim: AnimationHeader;
    #[no_mangle]
    static mut gChildEponaIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gChildEponaWhinnyAnim: AnimationHeader;
    #[no_mangle]
    static mut gChildEponaWalkingAnim: AnimationHeader;
    #[no_mangle]
    static mut gChildEponaSkel: SkeletonHeader;
}
...
pub type EnHorseLinkChildActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Horse_Link_Child_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HORSE_LINK_CHILD as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId:
                              OBJECT_HORSE_LINK_CHILD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHorseLinkChild>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseLinkChild_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseLinkChild_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseLinkChild_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseLinkChild_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sAnimations: [*mut AnimationHeader; 5] =
    unsafe {
        [&gChildEponaIdleAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gChildEponaWhinnyAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gChildEponaWalkingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gChildEponaTrottingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gChildEponaGallopingAnim as *const AnimationHeader as
             *mut AnimationHeader]
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A693D0(mut this: *mut EnHorseLinkChild) {
    static mut D_80A6AF5C: [s32; 2] = [1 as libc::c_int, 19 as libc::c_int];
    if (*this).skin.skelAnime.curFrame >
           D_80A6AF5C[(*this).unk_1F0 as usize] as libc::c_float &&
           !((*this).unk_1F0 == 0 as libc::c_int &&
                 (*this).skin.skelAnime.curFrame >
                     D_80A6AF5C[1 as libc::c_int as usize] as libc::c_float) {
        Audio_PlaySoundGeneral(0x2842 as libc::c_int as u16_0,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6948C(mut this: *mut EnHorseLinkChild) {
    if (*this).animationIdx == 2 as libc::c_int {
        func_80A693D0(this);
    } else if (*this).skin.skelAnime.curFrame == 0.0f32 {
        if (*this).animationIdx == 3 as libc::c_int ||
               (*this).animationIdx == 4 as libc::c_int {
            Audio_PlaySoundGeneral(0x2843 as libc::c_int as u16_0,
                                   &mut (*this).actor.projectedPos,
                                   4 as libc::c_int as u8_0, &mut D_801333E0,
                                   &mut D_801333E0, &mut D_801333E8);
        } else if (*this).animationIdx == 1 as libc::c_int {
            if Rand_ZeroOne() > 0.5f32 {
                Audio_PlaySoundGeneral(0x2845 as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
            } else {
                Audio_PlaySoundGeneral(0x2844 as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
...
static mut D_80A6AF64: [f32_0; 5] = [1.0f32, 1.0f32, 1.5f32, 1.5f32, 1.5f32];
#[no_mangle]
pub unsafe extern "C" fn func_80A695A4(mut this: *mut EnHorseLinkChild)
 -> f32_0 {
    let mut result: f32_0 = 0.;
    if (*this).animationIdx == 2 as libc::c_int {
        result =
            D_80A6AF64[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1.0f32 / 2.0f32)
    } else if (*this).animationIdx == 3 as libc::c_int {
        result =
            D_80A6AF64[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1.0f32 / 3.0f32)
    } else if (*this).animationIdx == 4 as libc::c_int {
        result =
            D_80A6AF64[(*this).animationIdx as usize] * (*this).actor.speedXZ
                * (1.0f32 / 5.0f32)
    } else { result = D_80A6AF64[(*this).animationIdx as usize] }
    return result;
}
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseLinkChild_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnHorseLinkChild = thisx as *mut EnHorseLinkChild;
    let mut pad: s32 = 0;
    ...
    func_800A663C(globalCtx, &mut (*this).skin, &mut gChildEponaSkel,
                  &mut gChildEponaGallopingAnim);
    (*this).animationIdx = 0 as libc::c_int;
    Animation_PlayOnce(&mut (*this).skin.skelAnime,
                       sAnimations[0 as libc::c_int as usize]);
    Collider_InitCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_SetCylinderType1(globalCtx, &mut (*this).bodyCollider,
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo,
                           0 as *mut DamageTable, &mut sColCheckInfoInit);
    (*this).unk_1F0 = 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6988C(mut this: *mut EnHorseLinkChild) {
    (*this).action = 0 as libc::c_int;
    (*this).animationIdx += 1;
    if (*this).animationIdx >=
           (::std::mem::size_of::<[*mut AnimationHeader; 5]>() as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A698F4(mut this: *mut EnHorseLinkChild,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6993C(mut this: *mut EnHorseLinkChild,
                                       mut newAnimationIdx: s32) {
    (*this).action = 2 as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    if !(newAnimationIdx == 0 as libc::c_int ||
             newAnimationIdx == 1 as libc::c_int) {
        newAnimationIdx = 0 as libc::c_int
    }
    if (*this).animationIdx != newAnimationIdx {
        (*this).animationIdx = newAnimationIdx;
        Animation_Change(&mut (*this).skin.skelAnime,
                         sAnimations[(*this).animationIdx as usize],
                         func_80A695A4(this), 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A699FC(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    let mut distFromLink: f32_0 = 0.;
    let mut newAnimationIdx: s32 = 0;
    distFromLink =
        Actor_WorldDistXZToActor(&mut (*this).actor,
                                 &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                             ...
                                             as *mut Player)).actor);
    if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
        if distFromLink < 1000.0f32 && distFromLink > 70.0f32 {
            func_80A69B7C(this);
        } else {
            newAnimationIdx =
                if (*this).animationIdx == 1 as libc::c_int {
                    0 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_80A69B7C(mut this: *mut EnHorseLinkChild) {
    (*this).action = 1 as libc::c_int;
    (*this).animationIdx = 0 as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skin.skelAnime,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A69C18(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).animationIdx == 4 as libc::c_int ||
           ...
           (*this).animationIdx == 2 as libc::c_int {
        yawDiff =
            (Actor_WorldYawTowardActor(&mut (*this).actor,
                 ...
                 libc::c_int - (*this).actor.world.rot.y as libc::c_int) as
                s16;
        if yawDiff as libc::c_int > 0x12c as libc::c_int {
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_int +
                     0x12c as libc::c_int) as s16
        } else if (yawDiff as libc::c_int) < -(0x12c as libc::c_int) {
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_int -
                     0x12c as libc::c_int) as s16
        } else {
        ...
        distFromLink =
            Actor_WorldDistXZToActor(&mut (*this).actor,
                                     &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                                        ...
                                                                                                        isize)).head
                                                 as *mut Player)).actor);
        if distFromLink > 1000.0f32 {
            func_80A6993C(this, 0 as libc::c_int);
            return
        } else {
            if distFromLink < 1000.0f32 && distFromLink >= 300.0f32 {
                newAnimationIdx = 4 as libc::c_int;
                (*this).actor.speedXZ = 6.0f32
            } else if distFromLink < 300.0f32 && distFromLink >= 150.0f32 {
                newAnimationIdx = 3 as libc::c_int;
                (*this).actor.speedXZ = 4.0f32
            } else if distFromLink < 150.0f32 && distFromLink >= 70.0f32 {
                newAnimationIdx = 2 as libc::c_int;
                (*this).actor.speedXZ = 2.0f32;
                (*this).unk_1F0 = 0 as libc::c_int
            } else { func_80A6993C(this, 1 as libc::c_int); return }
        }
        if (*this).animationIdx != newAnimationIdx {
            (*this).animationIdx = newAnimationIdx;
            Animation_Change(&mut (*this).skin.skelAnime,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A69EC0(mut this: *mut EnHorseLinkChild) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A69F5C(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut yawDiff: s16 = 0;
    let mut yawSign: s32 = 0;
    let mut yawOffset: s32 = 0;
    if (*this).animationIdx == 4 as libc::c_int ||
           (*this).animationIdx == 3 as libc::c_int ||
           (*this).animationIdx == 2 as libc::c_int {
        player =
        ...
        if Math3D_Vec3f_DistXYZ(&mut (*player).actor.world.pos,
                                &mut (*this).actor.home.pos) < 250.0f32 {
            ...
            yawOffset = yawSign << 0xe as libc::c_int;
            yawDiff = (yawDiff as libc::c_int + yawOffset) as s16
        } else {
            yawDiff =
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6A068(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player = 0 as *mut Player;
    let mut distFromLink: f32_0 = 0.;
    ...
    let mut distLinkFromHome: f32_0 = 0.;
    func_80A69F5C(this, globalCtx);
    player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    distFromLink =
        Actor_WorldDistXZToActor(&mut (*this).actor, &mut (*player).actor);
    if gSaveContext.entranceIndex == 0x2ae as libc::c_int {
        Audio_PlaySoundGeneral(0x2844 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    ...
    if animationEnded != 0 || (*this).animationIdx == 1 as libc::c_int ||
           (*this).animationIdx == 0 as libc::c_int {
        if gSaveContext.eventChkInf[1 as libc::c_int as usize] as libc::c_int
            ...
            distLinkFromHome =
                Math3D_Vec3f_DistXYZ(&mut (*player).actor.world.pos,
                                     &mut (*this).actor.home.pos);
            if distLinkFromHome > 250.0f32 {
                if distFromHome >= 300.0f32 {
                    newAnimationIdx = 4 as libc::c_int;
                    (*this).actor.speedXZ = 6.0f32
                } else if distFromHome < 300.0f32 && distFromHome >= 150.0f32
                 {
                    newAnimationIdx = 3 as libc::c_int;
                    (*this).actor.speedXZ = 4.0f32
                } else if distFromHome < 150.0f32 && distFromHome >= 70.0f32 {
                    newAnimationIdx = 2 as libc::c_int;
                    (*this).actor.speedXZ = 2.0f32;
                    (*this).unk_1F0 = 0 as libc::c_int
                } else {
                    (*this).actor.speedXZ = 0.0f32;
                    if (*this).animationIdx == 0 as libc::c_int {
                        newAnimationIdx =
                            if animationEnded == 1 as libc::c_int {
                                1 as libc::c_int
            ...
            } else if distFromLink < 200.0f32 {
                newAnimationIdx = 4 as libc::c_int;
                (*this).actor.speedXZ = 6.0f32
            } else if distFromLink < 300.0f32 {
                newAnimationIdx = 3 as libc::c_int;
                (*this).actor.speedXZ = 4.0f32
            } else if distFromLink < 400.0f32 {
                newAnimationIdx = 2 as libc::c_int;
                (*this).actor.speedXZ = 2.0f32;
                (*this).unk_1F0 = 0 as libc::c_int
            } else {
    ...
    if (*this).animationIdx != newAnimationIdx ||
           animationEnded == 1 as libc::c_int {
        (*this).animationIdx = newAnimationIdx;
        Animation_Change(&mut (*this).skin.skelAnime,
                         sAnimations[(*this).animationIdx as usize],
                         func_80A695A4(this), 0.0f32,
        ...
        Animation_Change(&mut (*this).skin.skelAnime,
                         sAnimations[(*this).animationIdx as usize],
                         func_80A695A4(this), (*this).skin.skelAnime.curFrame,
                         Animation_GetLastFrame(sAnimations[(*this).animationIdx
                                                                as usize] as
                                                    *mut libc::c_void) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6A4DC(mut this: *mut EnHorseLinkChild) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6A5A4(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 = 0;
    if (*gGameInfo).data[(7 as libc::c_int * 6 as libc::c_int *
        ...
        yawDiff =
            (Actor_WorldYawTowardActor(&mut (*this).actor,
                ...
                s16;
        // 0.7071 = cos(pi/4)
        if Math_CosS(yawDiff) < 0.7071f32 &&
               (*this).animationIdx == 2 as libc::c_int {
            func_8006DD9C(&mut (*this).actor,
                          &mut (*((*(*globalCtx).actorCtx.actorLists.as_mut_ptr().offset(ACTORCAT_PLAYER
                                                                                             as
                                                                                             libc::c_int
                                                                                             as
        ...
        if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
            if Math_CosS(yawDiff) < 0.0f32 {
                (*this).animationIdx = 2 as libc::c_int;
                Animation_Change(&mut (*this).skin.skelAnime,
                                 sAnimations[(*this).animationIdx as usize],
                                 D_80A6AF64[(*this).animationIdx as usize],
                                 0.0f32,
                                 Animation_GetLastFrame(sAnimations[(*this).animationIdx
                                                                        as
                                                                        usize]
                                 ...
                                 ANIMMODE_ONCE as libc::c_int as u8_0,
                                 -5.0f32);
            } else { func_80A6A4DC(this); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6A724(mut this: *mut EnHorseLinkChild) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6A7D0(mut this: *mut EnHorseLinkChild,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut newAnimationIdx: s32 = 0;
    (*this).timer += 1;
    if (*this).timer > 300 as libc::c_int {
    ...
    if (*this).animationIdx == 4 as libc::c_int ||
           ...
           (*this).animationIdx == 2 as libc::c_int {
        if (*this).unk_1E8 == 0 {
            func_8006DD9C(&mut (*this).actor, &mut (*player).actor.world.pos,
                          300 as libc::c_int as s16);
        } else {
            func_8006DD9C(&mut (*this).actor, &mut (*this).actor.home.pos,
                          300 as libc::c_int as s16);
        }
    }
    if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 {
        ...
        } else if dist >= 300.0f32 {
            newAnimationIdx = 4 as libc::c_int;
            (*this).actor.speedXZ = 6.0f32
        } else if dist >= 150.0f32 {
            newAnimationIdx = 3 as libc::c_int;
            (*this).actor.speedXZ = 4.0f32
        } else if dist >= 70.0f32 {
            newAnimationIdx = 2 as libc::c_int;
            (*this).actor.speedXZ = 2.0f32;
            (*this).unk_1F0 = 0 as libc::c_int
        } else { func_80A6A4DC(this); return }
        if (*this).animationIdx != newAnimationIdx {
            (*this).animationIdx = newAnimationIdx;
            Animation_Change(&mut (*this).skin.skelAnime,
                             sAnimations[(*this).animationIdx as usize],
...
static mut sActionFuncs: [EnHorseLinkChildActionFunc; 6] =
    unsafe {
        [Some(func_80A698F4 as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A69C18 as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A699FC as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A6A068 as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A6A7D0 as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A6A5A4 as
                  unsafe extern "C" fn(_: *mut EnHorseLinkChild,
                                       _: *mut GlobalContext) -> ())]
    };
static mut sEyeTextures: [*mut libc::c_void; 3] =
    unsafe {
        [gChildEponaEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
         gChildEponaEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
         gChildEponaEyeCloseTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sEyeIndexOrder: [u8_0; 4] =
    [0 as libc::c_int as u8_0, 1 as libc::c_int as u8_0,
     2 as libc::c_int as u8_0, 1 as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn EnHorseLinkChild_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut EnHorseLinkChild = thisx as *mut EnHorseLinkChild;
    let mut pad: s32 = 0;
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 55.0f32,
    ...
    if Rand_ZeroOne() < 0.025f32 &&
           (*this).eyeTexIndex as libc::c_int == 0 as libc::c_int {
        (*this).eyeTexIndex = (*this).eyeTexIndex.wrapping_add(1)
    } else if (*this).eyeTexIndex as libc::c_int > 0 as libc::c_int {
        (*this).eyeTexIndex = (*this).eyeTexIndex.wrapping_add(1);
        if (*this).eyeTexIndex as libc::c_int >=
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6ABF8(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6AD84(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32, mut arg3: *mut PSkinAwb)
 -> s32 {
    let mut this: *mut EnHorseLinkChild = thisx as *mut EnHorseLinkChild;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_horse_link_child.c\x00" as *const u8 as
                        *const libc::c_char, 1467 as libc::c_int);
    if arg2 == 0xd as libc::c_int {
        let mut index: u8_0 = sEyeIndexOrder[(*this).eyeTexIndex as usize];
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((sEyeTextures[index as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(sEyeTextures[index as usize] as
                                                  u32_0 &
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_horse_link_child.c\x00" as *const u8 as
                         *const libc::c_char, 1479 as libc::c_int);
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseLinkChild_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut EnHorseLinkChild = thisx as *mut EnHorseLinkChild;
    func_80093D18((*globalCtx).state.gfxCtx);
    func_800A6360(&mut (*this).actor, globalCtx, &mut (*this).skin,
                  Some(func_80A6ABF8 as
                           unsafe extern "C" fn(_: *mut Actor,
                                                _: *mut GlobalContext,
                                                _: *mut PSkinAwb) -> ()),
                  Some(func_80A6AD84 as
                           unsafe extern "C" fn(_: *mut Actor,
