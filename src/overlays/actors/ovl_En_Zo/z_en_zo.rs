...
extern "C" {
    ...
    #[no_mangle]
    static mut gZoraHandsOnHipsTappingFootAnim: AnimationHeader;
    #[no_mangle]
    static mut gZoraOpenArmsAnim: AnimationHeader;
    #[no_mangle]
    static mut gZoraThrowRupeesAnim: AnimationHeader;
    #[no_mangle]
    static mut gZoraBubblesMaterialDL: [Gfx; 0];
    #[no_mangle]
    static mut gZoraBubblesModelDL: [Gfx; 0];
    #[no_mangle]
    static mut gZoraSplashesMaterialDL: [Gfx; 0];
    #[no_mangle]
    static mut gZoraSplashesModelDL: [Gfx; 0];
    #[no_mangle]
    static mut gZoraSurfaceAnim: AnimationHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gZoraRipplesMaterialDL: [Gfx; 0];
    #[no_mangle]
    static mut gZoraRipplesModelDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnZoEffect {
    pub type_0: u8_0,
    pub scale: f32_0,
    pub targetScale: f32_0,
...
pub type EnZoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const ENZO_EFFECT_BUBBLE: C2RustUnnamed_24 = 3;
pub const ENZO_EFFECT_SPLASH: C2RustUnnamed_24 = 2;
pub const ENZO_EFFECT_RIPPLE: C2RustUnnamed_24 = 1;
pub const ENZO_EFFECT_NONE: C2RustUnnamed_24 = 0;
#[no_mangle]
pub unsafe extern "C" fn EnZo_Ripple(mut this: *mut EnZo, mut pos: *mut Vec3f,
                                     mut scale: f32_0, mut targetScale: f32_0,
                                     mut alpha: u8_0) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut vec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut i: s16 = 0;
    effect = (*this).effects.as_mut_ptr();
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnZoEffect; 15]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnZoEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*effect).type_0 as libc::c_int == ENZO_EFFECT_NONE as libc::c_int
           {
            (*effect).type_0 = ENZO_EFFECT_RIPPLE as libc::c_int as u8_0;
            (*effect).pos = *pos;
            (*effect).scale = scale;
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Bubble(mut this: *mut EnZo,
                                     mut pos: *mut Vec3f) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut vec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        ...
        if (*effect).type_0 as libc::c_int == ENZO_EFFECT_NONE as libc::c_int
           {
            ...
            if !(waterSurface <= (*pos).y) {
                (*effect).type_0 = ENZO_EFFECT_BUBBLE as libc::c_int as u8_0;
                (*effect).pos = *pos;
                (*effect).vec = *pos;
                (*effect).vel = vel;
                (*effect).scale =
                    (Rand_ZeroOne() - 0.5f32) * 0.02f32 + 0.12f32;
                break ;
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Splash(mut this: *mut EnZo, mut pos: *mut Vec3f,
                                     mut vel: *mut Vec3f, mut scale: f32_0) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -1.0f32, z: 0.0f32,}; init };
    let mut i: s16 = 0;
    ...
    while (i as libc::c_int) <
        ...
        if (*effect).type_0 as libc::c_int !=
               ENZO_EFFECT_SPLASH as libc::c_int {
            (*effect).type_0 = ENZO_EFFECT_SPLASH as libc::c_int as u8_0;
            (*effect).pos = *pos;
            (*effect).vec = accel;
            (*effect).vel = *vel;
            (*effect).color.a =
                (Rand_ZeroOne() * 100.0f32 + 100.0f32) as u8_0;
            (*effect).scale = scale;
            break ;
        } else { effect = effect.offset(1); i += 1 }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_UpdateRipples(mut this: *mut EnZo) {
    let mut effect: *mut EnZoEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnZoEffect; 15]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnZoEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*effect).type_0 as libc::c_int ==
               ENZO_EFFECT_RIPPLE as libc::c_int {
            Math_ApproachF(&mut (*effect).scale, (*effect).targetScale,
                           0.2f32, 0.8f32);
            if (*effect).color.a as libc::c_int > 20 as libc::c_int {
                (*effect).color.a =
                    ((*effect).color.a as libc::c_int - 20 as libc::c_int) as
                        u8_0
            } else { (*effect).color.a = 0 as libc::c_int as u8_0 }
            if (*effect).color.a as libc::c_int == 0 as libc::c_int {
                (*effect).type_0 = ENZO_EFFECT_NONE as libc::c_int as u8_0
            }
        }
        effect = effect.offset(1);
        i += 1
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_UpdateBubbles(mut this: *mut EnZo) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut waterSurface: f32_0 = 0.;
    let mut i: s16 = 0;
    effect = (*this).effects.as_mut_ptr();
    ...
    while (i as libc::c_int) <
              (::std::mem::size_of::<[EnZoEffect; 15]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<EnZoEffect>()
                                                   as libc::c_ulong) as s32 {
        if (*effect).type_0 as libc::c_int ==
               ENZO_EFFECT_BUBBLE as libc::c_int {
            (*effect).pos.x =
                Rand_ZeroOne() * 0.5f32 - 0.25f32 + (*effect).vec.x;
            (*effect).pos.z =
                Rand_ZeroOne() * 0.5f32 - 0.25f32 + (*effect).vec.z;
            ...
            if waterSurface <= (*effect).pos.y {
                ...
                EnZo_Ripple(this, &mut (*effect).pos, 0.06f32, 0.12f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_UpdateSplashes(mut this: *mut EnZo) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut waterSurface: f32_0 = 0.;
    let mut i: s16 = 0;
    effect = (*this).effects.as_mut_ptr();
    ...
    while (i as libc::c_int) <
        ...
        if (*effect).type_0 as libc::c_int ==
            ...
            } else { (*effect).vel.y = -20.0f32; (*effect).vec.y = 0.0f32 }
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_DrawRipples(mut this: *mut EnZo,
                                          mut globalCtx: *mut GlobalContext) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut i: s16 = 0;
    let mut setup: u8_0 = 0;
    effect = (*this).effects.as_mut_ptr();
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_zo_eff.c\x00" as *const u8 as
                        *const libc::c_char, 217 as libc::c_int);
    setup = 0 as libc::c_int as u8_0;
                ...
                (*_g_0).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_0).words.w1 =
                    gZoraRipplesMaterialDL.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gZoraRipplesModelDL.as_mut_ptr() as libc::c_uint
        }
        effect = effect.offset(1);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_DrawBubbles(mut this: *mut EnZo,
                                          mut globalCtx: *mut GlobalContext) {
    let mut effect: *mut EnZoEffect = (*this).effects.as_mut_ptr();
    let mut i: s16 = 0;
    let mut setup: u8_0 = 0;
                ...
                (*_g).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g).words.w1 =
                    gZoraBubblesMaterialDL.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gZoraBubblesModelDL.as_mut_ptr() as libc::c_uint
        }
        effect = effect.offset(1);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_DrawSplashes(mut this: *mut EnZo,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut effect: *mut EnZoEffect = 0 as *mut EnZoEffect;
    let mut i: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_zo_eff.c\x00" as *const u8 as
                        *const libc::c_char, 298 as libc::c_int);
    setup = 0 as libc::c_int as u8_0;
    func_80093D84((*globalCtx).state.gfxCtx);
    i = 0 as libc::c_int as s16;
    while (i as libc::c_int) <
                ...
                (*_g).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g).words.w1 =
                    gZoraSplashesMaterialDL.as_mut_ptr() as libc::c_uint;
            ...
            (*_g_4).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_4).words.w1 =
                gZoraSplashesModelDL.as_mut_ptr() as libc::c_uint
        }
        effect = effect.offset(1);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_TreadWaterRipples(mut this: *mut EnZo,
                                                mut scale: f32_0,
                                                mut targetScale: f32_0,
                                                mut alpha: u8_0) {
    let mut pos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    ...
    EnZo_Ripple(this, &mut pos, scale, targetScale, alpha);
}
...
#[no_mangle]
pub static mut En_Zo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ZO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnZo>() as libc::c_ulong,
                          init:
    ...
    unsafe {
        [{
         ...
         },
         {
             let mut init =
                 struct_80034EC0_Entry{animation:
                                           &gZoraHandsOnHipsTappingFootAnim as
                                               *const AnimationHeader as
                                               *mut AnimationHeader,
                                       playbackSpeed: 1.0f32,
                                       startFrame: 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_SpawnSplashes(mut this: *mut EnZo) {
    ...
    i = 0 as libc::c_int; // ~pi * 2
    while i < 20 as libc::c_int {
        let mut speed: f32_0 = Rand_ZeroOne() * 1.5f32 + 0.5f32;
        let mut angle: f32_0 = Rand_ZeroOne() * 6.28f32;
        vel.y = Rand_ZeroOne() * 3.0f32 + 3.0f32;
        ...
        EnZo_Splash(this, &mut pos, &mut vel, 0.08f32);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B61024(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> u16_0 {
    let mut textId: u16_0 = 0;
    textId = Text_GetFaceReaction(globalCtx, 29 as libc::c_int as u32_0);
    if textId as libc::c_int != 0 as libc::c_int { return textId }
    match (*thisx).params as libc::c_int & 0x3f as libc::c_int {
        8 => {
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x402a as libc::c_int as u16_0
            }
        }
        6 => { return 0x4020 as libc::c_int as u16_0 }
        7 => { return 0x4021 as libc::c_int as u16_0 }
        0 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
                   gSaveContext.inventory.questItems != 0 {
                return 0x402d as libc::c_int as u16_0
            }
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x4007 as libc::c_int as u16_0
            }
        }
        1 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
                   gSaveContext.inventory.questItems != 0 {
                return 0x402e as libc::c_int as u16_0
            }
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return if gSaveContext.infTable[18 as libc::c_int as usize] as
                              libc::c_int & 0x10 as libc::c_int != 0 {
                           0x4009 as libc::c_int
                       } else { 0x4008 as libc::c_int } as u16_0
            }
        }
        2 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                ...
                return if gSaveContext.infTable[18 as libc::c_int as usize] as
                           ...
                           0x400b as libc::c_int
                       } else { 0x402f as libc::c_int } as u16_0
            }
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x400a as libc::c_int as u16_0
            }
        }
        3 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x400c as libc::c_int as u16_0
            }
        }
        4 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                ...
                return 0x4010 as libc::c_int as u16_0
            }
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x400f as libc::c_int as u16_0
            }
        }
        5 => {
            if gBitFlags[QUEST_ZORA_SAPPHIRE as libc::c_int as usize] &
            ...
            if gSaveContext.eventChkInf[3 as libc::c_int as usize] as
                   libc::c_int & 1 as libc::c_int != 0 {
                return 0x4011 as libc::c_int as u16_0
            }
        }
        _ => { }
    }
    return 0x4006 as libc::c_int as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80B61298(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor) -> s16 {
    match Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int {
        0 | 1 | 3 | 6 | 7 | 8 | 9 => { return 1 as libc::c_int as s16 }
        2 => {
            match (*thisx).textId as libc::c_int {
                16416 | 16417 => { return 0 as libc::c_int as s16 }
                16392 => {
                    gSaveContext.infTable[18 as libc::c_int as usize] =
                        (gSaveContext.infTable[18 as libc::c_int as usize] as
        ...
        4 => {
            match Message_ShouldAdvance(globalCtx) as libc::c_int {
                0 => { return 1 as libc::c_int as s16 }
                _ => {
                    if (*thisx).textId as libc::c_int == 0x400c as libc::c_int
                       {
                        (*thisx).textId =
                            if (*globalCtx).msgCtx.choiceIndex as libc::c_int
                                   == 0 as libc::c_int {
                                0x400d as libc::c_int
                            } else { 0x400e as libc::c_int } as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Blink(mut this: *mut EnZo) {
    if (if (*this).blinkTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).blinkTimer -= 1; (*this).blinkTimer as libc::c_int })
           == 0 as libc::c_int {
        (*this).eyeTexture += 1;
        if (*this).eyeTexture as libc::c_int >= 3 as libc::c_int {
            (*this).blinkTimer =
                Rand_S16Offset(30 as libc::c_int as s16,
                               30 as libc::c_int as s16);
            (*this).eyeTexture = 0 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_Dialog(mut this: *mut EnZo,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actionFunc ==
           Some(EnZo_Standing as
                    unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext)
                        -> ()) {
    ...
    } else { (*this).unk_194.unk_18.y = (*this).actor.world.pos.y }
    func_80034A14(&mut (*this).actor, &mut (*this).unk_194,
                  11 as libc::c_int as s16, (*this).unk_64C);
    if (*this).canSpeak as libc::c_int == 1 as libc::c_int {
        func_800343CC(globalCtx, &mut (*this).actor,
                      &mut (*this).unk_194.unk_00, (*this).dialogRadius,
                      Some(func_80B61024 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> u16_0),
                      Some(func_80B61298 as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: *mut Actor) -> s16));
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_PlayerInProximity(mut this: *mut EnZo,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut surfacePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut yDist: f32_0 = 0.;
    let mut hDist: f32_0 = 0.;
    ...
    hDist =
        Math_Vec3f_DistXZ(&mut surfacePos, &mut (*player).actor.world.pos);
    yDist = fabsf((*player).actor.world.pos.y - surfacePos.y);
    if hDist < 240.0f32 && yDist < 80.0f32 { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_SetAnimation(mut this: *mut EnZo) {
    let mut animId: s32 = 8 as libc::c_int;
    if (*this).skelAnime.animation ==
           &mut gZoraHandsOnHipsTappingFootAnim as *mut AnimationHeader as
               *mut libc::c_void ||
           (*this).skelAnime.animation ==
               &mut gZoraOpenArmsAnim as *mut AnimationHeader as
                   *mut libc::c_void {
        if (*this).unk_194.unk_00 as libc::c_int == 0 as libc::c_int {
            if (*this).actionFunc ==
                   Some(EnZo_Standing as
                            unsafe extern "C" fn(_: *mut EnZo,
                                                 _: *mut GlobalContext) -> ())
               {
                animId = 0 as libc::c_int
            } else { animId = 3 as libc::c_int }
        }
    }
    if (*this).unk_194.unk_00 as libc::c_int != 0 as libc::c_int &&
           (*this).actor.textId as libc::c_int == 0x4006 as libc::c_int &&
           (*this).skelAnime.animation !=
               &mut gZoraHandsOnHipsTappingFootAnim as *mut AnimationHeader as
                   *mut libc::c_void {
        animId = 6 as libc::c_int
    }
    if (*this).unk_194.unk_00 as libc::c_int != 0 as libc::c_int &&
           (*this).actor.textId as libc::c_int == 0x4007 as libc::c_int &&
           (*this).skelAnime.animation !=
               &mut gZoraOpenArmsAnim as *mut AnimationHeader as
                   *mut libc::c_void {
        animId = 7 as libc::c_int
    }
    if animId != 8 as libc::c_int {
        func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                      animId);
        if animId == 3 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZo = thisx as *mut EnZo;
    ...
    CollisionCheck_SetInfo2(&mut (*this).actor.colChkInfo,
                            0 as *mut DamageTable, &mut sColChkInit);
    if gSaveContext.linkAge == 0 as libc::c_int &&
    ...
    (*this).dialogRadius =
        (*this).collider.dim.radius as libc::c_int as libc::c_float + 30.0f32;
    (*this).unk_64C = 1 as libc::c_int as s16;
    (*this).canSpeak = 0 as libc::c_int as u8_0;
    (*this).unk_194.unk_00 = 0 as libc::c_int as s16;
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor,
                            (*this).collider.dim.height as libc::c_int as
                                libc::c_float * 0.5f32,
                            (*this).collider.dim.radius as f32_0, 0.0f32,
                            5 as libc::c_int);
    if (*this).actor.yDistToWater < 54.0f32 ||
           (*this).actor.params as libc::c_int & 0x3f as libc::c_int ==
               8 as libc::c_int {
        (*this).actor.shape.shadowDraw =
            Some(ActorShadow_DrawCircle as
                     unsafe extern "C" fn(_: *mut Actor, _: *mut Lights,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.shape.shadowScale = 24.0f32;
        func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                      1 as libc::c_int);
        (*this).canSpeak = 1 as libc::c_int as u8_0;
        (*this).alpha = 255.0f32;
        (*this).actionFunc =
            Some(EnZo_Standing as
                     unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext)
        ...
        (*this).actionFunc =
            Some(EnZo_Submerged as
                     unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext)
                         -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
}
// Actions
#[no_mangle]
pub unsafe extern "C" fn EnZo_Standing(mut this: *mut EnZo,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angle: s16 = 0;
    func_80034F54(globalCtx, (*this).unk_656.as_mut_ptr(),
                  (*this).unk_67E.as_mut_ptr(), 20 as libc::c_int);
    EnZo_SetAnimation(this);
    if (*this).unk_194.unk_00 as libc::c_int != 0 as libc::c_int {
        (*this).unk_64C = 4 as libc::c_int as s16;
        return
    }
    angle =
        if ((*this).actor.yawTowardsPlayer as f32_0 -
                (*this).actor.shape.rot.y as f32_0) as s16 as libc::c_int >=
               0 as libc::c_int {
    ...
    if (angle as libc::c_int) < 0x4718 as libc::c_int {
        if EnZo_PlayerInProximity(this, globalCtx) != 0 {
            (*this).unk_64C = 2 as libc::c_int as s16
        } else { (*this).unk_64C = 1 as libc::c_int as s16 }
    } else { (*this).unk_64C = 1 as libc::c_int as s16 };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_Submerged(mut this: *mut EnZo,
                                        mut globalCtx: *mut GlobalContext) {
    if EnZo_PlayerInProximity(this, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnZo_Surface as
                     unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext)
                         -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Surface(mut this: *mut EnZo,
                                      mut globalCtx: *mut GlobalContext) {
    if (*this).actor.yDistToWater < 54.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2808 as libc::c_int as u16_0);
        ...
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(EnZo_TreadWater as
                     unsafe extern "C" fn(_: *mut EnZo, _: *mut GlobalContext)
                         -> ());
        (*this).actor.velocity.y = 0.0f32;
        (*this).alpha = 255.0f32
    } else if (*this).actor.yDistToWater < 80.0f32 {
        Math_ApproachF(&mut (*this).actor.velocity.y, 2.0f32, 0.4f32, 0.6f32);
        Math_ApproachF(&mut (*this).alpha, 255.0f32, 0.3f32, 10.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_TreadWater(mut this: *mut EnZo,
                                         mut globalCtx: *mut GlobalContext) {
    func_80034F54(globalCtx, (*this).unk_656.as_mut_ptr(),
                  (*this).unk_67E.as_mut_ptr(), 20 as libc::c_int);
    ...
    EnZo_SetAnimation(this);
    Math_ApproachF(&mut (*this).actor.velocity.y,
                   if (*this).actor.yDistToWater < 54.0f32 {
                       -0.6f32
                   } else { 0.6f32 }, 0.3f32, 0.2f32);
    if (*this).rippleTimer as libc::c_int != 0 as libc::c_int {
        (*this).rippleTimer -= 1;
        if (*this).rippleTimer as libc::c_int == 3 as libc::c_int ||
               (*this).rippleTimer as libc::c_int == 6 as libc::c_int {
            EnZo_TreadWaterRipples(this, 0.2f32, 1.0f32,
                                   200 as libc::c_int as u8_0);
        }
    } else {
        EnZo_TreadWaterRipples(this, 0.2f32, 1.0f32,
                               200 as libc::c_int as u8_0);
        (*this).rippleTimer = 12 as libc::c_int as s16
    }
    if EnZo_PlayerInProximity(this, globalCtx) != 0 as libc::c_int {
        (*this).timeToDive =
            Rand_S16Offset(40 as libc::c_int as s16, 40 as libc::c_int as s16)
    } else if (if (*this).timeToDive as libc::c_int == 0 as libc::c_int {
                   0 as libc::c_int
               } else {
                   (*this).timeToDive -= 1;
                   (*this).timeToDive as libc::c_int
               }) == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Dive(mut this: *mut EnZo,
                                   mut globalCtx: *mut GlobalContext) {
    if Animation_OnFrame(&mut (*this).skelAnime, (*this).skelAnime.endFrame)
           != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2809 as libc::c_int as u16_0);
        EnZo_SpawnSplashes(this);
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actor.velocity.y = -4.0f32;
    ...
    if (*this).skelAnime.playSpeed > 0.0f32 { return }
    if (*this).actor.yDistToWater > 80.0f32 ||
           (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_ApproachF(&mut (*this).actor.velocity.y, -1.0f32, 0.4f32,
                       0.6f32);
        Math_ApproachF(&mut (*this).alpha, 0.0f32, 0.3f32, 10.0f32);
    }
    if (*this).alpha as s16 as libc::c_int == 0 as libc::c_int {
        func_80034EC0(&mut (*this).skelAnime, sAnimations.as_mut_ptr(),
                      2 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZo = thisx as *mut EnZo;
    let mut pad: u32_0 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).alpha as s32 != 0 as libc::c_int {
        SkelAnime_Update(&mut (*this).skelAnime);
        EnZo_Blink(this);
    }
    Actor_MoveForward(thisx);
    Actor_UpdateBgCheckInfo(globalCtx, thisx,
                            (*this).collider.dim.radius as f32_0,
                            (*this).collider.dim.height as libc::c_int as
                                libc::c_float * 0.25f32, 0.0f32,
                            5 as libc::c_int);
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    EnZo_Dialog(this, globalCtx);
    // Spawn air bubbles
    if (*globalCtx).state.frames & 8 as libc::c_int as libc::c_uint != 0 {
        pos = (*this).actor.world.pos;
        pos.y += (Rand_ZeroOne() - 0.5f32) * 10.0f32 + 18.0f32;
        pos.x += (Rand_ZeroOne() - 0.5f32) * 28.0f32;
        pos.z += (Rand_ZeroOne() - 0.5f32) * 28.0f32;
        EnZo_Bubble(this, &mut pos);
    }
    if (*this).alpha as s32 != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnZo_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 15 as libc::c_int {
        Matrix_Translate(1800.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    if limbIndex == 8 as libc::c_int || limbIndex == 9 as libc::c_int ||
        ...
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*this).unk_656[limbIndex as usize]) * 200.0f32) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*this).unk_67E[limbIndex as usize]) * 200.0f32) as
                s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void,
    ...
    let mut this: *mut EnZo = thisx as *mut EnZo;
    let mut vec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 600.0f32, z: 0.0f32,}; init };
    if limbIndex == 15 as libc::c_int {
        Matrix_MultVec3f(&mut vec, &mut (*this).actor.focus.pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnZo_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnZo = thisx as *mut EnZo;
    let mut eyeTextures: [*mut libc::c_void; 3] =
        [gZoraEyeOpenTex.as_mut_ptr() as *mut libc::c_void,
         gZoraEyeHalfTex.as_mut_ptr() as *mut libc::c_void,
         gZoraEyeClosedTex.as_mut_ptr() as *mut libc::c_void];
    Matrix_Push();
    ...
    if (*this).alpha as s32 != 0 as libc::c_int {
        ...
        __gfxCtx = (*globalCtx).state.gfxCtx;
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_zo.c\x00" as *const u8 as
                            *const libc::c_char, 1008 as libc::c_int);
        if (*this).alpha == 255.0f32 {
            ...
            (*_g).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g).words.w1 =
                gSegments[((eyeTextures[(*this).eyeTexture as usize] as u32_0)
                               << 4 as libc::c_int >> 28 as libc::c_int) as
                              usize].wrapping_add(eyeTextures[(*this).eyeTexture
                                                                  as usize] as
                                                      u32_0 &
        ...
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_zo.c\x00" as *const u8 as
                             *const libc::c_char, 1025 as libc::c_int);
    };
}
