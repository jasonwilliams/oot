...
extern "C" {
    ...
    #[no_mangle]
    static mut gBotwCoffinLidDL: [Gfx; 0];
    #[no_mangle]
    static mut gBotwCoffinLidCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHakaHuta {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgHakaHutaActionFunc,
    pub counter: s16,
    pub unk_16A: s16,
}
pub type BgHakaHutaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHakaHuta, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Haka_Huta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HAKA_HUTA as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaHuta_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaHuta_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaHuta_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHakaHuta_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgHakaHuta = thisx as *mut BgHakaHuta;
    let mut pad: s16 = 0;
    ...
    CollisionHeader_GetVirtual(&mut gBotwCoffinLidCol as *mut CollisionHeader
    ...
    if Flags_GetSwitch(globalCtx, (*thisx).params as s32) != 0 {
        (*this).counter = -(1 as libc::c_int) as s16;
        (*this).actionFunc =
            Some(func_8087D720 as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(BgHakaHuta_SpawnEnemies as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgHakaHuta = thisx as *mut BgHakaHuta;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_SpawnDust(mut this: *mut BgHakaHuta,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut sEffectAccel: [Vec3f; 1] =
    ...
    let mut i: s32 = 0;
    let mut new_Xpos: f32_0 = 0.;
    let mut xPosOffset: f32_0 = 0.;
    phi_f20 =
        if (*this).dyna.actor.world.rot.y as libc::c_int == 0 as libc::c_int {
            1.0f32
        } else { -1.0f32 };
    effectVel.y = 0.0f32;
    effectVel.z = 0.0f32;
    effectVel.x = -0.5f32 * phi_f20;
    ...
    while i < 4 as libc::c_int {
        if i == 2 as libc::c_int { effectPos.z += 120.0f32 * phi_f20 }
        effectPos.x =
            (*this).dyna.actor.home.pos.x - Rand_ZeroOne() * xPosOffset;
        scale = Rand_ZeroOne() * 10.0f32 + 50.0f32;
        func_8002829C(globalCtx, &mut effectPos, &mut effectVel,
                      sEffectAccel.as_mut_ptr(), &mut primColor,
                      &mut envColor, scale as s16, 0xa as libc::c_int as s16);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_PlaySound(mut this: *mut BgHakaHuta,
                                              mut globalCtx:
                                                  *mut GlobalContext,
                                              mut sfx: u16_0) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    pos.z =
        if (*this).dyna.actor.shape.rot.y as libc::c_int == 0 as libc::c_int {
            ((*this).dyna.actor.world.pos.z) + 120.0f32
        } else { ((*this).dyna.actor.world.pos.z) - 120.0f32 };
    pos.x = (*this).dyna.actor.world.pos.x;
    pos.y = (*this).dyna.actor.world.pos.y;
    Audio_PlaySoundAtPosition(globalCtx, &mut pos, 30 as libc::c_int, sfx);
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_SpawnEnemies(mut this: *mut BgHakaHuta,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).dyna.actor.params as s32) != 0 &&
           Player_InCsMode(globalCtx) == 0 {
        (*this).counter = 25 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgHakaHuta_Open as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 6001 as libc::c_int as s16,
                              999 as libc::c_int as s16,
                              &mut (*this).dyna.actor,
                              0 as libc::c_int as s16);
        if (*this).unk_16A as libc::c_int == 2 as libc::c_int {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        (*this).dyna.actor.world.pos.z -
                            -25.0f32 *
                                Math_SinS((*this).dyna.actor.shape.rot.y) +
                            Math_CosS((*this).dyna.actor.shape.rot.y) *
                                40.0f32, 0 as libc::c_int as s16,
            ...
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ...
                        (*this).dyna.actor.world.pos.z -
                            -25.0f32 *
                                Math_SinS((*this).dyna.actor.shape.rot.y) +
                            Math_CosS((*this).dyna.actor.shape.rot.y) *
                                80.0f32, 0 as libc::c_int as s16,
                        (*this).dyna.actor.shape.rot.y,
                        0 as libc::c_int as s16, 2 as libc::c_int as s16);
        } else if (*this).unk_16A as libc::c_int == 1 as libc::c_int {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_RD as libc::c_int as s16,
                        ...
                        (*this).dyna.actor.home.pos.z -
                            -25.0f32 *
                                Math_SinS((*this).dyna.actor.shape.rot.y) +
                            Math_CosS((*this).dyna.actor.shape.rot.y) *
                                100.0f32, 0 as libc::c_int as s16,
                        (*this).dyna.actor.shape.rot.y,
                        0 as libc::c_int as s16, 0xfd as libc::c_int as s16);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_Open(mut this: *mut BgHakaHuta,
                                         mut globalCtx: *mut GlobalContext) {
    let mut posOffset: f32_0 = 0.;
    ...
    Math_StepToF(&mut (*this).dyna.actor.world.pos.x,
                 (*this).dyna.actor.home.pos.x + posOffset, 2.0f32);
    if (*this).counter as libc::c_int == 0 as libc::c_int {
        (*this).counter = 37 as libc::c_int as s16;
        BgHakaHuta_PlaySound(this, globalCtx, 0x2855 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(BgHakaHuta_SlideOpen as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_SlideOpen(mut this: *mut BgHakaHuta,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut posOffset: f32_0 = 0.;
    if (*this).counter as libc::c_int != 0 as libc::c_int {
    ...
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.x,
                    (*this).dyna.actor.home.pos.x + posOffset, 0.5f32) == 0 {
        BgHakaHuta_SpawnDust(this, globalCtx);
    }
    if (*this).counter as libc::c_int == 0 as libc::c_int {
        BgHakaHuta_PlaySound(this, globalCtx, 0x2856 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(func_8087D720 as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_8087D720(mut this: *mut BgHakaHuta,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_8087D958: Vec3f =
        { let mut init = Vec3f{x: 30.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut D_8087D964: Vec3f =
        {
            let mut init = Vec3f{x: 0.03258f32, y: 0.3258f32, z: -0.9449f32,};
            init
        };
    ...
    (*this).counter += 1;
    if (*this).counter as libc::c_int == 6 as libc::c_int {
        (*this).actionFunc =
            Some(BgHakaHuta_DoNothing as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ());
        quakeIndex =
        ...
        Quake_SetSpeed(quakeIndex as s16, 0x7530 as libc::c_int as s16);
        Quake_SetQuakeValues(quakeIndex as s16, 4 as libc::c_int as s16,
                             0 as libc::c_int as s16, 0 as libc::c_int as s16,
                             0 as libc::c_int as s16);
        Quake_SetCountdown(quakeIndex as s16, 2 as libc::c_int as s16);
    } else if (*this).counter as libc::c_int == 0 as libc::c_int {
        (*this).counter = 6 as libc::c_int as s16;
        (*this).actionFunc =
            Some(BgHakaHuta_DoNothing as
                     unsafe extern "C" fn(_: *mut BgHakaHuta,
                                          _: *mut GlobalContext) -> ())
    }
    D_8087D958.x = (*this).counter as libc::c_int as libc::c_float + 24.0f32;
    if D_8087D958.x > 30.0f32 { D_8087D958.x = 30.0f32 }
    Matrix_RotateY((*this).dyna.actor.world.rot.y as libc::c_int as
                       libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateAxis((*this).counter as libc::c_int as libc::c_float *
                          (191 as libc::c_int as libc::c_float *
                               3.14159265358979323846f32 /
                               3750 as libc::c_int as libc::c_float),
                      &mut D_8087D964, MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut D_8087D958, &mut vec);
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_DoNothing(mut this: *mut BgHakaHuta,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHakaHuta = thisx as *mut BgHakaHuta;
...
#[no_mangle]
pub unsafe extern "C" fn BgHakaHuta_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gBotwCoffinLidDL.as_mut_ptr());
}
