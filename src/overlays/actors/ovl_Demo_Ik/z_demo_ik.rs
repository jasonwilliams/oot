...
extern "C" {
    ...
    #[no_mangle]
    static mut object_ik_Anim_00035C: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_000380: SkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_000634: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_000660: SkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_0008DC: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_000900: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_000C6C: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_000C90: SkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_000F0C: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_000F30: FlexSkeletonHeader;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_ik_DL_017028: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_017170: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_Anim_01EB14: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_01EB40: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_01EE34: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_01EE60: FlexSkeletonHeader;
}
...
pub struct DemoIk {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 2],
    pub morphTable: [Vec3s; 2],
    pub actionMode: s32,
    pub drawMode: s32,
    pub csAction: s32,
}
pub type DemoIkActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext) -> ()>;
pub type DemoIkDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_BgCheck(mut this: *mut DemoIk,
                                        mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 30.0f32,
                            30.0f32, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_UpdateSkelAnime(mut this: *mut DemoIk)
 -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_GetCue(mut globalCtx: *mut GlobalContext,
                                       mut index: s32)
 -> *mut CsCmdActorAction {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        return (*globalCtx).csCtx.npcActions[index as usize]
    }
    return 0 as *mut CsCmdActorAction;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_CheckCue(mut globalCtx: *mut GlobalContext,
                                         mut action: u16_0, mut index: s32)
 -> s32 {
    let mut cue: *mut CsCmdActorAction = DemoIk_GetCue(globalCtx, index);
    if !cue.is_null() && (*cue).action as libc::c_int == action as libc::c_int
       {
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_SetMove(mut this: *mut DemoIk,
                                        mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_EndMove(mut this: *mut DemoIk) {
    (*this).skelAnime.moveFlags =
        ((*this).skelAnime.moveFlags as libc::c_int & !(1 as libc::c_int)) as
            u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_GetCurFrame(mut this: *mut DemoIk) -> f32_0 {
    return (*this).skelAnime.curFrame;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_SetColors(mut gfxCtx: *mut GraphicsContext,
                                          mut primR: u8_0, mut primG: u8_0,
                                          mut primB: u8_0, mut envR: u8_0,
                                          mut envG: u8_0, mut envB: u8_0)
 -> *mut Gfx {
    let mut head: *mut Gfx =
        Graph_Alloc(gfxCtx,
                    (3 as libc::c_int as
                         libc::c_uint).wrapping_mul(::std::mem::size_of::<Gfx>()
                                                        as libc::c_ulong) as
                        size_t) as *mut Gfx;
    let mut entry: *mut Gfx = head;
    let fresh0 = entry;
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_GetIndexFromParams(mut params: s32) -> s32 {
    let mut ret: s32 = 0;
    if params == 0 as libc::c_int {
        ret = 5 as libc::c_int
    } else if params == 1 as libc::c_int {
        ret = 6 as libc::c_int
    } else { ret = 7 as libc::c_int }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1PlaySound(mut this: *mut DemoIk) {
    match (*this).actor.params as libc::c_int {
        0 => {
            if Animation_OnFrame(&mut (*this).skelAnime, 5.0f32) != 0 {
                Audio_PlaySoundGeneral(0x392d as libc::c_int as u16_0,
        ...
        1 => {
            if Animation_OnFrame(&mut (*this).skelAnime, 10.0f32) != 0 {
                Audio_PlaySoundGeneral(0x392f as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
        ...
        2 => {
            if Animation_OnFrame(&mut (*this).skelAnime, 9.0f32) != 0 {
                Audio_PlaySoundGeneral(0x392e as libc::c_int as u16_0,
                                       &mut (*this).actor.projectedPos,
                                       4 as libc::c_int as u8_0,
                                       &mut D_801333E0, &mut D_801333E0,
                                       &mut D_801333E8);
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_SpawnDeadDb(mut this: *mut DemoIk,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    static mut deadDbOffsets: [Vec3f; 11] =
        [{ let mut init = Vec3f{x: -14.0f32, y: 5.0f32, z: 5.0f32,}; init },
         { let mut init = Vec3f{x: -20.0f32, y: 12.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: -5.0f32, y: 10.0f32, z: -1.0f32,}; init },
         { let mut init = Vec3f{x: -10.0f32, y: 8.0f32, z: 14.0f32,}; init },
         { let mut init = Vec3f{x: -3.0f32, y: 10.0f32, z: 7.0f32,}; init },
         { let mut init = Vec3f{x: -10.0f32, y: 11.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: 9.0f32, y: 10.0f32, z: -8.0f32,}; init },
         { let mut init = Vec3f{x: 4.0f32, y: 10.0f32, z: 3.0f32,}; init },
         { let mut init = Vec3f{x: -6.0f32, y: 13.0f32, z: -5.0f32,}; init },
         { let mut init = Vec3f{x: 1.0f32, y: 9.0f32, z: 3.0f32,}; init },
         { let mut init = Vec3f{x: -10.0f32, y: 9.0f32, z: 1.0f32,}; init }];
    let mut i: s32 = 0;
    let mut index: s32 =
        DemoIk_GetIndexFromParams((*this).actor.params as s32);
    if DemoIk_CheckCue(globalCtx, 5 as libc::c_int as u16_0, index) != 0 {
        let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut zeroVec: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut startIndex: s32 = 0;
        let mut endIndex: s32 = 0;
        if index == 5 as libc::c_int {
            startIndex = 0 as libc::c_int;
            endIndex = 4 as libc::c_int
        } else if index == 7 as libc::c_int {
            startIndex = 4 as libc::c_int;
            endIndex = 8 as libc::c_int
        } else { startIndex = 8 as libc::c_int; endIndex = 11 as libc::c_int }
        i = startIndex;
        while i < endIndex {
            pos.x = deadDbOffsets[i as usize].x + (*this).actor.world.pos.x;
            pos.y = deadDbOffsets[i as usize].y + (*this).actor.world.pos.y;
            pos.z = deadDbOffsets[i as usize].z + (*this).actor.world.pos.z;
            EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut zeroVec,
                                 &mut zeroVec, 10 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_MoveToStartPos(mut this: *mut DemoIk,
                                               mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: s32) {
    let mut cue: *mut CsCmdActorAction = DemoIk_GetCue(globalCtx, index);
    if !cue.is_null() {
        (*this).actor.world.pos.x = (*cue).startPos.x as f32_0;
        (*this).actor.world.pos.y = (*cue).startPos.y as f32_0;
        (*this).actor.world.pos.z = (*cue).startPos.z as f32_0;
        (*this).actor.shape.rot.y = (*cue).c2rust_unnamed.rot.y;
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1Init(mut this: *mut DemoIk,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut skeleton: *mut SkeletonHeader = 0 as *mut SkeletonHeader;
    let mut animation: *mut AnimationHeader = 0 as *mut AnimationHeader;
    let mut phi_f0: f32_0 = 0.;
    match (*this).actor.params as libc::c_int {
        0 => {
            skeleton = &mut object_ik_Skel_000C90;
            animation = &mut object_ik_Anim_000C6C;
            phi_f0 = 30.0f32
            // No break is required for matching
        }
        1 => {
            skeleton = &mut object_ik_Skel_000660;
            animation = &mut object_ik_Anim_000634;
            phi_f0 = 10.0f32
        }
        _ => {
            skeleton = &mut object_ik_Skel_000380;
            animation = &mut object_ik_Anim_00035C;
            phi_f0 = 20.0f32
        }
    }
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), phi_f0);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, skeleton,
                   0 as *mut AnimationHeader, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 2 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn func_8098393C(mut this: *mut DemoIk) {
    (*this).actionMode = 0 as libc::c_int;
    (*this).drawMode = 0 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_8098394C(mut this: *mut DemoIk,
                                       mut globalCtx: *mut GlobalContext) {
    DemoIk_EndMove(this);
    DemoIk_MoveToStartPos(this, globalCtx,
                          DemoIk_GetIndexFromParams((*this).actor.params as
                                                        s32));
    (*this).actionMode = 1 as libc::c_int;
    (*this).drawMode = 1 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 255 as libc::c_int as u8_0;
    (*this).skelAnime.curFrame = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_809839AC(mut this: *mut DemoIk) {
    (*this).actionMode = 2 as libc::c_int;
    (*this).drawMode = 1 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 255 as libc::c_int as u8_0;
    (*this).skelAnime.curFrame = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_809839D0(mut this: *mut DemoIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut cue: *mut CsCmdActorAction =
        DemoIk_GetCue(globalCtx,
                      DemoIk_GetIndexFromParams((*this).actor.params as s32));
    if !cue.is_null() {
        let mut nextCsAction: s32 = (*cue).action as s32;
        let mut csAction: s32 = (*this).csAction;
        if nextCsAction != csAction {
            match nextCsAction {
                1 => { func_8098393C(this); }
                2 => { func_8098394C(this, globalCtx); }
                3 => { func_809839AC(this); }
                4 => { Actor_Kill(&mut (*this).actor); }
                5 | 6 => { }
                _ => {
                    // "there is no such action"
                    osSyncPrintf(b"Demo_Ik_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1Action0(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    func_809839D0(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1Action1(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1Action2(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1PostLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
                                                  ...
                                                  mut thisx:
                                                      *mut libc::c_void) {
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_ik_inArmer.c\x00" as *const u8 as
                        *const libc::c_char, 385 as libc::c_int);
            ...
            0 => {
                ...
                (*_g).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inArmer.c\x00" as *const u8
                                      as *const libc::c_char as
                                      *mut libc::c_char, 390 as libc::c_int)
                        as libc::c_uint;
            ...
            2 => {
                ...
                (*_g_1).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inArmer.c\x00" as *const u8
                                      as *const libc::c_char as
                                      *mut libc::c_char, 396 as libc::c_int)
                        as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type1Draw(mut this: *mut DemoIk,
                                          mut globalCtx: *mut GlobalContext) {
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        DemoIk_SetColors(gfxCtx, 245 as libc::c_int as u8_0,
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        DemoIk_SetColors(gfxCtx, 255 as libc::c_int as u8_0,
    ...
    SkelAnime_DrawOpa(globalCtx, (*skelAnime).skeleton,
                      (*skelAnime).jointTable, None,
                      Some(DemoIk_Type1PostLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2Init(mut this: *mut DemoIk,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut skeleton: *mut FlexSkeletonHeader = 0 as *mut FlexSkeletonHeader;
    let mut animation: *mut AnimationHeader = 0 as *mut AnimationHeader;
    match (*this).actor.params as libc::c_int {
        3 => {
            skeleton = &mut object_ik_Skel_01EB40;
            animation = &mut object_ik_Anim_01EB14
        }
        4 => {
            skeleton = &mut object_ik_Skel_01EE60;
            animation = &mut object_ik_Anim_01EE34
        }
        5 => {
            skeleton = &mut object_ik_Skel_000F30;
            animation = &mut object_ik_Anim_000F0C
        }
        _ => {
            skeleton = &mut object_ik_Skel_000900;
            animation = &mut object_ik_Anim_0008DC
        }
    }
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, skeleton,
    ...
    Animation_Change(&mut (*this).skelAnime, animation, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(animation as *mut libc::c_void) as
                         f32_0, ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).actionMode = 3 as libc::c_int;
    (*this).drawMode = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2PlaySoundOnFrame(mut this: *mut DemoIk,
                                                      mut frame: f32_0) {
    if Animation_OnFrame(&mut (*this).skelAnime, frame) != 0 {
        Audio_PlaySoundGeneral(0x392c as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2PlaySound(mut this: *mut DemoIk) {
    match (*this).actor.params as libc::c_int {
        3 => { DemoIk_Type2PlaySoundOnFrame(this, 33.0f32); }
        5 => { DemoIk_Type2PlaySoundOnFrame(this, 44.0f32); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80983FDC(mut this: *mut DemoIk) {
    (*this).actionMode = 3 as libc::c_int;
    (*this).drawMode = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_80983FEC(mut this: *mut DemoIk,
                                       mut globalCtx: *mut GlobalContext) {
    DemoIk_MoveToStartPos(this, globalCtx, 4 as libc::c_int);
    (*this).actionMode = 4 as libc::c_int;
    (*this).drawMode = 2 as libc::c_int;
    (*this).skelAnime.curFrame = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_8098402C(mut this: *mut DemoIk) {
    (*this).actionMode = 5 as libc::c_int;
    (*this).drawMode = 2 as libc::c_int;
    (*this).skelAnime.curFrame = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn func_80984048(mut this: *mut DemoIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut cue: *mut CsCmdActorAction =
        DemoIk_GetCue(globalCtx, 4 as libc::c_int);
    if !cue.is_null() {
        let mut nextCsAction: s32 = (*cue).action as s32;
        let mut csAction: s32 = (*this).csAction;
        if nextCsAction != csAction {
            match nextCsAction {
                1 => { func_80983FDC(this); }
                5 => { func_80983FEC(this, globalCtx); }
                6 => { func_8098402C(this); }
                7 => { Actor_Kill(&mut (*this).actor); }
                _ => {
                    // "there is no such action"
                    osSyncPrintf(b"Demo_Ik_inFace_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
                                     as *const u8 as *const libc::c_char);
                }
            }
            (*this).csAction = nextCsAction
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2Action0(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    func_80984048(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2Action1(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    func_80984048(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2Action2(mut this: *mut DemoIk,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    DemoIk_UpdateSkelAnime(this);
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2OverrideLimbDraw(mut globalCtx:
                                                          *mut GlobalContext,
                                                      mut limbIndex: s32,
                                                      mut dList:
                                                          *mut *mut Gfx,
 ...
 -> s32 {
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    if limbIndex == 1 as libc::c_int && DemoIk_GetCurFrame(this) < 30.0f32 {
        *dList = 0 as *mut Gfx
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2PostLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
                                                  mut dList: *mut *mut Gfx,
                                                  mut rot: *mut Vec3s,
    ...
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut frame: f32_0 = DemoIk_GetCurFrame(this);
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_ik_inFace.c\x00" as *const u8 as
                        *const libc::c_char, 268 as libc::c_int);
    if limbIndex == 1 as libc::c_int && frame >= 30.0f32 {
        match (*this).actor.params as libc::c_int {
            3 => {
                ...
                (*_g).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inFace.c\x00" as *const u8 as
                                      ...
                                      *mut libc::c_char, 274 as libc::c_int)
                        as libc::c_uint;
                ...
                (*_g_0).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_0).words.w1 =
                    object_ik_DL_017028.as_mut_ptr() as libc::c_uint
            }
            4 => {
                ...
                (*_g_1).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inFace.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 280 as libc::c_int)
                        as libc::c_uint;
                ...
                (*_g_2).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_2).words.w1 =
                    object_ik_DL_017170.as_mut_ptr() as libc::c_uint
            }
            5 => {
                ...
                (*_g_3).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inFace.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 286 as libc::c_int)
                        as libc::c_uint;
            ...
            _ => {
                ...
                (*_g_5).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_demo_ik_inFace.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 292 as libc::c_int)
                        as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Type2Draw(mut this: *mut DemoIk,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut skelAnime: *mut SkelAnime = &mut (*this).skelAnime;
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*skelAnime).skeleton,
                          ...
                          Some(DemoIk_Type2OverrideLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3f,
                                                        ...
                                                        _: *mut libc::c_void)
                                       -> s32),
                          Some(DemoIk_Type2PostLimbDraw as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3s,
...
static mut sActionFuncs: [DemoIkActionFunc; 6] =
    unsafe {
        [Some(DemoIk_Type1Action0 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type1Action1 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type1Action2 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type2Action0 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type2Action1 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type2Action2 as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    if (*this).actionMode < 0 as libc::c_int ||
           (*this).actionMode >=
               (::std::mem::size_of::<[DemoIkActionFunc; 6]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoIkActionFunc>()
                                                    as libc::c_ulong) as s32
           || sActionFuncs[(*this).actionMode as usize].is_none() {
    ...
    sActionFuncs[(*this).actionMode as
                     usize].expect("non-null function pointer")(this,
                                                                globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn DemoIk_DrawNothing(mut this: *mut DemoIk,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
static mut sDrawFuncs: [DemoIkDrawFunc; 3] =
    unsafe {
        [Some(DemoIk_DrawNothing as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type1Draw as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ()),
         Some(DemoIk_Type2Draw as
                  unsafe extern "C" fn(_: *mut DemoIk, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    if (*this).drawMode < 0 as libc::c_int ||
           (*this).drawMode >=
               (::std::mem::size_of::<[DemoIkDrawFunc; 3]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<DemoIkDrawFunc>()
                                                    as libc::c_ulong) as s32
...
#[no_mangle]
pub static mut Demo_Ik_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_IK as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn DemoIk_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut DemoIk = thisx as *mut DemoIk;
    ...
    } else { DemoIk_Type2Init(this, globalCtx); };
}
