...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gCraterSmokeConeDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot17Funen {
    pub actor: Actor,
}
#[no_mangle]
pub static mut Bg_Spot17_Funen_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT17_FUNEN as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot17Funen>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Funen_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Funen_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot17Funen_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Funen_Init(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgSpot17Funen = thisx as *mut BgSpot17Funen;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    osSyncPrintf(b"spot17 obj. \xe5\x99\xb4\xe7\x85\x99 (arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Funen_Destroy(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot17Funen_Update(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgSpot17Funen = thisx as *mut BgSpot17Funen;
    (*this).actor.draw =
        Some(func_808B7478 as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
    (*this).actor.update =
        Some(func_808B746C as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_808B746C(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808B7478(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gCraterSmokeConeDL.as_mut_ptr() as libc::c_uint;
