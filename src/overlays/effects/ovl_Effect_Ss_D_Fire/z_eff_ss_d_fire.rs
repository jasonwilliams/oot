...
extern "C" {
    ...
    #[no_mangle]
    static mut gDodongoFire0Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDodongoFire1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDodongoFire2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDodongoFire3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDodongoFireDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut Effect_Ss_D_Fire_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_D_FIRE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDFire_Init as
 ...
 */
// has no effect due to how it's implemented
#[no_mangle]
pub unsafe extern "C" fn EffectSsDFire_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsDFireInitParams =
        initParamsx as *mut EffectSsDFireInitParams;
    let mut objBankIndex: s32 =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_DODONGO as libc::c_int as s16);
    if objBankIndex >= 0 as libc::c_int {
        (*this).pos = (*initParams).pos;
        (*this).velocity = (*initParams).velocity;
        (*this).accel = (*initParams).accel;
        (*this).gfx =
            gSegments[((gDodongoFireDL.as_mut_ptr() as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(gDodongoFireDL.as_mut_ptr() as
                                                  u32_0 &
        ...
        (*this).draw =
            Some(EffectSsDFire_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsDFire_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).regs[1 as libc::c_int as usize] =
            ((*globalCtx).state.frames.wrapping_rem(4 as libc::c_int as
                                                        libc::c_uint) as s16
                 as libc::c_int ^ 3 as libc::c_int) as s16;
        (*this).regs[2 as libc::c_int as usize] = 255 as libc::c_int as s16;
        (*this).regs[3 as libc::c_int as usize] = 255 as libc::c_int as s16;
        (*this).regs[4 as libc::c_int as usize] = 50 as libc::c_int as s16;
        (*this).regs[5 as libc::c_int as usize] = (*initParams).alpha;
        (*this).regs[6 as libc::c_int as usize] = (*initParams).fadeDelay;
        return 1 as libc::c_int as u32_0
    }
    return 0 as libc::c_int as u32_0;
}
static mut sTextures: [*mut libc::c_void; 4] =
    unsafe {
        [gDodongoFire0Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDodongoFire1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDodongoFire2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDodongoFire3Tex.as_ptr() as *mut _ as *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EffectSsDFire_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_d_fire.c\x00" as *const u8 as
    ...
    if Object_GetIndex(&mut (*globalCtx).objectCtx,
        ...
        SkinMatrix_MtxFMtxFMult(&mut mfTrans, &mut (*globalCtx).billboardMtxF,
                                &mut mfTrans11DA0);
        SkinMatrix_MtxFMtxFMult(&mut mfTrans11DA0, &mut mfScale,
                                &mut mfResult);
            ...
            (*_g_3).words.w0 =
                (0xdb as libc::c_int as u32_0 &
                    ...
                    ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                gSegments[((sTextures[(*this).regs[1 as libc::c_int as usize]
                                          as usize] as u32_0) <<
                               4 as libc::c_int >> 28 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDFire_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
