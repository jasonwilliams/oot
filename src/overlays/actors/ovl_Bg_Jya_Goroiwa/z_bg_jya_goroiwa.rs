...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaGoroiwa {
    pub actor: Actor,
    pub actionFunc: BgJyaGoroiwaFunc,
    pub collider: ColliderJntSph,
    pub colliderItem: ColliderJntSphElement,
    pub speedFactor: f32_0,
    pub hasHit: s16,
    pub waitTimer: s16,
    pub yOffsetSpeed: f32_0,
}
pub type BgJyaGoroiwaFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaGoroiwa, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Jya_Goroiwa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_GOROIWA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgJyaGoroiwa>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaGoroiwa_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaGoroiwa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaGoroiwa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaGoroiwa_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_UpdateCollider(mut this:
                                                         *mut BgJyaGoroiwa) {
    ...
    (*worldSphere).center.y = ((*this).actor.world.pos.y + 59.5f32) as s16;
    (*worldSphere).center.z = (*this).actor.world.pos.z as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_InitCollider(mut this:
                                                       *mut BgJyaGoroiwa,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_UpdateRotation(mut this:
                                                         *mut BgJyaGoroiwa) {
    let mut xDiff: f32_0 =
        (*this).actor.world.pos.x - (*this).actor.prevPos.x;
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_float -
             0x10000 as libc::c_int as libc::c_float /
                 (119 as libc::c_int as libc::c_float *
                      3.14159265358979323846f32) * xDiff) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgJyaGoroiwa = thisx as *mut BgJyaGoroiwa;
    ...
    ActorShape_Init(&mut (*this).actor.shape, 595.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgJyaGoroiwa = thisx as *mut BgJyaGoroiwa;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_SetupMove(mut this: *mut BgJyaGoroiwa) {
    (*this).actionFunc =
        Some(BgJyaGoroiwa_Move as
                 unsafe extern "C" fn(_: *mut BgJyaGoroiwa,
                                      _: *mut GlobalContext) -> ());
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).hasHit = 0 as libc::c_int as s16;
    (*this).speedFactor = 1.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Move(mut this: *mut BgJyaGoroiwa,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).actor;
    let mut relYawTowardsPlayer: s16 = 0;
    let mut speedXZsqBase: f32_0 =
        (-100.0f32 - (*thisx).world.pos.y) * 2.5f32;
    let mut posYfac: f32_0 = 0.;
    if speedXZsqBase < 0.01f32 { speedXZsqBase = 0.01f32 }
    ...
    if (*thisx).world.pos.x > 1466.0f32 && (*thisx).world.pos.x < 1673.0f32 {
        (*thisx).world.pos.y = -129.5f32
    } else {
        posYfac = 1569.0f32 - (*thisx).world.pos.x;
        posYfac = fabsf(posYfac) - 103.0f32;
        (*thisx).world.pos.y = 35.0f32 / 92.0f32 * posYfac - 129.5f32
    }
    if (*this).collider.base.atFlags as libc::c_int &
        ...
        if relYawTowardsPlayer as libc::c_int > -(0x4000 as libc::c_int) &&
               (relYawTowardsPlayer as libc::c_int) < 0x4000 as libc::c_int {
            (*thisx).world.rot.y =
                ((*thisx).world.rot.y as libc::c_int + 0x8000 as libc::c_int)
                    as s16
        }
        func_8002F6D4(globalCtx, thisx, 2.0f32, (*thisx).yawTowardsPlayer,
                      0.0f32, 0 as libc::c_int as u32_0);
        ...
        (*this).yOffsetSpeed = 10.0f32;
        (*this).speedFactor = 0.5f32;
        (*this).hasHit = 1 as libc::c_int as s16
    }
    if (*this).hasHit != 0 {
        (*this).yOffsetSpeed -= 1.5f32;
        (*thisx).shape.yOffset += (*this).yOffsetSpeed * 10.0f32;
        if (*thisx).shape.yOffset < 595.0f32 {
            (*thisx).shape.yOffset = 595.0f32;
            BgJyaGoroiwa_SetupWait(this);
        }
    } else { Math_StepToF(&mut (*this).speedFactor, 1.0f32, 0.04f32); }
    if (*thisx).world.pos.x > 1745.0f32 {
        (*thisx).world.rot.y = -(0x4000 as libc::c_int) as s16
    } else if (*thisx).world.pos.x < 1393.0f32 {
        (*thisx).world.rot.y = 0x4000 as libc::c_int as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_SetupWait(mut this: *mut BgJyaGoroiwa) {
    (*this).actionFunc =
        Some(BgJyaGoroiwa_Wait as
                 unsafe extern "C" fn(_: *mut BgJyaGoroiwa,
                                      _: *mut GlobalContext) -> ());
    (*this).waitTimer = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Wait(mut this: *mut BgJyaGoroiwa,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).waitTimer += 1;
    if (*this).waitTimer as libc::c_int > 60 as libc::c_int {
        BgJyaGoroiwa_SetupMove(this);
        (*this).speedFactor = 0.1f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgJyaGoroiwa = thisx as *mut BgJyaGoroiwa;
    ...
    if (*player).stateFlags1 & 0x300000c0 as libc::c_int as libc::c_uint == 0
       {
        ...
        pos.y = (*this).actor.world.pos.y + 59.5f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaGoroiwa_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
