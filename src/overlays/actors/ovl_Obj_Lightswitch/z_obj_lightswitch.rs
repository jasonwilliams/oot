...
extern "C" {
    ...
    #[no_mangle]
    static mut object_lightswitch_DL_000260: [Gfx; 0];
    #[no_mangle]
    static mut object_lightswitch_DL_000398: [Gfx; 0];
    #[no_mangle]
    static mut object_lightswitch_DL_000408: [Gfx; 0];
    #[no_mangle]
    static mut object_lightswitch_Tex_000420: [u64_0; 0];
    #[no_mangle]
    static mut object_lightswitch_Tex_000C20: [u64_0; 0];
    #[no_mangle]
    static mut object_lightswitch_Tex_001420: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjLightswitch {
    pub actor: Actor,
    pub actionFunc: ObjLightswitchActionFunc,
    pub collider: ColliderJntSph,
    pub colliderItems: [ColliderJntSphElement; 1],
    pub timer: s16,
    pub toggleDelay: s16,
    pub faceTextureIndex: s16,
    pub color: [s16; 3],
    pub alpha: s16,
    pub flameRingRot: s16,
    pub flameRingRotSpeed: s16,
    pub prevFrameACflags: u8_0,
}
pub type ObjLightswitchActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjLightswitch, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_22 = libc::c_uint;
pub const OBJLIGHTSWITCH_TYPE_BURN: C2RustUnnamed_22 = 3;
pub const OBJLIGHTSWITCH_TYPE_2: C2RustUnnamed_22 = 2;
pub const OBJLIGHTSWITCH_TYPE_1: C2RustUnnamed_22 = 1;
pub const OBJLIGHTSWITCH_TYPE_STAY_ON: C2RustUnnamed_22 = 0;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const PUSHBLOCK_HUGE_START_OFF: C2RustUnnamed_23 = 7;
pub const PUSHBLOCK_LARGE_START_OFF: C2RustUnnamed_23 = 6;
pub const PUSHBLOCK_MEDIUM_START_OFF: C2RustUnnamed_23 = 5;
pub const PUSHBLOCK_SMALL_START_OFF: C2RustUnnamed_23 = 4;
pub const PUSHBLOCK_HUGE_START_ON: C2RustUnnamed_23 = 3;
pub const PUSHBLOCK_LARGE_START_ON: C2RustUnnamed_23 = 2;
pub const PUSHBLOCK_MEDIUM_START_ON: C2RustUnnamed_23 = 1;
pub const PUSHBLOCK_SMALL_START_ON: C2RustUnnamed_23 = 0;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const FACE_EYES_OPEN_SMILING: C2RustUnnamed_24 = 2;
pub const FACE_EYES_OPEN: C2RustUnnamed_24 = 1;
pub const FACE_EYES_CLOSED: C2RustUnnamed_24 = 0;
#[no_mangle]
pub static mut Obj_Lightswitch_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_LIGHTSWITCH as libc::c_int as s16,
                          category: ACTORCAT_SWITCH as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_LIGHTSWITCH as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjLightswitch>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjLightswitch_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjLightswitch_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjLightswitch_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjLightswitch_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColliderJntSphElementInit: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
...
static mut sFaceTextures: [*mut libc::c_void; 3] =
    unsafe {
        [object_lightswitch_Tex_000C20.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_lightswitch_Tex_000420.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_lightswitch_Tex_001420.as_ptr() as *mut _ as
             *mut libc::c_void]
    };
static mut D_80B97F68: Vec3f =
    { let mut init = Vec3f{x: -1707.0f32, y: 843.0f32, z: -180.0f32,}; init };
static mut D_80B97F74: Vec3f =
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_InitCollider(mut this:
                                                         *mut ObjLightswitch,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0; // required
    ...
    func_800D1694((*this).actor.world.pos.x,
                  ...
                  (*this).actor.world.pos.z, &mut (*this).actor.shape.rot);
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetSwitchFlag(mut this:
                                                          *mut ObjLightswitch,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        if type_0 == OBJLIGHTSWITCH_TYPE_1 as libc::c_int {
            OnePointCutscene_AttentionSetSfx(globalCtx, thisx,
                                             0x4807 as libc::c_int);
        } else if type_0 == OBJLIGHTSWITCH_TYPE_BURN as libc::c_int {
            OnePointCutscene_AttentionSetSfx(globalCtx, thisx,
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_ClearSwitchFlag(mut this:
                                                            *mut ObjLightswitch,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
        ...
        if (*this).actor.params as libc::c_int >> 4 as libc::c_int &
               3 as libc::c_int == OBJLIGHTSWITCH_TYPE_1 as libc::c_int {
            OnePointCutscene_AttentionSetSfx(globalCtx, &mut (*this).actor,
                                             0x4807 as libc::c_int);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SpawnDisappearEffects(mut this:
                                                                  *mut ObjLightswitch,
                                                              mut globalCtx:
                                                                  *mut GlobalContext) {
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut s: f32_0 = Math_SinS((*this).actor.shape.rot.y);
    let mut c: f32_0 = Math_CosS((*this).actor.shape.rot.y);
    let mut x: f32_0 = 0.;
    let mut y: f32_0 = 0.;
    let mut z: f32_0 = 0.;
    let mut pad: s32 = 0;
    if (*this).alpha as libc::c_int >=
           (100 as libc::c_int) << 6 as libc::c_int {
        x =
            ((if (1.0f32 -
                      1.0f32 /
                          ((255 as libc::c_int) << 6 as libc::c_int) as
                              libc::c_float *
                          (*this).alpha as libc::c_int as libc::c_float) *
                     400.0f32 > 60.0f32 {
                  60.0f32
              } else {
                  (1.0f32 -
                       1.0f32 /
                           ...
                           (*this).alpha as libc::c_int as libc::c_float) *
                      400.0f32
              }) - 30.0f32 + 30.0f32) * Rand_ZeroOne();
        y = x - 30.0f32;
        if x > 30.0f32 {
            x = 30.0f32
        } else {
            x = 900.0f32 - y * y;
            if x < 100.0f32 { x = 100.0f32 }
            x = sqrtf(x)
        }
        x = 2.0f32 * (x * (Rand_ZeroOne() - 0.5f32));
        z = (30.0f32 - fabsf(x)) * 0.5f32 + 10.0f32 * Rand_ZeroOne();
        pos.x = (*this).actor.world.pos.x + (z * s + x * c);
        pos.y = (*this).actor.world.pos.y + y + 10.0f32;
        pos.z = (*this).actor.world.pos.z + (z * c - x * s);
        EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut D_80B97F74,
                             &mut D_80B97F74, 100 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjLightswitch = thisx as *mut ObjLightswitch;
    let mut switchFlagSet: s32 =
        Flags_GetSwitch(globalCtx,
                        (*this).actor.params as libc::c_int >>
                            8 as libc::c_int & 0x3f as libc::c_int);
    let mut removeSelf: s32 = 0 as libc::c_int;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetFocus(&mut (*this).actor, 0.0f32);
    if switchFlagSet != 0 {
        if (*this).actor.params as libc::c_int >> 4 as libc::c_int &
               3 as libc::c_int == OBJLIGHTSWITCH_TYPE_BURN as libc::c_int {
            removeSelf = 1 as libc::c_int
        } else { ObjLightswitch_SetupOn(this); }
    } else { ObjLightswitch_SetupOff(this); }
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
           1 as libc::c_int {
        if switchFlagSet != 0 {
            Math_Vec3f_Copy(&mut (*this).actor.world.pos, &mut D_80B97F68);
            Math_Vec3f_Copy(&mut (*this).actor.home.pos, &mut D_80B97F68);
        }
        (*this).actor.shape.rot.x = -(0x4000 as libc::c_int) as s16;
        (*this).actor.shape.rot.z = 0 as libc::c_int as s16;
        (*this).actor.home.rot.x = (*this).actor.shape.rot.x;
        (*this).actor.world.rot.x = (*this).actor.home.rot.x;
        (*this).actor.home.rot.z = (*this).actor.shape.rot.z;
        (*this).actor.world.rot.z = (*this).actor.home.rot.z;
        (*this).actor.flags |=
            ((1 as libc::c_int) << 5 as libc::c_int) as libc::c_uint;
        if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                              globalCtx,
                              ACTOR_OBJ_OSHIHIKI as libc::c_int as s16,
                              ...
                              ((0xff as libc::c_int) << 8 as libc::c_int |
                                   PUSHBLOCK_SMALL_START_ON as libc::c_int) as
                                  s16).is_null() {
            osSyncPrintf(b"\x1b[41;37m\x00" as *const u8 as
                             *const libc::c_char);
            // "Push-pull block occurrence failure"
            osSyncPrintf(b"\xe6\x8a\xbc\xe5\xbc\x95\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf\xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_lightswitch.c\x00" as *const u8 as
    ...
    if removeSelf != 0 { Actor_Kill(&mut (*this).actor); }
    // "Light switch"
    osSyncPrintf(b"(\xe5\x85\x89\xe3\x82\xb9\xe3\x82\xa4\xe3\x83\x83\xe3\x83\x81)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx2:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupOff(mut this:
                                                     *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_Off as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).faceTextureIndex = FACE_EYES_CLOSED as libc::c_int as s16;
    (*this).color[0 as libc::c_int as usize] =
        ((155 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).color[1 as libc::c_int as usize] =
        ((125 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).color[2 as libc::c_int as usize] =
        ((255 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).alpha = ((255 as libc::c_int) << 6 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Off(mut this: *mut ObjLightswitch,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    match (*this).actor.params as libc::c_int >> 4 as libc::c_int &
              3 as libc::c_int {
        0 | 2 => {
        ...
        1 => {
            if (*this).collider.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                   (*this).prevFrameACflags as libc::c_int &
                       (1 as libc::c_int) << 1 as libc::c_int == 0 {
                ObjLightswitch_SetupTurnOn(this);
                ObjLightswitch_SetSwitchFlag(this, globalCtx);
            }
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupTurnOn(mut this:
                                                        *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_TurnOn as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).toggleDelay = 100 as libc::c_int as s16;
    (*this).timer = 0 as libc::c_int as s16;
    (*this).faceTextureIndex = FACE_EYES_CLOSED as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_TurnOn(mut this: *mut ObjLightswitch,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if func_8005B198() == (*this).actor.category as libc::c_int ||
           (*this).toggleDelay as libc::c_int <= 0 as libc::c_int {
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x286f as libc::c_int as u16_0);
        }
        (*this).timer += 1;
        Math_StepToS(&mut (*this).flameRingRotSpeed,
                     -(0xaa as libc::c_int) as s16,
                     0xa as libc::c_int as s16);
        (*this).flameRingRot =
            ((*this).flameRingRot as libc::c_int +
                 (*this).flameRingRotSpeed as libc::c_int) as s16;
        (*this).color[0 as libc::c_int as usize] =
            ((*this).timer as libc::c_int *
                 (((255 as libc::c_int - 155 as libc::c_int) <<
                       6 as libc::c_int) / 20 as libc::c_int) +
                 ((155 as libc::c_int) << 6 as libc::c_int)) as s16;
        (*this).color[1 as libc::c_int as usize] =
            ((*this).timer as libc::c_int *
                 (((255 as libc::c_int - 125 as libc::c_int) <<
                       6 as libc::c_int) / 20 as libc::c_int) +
                 ((125 as libc::c_int) << 6 as libc::c_int)) as s16;
        if (*this).timer as libc::c_int >= 20 as libc::c_int {
            ObjLightswitch_SetupOn(this);
        } else if (*this).timer as libc::c_int == 15 as libc::c_int {
            (*this).faceTextureIndex = FACE_EYES_OPEN as libc::c_int as s16;
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupOn(mut this:
                                                    *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_On as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).faceTextureIndex = FACE_EYES_OPEN_SMILING as libc::c_int as s16;
    (*this).color[0 as libc::c_int as usize] =
        ((255 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).color[1 as libc::c_int as usize] =
        ((255 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).color[2 as libc::c_int as usize] =
        ((255 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).alpha = ((255 as libc::c_int) << 6 as libc::c_int) as s16;
    (*this).flameRingRotSpeed = -(0xaa as libc::c_int) as s16;
    (*this).timer = 0 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_On(mut this: *mut ObjLightswitch,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    match (*this).actor.params as libc::c_int >> 4 as libc::c_int &
              3 as libc::c_int {
        ...
        2 => {
            if (*this).collider.base.acFlags as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int == 0 {
                if (*this).timer as libc::c_int >= 7 as libc::c_int {
                    ObjLightswitch_SetupTurnOff(this);
                    ObjLightswitch_ClearSwitchFlag(this, globalCtx);
                } else { (*this).timer += 1 }
            } else { (*this).timer = 0 as libc::c_int as s16 }
        }
        _ => { }
    }
    (*this).flameRingRot =
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupTurnOff(mut this:
                                                         *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_TurnOff as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).toggleDelay = 100 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_TurnOff(mut this: *mut ObjLightswitch,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).actor.params as libc::c_int >> 4 as libc::c_int &
           3 as libc::c_int != OBJLIGHTSWITCH_TYPE_1 as libc::c_int ||
           func_8005B198() == (*this).actor.category as libc::c_int ||
           (*this).toggleDelay as libc::c_int <= 0 as libc::c_int {
        (*this).timer -= 1;
        Math_StepToS(&mut (*this).flameRingRotSpeed, 0 as libc::c_int as s16,
                     0xa as libc::c_int as s16);
        (*this).flameRingRot =
            ((*this).flameRingRot as libc::c_int +
                 (*this).flameRingRotSpeed as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupDisappearDelay(mut this:
                                                                *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_DisappearDelay as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).toggleDelay = 100 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_DisappearDelay(mut this:
                                                           *mut ObjLightswitch,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    if func_8005B198() == (*this).actor.category as libc::c_int ||
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_SetupDisappear(mut this:
                                                           *mut ObjLightswitch) {
    (*this).actionFunc =
        Some(ObjLightswitch_Disappear as
                 unsafe extern "C" fn(_: *mut ObjLightswitch,
                                      _: *mut GlobalContext) -> ());
    (*this).alpha = ((255 as libc::c_int) << 6 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Disappear(mut this:
                                                      *mut ObjLightswitch,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    (*this).alpha =
        ((*this).alpha as libc::c_int - 200 as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Update(mut thisx: *mut Actor,
                                               mut globalCtx2:
                                                   *mut GlobalContext) {
    let mut this: *mut ObjLightswitch = thisx as *mut ObjLightswitch;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    if (*this).toggleDelay as libc::c_int > 0 as libc::c_int {
        (*this).toggleDelay -= 1
    }
    ...
    if (*this).actor.update.is_some() {
        if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
            ...
            (*this).actor.world.pos.y =
                (*(*this).actor.child).world.pos.y + 60.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_DrawOpa(mut this: *mut ObjLightswitch,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    (*_g).words.w1 =
        (((*this).color[0 as libc::c_int as usize] as libc::c_int >>
              6 as libc::c_int) as u8_0 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((*this).color[1 as libc::c_int as usize] as libc::c_int >>
                  6 as libc::c_int) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (((*this).color[2 as libc::c_int as usize] as libc::c_int >>
                  6 as libc::c_int) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((*this).alpha as libc::c_int >> 6 as libc::c_int) as u8_0 as
                 u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
    ...
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
        ...
        (*this).actor.world.pos.y = (*child).world.pos.y + 60.0f32;
        (*this).actor.world.pos.z = (*child).world.pos.z;
        Math_Vec3f_Copy(&mut pos, &mut (*this).actor.world.pos);
        func_800D1694(pos.x, pos.y, pos.z, &mut (*this).actor.shape.rot);
        Matrix_Scale((*this).actor.scale.x, (*this).actor.scale.y,
                     (*this).actor.scale.z,
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gSegments[((sFaceTextures[(*this).faceTextureIndex as usize] as u32_0)
                       << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sFaceTextures[(*this).faceTextureIndex
                                                            as usize] as u32_0
                                              &
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 =
        object_lightswitch_DL_000260.as_mut_ptr() as libc::c_uint;
    rot.x = (*this).actor.shape.rot.x;
    rot.y = (*this).actor.shape.rot.y;
    rot.z =
        ((*this).actor.shape.rot.z as libc::c_int +
             (*this).flameRingRot as libc::c_int) as s16;
    func_800D1694(pos.x, pos.y, pos.z, &mut rot);
    Matrix_Scale((*this).actor.scale.x, (*this).actor.scale.y,
                 (*this).actor.scale.z, MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 =
        object_lightswitch_DL_000398.as_mut_ptr() as libc::c_uint;
    rot.z =
        ((*this).actor.shape.rot.z as libc::c_int -
             (*this).flameRingRot as libc::c_int) as s16;
    func_800D1694(pos.x, pos.y, pos.z, &mut rot);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_7).words.w1 =
        object_lightswitch_DL_000408.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_lightswitch.c\x00" as *const u8 as
                         *const libc::c_char, 878 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_DrawXlu(mut this: *mut ObjLightswitch,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp68: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp60: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_lightswitch.c\x00" as *const u8 as
                        *const libc::c_char, 890 as libc::c_int);
    ...
    (*_g_0).words.w0 =
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = D_80116280.as_mut_ptr() as libc::c_uint;
    ...
    sp60.z =
        ((*this).actor.shape.rot.z as libc::c_int +
             (*this).flameRingRot as libc::c_int) as s16;
    func_800D1694(sp68.x, sp68.y, sp68.z, &mut sp60);
    Matrix_Scale((*this).actor.scale.x, (*this).actor.scale.y,
                 (*this).actor.scale.z, MTXMODE_APPLY as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn ObjLightswitch_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjLightswitch = thisx as *mut ObjLightswitch;
    let mut alpha: s32 =
        (*this).alpha as libc::c_int >> 6 as libc::c_int &
            0xff as libc::c_int;
    if (*this).actor.params as libc::c_int & 1 as libc::c_int ==
           1 as libc::c_int {
        Collider_UpdateSpheres(0 as libc::c_int, &mut (*this).collider);
    ...
    if (*this).actor.params as libc::c_int >> 4 as libc::c_int &
           3 as libc::c_int == OBJLIGHTSWITCH_TYPE_BURN as libc::c_int &&
           (alpha > 0 as libc::c_int || alpha < 255 as libc::c_int) {
        ObjLightswitch_DrawXlu(this, globalCtx);
    } else { ObjLightswitch_DrawOpa(this, globalCtx); };
}
