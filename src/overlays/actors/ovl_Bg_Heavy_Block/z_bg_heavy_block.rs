...
extern "C" {
    ...
    #[no_mangle]
    static mut gHeavyBlockEntirePillarDL: [Gfx; 0];
    #[no_mangle]
    static mut gHeavyBlockCol: CollisionHeader;
    #[no_mangle]
    static mut gHeavyBlockBigPieceDL: [Gfx; 0];
    #[no_mangle]
    static mut gHeavyBlockSmallPieceDL: [Gfx; 0];
}
...
pub const HEAVYBLOCK_UNBREAKABLE_OUTSIDE_CASTLE: C2RustUnnamed_21 = 4;
pub const HEAVYBLOCK_SMALL_PIECE: C2RustUnnamed_21 = 3;
pub const HEAVYBLOCK_BIG_PIECE: C2RustUnnamed_21 = 2;
pub const HEAVYBLOCK_BREAKABLE: C2RustUnnamed_21 = 1;
pub const HEAVYBLOCK_UNBREAKABLE: C2RustUnnamed_21 = 0;
#[no_mangle]
pub static mut Bg_Heavy_Block_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HEAVY_BLOCK as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_HEAVY_OBJECT as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgHeavyBlock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHeavyBlock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHeavyBlock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHeavyBlock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHeavyBlock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_SetPieceRandRot(mut this:
                                                          *mut BgHeavyBlock,
                                                      mut scale: f32_0) {
    (*this).dyna.actor.world.rot.x =
        (Rand_CenteredFloat(1024.0f32) * scale) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_InitPiece(mut this: *mut BgHeavyBlock,
                                                mut scale: f32_0) {
    let mut rand: f32_0 = 0.;
    let mut yawSinCos: f32_0 = 0.;
    let mut randChoice: f32_0 = 0.;
    (*this).dyna.actor.gravity = -0.6f32;
    (*this).dyna.actor.minVelocityY = -12.0f32;
    randChoice = Rand_CenteredFloat(12.0f32 * scale);
    rand =
        if randChoice < 0.0f32 {
            (randChoice) - 2.0f32
        } else { (randChoice) + 2.0f32 };
    (*this).dyna.actor.velocity.y = (Rand_ZeroFloat(8.0f32) + 4.0f32) * scale;
    (*this).dyna.actor.velocity.z = Rand_ZeroFloat(-8.0f32 * scale);
    yawSinCos = Math_CosS((*this).dyna.actor.world.rot.y);
    (*this).dyna.actor.velocity.x =
        Math_SinS((*this).dyna.actor.world.rot.y) *
            (*this).dyna.actor.velocity.z + yawSinCos * rand;
    yawSinCos = Math_SinS((*this).dyna.actor.world.rot.y);
    (*this).dyna.actor.velocity.z =
        Math_CosS((*this).dyna.actor.world.rot.y) *
            (*this).dyna.actor.velocity.z + -yawSinCos * rand;
    BgHeavyBlock_SetPieceRandRot(this, scale);
    Actor_SetScale(&mut (*this).dyna.actor,
                   Rand_CenteredFloat(0.2f32) + 1.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_SetupDynapoly(mut this:
                                                        *mut BgHeavyBlock,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    ...
    CollisionHeader_GetVirtual(&mut gHeavyBlockCol as *mut CollisionHeader as
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgHeavyBlock = thisx as *mut BgHeavyBlock;
    Actor_ProcessInitChain(thisx, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*thisx).shape, 0.0f32, None, 0.0f32);
    (*this).pieceFlags = 0 as libc::c_int as u16_0;
    if (*globalCtx).sceneNum as libc::c_int == SCENE_GANON_TOU as libc::c_int
       {
        (*thisx).params =
            ((*thisx).params as libc::c_int & 0xff00 as libc::c_int) as s16;
        (*thisx).params =
            ((*thisx).params as libc::c_int | 4 as libc::c_int) as s16
    }
    match (*thisx).params as libc::c_int & 0xff as libc::c_int {
        2 => {
            (*thisx).draw =
                Some(BgHeavyBlock_DrawPiece as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ());
            (*this).actionFunc =
                Some(BgHeavyBlock_MovePiece as
                         unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                              _: *mut GlobalContext) -> ());
            BgHeavyBlock_InitPiece(this, 1.0f32);
            (*this).timer = 120 as libc::c_int as s16;
            (*thisx).flags |=
                ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
            (*this).unk_164.y = -50.0f32
        }
        3 => {
            (*thisx).draw =
                Some(BgHeavyBlock_DrawPiece as
            ...
            (*this).actionFunc =
                Some(BgHeavyBlock_MovePiece as
                         unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                              _: *mut GlobalContext) -> ());
            BgHeavyBlock_InitPiece(this, 2.0f32);
            (*this).timer = 120 as libc::c_int as s16;
            (*thisx).flags |=
                ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
            (*this).unk_164.y = -20.0f32
        }
        1 => {
        ...
        4 => {
            ...
            if Flags_GetSwitch(globalCtx,
                   ...
                   0 {
                (*this).actionFunc =
                    Some(BgHeavyBlock_DoNothing as
                             unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*thisx).world.rot.x = 0x8ad0 as libc::c_int as s16;
                (*thisx).shape.rot.x = (*thisx).world.rot.x;
                (*thisx).world.rot.y = 0xc000 as libc::c_int as s16;
                (*thisx).shape.rot.y = (*thisx).world.rot.y;
                (*thisx).world.rot.z = 0 as libc::c_int as s16;
                (*thisx).shape.rot.z = (*thisx).world.rot.z;
                (*thisx).world.pos.x = 1704.0f32;
                (*thisx).world.pos.y = 1504.0f32;
                (*thisx).world.pos.z = 516.0f32
            }
            (*this).actionFunc =
                Some(BgHeavyBlock_Wait as
                         unsafe extern "C" fn(_: *mut BgHeavyBlock,
    ...
    osSyncPrintf(b"\x1b[36m \xe6\x9c\x80\xe5\xa4\xa7 \xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf \xe3\x82\xbb\xe3\x83\xbc\xe3\x83\x96\xe3\x83\x93\xe3\x83\x83\xe3\x83\x88 %x\n\x1b[m\x00"
                     as *const u8 as *const libc::c_char,
                 (*thisx).params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgHeavyBlock = thisx as *mut BgHeavyBlock;
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        2 | 3 => { }
        _ => {
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_MovePiece(mut this: *mut BgHeavyBlock,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    (*thisx).velocity.x *= 0.98f32;
    (*thisx).velocity.z *= 0.98f32;
    func_8002D7EC(thisx);
    (*thisx).shape.rot.x =
        ((*thisx).shape.rot.x as libc::c_int +
             (*thisx).world.rot.x as libc::c_int) as s16;
    (*thisx).shape.rot.y =
        ((*thisx).shape.rot.y as libc::c_int +
             (*thisx).world.rot.y as libc::c_int) as s16;
    (*thisx).shape.rot.z =
        ((*thisx).shape.rot.z as libc::c_int +
             (*thisx).world.rot.z as libc::c_int) as s16;
    if (*this).pieceFlags as libc::c_int &
           (1 as libc::c_int) << 0 as libc::c_int == 0 {
        (*thisx).world.pos.y += (*this).unk_164.y;
        (*thisx).prevPos.y += (*this).unk_164.y;
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 50.0f32, 50.0f32, 0.0f32,
                                5 as libc::c_int);
        (*thisx).world.pos.y -= (*this).unk_164.y;
        (*thisx).prevPos.y -= (*this).unk_164.y;
        if (*thisx).bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
            (*this).pieceFlags =
                ((*this).pieceFlags as libc::c_int |
                     (1 as libc::c_int) << 0 as libc::c_int) as u16_0;
            (*thisx).velocity.y = Rand_ZeroFloat(4.0f32) + 2.0f32;
            (*thisx).velocity.x = Rand_CenteredFloat(8.0f32);
            (*thisx).velocity.z = Rand_CenteredFloat(8.0f32);
            BgHeavyBlock_SetPieceRandRot(this, 1.0f32);
            Audio_PlayActorSound2(thisx, 0x2852 as libc::c_int as u16_0);
            func_800AA000((*thisx).xzDistToPlayer,
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_SpawnDust(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut posX: f32_0,
                                                mut posY: f32_0,
                                                mut posZ: f32_0,
    ...
    let mut scaleStep: s16 = 0;
    let mut scale: s16 = 0;
    pos.x = posX;
    pos.y = posY;
    pos.z = posZ;
    if dustParams as libc::c_int & 1 as libc::c_int != 0 {
        // red dust, landed in fire
        primColor.r = 150 as libc::c_int as u8_0;
        envColor.b = 0 as libc::c_int as u8_0;
        envColor.g = envColor.b;
        primColor.b = envColor.g;
        primColor.g = primColor.b;
        envColor.r = 80 as libc::c_int as u8_0;
        envColor.a = 0 as libc::c_int as u8_0;
        primColor.a = envColor.a
    } else {
        // brown dust
        // clang-format off
        primColor.r = 170 as libc::c_int as u8_0;
        primColor.g = 130 as libc::c_int as u8_0;
        primColor.b = 90 as libc::c_int as u8_0;
        primColor.a = 255 as libc::c_int as u8_0;
        envColor.r = 100 as libc::c_int as u8_0;
        envColor.g = 60 as libc::c_int as u8_0;
        envColor.b = 20 as libc::c_int as u8_0;
        envColor.a = 255 as libc::c_int as u8_0
        // clang-format on
    }
    accel.z = 0.0f32;
    accel.x = 0.0f32;
    accel.y =
        if dustParams as libc::c_int & 8 as libc::c_int != 0 {
            0.0f32
        } else { 0.5f32 };
    eye = (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize]).eye;
    at = (*(*globalCtx).cameraPtrs[(*globalCtx).activeCamera as usize]).at;
    scale = 1000 as libc::c_int as s16;
    scaleStep = 160 as libc::c_int as s16;
    match dustParams as libc::c_int & 6 as libc::c_int {
        4 | 6 => {
            velocity.x = velX;
            velocity.y = velY;
            velocity.z = velZ;
            scale = 300 as libc::c_int as s16;
            scaleStep = 50 as libc::c_int as s16
        }
        2 => {
            sp44 = Rand_ZeroFloat(5.0f32) + 5.0f32;
            sp6E = Rand_CenteredFloat(65280.0f32) as s16;
            velocity.x = Math_SinS(sp6E) * sp44 + velX;
            velocity.y = velY;
            velocity.z = Math_CosS(sp6E) * sp44 + velZ
        }
        0 => {
            sp6E = Math_Vec3f_Yaw(&mut eye, &mut at);
            sp6C =
                -(Math_Vec3f_Pitch(&mut eye, &mut at) as libc::c_int) as s16;
            velocity.x = 5.0f32 * Math_SinS(sp6E) * Math_CosS(sp6C) + velX;
            velocity.y = Math_SinS(sp6C) * 5.0f32 + velY;
            velocity.z = 5.0f32 * Math_CosS(sp6E) * Math_CosS(sp6C) + velZ;
            pos.x -= velocity.x * 20.0f32;
            pos.y -= velocity.y * 20.0f32;
            pos.z -= velocity.z * 20.0f32
        }
        _ => { }
    }
    func_8002843C(globalCtx, &mut pos, &mut velocity, &mut accel,
                  &mut primColor, &mut envColor, scale, scaleStep,
                  (Rand_ZeroFloat(10.0f32) as s32 + 20 as libc::c_int) as
                      s16);
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_SpawnPieces(mut this: *mut BgHeavyBlock,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut spA4: [Vec3f; 6] =
        [{ let mut init = Vec3f{x: 0.0f32, y: 300.0f32, z: -20.0f32,}; init },
         {
             let mut init = Vec3f{x: 50.0f32, y: 200.0f32, z: -20.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -50.0f32, y: 200.0f32, z: -20.0f32,};
         ...
         { let mut init = Vec3f{x: 0.0f32, y: 100.0f32, z: 30.0f32,}; init },
         { let mut init = Vec3f{x: 0.0f32, y: 100.0f32, z: -70.0f32,}; init },
    ...
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[Vec3f; 6]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<Vec3f>()
                                                   as libc::c_ulong) as s32 {
        pos.z = spA4[i as usize].y * sinPitch + spA4[i as usize].z * cosPitch;
        pos.x =
            (*this).dyna.actor.world.pos.x + spA4[i as usize].x * cosYaw +
                sinYaw * pos.z;
        pos.y =
            (*this).dyna.actor.world.pos.y + spA4[i as usize].y * cosPitch +
                -spA4[i as usize].z * sinPitch;
        pos.z =
            (*this).dyna.actor.world.pos.z + spA4[i as usize].x * -sinYaw +
                cosYaw * pos.z;
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_BG_HEAVY_BLOCK as libc::c_int as s16, pos.x, pos.y,
                    pos.z, (*this).dyna.actor.shape.rot.x,
                    (*this).dyna.actor.shape.rot.y, 0 as libc::c_int as s16,
        ...
        BgHeavyBlock_SpawnDust(globalCtx, pos.x, pos.y, pos.z, 0.0f32, 0.0f32,
                               0.0f32, 0 as libc::c_int as u8_0);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Wait(mut this: *mut BgHeavyBlock,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut quakeIndex: s32 = 0;
    ...
    if Actor_HasParent(&mut (*this).dyna.actor, globalCtx) != 0 {
        ...
        match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
            1 => {
                OnePointCutscene_Init(globalCtx, 4020 as libc::c_int as s16,
                                      270 as libc::c_int as s16,
                                      &mut (*this).dyna.actor,
                                      0 as libc::c_int as s16);
            }
            0 => {
                OnePointCutscene_Init(globalCtx, 4021 as libc::c_int as s16,
                                      220 as libc::c_int as s16,
                                      &mut (*this).dyna.actor,
                                      0 as libc::c_int as s16);
            }
            4 => {
                OnePointCutscene_Init(globalCtx, 4022 as libc::c_int as s16,
                                      210 as libc::c_int as s16,
                                      &mut (*this).dyna.actor,
                                      0 as libc::c_int as s16);
            }
            _ => { }
        ...
        Quake_SetSpeed(quakeIndex as s16, 25000 as libc::c_int as s16);
        Quake_SetQuakeValues(quakeIndex as s16, 1 as libc::c_int as s16,
                             1 as libc::c_int as s16, 5 as libc::c_int as s16,
                             0 as libc::c_int as s16);
        Quake_SetCountdown(quakeIndex as s16, 10 as libc::c_int as s16);
        (*this).actionFunc =
            Some(BgHeavyBlock_LiftedUp as
                     unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_LiftedUp(mut this: *mut BgHeavyBlock,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ...
    if (*this).timer as libc::c_int == 11 as libc::c_int {
        func_800AA000(0.0f32, 0xff as libc::c_int as u8_0,
                      0x14 as libc::c_int as u8_0,
                      0x14 as libc::c_int as u8_0);
        func_8002F7DC(&mut (*player).actor, 0x86c as libc::c_int as u16_0);
        LogUtils_LogThreadId(b"../z_bg_heavy_block.c\x00" as *const u8 as
                                 *const libc::c_char, 691 as libc::c_int);
        osSyncPrintf(b"\"NA_SE_PL_PULL_UP_BIGROCK\" = %s\n\x00" as *const u8
                         as *const libc::c_char,
                     b"NA_SE_PL_PULL_UP_BIGROCK\x00" as *const u8 as
                         *const libc::c_char);
    }
    if ((*this).timer as libc::c_int) < 40 as libc::c_int {
        xOffset = Rand_CenteredFloat(110.0f32);
        sinYaw = Math_SinS((*this).dyna.actor.shape.rot.y);
        zOffset = Rand_CenteredFloat(110.0f32);
        cosYaw = Math_CosS((*this).dyna.actor.shape.rot.y);
        BgHeavyBlock_SpawnDust(globalCtx,
                               sinYaw * -70.0f32 +
                                   ((*this).dyna.actor.world.pos.x + xOffset),
                               (*this).dyna.actor.world.pos.y + 10.0f32,
                               cosYaw * -70.0f32 +
                                   ((*this).dyna.actor.world.pos.z + zOffset),
    ...
    if Actor_HasNoParent(&mut (*this).dyna.actor, globalCtx) != 0 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x28e2 as libc::c_int as u16_0);
        (*this).actionFunc =
            Some(BgHeavyBlock_Fly as
                     unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Fly(mut this: *mut BgHeavyBlock,
                                          mut globalCtx: *mut GlobalContext) {
    let mut bgId: s32 = 0;
    let mut quakeIndex: s32 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut raycastResult: f32_0 = 0.;
    Actor_MoveForward(&mut (*this).dyna.actor);
    pos.x = (*this).dyna.actor.home.pos.x;
    pos.y = (*this).dyna.actor.home.pos.y + 1000.0f32;
    ...
    if (*this).dyna.actor.home.pos.y <= raycastResult {
        func_800AA000(0.0f32, 0xff as libc::c_int as u8_0,
                      0x3c as libc::c_int as u8_0, 4 as libc::c_int as u8_0);
        match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
            1 => {
                ...
                quakeIndex =
                    Quake_Add((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                          as usize],
                              3 as libc::c_int as u32_0) as s32;
                Quake_SetSpeed(quakeIndex as s16,
                               28000 as libc::c_int as s16);
                Quake_SetQuakeValues(quakeIndex as s16,
                                     14 as libc::c_int as s16,
                                     2 as libc::c_int as s16,
                                     100 as libc::c_int as s16,
                                     0 as libc::c_int as s16);
                Quake_SetCountdown(quakeIndex as s16,
    ...
    (*this).dyna.actor.shape.rot.x =
        Math_Atan2S((*this).dyna.actor.velocity.y,
                    (*this).dyna.actor.speedXZ);
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_DoNothing(mut this: *mut BgHeavyBlock,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Land(mut this: *mut BgHeavyBlock,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    if Math_SmoothStepToS(&mut (*this).dyna.actor.shape.rot.x,
                          0x8ad0 as libc::c_int as s16,
                          6 as libc::c_int as s16, 2000 as libc::c_int as s16,
                          100 as libc::c_int as s16) as libc::c_int !=
           0 as libc::c_int {
        Math_StepToF(&mut (*this).dyna.actor.speedXZ, 0.0f32, 20.0f32);
        Math_StepToF(&mut (*this).dyna.actor.velocity.y, 0.0f32, 3.0f32);
        (*this).dyna.actor.gravity = 0.0f32;
        ...
        match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
            4 => {
                BgHeavyBlock_SpawnDust(globalCtx,
                                       Rand_CenteredFloat(30.0f32) +
                                           1678.0f32,
                                       Rand_ZeroFloat(100.0f32) + 1286.0f32,
                                       Rand_CenteredFloat(30.0f32) + 552.0f32,
                                       0.0f32, 0.0f32, 0.0f32,
                                       0 as libc::c_int as u8_0);
                BgHeavyBlock_SpawnDust(globalCtx,
                                       Rand_CenteredFloat(30.0f32) +
                                           1729.0f32,
                                       Rand_ZeroFloat(80.0f32) + 1269.0f32,
                                       Rand_CenteredFloat(30.0f32) + 600.0f32,
                                       0.0f32, 0.0f32, 0.0f32,
                                       0 as libc::c_int as u8_0);
            }
            0 => {
                BgHeavyBlock_SpawnDust(globalCtx,
                                       Rand_CenteredFloat(100.0f32) +
                                           -735.0f32, 29.0f32,
                                       Rand_CenteredFloat(100.0f32) +
                                           -3418.0f32, 0.0f32, 0.0f32, 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHeavyBlock = thisx as *mut BgHeavyBlock;
...
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut D_80884EC8: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut D_80884ED4: Vec3f =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_heavy_block.c\x00" as *const u8 as
                        *const libc::c_char, 904 as libc::c_int);
    if Some(BgHeavyBlock_LiftedUp as
                unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                     _: *mut GlobalContext) -> ()) ==
           (*this).actionFunc {
        func_800D1694((*player).leftHandPos.x, (*player).leftHandPos.y,
                      (*player).leftHandPos.z, &mut (*thisx).shape.rot);
        Matrix_Translate(-(*this).unk_164.x, -(*this).unk_164.y,
                         -(*this).unk_164.z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    } else if (*thisx).gravity == 0.0f32 &&
                  Some(BgHeavyBlock_Land as
                           unsafe extern "C" fn(_: *mut BgHeavyBlock,
                                                _: *mut GlobalContext) -> ())
                      == (*this).actionFunc {
        func_800D1694((*thisx).home.pos.x, (*thisx).home.pos.y,
                      (*thisx).home.pos.z, &mut (*thisx).shape.rot);
        Matrix_Translate(-D_80884ED4.x, -D_80884ED4.y, -D_80884ED4.z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    }
    Matrix_MultVec3f(&mut D_80884EC8, &mut (*thisx).world.pos);
    Matrix_MultVec3f(&mut D_80884ED4, &mut (*thisx).home.pos);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gHeavyBlockEntirePillarDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_heavy_block.c\x00" as *const u8 as
                         *const libc::c_char, 935 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgHeavyBlock_DrawPiece(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    match (*thisx).params as libc::c_int & 0xff as libc::c_int {
        2 => {
            Matrix_Translate(50.0f32, -260.0f32, -20.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Gfx_DrawDListOpa(globalCtx, gHeavyBlockBigPieceDL.as_mut_ptr());
        }
        3 => {
            Matrix_Translate(45.0f32, -280.0f32, -5.0f32,
                             MTXMODE_APPLY as libc::c_int as u8_0);
            Gfx_DrawDListOpa(globalCtx, gHeavyBlockSmallPieceDL.as_mut_ptr());
        }
        _ => { }
    };
}
