...
extern "C" {
    ...
    #[no_mangle]
    fn Math_StepToAngleS(pValue: *mut s16, target: s16, step: s16) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gFishOutOfWaterAnim: AnimationHeader;
    #[no_mangle]
    static mut gFishSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gFishInWaterAnim: AnimationHeader;
}
...
pub struct EnFish {
    ...
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 7],
    pub morphTable: [Vec3s; 7],
    pub actionFunc: EnFishActionFunc,
    pub timer: s16,
    pub respawnTimer: s16,
    pub slowPhase: s16,
    pub fastPhase: s16,
    pub unk_250: s32,
}
pub type EnFishActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_int;
pub const FISH_SWIMMING_UNIQUE: C2RustUnnamed_23 = 1;
pub const FISH_DROPPED: C2RustUnnamed_23 = 0;
pub const FISH_SWIMMING_RESPAWNING: C2RustUnnamed_23 = -1;
// Used in the cutscene functions
static mut D_80A17010: *mut Actor = 0 as *const Actor as *mut Actor;
static mut D_80A17014: f32_0 = 0.0f32;
static mut D_80A17018: f32_0 = 0.0f32;
...
#[no_mangle]
pub static mut En_Fish_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FISH as libc::c_int as s16,
                          category:
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_XZDistanceSquared(mut v1: *mut Vec3f,
                                                  mut v2: *mut Vec3f)
 -> f32_0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_SetInWaterAnimation(mut this: *mut EnFish) {
    Animation_Change(&mut (*this).skelAnime, &mut gFishInWaterAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gFishInWaterAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, 2.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_SetOutOfWaterAnimation(mut this:
                                                           *mut EnFish) {
    Animation_Change(&mut (*this).skelAnime, &mut gFishOutOfWaterAnim, 1.0f32,
                     0.0f32,
                     Animation_GetLastFrame(&mut gFishOutOfWaterAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, 2.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_BeginRespawn(mut this: *mut EnFish) {
    (*this).respawnTimer = 400 as libc::c_int as s16;
    Actor_SetScale(&mut (*this).actor, 0.001f32);
    (*this).actor.draw = None;
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_SetCutsceneData(mut this: *mut EnFish) {
    let mut thisx: *mut Actor = &mut (*this).actor;
    if D_80A17010.is_null() {
        D_80A17010 = thisx;
        ...
        (*thisx).draw =
            Some(EnFish_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*thisx).shape.rot.x = 0 as libc::c_int as s16;
        (*thisx).shape.rot.y = -(0x6410 as libc::c_int) as s16;
        (*thisx).shape.rot.z = 0x4000 as libc::c_int as s16;
        (*thisx).shape.yOffset = 600.0f32;
        D_80A17014 = 10.0f32;
        D_80A17018 = 0.0f32;
        (*thisx).flags |=
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_ClearCutsceneData(mut this: *mut EnFish) {
    D_80A17010 = 0 as *mut Actor;
    D_80A17014 = 0.0f32;
    D_80A17018 = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFish = thisx as *mut EnFish;
    let mut params: s16 = (*this).actor.params;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gFishSkel,
                       &mut gFishInWaterAnim, (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 7 as libc::c_int);
    ...
    (*this).actor.colChkInfo.mass = 50 as libc::c_int as u8_0;
    (*this).slowPhase =
    ...
    (*this).fastPhase =
        (Rand_ZeroOne() * (0xffff as libc::c_int as libc::c_float + 0.5f32))
            as s16;
    if params as libc::c_int == FISH_DROPPED as libc::c_int {
        (*this).actor.flags |=
            ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
    ...
    } else if params as libc::c_int == FISH_SWIMMING_UNIQUE as libc::c_int {
        EnFish_Unique_SetupSwimIdle(this);
    } else { EnFish_Respawning_SetupSlowDown(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Destroy(mut thisx: *mut Actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_SetYOffset(mut this: *mut EnFish) {
    (*this).actor.shape.yOffset +=
        Math_SinS((*this).slowPhase) * 10.0f32 +
            Math_SinS((*this).fastPhase) * 5.0f32;
    (*this).actor.shape.yOffset =
        if (*this).actor.shape.yOffset < -200.0f32 {
            -200.0f32
        } else if (*this).actor.shape.yOffset > 200.0f32 {
            200.0f32
        } else { (*this).actor.shape.yOffset };
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_InBottleRange(mut this: *mut EnFish,
                                              mut globalCtx:
    ...
    if (*this).actor.xzDistToPlayer < 32.0f32 {
        ...
        // ! world rotation.
        if EnFish_XZDistanceSquared(&mut sp1C, &mut (*this).actor.world.pos)
               <= 20.0f32 * 20.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_CheckXZDistanceToPlayer(mut this: *mut EnFish,
                                                        mut globalCtx:
                                                            *mut GlobalContext)
 -> s32 {
    return ((*this).actor.xzDistToPlayer < 60.0f32) as libc::c_int;
}
// Respawning type functions
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_SetupSlowDown(mut this:
                                                             *mut EnFish) {
    (*this).actor.gravity = 0.0f32;
    (*this).actor.minVelocityY = 0.0f32;
    (*this).timer =
        Rand_S16Offset(5 as libc::c_int as s16, 35 as libc::c_int as s16);
    (*this).unk_250 = 0 as libc::c_int;
    EnFish_SetInWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Respawning_SlowDown as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_SlowDown(mut this: *mut EnFish,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    EnFish_SetYOffset(this);
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.05f32, 0.3f32,
                       0.0f32);
    (*this).skelAnime.playSpeed =
        if (*this).actor.speedXZ * 1.4f32 + 0.8f32 > 2.0f32 {
            2.0f32
        } else { ((*this).actor.speedXZ * 1.4f32) + 0.8f32 };
    ...
    } else if &mut (*this).actor as *mut Actor == (*this).actor.child {
        EnFish_Respawning_SetupApproachPlayer(this);
    } else if EnFish_CheckXZDistanceToPlayer(this, globalCtx) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_SetupFollowChild(mut this:
                                                                *mut EnFish) {
    (*this).actor.gravity = 0.0f32;
    (*this).actor.minVelocityY = 0.0f32;
    (*this).timer =
        Rand_S16Offset(15 as libc::c_int as s16, 45 as libc::c_int as s16);
    (*this).unk_250 = 0 as libc::c_int;
    EnFish_SetInWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Respawning_FollowChild as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_FollowChild(mut this: *mut EnFish,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut pad: s32 = 0;
    EnFish_SetYOffset(this);
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 1.8f32, 0.08f32, 0.4f32,
                       0.0f32);
    if EnFish_XZDistanceSquared(&mut (*this).actor.world.pos,
                                &mut (*this).actor.home.pos) >
           80.0f32 * 80.0f32 ||
           ((*this).timer as libc::c_int) < 4 as libc::c_int {
        Math_StepToAngleS(&mut (*this).actor.world.rot.y,
    ...
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    (*this).skelAnime.playSpeed =
        if (*this).actor.speedXZ * 1.5f32 + 0.8f32 > 4.0f32 {
            4.0f32
        } else { ((*this).actor.speedXZ * 1.5f32) + 0.8f32 };
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_SetupFleePlayer(mut this:
                                                               *mut EnFish) {
    (*this).actor.gravity = 0.0f32;
    (*this).actor.minVelocityY = 0.0f32;
    (*this).timer =
    ...
    EnFish_SetInWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Respawning_FleePlayer as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_FleePlayer(mut this: *mut EnFish,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s16 = 0;
    ...
    let mut yaw: s16 = 0;
    let mut playerClose: s16 = 0;
    EnFish_SetYOffset(this);
    playerClose = EnFish_CheckXZDistanceToPlayer(this, globalCtx) as s16;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 4.2f32, 0.08f32, 1.4f32,
                       0.0f32);
    if EnFish_XZDistanceSquared(&mut (*this).actor.world.pos,
                                &mut (*this).actor.home.pos) >
           160.0f32 * 160.0f32 {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        Math_StepToAngleS(&mut (*this).actor.world.rot.y, yaw,
                          3000 as libc::c_int as s16);
    } else if !(*this).actor.child.is_null() &&
                  &mut (*this).actor as *mut Actor != (*this).actor.child {
        yaw =
    ...
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int <= 0 as libc::c_int || playerClose == 0 {
        EnFish_Respawning_SetupSlowDown(this);
    } else if &mut (*this).actor as *mut Actor == (*this).actor.child {
        EnFish_Respawning_SetupApproachPlayer(this);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_SetupApproachPlayer(mut this:
                                                                   *mut EnFish) {
    (*this).actor.gravity = 0.0f32;
    (*this).actor.minVelocityY = 0.0f32;
    EnFish_SetInWaterAnimation(this);
    ...
    (*this).unk_250 = 0 as libc::c_int;
    (*this).actionFunc =
        Some(EnFish_Respawning_ApproachPlayer as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Respawning_ApproachPlayer(mut this:
                                                              *mut EnFish,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    if EnFish_XZDistanceSquared(&mut (*this).actor.world.pos,
        ...
        if (*globalCtx).state.frames as s16 as libc::c_int &
               0x40 as libc::c_int != 0 {
            temp_a0_2 =
                ((*this).actor.yawTowardsPlayer as libc::c_int +
                     0x9000 as libc::c_int) as s16
        } else {
            temp_a0_2 =
                ((*this).actor.yawTowardsPlayer as libc::c_int +
                     0x7000 as libc::c_int) as s16
        }
        sp38.x = (*player).actor.world.pos.x + Math_SinS(temp_a0_2) * 20.0f32;
        sp38.y = (*player).actor.world.pos.y;
        sp38.z = (*player).actor.world.pos.z + Math_CosS(temp_a0_2) * 20.0f32;
        yaw = Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut sp38);
        Math_StepToAngleS(&mut (*this).actor.world.rot.y, yaw,
                          3000 as libc::c_int as s16);
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_SetupFall(mut this: *mut EnFish) {
    (*this).actor.gravity = -1.0f32;
    (*this).actor.minVelocityY = -10.0f32;
    (*this).actor.shape.yOffset = 0.0f32;
    EnFish_SetOutOfWaterAnimation(this);
    (*this).unk_250 = 5 as libc::c_int;
    (*this).actionFunc =
        Some(EnFish_Dropped_Fall as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
    (*this).timer = 300 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_Fall(mut this: *mut EnFish,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32, 0.1f32,
                       0.0f32);
    Math_StepToAngleS(&mut (*this).actor.world.rot.x,
                      0x4000 as libc::c_int as s16,
                      100 as libc::c_int as s16);
    Math_StepToAngleS(&mut (*this).actor.world.rot.z,
                      -(0x4000 as libc::c_int) as s16,
                      100 as libc::c_int as s16);
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        osSyncPrintf(b"BG \xe6\x8a\x9c\xe3\x81\x91\xef\xbc\x9f Actor_delete \xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99(%s %d)\n\x00"
                     ...
                     b"../z_en_sakana.c\x00" as *const u8 as
                         *const libc::c_char, 822 as libc::c_int);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_SetupFlopOnGround(mut this:
                                                              *mut EnFish) {
    let mut pad: s32 = 0;
    let mut randomFloat: f32_0 = 0.;
    let mut playSound: s32 = 0;
    (*this).actor.gravity = -1.0f32;
    (*this).actor.minVelocityY = -10.0f32;
    randomFloat = Rand_ZeroOne();
    if randomFloat < 0.1f32 {
        (*this).actor.velocity.y = Rand_ZeroOne() * 3.0f32 + 2.5f32;
        playSound = 1 as libc::c_int
    } else if randomFloat < 0.2f32 {
        (*this).actor.velocity.y = Rand_ZeroOne() * 1.2f32 + 0.2f32;
        playSound = 1 as libc::c_int
    } else {
        (*this).actor.velocity.y = 0.0f32;
        if Rand_ZeroOne() < 0.2f32 {
            playSound = 1 as libc::c_int
        } else { playSound = 0 as libc::c_int }
    }
    (*this).actor.shape.yOffset = 300.0f32;
    EnFish_SetOutOfWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Dropped_FlopOnGround as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
    (*this).unk_250 = 5 as libc::c_int;
    if playSound != 0 && (*this).actor.draw.is_some() {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x2869 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_FlopOnGround(mut this: *mut EnFish,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut frames: s16 = (*globalCtx).state.frames as s16;
    let mut targetXRot: s16 = 0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, Rand_ZeroOne() * 0.2f32,
                       0.1f32, 0.1f32, 0.0f32);
    targetXRot =
        (((frames as libc::c_int >> 5 as libc::c_int & 2 as libc::c_int |
               frames as libc::c_int >> 2 as libc::c_int & 1 as libc::c_int)
              << 0xb as libc::c_int) as s16 as libc::c_int as libc::c_float *
             0.3f32) as s16;
    if frames as libc::c_int & 4 as libc::c_int != 0 {
        targetXRot = -(targetXRot as libc::c_int) as s16
    }
    Math_StepToAngleS(&mut (*this).actor.world.rot.x, targetXRot,
    ...
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             ((Math_SinS((*this).slowPhase) * 2000.0f32 +
                   Math_SinS((*this).fastPhase) * 1000.0f32) * Rand_ZeroOne())
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_SetupSwimAway(mut this: *mut EnFish) {
    ...
    EnFish_SetInWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Dropped_SwimAway as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
    (*this).unk_250 = 5 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Dropped_SwimAway(mut this: *mut EnFish,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 2.8f32, 0.1f32, 0.4f32,
                       0.0f32);
    ...
    Math_StepToAngleS(&mut (*this).actor.world.rot.x, 0 as libc::c_int as s16,
                      1500 as libc::c_int as s16);
    Math_StepToAngleS(&mut (*this).actor.world.rot.y,
                      (*this).actor.home.rot.y, 3000 as libc::c_int as s16);
    Math_StepToAngleS(&mut (*this).actor.world.rot.z, 0 as libc::c_int as s16,
                      1000 as libc::c_int as s16);
    (*this).actor.shape.rot = (*this).actor.world.rot;
    // Raise if on a floor.
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_StepToF(&mut (*this).actor.world.pos.y,
                     (*this).actor.home.pos.y - 4.0f32, 2.0f32);
    } else {
        Math_StepToF(&mut (*this).actor.world.pos.y,
                     (*this).actor.home.pos.y - 10.0f32, 2.0f32);
    }
    // Shrink when close to disappearing.
    if ((*this).timer as libc::c_int) < 100 as libc::c_int {
        Actor_SetScale(&mut (*this).actor, (*this).actor.scale.x * 0.982f32);
    }
    (*this).skelAnime.playSpeed =
        if (*this).actor.speedXZ * 1.5f32 + 1.0f32 > 4.0f32 {
            4.0f32
        } else { ((*this).actor.speedXZ * 1.5f32) + 1.0f32 };
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Unique_SetupSwimIdle(mut this: *mut EnFish) {
    (*this).actor.gravity = 0.0f32;
    (*this).actor.minVelocityY = 0.0f32;
    (*this).timer =
        Rand_S16Offset(5 as libc::c_int as s16, 35 as libc::c_int as s16);
    ...
    EnFish_SetInWaterAnimation(this);
    (*this).actionFunc =
        Some(EnFish_Unique_SwimIdle as
                 unsafe extern "C" fn(_: *mut EnFish, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Unique_SwimIdle(mut this: *mut EnFish,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    static mut speedStopping: [f32_0; 3] = [0.0f32, 0.04f32, 0.09f32];
    static mut speedMoving: [f32_0; 3] = [0.5f32, 0.1f32, 0.15f32];
    let mut playSpeed: f32_0 = 0.;
    let mut frames: u32_0 = (*globalCtx).gameplayFrames;
    let mut speed: *mut f32_0 = 0 as *mut f32_0;
    let mut pad2: s32 = 0;
    let mut extraPlaySpeed: f32_0 = 0.;
    let mut pad3: s32 = 0;
    if (*this).actor.xzDistToPlayer < 60.0f32 {
        if ((*this).timer as libc::c_int) < 12 as libc::c_int {
            speed = speedMoving.as_mut_ptr()
        } else { speed = speedStopping.as_mut_ptr() }
    } else if ((*this).timer as libc::c_int) < 4 as libc::c_int {
        speed = speedMoving.as_mut_ptr()
    } else { speed = speedStopping.as_mut_ptr() }
    EnFish_SetYOffset(this);
    Math_SmoothStepToF(&mut (*this).actor.speedXZ,
                       *speed.offset(0 as libc::c_int as isize),
                       *speed.offset(1 as libc::c_int as isize),
                       *speed.offset(2 as libc::c_int as isize), 0.0f32);
    extraPlaySpeed = 0.0f32;
    if EnFish_XZDistanceSquared(&mut (*this).actor.world.pos,
                                &mut (*this).actor.home.pos) >
           15.0f32 * 15.0f32 {
        if Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                              Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                                             &mut (*this).actor.home.pos),
                              200 as libc::c_int as s16) == 0 {
            extraPlaySpeed = 0.5f32
        }
    } else if ((*this).timer as libc::c_int) < 4 as libc::c_int &&
                  Math_ScaledStepToS(&mut (*this).actor.world.rot.y,
                                     frames.wrapping_mul(0x80 as libc::c_int
                                                             as libc::c_uint)
                                         as s16, 100 as libc::c_int as s16) ==
                      0 {
        extraPlaySpeed = 0.5f32
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    playSpeed = (*this).actor.speedXZ * 1.2f32 + 0.2f32 + extraPlaySpeed;
    (*this).skelAnime.playSpeed =
        if playSpeed < 1.5f32 {
            1.5f32 as libc::c_double
        } else if playSpeed as libc::c_double > 0.5f64 {
            0.5f64
        } else { playSpeed as libc::c_double } as f32_0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int <= 0 as libc::c_int {
        (*this).timer =
            Rand_S16Offset(5 as libc::c_int as s16, 80 as libc::c_int as s16)
    };
}
// Cutscene functions
#[no_mangle]
pub unsafe extern "C" fn EnFish_Cutscene_FlopOnGround(mut this: *mut EnFish,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    let mut sp24: f32_0 = Math_SinS((*this).slowPhase);
    let mut sp20: f32_0 = Math_SinS((*this).fastPhase);
    D_80A17014 += D_80A17018;
    if D_80A17014 <= 1.0f32 {
        D_80A17014 = 1.0f32;
        if Rand_ZeroOne() < 0.1f32 {
            D_80A17018 = Rand_ZeroOne() * 3.0f32 + 2.0f32;
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x2869 as libc::c_int as u16_0);
        } else { D_80A17018 = 0.0f32 }
    } else { D_80A17018 -= 0.4f32 }
    (*this).skelAnime.playSpeed = (sp24 + sp20) * 0.5f32 + 2.0f32;
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Cutscene_WiggleFlyingThroughAir(mut this:
                                                                    *mut EnFish,
                                                                mut globalCtx:
                                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp28: f32_0 = Math_SinS((*this).slowPhase);
    let mut sp24: f32_0 = Math_SinS((*this).fastPhase);
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int - 500 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.z =
        ((*this).actor.shape.rot.z as libc::c_int + 100 as libc::c_int) as
            s16;
    Math_StepToF(&mut D_80A17014, 0.0f32, 1.0f32);
    (*this).skelAnime.playSpeed = (sp28 + sp24) * 0.5f32 + 2.0f32;
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_UpdateCutscene(mut this: *mut EnFish,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pad2: s32 = 0;
    ...
    let mut progress: f32_0 = 0.;
    let mut bgId: s32 = 0;
    if csAction.is_null() {
        // "Warning : DEMO ended without dousa (action) 3 termination being called"
        osSyncPrintf(b"Warning : dousa 3 \xe6\xb6\x88\xe6\xbb\x85 \xe3\x81\x8c\xe5\x91\xbc\xe3\x81\xb0\xe3\x82\x8c\xe3\x81\x9a\xe3\x81\xab\xe3\x83\x87\xe3\x83\xa2\xe3\x81\x8c\xe7\xb5\x82\xe4\xba\x86\xe3\x81\x97\xe3\x81\x9f(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_en_sakana.c\x00" as *const u8 as
    ...
    (*this).slowPhase =
        ((*this).slowPhase as libc::c_int + 0x111 as libc::c_int) as s16;
    (*this).fastPhase =
        ((*this).fastPhase as libc::c_int + 0x500 as libc::c_int) as s16;
    match (*csAction).action as libc::c_int {
        1 => { EnFish_Cutscene_FlopOnGround(this, globalCtx); }
        2 => { EnFish_Cutscene_WiggleFlyingThroughAir(this, globalCtx); }
        3 => {
            // "DEMO fish termination"
            osSyncPrintf(b"\xe3\x83\x87\xe3\x83\xa2\xe9\xad\x9a\xe6\xb6\x88\xe6\xbb\x85\n\x00"
                             as *const u8 as *const libc::c_char);
            EnFish_ClearCutsceneData(this);
            Actor_Kill(&mut (*this).actor);
            return
        ...
        _ => {
            ...
            osSyncPrintf(b"\xe4\xb8\x8d\xe6\xad\xa3\xe3\x81\xaa\xe3\x83\x87\xe3\x83\xa2\xe5\x8b\x95\xe4\xbd\x9c(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_en_sakana.c\x00" as *const u8 as
    ...
    (*this).actor.world.pos.x =
        (endPos.x - startPos.x) * progress + startPos.x;
    (*this).actor.world.pos.y =
        (endPos.y - startPos.y) * progress + startPos.y + D_80A17014;
    (*this).actor.world.pos.z =
        (endPos.z - startPos.z) * progress + startPos.z;
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_OrdinaryUpdate(mut this: *mut EnFish,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ...
    if (*this).actionFunc.is_none() ||
           {
               (*this).actionFunc.expect("non-null function pointer")(this,
                                                                      globalCtx);
               ((*this).actor.update.is_some() as libc::c_int) != 0
           } {
        Actor_MoveForward(&mut (*this).actor);
        if (*this).unk_250 != 0 as libc::c_int {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 17.5f32,
                                    4.0f32, 0.0f32, (*this).unk_250);
        }
        ...
        Actor_SetFocus(&mut (*this).actor,
                       (*this).actor.shape.yOffset * 0.01f32);
        ...
        } else if EnFish_InBottleRange(this, globalCtx) != 0 {
            // GI_MAX in this case allows the player to catch the actor in a bottle
            func_8002F434(&mut (*this).actor, globalCtx,
                          GI_MAX as libc::c_int, 80.0f32, 20.0f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_RespawningUpdate(mut this: *mut EnFish,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).actor.params as libc::c_int ==
           FISH_SWIMMING_UNIQUE as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
    }
    if !(*this).actor.child.is_null() &&
    ...
    if (*this).actionFunc.is_none() ||
        ...
        Actor_MoveForward(&mut (*this).actor);
        if (*this).respawnTimer as libc::c_int == 20 as libc::c_int {
            (*this).actor.draw =
                Some(EnFish_Draw as
                         unsafe extern "C" fn(_: *mut Actor,
                                              _: *mut GlobalContext) -> ())
        } else if (*this).respawnTimer as libc::c_int == 0 as libc::c_int {
            Actor_SetScale(&mut (*this).actor, 0.01f32);
        } else if ((*this).respawnTimer as libc::c_int) < 20 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFish_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFish = thisx as *mut EnFish;
    if D_80A17010.is_null() &&
           (*this).actor.params as libc::c_int == FISH_DROPPED as libc::c_int
    ...
    if !D_80A17010.is_null() && &mut (*this).actor as *mut Actor == D_80A17010
       {
        EnFish_UpdateCutscene(this, globalCtx);
    } else if (*this).respawnTimer as libc::c_int > 0 as libc::c_int {
        (*this).respawnTimer -= 1;
        EnFish_RespawningUpdate(this, globalCtx);
    } else { EnFish_OrdinaryUpdate(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnFish_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFish = thisx as *mut EnFish;
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(900 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
