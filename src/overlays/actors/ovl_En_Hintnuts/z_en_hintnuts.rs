...
extern "C" {
    ...
    #[no_mangle]
    static mut gHintNutsLookAroundAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsFreezeAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsUpAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsTalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gHintNutsStandAnim: AnimationHeader;
    #[no_mangle]
...
pub struct EnHintnuts {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnHintnutsActionFunc,
    pub animFlagAndTimer: s16,
    pub unk_196: s16,
    pub textIdCopy: u16_0,
    pub jointTable: [Vec3s; 10],
    pub morphTable: [Vec3s; 10],
    pub collider: ColliderCylinder,
}
pub type EnHintnutsActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHintnuts, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Hintnuts_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HINTNUTS as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_HINTNUTS as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHintnuts>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHintnuts_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHintnuts_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHintnuts_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHintnuts_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sPuzzleCounter: s16 = 0 as libc::c_int as s16;
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHintnuts = thisx as *mut EnHintnuts;
    let mut pad: s32 = 0;
    ...
    if (*this).actor.params as libc::c_int == 0xa as libc::c_int {
        ...
        ActorShape_Init(&mut (*this).actor.shape, 0 as libc::c_int as f32_0,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                                      ...
                                                      _: *mut GlobalContext)
                                     -> ()), 35.0f32);
        SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gHintNutsSkel,
                       &mut gHintNutsStandAnim,
        ...
        (*this).actor.params =
            ((*this).actor.params as libc::c_int & 0xff as libc::c_int) as
                s16;
        sPuzzleCounter = 0 as libc::c_int as s16;
        if (*this).actor.textId as libc::c_int == 0x109b as libc::c_int {
            if Flags_GetClear(globalCtx, 0x9 as libc::c_int) !=
                   0 as libc::c_int {
        ...
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                           globalCtx, ACTOR_EN_HINTNUTS as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnHintnuts = thisx as *mut EnHintnuts;
    if (*this).actor.params as libc::c_int != 0xa as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_HitByScrubProjectile1(mut this:
                                                              *mut EnHintnuts,
                                                          mut globalCtx:
                                                              *mut GlobalContext) {
    if (*this).actor.textId as libc::c_int != 0 as libc::c_int &&
           ...
           ((*this).actor.params as libc::c_int == 0 as libc::c_int ||
                sPuzzleCounter as libc::c_int == 2 as libc::c_int) {
        (*this).actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int |
                  (1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
        (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupWait(mut this: *mut EnHintnuts) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime, &mut gHintNutsUpAnim,
                               0.0f32);
    ...
    (*this).actionFunc =
        Some(EnHintnuts_Wait as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupLookAround(mut this:
                                                        *mut EnHintnuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gHintNutsLookAroundAnim);
    (*this).animFlagAndTimer = 2 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnHintnuts_LookAround as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupThrowScrubProjectile(mut this:
                                                                  *mut EnHintnuts) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gHintNutsSpitAnim);
    (*this).actionFunc =
        Some(EnHintnuts_ThrowNut as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupStand(mut this: *mut EnHintnuts) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gHintNutsStandAnim,
                          -3.0f32);
    if (*this).actionFunc ==
           Some(EnHintnuts_ThrowNut as
                    unsafe extern "C" fn(_: *mut EnHintnuts,
        ...
        (*this).animFlagAndTimer = 1 as libc::c_int as s16
    } // recovery heart
    (*this).actionFunc =
        Some(EnHintnuts_Stand as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupBurrow(mut this: *mut EnHintnuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gHintNutsBurrowAnim, -5.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x387d as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnHintnuts_Burrow as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_HitByScrubProjectile2(mut this:
                                                              *mut EnHintnuts) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gHintNutsUnburrowAnim, -3.0f32);
    ...
    if (*this).actor.params as libc::c_int > 0 as libc::c_int &&
           ...
           (*this).actor.category as libc::c_int ==
               ACTORCAT_ENEMY as libc::c_int {
        if sPuzzleCounter as libc::c_int == -(4 as libc::c_int) {
            sPuzzleCounter = 0 as libc::c_int as s16
        }
        if (*this).actor.params as libc::c_int ==
               sPuzzleCounter as libc::c_int + 1 as libc::c_int {
            sPuzzleCounter += 1
        } else {
            if sPuzzleCounter as libc::c_int > 0 as libc::c_int {
                sPuzzleCounter = -(sPuzzleCounter as libc::c_int) as s16
            }
            sPuzzleCounter -= 1
        }
        (*this).actor.flags |=
        ...
        (*this).actionFunc =
            Some(EnHintnuts_BeginFreeze as
                     unsafe extern "C" fn(_: *mut EnHintnuts,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(EnHintnuts_BeginRun as
                     unsafe extern "C" fn(_: *mut EnHintnuts,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupRun(mut this: *mut EnHintnuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gHintNutsRunAnim);
    (*this).animFlagAndTimer = 5 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnHintnuts_Run as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupTalk(mut this: *mut EnHintnuts) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gHintNutsTalkAnim,
                          -5.0f32);
    (*this).actionFunc =
        Some(EnHintnuts_Talk as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupLeave(mut this: *mut EnHintnuts,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gHintNutsRunAnim,
                          -5.0f32);
    (*this).actor.speedXZ = 3.0f32;
    (*this).animFlagAndTimer = 100 as libc::c_int as s16;
    ...
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ...
                0x3 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnHintnuts_Leave as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_SetupFreeze(mut this: *mut EnHintnuts) {
    Animation_PlayLoop(&mut (*this).skelAnime, &mut gHintNutsFreezeAnim);
    (*this).actor.flags &=
    ...
    (*this).actor.colorFilterTimer = 1 as libc::c_int as u8_0;
    (*this).animFlagAndTimer = 0 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3882 as libc::c_int as u16_0);
    if sPuzzleCounter as libc::c_int == -(3 as libc::c_int) {
        func_80078884(0x4806 as libc::c_int as u16_0);
        sPuzzleCounter = -(4 as libc::c_int) as s16
    }
    (*this).actionFunc =
        Some(EnHintnuts_Freeze as
                 unsafe extern "C" fn(_: *mut EnHintnuts,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Wait(mut this: *mut EnHintnuts,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if hasSlowPlaybackSpeed == 0 && (*this).actor.xzDistToPlayer < 120.0f32 {
        ...
        } else { EnHintnuts_SetupStand(this); }
    }
    if hasSlowPlaybackSpeed != 0 && 160.0f32 < (*this).actor.xzDistToPlayer &&
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_LookAround(mut this: *mut EnHintnuts,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Stand(mut this: *mut EnHintnuts,
                                          mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).actor.xzDistToPlayer < 120.0f32 ||
           (*this).animFlagAndTimer as libc::c_int == 0x1000 as libc::c_int {
        EnHintnuts_SetupBurrow(this);
    } else if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_ThrowNut(mut this: *mut EnHintnuts,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut nutPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
    ...
    if (*this).actor.xzDistToPlayer < 120.0f32 {
        ...
        nutPos.y = (*this).actor.world.pos.y + 12.0f32;
        nutPos.z =
            (*this).actor.world.pos.z +
                Math_CosS((*this).actor.shape.rot.y) * 23.0f32;
        if !Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_NUTSBALL as libc::c_int as s16, nutPos.x,
                        nutPos.y, nutPos.z, (*this).actor.shape.rot.x,
                        (*this).actor.shape.rot.y, (*this).actor.shape.rot.z,
                        1 as libc::c_int as s16).is_null() {
            Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Burrow(mut this: *mut EnHintnuts,
                                           mut globalCtx:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_BeginRun(mut this: *mut EnHintnuts,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).unk_196 =
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_BeginFreeze(mut this: *mut EnHintnuts,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_CheckProximity(mut this: *mut EnHintnuts,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if (*this).actor.category as libc::c_int != ACTORCAT_ENEMY as libc::c_int
       {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Run(mut this: *mut EnHintnuts,
                                        mut globalCtx: *mut GlobalContext) {
    let mut temp_ret: s32 = 0;
    let mut diffRotInit: s16 = 0;
    let mut diffRot: s16 = 0;
    let mut phi_f0: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    temp_ret = Animation_OnFrame(&mut (*this).skelAnime, 0.0f32);
    if temp_ret != 0 as libc::c_int &&
           (*this).animFlagAndTimer as libc::c_int != 0 as libc::c_int {
        (*this).animFlagAndTimer -= 1
    }
    if temp_ret != 0 as libc::c_int ||
    ...
    if Math_SmoothStepToS(&mut (*this).actor.world.rot.y, (*this).unk_196,
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 0x20 as libc::c_int !=
        ...
        } else if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int
         {
            ...
            if (if diffRot as libc::c_int >= 0 as libc::c_int {
                ...
                } else { -(diffRot as libc::c_int) }) >= 0x2001 as libc::c_int
               {
                (*this).unk_196 = diffRotInit
            } else {
                phi_f0 =
                    if 0.0f32 <= diffRot as f32_0 { 1.0f32 } else { -1.0f32 };
                (*this).unk_196 =
                    (phi_f0 * -8192.0f32 +
                         (*this).actor.yawTowardsPlayer as f32_0) as s16
            }
        } else {
            (*this).unk_196 =
                ((*this).actor.yawTowardsPlayer as libc::c_int +
    ...
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        EnHintnuts_SetupTalk(this);
                  ...
                  fabsf((*this).actor.world.pos.y - (*this).actor.home.pos.y)
                      < 2.0f32 {
        (*this).actor.speedXZ = 0.0f32;
        if (*this).actor.category as libc::c_int == ACTORCAT_BG as libc::c_int
           {
            (*this).actor.flags &=
                !((1 as libc::c_int) << 0 as libc::c_int |
        ...
        EnHintnuts_SetupBurrow(this);
    } else { EnHintnuts_CheckProximity(this, globalCtx); };
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Talk(mut this: *mut EnHintnuts,
                                         mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0x3 as libc::c_int as s16, 0x400 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Leave(mut this: *mut EnHintnuts,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        ...
        if (if temp_a1 as libc::c_int >= 0 as libc::c_int {
                temp_a1 as libc::c_int
            } else { -(temp_a1 as libc::c_int) }) >= 0x4001 as libc::c_int {
            temp_a1 =
                (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                 as usize]) as
                     libc::c_int + 0x8000 as libc::c_int) as s16
            ...
            temp_a1 =
                (Camera_GetCamDirYaw((*globalCtx).cameraPtrs[(*globalCtx).activeCamera
                                                                 as usize]) as
                     libc::c_int -
                     (temp_a1 as libc::c_int >> 1 as libc::c_int) +
                     0x8000 as libc::c_int) as s16
        }
    }
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.y, temp_a1,
    ...
    if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int ||
        ...
        if (*this).actor.params as libc::c_int == 3 as libc::c_int {
            ...
            sPuzzleCounter = 3 as libc::c_int as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Freeze(mut this: *mut EnHintnuts,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    (*this).actor.colorFilterTimer = 1 as libc::c_int as u8_0;
    SkelAnime_Update(&mut (*this).skelAnime);
    ...
    if (*this).animFlagAndTimer as libc::c_int == 0 as libc::c_int {
        if sPuzzleCounter as libc::c_int == 3 as libc::c_int {
            ...
            (*this).animFlagAndTimer = 1 as libc::c_int as s16
        } else if sPuzzleCounter as libc::c_int == -(4 as libc::c_int) {
            (*this).animFlagAndTimer = 2 as libc::c_int as s16
        }
    } else if Math_StepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.home.pos.y - 35.0f32, 7.0f32) !=
                  0 as libc::c_int {
        if (*this).animFlagAndTimer as libc::c_int == 1 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        } else {
            (*this).actor.flags |=
                ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_ColliderCheck(mut this: *mut EnHintnuts,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        Actor_SetDropFlag(&mut (*this).actor, &mut (*this).collider.info,
                          1 as libc::c_int);
        if (*(*this).collider.base.ac).id as libc::c_int !=
               ACTOR_EN_NUTSBALL as libc::c_int {
            EnHintnuts_SetupBurrow(this);
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHintnuts = thisx as *mut EnHintnuts;
    let mut pad: s32 = 0;
            ...
            Actor_SetFocus(&mut (*this).actor,
                           20.0f32 -
                               (*this).skelAnime.curFrame * 20.0f32 /
                                   Animation_GetLastFrame(&mut gHintNutsBurrowAnim
                                                              as
                                                              *mut AnimationHeader
                                                              as
                                                              *mut libc::c_void)
...
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 5 as libc::c_int &&
        ...
        if curFrame <= 6.0f32 {
            vec.y = 1.0f32 - curFrame * 0.0833f32;
            vec.z = 1.0f32 + curFrame * 0.1167f32;
            vec.x = 1.0f32 + curFrame * 0.1167f32
        } else if curFrame <= 7.0f32 {
            curFrame -= 6.0f32;
            vec.y = 0.5f32 + curFrame;
            vec.z = 1.7f32 - curFrame * 0.7f32;
            vec.x = 1.7f32 - curFrame * 0.7f32
        } else if curFrame <= 10.0f32 {
            vec.y = 1.5f32 - (curFrame - 7.0f32) * 0.1667f32;
            vec.z = 1.0f32;
            vec.x = 1.0f32
        } else { return 0 as libc::c_int }
        Matrix_Scale(vec.x, vec.y, vec.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnHintnuts_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnHintnuts = thisx as *mut EnHintnuts;
    if (*this).actor.params as libc::c_int == 0xa as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gHintNutsFlowerDL.as_mut_ptr());
    } else {
        SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                          (*this).skelAnime.jointTable,
                          Some(EnHintnuts_OverrideLimbDraw as
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_value(0xa as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
