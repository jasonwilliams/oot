...
pub struct ObjTimeblock {
    ...
    pub actionFunc: ObjTimeblockActionFunc,
    pub songObserverFunc: ObjTimeblockSongObserverFunc,
    pub demoEffectTimer: s16,
    pub songEndTimer: s16,
    pub demoEffectFirstPartTimer: s16,
    pub unk_172: u16_0,
    pub unk_174: u8_0,
    pub unk_175: u8_0,
    pub unk_176: u8_0,
...
pub type ObjTimeblockSongObserverFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjTimeblock, _: *mut GlobalContext)
               -> s32>;
pub type ObjTimeblockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjTimeblock, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjTimeblockSizeOptions {
    pub scale: f32_0,
    pub height: f32_0,
    pub demoEffectParams: s16,
}
#[no_mangle]
pub static mut Obj_Timeblock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_TIMEBLOCK as libc::c_int as s16,
                          category:
                          ...
                          instanceSize:
                              ::std::mem::size_of::<ObjTimeblock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTimeblock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTimeblock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTimeblock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjTimeblock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
// size = 0x0C
static mut sSizeOptions: [ObjTimeblockSizeOptions; 2] =
    [{
         let mut init =
             ObjTimeblockSizeOptions{scale: 1.0f64 as f32_0,
                                     height: 60.0f64 as f32_0,
                                     demoEffectParams:
                                         0x18 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             ObjTimeblockSizeOptions{scale: 0.60f64 as f32_0,
                                     height: 40.0f64 as f32_0,
                                     demoEffectParams:
                                         0x19 as libc::c_int as s16,};
         init
     }];
static mut sRanges: [f32_0; 8] =
    [60.0f64 as f32_0, 100.0f64 as f32_0, 140.0f64 as f32_0,
     180.0f64 as f32_0, 220.0f64 as f32_0, 260.0f64 as f32_0,
     300.0f64 as f32_0, 300.0f64 as f32_0];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut sPrimColors: [Color_RGB8; 8] =
    [{
         let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_CalculateIsVisible(mut this:
                                                             *mut ObjTimeblock)
 -> u32_0 {
    if (*this).dyna.actor.params as libc::c_int >> 10 as libc::c_int &
           1 as libc::c_int == 0 {
        if (*this).unk_177 as libc::c_int == 0 as libc::c_int {
            return (*this).unk_175 as u32_0
        } else {
            let mut temp: u8_0 =
            ...
            if (*this).unk_177 as libc::c_int == 1 as libc::c_int {
                return ((*this).unk_174 as libc::c_int ^ temp as libc::c_int)
                           as u32_0
            } else {
                let mut linkIsYoung: u8_0 =
                ...
                return ((*this).unk_174 as libc::c_int ^ temp as libc::c_int ^
                            linkIsYoung as libc::c_int) as u32_0
            }
        }
    } else {
        return ((if (*this).dyna.actor.params as libc::c_int >>
                        15 as libc::c_int & 1 as libc::c_int != 0 {
                     1 as libc::c_int
                 } else { 0 as libc::c_int }) ^
                    (*this).unk_174 as libc::c_int) as u32_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_SpawnDemoEffect(mut this:
                                                          *mut ObjTimeblock,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                ...
                sSizeOptions[((*this).dyna.actor.params as libc::c_int >>
                                  8 as libc::c_int & 1 as libc::c_int) as
                                 usize].demoEffectParams);
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_ToggleSwitchFlag(mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut flag: s32) {
    if Flags_GetSwitch(globalCtx, flag) != 0 {
        Flags_UnsetSwitch(globalCtx, flag);
    } else { Flags_SetSwitch(globalCtx, flag); };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjTimeblock = thisx as *mut ObjTimeblock;
    let mut pad: s32 = 0;
    ...
    Actor_SetScale(&mut (*this).dyna.actor,
                   sSizeOptions[((*this).dyna.actor.params as libc::c_int >>
                                     8 as libc::c_int & 1 as libc::c_int) as
                                    usize].scale);
    if (*this).dyna.actor.params as libc::c_int >> 6 as libc::c_int &
           1 as libc::c_int != 0 {
        (*this).unk_177 = 0 as libc::c_int as u8_0
    } else {
        (*this).unk_177 =
            if ((*this).dyna.actor.params as libc::c_int &
                    0x3f as libc::c_int) < 0x38 as libc::c_int {
                2 as libc::c_int
            } else { 1 as libc::c_int } as u8_0
    }
    (*this).songObserverFunc =
        Some(ObjTimeblock_WaitForOcarina as
                 unsafe extern "C" fn(_: *mut ObjTimeblock,
    ...
    (*this).unk_175 =
        if (*this).dyna.actor.params as libc::c_int >> 15 as libc::c_int &
               1 as libc::c_int != 0 {
            1 as libc::c_int
        } else { 0 as libc::c_int } as u8_0;
    (*this).isVisible = ObjTimeblock_CalculateIsVisible(this) as u8_0;
    if (*this).dyna.actor.params as libc::c_int >> 10 as libc::c_int &
           1 as libc::c_int == 0 {
        ObjTimeblock_SetupNormal(this);
    } else if (*this).isVisible != 0 {
        ObjTimeblock_SetupAltBehaviorVisible(this);
    } else { ObjTimeblock_SetupAltBehaviourNotVisible(this); }
    // "Block of time"
    osSyncPrintf(b"\xe6\x99\x82\xe3\x81\xae\xe3\x83\x96\xe3\x83\xad\xe3\x83\x83\xe3\x82\xaf (<arg> %04xH <type> save:%d color:%d range:%d move:%d)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as u16_0 as libc::c_int,
                 (*this).unk_177 as libc::c_int,
                 (*this).dyna.actor.home.rot.z as libc::c_int &
                     7 as libc::c_int,
                 (*this).dyna.actor.params as libc::c_int >> 11 as libc::c_int
                     & 7 as libc::c_int,
                 (*this).dyna.actor.params as libc::c_int >> 10 as libc::c_int
                     & 1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut ObjTimeblock = thisx as *mut ObjTimeblock;
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_PlayerIsInRange(mut this:
                                                          *mut ObjTimeblock,
                                                      mut globalCtx:
                                                          *mut GlobalContext)
 -> u8_0 {
    if (*this).isVisible as libc::c_int != 0 &&
           func_80043590(&mut (*this).dyna) != 0 {
        return 0 as libc::c_int as u8_0
    }
    if (*this).dyna.actor.xzDistToPlayer <=
           sRanges[((*this).dyna.actor.params as libc::c_int >>
                        11 as libc::c_int & 7 as libc::c_int) as usize] {
        let mut distance: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut blockSize: f32_0 = 0.;
        func_8002DBD0(&mut (*this).dyna.actor, &mut distance,
        ...
        blockSize = (*this).dyna.actor.scale.x * 50.0f32 + 6.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_WaitForOcarina(mut this:
                                                         *mut ObjTimeblock,
                                                     mut globalCtx:
                                                         *mut GlobalContext)
 -> s32 {
    ...
    if ObjTimeblock_PlayerIsInRange(this, globalCtx) != 0 {
        if (*player).stateFlags2 & 0x1000000 as libc::c_int as libc::c_uint !=
            ...
            (*this).songObserverFunc =
                Some(ObjTimeblock_WaitForSong as
                         unsafe extern "C" fn(_: *mut ObjTimeblock,
                                              _: *mut GlobalContext) -> s32)
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_WaitForSong(mut this: *mut ObjTimeblock,
                                                  mut globalCtx:
                                                      *mut GlobalContext)
 -> s32 {
    ...
    if (*globalCtx).msgCtx.lastPlayedSong as libc::c_int ==
        ...
        if (*this).unk_172 as libc::c_int == 254 as libc::c_int {
            (*this).songEndTimer = 110 as libc::c_int as s16
        } else {
            (*this).songEndTimer -= 1;
            if (*this).songEndTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_SetupDoNothing(mut this:
                                                         *mut ObjTimeblock) {
    (*this).actionFunc =
        Some(ObjTimeblock_DoNothing as
                 unsafe extern "C" fn(_: *mut ObjTimeblock,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_DoNothing(mut this: *mut ObjTimeblock,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_SetupNormal(mut this:
                                                      *mut ObjTimeblock) {
    (*this).actionFunc =
        Some(ObjTimeblock_Normal as
                 unsafe extern "C" fn(_: *mut ObjTimeblock,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_Normal(mut this: *mut ObjTimeblock,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut newIsVisible: u32_0 = 0;
    if (*this).songObserverFunc.expect("non-null function pointer")(this,
                                                                    globalCtx)
           != 0 && (*this).demoEffectTimer as libc::c_int <= 0 as libc::c_int
       {
        ObjTimeblock_SpawnDemoEffect(this, globalCtx);
        (*this).demoEffectTimer = 160 as libc::c_int as s16;
        ...
        osSyncPrintf(b"\xe2\x97\xaf\xe2\x97\xaf\xe2\x97\xaf\xe2\x97\xaf Time Block \xe6\xb3\xa8\xe7\x9b\xae\xe3\x82\xab\xe3\x83\xa1\xe3\x83\xa9 (frame counter  %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*globalCtx).state.frames);
        (*this).demoEffectFirstPartTimer = 12 as libc::c_int as s16;
        if (*this).unk_177 as libc::c_int == 0 as libc::c_int {
            (*this).dyna.actor.params =
                ((*this).dyna.actor.params as libc::c_int ^
                     0x8000 as libc::c_int) as s16
        } else {
            ObjTimeblock_ToggleSwitchFlag(globalCtx,
    ...
    if (*this).demoEffectFirstPartTimer as libc::c_int > 0 as libc::c_int {
        (*this).demoEffectFirstPartTimer -= 1;
        if (*this).demoEffectFirstPartTimer as libc::c_int == 0 as libc::c_int
           {
            if (*this).unk_177 as libc::c_int == 0 as libc::c_int {
                (*this).unk_175 =
    ...
    if (*this).unk_177 as libc::c_int == 1 as libc::c_int &&
           newIsVisible != (*this).isVisible as libc::c_uint {
        ObjTimeblock_SetupDoNothing(this);
    }
    (*this).isVisible = newIsVisible as u8_0;
    if (*this).demoEffectTimer as libc::c_int == 50 as libc::c_int {
        func_80078884(0x4807 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80BA06AC(mut this: *mut ObjTimeblock,
    ...
    if (*this).demoEffectFirstPartTimer as libc::c_int > 0 as libc::c_int &&
           {
               (*this).demoEffectFirstPartTimer -= 1;
               ((*this).demoEffectFirstPartTimer as libc::c_int) ==
                   0 as libc::c_int
           } {
        (*this).unk_174 =
            if Flags_GetSwitch(globalCtx, switchFlag) != 0 {
                1 as libc::c_int
            } else { 0 as libc::c_int } as u8_0
    }
    (*this).isVisible = ObjTimeblock_CalculateIsVisible(this) as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_SetupAltBehaviorVisible(mut this:
                                                                  *mut ObjTimeblock) {
    (*this).actionFunc =
        Some(ObjTimeblock_AltBehaviorVisible as
                 unsafe extern "C" fn(_: *mut ObjTimeblock,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_AltBehaviorVisible(mut this:
                                                             *mut ObjTimeblock,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if (*this).songObserverFunc.expect("non-null function pointer")(this,
    ...
    if (*this).isVisible == 0 &&
           (*this).demoEffectTimer as libc::c_int <= 0 as libc::c_int {
        ObjTimeblock_SetupAltBehaviourNotVisible(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_SetupAltBehaviourNotVisible(mut this:
                                                                      *mut ObjTimeblock) {
    (*this).actionFunc =
        Some(ObjTimeblock_AltBehaviourNotVisible as
                 unsafe extern "C" fn(_: *mut ObjTimeblock,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_AltBehaviourNotVisible(mut this:
                                                                 *mut ObjTimeblock,
                                                             mut globalCtx:
                                                                 *mut GlobalContext) {
    let mut switchFlag: s32 =
        (*this).dyna.actor.params as libc::c_int & 0x3f as libc::c_int;
    let mut switchFlagIsSet: s8 =
        if Flags_GetSwitch(globalCtx, switchFlag) != 0 {
            1 as libc::c_int
        } else { 0 as libc::c_int } as s8;
    if (*this).unk_176 as libc::c_int ^ switchFlagIsSet as libc::c_int != 0 &&
           switchFlagIsSet as libc::c_int ^
               (if (*this).dyna.actor.params as libc::c_int >>
                       15 as libc::c_int & 1 as libc::c_int != 0 {
                    1 as libc::c_int
                } else { 0 as libc::c_int }) != 0 {
        if (*this).demoEffectTimer as libc::c_int <= 0 as libc::c_int {
            ObjTimeblock_SpawnDemoEffect(this, globalCtx);
            (*this).demoEffectTimer = 160 as libc::c_int as s16
        }
        (*this).demoEffectFirstPartTimer = 12 as libc::c_int as s16
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjTimeblock = thisx as *mut ObjTimeblock;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).demoEffectTimer as libc::c_int > 0 as libc::c_int {
        (*this).demoEffectTimer -= 1
    }
    if (*this).isVisible != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjTimeblock_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*(thisx as *mut ObjTimeblock)).isVisible != 0 {
        let mut primColor: *mut Color_RGB8 =
            &mut *sPrimColors.as_mut_ptr().offset(((*thisx).home.rot.z as
                                                       libc::c_int &
                                                       7 as libc::c_int) as
                                                      isize) as
                *mut Color_RGB8;
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_obj_timeblock.c\x00" as *const u8 as
                            *const libc::c_char, 762 as libc::c_int);
