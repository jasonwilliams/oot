...
extern "C" {
    ...
    #[no_mangle]
    static mut object_brob_Anim_000290: AnimationHeader;
    #[no_mangle]
    static mut object_brob_Skel_0015D8: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_brob_Anim_001678: AnimationHeader;
    #[no_mangle]
    static mut object_brob_Anim_001750: AnimationHeader;
    #[no_mangle]
    static mut object_brob_Anim_001958: AnimationHeader;
    #[no_mangle]
    static mut object_brob_Col_001A70: CollisionHeader;
}
...
pub struct EnBrob {
    ...
    pub skelAnime: SkelAnime,
    pub actionFunc: EnBrobActionFunc,
    pub timer: s16,
    pub unk_1AE: s16,
...
pub type EnBrobActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Brob_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BROB as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_BROB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBrob>() as
                                  libc::c_ulong,
                          init:
...
pub unsafe extern "C" fn EnBrob_Init(mut thisx: *mut Actor,
    ...
    CollisionHeader_GetVirtual(&mut object_brob_Col_001A70 as
    ...
    CollisionCheck_SetInfo(&mut (*thisx).colChkInfo, 0 as *mut DamageTable,
                           &mut sColChkInfoInit);
    if (*thisx).params as libc::c_int >> 8 as libc::c_int &
        ...
        if (*thisx).params as libc::c_int != 0xff as libc::c_int {
            (*thisx).scale.y *=
                ((*thisx).params as libc::c_int & 0xff as libc::c_int) as
                    libc::c_float * (2.0f32 / 30.0f32)
        }
    }
    (*this).colliders[0 as libc::c_int as usize].dim.radius =
        ((*this).colliders[0 as libc::c_int as usize].dim.radius as
             libc::c_float * (*thisx).scale.x) as s16;
    (*this).colliders[0 as libc::c_int as usize].dim.height =
        ((*thisx).scale.y * 12000.0f32) as s16;
    (*this).colliders[0 as libc::c_int as usize].dim.yShift =
        0 as libc::c_int as s16;
    (*this).colliders[1 as libc::c_int as usize].dim.radius =
        ((*this).colliders[1 as libc::c_int as usize].dim.radius as
             libc::c_float * (*thisx).scale.x) as s16;
    (*this).colliders[1 as libc::c_int as usize].dim.height =
        ((*this).colliders[1 as libc::c_int as usize].dim.height as
             libc::c_float * (*thisx).scale.y) as s16;
    (*this).colliders[1 as libc::c_int as usize].dim.yShift =
        ((*this).colliders[1 as libc::c_int as usize].dim.yShift as
             libc::c_float * (*thisx).scale.y) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnBrob_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBrob = thisx as *mut EnBrob;
...
#[no_mangle]
pub unsafe extern "C" fn func_809CADDC(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    func_8003EC50(globalCtx, &mut (*globalCtx).colCtx.dyna,
                  (*this).dyna.bgId);
    (*this).timer =
        if (*this).actionFunc ==
               Some(func_809CB2B8 as
                        unsafe extern "C" fn(_: *mut EnBrob,
                                             _: *mut GlobalContext) -> ()) {
            200 as libc::c_int
        } else { 0 as libc::c_int } as s16;
    (*this).unk_1AE = 0 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809CB054 as
                 unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809CAE44(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut object_brob_Anim_001750);
    func_8003EBF8(globalCtx, &mut (*globalCtx).colCtx.dyna,
                  (*this).dyna.bgId);
    (*this).unk_1AE = 1000 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809CB114 as
                 unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809CAEA0(mut this: *mut EnBrob) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_brob_Anim_001958, -5.0f32);
    (*this).unk_1AE = 8000 as libc::c_int as s16;
    (*this).timer = 1200 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809CB218 as
                 unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809CAEF4(mut this: *mut EnBrob) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_brob_Anim_000290, -5.0f32);
    (*this).unk_1AE = ((*this).unk_1AE as libc::c_float - 125.0f32) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn func_809CAF88(mut this: *mut EnBrob) {
    Animation_Change(&mut (*this).skelAnime, &mut object_brob_Anim_001750,
                     -1.0f32,
                     Animation_GetLastFrame(&mut object_brob_Anim_001750 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, -5.0f32);
    (*this).unk_1AE = 8250 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809CB354 as
                 unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809CB008(mut this: *mut EnBrob) {
    Animation_MorphToLoop(&mut (*this).skelAnime,
                          &mut object_brob_Anim_001678, -5.0f32);
    (*this).timer = 10 as libc::c_int as s16;
    (*this).actionFunc =
        Some(func_809CB458 as
                 unsafe extern "C" fn(_: *mut EnBrob, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_809CB054(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        if func_8004356C(&mut (*this).dyna) != 0 as libc::c_int {
            func_8002F71C(globalCtx, &mut (*this).dyna.actor, 5.0f32,
                          (*this).dyna.actor.yawTowardsPlayer, 1.0f32);
            func_809CAE44(this, globalCtx);
        } else if (*this).dyna.actor.xzDistToPlayer < 300.0f32 {
            func_809CAE44(this, globalCtx);
        }
    } else if (*this).timer as libc::c_int >= 81 as libc::c_int {
        (*this).dyna.actor.colorFilterTimer = 80 as libc::c_int as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CB114(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if curFrame < 8.0f32 {
            (*this).unk_1AE =
                ((*this).unk_1AE as libc::c_float + 1000.0f32) as s16
        } else if curFrame < 12.0f32 {
            (*this).unk_1AE =
                ((*this).unk_1AE as libc::c_float + 250.0f32) as s16
        } else {
            (*this).unk_1AE =
                ((*this).unk_1AE as libc::c_float - 250.0f32) as s16
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_809CB218(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 6.0f32) != 0 ||
        ...
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x394a as libc::c_int as u16_0);
    }
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           (*this).dyna.actor.xzDistToPlayer > 500.0f32 {
        func_809CAF88(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CB2B8(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        func_809CADDC(this, globalCtx);
    } else if (*this).skelAnime.curFrame < 8.0f32 {
        (*this).unk_1AE =
            ((*this).unk_1AE as libc::c_float - 1250.0f32) as s16
    }
    (*this).dyna.actor.colorFilterTimer = 0x50 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_809CB354(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    let mut curFrame: f32_0 = 0.;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        func_809CADDC(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_809CB458(mut this: *mut EnBrob,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut i: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0 as libc::c_int as f32_0) !=
    ...
    dist1 =
        if (*globalCtx).gameplayFrames.wrapping_rem(2 as libc::c_int as
                                                        libc::c_uint) != 0 {
            0.0f32
        } else { ((*this).dyna.actor.scale.x) * 5500.0f32 };
    dist2 = (*this).dyna.actor.scale.x * 5500.0f32;
    i = 0 as libc::c_int;
    while i < 4 as libc::c_int {
        ...
        pos.y =
            (Rand_ZeroOne() * 15000.0f32 + 1000.0f32) *
                (*this).dyna.actor.scale.y + (*this).dyna.actor.world.pos.y;
        EffectSsLightning_Spawn(globalCtx, &mut pos, &mut primColor,
                                &mut envColor,
                                ((*this).dyna.actor.scale.y * 8000.0f32) as
                                    s16, (Rand_ZeroOne() * 65536.0f32) as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnBrob_Update(mut thisx: *mut Actor,
                                       mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnBrob = thisx as *mut EnBrob;
    let mut i: s32 = 0;
    let mut acHits: [s32; 2] = [0; 2];
    acHits[0 as libc::c_int as usize] =
        ((*this).colliders[0 as libc::c_int as usize].base.acFlags as
             libc::c_int & (1 as libc::c_int) << 1 as libc::c_int !=
             0 as libc::c_int) as libc::c_int;
    acHits[1 as libc::c_int as usize] =
        ((*this).colliders[1 as libc::c_int as usize].base.acFlags as
             libc::c_int & (1 as libc::c_int) << 1 as libc::c_int !=
             0 as libc::c_int) as libc::c_int;
    if acHits[0 as libc::c_int as usize] != 0 &&
           (*(*this).colliders[0 as libc::c_int as
                                   usize].info.acHitInfo).toucher.dmgFlags &
               0x10 as libc::c_int as libc::c_uint != 0 ||
           acHits[1 as libc::c_int as usize] != 0 &&
               (*(*this).colliders[1 as libc::c_int as
                                       usize].info.acHitInfo).toucher.dmgFlags
                   & 0x10 as libc::c_int as libc::c_uint != 0 {
        i = 0 as libc::c_int;
        while i < 2 as libc::c_int {
            (*this).colliders[i as usize].base.atFlags =
                ((*this).colliders[i as usize].base.atFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int |
                           (1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
            (*this).colliders[i as usize].base.acFlags =
                ((*this).colliders[i as usize].base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            i += 1
        }
        func_809CAEF4(this);
    } else if (*this).colliders[0 as libc::c_int as usize].base.atFlags as
                  libc::c_int & (1 as libc::c_int) << 1 as libc::c_int != 0 ||
                  (*this).colliders[1 as libc::c_int as usize].base.atFlags as
                      libc::c_int & (1 as libc::c_int) << 1 as libc::c_int !=
                      0 ||
                  acHits[0 as libc::c_int as usize] != 0 &&
                      (*(*this).colliders[0 as libc::c_int as
                                              usize].info.acHitInfo).toucher.dmgFlags
        ...
        if (*this).actionFunc ==
               Some(func_809CB114 as
                        unsafe extern "C" fn(_: *mut EnBrob,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).colliders[0 as libc::c_int as usize].base.atFlags as
...
#[no_mangle]
pub unsafe extern "C" fn EnBrob_PostLimbDraw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut limbIndex: s32,
    ...
    if limbIndex == 3 as libc::c_int {
        ...
        (*this).colliders[1 as libc::c_int as usize].dim.pos.y =
            (mtx.c2rust_unnamed.yw + 7.0f32) as s16;
        (*this).colliders[1 as libc::c_int as usize].dim.pos.z =
            mtx.c2rust_unnamed.zw as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBrob_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBrob = thisx as *mut EnBrob;
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_Translate(0.0f32, (*this).unk_1AE as f32_0, 0.0f32,
