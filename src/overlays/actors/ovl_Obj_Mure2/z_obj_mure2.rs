...
extern "C" {
    ...
    fn Actor_Spawn(actorCtx: *mut ActorContext, globalCtx: *mut GlobalContext,
     ...
     -> *mut Actor;
    #[no_mangle]
    fn Actor_Noop(actor: *mut Actor, globalCtx: *mut GlobalContext);
    #[no_mangle]
...
pub struct ObjMure2 {
    pub actor: Actor,
    pub actionFunc: ObjMure2ActionFunc,
    pub actorSpawnPtrList: [*mut Actor; 12],
    pub currentActorNum: u16_0,
    pub unk_184: f32_0,
}
pub type ObjMure2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjMure2, _: *mut GlobalContext)
               -> ()>;
pub type ObjMure2SetPosFunc
    =
    Option<unsafe extern "C" fn(_: *mut Vec3f, _: *mut ObjMure2) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct Mure2sScatteredShrubInfo {
    pub radius: s16,
    pub angle: s16,
}
#[no_mangle]
pub static mut Obj_Mure2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_MURE2 as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjMure2>() as
                                  libc::c_ulong,
                          init:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjMure2_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sDistSquared1: [f32_0; 3] =
    [1600.0f32 * 1600.0f32, 1600.0f32 * 1600.0f32, 1600.0f32 * 1600.0f32];
static mut sDistSquared2: [f32_0; 3] =
    [1705.0f32 * 1705.0f32, 1705.0f32 * 1705.0f32, 1705.0f32 * 1705.0f32];
static mut D_80B9A818: [s16; 3] =
    [9 as libc::c_int as s16, 12 as libc::c_int as s16,
     8 as libc::c_int as s16];
static mut sActorSpawnIDs: [s16; 3] =
    [ACTOR_EN_KUSA as libc::c_int as s16, ACTOR_EN_KUSA as libc::c_int as s16,
     ACTOR_EN_ISHI as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SetPosShrubCircle(mut vec: *mut Vec3f,
                                                    mut this: *mut ObjMure2) {
    let mut i: s32 = 0;
    Math_Vec3f_Copy(vec, &mut (*this).actor.world.pos);
    i = 1 as libc::c_int;
    while i <
              D_80B9A818[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] as libc::c_int {
        Math_Vec3f_Copy(vec.offset(i as isize), &mut (*this).actor.world.pos);
        let ref mut fresh0 = (*vec.offset(i as isize)).x;
        *fresh0 +=
            80.0f32 *
                Math_SinS(((i - 1 as libc::c_int) * 0x2000 as libc::c_int) as
                              s16);
        let ref mut fresh1 = (*vec.offset(i as isize)).z;
        *fresh1 +=
            80.0f32 *
                Math_CosS(((i - 1 as libc::c_int) * 0x2000 as libc::c_int) as
                              s16);
        i += 1
    };
}
static mut sScatteredShrubInfo: [Mure2sScatteredShrubInfo; 12] =
    [{
         let mut init =
             Mure2sScatteredShrubInfo{radius: 40 as libc::c_int as s16,
                                      angle: 0x666 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 40 as libc::c_int as s16,
                                      angle: 0x2ccc as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 40 as libc::c_int as s16,
                                      angle: 0x5999 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 40 as libc::c_int as s16,
                                      angle: 0x8666 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 20 as libc::c_int as s16,
                                      angle: 0xc000 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 80 as libc::c_int as s16,
                                      angle: 0x1333 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 80 as libc::c_int as s16,
                                      angle: 0x6ccc as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 80 as libc::c_int as s16,
                                      angle: 0x9333 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 80 as libc::c_int as s16,
                                      angle: 0xaccc as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 80 as libc::c_int as s16,
                                      angle: 0xc666 as libc::c_int as s16,};
         init
     },
     {
         let mut init =
             Mure2sScatteredShrubInfo{radius: 60 as libc::c_int as s16,
                                      angle: 0xe000 as libc::c_int as s16,};
         init
     }];
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SetPosShrubScattered(mut vec: *mut Vec3f,
                                                       mut this:
                                                           *mut ObjMure2) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              D_80B9A818[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] as libc::c_int {
        Math_Vec3f_Copy(vec.offset(i as isize), &mut (*this).actor.world.pos);
        let ref mut fresh2 = (*vec.offset(i as isize)).x;
        *fresh2 +=
            sScatteredShrubInfo[i as usize].radius as libc::c_int as
                libc::c_float *
                Math_CosS(sScatteredShrubInfo[i as usize].angle);
        let ref mut fresh3 = (*vec.offset(i as isize)).z;
        *fresh3 -=
            sScatteredShrubInfo[i as usize].radius as libc::c_int as
                libc::c_float *
                Math_SinS(sScatteredShrubInfo[i as usize].angle);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SetPosRockCircle(mut vec: *mut Vec3f,
                                                   mut this: *mut ObjMure2) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              D_80B9A818[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] as libc::c_int {
        Math_Vec3f_Copy(vec.offset(i as isize), &mut (*this).actor.world.pos);
        let ref mut fresh4 = (*vec.offset(i as isize)).x;
        *fresh4 += 80.0f32 * Math_SinS((i * 0x2000 as libc::c_int) as s16);
        let ref mut fresh5 = (*vec.offset(i as isize)).z;
        *fresh5 += 80.0f32 * Math_CosS((i * 0x2000 as libc::c_int) as s16);
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SetActorSpawnParams(mut params: *mut s16,
                                                      mut this:
                                                          *mut ObjMure2) {
    static mut actorSpawnParams: [s16; 3] =
        [0 as libc::c_int as s16, 0 as libc::c_int as s16,
         0 as libc::c_int as s16];
    let mut dropTable: s16 =
        ((*this).actor.params as libc::c_int >> 8 as libc::c_int &
             0xf as libc::c_int) as s16;
    if dropTable as libc::c_int >= 13 as libc::c_int {
        dropTable = 0 as libc::c_int as s16
    }
    *params =
        (actorSpawnParams[((*this).actor.params as libc::c_int &
                               3 as libc::c_int) as usize] as libc::c_int &
             0xf0ff as libc::c_int) as s16;
    *params =
        (*params as libc::c_int |
             (dropTable as libc::c_int) << 8 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SpawnActors(mut this: *mut ObjMure2,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    static mut setPosFunc: [ObjMure2SetPosFunc; 3] =
        unsafe {
            [Some(ObjMure2_SetPosShrubCircle as
                      unsafe extern "C" fn(_: *mut Vec3f, _: *mut ObjMure2)
                          -> ()),
             Some(ObjMure2_SetPosShrubScattered as
                      unsafe extern "C" fn(_: *mut Vec3f, _: *mut ObjMure2)
                          -> ()),
             Some(ObjMure2_SetPosRockCircle as
                      unsafe extern "C" fn(_: *mut Vec3f, _: *mut ObjMure2)
                          -> ())]
        };
    let mut actorNum: s32 =
        (*this).actor.params as libc::c_int & 3 as libc::c_int;
    let mut i: s32 = 0;
    let mut spawnPos: [Vec3f; 12] = [Vec3f{x: 0., y: 0., z: 0.,}; 12];
    let mut params: s16 = 0;
    setPosFunc[actorNum as
                   usize].expect("non-null function pointer")(spawnPos.as_mut_ptr(),
                                                              this);
    ObjMure2_SetActorSpawnParams(&mut params, this);
    i = 0 as libc::c_int;
    while i < D_80B9A818[actorNum as usize] as libc::c_int {
        if !(*this).actorSpawnPtrList[i as usize].is_null() {
            // "Warning : I already have a child (%s %d)(arg_data 0x%04x)"
            osSyncPrintf(b"Warning : \xe6\x97\xa2\xe3\x81\xab\xe5\xad\x90\xe4\xbe\x9b\xe3\x81\x8c\xe3\x81\x84\xe3\x82\x8b(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_obj_mure2.c\x00" as *const u8 as
                             *const libc::c_char, 269 as libc::c_int,
                         (*this).actor.params as libc::c_int);
        } else if (*this).currentActorNum as libc::c_int >> i &
                      1 as libc::c_int == 0 as libc::c_int {
            (*this).actorSpawnPtrList[i as usize] =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            sActorSpawnIDs[actorNum as usize],
                            spawnPos[i as usize].x, spawnPos[i as usize].y,
                            spawnPos[i as usize].z, (*this).actor.world.rot.x,
                            0 as libc::c_int as s16,
                            (*this).actor.world.rot.z, params);
            if !(*this).actorSpawnPtrList[i as usize].is_null() {
                (*(*this).actorSpawnPtrList[i as usize]).room =
                    (*this).actor.room
            }
        }
        i += 1
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_CleanupAndDie(mut this: *mut ObjMure2,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              D_80B9A818[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] as libc::c_int {
        if (*this).currentActorNum as libc::c_int >> i & 1 as libc::c_int ==
               0 as libc::c_int {
            if !(*this).actorSpawnPtrList[i as usize].is_null() {
                if Actor_HasParent((*this).actorSpawnPtrList[i as usize],
                                   globalCtx) != 0 {
                    (*this).currentActorNum =
                        ((*this).currentActorNum as libc::c_int |
                             (1 as libc::c_int) << i) as u16_0
                } else { Actor_Kill((*this).actorSpawnPtrList[i as usize]); }
                (*this).actorSpawnPtrList[i as usize] = 0 as *mut Actor
            }
        } else { (*this).actorSpawnPtrList[i as usize] = 0 as *mut Actor }
        i += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9A534(mut this: *mut ObjMure2) {
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i <
              D_80B9A818[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] as libc::c_int {
        if !(*this).actorSpawnPtrList[i as usize].is_null() &&
               (*this).currentActorNum as libc::c_int >> i & 1 as libc::c_int
                   == 0 as libc::c_int &&
               (*(*this).actorSpawnPtrList[i as usize]).update.is_none() {
            (*this).currentActorNum =
                ((*this).currentActorNum as libc::c_int |
                     (1 as libc::c_int) << i) as u16_0;
            (*this).actorSpawnPtrList[i as usize] = 0 as *mut Actor
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjMure2 = thisx as *mut ObjMure2;
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_SetupWait(mut this: *mut ObjMure2) {
    (*this).actionFunc =
        Some(ObjMure2_Wait as
                 unsafe extern "C" fn(_: *mut ObjMure2, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_Wait(mut this: *mut ObjMure2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B9A658(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9A658(mut this: *mut ObjMure2) {
    (*this).actionFunc =
        Some(func_80B9A668 as
                 unsafe extern "C" fn(_: *mut ObjMure2, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9A668(mut this: *mut ObjMure2,
                                       mut globalCtx: *mut GlobalContext) {
    if Math3D_Dist1DSq((*this).actor.projectedPos.x,
                       (*this).actor.projectedPos.z) <
           sDistSquared1[((*this).actor.params as libc::c_int &
                              3 as libc::c_int) as usize] * (*this).unk_184 {
        (*this).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn func_80B9A6E8(mut this: *mut ObjMure2) {
    (*this).actionFunc =
        Some(func_80B9A6F8 as
                 unsafe extern "C" fn(_: *mut ObjMure2, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn func_80B9A6F8(mut this: *mut ObjMure2,
                                       mut globalCtx: *mut GlobalContext) {
    func_80B9A534(this);
    if sDistSquared2[((*this).actor.params as libc::c_int & 3 as libc::c_int)
                         as usize] * (*this).unk_184 <=
           Math3D_Dist1DSq((*this).actor.projectedPos.x,
                           (*this).actor.projectedPos.z) {
        (*this).actor.flags &=
            !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn ObjMure2_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjMure2 = thisx as *mut ObjMure2;
    if (*globalCtx).csCtx.state as libc::c_int == CS_STATE_IDLE as libc::c_int
       {
        (*this).unk_184 = 1.0f32
    } else { (*this).unk_184 = 4.0f32 }
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).uncullZoneScale as
                                 *mut f32_0 as size_t as u32_0);
             init.set_value(2100 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
