...
extern "C" {
    ...
    #[no_mangle]
    static mut gIngoGateDL: [Gfx; 0];
    #[no_mangle]
    static mut gIngoGateCol: CollisionHeader;
}
...
pub struct BgInGate {
    ...
    pub actionFunc: BgInGateActionFunc,
}
pub type BgInGateActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgInGate, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Ingate_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_INGATE as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_INGATE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgInGate>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgInGate_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgInGate_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgInGate_SetupAction(mut this: *mut BgInGate,
                                              mut actionFunc:
                                                  BgInGateActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgInGate_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgInGate = thisx as *mut BgInGate;
    let mut pad: s32 = 0;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
    CollisionHeader_GetVirtual(&mut gIngoGateCol as *mut CollisionHeader as
    ...
    if (*this).dyna.actor.params as libc::c_int & 1 as libc::c_int !=
        ...
        BgInGate_SetupAction(this,
                             Some(func_80892890 as
                                      unsafe extern "C" fn(_: *mut BgInGate,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
    } else {
        BgInGate_SetupAction(this,
                             Some(BgInGate_DoNothing as
                                      unsafe extern "C" fn(_: *mut BgInGate,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn BgInGate_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgInGate = thisx as *mut BgInGate;
...
#[no_mangle]
pub unsafe extern "C" fn func_80892890(mut this: *mut BgInGate,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi0: s32 = 0;
    let mut phi1: s16 = 0;
    let mut csFrames: s16 = 0;
    if (*globalCtx).csCtx.frames as libc::c_int >= 50 as libc::c_int {
        phi0 = 0x4000 as libc::c_int;
        if (*this).dyna.actor.params as libc::c_int & 2 as libc::c_int ==
               0 as libc::c_int {
            phi0 = -(0x4000 as libc::c_int)
        }
        (*this).dyna.actor.shape.rot.y =
            ((*this).dyna.actor.world.rot.y as libc::c_int + phi0) as s16;
        BgInGate_SetupAction(this,
                             Some(BgInGate_DoNothing as
                                      unsafe extern "C" fn(_: *mut BgInGate,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
    } else if (*globalCtx).csCtx.frames as libc::c_int >= 10 as libc::c_int {
        csFrames =
            ((*globalCtx).csCtx.frames as libc::c_int - 10 as libc::c_int) as
                s16;
        csFrames = (csFrames as libc::c_int * 400 as libc::c_int) as s16;
        phi1 = csFrames;
        if csFrames as libc::c_int > 0x4000 as libc::c_int {
            csFrames = 0x4000 as libc::c_int as s16
        }
        csFrames = (Math_SinS(csFrames) * 16384.0f32) as s16;
        phi1 = csFrames;
        if (*this).dyna.actor.params as libc::c_int & 2 as libc::c_int ==
               0 as libc::c_int {
            phi1 = -(phi1 as libc::c_int) as s16
        }
        (*this).dyna.actor.shape.rot.y =
            ((*this).dyna.actor.world.rot.y as libc::c_int +
                 phi1 as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgInGate_DoNothing(mut this: *mut BgInGate,
                                            mut globalCtx:
                                                *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgInGate_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgInGate = thisx as *mut BgInGate;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgInGate_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_ingate.c\x00" as *const u8 as
                        *const libc::c_char, 240 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gIngoGateDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_ingate.c\x00" as *const u8 as
                         *const libc::c_char, 250 as libc::c_int);
}
