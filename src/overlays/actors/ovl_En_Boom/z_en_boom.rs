...
extern "C" {
    ...
    #[no_mangle]
    static mut gBoomerangRefDL: [Gfx; 0];
}
...
#[no_mangle]
pub static mut En_Boom_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOOM as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnBoom_SetupAction(mut this: *mut EnBoom,
                                            mut actionFunc:
                                                EnBoomActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBoom_Init(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBoom = thisx as *mut EnBoom;
    let mut blure: EffectBlureInit1 =
    ...
    blure.p1StartColor[0 as libc::c_int as usize] =
        255 as libc::c_int as u8_0;
    blure.p1StartColor[1 as libc::c_int as usize] =
        255 as libc::c_int as u8_0;
    blure.p1StartColor[2 as libc::c_int as usize] =
        100 as libc::c_int as u8_0;
    blure.p1StartColor[3 as libc::c_int as usize] =
        255 as libc::c_int as u8_0;
    blure.p2StartColor[0 as libc::c_int as usize] =
        255 as libc::c_int as u8_0;
    blure.p2StartColor[1 as libc::c_int as usize] =
        255 as libc::c_int as u8_0;
    blure.p2StartColor[2 as libc::c_int as usize] =
        100 as libc::c_int as u8_0;
    blure.p2StartColor[3 as libc::c_int as usize] = 64 as libc::c_int as u8_0;
    blure.p1EndColor[0 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
    blure.p1EndColor[1 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
    blure.p1EndColor[2 as libc::c_int as usize] = 100 as libc::c_int as u8_0;
    blure.p1EndColor[3 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
    blure.p2EndColor[0 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
    blure.p2EndColor[1 as libc::c_int as usize] = 255 as libc::c_int as u8_0;
    blure.p2EndColor[2 as libc::c_int as usize] = 100 as libc::c_int as u8_0;
    blure.p2EndColor[3 as libc::c_int as usize] = 0 as libc::c_int as u8_0;
    blure.elemDuration = 8 as libc::c_int;
    blure.unkFlag = 0 as libc::c_int;
    blure.calcMode = 0 as libc::c_int;
    Effect_Add(globalCtx, &mut (*this).effectIndex,
               EFFECT_BLURE1 as libc::c_int, 0 as libc::c_int as u8_0,
               0 as libc::c_int as u8_0,
               &mut blure as *mut EffectBlureInit1 as *mut libc::c_void);
    Collider_InitQuad(globalCtx, &mut (*this).collider);
    Collider_SetQuad(globalCtx, &mut (*this).collider, &mut (*this).actor,
                     &mut sQuadInit);
    EnBoom_SetupAction(this,
                       Some(EnBoom_Fly as
                                unsafe extern "C" fn(_: *mut EnBoom,
                                                     _: *mut GlobalContext)
                                    -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnBoom_Destroy(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBoom = thisx as *mut EnBoom;
...
#[no_mangle]
pub unsafe extern "C" fn EnBoom_Fly(mut this: *mut EnBoom,
                                    mut globalCtx: *mut GlobalContext) {
    let mut target: *mut Actor = 0 as *mut Actor;
    let mut player: *mut Player = 0 as *mut Player;
    let mut collided: s32 = 0;
    let mut yawTarget: s16 = 0;
    let mut yawDiff: s16 = 0;
    let mut pitchTarget: s16 = 0;
    let mut pitchDiff: s16 = 0;
    let mut pad1: s32 = 0;
    let mut distXYZScale: f32_0 = 0.;
    let mut distFromLink: f32_0 = 0.;
    let mut hitActor: *mut DynaPolyActor = 0 as *mut DynaPolyActor;
    let mut hitDynaID: s32 = 0;
    ...
    if !target.is_null() {
        yawTarget =
            Actor_WorldYawTowardPoint(&mut (*this).actor,
                                      &mut (*target).focus.pos);
        yawDiff =
            ((*this).actor.world.rot.y as libc::c_int -
                 yawTarget as libc::c_int) as s16;
        pitchTarget =
            Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                        &mut (*target).focus.pos);
        pitchDiff =
            ((*this).actor.world.rot.x as libc::c_int -
                 pitchTarget as libc::c_int) as s16;
        distXYZScale =
            (200.0f32 -
                 Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                                    &mut (*target).focus.pos)) * 0.005f32;
        if distXYZScale < 0.12f32 { distXYZScale = 0.12f32 }
        if target != &mut (*player).actor as *mut Actor &&
               ((*target).update.is_none() ||
            ...
            (*this).moveTo = 0 as *mut Actor
        } else {
            Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yawTarget,
                               ((if yawDiff as libc::c_int >= 0 as libc::c_int
                                    {
                                     yawDiff as libc::c_int
                                 } else { -(yawDiff as libc::c_int) }) as
                                    libc::c_float * distXYZScale) as s16);
            Math_ScaledStepToS(&mut (*this).actor.world.rot.x, pitchTarget,
                               ((if pitchDiff as libc::c_int >=
                                        0 as libc::c_int {
                                     pitchDiff as libc::c_int
                                 } else { -(pitchDiff as libc::c_int) }) as
                                    libc::c_float * distXYZScale) as s16);
        }
    }
    // Set xyz speed, move forward, and play the boomerang sound
    func_8002D9A4(&mut (*this).actor, 12.0f32);
    ...
    collided = (collided != 0) as libc::c_int;
    if collided != 0 {
        if (*(*this).collider.base.at).id as libc::c_int ==
               ACTOR_EN_ITEM00 as libc::c_int ||
               (*(*this).collider.base.at).id as libc::c_int ==
                   ACTOR_EN_SI as libc::c_int {
            (*this).grabbed = (*this).collider.base.at;
            if (*(*this).collider.base.at).id as libc::c_int ==
                   ACTOR_EN_SI as libc::c_int {
                (*(*this).collider.base.at).flags |=
    ...
    if (if (*this).returnTimer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else {
            (*this).returnTimer = (*this).returnTimer.wrapping_sub(1);
            (*this).returnTimer as libc::c_int
        }) == 0 as libc::c_int {
        distFromLink =
            Math_Vec3f_DistXYZ(&mut (*this).actor.world.pos,
                               &mut (*player).actor.focus.pos);
        (*this).moveTo = &mut (*player).actor;
        // If the boomerang is less than 40 units away from Link, he can catch it.
        if distFromLink < 40.0f32 {
            target = (*this).grabbed;
            if !target.is_null() {
                Math_Vec3f_Copy(&mut (*target).world.pos,
                ...
                if (*target).id as libc::c_int ==
                       ACTOR_EN_ITEM00 as libc::c_int {
                    (*target).gravity = -0.9f32;
                    (*target).bgCheckFlags =
                        ((*target).bgCheckFlags as libc::c_int &
        ...
        if collided != 0 {
            ...
            if collided != 0 {
                ...
                if func_8002F9EC(globalCtx, &mut (*this).actor,
                                 (*this).actor.wallPoly, hitDynaID,
                                 &mut hitPoint) != 0 as libc::c_int ||
                       hitDynaID != 50 as libc::c_int &&
                           {
                               hitActor =
                           ...
                           (*hitActor).actor.id as libc::c_int ==
                               ACTOR_BG_BDAN_OBJECTS as libc::c_int &&
                           (*hitActor).actor.params as libc::c_int ==
                               0 as libc::c_int {
                    collided = 0 as libc::c_int
                } else {
        ...
        if collided != 0 {
            ...
            (*this).moveTo = &mut (*player).actor;
            (*this).returnTimer = 0 as libc::c_int as u8_0
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnBoom_Update(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBoom = thisx as *mut EnBoom;
    ...
    if (*player).stateFlags1 & 0x20000000 as libc::c_int as libc::c_uint == 0
       {
        ...
        (*this).activeTimer =
            ((*this).activeTimer as libc::c_int + 1 as libc::c_int) as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBoom_Draw(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    static mut sMultVec1: Vec3f =
        { let mut init = Vec3f{x: -960.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut sMultVec2: Vec3f =
        { let mut init = Vec3f{x: 960.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut this: *mut EnBoom = thisx as *mut EnBoom;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_boom.c\x00" as *const u8 as *const libc::c_char,
                    567 as libc::c_int);
    ...
    Matrix_RotateZ(0x1f40 as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_RotateX((*this).actor.world.rot.x as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_MultVec3f(&mut sMultVec1, &mut vec1);
    Matrix_MultVec3f(&mut sMultVec2, &mut vec2);
    if func_80090480(globalCtx, &mut (*this).collider,
                     &mut (*this).boomerangInfo, &mut vec1, &mut vec2) as
           libc::c_int != 0 as libc::c_int {
        EffectBlure_AddVertex(Effect_GetByIndex((*this).effectIndex) as
                                  *mut EffectBlure, &mut vec1, &mut vec2);
    }
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_RotateY(((*this).activeTimer as libc::c_int * 12000 as libc::c_int)
                       as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_boom.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBoomerangRefDL.as_mut_ptr() as libc::c_uint;
    ...
    sInitChain =
        [{
         ...
         },
         {
             ...
             init.set_type_0(ICHAINTYPE_VEC3S as libc::c_int as u32_0);
             init.set_offset(&mut (*(0 as *mut Actor)).shape.rot as *mut Vec3s
                                 as size_t as u32_0);
