...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseZelda {
    pub actor: Actor,
    pub action: s32,
    pub animationIndex: s32,
    pub skin: PSkinAwb,
    pub unk_1E4: [libc::c_char; 8],
    pub unk_1EC: s32,
    ...
    pub colliderSphereItem: ColliderJntSphElement,
}
pub type EnHorseZeldaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHorseZelda, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut En_Horse_Zelda_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HORSE_ZELDA as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_HORSE_ZELDA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHorseZelda>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseZelda_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseZelda_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseZelda_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseZelda_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sAnimationHeaders: [*mut AnimationHeader; 1] =
    unsafe {
        [&gHorseZeldaGallopingAnim as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut splaySpeeds: [f32_0; 1] = [2.0f32 / 3.0f32];
...
// size = 0x8
static mut D_80A6E240: [unknownStruct; 14] =
    [{
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(1682 as libc::c_int) as s16,
                                             y: -(500 as libc::c_int) as s16,
                                             z: 12578 as libc::c_int as s16,};
                                   init
                               },
     ...
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(3288 as libc::c_int) as s16,
                                             y: -(500 as libc::c_int) as s16,
                                             z: 13013 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(5142 as libc::c_int) as s16,
                                             y: -(417 as libc::c_int) as s16,
                                             z: 11630 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(5794 as libc::c_int) as s16,
                                             y: -(473 as libc::c_int) as s16,
                                             z: 9573 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(6765 as libc::c_int) as s16,
                                             y: -(500 as libc::c_int) as s16,
                                             z: 8364 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(6619 as libc::c_int) as s16,
                                             y: -(393 as libc::c_int) as s16,
                                             z: 6919 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(5193 as libc::c_int) as s16,
                                             y: 124 as libc::c_int as s16,
                                             z: 5433 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(2970 as libc::c_int) as s16,
                                             y: 2 as libc::c_int as s16,
                                             z: 4537 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(2949 as libc::c_int) as s16,
                                             y: -(35 as libc::c_int) as s16,
                                             z: 4527 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: -(1907 as libc::c_int) as s16,
                                             y: -(47 as libc::c_int) as s16,
                                             z: 2978 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: 2488 as libc::c_int as s16,
                                             y: 294 as libc::c_int as s16,
                                             z: 3628 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: 3089 as libc::c_int as s16,
                                             y: 378 as libc::c_int as s16,
                                             z: 4713 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: 1614 as libc::c_int as s16,
                                             y: -(261 as libc::c_int) as s16,
                                             z: 7596 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unknownStruct{unk_0:
                               {
                                   let mut init =
                                       Vec3s{x: 754 as libc::c_int as s16,
                                             y: -(187 as libc::c_int) as s16,
                                             z: 9295 as libc::c_int as s16,};
                                   init
                               },
                           unk_6: 0x7 as libc::c_int as u8_0,};
         init
...
static mut sActionFuncs: [EnHorseZeldaActionFunc; 2] =
    unsafe {
        [Some(func_80A6DCCC as
                  unsafe extern "C" fn(_: *mut EnHorseZelda,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A6DDFC as
                  unsafe extern "C" fn(_: *mut EnHorseZelda,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn func_80A6D8D0(mut data: *mut unknownStruct,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6D918(mut this: *mut EnHorseZelda,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp28: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut yawDiff: s16 = 0;
    func_80A6D8D0(D_80A6E240.as_mut_ptr(), (*this).unk_1EC, &mut sp28);
    if Math3D_Vec3f_DistXYZ(&mut sp28, &mut (*this).actor.world.pos) <=
           400.0f32 {
        (*this).unk_1EC += 1;
        if (*this).unk_1EC >= 14 as libc::c_int {
            (*this).unk_1EC = 0 as libc::c_int;
            func_80A6D8D0(D_80A6E240.as_mut_ptr(), 0 as libc::c_int,
                          &mut sp28);
        }
    }
    yawDiff =
        (Math_Vec3f_Yaw(&mut (*this).actor.world.pos, &mut sp28) as
             libc::c_int - (*this).actor.world.rot.y as libc::c_int) as s16;
    if yawDiff as libc::c_int >= 0x12d as libc::c_int {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int + 0x12c as libc::c_int)
                as s16
    ...
    if Actor_WorldDistXZToActor(&mut (*this).actor,
        ...
        if (*this).actor.speedXZ < 12.0f32 {
            (*this).actor.speedXZ += 1.0f32
                  ...
                  D_80A6E240[(*this).unk_1EC as usize].unk_6 as libc::c_int as
                      libc::c_float {
        (*this).actor.speedXZ += 0.5f32
    } else { (*this).actor.speedXZ -= 0.5f32 };
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseZelda_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHorseZelda = thisx as *mut EnHorseZelda;
    ...
    func_800A663C(globalCtx, &mut (*this).skin, &mut gHorseZeldaSkel,
                  &mut gHorseZeldaGallopingAnim);
    (*this).animationIndex = 0 as libc::c_int;
    Animation_PlayOnce(&mut (*this).skin.skelAnime,
                       sAnimationHeaders[0 as libc::c_int as usize]);
    Collider_InitCylinder(globalCtx, &mut (*this).colliderCylinder);
    Collider_SetCylinderType1(globalCtx, &mut (*this).colliderCylinder,
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseZelda_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnHorseZelda = thisx as *mut EnHorseZelda;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6DC7C(mut this: *mut EnHorseZelda) {
    (*this).action = 0 as libc::c_int;
    (*this).animationIndex += 1;
    if (*this).animationIndex > 0 as libc::c_int {
        (*this).animationIndex = 0 as libc::c_int
    }
    Animation_PlayOnce(&mut (*this).skin.skelAnime,
                       sAnimationHeaders[(*this).animationIndex as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6DCCC(mut this: *mut EnHorseZelda,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6DD14(mut this: *mut EnHorseZelda) {
    let mut sp34: f32_0 = 0.;
    (*this).action = 1 as libc::c_int;
    (*this).animationIndex = 0 as libc::c_int;
    sp34 = (*this).actor.speedXZ / 6.0f32;
    ...
    Animation_Change(&mut (*this).skin.skelAnime,
                     sAnimationHeaders[(*this).animationIndex as usize],
                     splaySpeeds[(*this).animationIndex as usize] * sp34 *
                         1.5f32, 0.0f32,
                     Animation_GetLastFrame(sAnimationHeaders[(*this).animationIndex
                                                                  as usize] as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A6DDFC(mut this: *mut EnHorseZelda,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6DE38(mut this: *mut EnHorseZelda,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    pos.y = (*this).actor.world.pos.y + 60.0f32;
    pos.z =
    ...
    (*this).actor.shape.rot.x =
        (Math_FAtan2F((*this).actor.world.pos.y - (*this).unk_1F4, 30.0f32) *
             (0x8000 as libc::c_int as libc::c_float /
                  3.14159265358979323846f32)) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseZelda_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnHorseZelda = thisx as *mut EnHorseZelda;
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A6DFD4(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
    ...
    let mut i: s32 = 0;
    i = 0 as libc::c_int;
    while i < (*this).colliderSphere.count {
        sp4C.x =
            (*(*this).colliderSphere.elements.offset(i as
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseZelda_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHorseZelda = thisx as *mut EnHorseZelda;
