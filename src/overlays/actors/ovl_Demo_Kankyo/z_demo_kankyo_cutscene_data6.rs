...
// clang-format off
#[no_mangle]
pub static mut gChildWarpOutCS: [CutsceneData; 96] =
    [CutsceneData{i: 5 as libc::c_int,},
     CutsceneData{i: 1167 as libc::c_int,},
     ...
     CutsceneData{i: 0xffffffcd as libc::c_uint as s32,},
