...
extern "C" {
    ...
    #[no_mangle]
    fn Actor_ActorAIsFacingAndNearActorB(actorA: *mut Actor,
                                         actorB: *mut Actor, range: f32_0,
                                         angle: s16) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_8003424C(globalCtx: *mut GlobalContext, arg1: *mut Vec3f);
    #[no_mangle]
    ...
    #[no_mangle]
    fn Math_StepUntilS(pValue: *mut s16, limit: s16, step: s16) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gSpiritBossNabooruKnuckleDefeatCs: [CutsceneData; 0];
    #[no_mangle]
    static mut object_ik_Anim_001C28: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_002538: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_0029FC: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_0033C4: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_003DBC: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_0045BC: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_00485C: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_005944: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_006194: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_006734: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_00C114: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_00CD70: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_00DD50: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Anim_00ED24: AnimationHeader;
    #[no_mangle]
    static mut object_ik_DL_016BE0: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_016CD8: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_016D88: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_016EE8: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_016F88: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_018E78: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_019100: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_DL_019E08: [Gfx; 0];
    #[no_mangle]
    static mut object_ik_Skel_01E178: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_ik_Anim_0203D8: AnimationHeader;
    #[no_mangle]
    static mut object_ik_Skel_0205C0: FlexSkeletonHeader;
}
...
pub const EFFECT_SHIELD_PARTICLE: C2RustUnnamed_22 = 3;
pub const EFFECT_BLURE2: C2RustUnnamed_22 = 2;
pub const EFFECT_BLURE1: C2RustUnnamed_22 = 1;
pub const EFFECT_SPARK: C2RustUnnamed_22 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnIk {
    pub actor: Actor,
    ...
    pub unk_300: s16,
    pub switchFlags: s16,
    pub actionFunc: EnIkActionFunc,
    pub bodyBreak: BodyBreak,
    pub bodyCollider: ColliderCylinder,
    pub axeCollider: ColliderQuad,
    pub shieldCollider: ColliderTris,
    pub shieldColliderItems: [ColliderTrisElement; 2],
    pub blureIdx: s32,
    pub action: s32,
    pub drawMode: s32,
    pub npcAction: u32_0,
    pub unk_4D4: s32,
    pub unk_4D8: [libc::c_char; 4],
}
pub type EnIkActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext) -> ()>;
pub type EnIkDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext) -> ()>;
...
static mut sTrisElementsInit: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
...
static mut sTrisInit: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sTrisElementsInit.as_ptr() as *mut _,};
            init
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    if Actor_FindNearby(globalCtx, &mut (*this).actor,
                        ACTOR_EN_IK as libc::c_int as s16,
                        ACTORCAT_ENEMY as libc::c_int as u8_0,
                        8000.0f32).is_null() {
        func_800F5B58();
    }
    Collider_DestroyTris(globalCtx, &mut (*this).shieldCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_DestroyQuad(globalCtx, &mut (*this).axeCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnIk_SetupAction(mut this: *mut EnIk,
                                          mut actionFunc: EnIkActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A74398(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    let mut pad: s32 = 0;
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).bodyCollider, thisx,
                         &mut sCylinderInit);
    Collider_InitTris(globalCtx, &mut (*this).shieldCollider);
    Collider_SetTris(globalCtx, &mut (*this).shieldCollider, thisx,
                     &mut sTrisInit,
                     (*this).shieldColliderItems.as_mut_ptr());
    Collider_InitQuad(globalCtx, &mut (*this).axeCollider);
    Collider_SetQuad(globalCtx, &mut (*this).axeCollider, thisx,
                     &mut sQuadInit);
    (*thisx).colChkInfo.damageTable = &mut sDamageTable;
    (*thisx).colChkInfo.mass = 0xfe as libc::c_int as u8_0;
    (*this).unk_2FC = 0 as libc::c_int as u8_0;
    (*thisx).colChkInfo.health = 30 as libc::c_int as u8_0;
    (*thisx).gravity = -1.0f32;
    (*this).switchFlags =
        ((*thisx).params as libc::c_int >> 8 as libc::c_int &
             0xff as libc::c_int) as s16;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    if (*thisx).params as libc::c_int == 0 as libc::c_int {
        (*thisx).colChkInfo.health =
            ((*thisx).colChkInfo.health as libc::c_int + 20 as libc::c_int) as
                u8_0;
        (*thisx).naviEnemyId = 0x34 as libc::c_int as u8_0
    } else {
        Actor_SetScale(thisx, 0.012f32);
        (*thisx).naviEnemyId = 0x35 as libc::c_int as u8_0;
    ...
    Effect_Add(globalCtx, &mut (*this).blureIdx, EFFECT_BLURE1 as libc::c_int,
               0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
               &mut blureInit as *mut EffectBlureInit1 as *mut libc::c_void);
    func_80A74714(this);
    if (*this).switchFlags as libc::c_int != 0xff as libc::c_int {
        if Flags_GetSwitch(globalCtx, (*this).switchFlags as s32) != 0 {
            Actor_Kill(thisx);
        }
    } else if (*thisx).params as libc::c_int != 0 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80A745E4(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext)
 -> s32 {
    if ((*this).unk_2FB as libc::c_int != 0 as libc::c_int ||
            (*this).actor.params as libc::c_int == 0 as libc::c_int) &&
           func_800354B4(globalCtx, &mut (*this).actor, 100.0f32,
                         0x2710 as libc::c_int as s16,
                         0x4000 as libc::c_int as s16,
                         (*this).actor.shape.rot.y) != 0 as libc::c_int &&
           (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0
       {
        func_80A755F0(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A74674(mut globalCtx: *mut GlobalContext,
                                       mut actor: *mut Actor) -> *mut Actor {
    ...
    while !prop.is_null() {
        if prop == actor ||
               (*prop).id as libc::c_int !=
                   ACTOR_BG_JYA_IRONOBJ as libc::c_int {
            prop = (*prop).next
        } else {
            if Actor_ActorAIsFacingAndNearActorB(actor, prop, 80.0f32,
                                                 0x2710 as libc::c_int as s16)
                   != 0 {
                return prop
            }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A74714(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_00CD70 as
    ...
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00CD70,
                     0.0f32, frame, frames,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).unk_2F8 = 3 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnIk_SetupAction(this,
                     Some(func_80A747C0 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A747C0(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7489C(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_00DD50 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int |
             (1 as libc::c_int) << 2 as libc::c_int) as libc::c_uint;
    (*this).unk_2F8 = 4 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00DD50,
                     0.0f32, 0.0f32, frames,
                     ANIMMODE_LOOP as libc::c_int as u8_0, 4.0f32);
    EnIk_SetupAction(this,
                     Some(func_80A7492C as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7492C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_a0: s32 =
        if (*this).unk_2FB as libc::c_int == 0 as libc::c_int {
            0xaaa as libc::c_int
        } else { 0x3ffc as libc::c_int };
    let mut yawDiff: s16 =
    ...
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
        ...
        } else { -(yawDiff as libc::c_int) }) <= phi_a0 &&
        ...
        if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0
           {
            func_80A74E2C(this);
        } else { func_80A751C8(this); }
    } else if (if yawDiff as libc::c_int >= 0 as libc::c_int {
                   yawDiff as libc::c_int
               } else { -(yawDiff as libc::c_int) }) <= 0x4000 as libc::c_int
                  &&
                  (if (*this).actor.yDistToPlayer >=
                          0 as libc::c_int as libc::c_float {
                       (*this).actor.yDistToPlayer
        ...
        func_80A74AAC(this);
    } else { func_80A74AAC(this); }
    func_80A745E4(this, globalCtx);
    SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A74AAC(mut this: *mut EnIk) {
    (*this).unk_2F8 = 5 as libc::c_int as u8_0;
    if (*this).unk_2FB as libc::c_int == 0 as libc::c_int {
        Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00ED24,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_ik_Anim_00ED24 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         -4.0f32);
        (*this).actor.speedXZ = 0.9f32
    } else {
        Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_006734,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_ik_Anim_006734 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         -4.0f32);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39bf as libc::c_int as u16_0);
        (*this).actor.speedXZ = 2.5f32
    }
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnIk_SetupAction(this,
                     Some(func_80A74BA4 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A74BA4(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).unk_2FB as libc::c_int == 0 as libc::c_int {
        temp_t0 = 0xaaa as libc::c_int as s16;
        phi_a3 = 0x320 as libc::c_int as s16;
        sp30 = 0 as libc::c_int as s16;
        sp2E = 0x10 as libc::c_int as s16
    } else {
        temp_t0 = 0x3ffc as libc::c_int as s16;
        phi_a3 = 0x4b0 as libc::c_int as s16;
        sp30 = 2 as libc::c_int as s16;
        sp2E = 9 as libc::c_int as s16
    }
    temp_a1 =
        ((*this).actor.wallYaw as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 &&
           (if temp_a1 as libc::c_int >= 0 as libc::c_int {
                temp_a1 as libc::c_int
            } else { -(temp_a1 as libc::c_int) }) >= 0x4000 as libc::c_int {
        temp_a1 =
            if (*this).actor.yawTowardsPlayer as libc::c_int >
                   0 as libc::c_int {
                ((*this).actor.wallYaw as libc::c_int) - 0x4000 as libc::c_int
            } else {
                ((*this).actor.wallYaw as libc::c_int) + 0x4000 as libc::c_int
            } as s16;
        Math_SmoothStepToS(&mut (*this).actor.world.rot.y, temp_a1,
                           1 as libc::c_int as s16, phi_a3,
    ...
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
            yawDiff as libc::c_int
        } else { -(yawDiff as libc::c_int) }) <= temp_t0 as libc::c_int &&
           (*this).actor.xzDistToPlayer < 100.0f32 {
        if (if (*this).actor.yDistToPlayer >=
                   0 as libc::c_int as libc::c_float {
                (*this).actor.yDistToPlayer
            } else { -(*this).actor.yDistToPlayer }) < 150.0f32 {
            if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint
                   != 0 {
                func_80A74E2C(this);
            } else { func_80A751C8(this); }
        }
    }
    if !func_80A74674(globalCtx, &mut (*this).actor).is_null() {
        func_80A751C8(this);
        (*this).unk_2FC = 1 as libc::c_int as u8_0
    } else {
        temp_t0 =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        if (if temp_t0 as libc::c_int >= 0 as libc::c_int {
                temp_t0 as libc::c_int
            } else { -(temp_t0 as libc::c_int) }) > 0x4000 as libc::c_int {
            (*this).unk_300 -= 1;
            if (*this).unk_300 as libc::c_int == 0 as libc::c_int {
                func_80A754A0(this);
            }
        } else { (*this).unk_300 = 0x28 as libc::c_int as s16 }
    }
    func_80A745E4(this, globalCtx);
    SkelAnime_Update(&mut (*this).skelAnime);
    if sp30 as libc::c_int == (*this).skelAnime.curFrame as s16 as libc::c_int
           ||
           sp2E as libc::c_int ==
               (*this).skelAnime.curFrame as s16 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3928 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A74E2C(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_001C28 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FF = 1 as libc::c_int as s8;
    (*this).unk_2F8 = 6 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_001C28,
                     1.5f32, 0.0f32, frames,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    EnIk_SetupAction(this,
                     Some(func_80A74EBC as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A74EBC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp2C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).skelAnime.curFrame == 15.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3929 as libc::c_int as u16_0);
    } else if (*this).skelAnime.curFrame == 21.0f32 {
        sp2C.x =
            (*this).actor.world.pos.x +
                Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                               0x6a4 as libc::c_int) as s16) * 70.0f32;
        sp2C.z =
        ...
        CollisionCheck_SpawnShieldParticles(globalCtx, &mut sp2C);
    }
    if (*this).skelAnime.curFrame > 17.0f32 &&
           (*this).skelAnime.curFrame < 23.0f32 {
        (*this).unk_2FE = 1 as libc::c_int as s8
    } else {
        if (*this).unk_2FB as libc::c_int != 0 as libc::c_int &&
               (*this).skelAnime.curFrame < 10.0f32 {
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                               (*this).actor.yawTowardsPlayer,
        ...
        (*this).unk_2FE = 0 as libc::c_int as s8
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 { func_80A7506C(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7506C(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_0029FC as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FE = 0 as libc::c_int as s8;
    (*this).unk_2F9 = frames as s8 as u8_0;
    (*this).unk_2F8 = 7 as libc::c_int as u8_0;
    (*this).unk_2FF = (*this).unk_2FE;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_0029FC,
                     1.0f32, 0.0f32, frames,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -4.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x39c1 as libc::c_int as u16_0);
    EnIk_SetupAction(this,
                     Some(func_80A7510C as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7510C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut frames: f32_0 = 0.;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 ||
           {
               (*this).unk_2F9 = (*this).unk_2F9.wrapping_sub(1);
               ((*this).unk_2F9 as libc::c_int) == 0 as libc::c_int
           } {
        if (*this).unk_2F8 as libc::c_int == 8 as libc::c_int {
            func_80A7489C(this);
        } else {
            frames =
                Animation_GetLastFrame(&mut object_ik_Anim_002538 as
                                           *mut AnimationHeader as
                                           *mut libc::c_void) as f32_0;
            (*this).unk_2F8 = 8 as libc::c_int as u8_0;
            Animation_Change(&mut (*this).skelAnime,
                             &mut object_ik_Anim_002538, 1.5f32, 0.0f32,
                             frames,
...
#[no_mangle]
pub unsafe extern "C" fn func_80A751C8(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_0033C4 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FF = 2 as libc::c_int as s8;
    (*this).unk_300 = 0 as libc::c_int as s16;
    (*this).unk_2F8 = 6 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_0033C4,
                     0.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, -6.0f32);
    (*this).unk_2FC = 0 as libc::c_int as u8_0;
    EnIk_SetupAction(this,
                     Some(func_80A75260 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75260(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_f0: f32_0 = 0.;
    (*this).unk_300 =
        ((*this).unk_300 as libc::c_int + 0x1c2 as libc::c_int) as s16;
    temp_f0 = Math_SinS((*this).unk_300);
    (*this).skelAnime.playSpeed =
        if temp_f0 >= 0 as libc::c_int as libc::c_float {
            temp_f0
        } else { -temp_f0 };
    if (*this).skelAnime.curFrame > 11.0f32 {
        (*this).unk_2FF = 3 as libc::c_int as s8
    }
    if (*this).skelAnime.curFrame > 1.0f32 &&
           (*this).skelAnime.curFrame < 9.0f32 ||
           (*this).skelAnime.curFrame > 13.0f32 &&
               (*this).skelAnime.curFrame < 18.0f32 {
        if (*this).unk_2FC as libc::c_int == 0 as libc::c_int &&
               (*this).unk_2FB as libc::c_int != 0 as libc::c_int &&
               (*this).skelAnime.curFrame < 10.0f32 {
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                               (*this).actor.yawTowardsPlayer,
                               1 as libc::c_int as s16,
        ...
        if ((*this).unk_2FE as libc::c_int) < 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3929 as libc::c_int as u16_0);
        }
        (*this).unk_2FE = 1 as libc::c_int as s8
    } else { (*this).unk_2FE = 0 as libc::c_int as s8 }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 { func_80A753D0(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A753D0(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_003DBC as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FE = 0 as libc::c_int as s8;
    (*this).unk_2FF = (*this).unk_2FE;
    (*this).unk_2F8 = 8 as libc::c_int as u8_0;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_003DBC,
                     1.5f32, 0.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, -4.0f32);
    EnIk_SetupAction(this,
                     Some(func_80A7545C as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7545C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        func_80A7489C(this);
        func_80A745E4(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A754A0(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_0033C4 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2F8 = 1 as libc::c_int as u8_0;
    (*this).unk_2FF = 3 as libc::c_int as s8;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_0033C4,
                     0.5f32, 13.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, -4.0f32);
    EnIk_SetupAction(this,
                     Some(func_80A75530 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75530(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    Math_StepUntilS(&mut (*this).actor.world.rot.y,
                    (*this).actor.yawTowardsPlayer,
                    0x7d0 as libc::c_int as s16);
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    if (*this).skelAnime.curFrame > 13.0f32 &&
           (*this).skelAnime.curFrame < 18.0f32 {
        if ((*this).unk_2FE as libc::c_int) < 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3929 as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A755F0(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_00485C as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FE = 0 as libc::c_int as s8;
    (*this).unk_2F8 = 9 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00485C,
                     1.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE_INTERP as libc::c_int as u8_0, -4.0f32);
    EnIk_SetupAction(this,
                     Some(func_80A7567C as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7567C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        } else { func_80A7489C(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75790(mut this: *mut EnIk) {
    let mut yaw: s16 = 0;
    let mut yawDiff: s16 = 0;
    yaw =
        Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                       &mut (*(*this).bodyCollider.base.ac).world.pos);
    (*this).unk_2F8 = 0 as libc::c_int as u8_0;
    yawDiff =
        (yaw as libc::c_int - (*this).actor.shape.rot.y as libc::c_int) as
            s16;
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
            yawDiff as libc::c_int
        } else { -(yawDiff as libc::c_int) }) <= 0x4000 as libc::c_int {
        Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_006194,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_ik_Anim_006194 as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
        ...
        Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_0045BC,
                         1.0f32, 0.0f32,
                         Animation_GetLastFrame(&mut object_ik_Anim_0045BC as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_ONCE as libc::c_int as u8_0,
                         -4.0f32);
    ...
    (*this).unk_2FE = 0 as libc::c_int as s8;
    EnIk_SetupAction(this,
                     Some(func_80A758B0 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A758B0(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if BodyBreak_SpawnParts(&mut (*this).actor, &mut (*this).bodyBreak,
                            ...
                            ((*this).actor.params as libc::c_int +
                                 4 as libc::c_int) as s16) != 0 {
        (*this).bodyBreak.val = 0 as libc::c_int
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
                    (*this).actor.shape.rot.y as libc::c_int) as s16 as
            ...
            func_80A7489C(this);
            func_80A745E4(this, globalCtx);
        } else { func_80A754A0(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7598C(mut this: *mut EnIk) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_005944 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).unk_2FE = 0 as libc::c_int as s8;
    (*this).unk_2F8 = 2 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_005944,
                     1.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    (*this).unk_2F9 = 0x18 as libc::c_int as u8_0;
    Audio_PlayActorSound2(&mut (*this).actor, 0x39c0 as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x393b as libc::c_int as u16_0);
    EnIk_SetupAction(this,
                     Some(func_80A75A38 as
                              unsafe extern "C" fn(_: *mut EnIk,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75A38(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
            ...
            let mut sp7C: Vec3f =
                {
                    let mut init = Vec3f{x: 0.0f32, y: 0.5f32, z: 0.0f32,};
                    init
                };
            (*this).unk_2F9 = (*this).unk_2F9.wrapping_sub(1);
            i =
                0xc as libc::c_int -
                    ((*this).unk_2F9 as libc::c_int >> 1 as libc::c_int);
            while i >= 0 as libc::c_int {
                pos.x =
                    (*this).actor.world.pos.x + Rand_CenteredFloat(120.0f32);
                pos.z =
                    (*this).actor.world.pos.z + Rand_CenteredFloat(120.0f32);
                pos.y =
                    (*this).actor.world.pos.y + 20.0f32 +
                        Rand_CenteredFloat(50.0f32);
                EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut sp7C,
                                     &mut sp7C, 100 as libc::c_int as s16,
                                     0 as libc::c_int as s16,
            ...
            if (*this).unk_2F9 as libc::c_int == 0 as libc::c_int {
                Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                           &mut (*this).actor.world.pos,
                                           0xb0 as libc::c_int as s16);
                if (*this).switchFlags as libc::c_int != 0xff as libc::c_int {
                    Flags_SetSwitch(globalCtx, (*this).switchFlags as s32);
                }
                Actor_Kill(&mut (*this).actor);
            }
        }
    } else if (*this).skelAnime.curFrame == 23.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3928 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75C38(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_f0: f32_0 = 0.;
    let mut pad: u8_0 = 0;
    let mut pad2: u8_0 = 0;
    let mut prevHealth: u8_0 = 0;
    let mut temp_v0_3: s32 = 0;
    let mut sp38: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_2F8 as libc::c_int == 3 as libc::c_int ||
           (*this).unk_2F8 as libc::c_int == 2 as libc::c_int {
        return
    }
    ...
    sp38.y += 50.0f32;
    Actor_SetDropFlag(&mut (*this).actor, &mut (*this).bodyCollider.info,
                      1 as libc::c_int);
    temp_v0_3 = (*this).actor.colChkInfo.damageEffect as s32;
    (*this).unk_2FD = (temp_v0_3 & 0xff as libc::c_int) as u8_0;
    (*this).bodyCollider.base.acFlags =
        ((*this).bodyCollider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
    if (*this).unk_2FD as libc::c_int == 0 as libc::c_int ||
           (*this).unk_2FD as libc::c_int == 0xd as libc::c_int ||
           (*this).unk_2FB as libc::c_int == 0 as libc::c_int &&
               (*this).unk_2FD as libc::c_int == 0xe as libc::c_int {
        if (*this).unk_2FD as libc::c_int != 0 as libc::c_int {
            CollisionCheck_SpawnShieldParticlesMetal(globalCtx, &mut sp38);
        }
        return
    }
    ...
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        if prevHealth as libc::c_int > 10 as libc::c_int &&
               (*this).actor.colChkInfo.health as libc::c_int <=
                   10 as libc::c_int {
            (*this).unk_2FB = 1 as libc::c_int as u8_0;
            BodyBreak_Alloc(&mut (*this).bodyBreak, 3 as libc::c_int,
                            globalCtx);
        }
        ...
        if prevHealth as libc::c_int == 50 as libc::c_int {
            Actor_ChangeCategory(globalCtx, &mut (*globalCtx).actorCtx,
                                 &mut (*this).actor,
                                 ACTORCAT_ENEMY as libc::c_int as u8_0);
        }
    ...
    Math_SmoothStepToS(&mut (*this).actor.world.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       1 as libc::c_int as s16, 0x7d0 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if (*this).actor.params as libc::c_int == 0 as libc::c_int &&
           Rand_ZeroOne() < 0.5f32 {
        if (if ((*this).actor.yawTowardsPlayer as libc::c_int -
    ...
    if (*this).actor.params as libc::c_int != 0 as libc::c_int &&
        ...
        if prevHealth as libc::c_int > 10 as libc::c_int &&
               (*this).actor.colChkInfo.health as libc::c_int <=
                   10 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x392c as libc::c_int as u16_0);
        } else {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39be as libc::c_int as u16_0);
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x393b as libc::c_int as u16_0);
        }
        func_80A75790(this);
        return
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x393a as libc::c_int as u16_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x39be as libc::c_int as u16_0);
    CollisionCheck_SpawnShieldParticles(globalCtx, &mut sp38);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A75FA0(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    let mut pad: s32 = 0;
    ...
    let mut prevInvincibilityTimer: u8_0 = 0;
    (*this).unk_2FA = (*this).unk_2FB;
    func_80A75C38(this, globalCtx);
    if (*this).actor.params as libc::c_int == 0 as libc::c_int &&
           (*this).actor.colChkInfo.health as libc::c_int <= 10 as libc::c_int
       {
        func_80A781CC(&mut (*this).actor, globalCtx);
        return
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    if (*this).axeCollider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).axeCollider.base.atFlags =
            ((*this).axeCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if &mut (*player).actor as *mut Actor == (*this).axeCollider.base.at {
            prevInvincibilityTimer = (*player).invincibilityTimer as u8_0;
    ...
    if (*this).unk_2FE as libc::c_int > 0 as libc::c_int {
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).axeCollider.base);
    }
    if (*this).unk_2F8 as libc::c_int == 9 as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).shieldCollider.base);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A761B0(mut gfxCtx: *mut GraphicsContext,
                                       mut primR: u8_0, mut primG: u8_0,
                                       mut primB: u8_0, mut envR: u8_0,
                                       mut envG: u8_0, mut envB: u8_0)
 -> *mut Gfx {
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_OverrideLimbDraw3(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 12 as libc::c_int {
        if (*this).actor.params as libc::c_int != 0 as libc::c_int {
            *dList = object_ik_DL_018E78.as_mut_ptr()
        }
    } else if limbIndex == 13 as libc::c_int {
        if (*this).actor.params as libc::c_int != 0 as libc::c_int {
            *dList = object_ik_DL_019100.as_mut_ptr()
        }
    } else if limbIndex == 26 as libc::c_int || limbIndex == 27 as libc::c_int
     {
        if (*this).unk_2FA as libc::c_int & 1 as libc::c_int != 0 {
            *dList = 0 as *mut Gfx
        }
    } else if limbIndex == 28 as libc::c_int || limbIndex == 29 as libc::c_int
     {
        if (*this).unk_2FA as libc::c_int & 1 as libc::c_int == 0 {
            *dList = 0 as *mut Gfx
        }
...
static mut D_80A7847C: [Vec3f; 4] =
    [{
         let mut init = Vec3f{x: 800.0f32, y: -200.0f32, z: -5200.0f32,};
         init
     }, { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init },
     {
         let mut init = Vec3f{x: -200.0f32, y: -2200.0f32, z: -200.0f32,};
         init
     },
     {
         let mut init = Vec3f{x: -6000.0f32, y: 2000.0f32, z: -3000.0f32,};
         init
     }];
static mut D_80A784AC: [Vec3f; 3] =
    [{
         let mut init =
             Vec3f{x: -3000.0f64 as f32_0,
                   y: -700.0f64 as f32_0,
                   z: -5000.0f64 as f32_0,};
         init
     },
     {
         let mut init =
             Vec3f{x: -3000.0f64 as f32_0,
                   y: -700.0f64 as f32_0,
                   z: 2000.0f64 as f32_0,};
         init
     },
     {
         let mut init =
             Vec3f{x: 4000.0f64 as f32_0,
                   y: -700.0f64 as f32_0,
                   z: 2000.0f64 as f32_0,};
         init
     }];
static mut D_80A784D0: [Vec3f; 3] =
    [{
         let mut init =
             Vec3f{x: 4000.0f64 as f32_0,
                   y: -700.0f64 as f32_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_PostLimbDraw3(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ik_inFight.c\x00" as *const u8 as
                        *const libc::c_char, 1201 as libc::c_int);
    if (*this).unk_2FB as libc::c_int & 1 as libc::c_int != 0 {
        BodyBreak_SetInfo(&mut (*this).bodyBreak, limbIndex,
                          26 as libc::c_int, 27 as libc::c_int,
                          28 as libc::c_int as u32_0, dList,
                          -(1 as libc::c_int) as s16);
    }
    if limbIndex == 12 as libc::c_int {
            ...
            (*_g_0).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_0).words.w1 =
                object_ik_DL_019E08.as_mut_ptr() as libc::c_uint
        } else {
            ...
            (*_g_1).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_1).words.w1 =
                object_ik_DL_016D88.as_mut_ptr() as libc::c_uint
        }
    } else if limbIndex == 17 as libc::c_int {
        let mut i: s32 = 0;
        let mut sp9C: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
        let mut sp78: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
        Matrix_MultVec3f(&mut *D_80A7847C.as_mut_ptr().offset(0 as libc::c_int
                                                                  as isize),
                         &mut *(*this).axeCollider.dim.quad.as_mut_ptr().offset(1
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    isize));
        Matrix_MultVec3f(&mut *D_80A7847C.as_mut_ptr().offset(1 as libc::c_int
                                                                  as isize),
                         &mut *(*this).axeCollider.dim.quad.as_mut_ptr().offset(0
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    isize));
        Matrix_MultVec3f(&mut *D_80A7847C.as_mut_ptr().offset(2 as libc::c_int
                                                                  as isize),
                         &mut *(*this).axeCollider.dim.quad.as_mut_ptr().offset(3
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    isize));
        Matrix_MultVec3f(&mut *D_80A7847C.as_mut_ptr().offset(3 as libc::c_int
                                                                  as isize),
                         &mut *(*this).axeCollider.dim.quad.as_mut_ptr().offset(2
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    isize));
        Collider_SetQuadVertices(&mut (*this).axeCollider,
                                 &mut *(*this).axeCollider.dim.quad.as_mut_ptr().offset(0
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
        ...
        Matrix_MultVec3f(&mut *D_80A7847C.as_mut_ptr().offset(1 as libc::c_int
                         ...
                         &mut spE8);
        if (*this).unk_2FE as libc::c_int > 0 as libc::c_int {
            EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIdx) as
                                      *mut EffectBlure, &mut spF4, &mut spE8);
        } else if (*this).unk_2FE as libc::c_int == 0 as libc::c_int {
            EffectBlure_AddSpace(Effect_GetByIndex((*this).blureIdx) as
                                     *mut EffectBlure);
            (*this).unk_2FE = -(1 as libc::c_int) as s8
        }
        if (*this).unk_2F8 as libc::c_int == 9 as libc::c_int {
            ...
            while i <
                      (::std::mem::size_of::<[Vec3f; 3]>() as
                           libc::c_ulong).wrapping_div(::std::mem::size_of::<Vec3f>()
                                                           as libc::c_ulong)
                          as s32 {
                Matrix_MultVec3f(&mut *D_80A784AC.as_mut_ptr().offset(i as
                                                                          isize),
                                 &mut *sp9C.as_mut_ptr().offset(i as isize));
                Matrix_MultVec3f(&mut *D_80A784D0.as_mut_ptr().offset(i as
                                                                          isize),
                                 &mut *sp78.as_mut_ptr().offset(i as isize));
                i += 1
            }
            Collider_SetTrisVertices(&mut (*this).shieldCollider,
                                     0 as libc::c_int,
                                     &mut *sp9C.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp9C.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp9C.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
            Collider_SetTrisVertices(&mut (*this).shieldCollider,
                                     1 as libc::c_int,
                                     &mut *sp78.as_mut_ptr().offset(0 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp78.as_mut_ptr().offset(1 as
                                                                        libc::c_int
                                                                        as
                                                                        isize),
                                     &mut *sp78.as_mut_ptr().offset(2 as
                                                                        libc::c_int
                                                                        as
                                                                        isize));
        }
            ...
            (*_g_3).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_3).words.w1 =
                object_ik_DL_016F88.as_mut_ptr() as libc::c_uint
        }
        24 => {
            ...
            (*_g_5).words.w0 =
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                        ...
                        0 as libc::c_int;
            (*_g_5).words.w1 =
                object_ik_DL_016EE8.as_mut_ptr() as libc::c_uint
        }
        26 => {
            if (*this).unk_2FA as libc::c_int & 1 as libc::c_int == 0 {
                ...
                (*_g_7).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_7).words.w1 =
                    object_ik_DL_016BE0.as_mut_ptr() as libc::c_uint
            }
        }
        27 => {
            if (*this).unk_2FA as libc::c_int & 1 as libc::c_int == 0 {
                ...
                (*_g_8).words.w1 =
                    Matrix_NewMtx((*globalCtx).state.gfxCtx,
                                  b"../z_en_ik_inFight.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 1288 as libc::c_int)
                        as libc::c_uint;
                ...
                (*_g_9).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                        ...
                        (0 as libc::c_int as u32_0 &
                            ...
                            0 as libc::c_int;
                (*_g_9).words.w1 =
                    object_ik_DL_016CD8.as_mut_ptr() as libc::c_uint
            }
        }
        _ => { }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A76798(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ik_inFight.c\x00" as *const u8 as
                        *const libc::c_char, 1309 as libc::c_int);
    ...
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          245 as libc::c_int as u8_0,
                          225 as libc::c_int as u8_0,
                          155 as libc::c_int as u8_0,
                          30 as libc::c_int as u8_0,
                          30 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint;
        ...
        (*_g_1).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          ...
                          30 as libc::c_int as u8_0) as libc::c_uint
        ...
        (*_g_3).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          185 as libc::c_int as u8_0,
                          135 as libc::c_int as u8_0,
                          25 as libc::c_int as u8_0,
                          20 as libc::c_int as u8_0,
                          20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint;
        ...
        (*_g_4).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          ...
                          30 as libc::c_int as u8_0,
                          40 as libc::c_int as u8_0,
                          20 as libc::c_int as u8_0) as libc::c_uint
    } else if (*this).actor.params as libc::c_int == 2 as libc::c_int {
        ...
        (*_g_5).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          ...
                          65 as libc::c_int as u8_0,
                          55 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
                          0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint;
        ...
        (*_g_6).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          205 as libc::c_int as u8_0,
                          165 as libc::c_int as u8_0,
                          75 as libc::c_int as u8_0,
                          25 as libc::c_int as u8_0,
                          20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint;
        ...
        (*_g_8).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          ...
                          180 as libc::c_int as u8_0,
                          180 as libc::c_int as u8_0) as libc::c_uint;
        let fresh25 = (*__gfxCtx).polyOpa.p;
        (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
        let mut _g_9: *mut Gfx = fresh25;
        (*_g_9).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
        ...
        (*_g_9).words.w1 =
            func_80A761B0((*globalCtx).state.gfxCtx,
                          225 as libc::c_int as u8_0,
                          205 as libc::c_int as u8_0,
                          115 as libc::c_int as u8_0,
                          25 as libc::c_int as u8_0,
                          20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0)
                as libc::c_uint;
        let fresh26 = (*__gfxCtx).polyOpa.p;
        (*__gfxCtx).polyOpa.p = (*__gfxCtx).polyOpa.p.offset(1);
        let mut _g_10: *mut Gfx = fresh26;
        (*_g_10).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnIk_OverrideLimbDraw3 as
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_StartMusic() {
    func_800F5ACC(0x38 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A76C14(mut this: *mut EnIk) {
    if Animation_OnFrame(&mut (*this).skelAnime, 1.0f32) != 0 {
        Audio_PlaySoundGeneral(0x39c2 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 33.0f32) != 0 {
        Audio_PlaySoundGeneral(0x3928 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 68.0f32) != 0 ||
                  Animation_OnFrame(&mut (*this).skelAnime, 80.0f32) != 0 {
        Audio_PlaySoundGeneral(0x392a as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 107.0f32) != 0 {
        Audio_PlaySoundGeneral(0x3939 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 156.0f32) != 0 {
        Audio_PlaySoundGeneral(0x392a as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if Animation_OnFrame(&mut (*this).skelAnime, 188.0f32) != 0 {
        Audio_PlaySoundGeneral(0x3938 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A76DDC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext,
                                       mut pos: *mut Vec3f) {
    Audio_PlaySoundGeneral(0x390d as libc::c_int as u16_0,
                           &mut (*this).actor.projectedPos,
                           4 as libc::c_int as u8_0, &mut D_801333E0,
                           &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A76E2C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext,
                                       mut pos: *mut Vec3f) {
    static mut D_80A78514: [Vec3f; 20] =
        [{
             let mut init =
                 Vec3f{x: 1000.0f64 as f32_0,
                       y: -1000.0f64 as f32_0,
                       z: 1000.0f64 as f32_0,};
             init
         },
         {
             let mut init =
                 Vec3f{x: 0.0f64 as f32_0,
                       y: -1000.0f64 as f32_0,
                       z: 0.0f64 as f32_0,};
             init
         },
         {
             let mut init =
                 Vec3f{x: -1000.0f64 as f32_0,
                       y: -5000.0f64 as f32_0,
                       z: -4000.0f64 as f32_0,};
             init
         },
         {
             let mut init =
         ...
         },
         {
             let mut init =
                 Vec3f{x: -1000.0f64 as f32_0,
                       y: 1000.0f64 as f32_0,
                       z: -6000.0f64 as f32_0,};
             init
         },
         {
             let mut init =
                 Vec3f{x: -1000.0f64 as f32_0,
                       y: 3000.0f64 as f32_0,
                       z: -5000.0f64 as f32_0,};
             init
         },
         {
             let mut init =
                 Vec3f{x: -800.0f64 as f32_0,
                       y: 1000.0f64 as f32_0,
                       z: -3000.0f64 as f32_0,};
             init
         },
         ...
         {
             let mut init =
                 Vec3f{x: 900.0f64 as f32_0,
                       y: -800.0f64 as f32_0,
                       z: 2700.0f64 as f32_0,};
             init
         },
         {
             let mut init = Vec3f{x: 720.0f32, y: 900.0f32, z: 2500.0f32,};
             init
         }];
    if (*this).unk_4D4 == 0 as libc::c_int {
        let mut pad: s32 = 0;
        let mut effectVelocity: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
        let mut effectAccel: Vec3f =
            { let mut init = Vec3f{x: 0.0f32, y: 0.3f32, z: 0.0f32,}; init };
        let mut i: s32 = 0;
        i =
            (::std::mem::size_of::<[Vec3f; 20]>() as
        ...
        while i >= 0 as libc::c_int {
            ...
            Matrix_MultVec3f(&mut *D_80A78514.as_mut_ptr().offset(i as isize),
                             &mut effectPos);
            temp_v0 = (Rand_ZeroOne() * 20.0f32 - 10.0f32) as s32;
            primColor.r = (primColor.r as libc::c_int + temp_v0) as u8_0;
            primColor.g = (primColor.g as libc::c_int + temp_v0) as u8_0;
            primColor.b = (primColor.b as libc::c_int + temp_v0) as u8_0;
            envColor.r = (envColor.r as libc::c_int + temp_v0) as u8_0;
            envColor.g = (envColor.g as libc::c_int + temp_v0) as u8_0;
            envColor.b = (envColor.b as libc::c_int + temp_v0) as u8_0;
            func_8002829C(globalCtx, &mut effectPos, &mut effectVelocity,
                          &mut effectAccel, &mut primColor, &mut envColor,
                          (Rand_ZeroOne() * 60.0f32 + 300.0f32) as s16,
                          0 as libc::c_int as s16);
            i -= 1
        }
        (*this).unk_4D4 = 1 as libc::c_int;
        func_80A76DDC(this, globalCtx, pos);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77034(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 30.0f32,
                            30.0f32, 5 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7707C(mut this: *mut EnIk) -> s32 {
    return SkelAnime_Update(&mut (*this).skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn EnIk_GetNpcAction(mut globalCtx: *mut GlobalContext,
                                           mut actionIdx: s32)
 -> *mut CsCmdActorAction {
    if (*globalCtx).csCtx.state as libc::c_int != CS_STATE_IDLE as libc::c_int
       {
        return (*globalCtx).csCtx.npcActions[actionIdx as usize]
    } else { return 0 as *mut CsCmdActorAction };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A770C0(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext,
                                       mut actionIdx: s32) {
    let mut npcAction: *mut CsCmdActorAction =
        EnIk_GetNpcAction(globalCtx, actionIdx);
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_curFrame(mut thisx: *mut Actor) -> f32_0 {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    return (*this).skelAnime.curFrame;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77148(mut this: *mut EnIk) {
    (*this).action = 0 as libc::c_int;
    (*this).drawMode = 0 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77158(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00C114,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_ik_Anim_00C114 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    func_80A770C0(this, globalCtx, 4 as libc::c_int);
    (*this).action = 1 as libc::c_int;
    (*this).drawMode = 1 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A771E4(mut this: *mut EnIk) {
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_00C114,
                     1.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_ik_Anim_00C114 as
                                                *mut AnimationHeader as
    ...
    (*this).drawMode = 1 as libc::c_int;
    (*this).unk_4D4 = 0 as libc::c_int;
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77264(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext,
                                       mut arg2: s32) {
    if arg2 != 0 as libc::c_int &&
           !EnIk_GetNpcAction(globalCtx, 4 as libc::c_int).is_null() {
        func_80A78160(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A772A4(mut this: *mut EnIk) {
    Audio_PlaySoundGeneral(0x392b as libc::c_int as u16_0,
                           &mut (*this).actor.projectedPos,
                           4 as libc::c_int as u8_0, &mut D_801333E0,
                           &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A772EC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    static mut D_80A78FA0: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pad: [s32; 2] = [0; 2];
    let mut wDest: f32_0 = 0.;
    SkinMatrix_Vec3fMtxFMultXYZW(&mut (*globalCtx).viewProjectionMtxF,
                                 &mut (*this).actor.world.pos,
                                 &mut D_80A78FA0, &mut wDest);
    Audio_PlaySoundGeneral(0x39c0 as libc::c_int as u16_0, &mut D_80A78FA0,
                           4 as libc::c_int as u8_0, &mut D_801333E0,
                           &mut D_801333E0, &mut D_801333E8);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7735C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 3] = [0; 3];
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut object_ik_Anim_0203D8 as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut object_ik_Skel_0205C0, 0 as *mut AnimationHeader,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 30 as libc::c_int);
    Animation_Change(&mut (*this).skelAnime, &mut object_ik_Anim_0203D8,
                     1.0f32, 0.0f32, frames,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).action = 3 as libc::c_int;
    (*this).drawMode = 2 as libc::c_int;
    func_80A770C0(this, globalCtx, 4 as libc::c_int);
    func_80A772EC(this, globalCtx);
    (*this).actor.shape.shadowAlpha = 0xff as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77434(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A77474(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7748C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A77034(this, globalCtx);
    func_80A779DC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A774BC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A7707C(this);
    func_80A77034(this, globalCtx);
    func_80A779DC(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A774F8(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    if EnIk_GetNpcAction(globalCtx, 4 as libc::c_int).is_null() {
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnIk_OverrideLimbDraw2(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut pos: *mut Vec3f,
 ...
 -> s32 {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    if limbIndex == 13 as libc::c_int || limbIndex == 26 as libc::c_int ||
           limbIndex == 27 as libc::c_int {
        if EnIk_curFrame(&mut (*this).actor) >= 30.0f32 {
            *dList = 0 as *mut Gfx
        }
    }
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_PostLimbDraw2(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_ik_inAwake.c\x00" as *const u8 as
    ...
    match limbIndex {
            ...
            if EnIk_curFrame(&mut (*this).actor) < 30.0f32 {
                ...
                (*_g).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_en_ik_inAwake.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 267 as libc::c_int)
                        as libc::c_uint;
        ...
        26 => {
            let mut this_0: *mut EnIk = thisx as *mut EnIk;
            if EnIk_curFrame(&mut (*this_0).actor) < 30.0f32 {
                ...
                (*_g_5).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_en_ik_inAwake.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 288 as libc::c_int)
                        as libc::c_uint;
        ...
        27 => {
            let mut this_1: *mut EnIk = thisx as *mut EnIk;
            if EnIk_curFrame(&mut (*this_1).actor) < 30.0f32 {
                let fresh35 = (*__gfxCtx).polyXlu.p;
                (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
                let mut _g_7: *mut Gfx = fresh35;
                (*_g_7).words.w0 =
                    (0xda as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                ...
                (*_g_7).words.w1 =
                    Matrix_NewMtx(gfxCtx,
                                  b"../z_en_ik_inAwake.c\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char, 297 as libc::c_int)
                        as libc::c_uint;
                let fresh36 = (*__gfxCtx).polyXlu.p;
                (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
                let mut _g_8: *mut Gfx = fresh36;
                (*_g_8).words.w0 =
                    (0xde as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 8 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
...
#[no_mangle]
pub unsafe extern "C" fn func_80A77844(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        func_80A761B0(gfxCtx, 245 as libc::c_int as u8_0,
                      225 as libc::c_int as u8_0, 155 as libc::c_int as u8_0,
                      30 as libc::c_int as u8_0, 30 as libc::c_int as u8_0,
                      0 as libc::c_int as u8_0) as libc::c_uint;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        func_80A761B0(gfxCtx, 255 as libc::c_int as u8_0,
                      40 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
                      40 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
                      0 as libc::c_int as u8_0) as libc::c_uint;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_en_ik_inAwake.c\x00" as *const u8 as
                         *const libc::c_char, 345 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A779DC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut npcAction: *mut CsCmdActorAction =
        EnIk_GetNpcAction(globalCtx, 4 as libc::c_int);
    let mut action: u32_0 = 0;
    let mut currentNpcAction: u32_0 = 0;
    if !npcAction.is_null() {
        action = (*npcAction).action as u32_0;
        currentNpcAction = (*this).npcAction;
        if action != currentNpcAction {
            match action {
                1 => { func_80A77148(this); }
                2 => { func_80A77158(this, globalCtx); }
                3 => { func_80A771E4(this); }
                4 => { func_80A78160(this, globalCtx); }
                5 => { func_80A7735C(this, globalCtx); }
                6 => { func_80A77434(this, globalCtx); }
                7 => { func_80A77474(this, globalCtx); }
                _ => {
                    osSyncPrintf(b"En_Ik_inConfrontion_Check_DemoMode:\xe3\x81\x9d\xe3\x82\x93\xe3\x81\xaa\xe5\x8b\x95\xe4\xbd\x9c\xe3\x81\xaf\xe7\x84\xa1\xe3\x81\x84!!!!!!!!\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn func_80A77AEC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A779DC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77B0C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    func_80A77034(this, globalCtx);
    func_80A779DC(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77B3C(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp24: s32 = 0;
...
static mut sActionFuncs: [EnIkActionFunc; 6] =
    unsafe {
        [Some(func_80A77AEC as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A77B0C as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A77B3C as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A7748C as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A774BC as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A774F8 as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnIk_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    if (*this).action < 0 as libc::c_int ||
           (*this).action >=
               (::std::mem::size_of::<[EnIkActionFunc; 6]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<EnIkActionFunc>()
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_OverrideLimbDraw1(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut pos: *mut Vec3f,
 ...
 -> s32 {
    ...
    match limbIndex {
        17 => {
            ...
            if curFrame < 120.0f32 {
                *dList = 0 as *mut Gfx
            } else { func_80A76E2C(this, globalCtx, pos); }
        }
        29 | 30 => { *dList = 0 as *mut Gfx }
        _ => { }
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnIk_PostLimbDraw1(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
    ...
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_en_ik_inConfrontion.c\x00" as *const u8 as
                        *const libc::c_char, 571 as libc::c_int);
    match limbIndex {
        12 => {
            ...
            (*_g).words.w1 =
                Matrix_NewMtx(gfxCtx,
                              b"../z_en_ik_inConfrontion.c\x00" as *const u8
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_en_ik_inConfrontion.c\x00" as *const u8 as
                         *const libc::c_char, 604 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77ED0(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_80A77EDC(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut skelAnime: *mut SkelAnime = &mut (*this).skelAnime;
    let mut pad: [s32; 2] = [0; 2];
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*skelAnime).skeleton,
                          (*skelAnime).jointTable,
                          (*skelAnime).dListCount as s32,
                          Some(EnIk_OverrideLimbDraw1 as
                                   unsafe extern "C" fn(_: *mut GlobalContext,
                                                        _: s32,
                                                        _: *mut *mut Gfx,
                                                        _: *mut Vec3f,
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_en_ik_inConfrontion.c\x00" as *const u8 as
                         *const libc::c_char, 653 as libc::c_int);
}
static mut sDrawFuncs: [EnIkDrawFunc; 3] =
    unsafe {
        [Some(func_80A77ED0 as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A77EDC as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ()),
         Some(func_80A77844 as
                  unsafe extern "C" fn(_: *mut EnIk, _: *mut GlobalContext)
                      -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn EnIk_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    if (*this).drawMode < 0 as libc::c_int ||
           (*this).drawMode >=
               (::std::mem::size_of::<[EnIkDrawFunc; 3]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<EnIkDrawFunc>()
                                                    as libc::c_ulong) as s32
...
#[no_mangle]
pub unsafe extern "C" fn func_80A780D0(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        ...
        } else { func_80A78160(this, globalCtx); EnIk_StartMusic(); }
    }
    osSyncPrintf(b"En_Ik_inConfrontion_Init : %d !!!!!!!!!!!!!!!!\n\x00" as
                     *const u8 as *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A78160(mut this: *mut EnIk,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.update =
        Some(func_80A75FA0 as
                 unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext)
    ...
    gSaveContext.eventChkInf[3 as libc::c_int as usize] =
        (gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int |
             0x800 as libc::c_int) as u16_0;
    Actor_SetScale(&mut (*this).actor, 0.012f32);
    func_80A7489C(this);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A781CC(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    if Gameplay_InCsMode(globalCtx) == 0 {
        ...
        Cutscene_SetSegment(globalCtx,
                            gSpiritBossNabooruKnuckleDefeatCs.as_mut_ptr() as
                                *mut libc::c_void);
...
#[no_mangle]
pub unsafe extern "C" fn EnIk_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIk = thisx as *mut EnIk;
    let mut flag: s32 =
        (*this).actor.params as libc::c_int & 0xff00 as libc::c_int;
    if (*this).actor.params as libc::c_int & 0xff as libc::c_int ==
           0 as libc::c_int &&
           gSaveContext.eventChkInf[3 as libc::c_int as usize] as libc::c_int
               & 0x1000 as libc::c_int != 0 ||
           flag != 0 as libc::c_int &&
               Flags_GetSwitch(globalCtx, flag >> 8 as libc::c_int) != 0 {
        Actor_Kill(&mut (*this).actor);
    } else {
        ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                        Some(ActorShadow_DrawCircle as
                                 unsafe extern "C" fn(_: *mut Actor,
                                     ...
                                     -> ()), 30.0f32);
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut object_ik_Skel_01E178,
                           &mut object_ik_Anim_00C114,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           30 as libc::c_int);
        func_80A74398(&mut (*this).actor, globalCtx);
        func_80A780D0(this, globalCtx);
    };
}
#[no_mangle]
pub static mut En_Ik_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_IK as libc::c_int as s16,
                          category: ACTORCAT_BOSS as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_IK as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnIk>() as libc::c_ulong,
                          init:
