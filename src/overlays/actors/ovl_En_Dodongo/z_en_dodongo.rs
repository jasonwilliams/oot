...
extern "C" {
    ...
    #[no_mangle]
    fn EffectSsDFire_SpawnFixedScale(globalCtx: *mut GlobalContext,
                                     pos: *mut Vec3f, velocity: *mut Vec3f,
                                     accel: *mut Vec3f, alpha: s16,
                                     fadeDelay: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gDodongoDieAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoDamageAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoBreatheFireAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoAfterBreatheFireAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoSweepTailRightAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoSweepTailLeftAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoWaitAnim: AnimationHeader;
    #[no_mangle]
    static mut gDodongoSkel: SkeletonHeader;
    #[no_mangle]
    static mut gDodongoWalkAnim: AnimationHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnDodongo {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 31],
    pub morphTable: [Vec3s; 31],
    pub actionState: s32,
    pub actionFunc: EnDodongoActionFunc,
    pub timer: s16,
    pub retreatTimer: s16,
    pub tailSwipeSpeed: s16,
    pub iceTimer: s16,
    pub unk_314: [libc::c_char; 2],
    pub rightFootStep: s16,
    pub unk_318: [libc::c_char; 4],
    ...
    pub bodyScale: Vec3f,
    pub icePos: [Vec3f; 9],
    pub bombSmokePrimColor: Color_RGBA8,
    pub bombSmokeEnvColor: Color_RGBA8,
    pub damageEffect: u8_0,
    pub blureIdx: s32,
    pub colliderAT: ColliderQuad,
    pub colliderHard: ColliderTris,
    pub trisElements: [ColliderTrisElement; 3],
    pub colliderBody: ColliderJntSph,
    pub sphElements: [ColliderJntSphElement; 6],
}
pub type EnDodongoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnDodongo, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_24 = libc::c_int;
pub const EN_DODONGO_SMOKE_DEATH: C2RustUnnamed_24 = 0;
pub const EN_DODONGO_NORMAL: C2RustUnnamed_24 = -1;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
    pub actor: Actor,
...
pub const BOMB_EXPLOSION: C2RustUnnamed_25 = 1;
pub const BOMB_BODY: C2RustUnnamed_25 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBombf {
    pub actor: Actor,
    ...
    pub explosionColliderItems: [ColliderJntSphElement; 1],
    pub timer: s16,
    pub actionFunc: EnBombfActionFunc,
    pub unk_200: s32,
    pub bumpOn: u8_0,
    pub flashSpeedScale: s16,
    pub flashIntensity: f32_0,
    pub flowerBombScale: f32_0,
}
pub type EnBombfActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBombf, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const DODONGO_WALK: C2RustUnnamed_26 = 8;
pub const DODONGO_STUNNED: C2RustUnnamed_26 = 7;
pub const DODONGO_UNUSED: C2RustUnnamed_26 = 6;
pub const DODONGO_END_BREATHE_FIRE: C2RustUnnamed_26 = 5;
pub const DODONGO_IDLE: C2RustUnnamed_26 = 4;
pub const DODONGO_BREATHE_FIRE: C2RustUnnamed_26 = 3;
pub const DODONGO_DEATH: C2RustUnnamed_26 = 2;
pub const DODONGO_SWALLOW_BOMB: C2RustUnnamed_26 = 1;
pub const DODONGO_SWEEP_TAIL: C2RustUnnamed_26 = 0;
#[no_mangle]
pub static mut En_Dodongo_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_DODONGO as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_DODONGO as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnDodongo>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDodongo_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnDodongo_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBodyElementsInit: [ColliderJntSphElementInit; 6] =
    [{
         let mut init =
...
static mut sBodyJntSphInit: ColliderJntSphInit =
    unsafe {
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   elements:
                                       sBodyElementsInit.as_ptr() as *mut _,};
            init
        }
    };
static mut sHardElementsInit: [ColliderTrisElementInit; 3] =
    [{
         let mut init =
...
static mut sHardTrisInit: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sHardElementsInit.as_ptr() as *mut _,};
            init
        }
    };
static mut sAttackQuadInit: ColliderQuadInit =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupAction(mut this: *mut EnDodongo,
                                               mut actionFunc:
                                                   EnDodongoActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SpawnBombSmoke(mut this: *mut EnDodongo,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    let mut pos: Vec3f = (*this).headPos;
    let mut randAngle: s16 =
        Rand_CenteredFloat(0x4000 as libc::c_int as f32_0) as s16;
    let mut randCos: f32_0 = 0.;
    let mut randSin: f32_0 = 0.;
    randCos =
        Math_CosS(((*this).actor.shape.rot.y as libc::c_int +
                       randAngle as libc::c_int) as s16);
    randSin =
        Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                       randAngle as libc::c_int) as s16);
    if (*this).bombSmokePrimColor.r as libc::c_int > 30 as libc::c_int {
        (*this).bombSmokePrimColor.r =
            ((*this).bombSmokePrimColor.r as libc::c_int - 16 as libc::c_int)
                as u8_0;
        (*this).bombSmokePrimColor.g =
            ((*this).bombSmokePrimColor.g as libc::c_int - 16 as libc::c_int)
                as u8_0
    }
    if ((*this).bombSmokePrimColor.b as libc::c_int) < 30 as libc::c_int {
        (*this).bombSmokePrimColor.b =
            ((*this).bombSmokePrimColor.b as libc::c_int + 5 as libc::c_int)
                as u8_0;
        (*this).bombSmokePrimColor.a =
            ((*this).bombSmokePrimColor.a as libc::c_int + 8 as libc::c_int)
                as u8_0;
        (*this).bombSmokeEnvColor.a =
            ((*this).bombSmokeEnvColor.a as libc::c_int + 8 as libc::c_int) as
                u8_0
    }
    if (*this).bombSmokeEnvColor.r as libc::c_int != 0 as libc::c_int {
        (*this).bombSmokeEnvColor.r =
            ((*this).bombSmokeEnvColor.r as libc::c_int - 15 as libc::c_int)
                as u8_0
    }
    if (*this).bombSmokeEnvColor.g as libc::c_int != 0 as libc::c_int {
        (*this).bombSmokeEnvColor.g =
            (*this).bombSmokeEnvColor.g.wrapping_sub(1)
    }
    velocity.x = randSin * 3.5f32;
    velocity.y =
        (*this).bombSmokeEnvColor.r as libc::c_int as libc::c_float * 0.02f32;
    velocity.z = randCos * 3.5f32;
    accel.x = (Rand_ZeroOne() * 0.1f32 + 0.15f32) * -randSin;
    accel.z = (Rand_ZeroOne() * 0.1f32 + 0.15f32) * -randCos;
    func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel,
                  &mut (*this).bombSmokePrimColor,
                  &mut (*this).bombSmokeEnvColor, 100 as libc::c_int as s16,
                  25 as libc::c_int as s16, 20 as libc::c_int as s16);
    randAngle =
        (Rand_ZeroOne() * 0x2000 as libc::c_int as libc::c_float) as s16;
    randCos =
        Math_CosS(((*this).actor.shape.rot.y as libc::c_int +
                       randAngle as libc::c_int) as s16);
    randSin =
        Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                       randAngle as libc::c_int) as s16);
    pos.x -= randCos * 6.0f32;
    pos.z += randSin * 6.0f32;
    velocity.x = -randCos * 3.5f32;
    velocity.y =
        (*this).bombSmokeEnvColor.r as libc::c_int as libc::c_float * 0.02f32;
    velocity.z = randSin * 3.5f32;
    accel.x = (Rand_ZeroOne() * 0.1f32 + 0.15f32) * randCos;
    accel.z = (Rand_ZeroOne() * 0.1f32 + 0.15f32) * -randSin;
    func_8002836C(globalCtx, &mut pos, &mut velocity, &mut accel,
                  &mut (*this).bombSmokePrimColor,
                  &mut (*this).bombSmokeEnvColor, 100 as libc::c_int as s16,
                  25 as libc::c_int as s16, 20 as libc::c_int as s16);
    ...
    randSin =
        Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                       randAngle as libc::c_int) as s16);
    pos.x = (*this).headPos.x + randCos * 6.0f32;
    pos.z = (*this).headPos.z - randSin * 6.0f32;
    velocity.x = randCos * 3.5f32;
    velocity.y =
        (*this).bombSmokeEnvColor.r as libc::c_int as libc::c_float * 0.02f32;
    velocity.z = -randSin * 3.5f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnDodongo = thisx as *mut EnDodongo;
    ...
    (*this).bombSmokeEnvColor.r = 255 as libc::c_int as u8_0;
    (*this).bombSmokePrimColor.g = (*this).bombSmokeEnvColor.r;
    (*this).bombSmokePrimColor.r = (*this).bombSmokePrimColor.g;
    (*this).bombSmokeEnvColor.a = 200 as libc::c_int as u8_0;
    (*this).bombSmokePrimColor.a = (*this).bombSmokeEnvColor.a;
    (*this).bombSmokeEnvColor.g = 10 as libc::c_int as u8_0;
    (*this).bodyScale.z = 1.0f32;
    (*this).bodyScale.y = (*this).bodyScale.z;
    (*this).bodyScale.x = (*this).bodyScale.y;
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 48.0f32);
    Actor_SetScale(&mut (*this).actor, 0.01875f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gDodongoSkel,
                   &mut gDodongoWaitAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 31 as libc::c_int);
    ...
    Collider_InitQuad(globalCtx, &mut (*this).colliderAT);
    Collider_InitTris(globalCtx, &mut (*this).colliderHard);
    Collider_InitJntSph(globalCtx, &mut (*this).colliderBody);
    Collider_SetQuad(globalCtx, &mut (*this).colliderAT, &mut (*this).actor,
                     &mut sAttackQuadInit);
    Collider_SetTris(globalCtx, &mut (*this).colliderHard, &mut (*this).actor,
                     &mut sHardTrisInit, (*this).trisElements.as_mut_ptr());
    Collider_SetJntSph(globalCtx, &mut (*this).colliderBody,
                       &mut (*this).actor, &mut sBodyJntSphInit,
                       (*this).sphElements.as_mut_ptr());
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32, 60.0f32,
                            70.0f32, 0x1d as libc::c_int);
    EnDodongo_SetupIdle(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDodongo = thisx as *mut EnDodongo;
    Effect_Delete(globalCtx, (*this).blureIdx);
    Collider_DestroyTris(globalCtx, &mut (*this).colliderHard);
    Collider_DestroyJntSph(globalCtx, &mut (*this).colliderBody);
    Collider_DestroyQuad(globalCtx, &mut (*this).colliderAT);
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupIdle(mut this: *mut EnDodongo) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gDodongoWaitAnim,
                          -4.0f32);
    (*this).actor.speedXZ = 0.0f32;
    (*this).timer =
        Rand_S16Offset(30 as libc::c_int as s16, 50 as libc::c_int as s16);
    (*this).actionState = DODONGO_IDLE as libc::c_int;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_Idle as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupWalk(mut this: *mut EnDodongo) {
    let mut frames: f32_0 =
        Animation_GetLastFrame(&mut gDodongoWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gDodongoWalkAnim, 0.0f32,
                     0.0f32, frames, ANIMMODE_LOOP as libc::c_int as u8_0,
                     -4.0f32);
    (*this).actor.speedXZ = 1.5f32;
    (*this).timer =
        Rand_S16Offset(50 as libc::c_int as s16, 70 as libc::c_int as s16);
    (*this).rightFootStep = 1 as libc::c_int as s16;
    (*this).actionState = DODONGO_WALK as libc::c_int;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_Walk as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupBreatheFire(mut this:
                                                        *mut EnDodongo) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gDodongoBreatheFireAnim, -4.0f32);
    (*this).actionState = DODONGO_BREATHE_FIRE as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_BreatheFire as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupEndBreatheFire(mut this:
                                                           *mut EnDodongo) {
    Animation_PlayOnce(&mut (*this).skelAnime,
                       &mut gDodongoAfterBreatheFireAnim);
    (*this).actionState = DODONGO_END_BREATHE_FIRE as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_EndBreatheFire as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupSwallowBomb(mut this:
                                                        *mut EnDodongo) {
    Animation_Change(&mut (*this).skelAnime, &mut gDodongoBreatheFireAnim,
                     -1.0f32, 35.0f32, 0.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    (*this).actionState = DODONGO_SWALLOW_BOMB as libc::c_int;
    (*this).timer = 25 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_SwallowBomb as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupStunned(mut this: *mut EnDodongo) {
    Animation_Change(&mut (*this).skelAnime, &mut gDodongoBreatheFireAnim,
                     0.0f32, 25.0f32, 0.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    (*this).actionState = DODONGO_STUNNED as libc::c_int;
    (*this).actor.speedXZ = 0.0f32;
    if (*this).damageEffect as libc::c_int == 0xf as libc::c_int {
        (*this).iceTimer = 36 as libc::c_int as s16
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x389e as libc::c_int as u16_0);
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_Stunned as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Idle(mut this: *mut EnDodongo,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (if (*this).timer as libc::c_int == 0 as libc::c_int {
            0 as libc::c_int
        } else { (*this).timer -= 1; (*this).timer as libc::c_int }) ==
           0 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_EndBreatheFire(mut this: *mut EnDodongo,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnDodongo_SetupIdle(this);
        (*this).timer =
            Rand_S16Offset(10 as libc::c_int as s16, 20 as libc::c_int as s16)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_BreatheFire(mut this: *mut EnDodongo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut velocity: Vec3f =
    ...
    let mut pad2: s16 = 0;
    let mut fireFrame: s16 = 0;
    if (*this).skelAnime.curFrame as s32 == 24 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3801 as libc::c_int as u16_0);
    }
    if 29.0f32 <= (*this).skelAnime.curFrame &&
           (*this).skelAnime.curFrame <= 43.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x3802 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        fireFrame = ((*this).skelAnime.curFrame - 29.0f32) as s16;
        pos = (*this).actor.world.pos;
        pos.y += 35.0f32;
        EnDodongo_ShiftVecRadial((*this).actor.world.rot.y, 30.0f32,
                                 &mut pos);
        EnDodongo_ShiftVecRadial((*this).actor.world.rot.y, 2.5f32,
                                 &mut accel);
        EffectSsDFire_SpawnFixedScale(globalCtx, &mut pos, &mut velocity,
                                      &mut accel,
                                      (255 as libc::c_int -
                                           fireFrame as libc::c_int *
                                               10 as libc::c_int) as s16,
                                      (fireFrame as libc::c_int +
                                           3 as libc::c_int) as s16);
    } else if 2.0f32 <= (*this).skelAnime.curFrame &&
                  (*this).skelAnime.curFrame <= 20.0f32 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              (0x3858 as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SwallowBomb(mut this: *mut EnDodongo,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut smokeVel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut smokeAccel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.6f32, z: 0.0f32,}; init };
    let mut white: Color_RGBA8 =
        {
            let mut init =
    ...
    let mut deathFireVel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut deathFireAccel: Vec3f =
    ...
    if !(*this).actor.child.is_null() {
        ...
        let ref mut fresh0 = (*((*this).actor.child as *mut EnBom)).timer;
        *fresh0 += 1
    } else if !(*this).actor.parent.is_null() {
        (*(*this).actor.parent).world.pos = (*this).mouthPos;
        let ref mut fresh1 = (*((*this).actor.parent as *mut EnBombf)).timer;
        *fresh1 += 1
    ...
    } // also TOUCH_ON | TOUCH_SFX_WOOD
    if (*this).skelAnime.curFrame as s32 == 28 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x385b as libc::c_int as
                                  u16_0); // Possibly 3 more Vec3fs?
        if !(*this).actor.child.is_null() {
            Actor_Kill((*this).actor.child); // These indices are needed to match.
            (*this).actor.child = 0 as *mut Actor
        } else if !(*this).actor.parent.is_null() {
            Actor_Kill((*this).actor.parent); // Might be a way to quickly test vertex arrangements
        ...
        if (*this).timer as libc::c_int != 0 as libc::c_int {
            (*this).skelAnime.curFrame += 1.;
            if (*this).timer as libc::c_int == 10 as libc::c_int {
                i = 10 as libc::c_int as s16;
                while i as libc::c_int >= 0 as libc::c_int {
                    deathFireVel.x = Rand_CenteredFloat(10.0f32);
                    deathFireVel.y = Rand_CenteredFloat(10.0f32);
                    deathFireVel.z = Rand_CenteredFloat(10.0f32);
                    deathFireAccel.x = deathFireVel.x * -0.1f32;
                    deathFireAccel.y = deathFireVel.y * -0.1f32;
                    deathFireAccel.z = deathFireVel.z * -0.1f32;
                    pos.x =
                        (*this).sphElements[0 as libc::c_int as
                                                usize].dim.worldSphere.center.x
                            as libc::c_int as libc::c_float + deathFireVel.x;
                    pos.y =
                        (*this).sphElements[0 as libc::c_int as
                                                usize].dim.worldSphere.center.y
                            as libc::c_int as libc::c_float + deathFireVel.y;
                    pos.z =
                        (*this).sphElements[0 as libc::c_int as
                                                usize].dim.worldSphere.center.z
                            as libc::c_int as libc::c_float + deathFireVel.z;
                    func_8002836C(globalCtx, &mut pos, &mut deathFireVel,
                                  &mut deathFireAccel,
                                  &mut (*this).bombSmokePrimColor,
                                  &mut (*this).bombSmokeEnvColor,
    ...
    if ((*this).skelAnime.curFrame as s32) < 28 as libc::c_int {
        if ((*this).skelAnime.curFrame as s32) < 26 as libc::c_int &&
               (*this).timer as libc::c_int <= 10 as libc::c_int {
            EnDodongo_SpawnBombSmoke(this, globalCtx);
        } else {
            pos = (*this).headPos;
            func_8002829C(globalCtx, &mut pos, &mut smokeVel, &mut smokeAccel,
                          &mut white, &mut white, 50 as libc::c_int as s16,
                          5 as libc::c_int as s16);
            pos.x -= Math_CosS((*this).actor.shape.rot.y) * 6.0f32;
            pos.z += Math_SinS((*this).actor.shape.rot.y) * 6.0f32;
            func_8002829C(globalCtx, &mut pos, &mut smokeVel, &mut smokeAccel,
                          &mut white, &mut white, 50 as libc::c_int as s16,
                          5 as libc::c_int as s16);
            pos.x =
                (*this).headPos.x +
                    Math_CosS((*this).actor.shape.rot.y) * 6.0f32;
            pos.z =
                (*this).headPos.z -
                    Math_SinS((*this).actor.shape.rot.y) * 6.0f32;
            func_8002829C(globalCtx, &mut pos, &mut smokeVel, &mut smokeAccel,
                          &mut white, &mut white, 50 as libc::c_int as s16,
                          5 as libc::c_int as s16);
        }
    ...
    (*this).bodyScale.z =
        Math_SinS(((*this).actor.colorFilterTimer as libc::c_int *
                       0x1000 as libc::c_int) as s16) * 0.5f32 + 1.0f32;
    (*this).bodyScale.y = (*this).bodyScale.z;
    (*this).bodyScale.x =
        Math_SinS(((*this).actor.colorFilterTimer as libc::c_int *
                       0x1000 as libc::c_int) as s16) + 1.0f32;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).timer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Walk(mut this: *mut EnDodongo,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 1.5f32, 0.1f32, 1.0f32,
                       0.0f32);
    playbackSpeed = (*this).actor.speedXZ * 0.75f32;
    if (*this).actor.speedXZ >= 0.0f32 {
        if playbackSpeed > 3.0f32 / 2 as libc::c_int as libc::c_float {
            playbackSpeed = 3.0f32 / 2 as libc::c_int as libc::c_float
        }
    } else if playbackSpeed < -3.0f32 / 2 as libc::c_int as libc::c_float {
        playbackSpeed = -3.0f32 / 2 as libc::c_int as libc::c_float
    }
    (*this).skelAnime.playSpeed = playbackSpeed;
    SkelAnime_Update(&mut (*this).skelAnime);
    if ((*this).skelAnime.curFrame as s32) < 21 as libc::c_int {
        if (*this).rightFootStep == 0 {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3800 as libc::c_int as u16_0);
            Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                     &mut (*this).leftFootPos, 10.0f32,
                                     3 as libc::c_int, 2.0f32,
                                     0xc8 as libc::c_int as s16,
                                     0xf as libc::c_int as s16,
                                     0 as libc::c_int as u8_0);
            (*this).rightFootStep = 1 as libc::c_int as s16
        }
    } else if (*this).rightFootStep != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3800 as libc::c_int as u16_0);
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).rightFootPos, 10.0f32,
                                 3 as libc::c_int, 2.0f32,
                                 0xc8 as libc::c_int as s16,
                                 0xf as libc::c_int as s16,
                                 0 as libc::c_int as u8_0);
        (*this).rightFootStep = 0 as libc::c_int as s16
    }
    if Math_Vec3f_DistXZ(&mut (*this).actor.home.pos,
                         &mut (*player).actor.world.pos) < 400.0f32 {
        ...
        if (*this).actor.xzDistToPlayer < 100.0f32 &&
               (yawDiff as libc::c_int) < 0x1388 as libc::c_int &&
               (*this).actor.yDistToPlayer < 60.0f32 {
        ...
        if Math_Vec3f_DistXZ(&mut (*this).actor.world.pos,
                             &mut (*this).actor.home.pos) > 150.0f32 ||
               (*this).retreatTimer as libc::c_int != 0 as libc::c_int {
            let mut yawToHome: s16 =
                Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                               &mut (*this).actor.home.pos);
            Math_SmoothStepToS(&mut (*this).actor.world.rot.y, yawToHome,
                               1 as libc::c_int as s16,
                               0x1f4 as libc::c_int as s16,
                               0 as libc::c_int as s16);
        }
        if (*this).retreatTimer as libc::c_int != 0 as libc::c_int {
            (*this).retreatTimer -= 1
        }
        (*this).timer -= 1;
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            ...
            } else { EnDodongo_SetupIdle(this); }
        }
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupSweepTail(mut this: *mut EnDodongo) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gDodongoDamageAnim,
                              -4.0f32);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3803 as libc::c_int as u16_0);
    (*this).actionState = DODONGO_SWEEP_TAIL as libc::c_int;
    (*this).timer = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_SweepTail as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SweepTail(mut this: *mut EnDodongo,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut yawDiff1: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).timer as libc::c_int != 0 as libc::c_int ||
               (if yawDiff1 as libc::c_int >= 0 as libc::c_int {
                    yawDiff1 as libc::c_int
                } else { -(yawDiff1 as libc::c_int) }) < 0x4000 as libc::c_int
           {
            (*this).sphElements[2 as libc::c_int as usize].info.toucherFlags =
                0 as libc::c_int as u8_0;
            (*this).sphElements[1 as libc::c_int as usize].info.toucherFlags =
                0 as libc::c_int as u8_0;
            (*this).colliderBody.base.atFlags = 0 as libc::c_int as u8_0;
            (*this).sphElements[2 as libc::c_int as
                                    usize].info.toucher.dmgFlags =
                0 as libc::c_int as u32_0;
            (*this).sphElements[1 as libc::c_int as
                                    usize].info.toucher.dmgFlags =
                0 as libc::c_int as u32_0;
            (*this).sphElements[2 as libc::c_int as usize].info.toucher.damage
                = 0 as libc::c_int as u8_0;
            (*this).sphElements[1 as libc::c_int as usize].info.toucher.damage
                = 0 as libc::c_int as u8_0;
            EnDodongo_SetupBreatheFire(this);
            (*this).timer =
                Rand_S16Offset(5 as libc::c_int as s16,
                               10 as libc::c_int as s16)
        } else {
            let mut yawDiff2: s16 =
                ((*this).actor.yawTowardsPlayer as libc::c_int -
                     (*this).actor.shape.rot.y as libc::c_int) as s16;
            ...
            (*this).tailSwipeSpeed =
                ((0xffff as libc::c_int -
                      (if yawDiff2 as libc::c_int >= 0 as libc::c_int {
                           yawDiff2 as libc::c_int
                       } else { -(yawDiff2 as libc::c_int) })) /
                     0xf as libc::c_int) as s16;
            if ((*this).actor.yawTowardsPlayer as libc::c_int -
                    (*this).actor.shape.rot.y as libc::c_int) as s16 as
                   libc::c_int >= 0 as libc::c_int {
                (*this).tailSwipeSpeed =
                    -((*this).tailSwipeSpeed as libc::c_int) as s16;
                animation = &mut gDodongoSweepTailLeftAnim
            } else { animation = &mut gDodongoSweepTailRightAnim }
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x3859 as libc::c_int as u16_0);
            Animation_PlayOnceSetSpeed(&mut (*this).skelAnime, animation,
                                       2.0f32);
            (*this).timer = 18 as libc::c_int as s16;
            (*this).sphElements[2 as libc::c_int as usize].info.toucherFlags =
                ((1 as libc::c_int) << 0 as libc::c_int |
                     (1 as libc::c_int) << 4 as libc::c_int) as u8_0;
            (*this).sphElements[1 as libc::c_int as usize].info.toucherFlags =
                (*this).sphElements[2 as libc::c_int as
                                        usize].info.toucherFlags;
            ...
            (*this).sphElements[1 as libc::c_int as usize].info.toucher.damage
                =
                (*this).sphElements[2 as libc::c_int as
                                        usize].info.toucher.damage
        }
    } else if (*this).timer as libc::c_int > 1 as libc::c_int {
        let mut tailPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        (*this).timer -= 1;
        ...
        tailPos.x =
            (*this).sphElements[1 as libc::c_int as
                                    usize].dim.worldSphere.center.x as f32_0;
        tailPos.y =
            (*this).sphElements[1 as libc::c_int as
                                    usize].dim.worldSphere.center.y as f32_0;
        tailPos.z =
            (*this).sphElements[1 as libc::c_int as
                                    usize].dim.worldSphere.center.z as f32_0;
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor, &mut tailPos,
                                 5.0f32, 2 as libc::c_int, 2.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_SetupDeath(mut this: *mut EnDodongo,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gDodongoDieAnim,
                              -8.0f32);
    (*this).timer = 0 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3804 as libc::c_int as u16_0);
    (*this).actionState = DODONGO_DEATH as libc::c_int;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    EnDodongo_SetupAction(this,
                          Some(EnDodongo_Death as
                                   unsafe extern "C" fn(_: *mut EnDodongo,
                                                        _: *mut GlobalContext)
                                       -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Death(mut this: *mut EnDodongo,
                                         mut globalCtx: *mut GlobalContext) {
    let mut bomb: *mut EnBom = 0 as *mut EnBom;
    if (*this).skelAnime.curFrame < 35.0f32 {
        if (*this).actor.params as libc::c_int ==
               EN_DODONGO_SMOKE_DEATH as libc::c_int {
            EnDodongo_SpawnBombSmoke(this, globalCtx);
        }
        ...
        if (*this).timer as libc::c_int == 0 as libc::c_int {
            bomb =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ...
                            BOMB_BODY as libc::c_int as s16) as *mut EnBom;
            if !bomb.is_null() {
                (*bomb).timer = 0 as libc::c_int as s16;
                (*this).timer = 8 as libc::c_int as s16
            }
        }
    } else if (*this).skelAnime.curFrame as s32 == 52 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Stunned(mut this: *mut EnDodongo,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_CollisionCheck(mut this: *mut EnDodongo,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).colliderHard.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 7 as libc::c_int != 0 {
        (*this).colliderHard.base.acFlags =
            ((*this).colliderHard.base.acFlags as libc::c_int &
    ...
    } else if (*this).colliderBody.base.acFlags as libc::c_int &
                  (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                  (*this).actionState > DODONGO_DEATH as libc::c_int {
        (*this).colliderBody.base.acFlags =
            ((*this).colliderBody.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        Actor_SetDropFlagJntSph(&mut (*this).actor, &mut (*this).colliderBody,
                                0 as libc::c_int);
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   ...
                   (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       0xf as libc::c_int {
                if (*this).actionState != DODONGO_STUNNED as libc::c_int {
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0 as libc::c_int as s16,
                                         0x78 as libc::c_int as s16,
                                         0 as libc::c_int as s16,
                ...
                if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                       0 as libc::c_int {
                    EnDodongo_SetupDeath(this, globalCtx);
                } else { EnDodongo_SetupSweepTail(this); }
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_UpdateQuad(mut this: *mut EnDodongo,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut sp94: Vec3f =
        {
    ...
    let mut sp88: Vec3f =
        {
            let mut init = Vec3f{x: -1000.0f32, y: -200.0f32, z: 1500.0f32,};
            init
        };
    let mut sp7C: Vec3f =
        {
    ...
    let mut sp70: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pad4C: [s32; 9] = [0; 9];
    let mut a: s32 = 0 as libc::c_int;
    let mut b: s32 = 1 as libc::c_int;
    let mut c: s32 = 2 as libc::c_int;
    let mut d: s32 = 3 as libc::c_int;
    let mut xMod: f32_0 =
        Math_SinF(((*this).skelAnime.curFrame - 28.0f32) * 0.08f32) *
            5500.0f32;
    sp7C.x -= xMod;
    sp94.x -= xMod;
    sp88.x -= xMod;
    Matrix_MultVec3f(&mut sp94,
                     &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(b
                                                                               as
                                                                               isize));
    Matrix_MultVec3f(&mut sp88,
                     &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(a
                                                                               as
                                                                               isize));
    Matrix_MultVec3f(&mut sp7C,
                     &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(d
                                                                               as
                                                                               isize));
    Matrix_MultVec3f(&mut sp70,
                     &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(c
                                                                               as
                                                                               isize));
    Collider_SetQuadVertices(&mut (*this).colliderAT,
                             &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(a
                                                                                       as
                                                                                       isize),
                             &mut *(*this).colliderAT.dim.quad.as_mut_ptr().offset(b
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnDodongo = thisx as *mut EnDodongo;
    ...
    if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 75.0f32,
                                60.0f32, 70.0f32, 0x1d as libc::c_int);
    ...
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderBody.base);
    if (*this).actionState != DODONGO_DEATH as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderHard.base);
    }
    if (*this).actionState > DODONGO_DEATH as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).colliderBody.base);
    }
    if (*this).actionState >= DODONGO_IDLE as libc::c_int &&
           EnDodongo_AteBomb(this, globalCtx) != 0 {
        EnDodongo_SetupSwallowBomb(this);
    }
    if (*this).actionState == DODONGO_BREATHE_FIRE as libc::c_int {
        if 29.0f32 < (*this).skelAnime.curFrame &&
               (*this).skelAnime.curFrame < 43.0f32 {
            CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                                 &mut (*this).colliderAT.base);
        }
    }
    (*this).actor.focus.pos.x =
        (*this).actor.world.pos.x +
            Math_SinS((*this).actor.shape.rot.y) * -30.0f32;
    (*this).actor.focus.pos.y = (*this).actor.world.pos.y + 20.0f32;
    (*this).actor.focus.pos.z =
        (*this).actor.world.pos.z +
            Math_CosS((*this).actor.shape.rot.y) * -30.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_OverrideLimbDraw(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnDodongo = thisx as *mut EnDodongo;
    if limbIndex == 15 as libc::c_int || limbIndex == 16 as libc::c_int {
        Matrix_Scale((*this).bodyScale.x, (*this).bodyScale.y,
                     (*this).bodyScale.z,
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_PostLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
                                                mut dList: *mut *mut Gfx,
                                                mut rot: *mut Vec3s,
                                                mut thisx:
                                                    *mut libc::c_void) {
    static mut legOffsets: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: 1100.0f32, y: -700.0f32, z: 0.0f32,};
             init
         }, { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init },
         { let mut init = Vec3f{x: 2190.0f32, y: 0.0f32, z: 0.0f32,}; init }];
    let mut tailTipOffset: Vec3f =
        { let mut init = Vec3f{x: 3000.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut baseOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut i: s32 = 0;
    let mut hardTris0Vtx: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut hardTris1Vtx: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut hardTris2Vtx: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut tailTip: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut tailBase: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut this: *mut EnDodongo = thisx as *mut EnDodongo;
    let mut hardTris0VtxOffset: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -300.0f32, y: -2500.0f32, z: 0.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -300.0f32, y: 1200.0f32, z: -2700.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 3000.0f32, y: 1200.0f32, z: 0.0f32,};
             init
         }];
    let mut hardTris1VtxOffset: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -300.0f32, y: -2500.0f32, z: 0.0f32,};
             init
         },
    ...
    let mut hardTris2VtxOffset: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -600.0f32, y: 1200.0f32, z: -2800.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -600.0f32, y: 1200.0f32, z: 2800.0f32,};
    ...
    let mut mouthOffset: Vec3f =
        {
            let mut init = Vec3f{x: 1800.0f32, y: 1200.0f32, z: 0.0f32,};
            init
        };
    let mut headOffset: Vec3f =
        { let mut init = Vec3f{x: 1500.0f32, y: 300.0f32, z: 0.0f32,}; init };
    Collider_UpdateSpheres(limbIndex, &mut (*this).colliderBody);
    match limbIndex {
        2 => {
            if (*this).actionState == DODONGO_BREATHE_FIRE as libc::c_int &&
                   29.0f32 < (*this).skelAnime.curFrame &&
                   (*this).skelAnime.curFrame < 43.0f32 {
        ...
        7 => {
            ...
            while i < 3 as libc::c_int {
                Matrix_MultVec3f(&mut *hardTris0VtxOffset.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize),
                                 &mut *hardTris0Vtx.as_mut_ptr().offset(i as
                                                                            isize));
                Matrix_MultVec3f(&mut *hardTris1VtxOffset.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize),
                                 &mut *hardTris1Vtx.as_mut_ptr().offset(i as
                                                                            isize));
                Matrix_MultVec3f(&mut *hardTris2VtxOffset.as_mut_ptr().offset(i
                                                                                  as
                                                                                  isize),
                                 &mut *hardTris2Vtx.as_mut_ptr().offset(i as
                                                                            isize));
                i += 1
            }
            Collider_SetTrisVertices(&mut (*this).colliderHard,
                                     0 as libc::c_int,
                                     &mut *hardTris0Vtx.as_mut_ptr().offset(0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris0Vtx.as_mut_ptr().offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris0Vtx.as_mut_ptr().offset(2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
            Collider_SetTrisVertices(&mut (*this).colliderHard,
                                     1 as libc::c_int,
                                     &mut *hardTris1Vtx.as_mut_ptr().offset(0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris1Vtx.as_mut_ptr().offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris1Vtx.as_mut_ptr().offset(2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
            Collider_SetTrisVertices(&mut (*this).colliderHard,
                                     2 as libc::c_int,
                                     &mut *hardTris2Vtx.as_mut_ptr().offset(0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris2Vtx.as_mut_ptr().offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize),
                                     &mut *hardTris2Vtx.as_mut_ptr().offset(2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
            Matrix_MultVec3f(&mut mouthOffset, &mut (*this).mouthPos);
            Matrix_MultVec3f(&mut headOffset, &mut (*this).headPos);
        }
        15 => {
            if (*this).actionState == DODONGO_SWEEP_TAIL as libc::c_int &&
                   (*this).timer as libc::c_int >= 2 as libc::c_int {
                Matrix_MultVec3f(&mut tailTipOffset, &mut tailTip);
                Matrix_MultVec3f(&mut baseOffset, &mut tailBase);
                EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIdx) as
                                          *mut EffectBlure, &mut tailTip,
                                      &mut tailBase);
            } else if (*this).actionState == DODONGO_SWEEP_TAIL as libc::c_int
        ...
        21 => {
            Matrix_MultVec3f(&mut *legOffsets.as_mut_ptr().offset(1 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
                             &mut (*this).leftFootPos);
        }
        28 => {
            Matrix_MultVec3f(&mut *legOffsets.as_mut_ptr().offset(1 as
                                                                      libc::c_int
    ...
    if (*this).iceTimer as libc::c_int != 0 as libc::c_int {
        i = -(1 as libc::c_int);
        match limbIndex {
            7 => { baseOffset.x = 1200.0f32; i = 0 as libc::c_int }
            13 => { i = 1 as libc::c_int }
            14 => { i = 2 as libc::c_int }
            15 => { i = 3 as libc::c_int }
            16 => { i = 4 as libc::c_int }
            22 => { i = 5 as libc::c_int }
            29 => { i = 6 as libc::c_int }
            21 => { i = 7 as libc::c_int }
            28 => { i = 8 as libc::c_int }
            _ => { }
        }
        if i >= 0 as libc::c_int {
            Matrix_MultVec3f(&mut baseOffset,
                             &mut *(*this).icePos.as_mut_ptr().offset(i as
                                                                          isize));
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_Draw(mut thisx: *mut Actor,
    ...
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      ...
                      Some(EnDodongo_OverrideLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    ...
                                                    _: *mut libc::c_void)
                                   -> s32),
                      Some(EnDodongo_PostLimbDraw as
                               unsafe extern "C" fn(_: *mut GlobalContext,
                                                    _: s32, _: *mut *mut Gfx,
                                                    _: *mut Vec3s,
                                                    _: *mut libc::c_void)
    ...
    if (*this).iceTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).iceTimer as libc::c_int % 4 as libc::c_int ==
               0 as libc::c_int {
            index = (*this).iceTimer as libc::c_int >> 2 as libc::c_int;
            EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).actor,
                                           &mut *(*this).icePos.as_mut_ptr().offset(index
                                                                                        as
                                                                                        isize),
                                           ...
                                           255 as libc::c_int as s16, 1.8f32);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_ShiftVecRadial(mut yaw: s16,
                                                  mut radius: f32_0,
                                                  mut vec: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn EnDodongo_AteBomb(mut this: *mut EnDodongo,
                                           mut globalCtx: *mut GlobalContext)
 -> s32 {
    ...
    let mut dz: f32_0 = 0.;
    while !actor.is_null() {
        if (*actor).params as libc::c_int != 0 as libc::c_int ||
               !(*actor).parent.is_null() {
            actor = (*actor).next
        } else {
            dx = (*actor).world.pos.x - (*this).mouthPos.x;
            dy = (*actor).world.pos.y - (*this).mouthPos.y;
            dz = (*actor).world.pos.z - (*this).mouthPos.z;
            if fabsf(dx) < 20.0f32 && fabsf(dy) < 10.0f32 &&
                   fabsf(dz) < 20.0f32 {
                if (*actor).id as libc::c_int == ACTOR_EN_BOM as libc::c_int {
                    (*this).actor.child = actor
                } else { (*this).actor.parent = actor }
                (*actor).parent = &mut (*this).actor;
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0xd as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_value(2800 as libc::c_int);
             init
         }]
}
#[used]
