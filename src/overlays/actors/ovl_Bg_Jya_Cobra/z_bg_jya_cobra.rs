...
extern "C" {
    ...
    #[no_mangle]
    static mut gCobra1DL: [Gfx; 0];
    #[no_mangle]
    static mut gCobra2DL: [Gfx; 0];
    #[no_mangle]
    static mut gCobraCol: CollisionHeader;
    #[no_mangle]
    static mut gCobra3DL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaCobra {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgJyaCobraActionFunc,
    pub unk_168: s16,
    pub unk_16A: s16,
    pub unk_16C: s16,
    pub unk_16E: s16,
    ...
    pub unk_18C: f32_0,
    pub unk_190: f32_0,
    pub shadowTexture: [u8_0; 4112],
}
pub type BgJyaCobraActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgJyaCobra, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgJyaBigmirror {
    pub actor: Actor,
    pub cobraInfo: [BigmirrorCobra; 2],
    pub puzzleFlags: u8_0,
    pub spawned: u8_0,
    pub lightBeams: [*mut Actor; 3],
    pub mirRayObjIndex: s32,
    pub liftHeight: f32_0,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BigmirrorCobra {
    pub cobra: *mut BgJyaCobra,
    pub rotY: s16,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
static mut sShadowDL: [Gfx; 7] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 7];
#[no_mangle]
pub static mut Bg_Jya_Cobra_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_JYA_COBRA as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_JYA_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgJyaCobra>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaCobra_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaCobra_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaCobra_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgJyaCobra_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_8089731C: [[u8_0; 11]; 11] =
    [[0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
     ...
     [0 as libc::c_int as u8_0, 0x20 as libc::c_int as u8_0,
      0x80 as libc::c_int as u8_0, 0xa0 as libc::c_int as u8_0,
      0xa3 as libc::c_int as u8_0, 0xa3 as libc::c_int as u8_0,
      0xa3 as libc::c_int as u8_0, 0xa0 as libc::c_int as u8_0,
      0x80 as libc::c_int as u8_0, 0x20 as libc::c_int as u8_0,
      0 as libc::c_int as u8_0],
     [0x20 as libc::c_int as u8_0, 0x80 as libc::c_int as u8_0,
      0xa0 as libc::c_int as u8_0, 0xa5 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa5 as libc::c_int as u8_0,
      0xa0 as libc::c_int as u8_0, 0x80 as libc::c_int as u8_0,
      0x20 as libc::c_int as u8_0],
     [0x80 as libc::c_int as u8_0, 0xa0 as libc::c_int as u8_0,
      0xa5 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa5 as libc::c_int as u8_0, 0xa0 as libc::c_int as u8_0,
      0x80 as libc::c_int as u8_0],
     [0x80 as libc::c_int as u8_0, 0xa3 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa3 as libc::c_int as u8_0,
      0x80 as libc::c_int as u8_0],
     [0x80 as libc::c_int as u8_0, 0xa3 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
      0xa6 as libc::c_int as u8_0, 0xa6 as libc::c_int as u8_0,
     ...
     [0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
      ...
      0x20 as libc::c_int as u8_0, 0 as libc::c_int as u8_0,
      0 as libc::c_int as u8_0]];
static mut D_80897398: [[u8_0; 3]; 3] =
    [[0x20 as libc::c_int as u8_0, 0x80 as libc::c_int as u8_0,
      0x20 as libc::c_int as u8_0],
     [0x80 as libc::c_int as u8_0, 0xa0 as libc::c_int as u8_0,
      0x80 as libc::c_int as u8_0],
     [0x20 as libc::c_int as u8_0, 0x80 as libc::c_int as u8_0,
      0x20 as libc::c_int as u8_0]];
static mut D_808973A4: [Vec3f; 26] =
    [{ let mut init = Vec3f{x: -6.0f32, y: 100.0f32, z: 7.6f32,}; init },
     {
         let mut init = Vec3f{x: -12.6f32, y: 69.200005f32, z: -10.0f32,};
         init
     }, { let mut init = Vec3f{x: -9.0f32, y: 43.0f32, z: -1.0f32,}; init },
     { let mut init = Vec3f{x: -3.0f32, y: 15.0f32, z: 8.6f32,}; init },
     { let mut init = Vec3f{x: -8.6f32, y: 15.0f32, z: 13.5f32,}; init },
     { let mut init = Vec3f{x: -6.6f32, y: 26.0f32, z: 11.6f32,}; init },
     { let mut init = Vec3f{x: -12.5f32, y: 43.0f32, z: 8.0f32,}; init },
     { let mut init = Vec3f{x: -17.2f32, y: 70.0f32, z: 0.6f32,}; init },
     { let mut init = Vec3f{x: -8.0f32, y: 100.0f32, z: 7.6f32,}; init },
     { let mut init = Vec3f{x: 6.0f32, y: 100.0f32, z: 7.6f32,}; init },
     {
         let mut init = Vec3f{x: 12.6f32, y: 69.200005f32, z: -10.0f32,};
         init
     ...
     { let mut init = Vec3f{x: 17.2f32, y: 70.0f32, z: 0.6f32,}; init },
     { let mut init = Vec3f{x: 8.0f32, y: 100.0f32, z: 7.6f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 70.0f32, z: -11.3f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 44.600002f32, z: -2.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 15.0f32, z: 10.6f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 15.0f32, z: 0.3f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 26.0f32, z: 11.6f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 88.4f32, z: -1.4f32,}; init },
     {
         let mut init = Vec3f{x: 0.0f32, y: 95.700005f32, z: 14.900001f32,};
         init
     }, { let mut init = Vec3f{x: 0.0f32, y: 101.4f32, z: 5.0f32,}; init }];
static mut D_808974DC: [Vec3f; 5] =
    [{ let mut init = Vec3f{x: 12.0f32, y: 21.300001f32, z: -2.5f32,}; init },
     { let mut init = Vec3f{x: 30.0f32, y: 21.300001f32, z: -2.5f32,}; init },
     {
         let mut init = Vec3f{x: -15.0f32, y: 21.300001f32, z: -2.5f32,};
         init
     },
     {
         let mut init = Vec3f{x: -30.0f32, y: 21.300001f32, z: -2.5f32,};
         init
     },
     {
         let mut init = Vec3f{x: 12.0f32, y: 21.300001f32, z: -2.5f32,};
         init
     }];
static mut D_80897518: [s32; 4] =
    [0x80 as libc::c_int, 0xa0 as libc::c_int, 0xa0 as libc::c_int,
     0x80 as libc::c_int];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut D_80897538: Vec3s =
    {
        let mut init =
            Vec3s{x: 0 as libc::c_int as s16,
                  y: -(0x4000 as libc::c_int) as s16,
                  z: 0 as libc::c_int as s16,};
        init
    };
static mut D_80897540: Vec3s =
    {
        let mut init =
            Vec3s{x: 0 as libc::c_int as s16,
                  y: 0x4000 as libc::c_int as s16,
...
static mut D_80897548: [Vec3f; 3] =
    [{ let mut init = Vec3f{x: 0.1f32, y: 0.1f32, z: 0.1f32,}; init },
     { let mut init = Vec3f{x: 0.072f32, y: 0.072f32, z: 0.072f32,}; init },
     { let mut init = Vec3f{x: 0.1f32, y: 0.1f32, z: 0.132f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn func_808958F0(mut dest: *mut Vec3f,
                                       mut src: *mut Vec3f, mut arg2: f32_0,
                                       mut arg3: f32_0) {
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_InitDynapoly(mut this: *mut BgJyaCobra,
                                                 mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut collision:
                                                     *mut CollisionHeader,
    ...
    let mut pad2: s32 = 0;
    DynaPolyActor_Init(&mut (*this).dyna, flags);
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_jya_cobra.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_SpawnRay(mut this: *mut BgJyaCobra,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).dyna.actor,
                       globalCtx, ACTOR_MIR_RAY as libc::c_int as s16,
                       (*this).dyna.actor.world.pos.x,
                       (*this).dyna.actor.world.pos.y + 57.0f32,
                       (*this).dyna.actor.world.pos.z,
                       0 as libc::c_int as s16, 0 as libc::c_int as s16,
                       0 as libc::c_int as s16, 6 as libc::c_int as s16);
    if (*this).dyna.actor.child.is_null() {
        osSyncPrintf(b"\x1b[31m\x00" as *const u8 as *const libc::c_char);
        // "Ｅｒｒｏｒ : Mir Ray occurrence failure"
        osSyncPrintf(b"\xef\xbc\xa5\xef\xbd\x92\xef\xbd\x92\xef\xbd\x8f\xef\xbd\x92 : Mir Ray \xe7\x99\xba\xe7\x94\x9f\xe5\xa4\xb1\xe6\x95\x97 (%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_jya_cobra.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80895A70(mut this: *mut BgJyaCobra) {
    let mut pad: s32 = 0;
    let mut mirror: *mut BgJyaBigmirror =
        (*this).dyna.actor.parent as *mut BgJyaBigmirror;
    let mut mirRay: *mut MirRay = 0 as *mut MirRay;
    match (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int {
        0 => {
            mirRay = (*this).dyna.actor.child as *mut MirRay;
            if mirRay.is_null() { return }
            if (*(*this).dyna.actor.child).update.is_none() {
                (*this).dyna.actor.child = 0 as *mut Actor;
                return
            }
        }
        1 => {
            mirRay =
                (*mirror).lightBeams[1 as libc::c_int as usize] as
                    *mut MirRay;
            if mirRay.is_null() { return }
        }
        2 => {
            mirRay =
                (*mirror).lightBeams[2 as libc::c_int as usize] as
                    *mut MirRay;
            if mirRay.is_null() { return }
        }
        _ => { }
    }
    if (*this).unk_18C <= 0.0f32 {
        (*mirRay).unLit = 1 as libc::c_int as u8_0
    } else {
        let mut sp28: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        (*mirRay).unLit = 0 as libc::c_int as u8_0;
        Math_Vec3f_Copy(&mut (*mirRay).sourcePt, &mut (*this).unk_180);
        ...
        Matrix_RotateX(D_80897308[((*this).dyna.actor.params as libc::c_int &
        ...
        sp28.x = 0.0f32;
        sp28.y = 0.0f64 as f32_0;
        sp28.z = (*this).unk_190 * 2800.0f32;
        Matrix_MultVec3f(&mut sp28, &mut (*mirRay).poolPt);
        Math_Vec3f_Sum(&mut (*mirRay).sourcePt, &mut (*mirRay).poolPt,
                       &mut (*mirRay).poolPt);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80895BEC(mut this: *mut BgJyaCobra,
    ...
    func_808958F0(&mut sp2C, &mut (*this).unk_174, Math_SinS((*this).unk_170),
                  Math_CosS((*this).unk_170));
...
#[no_mangle]
pub unsafe extern "C" fn func_80895C74(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    let mut phi_v0: s16 = 0;
    let mut params: s16 = (*this).dyna.actor.params;
    let mut mirror: *mut BgJyaBigmirror =
        (*this).dyna.actor.parent as *mut BgJyaBigmirror;
    let mut phi_f0: f32_0 = 0.;
    if params as libc::c_int & 3 as libc::c_int == 2 as libc::c_int &&
           !mirror.is_null() &&
           ((*mirror).puzzleFlags as libc::c_int &
                (1 as libc::c_int) << 2 as libc::c_int == 0 ||
                (*mirror).puzzleFlags as libc::c_int &
                    (1 as libc::c_int) << 0 as libc::c_int == 0) {
        Math_StepToF(&mut (*this).unk_18C, 0.0f32, 0.05f32);
    } else {
        (*this).unk_18C = 1.0f32;
        if D_80897310[(params as libc::c_int & 3 as libc::c_int) as usize] !=
               0 {
            phi_v0 =
                ((*this).dyna.actor.shape.rot.y as libc::c_int -
                     D_80897314[(params as libc::c_int & 3 as libc::c_int) as
                                    usize] as libc::c_int) as s16;
            phi_v0 =
                if phi_v0 as libc::c_int >= 0 as libc::c_int {
                    phi_v0 as libc::c_int
                } else { -(phi_v0 as libc::c_int) } as s16;
            if (phi_v0 as libc::c_int) < 0x2000 as libc::c_int &&
                   phi_v0 as libc::c_int != -(0x8000 as libc::c_int) {
                (*this).unk_18C +=
                    (phi_v0 as libc::c_int - 0x2000 as libc::c_int) as
                        libc::c_float *
                        (3.0f32 / 0x4000 as libc::c_int as libc::c_float);
                if (*this).unk_18C < 0.0f32 { (*this).unk_18C = 0.0f32 }
            }
        }
    }
    (*this).unk_180.x = (*this).dyna.actor.world.pos.x;
    (*this).unk_180.y = (*this).dyna.actor.world.pos.y + 57.0f32;
    (*this).unk_180.z = (*this).dyna.actor.world.pos.z;
    if params as libc::c_int & 3 as libc::c_int == 0 as libc::c_int {
        (*this).unk_190 = 0.1f32
    } else if params as libc::c_int & 3 as libc::c_int == 1 as libc::c_int {
        phi_f0 = 0.1f32;
        phi_v0 =
            ((*this).dyna.actor.shape.rot.y as libc::c_int -
                 0x8000 as libc::c_int) as s16;
        if (phi_v0 as libc::c_int) < 0x500 as libc::c_int &&
               phi_v0 as libc::c_int > -(0x500 as libc::c_int) {
            phi_f0 = 0.34f32
        } else {
            phi_v0 =
                ((*this).dyna.actor.shape.rot.y as libc::c_int -
        ...
        Math_StepToF(&mut (*this).unk_190, phi_f0, 0.04f32);
    } else if params as libc::c_int & 3 as libc::c_int == 2 as libc::c_int {
        phi_f0 = 0.1f32;
        phi_v0 =
            ((*this).dyna.actor.shape.rot.y as libc::c_int -
                 0x8000 as libc::c_int) as s16;
        if (phi_v0 as libc::c_int) < 0x500 as libc::c_int &&
            ...
            phi_v0 =
                ((*this).dyna.actor.shape.rot.y as
                     libc::c_uint).wrapping_add(0xffff4000 as libc::c_uint) as
                    s16;
            if (phi_v0 as libc::c_int) < 0x500 as libc::c_int &&
                   phi_v0 as libc::c_int > -(0x500 as libc::c_int) {
                phi_f0 = 0.34f32
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_UpdateShadowFromSide(mut this:
                                                             *mut BgJyaCobra) {
    let mut spD4: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spC8: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spBC: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut temp_s2: *mut u8_0 = 0 as *mut u8_0;
    let mut temp_x: s32 = 0;
    let mut temp_z: s32 = 0;
    let mut x: s32 = 0;
    let mut z: s32 = 0;
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    ...
    let mut rotY: s16 = 0;
    temp_s2 =
        (&mut (*this).shadowTexture as *mut [u8_0; 4112] as s32 +
             0xf as libc::c_int & !(0xf as libc::c_int)) as *mut u8_0;
    Lib_MemSet(temp_s2, 0x1000 as libc::c_int as size_t,
               0 as libc::c_int as u8_0);
    Matrix_RotateX(3.14159265358979323846f32 /
                       4 as libc::c_int as libc::c_float,
                   MTXMODE_NEW as libc::c_int as u8_0);
    rotY =
        if (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int == 0 {
            ((*this).dyna.actor.shape.rot.y as libc::c_int) +
    ...
    Matrix_RotateY(rotY as libc::c_int as libc::c_float *
                       (3.14159265358979323846f32 /
                            0x8000 as libc::c_int as libc::c_float),
                   MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Scale(0.9f32, 0.9f32, 0.9f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    i = 0 as libc::c_int;
    while i < 25 as libc::c_int {
        Math_Vec3f_Diff(&mut *D_808973A4.as_mut_ptr().offset((i +
                                                                  1 as
                                                                      libc::c_int)
                                                                 as isize),
                        &mut *D_808973A4.as_mut_ptr().offset(i as isize),
                        &mut spD4);
        spD4.x *= 1 as libc::c_int as libc::c_float / 2.0f32;
        spD4.y *= 1 as libc::c_int as libc::c_float / 2.0f32;
        spD4.z *= 1 as libc::c_int as libc::c_float / 2.0f32;
        j = 0 as libc::c_int;
        while j < 2 as libc::c_int {
            spC8.x = D_808973A4[i as usize].x + spD4.x * j as libc::c_float;
            spC8.y = D_808973A4[i as usize].y + spD4.y * j as libc::c_float;
            spC8.z = D_808973A4[i as usize].z + spD4.z * j as libc::c_float;
            Matrix_MultVec3f(&mut spC8, &mut spBC);
            x = ((spBC.x + 50.0f32) * 0.64f32 + 0.5f32) as s32;
            z = ((88.0f32 - spBC.z) * 0.64f32 + 0.5f32) as s32;
            k = 0 as libc::c_int;
            while k < 11 as libc::c_int {
                temp_z = z - 5 as libc::c_int + k;
                if temp_z & !(0x3f as libc::c_int) == 0 {
                    temp_z *= 0x40 as libc::c_int;
                    l = 0 as libc::c_int;
                    while l < 11 as libc::c_int {
                        temp_x = x - 5 as libc::c_int + l;
                        if temp_x & !(0x3f as libc::c_int) == 0 {
                            let ref mut fresh0 =
                                *temp_s2.offset((temp_z + temp_x) as isize);
                            *fresh0 =
                                (*fresh0 as libc::c_int |
                                     D_8089731C[k as usize][l as usize] as
                                         libc::c_int) as u8_0
                        }
                        l += 1
                    }
    ...
    while i < 4 as libc::c_int {
        Math_Vec3f_Diff(&mut *D_808974DC.as_mut_ptr().offset((i +
                                                                  1 as
                                                                      libc::c_int)
                                                                 as isize),
                        &mut *D_808974DC.as_mut_ptr().offset(i as isize),
                        &mut spD4);
        spD4.x *= 1 as libc::c_int as libc::c_float / 5.0f32;
        spD4.y *= 1 as libc::c_int as libc::c_float / 5.0f32;
        spD4.z *= 1 as libc::c_int as libc::c_float / 5.0f32;
        j = 0 as libc::c_int;
        while j < 5 as libc::c_int {
            spC8.x = D_808974DC[i as usize].x + spD4.x * j as libc::c_float;
            spC8.y = D_808974DC[i as usize].y + spD4.y * j as libc::c_float;
            spC8.z = D_808974DC[i as usize].z + spD4.z * j as libc::c_float;
            Matrix_MultVec3f(&mut spC8, &mut spBC);
            x = ((spBC.x + 50.0f32) * 0.64f32 + 0.5f32) as s32;
            z = ((88.0f32 - spBC.z) * 0.64f32 + 0.5f32) as s32;
            k = 0 as libc::c_int;
            while k < 3 as libc::c_int {
                temp_z = z - 1 as libc::c_int + k;
                if temp_z & !(0x3f as libc::c_int) == 0 {
                    temp_z *= 0x40 as libc::c_int;
                    l = 0 as libc::c_int;
                    while l < 3 as libc::c_int {
                        temp_x = x - 1 as libc::c_int + l;
                        if temp_x & !(0x3f as libc::c_int) == 0 {
                            let ref mut fresh1 =
                                *temp_s2.offset((temp_z + temp_x) as isize);
                            *fresh1 =
                                (*fresh1 as libc::c_int |
                                     D_80897398[k as usize][l as usize] as
                                         libc::c_int) as u8_0
                        }
                        l += 1
                    }
    ...
    while i < 0x40 as libc::c_int {
        *temp_s2.offset((0 as libc::c_int * 0x40 as libc::c_int + i) as isize)
            = 0 as libc::c_int as u8_0;
        *temp_s2.offset((0x3f as libc::c_int * 0x40 as libc::c_int + i) as
                            isize) = 0 as libc::c_int as u8_0;
        i += 1
    }
    j = 1 as libc::c_int;
    while j < 0x3f as libc::c_int {
        *temp_s2.offset((j * 0x40 as libc::c_int + 0 as libc::c_int) as isize)
            = 0 as libc::c_int as u8_0;
        *temp_s2.offset((j * 0x40 as libc::c_int + 0x3f as libc::c_int) as
                            isize) = 0 as libc::c_int as u8_0;
        j += 1
    }
    (D_80897398[0 as libc::c_int as usize][0 as libc::c_int as usize]) != 0;
}
/*
 * Updates the shadow with light coming from above the mirror
 */
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_UpdateShadowFromTop(mut this:
                                                            *mut BgJyaCobra) {
    let mut sp58: [f32_0; 64] = [0.; 64];
    let mut i: s32 = 0;
    let mut j: s32 = 0;
    let mut i_copy: s32 = 0;
    let mut counter: s32 = 0;
    let mut temp_s0: *mut u8_0 = 0 as *mut u8_0;
    let mut sp40: *mut u8_0 = 0 as *mut u8_0;
    i = 0 as libc::c_int;
    while i < 0x40 as libc::c_int {
        sp58[i as usize] =
            (i as libc::c_float - 31.5f32) * (i as libc::c_float - 31.5f32);
        i += 1
    }
    temp_s0 =
        ((&mut (*this).shadowTexture as *mut [u8_0; 4112] as
              u32_0).wrapping_add(0xf as libc::c_int as libc::c_uint) &
             !(0xf as libc::c_int) as libc::c_uint) as *mut u8_0;
    sp40 = temp_s0;
    Lib_MemSet(temp_s0, 0x1000 as libc::c_int as size_t,
               0 as libc::c_int as u8_0);
    i = 0 as libc::c_int;
    while i != 0x40 as libc::c_int {
        let mut temp_f12: f32_0 = sp58[i as usize];
        j = 0 as libc::c_int;
        while j < 0x40 as libc::c_int {
            let mut temp_f2: f32_0 = sp58[j as usize] * 0.5f32 + temp_f12;
            if temp_f2 < 300.0f32 {
                *sp40 =
                    (*sp40 as libc::c_int |
                         if 640 as libc::c_int - (temp_f2 * 2.0f32) as s32 >
                                166 as libc::c_int {
                             166 as libc::c_int
                         } else {
                             (640 as libc::c_int) - (temp_f2 * 2.0f32) as s32
                         }) as u8_0
            }
            j += 1;
            sp40 = sp40.offset(1)
    ...
    i_copy = 0x780 as libc::c_int;
    counter = 0 as libc::c_int;
    while counter < 4 as libc::c_int {
        i = i_copy;
        j = 4 as libc::c_int;
        while j < 0x3c as libc::c_int {
            if (*temp_s0.offset((i_copy + j) as isize) as libc::c_int) <
                   D_80897518[counter as usize] {
                *temp_s0.offset((i_copy + j) as isize) =
                    D_80897518[counter as usize] as u8_0
            }
            j += 1
        }
        *temp_s0.offset((i + 0x3c as libc::c_int) as isize) =
            0x20 as libc::c_int as u8_0;
        *temp_s0.offset((i + 0x3 as libc::c_int) as isize) =
            0x20 as libc::c_int as u8_0;
        counter += 1;
        i_copy += 0x40 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJyaCobra = thisx as *mut BgJyaCobra;
    BgJyaCobra_InitDynapoly(this, globalCtx, &mut gCobraCol,
                            DPM_UNK as libc::c_int);
    Actor_ProcessInitChain(&mut (*this).dyna.actor, sInitChain.as_mut_ptr());
    if (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int == 0 &&
           Flags_GetSwitch(globalCtx,
                           (*this).dyna.actor.params as s32 >>
    ...
    if (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int ==
           1 as libc::c_int ||
           (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int ==
               2 as libc::c_int {
        (*this).dyna.actor.room = -(1 as libc::c_int) as s8
    }
    if (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int ==
           1 as libc::c_int {
    ...
    // "(jya cobra)"
    osSyncPrintf(b"(jya \xe3\x82\xb3\xe3\x83\x96\xe3\x83\xa9)(arg_data 0x%04x)(act %x)(txt %x)(txt16 %x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int, this,
                 &mut (*this).shadowTexture as *mut [u8_0; 4112],
                 &mut (*this).shadowTexture as *mut [u8_0; 4112] as s32 +
                     0xf as libc::c_int &
                     !(0xf as libc::c_int)); // params == 1
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut BgJyaCobra = thisx as *mut BgJyaCobra;
...
#[no_mangle]
pub unsafe extern "C" fn func_80896918(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actionFunc =
        Some(func_80896950 as
                 unsafe extern "C" fn(_: *mut BgJyaCobra,
                                      _: *mut GlobalContext) -> ());
    (*this).unk_168 = 0 as libc::c_int as s16;
    (*this).dyna.actor.world.rot.y =
        ((*this).unk_16C as libc::c_int * 0x2000 as libc::c_int +
             (*this).dyna.actor.home.rot.y as libc::c_int) as s16;
    (*this).dyna.actor.shape.rot.y = (*this).dyna.actor.world.rot.y;
}
#[no_mangle]
pub unsafe extern "C" fn func_80896950(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).dyna.unk_150 > 0.001f32 {
        (*this).unk_168 += 1;
        if (*this).unk_168 as libc::c_int >= 15 as libc::c_int {
            func_808969F8(this, globalCtx);
        }
    } else { (*this).unk_168 = 0 as libc::c_int as s16 }
...
#[no_mangle]
pub unsafe extern "C" fn func_808969F8(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    phi_a3 =
        ((*this).dyna.actor.shape.rot.y as libc::c_int -
             (*this).dyna.unk_158 as libc::c_int) as s16 as s32;
    phi_a3 = if phi_a3 >= 0 as libc::c_int { phi_a3 } else { -phi_a3 };
    if temp2 as libc::c_int > 0 as libc::c_int {
        (*this).unk_16A =
            if phi_a3 > 0x4000 as libc::c_int {
                1 as libc::c_int
    ...
    (*this).unk_170 = (*this).unk_16E;
    (*this).unk_172 = 1 as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80896ABC(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    temp_v0 =
        (((*this).unk_16C as libc::c_int * 0x2000 as libc::c_int +
              (*this).dyna.actor.home.rot.y as libc::c_int) as s16 as
             libc::c_int - (*this).dyna.actor.world.rot.y as libc::c_int) as
            s16;
    if (if temp_v0 as libc::c_int >= 0 as libc::c_int {
            temp_v0 as libc::c_int
        } else { -(temp_v0 as libc::c_int) }) < 7424 as libc::c_int {
        Math_StepToS(&mut (*this).unk_16E, 106 as libc::c_int as s16,
                     4 as libc::c_int as s16);
    } else {
        Math_StepToS(&mut (*this).unk_16E, 21 as libc::c_int as s16,
                     10 as libc::c_int as s16);
    }
    if Math_ScaledStepToS(&mut (*this).unk_170,
                          ((*this).unk_16A as libc::c_int *
                               0x2000 as libc::c_int) as s16, (*this).unk_16E)
           != 0 {
        (*this).unk_16C =
            ((*this).unk_16C as libc::c_int + (*this).unk_16A as libc::c_int &
        ...
        (*this).dyna.actor.world.rot.y =
            ((*this).unk_16C as libc::c_int * 0x2000 as libc::c_int +
                 ...
                 (*this).unk_170 as libc::c_int) as s16;
        (*this).dyna.actor.shape.rot.y = (*this).dyna.actor.world.rot.y
    }
    if (*player).stateFlags2 & 0x10 as libc::c_int as libc::c_uint != 0 {
        if (*this).unk_172 != 0 { func_80895BEC(this, globalCtx); }
    } else if fabsf((*this).dyna.unk_150) < 0.001f32 {
        (*this).unk_172 = 0 as libc::c_int as u8_0
    }
    (*this).dyna.unk_150 = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_Update(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80896CB4(mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_jya_cobra.c\x00" as *const u8 as
                        *const libc::c_char, 864 as libc::c_int);
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gCobra2DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_cobra.c\x00" as *const u8 as
                         *const libc::c_char, 872 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_80896D78(mut this: *mut BgJyaCobra,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sp44: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    func_80093D84((*globalCtx).state.gfxCtx);
    sp44.x =
        (D_80897308[((*this).dyna.actor.params as libc::c_int &
                         3 as libc::c_int) as usize] as libc::c_int +
             (*this).dyna.actor.shape.rot.x as libc::c_int) as s16;
    sp44.y = (*this).dyna.actor.shape.rot.y;
    sp44.z = (*this).dyna.actor.shape.rot.z;
    func_800D1694((*this).unk_180.x, (*this).unk_180.y, (*this).unk_180.z,
                  &mut sp44);
    Matrix_Scale(0.1f32, 0.1f32, (*this).unk_190,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_0).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((*this).unk_18C * 140.0f32) as s32 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gCobra3DL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_cobra.c\x00" as *const u8 as
                         *const libc::c_char, 947 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_DrawShadow(mut this: *mut BgJyaCobra,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut params: s16 =
        ((*this).dyna.actor.params as libc::c_int & 3 as libc::c_int) as s16;
    let mut sp64: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut phi_a3: *mut Vec3s = 0 as *mut Vec3s;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    if params as libc::c_int == 0 as libc::c_int {
        sp64.x = (*this).dyna.actor.world.pos.x - 50.0f32;
        sp64.y = (*this).dyna.actor.world.pos.y;
        sp64.z = (*this).dyna.actor.world.pos.z;
        phi_a3 = &mut D_80897538
    } else if params as libc::c_int == 2 as libc::c_int {
        sp64.x = (*this).dyna.actor.world.pos.x + 70.0f32;
        sp64.y = (*this).dyna.actor.world.pos.y;
        sp64.z = (*this).dyna.actor.world.pos.z;
        phi_a3 = &mut D_80897540
    } else {
        phi_a3 = &mut (*this).dyna.actor.shape.rot;
        Math_Vec3f_Copy(&mut sp64, &mut (*this).dyna.actor.world.pos);
    }
    func_800D1694(sp64.x, sp64.y, sp64.z, phi_a3);
    Matrix_Scale(D_80897548[params as usize].x, D_80897548[params as usize].y,
                 D_80897548[params as usize].z,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    Matrix_Translate(0.0f32, 0.0f32, 40.0f32,
                     MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    (*_g_1).words.w1 =
        (&mut (*this).shadowTexture as *mut [u8_0; 4112] as s32 +
             0xf as libc::c_int & !(0xf as libc::c_int)) as libc::c_uint;
    ...
    (*_g_4).words.w1 =
        (7 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((if ((0x40 as libc::c_int * 0x40 as libc::c_int +
        ...
        (0xf5 as libc::c_int as u32_0 &
            ...
            (1 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 2 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 19 as libc::c_int
            |
            ((0x40 as libc::c_int * 1 as libc::c_int + 7 as libc::c_int >>
    ...
    (*_g_7).words.w1 =
        (0 as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 3 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((0x40 as libc::c_int - 1 as libc::c_int) << 2 as libc::c_int) as
                 u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 12 as libc::c_int
            |
    ...
    (*_g_8).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_8).words.w1 = sShadowDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_jya_cobra.c\x00" as *const u8 as
                         *const libc::c_char, 1006 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgJyaCobra_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgJyaCobra = thisx as *mut BgJyaCobra;
    func_80896CB4(globalCtx);
    Gfx_DrawDListOpa(globalCtx, gCobra1DL.as_mut_ptr());
    if (*this).unk_18C > 0.0f32 { func_80896D78(this, globalCtx); }
    if (*this).dyna.actor.params as libc::c_int & 3 as libc::c_int ==
           2 as libc::c_int {
        let mut mirror: *mut BgJyaBigmirror =
            (*this).dyna.actor.parent as *mut BgJyaBigmirror;
    ...
    } else { BgJyaCobra_DrawShadow(this, globalCtx); };
}
