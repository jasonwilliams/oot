...
extern "C" {
    ...
    #[no_mangle]
    static mut object_toki_objects_DL_000880: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_0009C0: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_007E20: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_007EE0: [Gfx; 0];
    #[no_mangle]
    static mut object_toki_objects_DL_008190: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgTokiHikari {
    pub actor: Actor,
    pub unk_14C: f32_0,
    pub actionFunc: BgTokiHikariActionFunc,
}
pub type BgTokiHikariActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgTokiHikari, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Toki_Hikari_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_TOKI_HIKARI as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgTokiHikari>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiHikari_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiHikari_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiHikari_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgTokiHikari_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiHikari_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgTokiHikari = thisx as *mut BgTokiHikari;
    match (*this).actor.params as libc::c_int {
        0 => {
            Actor_ProcessInitChain(&mut (*this).actor,
                                   sInitChain.as_mut_ptr());
            (*this).actionFunc =
                Some(BgTokiHikari_DoNothing as
                         unsafe extern "C" fn(_: *mut BgTokiHikari,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiHikari_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgTokiHikari_DoNothing(mut this: *mut BgTokiHikari,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgTokiHikari_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgTokiHikari = thisx as *mut BgTokiHikari;
...
#[no_mangle]
pub unsafe extern "C" fn BgTokiHikari_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgTokiHikari = thisx as *mut BgTokiHikari;
    match (*this).actor.params as libc::c_int {
        0 => { func_808BA018(this, globalCtx); }
        1 => { func_808BA2CC(this, globalCtx); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808BA018(mut this: *mut BgTokiHikari,
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_toki_hikari.c\x00" as *const u8 as
        ...
        (*_g_0).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_0).words.w1 =
            object_toki_objects_DL_008190.as_mut_ptr() as libc::c_uint
    } else {
        ...
        (*_g_1).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_1).words.w1 =
            object_toki_objects_DL_007E20.as_mut_ptr() as libc::c_uint;
        ...
        (*_g_5).words.w0 =
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g_5).words.w1 =
            object_toki_objects_DL_007EE0.as_mut_ptr() as libc::c_uint
    }
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_toki_hikari.c\x00" as *const u8 as
                         *const libc::c_char, 284 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_808BA204(mut this: *mut BgTokiHikari,
                                       mut globalCtx: *mut GlobalContext) {
    if (*globalCtx).roomCtx.unk_74[1 as libc::c_int as usize] as libc::c_int
           != 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_808BA22C as
                     unsafe extern "C" fn(_: *mut BgTokiHikari,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808BA22C(mut this: *mut BgTokiHikari,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_14C < 1.0f32 {
        (*this).unk_14C += 0.05f32
    } else {
        (*this).unk_14C = 1.0f32;
        (*this).actionFunc =
            Some(func_808BA274 as
                     unsafe extern "C" fn(_: *mut BgTokiHikari,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808BA274(mut this: *mut BgTokiHikari,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_14C > 0.2f32 {
        (*this).unk_14C -= 0.025f32
    } else { (*this).unk_14C = 0.0f32; Actor_Kill(&mut (*this).actor); };
}
#[no_mangle]
pub unsafe extern "C" fn func_808BA2CC(mut this: *mut BgTokiHikari,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Matrix_Translate(0.0f32, 276.0f32, 1122.0f32,
                     MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_Scale(0.32f32, 0.32f32, (*this).unk_14C * 7.0f32,
        ...
        (0xfa as libc::c_int as u32_0 &
            ...
            (0x80 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        (((*this).unk_14C * 255.0f32) as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((155.0f32 * (*this).unk_14C) as u8_0 as libc::c_int +
    ...
    (*_g_1).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_1).words.w1 =
        ((((*this).unk_14C * 155.0f32) as u8_0 as libc::c_int +
              100 as libc::c_int) as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            ((255.0f32 * (*this).unk_14C) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 16 as libc::c_int
            |
            (0 as libc::c_int as u32_0 &
    ...
    (*_g_3).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         (-(2 as libc::c_int) as
                              libc::c_uint).wrapping_mul((*globalCtx).gameplayFrames
                                                             &
                                                             0x7f as
                                                                 libc::c_int
                                                                 as
                         ...
                         ((*globalCtx).gameplayFrames &
                              0x7f as libc::c_int as
                                  libc::c_uint).wrapping_mul(4 as libc::c_int
                                                                 as
                                                                 libc::c_uint),
                         0 as libc::c_int as u32_0, 0x20 as libc::c_int,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 =
        object_toki_objects_DL_000880.as_mut_ptr() as libc::c_uint;
    Matrix_Pop();
    Matrix_Push();
    ...
    (*_g_6).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            (((*this).unk_14C * 200.0f32) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    ...
    (*_g_7).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_7).words.w1 =
        (((*this).unk_14C * 255.0f32) as u8_0 as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
            (((*this).unk_14C * 255.0f32) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
            ...
            (((*this).unk_14C * 255.0f32) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 8 as libc::c_int |
            ((200.0f32 * (*this).unk_14C) as u8_0 as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_9).words.w1 =
        object_toki_objects_DL_0009C0.as_mut_ptr() as libc::c_uint;
    Matrix_Pop();
    Matrix_Push();
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_14).words.w1 =
        &mut *object_toki_objects_DL_0009C0.as_mut_ptr().offset(10 as
                                                                    libc::c_int
                                                                    as isize)
            as *mut Gfx as libc::c_uint;
    Matrix_Pop();
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_toki_hikari.c\x00" as *const u8 as
