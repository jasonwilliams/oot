...
extern "C" {
    ...
    #[no_mangle]
    static mut gObjectMizuObjectsUzuCol_0074EC: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMizuUzu {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMizuUzuActionFunc,
}
pub type BgMizuUzuActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMizuUzu, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Mizu_Uzu_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MIZU_UZU as libc::c_int as s16,
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuUzu_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuUzu_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuUzu_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgMizuUzu = thisx as *mut BgMizuUzu;
    ...
    CollisionHeader_GetVirtual(&mut gObjectMizuObjectsUzuCol_0074EC as
    ...
    (*this).actionFunc =
        Some(func_8089F788 as
                 unsafe extern "C" fn(_: *mut BgMizuUzu,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuUzu_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgMizuUzu = thisx as *mut BgMizuUzu;
...
#[no_mangle]
pub unsafe extern "C" fn func_8089F788(mut this: *mut BgMizuUzu,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisx: *mut Actor = &mut (*this).dyna.actor;
    if (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                               usize].head as
    ...
    Audio_PlayActorSound2(thisx,
                          (0x28cd as libc::c_int - 0x800 as libc::c_int) as
                              u16_0);
    (*thisx).shape.rot.y =
        ((*thisx).shape.rot.y as libc::c_int + 0x1c0 as libc::c_int) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuUzu_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgMizuUzu = thisx as *mut BgMizuUzu;
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuUzu_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
}
