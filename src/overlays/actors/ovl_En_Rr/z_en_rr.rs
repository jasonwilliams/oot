...
extern "C" {
    ...
    fn Collider_UpdateCylinder(actor: *mut Actor,
                               collider: *mut ColliderCylinder);
    #[no_mangle]
    fn CollisionCheck_SpawnShieldParticlesMetal2(globalCtx:
                                                     *mut GlobalContext,
                                                 v: *mut Vec3f);
    #[no_mangle]
...
pub struct EnRr {
    pub actor: Actor,
    pub actionFunc: EnRrActionFunc,
    pub collider1: ColliderCylinder,
    ...
    pub effectTimer: s16,
    pub ocTimer: s16,
    pub segMovePhase: s16,
    pub segPhaseVel: f32_0,
    pub segPhaseVelTarget: f32_0,
    pub segPulsePhaseDiff: f32_0,
    pub segWobblePhaseDiffX: f32_0,
    pub segWobbleXTarget: f32_0,
    pub segWobblePhaseDiffZ: f32_0,
    pub segWobbleZTarget: f32_0,
    pub pulseSize: f32_0,
    pub pulseSizeTarget: f32_0,
    pub wobbleSize: f32_0,
    pub wobbleSizeTarget: f32_0,
    pub bodySegs: [EnRrBodySegment; 5],
    pub segMoveRate: f32_0,
    pub shrinkRate: f32_0,
    pub swallowOffset: f32_0,
    pub reachState: u8_0,
    pub isDead: u8_0,
    pub eatenShield: u8_0,
    pub eatenTunic: u8_0,
    pub dropType: u8_0,
    pub retreat: u8_0,
    pub stopScroll: u8_0,
    pub hasPlayer: s16,
    pub mouthPos: Vec3f,
    pub effectPos: [Vec3f; 5],
    pub unk_3C4: [libc::c_char; 8192],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnRrBodySegment {
    pub height: f32_0,
    pub heightTarget: f32_0,
    pub scale: Vec3f,
    pub scaleTarget: Vec3f,
    pub scaleMod: Vec3f,
    pub rotTarget: Vec3f,
    pub rot: Vec3s,
}
pub type EnRrActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const REACH_CLOSE: C2RustUnnamed_24 = 5;
pub const REACH_GAPE: C2RustUnnamed_24 = 4;
pub const REACH_OPEN: C2RustUnnamed_24 = 3;
pub const REACH_STOP: C2RustUnnamed_24 = 2;
pub const REACH_EXTEND: C2RustUnnamed_24 = 1;
pub const REACH_NONE: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const RR_DMG_NORMAL: C2RustUnnamed_25 = 15;
pub const RR_DMG_SPRT_ARROW: C2RustUnnamed_25 = 14;
pub const RR_DMG_WIND_ARROW: C2RustUnnamed_25 = 13;
pub const RR_DMG_SHDW_ARROW: C2RustUnnamed_25 = 12;
pub const RR_DMG_LIGHT_ARROW: C2RustUnnamed_25 = 11;
pub const RR_DMG_LIGHT_MAGIC: C2RustUnnamed_25 = 4;
pub const RR_DMG_ICE: C2RustUnnamed_25 = 3;
pub const RR_DMG_FIRE: C2RustUnnamed_25 = 2;
pub const RR_DMG_STUN: C2RustUnnamed_25 = 1;
pub const RR_DMG_NONE: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const RR_DROP_RUPEE_RED: C2RustUnnamed_26 = 5;
pub const RR_DROP_RUPEE_PURPLE: C2RustUnnamed_26 = 4;
pub const RR_DROP_FLEXIBLE: C2RustUnnamed_26 = 3;
pub const RR_DROP_ARROW: C2RustUnnamed_26 = 2;
pub const RR_DROP_MAGIC: C2RustUnnamed_26 = 1;
pub const RR_DROP_RANDOM_RUPEE: C2RustUnnamed_26 = 0;
#[no_mangle]
pub static mut En_Rr_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_RR as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_RR as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnRr>() as libc::c_ulong,
                          init:
...
static mut sDropNames: [*mut libc::c_char; 6] =
    [b"\xe3\x82\xbf\xe3\x82\xa4\xe3\x83\x97\xef\xbc\x97  \x00" as *const u8 as
         *const libc::c_char as *mut libc::c_char,
     b"\xe9\xad\x94\xe6\xb3\x95\xe3\x81\xae\xe5\xa3\xb7\xe5\xb0\x8f\x00" as
         *const u8 as *const libc::c_char as *mut libc::c_char,
     b"\xe7\x9f\xa2        \x00" as *const u8 as *const libc::c_char as
         *mut libc::c_char,
     b"\xe5\xa6\x96\xe7\xb2\xbe      \x00" as *const u8 as *const libc::c_char
         as *mut libc::c_char,
     b"20\xe3\x83\xab\xe3\x83\x94\xe3\x83\xbc  \x00" as *const u8 as
         *const libc::c_char as *mut libc::c_char,
     b"50\xe3\x83\xab\xe3\x83\x94\xe3\x83\xbc  \x00" as *const u8 as
         *const libc::c_char as *mut libc::c_char];
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (RR_DMG_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (RR_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (RR_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (4 as libc::c_int |
                                  (RR_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (RR_DMG_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (RR_DMG_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (15 as libc::c_int |
                                  (RR_DMG_LIGHT_ARROW as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (RR_DMG_WIND_ARROW as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (15 as libc::c_int |
                                  (RR_DMG_SHDW_ARROW as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (15 as libc::c_int |
                                  (RR_DMG_SPRT_ARROW as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (RR_DMG_FIRE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (3 as libc::c_int |
                                  (RR_DMG_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (10 as libc::c_int |
                                  (RR_DMG_LIGHT_MAGIC as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (RR_DMG_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_Init(mut thisx: *mut Actor,
                                   mut globalCtx2: *mut GlobalContext) {
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnRr = thisx as *mut EnRr;
    let mut i: s32 = 0;
    ...
    Collider_InitCylinder(globalCtx, &mut (*this).collider1);
    Collider_SetCylinderType1(globalCtx, &mut (*this).collider1,
    ...
    (*this).actor.scale.y = 0.013f32;
    (*this).actor.scale.z = 0.014f32;
    ...
    (*this).eatenShield = 0 as libc::c_int as u8_0;
    (*this).eatenTunic = 0 as libc::c_int as u8_0;
    (*this).retreat = 0 as libc::c_int as u8_0;
    (*this).grabTimer = 0 as libc::c_int as s16;
    (*this).invincibilityTimer = 0 as libc::c_int as s16;
    (*this).effectTimer = 0 as libc::c_int as s16;
    (*this).hasPlayer = 0 as libc::c_int as s16;
    (*this).stopScroll = 0 as libc::c_int as u8_0;
    (*this).ocTimer = 0 as libc::c_int as s16;
    (*this).isDead = 0 as libc::c_int as u8_0;
    (*this).reachState = (*this).isDead;
    (*this).actionFunc =
        Some(EnRr_Approach as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].scaleMod.z = 0.0f32;
        (*this).bodySegs[i as usize].scaleMod.y =
            (*this).bodySegs[i as usize].scaleMod.z;
        (*this).bodySegs[i as usize].scaleMod.x =
            (*this).bodySegs[i as usize].scaleMod.y;
        (*this).bodySegs[i as usize].heightTarget =
            (*this).bodySegs[i as usize].scaleMod.x;
        (*this).bodySegs[i as usize].height =
            (*this).bodySegs[i as usize].heightTarget;
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnRr = thisx as *mut EnRr;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider1);
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider2);
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetSpeed(mut this: *mut EnRr,
                                       mut speed: f32_0) {
    (*this).actor.speedXZ = speed;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3990 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupReach(mut this: *mut EnRr) {
    static mut segmentHeights: [f32_0; 5] =
        [0.0f32, 500.0f32, 750.0f32, 1000.0f32, 1000.0f32];
    let mut i: s32 = 0;
    (*this).reachState = 1 as libc::c_int as u8_0;
    (*this).actionTimer = 20 as libc::c_int as s16;
    (*this).segPhaseVelTarget = 2500.0f32;
    (*this).segMoveRate = 0.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].heightTarget =
            segmentHeights[i as usize];
        (*this).bodySegs[i as usize].scaleTarget.z = 0.8f32;
        (*this).bodySegs[i as usize].scaleTarget.x =
            (*this).bodySegs[i as usize].scaleTarget.z;
        (*this).bodySegs[i as usize].rotTarget.x = 6000.0f32;
        (*this).bodySegs[i as usize].rotTarget.z = 0.0f32;
        i += 1
    }
    (*this).actionFunc =
        Some(EnRr_Reach as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
    Audio_PlayActorSound2(&mut (*this).actor, 0x3991 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupNeutral(mut this: *mut EnRr) {
    let mut i: s32 = 0;
    (*this).reachState = 0 as libc::c_int as u8_0;
    (*this).segMoveRate = 0.0f32;
    (*this).segPhaseVelTarget = 2500.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].heightTarget = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.z = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.x =
            (*this).bodySegs[i as usize].rotTarget.z;
        (*this).bodySegs[i as usize].scaleTarget.z = 1.0f32;
        (*this).bodySegs[i as usize].scaleTarget.x =
            (*this).bodySegs[i as usize].scaleTarget.z;
        i += 1
    }
    if (*this).retreat != 0 {
        (*this).actionTimer = 100 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnRr_Retreat as
                     unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                         -> ())
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupGrabPlayer(mut this: *mut EnRr,
                                              mut player: *mut Player) {
    let mut i: s32 = 0;
    (*this).grabTimer = 100 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).ocTimer = 8 as libc::c_int as s16;
    (*this).hasPlayer = 1 as libc::c_int as s16;
    (*this).reachState = 0 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).swallowOffset = (*this).actor.speedXZ;
    (*this).segMoveRate = (*this).swallowOffset;
    (*this).pulseSizeTarget = 0.15f32;
    (*this).segPhaseVelTarget = 5000.0f32;
    (*this).wobbleSizeTarget = 512.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].heightTarget = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.z = 0.0f32;
    ...
    (*this).actionFunc =
        Some(EnRr_GrabPlayer as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
    Audio_PlayActorSound2(&mut (*this).actor, 0x3992 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_GetMessage(mut shield: u8_0, mut tunic: u8_0)
 -> u8_0 {
    let mut messageIndex: u8_0 = 0 as libc::c_int as u8_0;
    if shield as libc::c_int == 1 as libc::c_int ||
           shield as libc::c_int == 2 as libc::c_int {
        messageIndex = ((1 as libc::c_int) << 0 as libc::c_int) as u8_0
    }
    if tunic as libc::c_int == 2 as libc::c_int ||
           tunic as libc::c_int == 3 as libc::c_int {
        messageIndex =
            (messageIndex as libc::c_int |
                 (1 as libc::c_int) << 1 as libc::c_int) as u8_0
    }
    return messageIndex;
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupReleasePlayer(mut this: *mut EnRr,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut shield: u8_0 = 0;
    let mut tunic: u8_0 = 0;
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).hasPlayer = 0 as libc::c_int as s16;
    (*this).ocTimer = 110 as libc::c_int as s16;
    (*this).segMoveRate = 0.0f32;
    (*this).segPhaseVelTarget = 2500.0f32;
    (*this).wobbleSizeTarget = 2048.0f32;
    tunic = 0 as libc::c_int as u8_0;
    shield = 0 as libc::c_int as u8_0;
    if (gSaveContext.equips.equipment as libc::c_int &
            gEquipMasks[EQUIP_SHIELD as libc::c_int as usize] as libc::c_int)
           >>
           gEquipShifts[EQUIP_SHIELD as libc::c_int as usize] as libc::c_int
           != 3 as libc::c_int {
        /* Mirror shield */
        shield =
            Inventory_DeleteEquipment(globalCtx,
                                      EQUIP_SHIELD as libc::c_int as s16);
        if shield as libc::c_int != 0 as libc::c_int {
            (*this).eatenShield = shield;
            (*this).retreat = 1 as libc::c_int as u8_0
        }
    }
    if (gSaveContext.equips.equipment as libc::c_int &
            gEquipMasks[EQUIP_TUNIC as libc::c_int as usize] as libc::c_int)
           >> gEquipShifts[EQUIP_TUNIC as libc::c_int as usize] as libc::c_int
           != 1 as libc::c_int {
        /* Kokiri tunic */
        tunic =
            Inventory_DeleteEquipment(globalCtx,
                                      EQUIP_TUNIC as libc::c_int as s16);
        if tunic as libc::c_int != 0 as libc::c_int {
            (*this).eatenTunic = tunic;
            (*this).retreat = 1 as libc::c_int as u8_0
        }
    }
    (*player).actor.parent = 0 as *mut Actor;
    match EnRr_GetMessage(shield, tunic) as libc::c_int {
        1 => {
            Message_StartTextbox(globalCtx, 0x305f as libc::c_int as u16_0,
                                 0 as *mut Actor);
        }
        2 => {
            Message_StartTextbox(globalCtx, 0x3060 as libc::c_int as u16_0,
                                 0 as *mut Actor);
        }
        3 => {
            Message_StartTextbox(globalCtx, 0x3061 as libc::c_int as u16_0,
                                 0 as *mut Actor);
        }
        _ => { }
    }
    osSyncPrintf(b"\x1b[33m%s[%d] : Rr_Catch_Cancel\x1b[m\n\x00" as *const u8
                     as *const libc::c_char,
                 b"../z_en_rr.c\x00" as *const u8 as *const libc::c_char,
                 650 as libc::c_int);
    func_8002F6D4(globalCtx, &mut (*this).actor, 4.0f32,
                  (*this).actor.shape.rot.y, 12.0f32,
    ...
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3994 as libc::c_int as u16_0);
    } else if (*this).actor.colChkInfo.health as libc::c_int !=
                  0 as libc::c_int {
        EnRr_SetupDamage(this);
    } else { EnRr_SetupDeath(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupDamage(mut this: *mut EnRr) {
    let mut i: s32 = 0;
    (*this).reachState = 0 as libc::c_int as u8_0;
    (*this).actionTimer = 20 as libc::c_int as s16;
    (*this).segMoveRate = 0.0f32;
    (*this).segPhaseVelTarget = 2500.0f32;
    (*this).pulseSizeTarget = 0.0f32;
    (*this).wobbleSizeTarget = 0.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].heightTarget = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.z = 0.0f32;
    ...
    (*this).actionFunc =
        Some(EnRr_Damage as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
    Audio_PlayActorSound2(&mut (*this).actor, 0x3995 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupApproach(mut this: *mut EnRr) {
    let mut i: s32 = 0;
    (*this).segMoveRate = 0.0f32;
    (*this).pulseSizeTarget = 0.15f32;
    (*this).segPhaseVelTarget = 2500.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupDeath(mut this: *mut EnRr) {
    let mut i: s32 = 0;
    (*this).isDead = 1 as libc::c_int as u8_0;
    (*this).frameCount = 0 as libc::c_int as s16;
    (*this).shrinkRate = 0.0f32;
    (*this).segMoveRate = 0.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].heightTarget = 0.0f32;
    ...
    (*this).actionFunc =
        Some(EnRr_Death as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
    Audio_PlayActorSound2(&mut (*this).actor, 0x3996 as libc::c_int as u16_0);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_SetupStunned(mut this: *mut EnRr) {
    let mut i: s32 = 0;
    (*this).stopScroll = 1 as libc::c_int as u8_0;
    (*this).segMovePhase = 0 as libc::c_int as s16;
    (*this).segPhaseVel = 0.0f32;
    (*this).segPhaseVelTarget = 2500.0f32;
    (*this).segPulsePhaseDiff = 0.0f32;
    (*this).segWobblePhaseDiffX = 0.0f32;
    (*this).segWobbleXTarget = 3.0f32;
    (*this).segWobblePhaseDiffZ = 0.0f32;
    (*this).segWobbleZTarget = 1.0f32;
    (*this).pulseSize = 0.0f32;
    (*this).pulseSizeTarget = 0.15f32;
    (*this).wobbleSize = 0.0f32;
    (*this).wobbleSizeTarget = 2048.0f32;
    i = 0 as libc::c_int;
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].scaleMod.y = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.x = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.y = 0.0f32;
        (*this).bodySegs[i as usize].rotTarget.z = 0.0f32;
        (*this).bodySegs[i as usize].scaleTarget.z = 1.0f32;
        (*this).bodySegs[i as usize].scaleTarget.y =
            (*this).bodySegs[i as usize].scaleTarget.z;
        (*this).bodySegs[i as usize].scaleTarget.x =
            (*this).bodySegs[i as usize].scaleTarget.y;
        (*this).bodySegs[i as usize].scale.z =
            (*this).bodySegs[i as usize].scaleTarget.x;
        (*this).bodySegs[i as usize].scale.y =
            (*this).bodySegs[i as usize].scale.z;
        (*this).bodySegs[i as usize].scale.x =
            (*this).bodySegs[i as usize].scale.y;
        i += 1
    }
    (*this).actionFunc =
        Some(EnRr_Stunned as
                 unsafe extern "C" fn(_: *mut EnRr, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_CollisionCheck(mut this: *mut EnRr,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).collider2.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).collider2.base.acFlags =
            ((*this).collider2.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        // "Kakin" (not sure what this means)
        osSyncPrintf(b"\x1b[32m\xe3\x82\xab\xe3\x82\xad\xe3\x83\xb3(%d)\xef\xbc\x81\xef\xbc\x81\x1b[m\n\x00"
                         as *const u8 as *const libc::c_char,
                     (*this).frameCount as libc::c_int); // purple rupee
        hitPos.x = (*this).collider2.info.bumper.hitPos.x as f32_0;
        hitPos.y = (*this).collider2.info.bumper.hitPos.y as f32_0;
        hitPos.z = (*this).collider2.info.bumper.hitPos.z as f32_0;
        CollisionCheck_SpawnShieldParticlesMetal2(globalCtx, &mut hitPos);
    } else {
        if (*this).collider1.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            let mut dropType: u8_0 =
                RR_DROP_RANDOM_RUPEE as libc::c_int as u8_0;
            (*this).collider1.base.acFlags =
                ((*this).collider1.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
                   0 as libc::c_int {
                hitPos.x = (*this).collider1.info.bumper.hitPos.x as f32_0;
                hitPos.y = (*this).collider1.info.bumper.hitPos.y as f32_0;
                hitPos.z = (*this).collider1.info.bumper.hitPos.z as f32_0;
                CollisionCheck_BlueBlood(globalCtx, 0 as *mut Collider,
                                         &mut hitPos);
            }
            's_301:
                {
                    let mut current_block_61: u64;
                    match (*this).actor.colChkInfo.damageEffect as libc::c_int
                        {
                        11 => {
                            dropType = dropType.wrapping_add(1);
                            current_block_61 = 2292236339046792762;
                        }
                        12 => { current_block_61 = 2292236339046792762; }
                        13 => { current_block_61 = 14012021152738610266; }
                        14 => { current_block_61 = 13347353552671844059; }
                        15 => { current_block_61 = 9637264427244109548; }
                        2 => {
                            // Fire Arrow and Din's Fire
                            Actor_ApplyDamage(&mut (*this).actor);
                            if (*this).actor.colChkInfo.health as libc::c_int
                                   == 0 as libc::c_int {
                                (*this).dropType =
                                    RR_DROP_RANDOM_RUPEE as libc::c_int as
                                        u8_0
                            }
                            ...
                            (*this).effectTimer = 20 as libc::c_int as s16;
                            EnRr_SetupStunned(this);
                            return
                        }
                        3 => {
                            // Ice Arrow and unused ice magic
                            Actor_ApplyDamage(&mut (*this).actor);
                            if (*this).actor.colChkInfo.health as libc::c_int
                                   == 0 as libc::c_int {
                                (*this).dropType =
                        ...
                        4 => {
                            ...
                            if (*this).actor.colChkInfo.health as libc::c_int
                                   == 0 as libc::c_int {
                                (*this).dropType =
                                    RR_DROP_RUPEE_RED as libc::c_int as u8_0
                            }
                            Actor_SetColorFilter(&mut (*this).actor,
                        ...
                        1 => {
                            ...
                            Actor_SetColorFilter(&mut (*this).actor,
                                                 ...
                                                 0x50 as libc::c_int as
                                                     s16); // arrow
                            EnRr_SetupStunned(this); // magic jar
                            return
                        }
                        _ => { break 's_301 ; }
                    }
                    match current_block_61 {
                        2292236339046792762 => {
                            dropType = dropType.wrapping_add(1);
                            current_block_61 = 14012021152738610266;
                        }
                        _ => { }
                    }
                    match current_block_61 {
                        14012021152738610266 => {
                            dropType = dropType.wrapping_add(1);
                            current_block_61 = 13347353552671844059;
                        }
                        _ => { }
                    }
                    match current_block_61 {
                        13347353552671844059 => {
                            dropType = dropType.wrapping_add(1)
                        }
                        _ => { }
                    }
                    // "ouch"
                    osSyncPrintf(b"\x1b[31m\xe3\x81\x84\xe3\x81\xa6\xe3\x81\xa3( %d : LIFE %d : DAMAGE %d : %x )\xef\xbc\x81\xef\xbc\x81\x1b[m\n\x00"
                                     as *const u8 as *const libc::c_char,
                                 (*this).frameCount as libc::c_int,
                                 (*this).actor.colChkInfo.health as
                                     libc::c_int,
                                 (*this).actor.colChkInfo.damage as
                                     libc::c_int,
                                 (*this).actor.colChkInfo.damageEffect as
                                     libc::c_int);
                    (*this).stopScroll = 0 as libc::c_int as u8_0;
                    Actor_ApplyDamage(&mut (*this).actor);
                    (*this).invincibilityTimer = 40 as libc::c_int as s16;
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0x4000 as libc::c_int as s16,
                                         0xff as libc::c_int as s16,
                                         0x2000 as libc::c_int as s16,
        ...
        if (*this).ocTimer as libc::c_int == 0 as libc::c_int &&
               ...
               (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint ==
                   0 &&
               ((*this).collider1.base.ocFlags1 as libc::c_int &
                    (1 as libc::c_int) << 1 as libc::c_int != 0 ||
                    (*this).collider2.base.ocFlags1 as libc::c_int &
                        (1 as libc::c_int) << 1 as libc::c_int != 0) {
            (*this).collider1.base.ocFlags1 =
                ((*this).collider1.base.ocFlags1 as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            (*this).collider2.base.ocFlags1 =
                ((*this).collider2.base.ocFlags1 as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            // "catch"
            osSyncPrintf(b"\x1b[32m\xe3\x82\xad\xe3\x83\xa3\xe3\x83\x83\xe3\x83\x81(%d)\xef\xbc\x81\xef\xbc\x81\x1b[m\n\x00"
                             as *const u8 as *const libc::c_char,
                         (*this).frameCount as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_InitBodySegments(mut this: *mut EnRr,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut i: s32 = 0;
    (*this).segMovePhase = 0 as libc::c_int as s16;
    ...
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].scaleMod.z =
            Math_CosS((i as
                           libc::c_uint).wrapping_mul((*this).segPulsePhaseDiff
                                                          as s16 as
                                                          u32_0).wrapping_mul(0x1000
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint)
                          as s16) * (*this).pulseSize;
        (*this).bodySegs[i as usize].scaleMod.x =
            (*this).bodySegs[i as usize].scaleMod.z;
        i += 1
    }
    ...
    while i < 5 as libc::c_int {
        (*this).bodySegs[i as usize].rotTarget.x =
            Math_CosS((i as
                           libc::c_uint).wrapping_mul((*this).segWobblePhaseDiffX
                                                          as s16 as
                                                          u32_0).wrapping_mul(0x1000
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint)
                          as s16) * (*this).wobbleSize;
        (*this).bodySegs[i as usize].rotTarget.z =
            Math_SinS((i as
                           libc::c_uint).wrapping_mul((*this).segWobblePhaseDiffZ
                                                          as s16 as
                                                          u32_0).wrapping_mul(0x1000
                                                                                  as
                                                                                  libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_UpdateBodySegments(mut this: *mut EnRr,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut i: s32 = 0;
    let mut phase: s16 = (*this).segMovePhase;
    if (*this).isDead == 0 {
        i = 0 as libc::c_int;
        while i < 5 as libc::c_int {
            (*this).bodySegs[i as usize].scaleMod.z =
                Math_CosS((phase as libc::c_int +
                               i *
                                   (*this).segPulsePhaseDiff as s16 as
                                       libc::c_int * 0x1000 as libc::c_int) as
                              s16) * (*this).pulseSize;
            (*this).bodySegs[i as usize].scaleMod.x =
                (*this).bodySegs[i as usize].scaleMod.z;
            i += 1
        ...
        if (*this).isDead == 0 &&
               (*this).reachState as libc::c_int == 0 as libc::c_int {
            i = 1 as libc::c_int;
            while i < 5 as libc::c_int {
                (*this).bodySegs[i as usize].rotTarget.x =
                    Math_CosS((phase as libc::c_int +
                                   i *
                                       (*this).segWobblePhaseDiffX as s16 as
                                           libc::c_int *
                                       0x1000 as libc::c_int) as s16) *
                        (*this).wobbleSize;
                (*this).bodySegs[i as usize].rotTarget.z =
                    Math_SinS((phase as libc::c_int +
                                   i *
                                       (*this).segWobblePhaseDiffZ as s16 as
                                           libc::c_int *
                                       0x1000 as libc::c_int) as s16) *
                        (*this).wobbleSize;
                i += 1
    ...
    if (*this).stopScroll == 0 {
        (*this).segMovePhase =
            ((*this).segMovePhase as libc::c_int +
                 (*this).segPhaseVel as s16 as libc::c_int) as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Approach(mut this: *mut EnRr,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0xa as libc::c_int as s16, 0x1f4 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    ...
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int &&
        ...
        EnRr_SetupReach(this);
                  ...
                  (*this).actor.speedXZ == 0.0f32 {
        EnRr_SetSpeed(this, 2.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Reach(mut this: *mut EnRr,
                                    mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       0xa as libc::c_int as s16, 0x1f4 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    match (*this).reachState as libc::c_int {
        1 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                (*this).reachState = REACH_STOP as libc::c_int as u8_0
            }
        }
        2 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                (*this).actionTimer = 5 as libc::c_int as s16;
                (*this).bodySegs[4 as libc::c_int as usize].scaleTarget.z =
                    1.5f32;
                (*this).bodySegs[4 as libc::c_int as usize].scaleTarget.x =
                    (*this).bodySegs[4 as libc::c_int as usize].scaleTarget.z;
                (*this).reachState = REACH_OPEN as libc::c_int as u8_0
            }
        }
        3 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                (*this).actionTimer = 2 as libc::c_int as s16;
                (*this).bodySegs[4 as libc::c_int as usize].heightTarget =
                    2000.0f32;
                (*this).reachState = REACH_GAPE as libc::c_int as u8_0
            }
        }
        4 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
                ...
                (*this).bodySegs[4 as libc::c_int as usize].scaleTarget.x =
                    (*this).bodySegs[4 as libc::c_int as usize].scaleTarget.z;
                (*this).reachState = REACH_CLOSE as libc::c_int as u8_0
            }
        }
        5 => {
            if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_GrabPlayer(mut this: *mut EnRr,
                                         mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    func_800AA000((*this).actor.xyzDistToPlayerSq, 120 as libc::c_int as u8_0,
                  2 as libc::c_int as u8_0, 120 as libc::c_int as u8_0);
    if (*this).frameCount as libc::c_int % 8 as libc::c_int ==
           0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3993 as libc::c_int as u16_0);
    }
    (*this).ocTimer = 8 as libc::c_int as s16;
    if (*this).grabTimer as libc::c_int == 0 as libc::c_int ||
           (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint == 0 {
        EnRr_SetupReleasePlayer(this, globalCtx);
    } else {
        Math_ApproachF(&mut (*player).actor.world.pos.x, (*this).mouthPos.x,
                       1.0f32, 30.0f32);
        Math_ApproachF(&mut (*player).actor.world.pos.y,
                       (*this).mouthPos.y + (*this).swallowOffset, 1.0f32,
                       30.0f32);
        Math_ApproachF(&mut (*player).actor.world.pos.z, (*this).mouthPos.z,
                       1.0f32, 30.0f32);
        Math_ApproachF(&mut (*this).swallowOffset, -55.0f32, 1.0f32, 5.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Damage(mut this: *mut EnRr,
                                     mut globalCtx: *mut GlobalContext) {
    let mut i: s32 = 0;
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        EnRr_SetupApproach(this);
    } else if (*this).actor.colorFilterTimer as libc::c_int & 8 as libc::c_int
                  != 0 as libc::c_int {
        i = 1 as libc::c_int;
        while i < 5 as libc::c_int {
            (*this).bodySegs[i as usize].rotTarget.z = 5000.0f32;
            i += 1
        }
    } else {
        i = 1 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn EnRr_Death(mut this: *mut EnRr,
                                    mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut i: s32 = 0;
    if ((*this).frameCount as libc::c_int) < 40 as libc::c_int {
        i = 0 as libc::c_int;
        while i < 5 as libc::c_int {
            Math_ApproachF(&mut (*(*this).bodySegs.as_mut_ptr().offset(i as
                                                                           isize)).heightTarget,
                           (i + 59 as libc::c_int) as libc::c_float -
                               (*this).frameCount as libc::c_int as
                                   libc::c_float * 25.0f32, 1.0f32, 50.0f32);
            (*this).bodySegs[i as usize].scaleTarget.z =
                ((4 as libc::c_int - i) * (4 as libc::c_int - i)) as
                    libc::c_float * (*this).frameCount as f32_0 * 0.003f32 +
                    1.0f32;
            (*this).bodySegs[i as usize].scaleTarget.x =
                (*this).bodySegs[i as usize].scaleTarget.z;
            i += 1
        }
    } else if (*this).frameCount as libc::c_int >= 95 as libc::c_int {
        ...
        match (*this).eatenShield as libc::c_int {
            1 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_SHIELD_DEKU as libc::c_int as
                                         s16);
            }
            2 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_SHIELD_HYLIAN as libc::c_int as
                                         s16);
            }
            _ => { }
        }
        match (*this).eatenTunic as libc::c_int {
            2 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_TUNIC_GORON as libc::c_int as
                                         s16);
            }
            3 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_TUNIC_ZORA as libc::c_int as s16);
            }
            _ => { }
        }
        // "dropped"
        osSyncPrintf(b"\x1b[32m\xe3\x80\x8c%s\xe3\x80\x8d\xe3\x81\x8c\xe5\x87\xba\xe3\x81\x9f\xef\xbc\x81\xef\xbc\x81\x1b[m\n\x00"
                         as *const u8 as *const libc::c_char,
                     sDropNames[(*this).dropType as usize]);
        match (*this).dropType as libc::c_int {
            1 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_MAGIC_SMALL as libc::c_int as
                                         s16);
            }
            2 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_ARROWS_SINGLE as libc::c_int as
                                         s16);
            }
            3 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
            ...
            4 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_RUPEE_PURPLE as libc::c_int as
                                         s16);
            }
            5 => {
                Item_DropCollectible(globalCtx, &mut dropPos,
                                     ITEM00_RUPEE_RED as libc::c_int as s16);
            }
            0 | _ => {
        ...
        accel.y = 0.0f32;
        accel.z = 0.0f32;
        EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut vel, &mut accel,
        ...
        Math_ApproachF(&mut (*this).actor.scale.x, 0.0f32, 1.0f32,
                       (*this).shrinkRate);
        Math_ApproachF(&mut (*this).shrinkRate, 0.001f32, 1.0f32, 0.00001f32);
        (*this).actor.scale.z = (*this).actor.scale.x
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Retreat(mut this: *mut EnRr,
                                      mut globalCtx: *mut GlobalContext) {
    if (*this).actionTimer as libc::c_int == 0 as libc::c_int {
        (*this).retreat = 0 as libc::c_int as u8_0;
        (*this).actionFunc =
        ...
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           ...
                           0 as libc::c_int as s16);
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        if (*this).actor.speedXZ == 0.0f32 { EnRr_SetSpeed(this, 2.0f32); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Stunned(mut this: *mut EnRr,
                                      mut globalCtx: *mut GlobalContext) {
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        (*this).stopScroll = 0 as libc::c_int as u8_0;
        if (*this).hasPlayer != 0 {
            ...
            (*this).actionFunc =
                Some(EnRr_Approach as
                         unsafe extern "C" fn(_: *mut EnRr,
                                              _: *mut GlobalContext) -> ())
        } else { EnRr_SetupDeath(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRr_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnRr = thisx as *mut EnRr;
    let mut i: s32 = 0;
    (*this).frameCount += 1;
    if (*this).stopScroll == 0 { (*this).scrollTimer += 1 }
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
    }
    if (*this).grabTimer as libc::c_int != 0 as libc::c_int {
    ...
    if (*this).effectTimer as libc::c_int != 0 as libc::c_int {
        (*this).effectTimer -= 1
    }
    Actor_SetFocus(&mut (*this).actor, 30.0f32);
    ...
    if (*this).hasPlayer as libc::c_int == 0x3f80 as libc::c_int {
        // checks if 1.0f has been stored to hasPlayer's address
    ...
    Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32);
    Actor_MoveForward(&mut (*this).actor);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider1);
    (*this).collider2.dim.pos.x = (*this).mouthPos.x as s16;
    (*this).collider2.dim.pos.y = (*this).mouthPos.y as s16;
    (*this).collider2.dim.pos.z = (*this).mouthPos.z as s16;
    if (*this).isDead == 0 &&
           (*this).invincibilityTimer as libc::c_int == 0 as libc::c_int {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider1.base);
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32, 30.0f32,
                            20.0f32, 7 as libc::c_int);
    if (*this).stopScroll == 0 {
        Math_ApproachF(&mut (*this).segPhaseVel, (*this).segPhaseVelTarget,
                       1.0f32, 50.0f32);
        Math_ApproachF(&mut (*this).segPulsePhaseDiff, 4.0f32, 1.0f32,
                       5.0f32);
        Math_ApproachF(&mut (*this).segWobblePhaseDiffX,
                       (*this).segWobbleXTarget, 1.0f32, 0.04f32);
        Math_ApproachF(&mut (*this).segWobblePhaseDiffZ,
                       (*this).segWobbleZTarget, 1.0f32, 0.01f32);
        Math_ApproachF(&mut (*this).pulseSize, (*this).pulseSizeTarget,
                       1.0f32, 0.0015f32);
        Math_ApproachF(&mut (*this).wobbleSize, (*this).wobbleSizeTarget,
                       1.0f32, 20.0f32);
        i = 0 as libc::c_int;
        while i < 5 as libc::c_int {
            Math_SmoothStepToS(&mut (*(*this).bodySegs.as_mut_ptr().offset(i
                                                                               as
                                                                               isize)).rot.x,
                               (*this).bodySegs[i as usize].rotTarget.x as
                                   s16, 5 as libc::c_int as s16,
                               ((*this).segMoveRate * 1000.0f32) as s16,
                               0 as libc::c_int as s16);
            Math_SmoothStepToS(&mut (*(*this).bodySegs.as_mut_ptr().offset(i
                                                                               as
                                                                               isize)).rot.z,
                               (*this).bodySegs[i as usize].rotTarget.z as
                                   s16, 5 as libc::c_int as s16,
                               ((*this).segMoveRate * 1000.0f32) as s16,
                               0 as libc::c_int as s16);
            Math_ApproachF(&mut (*(*this).bodySegs.as_mut_ptr().offset(i as
                                                                           isize)).scale.x,
                           (*this).bodySegs[i as usize].scaleTarget.x, 1.0f32,
                           (*this).segMoveRate * 0.2f32);
            (*this).bodySegs[i as usize].scale.z =
                (*this).bodySegs[i as usize].scale.x;
            Math_ApproachF(&mut (*(*this).bodySegs.as_mut_ptr().offset(i as
                                                                           isize)).height,
                           (*this).bodySegs[i as usize].heightTarget, 1.0f32,
                           (*this).segMoveRate * 300.0f32);
            i += 1
        }
        Math_ApproachF(&mut (*this).segMoveRate, 1.0f32, 1.0f32, 0.2f32);
    };
}
static mut sEffectOffsets: [Vec3f; 4] =
    [{ let mut init = Vec3f{x: 25.0f32, y: 0.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: -25.0f32, y: 0.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 25.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: -25.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnRr_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut zeroVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut this: *mut EnRr = thisx as *mut EnRr;
    let mut i: s32 = 0;
    let mut segMtx: *mut Mtx =
    ...
    (*_g).words.w1 = segMtx as libc::c_uint;
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ((*this).scrollTimer as libc::c_int *
                              0 as libc::c_int & 0x7f as libc::c_int) as
                             u32_0,
                         ((*this).scrollTimer as libc::c_int *
                              0 as libc::c_int & 0x3f as libc::c_int) as
                             u32_0, 32 as libc::c_int, 16 as libc::c_int,
                         1 as libc::c_int,
                         ((*this).scrollTimer as libc::c_int *
                              0 as libc::c_int & 0x3f as libc::c_int) as
                             u32_0,
                         ((*this).scrollTimer as libc::c_int *
                              -(6 as libc::c_int) & 0x7f as libc::c_int) as
                             u32_0, 32 as libc::c_int, 16 as libc::c_int) as
            libc::c_uint;
    Matrix_Push();
    Matrix_Scale((1.0f32 +
                      (*this).bodySegs[0 as libc::c_int as usize].scaleMod.x)
                     * (*this).bodySegs[0 as libc::c_int as usize].scale.x,
                 (1.0f32 +
                      (*this).bodySegs[0 as libc::c_int as usize].scaleMod.y)
                     * (*this).bodySegs[0 as libc::c_int as usize].scale.y,
                 (1.0f32 +
                      (*this).bodySegs[0 as libc::c_int as usize].scaleMod.z)
                     * (*this).bodySegs[0 as libc::c_int as usize].scale.z,
    ...
    (*_g_1).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_rr.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 1501 as libc::c_int) as
            libc::c_uint;
    Matrix_Pop();
    zeroVec.x = 0.0f32;
    zeroVec.y = 0.0f32;
    ...
    while i < 5 as libc::c_int {
        Matrix_Translate(0.0f32,
                         (*this).bodySegs[i as usize].height + 1000.0f32,
                         0.0f32, MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZYX((*this).bodySegs[i as usize].rot.x,
                         (*this).bodySegs[i as usize].rot.y,
                         (*this).bodySegs[i as usize].rot.z,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Push();
        Matrix_Scale((1.0f32 + (*this).bodySegs[i as usize].scaleMod.x) *
                         (*this).bodySegs[i as usize].scale.x,
                     (1.0f32 + (*this).bodySegs[i as usize].scaleMod.y) *
                         (*this).bodySegs[i as usize].scale.y,
                     (1.0f32 + (*this).bodySegs[i as usize].scaleMod.z) *
                         (*this).bodySegs[i as usize].scale.z,
                     MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_ToMtx(segMtx,
                     b"../z_en_rr.c\x00" as *const u8 as *const libc::c_char
                         as *mut libc::c_char, 1527 as libc::c_int);
        Matrix_Pop();
        segMtx = segMtx.offset(1);
        Matrix_MultVec3f(&mut zeroVec,
                         &mut *(*this).effectPos.as_mut_ptr().offset(i as
                                                                         isize));
        i += 1
    }
    (*this).effectPos[0 as libc::c_int as usize] = (*this).actor.world.pos;
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gLikeLikeDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_rr.c\x00" as *const u8 as *const libc::c_char,
                     1551 as libc::c_int);
    if (*this).effectTimer as libc::c_int != 0 as libc::c_int {
        let mut effectPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
        let mut effectTimer: s16 =
            ((*this).effectTimer as libc::c_int - 1 as libc::c_int) as s16;
        (*this).actor.colorFilterTimer =
            (*this).actor.colorFilterTimer.wrapping_add(1);
        if effectTimer as libc::c_int & 1 as libc::c_int == 0 as libc::c_int {
            let mut segIndex: s32 =
                4 as libc::c_int -
                    (effectTimer as libc::c_int >> 2 as libc::c_int);
            let mut offIndex: s32 =
                effectTimer as libc::c_int >> 1 as libc::c_int &
                    3 as libc::c_int;
            effectPos.x =
                (*this).effectPos[segIndex as usize].x +
                    sEffectOffsets[offIndex as usize].x +
                    Rand_CenteredFloat(10.0f32);
            effectPos.y =
                (*this).effectPos[segIndex as usize].y +
                    sEffectOffsets[offIndex as usize].y +
                    Rand_CenteredFloat(10.0f32);
            effectPos.z =
                (*this).effectPos[segIndex as usize].z +
                    sEffectOffsets[offIndex as usize].z +
                    Rand_CenteredFloat(10.0f32);
            if (*this).actor.colorFilterParams as libc::c_int &
                   0x4000 as libc::c_int != 0 {
                ...
                EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).actor,
                                               &mut effectPos,
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x37 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
