...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct FireActorF {
    pub actor: Actor,
    pub firePos: [Vec3f; 10],
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct FireActorS {
    pub actor: Actor,
    pub firePos: [Vec3s; 10],
}
#[no_mangle]
pub static mut Effect_Ss_En_Fire_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_EN_FIRE as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsEnFire_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnFire_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsEnFireInitParams =
        initParamsx as *mut EffectSsEnFireInitParams;
    ...
    (*this).regs[2 as libc::c_int as usize] = (*this).life;
    (*this).actor = (*initParams).actor;
    (*this).regs[9 as libc::c_int as usize] =
        (Rand_ZeroOne() * 20.0f32) as s16;
    (*this).draw =
        Some(EffectSsEnFire_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsEnFire_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[3 as libc::c_int as usize] = -(15 as libc::c_int) as s16;
    if ((*initParams).bodyPart as libc::c_int) < 0 as libc::c_int {
        (*this).regs[5 as libc::c_int as usize] =
            (Math_Vec3f_Yaw(&mut (*(*initParams).actor).world.pos,
                            &mut (*initParams).pos) as libc::c_int -
                 (*(*initParams).actor).shape.rot.y as libc::c_int) as s16;
        (*this).regs[4 as libc::c_int as usize] =
            (Math_Vec3f_Pitch(&mut (*(*initParams).actor).world.pos,
                              &mut (*initParams).pos) as libc::c_int -
                 (*(*initParams).actor).shape.rot.x as libc::c_int) as s16;
        (*this).vec.z =
            Math_Vec3f_DistXYZ(&mut (*initParams).pos,
                               &mut (*(*initParams).actor).world.pos)
    }
    (*this).regs[0 as libc::c_int as usize] = (*initParams).scale;
    if (*initParams).unk_12 as libc::c_int & 0x8000 as libc::c_int !=
           0 as libc::c_int {
    ...
    (*this).regs[6 as libc::c_int as usize] =
        ((*initParams).unk_12 as libc::c_int & 0x7fff as libc::c_int) as s16;
    (*this).regs[7 as libc::c_int as usize] = (*initParams).bodyPart;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).flags;
    return 1 as libc::c_int as u32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnFire_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut scale: f32_0 = 0.;
    let mut camYaw: s16 = 0;
    let mut pad: [s32; 3] = [0; 3];
    let mut redGreen: s16 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_en_fire.c\x00" as *const u8 as
                        *const libc::c_char, 169 as libc::c_int);
    ...
    redGreen = ((*this).life as libc::c_int - 5 as libc::c_int) as s16;
    if (redGreen as libc::c_int) < 0 as libc::c_int {
        redGreen = 0 as libc::c_int as s16
    }
    ...
    (*_g_0).words.w0 =
        (0xfb as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int;
    (*_g_0).words.w1 =
        ((redGreen as libc::c_int as libc::c_float * 12.7f32) as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
    ...
    (*_g_2).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         ((*this).regs[9 as libc::c_int as usize] as
                              libc::c_int * -(0x14 as libc::c_int) &
                              0x1ff as libc::c_int) as u32_0,
                         0x20 as libc::c_int, 0x80 as libc::c_int) as
            libc::c_uint;
    if (*this).regs[8 as libc::c_int as usize] as libc::c_int &
           0x7fff as libc::c_int != 0 as libc::c_int ||
           ((*this).life as libc::c_int) < 18 as libc::c_int {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_3).words.w1 = gEffFire2DL.as_mut_ptr() as libc::c_uint
    } else {
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_eff_en_fire.c\x00" as *const u8 as
                         *const libc::c_char, 213 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EffectSsEnFire_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    (*this).regs[9 as libc::c_int as usize] += 1;
    if !(*this).actor.is_null() {
        if (*(*this).actor).colorFilterTimer as libc::c_int >=
               22 as libc::c_int {
            (*this).life += 1
        }
        if (*(*this).actor).update.is_some() {
            Math_SmoothStepToS(&mut *(*this).regs.as_mut_ptr().offset(1 as
                                                                          libc::c_int
                                                                          as
                                                                          isize),
                               (*this).regs[0 as libc::c_int as usize],
                               1 as libc::c_int as s16,
                               ((*this).regs[0 as libc::c_int as usize] as
            ...
            if ((*this).regs[7 as libc::c_int as usize] as libc::c_int) <
                ...
                Matrix_Translate((*(*this).actor).world.pos.x,
                                 ...
                                 MTXMODE_NEW as libc::c_int as u8_0);
                Matrix_RotateY(((*this).regs[5 as libc::c_int as usize] as
                                    libc::c_int +
                                   ...
                                   (3.14159265358979323846f32 /
                                        0x8000 as libc::c_int as
                                            libc::c_float),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_RotateX(((*this).regs[4 as libc::c_int as usize] as
                                    libc::c_int +
                                    (*(*this).actor).shape.rot.x as
                                        libc::c_int) as libc::c_float *
                                   (3.14159265358979323846f32 /
                                        0x8000 as libc::c_int as
                                            libc::c_float),
                               MTXMODE_APPLY as libc::c_int as u8_0);
                Matrix_MultVec3f(&mut (*this).vec, &mut (*this).pos);
            } else if (*this).regs[8 as libc::c_int as usize] as libc::c_int &
                          0x8000 as libc::c_int != 0 {
                (*this).pos.x =
                    (*((*this).actor as
                           *mut FireActorS)).firePos[(*this).regs[7 as
                                                                      libc::c_int
                                                                      as
                                                                      usize]
                                                         as usize].x as f32_0;
                ...
                (*this).pos.x =
                    (*((*this).actor as
                           *mut FireActorF)).firePos[(*this).regs[7 as
                                                                      libc::c_int
                                                                      as
                                                                      usize]
                                                         as usize].x;
        ...
        } else if (*this).regs[6 as libc::c_int as usize] as libc::c_int !=
                      0 as libc::c_int {
            (*this).life = 0 as libc::c_int as s16
        } else { (*this).actor = 0 as *mut Actor }
    };
}
