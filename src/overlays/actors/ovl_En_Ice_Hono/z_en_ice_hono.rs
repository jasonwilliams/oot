...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnIceHono {
    pub actor: Actor,
    pub actionFunc: EnIceHonoActionFunc,
    pub alpha: s16,
    pub timer: s16,
    pub unk_154: s16,
    pub unk_156: s16,
    pub smallFlameTargetYScale: f32_0,
    pub collider: ColliderCylinder,
    pub lightNode: *mut LightNode,
    pub lightInfo: LightInfo,
}
pub type EnIceHonoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnIceHono, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Ice_Hono_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ICE_HONO as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnIceHono_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnIceHono_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sCylinderInitCapturableFlame: ColliderCylinderInit =
    {
        let mut init =
...
static mut sCylinderInitDroppedFlame: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sInitChainCapturableFlame: [InitChainEntry; 5] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 5];
// Initialized in run_static_initializers
static mut sInitChainDroppedFlame: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
// Initialized in run_static_initializers
static mut sInitChainSmallFlame: [InitChainEntry; 3] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 3];
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_XZDistanceSquared(mut v1: *mut Vec3f,
                                                     mut v2: *mut Vec3f)
 -> f32_0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_InitCapturableFlame(mut thisx: *mut Actor,
                                                       mut globalCtx:
                                                           *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    Actor_ProcessInitChain(&mut (*this).actor,
                           sInitChainCapturableFlame.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 0.0074f32);
    (*this).actor.flags |=
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInitCapturableFlame);
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_InitDroppedFlame(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    Actor_ProcessInitChain(&mut (*this).actor,
                           sInitChainDroppedFlame.as_mut_ptr());
    (*this).actor.scale.y = 0.00002f32;
    ...
    (*this).actor.shape.rot.z = (*this).actor.world.rot.x;
    (*this).actor.shape.rot.y = (*this).actor.shape.rot.z;
    (*this).actor.shape.rot.x = (*this).actor.shape.rot.y;
    Collider_InitCylinder(globalCtx, &mut (*this).collider);
    Collider_SetCylinder(globalCtx, &mut (*this).collider, &mut (*this).actor,
                         &mut sCylinderInitDroppedFlame);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
    (*this).collider.dim.radius = ((*this).actor.scale.x * 4000.4f32) as s16;
    (*this).collider.dim.height = ((*this).actor.scale.y * 8000.2f32) as s16;
    (*this).actor.colChkInfo.mass = 253 as libc::c_int as u8_0;
    EnIceHono_SetupActionDroppedFlame(this);
}
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_InitSmallFlame(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    Actor_ProcessInitChain(&mut (*this).actor,
                           sInitChainSmallFlame.as_mut_ptr());
    (*this).actor.scale.y = 0.0008f32;
    (*this).actor.scale.z = (*this).actor.scale.y;
    (*this).actor.scale.x = (*this).actor.scale.z;
    (*this).actor.gravity = -0.3f32;
    (*this).actor.minVelocityY = -4.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    let mut params: s16 = (*this).actor.params;
    match (*this).actor.params as libc::c_int {
        -1 => {
            EnIceHono_InitCapturableFlame(&mut (*this).actor, globalCtx);
        }
        0 => { EnIceHono_InitDroppedFlame(&mut (*this).actor, globalCtx); }
        1 | 2 => { EnIceHono_InitSmallFlame(&mut (*this).actor, globalCtx); }
        _ => { }
    }
    if (*this).actor.params as libc::c_int == -(1 as libc::c_int) ||
        ...
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                                  ...
                                  ((*this).actor.world.pos.y as s16 as
                                      ...
                                      s16, (*this).actor.world.pos.z as s16,
                                  155 as libc::c_int as u8_0,
                                  210 as libc::c_int as u8_0,
        ...
        (*this).unk_154 =
            (Rand_ZeroOne() *
                 (0x1ffff as libc::c_int as libc::c_float / 2.0f32)) as s16;
        (*this).unk_156 =
            (Rand_ZeroOne() *
                 (0x1ffff as libc::c_int as libc::c_float / 2.0f32)) as s16;
        osSyncPrintf(b"(ice \xe7\x82\x8e)(arg_data 0x%04x)\n\x00" as *const u8
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    if (*this).actor.params as libc::c_int == -(1 as libc::c_int) ||
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_InBottleRange(mut this: *mut EnIceHono,
                                                 mut globalCtx:
                                                     *mut GlobalContext)
 -> u32_0 {
    ...
    if (*this).actor.xzDistToPlayer < 60.0f32 {
        ...
        tempPos.x =
            Math_SinS(((*this).actor.yawTowardsPlayer as libc::c_int +
                           0x8000 as libc::c_int) as s16) * 40.0f32 +
        ...
        // ! world rotation.
        if EnIceHono_XZDistanceSquared(&mut tempPos,
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SetupActionCapturableFlame(mut this:
                                                                  *mut EnIceHono) {
    (*this).actionFunc =
        Some(EnIceHono_CapturableFlame as
                 unsafe extern "C" fn(_: *mut EnIceHono,
                                      _: *mut GlobalContext) -> ());
    (*this).alpha = 255 as libc::c_int as s16;
    (*this).actor.shape.yOffset = -1000.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_CapturableFlame(mut this: *mut EnIceHono,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actor.parent = 0 as *mut Actor
    } else if EnIceHono_InBottleRange(this, globalCtx) != 0 {
        // GI_MAX in this case allows the player to catch the actor in a bottle
        func_8002F434(&mut (*this).actor, globalCtx, GI_MAX as libc::c_int,
                      60.0f32, 100.0f32);
    }
    ...
    func_8002F8F0(&mut (*this).actor,
                  (0x28a3 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SetupActionDroppedFlame(mut this:
                                                               *mut EnIceHono) {
    (*this).actionFunc =
        Some(EnIceHono_DropFlame as
                 unsafe extern "C" fn(_: *mut EnIceHono,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_DropFlame(mut this: *mut EnIceHono,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut bgFlag: u32_0 =
        ((*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int) as
            u32_0;
    Math_StepToF(&mut (*this).actor.scale.x, 0.0017f32, 0.00008f32);
    (*this).actor.scale.z = (*this).actor.scale.x;
    Math_StepToF(&mut (*this).actor.scale.y, 0.0017f32, 0.00008f32);
    if bgFlag != 0 as libc::c_int as libc::c_uint {
        let mut i: s32 = 0;
        i = 0 as libc::c_int;
        while i < 8 as libc::c_int {
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_ICE_HONO as libc::c_int as s16,
                        (*this).actor.world.pos.x, (*this).actor.world.pos.y,
                        (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                        ((Rand_ZeroOne() * 1000.0f32) as s32 +
                             i * 0x2000 as libc::c_int - 0x1f4 as libc::c_int)
    ...
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32,
                            (*this).actor.scale.x * 3500.0f32, 0.0f32,
                            5 as libc::c_int);
    Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
    (*this).collider.dim.radius = ((*this).actor.scale.x * 4000.0f32) as s16;
    (*this).collider.dim.height = ((*this).actor.scale.y * 8000.0f32) as s16;
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider.base);
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SetupActionSpreadFlames(mut this:
                                                               *mut EnIceHono) {
    (*this).actionFunc =
        Some(EnIceHono_SpreadFlames as
                 unsafe extern "C" fn(_: *mut EnIceHono,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SpreadFlames(mut this: *mut EnIceHono,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if (*this).timer as libc::c_int > 20 as libc::c_int {
        Math_StepToF(&mut (*this).actor.scale.x, 0.011f32, 0.00014f32);
        Math_StepToF(&mut (*this).actor.scale.y, 0.006f32, 0.00012f32);
    } else {
        Math_StepToF(&mut (*this).actor.scale.x, 0.0001f32, 0.00015f32);
        Math_StepToF(&mut (*this).actor.scale.y, 0.0001f32, 0.00015f32);
    }
    (*this).actor.scale.z = (*this).actor.scale.x;
    Actor_MoveForward(&mut (*this).actor);
    Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32,
                            (*this).actor.scale.x * 3500.0f32, 0.0f32,
                            4 as libc::c_int);
    if ((*this).timer as libc::c_int) < 25 as libc::c_int {
        (*this).alpha =
            ((*this).alpha as libc::c_int - 10 as libc::c_int) as s16;
        (*this).alpha =
    ...
    if (*this).alpha as libc::c_int > 100 as libc::c_int &&
           ((*this).timer as libc::c_int) < 40 as libc::c_int {
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).collider);
        (*this).collider.dim.radius =
            ((*this).actor.scale.x * 6000.0f32) as s16;
        (*this).collider.dim.height =
            ((*this).actor.scale.y * 8000.0f32) as s16;
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider.base);
    }
    if (*this).timer as libc::c_int == 46 as libc::c_int {
        let mut i: s32 = 0;
        i = 0 as libc::c_int;
        while i < 10 as libc::c_int {
            let mut rot: s32 = i * 0x1999 as libc::c_int;
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_ICE_HONO as libc::c_int as s16,
                        (*this).actor.world.pos.x, (*this).actor.world.pos.y,
                        (*this).actor.world.pos.z, 0 as libc::c_int as s16,
                        ((Rand_ZeroOne() * 1000.0f32) as s32 + rot -
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SetupActionSmallFlame(mut this:
                                                             *mut EnIceHono) {
    (*this).actionFunc =
        Some(EnIceHono_SmallFlameMove as
                 unsafe extern "C" fn(_: *mut EnIceHono,
                                      _: *mut GlobalContext) -> ());
    (*this).timer = 44 as libc::c_int as s16;
    (*this).alpha = 255 as libc::c_int as s16;
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        (*this).smallFlameTargetYScale = Rand_ZeroOne() * 0.005f32 + 0.004f32;
        (*this).actor.speedXZ = Rand_ZeroOne() * 1.6f32 + 0.5f32
    } else {
        (*this).smallFlameTargetYScale = Rand_ZeroOne() * 0.005f32 + 0.003f32;
        (*this).actor.speedXZ = Rand_ZeroOne() * 2.0f32 + 0.5f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_SmallFlameMove(mut this: *mut EnIceHono,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if (*this).timer as libc::c_int > 20 as libc::c_int {
        Math_StepToF(&mut (*this).actor.scale.x, 0.006f32, 0.00016f32);
        Math_StepToF(&mut (*this).actor.scale.y,
                     (*this).smallFlameTargetYScale * 0.667f32, 0.00014f32);
    } else {
        Math_StepToF(&mut (*this).actor.scale.x, 0.0001f32, 0.00015f32);
        Math_StepToF(&mut (*this).actor.scale.y, 0.0001f32, 0.00015f32);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    let mut pad1: s32 = 0;
    let mut intensity: f32_0 = 0.;
    let mut pad2: s32 = 0;
    let mut sin154: f32_0 = 0.;
    let mut sin156: f32_0 = 0.;
    if (*this).timer as libc::c_int > 0 as libc::c_int { (*this).timer -= 1 }
    if (*this).actor.params as libc::c_int == 0 as libc::c_int {
        func_8002F8F0(&mut (*this).actor,
                      (0x1848 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    }
    if (*this).actor.params as libc::c_int == -(1 as libc::c_int) ||
           (*this).actor.params as libc::c_int == 0 as libc::c_int {
        (*this).unk_154 =
            ((*this).unk_154 as libc::c_int + 0x1111 as libc::c_int) as s16;
        (*this).unk_156 =
            ((*this).unk_156 as libc::c_int + 0x4000 as libc::c_int) as s16;
        sin156 = Math_SinS((*this).unk_156);
        sin154 = Math_SinS((*this).unk_154);
        intensity =
            Rand_ZeroOne() * 0.05f32 + (sin154 * 0.125f32 + sin156 * 0.1f32) +
                0.425f32;
        if intensity > 0.7f32 || intensity < 0.2f32 {
            osSyncPrintf(b"\xe3\x81\x82\xe3\x82\x8a\xe3\x81\x88\xe3\x81\xaa\xe3\x81\x84\xe5\x80\xa4(ratio = %f)\n\x00"
                             as *const u8 as *const libc::c_char,
                         intensity as libc::c_double);
        ...
        Lights_PointNoGlowSetInfo(&mut (*this).lightInfo,
                                  ...
                                  ((*this).actor.world.pos.y as s16 as
                                       libc::c_int + 10 as libc::c_int) as
                                      s16, (*this).actor.world.pos.z as s16,
                                  (155.0f32 * intensity) as s32 as u8_0,
                                  (210.0f32 * intensity) as s32 as u8_0,
                                  (255.0f32 * intensity) as s32 as u8_0,
                                  1400 as libc::c_int as s16);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnIceHono_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnIceHono = thisx as *mut EnIceHono;
    let mut pad: u32_0 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_ice_hono.c\x00" as *const u8 as
    ...
    sInitChainCapturableFlame =
        [{
         ...
         },
         {
             ...
             init.set_value(60 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
