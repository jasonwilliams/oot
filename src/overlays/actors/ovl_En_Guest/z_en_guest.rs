...
extern "C" {
    ...
    #[no_mangle]
    static mut object_boj_Skel_0000F0: FlexSkeletonHeader;
}
...
pub struct EnGuest {
    ...
    pub actionFunc: EnGuestActionFunc,
    pub collider: ColliderCylinder,
    pub unk_2A0: struct_80034A14_arg1,
    pub unk_2C8: s16,
    pub unk_2CA: s16,
    pub unk_2CC: [s16; 16],
    pub unk_2EC: [s16; 16],
...
pub type EnGuestActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGuest, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Guest_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GUEST as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BOJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnGuest>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGuest_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnGuest_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGuest = thisx as *mut EnGuest;
    if gSaveContext.infTable[7 as libc::c_int as usize] as libc::c_int &
        ...
        if ((*this).osAnimeBankIndex as libc::c_int) < 0 as libc::c_int {
            ...
            osSyncPrintf(b"%s[%d] : \xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x81\x8c\xe7\x84\xa1\xe3\x81\x84\xe3\x82\x88\xef\xbc\x81\xef\xbc\x81\n\x00"
                         ...
                         b"../z_en_guest.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnGuest_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGuest = thisx as *mut EnGuest;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnGuest_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGuest = thisx as *mut EnGuest;
    let mut pad: s32 = 0;
    if Object_IsLoaded(&mut (*globalCtx).objectCtx,
                       (*this).osAnimeBankIndex as s32) != 0 as libc::c_int {
        (*this).actor.flags &=
        ...
        gSegments[6 as libc::c_int as usize] =
            ((*globalCtx).objectCtx.status[(*this).osAnimeBankIndex as
                ...
                u32_0;
        Animation_Change(&mut (*this).skelAnime, &mut gObjOsAnim_42AC, 1.0f32,
                         0.0f32,
                         Animation_GetLastFrame(&mut gObjOsAnim_42AC as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, ANIMMODE_LOOP as libc::c_int as u8_0,
                         0.0f32);
        (*this).actor.draw =
            Some(EnGuest_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        (*this).actor.update =
            Some(func_80A505CC as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ());
        ...
        (*this).unk_30E = 0 as libc::c_int as u8_0;
        (*this).unk_30D = 0 as libc::c_int as u8_0;
        (*this).unk_2CA = 0 as libc::c_int as s16;
        (*this).actor.textId = 0x700d as libc::c_int as u16_0;
        (*this).actionFunc =
            Some(func_80A50518 as
                     unsafe extern "C" fn(_: *mut EnGuest,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A5046C(mut this: *mut EnGuest) {
    if (*this).unk_30D as libc::c_int == 0 as libc::c_int {
        if (*this).unk_2CA as libc::c_int != 0 as libc::c_int {
            (*this).unk_2CA -= 1
        } else { (*this).unk_30D = 1 as libc::c_int as u8_0 }
    } else if (*this).unk_2CA as libc::c_int != 0 as libc::c_int {
        (*this).unk_2CA -= 1
    } else {
        (*this).unk_30E =
            ((*this).unk_30E as libc::c_int + 1 as libc::c_int) as u8_0;
        if (*this).unk_30E as libc::c_int >= 3 as libc::c_int {
            (*this).unk_30E = 0 as libc::c_int as u8_0;
            (*this).unk_30D = 0 as libc::c_int as u8_0;
            (*this).unk_2CA =
                (Rand_ZeroFloat(60.0f32) as s32 + 20 as libc::c_int) as s16
        } else { (*this).unk_2CA = 1 as libc::c_int as s16 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A50518(mut this: *mut EnGuest,
                                       mut globalCtx: *mut GlobalContext) {
    if Actor_ProcessTalkRequest(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(func_80A5057C as
                     unsafe extern "C" fn(_: *mut EnGuest,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80A5057C(mut this: *mut EnGuest,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A505CC(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnGuest = thisx as *mut EnGuest;
    let mut pad: s32 = 0;
    ...
    if gSaveContext.linkAge == 0 as libc::c_int {
        (*this).unk_2A0.unk_14 = 10.0f32
    } else { (*this).unk_2A0.unk_14 = 20.0f32 }
    func_80034A14(&mut (*this).actor, &mut (*this).unk_2A0,
                  6 as libc::c_int as s16, 2 as libc::c_int as s16);
    func_80034F54(globalCtx, (*this).unk_2CC.as_mut_ptr(),
                  (*this).unk_2EC.as_mut_ptr(), 16 as libc::c_int);
    gSegments[6 as libc::c_int as usize] =
        ((*globalCtx).objectCtx.status[(*this).osAnimeBankIndex as
                                           usize].segment as
             *mut u8_0).offset(-(0x80000000 as libc::c_uint as isize)) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A50708(mut gfxCtx: *mut GraphicsContext,
                                       mut r: u8_0, mut g: u8_0, mut b: u8_0,
                                       mut a: u8_0) -> *mut Gfx {
...
#[no_mangle]
pub unsafe extern "C" fn EnGuest_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnGuest = thisx as *mut EnGuest;
    let mut sp3C: Vec3s = Vec3s{x: 0, y: 0, z: 0,};
    ...
    if limbIndex == 15 as libc::c_int {
        *dList = object_boj_DL_0059B0.as_mut_ptr();
        Matrix_Translate(1400.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        sp3C = (*this).unk_2A0.unk_08;
        Matrix_RotateX(sp3C.y as libc::c_int as libc::c_float / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(sp3C.x as libc::c_int as libc::c_float / 32768.0f32 *
                           3.14159265358979323846f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_Translate(-1400.0f32, 0.0f32, 0.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
    ...
    if limbIndex == 8 as libc::c_int || limbIndex == 9 as libc::c_int ||
        ...
        (*rot).y =
            ((*rot).y as libc::c_float +
                 Math_SinS((*this).unk_2CC[limbIndex as usize]) * 200.0f32) as
                s16;
        (*rot).z =
            ((*rot).z as libc::c_float +
                 Math_CosS((*this).unk_2EC[limbIndex as usize]) * 200.0f32) as
                s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnGuest_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    static mut D_80A50BA4: [*mut libc::c_void; 3] =
        unsafe {
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        func_80A50708((*globalCtx).state.gfxCtx, 0xff as libc::c_int as u8_0,
                      0xff as libc::c_int as u8_0,
                      0xff as libc::c_int as u8_0,
                      0xff as libc::c_int as u8_0) as libc::c_uint;
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x9 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        func_80A50708((*globalCtx).state.gfxCtx, 0xa0 as libc::c_int as u8_0,
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0xa as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        gSegments[((D_80A50BA4[(*this).unk_30E as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(D_80A50BA4[(*this).unk_30E as usize]
                                              as u32_0 &
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnGuest_OverrideLimbDraw as
