...
extern "C" {
    ...
    fn Animation_Change(skelAnime: *mut SkelAnime,
                        ...
                        morphFrames: f32_0);
    #[no_mangle]
    fn Math3D_Dist2DSq(x0: f32_0, y0: f32_0, x1: f32_0, y1: f32_0) -> f32_0;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gBugCrawlAnim: AnimationHeader;
    #[no_mangle]
    static mut gBugSkel: SkeletonHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjMakekinsuta {
    pub actor: Actor,
    pub actionFunc: ObjMakekinsutaActionFunc,
    pub timer: s16,
    pub unk_152: s16,
}
pub type ObjMakekinsutaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut ObjMakekinsuta, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnInsect {
    ...
    pub jointTable: [Vec3s; 24],
    pub morphTable: [Vec3s; 24],
    pub actionFunc: EnInsectActionFunc,
    pub unk_314: u16_0,
    pub unk_316: s16,
    pub unk_318: s16,
    pub unk_31A: s16,
    pub unk_31C: s16,
    pub unk_31E: s16,
    pub soilActor: *mut ObjMakekinsuta,
    pub unk_324: f32_0,
    pub unk_328: s16,
    pub unk_32A: u8_0,
}
pub type EnInsectActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
               -> ()>;
static mut D_80A7DEB0: f32_0 = 0.0f32;
static mut D_80A7DEB4: s16 = 0 as libc::c_int as s16;
static mut D_80A7DEB8: s16 = 0 as libc::c_int as s16;
#[no_mangle]
pub static mut En_Insect_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_INSECT as libc::c_int as s16,
                          category:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnInsect_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnInsect_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColliderItemInit: [ColliderJntSphElementInit; 1] =
    [{
         let mut init =
...
static mut sColliderInit: ColliderJntSphInit =
    unsafe {
        {
            let mut init =
                ColliderJntSphInit{base:
                                   ...
                                   elements:
                                       sColliderItemInit.as_ptr() as *mut _,};
            init
        }
    };
static mut D_80A7DF10: [u16_0; 4] =
    [0 as libc::c_int as u16_0, 5 as libc::c_int as u16_0,
     7 as libc::c_int as u16_0, 7 as libc::c_int as u16_0];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
#[no_mangle]
pub unsafe extern "C" fn func_80A7BE20(mut this: *mut EnInsect) {
    (*this).unk_314 =
        D_80A7DF10[((*this).actor.params as libc::c_int & 3 as libc::c_int) as
                       usize];
}
#[no_mangle]
pub unsafe extern "C" fn EnInsect_XZDistanceSquared(mut v1: *mut Vec3f,
                                                    mut v2: *mut Vec3f)
 -> f32_0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnInsect_InBottleRange(mut this: *mut EnInsect,
                                                mut globalCtx:
                                                    *mut GlobalContext)
 -> s32 {
    let mut pad: s32 = 0;
    ...
    if (*this).actor.xzDistToPlayer < 32.0f32 {
        pos.x =
            Math_SinS(((*this).actor.yawTowardsPlayer as libc::c_int +
                           0x8000 as libc::c_int) as s16) * 16.0f32 +
                (*player).actor.world.pos.x;
        pos.y = (*player).actor.world.pos.y;
        pos.z =
            Math_CosS(((*this).actor.yawTowardsPlayer as libc::c_int +
                           0x8000 as libc::c_int) as s16) * 16.0f32 +
        ...
        // ! world rotation.
        if EnInsect_XZDistanceSquared(&mut pos, &mut (*this).actor.world.pos)
               <= 20.0f32 * 20.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7BF58(mut this: *mut EnInsect) {
    Animation_Change(&mut (*this).skelAnime, &mut gBugCrawlAnim, 1.0f32,
                     0.0f32, 0.0f32,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnInsect_FoundNearbySoil(mut this: *mut EnInsect,
                                                  mut globalCtx:
                                                      *mut GlobalContext)
 -> s32 {
    let mut currentActor: *mut Actor = 0 as *mut Actor; // Must be 'globalCtx'
    let mut currentDistance: f32_0 = 0.;
    let mut bestDistance: f32_0 = 0.;
    let mut ret: s32 = 0;
    ret = 0 as libc::c_int;
    currentActor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ITEMACTION as libc::c_int as
                                             usize].head;
    bestDistance = 6400.0f32;
    (*this).soilActor = 0 as *mut ObjMakekinsuta;
    while !currentActor.is_null() {
        if (*currentActor).id as libc::c_int ==
               ACTOR_OBJ_MAKEKINSUTA as libc::c_int {
            currentDistance =
                Math3D_Dist2DSq((*this).actor.world.pos.x,
                                (*this).actor.world.pos.z,
                                (*currentActor).world.pos.x,
                                (*currentActor).world.pos.z);
            if currentDistance < bestDistance &&
                   (*currentActor).room as libc::c_int ==
                       (*this).actor.room as libc::c_int {
                ret = 1 as libc::c_int;
                bestDistance = currentDistance;
                (*this).soilActor = currentActor as *mut ObjMakekinsuta
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7C058(mut this: *mut EnInsect) {
    if (*this).unk_31E as libc::c_int > 0 as libc::c_int {
        (*this).unk_31E -= 1;
        return
    }
    Audio_PlayActorSound2(&mut (*this).actor, 0x39f0 as libc::c_int as u16_0);
    (*this).unk_31E =
        (3.0f32 /
             (if (*this).skelAnime.playSpeed < 0.1f32 {
                  0.1f32
              } else { (*this).skelAnime.playSpeed })) as s16;
    if ((*this).unk_31E as libc::c_int) < 2 as libc::c_int {
        (*this).unk_31E = 2 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnInsect_Init(mut thisx: *mut Actor,
                                       mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnInsect = thisx as *mut EnInsect;
    ...
    func_80A7BE20(this);
    temp_s2 = ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gBugSkel,
                   &mut gBugCrawlAnim, (*this).jointTable.as_mut_ptr(),
    ...
    Collider_SetJntSph(globalCtx, &mut (*this).collider, &mut (*this).actor,
                       &mut sColliderInit, &mut (*this).colliderItem);
    (*this).actor.colChkInfo.mass = 30 as libc::c_int as u8_0;
    if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.gravity = -0.2f32;
        (*this).actor.minVelocityY = -2.0f32
    }
    if (*this).unk_314 as libc::c_int & 4 as libc::c_int != 0 {
        (*this).unk_31C =
            Rand_S16Offset(200 as libc::c_int as s16,
                           40 as libc::c_int as s16);
        (*this).actor.flags |=
            ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint
    }
    if temp_s2 as libc::c_int == 2 as libc::c_int ||
           temp_s2 as libc::c_int == 3 as libc::c_int {
        if EnInsect_FoundNearbySoil(this, globalCtx) != 0 {
            (*this).unk_314 =
                ((*this).unk_314 as libc::c_int | 0x10 as libc::c_int) as
                    u16_0;
            D_80A7DEB0 = 0.0f32
        }
        if temp_s2 as libc::c_int == 2 as libc::c_int {
            ...
            while count < 2 as libc::c_int {
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_INSECT as libc::c_int as s16,
        ...
        if rand < 0.3f32 {
            ...
            func_80A7C598(this);
        } else { func_80A7C818(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnInsect_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut temp_v0: s16 = 0;
    let mut this: *mut EnInsect = thisx as *mut EnInsect;
    temp_v0 = ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    Collider_DestroyJntSph(globalCtx, &mut (*this).collider);
    if (temp_v0 as libc::c_int == 2 as libc::c_int ||
            temp_v0 as libc::c_int == 3 as libc::c_int) &&
           D_80A7DEB8 as libc::c_int > 0 as libc::c_int {
        D_80A7DEB8 -= 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7C3A0(mut this: *mut EnInsect) {
    (*this).unk_31A =
        Rand_S16Offset(5 as libc::c_int as s16, 35 as libc::c_int as s16);
    func_80A7BF58(this);
    (*this).actionFunc =
        Some(func_80A7C3F4 as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 0x100 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7C3F4(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut sp2E: s16 = 0;
    let mut playSpeed: f32_0 = 0.;
    sp2E = ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32, 0.5f32,
                       0.0f32);
    playSpeed = Rand_ZeroOne() * 0.8f32 + (*this).actor.speedXZ * 1.2f32;
    (*this).skelAnime.playSpeed =
        if playSpeed < 0.0f32 {
            0.0f32
        } else if playSpeed > 1.9f32 { 1.9f32 } else { playSpeed };
    ...
    if (*this).unk_314 as libc::c_int & 4 as libc::c_int != 0 &&
           (*this).unk_31C as libc::c_int <= 0 as libc::c_int ||
           (sp2E as libc::c_int == 2 as libc::c_int ||
                sp2E as libc::c_int == 3 as libc::c_int) &&
               (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
               (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                   0 && D_80A7DEB8 as libc::c_int >= 4 as libc::c_int {
        func_80A7CBC8(this);
    } else if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
                  (*this).actor.bgCheckFlags as libc::c_int &
                      0x40 as libc::c_int != 0 {
        func_80A7CE60(this);
    } else if (*this).actor.xzDistToPlayer < 40.0f32 { func_80A7C818(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7C598(mut this: *mut EnInsect) {
    (*this).unk_31A =
        Rand_S16Offset(10 as libc::c_int as s16, 45 as libc::c_int as s16);
    func_80A7BF58(this);
    (*this).actionFunc =
        Some(func_80A7C5EC as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 0x100 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7C5EC(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut pad2: s32 = 0;
    let mut yaw: s16 = 0;
    let mut sp34: s16 =
        ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 1.5f32, 0.1f32, 0.5f32,
                       0.0f32);
    if EnInsect_XZDistanceSquared(&mut (*this).actor.world.pos,
                                  &mut (*this).actor.home.pos) > 1600.0f32 ||
           ((*this).unk_31A as libc::c_int) < 4 as libc::c_int {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
                           2000 as libc::c_int as s16);
    } else if !(*this).actor.child.is_null() &&
                  &mut (*this).actor as *mut Actor != (*this).actor.child {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*(*this).actor.child).world.pos);
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
                           2000 as libc::c_int as s16);
    }
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    (*this).skelAnime.playSpeed =
        if (*this).actor.speedXZ * 1.4f32 < 0.7f32 {
            0.7f32
        } else if (*this).actor.speedXZ * 1.4f32 > 1.9f32 {
            1.9f32
        } else { ((*this).actor.speedXZ) * 1.4f32 };
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_31A as libc::c_int <= 0 as libc::c_int {
        func_80A7C3A0(this);
    }
    if (*this).unk_314 as libc::c_int & 4 as libc::c_int != 0 &&
           (*this).unk_31C as libc::c_int <= 0 as libc::c_int ||
           (sp34 as libc::c_int == 2 as libc::c_int ||
                sp34 as libc::c_int == 3 as libc::c_int) &&
               (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
               (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int !=
                   0 && D_80A7DEB8 as libc::c_int >= 4 as libc::c_int {
        func_80A7CBC8(this);
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7C818(mut this: *mut EnInsect) {
    (*this).unk_31A =
        Rand_S16Offset(10 as libc::c_int as s16, 40 as libc::c_int as s16);
    func_80A7BF58(this);
    (*this).actionFunc =
        Some(func_80A7C86C as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 0x100 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7C86C(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad1: s32 = 0;
    let mut pad2: s32 = 0;
    let mut pad3: s16 = 0;
    let mut frames: s16 = 0;
    let mut yaw: s16 = 0;
    let mut sp38: s16 =
        ((*this).actor.xzDistToPlayer < 40.0f32) as libc::c_int as s16;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 1.8f32, 0.1f32, 0.5f32,
                       0.0f32);
    if EnInsect_XZDistanceSquared(&mut (*this).actor.world.pos,
                                  &mut (*this).actor.home.pos) > 25600.0f32 ||
           ((*this).unk_31A as libc::c_int) < 4 as libc::c_int {
        yaw =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
                           2000 as libc::c_int as s16);
    } else if sp38 as libc::c_int != 0 as libc::c_int {
        frames = (*globalCtx).state.frames as s16;
        yaw =
            ((*this).actor.yawTowardsPlayer as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        if frames as libc::c_int & 0x10 as libc::c_int != 0 {
            if frames as libc::c_int & 0x20 as libc::c_int != 0 {
                yaw = (yaw as libc::c_int + 0x2000 as libc::c_int) as s16
            }
        } else if frames as libc::c_int & 0x20 as libc::c_int != 0 {
            yaw = (yaw as libc::c_int - 0x2000 as libc::c_int) as s16
        }
        !globalCtx.is_null();
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y, yaw,
    ...
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    (*this).skelAnime.playSpeed =
        if (*this).actor.speedXZ * 1.6f32 < 0.8f32 {
            0.8f32
        } else if (*this).actor.speedXZ * 1.6f32 > 1.9f32 {
            1.9f32
        } else { ((*this).actor.speedXZ) * 1.6f32 };
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_31A as libc::c_int <= 0 as libc::c_int || sp38 == 0 {
        func_80A7C3A0(this);
    } else if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
                  (*this).actor.bgCheckFlags as libc::c_int &
                      0x40 as libc::c_int != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7CA64(mut this: *mut EnInsect) {
    (*this).unk_31A = 200 as libc::c_int as s16;
    Actor_SetScale(&mut (*this).actor, 0.001f32);
    (*this).actor.draw = None;
    (*this).actor.speedXZ = 0.0f32;
    func_80A7BF58(this);
    (*this).skelAnime.playSpeed = 0.3f32;
    (*this).actionFunc =
        Some(func_80A7CAD0 as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int & !(0x100 as libc::c_int)) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7CAD0(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_31A as libc::c_int == 20 as libc::c_int &&
           (*this).unk_314 as libc::c_int & 4 as libc::c_int == 0 {
        (*this).actor.draw =
            Some(EnInsect_Draw as
                     unsafe extern "C" fn(_: *mut Actor,
                                          _: *mut GlobalContext) -> ())
    } else if (*this).unk_31A as libc::c_int == 0 as libc::c_int {
        if (*this).unk_314 as libc::c_int & 4 as libc::c_int != 0 {
    ...
    } else if ((*this).unk_31A as libc::c_int) < 20 as libc::c_int {
        Actor_SetScale(&mut (*this).actor,
                       if (*this).actor.scale.x + 0.001f32 > 0.01f32 {
                           0.01f32
                       } else { ((*this).actor.scale.x) + 0.001f32 });
        SkelAnime_Update(&mut (*this).skelAnime);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7CBC8(mut this: *mut EnInsect) {
    (*this).unk_31A = 60 as libc::c_int as s16;
    func_80A7BF58(this);
    (*this).skelAnime.playSpeed = 1.9f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x39e9 as libc::c_int as u16_0);
    Math_Vec3f_Copy(&mut (*this).actor.home.pos,
                    &mut (*this).actor.world.pos);
    (*this).actionFunc =
        Some(func_80A7CC3C as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int & !(0x100 as libc::c_int)) as u16_0;
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 0x8 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7CC3C(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32, 0.5f32,
                       0.0f32);
    Math_StepToS(&mut (*this).actor.shape.rot.x, 10922 as libc::c_int as s16,
                 352 as libc::c_int as s16);
    Actor_SetScale(&mut (*this).actor,
                   if (*this).actor.scale.x - 0.0002f32 < 0.001f32 {
                       0.001f32
                   } else { ((*this).actor.scale.x) - 0.0002f32 });
    (*this).actor.shape.yOffset -= 0.8f32;
    (*this).actor.world.pos.x =
        Rand_ZeroOne() + (*this).actor.home.pos.x - 0.5f32;
    (*this).actor.world.pos.z =
        Rand_ZeroOne() + (*this).actor.home.pos.z - 0.5f32;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_31A as libc::c_int > 20 as libc::c_int &&
           Rand_ZeroOne() < 0.1f32 {
        velocity.x = Math_SinS((*this).actor.shape.rot.y) * -0.6f32;
        velocity.y = Math_SinS((*this).actor.shape.rot.x) * 0.6f32;
        velocity.z = Math_CosS((*this).actor.shape.rot.y) * -0.6f32;
        func_800286CC(globalCtx, &mut (*this).actor.world.pos, &mut velocity,
                      &mut accel, (Rand_ZeroOne() * 5.0f32 + 8.0f32) as s16,
                      (Rand_ZeroOne() * 5.0f32 + 8.0f32) as s16);
    }
    if (*this).unk_31A as libc::c_int <= 0 as libc::c_int {
        if (*this).unk_314 as libc::c_int & 0x10 as libc::c_int != 0 &&
               !(*this).soilActor.is_null() &&
               Math3D_Vec3fDistSq(&mut (*(*this).soilActor).actor.world.pos,
                                  &mut (*this).actor.world.pos) < 64.0f32 {
            (*(*this).soilActor).unk_152 = 1 as libc::c_int as s16
        }
        Actor_Kill(&mut (*this).actor);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7CE60(mut this: *mut EnInsect) {
    (*this).unk_31A =
        Rand_S16Offset(120 as libc::c_int as s16, 50 as libc::c_int as s16);
    func_80A7BF58(this);
    (*this).unk_318 = 0 as libc::c_int as s16;
    (*this).unk_316 = (*this).unk_318;
    (*this).actionFunc =
        Some(func_80A7CEC0 as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int & !(0x100 as libc::c_int)) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7CEC0(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut phi_v0_2: s32 = 0;
    sp4E = ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    if (*this).unk_31A as libc::c_int >= 81 as libc::c_int {
        Math_StepToF(&mut (*this).actor.speedXZ, 0.6f32, 0.08f32);
    } else { Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.02f32); }
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.world.pos.y += (*this).actor.yDistToWater;
    (*this).skelAnime.playSpeed =
        if (*this).unk_31A as libc::c_int as libc::c_float * 0.018f32 < 0.1f32
           {
            0.1f32
        } else if (*this).unk_31A as libc::c_int as libc::c_float * 0.018f32 >
                      1.9f32 {
            1.9f32
        } else {
            ((*this).unk_31A as libc::c_int as libc::c_float) * 0.018f32
        };
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_31A as libc::c_int >= 81 as libc::c_int {
        (*this).unk_316 =
            ((*this).unk_316 as libc::c_int +
                 Rand_S16Offset(-(50 as libc::c_int) as s16,
                                100 as libc::c_int as s16) as libc::c_int) as
                s16;
        (*this).unk_318 =
            ((*this).unk_318 as libc::c_int +
                 Rand_S16Offset(-(300 as libc::c_int) as s16,
                                600 as libc::c_int as s16) as libc::c_int) as
                s16
    }
    temp_v1 = ((*this).skelAnime.playSpeed * 200.0f32) as s16;
    if ((*this).unk_316 as libc::c_int) < -(temp_v1 as libc::c_int) {
        (*this).unk_316 = -(temp_v1 as libc::c_int) as s16
    } else {
        if (temp_v1 as libc::c_int) < (*this).unk_316 as libc::c_int {
            phi_v0 = temp_v1 as s32
        } else { phi_v0 = (*this).unk_316 as s32 }
        (*this).unk_316 = phi_v0 as s16
    }
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int +
             (*this).unk_316 as libc::c_int) as s16;
    temp_v1 = ((*this).skelAnime.playSpeed * 1000.0f32) as s16;
    if ((*this).unk_318 as libc::c_int) < -(temp_v1 as libc::c_int) {
        (*this).unk_318 = -(temp_v1 as libc::c_int) as s16
    } else {
        if (temp_v1 as libc::c_int) < (*this).unk_318 as libc::c_int {
            phi_v0_2 = temp_v1 as s32
        } else { phi_v0_2 = (*this).unk_318 as s32 }
        (*this).unk_318 = phi_v0_2 as s16
    }
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int +
             (*this).unk_318 as libc::c_int) as s16;
    Math_ScaledStepToS(&mut (*this).actor.world.rot.x,
                       0 as libc::c_int as s16, 3000 as libc::c_int as s16);
    (*this).actor.shape.rot.x = (*this).actor.world.rot.x;
    if Rand_ZeroOne() < 0.03f32 {
        sp40.x = (*this).actor.world.pos.x;
        sp40.y = (*this).actor.world.pos.y + (*this).actor.yDistToWater;
        sp40.z = (*this).actor.world.pos.z;
        EffectSsGRipple_Spawn(globalCtx, &mut sp40, 20 as libc::c_int as s16,
                              100 as libc::c_int as s16,
                              4 as libc::c_int as s16);
        EffectSsGRipple_Spawn(globalCtx, &mut sp40, 40 as libc::c_int as s16,
    ...
    if (*this).unk_31A as libc::c_int <= 0 as libc::c_int ||
           (*this).unk_314 as libc::c_int & 4 as libc::c_int != 0 &&
               (*this).unk_31C as libc::c_int <= 0 as libc::c_int ||
           (sp4E as libc::c_int == 2 as libc::c_int ||
                sp4E as libc::c_int == 3 as libc::c_int) &&
               (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
               D_80A7DEB8 as libc::c_int >= 4 as libc::c_int {
        func_80A7D1F4(this);
    } else if (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int
                  == 0 {
        if (*this).unk_314 as libc::c_int & 0x10 as libc::c_int != 0 {
            func_80A7D39C(this);
        } else { func_80A7C3A0(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7D1F4(mut this: *mut EnInsect) {
    (*this).unk_31A = 100 as libc::c_int as s16;
    func_80A7BF58(this);
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.minVelocityY = -0.8f32;
    (*this).actor.gravity = -0.04f32;
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int & !(0x3 as libc::c_int)) as u16_0;
    (*this).actionFunc =
        Some(func_80A7D26C as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int & !(0x100 as libc::c_int)) as u16_0;
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 8 as libc::c_int) as u16_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A7D26C(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int - 500 as libc::c_int) as
            s16;
    (*this).actor.shape.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 200 as libc::c_int) as
            s16;
    Actor_SetScale(&mut (*this).actor,
                   if (*this).actor.scale.x - 0.00005f32 < 0.001f32 {
                       0.001f32
                   } else { ((*this).actor.scale.x) - 0.00005f32 });
    if (*this).actor.yDistToWater > 5.0f32 &&
           (*this).actor.yDistToWater < 30.0f32 && Rand_ZeroOne() < 0.3f32 {
        EffectSsBubble_Spawn(globalCtx, &mut (*this).actor.world.pos, -5.0f32,
                             5.0f32, 5.0f32,
                             Rand_ZeroOne() * 0.04f32 + 0.02f32);
    }
    if (*this).unk_31A as libc::c_int <= 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7D39C(mut this: *mut EnInsect) {
    func_80A7BF58(this);
    (*this).unk_31A = 100 as libc::c_int as s16;
    (*this).unk_324 = 1.5f32;
    (*this).unk_328 =
        (Rand_ZeroOne() * (0xffff as libc::c_int as libc::c_float + 0.5f32))
            as s16;
    (*this).unk_316 = ((Rand_ZeroOne() - 0.5f32) * 1500.0f32) as s16;
    (*this).actor.world.rot.y =
        (Rand_ZeroOne() * (0xffff as libc::c_int as libc::c_float + 0.5f32))
            as s16;
    Actor_SetScale(&mut (*this).actor, 0.003f32);
    (*this).actionFunc =
        Some(func_80A7D460 as
                 unsafe extern "C" fn(_: *mut EnInsect, _: *mut GlobalContext)
                     -> ());
    (*this).unk_314 =
        ((*this).unk_314 as libc::c_int | 0x100 as libc::c_int) as u16_0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A7D460(mut this: *mut EnInsect,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp_a0: s32 = 0;
    let mut sp50: s32 = 0;
    let mut phi_f0: f32_0 = 0.;
    let mut thisTemp: *mut EnInsect = this;
    let mut temp_a1: s32 = 0;
    let mut sp40: f32_0 = 0.;
    let mut phi_f2: f32_0 = 0.;
    let mut sp3A: s16 = 0;
    let mut sp38: s16 = 0;
    let mut sp34: f32_0 = 0.;
    sp50 = 0 as libc::c_int;
    sp3A = ((*this).actor.params as libc::c_int & 3 as libc::c_int) as s16;
    if !(*this).soilActor.is_null() {
        sp40 =
            Math3D_Vec3fDistSq(&mut (*this).actor.world.pos,
                               &mut (*(*this).soilActor).actor.world.pos)
    } else {
        if (*this).unk_314 as libc::c_int & 0x10 as libc::c_int != 0 {
            osSyncPrintf(b"\x1b[43;30m\x00" as *const u8 as
                             *const libc::c_char);
            // "warning: target Actor is NULL"
            osSyncPrintf(b"warning:\xe7\x9b\xae\xe6\xa8\x99 Actor \xe3\x81\x8c NULL (%s %d)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_en_mushi.c\x00" as *const u8 as
                             *const libc::c_char, 1046 as libc::c_int);
            osSyncPrintf(b"\x1b[m\x00" as *const u8 as *const libc::c_char);
        }
        sp40 = 40.0f32
    }
    D_80A7DEB0 += 0.99999994f32 / 300.0f32;
    if D_80A7DEB0 > 1.0f32 { D_80A7DEB0 = 1.0f32 }
    if D_80A7DEB0 > 0.999f32 {
        phi_f2 = 0.0f32
    } else if sp40 > 900.0f32 {
        phi_f2 = (1.1f32 - D_80A7DEB0) * 100.0f32 + 20.0f32
    } else { phi_f2 = (1.0f32 - D_80A7DEB0) * 10.0f32 }
    if !(*this).soilActor.is_null() && Rand_ZeroOne() < 0.07f32 {
        (*this).actor.home.pos.x =
            (Rand_ZeroOne() - 0.5f32) * phi_f2 +
                (*(*thisTemp).soilActor).actor.world.pos.x;
        (*this).actor.home.pos.y = (*(*thisTemp).soilActor).actor.world.pos.y;
        (*this).actor.home.pos.z =
            (Rand_ZeroOne() - 0.5f32) * phi_f2 +
                (*(*thisTemp).soilActor).actor.world.pos.z
    }
    if D_80A7DEB0 > 0.999f32 {
        (*this).unk_328 =
            Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                           &mut (*this).actor.home.pos);
        (*this).unk_324 = Rand_ZeroOne() * 0.6f32 + 0.6f32
    } else if Rand_ZeroOne() < 0.07f32 {
        if (*this).unk_324 > 1.0f32 {
            (*this).unk_324 = 0.1f32
        } else { (*this).unk_324 = Rand_ZeroOne() * 0.8f32 + 1.0f32 }
        sp34 = 1.3f32 - D_80A7DEB0;
        if sp34 < 0.0f32 {
            sp34 = 0.0f32
        } else {
            if sp34 > 1.0f32 { phi_f0 = 1.0f32 } else { phi_f0 = sp34 }
            sp34 = phi_f0
        }
        sp38 = ((Rand_ZeroOne() - 0.5f32) * 65535.0f32 * sp34) as s16;
        (*this).unk_328 =
            (Math_Vec3f_Yaw(&mut (*this).actor.world.pos,
                            &mut (*this).actor.home.pos) as libc::c_int +
                 sp38 as libc::c_int) as s16
    }
    Actor_SetScale(&mut (*this).actor,
                   if (*thisTemp).actor.scale.x + 0.0008f32 > 0.01f32 {
                       0.01f32
                   } else { ((*thisTemp).actor.scale.x) + 0.0008f32 });
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, (*this).unk_324,
                           0.1f32, 0.5f32, 0.0f32);
        Math_ScaledStepToS(&mut (*this).actor.world.rot.y, (*this).unk_328,
                           2000 as libc::c_int as s16);
        sp50 =
            Math_ScaledStepToS(&mut (*this).actor.world.rot.x,
        ...
        Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 0.1f32, 0.5f32,
                           0.0f32);
        (*this).actor.speedXZ += (Rand_ZeroOne() - 0.5f32) * 0.14f32;
        (*this).actor.velocity.y += Rand_ZeroOne() * 0.12f32;
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int +
                 (*this).unk_316 as libc::c_int) as s16;
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
        (*this).actor.shape.rot.x =
            ((*this).actor.shape.rot.x as libc::c_int - 2000 as libc::c_int)
                as s16
    }
    phi_f2 = Rand_ZeroOne() * 0.5f32 + (*this).actor.speedXZ * 1.3f32;
    if phi_f2 < 0.0f32 {
        (*this).skelAnime.playSpeed = 0.0f32
    } else {
        if phi_f2 > 1.9f32 { phi_f0 = 1.9f32 } else { phi_f0 = phi_f2 }
        (*this).skelAnime.playSpeed = phi_f0
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_314 as libc::c_int & 0x40 as libc::c_int == 0 &&
           (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
           (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39a0 as libc::c_int as u16_0);
        (*this).unk_314 =
            ((*this).unk_314 as libc::c_int | 0x40 as libc::c_int) as u16_0
    }
    if sp3A as libc::c_int == 2 as libc::c_int &&
           (*this).unk_314 as libc::c_int & 0x10 as libc::c_int != 0 &&
           (*this).unk_314 as libc::c_int & 0x80 as libc::c_int == 0 {
        if (*this).unk_32A as libc::c_int >= 15 as libc::c_int {
            if !(*this).soilActor.is_null() {
                if (gSaveContext.gsFlags[(((*(*this).soilActor).actor.params
                                               as libc::c_int >>
                                               8 as libc::c_int &
                                               0x1f as libc::c_int) -
                                              1 as libc::c_int >>
                        ...
                        libc::c_uint &
                        gGsFlagsMasks[(((*(*this).soilActor).actor.params as
                                            libc::c_int >> 8 as libc::c_int &
                                            0x1f as libc::c_int) -
                                           1 as libc::c_int &
                                           3 as libc::c_int) as usize]) >>
                       gGsFlagsShifts[(((*(*this).soilActor).actor.params as
                                            libc::c_int >> 8 as libc::c_int &
                                            0x1f as libc::c_int) -
                                           1 as libc::c_int &
                                           3 as libc::c_int) as usize] &
                       ((*(*this).soilActor).actor.params as libc::c_int &
                            0xff as libc::c_int) as libc::c_uint == 0 {
                    func_80078884(0x4807 as libc::c_int as u16_0);
                }
            }
            (*this).unk_314 =
                ((*this).unk_314 as libc::c_int | 0x80 as libc::c_int) as
                    u16_0
        } else { (*this).unk_32A = (*this).unk_32A.wrapping_add(1) }
    }
    if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
           (*this).actor.bgCheckFlags as libc::c_int & 0x40 as libc::c_int !=
               0 {
        func_80A7CE60(this);
    } else if (*this).unk_314 as libc::c_int & 0x10 as libc::c_int != 0 {
        if sp40 < 9.0f32 {
            func_80A7CBC8(this);
        } else if (*this).unk_31A as libc::c_int <= 0 as libc::c_int ||
                      (*this).unk_31C as libc::c_int <= 0 as libc::c_int ||
                      (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0
                          ...
                          (*this).actor.bgCheckFlags as libc::c_int &
                              1 as libc::c_int != 0 &&
                          D_80A7DEB8 as libc::c_int >= 4 as libc::c_int &&
                          (sp3A as libc::c_int == 2 as libc::c_int ||
                               sp3A as libc::c_int == 3 as libc::c_int) {
            func_80A7CBC8(this);
        } else if sp40 < 900.0f32 {
            (*this).unk_31C += 1;
            (*this).unk_314 =
                ((*this).unk_314 as libc::c_int | 0x20 as libc::c_int) as
                    u16_0
        } else { (*this).unk_31A = 100 as libc::c_int as s16 }
    } else if sp50 != 0 as libc::c_int {
        func_80A7C3A0(this);
    } else if (sp3A as libc::c_int == 2 as libc::c_int ||
                   sp3A as libc::c_int == 3 as libc::c_int) &&
                  (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 &&
                  (*this).unk_31C as libc::c_int <= 0 as libc::c_int &&
                  (*this).unk_31A as libc::c_int <= 0 as libc::c_int &&
                  (*this).actor.floorHeight < -32000.0f32 + 10.0f32 {
        osSyncPrintf(b"\x1b[43;30m\x00" as *const u8 as *const libc::c_char);
        // "BG missing? To do Actor_delete"
        osSyncPrintf(b"BG \xe6\x8a\x9c\xe3\x81\x91\xef\xbc\x9f Actor_delete \xe3\x81\x97\xe3\x81\xbe\xe3\x81\x99(%s %d)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_en_mushi.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn EnInsect_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnInsect = thisx as *mut EnInsect;
    let mut phi_v0: s32 = 0;
    if !(*this).actor.child.is_null() {
        if (*(*this).actor.child).update.is_none() {
            if &mut (*this).actor as *mut Actor != (*this).actor.child {
    ...
    if (*this).actor.update.is_some() {
        ...
        if (*this).unk_314 as libc::c_int & 0x100 as libc::c_int != 0 {
            if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 {
                if (*this).actor.bgCheckFlags as libc::c_int &
                       1 as libc::c_int != 0 {
                    func_80A7C058(this);
                }
            } else { func_80A7C058(this); }
        }
        phi_v0 = 0 as libc::c_int;
        if (*this).unk_314 as libc::c_int & 1 as libc::c_int != 0 {
            phi_v0 = 4 as libc::c_int
        }
        if (*this).unk_314 as libc::c_int & 2 as libc::c_int != 0 {
            phi_v0 |= 1 as libc::c_int
        }
        if phi_v0 != 0 as libc::c_int {
            phi_v0 |= 0x40 as libc::c_int;
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 8.0f32,
                                    5.0f32, 0.0f32, phi_v0);
        }
        if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
            (*this).actor.parent = 0 as *mut Actor;
            phi_v0 = (*this).actor.params as libc::c_int & 3 as libc::c_int;
            if phi_v0 == 2 as libc::c_int || phi_v0 == 3 as libc::c_int {
                Actor_Kill(&mut (*this).actor);
            } else { func_80A7CA64(this); }
        } else if (*this).actor.xzDistToPlayer < 50.0f32 &&
                      (*this).actionFunc !=
                          Some(func_80A7CAD0 as
                                   unsafe extern "C" fn(_: *mut EnInsect,
                                                        _: *mut GlobalContext)
                                       -> ()) {
            if (*this).unk_314 as libc::c_int & 0x20 as libc::c_int == 0 &&
                   ((*this).unk_31C as libc::c_int) < 180 as libc::c_int {
                CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                                     &mut (*this).collider.base);
            }
            if (*this).unk_314 as libc::c_int & 8 as libc::c_int == 0 &&
                   (D_80A7DEB4 as libc::c_int) < 4 as libc::c_int &&
                   EnInsect_InBottleRange(this, globalCtx) != 0 &&
                   func_8002F434(&mut (*this).actor, globalCtx,
                                 GI_MAX as libc::c_int, 60.0f32, 30.0f32) != 0
               {
                D_80A7DEB4 += 1
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnInsect_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnInsect = thisx as *mut EnInsect;
    ...
    D_80A7DEB4 = 0 as libc::c_int as s16;
}
