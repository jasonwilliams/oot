...
extern "C" {
    ...
    #[no_mangle]
    fn func_800435D8(globalCtx: *mut GlobalContext,
                     dynaActor: *mut DynaPolyActor, arg2: s16, arg3: s16,
                     arg4: s16) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gArmosCol: CollisionHeader;
    #[no_mangle]
    static mut gArmosHopAnim: AnimationHeader;
    #[no_mangle]
    static mut gArmosRicochetAnim: AnimationHeader;
    #[no_mangle]
    static mut gArmosSkel: SkeletonHeader;
    #[no_mangle]
    static mut gArmosDamagedAnim: AnimationHeader;
}
...
pub struct EnAm {
    ...
    pub skelAnime: SkelAnime,
    pub behavior: s32,
    pub jointTable: [Vec3s; 14],
    pub morphTable: [Vec3s; 14],
    pub actionFunc: EnAmActionFunc,
    pub unk_258: s16,
    pub cooldownTimer: s16,
    pub attackTimer: s16,
    pub iceTimer: s16,
    pub deathTimer: s16,
    pub panicSpinRot: s16,
    pub unk_264: s16,
    pub textureBlend: u8_0,
    pub damageEffect: u8_0,
    pub shakeOrigin: Vec3f,
    pub hurtCollider: ColliderCylinder,
    pub blockCollider: ColliderCylinder,
    pub hitCollider: ColliderQuad,
}
pub type EnAmActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAm, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_23 = libc::c_uint;
pub const ARMOS_ENEMY: C2RustUnnamed_23 = 1;
pub const ARMOS_STATUE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnBom {
    pub actor: Actor,
...
pub const BOMB_EXPLOSION: C2RustUnnamed_24 = 1;
pub const BOMB_BODY: C2RustUnnamed_24 = 0;
pub const AM_BEHAVIOR_AGGRO: C2RustUnnamed_25 = 10;
pub const AM_BEHAVIOR_GO_HOME: C2RustUnnamed_25 = 7;
pub const AM_BEHAVIOR_DO_NOTHING: C2RustUnnamed_25 = 3;
pub const AM_DMGEFF_NONE: C2RustUnnamed_26 = 0;
pub const AM_DMGEFF_KILL: C2RustUnnamed_26 = 15;
pub const AM_DMGEFF_MAGIC_FIRE_LIGHT: C2RustUnnamed_26 = 14;
pub const AM_DMGEFF_ICE: C2RustUnnamed_26 = 13;
pub const AM_DMGEFF_STUN: C2RustUnnamed_26 = 6;
pub const AM_DMGEFF_NUT: C2RustUnnamed_26 = 1;
pub const AM_BEHAVIOR_RICOCHET: C2RustUnnamed_25 = 8;
pub const AM_BEHAVIOR_DAMAGED: C2RustUnnamed_25 = 1;
pub const AM_BEHAVIOR_STUNNED: C2RustUnnamed_25 = 6;
pub const AM_BEHAVIOR_5: C2RustUnnamed_25 = 5;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const AM_BEHAVIOR_NONE: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
#[no_mangle]
pub static mut En_Am_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_AM as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_AM as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnAm>() as libc::c_ulong,
                          init:
...
static mut sHurtCylinderInit: ColliderCylinderInit =
    {
        let mut init =
...
static mut sBlockCylinderInit: ColliderCylinderInit =
    {
        let mut init =
            ColliderCylinderInit{base:
                                     {
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (AM_DMGEFF_NUT as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (AM_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (AM_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (AM_DMGEFF_KILL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (AM_DMGEFF_STUN as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (AM_DMGEFF_KILL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (AM_DMGEFF_NONE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (AM_DMGEFF_MAGIC_FIRE_LIGHT as libc::c_int)
                                      << 4 as libc::c_int) as u8_0,
                             (3 as libc::c_int |
                                  (AM_DMGEFF_ICE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupAction(mut this: *mut EnAm,
                                          mut actionFunc: EnAmActionFunc) {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnAm_CanMove(mut this: *mut EnAm,
                                      mut globalCtx: *mut GlobalContext,
                                      mut distance: f32_0, mut yaw: s16)
 -> s32 {
    let mut ret: s16 = 0;
    ...
    curBgCheckFlags = (*this).dyna.actor.bgCheckFlags as s16;
    ...
    ret =
        ((*this).dyna.actor.bgCheckFlags as libc::c_int & 1 as libc::c_int) as
            s16;
    if ret == 0 &&
           (*this).dyna.actor.floorHeight >=
               (*this).dyna.actor.home.pos.y - 20.0f32 {
        ret = 1 as libc::c_int as s16
    }
    (*this).dyna.actor.bgCheckFlags = curBgCheckFlags as u16_0;
    return ret as s32;
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut pad: s32 = 0;
    let mut this: *mut EnAm = thisx as *mut EnAm;
    ...
    ActorShape_Init(&mut (*this).dyna.actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 48.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gArmosSkel,
                   &mut gArmosRicochetAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 14 as libc::c_int);
    Actor_SetScale(&mut (*this).dyna.actor, 0.01f32);
    DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
    Collider_InitCylinder(globalCtx, &mut (*this).hurtCollider);
    Collider_InitCylinder(globalCtx, &mut (*this).blockCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).hurtCollider,
                         &mut (*this).dyna.actor, &mut sHurtCylinderInit);
    if (*this).dyna.actor.params as libc::c_int == ARMOS_STATUE as libc::c_int
       {
        (*this).dyna.actor.colChkInfo.health = 1 as libc::c_int as u8_0;
        Collider_SetCylinder(globalCtx, &mut (*this).blockCollider,
                             &mut (*this).dyna.actor, &mut sHurtCylinderInit);
        (*this).hurtCollider.base.ocFlags1 =
            ((1 as libc::c_int) << 0 as libc::c_int |
                 (1 as libc::c_int) << 2 as libc::c_int |
                 (1 as libc::c_int) << 4 as libc::c_int |
                 (1 as libc::c_int) << 5 as libc::c_int) as u8_0;
        (*this).blockCollider.base.ocFlags1 =
            ((1 as libc::c_int) << 0 as libc::c_int |
                 (1 as libc::c_int) << 2 as libc::c_int |
                 (1 as libc::c_int) << 3 as libc::c_int) as u8_0;
        CollisionHeader_GetVirtual(&mut gArmosCol as *mut CollisionHeader as
        ...
        Collider_SetCylinder(globalCtx, &mut (*this).blockCollider,
                             &mut (*this).dyna.actor,
                             &mut sBlockCylinderInit);
        Collider_InitQuad(globalCtx, &mut (*this).hitCollider);
        Collider_SetQuad(globalCtx, &mut (*this).hitCollider,
                         &mut (*this).dyna.actor, &mut sQuadInit);
        (*this).dyna.actor.colChkInfo.health = 1 as libc::c_int as u8_0;
        (*this).dyna.actor.colChkInfo.damageTable = &mut sDamageTable;
        EnAm_SetupSleep(this);
        (*this).unk_258 = 0 as libc::c_int as s16
    }
    (*this).dyna.actor.colChkInfo.mass = 0xfe as libc::c_int as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnAm = thisx as *mut EnAm;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    Collider_DestroyCylinder(globalCtx, &mut (*this).hurtCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).blockCollider);
    // ! @bug Quad collider is not destroyed (though destroy doesnt really do anything anyway)
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SpawnEffects(mut this: *mut EnAm,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    while i > 0 as libc::c_int {
        pos.x =
            (*this).dyna.actor.world.pos.x +
                (Rand_ZeroOne() - 0.5f32) * 65.0f32;
        pos.y =
            (*this).dyna.actor.world.pos.y + 40.0f32 +
                (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        pos.z =
            (*this).dyna.actor.world.pos.z +
                (Rand_ZeroOne() - 0.5f32) * 65.0f32;
        EffectSsKiraKira_SpawnSmall(globalCtx, &mut pos, &mut velocity,
                                    &mut accel, &mut primColor,
                                    &mut envColor);
        i -= 1
    }
    Audio_PlayActorSound2(&mut (*this).dyna.actor,
                          0x3844 as libc::c_int as u16_0);
    Actor_SpawnFloorDustRing(globalCtx, &mut (*this).dyna.actor,
                             &mut (*this).dyna.actor.world.pos, 4.0f32,
                             3 as libc::c_int, 8.0f32,
                             0x12c as libc::c_int as s16,
                             0xf as libc::c_int as s16,
                             0 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupSleep(mut this: *mut EnAm) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gArmosRicochetAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gArmosRicochetAnim, 0.0f32,
                     lastFrame, lastFrame,
                     ANIMMODE_LOOP as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = AM_BEHAVIOR_DO_NOTHING as libc::c_int;
    (*this).dyna.actor.speedXZ = 0.0f32;
    (*this).unk_258 =
        if (*this).textureBlend as libc::c_int == 255 as libc::c_int {
            0 as libc::c_int
        } else { 1 as libc::c_int } as s16;
    EnAm_SetupAction(this,
                     Some(EnAm_Sleep as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupStatue(mut this: *mut EnAm) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gArmosRicochetAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gArmosRicochetAnim, 0.0f32,
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupLunge(mut this: *mut EnAm) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime, &mut gArmosHopAnim,
                               4.0f32);
    (*this).unk_258 = 3 as libc::c_int as s16;
    (*this).behavior = AM_BEHAVIOR_AGGRO as libc::c_int;
    (*this).dyna.actor.speedXZ = 0.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupCooldown(mut this: *mut EnAm) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime, &mut gArmosHopAnim,
                               4.0f32);
    (*this).unk_258 = 3 as libc::c_int as s16;
    (*this).cooldownTimer = 40 as libc::c_int as s16;
    (*this).behavior = AM_BEHAVIOR_AGGRO as libc::c_int;
    (*this).dyna.actor.speedXZ = 0.0f32;
    (*this).dyna.actor.world.rot.y = (*this).dyna.actor.shape.rot.y;
    EnAm_SetupAction(this,
                     Some(EnAm_Cooldown as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupMoveToHome(mut this: *mut EnAm) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime, &mut gArmosHopAnim,
                               4.0f32);
    (*this).behavior = AM_BEHAVIOR_GO_HOME as libc::c_int;
    (*this).unk_258 = 1 as libc::c_int as s16;
    (*this).dyna.actor.speedXZ = 0.0f32;
    EnAm_SetupAction(this,
                     Some(EnAm_MoveToHome as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupRotateToInit(mut this: *mut EnAm) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime, &mut gArmosHopAnim,
                               4.0f32);
    (*this).behavior = AM_BEHAVIOR_GO_HOME as libc::c_int;
    (*this).unk_258 = 1 as libc::c_int as s16;
    (*this).dyna.actor.speedXZ = 0.0f32;
    EnAm_SetupAction(this,
                     Some(EnAm_RotateToInit as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupRotateToHome(mut this: *mut EnAm) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime, &mut gArmosHopAnim,
                               4.0f32);
    (*this).behavior = AM_BEHAVIOR_GO_HOME as libc::c_int;
    (*this).dyna.actor.speedXZ = 0.0f32;
    (*this).dyna.actor.world.rot.y = (*this).dyna.actor.shape.rot.y;
    EnAm_SetupAction(this,
                     Some(EnAm_RotateToHome as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupRecoilFromDamage(mut this: *mut EnAm,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gArmosDamagedAnim, 1.0f32,
                     4.0f32,
                     Animation_GetLastFrame(&mut gArmosDamagedAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as
                         libc::c_int as libc::c_float - 6.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).behavior = AM_BEHAVIOR_DAMAGED as libc::c_int;
    (*this).dyna.actor.world.rot.y = (*this).dyna.actor.yawTowardsPlayer;
    Audio_PlayActorSound2(&mut (*this).dyna.actor,
                          0x3847 as libc::c_int as u16_0);
    if EnAm_CanMove(this, globalCtx, -6.0f32, (*this).dyna.actor.world.rot.y)
           != 0 {
        (*this).dyna.actor.speedXZ = -6.0f32
    }
    (*this).dyna.actor.colorFilterTimer = 0 as libc::c_int as u8_0;
    Enemy_StartFinishingBlow(globalCtx, &mut (*this).dyna.actor);
    EnAm_SetupAction(this,
                     Some(EnAm_RecoilFromDamage as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupRicochet(mut this: *mut EnAm,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gArmosRicochetAnim, 1.0f32,
                     0.0f32, 8.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     0.0f32);
    (*this).dyna.actor.world.rot.y = (*this).dyna.actor.yawTowardsPlayer;
    if EnAm_CanMove(this, globalCtx, -6.0f32, (*this).dyna.actor.world.rot.y)
           != 0 {
    ...
    (*this).unk_264 = 0 as libc::c_int as s16;
    (*this).unk_258 = 0 as libc::c_int as s16;
    (*this).cooldownTimer = 5 as libc::c_int as s16;
    (*this).behavior = AM_BEHAVIOR_RICOCHET as libc::c_int;
    EnAm_SetupAction(this,
                     Some(EnAm_Ricochet as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Sleep(mut this: *mut EnAm,
                                    mut globalCtx: *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    let mut pad: s32 = 0;
    ...
    if (*this).unk_258 as libc::c_int != 0 as libc::c_int ||
           (*this).hurtCollider.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 &&
               (*this).hurtCollider.base.oc ==
                   &mut (*player).actor as *mut Actor ||
           (*this).hurtCollider.base.acFlags as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).hurtCollider.base.acFlags =
            ((*this).hurtCollider.base.acFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        if (*this).textureBlend as libc::c_int == 0 as libc::c_int {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x3845 as libc::c_int as u16_0);
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  0x3848 as libc::c_int as u16_0);
            Actor_SetColorFilter(&mut (*this).dyna.actor,
                                 0x4000 as libc::c_int as s16,
                                 255 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
                                 8 as libc::c_int as s16);
        }
        if (*this).textureBlend as libc::c_int >= 240 as libc::c_int {
            (*this).attackTimer = 200 as libc::c_int as s16;
            (*this).textureBlend = 255 as libc::c_int as u8_0;
            (*this).dyna.actor.flags |=
                ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            (*this).dyna.actor.shape.yOffset = 0.0f32;
            EnAm_SetupLunge(this);
        } else {
            // shake randomly about the origin while waking up
            rand = (Rand_ZeroOne() - 0.5f32) * 10.0f32;
            ...
            (*this).textureBlend =
                ((*this).textureBlend as libc::c_int + 20 as libc::c_int) as
                    u8_0;
            (*this).unk_258 = 1 as libc::c_int as s16
        }
    } else if (*this).textureBlend as libc::c_int > 10 as libc::c_int {
        (*this).textureBlend =
            ((*this).textureBlend as libc::c_int - 10 as libc::c_int) as u8_0
    } else {
        (*this).textureBlend = 0 as libc::c_int as u8_0;
        (*this).dyna.actor.flags &=
            !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        if (*this).dyna.bgId < 0 as libc::c_int {
            (*this).unk_264 = 0 as libc::c_int as s16
        }
        ...
        (*this).dyna.actor.speedXZ =
            if (*this).dyna.actor.speedXZ < -2.5f32 {
                -2.5f32
            } else if (*this).dyna.actor.speedXZ > 2.5f32 {
                2.5f32
            } else { (*this).dyna.actor.speedXZ };
        Math_SmoothStepToF(&mut (*this).dyna.actor.speedXZ, 0.0f32, 1.0f32,
                           1.0f32, 0.0f32);
        if (*this).dyna.actor.speedXZ != 0.0f32 {
            Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                  (0x280a as libc::c_int -
                                       0x800 as libc::c_int) as u16_0);
        }
        (*this).dyna.unk_154 = 0.0f32;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnAm_RotateToHome(mut this: *mut EnAm,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut yawToHome: s16 =
        Math_Vec3f_Yaw(&mut (*this).dyna.actor.world.pos,
                       &mut (*this).dyna.actor.home.pos);
    if (*this).skelAnime.curFrame == 8.0f32 {
        Math_SmoothStepToS(&mut (*this).dyna.actor.world.rot.y, yawToHome,
                           1 as libc::c_int as s16,
                           0x1f40 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        (*this).dyna.actor.velocity.y = 12.0f32
    } else if (*this).skelAnime.curFrame > 11.0f32 {
        if (*this).dyna.actor.bgCheckFlags as libc::c_int & 1 as libc::c_int
               == 0 {
            (*this).skelAnime.curFrame = 11 as libc::c_int as f32_0
        } else {
            EnAm_SpawnEffects(this, globalCtx);
            if (*this).dyna.actor.world.rot.y as libc::c_int ==
                   yawToHome as libc::c_int {
                (*this).unk_258 = 0 as libc::c_int as s16
            }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnAm_RotateToInit(mut this: *mut EnAm,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    if (*this).skelAnime.curFrame == 8.0f32 {
        if (*this).dyna.actor.world.pos.x == (*this).dyna.actor.home.pos.x &&
           ...
           {
            Math_SmoothStepToS(&mut (*this).dyna.actor.world.rot.y,
                               (*this).dyna.actor.home.rot.y,
                               1 as libc::c_int as s16,
                               0x1f40 as libc::c_int as s16,
                               0 as libc::c_int as s16);
        }
        (*this).unk_258 = 2 as libc::c_int as s16;
        (*this).dyna.actor.velocity.y = 12.0f32
    } else if (*this).skelAnime.curFrame > 11.0f32 {
        if (*this).dyna.actor.bgCheckFlags as libc::c_int & 1 as libc::c_int
               == 0 {
            ...
            (*this).unk_258 = 1 as libc::c_int as s16;
            EnAm_SpawnEffects(this, globalCtx);
            if (*this).dyna.actor.home.rot.y as libc::c_int ==
    ...
    if (*this).unk_258 as libc::c_int == 2 as libc::c_int {
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.x,
                           (*this).dyna.actor.home.pos.x, 1.0f32, 8.0f32,
                           0.0f32);
        Math_SmoothStepToF(&mut (*this).dyna.actor.world.pos.z,
                           (*this).dyna.actor.home.pos.z, 1.0f32, 8.0f32,
                           0.0f32);
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).unk_258 as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_MoveToHome(mut this: *mut EnAm,
                                         mut globalCtx: *mut GlobalContext) {
    let mut yawToHome: s16 =
        Math_Vec3f_Yaw(&mut (*this).dyna.actor.world.pos,
                       &mut (*this).dyna.actor.home.pos);
    if (*this).skelAnime.curFrame == 8.0f32 {
        ...
        if (*this).dyna.actor.bgCheckFlags as libc::c_int & 1 as libc::c_int
            ...
            Math_SmoothStepToS(&mut (*this).dyna.actor.world.rot.y, yawToHome,
                               ...
                               0 as libc::c_int as s16);
            if (*this).dyna.actor.bgCheckFlags as libc::c_int &
                   2 as libc::c_int != 0 {
                (*this).unk_258 -= 1
            }
            (*this).dyna.actor.velocity.y = 0.0f32;
            ...
            (*this).dyna.actor.world.pos.y = (*this).dyna.actor.floorHeight;
            EnAm_SpawnEffects(this, globalCtx);
            if Actor_WorldDistXYZToPoint(&mut (*this).dyna.actor,
                                         &mut (*this).dyna.actor.home.pos) <
                   80.0f32 {
    ...
    if (*this).dyna.actor.speedXZ != 0.0f32 &&
           (*this).dyna.actor.bgCheckFlags as libc::c_int & 8 as libc::c_int
               != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_RecoilFromDamage(mut this: *mut EnAm,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if (*this).dyna.actor.speedXZ < 0.0f32 {
        (*this).dyna.actor.speedXZ += 0.5f32
    }
    if (*this).dyna.actor.velocity.y <= 0.0f32 &&
           EnAm_CanMove(this, globalCtx, -8.0f32,
                        (*this).dyna.actor.world.rot.y) == 0 {
        (*this).dyna.actor.speedXZ = 0.0f32
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnAm_SetupLunge(this);
        (*this).deathTimer = 64 as libc::c_int as s16;
        (*this).panicSpinRot = 0 as libc::c_int as s16
    };
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnAm_Cooldown(mut this: *mut EnAm,
                                       mut globalCtx: *mut GlobalContext) {
    let mut yawDiff: s16 =
        ((*this).dyna.actor.yawTowardsPlayer as libc::c_int -
             (*this).dyna.actor.world.rot.y as libc::c_int) as s16;
    yawDiff =
    ...
    if (*this).cooldownTimer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).skelAnime.curFrame == 8.0f32 {
            Math_SmoothStepToS(&mut (*this).dyna.actor.world.rot.y,
                               (*this).dyna.actor.yawTowardsPlayer,
                               1 as libc::c_int as s16,
                               0x1f40 as libc::c_int as s16,
                               0 as libc::c_int as s16);
            (*this).dyna.actor.velocity.y = 12.0f32
            ...
            if (*this).dyna.actor.bgCheckFlags as libc::c_int &
                ...
                if (yawDiff as libc::c_int) < 3500 as libc::c_int {
                    (*this).unk_258 = 0 as libc::c_int as s16
                }
                (*this).dyna.actor.velocity.y = 0.0f32;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnAm_Lunge(mut this: *mut EnAm,
                                    mut globalCtx: *mut GlobalContext) {
    if ((*this).deathTimer as libc::c_int) < 52 as libc::c_int {
        if (*this).skelAnime.curFrame == 8.0f32 {
            (*this).dyna.actor.velocity.y = 12.0f32;
            if EnAm_CanMove(this, globalCtx, 80.0f32,
                            (*this).dyna.actor.world.rot.y) != 0 {
                (*this).dyna.actor.speedXZ = 6.0f32
            } else { (*this).dyna.actor.speedXZ = 0.0f32 }
            (*this).unk_264 = 1 as libc::c_int as s16;
            (*this).hitCollider.base.atFlags =
                ((*this).hitCollider.base.atFlags as libc::c_int &
            ...
            if (*this).dyna.actor.bgCheckFlags as libc::c_int &
                ...
                (*this).dyna.actor.world.pos.y =
                    (*this).dyna.actor.floorHeight;
                EnAm_SpawnEffects(this, globalCtx);
                if (Actor_WorldDistXZToPoint(&mut (*this).dyna.actor,
                                             &mut (*this).dyna.actor.home.pos)
                        > 240.0f32 ||
                        (*this).attackTimer as libc::c_int ==
                            0 as libc::c_int) &&
        ...
        if (*this).dyna.actor.speedXZ != 0.0f32 &&
               (*this).dyna.actor.bgCheckFlags as libc::c_int &
                   8 as libc::c_int != 0 {
            (*this).dyna.actor.world.rot.y =
                ((*this).dyna.actor.wallYaw as libc::c_int -
                     (*this).dyna.actor.world.rot.y as libc::c_int +
                     (*this).dyna.actor.wallYaw as libc::c_int) as s16;
            Actor_MoveForward(&mut (*this).dyna.actor);
            (*this).dyna.actor.bgCheckFlags =
                ((*this).dyna.actor.bgCheckFlags as libc::c_int &
        ...
        if (*this).deathTimer as libc::c_int == 0 as libc::c_int {
            ...
            if ((*this).panicSpinRot as libc::c_int) < 8000 as libc::c_int {
                (*this).panicSpinRot =
                    ((*this).panicSpinRot as libc::c_int + 800 as libc::c_int)
                        as s16
            }
            (*this).dyna.actor.shape.rot.y =
                ((*this).dyna.actor.shape.rot.y as libc::c_int +
                     (*this).panicSpinRot as libc::c_int) as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Statue(mut this: *mut EnAm,
                                     mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut temp158f: f32_0 = (*this).dyna.unk_158 as f32_0;
    let mut moveDir: s16 = 0 as libc::c_int as s16;
    if (*this).unk_258 as libc::c_int == 0 as libc::c_int {
        if (*this).dyna.unk_150 != 0.0f32 {
            (*this).unk_258 = 0x8000 as libc::c_int as s16
        }
    } else {
        (*this).unk_258 =
            ((*this).unk_258 as libc::c_int - 0x800 as libc::c_int) as s16;
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              (0x280a as libc::c_int - 0x800 as libc::c_int)
                                  as u16_0);
        if (*this).dyna.unk_150 < 0.0f32 {
            temp158f =
                ((*this).dyna.unk_158 as libc::c_int + 0x8000 as libc::c_int)
                    as f32_0
        }
        if (*this).hurtCollider.base.ocFlags1 as libc::c_int &
               (1 as libc::c_int) << 1 as libc::c_int != 0 {
            moveDir =
                (Math_Vec3f_Yaw(&mut (*this).dyna.actor.world.pos,
                                &mut (*(*this).hurtCollider.base.oc).world.pos)
                     as libc::c_int as libc::c_float - temp158f) as s16
        }
        if (*this).dyna.unk_150 == 0.0f32 ||
               (*this).unk_258 as libc::c_int == 0 as libc::c_int ||
               (*this).dyna.actor.bgCheckFlags as libc::c_int &
                   1 as libc::c_int == 0 ||
               func_800435D8(globalCtx, &mut (*this).dyna,
                             0x14 as libc::c_int as s16,
                             (Math_SinS((*this).unk_258) *
                                  ((*this).dyna.unk_150 * 0.5f32) + 40.0f32)
                                 as s16, 0xa as libc::c_int as s16) == 0 ||
               (*this).hurtCollider.base.ocFlags1 as libc::c_int &
                   (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                   (if moveDir as libc::c_int >= 0 as libc::c_int {
                        moveDir as libc::c_int
                    } else { -(moveDir as libc::c_int) }) <=
                       0x2000 as libc::c_int {
            (*this).unk_258 = 0 as libc::c_int as s16;
            (*player).stateFlags2 &= !(0x151 as libc::c_int) as libc::c_uint;
            (*player).actor.speedXZ = 0.0f32;
            (*this).dyna.unk_154 = 0.0f32;
            (*this).dyna.unk_150 = (*this).dyna.unk_154
        }
        (*this).dyna.actor.world.rot.y = (*this).dyna.unk_158;
        (*this).dyna.actor.speedXZ =
            Math_SinS((*this).unk_258) * ((*this).dyna.unk_150 * 0.5f32)
    }
    if (*this).dyna.actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0
       {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_SetupStunned(mut this: *mut EnAm,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    ...
    Actor_SetColorFilter(&mut (*this).dyna.actor, 0 as libc::c_int as s16,
                         120 as libc::c_int as s16, 0 as libc::c_int as s16,
                         100 as libc::c_int as s16);
    if (*this).damageEffect as libc::c_int == AM_DMGEFF_ICE as libc::c_int {
        (*this).iceTimer = 48 as libc::c_int as s16
    }
    (*this).behavior = AM_BEHAVIOR_STUNNED as libc::c_int;
    Audio_PlayActorSound2(&mut (*this).dyna.actor,
                          0x389e as libc::c_int as u16_0);
    EnAm_SetupAction(this,
                     Some(EnAm_Stunned as
                              unsafe extern "C" fn(_: *mut EnAm,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Stunned(mut this: *mut EnAm,
                                      mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).dyna.actor.shape.rot.y,
                       (*this).dyna.actor.world.rot.y,
    ...
    if (*this).dyna.actor.velocity.y <= 0.0f32 &&
           EnAm_CanMove(this, globalCtx, -9.0f32,
                        (*this).dyna.actor.world.rot.y) == 0 {
        (*this).dyna.actor.speedXZ = 0.0f32
    }
    if (*this).dyna.actor.colorFilterTimer as libc::c_int == 0 as libc::c_int
       {
        if (*this).dyna.actor.colChkInfo.health as libc::c_int !=
               0 as libc::c_int {
            EnAm_SetupLunge(this);
        } else { EnAm_SetupRecoilFromDamage(this, globalCtx); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Ricochet(mut this: *mut EnAm,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).dyna.actor.speedXZ < 0.0f32 {
        (*this).dyna.actor.speedXZ += 0.5f32
    }
    if (*this).dyna.actor.velocity.y <= 0.0f32 &&
           EnAm_CanMove(this, globalCtx, (*this).dyna.actor.speedXZ * 1.5f32,
                        (*this).dyna.actor.world.rot.y) == 0 {
        (*this).dyna.actor.speedXZ = 0.0f32
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_TransformSwordHitbox(mut thisx: *mut Actor,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    static mut D_809B0074: Vec3f =
        {
            let mut init = Vec3f{x: 2500.0f32, y: 7000.0f32, z: 0.0f32,};
            init
        };
    static mut D_809B0080: Vec3f =
        { let mut init = Vec3f{x: -2500.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut D_809B008C: Vec3f =
        {
            let mut init = Vec3f{x: 2500.0f32, y: 7000.0f32, z: 4000.0f32,};
            init
        };
    static mut D_809B0098: Vec3f =
        {
            let mut init = Vec3f{x: -2500.0f32, y: 0.0f32, z: 4000.0f32,};
            init
        };
    let mut this: *mut EnAm = thisx as *mut EnAm;
    Matrix_MultVec3f(&mut D_809B0074,
                     &mut *(*this).hitCollider.dim.quad.as_mut_ptr().offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
    Matrix_MultVec3f(&mut D_809B0080,
                     &mut *(*this).hitCollider.dim.quad.as_mut_ptr().offset(0
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
    Matrix_MultVec3f(&mut D_809B008C,
                     &mut *(*this).hitCollider.dim.quad.as_mut_ptr().offset(3
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
    Matrix_MultVec3f(&mut D_809B0098,
                     &mut *(*this).hitCollider.dim.quad.as_mut_ptr().offset(2
                                                                                as
                                                                                libc::c_int
                                                                                as
                                                                                isize));
    Collider_SetQuadVertices(&mut (*this).hitCollider,
                             &mut *(*this).hitCollider.dim.quad.as_mut_ptr().offset(0
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_UpdateDamage(mut this: *mut EnAm,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut sparkPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).deathTimer as libc::c_int == 0 as libc::c_int {
        if (*this).blockCollider.base.acFlags as libc::c_int &
            ...
            (*this).hurtCollider.base.acFlags =
                ((*this).hurtCollider.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*this).behavior >= AM_BEHAVIOR_5 as libc::c_int {
                EnAm_SetupRicochet(this, globalCtx);
            }
        } else if (*this).hurtCollider.base.acFlags as libc::c_int &
                      (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                      (*this).behavior >= AM_BEHAVIOR_5 as libc::c_int {
            (*this).hurtCollider.base.acFlags =
                ((*this).hurtCollider.base.acFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            if (*this).dyna.actor.colChkInfo.damageEffect as libc::c_int !=
                   AM_DMGEFF_MAGIC_FIRE_LIGHT as libc::c_int {
                (*this).unk_264 = 0 as libc::c_int as s16;
                (*this).damageEffect =
                    (*this).dyna.actor.colChkInfo.damageEffect;
                Actor_SetDropFlag(&mut (*this).dyna.actor,
                                  &mut (*this).hurtCollider.info,
                                  0 as libc::c_int);
                if (*this).dyna.actor.colChkInfo.damageEffect as libc::c_int
                       == AM_DMGEFF_NUT as libc::c_int ||
                       (*this).dyna.actor.colChkInfo.damageEffect as
                           libc::c_int == AM_DMGEFF_STUN as libc::c_int ||
                       (*this).dyna.actor.colChkInfo.damageEffect as
                           libc::c_int == AM_DMGEFF_ICE as libc::c_int {
                    if (*this).behavior != AM_BEHAVIOR_STUNNED as libc::c_int
                       {
                        EnAm_SetupStunned(this, globalCtx);
                        if (*this).dyna.actor.colChkInfo.damage as libc::c_int
                               != 0 as libc::c_int {
                            (*this).dyna.actor.colChkInfo.health =
                                0 as libc::c_int as u8_0
                        }
                    } else if (*this).dyna.actor.colChkInfo.damageEffect as
                                  libc::c_int == AM_DMGEFF_STUN as libc::c_int
                     {
                        ...
                        CollisionCheck_SpawnShieldParticlesMetal(globalCtx,
                              ...
                              libc::c_int == AM_DMGEFF_KILL as libc::c_int ||
                              (*this).behavior ==
                                  AM_BEHAVIOR_STUNNED as libc::c_int {
                    (*this).dyna.actor.colChkInfo.health =
                        0 as libc::c_int as u8_0;
                    EnAm_SetupRecoilFromDamage(this, globalCtx);
                } else { EnAm_SetupRicochet(this, globalCtx); }
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAm_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).dyna.actor.colChkInfo.damageEffect as libc::c_int !=
           AM_DMGEFF_MAGIC_FIRE_LIGHT as libc::c_int {
        if (*this).attackTimer as libc::c_int != 0 as libc::c_int {
            (*this).attackTimer -= 1
        }
        ...
        if (*this).deathTimer as libc::c_int != 0 as libc::c_int {
            ...
            if (*this).deathTimer as libc::c_int == 0 as libc::c_int {
                dustPosScale =
                    (*globalCtx).gameplayFrames.wrapping_mul(10 as libc::c_int
                                                                 as
                                                                 libc::c_uint)
                        as f32_0;
                EnAm_SpawnEffects(this, globalCtx);
                bomb =
                    Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                ...
                                BOMB_BODY as libc::c_int as s16) as
                        *mut EnBom;
                if !bomb.is_null() { (*bomb).timer = 0 as libc::c_int as s16 }
                Audio_PlayActorSound2(&mut (*this).dyna.actor,
                                      0x3846 as libc::c_int as u16_0);
                Item_DropCollectibleRandom(globalCtx, &mut (*this).dyna.actor,
                                           &mut (*this).dyna.actor.world.pos,
                                           0xa0 as libc::c_int as s16);
                i = 9 as libc::c_int;
                while i >= 0 as libc::c_int {
                    dustPos.x =
                        sinf(dustPosScale) * 7.0f32 +
                            (*this).dyna.actor.world.pos.x;
                    dustPos.y =
                        Rand_CenteredFloat(10.0f32) * 6.0f32 +
                            ((*this).dyna.actor.world.pos.y + 40.0f32);
                    dustPos.z =
                        cosf(dustPosScale) * 7.0f32 +
                            (*this).dyna.actor.world.pos.z;
                    func_8002836C(globalCtx, &mut dustPos, &mut zeroVec,
                                  &mut zeroVec, &mut dustPrimColor,
                                  &mut dustEnvColor,
                                  200 as libc::c_int as s16,
                                  45 as libc::c_int as s16,
                                  12 as libc::c_int as s16);
                    dustPosScale += 60.0f32;
                    i -= 1
                }
                Actor_Kill(&mut (*this).dyna.actor);
                return
            }
            if (*this).deathTimer as libc::c_int % 4 as libc::c_int ==
                   0 as libc::c_int {
                Actor_SetColorFilter(&mut (*this).dyna.actor,
                                     0x4000 as libc::c_int as s16,
                                     255 as libc::c_int as s16,
        ...
        Actor_MoveForward(&mut (*this).dyna.actor);
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).dyna.actor, 20.0f32,
                                28.0f32, 80.0f32, 0x1d as libc::c_int);
    }
    Collider_UpdateCylinder(&mut (*this).dyna.actor,
                            &mut (*this).hurtCollider);
    Collider_UpdateCylinder(&mut (*this).dyna.actor,
                            &mut (*this).blockCollider);
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).hurtCollider.base);
    if (*this).dyna.actor.params as libc::c_int != ARMOS_STATUE as libc::c_int
       {
        Actor_SetFocus(&mut (*this).dyna.actor,
                       (*this).dyna.actor.scale.x * 4500.0f32);
        if (*this).dyna.actor.colorFilterTimer as libc::c_int ==
               0 as libc::c_int {
        ...
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).hurtCollider.base);
        if (*this).behavior >= 4 as libc::c_int &&
               (*this).unk_264 as libc::c_int > 0 as libc::c_int {
            if (*this).hitCollider.base.atFlags as libc::c_int &
                ...
                (*this).hitCollider.base.atFlags =
                    ((*this).hitCollider.base.atFlags as libc::c_int &
                        ...
                        u8_0;
                (*this).hitCollider.base.at = 0 as *mut Actor;
                EnAm_SetupRicochet(this, globalCtx);
            }
        }
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnAm_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
    ...
    if limbIndex == 1 as libc::c_int &&
           (*this).unk_264 as libc::c_int != 0 as libc::c_int {
        EnAm_TransformSwordHitbox(&mut (*this).dyna.actor, globalCtx);
    };
}
static mut sIcePosOffsets: [Vec3f; 12] =
    [{ let mut init = Vec3f{x: 20.0f32, y: 40.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 60.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 60.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -20.0f32, y: 40.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 60.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 60.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 40.0f32, z: -20.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 20.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 20.0f32, z: -10.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 40.0f32, z: 20.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 20.0f32, z: 10.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 20.0f32, z: -10.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnAm_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_am.c\x00" as *const u8 as *const libc::c_char,
                    1580 as libc::c_int);
    ...
    if (*this).iceTimer as libc::c_int != 0 as libc::c_int {
        (*this).dyna.actor.colorFilterTimer =
            (*this).dyna.actor.colorFilterTimer.wrapping_add(1);
        (*this).iceTimer -= 1;
        if (*this).iceTimer as libc::c_int % 4 as libc::c_int ==
            ...
            sp68.x =
                (*this).dyna.actor.world.pos.x +
                    sIcePosOffsets[index as usize].x;
            sp68.y =
                (*this).dyna.actor.world.pos.y +
                    sIcePosOffsets[index as usize].y;
            sp68.z =
                (*this).dyna.actor.world.pos.z +
                    sIcePosOffsets[index as usize].z;
            EffectSsEnIce_SpawnFlyingVec3f(globalCtx, &mut (*this).dyna.actor,
                                           &mut sp68,
                                           ...
                                           255 as libc::c_int as s16, 1.4f32);
        }
    }
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x13 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
