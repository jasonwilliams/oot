...
extern "C" {
    ...
    #[no_mangle]
    static mut gEffUnknown11Tex: [u64_0; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct OceffStorm {
    pub actor: Actor,
    pub counter: u16_0,
    pub primColorAlpha: u8_0,
    pub vtxAlpha: u8_0,
    pub posYOff: s16,
    pub posYOffAdd: s16,
    pub actionFunc: OceffStormActionFunc,
}
pub type OceffStormActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut OceffStorm, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Oceff_Storm_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OCEFF_STORM as libc::c_int as s16,
                          category:
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffStorm_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffStorm_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffStorm_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffStorm_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_SetupAction(mut this: *mut OceffStorm,
                                                mut actionFunc:
                                                    OceffStormActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut OceffStorm = thisx as *mut OceffStorm;
    OceffStorm_SetupAction(this,
                           Some(OceffStorm_DefaultAction as
                                    unsafe extern "C" fn(_: *mut OceffStorm,
                                                         _:
                                                             *mut GlobalContext)
                                        -> ()));
    (*this).posYOffAdd = 0 as libc::c_int as s16;
    (*this).counter = 0 as libc::c_int as u16_0;
    (*this).primColorAlpha = 0 as libc::c_int as u8_0;
    (*this).vtxAlpha = 0 as libc::c_int as u8_0;
...
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut OceffStorm = thisx as *mut OceffStorm;
...
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_DefaultAction(mut this: *mut OceffStorm,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    if ((*this).counter as libc::c_int) < 20 as libc::c_int {
        (*this).primColorAlpha =
            ((*this).counter as libc::c_int as libc::c_float * 5.0f32) as s8
                as u8_0
    } else if (*this).counter as libc::c_int > 80 as libc::c_int {
        (*this).primColorAlpha =
            ((100 as libc::c_int - (*this).counter as libc::c_int) as
                 libc::c_float * 5.0f32) as s8 as u8_0
    } else { (*this).primColorAlpha = 100 as libc::c_int as u8_0 }
    if ((*this).counter as libc::c_int) < 10 as libc::c_int ||
           (*this).counter as libc::c_int >= 90 as libc::c_int {
        (*this).vtxAlpha = 0 as libc::c_int as u8_0
    } else if (*this).counter as libc::c_int <= 65 as libc::c_int {
        if (*this).vtxAlpha as libc::c_int <= 200 as libc::c_int {
            (*this).vtxAlpha =
                ((*this).vtxAlpha as libc::c_int + 10 as libc::c_int) as u8_0
        }
        (*this).actor.scale.z = 0.4f32;
        (*this).actor.scale.x = (*this).actor.scale.z;
        (*this).actor.scale.y = 0.3f32
    } else if (*this).counter as libc::c_int > 65 as libc::c_int {
        (*this).vtxAlpha =
            ((90 as libc::c_int - (*this).counter as libc::c_int) *
                 10 as libc::c_int) as u8_0
    } else {
        (*this).vtxAlpha = 255 as libc::c_int as u8_0;
        (*this).actor.scale.z = 0.4f32;
        (*this).actor.scale.x = (*this).actor.scale.z
    }
    if (*this).counter as libc::c_int > 60 as libc::c_int {
        (*this).actor.world.pos.y +=
            (*this).posYOff as libc::c_int as libc::c_float * 0.01f32;
        (*this).posYOff =
            ((*this).posYOff as libc::c_int +
                 (*this).posYOffAdd as libc::c_int) as s16;
        (*this).posYOffAdd =
            ((*this).posYOffAdd as libc::c_int + 10 as libc::c_int) as s16
    }
...
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_UnkAction(mut this: *mut OceffStorm,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    if ((*this).primColorAlpha as libc::c_int) < 100 as libc::c_int {
        (*this).primColorAlpha =
            ((*this).primColorAlpha as libc::c_int + 5 as libc::c_int) as u8_0
    };
    // ! @bug Actor_Kill is never called so the actor will stay alive forever
}
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut OceffStorm = thisx as *mut OceffStorm;
    let mut player: *mut Player =
...
static mut sTex: [u64_0; 512] =
    [0x2f6e6f596197b3cc as libc::c_longlong as u64_0,
     0xc8ad8e6c5333170a as libc::c_ulonglong,
     0x1736617386abc7c6 as libc::c_longlong as u64_0,
     0xa9928c7e55496341 as libc::c_ulonglong,
     0x40705b5979a5dae8 as libc::c_longlong as u64_0,
     0xc9a5927f6f50270d as libc::c_ulonglong,
     0x17304f6c8baac3b9 as libc::c_longlong as u64_0,
     0x9189a0a5854a2f1f as libc::c_ulonglong,
     0x33808e74709bb7cc as libc::c_longlong as u64_0,
     0xc6b18e694627100d as libc::c_ulonglong,
     0x214068809bc2dac1 as libc::c_longlong as u64_0,
     0x92808378514b7350 as libc::c_ulonglong,
     0x386e676880aae1e4 as libc::c_longlong as u64_0,
     0xc6a0866d644b2513 as libc::c_ulonglong,
     0x2541617fa2bbd7c6 as libc::c_longlong as u64_0,
     0x9c97b8b986322a2c as libc::c_ulonglong,
     0x3381a28f82a0beca as libc::c_longlong as u64_0,
     0xcbbf956b40210a15 as libc::c_ulonglong,
     0x2f4d718fb1d7e8ba as libc::c_longlong as u64_0,
     0x856b706d49447654 as libc::c_ulonglong,
     0x366c6c7187addfd8 as libc::c_longlong as u64_0,
     0xb8967b68543a1b15 as libc::c_ulonglong,
     0x32537094b5d1e5cf as libc::c_longlong as u64_0,
     0xaea9c9cd9f3c3235 as libc::c_ulonglong,
     0x3883aea898a4c1c5 as libc::c_longlong as u64_0,
     0xc9cca57645210d1d as libc::c_ulonglong,
     0x3c5d7e9fc3e7efaf as libc::c_longlong as u64_0,
     0x785b5c5b3935684f as libc::c_longlong as u64_0,
     0x36646a798fadd5c9 as libc::c_longlong as u64_0,
     0xa687756140271721 as libc::c_ulonglong,
     0x406180a5c7e2eed5 as libc::c_longlong as u64_0,
     0xc1bdcacdad46333d as libc::c_ulonglong,
     0x3a82b5bbadadc5bd as libc::c_longlong as u64_0,
     0xc4d5b282532c152a as libc::c_ulonglong,
     0x4b6d8fb0d5f4f4ad as libc::c_longlong as u64_0,
     0x73534f4d2d28584d as libc::c_longlong as u64_0,
     0x3c5e69819ab0ccbb as libc::c_longlong as u64_0,
     0x987b775e2d151b2f as libc::c_ulonglong,
     0x507192b8daf0f2d6 as libc::c_longlong as u64_0,
     0xd0cac1c0b5573241 as libc::c_ulonglong,
     0x4180b2c3bfb9c8b3 as libc::c_longlong as u64_0,
     0xb9ccb0855e392138 as libc::c_ulonglong,
     0x5b7da1c3e5fbf8bc as libc::c_longlong as u64_0,
     0x805b534f383c605e as libc::c_ulonglong,
     0x5363738fa9b7cab1 as libc::c_longlong as u64_0,
     0x8e79805e1f10233f as libc::c_ulonglong,
     0x6081a4caeafaf1cf as libc::c_longlong as u64_0,
     0xd4cbb0b2c06e3246 as libc::c_ulonglong,
     0x4d7ba9c3c8c4caab as libc::c_longlong as u64_0,
     0xa5af977762463249 as libc::c_ulonglong,
     0x6b90b4d4f2fefbd3 as libc::c_longlong as u64_0,
     0xa47b6b69686b7d7e as libc::c_ulonglong,
     0x777d869db4c3c6a8 as libc::c_longlong as u64_0,
     0x8e888e5f1b173050 as libc::c_ulonglong,
     0x7292b8dcf6ffe7c0 as libc::c_longlong as u64_0,
     0xc2b99cacc682334e as libc::c_ulonglong,
     0x57779ebbcbcfd0a4 as libc::c_longlong as u64_0,
     0x8d856e585b514459 as libc::c_ulonglong,
     0x7ba1c6e5fafffee9 as libc::c_longlong as u64_0,
     0xc9a48d8f8c868e92 as libc::c_ulonglong,
     0x8c999da8bccabe9f as libc::c_ulonglong,
     0x99a4a06523254060 as libc::c_ulonglong,
     0x83a4cbebfcffddac as libc::c_ulonglong,
     0xa69d8cafc8993a56 as libc::c_ulonglong,
     0x617998b5cbd7d29f as libc::c_longlong as u64_0,
     0x765b4138505d596e as libc::c_longlong as u64_0,
     0x8cb2d6f1fefffef8 as libc::c_ulonglong,
     0xe7c5b0ada295979b as libc::c_ulonglong,
     0x99afb3b2c3cab197 as libc::c_ulonglong,
     0xa9c1b36f32354f72 as libc::c_ulonglong,
     0x94b5dcf6ffffd99f as libc::c_ulonglong,
     0x8e898bb8c3a84a5d as libc::c_ulonglong,
     0x6e819ab5cedecf98 as libc::c_longlong as u64_0,
     0x654023234b6b7283 as libc::c_longlong as u64_0,
     0x9ec1e4fafffffcf7 as libc::c_ulonglong,
     0xf6dac7c2ac96929d as libc::c_ulonglong,
     0xa2bfc5bdc9c6a192 as libc::c_ulonglong,
     0xb6d7c68249466281 as libc::c_ulonglong,
     0xa4c4ecfdffffdfad as libc::c_ulonglong,
     0x95919dbeb8b26768 as libc::c_ulonglong,
     0x8190a4bcd5dfc38c as libc::c_ulonglong,
     0x61402328547d8c99 as libc::c_longlong as u64_0,
     0xadcfebfafefffaf1 as libc::c_ulonglong,
     0xf3dcd0c89c808aa2 as libc::c_ulonglong,
     0xa9c9d4cad0c09d94 as libc::c_ulonglong,
     0xb9dcd7a2685d7290 as libc::c_ulonglong,
     0xb2cff4ffffffebc6 as libc::c_ulonglong,
     0xada2aabeb1b98781 as libc::c_ulonglong,
     0x99a2b1c6dedbad7e as libc::c_ulonglong,
     0x6957393a6995a8af as libc::c_longlong as u64_0,
     0xbed7e7eff7fefaed as libc::c_ulonglong,
     0xe8d1cec1907595aa as libc::c_ulonglong,
     0xb3cedfd7d5b69f99 as libc::c_ulonglong,
     0xadcee4c48b7482a0 as libc::c_ulonglong,
     0xbfcff2fcfefff7dd as libc::c_ulonglong,
     0xc7b5b2b5b0b69390 as libc::c_ulonglong,
     0xadb8c0d4e9d69970 as libc::c_ulonglong,
     0x7474565682aec0c0 as libc::c_longlong as u64_0,
     0xc9d9dbdceaf8faeb as libc::c_ulonglong,
     0xdec9c4b88f71a5b5 as libc::c_ulonglong,
     0xc1d6e7e4d7afa39d as libc::c_ulonglong,
     0x9cbaece1ad8a93af as libc::c_ulonglong,
     0xc5c6e1f1fafefced as libc::c_ulonglong,
     0xdac6b0a6acad9094 as libc::c_ulonglong,
     0xb5cdd2e3f3d38d69 as libc::c_ulonglong,
     0x808a6d70a0c7cecb as libc::c_ulonglong,
     0xd1d8ccc6d4eff9e9 as libc::c_ulonglong,
     0xd5c3bcad937ab7be as libc::c_ulonglong,
     0xcbdfefeed3a5a097 as libc::c_ulonglong,
     0x88a4edf6c39ca2bf as libc::c_ulonglong,
     0xc4b5c9deeef7f9ed as libc::c_ulonglong,
     0xdac4a092a0967c8b as libc::c_ulonglong,
     0xb1dfe4eef9da926c as libc::c_ulonglong,
     0x83927c84bcd7d5d5 as libc::c_ulonglong,
     0xd8d5c0b2b9ddf4e1 as libc::c_ulonglong,
     0xcfbcb4a4a190c5c3 as libc::c_ulonglong,
     0xcfe3f4f6cd9b9388 as libc::c_ulonglong,
     0x7899e8f9cca8b3cd as libc::c_longlong as u64_0,
     0xbda0acc3dbedf4e4 as libc::c_ulonglong,
     0xd7c094818b7c5b71 as libc::c_ulonglong,
     0xabededf0fce6a97a as libc::c_ulonglong,
     0x818b8198d1ddd5dc as libc::c_ulonglong,
     0xddd2b9a49fccecd5 as libc::c_ulonglong,
     0xccbaaf9facaacac9 as libc::c_ulonglong,
     0xdaebf8fac68f7e72 as libc::c_ulonglong,
     0x6f98e2f1cbb1c2d8 as libc::c_longlong as u64_0,
     0xb49191a8c6e4ead7 as libc::c_ulonglong,
     0xccbb8b757867495e as libc::c_ulonglong,
     0xadf6efe5f7f1c692 as libc::c_ulonglong,
     0x817f84a9dedbd2e3 as libc::c_ulonglong,
     0xdeccb2998abbe1c7 as libc::c_ulonglong,
     0xcab6a7a4b5c1c6c4 as libc::c_ulonglong,
     0xe1f4fcfcc3876a5e as libc::c_ulonglong,
     0x6c98dae8c4b8cfda as libc::c_longlong as u64_0,
     0xa9858399bbdedcc9 as libc::c_ulonglong,
     0xc2b2846d6d5d4357 as libc::c_ulonglong,
     0xbcfbead2e7f7e1af as libc::c_ulonglong,
     0x85798db9dfd2d1e5 as libc::c_ulonglong,
     0xd6bca48c81b1dabf as libc::c_ulonglong,
     0xcbb399a9bfc9b1b1 as libc::c_ulonglong,
     0xe1fafefec8895f55 as libc::c_ulonglong,
     0x6d9dd8dfc1c2d3d0 as libc::c_longlong as u64_0,
     0x9e80829dbfdacdb7 as libc::c_ulonglong,
     0xb8b0846e6e5e4061 as libc::c_ulonglong,
     0xd3fee5bccfecf1cf as libc::c_ulonglong,
     0x9882a0cadac7cedd as libc::c_ulonglong,
     0xc19f8b7d82b5d7c0 as libc::c_ulonglong,
     0xcbb288a1b4b98e8f as libc::c_ulonglong,
     0xd9fefffed697695c as libc::c_ulonglong,
     0x729fdadbc5c8c9bc as libc::c_longlong as u64_0,
     0x928392b5ccd3bfa8 as libc::c_ulonglong,
     0xb3b4917877603c76 as libc::c_ulonglong,
     0xe6ffe6abb1d4ede6 as libc::c_ulonglong,
     0xb094b9d3d1c0c6cb as libc::c_ulonglong,
     0xa37e6f6e92c0d5c3 as libc::c_ulonglong,
     0xcaac758f9f996568 as libc::c_ulonglong,
     0xc8feffffe6b28271 as libc::c_ulonglong,
     0x7ba5dfd9c8c7b9a0 as libc::c_longlong as u64_0,
     0x878caecfd2cbb69d as libc::c_ulonglong,
     0xb2b9a4857d5c368e as libc::c_ulonglong,
     0xf2ffe89f95b8daf3 as libc::c_ulonglong,
     0xc9a9ccd5c7bcbdb3 as libc::c_ulonglong,
     0x84615364a6c7d3c9 as libc::c_ulonglong,
     0xc3a064728372444b as libc::c_ulonglong,
     0xb1fafffff4d1a890 as libc::c_ulonglong,
     0x8bb1e1d6c9c09f87 as libc::c_ulonglong,
     0x7a95c9dfd2bdaf93 as libc::c_longlong as u64_0,
     0xb3c0b2907c5138a6 as libc::c_ulonglong,
     0xfaffe38f88a4bff2 as libc::c_ulonglong,
     0xddbad7d0c0bcb09a as libc::c_ulonglong,
     0x70534569b9c6cac6 as libc::c_longlong as u64_0,
     0xb18d5b515f50363f as libc::c_ulonglong,
     0x92f0fffffde9cdb5 as libc::c_ulonglong,
     0xa8c1decec4b18b74 as libc::c_ulonglong,
     0x6b98dbe4c9b0a48a as libc::c_longlong as u64_0,
     0xa9bab494784541bd as libc::c_ulonglong,
     0xfcfac9788da8a6e6 as libc::c_ulonglong,
     0xe9c6dac5bdbfa385 as libc::c_ulonglong,
     0x6e61537ac3bab7b3 as libc::c_longlong as u64_0,
     0x9776514150433d4a as libc::c_ulonglong,
     0x70d8fffffcf3e6d6 as libc::c_longlong as u64_0,
     0xc6d0d7c4bca17e69 as libc::c_ulonglong,
     0x5b90e1dfc3ad9c80 as libc::c_longlong as u64_0,
     0x93a3a38d723c4eca as libc::c_ulonglong,
     0xf3eba45d99bc98d7 as libc::c_ulonglong,
     0xf0cdd2bab9bd9475 as libc::c_ulonglong,
     0x7a7d6c91c2a6a29c as libc::c_longlong as u64_0,
     0x7c634a3a50414a64 as libc::c_longlong as u64_0,
     0x55b9fdfff7e6f1ed as libc::c_longlong as u64_0,
     0xe0dacebab394725f as libc::c_ulonglong,
     0x4a7ad6d8c1af9c7c as libc::c_longlong as u64_0,
     0x7d8886806e3557ca as libc::c_longlong as u64_0,
     0xdecf7743a2cd99cf as libc::c_ulonglong,
     0xefcfc7afb1b38063 as libc::c_ulonglong,
     0x809482a2bc978e82 as libc::c_ulonglong,
     0x6a5e43394d3f5077 as libc::c_longlong as u64_0,
     0x4b90fbfff1cee6f1 as libc::c_longlong as u64_0,
     0xf0dfc3b0a8896454 as libc::c_ulonglong,
     0x3a60c2d1b9a99f85 as libc::c_longlong as u64_0,
     0x64656776743854ba as libc::c_longlong as u64_0,
     0xbbaa4e2d9ccfa4d6 as libc::c_ulonglong,
     0xedccbda5a19f6d54 as libc::c_ulonglong,
     0x7b998aa4b79a8b71 as libc::c_longlong as u64_0,
     0x615e414549384b79 as libc::c_longlong as u64_0,
     0x4f67f7ffedb7ccdf as libc::c_longlong as u64_0,
     0xebdcb9a59a7c5846 as libc::c_ulonglong,
     0x2f43a4c3ada0a097 as libc::c_longlong as u64_0,
     0x624b557685504a95 as libc::c_longlong as u64_0,
     0x8c853a1f80bcbbdf as libc::c_ulonglong,
     0xe6cab9a392885e46 as libc::c_ulonglong,
     0x65827b95a59b9778 as libc::c_longlong as u64_0,
     0x5c57546e5b333d67 as libc::c_longlong as u64_0,
     0x574df0ffefacafbd as libc::c_longlong as u64_0,
     0xd2daad98896e4d39 as libc::c_ulonglong,
     0x282882ad9d9298a0 as libc::c_longlong as u64_0,
     0x7e5f6188a27a516c as libc::c_longlong as u64_0,
     0x5f6a38175c99cee7 as libc::c_longlong as u64_0,
     0xdfcbbda88e7d5e48 as libc::c_ulonglong,
     0x4d5e60798d929b8c as libc::c_longlong as u64_0,
     0x584e75a186412c4b as libc::c_longlong as u64_0,
     0x583ae8fff5b99292 as libc::c_longlong as u64_0,
     0xb3d3a48a775e412c as libc::c_ulonglong,
     0x211961918f8187a4 as libc::c_longlong as u64_0,
     0x9a857d9fbfa9724e as libc::c_ulonglong,
     0x3c5f3a153871dae8 as libc::c_longlong as u64_0,
     0xdad1c6b39b887055 as libc::c_ulonglong,
     0x4139405d73859fa4 as libc::c_longlong as u64_0,
     0x584e9eccb7632338 as libc::c_longlong as u64_0,
     0x513adafffbca7e6a as libc::c_longlong as u64_0,
     0x90cda17f6b533821 as libc::c_ulonglong,
     0x1b10457a8c807a9f as libc::c_longlong as u64_0,
     0xb7ab96adcecc9c4a as libc::c_ulonglong,
     0x2c6240132151e1de as libc::c_longlong as u64_0,
     0xd7d2cebcaea28a68 as libc::c_ulonglong,
     0x411f324e536f9fb9 as libc::c_longlong as u64_0,
     0x6c6fc7ede1872736 as libc::c_longlong as u64_0,
     0x4d3fc6fefeda724a as libc::c_longlong as u64_0,
     0x72c2a57f6e59361d as libc::c_longlong as u64_0,
     0x1710356d918a7d9b as libc::c_longlong as u64_0,
     0xcfc09fa7c7d2b854 as libc::c_ulonglong,
     0x326e41132540dcd5 as libc::c_longlong as u64_0,
     0xd5ccd0bbbeb9a378 as libc::c_ulonglong,
     0x481d40554d63a2c1 as libc::c_longlong as u64_0,
     0x939fe2fcfaa42f3f as libc::c_ulonglong,
     0x4b45aafbffe46838 as libc::c_longlong as u64_0,
     0x63b5b09187744f2a as libc::c_longlong as u64_0,
     0x1b15356d97998ea9 as libc::c_longlong as u64_0,
     0xcbb58f8aa4b9b553 as libc::c_ulonglong,
     0x417d3f172d39d8cf as libc::c_longlong as u64_0,
     0xd1becbb3c6c6b583 as libc::c_ulonglong,
     0x4527606d576dafbf as libc::c_longlong as u64_0,
     0xb8c5f3fdffb93541 as libc::c_ulonglong,
     0x494d86f2fee25932 as libc::c_longlong as u64_0,
     0x5db0baa49f967343 as libc::c_longlong as u64_0,
     0x21193c729fa9a4bd as libc::c_longlong as u64_0,
     0xb8926c62748a9549 as libc::c_ulonglong,
     0x51873d193238d4ce as libc::c_longlong as u64_0,
     0xc8adc2a6c4c9c089 as libc::c_ulonglong,
     0x3f2d7f8a6a7dbcb8 as libc::c_longlong as u64_0,
     0xd6e4fafeffc7333d as libc::c_ulonglong,
     0x454a63dbf8d34d36 as libc::c_longlong as u64_0,
     0x61adc0b2b1b3955e as libc::c_longlong as u64_0,
     0x2c214477a4b7bacc as libc::c_longlong as u64_0,
     0x9e61443843516436 as libc::c_ulonglong,
     0x5f83391b3338cccf as libc::c_longlong as u64_0,
     0xbea0bc9dc2c4c990 as libc::c_ulonglong,
     0x403a99a88090c5b1 as libc::c_longlong as u64_0,
     0xe9f1fcfffdd63238 as libc::c_ulonglong,
     0x394445bbdcb14540 as libc::c_longlong as u64_0,
     0x73b5c3bcbfc6ac72 as libc::c_longlong as u64_0,
     0x3c304d7ba5bcc9da as libc::c_longlong as u64_0,
     0x7e3621171d27352f as libc::c_longlong as u64_0,
     0x5f7238213238c2d2 as libc::c_longlong as u64_0,
     0xb59db99fc1c0d09b as libc::c_ulonglong,
     0x4e46a9bc9da9cab5 as libc::c_longlong as u64_0,
     0xedf5fef9f6e43236 as libc::c_ulonglong,
     0x2d353592b08d544d as libc::c_longlong as u64_0,
     0x88b9c3bfc0c4a97a as libc::c_ulonglong,
     0x50455579a2bccddf as libc::c_longlong as u64_0,
     0x7427131932251738 as libc::c_longlong as u64_0,
     0x535539283238b5d2 as libc::c_longlong as u64_0,
     0xb19dbcabc0bfd8a9 as libc::c_ulonglong,
     0x624eadc9b7c3d2c3 as libc::c_longlong as u64_0,
     0xeffafeefedf03536 as libc::c_ulonglong,
     0x232335697f797259 as libc::c_longlong as u64_0,
     0x99b5c3c3bbb2977c as libc::c_ulonglong,
     0x6c65637b9fb9cee3 as libc::c_longlong as u64_0,
     0x862f193260401040 as libc::c_ulonglong,
     0x40393632383fa7d2 as libc::c_longlong as u64_0,
     0xb5a3bfb9c0c3e1b8 as libc::c_ulonglong,
     0x7759a7cfccd9dfda as libc::c_longlong as u64_0,
     0xf2fefde6e8f23539 as libc::c_ulonglong,
     0x1f19324a50759267 as libc::c_longlong as u64_0,
     0xa5adc5cab59c827d as libc::c_ulonglong,
     0x8a8676809eb8cce8 as libc::c_ulonglong,
     0xa03d2f579664153d as libc::c_ulonglong,
     0x2d283538414a98cf as libc::c_longlong as u64_0,
     0xbaadbec0c3cfe7c3 as libc::c_ulonglong,
     0x8a639fccd8e6e8eb as libc::c_ulonglong,
     0xf6fffde5ebea3238 as libc::c_ulonglong,
     0x1d1730353d7da973 as libc::c_longlong as u64_0,
     0xa9a4c5ceab82778a as libc::c_ulonglong,
     0xa9a5888aa4bcc6e6 as libc::c_ulonglong,
     0xba4f548ac6881f33 as libc::c_ulonglong,
     0x302d3239535c8ac9 as libc::c_longlong as u64_0,
     0xbab6bac1cbd6e6cb as libc::c_ulonglong,
     0x967195c3d7e6eef8 as libc::c_ulonglong,
     0xfafffdebf1d42a35 as libc::c_ulonglong,
     0x1f25322f417daf7d as libc::c_longlong as u64_0,
     0xa6acc0cea27583a9 as libc::c_ulonglong,
     0xc9bf9898b0bebee1 as libc::c_ulonglong,
     0xcc6585bbe7a53832 as libc::c_ulonglong,
     0x4e402f38697084c4 as libc::c_longlong as u64_0,
     0xb3beb4bdd5d7e1cc as libc::c_ulonglong,
     0x9f7e92bcd2e4effb as libc::c_ulonglong,
     0xfefffef6f4b5212c as libc::c_ulonglong,
     0x273c3a304a70ac89 as libc::c_longlong as u64_0,
     0xa3b7bccd9f7499c8 as libc::c_ulonglong,
     0xe1cfa3a4bcbdb0d7 as libc::c_ulonglong,
     0xd87db5dff9bc604b as libc::c_ulonglong,
     0x7454323d7c7d7fbf as libc::c_longlong as u64_0,
     0xaac1b1bedfd8d9cb as libc::c_ulonglong,
     0xa48994b5cee1e6f1 as libc::c_ulonglong,
     0xfefffffef59f2d30 as libc::c_ulonglong,
     0x3d574d365462a394 as libc::c_longlong as u64_0,
     0xa2c2b9cfa277afe1 as libc::c_ulonglong,
     0xf3daabafc4b69fcf as libc::c_ulonglong,
     0xe29fdbf6fecf947d as libc::c_ulonglong,
     0x9c65414d898282bb as libc::c_ulonglong,
     0xa3c3b4c6e6dcd7c7 as libc::c_ulonglong,
     0xa2919cb6cfe1dbe2 as libc::c_ulonglong,
     0xfdfffffff4a56358 as libc::c_ulonglong,
     0x64725c3d5f5f9fa0 as libc::c_longlong as u64_0,
     0xa1c9b9d4a47bb8ed as libc::c_ulonglong,
     0xfadfb5b9c8ae99cf as libc::c_ulonglong,
     0xecc3f3fefee1c3b2 as libc::c_ulonglong,
     0xbb765b698d7d90ba as libc::c_ulonglong,
     0xa9c6bcd5efe6dfc5 as libc::c_ulonglong,
     0x9f97a8c0d9e7cdcc as libc::c_ulonglong,
     0xf9fffffff6c09d90 as libc::c_ulonglong,
     0x918663436564a7ab as libc::c_ulonglong,
     0xa2ccc1dca379b3e6 as libc::c_ulonglong,
     0xf6e1bec4cbb2aada as libc::c_ulonglong,
     0xf6e0fdfffff1e4d7 as libc::c_ulonglong,
     0xcd877d8b8e7596bd as libc::c_ulonglong,
     0xb6c8c7e5f6f3e8c3 as libc::c_ulonglong,
     0x9d9fb2cce5ecb9b3 as libc::c_ulonglong,
     0xf4fffffef9ddc6b9 as libc::c_ulonglong,
     0xb78f6549646eb0b4 as libc::c_ulonglong,
     0xa9d0cce5a378a6d5 as libc::c_ulonglong,
     0xebe1c6ccccbfc6e8 as libc::c_ulonglong,
     0xfbf5fefffffbf4e9 as libc::c_ulonglong,
     0xd99fa2a9947399bd as libc::c_ulonglong,
     0xc1ccd2f1fbfcf2c3 as libc::c_ulonglong,
     0x9fa7bed5e9e4a299 as libc::c_ulonglong,
     0xebfefffdfaefe3d5 as libc::c_ulonglong,
     0xce8c6150657eb9ba as libc::c_ulonglong,
     0xafd4d7efa97d9ac3 as libc::c_ulonglong,
     0xdfdccccfcacae0f6 as libc::c_ulonglong,
     0xfcf7f7fefffef3ea as libc::c_ulonglong,
     0xdab5b9baa2819ebb as libc::c_ulonglong,
     0xc8d0defafffff6c6 as libc::c_ulonglong,
     0xa7b3c5d1decf887e as libc::c_ulonglong,
     0xd6f9fffdf9efe4d8 as libc::c_ulonglong,
     0xd58461607396b9bd as libc::c_ulonglong,
     0xb9d7e3f7b48899b9 as libc::c_ulonglong,
     0xd2d7d2cdc0caf1fd as libc::c_ulonglong,
     0xf1e4e6f9fffdebe0 as libc::c_ulonglong,
     0xd6bebebba890a3bc as libc::c_ulonglong,
     0xc9d7eafefffff6c9 as libc::c_ulonglong,
     0xb4bdc2c0c2ac6963 as libc::c_ulonglong,
     0xb6ebfefdf8e6d7c9 as libc::c_ulonglong,
     0xcc78687a8da3adbb as libc::c_ulonglong,
     0xc6deedfbc79faabb as libc::c_ulonglong,
     0xcad3d8c9acb5e8f8 as libc::c_ulonglong,
     0xdec9cdebfdfae7da as libc::c_ulonglong,
     0xceb9b1aaa18f99b9 as libc::c_ulonglong,
     0xcce2f4fffffff5ce as libc::c_ulonglong,
     0xc0c0b7a6997e4948 as libc::c_ulonglong,
     0x91d7fdfef8e0ccc0 as libc::c_ulonglong,
     0xbc6b71929fa39cb5 as libc::c_ulonglong,
     0xd1e7f6feddbcc5c6 as libc::c_ulonglong,
     0xc9d5e3c48f92d1e8 as libc::c_ulonglong,
     0xc6a9b0dbf7f6e7d6 as libc::c_ulonglong,
     0xbca3958d8a818ab1 as libc::c_ulonglong,
     0xd3edfbfffffff2d2 as libc::c_ulonglong,
     0xc5bca4896f542f32 as libc::c_ulonglong,
     0x6bbefbfffadcc2b8 as libc::c_longlong as u64_0,
     0xae657aa9a9988ab1 as libc::c_ulonglong,
     0xddf1fcffedd7ddd0 as libc::c_ulonglong,
     0xcbdcefbf716ab1d2 as libc::c_ulonglong,
     0xac9199caeeede6d0 as libc::c_ulonglong,
     0xa884786e656373a1 as libc::c_ulonglong,
     0xd6f4fffeffffefd3 as libc::c_ulonglong,
     0xc3b0906f4e331b23 as libc::c_ulonglong,
     0x4fa5f7fff8d7b8b1 as libc::c_longlong as u64_0,
     0xa56780b5ac8785b3 as libc::c_ulonglong,
     0xe9fbfffffaededd4 as libc::c_ulonglong,
     0xcbe4f8bc57458fb9 as libc::c_ulonglong,
     0x9b878fbce1dfdfc4 as libc::c_ulonglong,
     0x916d5f5046455189 as libc::c_ulonglong,
     0xccf6fffeffffe8cf as libc::c_ulonglong,
     0xba9f82603a1f101f as libc::c_ulonglong,
     0x4692f4fef4d1b0ac as libc::c_longlong as u64_0,
     0xa97382b3ab878cc2 as libc::c_ulonglong,
     0xf2fefffffefaf1cf as libc::c_ulonglong,
     0xc4e8fcb4453278a5 as libc::c_ulonglong,
     0x968a92bbd6ced1b1 as libc::c_ulonglong,
     0x7c604e3a323c4b74 as libc::c_longlong as u64_0,
     0xb9f1fffefffce0c7 as libc::c_ulonglong,
     0xae92795630151027 as libc::c_ulonglong,
     0x4888edfaefcba9a6 as libc::c_longlong as u64_0,
     0xb28384adb4969ed6 as libc::c_ulonglong,
     0xfafffffffffae8c3 as libc::c_ulonglong,
     0xb6ddf4a93925659a as libc::c_ulonglong,
     0x99959ebecdbcbb9a as libc::c_ulonglong,
     0x6c5b452c25435772 as libc::c_longlong as u64_0,
     0xa8ebfffefff6d2bb as libc::c_ulonglong,
     0xa28972502c131730 as libc::c_ulonglong,
     0x5186e4f1e5c3a5a3 as libc::c_longlong as u64_0,
     0xba9689a6c3acb5ea as libc::c_ulonglong,
     0xfefefffffff4d9b3 as libc::c_ulonglong,
     0xa2c5dc95301f5b96 as libc::c_ulonglong,
     0xa4a5acc3c3aba183 as libc::c_ulonglong,
     0x605741211f4d6a82 as libc::c_longlong as u64_0,
     0xa6eafffffdecc4ac as libc::c_ulonglong,
     0x96826d4e2f1b213f as libc::c_ulonglong,
     0x608bdbe2d5baa3a2 as libc::c_longlong as u64_0,
     0xbca991a6d0c1ccf7 as libc::c_ulonglong,
     0xfefcfffffce7c9a2 as libc::c_ulonglong,
     0x8aa0b87a271f5998 as libc::c_ulonglong,
     0xb5b7b9c8b99d8a70 as libc::c_ulonglong,
     0x59503a191f577f9e as libc::c_longlong as u64_0,
     0xbfeffffff7deb59b as libc::c_ulonglong,
     0x8a7d654d3d2f324e as libc::c_ulonglong,
     0x6f98d1cfc3afa2a4 as libc::c_longlong as u64_0,
     0xbab79daed9d2e1fe as libc::c_ulonglong,
     0xfefcfffef6d7b691 as libc::c_ulonglong,
     0x7576895c1d21599f as libc::c_longlong as u64_0,
     0xcac8c3c9ac907964 as libc::c_ulonglong,
     0x51453013215e92bd as libc::c_longlong as u64_0,
     0xdaf6fffcedcea58a as libc::c_ulonglong,
     0x7d7a604e5549415e as libc::c_longlong as u64_0,
     0x82a4ccbdada09ea4 as libc::c_ulonglong,
     0xb5c1adbbe1dfefff as libc::c_ulonglong,
     0xfefcfffbe9c5a581 as libc::c_ulonglong,
     0x61505b3f192a60a8 as libc::c_longlong as u64_0,
     0xdad1c9c69e836d5d as libc::c_ulonglong,
     0x4936230d2361a5d9 as libc::c_longlong as u64_0,
     0xf1fdfef7ddbc9476 as libc::c_ulonglong,
     0x6e745c536b5f5371 as libc::c_longlong as u64_0,
     0x92b2c9af9a8e919f as libc::c_ulonglong,
     0xb1c8bec9e4e7f9ff as libc::c_ulonglong,
     0xfefdfef3dab29471 as libc::c_ulonglong,
     0x4f35352d1d3869b3 as libc::c_longlong as u64_0,
     0xe1d2c9c091776859 as libc::c_ulonglong,
     0x3f2517102767b9ee as libc::c_longlong as u64_0,
     0xfefffceccaa88364 as libc::c_ulonglong,
     0x5e6c58597d706282 as libc::c_longlong as u64_0,
     0xa3c0c6a68b7b7c8c as libc::c_ulonglong,
     0xacc9c6cbdeebfeff as libc::c_ulonglong,
     0xfffffae6c7a08563 as libc::c_ulonglong,
     0x3f231f272a4874bb as libc::c_longlong as u64_0,
     0xdfcbc3b78a736c5b as libc::c_ulonglong,
     0x3219131f2a69c6fa as libc::c_longlong as u64_0,
     0xfffff6dcb8957253 as libc::c_ulonglong,
     0x4e5f596384797394 as libc::c_longlong as u64_0,
     0xb5c9c09f826f6570 as libc::c_ulonglong,
     0xa5c6bfbccfecffff as libc::c_ulonglong,
     0xfffdefd5b48f7454 as libc::c_ulonglong,
     0x3017172d3c5d82bd as libc::c_longlong as u64_0,
     0xd5c0b9b08c7d7a5b as libc::c_ulonglong,
     0x271b132f306cd2fe as libc::c_longlong as u64_0,
     0xfffeebcca5856143 as libc::c_ulonglong,
     0x3c505b6d837b82a5 as libc::c_longlong as u64_0,
     0xc3cfb8977e695751 as libc::c_ulonglong,
     0x9cc0a9a0b8e6ffff as libc::c_ulonglong,
     0xfff6e2c8a47d6346 as libc::c_ulonglong,
     0x231019394f7091c3 as libc::c_longlong as u64_0,
     0xcab3aba999928955 as libc::c_ulonglong,
     0x1f23173a3975d9fe as libc::c_longlong as u64_0,
     0xfff8dcba94765333 as libc::c_ulonglong,
     0x2c415d737d7d92b6 as libc::c_longlong as u64_0,
     0xd2d0ae927a675136 as libc::c_ulonglong,
     0x8eb389799eddfeff as libc::c_ulonglong,
     0xfdecd4c19b6f5039 as libc::c_ulonglong,
     0x190d23456181a0c4 as libc::c_longlong as u64_0,
     0xc0a89fa6aba98f48 as libc::c_ulonglong,
     0x1b271940437ccff4 as libc::c_longlong as u64_0,
     0xf3e4c3a182674023 as libc::c_ulonglong,
     0x1f365e71757f9dc1 as libc::c_longlong as u64_0,
     0xd8c4a18a705d4f25 as libc::c_ulonglong,
     0x7c9f675685c9edf7 as libc::c_longlong as u64_0,
     0xedd5c3b98f5f3d2c as libc::c_ulonglong,
     0x1310274a688da4bc as libc::c_longlong as u64_0,
     0xad998fa0b2ad8236 as libc::c_ulonglong,
     0x234633434b85c4e6 as libc::c_longlong as u64_0,
     0xe2cdae8d72563215 as libc::c_ulonglong,
     0x15305f6f718aa9c6 as libc::c_longlong as u64_0,
     0xceb99c8464534e25 as libc::c_ulonglong,
     0x658a514678b3e1f2 as libc::c_longlong as u64_0,
     0xe2c1b4a98759351f as libc::c_ulonglong,
     0xd1733507292acba as libc::c_longlong as u64_0,
     0x9e8f8792a0956725 as libc::c_ulonglong,
     0x2a5c534b5691bcd9 as libc::c_longlong as u64_0,
     0xd5bb9e7d6245250d as libc::c_ulonglong,
     0x13305f6f7999b8ca as libc::c_longlong as u64_0,
     0xc0a897825c4b5732 as libc::c_ulonglong,
     0x517a504b74aadcef as libc::c_longlong as u64_0,
     0xd7b4a4977e562d15 as libc::c_ulonglong,
     0x1023405e7e9fb7b9 as libc::c_longlong as u64_0,
     0x95898f9790734619 as libc::c_ulonglong];
// Initialized in run_static_initializers
static mut sCylinderMaterialDL: [Gfx; 21] =
    [Gfx{words: Gwords{w0: 0, w1: 0,},}; 21];
static mut sCylinderVtx: [Vtx; 27] =
    [Vtx{v:
             {
                 let mut init =
                     Vtx_t{ob:
...
// Initialized in run_static_initializers
static mut sCylinderModelDL: [Gfx; 18] =
    [Gfx{words: Gwords{w0: 0, w1: 0,},}; 18];
// Initialized in run_static_initializers
static mut sMaterialDL: [Gfx; 21] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 21];
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_Draw2(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_oceff_storm.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_3).words.w1 = sMaterialDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_4).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         scroll.wrapping_mul(8 as libc::c_int as
                                                 libc::c_uint),
                         scroll.wrapping_mul(4 as libc::c_int as
                                                 libc::c_uint),
    ...
    (*_g_5).words.w0 =
        (0xe4 as libc::c_int as u32_0 &
            ...
            |
            (((240 as libc::c_int) << 2 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 12 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_5).words.w1 =
        (0 as libc::c_int as u32_0 &
    ...
    (*_g_7).words.w1 =
        (140 as libc::c_int as u32_0 &
            ...
            (((1 as libc::c_int) << 15 as libc::c_int |
                  ...
                  884 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_oceff_storm.c\x00" as *const u8 as
                         *const libc::c_char, 477 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn OceffStorm_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut scroll: u32_0 =
        (*globalCtx).state.frames & 0xfff as libc::c_int as libc::c_uint;
    let mut this: *mut OceffStorm = thisx as *mut OceffStorm;
    let mut vtxPtr: *mut Vtx = sCylinderVtx.as_mut_ptr();
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    (*_g_2).words.w1 =
        ((2 as libc::c_int) << 6 as libc::c_int) as libc::c_uint;
    let ref mut fresh13 =
        (*vtxPtr.offset(25 as libc::c_int as
                            isize)).v.cn[3 as libc::c_int as usize];
    *fresh13 =
        ((*this).vtxAlpha as libc::c_int >> 1 as libc::c_int) as
            libc::c_uchar;
    let ref mut fresh14 =
        (*vtxPtr.offset(16 as libc::c_int as
                            isize)).v.cn[3 as libc::c_int as usize];
    *fresh14 = *fresh13;
    let ref mut fresh15 =
        (*vtxPtr.offset(6 as libc::c_int as
                            isize)).v.cn[3 as libc::c_int as usize];
    *fresh15 = *fresh14;
    (*vtxPtr.offset(0 as libc::c_int as
                        isize)).v.cn[3 as libc::c_int as usize] = *fresh15;
    let ref mut fresh16 =
        (*vtxPtr.offset(22 as libc::c_int as
                            isize)).v.cn[3 as libc::c_int as usize];
    *fresh16 = (*this).vtxAlpha;
    (*vtxPtr.offset(10 as libc::c_int as
                        isize)).v.cn[3 as libc::c_int as usize] = *fresh16;
    ...
    (*_g_4).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 = sCylinderMaterialDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_5).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         scroll.wrapping_mul(4 as libc::c_int as
                                                 libc::c_uint),
                         (0 as libc::c_int as
                              libc::c_uint).wrapping_sub(scroll).wrapping_mul(8
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint),
                         ...
                         scroll.wrapping_mul(8 as libc::c_int as
                                                 libc::c_uint),
                         (0 as libc::c_int as
                              libc::c_uint).wrapping_sub(scroll).wrapping_mul(12
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint),
    ...
    (*_g_6).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_6).words.w1 = sCylinderModelDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_oceff_storm.c\x00" as *const u8 as
                         *const libc::c_char, 512 as libc::c_int);
    OceffStorm_Draw2(&mut (*this).actor, globalCtx);
}
                         ...
                         Gwords{w0:
                                    (0xfd as libc::c_int as u32_0 &
                                        ...
                                        ((1 as libc::c_int - 1 as libc::c_int)
                                            ...
                                            0 as libc::c_int,
                                w1:
                                    gEffUnknown11Tex.as_mut_ptr() as
                                        libc::c_uint,};
                     init
                 },},
         Gfx{words:
