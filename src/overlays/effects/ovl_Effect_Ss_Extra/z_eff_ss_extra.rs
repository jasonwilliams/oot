...
extern "C" {
    ...
    #[no_mangle]
    static mut object_yabusame_point_Tex_000000: [u64_0; 0];
    #[no_mangle]
    static mut object_yabusame_point_Tex_000480: [u64_0; 0];
    #[no_mangle]
    static mut object_yabusame_point_Tex_000900: [u64_0; 0];
    #[no_mangle]
    static mut object_yabusame_point_DL_000DC0: [Gfx; 0];
}
...
static mut sScores: [s16; 3] =
    [30 as libc::c_int as s16, 60 as libc::c_int as s16,
     100 as libc::c_int as s16];
#[no_mangle]
pub static mut Effect_Ss_Extra_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0: EFFECT_SS_EXTRA as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsExtra_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsExtra_Init(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs,
                                            mut initParamsx:
                                                *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsExtraInitParams =
        initParamsx as *mut EffectSsExtraInitParams;
    let mut pad: s32 = 0;
    let mut objBankIndex: s32 = 0;
    let mut oldSeg6: u32_0 = 0;
    objBankIndex =
        Object_GetIndex(&mut (*globalCtx).objectCtx,
                        OBJECT_YABUSAME_POINT as libc::c_int as s16);
    if objBankIndex >= 0 as libc::c_int &&
           Object_IsLoaded(&mut (*globalCtx).objectCtx, objBankIndex) != 0 {
        oldSeg6 = gSegments[6 as libc::c_int as usize];
        ...
        (*this).draw =
            Some(EffectSsExtra_Draw as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).update =
            Some(EffectSsExtra_Update as
                     unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                          _: *mut EffectSs) -> ());
        (*this).life = 50 as libc::c_int as s16;
        (*this).regs[2 as libc::c_int as usize] = (*initParams).scoreIdx;
        (*this).regs[3 as libc::c_int as usize] = (*initParams).scale;
        (*this).regs[1 as libc::c_int as usize] = 5 as libc::c_int as s16;
        (*this).regs[0 as libc::c_int as usize] = objBankIndex as s16;
        gSegments[6 as libc::c_int as usize] = oldSeg6;
        return 1 as libc::c_int as u32_0
    }
    return 0 as libc::c_int as u32_0;
}
static mut sTextures: [*mut libc::c_void; 3] =
    unsafe {
        [object_yabusame_point_Tex_000000.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_yabusame_point_Tex_000480.as_ptr() as *mut _ as
             *mut libc::c_void,
         object_yabusame_point_Tex_000900.as_ptr() as *mut _ as
             *mut libc::c_void]
    };
#[no_mangle]
pub unsafe extern "C" fn EffectSsExtra_Draw(mut globalCtx: *mut GlobalContext,
                                            mut index: u32_0,
                                            mut this: *mut EffectSs) {
    let mut pad: s32 = 0;
    let mut scale: f32_0 =
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_eff_ss_extra.c\x00" as *const u8 as
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 =
        gSegments[((sTextures[(*this).regs[2 as libc::c_int as usize] as
                                  usize] as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add(sTextures[(*this).regs[2 as
                                                                     libc::c_int
                                                                     as usize]
                                                        as usize] as u32_0 &
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 =
        gSegments[((object_yabusame_point_DL_000DC0.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(object_yabusame_point_DL_000DC0.as_mut_ptr()
                                              as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsExtra_Update(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut index: u32_0,
                                              mut this: *mut EffectSs) {
    ...
    } else { (*this).velocity.y = 0.0f32 }
    if (*this).regs[1 as libc::c_int as usize] as libc::c_int ==
           1 as libc::c_int {
        (*globalCtx).interfaceCtx.unk_23C =
            sScores[(*this).regs[2 as libc::c_int as usize] as usize] as u16_0
    };
}
