...
extern "C" {
    ...
    #[no_mangle]
    static mut gBlockMediumDL: [Gfx; 0];
    #[no_mangle]
    static mut gBlockMediumCol: CollisionHeader;
}
...
#[no_mangle]
pub static mut En_Pu_box_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_PU_BOX as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_PU_BOX as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnPubox>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnPubox_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnPubox_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut this: *mut EnPubox = thisx as *mut EnPubox;
    match (*thisx).params as libc::c_int {
        0 => { Actor_SetScale(thisx, 0.0025f32); }
        1 => { Actor_SetScale(thisx, 0.005f32); }
        2 => { Actor_SetScale(thisx, 0.0075f32); }
        3 => { Actor_SetScale(thisx, 0.01f32); }
        _ => { }
    }
    (*this).unk_164 = 1 as libc::c_int as u32_0;
    (*thisx).colChkInfo.cylRadius = 20 as libc::c_int as s16;
    (*thisx).colChkInfo.cylHeight = 50 as libc::c_int as s16;
    (*thisx).uncullZoneDownward = 1200.0f32;
    (*thisx).uncullZoneScale = 720.0f32;
    ...
    CollisionHeader_GetVirtual(&mut gBlockMediumCol as *mut CollisionHeader as
...
#[no_mangle]
pub unsafe extern "C" fn EnPubox_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPubox = thisx as *mut EnPubox;
...
#[no_mangle]
pub unsafe extern "C" fn EnPubox_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnPubox = thisx as *mut EnPubox;
    (*thisx).speedXZ += (*this).dyna.unk_150;
    (*thisx).world.rot.y = (*this).dyna.unk_158;
    (*thisx).speedXZ =
        if (*thisx).speedXZ < -2.5f32 {
            -2.5f32
        } else if (*thisx).speedXZ > 2.5f32 {
            2.5f32
        } else { (*thisx).speedXZ };
    Math_SmoothStepToF(&mut (*thisx).speedXZ, 0.0f32, 1.0f32, 1.0f32, 0.0f32);
    if (*thisx).speedXZ != 0.0f32 {
        Audio_PlaySoundGeneral((0x280a as libc::c_int - 0x800 as libc::c_int)
                                   as u16_0, &mut (*thisx).projectedPos,
...
#[no_mangle]
pub unsafe extern "C" fn EnPubox_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gBlockMediumDL.as_mut_ptr());
}
