...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanCurtainParams {
    pub radius: s16,
    pub height: s16,
    pub scale: f32_0,
    pub riseDist: f32_0,
...
static mut sCcInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
...
static mut sHCParams: [BgHidanCurtainParams; 2] =
    [{
         let mut init =
             BgHidanCurtainParams{radius: 81 as libc::c_int as s16,
                                  height: 144 as libc::c_int as s16,
                                  scale: 0.090f32,
                                  riseDist: 144.0f32,
                                  riseSpeed: 5.0f32,};
         init
     ...
     {
         let mut init =
             BgHidanCurtainParams{radius: 46 as libc::c_int as s16,
                                  height: 88 as libc::c_int as s16,
                                  scale: 0.055f32,
                                  riseDist: 88.0f32,
                                  riseSpeed: 3.0f32,};
         init
...
#[no_mangle]
pub static mut Bg_Hidan_Curtain_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_HIDAN_CURTAIN as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgHidanCurtain>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanCurtain_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanCurtain_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanCurtain_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgHidanCurtain_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanCurtain = thisx as *mut BgHidanCurtain;
    let mut hcParams: *mut BgHidanCurtainParams =
        0 as *mut BgHidanCurtainParams;
    osSyncPrintf(b"Curtain (arg_data 0x%04x)\n\x00" as *const u8 as
                     *const libc::c_char,
    ...
    if (*this).type_0 as libc::c_int > 6 as libc::c_int {
        // "Type is not set"
        osSyncPrintf(b"Error : object \xe3\x81\xae\xe3\x82\xbf\xe3\x82\xa4\xe3\x83\x97\xe3\x81\x8c\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_hidan_curtain.c\x00" as *const u8 as
    ...
    (*this).size =
        if (*this).type_0 as libc::c_int == 2 as libc::c_int ||
               (*this).type_0 as libc::c_int == 4 as libc::c_int {
            1 as libc::c_int
        } else { 0 as libc::c_int } as u8_0;
    hcParams =
        &mut *sHCParams.as_mut_ptr().offset((*this).size as isize) as
            *mut BgHidanCurtainParams;
    (*this).treasureFlag =
    ...
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int ||
        ...
        // "Save bit is not set"
        osSyncPrintf(b"Warning : object \xe3\x81\xae\xe3\x82\xbb\xe3\x83\xbc\xe3\x83\x96\xe3\x83\x93\xe3\x83\x83\xe3\x83\x88\xe3\x81\x8c\xe8\xa8\xad\xe5\xae\x9a\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84(%s %d)(arg_data 0x%04x)\n\x00"
                         as *const u8 as *const libc::c_char,
                     b"../z_bg_hidan_curtain.c\x00" as *const u8 as
                         *const libc::c_char, 373 as libc::c_int,
                     (*this).actor.params as libc::c_int); // this->type == 1
    }
    Actor_SetScale(&mut (*this).actor, (*hcParams).scale);
    ...
    (*this).collider.dim.pos.y = (*this).actor.world.pos.y as s16;
    ...
    if (*this).type_0 as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(BgHidanCurtain_WaitForClear as
                     unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(BgHidanCurtain_WaitForSwitchOn as
                     unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                          _: *mut GlobalContext) -> ());
        if (*this).type_0 as libc::c_int == 4 as libc::c_int ||
               (*this).type_0 as libc::c_int == 5 as libc::c_int {
            (*this).actor.world.pos.y =
                (*this).actor.home.pos.y - (*hcParams).riseDist
        }
    }
    if (*this).type_0 as libc::c_int == 1 as libc::c_int &&
           Flags_GetTreasure(globalCtx, (*this).treasureFlag as s32) != 0 ||
           ((*this).type_0 as libc::c_int == 0 as libc::c_int ||
                (*this).type_0 as libc::c_int == 6 as libc::c_int) &&
               Flags_GetClear(globalCtx, (*this).actor.room as s32) != 0 {
        Actor_Kill(&mut (*this).actor);
    }
    (*this).texScroll = (Rand_ZeroOne() * 15.0f32) as s16;
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgHidanCurtain = thisx as *mut BgHidanCurtain;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_WaitForSwitchOn(mut this:
                                                            *mut BgHidanCurtain,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        if (*this).type_0 as libc::c_int == 1 as libc::c_int {
            (*this).actionFunc =
                Some(BgHidanCurtain_WaitForCutscene as
                         unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                              _: *mut GlobalContext) -> ());
            OnePointCutscene_Init(globalCtx, 3350 as libc::c_int as s16,
                                  -(99 as libc::c_int) as s16,
                                  &mut (*this).actor,
                                  0 as libc::c_int as s16);
            (*this).timer = 50 as libc::c_int as s16
        } else if (*this).type_0 as libc::c_int == 3 as libc::c_int {
            (*this).actionFunc =
                Some(BgHidanCurtain_WaitForCutscene as
                         unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                              _: *mut GlobalContext) -> ());
            OnePointCutscene_Init(globalCtx, 3360 as libc::c_int as s16,
            ...
            (*this).actionFunc =
                Some(BgHidanCurtain_TurnOff as
                         unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_WaitForCutscene(mut this:
                                                            *mut BgHidanCurtain,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let fresh0 = (*this).timer;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_WaitForClear(mut this:
                                                         *mut BgHidanCurtain,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if Flags_GetClear(globalCtx, (*this).actor.room as s32) != 0 {
        (*this).actionFunc =
            Some(BgHidanCurtain_TurnOff as
                     unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_WaitForSwitchOff(mut this:
                                                             *mut BgHidanCurtain,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) == 0 {
        (*this).actionFunc =
            Some(BgHidanCurtain_TurnOn as
                     unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_TurnOn(mut this: *mut BgHidanCurtain,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut riseSpeed: f32_0 = sHCParams[(*this).size as usize].riseSpeed;
    if Math_StepToF(&mut (*this).actor.world.pos.y, (*this).actor.home.pos.y,
                    riseSpeed) != 0 {
        Flags_UnsetSwitch(globalCtx, (*this).actor.params as s32);
        (*this).actionFunc =
            Some(BgHidanCurtain_WaitForSwitchOn as
                     unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_TurnOff(mut this: *mut BgHidanCurtain,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut hcParams: *mut BgHidanCurtainParams =
        &mut *sHCParams.as_mut_ptr().offset((*this).size as isize) as
    ...
    if Math_StepToF(&mut (*this).actor.world.pos.y,
                    (*this).actor.home.pos.y - (*hcParams).riseDist,
                    (*hcParams).riseSpeed) != 0 {
        if (*this).type_0 as libc::c_int == 0 as libc::c_int ||
               (*this).type_0 as libc::c_int == 6 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
        } else if (*this).type_0 as libc::c_int == 5 as libc::c_int {
            (*this).actionFunc =
                Some(BgHidanCurtain_WaitForSwitchOff as
                         unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                              _: *mut GlobalContext) -> ())
        } else {
            if (*this).type_0 as libc::c_int == 2 as libc::c_int {
            ...
            } else { (*this).timer = 300 as libc::c_int as s16 }
            (*this).actionFunc =
                Some(BgHidanCurtain_WaitForTimer as
                         unsafe extern "C" fn(_: *mut BgHidanCurtain,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_WaitForTimer(mut this:
                                                         *mut BgHidanCurtain,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    ...
    if (*this).type_0 as libc::c_int == 1 as libc::c_int ||
           (*this).type_0 as libc::c_int == 3 as libc::c_int {
        func_8002F994(&mut (*this).actor, (*this).timer as s32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_Update(mut thisx: *mut Actor,
                                               mut globalCtx2:
                                                   *mut GlobalContext) {
    ...
    let mut hcParams: *mut BgHidanCurtainParams =
        &mut *sHCParams.as_mut_ptr().offset((*this).size as isize) as
            *mut BgHidanCurtainParams;
    let mut riseProgress: f32_0 = 0.;
    if (*(*globalCtx).cameraPtrs[0 as libc::c_int as usize]).setting as
           libc::c_int == CAM_SET_SLOW_CHEST_CS as libc::c_int ||
           (*(*globalCtx).cameraPtrs[0 as libc::c_int as usize]).setting as
               libc::c_int == CAM_SET_TURN_AROUND as libc::c_int {
        ...
        if (*this).collider.base.atFlags as libc::c_int &
            ...
            func_8002F71C(globalCtx, &mut (*this).actor, 5.0f32,
                          (*this).actor.yawTowardsPlayer, 1.0f32);
        }
        if (*this).type_0 as libc::c_int == 4 as libc::c_int ||
               (*this).type_0 as libc::c_int == 5 as libc::c_int {
            (*this).actor.world.pos.y =
                2.0f32 * (*this).actor.home.pos.y - (*hcParams).riseDist -
                    (*this).actor.world.pos.y
        }
        ...
        riseProgress =
            ((*hcParams).riseDist -
                ...
                (*hcParams).riseDist;
        (*this).alpha = (255.0f32 * riseProgress) as u8_0;
        if (*this).alpha as libc::c_int > 50 as libc::c_int {
            (*this).collider.dim.height =
                ((*hcParams).height as libc::c_int as libc::c_float *
                     riseProgress) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgHidanCurtain_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgHidanCurtain = thisx as *mut BgHidanCurtain;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_hidan_curtain.c\x00" as *const u8 as
                        *const libc::c_char, 685 as libc::c_int);
