...
extern "C" {
    ...
    #[no_mangle]
    static mut gAnubiceFallDownAnim: AnimationHeader;
    #[no_mangle]
    static mut gAnubiceAttackingAnim: AnimationHeader;
    #[no_mangle]
    static mut gAnubiceIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gAnubiceEyesDL: [Gfx; 0];
    #[no_mangle]
    static mut gAnubiceSkel: SkeletonHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgHidanCurtain {
    pub actor: Actor,
    pub actionFunc: BgHidanCurtainActionFunc,
    pub type_0: u8_0,
    pub treasureFlag: u8_0,
    pub size: u8_0,
    pub alpha: u8_0,
    pub timer: s16,
    pub texScroll: s16,
...
pub type BgHidanCurtainActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgHidanCurtain, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnAnubice {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
    pub actionFunc: EnAnubiceActionFunc,
    pub timeAlive: s16,
    pub unk_256: s16,
    pub unk_258: s16,
    pub deathTimer: s16,
    pub knockbackTimer: s16,
    pub isMirroringLink: s16,
    pub isLinkOutOfRange: s16,
    pub isKnockedback: s16,
    pub hasSearchedForFlameCircles: s16,
    pub hoverVelocityTimer: f32_0,
    pub animLastFrame: f32_0,
    pub targetHeight: f32_0,
    pub playerHeightOffset: f32_0,
    pub unk_278: f32_0,
    pub focusHeightOffset: f32_0,
    pub fireballPos: Vec3f,
    pub fireballRot: Vec3f,
    pub home: Vec3f,
    pub knockbackRecoveryVelocity: Vec3f,
    pub flameCircles: [*mut BgHidanCurtain; 4],
    pub unk_2C0: [libc::c_char; 8],
    pub col: ColliderCylinder,
}
pub type EnAnubiceActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAnubice, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnAnubiceTag {
    pub actor: Actor,
    pub actionFunc: EnAnubiceTagActionFunc,
    pub anubis: *mut EnAnubice,
    pub triggerRange: f32_0,
}
pub type EnAnubiceTagActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnAnubiceTag, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Anubice_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ANUBICE as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_ANUBICE as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnAnubice>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubice_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnAnubice_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Hover(mut this: *mut EnAnubice,
    ...
    (*this).hoverVelocityTimer += 1500.0f32;
    (*this).targetHeight =
        (*player).actor.world.pos.y + (*this).playerHeightOffset;
    Math_ApproachF(&mut (*this).actor.world.pos.y, (*this).targetHeight,
                   0.1f32, 10.0f32);
    Math_ApproachF(&mut (*this).playerHeightOffset, 10.0f32, 0.1f32, 0.5f32);
    (*this).actor.velocity.y = Math_SinS((*this).hoverVelocityTimer as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_SetFireballRot(mut this: *mut EnAnubice,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    y = (*player).actor.world.pos.y + 10.0f32 - (*this).fireballPos.y;
    z = (*player).actor.world.pos.z - (*this).fireballPos.z;
    xzdist = sqrtf(x * x + z * z);
    (*this).fireballRot.x =
        -((Math_FAtan2F(y, xzdist) * (32768.0f32 / 3.14159265358979323846f32))
              as s16 as libc::c_int) as f32_0;
    (*this).fireballRot.y =
        (Math_FAtan2F(x, z) * (32768.0f32 / 3.14159265358979323846f32)) as s16
            as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Init(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAnubice = thisx as *mut EnAnubice;
    ActorShape_Init(&mut (*this).actor.shape, 0.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  ...
                                                  _: *mut GlobalContext)
                                 -> ()), 20.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime, &mut gAnubiceSkel,
                   &mut gAnubiceIdleAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 16 as libc::c_int);
    osSyncPrintf(b"\n\n\x00" as *const u8 as *const libc::c_char);
    // "☆☆☆☆☆ Anubis occurence ☆☆☆☆☆"
    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x82\xa2\xe3\x83\x8c\xe3\x83\x93\xe3\x82\xb9\xe7\x99\xba\xe7\x94\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                     as *const u8 as *const libc::c_char);
    (*this).actor.naviEnemyId = 0x3a as libc::c_int as u8_0;
    Collider_InitCylinder(globalCtx, &mut (*this).col);
    Collider_SetCylinder(globalCtx, &mut (*this).col, &mut (*this).actor,
                         &mut sCylinderInit);
    Actor_SetScale(&mut (*this).actor, 0.015f32);
    (*this).actor.colChkInfo.damageTable = sDamageTable.as_mut_ptr();
    (*this).actor.colChkInfo.mass = 0xff as libc::c_int as u8_0;
    (*this).actor.shape.yOffset = -4230.0f32;
    (*this).focusHeightOffset = 0.0f32;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).home = (*this).actor.world.pos;
    (*this).actor.targetMode = 3 as libc::c_int as s8;
    (*this).actionFunc =
        Some(EnAnubice_FindFlameCircles as
                 unsafe extern "C" fn(_: *mut EnAnubice,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Destroy(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnAnubice = thisx as *mut EnAnubice;
    let mut temp_v1: *mut EnAnubiceTag = 0 as *mut EnAnubiceTag;
    Collider_DestroyCylinder(globalCtx, &mut (*this).col);
    if (*this).actor.params as libc::c_int != 0 as libc::c_int {
        !(*this).actor.parent.is_null();
        temp_v1 = (*this).actor.parent as *mut EnAnubiceTag;
        if !temp_v1.is_null() && (*temp_v1).actor.update.is_some() {
            (*temp_v1).anubis = 0 as *mut EnAnubice
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_FindFlameCircles(mut this: *mut EnAnubice,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut currentProp: *mut Actor = 0 as *mut Actor;
    let mut flameCirclesFound: s32 = 0;
    if (*this).isMirroringLink != 0 {
        if (*this).hasSearchedForFlameCircles == 0 {
            flameCirclesFound = 0 as libc::c_int;
            currentProp =
                (*globalCtx).actorCtx.actorLists[ACTORCAT_PROP as libc::c_int
                                                     as usize].head;
            while !currentProp.is_null() {
                if (*currentProp).id as libc::c_int !=
                       ACTOR_BG_HIDAN_CURTAIN as libc::c_int {
                    currentProp = (*currentProp).next
                } else {
                    (*this).flameCircles[flameCirclesFound as usize] =
                        currentProp as *mut BgHidanCurtain;
                    // "☆☆☆☆☆ How many fires? ☆☆☆☆☆"
                    osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x81\xab\xe3\x81\xaf\xe5\xb9\xbe\xe3\x81\xa4\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %d\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char,
                                 flameCirclesFound);
                    osSyncPrintf(b"\x1b[33m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe7\x81\xab\xe3\x81\xaf\xe5\xb9\xbe\xe3\x81\xa4\xef\xbc\x9f \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 %x\n\x1b[m\x00"
                                     as *const u8 as *const libc::c_char,
                                 (*this).flameCircles[flameCirclesFound as
                                                          usize]);
                    if flameCirclesFound < 4 as libc::c_int {
                        flameCirclesFound += 1
                    }
                    currentProp = (*currentProp).next
                }
            }
            (*this).hasSearchedForFlameCircles = 1 as libc::c_int as s16
        }
        (*this).actor.flags |=
            ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
        (*this).actionFunc =
            Some(EnAnubice_SetupIdle as
                     unsafe extern "C" fn(_: *mut EnAnubice,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_SetupIdle(mut this: *mut EnAnubice,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gAnubiceIdleAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gAnubiceIdleAnim, 1.0f32,
                     0.0f32, lastFrame as s16 as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnAnubice_Idle as
                 unsafe extern "C" fn(_: *mut EnAnubice,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.gravity = 0.0f32;
    (*this).actor.velocity.z = (*this).actor.gravity;
    (*this).actor.velocity.x = (*this).actor.velocity.z;
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Idle(mut this: *mut EnAnubice,
                                        mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ApproachZeroF(&mut (*this).actor.shape.yOffset, 0.5f32, 300.0f32);
    Math_ApproachF(&mut (*this).focusHeightOffset, 70.0f32, 0.5f32, 5.0f32);
    if (*this).isKnockedback == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_GoToHome(mut this: *mut EnAnubice,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut xzdist: f32_0 = 0.;
    let mut xRatio: f32_0 = 0.;
    let mut zRatio: f32_0 = 0.;
    let mut x: f32_0 = 0.;
    let mut z: f32_0 = 0.;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ApproachF(&mut (*this).actor.shape.yOffset, -4230.0f32, 0.5f32,
                   300.0f32);
    Math_ApproachZeroF(&mut (*this).focusHeightOffset, 0.5f32, 5.0f32);
    if (*this).isKnockedback == 0 {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           (*this).actor.yawTowardsPlayer,
                           5 as libc::c_int as s16,
    ...
    if fabsf((*this).home.x - (*this).actor.world.pos.x) > 3.0f32 &&
           fabsf((*this).home.z - (*this).actor.world.pos.z) > 3.0f32 {
        ...
        (*this).actor.world.pos.x +=
            xRatio * 8 as libc::c_int as libc::c_float;
        (*this).actor.world.pos.z += zRatio * 8.0f32
    } else if (*this).actor.shape.yOffset < -4220.0f32 {
        (*this).actor.shape.yOffset = -4230.0f32;
        (*this).isLinkOutOfRange = 0 as libc::c_int as s16;
        (*this).isMirroringLink = (*this).isLinkOutOfRange;
        (*this).actionFunc =
            Some(EnAnubice_FindFlameCircles as
                     unsafe extern "C" fn(_: *mut EnAnubice,
                                          _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubis_SetupShootFireball(mut this: *mut EnAnubice,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gAnubiceAttackingAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).animLastFrame = lastFrame;
    Animation_Change(&mut (*this).skelAnime, &mut gAnubiceAttackingAnim,
                     1.0f32, 0.0f32, lastFrame,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -10.0f32);
    (*this).actionFunc =
        Some(EnAnubis_ShootFireball as
                 unsafe extern "C" fn(_: *mut EnAnubice,
                                      _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubis_ShootFireball(mut this: *mut EnAnubice,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    if curFrame == 12.0f32 {
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_EN_ANUBICE_FIRE as libc::c_int as s16,
                    (*this).fireballPos.x, (*this).fireballPos.y + 15.0f32,
                    (*this).fireballPos.z, (*this).fireballRot.x as s16,
                    (*this).fireballRot.y as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_SetupDie(mut this: *mut EnAnubice,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gAnubiceFallDownAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    (*this).animLastFrame = lastFrame;
    Animation_Change(&mut (*this).skelAnime, &mut gAnubiceFallDownAnim,
                     1.0f32, 0.0f32, lastFrame,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -20.0f32);
    ...
    if BgCheck_SphVsFirstPoly(&mut (*globalCtx).colCtx,
                              &mut (*this).fireballPos, 70.0f32) != 0 {
        (*this).unk_256 = 1 as libc::c_int as s16;
        (*this).unk_258 =
            ((*this).actor.shape.rot.x as libc::c_int - 0x7f00 as libc::c_int)
                as s16
    }
    (*this).actionFunc =
        Some(EnAnubice_Die as
                 unsafe extern "C" fn(_: *mut EnAnubice,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Die(mut this: *mut EnAnubice,
                                       mut globalCtx: *mut GlobalContext) {
    let mut curFrame: f32_0 = 0.;
    let mut phi_f2: f32_0 = 0.;
    let mut sp4C: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut fireEffectPos: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pad: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_ApproachZeroF(&mut (*this).actor.shape.shadowScale, 0.4f32, 0.25f32);
    if (*this).unk_256 != 0 {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, (*this).unk_258,
                           1 as libc::c_int as s16,
                           10000 as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if fabsf(((*this).actor.shape.rot.y as libc::c_int -
                      (*this).unk_258 as libc::c_int) as f32_0) < 100.0f32 {
            (*this).unk_256 = 0 as libc::c_int as s16
        }
    }
    curFrame = (*this).skelAnime.curFrame;
    phi_f2 = curFrame * -3000.0f32;
    phi_f2 = if phi_f2 < -11000.0f32 { -11000.0f32 } else { phi_f2 };
    Matrix_RotateY((*this).actor.shape.rot.y as f32_0 / 32768.0f32 *
                       3.14159265358979323846f32,
                   MTXMODE_NEW as libc::c_int as u8_0);
    Matrix_RotateX(phi_f2 / 32768.0f32 * 3.14159265358979323846f32,
                   MTXMODE_APPLY as libc::c_int as u8_0);
    sp4C.y = Rand_CenteredFloat(10.0f32) + 30.0f32;
    Matrix_MultVec3f(&mut sp4C, &mut fireEffectPos);
    fireEffectPos.x +=
        (*this).actor.world.pos.x + Rand_CenteredFloat(40.0f32);
    fireEffectPos.y +=
        (*this).actor.world.pos.y + Rand_CenteredFloat(40.0f32);
    fireEffectPos.z +=
        (*this).actor.world.pos.z + Rand_CenteredFloat(30.0f32);
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
                         0x80 as libc::c_int as s16, 0 as libc::c_int as s16,
                         8 as libc::c_int as s16);
    EffectSsEnFire_SpawnVec3f(globalCtx, &mut (*this).actor,
                              &mut fireEffectPos, 100 as libc::c_int as s16,
                              0 as libc::c_int as s16,
                              0 as libc::c_int as s16,
                              -(1 as libc::c_int) as s16);
    if (*this).animLastFrame <= curFrame &&
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Update(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut zero: f32_0 = 0.;
    let mut flameCircle: *mut BgHidanCurtain = 0 as *mut BgHidanCurtain;
    let mut i: s32 = 0;
    let mut sp48: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp3C: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut this: *mut EnAnubice = thisx as *mut EnAnubice;
    if (*this).actionFunc !=
           Some(EnAnubice_SetupDie as
                    unsafe extern "C" fn(_: *mut EnAnubice,
                                         _: *mut GlobalContext) -> ()) &&
           (*this).actionFunc !=
               Some(EnAnubice_Die as
        ...
        while i < 5 as libc::c_int {
            flameCircle = (*this).flameCircles[i as usize];
            if !flameCircle.is_null() &&
                   fabsf((*flameCircle).actor.world.pos.x -
                             (*this).actor.world.pos.x) < 60.0f32 &&
                   fabsf((*(*this).flameCircles[i as usize]).actor.world.pos.z
                             - (*this).actor.world.pos.z) < 60.0f32 &&
                   (*flameCircle).timer as libc::c_int != 0 as libc::c_int {
        ...
        if (*this).col.base.acFlags as libc::c_int & 2 as libc::c_int != 0 {
            (*this).col.base.acFlags =
                ((*this).col.base.acFlags as libc::c_int &
            ...
            if (*this).isKnockedback == 0 {
                (*this).knockbackTimer = 10 as libc::c_int as s16;
                (*this).isKnockedback = 1 as libc::c_int as s16;
                sp48.x = 0.0f32;
                sp48.y = 0.0f32;
                sp48.z = -10.0f32;
                sp3C.x = 0.0f32;
        ...
        if (*this).isKnockedback != 0 {
            (*this).actor.shape.rot.y =
                ((*this).actor.shape.rot.y as libc::c_int +
                     6500 as libc::c_int) as s16;
            Math_ApproachF(&mut (*this).actor.velocity.x,
                           (*this).knockbackRecoveryVelocity.x, 0.3f32,
                           1.0f32);
            Math_ApproachF(&mut (*this).actor.velocity.z,
                           (*this).knockbackRecoveryVelocity.z, 0.3f32,
                           1.0f32);
            zero = 0.0f32;
            (zero) != 0.;
            if (*this).knockbackTimer as libc::c_int == 0 as libc::c_int {
                (*this).actor.velocity.z = 0.0f32;
                (*this).actor.velocity.x = (*this).actor.velocity.z;
                (*this).knockbackRecoveryVelocity.z = 0.0f32;
                (*this).knockbackRecoveryVelocity.x =
                    (*this).knockbackRecoveryVelocity.z;
                (*this).isKnockedback = 0 as libc::c_int as s16
            }
        }
    }
    (*this).timeAlive += 1;
    ...
    if (*this).isLinkOutOfRange == 0 {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32, 5.0f32,
                                10.0f32, 0x1d as libc::c_int);
    } else {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32, 5.0f32,
                                10.0f32, 0x1c as libc::c_int);
    }
    if (*this).actionFunc !=
           Some(EnAnubice_SetupDie as
                    unsafe extern "C" fn(_: *mut EnAnubice,
           ...
           (*this).actionFunc !=
               Some(EnAnubice_Die as
                        unsafe extern "C" fn(_: *mut EnAnubice,
                                             _: *mut GlobalContext) -> ()) {
        Actor_SetFocus(&mut (*this).actor, (*this).focusHeightOffset);
        Collider_UpdateCylinder(&mut (*this).actor, &mut (*this).col);
        CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).col.base);
        if (*this).isKnockedback == 0 && (*this).actor.shape.yOffset == 0.0f32
           {
...
#[no_mangle]
pub unsafe extern "C" fn EnAnubis_OverrideLimbDraw(mut globalCtx:
                                                       *mut GlobalContext,
                                                   mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 13 as libc::c_int {
        (*rot).z = ((*rot).z as libc::c_float + (*this).unk_278) as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubis_PostLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
                                               mut dList: *mut *mut Gfx,
                                               mut rot: *mut Vec3s,
    ...
    if limbIndex == 13 as libc::c_int {
        ...
        Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                        b"../z_en_anubice.c\x00" as *const u8 as
                            *const libc::c_char, 853 as libc::c_int);
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gAnubiceEyesDL.as_mut_ptr() as libc::c_uint;
        Matrix_MultVec3f(&mut pos, &mut (*this).fireballPos);
        Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                         b"../z_en_anubice.c\x00" as *const u8 as
                             *const libc::c_char, 868 as libc::c_int);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnAnubice_Draw(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnAnubice = thisx as *mut EnAnubice;
    func_80093D84((*globalCtx).state.gfxCtx);
    SkelAnime_DrawOpa(globalCtx, (*this).skelAnime.skeleton,
                      (*this).skelAnime.jointTable,
                      Some(EnAnubis_OverrideLimbDraw as
