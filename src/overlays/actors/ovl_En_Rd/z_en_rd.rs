...
extern "C" {
    ...
    #[no_mangle]
    fn func_8008EEAC(globalCtx: *mut GlobalContext, actor: *mut Actor);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut object_rd_Skel_003DD8: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_rd_Anim_004268: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_0046F8: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_004ADC: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_004F94: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_0057AC: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_005D98: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_006E88: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_0074F0: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_008040: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Anim_0087D0: AnimationHeader;
    #[no_mangle]
    static mut object_rd_Skel_00E778: FlexSkeletonHeader;
    #[no_mangle]
    static mut object_rd_Anim_00EFDC: AnimationHeader;
}
...
pub struct EnRd {
    pub actor: Actor,
    pub firePos: [Vec3s; 10],
    pub skelAnime: SkelAnime,
    pub jointTable: [Vec3s; 26],
    pub morphTable: [Vec3s; 26],
    pub unk_304: u8_0,
    pub unk_305: u8_0,
    pub unk_306: u8_0,
    pub unk_307: u8_0,
    pub actionFunc: EnRdActionFunc,
    pub unk_30C: s16,
    pub unk_30E: s16,
    pub unk_310: s16,
    pub unk_312: s16,
...
pub type EnRdActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnRd, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Rd_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_RD as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_RD as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnRd>() as libc::c_ulong,
                          init:
...
static mut D_80AE4928: Color_RGBA8 =
    {
        let mut init =
...
static mut D_80AE492C: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80AE4938: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 200 as libc::c_int as u8_0,
                        g: 200 as libc::c_int as u8_0,
...
static mut D_80AE493C: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 0 as libc::c_int as u8_0,
                        g: 0 as libc::c_int as u8_0,
...
static mut D_80AE4940: Vec3f =
    { let mut init = Vec3f{x: 300.0f32, y: 0.0f32, z: 0.0f32,}; init };
static mut D_80AE4958: Vec3f =
    { let mut init = Vec3f{x: 0.25f32, y: 0.25f32, z: 0.25f32,}; init };
#[no_mangle]
pub unsafe extern "C" fn EnRd_SetupAction(mut this: *mut EnRd,
                                          mut actionFunc: EnRdActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnRd_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRd = thisx as *mut EnRd;
    ...
    (*this).unk_310 = (*this).unk_30E;
    (*thisx).focus.pos = (*thisx).world.pos;
    (*thisx).focus.pos.y += 50.0f32;
    (*thisx).colChkInfo.mass = 0xfe as libc::c_int as u8_0;
    (*thisx).colChkInfo.health = 8 as libc::c_int as u8_0;
    (*this).unk_31D = 0xff as libc::c_int as u8_0;
    (*this).unk_314 = (*this).unk_31D as s16;
    (*this).unk_312 =
    ...
    if (*thisx).params as libc::c_int >= -(1 as libc::c_int) {
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut object_rd_Skel_00E778,
                           &mut object_rd_Anim_0087D0,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           26 as libc::c_int);
        (*thisx).naviEnemyId = 0x2a as libc::c_int as u8_0
    } else {
        SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                           &mut object_rd_Skel_003DD8,
                           &mut object_rd_Anim_0087D0,
                           (*this).jointTable.as_mut_ptr(),
                           (*this).morphTable.as_mut_ptr(),
                           26 as libc::c_int);
        (*thisx).naviEnemyId = 0x2d as libc::c_int as u8_0
    }
    ...
    if (*thisx).params as libc::c_int >= -(2 as libc::c_int) {
        func_80AE269C(this);
    } else { func_80AE2970(this); }
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*thisx).params as libc::c_int == 3 as libc::c_int {
        (*thisx).flags |=
            ((1 as libc::c_int) << 7 as libc::c_int) as libc::c_uint
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRd_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnRd = thisx as *mut EnRd;
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE2630(mut globalCtx: *mut GlobalContext,
                                       mut thisx: *mut Actor, mut arg2: s32) {
    let mut enemyIt: *mut Actor =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_ENEMY as libc::c_int as
                                             usize].head;
    while !enemyIt.is_null() {
        if (*enemyIt).id as libc::c_int != ACTOR_EN_RD as libc::c_int ||
               enemyIt == thisx ||
               ((*enemyIt).params as libc::c_int) < 0 as libc::c_int {
            enemyIt = (*enemyIt).next
        } else {
            if arg2 != 0 as libc::c_int {
                (*enemyIt).parent = thisx
            } else if (*enemyIt).parent == thisx {
                (*enemyIt).parent = 0 as *mut Actor
            }
            enemyIt = (*enemyIt).next
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE269C(mut this: *mut EnRd) {
    if (*this).actor.params as libc::c_int != 2 as libc::c_int {
        Animation_MorphToLoop(&mut (*this).skelAnime,
                              &mut object_rd_Anim_0087D0, -6.0f32);
    } else {
        Animation_PlayLoop(&mut (*this).skelAnime,
                           &mut object_rd_Anim_005D98);
    }
    (*this).unk_31B = 0 as libc::c_int as u8_0;
    (*this).unk_30C = (Rand_ZeroOne() * 10.0f32 + 5.0f32) as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnRd_SetupAction(this,
                     Some(func_80AE2744 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE2744(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    Math_SmoothStepToS(&mut (*this).unk_30E, 0 as libc::c_int as s16,
                       1 as libc::c_int as s16, 0x64 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).unk_310, 0 as libc::c_int as s16,
                       1 as libc::c_int as s16, 0x64 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if (*this).actor.params as libc::c_int == 2 as libc::c_int &&
           0.0f32 == (*this).skelAnime.curFrame {
        if Rand_ZeroOne() >= 0.5f32 {
            Animation_PlayLoop(&mut (*this).skelAnime,
                               &mut object_rd_Anim_005D98);
        } else {
            Animation_PlayLoop(&mut (*this).skelAnime,
                               &mut object_rd_Anim_0057AC);
        }
    } else {
        (*this).unk_30C -= 1;
        if (*this).unk_30C as libc::c_int == 0 as libc::c_int {
            (*this).unk_30C = (Rand_ZeroOne() * 10.0f32 + 10.0f32) as s16;
            (*this).skelAnime.curFrame = 0.0f32
        }
    }
    if !(*this).actor.parent.is_null() {
        if (*this).unk_305 as libc::c_int == 0 as libc::c_int {
            if (*this).actor.params as libc::c_int != 2 as libc::c_int {
                func_80AE31DC(this);
            } else { func_80AE392C(this); }
        }
    } else {
        if (*this).unk_305 as libc::c_int != 0 as libc::c_int {
            if (*this).actor.params as libc::c_int != 2 as libc::c_int {
        ...
        (*this).unk_305 = 0 as libc::c_int as u8_0;
        if (*this).actor.xzDistToPlayer <= 150.0f32 &&
               func_8002DDE4(globalCtx) != 0 {
            if (*this).actor.params as libc::c_int != 2 as libc::c_int &&
                   (*this).unk_305 as libc::c_int == 0 as libc::c_int {
                func_80AE37BC(this);
            } else { func_80AE392C(this); }
        }
    }
    if (*globalCtx).gameplayFrames & 0x5f as libc::c_int as libc::c_uint ==
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x38e4 as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE2970(mut this: *mut EnRd) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_0087D0,
                     0 as libc::c_int as f32_0, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_rd_Anim_0087D0 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP as libc::c_int as u8_0, -6.0f32);
    (*this).unk_31B = 11 as libc::c_int as u8_0;
    (*this).unk_30C = 6 as libc::c_int as s16;
    (*this).actor.shape.rot.x = -(0x4000 as libc::c_int) as s16;
    (*this).actor.gravity = 0.0f32;
    (*this).actor.shape.yOffset = 0.0f32;
    (*this).actor.speedXZ = 0.0f32;
    EnRd_SetupAction(this,
                     Some(func_80AE2A10 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE2A10(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.shape.rot.x as libc::c_int != -(0x4000 as libc::c_int) {
        ...
        if Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                              (*this).actor.home.pos.y, 0.3f32, 2.0f32,
                              0.3f32) == 0.0f32 {
        ...
        if Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                              (*this).actor.home.pos.y + 50.0f32, 0.3f32,
                              2.0f32, 0.3f32) == 0.0f32 {
            if (*this).unk_30C as libc::c_int != 0 as libc::c_int {
                (*this).unk_30C -= 1;
                Math_SmoothStepToF(&mut (*this).actor.speedXZ, 6.0f32, 0.3f32,
                                   1.0f32, 0.3f32);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE2B90(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_00EFDC,
                     1.0f32, 4.0f32,
                     Animation_GetLastFrame(&mut object_rd_Anim_00EFDC as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    (*this).actor.speedXZ = 0.4f32;
    (*this).unk_31B = 4 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE2C1C as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE2C1C(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp44: Vec3f = D_80AE4918;
    let mut sp40: Color_RGBA8 = D_80AE4924;
    let mut sp3C: Color_RGBA8 = D_80AE4928;
    ...
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if Actor_WorldDistXYZToPoint(&mut (*player).actor,
                                 &mut (*this).actor.home.pos) >= 150.0f32 {
        func_80AE2F50(this, globalCtx);
    }
    if (if sp32 as libc::c_int >= 0 as libc::c_int {
            sp32 as libc::c_int
        } else { -(sp32 as libc::c_int) }) < 0x1554 as libc::c_int &&
           Actor_WorldDistXYZToActor(&mut (*this).actor, &mut (*player).actor)
               <= 150.0f32 {
        if (*player).stateFlags1 & 0x2c6080 as libc::c_int as libc::c_uint ==
               0 &&
               (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint ==
                   0 {
            if (*this).unk_306 as libc::c_int == 0 as libc::c_int {
                if (*this).unk_312 as libc::c_int & 0x80 as libc::c_int == 0 {
                    (*player).actor.freezeTimer = 40 as libc::c_int as u16_0;
                    func_8008EEAC(globalCtx, &mut (*this).actor);
                    let ref mut fresh0 =
                        (*((*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                                libc::c_int as
                                                                usize].head as
                               *mut Player)).unk_684;
                    *fresh0 = &mut (*this).actor;
                    func_800AA000((*this).actor.xzDistToPlayer,
                                  0xff as libc::c_int as u8_0,
                                  0x14 as libc::c_int as u8_0,
                                  0x96 as libc::c_int as u8_0);
                }
                (*this).unk_306 = 0x3c as libc::c_int as u8_0;
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38e5 as libc::c_int as u16_0);
            }
        } else { func_80AE2F50(this, globalCtx); }
    }
    if (*this).unk_307 as libc::c_int != 0 as libc::c_int {
        (*this).unk_307 = (*this).unk_307.wrapping_sub(1)
    }
    if (*this).unk_307 == 0 &&
           Actor_WorldDistXYZToActor(&mut (*this).actor, &mut (*player).actor)
               <= 45.0f32 &&
           Actor_IsFacingPlayer(&mut (*this).actor,
                                0x38e3 as libc::c_int as s16) != 0 {
        ...
        if !(*this).actor.parent.is_null() {
            func_80AE31DC(this);
        } else { (*this).unk_305 = 0 as libc::c_int as u8_0 }
    }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE2F50(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_00EFDC,
                     0.5f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_rd_Anim_00EFDC as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    (*this).unk_31B = 2 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE2FD0 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE2FD0(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if Actor_WorldDistXYZToPoint(&mut (*this).actor,
                                 &mut (*this).actor.home.pos) >= 5.0f32 {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, targetY,
                           1 as libc::c_int as s16,
    ...
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*player).stateFlags1 & 0x2c6080 as libc::c_int as libc::c_uint == 0 &&
           (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint == 0 &&
           Actor_WorldDistXYZToPoint(&mut (*player).actor,
                                     &mut (*this).actor.home.pos) < 150.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE31DC(mut this: *mut EnRd) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_00EFDC,
                     0.5f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut object_rd_Anim_00EFDC as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    (*this).unk_31B = 3 as libc::c_int as u8_0;
    (*this).unk_305 = 1 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE3260 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3260(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if !(*this).actor.parent.is_null() {
        let mut pad: s32 = 0;
        let mut targetY: s16 = 0;
        let mut thisPos: Vec3f = (*(*this).actor.parent).world.pos;
        targetY = Actor_WorldYawTowardPoint(&mut (*this).actor, &mut thisPos);
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y, targetY,
                           1 as libc::c_int as s16,
                           0xfa as libc::c_int as s16,
                           0 as libc::c_int as s16);
        if Actor_WorldDistXYZToPoint(&mut (*this).actor, &mut thisPos) >=
               45.0f32 {
            (*this).actor.speedXZ = 0.4f32
        } else {
            (*this).actor.speedXZ = 0.0f32;
        ...
        Math_SmoothStepToS(&mut (*this).unk_310, 0 as libc::c_int as s16,
                           ...
                           0x64 as libc::c_int as s16,
                           0 as libc::c_int as s16);
    } else { func_80AE2B90(this, globalCtx); }
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).skelAnime.curFrame == 10.0f32 ||
           (*this).skelAnime.curFrame == 22.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE33F0(mut this: *mut EnRd) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut object_rd_Anim_004ADC);
    (*this).unk_304 = 0 as libc::c_int as u8_0;
    (*this).unk_30C = (*this).unk_304 as s16;
    (*this).unk_319 = 200 as libc::c_int as u8_0;
    (*this).unk_31B = 8 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnRd_SetupAction(this,
                     Some(func_80AE3454 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3454(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).unk_304 = (*this).unk_304.wrapping_add(1)
    }
    let mut current_block_43: u64;
    match (*this).unk_304 as libc::c_int {
        1 => {
            Animation_PlayLoop(&mut (*this).skelAnime,
                               &mut object_rd_Anim_004268);
            (*this).unk_304 = (*this).unk_304.wrapping_add(1);
            ...
            (*this).unk_319 = 20 as libc::c_int as u8_0;
            current_block_43 = 13866204865078505894;
        }
        0 => { current_block_43 = 13866204865078505894; }
        2 => { current_block_43 = 15461379861102614130; }
        3 => {
        ...
        4 => {
            ...
            (*this).actor.flags |=
                ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
            (*this).unk_306 = 0xa as libc::c_int as u8_0;
            (*this).unk_307 = 0xf as libc::c_int as u8_0;
            func_80AE2B90(this, globalCtx);
            current_block_43 = 2480299350034459858;
        }
        _ => { current_block_43 = 2480299350034459858; }
    }
    match current_block_43 {
        13866204865078505894 => {
            Math_SmoothStepToS(&mut (*this).unk_30E, 0 as libc::c_int as s16,
                               1 as libc::c_int as s16,
            ...
            Math_SmoothStepToS(&mut (*this).unk_310, 0 as libc::c_int as s16,
                               ...
                               0x5dc as libc::c_int as s16,
                               0 as libc::c_int as s16);
            current_block_43 = 15461379861102614130;
        }
        _ => { }
    }
    match current_block_43 {
        15461379861102614130 => {
            if (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint ==
                   0 {
                Animation_Change(&mut (*this).skelAnime,
                                 &mut object_rd_Anim_0046F8, 0.5f32, 0.0f32,
                                 Animation_GetLastFrame(&mut object_rd_Anim_0046F8
                                                            as
                                                            *mut AnimationHeader
                                                            as
                                                            *mut libc::c_void)
            ...
            Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                               ...
                               0 as libc::c_int as s16);
            if (*this).skelAnime.curFrame == 0.0f32 {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x38e8 as libc::c_int as u16_0);
            }
            (*this).unk_319 = (*this).unk_319.wrapping_sub(1);
            if (*this).unk_319 as libc::c_int == 0 as libc::c_int {
                (*globalCtx).damagePlayer.expect("non-null function pointer")(globalCtx,
                                                                              -(8
                                                                                    as
                                                                                    libc::c_int));
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE37BC(mut this: *mut EnRd) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_004F94,
                     0.0f32, 0.0f32,
                     Animation_GetLastFrame(&mut object_rd_Anim_004F94 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).unk_31B = 7 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE3834 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3834(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp34: Vec3f = D_80AE492C;
    let mut sp30: Color_RGBA8 = D_80AE4938;
    let mut sp2C: Color_RGBA8 = D_80AE493C;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut temp_v0: s16 =
    ...
    if (if temp_v0 as libc::c_int >= 0 as libc::c_int {
        ...
        } else { -(temp_v0 as libc::c_int) }) < 0x2008 as libc::c_int {
        if (*this).unk_312 as libc::c_int & 0x80 as libc::c_int == 0 {
            (*player).actor.freezeTimer = 60 as libc::c_int as u16_0;
            func_800AA000((*this).actor.xzDistToPlayer,
                          0xff as libc::c_int as u8_0,
                          0x14 as libc::c_int as u8_0,
                          0x96 as libc::c_int as u8_0);
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE392C(mut this: *mut EnRd) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_rd_Anim_008040, -4.0f32);
    (*this).unk_31B = 5 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE3978 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3978(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if !(*this).actor.parent.is_null() {
            func_80AE31DC(this);
        } else { func_80AE37BC(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE39D4(mut this: *mut EnRd) {
    Animation_Change(&mut (*this).skelAnime, &mut object_rd_Anim_008040,
                     -1.0f32,
                     Animation_GetLastFrame(&mut object_rd_Anim_008040 as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0, -4.0f32);
    (*this).unk_31B = 6 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE3A54 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3A54(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 { func_80AE269C(this); };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3A8C(mut this: *mut EnRd) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_rd_Anim_0074F0, -6.0f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.speedXZ = -2.0f32
    }
    (*this).actor.flags |=
        ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38e6 as libc::c_int as u16_0);
    (*this).unk_31B = 9 as libc::c_int as u8_0;
    EnRd_SetupAction(this,
                     Some(func_80AE3B18 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3B18(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if (*this).actor.speedXZ < 0.0f32 { (*this).actor.speedXZ += 0.15f32 }
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    Math_SmoothStepToS(&mut (*this).unk_30E, 0 as libc::c_int as s16,
                       1 as libc::c_int as s16, 0x12c as libc::c_int as s16,
                       0 as libc::c_int as s16);
    Math_SmoothStepToS(&mut (*this).unk_310, 0 as libc::c_int as s16,
                       1 as libc::c_int as s16, 0x12c as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if !(*this).actor.parent.is_null() {
            func_80AE31DC(this);
        } else if Actor_WorldDistXYZToPoint(&mut (*player).actor,
                                            &mut (*this).actor.home.pos) >=
                      150.0f32 {
            func_80AE2F50(this, globalCtx);
        } else { func_80AE2B90(this, globalCtx); }
...
#[no_mangle]
pub unsafe extern "C" fn func_80AE3C20(mut this: *mut EnRd) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_rd_Anim_006E88, -1.0f32);
    (*this).unk_31B = 10 as libc::c_int as u8_0;
    (*this).unk_30C = 300 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38e7 as libc::c_int as u16_0);
    EnRd_SetupAction(this,
                     Some(func_80AE3C98 as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3C98(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.category as libc::c_int != ACTORCAT_PROP as libc::c_int {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).unk_30C as libc::c_int == 0 as libc::c_int {
            if Flags_GetSwitch(globalCtx,
                               (*this).unk_312 as libc::c_int &
                                   0x7f as libc::c_int) == 0 {
                Flags_SetSwitch(globalCtx,
                                (*this).unk_312 as libc::c_int &
                                    0x7f as libc::c_int);
            }
            if (*this).unk_314 as libc::c_int != 0 as libc::c_int {
                if (*this).unk_314 as libc::c_int == 0xb4 as libc::c_int {
                    func_80AE2630(globalCtx, &mut (*this).actor,
                                  0 as libc::c_int);
                }
                (*this).actor.scale.y -= 0.000075f32;
                (*this).unk_314 =
                    ((*this).unk_314 as libc::c_int - 5 as libc::c_int) as s16
            } else { Actor_Kill(&mut (*this).actor); }
        } else { (*this).unk_30C -= 1 }
    } else if (*this).skelAnime.curFrame as s32 == 33 as libc::c_int ||
                  (*this).skelAnime.curFrame as s32 == 40 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387a as libc::c_int as u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3DE4(mut this: *mut EnRd) {
    (*this).unk_31B = 1 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    if gSaveContext.sunsSongState as libc::c_int !=
           SUNSSONG_INACTIVE as libc::c_int {
        (*this).unk_318 = 1 as libc::c_int as u8_0;
        (*this).unk_316 = 0x258 as libc::c_int as s16;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3836 as libc::c_int as u16_0);
        Actor_SetColorFilter(&mut (*this).actor,
                             -(0x8000 as libc::c_int) as s16,
                             -(0x7f38 as libc::c_int) as s16,
                             0 as libc::c_int as s16,
                             0xff as libc::c_int as s16);
    } else if (*this).unk_31C as libc::c_int == 1 as libc::c_int {
    ...
    EnRd_SetupAction(this,
                     Some(func_80AE3ECC as
                              unsafe extern "C" fn(_: *mut EnRd,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3ECC(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_318 as libc::c_int != 0 as libc::c_int &&
           (*this).unk_316 as libc::c_int != 0 as libc::c_int {
        (*this).unk_316 -= 1;
        if (*this).unk_316 as libc::c_int >= 0xff as libc::c_int {
            Actor_SetColorFilter(&mut (*this).actor,
                                 -(0x8000 as libc::c_int) as s16,
                                 0xc8 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
        ...
        if (*this).unk_316 as libc::c_int == 0 as libc::c_int {
            (*this).unk_318 = 0 as libc::c_int as u8_0;
    ...
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            func_80AE2630(globalCtx, &mut (*this).actor, 1 as libc::c_int);
            func_80AE3C20(this);
            Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                       &mut (*this).actor.world.pos,
                                       0x90 as libc::c_int as s16);
        } else { func_80AE3A8C(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE3F9C(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp1: s16 = 0;
    let mut temp2: s16 = 0;
    let mut temp3: s16 = 0;
    temp1 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             ((*this).actor.shape.rot.y as libc::c_int +
                  (*this).unk_310 as libc::c_int) as s16 as libc::c_int) as
            s16;
    temp2 =
        if (temp1 as libc::c_int) < -(500 as libc::c_int) {
            -(500 as libc::c_int)
        } else if temp1 as libc::c_int > 500 as libc::c_int {
            500 as libc::c_int
        } else { temp1 as libc::c_int } as s16;
    temp1 = (temp1 as libc::c_int - (*this).unk_30E as libc::c_int) as s16;
    temp3 =
        if (temp1 as libc::c_int) < -(500 as libc::c_int) {
            -(500 as libc::c_int)
        } else if temp1 as libc::c_int > 500 as libc::c_int {
    ...
    (*this).unk_310 =
        if ((*this).unk_310 as libc::c_int) < -(18783 as libc::c_int) {
            -(18783 as libc::c_int)
        } else if (*this).unk_310 as libc::c_int > 18783 as libc::c_int {
            18783 as libc::c_int
        } else { (*this).unk_310 as libc::c_int } as s16;
    (*this).unk_30E =
        if ((*this).unk_30E as libc::c_int) < -(9583 as libc::c_int) {
            -(9583 as libc::c_int)
        } else if (*this).unk_30E as libc::c_int > 9583 as libc::c_int {
            9583 as libc::c_int
        } else { (*this).unk_30E as libc::c_int } as s16;
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE4114(mut this: *mut EnRd,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
    ...
    if gSaveContext.sunsSongState as libc::c_int !=
           SUNSSONG_INACTIVE as libc::c_int &&
           (*this).actor.shape.rot.x as libc::c_int == 0 as libc::c_int &&
           (*this).unk_318 as libc::c_int == 0 as libc::c_int &&
           (*this).unk_31B as libc::c_int != 9 as libc::c_int &&
           (*this).unk_31B as libc::c_int != 10 as libc::c_int &&
           (*this).unk_31B as libc::c_int != 1 as libc::c_int {
        func_80AE3DE4(this);
        return
    }
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).unk_31B as libc::c_int != 11 as libc::c_int {
            Actor_SetDropFlag(&mut (*this).actor, &mut (*this).collider.info,
                              1 as libc::c_int);
            if (*player).unk_844 as libc::c_int != 0 as libc::c_int {
                (*this).unk_31D = (*player).unk_845
            }
            if (*this).unk_31C as libc::c_int != 0 as libc::c_int &&
                   (*this).unk_31C as libc::c_int != 6 as libc::c_int {
                if ((*this).unk_31C as libc::c_int == 1 as libc::c_int ||
                        (*this).unk_31C as libc::c_int == 13 as libc::c_int)
                       && (*this).unk_31B as libc::c_int != 1 as libc::c_int {
                ...
                (*this).unk_318 = 0 as libc::c_int as u8_0;
                (*this).unk_316 = 0 as libc::c_int as s16;
                if (*this).unk_31C as libc::c_int == 0xe as libc::c_int {
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0x4000 as libc::c_int as s16,
                                         0xff as libc::c_int as s16,
                                         0 as libc::c_int as s16,
                                         0x50 as libc::c_int as s16);
                    (*this).unk_31A = 0x28 as libc::c_int as u8_0
                } else {
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0x4000 as libc::c_int as s16,
                                         0xff as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnRd_Update(mut thisx: *mut Actor,
                                     mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnRd = thisx as *mut EnRd;
    let mut player: *mut Player =
    ...
    if (*this).unk_31C as libc::c_int != 6 as libc::c_int &&
           ((*this).unk_31B as libc::c_int != 11 as libc::c_int ||
                (*this).unk_31C as libc::c_int != 14 as libc::c_int) {
        if (*this).unk_306 as libc::c_int != 0 as libc::c_int {
            (*this).unk_306 = (*this).unk_306.wrapping_sub(1)
        }
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        if (*this).unk_31B as libc::c_int != 8 as libc::c_int &&
               (*this).actor.speedXZ != 0.0f32 {
            Actor_MoveForward(&mut (*this).actor);
        }
        if (*this).actor.shape.rot.x as libc::c_int == 0 as libc::c_int &&
               (*this).unk_31B as libc::c_int != 8 as libc::c_int &&
               (*this).actor.speedXZ != 0.0f32 {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 30.0f32,
                                    20.0f32, 35.0f32, 0x1d as libc::c_int);
        }
        if (*this).unk_31B as libc::c_int == 7 as libc::c_int {
            func_80AE3F9C(this, globalCtx);
        }
    }
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).actor.focus.pos.y += 50.0f32;
    if (*this).actor.colChkInfo.health as libc::c_int > 0 as libc::c_int &&
           (*this).unk_31B as libc::c_int != 8 as libc::c_int {
        ...
        if (*this).unk_31B as libc::c_int != 9 as libc::c_int ||
               (*player).unk_844 as libc::c_int != 0 as libc::c_int &&
                   (*player).unk_845 as libc::c_int !=
                       (*this).unk_31D as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnRd_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnRd = thisx as *mut EnRd;
    if limbIndex == 23 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_30E as libc::c_int) as s16
    } else if limbIndex == 12 as libc::c_int {
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).unk_310 as libc::c_int) as s16
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnRd_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                           mut limbIndex: s32,
                                           mut dList: *mut *mut Gfx,
                                           mut rot: *mut Vec3s,
                                           mut thisx: *mut libc::c_void,
                                           mut gfx: *mut *mut Gfx) {
    let mut sp2C: Vec3f = D_80AE4940;
    let mut this: *mut EnRd = thisx as *mut EnRd;
    let mut idx: s32 = -(1 as libc::c_int);
    let mut destPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*this).unk_31A as libc::c_int != 0 as libc::c_int ||
        ...
        match limbIndex - 1 as libc::c_int {
            23 => { idx = 0 as libc::c_int }
            0 => { idx = 1 as libc::c_int }
            21 => { idx = 2 as libc::c_int }
            17 => { idx = 3 as libc::c_int }
            13 => { idx = 4 as libc::c_int }
            24 => { idx = 5 as libc::c_int }
            8 => { idx = 6 as libc::c_int }
            3 => { idx = 7 as libc::c_int }
            10 => { idx = 8 as libc::c_int }
            5 => { idx = 9 as libc::c_int }
            _ => { }
        }
        if idx >= 0 as libc::c_int {
            Matrix_MultVec3f(&mut sp2C, &mut destPos);
            (*this).firePos[idx as usize].x = destPos.x as s16;
            (*this).firePos[idx as usize].y = destPos.y as s16;
            (*this).firePos[idx as usize].z = destPos.z as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRd_Draw(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnRd = thisx as *mut EnRd;
    let mut thisPos: Vec3f = (*thisx).world.pos;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_rd.c\x00" as *const u8 as *const libc::c_char,
                    1679 as libc::c_int);
    if (*this).unk_314 as libc::c_int == 0xff as libc::c_int {
        ...
        (*__gfxCtx).polyOpa.p =
            SkelAnime_DrawFlex(globalCtx, (*this).skelAnime.skeleton,
                               ...
                               (*__gfxCtx).polyOpa.p);
        func_80033C30(&mut thisPos, &mut D_80AE4958,
                      255 as libc::c_int as u8_0, globalCtx);
        if (*this).unk_31A as libc::c_int != 0 as libc::c_int {
            (*thisx).colorFilterTimer =
                (*thisx).colorFilterTimer.wrapping_add(1);
            (*this).unk_31A = (*this).unk_31A.wrapping_sub(1);
            if (*this).unk_31A as libc::c_int % 4 as libc::c_int ==
                   0 as libc::c_int {
                EffectSsEnFire_SpawnVec3s(globalCtx, thisx,
                                          &mut *(*this).firePos.as_mut_ptr().offset(((*this).unk_31A
                                                                                         as
                                                                                         libc::c_int
                                                                                         >>
                                                                                         2
                                                                                        ...
                                                                                        as
                                                                                        isize),
                                          0x4b as libc::c_int as s16,
                                          0 as libc::c_int as s16,
                                          0 as libc::c_int as s16,
                                          ((*this).unk_31A as libc::c_int >>
        ...
        (*__gfxCtx).polyXlu.p =
            SkelAnime_DrawFlex(globalCtx, (*this).skelAnime.skeleton,
                               ...
                               this as *mut libc::c_void,
                               (*__gfxCtx).polyXlu.p);
        func_80033C30(&mut thisPos, &mut D_80AE4958, (*this).unk_314 as u8_0,
                      globalCtx);
    }
