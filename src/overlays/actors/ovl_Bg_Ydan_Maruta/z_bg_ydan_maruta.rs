...
extern "C" {
    ...
    fn OnePointCutscene_Init(globalCtx: *mut GlobalContext, csId: s16,
     ...
     -> s16;
    #[no_mangle]
    static mut gDTFallingLadderDL: [Gfx; 0];
    #[no_mangle]
    static mut gDTFallingLadderCol: CollisionHeader;
    #[no_mangle]
    static mut gDTRollingSpikeTrapDL: [Gfx; 0];
}
...
pub struct BgYdanMaruta {
    ...
    pub actionFunc: BgYdanMarutaActionFunc,
    pub switchFlag: u8_0,
    pub unk_16A: s16,
    pub collider: ColliderTris,
    pub elements: [ColliderTrisElement; 2],
}
pub type BgYdanMarutaActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgYdanMaruta, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Ydan_Maruta_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_YDAN_MARUTA as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgYdanMaruta>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanMaruta_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanMaruta_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanMaruta_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgYdanMaruta_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanMaruta_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0; // thisx is required to match here
    let mut this: *mut BgYdanMaruta = thisx as *mut BgYdanMaruta;
    let mut sp4C: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut i: s32 = 0;
    let mut sinRotY: f32_0 = 0.;
    let mut cosRotY: f32_0 = 0.;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut triInit: *mut ColliderTrisElementInit =
    ...
    (*this).switchFlag =
        ((*this).dyna.actor.params as libc::c_int & 0xffff as libc::c_int) as
            u8_0;
    (*thisx).params =
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        triInit =
            &mut *sTrisElementsInit.as_mut_ptr().offset(0 as libc::c_int as
                                                            isize) as
                *mut ColliderTrisElementInit;
        (*this).actionFunc =
            Some(func_808BEFF4 as
                     unsafe extern "C" fn(_: *mut BgYdanMaruta,
                                          _: *mut GlobalContext) -> ())
    } else {
        triInit =
            &mut *sTrisElementsInit.as_mut_ptr().offset(1 as libc::c_int as
                                                            isize) as
                *mut ColliderTrisElementInit;
        DynaPolyActor_Init(&mut (*this).dyna, DPM_UNK as libc::c_int);
        CollisionHeader_GetVirtual(&mut gDTFallingLadderCol as
                                       *mut CollisionHeader as
                                       *mut libc::c_void, &mut colHeader);
        (*this).dyna.bgId =
            DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                                thisx, colHeader);
        (*thisx).home.pos.y += -280.0f32;
        if Flags_GetSwitch(globalCtx, (*this).switchFlag as s32) != 0 {
            (*thisx).world.pos.y = (*thisx).home.pos.y;
            (*this).actionFunc =
                Some(BgYdanMaruta_DoNothing as
                         unsafe extern "C" fn(_: *mut BgYdanMaruta,
                                              _: *mut GlobalContext) -> ())
        } else {
            (*this).actionFunc =
                Some(func_808BF078 as
                         unsafe extern "C" fn(_: *mut BgYdanMaruta,
                                              _: *mut GlobalContext) -> ())
        }
    }
    ...
    while i < 3 as libc::c_int {
        sp4C[i as usize].x =
            (*triInit).dim.vtx[i as usize].x * cosRotY +
                (*this).dyna.actor.world.pos.x;
        sp4C[i as usize].y =
            (*triInit).dim.vtx[i as usize].y + (*this).dyna.actor.world.pos.y;
        sp4C[i as usize].z =
            (*this).dyna.actor.world.pos.z -
                (*triInit).dim.vtx[i as usize].x * sinRotY;
        i += 1
    }
    Collider_SetTrisVertices(&mut (*this).collider, 0 as libc::c_int,
                             &mut *sp4C.as_mut_ptr().offset(0 as libc::c_int
                                                                as isize),
                             &mut *sp4C.as_mut_ptr().offset(1 as libc::c_int
                                                                as isize),
                             &mut *sp4C.as_mut_ptr().offset(2 as libc::c_int
                                                                as isize));
    sp4C[1 as libc::c_int as usize].x =
        (*triInit).dim.vtx[2 as libc::c_int as usize].x * cosRotY +
            (*this).dyna.actor.world.pos.x;
    sp4C[1 as libc::c_int as usize].y =
        (*triInit).dim.vtx[0 as libc::c_int as usize].y +
            (*this).dyna.actor.world.pos.y;
    sp4C[1 as libc::c_int as usize].z =
        (*this).dyna.actor.world.pos.z -
            (*triInit).dim.vtx[2 as libc::c_int as usize].x * sinRotY;
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanMaruta_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgYdanMaruta = thisx as *mut BgYdanMaruta;
...
#[no_mangle]
pub unsafe extern "C" fn func_808BEFF4(mut this: *mut BgYdanMaruta,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        func_8002F71C(globalCtx, &mut (*this).dyna.actor, 7.0f32,
                      (*this).dyna.actor.shape.rot.y, 6.0f32);
    }
    (*this).dyna.actor.shape.rot.x =
        ((*this).dyna.actor.shape.rot.x as libc::c_int + 0x360 as libc::c_int)
            as s16;
    CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).collider.base);
    func_8002F974(&mut (*this).dyna.actor,
                  (0x28ec as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_808BF078(mut this: *mut BgYdanMaruta,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        (*this).actionFunc =
            Some(func_808BF108 as
                     unsafe extern "C" fn(_: *mut BgYdanMaruta,
                                          _: *mut GlobalContext) -> ());
        OnePointCutscene_Init(globalCtx, 3010 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808BF108(mut this: *mut BgYdanMaruta,
                                       mut globalCtx: *mut GlobalContext) {
    let mut temp: s16 = 0;
    ...
    if (*this).unk_16A as libc::c_int == 0 as libc::c_int {
        (*this).actionFunc =
            Some(func_808BF1EC as
                     unsafe extern "C" fn(_: *mut BgYdanMaruta,
                                          _: *mut GlobalContext) -> ())
    }
    temp =
        ((*this).unk_16A as libc::c_int % 4 as libc::c_int - 2 as libc::c_int)
            as s16;
    if temp as libc::c_int == -(2 as libc::c_int) {
        temp = 0 as libc::c_int as s16
    } else { temp = (temp as libc::c_int * 2 as libc::c_int) as s16 }
    (*this).dyna.actor.world.pos.x =
        Math_CosS((*this).dyna.actor.shape.rot.y) *
            temp as libc::c_int as libc::c_float +
    ...
    func_8002F974(&mut (*this).dyna.actor,
                  (0x2858 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn func_808BF1EC(mut this: *mut BgYdanMaruta,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanMaruta_DoNothing(mut this: *mut BgYdanMaruta,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgYdanMaruta_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgYdanMaruta = thisx as *mut BgYdanMaruta;
...
#[no_mangle]
pub unsafe extern "C" fn BgYdanMaruta_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut BgYdanMaruta = thisx as *mut BgYdanMaruta;
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        Gfx_DrawDListOpa(globalCtx, gDTRollingSpikeTrapDL.as_mut_ptr());
    } else { Gfx_DrawDListOpa(globalCtx, gDTFallingLadderDL.as_mut_ptr()); };
}
