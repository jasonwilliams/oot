...
extern "C" {
    ...
    #[no_mangle]
    fn Audio_PlaySoundRiver(pos: *mut Vec3f, freqScale: f32_0);
    #[no_mangle]
    fn func_800F4870(_: u8_0);
    #[no_mangle]
    fn func_800F4A54(_: u8_0);
    #[no_mangle]
    fn func_800F4E30(pos: *mut Vec3f, _: f32_0);
    #[no_mangle]
    fn Audio_ClearSariaBgmAtPos(pos: *mut Vec3f);
    #[no_mangle]
    fn Audio_PlaySariaBgm(pos: *mut Vec3f, seqId: u16_0, distMax: u16_0);
    #[no_mangle]
    fn Audio_ClearSariaBgm2();
    #[no_mangle]
...
pub struct EnRiverSound {
    pub actor: Actor,
    pub playSound: u8_0,
    pub soundPitchIndex: u8_0,
    pub pathIndex: s16,
}
pub type C2RustUnnamed_19 = libc::c_uint;
pub const RS_MAX: C2RustUnnamed_19 = 248;
pub const RS_UNK_F7: C2RustUnnamed_19 = 247;
pub const RS_COW_MOOING: C2RustUnnamed_19 = 21;
pub const RS_TORCH_CRACKLING: C2RustUnnamed_19 = 20;
pub const RS_UNK_19: C2RustUnnamed_19 = 19;
pub const RS_RUMBLING: C2RustUnnamed_19 = 18;
pub const RS_CHAMBER_OF_SAGES_2: C2RustUnnamed_19 = 17;
pub const RS_CHAMBER_OF_SAGES_1: C2RustUnnamed_19 = 16;
pub const RS_LAKESIDE_LAB_TANK: C2RustUnnamed_19 = 15;
pub const RS_SANDSTORM: C2RustUnnamed_19 = 14;
pub const RS_UNK_13: C2RustUnnamed_19 = 13;
pub const RS_SARIAS_SONG: C2RustUnnamed_19 = 12;
pub const RS_UNK_11: C2RustUnnamed_19 = 11;
pub const RS_MARKET_CROWD: C2RustUnnamed_19 = 10;
pub const RS_FOUNTAIN_WATER: C2RustUnnamed_19 = 9;
pub const RS_DRIPPING_WATER: C2RustUnnamed_19 = 8;
pub const RS_LAVA_BUBBLES_3: C2RustUnnamed_19 = 7;
pub const RS_LAVA_BUBBLES_2: C2RustUnnamed_19 = 6;
pub const RS_UNK_5: C2RustUnnamed_19 = 5;
pub const RS_UNK_4: C2RustUnnamed_19 = 4;
pub const RS_LARGE_WATERFALL: C2RustUnnamed_19 = 3;
pub const RS_LAVA_BUBBLES_1: C2RustUnnamed_19 = 2;
pub const RS_SMALL_WATERFALL: C2RustUnnamed_19 = 1;
pub const RS_UNK_0: C2RustUnnamed_19 = 0;
#[no_mangle]
pub static mut En_River_Sound_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_RIVER_SOUND as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnRiverSound>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnRiverSound_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnRiverSound_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnRiverSound_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnRiverSound_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnRiverSound_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnRiverSound = thisx as *mut EnRiverSound;
    (*this).playSound = 0 as libc::c_int as u8_0;
    (*this).pathIndex =
    ...
    if (*this).actor.params as libc::c_int >= RS_MAX as libc::c_int {
        // used for ganon and ganon_boss scenes
        func_800F4870(((*this).actor.params as libc::c_int -
                           RS_MAX as libc::c_int) as u8_0);
        Actor_Kill(&mut (*this).actor);
    } else if (*this).actor.params as libc::c_int == RS_UNK_F7 as libc::c_int
     {
        func_800F6FB4(4 as libc::c_int as u8_0);
        Actor_Kill(&mut (*this).actor);
    } else if (*this).actor.params as libc::c_int ==
                  RS_SARIAS_SONG as libc::c_int {
        if gBitFlags[QUEST_SONG_LULLABY as libc::c_int as usize] &
               gSaveContext.inventory.questItems == 0 ||
               gBitFlags[QUEST_SONG_SARIA as libc::c_int as usize] &
                   gSaveContext.inventory.questItems != 0 {
            Actor_Kill(&mut (*this).actor);
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnRiverSound_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnRiverSound = thisx as *mut EnRiverSound;
    if (*this).actor.params as libc::c_int == RS_SARIAS_SONG as libc::c_int {
        Audio_ClearSariaBgmAtPos(&mut (*this).actor.projectedPos);
    } else if (*this).actor.params as libc::c_int == RS_UNK_13 as libc::c_int
     {
        Audio_ClearSariaBgm2();
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AE6A54(mut arg0: *mut Vec3f,
                                       mut arg1: *mut Vec3f,
                                       mut arg2: *mut Vec3f,
                                       mut arg3: *mut Vec3f) -> s32 {
    let mut vec: [Vec3f; 3] = [Vec3f{x: 0., y: 0., z: 0.,}; 3];
    let mut temp: f32_0 = 0.;
    vec[0 as libc::c_int as usize].x = (*arg0).x - (*arg2).x;
    vec[0 as libc::c_int as usize].y = (*arg0).y - (*arg2).y;
    vec[0 as libc::c_int as usize].z = (*arg0).z - (*arg2).z;
    vec[1 as libc::c_int as usize].x = (*arg1).x - (*arg2).x;
    vec[1 as libc::c_int as usize].y = (*arg1).y - (*arg2).y;
    vec[1 as libc::c_int as usize].z = (*arg1).z - (*arg2).z;
    vec[2 as libc::c_int as usize].x =
        vec[1 as libc::c_int as usize].x - vec[0 as libc::c_int as usize].x;
    vec[2 as libc::c_int as usize].y =
        vec[1 as libc::c_int as usize].y - vec[0 as libc::c_int as usize].y;
    vec[2 as libc::c_int as usize].z =
        vec[1 as libc::c_int as usize].z - vec[0 as libc::c_int as usize].z;
    temp =
        vec[2 as libc::c_int as usize].x * vec[0 as libc::c_int as usize].x +
            vec[2 as libc::c_int as usize].y *
                vec[0 as libc::c_int as usize].y +
            vec[2 as libc::c_int as usize].z *
                vec[0 as libc::c_int as usize].z;
    if (vec[2 as libc::c_int as usize].x * vec[1 as libc::c_int as usize].x +
            vec[2 as libc::c_int as usize].y *
                vec[1 as libc::c_int as usize].y +
            vec[2 as libc::c_int as usize].z *
                vec[1 as libc::c_int as usize].z) * temp < 0.0f32 {
        temp =
            -temp /
                (vec[2 as libc::c_int as usize].x *
                     vec[2 as libc::c_int as usize].x +
                     ...
                     vec[2 as libc::c_int as usize].z *
                         vec[2 as libc::c_int as usize].z);
        (*arg3).x = vec[2 as libc::c_int as usize].x * temp + (*arg0).x;
        (*arg3).y = vec[2 as libc::c_int as usize].y * temp + (*arg0).y;
        (*arg3).z = vec[2 as libc::c_int as usize].z * temp + (*arg0).z;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnRiverSound_GetSoundPos(mut points: *mut Vec3s,
                                                  mut numPoints: s32,
                                                  mut hearPos: *mut Vec3f,
                                                  mut soundPos: *mut Vec3f)
 -> s32 {
    let mut i: s32 = 0;
    let mut pointIdx: s32 = 0;
    let mut sp78: [s32; 2] = [0 as libc::c_int, 0 as libc::c_int];
    let mut pointLoc: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp60: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp54: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pointDist: f32_0 = 10000.0f32;
    let mut point: *mut Vec3s = 0 as *mut Vec3s;
    i = 0 as libc::c_int;
    while i < numPoints {
        let mut dist: f32_0 = 0.;
        vec.x = (*points.offset(i as isize)).x as f32_0;
        vec.y = (*points.offset(i as isize)).y as f32_0;
        vec.z = (*points.offset(i as isize)).z as f32_0;
        dist = Math_Vec3f_DistXYZ(hearPos, &mut vec);
        if dist < pointDist { pointDist = dist; pointIdx = i }
        i += 1
    }
    if pointDist >= 10000.0f32 { return 0 as libc::c_int }
    point = &mut *points.offset(pointIdx as isize) as *mut Vec3s;
    pointLoc.x = (*point).x as f32_0;
    pointLoc.y = (*point).y as f32_0;
    pointLoc.z = (*point).z as f32_0;
    if pointIdx != 0 as libc::c_int {
        vec.x = (*point.offset(-(1 as libc::c_int) as isize)).x as f32_0;
        vec.y = (*point.offset(-(1 as libc::c_int) as isize)).y as f32_0;
        vec.z = (*point.offset(-(1 as libc::c_int) as isize)).z as f32_0;
        sp78[0 as libc::c_int as usize] =
            func_80AE6A54(&mut vec, &mut pointLoc, hearPos, &mut sp54)
    }
    if pointIdx + 1 as libc::c_int != numPoints {
        vec.x = (*point.offset(1 as libc::c_int as isize)).x as f32_0;
        vec.y = (*point.offset(1 as libc::c_int as isize)).y as f32_0;
        vec.z = (*point.offset(1 as libc::c_int as isize)).z as f32_0;
        sp78[1 as libc::c_int as usize] =
            func_80AE6A54(&mut pointLoc, &mut vec, hearPos, &mut sp60)
    }
    if sp78[0 as libc::c_int as usize] != 0 &&
           sp78[1 as libc::c_int as usize] != 0 {
        if func_80AE6A54(&mut sp54, &mut sp60, hearPos, soundPos) == 0 {
            (*soundPos).x = (sp54.x + sp60.x) * 0.5f32;
            (*soundPos).y = (sp54.y + sp60.y) * 0.5f32;
            (*soundPos).z = (sp54.z + sp60.z) * 0.5f32
        }
    } else if sp78[0 as libc::c_int as usize] != 0 {
        (*soundPos).x = sp54.x;
        (*soundPos).y = sp54.y;
        (*soundPos).z = sp54.z
    } else if sp78[1 as libc::c_int as usize] != 0 {
        (*soundPos).x = sp60.x;
        (*soundPos).y = sp60.y;
        (*soundPos).z = sp60.z
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnRiverSound_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    let mut this: *mut EnRiverSound = thisx as *mut EnRiverSound;
    let mut sp34: s32 = 0;
    if (*thisx).params as libc::c_int == RS_UNK_0 as libc::c_int ||
           (*thisx).params as libc::c_int == RS_UNK_4 as libc::c_int ||
           (*thisx).params as libc::c_int == RS_UNK_5 as libc::c_int {
        path =
            &mut *(*globalCtx).setupPathList.offset((*this).pathIndex as
                                                        isize) as *mut Path;
        pos = &mut (*thisx).world.pos;
        if EnRiverSound_GetSoundPos(gSegments[(((*path).points as u32_0) <<
                                                   4 as libc::c_int >>
                                                   28 as libc::c_int) as
                                                  usize].wrapping_add((*path).points
                                                                          as
                                                                          u32_0
                                                                          &
                                                                          0xffffff
                                    ...
                                    (*path).count as s32,
                                    &mut (*player).actor.world.pos, pos) != 0
           {
            if BgCheck_EntityRaycastFloor4(&mut (*globalCtx).colCtx,
                                           &mut (*thisx).floorPoly, &mut sp34,
                                           thisx, pos) != -32000.0f32 {
                // Get the sound volume pitch based on the speed of the river current under the actor
                (*this).soundPitchIndex =
                    SurfaceType_GetConveyorSpeed(&mut (*globalCtx).colCtx,
                                                 (*thisx).floorPoly, sp34) as
                        u8_0
            } else { (*this).soundPitchIndex = 0 as libc::c_int as u8_0 }
            if (*this).soundPitchIndex as libc::c_int == 0 as libc::c_int {
                if (*thisx).params as libc::c_int == RS_UNK_4 as libc::c_int {
                    (*this).soundPitchIndex = 0 as libc::c_int as u8_0
                } else if (*thisx).params as libc::c_int ==
                              RS_UNK_0 as libc::c_int {
                    (*this).soundPitchIndex = 1 as libc::c_int as u8_0
                } else { (*this).soundPitchIndex = 2 as libc::c_int as u8_0 }
            } else {
                (*this).soundPitchIndex =
                    (*this).soundPitchIndex.wrapping_sub(1);
                (*this).soundPitchIndex =
                    if (*this).soundPitchIndex as libc::c_int >
                           2 as libc::c_int {
                        2 as libc::c_int
                    } else { (*this).soundPitchIndex as libc::c_int } as u8_0
            }
        }
    } else if (*thisx).params as libc::c_int == RS_UNK_13 as libc::c_int ||
                  (*thisx).params as libc::c_int == RS_UNK_19 as libc::c_int {
        func_8002DBD0(&mut (*player).actor, &mut (*thisx).home.pos,
                      &mut (*thisx).world.pos);
    } else if (*globalCtx).sceneNum as libc::c_int ==
                  SCENE_DDAN_BOSS as libc::c_int &&
                  Flags_GetClear(globalCtx, (*thisx).room as s32) != 0 {
        Actor_Kill(thisx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnRiverSound_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    static mut soundEffects: [s16; 22] =
        [0 as libc::c_int as s16,
         (0x2828 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x280b as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x2807 as libc::c_int - 0x800 as libc::c_int) as s16,
         0 as libc::c_int as s16, 0 as libc::c_int as s16,
         (0x2832 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x283b as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x2830 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x2841 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x285d as libc::c_int - 0x800 as libc::c_int) as s16,
         0 as libc::c_int as s16,
         (0x28a6 as libc::c_int - 0x800 as libc::c_int) as s16,
         0 as libc::c_int as s16,
         (0x28c0 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x28ca as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x28d6 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x28d7 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x2898 as libc::c_int - 0x800 as libc::c_int) as s16,
         0 as libc::c_int as s16,
         (0x2831 as libc::c_int - 0x800 as libc::c_int) as s16,
         (0x28e5 as libc::c_int - 0x800 as libc::c_int) as s16];
    static mut soundPitch: [f32_0; 3] = [0.7f32, 1.0f32, 1.4f32];
    let mut this: *mut EnRiverSound = thisx as *mut EnRiverSound;
    if (*this).playSound == 0 {
        (*this).playSound = 1 as libc::c_int as u8_0
    } else if (*this).actor.params as libc::c_int == RS_UNK_0 as libc::c_int
                  ||
                  (*this).actor.params as libc::c_int ==
                      RS_UNK_4 as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      RS_UNK_5 as libc::c_int {
        Audio_PlaySoundRiver(&mut (*this).actor.projectedPos,
                             soundPitch[(*this).soundPitchIndex as usize]);
    } else if (*this).actor.params as libc::c_int == RS_UNK_11 as libc::c_int
     {
        func_800F4A54(90 as libc::c_int as u8_0);
    } else if (*this).actor.params as libc::c_int ==
                  RS_SARIAS_SONG as libc::c_int {
        func_800F4E30(&mut (*this).actor.projectedPos,
                      (*this).actor.xzDistToPlayer);
    } else if (*this).actor.params as libc::c_int == RS_UNK_13 as libc::c_int
     {
        Audio_PlaySariaBgm(&mut (*this).actor.home.pos,
                           0x3e as libc::c_int as u16_0,
                           1000 as libc::c_int as u16_0);
    } else if (*this).actor.params as libc::c_int == RS_UNK_19 as libc::c_int
     {
        Audio_PlaySariaBgm(&mut (*this).actor.home.pos,
                           0x28 as libc::c_int as u16_0,
                           800 as libc::c_int as u16_0);
    } else if (*this).actor.params as libc::c_int ==
                  RS_SANDSTORM as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      RS_CHAMBER_OF_SAGES_1 as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      RS_CHAMBER_OF_SAGES_2 as libc::c_int ||
                  (*this).actor.params as libc::c_int ==
                      RS_RUMBLING as libc::c_int {
        func_800788CC(soundEffects[(*this).actor.params as usize] as u16_0);
    } else {
        Audio_PlayActorSound2(&mut (*this).actor,
                              soundEffects[(*this).actor.params as usize] as
                                  u16_0);
    };
}
