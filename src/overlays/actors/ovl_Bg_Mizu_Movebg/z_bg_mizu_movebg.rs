...
extern "C" {
    ...
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgDL_000190: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgCol_0003F0: CollisionHeader;
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgDL_000680: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgCol_000998: CollisionHeader;
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgDL_000C20: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgCol_000ED0: CollisionHeader;
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgDL_0011F0: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgCol_0015F8: CollisionHeader;
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgDL_002E10: [Gfx; 0];
    #[no_mangle]
    static mut gObjectMizuObjectsMovebgCol_003590: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgMizuMovebg {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgMizuMovebgActionFunc,
    pub homeY: f32_0,
...
pub type BgMizuMovebgActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgMizuMovebg, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Mizu_Movebg_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_MIZU_MOVEBG as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgMizuMovebg>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuMovebg_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuMovebg_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuMovebg_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgMizuMovebg_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut D_8089EB40: [f32_0; 4] =
    [-115.200005f32, -115.200005f32, -115.200005f32, 0.0f32];
static mut D_8089EB50: [*mut Gfx; 8] =
    unsafe {
        [gObjectMizuObjectsMovebgDL_000190.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_000680.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_000C20.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_002E10.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_002E10.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_002E10.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_002E10.as_ptr() as *mut _,
         gObjectMizuObjectsMovebgDL_0011F0.as_ptr() as *mut _]
    };
static mut D_8089EB70: [*mut CollisionHeader; 8] =
    unsafe {
        [&gObjectMizuObjectsMovebgCol_0003F0 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_000998 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_000ED0 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_003590 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_003590 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_003590 as *const CollisionHeader as
         ...
         &gObjectMizuObjectsMovebgCol_003590 as *const CollisionHeader as
             *mut CollisionHeader,
         &gObjectMizuObjectsMovebgCol_0015F8 as *const CollisionHeader as
             *mut CollisionHeader]
    };
// Initialized in run_static_initializers
static mut D_8089EB90: [InitChainEntry; 4] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 4];
static mut D_8089EBA0: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 80.0f32, z: 23.0f32,}; init };
static mut D_8089EBAC: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 80.0f32, z: 23.0f32,}; init };
static mut D_8089EE40: u8_0 = 0;
#[no_mangle]
pub unsafe extern "C" fn func_8089DC30(mut globalCtx: *mut GlobalContext)
 -> s32 {
    let mut result: s32 = 0;
    if Flags_GetSwitch(globalCtx, 0x1c as libc::c_int) != 0 {
        result = 1 as libc::c_int
    } else if Flags_GetSwitch(globalCtx, 0x1d as libc::c_int) != 0 {
        result = 2 as libc::c_int
    } else if Flags_GetSwitch(globalCtx, 0x1e as libc::c_int) != 0 {
        result = 3 as libc::c_int
    } else { result = 1 as libc::c_int }
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuMovebg_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut type_0: s32 = 0;
    let mut waypointId: s32 = 0;
    let mut waterBoxes: *mut WaterBox =
        (*(*globalCtx).colCtx.colHeader).waterBoxes;
    let mut temp: f32_0 = 0.;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    let mut sp48: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    Actor_ProcessInitChain(thisx, D_8089EB90.as_mut_ptr());
    (*(thisx as *mut BgMizuMovebg)).homeY = (*thisx).world.pos.y;
    let ref mut fresh0 = (*(thisx as *mut BgMizuMovebg)).dlist;
    *fresh0 =
        D_8089EB50[((*thisx).params as u16_0 as libc::c_int >>
                        0xc as libc::c_int & 0xf as libc::c_int) as usize];
    DynaPolyActor_Init(&mut (*(thisx as *mut BgMizuMovebg)).dyna,
                       DPM_PLAYER as libc::c_int);
    CollisionHeader_GetVirtual(D_8089EB70[((*thisx).params as u16_0 as
                                               libc::c_int >>
                                               0xc as libc::c_int &
                                               0xf as libc::c_int) as usize]
                                   as *mut libc::c_void, &mut colHeader);
    (*(thisx as *mut BgMizuMovebg)).dyna.bgId =
        DynaPoly_SetBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna, thisx,
                            colHeader);
    type_0 =
        (*thisx).params as u16_0 as libc::c_int >> 0xc as libc::c_int &
            0xf as libc::c_int;
    match type_0 {
        0 => {
            temp =
                (*waterBoxes.offset(2 as libc::c_int as isize)).ySurface as
                    libc::c_int as libc::c_float + 15.0f32;
            if temp < (*(thisx as *mut BgMizuMovebg)).homeY - 700.0f32 {
                (*thisx).world.pos.y =
                    (*(thisx as *mut BgMizuMovebg)).homeY - 700.0f32
            } else { (*thisx).world.pos.y = temp }
            let ref mut fresh1 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh1 =
                Some(func_8089E318 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        }
        1 => {
            temp =
                (*waterBoxes.offset(2 as libc::c_int as isize)).ySurface as
                    libc::c_int as libc::c_float + 15.0f32;
            if temp < (*(thisx as *mut BgMizuMovebg)).homeY - 710.0f32 {
                (*thisx).world.pos.y =
                    (*(thisx as *mut BgMizuMovebg)).homeY - 710.0f32
            } else { (*thisx).world.pos.y = temp }
            let ref mut fresh2 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh2 =
                Some(func_8089E318 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        ...
        2 => {
            ...
            let ref mut fresh3 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh3 =
                Some(func_8089E318 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        ...
        3 => {
            (*thisx).world.pos.y =
                (*(thisx as *mut BgMizuMovebg)).homeY +
                    D_8089EB40[func_8089DC30(globalCtx) as usize];
            let ref mut fresh4 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh4 =
                Some(func_8089E318 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        ...
        4 | 5 | 6 => {
            if Flags_GetSwitch(globalCtx,
                               (*thisx).params as u16_0 as libc::c_int &
                                   0x3f as libc::c_int) != 0 {
                (*thisx).world.pos.y =
                    ((*(thisx as *mut BgMizuMovebg)).homeY as libc::c_double +
                         115.19999999999999f64) as f32_0
            } else {
                (*thisx).world.pos.y = (*(thisx as *mut BgMizuMovebg)).homeY
            }
            let ref mut fresh5 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh5 =
                Some(func_8089E318 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        ...
        7 => {
            (*(thisx as *mut BgMizuMovebg)).scrollAlpha1 = 160 as libc::c_int;
            (*(thisx as *mut BgMizuMovebg)).scrollAlpha2 = 160 as libc::c_int;
            (*(thisx as *mut BgMizuMovebg)).scrollAlpha3 = 160 as libc::c_int;
            (*(thisx as *mut BgMizuMovebg)).scrollAlpha4 = 160 as libc::c_int;
            waypointId =
                (*thisx).params as u16_0 as libc::c_int & 0xf as libc::c_int;
            (*(thisx as *mut BgMizuMovebg)).waypointId = waypointId;
            func_8089E108((*globalCtx).setupPathList, &mut (*thisx).world.pos,
                          (*thisx).params as u16_0 as libc::c_int >>
                              0x8 as libc::c_int & 0xf as libc::c_int,
                          waypointId);
            let ref mut fresh6 = (*(thisx as *mut BgMizuMovebg)).actionFunc;
            *fresh6 =
                Some(func_8089E650 as
                         unsafe extern "C" fn(_: *mut BgMizuMovebg,
                                              _: *mut GlobalContext) -> ())
        }
        _ => { }
    ...
    match type_0 {
        3 | 4 | 5 | 6 => {
            Matrix_RotateY((*thisx).world.rot.y as libc::c_int as
                               libc::c_float *
                               (3.14159265358979323846f32 /
                                    32768 as libc::c_int as libc::c_float),
                           MTXMODE_NEW as libc::c_int as u8_0);
            Matrix_MultVec3f(&mut D_8089EBA0, &mut sp48);
            if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, thisx,
                                  globalCtx,
                                  ACTOR_OBJ_HSBLOCK as libc::c_int as s16,
                                  (*thisx).world.pos.x + sp48.x,
                                  (*thisx).world.pos.y + sp48.y,
                                  (*thisx).world.pos.z + sp48.z,
                                  (*thisx).world.rot.x, (*thisx).world.rot.y,
                                  (*thisx).world.rot.z,
                                  2 as libc::c_int as s16).is_null() {
                Actor_Kill(thisx);
            }
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuMovebg_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut BgMizuMovebg = thisx as *mut BgMizuMovebg;
    DynaPoly_DeleteBgActor(globalCtx, &mut (*globalCtx).colCtx.dyna,
                           (*this).dyna.bgId);
    match (*thisx).params as u16_0 as libc::c_int >> 0xc as libc::c_int &
              0xf as libc::c_int {
        3 | 4 | 5 | 6 => {
            if (*this).sfxFlags as libc::c_int & 2 as libc::c_int != 0 {
                D_8089EE40 =
                    (D_8089EE40 as libc::c_int & !(2 as libc::c_int)) as u8_0
            }
        }
        7 => {
            if (*this).sfxFlags as libc::c_int & 1 as libc::c_int != 0 {
                D_8089EE40 =
                    (D_8089EE40 as libc::c_int & !(1 as libc::c_int)) as u8_0
            }
        }
        _ => { }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_8089E108(mut pathList: *mut Path,
                                       mut pos: *mut Vec3f, mut pathId: s32,
                                       mut pointId: s32) -> s32 {
    let mut path: *mut Path = pathList;
    let mut point: *mut Vec3s = 0 as *mut Vec3s;
    path = path.offset(pathId as isize);
    point =
        &mut *((*gSegments.as_mut_ptr().offset((((*path).points as u32_0) <<
                   ...
                   *mut Vec3s).offset(pointId as isize) as *mut Vec3s;
    (*pos).x = (*point).x as f32_0;
    (*pos).y = (*point).y as f32_0;
    (*pos).z = (*point).z as f32_0;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn func_8089E198(mut this: *mut BgMizuMovebg,
...
#[no_mangle]
pub unsafe extern "C" fn func_8089E318(mut this: *mut BgMizuMovebg,
                                       mut globalCtx: *mut GlobalContext) {
    let mut waterBoxes: *mut WaterBox =
        (*(*globalCtx).colCtx.colHeader).waterBoxes;
    ...
    type_0 =
        (*this).dyna.actor.params as u16_0 as libc::c_int >>
            0xc as libc::c_int & 0xf as libc::c_int;
    match type_0 {
        0 | 2 => {
            phi_f0 =
                (*waterBoxes.offset(2 as libc::c_int as isize)).ySurface as
                    libc::c_int as libc::c_float + 15.0f32;
            if phi_f0 < (*this).homeY - 700.0f32 {
                (*this).dyna.actor.world.pos.y = (*this).homeY - 700.0f32
            } else { (*this).dyna.actor.world.pos.y = phi_f0 }
        }
        1 => {
            phi_f0 =
                (*waterBoxes.offset(2 as libc::c_int as isize)).ySurface as
                    libc::c_int as libc::c_float + 15.0f32;
            if phi_f0 < (*this).homeY - 710.0f32 {
                (*this).dyna.actor.world.pos.y = (*this).homeY - 710.0f32
            } else { (*this).dyna.actor.world.pos.y = phi_f0 }
        }
        3 => {
            phi_f0 =
                (*this).homeY + D_8089EB40[func_8089DC30(globalCtx) as usize];
            if Math_StepToF(&mut (*this).dyna.actor.world.pos.y, phi_f0,
                            1.0f32) == 0 {
                if D_8089EE40 as libc::c_int & 2 as libc::c_int == 0 &&
                       (*this).dyna.actor.params as u16_0 as libc::c_int >>
                           0x4 as libc::c_int & 0xf as libc::c_int !=
                           0 as libc::c_int {
                    D_8089EE40 =
                        (D_8089EE40 as libc::c_int | 2 as libc::c_int) as
                            u8_0;
                    (*this).sfxFlags =
                        ((*this).sfxFlags as libc::c_int | 2 as libc::c_int)
                            as u8_0
                }
                if (*this).sfxFlags as libc::c_int & 2 as libc::c_int != 0 {
                    if (*this).dyna.actor.room as libc::c_int ==
                           0 as libc::c_int {
                        func_8002F974(&mut (*this).dyna.actor,
                                      (0x2824 as libc::c_int -
        ...
        4 | 5 | 6 => {
            if Flags_GetSwitch(globalCtx,
                               (*this).dyna.actor.params as u16_0 as
                                   libc::c_int & 0x3f as libc::c_int) != 0 {
                phi_f0 = (*this).homeY + 115.200005f32
    ...
    match type_0 {
        3 | 4 | 5 | 6 => {
            if (*globalCtx).roomCtx.curRoom.num as libc::c_int ==
                   (*this).dyna.actor.room as libc::c_int {
                Matrix_RotateY((*this).dyna.actor.world.rot.y as libc::c_int
                                   as libc::c_float *
                                   (3.14159265358979323846f32 /
                                        32768 as libc::c_int as
                                            libc::c_float),
                               MTXMODE_NEW as libc::c_int as u8_0);
                Matrix_MultVec3f(&mut D_8089EBAC, &mut sp28);
                (*(*this).dyna.actor.child).world.pos.x =
                    (*this).dyna.actor.world.pos.x + sp28.x;
                (*(*this).dyna.actor.child).world.pos.y =
                    (*this).dyna.actor.world.pos.y + sp28.y;
                (*(*this).dyna.actor.child).world.pos.z =
                    (*this).dyna.actor.world.pos.z + sp28.z;
                (*(*this).dyna.actor.child).flags &=
...
#[no_mangle]
pub unsafe extern "C" fn func_8089E650(mut this: *mut BgMizuMovebg,
                                       mut globalCtx: *mut GlobalContext) {
    let mut waypoint: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    (*this).dyna.actor.speedXZ =
        ((*this).dyna.actor.params as u16_0 as libc::c_int >>
             0x4 as libc::c_int & 0xf as libc::c_int) as libc::c_float *
            0.1f32;
    func_8089E108((*globalCtx).setupPathList, &mut waypoint,
                  (*this).dyna.actor.params as u16_0 as libc::c_int >>
                      0x8 as libc::c_int & 0xf as libc::c_int,
                  (*this).waypointId);
    dist = Actor_WorldDistXYZToPoint(&mut (*this).dyna.actor, &mut waypoint);
    if dist < (*this).dyna.actor.speedXZ { (*this).dyna.actor.speedXZ = dist }
    func_80035844(&mut (*this).dyna.actor.world.pos, &mut waypoint,
                  &mut (*this).dyna.actor.world.rot, 1 as libc::c_int);
    func_8002D97C(&mut (*this).dyna.actor);
    ...
    if fabsf(dx) < 2.0f32 && fabsf(dy) < 2.0f32 && fabsf(dz) < 2.0f32 {
        (*this).waypointId += 1;
        if (*this).waypointId >=
               (*(*globalCtx).setupPathList.offset(((*this).dyna.actor.params
                                                        as u16_0 as
                                                        libc::c_int >>
                                                        0x8 as libc::c_int &
                                                       ...
                                                       isize)).count as
                   libc::c_int {
            (*this).waypointId = 0 as libc::c_int;
            func_8089E108((*globalCtx).setupPathList,
    ...
    if D_8089EE40 as libc::c_int & 1 as libc::c_int == 0 &&
           (*this).dyna.actor.params as u16_0 as libc::c_int >>
               0x4 as libc::c_int & 0xf as libc::c_int != 0 as libc::c_int {
        D_8089EE40 = (D_8089EE40 as libc::c_int | 1 as libc::c_int) as u8_0;
        (*this).sfxFlags =
            ((*this).sfxFlags as libc::c_int | 1 as libc::c_int) as u8_0
    }
    if (*this).sfxFlags as libc::c_int & 1 as libc::c_int != 0 {
        func_8002F948(&mut (*this).dyna.actor,
                      (0x2882 as libc::c_int - 0x800 as libc::c_int) as
                          u16_0);
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgMizuMovebg_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut BgMizuMovebg = thisx as *mut BgMizuMovebg;
...
#[no_mangle]
pub unsafe extern "C" fn BgMizuMovebg_Draw(mut thisx: *mut Actor,
                                           mut globalCtx2:
                                               *mut GlobalContext) {
    let mut this: *mut BgMizuMovebg = thisx as *mut BgMizuMovebg;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_mizu_movebg.c\x00" as *const u8 as
                        *const libc::c_char, 754 as libc::c_int);
    ...
    (*_g).words.w1 =
        Gfx_TwoTexScrollEnvColor((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 frames.wrapping_mul(1 as libc::c_int as
                                                         libc::c_uint),
                                 ...
                                 (*this).scrollAlpha1) as libc::c_uint;
    ...
    (*_g_0).words.w1 =
        Gfx_TwoTexScrollEnvColor((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 ...
                                 32 as libc::c_int, 0 as libc::c_int,
                                 0 as libc::c_int, 0 as libc::c_int,
                                 (*this).scrollAlpha2) as libc::c_uint;
    ...
    (*_g_1).words.w1 =
        Gfx_TwoTexScrollEnvColor((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 ...
                                 32 as libc::c_int, 0 as libc::c_int,
                                 0 as libc::c_int, 0 as libc::c_int,
                                 (*this).scrollAlpha3) as libc::c_uint;
    ...
    (*_g_2).words.w1 =
        Gfx_TwoTexScrollEnvColor((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                                 frames.wrapping_mul(3 as libc::c_int as
                                                         libc::c_uint),
                                 0 as libc::c_int as u32_0, 32 as libc::c_int,
                                 32 as libc::c_int, 1 as libc::c_int,
                                 0 as libc::c_int as u32_0,
                                 ...
                                 32 as libc::c_int, 0 as libc::c_int,
                                 0 as libc::c_int, 0 as libc::c_int,
                                 (*this).scrollAlpha4) as libc::c_uint;
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_bg_mizu_movebg.c\x00" as *const u8 as
                         *const libc::c_char, 795 as libc::c_int);
}
