...
extern "C" {
    ...
    #[no_mangle]
    static mut gKakarikoBOTWStoneDL: [Gfx; 0];
    #[no_mangle]
    static mut gKakarikoBOTWStoneCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot01Idosoko {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot01IdosokoActionFunc,
}
pub type BgSpot01IdosokoActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot01Idosoko,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Spot01_Idosoko_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT01_IDOSOKO as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId:
                              OBJECT_SPOT01_MATOYA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot01Idosoko>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idosoko_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idosoko_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idosoko_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot01Idosoko_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idosoko_SetupAction(mut this:
                                                         *mut BgSpot01Idosoko,
                                                     mut actionFunc:
                                                         BgSpot01IdosokoActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idosoko_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSpot01Idosoko = thisx as *mut BgSpot01Idosoko;
    ...
    CollisionHeader_GetVirtual(&mut gKakarikoBOTWStoneCol as
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        ...
        BgSpot01Idosoko_SetupAction(this,
                                    Some(func_808ABF54 as
                                             unsafe extern "C" fn(_:
                                                                      *mut BgSpot01Idosoko,
                                                                  _:
                                                                      *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idosoko_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot01Idosoko = thisx as *mut BgSpot01Idosoko;
...
#[no_mangle]
pub unsafe extern "C" fn func_808ABF54(mut this: *mut BgSpot01Idosoko,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idosoko_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgSpot01Idosoko = thisx as *mut BgSpot01Idosoko;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot01Idosoko_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_spot01_idosoko.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gKakarikoBOTWStoneDL.as_mut_ptr() as libc::c_uint;
