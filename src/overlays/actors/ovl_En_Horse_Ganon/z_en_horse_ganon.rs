...
extern "C" {
    ...
    #[no_mangle]
    static mut gHorseGanonTrottingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonRearingAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonWhinnyAnim: AnimationHeader;
    #[no_mangle]
    static mut gHorseGanonWalkingAnim: AnimationHeader;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnHorseGanon {
    pub actor: Actor,
    pub action: s32,
    pub currentAnimation: s32,
    pub skin: PSkinAwb,
    pub unk_1E4: [u8_0; 4],
    pub soundCount: s32,
    pub unk_1EC: s32,
    ...
    pub colliderHead: ColliderJntSph,
    pub headElements: [ColliderJntSphElement; 1],
}
pub type EnHorseGanonActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnHorseGanon, _: *mut GlobalContext)
               -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct unk_D_80A69248 {
    pub unk_0: Vec3s,
    pub unk_6: u8_0,
}
#[no_mangle]
pub static mut En_Horse_Ganon_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_HORSE_GANON as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_HORSE_GANON as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnHorseGanon>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGanon_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGanon_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGanon_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnHorseGanon_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sAnimations: [*mut AnimationHeader; 6] =
    unsafe {
        [&gHorseGanonIdleAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseGanonWhinnyAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseGanonWalkingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseGanonTrottingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseGanonGallopingAnim as *const AnimationHeader as
             *mut AnimationHeader,
         &gHorseGanonRearingAnim as *const AnimationHeader as
             *mut AnimationHeader]
    };
static mut splaySpeeds: [f32_0; 6] =
    [2.0f32 / 3.0f32, 2.0f32 / 3.0f32, 1.0f32, 1.0f32, 1.0f32,
     2.0f32 / 3.0f32];
...
static mut D_80A69248: [unk_D_80A69248; 14] =
    [{
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0x9b8 as libc::c_int as s16,
                                              y: 0x126 as libc::c_int as s16,
                                              z:
                                                  0xe2c as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
         init
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xc11 as libc::c_int as s16,
                                              y: 0x17a as libc::c_int as s16,
                                              z:
                                                  0x1269 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0x64e as libc::c_int as s16,
                                              y: 0xfefb as libc::c_int as s16,
                                              z:
                                                  0x1dac as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0x2f2 as libc::c_int as s16,
                                              y: 0xff45 as libc::c_int as s16,
                                              z:
                                                  0x244f as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xf96e as libc::c_int as s16,
                                              y: 0xfe0c as libc::c_int as s16,
                                              z:
                                                  0x3122 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xf328 as libc::c_int as s16,
                                              y: 0xfe0c as libc::c_int as s16,
                                              z:
                                                  0x32d5 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xebea as libc::c_int as s16,
                                              y: 0xfe5f as libc::c_int as s16,
                                              z:
                                                  0x2d6e as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xe95e as libc::c_int as s16,
                                              y: 0xfe27 as libc::c_int as s16,
                                              z:
                                                  0x2565 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xe593 as libc::c_int as s16,
                                              y: 0xfe0c as libc::c_int as s16,
                                              z:
                                                  0x20ac as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xe625 as libc::c_int as s16,
                                              y: 0xfe77 as libc::c_int as s16,
                                              z:
                                                  0x1b07 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xebb7 as libc::c_int as s16,
                                              y: 0x7c as libc::c_int as s16,
                                              z:
                                                  0x1539 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xf466 as libc::c_int as s16,
                                              y: 0x2 as libc::c_int as s16,
                                              z:
                                                  0x11b9 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xf47b as libc::c_int as s16,
                                              y: 0xffdd as libc::c_int as s16,
                                              z:
                                                  0x11af as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
     ...
     },
     {
         let mut init =
             unk_D_80A69248{unk_0:
                                {
                                    let mut init =
                                        Vec3s{x: 0xf88d as libc::c_int as s16,
                                              y: 0xffd1 as libc::c_int as s16,
                                              z:
                                                  0xba2 as libc::c_int as
                                                      s16,};
                                    init
                                },
                            unk_6: 0x7 as libc::c_int as u8_0,};
...
static mut D_80A692B8: [s32; 2] = [0 as libc::c_int, 16 as libc::c_int];
// Initialized in run_static_initializers
static mut sInitChain: [InitChainEntry; 1] =
    [InitChainEntry{cont_type_0_offset_value: [0; 4],}; 1];
static mut sActionFuncs: [EnHorseGanonActionFunc; 2] =
    unsafe {
        [Some(func_80A68AF0 as
                  unsafe extern "C" fn(_: *mut EnHorseGanon,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80A68DB0 as
                  unsafe extern "C" fn(_: *mut EnHorseGanon,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub unsafe extern "C" fn func_80A68660(mut data: *mut unk_D_80A69248,
                                       mut index: s32, mut vec: *mut Vec3f) {
    (*vec).x = (*data.offset(index as isize)).unk_0.x as f32_0;
    (*vec).y = (*data.offset(index as isize)).unk_0.y as f32_0;
    (*vec).z = (*data.offset(index as isize)).unk_0.z as f32_0;
}
#[no_mangle]
pub unsafe extern "C" fn func_80A686A8(mut this: *mut EnHorseGanon,
                                       mut globalCtx: *mut GlobalContext) {
    let mut tempPos: *mut Vec3f = 0 as *mut Vec3f;
    let mut vec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut y: s16 = 0;
    func_80A68660(D_80A69248.as_mut_ptr(), (*this).unk_1EC, &mut vec);
    if Math3D_Vec3f_DistXYZ(&mut vec, &mut (*this).actor.world.pos) <=
           400.0f32 {
        (*this).unk_1EC += 1 as libc::c_int;
        if (*this).unk_1EC >= 14 as libc::c_int {
            (*this).unk_1EC = 0 as libc::c_int;
            func_80A68660(D_80A69248.as_mut_ptr(), 0 as libc::c_int,
                          &mut vec);
        }
    }
    tempPos = &mut (*this).actor.world.pos;
    y =
        (Math_Vec3f_Yaw(tempPos, &mut vec) as libc::c_int -
             (*this).actor.world.rot.y as libc::c_int) as s16;
    if y as libc::c_int >= 301 as libc::c_int {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int + 300 as libc::c_int) as
                s16
    } else if (y as libc::c_int) < -(300 as libc::c_int) {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int - 300 as libc::c_int) as
                s16
    } else {
        (*this).actor.world.rot.y =
            ((*this).actor.world.rot.y as libc::c_int + y as libc::c_int) as
                s16
    }
    ...
    } else if (*this).actor.speedXZ <
                  D_80A69248[(*this).unk_1EC as usize].unk_6 as libc::c_int as
                      libc::c_float {
        (*this).actor.speedXZ += 0.5f32
    } else { (*this).actor.speedXZ -= 0.5f32 };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A68870(mut this: *mut EnHorseGanon) {
    if (*this).skin.skelAnime.curFrame >
           D_80A692B8[(*this).soundCount as usize] as libc::c_float &&
           ((*this).soundCount != 0 as libc::c_int ||
                !((*this).skin.skelAnime.curFrame >
                      D_80A692B8[1 as libc::c_int as usize] as libc::c_float))
       {
        ...
        (*this).soundCount += 1;
        if (*this).soundCount >= 2 as libc::c_int {
            (*this).soundCount = 0 as libc::c_int
        }
    };
}
// size = 0x8
#[no_mangle]
pub unsafe extern "C" fn EnHorseGanon_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHorseGanon = thisx as *mut EnHorseGanon;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    Actor_SetScale(&mut (*this).actor, 0.0115f32);
    ...
    func_800A663C(globalCtx, &mut (*this).skin, &mut gHorseGanonSkel,
                  &mut gHorseGanonIdleAnim);
    (*this).currentAnimation = 0 as libc::c_int;
    ...
    Collider_InitJntSph(globalCtx, &mut (*this).colliderHead);
    Collider_SetJntSph(globalCtx, &mut (*this).colliderHead,
...
#[no_mangle]
pub unsafe extern "C" fn EnHorseGanon_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut this: *mut EnHorseGanon = thisx as *mut EnHorseGanon;
    func_800A6888(globalCtx, &mut (*this).skin);
    Collider_DestroyCylinder(globalCtx, &mut (*this).colliderBody);
    Collider_DestroyJntSph(globalCtx, &mut (*this).colliderHead);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A68AC4(mut this: *mut EnHorseGanon) {
    (*this).action = 0 as libc::c_int;
    Animation_PlayLoop(&mut (*this).skin.skelAnime,
                       sAnimations[4 as libc::c_int as usize]);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A68AF0(mut this: *mut EnHorseGanon,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.speedXZ = 0.0f32;
    SkelAnime_Update(&mut (*this).skin.skelAnime);
}
#[no_mangle]
pub unsafe extern "C" fn func_80A68B20(mut this: *mut EnHorseGanon) {
    let mut animationChanged: s32 = 0;
    let mut sp30: f32_0 = 0.;
    animationChanged = 0 as libc::c_int;
    (*this).action = 1 as libc::c_int;
    if (*this).actor.speedXZ <= 3.0f32 {
        if (*this).currentAnimation != 2 as libc::c_int {
            animationChanged = 1 as libc::c_int
        }
        (*this).currentAnimation = 2 as libc::c_int
    } else if (*this).actor.speedXZ <= 6.0f32 {
        if (*this).currentAnimation != 3 as libc::c_int {
            animationChanged = 1 as libc::c_int
        }
        (*this).currentAnimation = 3 as libc::c_int
    } else {
        if (*this).currentAnimation != 4 as libc::c_int {
            animationChanged = 1 as libc::c_int
        }
        (*this).currentAnimation = 4 as libc::c_int
    }
    if (*this).currentAnimation == 2 as libc::c_int {
        sp30 = (*this).actor.speedXZ / 3.0f32
    } else if (*this).currentAnimation == 3 as libc::c_int {
        sp30 = (*this).actor.speedXZ / 5.0f32;
        Audio_PlaySoundGeneral(0x2804 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else if (*this).currentAnimation == 4 as libc::c_int {
        sp30 = (*this).actor.speedXZ / 7.0f32;
        Audio_PlaySoundGeneral(0x2804 as libc::c_int as u16_0,
                               &mut (*this).actor.projectedPos,
                               4 as libc::c_int as u8_0, &mut D_801333E0,
                               &mut D_801333E0, &mut D_801333E8);
    } else { sp30 = 1.0f32 }
    if animationChanged == 1 as libc::c_int {
        Animation_Change(&mut (*this).skin.skelAnime,
                         sAnimations[(*this).currentAnimation as usize],
                         splaySpeeds[(*this).currentAnimation as usize] * sp30
                             * 1.5f32, 0.0f32,
                         Animation_GetLastFrame(sAnimations[(*this).currentAnimation
                                                                as usize] as
                                                    *mut libc::c_void) as
...
#[no_mangle]
pub unsafe extern "C" fn func_80A68DB0(mut this: *mut EnHorseGanon,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).currentAnimation == 2 as libc::c_int { func_80A68870(this); }
    func_80A686A8(this, globalCtx);
    if SkelAnime_Update(&mut (*this).skin.skelAnime) != 0 as libc::c_int {
        func_80A68B20(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80A68E14(mut this: *mut EnHorseGanon,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut col: *mut CollisionPoly = 0 as *mut CollisionPoly;
    ...
    v.y = (*this).actor.world.pos.y + 60.0f32;
    v.z =
        Math_CosS((*this).actor.shape.rot.y) * 30.0f32 +
            (*this).actor.world.pos.z;
    temp_ret =
        BgCheck_EntityRaycastFloor3(&mut (*globalCtx).colCtx, &mut col,
                                    &mut temp1, &mut v);
    (*this).unk_1F4 = temp_ret;
    (*this).actor.shape.rot.x =
        (0x8000 as libc::c_int as libc::c_float / 3.14159265358979323846f32 *
             Math_FAtan2F((*this).actor.world.pos.y - temp_ret, 30.0f32)) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGanon_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnHorseGanon = thisx as *mut EnHorseGanon;
    let mut pad: s32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn func_80A68FA8(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
    ...
    while index < (*this).colliderHead.count {
        sp4C.x =
            (*(*this).colliderHead.elements.offset(index as
    ...
    CollisionCheck_SetOC(globalCtx, &mut (*globalCtx).colChkCtx,
                         &mut (*this).colliderHead.base);
}
#[no_mangle]
pub unsafe extern "C" fn EnHorseGanon_Draw(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnHorseGanon = thisx as *mut EnHorseGanon;
