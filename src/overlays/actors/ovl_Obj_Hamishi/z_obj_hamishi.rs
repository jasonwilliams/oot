...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ObjHamishi {
    pub actor: Actor,
    pub collider: ColliderCylinder,
    pub shakePosSize: f32_0,
    pub shakeRotSize: f32_0,
    pub shakeFrames: s16,
    pub shakePosPhase: s16,
    pub shakeRotPhase: s16,
    pub hitCount: s16,
}
#[no_mangle]
pub static mut Obj_Hamishi_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_HAMISHI as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHamishi_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHamishi_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHamishi_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjHamishi_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sEffectScales: [s16; 9] =
    [145 as libc::c_int as s16, 135 as libc::c_int as s16,
     115 as libc::c_int as s16, 85 as libc::c_int as s16,
     75 as libc::c_int as s16, 53 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_InitCollision(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut ObjHamishi = thisx as *mut ObjHamishi;
...
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Shake(mut this: *mut ObjHamishi) {
    if (*this).shakeFrames as libc::c_int > 0 as libc::c_int {
        (*this).shakeFrames -= 1;
        (*this).shakePosPhase =
            ((*this).shakePosPhase as libc::c_int + 5000 as libc::c_int) as
                s16;
        (*this).shakeRotPhase =
            ((*this).shakeRotPhase as libc::c_int + 0xe10 as libc::c_int) as
                s16;
        Math_StepToF(&mut (*this).shakePosSize, 0.0f32, 0.15f32);
        Math_StepToF(&mut (*this).shakeRotSize, 0.0f32, 40.0f32);
        (*this).actor.world.pos.x =
            (*this).actor.home.pos.x +
                Math_SinS(((*this).shakePosPhase as libc::c_int *
                               4 as libc::c_int) as s16) *
                    (*this).shakePosSize;
        (*this).actor.world.pos.z =
            (*this).actor.home.pos.z +
                Math_CosS(((*this).shakePosPhase as libc::c_int *
                               7 as libc::c_int) as s16) *
                    (*this).shakePosSize;
        (*this).actor.shape.rot.x =
            ((*this).actor.home.rot.x as libc::c_int +
                 (Math_SinS(((*this).shakeRotPhase as libc::c_int *
                                 4 as libc::c_int) as s16) *
                      (*this).shakeRotSize) as s16 as libc::c_int) as s16;
        (*this).actor.shape.rot.z =
            ((*this).actor.home.rot.z as libc::c_int +
                 (Math_CosS(((*this).shakeRotPhase as libc::c_int *
                                 7 as libc::c_int) as s16) *
                      (*this).shakeRotSize) as s16 as libc::c_int) as s16
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Break(mut this: *mut ObjHamishi,
                                          mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut velocity: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut phi_s0: s16 = 1000 as libc::c_int as s16;
    ...
    while i <
              (::std::mem::size_of::<[s16; 9]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        phi_s0 = (phi_s0 as libc::c_int + 20000 as libc::c_int) as s16;
        temp_f20 = Rand_ZeroOne() * 10.0f32;
        pos.x = Math_SinS(phi_s0) * temp_f20 + (*this).actor.world.pos.x;
        pos.y = Rand_ZeroOne() * 40.0f32 + (*this).actor.world.pos.y + 5.0f32;
        pos.z = Math_CosS(phi_s0) * temp_f20 + (*this).actor.world.pos.z;
        temp_f20 = Rand_ZeroOne() * 10.0f32 + 2.0f32;
        velocity.x = Math_SinS(phi_s0) * temp_f20;
        temp_f22 = Rand_ZeroOne();
        velocity.y =
            Rand_ZeroOne() * i as libc::c_float * 2.5f32 + temp_f22 * 15.0f32;
        velocity.z = Math_CosS(phi_s0) * temp_f20;
        if i == 0 as libc::c_int {
            phi_v0 = 41 as libc::c_int as s16;
            gravity = -(450 as libc::c_int) as s16
        } else if i < 4 as libc::c_int {
            phi_v0 = 37 as libc::c_int as s16;
            gravity = -(380 as libc::c_int) as s16
        } else {
            phi_v0 = 69 as libc::c_int as s16;
            gravity = -(320 as libc::c_int) as s16
        }
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity,
                             &mut (*this).actor.world.pos, gravity, phi_v0,
                             30 as libc::c_int as s16,
                             5 as libc::c_int as s16, 0 as libc::c_int as s16,
                             sEffectScales[i as usize],
                             3 as libc::c_int as s16, 0 as libc::c_int as s16,
                             70 as libc::c_int, 1 as libc::c_int as s16,
                             OBJECT_GAMEPLAY_FIELD_KEEP as libc::c_int as s16,
                             gSilverRockFragmentsDL.as_mut_ptr());
        i += 1
    }
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 140.0f32,
                  6 as libc::c_int, 180 as libc::c_int as s16,
                  90 as libc::c_int as s16, 1 as libc::c_int as u8_0);
    func_80033480(globalCtx, &mut (*this).actor.world.pos, 140.0f32,
                  12 as libc::c_int, 80 as libc::c_int as s16,
                  90 as libc::c_int as s16, 1 as libc::c_int as u8_0);
}
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut ObjHamishi = thisx as *mut ObjHamishi;
    ...
    if (*this).actor.shape.rot.y as libc::c_int == 0 as libc::c_int {
        (*this).actor.home.rot.y = Rand_ZeroFloat(65536.0f32) as s16;
        (*this).actor.world.rot.y = (*this).actor.home.rot.y;
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y
    }
    ObjHamishi_InitCollision(&mut (*this).actor, globalCtx);
    ...
    (*this).actor.shape.yOffset = 80.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx2:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjHamishi = thisx as *mut ObjHamishi;
    ...
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        (*this).hitCount += 1;
        if ((*this).hitCount as libc::c_int) < 2 as libc::c_int {
            (*this).shakeFrames = 15 as libc::c_int as s16;
            (*this).shakePosSize = 2.0f32;
            (*this).shakeRotSize = 400.0f32
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn ObjHamishi_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_obj_hamishi.c\x00" as *const u8 as
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_obj_hamishi.c\x00" as *const u8 as
                         *const libc::c_char, 411 as libc::c_int);
}
