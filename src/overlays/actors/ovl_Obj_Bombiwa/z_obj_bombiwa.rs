...
#[no_mangle]
pub static mut Obj_Bombiwa_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_BOMBIWA as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_BOMBIWA as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjBombiwa>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBombiwa_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBombiwa_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBombiwa_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBombiwa_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sEffectScales: [s16; 8] =
    [17 as libc::c_int as s16, 14 as libc::c_int as s16,
     10 as libc::c_int as s16, 8 as libc::c_int as s16,
     7 as libc::c_int as s16, 5 as libc::c_int as s16,
     3 as libc::c_int as s16, 2 as libc::c_int as s16];
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_InitCollision(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut ObjBombiwa = thisx as *mut ObjBombiwa;
...
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_Init(mut thisx: *mut Actor,
    ...
    if Flags_GetSwitch(globalCtx,
        ...
        CollisionCheck_SetInfo(&mut (*thisx).colChkInfo,
                               0 as *mut DamageTable, &mut sColChkInfoInit);
        if (*thisx).shape.rot.y as libc::c_int == 0 as libc::c_int {
            let mut rand: s16 = Rand_ZeroFloat(65536.0f32) as s16;
            (*thisx).world.rot.y = rand;
            (*thisx).shape.rot.y = rand
        }
        (*thisx).shape.yOffset = -200.0f32;
        (*thisx).world.pos.y = (*thisx).home.pos.y + 20.0f32
    };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx2:
                                                *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_Break(mut this: *mut ObjBombiwa,
                                          mut globalCtx: *mut GlobalContext) {
    ...
    let mut scale: s16 = 0;
    let mut i: s32 = 0;
    dlist = object_bombiwa_DL_0009E0.as_mut_ptr();
    i = 0 as libc::c_int;
    while i <
              (::std::mem::size_of::<[s16; 8]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<s16>() as
                                                   libc::c_ulong) as s32 {
        pos.x =
            (Rand_ZeroOne() - 0.5f32) * 10.0f32 + (*this).actor.home.pos.x;
        pos.y = Rand_ZeroOne() * 5.0f32 + (*this).actor.home.pos.y + 8.0f32;
        pos.z =
            (Rand_ZeroOne() - 0.5f32) * 10.0f32 + (*this).actor.home.pos.z;
        velocity.x = (Rand_ZeroOne() - 0.5f32) * 15.0f32;
        velocity.y = Rand_ZeroOne() * 16.0f32 + 5.0f32;
        velocity.z = (Rand_ZeroOne() - 0.5f32) * 15.0f32;
        scale = sEffectScales[i as usize];
        arg5 =
            if scale as libc::c_int >= 11 as libc::c_int {
                37 as libc::c_int
            } else { 33 as libc::c_int } as s16;
        EffectSsKakera_Spawn(globalCtx, &mut pos, &mut velocity, &mut pos,
                             -(400 as libc::c_int) as s16, arg5,
                             ...
                             OBJECT_BOMBIWA as libc::c_int as s16, dlist);
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjBombiwa = thisx as *mut ObjBombiwa;
    let mut pad: s32 = 0;
    if !func_80033684(globalCtx, &mut (*this).actor).is_null() ||
        ...
        if (*this).actor.xzDistToPlayer < 800.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn ObjBombiwa_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, object_bombiwa_DL_0009E0.as_mut_ptr());
}
