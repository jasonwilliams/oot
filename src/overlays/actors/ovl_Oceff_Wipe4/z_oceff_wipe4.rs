...
pub const OCEFF_WIPE4_UNUSED: C2RustUnnamed_18 = 1;
pub const OCEFF_WIPE4_SCARECROWS: C2RustUnnamed_18 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct OceffWipe4 {
    pub actor: Actor,
    pub timer: s16,
}
#[no_mangle]
pub static mut Oceff_Wipe4_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OCEFF_WIPE4 as libc::c_int as s16,
                          category:
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe4_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe4_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe4_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(OceffWipe4_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn OceffWipe4_Init(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut OceffWipe4 = thisx as *mut OceffWipe4;
    ...
    osSyncPrintf(b"\x1b[36m WIPE4 arg_data = %d\n\x1b[m\x00" as *const u8 as
                     *const libc::c_char,
                 (*this).actor.params as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn OceffWipe4_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut OceffWipe4 = thisx as *mut OceffWipe4;
...
#[no_mangle]
pub unsafe extern "C" fn OceffWipe4_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut OceffWipe4 = thisx as *mut OceffWipe4;
    (*this).actor.world.pos =
...
static mut sUnusedMaterialDL: [Gfx; 13] =
    [Gfx{words: Gwords{w0: 0, w1: 0,},}; 13];
// Initialized in run_static_initializers
static mut sMaterialDL: [Gfx; 13] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 13];
static mut sTex: [u64_0; 256] =
...
// Initialized in run_static_initializers
static mut sMaterial2DL: [Gfx; 23] = [Gfx{words: Gwords{w0: 0, w1: 0,},}; 23];
...
#[no_mangle]
pub unsafe extern "C" fn OceffWipe4_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if ((*this).timer as libc::c_int) < 16 as libc::c_int {
        z =
            Math_SinS(((*this).timer as libc::c_int * 1024 as libc::c_int) as
                          s16) * 1330.0f32
    } else { z = 1330.0f32 }
    ...
    if (*this).timer as libc::c_int >= 30 as libc::c_int {
        alpha =
            (12 as libc::c_int *
                 (50 as libc::c_int - (*this).timer as libc::c_int)) as u8_0
    ...
    *fresh9 = *fresh8;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_oceff_wipe4.c\x00" as *const u8 as
                        *const libc::c_char, 314 as libc::c_int);
    ...
    if (*this).actor.params as libc::c_int ==
           OCEFF_WIPE4_UNUSED as libc::c_int {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = sUnusedMaterialDL.as_mut_ptr() as libc::c_uint
    } else {
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_1).words.w1 = sMaterialDL.as_mut_ptr() as libc::c_uint
    }
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = sMaterial2DL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_3).words.w1 =
        Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                         ...
                         1 as libc::c_int,
                         scroll.wrapping_mul(-(1 as libc::c_int) as
                                                 libc::c_uint), scroll,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_4).words.w1 =
        &mut *sMaterial2DL.as_mut_ptr().offset(11 as libc::c_int as isize) as
