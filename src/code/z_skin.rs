...
extern "C" {
    #[no_mangle]
    fn func_800A6AC4(skin: *mut PSkinAwb, arg1: *mut MtxF, actor: *mut Actor,
                     arg3: s32) -> s32;
    #[no_mangle]
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct Struct_800A598C {
    pub unk_0: u16_0,
    pub unk_2: u16_0,
    pub unk_4: u16_0,
    pub unk_8: *mut Struct_800A57C0,
    pub unk_C: *mut Struct_800A598C_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct Struct_800A5E28 {
    pub unk_0: u16_0,
    pub unk_2: u16_0,
    pub unk_4: *mut Struct_800A598C,
    pub unk_8: *mut Gfx,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub type SkinCallback2
    ...
    Option<unsafe extern "C" fn(_: *mut Actor, _: *mut GlobalContext, _: s32,
                                _: *mut PSkinAwb) -> s32>;
#[no_mangle]
pub static mut D_801600C0: [MtxF; 60] = [MtxF{mf: [[0.; 4]; 4],}; 60];
#[no_mangle]
pub static mut D_80160FC0: [libc::c_char; 16] = [0; 16];
#[no_mangle]
pub unsafe extern "C" fn func_800A57C0(mut mtx: *mut MtxF,
                                       mut arg1: *mut Struct_800A57C0,
                                       mut arg2: *mut Struct_800A598C,
                                       mut arg3: *mut Vtx,
                                       mut arg4: *mut Vec3f) {
    let mut temp_s2: *mut Vtx = 0 as *mut Vtx;
    let mut phi_s1: *mut Struct_800A57C0 = 0 as *mut Struct_800A57C0;
    ...
    phi_s1 = arg1;
    while phi_s1 < arg1.offset((*arg2).unk_0 as libc::c_int as isize) {
        temp_s2 = &mut *arg3.offset((*phi_s1).unk_0 as isize) as *mut Vtx;
        (*temp_s2).n.ob[0 as libc::c_int as usize] =
            (*arg4).x as libc::c_short;
        (*temp_s2).n.ob[1 as libc::c_int as usize] =
            (*arg4).y as libc::c_short;
        (*temp_s2).n.ob[2 as libc::c_int as usize] =
            (*arg4).z as libc::c_short;
        temp_x = (*mtx).c2rust_unnamed.xw;
        temp_y = (*mtx).c2rust_unnamed.yw;
        temp_z = (*mtx).c2rust_unnamed.zw;
        (*mtx).c2rust_unnamed.zw = 0.0f32;
        (*mtx).c2rust_unnamed.yw = 0.0f32;
        (*mtx).c2rust_unnamed.xw = 0.0f32;
        sp64.x = (*phi_s1).unk_6 as f32_0;
        sp64.y = (*phi_s1).unk_7 as f32_0;
        sp64.z = (*phi_s1).unk_8 as f32_0;
        SkinMatrix_Vec3fMtxFMultXYZ(mtx, &mut sp64, &mut sp70);
        (*temp_s2).n.n[0 as libc::c_int as usize] = sp70.x as libc::c_schar;
        (*temp_s2).n.n[1 as libc::c_int as usize] = sp70.y as libc::c_schar;
        (*temp_s2).n.n[2 as libc::c_int as usize] = sp70.z as libc::c_schar;
        (*mtx).c2rust_unnamed.xw = temp_x;
        (*mtx).c2rust_unnamed.yw = temp_y;
        (*mtx).c2rust_unnamed.zw = temp_z;
        phi_s1 = phi_s1.offset(1)
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_800A598C(mut gfxCtx: *mut GraphicsContext,
                                       mut skin: *mut PSkinAwb,
                                       mut limbIndex: s32, mut arg3: s32) {
    let mut temp_1: s32 = 0;
    let mut skeleton: *mut *mut SkinLimb = 0 as *mut *mut SkinLimb;
    let mut limb: *mut SkinLimb = 0 as *mut SkinLimb;
    let mut data: *mut Struct_800A5E28 = 0 as *mut Struct_800A5E28;
    let mut phi_s6: *mut Struct_800A598C = 0 as *mut Struct_800A598C;
    let mut avb: *mut SkinAvb = 0 as *mut SkinAvb;
    let mut temp_a0_2: s32 = 0;
    let mut temp_f20: f32_0 = 0.;
    let mut temp_v0: *mut Struct_800A57C0 = 0 as *mut Struct_800A57C0;
    let mut temp_s3: *mut Struct_800A598C_2 = 0 as *mut Struct_800A598C_2;
    let mut spEC: *mut Vtx = 0 as *mut Vtx;
    let mut temp_2: *mut Struct_800A598C = 0 as *mut Struct_800A598C;
    let mut spDC: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut spD0: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut phi_s0: *mut Struct_800A598C_2 = 0 as *mut Struct_800A598C_2;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_skin.c\x00" as *const u8 as *const libc::c_char,
                    254 as libc::c_int);
    skeleton =
        gSegments[(((*(*skin).skeletonHeader).segment as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add((*(*skin).skeletonHeader).segment as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut *mut SkinLimb;
    data =
        gSegments[(((*(gSegments[((*skeleton.offset(limbIndex as isize) as
                                       u32_0) << 4 as libc::c_int >>
                                      28 as libc::c_int) as
                                     usize].wrapping_add(*skeleton.offset(limbIndex
                                                                              as
                                                                              isize)
                                                             as u32_0 &
                                                             0xffffff as
                                                                 ...
                                                                 libc::c_uint).wrapping_add(0x80000000
                                                                                                as
                                                                                                libc::c_uint)
                           as *mut libc::c_void as *mut SkinLimb)).segment as
                        u32_0) << 4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add((*(gSegments[((*skeleton.offset(limbIndex
                                                                              as
                                                                              isize)
                                                             as u32_0) <<
                                                            4 as libc::c_int
                                                 ...
                                                 *mut SkinLimb)).segment as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut Struct_800A5E28;
    temp_2 =
        gSegments[(((*data).unk_4 as u32_0) << 4 as libc::c_int >>
                       28 as libc::c_int) as
                      usize].wrapping_add((*data).unk_4 as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut Struct_800A598C;
    avb = &mut *(*skin).avbTbl.offset(limbIndex as isize) as *mut SkinAvb;
    spEC = (*avb).buf[(*avb).unk_0 as usize];
    temp_1 = (*data).unk_2 as s32;
    phi_s6 = temp_2;
    while phi_s6 < temp_2.offset(temp_1 as isize) {
        temp_a0_2 = (*phi_s6).unk_2 as s32;
        temp_v0 =
            gSegments[(((*phi_s6).unk_8 as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add((*phi_s6).unk_8 as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
                as *mut libc::c_void as *mut Struct_800A57C0;
        temp_s3 =
            gSegments[(((*phi_s6).unk_C as u32_0) << 4 as libc::c_int >>
                           28 as libc::c_int) as
                          usize].wrapping_add((*phi_s6).unk_C as u32_0 &
                                                  0xffffff as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x80000000
                                                                                     as
                                                                                     libc::c_uint)
                as *mut libc::c_void as *mut Struct_800A598C_2;
        if temp_a0_2 == 1 as libc::c_int {
            let mut spAC: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            spAC.x = (*temp_s3.offset(0 as libc::c_int as isize)).x as f32_0;
            spAC.y = (*temp_s3.offset(0 as libc::c_int as isize)).y as f32_0;
            spAC.z = (*temp_s3.offset(0 as libc::c_int as isize)).z as f32_0;
            SkinMatrix_Vec3fMtxFMultXYZ(&mut *D_801600C0.as_mut_ptr().offset((*temp_s3.offset(0
                                                                                                  as
                                                                                                  libc::c_int
                                                                                                  as
                                                                                                  isize)).unk_0
                                                                                 ...
                                                                                 isize),
                                        &mut spAC, &mut spDC);
        } else if arg3 == 1 as libc::c_int {
            let mut spA0: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            phi_s0 =
                &mut *temp_s3.offset((*phi_s6).unk_4 as isize) as
                    *mut Struct_800A598C_2;
            spA0.x = (*phi_s0).x as f32_0;
            spA0.y = (*phi_s0).y as f32_0;
            spA0.z = (*phi_s0).z as f32_0;
            SkinMatrix_Vec3fMtxFMultXYZ(&mut *D_801600C0.as_mut_ptr().offset((*phi_s0).unk_0
                                                                                 as
                                                                                 isize),
                                        &mut spA0, &mut spDC);
        } else {
            let mut phi_f20: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            let mut sp88: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            phi_f20.z = 0.0f32;
            phi_f20.y = phi_f20.z;
            phi_f20.x = phi_f20.y;
            phi_s0 =
                &mut *temp_s3.offset(0 as libc::c_int as isize) as
                    *mut Struct_800A598C_2;
            while phi_s0 <
                      &mut *temp_s3.offset(temp_a0_2 as isize) as
                          *mut Struct_800A598C_2 {
                temp_f20 =
                    (*phi_s0).unk_8 as libc::c_int as libc::c_float * 0.01f32;
                sp88.x = (*phi_s0).x as f32_0;
                sp88.y = (*phi_s0).y as f32_0;
                sp88.z = (*phi_s0).z as f32_0;
                SkinMatrix_Vec3fMtxFMultXYZ(&mut *D_801600C0.as_mut_ptr().offset((*phi_s0).unk_0
                                                                                     as
                                                                                     isize),
                                            &mut sp88, &mut spD0);
        ...
        func_800A57C0(&mut *D_801600C0.as_mut_ptr().offset((*temp_s3.offset((*phi_s6).unk_4
                                                                                as
                                                                                isize)).unk_0
                                                               as isize),
                      temp_v0, phi_s6, spEC, &mut spDC);
        phi_s6 = phi_s6.offset(1)
    }
    ...
    (*_g).words.w1 = (*avb).buf[(*avb).unk_0 as usize] as libc::c_uint;
    (*avb).unk_0 =
        if (*avb).unk_0 as libc::c_int == 0 as libc::c_int {
            1 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_800A5E28(mut gfxCtx: *mut GraphicsContext,
                                       mut skin: *mut PSkinAwb,
                                       mut limbIndex: s32, mut arg3: s32,
                                       mut arg4: s32) {
    let mut skeleton: *mut *mut SkinLimb = 0 as *mut *mut SkinLimb;
    let mut temp_t9: *mut Struct_800A5E28 = 0 as *mut Struct_800A5E28;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
    ...
    (*_g).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 = (*temp_t9).unk_8 as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), gfxCtx,
                     b"../z_skin.c\x00" as *const u8 as *const libc::c_char,
                     377 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_800A5F60(mut gfxCtx: *mut GraphicsContext,
                                       mut skin: *mut PSkinAwb,
                                       mut limbIndex: s32, mut arg3: *mut Gfx,
                                       mut arg4: s32) {
    let mut gfx: *mut Gfx = arg3;
    let mut skeleton: *mut *mut SkinLimb = 0 as *mut *mut SkinLimb;
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    ...
    if arg3.is_null() {
        gfx =
            (*(gSegments[((*skeleton.offset(limbIndex as isize) as u32_0) <<
                              4 as libc::c_int >> 28 as libc::c_int) as
                             usize].wrapping_add(*skeleton.offset(limbIndex as
                                                                      isize)
                                                     as u32_0 &
                                                     0xffffff as libc::c_int
                                                         ...
                                                         libc::c_uint).wrapping_add(0x80000000
                                                                                        as
                                                                                        libc::c_uint)
                   as *mut libc::c_void as *mut SkinLimb)).segment as *mut Gfx
    }
    if !gfx.is_null() {
        let mut mtx: *mut Mtx =
            SkinMatrix_MtxFToNewMtx(gfxCtx,
                                    &mut *D_801600C0.as_mut_ptr().offset(limbIndex
                                                                             as
                                                                             isize));
        if !mtx.is_null() {
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_0).words.w1 = gfx as libc::c_uint;
...
#[no_mangle]
pub unsafe extern "C" fn func_800A60D8(mut actor: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut callback: SkinCallback,
                                       mut arg4: SkinCallback2, mut arg5: s32,
                                       mut arg6: s32, mut arg7: s32) {
    let mut i: s32 = 0;
    let mut dataType: s32 = 0;
    let mut skeleton: *mut *mut SkinLimb = 0 as *mut *mut SkinLimb;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_skin.c\x00" as *const u8 as *const libc::c_char,
                    471 as libc::c_int);
    if arg7 & 1 as libc::c_int == 0 as libc::c_int {
        func_800A6AC4(skin,
                      &mut *D_801600C0.as_mut_ptr().offset(0 as libc::c_int as
                                                               isize), actor,
                      arg5);
    }
    skeleton =
                      ...
                      usize].wrapping_add((*(*skin).skeletonHeader).segment as
                                              ...
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void as *mut *mut SkinLimb;
    if arg7 & 2 as libc::c_int == 0 as libc::c_int {
        ...
        mtx = SkinMatrix_MtxFToNewMtx(gfxCtx, &mut (*skin).mtx);
        if mtx.is_null() {
            current_block_34 = 15316457195432865246;
        } else {
            ...
            current_block_34 = 6669252993407410313;
        }
    } else { current_block_34 = 6669252993407410313; }
    match current_block_34 {
        6669252993407410313 => {
            i = 0 as libc::c_int;
            while i < (*(*skin).skeletonHeader).limbCount as libc::c_int {
                let mut phi_a0: s32 = 1 as libc::c_int;
                if arg4.is_some() {
                    phi_a0 =
                        arg4.expect("non-null function pointer")(actor,
                                                                 globalCtx, i,
                                                                 skin)
                }
                dataType =
                    (*(gSegments[((*skeleton.offset(i as isize) as u32_0) <<
                                      4 as libc::c_int >> 28 as libc::c_int)
                                     as
                                     usize].wrapping_add(*skeleton.offset(i as
                                                                              isize)
                                                             as u32_0 &
                                                             0xffffff as
                                                                 libc::c_int
                                                                 ...
                                                                 libc::c_uint).wrapping_add(0x80000000
                                                                                                as
                                                                                                libc::c_uint)
                           as *mut libc::c_void as *mut SkinLimb)).unk_8;
                if dataType == 4 as libc::c_int && phi_a0 == 1 as libc::c_int
                   {
                    func_800A5E28(gfxCtx, skin, i, arg6, arg7);
                } else if dataType == 0xb as libc::c_int &&
                              phi_a0 == 1 as libc::c_int {
                    func_800A5F60(gfxCtx, skin, i, 0 as *mut Gfx, arg7);
                }
                i += 1
            }
            if callback.is_some() {
                callback.expect("non-null function pointer")(actor, globalCtx,
                                                             skin);
            }
        }
        _ => { }
...
#[no_mangle]
pub unsafe extern "C" fn func_800A6330(mut this: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut callback: SkinCallback,
                                       mut arg4: s32) {
    func_800A60D8(this, globalCtx, skin, callback, None, arg4,
                  0 as libc::c_int, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_800A6360(mut this: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut callback: SkinCallback,
                                       mut arg4: SkinCallback2,
                                       mut arg5: s32) {
    func_800A60D8(this, globalCtx, skin, callback, arg4, arg5,
                  0 as libc::c_int, 0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_800A6394(mut this: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut callback: SkinCallback,
                                       mut arg4: SkinCallback2, mut arg5: s32,
                                       mut arg6: s32) {
    func_800A60D8(this, globalCtx, skin, callback, arg4, arg5, arg6,
                  0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn func_800A63CC(mut this: *mut Actor,
                                       mut globalCtx: *mut GlobalContext,
                                       mut skin: *mut PSkinAwb,
                                       mut callback: SkinCallback,
                                       mut arg4: SkinCallback2, mut arg5: s32,
...
#[no_mangle]
pub unsafe extern "C" fn func_800A6408(mut skin: *mut PSkinAwb,
                                       mut joint: s32, mut arg2: *mut Vec3f,
                                       mut arg3: *mut Vec3f) {
    let mut sp18: MtxF = MtxF{mf: [[0.; 4]; 4],};
    SkinMatrix_MtxFMtxFMult(&mut (*skin).mtx,
                            &mut *D_801600C0.as_mut_ptr().offset(joint as
                                                                     isize),
                            &mut sp18);
    SkinMatrix_Vec3fMtxFMultXYZ(&mut sp18, arg2, arg3);
}
