...
#[no_mangle]
pub static mut Effect_Ss_Dead_Db_InitVars: EffectSsInit =
    unsafe {
        {
            let mut init =
                EffectSsInit{type_0:
                                 EFFECT_SS_DEAD_DB as libc::c_int as u32_0,
                             init:
                                 Some(EffectSsDeadDb_Init as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDb_Init(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs,
                                             mut initParamsx:
                                                 *mut libc::c_void) -> u32_0 {
    let mut initParams: *mut EffectSsDeadDbInitParams =
        initParamsx as *mut EffectSsDeadDbInitParams;
    (*this).pos = (*initParams).pos;
    (*this).velocity = (*initParams).velocity;
    (*this).accel = (*initParams).accel;
    (*this).gfx =
        gSegments[((gEffEnemyDeathFlameDL.as_mut_ptr() as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(gEffEnemyDeathFlameDL.as_mut_ptr()
                                              as u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 ...
                                                                                 libc::c_uint)
            as *mut libc::c_void;
    (*this).life = (*initParams).unk_34 as s16;
    (*this).flags = 4 as libc::c_int as u16_0;
    (*this).regs[9 as libc::c_int as usize] = (*initParams).scaleStep;
    (*this).regs[11 as libc::c_int as usize] = (*initParams).unk_34 as s16;
    (*this).draw =
        Some(EffectSsDeadDb_Draw as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).update =
        Some(EffectSsDeadDb_Update as
                 unsafe extern "C" fn(_: *mut GlobalContext, _: u32_0,
                                      _: *mut EffectSs) -> ());
    (*this).regs[0 as libc::c_int as usize] = (*initParams).scale;
    (*this).regs[1 as libc::c_int as usize] = 0 as libc::c_int as s16;
    (*this).regs[10 as libc::c_int as usize] = (*initParams).playSound;
    (*this).regs[2 as libc::c_int as usize] =
        (*initParams).primColor.r as s16;
    (*this).regs[3 as libc::c_int as usize] =
        (*initParams).primColor.g as s16;
    (*this).regs[4 as libc::c_int as usize] =
        (*initParams).primColor.b as s16;
    (*this).regs[5 as libc::c_int as usize] =
        (*initParams).primColor.a as s16;
    (*this).regs[6 as libc::c_int as usize] = (*initParams).envColor.r as s16;
    (*this).regs[7 as libc::c_int as usize] = (*initParams).envColor.g as s16;
    (*this).regs[8 as libc::c_int as usize] = (*initParams).envColor.b as s16;
    return 1 as libc::c_int as u32_0;
}
static mut sTextures: [*mut libc::c_void; 10] =
    unsafe {
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDb_Draw(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut index: u32_0,
                                             mut this: *mut EffectSs) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_eff_ss_dead_db.c\x00" as *const u8 as
    ...
    SkinMatrix_MtxFMtxFMult(&mut mfTrans, &mut mfScale, &mut mfResult);
...
#[no_mangle]
pub unsafe extern "C" fn EffectSsDeadDb_Update(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut index: u32_0,
                                               mut this: *mut EffectSs) {
    let mut w: f32_0 = 0.;
    ...
    (*this).regs[1 as libc::c_int as usize] =
        ((((*this).regs[11 as libc::c_int as usize] as libc::c_int -
               (*this).life as libc::c_int) * 9 as libc::c_int) as f32_0 /
             (*this).regs[11 as libc::c_int as usize] as libc::c_int as
                 libc::c_float) as s16;
    ...
    if ((*this).regs[2 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
        (*this).regs[2 as libc::c_int as usize] = 0 as libc::c_int as s16
    }
    (*this).regs[3 as libc::c_int as usize] =
        ((*this).regs[3 as libc::c_int as usize] as libc::c_int -
             10 as libc::c_int) as s16;
    if ((*this).regs[3 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
        (*this).regs[3 as libc::c_int as usize] = 0 as libc::c_int as s16
    }
    (*this).regs[4 as libc::c_int as usize] =
    ...
    if ((*this).regs[4 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
        (*this).regs[4 as libc::c_int as usize] = 0 as libc::c_int as s16
    }
    (*this).regs[6 as libc::c_int as usize] =
        ((*this).regs[6 as libc::c_int as usize] as libc::c_int -
             10 as libc::c_int) as s16;
    if ((*this).regs[6 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
        (*this).regs[6 as libc::c_int as usize] = 0 as libc::c_int as s16
    }
    (*this).regs[7 as libc::c_int as usize] =
        ((*this).regs[7 as libc::c_int as usize] as libc::c_int -
             10 as libc::c_int) as s16;
    if ((*this).regs[7 as libc::c_int as usize] as libc::c_int) <
           0 as libc::c_int {
