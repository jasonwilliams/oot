...
// clang-format off
#[no_mangle]
pub static mut gChildWarpOutToTCS: [CutsceneData; 72] =
    [CutsceneData{i: 5 as libc::c_int,},
     ...
     CutsceneData{i: 0xffffffdf as libc::c_uint as s32,},
     CutsceneData{i: 0x19 as libc::c_int,},
