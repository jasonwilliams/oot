...
pub struct EnMm2 {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnMm2ActionFunc,
    ...
    pub unk_1F4: u16_0,
    pub unk_1F6: s16,
    pub previousAnimation: s32,
    pub jointTable: [Vec3s; 16],
    pub morphTable: [Vec3s; 16],
}
pub type EnMm2ActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnMm2, _: *mut GlobalContext) -> ()>;
pub type C2RustUnnamed_24 = libc::c_uint;
pub const RM2_ANIM_HAPPY: C2RustUnnamed_24 = 6;
pub const RM2_ANIM_EXCITED: C2RustUnnamed_24 = 5;
pub const RM2_ANIM_SPRINT: C2RustUnnamed_24 = 4;
pub const RM2_ANIM_STAND: C2RustUnnamed_24 = 3;
pub const RM2_ANIM_SIT_WAIT: C2RustUnnamed_24 = 2;
pub const RM2_ANIM_SIT: C2RustUnnamed_24 = 1;
pub const RM2_ANIM_RUN: C2RustUnnamed_24 = 0;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const RM2_MOUTH_OPEN: C2RustUnnamed_25 = 1;
pub const RM2_MOUTH_CLOSED: C2RustUnnamed_25 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnMm2AnimEntry {
...
#[no_mangle]
pub static mut En_Mm2_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_MM2 as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnMm2>() as libc::c_ulong,
                          init:
...
// size = 0x10
static mut sAnimationEntries: [EnMm2AnimEntry; 7] =
    unsafe {
        [{
             let mut init =
                 EnMm2AnimEntry{animation:
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_ChangeAnimation(mut this: *mut EnMm2,
                                               mut animationIndex: s32,
                                               mut previousAnimation:
                                                   *mut s32) {
    let mut phi_f0: f32_0 = 0.;
    if *previousAnimation < 0 as libc::c_int ||
           animationIndex == *previousAnimation {
        phi_f0 = 0.0f32
    } else { phi_f0 = sAnimationEntries[animationIndex as usize].morphFrames }
    if sAnimationEntries[animationIndex as usize].playSpeed >= 0.0f32 {
        Animation_Change(&mut (*this).skelAnime,
                         sAnimationEntries[animationIndex as usize].animation,
                         sAnimationEntries[animationIndex as usize].playSpeed,
                         0.0f32,
                         Animation_GetLastFrame(sAnimationEntries[animationIndex
                                                                      as
                                                                      usize].animation
                                                    as *mut libc::c_void) as
                             f32_0,
                         sAnimationEntries[animationIndex as usize].mode,
                         phi_f0);
    } else {
        Animation_Change(&mut (*this).skelAnime,
                         sAnimationEntries[animationIndex as usize].animation,
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAEF70(mut this: *mut EnMm2,
    ...
    if gSaveContext.eventChkInf[9 as libc::c_int as usize] as libc::c_int &
        ...
        (*this).actor.textId = 0x6086 as libc::c_int as u16_0
    } else if gSaveContext.infTable[23 as libc::c_int as usize] as libc::c_int
                  & 0x8000 as libc::c_int != 0 {
        if gSaveContext.eventInf[1 as libc::c_int as usize] as libc::c_int &
               1 as libc::c_int != 0 {
            (*this).actor.textId = 0x6082 as libc::c_int as u16_0
        } else if gSaveContext.timer2State as libc::c_int != 0 as libc::c_int
         {
            (*this).actor.textId = 0x6076 as libc::c_int as u16_0
        } else if gSaveContext.highScores[HS_MARATHON as libc::c_int as usize]
                      == 158 as libc::c_int {
            (*this).actor.textId = 0x607e as libc::c_int as u16_0
        } else { (*this).actor.textId = 0x6081 as libc::c_int as u16_0 }
    } else if gSaveContext.timer2State != 0 {
        (*this).actor.textId = 0x6076 as libc::c_int as u16_0
    } else {
        (*this).actor.textId = 0x607d as libc::c_int as u16_0;
        ...
        gSaveContext.highScores[HS_MARATHON as libc::c_int as usize] =
            158 as libc::c_int
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnMm2_Init(mut thisx: *mut Actor,
                                    mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnMm2 = thisx as *mut EnMm2;
    ...
    Animation_Change(&mut (*this).skelAnime,
                     sAnimationEntries[RM2_ANIM_SIT_WAIT as libc::c_int as
                                           usize].animation, 1.0f32, 0.0f32,
                     Animation_GetLastFrame(sAnimationEntries[RM2_ANIM_SIT_WAIT
                                                                  as
                                                                  libc::c_int
                                                                  as
                                                                  usize].animation
                     ...
                     sAnimationEntries[RM2_ANIM_SIT_WAIT as libc::c_int as
                                           usize].morphFrames);
    (*this).previousAnimation = RM2_ANIM_SIT_WAIT as libc::c_int;
    ...
    (*this).mouthTexIndex = RM2_MOUTH_CLOSED as libc::c_int;
    (*this).actor.targetMode = 6 as libc::c_int as s8;
    (*this).unk_1F4 =
        ((*this).unk_1F4 as libc::c_int | 1 as libc::c_int) as u16_0;
    (*this).actor.gravity = -1.0f32;
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        (*this).actionFunc =
            Some(func_80AAF668 as
                     unsafe extern "C" fn(_: *mut EnMm2,
                                          _: *mut GlobalContext) -> ())
    } else {
        func_80AAEF70(this, globalCtx);
        (*this).actionFunc =
            Some(func_80AAF57C as
                     unsafe extern "C" fn(_: *mut EnMm2,
                                          _: *mut GlobalContext) -> ())
    }
    ...
    if (*this).actor.params as libc::c_int == 1 as libc::c_int {
        if gSaveContext.infTable[23 as libc::c_int as usize] as libc::c_int &
               0x8000 as libc::c_int == 0 ||
               gSaveContext.eventInf[1 as libc::c_int as usize] as libc::c_int
                   & 1 as libc::c_int == 0 {
            osSyncPrintf(b"\x1b[36m \xe3\x83\x9e\xe3\x83\xa9\xe3\x82\xbd\xe3\x83\xb3 \xe9\x96\x8b\xe5\xa7\x8b\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xa6\xe3\x81\x84\xe3\x81\xaa\xe3\x81\x84 \n\x1b[m\n\x00"
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_Destroy(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMm2 = thisx as *mut EnMm2;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAF224(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext,
                                       mut actionFunc: EnMm2ActionFunc)
 -> s32 {
    ...
    if (if yawDiff as libc::c_int >= 0 as libc::c_int {
        ...
        } else { -(yawDiff as libc::c_int) }) <= 0x4300 as libc::c_int &&
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAF2BC(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_1F6 as libc::c_int > 60 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    }
    SkelAnime_Update(&mut (*this).skelAnime);
    (*this).unk_1F6 += 1;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 10.0f32, 0.6f32, 2.0f32,
                       0.0f32);
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAF330(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).actionFunc =
            Some(func_80AAF2BC as
                     unsafe extern "C" fn(_: *mut EnMm2,
                                          _: *mut GlobalContext) -> ());
        EnMm2_ChangeAnimation(this, 0 as libc::c_int,
                              &mut (*this).previousAnimation);
        (*this).mouthTexIndex = RM2_MOUTH_OPEN as libc::c_int;
        if (*this).unk_1F4 as libc::c_int & 2 as libc::c_int == 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAF3C0(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    match (*this).actor.textId as libc::c_int {
                ...
                match (*globalCtx).msgCtx.choiceIndex as libc::c_int {
                    0 => {
                        Message_ContinueTextbox(globalCtx,
                                                0x607f as libc::c_int as
                                                    u16_0);
                        (*this).actor.textId = 0x607f as libc::c_int as u16_0;
                        gSaveContext.eventInf[1 as libc::c_int as usize] =
                            (gSaveContext.eventInf[1 as libc::c_int as usize]
                    ...
                    1 => {
                        Message_ContinueTextbox(globalCtx,
                                                0x6080 as libc::c_int as
                                                    u16_0);
                        (*this).actor.textId = 0x6080 as libc::c_int as u16_0
                    }
                    _ => { }
                }
                if (*this).unk_1F4 as libc::c_int & 4 as libc::c_int != 0 {
                    (*this).unk_1F4 =
                        ((*this).unk_1F4 as libc::c_int & !(4 as libc::c_int))
                            as u16_0;
                    gSaveContext.highScores[HS_MARATHON as libc::c_int as
        ...
        24705 => {
            if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
                   ...
                   Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
                (*this).unk_1F4 =
                    ((*this).unk_1F4 as libc::c_int | 4 as libc::c_int) as
                        u16_0;
                gSaveContext.highScores[HS_MARATHON as libc::c_int as usize]
                    -= 1 as libc::c_int;
                Message_ContinueTextbox(globalCtx,
                                        0x607e as libc::c_int as u16_0);
                (*this).actor.textId = 0x607e as libc::c_int as u16_0
            }
            return
        }
    ...
    if Actor_TextboxIsClosing(&mut (*this).actor, globalCtx) != 0 {
        if (*this).actor.textId as libc::c_int == 0x607f as libc::c_int {
            func_80088AA0(0 as libc::c_int as s16);
            (*this).actionFunc =
                Some(func_80AAF57C as
                         unsafe extern "C" fn(_: *mut EnMm2,
                                              _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn func_80AAF57C(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    func_80AAEF70(this, globalCtx);
    if func_80AAF224(this, globalCtx,
                     Some(func_80AAF3C0 as
                              unsafe extern "C" fn(_: *mut EnMm2,
                                                   _: *mut GlobalContext)
                                  -> ())) != 0 &&
           (*this).actor.textId as libc::c_int == 0x607d as libc::c_int {
        gSaveContext.infTable[23 as libc::c_int as usize] =
            (gSaveContext.infTable[23 as libc::c_int as usize] as libc::c_int
                 | 0x8000 as libc::c_int) as u16_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAF5EC(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
           TEXT_STATE_EVENT as libc::c_int &&
        ...
        (*this).unk_1F4 =
            ((*this).unk_1F4 as libc::c_int & !(1 as libc::c_int)) as u16_0;
        EnMm2_ChangeAnimation(this, 3 as libc::c_int,
                              &mut (*this).previousAnimation);
        (*this).actionFunc =
            Some(func_80AAF330 as
                     unsafe extern "C" fn(_: *mut EnMm2,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80AAF668(mut this: *mut EnMm2,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).actor.world.rot.y = -(0x3e80 as libc::c_int) as s16;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (gSaveContext.timer2Value as libc::c_int) <
           gSaveContext.highScores[HS_MARATHON as libc::c_int as usize] {
        (*this).actor.textId = 0x6085 as libc::c_int as u16_0
    } else { (*this).actor.textId = 0x6084 as libc::c_int as u16_0 }
    if func_80AAF224(this, globalCtx,
                     Some(func_80AAF5EC as
                              unsafe extern "C" fn(_: *mut EnMm2,
                                                   _: *mut GlobalContext)
                                  -> ())) != 0 {
        (*this).unk_1F6 = 0 as libc::c_int as s16;
        if (gSaveContext.timer2Value as libc::c_int) <
               gSaveContext.highScores[HS_MARATHON as libc::c_int as usize] {
            gSaveContext.highScores[HS_MARATHON as libc::c_int as usize] =
                gSaveContext.timer2Value as s32
        }
    } else {
        LogUtils_LogThreadId(b"../z_en_mm2.c\x00" as *const u8 as
                                 *const libc::c_char, 541 as libc::c_int);
        osSyncPrintf(b"((z_common_data.event_inf[1]) & (0x0001)) = %x\n\x00"
                         as *const u8 as *const libc::c_char,
        ...
        if gSaveContext.eventInf[1 as libc::c_int as usize] as libc::c_int &
               1 as libc::c_int == 0 {
            (*this).unk_1F4 =
                ((*this).unk_1F4 as libc::c_int | 2 as libc::c_int) as u16_0;
            (*this).unk_1F4 =
                ((*this).unk_1F4 as libc::c_int & !(1 as libc::c_int)) as
                    u16_0;
            EnMm2_ChangeAnimation(this, 3 as libc::c_int,
                                  &mut (*this).previousAnimation);
            (*this).actionFunc =
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_Update(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnMm2 = thisx as *mut EnMm2;
    let mut pad: s32 = 0;
    if (*this).unk_1F4 as libc::c_int & 1 as libc::c_int != 0 {
        func_80038290(globalCtx, &mut (*this).actor, &mut (*this).unk_1E8,
                      &mut (*this).unk_1EE, (*this).actor.focus.pos);
    } else {
        Math_SmoothStepToS(&mut (*this).unk_1E8.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_1E8.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_1EE.x, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
        Math_SmoothStepToS(&mut (*this).unk_1EE.y, 0 as libc::c_int as s16,
                           6 as libc::c_int as s16,
                           6200 as libc::c_int as s16,
                           100 as libc::c_int as s16);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_Draw(mut thisx: *mut Actor,
                                    mut globalCtx: *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_mm2.c\x00" as *const u8 as *const libc::c_char,
                    634 as libc::c_int);
    ...
    SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                          ...
                          Some(EnMm2_OverrideLimbDraw as
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_OverrideLimbDraw(mut globalCtx:
                                                    *mut GlobalContext,
                                                mut limbIndex: s32,
 ...
 -> s32 {
    ...
    match limbIndex {
        8 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_1EE.y as libc::c_int)
                    as s16;
            (*rot).y =
                ((*rot).y as libc::c_int - (*this).unk_1EE.x as libc::c_int)
                    as s16
        }
        15 => {
            (*rot).x =
                ((*rot).x as libc::c_int + (*this).unk_1E8.y as libc::c_int)
                    as s16;
            (*rot).z =
                ((*rot).z as libc::c_int +
                     ((*this).unk_1E8.x as libc::c_int +
...
#[no_mangle]
pub unsafe extern "C" fn EnMm2_PostLimbDraw(mut globalCtx: *mut GlobalContext,
                                            mut limbIndex: s32,
                                            mut dList: *mut *mut Gfx,
                                            mut rot: *mut Vec3s,
                                            mut thisx: *mut libc::c_void) {
