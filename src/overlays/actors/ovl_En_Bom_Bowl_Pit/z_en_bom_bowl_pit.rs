...
pub type EnBomChuActionFunc
    ...
    Option<unsafe extern "C" fn(_: *mut EnBomChu, _: *mut GlobalContext)
               -> ()>;
static mut sGetItemIds: [s32; 5] =
    [GI_BOMB_BAG_30 as libc::c_int, GI_HEART_PIECE as libc::c_int,
     GI_BOMBCHUS_10 as libc::c_int, GI_BOMBS_1 as libc::c_int,
     GI_RUPEE_PURPLE as libc::c_int];
#[no_mangle]
pub static mut En_Bom_Bowl_Pit_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BOM_BOWL_PIT as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<EnBomBowlPit>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlPit_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlPit_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnBomBowlPit_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnBomBowlPit = thisx as *mut EnBomBowlPit;
    (*this).actionFunc =
        Some(EnBomBowlPit_SetupDetectHit as
                 unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_SetupDetectHit(mut this:
                                                         *mut EnBomBowlPit,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).start as libc::c_int != 0 as libc::c_int {
        (*this).status = 0 as libc::c_int as u8_0;
        (*this).start = (*this).status as s16;
        (*this).actionFunc =
            Some(EnBomBowlPit_DetectHit as
                     unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_DetectHit(mut this: *mut EnBomBowlPit,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut chu: *mut EnBomChu = 0 as *mut EnBomChu;
    let mut chuPosDiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    if (*(*globalCtx).cameraPtrs[0 as libc::c_int as usize]).setting as
           libc::c_int == CAM_SET_CHU_BOWLING as libc::c_int {
        chu =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_EXPLOSIVE as libc::c_int
                                                 as usize].head as
                *mut EnBomChu;
        while !chu.is_null() {
            if &mut (*chu).actor as *mut Actor ==
                   &mut (*this).actor as *mut Actor ||
                   (*chu).actor.id as libc::c_int !=
                       ACTOR_EN_BOM_CHU as libc::c_int {
                chu = (*chu).actor.next as *mut EnBomChu
            } else {
                chuPosDiff.x =
                    (*chu).actor.world.pos.x - (*this).actor.world.pos.x;
                chuPosDiff.y =
                    (*chu).actor.world.pos.y - (*this).actor.world.pos.y;
                chuPosDiff.z =
                    (*chu).actor.world.pos.z - (*this).actor.world.pos.z;
                if (fabsf(chuPosDiff.x) < 40.0f32 ||
                        (*gGameInfo).data[(25 as libc::c_int *
                                               6 as libc::c_int *
                                               16 as libc::c_int +
                                               2 as libc::c_int) as usize] as
                            libc::c_int != 0) &&
                       (fabsf(chuPosDiff.y) < 40.0f32 ||
                            (*gGameInfo).data[(25 as libc::c_int *
                                                   6 as libc::c_int *
                                                   16 as libc::c_int +
                                                   2 as libc::c_int) as usize]
                                as libc::c_int != 0) &&
                       (fabsf(chuPosDiff.z) < 40.0f32 ||
                            (*gGameInfo).data[(25 as libc::c_int *
                                                   6 as libc::c_int *
                                                   16 as libc::c_int +
                                                   2 as libc::c_int) as usize]
                    ...
                    (*chu).timer = 1 as libc::c_int as s16;
                    ...
                    (*this).unk_1C8.z = 0.1f32;
                    (*this).unk_1C8.y = (*this).unk_1C8.z;
                    (*this).unk_1C8.x = (*this).unk_1C8.y;
                    (*this).unk_1A4.z = 0.1f32;
                    (*this).unk_1A4.y = (*this).unk_1A4.z;
                    (*this).unk_1A4.x = (*this).unk_1A4.y;
                    (*this).unk_168.x = (*globalCtx).view.lookAt.x;
                    (*this).unk_180.x = (*this).unk_168.x;
                    (*this).unk_168.y = (*globalCtx).view.lookAt.y;
                    (*this).unk_180.y = (*this).unk_168.y;
                    (*this).unk_168.z = (*globalCtx).view.lookAt.z;
                    (*this).unk_180.z = (*this).unk_168.z;
                    (*this).unk_174.x = (*globalCtx).view.eye.x;
                    (*this).unk_18C.x = (*this).unk_174.x;
                    (*this).unk_174.y = (*globalCtx).view.eye.y;
                    (*this).unk_18C.y = (*this).unk_174.y;
                    (*this).unk_174.z = (*globalCtx).view.eye.z;
                    (*this).unk_18C.z = (*this).unk_174.z;
                    (*this).unk_1BC.x = 20.0f32;
                    (*this).unk_1BC.y = 100.0f32;
                    (*this).unk_1BC.z = -800.0f32;
                    (*this).unk_198.x = 20.0f32;
                    (*this).unk_198.y = 50.0f32;
                    (*this).unk_198.z = -485.0f32;
                    (*this).unk_1B0.x =
                        fabsf((*this).unk_18C.x - (*this).unk_198.x) *
                            0.02f32;
                    (*this).unk_1B0.y =
                        fabsf((*this).unk_18C.y - (*this).unk_198.y) *
                            0.02f32;
                    (*this).unk_1B0.z =
                        fabsf((*this).unk_18C.z - (*this).unk_198.z) *
                            0.02f32;
                    (*this).unk_1D4.x =
                        fabsf((*this).unk_180.x - (*this).unk_1BC.x) *
                            0.02f32;
                    (*this).unk_1D4.y =
                        fabsf((*this).unk_180.y - (*this).unk_1BC.y) *
                            0.02f32;
                    (*this).unk_1D4.z =
                        fabsf((*this).unk_180.z - (*this).unk_1BC.z) *
                            0.02f32;
                    Gameplay_CameraSetAtEye(globalCtx, (*this).camId,
                                            &mut (*this).unk_180,
                                            &mut (*this).unk_18C);
                    (*this).actor.textId = 0xf as libc::c_int as u16_0;
                    Message_StartTextbox(globalCtx, (*this).actor.textId,
                                         0 as *mut Actor);
                    (*this).unk_154 = TEXT_STATE_EVENT as libc::c_int as s16;
                    func_80078884(0x28d3 as libc::c_int as u16_0);
                    func_8002DF54(globalCtx, 0 as *mut Actor,
                                  8 as libc::c_int as u8_0);
                    (*this).status = 1 as libc::c_int as u8_0;
                    (*this).actionFunc =
                        Some(EnBomBowlPit_CameraDollyIn as
                                 unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                                      _: *mut GlobalContext)
                                     -> ());
                    break ;
                } else { chu = (*chu).actor.next as *mut EnBomChu }
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_CameraDollyIn(mut this:
                                                        *mut EnBomBowlPit,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if (*this).camId as libc::c_int != 0 as libc::c_int {
        Math_ApproachF(&mut (*this).unk_180.x, (*this).unk_1BC.x,
                       (*this).unk_1C8.x, (*this).unk_1D4.x);
        Math_ApproachF(&mut (*this).unk_180.y, (*this).unk_1BC.y,
                       (*this).unk_1C8.y, (*this).unk_1D4.y);
        Math_ApproachF(&mut (*this).unk_180.z, (*this).unk_1BC.z,
                       (*this).unk_1C8.z, (*this).unk_1D4.z);
        Math_ApproachF(&mut (*this).unk_18C.x, (*this).unk_198.x,
                       (*this).unk_1A4.x, (*this).unk_1B0.x);
        Math_ApproachF(&mut (*this).unk_18C.y, (*this).unk_198.y,
                       (*this).unk_1A4.y, (*this).unk_1B0.y);
        Math_ApproachF(&mut (*this).unk_18C.z, (*this).unk_198.z,
                       (*this).unk_1A4.z, (*this).unk_1B0.z);
    }
    Gameplay_CameraSetAtEye(globalCtx, (*this).camId, &mut (*this).unk_180,
                            &mut (*this).unk_18C);
    if (*this).unk_154 as libc::c_int ==
           Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int &&
           Message_ShouldAdvance(globalCtx) as libc::c_int != 0 {
        Message_CloseTextbox(globalCtx);
    }
    if fabsf((*this).unk_18C.x - (*this).unk_198.x) < 5.0f32 &&
           fabsf((*this).unk_18C.y - (*this).unk_198.y) < 5.0f32 &&
           fabsf((*this).unk_18C.z - (*this).unk_198.z) < 5.0f32 &&
           fabsf((*this).unk_180.x - (*this).unk_1BC.x) < 5.0f32 &&
           fabsf((*this).unk_180.y - (*this).unk_1BC.y) < 5.0f32 &&
           fabsf((*this).unk_180.z - (*this).unk_1BC.z) < 5.0f32 {
        Message_CloseTextbox(globalCtx);
        (*this).timer = 30 as libc::c_int as s16;
        (*this).actionFunc =
            Some(EnBomBowlPit_SpawnPrize as
                     unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_SpawnPrize(mut this: *mut EnBomBowlPit,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).exItem =
            Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                               ...
                               (*this).actor.world.pos.z - 70.0f32,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16,
                               0 as libc::c_int as s16, (*this).prizeIndex) as
                *mut EnExItem;
        if !(*this).exItem.is_null() {
            (*this).actionFunc =
                Some(EnBomBowlPit_SetupGivePrize as
                         unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                              _: *mut GlobalContext) -> ())
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_SetupGivePrize(mut this:
                                                         *mut EnBomBowlPit,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    if (*this).exItemDone as libc::c_int != 0 as libc::c_int {
        match (*this).prizeIndex as libc::c_int {
            0 => {
        ...
        (*this).actionFunc =
            Some(EnBomBowlPit_GivePrize as
                     unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_GivePrize(mut this: *mut EnBomBowlPit,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    ...
    (*this).getItemId = sGetItemIds[(*this).prizeIndex as usize];
    if (*this).getItemId == GI_BOMB_BAG_30 as libc::c_int &&
        ...
        (*this).getItemId = GI_BOMB_BAG_40 as libc::c_int
    }
    (*player).stateFlags1 &= !(0x20000000 as libc::c_int) as libc::c_uint;
    (*this).actor.parent = 0 as *mut Actor;
    func_8002F434(&mut (*this).actor, globalCtx, (*this).getItemId, 2000.0f32,
                  1000.0f32);
    (*player).stateFlags1 |= 0x20000000 as libc::c_int as libc::c_uint;
    (*this).actionFunc =
        Some(EnBomBowlPit_WaitTillPrizeGiven as
                 unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_WaitTillPrizeGiven(mut this:
                                                             *mut EnBomBowlPit,
                                                         mut globalCtx:
                                                             *mut GlobalContext) {
    if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
        (*this).actionFunc =
            Some(EnBomBowlPit_Reset as
                     unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                          _: *mut GlobalContext) -> ())
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_Reset(mut this: *mut EnBomBowlPit,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if Message_GetState(&mut (*globalCtx).msgCtx) as libc::c_int ==
        ...
        if (*this).getItemId == GI_HEART_PIECE as libc::c_int {
            gSaveContext.healthAccumulator = 0x140 as libc::c_int as s16;
            // "Ah recovery!" (?)
            osSyncPrintf(b"\x1b[32m\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \xe3\x81\x82\xe3\x81\x81\xe5\x9b\x9e\xe5\xbe\xa9\xef\xbc\x81 \xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86\xe2\x98\x86 \n\x1b[m\x00"
                             as *const u8 as *const libc::c_char);
        }
        (*this).exItemDone = 0 as libc::c_int as s16;
        (*this).status = 2 as libc::c_int as u8_0;
        (*this).actionFunc =
            Some(EnBomBowlPit_SetupDetectHit as
                     unsafe extern "C" fn(_: *mut EnBomBowlPit,
                                          _: *mut GlobalContext) -> ())
...
#[no_mangle]
pub unsafe extern "C" fn EnBomBowlPit_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut EnBomBowlPit = thisx as *mut EnBomBowlPit;
