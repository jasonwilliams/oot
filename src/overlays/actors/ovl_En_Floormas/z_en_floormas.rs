...
extern "C" {
    ...
    fn Item_DropCollectibleRandom(globalCtx: *mut GlobalContext,
                                  ...
                                  params: s16);
    #[no_mangle]
    fn func_80026230(globalCtx: *mut GlobalContext, color: *mut Color_RGBA8,
                     arg2: s16, arg3: s16);
    #[no_mangle]
    fn func_80026608(globalCtx: *mut GlobalContext);
    #[no_mangle]
    fn func_80026690(globalCtx: *mut GlobalContext, color: *mut Color_RGBA8,
                     arg2: s16, arg3: s16);
    #[no_mangle]
    ...
    fn func_800286CC(globalCtx: *mut GlobalContext, pos: *mut Vec3f,
                     ...
                     scaleStep: s16);
    #[no_mangle]
    fn EffectSsFCircle_Spawn(globalCtx: *mut GlobalContext, actor: *mut Actor,
                             pos: *mut Vec3f, radius: s16, height: s16);
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gWallmasterDamageAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterRecoverFromDamageAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterJumpAnim: AnimationHeader;
    #[no_mangle]
    static mut gFloormasterTurnAnim: AnimationHeader;
    #[no_mangle]
    static mut gFloormasterTapFingerAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterFingerDL: [Gfx; 0];
    #[no_mangle]
    static mut gWallmasterSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gWallmasterStopWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterHoverAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterWaitAnim: AnimationHeader;
    #[no_mangle]
    static mut gWallmasterStandUpAnim: AnimationHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnFloormas {
    pub actor: Actor,
    pub skelAnime: SkelAnime,
    pub actionFunc: EnFloormasActionFunc,
    pub actionTimer: s16,
    pub actionTarget: s16,
    pub zOffset: s16,
    pub smActionTimer: s16,
    pub jointTable: [Vec3s; 25],
    pub morphTable: [Vec3s; 25],
    pub collider: ColliderCylinder,
}
pub type EnFloormasActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnFloormas, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Floormas_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_FLOORMAS as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_WALLMASTER as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnFloormas>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFloormas_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFloormas_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFloormas_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnFloormas_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 4 as libc::c_int as u8_0,
                                   cylRadius: 30 as libc::c_int as s16,
                                   cylHeight: 40 as libc::c_int as s16,
                                   mass: 150 as libc::c_int as u8_0,};
        init
    };
            ...
            DamageTable{table:
                            [(0 as libc::c_int |
                             ...
                             (4 as libc::c_int |
                                 ...
                                 u8_0,
                             (4 as libc::c_int |
                                  (0x2 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
                             (2 as libc::c_int |
                                  (0 as libc::c_int) << 4 as libc::c_int) as
                                 u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Init(mut thisx: *mut Actor,
                                         mut globalCtx2: *mut GlobalContext) {
    let mut this: *mut EnFloormas = thisx as *mut EnFloormas;
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut invisble: s32 = 0;
    let mut pad: s32 = 0;
    ...
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime,
                       &mut gWallmasterSkel, &mut gWallmasterWaitAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(), 25 as libc::c_int);
    ...
    CollisionCheck_SetInfo(&mut (*this).actor.colChkInfo, &mut sDamageTable,
                           &mut sColChkInfoInit);
    (*this).zOffset = -(1600 as libc::c_int) as s16;
    invisble = (*this).actor.params as libc::c_int & 0x8000 as libc::c_int;
    // s16 cast needed
    (*this).actor.params =
    ...
    if (*this).actor.params as libc::c_int == 0x10 as libc::c_int {
        ...
        (*(*this).actor.parent).child = &mut (*this).actor;
        (*(*this).actor.parent).parent = (*this).actor.child;
        (*(*this).actor.child).parent = &mut (*this).actor;
        (*(*this).actor.child).child = (*this).actor.parent;
        EnFloormas_SetupBigDecideAction(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Destroy(mut thisx: *mut Actor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut this: *mut EnFloormas = thisx as *mut EnFloormas;
    let mut col: *mut ColliderCylinder = &mut (*this).collider;
    Collider_DestroyCylinder(globalCtx, col);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_MakeInvulnerable(mut this:
                                                         *mut EnFloormas) {
    ...
    (*this).actionTarget = 0x28 as libc::c_int as s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_MakeVulnerable(mut this:
                                                       *mut EnFloormas) {
    (*this).collider.base.colType = COLTYPE_HIT0 as libc::c_int as u8_0;
    (*this).actionTarget = 0 as libc::c_int as s16;
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupBigDecideAction(mut this:
                                                             *mut EnFloormas) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWallmasterWaitAnim);
    (*this).actionFunc =
        Some(EnFloormas_BigDecideAction as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupStand(mut this: *mut EnFloormas) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gWallmasterStandUpAnim, -3.0f32);
    (*this).actionFunc =
        Some(EnFloormas_Stand as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupBigWalk(mut this: *mut EnFloormas) {
    if (*this).actionFunc !=
           Some(EnFloormas_Run as
                    unsafe extern "C" fn(_: *mut EnFloormas,
                                         _: *mut GlobalContext) -> ()) {
        Animation_PlayLoopSetSpeed(&mut (*this).skelAnime,
                                   &mut gWallmasterWalkAnim, 1.5f32);
    } else { (*this).skelAnime.playSpeed = 1.5f32 }
    (*this).actionTimer =
        Rand_S16Offset(2 as libc::c_int as s16, 4 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnFloormas_BigWalk as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 1.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupBigStopWalk(mut this:
                                                         *mut EnFloormas) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWallmasterStopWalkAnim);
    (*this).actionFunc =
        Some(EnFloormas_BigStopWalk as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupRun(mut this: *mut EnFloormas) {
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupTurn(mut this: *mut EnFloormas) {
    let mut rotDelta: s16 =
        ((*this).actionTarget as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    (*this).actor.speedXZ = 0.0f32;
    if rotDelta as libc::c_int > 0 as libc::c_int {
        Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                                  &mut gFloormasterTurnAnim, -3.0f32);
    } else {
        Animation_Change(&mut (*this).skelAnime, &mut gFloormasterTurnAnim,
                         -1.0f32,
                         Animation_GetLastFrame(&mut gFloormasterTurnAnim as
                                                    *mut AnimationHeader as
                                                    *mut libc::c_void) as
                             f32_0, 0.0f32,
                         ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    }
    if (*this).actor.scale.x > 0.004f32 {
        (*this).actionTarget =
            (rotDelta as libc::c_int as libc::c_float * (2.0f32 / 30.0f32)) as
                s16
    } else {
        (*this).skelAnime.playSpeed =
            (*this).skelAnime.playSpeed + (*this).skelAnime.playSpeed;
        (*this).actionTarget =
            (rotDelta as libc::c_int as libc::c_float * (2.0f32 / 15.0f32)) as
                s16
    }
    (*this).actionFunc =
        Some(EnFloormas_Turn as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupHover(mut this: *mut EnFloormas,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterHoverAnim,
                     3.0f32, 0 as libc::c_int as f32_0,
                     Animation_GetLastFrame(&mut gWallmasterHoverAnim as
                                                *mut AnimationHeader as
    ...
    Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                             ...
                             6 as libc::c_int, 20.0f32,
                             0x12c as libc::c_int as s16,
                             0x64 as libc::c_int as s16,
                             1 as libc::c_int as u8_0);
    Audio_PlayActorSound2(&mut (*this).actor, 0x3930 as libc::c_int as u16_0);
    (*this).actionFunc =
        Some(EnFloormas_Hover as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupCharge(mut this: *mut EnFloormas) {
    (*this).actionTimer = 25 as libc::c_int as s16;
    (*this).actor.gravity = -0.15f32;
    (*this).actionFunc =
        Some(EnFloormas_Charge as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupLand(mut this: *mut EnFloormas) {
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 1.0f32,
                     41.0f32, 42.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     5.0f32);
    ...
    } else { (*this).actionTimer = 45 as libc::c_int as s16 }
    (*this).actor.gravity = -1.0f32;
    (*this).actionFunc =
        Some(EnFloormas_Land as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSplit(mut this: *mut EnFloormas) {
    Actor_SetScale(&mut (*this).actor, 0.004f32);
    (*this).actor.flags |=
    ...
    (*this).actor.params = 0x10 as libc::c_int as s16;
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 1.0f32,
                     41.0f32,
                     Animation_GetLastFrame(&mut gWallmasterJumpAnim as
                                                *mut AnimationHeader as
                                                *mut libc::c_void) as f32_0,
                     ANIMMODE_ONCE as libc::c_int as u8_0, 0.0f32);
    (*this).collider.dim.radius =
        (sCylinderInit.dim.radius as libc::c_int as libc::c_float * 0.6f32) as
            s16;
    (*this).collider.dim.height =
        (sCylinderInit.dim.height as libc::c_int as libc::c_float * 0.6f32) as
            s16;
    (*this).collider.info.bumperFlags =
        ((*this).collider.info.bumperFlags as libc::c_int &
             !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
    (*this).actor.speedXZ = 4.0f32;
    (*this).actor.velocity.y = 7.0f32;
    // using div creates a signed check.
    (*this).actor.colChkInfo.health =
        (sColChkInfoInit.health as libc::c_int >> 1 as libc::c_int) as u8_0;
    (*this).actionFunc =
        Some(EnFloormas_Split as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSmWalk(mut this: *mut EnFloormas) {
    Animation_PlayLoopSetSpeed(&mut (*this).skelAnime,
                               &mut gWallmasterWalkAnim, 4.5f32);
    (*this).actionFunc =
        Some(EnFloormas_SmWalk as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 5.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSmDecideAction(mut this:
                                                            *mut EnFloormas) {
    if (*this).actionFunc !=
           Some(EnFloormas_SmWalk as
                    unsafe extern "C" fn(_: *mut EnFloormas,
    ...
    (*this).actionFunc =
        Some(EnFloormas_SmDecideAction as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 5.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSmShrink(mut this: *mut EnFloormas,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    ...
    pos.y = (*this).actor.world.pos.y + 15.0f32;
    pos.z = (*this).actor.world.pos.z;
    EffectSsDeadDb_Spawn(globalCtx, &mut pos, &mut velocity, &mut accel,
                         150 as libc::c_int as s16,
                         -(10 as libc::c_int) as s16,
                         255 as libc::c_int as s16, 255 as libc::c_int as s16,
                         255 as libc::c_int as s16, 255 as libc::c_int as s16,
                         0 as libc::c_int as s16, 0 as libc::c_int as s16,
                         255 as libc::c_int as s16, 1 as libc::c_int as s16,
                         9 as libc::c_int, 1 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnFloormas_SmShrink as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSlaveJumpAtMaster(mut this:
                                                               *mut EnFloormas) {
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 2.0f32,
                     0.0f32, 41.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     0.0f32);
    (*this).actionFunc =
        Some(EnFloormas_SmSlaveJumpAtMaster as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupJumpAtLink(mut this:
                                                        *mut EnFloormas) {
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 2.0f32,
                     0.0f32, 41.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     0.0f32);
    (*this).actionFunc =
        Some(EnFloormas_JumpAtLink as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 0.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupGrabLink(mut this: *mut EnFloormas,
                                                  mut player: *mut Player) {
    let mut yDelta: f32_0 = 0.;
    let mut xzDelta: f32_0 = 0.;
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 1.0f32,
                     36.0f32, 45.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     -3.0f32);
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    ...
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        yDelta =
            if -(*this).actor.yDistToPlayer < 20.0f32 {
                20.0f32
            } else if -(*this).actor.yDistToPlayer > 30.0f32 {
                30.0f32
            } else { -(*this).actor.yDistToPlayer };
        xzDelta = -10.0f32
    } else {
        yDelta =
            if -(*this).actor.yDistToPlayer < 25.0f32 {
                25.0f32
            } else if -(*this).actor.yDistToPlayer > 45.0f32 {
                45.0f32
            } else { -(*this).actor.yDistToPlayer };
        xzDelta = -70.0f32
    }
    ...
    (*this).actor.world.pos.x =
        Math_SinS((*this).actor.shape.rot.y) * (xzDelta * 0.1f32) +
            (*player).actor.world.pos.x;
    (*this).actor.world.pos.z =
        Math_CosS((*this).actor.shape.rot.y) * (xzDelta * 0.1f32) +
            (*player).actor.world.pos.z;
    (*this).actor.shape.rot.x = -(0x4ce0 as libc::c_int) as s16;
    (*this).actionFunc =
        Some(EnFloormas_GrabLink as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupMerge(mut this: *mut EnFloormas) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gWallmasterWaitAnim);
    (*this).actionTimer = 0 as libc::c_int as s16;
    (*this).smActionTimer =
        ((*this).smActionTimer as libc::c_int + 1500 as libc::c_int) as s16;
    EnFloormas_MakeInvulnerable(this);
    (*this).actionFunc =
        Some(EnFloormas_Merge as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupSmWait(mut this: *mut EnFloormas) {
    let mut parent: *mut EnFloormas = (*this).actor.parent as *mut EnFloormas;
    let mut child: *mut EnFloormas = (*this).actor.child as *mut EnFloormas;
    // if this is the last remaining small floor master, kill all.
    if (*parent).actionFunc ==
           Some(EnFloormas_SmWait as
                    unsafe extern "C" fn(_: *mut EnFloormas,
                                         _: *mut GlobalContext) -> ()) &&
           (*child).actionFunc ==
               Some(EnFloormas_SmWait as
                        unsafe extern "C" fn(_: *mut EnFloormas,
                                             _: *mut GlobalContext) -> ()) {
        Actor_Kill(&mut (*parent).actor);
        Actor_Kill(&mut (*child).actor);
        Actor_Kill(&mut (*this).actor);
        return
    }
    (*this).actor.draw = None;
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupTakeDamage(mut this:
                                                        *mut EnFloormas) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gWallmasterDamageAnim, -3.0f32);
    ...
    (*this).actionFunc =
        Some(EnFloormas_TakeDamage as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
    (*this).actor.speedXZ = 5.0f32;
    (*this).actor.velocity.y = 5.5f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupRecover(mut this: *mut EnFloormas) {
    Animation_PlayOnce(&mut (*this).skelAnime,
                       &mut gWallmasterRecoverFromDamageAnim);
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = (*this).actor.speedXZ;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actionFunc =
        Some(EnFloormas_Recover as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SetupFreeze(mut this: *mut EnFloormas) {
    Animation_Change(&mut (*this).skelAnime, &mut gWallmasterJumpAnim, 1.5f32,
                     0 as libc::c_int as f32_0, 20.0f32,
                     ANIMMODE_ONCE as libc::c_int as u8_0, -3.0f32);
    (*this).actor.speedXZ = 0.0f32;
    ...
    (*this).actionFunc =
        Some(EnFloormas_Freeze as
                 unsafe extern "C" fn(_: *mut EnFloormas,
                                      _: *mut GlobalContext) -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Die(mut this: *mut EnFloormas,
    ...
    if (*this).actor.scale.x > 0.004f32 {
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.yawTowardsPlayer as libc::c_int +
                 0x8000 as libc::c_int) as s16;
        EnFloormas_SetupSplit((*this).actor.child as *mut EnFloormas);
        EnFloormas_SetupSplit((*this).actor.parent as *mut EnFloormas);
        EnFloormas_SetupSplit(this);
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3935 as libc::c_int as u16_0);
    } else {
        // Die
        Item_DropCollectibleRandom(globalCtx, &mut (*this).actor,
                                   &mut (*this).actor.world.pos,
                                   0x90 as libc::c_int as s16);
        EnFloormas_SetupSmShrink(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_BigDecideAction(mut this: *mut EnFloormas,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        // within 400 units of link and within 90 degrees rotation of him
        if (*this).actor.xzDistToPlayer < 400.0f32 &&
        ...
        } else { EnFloormas_SetupStand(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Stand(mut this: *mut EnFloormas,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).actor.scale.x > 0.004f32 {
            EnFloormas_SetupBigWalk(this);
        } else if (*this).actor.params as libc::c_int == 0x20 as libc::c_int {
            EnFloormas_SetupSmDecideAction(this);
        } else { EnFloormas_SetupSmWalk(this); }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_BigWalk(mut this: *mut EnFloormas,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut animPastFrame: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    animPastFrame = Animation_OnFrame(&mut (*this).skelAnime, 0.0f32);
    if animPastFrame != 0 {
    ...
    if animPastFrame != 0 ||
           ...
           Animation_OnFrame(&mut (*this).skelAnime, 24.0f32) !=
               0 as libc::c_int ||
           Animation_OnFrame(&mut (*this).skelAnime, 36.0f32) !=
               0 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3894 as libc::c_int as u16_0);
    }
    if (*this).actor.xzDistToPlayer < 320.0f32 &&
           Actor_IsFacingPlayer(&mut (*this).actor,
                                0x4000 as libc::c_int as s16) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_BigStopWalk(mut this: *mut EnFloormas,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnFloormas_SetupBigDecideAction(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Run(mut this: *mut EnFloormas,
                                        mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 12.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 24.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 36.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3894 as libc::c_int as u16_0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Turn(mut this: *mut EnFloormas,
                                         mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).skelAnime.curFrame >= 7.0f32 &&
        ...
        sp30 =
            Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                           0x4268 as libc::c_int) as s16);
        sp2C =
            Math_CosS(((*this).actor.shape.rot.y as libc::c_int +
                           0x4268 as libc::c_int) as s16);
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 (*this).actionTarget as libc::c_int) as s16;
        (*this).actor.world.pos.x -=
            (*this).actor.scale.x * 2700.0f32 *
                (Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                                0x4268 as libc::c_int) as s16) - sp30);
        (*this).actor.world.pos.z -=
            (*this).actor.scale.x * 2700.0f32 *
                (Math_CosS(((*this).actor.shape.rot.y as libc::c_int +
                                0x4268 as libc::c_int) as s16) - sp2C)
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Hover(mut this: *mut EnFloormas,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        EnFloormas_SetupCharge(this);
    }
    (*this).actor.shape.rot.x =
        ((*this).actor.shape.rot.x as libc::c_int + 0x140 as libc::c_int) as
            s16;
    (*this).actor.world.pos.y += 10.0f32;
    Math_ApproachS(&mut (*this).actor.shape.rot.y,
                   (*this).actor.yawTowardsPlayer, 3 as libc::c_int as s16,
                   2730 as libc::c_int as s16);
    Math_StepToS(&mut (*this).zOffset, 1200 as libc::c_int as s16,
                 100 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Slide(mut this: *mut EnFloormas,
                                          mut globalCtx: *mut GlobalContext) {
    static mut accel: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    ...
    velocity.x =
        Math_SinS(((*this).actor.shape.rot.y as libc::c_int +
                       0x6000 as libc::c_int) as s16) * 7.0f32;
    velocity.z =
        Math_CosS(((*this).actor.shape.rot.y as libc::c_int +
                       0x6000 as libc::c_int) as s16) * 7.0f32;
    func_800286CC(globalCtx, &mut pos, &mut velocity, &mut accel,
                  450 as libc::c_int as s16, 100 as libc::c_int as s16);
    velocity.x =
        Math_SinS(((*this).actor.shape.rot.y as libc::c_int -
                       0x6000 as libc::c_int) as s16) * 7.0f32;
    velocity.z =
    ...
    func_800286CC(globalCtx, &mut pos, &mut velocity, &mut accel,
                  450 as libc::c_int as s16, 100 as libc::c_int as s16);
    func_8002F974(&mut (*this).actor, 0x3034 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Charge(mut this: *mut EnFloormas,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut distFromGround: f32_0 = 0.;
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
        (*this).actionTimer -= 1
    }
    Math_StepToF(&mut (*this).actor.speedXZ, 15.0f32,
                 (*this).actor.speedXZ * (*this).actor.speedXZ *
                     (1.0f32 / 3.0f32));
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       -(0x1680 as libc::c_int) as s16,
                       0x140 as libc::c_int as s16);
    distFromGround = (*this).actor.world.pos.y - (*this).actor.floorHeight;
    if distFromGround < 10.0f32 {
        (*this).actor.world.pos.y = (*this).actor.floorHeight + 10.0f32;
        (*this).actor.gravity = 0.0f32;
        (*this).actor.velocity.y = 0.0f32
    }
    if distFromGround < 12.0f32 { EnFloormas_Slide(this, globalCtx); }
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Land(mut this: *mut EnFloormas,
                                         mut globalCtx: *mut GlobalContext) {
    let mut isOnGround: s32 = 0;
    isOnGround = (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int;
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        if (*this).actor.params as libc::c_int != 0x40 as libc::c_int {
            EnFloormas_MakeVulnerable(this);
        }
        if (*this).actor.velocity.y < -4.0f32 {
            if (*this).actor.scale.x > 0.004f32 {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3893 as libc::c_int as u16_0);
            } else {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3937 as libc::c_int as u16_0);
            }
        }
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
    ...
    if isOnGround != 0 {
        Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 2.0f32);
    }
    if (*this).actor.speedXZ > 0.0f32 &&
           (*this).actor.world.pos.y - (*this).actor.floorHeight < 12.0f32 {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (*this).actionTimer as libc::c_int == 0 as libc::c_int &&
               isOnGround != 0 {
            if (*this).skelAnime.endFrame < 45.0f32 {
                ...
                EnFloormas_SetupStand(this);
                (*this).smActionTimer = 50 as libc::c_int as s16
            }
        }
    }
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x140 as libc::c_int as s16);
    Math_StepToS(&mut (*this).zOffset, -(1600 as libc::c_int) as s16,
                 100 as libc::c_int as s16);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Split(mut this: *mut EnFloormas,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        ...
        Math_StepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32);
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3937 as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SmWalk(mut this: *mut EnFloormas,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).smActionTimer as libc::c_int == 0 as libc::c_int {
    } else { (*this).smActionTimer -= 1 };
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 ||
    ...
    if (*this).smActionTimer as libc::c_int == 0 as libc::c_int {
        ...
        (*this).actionTarget = (*this).actor.wallYaw;
        EnFloormas_SetupTurn(this);
    } else if (*this).actor.xzDistToPlayer < 120.0f32 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SmDecideAction(mut this: *mut EnFloormas,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    let mut primaryFloormas: *mut Actor = 0 as *mut Actor;
    let mut isAgainstWall: s32 = 0;
    SkelAnime_Update(&mut (*this).skelAnime);
    if Animation_OnFrame(&mut (*this).skelAnime, 0.0f32) != 0 ||
           Animation_OnFrame(&mut (*this).skelAnime, 18.0f32) != 0 {
        Audio_PlayActorSound2(&mut (*this).actor,
    ...
    if (*this).actor.params as libc::c_int == 0x20 as libc::c_int {
        if (*(*this).actor.parent).params as libc::c_int ==
               0x40 as libc::c_int {
            primaryFloormas = (*this).actor.parent
        } else if (*(*this).actor.child).params as libc::c_int ==
                      0x40 as libc::c_int {
            primaryFloormas = (*this).actor.child
        } else { (*this).actor.params = 0x10 as libc::c_int as s16; return }
        Math_ScaledStepToS(&mut (*this).actor.shape.rot.y,
                           Actor_WorldYawTowardActor(&mut (*this).actor,
                                                     primaryFloormas),
                           0x38e as libc::c_int as s16);
        if Actor_WorldDistXZToActor(&mut (*this).actor, primaryFloormas) <
               80.0f32 {
        ...
        Math_ApproachS(&mut (*this).actor.shape.rot.y,
                       ...
                       3 as libc::c_int as s16, 0x71c as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SmShrink(mut this: *mut EnFloormas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    if Math_StepToF(&mut (*this).actor.scale.x, 0.0f32, 0.0015f32) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_JumpAtLink(mut this: *mut EnFloormas,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    ...
    } else if Animation_OnFrame(&mut (*this).skelAnime, 20.0f32) != 0 {
        (*this).actor.speedXZ = 5.0f32;
        (*this).actor.velocity.y = 7.0f32
    } else if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int !=
                  0 {
        (*this).actionTimer = 0x32 as libc::c_int as s16;
        (*this).actor.speedXZ = 0.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3937 as libc::c_int as u16_0);
        EnFloormas_SetupLand(this);
    } else if (*this).actor.yDistToPlayer < -10.0f32 &&
                  (*this).collider.base.ocFlags1 as libc::c_int &
                      (1 as libc::c_int) << 1 as libc::c_int != 0 &&
                  &mut (*player).actor as *mut Actor ==
                      (*this).collider.base.oc {
        (*globalCtx).grabPlayer.expect("non-null function pointer")(globalCtx,
                                                                    player);
        EnFloormas_SetupGrabLink(this, player);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_GrabLink(mut this: *mut EnFloormas,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut parent: *mut EnFloormas = 0 as *mut EnFloormas;
    let mut child: *mut EnFloormas = 0 as *mut EnFloormas;
    let mut yDelta: f32_0 = 0.;
    let mut xzDelta: f32_0 = 0.;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).skelAnime.playSpeed > 0.0f32 {
            (*this).skelAnime.playSpeed = -1.0f32;
            (*this).skelAnime.endFrame = 36.0f32;
            (*this).skelAnime.startFrame = 45.0f32
        } else {
            (*this).skelAnime.playSpeed = 1.0f32;
            (*this).skelAnime.endFrame = 45.0f32;
            (*this).skelAnime.startFrame = 36.0f32
        }
    }
    if !(gSaveContext.linkAge == 0 as libc::c_int) {
        yDelta =
    ...
    if (*player).stateFlags2 & 0x80 as libc::c_int as libc::c_uint == 0 ||
        ...
        parent = (*this).actor.parent as *mut EnFloormas;
        child = (*this).actor.child as *mut EnFloormas;
        if ((*parent).actionFunc ==
                Some(EnFloormas_GrabLink as
                         unsafe extern "C" fn(_: *mut EnFloormas,
                                              _: *mut GlobalContext) -> ()) ||
                    ...
                    (*child).actionFunc ==
                        Some(EnFloormas_SmWait as
                                 unsafe extern "C" fn(_: *mut EnFloormas,
                                                      _: *mut GlobalContext)
                                     -> ())) {
            (*parent).actor.params = 0x20 as libc::c_int as s16;
            (*child).actor.params = 0x20 as libc::c_int as s16;
            (*this).actor.params = 0x40 as libc::c_int as s16
        }
        ...
        EnFloormas_SetupLand(this);
    } else if (*this).actionTarget as libc::c_int % 20 as libc::c_int ==
                  0 as libc::c_int {
        if !(gSaveContext.linkAge == 0 as libc::c_int) {
    ...
    Audio_PlayActorSound2(&mut (*this).actor, 0x3136 as libc::c_int as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SmSlaveJumpAtMaster(mut this:
                                                            *mut EnFloormas,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    let mut primFloormas: *mut Actor = 0 as *mut Actor;
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*(*this).actor.parent).params as libc::c_int == 0x40 as libc::c_int {
    ...
    if Animation_OnFrame(&mut (*this).skelAnime, 20.0f32) != 0 {
        ...
        Math_ApproachS(&mut (*this).actor.shape.rot.y,
                       Actor_WorldYawTowardActor(&mut (*this).actor,
                                                 primFloormas),
                       2 as libc::c_int as s16, 0xe38 as libc::c_int as s16);
    } else if (*primFloormas).world.pos.y - (*this).actor.world.pos.y <
                  -10.0f32 &&
                  fabsf((*this).actor.world.pos.x -
                            (*primFloormas).world.pos.x) < 10.0f32 &&
                  fabsf((*this).actor.world.pos.z -
                            (*primFloormas).world.pos.z) < 10.0f32 {
        EnFloormas_SetupSmWait(this);
    ...
    if fabsf((*this).actor.world.pos.x - (*primFloormas).world.pos.x) < 5.0f32
           &&
           fabsf((*this).actor.world.pos.z - (*primFloormas).world.pos.z) <
               5.0f32 {
        Math_StepToF(&mut (*this).actor.speedXZ, 0 as libc::c_int as f32_0,
                     2.0f32);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Merge(mut this: *mut EnFloormas,
                                          mut globalCtx: *mut GlobalContext) {
    let mut parent: *mut EnFloormas = 0 as *mut EnFloormas;
    let mut child: *mut EnFloormas = 0 as *mut EnFloormas;
    let mut mergeCnt: s32 = 0;
    let mut prevScale: f32_0 = 0.;
    let mut curScale: f32_0 = 0.;
    mergeCnt = 0 as libc::c_int;
    if (*this).smActionTimer as libc::c_int == 0 as libc::c_int {
    } else { (*this).smActionTimer -= 1 };
    parent = (*this).actor.parent as *mut EnFloormas;
    child = (*this).actor.child as *mut EnFloormas;
    ...
    if mergeCnt == 1 as libc::c_int {
        Math_StepToF(&mut (*this).actor.scale.x, 0.007f32, 0.0005f32);
    } else if mergeCnt == 0 as libc::c_int {
        Math_StepToF(&mut (*this).actor.scale.x, 0.01f32, 0.0005f32);
    }
    curScale = (*this).actor.scale.x;
    (*this).actor.scale.z = curScale;
    (*this).actor.scale.y = (*this).actor.scale.z;
    if (prevScale == 0.007f32 || prevScale == 0.004f32) &&
           prevScale != (*this).actor.scale.x {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3934 as libc::c_int as u16_0);
    }
    (*this).collider.dim.radius =
        (sCylinderInit.dim.radius as libc::c_int as libc::c_float * 100.0f32 *
             (*this).actor.scale.x) as s16;
    (*this).collider.dim.height =
        (sCylinderInit.dim.height as libc::c_int as libc::c_float * 100.0f32 *
             (*this).actor.scale.x) as s16;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        if (*this).actor.scale.x >= 0.01f32 {
            (*this).actor.flags &=
                !((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint;
            EnFloormas_MakeVulnerable(this);
            ...
            Animation_PlayOnce(&mut (*this).skelAnime,
                               &mut gFloormasterTapFingerAnim);
            (*this).actionTimer = 1 as libc::c_int as s16
        } else {
            Animation_PlayOnce(&mut (*this).skelAnime,
                               &mut gWallmasterWaitAnim);
            (*this).actionTimer = 0 as libc::c_int as s16
        }
    }
    func_8002F974(&mut (*this).actor,
                  (0x3933 as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_SmWait(mut this: *mut EnFloormas,
                                           mut globalCtx:
                                               *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_TakeDamage(mut this: *mut EnFloormas,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        ...
        } else { EnFloormas_SetupRecover(this); }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Recover(mut this: *mut EnFloormas,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 as libc::c_int {
        EnFloormas_SetupStand(this);
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Freeze(mut this: *mut EnFloormas,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actionTimer as libc::c_int != 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_ColliderCheck(mut this: *mut EnFloormas,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut isSmall: s32 = 0;
    if (*this).collider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*this).collider.base.colType as libc::c_int !=
                ...
                isSmall = 0 as libc::c_int;
                if (*this).actor.scale.x < 0.01f32 {
                    isSmall = 1 as libc::c_int
                }
                if isSmall != 0 &&
                ...
                if Actor_ApplyDamage(&mut (*this).actor) as libc::c_int ==
                    ...
                    if isSmall != 0 {
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x3932 as libc::c_int as u16_0);
                    } else {
                        Audio_PlayActorSound2(&mut (*this).actor,
                                              0x3896 as libc::c_int as u16_0);
                    }
                    Enemy_StartFinishingBlow(globalCtx, &mut (*this).actor);
                    (*this).actor.flags &=
                        !((1 as libc::c_int) << 0 as libc::c_int) as
                            libc::c_uint
                } else if (*this).actor.colChkInfo.damage as libc::c_int !=
                              0 as libc::c_int {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x3895 as libc::c_int as u16_0);
                }
                if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       4 as libc::c_int ||
                    ...
                    if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                           2 as libc::c_int {
                        EffectSsFCircle_Spawn(globalCtx, &mut (*this).actor,
                                              &mut (*this).actor.world.pos,
                                              ((*this).actor.scale.x *
                                                   4000.0f32) as s16,
                                              ((*this).actor.scale.x *
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Update(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut EnFloormas = thisx as *mut EnFloormas;
    let mut pad: s32 = 0;
    if (*this).actionFunc !=
        ...
        if (*this).collider.base.atFlags as libc::c_int &
            ...
            (*this).collider.base.atFlags =
                ((*this).collider.base.atFlags as libc::c_int &
                     !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
            (*this).actor.speedXZ *= -0.5f32;
            if -5.0f32 < (*this).actor.speedXZ {
                (*this).actor.speedXZ = -5.0f32
            } else { (*this).actor.speedXZ = (*this).actor.speedXZ }
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 20.0f32,
                                (*this).actor.scale.x * 3000.0f32, 0.0f32,
                                0x1d as libc::c_int);
        ...
        Actor_SetFocus(&mut (*this).actor, (*this).actor.scale.x * 2500.0f32);
        if (*this).collider.base.colType as libc::c_int ==
               COLTYPE_HARD as libc::c_int {
            if (*this).actionTarget as libc::c_int != 0 as libc::c_int {
                (*this).actionTarget -= 1
            }
            if (*this).actionTarget as libc::c_int == 0 as libc::c_int {
                (*this).actionTarget = 0x28 as libc::c_int as s16
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_OverrideLimbDraw(mut globalCtx:
                                                         *mut GlobalContext,
                                                     mut limbIndex: s32,
 ...
 -> s32 {
    ...
    if limbIndex == 1 as libc::c_int {
        (*pos).z += (*this).zOffset as libc::c_int as libc::c_float
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_PostLimbDraw(mut globalCtx:
                                                     *mut GlobalContext,
                                                 mut limbIndex: s32,
                                                 mut dList: *mut *mut Gfx,
                                                 mut rot: *mut Vec3s,
    ...
    if limbIndex == 2 as libc::c_int {
        Matrix_Push();
        Matrix_Translate(1600.0f32, -700.0f32, -1700.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateY(60.0f32 * 3.14159265358979323846f32 / 180.0f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        Matrix_RotateZ(15.0f32 * 3.14159265358979323846f32 / 180.0f32,
                       MTXMODE_APPLY as libc::c_int as u8_0);
        ...
        *gfx = (*gfx).offset(1);
        ...
        (*_g).words.w1 =
            Matrix_NewMtx((*globalCtx).state.gfxCtx,
                          b"../z_en_floormas.c\x00" as *const u8 as
            ...
            (0xde as libc::c_int as u32_0 &
                ...
                (0 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 16 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*_g_0).words.w1 = gWallmasterFingerDL.as_mut_ptr() as libc::c_uint;
        Matrix_Pop();
    };
}
static mut sMergeColor: Color_RGBA8 =
    {
        let mut init =
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_Draw(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnFloormas = thisx as *mut EnFloormas;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_floormas.c\x00" as *const u8 as
                        *const libc::c_char, 2318 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    if (*this).collider.base.colType as libc::c_int ==
           COLTYPE_HARD as libc::c_int {
        func_80026230(globalCtx, &mut sMergeColor,
                      ((*this).actionTarget as libc::c_int %
    ...
    (*__gfxCtx).polyOpa.p =
        SkelAnime_DrawFlex(globalCtx, (*this).skelAnime.skeleton,
                           ...
                           Some(EnFloormas_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
                                                         ...
                                                         _: *mut *mut Gfx)
                                        -> s32),
                           Some(EnFloormas_PostLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
...
#[no_mangle]
pub unsafe extern "C" fn EnFloormas_DrawHighlighted(mut thisx: *mut Actor,
                                                    mut globalCtx:
                                                        *mut GlobalContext) {
    let mut this: *mut EnFloormas = thisx as *mut EnFloormas;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    if (*this).collider.base.colType as libc::c_int ==
           COLTYPE_HARD as libc::c_int {
        func_80026690(globalCtx, &mut sMergeColor,
                      ((*this).actionTarget as libc::c_int %
                           0x28 as libc::c_int) as s16,
                      0x28 as libc::c_int as s16);
    }
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_floormas.c\x00" as *const u8 as
                         *const libc::c_char, 2374 as libc::c_int);
}
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x31 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_value(5500 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
