...
extern "C" {
    ...
    #[no_mangle]
    fn func_80043548(dynaActor: *mut DynaPolyActor) -> s32;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gZorasFountainIceRampDL: [Gfx; 0];
    #[no_mangle]
    static mut gZorasFountainIceRampCol: CollisionHeader;
    #[no_mangle]
    static mut gZorasFountainIcebergDL: [Gfx; 0];
    #[no_mangle]
    static mut gZorasFountainIcebergCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot08Iceblock {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot08IceblockActionFunc,
    pub surfaceNormal: Vec3f,
    pub normalDelta: Vec3f,
    pub rotationAxis: Vec3f,
    pub bobPhaseSlow: s16,
    pub bobPhaseFast: s16,
    pub bobIncrSlow: s16,
    pub bobIncrFast: s16,
    pub sinkOffset: f32_0,
    pub bobOffset: f32_0,
}
pub type BgSpot08IceblockActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot08Iceblock,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Spot08_Iceblock_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT08_ICEBLOCK as libc::c_int as s16,
                          category: ACTORCAT_BG as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId: OBJECT_SPOT08_OBJ as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<BgSpot08Iceblock>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot08Iceblock_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot08Iceblock_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot08Iceblock_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot08Iceblock_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetupAction(mut this:
                                                          *mut BgSpot08Iceblock,
                                                      mut actionFunc:
                                                          BgSpot08IceblockActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_InitDynaPoly(mut this:
                                                           *mut BgSpot08Iceblock,
                                                       mut globalCtx:
                                                           *mut GlobalContext,
                                                       mut collision:
    ...
    if (*this).dyna.bgId == 50 as libc::c_int {
        ...
        osSyncPrintf(b"Warning : move BG \xe7\x99\xbb\xe9\x8c\xb2\xe5\xa4\xb1\xe6\x95\x97(%s %d)(name %d)(arg_data 0x%04x)\n\x00"
                     ...
                     b"../z_bg_spot08_iceblock.c\x00" as *const u8 as
                         *const libc::c_char, 0xd9 as libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_CheckParams(mut this:
                                                          *mut BgSpot08Iceblock) {
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        255 => { (*this).dyna.actor.params = 0x10 as libc::c_int as s16 }
        1 | 4 | 16 | 17 | 18 | 20 | 32 | 35 | 36 => { }
        _ => {
            // "Error: arg_data setting error"
            osSyncPrintf(b"Error : arg_data \xe8\xa8\xad\xe5\xae\x9a\xe3\x83\x9f\xe3\x82\xb9\xe3\x81\xa7\xe3\x81\x99\xe3\x80\x82(%s %d)(arg_data 0x%04x)\n\x00"
                             as *const u8 as *const libc::c_char,
                         b"../z_bg_spot08_iceblock.c\x00" as *const u8 as
                             *const libc::c_char, 0xf6 as libc::c_int,
                         (*this).dyna.actor.params as libc::c_int);
            (*this).dyna.actor.params = 0x10 as libc::c_int as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Bobbing(mut this:
                                                      *mut BgSpot08Iceblock) {
    (*this).bobOffset =
        Math_SinS((*this).bobPhaseSlow) * 4.0f32 +
            Math_SinS((*this).bobPhaseFast) * 3.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SinkUnderPlayer(mut this:
                                                              *mut BgSpot08Iceblock) {
    let mut target: f32_0 = 0.;
    let mut step: f32_0 = 0.;
    match (*this).dyna.actor.params as libc::c_int & 0xf0 as libc::c_int {
        0 => { step = 0.15f32 }
        16 => { step = 0.2f32 }
        32 => { step = 0.4f32 }
        _ => { }
    ...
    target =
        if func_80043548(&mut (*this).dyna) != 0 { -4.0f32 } else { 0.0f32 };
    Math_StepToF(&mut (*this).sinkOffset, target, step);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetWaterline(mut this:
                                                           *mut BgSpot08Iceblock) {
    (*this).dyna.actor.world.pos.y =
        (*this).sinkOffset + (*this).bobOffset +
            (*this).dyna.actor.home.pos.y;
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_MultVectorScalar(mut dest:
                                                               *mut Vec3f,
                                                           mut v: *mut Vec3f,
                                                           mut scale: f32_0) {
    (*dest).x = (*v).x * scale;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_CrossProduct(mut dest: *mut Vec3f,
                                                       mut v1: *mut Vec3f,
                                                       mut v2: *mut Vec3f) {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_NormalizeVector(mut dest:
                                                              *mut Vec3f,
                                                          mut v: *mut Vec3f)
 -> s32 {
    let mut magnitude: f32_0 = 0.;
    magnitude = Math3D_Vec3fMagnitude(v);
    if magnitude < 0.001f32 {
        (*dest).y = 0.0f32;
        (*dest).x = (*dest).y;
        (*dest).z = 1.0f32;
        return 0 as libc::c_int
    } else {
        (*dest).x = (*v).x * (1.0f32 / magnitude);
        (*dest).y = (*v).y * (1.0f32 / magnitude);
        (*dest).z = (*v).z * (1.0f32 / magnitude);
        return 1 as libc::c_int
    };
}
static mut sVerticalVector: Vec3f =
...
static mut sInertias: [f32_0; 3] =
    [1.0f32 / 70000000 as libc::c_int as libc::c_float,
     1.0f32 / 175000000 as libc::c_int as libc::c_float,
     1.0f32 / 700000000 as libc::c_int as libc::c_float];
static mut sDampingFactors: [f32_0; 3] = [0.96f32, 0.96f32, 0.98f32];
static mut sRollSins: [f32_0; 3] =
    [0.22495104f32, 0.22495104f32, 0.03489947f32];
static mut sRollCoss: [f32_0; 3] =
    [0.97437006f32, 0.97437006f32, 0.99939084f32];
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Roll(mut this:
                                                   *mut BgSpot08Iceblock,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut deviationFromVertSq: f32_0 = 0.; // reused with different meanings
    let mut stabilityCorrection: f32_0 = 0.;
    let mut surfaceNormalHorizontal: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut playerCentroidDiff: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut playerMoment: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut surfaceNormalHorizontalScaled: Vec3f =
        Vec3f{x: 0., y: 0., z: 0.,};
    let mut randomNutation: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut tempVec: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut torqueDirection: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut playerCentroidDist: f32_0 = 0.;
    let mut rollDataIndex: s32 = 0;
    ...
    match (*this).dyna.actor.params as libc::c_int & 0xff as libc::c_int {
        17 => {
            // Medium nonrotating
            rollDataIndex = 0 as libc::c_int
        }
        1 => { rollDataIndex = 1 as libc::c_int }
        _ => { rollDataIndex = 2 as libc::c_int }
    } // Large nonrotating
    Math_Vec3f_Diff(&mut (*player).actor.world.pos,
                    &mut (*this).dyna.actor.world.pos,
                    &mut playerCentroidDiff);
    playerCentroidDiff.y -= 150.0f32 * (*this).dyna.actor.scale.y;
    playerCentroidDist = Math3D_Vec3fMagnitude(&mut playerCentroidDiff);
    randomNutation.x =
        (Rand_ZeroOne() - 0.5f32) *
            (1.0f32 / 625 as libc::c_int as libc::c_float);
    randomNutation.y = 0.0f32;
    randomNutation.z =
        (Rand_ZeroOne() - 0.5f32) *
            (1.0f32 / 625 as libc::c_int as libc::c_float);
    surfaceNormalHorizontal.x = (*this).surfaceNormal.x;
    surfaceNormalHorizontal.y = 0.0f32;
    surfaceNormalHorizontal.z = (*this).surfaceNormal.z;
    // If player is standing on it or holding the edge
    if func_8004356C(&mut (*this).dyna) != 0 && playerCentroidDist > 3.0f32 {
        Math_Vec3f_Diff(&mut playerCentroidDiff, &mut surfaceNormalHorizontal,
                        &mut playerMoment);
        BgSpot08Iceblock_MultVectorScalar(&mut playerMoment,
                                          &mut playerMoment,
                                          sInertias[rollDataIndex as usize] *
                                              playerCentroidDist /
                                              (*this).dyna.actor.scale.x);
    } else { playerMoment = sZeroVector }
    BgSpot08Iceblock_MultVectorScalar(&mut surfaceNormalHorizontalScaled,
                                      &mut surfaceNormalHorizontal, -0.01f32);
    // Add all three deviations
    Math_Vec3f_Sum(&mut (*this).normalDelta, &mut playerMoment,
                   &mut (*this).normalDelta);
    Math_Vec3f_Sum(&mut (*this).normalDelta,
                   &mut surfaceNormalHorizontalScaled,
                   &mut (*this).normalDelta);
    Math_Vec3f_Sum(&mut (*this).normalDelta, &mut randomNutation,
                   &mut (*this).normalDelta);
    (*this).normalDelta.y = 0.0f32;
    Math_Vec3f_Sum(&mut (*this).surfaceNormal, &mut (*this).normalDelta,
                   &mut tempVec);
    tempVec.x *= sDampingFactors[rollDataIndex as usize];
    tempVec.z *= sDampingFactors[rollDataIndex as usize];
    // Set up roll axis and final new angle
    if BgSpot08Iceblock_NormalizeVector(&mut (*this).surfaceNormal,
                                        &mut tempVec) != 0 {
        deviationFromVertSq =
            Math3D_Dist1DSq((*this).surfaceNormal.z, (*this).surfaceNormal.x);
        // Prevent overrolling
        if sRollSins[rollDataIndex as usize] < deviationFromVertSq {
            stabilityCorrection =
                sRollSins[rollDataIndex as usize] / deviationFromVertSq;
            (*this).surfaceNormal.x *= stabilityCorrection;
            (*this).surfaceNormal.y = sRollCoss[rollDataIndex as usize];
            (*this).surfaceNormal.z *= stabilityCorrection
        }
        BgSpot08Iceblock_CrossProduct(&mut tempVec, &mut sVerticalVector,
                                      &mut (*this).surfaceNormal);
        if BgSpot08Iceblock_NormalizeVector(&mut torqueDirection,
                                            &mut tempVec) != 0 {
            (*this).rotationAxis = torqueDirection
        }
    } else { (*this).surfaceNormal = sVerticalVector }
    // Rotation by the angle between surfaceNormal and the vertical about rotationAxis
    Matrix_RotateAxis(Math_FAcosF(Math3D_Cos(&mut sVerticalVector,
                                             &mut (*this).surfaceNormal)),
                      &mut (*this).rotationAxis,
    ...
    Matrix_Get(&mut mtx);
    Matrix_MtxFToYXZRotS(&mut mtx, &mut (*this).dyna.actor.shape.rot,
                         0 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SpawnTwinFloe(mut this:
                                                            *mut BgSpot08Iceblock,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    ...
    let mut sin: f32_0 = 0.;
    let mut cos: f32_0 = 0.;
    sin = Math_SinS((*this).dyna.actor.home.rot.y) * 100.0f32;
    cos = Math_CosS((*this).dyna.actor.home.rot.y) * 100.0f32;
    if (*this).dyna.actor.params as libc::c_int & 0x100 as libc::c_int == 0 {
        Actor_SpawnAsChild(&mut (*globalCtx).actorCtx,
                           &mut (*this).dyna.actor, globalCtx,
                           ACTOR_BG_SPOT08_ICEBLOCK as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Init(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgSpot08Iceblock = thisx as *mut BgSpot08Iceblock;
    let mut colHeader: *mut CollisionHeader = 0 as *mut CollisionHeader;
    // "spot08 ice floe"
    osSyncPrintf(b"(spot08 \xe6\xb5\x81\xe6\xb0\xb7)(arg_data 0x%04x)\n\x00"
                     as *const u8 as *const libc::c_char,
                 (*this).dyna.actor.params as libc::c_int);
    BgSpot08Iceblock_CheckParams(this);
    match (*this).dyna.actor.params as libc::c_int & 0x200 as libc::c_int {
        0 => { colHeader = &mut gZorasFountainIcebergCol }
        512 => { colHeader = &mut gZorasFountainIceRampCol }
        _ => { }
    }
    match (*this).dyna.actor.params as libc::c_int & 0xf as libc::c_int {
        2 | 3 => {
            BgSpot08Iceblock_InitDynaPoly(this, globalCtx, colHeader,
    ...
    match (*this).dyna.actor.params as libc::c_int & 0xf0 as libc::c_int {
        0 => { Actor_SetScale(&mut (*this).dyna.actor, 0.2f32); }
        16 => { Actor_SetScale(&mut (*this).dyna.actor, 0.1f32); }
        32 => { Actor_SetScale(&mut (*this).dyna.actor, 0.05f32); }
        _ => { }
    }
    (*this).bobPhaseSlow =
    ...
    (*this).bobPhaseFast =
        (Rand_ZeroOne() * (0xffff as libc::c_int as libc::c_float + 0.5f32))
            as s32 as s16;
    (*this).surfaceNormal.y = 1.0f32;
    (*this).rotationAxis.x = 1.0f32;
    match (*this).dyna.actor.params as libc::c_int & 0xf as libc::c_int {
        0 | 1 => { BgSpot08Iceblock_SetupFloatNonrotating(this); }
        2 => { BgSpot08Iceblock_SetupFloatRotating(this); }
        3 => { BgSpot08Iceblock_SpawnTwinFloe(this, globalCtx); }
        4 => { BgSpot08Iceblock_SetupNoAction(this); }
        _ => { }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Destroy(mut thisx: *mut Actor,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut this: *mut BgSpot08Iceblock = thisx as *mut BgSpot08Iceblock;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetupFloatNonrotating(mut this:
                                                                    *mut BgSpot08Iceblock) {
    BgSpot08Iceblock_SetupAction(this,
                                 Some(BgSpot08Iceblock_FloatNonrotating as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgSpot08Iceblock,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_FloatNonrotating(mut this:
                                                               *mut BgSpot08Iceblock,
                                                           mut globalCtx:
                                                               *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetupFloatRotating(mut this:
                                                                 *mut BgSpot08Iceblock) {
    BgSpot08Iceblock_SetupAction(this,
                                 Some(BgSpot08Iceblock_FloatRotating as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgSpot08Iceblock,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_FloatRotating(mut this:
                                                            *mut BgSpot08Iceblock,
                                                        mut globalCtx:
                                                            *mut GlobalContext) {
    BgSpot08Iceblock_Bobbing(this);
    ...
    (*this).dyna.actor.world.rot.y =
        ((*this).dyna.actor.world.rot.y as libc::c_int + 0x190 as libc::c_int)
            as s16;
    (*this).dyna.actor.shape.rot.y = (*this).dyna.actor.world.rot.y;
    BgSpot08Iceblock_Roll(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetupFloatOrbitingTwins(mut this:
                                                                      *mut BgSpot08Iceblock) {
    BgSpot08Iceblock_SetupAction(this,
                                 Some(BgSpot08Iceblock_FloatOrbitingTwins as
                                          unsafe extern "C" fn(_:
                                                                   *mut BgSpot08Iceblock,
                                                               _:
                                                                   *mut GlobalContext)
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_FloatOrbitingTwins(mut this:
                                                                 *mut BgSpot08Iceblock,
                                                             mut globalCtx:
                                                                 *mut GlobalContext) {
    let mut cos: f32_0 = 0.;
    ...
    if (*this).dyna.actor.params as libc::c_int & 0x100 as libc::c_int == 0 {
        ...
        sin = Math_SinS((*this).dyna.actor.world.rot.y) * 100.0f32;
        cos = Math_CosS((*this).dyna.actor.world.rot.y) * 100.0f32;
        ...
        if !(*this).dyna.actor.child.is_null() {
            (*(*this).dyna.actor.child).world.pos.x =
                (*this).dyna.actor.home.pos.x - sin;
            (*(*this).dyna.actor.child).world.pos.z =
                (*this).dyna.actor.home.pos.z - cos
        }
    }
    (*this).dyna.actor.shape.rot.y = (*this).dyna.actor.home.rot.y;
    BgSpot08Iceblock_Roll(this, globalCtx);
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_SetupNoAction(mut this:
                                                            *mut BgSpot08Iceblock) {
    BgSpot08Iceblock_SetupAction(this, None);
}
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Update(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot08Iceblock = thisx as *mut BgSpot08Iceblock;
    if Rand_ZeroOne() < 0.05f32 {
        ...
        (*this).bobIncrFast =
            Rand_S16Offset(800 as libc::c_int as s16,
                           400 as libc::c_int as s16)
    }
    (*this).bobPhaseSlow =
        ((*this).bobPhaseSlow as libc::c_int +
             (*this).bobIncrSlow as libc::c_int) as s16;
    (*this).bobPhaseFast =
        ((*this).bobPhaseFast as libc::c_int +
             (*this).bobIncrFast as libc::c_int) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot08Iceblock_Draw(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut dList: *mut Gfx = 0 as *mut Gfx;
    let mut this: *mut BgSpot08Iceblock = thisx as *mut BgSpot08Iceblock;
    match (*this).dyna.actor.params as libc::c_int & 0x200 as libc::c_int {
        0 => { dList = gZorasFountainIcebergDL.as_mut_ptr() }
        512 => { dList = gZorasFountainIceRampDL.as_mut_ptr() }
        _ => { }
    }
