...
extern "C" {
    ...
    #[no_mangle]
    static mut gGoronCityDoorDL: [Gfx; 0];
    #[no_mangle]
    static mut gGoronCityDoorCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgSpot18Shutter {
    pub dyna: DynaPolyActor,
    pub actionFunc: BgSpot18ShutterActionFunc,
}
pub type BgSpot18ShutterActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut Bg_Spot18_Shutter_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SPOT18_SHUTTER as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgSpot18Shutter>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Shutter_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Shutter_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Shutter_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSpot18Shutter_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Shutter_Init(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSpot18Shutter = thisx as *mut BgSpot18Shutter;
    let mut param: s32 =
    ...
    if param == 0 as libc::c_int {
        if (if !(gSaveContext.linkAge == 0 as libc::c_int) {
            ...
            if gSaveContext.infTable[16 as libc::c_int as usize] as
                ...
                (*this).actionFunc =
                    Some(func_808B95AC as
                             unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                                  _: *mut GlobalContext)
                                 -> ());
                (*this).dyna.actor.world.pos.y += 180.0f32
            } else {
                (*this).actionFunc =
                    Some(func_808B9618 as
                             unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                                  _: *mut GlobalContext)
                                 -> ())
            }
        ...
        (*this).dyna.actor.world.pos.x +=
            125.0f32 * Math_CosS((*this).dyna.actor.world.rot.y);
        (*this).dyna.actor.world.pos.z -=
            125.0f32 * Math_SinS((*this).dyna.actor.world.rot.y);
        (*this).actionFunc =
            Some(func_808B95AC as
                     unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                          _: *mut GlobalContext) -> ())
    ...
    CollisionHeader_GetVirtual(&mut gGoronCityDoorCol as *mut CollisionHeader
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Shutter_Destroy(mut thisx: *mut Actor,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut this: *mut BgSpot18Shutter = thisx as *mut BgSpot18Shutter;
...
#[no_mangle]
pub unsafe extern "C" fn func_808B95AC(mut this: *mut BgSpot18Shutter,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn func_808B95B8(mut this: *mut BgSpot18Shutter,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).dyna.actor.params as libc::c_int &
                           0x3f as libc::c_int) != 0 {
        Actor_SetFocus(&mut (*this).dyna.actor, 70.0f32);
        OnePointCutscene_Attention(globalCtx, &mut (*this).dyna.actor);
        (*this).actionFunc =
            Some(func_808B9698 as
                     unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_808B9618(mut this: *mut BgSpot18Shutter,
                                       mut globalCtx: *mut GlobalContext) {
    if gSaveContext.infTable[16 as libc::c_int as usize] as libc::c_int &
           0x200 as libc::c_int != 0 {
        Actor_SetFocus(&mut (*this).dyna.actor, 70.0f32);
        if (*this).dyna.actor.params as libc::c_int >> 8 as libc::c_int &
            ...
            (*this).actionFunc =
                Some(func_808B971C as
                         unsafe extern "C" fn(_: *mut BgSpot18Shutter,
                                              _: *mut GlobalContext) -> ());
            OnePointCutscene_Init(globalCtx, 4221 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn func_808B9698(mut this: *mut BgSpot18Shutter,
                                       mut globalCtx: *mut GlobalContext) {
    if Math_StepToF(&mut (*this).dyna.actor.world.pos.y,
                    (*this).dyna.actor.home.pos.y + 180.0f32, 1.44f32) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn func_808B971C(mut this: *mut BgSpot18Shutter,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sin: f32_0 = Math_SinS((*this).dyna.actor.world.rot.y);
    let mut cos: f32_0 = Math_CosS((*this).dyna.actor.world.rot.y);
    let mut flag: s32 = 1 as libc::c_int;
    flag &=
        Math_StepToF(&mut (*this).dyna.actor.world.pos.x,
                     (*this).dyna.actor.home.pos.x + 125.0f32 * cos,
                     fabsf(cos));
    flag &=
        Math_StepToF(&mut (*this).dyna.actor.world.pos.z,
                     (*this).dyna.actor.home.pos.z - 125.0f32 * sin,
                     fabsf(sin));
    if flag != 0 {
        Audio_PlayActorSound2(&mut (*this).dyna.actor,
                              0x2893 as libc::c_int as u16_0);
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Shutter_Update(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgSpot18Shutter = thisx as *mut BgSpot18Shutter;
...
#[no_mangle]
pub unsafe extern "C" fn BgSpot18Shutter_Draw(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    Gfx_DrawDListOpa(globalCtx, gGoronCityDoorDL.as_mut_ptr());
}
