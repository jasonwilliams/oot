...
extern "C" {
    ...
    #[no_mangle]
    static mut gSpiritTrialLightSourceDL: [Gfx; 0];
    #[no_mangle]
    static mut gSpiritTrialLightFloorDL: [Gfx; 0];
    #[no_mangle]
    static mut gSpiritTrialWebDL: [Gfx; 0];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGndSoulmeiro {
    pub actor: Actor,
    pub collider: ColliderCylinder,
    pub unk_198: u16_0,
    pub actionFunc: BgGndSoulmeiroActionFunc,
}
pub type BgGndSoulmeiroActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGndSoulmeiro, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Gnd_Soulmeiro_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GND_SOULMEIRO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgGndSoulmeiro>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndSoulmeiro_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndSoulmeiro_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndSoulmeiro_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndSoulmeiro_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGndSoulmeiro_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndSoulmeiro = thisx as *mut BgGndSoulmeiro;
    ...
    match (*this).actor.params as libc::c_int & 0xff as libc::c_int {
        0 => {
            ...
            (*this).actionFunc =
                Some(func_8087B284 as
                         unsafe extern "C" fn(_: *mut BgGndSoulmeiro,
                                              _: *mut GlobalContext) -> ());
...
#[no_mangle]
pub unsafe extern "C" fn BgGndSoulmeiro_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut this: *mut BgGndSoulmeiro = thisx as *mut BgGndSoulmeiro;
...
#[no_mangle]
pub unsafe extern "C" fn func_8087AF38(mut this: *mut BgGndSoulmeiro,
    ...
    if (*this).unk_198 as libc::c_int != 0 as libc::c_int {
        (*this).unk_198 = (*this).unk_198.wrapping_sub(1)
    }
    if (*this).unk_198 as libc::c_int == 20 as libc::c_int {
    ...
    if (*this).unk_198 == 0 {
        Flags_SetSwitch(globalCtx,
                        (*thisx).params as libc::c_int >> 8 as libc::c_int &
                            0x3f as
                                libc::c_int); // This should be: 0x10000 / 6.0f
        Actor_Kill(&mut (*this).actor);
        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ACTOR_MIR_RAY as libc::c_int as s16, (*thisx).world.pos.x,
                    (*thisx).world.pos.y, (*thisx).world.pos.z,
                    0 as libc::c_int as s16, 0 as libc::c_int as s16,
                    0 as libc::c_int as s16, 9 as libc::c_int as s16);
    } else if (*this).unk_198 as libc::c_int % 6 as libc::c_int ==
                  0 as libc::c_int {
        let mut i: s32 = 0;
        let mut temp_2: s16 = (Rand_ZeroOne() * 10922.0f32) as s16;
        vecA.y = 0.0f32;
        ...
        while i < 6 as libc::c_int {
            let mut temp_1: s16 =
                (Rand_CenteredFloat(0x2800 as libc::c_int as f32_0) +
                     temp_2 as libc::c_int as libc::c_float) as s16;
            let mut temp_3: f32_0 = Math_SinS(temp_1);
            let mut temp_4: f32_0 = Math_CosS(temp_1);
            let mut distXZ: f32_0 = 0.;
            vecB.x = (*thisx).world.pos.x + 120.0f32 * temp_3;
            vecB.z = (*thisx).world.pos.z + 120.0f32 * temp_4;
            distXZ =
                Math_Vec3f_DistXZ(&mut (*thisx).home.pos, &mut vecB) *
                    (1.0f32 / 120.0f32);
            if distXZ < 0.7f32 {
                temp_3 =
                    Math_SinS((temp_1 as libc::c_int + 0x8000 as libc::c_int)
                                  as s16);
                temp_4 =
                    Math_CosS((temp_1 as libc::c_int + 0x8000 as libc::c_int)
                                  as s16);
                vecB.x = (*thisx).world.pos.x + 120.0f32 * temp_3;
                vecB.z = (*thisx).world.pos.z + 120.0f32 * temp_4;
                distXZ =
            ...
            vecA.x = 4.0f32 * temp_3 * distXZ;
            vecA.y = 0.0f32;
            vecA.z = 4.0f32 * temp_4 * distXZ;
            EffectSsDeadDb_Spawn(globalCtx, &mut (*thisx).home.pos, &mut vecA,
                                 &mut zeroVec, 60 as libc::c_int as s16,
                                 ...
                                 0 as libc::c_int as s16,
                                 1 as libc::c_int as s16, 14 as libc::c_int,
                                 1 as libc::c_int as s16);
            temp_2 = (temp_2 as libc::c_int + 0x2aaa as libc::c_int) as s16;
            i += 1
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_8087B284(mut this: *mut BgGndSoulmeiro,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    if Flags_GetSwitch(globalCtx,
        ...
        if (*this).collider.base.acFlags as libc::c_int &
            ...
            Audio_PlaySoundGeneral(0x4802 as libc::c_int as u16_0,
                                   ...
                                   &mut D_801333E8);
            (*this).unk_198 = 40 as libc::c_int as u16_0;
            (*this).actionFunc =
                Some(func_8087AF38 as
                         unsafe extern "C" fn(_: *mut BgGndSoulmeiro,
                                              _: *mut GlobalContext) -> ())
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn func_8087B350(mut this: *mut BgGndSoulmeiro,
                                       mut globalCtx: *mut GlobalContext) {
    if Flags_GetSwitch(globalCtx,
                       (*this).actor.params as libc::c_int >> 8 as libc::c_int
                           & 0x3f as libc::c_int) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndSoulmeiro_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgGndSoulmeiro = thisx as *mut BgGndSoulmeiro;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndSoulmeiro_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    static mut dLists: [*mut Gfx; 3] =
        unsafe {
            [gSpiritTrialWebDL.as_ptr() as *mut _,
             gSpiritTrialLightSourceDL.as_ptr() as *mut _,
             gSpiritTrialLightFloorDL.as_ptr() as *mut _]
        };
    let mut params: s32 =
    ...
    match params {
        0 => {
            ...
            Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                            b"../z_bg_gnd_soulmeiro.c\x00" as *const u8 as
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_0).words.w1 = dLists[params as usize] as libc::c_uint;
            Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                             b"../z_bg_gnd_soulmeiro.c\x00" as *const u8 as
                                 *const libc::c_char, 403 as libc::c_int);
        }
        1 => { Gfx_DrawDListXlu(globalCtx, dLists[params as usize]); }
        2 => { Gfx_DrawDListOpa(globalCtx, dLists[params as usize]); }
        _ => { }
    };
}
