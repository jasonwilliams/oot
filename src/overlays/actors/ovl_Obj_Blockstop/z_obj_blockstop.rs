...
#[no_mangle]
pub static mut Obj_Blockstop_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_OBJ_BLOCKSTOP as libc::c_int as s16,
                          category: ACTORCAT_PROP as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<ObjBlockstop>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBlockstop_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBlockstop_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(ObjBlockstop_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn ObjBlockstop_Init(mut thisx: *mut Actor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut this: *mut ObjBlockstop = thisx as *mut ObjBlockstop;
    if Flags_GetSwitch(globalCtx, (*this).actor.params as s32) != 0 {
        Actor_Kill(&mut (*this).actor);
    } else { (*this).actor.world.pos.y += 1. };
}
#[no_mangle]
pub unsafe extern "C" fn ObjBlockstop_Destroy(mut thisx: *mut Actor,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn ObjBlockstop_Update(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut this: *mut ObjBlockstop = thisx as *mut ObjBlockstop;
    ...
    let mut bgId: s32 = 0;
    let mut pad: s32 = 0;
    if BgCheck_EntityLineTest2(&mut (*globalCtx).colCtx,
                               &mut (*this).actor.home.pos,
                               &mut (*this).actor.world.pos, &mut sp4C,
                               &mut (*this).actor.floorPoly, 0 as libc::c_int,
        ...
        if !dynaPolyActor.is_null() &&
            ...
            if (*dynaPolyActor).actor.params as libc::c_int &
                   0xf as libc::c_int ==
                   PUSHBLOCK_HUGE_START_ON as libc::c_int ||
                   (*dynaPolyActor).actor.params as libc::c_int &
                       0xf as libc::c_int ==
                       PUSHBLOCK_HUGE_START_OFF as libc::c_int {
