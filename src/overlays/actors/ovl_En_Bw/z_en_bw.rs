...
extern "C" {
    ...
    fn Actor_SetColorFilter(actor: *mut Actor, colorFlag: s16,
                            ...
                            duration: s16);
    #[no_mangle]
    fn func_800355E4(globalCtx: *mut GlobalContext, collider: *mut Collider)
     -> u8_0;
    #[no_mangle]
    ...
    fn Actor_SetDropFlag(actor: *mut Actor, colBody: *mut ColliderInfo,
                         freezeFlag: s32);
    #[no_mangle]
    fn BgCheck_AnyLineTest2(colCtx: *mut CollisionContext, posA: *mut Vec3f,
    ...
    #[no_mangle]
    static mut object_bw_Anim_000228: AnimationHeader;
    #[no_mangle]
    static mut object_bw_Skel_0020F0: SkeletonHeader;
    #[no_mangle]
    static mut object_bw_Anim_0021A0: AnimationHeader;
    #[no_mangle]
    static mut object_bw_Anim_002250: AnimationHeader;
}
...
pub struct EnBw {
    ...
    pub unk_222: s16,
    pub unk_224: s16,
    pub actionFunc: EnBwActionFunc,
    pub color1: Color_RGBA8,
    pub unk_230: u8_0,
    pub damageEffect: u8_0,
    pub unk_232: u8_0,
    pub unk_234: s16,
...
pub type EnBwActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnBw, _: *mut GlobalContext) -> ()>;
#[no_mangle]
pub static mut En_Bw_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_BW as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_BW as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnBw>() as libc::c_ulong,
                          init:
...
static mut sSlugGroup: s32 = 0 as libc::c_int;
#[no_mangle]
pub unsafe extern "C" fn EnBw_SetupAction(mut this: *mut EnBw,
                                          mut actionFunc: EnBwActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnBw_Init(mut thisx: *mut Actor,
                                   mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnBw = thisx as *mut EnBw;
    Actor_SetScale(&mut (*this).actor, 0.012999999f32);
    (*this).actor.naviEnemyId = 0x23 as libc::c_int as u8_0;
    (*this).actor.gravity = -2.0f32;
    SkelAnime_Init(globalCtx, &mut (*this).skelAnime,
                   &mut object_bw_Skel_0020F0, &mut object_bw_Anim_000228,
    ...
    func_809CE9A8(this);
    (*this).color1.r = 255 as libc::c_int as u8_0;
    (*this).color1.a = (*this).color1.r;
    (*this).color1.b = 0 as libc::c_int as u8_0;
    (*this).color1.g = (*this).color1.b;
    (*this).unk_248 = 0.6f32;
    (*this).unk_221 = 3 as libc::c_int as u8_0;
    ...
    Collider_SetCylinder(globalCtx, &mut (*this).collider1,
                         &mut (*this).actor,
                         &mut sCylinderInit1); // probably an unused Vec3f
    Collider_SetCylinder(globalCtx, &mut (*this).collider2,
                         &mut (*this).actor, &mut sCylinderInit2);
    (*this).unk_236 = (*this).actor.world.rot.y;
    (*this).actor.params = sSlugGroup as s16;
    sSlugGroup = sSlugGroup + 1 as libc::c_int & 3 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnBw_Destroy(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnBw = thisx as *mut EnBw;
...
#[no_mangle]
pub unsafe extern "C" fn func_809CE884(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    (*this).unk_222 =
        ((*this).unk_222 as libc::c_int - 250 as libc::c_int) as s16;
    (*this).actor.scale.x =
        0.013f32 +
            Math_SinF((*this).unk_222 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0069999998f32;
    (*this).actor.scale.y =
        0.013f32 -
            Math_SinF((*this).unk_222 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0069999998f32;
    (*this).actor.scale.z =
        0.013f32 +
            Math_SinF((*this).unk_222 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0069999998f32;
    if (*this).unk_222 as libc::c_int == 0 as libc::c_int {
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        func_809CE9A8(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CE9A8(mut this: *mut EnBw) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut object_bw_Anim_000228,
                          -2.0f32);
    (*this).unk_220 = 2 as libc::c_int as u8_0;
    (*this).unk_222 = (Rand_ZeroOne() * 200.0f32 + 200.0f32) as s16;
    (*this).unk_232 = 0 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    EnBw_SetupAction(this,
                     Some(func_809CEA24 as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809CEA24(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut sp74: *mut CollisionPoly = 0 as *mut CollisionPoly;
    let mut sp68: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut sp64: u32_0 = 0 as libc::c_int as u32_0;
    let mut sp62: s16 = 0;
    let mut sp60: s16 = 0;
    ...
    (*this).unk_244 = (*this).unk_250 + 0.1f32;
    sp58 = Math_CosF((*this).unk_240);
    (*this).unk_240 += (*this).unk_244;
    if (*this).unk_24C < 0.8f32 { (*this).unk_24C += 0.1f32 }
    (*this).actor.scale.x =
        0.013f32 - Math_SinF((*this).unk_240) * ((*this).unk_24C * 0.004f32);
    (*this).actor.scale.y =
        0.013f32 - Math_SinF((*this).unk_240) * ((*this).unk_24C * 0.004f32);
    (*this).actor.scale.z =
        0.013f32 + Math_SinF((*this).unk_240) * ((*this).unk_24C * 0.004f32);
    sp5C = Math_CosF((*this).unk_240);
    if (*this).unk_232 as libc::c_int == 0 as libc::c_int {
        if (if sp58 >= 0 as libc::c_int as libc::c_float {
                sp58
            } else { -sp58 }) <
               (if sp5C >= 0 as libc::c_int as libc::c_float {
                    sp5C
                } else { -sp5C }) {
            (*this).unk_232 = (*this).unk_232.wrapping_add(1)
        }
    } else if (if sp58 >= 0 as libc::c_int as libc::c_float {
                   sp58
               } else { -sp58 }) >
                  (if sp5C >= 0 as libc::c_int as libc::c_float {
                       sp5C
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3974 as libc::c_int as u16_0);
        (*this).unk_232 = 0 as libc::c_int as u8_0
    }
    sp5C *= (*this).unk_24C * (10.0f32 * (*this).unk_244);
    (*this).actor.speedXZ =
        if sp5C >= 0 as libc::c_int as libc::c_float { sp5C } else { -sp5C };
    if (*this).unk_221 as libc::c_int != 1 as libc::c_int {
        sp58 = Math_SinF((*this).unk_240);
        sp60 =
            ((if sp58 >= 0 as libc::c_int as libc::c_float {
                  sp58
              } else { -sp58 }) * 85.0f32) as s16;
        (*this).color1.g = sp60 as u8_0
    }
    if (*globalCtx).gameplayFrames.wrapping_rem(4 as libc::c_int as
                                                    libc::c_uint) ==
           (*this).actor.params as u32_0 && (*this).actor.speedXZ != 0.0f32 &&
           {
               sp64 =
                   BgCheck_AnyLineTest2(&mut (*globalCtx).colCtx,
                                        &mut (*this).actor.world.pos,
                                        &mut (*this).unk_264, &mut sp68,
                                        &mut sp74, 1 as libc::c_int,
                                        0 as libc::c_int, 0 as libc::c_int,
                                        1 as libc::c_int) as u32_0;
               (sp64) != 0
           } || (*this).unk_222 as libc::c_int == 0 as libc::c_int {
        if !sp74.is_null() {
            sp74 =
                gSegments[((sp74 as u32_0) << 4 as libc::c_int >>
                               28 as libc::c_int) as
                              usize].wrapping_add(sp74 as u32_0 &
            ...
            sp62 =
                (Math_FAtan2F((*sp74).normal.x as f32_0,
                              (*sp74).normal.z as f32_0) *
        ...
        if (*this).unk_236 as libc::c_int != sp62 as libc::c_int ||
               sp64 == 0 as libc::c_int as libc::c_uint {
            if BgCheck_AnyLineTest2(&mut (*globalCtx).colCtx,
                                    &mut (*this).unk_270,
                                    &mut (*this).unk_288, &mut sp68,
                                    &mut sp74, 1 as libc::c_int,
                                    0 as libc::c_int, 0 as libc::c_int,
                                    1 as libc::c_int) != 0 {
                sp64 |= 2 as libc::c_int as libc::c_uint
            }
            if BgCheck_AnyLineTest2(&mut (*globalCtx).colCtx,
                                    &mut (*this).unk_270,
                                    &mut (*this).unk_27C, &mut sp68,
                                    &mut sp74, 1 as libc::c_int,
                                    0 as libc::c_int, 0 as libc::c_int,
                                    1 as libc::c_int) != 0 {
                sp64 |= 4 as libc::c_int as libc::c_uint
            }
            let mut current_block_61: u64;
            match sp64 {
                0 => {
                    (*this).unk_236 =
                        ((*this).unk_236 as libc::c_int +
                             (*this).unk_238 as libc::c_int) as s16;
                    current_block_61 = 14627780020937145761;
                }
                1 => { current_block_61 = 14627780020937145761; }
                2 => {
                    (*this).unk_236 =
                        ((*this).unk_236 as libc::c_int +
                             (*this).unk_238 as libc::c_int) as s16;
                    current_block_61 = 7020230028876087877;
                }
                3 => { current_block_61 = 7020230028876087877; }
                4 => {
                    (*this).unk_236 =
                        ((*this).unk_236 as libc::c_int +
                             (*this).unk_238 as libc::c_int) as s16;
                    current_block_61 = 12985957172377611972;
                }
                5 => { current_block_61 = 12985957172377611972; }
                7 => {
                    (*this).unk_238 = 0 as libc::c_int as s16;
                    current_block_61 = 16779030619667747692;
                }
                _ => { current_block_61 = 16779030619667747692; }
            }
            match current_block_61 {
                14627780020937145761 => {
                    if (*this).unk_221 as libc::c_int == 3 as libc::c_int {
                        if (*globalCtx).gameplayFrames &
                               2 as libc::c_int as libc::c_uint != 0 {
                            (*this).unk_238 = 0x4000 as libc::c_int as s16
                        } else {
                            (*this).unk_238 = -(0x4000 as libc::c_int) as s16
                        }
                    } else {
                        if ((*this).actor.yawTowardsPlayer as libc::c_int -
                               ...
                               s16 as libc::c_int as libc::c_float >= 0.0f32 {
                            (*this).unk_238 = 0x4000 as libc::c_int as s16
                        } else {
                            (*this).unk_238 = -(0x4000 as libc::c_int) as s16
                        }
                ...
                12985957172377611972 => {
                    (*this).unk_238 = -(0x4000 as libc::c_int) as s16
                }
                _ => { }
            }
            if sp64 != 6 as libc::c_int as libc::c_uint {
                (*this).unk_236 = sp62
            }
            (*this).unk_222 = (Rand_ZeroOne() * 200.0f32 + 200.0f32) as s16
        }
                  ...
                  (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int
                      != 0 {
        if (*this).unk_236 as libc::c_int !=
               (*this).actor.wallYaw as libc::c_int {
            sp64 = 1 as libc::c_int as u32_0;
            (*this).unk_236 = (*this).actor.wallYaw;
            if (*this).unk_221 as libc::c_int == 3 as libc::c_int {
                if (*globalCtx).gameplayFrames &
                       0x20 as libc::c_int as libc::c_uint != 0 {
                    (*this).unk_238 = 0x4000 as libc::c_int as s16
                } else { (*this).unk_238 = -(0x4000 as libc::c_int) as s16 }
                (*this).actor.bgCheckFlags =
                    ((*this).actor.bgCheckFlags as libc::c_int &
                         !(8 as libc::c_int)) as u16_0;
                (*this).unk_222 = (Rand_ZeroOne() * 20.0f32 + 160.0f32) as s16
            } else {
                if ((*this).actor.yawTowardsPlayer as libc::c_int -
                        (*this).unk_236 as libc::c_int) as s16 as libc::c_int
                       >= 0 as libc::c_int {
                    (*this).unk_238 = 0x4000 as libc::c_int as s16
                } else { (*this).unk_238 = -(0x4000 as libc::c_int) as s16 }
                if (*this).unk_221 as libc::c_int == 1 as libc::c_int {
                    (*this).unk_238 = -((*this).unk_238 as libc::c_int) as s16
                }
            }
        } else if (*this).unk_221 as libc::c_int == 0 as libc::c_int {
            sp64 =
                BgCheck_AnyLineTest2(&mut (*globalCtx).colCtx,
                                     &mut (*this).actor.world.pos,
                                     &mut (*player).actor.world.pos,
                                     &mut sp68, &mut sp74, 1 as libc::c_int,
                                     0 as libc::c_int, 0 as libc::c_int,
                                     1 as libc::c_int) as u32_0;
            if sp64 != 0 as libc::c_int as libc::c_uint {
                sp74 =
                    gSegments[((sp74 as u32_0) << 4 as libc::c_int >>
                                   28 as libc::c_int) as
                                  usize].wrapping_add(sp74 as u32_0 &
                ...
                sp60 =
                    (Math_FAtan2F((*sp74).normal.x as f32_0,
                         ...
                         (0x8000 as libc::c_int as f32_0 /
                              3.14159265358979323846f32)) as s16;
                if (*this).unk_236 as libc::c_int != sp60 as libc::c_int {
                    if ((*this).actor.yawTowardsPlayer as libc::c_int -
                            sp60 as libc::c_int) as s16 as libc::c_int >=
                           0 as libc::c_int {
                        (*this).unk_238 = 0x4000 as libc::c_int as s16
                    } else {
                        (*this).unk_238 = -(0x4000 as libc::c_int) as s16
    ...
    (*this).unk_222 -= 1;
    if (*this).unk_224 as libc::c_int != 0 as libc::c_int {
        (*this).unk_224 -= 1
    }
    if (*this).unk_234 as libc::c_int == 0 as libc::c_int &&
           Actor_TestFloorInDirection(&mut (*this).actor, globalCtx, 50.0f32,
                                      ((*this).unk_236 as libc::c_int +
                                           (*this).unk_238 as libc::c_int) as
                                          s16) == 0 {
        if (*this).unk_238 as libc::c_int != 0x4000 as libc::c_int {
            (*this).unk_238 = 0x4000 as libc::c_int as s16
        } else { (*this).unk_238 = -(0x4000 as libc::c_int) as s16 }
    }
    match (*this).unk_221 as libc::c_int {
        3 => {
            Math_SmoothStepToF(&mut (*this).unk_248, 0.6f32, 1.0f32, 0.05f32,
                               0.0f32);
            if (*this).unk_224 as libc::c_int == 0 as libc::c_int &&
        ...
        0 => {
            ...
            if (*this).unk_224 as libc::c_int == 0 as libc::c_int ||
                   (if (*this).actor.yDistToPlayer >=
                           0 as libc::c_int as libc::c_float {
                        (*this).actor.yDistToPlayer
                    } else { -(*this).actor.yDistToPlayer }) > 60.0f32 ||
                   (*player2).stateFlags1 &
                       0x6000 as libc::c_int as libc::c_uint != 0 {
                (*this).unk_221 = 3 as libc::c_int as u8_0;
                (*this).unk_224 = 150 as libc::c_int as s16;
                (*this).unk_250 = 0.0f32
            }
        }
        1 => {
            ...
            if (*this).unk_224 as libc::c_int <= 200 as libc::c_int {
                sp60 =
                    (Math_SinS(((*this).unk_224 as libc::c_int *
                                    (0x960 as libc::c_int -
                                         (*this).unk_224 as libc::c_int)) as
                                   s16) * 55.0f32) as s16;
                (*this).color1.r =
                    (255 as libc::c_int -
                         (if sp60 as libc::c_int >= 0 as libc::c_int {
                              sp60 as libc::c_int
                          } else { -(sp60 as libc::c_int) })) as u8_0;
                sp60 =
                    (Math_SinS(((*this).unk_224 as libc::c_int *
                                    (0x960 as libc::c_int -
                                         (*this).unk_224 as libc::c_int)) as
                ...
                (*this).color1.g =
                    ((if sp60 as libc::c_int >= 0 as libc::c_int {
                          sp60 as libc::c_int
                      } else { -(sp60 as libc::c_int) }) + 85 as libc::c_int)
                        as u8_0;
                sp60 =
                    (Math_SinS((0x960 as libc::c_int -
                                    (*this).unk_224 as libc::c_int) as s16) *
                         255.0f32) as s16;
                (*this).color1.b =
                    if sp60 as libc::c_int >= 0 as libc::c_int {
                        sp60 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_809CF72C(mut this: *mut EnBw) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_bw_Anim_0021A0, -2.0f32);
    (*this).unk_220 = 3 as libc::c_int as u8_0;
    (*this).unk_221 = 0 as libc::c_int as u8_0;
    (*this).unk_250 = 0.6f32;
    (*this).unk_222 = 20 as libc::c_int as s16;
    (*this).unk_224 = 0xbb8 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3975 as libc::c_int as u16_0);
    EnBw_SetupAction(this,
                     Some(func_809CF7AC as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809CF7AC(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).unk_222 as libc::c_int > 0 as libc::c_int {
            (*this).unk_222 -= 1
        } else { (*this).unk_222 = 100 as libc::c_int as s16 }
    }
    if (*this).unk_222 as libc::c_int >= 20 as libc::c_int {
        (*this).unk_224 =
            ((*this).unk_224 as libc::c_int - 250 as libc::c_int) as s16
    }
    (*this).actor.scale.x =
        0.013f32 -
            Math_SinF((*this).unk_224 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0034999999f32;
    (*this).actor.scale.y =
        0.013f32 +
            Math_SinF((*this).unk_224 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0245f32;
    ...
    if (*this).unk_224 as libc::c_int == 0 as libc::c_int {
        func_809CE9A8(this);
        (*this).unk_224 = 200 as libc::c_int as s16
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CF8F0(mut this: *mut EnBw) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut object_bw_Anim_002250, -1.0f32);
    (*this).actor.speedXZ = 7.0f32;
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).unk_220 = 4 as libc::c_int as u8_0;
    (*this).unk_222 = 1000 as libc::c_int as s16;
    ...
    EnBw_SetupAction(this,
                     Some(func_809CF984 as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809CF984(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut floorPolyType: s32 = 0;
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    (*this).unk_222 =
        ((*this).unk_222 as libc::c_int + 250 as libc::c_int) as s16;
    ...
    (*this).actor.scale.z =
        0.013f32 -
            Math_SinF((*this).unk_222 as libc::c_int as libc::c_float *
                          0.001f32) * 0.0034999999f32;
    if (*this).collider1.base.atFlags as libc::c_int &
           (1 as libc::c_int) << 1 as libc::c_int != 0 {
        (*this).collider1.base.atFlags =
            ((*this).collider1.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int)) as u8_0;
        (*this).actor.speedXZ = -6.0f32;
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        if &mut (*player).actor as *mut Actor == (*this).collider1.base.at &&
               (*this).collider1.base.atFlags as libc::c_int &
    ...
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
        floorPolyType =
            func_80041D4C(&mut (*globalCtx).colCtx, (*this).actor.floorPoly,
                          (*this).actor.floorBgId as s32) as s32;
        if floorPolyType == 2 as libc::c_int ||
               floorPolyType == 3 as libc::c_int ||
               floorPolyType == 9 as libc::c_int {
            Actor_Kill(&mut (*this).actor);
            return
        }
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).actor.world.pos, 30.0f32,
                                 0xb as libc::c_int, 4.0f32,
                                 0 as libc::c_int as s16,
                                 0 as libc::c_int as s16,
                                 0 as libc::c_int as u8_0);
        (*this).unk_222 = 3000 as libc::c_int as s16;
        (*this).actor.flags &=
            !((1 as libc::c_int) << 24 as libc::c_int) as libc::c_uint;
        (*this).actor.speedXZ = 0.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
...
#[no_mangle]
pub unsafe extern "C" fn func_809CFBA8(mut this: *mut EnBw) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut object_bw_Anim_002250,
                          -1.0f32);
    (*this).unk_220 = 5 as libc::c_int as u8_0;
    (*this).unk_222 = 1000 as libc::c_int as s16;
    (*this).unk_260 = 0.0f32;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 11.0f32;
    (*this).unk_25C = Rand_ZeroOne() * 0.25f32 + 1.0f32;
    (*this).unk_224 = 0xbb8 as libc::c_int as s16;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3976 as libc::c_int as u16_0);
    EnBw_SetupAction(this,
                     Some(func_809CFC4C as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809CFC4C(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    Math_SmoothStepToF(&mut (*this).unk_248, 0.0f32, 1.0f32, 0.05f32, 0.0f32);
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
        if (*globalCtx).gameplayFrames.wrapping_rem(0x80 as libc::c_int as
                                                        libc::c_uint) ==
               0 as libc::c_int as libc::c_uint {
            (*this).unk_25C = Rand_ZeroOne() * 0.25f32 + 0.7f32
        }
        (*this).unk_221 = 4 as libc::c_int as u8_0;
        (*this).unk_258 += (*this).unk_25C;
        Math_SmoothStepToF(&mut (*this).unk_260, 0.075f32, 1.0f32, 0.005f32,
                           0.0f32);
        ...
        (*this).color1.r =
            ((*this).color1.r as libc::c_int - 8 as libc::c_int) as u8_0;
        (*this).color1.g =
            ((*this).color1.g as libc::c_int + 32 as libc::c_int) as u8_0;
        if ((*this).color1.r as libc::c_int) < 200 as libc::c_int {
            (*this).color1.r = 200 as libc::c_int as u8_0
        }
        if (*this).color1.g as libc::c_int > 200 as libc::c_int {
            (*this).color1.g = 200 as libc::c_int as u8_0
        }
        if (*this).color1.b as libc::c_int > 235 as libc::c_int {
            (*this).color1.b = 255 as libc::c_int as u8_0
        } else {
            (*this).color1.b =
                ((*this).color1.b as libc::c_int + 40 as libc::c_int) as u8_0
        }
        if (*this).actor.shape.yOffset < 1000.0f32 {
            (*this).actor.shape.yOffset += 200.0f32
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809CFF10(mut this: *mut EnBw) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut object_bw_Anim_002250,
                          -1.0f32);
    (*this).unk_220 = 6 as libc::c_int as u8_0;
    (*this).unk_222 = 1000 as libc::c_int as s16;
    (*this).unk_221 = 3 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 11.0f32;
    ...
    (*this).actor.bgCheckFlags =
        ((*this).actor.bgCheckFlags as libc::c_int & !(1 as libc::c_int)) as
            u16_0;
    EnBw_SetupAction(this,
                     Some(func_809CFF98 as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809CFF98(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.z,
                       0 as libc::c_int as s16, 1 as libc::c_int as s16,
                       0xfa0 as libc::c_int as s16, 0 as libc::c_int as s16);
    Math_SmoothStepToF(&mut (*this).unk_248, 0.6f32, 1.0f32, 0.05f32, 0.0f32);
    SkelAnime_Update(&mut (*this).skelAnime);
    if (*this).actor.bgCheckFlags as libc::c_int & 3 as libc::c_int != 0 {
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).actor.world.pos, 30.0f32,
                                 ...
                                 0 as libc::c_int as s16,
                                 0 as libc::c_int as u8_0);
        (*this).unk_222 = 0xbb8 as libc::c_int as s16;
        (*this).unk_250 = 0.0f32;
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387b as libc::c_int as u16_0);
        EnBw_SetupAction(this,
    ...
    if ((*this).color1.r as libc::c_int) < 247 as libc::c_int {
        (*this).color1.r =
            ((*this).color1.r as libc::c_int + 8 as libc::c_int) as u8_0
    } else { (*this).color1.r = 255 as libc::c_int as u8_0 }
    if ((*this).color1.g as libc::c_int) < 32 as libc::c_int {
        (*this).color1.g = 0 as libc::c_int as u8_0
    } else {
        (*this).color1.g =
            ((*this).color1.g as libc::c_int - 32 as libc::c_int) as u8_0
    }
    if ((*this).color1.b as libc::c_int) < 40 as libc::c_int {
        (*this).color1.b = 0 as libc::c_int as u8_0
    } else {
        (*this).color1.b =
            ((*this).color1.b as libc::c_int - 40 as libc::c_int) as u8_0
...
#[no_mangle]
pub unsafe extern "C" fn func_809D00F4(mut this: *mut EnBw) {
    (*this).unk_220 = 0 as libc::c_int as u8_0;
    (*this).unk_222 = 40 as libc::c_int as s16;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.speedXZ = 0.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3978 as libc::c_int as u16_0);
    EnBw_SetupAction(this,
                     Some(func_809D014C as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809D014C(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).unk_230 != 0 {
        (*this).actor.scale.x += 0.0002f32;
        (*this).actor.scale.y -= 0.0002f32;
        (*this).actor.scale.z += 0.0002f32
    }
    (*this).color1.a =
        ((*this).color1.a as libc::c_int - 6 as libc::c_int) as u8_0;
    (*this).actor.shape.shadowAlpha = (*this).color1.a;
    (*this).unk_222 -= 1;
    if (*this).unk_222 as libc::c_int <= 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_809D01CC(mut this: *mut EnBw) {
    (*this).unk_220 = 1 as libc::c_int as u8_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).unk_25C = Rand_ZeroOne() * 0.25f32 + 1.0f32;
    (*this).unk_260 = 0.0f32;
    if (*this).damageEffect as libc::c_int == 0xe as libc::c_int {
        (*this).iceTimer = 0x50 as libc::c_int as u8_0
    }
    (*this).unk_222 =
        if (*this).actor.colorFilterParams as libc::c_int &
               0x4000 as libc::c_int != 0 {
            25 as libc::c_int
        } else { 80 as libc::c_int } as s16;
    EnBw_SetupAction(this,
                     Some(func_809D0268 as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809D0268(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    (*this).color1.r =
        ((*this).color1.r as libc::c_int - 1 as libc::c_int) as u8_0;
    (*this).color1.g =
        ((*this).color1.g as libc::c_int + 4 as libc::c_int) as u8_0;
    (*this).color1.b =
        ((*this).color1.b as libc::c_int + 5 as libc::c_int) as u8_0;
    if ((*this).color1.r as libc::c_int) < 200 as libc::c_int {
        (*this).color1.r = 200 as libc::c_int as u8_0
    }
    if (*this).color1.g as libc::c_int > 200 as libc::c_int {
    ...
    if (*this).color1.b as libc::c_int > 230 as libc::c_int {
        (*this).color1.b = 230 as libc::c_int as u8_0
    }
    if (*this).actor.colorFilterParams as libc::c_int & 0x4000 as libc::c_int
           != 0 {
        if (*globalCtx).gameplayFrames.wrapping_rem(0x80 as libc::c_int as
                                                        libc::c_uint) ==
               0 as libc::c_int as libc::c_uint {
            (*this).unk_25C = 0.5f32 + Rand_ZeroOne() * 0.25f32
        }
        (*this).unk_258 += (*this).unk_25C;
        Math_SmoothStepToF(&mut (*this).unk_260, 0.075f32, 1.0f32, 0.005f32,
                           0.0f32);
    ...
    if (*this).unk_222 as libc::c_int == 0 as libc::c_int {
        func_809CE9A8(this);
        (*this).color1.g = 200 as libc::c_int as u8_0;
        (*this).color1.r = (*this).color1.g;
        (*this).color1.b = 255 as libc::c_int as u8_0;
        (*this).unk_224 = 0x258 as libc::c_int as s16;
        (*this).unk_221 = 1 as libc::c_int as u8_0;
        (*this).unk_250 = 0.7f32;
        (*this).unk_236 += 1
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809D03CC(mut this: *mut EnBw) {
    (*this).actor.speedXZ = 0.0f32;
    if (*this).damageEffect as libc::c_int == 0xe as libc::c_int {
        (*this).iceTimer = 32 as libc::c_int as u8_0
    }
    (*this).unk_23C = (*this).actor.colorFilterTimer;
    Audio_PlayActorSound2(&mut (*this).actor, 0x389e as libc::c_int as u16_0);
    EnBw_SetupAction(this,
                     Some(func_809D0424 as
                              unsafe extern "C" fn(_: *mut EnBw,
                                                   _: *mut GlobalContext)
                                  -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn func_809D0424(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.colorFilterTimer as libc::c_int == 0 as libc::c_int {
        (*this).unk_23C = 0 as libc::c_int as u8_0;
        if (*this).actor.colChkInfo.health as libc::c_int != 0 as libc::c_int
           {
            if (*this).unk_220 as libc::c_int != 5 as libc::c_int &&
                   (*this).unk_220 as libc::c_int != 6 as libc::c_int {
                func_809CE9A8(this);
                (*this).color1.g = 200 as libc::c_int as u8_0;
                (*this).color1.r = (*this).color1.g;
                (*this).color1.b = 255 as libc::c_int as u8_0;
                ...
                (*this).unk_250 = 0.7f32;
                (*this).unk_236 += 1
            } else if (*this).unk_220 as libc::c_int != 5 as libc::c_int {
                EnBw_SetupAction(this,
                                 Some(func_809CFF98 as
                                          unsafe extern "C" fn(_: *mut EnBw,
                                                               _:
                                                                   *mut GlobalContext)
                                              -> ()));
            } else { func_809CFF10(this); }
        } else {
            if func_800355E4(globalCtx, &mut (*this).collider2.base) != 0 {
                (*this).unk_230 = 0 as libc::c_int as u8_0;
                (*this).actor.scale.y -= 0.009f32;
                Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                         &mut (*this).actor.world.pos,
                                         30.0f32, 0xb as libc::c_int, 4.0f32,
                                         0 as libc::c_int as s16,
                                         0 as libc::c_int as s16,
                                         0 as libc::c_int as u8_0);
            } else { (*this).unk_230 = 1 as libc::c_int as u8_0 }
...
#[no_mangle]
pub unsafe extern "C" fn func_809D0584(mut this: *mut EnBw,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 0x10 as libc::c_int != 0 &&
        ...
        if (*this).collider2.base.acFlags as libc::c_int &
            ...
            Actor_SetDropFlag(&mut (*this).actor, &mut (*this).collider2.info,
                              0 as libc::c_int);
            if (*this).damageEffect as libc::c_int == 1 as libc::c_int ||
                   (*this).damageEffect as libc::c_int == 0xe as libc::c_int {
                if (*this).unk_23C as libc::c_int == 0 as libc::c_int {
            ...
            if (*this).unk_248 == 0.0f32 {
                Actor_ApplyDamage(&mut (*this).actor);
            }
            if ((*this).unk_221 as libc::c_int == 1 as libc::c_int ||
                    (*this).unk_221 as libc::c_int == 4 as libc::c_int) &&
                   (*this).actor.colChkInfo.health as libc::c_int ==
                       0 as libc::c_int {
                if (*this).unk_220 as libc::c_int != 0 as libc::c_int {
                    Actor_SetColorFilter(&mut (*this).actor,
                                         0x4000 as libc::c_int as s16,
                                         0xff as libc::c_int as s16,
                                         0 as libc::c_int as s16,
                                         8 as libc::c_int as s16);
                    if func_800355E4(globalCtx, &mut (*this).collider2.base)
                           != 0 {
                        (*this).unk_230 = 0 as libc::c_int as u8_0;
                        (*this).actor.scale.y -= 0.009f32;
            ...
            } else if (*this).unk_220 as libc::c_int != 1 as libc::c_int &&
                          (*this).unk_220 as libc::c_int != 6 as libc::c_int {
                Audio_PlayActorSound2(&mut (*this).actor,
                                      0x3977 as libc::c_int as u16_0);
                Actor_SetColorFilter(&mut (*this).actor,
                                     0x4000 as libc::c_int as s16,
                                     0xff as libc::c_int as s16,
                                     0 as libc::c_int as s16,
        ...
        if (*globalCtx).actorCtx.unk_02 as libc::c_int != 0 as libc::c_int &&
            ...
            if (*this).unk_220 as libc::c_int == 5 as libc::c_int {
                (*this).unk_23C = 0 as libc::c_int as u8_0;
                func_809CFF10(this);
            } else if (*this).unk_220 as libc::c_int != 0 as libc::c_int {
                (*this).unk_23C = 0 as libc::c_int as u8_0;
                func_809CFBA8(this);
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnBw_Update(mut thisx: *mut Actor,
    ...
    let mut sp44: Color_RGBA8 =
        {
            let mut init =
                Color_RGBA8{r: 0 as libc::c_int as u8_0,
                            g: 0 as libc::c_int as u8_0,
                            b: 0 as libc::c_int as u8_0,
                            a: 220 as libc::c_int as u8_0,};
            init
        };
    func_809D0584(this, globalCtx);
    if (*thisx).colChkInfo.damageEffect as libc::c_int != 6 as libc::c_int {
        (*this).actionFunc.expect("non-null function pointer")(this,
                                                               globalCtx);
        if (*this).unk_23C as libc::c_int == 0 as libc::c_int {
            (*this).unk_23A =
                ((*this).unk_23A as libc::c_int + 4 as libc::c_int &
                     0x7f as libc::c_int) as u8_0
        }
        if (*globalCtx).gameplayFrames & (*this).unk_221 as libc::c_uint ==
               0 as libc::c_int as libc::c_uint {
            accel.y = -3.0f32;
            velocity.x = Rand_CenteredFloat((*this).unk_248 * 24.0f32);
            velocity.y = (*this).unk_248 * 30.0f32;
            velocity.z = Rand_CenteredFloat((*this).unk_248 * 24.0f32);
            accel.x = velocity.x * -0.075f32;
            accel.z = velocity.z * -0.075f32;
            func_8002836C(globalCtx, &mut (*thisx).world.pos, &mut velocity,
                          &mut accel, &mut sp50, &mut sp4C,
                          0x3c as libc::c_int as s16, 0 as libc::c_int as s16,
                          0x14 as libc::c_int as s16);
        }
        if (*this).unk_248 <= 0.4f32 {
            (*this).collider1.info.toucher.effect = 0 as libc::c_int as u8_0;
            if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint
                   == 0 as libc::c_int as libc::c_uint &&
                   ((*this).unk_220 as libc::c_int) < 5 as libc::c_int &&
                   (*this).unk_23C as libc::c_int == 0 as libc::c_int {
                accel.y = -0.1f32;
                velocity.x = Rand_CenteredFloat(4.0f32);
                velocity.y = Rand_CenteredFloat(2.0f32) + 6.0f32;
                velocity.z = Rand_CenteredFloat(4.0f32);
                accel.x = velocity.x * -0.1f32;
                accel.z = velocity.z * -0.1f32;
                Rand_CenteredFloat(4.0f32);
                Rand_CenteredFloat(4.0f32);
                sp48.a = (*this).color1.a;
                if sp48.a as libc::c_int >= 30 as libc::c_int {
                    sp44.a =
                        (sp48.a as libc::c_int - 30 as libc::c_int) as u8_0
                } else { sp44.a = 0 as libc::c_int as u8_0 }
                func_8002836C(globalCtx, &mut (*thisx).world.pos,
                              &mut velocity, &mut accel, &mut sp48, &mut sp44,
                              0xb4 as libc::c_int as s16,
                              0x28 as libc::c_int as s16,
                              (20.0f32 - (*this).unk_248 * 40.0f32) as s16);
            }
        } else {
            (*this).collider1.info.toucher.effect = 1 as libc::c_int as u8_0
        }
        (*this).unk_234 =
            Actor_TestFloorInDirection(thisx, globalCtx, 50.0f32,
                                       (*thisx).world.rot.y);
        if (*this).unk_220 as libc::c_int == 4 as libc::c_int ||
               (*this).unk_220 as libc::c_int == 6 as libc::c_int ||
               (*this).unk_220 as libc::c_int == 5 as libc::c_int ||
               (*this).unk_220 as libc::c_int == 1 as libc::c_int ||
               (*this).unk_234 as libc::c_int != 0 as libc::c_int {
            Actor_MoveForward(thisx);
        }
        Actor_UpdateBgCheckInfo(globalCtx, thisx, 20.0f32, 30.0f32, 21.0f32,
                                0x1f as libc::c_int);
    }
    Collider_UpdateCylinder(thisx, &mut (*this).collider2);
    ...
    if (*this).unk_221 as libc::c_int != 1 as libc::c_int &&
           ((*this).unk_220 as libc::c_int) < 5 as libc::c_int &&
           (*this).unk_248 > 0.4f32 {
        Collider_UpdateCylinder(thisx, &mut (*this).collider1);
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).collider1.base);
    }
    (*thisx).focus.pos = (*thisx).world.pos;
    (*thisx).focus.pos.y += 5.0f32;
}
#[no_mangle]
pub unsafe extern "C" fn EnBw_OverrideLimbDraw(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut limbIndex: s32,
        ...
        *gfx = (*gfx).offset(1);
        ...
        (*_g).words.w1 =
            Gfx_TwoTexScroll((*globalCtx).state.gfxCtx, 0 as libc::c_int,
                             ...
                             0 as libc::c_int as u32_0,
                             (*this).unk_23A as u32_0, 0x20 as libc::c_int,
                             0x20 as libc::c_int) as libc::c_uint;
        if (*this).unk_220 as libc::c_int == 1 as libc::c_int ||
               (*this).unk_220 as libc::c_int == 5 as libc::c_int {
            Matrix_Push();
            Matrix_Scale(1.0f32, 1.0f32, 1.0f32,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateX((*this).unk_258 * 0.115f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateY((*this).unk_258 * 0.13f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ((*this).unk_258 * 0.1f32,
                           MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_Scale(1.0f32 - (*this).unk_260, 1.0f32 + (*this).unk_260,
                         1.0f32 - (*this).unk_260,
                         MTXMODE_APPLY as libc::c_int as u8_0);
            Matrix_RotateZ(-((*this).unk_258 * 0.1f32),
                           MTXMODE_APPLY as libc::c_int as u8_0);
            ...
            *gfx = (*gfx).offset(1);
            ...
            (*_g_0).words.w1 =
                Matrix_NewMtx((*globalCtx).state.gfxCtx,
                              b"../z_en_bw.c\x00" as *const u8 as
                ...
                (0xde as libc::c_int as u32_0 &
                    ...
                    (0 as libc::c_int as u32_0 &
                         (((0x1 as libc::c_int) << 16 as libc::c_int) -
                              1 as libc::c_int) as libc::c_uint) <<
                        0 as libc::c_int;
            (*_g_1).words.w1 = *dList as libc::c_uint;
            Matrix_Pop();
...
static mut sIceOffsets: [Vec3f; 8] =
    [{ let mut init = Vec3f{x: 20.0f32, y: 10.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: -20.0f32, y: 10.0f32, z: 0.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 10.0f32, z: -25.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 0.0f32, z: 15.0f32,}; init },
     { let mut init = Vec3f{x: 10.0f32, y: 0.0f32, z: -15.0f32,}; init },
     { let mut init = Vec3f{x: 0.0f32, y: 10.0f32, z: 25.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 0.0f32, z: 15.0f32,}; init },
     { let mut init = Vec3f{x: -10.0f32, y: 0.0f32, z: -15.0f32,}; init }];
#[no_mangle]
pub unsafe extern "C" fn EnBw_Draw(mut thisx: *mut Actor,
                                   mut globalCtx2: *mut GlobalContext) {
    let mut spAC: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut globalCtx: *mut GlobalContext = globalCtx2;
    let mut this: *mut EnBw = thisx as *mut EnBw;
    let mut icePos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut iceIndex: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_bw.c\x00" as *const u8 as *const libc::c_char,
                    1423 as libc::c_int);
    if (*this).color1.a as libc::c_int == 0xff as libc::c_int {
        ...
        (*_g).words.w0 =
            (0xfb as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int;
        (*_g).words.w1 =
            ((*this).color1.r as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 24 as libc::c_int
                |
                ((*this).color1.g as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    16 as libc::c_int |
                ((*this).color1.b as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).color1.a as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
            ...
            SkelAnime_Draw(globalCtx, (*this).skelAnime.skeleton,
                           ...
                           Some(EnBw_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                         ...
                                                         _: *mut *mut Gfx)
                                        -> s32), None,
                           this as *mut libc::c_void, (*__gfxCtx).polyOpa.p)
    } else {
    ...
    if (*globalCtx).gameplayFrames.wrapping_add(1 as libc::c_int as
                                                    libc::c_uint).wrapping_rem(4
                                                                                   ...
                                                                                   as
                                                                                   libc::c_uint)
           == (*thisx).params as u32_0 {
        spAC.z = (*thisx).scale.z * 375000.0f32;
        Matrix_MultVec3f(&mut spAC, &mut (*this).unk_264);
        spAC.z = (*thisx).scale.z * 150000.0f32;
        Matrix_MultVec3f(&mut spAC, &mut (*this).unk_270);
        spAC.x = (*thisx).scale.x * 550000.0f32;
        Matrix_MultVec3f(&mut spAC, &mut (*this).unk_288);
        spAC.x = -spAC.x;
        Matrix_MultVec3f(&mut spAC, &mut (*this).unk_27C);
    }
    Matrix_Translate((*thisx).world.pos.x,
                     (*thisx).world.pos.y +
                         ((*thisx).scale.y - 0.013f32) * 1000.0f32,
                     (*thisx).world.pos.z,
    ...
    (*_g_7).words.w1 =
        (255 as libc::c_int as u32_0 &
            ...
            (255 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 8 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    Matrix_Scale((*this).unk_248 * 0.01f32, (*this).unk_248 * 0.01f32,
                 (*this).unk_248 * 0.01f32,
                 MTXMODE_APPLY as libc::c_int as u8_0);
    func_800D1FD4(&mut (*globalCtx).billboardMtxF);
    let fresh12 = (*__gfxCtx).polyXlu.p;
    (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
    let mut _g_8: *mut Gfx = fresh12;
    (*_g_8).words.w0 =
        (0xda as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
    ...
    (*_g_8).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_bw.c\x00" as *const u8 as *const libc::c_char
                          as *mut libc::c_char, 1500 as libc::c_int) as
            libc::c_uint;
    let fresh13 = (*__gfxCtx).polyXlu.p;
    (*__gfxCtx).polyXlu.p = (*__gfxCtx).polyXlu.p.offset(1);
    let mut _g_9: *mut Gfx = fresh13;
    (*_g_9).words.w0 =
        (0xde as libc::c_int as u32_0 &
             (((0x1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
                 as libc::c_uint) << 24 as libc::c_int |
    ...
    if (*this).iceTimer as libc::c_int != 0 as libc::c_int {
        ...
        (*this).iceTimer = (*this).iceTimer.wrapping_sub(1);
        if (*this).iceTimer as libc::c_int & 3 as libc::c_int ==
               0 as libc::c_int {
            iceIndex = (*this).iceTimer as libc::c_int >> 2 as libc::c_int;
            icePos.x =
                sIceOffsets[iceIndex as usize].x + (*thisx).world.pos.x;
            icePos.y =
                sIceOffsets[iceIndex as usize].y + (*thisx).world.pos.y;
            icePos.z =
                sIceOffsets[iceIndex as usize].z + (*thisx).world.pos.z;
            EffectSsEnIce_SpawnFlyingVec3f(globalCtx, thisx, &mut icePos,
                                           0x96 as libc::c_int as s16,
                                           0x96 as libc::c_int as s16,
                                           0x96 as libc::c_int as s16,
                                           0xfa as libc::c_int as s16,
                                           0xeb as libc::c_int as s16,
                                           0xf5 as libc::c_int as s16,
                                           0xff as libc::c_int as s16,
                                           1.3f32);
        }
    }
