...
extern "C" {
    ...
    #[no_mangle]
    fn Flags_GetCollectible(globalCtx: *mut GlobalContext, flag: s32) -> s32;
    #[no_mangle]
    fn Flags_SetCollectible(globalCtx: *mut GlobalContext, flag: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_8002F554(actor: *mut Actor, globalCtx: *mut GlobalContext,
                     getItemId: s32);
    #[no_mangle]
    ...
    #[no_mangle]
    fn func_800946E4(gfx: *mut Gfx) -> *mut Gfx;
    #[no_mangle]
    ...
    #[no_mangle]
    static mut gHeartPieceInteriorDL: [Gfx; 0];
    #[no_mangle]
    static mut gHeartPieceExteriorDL: [Gfx; 0];
    #[no_mangle]
    static mut gHeartContainerInteriorDL: [Gfx; 0];
    #[no_mangle]
    static mut gDropArrows2Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDropArrows1Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDropArrows3Tex: [u64_0; 0];
    #[no_mangle]
    static mut gDropBombTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropRecoveryHeartTex: [u64_0; 0];
    #[no_mangle]
    static mut gItemDropDL: [Gfx; 0];
    #[no_mangle]
    static mut gDropKeySmallTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropMagicSmallTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropDekuNutTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropDekuSeedsTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropDekuStickTex: [u64_0; 0];
    #[no_mangle]
    static mut gDropMagicLargeTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeGreenTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeBlueTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeRedTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeOrangeTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeePinkTex: [u64_0; 0];
    #[no_mangle]
    static mut gRupeeDL: [Gfx; 0];
}
...
pub const ITEM00_BOMBS_SPECIAL: C2RustUnnamed_17 = 25;
pub const ITEM00_TUNIC_GORON: C2RustUnnamed_17 = 24;
pub const ITEM00_TUNIC_ZORA: C2RustUnnamed_17 = 23;
pub const ITEM00_SHIELD_HYLIAN: C2RustUnnamed_17 = 22;
pub const ITEM00_SHIELD_DEKU: C2RustUnnamed_17 = 21;
pub const ITEM00_RUPEE_PURPLE: C2RustUnnamed_17 = 20;
pub const ITEM00_RUPEE_ORANGE: C2RustUnnamed_17 = 19;
pub const ITEM00_FLEXIBLE: C2RustUnnamed_17 = 18;
pub const ITEM00_SMALL_KEY: C2RustUnnamed_17 = 17;
pub const ITEM00_SEEDS: C2RustUnnamed_17 = 16;
pub const ITEM00_MAGIC_SMALL: C2RustUnnamed_17 = 15;
pub const ITEM00_MAGIC_LARGE: C2RustUnnamed_17 = 14;
pub const ITEM00_STICK: C2RustUnnamed_17 = 13;
pub const ITEM00_NUTS: C2RustUnnamed_17 = 12;
pub const ITEM00_BOMBS_B: C2RustUnnamed_17 = 11;
pub const ITEM00_ARROWS_LARGE: C2RustUnnamed_17 = 10;
pub const ITEM00_ARROWS_MEDIUM: C2RustUnnamed_17 = 9;
pub const ITEM00_ARROWS_SMALL: C2RustUnnamed_17 = 8;
pub const ITEM00_HEART_CONTAINER: C2RustUnnamed_17 = 7;
pub const ITEM00_HEART_PIECE: C2RustUnnamed_17 = 6;
pub const ITEM00_ARROWS_SINGLE: C2RustUnnamed_17 = 5;
pub const ITEM00_BOMBS_A: C2RustUnnamed_17 = 4;
pub const ITEM00_HEART: C2RustUnnamed_17 = 3;
pub const ITEM00_RUPEE_RED: C2RustUnnamed_17 = 2;
pub const ITEM00_RUPEE_BLUE: C2RustUnnamed_17 = 1;
pub const ITEM00_RUPEE_GREEN: C2RustUnnamed_17 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct EnItem00 {
    pub actor: Actor,
...
pub const GID_MAX: C2RustUnnamed_23 = 117;
pub const GID_SKULL_TOKEN_2: C2RustUnnamed_23 = 116;
pub const GID_SWORD_KOKIRI: C2RustUnnamed_23 = 115;
pub const GID_BULLET_BAG_50: C2RustUnnamed_23 = 114;
pub const GID_RUPEE_GOLD: C2RustUnnamed_23 = 113;
pub const GID_RUPEE_PURPLE: C2RustUnnamed_23 = 112;
pub const GID_BIG_POE: C2RustUnnamed_23 = 111;
pub const GID_RUPEE_RED: C2RustUnnamed_23 = 110;
pub const GID_RUPEE_BLUE: C2RustUnnamed_23 = 109;
pub const GID_RUPEE_GREEN: C2RustUnnamed_23 = 108;
pub const GID_BULLET_BAG: C2RustUnnamed_23 = 107;
pub const GID_FAIRY: C2RustUnnamed_23 = 106;
pub const GID_POE: C2RustUnnamed_23 = 105;
pub const GID_BUTTERFLY: C2RustUnnamed_23 = 104;
pub const GID_BUG: C2RustUnnamed_23 = 103;
pub const GID_BLUE_FIRE: C2RustUnnamed_23 = 102;
pub const GID_NAYRUS_LOVE: C2RustUnnamed_23 = 101;
pub const GID_FARORES_WIND: C2RustUnnamed_23 = 100;
pub const GID_DINS_FIRE: C2RustUnnamed_23 = 99;
pub const GID_SKULL_TOKEN: C2RustUnnamed_23 = 98;
pub const GID_ARROW_LIGHT: C2RustUnnamed_23 = 97;
pub const GID_ARROW_ICE: C2RustUnnamed_23 = 96;
pub const GID_ARROW_FIRE: C2RustUnnamed_23 = 95;
pub const GID_BOOTS_HOVER: C2RustUnnamed_23 = 94;
pub const GID_COJIRO: C2RustUnnamed_23 = 93;
pub const GID_MASK_GERUDO: C2RustUnnamed_23 = 92;
pub const GID_MASK_ZORA: C2RustUnnamed_23 = 91;
pub const GID_MASK_GORON: C2RustUnnamed_23 = 90;
pub const GID_FROG: C2RustUnnamed_23 = 89;
pub const GID_SOLDOUT: C2RustUnnamed_23 = 88;
pub const GID_BRACELET: C2RustUnnamed_23 = 87;
pub const GID_PRESCRIPTION: C2RustUnnamed_23 = 86;
pub const GID_SWORD_BROKEN: C2RustUnnamed_23 = 85;
pub const GID_CLAIM_CHECK: C2RustUnnamed_23 = 84;
pub const GID_ODD_MUSHROOM: C2RustUnnamed_23 = 83;
pub const GID_ODD_POTION: C2RustUnnamed_23 = 82;
pub const GID_EYEDROPS: C2RustUnnamed_23 = 81;
pub const GID_MASK_TRUTH: C2RustUnnamed_23 = 80;
pub const GID_MASK_BUNNY: C2RustUnnamed_23 = 79;
pub const GID_MASK_SKULL: C2RustUnnamed_23 = 78;
pub const GID_NCOIN_BLUE: C2RustUnnamed_23 = 77;
pub const GID_NCOIN_GREEN: C2RustUnnamed_23 = 76;
pub const GID_NCOIN_RED: C2RustUnnamed_23 = 75;
pub const GID_NCOIN_YELLOW: C2RustUnnamed_23 = 74;
pub const GID_GAUNTLETS_GOLD: C2RustUnnamed_23 = 73;
pub const GID_GAUNTLETS_SILVER: C2RustUnnamed_23 = 72;
pub const GID_SEEDS: C2RustUnnamed_23 = 71;
pub const GID_BOOTS_IRON: C2RustUnnamed_23 = 70;
pub const GID_OCARINA_FAIRY: C2RustUnnamed_23 = 69;
pub const GID_LETTER_RUTO: C2RustUnnamed_23 = 68;
pub const GID_CHICKEN: C2RustUnnamed_23 = 67;
pub const GID_SWORD_BGS: C2RustUnnamed_23 = 66;
pub const GID_GRASS: C2RustUnnamed_23 = 65;
pub const GID_HAMMER: C2RustUnnamed_23 = 64;
pub const GID_SAW: C2RustUnnamed_23 = 63;
pub const GID_FISH: C2RustUnnamed_23 = 62;
pub const GID_BEAN: C2RustUnnamed_23 = 61;
pub const GID_TUNIC_ZORA: C2RustUnnamed_23 = 60;
pub const GID_TUNIC_GORON: C2RustUnnamed_23 = 59;
pub const GID_LETTER_ZELDA: C2RustUnnamed_23 = 58;
pub const GID_SHIELD_MIRROR: C2RustUnnamed_23 = 57;
pub const GID_POTION_BLUE: C2RustUnnamed_23 = 56;
pub const GID_POTION_RED: C2RustUnnamed_23 = 55;
pub const GID_POTION_GREEN: C2RustUnnamed_23 = 54;
pub const GID_LENS: C2RustUnnamed_23 = 53;
pub const GID_BOW: C2RustUnnamed_23 = 52;
pub const GID_BOOMERANG: C2RustUnnamed_23 = 51;
pub const GID_SLINGSHOT: C2RustUnnamed_23 = 50;
pub const GID_MASK_SPOOKY: C2RustUnnamed_23 = 49;
pub const GID_MASK_KEATON: C2RustUnnamed_23 = 48;
pub const GID_MILK: C2RustUnnamed_23 = 47;
pub const GID_OCARINA_TIME: C2RustUnnamed_23 = 46;
pub const GID_LONGSHOT: C2RustUnnamed_23 = 45;
pub const GID_HOOKSHOT: C2RustUnnamed_23 = 44;
pub const GID_SHIELD_HYLIAN: C2RustUnnamed_23 = 43;
pub const GID_SCALE_GOLDEN: C2RustUnnamed_23 = 42;
pub const GID_SCALE_SILVER: C2RustUnnamed_23 = 41;
pub const GID_EGG: C2RustUnnamed_23 = 40;
pub const GID_BOMBCHU: C2RustUnnamed_23 = 39;
pub const GID_ARROWS_LARGE: C2RustUnnamed_23 = 38;
pub const GID_ARROWS_MEDIUM: C2RustUnnamed_23 = 37;
pub const GID_ARROWS_SMALL: C2RustUnnamed_23 = 36;
pub const GID_GERUDO_CARD: C2RustUnnamed_23 = 35;
pub const GID_WALLET_GIANT: C2RustUnnamed_23 = 34;
pub const GID_WALLET_ADULT: C2RustUnnamed_23 = 33;
pub const GID_STONE_OF_AGONY: C2RustUnnamed_23 = 32;
pub const GID_BOMB: C2RustUnnamed_23 = 31;
pub const GID_MAGIC_LARGE: C2RustUnnamed_23 = 30;
pub const GID_MAGIC_SMALL: C2RustUnnamed_23 = 29;
pub const GID_SHIELD_DEKU: C2RustUnnamed_23 = 28;
pub const GID_DUNGEON_MAP: C2RustUnnamed_23 = 27;
pub const GID_STICK: C2RustUnnamed_23 = 26;
pub const GID_BOMB_BAG_40: C2RustUnnamed_23 = 25;
pub const GID_BOMB_BAG_30: C2RustUnnamed_23 = 24;
pub const GID_BOMB_BAG_20: C2RustUnnamed_23 = 23;
pub const GID_QUIVER_50: C2RustUnnamed_23 = 22;
pub const GID_QUIVER_40: C2RustUnnamed_23 = 21;
pub const GID_QUIVER_30: C2RustUnnamed_23 = 20;
pub const GID_HEART_PIECE: C2RustUnnamed_23 = 19;
pub const GID_HEART_CONTAINER: C2RustUnnamed_23 = 18;
pub const GID_NUTS: C2RustUnnamed_23 = 17;
pub const GID_MEDALLION_LIGHT: C2RustUnnamed_23 = 16;
pub const GID_MEDALLION_SHADOW: C2RustUnnamed_23 = 15;
pub const GID_MEDALLION_SPIRIT: C2RustUnnamed_23 = 14;
pub const GID_MEDALLION_WATER: C2RustUnnamed_23 = 13;
pub const GID_MEDALLION_FIRE: C2RustUnnamed_23 = 12;
pub const GID_MEDALLION_FOREST: C2RustUnnamed_23 = 11;
pub const GID_COMPASS: C2RustUnnamed_23 = 10;
pub const GID_KEY_BOSS: C2RustUnnamed_23 = 9;
pub const GID_HEART: C2RustUnnamed_23 = 8;
pub const GID_SONG_PRELUDE: C2RustUnnamed_23 = 7;
pub const GID_SONG_NOCTURNE: C2RustUnnamed_23 = 6;
pub const GID_SONG_REQUIEM: C2RustUnnamed_23 = 5;
pub const GID_SONG_SERENADE: C2RustUnnamed_23 = 4;
pub const GID_SONG_BOLERO: C2RustUnnamed_23 = 3;
pub const GID_SONG_MINUET: C2RustUnnamed_23 = 2;
pub const GID_KEY_SMALL: C2RustUnnamed_23 = 1;
pub const GID_BOTTLE: C2RustUnnamed_23 = 0;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
...
pub const ICHAINTYPE_VEC3S: C2RustUnnamed_24 = 10;
pub const ICHAINTYPE_VEC3F_DIV1000: C2RustUnnamed_24 = 9;
pub const ICHAINTYPE_VEC3F: C2RustUnnamed_24 = 8;
pub const ICHAINTYPE_F32_DIV1000: C2RustUnnamed_24 = 7;
pub const ICHAINTYPE_F32: C2RustUnnamed_24 = 6;
pub const ICHAINTYPE_S32: C2RustUnnamed_24 = 5;
pub const ICHAINTYPE_U32: C2RustUnnamed_24 = 4;
pub const ICHAINTYPE_S16: C2RustUnnamed_24 = 3;
pub const ICHAINTYPE_U16: C2RustUnnamed_24 = 2;
pub const ICHAINTYPE_S8: C2RustUnnamed_24 = 1;
pub const ICHAINTYPE_U8: C2RustUnnamed_24 = 0;
...
pub const FAIRY_HEAL_TIMED: C2RustUnnamed_27 = 2;
pub type C2RustUnnamed_27 = libc::c_uint;
pub const FAIRY_HEAL_BIG: C2RustUnnamed_27 = 7;
pub const FAIRY_HEAL: C2RustUnnamed_27 = 6;
pub const FAIRY_REVIVE_DEATH: C2RustUnnamed_27 = 5;
pub const FAIRY_SPAWNER: C2RustUnnamed_27 = 4;
pub const FAIRY_KOKIRI: C2RustUnnamed_27 = 3;
pub const FAIRY_REVIVE_BOTTLE: C2RustUnnamed_27 = 1;
pub const FAIRY_NAVI: C2RustUnnamed_27 = 0;
#[no_mangle]
pub static mut En_Item00_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_ITEM00 as libc::c_int as s16,
                          category: ACTORCAT_MISC as libc::c_int as u8_0,
                          flags: 0 as libc::c_int as u32_0,
                          objectId:
                              OBJECT_GAMEPLAY_KEEP as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnItem00>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnItem00_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnItem00_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sEffectPrimColor: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 255 as libc::c_int as u8_0,
                        g: 255 as libc::c_int as u8_0,
                        b: 127 as libc::c_int as u8_0,
                        a: 0 as libc::c_int as u8_0,};
        init
    };
static mut sEffectEnvColor: Color_RGBA8 =
    {
        let mut init =
            Color_RGBA8{r: 255 as libc::c_int as u8_0,
                        g: 255 as libc::c_int as u8_0,
...
static mut sEffectVelocity: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.1f32, z: 0.0f32,}; init };
static mut sEffectAccel: Vec3f =
    { let mut init = Vec3f{x: 0.0f32, y: 0.01f32, z: 0.0f32,}; init };
static mut sRupeeTex: [*mut libc::c_void; 5] =
    unsafe {
        [gRupeeGreenTex.as_ptr() as *mut _ as *mut libc::c_void,
         gRupeeBlueTex.as_ptr() as *mut _ as *mut libc::c_void,
         gRupeeRedTex.as_ptr() as *mut _ as *mut libc::c_void,
         gRupeePinkTex.as_ptr() as *mut _ as *mut libc::c_void,
         gRupeeOrangeTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sItemDropTex: [*mut libc::c_void; 12] =
    unsafe {
        [gDropRecoveryHeartTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropBombTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropArrows1Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropArrows2Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropArrows3Tex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropBombTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropDekuNutTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropDekuStickTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropMagicLargeTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropMagicSmallTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropDekuSeedsTex.as_ptr() as *mut _ as *mut libc::c_void,
         gDropKeySmallTex.as_ptr() as *mut _ as *mut libc::c_void]
    };
static mut sItemDropIds: [u8_0; 240] =
    [ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_BOMBS_A as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_BOMBS_A as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_NUTS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     ITEM00_NUTS as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_FLEXIBLE as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0,
     ITEM00_BOMBS_A as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_BOMBS_A as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ...
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ...
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_BOMBS_A as libc::c_int as u8_0,
     ITEM00_ARROWS_SMALL as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_ARROWS_MEDIUM as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_MAGIC_LARGE as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_RUPEE_GREEN as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0,
     ...
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_MAGIC_SMALL as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_MAGIC_LARGE as libc::c_int as u8_0,
     ITEM00_ARROWS_LARGE as libc::c_int as u8_0,
     ITEM00_ARROWS_MEDIUM as libc::c_int as u8_0,
     ITEM00_ARROWS_MEDIUM as libc::c_int as u8_0,
     ITEM00_ARROWS_SMALL as libc::c_int as u8_0,
     ITEM00_ARROWS_SMALL as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0,
     ITEM00_ARROWS_SMALL as libc::c_int as u8_0,
     ITEM00_ARROWS_SMALL as libc::c_int as u8_0,
     ...
     ITEM00_HEART as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, ITEM00_HEART as libc::c_int as u8_0,
     ITEM00_RUPEE_RED as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ITEM00_RUPEE_RED as libc::c_int as u8_0,
     ITEM00_RUPEE_BLUE as libc::c_int as u8_0,
     ...
     ITEM00_SEEDS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_NUTS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_STICK as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_NUTS as libc::c_int as u8_0,
     0xff as libc::c_int as u8_0, ITEM00_NUTS as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, ITEM00_SEEDS as libc::c_int as u8_0,
     ITEM00_HEART as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ITEM00_SEEDS as libc::c_int as u8_0, 0xff as libc::c_int as u8_0,
     ...
     ITEM00_SEEDS as libc::c_int as u8_0,
     ITEM00_FLEXIBLE as libc::c_int as u8_0];
static mut sDropQuantities: [u8_0; 244] =
    [1 as libc::c_int as u8_0, 1 as libc::c_int as u8_0,
     ...
     0 as libc::c_int as u8_0, 0 as libc::c_int as u8_0];
#[no_mangle]
pub unsafe extern "C" fn EnItem00_SetupAction(mut this: *mut EnItem00,
                                              mut actionFunc:
                                                  EnItem00ActionFunc) {
    (*this).actionFunc = actionFunc;
}
#[no_mangle]
pub unsafe extern "C" fn EnItem00_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnItem00 = thisx as *mut EnItem00;
    let mut pad: s32 = 0;
    let mut yOffset: f32_0 = 980.0f32;
    let mut shadowScale: f32_0 = 6.0f32;
    let mut getItemId: s32 = GI_NONE as libc::c_int;
    let mut spawnParam8000: s16 =
        ((*this).actor.params as libc::c_int & 0x8000 as libc::c_int) as s16;
    let mut pad1: s32 = 0;
    (*this).collectibleFlag =
        (((*this).actor.params as libc::c_int & 0x3f00 as libc::c_int) >>
             8 as libc::c_int) as s16;
    (*this).actor.params =
        ((*this).actor.params as libc::c_int & 0xff as libc::c_int) as s16;
    if Flags_GetCollectible(globalCtx, (*this).collectibleFlag as s32) != 0 {
    ...
    match (*this).actor.params as libc::c_int {
        ...
        6 => {
            (*this).unk_158 = 0 as libc::c_int as s16;
            yOffset = 650.0f32;
            Actor_SetScale(&mut (*this).actor, 0.02f32);
            (*this).scale = 0.02f32
        }
        3 => {
            (*this).actor.home.rot.z = Rand_CenteredFloat(65535.0f32) as s16;
            yOffset = 430.0f32;
            Actor_SetScale(&mut (*this).actor, 0.02f32);
            (*this).scale = 0.02f32
        }
        ...
        8 | 9 | 10 => {
            Actor_SetScale(&mut (*this).actor, 0.035f32);
            (*this).scale = 0.035f32;
            yOffset = 250.0f32
        }
        4 | 11 | 12 | 13 | 15 | 16 | 25 => {
        ...
        14 => {
            Actor_SetScale(&mut (*this).actor,
                           (0.045f64 - 1e-10f64) as f32_0);
            (*this).scale = (0.045f64 - 1e-10f64) as f32_0;
            yOffset = 320.0f32
        }
        19 => {
            Actor_SetScale(&mut (*this).actor,
        ...
        21 => {
            (*this).actor.objBankIndex =
                Object_GetIndex(&mut (*globalCtx).objectCtx,
                                OBJECT_GI_SHIELD_1 as libc::c_int as s16) as
                    s8;
            Actor_SetObjectDependency(globalCtx, &mut (*this).actor);
            Actor_SetScale(&mut (*this).actor, 0.5f32);
            (*this).scale = 0.5f32;
            yOffset = 0.0f32;
            shadowScale = 0.6f32;
        ...
        22 => {
            (*this).actor.objBankIndex =
                Object_GetIndex(&mut (*globalCtx).objectCtx,
                                OBJECT_GI_SHIELD_2 as libc::c_int as s16) as
                    s8;
            Actor_SetObjectDependency(globalCtx, &mut (*this).actor);
            Actor_SetScale(&mut (*this).actor, 0.5f32);
            (*this).scale = 0.5f32;
        ...
        23 | 24 => {
            (*this).actor.objBankIndex =
                Object_GetIndex(&mut (*globalCtx).objectCtx,
                                OBJECT_GI_CLOTHES as libc::c_int as s16) as
                    s8;
            Actor_SetObjectDependency(globalCtx, &mut (*this).actor);
            Actor_SetScale(&mut (*this).actor, 0.5f32);
            (*this).scale = 0.5f32;
    ...
    (*this).unk_156 = 0 as libc::c_int as s16;
    ActorShape_Init(&mut (*this).actor.shape, yOffset,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), shadowScale);
    (*this).actor.shape.shadowAlpha = 180 as libc::c_int as u8_0;
    (*this).actor.focus.pos = (*this).actor.world.pos;
    (*this).getItemId = GI_NONE as libc::c_int as s16;
    if spawnParam8000 == 0 {
        EnItem00_SetupAction(this,
                             Some(func_8001DFC8 as
                                      unsafe extern "C" fn(_: *mut EnItem00,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
        (*this).unk_15A = -(1 as libc::c_int) as s16;
        return
    }
    (*this).unk_15A = 15 as libc::c_int as s16;
    (*this).unk_154 = 35 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.gravity = 0.0f32;
    match (*this).actor.params as libc::c_int {
        0 => {
            Item_Give(globalCtx, ITEM_RUPEE_GREEN as libc::c_int as u8_0);
        }
        1 => { Item_Give(globalCtx, ITEM_RUPEE_BLUE as libc::c_int as u8_0); }
        2 => { Item_Give(globalCtx, ITEM_RUPEE_RED as libc::c_int as u8_0); }
        20 => {
            Item_Give(globalCtx, ITEM_RUPEE_PURPLE as libc::c_int as u8_0);
        }
        19 => {
            Item_Give(globalCtx, ITEM_RUPEE_GOLD as libc::c_int as u8_0);
        }
        3 => { Item_Give(globalCtx, ITEM_HEART as libc::c_int as u8_0); }
        18 => { Health_ChangeBy(globalCtx, 0x70 as libc::c_int as s16); }
        4 | 11 => {
            Item_Give(globalCtx, ITEM_BOMBS_5 as libc::c_int as u8_0);
        }
        5 => { Item_Give(globalCtx, ITEM_BOW as libc::c_int as u8_0); }
        8 => {
            Item_Give(globalCtx, ITEM_ARROWS_SMALL as libc::c_int as u8_0);
        }
        9 => {
            Item_Give(globalCtx, ITEM_ARROWS_MEDIUM as libc::c_int as u8_0);
        }
        10 => {
            Item_Give(globalCtx, ITEM_ARROWS_LARGE as libc::c_int as u8_0);
        }
        14 => { getItemId = GI_MAGIC_SMALL as libc::c_int }
        15 => { getItemId = GI_MAGIC_LARGE as libc::c_int }
        17 => { Item_Give(globalCtx, ITEM_KEY_SMALL as libc::c_int as u8_0); }
        16 => { getItemId = GI_SEEDS_5 as libc::c_int }
        12 => { getItemId = GI_NUTS_5 as libc::c_int }
        13 => { getItemId = GI_STICKS_1 as libc::c_int }
        6 | 7 | 21 | 22 | 23 | 24 | 25 | _ => { }
    }
    if getItemId != GI_NONE as libc::c_int &&
           Actor_HasParent(&mut (*this).actor, globalCtx) == 0 {
        func_8002F554(&mut (*this).actor, globalCtx, getItemId);
    }
    EnItem00_SetupAction(this,
                         Some(func_8001E5C8 as
                                  unsafe extern "C" fn(_: *mut EnItem00,
                                                       _: *mut GlobalContext)
                                      -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn EnItem00_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnItem00 = thisx as *mut EnItem00;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn func_8001DFC8(mut this: *mut EnItem00,
                                       mut globalCtx: *mut GlobalContext) {
    if (*this).actor.params as libc::c_int <= ITEM00_RUPEE_RED as libc::c_int
           ||
           (*this).actor.params as libc::c_int == ITEM00_HEART as libc::c_int
               && ((*this).unk_15A as libc::c_int) < 0 as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               ITEM00_HEART_PIECE as libc::c_int {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 960 as libc::c_int) as
                s16
    } else if (*this).actor.params as libc::c_int >=
                  ITEM00_SHIELD_DEKU as libc::c_int &&
                  (*this).actor.params as libc::c_int !=
                      ITEM00_BOMBS_SPECIAL as libc::c_int {
        if (*this).unk_15A as libc::c_int == -(1 as libc::c_int) {
            if Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                                  ((*this).actor.world.rot.x as libc::c_int -
                                       0x4000 as libc::c_int) as s16,
                                  2 as libc::c_int as s16,
                                  3000 as libc::c_int as s16,
                                  1500 as libc::c_int as s16) as libc::c_int
                   == 0 as libc::c_int {
                (*this).unk_15A = -(2 as libc::c_int) as s16
            }
        } else if Math_SmoothStepToS(&mut (*this).actor.shape.rot.x,
                                     (-((*this).actor.world.rot.x as
                                            libc::c_int) -
                                          0x4000 as libc::c_int) as s16,
                                     2 as libc::c_int as s16,
                                     3000 as libc::c_int as s16,
                                     1500 as libc::c_int as s16) as
                      libc::c_int == 0 as libc::c_int {
            (*this).unk_15A = -(1 as libc::c_int) as s16
        }
        Math_SmoothStepToS(&mut (*this).actor.world.rot.x,
                           0 as libc::c_int as s16, 2 as libc::c_int as s16,
                           2500 as libc::c_int as s16,
                           500 as libc::c_int as s16);
    }
    if (*this).actor.params as libc::c_int ==
           ITEM00_HEART_PIECE as libc::c_int {
        (*this).actor.shape.yOffset =
            Math_SinS((*this).actor.shape.rot.y) * 150.0f32 + 850.0f32
    }
    Math_SmoothStepToF(&mut (*this).actor.speedXZ, 0.0f32, 1.0f32, 0.5f32,
                       0.0f32);
    if (*this).unk_154 as libc::c_int == 0 as libc::c_int {
        if (*this).actor.params as libc::c_int !=
               ITEM00_SMALL_KEY as libc::c_int &&
               (*this).actor.params as libc::c_int !=
                   ITEM00_HEART_PIECE as libc::c_int &&
               (*this).actor.params as libc::c_int !=
                   ITEM00_HEART_CONTAINER as libc::c_int {
            (*this).unk_154 = -(1 as libc::c_int) as s16
        }
    }
    if (*this).unk_15A as libc::c_int == 0 as libc::c_int {
        if (*this).actor.params as libc::c_int !=
               ITEM00_SMALL_KEY as libc::c_int &&
               (*this).actor.params as libc::c_int !=
                   ITEM00_HEART_PIECE as libc::c_int &&
    ...
    if (*this).actor.gravity != 0.0f32 &&
           (*this).actor.bgCheckFlags as libc::c_int & 0x1 as libc::c_int == 0
       {
        EnItem00_SetupAction(this,
                             Some(func_8001E1C8 as
                                      unsafe extern "C" fn(_: *mut EnItem00,
                                                           _:
                                                               *mut GlobalContext)
                                          -> ()));
...
#[no_mangle]
pub unsafe extern "C" fn func_8001E1C8(mut this: *mut EnItem00,
                                       mut globalCtx: *mut GlobalContext) {
    let mut originalVelocity: f32_0 = 0.;
    ...
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint != 0 {
        effectPos.x = (*this).actor.world.pos.x + Rand_CenteredFloat(10.0f32);
        effectPos.y = (*this).actor.world.pos.y + Rand_CenteredFloat(10.0f32);
        effectPos.z = (*this).actor.world.pos.z + Rand_CenteredFloat(10.0f32);
        EffectSsKiraKira_SpawnSmall(globalCtx, &mut effectPos,
                                    &mut sEffectVelocity, &mut sEffectAccel,
                                    &mut sEffectPrimColor,
                                    &mut sEffectEnvColor);
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 0x3 as libc::c_int != 0 {
        originalVelocity = (*this).actor.velocity.y;
        if originalVelocity > -2.0f32 {
            EnItem00_SetupAction(this,
                                 Some(func_8001DFC8 as
                                          unsafe extern "C" fn(_:
                                                                   *mut EnItem00,
            ...
            (*this).actor.velocity.y = originalVelocity * -0.8f32;
...
#[no_mangle]
pub unsafe extern "C" fn func_8001E304(mut this: *mut EnItem00,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut pos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut rotOffset: s32 = 0;
    (*this).unk_15A += 1;
    if (*this).actor.params as libc::c_int == ITEM00_HEART as libc::c_int {
        if (*this).actor.velocity.y < 0.0f32 {
            (*this).actor.speedXZ = 0.0f32;
            (*this).actor.gravity = -0.4f32;
            if (*this).actor.velocity.y < -1.5f32 {
                (*this).actor.velocity.y = -1.5f32
            }
            (*this).actor.home.rot.z =
                ((*this).actor.home.rot.z as libc::c_int +
                     (((*this).actor.velocity.y + 3.0f32) * 1000.0f32) as s16
                         as libc::c_int) as s16;
            (*this).actor.world.pos.x +=
                Math_CosS((*this).actor.yawTowardsPlayer) *
                    (-3.0f32 * Math_CosS((*this).actor.home.rot.z));
            (*this).actor.world.pos.z +=
                Math_SinS((*this).actor.yawTowardsPlayer) *
                    (-3.0f32 * Math_CosS((*this).actor.home.rot.z))
        }
    }
    if (*this).actor.params as libc::c_int <= ITEM00_RUPEE_RED as libc::c_int
       {
        ...
        (*this).actor.world.rot.x =
            ((*this).actor.world.rot.x as libc::c_int - 700 as libc::c_int) as
                s16;
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 400 as libc::c_int) as
                s16;
        (*this).actor.shape.rot.x =
            ((*this).actor.world.rot.x as libc::c_int - 0x4000 as libc::c_int)
                as s16
    }
    if (*this).actor.velocity.y <= 2.0f32 {
        rotOffset =
            (*this).actor.shape.rot.z as u16_0 as libc::c_int +
                10000 as libc::c_int;
        if rotOffset < 65535 as libc::c_int {
            (*this).actor.shape.rot.z =
                ((*this).actor.shape.rot.z as libc::c_int +
                     10000 as libc::c_int) as s16
        } else { (*this).actor.shape.rot.z = -(1 as libc::c_int) as s16 }
    }
    if (*globalCtx).gameplayFrames & 1 as libc::c_int as libc::c_uint == 0 {
        pos.x =
            (*this).actor.world.pos.x + (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        pos.y =
            (*this).actor.world.pos.y + (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        pos.z =
            (*this).actor.world.pos.z + (Rand_ZeroOne() - 0.5f32) * 10.0f32;
        EffectSsKiraKira_SpawnSmall(globalCtx, &mut pos, &mut sEffectVelocity,
                                    &mut sEffectAccel, &mut sEffectPrimColor,
                                    &mut sEffectEnvColor);
    }
    if (*this).actor.bgCheckFlags as libc::c_int & 0x3 as libc::c_int != 0 {
        EnItem00_SetupAction(this,
...
#[no_mangle]
pub unsafe extern "C" fn func_8001E5C8(mut this: *mut EnItem00,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    if (*this).getItemId as libc::c_int != GI_NONE as libc::c_int {
        if Actor_HasParent(&mut (*this).actor, globalCtx) == 0 {
            func_8002F434(&mut (*this).actor, globalCtx,
                          (*this).getItemId as s32, 50.0f32, 80.0f32);
            (*this).unk_15A += 1
        } else { (*this).getItemId = GI_NONE as libc::c_int as s16 }
    }
    if (*this).unk_15A as libc::c_int == 0 as libc::c_int {
        Actor_Kill(&mut (*this).actor);
        return
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 960 as libc::c_int) as
                s16
                  ...
                  ITEM00_HEART as libc::c_int {
        (*this).actor.shape.rot.y = 0 as libc::c_int as s16
    }
    (*this).actor.world.pos.y +=
        40.0f32 +
            Math_SinS(((*this).unk_15A as libc::c_int * 15000 as libc::c_int)
                          as s16) *
                ((*this).unk_15A as libc::c_int as libc::c_float * 0.3f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnItem00_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    static mut D_80157D90: u32_0 = 0;
    static mut D_80157D94: [s16; 1] = [0; 1];
    let mut params: *mut s16 = 0 as *mut s16;
    let mut dynaActor: *mut Actor = 0 as *mut Actor;
    let mut getItemId: s32 = GI_NONE as libc::c_int;
    let mut sp3A: s16 = 0 as libc::c_int as s16;
    let mut i: s16 = 0;
    let mut temp: *mut u32_0 = 0 as *mut u32_0;
    let mut this: *mut EnItem00 = thisx as *mut EnItem00;
    let mut pad: s32 = 0;
    if (*this).unk_15A as libc::c_int > 0 as libc::c_int {
        (*this).unk_15A -= 1
    ...
    if (*this).unk_15A as libc::c_int > 0 as libc::c_int &&
           ((*this).unk_15A as libc::c_int) < 41 as libc::c_int &&
           (*this).unk_154 as libc::c_int <= 0 as libc::c_int {
        (*this).unk_156 = (*this).unk_15A
    }
    (*this).actionFunc.expect("non-null function pointer")(this, globalCtx);
    Math_SmoothStepToF(&mut (*this).actor.scale.x, (*this).scale, 0.1f32,
                       (*this).scale * 0.1f32, 0.0f32);
    temp = &mut D_80157D90;
    (*this).actor.scale.z = (*this).actor.scale.x;
    (*this).actor.scale.y = (*this).actor.scale.x;
    if (*this).actor.gravity != 0. {
        if (*this).actor.bgCheckFlags as libc::c_int & 0x3 as libc::c_int != 0
           {
            if *temp != (*globalCtx).gameplayFrames {
                D_80157D90 = (*globalCtx).gameplayFrames;
                D_80157D94[0 as libc::c_int as usize] =
                    0 as libc::c_int as s16;
                i = 0 as libc::c_int as s16;
                while (i as libc::c_int) < 50 as libc::c_int {
                    if (*globalCtx).colCtx.dyna.bgActorFlags[i as usize] as
                           libc::c_int & 1 as libc::c_int != 0 {
                        dynaActor =
                            (*globalCtx).colCtx.dyna.bgActors[i as
                                                                  usize].actor;
                        if !dynaActor.is_null() &&
                               (*dynaActor).update.is_some() {
                            if (*dynaActor).world.pos.x !=
                                   (*dynaActor).prevPos.x ||
                                   (*dynaActor).world.pos.y !=
                                       (*dynaActor).prevPos.y ||
                                   (*dynaActor).world.pos.z !=
                                       (*dynaActor).prevPos.z {
                                D_80157D94[0 as libc::c_int as usize] += 1;
                                break ;
                            }
                        }
                    }
            ...
            sp3A = 1 as libc::c_int as s16;
            Actor_MoveForward(&mut (*this).actor);
        }
        if sp3A as libc::c_int != 0 ||
               D_80157D94[0 as libc::c_int as usize] as libc::c_int != 0 {
            Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 10.0f32,
                                    15.0f32, 15.0f32, 0x1d as libc::c_int);
            if (*this).actor.floorHeight <= -10000.0f32 {
                Actor_Kill(&mut (*this).actor);
                return
            }
        }
    ...
    if (*this).actor.params as libc::c_int ==
           ITEM00_SHIELD_DEKU as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               ITEM00_SHIELD_HYLIAN as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               ITEM00_TUNIC_ZORA as libc::c_int ||
           (*this).actor.params as libc::c_int ==
               ITEM00_TUNIC_GORON as libc::c_int {
        (*this).actor.shape.yOffset =
            Math_CosS((*this).actor.shape.rot.x) * 37.0f32;
        (*this).actor.shape.yOffset =
            if (*this).actor.shape.yOffset >=
                   0 as libc::c_int as libc::c_float {
                (*this).actor.shape.yOffset
            } else { -(*this).actor.shape.yOffset }
    }
    if (*this).unk_154 as libc::c_int > 0 as libc::c_int { return }
    if !((*this).actor.xzDistToPlayer <= 30.0f32 &&
             (*this).actor.yDistToPlayer >= -50.0f32 &&
             (*this).actor.yDistToPlayer <= 50.0f32) {
        if Actor_HasParent(&mut (*this).actor, globalCtx) == 0 { return }
    }
    ...
    match (*this).actor.params as libc::c_int {
        ...
        16 => { getItemId = GI_SEEDS_5 as libc::c_int }
        17 => { getItemId = GI_KEY_SMALL as libc::c_int }
        6 => { getItemId = GI_HEART_PIECE as libc::c_int }
        7 => { getItemId = GI_HEART_CONTAINER as libc::c_int }
        14 => { getItemId = GI_MAGIC_LARGE as libc::c_int }
        15 => { getItemId = GI_MAGIC_SMALL as libc::c_int }
        21 => { getItemId = GI_SHIELD_DEKU as libc::c_int }
        22 => { getItemId = GI_SHIELD_HYLIAN as libc::c_int }
        23 => { getItemId = GI_TUNIC_ZORA as libc::c_int }
        24 => { getItemId = GI_TUNIC_GORON as libc::c_int }
        25 | _ => { }
    }
    params = &mut (*this).actor.params;
    if getItemId != GI_NONE as libc::c_int &&
           Actor_HasParent(&mut (*this).actor, globalCtx) == 0 {
        func_8002F554(&mut (*this).actor, globalCtx, getItemId);
    }
    match *params as libc::c_int {
        6 | 7 | 17 | 21 | 22 | 23 | 24 => {
            if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
                Flags_SetCollectible(globalCtx,
                                     (*this).collectibleFlag as s32);
                Actor_Kill(&mut (*this).actor);
            }
            return
        }
    ...
    if *params as libc::c_int <= ITEM00_RUPEE_RED as libc::c_int ||
           *params as libc::c_int == ITEM00_RUPEE_ORANGE as libc::c_int {
        Audio_PlaySoundGeneral(0x4803 as libc::c_int as u16_0,
                               &mut D_801333D4, 4 as libc::c_int as u8_0,
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
    } else if getItemId != GI_NONE as libc::c_int {
        if Actor_HasParent(&mut (*this).actor, globalCtx) != 0 {
            Flags_SetCollectible(globalCtx, (*this).collectibleFlag as s32);
            Actor_Kill(&mut (*this).actor);
        }
        return
    } else {
        Audio_PlaySoundGeneral(0x4824 as libc::c_int as u16_0,
                               &mut D_801333D4, 4 as libc::c_int as u8_0,
                               &mut D_801333E0, &mut D_801333E0,
                               &mut D_801333E8);
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnItem00_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnItem00 = thisx as *mut EnItem00;
    let mut mtxScale: f32_0 = 0.;
    if (*this).unk_156 as libc::c_int & (*this).unk_158 as libc::c_int == 0 {
        let mut current_block_18: u64;
        match (*this).actor.params as libc::c_int {
            0 | 1 | 2 | 19 | 20 => {
                EnItem00_DrawRupee(this, globalCtx);
                current_block_18 = 7245201122033322888;
            }
            6 => {
            ...
            3 => {
                if ((*this).unk_15A as libc::c_int) < 0 as libc::c_int {
                    if (*this).unk_15A as libc::c_int == -(1 as libc::c_int) {
                        let mut bankIndex: s8 =
                            Object_GetIndex(&mut (*globalCtx).objectCtx,
                                            OBJECT_GI_HEART as libc::c_int as
                                                s16) as s8;
                        ...
                        GetItem_Draw(globalCtx,
                                     GID_HEART as libc::c_int as s16);
                    }
                    current_block_18 = 7245201122033322888;
                } else { current_block_18 = 6035477365096989584; }
            }
            4 | 11 | 25 | 5 | 8 | 9 | 10 | 12 | 13 | 14 | 15 | 16 | 17 => {
                current_block_18 = 6035477365096989584;
            }
            21 => {
                GetItem_Draw(globalCtx,
            ...
            23 => {
                GetItem_Draw(globalCtx, GID_TUNIC_ZORA as libc::c_int as s16);
                current_block_18 = 7245201122033322888;
            }
            24 => {
                GetItem_Draw(globalCtx,
            ...
            18 | _ => { current_block_18 = 7245201122033322888; }
        }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnItem00_DrawRupee(mut this: *mut EnItem00,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut texIndex: s32 = 0;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_item00.c\x00" as *const u8 as
                        *const libc::c_char, 1546 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    func_8002EBCC(&mut (*this).actor, globalCtx, 0 as libc::c_int);
    if (*this).actor.params as libc::c_int <= ITEM00_RUPEE_RED as libc::c_int
       {
        texIndex = (*this).actor.params as s32
    } else {
        texIndex = (*this).actor.params as libc::c_int - 0x10 as libc::c_int
    }
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 =
        gSegments[((sRupeeTex[texIndex as usize] as u32_0) << 4 as libc::c_int
                       >> 28 as libc::c_int) as
                      usize].wrapping_add(sRupeeTex[texIndex as usize] as
                                              u32_0 &
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gRupeeDL.as_mut_ptr() as libc::c_uint;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnItem00_DrawCollectible(mut this: *mut EnItem00,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
    let mut texIndex: s32 =
        (*this).actor.params as libc::c_int - 3 as libc::c_int;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = (*globalCtx).state.gfxCtx;
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
    ...
    if (*this).actor.params as libc::c_int ==
           ITEM00_BOMBS_SPECIAL as libc::c_int {
        texIndex = 1 as libc::c_int
    } else if (*this).actor.params as libc::c_int >=
                  ITEM00_ARROWS_SMALL as libc::c_int {
        texIndex -= 3 as libc::c_int
    }
    (*__gfxCtx).polyOpa.p = func_800946E4((*__gfxCtx).polyOpa.p);
        ...
        (0xdb as libc::c_int as u32_0 &
            ...
            ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g).words.w1 =
        gSegments[((sItemDropTex[texIndex as usize] as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(sItemDropTex[texIndex as usize] as
                                              u32_0 &
                                              0xffffff as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x80000000
                                                                                 as
    ...
    (*_g_0).words.w1 =
        Matrix_NewMtx((*globalCtx).state.gfxCtx,
                      b"../z_en_item00.c\x00" as *const u8 as
                          *const libc::c_char as *mut libc::c_char,
                      1607 as libc::c_int) as libc::c_uint;
    ...
    (*_g_1).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_1).words.w1 = gItemDropDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_item00.c\x00" as *const u8 as
                         *const libc::c_char, 1611 as libc::c_int);
}
/* *
 * Draw Function used for the Heart Container type of En_Item00.
 */
#[no_mangle]
pub unsafe extern "C" fn EnItem00_DrawHeartContainer(mut this: *mut EnItem00,
                                                     mut globalCtx:
                                                         *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_item00.c\x00" as *const u8 as
                        *const libc::c_char, 1623 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    func_8002EBCC(&mut (*this).actor, globalCtx, 0 as libc::c_int);
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gHeartPieceExteriorDL.as_mut_ptr() as libc::c_uint;
    ...
    (*_g_2).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_2).words.w1 = gHeartContainerInteriorDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_item00.c\x00" as *const u8 as
                         *const libc::c_char, 1647 as libc::c_int);
}
/* *
 * Draw Function used for the Piece of Heart type of En_Item00.
 */
#[no_mangle]
pub unsafe extern "C" fn EnItem00_DrawHeartPiece(mut this: *mut EnItem00,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_item00.c\x00" as *const u8 as
                        *const libc::c_char, 1658 as libc::c_int);
    func_80093D84((*globalCtx).state.gfxCtx);
    func_8002ED80(&mut (*this).actor, globalCtx, 0 as libc::c_int);
    ...
    (*_g_0).words.w0 =
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gHeartPieceInteriorDL.as_mut_ptr() as libc::c_uint;
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_item00.c\x00" as *const u8 as
                         *const libc::c_char, 1673 as libc::c_int);
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn func_8001F404(mut dropId: s16) -> s16 {
    if gSaveContext.linkAge == 0 as libc::c_int {
        if dropId as libc::c_int == ITEM00_SEEDS as libc::c_int {
            dropId = ITEM00_ARROWS_SMALL as libc::c_int as s16
        } else if dropId as libc::c_int == ITEM00_STICK as libc::c_int {
            dropId = ITEM00_RUPEE_GREEN as libc::c_int as s16
        }
    } else if dropId as libc::c_int == ITEM00_ARROWS_SMALL as libc::c_int ||
                  dropId as libc::c_int == ITEM00_ARROWS_MEDIUM as libc::c_int
                  ||
                  dropId as libc::c_int == ITEM00_ARROWS_LARGE as libc::c_int
     {
        dropId = ITEM00_SEEDS as libc::c_int as s16
    }
    // This is convoluted but it seems like it must be a single condition to match
    // clang-format off
    if (dropId as libc::c_int == ITEM00_BOMBS_A as libc::c_int ||
            dropId as libc::c_int == ITEM00_BOMBS_SPECIAL as libc::c_int ||
            dropId as libc::c_int == ITEM00_BOMBS_B as libc::c_int) &&
           gSaveContext.inventory.items[gItemSlots[ITEM_BOMB as libc::c_int as
                                                       usize] as usize] as
               libc::c_int == ITEM_NONE as libc::c_int ||
           (dropId as libc::c_int == ITEM00_ARROWS_SMALL as libc::c_int ||
                dropId as libc::c_int == ITEM00_ARROWS_MEDIUM as libc::c_int
                ||
                dropId as libc::c_int == ITEM00_ARROWS_LARGE as libc::c_int)
               &&
               gSaveContext.inventory.items[gItemSlots[ITEM_BOW as libc::c_int
                                                           as usize] as usize]
                   as libc::c_int == ITEM_NONE as libc::c_int ||
           (dropId as libc::c_int == ITEM00_MAGIC_LARGE as libc::c_int ||
                dropId as libc::c_int == ITEM00_MAGIC_SMALL as libc::c_int) &&
               gSaveContext.magicLevel as libc::c_int == 0 as libc::c_int ||
           dropId as libc::c_int == ITEM00_SEEDS as libc::c_int &&
               gSaveContext.inventory.items[gItemSlots[ITEM_SLINGSHOT as
                                                           libc::c_int as
                                                           usize] as usize] as
                   libc::c_int == ITEM_NONE as libc::c_int {
    ...
    // clang-format on
    if dropId as libc::c_int == ITEM00_HEART as libc::c_int &&
           gSaveContext.healthCapacity as libc::c_int ==
               gSaveContext.health as libc::c_int {
        return ITEM00_RUPEE_GREEN as libc::c_int as s16
    }
    return dropId;
}
// External functions used by other actors to drop collectibles, which usually results in spawning an En_Item00 actor.
#[no_mangle]
pub unsafe extern "C" fn Item_DropCollectible(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut spawnPos: *mut Vec3f,
                                              mut params: s16)
 -> *mut EnItem00 {
    let mut pad: [s32; 2] = [0; 2];
    let mut spawnedActor: *mut EnItem00 = 0 as *mut EnItem00;
    let mut param4000: s16 =
        (params as libc::c_int & 0x4000 as libc::c_int) as s16;
    let mut param8000: s16 =
        (params as libc::c_int & 0x8000 as libc::c_int) as s16;
    let mut param3F00: s16 =
        (params as libc::c_int & 0x3f00 as libc::c_int) as s16;
    params = (params as libc::c_int & 0x3fff as libc::c_int) as s16;
    if params as libc::c_int & 0xff as libc::c_int ==
           ITEM00_FLEXIBLE as libc::c_int && param4000 == 0 {
        ...
        spawnedActor =
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_ELF as libc::c_int as s16, (*spawnPos).x,
                        (*spawnPos).y + 40.0f32, (*spawnPos).z,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16,
                        FAIRY_HEAL_TIMED as libc::c_int as s16) as
                *mut EnItem00;
        EffectSsDeadSound_SpawnStationary(globalCtx, spawnPos,
                                          0x28e7 as libc::c_int as u16_0,
        ...
        if param8000 == 0 {
            params =
                func_8001F404((params as libc::c_int & 0xff as libc::c_int) as
                                  s16)
        }
        if params as libc::c_int != -(1 as libc::c_int) {
            spawnedActor =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                            ACTOR_EN_ITEM00 as libc::c_int as s16,
                            (*spawnPos).x, (*spawnPos).y, (*spawnPos).z,
                            0 as libc::c_int as s16, 0 as libc::c_int as s16,
                            0 as libc::c_int as s16,
                            (params as libc::c_int | param8000 as libc::c_int
                                 | param3F00 as libc::c_int) as s16) as
                    *mut EnItem00;
            if !spawnedActor.is_null() && param8000 == 0 {
                (*spawnedActor).actor.velocity.y =
                    if param4000 == 0 { 8.0f32 } else { -2.0f32 };
                (*spawnedActor).actor.speedXZ = 2.0f32;
                (*spawnedActor).actor.gravity = -0.9f32;
                (*spawnedActor).actor.world.rot.y =
                    Rand_CenteredFloat(65536.0f32) as s16;
                Actor_SetScale(&mut (*spawnedActor).actor, 0.0f32);
                EnItem00_SetupAction(spawnedActor,
                                     Some(func_8001E304 as
                                              unsafe extern "C" fn(_:
                                                                       *mut EnItem00,
                                                                   _:
                                                                       *mut GlobalContext)
                                                  -> ()));
                (*spawnedActor).unk_15A = 220 as libc::c_int as s16;
                if (*spawnedActor).actor.params as libc::c_int !=
                       ITEM00_SMALL_KEY as libc::c_int &&
                       (*spawnedActor).actor.params as libc::c_int !=
                           ITEM00_HEART_PIECE as libc::c_int &&
                       (*spawnedActor).actor.params as libc::c_int !=
                           ITEM00_HEART_CONTAINER as libc::c_int {
                    (*spawnedActor).actor.room = -(1 as libc::c_int) as s8
                }
                (*spawnedActor).actor.flags |=
...
#[no_mangle]
pub unsafe extern "C" fn Item_DropCollectible2(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut spawnPos: *mut Vec3f,
                                               mut params: s16)
 -> *mut EnItem00 {
        ...
        if params as libc::c_int != -(1 as libc::c_int) {
            spawnedActor =
                Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                    ...
                    *mut EnItem00;
            if !spawnedActor.is_null() && param8000 == 0 {
                (*spawnedActor).actor.velocity.y = 0.0f32;
                (*spawnedActor).actor.speedXZ = 0.0f32;
                (*spawnedActor).actor.gravity =
                    if param4000 as libc::c_int != 0 {
                        0.0f32
                    } else { -0.9f32 };
                (*spawnedActor).actor.world.rot.y =
                    Rand_CenteredFloat(65536.0f32) as s16;
...
#[no_mangle]
pub unsafe extern "C" fn Item_DropCollectibleRandom(mut globalCtx:
                                                        *mut GlobalContext,
                                                    mut fromActor: *mut Actor,
                                                    mut spawnPos: *mut Vec3f,
                                                    mut params: s16) {
    let mut pad: s32 = 0;
    let mut spawnedActor: *mut EnItem00 = 0 as *mut EnItem00;
    let mut dropQuantity: s16 = 0;
    let mut param8000: s16 = 0;
    let mut dropTableIndex: s16 = (Rand_ZeroOne() * 16.0f32) as s16;
    let mut dropId: u8_0 = 0;
    param8000 = (params as libc::c_int & 0x8000 as libc::c_int) as s16;
    params = (params as libc::c_int & 0x7fff as libc::c_int) as s16;
    if !fromActor.is_null() {
        if (*fromActor).dropFlag != 0 {
            if (*fromActor).dropFlag as libc::c_int & 0x1 as libc::c_int != 0
               {
                params = (1 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 11 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x2 as libc::c_int != 0 {
                params = (1 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 6 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x4 as libc::c_int != 0 {
                params = (6 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 9 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x8 as libc::c_int != 0 {
                params = (3 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 11 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x10 as libc::c_int != 0 {
                params = (6 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 12 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x20 as libc::c_int != 0 {
                params = (0 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16
            } else if (*fromActor).dropFlag as libc::c_int &
                          0x40 as libc::c_int != 0 {
                params = (0 as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 1 as libc::c_int as s16
            }
        }
        if (*fromActor).dropFlag as libc::c_int & 0x20 as libc::c_int != 0 {
            dropId = ITEM00_RUPEE_PURPLE as libc::c_int as u8_0
        } else {
            dropId =
                sItemDropIds[(params as libc::c_int +
                                  dropTableIndex as libc::c_int) as usize]
        }
    } else {
        dropId =
            sItemDropIds[(params as libc::c_int +
    ...
    if dropId as libc::c_int == ITEM00_FLEXIBLE as libc::c_int {
        if gSaveContext.health as libc::c_int <= 0x10 as libc::c_int {
            // 1 heart or less
            Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                        ACTOR_EN_ELF as libc::c_int as s16, (*spawnPos).x,
                        (*spawnPos).y + 40.0f32, (*spawnPos).z,
                        0 as libc::c_int as s16, 0 as libc::c_int as s16,
                        0 as libc::c_int as s16,
                        FAIRY_HEAL_TIMED as libc::c_int as s16);
            EffectSsDeadSound_SpawnStationary(globalCtx, spawnPos,
                                              0x28e7 as libc::c_int as u16_0,
                                              1 as libc::c_int as s16,
                                              1 as libc::c_int as s16,
            ...
            if gSaveContext.health as libc::c_int <= 0x30 as libc::c_int {
                // 3 hearts or less
                params = (0xb as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_HEART as libc::c_int as u8_0
            } else if gSaveContext.health as libc::c_int <=
                          0x50 as libc::c_int {
                // 5 hearts or less
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_HEART as libc::c_int as u8_0
            } else if gSaveContext.magicLevel as libc::c_int !=
                          0 as libc::c_int &&
                ...
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_MAGIC_LARGE as libc::c_int as u8_0
            } else if gSaveContext.magicLevel as libc::c_int !=
                          0 as libc::c_int &&
                          gSaveContext.magic as libc::c_int <=
                ...
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_MAGIC_SMALL as libc::c_int as u8_0
                ...
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_SEEDS as libc::c_int as u8_0
            } else if gSaveContext.linkAge == 0 as libc::c_int &&
                          (gSaveContext.inventory.ammo[gItemSlots[ITEM_BOW as
                                                                      libc::c_int
                                                                      as
                                                                      usize]
                                                           as usize] as
                ...
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_ARROWS_MEDIUM as libc::c_int as u8_0
            } else if (gSaveContext.inventory.ammo[gItemSlots[ITEM_BOMB as
                                                                  libc::c_int
                                                                  as usize] as
                                                       usize] as libc::c_int)
                          < 6 as libc::c_int {
                params = (0xd as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_BOMBS_A as libc::c_int as u8_0
            } else if (gSaveContext.rupees as libc::c_int) < 11 as libc::c_int
             {
                params = (0xa as libc::c_int * 0x10 as libc::c_int) as s16;
                dropTableIndex = 0 as libc::c_int as s16;
                dropId = ITEM00_RUPEE_RED as libc::c_int as u8_0
            } else { return }
        }
    }
    if dropId as libc::c_int != 0xff as libc::c_int {
        dropQuantity =
            sDropQuantities[(params as libc::c_int +
                                 dropTableIndex as libc::c_int) as usize] as
                s16;
        while dropQuantity as libc::c_int > 0 as libc::c_int {
            if param8000 == 0 {
                dropId = func_8001F404(dropId as s16) as u8_0;
                if dropId as libc::c_int != 0xff as libc::c_int {
                    spawnedActor =
                        Actor_Spawn(&mut (*globalCtx).actorCtx, globalCtx,
                                    ACTOR_EN_ITEM00 as libc::c_int as s16,
                                    (*spawnPos).x, (*spawnPos).y,
                                    (*spawnPos).z, 0 as libc::c_int as s16,
                                    0 as libc::c_int as s16,
                                    0 as libc::c_int as s16, dropId as s16) as
                            *mut EnItem00;
                    if !spawnedActor.is_null() &&
                           dropId as libc::c_int != 0xff as libc::c_int {
                        (*spawnedActor).actor.velocity.y = 8.0f32;
                        (*spawnedActor).actor.speedXZ = 2.0f32;
                        (*spawnedActor).actor.gravity = -0.9f32;
                        (*spawnedActor).actor.world.rot.y =
                            (Rand_ZeroOne() * 40000.0f32) as s16;
                        Actor_SetScale(&mut (*spawnedActor).actor, 0.0f32);
                        EnItem00_SetupAction(spawnedActor,
                                             Some(func_8001E304 as
                                                      unsafe extern "C" fn(_:
                ...
                Item_DropCollectible(globalCtx, spawnPos,
