...
extern "C" {
    ...
    fn Matrix_NewMtx(gfxCtx: *mut GraphicsContext, file: *mut libc::c_char,
                     line: s32) -> *mut Mtx;
    #[no_mangle]
    static mut gFireTrialPlatformDL: [Gfx; 0];
    #[no_mangle]
    static mut gFireTrialPlatformCol: CollisionHeader;
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct BgGndFiremeiro {
    pub dyna: DynaPolyActor,
    pub initPos: Vec3f,
    pub timer: u16_0,
    pub actionFunc: BgGndFiremeiroActionFunc,
}
pub type BgGndFiremeiroActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut BgGndFiremeiro, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut Bg_Gnd_Firemeiro_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_GND_FIREMEIRO as libc::c_int as s16,
                          ...
                          instanceSize:
                              ::std::mem::size_of::<BgGndFiremeiro>() as
                                  libc::c_ulong,
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndFiremeiro_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndFiremeiro_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndFiremeiro_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgGndFiremeiro_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Init(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgGndFiremeiro = thisx as *mut BgGndFiremeiro;
    ...
    if (*this).dyna.actor.params as libc::c_int == 0 as libc::c_int {
        ...
        CollisionHeader_GetVirtual(&mut gFireTrialPlatformCol as
        ...
        (*this).actionFunc =
            Some(BgGndFiremeiro_Rise as
                     unsafe extern "C" fn(_: *mut BgGndFiremeiro,
                                          _: *mut GlobalContext) -> ())
    };
}
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Destroy(mut thisx: *mut Actor,
                                                mut globalCtx2:
                                                    *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Sink(mut this: *mut BgGndFiremeiro,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut sunkHeight: f32_0 = (*this).initPos.y - 150.0f32;
    if func_8004356C(&mut (*this).dyna) != 0 {
        (*this).timer = 10 as libc::c_int as u16_0
    }
    if sunkHeight < (*this).dyna.actor.world.pos.y {
        (*this).dyna.actor.world.pos.y -= 0.5f32;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Shake(mut this: *mut BgGndFiremeiro,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut randSign: f32_0 = 0.;
    if func_8004356C(&mut (*this).dyna) != 0 {
        ...
        if (*this).timer as libc::c_int > 0 as libc::c_int {
            ...
            (*this).dyna.actor.world.pos.x +=
                randSign *
                    Math_SinS(((*this).timer as libc::c_int *
                                   0x2fff as libc::c_int) as s16);
            (*this).dyna.actor.world.pos.z +=
                randSign *
                    Math_CosS(((*this).timer as libc::c_int *
                                   0x2fff as libc::c_int) as s16);
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Rise(mut this: *mut BgGndFiremeiro,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    if (*player).currentBoots as libc::c_int !=
        ...
        if (*thisx).world.pos.y < (*this).initPos.y {
            (*this).actionFunc =
                Some(BgGndFiremeiro_Sink as
                         unsafe extern "C" fn(_: *mut BgGndFiremeiro,
                                              _: *mut GlobalContext) -> ());
            (*this).timer = 20 as libc::c_int as u16_0
        } else {
            (*this).actionFunc =
                Some(BgGndFiremeiro_Shake as
                         unsafe extern "C" fn(_: *mut BgGndFiremeiro,
                                              _: *mut GlobalContext) -> ());
            (*this).timer = 20 as libc::c_int as u16_0
        }
    } else if (*thisx).world.pos.y < (*this).initPos.y {
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Update(mut thisx: *mut Actor,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut this: *mut BgGndFiremeiro = thisx as *mut BgGndFiremeiro;
...
#[no_mangle]
pub unsafe extern "C" fn BgGndFiremeiro_Draw(mut thisx: *mut Actor,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_gnd_firemeiro.c\x00" as *const u8 as
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gFireTrialPlatformDL.as_mut_ptr() as libc::c_uint;
