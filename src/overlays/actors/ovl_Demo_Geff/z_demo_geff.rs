...
pub struct DemoGeff {
    ...
    pub action: s32,
    pub drawConfig: s32,
    pub objBankIndex: s32,
    pub demoGt: *mut DemoGt,
    pub deltaPosX: f32_0,
    pub deltaPosY: f32_0,
    pub deltaPosZ: f32_0,
}
pub type DemoGeffInitFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGeff, _: *mut GlobalContext)
               -> ()>;
pub type DemoGeffActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGeff, _: *mut GlobalContext)
               -> ()>;
pub type DemoGeffDrawFunc
    =
    Option<unsafe extern "C" fn(_: *mut DemoGeff, _: *mut GlobalContext)
               -> ()>;
static mut sObjectIDs: [s16; 9] =
    [OBJECT_GEFF as libc::c_int as s16, OBJECT_GEFF as libc::c_int as s16,
     OBJECT_GEFF as libc::c_int as s16, OBJECT_GEFF as libc::c_int as s16,
     OBJECT_GEFF as libc::c_int as s16, OBJECT_GEFF as libc::c_int as s16,
     OBJECT_GEFF as libc::c_int as s16, OBJECT_GEFF as libc::c_int as s16,
     OBJECT_GEFF as libc::c_int as s16];
static mut sInitFuncs: [DemoGeffInitFunc; 9] =
    unsafe {
        [Some(func_80978030 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80978030 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ()),
...
static mut sActionFuncs: [DemoGeffActionFunc; 2] =
    unsafe {
        [Some(func_809783D4 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80978308 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ())]
    };
static mut sDrawFuncs: [DemoGeffDrawFunc; 2] =
    unsafe {
        [Some(func_809784D4 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ()),
         Some(func_80978344 as
                  unsafe extern "C" fn(_: *mut DemoGeff,
                                       _: *mut GlobalContext) -> ())]
    };
#[no_mangle]
pub static mut Demo_Geff_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_DEMO_GEFF as libc::c_int as s16,
                          category: ACTORCAT_BOSS as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 4 as libc::c_int |
                                   (1 as libc::c_int) << 5 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_GEFF as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<DemoGeff>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoGeff_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(DemoGeff_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn DemoGeff_Destroy(mut thisx: *mut Actor,
                                          mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoGeff_Init(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGeff = thisx as *mut DemoGeff;
    if ((*this).actor.params as libc::c_int) < 0 as libc::c_int ||
           (*this).actor.params as libc::c_int >= 9 as libc::c_int {
        osSyncPrintf(b"\x1b[31mDemo_Geff_Actor_ct:arg_data\xe3\x81\x8c\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84!!!!!!!!!!!!\n\x1b[m\x00"
...
#[no_mangle]
pub unsafe extern "C" fn func_80977EA8(mut globalCtx: *mut GlobalContext,
                                       mut dlist: *mut Gfx) {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), gfxCtx,
                    b"../z_demo_geff.c\x00" as *const u8 as
...
#[no_mangle]
pub unsafe extern "C" fn func_80977F80(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    let mut pad: [s32; 2] = [0; 2];
    let mut objBankIndex: s32 = (*this).objBankIndex;
    let mut gfxCtx: *mut GraphicsContext = (*globalCtx).state.gfxCtx;
    let mut __gfxCtx: *mut GraphicsContext = 0 as *mut GraphicsContext;
    let mut dispRefs: [*mut Gfx; 4] = [0 as *mut Gfx; 4];
    __gfxCtx = gfxCtx;
...
#[no_mangle]
pub unsafe extern "C" fn func_80978030(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    let mut thisScale: *mut Vec3f = &mut (*this).actor.scale;
        ...
        1 | 4 | 7 => {
            (*thisScale).x =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                      ...
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 0.15f32;
            (*thisScale).y =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 11 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 0.29f32;
            (*thisScale).z =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                       16 as libc::c_int + 12 as libc::c_int)
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 0.12f32
        }
        _ => {
            (*thisScale).x =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
            ...
            (*thisScale).z =
                (*gGameInfo).data[(27 as libc::c_int * 6 as libc::c_int *
                                      ...
                                      as usize] as libc::c_int as
                    libc::c_float * 0.01f32 + 0.2f32
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_809781FC(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    let mut targetParams: s32 = 2 as libc::c_int;
    let mut propIt: *mut Actor = 0 as *mut Actor;
    if (*this).demoGt.is_null() {
        propIt =
        ...
        if (*this).actor.params as libc::c_int != 0 as libc::c_int &&
            ...
            targetParams = 2 as libc::c_int
        } else { targetParams = 1 as libc::c_int }
        while !propIt.is_null() {
            if (*propIt).id as libc::c_int == ACTOR_DEMO_GT as libc::c_int &&
                   (*propIt).params as libc::c_int == targetParams {
                (*this).deltaPosX =
                    (*this).actor.world.pos.x - (*propIt).world.pos.x;
                (*this).deltaPosY =
                    (*this).actor.world.pos.y - (*propIt).world.pos.y;
                (*this).deltaPosZ =
                    (*this).actor.world.pos.z - (*propIt).world.pos.z;
                (*this).demoGt = propIt as *mut DemoGt
            }
            propIt = (*propIt).next
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn func_809782A0(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    let mut demoGt: *mut DemoGt = (*this).demoGt;
    let mut params: s16 = (*this).actor.params;
    if !demoGt.is_null() && params as libc::c_int != 6 as libc::c_int &&
           params as libc::c_int != 7 as libc::c_int &&
           params as libc::c_int != 8 as libc::c_int {
        (*this).actor.world.pos.x =
            (*demoGt).dyna.actor.world.pos.x + (*this).deltaPosX;
        (*this).actor.world.pos.y =
            (*demoGt).dyna.actor.world.pos.y + (*this).deltaPosY;
        (*this).actor.world.pos.z =
            (*demoGt).dyna.actor.world.pos.z + (*this).deltaPosZ
    };
}
#[no_mangle]
pub unsafe extern "C" fn func_80978308(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn func_80978344(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    func_80977EA8(globalCtx, gGanonRubbleDL.as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn func_80978370(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    let mut params: s16 = (*this).actor.params;
    let mut initFunc: DemoGeffInitFunc = sInitFuncs[params as usize];
    if initFunc.is_none() {
        osSyncPrintf(b"\x1b[31m Demo_Geff_main_init:\xe5\x88\x9d\xe6\x9c\x9f\xe5\x8c\x96\xe5\x87\xa6\xe7\x90\x86\xe3\x81\x8c\xe3\x81\x8a\xe3\x81\x8b\xe3\x81\x97\xe3\x81\x84arg_data = %d!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char,
                     params as libc::c_int);
        Actor_Kill(&mut (*this).actor);
        return
    }
    initFunc.expect("non-null function pointer")(this, globalCtx);
}
#[no_mangle]
pub unsafe extern "C" fn func_809783D4(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
    ...
    let mut objectId: s16 = sObjectIDs[params as usize];
    let mut objBankIndex: s32 = Object_GetIndex(objCtx, objectId);
    let mut pad: s32 = 0;
    if objBankIndex < 0 as libc::c_int {
        osSyncPrintf(b"\x1b[31mDemo_Geff_main_bank:\xe3\x83\x90\xe3\x83\xb3\xe3\x82\xaf\xe3\x82\x92\xe8\xaa\xad\xe3\x82\x81\xe3\x81\xaa\xe3\x81\x84 arg_data = %d!\n\x1b[m\x00"
                         as *const u8 as *const libc::c_char, params);
        Actor_Kill(thisx);
        return
    }
    if Object_IsLoaded(objCtx, objBankIndex) != 0 {
        (*this).objBankIndex = objBankIndex;
        func_80978370(this, globalCtx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn DemoGeff_Update(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGeff = thisx as *mut DemoGeff;
    if (*this).action < 0 as libc::c_int || (*this).action >= 2 as libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn func_809784D4(mut this: *mut DemoGeff,
                                       mut globalCtx: *mut GlobalContext) {
}
#[no_mangle]
pub unsafe extern "C" fn DemoGeff_Draw(mut thisx: *mut Actor,
                                       mut globalCtx: *mut GlobalContext) {
    let mut this: *mut DemoGeff = thisx as *mut DemoGeff;
    let mut drawConfig: s32 = (*this).drawConfig;
    if drawConfig < 0 as libc::c_int || drawConfig >= 2 as libc::c_int ||
    ...
    if drawConfig != 0 as libc::c_int { func_80977F80(this, globalCtx); }
