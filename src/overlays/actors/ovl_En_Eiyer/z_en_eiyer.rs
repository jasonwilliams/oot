...
extern "C" {
    ...
    #[no_mangle]
    static mut gStingerPopOutAnim: AnimationHeader;
    #[no_mangle]
    static mut gStingerDiveAnim: AnimationHeader;
    #[no_mangle]
    static mut gStingerBackflipAnim: AnimationHeader;
    #[no_mangle]
    static mut gStingerHitAnim: AnimationHeader;
    #[no_mangle]
    static mut gStingerIdleAnim: AnimationHeader;
    #[no_mangle]
    static mut gStingerSkel: SkeletonHeader;
}
...
pub struct EnEiyer {
    pub actor: Actor,
    pub skelanime: SkelAnime,
    pub actionFunc: EnEiyerActionFunc,
    pub timer: s16,
    pub targetYaw: s16,
...
pub type EnEiyerActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
               -> ()>;
#[no_mangle]
pub static mut En_Eiyer_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_EIYER as libc::c_int as s16,
                          category: ACTORCAT_ENEMY as libc::c_int as u8_0,
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                   (1 as libc::c_int) << 2 as libc::c_int) as
                                  u32_0,
                          objectId: OBJECT_EI as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnEiyer>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnEiyer_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sColChkInfoInit: CollisionCheckInfoInit =
    {
        let mut init =
            CollisionCheckInfoInit{health: 2 as libc::c_int as u8_0,
                                   cylRadius: 45 as libc::c_int as s16,
                                   cylHeight: 15 as libc::c_int as s16,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Init(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEiyer = thisx as *mut EnEiyer;
    let mut pad: s32 = 0;
    Actor_ProcessInitChain(&mut (*this).actor, sInitChain.as_mut_ptr());
    ActorShape_Init(&mut (*this).actor.shape, 600.0f32,
                    Some(ActorShadow_DrawCircle as
                             unsafe extern "C" fn(_: *mut Actor,
                                                  _: *mut Lights,
                                                  _: *mut GlobalContext)
                                 -> ()), 65.0f32);
    SkelAnime_Init(globalCtx, &mut (*this).skelanime, &mut gStingerSkel,
                   &mut gStingerIdleAnim, (*this).jointTable.as_mut_ptr(),
                   (*this).morphTable.as_mut_ptr(), 19 as libc::c_int);
    ...
    if ((*this).actor.params as libc::c_int) < 3 as libc::c_int {
        ...
        if Actor_SpawnAsChild(&mut (*globalCtx).actorCtx, &mut (*this).actor,
                              globalCtx, ACTOR_EN_EIYER as libc::c_int as s16,
        ...
        if (*this).actor.params as libc::c_int == 0 as libc::c_int {
            ...
            let mut clonesSpawned: s32 = 0;
            clonesSpawned = 0 as libc::c_int;
            while clonesSpawned != 3 as libc::c_int {
                if child.is_null() { break ; }
                child = (*child).child;
                clonesSpawned += 1
            }
            if clonesSpawned != 3 as libc::c_int {
                child = &mut (*this).actor;
                while !child.is_null() {
                    Actor_Kill(child);
                    child = (*child).child
                }
                ...
                (*(*(*this).actor.child).child).parent = &mut (*this).actor;
                (*(*(*(*this).actor.child).child).child).parent =
                    &mut (*this).actor
            }
        }
    }
    ...
    } else { EnEiyer_SetupInactive(this); };
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEiyer = thisx as *mut EnEiyer;
    Collider_DestroyCylinder(globalCtx, &mut (*this).collider);
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_RotateAroundHome(mut this: *mut EnEiyer) {
    (*this).actor.world.pos.x =
        Math_SinS((*this).actor.world.rot.y) * 80.0f32 +
            (*this).actor.home.pos.x;
    (*this).actor.world.pos.z =
        Math_CosS((*this).actor.world.rot.y) * 80.0f32 +
            (*this).actor.home.pos.z;
    (*this).actor.shape.rot.y =
        ((*this).actor.world.rot.y as libc::c_int + 0x4000 as libc::c_int) as
            s16;
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupAppearFromGround(mut this:
                                                           *mut EnEiyer) {
    (*this).collider.info.bumper.dmgFlags = 0x19 as libc::c_int as u32_0;
    Animation_PlayLoop(&mut (*this).skelanime, &mut gStingerIdleAnim);
    (*this).actor.world.pos.x = (*this).actor.home.pos.x;
    (*this).actor.world.pos.y = (*this).actor.home.pos.y - 40.0f32;
    ...
    if (*this).actor.params as libc::c_int != 0xa as libc::c_int {
        if (*this).actor.params as libc::c_int == 0 as libc::c_int {
            (*this).actor.world.rot.y =
                (Rand_ZeroOne() * 0x10000 as libc::c_int as libc::c_float) as
                    s16
        } else {
            (*this).actor.world.rot.y =
                ((*(*this).actor.parent).world.rot.y as libc::c_int +
                     (*this).actor.params as libc::c_int *
                         0x4000 as libc::c_int) as s16
        }
    ...
    (*this).actionFunc =
        Some(EnEiyer_AppearFromGround as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupUnderground(mut this: *mut EnEiyer) {
    if (*this).actor.params as libc::c_int == 0xa as libc::c_int {
        (*this).actor.speedXZ = -0.5f32;
        (*this).actionFunc =
            Some(EnEiyer_WanderUnderground as
                     unsafe extern "C" fn(_: *mut EnEiyer,
                                          _: *mut GlobalContext) -> ())
    } else {
        (*this).actionFunc =
            Some(EnEiyer_CircleUnderground as
                     unsafe extern "C" fn(_: *mut EnEiyer,
                                          _: *mut GlobalContext) -> ())
    }
    (*this).collider.base.acFlags =
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupInactive(mut this: *mut EnEiyer) {
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actionFunc =
        Some(EnEiyer_Inactive as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupAmbush(mut this: *mut EnEiyer,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    (*this).actor.speedXZ = 0.0f32;
    Animation_PlayOnce(&mut (*this).skelanime, &mut gStingerBackflipAnim);
    (*this).collider.info.bumper.dmgFlags =
        !(0x300000 as libc::c_int) as u32_0;
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actor.shape.shadowScale = 65.0f32;
    (*this).actor.shape.yOffset = 600.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x38c2 as libc::c_int as u16_0);
    EffectSsGSplash_Spawn(globalCtx, &mut (*this).actor.world.pos,
                          0 as *mut Color_RGBA8, 0 as *mut Color_RGBA8,
                          1 as libc::c_int as s16, 700 as libc::c_int as s16);
    (*this).actionFunc =
        Some(EnEiyer_Ambush as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupGlide(mut this: *mut EnEiyer) {
    (*this).targetYaw = (*this).actor.shape.rot.y;
    (*this).basePos.y =
        cosf(-3.14159265358979323846f32 / 8 as libc::c_int as libc::c_float) *
            5.0f32 + (*this).actor.world.pos.y;
    Animation_MorphToLoop(&mut (*this).skelanime, &mut gStingerHitAnim,
                          -5.0f32);
    (*this).timer = 60 as libc::c_int as s16;
    (*this).actionFunc =
        Some(EnEiyer_Glide as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupStartAttack(mut this: *mut EnEiyer) {
    (*this).actionFunc =
        Some(EnEiyer_StartAttack as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupDiveAttack(mut this: *mut EnEiyer,
                                                 mut globalCtx:
                                                     *mut GlobalContext) {
    ...
    (*this).actor.velocity.y = 0.0f32;
    (*this).basePos.y = (*player).actor.world.pos.y + 15.0f32;
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int |
             (1 as libc::c_int) << 0 as libc::c_int) as u8_0;
    (*this).collider.base.atFlags =
    ...
    (*this).actionFunc =
        Some(EnEiyer_DiveAttack as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupLand(mut this: *mut EnEiyer) {
    Animation_MorphToPlayOnce(&mut (*this).skelanime, &mut gStingerDiveAnim,
                              -3.0f32);
    (*this).collider.base.atFlags =
        ((*this).collider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    ...
    (*this).actionFunc =
        Some(EnEiyer_Land as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupHurt(mut this: *mut EnEiyer) {
    (*this).basePos.y = (*this).actor.world.pos.y;
    Animation_Change(&mut (*this).skelanime, &mut gStingerHitAnim, 2.0f32,
                     0.0f32, 0.0f32, 0 as libc::c_int as u8_0, -3.0f32);
    ...
    (*this).collider.base.acFlags =
        ((*this).collider.base.acFlags as libc::c_int &
             !((1 as libc::c_int) << 0 as libc::c_int)) as u8_0;
    (*this).actionFunc =
        Some(EnEiyer_Hurt as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupDie(mut this: *mut EnEiyer) {
    (*this).timer = 20 as libc::c_int as s16;
    Actor_SetColorFilter(&mut (*this).actor, 0x4000 as libc::c_int as s16,
                         200 as libc::c_int as s16, 0 as libc::c_int as s16,
                         40 as libc::c_int as s16);
    if (*this).collider.info.bumper.dmgFlags !=
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupDead(mut this: *mut EnEiyer) {
    (*this).actor.colorFilterParams =
        ((*this).actor.colorFilterParams as libc::c_int |
             0x2000 as libc::c_int) as u16_0;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actionFunc =
        Some(EnEiyer_Dead as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_SetupStunned(mut this: *mut EnEiyer) {
    Animation_Change(&mut (*this).skelanime, &mut gStingerPopOutAnim, 2.0f32,
                     0.0f32, 0.0f32, 0 as libc::c_int as u8_0, -8.0f32);
    (*this).timer = 80 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.velocity.y = 0.0f32;
    (*this).actor.gravity = -1.0f32;
    (*this).collider.dim.height =
        (sColCylInit.dim.height as libc::c_int + 8 as libc::c_int) as s16;
    ...
    (*this).actionFunc =
        Some(EnEiyer_Stunned as
                 unsafe extern "C" fn(_: *mut EnEiyer, _: *mut GlobalContext)
                     -> ());
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_AppearFromGround(mut this: *mut EnEiyer,
                                                  mut globalCtx:
                                                      *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_CheckPlayerCollision(mut this: *mut EnEiyer,
                                                      mut globalCtx:
                                                          *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_CircleUnderground(mut this: *mut EnEiyer,
                                                   mut globalCtx:
                                                       *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    (*this).actor.world.rot.y =
        ((*this).actor.world.rot.y as libc::c_int + -(0x60 as libc::c_int)) as
            s16;
    EnEiyer_RotateAroundHome(this);
    EnEiyer_CheckPlayerCollision(this, globalCtx);
    // Clones disappear when the main Eiyer leaves the ground
    if (*this).actor.params as libc::c_int != 0 as libc::c_int &&
           (*((*this).actor.parent as *mut EnEiyer)).actionFunc !=
               Some(EnEiyer_CircleUnderground as
                        unsafe extern "C" fn(_: *mut EnEiyer,
                                             _: *mut GlobalContext) -> ()) {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Inactive(mut this: *mut EnEiyer,
                                          mut globalCtx: *mut GlobalContext) {
    let mut parent: *mut EnEiyer = 0 as *mut EnEiyer;
    if (*this).actor.home.pos.y - 50.0f32 < (*this).actor.world.pos.y {
        (*this).actor.world.pos.y -= 0.5f32
    }
    parent = (*this).actor.parent as *mut EnEiyer;
    if (*parent).actionFunc ==
           Some(EnEiyer_Dead as
                    unsafe extern "C" fn(_: *mut EnEiyer,
                                         _: *mut GlobalContext) -> ()) {
        Actor_Kill(&mut (*this).actor);
    } else if (*parent).actionFunc ==
                  Some(EnEiyer_AppearFromGround as
                           unsafe extern "C" fn(_: *mut EnEiyer,
                                                _: *mut GlobalContext) -> ())
     {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Ambush(mut this: *mut EnEiyer,
                                        mut globalCtx: *mut GlobalContext) {
    let mut animFinished: s32 = 0;
    let mut curFrame: f32_0 = 0.;
    let mut xzOffset: f32_0 = 0.;
    let mut bgId: s32 = 0;
    animFinished = SkelAnime_Update(&mut (*this).skelanime);
    curFrame = (*this).skelanime.curFrame;
    if (*this).skelanime.curFrame < 12.0f32 {
        (*this).actor.world.pos.y =
            (1.0f32 -
                 cosf(0.996f32 * 3.14159265358979323846f32 / 12.0f32 *
                          curFrame)) * 40.0f32 + (*this).actor.home.pos.y;
        xzOffset =
            sinf(0.996f32 * 3.14159265358979323846f32 / 12.0f32 * curFrame) *
                -40.0f32;
        (*this).actor.world.pos.x =
            Math_SinS((*this).actor.shape.rot.y) * xzOffset +
                (*this).basePos.x;
        (*this).actor.world.pos.z =
            Math_CosS((*this).actor.shape.rot.y) * xzOffset +
                (*this).basePos.z
    } else {
        Math_StepToF(&mut (*this).actor.world.pos.y,
                     (*this).actor.home.pos.y + 80.0f32, 0.5f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Glide(mut this: *mut EnEiyer,
                                       mut globalCtx: *mut GlobalContext) {
    let mut curFrame: f32_0 = 0.;
    let mut pad: s32 = 0;
    ...
    curFrame = (*this).skelanime.curFrame;
    Math_ApproachF(&mut (*this).basePos.y,
                   (*this).actor.floorHeight + 80.0f32 + 5.0f32, 0.3f32,
                   (*this).actor.speedXZ);
    (*this).actor.world.pos.y =
        (*this).basePos.y -
            cosf((curFrame - 5.0f32) *
                     (3.14159265358979323846f32 /
                          40 as libc::c_int as libc::c_float)) * 5.0f32;
    if curFrame <= 45.0f32 {
        Math_StepToF(&mut (*this).actor.speedXZ, 1.0f32, 0.03f32);
    } else { Math_StepToF(&mut (*this).actor.speedXZ, 1.5f32, 0.03f32); }
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        (*this).targetYaw = (*this).actor.wallYaw
    }
    if Math_ScaledStepToS(&mut (*this).actor.world.rot.y, (*this).targetYaw,
                          0xb6 as libc::c_int as s16) != 0 {
        if (*this).timer as libc::c_int != 0 as libc::c_int ||
               Rand_ZeroOne() > 0.05f32 {
            (*this).actor.world.rot.y =
                ((*this).actor.world.rot.y as libc::c_int +
                     0x100 as libc::c_int) as s16
        } else {
            yawChange =
                Rand_S16Offset(0x2000 as libc::c_int as s16,
                               0x2000 as libc::c_int as s16);
            (*this).targetYaw =
                ((if Rand_ZeroOne() < 0.5f32 {
                      -(1 as libc::c_int)
                  } else { 1 as libc::c_int }) * yawChange as libc::c_int +
                     (*this).actor.world.rot.y as libc::c_int) as s16
        }
    }
    if (*this).timer as libc::c_int == 0 as libc::c_int &&
           (*this).actor.yDistToPlayer < 0.0f32 &&
           (*this).actor.xzDistToPlayer < 120.0f32 {
        EnEiyer_SetupStartAttack(this);
    }
    func_8002F974(&mut (*this).actor,
                  (0x394f as libc::c_int - 0x800 as libc::c_int) as u16_0);
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_StartAttack(mut this: *mut EnEiyer,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut focus: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).actor.shape.rot.x as libc::c_int > 0 as libc::c_int &&
           ((*this).actor.shape.rot.x as libc::c_int) < 0x8000 as libc::c_int
       {
        focus.x = (*player).actor.world.pos.x;
        focus.y = (*player).actor.world.pos.y + 20.0f32;
        focus.z = (*player).actor.world.pos.z;
        if Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                              Actor_WorldPitchTowardPoint(&mut (*this).actor,
                                                          &mut focus),
                              0x1000 as libc::c_int as s16) != 0 {
    ...
    Math_StepToF(&mut (*this).actor.speedXZ, 5.0f32, 0.3f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_DiveAttack(mut this: *mut EnEiyer,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    (*this).actor.speedXZ *= 1.1f32;
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 ||
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Land(mut this: *mut EnEiyer,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    Math_ScaledStepToS(&mut (*this).actor.world.rot.x,
                       -(0x4000 as libc::c_int) as s16,
                       0x450 as libc::c_int as s16);
    Math_StepToF(&mut (*this).actor.speedXZ, 7.0f32, 1.0f32);
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Hurt(mut this: *mut EnEiyer,
                                      mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    Math_ApproachF(&mut (*this).basePos.y,
                   (*this).actor.floorHeight + 80.0f32 + 5.0f32, 0.5f32,
                   (*this).actor.speedXZ);
    (*this).actor.world.pos.y = (*this).basePos.y - 5.0f32;
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
        (*this).targetYaw = (*this).actor.wallYaw
    } else {
        (*this).targetYaw =
    ...
    (*this).actor.shape.rot.z =
        (sinf((*this).timer as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       5 as libc::c_int as libc::c_float)) * 5120.0f32) as
            s16;
    if (*this).timer as libc::c_int == 0 as libc::c_int {
        (*this).actor.shape.rot.x = 0 as libc::c_int as s16;
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Die(mut this: *mut EnEiyer,
                                     mut globalCtx: *mut GlobalContext) {
    SkelAnime_Update(&mut (*this).skelanime);
    ...
    (*this).actor.world.rot.x =
        -((*this).actor.shape.rot.x as libc::c_int) as s16;
    if (*this).timer as libc::c_int == 0 as libc::c_int ||
           (*this).actor.bgCheckFlags as libc::c_int & 0x10 as libc::c_int !=
               0 {
        EnEiyer_SetupDead(this);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Dead(mut this: *mut EnEiyer,
                                      mut globalCtx: *mut GlobalContext) {
    (*this).actor.shape.shadowAlpha =
        if (((*this).actor.shape.shadowAlpha as libc::c_int -
                 5 as libc::c_int) as s16 as libc::c_int) < 0 as libc::c_int {
            0 as libc::c_int
        } else {
    ...
    if (*this).actor.shape.shadowAlpha as libc::c_int == 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Stunned(mut this: *mut EnEiyer,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).timer as libc::c_int != 0 as libc::c_int { (*this).timer -= 1 }
    Math_ScaledStepToS(&mut (*this).actor.shape.rot.x,
                       0 as libc::c_int as s16, 0x200 as libc::c_int as s16);
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_UpdateDamage(mut this: *mut EnEiyer,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
...
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEiyer = thisx as *mut EnEiyer;
    let mut pad: s32 = 0;
    ...
    } else { func_8002D97C(&mut (*this).actor); }
    if (*this).actionFunc ==
           Some(EnEiyer_Glide as
                    unsafe extern "C" fn(_: *mut EnEiyer,
                                         _: *mut GlobalContext) -> ()) ||
           ...
           (*this).actionFunc ==
               Some(EnEiyer_Land as
                        unsafe extern "C" fn(_: *mut EnEiyer,
                                             _: *mut GlobalContext) -> ()) &&
               (*this).timer as libc::c_int == -(1 as libc::c_int) {
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 5.0f32,
                                27.0f32, 30.0f32, 7 as libc::c_int);
    }
    if (*this).actor.params as libc::c_int == 0xa as libc::c_int ||
           (*this).actionFunc !=
               Some(EnEiyer_AppearFromGround as
    ...
    if (*this).actor.flags &
        ...
        (*this).actor.focus.pos.x =
            (*this).actor.world.pos.x +
                Math_SinS((*this).actor.shape.rot.y) * 12.5f32;
        (*this).actor.focus.pos.z =
            (*this).actor.world.pos.z +
                Math_CosS((*this).actor.shape.rot.y) * 12.5f32;
        (*this).actor.focus.pos.y = (*this).actor.world.pos.y
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
 ...
 -> s32 {
    let mut this: *mut EnEiyer = thisx as *mut EnEiyer;
    if limbIndex == 1 as libc::c_int { (*pos).z += 2500.0f32 }
    if (*this).collider.info.bumper.dmgFlags ==
           0x19 as libc::c_int as libc::c_uint &&
           limbIndex != 9 as libc::c_int && limbIndex != 10 as libc::c_int {
        *dList = 0 as *mut Gfx
    }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnEiyer_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    let mut this: *mut EnEiyer = thisx as *mut EnEiyer;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_eiyer.c\x00" as *const u8 as
    ...
    if (*this).actionFunc !=
        ...
        (*__gfxCtx).polyOpa.p =
            SkelAnime_Draw(globalCtx, (*this).skelanime.skeleton,
                           ...
                           Some(EnEiyer_OverrideLimbDraw as
                                    unsafe extern "C" fn(_:
                                                             *mut GlobalContext,
                                                         _: s32,
                                                         _: *mut *mut Gfx,
            ...
            (255 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    8 as libc::c_int |
                ((*this).actor.shape.shadowAlpha as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int;
        (*__gfxCtx).polyXlu.p =
...
unsafe extern "C" fn run_static_initializers() {
    sInitChain =
        [{
             ...
             init.set_value(0x19 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
         ...
         },
         {
             ...
             init.set_value(2500 as libc::c_int);
             init
         }]
}
#[used]
