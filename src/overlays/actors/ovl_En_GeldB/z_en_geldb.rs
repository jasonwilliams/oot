...
extern "C" {
    ...
    #[no_mangle]
    static mut gGerudoRedSlashAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedSpinAttackAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedFlipAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedBlockAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedDefeatAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedDamageAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedWalkAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedEyeOpenTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoRedEyeHalfTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoRedEyeShutTex: [u64_0; 0];
    #[no_mangle]
    static mut gGerudoRedSkel: FlexSkeletonHeader;
    #[no_mangle]
    static mut gGerudoRedSidestepAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedJumpAnim: AnimationHeader;
    #[no_mangle]
    static mut gGerudoRedNeutralAnim: AnimationHeader;
}
...
pub struct EnGeldB {
    ...
    pub morphTable: [Vec3s; 24],
    pub action: s32,
    pub unk_2F0: [libc::c_char; 4],
    pub actionFunc: EnGeldBActionFunc,
    pub unkTimer: s16,
    pub lookTimer: s16,
    pub iceTimer: s16,
    pub damageEffect: u8_0,
    ...
    pub unkFloat: f32_0,
    pub swordState: s16,
    pub spinAttackState: s16,
    pub keyFlag: s16,
    pub unk_316: [libc::c_char; 2],
    pub invisible: s16,
    pub blinkState: u8_0,
    pub blureIndex: s32,
    pub bodyCollider: ColliderCylinder,
    pub swordCollider: ColliderQuad,
    pub blockCollider: ColliderTris,
    pub blockElements: [ColliderTrisElement; 2],
    pub rightFootPos: Vec3f,
    pub leftFootPos: Vec3f,
    pub headRot: Vec3s,
}
pub type EnGeldBActionFunc
    =
    Option<unsafe extern "C" fn(_: *mut EnGeldB, _: *mut GlobalContext)
               -> ()>;
pub type C2RustUnnamed_25 = libc::c_uint;
pub const GELDB_LIMB_MAX: C2RustUnnamed_25 = 24;
pub const GELDB_LIMB_WAIST: C2RustUnnamed_25 = 23;
pub const GELDB_LIMB_R_FOOT: C2RustUnnamed_25 = 22;
pub const GELDB_LIMB_R_SHIN: C2RustUnnamed_25 = 21;
pub const GELDB_LIMB_R_THIGH: C2RustUnnamed_25 = 20;
pub const GELDB_LIMB_L_FOOT: C2RustUnnamed_25 = 19;
pub const GELDB_LIMB_L_SHIN: C2RustUnnamed_25 = 18;
pub const GELDB_LIMB_L_THIGH: C2RustUnnamed_25 = 17;
pub const GELDB_LIMB_L_SWORD: C2RustUnnamed_25 = 16;
pub const GELDB_LIMB_L_HAND: C2RustUnnamed_25 = 15;
pub const GELDB_LIMB_L_WRIST: C2RustUnnamed_25 = 14;
pub const GELDB_LIMB_L_FOREARM: C2RustUnnamed_25 = 13;
pub const GELDB_LIMB_L_UPPER_ARM: C2RustUnnamed_25 = 12;
pub const GELDB_LIMB_R_SWORD: C2RustUnnamed_25 = 11;
pub const GELDB_LIMB_R_HAND: C2RustUnnamed_25 = 10;
pub const GELDB_LIMB_R_WRIST: C2RustUnnamed_25 = 9;
pub const GELDB_LIMB_R_FOREARM: C2RustUnnamed_25 = 8;
pub const GELDB_LIMB_R_UPPER_ARM: C2RustUnnamed_25 = 7;
pub const GELDB_LIMB_HEAD: C2RustUnnamed_25 = 6;
pub const GELDB_LIMB_VEIL: C2RustUnnamed_25 = 5;
pub const GELDB_LIMB_PONYTAIL: C2RustUnnamed_25 = 4;
pub const GELDB_LIMB_NECK: C2RustUnnamed_25 = 3;
pub const GELDB_LIMB_TORSO: C2RustUnnamed_25 = 2;
pub const GELDB_LIMB_ROOT: C2RustUnnamed_25 = 1;
pub const GELDB_LIMB_NONE: C2RustUnnamed_25 = 0;
pub type C2RustUnnamed_26 = libc::c_uint;
pub const GELDB_SPIN_DODGE: C2RustUnnamed_26 = 16;
pub const GELDB_STUNNED: C2RustUnnamed_26 = 15;
pub const GELDB_ROLL_FORWARD: C2RustUnnamed_26 = 14;
pub const GELDB_SIDESTEP: C2RustUnnamed_26 = 13;
pub const GELDB_SPIN_ATTACK: C2RustUnnamed_26 = 12;
pub const GELDB_UNUSED: C2RustUnnamed_26 = 11;
pub const GELDB_CIRCLE: C2RustUnnamed_26 = 10;
pub const GELDB_PIVOT: C2RustUnnamed_26 = 9;
pub const GELDB_ADVANCE: C2RustUnnamed_26 = 8;
pub const GELDB_SLASH: C2RustUnnamed_26 = 7;
pub const GELDB_BLOCK: C2RustUnnamed_26 = 6;
pub const GELDB_READY: C2RustUnnamed_26 = 5;
pub const GELDB_ROLL_BACK: C2RustUnnamed_26 = 4;
pub const GELDB_JUMP: C2RustUnnamed_26 = 3;
pub const GELDB_DAMAGED: C2RustUnnamed_26 = 2;
pub const GELDB_DEFEAT: C2RustUnnamed_26 = 1;
pub const GELDB_WAIT: C2RustUnnamed_26 = 0;
pub const GELDB_DMG_NORMAL: C2RustUnnamed_27 = 0;
pub const GELDB_DMG_UNK_D: C2RustUnnamed_27 = 13;
pub const GELDB_DMG_UNK_6: C2RustUnnamed_27 = 6;
pub const GELDB_DMG_UNK_E: C2RustUnnamed_27 = 14;
pub const GELDB_DMG_FREEZE: C2RustUnnamed_27 = 15;
pub const GELDB_DMG_STUN: C2RustUnnamed_27 = 1;
pub type C2RustUnnamed_27 = libc::c_uint;
#[no_mangle]
pub static mut En_GeldB_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_EN_GELDB as libc::c_int as s16,
                          ...
                          flags:
                              ((1 as libc::c_int) << 0 as libc::c_int |
                                  ...
                                  u32_0,
                          objectId: OBJECT_GELDB as libc::c_int as s16,
                          instanceSize:
                              ::std::mem::size_of::<EnGeldB>() as
                                  libc::c_ulong,
                          init:
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(EnGeldB_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut Actor,
                                                                                               _:
...
static mut sBodyCylInit: ColliderCylinderInit =
    {
        let mut init =
...
static mut sBlockTrisElementsInit: [ColliderTrisElementInit; 2] =
    [{
         let mut init =
...
static mut sBlockTrisInit: ColliderTrisInit =
    unsafe {
        {
            let mut init =
                ColliderTrisInit{base:
                                 ...
                                 elements:
                                     sBlockTrisElementsInit.as_ptr() as
                                         *mut _,};
            init
        }
    };
...
static mut sDamageTable: DamageTable =
    {
        let mut init =
            DamageTable{table:
                            [(0 as libc::c_int |
                                  (GELDB_DMG_STUN as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (1 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (GELDB_DMG_FREEZE as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (2 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             ...
                             (2 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (4 as libc::c_int |
                                  (GELDB_DMG_UNK_E as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (GELDB_DMG_UNK_6 as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (3 as libc::c_int |
                                  (GELDB_DMG_UNK_D as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
                             (0 as libc::c_int |
                                  (GELDB_DMG_NORMAL as libc::c_int) <<
                                      4 as libc::c_int) as u8_0,
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupAction(mut this: *mut EnGeldB,
                                             mut actionFunc:
                                                 EnGeldBActionFunc) {
    (*this).actionFunc = actionFunc; // Needed to match for some reason
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Init(mut thisx: *mut Actor,
    ...
    let mut blureInit: EffectBlureInit1 =
        EffectBlureInit1{unk_00: [0; 388],
                         ...
                         unkFlag: 0,
                         calcMode: 0,};
    let mut this: *mut EnGeldB = thisx as *mut EnGeldB;
    ...
    (*thisx).colChkInfo.health = 20 as libc::c_int as u8_0;
    (*thisx).colChkInfo.cylRadius = 50 as libc::c_int as s16;
    (*thisx).colChkInfo.cylHeight = 100 as libc::c_int as s16;
    (*thisx).naviEnemyId = 0x54 as libc::c_int as u8_0;
    (*this).keyFlag =
        ((*thisx).params as libc::c_int & 0xff00 as libc::c_int) as s16;
    (*thisx).params =
        ((*thisx).params as libc::c_int & 0xff as libc::c_int) as s16;
    (*this).blinkState = 0 as libc::c_int as u8_0;
    (*this).unkFloat = 10.0f32;
    SkelAnime_InitFlex(globalCtx, &mut (*this).skelAnime, &mut gGerudoRedSkel,
                       &mut gGerudoRedNeutralAnim,
                       (*this).jointTable.as_mut_ptr(),
                       (*this).morphTable.as_mut_ptr(),
                       GELDB_LIMB_MAX as libc::c_int);
    Collider_InitCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_SetCylinder(globalCtx, &mut (*this).bodyCollider, thisx,
                         &mut sBodyCylInit);
    Collider_InitTris(globalCtx, &mut (*this).blockCollider);
    Collider_SetTris(globalCtx, &mut (*this).blockCollider, thisx,
                     &mut sBlockTrisInit, (*this).blockElements.as_mut_ptr());
    ...
    Actor_SetScale(thisx, 0.012499999f32);
    EnGeldB_SetupWait(this);
    if (*this).keyFlag as libc::c_int != 0 as libc::c_int &&
           Flags_GetCollectible(globalCtx,
                                (*this).keyFlag as libc::c_int >>
                                    8 as libc::c_int) != 0 {
        Actor_Kill(thisx);
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Destroy(mut thisx: *mut Actor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGeldB = thisx as *mut EnGeldB;
    func_800F5B58();
    Effect_Delete(globalCtx, (*this).blureIndex);
    Collider_DestroyTris(globalCtx, &mut (*this).blockCollider);
    Collider_DestroyCylinder(globalCtx, &mut (*this).bodyCollider);
    Collider_DestroyQuad(globalCtx, &mut (*this).swordCollider);
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_ReactToPlayer(mut globalCtx:
                                                   *mut GlobalContext,
                                               mut this: *mut EnGeldB,
                                               mut arg2: s16) -> s32 {
    ...
    let mut angleToLink: s16 = 0;
    let mut bomb: *mut Actor = 0 as *mut Actor;
    angleToWall =
        ((*thisx).wallYaw as libc::c_int -
    ...
    angleToLink =
        ((*thisx).yawTowardsPlayer as libc::c_int -
             (*thisx).shape.rot.y as libc::c_int) as s16;
    angleToLink =
        if angleToLink as libc::c_int >= 0 as libc::c_int {
            angleToLink as libc::c_int
        } else { -(angleToLink as libc::c_int) } as s16;
    if func_800354B4(globalCtx, thisx, 100.0f32, 0x2710 as libc::c_int as s16,
                     0x3e80 as libc::c_int as s16, (*thisx).shape.rot.y) != 0
       {
        if (*player).swordAnimation as libc::c_int == 0x11 as libc::c_int {
    ...
    if func_800354B4(globalCtx, thisx, 100.0f32, 0x5dc0 as libc::c_int as s16,
                     0x2aa8 as libc::c_int as s16, (*thisx).shape.rot.y) != 0
       {
        (*thisx).world.rot.y = (*thisx).yawTowardsPlayer;
        (*thisx).shape.rot.y = (*thisx).world.rot.y;
        if (*thisx).bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 &&
               (if angleToWall as libc::c_int >= 0 as libc::c_int {
                    angleToWall as libc::c_int
                } else { -(angleToWall as libc::c_int) }) <
                   0x2ee0 as libc::c_int && (*thisx).xzDistToPlayer < 90.0f32
           {
            ...
            EnGeldB_SetupSpinDodge(this, globalCtx);
            return 1 as libc::c_int
        } else if (*thisx).xzDistToPlayer < 90.0f32 &&
                      (*globalCtx).gameplayFrames &
                          1 as libc::c_int as libc::c_uint != 0 {
            EnGeldB_SetupBlock(this);
            return 1 as libc::c_int
        } else { EnGeldB_SetupRollBack(this); return 1 as libc::c_int }
    } else {
        bomb =
            Actor_FindNearby(globalCtx, thisx, -(1 as libc::c_int) as s16,
        ...
        if !bomb.is_null() {
            ...
            if (*thisx).bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 &&
                   ...
                   (*bomb).id as libc::c_int ==
                       ACTOR_EN_BOM_CHU as libc::c_int {
                if (*bomb).id as libc::c_int ==
                       ACTOR_EN_BOM_CHU as libc::c_int &&
                       Actor_WorldDistXYZToActor(thisx, bomb) < 80.0f32 &&
                       (((*thisx).shape.rot.y as libc::c_int -
                             ((*bomb).world.rot.y as libc::c_int -
                                  0x8000 as libc::c_int)) as s16 as
                            libc::c_int) < 0x3e80 as libc::c_int {
                    EnGeldB_SetupJump(this);
                    return 1 as libc::c_int
                } else {
            ...
            if arg2 != 0 {
                if angleToLink as libc::c_int >= 0x1b58 as libc::c_int {
                    EnGeldB_SetupSidestep(this, globalCtx);
                    return 1 as libc::c_int
                } else {
                    let mut angleToFacingLink: s16 =
                        ((*player).actor.shape.rot.y as libc::c_int -
                             (*thisx).shape.rot.y as libc::c_int) as s16;
                    if (*thisx).xzDistToPlayer <= 45.0f32 &&
                           Actor_OtherIsTargeted(globalCtx, thisx) == 0 &&
                           ((*globalCtx).gameplayFrames &
                                7 as libc::c_int as libc::c_uint != 0 ||
                                (if angleToFacingLink as libc::c_int >=
                                        0 as libc::c_int {
                                     angleToFacingLink as libc::c_int
                                 } else {
                                     -(angleToFacingLink as libc::c_int)
                                 }) < 0x38e0 as libc::c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupWait(mut this: *mut EnGeldB) {
    Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                               &mut gGerudoRedJumpAnim, 0.0f32);
    (*this).actor.world.pos.y = (*this).actor.home.pos.y + 120.0f32;
    (*this).timer = 10 as libc::c_int;
    (*this).invisible = 1 as libc::c_int as s16;
    (*this).action = GELDB_WAIT as libc::c_int;
    (*this).actor.bgCheckFlags =
        ((*this).actor.bgCheckFlags as libc::c_int & !(3 as libc::c_int)) as
            u16_0;
    (*this).actor.gravity = -2.0f32;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Wait as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Wait(mut this: *mut EnGeldB,
                                      mut globalCtx: *mut GlobalContext) {
    if (*this).invisible as libc::c_int != 0 &&
           Flags_GetSwitch(globalCtx, (*this).actor.home.rot.z as s32) == 0 ||
           (*this).actor.xzDistToPlayer > 300.0f32 {
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
        (*this).actor.world.pos.y = (*this).actor.floorHeight + 120.0f32
    } else {
        (*this).invisible = 0 as libc::c_int as s16;
        (*this).actor.shape.shadowScale = 90.0f32;
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupFlee(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedJumpAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedJumpAnim, -2.0f32,
                     lastFrame, 0.0f32,
    ...
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Flee as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Flee(mut this: *mut EnGeldB,
                                      mut globalCtx: *mut GlobalContext) {
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        Math_SmoothStepToF(&mut (*this).actor.world.pos.y,
                           (*this).actor.floorHeight + 300.0f32, 1.0f32,
                           20.5f32, 0.0f32);
        (*this).timer -= 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupReady(mut this: *mut EnGeldB) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gGerudoRedNeutralAnim,
                          -4.0f32);
    (*this).action = GELDB_READY as libc::c_int;
    (*this).timer = (Rand_ZeroOne() * 10.0f32 + 5.0f32) as s32;
    (*this).actor.speedXZ = 0.0f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Ready as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Ready(mut this: *mut EnGeldB,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if (*this).lookTimer as libc::c_int != 0 as libc::c_int {
        angleToLink =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int -
                 (*this).headRot.y as libc::c_int) as s16;
        if (if angleToLink as libc::c_int >= 0 as libc::c_int {
                angleToLink as libc::c_int
            } else { -(angleToLink as libc::c_int) }) > 0x2000 as libc::c_int
           {
            (*this).lookTimer -= 1;
            return
        }
        (*this).lookTimer = 0 as libc::c_int as s16
    }
    angleToLink =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 {
        if (*this).unkTimer as libc::c_int != 0 as libc::c_int {
            (*this).unkTimer -= 1;
            if (if angleToLink as libc::c_int >= 0 as libc::c_int {
                    angleToLink as libc::c_int
                } else { -(angleToLink as libc::c_int) }) >=
                   0x1ffe as libc::c_int {
                return
            }
            (*this).unkTimer = 0 as libc::c_int as s16
        } else if EnGeldB_ReactToPlayer(globalCtx, this,
        ...
        if (*this).actor.xzDistToPlayer < 100.0f32 &&
            ...
            if (*this).timer == 0 as libc::c_int {
                if Actor_IsFacingPlayer(&mut (*this).actor,
                   ...
                   {
                    if 210.0f32 > (*this).actor.xzDistToPlayer &&
                           (*this).actor.xzDistToPlayer > 150.0f32 &&
                           Rand_ZeroOne() < 0.3f32 {
                        if Actor_OtherIsTargeted(globalCtx,
                                                 &mut (*this).actor) != 0 ||
                               Rand_ZeroOne() > 0.5f32 ||
                               (if angleToLink as libc::c_int >=
                                       0 as libc::c_int {
                                    angleToLink as libc::c_int
                                } else { -(angleToLink as libc::c_int) }) <
                                   0x38e0 as libc::c_int {
                            EnGeldB_SetupRollForward(this);
                        } else { EnGeldB_SetupSpinAttack(this); }
                    } else if Rand_ZeroOne() > 0.3f32 {
                        EnGeldB_SetupAdvance(this, globalCtx);
                    } else { EnGeldB_SetupCircle(this); }
                } else { EnGeldB_SetupPivot(this); }
                if (*globalCtx).gameplayFrames &
                       0x5f as libc::c_int as libc::c_uint ==
                       0 as libc::c_int as libc::c_uint {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x39c6 as libc::c_int as u16_0);
                }
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupAdvance(mut this: *mut EnGeldB,
                                              mut globalCtx:
                                                  *mut GlobalContext) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedWalkAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedWalkAnim, 1.0f32,
                     0.0f32, lastFrame,
                     ANIMMODE_LOOP_INTERP as libc::c_int as u8_0, -4.0f32);
    (*this).action = GELDB_ADVANCE as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Advance as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Advance(mut this: *mut EnGeldB,
                                         mut globalCtx: *mut GlobalContext) {
    let mut thisKeyFrame: s32 = 0;
    let mut prevKeyFrame: s32 = 0;
    let mut playSpeed: s32 = 0;
    let mut facingAngletoLink: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 {
        Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                           ...
                           0 as libc::c_int as s16);
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        if (*this).actor.xzDistToPlayer <= 40.0f32 {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, -8.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else if (*this).actor.xzDistToPlayer > 55.0f32 {
            Math_SmoothStepToF(&mut (*this).actor.speedXZ, 8.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else {
        ...
        (*this).skelAnime.playSpeed = (*this).actor.speedXZ / 8.0f32;
        facingAngletoLink =
            ((*player).actor.shape.rot.y as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        facingAngletoLink =
            if facingAngletoLink as libc::c_int >= 0 as libc::c_int {
                facingAngletoLink as libc::c_int
            } else { -(facingAngletoLink as libc::c_int) } as s16;
        if (*this).actor.xzDistToPlayer < 150.0f32 &&
               (*player).swordState as libc::c_int != 0 as libc::c_int &&
               facingAngletoLink as libc::c_int >= 0x1f40 as libc::c_int {
            (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
            (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
            if Rand_ZeroOne() > 0.7f32 { EnGeldB_SetupCircle(this); return }
        }
        thisKeyFrame = (*this).skelAnime.curFrame as s32;
        SkelAnime_Update(&mut (*this).skelAnime);
        prevKeyFrame =
        ...
        if Actor_IsFacingPlayer(&mut (*this).actor,
            ...
            if Rand_ZeroOne() > 0.5f32 {
                EnGeldB_SetupCircle(this);
            } else { EnGeldB_SetupReady(this); }
        } else if (*this).actor.xzDistToPlayer < 90.0f32 {
            if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
                   (Rand_ZeroOne() > 0.03f32 ||
                        (*this).actor.xzDistToPlayer <= 45.0f32 &&
                            (facingAngletoLink as libc::c_int) <
                                0x38e0 as libc::c_int) {
                EnGeldB_SetupSlash(this);
            } else if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) !=
                          0 && Rand_ZeroOne() > 0.5f32 {
                EnGeldB_SetupRollBack(this);
            } else { EnGeldB_SetupCircle(this); }
        }
        if EnGeldB_ReactToPlayer(globalCtx, this, 0 as libc::c_int as s16) ==
               0 {
            if 210.0f32 > (*this).actor.xzDistToPlayer &&
                   (*this).actor.xzDistToPlayer > 150.0f32 &&
                ...
                } else { EnGeldB_SetupCircle(this); return }
            }
            if (*globalCtx).gameplayFrames &
                   0x5f as libc::c_int as libc::c_uint ==
                   0 as libc::c_int as libc::c_uint {
            ...
            if thisKeyFrame != (*this).skelAnime.curFrame as s32 {
                let mut temp: s32 = playSpeed + thisKeyFrame;
                if prevKeyFrame < 0 as libc::c_int && temp > 0 as libc::c_int
                       ||
                       prevKeyFrame < 4 as libc::c_int &&
                           temp > 4 as libc::c_int {
                    Audio_PlayActorSound2(&mut (*this).actor,
                                          0x39a0 as libc::c_int as u16_0);
                }
            }
        }
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupRollForward(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedFlipAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedFlipAnim, -1.0f32,
                     lastFrame, 0.0f32, ANIMMODE_ONCE as libc::c_int as u8_0,
                     -3.0f32);
    (*this).timer = 0 as libc::c_int;
    (*this).invisible = 1 as libc::c_int as s16;
    (*this).action = GELDB_ROLL_FORWARD as libc::c_int;
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).actor.speedXZ = 10.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_RollForward as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_RollForward(mut this: *mut EnGeldB,
                                             mut globalCtx:
                                                 *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut facingAngleToLink: s16 =
        ((*player).actor.shape.rot.y as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        (*this).invisible = 0 as libc::c_int as s16;
        (*this).actor.speedXZ = 0.0f32;
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                0x1554 as libc::c_int as s16) == 0 {
            EnGeldB_SetupReady(this);
            (*this).timer = (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
            if (if facingAngleToLink as libc::c_int >= 0 as libc::c_int {
                    facingAngleToLink as libc::c_int
                } else { -(facingAngleToLink as libc::c_int) }) <
                   0x38e0 as libc::c_int {
                (*this).lookTimer = 20 as libc::c_int as s16
            }
        } else if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
                      (Rand_ZeroOne() > 0.5f32 ||
                           (if facingAngleToLink as libc::c_int >=
                                   0 as libc::c_int {
                                facingAngleToLink as libc::c_int
                            } else { -(facingAngleToLink as libc::c_int) }) <
                               0x3ffc as libc::c_int) {
            EnGeldB_SetupSlash(this);
        } else { EnGeldB_SetupAdvance(this, globalCtx); }
    }
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupPivot(mut this: *mut EnGeldB) {
    Animation_MorphToLoop(&mut (*this).skelAnime, &mut gGerudoRedSidestepAnim,
                          -4.0f32);
    (*this).action = GELDB_PIVOT as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Pivot as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Pivot(mut this: *mut EnGeldB,
                                       mut globalCtx: *mut GlobalContext) {
    let mut angleToLink: s16 = 0;
    let mut turnRate: s16 = 0;
    let mut playSpeed: f32_0 = 0.;
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 &&
           EnGeldB_ReactToPlayer(globalCtx, this, 0 as libc::c_int as s16) ==
               0 {
        angleToLink =
            ((*this).actor.yawTowardsPlayer as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        turnRate =
            if angleToLink as libc::c_int > 0 as libc::c_int {
                (angleToLink as libc::c_int as libc::c_float * 0.25f32) +
                    2000.0f32
            } else {
                (angleToLink as libc::c_int as libc::c_float * 0.25f32) -
                    2000.0f32
        ...
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int +
                 turnRate as libc::c_int) as s16;
        (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
        if angleToLink as libc::c_int > 0 as libc::c_int {
            playSpeed = turnRate as libc::c_int as libc::c_float * 0.5f32;
        ...
        SkelAnime_Update(&mut (*this).skelAnime);
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                (30 as libc::c_int * 0x10000 as libc::c_int /
                                     360 as libc::c_int) as s16) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupCircle(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedSidestepAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedSidestepAnim,
    ...
    (*this).timer = (Rand_ZeroOne() * 30.0f32 + 30.0f32) as s32;
    (*this).action = GELDB_CIRCLE as libc::c_int;
    (*this).approachRate = 0.0f32;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Circle as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Circle(mut this: *mut EnGeldB,
                                        mut globalCtx: *mut GlobalContext) {
    let mut angleBehindLink: s16 = 0;
    let mut phi_v1: s16 = 0;
    let mut nextKeyFrame: s32 = 0;
    let mut thisKeyFrame: s32 = 0;
    let mut pad: s32 = 0;
    let mut prevKeyFrame: s32 = 0;
    let mut player: *mut Player =
    ...
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 &&
        ...
        if Math_SinS((angleBehindLink as libc::c_int -
                          (*this).actor.shape.rot.y as libc::c_int) as s16) >=
               0.0f32 {
        ...
        } else if Math_SinS((angleBehindLink as libc::c_int -
        ...
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0
            ...
            if (if phi_v1 as libc::c_int >= 0 as libc::c_int {
                    phi_v1 as libc::c_int
                } else { -(phi_v1 as libc::c_int) }) > 0x4000 as libc::c_int {
                (*this).actor.speedXZ *= -0.8f32;
                if (*this).actor.speedXZ < 0.0f32 {
        ...
        if (*this).actor.xzDistToPlayer <= 45.0f32 {
            Math_SmoothStepToF(&mut (*this).approachRate, -4.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else if (*this).actor.xzDistToPlayer > 40.0f32 {
            Math_SmoothStepToF(&mut (*this).approachRate, 4.0f32, 1.0f32,
                               1.5f32, 0.0f32);
        } else {
            Math_SmoothStepToF(&mut (*this).approachRate, 0.0f32, 1.0f32,
                               6.65f32, 0.0f32);
        }
        if (*this).approachRate != 0.0f32 {
            (*this).actor.world.pos.x +=
                Math_SinS((*this).actor.shape.rot.y) * (*this).approachRate;
            (*this).actor.world.pos.z +=
                Math_CosS((*this).actor.shape.rot.y) * (*this).approachRate
        }
        if (if (*this).approachRate >= 0 as libc::c_int as libc::c_float {
                (*this).approachRate
            } else { -(*this).approachRate }) <
               (if (*this).actor.speedXZ >= 0 as libc::c_int as libc::c_float
                   {
                    (*this).actor.speedXZ
                } else { -(*this).actor.speedXZ }) {
            (*this).skelAnime.playSpeed = -(*this).actor.speedXZ * 0.5f32
        } else {
            (*this).skelAnime.playSpeed = -(*this).approachRate * 0.5f32
        }
        (*this).skelAnime.playSpeed =
            if (*this).skelAnime.playSpeed < -3.0f32 {
                -3.0f32
            } else if (*this).skelAnime.playSpeed > 3.0f32 {
                3.0f32
        ...
        nextKeyFrame =
            (if (*this).skelAnime.playSpeed >=
                    0 as libc::c_int as libc::c_float {
                 (*this).skelAnime.playSpeed
             } else { -(*this).skelAnime.playSpeed }) as s32 + thisKeyFrame;
        if thisKeyFrame != (*this).skelAnime.curFrame as s32 &&
               (prevKeyFrame < 0 as libc::c_int &&
                    (0 as libc::c_int) < nextKeyFrame ||
                    prevKeyFrame < 5 as libc::c_int &&
                        (5 as libc::c_int) < nextKeyFrame) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39a0 as libc::c_int as u16_0);
        }
        if (*globalCtx).gameplayFrames & 0x5f as libc::c_int as libc::c_uint
        ...
        if Math_CosS((angleBehindLink as libc::c_int -
                          (*this).actor.shape.rot.y as libc::c_int) as s16) <
               -0.85f32 &&
               Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
               (*this).actor.xzDistToPlayer <= 45.0f32 {
            EnGeldB_SetupSlash(this);
        } else {
            (*this).timer -= 1;
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupSpinDodge(mut this: *mut EnGeldB,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut sp3E: s16 = 0;
    let mut player: *mut Player =
    ...
    if Math_SinS((sp3E as libc::c_int -
                      (*this).actor.shape.rot.y as libc::c_int) as s16) >
           0.0f32 {
        (*this).actor.speedXZ = -10.0f32
    } else if Math_SinS((sp3E as libc::c_int -
                             (*this).actor.shape.rot.y as libc::c_int) as s16)
                  < 0.0f32 {
        (*this).actor.speedXZ = 10.0f32
    ...
    (*this).skelAnime.playSpeed = -(*this).actor.speedXZ * 0.5f32;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    (*this).timer = 6 as libc::c_int;
    (*this).approachRate = 0.0f32;
    (*this).unkFloat = 0.0f32;
    (*this).action = GELDB_SPIN_DODGE as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_SpinDodge as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SpinDodge(mut this: *mut EnGeldB,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut phi_v1: s16 = 0;
    let mut thisKeyFrame: s32 = 0;
    let mut pad: s32 = 0;
    let mut lastKeyFrame: s32 = 0;
    let mut nextKeyFrame: s32 = 0;
    (*this).actor.world.rot.y =
        ((*this).actor.yawTowardsPlayer as libc::c_int +
             0x3a98 as libc::c_int) as s16;
    if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 ||
           Actor_TestFloorInDirection(&mut (*this).actor, globalCtx,
                                      (*this).actor.speedXZ,
                                      ((*this).actor.shape.rot.y as
                                           libc::c_int +
                                           0x3e80 as libc::c_int) as s16) == 0
       {
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0 {
            if (*this).actor.speedXZ >= 0.0f32 {
                phi_v1 =
            ...
            phi_v1 =
                ((*this).actor.wallYaw as libc::c_int - phi_v1 as libc::c_int)
                    as s16
        } else {
            (*this).actor.speedXZ *= -0.8f32;
            phi_v1 = 0 as libc::c_int as s16
    ...
    if (*this).actor.xzDistToPlayer <= 45.0f32 {
        Math_SmoothStepToF(&mut (*this).approachRate, -4.0f32, 1.0f32, 1.5f32,
                           0.0f32);
    } else if (*this).actor.xzDistToPlayer > 40.0f32 {
        Math_SmoothStepToF(&mut (*this).approachRate, 4.0f32, 1.0f32, 1.5f32,
                           0.0f32);
    } else {
        Math_SmoothStepToF(&mut (*this).approachRate, 0.0f32, 1.0f32, 6.65f32,
                           0.0f32);
    }
    if (*this).approachRate != 0.0f32 {
        (*this).actor.world.pos.x +=
            Math_SinS((*this).actor.yawTowardsPlayer) * (*this).approachRate;
        (*this).actor.world.pos.z +=
            Math_CosS((*this).actor.yawTowardsPlayer) * (*this).approachRate
    }
    if (if (*this).approachRate >= 0 as libc::c_int as libc::c_float {
            (*this).approachRate
        } else { -(*this).approachRate }) <
        ...
        (*this).skelAnime.playSpeed = -(*this).actor.speedXZ * 0.5f32
    } else { (*this).skelAnime.playSpeed = -(*this).approachRate * 0.5f32 }
    (*this).skelAnime.playSpeed =
        if (*this).skelAnime.playSpeed < -3.0f32 {
            -3.0f32
        } else if (*this).skelAnime.playSpeed > 3.0f32 {
    ...
    if thisKeyFrame != (*this).skelAnime.curFrame as s32 &&
           (lastKeyFrame < 0 as libc::c_int &&
                (0 as libc::c_int) < nextKeyFrame ||
                lastKeyFrame < 5 as libc::c_int &&
                    (5 as libc::c_int) < nextKeyFrame) {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x39a0 as libc::c_int as u16_0);
    }
    ...
    if (*this).timer == 0 as libc::c_int {
        ...
        if EnGeldB_DodgeRanged(globalCtx, this) == 0 {
            if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
                ...
                EnGeldB_SetupSlash(this);
            } else { EnGeldB_SetupRollBack(this); }
        }
    } else if (*this).actor.speedXZ >= 0.0f32 {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int + 0x4000 as libc::c_int)
                as s16
    } else {
        (*this).actor.shape.rot.y =
            ((*this).actor.shape.rot.y as libc::c_int - 0x4000 as libc::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupSlash(mut this: *mut EnGeldB) {
    Animation_PlayOnce(&mut (*this).skelAnime, &mut gGerudoRedSlashAnim);
    (*this).swordCollider.base.atFlags =
        ((*this).swordCollider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
    (*this).action = GELDB_SLASH as libc::c_int;
    (*this).spinAttackState = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    Audio_StopSfxByPosAndId(&mut (*this).actor.projectedPos,
                            0x39c6 as libc::c_int as u16_0);
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Slash as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Slash(mut this: *mut EnGeldB,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut angleFacingLink: s16 =
        ((*player).actor.shape.rot.y as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    let mut angleToLink: s16 =
        ((*this).actor.yawTowardsPlayer as libc::c_int -
             (*this).actor.shape.rot.y as libc::c_int) as s16;
    angleFacingLink =
        if angleFacingLink as libc::c_int >= 0 as libc::c_int {
            angleFacingLink as libc::c_int
        } else { -(angleFacingLink as libc::c_int) } as s16;
    angleToLink =
        if angleToLink as libc::c_int >= 0 as libc::c_int {
            angleToLink as libc::c_int
        } else { -(angleToLink as libc::c_int) } as s16;
    ...
    if (*this).skelAnime.curFrame as s32 == 1 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3998 as libc::c_int as u16_0);
        (*this).swordState = 1 as libc::c_int as s16
    } else if (*this).skelAnime.curFrame as s32 == 6 as libc::c_int {
        (*this).swordState = -(1 as libc::c_int) as s16
    }
        ...
        (*this).swordCollider.base.atFlags =
            ((*this).swordCollider.base.atFlags as libc::c_int &
                 !((1 as libc::c_int) << 1 as libc::c_int |
                       (1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
        EnGeldB_SetupRollBack(this);
    } else if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                0x1554 as libc::c_int as s16) == 0 {
            EnGeldB_SetupReady(this);
            (*this).timer = (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
            if angleToLink as libc::c_int > 0x4000 as libc::c_int {
                (*this).lookTimer = 20 as libc::c_int as s16
            }
            ...
            if Rand_ZeroOne() > 0.7f32 {
                EnGeldB_SetupSidestep(this, globalCtx);
            } else if angleFacingLink as libc::c_int <= 0x2710 as libc::c_int
             {
                if angleToLink as libc::c_int > 0x3e80 as libc::c_int {
                    (*this).actor.world.rot.y =
                        (*this).actor.yawTowardsPlayer;
                    EnGeldB_SetupCircle(this);
                } else {
                    EnGeldB_ReactToPlayer(globalCtx, this,
                                          1 as libc::c_int as s16);
                }
            } else { EnGeldB_SetupCircle(this); }
        }
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupSpinAttack(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedSpinAttackAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedSpinAttackAnim,
                     1.0f32, 0.0f32, lastFrame,
    ...
    (*this).swordCollider.base.atFlags =
        ((*this).swordCollider.base.atFlags as libc::c_int &
             !((1 as libc::c_int) << 1 as libc::c_int |
                   (1 as libc::c_int) << 2 as libc::c_int)) as u8_0;
    (*this).action = GELDB_SPIN_ATTACK as libc::c_int;
    (*this).spinAttackState = 0 as libc::c_int as s16;
    (*this).actor.speedXZ = 0.0f32;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_SpinAttack as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SpinAttack(mut this: *mut EnGeldB,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    let mut angleFacingLink: s16 = 0;
    let mut angleToLink: s16 = 0;
    if ((*this).spinAttackState as libc::c_int) < 2 as libc::c_int {
        if (*this).swordCollider.base.atFlags as libc::c_int &
               (1 as libc::c_int) << 2 as libc::c_int != 0 {
            (*this).swordCollider.base.atFlags =
                ((*this).swordCollider.base.atFlags as libc::c_int &
    ...
    if ((*this).skelAnime.curFrame as s32) < 9 as libc::c_int {
        (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
        (*this).actor.shape.rot.y = (*this).actor.world.rot.y
    } else if (*this).skelAnime.curFrame as s32 == 13 as libc::c_int {
        Actor_SpawnFloorDustRing(globalCtx, &mut (*this).actor,
                                 &mut (*this).leftFootPos, 3.0f32,
                                 2 as libc::c_int, 2.0f32,
                                 0 as libc::c_int as s16,
        ...
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x3998 as libc::c_int as u16_0);
    } else if (*this).skelAnime.curFrame as s32 == 21 as libc::c_int {
        (*this).actor.speedXZ = 0.0f32
    } else if (*this).skelAnime.curFrame as s32 == 24 as libc::c_int {
        (*this).swordState = -(1 as libc::c_int) as s16
    }
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 &&
           ((*this).spinAttackState as libc::c_int) < 2 as libc::c_int {
        if Actor_IsFacingPlayer(&mut (*this).actor,
                                0x1554 as libc::c_int as s16) == 0 {
            EnGeldB_SetupReady(this);
            (*this).timer = (Rand_ZeroOne() * 5.0f32 + 5.0f32) as s32;
            (*this).lookTimer = 46 as libc::c_int as s16
        } else if (*this).spinAttackState as libc::c_int != 0 as libc::c_int {
            EnGeldB_SetupRollBack(this);
        } else if Rand_ZeroOne() > 0.7f32 ||
                      (*this).actor.xzDistToPlayer >= 120.0f32 {
            EnGeldB_SetupReady(this);
            ...
            if Rand_ZeroOne() > 0.7f32 {
                ...
                if angleFacingLink as libc::c_int <= 0x2710 as libc::c_int {
                    angleToLink =
                        ((*this).actor.yawTowardsPlayer as libc::c_int -
                             (*this).actor.shape.rot.y as libc::c_int) as s16;
                    angleToLink =
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupRollBack(mut this: *mut EnGeldB) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime, &mut gGerudoRedFlipAnim,
                              -3.0f32);
    (*this).timer = 0 as libc::c_int;
    (*this).invisible = 1 as libc::c_int as s16;
    (*this).action = GELDB_ROLL_BACK as libc::c_int;
    (*this).actor.speedXZ = -8.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.shape.rot.y = (*this).actor.world.rot.y;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_RollBack as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_RollBack(mut this: *mut EnGeldB,
                                          mut globalCtx: *mut GlobalContext) {
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupStunned(mut this: *mut EnGeldB) {
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).actor.speedXZ = 0.0f32
    }
    if (*this).damageEffect as libc::c_int != GELDB_DMG_FREEZE as libc::c_int
           || (*this).action == GELDB_SPIN_ATTACK as libc::c_int {
        Animation_PlayOnceSetSpeed(&mut (*this).skelAnime,
                                   &mut gGerudoRedDamageAnim, 0.0f32);
    }
    if (*this).damageEffect as libc::c_int == GELDB_DMG_FREEZE as libc::c_int
       {
    ...
    (*this).action = GELDB_STUNNED as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Stunned as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Stunned(mut this: *mut EnGeldB,
                                         mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).actor.speedXZ = 0.0f32
    }
        ...
        if (*this).actor.colChkInfo.health as libc::c_int == 0 as libc::c_int
           {
            ...
            EnGeldB_ReactToPlayer(globalCtx, this, 1 as libc::c_int as s16);
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupDamaged(mut this: *mut EnGeldB) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gGerudoRedDamageAnim, -4.0f32);
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).invisible = 0 as libc::c_int as s16;
        (*this).actor.speedXZ = -4.0f32
    } else { (*this).invisible = 1 as libc::c_int as s16 }
    (*this).lookTimer = 0 as libc::c_int as s16;
    (*this).actor.world.rot.y = (*this).actor.yawTowardsPlayer;
    Audio_PlayActorSound2(&mut (*this).actor, 0x3999 as libc::c_int as u16_0);
    (*this).action = GELDB_DAMAGED as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Damaged as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Damaged(mut this: *mut EnGeldB,
                                         mut globalCtx: *mut GlobalContext) {
    let mut angleToWall: s16 = 0;
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).actor.speedXZ = 0.0f32
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       1 as libc::c_int as s16, 0x1194 as libc::c_int as s16,
                       0 as libc::c_int as s16);
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 &&
           EnGeldB_ReactToPlayer(globalCtx, this, 0 as libc::c_int as s16) ==
               0 && SkelAnime_Update(&mut (*this).skelAnime) != 0 &&
           (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        angleToWall =
            ((*this).actor.wallYaw as libc::c_int -
                 (*this).actor.shape.rot.y as libc::c_int) as s16;
        if (*this).actor.bgCheckFlags as libc::c_int & 8 as libc::c_int != 0
            ...
            EnGeldB_SetupJump(this);
        } else if EnGeldB_DodgeRanged(globalCtx, this) == 0 {
            if (*this).actor.xzDistToPlayer <= 45.0f32 &&
                   Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0
                   &&
                   (*globalCtx).gameplayFrames &
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupJump(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedFlipAnim as *mut AnimationHeader
                                   as *mut libc::c_void) as f32_0;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedFlipAnim, -1.0f32,
    ...
    (*this).timer = 0 as libc::c_int;
    (*this).invisible = 0 as libc::c_int as s16;
    (*this).action = GELDB_JUMP as libc::c_int;
    (*this).actor.speedXZ = 6.5f32;
    (*this).actor.velocity.y = 15.0f32;
    Audio_PlayActorSound2(&mut (*this).actor, 0x386c as libc::c_int as u16_0);
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Jump as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Jump(mut this: *mut EnGeldB,
                                      mut globalCtx: *mut GlobalContext) {
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       (*this).actor.yawTowardsPlayer,
                       1 as libc::c_int as s16, 0xfa0 as libc::c_int as s16,
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupBlock(mut this: *mut EnGeldB) {
    let mut lastFrame: f32_0 =
        Animation_GetLastFrame(&mut gGerudoRedBlockAnim as
                                   *mut AnimationHeader as *mut libc::c_void)
            as f32_0;
    ...
    (*this).actor.speedXZ = 0.0f32;
    (*this).action = GELDB_BLOCK as libc::c_int;
    (*this).timer = Rand_CenteredFloat(10.0f32) as s32 + 10 as libc::c_int;
    Animation_Change(&mut (*this).skelAnime, &mut gGerudoRedBlockAnim, 0.0f32,
                     0.0f32, lastFrame, ANIMMODE_ONCE as libc::c_int as u8_0,
                     0.0f32);
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Block as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Block(mut this: *mut EnGeldB,
                                       mut globalCtx: *mut GlobalContext) {
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    if SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        ...
        if (if angleToLink as libc::c_int >= 0 as libc::c_int {
                angleToLink as libc::c_int
            } else { -(angleToLink as libc::c_int) }) <= 0x4000 as libc::c_int
               && (*this).actor.xzDistToPlayer < 40.0f32 &&
               (if (*this).actor.yDistToPlayer >=
                       0 as libc::c_int as libc::c_float {
                    (*this).actor.yDistToPlayer
                } else { -(*this).actor.yDistToPlayer }) < 50.0f32 {
            if func_800354B4(globalCtx, &mut (*this).actor, 100.0f32,
                ...
                if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) == 0
                       ...
                       ((*globalCtx).gameplayFrames &
                            1 as libc::c_int as libc::c_uint != 0 ||
                            (if angleFacingLink as libc::c_int >=
                                    0 as libc::c_int {
                                 angleFacingLink as libc::c_int
                             } else { -(angleFacingLink as libc::c_int) }) <
                                0x38e0 as libc::c_int) {
                    EnGeldB_SetupSlash(this);
                } else { EnGeldB_SetupCircle(this); }
            }
        } else { EnGeldB_SetupCircle(this); }
    } else if (*this).timer == 0 as libc::c_int &&
        ...
        if (*player).swordAnimation as libc::c_int == 0x11 as libc::c_int {
            ...
            } else { EnGeldB_SetupBlock(this); }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupSidestep(mut this: *mut EnGeldB,
                                               mut globalCtx:
                                                   *mut GlobalContext) {
    let mut linkAngle: s16 = 0;
    ...
    if Math_SinS((linkAngle as libc::c_int -
                      (*this).actor.shape.rot.y as libc::c_int) as s16) >
           0.0f32 {
        (*this).actor.speedXZ = -6.0f32
    } else if Math_SinS((linkAngle as libc::c_int -
                             (*this).actor.shape.rot.y as libc::c_int) as s16)
                  < 0.0f32 {
        (*this).actor.speedXZ = 6.0f32
    } else { (*this).actor.speedXZ = Rand_CenteredFloat(12.0f32) }
    (*this).skelAnime.playSpeed = -(*this).actor.speedXZ * 0.5f32;
    (*this).approachRate = 0.0f32;
    (*this).actor.world.rot.y =
        ((*this).actor.shape.rot.y as libc::c_int + 0x3fff as libc::c_int) as
            s16;
    (*this).timer = (Rand_ZeroOne() * 10.0f32 + 5.0f32) as s32;
    (*this).action = GELDB_SIDESTEP as libc::c_int;
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Sidestep as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Sidestep(mut this: *mut EnGeldB,
                                          mut globalCtx: *mut GlobalContext) {
    let mut behindLinkAngle: s16 = 0;
    let mut phi_v1: s16 = 0;
    let mut player: *mut Player =
        (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as libc::c_int as
                                             usize].head as *mut Player;
    ...
    Math_SmoothStepToS(&mut (*this).actor.shape.rot.y,
                       ...
                       1 as libc::c_int as s16);
    behindLinkAngle =
        ((*player).actor.shape.rot.y as libc::c_int + 0x8000 as libc::c_int)
            as s16;
    if Math_SinS((behindLinkAngle as libc::c_int -
                      (*this).actor.shape.rot.y as libc::c_int) as s16) >
           0.0f32 {
        (*this).actor.speedXZ += 0.125f32
    } else if Math_SinS((behindLinkAngle as libc::c_int -
                             (*this).actor.shape.rot.y as libc::c_int) as s16)
                  <= 0.0f32 {
        (*this).actor.speedXZ -= 0.125f32
    }
    ...
    if EnGeldB_DodgeRanged(globalCtx, this) == 0 &&
        ...
        (*this).timer -= 1;
        if (*this).timer == 0 as libc::c_int {
            let mut angleFacingPlayer: s16 =
                ((*player).actor.shape.rot.y as libc::c_int -
                     (*this).actor.shape.rot.y as libc::c_int) as s16;
            angleFacingPlayer =
                if angleFacingPlayer as libc::c_int >= 0 as libc::c_int {
                    angleFacingPlayer as libc::c_int
                } else { -(angleFacingPlayer as libc::c_int) } as s16;
            if angleFacingPlayer as libc::c_int >= 0x3a98 as libc::c_int {
                EnGeldB_SetupReady(this);
                (*this).timer = (Rand_ZeroOne() * 5.0f32 + 1.0f32) as s32
            } else {
                let mut player2: *mut Player =
                    (*globalCtx).actorCtx.actorLists[ACTORCAT_PLAYER as
                                                         ...
                                                         usize].head as
                        *mut Player;
                let mut angleFacingPlayer2: s16 =
                    ((*player2).actor.shape.rot.y as libc::c_int -
                         (*this).actor.shape.rot.y as libc::c_int) as s16;
                (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
                if (*this).actor.xzDistToPlayer <= 45.0f32 &&
                       Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) ==
                           0 &&
                       ((*globalCtx).gameplayFrames &
                            3 as libc::c_int as libc::c_uint == 0 ||
                            (if angleFacingPlayer2 as libc::c_int >=
                                    0 as libc::c_int {
                                 angleFacingPlayer2 as libc::c_int
                             } else { -(angleFacingPlayer2 as libc::c_int) })
                                < 0x38e0 as libc::c_int) {
                    EnGeldB_SetupSlash(this);
                } else if 210.0f32 > (*this).actor.xzDistToPlayer &&
                              (*this).actor.xzDistToPlayer > 150.0f32 &&
                              (*globalCtx).gameplayFrames &
                                  1 as libc::c_int as libc::c_uint == 0 {
                    if Actor_OtherIsTargeted(globalCtx, &mut (*this).actor) !=
                           0 || Rand_ZeroOne() > 0.5f32 ||
                           (if angleFacingPlayer2 as libc::c_int >=
                                   0 as libc::c_int {
                                angleFacingPlayer2 as libc::c_int
        ...
        if thisKeyFrame != (*this).skelAnime.curFrame as s32 &&
               (prevKeyFrame < 0 as libc::c_int &&
                    playSpeed as s32 + thisKeyFrame > 0 as libc::c_int ||
                    prevKeyFrame < 5 as libc::c_int &&
                        playSpeed as s32 + thisKeyFrame > 5 as libc::c_int) {
            Audio_PlayActorSound2(&mut (*this).actor,
                                  0x39a0 as libc::c_int as u16_0);
        }
        if (*globalCtx).gameplayFrames & 0x5f as libc::c_int as libc::c_uint
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_SetupDefeated(mut this: *mut EnGeldB) {
    Animation_MorphToPlayOnce(&mut (*this).skelAnime,
                              &mut gGerudoRedDefeatAnim, -4.0f32);
    (*this).actor.shape.rot.y = (*this).actor.yawTowardsPlayer;
    (*this).actor.world.rot.y = (*this).actor.shape.rot.y;
    if (*this).actor.bgCheckFlags as libc::c_int & 1 as libc::c_int != 0 {
        (*this).invisible = 0 as libc::c_int as s16;
    ...
    (*this).action = GELDB_DEFEAT as libc::c_int;
    (*this).actor.flags &=
        !((1 as libc::c_int) << 0 as libc::c_int) as libc::c_uint;
    Audio_PlayActorSound2(&mut (*this).actor, 0x399a as libc::c_int as u16_0);
    EnGeldB_SetupAction(this,
                        Some(EnGeldB_Defeated as
                                 unsafe extern "C" fn(_: *mut EnGeldB,
                                                      _: *mut GlobalContext)
                                     -> ()));
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Defeated(mut this: *mut EnGeldB,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).actor.bgCheckFlags as libc::c_int & 2 as libc::c_int != 0 {
        (*this).actor.speedXZ = 0.0f32
    }
    ...
    } else if (*this).skelAnime.curFrame as s32 == 10 as libc::c_int {
        Audio_PlayActorSound2(&mut (*this).actor,
                              0x387a as libc::c_int as u16_0);
        func_800F5B58();
    };
...
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_TurnHead(mut this: *mut EnGeldB,
                                          mut globalCtx: *mut GlobalContext) {
    if (*this).action == GELDB_READY as libc::c_int &&
           (*this).lookTimer as libc::c_int != 0 as libc::c_int {
        (*this).headRot.y =
            (Math_SinS(((*this).lookTimer as libc::c_int *
                            0x1068 as libc::c_int) as s16) * 8920.0f32) as s16
    } else if (*this).action != GELDB_STUNNED as libc::c_int {
        if (*this).action != GELDB_SLASH as libc::c_int &&
               (*this).action != GELDB_SPIN_ATTACK as libc::c_int {
            Math_SmoothStepToS(&mut (*this).headRot.y,
                               ...
                               0 as libc::c_int as s16);
            (*this).headRot.y =
                if ((*this).headRot.y as libc::c_int) <
                       -(0x256f as libc::c_int) {
                    -(0x256f as libc::c_int)
                } else if (*this).headRot.y as libc::c_int >
                              0x256f as libc::c_int {
                    0x256f as libc::c_int
                } else { (*this).headRot.y as libc::c_int } as s16
        } else { (*this).headRot.y = 0 as libc::c_int as s16 }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_CollisionCheck(mut this: *mut EnGeldB,
                                                mut globalCtx:
                                                    *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut key: *mut EnItem00 = 0 as *mut EnItem00;
    if (*this).blockCollider.base.acFlags as libc::c_int &
           (1 as libc::c_int) << 7 as libc::c_int != 0 {
        (*this).blockCollider.base.acFlags =
            ((*this).blockCollider.base.acFlags as libc::c_int &
        ...
        if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
            ...
            if (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                   ...
                   (*this).actor.colChkInfo.damageEffect as libc::c_int ==
                       GELDB_DMG_FREEZE as libc::c_int {
                if (*this).action != GELDB_STUNNED as libc::c_int {
                    ...
                    if (*this).keyFlag as libc::c_int != 0 as libc::c_int {
                        ...
                        if !key.is_null() {
                            (*key).actor.world.rot.y =
                                Math_Vec3f_Yaw(&mut (*key).actor.world.pos,
                                               &mut (*this).actor.home.pos);
                            (*key).actor.speedXZ = 6.0f32;
                            Audio_PlaySoundGeneral(0x4807 as libc::c_int as
                ...
                } else { EnGeldB_SetupDamaged(this); }
            }
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Update(mut thisx: *mut Actor,
                                        mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut EnGeldB = thisx as *mut EnGeldB;
    ...
    if (*this).actor.colChkInfo.damageEffect as libc::c_int !=
        ...
        Actor_UpdateBgCheckInfo(globalCtx, &mut (*this).actor, 15.0f32,
    ...
    if (*this).action == GELDB_BLOCK as libc::c_int &&
           (*this).skelAnime.curFrame == 0.0f32 {
        CollisionCheck_SetAC(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).blockCollider.base);
    }
    if (*this).swordState as libc::c_int > 0 as libc::c_int {
        CollisionCheck_SetAT(globalCtx, &mut (*globalCtx).colChkCtx,
                             &mut (*this).swordCollider.base);
    }
    if (*this).blinkState as libc::c_int == 0 as libc::c_int {
        if Rand_ZeroOne() < 0.1f32 &&
               (*globalCtx).gameplayFrames.wrapping_rem(4 as libc::c_int as
                                                            libc::c_uint) ==
                   0 as libc::c_int as libc::c_uint {
            (*this).blinkState = (*this).blinkState.wrapping_add(1)
        }
    } else {
        (*this).blinkState =
            ((*this).blinkState as libc::c_int + 1 as libc::c_int &
                 3 as libc::c_int) as u8_0
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_OverrideLimbDraw(mut globalCtx:
                                                      *mut GlobalContext,
                                                  mut limbIndex: s32,
 ...
 -> s32 {
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_geldB.c\x00" as *const u8 as
                        *const libc::c_char, 2507 as libc::c_int);
    if limbIndex == GELDB_LIMB_NECK as libc::c_int {
        (*rot).z =
        ...
        (*rot).x =
            ((*rot).x as libc::c_int + (*this).headRot.y as libc::c_int) as
                s16;
        (*rot).y =
            ((*rot).y as libc::c_int + (*this).headRot.z as libc::c_int) as
                s16
    } else if limbIndex == GELDB_LIMB_HEAD as libc::c_int {
            ...
            (80 as libc::c_int as u32_0 &
                ...
                (255 as libc::c_int as u32_0 &
                     (((0x1 as libc::c_int) << 8 as libc::c_int) -
                          1 as libc::c_int) as libc::c_uint) <<
                    0 as libc::c_int
    } else if limbIndex == GELDB_LIMB_R_SWORD as libc::c_int ||
                  limbIndex == GELDB_LIMB_L_SWORD as libc::c_int {
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_geldB.c\x00" as *const u8 as
                         *const libc::c_char, 2529 as libc::c_int);
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_PostLimbDraw(mut globalCtx:
                                                  *mut GlobalContext,
                                              mut limbIndex: s32,
                                              mut dList: *mut *mut Gfx,
                                              mut rot: *mut Vec3s,
    ...
    static mut swordTipOffset: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: -3000.0f32, z: 0.0f32,}; init };
    static mut swordHiltOffset: Vec3f =
        { let mut init = Vec3f{x: 400.0f32, y: 0.0f32, z: 0.0f32,}; init };
    static mut swordQuadOffset1: Vec3f =
        {
            let mut init = Vec3f{x: 1600.0f32, y: -4000.0f32, z: 0.0f32,};
            init
        };
    static mut swordQuadOffset0: Vec3f =
        {
            let mut init = Vec3f{x: -3000.0f32, y: -2000.0f32, z: 1300.0f32,};
            init
        };
    static mut swordQuadOffset3: Vec3f =
        {
            let mut init =
                Vec3f{x: -3000.0f32, y: -2000.0f32, z: -1300.0f32,};
            init
        };
    static mut swordQuadOffset2: Vec3f =
        {
            let mut init = Vec3f{x: 1000.0f32, y: 1000.0f32, z: 0.0f32,};
            init
        };
    static mut zeroVec: Vec3f =
        { let mut init = Vec3f{x: 0.0f32, y: 0.0f32, z: 0.0f32,}; init };
    let mut swordTip: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut swordHilt: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
    let mut this: *mut EnGeldB = thisx as *mut EnGeldB;
    let mut bodyPart: s32 = -(1 as libc::c_int);
    if limbIndex == GELDB_LIMB_R_SWORD as libc::c_int {
        ...
        Collider_SetQuadVertices(&mut (*this).swordCollider,
                                 ...
                                 &mut *(*this).swordCollider.dim.quad.as_mut_ptr().offset(3
                                                                                              ...
                                                                                              as
                                                                                              isize));
        Matrix_MultVec3f(&mut swordTipOffset, &mut swordTip);
        Matrix_MultVec3f(&mut swordHiltOffset, &mut swordHilt);
        if ((*this).swordState as libc::c_int) < 0 as libc::c_int ||
               (*this).action != GELDB_SLASH as libc::c_int &&
                   (*this).action != GELDB_SPIN_ATTACK as libc::c_int {
            EffectBlure_AddSpace(Effect_GetByIndex((*this).blureIndex) as
                                     *mut EffectBlure);
            (*this).swordState = 0 as libc::c_int as s16
        } else if (*this).swordState as libc::c_int > 0 as libc::c_int {
            EffectBlure_AddVertex(Effect_GetByIndex((*this).blureIndex) as
                                      *mut EffectBlure, &mut swordTip,
                                  &mut swordHilt);
        }
    } else {
        Actor_SetFeetPos(&mut (*this).actor, limbIndex,
                         GELDB_LIMB_L_FOOT as libc::c_int, &mut footOffset,
                         GELDB_LIMB_R_FOOT as libc::c_int, &mut footOffset);
    }
    if limbIndex == GELDB_LIMB_L_FOOT as libc::c_int {
        Matrix_MultVec3f(&mut footOffset, &mut (*this).leftFootPos);
    } else if limbIndex == GELDB_LIMB_R_FOOT as libc::c_int {
        Matrix_MultVec3f(&mut footOffset, &mut (*this).rightFootPos);
    }
    if (*this).iceTimer as libc::c_int != 0 as libc::c_int {
        match limbIndex {
            3 => { bodyPart = 0 as libc::c_int }
            16 => { bodyPart = 1 as libc::c_int }
            11 => { bodyPart = 2 as libc::c_int }
            12 => { bodyPart = 3 as libc::c_int }
            7 => { bodyPart = 4 as libc::c_int }
            2 => { bodyPart = 5 as libc::c_int }
            23 => { bodyPart = 6 as libc::c_int }
            19 => { bodyPart = 7 as libc::c_int }
            22 => { bodyPart = 8 as libc::c_int }
            _ => { }
        }
        if bodyPart >= 0 as libc::c_int {
            let mut limbPos: Vec3f = Vec3f{x: 0., y: 0., z: 0.,};
            Matrix_MultVec3f(&mut zeroVec, &mut limbPos);
            (*this).bodyPartsPos[bodyPart as usize].x = limbPos.x as s16;
            (*this).bodyPartsPos[bodyPart as usize].y = limbPos.y as s16;
            (*this).bodyPartsPos[bodyPart as usize].z = limbPos.z as s16
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_Draw(mut thisx: *mut Actor,
                                      mut globalCtx: *mut GlobalContext) {
    static mut blockTrisOffsets0: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -3000.0f32, y: 6000.0f32, z: 1600.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: -3000.0f32, y: 0.0f32, z: 1600.0f32,};
             init
         },
         {
             let mut init = Vec3f{x: 3000.0f32, y: 6000.0f32, z: 1600.0f32,};
    ...
    static mut blockTrisOffsets1: [Vec3f; 3] =
        [{
             let mut init = Vec3f{x: -3000.0f32, y: 0.0f32, z: 1600.0f32,};
             init
         },
    ...
    static mut eyeTextures: [*mut libc::c_void; 4] =
        unsafe {
            [gGerudoRedEyeOpenTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGerudoRedEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGerudoRedEyeShutTex.as_ptr() as *mut _ as *mut libc::c_void,
             gGerudoRedEyeHalfTex.as_ptr() as *mut _ as *mut libc::c_void]
        };
    let mut pad: s32 = 0;
    let mut this: *mut EnGeldB = thisx as *mut EnGeldB;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_en_geldB.c\x00" as *const u8 as
                        *const libc::c_char, 2672 as libc::c_int);
    if (*this).spinAttackState as libc::c_int >= 2 as libc::c_int &&
           SkelAnime_Update(&mut (*this).skelAnime) != 0 {
        if (*this).spinAttackState as libc::c_int == 2 as libc::c_int {
            Animation_Change(&mut (*this).skelAnime,
                             &mut gGerudoRedSpinAttackAnim, 0.5f32, 0.0f32,
                             12.0f32,
            ...
            if (*this).timer == 0 as libc::c_int {
                if gSaveContext.inventory.items[gItemSlots[ITEM_HOOKSHOT as
                       ...
                       gSaveContext.inventory.items[gItemSlots[ITEM_LONGSHOT
                                                                   as
                                                                   libc::c_int
                                                                   as usize]
                                                        as usize] as
                    ...
                    (*globalCtx).nextEntranceIndex =
                        0x1a5 as libc::c_int as s16
                } else if gSaveContext.eventChkInf[12 as libc::c_int as usize]
                              as libc::c_int & 0x80 as libc::c_int != 0 {
                    (*globalCtx).nextEntranceIndex =
                        0x5f8 as libc::c_int as s16
                } else {
                    (*globalCtx).nextEntranceIndex =
                        0x3b4 as libc::c_int as s16
                }
    ...
    if (*this).action != GELDB_WAIT as libc::c_int || (*this).invisible == 0 {
        ...
        (*_g).words.w0 =
            (0xdb as libc::c_int as u32_0 &
                ...
                ((0x8 as libc::c_int * 4 as libc::c_int) as u32_0 &
                    ...
                    0 as libc::c_int;
        (*_g).words.w1 =
            gSegments[((eyeTextures[(*this).blinkState as usize] as u32_0) <<
                           4 as libc::c_int >> 28 as libc::c_int) as
                          usize].wrapping_add(eyeTextures[(*this).blinkState
                                                              as usize] as
                                                  u32_0 &
        ...
        SkelAnime_DrawFlexOpa(globalCtx, (*this).skelAnime.skeleton,
                              ...
                              Some(EnGeldB_OverrideLimbDraw as
                                       unsafe extern "C" fn(_:
                                                                *mut GlobalContext,
                                                            _: s32,
                                                            _: *mut *mut Gfx,
        ...
        if (*this).action == GELDB_BLOCK as libc::c_int {
            let mut i: s32 = 0;
            let mut blockTrisVtx0: [Vec3f; 3] =
                [Vec3f{x: 0., y: 0., z: 0.,}; 3];
            let mut blockTrisVtx1: [Vec3f; 3] =
                [Vec3f{x: 0., y: 0., z: 0.,}; 3];
            i = 0 as libc::c_int;
            while i < 3 as libc::c_int {
                Matrix_MultVec3f(&mut *blockTrisOffsets0.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize),
                                 &mut *blockTrisVtx0.as_mut_ptr().offset(i as
                                                                             isize));
                Matrix_MultVec3f(&mut *blockTrisOffsets1.as_mut_ptr().offset(i
                                                                                 as
                                                                                 isize),
                                 &mut *blockTrisVtx1.as_mut_ptr().offset(i as
                                                                             isize));
                i += 1
            }
            Collider_SetTrisVertices(&mut (*this).blockCollider,
                                     0 as libc::c_int,
                                     &mut *blockTrisVtx0.as_mut_ptr().offset(0
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                     &mut *blockTrisVtx0.as_mut_ptr().offset(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                     &mut *blockTrisVtx0.as_mut_ptr().offset(2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize));
            Collider_SetTrisVertices(&mut (*this).blockCollider,
                                     1 as libc::c_int,
                                     &mut *blockTrisVtx1.as_mut_ptr().offset(0
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                     &mut *blockTrisVtx1.as_mut_ptr().offset(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize),
                                     &mut *blockTrisVtx1.as_mut_ptr().offset(2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 isize));
    ...
    Graph_CloseDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                     b"../z_en_geldB.c\x00" as *const u8 as
                         *const libc::c_char, 2744 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn EnGeldB_DodgeRanged(mut globalCtx:
                                                 *mut GlobalContext,
                                             mut this: *mut EnGeldB) -> s32 {
    let mut actor: *mut Actor =
        Actor_GetProjectileActor(globalCtx, &mut (*this).actor, 800.0f32);
    if !actor.is_null() {
        let mut angleToFacing: s16 = 0;
        let mut pad18: s16 = 0;
        let mut dist: f32_0 = 0.;
        angleToFacing =
            (Actor_WorldYawTowardActor(&mut (*this).actor, actor) as
                 libc::c_int - (*this).actor.shape.rot.y as libc::c_int) as
                s16;
        (*this).actor.world.rot.y =
            ((*this).actor.shape.rot.y as u16_0 as libc::c_int &
                 0xffff as libc::c_int) as s16;
        dist =
            Actor_WorldDistXYZToPoint(&mut (*this).actor,
                                      &mut (*actor).world.pos);
        // ! @bug
        ...
        if (if angleToFacing as libc::c_int >= 0 as libc::c_int {
                angleToFacing as libc::c_int
            } else { -(angleToFacing as libc::c_int) }) <
               0x2ee0 as libc::c_int && sqrt(dist as f64_0) < 600.0f64 {
            ...
            if (if angleToFacing as libc::c_int >= 0 as libc::c_int {
                   ...
                   (if angleToFacing as libc::c_int >= 0 as libc::c_int {
                        angleToFacing as libc::c_int
                    } else { -(angleToFacing as libc::c_int) }) >
                       0x5fff as libc::c_int {
                EnGeldB_SetupSidestep(this, globalCtx);
                (*this).actor.speedXZ *= 3.0f32
            } else if (if angleToFacing as libc::c_int >= 0 as libc::c_int {
                           angleToFacing as libc::c_int
                       } else { -(angleToFacing as libc::c_int) }) <
                          0x5fff as libc::c_int {
                EnGeldB_SetupRollBack(this);
        ...
        [{
         ...
         },
         {
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).scale as *mut Vec3f as
                                 size_t as u32_0);
             init.set_value(10 as libc::c_int);
             init
         },
         {
             let mut init = InitChainEntry{cont_type_0_offset_value: [0; 4],};
             ...
             init.set_offset(&mut (*(0 as *mut Actor)).gravity as *mut f32_0
                                 as size_t as u32_0);
             init.set_value(-(3000 as libc::c_int));
             init
         }]
}
#[used]
