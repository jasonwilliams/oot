...
extern "C" {
    ...
    #[no_mangle]
    fn func_8003EE6C(globalCtx: *mut GlobalContext,
    ...
    #[no_mangle]
    static mut gBongoDrumDL: [Gfx; 0];
    #[no_mangle]
    static mut gBongoDrumCol: CollisionHeader;
}
...
pub const BONGOFLOOR_HIT: C2RustUnnamed_21 = 1;
pub const BONGOFLOOR_REST: C2RustUnnamed_21 = 0;
// Unused, probably a zero vector
#[no_mangle]
pub static mut Bg_Sst_Floor_InitVars: ActorInit =
    unsafe {
        {
            let mut init =
                ActorInit{id: ACTOR_BG_SST_FLOOR as libc::c_int as s16,
                          ...
                          init:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSstFloor_Init
                                                                          as
                          ...
                          destroy:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSstFloor_Destroy
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgSstFloor,
                                                                                               _:
                          ...
                          update:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSstFloor_Update
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgSstFloor,
                                                                                               _:
                          ...
                          draw:
                              ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                  ...
                                                                                  _:
                                                                                      *mut GlobalContext)
                                                                 -> ()>,
                                                      ActorFunc>(Some(BgSstFloor_Draw
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut BgSstFloor,
                                                                                               _:
...
#[no_mangle]
pub unsafe extern "C" fn BgSstFloor_Init(mut thisx: *mut BgSstFloor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSstFloor = thisx;
    ...
    CollisionHeader_GetVirtual(&mut gBongoDrumCol as *mut CollisionHeader as
...
#[no_mangle]
pub unsafe extern "C" fn BgSstFloor_Destroy(mut thisx: *mut BgSstFloor,
                                            mut globalCtx:
                                                *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSstFloor = thisx;
...
#[no_mangle]
pub unsafe extern "C" fn BgSstFloor_Update(mut thisx: *mut BgSstFloor,
                                           mut globalCtx:
                                               *mut GlobalContext) {
    let mut pad: s32 = 0;
    let mut this: *mut BgSstFloor = thisx;
    ...
    let mut colHeader: *mut CollisionHeader =
        gSegments[((&mut gBongoDrumCol as *mut CollisionHeader as u32_0) <<
                       4 as libc::c_int >> 28 as libc::c_int) as
                      usize].wrapping_add(&mut gBongoDrumCol as
    ...
    if func_80043590(&mut (*this).dyna) != 0 &&
           (*this).dyna.actor.yDistToPlayer < 1000.0f32 {
        Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                         usize],
                             CAM_SET_BOSS_BONGO as libc::c_int as s16);
    } else {
        Camera_ChangeSetting((*globalCtx).cameraPtrs[0 as libc::c_int as
                                                         usize],
    ...
    if func_8004356C(&mut (*this).dyna) != 0 &&
           (*player).fallDistance as libc::c_int as libc::c_float > 1000.0f32
       {
    ...
    if (*this).dyna.actor.params as libc::c_int ==
           BONGOFLOOR_HIT as libc::c_int {
        let mut item00: *mut Actor =
            (*globalCtx).actorCtx.actorLists[ACTORCAT_MISC as libc::c_int as
                                                 usize].head;
        let mut distFromRim: f32_0 = 0.;
        let mut xzDist: f32_0 = 0.;
        (*this).drumAmp = 80 as libc::c_int as s16;
        (*this).dyna.actor.params = BONGOFLOOR_REST as libc::c_int as s16;
        (*this).drumPhase = 28 as libc::c_int as s16;
        if func_8004356C(&mut (*this).dyna) != 0 &&
               (*player).stateFlags1 & 0x6000 as libc::c_int as libc::c_uint
                   == 0 {
            distFromRim = 600.0f32 - (*this).dyna.actor.xzDistToPlayer;
            if distFromRim > 0.0f32 {
                if distFromRim > 350.0f32 { distFromRim = 350.0f32 }
                (*player).actor.bgCheckFlags =
                    ((*player).actor.bgCheckFlags as libc::c_int &
                         !(1 as libc::c_int)) as u16_0;
                (*player).actor.velocity.y =
                    9.0f32 * distFromRim * (1.0f32 / 350.0f32)
            }
        }
        while !item00.is_null() {
            if (*item00).id as libc::c_int == ACTOR_EN_ITEM00 as libc::c_int
                   && (*item00).world.pos.y == 0.0f32 {
                xzDist =
                    Actor_WorldDistXZToActor(&mut (*this).dyna.actor, item00);
                distFromRim = 600.0f32 - xzDist;
                if xzDist < 600.0f32 {
                    if distFromRim > 350.0f32 { distFromRim = 350.0f32 }
                    (*item00).bgCheckFlags =
                        ((*item00).bgCheckFlags as libc::c_int &
    ...
    (*this).drumHeight =
        (sinf((*this).drumPhase as libc::c_int as libc::c_float *
                  (3.14159265358979323846f32 /
                       2 as libc::c_int as libc::c_float)) *
             -((*this).drumAmp as libc::c_int) as libc::c_float) as s16;
    Math_StepToS(&mut (*this).drumAmp, 0 as libc::c_int as s16,
                 5 as libc::c_int as s16);
    let ref mut fresh0 =
        (*(*colHeader).vtxList.offset(13 as libc::c_int as isize)).y;
    *fresh0 =
        ((*this).dyna.actor.home.pos.y +
             (*this).drumHeight as libc::c_int as libc::c_float) as s16;
    let ref mut fresh1 =
        (*(*colHeader).vtxList.offset(11 as libc::c_int as isize)).y;
    *fresh1 = *fresh0;
    let ref mut fresh2 =
        (*(*colHeader).vtxList.offset(9 as libc::c_int as isize)).y;
    *fresh2 = *fresh1;
    let ref mut fresh3 =
        (*(*colHeader).vtxList.offset(7 as libc::c_int as isize)).y;
    *fresh3 = *fresh2;
    let ref mut fresh4 =
        (*(*colHeader).vtxList.offset(4 as libc::c_int as isize)).y;
    *fresh4 = *fresh3;
    let ref mut fresh5 =
        (*(*colHeader).vtxList.offset(3 as libc::c_int as isize)).y;
    *fresh5 = *fresh4;
    let ref mut fresh6 =
        (*(*colHeader).vtxList.offset(2 as libc::c_int as isize)).y;
    *fresh6 = *fresh5;
    let ref mut fresh7 =
        (*(*colHeader).vtxList.offset(0 as libc::c_int as isize)).y;
    *fresh7 = *fresh6;
    (*(*colHeader).vtxList.offset(1 as libc::c_int as isize)).y = *fresh7;
    if (*this).drumPhase as libc::c_int != 0 as libc::c_int {
        (*this).drumPhase -= 1
    }
    func_8003EE6C(globalCtx, &mut (*globalCtx).colCtx.dyna);
}
#[no_mangle]
pub unsafe extern "C" fn BgSstFloor_Draw(mut thisx: *mut BgSstFloor,
                                         mut globalCtx: *mut GlobalContext) {
    let mut this: *mut BgSstFloor = thisx;
    ...
    Graph_OpenDisps(dispRefs.as_mut_ptr(), (*globalCtx).state.gfxCtx,
                    b"../z_bg_sst_floor.c\x00" as *const u8 as
                        *const libc::c_char, 277 as libc::c_int);
    func_80093D18((*globalCtx).state.gfxCtx);
    Matrix_Scale(1.0f32,
                 (*this).drumHeight as libc::c_int as libc::c_float *
                     -0.0025f32, 1.0f32,
        ...
        (0xde as libc::c_int as u32_0 &
            ...
            (0 as libc::c_int as u32_0 &
                 (((0x1 as libc::c_int) << 16 as libc::c_int) -
                      1 as libc::c_int) as libc::c_uint) << 0 as libc::c_int;
    (*_g_0).words.w1 = gBongoDrumDL.as_mut_ptr() as libc::c_uint;
    ...
    sInitChain =
        [{
             ...
             init.set_type_0(ICHAINTYPE_VEC3F_DIV1000 as libc::c_int as
                                 u32_0);
             init.set_offset(&mut (*(0 as *mut Actor)).scale.x as *mut f32_0
                                 as size_t as u32_0);
